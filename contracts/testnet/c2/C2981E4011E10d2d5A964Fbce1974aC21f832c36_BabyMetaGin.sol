...
//uint256
    ...
    uint256 public totalBuyFees = BNBRewardsBuyFee.add(marketingBuyFee).add(marketMakerBuyFee);
    uint256 public totalSellFees = BNBRewardsSellFee.add(marketingSellFee).add(marketMakerSellFee);
...
//constructor
    ...
    function setSwapSend(bool _holders, bool _marketing, bool _dev) external onlyOwner {
    ...
    function setFees(uint256 _reward_buy, uint256 _marketing_buy,
        uint256 _reward_sell,uint256 _marketing_sell, uint _marketMaker_buy, uint _marketMaker_sell) external onlyOwner {
        ...
        totalBuyFees = BNBRewardsBuyFee.add(marketingBuyFee).add(marketMakerBuyFee);
        totalSellFees = BNBRewardsSellFee.add(marketingSellFee).add(marketMakerSellFee);
