...
contract UniwhaleGenesisPass is
  Initializable,
  ERC721Upgradeable,
  ...
  ERC721BurnableUpgradeable
{
  ...
  function initialize(
    ...
    __ERC721_init("Uniwhale Genesis Pass", "UGP");
    ...
    _transferOwnership(admin); // used for OpenSea admin mgmt
  ...
  function safeMint() external onlyRole(MINTER_ROLE) {
  ...
  function _safeMint(address to) internal {
    ...
    _require(tokenId < MAX_SUPPLY, Errors.MAX_MINTED);
