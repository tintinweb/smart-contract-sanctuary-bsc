...
contract KRAKEN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69 * 10**15 * 10**9;
    uint256 public _maxTxAmount = _tTotal; // 
    uint256 private SWAP_TOKENS_AT_AMOUNT = _tTotal/100; //
    string private constant _name = "Kraken 2.0"; // 
    string private constant _symbol = "KRATWO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 private _marketingFee = 7;
    uint256 private _liquidityFee = 1;

    address private  _marketingWallet = 0xee3f62631727f0ad055f3088C891ca126db00043;
