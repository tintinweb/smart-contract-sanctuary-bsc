...
contract BMA is IERC20, Ownable {
    ...
    string constant _name = "BTC Max APY";
    ...
    uint256 public buyRewardFee = 60;
    uint256 public buyMarketingFee = 25;
    uint256 public buyLotteryFee = 15;
    uint256 public buyLiquidityFee = 20;
    uint256 public buyBurnFee = 20;
    uint256 public buyTotalFee = 140;

    uint256 public sellRewardFee = 60;
    uint256 public sellMarketingFee = 45;
    uint256 public sellLotteryFee = 15;
    uint256 public sellLiquidityFee = 20;
    uint256 public sellBurnFee = 20;
    uint256 public sellTotalFee = 160;

    // swap percentages
    uint256 public rewardSwap = 60;
    uint256 public marketingSwap = 25;
    uint256 public lotterySwap = 15;
    uint256 public liquiditySwap = 20;
    uint256 public totalSwap = 120;
    ...
    constructor() {
        ...
        marketingReceiver = 0xa9494e3fF124B319D391AC5c2dC8c33820F0C69C;
        lotteryReceiver = 0xcC336eCa9110c46ec9890297d7335405C91d21De;
    ...
    function takeFee(
        ...
        if (recipient == pair) {
            ...
            if (sellBurnFee > 0) {
                tokensToBurn = feeAmount.mul(sellBurnFee).div(sellTotalFee);
            ...
            if (buyBurnFee > 0) {
                tokensToBurn = feeAmount.mul(buyBurnFee).div(buyTotalFee);
                _gonBalances[DEAD] = _gonBalances[DEAD].add(tokensToBurn);
    ...
    function swapBack() internal swapping {
        ...
        uint256 btcSwappedFee = totalSwap.sub(liquiditySwap);
        ...
        uint256 tokensToLottery = swappedTokensAmount.mul(lotterySwap).div(
            btcSwappedFee
        );
        ...
        if (tokensToMarketing > 0) {
            try
                IERC20(REWARD).transfer(marketingReceiver, tokensToMarketing)
            {} catch {}
        }

        if (tokensToLottery > 0) {
            try
                IERC20(REWARD).transfer(lotteryReceiver, tokensToLottery)
            {} catch {}
        }
