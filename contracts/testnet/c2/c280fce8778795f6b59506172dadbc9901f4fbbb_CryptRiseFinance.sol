...
contract CryptRiseFinance is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("CryptRise Finance", "CRF", uint8(DECIMALS)) Ownable() {
        ...
        cryptRiseTreasuryReceiver = 0x01f35a2671656Bb7950b9f617Bb95FCACA18558e; //MultiSigWallet
        cryptRiseVaultFundReceiver = 0xBf24936008653543b9Da8Ad9a4a3E707A80e44b2; //MultiSigWallet
        firePit = DEAD;
