...
contract StorageV2 is Initializable, OwnableUpgradeableVersionable, PausableUpgradeable {
...
abstract contract OwnableUpgradeableVersionable is OwnableUpgradeable {
	...
	function getVersion () external view returns (string memory) { return _version; }

	function getPurpose () external view returns (string memory) { return _purpose; }
