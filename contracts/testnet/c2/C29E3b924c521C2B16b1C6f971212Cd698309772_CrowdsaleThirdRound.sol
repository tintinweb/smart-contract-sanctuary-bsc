...
contract CrowdsaleThirdRound is Ownable, Pausable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for ERC20;
    ...
    uint256 constant public CROWDSALE_ESCROW_CLIFF = 1 hours;
    uint256 constant public CROWDSALE_ESCROW_DURATION = 2 hours;
