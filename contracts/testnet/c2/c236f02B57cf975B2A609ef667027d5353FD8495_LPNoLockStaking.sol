    ...
    PausableUpgradeable
{
    ...
    event LPSetDelayDuration(uint256 poolId, uint256 duration);
    ...
    function lpSetDelayDuration(uint256 _poolId, uint256 _duration)
        external
        onlyOwner
        lpValidatePoolById(_poolId)
    {
        lpPoolInfo[_poolId].delayDuration = _duration;
        emit LPSetDelayDuration(_poolId, _duration);
    }
    ...
    function lpSetPool(
        ...
        require(
            ...
            "LPStakingPool: Cannot set pool in this time"
        );
        ...
        pool.delayDuration = _delayDuration;
        pool.startJoinTime = _startJoinTime;
