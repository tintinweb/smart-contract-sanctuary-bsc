...
contract JurassicCrops is Context , ReentrancyGuard {
    ...
    uint256 public withdrawDays = 2 hours;
    uint256 public claimDays = 1 hours;
    address private dev;
    ...
    constructor(address _dev,address _dev1,address _partner1) {
        tokenAdress = 0x18dF76daeB8689816147f0DADC19FE26f34496B7;
