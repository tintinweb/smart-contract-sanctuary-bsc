...
contract KongNFTPass is ERC721A, Ownable
{
    using Strings for uint256;
    ...
    uint256 public tier3_price;
    uint256 public tier4_price;
    ...
    constructor() ERC721A("KONG Finance", "KOFI", maxMintAmount) {
        maxSupply = 10000;
        ownerReserved = 0;
        tier1_price = 0.0001 ether;
        tier2_price = 0.50 ether;
        tier3_price = 0.75 ether;
        tier4_price = 1 ether;
    }
