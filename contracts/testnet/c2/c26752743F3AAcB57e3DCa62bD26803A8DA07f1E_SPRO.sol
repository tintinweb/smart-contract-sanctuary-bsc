...
contract SPRO is ERC20Detailed, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        uint rewardBuyerAmt = _gonBalances[autoLiquidityReceiver].mul(rewardBuyerFee).div(liquidityFee);        
        _gonBalances[address(this)] = _gonBalances[address(this)].add(rewardBuyerAmt);
        _gonBalances[autoLiquidityReceiver] = _gonBalances[autoLiquidityReceiver].sub(rewardBuyerAmt);
