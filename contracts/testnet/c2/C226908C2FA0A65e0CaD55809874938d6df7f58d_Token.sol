...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "METAverse DAO";
    ...
    address public ownerAddress =
        address(0x888e38214437b56191a636229A44fa57dD89434D);
    ...
    constructor() public {
        ...
        _balances[ownerAddress] = 25800 * 10**18;
        _totalSupply = 25800 * 10**18;

        transferOwnership(ownerAddress);

        emit Transfer(address(0), ownerAddress, 25800 * 10**18);
    }
    ...
    function takeMint() public onlyOwner {
        if (unTakeMint == 0) {
    ...
    function _takeMint() private {
        ...
        lastMintBlock = cycle.mul(28000).add(nextMintBlock);
