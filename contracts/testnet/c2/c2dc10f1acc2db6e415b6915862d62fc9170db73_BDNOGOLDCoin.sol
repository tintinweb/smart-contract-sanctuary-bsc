...
contract BDNOGOLDCoin {
    ...
    constructor() {
        name = "BDNOGOLD Coin by None2"; // Sets the name of the token, i.e Ether
        symbol = "BDNOGOLD"; // Sets the symbol of the token, i.e ETH
        decimals = 8; // Sets the number of decimal places
        uint256 _initialSupply = 10000000000000000; // Holds an initial supply of coins
