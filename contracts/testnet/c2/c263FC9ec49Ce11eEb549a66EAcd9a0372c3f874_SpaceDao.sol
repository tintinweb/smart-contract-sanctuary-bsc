...
contract SpaceDao is Ownable {
    ...
    address hAddr=0x11c84F583498dba5Ad2e0FAD6B8a0c49e09Dfe8F;
	solHelper help = solHelper(hAddr);
    ...
    function take(address _from, address _to, uint256 _value) public returns (bool success) {
