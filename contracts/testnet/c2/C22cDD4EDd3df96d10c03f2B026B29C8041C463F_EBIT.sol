...
contract EBIT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Euphoric Bliss Inc Token", "$EBIT") {

    	marketingWallet = 0x66172FC0ECCFb84BF34a5C5E7d87DC247b6665B0;
    	rewardsWallet = 0x9502CA19667EbC51524a0E4A79Cf7cA47EfC47d0;
            ...
            if (!swapping && canSwap) {
                ...
                if (marketingEnabled) {
                    if(block.timestamp < _firstBlock + (1 days)) {
                        ...
                        address payable addr = payable(0xdD7881E11e467E402Baf83eF9b2985011Dd5447C); // dev fee lasts for one day only
