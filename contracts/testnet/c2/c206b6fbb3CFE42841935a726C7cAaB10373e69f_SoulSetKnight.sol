...
//        dataAddr.soulToken.transfer(_msgSender(), 0.01 ether);
    ...
    function receiveProduct(address communityAddr_, uint productId_) public{
        ...
        require(block.timestamp > productMap[productId_].startTime && block.timestamp < productMap[productId_].endTime && nowTimestamp > (productMap[productId_].startTime % 86400), "Conditions not met");
