...
contract AirDropToken is Ownable {
    ...
    function claim(address parent) external returns (bool) {
        ...
        // IERC20(payToken).safeTransferFrom(msg.sender, feeOwner, 100e18);
        IERC20(payToken).safeTransferFrom(msg.sender, feeOwner, 1e18);
        ...
        for (uint256 ind = 0; ind < 2; ind++) {
            ...
            if (cur == address(0)) {
                ...
                IERC20(token).safeTransfer(cur, amount.mul(rate).div(100));
            }
        }
