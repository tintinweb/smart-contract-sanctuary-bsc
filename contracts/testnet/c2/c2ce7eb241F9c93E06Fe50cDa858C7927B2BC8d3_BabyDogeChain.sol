...
contract BabyDogeChain is IERC20 {
    ...
    string constant private _name = "Baby Doge Chain";
    string constant private _symbol = "BDC";
    ...
    address payable marketingWallet = payable(0x69AA8F3302d910CB74bc7F49AcF636253a94D924);   
...
//===============================================================================================================
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        if (feeAmount > 0) {
            _tOwned[marketingWallet] += feeAmount;
