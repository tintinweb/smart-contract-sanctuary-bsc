...
contract marketingPhenom{
    ...
    function updatePools(address[] memory users, uint8[] memory qualifications) public onlyLegalCaller {
        uint256 q1 = 0;
        uint256 q2 = 0;
        uint256 q3 = 0;
        uint256 q4 = 0;
        ...
        for(uint256 i = 0; i < users.length; i++){
            if(qualifications[i] == 1 && userStackingAmount[users[i]] >= 100){
                for(uint256 a = 0; a < 1; a++){
                    usersAmount[users[i]] += UserLinePool[users[i]][a];
                }
            }else if(qualifications[i] == 2 && userStackingAmount[users[i]] >= 250){
                for(uint256 a = 0; a < 2; a++){
                    usersAmount[users[i]] += UserLinePool[users[i]][a];
                }
            }else if(qualifications[i] == 3 && userStackingAmount[users[i]] >= 250){
                for(uint256 a = 0; a < 3; a++){
                    usersAmount[users[i]] += UserLinePool[users[i]][a];
                }
            }else if(qualifications[i] == 4 && userStackingAmount[users[i]] >= 500){
                for(uint256 a = 0; a < 4; a++){
                    usersAmount[users[i]] += UserLinePool[users[i]][a];
                }
            }else if(qualifications[i] == 5 && userStackingAmount[users[i]] >= 750){
                for(uint256 a = 0; a < 5; a++){
                    usersAmount[users[i]] += UserLinePool[users[i]][a];
                }
            }else if(qualifications[i] == 6 && userStackingAmount[users[i]] >= 1000){
                for(uint256 a = 0; a < 6; a++){
                    usersAmount[users[i]] += UserLinePool[users[i]][a];
                }
            }else if(qualifications[i] == 7 && userStackingAmount[users[i]] >= 2000){
                for(uint256 a = 0; a < 6; a++){
                    usersAmount[users[i]] += UserLinePool[users[i]][a];
                }
            }else if(qualifications[i] == 8 && userStackingAmount[users[i]] >= 4000){
                for(uint256 a = 0; a < 6; a++){
                    usersAmount[users[i]] += UserLinePool[users[i]][a];
                }
                usersAmount[users[i]] += pool1 / q1;
            }else if(qualifications[i] == 9 && userStackingAmount[users[i]] >= 6000){
                for(uint256 a = 0; a < 7; a++){
                    usersAmount[users[i]] += UserLinePool[users[i]][a];
                }
                usersAmount[users[i]] += pool1 / q1;
            }else if(qualifications[i] == 10 && userStackingAmount[users[i]] >= 8000){
                for(uint256 a = 0; a < 7; a++){
                    usersAmount[users[i]] += UserLinePool[users[i]][a];
                }
                usersAmount[users[i]] += pool1 / q1;
                usersAmount[users[i]] += pool2 / q2;
            }else if(qualifications[i] == 11 && userStackingAmount[users[i]] >= 10000){
                for(uint256 a = 0; a < 8; a++){
                    usersAmount[users[i]] += UserLinePool[users[i]][a];
                }
                usersAmount[users[i]] += pool1 / q1;
                usersAmount[users[i]] += pool2 / q2;
            }else if(qualifications[i] == 12 && userStackingAmount[users[i]] >= 15000){
                for(uint256 a = 0; a < 8; a++){
                    usersAmount[users[i]] += UserLinePool[users[i]][a];
                }
                usersAmount[users[i]] += pool1 / q1;
            ...
            }else if(qualifications[i] == 13 && userStackingAmount[users[i]] >= 25000){
                ...
                usersAmount[users[i]] += pool2 / q2;
                usersAmount[users[i]] += pool3 / q3;
            }else if(qualifications[i] >= 14 && userStackingAmount[users[i]] >= 40000){
                for(uint256 a = 0; a < 9; a++){
                    usersAmount[users[i]] += UserLinePool[users[i]][a];
                }
                usersAmount[users[i]] += pool1 / q1;
