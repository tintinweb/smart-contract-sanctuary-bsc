...
contract MetaVesting2 is Ownable {
    ...
    function claimAtTge(uint256 _strategyId) internal {
        ...
        require(claimingPart > 0, "MetaVesting2: Waiting for the next!");
    ...
    function claim(uint256 _strategyId) public {
        ...
        VestingInfo storage userInfo = userToVesting[msg.sender][_strategyId];
        VestingStrategy storage vestingInfo = vestingStrategy[_strategyId];
        require(userInfo.amount > 0, "MetaVesting2: You do not have allocation for this type!");
        require(userInfo.claimed < userInfo.amount, "MetaVesting2: You already received fully your allocation!");
        ...
        require(claiming > 0, "MetaVesting2: We already vested all tokens!");
        mtsERC20.safeTransfer(msg.sender, claiming);
    }
