    ...
    Oracle
{
    ...
    // @dev fee per transaction for KannabisCity
        ...
        returns (bool)
    {
        ...
        uint256 valueInUsd = msg.value.mul(latestPrice);

        // @dev check if the user has enought tokens to buy the amount of token he wants to buy
        uint256 _quantity = (valueInUsd / pair.price);
        ...
        require(
            ...
            "Mint Native Token: Can only mint between 1 and MAX_MINT_PER_TX tokens at once"
        );
        ...
        returns (bool)
    {
        ...
        /// @dev calculate the amount of token to buy
        uint256 valueInUsd = _amountTokens.mul(latestPrice);
