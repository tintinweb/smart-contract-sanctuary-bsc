...
contract UberTaxiController7 is Ownable {
    ...
    constructor() {
        ...
        // UTC = UberTaxiController(0xa7D19a6b9dA84A087014E5148E455CBa0217F668);
        UTC = UberTaxiDate(0x6E3374767DED4bFC6D4D4d84Ccd484436f37d612);

        UTD = CryptoTaxiDate(0x1D3B2670480274315aBCb3ac5213a77e797d913C);
    }

    
    function updatenUberTaxiController(address UTDAddress) public onlyOwner {
        // UTC = UberTaxiController(UTDAddress);
        UTC = UberTaxiDate(UTDAddress);
    }
    ...
    function synchData(uint256 start, uint256 end) public onlyOwner {
        ...
        for(uint256 i = start; i < end; i++){
            ...
            if(!isUsers[hold]){
                ...
                // (address[] memory bindingUsers, uint256[] memory bindingTime) = UTC.queryBindingUsersAndTime(hold);
