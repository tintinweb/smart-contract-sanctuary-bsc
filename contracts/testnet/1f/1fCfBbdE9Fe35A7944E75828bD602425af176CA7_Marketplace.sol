    ...
    ERC721URIStorageUpgradeable
{
    ...
    ) external payable nonReentrant validQuantity(_quantityToBuy) onlyValidListing(_listingId)
    {
        ...
        require(_quantityToBuy <= selectedListing.quantity, "Marketplace_CreateMarketSale: Invalid quantity");
