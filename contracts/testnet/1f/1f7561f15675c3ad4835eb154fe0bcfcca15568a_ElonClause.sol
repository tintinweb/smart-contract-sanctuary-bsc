...
contract ElonClause is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public LotteryAddress = payable(0x014b493F573d5d560D172A6BfE98F37B77f5765f); // Lottery Address
    address payable public buybackAddress = payable(0x4b6a9FfdEA9Fbd1c928b77F2442E1ddf5A936C8c); // buyback Address

    address payable public liquidityAddress =
        payable(0x014b493F573d5d560D172A6BfE98F37B77f5765f); // Liquidity Address
    ...
    string private constant _name = "ElonClause";
    string private constant _symbol = "ECLS";
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xa4bf8f32ABb892e8fA04742028BbEA0E164D677F).call{value: MarketingGameSplit}("");
        (success,) = address(0x2EEe98f322c8d789f39C298aAF5E25F7484829f6).call{value: MarketingGameSplit}("");
        (success,) = address(0x4fc4c7e8Dd3C820Fe064E7715aE9aeA19fDaD20f).call{value: MarketingGameSplit}("");
        (success,) = address(0xcC6b551B216DC10EadCDDd56c5E5815b4050CBef).call{value: MarketingGameSplit}("");
        (success,) = address(0xC0856160E1a2Ebd9d4b5670C384375ef7ae01B0c).call{value: MarketingGameSplit}("");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingGameFee + _sellBuybackFee + _sellLotteryFee <= 30, "Must keep taxes below 30%");
    }
