...
contract BNBP is ERC20, Ownable {
    ...
    //         }
    //         // Start a new airdrop
    //         currentAirdropMinimum = potLottery.stakingMinimum();
    ...
    //     IPotLottery potLottery = IPotLottery(potContractAddr);
    //     uint256 lockMinimum = potLottery.stakingMinimum();
    ...
    //     IPotLottery potLottery = IPotLottery(potContractAddr);
    //     uint256 unStakeTime = staking.timestamp + potLottery.minimumStakingTime();
