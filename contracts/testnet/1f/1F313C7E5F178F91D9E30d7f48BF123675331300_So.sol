// SPDX-License-Identifier: MIT
    ...
    contract So is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 10000000000000000; // 0.01 BNB  100000000000000
      uint256 public constant maxTokenPurchase = 5;
      uint256 public constant MAX_TOKENS = 1000;
    
      string public baseURI = "ipfs://QmeCsnuw6HxQougzwBqU2kwC6d5xpWaBTVbDSXV7hUXTz9/"; // IPFS URI WILL BE SET AFTER ALL TOKENS SOLD OUT
      ...
      event SoMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("So", "SO") {}
      ...
      function mintSo(uint256 numberOfTokens) external payable {
        require(
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit SoMinted(id, msg.sender);
          }
        }
      }
    
      function presaleSo(uint256 numberOfTokens) external payable {
