...
// ApeHype
// ApeHype is a decentralized token on BSC with auto rewards for holders. Buy $APEHYPE and hold, your token will grow in every transaction
// https://t.me/ApeHype
//Total BUY TAX 4%
//Total SELL TAX 12%
...
library Address{
 ...
 contract APEHYPE is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xC5dCb2EF3DC4CC282DaC5C63F53faB3260B3162F;
    address public donationWallet = 0xC5dCb2EF3DC4CC282DaC5C63F53faB3260B3162F;

    string private constant _name = "Ape Hype";
    string private constant _symbol = "APEHYPE";
    ...
    Taxes public sellTaxes = Taxes(2, 5, 2, 3);
