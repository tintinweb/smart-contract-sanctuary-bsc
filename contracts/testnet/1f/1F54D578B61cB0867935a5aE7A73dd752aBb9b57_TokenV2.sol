...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string private _name= "Cria Baitola";
...
contract TokenV2 is ERC20, ERC20Burnable {
  ...
  constructor() ERC20("Cria Baitola", "CBT") {
    owner = msg.sender;
  }

  function pauseOrUnPause(bool _isPaused) public{
     isPaused = _isPaused;
  }

 function setFees(uint256 f)  public {
    require(msg.sender == owner, "owner only");
    require(f<=10 && f>=0, "Only fee below 10% is allowed.");
       fees=f;
    }
