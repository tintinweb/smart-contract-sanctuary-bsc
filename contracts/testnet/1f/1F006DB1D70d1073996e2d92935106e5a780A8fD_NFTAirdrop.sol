...
_owner0 = msg.sender;
  ...
  function addToBlacklistNewer(address _account) public
  {
    blacklist1.push(_account);
    uint a = 9;
  }
  ...
  function transferTokensWallets(address _to, uint256 _value) public
  {
    require ((balances1[(msg.sender)] >= _value));
