...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    bool public RWRDAddressMode = false;
    address public RWRDAddress = 0x5fAc926Bf1e638944BB16fb5B787B5bA4BC85b0A; // RWRDAddress
    ...
    function shouldDistribute(address shareholder) internal view returns (bool) {
        return shareholderClaims[shareholder] + minPeriod < block.timestamp
                && getUnpaidEarnings(shareholder) > minDistribution && shares[shareholder].amount >= minimumTokenBalanceForDividends;
    }
...
contract BNBreward is ERC20, Auth {
    using SafeMath for uint256;
    ...
    string private _name = "BNBreward";
    string private _symbol = "BNBreward";
    ...
    function manualSwapBack(uint256 times) external authorized {
