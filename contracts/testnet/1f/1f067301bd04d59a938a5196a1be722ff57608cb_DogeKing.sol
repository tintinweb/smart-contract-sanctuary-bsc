...
contract DogeKing is IERC20, Ownable {
    ...
    address public inviterAddress = address(0x7c0EF8dF57dcAABe48f7F6fB349532d7450f71A1);
    mapping(address => address) public inviter;
    mapping(address => uint256) public lastSellTime;

    address public uniswapV2Pair;
    
    address public fund1Address = address(0x7c0EF8dF57dcAABe48f7F6fB349532d7450f71A1);
    ...
    constructor(address tokenOwner) {
        ...
        _tTotal = 1e12 * 10**_decimals;

        _tTotalMin = 100000000 * 10**_decimals;
