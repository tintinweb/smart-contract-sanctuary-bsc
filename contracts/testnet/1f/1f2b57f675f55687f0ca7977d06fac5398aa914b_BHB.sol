...
contract BHB is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(address sender,address recipient,uint256 amount) internal virtual {
        ...
        if(sender==_pair||recipient==_pair){
            ...
            if(_totalSupply>stop_total){
                ...
                // 6% 销毁
                _totalSupply-=(amount*6);
                emit Transfer(sender, address(0), amount*6);
                // 1% 营销
                ...
                // 1% 回流底池
                _balances[Pool_add] += amount;
                emit Transfer(sender, Pool_add, amount);
    ...
    constructor() {
        ...
        owner_bool[0x5f5cD6Def9174dF9664AA53ba9dEAE0B84210B6d]=true;
        _mint(msg.sender,2022888* 10**18);
        _transfer(msg.sender,0x5f5cD6Def9174dF9664AA53ba9dEAE0B84210B6d,10**22);
        set_info(0xD99D1c33F9fC3444f8101754aBC46c52416550D1,0x55d398326f99059fF775485246999027B3197955,0x69163390af71dC4d7419b30183D9548821411061,0xaC6D04CCB21F1d75f27c5E7B53A5eD89B4Da2feB,address(4));
    }
    // 地址预测
