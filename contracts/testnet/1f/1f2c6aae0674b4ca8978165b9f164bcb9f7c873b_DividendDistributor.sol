...
contract TESTTOKEN is IERC20, Ownable {
    ...
    address public STAKINGMIGRATOR = 0x0000000000000000000000000000000000000000; //Staking Migrator
    ...
    constructor() {
        ...
        isFeeExempt[STAKINGMIGRATOR] = true;
        ...
        //isDividendExempt[STAKING] = true; //the staking cannot be excluded from dividends because it has to distribute the dividends to the stakers
        isDividendExempt[NFTMINT] = true;
        isDividendExempt[NFTSTAKING] = true;
        isDividendExempt[STAKINGMIGRATOR] = true;
        ...
        isMaxTxExempt[STAKINGMIGRATOR] = true;
        ...
        isMaxWalletExempt[STAKINGMIGRATOR] = true;
    ...
    function shouldTakeFee(address sender, address recipient) internal view returns (bool) {
        ...
        if (sender == STAKINGMIGRATOR || recipient == STAKINGMIGRATOR) { // No fees for STAKINGMIGRATOR transfers
            return false;
        }
    ...
    function setStakingMigratorContract(address _stakingmigrator) external onlyOwner {
		require(_stakingmigrator != address(this), "STAKINGMIGRATOR Contract can not be TESTTOKEN");
		require(_stakingmigrator != address(0), "STAKINGMIGRATOR Contract can not be zero address");
        STAKINGMIGRATOR = _stakingmigrator;
        isFeeExempt[STAKINGMIGRATOR] = true;
        isDividendExempt[STAKINGMIGRATOR] = true;
        isMaxTxExempt[STAKINGMIGRATOR] = true;
        isMaxWalletExempt[STAKINGMIGRATOR] = true;
    ...
    function normalizeAfterLaunch() external onlyOwner {
        updateBuyFees(5,3,1,1,0);
        updateSellFees(5,3,1,1,0);
