...
/**
 ____     ____    __    __  ____    ______  _____   ____     _____   ______  ____       
/\  _`\  /\  _`\ /\ \  /\ \/\  _`\ /\__  _\/\  __`\/\  _`\  /\  __`\/\__  _\/\  _`\     
\ \ \/\_\\ \ \L\ \ `\`\\/'/\ \ \L\ \/_/\ \/\ \ \/\ \ \ \L\ \\ \ \/\ \/_/\ \/\ \,\L\_\   
 \ \ \/_/_\ \ ,  /`\ `\ /'  \ \ ,__/  \ \ \ \ \ \ \ \ \  _ <'\ \ \ \ \ \ \ \ \/_\__ \   
  \ \ \L\ \\ \ \\ \ `\ \ \   \ \ \/    \ \ \ \ \ \_\ \ \ \L\ \\ \ \_\ \ \ \ \  /\ \L\ \ 
   \ \____/ \ \_\ \_\ \ \_\   \ \_\     \ \_\ \ \_____\ \____/ \ \_____\ \ \_\ \ `\____\
    \/___/   \/_/\/ /  \/_/    \/_/      \/_/  \/_____/\/___/   \/_____/  \/_/  \/_____/
                                                                                                                                                                           
*/

/** 
    Project: CryptoBots 3D
    Website: CryptoBotCollection.com
...
contract CryptoBots3D is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  function mint(uint256 _mintAmount) public payable nonReentrant {
    ...
    if (msg.sender != owner()) {
      ...
      require(isAllowlisted(msg.sender), "You are not allowlisted");
      require(tokensMinted[msg.sender] + _mintAmount <= maxMintAmount, "You minted maximum amount during allowlist");

      tokensMinted[msg.sender] = tokensMinted[msg.sender] + _mintAmount;
    }
    }
