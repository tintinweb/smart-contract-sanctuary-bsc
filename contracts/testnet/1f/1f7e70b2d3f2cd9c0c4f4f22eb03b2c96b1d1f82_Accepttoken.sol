...
contract Accepttoken{
    // Token t;
    // constructor(){
    // t=Token(0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8);
    // }
    event _tokentransfer(address from,address to,uint _token);
    function tokentransfer(address tokenAddress,uint value)public {
         Token t = Token(tokenAddress);
         t.transfer(address(this),value);
        emit _tokentransfer(tokenAddress,msg.sender,value);
    }
}