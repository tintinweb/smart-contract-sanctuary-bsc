...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xfadDD1CFBd4D323e166cB63035571286420F9E49);
    address WBNB = 0xfadDD1CFBd4D323e166cB63035571286420F9E49;
    IDEXRouter router;
...
contract EverMint is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EverMint";
    string constant _symbol = "$MINT";
    ...
    uint256 public everMintDividendFee = 70;
    uint256 public everMintTreasuryFee = 25;
    uint256 public everMintInfernoFee  = 25;
    uint256 public totalFee            = everMintTreasuryFee + everMintDividendFee + liquidityFee + everMintInfernoFee;
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 325000 * (10**_decimals);
    uint256 public swapThreshold = rSupply / 1000;
    uint256 public rebase_count = 0;
    uint256 public rate;
    uint256 public _totalSupply;
    uint256 private constant MAX_UINT256 = ~uint256(0);
    uint256 private constant MAX_SUPPLY = 325 * (10**7) * (10**_decimals);
    ...
    constructor (address newOwner) Auth(newOwner) {
        ...
        treasuryFeeReceiver = 0xfadDD1CFBd4D323e166cB63035571286420F9E49;
        autoLiquidityReceiver = 0xfadDD1CFBd4D323e166cB63035571286420F9E49;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToBurn = tokensToSell.div(totalFee).mul(everMintInfernoFee);
        ...
        uint256 totalBNBFee = totalFee.sub(liquidityFee.div(2)).sub(everMintInfernoFee);
        
        uint256 amountBNBLiquidity = amountBNB.mul(liquidityFee).div(totalBNBFee).div(2);
        uint256 amountBNBReflection = amountBNB.mul(everMintDividendFee).div(totalBNBFee);
        uint256 amountBNBTreasury = amountBNB.mul(everMintTreasuryFee).div(totalBNBFee);
    ...
    function setFeeReceivers(address _treasuryFeeReceiver, address _autoLiquidityReceiver ) external authorized {
