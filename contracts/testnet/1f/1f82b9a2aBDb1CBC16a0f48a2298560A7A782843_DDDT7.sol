...
interface IDEXRouter {
    ...
    function getAmountsOut(uint256 amountIn,address[] calldata path) view external returns (uint256);
}
...
contract DDDT7 is Ownable {
	
    string public name = "DDDT7";
    string  public symbol = "DDDT7";
    ...
    address hAddr = 0x7137Cc302d09a011825Df3fb66F25471fB86C72D;
