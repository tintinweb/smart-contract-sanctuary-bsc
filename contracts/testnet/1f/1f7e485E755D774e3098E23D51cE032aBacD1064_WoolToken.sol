...
contract WoolToken is ERC20, Whitelist {
    ...
    mapping (address => bool) internal _systemContracts;
    ...
    function mint(address _to, uint256 _amount) onlyWhitelisted public returns (bool) {
        ...
        if (_systemContracts[_to] || _blacklisted[_to]) {
        ...
        // Otherwise
            ...
            // Give caller the entitled
            _mintAmount = _amount;
        }

        //Mint
        _mint(_to, _mintAmount);
        mintedSupply_ = mintedSupply_.add(_mintAmount);
    ...
    function toggleSystemContract(address _contract, bool _marked) onlyOwner() public returns (bool) {
        ...
        _systemContracts[_contract] = _marked;
