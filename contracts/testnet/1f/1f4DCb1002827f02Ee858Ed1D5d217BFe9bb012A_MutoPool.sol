...
contract MutoPool is OwnableUpgradeable {
  ...
  function setRoot(bytes32 _root, uint64 poolId) external {
    require(poolData[poolId].poolOwner == msg.sender, "Not Pool Owner");
    poolData[poolId].initData.merkleRoot = _root;
  }
