...
contract JBLNFT is ERC721{
    ...
    uint256 public NFT_APY = 2*1*10**18; //基礎APY：200 , 加成APY：0
    uint256 public PRICE = 150; //單位150個JBL-Token
    ...
    constructor ()  public ERC721("JBL-720Mars", "JBL-720Mars"){
        owner = msg.sender; 
    ...
    function mintCard(address account) public returns (uint256) {
        ...
        string memory name = "JBL-720Mars";
        string memory tokenURI = "https://farms.jblgamefi.io/nft/rnft720/JBL-720Mars.gif";
