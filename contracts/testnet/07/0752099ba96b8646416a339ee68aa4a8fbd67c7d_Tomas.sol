...
contract Tomas is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable {
  ...
  function mintel(address to, uint256 amount) external onlyAdmin {
    _mint(to, amount);
  }

  // Anyone can burn thier own token if required.
  function burnol(uint256 amount) external {
