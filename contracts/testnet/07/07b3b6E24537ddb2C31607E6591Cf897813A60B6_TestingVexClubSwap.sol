...
contract TestingVexClubSwap is ChainlinkClient, Ownable {
    ...
    constructor() {
        ...
        // oracle = 0x77a5310E41F0B9FE35E95239Fa5624390fadFbBA; // bsc  mainnet
        oracle = 0x19f7f3bF88CB208B0C422CC2b8E2bd23ee461DD1; //  bsc testnet
        //jobId = "6970f959a9ac437788e305a246c3e906"; //  bsc mainnet
        jobId = "9b32442f55d74362b26c608c6e9bb80c"; //  bsc testnet
        fee = 0.04 * 10 ** 18; // 0.04
    }
