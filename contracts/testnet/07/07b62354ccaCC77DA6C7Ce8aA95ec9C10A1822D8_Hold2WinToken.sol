...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 public h2wToken;

    // address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // bsc mainnet
    address public WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // bsc testnet
        ...
        returns (bool)
    {
        return
            ...
            h2wToken.balanceOf(shareholder) > minBalanceToGetReward;
    }
...
contract Hold2WinToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address DEAD = 0x000000000000000000000000000000000000dEaD;

    address payable public marketingAddress = payable(0x7C2ce1b2d1d9AbC070d584c5BFdBB7b369c2EDBD); // Marketing Address
    address payable public burnAddress = payable(0xDF06f9Cb5CdfAA76884F49739824771515B66722); // Reward Address. zero address so will burn.
    address payable public liquidityAddress = payable(0x000000000000000000000000000000000000dEaD); // Liquidity Address
    address payable public devAddress = payable(0xD95Fc8544Ded12bc019012CF94E33d97E515dc6b); // dev address
    address payable public treasuryAddress = payable(0xD95Fc8544Ded12bc019012CF94E33d97E515dc6b); // Treasury address
    ...
    string private constant _name = "Hold2Win Token";
    ...
    constructor(/*address pinkAntiBot_, */address _rewardToken) {
        ...
        // 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 // Test Pancakeswap Router
    ...
    function swapBack() private lockTheSwap {
        ...
        bool success;
        uint256 totalTokensToSwap = _liquidityTokensToSwap + _burnTokens + _marketingTokensToSwap;
        ...
        uint256 amountToSwapForETH = _liquidityTokensToSwap.sub(tokensForLiquidity).add(_marketingTokensToSwap);
        ...
        uint256 ethForMarketing = ethBalance.mul(_marketingTokensToSwap).div(amountToSwapForETH);
        ...
        uint256 treasuryFee = address(this).balance.mul(_treasuryFee).div(_sellMarketingFee);
        (success,) = address(treasuryAddress).call{value: treasuryFee}("");
