...
contract PandoraNFT is Initializable, ERC721EnumerableUpgradeable, AccessControlUpgradeable {
  ...
  function initialize() public initializer {
    __ERC721_init("Pandora NFT", "PNFT");
  ...
  function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) {
        ...
        return string.concat("https://pandora-3qfdjyqhq-en3sis.vercel.app/api/nft/", Strings.toString(_tokenId));
    }
