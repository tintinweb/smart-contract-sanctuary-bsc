...
contract BakedBeans is Context, Ownable {
    ...
    function getMarketEggs() public returns(uint256)  {
        return marketEggs;
    }

     function getClaimedEggs(address adr) public returns(uint256) {
        return claimedEggs[adr];
    }

     function getLastHatch(address adr) public returns(uint256) {
