...
contract XSpaceMoonX {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 0.1 ether; // 5 MATIC
	uint256[] public REFERRAL_PERCENTS = [50, 30, 20];
	uint256 constant public PROJECT_FEE = 100;
	uint256 constant public DEVELOPER_FEE = 150;
	...
	constructor(address payable wallet, address payable _developer) public {
        ...
        startUNIX = block.timestamp.add(1000 minutes);

        plans.push(Plan(5, 200)); // 7% per day for 28 days
