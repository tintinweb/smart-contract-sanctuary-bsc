...
// File: contracts/newTesting/WPTNftStaking.sol
...
contract WPTNftStaking is Ownable, IERC721Receiver, ReentrancyGuard {
    ...
    */
    ...
    function restartReward() external onlyOwner {
    require(startBlock > 0 && bonusEndBlock > 0, "Pool has not been started yet");
    require(block.number >= bonusEndBlock, "Rewards are still ongoing");
