...
contract Ordostake {
    ...
    function stake(uint256 amount, uint256 timeperiod) public {
        ...
        uint256 ERC20VAL = getPriceinUSD();
        uint256 rewardtokenPrice = (amount.mul(ERC20VAL)).div(1e9);
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address BUSD_WBNB = 0x5126C1B8b4368c6F07292932451230Ba53a6eB7A;
        ...
        address ERC20_WBNB = 0xd0d7d613DD9722D4B94AF6c31E95EE380dfCFF3F;
        IERC20 ERC20TOKEN = IERC20(0x445da459E18A4D54717664ae329913173d3920bf);

        uint256 WBNBSUPPLYINERC20_WBNB =(WBNBTOKEN.balanceOf(ERC20_WBNB));
        uint256 ERC20SUPPLYINERC20_WBNB = (ERC20TOKEN.balanceOf(ERC20_WBNB));

        uint256 ERC20USDVAL = (((WBNBSUPPLYINERC20_WBNB.mul(1e9)).div((ERC20SUPPLYINERC20_WBNB))).mul(BNBPRICE)).div(1e18);
        return ERC20USDVAL;
    }
