...
contract NFTTest1 is Ownable, ERC721Enumerable, SalesActivation {
    ...
    uint256 public constant PUBLIC_SALES_PRICE = 0.03 ether;
    ...
    constructor() ERC721("NFT1", "NFT1") {
        tokenAddress = IERC20(0xC78F9aAFb890d51d5cB72431028Bc7393130c1cC);
    }
    ...
    // function tokenIdOfAddress(address _address) public view returns( uint256[] memory) {
