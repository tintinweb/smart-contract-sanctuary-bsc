...
contract TestToken is ERC20, Ownable, Distributor {
    ...
    address public marketingWallet = 0xf45C2F6C0129D18198BE3C9a62A442943C01b7f3;
    address public influenceWallet = 0xf45C2F6C0129D18198BE3C9a62A442943C01b7f3;
    address public buybackWallet = 0xf45C2F6C0129D18198BE3C9a62A442943C01b7f3;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if (to == DEAD || to == ZERO) super._burn(from, amount);
