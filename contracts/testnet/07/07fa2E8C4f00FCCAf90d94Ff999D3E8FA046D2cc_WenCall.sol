...
contract WenCall is IBEP20, Auth {
    ...
    address MkgDevWallet = 0x9E25633Ff9e3Fd2d50B5c29c6e6Fb1dC76AF8051; 
    address TeamWallet   = 0x0000000000000000000000000000000000000000; 
    address BBBWallet    = 0xD4f2155B786716183490aA04f1b08E416f8A4B1b;
    ...
    //20%
    uint256 public maxTxAmount = _totalSupply * 20 / 100;

    //20%
    uint256 public maxWalletToken = _totalSupply * 20 / 100;
    ...
    function setTxAmoutLimit(uint256 amount) external authorized {
        maxTxAmount = amount;
    }

    function getTxAmoutLimit() public view returns (uint256) {
         return maxTxAmount;
    }
    ...
    function setMarketingWalletAddress(address _MarketingWallet) external authorized {
        MkgDevWallet = _MarketingWallet;
    }

    function setBuyBackBurnWalletAddress(address _BBBWallet) external authorized {
       BBBWallet = _BBBWallet;
    }

    function setTeamlletAddress(address _TeamWallet) external authorized {
