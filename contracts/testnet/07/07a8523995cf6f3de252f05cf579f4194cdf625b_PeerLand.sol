...
Burning: 2% from each transaction



*/

contract PeerLand is Context, IERC20, Ownable {
    ...
    uint256 public _tTotal = 7000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "PeerLand";
    string public _symbol = "PELD";
    ...
    address public marketingWallet = 0x000000000000000000000000000000000000dEaD ; // currently set as dead address 
