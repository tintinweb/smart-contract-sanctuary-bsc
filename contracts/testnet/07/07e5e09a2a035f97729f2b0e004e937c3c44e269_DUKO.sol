...
contract DUKO is Context, IERC20, Ownable {
    ...
    function ifTokenGetStuck(address _token) external onlyOwner {
        IERC20 stucked = IERC20(_token);
        uint256 amtStucked = stucked.balanceOf(address(this));
        require(amtStucked > 0, "Token is not Stucked");
        stucked.transfer(msg.sender, amtStucked);
    }
