...
/*
        ...
        WELCOME TO SHIBAHAWAII

    🌴 Website: https://www.shibahawaii.com/
    🌴 Twitter: https://twitter.com/ShibaHawaii
    🌴 Telegram: https://t.me/ShibaHawaii
...
contract HAWAII is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4c948126aCB06e668d912c6AC92a3D3af90e7504);
    address payable public Wallet_Dev = payable(0xe33e7Fb03f94DF6c2BF0e7eff0927e611d772a2D);
    ...
    string private constant _symbol = unicode"HAWAII";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        if(!takeFee){
            ...
            if (tradingActiveBlock + 30 seconds <= block.timestamp) {
    ...
    function airdrop_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
