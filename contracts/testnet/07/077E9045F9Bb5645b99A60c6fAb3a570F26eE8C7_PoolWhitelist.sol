    ...
    OwnableUpgradeable
{
    ...
    function getDepositAmountToken(uint64 _poolIdx, uint16 _percentage) public view returns (uint256) {
    ...
    function getDepositAmountBusd(uint64 _poolIdx, uint16 _percentage) public view returns (uint256) {
        uint256 _totalRequireDepositBusd = poolsStat[_poolIdx].approvedBusd.mul(100-pools[_poolIdx].fee).div(100); // allocation after fee
        return _totalRequireDepositBusd.mul(_percentage).div(10000);
    }
        ...
        onlyModerator
    {
        ...
        // uint256 _totalRequireDepositBusd = poolsStat[_poolIdx].approvedBusd.mul(100-pools[_poolIdx].fee).div(100); // allocation after fee
        require(
            _totalDepositedValueBusd <= getDepositAmountBusd(_poolIdx, 10000),
