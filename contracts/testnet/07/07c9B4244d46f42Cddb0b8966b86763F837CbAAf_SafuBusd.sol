...
//
// SAFU 2.0 PROTOCOL DUAL REWARD WITH DIVIDEND
...
contract SafuBusd is ERC20Detailed, Ownable {
    ...
    // string public _name = "SafuBusd";
    // string public _symbol = "SAFU";
    ...
    constructor() ERC20Detailed("TestSafu", "TestSafu", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x286603493374f97073B6Ec05ce1bBe5A82434031;
        treasuryReceiver = 0x65edFAA65cacB23D526c5dA9E89b06A861ebdD9F; 
