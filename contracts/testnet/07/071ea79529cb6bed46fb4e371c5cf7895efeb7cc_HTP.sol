...
contract HTP is Context, IERC20, Ownable {
    ...
    string private _name = "Hotkeep";
    string private _symbol = "HTP";
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address private _receive = address(0x87ac6FB066AcBA8B7Eaa70A8fbD28F26cf110861);
    address _tokenOwner;
    ...
    constructor (address tokenOwner){
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), 0xFa60D973F7642B748046464e165A65B7323b0DEE);
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = address(0xFa60D973F7642B748046464e165A65B7323b0DEE);
