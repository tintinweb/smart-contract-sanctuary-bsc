...
contract OperonOriginsMarketplace {
        ...
        payable
    {
        ...
        if (
            ...
            uint256 tokenPrice = offeringRegistry[_offeringId].price;

            require(
                tokenBalance >= offeringRegistry[_offeringId].price + _adminfee,
            ...
            require(
                msg.value >= offeringRegistry[_offeringId].price + _adminfee,
