...
contract CamelNFT is ERC721r, ReentrancyGuard, Ownable {

    address tokenAddress;


    constructor() ERC721r("MyToken","MTK",287){
    ...
    function mint(uint256 quantity) public{
        // require(IERC20(tokenAddress).balanceOf(msg.sender) >= 100, "Not enough tokens");
