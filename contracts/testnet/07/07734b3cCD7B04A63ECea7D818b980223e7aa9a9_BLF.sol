...
contract BLF is Context, IERC20, Ownable, IERC20Metadata {
    ...
    address payable private _devAddress =
        payable(0x52ddD9E8B9E264Bb4eE498b817ECC7F59F4eF5bA);
    address payable private _marketingAddress =
        payable(0x4E62F09F054E958a3eE7a173cFC9f2af5B91e49C);
    ...
    function sendETHToFee(uint256 amount) private {
        _devAddress.transfer(amount.mul(70).div(100));
