...
// https://t.me/babyjunibsc
// https://www.twitter.com/babyjunibsc
...
contract BabyJUNI is IBEP20, Ownable {
    ...
    string private _name = "Baby JUNI";
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        dev: 0x568dbfdeCa45AFAe356ec924725eEb769d460BdD,
        events: 0x7443A2082E571B78Adb10E4edAe065d2519a463A,
        marketing: 0xFf5e8a0d939aaE1F95E579bD2BEdb2d007512B35
    });
    ...
    address public mainReward = 0x95Aa33319698CF67C7AB33bb23A65E9d38397187;
...
///// AUTHORIZED FUNCTIONS /////
        ...
        onlyOwner 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newDev + newLiquidity + newevents + newMarketing + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newDev, newLiquidity, newevents, newMarketing, newRewards);
    }
