...
contract SPURT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Spurt", "SPURT") {

        address newOwner = address(0xc72e05F49e4a1eabDf3174a8081686260f1cBf64);
        ...
        // 10% sell tax to start, will be reduced over time.
    	...
    	marketingWallet = address(0xc72e05F49e4a1eabDf3174a8081686260f1cBf64); // for marketing
    	buyBackWallet = address(0xc72e05F49e4a1eabDf3174a8081686260f1cBf64); // for buyback wallet
    ...
    function updateMaxAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 5 / 100)/1e18, "Cannot set maxTransactionAmount lower than 5%");
