...
contract MHC is IERC20, Ownable {
    ...
    address tokenOwner = address(0xa75847E668A072A758D1c07C82C9B0C0E1B064a9);
    constructor() {
        _name = "Meta Hero Coin";
        _symbol = "MHC";
        _decimals = 18;
        _tTotal = 50000000 * 10**_decimals;
        uint256 leaveAmount = 10000000 * 10**_decimals;
    ...
    function _transfer(
		...
		if(isInviter && amount >= 10 * 10**_decimals) {
            inviter[to] = from;
        }
    }
