...
contract Test1 {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 1 wei; //5e16; // 0.05 bnb
	uint256[] public REFERRAL_PERCENTS = [70, 30, 15, 10, 5, 5];
	uint256 constant public TOTAL_REF = 135;
	...
	function invest(uint8 plan, address referrer) public payable {
		...
		require(msg.value >= INVEST_MIN_AMOUNT, "Need to deposit more than min amount");
	...
	function getPlanInfo() public view returns(uint8 plan, uint256 time, uint256 percent) {
