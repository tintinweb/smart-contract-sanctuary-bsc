...
contract XGToken is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 private immutable _capped;
    address private _minter;
    constructor(uint256 initialSupply, uint256 capped, address owner) ERC20("XGToken", "XGT") {
        _minter = _msgSender();
        _capped = capped;
    ...
    function mint(uint256 amount) public onlyMinter {
        require(totalSupply() + amount <= _capped, "supply cap exceeded.");
        _mint(owner(), amount);
    }
