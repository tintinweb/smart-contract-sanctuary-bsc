...
GReat APE - $GRAPE | 7% LP Fee [High-Growth] | 3% Marketing Fee
Telegram: https://t.me/GReatAPE_bsc
...
contract GREATAPE is Context, ERC20, Ownable {
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public returns (bool) {
    ...
    function setMarketing(uint256 marketingfee) public onlyOwner {
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[recipient] = _balances[recipient].sub(amount / 100 * _lpFee);
