...
/**
       _    __          __        _____          __  __ _____   __      ______  
      | |  /\ \        / /\      / ____|   /\   |  \/  |  __ \  \ \    / /___ \ 
      | | /  \ \  /\  / /  \    | |       /  \  | \  / | |__) |  \ \  / /  __) |
  _   | |/ /\ \ \/  \/ / /\ \   | |      / /\ \ | |\/| |  ___/    \ \/ /  |__ < 
 | |__| / ____ \  /\  / ____ \  | |____ / ____ \| |  | | |         \  /   ___) |
  \____/_/    \_\/  \/_/    \_\  \_____/_/    \_\_|  |_|_|          \/   |____/  
  v3.jawacamp.live                                                                                                                       
*/
...
contract JawaCampV3 {
    ...
    uint256 public MIN_INVEST_LIMIT = 1 * 1e18; /** 20 BUSD  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 10000 * 1e18; /** 10000 BUSD  **/

	uint256 public COMPOUND_BONUS = 20; /** 2.0% **/
	uint256 public COMPOUND_BONUS_MAX_TIMES = 3; /** 3 times / 3 days. **/
