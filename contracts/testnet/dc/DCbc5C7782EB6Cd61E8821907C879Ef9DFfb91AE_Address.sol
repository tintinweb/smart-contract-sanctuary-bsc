...
// !multiple spdx license identifers!
...
// File: contracts\SLEEPNNFT.sol

// contracts/SLEEPNNFT.sol
pragma solidity ^0.8.0;
/**
 * SLEEPN NFTs
 * @author SLEEPN
 */
contract SLEEPNNFT is ERC721Enumerable, Ownable {
    // base uri for nfts
    string private _buri;

    constructor() ERC721("SLEEPNNFT", "SNFT") {}
