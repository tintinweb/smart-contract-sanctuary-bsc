...
contract Stadium is Ownable, ERC721URIStorage {
    ...
    function buyNFPBox() public payable {
        ...
        require(_tokenIds.current() <= 100, "All NFTs are sold");
        require(msg.value == price, "Price is 0.01 BNB");
