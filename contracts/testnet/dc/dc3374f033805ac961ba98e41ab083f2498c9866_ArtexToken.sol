...
contract ArtexToken is ERC20, Ownable {
    ...
    address public liquidityWallet   = 0xfeE18f6FfbD10379Bf9F415E971E823460373050;
    address public marketingWallet   = 0xFeE2722c21d9069B05b555a49829Ec282a82B3c7;
    address public developmentWallet = 0xFee35605B32791aEFf86e24c7E515aBaa719E5be;
    ...
    uint256 private _timeAntiBot    = 180;
    uint256 private _botFeeIncrease = 5;
    ...
    function changeLiquidityWallet(address _liquidityWallet) external onlyOwner {
        ...
        require(!isContract(_liquidityWallet), "Liquidity wallet cannot be a contract");
    ...
    function setBotFeeMultiplicator(uint256 _value) external onlyOwner {
        require(_value <= 10 && _launchTime == 0, "Max value is 10, cannot be changed after launch");
        _botFeeIncrease = _value;
    }

    function setTimeAntiBot(uint256 _value) external onlyOwner {
        require(_launchTime == 0, "Cannot be changed after launch");
        _timeAntiBot = _value;
    }
