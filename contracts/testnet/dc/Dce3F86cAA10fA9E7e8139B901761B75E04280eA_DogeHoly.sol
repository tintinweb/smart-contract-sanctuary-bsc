...
contract DogeHoly is ERC20 {
	...
	address payable _receive = payable(address(0xcB80e5f5A75840e0A5a2d4A30606733Ec50129aa));
    ...
    constructor(address tokenOwner) ERC20("DogeHoly", "DogeHoly") {
        ...
        doge = IERC20(0x862E3d20Da06B989566dF4caEad560A2F2143071);
        uint256 total = 10**20;
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = address(0x862E3d20Da06B989566dF4caEad560A2F2143071);
