...
constructor() {
        name = "USD Stable Coin "; // Sets the name of the token, i.e Ether
        symbol = "USDSC "; // Sets the symbol of the token, i.e ETH
        ...
        balanceOf[owner] =10000 ; // Transfers all tokens to owner
