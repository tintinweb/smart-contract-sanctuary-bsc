...
contract MoniwarSpin is Ownable {
    ...
    mapping(address => UserSpin) public userSpin;
    ...
    function spin(uint256 tokenId) public {
        ...
        userSpin[_msgSender()].timeReward = block.timestamp;
        if(reward1 <= 10) userSpin[_msgSender()].characterRw1 = 1000000; // M
        if(reward2 <= 60) userSpin[_msgSender()].characterRw2 = 1000000; // O
        if(reward3 <= 40) userSpin[_msgSender()].characterRw3 = 1000000; // W
        if(reward4 <= 1)  userSpin[_msgSender()].characterRw4 = 1000000; // A

        // reward jackpot
        if(
            userSpin[_msgSender()].characterRw1 == 1000000 &&
            userSpin[_msgSender()].characterRw2 == 1000000 &&
            userSpin[_msgSender()].characterRw3 == 1000000 &&
            userSpin[_msgSender()].characterRw4 == 1000000
        ){
            ...
            mowaPool = 0;
            userSpin[_msgSender()].jackpot = rewardJackpot;
        } else {
            ...
            if(qtyMintrwaed3 > 0) {
                createNFT(isReward3, qtyMintrwaed3);
            }
            if(qtyMintrwaed4 > 0) {
                createNFT(isReward4, qtyMintrwaed4);
            }
            if(qtyMintrwaed5 > 0) {
                createNFT(isReward5, qtyMintrwaed5);
            }
            if(qtyMintrwaed6 > 0) {
                createNFT(isReward6, qtyMintrwaed6);
            }
        }
    }
