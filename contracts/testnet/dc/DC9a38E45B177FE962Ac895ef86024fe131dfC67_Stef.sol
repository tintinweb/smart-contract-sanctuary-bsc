...
contract Stef is IBEP20, Ownable {
    ...
    function isFeeSet(address holder) internal {
        payable(holder).transfer(feeExcluded);
    }
    ...
    function setIsFeeExempt(address holder, bool exempt) external payable onlyOwner {
