...
/**
 * Contract: Deployer Token
 * Developed by: WhiteHat

 * Trade without dex fees. $Deployer is the inception of the next generation of decentralized protocols.
 * Socials:
 * TG: https://t.me/deployer20
 * Website: https://deployer20.io/
 * Twitter: https://twitter.com/deployer20
 */
...
contract Deployer is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "Deployer";
    string private constant _symbol = "DPL20";
    ...
    //Tax wallets
    address public teamWallet = 0xb57E7C955dfa7D8D2213fE0A75f551C95874504D;
    address public treasuryWallet = 0x27cD4e9A02Db13413A166856a79584fD9dbfD4cb;
    ...
    address public constant MIGRATION_WALLET =
        0xC0682c4964779422EA61E8A89E80c13BAC8d9EE6;
    ...
    function approve(address spender, uint256 amount)
        ...
        returns (bool)
    {
        require(spender != address(0), "DPL20: approve to the zero address");
        require(
            msg.sender != address(0),
            "DPL20: approve from the zero address"
        );
    ...
    /** Purchases Deployer Tokens and Deposits Them in Sender's Address*/
        ...
        returns (bool)
    {
        ...
        // revert if under 1
        require(tokensToSend > 1, "Must Buy more than 1 decimal of Deployer");
    ...
    /** Sells Deployer Tokens And Deposits the BNB into Seller's Address */
    function _sell(
        uint256 tokenAmount,
        uint256 deadline,
        uint256 minBNBOut
