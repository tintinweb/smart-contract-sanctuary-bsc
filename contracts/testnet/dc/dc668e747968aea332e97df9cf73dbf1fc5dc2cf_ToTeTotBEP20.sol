...
abstract contract BEP20GlobalData is BEP20{
	string internal constant _name = "KangToT";
	string internal constant _symbol = "ToT";
...
abstract contract DEX is Ownable, BEP20Modifier{
	...
	function addLiquidity(uint256 amountWETH, uint256 amountToken) public payable 
		...
		returns(bool)
	{
		...
		require(amountWETH > 0, "weth amount must be higher than 0");
		bypassTax = true;
		router = DEXRouter02(adr_router);
