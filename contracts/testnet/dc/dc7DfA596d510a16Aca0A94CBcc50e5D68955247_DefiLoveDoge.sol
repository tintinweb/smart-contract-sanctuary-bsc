...
contract DefiLoveDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DefiLoveDoge";
    string private _symbol = "DLD";
    uint8 private _decimals = 9;
    address payable private marketingWalletAddress = payable(0x9AaD301dead8bE898f80C9ae5a3a7351D3993198); // Marketing Address
    address payable public teamWalletAddress = payable(0x9AaD301dead8bE898f80C9ae5a3a7351D3993198); // Team Address
