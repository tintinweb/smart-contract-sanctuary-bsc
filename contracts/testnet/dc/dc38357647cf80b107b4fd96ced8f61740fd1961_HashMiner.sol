...
// 30% Feedback Tax For claims made before 12 compounds
// Deposit min 1 FTM, max 3600 FTM
// Deposit min 0.01 BNB, max 10 BNB
// Deposit min 0.01 AVA, max 60 AVAX
...
contract HashMiner {
    ...
    uint256 public MIN_INVEST_LIMIT = 0.01 * 1e18;      /** 0.01 BNB  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 10 * 1e18;     /** 5 BNB  **/
