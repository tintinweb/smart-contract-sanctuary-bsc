...
contract DividendDistributor is IDividendDistributor {
    ...
    function setRewardtoken(address _rwrdtoken) external onlyToken {
        ...
        while (gasLeft > 0 && iterations < shareholderCount) {
            if (currentIndex >= shareholderCount) {
                currentIndex = 0;
            }
...
/* Token contract */
contract DoppelgangerCOIN is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address public RWRD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "DoppelgangerCOIN";
    string constant _symbol = "Doppelganger";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = (_totalSupply * 300) / 10000; // 3% on launch or 30k tokens
    uint256 public _maxSellTxAmount = (_totalSupply * 150) / 10000; // 1.5% or 15k tokens
    uint256 public _maxWalletToken = (_totalSupply * 300) / 10000; // 3% or 30k tokens
    ...
    constructor() Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xae7886175F583138E986491B84b4dCb9f115223d;
        devFeeReceiver = 0x11DC53aCCCb8A92749771A9723422E3EaF350054;
