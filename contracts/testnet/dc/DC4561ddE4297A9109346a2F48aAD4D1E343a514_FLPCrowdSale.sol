...
contract FLPCrowdSale is Ownable
{
    ...
    function buyTokenByBNB()external payable{
            ...
            // SafeERC20(msg.sender).transfer(msg.sender, amount);
    ...
    // Trường hợp tiền bị kẹt hay user chuyển tiền thẳng vào contract, thì owner rút ra
