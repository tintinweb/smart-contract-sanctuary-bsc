...
contract DEEPLaunchpad is ReentrancyGuard, Pausable, AccessControl {
    ...
    function buy(
        ...
        uint256 rate = getTokenRate(_pairToken).rate;
        ...
        deepToken.safeTransfer(address(deepLocker), _amount);
        ...
        whenNotPaused
    {
        ...
        require(_amount > 0, "Amount: non zero");
        require(
            deepToken.balanceOf(msg.sender) >= _amount,
            "Token: your balance not enough"
        );
        require(
            getTokenRate(_pairToken).isExist == true,
        ...
        deepToken.safeTransferFrom(msg.sender, address(this), _amount);
        pairToken.safeTransfer(msg.sender, amount);
        ...
        whenNotPaused
    {
        ...
        pairToken.safeTransfer(msg.sender, _amount);
    }
}
