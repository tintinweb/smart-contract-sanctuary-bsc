...
contract VIPMO is Ownable {
	...
	constructor(address _dev, address _mark, address _ba) {		
	...
	function payFeesInv(uint _amount) internal {
		...
		uint toValue = _amount.div(4);
		transferHandler(devAddress, toValue.mul(2));
		transferHandler(marketingAddress, toValue);
