...
contract FLCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x40137B8D8289c014ffd2a3b65b46635F58340e91); // Marketing Address
    ...
    string private _name = "FLCoin";
    string private _symbol = "FL01";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x40137B8D8289c014ffd2a3b65b46635F58340e91);
    }
