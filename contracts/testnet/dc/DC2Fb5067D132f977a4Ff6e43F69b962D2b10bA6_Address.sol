...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x97Ea4C3f13cbe46C11Ef14be42c05971D2695cf3;
...
contract HinuInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 600000000 * 10**6;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Hinu Inu";
    ...
    uint256 public _maxTxAmount = 600000000 * 10**6;
    uint256 private numTokensSellToAddToLiquidity = 600000000 * 10**6;
