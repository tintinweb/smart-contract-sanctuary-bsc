 ...
 *Submitted for verification at BscScan.com on 2022-03-05
 https://bscscan.com/address/0x88ca5e4079fc55a094f765f256a5e7bdbaeefcbf#code
*/

/**
Dont Snipe This Or You Will Be Rekt!
TG @ MoonKatzBSC                                                                                       
*/
...
contract MoonKatz is IERC20 {
    ...
    uint256 private constant startingSupply = 1_000_000_000_000; //TODO

    uint8 private _decimals = 9; //TODO
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "Test Moon Katz2"; //TODO
    string constant _symbol = "MKT2"; //TODO
    ...
    // PCS ROUTER
    address private _routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;// Test Net one instead 0x10ED43C718714eb63d5aA57B78B54704E256024E 
    ...
    address payable private _marketingWallet = payable(0x3C0feFf95DaEeC137f238A213b46457242Ba3202); //TODO
    address payable private _buybackWallet = payable(0x3C0feFf95DaEeC137f238A213b46457242Ba3202); //TODO

    
    uint256 private maxTxPercent = 8000; //TODO
    ...
    uint256 private maxWalletPercent = 8000; //TODO
    ...
    constructor (uint256 _snipeBlockAmt, address cInitializer) payable {
        ...
        _isFeeExcluded[0x54F1a7B062A0abaC7d7565fD0a112AFC28728584] = true;      //TODO PUT OWNER for now PINKSALE ADDRESS via contract
        _isDividendExcluded[0x54F1a7B062A0abaC7d7565fD0a112AFC28728584] = true; //TODO PUT OWNER for now  PINKSALE ADDRESS - when creating pre-sale, you will get presale address - just need to include it in the contract
