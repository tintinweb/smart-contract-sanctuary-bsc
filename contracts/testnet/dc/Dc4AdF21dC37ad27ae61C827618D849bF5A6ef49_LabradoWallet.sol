...
contract LabradoWallet is Ownable, IERC721Receiver {
    ...
    event TokenWithdrewByOwner(address indexed to, uint256 value);
    event CoinWithdrewByOwner(address indexed to, uint256 value);
    event CoinDeposited(address indexed from, uint256 value);
    event SignerUpdated(
