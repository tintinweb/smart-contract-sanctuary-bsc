...
// File: contracts/interfaces/IwateenSwapLottery.sol
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public wateenSwapLottery;
     ...
     * @param _seed: seed provided by the wateenSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == wateenSwapLottery, "Only wateenSwapLottery");
    ...
    /**
     * @notice Set the address for the wateenSwapLottery
     * @param _wateenSwapLottery: address of the wateenSwap lottery
     */
    function setLotteryAddress(address _wateenSwapLottery) external onlyOwner {
        wateenSwapLottery = _wateenSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IwateenSwapLottery(wateenSwapLottery).viewCurrentLotteryId();
    }
}