...
contract ETokenProxy is ETokenAdminStorage, TokenErrorReporter  {
    
    bytes32 private constant _IMPLEMENTATION_SLOT = 0x360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc;

    /**
      * @notice Emitted when EBep20/EBNB is accepted, which means EToken implementation is updated
      */
    ...
    /**
    * @notice Sets new implementation of EBep20/EBNB. msg.sender must be admin
    ...
    */
    function _setImplementation(address newImplementation) public returns (uint) {
        if (msg.sender != admin) {
            return fail(Error.UNAUTHORIZED, FailureInfo.SET_ETOKEN_IMPLEMENTATION_OWNER_CHECK);
        }
        ...
        emit NewImplementation(oldImplementation, tokenImplementation);
