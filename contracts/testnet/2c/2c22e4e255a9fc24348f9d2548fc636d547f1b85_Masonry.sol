...
contract Masonry is ShareWrapper, ContractGuard {
    ...
    function getTangerinePrice() external view returns (uint256) {
        return treasury.getTangerinePrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            tangerine.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        tangerine.safeTransferFrom(msg.sender, address(this), amount);
