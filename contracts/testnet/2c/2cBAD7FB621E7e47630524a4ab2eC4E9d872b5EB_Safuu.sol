...
contract Safuu is ERC20Detailed, Ownable {
    ...
    uint256 private constant MAX_SUPPLY = 210000 * 10**6 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Safuu", "SAFUU", uint8(DECIMALS)) Ownable() {
        ...
        treasuryReceiver = 0x4B7Fd1771C8E479348ADF87a2aebE57162469FC0; 
        autoLiquidityReceiver = 0x4C9d56329bf90fcd551568b1F4544fCdb6471c7B;
        safuuInsuranceFundReceiver = 0x9cce34F7aB185c7ABA1b7C8140d620B4BDA941d6;
    ...
    function rebase() internal {
        ...
        if (deltaTimeFromInit < (1 days)) {
            ...
            rebaseRate = 627546;
        } else if (deltaTimeFromInit >= ((2 * 1 days) / 1)) {
            rebaseRate = 125509;
        } else if (deltaTimeFromInit >= (3 * 1 days)) {
            rebaseRate = 18826;
        } else if (deltaTimeFromInit >= (4 days)) {
            rebaseRate = 1882;
        } else if (deltaTimeFromInit >= (5 days)) {
            rebaseRate = 94;
        }
