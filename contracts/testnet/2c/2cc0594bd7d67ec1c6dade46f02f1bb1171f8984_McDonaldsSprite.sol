...
contract McDonaldsSprite is IBEP20, Auth {
    ...
    string constant _name = "McDonalds Sprite";
   ...
   // uint256 private _Maxtx = _totalSupply.div(1);
    ...
    address public marketingFeeReceiver = 0x21AFbcb5ea5A9B0D9e71fF8e3d372804ac238fe6;
    address public devFeeReceiver = 0x27f0e47524b3C6e349955B117e98Fdd105c51907;
  ...
  //  }
    function setSwapBackEnabled(bool _enabled) external authorized {
        swapEnabled = _enabled;
        
    }

      function setSwapBackSetThreshold(uint256 _amount) external authorized {
