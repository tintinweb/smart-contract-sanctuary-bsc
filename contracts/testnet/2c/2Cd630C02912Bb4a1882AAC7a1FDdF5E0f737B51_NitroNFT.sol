...
/// @author NitroLeague.
contract NitroNFT is ERC721Enumerable, Ownable {
    ...
    // function setTokenURI(uint256 tokenId, string memory uri) external onlyOwner returns (string memory) {
    //     require( _exists(tokenId), "URI query for nonexistent token" );
    //     super._setTokenUri(tokenId, string.concat(baseURI,uri));
