...
contract SRV is ERC20, AccessControl {
  ...
  address private feeRecipient; // Taxes are sent to this address // TODO: This was payable, should it be?
  ...
  bool private isTestnet; // The order of tokens of the BNB/BUSD pair is not the same on mainnet & testnet
  ...
  function _processFeeBalance() internal {
    ...
    // TODO: Test. This was the other way around.
  ...
  function getSrvPriceInUsd() public view returns (uint256) {
    ...
    uint256 bnbToBusdReserves;
    uint256 busdToBnbReserves;

    (uint256 reserve0, uint256 reserve1, ) = pancakeBnbBusdPair.getReserves();

    if (isTestnet) {
      bnbToBusdReserves = reserve1;
      busdToBnbReserves = reserve0;
    } else {
      bnbToBusdReserves = reserve0;
      busdToBnbReserves = reserve1;
    }
