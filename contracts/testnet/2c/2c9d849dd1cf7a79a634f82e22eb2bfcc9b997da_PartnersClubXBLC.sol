...
contract PartnersClubXBLC is Ownable, ReentrancyGuard {
    ...
    uint pay1 = msg.value * 1 /100;
    uint pay2 = msg.value * 1 /100;
    uint pay3 = msg.value * 1 /100;
    uint pay4 = msg.value * 1 /100;
    uint pay5 = msg.value * 1 /100;
    uint pay6 = msg.value * 1 /100;
    uint pay7 = msg.value * 1 /100;
    uint pay8 = msg.value * 1 /100;
    uint pay9 = msg.value * 1 /100;
    uint pay10 = msg.value * 1 /100;
    ...
    function stakingInitial(address _referrer) public payable nonReentrant returns (bool) {
        ...
        infoVesting[msg.sender].firstBalance = 6000000*10**18;
