...
contract gameOperation{
    ...
    function setTheGame() external onlyOperator{
        ...
        trdcGame.addBank("Bank of America", 3, 1000);
        trdcGame.addBank("National Bank", 3, 1000);
        trdcGame.addBank("China Bank", 1, 1000);
        trdcGame.addBank("Bank Of Egypt", 2, 1000);
        trdcGame.addBank("Bank of Madrid", 10000, 6000);
        trdcGame.addBank("France Bank", 10000, 6000);
        trdcGame.addBank("Bank Of Beirut", 10000, 6000);
