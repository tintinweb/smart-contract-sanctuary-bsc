...
contract MasterKey1_3 is ERC721A, Ownable,Pausable,IMK {
 IContracts_TITIMITI Contr;
   ...
   string private URL;
    ...
    constructor( ) ERC721A("MasterKey1_3 - NFT by TITIMITI", "MK1_3", 10, 500000) {
    ...
    function MINT_Price_MasterKey_1_3 (address adr, uint256 amount)  public  {
    ...
    function SkillUP_1_3 (uint256 ID)  public {
        address sender =msg.sender;
    ...
    function WearUP_1_3 (uint256 ID, uint256 num_RepairKit) public {
         address sender =msg.sender;
        skillUP_c.GNFTtrans(num_RepairKit,sender);
        Wear[ID] = Wear[ID] + skillUP_c.GetWearPlus(num_RepairKit);
    }

    function OpeningMasterKey_1_3 (uint256 ID, uint256 ChestLevel_) public {
