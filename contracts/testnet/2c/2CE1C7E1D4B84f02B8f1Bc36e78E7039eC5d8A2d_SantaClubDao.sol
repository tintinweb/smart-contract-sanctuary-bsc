...
contract SantaClubDao is Ownable {
    ...
    constructor() {
        tokenCustody = ITokenCustody(
            0xDe103B47e1dd24a7e2D12421DE7CEC6fE3465C54
        );
        staking = ISantaClubStaking(0xa89990154cd2e4c580eeB571908700b7419dA09F);
    ...
    // Allows a token holder to submit a proposal to vote on
