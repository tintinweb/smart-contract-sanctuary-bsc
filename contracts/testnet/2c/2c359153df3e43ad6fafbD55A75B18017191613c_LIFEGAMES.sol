...
contract LIFEGAMES is ERC20Upgradeable {
    ...
    function setTaxes(uint16 distributionToHoldersFee, uint16 liquidityFee, uint16 buyBackFee, uint16 busdReserveFee) external onlyOwner {
        ...
        require(buyBackFee <= 300, "buyBackFee EXCEEDED 3%");
        require(busdReserveFee <= 300, "busdReserveFee EXCEEDED 3%");

          // check max fee dont be higer than 3%
        require((distributionToHoldersFee + liquidityFee + buyBackFee + busdReserveFee) <= 300, "MAX TOTAL BUY FEES EXCEEDED 3%");
...
*/
    ...
    function swapTokensForBUSD(uint256 tokenAmount) private {
        ...
        IERC20(busdAddress).approve(address(dexRouter), tokenAmount);
    ...
    function sendToPools() internal {
        ...
        busd.transfer(busdBuyBurnAddress, busdTokensToBuyBurnAmount);
