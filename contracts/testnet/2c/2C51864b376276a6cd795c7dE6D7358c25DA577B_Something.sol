...
contract Something is IERC20, Ownable {
    ...
    constructor () {
        ...
        globalLimit = 0.00001 ether;
        globalLimitPeriod = 5 minutes;
        limitsActive = true;
    ...
    function balanceOf(address account) public view override returns (uint256) {
        if (account == burnWallet) return 0;
    ...
    function _transfer(
        ...
        require(!botWallet[from] && !botWallet[to], "Bot wallets not allowed");
        checkLiquidity();
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        uint256 taxedAmount = amount * (_feeDenominator - _taxFee - _liquidityFee - _marketingFee - _burnFee) / _feeDenominator;
        _handleLimited(sender, recipient, taxedAmount);
