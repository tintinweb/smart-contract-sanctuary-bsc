...
contract BWGToken is ERC777, Ownable {
    ...
    function setManager(address _sender) external onlyOwner {
        _ERC1820_REGISTRY.setManager(address(this), _sender);
    }

    /**
     * @dev See {ERC777-revokeOperator}.
     */
