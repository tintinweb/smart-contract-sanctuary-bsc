...
contract sexx is Context, IERC20, Ownable {
    ...
    function deactivate() external onlyOwner{
        require(antiwhale == true, "Já está desativado");
        antiwhale = false;

    }

    function active() external onlyOwner{
        require(antiwhale == false, "Já ativado");
        antiwhale = true;
      
    }
    
    function approve(address spender, uint256 amount) public override returns (bool) {
        require(antiwhale == true);
