...
contract ERC20Token is Context, IERC20, Ownable 
{
    ...
    string private _name = "Muhammad Hanan";
    string private _symbol = "MH";
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private 
    {
        ...
        if(burnTokens>0) {  _transferStandard(sender, deaddAddress, burnTokens); }
        restoreAllFee();
    }
    ...
    function setAllFeePercentages(uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) 
    external onlyOwner()
    {
