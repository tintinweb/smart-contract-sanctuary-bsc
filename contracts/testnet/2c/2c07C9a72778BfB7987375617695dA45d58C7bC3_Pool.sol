...
contract Pool is Ownable, Vesting {
  ...
  */
  ...
  XpToken private XPToken = XpToken(0x393F4e3D0f50A6dEB3900842365AD896e0f99266);
 ...
 */
  ...
  */
  function buyTickets(uint256 _bracketNumber)
    ...
    _isPoolActive
  {
    require(lotteryStatus == LotteryStatus.STARTED, "lottery not created");
  ...
  */
  function drawWinners(string memory _seed) public onlyOwner {
    ...
    require(lotteryStatus == LotteryStatus.STARTED, "lottery has not started");
  ...
  */
  function claimBackBUSD() public {
    ...
    require(
      !investorsInfo[msg.sender].lotteryWon,
    ...
    require(
      lotteryStatus == LotteryStatus.FINISHED,
      "lottery has not been finished yet"
    );
  ...
  */
  ...
  /**
    @notice function for testing purpose
  */
  function setXPandBUSD(XpToken _xpToken, IERC20 _busd) public onlyOwner {
    XPToken = _xpToken;
    BUSD = _busd;
  }
}
...
contract XpToken is ERC20, AccessControl {
  ...
  function addMinter(address _minter) public onlyRole(OWNER_ROLE) {
    require(isContract(_minter), "minter should be a contract");
    _setupRole(MINTER_ROLE, _minter);
  }

  function removeMinter(address _minter) public onlyRole(OWNER_ROLE) {
...
contract Vesting {
  ...
  */
  function initVestingStages() internal {
    ...
    stages.push(VestingStages(claimTime + 5 * vestingPeriod, 10000));
  }
  ...
  */
  ...
  /**
    ...
    @param claimedStage stage from which the tokens have been claimed (0, 1, 2 ...)
