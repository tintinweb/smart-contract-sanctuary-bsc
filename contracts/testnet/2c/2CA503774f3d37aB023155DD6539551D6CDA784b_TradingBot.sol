...
contract TradingBot is Operator { // Where the actual contract for the trading bot starts. anything above that are just libraries.
    ...
    function arb(address _fromToken,address[] memory _paths, uint256 _fromAmount, uint256 gasFee) onlyOperator external {
        ...
        _trade(_fromToken, _paths, _fromAmount);
    ...
    function _trade(address _fromToken, address[] memory _paths, uint256 _fromAmount) internal {
