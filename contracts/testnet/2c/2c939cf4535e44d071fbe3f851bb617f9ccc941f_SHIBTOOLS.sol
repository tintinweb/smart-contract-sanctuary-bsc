...
// File: contracts/SHIBTool.sol



/*
https://t.me/shibtools_io
https://shibtools.io
*/
...
contract SHIBTOOLS is Context, IERC20, Ownable {
    ...
    string private constant _name = "SHIBTOOLS";
    ...
    function openTrade(uint256 botBlocks) external onlyOwner() {
        launchEpoch = block.timestamp.add(botBlocks);
        launched = true;
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            require(launched);
            if(block.timestamp < launchEpoch) {
                buyFee.liquidity = 45;
                buyFee.marketing = 45;
                sellFee.liquidity = 45;
                sellFee.marketing = 45;
            } else {
                buyFee.liquidity = 1;
                buyFee.marketing = 4;
                sellFee.liquidity = 1;
