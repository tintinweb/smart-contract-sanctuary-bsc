...
contract Aimedis is LERC20, Ownable {
    ...
    constructor(uint256 totalSupply_, string memory name_, string memory symbol_, address admin_, address recoveryAdmin_, uint256 timelockPeriod_, address lossless_) LERC20(totalSupply_, name_, symbol_, admin_, recoveryAdmin_, timelockPeriod_, lossless_) {
        ...
        operationsAddress = address(0xdc976a15e3929759df943544c918B4E2A68C3F9e); // update
        devAddress = address(0xA1B729591c2fcC1f3286013620b1D055A3006Ab1); // update 
        liquidityAddress = address(0xA1B729591c2fcC1f3286013620b1D055A3006Ab1); // update
    ...
    function updateMaxSellAmount(uint256 newNum) external onlyOwner {
        require(newNum >= 50000 * 1e18, "Cannot set max sell amount lower than 0.1%");
    ...
    function updateExtraTax(uint256 _extraTax) external onlyOwner {
        extraTax = _extraTax;
        require(extraTax <= 2000, "Must keep extra tax at 10% or less");
    }
