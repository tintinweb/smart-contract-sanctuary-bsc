...
contract KALISSA is ERC20, Ownable {
    ...
    constructor (address newOwner ) payable ERC20("KALISSA","KALI",15_000_000_000_000_000) 
    {   
        ...
        liquidityShare  = 50;
        marketingShare  = 50;
        marketingWallet = 0xB828b4B5dE5ca744688d6F7fe27310Ac621aEa0b;
        ...
        require(buyFee <= 10 && sellFee <= 10, "Fees must be less than 25%");
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee <= 10 && _sellFee <= 10, "Fees must be less than 25%");
        buyFee = _buyFee;
        sellFee = _sellFee;
