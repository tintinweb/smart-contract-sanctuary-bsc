...
contract sponsor is Context,IERC20Metadata {

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    //mainnet: 
    string private constant _name = "sponsorLP";
    //mainnet: 
    string private constant _symbol = "SLP";
     // LP池
   uint256 public _sponsorSupply = 21450000 * 1e18;
    ...
    constructor(){
        ...
        _balances[msg.sender] = _sponsorSupply;
        emit Transfer(address(0), msg.sender, _sponsorSupply);
    }
    ...
    function totalSupply() public view override returns (uint256) {
        return _sponsorSupply;
    }
  function sponsorSupply() public view  returns (uint256) {
        return _sponsorSupply;
    }
