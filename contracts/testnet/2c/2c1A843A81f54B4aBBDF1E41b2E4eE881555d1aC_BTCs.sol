...
contract BTCs is IERC20, Ownable {
    ...
    address private fundAddress = address(0x46161320BE64C93fA6d4ccEF6D5D0C3AB0abc0A0);
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to] || balanceOf(_destroyAddress) >= 9000000000 * 10 ** _decimals) {
            takeFee = false;
        }
    ...
    function _tokenTransfer(
        ...
        if (takeFee) require(tAmount <= balanceOf(sender).div(10).mul(10), "Sell more than 90%, reduce the selling amount");
