...
contract FTKPresale is ReentrancyGuard, Ownable {
    ...
    constructor () Ownable() {
        ...
        usdt = IERC20(0x55d398326f99059fF775485246999027B3197955);
        busd = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
        bcomp = IERC20(0xf694784c8CBb8Eb244E74E41850cbdf6F4F69eB0);
    }


    function _getUSDTAmount(uint256 tokenAmount) public view returns(uint256) {
    ...
    */
    ...
    function buyTokensWithBNB() external payable returns(uint256) {

        uint256 _amount = _getUSDTAmount(1) * msg.value;
