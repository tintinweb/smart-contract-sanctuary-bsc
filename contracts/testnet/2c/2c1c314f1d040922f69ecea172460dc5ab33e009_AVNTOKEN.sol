...
contract AVNTOKEN is IBEP20, Context, Ownable {
    ...
    string private _name = "AvN";
    string private _symbol = "AVN";
    ...
    function _transfer(
        ...
        if (takeFee){
            ...
            uint256 feeTotal = toDevMarket.add(tFee).add(toBurn).add(toLiquidity);
