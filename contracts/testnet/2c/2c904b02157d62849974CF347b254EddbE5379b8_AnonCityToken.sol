...
contract AnonCityToken is Initializable, ERC20Upgradeable {
    ...
    address public marketingAddress1; // fee wallet address
    address public marketingAddress2; // fee wallet address
    address public marketingAddress3; // fee wallet address
    ...
    uint256 marketingAddress1Percent;
    uint256 marketingAddress2Percent;
    uint256 marketingAddress3Percent;
...
// 0x23E87E1793B17725a0c241b659A3b5fb89aE4914 remember to remove liq 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    ...
    function initialize() public initializer {
       ...
       __ERC20_init("AnonCityToken", "ACT");
        ...
        // marketing address
        marketingAddress = 0xc985E87686bfC6E3d30C2af49cDc08B487C46491;
        marketingAddress1 = 0xc985E87686bfC6E3d30C2af49cDc08B487C46491;
        marketingAddress2 = 0xc985E87686bfC6E3d30C2af49cDc08B487C46491;
        marketingAddress3 = 0xc985E87686bfC6E3d30C2af49cDc08B487C46491;
        ...
        marketingAddressPercent = 700; //7%
        marketingAddress1Percent = 700; //7%
        marketingAddress2Percent = 700; //7%
        marketingAddress3Percent = 700; //7%
    ...
    function swapAndLiquify(uint256 tokenAmount,uint256 liquidityToken) internal swapping  {
        ...
        uint256 mktShare = (currentBalanceBUSD * marketingAddressPercent) / _feesRates;
        IERC20Upgradeable(BUSD).transfer(marketingAddress, mktShare);
        
        _addLiquidity(liquidityToken,currentBalanceBUSD - mktShare);
