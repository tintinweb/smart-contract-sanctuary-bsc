...
contract HTCToken is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    function random(uint256 _NumberOfLotteryEligibles) internal view returns(uint256){
    return uint256(keccak256(abi.encodePacked(block.timestamp, msg.sender))) % _NumberOfLotteryEligibles;
}
