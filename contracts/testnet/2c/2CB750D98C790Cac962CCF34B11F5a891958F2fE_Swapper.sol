...
contract Swapper is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function updateVariablesFromInfinityToken() public {
        ...
        extraSellFee = infinityToken.extraSellFee();
    }
    ...
    function _buyChecks() internal view {
        ...
        require(
            getContractsPSTNBalance().add(getUsersPSTNBalance()) <=
                maxWalletBalance,
    ...
    function _takeFees() internal {
        ...
        //calculate fees
        uint256 feesToDeduct = getContractsPSTNBalance()
            .mul(totalFees.add(extraSellFee))
            .div(100);
    ...
    function swapBUSDForTokens(uint256 busdAmount) public {
        ...
        //send to user
        infinityToken.transfer(msg.sender, getContractsPSTNBalance());
    }
    ...
    {
        return (maxWalletBalance, totalFees, extraSellFee);
    }
}
