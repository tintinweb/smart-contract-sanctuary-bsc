...
contract Test is  ERC20 {
    ...
    function get_Realease_Time(address caller) public view returns(uint)
    {  
        require( _contractLink[caller] != newContract ,"No link between acoounts found" );
        return _contractLink[caller].get_realeaseTime();
    }
    ...
    function showBalance_locked() public view
    {
        ...
        require( _contractLink[caller] != newContract ,"No link between acoounts found" );
        _contractLink[caller].showBalance_locked(caller);
    }
