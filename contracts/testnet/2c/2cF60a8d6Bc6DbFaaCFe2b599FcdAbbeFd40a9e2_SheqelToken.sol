...
contract HolderRewarderDistributor is Structures {
    ...
    constructor(address _router, address _reserve, address _deployer, int _amount) {
...
contract SheqelToken is Context, IERC20, IERC20Metadata {
    ...
    uint256 public currentSqlToLiquidity;
    ...
    constructor(address _reserveAddress, address _MDOAddress, uint256 _tSupply, address _spookyswapAddress, address _USDCAddress) {
        ...
        currentSqlToLiquidity = 0; // To remove
    ...
    function _transfer(
        ...
        if(recipient != uniswapV2Pair/*!liqTransaction*/ && recipient != reserveAddress){
    ...
    function initiateLiquidityProviding() public {
        swapAndLiquify(currentSqlToLiquidity);
    }
    ...
    function swapTokensFor(uint256 tokenAmount) private {
        ...
        uniswapV2Router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            tokenAmount,
            0, // accept any amount of ETH ! TODO: NEEDS TO BE CHANGED
            path,
            address(this),
            block.timestamp
        );
