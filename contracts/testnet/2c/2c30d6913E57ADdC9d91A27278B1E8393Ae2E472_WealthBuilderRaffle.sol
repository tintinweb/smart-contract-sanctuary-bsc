...
contract WealthBuilderRaffle is Context, Ownable , ReentrancyGuard  {
    address public owner1 = 0x2547c7da46017b7caa3386ffeF04F62Bb4b4e73b;
    address public owner2 = 0xA3D149f796850468206bC211152d80E53f17e5C6;
    ...
    function pickWinner_lotto1() public {
        ...
        BusdInterface.transfer(owner1,devFee*4/10);
        BusdInterface.transfer(owner2,devFee*4/10);
        BusdInterface.transfer(dev,devFee*2/10);
