...
contract FuckTheWorldCup is Context, BEP20, Ownable {
    ...
    string private constant _name = unicode"Fuck The World Cup"; // 
    string private constant _symbol = unicode"FTWC"; //    
    ...
    function updateBuyFees(uint256 _NewliquidityFee, uint256 _NewmarketingFee) public onlyOwner {
