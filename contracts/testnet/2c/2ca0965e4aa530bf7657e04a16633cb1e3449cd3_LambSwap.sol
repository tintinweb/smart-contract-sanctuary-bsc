...
contract BEP20 is Context, IBEP20, Ownable {
    uint256 private constant _preMineSupply = 39000000000 * 1e18;
    uint256 private constant _maxSupply = 500000000000 * 1e18; 
...
// LambSwap token with Governance.
contract LambSwap is BEP20('LambSwap Token', 'LST') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying LSTs (not scaled);
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "LST: _addMinter is the zero address");
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "LST: _delMinter is the zero address");
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getMinterLength() - 1, "LST: index out of bounds");
