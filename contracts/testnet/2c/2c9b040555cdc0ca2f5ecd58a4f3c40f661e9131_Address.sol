...
// this a demon NFT
contract HEROCATNFT is ERC721Enumerable, Ownable {
    ...
    function setLaunchpad(address addr) public  onlyOwner{
        LAUNCHPAD = addr;
    }
    // end
    ...
    function batchTransfer(address to,uint256 startTokenId, uint count) external {
        require(to != address(0), "can't mint to empty address");
