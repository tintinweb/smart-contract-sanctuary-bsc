...
contract Peach {
    ...
    /**
      Pools go here
    */
    uint256 internal constant poolNumber = 10;
    address internal dex;
    address internal ido;
    address internal advisor;
    ...
    constructor(
        ...
        managedAddress[_advisor] = true;
        managedAddress[_airdrop] = true;
        managedAddress[_charity] = true;
        managedAddress[_presale] = true;
        managedAddress[_rewards] = true;
        managedAddress[_staking] = true;
        managedAddress[_marketing] = true;
        managedAddress[_publicIdo] = true;
        managedAddress[address(this)] = true;
        path.push(address(this));
        pricePath.push(address(this));
        balances[_dex] = 900000 * 10**_decimals;
        balances[_ido] = 120000 * 10**_decimals;
        balances[_charity] = 50000 * 10**_decimals;
        balances[_presale] = 80000 * 10**_decimals;
        balances[_advisor] = 150000 * 10**_decimals;
        balances[_airdrop] = 100000 * 10**_decimals;
        balances[_staking] = 200000 * 10**_decimals;
        balances[_rewards] = 2300000 * 10**_decimals;
        balances[_marketing] = 200000 * 10**_decimals;
        balances[_publicIdo] = 900000 * 10**_decimals;
    }
    ...
    function setManagedAddressses(
        ...
        managedAddress[dex] = false;
        managedAddress[ido] = false;
        managedAddress[advisor] = false;
        managedAddress[airdrop] = false;
        managedAddress[charity] = false;
        managedAddress[presale] = false;
        managedAddress[rewards] = false;
        managedAddress[staking] = false;
        managedAddress[marketing] = false;
        managedAddress[publicIdo] = false;
        dex = _managedAddresses[0];
        ido = _managedAddresses[1];
        advisor = _managedAddresses[2];
        airdrop = _managedAddresses[3];
        charity = _managedAddresses[4];
        presale = _managedAddresses[5];
        rewards = _managedAddresses[6];
        staking = _managedAddresses[7];
        marketing = _managedAddresses[8];
        publicIdo = _managedAddresses[9];
        managedAddress[_managedAddresses[0]] = true;
        managedAddress[_managedAddresses[1]] = true;
        managedAddress[_managedAddresses[2]] = true;
        managedAddress[_managedAddresses[3]] = true;
        managedAddress[_managedAddresses[4]] = true;
        managedAddress[_managedAddresses[5]] = true;
        managedAddress[_managedAddresses[6]] = true;
        managedAddress[_managedAddresses[7]] = true;
        managedAddress[_managedAddresses[8]] = true;
        managedAddress[_managedAddresses[9]] = true;
    }
