...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
	...
	address private _BNBAddress = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;  // Testnet: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd  Mainnet:  0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
...
contract DogeRoulette is Ownable, ERC20 {
	...
	uint256 public minimumTokensBeforeSwap = initialSupply / 1000;
	...
	CustomTaxPeriod private _launch1 = CustomTaxPeriod('launch1',0,0,2,2,3,3,5,5);


	// Base taxes
	CustomTaxPeriod private _default = CustomTaxPeriod('default',0,0,2,2,3,3,5,5);
	CustomTaxPeriod private _base = CustomTaxPeriod('base',0,0,2,2,3,3,5,5);
	...
	constructor() ERC20(_name, _symbol) {
		//DOGE
		dividendTokens.push(address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684)); 
		//MainNet  0xbA2aE424d960c26247Dd6c32edC70B295c744C43
		//TestNet  0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684

		//Shib
		dividendTokens.push(address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7)); 
		//MainNet  0x2859e4544C4bB03966803b044A93563Bd2D0DD4D
		//TestNet  0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7

		//BabyDoge
		dividendTokens.push(address(0x8BaBbB98678facC7342735486C851ABD7A0d17Ca)); 
