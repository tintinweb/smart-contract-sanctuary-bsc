...
// File contracts/ManagerLiquidity.sol

contract ManagerLiquidity is AccessControl {
    ...
    constructor (address _usdt) {
        ...
        _grantRole(LIQUIDITY_ROLE, 0x538935d9bd028bF29D4c3B6BDd5AA02D885D59e2);
    }

    function removeLiquidity(address account, uint256 amount) public onlyRole(LIQUIDITY_ROLE) {
        require(IERC20(USDT).balanceOf(address(this)) >= amount, "token balance not enough");
