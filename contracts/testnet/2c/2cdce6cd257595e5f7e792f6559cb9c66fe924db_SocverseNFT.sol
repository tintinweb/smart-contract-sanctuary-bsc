...
contract SocverseNFT is ERC721Enumerable, ReentrancyGuard, Ownable {
    using Strings for uint256;
    
    uint public totalMinted = 0;
    uint public LIMIT_BATCH_MINT = 100;
    ...
    function mint(uint _quantity) public onlyOwner {     
        require(_quantity <= LIMIT_BATCH_MINT, "Quantity Exceeded Limit");
    ...
    constructor() ERC721("Socverse NFT", "SOCNFT") Ownable() {}
}