...
contract MetarixContract is Ownable {
  ...
  uint256 public immutable bnbPriceInDollar; // bnb price in dollar
  ...
  // CONSTRUCTOR  
  constructor(uint _maxCap, uint256 _saleStartTime, uint256 _saleEndTime, uint256 _bnbPriceInDollar, address payable _projectOwner) public {
    require(_maxCap != 0, "_maxCap should not equal to 0!");
    maxCap = _maxCap*10**18;
    saleStartTime = _saleStartTime;
    saleEndTime = _saleEndTime;    
    bnbPriceInDollar = _bnbPriceInDollar; 
