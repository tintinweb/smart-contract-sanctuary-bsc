...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'7bdf0ff47b0c84fdb3b08e7a2e14106be8533a053d4e557bf15455c1d8bac3e3'   // Change to INIT_CODE_PAIR_HASH of Pancake Factory
            ))));
    }
...
contract PancakeRouter01 is IPancakeRouter01 {
    ...
    constructor() public {
        factory = address(0x61B741c172E0bF8dF9E7eA3f4823afDc384a94e7);
