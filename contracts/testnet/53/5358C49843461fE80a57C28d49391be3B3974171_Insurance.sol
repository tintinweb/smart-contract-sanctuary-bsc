...
contract Insurance is Ownable {
    ...
    **/
    ...
    // event ECancleStateInsurance(uint256 idInsurnace);
        ...
        returns (InsuranceStruct memory)
    {
        ...
        require(
            busd.balanceOf(address(msg.sender)) >= _margin,
        ...
        busd.transferFrom(msg.sender, admin, _margin);
    ...
    // function cancleInsurance(uint256 _idInsurance) external returns (bool) {
    //     address owner = insurance[_idInsurance].buyer;
    ...
    //     insurance[_idInsurance].state = "Cancle";
    //     insurance[_idInsurance].recognition_date = block.timestamp;

    //     emit ECancleStateInsurance(_idInsurance);
