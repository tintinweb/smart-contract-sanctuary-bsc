...
contract TEST is Ownable, ERC721, NonblockingReceiver {
 ...
 uint256 nextTokenId = 9110;
 uint256 MAX_MINT_BNB = 9332;
 ...
 require(nextTokenId + numTokens <= MAX_MINT_BNB, "SUPPLY LIMIT REACHED!");
