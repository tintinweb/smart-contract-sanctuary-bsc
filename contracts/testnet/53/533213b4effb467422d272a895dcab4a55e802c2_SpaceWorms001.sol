...
contract SpaceWorms001 is ERC721, Ownable {
    ...
    {
		require(balanceOf(msg.sender) <= 5, 'Cada address solo puede tener hasta dos NFT');
        require((_tokenIdCounter.current() + numberOfTokens) < 21, 'Se han minteado todos los NFT');
