...
import {IOceanDriveGovernanceV2} from '../interfaces/IOceanDriveGovernanceV2.sol';
import {SafeMath} from '../open-zeppelin/SafeMath.sol';

/**
 * @title Time Locked Executor Contract, inherited by OceanDrive Governance Executors
...
contract ExecutorWithTimelock is IExecutorWithTimelock {
   ...
   **/
  function isProposalOverGracePeriod(IOceanDriveGovernanceV2 governance, uint256 proposalId)
    external
    view
    override
    returns (bool)
  {
    IOceanDriveGovernanceV2.ProposalWithoutVotes memory proposal = governance.getProposalById(proposalId);
...
/**
 * @title Proposal Validator Contract, inherited by OceanDrive Governance Executors
...
contract ProposalValidator is IProposalValidator {
  ...
  function validateCreatorOfProposal(
    IOceanDriveGovernanceV2 governance,
    address user,
    uint256 blockNumber
   ...
   **/
  function getMinimumPropositionPowerNeeded(IOceanDriveGovernanceV2 governance, uint256 blockNumber)
    public
    view
    override
    returns (uint256)
   ...
   **/
  function isProposalPassed(IOceanDriveGovernanceV2 governance, uint256 proposalId)
    external
    view
    override
    returns (bool)
   ...
   * @return voting power needed for a proposal to pass
   **/
  function isQuorumValid(IOceanDriveGovernanceV2 governance, uint256 proposalId)
    public
    view
    override
    returns (bool)
   ...
   **/
  function isVoteDifferentialValid(IOceanDriveGovernanceV2 governance, uint256 proposalId)
    public
    view
    override
    returns (bool)
...
import {IOceanDriveGovernanceV2} from './IOceanDriveGovernanceV2.sol';
...
interface IOceanDriveGovernanceV2 {
