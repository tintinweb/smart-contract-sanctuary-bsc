...
contract dAngelVesting is AccessControl, ReentrancyGuard {
    ...
    constructor(address token, uint256 start, uint256 duration, uint256 releasesCount, bool revocable) {
        ...
        _finish = _releasesCount * _duration;
        _finish = _finish + _start;
  ...
  /****************************|
    ...
    */
    ...
    {
        return (
            (!_vestingSchedules[_beneficiary].revoked && _vestingSchedules[_beneficiary].beneficiary != address(0)),
            _vestingSchedules[_beneficiary].totalAmount,
            _vestingSchedules[_beneficiary].releasedAmount,
            _releasableAmount(_beneficiary),
            _vestingSchedules[_beneficiary].revoked
        );
    }
        /**
