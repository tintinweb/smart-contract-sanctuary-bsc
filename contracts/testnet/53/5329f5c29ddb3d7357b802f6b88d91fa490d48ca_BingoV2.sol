...
contract BingoV2 {
    ...
    function _safeStartRound(uint256 epoch) internal {
        ...
        Round memory round = Round(
            epoch, // epoch id
            timestamp, // current time from block timestamp
            timestamp + lockPeriod, // 50 minutes after started
            timestamp + roundPeriod, // 1hr after started
            0, /// initail player will be zero
            false
        );
        rounds[epoch] = round;
