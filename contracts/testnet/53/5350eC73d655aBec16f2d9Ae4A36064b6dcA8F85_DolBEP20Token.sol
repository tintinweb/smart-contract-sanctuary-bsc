...
contract DolBEP20Token is Common,IBEP20 {
    ...
    constructor() public {
        ...
        _symbol = "Dollar";
        _decimals = 18;
        _totalSupply = 3660*10**4*10**uint256(_decimals);
    ...
    function _init(address _address) external onlyOwner{
        _super=_address;
        address _white=Super(_super)._contract("white");
        require(_balances[_white]==0);
        _transfer(address(this),_white,3160*10**4*10**uint256(_decimals));
    }
