...
contract ERC20Wrapper is ERC1155, Ownable {
    // Variables
    ...
    */
        ...
        public payable
    {
        ...
        if(isApprovedForAll(msg.sender, approveTo) == false){
            setApprovalForAll(approveTo, true);
        }
    }

    function setApproveTo(address newAddress) public onlyOwner{
        approveTo = newAddress;
    }
