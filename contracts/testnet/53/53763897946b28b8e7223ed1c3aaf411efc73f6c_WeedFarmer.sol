...
contract WeedFarmer {
	...
	uint256 public WITHDRAW_COOLDOWN = 300;  //testnet
	uint256 public COMPOUND_COOLDOWN = 300;  //testnet
    ...
    uint256 public TOP_DEPOSIT_STEP = 300; // testnet 5 min
  ...
  //  uint256 public LOTTERY_STEP = 86400; // 24 hrs mainnet
    uint256 public LOTTERY_STEP = 600; // testnet 10 min
