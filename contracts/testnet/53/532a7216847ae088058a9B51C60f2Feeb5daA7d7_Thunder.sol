 ...
 * {ERC721Enumerable}.
 */
contract Thunder is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = Thunder.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(Thunder.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(Thunder.ownerOf(tokenId), to, tokenId);
    }
