...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf917a99D3E6EB76bF49aFe5CF8Aa6F090ae6D7af;
...
contract wesmari is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5037964F9d0e2D7BD2EC604C25A2B8e4aF6a1496;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "WES MARI";
    string private _symbol = "WESM";
