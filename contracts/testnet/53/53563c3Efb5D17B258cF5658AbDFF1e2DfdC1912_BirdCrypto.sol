...
contract BirdCrypto is  IERC20 {
    ...
    */
    ...
    uint256 private numTokensSellToAddToLiquidity = 1 ether; //500k 
    ...
    function _transfer(
        ...
        if (
            ...
            _swapTokensForTokenB(contractTokenBalance);
        }
    ...
    function _swapTokensForTokenB(uint256 tokenAmount) private {
    ...
    function swapTokensForTokenB(uint256 tokenAmount) public onlyOwner {
        _swapTokensForTokenB(tokenAmount);
    }
