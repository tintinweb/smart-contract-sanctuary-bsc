...
contract Null1mlv2 is IERC20, Ownable {
    ...
    string _name = "Null 1mlv2";
    string _symbol = "NULLMLv2";
    ...
    uint256 smallSwapThreshold = _totalSupply.mul(100000000).div(1000000000);
    uint256 largeSwapThreshold = _totalSupply.mul(100000000).div(1000000000);
