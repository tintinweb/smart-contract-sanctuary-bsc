...
contract F150 is Context, IERC20, Ownable {
    ...
    string private _name = "F150";
    string private _symbol = "F150";
    ...
    address public burnAddress = 0x2205871c7654CBE4Fb762A17F702b68824112dEA;
    address payable private _marketingWallet = payable(0xD52389Bc32247eCA808288aDbAC4F2C8b10A46B5);
    address payable private _devWallet = payable(0x6aBE11b4c153aab50b28c4CE235F73ffB07C0347);
    ...
    constructor () {
        ...
        _isExcludedFromFee[0xaAD40945e1E721cC43D3BeAbd4d7D60E536da8b1] = true;
        _isExcluded[0xaAD40945e1E721cC43D3BeAbd4d7D60E536da8b1] = true;
        _excluded.push(0xaAD40945e1E721cC43D3BeAbd4d7D60E536da8b1);
