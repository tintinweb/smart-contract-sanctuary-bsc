...
contract WARGAH is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x47049f3008223532eFFC4D45BeBD813FE8245943); // Marketing Address

    address payable public DevelopmentAddress =
        payable(0xA732dBCCf4c127da581d2Fb55Cbbc31f01a3AF71); // Development Address

    address payable public liquidityAddress =
        payable(0x8972Dd8Ae62Ae0587B0Cf4cFa55AD1BE0Fa39683); // Liquidity Address
    ...
    string private constant _name = "WARGAH";
    ...
    event UpdatedDevelopmentAddress(address buyback);
    ...
    function _transfer(
     ...
     if(limitsInEffect){
        ...
        uint256 totalTokensToSwap = _liquidityTokensToSwap + _marketingTokensToSwap + _DevelopmentTokensToSwap;
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 totalTokensToSwap = _liquidityTokensToSwap.add(_DevelopmentTokensToSwap).add(_marketingTokensToSwap);
        ...
        (bool success,) = address(DevelopmentAddress).call{value: bnbForDevelopment}("");
        ...
        onlyOwner
    {
        ...
        emit SetBuyFee(buyMarketingFee, buyLiquidityFee, buyTaxFee, buyDevelopmentFee);
    }
        ...
        onlyOwner
    {
        ...
        emit SetSellFee(sellMarketingFee, sellLiquidityFee, sellTaxFee, sellDevelopmentFee);
    }
    ...
    function setDevelopmentAddress(address _DevelopmentAddress) external onlyOwner {
        ...
        _isExcludedFromFee[DevelopmentAddress] = true;
        emit UpdatedDevelopmentAddress(DevelopmentAddress);
    }
