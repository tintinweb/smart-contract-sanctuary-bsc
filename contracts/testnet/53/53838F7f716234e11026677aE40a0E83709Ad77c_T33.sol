...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x324E8E649A6A3dF817F97CdDBED2b746b62553dD);  // rewards token address
    IDEXRouter router;
...
contract T33 is IBEP20, Auth {
    ...
    string constant _name = "T33";
    string constant _symbol = "T33";
    ...
    bool public luigiMode = true;
    mapping (address => bool) public isluigied;
    ...
    // Set Fee Receiver Wallets
        ...
        teamFeeReceiver = 0x6C34c4de1b1af7E4604d07894E90AD83A11c5E91;
        ArcadelonFeeReceiver = 0xF0594a8Df7964e890C7f515CD44869A475fD3EC9;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(WenLaunch,"Trading not open yet");
        }
    ...
    function takeFee(address sender, uint256 amount, bool isSell, address receiver) internal returns (uint256) {
        ...
        if(luigiMode && !isluigied[receiver] && !isSell){
            multiplier = 850;
        }
    ...
    function enable_nuisance(bool _status) public onlyOwner {
     ...
     function enable_luigi(bool _status) public onlyOwner {
        luigiMode = _status;
    }
    //GK
    ...
    function manage_luigi(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            isluigied[addresses[i]] = status;
        }
    }
