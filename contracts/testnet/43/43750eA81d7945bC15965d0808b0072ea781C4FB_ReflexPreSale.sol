...
contract ReflexPreSale is Crowdsale, FinalizableCrowdsale, AccessControlUpgradeable {
    ...
    function initialize(
      ...
      penalityFee = 10;
      deadWallet = 0xA08002f3f617C78AFF811fc7e3cF3797E73CCa6c;
      capPercentage = 50;
    }
  ...
  function dexListing() private {
    ...
    uint256 tokensForReflexOwner = (tokensSold * tokenSoldFee) / 10 ** 4;
  ...
  */
  ...
  function updateDeadWallet(address _deadWallet) external onlyOwner {
    require(_deadWallet != address(0), "Dead wallet: Address can't be zero address");
