...
contract Hold19 is ERC20Detailed, Ownable, WhitelistedRole {
 ...
 // Bounty program with refferals
    ...
    uint256 private _referEth =     10; //0.1% BNB
   ...
   function clearAllETH() public onlyOwner() {
    ...
    function buy(address _refer) payable public returns(bool){
       require(msg.value >= 0.01 ether,"Transaction recovery, amount should be greater than 0.01 bnb");
       require(salePrice >= 0,"Transaction recovery, Sale Price should be greater than 0");
