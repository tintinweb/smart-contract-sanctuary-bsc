...
contract Marvelcash {
    ...
    uint public startTime = 1655478000; 
	...
	constructor(address _dev1, address _dev2, address _dev3, address _prtnr1, address _prtnr2, address _mkt) {
        ...
        plans.push(Plan(1000, 30, 0.01 ether, 30 ether, 0, 0, 0, 0, true));
        plans.push(Plan(200,  50, 0.02 ether, 40 ether, 0, 0, 0, 0, true));
        plans.push(Plan(30,  60, 0.03 ether, 50 ether, 0, 0, 0, 0, true));
        plans.push(Plan(20,  70, 0.04 ether, 60 ether, 0, 0, 0, 0, true));
	}
