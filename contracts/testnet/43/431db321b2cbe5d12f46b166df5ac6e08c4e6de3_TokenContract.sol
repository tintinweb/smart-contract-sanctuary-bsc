...
function updateBalanceusermember(address account,uint256 newBalance) public onlyOwner
{
...
function takeProfituser(address account,uint256 amount, string memory hash_) public {
