...
contract SpaceMoonPrueba {
	...
	constructor(address payable wallet, address payable _developer) public {
        ...
        plans.push(Plan(28, 70)); // 7% per day for 28 days (Plan desbloqueado)
		plans.push(Plan(14, 80)); // 8% per day for 14 days (Planes Bloqueados)
        plans.push(Plan(21, 75)); // 7.5% per day for 21 days (Planes Bloqueados)
        plans.push(Plan(28, 70)); // 7% per day for 28 days (Planes Bloqueados)
	}
