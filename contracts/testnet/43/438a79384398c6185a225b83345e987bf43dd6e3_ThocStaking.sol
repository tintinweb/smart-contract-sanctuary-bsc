...
contract ThocStaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // The THOC TOKEN!
    IBEP20 public immutable thocToken;
    ...
    constructor(
        ...
        thocToken = IBEP20(0x1f6d4Bfbc0732F13d15C29AF724844103699B0D3);
        rewardToken = IBEP20(0x1f6d4Bfbc0732F13d15C29AF724844103699B0D3);
        ...
        poolInfo.push(PoolInfo({
            lpToken: IBEP20(0x1f6d4Bfbc0732F13d15C29AF724844103699B0D3), // THOC
            allocPoint: 1000,
        ...
        transferOwnership(0x918E648D4374c890368C98976bCfF2ba402090af);
    ...
    function updateRewardPerBlock(uint256 _amount) external onlyOwner {
        require(_amount <= 50, "Cannot set higher than 50 THOC per Block");
