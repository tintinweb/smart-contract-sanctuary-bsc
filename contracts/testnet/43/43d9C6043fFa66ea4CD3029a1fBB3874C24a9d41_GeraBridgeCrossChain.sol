...
contract GeraBridgeCrossChain is Context {
    ...
    /**
     * Returns set minimum swap fee in GERA
     */
    ...
    {
        require(
            _feePerGera <= 100000000000000000000,
            "feePercentageInGera: Greater than 100 %"
        );
    ...
    function createSwapPair(
        ...
        emit SwapPairCreated(ethTxHash, gen20TokenAddr, eth20Addr, chain);
    ...
    function swapToken(
        ...
        require(amount > 0, "Amount should be greater than 0");
        require(
            feePercentageInGera < 100000000000000000000,
            "feePercentageInGera: Greater than 100 %"
        );

        uint256 feeAmountInGera = 0;
        if (feePercentageInGera > 0) {
            feeAmountInGera = amount.mul(feePercentageInGera);
            feeAmountInGera = feeAmountInGera.div(100000000000000000000);
            amount = amount.sub(feeAmountInGera);
