...
contract DOGEBLOX is Context, IERC20, Ownable {
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        require(_buyLiquidityFee <= _maxBuyLiquidityFee, "DOGEBLOX: buyLiquidityFee exceeds maximum value!");
        require(_buyMarketingFee <= _maxBuyMarketingFee, "DOGEBLOX: buyMarketingFee exceeds maximum value!");
        require(_buyTeamFee <= _maxBuyTeamFee, "DOGEBLOX: buyTeamFee exceeds maximum value!");
    ...
    function setSelTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        require(_sellLiquidityFee <= _maxSellLiquidityFee, "DOGEBLOX: sellLiquidityFee exceeds maximum value!");
        require(_sellMarketingFee <= _maxSellMarketingFee, "DOGEBLOX: sellMarketingFee exceeds maximum value!");
        require(_sellTeamFee <= _maxSellTeamFee, "DOGEBLOX: sellTeamFee exceeds maximum value!");
    ...
    function setDistributionSettings(uint256 newLiquidityShare, uint256 newMarketingShare, uint256 newTeamShare) external onlyOwner() {
        require(_liquidityShare <= _maxLiquidityShare, "DOGEBLOX: liquidityShare exceeds maximum value!");
        require(_marketingShare <= _maxMarketingShare, "DOGEBLOX: marketingShare exceeds maximum value!");
        require(_teamShare <= _maxTeamShare, "DOGEBLOX: teamShare exceeds maximum value!");
