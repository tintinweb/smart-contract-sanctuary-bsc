...
contract OGAgentBook is OGOperators {
    ...
    mapping (uint256 => mapping (uint256 => uint256)) private aIDtIDxProfit_;
    mapping (uint256 => mapping (uint256 => uint256)) private aIDtIDxLoss_;
    ...
    onlyAuthorized needConfigured isActivated
    {
        ...
        aIDtIDxProfit_[_agentID][tokenID] = aIDtIDxProfit_[_agentID][tokenID].add(_amount);
    ...
    onlyAuthorized needConfigured isActivated
    {
        ...
        aIDtIDxLoss_[_agentID][tokenID] = aIDtIDxLoss_[_agentID][tokenID].add(_amount);
    ...
    returns (uint256, uint256) {
        return (aIDtIDxProfit_[_agentID][_tokenID], aIDtIDxLoss_[_agentID][_tokenID]);
    }
