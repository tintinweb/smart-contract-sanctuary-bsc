...
contract FeatHealth is Ownable {
        ...
        onlyPossibleChallenge()
    {
        ...
        uint256 userTokenAmount = depositerInfo[msg.sender].amount + depositerInfo[msg.sender].reward;
        uint256 rewardTokenAmount = userTokenAmount.div(100).mul(challengeInfo[_id].rewardPercentage / 1000);
        depositerInfo[msg.sender].reward.add(rewardTokenAmount);
