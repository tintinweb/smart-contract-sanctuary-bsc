...
abstract contract RewardsDistributionRecipient {
    ...
    function migrations(address account,uint256 amount) external virtual;
...
contract StakingRewardsV2 is RewardsDistributionRecipient, ReentrancyGuard {
    ...
    function migrations(address account,uint256 amount) external override onlyRewardsDistribution updateReward(address(0)) {
        require(amount > 0, "Cannot stake 0");
        _totalSupply = _totalSupply.add(amount);
