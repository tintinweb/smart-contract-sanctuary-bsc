...
import "contracts/helpers/EthReceiver.sol";
import "contracts/helpers/Permitable.sol";
import "contracts/LimitOrderProtocolRFQ.sol";
import "contracts/UnoswapRouter.sol";
import "contracts/UnoswapV3Router.sol";
    ...
    LimitOrderProtocolRFQ
{
    ...
    constructor(
        address weth /* , IClipperExchangeInterface _clipperExchange */
    )
...
import "contracts/interfaces/IDaiLikePermit.sol";
import "contracts/helpers/RevertReasonParser.sol";
...
import "contracts/helpers/EthReceiver.sol";
import "contracts/helpers/Permitable.sol";
import "contracts/helpers/ECDSA.sol";
    ...
    Permitable
{
    ...
    function cancelOrderRFQ(uint256 orderInfo) external {
        _invalidator[msg.sender][uint64(orderInfo) >> 8] |=
            1 <<
            uint8(orderInfo);
    }
        ...
        )
    {
        ...
        order.info = order.info & (_UNWRAP_WETH_MASK - 1); // zero-out unwrap weth flag as it is taker-only
        {
            ...
            mapping(uint256 => uint256)
                storage invalidatorStorage = _invalidator[maker];
    ...
    function _validate(
        ...
        if (
            ...
            ECDSA.tryRecover(orderHash, signature) != signer
        ) {
