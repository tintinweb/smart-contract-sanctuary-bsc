...
contract MdNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    function setValidTarget(address _target, bool _permission) public onlyOwner {
        // only owner who creates this contract can set valid target who can mint token   
    ...
    function mintValidTarget(address to, string memory uri) 
        ...
        returns(uint256)
    {
        // check if the person who calls the function is valid target
        require(totalSupply() < maxSupply, "MdNFT: Max total supply, you can't mint more token");
