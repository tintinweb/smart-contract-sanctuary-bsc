...
// File: implementations/Implementation.sol
...
contract Implementation is Upgradeable {
    ...
    function isAdmin(address _account) public view returns (bool role) {
        if(_account == owner()) {
            role = true;
        } else if (saleAdminList[_account]) {
            role = true;
        } else if (creatorAdmins[_account]) {
            role = true;
...
// File: implementations/ImplementationV1.sol
...
// File: implementations/ImplementationV2.sol
