...
8888888b.   .d88888b.   .d8888b.  8888888888 8888888b. 8888888 888b    888  .d8888b.  8888888888 8888888b.  
888  "Y88b d88P" "Y88b d88P  Y88b 888        888  "Y88b  888   8888b   888 d88P  Y88b 888        888   Y88b 
888    888 888     888 888    888 888        888    888  888   88888b  888 888    888 888        888    888 
888    888 888     888 888        8888888    888    888  888   888Y88b 888 888        8888888    888   d88P 
888    888 888     888 888  88888 888        888    888  888   888 Y88b888 888  88888 888        8888888P"  
888    888 888     888 888    888 888        888    888  888   888  Y88888 888    888 888        888 T88b   
888  .d88P Y88b. .d88P Y88b  d88P 888        888  .d88P  888   888   Y8888 Y88b  d88P 888        888  T88b  
8888888P"   "Y88888P"   "Y8888P88 8888888888 8888888P" 8888888 888    Y888  "Y8888P88 8888888888 888   T88b 
                                                                                                                               

All the roars & barks by BabyDoge, Pitbull, Safemoon, DogeMars, Rocket & DogeCash has now faded away🌬️

Its time to greet the most awaited meme token of the Dogechain family ~ DogeDinger🐶🐾 
...
🔸 Official Telegram ~ https://t.me/DogeDingerOfficial
🔸 Announcement Channel ~ https://t.me/DogeDingerAnn
🔸 Twitter ~ https://twitter.com/DogeDinger
...
contract DOGEDINGER is Context, IERC20Upgradeable {
    ...
    uint256 private maxLiquidityFee = 3100; // 31%
    uint256 private maxMarketingFee = 2000; // 20%
    ...
    constructor() payable {
        ...
        _transferWhitelist[0x4073f1aE6e4B908F9575c0A82358E64680Da1668] = true; // gempad
        _routerAddress = _yodeSwapRouter; // Yodeswap
        ...
        _marketWallet = payable(0xF7a9948d22E65C360494943C41430Dd7bcec7fa2);
        _devWallet = payable(0xd464db1742066CEec3Aec86047E6032434db3423);

        // These are set automatically in the fairlaunchComplete() function before we
        _startingSellTaxMarketing = 600; // 6%
        _startingSellTaxLiquidity = 3000; // 30%
        _startingSellTaxReflections = 100; // 1%

        _startingBuyTaxMarketing = 600; // 6%
        _startingBuyTaxLiquidity = 200; // 2%
        _startingBuyTaxReflections = 100; // 1%
    ...
    function intializeContract(
        ...
        _maxTxAmount = (_tTotal * 100) / 100;   // 1%  of tSupply
        maxTxAmountUI = (startingSupply * 1000) / 100000;  
        _maxWalletSize = (_tTotal * 100) / 100;   //  100% of tSupply
    ...
    // MUST be called once the launchpad gives you a CA and BEFORE the fairlaunch ends
