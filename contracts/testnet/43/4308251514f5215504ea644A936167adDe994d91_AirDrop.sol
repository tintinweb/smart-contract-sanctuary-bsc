...
contract AirDrop is EIP712, AccessControl {
    ...
    function recover(address _account, uint256 _amount, bytes calldata _signature) external view returns (address) {

        return ECDSA.recover(_hash(_account, _amount), _signature);
    }
