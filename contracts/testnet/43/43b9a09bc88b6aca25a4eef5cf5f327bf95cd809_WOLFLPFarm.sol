...
contract WOLFLPFarm is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of WOLF
    ...
    struct PoolInfo {
        ...
        uint256 accTokenPerShare;   // Accumulated WOLF per share, times 1e12. See below.
    ...
    constructor() {
        token = IBEP20(0x0b2fD6cc02c3C20B276F9E0854b470c62BdF6b85);
        startBlock = block.number;
        tokenPerBlock = 58 ether;
    ...
    // View function to see if user can harvest WOLF.
    ...
    // Deposit LP tokens to Farm for WOLF allocation.
    ...
    // Safe token transfer function, just in case if rounding error causes pool to not have enough WOLF.
