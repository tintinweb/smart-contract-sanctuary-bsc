...
contract Snn is ERC20, Ownable {
    ...
    // beta router 0xD99D1c33F9fC3444f8101754aBC46c52416550D1/0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    // prod router 0x10ED43C718714eb63d5aA57B78B54704E256024E
    address constant routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //pancake route address
    ...
    function swapAndTakeFees(uint256 contractTokenBalance) private lockTheSwap {
        uint256 distributionPart = contractTokenBalance;
        // swap and take distribution part
        uint256 initialBalance = address(this).balance;
        swapTokensForEth(distributionPart);
        ...
        uint256 ethForBack = newBalance.sub(ethForMarketing);

        payable(marketingAddress).transfer(ethForMarketing);
        backAddress.transfer(ethForBack);
    }
