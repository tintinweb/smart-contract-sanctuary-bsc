...
contract TESTCOIN is Context, IERC20, Ownable {
    ...
    address public truckerAndMarketingWallet;
    ...
    uint256 public _maxTxAmount = 100000 * 10**6;
    uint256 public numTokensSellToAddToLiquidity = 1000 * 10**6;
    uint256 public _maxWalletSize = 100000 * 10**6;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 1000000000000, "Max Tx Amount cannot be less than 69 Million");
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        ...
        numTokensSellToAddToLiquidity = SwapThresholdAmount * 10**6;
    }
