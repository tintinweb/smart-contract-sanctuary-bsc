...
╰╯╰╯╰┻━━━╯╱╰╯╱╰╯╱╰╯╰━━━┻━━━┻╯╱╰┻━━━┻━━┻╯╱╰╯╱╰╯╱╰━━━┻╯╰━╯
    Website: 
    Contract Name: METAGLADIATOR
    Contract Version: 1.46
...
contract MGDT is Context, IERC20, Ownable
{
    ...
    uint256 private _tTotal = 10_000_000 * 10**9; //10 Million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "METAGLADIATOR";
    string private _symbol = "MGDT";
    ...
    uint256 public totalBuyFee = _taxFee.add(_liquidityFee).add(_marketingFee); //8% Total Buy Fee
    
    
    

    address payable public marketingWallet =  payable(0x3170E44012c31A9928eBAe37d0B5c691D63fE829); //Marketing Wallet Defined.
    ...
    constructor () 
    {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(currentRouter);  //Prod PCS = 0x10ED43C718714eb63d5aA57B78B54704E256024E  Dev PCS =0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    ...
    function setAllBuyFees(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee) public onlyOwner() 
    {
        ...
        uint256 totalBuyFees = _taxFee.add(_liquidityFee).add(_marketingFee);
        require(totalBuyFees <= 10, "Total fee is over 10%");
    ...
    {
		require(newWallet != address(0), "setmarketingWallets: ZERO");
    ...
    // Withdraw ERC20 tokens that are potentially stuck in the contract
    function recoverTokensFromContract(address _tokenAddress, uint256 _amount) public onlyOwner {                               
