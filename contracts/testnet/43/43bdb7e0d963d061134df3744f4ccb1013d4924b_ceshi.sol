...
contract ceshi is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xC0294901C4AFf3328594EaBF1E41dc423e604722));
        marketingWalletAddress = payable(address(0x8F35FF21e2e0100e674fB9187cCE1b51fAAD1bFc));
