...
contract TestBabyToken is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        dividendTracker = new BabyTokenDividendTracker(rewardToken, minimumTokenBalanceForDividends_);
