...
contract Lottery {
    uint256 public constant ticketPrice = 0.012 ether;
    uint256 private constant maxTickets = 50; // maximum tickets per lottery
    uint256 public constant ticketCommission = 0.03 ether; // commition per ticket
