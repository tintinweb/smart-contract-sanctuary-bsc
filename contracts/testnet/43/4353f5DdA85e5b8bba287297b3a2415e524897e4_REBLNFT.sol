...
//          address =>   token level => amount of tokens
    ...
    constructor(
        ...
        levelsInfo.push(LevelInfo(Level.Special, 6, 500 * USDT_DECIMAL));
        levelsInfo.push(LevelInfo(Level.Rare, 25, 2500 * USDT_DECIMAL));
        levelsInfo.push(LevelInfo(Level.Epic, 100, 10000 * USDT_DECIMAL));
        levelsInfo.push(LevelInfo(Level.Legendary, 500, 50000 * USDT_DECIMAL));
    }
