...
contract GeneralNFTRewardUpgradeable is IPool,GovernanceUpgradeable {
    ...
    2	quality	1.2+ 0.1*(quality-5000)/2000
    3	quality	1.3+ 0.2*(quality-7000/1500
    4	quality	1.5+ 0.3*(quality-8500)/1000
    5	quality	1.8+ 0.2*(quality-9500)/500
    */
    ...
    function getFixRate(uint256 grade,uint256 quality) public pure returns (uint256){
        ...
        if( grade == 1 ){
            ...
            unfold = quality.sub(5000)*10000/2000;
            return unfold.add(120000);
        }else if( grade == 3){
            unfold = quality.sub(7000)*10000/1500;
           return unfold.add(130000);
        }else if( grade == 4){
            unfold = quality.sub(8500)*20000/1000;
           return unfold.add(150000);
        }else{
            unfold = quality.sub(9500)*20000/500;
