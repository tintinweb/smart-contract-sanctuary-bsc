...
contract GreenDEX is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xA0C16B20D986E804EDdF5Aa73897d42eEEB3513c;
    address public operationsAddress = 0x54f841e86df75468a4Bf8fEdBBeF43fD5eB92283;
   ...
   function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(!swapping && swapEnabled && canSwap && from != pair){
            ...
            if (buyBackEnabled && balance > uint256(1 * 10**13) && to == pair) {
