...
import "@openzeppelin/contracts/utils/math/Math.sol";
import "./launchpad/interfaces/IUniswapV2Pair.sol";
import "./launchpad/interfaces/PoolLibrary.sol";

interface ICircleLocker {
    function lock(
        address owner,
        address token,
        bool isLpToken,
...
contract CircleLocker is ICircleLocker , Ownable {
    ...
    function _safeTransferFromEnsureExactAmount(
        ...
        require(
            ...
            "Not enough token was transferred"
        );
    }
