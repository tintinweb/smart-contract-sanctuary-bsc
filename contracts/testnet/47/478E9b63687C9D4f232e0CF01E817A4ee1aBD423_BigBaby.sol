...
contract BigBaby is ERC20, Ownable {
    ...
    uint256 public totalSellFee = 17;

    uint256 public rewardShare = 40;
    uint256 public marketingShare = 40;
    uint256 public buyBackShare = 20;

    address public marketingWallet = 0xB828b4B5dE5ca744688d6F7fe27310Ac621aEa0b; 
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            if(buyBackShare > 0){
                uint256 buyBackBNB = newBalance * buyBackShare / 100;
                buyBack(buyBackBNB);
            }
