...
// File: contracts/GameforceNFT.sol
pragma solidity >=0.6.0 <0.8.0;

contract GameforceNFT is ERC721, MinterRole, ERC721Burnable {
    ...
    function setTokenURI(uint256 _tokenId, string memory _tokenURI) public onlyOwner {
        require(getApproved(_tokenId) == _msgSender(), "Operator is not authorized");
     ...
     */
    function mint(address _to, string memory _tokenURI) public onlyMinter returns (uint256) {
    ...
    /**
     * @dev Batch Mint NFTs. Only the minter can call it.
     */
    function batchMint(uint256 _amount, address _to, string memory _tokenURI) public onlyMinter returns(uint256) {
        uint256 newId = _tokenIds.current();
