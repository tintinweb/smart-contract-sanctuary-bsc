...
contract Loan is LoanAdmin {
    ...
    constructor(address _address) {
        ...
        treasuryContract = ITreasury(_address);
    }
    ...
    function beginLoan(
        ...
        treasuryContract.transfer(_lender, _price);
    ...
    function liquidateOverdueLoan(uint256 _loanId) external nonReentrant {
        ...
        treasuryContract.transferFrom(loanIdToLoan[_loanId].lender, feeAddress, feeAmount);
        treasuryContract.transferFrom(loanIdToLoan[_loanId].lender, loanIdToLoan[_loanId].borrower, loanIdToLoan[_loanId].price.sub(feeAmount));
