...
contract tys is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "test";
    string constant _symbol = "tys";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = address(ZERO);  // marketingwallet
    ...
    function changeTxLimit(uint256 newLimit) external authorized {
        ...
        require(newLimit >= 1000000 * 10 ** _decimals); // Max Tx amount should be bigger or equal to 0.1% of Total Supply
    }
    ...
    function changeWalletLimit(uint256 newLimit) external authorized {
        _walletMax  = newLimit;
        require(newLimit >= 10000000 * 10 ** _decimals); // Max Wallet amount should be bigger or equal to 1% of Total Supply
    }
    ...
    function changeMarketingFeeReceiver(address newMarketingWallet) external onlyOwner {
