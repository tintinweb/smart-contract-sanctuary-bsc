    ...
    UUPSUpgradeable
{
    ...
    function _transfer(
        ...
        require(from != address(0), "CLDX: transfer from the zero address");
        require(to != address(0), "CLDX: transfer to the zero address");
        require(
        ...
        require(fromBalance >= amount, "CLDX: transfer amount exceeds balance");
        unchecked {
