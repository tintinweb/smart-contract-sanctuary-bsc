...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == stLottery, "Only STLottery");
    ...
    /**
     * @notice Set the address for the STLottery
     * @param _stLottery: address of the lottery
     */
    function setLotteryAddress(address _stLottery) external onlyOwner {
        stLottery = _stLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ISTLottery(stLottery).viewCurrentLotteryId();
    }
}