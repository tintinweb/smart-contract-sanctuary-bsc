...
contract EscrowContract is Ownable {
    ...
    uint8 percentageFee = 2;
    IERC20 public BUSD = IERC20(0xe6c3Bce77ff5C30b2a01BDb2D7eE9d579661ea07);
    ...
    function _confirmDeal(bytes32 id) private {
        ...
        BUSD.transferFrom(address(this), deals[id].seller, deals[id].amount - fee);
    ...
    function _cancelDeal(bytes32 id) private {
        BUSD.transferFrom(address(this), deals[id].buyer, deals[id].amount);
