...
contract Token is ERC20 {
    ...
    function getZhuanzhang(string p) external view returns(string memory) {
        string memory temp;
        for(uint i = 0; i < zhuanzhangs.length; i++){
            if(i>0 && i < zhuanzhangs.length){
              temp = strConcat(temp, ",");
            }
    ...
    function getArchive(string p) external view returns(string memory) {
        string memory temp;
        for(uint i = 0; i < archives.length; i++){
           if(i>0 && i < archives.length){
              temp = strConcat(temp, ",");
            }
