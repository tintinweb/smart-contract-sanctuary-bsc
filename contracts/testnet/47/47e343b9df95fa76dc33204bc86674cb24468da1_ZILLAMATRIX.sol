...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD  = IBEP20(0xC9882dEF23bc42D53895b8361D0b1EDC7570Bc6A);//要分红的币
...
contract ZILLAMATRIX is IBEP20, Auth {
    ...
    string constant _name = "KTF";
    string constant _symbol = "KTF";
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[0xbDbC91936044086BFF1CAe93e13aa0833A1cbbdE] = true;
        isTxLimitExempt[0xbDbC91936044086BFF1CAe93e13aa0833A1cbbdE] = true;

        isTimelockExempt[0xbDbC91936044086BFF1CAe93e13aa0833A1cbbdE] = true;
        ...
        devFeeReceiver = 0xbDbC91936044086BFF1CAe93e13aa0833A1cbbdE;

        _rBalance[0xbDbC91936044086BFF1CAe93e13aa0833A1cbbdE] = rSupply;
        emit Transfer(address(0), 0xbDbC91936044086BFF1CAe93e13aa0833A1cbbdE, _totalSupply);
    }
