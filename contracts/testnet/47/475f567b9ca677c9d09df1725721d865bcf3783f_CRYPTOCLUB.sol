...
contract CRYPTOCLUB is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xC25B460a1D7B2b55D93CB4C517a3D3954A6afB98); // Marketing Address
        
    address payable public teamAddress =
        payable(0xC25B460a1D7B2b55D93CB4C517a3D3954A6afB98); // Team Address
    ...
    string private constant _name = "CRYPTO CLUB";
    string private constant _symbol = "$CLUB";
    
    uint8 private constant _decimals = 18;
    
    uint256 private constant BUY = 0;
    uint256 private constant SELL = 20;
    ...
    uint256 private gasMaxLimit =  30000000; // gasLeft limit
