...
contract NiftyFlex is ERC721Enumerable, Ownable {
    ...
    address private _ashContract = 0x09d8AF358636D9BCC9a3e177B66EB30381a4b1a8;  // ZAPO address  for test
    // address ashContract_address = 0x09d8AF358636D9BCC9a3e177B66EB30381a4b1a8;  // ASH address  for live

    // base token Uri
    string  private  _baseTokenUri = "https://nifty-flex.xyz/metadata/";
    ...
    function buyProduct(uint256 _productId) public payable {  
        ...
        if(productInfo.isRequiredNftTokenBalance) {
            ...
            ERC721 nftTokenContract = ERC721(productInfo.nftTokenContractAddress);
        ...
        ERC20  ashContract = ERC20(_ashContract);       
        ...
        require(ashContract.transferFrom(msg.sender, ownerAddress, productInfo.price));
