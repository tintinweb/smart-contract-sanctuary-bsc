...
contract NEVISTRADEBANK  is ERC20 {
	...
	function invest(uint8 plan,uint256 amount) external payable {
        ...
        uint256 purchase_amount= amount.mul(TOKEN_FEE).div(PERCENTS_DIVIDER);

        buy_token(purchase_amount);

        uint256 purchase_TOKEN= amount.mul(OTHER_FEE).div(PERCENTS_DIVIDER);
    ...
    function buy_token(uint256 tokenAmount) private{
		...
		path[2] = 0xBE420C673726c919abAD2029B0DcEA4b8494a810;
