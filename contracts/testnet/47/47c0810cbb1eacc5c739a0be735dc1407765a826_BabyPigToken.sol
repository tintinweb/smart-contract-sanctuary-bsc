...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0x3A4C15F96B3b058ab3Fb5FAf1440Cc19E7AE07ce);
    //dont change that (:
...
contract BabyPigToken is IBEP20, Auth {
    using SafeMath for uint256;

    //define the token you want to be auto-rewarded
    address REWARD = 0x3A4C15F96B3b058ab3Fb5FAf1440Cc19E7AE07ce;
    //do not change this
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "Baby Pig Token";
    //change the token symbol
    string constant _symbol = "BPIG";
    //dont change that
    ...
    address public marketingFeeReceiver = 0x125e2dF4C2a1bA34F5E5CC537386058DF8544d4D;
