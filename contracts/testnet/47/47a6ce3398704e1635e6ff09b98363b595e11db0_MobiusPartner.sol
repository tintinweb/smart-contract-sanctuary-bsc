...
contract MobiusPartner is Modifier {
    ...
    constructor() {
        nodeTotalQuota = 18;
        nodeAmount = 10000000000000000000000;
    }
    ...
    function join() public isRunning nonReentrant returns (bool) {
        ...
        token.transfer(receiveAddress[joinAddress.length - 1], nodeAmount);
    ...
    function getAvailableNumber() public view returns(uint) {
