...
contract AstaBridgeCrossChain is Context {
    ...
    function createSwapPair(
        ...
        require(
            swapMapping2BSC[eth20Addr] == address(0x0),
            "duplicated swap pair"
        );

        swapMapping2BSC[eth20Addr] = address(gen20TokenAddr);
        swapMappingFrmBSC[address(gen20TokenAddr)] = eth20Addr;
    ...
    function fillSwap(
        ...
        address genTokenAddr = swapMapping2BSC[eth20Addr];
    ...
    function swapToken(
        ...
        address eth20Addr = swapMappingFrmBSC[gen20Addr];
