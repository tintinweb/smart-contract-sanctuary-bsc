...
contract MasterSpaceInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // The address of the master space factory
    address public MASTER_SPACE_FACTORY;

    bool public onlyWhitelisted = true;

    // The address of the master space factory
    address public feeAddress = 0x0820f52e7237305011199A348B05Dff771E245Dc;
    ...
    constructor() public {
        MASTER_SPACE_FACTORY = msg.sender;
    }
    ...
    function initialize(
        ...
        require(msg.sender == MASTER_SPACE_FACTORY, "Not factory");
