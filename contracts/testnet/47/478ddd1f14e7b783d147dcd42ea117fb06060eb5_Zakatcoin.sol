...
contract Zakatcoin is Context, IERC20, Ownable {
    ...
    address private fixedBurnAddress = 0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "Zakatcoin";
    string private _symbol = "ZKTC";
    ...
    uint256 public _maxWalletSize = 1 *10**10 * 10**18;
    ...
    constructor() {
        ...
        charityWallet = payable(0x1464E823C6ed2945A6DEaF34385AFFF429990AA5);
        adminWallet = payable(0xC5DA9f659B2fEA8BDE0C280E5D3de1a44ab9Ed83);
        liquidityReceiver = payable(0xC5DA9f659B2fEA8BDE0C280E5D3de1a44ab9Ed83);
        ...
        _isExcludedFromLimit[adminWallet] = true;
        _isExcludedFromLimit[charityWallet] = true;
        _isExcludedFromLimit[liquidityReceiver] = true;
    ...
    function updateAdminWallet(address payable newAddress) external onlyOwner {
        adminWallet = newAddress;
    }
        ...
        )
    {
        ...
        uint256 tWallet = calculateAdminFee(tAmount) +
    ...
    function calculateAdminFee(uint256 _amount)
        private
        view
        returns (uint256)
    {
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap {
        ...
        uint256 adminAmt = unitBalance *
            2 *
            (buyFee.admin + sellFee.admin);
        ...
        if (adminAmt > 0) {
            payable(adminWallet).transfer(adminAmt);
        }
