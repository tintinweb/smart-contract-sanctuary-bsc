...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        _marketingWalletAddress = 0x1a3f6f21e2Fb8e7172325D79D12D8710240F2Feb;
        _devAddress = 0xB0796952B60C67F94F35075232Ff3abBc2282367;
        require(
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            test1 = amount.mul(inviterFee).div(100);
    ...
    uint256[] public _inviters = [200,100,25,25,25,25,25,25,25,25];
    ...
    function swapAndSendToFee(uint256 tokens) private {
        ...
        IERC20(rewardToken).transfer(_marketingWalletAddress, newBalance*3/5);
        IERC20(rewardToken).transfer(_devAddress, newBalance*2/5);
    }
