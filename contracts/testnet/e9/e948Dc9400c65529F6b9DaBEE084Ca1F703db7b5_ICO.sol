...
contract ICO {
    ...
    event tokenSold(address buyer, address referrer, uint256 boughtAmount, IBEP20 payToken, uint256 payAmount, uint256 timestamp);
    ...
    function buy(uint256 amount, IBEP20 payToken, address referrer) external {
        require(hardCap > totalSold, "Hardcap is reached.");
        ...
        emit tokenSold(msg.sender, referrers[msg.sender], amount, payToken, payAmount, block.timestamp);
    }
