...
contract Incentive is ReentrancyGuard {
    ...
    function findWinnerToken(uint256 _round) public nonReentrant {
        require(msg.sender == saleContract, "Not authorized");
    ...
    function findWinnerBase(uint256 _round) public nonReentrant payable {
        require(msg.sender == saleContract, "Not authorized");
        require(block.timestamp >= _incentiveDetails[_round].incentive_date, "Not ended");
        require(prizeAmount[_round] > 0, "No prize set");
    ...
    function getBallotList(uint256 _round) public view returns(address[] memory entrant) {
