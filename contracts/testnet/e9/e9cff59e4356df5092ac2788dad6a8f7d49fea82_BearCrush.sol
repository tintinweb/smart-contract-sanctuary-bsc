...
% per tx:
2% to all holders in BCRUSH Tokens
1% per tx to marketing wallet in BNB
1% per tx to developments wallet in BNB

Mktg 0x3Dd594f9cC628a16980aF7230708aBA92bD3df95
Devt 0x711d623cba424dAbA3B56eC55b88bDfB46062a69
...
Add correct addresses as given above
The setSwatTokensAmount spelling was wrong
update the notes, copy paste the above
Rewards to All holders in BCRUSH tokens*

*/

contract BearCrush is Context, IERC20, Ownable {
    ...
    string private _name = "Bear Crush";
    string private _symbol = "BCRUSH";
    ...
    address payable public devWallet = payable(0x711d623cba424dAbA3B56eC55b88bDfB46062a69);
    address payable public marketingWallet = payable(0x3Dd594f9cC628a16980aF7230708aBA92bD3df95);
