...
library Error {
    ...
    string public constant INITIALIZED_LOTTERYDAILY= "2"; // 
    string public constant MINT_WITH_AMOUNT_INVALID= "3"; // 
    string public constant INVALID_OWNER_OF_TOKEN= "4"; // 
    string public constant YOU_HAVE_NO_REWARD= "5"; // 
    string public constant INVALID_TIME_GENERATE_NUMBER_WINNING= "6"; // 
    string public constant INVALID_ADDRESS_ZERO= "7"; // argument not is a 0x00000000000000000000000000
    string public constant FORGET_INIT_LOTTERY_DAILY= "8"; // argument not is a 0x00000000000000000000000000
}
...
contract LotteryFactory is AccessControl {
    ...
    uint256 constant hundredPercent = 1000; // 100 %  
    ...
    // modifier onlyOwnerTicket(uint256 _tokenId, address _owner) {
    //     require(lotteryTicket[_tokenId].owner == _owner, Error.INVALID_OWNER_OF_TOKEN);
    //     _;
    // }
    ...
    // 0h hằng ngày owner chạy tx để khỏi tạo 1 xổ số hằng ngày 
    ...
    // remaining Reward sau 7 ngày sẽ được đưa vào total reward của ngày tiếp theo
    ...
    // 21h generateWinningNumber gồm 2 chữ số 
