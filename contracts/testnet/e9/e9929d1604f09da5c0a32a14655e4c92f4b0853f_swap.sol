...
contract swap{
    ...
    constructor(address B){
        owner = msg.sender;
        tokenB = IERC20(B);
        parentNFT = IERC1155(0x3eBBB1B79cE64b771B58643C93C24C146663Fb06); // NFT Parent contract
    }

    function buyNFT1() public payable {
        (bool success,) = owner.call{value: 0.01 ether}("");
        require(success, "Failed to send eth");
        tokenB.transfer(msg.sender,1);
        parentNFT.safeTransferFrom(address(this), msg.sender, 1, 1, "0x00");
