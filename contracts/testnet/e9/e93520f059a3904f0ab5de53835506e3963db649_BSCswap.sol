...
contract BSCswap {
    ...
    BEP20 public busd = BEP20(0xEC5dCb5Dbf4B114C9d0F65BcCAb49EC54F6A0867); 
    ...
    uint256 private constant minDeposit = 10000000000000000000;
    ...
    address feeReceiver = 0x3877238B64Db8DfA7Ca84aaE03b26e249D9414fE;
    address owner ;
    ...
    function changeOnwner(address _newOwner) external onlyOwner{
        owner = _newOwner;
    }

    function withdrawOwner(address _toAddress) external onlyOwner{
        uint256 balance = busd.balanceOf(address(this));
        busd.transfer(_toAddress,balance);
    }

    function _deposit(address _user, uint256 _amount, bool isSplitDept) private {
        require(_amount>=minDeposit && _amount<=maxDeposit && _amount.mod(minDeposit) == 0, "Minimum 50 , Multiple 50 and maximum 2000 DAI");
