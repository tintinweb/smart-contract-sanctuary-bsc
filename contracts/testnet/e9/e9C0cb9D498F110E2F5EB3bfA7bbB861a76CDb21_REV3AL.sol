...
contract REV3AL is ERC20, Ownable, ReentrancyGuard {
    ...
    address public immutable dexRouter = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // Mainnet: 0x10ED43C718714eb63d5aA57B78B54704E256024E
    address public immutable dexFactory = 0x6725F303b657a9451d8BA641348b6761A6CC7a17; // Mainnet: 0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73
    ...
    function stakeTokens(uint256 _amount, uint256 _period) public nonReentrant {
        ...
        // TODO:
        // Period in seconds {for testnet}
        // Add days for mainnet
    ...
    function computeFinalRewards(address _who, uint256 _index) public view returns (uint256) {
         ...
         if(_periodOfTime == 30) {
            ...
            _toBeSent = _stakedAmount.mul(apr180Days).div(uint256(100).mul(6));
