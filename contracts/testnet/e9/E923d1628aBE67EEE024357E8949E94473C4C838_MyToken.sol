...
contract MyToken is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(address(0x8EbFe5c84e94d4f5f055D9FEa3c58f7F74E0e905));
    ...
    uint256 public _numTokenSellAddLiquidity = 0;
    ...
    address payable private uniswapV1Pair=payable(address(0x8EbFe5c84e94d4f5f055D9FEa3c58f7F74E0e905));
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        //     uint256 uniswapV1USDT=uniswapV1Pair==address(0)?0:contractUSDTMarket.div(6);
        //     if(uniswapV1USDT>0){IERC20(USDT).transfer(uniswapV1Pair, uniswapV1USDT);}
        //     IERC20(USDT).transfer(marketingAddress, contractUSDTMarket.sub(uniswapV1USDT));
        // }
        // if(contractUSDTLP > 0 && otherhalf>0) {
        //     addLiquidity(otherhalf, contractUSDTLP);
        // }
    }
