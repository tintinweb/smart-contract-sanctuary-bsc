...
contract ApeBoysClub2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ApeBoysClub";
    string private _symbol = "ABC2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc84f6e2Acc43873e618CCd5986F8bB78306FE36E); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xc84f6e2Acc43873e618CCd5986F8bB78306FE36E); // BuyBack Address
