...
contract PosiBridge is
    ...
    OwnableUpgradeable
{
    // TODO: config POSI_TOKEN_ADDRESS when deploy
    address public constant POSI_TOKEN_ADDRESS = 0x73941275a06354f795066E87b60112BbC49A3C88;
    ...
    // TODO: config minimum transfer amount of each transaction
    ...
    /**
     * Change Posi chain bridge contract.
     *
     * Requirements:
     ...
     * - the caller must be owner.
     *
     * @param _crosschainControlContract     Address of contract bridge on Posichain.
     */
     ...
     * @param _posiChainTokenHubContract     Address of contract bridge on Posichain.
     */
    function updatePosiChainBridgeContract(
        address _posiChainTokenHubContract
    ) external onlyOwner {
        posiChainTokenHubContract = _posiChainTokenHubContract;
    }
    ...
    function receiveFromOtherBlockchain(
        ...
        if (_destTokenContract != POSI_TOKEN_ADDRESS) {
            revert("not support other token than posi");
        }
