...
contract Test_Drift_Credits_V1 is AccessControlUpgradeable,PausableUpgradeable,UUPSUpgradeable {
    ...
    function initialize() public initializer {
        ...
        creditPurchaseTokenOpen = true;
        
        minimumBnbPurchase = 0.0001 ether;
        minimumBUSDPurchase = 1 ether;
        minimumTokenPurchase = 1 ether;
    }
    ...
    bool creditPurchaseBNBOpen;
    bool creditPurchaseBUSDOpen;
    bool creditPurchaseTokenOpen;
    ...
    mapping(address => purchase[]) public PURCHASES_BNB;
    mapping(address => purchase[]) public PURCHASES_BUSD;
    mapping(address => purchase[]) public PURCHASES_TOKEN;
    ...
    function purchaseViaBUSD(uint256 bnbValue, uint256 amount) external  {
      ...
      busdContract.transfer(address(this), amount);
