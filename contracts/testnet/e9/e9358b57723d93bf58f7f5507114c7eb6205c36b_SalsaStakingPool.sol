...
// File: SalsaStakingPool.sol
contract SalsaStakingPool is Ownable {
    using SafeMath for uint256;
    ...
    */ 
    ...
    string constant public lockPeriod = '2 Days';  // locked period in text to be shown by the GUI
    uint256 private contractLockPeriod = 172800; // 6-month in seconds 
