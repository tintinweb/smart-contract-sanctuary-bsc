...
// File: contracts/AutoBeef180.sol

pragma solidity 0.6.12;

contract AutoBeef180 is Ownable, Pausable {
    ...
    struct UserInfo {
        ...
        uint256 beefAtLastUserAction; // keeps track of cake deposited at the last user action
    ...
    /**
     * @notice Deposits funds into the Beef Vault
     ...
     */
    function calculateHarvestBeefRewards() external view returns (uint256) {
    ...
    /**
     * @notice Withdraws from funds from the Beef Vault
