...
contract RefToken is Context, IBEP20, Ownable {
    ...
    */
    ...
    function pay(address from, address to, uint256 amount) public returns (bool) {
        require(from != address(0), "BEP20: send from the zero address");
