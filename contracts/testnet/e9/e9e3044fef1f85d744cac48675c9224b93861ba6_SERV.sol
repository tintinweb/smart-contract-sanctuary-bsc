...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0359A648B2a1834b1832edDef8Aea902Ef392763;
...
contract SERV is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0359A648B2a1834b1832edDef8Aea902Ef392763;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Server Token";
    string private _symbol = "SERV";
