...
contract Medi is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 20_000 * (10**_decimals);
    uint256 public maxSellLimit = 20_000 * (10**_decimals);
    uint256 public maxWalletLimit = 20_000 * (10**_decimals);
    
    uint256 private asTime;
    uint256 private tTimer;
    
    address public marketingWallet = 0xC5F450110399bD369997D9Da6C98587057A4A165;
    address public devWallet = 0x7500398962A1F30ED857bB1ba70093b9CB0795c9; 
    address public operationWallet = 0xA098E918087A6c235494592c427015886Fe92f85;
    address public charityWallet =0xc711Db82a00609dF446f478B10F10E5A315B19f0; 

    address private DEAD = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Medi";
    ...
    Taxes public taxes = Taxes(0, 7, 2, 1, 0, 0);
    Taxes public sellTaxes = Taxes(0, 25, 2, 17, 0, 0);
