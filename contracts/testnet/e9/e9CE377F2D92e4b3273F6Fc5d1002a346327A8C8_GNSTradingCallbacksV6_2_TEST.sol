...
interface StorageInterfaceV5{
    ...
    function storeTradeContinue(address, uint) external;
    function storeTradeInfo(Trade calldata) external;
    function storeOpenTradeInfoFromCallback(TradeInfo calldata, address, uint, uint) external;
    ...
    function updateOpenInterestDai(uint, uint, bool, bool) external;
}
...
*/
    ...
    function registerTrade(
        ...
        storageT.storeTradeInfo(trade);
        //storageT.storeTradeContinue(trade.trader, trade.pairIndex);
        storageT.storeOpenTradeInfoFromCallback(StorageInterfaceV5.TradeInfo(
            0,
            v.tokenPriceDai,
        ...
        storageT.updateOpenInterestDai(trade.pairIndex, trade.positionSizeDai * trade.leverage, true, trade.buy);
        emit DATA(true);
