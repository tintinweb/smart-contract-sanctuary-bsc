...
contract ThirtPartyPackage is AccessControlEnumerable, Ownable, ReentrancyGuard {
    ...
    function buyStarterPack() public nonReentrant 
    {
        ...
        {
            require(checkWhitelist(msg.sender) == true ,'Error : Invalid Whitelist');
        }

        require(saleStatus == true,'Error : Invalid Whitelist');
        require(BUSD.balanceOf(msg.sender) > pricePack,'Error: Invalid balance of BUSD');
