...
//Telegram : https://t.me/KalengChain
...
contract KalengChain is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xC35dd751F76b03EfaB3A7B2cf84F4a911906C587); 
    address payable public Dev_Wallet = payable(0xC35dd751F76b03EfaB3A7B2cf84F4a911906C587);
    ...
    string private constant _name = "KalengChain"; 
    string private constant _symbol = unicode"KALENG"; 
    ...
    constructor () {
        ...
        _owner = 0xC35dd751F76b03EfaB3A7B2cf84F4a911906C587;
