...
import "./../managers/midas/MidasMultinetworkRouterManager.sol";
import "./../interfaces/midas/IMidasRouterFactory.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract MidasERC20Token is ERC20, Ownable {
    ...
    constructor(
        ...
        availableNetworks["avalanche"] = true;
        ...
        // chainlink
        addresses[3] = 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526;
        ...
        IERC20(self()).approve(self(), type(uint256).max);

        lpPair = IMidasRouterFactory(
        ...
        availableChainlinkNetworks[currentNetwork] = true;
    ...
    function _transfer(
        ...
        if (
            !tradingActive &&
            from != _owner &&
            to != midasMultinetworkRouterManager.getDexRouterAddress() &&
            to != address(lpPair)
        ) {
