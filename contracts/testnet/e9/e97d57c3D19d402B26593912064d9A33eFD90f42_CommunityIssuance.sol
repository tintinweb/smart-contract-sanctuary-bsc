...
contract CommunityIssuance is BaseContract, ICommunityIssuance, BaseMath {
    ...
    */
    ...
    address public furfiStabilityPoolAddress;
    address public furStabilityPoolAddress;
    ...
    event FurFiStabilityPoolAddressSet(address _furfiStabilityPoolAddress);
    event FurStabilityPoolAddressSet(address _furStabilityPoolAddress);
    ...
    function setLoanTokenAddresses(address _loanTokenAddress) external onlyOwner  {
    ...
    function setFurFiStabilityPoolAddress(address _furfiStabilityPoolAddress) external onlyOwner {
        furfiStabilityPoolAddress = _furfiStabilityPoolAddress;
        emit FurFiStabilityPoolAddressSet(_furfiStabilityPoolAddress);
    }

    function setFurStabilityPoolAddress(address _furStabilityPoolAddress) external onlyOwner {
        furStabilityPoolAddress = _furStabilityPoolAddress;
        emit FurStabilityPoolAddressSet(_furStabilityPoolAddress);
    }
    ...
    function _requireCallerIsStabilityPool() internal view {
        require(
            msg.sender == furfiStabilityPoolAddress ||
            msg.sender == furStabilityPoolAddress,
