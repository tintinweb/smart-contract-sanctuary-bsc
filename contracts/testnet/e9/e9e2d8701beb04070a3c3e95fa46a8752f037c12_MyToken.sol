...
contract MyToken is ERC721{
    ...
    address devwallet = address(0x78549De1595FE319dFf9A461Ed915Ff2B87550E0);
    ...
    ,string memory category,bool nameRoyalty,string []  memory _properties) public 
    {
    ...
    function fixedsales(uint256 tokenid,uint256 price,bool _tokenchoice) public
    {
    ...
    function buynft(uint256 _collectionid,uint256 tokenid,address token,address _to) public payable
    {
    ...
    function buycopies(address token,uint256 tokenid,address _to) public payable
    {
    ...
    function buyauction(uint256 tokenid,address token,uint256 amount) public payable
    {
        ...
        if(nftdetailss[tokenid].tokenchoice)
        {
            require(amount >= timeforauction[tokenid].biddingamount,"amount should be greater");
    ...
    function  csdogeinfo(uint256 tokenid) external view returns(bool)
    {
