...
contract ActionWorld {
    ...
    uint256 public constant INVEST_MIN_AMOUNT = 100;
    ...
    uint256[7] public defaultPackages = [100, 500, 1000];
    ...
    function invest(address referrer, uint256 amount) public {
        ...
        poolAmount =
            poolAmount +
            amount.mul(POOL_FEE.div(2)).div(PERCENTS_DIVIDER);
    ...
    function withdrawal() external {
        ...
        poolAmount =
            poolAmount +
            TotalBonus.mul(POOL_FEE.div(2)).div(PERCENTS_DIVIDER);
