...
contract KittenCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KittenCat";
    string private _symbol = "KittenCat";
    uint8 private _decimals = 9;

    address public marketingWallet = 0x6660f64B27EA47F5983bD6B0dD6635758895c45d;
    address public developerWallet = 0x9997eA1C1362c8D30A1B24d4fc2A483222946447;
