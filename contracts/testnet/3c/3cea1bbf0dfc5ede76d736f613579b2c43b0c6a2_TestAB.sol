...
interface IDividendDistributor {
    ...
    function nest() external payable;
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20 (0xcbf797f707F3A608C5e39B069db0227d82519448);
    ...
    function nest() external payable override onlyToken {
   ...
   contract TestAB is IBEP20, Auth { 
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "TestAB";
    string constant _symbol = "TestAB";
    ...
    uint256 rewardFeeBuy = 10;      //Reward might be turned on later
    uint256 teamFeeBuy = 10;        //Team Fee
    uint256 marketingFeeBuy = 1;   //Marketing 
    uint256 devFeeBuy = 1;         //Dev Fee
    uint256 burnFeeBuy = 0;        //Default sends to Dead adress
    uint256 totalFeeBuy = marketingFeeBuy + liquidityFeeBuy + rewardFeeBuy + teamFeeBuy + burnFeeBuy + devFeeBuy + BuybackFeeBuy;
    

    // Set sell fees
    uint256 liquidityFeeSell = 1;
    uint256 BuybackFeeSell = 0;
    uint256 rewardFeeSell = 10;
    uint256 teamFeeSell = 10;
    uint256 marketingFeeSell = 1;
    uint256 devFeeSell = 1;
    uint256 burnFeeSell = 0;
    uint256 totalFeeSell = marketingFeeSell + liquidityFeeSell + rewardFeeSell + teamFeeSell + burnFeeSell + devFeeSell + BuybackFeeSell;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9664Acb5825018Ee9E5600d3804c3939a2FeD58a; //Marketing wallet
        devFeeReceiver = 0x9664Acb5825018Ee9E5600d3804c3939a2FeD58a; //Dev fee
    ...
    function swapBack() internal swapping {
        ...
        try distributor.nest{value: amountBNBteam}() {} catch {}
    ...
    function setBuyFees(uint256 _liquidityFeeBuy, uint256 _BuybackFeeBuy, uint256 _rewardFeeBuy, uint256 _teamFeeBuy, uint256 _marketingFeeBuy, uint256 _devFeeBuy, uint256 _burnFeeBuy, uint256 _feeDenominator) external authorized {
    ...
    function updateBuyFees() private{
        totalFeeBuy = liquidityFeeBuy.add(BuybackFeeBuy).add(rewardFeeBuy).add(teamFeeBuy).add(marketingFeeBuy).add(devFeeBuy).add(burnFeeBuy);
    }
    
    function updateSellFees() private{
        totalFeeSell = liquidityFeeSell.add(BuybackFeeSell).add(rewardFeeSell).add(teamFeeSell).add(marketingFeeSell).add(devFeeSell).add(burnFeeSell);
    }


    function setSellFees(
        uint256 _liquidityFeeSell, uint256 _BuybackFeeSell, uint256 _rewardFeeSell, uint256 _teamFeeSell, uint256 _marketingFeeSell, uint256 _devFeeSell, uint256 _burnFeeSell, uint256 _feeDenominator) external authorized {
