...
contract HibbyReflective is Context, IERC20, AccessControlEnumerable {
    ...
    constructor (address _teamWallet, address _developmentWallet, address _marketingWallet) {
        ...
        fees.deductedFee = 10;  //Deduction 10%
        fees.reflectionFee = 50; //Reflection fee 50% of Deduction
        fees.taxFee = 50; //Tax 50% of Deduction
        fees.teamWalletFee = 50; //Team wallet fees 50% of tax
        fees.developmentFee = 25; //Development fees 25% of tax
        fees.marketingFee = 25; //Marketing fees 25% of tax
    ...
    function burnFrom(address account, uint256 amount) public onlyRole(GAME_ROLE) {
    ...
    function _reflectFee(uint256 rFee, uint256 tFee) private {
        ...
        uint256 rTax = (rFee.mul(fees.taxFee)).div(100);
        uint256 tTax = (tFee.mul(fees.taxFee)).div(100);

        uint256 rTeamAmount = (rTax.mul(fees.teamWalletFee)).div(100);
        uint256 tTeamAmount = (tTax.mul(fees.teamWalletFee)).div(100);
        
        _rOwned[wallets.teamWallet] = _rOwned[wallets.teamWallet].add(rTeamAmount);
        _tOwned[wallets.teamWallet] = _tOwned[wallets.teamWallet].add(tTeamAmount);

        uint256 rDevelopmentAmount = (rTax.mul(fees.developmentFee)).div(100);
        uint256 tDevelopmentAmount = (tTax.mul(fees.developmentFee)).div(100);
        _rOwned[wallets.developmentWallet] = _rOwned[wallets.developmentWallet].add(rDevelopmentAmount);
        _tOwned[wallets.developmentWallet] = _tOwned[wallets.developmentWallet].add(tDevelopmentAmount);


        uint256 rMarketingAmount = (rTax.mul(fees.marketingFee)).div(100);
        uint256 tMarketingAmount = (tTax.mul(fees.marketingFee)).div(100);
        
        _rOwned[wallets.marketingWallet] = _rOwned[wallets.marketingWallet].add(rMarketingAmount);
        _tOwned[wallets.marketingWallet] = _tOwned[wallets.marketingWallet].add(tMarketingAmount);

        uint256 rRefectAmount = (rFee.mul(fees.reflectionFee)).div(100);
        uint256 tRefectAmount = (tFee.mul(fees.reflectionFee)).div(100);
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256) {
        uint256 tFee = (tAmount.mul(fees.deductedFee)).div(100);
