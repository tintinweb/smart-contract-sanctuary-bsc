...
contract ExchangeCore is ReentrancyGuarded, Ownable {
    ...
    bytes32 public constant DOMAIN_SEPARATOR = 0x9b4c71a2e6923d5d90687433106bde7af8b3f388bb1156e10b1e713b1c984812;
    ...
    function validateOrderer(bytes32 hash, Order memory order, Sig memory sig)
        internal
        view
        returns (string)
    {
        ...
        /* fallback — attempt EIP-1271 isValidSignature check. */
        return __tryContractSignature(order.maker, hash, sig);
    }

    function __tryContractSignature(address orderMaker, bytes32 hash, Sig memory sig) internal view returns (string) {
