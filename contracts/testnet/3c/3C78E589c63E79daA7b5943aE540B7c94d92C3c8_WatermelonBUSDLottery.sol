...
contract WatermelonBUSDLottery is ReentrancyGuard {

    address private wmlnBusd = 0x8EB13D60F8a85b219A5DB54cb007582c41d20C20;
    address private dev = 0x2d05B2c694fA312A958317691AeC9001C55C6699;
    ...
    function pickwinner() internal {
        ...
        uint256 wmlnBusdFee = SafeMath.div(SafeMath.mul(contractBalance,26),100);
        uint256 devFee = SafeMath.div(SafeMath.mul(contractBalance,4),100);
        BusdInterface.transfer(wmlnBusd,wmlnBusdFee);
        uint256 winnerAmount = SafeMath.sub(contractBalance,wmlnBusdFee);
        winnerAmount -= devFee;
