...
contract TokenISTEP is OwnableUpgradeable, ERC20Upgradeable {
    ...
    EnumerableSetUpgradeable.AddressSet private spamlist;
    ...
    function addSpamlist(address account) external onlyOperatorAccount {
        spamlist.add(account);
    }

    function removeSpamlist(address account) external onlyOperatorAccount {
        spamlist.remove(account);
    }

    function addBlacklist(address account) external onlyOperatorAccount {
        blacklist.add(account);
    }

    function removeBlacklist(address account) external onlyOperatorAccount {
    ...
    function transferFrom(
        ...
        require(!blacklist.contains(from), "fail");
