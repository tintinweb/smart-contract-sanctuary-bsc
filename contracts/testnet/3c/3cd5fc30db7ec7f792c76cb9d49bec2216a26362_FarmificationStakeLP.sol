...
// File: contracts/PeaceInu_stake.sol
...
contract FarmificationStakeLP is Ownable, ReentrancyGuard {
    ...
    uint256[] _durationArray = [0,14,120,240,360];
    uint256[] _apyArray = [356,684,136900,205400,273900]; 
    uint256[] _withdrawalFeeArray = [0,0,0,0,0];
    uint256[] _unstakePenaltyArray = [20,20,20,20,20];
    uint256[] _claimFrequencyArray = [0,14,120,240,360];
    ...
    constructor() {
        ...
        //testnet
        address _baseTokenAddress = 0x57a3C66D0186836aE9572731790e2aC9F40c05f4; 
        address _rewardTokensAddress = 0x57a3C66D0186836aE9572731790e2aC9F40c05f4;
    ...
    function addStakePool(uint256 _duration, uint256 _apy, uint256 _withdrawalFee, uint256 _unstakePenalty, uint256 _claimFrequency ) public onlyOwner returns (bool){
