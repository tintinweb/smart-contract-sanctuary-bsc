...
contract TokenAA is ERC20, ReentrancyGuard {
    
    constructor() ERC20("TokenAA", "TKN") {
...
//TODO: Convert all BNB context to BNB
contract Vendor is ReentrancyGuard, Ownable {
    // Token Contract
    TokenAA tokenAA;

    // Token price for BNB
    uint256 public tokensPerBNB = 1;

    // This event will print out buying tokens
    event BuyTokens(address buyer, uint256 amountOfBNB, uint256 amountOfTokens);

    constructor(address tokenAddress) {
        tokenAA = TokenAA(tokenAddress);
    }
