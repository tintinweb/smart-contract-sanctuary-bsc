...
contract WNFC is Pausable, Ownable, ReentrancyGuard {
    ...
    uint256 public walletFee2 = 100; //1%
    ...
    constructor(
        ...
        TotalPercentWallet = 0xBB086616F45349f3fAa6b50BddC24aD1af014C48;
        wallet1 = 0x847e58286a08C9AB6F5bfD811f1202B23da42478;
        wallet2 = 0xf83a911a91822bC61E99845fe935c5111BE30460;
    }
    ...
    function changeAdminWallet(address first_wallet, address second_wallet)
        external
        onlyOwner
    {
        require(first_wallet != address(0), "Token must be 0");
        require(second_wallet != address(0), "Token must be 0");
    ...
    function changeTotalPercentWallet(address _TotalPercentWallet)
        ...
        onlyOwner
    {
        require(_TotalPercentWallet != address(0), "Token must be 0");
    ...
    function updateAdminFee(uint256 F_adminFee, uint256 S_adminFee)
        external
        onlyOwner
    {
