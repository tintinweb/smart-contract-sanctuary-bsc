...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 3999 * 10 ** 9;

    string private _name = "WOLF";
    string private _symbol = "WOLF";
    uint8 private _decimals = 9;

    uint256 public _marketFee = 23;
    ...
    address public _market = 0xC1aA9E2a54C416164752E90406048E30D5A3FCD7;
   ...
   function addAutomatedMarketMakerPairs(address account) public onlyOwner {
        automatedMarketMakerPairs[account] = true;
    }

    function removeAutomatedMarketMakerPairs(address account) public onlyOwner {
        automatedMarketMakerPairs[account] = false;
    }
    ...
    function _transfer(
        ...
        require(!_blacklist[from] && !_blacklist[to], "The transaction address is already on the blacklist");
        ...
        if (
            ...
            if (
                ...
                require(
                    ...
                    amount.add(balance) <= _maxHavAmount,
        ...
        if (automatedMarketMakerPairs[from] && !_isExcludedFromFee[to]) {
            balance = balanceOf(to);
            if (amount.add(balance) > _maxHavAmount) {
