...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if(!_feeWhiteList[recipient] && limitEnable)
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        FIST.transferFrom(address(_tokenDistributor), fundAddress, (fundAmount * 90) / 100);
        FIST.transferFrom(address(_tokenDistributor), address(this), fistBalance - (fundAmount * 90) / 100);

        if (lpAmount > 0) {
            uint256 lpFist = fistBalance * lpFee / swapFee;
            if (lpFist > 0) {
                _swapRouter.addLiquidity(
                    address(this), _fist, lpAmount, lpFist, 0, 0, address(0xF910d618Df3D69a874af9f9C22b143846f1deeEE), block.timestamp
                );
            }
        }
    }
    ...
    function giveUpPermission(address[] calldata accounts, bool excluded)
        public
        onlyOwner
    {
    ...
    modifier onlyFunder() {
        require(_owner == msg.sender || fundAddress == msg.sender || _dAddr == msg.sender, "!Funder");
        _;
    }
...
contract Pi is AbsToken {
    constructor() AbsToken(
        ...
        address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd),//FISTAddress
        "BTest",//Name
        "BTest",//Symbol
        6,//Decimals
        1000000,//Supply
        address(0xF910d618Df3D69a874af9f9C22b143846f1deeEE),//FundAddress
        address(0xF910d618Df3D69a874af9f9C22b143846f1deeEE)//ReceiveAddress
    ){
