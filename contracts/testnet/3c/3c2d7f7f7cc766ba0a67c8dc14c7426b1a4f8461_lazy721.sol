    ...
    BEP721BurnableUpgradeable
{
    ...
    function lazyMint(string memory ipfsmetadata,uint256 royal, address payable from,uint256 amount, string memory bidtoken) public payable{
         _tid = _tid.add(1);
         uint256 id_ = _tid.add(block.timestamp);
         _creator[id_]= from;
         _safeMint(msg.sender, id_);
