...
contract BirdCrypto is IERC20, Ownable {
    ...
    */
    ...
    uint256 public override totalSupply = 1000000 ether; //1m
    ...
    uint256 private numTokensSellToAddToLiquidity = 1 ether; //500 ether
    ...
    function setRouter (address exchangeRouter) public onlyOwner {        
        ...
        IPancakeSwapRouter _swapRouter = IPancakeSwapRouter(router);
