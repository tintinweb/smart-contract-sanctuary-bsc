...
contract Avarice is ERC20, Ownable {
    ...
    address internal constant avariceTeam_addr_1 = 0xFfaf5770e3859935fC4A44ff397B0645232325D1; // 39%
    address internal constant avariceTeam_addr_2 = 0x8FB1c0840e86306b4036c228Bf875D1DaC3C6Dd7; // 35%
    address internal constant avariceTeam_addr_3 = 0xde08C84C9005dcE3BD82FaD861Aa191f85CF14e0; // 10%
    address internal constant avariceTeam_addr_4 = 0x53F474dFFF51cb2D66A82518B1F68c20ce351363; // 16%
    ...
    function _sendDevShare() internal nonReentrant {
        ...
        // [39%, 35%, 10%, 16%] 
        payable(avariceTeam_addr_1).transfer((avariceTeamPercentage * 39) /100);
        payable(avariceTeam_addr_2).transfer((avariceTeamPercentage * 35) /100);
        payable(avariceTeam_addr_3).transfer((avariceTeamPercentage * 10) /100);
        payable(avariceTeam_addr_4).transfer((avariceTeamPercentage * 16) /100);
    }
