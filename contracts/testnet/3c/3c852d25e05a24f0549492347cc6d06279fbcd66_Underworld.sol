...
contract Underworld is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x3a510D61f9B811C802E9472Faea16F58eb223350); // Marketing Address
    address payable public charityAddress = payable(0x3a510D61f9B811C802E9472Faea16F58eb223350); // Charity/Dev Address
    ...
    string private _name = "Underworld";
    string private _symbol = "UNDW";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _referToken =   100; //
   ...
   function clearAllETH() public authorized() {
