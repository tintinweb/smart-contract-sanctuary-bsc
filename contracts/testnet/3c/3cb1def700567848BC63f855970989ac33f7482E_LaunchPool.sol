    ...
    StakingTierModels
{
    ...
    function cancel() external virtual override whenOpening onlyManagerOrOwner {
        ...
        emit ChangeStatus(_factory, _status);
    }
        ...
        onlyManagerOrOwner
    {
        ...
        if (_saleType != _poolInfo.saleType) {
            ...
            emit UpdateSaleType(_factory, _saleType);
        }
        ...
        onlyManagerOrOwner
    {
        ...
        emit Register(_factory, user, 0, slot);
    }
        ...
        onlyUnRegister
    {
        ...
        emit Register(_factory, sender, uTier.amount, uTier.slot);
    }
    ...
    function unregister() external virtual whenOpening onlyRegistered {
        ...
        emit UnRegister(_factory, sender, 0, 0);
    }
        ...
        onlyRegistered
    {
        ...
        emit BuyTierRound(_factory, user, amount);
    }
        ...
        onlyRegistered
    {
        ...
        emit BuyCommunityRound(_factory, user, amount);
    }
    ...
    function emergencyWithdraw() external virtual override {
        ...
        emit EmergencyWithdraw(_factory, user, amount.sub(fee), fee);
    }
    ...
    function withdraw() external virtual override {
        ...
        emit Withdraw(_factory, user, amount);
    }
    ...
    function claim(uint32 _index) external virtual override {
        ...
        emit Claim(_factory, user, _index, freezeAmt);
    }
...
interface ILaunchPool {
    ...
    event ChangeStatus(
        address indexed factory,
        SharedConstants.Statuses status
    );
    event UpdateSaleType(
        address indexed factory,
        SharedConstants.SaleType saleType
    );
    event Register(
        address indexed factory,
        address indexed user,
