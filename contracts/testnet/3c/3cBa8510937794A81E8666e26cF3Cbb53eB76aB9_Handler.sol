...
contract Handler is Initializable, OwnersUpgradeable {
    ...
    function setFertilizerType(
        ...
        addons.setFertilizerType(name, durationEffect, rewardBoost, limits, prices);
    }

    uint256 private transientPlotTokenId;
