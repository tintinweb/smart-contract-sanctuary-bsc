    ...
    function _beforeTokenTransfer(
        ...
        for (uint256 i = 0; i < ids.length; ++i) {
            ...
            if ( to == address(0) ){
                ...
                delete _active[ ids[i] ];
                delete _owned[ to ][ ids[i] ];
            ...
            if ( from != address(0) && to != address(0) ) {
                ...
                _owned[ to ].push( _owned[ from ][ ids[i] ] );
                delete _owned[ from ][ ids[i] ];
