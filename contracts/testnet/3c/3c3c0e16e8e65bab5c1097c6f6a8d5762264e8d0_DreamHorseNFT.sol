...
contract DreamHorseNFT is ERC721URIStorage, Ownable {
    ...
    mapping(uint256 => uint256) public NFTIDToImageId;//NFT类型
    ...
    uint256[6] public imageNumber;//NFT图片数量

    mapping(address => bool) public isUser;//tokenId
    ...
    address USDT = 0x1D9ac4508531061Ad4d58373Cc82cb3b57A2526B;

    address recipientAddress = 0x45CbCBf16E1251d2019bEdb940f70Cb6F12068b0;
    ...
    //     //钱转钱包地址,不然咋提取?
    //     // ERC20(USDT).approve(address(this), boxsPrices[boxId - 1] * 10 ** decimals);
    //     ERC20(USDT).transferFrom(user, recipientAddress, boxsPrices[boxId - 1] * 10 ** decimals);
	...
	function createNFTByOwner(address user) public onlyOwner returns (uint256){
        ...
        uint256 number =  (uint256(keccak256(abi.encodePacked(block.timestamp, randNum++,msg.sender)))) % imageNumber[5] + 1;
