...
contract PlearnBenefits is Ownable {
    ...
    function deleteDiscount(string calldata id) external onlyOwner {
    ...
    function getDiscountFor(string calldata id, address user)
        public
        view
        returns (
            uint256 discount,
    ...
    function getDiscount(string calldata id)
        public
        view
        returns (
            uint256 discountForAllUser,
