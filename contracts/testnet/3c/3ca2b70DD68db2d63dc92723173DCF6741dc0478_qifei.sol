...
contract qifei is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "qifei";
    string private _symbol = "qifei";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x9B6407171D5737a6AcdDde73752A3a8E4e2FA376));
        marketingWalletAddress = payable(address(0x15b2FcFF514dF1d718701061003643658e034373));
