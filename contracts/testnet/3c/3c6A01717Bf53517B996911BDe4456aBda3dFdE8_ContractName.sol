...
contract ContractName is Ownable, IBEP20 {
    using SafeMath for uint256;

    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); //Set Supply
    ...
    string constant _name = "ContractName"; //Set the name of your token.
    string constant _symbol = "ContractSymbol"; //Set the symbol of your token.
    ...
    uint256 public liquidityFee = 2; //Fee to LP
    uint256 public marketingFee = 6; // Fee to Marketing wallet

    uint256 public totalFee = 0; //Ignore this
    uint256 public totalFeeIfSelling = 0; //Ignore this
    ...
    uint256 public swapThreshold = _totalSupply * 4 / 2000; //Amount to swap for LP/Marketing -- Set to 0.2% or 2,000,000,000 currently.
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xabFB407Ae7390fc321cB25C8aA0A37b60042B3c5; //Address for LP, must be added to CA manually.
        marketingWallet = 0x23F8F7F82e0aF414880dd3866435EeADcb471842; //Address for marketing fees
