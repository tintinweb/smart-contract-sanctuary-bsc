...
contract MDATokenFactory is Ownable {
    ...
    uint256 private deployPriceMDA = 695482999999999900000; // 695 MDA = 0.1 BNB
    ...
    function deployFree(
        ...
        return address(new ERC20Free(name, symbol, supply));
    }
    ...
    function deployPaidBNB(
        ...
        if (tokenType == 1)
            return address(new ERC20Standard(name, symbol, decimals, supply));
        if (tokenType == 2)
            return address(new ERC20Burnable(name, symbol, decimals, supply));
        if (tokenType == 3)
            return address(new ERC20Mintable(name, symbol, decimals, supply));
...
contract ERC20Standard is ERC20 {
    ...
    constructor(
        ...
        _mint(_msgSender(), supply * 10**_decimals);
    }
