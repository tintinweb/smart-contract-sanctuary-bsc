...
contract GetTheWealth is IBEP20, Auth {
    ...
    // Addresses
    // Testnet
    address BETH = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    // Mainnet
    ...
    constructor () Auth(msg.sender) {
        ...
        _allowances[autoLiquidityReceiver][address(router)] = type(uint256).max;
        ...
        // _balances[_presaler] = _maxWalletToken * (10 ** _decimals);
        // emit Transfer(address(0), _presaler, _maxWalletToken * (10 ** _decimals));
        // uint256 initialLiq = _totalSupply.sub(_maxWalletToken * (10 ** _decimals));
