...
contract StableGrowingCoin is ERC20, ERC20Snapshot, Ownable, ERC20Permit {
    constructor()
        ERC20("Stable Growing Coin", "SGC")
        ERC20Permit("Stable Growing Coin")
    {
