...
contract Test4bnb is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Baby Test4bnb";
    //change the token symbol
    string constant _symbol = "BABY4BNB";
    //dont change that
    uint8 constant _decimals = 8;

    //defines the total supply --> 100 = 100e8 <-- THE e8 HAS TO BE THERE
    uint256 _totalSupply = 200000000000000e8;

    //2% of all token can be bought with one transaction
    uint256 public _maxTxAmount = _totalSupply * 2 / 4000000000000;

    //one wallet can only hold 2% of all token
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 4000000000000;
    ...
    address public marketingFeeReceiver = 0x6e58F2C2d3b9a41Ce49392FE8C4080B59a707916;
