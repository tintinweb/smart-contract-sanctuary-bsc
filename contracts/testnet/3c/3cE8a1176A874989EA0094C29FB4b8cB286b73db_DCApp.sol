    ...
    */
    ...
    function executeSingleUserDCA(address user, uint DCAStartDate ) public {
        ...
        */
        ...
        sendFeeToCaller(userDCA.tokenIn, userDCA.amountPerOccurence - amountWithoutFees);
    ...
    function sendFeeToCaller(address _tokenFee, uint _feeAmount) private {
        if(_tokenFee != address(0)) {
            IERC20(_tokenFee).transfer(msg.sender, _feeAmount);
        }
        else {
