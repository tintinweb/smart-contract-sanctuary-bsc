...
contract MidasOdyssey is Initializable {
    ...
    function initialize() public initializer {
        ...
        mercuryMultiNetworkRouter = IMercuryMultiNetworkRouter(
            0x7F9bf13e2397b9aB0531cF27357f17d553D4DF78
        );

        midasHands = IMidasHands(0x019947846a0351077F83eE57B4AB95f237A45504);
    ...
    function setMidasHands(address _address) external onlyOwner {
        midasHands = IMidasHands(_address);
    }
    ...
    function createNewToken(
        ...
        midasHands.createNewToken(tokenOwner, tokenName, tokenSymbol, supply);
    }
        ...
        returns (uint256)
    {
        ...
        if (availableChainlinkNet[network]) {
            nativeTokenPrice = uint256(
                mercuryMultiNetworkRouter.getNativeNetworkCurrencyPriceInUsd()
            );
        } else {
    ...
    {
        return
            tokenAddress == mercuryMultiNetworkRouter.getNativeTokenAddress(97);
    }
