 ...
 */
contract de is IBEP20, ReentrancyGuard, Context, Ownable {
    using Address for address;
    ...
    uint256 private constant _tTotalSupply = 10 * 10**9 * 10**_decimals; // 10 Billion of tokens
	...
	uint256 public buyMaxTxAmountPercent   = 50; // max permited of 50% from LP on buy transaction
    uint256 public sellMaxTxAmountPercent  = 50; // max permited of 50% from balance on sell transaction
    uint256 public otherMaxTxAmountPercent = 50; // max permited of 50% from balance on other transaction
	...
	uint256 public otherRewardFee = 5; // 5% fee to distribute for holders on other transaction
	...
	uint256 public buyMarketingFee   = 2; // 2% fee to distribute for Marketing wallet on buy
	uint256 public sellMarketingFee  = 2; // 2% fee to distribute for Marketing wallet on sell
	uint256 public otherMarketingFee = 2; // 2% fee to distribute for Marketing wallet on other transaction
