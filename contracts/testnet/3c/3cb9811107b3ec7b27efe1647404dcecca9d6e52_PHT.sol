...
contract PHT is IBEP20, Auth {
    using SafeMath for uint256;
    
    address Reward = 0xab198fDaB33328F13FEC28B4f2C26879C5281a23; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address dev = 0xd7Ae52CCc96206F05378A5e889e5e9553ae68D65;

    string constant _name = "Pixel Hub Token";
    string constant _symbol = "PHT";
    ...
    function setbuyFees(uint256 _rfvFee, uint256 _devFee, uint256 _reflectionFee, uint256 _lpFee) external authorized {
        rfvFee = _rfvFee;
        devFee = _devFee;
        reflectionFee = _reflectionFee;
        lpFee = _lpFee;
        totalFee = _rfvFee.add(_devFee).add(_reflectionFee).add(_lpFee);
    }

    function setsellFees(uint256 _sellrfvFee, uint256 _selldevFee, uint256 _sellreflectionFee, uint256 _selllpFee) external authorized {
        sellrfvFee = _sellrfvFee;
        selldevFee = _selldevFee;
        sellreflectionFee = _sellreflectionFee;
        selllpFee = _selllpFee;
        totalsellFee = _sellrfvFee.add(_selldevFee).add(_sellreflectionFee).add(_selllpFee);
    }
