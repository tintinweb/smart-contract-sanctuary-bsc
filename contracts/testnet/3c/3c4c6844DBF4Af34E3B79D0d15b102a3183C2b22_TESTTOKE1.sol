...
contract TESTTOKE1 is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant public _name    = "Test Toke 1";
    string constant public _symbol  = "TT1";
    ...
    address public marketingFeeReceiver = 0x8638876BB4e001889ad2f4808CCCcC97721DC954;
    address public devFeeReceiver       = 0xbD5751B1037696e34814e00de70fceb63353305e;
    address public charityFeeReceiver   = 0xe1D8a654492E91413E936f05E07d3cA1d34Be63D;
    address public LPReceiver           = 0x7494f9E7Dd93f54eA3C204C4B36FEF58EBF0f7e4;
    ...
    function _transferFrom(
        ...
        if(!isFeeExempt[sender] && !isFeeExempt[recipient]){
            ...
            if (sender == pair) {
                    ...
                    require(contractBalanceRecepient + amount <= _maxWalletAmount,
