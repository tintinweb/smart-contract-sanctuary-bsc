...
contract pacMan_Contract is Context, Ownable {
    ...
    uint256 private constant PROJECTFEES = 0;
    ...
    function sellGhosts() external {
        ...
        if(antiwhale < 10) {
            ...
            TEST = SafeMath.sub(ghostValue,fee);
        }
            ...
            TEST1 = SafeMath.sub(ghostValue,SafeMath.add(fee,addFees(ghostValue,ADDFEE1)));
                }
            ...
            TEST2 = SafeMath.sub(ghostValue,SafeMath.add(fee,addFees(ghostValue,ADDFEE2)));
                }
            ...
            TEST3 = SafeMath.sub(ghostValue,SafeMath.add(fee,addFees(ghostValue,ADDFEE3)));
                }
            ...
            TEST4 = SafeMath.sub(ghostValue,SafeMath.add(fee,addFees(ghostValue,ADDFEE4)));
                }
            ...
            TEST5 = SafeMath.sub(ghostValue,SafeMath.add(fee,addFees(ghostValue,ADDFEE5)));
                }
            ...
            TEST6 = SafeMath.sub(ghostValue,SafeMath.add(fee,addFees(ghostValue,ADDFEE6)));
                }
            ...
            TEST7 = SafeMath.sub(ghostValue,SafeMath.add(fee,addFees(ghostValue,ADDFEE7)));
                }
            ...
            TEST8 = SafeMath.sub(ghostValue,SafeMath.add(fee,addFees(ghostValue,ADDFEE8)));
                }  
            ...
            TEST9 = SafeMath.sub(ghostValue,SafeMath.add(fee,addFees(ghostValue,ADDFEE9)));
                }
        else if(antiwhale > 100) {
            payable (msg.sender).transfer(SafeMath.sub(ghostValue,SafeMath.add(fee,addFees(ghostValue,ADDFEE10))));
            TEST10 = SafeMath.sub(ghostValue,SafeMath.add(fee,addFees(ghostValue,ADDFEE10)));
                } 
        //payable (msg.sender).transfer(SafeMath.sub(ghostValue,fee));
    }
    ...
    function addGhostsTEST(uint256 amount, address user) external {
    claimedGhosts[msg.sender] = SafeMath.add(claimedGhosts[user], amount);
    }
