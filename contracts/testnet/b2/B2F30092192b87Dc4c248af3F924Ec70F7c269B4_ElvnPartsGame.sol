...
contract ElvnPartsGame is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    */
    ...
    function totalStakingPower(uint[5] calldata _parts) public view returns(uint){
    ...
    function addEXPBoostBatch(uint[] calldata _boostId, uint[] calldata _expBoostPower) external onlySetter{
    ...
    function addStakingBoostBatch(uint[] calldata _boostId, uint[] calldata _stakingBoostPower, uint[] calldata _stakingBoostDuration) external onlySetter{
    ...
    function addChestBatch(uint[] calldata _chestId) external onlySetter{
