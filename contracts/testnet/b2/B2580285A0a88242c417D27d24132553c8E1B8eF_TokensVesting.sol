...
// File: contracts/TokensVesting.sol
...
contract TokensVesting {
    ...
    constructor (
        ...
        address revoker_) 
    {
        require(beneficiary_ != address(0), "TokensVesting: beneficiary is the zero address!");
        require(token != address(0), "TokensVesting: token is the zero address!");
        require(revoker_ != address(0), "TokensVesting: revoker is the zero address!");
        require(duration_ > 0, "TokensVesting: duration is 0!");
        require(releasesCount > 0, "TokensVesting: releases count is 0!");
        require(start_.add(duration_) > block.timestamp, "TokensVesting: final time is before current time!");
