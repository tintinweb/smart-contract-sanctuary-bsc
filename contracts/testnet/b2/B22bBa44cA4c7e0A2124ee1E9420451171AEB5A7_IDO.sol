...
contract IDO is Ownable {
    ...
    function claimToken(uint256 claimingTime) public {
        ...
        require(
            Token.balanceOf(sender) >= addressTotalAmount[msg.sender] / price,
            "Pool is out of Token, please try again later"
        );
        
        uint256 amount = addressTotalAmount[msg.sender] * 10**uint256(Token.decimals()) / price;
        Token.transferFrom(sender, msg.sender, amount * percent[index] / 100);
