...
contract TT0612 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    TT0612DividendTracker public dividendTracker;
    ...
    constructor() ERC20("TT0612", "$FD") {
        ...
        dividendTracker = new TT0612DividendTracker(
            payable(this),
            router,
...
contract TT0612DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor(
        ...
        defaultToken = token;
        TT0612Contract = TT0612(mainContract);
    ...
    function _transfer(
        ...
        require(false, "TT0612_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "TT0612_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TT0612 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(TT0612Contract);

            uint256 prevBalance = TT0612Contract.balanceOf(address(this));
            ...
            {
                uint256 received = TT0612Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    TT0612Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
