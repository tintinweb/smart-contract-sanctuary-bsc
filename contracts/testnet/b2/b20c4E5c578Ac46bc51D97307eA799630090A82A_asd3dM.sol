...
contract asd3dM is VRFConsumerBase,ReentrancyGuard {
    ...
    function swapTokens(address token2, uint256 tokenAmount, address to) private {
        ...
        IERC20(token2).approve(address(pancakeRouter), tokenAmount);
    ...
    function swapETHToUSD(uint256 tokenAmount) private {
        ...
        // make the swap
        pancakeRouter.swapETHForExactTokens(
            tokenAmount,
            path,
            address(this), // The contract
            block.timestamp
    ...
    function sendMatic(address payable _to,uint256 value) public payable {
