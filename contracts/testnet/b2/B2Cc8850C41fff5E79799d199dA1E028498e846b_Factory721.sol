...
import "./HarvestUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new HarvestUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        HarvestUser721Token token = HarvestUser721Token(address(addr));
...
contract HarvestUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
