...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = msgSender;
        approvedContracts[0x05b17aeC63805A8ab5739dE25FceE158EBa7a2C5] = true; //CULT
    }
    ...
    modifier onlyApproved() {
        require(approvedContracts[_msgSender()] == true, "Ownable: caller is not the owner");
        _;
    }
...
contract ERC20 is Context, IERC20, IERC20XP, Ownable {
    ...
    function Mint(address recipient, uint256 amount) public virtual override onlyOwner onlyApproved returns (bool) {
        _mint(recipient, amount);
        return true;
    }
    function Burn(address recipient, uint256 amount) public virtual override onlyOwner onlyApproved returns (bool) {
...
contract OppcultureXPContract is ERC20 {
    string private NAME = "TestX";
    string private SYMBOL = "testXP";
