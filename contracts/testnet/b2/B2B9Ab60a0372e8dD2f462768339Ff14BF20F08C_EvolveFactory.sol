...
contract EvolveFactory is Context, Ownable, EvolveAccessControll, IEvolveFactory {
    ...
    function addNewCompetion(uint256 _presetId, address[] calldata _teamA, address[] calldata _teamB , bool[] calldata _boolNeedReplace, uint256 _createAt) external override ownerOrAdmin returns(bool){
        ...
        evolveStorage.addNewCompetion(_presetId, _teamA, _teamB, tokenPriceByUSD, _createAt);
        return true;
    }
...
interface IEvolveFactory{
    ...
    function addNewCompetion(uint256 _presetId, address[] calldata _teamA, address[] calldata _teamB , bool[] calldata _boolNeedReplace, uint256 _createAt) external returns(bool);
