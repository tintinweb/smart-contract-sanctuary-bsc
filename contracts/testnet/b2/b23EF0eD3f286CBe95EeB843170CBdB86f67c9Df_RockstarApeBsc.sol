...
/* Token contract */
contract RockstarApeBsc is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xA1729BE86BCf18a148Bc16cD2187bD958f4586d9;
    ...
    // Name and symbol
    string constant _name = "RockstarApe";
    string constant _symbol = "RockstarApe";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200000000000000000000 / 10000; // 4% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 20000000000000000000 / 10000; // 4% or 5M tokens
    uint256 public _maxWalletToken = ( _totalSupply * 40000000000000000000 ) / 10000; // 4% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6981bf5404d71f71E0B56a08c41a61Ada37D73FE;
