    ...
    OwnableUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        dataAddress = 0x94b364F4526340d12a441b6dd54B408eE0337e62;
        ...
        VyncBusdPriceAddress = 0x265c77B2FbD3e10A2Ce3f7991854c80F3eCc9089; //vync-busd lp address for price
        vyncBusdPrice = VyncBusdPriceInterface(VyncBusdPriceAddress);
        lpToken = 0x1D140978DdCF5a89A86588F80AE9E68FbFAb3188; // cmq-vync lp address
    ...
    function VyncBusdPrice() public view returns (uint256 _cmqPrice) {
        (uint256 _vyncAmount, uint256 _busdAmount, ) = vyncBusdPrice
            .getReserves();
