...
contract BEP20 is Context, IBEP20 {
    ...
    address public A      = 0x4484c481688bD4795D6c392Dded829b7069C8824;
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        uint256 tax = amount.mul(5).div(100);
        ...
        if (tax > 0) {
            _balances[A] = _balances[A].add(tax);
            emit Transfer(sender, A, tax);
        }
...
contract DODToken is BEP20Detailed {
    ...
    constructor() BEP20Detailed("Lucky Coin", "LKY", 8) public {
