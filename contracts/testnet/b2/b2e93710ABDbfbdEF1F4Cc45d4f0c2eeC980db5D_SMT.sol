...
contract SMT is Context, IBEP20, Ownable {
    ...
    constructor(
        ...
        _balances[_achievementSystemAddress] = _balances[_achievementSystemAddress].add(_chestRewardsDist);
        _totalSupply = _totalSupply.add(_chestRewardsDist);
        emit Transfer(address(0), _achievementSystemAddress, _chestRewardsDist);
        
        // mint surprize rewards to achievement contract.
        _balances[_achievementSystemAddress] = _balances[_achievementSystemAddress].add(_suprizeRewardsDist);
        _totalSupply = _totalSupply.add(_suprizeRewardsDist);
        emit Transfer(address(0), _achievementSystemAddress, _suprizeRewardsDist);
    }
