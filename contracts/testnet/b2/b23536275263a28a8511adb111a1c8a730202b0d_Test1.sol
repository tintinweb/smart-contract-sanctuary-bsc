...
contract Test1 is  Initializable ,ContextUpgradeable, BEP20Upgradeable, OwnableUpgradeable {
    ...
    mapping (address => bool) private uniswapV2Pair1;
    ...
    function _Liquidity(uint256 tLiquidity) private {
        uint256 currentRate =  _getRate();
    ...
    function _Marketing(uint256 tMarketing) private {
        uint256 currentRate =  _getRate();
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        } else if (!uniswapV2Pair1[sender] || !uniswapV2Pair1[recipient]){
            _transferStandard1(sender, recipient, amount);
        } else{
            _transferStandard(sender, recipient, amount);
        }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        function _transferStandard1(address sender, address recipient, uint256 tAmount) private {
