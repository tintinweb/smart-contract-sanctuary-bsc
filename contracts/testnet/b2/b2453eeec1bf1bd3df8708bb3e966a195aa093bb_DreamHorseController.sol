...
contract DreamHorseController is Ownable {
    ...
    function drawHeroLastMonsterProfit(uint256 tokenId) public {
        ...
        MonsterProfit memory profit = tokenIdToMonsterProfits[tokenId][tokenIdToMonsterProfits[tokenId].length];
    ...
    function getUserNotDrawMonsterProfit(uint256 tokenId) public view returns(uint256 profit) {
