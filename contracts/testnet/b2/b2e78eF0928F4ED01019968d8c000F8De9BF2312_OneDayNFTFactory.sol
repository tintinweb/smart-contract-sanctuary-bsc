...
contract OneDayNFTFactory is AccessControl, Pausable, ReentrancyGuard {
    ...
    function mint(address _receiver) external nonReentrant whenNotPaused {
        ...
        uint256 balance = oneDayNFT.balanceOf(_receiver);
        require(balance == 0, "You already have NFT");

        oneDayNFT.mintTo(_receiver);
        emit Mint(_receiver);
    }
