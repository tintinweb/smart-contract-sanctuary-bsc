...
// File: contracts/JeetPack/JeetPackStake.sol
...
contract JeetPackStake is Ownable, ReentrancyGuard {
    ...
    uint256[] _durationArray = [7,14,30];
    ...
    constructor() {
        address _baseTokenAddress = 0x214CB76B1fC2932D345a9ec12F88D1bfc3ECB7D4; 
        address _rewardTokensAddress = 0x214CB76B1fC2932D345a9ec12F88D1bfc3ECB7D4;
