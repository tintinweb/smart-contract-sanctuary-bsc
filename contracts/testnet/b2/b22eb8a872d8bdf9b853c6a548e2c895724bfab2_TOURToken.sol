...
contract SmartVault {
    ...
    function initialize(IERC20 _usdtToken, IERC20 _tourToken) external {
        require(address(usdtToken) == address(0), "has been initialized");
        usdtToken = _usdtToken;
        tourToken = _tourToken;

        usdtToken.approve(address(tourToken),  ~uint256(0));
    }
...
contract TOURToken is ERC20, SafeOwnable {
    ...
    IERC20 public usdtToken;
    address public nftDividendAddress=0xa7E3b1EF98CD7287b62fF21d27716916a10f896e;
    address public blackHoleAddress=0x000000000000000000000000000000000000dEaD;
    address public shareholderAddress=0xa7E3b1EF98CD7287b62fF21d27716916a10f896e;
    address public fundAddress=0xa7E3b1EF98CD7287b62fF21d27716916a10f896e;
    
    address public lpReceiver=0xa7E3b1EF98CD7287b62fF21d27716916a10f896e;
    ...
    constructor() ERC20("TOUR", "TOUR") {
        _setupDecimals(18);
        usdtToken = IERC20(0x62E79D3f16acBdbfe73913A9Ab2f27FBd657a837);
        IFactory _factory=IFactory(0xAe0900440e3bf9936154df4d6e3B008284f48235);
        IRouter _router=IRouter(0x08d13aFC01a32E7730244a9a04f74a349F57Ff10);
        liquidity = _factory.createPair(0x62E79D3f16acBdbfe73913A9Ab2f27FBd657a837, address(this));
        router = _router;
    ...
    function swapAndLiquify() private lockTheSwap {
        ...
        addLiquidity(usdtToken.balanceOf(address(this)), otherHalf);

        emit SwapAndLiquify(half, usdtToken.balanceOf(address(this)), otherHalf);
    }
