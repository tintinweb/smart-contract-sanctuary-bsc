...
contract UberTaxiController5 is Ownable {
    ...
    function openBlindBox() public {
        ...
        UTD.setUtaxiDetails(msg.sender, 6, "openBlindBox", UTD.blindBoxPrice().div(10 ** 18), block.timestamp);
    ...
    function buyVehicle(uint256 index, uint8 tokenType) public {
        ...
        if (tokenType == 1) {
            ...
            UTD.setUtaxiDetails(msg.sender, 6, 'ids', uPrice.div(10 ** 18), block.timestamp);
        }
