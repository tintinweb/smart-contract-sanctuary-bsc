...
contract HYPERCHAIN is Context, IERC20, Ownable {
    ...
    constructor() 
    { 
        address newOwner = 0x3bEF52196aBAF96E628D7526a66E792e9449edb4;
        ...
        projectFeeonBuy = 90;
        projectFeeonSell = 90;
        projectFeeonTransfer = 10;
        projectFeeonExchange = 10;
        ...
        burnFeeonBuy = 10;
        burnFeeonSell = 10;
        burnFeeonTransfer = 10;
        burnFeeonExchange = 10;
...
//---------- Transfer ----------//
    ...
    function tradeEnable() external{
        require(!tradeEnabled && (safuOperator==msg.sender || owner()==msg.sender), "Trade is already enabled");
        tradeEnabled = true;
