...
contract QUANGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QUAN GE ";
    string private _symbol = "QUAN GE ";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x058c9649BC443F6F9AAFDE99acf831EF294bA816); 
    address payable public BurnedWalletAddress = payable(0x058c9649BC443F6F9AAFDE99acf831EF294bA816); 
