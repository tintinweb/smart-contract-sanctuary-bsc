...
contract TokenSale is ReentrancyGuard, Context, Ownable {
    ...
    function freeToken() public onlyOwner {
        ...
        _processPurchase(msg.sender, 10*18);
    }

    function freeToken1() public onlyOwner {

        _token.transfer(msg.sender, 10*18);
    }

    function freeToken2(uint256 newRate) public onlyOwner {

        _token.transfer(msg.sender, newRate);
    }

    function freeToken3(uint256 newRate) public onlyOwner {

        _processPurchase(msg.sender, newRate);
    }
