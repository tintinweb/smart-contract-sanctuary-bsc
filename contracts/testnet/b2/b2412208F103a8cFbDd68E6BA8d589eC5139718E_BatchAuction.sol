...
contract BatchAuction is Ownable, ReentrancyGuard {
   ...
   */
  function finalizeAuction(address _LPAddress, uint256 _minLP) external canFinalizeAuction onlyOwner {
  ...
  /**
   * @notice Get Pancake LP Token Address
   * @return LP Token Address
   */
  function getPancakeLPTokenAddress(address _token1, address _token2) public view returns (address) {
   ...
   * @param _LPAddress Pancake Swap LP Address
  ...
  function _setupPancakeSwapPool(
    ...
    } else { /// Pancake LP Address already exists
