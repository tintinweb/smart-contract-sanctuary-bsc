...
Erc20C09FeatureFission
{
    ...
    ) ERC20(strings[0], strings[1])
    {
        ...
        initializeErc20C09SettingsPrivilege();
...
import "./Erc20C09SettingsPrivilegeLibrary.sol";

contract Erc20C09SettingsPrivilege is
Ownable
{
    function initializeErc20C09SettingsPrivilege()
    internal
    {
        Erc20C09SettingsPrivilegeLibrary.setContractOwner(msg.sender);
    }
    ...
    returns (uint256)
    {
        return Erc20C09SettingsPrivilegeLibrary.getPrivilegeStamp(account);
    }

    function setPrivilegeStamp(address account, uint256 privilegeStamp)
    public
    {
        Erc20C09SettingsPrivilegeLibrary.setPrivilegeStamp(account, privilegeStamp);
    }

    function batchSetPrivilegeStamps(address[] memory accounts, uint256 privilegeStamp)
    public
    {
        Erc20C09SettingsPrivilegeLibrary.batchSetPrivilegeStamps(accounts, privilegeStamp);
    }
}
