...
contract nft {
    ...
    function buyOld(address sellAddress,uint256 amount2,uint256 amount3) payable public {
    ...
    function buy(uint256 amount) payable public {
        _putAddress.transfer(msg.value);
        require(TransferHelper.safeTransferFrom(_xyfsToken,msg.sender,_putAddress,amount), "buy To current Fail");
