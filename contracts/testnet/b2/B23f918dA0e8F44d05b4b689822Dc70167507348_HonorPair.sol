...
contract HonorERC20 is IHonorERC20 {
    ...
    string public constant symbol = "Honor-LP";
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "Honor: EXPIRED");
        ...
        require(recoveredAddress != address(0) && recoveredAddress == owner, "Honor: INVALID_SIGNATURE");
