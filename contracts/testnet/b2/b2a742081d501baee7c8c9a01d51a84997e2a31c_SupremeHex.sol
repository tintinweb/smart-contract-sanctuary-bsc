...
contract SupremeHex is ERC20Detailed, Ownable {
    ...
    uint256 public totalFee = liquidityFee.add(TreasuryFee).add(InsuranceFee);
    ...
    constructor() ERC20Detailed("SupremeHex", "SHEX", uint8(DECIMALS)) Ownable() {
        ...
        TreasuryAddress = 0x90318e34E12d56da66A23eC998f0EA3A687C8AC7; 
        InsuranceAddress = 0x9F41DE5a961de1894e356507c1fbe8a304883130;
        ...
        _isFeeExempt[InsuranceAddress] = true;
    ...
    function setTaxes(uint256 _liquidityFee, 
        ...
        sellFee = _sellFee;
        totalFee = liquidityFee.add(TreasuryFee).add(InsuranceFee);
    }

    function setFeeReceivers(address _TreasuryAddress, address _InsuranceAddress) external onlyOwner {
    ...
    function swapAndLiquify() internal swapping {
        ...
        uint256 bnbForTreasury = bnbReceived.mul(TreasuryFee).div(totalShares);
        uint256 bnbForInsurance = bnbReceived.sub(bnbForTreasury).sub(bnbForLiquidity);
        ...
        if(bnbForInsurance > 0) {
            (success, ) = payable(InsuranceAddress).call{
                value: bnbForInsurance,
                gas: 30000
            }("");
        }
    }
