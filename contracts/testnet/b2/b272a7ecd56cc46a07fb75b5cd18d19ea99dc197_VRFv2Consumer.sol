...
contract VRFv2Consumer is VRFConsumerBaseV2 {
  ...
  function betUp() public payable{
    rollDice(1);
  }

  function betDown() public payable{
    rollDice(0);
  }

  // Assumes the subscription is funded sufficiently.
  function rollDice(uint16 _bet) internal {
  ...
  function fulfillRandomWords(uint256 requestId, uint256[] memory randomWords ) internal override {
    ...
    playerCurrentResult1[playerAddress] = randomWords[0].mod(5).add(1);
    playerCurrentResult2[playerAddress] = randomWords[1].mod(5).add(1);
    ...
    */
    ...
    //bet =  Bet(requestId, playerCurrentResult1[playerAddress], playerCurrentResult2[playerAddress], betValue[s_requestId], true, block.timestamp);
    //userBets[playerAddress].push(bet);

    //addBets(requestId, betValue[s_requestId], playerCurrentResult1[playerAddress],playerCurrentResult2[playerAddress], true);
  ...
  function addBets(address _playerAddress, uint256 _requestId, uint256 _bet, uint256 _amount, uint256 _dice1Result, uint256 _dice2Result, bool _isWon) public {
