...
//  Site info
  ...
  function setIswhitelist(bool _iswhiteList) external onlyTokenOwner {
    iswhitelist = _iswhiteList;
  }
    ...
    icoActive
  {
    ...
    require(iswhitelist && existWhiteList[msg.sender] || iswhitelist == false, "You are not whitelist");
...
contract PresaleFactories is Ownable {
    ...
    uint256 private pricePresale = 0.1 ether;
    constructor() {
