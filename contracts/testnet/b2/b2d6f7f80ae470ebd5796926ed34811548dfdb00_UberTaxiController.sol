...
contract UberTaxiController is Ownable {
    ...
    function scrapVehicleToActive(uint256 index) public onlyOwner {
        allVehicles[index].durability = 100;
        allVehicles[index].expireTime = 0;
    }
    ...
    function queryUserScrapVehicleLists(address addr) public view returns(MyVehicle[] memory lists,uint256[] memory price){
