...
contract SAFU is ERC20, Ownable {
    ...
    {   
        ...
        marketingWallet = 0x297CdbD45033a020699102925d3D68efc3071b95;
        ...
        poolThresholdValue = 2 * (10 ** 17); // 0.2 BNB;
    }
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        uint256 _totalFees;
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to] || swapping || poolThreshold) {
            _totalFees = 0;
