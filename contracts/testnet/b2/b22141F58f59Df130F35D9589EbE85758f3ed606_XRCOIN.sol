...
contract XRCOIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x9965507D1a55bcC2695C58ba16FB37d819B0A4dc); // Marketing Address

    address payable public devAddress =
        payable(0x976EA74026E726554dB657fA54763abd0C3a0aa9); // Developer Address

    address payable public liquidityAddress =
        payable(0x14dC79964da2C08b23698B3D3cc7Ca32193d9955); // Liquidity Address
    ...
    uint256 private minimumTokensBeforeSwap = 1 ; //_tTotal * 5 / 10000; // 0.05%
