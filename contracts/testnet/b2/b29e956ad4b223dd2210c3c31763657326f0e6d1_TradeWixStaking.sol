...
contract TradeWixStaking is ReentrancyGuard, Ownable {
    ...
    uint256[5] public Duration = [2 weeks, 4 weeks, 6 weeks, 8 weeks , 10 weeks];
...
//     }
    ...
    function withdraw(uint256 orderId) public nonReentrant{
        ...
        uint256 stakeDays = totalStakeTime.div(86400);
        uint256 reward = rewardRatePerDay.mul(stakeDays);
