...
contract BlaBlaTest is Context, IERC20, Ownable, Janitable {
    
    // Settings for the contract (supply, taxes, ...)

    uint256 private constant MAX = 200000000;
    uint256 private _tTotal = 200000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _totalClaimed;

    string private _name = "BlaBlaTest";
    string private _symbol = "BlaBla";
