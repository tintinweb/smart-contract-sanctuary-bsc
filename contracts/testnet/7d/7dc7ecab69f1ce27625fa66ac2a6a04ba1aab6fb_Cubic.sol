...
contract Cubic is IBEP20, Auth {
    ...
    function setMaxWalletPercent_base1000(uint256 maxWallPercent_base1000) external onlyOwner() {
        require(maxWallPercent_base1000 >= 1 && maxWallPercent_base1000 <= 100, "max wallet percent out of limit!");
        _maxWalletToken = rSupply.div(1000).mul(maxWallPercent_base1000);
    }

    function setMaxTxPercent_base1000(uint256 maxTXPercentage_base1000) external onlyOwner() {
        require(maxTXPercentage_base1000 >= 1 && maxTXPercentage_base1000 <= 100, "max tx percent out of limit!");
