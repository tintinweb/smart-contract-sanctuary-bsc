...
contract SmartBeComBee {
    ...
    function updB6Referrer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (users[referrerAddress].b6Matrix[level].firstLevelReferrals.length < 2) {
            ...
            emit NewUserPlace(userAddress, referrerAddress, 2, level, place, users[userAddress].b6Matrix[level].reinvestCount, usertype);
    ...
    function updB6(address userAddress, address referrerAddress, uint8 level, bool x2) private {
        if (!x2) {
            ...
            emit NewUserPlace(userAddress, users[referrerAddress].b6Matrix[level].firstLevelReferrals[0], 2, level, place, users[userAddress].b6Matrix[level].reinvestCount, 2);
            emit NewUserPlace(userAddress, referrerAddress, 2, level, 2 + place, users[userAddress].b6Matrix[level].reinvestCount, 2);
            ...
            emit NewUserPlace(userAddress, users[referrerAddress].b6Matrix[level].firstLevelReferrals[1], 2, level, place, users[userAddress].b6Matrix[level].reinvestCount, 2);
            emit NewUserPlace(userAddress, referrerAddress, 2, level, 4 + place, users[userAddress].b6Matrix[level].reinvestCount, 2);
