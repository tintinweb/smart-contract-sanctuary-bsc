 ...
 *  - postRelayedCall
 */
contract GasRelayPaymaster is IPaymaster, Initializable {
    ...
    address private proxyPoolLogic;
    ...
    function _verifyPermission() internal view virtual {
        require(msg.sender == manager, "should have no approvalData");
    }
    ...
    function withdrawToPool() external {
        ...
        payable(proxyPoolLogic).call{value: amount}("");
