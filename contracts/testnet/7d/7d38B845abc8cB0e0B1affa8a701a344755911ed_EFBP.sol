...
contract EFBP is IERC20, Ownable {
    ...
    uint256 public maxWalletTokens = (_totalSupply * 2) / 100; // 0.5% of supply
    uint256 public maxTxAmount = (_totalSupply * 2) / 100; // 0.5% of supply
    ...
    constructor() {
        ...
        if (chainId == 97) {
            ...
            BURN = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
            deployer = 0xfcCaA044c7e1d567b191978Fe998a8C6860f0af0;
        } else {
            REWARD = 0x002d3C280f719c4B0444680A8C4B1785b6cC2A59;
            BURN = 0x002d3C280f719c4B0444680A8C4B1785b6cC2A59;
            deployer = 0xC0E892E39b7dbD478C69dEd07db08ABbEDc19259;
        }
        ...
        charityFeeReceiver = 0xB4f67EE77df5b02E739B55aC18408812fDb24a72;
