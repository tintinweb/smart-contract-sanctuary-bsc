...
// Telegram: https://t.me/NewCommunityTravladd
...
contract NewCommunityTravladd is Context, IERC20, Ownable {
        
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NewCommunity Travladd";
    string private _symbol = "$CTRAV";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa055FE07C0D6cC2aaF7dDcc5f6A98BB57067eEfE);
    address payable public TeamWalletAddress = payable(0x4EFADB9682609af82c4535B2E0594741b8a53077);
    ...
    uint256 public _walletMax = 30 * 10**3 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= (3 * 10**3 * 10**9), "Max wallet should be more than or euqal to 0.3% totalSupply");
    ...
    function removeFromBlackList(address[] calldata addresses) public onlyOwner(){
