...
contract TaurenToken2 is Context, IBEP20, Ownable {
    ...
    address public BUSD = 0x55d398326f99059fF775485246999027B3197955;//0xe52225889DC34fA282Ca9589f2b74aDA27a13b96    0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    ...
    constructor () {
        ...
        TRN = TaurenNFT(0xe1a5748e673F7A6F3F15fe9be1a7fd4A9bc1BAcE);//  main :  0x6753906270A16dc7D1DC391dDFe3990D187551Dc    test:  0xccb681566b9A8252b01F3B29f13Cf51F64B7F806
    ...
    function swapAndCharge(uint256 tokenBalance) public lockTheSwap {
        ...
        ERC20(BUSD).transfer(castingPoolAddr, castingPoolFee);
        ERC20(BUSD).transfer(operationAddr, operationFee);
        ERC20(BUSD).transfer(genesisPoolAddr, genesisPoolFee);

        emit SwapAndCharged(tokenBalance, address(this).balance, newBalance);
    }

    uint256 public chioce = 2;

    function setChioce(uint256 _chioce) external onlyOwner() {
        chioce = _chioce;
    }
    ...
    function rescueBullNFT(uint256 _bullPeriodIndex) public {
        ...
        transferFrom(msg.sender, deadWallet, amount);
    ...
    function pledgeNFT(uint256 types, uint256 tokenId) public {
        ...
        if(types == 2){
            ...
            transfer(castingPoolAddr, tokenAmount);
        }

        tokenIdToPledges[tokenId] = Pledge(tokenId, types, BUSDAmount, tokenAmount, block.timestamp);
