    ...
    ERC721Holder
{
    ...
    function addItemToMarket(
        ...
        if (NFTChecker.isERC1155(nftContract)) {
        ...
        } else if (NFTChecker.isERC721(nftContract)) {
            nftType = "ERC721";
            ...
            revert("error: This NFT address is not ERC721 nor ERC1155");
        }
...
contract NFTChecker is ITest, IERC165 {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return interfaceId == type(ITest).interfaceId || interfaceId == type(IERC165).interfaceId;
    }
}
