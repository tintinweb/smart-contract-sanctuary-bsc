...
contract FundNFTA is Ownable, Pausable,IFundNFTA{
   ...
   function getUSDT_id(uint256 ID_NFTA) public virtual override view returns(uint256) {
        uint256 Summa= One_user_USDT-CheckFundNFTA_USDT[ID_NFTA];
        return Summa;
    } 
   function getMITI_id(uint256 ID_NFTA) public virtual override view returns(uint256) {
        uint256 Summa= One_user_MITI-CheckFundNFTA_MITI[ID_NFTA];
        return Summa;
    }  
}
...
interface IFundNFTA {
    function getUSDT_id(uint256 ID_NFTA) external view returns(uint256);
    function getMITI_id(uint256 ID_NFTA) external view returns(uint256);
}
