...
contract UniswapHelper is Context, Ownable {
    ...
    // function getTokenPrice(uint256 amountA,address tokenA, address tokenB, address router) external{
    //     IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(router);
    //     // address newPairAddress = IUniswapV2Factory(_uniswapV2Router.factory()).getPair(address(this), _uniswapV2Router.WETH());
    // }
    function getPairAddress(address tokenA, address tokenB, address router) external view returns (address pair){
