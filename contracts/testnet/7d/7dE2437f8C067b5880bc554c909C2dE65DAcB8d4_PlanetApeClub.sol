...
contract PlanetApeClub is Context, IERC20, Ownable {
    ...
    address public safuDeployer = 0xFcB2bD89e1Ab0620f1d0e7e684eC918B1b22D784; //This should be the updated by the SAFU Developer to confirm he deployed the contract.
    ...
    constructor() {
        ...
        emit Transfer(address(0), safuDeployer, _tTotal);
    }
