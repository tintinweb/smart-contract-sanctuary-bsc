...
contract Token is Context, Auth, IBEP20 {
    ...
    uint public percentLP = 0;
    uint public percentStaking = 0;
    ...
    address public walletTreasury = 0x5aB9869069d3c32427Cb96178cbB4c783D00FBf2;
    address public walletMarketing = 0xB9710677E6ecAE9A0DaaB4051A28B7b4ED4fD587;
    ...
    function setTaxPercent(uint _percentTreasury, uint _percentMarketing, uint _percentLP, uint _percentStaking) external onlyOwner {
        ...
        require((percentTreasury + percentMarketing + percentLP + percentStaking) < 3,"Token: Maximum tax is 3%");
    }
