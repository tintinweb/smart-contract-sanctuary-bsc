...
contract Unisynths is Ownable, ReentrancyGuard {
    ...
    function getBoldPrice() public view returns (uint256) {
        uint256 btcprice = getLatestPrice("0x6b425443"); // kBTC
        uint256 goldprice = getLatestPrice("0x6b474f4c44");    // kGOLD
    ...
    function getSdrPrice() public view returns (uint256) {
        ...
        uint256 cnyprice = getLatestPrice("0x6b434e59"); // kCNY
        uint256 yenprice = getLatestPrice("0x6b59454e");   // kYEN
        uint256 gbpprice = getLatestPrice("0x6b474250");   // kGBP
        uint256 eurprice = getLatestPrice("0x6b455552");  // kEUR
    ...
    function mintSynth(bytes32 _ticker,uint256 _amount) tokenExist(_ticker) nonReentrant public {
        ...
        bytes32 boldHash = keccak256(abi.encodePacked("0x6b424f4c44"));   // kBOLD
        bytes32 sdrHash = keccak256(abi.encodePacked("0x6b534452"));       // kSDR
