...
contract JBLNFT is ERC721{
    ...
    constructor ()  public ERC721("JBL-Iner1", "JBL-Iner1"){
        owner = msg.sender; 
    ...
    function mintCard(address account) public returns (uint256) {
        ...
        string memory name = "JBL-Iner1";
        string memory tokenURI = "https://farms.jblgamefi.io/nft/cheerleading/JBL-Iner1.gif";
