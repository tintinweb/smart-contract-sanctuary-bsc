...
Wallet_Dev = payable(0xd4620F0859A2E251A919476F5517741c19AE1972);

When this wallet, every increase 1bnb added, 0.5bnb will be used to purchase our token.

Record the mantissa of the hash value generated by the purchase.

Purpose:

During this period, the mantissa of the buyer's wallet is greater than 1bnb value, which is a number

The same number indicates that the condition is met.

If no one is eligible, give the token to the following buyers.

5 new buyers after that, greater than 0.5bnb.
...
contract spacedragons is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xE53460ED97c4B23D4D55aE85A7Ae6485f3Bc3668); 
    address payable public Wallet_Dev = payable(0xd4620F0859A2E251A919476F5517741c19AE1972);
    ...
    string private constant _name = " space dragons"; 
    string private constant _symbol = unicode" spacedragon"; 
    ...
    constructor () {
        ...
        _owner = 0xd7716983Bf0F1Bc0Ab27120fC70F9f1C53C0Ff48;
