...
contract SigmaBeans is Context, Ownable {
    ...
    function hatchSigmaEggs(address ref) public {
        require(initialized);
    ...
    function buySigmaEggs(address ref) public payable {
        require(initialized);
