...
contract BrawlTalesNFT is ERC721RoyaltyUpgradeable, ERC721EnumerableUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("BrawlTalesNFT", "BRSNFT");
        __ERC721Enumerable_init();
        __Pausable_init();
        __Ownable_init();
        __ERC721Burnable_init();

        baseURI = "https://cdn.brawltales.com/nft/";
    }
    ...
    function mintMeta(string memory userTransactionGuid) public payable {
        emit mintMetaEvent(userTransactionGuid, msg.sender, msg.value);
    ...
    function setDefaultRoyaltyAmount(address receiver, uint96 feeNumerator) external onlyOwner {
