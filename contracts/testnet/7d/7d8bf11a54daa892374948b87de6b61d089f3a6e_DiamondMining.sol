...
contract DiamondMining {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 1000000000 ether; // 50 BUSD
    ...
    /*! anti-whale */
    uint256 constant public MAX_WITHDRAW = 100000000000 ether; // 2000 BUSD MAX
    uint256 constant public WITHDRAW_COOLDOWN = 0; // 4 HOURS 4 * 60 * 60
