...
/////////////////////////////   EVENTS  /////////////////////////////////////////
    ...
    event AddedAccountWhitelist(address account, bool whitelisted);
...
///// AUTHORIZED FUNCTIONS /////
    ...
    function AddWhitelist(address account, bool whitelist) public authorized {
        if(whitelist == true)
            isWhitelisted[account];
        emit AddedAccountWhitelist(account, whitelist);
    }
...
/////////////////////////////   PRIVATE FUNCTIONS  /////////////////////////////////////////
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if (isSell) {
            ...
            if (whitelistEnabled) {
                require(isWhitelisted[sender], "user not whitelisted");
            }
