...
contract GBridge {
    ...
    function _SaveClaim(bytes32 _submissionId, TransactionsTypes.TxTransfer memory tx) internal {
    ...
    function Transfer(
        ...
        emit TokenChainTransfer(submissionId, _chainId, msg.sender, _to, token, a, nonce);
        _NonceIncrement();
    }
    ...
    function Claim(
        ...
        _CheckProof(_submissionId, _token, _amount, _proofs);
        _SendToken(_token, _to, _amount);
        emit TokenChainTransferClaimed(_submissionId, _chainId, _from, _to, _token, _amount, _nonce);
    }
