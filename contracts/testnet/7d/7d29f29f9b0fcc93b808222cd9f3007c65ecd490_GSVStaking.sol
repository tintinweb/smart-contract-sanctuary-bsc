...
contract GSVStaking {
    ...
    uint[10] public tierAPY1Year = [0 ether,0 ether,0 ether,0 ether,0 ether,0 ether,0 ether,0 ether,0 ether,0 ether];
    ...
    uint[10] public tierAPY2Year = [0 ether,0 ether,0 ether,0 ether,0 ether,0 ether,0 ether,0 ether,0 ether,0 ether];
    ...
    uint[10] public tierAPY3Year = [0 ether,0 ether,0 ether,0 ether,0 ether,0 ether,0 ether,0 ether,0 ether,0 ether];
    ...
    constructor() {
        ...
        stakingToken = IERC20(0x9b5451B2e2cAA5f423D383975c3D36b2BfebAcfD);
