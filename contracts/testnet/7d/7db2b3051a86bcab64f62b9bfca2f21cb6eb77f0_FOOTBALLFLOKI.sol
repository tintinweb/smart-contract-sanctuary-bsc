...
contract FOOTBALLFLOKI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0525676D822D151B290b04429CaaEA97828D335D);
    address payable public devAddress = payable(0x1bE5643ED94166E44BcA4c179148809e13ce0149);
    ...
    bool public isTokenLive = false;      // LFGGGGG!
    uint256 public _maxTxAmount = 10000 * 10 ** 6 * 10 ** 9;
    uint256 public numTokensSellToAddToLiquidity = 25 * 10**6 * 10**9;
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || _isExcludedFromFee[to] || isTokenLive, "SBF is not live yet");
