...
contract Safuu is ERC20Detailed, Ownable {
    ...
    string public _name = "MegaSafuu";
    string public _symbol = "MegaSAFUU";
    ...
    constructor() ERC20Detailed("MegaSafuu", "MegaSAFUU", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xFc12b62Ac8ee160156a227798375d3c8e09a5595;
        treasuryReceiver = 0x15F5dfCb39B92416A1bA2d6E16cdeD4DD1cB44BD; 
        safuuInsuranceFundReceiver = 0x868FC78c6E61500B423f8D1D8eE884730aBD582C;
        firePit = 0xE4C103d84C83894FAe53d13F39295fB814BB10a0;
