...
contract xQuantumtestnet {
    ...
    IERC20 public constant BUSD = IERC20(0x63560751DF908C488f207acb8bf448D6bB20f641); // mainnet BUSD contract on BSC
    IERC20 public constant XQZS = IERC20(0x63560751DF908C488f207acb8bf448D6bB20f641);  //xqzs token adress
    ...
    constructor() { _owner = 0x0B47E6574084b3dC5337B3944E9e1a6a055e8125; }
    ...
    function getMonthlyRewards(uint256 id) external view returns (uint256) {
        ...
        if(block.timestamp >  currentPurchase.lastPayoutTimestamp){
            uint newPayouts = (block.timestamp - currentPurchase.lastPayoutTimestamp) / currentPurchase.payoutPeriodInSeconds;
