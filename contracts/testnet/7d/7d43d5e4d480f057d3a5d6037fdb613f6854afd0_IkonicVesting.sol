...
// uint[] public saleTypeMultiplier = [0,0,5,10,20,0,0,0,6,3,20];
    ...
    function withdrawTokens() public   nonReentrant setStart {
        ...
        if(Investors[msg.sender].isInitialAmountClaimed || Investors[msg.sender].investorType == 1 || Investors[msg.sender].investorType == 5 || Investors[msg.sender].investorType == 6 || Investors[msg.sender].investorType == 7) {
            ...
            */
            ...
            emit TokenWithdraw(msg.sender, amount);}
                ...
                //  uint256 amount = (Investors[msg.sender].initialAmount)*(6)/1
                 timestampp[msg.sender]=block.timestamp;
                 uint pending = (intermediateRelease-timestampp[msg.sender])/day;
