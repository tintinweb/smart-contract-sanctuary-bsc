...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant ETH = address(0x8BaBbB98678facC7342735486C851ABD7A0d17Ca); //ETH
...
contract Kobastest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = payable(address(0x905e160cb1a0febf36078900975CA47aa6D59104)); //marketing wallet
    ...
    constructor() ERC20("kobastest", "KTST") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("kobas_Dividen_Tracker", "kobas_Dividend_Tracker")
    {
        claimWait = 3600;
