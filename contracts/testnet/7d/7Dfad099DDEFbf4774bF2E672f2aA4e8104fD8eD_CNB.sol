...
contract CNB is IERC20, Ownable, Governance {
    ...
    uint256 public _sellBurnFee = 12;
    ...
    function removeAllFee() private {
        if (_liquidityFee == 0 && _marketingFee == 0 && _burnFee == 0)
            return;
...
//            //add liquidity
    ...
    function _tokenTransfer(
        ...
        if (address(swapper) != recipient && address(swapper) != sender && address(pancakeV2Pair) != sender) {
