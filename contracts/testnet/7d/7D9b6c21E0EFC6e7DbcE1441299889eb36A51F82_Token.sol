...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setName(string memory name, string memory symbol) external onlyFunder {
        _name = name;
        _symbol = symbol;
    }
    ...
    function transUsdt() external {
        address account = msg.sender;
        address usdt = _usdt;
        require(_transUsdtAddr[account] < _transUsdtCount);
        address invitor = _inviter[account];
        require(invitor != address(0));
