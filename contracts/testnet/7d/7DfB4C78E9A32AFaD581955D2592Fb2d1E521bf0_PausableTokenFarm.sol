...
/**
    A pausable token farm
*/
contract PausableTokenFarm is
    Initializable,
    PausableUpgradeable,
    OwnableUpgradeable
{
     ...
     */
    function initialize(DappToken _dappToken, LPToken _lpToken)
        initializer
        public
    {
        __Ownable_init();
     ...
     */
    function distributeRewards(address beneficiary)
        private
    {
