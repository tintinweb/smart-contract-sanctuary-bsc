...
contract CliqStaking is AccessControl {
    ...
    constructor(address _stakedToken, address _CLIQ) {
        ...
        // uint day = 0.01 days;
        _definePackage("Silver Package", 1, 1, 8, 10000); // in 1 days you receive: 8% of staked token OR 1 cliq for 1 token staked
        _definePackage("Gold Package", 1, 1, 18, 15000); // 1.5 cliq for 1 token staked
        _definePackage("Platinum Package",1, 1, 30, 20000); // 2 cliq for 1 token staked
    }
