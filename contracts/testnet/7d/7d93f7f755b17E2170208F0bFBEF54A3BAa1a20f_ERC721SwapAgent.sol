    ...
    ERC721Holder
{
        ...
        if (bridgedTokenAddr != address(0x0)) {
            ...
            for (uint256 i = 0; i < tokenIds.length; i++){
                ...
                if (ownerAddress == address(0x0)){
                    ...
                    bridgedToken.setTokenURI(tokenIds[i], tokenURI);
                } else {
    ...
    function isAuthorizedTransaction(bytes32 _hashedMessage, uint8 _v, bytes32 _r, bytes32 _s) internal view returns (bool) {
