...
contract TEST is ERC721Enumerable, Ownable {
    ...
    //Dutch auction logic
    uint256 public startingPrice = 20000000000000000; // 0.02 eth testing only
    uint256 public decrease_interval = 300; // In seconds
    uint256 public decrease_per_interval = 100000000000000; // 0.001 eth
    uint256 public ending_price = 6000000000000000; // 0.006 eth
    uint256 public starting_block;

    //Whitelist
    uint256 public whitelistPrice = 1000000000000000000; // 0.01 eth
    mapping (address => uint256) private _whitelistClaimed;
    // uint256 private _whitelistReserved = 100; //total NFTs reserved for WL mint
