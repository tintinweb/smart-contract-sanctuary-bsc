...
// File contracts/marketplace/MarketplaceV2.sol
...
contract MarketplaceV2 is Initializable, AccessControlUpgradeable, PausableUpgradeable {
  ...
  struct OrderIdToOrderIndex {
    // remove this for the update
    uint256 orderIndex;
    uint256 orderId;
  }

  //OrderIdToOrderIndex[] public ordersDebug; // TODO remove this for the update
  //uint256 public orderCountDebug; // TODO remove this for the update
