...
contract Nusic is ERC721 {
    ...
    function updateSinglesPrice(uint _singlesPrice) public onlyOwner {
        singlesPrice = _singlesPrice;
    }

     function updateCollectionsPrice(uint _collectionPrice) public onlyOwner {
