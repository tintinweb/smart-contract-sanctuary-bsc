...
contract EnergyToken is Context, IBEP20, Ownable 
{
    ...
    constructor () 
    {
        ...
        _isExemptFromTxLimit[burnAddress] = true;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private 
    {
        ...
        if(burnTokens>0) 
        {
            _transferStandard(sender, burnAddress, burnTokens);
        }
        restoreAllFee();
    }
    ...
    function setAllBuyFeePercent(uint256 liquidityFee, uint256 burnFee) external onlyOwner() 
    {
        ...
        require(_liquidityFee.add(_burnFee)<=10, "Too High Fee");

    }


    function setAllSaleFeePercent(uint256 liquidityFee, uint256 burnFee) 
    external onlyOwner() 
    {
        _saleLiquidityFee = liquidityFee;
        _saleburnFee = burnFee;
        require(_saleLiquidityFee.add(_saleburnFee)<=15, "Too High Fee");
    }
