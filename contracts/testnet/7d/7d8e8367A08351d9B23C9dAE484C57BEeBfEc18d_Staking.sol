...
contract Staking is ReentrancyGuard {
    ...
    Stake[] s_stakes;
    mapping(address => bool) s_hasStake;
    ...
    function createStake(uint256 _amount) public {
        ...
        require(s_isSoldOut == false, 'Staking is already sold out');
    ...
    function _calculateReward(uint _amountStaked) internal view returns (uint256 reward) {
        ...
        reward = dailyYield * (s_duration / 1 days);
    }
    ...
    function endStake() external nonReentrant {
        ...
        uint unallocatedReward = rewardBalance - _calculateReward(s_totalSupply);
