...
contract SwapPancakeswap is Ownable {
    ...
    modifier ensureOffset(uint deadlineOffset) {
        require((block.timestamp+deadlineOffset) >= block.timestamp, 'PancakeRouter: EXPIRED');
        _;
    }
    ...
    */
    function tradeFromTokenToBNB(uint256 amountIn, uint256 amountOutMin, address[] calldata path, uint256 deadlineOffset) external onlyOwner {
        require(path.length >= 2, "Length of path needs to be 2 at least");
    ...
    inputIsToken0:
        - true if token0 is the input token
        - false if token1 is the input token
    path NOT USED:
        - [0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684, 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7] [USDT, BUSD]
        - [0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684, 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd] [UDST, WBNB]
        - [0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684, 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd, 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7] [UDST, WBNB, BUSD]
    ...
    [TODO] SOlo he cambiado el nombre... me falta hacerlo todo pero para eso hay que analizar bien el código del pair, el del swapExactTokensForTokens...e incluso alguna library pero vamos creo que es bastante factible, solo es una cuestiónde obtener bien los reserves del token in y del token out, hacer unos multipliaciones/sumas aplicando el fee correcto para cada DEX, hacer la transferencia de los tokens hacia el pair... llamar a swaps... y así sucesivamente 
    Idea: 
    ...
    Pair BUSD-WBNB Pancakeswap: 
        ...
        - token1: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd (WBNB)
     */
    function tradeFromTokenToToken_pairMethod(uint256 amountIn, address pairAddress, bool inputIsToken0, address receiver, uint256 deadlineOffset) external onlyOwner ensureOffset(deadlineOffset){
        ...
        if(inputIsToken0){
            amountInWithFee = amountIn.mul(998);
        ...
        /*
        // DELETE???? Approve that input token IERC20(path[0]) can be spent by the Router
        IERC20(path[0]).approve(
            address(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3),
            amountIn // type(uint256).max
        );*/
    ...
    /**
        ...
        [0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684, 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684, 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684] [USDT(pancake), USDT(pancake), 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684]
        [0x5126C1B8b4368c6F07292932451230Ba53a6eB7A, 0xF855E52ecc8b3b795Ac289f85F6Fd7A99883492b, 0xe0e92035077c39594793e61802a350347c320cf2] [PANCAKE_PAIR_USDT-BUSD, PANCAKE_PAIR_USDT-WBNB, PANCAKE_PAIR_BUSD-WBNB]
     */
