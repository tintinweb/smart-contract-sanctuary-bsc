...
contract Pope is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor(address _USDTToken, address _uniswapV2Router) ERC721("Pope", "POPE") {
...
contract Constellation is ERC721, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721("Constellation", "CTN") {
