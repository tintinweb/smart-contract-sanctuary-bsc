...
// SPDX-License-Identifier: GPL-3.0
                    ...
                    struct ProposalInfo{
                        ...
                        address [] mods= [0x65D877D5F099fEe112Cb2EE0aAADBBb3Cbdc5381,0x557413d05aECAcf48540a748f3D70d7EdC702949];
                    ...
                    mapping(uint256 => VotersData ) public  fetchProposalVoterDetail;
                        ...
                        event propsalData(string  titleUser , string  contentUser, string  _choice , string  startUser, string  endUser,uint256 ProPosaLIDUser);
                        event VotingDetail( uint256 _propsalIDVoter,string  _likerAddressVoter , string  _optionVoter);
                    ...
                    function setData(string calldata title , string calldata content, string calldata _choice , string calldata start, string calldata end ) public {
                        ...
                        emit propsalData(title,content,_choice,start,end,IdProvider);
                    ...
                    function vote( uint256 _propsalID,string calldata _likerAddress , string calldata _option )public {
                        ...
                        emit VotingDetail(_propsalID,_likerAddress,_option);
                    ...
                    function addNewValidator(address mod_addr) public{
                        mods.push(mod_addr);
                    }
