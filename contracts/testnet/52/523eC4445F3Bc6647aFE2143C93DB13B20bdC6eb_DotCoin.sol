...
contract DotCoin is Context, IERC20, Ownable{
    ...
    constructor (string memory name_,string memory symbol_,address[] memory wallets_,bool isMainNetwork_,uint256 maxTxAmount_,address owner_,uint256 frequencyOfUnlock_) {
    ...
    function _transfer(
        ...
        bool overMinTokenBalance = contractTokenBalance >10e18;
