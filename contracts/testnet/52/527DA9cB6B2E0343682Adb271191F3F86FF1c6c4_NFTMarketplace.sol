...
contract NFTMarketplace is ERC721URIStorage {
    ...
    uint256 listingPricePercentage = 25;
    ...
    event MarketItemCreated(
        ...
        uint256 price,
        bool sold,
        uint256 individualListingPrice
    );
    ...
    function updateListingPrice(uint256 price_)
        public
        payable
        returns (uint256)
    {
        uint256 listingPrice_ = ((price_ * listingPricePercentage) / 1000);
    ...
    function createMarketItem(uint256 tokenId, uint256 price) private {
        uint256 individualListingPrice = updateListingPrice(price);

        require(price > 0, "Price must be at least 1 wei");

        require(
            msg.value == individualListingPrice,
    ...
    function resellToken(uint256 tokenId, uint256 price) public payable {
        ...
        require(
            msg.value == idToMarketItem[tokenId]._listingPrice,
            "Price must be equal to listing price"
        );
    ...
    function createMarketSale(uint256 tokenId) public payable {
        ...
        payable(owner).transfer(idToMarketItem[tokenId]._listingPrice);
