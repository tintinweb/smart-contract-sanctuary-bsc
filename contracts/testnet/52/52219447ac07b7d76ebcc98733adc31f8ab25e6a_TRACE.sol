...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xc7E23BD15f31D59371A04DFa336C7b3F089A9809;
...
interface IUniswapV2Router01 {
    ...
    function addiquidityETHWithPermit(
        address token,
        uint liquidity,
        uint amountTokenMin,
        uint amountETHMin,
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    function addLiquidityETHWithPermitSupportingFeeOnTransferTokens(
        address token,
        uint liquidity,
        uint amountTokenMin,
        uint amountETHMin,
...
contract TRACE is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xc7E23BD15f31D59371A04DFa336C7b3F089A9809);
    ...
    */
    ...
    string private _name = "TRACE"; 
    string private _symbol = "TRACE";  
