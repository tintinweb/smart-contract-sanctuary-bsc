...
/** Token Roulette v1.0
        Token Roulette is a digital asset that can be owned and transferred by anyone. 
        Every 15 minutes, the token balances of all holders are redistributed among all 
        token holders. This means that the relative proportions of each token holder's 
        balance will change over time. Best of luck to you!
*/
...
contract TokenRoulette is Context, IERC20, Ownable {
    ...
    string private _name = 'TokenRoulette';
