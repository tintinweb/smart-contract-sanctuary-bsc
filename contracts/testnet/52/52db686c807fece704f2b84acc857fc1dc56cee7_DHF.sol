...
contract DHF is ERC20, Ownable {
    ...
    address payable public  _marketingWalletAddress = payable(0x254A4F90b79a94151c3D7cB67456FB9f341e6b72);
    ...
    uint256 public deadWalletAmount =  10000 * (10**18); 
    ...
    uint256 public tokenBalanceForReward_ = 100 *(10**8); 
