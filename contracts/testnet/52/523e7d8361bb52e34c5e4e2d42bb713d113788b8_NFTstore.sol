 ...
 */
contract NFTstore is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC721("NFT Starter", "NFT PRO")   {
    ...
    */
    function mintPro(address payable recipient, string memory uri, uint256 mintIndex) public payable  returns (uint256) {
