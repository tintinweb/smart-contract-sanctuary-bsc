...
contract AlexPsyToken is ERC20, Ownable {
    using SafeERC20 for IERC20;
    using Address for address;
    using SafeMath for uint;

    uint public minTokenAmountToSwap = 100 * 10 ** 8;
    ...
    constructor () ERC20("AlexPsyToken", "APT", 8, 2100000 * 10 ** 8){
        address msgSender = _msgSender();
