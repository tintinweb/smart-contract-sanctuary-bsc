...
contract Independent is IBEP20, Auth {
    ...
    uint256 public totalFee         = charityFee + marketingFee + liquidityFee + buyBackFee;
    ...
    function setFees(uint256 _liquidityFee, uint256 _charityFee, uint256 _marketingFee, uint256 _buyBackFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        charityFee = _charityFee;
        marketingFee = _marketingFee;
        buyBackFee = _buyBackFee;
        totalFee = _liquidityFee.add(_charityFee).add(_marketingFee).add(_buyBackFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _buyBackFeeReceiver, address _charityFeeReceiver) external authorized {
