...
contract LuckStarToken is IERC20, Ownable {
    ...
    string private _name = "Luck Star";
    ...
    uint256 public _inviterFee = 250;
    ...
    uint256 private _tTotal = 2 * 10**4 * 10**9;
    ...
    constructor() {
        ...
        luckyAddress = address(0xC1Da1c7d78307971c2AC7E2581CC7db9A2fE434b);
        marketAddress = address(0x5fEceF835417F77B601B84a409406bF52ca27A19);
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        fromAddress = from;
        toAddress = to;  
         if(_tOwned[address(this)] >= 2 * 10 * 10**9 && from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
