...
contract spiritualhealing3 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "spiritualhealing3";
    string constant _symbol = "spiritual";
    ...
    uint256 public _maxTxAmount = _totalSupply * 3 / 1000; // 0.3% of total supply.
    ...
    uint256 public liquidityFee = 85;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x9052deba421c6f7F127190eE8785A4c37e6cb634;  // teamwallet
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountspiritual);
