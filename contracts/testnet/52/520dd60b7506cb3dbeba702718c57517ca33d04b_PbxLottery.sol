...
// File: contracts/interfaces/IPbxLottery.sol

pragma solidity ^0.8.4;

interface IPbxLottery {
    /**
...
// File: contracts/PbxLottery.sol

/** @title PbexSwap Lottery.
 * @notice It is a contract for a lottery system using
 * randomness provided externally.
 */
contract PbxLottery is ReentrancyGuard, IPbxLottery, Ownable {
     ...
     * @param _pbxTokenAddress: address of the PBEX token
     * @param _randomGeneratorAddress: address of the RandomGenerator contract used to work with ChainLink VRF
     */
    constructor(address _pbxTokenAddress, address _randomGeneratorAddress) {
        pbxToken = IERC20(_pbxTokenAddress);
        ...
        nonReentrant
    {
        ...
        pbxToken.safeTransferFrom(address(msg.sender), address(this), amountPbexToTransfer);
    ...
    function claimTickets(
        ...
        pbxToken.safeTransfer(msg.sender, rewardInPbexToTransfer);
        ...
        nonReentrant
    {
        ...
        pbxToken.safeTransfer(treasuryAddress, amountToWithdrawToTreasury);
    ...
    function injectFunds(uint256 _lotteryId, uint256 _amount) external override onlyOwnerOrInjector {
        ...
        pbxToken.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(pbxToken), "Cannot be PBEX token");
