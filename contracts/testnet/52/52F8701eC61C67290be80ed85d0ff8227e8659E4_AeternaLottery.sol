...
contract AeternaLottery is ReentrancyGuard, IAeternaLottery, Ownable {
     ...
     * @dev Callable by users
     */
    function buyTickets(uint256 _lotteryId, uint32[] calldata _ticketNumbers) payable
        external
        override
        notContract
        nonReentrant
    {
        ...
        if(tokenBalance > 0)
            require(msg.value >= _ticketNumbers.length, "Insufficient funds for tickets.");
        else
            require(msg.value >= _ticketNumbers.length * 2, "Insufficient funds for tickets.");
    ...
    function startLottery(
        ...
        _rewardsBreakdown[3] = 0;
        _rewardsBreakdown[4] = 3000;
