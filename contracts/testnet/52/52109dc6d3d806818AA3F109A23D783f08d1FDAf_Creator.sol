...
contract Creator is Ownable {
    ...
    function createStaking(
        ...
        uint256 rewardsPerBlock = rewardsPerDay / blocksPerDay;
        uint256 dualRewardsPerBlock = dualRewardsPerDay / blocksPerDay;
        ...
        FeeDistributorV6(payable(_feeDistributor)).transferOwnership(msg.sender);
    }
}
