...
library Address{
 ...
 contract Pizza is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 7_000_000 * 1**6;
    uint256 public maxBuyLimit = 20_000 * 1**6;
    uint256 public maxSellLimit = 10_000 * 1**6;
    uint256 public maxWalletLimit = 20_000 * 1**6;
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0x2A324dEDF53bEcD42D7BB0CdE1D44F9614463a3A;
    address public donationWallet = 0x3A9aa53a9bA3Ce0BBCC99bdF22c579036d286285;

    string private constant _name = "PizzaCloud";
    string private constant _symbol = "PzC";
