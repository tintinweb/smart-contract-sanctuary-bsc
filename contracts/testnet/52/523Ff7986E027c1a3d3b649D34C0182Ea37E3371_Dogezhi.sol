...
contract Dogezhi is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Dogezhi", "DOGEZHI") {
        address newOwner = address(0x748518C1aB9471258D1451b06a03e728BeacF456);
    	...
    	marketingWallet = address(0x9f527a095e1a7710616f365Af68AD478676FcD27); // set as marketing wallet
        buyBackWallet = address(0x7F898ba858B5A52aB1C7ee9b50D80519EeDa50da); // set as marketing wallet
