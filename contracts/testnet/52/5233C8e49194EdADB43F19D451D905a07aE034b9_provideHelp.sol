     ...
     function clearGetHelp() internal{
        if(!getHelp[currentGetHelp].isPaid && getHelp[currentGetHelp].amount !=0 && address(this).balance != 0)
        {
            if((getHelp[currentGetHelp].amount-getHelp[currentGetHelp].paidAmount)<=address(this).balance)
            {
                ...
                pendingWithdrawalAmount=pendingWithdrawalAmount-getHelp[currentGetHelp].amount-getHelp[currentGetHelp].paidAmount;
                currentGetHelp++;
            ...
            else
            {
                ...
                pendingWithdrawalAmount=pendingWithdrawalAmount-address(this).balance;
           ...
           users[getHelp[currentGetHelp].userAddress].totalWithdrawalAmount=users[getHelp[currentGetHelp].userAddress].totalWithdrawalAmount+msg.value;
        }
     }
