...
Decimals:18
1% BNB for marketing
2% Reflection in tokens to holders and
1% BNB percent towards Liquidity

*/

contract WarriorNun is Context, IERC20, Ownable {
    ...
    string private _name = "Warrior Nun";
    string private _symbol = "Nun";
    ...
    address payable public MarketingWallet = payable(0x108581dC0636c06D0a04813FF26e03f7Df09Fad8);
    ...
    uint256 public numTokensSellToAddToLiquidity = 70000000 * 10**18;
