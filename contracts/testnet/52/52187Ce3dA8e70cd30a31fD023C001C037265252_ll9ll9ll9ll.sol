...
/**
 Telegram : https://t.me/ll9ll9ll9ll
*/
...
contract ll9ll9ll9ll is Context, IERC20, Ownable {
    ...
    address private feeOne = 0x8c66B22DeaD8bc01ddD14cDF2D5d422764129746;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "999";
    string private _symbol = "999";
    uint8 private _decimals = 18;
    uint256 private _tTotal = 100000000000000000 * 18;
    uint256 public _maxWalletAmount = (_tTotal * 2) / 100;
    bool inSwapAndLiquify;
    uint256 public buyFee = 5;
    uint256 public sellFee = 5;
    address public deployer;
    uint256 public ethPriceToSwap = 0.1 ether; 
    bool public isBurnEnabled = true;
    uint256 public burnFrequencynMinutes = 30;  
    uint256 public burnRateInBasePoints = 100;
    uint256 public tokensBurnedSinceLaunch = 0;
    uint public nextLiquidityBurnTimeStamp;

    uint256 totalShare = 100;
    uint256 feeShare = 50;
    uint256 lpShare = 50;
   
    constructor () {
        address tokenOwner = 0xE94F52e6BAf4449F8B833307140fa80dA31C80bC;
