 ...
 * @dev This contract is used to reduce the number of transactions required to post prices and execute orders.
 */
contract PriceReporter is Ownable {
     ...
     * @param _orderManager address of the order manager
     */
    ...
    /**
     * @notice Adds prices to the oracle and executes orders
     * @param tokens list of tokens to post prices for
     * @param prices list of prices to post
     * @param orders list of order ids to execute
     * @dev The length of tokens and prices must be the same
     * @dev The msg.sender must be a reporter
     */
    ...
    /**
     * @notice Adds a reporter to the list of reporters
     * @param reporter address of the reporter to add
     */
    ...
    /**
     * @notice Removes a reporter from the list of reporters
     * @param reporter address of the reporter to remove
     */
