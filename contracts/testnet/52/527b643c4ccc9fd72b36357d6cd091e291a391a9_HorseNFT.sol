	...
	IHorseNFT
{
	...
	modifier onlyGrade24Contract() {
		require(IGrade24(msg.sender) == grade24Contract, "not grade24 caller");
        _;
	}
	...
	function setGrade24Contract(IGrade24 _grade24Contract) public onlyOwner {
		grade24Contract = _grade24Contract;
	}
	...
	function _afterTokenTransfer(
		...
		if (from != to) {
			//grade24Contract.onHorseOwnerChanged(from, to, tokenId);
		}
	}
}
...
interface IGrade24 {
    ...
    function onHorseOwnerChanged(address oldOwner, address owner, uint256 tokenId) external;
}
