...
import "./HarvestUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new HarvestUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        HarvestUser1155Token token = HarvestUser1155Token(address(addr));
...
contract HarvestUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
