...
contract KongStakeV2 is Ownable, ReentrancyGuard {
    ...
    */
    ...
    address public kongV1Address = 0x46bAF3895A09Cdd5e8d9b28aC314730fB1FB557E;
    ...
    function activateMigratedStake(uint256 _stakeId, uint256 _amount) public{
        ...
        require(_amount >= v1UnstakableAmount,"Migration BUSD Balance is less than unstaked balance");
