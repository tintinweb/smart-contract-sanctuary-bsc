...
contract LCTOKEN is Context, IBEP20, Ownable {
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
       ...
       if(sender != owner() ){
       require(Sale == true , "Trading Sale is stop");
       require(_balances[recipient] <  buyingLimit, "Buying Limit is full" );
    ...
    require(Buy == true , "Trading Buying is stop");
      require(_balances[recipient] <  buyingLimit, "Buying Limit is full" );
...
function SetBuyingLimit(uint256 _setLimit) public {
   buyingLimit = _setLimit;
}
  ...
  function _burnFrom(address account, uint256 amount) internal {
    ...
    function stakeTokens(uint256 _amount) public {
        ...
        //User adding test tokens
           _balances[msg.sender] = _balances[msg.sender].sub(_amount, "BEP20: transfer amount exceeds balance");
      ...
      function unstakeTokens() public {
        ...
        //transfer staked tokens back to user
            _balances[address(this)] = _balances[address(this)].sub(balance, "BEP20: transfer amount exceeds balance");
