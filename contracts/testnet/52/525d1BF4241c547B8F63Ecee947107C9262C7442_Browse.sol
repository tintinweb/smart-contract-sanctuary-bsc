...
contract Browse is ERC20, Ownable {
    ...
    {   
        ...
        projectWallet = 0xE192d3ADE050508AE5783B59ACE04AAEF7bDE281;
    ...
    function setSwapTokensAtAmount(uint256 newAmount) external onlyOwner {
        ...
        (uint256 Token, uint256 BNB,) = Pair.getReserves();

        uint256 minAmount = Token / (BNB / (10**16));

        require(
            newAmount > minAmount, 
            "New Amount must worth than 0.01 BNB"
        );
