...
contract TestPresale is Ownable {
    ...
    bool public isRefereEnable = false;
    uint256 public referRewardpercentage = 1;

    // tokens sold
    uint256 tokensSold;
    // tokens to be sold in total
    uint256 tokensToBeSold = 1000*(10**18);
    uint256 ip = 10000000000000000;
    uint256 fp = 100000000000000000;
    ...
    address public tokenAddress=0x38827B15BBa99c50CCCcA82077cc23Dc68fE27c7;
    uint256 public tokenDecimals = 18;

    //@dev amount of tokens per ether 100 indicates 1 token per eth
    uint256 public tokenRatePerEth = 166666;
    ...
    uint256 public hardcap = 1000*1e18;
    address private dev;
    ...
    function buyToken() public payable returns (address) {
        ...
        uint256 tokenAmount = howMany(msg.value);
    ...
    uint256 fvalue = value * (10**18);
    uint256 a = sqrt(4 * ((tsip + pd * tokensSold) ** 2) + fvalue.mul(8 * pd * tokensToBeSold));
