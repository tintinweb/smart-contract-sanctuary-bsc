...
contract Xindex {
    ...
    function deposit(uint256 _amount, address _upline) public {
        ...
        deposits[depositsCount] = Deposit(depositsCount, msg.sender, 200, 1, original_amount, uint40(block.timestamp));
    ...
    function payoutOf(address _addr) view external returns(uint256 value) {
        ...
        for(uint256 i=0;i<depositsCount;i++) {
            ...
            uint40 time_end = deposits[i].time + 86400; // deposit timestamp + 30 days in sec
