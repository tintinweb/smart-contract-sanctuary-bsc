...
contract Dinuu is ERC20Detailed, Ownable {
    ...
    string public _name = "Dinuu";
    string public _symbol = "DUU";
    uint8 public _decimals = 5;

    ICapswapV2Pair public pairContract;
    ...
    ICapswapV2Router02 public router;
    address public pair;
    bool inSwap = false;
    modifier swapping() {
        inSwap = true;
    ...
    uint256 private constant MAX_SUPPLY = 5000000 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Dinuu", "DUU", uint8(DECIMALS)) Ownable() {

        
        //ICapswapV2Router02 _router = ICapswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);//
        ICapswapV2Router02 _router = ICapswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);   // bsc testnet
        router = _router;
        
        pair = ICapswapV2Factory(_router.factory())
            .createPair(address(this), _router.WETH());

        autoLiquidityReceiver = 0x3ff519b73ff870931552773B0D3565c4351419D6;
        treasuryReceiver = 0x4D26D5D678aF9696817cf38F9d59Ed8D3f4cAc5a;
        safuuInsuranceFundReceiver = 0xA40Ce1D01155AEac08e59C88FfDFD333A3a25E07;
        firePit = 0x9cd695a9d7288c61fc2F319f52198c9687Eaff41;

        _allowedFragments[address(this)][address(router)] = uint256(-1);

        pairAddress = pair;
        pairContract = ICapswapV2Pair(pair);
    ...
    function setPairAddress(address _pairAddress) public onlyOwner {
        ...
        pairContract = ICapswapV2Pair(_pairAddress);
        pair = _pairAddress;
    }

    function setLP(address _address) external onlyOwner {
        pairContract = ICapswapV2Pair(_address);
    }
