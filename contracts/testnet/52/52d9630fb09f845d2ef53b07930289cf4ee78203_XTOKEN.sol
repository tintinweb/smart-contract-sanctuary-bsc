...
//    | $$    | $$      | $$  \ $$  | $$  | $$\  $$$| $$  | $$| $$      
//    | $$    | $$$$$$$$| $$  | $$ /$$$$$$| $$ \  $$| $$$$$$$/| $$$$$$$$
//    |__/    |________/|__/  |__/|______/|__/  \__/|_______/ |________/
...
// Dependency file: contracts/main/IterableMapping.sol
...
// Dependency file: contracts/main/XTOKENDividendTracker.sol
...
// import "contracts/main/IterableMapping.sol";
...
contract XTOKENDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main XTOKEN contract."
        );
    }
...
// Root file: contracts/main/XTOKEN.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/main/XTOKENDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract XTOKEN is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        dividendTracker = XTOKENDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "XTOKEN: The dividend tracker already has that address"
        );

        XTOKENDividendTracker newDividendTracker = XTOKENDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "XTOKEN: The new dividend tracker must be owned by the XTOKEN token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "XTOKEN: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "XTOKEN: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "XTOKEN: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "XTOKEN: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "XTOKEN: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "XTOKEN: Cannot update gasForProcessing to same value"
        );
