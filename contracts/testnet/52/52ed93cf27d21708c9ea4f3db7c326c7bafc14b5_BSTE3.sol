...
contract BSTE3 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
   
    string private _name = "BuySellTaxT3";
    string private _symbol = "BST3";
    uint8 private _decimals = 18;

    address payable private marketingWalletAddress = payable(0xAB68dFA6CB855F233A8d77E8E819aE64E26CEc54);
    address payable private teamWalletAddress = payable(0xAB68dFA6CB855F233A8d77E8E819aE64E26CEc54);
...
// total sell tax = 5%
    ...
    constructor () {
        ...
        // @ES: Polygon Mumbai Router testnet address: 0x462C98Cae5AffEED576c98A55dAA922604e2D875
    ...
    function setDistributionSettings(uint256 newLiquidityShare, uint256 newMarketingShare, uint256 newTeamShare) internal onlyOwner() {
