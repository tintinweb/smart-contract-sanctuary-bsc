...
contract DogeWeed is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor () {
        ...
        _symbol = "BAPE";
        _decimals = 18;
        _totalSupply = 1000000000000 * 18**_decimals; 
                       
        _liquidityTransactionFee = 3; //Added to liquidity pool
        _buybackTransactionFee = 2; //Swapped to BNB and sent to buyback funding wallet
        _marketingTransactionFee = 5; //Sent as tokens to marketing wallet -> GIVE THESE TO INFLUENCERS!
        _totalTransactionFee = recalcTotalTransactionFee();        
        
        _buybackWallet = 0xbBd46a49f62F155868f95431dbcEA1B78fE893D0;
        _marketingWallet = 0x484eE2dcC3C0b27D6803703556Bd4b56d4873C9F;
    	...
    	pancakeV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    */
    ...
    function setBuybackTransactionFee(uint8 buybackFee) external onlyOwner() {
        require(buybackFee <= 5, "Buyback fee cannot exceed 5%");
        _buybackTransactionFee = buybackFee;
        recalcTotalTransactionFee();
    }    

    function setMarketingTransactionFee(uint8 marketingFee) external onlyOwner() {
        require(marketingFee <= 5, "Marketing fee cannot exceed 5%");
    ...
    */
    ...
    function _swapAndLiquify(uint256 swapAndLiquifyAmount) private lockTheSwap {   
        ...
        bnb = bnb/18**_decimals;

        //Min. amount of tokens to initiate a swap. Default 0.1 BNB worth of tokens
        uint256 minTokenSwapAmount = ((token/bnb) * 18**_decimals)/_swapAmountDivider; 
