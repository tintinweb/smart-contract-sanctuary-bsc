...
interface TokenSwap {
    function swapBNBtoToken(address _tokenAddressToSwap) external payable returns(bool);
}
...
contract DiceRoller is VRFConsumerBaseV2, ReentrancyGuard {
  ...
  address public TOKEN_SWAP_ADDRESS;
  ...
  constructor() VRFConsumerBaseV2(vrfCoordinator) {
    ...
    TOKEN_SWAP_ADDRESS = 0x583C6dFf7c11d60F3d9800008Ffa2f8d9186d1da;
    tokenSwap = TokenSwap(TOKEN_SWAP_ADDRESS);
  ...
  */
  ...
  function swapAndSendBUSDToMinerContract() internal {
    tokenSwap.swapBNBtoToken{value:minerWalletBalance}(busdAddress);
