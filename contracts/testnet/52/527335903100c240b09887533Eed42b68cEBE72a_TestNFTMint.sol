...
contract TestNFTMint is ERC721Enumerable, Ownable {
	...
	uint256 public minUSDT;	//the usdt part of nft price
	...
	constructor(IERC20 _usdt) ERC721("ThenticTestNFT_Collection", "TESTNFT") {
		pos = 0;
		maxMintSupply = 4000;
		usdt = _usdt;
		minUSDT = 100 * 10 ** 18;
	...
	//this function let the owner to set the price of the nft (usdt)
	function updateMinUsdt(uint256 _minUSDT) external onlyOwner {
		minUSDT = _minUSDT;
	}
	...
	function mint(uint256 nftAmount) external {
		...
		uint256 usdtAmount = minUSDT * nftAmount;
