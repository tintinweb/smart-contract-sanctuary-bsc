...
contract AMEXTEST is ERC20Detailed, Ownable {
    ...
    uint256 public AssetbackedFee = 7;
    ...
    address public URFOWNER = 0xd58e98758e7BE5FDF5e4e824260Cf325b904605d;
    ...
    constructor() ERC20Detailed("AMEXTEST", "AT", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xdF96EC81d67BB821A6cb8Fba0195D27ce1Bb072f; //Liquidity Reciever will get LP tokens
        treasuryReceiver = 0xd58e98758e7BE5FDF5e4e824260Cf325b904605d; //Treasury Receiver
        AssetbackedReceiver = 0xb9666F52E6b9C8c3Bb5ff71280cF503da420A51e; //Backed asset Receiver
    ...
    function rebase() internal {
        if ( inSwap ) return;
        uint256 rebaseRate = 185;
        uint256 deltaTime = 8640000;
