...
contract Multinet is Context, IERC20, Ownable {
    ...
    string private constant _name = "Multinet";
    ...
    uint256 public totalSwapableFee = _liquidityFee + _burnFee ;

    uint256 _saleTaxFee = 5;
    uint256 _saleLiquidityFee = 5;
    uint256 _saleBurnFee = 10;

    uint256 public totalSwapableSaleFee = _saleTaxFee + _saleLiquidityFee + _saleBurnFee ;
    ...
    constructor () {
        ...
        if (block.chainid == 56) {
            currentRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // PCS Router
        } else if (block.chainid == 97) {
            currentRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // PCS Testnet
        } else if (block.chainid == 43114) {
            currentRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //Avax Mainnet
        } else if (block.chainid == 137) {
            currentRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //Polygon Ropsten
        } else if (block.chainid == 250) {
            currentRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //SpookySwap FTM
        } else if (block.chainid == 3) {
            currentRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //Ropsten
        } else if (block.chainid == 1 || block.chainid == 4) {
            currentRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //Mainnet
        } else {
            revert();
        }
    ...
    {   
        ...
        uint256 totalTokensToSwap = liquidityTokensCollected + burnTokensCollected;
        uint256 totalTokens = balanceOf(address(this));
        if(totalTokens == 0 || totalTokensToSwap == 0) {return;}

        uint256 halfLiquidityTokens = totalTokens * liquidityTokensCollected / totalTokensToSwap /2;
        uint256 newBalance;
        ...
        if (totalTokens> 0){
            _tokenTransfer( address(this), deadAddress, totalTokens, false);
        }
    ...
    function setSaleFee() private {
        ...
        totalSwapableFee = _liquidityFee + _burnFee ; 
    }

    function countUpFeeShare(uint256 amount) private
    {
        if(totalSwapableFee==0) { return; }
        liquidityTokensCollected += (amount * _liquidityFee)/1000;
        burnTokensCollected += (amount * _burnFee)/1000;
    }
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return (_amount * totalSwapableFee) /1000;
    }
