...
contract RacingPunk is ERC721, Ownable {
    ...
    constructor() ERC721("RacingPunk", "RacingPunk") {}

    function mint(address to, uint256 tokenId) public {
        require(!paused,"Paused");
        require(verifyUser(to), "No permissions!");
        _safeMint(to, tokenId);
    }
    ...
    function verifyUser(address user) public view returns(bool) {
        return user == owner() || whitelistedAddresses[user];
    }
