...
contract PinkSaleToken is Ownable, IERC20 {
    ...
    function startorStopTrading(bool status) external onlyOwner{
        tradingStarted = status;
    }
    ...
    function _transfer(
        ...
        address recipient,
        uint256 amount
    ) internal virtual startedTrading validLockTime(sender, recipient) {
