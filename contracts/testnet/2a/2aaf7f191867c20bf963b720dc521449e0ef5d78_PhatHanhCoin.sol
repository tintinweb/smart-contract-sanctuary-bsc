...
contract PhatHanhCoin is Context, IBEP20, Ownable {
    ...
    /**
     * @dev transfer the Ether from the address of this contract
     * to address of the Operator
     */
    ...
    /**
     * @dev transfer the IBEP20 token from the address of this contract
     * to address of the Operator
     */
    function wipeIBEP20(address _tokenContract, uint256 _amount)
        external
        onlyOperator
    {
    ...
    /**
     * @dev transfer the IERC20 token from the address of this contract
     * to address of the Operator
     */
