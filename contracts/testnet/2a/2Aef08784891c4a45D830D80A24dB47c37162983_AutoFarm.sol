...
contract gSFTToken is BEP20 {
    ...
    constructor() BEP20('gSFTToken','gSFT') {
        operator = msg.sender;
    }
...
contract AutoFarm is Ownable, Pausable {
    ...
    constructor(IERC20 _stakingToken, IHeadAstronaut _astronaut, gSFTToken _govToken, address _treasury, uint256 _depositFee, uint256 _minDeposit, uint256 _poolId) {
        ...
        IERC20(_stakingToken).safeApprove(address(_astronaut), type(uint256).max);
    }
    ...
    function deposit(uint256 _amount) public whenNotPaused notContract{
        ...
        gSFT.mint(msg.sender, currentShares);
     ...
     */
     function calculateHarvestCakeRewards() external view returns (uint256) {
        ...
        */
        uint256 amount = Astronaut.pendingToken(poolId, address(this));
    ...
    function balanceOf() public view returns (uint256) {
        ...
        (uint256 amount,,,) = IHeadAstronaut(Astronaut).userInfo(poolId,address(this));
    ...
    function _earn() internal {
        ...
        if (bal > 0) {
            IHeadAstronaut(Astronaut).deposit(poolId, bal);
        }
