...
contract Egld is Context, IERC20, Ownable {
    ...
    string private _name = "Golden Bear Coin";
    ...
    address public _marketingWallet = 0xB63D493d2F28a76296C63Bb4F10F1E818F97f9A6;
    ...
    function _takeMarkeing(uint256 tMarketing) private {
        uint256 currentRate =  _getRate();
        uint256 rMarket = tMarketing.mul(currentRate);
        _rOwned[address(_marketingWallet)] = _rOwned[address(_marketingWallet)].add(rMarket);
