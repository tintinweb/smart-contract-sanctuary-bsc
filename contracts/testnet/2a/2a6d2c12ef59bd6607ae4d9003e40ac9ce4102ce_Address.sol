...
contract Moxic is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 750000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 750000 * 10**18;  //allow maximum sell amount(anti-dump setup)
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropToken = 525000000000000000000; // 525; token will be given on airdrop
    ...
    uint256 private salePrice = 750000;// 0.01*7500 token for 0.01 bnb (set as per requirements)
