...
/*   BNBHarvest - is the new yield farm on Binance Smart Chain with a fixed and steady daily income!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://bnbharvest.com                                     │
 *   │                                                                       │
 *   │   Telegram Public Chat: @bnbharvest                                   │
 *   │   Telegram Admin: @bsc_andrew                                         │
 *   │                                                                       │
