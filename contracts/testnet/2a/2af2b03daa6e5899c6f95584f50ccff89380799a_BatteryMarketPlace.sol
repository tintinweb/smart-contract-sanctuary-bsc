...
contract BatteryMarketPlace is OwnableUpgradeable, PausableUpgradeable  {
    struct Auction {
        uint256 highestBid;
        uint256 closingTime;
    ...
    function initByOwner(BatteryNFT _batteryNFT, address _tokenBEP20)public onlyOwner{
    ...
    function closeAuctionSudden(uint256 _nftId) external whenNotPaused {
        ...
        batteryNFT.transfer(_nftId, auctions[_nftId].originalOwner);
...
function openAuction(
        ...
        require(batteryNFT.ownerOf(_nftId) == msg.sender, "Not NFT owner");
        batteryNFT.approveMarketPlace(address(this),_nftId);
        // NFT Transfer to contract
        batteryNFT.transfer(_nftId, address(this));
    ...
    function buy(uint256 _nftId, uint256 _amount) external whenNotPaused {
        ...
        // Transfer NFT to Highest Bidder
        batteryNFT.transfer(_nftId, auctions[_nftId].highestBidder);
    ...
    function setBatteryNFT(BatteryNFT _batteryNFT) public onlyOwner{
    batteryNFT=_batteryNFT;
    }
