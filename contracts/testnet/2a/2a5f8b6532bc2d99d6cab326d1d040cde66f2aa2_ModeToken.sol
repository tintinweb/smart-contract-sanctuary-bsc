...
contract ModeToken is ERC20 {
	...
	address public _devAddress = 0xA41d4e94861D5415B9070F964f98D290E3CbD95B;
    ...
    function _transfer(address from,address to,uint256 amount ) internal override {
        ...
        if(from == pairAddress || to == pairAddress){
            super._transfer(from, pairAddress, amount.div(100).mul(4));
            super._transfer(from, _devAddress, amount.div(100).mul(3));
            super._transfer(from, address(0), amount.div(100).mul(3));
