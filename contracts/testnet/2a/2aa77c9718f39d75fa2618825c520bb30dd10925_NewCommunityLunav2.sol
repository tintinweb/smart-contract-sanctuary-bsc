...
contract NewCommunityLunav2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "NewCommunityLunav2.0";
    string private constant _symbol = "cLuna";
    ...
    function ABLStatus(bool _status) public onlyOwner {
        _ab = _status;
    }
