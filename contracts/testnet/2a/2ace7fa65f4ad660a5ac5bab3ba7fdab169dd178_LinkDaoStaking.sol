...
contract LinkDaoStaking is Ownable {
    ...
    function investAmount(uint256 _amount) external{
        ...
        require(totalInvestments.add(_amount)<=MAX_STAKE,"Cannot stake more than 10,000 LKD");
        require(investors[msg.sender].totalInvestment.add(_amount)<=MAX_STAKE_PER_USER,"Cannot stake more than 10,000 LKD");
