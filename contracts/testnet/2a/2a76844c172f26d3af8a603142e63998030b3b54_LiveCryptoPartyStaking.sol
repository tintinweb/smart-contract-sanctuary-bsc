...
contract LiveCryptoPartyStaking is Initializable {
    ...
    function initialize() public initializer {
        owner = payable(0xCe94734965CbA53217523d52D9772b02Db188622);
        ...
        goldMaxStakingAmount = 2000 * (10**stakeToken.decimals());
        silverMaxStakingAmount = 5000 * (10**stakeToken.decimals());
    }
