...
contract MaximusInvestToken is ERC20, Ownable, ERC20Permit {
        ...
        ERC20Permit("Maximus Invest Token")
    {
        ...
        _mint(msg.sender, 1000 * 5**decimals());
    }
    ...
    function totalRewards() public view returns (uint256) {
        ...
        for (uint256 s = 0; s < stakeholders.length; s += 1) {
            _totalRewards = _totalRewards.add(s_rewards[stakeholders[s]]);
        }
    ...
    function distributeRewards() public onlyOwner {
        for (uint256 s = 0; s < stakeholders.length; s += 1) {
            ...
            s_rewards[stakeholder] = s_rewards[stakeholder].add(reward);
        }
    }
