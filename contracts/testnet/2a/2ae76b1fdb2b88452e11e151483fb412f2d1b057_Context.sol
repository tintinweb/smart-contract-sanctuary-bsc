...
contract sookcoin is Context, IERC20, Ownable{
  ...
  uint8 public buyLiquidityFee = 0;
  uint8 public buyMarketingFee = 2;
  uint8 public buyTeamFee = 0;  
  uint8 public sellLiquidityFee = 2;
  uint8 public sellMarketingFee = 0;
  uint8 public sellTeamFee = 0;
  uint8 public _totalTaxIfBuying = 2;
  uint8 public _totalTaxIfSelling = 2;
