...
contract BabyShibaDAO is Context, IERC20, Ownable {
    ...
    string private _name = "mao1";
   
    string private _symbol = "mao1";

    uint8 private _decimals = 9;

    PancakeRouter private _router;
    address payable public marketingWalletAddress = payable(0x62bc3e503a50069f0b661C5E8fb5d28Ce4DFA7B4); 
    address payable public ttWal = payable(0x62bc3e503a50069f0b661C5E8fb5d28Ce4DFA7B4); 
