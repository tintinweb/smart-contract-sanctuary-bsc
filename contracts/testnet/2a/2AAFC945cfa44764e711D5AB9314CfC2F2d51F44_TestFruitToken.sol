...
7% buy and sell tax (3% marketing, 3% LP, 1% dev)
...
contract TestFruitToken is BEP20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() BEP20("TestFruitToken", "TFT") {
        marketingWallet = payable(0x13b03E1Cc97a7De6630f5E66a727483E2d256d20);
        devWallet = payable(0x559FAE021F2CDc51e1bBc5614C7c632b5d8C8821);
