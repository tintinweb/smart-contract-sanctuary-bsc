Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

     address public B2B_ADDRESS;

    bool public isInitialized;
    uint256 public timeindays = 365;
    ...
    uint256 public buyBackRate = 7500;
    uint256 public supplierWalletRate = 2500;
    ...
    uint256 public chargeFee = 0.0005 ether;
    ...
    event SupplierWalletUpdated(address _addr);
    event BuybackAddressUpadted(address _addr);
    event DurationUpdated(uint256 _timeindays);

    event SetSettings(
        uint256 _depositFee,
        uint256 _withdrawFee,
        uint256 _supplierWalletRate,
    ...
    function initialize(
        ...
        require(msg.sender == B2B_ADDRESS, "Not first contract creator");
    ...
    function stake(uint256 _amount) external nonReentrant {
        ...
        if (depositFee > 0) {
            ...
            if (fee > 0) {
                stakingToken.safeTransfer(supplierWallet, fee);
    ...
    function withdraw(uint256 _amount) external nonReentrant {
        ...
        if (withdrawFee > 0) {
            ...
            uint256 _supplierWalletAmt = fee.mul(supplierWalletRate).div(10000);
            if (_supplierWalletAmt > 0) {
                stakingToken.safeTransfer(supplierWallet, _supplierWalletAmt);
                realAmount = realAmount.sub(_supplierWalletAmt);
            }
    ...
    function _transferChargefee() internal {
        require(msg.value >= chargeFee, 'should pay small gas to compound or harvest');

        payable(buyBackWallet).transfer(chargeFee);
        if(msg.value > chargeFee) {
            payable(msg.sender).transfer(msg.value.sub(chargeFee));
        }
    }
     ...
     */
    function getRewardDetails(address _user) external view returns (uint256) {
    ...
    function busdBalance(address _user) external view returns (uint256) {
        UserDetails storage user = userDetails[_user];
    ...
    *************************/
    function emergencyharvest() external onlyOwner {        
        ...
        if(pendingReflection > 0) {
            if(address(dividendToken) == address(0x0)) {
                payable(supplierWallet).transfer(pendingReflection);
            } else {
                IERC20(dividendToken).safeTransfer( supplierWallet, pendingReflection);
            }
            totalReflections = totalReflections.sub(pendingReflection);
        }
    ...
    function startReward() external onlyOwner {
        ...
        bonusEndBlock = startBlock.add(timeindays * 28800);
    ...
    function updatesupplierWallet(address _supplierWallet) external onlyOwner {
        require(_supplierWallet != address(0x0) || _supplierWallet != supplierWallet, "Invalid address");

        supplierWallet = _supplierWallet;
        emit SupplierWalletUpdated(_supplierWallet);
    }
    ...
    function setDuration(uint256 _timeindays) external onlyOwner {
        require(startBlock == 0, "Pool was already started");
        require(_timeindays >= 30, "lower limit reached");

        timeindays = _timeindays;
        emit DurationUpdated(_timeindays);
    }
    ...
    function setSettings(
        ...
        depositFee = _depositFee;
        withdrawFee = _withdrawFee;
        supplierWalletRate = _supplierWalletRate;
        buyBackRate = uint256(10000).sub(supplierWalletRate);
        ...
        emit SetSettings(_depositFee, _withdrawFee, _supplierWalletRate, _slippageFactor, _uniRouter, _earnedToStakedPath, _reflectionToStakedPath);
    }
