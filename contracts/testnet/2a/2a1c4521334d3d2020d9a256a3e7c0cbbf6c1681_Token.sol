...
contract Token is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(address(0)); //marketing wallet
    ...
    function airdrop1 (address[] memory addresses, uint256[] memory tokens, uint256 totalTokens) external onlyOwner {
    ...
    function airdrop2 (address[] memory addresses, uint256[] memory tokens) external onlyOwner {
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    address public addressOwner = address(0xAFE7160eEaE0A358352B771B95556B5032CDB911);
