...
contract MSActivityCenter is MSActivityCenterProxyAdmin {
    ...
    function sale(
    ...
    ) public payable whenNotPaused checkSale(_activityId, _tokenQuantity) {
        require(
            _expectedTokenQuantity <= _tokenQuantity,
            "MSActivityCenter: expectedTokenQuantity exceeds tokenQuantity"
        );
        uint256 __tokenQuantity = 0;
        if (activities[_activityId].root != 0) {
            require(
            ...
            if (activities[_activityId].isDynamic) {
                __tokenQuantity = _expectedTokenQuantity;
            } else {
                __tokenQuantity = _tokenQuantity;
            }
        ...
        chargeTokens(_activityId, __tokenQuantity);
        _mint(
            _activityId,
            _msgSender(),
            __tokenQuantity,
    ...
    function privateSale(
        ...
        address _to,
        uint256 _tokenQuantity
    ) public onlyCreator whenNotPaused checkSale(_activityId, _tokenQuantity) {
        _mint(
            _activityId,
            _to,
            _tokenQuantity,
