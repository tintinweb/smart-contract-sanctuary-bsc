...
contract SuTong is Context, IERC20, Ownable {
    ...
    string private constant _name = "SuTong";
    string private constant _symbol = "ST";
    uint8 private constant _decimals = 9;
    
    address payable private _appAddress = payable(0x93480ea6e1957A1931cc335686abbDBc46e25150);
    address payable private _marketingAddress = payable(0xA9CC0B923CB161D0e6577CB6Ddb31dC4caeD2b13);
    address payable private _buybackAddress = payable(0xA9CC0B923CB161D0e6577CB6Ddb31dC4caeD2b13);
    address payable private _burnAddress = payable(0xA9CC0B923CB161D0e6577CB6Ddb31dC4caeD2b13);
