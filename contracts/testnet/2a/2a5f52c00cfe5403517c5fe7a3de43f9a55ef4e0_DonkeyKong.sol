...
contract DonkeyKong is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "Donkey Kong";                  
    ...
    uint256 public defaultLiquidityFee = 6;
    ...
    uint256 public _liquidityFee4Sellers = 6;
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal * 2 / 1000;                   // contract balance to trigger swap & liquify + wallet transfer.
    address public  pancakeRouterAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;   // Pancake Router Version 2 address
    uint[] public _percentages = [20,20,20,20,20,0];                                     // % of liquidity fee split to wallet(s)
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        ...
        payable(0xE755b5E187C95d96Ab68e28B62F1737A125972d8),                             // Team Member Wallet 2
        payable(0xE755b5E187C95d96Ab68e28B62F1737A125972d8),                             // Team Member Wallet 3
        payable(0xE755b5E187C95d96Ab68e28B62F1737A125972d8),                             // Team Member Wallet 4
        payable(0xE755b5E187C95d96Ab68e28B62F1737A125972d8),                             // Marketing Wallet
        payable(0xE755b5E187C95d96Ab68e28B62F1737A125972d8)                              // Speacial Events wallet
    ];
    ...
    modifier lockTheSwap {
        ...
        uniswapV2Router = _uniswapV2Router;
         ...
         maxTransactionAmount = _tTotal * 1 / 100;// 5.0% maxTransactionAmount
         maxWalletAmount = _tTotal * 2 / 100;// 5.0% maxTransactionAmount
    ...
    function updateMaxTxAmount(uint256 newNum) external onlyOwner {
     require(newNum >= (_tTotal * 5 /  1000)/1e9, "Cannot set maxTransactionAmount lower than 0.5%");
    ...
    function airdroKOAoWallets(address[] memory airdropWallets, uint256[] memory amounts) external onlyOwner returns (bool){
        require(!isTokenLive, "Trading is already active, cannot airdrop after launch.");
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "DIX is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFees[from] || _isExcludedFromFees[to] || isTokenLive, "DIX is not live yet");
