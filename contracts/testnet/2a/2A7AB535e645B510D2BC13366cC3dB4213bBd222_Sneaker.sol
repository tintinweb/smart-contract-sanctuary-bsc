...
contract Sneaker is BEP721, Ownable {
    ...
    function BurnNFT(uint256[] memory ID_Tokens) external onlyOwner onlyManager {
    ...
    function upgrade(address _user) public onlyOwner onlyManager { 
        circulatingSupply += 1;    
        _mint(_user, circulatingSupply);
    }

    function summon(address[] memory addresses) public onlyOwner onlyManager {
