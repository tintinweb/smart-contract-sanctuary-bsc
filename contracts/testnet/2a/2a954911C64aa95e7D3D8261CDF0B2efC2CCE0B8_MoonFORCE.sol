...
// File: MoonFORCE/MoonFORCE_token/contracts/interfaces/IStakingContract.sol
...
contract MoonshotMechanism is IMoonshotMechanism {
    ...
    constructor() {
        pyeSwapRouter = IPYESwapRouter(0x9A982948fBBE799be2F2292CcB48F8f8A0dc9F57);
...
//--------------------------------------BEGIN CONSTRUCTOR AND RECEIVE FUNCITON---------|    
    ...
    constructor() ERC20("MoonForce", "FORCE") {
        ...
        isRewardExempt[moonshotAddress] = true;
...
//--------------------------------------BEGIN FEE FUNCTIONS---------|
    ...
    function setMoonshotPercent(uint256 _moonshotFee) external onlyOwner {
        ...
        _sellFees.moonshotFee = _moonshotFee;
...
//--------------------------------------BEGIN SET ADDRESS FUNCTIONS---------|
    ...
    function updateMoonshotAddress(address payable newAddress) public onlyOwner {
        ...
        isRewardExempt[newAddress] = true;
...
//--------------------------------------BEGIN TRANSFER FUNCTIONS---------|
   ...
   function _transfer(
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, uint8 takeFee) private {
        ...
        if(!isRewardExempt[sender] && !isStakingContract[recipient]) { 
            setShare(sender, _balances[sender]);
            }
        if(!isRewardExempt[recipient] && !isStakingContract[recipient]) {
