...
contract LEYECOM is Context, IERC20, Ownable {
    ...
    function web() public view returns (string memory) {
        return WebSite;
    }

    function Tel() public view returns (string memory) {
        return Telegram;
    }
    
    function Twit() public view returns (string memory) {
        return Twitter;
    }

    function Tik() public view returns (string memory) {
        return Tiktok;
    }

    function White() public view returns (string memory) {
        return WhitePaper;
    }

    function Swap() public view returns (string memory) {
        return LeyeSwap;
    }

    function Git() public view returns (string memory) {
        return Github;
    }

    function Mission() public view returns (string memory) {
        return OurMission;
    }

    function Blog() public view returns (string memory) {
        return Twitter;
    }
