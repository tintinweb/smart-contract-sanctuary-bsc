...
contract ISTEPNft is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable {
    ...
    event shoesMinted(uint256 indexed tokenId, address marketplaceAddress);

    constructor(address _marketplaceAddress) ERC721("ISTEP NFT", "ISTEPN") {
    ...
    function mint(address toAddress, uint256 boxType) external returns (uint256) {
        ...
        emit shoesMinted(newItemId, marketplaceAddress);
