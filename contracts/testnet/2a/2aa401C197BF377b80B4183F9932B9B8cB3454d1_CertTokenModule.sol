...
bytes32 constant CertTokenModuleId = keccak256('certtokenimpl.dabot.module');

contract CertTokenModule is IBCertToken, IDABotModule {
    ...
    {
        name = "CertTokenModule";
        version = "v0.1.20220301";
        moduleId = CertTokenModuleId;
    }

    function onRegister(address moduleAddress) external override { 
        emit ModuleRegistered("CertTokenModule", CertTokenModuleId, moduleAddress);
    }
