...
contract BAOLTToken is BEP20Detailed, BEP20 {
    ...
    constructor() BEP20Detailed("BaoLT", "BLT", 18) {
    ...
    function setReceiver(address _mktReceiver, address _poolReceiver) external onlyOwner {
    ...
    function _transfer(
        ...
        if (liquidityPool[sender] == true) {
            ...
            require(
                ...
                string("Consecutive sales are not allowed. Please wait a moment.")
            );
