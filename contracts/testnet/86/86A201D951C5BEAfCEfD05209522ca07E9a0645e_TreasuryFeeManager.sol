...
contract LpManager {
    ...
    function _swapToWbnb(
        ...
        // 300_000 gas for other contract calculations
        uint256 gasAmount = startGas - gasleft() - lpData.length * 10_000 + 300_000;
...
contract TreasuryFeeManager is LpManager, AccessControlEnumerable{
