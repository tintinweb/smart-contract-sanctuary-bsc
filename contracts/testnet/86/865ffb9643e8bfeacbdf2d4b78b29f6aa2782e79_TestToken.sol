...
contract TestToken is Context, IBEP20, Ownable, Pausable {
    ...
    constructor () public {
		...
		_tTotal = 1000000000000000 * _DECIMALFACTOR;
	...
	function Pause_UnPause() onlyOwner() public{
         if( _paused ){
            _unpause();
         }else{
             _pause();
