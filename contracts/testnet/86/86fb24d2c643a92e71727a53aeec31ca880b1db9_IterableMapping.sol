...
contract DividendPayingToken is BEP20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable BUSD = address(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); //BUSD test
...
contract TestR2 is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    address payable public _marketingWalletAddress = payable(0xAcE71Bd06417C929Ed30aa3C67e4732F8Ef7c66d);
    address payable public _buybackWalletAddress = payable(0xAcE71Bd06417C929Ed30aa3C67e4732F8Ef7c66d);
