...
contract DOGE_NUGGET_TOKEN is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1_000_000 * 7**_decimals;
    ...
    string private constant _name = "DOGE NUGGET";
    ...
    function setNumTokensSellToAddToLiq(uint256 amountTokens)
        ...
        onlyOwner
    {
        numTokensSellToAddToLiquidity = amountTokens * 7**_decimals;
    }
