   ...
   */
    ...
    */
    function _mint(address account, uint256 amount) internal {
        require(account != address(0), "DevToke: cannot mint to zero address");

        //Increase total supply
        _totalSupply = _totalSupply + amount;
        //Add amount to the account balance using balance mapping
        _balances[account] = _balances[account] + amount;
        //Emit our event log to the action
    ...
    */
    function _transfer(address sender, address recepient, uint256 amount) internal {
        ...
        require(recepient != address(0), "DevToken: transfer to zero address");
