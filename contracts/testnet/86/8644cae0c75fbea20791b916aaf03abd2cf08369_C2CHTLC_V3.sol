...
contract C2CHTLC_V3 is Initializable, ERC165Upgradeable, IERC1155ReceiverUpgradeable {
    ...
    */
    ...
    function acceptAndSwap( uint256 cpTokenGiveAmount, uint256 cpTokenGiveId, bytes32 requestOfferId, string calldata keyAuth )  external {
        ...
        require(cpTokenGiveAmount > 0, "Amount can't be zero");
        require(CPTOKEN.isApprovedForAll(msg.sender, address(this)), "HTLC not approved to move tokens");
        CPTOKEN.safeTransferFrom(msg.sender, _requestOfferDetails.party, cpTokenGiveId, cpTokenGiveAmount, "", keyAuth); //  replace address(this) with party's address
        ...
        emit Swap( _requestOfferDetails.party, _requestOfferDetails.counterParty, cpTokenGiveId,  _requestOfferDetails.partyTokenGiveId, cpTokenGiveAmount, _requestOfferDetails.partyTokenGiveAmount, requestOfferId );
