...
contract UphoriaProtocol is Initializable, IBEP20 {
    ...
    uint64 public MAX_PRESALE_SUPPLY;
    ...
    */
    function setPresaleTimes(uint64 _openTime, uint64 _closeTime) external onlyOwner {
    ...
    */
    function setTokenPrice(uint64 _price) external onlyOwner {
        TOKEN_PRICE = _price;
    }
    ...
    */
    function setPresaleAmount(uint64 _amount) external onlyOwner {
    ...
    */
    function initialize() public initializer {  
        ...
        _symbol = "UP";
         ...
         _balances[_teamWallet] = 7000000; // to burn
         _balances[_teamWallet] = 1470000; // team %
         _balances[_marketingWallet] = 1470000; // marketing %
         _balances[_marketingWallet] = 1470000; // private sales %
    }
