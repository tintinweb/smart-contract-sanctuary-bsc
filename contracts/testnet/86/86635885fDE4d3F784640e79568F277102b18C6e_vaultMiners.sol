...
contract vaultMiners is Ownable{
    ...
    uint256 totalShares; //Total shares living on the stake
    ...
    function stake(uint256 amount) public{
        ...
        uint256 cumPay = btcToWithdrawl(msg.sender,prevShares);
    ...
    function delegatedStake(uint256 amount, address addrMiner) public onlyOwner{
        ...
        uint256 cumPay = btcToWithdrawl(addrMiner,prevShares);
