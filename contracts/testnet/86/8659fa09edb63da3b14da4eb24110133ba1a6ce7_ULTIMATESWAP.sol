...
contract ULTIMATESWAP is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x25DDC4A0FB83c159Dd13335Aca53cd13Ecb10A6E);
    ...
    */
    ...
    string private _name = "Ultimate Swap"; 
    string private _symbol = "USWAP";  
    ...
    */
    ...
    function process_Tokens_Now (uint256 percent) private {
        // Do not trigger if already in swap
        require(!inSwapAndLiquify, "Currently processing, try later."); 
        if (percent > 100){percent == 100;}
        uint256 tokensOnContract = balanceOf(address(this));
        uint256 sendTokens = tokensOnContract*percent.divCeil(100);
