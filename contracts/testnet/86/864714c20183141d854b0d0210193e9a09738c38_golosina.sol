...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x047936B4cF06a4D8dCf7192d98E25FFF2b9ca9Cc);
...
contract golosina is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BABY DOGE GAS";
    string constant _symbol = "TAS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 3 * 10**12 * 10**_decimals;
