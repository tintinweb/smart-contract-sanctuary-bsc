    ...
    ERC20PausableUpgradeable
{
    ...
    string private    _name = "beta12";
    string private  _symbol = "beta12";
    uint8 private _decimals = 18;
  

    uint256 public _BuytaxFee = 0; // % of transactions will be redistributed among holders
    uint256 public _BuyliquidityFee = 300; // % of transactions will be kept for liquidity
    uint256 public _BuymarketingFee = 500; // % of transactions will be kept for marketing wallet
   
    uint256 public _SelltaxFee = 0; // % of transactions will be redistributed among holders
    uint256 public _SellliquidityFee = 500; // % of transactions will be kept for liquidity
    uint256 public _SellmarketingFee = 500; // % of transactions will be kept for marketing wallet
