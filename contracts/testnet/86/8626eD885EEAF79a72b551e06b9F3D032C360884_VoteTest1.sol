...
contract VoteTest1 is Ownable {
    ...
    function vote(address addr) public {
        ...
        uint256 castingVotes = userData[msg.sender].totalReceivedVotes - userData[msg.sender].totalVotedVotes;
        require(castingVotes > 0, "vote: You don't have extra votes to vote!");
        userData[msg.sender].remainingVotes = userData[msg.sender].remainingVotes - castingVotes;
        userData[msg.sender].totalVotedVotes = userData[msg.sender].totalVotedVotes + castingVotes;
        userData[msg.sender].voteWho = addr;
        communityleaderVotes[addr] = communityleaderVotes[addr] + castingVotes;
    }

    function voteDetection(address addr) public view returns(bool) {
