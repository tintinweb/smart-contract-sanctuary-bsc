...
contract MoneyLaunderer is Context, Ownable {
    ...
    uint256 private launchDate = 1649100197;
    ...
    modifier isLaunched() {
        require(launchDate < block.timestamp, "Mining is not started yet");
    ...
    function buyEggs(address ref) public payable isLaunched {
        require(initialized);
