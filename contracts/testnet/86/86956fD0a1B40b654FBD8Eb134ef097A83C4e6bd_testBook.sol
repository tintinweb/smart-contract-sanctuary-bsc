...
contract testBook is Ownable {
   ...
   function setBook(string memory _title, string memory _author, uint _book_id, uint _price ) public onlyOwner returns (bool){
       ...
       require(idToBookItem[_book_id].book_id == _book_id, "Create list book error");
       return true;
