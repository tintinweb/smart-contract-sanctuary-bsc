...
contract MFSDAO is ERC20, Ownable{
    ...
    // address public usdt = address(0x55d398326f99059fF775485246999027B3197955);  //主网
    ...
    Taxes public taxes = Taxes(0); // transfer 0%
    Taxes public swapTaxes = Taxes(5);  //SWAP 5%
    ...
    constructor() ERC20("Meta Force Space Dao", "MFS-DAO") {
        _mint(msg.sender, 9999 * 10 ** decimals());
        excludedFromFees[msg.sender] = true;

        //IRouter _router = IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);  //主网
        IRouter _router = IRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);  //主网
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        super._transfer(sender, recipient, amount - burnAmt );  
     ...
     function setswapTaxes(uint256 _burn) external onlyOwner{
        swapTaxes = Taxes(_burn);
    }
