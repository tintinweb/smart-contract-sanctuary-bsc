...
// File: @openzeppelin/contract[email protected]/token/ERC1155/IERC1155Receiver.sol
...
contract Contract1155 is ERC1155, Ownable {
    ...
    {
        tokenURI[_tokenIdCounter] = _uri;
        _mint(msg.sender, _tokenIdCounter, amount, "0x");
        emit URI(_uri, _tokenIdCounter);
        _tokenIdCounter += 1;
    }
