...
contract HeySheepMiningProof is ERC721EnumerableUpgradeable, OwnableUpgradeable {
    ...
    CountersUpgradeable.Counter public nextNonce;
    ...
    function mint() external {
        require(tx.origin == msg.sender, 'HeySheepNFT: unsupported contract caller.');
        require(getMintStatus() == 1, 'HeySheepNFT: not start.');
    ...
    function flashSale() external {
        ...
        require(tx.origin == msg.sender, 'HeySheepNFT: unsupported contract caller.');
        require(getFlashSaleStatus() == 1, 'HeySheepNFT: close.');
        require(!isBought[msg.sender], 'HeySheepNFT: already bought.');
    ...
    function airdrop(address[] calldata _addresses) external onlyOwner {
        ...
        require(_length > 0, 'HeySheepNFT: airdrop array length cannot be 0.');
