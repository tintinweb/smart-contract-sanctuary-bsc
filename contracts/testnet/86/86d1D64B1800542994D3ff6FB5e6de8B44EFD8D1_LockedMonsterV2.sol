...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
       ...
       // uint256 fromBalance = _balances[from];
        ...
        //uint tax = amount * _tax / 100; // 5
        //uint _burn_amount = amount * _burn_fee / 100; // 2

        //uint _amount = amount - tax - _burn_amount;
        ...
        _balances[to] += __amount;
  
        /*if(tax > 0) {
          _balances[_tax_recipient] += tax;
           emit Transfer(from, _tax_recipient, tax);
        } */
