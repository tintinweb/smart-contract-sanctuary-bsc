 ...
 */
contract ZFTToken is Context, IERC20, IERC20Metadata, Pausable, Ownable {
    ...
    constructor() {
        ...
        _name = 'ZEDRAW FOOTBALL TOKEN';
        _symbol = 'ZFT';
        _mint(msg.sender, 1_000_000_000 * fractions);
    }
