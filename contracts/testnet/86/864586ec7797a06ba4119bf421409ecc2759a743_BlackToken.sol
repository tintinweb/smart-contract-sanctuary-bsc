...
/*
 ...
 twitter: https://twitter.com/BlackFinTechX
 telegram: https://t.me/Blackwalletproject
...
contract BlackToken is Context, IERC20, Ownable {
    using Address for address;
//Contract Update Information
string private constant version = "3";
...
//Definition of Wallets for Marketing or team.
    address payable public marketingWalletAddress =
        payable(0x3129f0db1BE77582F6EBF8E24f40180937bc2625); // Marketing Wallet Address
...
//Token Definition.
    string private constant _name = "Black Token";
...
//Taxes Definition.
    ...
    uint256 public totalSwapableSaleFee = _saleMarketingFee;
...
//function of add liquidity if the contract is going to add liquidity automatically or by swapandliquify it will split and add to the pair and transfer lp tokens to deadWallet.
...
//set a new marketing wallet.
    ...
    function setZeroMarketingFee () external onlyOwner {
        require (_saleMarketingFee != 0, "Your MarketingFee is currently set to 0.");
        _saleMarketingFee = 0;
        totalSwapableSaleFee = 0;
    }
