...
contract Molecules is ERC721, Ownable {
    ...
    // upgrade contract to allow MEST Nodes to 
...
contract NodeManager is Ownable, Pausable {
  ...
  uint256[] public _tiersPrice = [5, 10, 20, 100, 150];
  uint256[] public _tiersRewards = [1500,3000,15000,30000,300000]; // 10000 => 1 MEST
...
contract MEST is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    uint256 public growMultiplier = 2e18; //multiplier for growing molecules e.g. level 1 molecule needs 2 MEST to become a level 2, level 2 needs 4 MEST to become level 3
    ...
    constructor(
        ...
        address uniV2Router
    ) ERC20("MetaEstate", "MEST") PaymentSplitter(payees, shares) {

        teamPool = 0x31f6D1460C2F87788f091bF3C276b3A78ad3A5b3;
        distributionPool = 0x82Fa82501c29C9d59B339EF1574e92c1ED52040a;
        devPool = 0x2cA24e6143B30bb8793559f2291d4A88ca11EAc4;
        advisorPool = 0x7b1aAF4d325142a72C7D30096df17e60d9688777;
        ...
        //_mint(0xfd050b23FFb8d93f945C53F0A42aCf1879D74F7A, 300000e18);
    ...
    function growMolecule(uint256 _tokenId) external {
        ...
        require(balanceOf(sender) > growPrice, "Not enough MEST to grow your Molecule");
