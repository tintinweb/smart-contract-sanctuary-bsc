...
import "@openzeppelin/contracts-upgradeable/security/PausableUpgradeable.sol"; // TODO delete
...
contract WorldCupPool is
    Initializable,
    OwnableUpgradeable,
    PausableUpgradeable, // TODO delete
    ERC721HolderUpgradeable
{
    ...
    mapping(uint256 => string) public finalMatchCountries; // countryId => countryName TODO delete
    ...
    function __WorldCupPool_init() internal {
        __Ownable_init();
        __Pausable_init_unchained(); // TODO delete
...
//        claimMatchBetCreditsAll();
    ...
    function payToThisContract() external payable{
