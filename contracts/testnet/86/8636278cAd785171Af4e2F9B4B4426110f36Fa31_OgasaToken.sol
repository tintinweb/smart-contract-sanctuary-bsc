    ...
    ERC20FlashMint
{
    ...
    constructor() ERC20("TestOgasa", "OGT") ERC20Permit("TestOgasa") {
        // Assign Wallets
        ...
        returns (bool)
    {
        ...
        _transfer(owner, recipient, amount, takeFee);
        return true;
    }
    ...
    */
        ...
        override(ERC20, ERC20Votes)
    {
        ...
        require(amount <= _reflectionTotal, "Must be < total reflections");
        ...
        override(ERC20, ERC20Votes)
    {
        ...
        _beforeTokenTransfer(account, BURN_WALLET, amount);
        ...
        emit Transfer(account, BURN_WALLET, amount);

        _afterTokenTransfer(account, BURN_WALLET, amount);
    }
