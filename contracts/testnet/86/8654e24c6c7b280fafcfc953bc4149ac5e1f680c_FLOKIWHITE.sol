...
interface IDEXRouter {
 ...
 contract FLOKIWHITE is IBEP20, Auth {
    ...
    address TREASURY = 0xDa79244Ea456D4BAb0966FE2B8da23346f66Dd5d;

    string constant _name = "Floki White";
    string constant _symbol = "FLOKIWHITE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**7 * (10 ** _decimals);
    uint256 public _maxTxAmount = ( _totalSupply * 10 )  / 100;

    //max wallet holding of 10% start
    ...
    address public treasuryFeeReceiver = TREASURY;
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpTreasurySuccess,) = payable(treasuryFeeReceiver).call{value: amountBNBTreasury, gas: 30000}("");

        // only to supress warning msg
        tmpSuccess = false;
        tmpTreasurySuccess = false;
    ...
    function setFees(uint256 _liquidityFee, uint256 _treasuryFee, uint256 _marketingFee,  uint256 _burnFee, uint256 _feeDenominator) external authorized {
