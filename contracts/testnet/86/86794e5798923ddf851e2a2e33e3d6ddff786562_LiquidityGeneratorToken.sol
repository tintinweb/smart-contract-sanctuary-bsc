...
// File: contracts/LiquidityGeneratorToken.sol
...
contract LiquidityGeneratorToken is IERC20, Ownable, BaseToken {
  ...
  constructor(
    ...
    string memory name_ = "TreeNity";
    string memory symbol_ = "TREE";
    uint8 decimals_ = 18;
    uint256 totalSupply_ = 1000000000000000000000000000;
    address router_ = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    address marketingAddress_ = 0x84a5bAF8C75a2E36556Fc3c2D6B61739E1Cd5fC7;
    uint16 taxFeeBps_ = 10;
    uint16 liquidityFeeBps_ = 10;
    uint16 marketingFeeBps_ = 500;
    ...
    require(
      taxFeeBps_ + liquidityFeeBps_ + marketingFeeBps_ <= 10**4 / 4,
    ...
    onlyOwner
  {
    require(
      pair != uniswapV2Pair,
      'FRESH TOKEN: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs'
    );
  ...
  function _setAutomatedMarketMakerPair(address pair, bool value) private {
    require(
      ...
      'FRESH TOKEN: Automated market maker pair is already set to that value'
    );
    automatedMarketMakerPairs[pair] = value;
  ...
  function _takeMarketingFee(uint256 tMarketing) private {
    ...
    swapTokensForEth(tMarketing);

    uint256 difference = address(this).balance.sub(initialBalance);

    payable(_marketingAddress).transfer(difference);
  }
