...
contract Voting {
    ...
    event EQuestionStatus(address userAddress, uint256 questionId, uint256 questionStatusId);
    ...
    function enableQuestion(uint256 _qid) external onlyOwner validQuestion(_qid) {
        require(
    ...
    function disableQuestion(uint256 _qid) external onlyOwner validQuestion(_qid) {
    ...
    function vote(uint256 _qid, uint256 _optionId) external validQuestion(_qid) {
