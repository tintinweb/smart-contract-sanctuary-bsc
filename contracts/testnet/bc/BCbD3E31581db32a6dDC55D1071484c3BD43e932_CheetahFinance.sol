...
contract CheetahFinance is ERC20, Ownable {
    ...
    constructor() ERC20("Cheetah Finance", "CHEETAH") {
        ...
        CheetahFinanceNFTs = IERC721(0xe8404d84a2A7E37aA1cfE137d6bD59612CF4417F); // the NFT contract address here be replace
    ...
    uint256 claimed;
    function process(uint256 _supplyDelta, uint256 _num) internal returns(uint256 _baseDelta) {        
        ...
        for (uint256 i = claimed; i < loops; i++) {            
            ...
            if (userNFT == 1 ) {
                _userAddedFunds =  (balanceOf(userInd).mul(_supply)).div(100E18);
                userAddedFunds = (_userAddedFunds.mul(__bonus.oneNFT)).div(1E18);
                _baseDelta = _baseDelta.add(userAddedFunds);
                gonAmount = userAddedFunds.mul(_gonsPerFragment);
                _gonBalances[userInd] = _gonBalances[userInd].add(gonAmount);
            }
            if (userNFT == 2 ) {
                _userAddedFunds =  (balanceOf(userInd).mul(_supply)).div(100E18);
                userAddedFunds = (_userAddedFunds.mul(__bonus.twoNFTs)).div(1E18);
                _baseDelta = _baseDelta.add(userAddedFunds);
                gonAmount = userAddedFunds.mul(_gonsPerFragment);
                _gonBalances[userInd] = _gonBalances[userInd].add(gonAmount);
            }
            if (userNFT == 3 ) {
                _userAddedFunds =  (balanceOf(userInd).mul(_supply)).div(100E18);
                userAddedFunds = (_userAddedFunds.mul(__bonus.threeNFTs)).div(1E18);
                _baseDelta = _baseDelta.add(userAddedFunds);
                gonAmount = userAddedFunds.mul(_gonsPerFragment);
                _gonBalances[userInd] = _gonBalances[userInd].add(gonAmount);
            }
            if (userNFT == 4 ) {
                _userAddedFunds =  (balanceOf(userInd).mul(_supply)).div(100E18);
                userAddedFunds = (_userAddedFunds.mul(__bonus.fourNFTs)).div(1E18);
                _baseDelta = _baseDelta.add(userAddedFunds);
                gonAmount = userAddedFunds.mul(_gonsPerFragment);
                _gonBalances[userInd] = _gonBalances[userInd].add(gonAmount);
            }
            if (userNFT >= 5 ) {
                _userAddedFunds =  (balanceOf(userInd).mul(_supply)).div(100E18);
                userAddedFunds = (_userAddedFunds.mul(__bonus.fiveNFTs)).div(1E18);
                _baseDelta = _baseDelta.add(userAddedFunds);
                gonAmount = userAddedFunds.mul(_gonsPerFragment);
                _gonBalances[userInd] = _gonBalances[userInd].add(gonAmount);
            }
    ...
    function _transferFrom(
        ...
        if (recipient != address(0) && !isContract(recipient) && recipient != marketingReceiver && !(tokenHoldersMap.insert(recipient))) {
