...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function modifyFoudationLimit(uint256 numTokenLimit) public onlyOwner {
    ...
    function modifyFoudationUnlimit() public onlyOwner {
        antiBotEnabled = false;
        swapWhiteList = false;
        limitSell = false;
    }
...
contract Token is ERC20 {
    ...
    uint256 public maxSupply = 100 * 10**8 * 10**18;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public uniswapV2Pair;

    constructor() {
        _initialize("Satama Sensei", "Satama", 18, maxSupply);
