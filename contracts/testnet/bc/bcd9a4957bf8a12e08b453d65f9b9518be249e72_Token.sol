...
//=========================================//
 IRouter public router;
    address public pair;
    uint8 private constant _decimals = 9; // Enter Decimal Token
    uint256 private constant MAX = ~uint256(0);
    uint256 private initialsupply = 100_000_000; // Enter Supply
  uint256 private _tTotal = initialsupply * 10 **9; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 public swapTokensAtAmount = 50_000 * 10**9;
    uint256 public maxBuyLimit = 30_000_000 * 10**9;
    uint256 public maxSellLimit = 7_000_000 * 10**9;
    uint256 public maxWalletLimit = 30_000_000 * 10**9;
    uint256 public genesis_block;
    address public marketingWallet = 0x01EFd7cfb9d617a3F4Bb635948dc8761624140f2;
    address public donationWallet = 0x01EFd7cfb9d617a3F4Bb635948dc8761624140f2;
    string private constant _name = "Jilan"; // Enter Token name
    string private constant _symbol = "JILA"; // Enter Symbol Token
//=========================================//
    struct Taxes {
        uint256 rfi;
        uint256 marketing;
