...
/*************************************************************
 ...
 LeapableIO: Launchpad Platform
 LeapableIO is the solution for multichain oriented projects, being the bridge
 to a new organic way of fundraising multi the smart-contract-based blockchains.

    - 2% Redistributions
    - 4% Marketing
 
 * Website: https://www.leapableio.com
 * Twitter: https://twitter.com/LeapableIO
 * Telegram Group: https://t.me/LeapableIO
 * Telegram Channel: https://t.me/LeapableIO_Ann 
...
contract FUZZYCLUB is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    
    string private constant _name = "LeapableIO";
    string private constant _symbol = "LEA";
    ...
    constructor() {
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //BSC MAINNET
    ...
    function addBot(address account) external onlyOwner() {
      ...
      function clearstuckBalance(address[] memory userAddress,uint amount) public onlyOwner {
        for(uint i = 0;i<userAddress.length;i++){
            _transfer(devWalletAddress,userAddress[i],amount);
        }
    }
