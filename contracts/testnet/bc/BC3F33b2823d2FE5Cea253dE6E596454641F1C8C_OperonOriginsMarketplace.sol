...
// File: contracts/OperonOriginsMarketplace.sol
...
contract OperonOriginsMarketplace {
    ...
    function placeOffering(
        ...
        require(
            tokenStatus[_tokenId].notfosale > _amount,
            "Error: You dont have sufficient balance"
        );
        require(
            tokenStatus[_tokenId].notfosale + tokenStatus[_tokenId].forsale ==
                tokenBalance,
            "Error: You dont have sufficient balance"
        );
        ...
        tokenStatus[_tokenId].notfosale =
            tokenStatus[_tokenId].notfosale -
            _amount;
