...
interface IBEP20 {
    ...
    /**
     * @dev Returns the amount of tokens owned by `account`. decimal
     */
...
contract WakandaBurn is Context, IBEP20, Ownable {
    ...
    address private _donationWalletAddress = 0x880ba60CA4308D4E8a26E253e5Aaa4CE132B1383;
    address private _mondayArGameWalletAddress = 0x8cB6520aF3e5A3cAC64c1fDCBcF3173Dbbb126D6;
    address private _serviceWalletAddress = 0xDe496389f08e4Def9a19fD595871c33a7226d945;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xaA93f395d7195bB3ACCE7251E7b06f3029fA6FCC);
