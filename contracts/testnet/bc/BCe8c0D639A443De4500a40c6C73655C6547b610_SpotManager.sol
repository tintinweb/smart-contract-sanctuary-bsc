...
import "./libraries/types/SpotManagerStorage.sol";
import "@openzeppelin/contracts/security/Pausable.sol";
import "../interfaces/ISpotManager.sol";
import "./libraries/helper/Timers.sol";

contract SpotManager is
    ...
    ISpotManager
{
    ...
    function initialize(
        ...
        reserveSnapshots.push(
            ReserveSnapshot(_initialPip, _now(), block.number)
        );
    ...
    function getLiquidityInPipRange(
        ...
        uint256 dataLength,
        bool toHigher
    ) public view override returns (LiquidityOfEachPip[] memory, uint128) {
    ...
    function updateBasisPoint(uint256 _newBasisPoint)
        public
        override
        onlyOwner
    {
    ...
    function updateBaseBasicPoint(uint256 _newBaseBasisPoint)
        public
        override
        onlyOwner
    {
    ...
    function updateExpireTime(uint64 _expireTime) public override onlyOwner {
        expireTime = _expireTime;
    ...
    function setCounterParty(address _counterParty) public override onlyOwner {
        ...
        counterParty = _counterParty;
        emit UpdateCounterParty(address(this), _counterParty);
    }
...
//                        console.log("step.pipNext ", step.pipNext);
