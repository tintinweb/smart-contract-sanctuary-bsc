...
contract spookieDookie4 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal =  21000000000000000 * 10**_decimals; // 21 Trillion Fixed Max Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    
    uint256 public swapTokensAtAmount = _tTotal * 10 / 1000; // THRESHOLD: 1 = 0.1%
    uint256 public maxTxAmount = _tTotal;
    uint256 public maxWalletAmount = _tTotal * 1 / 100; //

    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xBDdaA735F31913146aCaE9D8F57f78CC229acd95; // REPLACE

    string private constant _name = "Spooky Dookie4"; //
    string private constant _symbol = "SDook4"; //
