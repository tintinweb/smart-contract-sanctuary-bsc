...
contract Details is ERC1155, Ownable, Pausable,IDetails {
    ...
    constructor() ERC1155("https://bafybeibm2cylzsno22uwmbkt73lsmemfktiz3b3u66sxfhoo65d2jpd7oa.ipfs.w3s.link/json/") {
...
//MINT -----------------------------------///;)--------------------
    //0 Detail_1
    function mint_Detail_1(address adr,uint256 amount) public virtual override  {
