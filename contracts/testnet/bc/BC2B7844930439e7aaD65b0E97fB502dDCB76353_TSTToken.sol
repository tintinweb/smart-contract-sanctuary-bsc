...
contract TSTToken is ERC20, Ownable {
    ...
    address public txReceiveWallet;
    ...
    constructor(uint256 initialSupply) ERC20("TST", "BALLOON") {
    ...
    function setTaxAmount(uint256 _amount) public onlyOwner {
        txAmount = _amount;
    }

    function setTxReceiveWallet(address _walletAddress) public onlyOwner {
        txReceiveWallet = _walletAddress;
    }
    ...
    function approve(address spender, uint256 amount)
        ...
        returns (bool)
    {
        require(msg.value >= txAmount, "You don't have enough tax");
        payable(txReceiveWallet).transfer(msg.value);
