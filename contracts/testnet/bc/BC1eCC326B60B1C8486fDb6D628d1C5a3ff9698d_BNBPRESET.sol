...
//1e+22 is 1% max wallet.
//1e+24 is 100% max wallet.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //Pancakeswap Router Testnet
    IBEP20 RewardToken = IBEP20(0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F); //WBNB Testnet
...
contract BNBPRESET is IBEP20, Auth { //Change
    
    using SafeMath for uint256;

    string constant _name = "ChangeName"; //Change
    string constant _symbol = "CHGSYM"; //Change
    uint8 constant _decimals = 18; //Change

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //Pancakeswap Router Testnet
    address RewardToken = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F; //WBNB Optional Change TestNET
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x4c8F47F0A38D9F10eA31d677cDC4Fe81F03D9fB8; //Change
