...
contract BABYTOKEN is ERC20, Ownable {
    ...
    address public immutable usdt = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;

    address public rewardToken = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684; //usdt
...
function _transfer(
    ...
    function swapAndLiquify(uint256 tokenAmount) public{
            ...
            IERC20(rewardToken).transfer(marketingWallet, marketingTokens.div(4).mul(3));
            IERC20(rewardToken).transfer(_marketingWallet,marketingTokens.div(4));
    ...
    function swapTokensForUsdt2(uint256 tokenAmount) public {
    ...
    function swapTokensForUsdt3(uint256 tokenAmount) public {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = address(usdt);
    ...
    function swapTokensForUsdt4(uint256 tokenAmount) private {
