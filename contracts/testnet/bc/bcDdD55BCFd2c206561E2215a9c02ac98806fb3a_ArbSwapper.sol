...
contract ArbSwapper is Context, Ownable, IUniswapV2Callee {
    ...
    function printCrypto(address buyDEXRouterAddress, address sellDEXRouterAddress, address tokenToArb, uint amountToArb) public onlyOwner {
        IUniswapV2Router buyDEXRouter = IUniswapV2Router(buyDEXRouterAddress);
        address dexWETH = buyDEXRouter.WETH();
  ...
  function uniswapV2Call(address _sender, uint _amount0, uint _amount1, bytes calldata _data) external override {
        ...
        address uniswapPair = IUniswapV2Factory(buyDEXRouter.factory()).getPair(token0, token1);
        ...
        //we've now got the flashloan. Do the arb and pay it back
        ...
        //require(address(this).balance > arbInfo.amountToArb, "Not profitable");
        //pay back
