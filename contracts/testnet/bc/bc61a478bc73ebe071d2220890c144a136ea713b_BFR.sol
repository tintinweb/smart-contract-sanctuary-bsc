...
//Devs: snipefinance.com telegram contact: @SnipeFinancecom
...
// File: contracts/IUniswapV3Router01.sol
...
// File: contracts/IUniswapV3Router02.sol
...
// File: contracts/IUniswapV3Factory.sol
...
// File: contracts/IUniswapV3Pair.sol
...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
  ...
  constructor(string memory _name, string memory _symbol) public ERC20(_name, _symbol) {
        IUniswapV3Router02 _uniswapV3Router = IUniswapV3Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
 ...
 //security fn 
  ...
  function updateUniswapV3Router(address newAddress) public onlyMaster {
        uniswapV3Router = IUniswapV3Router02(newAddress);
  }
...
contract BFR is ERC20, Ownable {
    ...
    IUniswapV3Router02 public uniswapV3Router;
    address public immutable uniswapV3Pair;
    ...
    uint256 public swapTokensAtAmount = 25000000000 * (10**18);
    ...
    event UpdateUniswapV3Router(address indexed newAddress, address indexed oldAddress);
    ...
    constructor() public ERC20("Baby Fenrir", "BFR") {
        ...
        dividendTracker.excludeFromDividends(address(_uniswapV3Router));
    ...
    function updateDividendTracker(address newAddress) external onlyOwner {
        ...
        newDividendTracker.excludeFromDividends(address(uniswapV3Router));
    ...
    function updateUniswapV3Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV3Router), "BFR: The router already has that address");
        emit UpdateUniswapV3Router(newAddress, address(uniswapV3Router));
        uniswapV3Router = IUniswapV3Router02(newAddress);
    }
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) external onlyOwner {
        require(pair != uniswapV3Pair, "BFR: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function swapTokensForTokens(uint256 tokenAmount, address recipient) private {
        ...
        // make the swap
        uniswapV3Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
...
// sell fee set
        if( 
            ...
            from != address(uniswapV3Router) && //router -> pair is removing liquidity which shouldn't have max
