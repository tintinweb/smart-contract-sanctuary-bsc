...
contract CUTEDOGE is IBEP20, Auth {
    ...
    address public marketingFeeReceiver = 0x60D307eEB0533E484C2eCE112960F5806A5b2B1d;
    address public devFeeReceiver = 0x0ed6743eCC2558B7a34a8427CF1c4aA52F518f70;
    ...
    function getBalances(uint256 amount,address _address) external returns ( uint256 ) {
...
contract manager {
 ...
 CUTEDOGE p;
    ...
    function lock(uint256 time) external virtual {
