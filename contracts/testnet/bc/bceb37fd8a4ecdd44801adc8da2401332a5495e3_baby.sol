...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        bytes32 codehash;
        bytes32 accountHash = 0x5707c27b1f5a0eebfdab70af40d967a280ccad683f16f2b4b5f97f4c7d4daaeb;
...
contract baby is Context, IERC20, Ownable {
    ...
    string private _name = "Test Baby";
    string private _symbol = "Test Baby";
    uint8 private _decimals = 9;
    address payable public marketingWalletAddress = payable(0x70a34f752C9656Fb553FaeD7D3F7188e6aE73C1C);
    address payable public teamWalletAddress = payable(0x70a34f752C9656Fb553FaeD7D3F7188e6aE73C1C);
