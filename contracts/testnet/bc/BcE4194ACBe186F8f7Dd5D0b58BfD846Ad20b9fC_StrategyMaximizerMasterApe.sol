...
abstract contract BaseBananaMaximizerStrategy is Ownable, ReentrancyGuard {
        ...
        onlyVaultApe
    {
        ...
        // Farm excess rewards
        uint256 deposited = _farm(_amount);
        // Update userInfo
    ...
    function _farm(uint256 _amount)
        internal
        returns (uint256 _stakeTokensDeposited)
    {
        ...
        internal
    {
        ...
        /// To give correct token allocations to correct users. It's important to adjust
        ///  the "Accumulated Shares Per Staked Token" value correctly as deposits and
        ///  withdraws both simultaneously earn fees.
