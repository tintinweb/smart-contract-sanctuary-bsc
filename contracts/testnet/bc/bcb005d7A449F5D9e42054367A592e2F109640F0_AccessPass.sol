...
contract AccessPass is ERC1155, Ownable, Pausable {
    ...
    constructor() ERC1155("https://game.example/api/item/{id}.json") {
        ...
        pricesUSD[0] = 499000000 * 10**10; // 4.99 x 10^8 ($4.99)
        pricesUSD[1] = 999000000;
        pricesUSD[2] = 1999000000;
        pricesUSD[3] = 2999000000;
        pricesUSD[4] = 3999000000;
        pricesUSD[5] = 4999000000;
    }
    ...
    function getAccessPassNativePrice() public view returns (uint256) {
        uint256 result = pricesUSD[0].div(uint256(getLatestPrice()));
    ...
    function mint(uint256 id) public payable {
        ...
        require(
            msg.value >= getAccessPassNativePrice(),
