...
contract UniswapV2Router02 is IUniswapV2Router01 {
    ...
    function _addLiquidity(
        ...
        // console.log("\n\nUniswapV2Router02.sol::: _addLiquidity()");
...
library UniswapV2Library {
    ...
    function getReserves(address factory, address tokenA, address tokenB) internal view returns (uint reserveA, uint reserveB) {
        console.log("\n\nInside getReserves() method..................................");
        (address token0,) = sortTokens(tokenA, tokenB);

        console.log("Token 0: ", token0);
        console.log("pair address with pairFor: ", pairFor(factory, tokenA, tokenB));
        // address pairAddress = 0xc48512D87dd77eD2e4C10563fd7C326E78b89dbc;
        address pairAddress = IUniswapV2Factory(factory).getPair(tokenA, tokenB);
        console.log("pair address with getPair: ", pairAddress);
