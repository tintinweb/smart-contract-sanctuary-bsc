        ...
        if (users[referrerAddress].b6Matrix[level].firstLevelReferrals.length < 2) {
            ...
            if ((len == 2) && 
                ...
                if (users[referrerAddress].b6Matrix[level].firstLevelReferrals.length == 1) {
                    emit NewUserPlace(userAddress, ref, 2, level, 5, users[referrerAddress].b6Matrix[level].reinvestCount, 4);
                    users[ref].b6Matrix[level].toLevelReferrals.push(245);

                } else {
                    emit NewUserPlace(userAddress, ref, 2, level, 6, users[referrerAddress].b6Matrix[level].reinvestCount, 4);
                    users[ref].b6Matrix[level].toLevelReferrals.push(246);
                }
            }  else if ((len == 1 || len == 2) &&
                    users[ref].b6Matrix[level].firstLevelReferrals[0] == referrerAddress) {
                if (users[referrerAddress].b6Matrix[level].firstLevelReferrals.length == 1) {
                    emit NewUserPlace(userAddress, ref, 2, level, 3, users[referrerAddress].b6Matrix[level].reinvestCount, 4);
                    users[ref].b6Matrix[level].toLevelReferrals.push(243);
                } else {
                    emit NewUserPlace(userAddress, ref, 2, level, 4, users[referrerAddress].b6Matrix[level].reinvestCount, 4);
                    users[ref].b6Matrix[level].toLevelReferrals.push(244);
                }
