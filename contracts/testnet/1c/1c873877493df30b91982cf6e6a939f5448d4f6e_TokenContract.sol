...
contract TokenContract is Authorized, ERC20 {
  ...
  constructor(string memory name_, string memory symbol_, uint256 maxSupply_, uint256 feeAdm_, uint256 feePool_, uint256 initMax_, address propWallet_
  )ERC20(name_, symbol_) {
    _name = name_;
    _symbol = symbol_;
    ...
    _maxTxAmount = _initMax;
    administrationWallet = propWallet_;
