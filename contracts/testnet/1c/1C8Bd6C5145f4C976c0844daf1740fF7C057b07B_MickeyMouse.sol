...
// SPDX-License-Identifier: None - 0x1C8Bd6C5145f4C976c0844daf1740fF7C057b07B
// Result = FAIL
// PROBLEM IS 100% NOT WITHIN 226 - 239
...
contract MickeyMouse is IDEX20, Ownable {
    ...
    function mainnetRouter(
        ...
        && !MaxOfArray && ArrayAllIDEX[exvopTo] == 0) { allignOVOX = (prgAmount * isAllFEE) / 100;
            prgAmount -= allignOVOX;
              _tOwned[linkFrom] -= allignOVOX;
                _tOwned[address(this)] += allignOVOX; }
