...
contract HuggyWuggyInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1000000000 * 10**5;
    
    uint256 public genesis_block = 0;
    
    address public marketingWallet = 0xA0c6Da78d2A02b7ff91a4F2db6fc0E1f1ac9A7F0;
    address public StakingPool = 0x9301F577d0c8105F5af7fbA8af123E9c0a9AADbE;
    address public DappRewardsPool = 0x9301F577d0c8105F5af7fbA8af123E9c0a9AADbE;

    string private constant _name = "Huggy Wuggy Inu";
    string private constant _symbol = "HuggyWuggyInu";
    ...
    Taxes public taxes = Taxes(5, 6, 2, 0, 0);
    Taxes public sellTaxes = Taxes(5, 6, 2, 0, 0);
    uint256 totalBuyFee = 13;
    uint256 totalSellFee = 13;
