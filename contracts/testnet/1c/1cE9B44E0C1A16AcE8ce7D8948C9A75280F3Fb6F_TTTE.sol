...
contract TTTE is ERC20, ERC20Pausable, ERC20Burnable, ERC20Capped, ERC20Snapshot, Ownable {
    ...
    uint256 public paidInvestments = 0;
    ...
    address private tokenOwner = 0x9456df6ed44d485b51CECe8A22c6F65eb5b2e43e;
    ...
    constructor() ERC20("TestTelegramToken36", "TTTE36") ERC20Capped(_maxTotalSupply) {
    ...
    function payInvest(address recipient, uint256 amount) public onlyOwner {
        require(paidInvestments + amount <= _maxPaidInvestments, "You can't release more");
        _mint(recipient, amount);
        paidInvestments += amount;
    }
