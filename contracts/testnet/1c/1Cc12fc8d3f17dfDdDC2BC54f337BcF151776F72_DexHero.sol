...
contract DexHero is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    mapping(address => uint16) public usdSums;
    ...
    receive() external payable {
        ...
        sendETH(msg.sender, msg.value - priceETH);
        usdSums[msg.sender] += uint16(getUSDPerNFT(mintAmount));
    }
