...
/* name_: wBtcKing Coin  */
      ...
      /* rewardAddr_SHIB: 0x11e815a78Cc41D733Db00f06B3A96074855362CE */
      /* marketingWalletAddr_: 0xE51D3DE4634b1b9f03e7b2B8d5711Ee397635fED */
      /* buyFeeSetting_: [10,2,0,0] (buyTokenRewardsFee、buyLiquidityFee、buyMarketingFee、buyDeadFee) */
      /* sellFeeSetting_: [10,2,0,0] (sellTokenRewardsFee、sellLiquidityFee、sellMarketingFee、sellDeadFee) */
      /* tokenBalanceForReward_: 10000.000000000000000000  */
...
contract wBtcKing is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        dividendTracker = TokenDividendTracker(
            payable(Clones.clone(0x772bE41EB1E813B01a6Da115fd5D1C9423E4c785))
        );
