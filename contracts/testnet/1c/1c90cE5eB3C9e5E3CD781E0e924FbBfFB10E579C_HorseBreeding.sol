...
import "./Utils.sol";
contract HorseBreeding is  HorseStruct, OwnableUpgradeable, PausableUpgradeable {
  using CountersUpgradeable for CountersUpgradeable.Counter;
    ...
    HorseUpgrade public horseUpgrade;
      mapping (uint256 => uint256) public breedTimeConfigs;
      Utils public utils;
    // namely the ERC721 instances for name symbol decimals etc
    function initialize() public initializer {
        breedTimeConfigs[1]=60*60*24;
        breedTimeConfigs[2]=60*60*30;
        breedTimeConfigs[3]=60*60*36;
        breedTimeConfigs[4]=60*60*48;
        breedTimeConfigs[5]=60*60*72;
        __Ownable_init();
    }

    function initByOwner(HorseNFT _horseNFT, HorseUpgrade _horseUpgrade, Utils _utils) public onlyOwner{
      horseNFT=_horseNFT;
      utils=_utils;
    ...
    function breedingRare(uint256 rare1,uint256 rare2) public view whenNotPaused returns (
      uint256 rare
    ) {
      rare = 1;
      uint256 random = utils.random(1,1000);
      if(rare1 == 1 && rare2 == 1){
        rare = pair11(random);
      }
      else if((rare1 == 1 && rare2 == 2) ||(rare1 == 2 && rare2 == 1) ){
        rare = pair12_21(random);
      }
      else if((rare1 == 1 && rare2 == 3) ||(rare1 == 3 && rare2 == 1) ){
        rare = pair13_31(random);
      }
      else if((rare1 == 1 && rare2 == 4) ||(rare1 == 4 && rare2 == 1) ){
        rare = pair14_41(random);
      }
      else if((rare1 == 1 && rare2 == 5) ||(rare1 == 5 && rare2 == 1) ){
        rare = pair15_51(random);
      }
      else if(rare1 == 2 && rare2 == 2) {
        rare = pair22(random);
      }
      else if((rare1 == 2 && rare2 == 3) ||(rare1 == 3 && rare2 == 2) ){
        rare = pair23_32(random);
      }
      else if((rare1 == 2 && rare2 == 4) ||(rare1 == 4 && rare2 == 2) ){
        rare = pair24_42(random);
      }
      else if((rare1 == 2 && rare2 == 5) ||(rare1 == 5 && rare2 == 2) ){
         rare = pair25_52(random);
      }
      else if(rare1 == 3 && rare2 == 3) {
          rare = pair33(random);
      }
      else if((rare1 == 3 && rare2 == 4) ||(rare1 == 4 && rare2 == 3) ){
          rare = pair34_43(random);
      }
      else if((rare1 == 3 && rare2 == 5) ||(rare1 == 5 && rare2 == 3) ){
           rare = pair35_53(random);
      }
      else if(rare1 == 4 && rare2 == 4) {
         rare = pair44(random);
      }
     else if((rare1 == 4 && rare2 == 5) ||(rare1 == 5 && rare2 == 4) ){
          rare = pair45_54(random);
      }
     else if(rare1 == 5 && rare2 == 5) {
          rare = pair55(random);
      }
      // _burn(horseNft1.id);
      // _burn(horseNft1.id);
  ...
  function pair11(uint256 random) public pure returns (uint256 rare){
    rare=1;
    if(random<=733){
      rare=1;
    }else if (random>733 && random<=933 ){
      rare=2;
    }
  }

  function pair12_21(uint256 random) public pure returns (uint256 rare){
  rare=1;
  if(random<=533){
        rare=1;
  }else if(random>533 && random <= 783){
        rare=2;
  }else if(random>783 && random<= 883){
        rare=3;
  }
  }

  function pair13_31(uint256 random) public pure returns (uint256 rare){
    rare=1;
    if(random<=360){
          rare=1;
    }else if(random>660 && random <= 810){
          rare=2;
    }else if(random>810 && random <= 840){
          rare=3;
    }
  }

  function pair14_41(uint256 random) public pure returns (uint256 rare){
    rare=1;
    if(random<=187){
          rare=1;
    }else if(random>187 && random <= 537){
          rare=2;
    }else if(random>537 && random <= 737){
          rare=3;
    }else if(random>737 && random <= 787){
          rare=4;
    }else if(random>787 && random <= 797){
          rare=5;
    }
  }

  function pair15_51(uint256 random) public pure returns (uint256 rare){
    rare=3;
    if(random<=53){
          rare=1;
    }else if(random>53 && random <= 303){
          rare=2;
    }else if(random>303 && random <= 653){
          rare=3;
    }else if(random>653 && random <= 733){
          rare=4;
    }else if(random>733 && random <= 763){
          rare=5;
    }
  }

  function pair22(uint256 random) public pure returns (uint256 rare){
    rare=2;
    if(random<=333){
          rare=1;
    }else if(random>333 && random <= 683){
          rare=2;
    }else if(random>683 && random <= 833){
          rare=3;
    }
  }

  function pair23_32(uint256 random) public pure returns (uint256 rare){
    rare=2;
    if(random<=267){
          rare=1;
    }else if(random>267 && random <= 567){
          rare=2;
    }else if(random>567 && random <= 767){
          rare=3;
    }else if(random>567 && random <= 767){
          rare=3;
    }else if(random>767 && random <= 817){
          rare=4;
    }
  }

  function pair24_42(uint256 random) public pure returns (uint256 rare){
    rare=2;
    if(random<=187){
          rare=1;
    }else if(random>187 && random <= 437){
          rare=2;
    }else if(random>437 && random <= 687){
          rare=3;
    }else if(random>687 && random <= 767){
          rare=4;
    }else if(random>767 && random <= 797){
          rare=5;
    }
  }

  function pair25_52(uint256 random) public pure returns (uint256 rare){
    rare=3;
    if(random<=107){
          rare=1;
    }else if(random>107 && random <= 307){
          rare=2;
    }else if(random>307 && random <= 607){
          rare=3;
    }else if(random>607 && random <= 727){
          rare=4;
    }else if(random>727 && random <= 777){
          rare=5;
    }
  }
    
  function pair33(uint256 random) public pure returns (uint256 rare){
    rare=3;
    if(random<=360){
          rare=2;
    }else if(random>360 && random <= 760){
          rare=3;
    }else if(random>760 && random <= 840){
          rare=4;
    }
  }

   function pair34_43(uint256 random) public pure returns (uint256 rare){
    rare=2;
    if(random<=440){
          rare=2;
    }else if(random>440 && random <= 690){
          rare=3;
    }else if(random>690 && random <= 810){
          rare=4;
    }else if(random>810 && random <= 860){
          rare=5;
    }
  }

  function pair35_53(uint256 random) public pure returns (uint256 rare){
    rare=2;
    if(random<=453){
          rare=2;
    }else if(random>453 && random <= 603){
          rare=3;
    }else if(random>603 && random <= 783){
          rare=4;
    }else if(random>783 && random <= 863){
          rare=5;
    }
  }

  function pair44(uint256 random) public pure returns (uint256 rare){
  rare=4;
    if(random<=653){
          rare=3;
    }else if(random>653 && random <= 833){
          rare=4;
    }else if(random>833 && random <= 913){
          rare=5;
    }
  }

 function pair45_54(uint256 random) public pure returns (uint256 rare){
  rare=3;
    if(random<=507){
          rare=1;
    }else if(random>507 && random <= 757){
          rare=2;
    }else if(random>757 && random <= 877){
          rare=3;
    }
  }

   function pair55(uint256 random) public pure returns (uint256 rare){
    rare=4;
    if(random<=760){
          rare=1;
    }else if(random>760 && random <= 940){
          rare=2;
    }
  }

    function breeding(uint256 horseNftId1,uint256 horseNftId2) public  whenNotPaused returns (
      uint256 id
    ) {
      address owner1 = horseNFT.ownerOf(horseNftId1);
      Horse memory horseNft1= horseNFT.getHorse(owner1, horseNftId1);
      require(horseNft1.breedRemain>0,"Horse 1 can not breed");
      address owner2 = horseNFT.ownerOf(horseNftId1);
      Horse memory horseNft2 = horseNFT.getHorse(owner2, horseNftId2);
      require(horseNft2.breedRemain>0,"Horse 1 can not breed");

      require(owner1==owner2,"Horses do not belong to you");
      uint256[] memory horseTypes = new uint256[](2);
      horseTypes[0] = horseNft1.horseType;
      horseTypes[1] = horseNft2.horseType;
      uint256 horseType = horseTypes[utils.random(0,1)] ; 
      uint256 rare = breedingRare(horseNft1.rare, horseNft2.rare);
  
      // TODO
      uint256 luck =100;
      HorseUpgradeStruct memory ugradeConfig = horseUpgrade.decode(horseType, rare, 1);
       id = horseNFT.createHorse(owner1, horseType, rare, 1, 
      utils.random(ugradeConfig.minBMS,ugradeConfig.maxBMS), 
      utils.random(ugradeConfig.minMMS,ugradeConfig.maxMMS),
      utils.random(ugradeConfig.minAlt,ugradeConfig.maxAlt), 
      utils.random(ugradeConfig.minSta,ugradeConfig.maxSta), 
      luck, 
      block.timestamp + breedTimeConfigs[rare]);
      horseNFT.updateBreedHorse(owner1,horseNft1.id);
      horseNFT.updateBreedHorse(owner2,horseNft2.id);
      // _burn(horseNft1.id);
      // _burn(horseNft1.id);
    } 
...
contract HorseNFT is  HorseStruct, ERC721Upgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable, PausableUpgradeable {
  ...
  function createHorse(address owner,
        ...
        horseDetails1[owner][newHorseId] = encodeHorseDetails1(Horse(newHorseId,horseType,rare,level,bms,mms,acceleration,stamina,luck,5,breedCompletedAt,0));
        horseDetails2[owner][newHorseId] = encodeHorseDetails2(Horse(newHorseId,horseType,rare,level,bms,mms,acceleration,stamina,luck,5,breedCompletedAt,0));
  ...
  function updateBreedHorse(address owner,uint256 nftId) public onlyOwner returns (uint256) {
...
function getHorsePublic(address _owner, uint256 _id) public view returns (
  ...
  function initByOwner(address _horseMarketPlace, address _boxNFT,address _horseConfig, address _horseShop) public onlyOwner{
...
contract HorseShop is HorseStruct,OwnableUpgradeable, PausableUpgradeable  {
    ...
    function initialize() public initializer {
        ...
        shopPurchaseConfigs[1][1] = 15*10**18;
