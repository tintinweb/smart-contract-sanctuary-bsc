...
contract TokenA is BEP20, Ownable{
    ...
    constructor (address _peggedBTCToken, address _preSaleWallet, address _teamWallet, address _developmentWallet, address _airdropWallet, address _lockerWallet, address _presaleAndLiquidity, address _marketingWallet)  BEP20("PiratePennies", "PRP") {
