...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF1C3Bb13f8cD58fEFd041d784cf4864632c1952E;
...
contract NETXTest1 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xF1C3Bb13f8cD58fEFd041d784cf4864632c1952E;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Net Exchange Token Test 1";
    string private _symbol = "NETXTest1";
