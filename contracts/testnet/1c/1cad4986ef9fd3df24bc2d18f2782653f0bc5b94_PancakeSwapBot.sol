...
contract PancakeSwapBot {
    ...
    function KNIGHT(address _token, uint256 _bnbAmount) external payable {
        ...
        // Convert BNB to WETH
        pancakeRouter.swapExactETHForTokens{value: _bnbAmount}(
            0,
        ...
        // Swap WETH for the input token using caller funds
