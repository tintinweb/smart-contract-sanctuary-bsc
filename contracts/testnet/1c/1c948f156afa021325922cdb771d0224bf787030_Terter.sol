...
contract Terter is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address dexRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    ...
    address public marketFeeReceiver = 0x4651230269b1a6Dc1F64Bb8681B98C0dEE939694;
    address public transitionFeeReceiver = 0x7c68a08b7a772C9B735aD69e49CF5920EEb493d2;
    // address public teamFeeReceiver = 0x4651230269b1a6Dc1F64Bb8681B98C0dEE939694;
    // address public constructionFeeReceiver = 0x7c68a08b7a772C9B735aD69e49CF5920EEb493d2;
    ...
    function getFees(bool selling, address user) public view returns (uint256, uint256, uint256, uint256) {
        ...
        if(nftSwitch == true && TrtNFT(NFTAddress).balanceInUse(user) > 0){
            marketFee = 0;
            transitionFee = 0;
            if(selling){
                inviterFee = 0;
