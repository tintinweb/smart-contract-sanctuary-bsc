...
contract Presale is Ownable, ReentrancyGuard {
    ...
    address public tokenAddress = 0x3D642Bc6DC49b7a046e42fd7ae4D7d707CAF73B5;
    uint256 public period = 3 hours;
    uint256 public startDate;

    constructor() {
        pricePerStage[1] = 10**16; //0.01bnb
        pricePerStage[2] = 17 * 10**15; //0.017 bnb
        pricePerStage[3] = 20 * 10**15; //0.02 bnb
    }
    ...
    function buyToken(uint256 buyAmount) external payable nonReentrant {
        ...
        require(
            msg.value ==
                (buyAmount * pricePerStage[getCurrentStage()]) / 10**18,
    ...
    function withdrawToken() external onlyOwner {
        ...
        IERC20(tokenAddress).transfer(msg.sender, remainingTokenAmount);
    }
}