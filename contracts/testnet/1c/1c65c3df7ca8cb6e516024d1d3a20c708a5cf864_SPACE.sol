...
contract SPACE is IERC20, Ownable {
    ...
    address public marketAddress = 0x0cFB330C8A8b5e96663a0A0edE6d89ECcE1c5d16;

    uint256 private _tFeeTotal;

    string private _name = "HQNS";
    string private _symbol = "HQNS";
    ...
    address public swapWhiteAddr = 0x0cFB330C8A8b5e96663a0A0edE6d89ECcE1c5d16;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        fromAddress = from;
        toAddress = to;  
         if(_tOwned[address(this)] >= 1 * 10**3 * 10**9 && from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
