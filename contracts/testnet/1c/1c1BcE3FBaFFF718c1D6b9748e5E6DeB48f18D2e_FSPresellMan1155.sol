...
//Import ownable, pausable, reentracy
...
contract FSPresellMan1155 is ERC1155, Ownable, Pausable, AccessControl{
    ...
    function updatePrice(uint256 _usdPrice) public onlyOwner {
        usdPrice = _usdPrice;
        emit PriceChanged(msg.sender, _usdPrice);
    }
    ...
    function mint(uint256 envNum, uint256 amount) public whenNotPaused returns(bool){
        ...
        require(envNum * usdPrice == amount, "The amount needs to be equals envNum * usdPrice");
        ...
        USDT.transferFrom(msg.sender, fsWallet, amount);

        //ERC1155Mint
        _mint(msg.sender, 0, envNum, "");

        buyers[msg.sender] += envNum;
