...
contract Rode is IBEP20, Owned {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        /* This strategy is used because there's no direct way to check
        * if a key exists in a mapping [it'll always return true]
        */
    ...
    // ------------------------------------------------------------------------
     function _updateRecord(address account) private returns (bool success){
        ...
        for(uint256 i=0; i < tempRecords.length; i++){
            if(tempRecords[i].lockingPeriod >= block.timestamp && tempRecords[i].isUnlocked == true){
