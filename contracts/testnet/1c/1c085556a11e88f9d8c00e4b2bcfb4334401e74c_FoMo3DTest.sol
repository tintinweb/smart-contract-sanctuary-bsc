...
library F3DKeysCalcLong {
                    ...
                    (
                        (
                            ((_eth).mul(1000000000000000000)).mul(
                                41687500000000000000000000000


                            )
                        ).add(
                                750373436719564208984375000000000000000000000000000000000000000000
                            )
                    ).sqrt()
                ).sub(10004989578125000000000000000000000)
            ) / (20843750000);
    }
    ...
    function eth(uint256 _keys) internal pure returns (uint256) {
        return
            (
                (10421875000).mul(_keys.sq()).add(
                    ((20009979156250000).mul(_keys.mul(1000000000000000000))) /
                        (2)
                )
