...
contract Tasker is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Tasker";
    ...
    uint256 internal _tokenTotal = 10000000 *10**18; // 10 Million totalSupply
    ...
    uint256 public _burningFee = 0;
    uint256 public _smarketingFee = 600; //600 = 6%

    uint256 public _maxTxAmount = 500000 * 10**18; // 500,000 initial max limit
    ...
    address public smarketingAddress = 0xc327aaA79c40996a2d4E8B82021ACb33892B3b11;      // SMarketing Address
