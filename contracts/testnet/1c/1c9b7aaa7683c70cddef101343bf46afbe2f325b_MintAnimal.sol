...
contract MintAnimal is TransferOwnable {
    ...
    constructor( ) {
        ...
        modify(indexs, actis);
        /*
        animals[1] = animalEntry({acti: 1});
        animals[2] = animalEntry({acti: 1});
        animals[3] = animalEntry({acti: 1});
        animals[4] = animalEntry({acti: 1});
        animals[5] = animalEntry({acti: 1});
        animals[6] = animalEntry({acti: 1});
        animals[7] = animalEntry({acti: 1});
        animals[8] = animalEntry({acti: 1});
        animals[9] = animalEntry({acti: 1});
        animals[10] = animalEntry({acti: 1});
