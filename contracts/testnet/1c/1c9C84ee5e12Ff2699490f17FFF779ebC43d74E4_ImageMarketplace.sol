    ...
    UUPSUpgradeable
{
    ...
    function cancelListImageNFT(uint256 marketItemId) public {
        ...
        delete idToMarketItem[marketItemId].tokenId;
        // Transfer
        nft.transferFrom(address(this), msg.sender, idToMarketItem[marketItemId].tokenId);

        // Emit
        emit CancelListImageNFT(idToMarketItem[marketItemId].tokenId, nftContract);
        ...
        public nonReentrant
    {
        ...
        payable(address(this)).transfer(item.price);    // deposit from msg.sender to contract
