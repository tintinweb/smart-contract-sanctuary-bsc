...
contract FarmCoin is Ownable {
    ...
    constructor(
        ...
        mint(ownderAddressForPublicSale, 25_00_000_0 * decimalfactor);
        mint(developmentTeam, 5_00_000_0 * decimalfactor);
        mint(treasuryTeam, 40_00_000_0 * decimalfactor);

        mint(marketingTeam, 5_0_000_00 * decimalfactor);
        mint(address(this), 25_0_000_00 * decimalfactor);
