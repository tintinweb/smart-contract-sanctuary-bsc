...
contract GoodGuyGreg is IERC20, Ownable {
    using Address for address;
    
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "GGG";
    string constant _symbol = "Good Guy Greg";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_00_000_000_000_000 * (10 ** _decimals);

    uint256 _maxTxAmount = 20; //2%
    ...
    uint256 communityAwardSellFee = 0;
    uint256 USDCRewardFee = 0;
