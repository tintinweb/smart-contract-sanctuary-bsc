...
contract BscArbitrage is OwnableUpgradeable {
    ...
    function initialize(address _pancakeRouterAddress, address tokenAddressBasic, address tokenAddressStable) external initializer {
        __Ownable_init();
