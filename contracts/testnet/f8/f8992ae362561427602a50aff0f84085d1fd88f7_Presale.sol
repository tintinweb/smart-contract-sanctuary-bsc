...
contract Presale is Ownable {
    ...
    address public tokenAddress=0xD1c1f1E09EAd8CbD2b6B9c15A8b676108a426854;
    ...
    uint256 public hardcap = 5000*1e18;
    address private dev;
    uint256 private MaxValue = 20000000000000000000;
    ...
    address public recipient = 0x84dC22340B4Dc954E9663BB0F29caF4a6063acb7;
    ...
    function burnUnsoldTokens() external onlyOwner {
        ...
        PreTokens(tokenAddress).burn(
            PreTokens(tokenAddress).balanceOf(address(this))
        );
    }
    ...
    function getUnsoldTokens(address to) external onlyOwner {
        ...
        PreTokens(tokenAddress).transfer(
            to,
            PreTokens(tokenAddress).balanceOf(address(this))
        );
    }
