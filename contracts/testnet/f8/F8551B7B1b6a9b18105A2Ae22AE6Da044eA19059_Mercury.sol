...
contract Mercury is ERC20Taxation {
    ...
    ERC20DexLink(0xB6BA90af76D139AB3170c7df0139636dB6120F7e)
    {
        autoSupportWallets = [0xd337A343940931ac2E1524AaC749778C6DC1Ec78];
        _isExcludedFromFee[0xd337A343940931ac2E1524AaC749778C6DC1Ec78] = true;
    ...
    function burnLP(uint256 amount) public onlyOwner {
