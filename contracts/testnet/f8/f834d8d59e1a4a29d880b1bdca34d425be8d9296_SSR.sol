...
TG: https://t.me/+1EMRioQiZzkzN2Rl
TAX: 
BUY : 10% 
SELL: 10%
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf7a619Db040f3c5aa4f73d1C761aa9d1d766EB29; // owner address
...
contract SSR is Context, IERC20, Ownable {
    ...
    string private _name = "SSR!!!";
    string private _symbol = "SSR!!!";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xe363eE2e2E7a8299cBe142e238bFadaECA9846Dc); // Marketing Address
    address payable public teamWalletAddress = payable(0x5973962152D9a5680f45725c9cA039B1679F5026); // Team Address
