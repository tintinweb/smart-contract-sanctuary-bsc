...
contract Token is ERC20, Ownable {
  ...
  uint256 public keepProtectTime = 3600; //3 days;
  uint256 public startPendingTime = 300; //5 hours;
  ...
  address public usdt = 0x0a8d08e14b8b2eaF5F8A89c9B87f4F13Ca41741e;
  ...
  constructor(string memory _name, string memory _symbol, address _owner) ERC20(_name, _symbol) Ownable(_owner) {
   ...
   whitelist1[address(0x6c89d7796818259da1f6D39ACAb882bea4E62947)] = true;
   whitelist2[address(0x940A9210ff9a6547D9aFA0887AEF7C9A5Ae6100e)] = true;
  }
