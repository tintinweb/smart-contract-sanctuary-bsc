...
contract GatorGang is ERC721Enumerable, Ownable {
    ...
    // NFT Name
    string public constant TOKEN_NAME = "Gator Gang NFT Collection";
    // NFT Symbol
    string public constant TOKEN_SYMBOL = "GatorGang";
    ...
    function setPresaleMaxCounter(uint256 counter) external onlyOwner {
        require(counter > 0, "setPresaleMaxCounter: amount could not be zero");
    ...
    function setPublicSaleMaxCounter(uint256 counter) external onlyOwner {
        require(
            counter > 0,
            "setPublicSaleMaxCounter: amount could not be zero"
        );
    ...
    function setPresalePrice(uint256 price) external onlyOwner {
        require(price > 0, "setPresalePrice: amount could not be zero");
    ...
    function setPublicSalePrice(uint256 price) external onlyOwner {
        require(price > 0, "setPublicSalePrice: amount could not be zero");
