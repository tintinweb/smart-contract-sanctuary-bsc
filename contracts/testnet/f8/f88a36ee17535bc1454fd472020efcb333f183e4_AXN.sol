...
// File: contracts/USDXImplementation.sol
...
/**
 * @title USDXImplementation
 * @dev this contract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing USDXImplementation
...
contract AXN {
    ...
    string public constant name = "AXEN TOKEN"; // solium-disable-line
    string public constant symbol = "AXN"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all USDX at the contract address.
     * This sends the USDX tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimUSDX() external onlyOwner {
