...
contract TokenSwap {
    ...
    ERC20 private tokenIn;
    ERC20 private tokenOut;
	address public tokenWallet;

	constructor(ERC20 _tokenIn, ERC20 _tokenOut, address _tokenWallet) {
		tokenIn = _tokenIn;
		tokenOut = _tokenOut;
    ...
    function swap(uint256 amountIn) public returns (uint256) {
        ...
        tokenOut.approve(msg.sender, exchangeAmount);
        tokenOut.transferFrom(address(this), msg.sender, exchangeAmount);
