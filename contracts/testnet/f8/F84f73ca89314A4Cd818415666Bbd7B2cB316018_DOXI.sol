...
contract DOXI is Context, IBEP20, Ownable {
        ...
        address private CharityWallet = 0x3cd46848990CeCDB19281368F8E0fDbAbd9032aC;
        ...
        uint256 public _maxWalletHoldingAmount = 2 *10**6 * 10**9;   
        ...
        constructor () {
            ...
            _isExcludedFromWalletLimit[CharityWallet] = true;
        ...
        function UpdateFeesPercentage(uint256 taxFee,uint256 CharityFee) external onlyOwner() {
            require(taxFee.add(CharityFee) <= 25);
            _taxFee = taxFee;
        ...
        function setMaxWalletHoldingPercentage(uint256 maxWalletPercentage) external onlyOwner() {
         ...
         _maxWalletHoldingAmount = _tTotal.mul(maxWalletPercentage).div(
            10**2
        );
        }
