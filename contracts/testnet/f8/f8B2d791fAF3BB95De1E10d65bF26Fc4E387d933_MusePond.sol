...
contract MusePond is Ownable {
    ...
    uint256 public gasPrice = 2 * 10 ** 5;
     mapping(uint256 => bool) isOrder;

    address public profitAddress = address(0x1aEC6c501977F9C6F90B65F80c400C33398cae04);
