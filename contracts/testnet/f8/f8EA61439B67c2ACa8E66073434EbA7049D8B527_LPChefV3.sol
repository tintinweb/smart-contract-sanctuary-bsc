...
contract LPChefV3 is Ownable {
    ...
    function initToken(
        ...
        address _aimToken,
        address _usdtToken,
        address _aimUsdtPair
    ) public onlyOwner {
        oasToken = _oasToken;
        aimToken = _aimToken;
        usdtToken = _usdtToken;
        aimUsdtPair = _aimUsdtPair;
    }
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        IERC20(aimUsdtPair).safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function withdraw(
        ...
        IERC20(aimUsdtPair).safeTransfer(msg.sender, _amount);
    ...
    function calcMicWorth(uint256 lpAmount) public view returns (uint256) {
        uint256 usdtPairBalance = IERC20(usdtToken).balanceOf(aimUsdtPair);
        uint256 totalSupply = IERC20(aimUsdtPair).totalSupply();
