...
library Address{
 ...
 contract SafuLine is Context, IERC20, Ownable {
    ...
    bool public tradingEnabled = true; // 2022.03.23
    ...
    uint256 public coolDownTime = 180 seconds; // 2022.03.18
    ...
    function setTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _funding) public onlyOwner {
        buytotaltaxes = _rfi + _marketing + _liquidity + _funding; // 2022.03.18
        require(buytotaltaxes <= 20, "Must keep taxes at 20% or less"); // 2022.03.18
    ...
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _funding) public onlyOwner {
        selltotaltaxes = _rfi + _marketing + _liquidity + _funding; // 2022.03.18
        require(selltotaltaxes <= 20, "Must keep taxes at 20% or less"); // 2022.03.18
    ...
    function updateCooldown(bool state, uint256 time) external onlyOwner{
        require(time <= 180, "Can't exceed 180 seconds."); // 2022.03.18
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell) external onlyOwner{
        require(maxBuy <= 10000000000, "Max tx limit could not be less than 1% total supply"); // 2022.03.18
        require(maxSell <= 10000000000, "Max tx limit could not be less than 1% total supply"); // 2022.03.18
