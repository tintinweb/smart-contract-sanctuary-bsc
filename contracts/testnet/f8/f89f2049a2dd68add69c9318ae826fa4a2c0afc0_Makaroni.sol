...
// File: contracts/makaroni/IERC20.sol
...
// File: contracts/makaroni/IERC20Metadata.sol
...
// File: contracts/makaroni/Context.sol
...
// File: contracts/makaroni/ERC20.sol
...
// File: contracts/makaroni/Ownable.sol
...
// File: contracts/makaroni/SafeMath.sol
...
// File: contracts/makaroni/SafeMathUint.sol
...
// File: contracts/makaroni/SafeMathInt.sol
...
// File: contracts/makaroni/DividendPayingTokenInterface.sol
...
// File: contracts/makaroni/DividendPayingTokenOptionalInterface.sol
...
// File: contracts/makaroni/DividendPayingToken.sol
...
// File: contracts/makaroni/IterableMapping.sol
...
// File: contracts/makaroni/IUniswapV2Router01.sol
...
// File: contracts/makaroni/IUniswapV2Router02.sol
...
// File: contracts/makaroni/IUniswapV2Factory.sol
...
// File: contracts/makaroni/IUniswapV2Pair.sol
...
// File: contracts/makaroni/MakaroniToken.sol
...
contract Makaroni is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable _marketingWallet = payable(address(0x3aF35e41d1974f8164B7475Eca963Cab9fc67a62));
    ...
    constructor() ERC20("Makaroni Token", "$MKRT") {
        buyFee.rewardFee = 3;
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Makaroni: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "Makaroni: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Makaroni: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "Makaroni: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "Makaroni: Cannot update gasForProcessing to same value"
        );
    ...
    function _transfer(
        ...
        require(from != address(0), "Makaroni: transfer from the zero address");
        require(to != address(0), "Makaroni: transfer to the zero address");
        require(
...
contract TokenDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("Makaroni", "Makaroni_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "Makaroni_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "Makaroni_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "Makaroni_Dividend_Tracker: Cannot update claimWait to same value"
        );
