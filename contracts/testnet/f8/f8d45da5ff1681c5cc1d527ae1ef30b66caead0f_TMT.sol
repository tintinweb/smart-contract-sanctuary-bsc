...
contract TMT is Context, IERC20, Ownable {
    ...
    address public _EcoWalletAddress = 0x5AA1dCA1EF60afBc2DDb215de890aD4b50615b2C;
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair)
        {
            ...
            uint256 ecoShare = amount * _EcoFee / 100;
            amount -= ecoShare;
            _tOwned[_EcoWalletAddress] += ecoShare;
            emit Transfer(from, _EcoWalletAddress, ecoShare);
