...
contract SafeMoonGrow is Context, Ownable, IERC20, IERC20Metadata {
    using SafeMath for uint256;
    string private _name = "SafeMoonGrow";
    string private _symbol = "SMG";
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 public _taxSell = 5;
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "SafeMoonGrow2: decreased allowance below zero"
        );
        unchecked {
    ...
    function _transfer(
        ...
        require(
            sender != address(0),
            "SafeMoonGrow2: transfer from the zero address"
        );
        require(
            recipient != address(0),
            "SafeMoonGrow2: transfer to the zero address"
        );
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(
            account != address(0),
            "SafeMoonGrow2: mint to the zero address"
        );
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(
            account != address(0),
            "SafeMoonGrow2: burn from the zero address"
        );

        uint256 accountBalance = _balances[account];
        require(
            accountBalance >= amount,
            "SafeMoonGrow2: burn amount exceeds balance"
        );
        unchecked {
    ...
    function _approve(
        ...
        require(
            owner != address(0),
            "SafeMoonGrow2: approve from the zero address"
        );
        require(
            spender != address(0),
            "SafeMoonGrow2: approve to the zero address"
        );
