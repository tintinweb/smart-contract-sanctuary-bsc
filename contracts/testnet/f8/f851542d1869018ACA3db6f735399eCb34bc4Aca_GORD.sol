...
contract GORD is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x6f87fE3F55a2cEFa9e17EF76Baf3822f6E1bb0C2));

    string private _name = "Gord Token";
    string private _symbol = "GORD";
