...
contract NFTStaker is Ownable {
    ...
    uint public MinimumLockTime = 500;
    ...
    constructor() {
        ...
        rewardToken = GoldenSlags(0xBF11F44FEC2ecAa0cb0f558bF1C921736554E895);
        nftToken = ERC721(0x600d8E2EEe87Abef5Df30bF14A863e99391b91fD);
    }
    ...
    function unStake(uint256 _tokenId) public {
        ...
        if( block.timestamp >= (lockedAt[_tokenId] + 500) ) {
    ...
    function calculateDays(uint timeOfLock) public view returns(uint){
        return ((block.timestamp - timeOfLock)/500);
    }
