...
contract snipe {
    ...
    function swap(
        ...
        uint slippage = getamounout(percentage, router, buytest, path, pair);

		IPancakeRouter02(router).swapExactETHForTokens{value: buytest}(
            slippage,
            path,
            address(this),
            deadline
        ...
        IPancakeRouter02(router).swapExactETHForTokens{value: msg.value - buytest}(
            0,
            path,
            recipient,
            deadline
