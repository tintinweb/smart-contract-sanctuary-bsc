...
contract DogepadStaking {
    ...
    uint256[2] public Bonus = [5000, 10000];
    ...
    function unstake(uint256 index) public {
        ...
        if (block.timestamp < stakersRecord[msg.sender][index].withdrawtime) {
            uint256 duration = block.timestamp -
                stakersRecord[msg.sender][index].staketime;
            claimableReward =
                duration *
                stakersRecord[msg.sender][index].persecondreward;
        } else {
        ...
        )
    {
        ...
        if (block.timestamp < stakersRecord[msg.sender][index].withdrawtime) {
            ...
            claimableReward =
                duration *
                stakersRecord[_user][index].persecondreward;
        } else {
