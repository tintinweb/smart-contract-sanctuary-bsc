...
contract WFTOKEN is Context, IERC20, Ownable {
    ...
    uint256 private lowBalance = 20000000000;
    ...
    constructor (
        ...
        isExcludedFromFee[wfSender] = true;
        isExcludedFromFee[marketingAddress] = true;

        _balances[owner] = 127875 * 10 ** _decimals;
        _balances[wfSender] = 82125 * 10 ** _decimals;
        
        emit Transfer(address(0), owner, _balances[owner]);
        emit Transfer(address(0), wfSender, _balances[wfSender]);
    }
    ...
    function getSpread(address _to) public view returns (address[] memory) {
        return spreads[_to];
    }
