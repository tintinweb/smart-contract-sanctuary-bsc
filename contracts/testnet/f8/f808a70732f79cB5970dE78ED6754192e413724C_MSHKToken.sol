 ...
 */
contract MSHKToken is ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    address private constant _factoryAddress = 0x6725F303b657a9451d8BA641348b6761A6CC7a17;
    address private constant _routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    address private constant _deadAddress = 0x000000000000000000000000000000000000aaaa;
    ...
    function setTaxes(
        ...
        require( rewardsTax_ + marketingTax_ + teamTax_ <= 10, "Total taxes should never be more than 10%.");
