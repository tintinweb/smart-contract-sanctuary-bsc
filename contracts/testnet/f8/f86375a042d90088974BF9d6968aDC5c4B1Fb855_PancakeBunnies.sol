...
import "./PancakeBunnies_ERC721.sol";
...
contract PancakeBunnies is ERC721, Ownable {
    ...
    constructor(string memory _baseURI) ERC721("Pancake Bunnies", "PB") {
     ...
     * eg. newId = 1, _tokenURI = ipfs://QmYu9WwPNKNSZQiTCDfRk7aCR472GURavR9M1qosDmqpev/sparkle.json
     */
    function mint(
        address _to,
