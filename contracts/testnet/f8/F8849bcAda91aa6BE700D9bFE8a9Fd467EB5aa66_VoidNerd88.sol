...
contract VoidNerd88 is ERC721, Ownable {
    constructor()ERC721("VoidNerd88", "VN88"){}
    ...
    function _createRandomNum(uint256 min, uint256 max, uint256 _tokenId,string memory _type) view internal returns (uint256) {
    ...
    function _createVoidNerd(string memory _name) internal {
        ...
        uint8 randomSpeed =  uint8(_createRandomNum(49,100,COUNTER,"Speed"));
        uint8 randomShoot =  uint8(_createRandomNum(49,100,COUNTER,"Shoot"));
        uint8 randomDefend =  uint8(_createRandomNum(49,100,COUNTER,"Defend"));
        uint8 randomSave =  uint8(_createRandomNum(49,100,COUNTER,"Save"));
        uint8 randomLucky =  uint8(_createRandomNum(49,100,COUNTER,"Lucky"));
        Void memory newVoid = Void(_name, COUNTER, randomDna, 1, randomRarity,randomSpeed,randomShoot,randomDefend,randomSave,randomLucky);
        voids.push(newVoid);
