...
contract LMSTracker is Initializable, OwnableUpgradeable {
    ...
    function initialize() initializer public{
        ...
        _proposedTokens.add(0xCA8a64D8414f8a891Cb13249d3B845839FBC2E8c);
        _proposedTokens.add(0x7b652c56AB8bE2EE29a65A018C25ae3B0A2AECa4);
        _proposedTokens.add(0x969faf5BEC994f40986b85c131d59e7219523257);
        _proposedTokens.add(0x242cb22b2524dBC64BA1b81c59AD139Dbe89E080);

        minimumBalanceForRewards = 1e7 * (10**18); //! test
        week;
