...
contract ZoomLoupe is Ownable, Pausable{
    ...
    uint256 Decimals =1000;

    uint256 Num_NFTW =220;
...
constructor() {
        ...
        TrueChest =ITrue_chest(0x3e9cE989B7c84Cf9032ADa506607EeA3e7f941B0);////
...
///////
    ...
    function Take_chest (uint256 num_Track, uint256 chest_num) public {
        ...
        uint256 procent_owner = TrueChest.Get_LevelPlayer_num(msg.sender, num_Track, chest_num);
        uint256 procent_landlord =100-procent_owner;



        MITICOIN.transfer(msg.sender, _MITI*Decimals/100*procent_owner);
        USDT.transfer(msg.sender, _USDT*Decimals/100*procent_owner);

        MITICOIN.transfer(dis.getLandLord(), _MITI*Decimals/100*procent_landlord);
        USDT.transfer(dis.getLandLord(), _USDT*Decimals/100*procent_landlord);
...
require(hs);
    ...
    function Set_Decimals(uint256 Num) public onlyOwner {
        Decimals=Num;
    }
