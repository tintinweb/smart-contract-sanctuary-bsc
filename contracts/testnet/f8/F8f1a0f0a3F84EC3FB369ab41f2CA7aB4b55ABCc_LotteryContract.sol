...
contract LotteryContract is Ownable {
    ...
    function viewTicketIdRewards(uint256 _ticketId, uint256 _lotteryId) public view returns(uint256){
    ...
    {      
        ...
        for (uint256 i = 0; i < 6; i++) {
            countWinner[i] = numberTicketsPerLotteryId[_lotteryId][bracketCalculator[i] + (lotteries[_lotteryId].finalNumber % 10 ** (i))];           
        }
