...
contract UberTaxiController is Ownable {
    ...
    constructor() {
        ...
        UTN = UberTaxiNFT(0xa0AA80224cc2c24A976145F46B917950f7A4f8B0);
        ...
        //初始化车辆
        vehicles[1] = Vehicle("Volkswagen",   1, 1000e18, 1000e18, 5*10, true);
        vehicles[2] = Vehicle("Tesla",        2, 2000e18, 2000e18, 5.2*10, true);
        vehicles[3] = Vehicle("Audi",         3, 3000e18, 3000e18, 5.4*10, false);
        vehicles[4] = Vehicle("BMW",          4, 4000e18, 4000e18, 5.6*10, false);
        vehicles[5] = Vehicle("MercedesBenz", 5, 5000e18, 5000e18, 5.8*10, false);
        vehicles[6] = Vehicle("RollsRoyce",   6, 10000e18, 10000e18, 6*10, false);
    }
