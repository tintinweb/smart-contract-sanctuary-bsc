...
contract TESTING_ERC1155X is ERC1155, Ownable {
  ...
  constructor() ERC1155("") {
    name = "CG";
    symbol = "CGX";
     _mint(0xC430A10C259a56926F80c4155a7e4037b20CFa50, 1, 10000, ""); // mint all
     emit URI("https://chaingold.net/json/batches.json", 1);
  }
 ...
 function mint(address _to, uint _id, uint _amount) external onlyOwner {
  ...
  function totalSupply() public returns (uint) {
        return 1000; // return number of meters in the batch
    }
