...
contract SmartBeComBee {
    ...
    function updB3Refer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (users[referrerAddress].b3Matrix[level].referrals.length < 3) {
            emit NewUserPlace(userAddress, referrerAddress, 1, level, uint8(users[referrerAddress].b3Matrix[level].referrals.length), users[userAddress].b3Matrix[level].reinvestCount, usertype);
            return sendETHDividends(referrerAddress, userAddress, 1, level);
        }
        
        emit NewUserPlace(userAddress, referrerAddress, 1, level, 3, users[userAddress].b3Matrix[level].reinvestCount, usertype);
    ...
    function updB6Referrer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (users[referrerAddress].b6Matrix[level].firstLevelReferrals.length < 2) {
            ...
            emit NewUserPlace(userAddress, referrerAddress, 2, level, uint8(users[referrerAddress].b6Matrix[level].firstLevelReferrals.length), users[userAddress].b6Matrix[level].reinvestCount, usertype);
            ...
            if ((len == 2) && 
                ...
                if (users[referrerAddress].b6Matrix[level].firstLevelReferrals.length == 1) {
                    emit NewUserPlace(userAddress, ref, 2, level, 5, users[userAddress].b6Matrix[level].reinvestCount, usertype);
                } else {
                    emit NewUserPlace(userAddress, ref, 2, level, 6, users[userAddress].b6Matrix[level].reinvestCount, usertype);
                }
            }  else if ((len == 1 || len == 2) &&
                    users[ref].b6Matrix[level].firstLevelReferrals[0] == referrerAddress) {
                if (users[referrerAddress].b6Matrix[level].firstLevelReferrals.length == 1) {
                    emit NewUserPlace(userAddress, ref, 2, level, 3, users[userAddress].b6Matrix[level].reinvestCount, usertype);
                } else {
                    emit NewUserPlace(userAddress, ref, 2, level, 4, users[userAddress].b6Matrix[level].reinvestCount, usertype);
                }
    ...
    function updB6(address userAddress, address referrerAddress, uint8 level, bool x2) private {
        if (!x2) {
            ...
            emit NewUserPlace(userAddress, users[referrerAddress].b6Matrix[level].firstLevelReferrals[0], 2, level, uint8(users[users[referrerAddress].b6Matrix[level].firstLevelReferrals[0]].b6Matrix[level].firstLevelReferrals.length), users[userAddress].b6Matrix[level].reinvestCount, 2);
            emit NewUserPlace(userAddress, referrerAddress, 2, level, 2 + uint8(users[users[referrerAddress].b6Matrix[level].firstLevelReferrals[0]].b6Matrix[level].firstLevelReferrals.length), users[userAddress].b6Matrix[level].reinvestCount, 2);
            //set current level
            ...
            emit NewUserPlace(userAddress, users[referrerAddress].b6Matrix[level].firstLevelReferrals[1], 2, level, uint8(users[users[referrerAddress].b6Matrix[level].firstLevelReferrals[1]].b6Matrix[level].firstLevelReferrals.length), users[userAddress].b6Matrix[level].reinvestCount, 2);
            emit NewUserPlace(userAddress, referrerAddress, 2, level, 4 + uint8(users[users[referrerAddress].b6Matrix[level].firstLevelReferrals[1]].b6Matrix[level].firstLevelReferrals.length), users[userAddress].b6Matrix[level].reinvestCount, 2);
            //set current level
