...
Space Field Game
  ...
  ~ 10 Space Ore minimum investment.
  ~ 50,000 Space Ore max deposits per wallet.
...
contract SpaceField {
    ...
    IERC20 public token_SOT;
	address erctoken = 0xE3b3d3558f6F1b5bb59f2064CEa91482abE44d93; /** token address **/

    /** base parameters **/
    uint256 public EGGS_TO_HIRE_1MINERS = 2592000; /** 4% **/
    ...
    uint256 public MIN_INVEST_LIMIT = 10 * 1e9; /** 10 Space Ore  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 50000 * 1e9; /** 50,000 Space Ore  **/
    ...
    function sellEggs() public{
        ...
        token_SOT.transfer(msg.sender, eggsPayout);
    ...
    function buyEggs(address ref, uint256 amount) public payable{
        ...
        token_SOT.transferFrom(address(msg.sender), address(this), amount);
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                ...
                token_SOT.transfer(upline, refRewards);
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_SOT.transfer(owner, dev);
        token_SOT.transfer(dev1, dev);
        token_SOT.transfer(dev2, marketing);
        token_SOT.transfer(mkt, marketing);
        return marketing.add(dev);
    }
    ...
    function getBalance() public view returns(uint256){
        return token_SOT.balanceOf(address(this));
    }
