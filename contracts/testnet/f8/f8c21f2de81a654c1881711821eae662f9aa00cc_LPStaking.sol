...
contract LPStaking is Initializable, ReentrancyGuard {
  ...
  event DepositWithdraw(address indexed user, uint256 amount, address indexed to, func indexed dw);
  /*==================================================== Modifiers ==========================================================*/
  //Modifiers here..
  modifier onlyAdmin() {
  ...
  function deposit(uint256 amount, address to) public {
    ...
    emit DepositWithdraw(msg.sender, amount, to, func._deposit);
  }
  ...
  function withdraw(uint256 amount, address to) public nonReentrant {
    ...
    emit DepositWithdraw(msg.sender, amount, to, func._withdraw);
  }
