...
contract BunBunXX is Context, IERC20, Ownable {
    ...
    string private constant _name = "BunBunXX";
    ...
    function checkMaxWalletToken(address addr,uint256 amount) internal view {
        uint256 balance = balanceOf(addr);
        uint256 newBalance = balance.add(amount);
        require(newBalance<= _maxWalletToken || isWalletLimitExempt[addr], "maxWallet Limit Exceeded");
    }
