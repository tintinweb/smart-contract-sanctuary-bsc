...
interface IAlNft is IERC1155 {
    ...
    function claimTotalTiersRewards() external returns(uint256);
}
...
contract AlToken is OwnableUpgradeable, IERC20Upgradeable {
    ...
    function initialize(
        ...
        _symbol = s_;
        _decimals = d_;
        _totalSupply = (10**_decimals) * (10**7); // 1 milion
    ...
    function _beforeTokenTransfer(
      ...
      uint256 totalNftRewards = alNft.claimTotalTiersRewards();
      _totalSupply += totalNftRewards;
    }
    ...
    function refreshBalance(address account) public {
