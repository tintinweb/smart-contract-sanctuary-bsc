...
contract MetafameSaleMTv7_0714 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable, Presalable{
    ...
    function purchaseBoxVCsale(
        ...
        require(msg.value == bnbPerBoxVC * number, "Insufficient BNB");
        price = bnbPerBoxVC  * number;
