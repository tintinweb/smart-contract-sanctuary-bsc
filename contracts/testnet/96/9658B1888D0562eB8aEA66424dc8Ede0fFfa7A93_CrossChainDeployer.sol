...
contract CrossChainDeployer {
    ...
    event deployEvent( bytes _code ,  bytes32 _salt , address _contractAddress );
    ...
    function deployContract(
        ...
        assembly {
            addr := create2(0, add(payload, 0x20), mload(decodedPayload), salt)
        }
        emit deployEvent( payload , salt , addr );
    }
