...
contract TEST1A is Context, IERC20, Ownable {
    ...
    string private _name = "Test 1 A";
    string private _symbol = "T1A";
    uint8 private _decimals = 9;
    uint8 private maxBuySellLimit=40;
    // cooldown
    ...
    address public _marketingWallet = payable(address(0x0ef0200482b6D89Cc8500637626e281510F89B8E)); //enter marketing wallet address here...
    address public _rewardWallet = payable(address(0x123));
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //mainnet address

       // IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //testnet address
    ...
    function setBuyFee(uint16 liq, uint16 market) external onlyOwner {
        require(liq+market<=40,"You can not set more than 40% taxes");
        buyFee.liquidityFee = liq;
        buyFee.marketingFee = market;
       
    }

    function setSellFee(uint16 liq, uint16 market) external onlyOwner {
        require(liq+market<=40,"You can not set more than 40% taxes");
        sellFee.liquidityFee = liq;
        sellFee.marketingFee = market;
       
    }
    function setBuyTaxesOff() external onlyOwner {
