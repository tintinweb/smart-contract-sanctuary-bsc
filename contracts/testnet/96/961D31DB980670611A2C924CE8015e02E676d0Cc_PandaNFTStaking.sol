...
contract PandaNFTStaking is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0x3802Eb4B7C62A31100235481112CE15d1634d4B2); // token contract address
        // number of tokens Per day
        // to set rarity for tiers you need to start from 0
        // tier0 = 50 , tier1 = 60 ....
        rewardRate = [20000, 30000, 300, 400, 500];
    }
