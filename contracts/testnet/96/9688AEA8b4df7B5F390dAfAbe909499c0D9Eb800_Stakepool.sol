    ...
    ReentrancyGuardUpgradeable
{
     ...
     */
    function stakeNft(uint256 _tokenId, address _collection)
        external
        nonReentrant
        whenNotPaused
    {
        ...
        (bool _exists, uint256 _tierIndex) = checkCollection(_collection);

        require(_exists, "!collection");
    ...
    function withdrawNft(uint256 _tokenId, address _collection)
        external
        nonReentrant
        whenNotPaused
    {
