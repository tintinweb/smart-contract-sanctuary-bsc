 ...
 */
/**
Tottal supply -99000000 (99Million)
Name -Albino
Symbol -ABO
Staking -2% (For investors)
*/
contract Albino  is Context, IERC20, IERC20Metadata, Ownable, Pausable{
    ...
    constructor () {
        ...
        _symbol = "ABO";
        _totalSupply;
        _mint(owner(), 99000000 * 10 ** (decimals()) ); 
