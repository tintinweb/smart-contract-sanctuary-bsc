...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xd0C493385315A451099CFA37537fa3625C242BBE;
...
contract SANTA is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xd0C493385315A451099CFA37537fa3625C242BBE);
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet_Percent(uint256 maxWallPercent_x100) external onlyOwner() {
        _maxWalletToken = _tTotal*maxWallPercent_x100/20000000;
    }
