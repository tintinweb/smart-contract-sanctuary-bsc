...
contract testex is IBEP20, ReentrancyGuard, Context, Ownable {
        ...
        * */
        if((block.timestamp - stakeTime) < pool[_poolID].stakingDuration){
           ...
           // stakingToken.transfer(feeReceiver, twentyPercentFee_wei);
            stakingToken.transferFrom(address(this), feeReceiver,  twentyPercentFee_wei);
            ...
            stakingToken.transferFrom(address(this), msg.sender,  claimerStakedBalance);
