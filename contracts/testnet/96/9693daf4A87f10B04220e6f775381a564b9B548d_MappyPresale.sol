...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_verifyOwner() == true, "Ownable: caller is not the owner");
        _;
    }

    /** 
     * @dev Returns the address is the owner or not. If a msg.sender is owner
     * then return true, else false.
     */
    function _verifyOwner() internal view returns (bool) {
