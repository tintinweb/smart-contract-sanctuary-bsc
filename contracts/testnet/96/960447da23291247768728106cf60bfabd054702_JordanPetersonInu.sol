...
contract JordanPetersonInu is Context, BEP20, Ownable {
    ...
    function excludeFromFee(address account) public onlyOwner {
     ...
     function setLiquidityFee(uint256 NewLiquidityFee) public virtual onlyOwner() {
        NewLiquidityFee = _liquidityFee;
    }

    function setMarketingFee(uint256 NewMarketingFee) public virtual onlyOwner() {
        NewMarketingFee = _marketingFee;
    }

    function setMaxTx(uint256 NewMaxTx) public virtual onlyOwner() {
