...
╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝ ╚═════╝      ╚═════╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝   ╚═╝               
 ...
 __  _  ____  ____    ____         __  __ __  __ __  _____ __  _  __ __             
|  |/ ]|    ||    \  /    |       /  ]|  |  ||  |  |/ ___/|  |/ ]|  |  |            
|  ' /  |  | |  _  ||   __|      /  / |  |  ||  |  (   \_ |  ' / |  |  |            
|    \  |  | |  |  ||  |  |     /  /  |  _  ||  |  |\__  ||    \ |  ~  |            
|     | |  | |  |  ||  |_ |    /   \_ |  |  ||  :  |/  \ ||     ||___, |            
|  .  | |  | |  |  ||     |    \     ||  |  ||     |\    ||  .  ||     |            
|__|\_||____||__|__||___,_|     \____||__|__| \__,_| \___||__|\_||____/             
...
contract KingChusky is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    KingChuskyDividendTracker public dividendTracker;
    ...
    // buy fees
    uint256 public buyDividendRewardsFee = 4;
    uint256 public buyLiquidityFee = 2;
    uint256 public buyLotteryFee = 0;
    ...
    uint256 public sellLotteryFee = 0;
    ...
    constructor() ERC20("KingChusky", "KCHU") {
        dividendTracker = new KingChuskyDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "KingChusky: The dividend tracker already has that address"
        );

        KingChuskyDividendTracker newDividendTracker = KingChuskyDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "KingChusky: The new dividend tracker must be owned by the KingChusky token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "KingChusky: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "KingChusky: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "KingChusky: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "KingChusky: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "KingChusky: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "KingChusky: Cannot update gasForProcessing to same value"
        );
...
contract KingChuskyDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("KingChusky_Dividend_Tracker", "KingChusky_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "KingChusky_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "KingChusky_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main KingChusky contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "KingChusky_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "KingChusky_Dividend_Tracker: Cannot update claimWait to same value"
        );
