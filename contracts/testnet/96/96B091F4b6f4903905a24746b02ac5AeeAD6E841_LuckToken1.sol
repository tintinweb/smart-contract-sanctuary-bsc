...
abstract contract AllTheFees is Auth {
    ...
    mapping (address => bool) public isFeeExemptBuy; //new
	mapping (address => bool) public isFeeExemptSell; //new
...
contract LuckToken1 is Token {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        bool exemptbuysell = false;
        if(pair == sender && isFeeExemptBuy[recipient] ) { exemptbuysell = true; } //new
