...
contract ReceiverPays is Ownable {
    ...
    function createRoom(string memory name, uint256 maxUser, uint256 amount1, uint256 amount2) external {
        require(maxUser >= 1);
    ...
    function joinRoom(string memory name, address master, uint256 amount1, uint256 amount2) external {
