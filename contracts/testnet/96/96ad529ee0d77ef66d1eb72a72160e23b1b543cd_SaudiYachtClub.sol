...
contract SaudiYachtClub is ERC20, Auth {
    ...
    event BL (address indexed addresse, bool indexed value) anonymous;

    address private WETH;
    address private DEAD = 0x000000000000000000000000000000000000dEaD;
    address private ZERO = 0x0000000000000000000000000000000000000000;

    string constant private _name = "Saudi Yacht Club ";
    string constant private _symbol = "$SYC";
