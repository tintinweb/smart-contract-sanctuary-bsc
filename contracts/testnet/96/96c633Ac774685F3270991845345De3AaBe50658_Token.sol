...
contract Token is Context, Ownable, ERC721Enumerable, ERC721URIStorage {
    ...
    constructor(string memory name, string memory symbol, string memory baseUri, string memory tokenUriSuffix) ERC721(name, symbol) {
        baseURI = baseUri;
    ...
    returns (uint256 tokenId)
    {
        ...
        emit Mint(newItemId, _msgSender());
        return newItemId;
    }
