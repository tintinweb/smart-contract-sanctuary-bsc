...
contract CREST__Token {
    ...
    function transferFrom(
        ...
        require(
            ...
            "CREST: transfer amount exceeds allowance"
        );
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "CREST: decreased allowance below zero"
        );
    ...
    function _transfer(
        ...
        require(
            ...
            "CREST: transfer amount exceeds balance"
        );
    ...
    function burnFrom(address account, uint256 amount) public {
        ...
        require(
            currentAllowance >= amount,
            "CREST: burn amount exceeds allowance"
        );
    ...
    function mint(address to, uint256 amount) public returns (bool) {
        require(
            ...
            "CREST: minting would exceed max supply"
        );
