...
contract Storm is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 15 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    uint256 private _tDonationTotal;

    string private _name = "STORM";
    ...
    uint256 private minimumTokensBeforeSwap = 15 * 10**3 * 10**9; 
    
    address payable public charityAddress = 0xFfD6BF08968CCb542E6Ecc24B3A5a5B8eAf09099;
