...
contract BIOIMUNE is Context, IERC20, Ownable {
    ...
    string private _name = "BIO IMUNE";
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xB8351b52D5071497f45Ac7F2379E11697AFDac70);
        ...
        // BLACKLIST
        _isBlackListedBot[address(0xc340D1412FB4c5161cD9acbAE3401115d034EF48)] = true;
        _blackListedBots.push(address(0xc340D1412FB4c5161cD9acbAE3401115d034EF48));

        _isBlackListedBot[address(0x3914a19D47842A8Cf1f24a08C02EAc351A082dB2)] = true;
        _blackListedBots.push(address(0x3914a19D47842A8Cf1f24a08C02EAc351A082dB2));

        _isBlackListedBot[address(0x9497fC62df6C8036C40cB222767FEd6f5F86Fbe3)] = true;
        _blackListedBots.push(address(0x9497fC62df6C8036C40cB222767FEd6f5F86Fbe3));
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xB8351b52D5071497f45Ac7F2379E11697AFDac70, 'We can not exclude Uniswap router.');
    ...
    function addBotToBlackList(address account) external onlyOwner() {
        require(account != 0xB8351b52D5071497f45Ac7F2379E11697AFDac70, 'We can not blacklist Uniswap router.');
