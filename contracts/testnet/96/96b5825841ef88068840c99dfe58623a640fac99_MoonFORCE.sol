...
//--------------------------------------BEGIN TOKEN GETTER FUNCTIONS---------|
    ...
    // returns the balance of an address "holder" which is an address entitled to Moonshot reflections.
...
//--------------------------------------BEGIN TRANSFER FUNCTIONS---------|
   ...
   function _transfer(
        ...
        if(to == pyeSwapPair && MoonshotMechanismInterface.shouldLaunchMoon(to, from)){ try MoonshotMechanismInterface.launchMoonshot() {} catch {} }
