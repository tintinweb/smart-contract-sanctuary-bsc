...
contract Stake is Ownable {
    ...
    function initialize(address _token) onlyOwner public onlyOwner returns (bool) {
    ...
    function changeLockPeriod(uint256 _min, uint8 _stakeType) public onlyOwner returns (bool) {
        lockPeriod[_stakeType] = _min * 60;
        return true;
    }
