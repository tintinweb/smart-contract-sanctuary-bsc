...
contract XFT is IERC20, Ownable {
    ...
    address public BURN = 0x1628F297654B9F333DB9C96892772E659aCA4aB1;

    string constant _name = "XRP Fan Token";
    string constant _symbol = "$XFT";
    ...
    uint256 public sellStakePoolFee = 1;
    ...
    uint256 public buyBackSwap = 3;
    uint256 public liquiditySwap = 4;
    uint256 public totalSwap = 15;
    ...
    uint256 public maxWalletTokens = (_totalSupply * 1000) / 10000; // 0.5% of supply
    ...
    constructor() {
        ...
        marketingFeeReceiver = 0xB58337f2DCA37ca78A2C21817cA53C42E995cEAb;
        stakePoolAddress = 0x0CaFdCC36486230885672eD8A0FBAA5Bc76c12Aa;
        developmentFeeReceiver = 0xb7f5601627CA28f329DB96918d93133F3d6554A8;
    ...
    function updateSwapPercentages(
        ...
        buyBackSwap = buyBack;
        devSwap = dev;
        totalSwap = reward.add(marketing).add(liquidity).add(dev).add(buyBack);
    }
    ...
    function swapBackInBnb() internal swapping {
        ...
        uint256 marketingAndDevFee = marketingSwap.add(devSwap);
        uint256 tokensToMarketingAndDev = contractTokenBalance
            .mul(marketingAndDevFee)
            .div(totalSwap);
        uint256 tokensForRewardAndBurn = contractTokenBalance
            .sub(tokensToLiquidity)
            .sub(tokensToMarketingAndDev);
        ...
        if (tokensToMarketingAndDev > 0) {
            swapTokensForEth(tokensToMarketingAndDev);
            uint256 swappedTokensAmount = address(this).balance;

            uint256 tokensToMarketing = swappedTokensAmount
                .mul(marketingSwap)
                .div(marketingAndDevFee);
            uint256 tokensToDev = swappedTokensAmount.sub(tokensToMarketing);
            ...
            if (tokensToDev > 0) {
                (bool devSuccess, ) = payable(developmentFeeReceiver).call{
                    value: tokensToDev,
                    gas: 30000
                }("");
                devSuccess = false;
    ...
    function setDevelopmentWallet(address _wallet) external onlyOwner {
        developmentFeeReceiver = _wallet;
    }
