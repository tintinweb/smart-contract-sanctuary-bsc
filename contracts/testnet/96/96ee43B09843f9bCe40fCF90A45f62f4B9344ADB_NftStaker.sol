...
contract NftStaker {
    ...
    constructor() {
        parentNFT = IERC1155(0x99d180944821225FdaB73dEeBb89df3Ca8d3E5b5); // Change it to your NFT contract addr
    }


    function getreward(uint256 amount) public {
        require(parentNFT.balanceOf(msg.sender, 2)>0, "ERROR: no playing NFT");
        parentNFT.safeTransferFrom(address(this), msg.sender, 1 , amount, "0x00");
    }
