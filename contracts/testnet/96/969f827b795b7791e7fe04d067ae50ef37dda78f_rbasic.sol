...
// pancake livenet 0x10ED43C718714eb63d5aA57B78B54704E256024E
// pancake testnet  0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
// BUSD 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56

 // sushi 0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506
 // Defi 3.1 deltaV the rocketscience of tokenomics
 // https://deltav.exchange
 // https://twitter.com/deltavexchange
 // SELL fee +5% floor +5% treasury                   = 20%
 // BUY fee 4% floor 3% treasury 2% liquidity 1% burn = 10%
 // 10% buy fee 20% sell fee
 // 500 000 000 000 000 = 500 trillion total supply
 // 1 000 000 000 000 max buy / sell per transaction = 1 trillion max / buy sell
 // 20% HADES BURN wallet burns APY periodically
 // COMMUNITY MARKETING DEVELOPMENT
 // 3% community wallet locked for apy rewards
 // 3% marketing wallet locked for apy rewards
 // 3% development wallet locked for apy rewards
 // 3% of supply in liquidity wallet for future liquidity pairs
 // 6% of supply sold in private sale before stealth launch
 // 2 minute rewards rebase
     _      _ _      __     __             _                            
  __| | ___| | |_ __ \ \   / /_____  _____| |__   __ _ _ __   __ _  ___ 
 / _` |/ _ \ | __/ _` \ \ / // _ \ \/ / __| '_ \ / _` | '_ \ / _` |/ _ \
| (_| |  __/ | || (_| |\ V /|  __/>  < (__| | | | (_| | | | | (_| |  __/
 \__,_|\___|_|\__\__,_| \_/(_)___/_/\_\___|_| |_|\__,_|_| |_|\__, |\___|
                                                             |___/      
*/
...
contract rbasic is ERC20Detailed, Ownable {
    ...
    uint256 public rewardYield = 222222;
    ...
    uint256 public constant MAX_FEE_RATE = 33;
    uint256 private constant MAX_REBASE_FREQUENCY = 120;
    uint256 private constant DECIMALS = 18;
    uint256 private constant MAX_UINT256 = ~uint256(0);
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 5 * 10**14 * 10**DECIMALS;
    ...
    address public liquidityReceiver = 0xdC43d30e333d418dA24F7ba390DdcFfc04b602F4;
    address public treasuryReceiver = 0x4543eA5412354E388C55AAFc4cff5e39E25c3482;
    address public riskFreeValueReceiver = 0xb2866D9909Ea2e950bAFff5Ae5Ba6B602f71005c;
    ...
    constructor() ERC20Detailed("rbasic", "madness", uint8(DECIMALS)) {
