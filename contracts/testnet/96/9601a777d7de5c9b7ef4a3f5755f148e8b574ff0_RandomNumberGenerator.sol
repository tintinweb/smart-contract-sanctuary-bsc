...
// File: contracts/interfaces/IxBLZDLottery.sol

pragma solidity ^0.8.4;

interface IxBLZDLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in xBLZD per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in xBLZD token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInxBLZD: price of a ticket in xBLZD
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the xBLZDLottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == xBLZDLottery, "Only xBLZDLottery");
    ...
    /**
     * @notice Set the address for the xBLZDLottery
     * @param _xBLZDLottery: address of the xBLZDLottery
     */
    function setLotteryAddress(address _xBLZDLottery) external onlyOwner {
        xBLZDLottery = _xBLZDLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IxBLZDLottery(xBLZDLottery).viewCurrentLotteryId();
    }
}