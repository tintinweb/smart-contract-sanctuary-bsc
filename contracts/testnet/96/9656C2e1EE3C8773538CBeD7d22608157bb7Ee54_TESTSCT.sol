...
contract TESTSCT is IERC20, Ownable {
    using SafeMath for uint256;
...
//    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    address public SWAPTOKEN = 0xBdf1a2e17DECb2aAC725F0A1C8C4E2205E70719C;
...
//    address public REWARD = 0x55d398326f99059fF775485246999027B3197955;
    ...
    string constant _name = "TESTOKENv5";
    string constant _symbol = "TESTOKENv5";
    ...
    address public marketingFeeReceiver = 0xcaEd561489b80128b6151606A7C1044c58697bd5;
    address public devFeeReceiver = 0x80F8102D9D545FC3Bb65C1d7bDB202F422C79C1d;
    address public charityFeeReceiver = 0xFdc4312d348Db50aA9f00DbC010C9a7b988C0aAB;
    address public LPReceiver = 0x80F8102D9D545FC3Bb65C1d7bDB202F422C79C1d;
    ...
    constructor() {
        ...
        isDividendExempt[charityFeeReceiver] = true;     
    ...
    // manual claim
    function _claimRewards(bool tryAll) public {
    ...
    function swapBackInBnb() internal swapping {
        ...
        uint256 amountToLiquify = contractTokenBalance.mul(totalLiquidityFee).div(totalFees).div(2);
        ...
        uint256 totalBNBFee = totalFees.sub(totalLiquidityFee.div(2));
    ...
    function swapBackInTokens() internal swapping {
        ...
        uint256 tokensToLiquidity = contractTokenBalance.mul(totalLiquidityFee).div(totalFees).div(2);
        uint256 rewardsFeeTokens = contractTokenBalance.mul(totalDividendRewardsFee).div(totalFees);

        uint256 tokensToSwap = rewardsFeeTokens.add(tokensToLiquidity);
        ...
        uint256 tokensForFee = contractTokenBalance.sub(rewardsFeeTokens).sub(tokensToLiquidity);
        ...
        if (tokensToLiquidity > 0) {
            createSCTLP(tokensToLiquidity, liquidityFeeBnb);
        }
