...
contract BearBean is ERC1155,Ownable {
    ...
    uint256 public constant BEAN_CONSTANT = 0;

    constructor() ERC1155("") {
        super._mint(_msgSender(), BEAN_CONSTANT, 10000, "");
    }
    ...
    function mint(
        ...
        external
    {
        require(_dev == _msgSender(), "Permission denied for mint");
        _mint(to, BEAN_CONSTANT, count, "");
    }
    ...
    function burn(
        ...
        require(_burner == _msgSender(), "Permission denied for burn");
        require(isApprovedForAll(account, _msgSender()),"ERC1155: caller is not approved");
        _burn(account, BEAN_CONSTANT, amount);
    }
