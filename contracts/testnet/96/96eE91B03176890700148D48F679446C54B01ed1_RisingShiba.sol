...
contract RisingShiba is Context, IERC20 {
    ...
    string constant private _name = "RisingShiba";
    string constant private _symbol = "RISINGSHIBA";
    ...
    struct StaticValuesStruct {
        uint16 maxReflect;
        uint16 maxLiquidity;
        uint16 maxMarketing1;
        uint16 maxMarketing2;
    ...
    address payable private _marketingWallet1 = payable(0xAeD86C87c421455a546A122644c2DE68852ea886);
    address payable private _marketingWallet2 = payable(0xE876735B87AaE1cc888EEd6AfdC48fa826E25DD4);
...
//===============================================================================================================
    ...
    function setTaxesBuy(uint16 reflect, uint16 liquidity, uint16 marketing1, uint16 marketing2) external onlyOwner {
        require(reflect <= staticVals.maxReflect
                && liquidity <= staticVals.maxLiquidity
                && marketing1 <= staticVals.maxMarketing1
                && marketing2 <= staticVals.maxMarketing2);
        uint16 check = reflect + liquidity + marketing1 + marketing2;
        require(check <= 3450);
        _buyTaxes.liquidity = liquidity;
        _buyTaxes.reflect = reflect;
        _buyTaxes.marketing1 = marketing1;
        _buyTaxes.marketing2 = marketing2;
        _buyTaxes.totalSwap = check - reflect;
    }

    function setTaxesSell(uint16 reflect, uint16 liquidity, uint16 marketing1, uint16 marketing2) external onlyOwner {
        require(reflect <= staticVals.maxReflect
                && liquidity <= staticVals.maxLiquidity
                && marketing1 <= staticVals.maxMarketing1
                && marketing2 <= staticVals.maxMarketing2);
        ...
        _sellTaxes.marketing1 = marketing1;
        _sellTaxes.marketing2 = marketing2;
        _sellTaxes.totalSwap = check - reflect;
    }

    function setTaxesTransfer(uint16 reflect, uint16 liquidity, uint16 marketing1, uint16 marketing2) external onlyOwner {
        require(reflect <= staticVals.maxReflect
                && liquidity <= staticVals.maxLiquidity
                && marketing1 <= staticVals.maxMarketing1
                && marketing2 <= staticVals.maxMarketing2);
        ...
        _transferTaxes.marketing1 = marketing1;
        _transferTaxes.marketing2 = marketing2;
        _transferTaxes.totalSwap = check - reflect;
    }

    function setRatios(uint16 liquidity, uint16 marketing1, uint16 marketing2) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.marketing1 = marketing1;
        _ratios.marketing2 = marketing2;
        _ratios.total = liquidity + marketing1 + marketing2;
    }
    ...
    function setWallets(address payable marketingWallet1, address payable marketingWallet2) external onlyOwner {
        _marketingWallet1 = payable(marketingWallet1);
        _marketingWallet2 = payable(marketingWallet2);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (address(this).balance > 0) {
            _marketingWallet1.transfer((address(this).balance * _ratios.marketing1) / (_ratios.marketing1 + _ratios.marketing2));
            _marketingWallet2.transfer(address(this).balance);
        }
    }
