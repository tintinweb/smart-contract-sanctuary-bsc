...
contract FallenLeaves1 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable  {
    ...
    string public  contractURIstorefront = '{ "name": "Rise of the Warbots: Fallen Leaves Issue #1", "description": "First NFT Series for Rise of the Warbots: Fallen Leaves Issue #1", "image": "https://riseofthewarbots.com", "external_link": "https://riseofthewarbots.com", "seller_fee_basis_points": 300, "fee_recipient": "0x42A1DE863683F3230568900bA23f86991D012f42"}'; 
    ...
    constructor(address _EngineEcosystemContractAddress ) ERC721("Rise of The Warbots Comic Series: Fallen Leaves", "Issue #1") {
    ...
    function mint(  ) public payable {
           ...
           require ( msg.value == MintFee, "Wrong Fee amount");
            _tokenIds++;
