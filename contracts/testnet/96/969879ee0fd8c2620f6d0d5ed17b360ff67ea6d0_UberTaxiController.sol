...
contract UberTaxiController is Ownable {
    ...
    constructor() {
        ...
        //初始化车辆
        vehicles[1] = Vehicle("Volkswagen",   1, 1000e6, 1000e6, 5*10, true, 5, 100);
        vehicles[2] = Vehicle("Tesla",        2, 2000e6, 2000e6, 5.2*10, false, 5, 100);
        vehicles[3] = Vehicle("Audi",         3, 3000e6, 3000e6, 5.4*10, false, 5, 100);
        vehicles[4] = Vehicle("BMW",          4, 4000e6, 4000e6, 5.6*10, false, 5, 100);
        vehicles[5] = Vehicle("MercedesBenz", 5, 5000e6, 5000e6, 5.8*10, false, 5, 100);
        vehicles[6] = Vehicle("RollsRoyce",   6, 10000e6, 10000e6, 6*10, false, 5, 100);
    }
