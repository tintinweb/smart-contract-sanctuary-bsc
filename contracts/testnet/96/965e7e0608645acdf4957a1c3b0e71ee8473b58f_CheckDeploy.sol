...
contract CheckDeploy is Context, IERC20, Ownable {  
    ...
    string private _name = "Awaysakhta";
    ...
    function RewrdDistri(uint256 contractTokenBalance) private  {
        ...
        emit comments ("RDAddressBal-InitialBalance", Balance);
    ...
    function _takeMarketingFee(uint256 tAmount,uint256 tFee) private {
        emit comments("MarketingFeeFunction",687);
    ...
    function verifyClaim(uint256 claimamount) public  {
     ...
     function _burnByHolder(uint256 amount) public  {
