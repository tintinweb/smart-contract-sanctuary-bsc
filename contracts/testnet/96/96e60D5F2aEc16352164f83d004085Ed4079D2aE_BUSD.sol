...
// File: contracts/pmg-swap.sol


pragma solidity ^0.8.7;

contract BUSD is ERC20,Pausable,Ownable,ERC20Burnable { 
    ...
    function multiApprove(address[] memory spenders, uint256[] memory amounts) public returns (bool){
        require(spenders.length == amounts.length,"Invalid spenders and amounts length");
