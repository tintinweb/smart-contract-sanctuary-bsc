...
contract GaslessLayer is BaseRelayRecipient {
    ...
    function withdraw(IERC20 token, address to, uint amount) public {
        require(_msgSender() == owner, "Only the owner can call this method");
    ...
    function deposit(address token, address to, uint256 amount) external {
        ...
        require(erc20Token.allowance(_msgSender(), to) >= amount, "Insufficient allowance");
        require(erc20Token.transferFrom(_msgSender(), to, amount), "Transfer failed");
    }
