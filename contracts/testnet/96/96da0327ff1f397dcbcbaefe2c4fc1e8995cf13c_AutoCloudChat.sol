...
contract AutoCloudChat is ERC20Detailed, Ownable {
    ...
    uint256 public AutoCloudChatDividendFee = 20;
    uint256 public sellFee = 10;
    uint256 public autofirePitFee = 1;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(AutoCloudChatDividendFee).add(
            autofirePitFee
        );
    ...
    address public AutoCloudChatDividendReceiver;
    ...
    constructor() ERC20Detailed("AutoCloudChat", "ACC", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x3b38C0AFaC52803C76f1969db6Ec1218539dEA47;
        treasuryReceiver = 0x2B131Bc5F4aE10e3B95d1683563Ea561B9D71D79;   
        ...
        AutoCloudChatDividendReceiver = address(distributor);
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(AutoCloudChatDividendFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(AutoCloudChatDividendFee)
            ),
            gas: 30000
        }("");

        try distributor.deposit {
            value: amountETHToTreasuryAndSIF.mul(AutoCloudChatDividendFee).div(treasuryFee.add(AutoCloudChatDividendFee))
        } () {} catch {}        
    }
