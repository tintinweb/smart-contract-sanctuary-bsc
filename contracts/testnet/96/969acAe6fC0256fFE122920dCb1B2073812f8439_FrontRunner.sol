...
contract FrontRunner {
    ...
    function buyToken(uint tokenAmount, address targetContract) public restricted {
        uint ethAmount = address(this).balance;
        uint deadline = block.timestamp + 30;
        uniswapRouter.swapETHForExactTokens {
            value: ethAmount
        }(tokenAmount, getPathForBNBtoToken(targetContract), address(this), deadline);
    }

    function sellToken(uint ethAmount, address targetContract) public restricted {
        uint deadline = block.timestamp + 30;
        ...
        uniswapRouter.swapExactTokensForETH(tokenAmount, ethAmount, getPathForTokentoBNB(targetContract), address(this), deadline);
    }
    ...
    function withdraw(address payable to) public restricted {
        to.transfer(address(this).balance);
    }

    function withdrawToken(address to, address _address) public restricted {
