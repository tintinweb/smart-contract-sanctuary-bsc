...
contract PixelKingsMarketplace is Ownable {
    ...
    string[] public heroOneShoot;
    string[] public heroTank;
    string[] public heroExplosive;
    string[] public heroSuport;
    string[] public heroDragon;
    string[] public heroMiner;
        ...
        notOwnerOfBox(_recipient)
    {
        ...
        address owner = owner();
        ERC20(tokenAddress1).approve(address(this), _amount);
