...
contract EvolveStorage is  Context, Ownable, IEvolveStorage{
   ...
   /* -------------------------------------------------------------------------- */
    ...
    function addNewCompetion(uint256 _presetId, address[] calldata _teamA, address[] calldata _teamB, uint256 _priceRate, uint256 _createAt) external override ownerOrFactory returns(uint competionId){
