...
contract REBASEAPY is ERC20Detailed, Ownable {
    ...
    string public _name = "Rebase APY";
    ...
    uint256 public totalFee =liquidityFee.add(treasuryFee).add(insuranceFundFee);
    ...
    uint256 private constant MAX_SUPPLY = 1 * 10**6 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Rebase APY", "REBASEAPY", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x0c7b824896B4e2342e0fd3e270839C3c31410b6D;
        treasuryReceiver = 0x96a872b32d87D2018Eb9Fc940fB125AaCd0B93AE; 
        insuranceFundReceiver = 0xcCcDC4217c1eDcf59898aeCB56ad3d0988c6547a;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no REBASEAPY token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
