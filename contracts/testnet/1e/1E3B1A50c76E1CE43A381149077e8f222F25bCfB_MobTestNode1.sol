...
contract MobTestNode1 is ERC20Detailed, Ownable {
    ...
    uint256 public totalFee = ecosystemFee.add(liquidityFee).add(marketingFee).add(teamFee);
    ...
    constructor() ERC20Detailed("MobTest Class 1", "MBTN1", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x5f1c07282957E8Ce557D98a37a53d2Eb86E6DEE3; // Account 5
        marketingFeeReceiver = 0xf7098c958d53B68988207b8ca4534a431AB4B9C7; // Test - Marketing
        ecosystemFeeReceiver = 0x6d364052FA694DC94AD8890D36AA8eb43490e23d; // Test - Treasury
        teamFeeReceiver = 0x389939a49c795840F4DF78F2bE2A2ffA4a810aA2; // Mobshed Stake
