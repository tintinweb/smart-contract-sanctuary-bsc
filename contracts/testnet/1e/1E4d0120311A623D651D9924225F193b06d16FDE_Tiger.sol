...
contract Tiger is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,100 TIGERs
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund, address _daoFund) public ERC20("Lion Shares", "TIGER") {
        _mint(msg.sender, 100 ether); // mint 100 TIGER for initial pools deployment
