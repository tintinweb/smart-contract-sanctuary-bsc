...
/*
THE SHIT COIN FACTORY Presents
██████╗░██╗░░░██╗███╗░░░███╗██████╗░  ███████╗██╗░█████╗░████████╗██╗░█████╗░███╗░░██╗██╗
██╔══██╗██║░░░██║████╗░████║██╔══██╗  ██╔════╝██║██╔══██╗╚══██╔══╝██║██╔══██╗████╗░██║██║
██████╔╝██║░░░██║██╔████╔██║██████╔╝  █████╗░░██║██║░░╚═╝░░░██║░░░██║██║░░██║██╔██╗██║██║
██╔═══╝░██║░░░██║██║╚██╔╝██║██╔═══╝░  ██╔══╝░░██║██║░░██╗░░░██║░░░██║██║░░██║██║╚████║╚═╝
...
https://t.me/TheShitCoinFactory
https://www.theshitcoinfactory.io
We are launching safe degen projects regularly and have a daily launch list as 
well as daily giveaways for the community. 
Join Us Fellow Degens!!
*/
...
contract ERC20 is Context, IERC20 {
    ...
    //FIX DOES NOT LOOK FOR BOT ACCOUNTS AND TAG THE RECIPIENT AS A BOT
...
contract PumpFiction is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public communityAddress = 0xAf22a1607A57D1BB5adFAe6D52Fd44B0B83898F7;
    ...
    constructor() ERC20("PumpFiction", "PMPFI") {
    	cakeDividendTracker = new CakeDividendTracker();
    	
    	marketingWallet = 0x1BE5436ca5c0949375B472cBdb644034501612cC;
    	teamWallet = 0x476E71Bc24028C2797b6d2f8DE2dCb346cf53c1E;
    	cakeDividendToken = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
        
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //bsctestnet
    	//IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //bscmain
        ...
        */
         //FIX OLD WAS 100000000000 * (10**18));
    ...
    receive() external payable {
  	...
  	function updateTeamWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != teamWallet, "PUMPFICTION: The team wallet is already this address");
  	...
  	function updateMarketingWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != marketingWallet, "PUMPFICTION: The marketing wallet is already this address");
         isExcludedFromFees[_newWallet] = true;
...
//FIX MADE THIS TO UPDATE EASIER
    function setFairLaunchAmounts(uint256 _maxWallet, uint256 _buyTaxDivider, uint256 _sellTaxMultiplier, 
    uint256 _maxSellTxn) external onlyOwner {
        maxWalletToken = _maxWallet * (10**18);
        maxBuyTranscationAmount = _maxWallet * (10**18);
        buyFeeIncreaseFactor = _buyTaxDivider;
        sellFeeIncreaseFactor = _sellTaxMultiplier;
 	    maxSellTransactionAmount = _maxSellTxn * (10**18);
  	}
    ...
    function afterPreSale() external onlyOwner {
        ...
        swapTokensAtAmount = 20000000000 * (10**18);
        maxBuyTranscationAmount = 10000000000000 * (10**18);
        maxSellTransactionAmount = 25000000000 * (10**18);
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "PUMPFICTION: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "PUMPFICTION: The new dividend tracker must be owned by the DogeGaySon token contract");
    ...
    function updateCakeDividendRewardFee(uint8 newFee) external onlyOwner {
        require(newFee <= 6, "PUMPFICTION: Fee must be less than 6%");
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "PUMPFICTION: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(isExcludedFromFees[account] != excluded, "PUMPFICTION: Account is already exluded from fees");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "PUMPFICTION: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private onlyOwner {
        require(automatedMarketMakerPairs[pair] != value, "PUMPFICTION: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue != gasForProcessing, "PUMPFICTION: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        require(tradingIsEnabled || (isExcludedFromFees[from] || isExcludedFromFees[to]), "PUMPFICTION: Trading has not started yet");
        ...
        if (
            ...
            //FIX SHOULD HAVE VAR TO CHECK INSTEAD OF CALLING BLOCK TIMESTAMP OVER AND OVER
...
//FIX 
            ...
            //FIX CHECKS AGAIN ON SELL TO SEE IF IT IS IN SNIPER BLOCKS THIS MAKES NO SENSE THEY ONLY GET 10%
            if (block.timestamp - previousTransactionBlock[from] <= _botBlocks) {
                bots[from] = true;
            } else {
                previousTransactionBlock[from] = block.timestamp;
            }
                //FIX DID NOT USE SWAPATAMOUNT SO ADDED IF ELSE STATEMENT TO CHECK FOR IT FIRST
            ...
            if (!swapping && canSwap) {
                ...
                if (marketingEnabled) {
                    if(block.timestamp < _firstBlock + (1 days)) {
                        ...
                        uint256 teamPortion = swapTokens.div(10**2).mul(60);
                        uint256 devPortion = swapTokens.div(10**2).mul(10);
                        ...
                        address payable addr = payable(0x1BE5436ca5c0949375B472cBdb644034501612cC);
        ...
        if(takeFee) {
            ...
            if(automatedMarketMakerPairs[from]) { // if buy, divide by buyFeeIn(de)creaseFactor //FIX Made to lower buy tax.
                fees = fees.div(buyFeeIncreaseFactor).mul(100);
            }
    ...
    function buyBackAndBurn(uint256 amount) private {
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            ...
            path,
            communityAddress, // Community address to  burn or giveaway as we see fit
    ...
    function swapTokensForDividendToken(uint256 _tokenAmount, address _recipient, address _dividendAddress) private {
        ...
        //_approve(address(this), address(uniswapV2Router), _token(Amount));
...
contract CakeDividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("SCF_Dividend_Tracker", "SCFDT", 0x336173dbc692d735acC2FB7920C9AF3eCf812c5b) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 2000000 * (10**18); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "SCF_PUMPFI_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "SCF_PUMPFI_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "SCF_PUMPFI_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "SCF_PUMPFI_Dividend_Tracker: Cannot update claimWait to same value");
