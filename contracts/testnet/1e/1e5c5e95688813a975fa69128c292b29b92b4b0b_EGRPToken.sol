...
/**
 *
 *  Eight Get Rich Project Token
 * 
 *  High-quality tokens with a total supply of 100 million 
 * 
 */
contract EGRPToken is IERC20 {
    
    using SafeMath for uint256;
    
    //EGRP token, creator will take 0.6% fee
    address public feeTo = 0x65312f9f7628c4a31b3f54Fd4e9d760A97D4A7C4;

    string public name = " Eight Get Rich Project Token";
    string public symbol = "EGRP";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 BAT
