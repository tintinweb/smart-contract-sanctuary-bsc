...
contract YSLVault is AccessControl, Initializable {
    using SafeERC20 for IERC20;
    bytes32 public constant ADMIN_ROLE = keccak256("ADMIN_ROLE"); //byte for admin role
    address public router;// address of router
    uint256 public exchangeRatio = 10 ** 18;// uint of exchange ratio
    uint256 public depositTax = 10;// uint of deposit tax
    ...
    function initialize(
        ...
        INTT(YSLs).initialize(address(this), "YSLs", "YSLs");
    ...
    */
    function Deposit(uint256 _amount) external {
        ...
        IYSLS(YSLs).mint(address(this),(_amount * (100 - depositTax) * (10 ** 18))/ (exchangeRatio * 100));
        exchangeRatio = (IERC20(Admin.YSL()).balanceOf(address(this)) * 100) / IERC20(YSLs).totalSupply();
    ...
    */
    function Withdraw(address user,uint256 amount) external {
        ...
        IERC20(Admin.YSL()).transfer(msg.sender, balance);
