...
contract EggNFT is ERC721Enumerable, Ownable {
    ...
    function MintEgg(uint mintId) public {
    require(mintId >=1 && mintId <= 20, "Mint ID must be between 1 and 55");
    ...
    function NFTList() public view returns(string[] memory){
        string[] memory NFTIDwithPrice = new string[](21);
        for(uint i = 1; i <= 20; i++){
                if(isMinted[i] == true){
