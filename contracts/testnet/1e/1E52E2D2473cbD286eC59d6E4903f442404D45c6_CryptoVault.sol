...
contract CryptoVault is Context, IERC20, Ownable {
 ...
 uint256 public reflectFeeSell = 4;
  ...
  address private _marketingWalletAddress = 0x0118402D126deB339179aC030132EDb413DDf835; //Affixed and created dynamically by the smart contract on construction time.
  ...
  constructor() {
      address _newOwner = 0x0118402D126deB339179aC030132EDb413DDf835;
