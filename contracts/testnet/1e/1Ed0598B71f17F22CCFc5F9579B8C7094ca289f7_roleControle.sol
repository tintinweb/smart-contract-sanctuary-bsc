...
contract roleControle is Ownable {
    ...
    modifier only_CLevel () {
        ...
        while   
            (
                ((roles[msg.sender])[i] != ROLE.CEO_Role)   || 
                ((roles[msg.sender])[i] != ROLE.CTO_Role)   ||
                ((roles[msg.sender])[i] != ROLE.CFO_Role)   || 
                ((roles[msg.sender])[i] != ROLE.CMO_Role)   || 
                ((roles[msg.sender])[i] != ROLE.COO_Role)   )  {
            i++;
        }
        require(((roles[msg.sender])[i] == ROLE.CEO_Role)   ||
                ((roles[msg.sender])[i] == ROLE.CTO_Role)   ||
                ((roles[msg.sender])[i] == ROLE.CFO_Role)   ||
                ((roles[msg.sender])[i] == ROLE.CMO_Role)   ||
                ((roles[msg.sender])[i] == ROLE.COO_Role)
        , "address is not Permit to Execute function !");
        _;
    }
    ...
    function setTest( uint _numTest) external only_CLevel {
        numTest = _numTest;
     }
}
