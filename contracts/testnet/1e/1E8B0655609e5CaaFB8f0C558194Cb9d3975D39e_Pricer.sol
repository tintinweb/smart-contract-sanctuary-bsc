...
contract Pricer {
    ...
    */
    ...
    function getLpTokensAmount(address lp, uint amountLp, address router) public view returns (address token0, uint amount0, address token1, uint amount1){
        address factory = getFactory(router); // get the factory address for getReserves
        ...
        (uint reserve0, uint reserve1) = UniswapV2Library.getReserves(factory, token0, token1); // get reserves of both tokens
