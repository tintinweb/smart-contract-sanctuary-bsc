...
// File: contracts/StableFundBUSD.sol
...
contract StableFundBUSD  is Ownable, ReentrancyGuard{
    ...
    function deposit(uint256 _amount) external {
        require(_amount > 0, "you can deposit more than 0 matic");
        ...
        investors[msg.sender].totalLocked = investors[msg.sender].totalLocked.add(_amount);
        investors[msg.sender].lastCalculationDate = block.timestamp;
    ...
    function withdrawCapital(uint256 id) public nonReentrant {
        ...
        investors[msg.sender].claimableAmount = investors[msg.sender].claimableAmount.sub(claimableReward);
        ...
        IERC20(BUSDContract).safeTransfer(msg.sender,depositState[id].depositAmount + claimableReward);
    ...
    function depositFunds(uint256 _amount) external payable onlyOwner returns(bool) {
