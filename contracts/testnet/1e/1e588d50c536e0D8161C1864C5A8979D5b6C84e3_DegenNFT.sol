...
contract DegenNFT is IDegenNFT, ERC721, Whitelist {
    ...
    function _afterTokenTransfer(address _user) internal override {
        woolFactory.claimTokens(_user);
        woolFactory.countItemsOf(_user);
    }
}