...
import "../ChainLinkOracles/interfaces/IMidasGoldOracle.sol";
...
contract GaiaLifeMother is Initializable {
    ...
    IMidasGoldOracle private midasGoldOracle;
    ...
    function initialize(
        ...
        address midasGoldOracleAddress
    ) public initializer {
        /**
        Dr. Duncan
        */
        ...
        midasGoldOracle = IMidasGoldOracle(midasGoldOracleAddress);
        sonsCounter = 0;
    }
