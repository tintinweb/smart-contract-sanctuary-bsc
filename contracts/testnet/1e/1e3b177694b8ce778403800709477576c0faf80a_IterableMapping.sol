...
contract dd4everToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    dd4everTokenDividendTracker public dividendTracker;
    ...
    constructor() ERC20("DiamondsAre4ver", "dd4ever") {
        dividendTracker = new dd4everTokenDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "dd4ever: The dividend tracker already has that address"
        );

        dd4everTokenDividendTracker newDividendTracker = dd4everTokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "dd4ever: The new dividend tracker must be owned by the dd4ever token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "dd4ever: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "dd4ever: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "dd4ever: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "dd4ever: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "dd4ever: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "dd4ever: Cannot update gasForProcessing to same value"
        );
...
contract dd4everTokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("dd4ever_Dividend_Tracker", "dd4ever_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "dd4ever_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "dd4ever_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main dd4ever contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "dd4ever_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "dd4ever_Dividend_Tracker: Cannot update claimWait to same value"
        );
