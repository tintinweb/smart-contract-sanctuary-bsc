...
contract newtoken is BEP20 {
    ...
    */
    ...
    function stakeprofit(address _customerAddress) public view returns(uint256){
        ...
        uint256 finish = startTime_[_customerAddress].add(deposits[_customerAddress][i].time).mul(1 days);
				...
				uint256 finish_2 = startTime_[_customerAddress].add(deposits[_customerAddress][i].time).mul(1 days);
				...
				uint256 finish_4 = startTime_[_customerAddress].add(deposits[_customerAddress][i].time).mul(1 days);
				...
				uint256 finish_6 = startTime_[_customerAddress].add(deposits[_customerAddress][i].time).mul(1 days);
    ...
    function getUserDepositInfo(address userAddress, uint256 index) public view returns(uint256 percent, uint256 incamount, uint256 tokenamount, uint256 start, uint256 finish) {
        ...
        tokenamount = deposits[userAddress][index].incamount;
