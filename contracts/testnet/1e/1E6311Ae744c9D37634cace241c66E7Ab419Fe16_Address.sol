...
contract Template  is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 420000000; 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Dr460n4ir3 T0k3n";
    string private _symbol = "DR4";
    uint8 private _decimals = 9;
    
    // 10% Fees Distribution
    uint256 public _taxFee = 4;                                 // Reflexion/rewards.
    ...
    uint256 private _burnAt = 1650486000;      // Begin From EST - 20 April 2022 04:20:00 Wed
