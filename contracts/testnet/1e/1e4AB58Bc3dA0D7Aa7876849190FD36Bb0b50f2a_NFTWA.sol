...
contract NFTWA is ERC721A, Ownable,Pausable,INFTWA{
  IContracts_TITIMITI Contr;
  IColl_NFTWA_NFTA CNF;
string private URL_W;
string  ID_Collection = "655";
//string  ID_Collection = "654";
uint256 Total_NFTWA;
uint256 Max_NFTWA = 1;

constructor() ERC721A("NFTWA - NFT by TITIMITI","NFTWA_655", 1, Max_NFTWA){
    Contr=IContracts_TITIMITI(0x998A99E482DFa7c436a39296B16C8d11e0beBFea);
    CNF=IColl_NFTWA_NFTA(0xF35Fa6b3D7D06d8a22FD0d91db9df42C2331577e);
    URL_W = CNF.Get_URL(); 
}

  function Mint_NFTW (address adr ) public virtual override{
  ...
  function get_Max_NFTWA () public virtual override view  returns (uint256){
    return Max_NFTWA;
  }
  function get_Total_NFTWA () public virtual override view  returns (uint256){
    return Total_NFTWA;
  }
  function update_URL()  public virtual override{
    URL_W = CNF.Get_URL();
  } 
  function get_ID_Collection () public virtual override view returns (string memory) {
