...
contract Tiers is ERC1155Holder, Ownable {
    ...
    function changeRequiredPercent(uint256 _requiredPercent) external onlyOwner {
        require(
    ...
    function changeTiers(uint256[5] memory _tiers) external onlyOwner {
        tiers = _tiers;
    }
}
...
contract FixedStaking is Ownable {
    ...
    event IncreaseRewardPoolForClass(address indexed adder, uint256 added, uint8 class);
