    ...
    ReentrancyGuardUpgradeable
{
    ...
    mapping(uint256 => UpgradePlan) upgradePlans;
    ...
    function _burnNFT(uint256 _tokenId) internal {
        IMstationCharacter(students[_tokenId].contractAddress).dead(
            students[_tokenId].contractAddress,
            _msgSender(),
            _tokenId
        );
...
interface IMstationCharacter {
    ...
    function upgradeLevel(uint256 _tokenId, uint16 _newLevel) external;
