...
contract RewardManager is RewardAuth {
  ...
  event Claimed(address indexed _user, uint _fotaAmount, uint _usdAmount, uint fotaPrice);
...
//    secondInADay = 86400; // 24 * 60 * 60
  ...
  function claim() public {
    ...
    if (distributedToUser > 0) {
      ...
      emit Claimed(msg.sender, toUserTokenAmount, distributedToUser, fotaPricer.fotaPrice());
    }
