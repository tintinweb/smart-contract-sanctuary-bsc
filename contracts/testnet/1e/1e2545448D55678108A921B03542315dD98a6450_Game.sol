...
contract Game is Ownable, ReentrancyGuard {
    ...
    constructor(address _usdt, address _mbq, uint256 _quotaAmount) {
        USDT = IERC20(_usdt);
        MBQ = IERC20(_mbq);
    ...
    function subscribe(uint256 _pid) external nonReentrant {
        ...
        // Take funds
        USDT.safeTransferFrom(msg.sender, address(this), packageInfo[_pid].subscribeAmount);
    ...
    function renew(uint256 _sid) external nonReentrant {
        ...
        // Take renewal funds
        USDT.safeTransferFrom(msg.sender, address(this), packageInfo[_userPackageInfo.package].subscribeAmount);
        // Take renewal fee
