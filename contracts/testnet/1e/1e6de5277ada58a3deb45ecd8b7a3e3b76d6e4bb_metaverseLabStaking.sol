...
//    address public stakeTokenAddr = 0x57E2A2FF2622cacEC775cf8D4C2848Aa9B31528c; //Mainnet
    ...
    function withdraw() public returns (bool) {
        ...
        //if(block.timestamp < tierEndTime){
            ...
            uint burnAmt = (amount-stake_.stakedAmount)*burnPercent/100;
            amount = amount - burnAmt; // burn 
            token.transfer(burnAddress, burnAmt); // burn transfer
        //}
    ...
    function transferSubOwnership(address _to) public returns(bool) {
        require((msg.sender == owner || msg.sender == subOwner), "Only owner");
        subOwner = _to;
