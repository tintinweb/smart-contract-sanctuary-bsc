...
interface StorageInterfaceV5{
    ...
    function storeTradePart1(Trade calldata) external;
    function storeTradeHi(Trade calldata) external;
...
*/
        // Pendent per cridar: updateOpenInterestDai(_trade.pairIndex, _tradeInfo.openInterestDai, true, _trade.buy);
