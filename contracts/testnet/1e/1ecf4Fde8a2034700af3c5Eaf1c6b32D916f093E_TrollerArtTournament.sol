...
contract TrollerArtTournament is Ownable {
    ...
    function endCurrentRound(
        ...
        // require(_playersRoundScores.length > 0 && _playersRoundScores.length < 5 ,  "Player Round scores are not valid");
    ...
    function endTournament(
        ...
        // uint256 MAX = 2;
        // require(_playersRoundScores.length == MAX ,  "Player Round scores length must be two");
