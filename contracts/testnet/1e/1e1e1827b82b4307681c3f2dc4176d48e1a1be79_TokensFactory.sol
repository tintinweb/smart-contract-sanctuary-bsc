...
contract TokensFactory{
  ...
  function createToken(address cOwner, address marketingWallet, string memory name, string memory symbol, uint256 totalSupply, uint256 taxFee) public returns (TOKEN){
