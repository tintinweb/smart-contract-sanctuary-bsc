...
contract Venom is Context, IERC20, Ownable {
    ...
    event CharityWalletUpdate(address newAddress);
    ...
    constructor() {
        ...
        // exclude owner, charity wallet, and this contract from fee
    ...
    function updateCharityWallet(address payable newAddress) external {
        ...
        _isExcludedFromFee[newAddress] = true;
        emit CharityWalletUpdate(newAddress);
    }
    ...
    function setFees(
        ...
        require(buy_tax + buy_marketing + buy_liquidity + buy_charity <= 15);
        require(
            sell_tax + sell_marketing + sell_liquidity + sell_charity <= 15
        );
        buyFee.tax = buy_tax;
