...
staking = https://staking.tresleches.finance
telegram = https://t.me/TresLechesCakeOfficial_EN
version 1.3
NFT Staking for Tres Leches Finance, this contract will stake NFT and give out ERC 20 as reward.
*/
...
contract TresLechesNFTStake is Ownable, ReentrancyGuard {
    ...
    // The block number when TresLechesCake mining starts.
    ...
    constructor() {
        nftCollection = IERC721(0x36C9F1eaD67E46B3F832D3BB309f1bD4D8D26761);
...
//external functions
    ...
    // Safe token transfer function, just in case if rounding error causes pool to not have enough TresLechesCake.
