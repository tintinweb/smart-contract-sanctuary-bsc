...
contract DNFT is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 private _totalSupply = 9990000000000 * 10**_decimals;
    ...
    address public devAddress = address(0x09359dD4193f95Cce955f259113a7A39ae2B894A);
    address public nodeAddress = address(0x483017993B2aD122c2d6adcBf8CF1441b58536A6);
    address public communityAddress = address(0x43E643FF56cB3b52711dE50935bce255CB4D40cD);
    ...
    constructor(
        ...
        pairAddress = IPancakeFactory(_router.factory()).createPair(
            address(this),
            address(0x12cf459B5d90fA6D697e245e1d0CFAe2068fb766)
        );
