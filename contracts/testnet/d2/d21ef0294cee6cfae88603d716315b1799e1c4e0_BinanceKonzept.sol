...
contract BinanceKonzept {
	using SafeMath for *;
	address payable public owner = 0xA09De897d63fC93405DC796e3c35e0c19EF08AA1;
	address public masterAccount = 0xA09De897d63fC93405DC796e3c35e0c19EF08AA1;
	...
	modifier isMaximumAmount(uint256 _bnb) {
		require(_bnb <= 200 * 10**18, "maximum contribution amount is 500 BNB");
		_;
	}
	...
	function emergencyWithdrawal() public {
	   ...
	   player[msg.sender].incomeLimitLeft = balance;
