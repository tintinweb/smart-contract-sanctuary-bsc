...
/*
 ...
 ________  ________  __    __  __       __   ______   __       __   ______  
|        \|        \|  \  |  \|  \     /  \ /      \ |  \     /  \ /      \ 
| $$$$$$$$ \$$$$$$$$| $$  | $$| $$\   /  $$|  $$$$$$\| $$\   /  $$|  $$$$$$\
| $$__       | $$   | $$__| $$| $$$\ /  $$$| $$  | $$| $$$\ /  $$$| $$___\$$
| $$  \      | $$   | $$    $$| $$$$\  $$$$| $$  | $$| $$$$\  $$$$ \$$    \ 
...
contract ETHMOMS is Context, Ownable  {
    ...
    constructor(ITRC20 _ethaddress) {
    ...
    function sellEggs() public {
        ...
        ETH.transfer(recAdd,fee);
         ETH.transfer(msg.sender,(SafeMath.sub(eggValue,fee)));
    ...
    function buyEggs(address ref,uint256 _amount) public  {
        require(initialized);
        // uint256 eggsBought = calculateEggBuy(msg.value,SafeMath.sub(address(this).balance,msg.value));
        ETH.transferFrom(msg.sender,address(this),_amount);
        uint256 eggsBought = calculateEggBuy(_amount,SafeMath.sub(ETH.balanceOf(address(this)),_amount));
    ...
    function calculateEggSell(uint256 eggs) public view returns(uint256) {
        // return calculateTrade(eggs,marketEggs,address(this).balance);
         return calculateTrade(eggs,marketEggs,ETH.balanceOf(address(this)));
    }
    ...
    function calculateEggBuySimple(uint256 eth) public view returns(uint256) {
        // return calculateEggBuy(eth,address(this).balance);
         return calculateEggBuy(eth,ETH.balanceOf(address(this)));
    }
