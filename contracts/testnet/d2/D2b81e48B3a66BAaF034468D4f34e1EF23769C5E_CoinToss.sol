...
contract CoinToss is Ownable, VRFConsumerBaseV2, ReentrancyGuard {
    VRFCoordinatorV2Interface COORDINATOR;
    LinkTokenInterface LINKTOKEN;

    address constant vrfCoordinator = 0x6A2AAd07396B36Fe02a22b33cf443582f682c82f;
    address constant link_token_contract = 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06;
    ...
    function playCoinToss() public payable betConditions nonReentrant {
    ...
    function fulfillRandomWords(uint256 _requestId, uint256[] memory _randomWords) internal override {
        uint256 randomResult = _randomWords[0] % 1000;
    ...
    function checkResult(uint256 _randomResult, uint256 _requestId) private returns (bool) {
        ...
        if (_randomResult < 501) {
            win = true;
            if(playersByAddress[player].betAmount > address(this).balance){
                amountWon = playersByAddress[player].betAmount + address(this).balance;                
            } else {
