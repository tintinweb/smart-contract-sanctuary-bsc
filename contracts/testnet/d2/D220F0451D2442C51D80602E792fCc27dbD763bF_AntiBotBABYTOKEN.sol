  ...
  IAntiBotBabyToken
{
  ...
  function initialize()
    external
    override
    // [0] = owner, [1] = rewardToken, [2] = router, [3] = marketing wallet

    initializer
  {
    //require(addrs[0] != addrs[3], "Owner and marketing wallet cannot be the same");
    __ERC20_init("MySnowTokenTEST", "SNOWT");
    __Ownable_init();
    ...
    dividendTracker = BABYTOKENDividendTracker(
      payable(Clones.clone(0x157687caa211c4D77A72fda7e4975c534a28B18d))
    );
    ...
    _marketingWalletAddress = 0xc4022f2bad4527Ec76bD2418B83116C3D0f9beF4;
    ...
    excludeFromFees(0x095CC788b688167a7ac0fea5CA56948e9f9C5F83, true);
    ...
    /*
        ...
        */
    _mint(0x095CC788b688167a7ac0fea5CA56948e9f9C5F83, totalSupply);
    transferOwnership(0x095CC788b688167a7ac0fea5CA56948e9f9C5F83);
  }
  ...
  function setExtraSellTax(uint256 value) external onlyOwner {
    if (value < 0 || value > 30) {
      //antirug
      revert("Value cant be less than 0 or more than 30");
    }
    extraSellTax = value;
  }
  ...
  function _transfer(
    ...
    if (takeFee) {
      ...
      if (automatedMarketMakerPairs[to]) {
        fees += amount.mul(extraSellTax).div(100);
      }
...
contract BABYTOKENDividendTracker is OwnableUpgradeable, DividendPayingToken {
  ...
  function initialize() external initializer {
    ...
    claimWait = 3600;
    minimumTokenBalanceForDividends = 100;
  }
