...
contract ZEUS is ERC20, Ownable {
    ...
    constructor() ERC20("KovanTestkimpie", "GANG2") payable {
  ...
  function addBotToBlackList(address account) external onlyOwner() {
        require(account != 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3, 'We can not blacklist Uniswap router.');
