...
contract Crsfans is Context, IBEP20, Ownable {
    ...
    string public constant name     = "Crsfans";
    string public constant symbol   = "CRSF";
    ...
    uint256 public _devFeeTransfer       = 100;
    uint256 public _charityFeeTransfer   = 100;
    uint256 public _holdFeeTransfer      = 100;
    ...
    uint256 public _charityFeeBuy   = 200;
    uint256 public _holdFeeBuy      = 200;  
    ...
    uint256 public _charityFeeSell   = 200;
    uint256 public _holdFeeSell      = 200; 

    uint256 public _sellPercentageOfLiquidityForBounty = 0;
    ...
    constructor (address cOwner, address marketingWallet, address devWallet, address charityWallet, address holdWallet) Ownable(cOwner) {
        ...
        _isExcludedFromFee[_holdWallet]      = true;
    ...
    function setHoldWallet(address holdWallet) external onlyOwner {
        _holdWallet = holdWallet;
    }
    function setExcludedFromFee(address account, bool e) external onlyOwner {
        _isExcludedFromFee[account] = e;
    }
    function setTransferFee(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 devFee, uint256 charityFee, uint256 holdFee) external onlyOwner {
        _taxFeeTransfer       = taxFee;
        _liquidityFeeTransfer = liquidityFee;
        _marketingFeeTransfer = marketingFee;
        _devFeeTransfer       = devFee;
        _charityFeeTransfer   = charityFee;
        _holdFeeTransfer       = holdFee;
    }
    function setBuyFee(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 devFee, uint256 charityFee, uint256 holdFee) external onlyOwner {
        _taxFeeBuy       = taxFee;
        _liquidityFeeBuy = liquidityFee;
        _marketingFeeBuy = marketingFee;
        _devFeeBuy       = devFee;
        _charityFeeBuy   = charityFee;
        _holdFeeBuy      = holdFee;
    }
    function setSellFee(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 devFee, uint256 charityFee, uint256 holdFee) external onlyOwner {
        _taxFeeSell       = taxFee;
        _liquidityFeeSell = liquidityFee;
        _marketingFeeSell = marketingFee;
        _devFeeSell       = devFee;
        _charityFeeSell   = charityFee;
        _holdFeeSell      = holdFee;
    }
    function setBountyPercent(uint256 bountyPercent) external onlyOwner {
        _sellPercentageOfLiquidityForBounty = bountyPercent;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        uint256 bnbForBounty = newBalance.mul(_sellPercentageOfLiquidityForBounty).div(100);
        uint256 bnbForLiquidity = newBalance.sub(bnbForBounty);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        uint256 previousDevFee       = _devFeeTransfer;
        uint256 previousCharityFee   = _charityFeeTransfer;
        uint256 previousHoldFee       = _holdFeeTransfer;
        ...
        if (!takeFee) {
            ...
            _devFeeTransfer       = _devFeeBuy;
            _charityFeeTransfer   = _charityFeeBuy;
            _holdFeeTransfer      = _holdFeeBuy;

        } else if (isSell) { 
            _taxFeeTransfer       = _taxFeeSell;
            _liquidityFeeTransfer = _liquidityFeeSell;
            _marketingFeeTransfer = _marketingFeeSell;
            _devFeeTransfer       = _devFeeSell;
            _charityFeeTransfer   = _charityFeeSell;
            _holdFeeTransfer       = _holdFeeSell;
        }
        ...
        if (!takeFee || isBuy || isSell) {
            ...
            _devFeeTransfer       = previousDevFee;
            _charityFeeTransfer   = previousCharityFee;
            _holdFeeTransfer      = previousHoldFee;
        }
    }
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        takeTransactionFee(sender, address(_devWallet), tDev, currentRate);
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256) {
        ...
        uint256 tDev       = tAmount.mul(_devFeeTransfer).div(10000);
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 tMarketing, uint tDev, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
