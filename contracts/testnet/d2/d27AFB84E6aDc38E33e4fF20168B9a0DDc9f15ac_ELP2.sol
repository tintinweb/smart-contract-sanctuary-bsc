...
contract ELP2 is IERC20, Ownable {
    ...
    constructor(address tokenOwner) {
        ...
        _tTotal = 15000 * 10**_decimals;
        _destroyMax = 13500 * 10**_decimals;
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            _reflectFee(
                rAmount.div(1000).mul(5),
                tAmount.div(1000).mul(5)
            );
