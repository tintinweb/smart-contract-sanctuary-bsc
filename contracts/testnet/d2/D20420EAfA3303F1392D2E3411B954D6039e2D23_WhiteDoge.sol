...
█░░░░░░░░░░░░███░░░░░░░░░░░░░░█░░░░░░░░░░░░░░█░░░░░░░░░░░░░░█
█████████████████████████████████████████████████████████████
    Telegram - https://t.me/WhiteDogeOfficial
...
contract WhiteDoge is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        */
        ...
        txFees["farmingSell"] = 4;

        /**
            Set default tx limits
            - Cooldown, buy limit, sell limit
        */
        txLimits.cooldown = 1 hours;
        txLimits.buyLimit = _totalSupply.div(8); // 1,25%
        txLimits.sellLimit = _totalSupply.div(80); // 0.25%
        ...
        */
        ...
        address _router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // BSC
    ...
    */
    ...
    function setFees(
        ...
        require(_marketingBuy <= 7, "Marketing fee is too high!");
        require(_devBuy <= 7, "Dev fee is too high!");
        require(_liquidityBuy <= 7, "Liquidity fee is too high!");
        require(_farmingBuy <= 7, "Farming fee is too high!");
        require(_marketingSell <= 7, "Marketing fee is too high!");
        require(_devSell <= 7, "Dev fee is too high!");
        require(_liquiditySell <= 7, "Liquidity fee is too high!");
        require(_farmingSell <= 7, "Farming fee is too high!");
    ...
    */
    function setTxLimits(uint _buyLimit, uint _sellLimit, uint _cooldown) external onlyOwner {
        require(_buyLimit >= _totalSupply.div(50), "Buy transaction limit is too low!"); // 0.5%
        require(_sellLimit >= _totalSupply.div(100), "Sell transaction limit is too low!"); // 0.25%
        require(_cooldown <= 2 hours, "Cooldown should be 4 hours or less!");
