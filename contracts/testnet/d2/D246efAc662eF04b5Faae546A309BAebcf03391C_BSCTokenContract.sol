...
contract BSCTokenContract is IBEP20, Ownable {
    ...
    function checkTxLimit(
        ...
        require(
            (amount - feeAmount <= _maxTxAmount) ||
                liquidityProviderAddress == sender ||
                liquidityProviderAddress == recipient,
            "TX Limit Exceeded"
        );
    }
    ...
    function swapBack() internal swapping {
        uint256 amountToLiquify = _balances[address(this)]
            .mul(liquidityFee)
            .div(totalFee)
            .div(2);
    ...
    function changeFValues(uint256 _liquidityFee, uint256 _marketingFee)
        external
        onlyOwner
    {
