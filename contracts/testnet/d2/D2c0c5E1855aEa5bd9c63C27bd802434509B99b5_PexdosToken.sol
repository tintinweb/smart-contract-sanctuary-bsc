...
contract PexdosToken is IERC20 {
    using SafeMath for uint256;

    string public constant name = 'PEXDOS';
    string public constant symbol = 'PXDS';
    ...
    constructor()  {
        totalSupply = totalSupply.add(10 ** 25);
		balanceOf[msg.sender] = balanceOf[msg.sender].add(10 ** 25);
    }
