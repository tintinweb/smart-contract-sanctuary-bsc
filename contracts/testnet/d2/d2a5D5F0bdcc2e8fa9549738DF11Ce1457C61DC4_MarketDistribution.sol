...
contract MarketDistribution is TokensRecoverable, IMarketDistribution {
    ...
    function distribute(uint256 _baseAmountForLiquidity, uint256 _rootedAmountForLiquidity,
        ...
        baseToken.safeTransferFrom(address(marketGeneration), address(this), baseToken.balanceOf(address(marketGeneration)));
...
//        eliteToken.withdrawTokens(_baseAmountForLiquidity);
