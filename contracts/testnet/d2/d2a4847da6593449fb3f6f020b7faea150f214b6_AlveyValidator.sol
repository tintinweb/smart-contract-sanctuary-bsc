...
contract AlveyValidator is Context, Ownable {
    ...
    string private _name = "Alvey Validator";
    string private _symbol = "Alvey Validator";
    ...
    constructor(address _alveyToken, address _bridge, address [] memory operators) {
