...
contract GrowCashCapital is Context, Ownable {
    ...
    uint256 constant maxRewards = 20000000 ether;
    ...
    constructor(address dev, address part) {
            ...
            PercsKey[10] = DivPercs(3 days, 20, 0);
            PercsKey[20] = DivPercs(7 days,  22, 0);
            PercsKey[30] = DivPercs(14 days, 25, 0);
            PercsKey[40] = DivPercs(30 days, 28, 0);
            PercsKey[40] = DivPercs(90 days, 33, 0);
    }
