...
contract BUYU is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x51CC7A95E9f8bD367Ca1A59B089b54c920564799));
    address payable public devWallet =
        payable(address(msg.sender));
    address public liquidityReceiver =
        0x51CC7A95E9f8bD367Ca1A59B089b54c920564799;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "BUYU";
    string private _symbol = "BUYU";
