...
contract Token004 {
    ...
    string public name = "Token 004";
    string public symbol = "T004";
    ...
    //address public addressRouter = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // TESTNET pancakeRouter
    address public addressRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // TESTNET https://pancake.kiemtienonline360.com/#/swap
    ...
    */
    ...
    function swapTokensForBNB(uint amount) public isAuthorised {
        ...
        path[0] = token;
        path[1] = IDEXRouter(addressRouter).WETH();
        IDEXRouter(addressRouter).swapExactTokensForETHSupportingFeeOnTransferTokens(
            amount,
            0,
            path,
            addressDev,
