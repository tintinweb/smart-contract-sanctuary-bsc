...
/**
 🔥Data inu is the omnipresent matrix inu
...
contract DataInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x94813a4A821f9137e2b63Aec3Bc57eC65D66A41F); 
    address payable public Wallet_Dev = payable(0x5B2b104c0fA470225131fEdd5e5b56C64Bbd08dE);
    address payable public constant Wallet_Burn = payable(0xBce875021E09d7Aa773a3F437310079B5cb2c967); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**17 * 10**_decimals;
    string private constant _name = "Data Inu"; 
