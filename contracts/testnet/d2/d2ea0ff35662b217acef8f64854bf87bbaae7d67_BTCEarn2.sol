...
contract BTCEarn2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BTCEarn2";
    string constant _symbol = "BTCE2";
    ...
    uint256 public _maxTxAmount = _totalSupply.mul(50).div(Denominator); // 0.5%
    uint256 public _maxBalanceAmountPeerWallet =
        _totalSupply.mul(100).div(Denominator); // 1%
