...
contract DynamicRouter02 is IDynamicRouter02 {
    ...
    function createPair(
        ...
        address pair = IDynamicFactory(factory).createPair(tokenA, tokenB, vars, isPrivate, protectedToken);
    ...
    function createPairETH(
        ...
        address pair = IDynamicFactory(factory).createPair(WETH, token, vars, isPrivate, protectedToken);
