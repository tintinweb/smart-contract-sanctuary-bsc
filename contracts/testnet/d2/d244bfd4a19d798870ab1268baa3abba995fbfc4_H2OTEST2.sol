...
contract H2OTEST2 is Context, Ownable, IERC20, IERC20Metadata {
    using SafeMath for uint256;
    string private _name = "H2OTEST2";
    string private _symbol = "H2OT2";
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 public _taxSell = 12;
    uint256 public _taxBuy = 8;
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "H2OTEST: decreased allowance below zero"
        );
        unchecked {
    ...
    function _transfer(
        ...
        require(
            sender != address(0),
            "H2OTEST: transfer from the zero address"
        );
        require(
            recipient != address(0),
            "H2OTEST: transfer to the zero address"
        );
    ...
    function _mint(address account, uint256 amount) internal virtual {
        require(
            account != address(0),
            "H2OTEST: mint to the zero address"
        );
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(
            account != address(0),
            "H2OTEST: burn from the zero address"
        );

        uint256 accountBalance = _balances[account];
        require(
            accountBalance >= amount,
            "H2OTEST: burn amount exceeds balance"
        );
        unchecked {
    ...
    function _approve(
        ...
        require(
            owner != address(0),
            "H2OTEST: approve from the zero address"
        );
        require(
            spender != address(0),
            "H2OTEST: approve to the zero address"
        );
