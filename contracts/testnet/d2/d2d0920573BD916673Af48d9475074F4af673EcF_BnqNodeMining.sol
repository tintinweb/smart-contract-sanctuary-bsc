...
contract BnqNodeMining is OwnableUpgradeable {
    ...
    ///////  link  //////
    /////////////////////
    function _processLink(address user_, uint amount_) internal {
    ...
    function buyNode(address inv_, uint lv_) external onlyEOA {
        ...
        // inherit
        bool isA;
        if (info.invitor == address(0) && info.buyAmount == 0) {
