...
contract ExchangeNFT is Ownable {
    ...
    function approveAbc(uint256 tokenId) public {
        IERC721(ERC721).approve(address(this), tokenId);
    }


    function testAbc(uint256 tokenId, address owner) public view returns (address) {
            IERC721(owner).getApproved(tokenId);
    }
