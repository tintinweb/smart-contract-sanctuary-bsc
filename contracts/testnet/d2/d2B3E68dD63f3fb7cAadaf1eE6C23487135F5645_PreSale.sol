...
contract PreSale is Context, Ownable{
    ...
    uint256 constant private busdRate = 2; // 1 busd = 2 MSET, OR 1 busd = 2 T
    uint256 constant private bnbRate = 216; // 1BNB = 216 MSET
    ...
    modifier validateOrder(uint256 amount, bool isBusd) {
        if(isBusd){
            ...
            require(amount >= 10 * 10 **(14) , "Min order limit is 0.01 BNB");
