...
contract AntiBot is Ownable, ReentrancyGuard {
    ...
    function addBlackLists(address _token, address[] memory _blacklists)
        public
    {
    ...
    function removeBlackLists(address _token, address[] memory _blacklists)
        public
    {
        require(token_owner[_token] == msg.sender, "Not Owner");
        for (uint256 i = 0; i < _blacklists.length; i++) {
    ...
    function onPreTransferCheck(
        ...
        require(
            blacklists[msg.sender][from] != true &&
                blacklists[msg.sender][to] != true,
