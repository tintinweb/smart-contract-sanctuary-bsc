...
contract PotionNFT is ERC721, Ownable {
    ...
    uint256 public restPotionsPrice = 10 * 1E18;
    ...
    event InterfacesUpdated(address laboManagement, address payments, address laboNFT);
    ...
    function updateInterfaces() external {
        ...
        laboNFT = ILaboratory(gameAddresses.getAddressOf(AddressesInit.Addresses.LABO_NFT));
    ...
    function offerPotion(
        ...
        return _mintPotion(0, 0, _type, _power, _to);
    }
    ...
    function mintPotionForSale(
        ...
        return _mintPotion(_laboId, _price, _type, _power, laboManagement);
    }
    ...
    function _mintPotion(
        ...
        _setPotion(newPotionId, _type, _power, _price,_laboId);
    ...
    function _setPotion(uint256 _potionId, uint8 _type, uint8 _power, uint256 _price, uint256 _laboId) internal {
    ...
    function mintMultiplePotion(uint8[7] memory _powers, address _owner)
        external
        onlyAuth
    ...
    function buyXpPotion(uint256 _quantity) external {
        ...
        uint256 _price = (_quantity == 5 ? 4 : _quantity) * xpPotionsPrice;
    ...
    function buyRestPotion(uint256 _quantity) external {
        ...
        // one potion offer when 5 bought
        uint256 _price = (_quantity == 5 ? 4 : _quantity) * restPotionsPrice;
    ...
    function emptyingPotion(uint256 _tokenId) external onlyAuth returns(bool) {
        _potions[_tokenId] = PotionStruct.Potion(address(0x0),0,0,0,0,99,PotionStruct.Powers(0,0,0,0,0,0,0,0));
