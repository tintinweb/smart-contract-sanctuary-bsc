...
contract BuildTowerGame is ReentrancyGuard {
    ...
    constructor(address payable _tokenBurner) public {
        ...
        minTotalUsersForLevel[2] = 4;  // min 25k users
        minTotalUsersForLevel[3] = 5;  // min 50k users
        minTotalUsersForLevel[4] = 6; // min 100k users
        minTotalUsersForLevel[5] = 7;  // min 25k users
        minTotalUsersForLevel[6] = 8;  // min 50k users
        minTotalUsersForLevel[7] = 9; // min 100k users
        minTotalUsersForLevel[8] = 10;  // min 25k users
        minTotalUsersForLevel[9] = 11;  // min 50k users
        minTotalUsersForLevel[10] = 12; // min 100k users
        minTotalUsersForLevel[11] = 13;  // min 25k users
        minTotalUsersForLevel[12] = 14;  // min 50k users
        minTotalUsersForLevel[13] = 15; // min 100k users
        minTotalUsersForLevel[14] = 16;  // min 25k users
        minTotalUsersForLevel[15] = 17;  // min 50k users
        minTotalUsersForLevel[16] = 18; // min 100k users
        minTotalUsersForLevel[17] = 19;  // min 25k users
        minTotalUsersForLevel[18] = 20;  // min 50k users
        minTotalUsersForLevel[19] = 21; // min 100k users
        minTotalUsersForLevel[20] = 22; // min 100k users
        ...
        for(uint8 level = 1; level <= totalLevels; level++) {
            ...
            users[owner].levels[level].maxPayouts = 3;
