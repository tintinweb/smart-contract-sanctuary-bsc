...
contract ECG_IDO is Ownable {
    ...
    address public teamAddress = 0x25CDB647434Dda4cC8e1C361427683CCB789c11b;
    ...
    function swap(uint256 amount) public {
        ...
        uint256 _remainingAmountCanBuy = remainingAmountCanBuy(msg.sender);
        ...
        if (amount > _remainingAmountCanBuy) {
    ...
    function getRemainingWithdrawToken(address userAdd) public view returns (uint256) {
        uint256 twentyPercent = totalBoughtAmount[userAdd].div(5);
        uint256 amount = 0;
