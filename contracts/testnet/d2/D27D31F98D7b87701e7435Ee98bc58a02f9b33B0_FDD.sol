...
contract FDD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "FDD";
    string private _symbol = "FDD";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xC66565287D4c6826AcCd8C2EfCeDFE9011024573));
        marketingWalletAddress = payable(address(0xC66565287D4c6826AcCd8C2EfCeDFE9011024573));
