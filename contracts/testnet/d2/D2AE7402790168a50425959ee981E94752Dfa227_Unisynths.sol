...
interface Iluckblocks {
    ...
    function BuyTicket(address player,uint256 ticketValue,uint number1,uint number2) external;
...
contract Unisynths is Ownable, ReentrancyGuard {
    ...
    constructor() {
        ...
        Iluckblocks _luckblocksB = Iluckblocks(0x07E9D1604055709504E9e2d654cF779E1989FeEb);
    ...
    function betBTC() public {
        ...
        luckblocksB.BuyTicket(address(this),amountNecessary,3,6);
    }
    function betKRSTM() public {
        uint256 amountNecessary = 20 * 10**18;
        usd.safeTransferFrom(address(msg.sender), address(this), amountNecessary);
        usd.approve(address(luckblocksK), amountNecessary);
        luckblocksK.BuyTicket(address(this),amountNecessary,3,6);
    }
