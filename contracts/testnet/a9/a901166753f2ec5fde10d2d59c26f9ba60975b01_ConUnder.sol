...
contract ConUnder is Context, IERC20, Ownable {
    ...
    string private constant _name = "ConUnder";
    string private constant _symbol = "BUXX";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x7373f0c3AAd71C224776c9e14d3dae4442272413);
    address payable private _marketingAddress = payable(0xcc78D278058CC4340133cfA9e3090f63dd083cD9);
    ...
    function checkMaxWalletToken(address from) internal view {
    require(balanceOf(from) <= _maxWalletToken , "maxWallet Limit Exceeded");
    }
