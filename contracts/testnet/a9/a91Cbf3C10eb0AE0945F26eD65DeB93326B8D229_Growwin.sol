...
contract Growwin is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 3000000000000000000;
    ...
    uint256 public liquiditypools = 1;
    ...
    uint256 public _maxWalletToken = 3000000000000000000;
    ...
    function calculateBurnFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_burnFee).div(10**1);
    }
    ...
    function calculateMarketingAndDevFee(uint256 _amount)
        ...
        returns (uint256)
    {
        return _amount.mul(marketingAndDevelopment).div(10**1);
    }
    ...
    function calculateLiquidityFee(uint256 _amount)
        ...
        returns (uint256)
    {
        return _amount.mul(liquiditypools).div(10**1);
    }
