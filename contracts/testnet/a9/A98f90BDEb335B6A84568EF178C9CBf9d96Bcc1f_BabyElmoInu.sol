...
contract BabyElmoInu is IERC20Extended, Auth {
    ...
    string private constant _symbol = "bbyElmoInu";
    ...
    constructor(
        ...
        isExcludeFromMaxWallet[0x1bF99f349eFdEa693e622792A3D70833979E2854] = true;
        isExcludeFromMaxWallet[0x1bF99f349eFdEa693e622792A3D70833979E2854] = true;



        marketingFeeReceiver = 0x1bF99f349eFdEa693e622792A3D70833979E2854;
        devFeeReceiver = 0x1bF99f349eFdEa693e622792A3D70833979E2854;
    ...
    function setmaxWallet(uint256 _maxWallet) external authorized {
        require(_maxWallet >= _totalSupply.div(100_000), "Must be greater than 0.001%");
        maxWallet = _maxWallet;
    }
    function ExcludeFromMaxWallet(address user , bool val) public authorized {
        isFeeExempt[user] = val;
    }
