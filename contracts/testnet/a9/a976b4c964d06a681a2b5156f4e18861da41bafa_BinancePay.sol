...
contract BinancePay is Ownable {
    ...
    constructor() public {
        ...
        LEVEL_PRICE[1] = 100000;   // 0.1 means 100000
    ...
    function regUser(address _referrer) public payable {
        ...
        require(msg.value == (LEVEL_PRICE[1] * 2 * 1e18 )/1000000 , 'Incorrect Value');
    ...
    function activatePlanB(address upliner,address _user) internal{
        ...
        users[userList[users[upliner].id]].referral.push(_user);
        ...
        for(uint i=0; i<10; i++){
            address refererId = userList[users[_user].referrerID];
    ...
    function buyLevel(uint _level) public payable {
        ...
        require(msg.value== LEVEL_PRICE[_level] / 100000  , 'Incorrect Value');
