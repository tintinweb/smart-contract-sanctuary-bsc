...
contract EternalApe is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EternalApe";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "EAPE";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 1 * 1000000000**1 * (10 ** _decimals);
