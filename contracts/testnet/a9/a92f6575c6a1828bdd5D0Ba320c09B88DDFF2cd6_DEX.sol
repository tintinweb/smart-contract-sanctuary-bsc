...
contract fghfgh is IBEP20, Ownable {

    string public constant name = "fghfgh";
    string public constant symbol = "fghfgh";
...
contract DEX is Ownable, fghfgh  {
