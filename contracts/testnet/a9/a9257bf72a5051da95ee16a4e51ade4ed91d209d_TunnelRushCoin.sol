...
contract TunnelRushCoin is IERC20, Ownable {
    ...
    uint256 public _maxWalletSize = (_totalSupply * 10) / 100;  // 5% PERCENT
    ...
    uint256 public antiWhaleTime = 1647398700;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (antiWhaleTime > block.timestamp && sender == pair) {
            revert("Anti Bot");
        }
