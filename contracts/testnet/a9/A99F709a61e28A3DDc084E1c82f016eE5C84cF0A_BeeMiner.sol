...
contract BeeMiner is Claimable, UserBonus {
    ...
    uint256[] public REFERRAL_PERCENT_PER_LEVEL = [10, 3, 2, 1, 1];
    ...
    function getReferrals(address who) public view returns(uint256[5] memory levels , uint256[5] memory bonuses)  
    {
