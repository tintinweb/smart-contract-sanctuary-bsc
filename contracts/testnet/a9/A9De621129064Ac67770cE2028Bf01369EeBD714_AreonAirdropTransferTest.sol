...
contract AreonAirdropTransferTest is Context, Ownable, BEP20 {
    ...
    function getRecipient(address _address) public recipientCheck(_address) view returns(RecipientSchema memory){
        return recipientList[_address];
    }

    function getTotalTokenBalance() external view returns(uint) {
