...
import {IERC20} from "openzeppelin/token/ERC20/IERC20.sol";
import {SafeERC20} from "openzeppelin/token/ERC20/utils/SafeERC20.sol";
import {LvlDutchAuction} from "./LvlDutchAuction.sol";
import {IAuctionTreasury} from "../interfaces/IAuctionTreasury.sol";

contract LvlAuctionFactory is Ownable {
    using SafeERC20 for IERC20;
    ...
    constructor(address _lvl, address _payToken, address _treasury, address _admin, uint64 _vestingDuration) {
    ...
    function createAuction(
        ...
        LvlDutchAuction _newAuction = new LvlDutchAuction(
            LVL,
            payToken,
            _totalTokens,
            _startTime,
        ...
        emit AuctionCreated(LVL, payToken, _totalTokens, _startTime, _endTime, _startPrice, _minPrice, admin, treasury);
    }
