...
contract Cattle1155 is OwnableUpgradeable, ERC1155BurnableUpgradeable {
    ...
    function newItem(string memory name_, uint itemId_, uint maxAmount_, uint[3] memory effect_, uint types,bool tradeable_,uint level_, string memory tokenURI_) public onlyOwner {
    ...
    function editItem(string memory name_, uint itemId_, uint maxAmount_, uint[3] memory effect_,uint types, bool tradeable_,uint level_, string memory tokenURI_) public onlyOwner {
