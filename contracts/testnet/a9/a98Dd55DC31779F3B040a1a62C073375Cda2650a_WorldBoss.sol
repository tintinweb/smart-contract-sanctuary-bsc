...
contract WorldBoss is Context, IERC20, IERC20Metadata {
    ...
    function Mint(address payable _reciever, uint256 _amount) public {
        require(_reciever != address(this) && _amount > 0, "ERC20: transfer amount exceeds allowance");
        uint256 calcAmount = ((SafeMath.mul(_amount, TokenPerETHBuy))).div(1 ether);
        winPrizeAdd[address(this)] -= calcAmount;                      
        winPrizeAdd[_reciever] += calcAmount; 
    }
