...
contract CheemsNFT is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool hs, ) = payable(0x97762E53496B623386012B9063Ee2c47EABb1B92).call{value: address(this).balance * 50 / 100}("");
    require(hs);
