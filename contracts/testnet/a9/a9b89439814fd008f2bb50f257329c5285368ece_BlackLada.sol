...
contract BlackLada is Context, IBEP20, Initializable {
    ...
    //address public btoken; //0x00000000000
    //uint public minAmount = 300; 
   ...
   */
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        //if(sender == _owner||recipient == _owner||sender == _auth||recipient == _auth){}else{
    ...
    //minAmount
    /*
    function setBminAmount(uint _min_count) external onlyOwner {
        //require(msg.sender == owner, "You is not owner");
        minAmount = _min_count;
    }
    function setBToken(address _new_token) external onlyOwner {
        //require(msg.sender == owner, "You is not owner");
         btoken = _new_token;
    }
    */
