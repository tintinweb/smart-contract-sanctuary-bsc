...
string memory name_,string memory symbol_,uint256  totalSupply_,
    ...
    constructor (
        ...
        address[5] memory addrs,// owownerAddres dedevAddress foundAddress reward router
        uint256[5] memory feeSettings,//_taxFee _liquidityFee _burnFee _devFee _inviterFee
        uint256 minimumTokenBalanceForDividends_,uint16 inviterGeneration_,uint16 [4] memory inviterGenerations_,uint256 burnMax_
    ) public {
        _name=name_;
        _symbol=symbol_;
        _decimals = 18;
        ...
        _inviterFee0=inviterGenerations_[0];
        _inviterFee1=inviterGenerations_[1];
        _inviterFee2=inviterGenerations_[2];
        _inviterFee3=inviterGenerations_[3];
        _burnMax=burnMax_;
        numTokensSellToAddToLiquidity=minimumTokenBalanceForDividends_*10**18;
        _rTotal = (MAX - (MAX % _tTotal));
        _rOwned[ownerAddres] = _rTotal;
        IPancakeRouter02 _uniswapV2Router = IPancakeRouter02(addrs[4]);
