...
contract TEST is IBEP20, Auth {
    ...
    uint256 public totalFees     = CroRewardsFee + developmentFee + lotteryFee + liquidityFee;
    uint256 public feeDenominator = 1000;
    uint256 public reducedFeePercentage = 0;

    address public marketingWallet = 0x18B31BA62145a0BE8Be3928eF6885E067dfFdaCF;
    address public lotteryWallet = 0xC5c03370f64618BE4D495c2DeC97409cE2EcfEc4;
  ...
  function setFeeRates(uint256 _CroRewardsFee, uint256 _liquidityFee, uint256 _developmentFee, uint256 _lotteryFee, uint256 _feeDenominator) public onlyOwner {
            CroRewardsFee = _CroRewardsFee;
            liquidityFee = _liquidityFee;
            developmentFee = _developmentFee;
            lotteryFee = _lotteryFee;
            totalFees = _CroRewardsFee + _liquidityFee + _developmentFee + _lotteryFee;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountCroTeam.sub(teamShare);
