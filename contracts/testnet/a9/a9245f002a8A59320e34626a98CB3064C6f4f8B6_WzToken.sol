...
contract WzToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    function _transfer(
        ...
        require(isStartSwap || !isSwap || isWhiteList,"swap not open");
        ...
        if( canSwap &&
            ...
            if(AmountLpRewardFee > 0){
                swapAndLiquify(AmountLpRewardFee);
                AmountLpRewardFee = 0;
            }
            swapping = false;
        }
