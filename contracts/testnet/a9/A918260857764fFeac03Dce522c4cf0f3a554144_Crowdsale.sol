...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    uint256 public buyTime = block.timestamp + 5 minutes; //15 days * 1 seconds; //+ 15 days
    
    constructor (uint256 lockTime, uint8 price_type, address payable manager_, 
   ...
   function buyTokens() public payable nonReentrant {
    ...
    function finalize() public nonReentrant returns(bool) {
        ...
        (bool successTransfer, ) = address(_wallet).call{value: _weiRaised}("");
