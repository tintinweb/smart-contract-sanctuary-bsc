...
contract BlackRabbitProject is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    string private constant _name = "Black Rabbit Project";
    string private constant _symbol = "BRP";
    uint8 private _decimals = 9;
    
    address payable public marketingWalletAddress = payable(0x30E74d6aa9e5C9020068f8DaF95141240c61c4E2);
    address payable public developmentWalletAddress = payable(0xf515B8Ac7B96CCc4eC481ec5B55561b9FaeBc11a); 
    ...
    uint256 private _totalSupply = 88888888 * 10**9;
    uint256 public _maxTxAmount = 1777777 * 10**9;
    uint256 public _walletMax = 1777777 * 10**9;
    uint256 private minimumTokensBeforeSwap = 888 * 10**9; 
