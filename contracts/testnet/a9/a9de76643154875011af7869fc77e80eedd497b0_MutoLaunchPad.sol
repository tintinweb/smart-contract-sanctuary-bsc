...
contract MutoLaunchPad is Ownable {
    ...
    uint256 public threshold = 100000 ether; // 100000 Muto
    ...
    // Approve big amount of number on MutoLaunchPad contract address from Muto & USDT
    ...
    */
    ...
    // function setMutoAddress(address _MutoToken) external onlyOwner {
    //     MutoToken = IERC20(_MutoToken);
    // }
