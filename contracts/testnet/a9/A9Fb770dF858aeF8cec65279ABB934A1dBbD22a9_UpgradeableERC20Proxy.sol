...
abstract contract Ownable is Context {
     ...
     */
    function _initializeOnwer(address newOwner) internal {
...
abstract contract Pausable is Context {
    ...
    bytes32 internal constant _PAUSED_SLOT = keccak256("Pausable.storage.pause");

    /**
     * @dev Initializes the contract in unpaused state.
     */
    function _initializePaused() internal {
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _initializeERC20(string memory name_, string memory symbol_) internal  {
        require(!StorageSlot.getBooleanSlot(INITIALIZE).value,"ERC20 : already initialized");
...
contract UpgradeableERC20Proxy is ERC20, Pausable, Ownable, Proxy {
     ...
     * initialization.
     */
    function initialize(string calldata _name, string calldata _symbol, uint _initialSupply) external {
        require(!StorageSlot.getBooleanSlot(INITIALIZE).value, "already initialized");
        _initializeOnwer(_msgSender());
    ...
    /**
     * @dev This is a override function that returns the address to which the fallback function
     * and {_fallback} should delegate.
     */
    ...
    /**
     * @dev This is an overridden function that moves `amount` tokens from the caller's account to `to`.
     *
     * Returns a boolean value indicating whether the operation succeeded.
     *
     * Emits a {Transfer} event.
    ...
    /**
     * @dev This is an overridden function that moves `amount` tokens from `from` to `to` using the
     * allowance mechanism. `amount` is then deducted from the caller's
     * allowance.
     *
     * Returns a boolean value indicating whether the operation succeeded.
    ...
    /**
     * @dev This is an overridden function that sets `amount` as the allowance of `spender` over the caller's tokens.
     *
     * Returns a boolean value indicating whether the operation succeeded.
     *
     * Emits an {Approval} event.
    ...
    /**
     * @dev This is an overridden function that atomically increases the allowance granted to `spender` by the caller.
     *
     * This is an alternative to {approve} that can be used as a mitigation for
     * problems described in {IERC20-approve}.
     *
    ...
    /**
     * @dev This is an overridden function that atomically decreases the allowance granted to `spender` by the caller.
     *
     * This is an alternative to {approve} that can be used as a mitigation for
     * problems described in {IERC20-approve}.
     *
