...
contract ARB is Ownable {
    ...
    constructor (){
        ...
        lpAddress = 0x326F00794B8c90e8531756a01fdaA4B349879FB4; //LP地址
        ...
        arbAddress = 0x20C2539dc17a486e81A4901CeEAADEf2b8AcC811;//ARB代币
    ...
    function _cashDepositInternal(
        ...
        if (t == 2) { //AR
            ...
            if(arblprate > 0){
                ...
                address(AR).safeTransferFrom(msg.sender, arblpAddress, arblprateNumber);
            }
        }

        if (t == 3) {
            require(ARUSDTLP.balanceOf(msg.sender) >= amount, "Insufficient balance");
            address(ARUSDTLP).safeTransferFrom(msg.sender, address(this), amount);
        }
