...
contract SwapV2 is BaseContract
{
    ...
    function _buy(address buyer_, address payment_, uint256 amount_) internal returns (uint256)
    {
        ...
        uint256 _output_ = buyOutput(address(usdc), _usdcAmount_ - _usdcTax_);
        liquidityManager.swapUsdcForToken(address(this), _usdcAmount_ - _usdcTax_, _output_);
    ...
    function sell(uint256 amount_) external whenNotPaused
    {
        ...
        uint256 _output_ = sellOutput(_furReceived_ - _furTax_);
        liquidityManager.swapTokenForUsdc(address(this), _furReceived_ - _furTax_, _output_);
