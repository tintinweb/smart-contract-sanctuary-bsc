...
contract CamelRacingTest is Ownable, ERC721S, ReentrancyGuard {
    enum ContractStatus {
        Paused,
        Public
    }
    ...
    string  public baseURI = 'https://testapp.al-hejin.io/metadata/';
    string  public baseExtension = "";
    uint256 public price = 0.03 ether;
    uint256 public totalMintSupply = 200;
    ...
    ERC721S ("Camel Racing Test", "CRT") {
        baseURI = contractBaseURI;
    }

    function contractURI() public pure returns (string memory) {
        return "https://testapp.al-hejin.io/metadata/contract";
    }
