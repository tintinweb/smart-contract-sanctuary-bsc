...
contract LuchaMaskRandom is ERC721, Ownable, RandomlyAssigned {
    ...
    constructor(address _TVKtoken,uint256 _maxNftSupply,uint256 _maxAmountTokensReserved,string memory _placeholderURI,string memory _baseURI, string memory _provinanceHash ) ERC721("Luchamask", "LMSK") RandomlyAssigned(_maxNftSupply, 1) {
    ...
    function mintMask(uint256 amount) public payable onlyOwner{
