...
contract ChristmasMemeFamily is Context, IBEP20, Ownable {
    ...
    uint256 public numTokensSellToAddToLiquidity;                                        // contract balance to trigger swap & liquify + wallet transfer.
   ...
   function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
    ...
    function changeTokenSymbol(string memory newSymbol) external onlyOwner {
     ...
     function afterPreSale() external onlyOwner {
        ...
        numTokensSellToAddToLiquidity =50000000 * (10**18);
    ...
    function setFees(address sender , address recipient) private {
        if (sender == uniswapV2Pair) {
            ...
            a80DividendRewardsFee =   a80DividendRewardsFee;
            b20DividendRewardsFee =   a80DividendRewardsFee;
    ...
    function _transfer(
        ...
        if(!isTokenLive){
         ...
         require(heldTokens + amount <= maxWalletToken, "Error amount");
