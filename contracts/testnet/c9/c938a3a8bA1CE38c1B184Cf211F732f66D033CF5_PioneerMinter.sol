...
contract PioneerMinter is Minter {
    ...
    IPioneer public inactivePioneer;
    ...
    constructor(
        ...
        address inactivePioneerAddr_,
        uint16 maxMintPerWallet_
    ) Minter(contractControlListAddr_) {
        prevalidateAddresses_(activePioneerAddr_, inactivePioneerAddr_);
        activePioneer = IPioneer(activePioneerAddr_);
        inactivePioneer = IPioneer(inactivePioneerAddr_);
    ...
    function prevalidateAddresses_(
        ...
        require(
            inactivePioneerAddr_ != zeroAddress,
            "PioneerMinter: InactivePioneer Address zero"
        );
    }
    ...
    function burnActiveForInactivePioneer(uint256 activePioneerId_) external {
        address owner = activePioneer.ownerOf(activePioneerId_);
        activePioneer.burn(activePioneerId_);
        inactivePioneer.mintTo(owner, activePioneerId_);
    }
}
