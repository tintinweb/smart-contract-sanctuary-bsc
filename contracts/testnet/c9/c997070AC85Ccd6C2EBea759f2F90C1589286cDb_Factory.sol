...
contract NFTCollection is ERC721, Ownable {
    ...
    uint256 public feeDecimals = 10**6; 
    ...
    constructor(string memory name, string memory symbol, uint256 maxNftSupply, uint256 saleStart, string[] memory _properties, uint256 _referalFee) ERC721(name, symbol) {
        ...
        require(_referalFee < feeDecimals, "Wrong number for referalFee");
...
contract Factory {
    ...
    function makeCollection(string memory name, string memory symbol, uint256 maxNftSupply, uint256 saleStart, string[] memory properties, uint256 referalFee) 
