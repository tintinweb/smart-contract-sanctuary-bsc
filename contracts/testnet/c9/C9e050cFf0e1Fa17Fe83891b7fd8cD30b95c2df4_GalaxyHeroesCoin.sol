...
contract GalaxyHeroesCoin is ERC20, Ownable, AccessControl {
    using SafeMath for uint256;

    uint256 constant ROYALTY_BASE = 10000;  // royalty base
    uint256 public royaltyFee = 400;        // royalty, ex: 400 / 10000 = 4%
    ...
    constructor() ERC20("Galaxy Heroes Coin", "GHC") {
    ...
    /**
     * mints $GHC to a recipient
     * @param to the recipient of the $GHC
     * @param amount the amount of $GHC to mint
     */
