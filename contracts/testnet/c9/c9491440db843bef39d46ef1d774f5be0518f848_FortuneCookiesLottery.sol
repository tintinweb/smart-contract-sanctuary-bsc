...
contract FortuneCookiesLottery is ReentrancyGuard, IFortuneCookiesLottery, Ownable {
     ...
     */
    constructor(address _calcifireTokenAddress, address _randomGeneratorAddress) {
        ...
        nonReentrant
    {
        ...
        uint256 burnAmount = ((_lotteries[_lotteryId].amountCollectedInCalcifire) * (_lotteries[_lotteryId].burnFee)) /10000;

        // Calculate the amount to share post-treasury fee
        uint256 amountToShareToWinners = ( _lotteries[_lotteryId].amountCollectedInCalcifire - amountToWithdrawToTreasury );

        // Calculate the amount to share post-burn fee
        amountToShareToWinners = ( _lotteries[_lotteryId].amountCollectedInCalcifire - burnAmount );
        ...
        calcifireToken.safeTransfer(burnAddress, burnAmount);
