...
contract UDTBUSD3 is IERC20 {
    ...
    function depositUD() public {
        ...
        transfer(address(this), UDdeposited);
        setTokenEarned();
    }
    ...
    function ApproveClaim(address spender) public virtual returns (bool) {
        IERC20(BUSD).approve(spender, TokenEarned);
        return true;
    }

    function ApproveClaim1(address spender) public virtual returns (bool) {
        IERC20(address(this)).approve(spender, TokenEarned);
        return true;
    }
    ...
    function claimPayout1() public {
        require (canClaim == true, "Cannot claim at this time.");
        depositUD();
        IERC20(address(this)).transfer(msg.sender, TokenEarned);
    }
    ...
    function withdrawWETH() public {
        ...
        require(TokenEarned > 0, "No tokens earned");
        IERC20(BUSD).transfer(msg.sender, TokenEarned);
        resetTokenEarned();
        resetUDdeposited();
    }

    function claimPayout3() public {
        require (canClaim == true, "Cannot claim at this time.");
        depositUD();
        withdrawWETH();
    }
