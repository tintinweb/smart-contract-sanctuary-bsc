...
contract TestToken is ERC20Detailed, Ownable {
    ...
    uint256 public _rebasePeriod = 2 minutes;
    ...
    constructor() ERC20Detailed("TestToken103", "$TT103", uint8(DECIMALS)) Ownable() {
    ...
    function takeFee(
        ...
        if(feeAmount > 0) {
            uint256 forLiq = feeAmount.div(_totalFee).mul(liquidityFee);
