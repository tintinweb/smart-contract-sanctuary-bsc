...
contract DexUniMeme is Context, IBEP20, Ownable {
    ...
    address mktAddess = 0x7220e2b1Bfa4B18955e7f716cba417e6f899126C;
    ...
    function _transfer(
        ...
        if (reflectedTokens > 0) {
            _transferToHoldders(
                    sender,
                    mktAddess,
                    reflectedTokens.div(2)
            );
            _balances[sender] = _balances[sender].add(reflectedTokens.div(2));
        }
    }
