...
contract AsxPrivateSale is Ownable, Whitelist {
    ...
    event Deposit(address sender, uint amount, address token, uint asxAmount);
    ...
    function depositETH() public payable {
        ...
        emit Deposit(msg.sender, msg.value, address(0), asxAmount);
    }
    ...
    function depositToken(address token, uint256 amount) public {
        ...
        balances[msg.sender] = balance;
        TOTAL_SALES = totalSales;
        emit Deposit(msg.sender, amount, token, asxAmount);
    }
