    ...
    ILayerZeroUserApplicationConfig
{
    ...
    function remoteCallB(uint16 _dstChainId, bool _isTest, uint _addVal) external payable onlyOwner {
        uint16 VERSION = 1;
        uint FEE = 350000;
        ...
        lzEndpoint.send{value: msg.value}(
            ...
            abi.encode(_isTest, _addVal), // abi.encoded()'ed bytes
    ...
    function _lzReceive(uint16, bytes memory, uint64, bytes memory) public {
