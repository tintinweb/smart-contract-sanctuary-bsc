...
contract HayyaInu is ERC20, Ownable, BaseToken {
    ...
    constructor(
        uint256[5] memory feeSettings // dev, liquidity, burn, community, marketing
    ) ERC20("Hayya Inu", "HAYYAINU") {
        ...
        totalFees = devFee
            ...
            .add(communityFee)
            .add(marketingFee);
        require(totalFees <= 2500, "HAYYAINU: Total fee is over 25%");
        swapTokensAtAmount = 100 ether; // Swap at 100 HAYYAINU
        ...
        // Set the wallets for the fees
        devWallet = 0x3291A5dd2a67dF2eE4C9051A4fcbA013d04d75c3;
        communityWallet = 0x3291A5dd2a67dF2eE4C9051A4fcbA013d04d75c3;
        marketingWallet = 0x3291A5dd2a67dF2eE4C9051A4fcbA013d04d75c3;
        buyBackBurnWallet = 0x3291A5dd2a67dF2eE4C9051A4fcbA013d04d75c3;
        ...
        */
        ...
        uint256 totalSupply = 300 * 1e6 ether;
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "HAYYAINU: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "HAYYAINU: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "HAYYAINU: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "HAYYAINU: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function _transfer(
        ...
        if (
            ...
            require(tradingOpen, "HAYYAINU: Trading is not open");
