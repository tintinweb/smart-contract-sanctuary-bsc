...
https://twitter.com/LangyaToken
https://t.me/LangyaToken

TOTAL SUPPLY: 1,000,000 $LANGYA

	BUY/SELL TAX: 10%
	- GIVEN TO HOLDERS: 5%
	- PERMANENTLY MARKETING: 3%
	- PERMANENTLY LOCKED IN LP: 2%
...
contract Langya is Context, IBEP20, Ownable {
	...
	address private _burnWalletAddress = 0x1bE3e3EB9F8e80CbF3823f8B7E85D9901Ed19f90;
    ...
    string private _name = "Langya Token";
    string private _symbol = "LANGYA";
    ...
    uint256 public _maxTxAmount = 20000 * 10**9; // 2% LANGYA max per TX
    uint256 private numTokensSellToAddToLiquidity = 10000 * 10**9; // add 10000 LANGYA increments to the LP every 1 percent
	
    bool public _allowTrading = false; // disabled by default
    ...
    function allowtrading() external onlyOwner() { _allowTrading = true; }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        if(_allowTrading == false){ require(sender == owner()); } // only owner allowed to trade or add liquidity if trading is not yet enabled
