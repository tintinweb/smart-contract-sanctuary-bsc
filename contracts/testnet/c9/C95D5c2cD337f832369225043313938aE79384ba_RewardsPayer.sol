// Deployed address: 0xD0275c701816A8e86db19064EfFDadF266fe51EF
...
contract RewardsPayer is ReentrancyGuard, AccessControl {
    // ****** SETEAR LA ADDRESS DEL RELAYER QUE ES LA QUE SE USA EN EL MODIFIER OnlyDev ****
    address private relayAddress;
    // Contratos de los tokens Busd y Usdc en BSC Mainnet
    IERC20 Busd = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // tesnet address: 0xed24fc36d5ee211ea25a80239fb8c4cfd80f12ee
        ...
        nonReentrant
    {
        ...
        for (uint16 i = 0; i < _collections.length; i++) {
            ...
            amountRents = collectionRewardsPerUser[msg.sender][_collections[i]]
                .rewardPerRent;
            amountRentFinal += collectionRewardsPerUser[msg.sender][
                _collections[i]
            ].rewardPerRent;
    ...
    // TAL VEZ SE DEBE CONFIGURAR QUE SOLO CIERTAS ADDRESS TENGAN ACCESO A ESTA FUNCION.
