    ...
    PausableUpgradeable
{
    ...
    function initialize(
        ...
        salePrice = 0.00125 * (10**18); //0.00125 USD
        ...
        returns (uint256 totalValue)
    {
        ...
        if (totalSold + _amount <= 100_000_000) {
            ...
            if (totalSold >= 100_000_000) {
                _salePrice =
                    (_salePrice + (0.00087499999999999 * (10**18))) +
                    (((totalSold - 100_000_000) / 100_000_000) *
                        (0.00087499999999999 * (10**18)));
                ...
                if (extra <= 100_000_000) {
                    return totalValue + (extra * ((_salePrice * 170) / 100));
                } else {
    ...
    function changeInsale(uint _a) external {
        inSale = _a;
    }
