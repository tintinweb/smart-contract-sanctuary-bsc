...
contract smiletest is ERC20Detailed, Ownable {
    ...
    string public _name = "smiletest";
    string public _symbol = "SBT";
    ...
    constructor() ERC20Detailed("smiletest", "SBT", uint8(DECIMALS)) Ownable() {
