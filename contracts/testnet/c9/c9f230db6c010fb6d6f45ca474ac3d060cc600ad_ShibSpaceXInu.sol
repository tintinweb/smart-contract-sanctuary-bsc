...
contract ShibSpaceXInu is Context, IERC20, Ownable {
    ...
    uint256 public _burnFeeOnBuy = 2;
    uint256 public _taxFeeOnBuy = 5;
    
    uint256 public _burnFeeOnSell = 2;
    ...
    address payable private _developmentAddress = payable(0x58d94B196038827DdC4C5B0f7063Bc6502075389);
    address payable private _marketingAddress = payable(0x0108791Dcb6E836876ccAc7Ce51e95a622725810);
