...
TOKENOMICS:
Supply: Gazillion tokens

Buy Tax 9% / Sell Tax 9%
5 / 4 % marketing
2 / 2 % buyback
2 / 3 % LP
...
contract DeBust is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 50; // 2% of sp
    uint256 public maxTxAmountSell = _tTotal / 50; // 2% of sp
    uint256 public maxWalletAmount = _tTotal / 50; // 2% of sp
    ...
    string private constant _name = "Debust";
    string private constant _symbol = "BUST";
