...
contract VaultMVLPToken is ERC4626, Ownable {
  ...
  address public operator; // MVLP Depositor

  constructor(address assetMVLP) ERC4626(IERC20Metadata(assetMVLP)) ERC20('Vault MVLP', 'xMVLP') {
