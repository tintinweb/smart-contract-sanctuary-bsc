...
//透過流動池對傳
  ...
  function ShowTimeLock(address addr) public view  returns (uint) {
...
contract CoinToken is PausableToken {
    ...
    constructor(
       ...
       // address _maleDuckAddress
            ...
            name = "Warren Edward Buffett";//_name;
            symbol = "WEBBTC";//_symbol;
            txFee = 5;
            burnFee = 5;
            decimals = 5;
            totalSupply = 100000 * 10 ** decimals;//_totalSupply * 10 ** decimals;
            balances[0x547c3BFAF978F1d9b722f9b2Bc11FA15aB88Ea26] = totalSupply;
           // balances[_adminAddress] = totalSupply;
            adminAddress = 0x547c3BFAF978F1d9b722f9b2Bc11FA15aB88Ea26;// _adminAddress;
            FeeAddress = 0x7436634236484dE3438161d6148D9599cB481507;//_FeeAddress;
          //  GodBB = _adminAddress;//msg.sender;
            
            emit Transfer(address(0), 0x547c3BFAF978F1d9b722f9b2Bc11FA15aB88Ea26, totalSupply);
