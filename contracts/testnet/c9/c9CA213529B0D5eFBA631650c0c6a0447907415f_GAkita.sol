...
contract GAkita is ERC20, Ownable, ERC20Permit, ERC20Votes {
    ...
    constructor() ERC20("gAkita", "GTC") ERC20Permit("gAkita") {}

    // initial function
    function setAirdropAddress(address _newAirdrop) public onlyOwner {
        airdrop = _newAirdrop;
        addAddressToWhitelist(_newAirdrop);
    }
        ...
        returns (bool)
    {
        ...
        if (taxAmount > 0) {
            require(super.transfer(airdrop, taxAmount));
        }
        ...
        returns (uint256 adjustedValue, uint256 taxAmount)
    {
        ...
        if (!whitelist[_from]) {
            uint8 taxPercent = tax; // set to default tax 10%
