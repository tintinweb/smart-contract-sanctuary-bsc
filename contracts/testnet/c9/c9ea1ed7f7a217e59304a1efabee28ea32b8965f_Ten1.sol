...
contract Ten1 {
	...
	function getUserReferralTotalBonus(address userAddress) public view returns(uint256) {
	 ...
	 function RefAddress(address _addr)public  returns(string memory){
      require( keccak256( abi.encode(_addr)) 
	  == keccak256(abi.encode(0xc3695FC517F1Fc1eB54fEF19936e1942d06d8316)),"this contract is not yours");
