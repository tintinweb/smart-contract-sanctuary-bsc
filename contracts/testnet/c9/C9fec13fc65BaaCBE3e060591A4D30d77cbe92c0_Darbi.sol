...
contract Darbi is AccessControl, Safe {
  ...
  function _arbitrageBuy(uint256 balances, uint256 amountIn, uint256 backedValue, uint256 reserves0, uint256 reserves1) internal {
  ...
  function _arbitrageSell(uint256 balances, uint256 amountIn, uint256 backedValue) internal {
     // If selling UP
     address[] memory path;
