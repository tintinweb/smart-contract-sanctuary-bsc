...
contract MCC is Context, Ownable, BEP20, Uniswap {
...
abstract contract Uniswap is Ownable, BEP20 {
    using SafeMath for uint256;
    using Address for address;
    ...
    constructor () {
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xA888b1ADe089100B37242d1e1Ab6B833bb99559a); //local
...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    uint256 public _totalTaxIfBuying = 6;/// 流动性整体份额
    uint256 public _totalTaxIfSelling = 6;/// 营销整体份额
    uint256 public _totalDistributionShares = 6;/// 团队整体份额
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _buyLiquidityFee.add(_buyMarketingFee).add(_buyTeamFee);/// 流动性整体份额
        _totalTaxIfSelling = _sellLiquidityFee.add(_sellMarketingFee).add(_sellTeamFee);/// 营销整体份额
        _totalDistributionShares = _liquidityShare.add(_marketingShare).add(_teamShare);/// 团队整体份额
        /// 不计算钱包限额
