...
contract BNBXMas {
    ...
    constructor(address commissionwallet) {
        owner = commissionwallet;
    ...
    function launch() public {
        require(msg.sender == owner, "caller is not the owner");//need dev address
        require(!initialized);//only initialized one time
        initialized = true;
    }
