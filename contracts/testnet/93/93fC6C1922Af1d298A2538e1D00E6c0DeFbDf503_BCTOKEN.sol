...
contract BCTOKEN is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Blues Clues";
...
;
    ...
    function swapBackInBnb() internal swapping {
        ...
        uint256 totalSwapFee = buyMarketingFee.add(buyBackFee);
