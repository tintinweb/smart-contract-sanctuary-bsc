...
contract LpStakingPool is USDTWrapper,Ownable {
    ...
    uint256 public totalDuration = 60 * 60 * 24 * 3600;
    ...
    constructor() public {
        ...
        address inToken_ = 0x9236B4e8Be54Ce361b0500C2B6424c2a94fFdd52;

        address outToken_ = 0xf010163D4D4c2464eF01f93b2b245Ff0682203c5;

        referrerAddress[msg.sender] = 0x46Cc66AB622CFcE570e3036C3c5c745dD0771D7A;

        uint256 starttime_ = 1677728830;
    ...
    modifier updateReward(address account) {
        if (block.timestamp < starttime + 1 days) {
             rewardRate = 9259259259000000000;
        } else  { 
             rewardRate = 578703703703703;
        }
