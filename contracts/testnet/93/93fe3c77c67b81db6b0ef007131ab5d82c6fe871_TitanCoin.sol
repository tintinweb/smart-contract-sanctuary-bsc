...
contract TitanCoin is ERC20Detailed, Ownable {
    ...
    string public _symbol = "TitanCoin";
    ...
    address public titanInsuranceFund;
    ...
    constructor() ERC20Detailed("TitanCoin", "TC", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityFund = 0x11e6F435ce391C626374Cf1FA57Ec51d4630066D;
        treasuryFund = 0x43efC6EBd6C1Bfb6C6F586CF58a0A75821c844c4;
        titanInsuranceFund = 0x5213Cd55A6a67fDE6445063452d46294082418cA;
    ...
    function swapBack() internal swapping {
        ...
        (success, ) = payable(titanInsuranceFund).call{
            value: amountETHToTreasuryAndRRFF.mul(titanInsuranceFundFee).div(
                treasuryFee.add(titanInsuranceFundFee)
            ),
            gas: 30000
        }("");
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no TC token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _titanInsuranceFund,
        address _titanCapsule
    ) external onlyOwner {
        autoLiquidityFund = _autoLiquidityFund;
        treasuryFund = _treasuryFund;
        titanInsuranceFund = _titanInsuranceFund;
