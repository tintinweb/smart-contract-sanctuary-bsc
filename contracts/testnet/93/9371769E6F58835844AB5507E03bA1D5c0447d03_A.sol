...
abstract contract BondBaseSDA is IBondSDA, Auth {
    ...
    event Tuned(uint256 indexed marketId, uint256 oldControlVariable, uint256 newControlVariable);
    ...
    constructor(
        ...
        defaultTuneInterval = 5 minutes;
        defaultTuneAdjustment = 1 minutes;
        minDebtDecayInterval = 10 minutes;
        minDepositInterval = 1 minutes;
        minMarketDuration = 1 minutes;
        minDebtBuffer = 10000; // 10%
...
contract A is BondBaseSDA {
    ...
    constructor(
        ...
        // address guardian_,
        // Authority authority_
    ) BondBaseSDA(IBondTeller(0x6b02eC717802Fd039e001e89fCED116FD907669d), IBondAggregator(0x68fe2D9A21Bc6A131934efc223C0f32a1aC4a058), address(0xb993A892241e9db2aD90eB2c8fB2D7D0e576cd7B), Authority(0x20397581F1426ec89dfd31E777cfB2fdBA646d43)) {}
