...
contract TokenStake is Ownable, ReentrancyGuard, Pausable, ITokenStake {
        ...
        whenNotPaused
    {
        ...
        totalStakedTokens[msg.sender] = totalStakedTokens[msg.sender] - accountBalance;
    ...
    {
        require(
            getRemainStakingDuration(msg.sender, stakingOrder) >=
                atLeastStakingDuration,
        ...
        emit RewardPaid(msg.sender, reward, stakingOrder, atLeastStakingDuration);
    }
    ...
    event RewardPaid(address indexed user, uint256 reward, uint256 order, uint256 requiredDuration);
