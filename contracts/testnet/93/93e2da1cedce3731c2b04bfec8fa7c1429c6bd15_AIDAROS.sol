...
/*
   ...
   db    88 8888b.     db    88""Yb  dP"Yb  .dP"Y8 
  dPYb   88  8I  Yb   dPYb   88__dP dP   Yb `Ybo." 
 dP__Yb  88  8I  dY  dP__Yb  88"Yb  Yb   dP o.`Y8b 
dP""""Yb 88 8888Y"  dP""""Yb 88  Yb  YbodP  8bodP' 

    Website: http://www.pennyinu.com
	Telegram: https://t.me/Penny_Inu
    Token Name: Aidaros
    Symbol: AID
	Total Supply: 100_000_000_000 (100 Billion)
    
    Tokenomics:
    Buy Fee
    3% Reflections in BUSD
    2% Liquidity
    ...
    Maximum Buy, Sell and Wallet limit is 5%
**/
...
contract AIDAROS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public swapTokensAtAmount = 1 * 10**7 * (10**9); //0.01% of the supply

    uint256 public maxBuyAmount = 5 * 10**9 * 10**9; // 5% of the supply
    uint256 public maxSellAmount = 5 * 10**9 * 10**9; // 5% of the supply
    uint256 public maxWalletAmount = 5 * 10**9 * 10**9; // 5% of the supply
    ...
    address public _devWallet = payable(address(0x9E92C6f41Aa0987c7e7F706E049358e2A455DBEc)); // developmentWallet
    address public _marketingWallet = payable(address(0xA4882601aF1c2661A5ce0B59C2b755C8fc169070)); //marketingWallet
    ...
    constructor() ERC20("Aidaros", "AID") {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 // Pancakeswap Router //testnet 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 //mainnet 0x10ED43C718714eb63d5aA57B78B54704E256024E
        );
...
//by ~tokensdev
// Donate: 0x753fb6d7aB272F19D2559602752b758c77862397, if you use this contract be kind and donate for more development.