...
contract yilongmusk is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "yi-long-musk";
    string private constant _symbol = "YLMUK";
    ...
    address payable private _marketingAddress = payable(0xE6087c6911cF08078F9424E9f0D319b6858E0798);
    address payable private _buybackAddress = payable(0xE6087c6911cF08078F9424E9f0D319b6858E0798);
    address payable constant private _projectMaintainence = payable(0xE6087c6911cF08078F9424E9f0D319b6858E0798);
    address payable private _developmentAddress = payable(0xE6087c6911cF08078F9424E9f0D319b6858E0798);
     ...
     */
    function getLatestPrice() external pure returns (uint80) {
    ...
    function getTokenPrice() external view returns(uint256) {
        ...
        uint256 res1 = (uint256(Res1)*(10**uint256(token0.decimals())))/uint256(token1.decimals());
