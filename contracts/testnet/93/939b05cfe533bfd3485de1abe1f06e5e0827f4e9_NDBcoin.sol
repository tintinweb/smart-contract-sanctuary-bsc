...
import './lib/OracleFixedWindows.sol';
...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    IOracleFixedWindows oracleFixedWindows;
    ...
    constructor (address _router,address _oracle) {
        ...
        _token = msg.sender;
        oracleFixedWindows = IOracleFixedWindows(_oracle);
    }
    ...
    function deposit() external payable override onlyToken {
        ...
        path[0] = WBNB;
        path[1] = address(BUSD);
        //uint amountOutMin = oracleFixedWindows.consult(address(this),msg.value);
...
contract NDBcoin is IBEP20, Auth {
    ...
    string constant _name = "NDBB1";
    string constant _symbol = "NDBB1";
    ...
    function initialize(address _dexRouter) public{
        ...
        distributor = new DividendDistributor(_dexRouter,oracleFixedWindowsAddress);
    ...
    function swapBack() internal swapping {
        ...
        uint amountOutMin = oracleFixedWindows.consult(address(this),amountToSwap);
        require(amountOutMin > 0,"Guard here !");
        ...
        if(amountToLiquify > 0){
            uint amountTokenMin = oracleFixedWindows.consult(WBNB,amountBNBLiquidity);
            require(amountTokenMin > 0,"Guard here !");
    ...
    function buyTokens(uint256 amount) internal swapping {
        ...
        uint amountOutMin = oracleFixedWindows.consult(WBNB,amount);
        require(amountOutMin > 0,"Guard here !");
