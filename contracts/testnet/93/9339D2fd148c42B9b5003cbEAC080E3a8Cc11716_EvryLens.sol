...
contract EvryLens {
    ...
    function eTokenMetadata(EToken eToken) public view returns (ETokenMetadata memory) {
        ...
        ComptrollerLensInterface comptroller = ComptrollerLensInterface(address(eToken.comptroller()));
        (bool isListed, uint collateralFactorMantissa) = comptroller.markets(address(eToken));
        address underlyingAssetAddress;
        uint underlyingDecimals;
