...
contract Presale is Whitelist {
    ...
    function getPresale(address _presale) public view returns(address, string memory, uint8, string memory, uint256, uint256, address, uint256[16] memory, string[10] memory) {
