...
contract ContractData is Authorized {
  ...
  uint public constant timeFrame = 2 minutes;
  uint public constant timeToWithdraw = 1 minutes;
  ...
  uint public constant networkFeePercent = 1;
  uint public constant wpmFeePercent = 1;
