...
contract Market is AccessControl,Ownable{
    ...
    function stake(uint256 _tokenId) public{
        require(_game.getUserAddress(_tokenId)==msg.sender,"Illegal operation");
        require(userStakeInfo[msg.sender].contains(_tokenId) == true, "It's already pledged");
    ...
    function unStake(uint256 _tokenId) public {
        ...
        require(userStakeInfo[msg.sender].contains(_tokenId) == false, "It's already decompressed");
