...
contract TokenContractMadeFaizDev is ReentrancyGuard{
...
/** check whether sender is registered with us **/
require(_amountDeposited[msg.sender] > 0, "User has no deposits.");

/** check whether sender has balance **/
require(balances[msg.sender] > 0, "User has no balance to withdraw.");
