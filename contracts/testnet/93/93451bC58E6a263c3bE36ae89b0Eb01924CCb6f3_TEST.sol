...
contract TEST is ERC20, Ownable {
    ...
    constructor() payable ERC20("TEST", "TEST") {
        ...
        if (block.chainid == 97) {
            _dexRouter = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // ETH: Uniswap V2 MAINNET
        } else if (block.chainid == 4) {
            _dexRouter = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // ETH: Uniswap V2 RINKEBY
        } else {
