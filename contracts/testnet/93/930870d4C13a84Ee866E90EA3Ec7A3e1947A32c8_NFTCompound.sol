...
contract NFTCompound is ContextMixin, AccessControl, Pausable, ReentrancyGuard, NativeMetaTransaction {
    ...
    bytes32 internal constant FACTORY_ROLE = keccak256("FACTORY_ROLE"); // Factory role is used to withdraw nft from the contract
    ...
    event Compound(address indexed _from, uint256 _type, string _transactionId, uint256[] _tokenIds);
    ...
    function compound(
        ...
        emit Compound(_receiver, _type, _transactionId, _tokenIds);
    }
