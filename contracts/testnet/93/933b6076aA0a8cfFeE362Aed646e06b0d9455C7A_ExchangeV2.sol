...
/**
* @notice contracts that we connect to the Exchange contract of the network operator for the transfer of tokens
*/
...
abstract contract ExchangeV2Core is Initializable, OwnableUpgradeable, AssetMatcher, TransferExecutor, OrderValidator, ITransferManager {
    ...
    // Match order function where we check right and left side and If everything is ok call matchAndTransfer
