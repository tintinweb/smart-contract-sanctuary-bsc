...
contract DeMeNetwork is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1000000 * 10**decimals();
    ...
    address private marketingWallet = 0xDd155CC31F70B31630a3fA8041875c21DB14Fc54;
    address private devWallet = 0x60E5384F9bdC3Fc33f3F4A35c841a32B4b10cfee;
    ...
    Taxes public taxes = Taxes(5, 2, 0);
    Taxes public sellTaxes = Taxes(5, 2, 0);
    ...
    constructor(address routerAdd) ERC20("DeMe Network", "DeMe") {
    ...
    function UpdateBuyTaxes(
        ...
        require((_marketing + _liquidity + _dev) <= 20, "Buy taxes up to 20% only");
    }
    ...
    function SetSellTaxes(
        ...
        require((_marketing + _liquidity + _dev) <= 20, "Sell taxes up to 20% only");
    }
