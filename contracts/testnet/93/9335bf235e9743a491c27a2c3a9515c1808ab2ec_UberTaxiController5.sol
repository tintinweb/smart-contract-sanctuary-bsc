...
contract UberTaxiController5 is Ownable {
    ...
    constructor() {
        ...
        UTD = UberTaxiDate(0x8cc2a51256F65E5288966630e47fAe145E944348);

        UTBC = UberTaxiBaseController(0x8381180ded027b3075b6275A2fb948A4Ad182De4);
    }
    ...
    function openBlindBox() public {
        ...
        UTD.setUtaxiDetails(msg.sender, 6, "Open BlindBox", UTD.blindBoxPrice().div(10 ** 18), block.timestamp);
    ...
    function buyVehicle(uint256 index, uint8 tokenType) public {
        ...
        if (tokenType == 1) {
            ...
            string memory source = string(abi.encodePacked(index, ''));
            UTD.setUtaxiDetails(msg.sender, 6, source, uPrice.div(10 ** 18), block.timestamp);
        }
    ...
    function playerTransfer(address addr, uint256 transferNum) public {
        ...
        UTD.setUtaxiDetails(msg.sender, 2, UTBC.toString(addr), transferNum, block.timestamp);

        UTD.setUtaxiDetails(addr, 1, UTBC.toString(msg.sender), transferNum, block.timestamp);
    ...
    function addUserUTAXINum(address addr, uint256 UTAXINum) public onlyOwner {
        ...
        UTD.setUtaxiDetails(addr, 1, UTBC.toString(msg.sender), UTAXINum, block.timestamp);
    }
