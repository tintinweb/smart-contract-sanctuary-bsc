...
contract AggregatorExecutor is Ownable {
    ...
    ensure(_deadline)
    {
        ...
        checkSigner(_signature.data, _steps);
        //check input eth
    ...
    //=========== internal functions ============//
    function checkSigner(bytes memory _signature, SwapStep[] memory _path) internal{
        // require(!usedNonce.get(_nonce), "AggregatorExecutor: _nonce has been used");
        bytes32 _hash = keccak256(abi.encode(address(this), _path)).toEthSignedMessageHash();
