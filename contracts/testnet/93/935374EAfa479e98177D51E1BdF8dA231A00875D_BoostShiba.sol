...
pragma solidity ^0.7.4; // compile with 0.7.6 not 0.7.4
...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minPeriod = 30 minutes; // reward every 30 minutes 
    uint256 public minDistribution = 1000 * (10 ** 18); // minimum token to get rewarded
...
contract BoostShiba is IBEP20, Auth { // contract name 
    
    using SafeMath for uint256;

    string constant _name = "BoostShiba";    // change the name here                     
    string constant _symbol = "Bsh";  // change the symbol 
    ...
    uint256 _totalSupply = 100000000 * 10**12 * (10 ** _decimals);
