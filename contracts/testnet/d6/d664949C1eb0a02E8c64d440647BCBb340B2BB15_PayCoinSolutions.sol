...
contract PayCoinSolutions is Context, IERC20, Ownable {
    ...
    string private constant _name = "Paycoin Solutions";
    string private constant _symbol = "Pspay";

    uint256 private _tTotal = 120000000000 * 10**_decimals;        // Supply do Token = 120 billions
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _maxTxAmount    = 960000000 * 10**_decimals;    // 960 millions - Initial max buy 
    uint256 public _maxRxAmount    = 350000 * 10**_decimals;       // 350 mil - Initial max sell
	uint256 public _maxWallet      = 1440000000 * 10**_decimals;   // 1.44 billions - Initial max Wallet	
    uint256 public numTokensToSwap = 5000000 * 10**_decimals;      // 5 millions
	
    uint public sellPerSecond = 20; // 20seconds
    uint public buyPerSecond = 5;	// 10seocnds
    ...
    struct feeRatesStruct {
        uint256 rfi;       // reflection staking to holders
        uint256 marketing; // wallet that accumulates bnb
        uint256 liquidity; // Pool Liquidify
        uint256 burn;      // Wallet burn
    }
 ...
 //     IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //BSC mainnet
        ...
        marketingAddress = payable(0x6c1A0d53d37eFb9E5a4B3CF10f014313852A9B2C); // wallet that accumulates bnb
        
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[marketingAddress] = true;
        _isExcludedFromFee[0x000000000000000000000000000000000000dEaD] = true;
        //_isExcludedFromFee[pancakeswapV2Pair] = true;
