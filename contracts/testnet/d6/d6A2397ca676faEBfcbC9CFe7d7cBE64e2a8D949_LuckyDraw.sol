...
contract LuckyDraw is ReentrancyGuard{
    ...
    address private TrexBusd = 0x296c03F07D1fD2641c68103B915462d885F4a835;
    address private dev = 0x296c03F07D1fD2641c68103B915462d885F4a835;
...
uint256 private maxParticipantNumbers1;
    ...
    constructor()  {  
        owner =  msg.sender;
        maxParticipantNumbers = 1;
        ticketPrice = 0.5 ether ;

         maxParticipantNumbers1 = 2;
        ticketPrice1 = 1 ether;

         maxParticipantNumbers2 = 3;
        ticketPrice2 = 1 ether;
