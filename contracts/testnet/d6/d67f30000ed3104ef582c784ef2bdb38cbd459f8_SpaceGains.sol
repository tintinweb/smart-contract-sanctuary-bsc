...
//
// Life is Good When you Have ForeverDome ForeverDome.com t.me/ForeverDome
// 5% ForeverDome Rewards
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47); // Mainnet
    address WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F; // Mainnet
    ...
    uint256 public minDistribution = 50 * (10 ** 18); // 50 EverDome minimum auto send
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81); // Mainnet
        _token = msg.sender;
    }
...
contract SpaceGains is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "SpaceGains";
    string constant _symbol = "SGS";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 10 ** 6 * (10 ** _decimals); // 10 ** 9 is 1 billion
    ...
    address public marketingFeeReceiver = 0x5164C34494627DE481c2cd51cFb86907Ee151689;
    address public buybackFeeReceiver = 0x5164C34494627DE481c2cd51cFb86907Ee151689;

    address DOME = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47; // Mainnet
	address WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F; // Mainnet
    ...
    constructor () Ownable(msg.sender) {
        router = IDEXRouter(0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81); // Mainnet
        ...
        isMaxHoldExempt[buybackFeeReceiver] = true;
