...
contract BabyFlokiDoge is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 8000000 * 10**9 * 10**9; //160 quadrillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "babyflokidogetest";
    string private _symbol = "babyflokidogetest";
    ...
    */
    ...
    function _transfer(address from, address to, uint256 amount
        ...
        if( (from != owner() && to != owner()) || !(_isExcludedFromTxLimit[from]) ) {
            require(amount <= _maxTxAmount, "BabyFlokiDoge: Transfer amount exceeds the maxTxAmount.");
        }
