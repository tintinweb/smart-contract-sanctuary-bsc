...
contract Akshare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 50,000 Akshare
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("Akshare", "Akshare") {
        _mint(msg.sender, 1 ether); // mint 1 Akshare for initial pools deployment
