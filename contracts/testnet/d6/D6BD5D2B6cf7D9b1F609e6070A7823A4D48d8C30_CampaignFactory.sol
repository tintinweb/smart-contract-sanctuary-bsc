...
contract CampaignFactory is ReentrancyGuardUpgradeable, Owned{
    ...
    function setManager(address _newManager) external ownerOnly {
...
contract Campaign is Owned, Whitelist {    
    ...
    function completeCampaign() public ownerOnly {
    ...
    function refundActivate() public ownerOnly {
        refundActive = true;
    }
...
contract ERC721JumpStart is ERC721A, Owned, Whitelist {
    ...
    function setTicketContract(address _ticketContract) public ownerOnly {
...
contract JumpStartTicket is ERC721A, Owned {
    address public admin;
    uint256 public mintLimit;
