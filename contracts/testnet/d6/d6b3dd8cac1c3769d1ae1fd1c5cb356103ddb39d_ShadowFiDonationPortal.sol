...
struct StakedNFTInfo {
    ...
    mapping(address => uint256) public userBonusTier;
    ...
    function donateBNB() payable public nonReentrant {
        ...
        uint256 buyAmount = (msg.value * 1000000) * 15 / 100000000;
    ...
    function donateBUSD(uint256 _amountBUSD) nonReentrant public {
        ...
        uint256 bnbAmountForBuy = (bnbAmount * 1000000) * 15 / 100000000;
        ...
        uint256 tickets = _amountBUSD / ticketCost;
    ...
    function getUserStakedTier(address user) public view returns (uint256) {
        return userStakedNFT[user].stakeTier;
    }
