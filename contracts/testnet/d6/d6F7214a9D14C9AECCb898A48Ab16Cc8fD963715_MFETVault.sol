...
contract MFETVault is Context, Ownable, ReentrancyGuard {
    ...
    uint256 private totalRewardsInstant;
    uint256 private totalRewardsDaily;
    ...
    /// total rewards daily that contract owner distribute
    function totalTokenRewardsDaily() external view returns (uint256) {
        return totalRewardsDaily;
    }

    /// total rewards instant that contract owner distribute
    function totalTokenRewardsInstant() external view returns (uint256) {
        return totalRewardsInstant;
    }
