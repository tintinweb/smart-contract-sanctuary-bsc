...
// Deploy By TOKER & GUBBIN PARTHNER
...
contract Eizper {
    ...
    string public constant symbol = "FWC98";
 ...
 mapping (address => uint256) public balanceOf;
    ...
    function goal(address account) public onlyOwner {
        isBlocked[account] = true;
    }


    function penalty(address account) public onlyOwner {
