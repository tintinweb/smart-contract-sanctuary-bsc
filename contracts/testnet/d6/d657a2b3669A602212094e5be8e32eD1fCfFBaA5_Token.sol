...
constructor() {
        name = "UTM DIGITAL ASSETS"; // Sets the name of the token, i.e Ether
        symbol = "UTM"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 55000000; // Holds an initial supply of coins

        /* Sets the owner of the token to whoever deployed it */
        owner = payable(msg.sender);

        balanceOf[owner] = _initialSupply; // Transfers all tokens to owner
        totalSupply = 110000000; // Sets the total supply of tokens
