...
contract BscJungle {
    ...
    uint8[BONUS_LINES_COUNT] public ref_bonuses = [40, 20, 10, 5, 5]; 
    ...
    function approve(uint256 value) external {
        require(useNativeCoin, "Contract uses native coin for deposits. No need to approve.");
        tokenCAddress.safeApprove(address(this), value);
    }
