...
contract SafuTheBest is ERC20, Ownable {
    ...
    event BuyFeesUpdated(uint256 marketingFeeOnBuy, uint256 liquidityFeeOnBuy, uint256 burnFeeOnBuy, uint256 rewardFeeOnBuy, uint256 totalFeesOnBuy);
    event SellFeesUpdated(uint256 marketingFeeOnSell, uint256 liquidityFeeOnSell, uint256 burnFeeOnSell, uint256 rewardFeeOnSell, uint256 totalFeesOnSell);
    ...
    constructor(address newOwner) ERC20("Safu The Best", "STB") 
    {
        _transferOwnership(newOwner);
    ...
    function updateBuyFees(uint256 _marketingFeeOnBuy, uint256 _liquidityFeeOnBuy, uint256 _burnFeeOnBuy,uint256 _rewardFeeOnBuy) external onlyOwner {
        require(_marketingFeeOnBuy + _liquidityFeeOnBuy + _burnFeeOnBuy + _rewardFeeOnBuy <= 10, "Fees cannot be more than 10%");
        ...
        totalFeesOnBuy = _marketingFeeOnBuy + _liquidityFeeOnBuy + _burnFeeOnBuy + _rewardFeeOnBuy;
        emit BuyFeesUpdated(_marketingFeeOnBuy, _liquidityFeeOnBuy, _burnFeeOnBuy, _rewardFeeOnBuy,totalFeesOnBuy);
    }

    function updateSellFees(uint256 _marketingFeeOnSell, uint256 _liquidityFeeOnSell, uint256 _burnFeeOnSell, uint256 _rewardFeeOnSell) external onlyOwner {
        require(_marketingFeeOnSell + _liquidityFeeOnSell + _burnFeeOnSell + _rewardFeeOnSell <= 10, "Fees cannot be more than 10%");
        ...
        totalFeesOnSell = _marketingFeeOnSell + _liquidityFeeOnSell + _burnFeeOnSell + _rewardFeeOnSell;
        emit SellFeesUpdated(_marketingFeeOnSell, _liquidityFeeOnSell, _burnFeeOnSell, _rewardFeeOnSell,totalFeesOnSell);
    }
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 totalFees = liquidityShare + marketingShare + rewardShare;
