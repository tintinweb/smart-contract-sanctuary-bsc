...
contract PresaleL5 is Ownable {
    ...
    uint256 public tokenPriceBnb = 18181818200; 
     uint256 public tokenPriceBusd = 1000000000000000000 ; // 1
  ...
  /* This will deposit BUSD to Contract */
    // function depositCrypto() payable public returns (bool){
    //     uint256 amount = msg.value;
    //     address userAddress = msg.sender;
    //     emit BusdDeposited(userAddress, amount);
    //     return true;
    // }
 ...
 /* This Function will exchange BUSD to Token */    
    function ExchangeBUSDforToken( uint256 _amount) public {
        ...
        bAmount = ((amount.mul(10 ** uint256(tokenDecimal)).div(tokenPriceBusd)).mul(10 ** uint256(tokenDecimal))).div(10 ** uint256(tokenDecimal));
        tokenExchanged[userAdd] += bAmount;
       
        //  emit BusdDeposited(msg.sender,msg.value);
    }
