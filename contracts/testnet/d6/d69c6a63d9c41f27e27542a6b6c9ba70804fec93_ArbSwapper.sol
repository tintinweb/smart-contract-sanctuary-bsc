...
contract ArbSwapper is Context, Ownable {
    ...
    function estimateProfitability(address buyRouterAddress, address sellRouterAddress, address tokenToArb, uint buyAmountETH) public view returns (uint[] memory totalProfit) {
        ...
        uint[] memory returnParams = new uint[](2);
        returnParams[0] = sellOutput;
        returnParams[1] = buyAmountETH;
