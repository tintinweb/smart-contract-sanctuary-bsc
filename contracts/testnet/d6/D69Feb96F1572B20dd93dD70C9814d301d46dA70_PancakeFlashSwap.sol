...
contract PancakeFlashSwap {
    ...
    function startArbitrage(
        ...
        IERC20(_tokenB).safeApprove(address(PANCAKE_ROUTER), MAX_INT);
        IERC20(_tokenC).safeApprove(address(PANCAKE_ROUTER), MAX_INT);
    ...
    function pancakeCall(
        ...
        (
            ...
            uint256 amount,
            address myAddress
        ) = abi.decode(_data, (address, address, address, uint256, address));
        ...
        // Place Trades
        // uint256 trade1AcquiredCoin = placeTrade(WBNB, BUSD, loanAmount);
        // uint256 trade2AcquiredCoin = placeTrade(BUSD, CAKE, trade1AcquiredCoin);
        // uint256 trade3AcquiredCoin = placeTrade(CAKE, WBNB, trade2AcquiredCoin);
        ...
        console.log("trade1AcquiredCoin: ", trade1AcquiredCoin);
        console.log("trade2AcquiredCoin: ", trade2AcquiredCoin);
        console.log("trade3AcquiredCoin: ", trade3AcquiredCoin);
