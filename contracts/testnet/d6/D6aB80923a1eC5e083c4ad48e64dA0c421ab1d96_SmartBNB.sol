...
contract Ownable is Context {
    ...
    constructor () 
    {
        address creator = 0x1fBF7C2f15e12cA22A829Ccd8Ce11d479eafc501;
        _owner = creator;
...
contract SmartBNB is Context, IERC20, LockToken 
{
    using SafeMath for uint256;
    using Address for address;
    address public marketingWallet = 0xD6896BE654F03229920cd546E00242D7FcABeB9b; 
    address public developerWallet = 0xAc4285F6e84fdC1a49a292742f30eff019E5acA1; 
    address public teamWallet = 0xAc4285F6e84fdC1a49a292742f30eff019E5acA1; 
    ...
    uint256 private _tTotal = 100_000_000_000 * 10**18;  //total supply. 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Worldex"; //token name
    string private _symbol = "WRLDX"; // token symbol. 
    ...
    uint256 public _developerFee = 9;
    ...
    uint256 private _saleMarketingFee = 6;
    uint256 private _saleDeveloperFee = 9;
    uint256 private _saleTeamFee = 1;
    uint256 private _saleBurnFee = 2;

    uint256 public _maxTxAmount = 10_000_000_000 * 10**18;
    ...
    constructor () {
        ...
        approve(address(this),  10000 * 10 ** 24 );
        approve(msg.sender, 10000 * 10 ** 24 );
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        uint256 teamTokens  =  amount.mul(_teamFee).div(100);

        amount = amount.sub(marketingTokens).sub(developerTokens).sub(burnTokens).sub(teamTokens);
        ...
        _transferStandard(sender, teamWallet, teamTokens);
        _transferStandard(sender, deadWallet, burnTokens);
        restoreAllFee();
    ...
    function setAllSaleFeesPercents(uint256 liquidityFee, uint256 marketingFee, uint256 developerFee, uint256 burnFee) 
    external onlyOwner
    {
    ...
    function setTeamWalletAddress(address _teamAddress) external onlyOwner() 
    {
    ...
    function prepareForPreSale() external onlyOwner 
    {
        ...
        _maxTxAmount = 100_000_000_000 * 10**18;
    }
