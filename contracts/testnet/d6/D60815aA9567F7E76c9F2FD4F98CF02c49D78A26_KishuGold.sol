...
contract KishuGold is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'KISHUGOLD';
    string private constant _symbol = '$KISHUGOLD';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000000000000 * 10**_decimals;//equals 1TB tokens
    ...
    //DevWallets
    address public TeamWallet=payable(0x57342724D5147027be372c49015Fd00bd7cb7A9B);
    address public walletTwo=payable(0x57342724D5147027be372c49015Fd00bd7cb7A9B);
    //TestNet
