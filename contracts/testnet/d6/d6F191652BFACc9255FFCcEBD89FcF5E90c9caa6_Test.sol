...
/**
 * Santa Token.
 * Deployed on the Binance Smart Chain (BSC), Santa Token is the currency of Santa Club ecosystem.
...
contract Test is IERC20, Ownable {
    ...
    // Allow users to do transactions before trading enable
    // This is for adding PinkSale presale address
    ...
    event SetEnableAntiBot(bool status);
    ...
    // Enable Trading after adding liquidity to PancakeSwap.
