...
/*
    ...
    Contract Name: SAFUCFGTAX
    Instagram: https://www.instagram.com/cfgninja
    Twitter: https://twitter.com/cfgninja
    Telegram: https://t.me/cfgninjaaudits/6
    Contract Version: 2.06

Dev Notes:
This contract will be part of our SAFU Contract Creation Dapp and will include Free Audit  with it.
...
contract SAFUCFGTax is Context, IERC20, Ownable {
    using Address for address;
    address public constant deadWallet =
        0x000000000000000000000000000000000000dEaD;
    address public constant developerWalletAddress =
        0x935134E77F4109602751864A6Bd60A0D403e6C37;
...
uint8 private _NewDecimals;
uint256 private _NewLiquidityFee;



//end of constructor variables
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = _NewTotalSupply;
    uint256 private _tFeeTotal;

    string private _name = _NewName;
    string private _symbol = _NewSymbol;
    uint8 private  _decimals = _NewDecimals;

    uint256 public _liquidityFee = _NewLiquidityFee;
    ...
    constructor(uint256 _NewTotalSupply1, string memory _NewName1, string memory _NewSymbol1, uint8 _NewDecimals1, uint256 _NewLiquidityFee1) {
 _NewTotalSupply = _NewTotalSupply1;
 
 _NewName = _NewName1 ;
 _NewSymbol = _NewSymbol1;
 _NewDecimals = _NewDecimals1;
 _NewTotalSupply = _NewTotalSupply1;

_NewLiquidityFee = _NewLiquidityFee1;
    ...
    function recoverETHfromContract() public virtual onlyOwner {
        payable(developerWalletAddress).transfer(address(this).balance);
        emit AuditLog(
