...
contract CLIME is Context, IERC20, Ownable {
  ...
  string private _name = "CLIME";
  string private _symbol = "CLIME";
  ...
  uint256 public minNumTokensSellToAddToLiquidity = 50000 * 10**18;
  ...
  constructor(address donationAddress, address uniswapRouter) {
  ...
  function _transferBothExcluded(
    ...
    uint256 tDonation = tOtherFee.mul(_donationFee).div(otherFee);
    ...
    )
  {
    ...
    uint256 tOtherFee = tLiquidity.add(tDonation);
  ...
  function _getOtherFee() private view returns (uint256) {
    uint256 otherFee = _previousLiquidityFee.add(_previousDonationFee);
    return otherFee;
  }
  ...
  function _withdrawBNB(uint256 amount) external onlyOwner {
    require(
      ...
      "withdrawBNB::Insufficient amount"
    );
  ...
  function inCaseTokensGetStuck(
    ...
    require(
      _token != address(this),
      "inCaseTokensGetStuck: Native token transfer is unavailable"
    );
  ...
  function setNumTokensSellToAddToLiquidity(
    ...
    require(
      _numTokensSellToAddToLiquidity >= minNumTokensSellToAddToLiquidity,
      "numTokens should be larger than min value"
    );
