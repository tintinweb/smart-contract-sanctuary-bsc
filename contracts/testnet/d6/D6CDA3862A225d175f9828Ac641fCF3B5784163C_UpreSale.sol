...
contract UpreSale is Ownable {
    ...
    function createTokenLockedWallets(
        ...
        require(
            ERC20Upgradeable(tokenAddress).transfer(timeLockedWallet, tokenAmount),
            "Insufficient balance of presale contract!"
        );
    ...
    //     ERC20Upgradeable(tokenAddress).burn(
    //         ERC20Upgradeable(tokenAddress).balanceOf(address(this))
    //     );
    // }
...
contract TimeLockedWallet {
    ...
    // callable by owner only, after specified time, only for Tokens implementing ERC20Upgradeable
...
contract TimeLockedWalletFactory is ITimeLockedWalletFactory{
        ...
        returns(address wallet)
    {
       ...
       // ERC20Upgradeable _tokenAddress = tokenAddress;
