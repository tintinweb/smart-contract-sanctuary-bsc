...
contract PreSale is Validatable {
    ...
    function buy(uint256 times) external payable {
        ...
        require(times > 0 && boughtAmountOf[_msgSender()] + times <= maxPerUser, "Limit times each user");
