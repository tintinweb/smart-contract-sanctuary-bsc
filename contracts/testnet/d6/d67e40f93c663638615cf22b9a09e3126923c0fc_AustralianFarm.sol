...
contract AustralianFarm is Ownable{
    ...
    function feedOrWatering(uint256 bulidingTokenId,uint256 cropNO)public{
        ...
        require(crop.lastTime + 60 < block.timestamp,"You can't feed or watering it yet");
        ...
        crop.isHarvest = isGet;
        
        userCrops[cropNO] = crop;

        // 是否可以收获
        emit FeedOrWatering(cropNO,isGet);
    }
    ...
    function harvest(uint256 cropNO)public{
        ...
        // 还未成熟
        require(crop.isHarvest,"You can't harvest yet");
