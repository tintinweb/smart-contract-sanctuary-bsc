...
contract theTestToken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"My F Test";
    string private constant _symbol = unicode"MFT";
    uint256 public constant _maxWalletSize = tokenTotalSupply * 27 / 1000;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        uint256 taxAmount=0;
        if (from != owner()) {
              taxAmount = amount.mul(_totalTaxes / 2).div(100);
