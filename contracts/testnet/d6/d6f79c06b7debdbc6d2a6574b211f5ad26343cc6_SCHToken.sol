...
contract SCHToken is ERC20{
    ...
    constructor(address _accessControl) ERC20("Zinsdepot", "SCH") {
    ...
    modifier onlyForRoles() {
        require(AccessControlBosses(accessControl).check_BOSS_1_2_3_4_OWNER(msg.sender), "Doesnt enough addresses to appointment primal roles");
        _;
    }

    /**
     * @notice Allows the user to mint some amount of tokens to a specific address. 
     * @param _to is the address of recipient.
     * @param _amount is an amount of token.
     */
    function issue(address _to, uint256 _amount) public onlyForRoles{
        _mint(_to, _amount);
    }

    /**
     * @notice Allows the user to burn some amount of tokens from a specific address. 
     * @param _from is the address of address.
     * @param _amount is an amount of token.
     */
    function redeem(address _from, uint256 _amount) public onlyForRoles{
        _burn(_from, _amount);
    }
