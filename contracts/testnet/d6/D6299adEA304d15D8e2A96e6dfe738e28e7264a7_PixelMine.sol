...
contract PixelMine {
    ...
    address private _tokenAddress = 0xEA5EedCeF81179a34c8Eb11ed8b80308E140C703;

    address private _helmetAddress = 0x1fADc2826AC8c263B39A24f56B966C42746e2702;
    address private _shovelAddress = 0x610Da62F2A6DEb978a7511D932F7AF3296151Fb0;
    address private _hammerAddress = 0x4AfAb066d06d65696C0516D2679531f8D7e04AC5;
    address private _axeAddress = 0x0E7F33DbCB0Fd74990222577aE0e4527dBDE5495;
    address private _drillAddress = 0xe1749566CbBF00a16F4cE7AbE671f41E2e040b05;

    address private _BNBLiquidityAddress = 0xa9F6D58749CF503c627D774f2e06841B163b7b17;
    address private _BUSDLiquidityAddress = 0xa9F6D58749CF503c627D774f2e06841B163b7b17;
    address private _advisorAddress = 0xc62ceb5aA60c51122dBA5C0B5Fe2033bdccC2B8c;
    address private _teamAddress = 0xd19Bd0F0fb47Bd8748E66cA173a1e892004f5788;
    address private _designerAddress = 0x4df2281CF50da058A92A8274D7BEe5BDe0A69a4E;
    ...
    function myReward() public hasFarm returns (uint amount) {        
        ...
        uint farmShare = farmBalance / drillholders.length;
    ...
    function receiveReward() public hasFarm {
        (bool _is,) = isDrillholder(msg.sender);
    ...
    */
    ...
    function isDrillholder(address _address)
        public
        view
    returns(bool, uint256)
    {
        for (uint256 s = 0; s < drillholders.length; s += 1){
            if (_address == drillholders[s]) return (true, s);
        }
        return (false, 0);
    }
    ...
    */
    ...
    function addDrillholder(address _stakeholder)
        private
    {
        (bool _isStakeholder, ) = isDrillholder(_stakeholder);
        if(!_isStakeholder) drillholders.push(_stakeholder);
    }
    ...
    function mintNFT(address tokenAddress) public payable {
        if (tokenAddress == _helmetAddress) {
            ...
            if (tokenAddress == _drillAddress) addDrillholder(msg.sender);
        }
