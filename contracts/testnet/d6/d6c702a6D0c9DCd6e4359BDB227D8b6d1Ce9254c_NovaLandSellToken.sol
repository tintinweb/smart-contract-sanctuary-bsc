...
contract NovaLandSellToken is Initializable , OwnableUpgradeable{
   ...
   **/
  function buyTokenBNB( address _referrer) public payable onlyNonContract returns (bool) {
    ...
    IERC20Upgradeable(IDO_TOKEN).transfer(msg.sender, sold_amount);
