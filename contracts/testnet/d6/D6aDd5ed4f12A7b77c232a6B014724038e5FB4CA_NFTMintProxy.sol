...
contract NFTMintProxy is Governance, IGegoRuleProxy{
    ...
    event eSetRuleData(uint256 ruleId, uint256 minMintAmount, uint256 maxMintAmount, uint256 costErc20Amount, address mintErc20, address costErc20, bool canMintMaxGrade,bool canMintMaxTLevel,uint256 expiringDuration);
        ...
        onlyGovernance
    {
        ...
        emit eSetRuleData( ruleId, minMintAmount, maxMintAmount, costErc20Amount, mintErc20,  costErc20, canMintMaxGrade, canMintMaxTLevel,expiringDuration);
    }
    ...
    function cost( MintParams calldata params) external override returns (  uint256 mintAmount,address mintErc20 ){
       ...
       (mintAmount,mintErc20) = _cost(params, 0);
    }

    function inject( MintParams calldata params, uint256 oldAmount) external override returns (  uint256 mintAmount,address mintErc20 ){
        require(_factory == INFTFactory(msg.sender)," invalid factory caller");
       (mintAmount,mintErc20) = _cost(params, oldAmount);
    }
    ...
    function _cost( MintParams memory params, uint256 oldAmount) internal returns (  uint256 mintAmount,address mintErc20 ){
