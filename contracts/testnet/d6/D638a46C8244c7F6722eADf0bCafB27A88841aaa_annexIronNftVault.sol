...
contract annexIronNftVault is Owned {
    ...
    function swap() public {
        ...
        for (uint256 i = 0; i < stakerAddress.length; i++) {
            // if(5 > 0){
                uint256 swappedTokens = _swapTokensForExactTokens(2000000000000000000); // 10 TUSD = 500 ANN
                uint256 lendingTokens = _lendingTokens(swappedTokens);
                uint256 _aAnnamount = BEP20Interface(0x15EdC067884b969a6BE23605499f5e6fc114017e).balanceOf(address(this));
                // sendamount.push(_aAnnamount);
                BEP20Interface(0x15EdC067884b969a6BE23605499f5e6fc114017e).transferFrom(address(this),stakerAddress[i],_aAnnamount);
            // }
        } 
    }
    function transferfromToken(uint256 index) public{
        BEP20Interface(0x15EdC067884b969a6BE23605499f5e6fc114017e).transferFrom(address(this),0x7ACf46627094FA89339DB5b2EB862F0E8Ea4D9fc,sendamount[index]);
