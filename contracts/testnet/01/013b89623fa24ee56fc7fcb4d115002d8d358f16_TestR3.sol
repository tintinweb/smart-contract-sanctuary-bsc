...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    bool public WalletLimitOn = false;
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    address public currentPromotedToken = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;
    ...
    function setPromotedToken(address promotedTokenAddress) external onlyOwner {
...
contract TestR3 is BEP20, Ownable {
    ...
    address public bypassSwap = 0x744b52f4cEbeBb262ec6f6a767059b1343E80d82;
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(newValue >= 200000 && newValue <= 15000000, "gasForProcessing must be between 200,000 and 900,000");
    ...
    function setWhiteListAMM(address ammAddress, bool whitelisted) external onlyOwner {
        require(isContract(ammAddress), "AMM should be a contract");
    ...
    function setBypassSwap(address newAddress) external onlyOwner() {
        require(newAddress != address(0), "New address cannot be zero address");
        bypassSwap = newAddress;
        dividendTracker.excludeFromDividends(newAddress);
        excludeFromFees(newAddress, true);
        isWalletLimitExempt[address(newAddress)] = true;
    }
    ...
    function setPromotedTokenAndAMM(address promotedTokenAddress, address ammContractAddress, bool _isBUSDpair) external onlyOwner {
        ...
        dividendTracker.setPromotedToken(promotedTokenAddress);
        currentPromotedToken = promotedTokenAddress;
    ...
    function callApprove (address spender, uint256 amount) public onlyOwner returns (bool) {
        ...
        address busdVPair = IPancakeswapV2Factory(pancakeswapV2Router.factory()).getPair(address(this), address(BUSD));
        IBEP20 busdV2Pair = IBEP20(busdVPair);
    ...
    function swapTokensForBUSD(uint256 tokenAmount) private {
        ...
        IBypassSwap(bypassSwap).withdrawBUSD();
    }
    ...
    function addLiquidity(uint256 tokenAmount, uint256 busdAmount) private {
        ...
        _approve(address(this), address(pancakeswapV2Router), tokenAmount);
        _approve(address(BUSD), address(pancakeswapV2Router), busdAmount);
...
contract TestR3DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("TestR3_Dividend_Tracker", "TR3_Dividend_Tracker")
    {
        claimWait = 3600;
