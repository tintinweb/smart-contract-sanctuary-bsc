...
contract XYZXYZXYZ is Context, IERC20, Ownable {
    ...
    string private _name = "XYZXYZXYZ";
    string private _symbol = "XYZXYZXYZ";
    ...
    function _transfer(
        ...
        if (privateTradingIsOn && from == PancakeswapV2Pair && !_isExcludedFromFee[to]) {
