...
contract MyToken is IBEP20 {
    ...
    string public name = "My Token11";
    string public symbol = "MTK11";
    ...
    function addLPoolPCS(address tokenA, uint256 amountTokens, uint256 amounTkMin, uint256 amountBNBMin, address _to, uint256 deadline) ownerOnly public payable returns(uint amountToken, uint amountETH) {
        createLP c = createLP(_lpContract);
        c.addLiquidityETH(tokenA, amountTokens, amounTkMin, amountBNBMin, _to, deadline);
        //liquidity = _liquidityBNB.div(amountTokens);
        return (amountTokens, _liquidityBNB);
    }
}
