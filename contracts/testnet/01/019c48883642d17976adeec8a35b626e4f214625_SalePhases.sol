...
contract SalePhases is Context, Ownable, Initializable {
    ...
    mapping (address => bool) public _PartialWritten;
    mapping (address => bool) public _PartialWritten2;
    mapping (address => uint256) public _partialWrittenuint;
    mapping (address => uint256) public _partialWrittenuint2;
