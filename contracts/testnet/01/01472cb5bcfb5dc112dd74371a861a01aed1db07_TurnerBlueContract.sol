...
contract TurnerBlueContract is IERC20 { 
    ...
    TokenInfo private _tokenInfo = TokenInfo ( //77,777  100,000
           "Turna Blue", "LMN", 8,  100_000_000, /*10**_decimals;*/ 10_000_000_000_000, //77_777 * _denomination; 
           14, 16,      1, 86400, //24hrs
    ...
    constructor() {      
        ...
        //dex.router = IDexRouter(dex.routeraddr); 
  ...
  DeX dex = DeX(
    ...
    {       
        ...
        if (_msgSender() != address(dex.router) && (to == dex.pairBNB)) {
