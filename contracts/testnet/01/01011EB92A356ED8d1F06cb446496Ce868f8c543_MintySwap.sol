...
contract MintySwap is Context, IERC20, Ownable {
    ...
    function _mint(address account, uint256 amount) internal {
        require(account != address(0), " MINTYS: mint to the zero address");
    ...
    function _burn(address account, uint256 amount) internal {
       require(account != address(0), " MINTYS: burn from the zero address");
       _balances[account] = _balances[account].sub(amount, " MINTYS: burn amount exceeds balance");
