...
contract banking{
    ...
    function addCustomer (
        ...
        customers[data.cid] = customer(data.cid, data.foreName, data.surName, data.dateOfBirth, data.fullAddress, data.nationality, data.idNumber, data.phoneNumber, data.religion, data.occupation, data.fullNameTrustee, data.phoneNumberTrustee, data.relationToTrustee, data.firstAdmin, data.secondAdmin, data.thirdAdmin);
