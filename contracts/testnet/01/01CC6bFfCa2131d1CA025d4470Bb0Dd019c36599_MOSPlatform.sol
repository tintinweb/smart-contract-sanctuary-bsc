...
contract MOSPlatform is TransformableToken {
        ...
        public
    {
        ...
        _GB1 = 1900000000000000000;
        _GB2 = 2004000000000000000;
...
contract TransformableToken is StakeableToken {
        ...
        external
    {
        ...
        do {
            ...
            if (referrerAddr == address(0) || referrerAddr == msg.sender) {
                ...
                referral storage referralList = refferalInfo[msg.sender];
    ...
    //     private
    // {
    //     emit Referral( // (auto-generated event)
    //         upline_address,
    //         msg.sender,
    //         amount,
    //         day
...
contract StakeableToken is GlobalsAndUtility {
        ...
        internal
    {
        ...
        */
        ...
        _emitStakeStart(newStakeId, newStakedHearts, newStakedDays);
...
contract GlobalsAndUtility{
    ...
    uint256 internal constant BPB = BPB_MAX_HEARTS * 100 / BPB_BONUS_PERCENT; //0.15
    ...
    mapping(address => referral) public refferalInfo;
