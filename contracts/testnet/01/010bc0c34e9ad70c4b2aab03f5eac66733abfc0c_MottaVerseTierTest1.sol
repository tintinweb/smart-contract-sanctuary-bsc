...
// MottaVerse Tier Test 1
// Do not buy unless authorized.
...
contract MottaVerseTierTest1 is IBEP20, Ownable {
    ...
    string private _name = "MottaVerse Tier Test 1";
    string private _symbol = "MVTT1";
    ...
    TierTaxes public _buyTaxes = TierTaxes({first: 12, second: 9, third: 6});

    TierTaxes public _sellTaxes = TierTaxes({first: 12, second: 9, third: 6});
    ...
    TaxWallets public _taxWallet =
        TaxWallets({
            dev: 0x1ca2c265074F5E5dc70FD560F530b247eD2D3E61,
            events: 0x323d6D14600c61cCA072bF7Ab4DA1D8Ba97F762C,
            marketing: 0xA51F4678Fe3E89afB8b38D92819B608863a43F97
        });

    MaxLimits public _limits;

    LimitRatios public _limitRatios =
        LimitRatios({wallet: 4, sell: 1, buy: 1, divisor: 200});
    ...
    uint256 private blacklistWindow = 2 hours;
