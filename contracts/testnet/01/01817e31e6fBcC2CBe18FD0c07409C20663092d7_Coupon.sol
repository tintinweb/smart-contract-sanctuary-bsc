...
contract Coupon is ModuleBase, Lockable, SafeMath {
    ...
    function claimCoupon() external lock {
    ...
    function useCoupon(address account) external lock onlyCaller {
    ...
    function addSharedCoupon(address account) external lock onlyCaller {
