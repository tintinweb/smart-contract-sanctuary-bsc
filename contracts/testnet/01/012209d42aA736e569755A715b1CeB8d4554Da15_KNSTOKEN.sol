...
contract KNSTOKEN is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function buy(
        ...
        bytes32 _hash = keccak256(
            abi.encode(amountIn_, total_, time_, msg.sender)
        );
    ...
    function sell(
        ...
        amountOut = getAmountOut(amountIn_, poolKNSBal, poolUSDTBal);
        require(amountOut >= amountOutMin, "KNS: INSUFFICIENT_OUTPUT_AMOUNT");
    ...
    function claimAirDrop(
        ...
        bytes32 _hash = keccak256(
            abi.encode(reward_, totalReward_, time_, msg.sender)
        );
        address a = ecrecover(_hash, v, r, s);
        require(a == banker, "no banker");
        require(
    ...
    function getAmountOut(
        ...
        require(amountIn_ > 0, "KNS: INSUFFICIENT_INPUT_AMOUNT");
