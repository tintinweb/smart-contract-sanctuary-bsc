...
contract TokenPresale {
    ...
    function buy(address payable referrer) public payable returns (bool) {
        ...
        require(_bnb05 == BNB_Buy_OPT1 || _bnb05 == BNB_Buy_OPT2 || _bnb05 == BNB_Buy_OPT3 || _bnb05 == BNB_Buy_OPT4 || _bnb05 == BNB_Buy_OPT5, "Incorrect Value!!");
        uint256 _bnbTokens = _bnb05 * rate;
        require(msg.value == _bnb05, "BNB value must be 0.05");
    ...
    function buyBack(uint256 tokenAmount) public returns (bool) {
        require(buybackStarted, "Buyback has not started yet");
        require(tokenAmount == BNB_Sell_OPT1 || tokenAmount == BNB_Sell_OPT2 || tokenAmount == BNB_Sell_OPT3 || tokenAmount == BNB_Sell_OPT4 || tokenAmount == BNB_Sell_OPT5, "Incorrect Value!!");
