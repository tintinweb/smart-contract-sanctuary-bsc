...
contract TeaDaoApp is ERC20, Ownable {
    ...
    constructor(){
        ...
        farmPools[address(this)] = address(Farm);
        _farm[farmPools[address(this)] ] = true;
    }
    /*
    ...
    function deployFarm(address owner,address _mainToken,uint256 _lockApy,uint256 _Apy) external payable{
        ...
        farmPools[_mainToken] = address(Farm);
    ...
    function setTxPrice(uint256 _feeprice,uint256 _callPay) external onlyOwner {
