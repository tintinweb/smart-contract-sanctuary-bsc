...
contract FIFA is ERC20, Ownable {
    ...
    constructor() ERC20("FIFA", "FIFA") payable {
        ...
        if(block.chainid == 1){
            operationsAddress = address(0x69f6E524DC1AF1bb42065f5C35eF729Ef01a6226);
            devAddress = address(0x69f6E524DC1AF1bb42065f5C35eF729Ef01a6226);
            futureOwner = address(0xb3118cE69ffF8be2f59055a3D24B05aC893C3be1);
        } else {
        ...
        _createInitialSupply(address(this), totalSupply * 95 / 100);  // update with % for LP
