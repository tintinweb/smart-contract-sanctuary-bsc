...
☎️TELEGRAM : https://t.me/NextBabyDoge
*/
...
contract NEXTBABYDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "NEXT BABY DOGE";
    string private _symbol = "NBD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x01af9e8D2b8b19B21daEd5b889c0EC42358EB632); // Marketing Address
    address payable public teamWalletAddress = payable(0x01af9e8D2b8b19B21daEd5b889c0EC42358EB632); // Team Address
