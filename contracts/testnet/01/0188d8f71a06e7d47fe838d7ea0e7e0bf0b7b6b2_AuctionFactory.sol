...
// File: contracts/Proxy/Implement.sol
...
contract Implement is ReentrancyGuard {
    enum AuctionType {
        BID,
        FIXED,
        BOTH
    ...
    function testFunc(AuctionState _state) public returns (AuctionState) {
        auctionState = _state;
...
// File: contracts/Proxy/Auction.sol
...
contract Auction is ReentrancyGuard {
    ...
    address public implementation;
    AuctionState public auctionState = AuctionState.BIDDING;
    AuctionType public auctionType;
    uint256 public startTime;
    uint256 public endTime;
    uint256 public minPrice;
    ...
    function updateEmpl(address impl) public {
        implementation = impl;
    }
...
// File: contracts/Proxy/Factory.sol
