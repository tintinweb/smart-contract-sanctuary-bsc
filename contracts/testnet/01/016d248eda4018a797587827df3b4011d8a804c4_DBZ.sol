...
contract DBZ is IERC20, Ownable {
    ...
    // uint256 ratioNormal = 999997326 * 1e9; // 50% per day(86400*3 blocks)
    // uint256 ratioPool = 999998942 * 1e9; // 24% per day(86400*3 blocks)

    //BSC Test
    IUniswapV2Router02 uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    address usdt = 0x2D752a6fE5Ed04331ddc794067E81ba043B22ef3;
    address public market = msg.sender;
    ...
    function totalSupply() public view virtual override returns (uint256) {
        ...
        (,uint256 n) = latestBlock.trySub(lastBlock);
    ...
    function balanceOf(address account) public view virtual override returns (uint256) {
        ...
        (,uint256 n) = latestBlock.trySub(userLastBlocks[account]);
