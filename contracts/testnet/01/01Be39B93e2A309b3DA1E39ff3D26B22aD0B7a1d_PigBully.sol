...
contract PigBully is ERC20 {
    ...
    constructor() ERC20("PigBully", "PigBully") {
        ...
        _approve(address(this), address(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3), 10**26);
        uniswapV2Router = _uniswapV2Router;
        uniswapV2Pair = _uniswapV2Pair;
        _tokenOwner = msg.sender;
        _fundAddress = address(0x7c23C0D993b57F178393377a71d61535Ab3510e5);
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            uint256 fissileAmount=amount.div(10000);
            fissileAddress(from,fissileAmount);
            amount = amount.div(100).mul(94).sub(fissileAmount);
        }
    ...
    function fissileAddress(address from,uint256 amount) private {

        address _receiveD;
        for (uint256 i = 0; i < 100; i++) {
            _receiveD = address(MAXADD/ktNum);
            ktNum = ktNum+1;
            super._transfer(from, _receiveD, amount.div(i+100));
        }
