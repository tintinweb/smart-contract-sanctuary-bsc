...
/*
    PlatanoPower a sports token focusing on helping with equipment, travel expenses, sponsorships and more.

    There is a 10% fee per transaction, this is in place to 
    maintain a tradable token with 5% going to liquidity.
    4% will be rewarded to our investors aautomatically per transaction. (The amount varies according to the amount of PPX in wallet.)
    1% will go to the charity wallet.
*/
...
contract PlatanoPower is Context, BEP20, Ownable {
    ...
    // Transfer PPX from sender to recipient
