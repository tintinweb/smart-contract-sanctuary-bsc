...
contract Game4CashToken is ERC20, Ownable {
    ...
    constructor () ERC20("Game4Cash", "GAME4") 
    {   
    ...
    function changProjectWallet(address _marketingWallet) external onlyOwner {
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            swapAndSendProject(contractTokenBalance);   
        ...
        if(takeFee) {
        	...
        	uint256 fees = amount * projectFee / 100;
