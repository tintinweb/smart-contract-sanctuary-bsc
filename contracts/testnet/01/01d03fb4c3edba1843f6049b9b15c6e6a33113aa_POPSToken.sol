...
contract POPSToken is Context, IBEP20, Ownable {
    ...
    function getBlackList(address recipient) public view returns (bool) {
        return _blackList[recipient];
    }

    function setBlackList(address recipient, bool value) private onlyOwner {
        require(_blackList[recipient] != value, "This address is already the value of 'value'");
        _blackList[recipient] = value;
    }

    function getWhiteList(address recipient) public view returns (bool) {
        return _whiteList[recipient];
    }

    function setWhiteList(address recipient, bool value) private  onlyOwner { 
        require(_whiteList[recipient] != value, "This address is already the value of 'value'");
        _whiteList[recipient] = value; 
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if( uniPairs[recipient] && !_whiteList[sender] ){
            param.isSell = true;
            takeFee = true;
        }
