...
contract OG_Token is Context, IERC20, Ownable {
    ...
    string private _name = "OG Token11";
    string private _symbol = "OG11";
    ...
    // Team Wallet 0xE86cc8E0fd53B912Dac2Ad68986Cee3e3A7B8d02                               -  10%
    ...
    // Launch on PANCAKESWAP + Presale 0xBDAF27BFB4E89449bf0aae5eAa3A70f275aEc9e7           -  25.04%
    ...
    constructor (address _BUSD)  {
        ...
        wallets = [0x6948E7B59968221B30CeC65c70F57c8E196554f4,0xE86cc8E0fd53B912Dac2Ad68986Cee3e3A7B8d02,0x723d6d58aA27E822fF6dfbAe66B35d96F7821A32,
            ...
            0x7fFf840D4f4daeef103907640dd0D0EF5BE4560d, 0xc425438ABD4cF1eC211818e8b76737B61d7a8920];
    ...
    function initialize() internal {
        ...
        uint16[8] memory distributionRate = [2500,1000,700,500,1000,2504,1600,196];


      for(uint i = 0; i < wallets.length; i++){
        require(wallets[i] != address(0),"Invalid wallet address");
        uint256 tTransferAmount = (_tTotal.mul(distributionRate[i]).div(10000)).mul(currentRate);
        _rOwned[wallets[i]] = tTransferAmount;
        excludeFromReflection(wallets[i]);
        _isExcludedFromFee[wallets[i]] = true;

        emit Transfer(address(0), wallets[i], tokenFromReflection(tTransferAmount));
      } 
    }
