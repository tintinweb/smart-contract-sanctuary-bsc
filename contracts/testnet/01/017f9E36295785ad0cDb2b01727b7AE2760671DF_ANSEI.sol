    ...
    <  >      |(,,) )__)
     ...
     | \____(      )___) )___
      \______(_______;;; __;;;
            ...
            Website: https://ansei-token.com
            Twitter: https://twitter.com/anseitoken
 Telegram Newspaper: https://t.me/ansei_token
  Telegram Comunity: https://t.me/ansei_community
...
contract ANSEI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(address[] memory e) ERC20("Ansei Token", "ANS") {
        ...
        buyMarketingFee = _buyMarketingFee / 10;
        buyLiquidityFee = _buyLiquidityFee / 10;
        buyBurnFee = _buyBurnFee / 10;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyBurnFee;

        sellMarketingFee = _sellMarketingFee / 10;
        sellLiquidityFee = _sellLiquidityFee / 10;
        sellBurnFee = _sellBurnFee / 10;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellBurnFee;

        marketingWallet = address(0x867775579528C426D7652001ac7Bc3F9aDA18541);
