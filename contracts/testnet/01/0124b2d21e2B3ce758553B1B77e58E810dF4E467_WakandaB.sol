...
/*
    ...
    3% fee automatically distributed to all holders // SHOULD BE REMOVED
    ...
    When buy token:
    5% fee automatically move to donation wallet. pancake
...
contract WakandaB is Context, IBEP20, Ownable {
    ...
    address private _wakandaInvestmentFund = 0xaA93f395d7195bB3ACCE7251E7b06f3029fA6FCC;
    address private _marketingWalletAddress = 0x8cB6520aF3e5A3cAC64c1fDCBcF3173Dbbb126D6;
    address private _wakandaDevWalletAddress = 0xDe496389f08e4Def9a19fD595871c33a7226d945;
    address private _teamWalletAddress = 0x83E32528D3765775a5b794Be2122bb53afb25F1b;
    ...
    constructor () {
        ...
        _isExcludedFromFee[_wakandaInvestmentFund] = true;
        _isExcludedFromFee[_marketingWalletAddress] = true;
        _isExcludedFromFee[_wakandaDevWalletAddress] = true;
    ...
    function _takeFundOrBurn(address sender, address recipient, uint256 tFundOrBurn) private {
        ...
        if (sender.isContract() != true && recipient.isContract() != true) {
            ...
            _rOwned[_marketingWalletAddress] = _rOwned[_marketingWalletAddress].add(rFundOrBurn);
            if(_isExcluded[_marketingWalletAddress])
                _tOwned[_marketingWalletAddress] = _tOwned[_marketingWalletAddress].add(tFundOrBurn);
            }
    }
    ...
    function _takeDev(uint256 tDev) private {
        uint256 currentRate =  _getRate();
        uint256 rDev = tDev.mul(currentRate);
        _rOwned[_wakandaInvestmentFund] = _rOwned[_wakandaInvestmentFund].add(rDev);
        if(_isExcluded[_wakandaInvestmentFund])
            _tOwned[_wakandaInvestmentFund] = _tOwned[_wakandaInvestmentFund].add(tDev);
    }
