...
contract PresaleContract is Crowdsale, AllowanceCrowdsale, TimedCrowdsale {
        ...
        public
    {
        ...
        require(_maxContribution > 0, "Maximum contribution must be greater than zero");
        require(_maxContribution >= _minContribution, "Maximum contribution must be greater than or equal to minimum contribution");
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        super._preValidatePurchase(beneficiary, weiAmount);
        require(weiAmount >= minContribution, "Wei amount is below the minimum contribution");
        require(weiAmount <= maxContribution, "Wei amount is above the maximum contribution");
