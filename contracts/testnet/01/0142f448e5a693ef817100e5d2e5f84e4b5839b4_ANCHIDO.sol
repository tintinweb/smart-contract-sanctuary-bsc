...
contract ANCHIDO {
    ...
    function setP1FinishTime(uint256 _p1FinishTime) public {
        require(msg.sender == contractOwner, "Must be owner");
        p1FinishTime = _p1FinishTime;
    }

    function setP2FinishTime(uint256 _p2FinishTime) public {
        require(msg.sender == contractOwner, "Must be owner");
        p2FinishTime = _p2FinishTime;
    }
    ...
    function setDayPeriod(uint256 _dayPeriod) public returns (bool) {
        require(msg.sender == contractOwner, "Must be owner");
