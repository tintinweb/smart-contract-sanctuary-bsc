...
contract PanGuToken is ERC20, Ownable {
    ...
    address public fistToken = 0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb; 
    ...
    constructor(
        ...
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), fistToken);

        uniswapV2Router = _uniswapV2Router;
        uniswapV2Pair = _uniswapV2Pair;

        marketingWalletAddress = marketingWalletAddr_;
        dividendTracker = new TokenDividendTracker(uniswapV2Pair, fistToken);
   ...
   function setDeadFee(uint256 val) public onlyOwner {
    ...
    function _transfer(
        ...
        if (openTime == 0 || openTime > block.timestamp){
            require(_isExcludedFromFees[from] || _isExcludedFromFees[to], "waiting");
        }
