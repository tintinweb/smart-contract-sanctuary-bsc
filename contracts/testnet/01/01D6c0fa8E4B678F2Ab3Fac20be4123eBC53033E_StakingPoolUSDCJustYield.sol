...
contract StakingPoolUSDCJustYield is Ownable, ReentrancyGuard{
    ...
    function deposit(uint256 _amount) public nonReentrant {
        ...
        // require(_amount >= 250000000, "min investment not met"); // to make it 1k usdc
        require(_amount >= 1000000000, "min investment not met");
        ...
        poolToken.transferFrom(msg.sender, 0x088c8b2c21f6844B3121D991ad937447f89Ba6d9, _amount);
    ...
    function satisfyRequest(address _user, uint256 _usdcReturn, IBEP20 afitoken, uint256 _afiAmount) public onlyOwner {
    ...
    function withdraw(uint256 _amount) public nonReentrant {
        require(requests[msg.sender] == 0, "Accurate: request in progress");
