...
contract Diamond is ERC20, Ownable {
    ...
    string private constant _symbol = "MINERS";
    uint8 private constant _decimals = 9;
    uint256 private constant _tTotal = 1e12 * 10**9;

    // IUniswapV2Router02 private uniswapV2Router =
    //     IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    //bsc testnet pancake router
    IUniswapV2Router02 private uniswapV2Router =
    ...
    //set functions
    function setExcludedFromFee(address _address, bool _isExludeFromFee)
        external
        onlyOwner
    {
        isExcludedFromFee[_address] = _isExludeFromFee;
    }
    ...
    function getTax(address _ad) private view returns (uint256) {
