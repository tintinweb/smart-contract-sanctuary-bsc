...
interface IStakingRewardsV3 {
    ...
    function migrateToLocker(address user, uint256 amount) external;
...
contract KalmarStaking is IStakingRewardsV3 , ReentrancyGuard, Initializable {
    using SafeMath for uint256;
    ...
    function migrateToLocker(address user, uint256 amount) public override
        nonReentrant
        updateReward(user)
        onlyWhitelistStake
        isNotEmergencyStop
