...
contract NewDefinaCard is ERC721EnumerableUpgradeable, OwnableUpgradeable, NewDefinaCardEventsAndErrors {
    ...
    function tokenURI(uint256 tokenId_) public view virtual override returns (string memory) {
        string memory baseURI = "https://hero-api.defina.finance/cards/";
        return string(abi.encodePacked(baseURI, heroIdMap[tokenId_].toString(), '_', rarityMap[tokenId_].toString()));
    }
}