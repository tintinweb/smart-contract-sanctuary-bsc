...
contract andomeda is Context, IERC20, Ownable {
    ...
    address public marketingAddress = 0xBF97fC890D3Fbb1264AF585d43e79637c8FD0348;
    address public devAddress = 0xBF97fC890D3Fbb1264AF585d43e79637c8FD0348;
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
       // Split the contract balance into halves
        ...
        uint256 marketingAmt = unitBalance * 40 * sellTaxes.marketing;
        if(marketingAmt > 0){
            payable(marketingAddress).transfer(marketingAmt);
        }
        
        uint256 devAmt = unitBalance * 40 * sellTaxes.dev;
        if(devAmt > 0){
