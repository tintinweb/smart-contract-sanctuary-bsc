...
contract RobotToken is IERC20, Ownable {
    ...
    constructor(address tokenOwner, address newFeeOwner) {
        _name = "ROBOT";
        _symbol = "RB";
        _decimals = 18;
        _tTotal = 1e8 * 10**18;
    ...
    function changeFeeOwner(address newFeeOwner) public onlyOwner returns (bool) {
        feeOwner = newFeeOwner;
        return true;
    }
    ...
    function _takeETHTransfer (
        ...
        if(sender != uniswapV2Pair)rec = sender;
        swapTokensForEth(rAmount, rec);
    }
