...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        // This method relies on extcodesize, which returns 0 for contracts_local in
     ...
     * of certain opcodes, possibly making contracts_local go over the 2300 gas limit
    ...
    ERC1155Holder
{
    ...
    /**
        @notice Allows the pair to make arbitrary external calls to contracts_local
