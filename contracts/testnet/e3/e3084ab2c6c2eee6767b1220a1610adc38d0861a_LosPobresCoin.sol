...
contract LosPobresCoin is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'LOS POBRES COIN';
    string  private constant _SYMBOL = 'LPO';
    ...
    uint256 private _tTotal = 300000000 * _DECIMALFACTOR;
    ...
    uint256 private    _BURN_FEE = 50;
    uint256 private _MARKETING_FEE = 450;
    uint256 private constant _MAX_TX_SIZE = 300000000 * _DECIMALFACTOR;
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0xBF2fFeB3244AD217FF4b3ca809918Af945A66Ccc, 'We can not exclude Uniswap router.');
    ...
    function setAsMarketingAccount(address account) external onlyOwner() {
        require(account != 0x93898eC4f01882fA91AEeda1513c0a04b29ed339, 'The Uniswap router can not be the Marketing account.');
    ...
    function BurnPercent(uint256 burnFee) external onlyOwner() {
        _BURN_FEE = burnFee;
    }
    
    function MarketingPercent(uint256 MarketingFee) external onlyOwner() {
