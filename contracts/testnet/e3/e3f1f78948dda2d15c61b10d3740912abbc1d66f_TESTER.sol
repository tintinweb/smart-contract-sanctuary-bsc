...
contract TESTER is Context, IERC20, Ownable {
   ...
   string private WebsiteUrl = 'https://leye.io';
   string private TelegramUrl = 'https://t.me/leyeio/';
   string private TwitterUrl = 'https://twitter.com/leye_io/';
   string private MediumUrl = 'https://medium.com/@leye.io';
   string private GithubUrl = 'https://github.com/leyeio';
   string private TiktokUrl = 'https://tiktok.com/leyeio';
   string private WhitePaperUrl = 'https://leye.io/whitepaper.pdf';
   string private LeyeSwapUrl = 'https://swap.leye.io';
    ...
    uint256 public _marketingLiquifyFee = 1;
    ...
    uint256 public _maxTxAmount = 19000000000000 * 10**18;
    ...
    function setOurLinks(
        ...
        WebsiteUrl = SetWebsite;
        TelegramUrl = SetTelegram;
        TwitterUrl = SetTwitter;
        MediumUrl = SetMedium;
        GithubUrl = SetGithub;
        TiktokUrl = SetTiktok;
        WhitePaperUrl = SetWhitePaper;
        LeyeSwapUrl = SetLeyeSwap;
    }

    function OurLink()public view returns (
    ...
    function LeyeFees() public view returns(
    ...
    **/
    ...
    function FeelessdayLeye() external onlyOwner {
        ...
        _burnFee = 0;
        _previousBurnFee = 0;
        _maxTxAmount = 19000000000000 * 10**9;
