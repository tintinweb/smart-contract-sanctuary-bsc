...
contract Market is Context, Ownable {
    ...
    mapping(uint256 => address) private idAddr; // todo tokenID Owner
    mapping(uint256 => uint256) private idPrice; // todo tokenID Price
    mapping(uint256 => bool) private isSell; // todo tokenID true/false
    mapping(address => uint256[]) private sellOrder; // todo tokenID already Sell .Order List
    mapping(address => mapping(uint256 => uint256)) private sellOrderPrice; // todo tokenID already Sell .Order List
