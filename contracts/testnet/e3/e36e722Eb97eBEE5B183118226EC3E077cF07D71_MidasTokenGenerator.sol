...
contract MidasTokenGenerator is Initializable {
    ...
    function initialize() public initializer {
        ...
        creationTokenPrice = 50000000000000000000; // 50$
        owner = msg.sender;
    ...
    function createNewToken(
        ...
        if (
            ...
            if (_isPayingWithNativeCurrency) {
                uint256 requiredEthAmount = getRequiredEthAmount(network);
    ...
    function swapBnbForUSD(uint256 _amount) private {
        ...
        uint256 amountOutIn = pcsV2Router.getAmountsOut(_amount, path)[0];
