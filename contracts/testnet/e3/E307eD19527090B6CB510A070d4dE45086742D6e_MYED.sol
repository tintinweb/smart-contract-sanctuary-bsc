...
contract MYED is ERC20, Ownable {
    ...
    constructor () ERC20("MyEducation", "MYED") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xAd1aA14523Cbc1481A34b1057281cCEa24b74535;
    ...
    function updateBuyFees(uint256 _feeOnBuy) external onlyOwner {
        ...
        require(_feeOnBuy <= 2, "Total Fees cannot exceed the maximum");
    ...
    function updateSellFees(uint256 _feeOnSell) external onlyOwner {
        ...
        require(_feeOnSell <= 2, "Total Fees cannot exceed the maximum");
