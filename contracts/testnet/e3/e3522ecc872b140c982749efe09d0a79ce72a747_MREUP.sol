...
contract MREUP is BEP20 {
  ...
  uint256 public liquidityShare = 500;
  ...
  function setTaxes(uint256 newBuyTax, uint256 newSellTax, uint256 newTransferTax) external onlyOwner {
    require(newBuyTax <= 300 && newSellTax <= 300 && newTransferTax <= 100, "Too high taxes");
    buyTax = newBuyTax;
    sellTax = newSellTax;
