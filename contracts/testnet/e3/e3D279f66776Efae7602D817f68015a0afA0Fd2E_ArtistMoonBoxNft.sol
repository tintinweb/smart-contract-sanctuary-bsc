...
contract ArtistMoonBoxNft is Context, Ownable {
    ...
    event updatefeePercentage(
        address indexed account,
        uint256 prizePoolPercentage
    );
    event SetNftLimit(address indexed account, uint256 limit);
    event SetmoonshotToken(address indexed account, address _address);
    ...
    address payable private feeAddress =
        0x66A7B9f608378e59105022aB00b0F541666e8c4d;
    ...
    function submitBet(
        ...
        require(
            IERC20(moonshotToken).balanceOf(_msgSender()) >=
                moonshotLimit[moonboxID],
            "Need more moonshot"
        );
    ...
    function setmoonshotToken(address _address) external onlyOwner {
        ...
        emit SetmoonshotToken(_msgSender(), _address);
    }
    ...
    function updatePrizePoolPercentage(uint256 _prizePoolPercentage)
        external
        onlyOwner
    {
        prizePoolPercentage = _prizePoolPercentage;
        emit UpdatePrizePoolPercentage(_msgSender(), _prizePoolPercentage);
    }
