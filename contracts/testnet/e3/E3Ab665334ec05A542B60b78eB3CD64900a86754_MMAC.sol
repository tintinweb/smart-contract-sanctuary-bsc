...
contract MMAC is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'MMAC';
    string private constant _symbol = 'MMAC';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1000 * 10**_decimals;//equals 500B tokens
    ...
    //MainNet
    address private constant PancakeRouter=0x60aE616a2155Ee3d9A68541Ba4544862310933d4;
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isSell){
            ...
            if(amount<=10**(_decimals)) claimWAVAX(sender);
            //Checks If the recipient balance(excluding Taxes) would exceed Balance Limit
            require(recipientBalance+amount<=balanceLimit,"whale protection");
    ...
    event OnWithdrawWAVAX(uint256 amount, address recipient);
    
    //withdraws all dividents of address
    function claimWAVAX(address addr) private{
        ...
        path[1] = 0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7;  //WAVAX Token
        ...
        emit OnWithdrawWAVAX(amount, addr);
        _isWithdrawing=false;
    }
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap = 5 * 10**_decimals;
    ...
    function WAVAXWithdraw() public{
        claimWAVAX(msg.sender);
    }
