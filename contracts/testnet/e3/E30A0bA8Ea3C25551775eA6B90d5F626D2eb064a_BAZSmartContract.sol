...
contract BAZSmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Retest with burn";
   ...
   function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
    ...
    function takeTaxes(address from, address to, uint256 amount) internal returns (uint256) {
        ...
        uint256 currentFeeLiqudity;
        uint256 currentFeeReward;
        uint256 currentFeeMarketing;
        uint256 currentFeeDev;
        */
    
        if (lpPairs[from]) {
            currentFeeBurn = _buyTaxes.totalSwap - _buyTaxes.burn;
             /**
            
            currentFeeLiqudity = _buyTaxes.totalSwap - _buyTaxes.liquidity;
            currentFeeReward = _buyTaxes.totalSwap - _buyTaxes.reward;
            currentFeeMarketing = _buyTaxes.totalSwap - _buyTaxes.marketing;
            currentFeeDev = _buyTaxes.totalSwap - _buyTaxes.dev;
            */
            currentFee = _buyTaxes.totalSwap;
            
        } else if (lpPairs[to]) {
            currentFeeBurn = _sellTaxes.totalSwap - _sellTaxes.burn;
             /**
            
            currentFeeLiqudity = _sellTaxes.totalSwap - _sellTaxes.liquidity;
            currentFeeReward = _sellTaxes.totalSwap - _sellTaxes.reward;
            currentFeeMarketing = _sellTaxes.totalSwap - _sellTaxes.marketing;
            currentFeeDev = _sellTaxes.totalSwap - _sellTaxes.dev;
            */
            currentFee = _sellTaxes.totalSwap;
        } else {
            
            currentFeeBurn = _transferTaxes.totalSwap - _transferTaxes.burn;
            /** 
            currentFeeLiqudity = _transferTaxes.totalSwap - _transferTaxes.liquidity;
            currentFeeReward = _transferTaxes.totalSwap - _transferTaxes.reward;
            currentFeeMarketing = _transferTaxes.totalSwap - _transferTaxes.marketing;
            currentFeeDev = _transferTaxes.totalSwap - _transferTaxes.dev;
            */
        ...
        /** 
        uint256 feeAmountLiquidity = amount * currentFeeLiqudity / masterTaxDivisor;
        uint256 feeAmountReward = amount * currentFeeReward / masterTaxDivisor;
        uint256 feeAmountMarketing = amount * currentFeeMarketing / masterTaxDivisor;
        uint256 feeAmountDev = amount * currentFeeDev / masterTaxDivisor;
        */
        ...
        //emit Transfer(from, to, feeAmountLiquidity + feeAmountReward + feeAmountMarketing + feeAmountDev);
