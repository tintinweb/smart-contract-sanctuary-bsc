...
contract ContractWolfTokenGen1 is ERC20, Ownable {
    ...
    address private marketingWallet = 0xAB1aC10B33022DA6B9b03Fc358b444a1F0ce7eb8;
    address private devWallet = 0xAB1aC10B33022DA6B9b03Fc358b444a1F0ce7eb8;
    ...
    constructor(address routerAdd, address serviceFeeReceiver) ERC20("TEST", "TST") payable {
        _tokengeneration(msg.sender, 1231 * 10**decimals());
