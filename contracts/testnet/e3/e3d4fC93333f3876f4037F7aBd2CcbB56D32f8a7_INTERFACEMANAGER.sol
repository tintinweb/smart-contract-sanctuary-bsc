...
pragma solidity ^0.8.16;
contract INTERFACEMANAGER is ERC20, Ownable {
    using SafeMath for uint256;
    uint256 public chainId;
    uint256 public currentVersion = 0;
    address public currentInterface;

    mapping (address => address) public tokenInterface;
    mapping (address => uint256) public interfaceVersion;

    constructor() ERC20("INTERFACEMANAGER", "INTERFACEMANAGER") {
        chainId = block.chainid;
    }

    function setNewDeployment(address interfaceAddress) public onlyOwner{
        currentVersion = currentVersion.add(1);
        interfaceVersion[interfaceAddress]=currentVersion;
        currentInterface = interfaceAddress;
    }
    

    function setNewToken(address tokenAddress) public {
        require(interfaceVersion[msg.sender]>0,"FUCK");
        tokenInterface[tokenAddress]= msg.sender;
    }
}