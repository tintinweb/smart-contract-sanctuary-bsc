...
contract Presale is Initializable {
    ...
    function initialize(address token_addr, address dai_addr) public initializer {
  ...
  function unpause() onlyowner public {
    ...
    function Claim() public claimAllowed 
    {
        require(boughtAndPaid[msg.sender], "You have not bought !" );
        boughtAndPaid[msg.sender] = false;
        token.transferFrom(address(this),msg.sender, limitperwallet);
    }
    ...
    function WithdrawVenom(uint256 amount) public onlyowner
    {
