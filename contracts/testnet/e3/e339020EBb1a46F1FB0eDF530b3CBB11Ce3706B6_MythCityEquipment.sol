...
contract MythCityEquipment is ERC721 {
    ...
    function changeEquipment(string[] calldata _url, uint256[] calldata _id)
        external
        isWhitelisted
    {
...
contract MythCityMods is ERC721 {
    ...
    function changeMod(string[] calldata _url, uint256[] calldata _id)
        external
        isWhitelisted
    {
        require(_url.length == _id.length, "The lists need to be same length");
...
contract MythCosmetic {
    ...
    function emitCosmeticAdded(
        ...
        degenContract.emitCosmeticAdded(_layerType, _layerId, _imageURL);
    }
        ...
        onlyOwner
    {
        require(_url.length == _id.length, "The lists need to be same length");
        for (uint256 i = 0; i < _id.length; i++) {
            emitCosmeticAdded(0, _id[i], _url[i]);
        ...
        onlyOwner
    {
        require(_url.length == _id.length, "The lists need to be same length");
        for (uint256 i = 0; i < _id.length; i++) {
            emitCosmeticAdded(1, _id[i], _url[i]);
        ...
        onlyOwner
    {
        require(_url.length == _id.length, "The lists need to be same length");
        for (uint256 i = 0; i < _id.length; i++) {
            emitCosmeticAdded(2, _id[i], _url[i]);
        ...
        onlyOwner
    {
        require(_url.length == _id.length, "The lists need to be same length");
        for (uint256 i = 0; i < _id.length; i++) {
            emitCosmeticAdded(3, _id[i], _url[i]);
        ...
        onlyOwner
    {
        require(_url.length == _id.length, "The lists need to be same length");
        for (uint256 i = 0; i < _id.length; i++) {
            emitCosmeticAdded(4, _id[i], _url[i]);
        ...
        onlyOwner
    {
        require(_url.length == _id.length, "The lists need to be same length");
        for (uint256 i = 0; i < _id.length; i++) {
            emitCosmeticAdded(5, _id[i], _url[i]);
        ...
        onlyOwner
    {
        require(_url.length == _id.length, "The lists need to be same length");
        for (uint256 i = 0; i < _id.length; i++) {
            emitCosmeticAdded(6, _id[i], _url[i]);
...
contract MythCityWeapons is ERC721 {
    ...
    function changeWeapon(string[] calldata _url, uint256[] calldata _id)
        external
        isWhitelisted
    {
        require(_url.length == _id.length, "The lists need to be same length");
...
contract MythCityWeaponSkins is ERC721 {
    ...
    function changeSkinURLs(string[] calldata _url, uint256[] calldata _id)
        external
        isWhitelisted
    {
        require(_url.length == _id.length, "The lists need to be same length");
