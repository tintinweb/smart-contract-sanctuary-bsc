...
contract SafemoonFork is Context, IERC20, Ownable {
    ...
    string private _name = "RecycleToken";      //CHANGE_REQUIRED: name of token
    string private _symbol = "RCY";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
