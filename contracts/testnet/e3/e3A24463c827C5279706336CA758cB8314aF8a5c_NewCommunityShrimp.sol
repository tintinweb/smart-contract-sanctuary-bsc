...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //DOGE
...
contract NewCommunityShrimp is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "New Community Shrimp";
    string constant _symbol = "NcShrimp";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x997c85fE83489e364b0df3d1B62be6A2a8c3d98F;
