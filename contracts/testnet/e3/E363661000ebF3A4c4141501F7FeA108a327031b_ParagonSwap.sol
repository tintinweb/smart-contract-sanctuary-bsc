...
contract ParagonSwap is Paragon {
        ...
        address _admin)
    {
        ...
        admins[dev]   = true; //<------------------------------------- add dev to admins
        admins[admin] = true; //<------------------------------------- add admin to admins
    ...
    function setAdmin(address atAddress, bool toValue) external onlyAdmin {
        admins[atAddress] = toValue;
    }
    ////////////////////////////////////////////////////////////////////////
}