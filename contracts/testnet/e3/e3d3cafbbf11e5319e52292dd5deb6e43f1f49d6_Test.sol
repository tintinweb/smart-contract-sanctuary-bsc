...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // CA of BEP20 Reward Token
...
contract Test is IBEP20, Auth { // Token Name
    using SafeMath for uint256;

    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x1F4239e31898bD8f97de2e858aFd22828c8C68fA; // Dev Wallet Address

    string constant _name = "Test"; // Token Name
    string constant _symbol = "TST"; // Token Symbol
