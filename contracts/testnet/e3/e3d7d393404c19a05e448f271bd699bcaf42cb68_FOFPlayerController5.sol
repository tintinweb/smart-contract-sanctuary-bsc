...
contract FOFPlayerRaceQuery is Ownable {
    ...
    constructor() {
        ...
        FPRD = FOFPlayerRaceData(0x4a017320Ac65649C922aa67354cA410B94564807);
...
contract FOFPlayerController5 is Ownable {
    ...
    constructor() {
        ...
        // FPC2 = FOFPlayerController2(payable(0xAf2f0af19158EE7977381Cb787a73744509A101F));
        // FPRD = FOFPlayerRaceData(0xDBa355CCa2Bf9CD1AdB70f63e2634576487D5c33);
        // FPRQ = FOFPlayerRaceQuery(0xFe3f8d4aeEF050dB04B6F53959C37912F2ea5d23);
        ...
        FPRQ = FOFPlayerRaceQuery(0x943D086f666de2a5DaB777591FF24fAecdf2AF46);
        FOF = ERC20(0x22Fa8506fe5E6859d3896Da570fE33FC89ab458a);
    }
    ...
    function raceSettlement(uint256 raceType) public onlyController {
        require(raceType == 2 || raceType == 3,"You entered the wrong race type");

        uint256 raceId = FPRD.raceIds(raceType);
        ...
        if(raceType == 2 ){
            FPRD.setRaceTime(raceType, raceId + 1, FPRD.raceTime(raceType,raceId) + 30 days);
        }else{
            FPRD.setRaceTime(raceType, raceId + 1, FPRD.raceTime(raceType,raceId) + 90 days);
        }
    }
