...
contract METAHUBToken is IBEP20, TokenAuth {
  string public constant name = "MetaHub";
  string public constant symbol = "MEH";
  uint public constant decimals = 18;

  uint public constant stakingAllocation = 300e24;
  uint public constant marketingAllocation = 25e24;
  uint public constant seedSaleAllocation = 75e24;
  uint public constant liquidityPoolAllocation = 25e24;

  uint public constant maxSupply = 500e24;
  ...
  constructor(address _liquidPoolAddress) TokenAuth(msg.sender, _liquidPoolAddress) {
  }
  ...
  function releaseStakingAllocation(address _userAddress, uint _amount) external onlyGameContract returns (bool) {
    require(stakingReleased + _amount <= stakingAllocation, "Max staking allocation had released");
    _mint(_userAddress, _amount);
    stakingReleased = stakingReleased + _amount;
    return true;
  }
