...
contract MEDEX is MedexERC20 {
    ...
    function calculateFeeAmount(
        ...
        uint256 tokenfeeCal = (amount * tokenfee) / 1e8;
        uint256 feeamount;
        if (input == 1) {
            feeamount = amount - fees-tokenfeeCal;
        } else {
            feeamount = amount + fees+tokenfeeCal;
        }
        ...
        if (tokenIN == 1) {
            ...
            tokenfeeCal = (amount * tokenfee) / 1e8;
            if (input == 1) {
                feeamount = amount - fees-tokenfeeCal;
            } else {
                feeamount = amount + fees+tokenfeeCal;
    ...
    function calculateFeeAmountTest(
        uint256 tokenIN,
        uint256 amountIn,
        uint256 input
        ...
        return (tokenfee,amount,feeamount,fees);
    }
