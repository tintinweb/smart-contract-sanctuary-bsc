...
contract BlockWorld is ERC20, Ownable {
//custom
...
//address
    ...
    address public marketingAddress = 0x3898D34fc43e93Fe4487F759993A20852aadC7e7;
    address public devAddress = 0x0adf3803A0f64B35552edF8f94C622c0926cf5Ad;
    address public liquidityAddress = 0x1D11C781066f3592fA8A6EAEF0B7b1203E381393;
//uint
    uint public minimumWeiForTokenomics = 1 * 10**16; // 0.01 BNB
    uint public buyMarketingFee = 5;
    uint public sellMarketingFee = 5;
    uint public buyDevFee = 1;
    uint public sellDevFee = 1;
    uint public buyLiquidityFee = 5;
    uint public sellLiquidityFee = 5;
...
// constructor
    constructor() ERC20("BlockWorld", "WRD") {
...
// operational functions
    ...
    function isThisBlockWorld() public pure returns(bool) {
        //heheboi.gif
        return true;
    }
}