...
contract GulfStacking is ReentrancyGuard, Ownable{
    ...
    function calculateRewards(address wallet, uint256 pendingMonth)internal view returns(uint256){
        ...
        uint256 percentage  = ((rewardPer * 100) / amount ); 
    ...
    function myStackingAmount() public view returns(uint256) {
        return (stackingUserDeatil[msg.sender].amountStaked > 0) ? stackingUserDeatil[msg.sender].amountStaked : 0 ;
    }
