...
// This contract generates ENMT tokens and registers them in the Digichain ENMT MintFactory.
...
contract MintFactory is Ownable {
    ...
    /**
     * @notice returns true if the token is a valid ENMT token generated by the Digichain Minter
     */
