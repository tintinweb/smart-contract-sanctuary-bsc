...
contract DividendPayingToken is IERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
...
contract BABYTOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    function initialize(
        ...
        DividendPayingToken.initialize(
            rewardToken_,
            "DIVIDEND_TRACKER",
            "DIVIDEND_TRACKER"
        );
...
contract StandardBabyTokenTest is IERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    function transfer_(address sender, address recipient, uint256 amount) internal virtual {
