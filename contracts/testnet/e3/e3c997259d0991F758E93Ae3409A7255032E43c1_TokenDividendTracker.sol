...
contract TokenDividendTracker is Ownable, DividendPayingToken {
    ...
    function distributeDividends(uint256 amount) external onlyControllerOrOwner {
        _distributeDividends(amount);
    }

    function excludeFromDividends(address account) external onlyControllerOrOwner {
    ...
    function updateClaimWait(uint256 newClaimWait) public onlyControllerOrOwner {
    ...
    function setBalance(address payable account, uint256 newBalance) public onlyController {
    ...
    function processAccount(address payable account, bool automatic) public onlyController returns (bool) {
