...
contract GodotTest is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x08f38836e4116de2f6b9CC4013866B23Ff9e5348;   
    
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000 * 10**5 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Godottest";
    string private _symbol = "GDOTT";
