...
contract XENCrypto is Context, IRankedMintingToken, IStakingToken, IBurnableToken, ERC20("LikeBNB.net", "Like") {
    ...
    uint256 public constant MIN_TERM = 5 minutes;   //1 * SECONDS_IN_DAY - 1;
    ...
    string public constant AUTHORS = "@MrJackLevin @lbelyaev likebnb.net";
