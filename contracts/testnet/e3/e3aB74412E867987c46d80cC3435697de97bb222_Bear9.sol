...
// Main Contract
contract Bear9 is IERC20Metadata, Ownable {
   ...
   // General
   string private _name = 'Bear Token 9';
   string private _symbol = 'BEAR9';
   ...
   uint256 public treasuryTaxS  = 15;
   uint256 public treasuryTaxB  = 15;
   uint256 public liqTaxS = 10;
   uint256 public liqTaxB = 10;
   ...
   // Swap
   uint256 public taxSwapAt  = 250000000000000;
   uint256 public liqSwapAt  = 250000000000000;
   ...
   function changeTreasuryTaxOnSell(uint256 newTax) public virtual onlyOwner {
       require (newTax <= 15, "Treasury tax needs to be 15 and below");
       treasuryTaxS = newTax;
   }
   ...
   function changeLiqOnSell(uint256 newLiqTax) public virtual onlyOwner {
       require (newLiqTax <= 10, "Liquidity tax needs to be 10 and below");
       liqTaxS = newLiqTax;
   }
