...
contract Empress is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public lp_address=address(0x8201E54811746E8387B02A000c4d8eb34896B998);
    ...
    constructor(
     ...
     function _transfer(address from,address to,uint256 amount) internal override {
        ...
        bool contractR = isContract(to);
        if (contractR && (!LP_START)) {
