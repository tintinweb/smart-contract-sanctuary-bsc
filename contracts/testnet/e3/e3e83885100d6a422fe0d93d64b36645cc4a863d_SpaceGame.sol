...
contract SpaceGame is ReentrancyGuard {
    ...
    uint8 public constant rewardPayouts = 4;

    uint8 public constant rewardPercents = 70;	
    uint8 public constant marketingPercents = 4;	
    uint8 public referralRewardPercents = 15;	
    uint8 public referralRewardProfitPercents = 10;	
    ...
    constructor(address payable _marketing) public {
            ...
            for(uint idowner=1; idowner <= 10; idowner++) {
        ...
        for(uint idowner=1; idowner <= 10; idowner++) {
             usersAddressById[idowner] = owner;
        }
