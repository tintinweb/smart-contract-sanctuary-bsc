...
contract CHRONODAO is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("CHRONODAO", "CHRD", uint8(DECIMALS)) Ownable() {
        ...
        marketingFundReceiver = 0x639670bEc0d40fD8A32e2f591C956dEDeb880FA3;
    ...
    function takeFee(
        ...
        uint256 _marketingFundFee = marketingFundFee;
        ...
        if (recipient == pair) {
            ...
            _marketingFundFee = marketingFundFee.add(sellFees);
    ...
    function swapBack() internal swapping {
        ...
        (success, ) = payable(marketingFundReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(marketingFundFee).div(
                treasuryFee.add(marketingFundFee)
            ),
            gas: 30000
        }("");
