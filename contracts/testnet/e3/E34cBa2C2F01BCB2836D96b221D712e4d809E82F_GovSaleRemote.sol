...
contract GovSaleRemote is
    ...
    function init(
        ...
        endpoint = ISaleGatewayRemote(factory.saleGatewayRemote()).lzEndpoint();
    ...
    function estimateFees(
        ...
        (fees,) = endpoint.estimateFees(dstChainId, factory.saleGatewayRemote(), getPayload(_amountIn, _buyer), false, getAdapterParams());
    ...
    function buyToken(uint128 _amountIn) external payable whenNotPaused nonReentrant {
        ...
        ISaleGatewayRemote(factory.saleGatewayRemote()).buyToken{value: feeNeeded}(getPayload(_amountIn, sender), getAdapterParams(), tax);
    ...
    function finalize(bytes calldata _payload) external {
        require(_msgSender() == factory.saleGatewayRemote(), "unknown");
