...
contract Distribution is ERC721Holder, ERC1155Holder, Context, Initializable {
    ...
    function initializable(address _project, address _sale) external initializer {
    ...
    function claim(uint256 _saleId) external {
        ...
        if (project.isSingle) {
            ...
            IOSB1155(project.token).safeTransferFrom(address(this), _msgSender(), sale.tokenId, buyer.amount, "");
            buyer.amount = 0;
        }
    }
