...
contract ExchangeCore is ReentrancyGuarded, Ownable {
    ...
    */
    ...
    //copyright fee for address
    mapping(address => address) public copyrightReceiver;
    ...
    struct Order {
        ...
        function setupCopyrightMap(address nftAddress,uint fee,address receiver) public onlyOwner{
            copyrightMap[nftAddress] = fee;
            copyrightReceiver[nftAddress] = receiver;
        }
        ...
        if (sell.feeMethod == FeeMethod.SplitFee) {
            ...
            if (sell.paymentToken == address(0)) {
                ...
                //收版税
                //uint fee = copyrightMap[sell.target];
                //uint copyrightValue = SafeMath.div(SafeMath.mul(fee, price), INVERSE_BASIS_POINT);
                //address copyrightValueRev = copyrightReceiver[sell.target];
                //transferTokens(sell.paymentToken, sell.maker, copyrightValueRev, copyrightValue);
                uint copyrightValue = SafeMath.div(SafeMath.mul(copyrightMap[sell.target], price), INVERSE_BASIS_POINT);
                transferTokens(sell.paymentToken, sell.maker, copyrightReceiver[sell.target], copyrightValue);
            }
        }
            ...
            require(buy.takerRelayerFee <= sell.takerRelayerFee);
                ...
                if (sell.feeMethod == FeeMethod.SplitFee) {
                    ...
                    if (buy.takerRelayerFee > 0) {
                        ...
                        //收版税
                        uint cValue = SafeMath.div(SafeMath.mul(copyrightMap[buy.target], price), INVERSE_BASIS_POINT);
                        transferTokens(sell.paymentToken, sell.maker, copyrightReceiver[buy.target], cValue);
                    }
