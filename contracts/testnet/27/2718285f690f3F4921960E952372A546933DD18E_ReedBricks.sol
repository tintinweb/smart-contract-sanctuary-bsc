...
contract ReedBricks is Context, IBEP20, Ownable, ReedLock {
    ...
    string private _name = "JAXE";
    string private _symbol = "JAXE";
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountREED);
    ...
    function transferFrom(
        ...
        address recipient,
        uint256 amount
    ) public override whenNotFrozen(sender) returns (bool) {
     ...
     */
    function emergencyTokenExtraction(address bep20tokenAddr)
        external
        onlyOwner
    {
        IBEP20 bep20token = IBEP20(bep20tokenAddr);
...
contract ReedLock is Ownable {
    ...
    modifier whenFrozen(address _account) {
        require(onFreezer(_account), "ReedLock: Account is frozen");
        _;
    }
