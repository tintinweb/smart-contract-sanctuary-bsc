...
contract StyleCreateFactory {
     ...
     */
    function createStyle(address admin,address dexAddress,uint96 royaltyRate) external virtual returns (address) {
        bytes memory bytecode = type(StyleCreate).creationCode;
