    ...
    ReentrancyGuardUpgradeable
{
    ...
    function temporaryMerge(
        ...
        require(_timestamp <= block.timestamp && block.timestamp - _timestamp < 4 minutes, "DNFT: INVALID TIMESTAMP");
        require(verifyMergeSignature(msg.sender, _timestamp, _sessionId, _signature), "DNFT: INVALID SIGNATURE");
    ...
    function verifyMergeSignature(
        ...
        return (Whitelist.verifySignatureWhenMergeDNFT(signer, _to, _timestamp, _sessionId, _signature));
    }
