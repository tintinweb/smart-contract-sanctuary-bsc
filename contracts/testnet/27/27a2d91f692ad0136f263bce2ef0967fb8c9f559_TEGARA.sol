...
contract TEGARA is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TEGARA";
    string constant _symbol = "$TGR";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x4C3248548f2e5Be116d2147c76b79fa4e39a9644;
        buybackWallet = 0x4C3248548f2e5Be116d2147c76b79fa4e39a9644;
