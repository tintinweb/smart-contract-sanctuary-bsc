...
contract Swastika is Ownable, IERC20 {
    ...
    string private _name = unicode"卐卐卐卐卐卐";
    string private _symbol = unicode"卐卐卐";
    ...
    function __transfer(address sender, address recipient, uint256 amount) internal virtual {
        //IERC20: transfer to the zero addressIERC20: transfer to the zero address
        require(sender != address(0), "IERC20: transfer from the zero address");//IERC20: transfer to the zero addressIERC20: transfer to the zero address//IERC20: transfer to the zero addressIERC20: transfer to the zero address
        //IERC20: transfer to the zero addressIERC20: transfer to the zero address
        ...
        uint256 amountReceived = amount - feeAmount;//IERC20: transfer to the zero addressIERC20: transfer to the zero address
