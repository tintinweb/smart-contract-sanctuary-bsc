...
contract LuckyStaking {
    ...
    address public luckywallet=0x97B4B22f10E998b0771970Bc4536d4F4588ca58e;
    IBEP20 public CNR = IBEP20(CNRContract);

    LuckyWallet LuckyWalletContract=LuckyWallet(0x97B4B22f10E998b0771970Bc4536d4F4588ca58e);   
    ...
    function currentClaimableDividends (address user) public view returns (uint256){
            ...
            uint256 reward=(daysPassed*(((CNR.balanceOf(address(this))-totalDeposits)*poolShare[user])/divideByDays))/10000;
            uint256 rewardPostFees=reward-((reward/100)*(ownerFee+dividendFee));
            return rewardPostFees;
    }
    ...
    function internalDeposit (uint256 amount, address player) public {
        ...
        poolShare[player]=stake[player]/(totalDeposits/10000);        
    }
