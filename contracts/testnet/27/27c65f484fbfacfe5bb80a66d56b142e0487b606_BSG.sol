...
contract BSG {
    ...
    uint256 private constant maxDeposit = 2000e18;   /*maximum deposit*/
    uint256 private constant freezeIncomePercents = 3000; ////30% will frezze
    uint256 private constant timeStep = 5 minutes;
    uint256 private constant dayPerCycle = 10 minutes; /////cycle duration is 15 days for now
    uint256 private constant dayRewardPercents = 150; /////1.5 % daily
    uint256 private constant maxAddFreeze = 15 minutes;
    uint256 private constant referDepth = 25;   //referDepth
    uint256 public distributeRewardTime= lastDistribute+timeStep;
