...
contract test is ERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x05d7D136D99c537f98c7F70A4AA8269f00062F7E);
    ...
    constructor() ERC20("test token", "test") {
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // uniswap v2 router address
    ...
    function _transfer(
        ...
        if(!excludedAccount) {
            ...
            if(from == uniswapV2Pair || to == uniswapV2Pair) {
              fees  = amount.mul(marketingFee.add(liquidityFee)).div(100);
            }
     ...
     function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 tokensForLiquidity = contractTokenBalance.mul(liquidityFee).div(marketingFee.add(liquidityFee));
    ...
    function setMaxWalletToken(uint256 _maxToken) external onlyOwner {
        ...
        require(maxWalletToken >= totalSupply().div(500), "value is too low");
  	}

    function setMaxTxAmount(uint256 _maxTx) public onlyOwner {
        maxTransactionAmount = _maxTx;
        require(maxTransactionAmount >= totalSupply().div(1000), "value is too low");
    }
    ...
    function setFees(uint256 _marketingFee, uint256 _liquidityFee) external onlyOwner {
        require(_marketingFee.add(_liquidityFee) <= 25, "tax too high");
