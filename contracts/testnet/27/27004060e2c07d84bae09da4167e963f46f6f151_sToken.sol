...
contract sToken is BEP20Detailed, BEP20 {
  ...
  constructor() BEP20Detailed("s18", "S18", 18) {
    ...
    //setLiquidityPoolStatus(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3, true);
  }
  ...
  function _transfer(address sender, address receiver, uint256 amount) internal virtual override {
    ...
    if (whitelistTax[sender] || whitelistTax[receiver] || sender == marketingPool || receiver == marketingPool || liquidityPool[sender] || liquidityPool[receiver]) {
       taxAmount = 0;
    } else {
