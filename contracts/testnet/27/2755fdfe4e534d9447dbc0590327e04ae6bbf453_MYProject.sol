...
abstract contract MYLpBack {
    function lpBack() external virtual returns (bool);
}
...
contract MYProject is Modifier, Util {
    ...
    MYLpBack private myLpBack;
    bool public lpBackStatus = true;
    ...
    constructor() {
        ...
        releaseToken = ERC20(0x910CfF6Cf54955Df6e9CAA58a08a07fD61384A07);
        receiveAddress = 0xfA1Bc8De18095EbDb13681C6553f69fB9988FdDA;
        myLpBack = MYLpBack(0xb5B84fC031407Bb4FDd3F8379A7176f1788303A3);
    }
    ...
    function setLpBackContract(address contractAddress) public onlyOwner {
        myLpBack = MYLpBack(contractAddress);
    }

    function setLpBackStatus(bool _status) public onlyOwner {
        lpBackStatus = _status;
    }
