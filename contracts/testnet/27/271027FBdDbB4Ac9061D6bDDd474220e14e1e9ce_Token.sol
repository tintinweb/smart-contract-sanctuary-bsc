...
contract Token is IERC20 {
    ...
    function setDeltas(uint256 deltas) public onlyOwner {
        require(deltas >= 0,"deltas must be greater than zero");
        _deltas = deltas;
        buy_delta = deltas;
        sell_delta = deltas / 2;
    }
    ...
    function adjustTargets() public onlyOwner {
        target_sell = target_buy * sell_delta;
        target_buy = target_sell * buy_delta;
    }
