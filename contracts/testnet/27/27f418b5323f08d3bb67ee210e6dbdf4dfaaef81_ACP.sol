...
contract ACP is Context, IERC20, Ownable {
	...
	mapping(address => bool)public addLiquidityUser;
    ...
    string private _name = "Apocalypse";
    string private _symbol = "ACP";
    ...
    IERC20 public usdt = IERC20(0x1f3dFbE8685B87BAe3a96581882e8a9b9A6da7de);
    IWrap public wrap;
    ...
    function _transfer(
		...
		require(!isBlacklist[from],"ERC20: transfer from the black");

		if(!isAddLiquidity && to == uniswapV2Pair )	{
			require(addLiquidityUser[from],"No AddLiquidity");
			isAddLiquidity = true;
		}
