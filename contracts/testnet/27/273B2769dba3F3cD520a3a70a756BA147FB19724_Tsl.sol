...
contract Tsl is Context {
    ...
    // event ceshi(uint256 a,uint256 b,uint256 c,uint256 d,address a_,address b_,address c_,address d_);
    
    constructor(address address_) {
        //0xce69a4B7994b84cC4BC11CEE3Ed9218354686260
        _name = "TESLAMETA_test2";
        _symbol = "TSL_test2";          
    ...
    function _transfer(
        ...
        // emit ceshi(senderBalance,_balances[sender],_balances[recipient],buyinnumber,sender,recipient,address(0),address(0));
