...
contract Nft2dSales is Initializable, OwnableUpgradeable {
    ...
    function initialize(address soul_, address nft_) public initializer {
    ...
    function playerMint(uint orderNumber_) public {
        ...
        if (freeMaxNums != 0 && isWhiteList(player) == 0) {
            ...
            sold += 1;
            // 付费铸造
            soulToken.transferFrom(player, address(this), handlingFee * 5 / 100);
...
contract Meta2dnft is Divestor, ERC721Enumerable {
    ...
    constructor (address soul_) ERC721("2D Meta NFT", "2DMT") {
        soulToken = ISoulToken(soul_);
        baseURI = "https://test/";
    }
