...
contract PoolLogic is ERC20ExtendedUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function withdraw(bool _isStablecoin, uint256 _unitOut) public nonReentrant {
        ...
        _withdraw(_isStablecoin, denominationAsset, proportion, msg.sender);
    }
    ...
    function redeemFee(bool _isStablecoin) public nonReentrant {
        ...
        _withdraw(_isStablecoin, denominationAsset, numberOfUnit.mul(10**18).div(totalSupply()), recipent);
...
library SwapLib {
    ...
    function _swapForWithdrawal(
        ...
        _swap(_router, _tokenIn, _amountIn, amountOutmin[0], path, _to);
    }
    ...
    function _swap(
        ...
        IPancakeRouter02(_router).swapExactTokensForTokens(_amountIn, _amountOutMin, _path, _to, block.timestamp);
    }
