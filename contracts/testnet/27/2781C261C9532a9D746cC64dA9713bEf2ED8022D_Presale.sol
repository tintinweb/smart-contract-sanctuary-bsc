...
contract Presale is Ownable {
    ...
    uint256[] public priceBrackets = [17, 40, 80,120];

    uint256 public hardcap = 10000*1e18;
    address private dev;
    uint256 private MaxValue;
    ITimeLockedWalletFactory walletFactory;
    //@dev max and min token buy limit per account
    uint256 public minEthLimit = 1600000000000000;
    uint256 public maxEthLimit = 400000000000000000000;
