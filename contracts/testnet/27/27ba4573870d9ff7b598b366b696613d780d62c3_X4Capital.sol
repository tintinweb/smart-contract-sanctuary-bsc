...
contract X4Capital is Context, Ownable {
    ...
    uint256 private constant DAY = 60 seconds;
    ...
    constructor() {         
        ...
        paymentTokenAddress = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684; //0x55d398326f99059fF775485246999027B3197955; //USDT
    ...
    function Reinvest() external {   
        ...
        require(player.dividends >= 1 ether, "Minimum reinvest is 50 USDT.");
    ...
    function Payout() external {      
        ...
        require(player.dividends >= 1 ether, "Minimum payout is 50 USDT.");
    ...
    function computePayout(address _addr) view external returns(uint256 value) {
        ...
        for(uint256 i = 0; i < player.deposits.length; i++) {
            ...
            if(from < to) {
                value += dep.amount * (to - from) * tarif.percent / tarif.life_days / 86400;
            }
        }
        return value;
    }
