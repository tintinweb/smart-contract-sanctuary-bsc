...
contract Create is Context, IERC20, IERC20Metadata, Ownable {
    ...
    BlueAnti blueAnti;
    string private _name = "GFLO";
    string private _symbol = "GFLO";
    uint8 private _decimals = 3;
    uint256 private _totalSupply;
    uint256 private _maxSupply = 210000000000000000 * 10**_decimals;

    constructor() {
        _mint(_msgSender(), 11000000000000000 * 10**_decimals);
    }
