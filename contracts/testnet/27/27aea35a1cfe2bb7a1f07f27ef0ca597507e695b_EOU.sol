...
contract EOU is Context, IERC20, Ownable {
    ...
    address public liquidityWallet = 0x0000000000000000000000000000000000000002;
    address public developmentWallet = 0x0000000000000000000000000000000000000003;
    ...
    function setReflectionFeePercent(uint256 _reflectionFee) external onlyOwner() {
        ...
        require(reflectionFee + marketingFee + liquidityFee + developmentFee <= 10, "Fees cannot be more than 10%");
    ...
    function setTaxCap(uint _tax) external onlyOwner() {
        require(_tax < taxCap, "Tax cap only can be decreased");
        taxCap = _tax;
