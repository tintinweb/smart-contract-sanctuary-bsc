...
contract Dalchand {
    ...
    constructor(address payable ownerAddress) public {
        ...
        LEVEL_PRICE[3] = 0.0002 ether;
        LEVEL_PRICE[4] = 0.0002 ether;
        LEVEL_PRICE[5] = 0.0004 ether;
        LEVEL_PRICE[6] = 0.0004 ether;        
        LEVEL_PRICE[7] = 0.008 ether;
        LEVEL_PRICE[8] = 0.008 ether; 
    ...
    function registration(address payable refAddress)public payable{
       ...
       function regUser(address payable userAddress,address refAddress) internal{        
        ...
        emit regLevelEvent(msg.sender,lastIDCount2x2,lastFreeParent2x2, refAddress, block.timestamp);
