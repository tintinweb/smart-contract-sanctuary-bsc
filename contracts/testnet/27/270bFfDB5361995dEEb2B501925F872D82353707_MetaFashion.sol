...
contract MetaFashion is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x5Bfb7ED32DC7BaEC41892d0ed10Ab231d495fb67); // Marketing Address
    address payable public rewardAddress = payable(0x4E14401C3857710467dcBa8BAFf6FA3bf44d5845); // Reward Address
    address payable public liquidityAddress = payable(0x701641b954a05825AfFB945B954dFe1eE1886C81); // Liquidity Address
