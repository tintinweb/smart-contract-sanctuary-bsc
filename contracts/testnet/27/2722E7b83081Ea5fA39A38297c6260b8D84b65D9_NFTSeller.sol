...
contract NFTSeller is Whitelist {
    ...
    */
     ...
     */
    function buy(uint256 amount, address _stablecoin) public payable canParticipate {
        ...
        if (!whitelistEnabled) {
            ...
            tokensPrice = 1*10**decimals;
            require(token.allowance(msg.sender, address(this)) >= tokensPrice, "Sales: required tokens amount not approved");
            token.safeTransferFrom(_msgSender(), founderDetails, tokensPrice);
