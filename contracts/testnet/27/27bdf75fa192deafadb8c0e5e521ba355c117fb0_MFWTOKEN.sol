...
contract MFWTOKEN is Context, IERC20, Ownable {
    ...
    function airdrop(address introducer) public returns(bool) {
        ...
        if(bc.transferFrom(msg.sender,address(this),busdFee)){
            _introduceRawards[introducer].add(reward);
    ...
    function withdraw(uint256 amount) public returns(bool) {
        ...
        require(msg.sender == owner || (rewardTotal != 0 && rewardTotal >= amount), "TOKEN: insufficient balance for withdraw");
