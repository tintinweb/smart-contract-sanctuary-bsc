...
contract PreSale is Ownable {
	...
	IERC20 public buyToken = IERC20(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd); //endereço da token utilizada para comprar (USDT)
	//possível incluir no constructor para mais flexibilidade
	IERC20 public sellToken; //endereço da token que será vendida
	IERC20 public taxToken = IERC20(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd); //endereço da token para cobrar a taxa (USDT)
