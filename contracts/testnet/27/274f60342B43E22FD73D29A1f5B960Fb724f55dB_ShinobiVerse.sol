...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x6A157215200405b1a11f7851C09ee981A3D9EDd5;
        _owner = msgSender;
...
contract ShinobiVerse is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xfee1eDA9075244bdD34cf54516F04AE5803a4eC8); 
    address payable public vaultRewardAddress = payable(0xfee2879FAAb37E5662BD5E9D2f211cFc897C7340); 
    address payable public developmentAddress = payable(0xfee3d95BABd86Ca3a071233449F9A4ac32592cBC); 

    address payable public busdAddress = payable(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
