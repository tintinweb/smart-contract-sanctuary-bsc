...
contract Marketplace  is Initializable, Ownable, BasicMetaTransaction {
    ICashemon public nft;
    ...
    function listing(uint tokenId) public {
        require(nft.ownerOf(tokenId) == msg.sender,"You are not owner");
        onSale[tokenId] = true;

    }

    function sell(address to, uint tokenId) public {
        require(onSale[tokenId],"Not available for sale");
