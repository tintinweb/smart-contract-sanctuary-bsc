...
contract NFTRefelection is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    */
    ...
    function updatePool(uint256 receivedAmount) public {
        PoolInfo storage pool = poolInfo;
        ...
        uint256 _reward = receivedAmount / 100 ;
       ...
       function _claim() private {
        ...
        uint256 pending = (user.totalGgymnetAmt * pool.accRewardPerShare) / (1e18) - (user.rewardDebt);
