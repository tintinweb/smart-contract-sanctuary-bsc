...
contract Richdotcoin is Context, IERC20, Ownable {
    ...
    function SetUpAsTreasuryMinter(address Mentor) external updateReward(msg.sender) {
        ...
        _transfer(msg.sender, _developmentWalletAddress, MentorshipFee);
    ...
    function resignMentorshipOf(address mentee) external updateReward(msg.sender) {
        ...
        _transfer(msg.sender, mentee, MentorshipFee);
    ...
    function MintNewCoinsAmount(uint256 amount) external updateReward(msg.sender) {
        uint256 _amount = amount/(treasuryRATE/100 -1);
        ...
        _transfer(msg.sender, _developmentWalletAddress, _amount);
