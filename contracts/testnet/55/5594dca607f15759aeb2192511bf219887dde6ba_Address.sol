...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x08D8BF3bf6f5055c0AeD8eC664e2bC00C3DDe8e2;
...
contract Rattyinu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x08D8BF3bf6f5055c0AeD8eC664e2bC00C3DDe8e2;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Ratty INU";
    string private _symbol = "RATINU";
