...
contract Sulfurpro is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 30000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Sulfur Protocol";
    string private _symbol = "SULP";
    ...
    function setRefToHoldersFeePercent(uint256 RefToHoldersFee) external onlyOwner() {
        _RefToHoldersFee = RefToHoldersFee;
    }
