...
contract DualFactory is AccessControl, IDualFactory {
  ...
  function _create(
    ...
    uint256 inputAmountUSD = _inputUSDT(inputToken, inputAmount);
    uint256 profitUSDT = Math.percent(inputAmountUSD, tariff.yield);
  ...
  function _input(Dual memory dual, DualTariff memory tariff)
    private
    pure
