...
contract SaFuTrendz is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x60dbf3E23F311Cab723DE2722A6b3f49C483BfE7); // Marketing Address
    ...
    uint256 private numTokensSellToAddToLiquidity = (_tTotal * 2) / 100000000;
    ...
    constructor () {
        ...
        // References https://www.reddit.com/r/pancakeswap/comments/m1s3ki/pancakeswap_on_bsc_testnet/ 
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        // router = PadSwapRouter(0x76437234D29f84D9A12820A137c6c6A719138C24); // Mainnet
        // router = PancakeswapTestnetRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // Testnet
