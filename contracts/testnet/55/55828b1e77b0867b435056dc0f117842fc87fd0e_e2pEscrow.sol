...
contract e2pEscrow is Stoppable, SafeMath {
    ...
    returns(bool)
  {
    ...
    require(msg.value > 0);
    uint commissionFee = getCommissionFeePercentage(_amount);
  ...
  function getCommissionFeePercentage(uint _amount)
    ...
    returns (uint amount) 
  {
        return (safeDiv((safeDiv(safeMul(safeMul(_amount,10**decimal),commissionFeePercentage),safeMul(100,10**decimal))),10**decimal));
  }
