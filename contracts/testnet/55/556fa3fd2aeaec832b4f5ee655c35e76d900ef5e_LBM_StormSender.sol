...
contract OwnerStorage {
    ...
    function setUpgradeabilityOwner(address newabilityOwner) internal {
...
contract OwnedUpgradeabilityStorage is OwnerStorage, UpgradeabilityStorage, EternalStorage {}
...
contract LBM_StormSender is OwnedUpgradeabilityStorage, Claimable {
    ...
    function LBM_Token_Send(address token, address[] _contributors, uint256[] _balances) public payable {
        if (token == 0x000000000000000000000000000000000000bEEF){
            LBM_SENDER(_contributors, _balances);
        } else {
            uint256 total = 0;
    ...
    function LBM_SENDER(address[] _contributors, uint256[] _balances) public payable {
