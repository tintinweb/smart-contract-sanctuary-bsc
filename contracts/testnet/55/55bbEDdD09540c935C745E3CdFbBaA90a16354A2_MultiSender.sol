...
/*
    ...
    # Follow the dev Twitter: @devToTheMars email: [email protected]
    ...
    # You can send max upto 65,535 address in one time or limit set by dev. (see maxReceipients variable)
