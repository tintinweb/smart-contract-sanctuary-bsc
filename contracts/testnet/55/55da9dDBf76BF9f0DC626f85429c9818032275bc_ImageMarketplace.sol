    ...
    UUPSUpgradeable
{
    ...
    CountersUpgradeable.Counter public _itemSold;
    ...
    function cancelListImageNFT(uint256 _tokenId) public {
        // Verify
        require(
            idToMarketItem[_tokenId].seller == msg.sender, "You do not own this NFT");
        ...
        public payable nonReentrant
    {
        ...
        require(marketItem.owner != msg.sender, "You already owned this NFT");
        require(msg.value >= marketItem.price, "Please pay the NFT's price");

        address payable buyer = payable(msg.sender);

        uint256 fee = (msg.value * feeRate) / 100;

        // Transfer money to seller %'s salePrice
        address owner = nft.ownerOf(_tokenId);
        payable(owner).transfer(msg.value - fee);

        // Transfer money to marketplace feeRate %'s salePrice
        ...
        // Emit event
        emit BuyImageNFT(marketItem.tokenId, nftContract, address(this), buyer, marketItem.price);
