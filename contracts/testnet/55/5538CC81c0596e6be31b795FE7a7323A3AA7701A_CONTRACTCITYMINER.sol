...
contract CONTRACTCITYMINER is Owned {
    ...
    uint256[] public REFERRAL_PERCENTS = [25]; // 25 = 2.5%
    uint256 public INVEST_MIN_AMOUNT = 0.01 ether; // 0.15 BNB
    ...
    constructor() {
        ...
        plans.push(Plan(1, 50)); // 10 days, 50 = 3%
    }
    ...
    function invest(address referrer) public payable {
        require(started, "CITYMINER: not launched");
        
        require(msg.value >= INVEST_MIN_AMOUNT, "CITYMINER: Deposit value is too small");
        require(msg.value <= INVEST_MAX_AMOUNT, "CITYMINER: Deposit limit exceeded");
        require(planCurrent < plans.length, "CITYMINER: Invalid plan");
    ...
    function withdrawreferalsbonus() public {
        ...
        require(referralBonus > 0, "CITYMINER: User has no referal payments");
        require(contractBalance > referralBonus , "CITYMINER: No enought balance. Try later");
    ...
    function withdrawdeposit(uint256 index) public {
        ...
        require(amount > 0, "CITYMINER: No deposit amount");
