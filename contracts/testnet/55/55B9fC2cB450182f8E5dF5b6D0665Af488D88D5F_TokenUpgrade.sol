    ...
    Drawable
{
    ...
    function getPartcipants() external view returns (address[] memory) {
    ...
    function enterDraw() public {
        require(
            ...
            "Raizzen Token: Enter Draw Require Raizzen Token"
        );
...
contract Drawable is Initializable {
    ...
    function _resetParticipant() internal {
