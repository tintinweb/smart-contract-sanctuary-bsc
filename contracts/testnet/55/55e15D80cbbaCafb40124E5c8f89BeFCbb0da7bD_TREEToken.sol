...
contract TREEToken is ERC20, Ownable {
    ...
    uint256 public holderRewardsFee = 1;
    ...
    constructor(
        ...
        dividendTracker = new TokenDividendTracker(address(this), 1);
    ...
    function setHolderRewardsFee(uint256 amount) public onlyOwner {
        holderRewardsFee = amount;
    }
    ...
    function _transfer(
        ...
        if(automatedMarketMakerPairs[from] || automatedMarketMakerPairs[to]){
            uint256 RFee = amount.mul(holderRewardsFee).div(100);
            AmountTokenRewardsFee += RFee;

            uint256 LFee = amount.mul(liquidityFee).div(100);
            AmountLiquidityFee += LFee;

            uint256 fees = LFee.add(RFee);
