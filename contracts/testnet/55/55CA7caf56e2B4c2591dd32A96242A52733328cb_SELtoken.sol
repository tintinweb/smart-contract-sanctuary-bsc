...
contract SELtoken  is Context, IERC20, Ownable {
    ...
    string private _name = "Student";
    string private _symbol = "SEL";
    uint8 private _decimals = 18;
    
    // 10% Fees Distribution
    uint256 public _reflectionFee = 2;                                 // Reflexion/rewards.
   ...
   address payable _charityWallet;
    ...
    constructor () public {
       ...
       _charityWallet = 0x9a02236B5CA1e785A1121DF6eFFaF4Ec10d0Fc4c;
       _marketingWallet = 0x1b0cd62887ABcB026a0a71BF53bb7123CAbf7f93;
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256[6] memory tValues) {
        uint256 tFee = calculateReflectionFee(tAmount);                        // token for distribution
    ...
    function removeAllFee() private {
        if(_reflectionFee == 0 && _liquidityFee == 0 && _marketingFee == 0 && _charityFee == 0 ) return;
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax, liquidity, marketing, charity fee
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // add liquidity to quickswapswap
