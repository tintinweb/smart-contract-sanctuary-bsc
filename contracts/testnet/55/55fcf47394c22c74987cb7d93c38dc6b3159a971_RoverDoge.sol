...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0xE4FAE3Faa8300810C835970b9187c268f55D998F);
...
contract RoverDoge is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARD = 0xE4FAE3Faa8300810C835970b9187c268f55D998F;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "Rover Doge";
    string constant _symbol = "$RDOGE";
    uint8 constant _decimals = 8;

    uint256 _totalSupply = 1_000_000_000e8;
    ...
    address public marketingFeeReceiver = 0xdEBd749C7aedac5C435f2CEEB6FC96c5B5Eb021F;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee <= 10, "Must keep fee at 10% or less");
    }
