...
contract FiveElements is Permission {
    ...
    function _getRandomNumber2() public returns (bytes32){
        // _updateRamdomSeed();
    ...
    function testGet5() public returns (uint8){
        ...
        return lucky5(_getRandomNumber());
    }

    function testGetX() public returns (uint8){

        return lucky5(_getRandomNumber2());
    }
    ...
    function testGet6() public returns (uint8){
        return getX(_getRandomNumber());
    }

    function testGetG() public returns (uint8){
       return getX(_getRandomNumber2());
    }
