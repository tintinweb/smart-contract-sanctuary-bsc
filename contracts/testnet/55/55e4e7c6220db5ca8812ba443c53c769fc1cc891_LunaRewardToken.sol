...
If you are afraid to buy luna then you can buy this token for $LUNA rewards
This token I created to support luna and for everyone who wants to be a millionaires,
because all buyer on $Luna dip is all retail, no big shit company,
that's mean fully decentralized by peoples, also luna are stopped minting, could moon
Just hold for your life changing money

This token offering 8% $Luna Wormhole reward (BSC)
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0x156ab3346823B651294766e23e6Cf87254d68962);
...
contract LunaRewardToken is IBEP20, Auth {
    using SafeMath for uint256;

    address REWARD = 0x156ab3346823B651294766e23e6Cf87254d68962;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address LP = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;

    string constant _name = "Luna Reward";

    string constant _symbol = "$LR";

    uint8 constant _decimals = 8;

    uint256 _totalSupply = 100_000_000_000_000e8;
    ...
    address public marketingFeeReceiver = 0xCe4e029C123AF9e173Af3cA1d61F973c0fc74CE4;
