...
contract Game is AccessControl,Ownable {
    ...
    function speedFee(uint256 remainTime) view public returns(uint256){
        ...
        uint256 amounts = router.getUsdtPrice1(_gameInfo.speedMoney);
    ...
    function upLevel(uint256 _tokenId) public{
        ...
        uint256 incomeByToken = router.getBNBPrice1(_tokenLevel[_tokenId][_tokenDetail[_tokenId].level]);
