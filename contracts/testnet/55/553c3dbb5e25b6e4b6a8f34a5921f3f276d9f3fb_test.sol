...
contract test is IBEP20, Ownable
{
    ...
    string private constant _symbol = 'ttt123';
    ...
    uint8 constant BotMaxTax=0;
    uint256 constant BotTaxTime=0 minutes;
    uint256 constant WLTaxTime=0 minutes;
    ...
    //If someone sacrifices their test, they receive additionalShares
    ...
    //Sacrifices test, test get burned, nothing remains exept 2x rewards for the one bringing the sacrifice
