...
contract pool1IDO is Ownable, ReentrancyGuard {
  ...
  uint256 public payAmountPerSlot = 100 * generalDec;
  uint256 public tokenPerSlot = 5000 * generalDec; // 100 BUSD / 0.02 = 5,000 HES
  uint256 public totalOfSlot = 100;
  uint256 public totalOfUserStaked; // User staked
  uint256 public requireStakingToken = 5000 * generalDec; // 5,000 BAMI
  uint256 public feeBamiAmount = 300 * generalDec; // 300 BAMI
...
//   uint256 public endClaimTime;
  ...
  constructor(
      //Test only - open it back when deploy on mainnet
    // address _devWallet,
    // address _idoOwner,
    ...
    // Test only - delete when deploy on mainnet
    devWallet = address(0xab29D07D27a641Ddb532f7054933273AB229c584);
    idoOwner = address(0xab29D07D27a641Ddb532f7054933273AB229c584);
    hesmanToken = ERC20(0xC56E3B597856333A2ccD37c4A77421da141FF3be);
    bamiToken = ERC20(0xFb25E38Cc94b448a3b7bede5cE7d0d779e151b93);
    paymentToken = ERC20(0x280b2e8B297E15467bC1929941b5439eC67fC145);
  ...
  function setTest() external onlyOwner {
    setTimeStake(block.timestamp, block.timestamp.add(60*10), block.timestamp.add(60*30));
    setBuyTime(block.timestamp.add(60*30), block.timestamp.add(60*40));
  }
