...
/*
-No hay blacklist
-Los cakes creados por la auto LP van a sender cuando se renuncia el contrato y no a ZERO
-No hay maxTxTrans pero si que hay maxHoldTrans del 2% modificable mediante una funcion.
-Marketing y Router en testnet 
*/
...
contract BurguerT2 is Context, IERC20, Ownable {
	...
	uint256 public _maxHoldAmount = _tTotal * 2 / 100;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 100_000 * 10**9; //
    string private constant _name = "BurguerT2"; // 
    string private constant _symbol = "BURGERT2"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0xB1A2e3dE86535fB7A0b5FAEF990Fd9672e914B93;
	address public _devWallet = 0x9138B9f3333d2485dA63a537451D024BC04652C0;
	...
	function setMaxHoldAmountPercent(uint256 maxHoldPercent) external onlyOwner() {
        _maxHoldAmount = _tTotal * maxHoldPercent / 10**2;
    }
    ...
    function _transfer(
		...
		if(from != owner() && to != owner() && to != uniswapV2Pair)
            require(balanceOf(to) + amount <= _maxHoldAmount, "Transfer amount exceeds the maxHoldAmount.");
