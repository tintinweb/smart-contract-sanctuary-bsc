...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x185D44882f303F0AF13bb738F752449939BeD511; // owner address
...
contract NamcoPeace is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Namco Peace";
    string private _symbol = "NPC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x185D44882f303F0AF13bb738F752449939BeD511); // Marketing Address
    address payable public teamWalletAddress = payable(0x185D44882f303F0AF13bb738F752449939BeD511); // Team Address
