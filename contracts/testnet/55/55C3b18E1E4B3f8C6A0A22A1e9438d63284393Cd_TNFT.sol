...
contract TNFT is BEP20Detailed, BEP20 {
    ...
    constructor(address _maketAddress, address _init, address _uniswapV2Factory, address _wbnb) 
    BEP20Detailed("TNFT", "TNFT", 18) {
        _mint(_init, maxSupply / 100);
        sellTax = 10;
    ...
    modifier onlyMinter() {
        require(minterRole[_msgSender()], "caller is not the minter");
        _;
