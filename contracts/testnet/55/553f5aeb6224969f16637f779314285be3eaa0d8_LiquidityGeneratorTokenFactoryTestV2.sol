...
contract StandardLiquidityGeneratorToken is IERC20, Ownable, BaseToken {
...
contract LiquidityGeneratorTokenFactoryTestV2 is TokenFactoryBase {
    using Address for address payable;
    ...
    function create(
        ...
        StandardLiquidityGeneratorToken tokenContract = new StandardLiquidityGeneratorToken();
        tokenAddress = address(tokenContract);
        StandardLiquidityGeneratorToken(payable(tokenAddress)).initialize(
        msg.sender,
        name,
        symbol,
        totalSupply,
        ...
        liquidityTokens.push(StandardLiquidityGeneratorToken(payable(tokenAddress)));
        assignTokenToOwner(msg.sender, tokenAddress, 2);
        emit TokenCreated(msg.sender, tokenAddress, TokenType.liquidityGenerator, 1);
    }
