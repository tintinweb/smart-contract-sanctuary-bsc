...
contract Powermoon is Context, IERC20, Ownable {
    ...
    string private _name = "PowerMoon Protocol";
    ...
    uint256 private _devFeeDivisor = 2;
    uint256 private _previousDevFeeDivisor = _devFeeDivisor;

    address payable public marketingWallet = payable(0x15A04850aA575Ab0D0477998Ed40F13F36B4D3C3);
    address payable public devWallet = payable(0x4E29504177F968BF9697ae31060E6a5934c3b7eF);
