...
contract DualDividendTracker is Ownable, DividendPayingToken {
    ...
    address public _rewardTokenAddress = 0x6582dC40Cb55C1B2e5865c4641eC3960A13dc75c;
...
contract DUAL is ERC20, Ownable {
    ...
    address public rewardToken = 0x6582dC40Cb55C1B2e5865c4641eC3960A13dc75c;
    address public BUSD = 0xE1B5192267B856B8e900Cfc1E5Ef4e049a63D743;     //swap BUSD ADDRESS
    ...
    address public _marketingWalletAddress = 0x66fed982dd84B6048489B8202865e3919601B8c5;
    address public _gasFeeCollector = 0x66fed982dd84B6048489B8202865e3919601B8c5;
    address public _externalwallet = 0x66fed982dd84B6048489B8202865e3919601B8c5;
    ...
    constructor() ERC20("Reward", "TREWARD")  {
        ...
        uint256 totalSupply = 1000000 * (10**18);  // 1,000,000
        ...
        IERC20(BUSD).approve(address(_uniswapV2Router), ~uint256(0));
        IERC20(BUSD).approve(address(_uniswapV2Pair), ~uint256(0));
