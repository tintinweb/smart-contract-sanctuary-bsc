...
contract GlobalsAndUtility is ERC20 {
    ...
    */
    ...
    uint256 private constant HEARTS_PER_HEX = 10 ** uint256(decimal); // 1e8
    ...
    uint256 internal constant LAUNCH_TIME = 1664433600;
    ...
    {
        require(beginDay < endDay && endDay <= globals.dailyDataCount, "HEX: range invalid dailyDataRange");
...
contract TransformableToken is StakeableToken {
    ...
    function xfLobbyExit(uint256 enterDay) external {
        ...
        require(headIndex < endIndex, "HEX: count invalid xfLobbyExit");
        ...
        returns (uint256[] memory list)
    {
        require(
            ...
            "HEX: invalid range xfLobbyRange"
        );
 ...
 \     * @param entriesDay 49 bit compound value. Top 9 bits: enterDay, Bottom 40 bits: entryIndex
        ...
        returns (XfLobbyEntryStore[] memory entries)
    {
        ...
        require(_headIndex <= _tailIndex, "HEX: invalid index xfLobbyEntry");
