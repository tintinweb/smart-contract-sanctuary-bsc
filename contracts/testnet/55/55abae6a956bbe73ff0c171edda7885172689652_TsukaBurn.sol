...
/**
 SmartContract
Visit our Telegram and become part of the TsukaBurn family! We are here to BURN THIS SUPPLY!
*/
...
contract TsukaBurn is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    TsukaBurnDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Tsuka Burn", "SBURN") {
        ...
        dividendTracker = new TsukaBurnDividendTracker(
            payable(this),
            router,
...
contract TsukaBurnDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    TsukaBurn public TsukaBurnContract;
    ...
    constructor(
        ...
        defaultToken = token;
        TsukaBurnContract = TsukaBurn(mainContract);
    ...
    function _transfer(
        ...
        require(false, "TsukaBurn_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "TsukaBurn_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main TsukaBurn contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(TsukaBurnContract);

            uint256 prevBalance = TsukaBurnContract.balanceOf(address(this));
            ...
            {
                uint256 received = TsukaBurnContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    TsukaBurnContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
