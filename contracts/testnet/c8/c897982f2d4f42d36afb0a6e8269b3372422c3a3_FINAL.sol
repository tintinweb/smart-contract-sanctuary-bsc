...
//forbscscan
    ...
    {   
        return (_name , _symbol ,_decimals, balanceOf(address(0))/10**18, (totalSupply() - balanceOf(address(stakeWallet)) - balanceOf(address(rewardWallet)) - balanceOf(address(this)) - balanceOf(owner()))/10**18 , totalSupply()/10**18 , MAX/10**18) ;
    }
