...
contract StakingSet is StakingSetStorage {
    ...
    function getTokenRewardsAmounts(uint tokenId) public view returns (uint256 NimbUserRewards, uint256 GnimbUserRewards, uint256 CakeUserRewards) {
        ...
        NimbUserRewards = (((_balancesRewardEquivalentNbu[tokenId] + _balancesRewardEquivalentNbu[tokenId]) * ((block.timestamp - weightedStakeDate[tokenId]) * 60)) * MULTIPLIER / (100 * rewardDuration)) / MULTIPLIER;
