...
contract NinjaInu is IBEP20, Auth {
    ...
    address payable public marketingWalletAddress = payable(0x7De8EF154bc3DE59BF91FF5268A0B2aD6E261e03); // Marketing Address
    address payable public teamWalletAddress = payable(0xEC18A29290CE528BC8231863EEa02FE7a40628C3); // Team Address
    ...
    uint256 public _maxTxAmount = 500 * 10**6 * 10**9; //5 * 10**6 * 10**9
    ...
    function changeRouterVersion(address newRouterAddress) public authorized returns(address newPairAddress) {
