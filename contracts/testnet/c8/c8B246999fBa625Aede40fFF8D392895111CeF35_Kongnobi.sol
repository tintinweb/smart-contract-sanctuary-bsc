...
contract Kongnobi is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xB828b4B5dE5ca744688d6F7fe27310Ac621aEa0b); // Marketing Wallet Address
    address payable public devWalletAddress = payable(0x8D1b7Be66DE1893F13b8230f899e0C27c2b3a7FD); // dev Wallet Address
    ...
    constructor () {
        address _owner = 0x1aBF9A2E66906F13ff2830bc18478405abC68eE0;
