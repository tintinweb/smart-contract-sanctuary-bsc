...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'ae4211238fdf73331aedf6f051a0aca1c2052b7d78494a3df2fe7e0545ca8d10' // init code hash
            ))));
    }
...
contract PancakeRouter01 is IPancakeRouter01 {
    ...
    constructor() public {
        factory = address(0x77A2FFA74F335931aC852dF094568DB5D3c3a474);
        WETH = address(0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F);
    }
