...
contract RandomSpadeChip is IRandomSpadeChip, VRFConsumerBase, Ownable {
     ...
     * Requests randomness
     */
    function requestRandomNumber() public override returns (bytes32 requestId) {
        require(
    ...
    {
        require(randomResults[requestId] > 0, "Not fulfilled yet");
