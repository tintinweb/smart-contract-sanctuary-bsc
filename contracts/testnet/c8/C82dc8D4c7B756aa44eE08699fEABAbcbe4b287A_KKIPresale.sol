...
contract KKIPresale is ReentrancyGuard, Context, Ownable {
    ...
    uint256 public availableKKITokensIDO;       // number of tazor token available (left)
    uint256 public totalKKITokens;              // number of initial tazor
    ...
    //Pre-Sale
    function buyKKITokens(uint256 tokenAmount) public nonReentrant icoActive payable {

        require(availableKKITokensIDO > tokenAmount, "required kki amount is greater than left tokens");
