...
contract GTEST is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function setSocials(string memory telegram_, string memory website_) public onlyOwner {
        telegram = telegram_;
        website = website_;
    }
    ...
    function toggleBlacklist(address account_) public onlyOwner {
        ...
        } else if(isBlacklisted_[account_] == true){
