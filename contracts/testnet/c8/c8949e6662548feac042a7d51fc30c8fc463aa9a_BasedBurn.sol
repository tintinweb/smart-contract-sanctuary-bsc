...
//                                 ╚═════╝  ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═══╝     
//                                                                                                                           
// https://t.me/BasedBurn
// https://basedburn.io/
// https://twitter.com/BasedBurnBSC
// https://www.instagram.com/basedburn/?igshid=YmMyMTA2M2Y=
// hhttps://www.facebook.com/basedburnbsc/
...
contract BasedBurn is IBEP20, Ownable {
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        Team: 0xb98DDd1677593Dc75fb59E613C08D945A3353676,
        Dev: 0xb98DDd1677593Dc75fb59E613C08D945A3353676,
        marketing: 0x1B1127Bf222ED3eBe6F6Fb4fBC54a9f681c8294e
    });
...
///// AUTHORIZED FUNCTIONS /////
    ...
    function updateTax(uint8 newBuy, uint8 newSell, uint8 newTransfer) external authorized {
        ...
        require(newBuy <= MAX_TAX && newSell <= MAX_TAX && newTransfer <= 100, "taxes higher than max tax");
