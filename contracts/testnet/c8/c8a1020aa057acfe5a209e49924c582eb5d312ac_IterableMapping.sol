...
contract Candylad is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = 0x0BCdd91bb581C6062153820955C19cdb79A7ee9b;
    address public buybackWallet =0x0BCdd91bb581C6062153820955C19cdb79A7ee9b;

    uint256 public maxTransactionAmount;   
    uint256 public maxHoldingAmount;   
    uint256 public swapTokensAtAmount = 1 * (10**decimals());   

    uint256 public buyback = 2;   
    uint256 public marketingFee = 2;   
    uint256 public dividendFee = 6;
    ...
    constructor() ERC20("Merry Christmas!", unicode"圣诞节") {
        dividendTracker = new ZillaDogeDividendTracker();

        updatePancakeRouter(0xB6BA90af76D139AB3170c7df0139636dB6120F7e);  // bscmainnet
