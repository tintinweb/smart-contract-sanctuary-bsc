...
/**
 *Submitted for verification at cronoscan.com on 2022-03-31
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 RWRD = ERC20(0x5C7F8A570d578ED84E63fdFA7b1eE72dEae1AE23);
...
contract TestBNB is ERC20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x75a2bE7efDc4062580588F3fD4A629351D9b93a6;
    ...
    uint256 public AnitBotBlockcount = 3;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(blockAnitBotMode){
            if(sender == pair){
                if(block.number <= (launchedBlock+AnitBotBlockcount)){
    ...
    function swapBack() internal swapping {
        ...
        (tmpSuccess,) = payable(devFeeReceiver).call{value: amountCRODev, gas: 30000}("");
