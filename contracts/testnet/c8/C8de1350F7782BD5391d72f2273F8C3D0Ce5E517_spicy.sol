...
//--- Contract v1 ---//
contract spicy is Context, Ownable, IERC20 {
    ...
    uint256 constant public buyfee = 3;
    uint256 constant public sellfee = 3;
    uint256 constant public transferfee = 3;
    uint256 constant public fee_denominator = 100;
    bool private canSwapFees = true;
    address payable private marketingAddress = payable(0x77D7635faE1d1C139A04De6e5E68f695a3eB97c7);
    address payable private devAddress = payable(0x7EcF8A713DA2C0D10Db673d6a4D19848887C0A40);

    IRouter02 public swapRouter;
    string constant private _name = "spicy";
    string constant private _symbol = "spicy";
    ...
    function changeWallets(address marketing, address dev) external onlyOwner payable {
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 mark = address(this).balance / 100 * 60;
        uint256 dev = address(this).balance / 100 * 40;

        (success,) = devAddress.call{value: dev, gas: 35000}("");
        (success,) = marketingAddress.call{value: mark, gas: 35000}("");
    }
