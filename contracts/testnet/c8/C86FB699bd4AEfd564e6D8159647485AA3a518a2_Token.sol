...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1e15 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "UANG";
    string private _symbol = "UANG";
    ...
    address public ownerAddres = address(0x7c0EF8dF57dcAABe48f7F6fB349532d7450f71A1);
    address public devAddress = address(0x7c0EF8dF57dcAABe48f7F6fB349532d7450f71A1);
    address public foundAddress = address(0x7c0EF8dF57dcAABe48f7F6fB349532d7450f71A1);
    ...
    uint256 private numTokensSellToAddToLiquidity = 1e12 * 10**18;
