...
contract NFTLaunchPad is Initializable, OwnableUpgradeable {
    ...
    uint256 public brokerage; //Set the brokerage
...
contract NFTCollection is ERC721A, ERC2981, Ownable {
    ...
    address platformPublicKey; //Address of Public key
    uint256 brokerage; //Set the brokerage
    ...
    */
     ...
     *@param _quantity: Maximum quantity to be minted.
    ...
    function mint(
        ...
        if (brokerage > 0) {
            uint256 brokerageAmount = (msg.value * brokerage) /
