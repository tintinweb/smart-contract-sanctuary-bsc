...
contract VestingContract is Ownable, ReentrancyGuard {
	...
	/**
       	...
       	@dev Caller must be Owner
			Note:
			- The lock() set value of `locked` to `true`
    ...
    */
	...
	/**
	   	...
	   	@param _list				An array of vesting amounts per month
    */
	function setVesting(
	...
	/**
       	@notice Query the addresses of current Beneficiaries
    ...
    */
	...
	/**
       	...
       	@dev Caller can be ANY
			...
			- Beneficiaries are be able to claim after `startAt + n * PERIOD`
