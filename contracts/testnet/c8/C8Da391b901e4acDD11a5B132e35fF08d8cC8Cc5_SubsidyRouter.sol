...
contract SubsidyRouter is Policy {
    ...
    function addSubsidyController(address _bill, address _subsidyController)
        ...
        onlyPolicy
    {
        require(_bill != address(0), "SubsidyRouter: Bill cannot address zero");
        require(_subsidyController != address(0), "SubsidyRouter: Subsidy controller cannot address zero");
