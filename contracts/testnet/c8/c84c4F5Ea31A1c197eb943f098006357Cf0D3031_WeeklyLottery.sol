...
contract WeeklyLottery is Initializable, IWeeklyLottery, OwnableUpgradeable {
    ...
    mapping(uint256 => uint256) uniqueUsersCount;
    mapping(uint256 => mapping(uint256 => mapping(address => bool))) isUserUniqueCheckpoint;
    ...
    function startLottery(uint256[] calldata _bets) external {
        require(msg.sender == manager || msg.sender == owner(), "Lottery:Not manager");
