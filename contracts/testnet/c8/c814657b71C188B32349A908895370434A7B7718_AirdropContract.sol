...
contract AirdropContract is Ownable {
    uint startTime = 1659806236;
    address gscAddr = 0xb2bfAba2d0d0940041283E5a4a38Dba98aAd0AB5;
    address usdtAddr = 0xb2bfAba2d0d0940041283E5a4a38Dba98aAd0AB5;
    IERC20 gsc;
    IERC20 usdt;
    ...
    function putIn(uint _num) public {
         require(users[msg.sender].isRun == 0, "isRun error");
         require(_num == 100e18 || _num == 500e18 || _num == 1000e18 || _num == 5000e18 || _num == 10000e18, "invalid _num");
         usdt.transferFrom(msg.sender, address(this), _num);
         User memory user = User({
            outTotalNum : _num * 10000,
            isRun : 1
        });
