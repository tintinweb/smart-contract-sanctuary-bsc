...
contract ceshi is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x374FDFF8F4D05279c2A58c3C88Acbc9E2C125d4f));
        marketingWalletAddress = payable(address(0x374FDFF8F4D05279c2A58c3C88Acbc9E2C125d4f));
