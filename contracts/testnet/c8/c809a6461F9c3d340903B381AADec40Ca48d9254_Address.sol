...
contract WallStreetCats is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xd7B5fB78946f38e4cBA46d85Bd0ee2912D7de0bA;
    address public devWallet = 0x30ace0d384d8BBa0B18fb255B0C49F4D85Fc7320;
    address public operationWallet = 0xCDCd5C8bfF6383110b7De8400325C9020063faC6;
    address public charityWallet = 0xd7B5fB78946f38e4cBA46d85Bd0ee2912D7de0bA;

    string private constant _name = "CJTESTCOIN";
    string private constant _symbol = "CTCC";
    ...
    Taxes public taxes = Taxes(0, 1, 2, 0, 0, 0);
    Taxes public sellTaxes = Taxes(0, 2, 1, 0, 0, 0);
