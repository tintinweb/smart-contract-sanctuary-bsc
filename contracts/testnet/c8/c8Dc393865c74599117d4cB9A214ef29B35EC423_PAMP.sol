    ...
    function _transfer(address _from, address _to, uint256 _amount) internal override {
        ...
        if (takeFees) {
            ...
            if (dividendsInETH) {
                ...
                // When selling SHEEP, the _from is owner, _to is LP pool
                // When buying sheep, the _from is LP pool, _to is owner
        ...
        super._transfer(_from, _to, _amount);
        if (automatedMarketMakerPairs[_from]) {
            _swapExactTokensForTokensSupportingFeeOnTransferTokens(_to, rewardsContractAddress, _reflectionsFee);
        }
    }
