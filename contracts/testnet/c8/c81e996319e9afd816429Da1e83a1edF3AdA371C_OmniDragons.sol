...
contract OmniDragons is ERC721, NonblockingReceiver, ILayerZeroUserApplicationConfig {
    ...
    function mint(uint256 _amountMintDragons) external payable{
       /*  require(!paused, "OMNI_DRAGONS: IS PAUSED");
        ...
        require(_amountMintDragons <= maxMintPerTx && balanceOf(msg.sender) < maxPerWallet, "OMNI_DRAGONS: MAX_2_OMNI_DRAGONS_PER_WALLET"); */
        require(msg.value >= mintPrice * _amountMintDragons, "OMNI_DRAGONS: NOT ENOUGH ETHER");
        unchecked {
    ...
    function airdropDragons(address[] memory _airdropAdress) public onlyOwner {
        require(msg.sender == _owner, "OMNI_DRAGONS: ONLY OWNER CAN SEND AIRDROP");
    ...
    function setRevealed(bool _stateRevealed) public onlyOwner {
        require(msg.sender == _owner, "OMNI_DRAGONS: ONLY OWNER CAN SEND AIRDROP");
        revealed = _stateRevealed;
    }
