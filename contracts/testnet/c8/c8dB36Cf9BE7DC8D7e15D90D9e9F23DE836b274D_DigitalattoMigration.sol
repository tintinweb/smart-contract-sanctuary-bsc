...
contract DigitalattoMigration{
    ...
    IBEP20 public OLDTOKEN = IBEP20(0xB469F7cfD0E5921372A7D6310F661D08DEee075C);
    IBEP20 public NEWTOKEN = IBEP20(0x0023E41964290Dc6B5e49E269fbEb1eC44539865);
    // Test OLD = 0xB469F7cfD0E5921372A7D6310F661D08DEee075C
    // Test NEW = 0x0023E41964290Dc6B5e49E269fbEb1eC44539865
    ...
    function migrate(uint256 _amount) external payable {
        ...
        uint256 newtokenAmount = _amount.mul(NEWTOKEN.decimals()).div(OLDTOKEN.decimals());
