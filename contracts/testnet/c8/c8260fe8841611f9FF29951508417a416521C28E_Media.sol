    ...
    IMedia
{
    ...
    constructor() ERC721("Mad Wallet NFT", "MAD") {
        baseURI = "ipfs://";
    ...
    function _beforeTokenTransfer(
        ...
        if (from != address(0)) {
            IMarket(marketContract).removeAsk(from, tokenId);
        }
    ...
    function mintToken(
        ...
        if (!isApprovedForAll(user, marketContract)) {
            setApprovalForAll(marketContract, true);
        }
        IMarket(marketContract).setAsk(user, id, ask);
