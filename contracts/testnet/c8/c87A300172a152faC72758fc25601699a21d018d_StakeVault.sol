...
contract StakeVault is ReentrancyGuard, Ownable {
    ...
    mapping(address => uint256[]) internal allStakePositionIds;
    ...
    function getAllPositionsForAsset(
        address _stakeAsset
    ) public view returns (uint256[] memory) {
        uint256[] memory allStakes = allStakePositionIds[_stakeAsset];
        return allStakes;
    }
