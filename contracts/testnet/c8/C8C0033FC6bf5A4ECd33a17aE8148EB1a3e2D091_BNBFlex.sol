...
contract BNBFlex {
    ...
    uint256 constant MAX_WITHDRAW = 4 ether;
    uint8 constant BONUS_LINES_COUNT = 5;
    uint8 public noReinvesting;
    uint16 constant PERCENT = 1000; 
    uint8[BONUS_LINES_COUNT] public ref_bonuses = [200, 150, 100, 50, 100]; 
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        require(msg.value >= 0.0025 ether, "Minimum deposit amount is 0.0025 BNB");
		...
		uint256 amount = msg.value / 20; //5% goes to the SC owner
