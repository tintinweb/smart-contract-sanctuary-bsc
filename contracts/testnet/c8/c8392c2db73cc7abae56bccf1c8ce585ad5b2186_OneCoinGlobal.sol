...
/*
* @title  1CC Global Financial System, build in Biance Network
...
contract OneCoinGlobal is Ownable {
    ...
    address public invest_token_address = 0x98F217868F1cbFbc30559066AFa9b9276d6A6EC6;
    /* Chainlink BNB/USD proxy address */
    address public bnbusd_proxy_address = 0x14e613AC84a31f709eadbdF89C6CC390fDc9540A;
    ...
    uint256 constant public SHAREHOLDER_LIMIT_NUM = 50;
    ...
    uint256[] public yield_reduce_section4 =  [12000000, 30];
    uint256[] public yield_reduce_section5 =  [14000000, 30];
    uint256[] public yield_reduce_section6 =  [17000000, 30];
    uint256[] public yield_reduce_section7 =  [20000000, 30];
    uint256[] public yield_reduce_section8 =  [25000000, 30];
    uint256[] public yield_reduce_section9 =  [30000000, 30];
    ...
    constructor() public {
        ...
        priceFeed = AggregatorInterface(bnbusd_proxy_address);
    }
    ...
    */
        ...
        private
    {
        ...
        while(true){
            ...
            if(ref == address(0)) break;
            //referral address level can't less than current account
            if(players[ref].level_id < player_level_id) break;
