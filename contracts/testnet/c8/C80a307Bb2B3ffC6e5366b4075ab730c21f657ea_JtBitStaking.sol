...
contract JtBitStaking {
    ...
    uint256 public constant MIN_WITHDRAW = 100e9;
    ...
    function withdraw() public {
        ...
        require(totalAmount >= MIN_WITHDRAW, "User dividends less than min Limit");
        require(totalAmount >= MAX_WITHDRAW, "User dividends more than max Limit");
