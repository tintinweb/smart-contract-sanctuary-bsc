...
contract BCEO3 is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0x530176ddb8f5742bAd71CB735FEf9c95f17259fd;
    address public opsWallet = 0x046E4074BcAB713C67032DC61Be8C4F416D1Ee26;
    address public devWallet = 0xEF0D5314F55678fae7086A2cE317fb94a5D2243f;

    string private constant _name = "BabyDoge CEO3";
    string private constant _symbol = "BCEO3";
    ...
    Taxes public taxes = Taxes(6, 4, 0, 0, 0);
    Taxes public sellTaxes = Taxes(6, 4, 0, 0, 0);
    Taxes private launchtax = Taxes(6, 4, 0, 0, 0);
