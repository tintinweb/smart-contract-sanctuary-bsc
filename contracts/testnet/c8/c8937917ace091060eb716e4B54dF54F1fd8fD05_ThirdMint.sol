...
contract ThirdMint is Ownable, ReentrancyGuard, Pausable, IERC721Receiver {
    ...
    function mint() external payable nonReentrant whenNotPaused {
        ...
        require(nfts.length > 0, "nft is sold out") ;
        for(uint256 i = 0; i < nftCount; i++) {
            // create random
            uint256 indexRandom = uint256(keccak256(abi.encodePacked(msg.sender, block.difficulty, block.timestamp, nftCount, price))) ;
