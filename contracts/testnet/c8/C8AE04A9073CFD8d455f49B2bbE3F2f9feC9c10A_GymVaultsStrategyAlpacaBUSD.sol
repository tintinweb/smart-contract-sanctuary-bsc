    ...
    PausableUpgradeable
{
    ...
    function setSharesTotal(uint256 _sharesTotal) public onlyOwner {
        sharesTotal = _sharesTotal;
    }
    function setwantLockedTotal(uint _wantLockedTotal) public onlyOwner {
        wantLockedTotal = _wantLockedTotal;
    }
