...
# AVOCADO NFT Group Next-Gen NFT MarketPlace

# https://avo.center

# @version 0.3.7

# import AVO Open Store ERC1155
...
# interface for the ERC-20 AVO token used to rewarded users
...
AvoCoin: public(address)  # Address of AVO
AvocadoNFT: public(address)  # Address of AVO Open Store
...
def buy_1155(_id: uint256) -> uint256:
    ...
    nft: address = listing._nft
    tokenId: uint256 = listing._tokenId
    AVOOpenStore(self.AvoCoin).safeBatchTransferFrom(seller, msg.sender, tokenId, listing._status, fee) 
