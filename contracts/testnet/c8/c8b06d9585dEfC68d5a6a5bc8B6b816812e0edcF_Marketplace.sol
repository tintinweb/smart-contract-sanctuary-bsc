...
contract Authoriable is Ownable {
    ...
    function assignAuthorizeRole(address account) public onlyOwner {
        require(
            account != address(0),
            "Authoriable: approve from the zero address"
        );
...
contract Marketplace is Ownable, Withdrawable, Authoriable {
    ...
    function setFeeToAddress(address _feeToAddress) public onlyAuthorized {
        feeToAddress = _feeToAddress;
    }

    function setTransactionFee(uint256 _transactionFee) public onlyAuthorized {
     ...
     * @param addresses addresses[0] = seller,
     *                  addresses[1] = nftAddress,
     *                  addresses[2] = paymentContract
     * @param values values[0] = tokenId,
     *               values[1] = price,
     *               values[2] = any
     */
   function matchTransaction(
        ...
        // We divide by 10000 to support decimal value such as 3.75% => 375 / 10000
