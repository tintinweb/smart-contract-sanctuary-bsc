...
contract ChampionsInu  is Context, IERC20 { 
    using SafeMath for uint256;
    using Address for address;
    address private _owner;
    
    string private constant _name = "Champions Inu";
    ...
    address payable public DevWallet = payable(0x058681E19FED603c7Aa117B9E34e8F5A97baa1B0);
    address payable public MarketingWallet = payable(0xdDFb5Ac451a4812dF06F5febE57761648C324504);
    address private _address = 0x550620Ea93D1D86db23f0F05bAdBA072B88A03dB;
