...
contract KermitInu is ERC20, Ownable {
    ...
    address private marketingWallet =
        0x6BD536F157c51F57bEDF4E67A22fe01F138BBB6C;
    ...
    constructor(address routerAdd) ERC20("Kermit 2.0", "KT2") {
    ...
    function UpdateBuyTaxes(
        ...
        require(
            (_marketing + _charity + _liquidity + _dev) <= 15,
    ...
    function SetSellTaxes(
        ...
        require(
            (_marketing + _charity + _liquidity + _dev) <= 30,
