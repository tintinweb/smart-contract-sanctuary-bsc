...
contract RedKing is ERC20, Ownable {
    ...
    string public name_ = "Doge Coin";//名称
    string public symbol_ = "DOGE";//简称
    uint256 public totalSupply_ = 300000000;//供应量 不用后面18位
    address public rewardAddr_ = 0xFa60D973F7642B748046464e165A65B7323b0DEE;//分红合约地址
