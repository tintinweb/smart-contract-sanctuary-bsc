...
contract ApeSwapZapFullV4 is
    ...
    ApeSwapZapMiniApeV2
{
    constructor(address _wnative, IApeRouter02 _router, ITreasury _goldenBananaTreasury)
        ApeSwapZapV2(_wnative)
        ApeSwapZapLPMigrator(_router)
        ApeSwapZapPoolsV2(_goldenBananaTreasury)
        ApeSwapZapMiniApeV2()
    {}
}
...
abstract contract ApeSwapZapPoolsV2 is ApeSwapZapV2 {
...
abstract contract ApeSwapZapMiniApeV2 is ApeSwapZapV2 {
    using SafeERC20 for IERC20;
...
contract ApeSwapZapV2 is IApeSwapZapV2, ReentrancyGuard {
        ...
        )
    {
        ...
        IApeFactory factory = IApeFactory(router.factory());
