...
contract TKOPower is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor(address _tko) ERC20("TKO Power", "TKO-POWER") {
        ...
        claimLockPeriod = 7 minutes;
    }
 
    function setLockPeriod(uint256 _lockPeriod) external onlyOwner {
        lockPeriod = _lockPeriod * 1 minutes;
    }
 
 
    function setClaimLockPeriod(uint256 _claimLockPeriod) external onlyOwner {
        claimLockPeriod = _claimLockPeriod * 1 minutes;
    }
    ...
    function lock(uint256 amount) external nonReentrant {
        ...
        TKO.safeTransferFrom(who, address(this), amount);
        stakedAmount[who] += amount;
    ...
    function unlock() external nonReentrant {
        ...
        claimTime[who] = timestamp+claimLockPeriod;
        stakeTime[who] = 0;
    ...
    function claim() external nonReentrant {
        ...
        require(claimTime[who] < block.timestamp, "Claim Locked Period Not Passed");
        uint256 tkoAmount = stakedAmount[who];
