...
contract ParagonSwap is Paragon {
    ...
    uint256 public pegRate = 100; //<--------------------------------- n tokens per 1 BUSD
    ...
    mapping(address => int256)  public costBasis; //<----------------- stores users cost basis
        ...
        address _adminRecovery)
    {
        ...
        setHistoricalPeg(currentEpoch, pegRate); //<------------------ store peg rate (at epoch 0)              [NOW REDUNDANT][NOW REDUNDANT][NOW REDUNDANT][NOW REDUNDANT]
    ...
    function coreRebase(uint256 supplyDelta) private {
        ...
        setHistoricalPeg(currentEpoch, pegRate);
    ...
    function setCostBasis(address atAddress, int256 toAmount) private {
        costBasis[atAddress] = toAmount;
    }

    function getCostBasis(address atAddress) public view returns (int256) {
        return costBasis[atAddress];
    }
