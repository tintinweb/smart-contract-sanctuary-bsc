...
contract BEP20Nitrox is Context, IBEP20, Ownable {
 ...
 function updateTotalBuyFee() public onlyOwner {
     totBuyFee = buyFees._liquidityBuyFee + buyFees._devBuyFee + buyFees._playToEarnBuyFee + buyFees._burnBuyFee + _reflectionFee;
 }

 function updateTotalSellFee() public onlyOwner {
     totSellFee = sellFees._liquiditySellFee + sellFees._devSellFee + sellFees._playToEarnSellFee + sellFees._burnSellFee + _reflectionFee;
 }
