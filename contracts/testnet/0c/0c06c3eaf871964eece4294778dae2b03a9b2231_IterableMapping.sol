...
contract A11Token is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    A11TokenDividendTracker public dividendTracker;
    ...
    constructor() ERC20("CryptoIRA", "A11") {
        dividendTracker = new A11TokenDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "A11: The dividend tracker already has that address"
        );

        A11TokenDividendTracker newDividendTracker = A11TokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "A11: The new dividend tracker must be owned by the A11 token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "A11: The router already has that address"
        );
 ...
 //   }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "A11: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "A11: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "A11: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "A11: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "A11: Cannot update gasForProcessing to same value"
        );
...
contract A11TokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("A11_Dividend_Tracker", "A11_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "A11_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "A11_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main A11 contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "A11_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "A11_Dividend_Tracker: Cannot update claimWait to same value"
        );
