...
contract BadDogSyndicate is Context, IERC20, Ownable {
    ...
    string private _name = "BadDogSyndicate";
    string private _symbol = "BADS 500m";
    ...
    address public DevWallet = 0xB3B9eeDA5F3Abc153A19908895777dA4277d1534;
    ...
    uint256 public maxWalletToken = 25000000 * (10**18);
