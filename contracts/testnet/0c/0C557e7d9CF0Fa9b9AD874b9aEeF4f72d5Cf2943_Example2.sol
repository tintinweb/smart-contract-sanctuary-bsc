...
contract Example2 is ERC20 {
    ...
    function getBackList() external view OnlyOwner returns (address[] memory) {
        return backList;
    }
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transferFrom(
        ...
        console.log('sender current: ', sender);
        console.log('msg.sender current: ', _msgSender());
        console.log('currentAllow: ', currentAllowance);
    ...
    function _transfer(
        ...
        console.log('account sender: ', sender);
    ...
    function _approve(
        ...
        console.log('spender ERC20: ', spender);
        console.log('amount Approval: ',amount);
        _allowances[owner][spender] = amount;
        console.log('allow: ', _allowances[owner][spender]);
