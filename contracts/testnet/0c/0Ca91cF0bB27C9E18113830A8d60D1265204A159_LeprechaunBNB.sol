...
contract LeprechaunBNB {
    ...
    function CompoundRewards(bool isCompound) public {
        ...
        if (msg.sender == dev1){buyGoldhiminers();}
    ...
    function startLeprechaun(address addr) public payable{
        if (!contractStarted) {
    		if (msg.sender == dev1) {
    ...
    /* How many Gold per day user will receive based on BNB deposit */
    ...
    function buyGoldhiminers() private{
