...
contract WorldCupNFT is SafeOwnable, NFTCoreV2, Mintable, Burnable, IMintableBurnableERC721 {

    constructor(
        string memory _name, 
        string memory _symbol, 
        string memory _uri
    ) NFTCoreV2(_name, _symbol, _uri, 3840) Mintable(new address[](0), false) Burnable(new address[](0), false) {
    }
