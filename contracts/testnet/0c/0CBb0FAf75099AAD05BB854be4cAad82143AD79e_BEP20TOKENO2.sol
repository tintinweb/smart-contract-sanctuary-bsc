...
contract BEP20TOKENO2 is Context, IBEP20, Ownable {
    ...
    address[10] public _addresses;//配置钱包地址
    uint256[10] public _percents;//配置奖项


    address public _usdt=address(0xD05A097B1Dc5Bd0733b9460fa562497278F55E36);//test
    address public _rbl=address(0xD05A097B1Dc5Bd0733b9460fa562497278F55E36);//test 母币地址
    address public _o2Staking;//test 质押合约
    // address public _usdt=address(0x55d398326f99059fF775485246999027B3197955);//main
    // address public _rbl=address(0xD05A097B1Dc5Bd0733b9460fa562497278F55E36);//main
    // address public _o2Staking;//main
