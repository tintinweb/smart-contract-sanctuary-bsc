...
contract clock24 is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("C24", "C24", uint8(DECIMALS)) Ownable() {
        ...
        router = IPancakeSwapRouter(0x3E2b14680108E8C5C45C3ab5Bc04E01397af14cB); 
        pair = IPancakeSwapFactory(router.factory()).createPair(
            router.WETH(),
            address(this)
        );
      
        autoLiquidityReceiver = 0x62D6813185A677E57975343260036A48CF74B162;
        treasuryReceiver = 0x62D6813185A677E57975343260036A48CF74B162; 
        clockInsuranceFundReceiver = 0x62D6813185A677E57975343260036A48CF74B162;
        firePit = 0x62D6813185A677E57975343260036A48CF74B162;
