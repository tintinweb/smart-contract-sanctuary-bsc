...
contract Nitu is ERC20, Ownable, SupportToken {

	address public CONTRACT_MINING_POOL = address(0);
	address public ADMIN_ADDRESS = 0xb07c035e4fbE2A4Fc3804b168852E9a737094589;
	...
	function mint(uint256 amount) public {
		require(CONTRACT_MINING_POOL != address(0), "Can not mining zero address");
		require(ADMIN_ADDRESS == msg.sender, "You can not mining");
		require(amount + totalSupply() <= MAX_SUPPLY, "Limit mining token");
		_mint(CONTRACT_MINING_POOL, amount);
	}
