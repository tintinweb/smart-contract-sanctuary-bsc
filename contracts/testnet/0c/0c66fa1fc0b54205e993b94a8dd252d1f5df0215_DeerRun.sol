...
contract DeerRun is IBEP20, Ownable {
    ...
    // Name and symbol
    string constant _name = "thou";
    string constant _symbol = "DDEE";
    ...
    uint256 rewardFee;
    uint256 totalFee;
    uint256 amountXmasReward;
    uint256 holdersCount;
    uint256 xmasDate = 1668297909;
    ...
    function swapBack() internal {
        ...
        amountXmasReward = amountXmasReward.add(amountBNB.mul(rewardBNB).div(totalBNBFee));
    ...
    function recieveXmasReward(address reciever) external {
        require(!hasAlreadyClaimed[msg.sender], "already claimed tokens");
        require(balanceOf(reciever) > 500 * (10** _decimals), "you don't hold the min amount of Deer Run tokens");
