...
contract KingCorgiChain is ERC20, Ownable {
    ...
    function changeDevWallet(address _devWallet) external onlyOwner {
        ...
        require(!_devWallet.isContract(), "Dev wallet cannot be a contract");
    ...
    function changeCharityWallet(address _charityWallet) external onlyOwner {
        ...
        require(
            !_charityWallet.isContract(),
            "Charity wallet cannot be a contract"
        );
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 buybackBNB;
            if (buybackShare > 0) {
                buybackBNB = (newBalance * buybackShare) / totalFee;
            ...
            if (busdShare > 0) {
                ...
                uint256 currentBalance = IERC20(busdAddress).balanceOf(address(this)) - initialBalance;
