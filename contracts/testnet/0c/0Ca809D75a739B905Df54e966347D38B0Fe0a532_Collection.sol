...
function getRoundDetails() public view returns(uint256 _roundId, uint256 startTime, uint256 endTime, uint256 price, uint256 userPurchaseLimit, uint256 maxSupply) {
