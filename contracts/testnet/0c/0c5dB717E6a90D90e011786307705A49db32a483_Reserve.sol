...
contract Reserve {
    ...
    IUniswapV2Router02 private uniswapV2Router = IUniswapV2Router02(0xF491e7B69E4244ad4002BC14e878a34207E38c29);
    ...
    modifier onlyTeam() {
        require(msg.sender == address(teamAddress), "Must be Sheqel Token");
        _;
    }
    ...
    function _processSell(address _beneficiary, uint256 _shqAmount) internal {
        ...
        // Making the user pay
        require(sheqelToken.transferFrom(msg.sender, address(this), usdcAmount), "Deposit failed");
