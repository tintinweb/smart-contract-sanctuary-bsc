...
contract INOBami is Ownable, ReentrancyGuard, IERC721Receiver {
    ...
    function BuyNft(uint256 purchaseQuantity) public {
        ...
        userTotalPrice = NftQuantityPerUser[msg.sender] * priceNft;
    ...
    function ClaimNft() external nonReentrant{
        ...
        if(priorWhiteList[msg.sender]==true){
            require(IERC20(tokenAddress).balanceOf(msg.sender)>=NftQuantityPerUser[msg.sender] * priceNft, "Not enough balance to pay");
            IERC20(tokenAddress).safeTransferFrom(msg.sender,devWallet,NftQuantityPerUser[msg.sender] * priceNft);
    ...
    function Staking(uint256 _levelStakeId) external nonReentrant{
        ...
        emit StakingComplete(_levelStakeId, amountOfLevelStake, maxNumberOfNftToBuy);
    }
