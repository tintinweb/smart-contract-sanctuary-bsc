...
contract Shiba {
    ...
    //address private tokenAddr = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; // Shiba mainnet
    address private tokenAddr = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // BUSD testnet
	IERC20 public token;

	//uint256 constant public INVEST_MIN_AMOUNT = 1000 ether; //shiba mainnet
	uint256 constant public INVEST_MIN_AMOUNT = 1 ether; //shiba testnet
	...
	function getUserDividends(address userAddress) public view returns (uint256) {
		...
		for (uint256 i = 0; i < user.deposits.length; i++) {
            ...
            //uint256[3] memory durationArray = [depositStartDate.add(1 days), depositStartDate.add(2 days), depositStartDate.add(3 days)]; mainnet
			uint256[3] memory durationArray = [depositStartDate.add(60), depositStartDate.add(120), depositStartDate.add(180)]; // testnet
