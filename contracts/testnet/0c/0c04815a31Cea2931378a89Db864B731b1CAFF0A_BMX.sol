...
contract BMX is Ownable, Stakeable {
    ...
    constructor(
        ...
        // Add 10% of maxSupply to the creator of the token
        _balances[msg.sender] = token_maxSupply / 10;
        _totalSupply += token_maxSupply / 10;
    }
    ...
    function buyToken(uint256 amount) external payable {
        ...
        require(msg.value >= (amount * _tokenPrice), "BMX: Insufficient fund");
     ...
     * 4 : 24 months staking
     */
    function stake(uint256 _amount, uint8 method) external {
    ...
    function withdraw(uint256 amount) public onlyOwner {
        require(address(this).balance < amount, "Cant withdraw more than have");
