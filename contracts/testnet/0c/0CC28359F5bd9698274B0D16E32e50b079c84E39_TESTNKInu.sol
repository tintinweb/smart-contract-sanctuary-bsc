...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BUSD = IBEP20(0x999f54Faf83824509371Ad7D4864Ed23EA64A927);
...
/* Token contract */
contract TESTNKInu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BUSD = 0x999f54Faf83824509371Ad7D4864Ed23EA64A927; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xF3066817b5Ab468198828AdFd716466BE4Eb7c5b;
    ...
    // Name and symbol
    string constant _name = "the testk inu";
    string constant _symbol = "testk inu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 9900 / 10000; // 4% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 9900 / 10000; // 4% or 5M tokens
    ...
    uint256 public swapThreshold = _totalSupply * 69 / 10000; // 2% of supply
