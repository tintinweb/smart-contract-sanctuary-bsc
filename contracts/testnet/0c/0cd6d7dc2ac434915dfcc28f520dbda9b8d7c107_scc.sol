...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    // Contract Name
contract scc is Context, IERC20 {
    ...
    //Mian Net (0x10ED43C718714eb63d5aA57B78B54704E256024E);
    // address private _routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    address public ZERO = 0x0000000000000000000000000000000000000000;
    // Important change your wallets:
    address payable private _marketingWallet = payable(0x48016eCe62Ed7CA6a07A38055635C4e170773aBb);
    address payable private _developmentWallet = payable(0x48016eCe62Ed7CA6a07A38055635C4e170773aBb);
...
//===============================================================================================================
    ...
    function setNewDEXRouter(address newRouter) public onlyOwner() {
