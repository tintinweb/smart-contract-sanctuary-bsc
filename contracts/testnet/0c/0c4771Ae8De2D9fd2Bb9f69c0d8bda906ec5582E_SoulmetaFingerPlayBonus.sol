...
//*
    function setUserData(address player, uint nft, uint accumulate, uint cumulative, uint lastSettleDay_) public  {
    ...
    function setUserDayData(uint day, address player, uint nft) public  {
        userPledge[day][player].nft = nft;
    }

    function setTotalDayData(uint day, uint nft) public  {
        totalPledge[day].nft = nft;
    }

    function setBonusPool(uint day, uint count) public  {
        bonusPool[day] = count;
    }

    function setMoneyRate(uint day, uint count) public  {
        moneyRate[day] = count;
    }
//*/
