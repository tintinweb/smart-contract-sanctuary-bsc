...
contract BNBBets_Prediction is Ownable, Pausable, ReentrancyGuard {
    ...
    function executeRound() external whenNotPaused onlyOperator {
        ...
        if(rounds[currentEpoch -1 ].closePrice > 0){
     ...
     function HouseBet(uint256 epoch) public onlyAdminOrOperator whenNotPaused notContract 
    {
        require(epoch == currentEpoch, "Bet is too early/late");
        require(_bettable(epoch), "Round not bettable");
     ...
     * @dev Callable by admin
     */
    function seHouseBetAmount(uint256 _betAmount) external onlyAdmin {
     ...
     * @dev Callable by admin
     */
    function seHouseBetEnable(bool status) external onlyAdmin {
