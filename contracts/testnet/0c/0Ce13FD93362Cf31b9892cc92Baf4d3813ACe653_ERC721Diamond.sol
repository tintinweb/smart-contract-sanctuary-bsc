...
contract ERC721Diamond {
    event ERC721DiamondInitialized(
        ...
        string symbol,
        address owner,
        IDiamondCut.FacetCutInitializable[] initializableDiamondCut,
    ...
    function initialize(
        ...
        address owner,
        IDiamondCut.FacetCutInitializable[] memory initializableDiamondCut,
        ...
        LibDiamond.diamondCutInitializableWithoutInit(
