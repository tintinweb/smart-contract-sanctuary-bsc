...
contract MebStake is Ownable {
    ...
    address public xMeb = 0x9B6A5B706e1f92dEA887F317296Bc3Ce93604bF5;
    ...
    uint256 public punishMulti = 1.5 * 1e18; //需 x  10**18
    ...
    function withdraw(
        ...
        if (pool.lockSecond == 0) {
            ...
            uint256 xMebAmount = _amount.mul(poolInfos[_pid].xMebExchangeRate).div(1e18); // 需销毁的金额
