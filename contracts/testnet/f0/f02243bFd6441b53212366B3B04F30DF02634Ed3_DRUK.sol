...
contract DRUK is Context, IERC20, Ownable {
    ...
    function addLiquidity(
        ...
        uint deadline
            ...
            (amountA, amountB, liquidity) = uniswapV2Router.addLiquidityETH{value: msg.value}(address(this), amountADesired, amountAMin, amountBMin,  address(this), block.timestamp + 2 minutes);
            lpamount = liquidity;
    }
