...
contract HotDao is Context, IBEP20, Ownable, PancakeTool {
    ...
    uint256 private _maxDeals = 7 * size;
    uint256 private _maxHold = 20 * size;

    uint256 private rewardMin = 20000000000000000000;
    ...
    function _beforeTransfer(
        ...
        if (sender == PancakePair && recipient == _PancakeRouter) {
            ...
            require(
                aBalance <= _maxHold,
                "The maximum number of holdings is 20"
            );
            ...
            require(amount <= _maxDeals, "The maximum number of deals is 7");
        } else {
            require(amount <= _maxDeals, "The maximum number of deals is 7");
            uint256 aBalance = _balances[recipient] + amount;
            require(
