...
contract UberTaxiController5 is Ownable {
    ...
    constructor() {
        ...
        UTD = UberTaxiDate(0x573683C3541Bb0B474b8aB18298d728A16F51AD7);
    ...
    function exchange(uint256 exchangeNum) public {
        ...
        UTBC.TaxiTransfer(UTD.depositAddress(), msg.sender, exchangeNum.mul(10 ** 16) * (100 - UTD.serviceCharge()));
    }
