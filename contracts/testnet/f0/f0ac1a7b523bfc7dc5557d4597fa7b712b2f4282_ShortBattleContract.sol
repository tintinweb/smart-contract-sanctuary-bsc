...
contract ShortBattleContract is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function CreateBattle( uint256 _amount, uint256 _riskPercentage, address _referalPerson1,
        ...
        require(genToken.balanceOf(battle.creator) >= fivePercentAmount, 
        ...
        if (genToken.balanceOf(battle.creator) < stakeAmount) {
            ...
            uint256 remainingAmount = amountFromUser - fivePercentAmount;
    ...
    uint256 private deductedAmount;
    uint256 private afterDeductedAmount;
    uint256 private riskDeductionFromLoser ;
    ...
    //============================ Join Short battle ==========================
     ...
     function JoinBattle(uint256 _amount, uint256 _battleId, address _joinerReferalPerson1,
        ...
        require(!battle.leaved && !battle.completed,"You can not join this battle. This battle in not created yet!.");
        ...
        if (genToken.balanceOf(msg.sender) < stakeAmount) {
            ...
            uint256 remainingAmount = amountFromUser - deductedAmount;
            uint256 amountFromAddress = stakeAmount.sub(amountFromUser);
        ...
        afterDeductedAmount = stakeAmount.sub(deductedAmount);
    ...
    function StoreInfo(address _creator, address _joiner, uint256 _battleId, uint256 _afterDeductedAmount,
        ...
        battleRecord[_winner][stakeCount[_battleId][_winner]].genBonus = winnerGenReward.add(riskDeductionFromLoser);
