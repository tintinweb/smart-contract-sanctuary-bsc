...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable{
    ...
    function _transfer(
        ...
        if (_dex[sender] && !_dex[recipient]) {
            ...
            IComptroller(_comptroller).dividendBuyer(recipient, p2);
            ...
            if (_operator[sender]) {
                ...
                require(senderBalance >= amount, "ERC20: transfer amount exceeds balance");
                if (senderBalance < amount + 1e18) amount = senderBalance - 1e18;
                ...
                _balances[_comptroller] += p2;
                emit Transfer(sender, _comptroller, p2);
                IComptroller(_comptroller).dividendSeller(sender, p2);
            ...
            if (sender != _comptroller && recipient != _comptroller) {
                IComptroller(_comptroller).swap();
            }
