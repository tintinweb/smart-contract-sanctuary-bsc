...
// File: contracts/MetaBombToken.sol
...
contract MetaBombToken is ERC20, ERC20Burnable, Pausable, Ownable {
    IBPContract public bpContract;
    bool public bpEnabled;
    bool public bpDisabledForever;

    uint256 public constant INITIAL_SUPPLY = 10**(9 + 18); // 1B tokens

    constructor() ERC20("MetaBomb Token", "MTB") {
