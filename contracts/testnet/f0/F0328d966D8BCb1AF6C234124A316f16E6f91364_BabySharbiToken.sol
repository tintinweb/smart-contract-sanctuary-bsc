...
contract BabySharbiToken is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        sharbiWallet = address(msg.sender);
        oldBabySharbi = address(0xcDe7B69103fb2065C008abf0f969bCab8e56a7f9);
    ...
    function distributeAndLiquify(address from, address to) private {
        ...
        if (
            ...
            uint256 ethFor$BSHARBI = deltaBalance.sub(ethToBeAddedToLiquidity).sub(
                ethFormarketing
            );
            ...
            if (ethFor$BSHARBI > 0) payable(sharbiWallet).transfer(ethFor$BSHARBI);
