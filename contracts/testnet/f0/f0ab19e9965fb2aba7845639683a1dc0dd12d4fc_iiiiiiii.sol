...
contract iiiiiiii is Context, ERC20, Ownable {
    using SafeMath for uint256;
    ...
    huchaDividendTracker public dividendTracker;
    ...
    constructor() ERC20 (".money", "HHA") {
    	...
    	dividendTracker = new huchaDividendTracker();

    	liquidityWallet = 0x63C429e356D043B5808316292A25a32c9D1174F4;
		
		marketingWallet = payable(0x593299A04cec407295352A89071CA6E49634e28b);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        huchaDividendTracker newDividendTracker = huchaDividendTracker(payable(newAddress));
...
contract huchaDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("hucha_Dividend_Tracker", "hucha_Dividend_Tracker") {
    	claimWait = 1800;
