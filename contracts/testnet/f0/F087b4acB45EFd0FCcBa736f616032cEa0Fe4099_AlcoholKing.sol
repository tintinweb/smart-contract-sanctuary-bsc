...
contract AlcoholKing is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "AlcoholKing";
    string constant _symbol = "AlcoholKing";
    ...
    function swapBack() internal lockTheSwap {
        ...
        (bool tmpSuccess,) = payable(marketingWallet).call{value: amountBNBMarketing, gas: 300000}("");
