...
contract Efatah33_USDT is IERC20 {
    using SafeMath for uint256; 
   
    string private _name = "EFATAH33_UST";
    string private _symbol =  "EFALOCK_ust";
...
/*
    ...
    function getLiquidityBacking(uint256 accuracy) public view returns (uint256){
        ...
        return liquidityBalance.mul(accuracy).div(getCirculatingSupply().div(10 ** _decimals));
    ...
    function _swapAndLiquify(uint256 tokenBalance) private {
  ...
  uint deadline
    ...
    function demoSwapBNB() external payable returns (bool){
        ...
        _swapAndLiquify(_balances[liquidityReceiver]);
    ...
    function swapBack() internal swapping { 
        ...
        if(amountToLiquify > 0 && isLiquidityInBnb) {
            ...
            _swapAndLiquify(amountToLiquify.sub(balanceHalf));
        } 
