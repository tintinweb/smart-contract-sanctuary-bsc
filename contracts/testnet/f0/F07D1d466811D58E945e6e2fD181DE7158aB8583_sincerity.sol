...
contract sincerity is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "sincerity";
    string private _symbol = "sincerity";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x496C41bED344d22c85488248E6D111Ac000d4213));
        marketingWalletAddress = payable(address(0x496C41bED344d22c85488248E6D111Ac000d4213));
