...
contract KNSTOKEN is ERC20Upgradeable, OwnableUpgradeable {
    ...
    event SwapBuy(address indexed sender, uint indexed amountUsdtIn, uint indexed amountKnsOut);
    event SwapSell(
        address indexed sender,
        uint indexed amountKnsIn,
        uint indexed amountUsdtOut
    );
    event AirDrop(
    ...
    function testEvent() external {
        emit SwapBuy(msg.sender, 1 ether, 2 ether);
        emit SwapSell(msg.sender, 2 ether, 1 ether);
    }
