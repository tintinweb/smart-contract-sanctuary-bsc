...
contract BLDOGE is Context, IERC20, Ownable {
    ...
    mapping (address => bool) liquidityLaunched;
    ...
    address payable private _appAddress = payable(0x4C9d56329bf90fcd551568b1F4544fCdb6471c7B);
    address payable private _marketingAddress = payable(0x9cce34F7aB185c7ABA1b7C8140d620B4BDA941d6);
    address payable private _buybackAddress = payable(0x8608dbaaEc0f1920100f75c719b39EAB1914801e);
    address payable private _burnAddress = payable(0x913AA378286a0e15bEC0ab5fB07Cc9484a6D6735);
    ...
    constructor () {
        ...
        liquidityLaunched[uniswapV2Pair] = true;
    ...
    payable(0x4B7Fd1771C8E479348ADF87a2aebE57162469FC0);
    ...
    function setSnipeBlocks(uint8 _blocks) external onlyOwner {
        require(!liquidityLaunched[uniswapV2Pair]);
        snipeBlocks = _blocks;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != address(_PresaleAddress)) {
            if(liquidityLaunched[uniswapV2Pair] && block.number <= lastSnipeTaxBlock && !isFirstLaunch){
        ...
        if (liquidityLaunched[uniswapV2Pair] && isFirstLaunch){
            isFirstLaunch = false;
        }
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(redisFeeOnBuy < 6, "Redis cannot be more than 5.");
	    require(redisFeeOnSell < 6, "Redis cannot be more than 5.");
