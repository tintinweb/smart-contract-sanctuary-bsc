...
import { ERC721WithPermitUpgradable } from "./ERC721WithPermitUpgradable.sol";
import { ERC721URIStorageUpgradeable } from "./ERC721URIStorageUpgradeable.sol";

contract ERC721Full is Initializable, ERC721WithPermitUpgradable, ERC721URIStorageUpgradeable, ERC721BurnableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) public override(ERC721AUpgradeable, ERC721WithPermitUpgradable) {
        super.transferFrom(from, to, tokenId);
    }

    function supportsInterface(bytes4 interfaceId) public view override(AccessControlUpgradeable, ERC721AUpgradeable, ERC721WithPermitUpgradable) returns (bool) {
 ...
 */
abstract contract ERC721BurnableUpgradeable is Initializable, ContextUpgradeable, ERC721AUpgradeable {
...
abstract contract ERC721WithPermitUpgradable is Initializable, ERC721AUpgradeable, IERC4494 {
