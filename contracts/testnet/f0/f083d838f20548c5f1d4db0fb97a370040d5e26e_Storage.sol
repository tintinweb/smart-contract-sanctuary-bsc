 ...
 */
contract Storage is EIP712Upgradeable {
    ...
    ItemVoucherStruct public voucherStruct;
    ...
    function createStruct(ItemVoucherStruct calldata data) public payable {
        voucherStruct.id = data.id;
        voucherStruct.itemType = data.itemType;
        voucherStruct.extraType = data.extraType;
        voucherStruct.price = data.price;
        voucherStruct.tokenAddress = data.tokenAddress;
        voucherStruct.nonce = data.nonce;
        voucherStruct.signature = data.signature;
        signer = _verifyItemVoucher(data);
    }
    ...
    function getStruct() public view returns ( ItemVoucherStruct memory) {
        return voucherStruct;
    } 
}