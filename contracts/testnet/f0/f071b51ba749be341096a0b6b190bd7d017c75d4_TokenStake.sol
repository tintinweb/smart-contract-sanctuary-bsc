...
contract TokenStake is Member {
    ...
    event WithdrawRequest(address _user, address _token);
    event Withdraw(address _user, address _token, uint256 _amount);
    event GetReward(address _user, address _token, uint256 _amount);
    event Deposit(address _user, address _token, uint256 _amount);
    ...
    function deposit(uint256 amount) public {
        ...
        emit Deposit(msg.sender, address(stakeToken), amount);
    }
    ...
    function getReward() public {
        ...
        emit GetReward(msg.sender, address(stakeToken), reward);
    }
    ...
    function withdraw() public {
        ...
        emit Withdraw(msg.sender, address(stakeToken), pendingWithdraw);
        pendingWithdraw = 0; // TODO:?
    }
    ...
    function withdrawRequest() public {
        ...
        emit WithdrawRequest(msg.sender, address(stakeToken));
    }
