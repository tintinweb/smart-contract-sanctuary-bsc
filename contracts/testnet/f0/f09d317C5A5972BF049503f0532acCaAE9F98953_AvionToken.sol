...
contract AvionToken is Initializable, ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable  {
    ...
    function initialize(address usdcAddress, address _router, address _avionNFT) public initializer {
        ...
        rewardYields = [46875, 93750, 140625, 187500];
    ...
    function _transferFrom(
        ...
        require(blacklist[sender] == false && blacklist[recipient] == false, "You're blacklist");
