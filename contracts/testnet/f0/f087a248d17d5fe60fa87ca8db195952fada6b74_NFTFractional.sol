...
contract NFTFractional is Upgradable, ERC20Upgradeable {
    ...
    */
    ...
    function minNFT(
        address _receiver,
        uint256 _tokenId,
        bytes memory _data) external onlyAdmins {
        require(bytes(NFTToken(nftToken).baseURI()).length > 0, "baseURI not empty");
        NFTToken(nftToken).mintNFT(_receiver, _tokenId, _data);
        emit MintNFT(_receiver,_tokenId, _data);
    }
    ...
    function fractionalizeNFT(
        ...
        uint256 _id,
        string memory _name,
        string memory _symbol) external onlyAdmins {
            ...
            fractionalNFTs[_id] = tokenVaultInfo;
