...
import "../token/ERC20/BithotelGovernanceTokenUpgradeable.sol";

contract BithotelGovernorUpgradeable is 
    Initializable,
    ...
    UUPSUpgradeable 
{
    ...
    function initialize(
        string memory name_,
        BithotelGovernanceTokenUpgradeable token_,
        ...
        public initializer
    {
        ...
        __BithotelGovernor_init_unchained(name_, token_, votingDelay_, votingPeriod_, timelock_, quorumNumerator_, owner_);
    }

    // solhint-disable-next-line func-name-mixedcase
    function __BithotelGovernor_init_unchained(
        string memory,
        BithotelGovernanceTokenUpgradeable,
        uint256,
        uint256,
...
contract BithotelGovernanceTokenUpgradeable is Initializable, ERC20Upgradeable, AccessControlUpgradeable, PausableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, UUPSUpgradeable {
    address private _sTimelockController;
    bool public initializerRan;
    bytes32 public constant UPGRADER_ROLE = keccak256("UPGRADER_ROLE");

    modifier onlyTimelock(address timelockController_) {
        // solhint-disable-next-line reason-string
        require(timelockController() == timelockController_, "BithotelGovernanceToken: not an timelock controller address.");
        _;
    }
    ...
    constructor() initializer {
     ...
     function initialize(
        ...
        __Pausable_init();
        __UUPSUpgradeable_init();
        __BithotelGovernanceToken_init_unchained(
            name_,
            symbol_,
            initialSupply,
            owner_,
    ...
    // solhint-disable-next-line func-name-mixedcase
    function __BithotelGovernanceToken_init_unchained(
        string memory,
        string memory,
        uint256 initialSupply,
        address owner_,
        ...
        _sTimelockController = timelockController_;
        initializerRan = true;
    }
    ...
    function setTimelock(address timelockController_) external virtual {
        _beforeSetTimelock(timelockController_);
        _sTimelockController = timelockController_;
        emit TimelockChanged(timelockController_);
    }
    ...
    /**
     * @dev Hook that is called before setTimelock.
     */
    function _beforeSetTimelock(address timelockController_) 
        internal 
        virtual 
        onlyTimelock(_msgSender()) 
    {
        // solhint-disable-next-line reason-string
        require(timelockController_ != address(0), "BithotelGovernanceToken: timelock controller is the zero address");
        // solhint-disable-next-line reason-string
        require(timelockController_ != timelockController(), "BithotelGovernanceToken: timelock controller already updated");
    }
