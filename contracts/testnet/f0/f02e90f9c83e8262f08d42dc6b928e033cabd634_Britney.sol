...
// LEAVE BRITNEY ALONE
//
// 4% reflections in BUSD to those that want people to leave Britney the hell alone
// 8% to liquidity to minimize volatility over time
...
contract Britney is IBEP20, Ownable {
    using SafeMath for uint256;
    string constant _name = "Leave Britney Alone";
    string constant _symbol = "BRITNEY";
    ...
    address public marketingFeeReceiver = 0xEE9C2c3c5cBFc2884cb8b67709a1FD73966A782D;
    address public buybackFeeReceiver = 0xEE9C2c3c5cBFc2884cb8b67709a1FD73966A782D;
