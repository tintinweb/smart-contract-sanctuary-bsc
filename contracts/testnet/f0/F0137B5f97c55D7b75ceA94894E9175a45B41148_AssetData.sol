...
contract AssetData {
    ...
    function addAsset(address _aa, address _va) public onlyController onlyNew(_aa) {
    ...
    function deleteAsset(address _assetAddress, address _vaultAddress) public onlyController { 
