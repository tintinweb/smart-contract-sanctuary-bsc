    ...
    ReentrancyGuard
{
    ...
    uint256 public packIn6hours = 60;
    ...
    AETHR_StarterPack public PackFactory;
    IERC20 public BUSD;
    ...
    function initialize(
        ...
        PackFactory = AETHR_StarterPack(_PackFactory);
    ...
    Ownable
{
    ...
    constructor() ERC721("AETHR_NFT", "ATHN") {}
    ...
    function initialize(
        ...
        _setupRole(MINTER_ROLE, packAddress);
    }
...
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";
import "./aethr-nft.sol";
import "./aethr-userpool.sol";

contract AETHR_StarterPack is
    ERC721,
    AccessControlEnumerable,
    ERC721Enumerable,
    Ownable,
    ReentrancyGuard
{
    ...
    constructor() ERC721("Aethr Pack", "ATHP") {}
    ...
    function openStarterPack(uint256 boxId) public checkOpenPack(boxId) {
        ...
        Pool.augmentPoolATH(msg.sender, totalATHInPack);
        isOpen[boxId] = true;
...
contract UserPool is AccessControlEnumerable, Ownable, ReentrancyGuard {
    ...
    function initialize(address _BUSD, address _ATH) public onlyOwner {
        BUSD = IERC20(_BUSD);
        ATH = IERC20(_ATH);
        BUSD.approve(
            address(this),
    ...
    function convertATH(uint256 amount) public nonReentrant {
        ...
        emit converATH(_msgSender(), amount);
    }
    ...
    function withdrawATH(uint256 total, address user) public nonReentrant {
