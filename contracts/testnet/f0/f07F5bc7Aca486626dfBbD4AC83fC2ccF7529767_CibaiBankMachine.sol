...
contract ERC20 is IERC20 {
    ...
    function _mint(address account, uint256 amount) internal {        require(availableSupply() >= amount, "Supply exceed");
...
contract CibaiBankMachine is Token {
    ...
    uint public USER_SELL_LIMIT        = 1000 ether; 

    mapping(address => User) private users;
    mapping(uint => uint) private sold; 
    mapping (address => mapping (uint => uint)) private soldIndividual;
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = 0x31500fb0e733f3D040ecAd3958262d4167732c3a;                                  // e
        DEV_2 = 0xBB47341032afdF3495C8E8c197bf15500bfc878a;  // N
        ADV_1 = 0xdE392d76983156ceB0985Ec8a2306E825339d00A;  // 0         
        ADV_2 = 0x829a1f2f7A34a3De019714C9F3260AEE33EB536c;  // E        
        ADV_3 = 0xd20994b00ee7348a9064ea386cFD8b2FCFFEfbc7;  // o 
        ADV_4 = 0xBdD45E3F425E546DADB600Fb75CE5Cea7a851F70;  // au    
        FIN_1 = 0x457E484069E17E41E812F635F84258020808C301;  // S   
        FIND_1 = 0xE8179CbAD9B5774A07f3A902D69F12792EfDB1Da; // ll
        MAR_1 = 0xe0c7eE70F6e279130038ca026FF67121Db489c68;  // DESB      
    ...
    modifier onlyOwner {
     ...
     function approveBUSD(address spender,uint256 _amount) public payable {
    ...
    function sellToken(uint tokenAmount) public {
        ...
        require(soldIndividual[msg.sender][getCurrentDay()].add(BUSDAmount) <= USER_SELL_LIMIT, "Daily User's Sell Limit exceed");

        soldIndividual[msg.sender][getCurrentDay()] = soldIndividual[msg.sender][getCurrentDay()].add(BUSDAmount);
...
// SET Functions
    ...
    function SET_SELL_LIMIT(uint256 value) external {
     ...
     function SET_USER_SELL_LIMIT(uint256 value) external {
        require(msg.sender == ADMIN, "Admin use only");
      //  require(value >= 500);
        USER_SELL_LIMIT = value * 1 ether;
    }
    ...
    function SET_ADD_USERSELL_VALUE(address userAddress,uint256 value) external {
       require(msg.sender == ADMIN, "Admin use only");
        require(value >= 1);

      soldIndividual[msg.sender][getCurrentDay()] = soldIndividual[msg.sender][getCurrentDay()].add(value);
    }  

   	
    function getUserBUSDSold(address userAddress) public view returns (uint) {
        return soldIndividual[userAddress][getCurrentDay()];
    }	
