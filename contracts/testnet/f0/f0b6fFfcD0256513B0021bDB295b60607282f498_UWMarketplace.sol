...
contract UWMarketplace is ERC721, Ownable, Pausable {
    ...
    modifier checkAcceptBid(
        ...
        require(cItem.owner == _msgSender(), "Accept Bid: Not an owner.");
        require(
            bid.tokenAddress == tokenAddress,
    ...
    function createMarketItem(
        ...
        uint256 price,
        address tokenAddress
    ) external checkCreateMarketItem(tokenId, conAdd, price) whenNotPaused {
    ...
    function purchaseMarketItem(
        uint256 tokenId,
        address conAdd
    ) external whenNotPaused checkPurchaseMarketItem(tokenId, conAdd) {
    ...
    function addBid(
        ...
        uint256 price,
        address tokenAddress
    ) external whenNotPaused checkAddBid(tokenId, conAdd, price, tokenAddress) {
