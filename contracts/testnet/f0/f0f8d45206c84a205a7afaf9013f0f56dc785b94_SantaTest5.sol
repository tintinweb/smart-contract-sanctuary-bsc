...
contract SantaTest5 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SantaTest5";
    string constant _symbol = "ST5";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xC0e9AD97c1E4BFEa3B6Ee9227593AB35d7efB72D;
        buybackWallet = 0xC0e9AD97c1E4BFEa3B6Ee9227593AB35d7efB72D;
