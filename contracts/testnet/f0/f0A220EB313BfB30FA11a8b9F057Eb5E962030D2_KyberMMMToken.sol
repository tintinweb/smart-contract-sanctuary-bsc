...
// BSCStationToken with Governance.
contract KyberMMMToken is BEP20('KyberMMM Token', 'MMM'), LGEWhitelisted {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "MMM::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "MMM::delegateBySig: invalid nonce");
        require(now <= expiry, "MMM::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "MMM::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying MMMs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "MMM::_writeCheckpoint: block number exceeds 32 bits");
