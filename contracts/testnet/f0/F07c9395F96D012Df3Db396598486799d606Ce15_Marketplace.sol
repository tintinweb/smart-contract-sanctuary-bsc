    ...
    PausableUpgradeable
{
    ...
    // vars
    IWETH public weth;
    IERC20Upgradeable public leslarTokenContract;
    IERC20Upgradeable public yetAnotherToken;
    ...
    function initialize(uint256 _feePercent, IERC20Upgradeable _leslarTokenContract, IWETH _weth) public initializer {
    ...
    function setTokenContract(IERC20Upgradeable _leslarTokenContract)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function _isNative(IERC20Upgradeable currency) internal pure returns (bool) {
