...
contract SaveVerse is Context, IERC20, Ownable {
    ...
    uint8 public _liquidityFee = 10;
    uint8 private _previousLiquidityFee = _liquidityFee;

    uint8 public _burnFee = 10;
    ...
    constructor() {
        ...
        _symbol = "SV";
        _decimals = 18;
        _tTotal = 1 * (10 ** _digits) * (10 ** _decimals);
        ...
        numTokensSellToAddToLiquidity = _tTotal.mul(1).div(10 ** 3);
    ...
    function calculateLiquidityFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_liquidityFee + _burnFee + _walletFee + _buybackFee).div(10 ** 3);
    }
