    ...
    /**
      ...
      */
      function _stake(uint256 _amount, uint256 collectedReward, uint8 stakeType, uint256 ccSupply, uint256 usedReward, address to) internal returns (uint256) {
        ...
        milliPercentOfUser = ((collectedReward - usedReward) * stakePart[stakeType]) * 1000 / (ccSupply * stakeAssumption[stakeType]);
...
contract GagagaG is Context, IERC20, Ownable, Stakeable {
