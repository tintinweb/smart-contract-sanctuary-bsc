...
contract SafeswapFactory is ISafeswapFactory, Initializable {
    ...
    function isAddressBlacklist(address _target) public view returns (bool) {
        return isBlacklistedStatus[_target] == true;
    }

    function isApprovePartnerStatus(address _target) public view returns (bool) {
        return approvePartnerStatus[_target] == true;
    }

    function isBlacklistedTokenAddress(address _target) public view returns (bool) {
        return isBlacklistedToken[_target] == true;
    }
