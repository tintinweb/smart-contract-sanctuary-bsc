...
contract Goblin is Context, IERC20, Ownable {
    ...
    address private marketingWallet = address(0xA7878AEc1a0e915220aF052EBd344a072dE098de);
    address private liquidityReceiver = address(0x034699E64038B349E7C51513A8808d6bde630836);
    ...
    function setBuyFees(uint256 newMarketingFee, uint256 newLiquidityFee) public onlyOwner {
        require(buyFee.marketing <= 10, "Can't set buyFee.marketing more than 10%");
        require(buyFee.liquidity <= 10, "Can't set buyFee.marketing more than 10%");
    ...
    function setSellFees(uint256 newMarketingFee, uint256 newLiquidityFee) public onlyOwner {
        require(sellFee.marketing <= 10, "Can't set buyFee.marketing more than 10%");
        require(sellFee.liquidity <= 10, "Can't set buyFee.marketing more than 10%");
