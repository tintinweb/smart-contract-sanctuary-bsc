...
contract TOKEN is ERC20, Ownable {
    ...
    address private constant BUSD =
        address(0x6D878D27b8b929143810c4a4EAaB4f37ad370c36); //BUSD address

    address public _taxWallet = payable(address(0x123)); //add your tax wallet address here
    ...
    constructor() ERC20("TOKEN", "TKKN") {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            ...
            0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 // pcs testnet router
        );
    ...
    function claimStuckedTokens(address _token) external onlyOwner {
    ...
    function setTaxWallet(address newWallet) external onlyOwner {
        require(newWallet != address(0), "taxWallet can't be a zero address");
    ...
    function _transfer(
        ...
        if (
            ...
            super._transfer(address(this), _taxWallet, walletTokens);
        }
