...
contract Presale is ReentrancyGuard, Ownable {
  ...
  uint256 public hardcap = 5000 ether; // could be 4250 // separate 750 for priv sale? but seems can add here
  ...
  uint256 public tokensPerBNB = 1188289 * 10**8; // 1188289/10000000000 or 0.000118828900000000 /// 118828900000000
  ...
  function buy(address beneficiary) public payable nonReentrant {
    ...
    require(_bnbSent >= 0.1 ether, "BNB is less than min value");
    require(_bnbSent <= 2.5 ether, "BNB is more than max value");
    ...
    require(
      tokensUnclaimed[beneficiary] + tokens <= tokensPerBNB * 2.5 ether,
      "Can't buy more than 2.5 BNB worth of tokens"
    );
  ...
  function claimTokens() external nonReentrant {
    ...
    require(
      ...
      "User should have unclaimed One1 tokens"
    );
    require(
      safeToken.balanceOf(address(this)) >= tokensUnclaimed[msg.sender],
      "There are not enough One1 tokens to transfer, nani?"
    );
