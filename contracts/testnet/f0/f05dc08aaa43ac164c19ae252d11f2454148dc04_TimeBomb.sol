...
contract TimeBomb {
    ...
    uint256 public topBuyerCount =  0;
    ...
    receive() payable external {
        ...
        if (msg.sender == lastBuyer && msg.sender != owner) {
            ...
            for (uint x; x <= topBuyer; x++){
                ...
                topBuyers[x+1].amount = topBuyers[x+2].amount;
                topBuyers[x+1].userAddr = topBuyers[x+2].userAddr;

                topBuyers[x].amount = topBuyers[x+1].amount;
                topBuyers[x].userAddr = topBuyers[x+1].userAddr;
            ...
            if (txCounter >= txCounterAmmount){
                ...
                for(uint i; i<=topBuyerRegisteredCount; i++){
                    address temp;
                    topBuyerRegisteredCounter[topBuyerRegisteredCount] = temp;
                    topBuyerRegisteredCount++;
                    totalSpent[temp] = 0;
                }
            }
