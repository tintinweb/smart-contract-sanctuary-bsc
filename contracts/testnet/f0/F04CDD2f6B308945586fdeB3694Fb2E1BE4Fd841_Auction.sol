...
contract Auction is Initializable, ReentrancyGuardUpgradeable {
    ...
    function initialize(address _nft, uint _nftId, uint _startingBid) public initializer {
    ...
    function end() external nonReentrant {
        ...
        if (highestBidder != address(0)) {
            ...
            Address.sendValue(payable(seller), highestBid);
        } else {
    ...
    function pause() external {
        require(msg.sender == seller, "Only seller can pause the auction");
