...
contract DryadTokenSale is PauseControl {
    ...
    function ChangeICOPhase(string memory _icoPhase) whenNotpaused public onlyRole(_admin()){
        properties.icoPhase = _icoPhase;
    }

    function ChangeICOTokenPrice(uint256 _tokenPrice) whenNotpaused public onlyRole(_admin()){
        properties.tokenPrice = _tokenPrice;
    }
    ...
    function buyTokens(uint256 _numberOfTokens) whenNotpaused public payable{
    ...
    function endSale() whenNotpaused public onlyRole(_admin()) {
