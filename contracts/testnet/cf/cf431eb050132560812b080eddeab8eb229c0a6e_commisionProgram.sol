...
contract commisionProgram is Ownable, ReentrancyGuard {
    ...
    event AddNewToken(uint256 indexed token_id, string token_name, IERC20 token_address);
    event AddNewProduct(
     ...
     */
    function addToken(uint256 _token_id, string memory _token_name, IERC20 _token_address) external onlyAdmin{
        ...
        tokenAdd.token_name = _token_name;
        tokenAdd.token_address = _token_address;

        emit AddNewToken(_token_id, _token_name, _token_address);
    }
