...
contract UANG is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   mapping(address => bool) private _isExcludedFromMaxWallet;
    ...
    uint256 public maxWalletAmountRate = 1000000;

    uint256 public swapTokensAtAmount = 100000000000000 * (10**9);
    
    mapping(address => bool) public _isBlacklisted;


    uint256 public charityFee = 0; //send in bnb
    uint256 public liquidityFee = 0;
    uint256 public marketing1Fee = 1; // converted to bnb
    uint256 public marketing2Fee = 0; // in native token
    uint256 public burnFee = 0;
    uint256 public totalFees = liquidityFee.add(charityFee).add(marketing1Fee).add(marketing2Fee).add(burnFee);


    address public _marketingWalletAddress = 0x348c8182f52deB5c80427655b8B3a081E5d5FD64;
    address public _charityWallet = 0xE3B74fe7aF171edB436225027b004e96586D0B4B;

    uint256 public maxTransferAmountRate = 1000000;
    ...
    constructor() public ERC20("hudian1", "hudian1") {
        ...
        excludeFromFees(0xB8f9774a08C68E57Ea14Ca5E8C53Cc2c3DeABd6d, true);
        ...
        */
        _mint(owner(), 10000000000000000  * (10**9));
    }
    ...
    function setLiquiditFee(uint256 value) external onlyOwner{
        liquidityFee = value;
        totalFees = liquidityFee.add(marketing1Fee).add(marketing2Fee).add(charityFee).add(burnFee);
    ...
    */
    function maxTransferAmount() public view returns (uint256) {
        ...
        return totalSupply().mul(1000000).div(1000000);
    }
    ...
    */
    function maxWalletAmount() public view returns (uint256) {
        ...
        if(maxWalletAmountRate > 0){
            return totalSupply().mul(maxWalletAmountRate).div(1000000);
        }
        // or we can just set an actual number
        return totalSupply().mul(1000000).div(1000000);
    }
    ...
    function sendToCharity(uint256 tokens) private  {
      
        uint256 initialBalance = address(this).balance;
        // swap tokens for ETH
        swapTokensForEth(tokens); 
        uint256 newBalance = address(this).balance.sub(initialBalance);
        (bool success,) = address(_charityWallet).call{value: newBalance}("");
        if(success) {
