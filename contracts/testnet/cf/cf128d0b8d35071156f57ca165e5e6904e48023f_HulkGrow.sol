...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x39A150703879Dd1352fAbCb8D48F351367392B18;
...
contract HulkGrow is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x39A150703879Dd1352fAbCb8D48F351367392B18;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "HulkGrow";
    string private _symbol = "HGW";
