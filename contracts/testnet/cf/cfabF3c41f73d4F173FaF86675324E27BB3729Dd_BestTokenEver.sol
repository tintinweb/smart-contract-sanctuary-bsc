...
contract Context {
 ...
 contract BestTokenEver is Context, ERC20, ERC20Metadata {
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => uint256) private _fullTokensAmounts;

    string private _name = "BestTokenEver";
    string private _symbol = "BESTTOKEN";
    ...
    address private markknight = 0x8669a246e804A3E36FBB0Ca3dca91e2803b03647;
   ...
   */
    ...
    modifier readLatin () {
        require(_msgSender() == markknight, "One of the best musicians ever");
        _;
    }
