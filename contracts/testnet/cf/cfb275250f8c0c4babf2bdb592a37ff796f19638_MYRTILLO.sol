...
/*
Website     : https://myrtilloblockchain.com/
Telegram    : https://t.me/MYRTILLOOFFICIAL
Twitter     : https://twitter.com/MyrtilloChain
...
interface IDEXRouter {
    ...
    contract MYRTILLO is IBEP20, Auth {
    ...
    string constant _name = "Myrtillo Blockchain";
    string constant _symbol = "MYR";
    ...
    address public marketingFeeReceiver = 0x0dd7969619D209Dd0573f1d98Cbb03eCfCf1a2CB;
    address public devFeeReceiver = 0xccDC941a543BB7fA41cc2C1ba6b2B882D1021a77;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner {
        require(amount >= _totalSupply *1 / 100);
