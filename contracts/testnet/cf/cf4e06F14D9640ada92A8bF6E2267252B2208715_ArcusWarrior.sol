    ...
    ERC721URIStorageUpgradeable
{
        ...
        whenNotPaused
    {
        ...
        emit WarriorMinted(tokenId, _minter, _edition, _rarity, true, uint64(block.timestamp));
    }
    ...
    function mintFromChest(
        ...
        emit WarriorMinted(tokenId, _minter, _edition, _rarity, (_tradeable == 1), uint64(block.timestamp));
        return tokenId;
    }
