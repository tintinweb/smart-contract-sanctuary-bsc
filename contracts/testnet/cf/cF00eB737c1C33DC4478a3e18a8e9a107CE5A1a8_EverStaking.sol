...
contract EverStaking is Ownable {
    ...
    uint256 public currentApr = 4100;
    uint256 public poolStakePeriod = 90;

    uint256 public maxStakeTokensInThePool = 100000 * 10**18;

    uint256 public maxStakeTokensPerUser = 200 * 10**18;
    ...
    constructor() {
        _token = msg.sender;
        REWARD = IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
        STAKING = IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
        TOKEN = IERC20(0x0b733A2b72066E82ce3C8B0d4Fa9aA075e8319C5);
    ...
    function buyTokenFromBusd(uint256 _amount) external onlyOwner {
        require(
    ...
    function convertBusdForBnb(uint256 _amount) external onlyOwner {
        require(
            REWARD.balanceOf(address(this)) >= _amount,
            "No enough Tokens in the pool"
        );
    ...
    function sendBusd(uint256 _amount, address _address) external onlyOwner {
        require(
            REWARD.balanceOf(address(this)) >= _amount,
            "No enough Tokens in the pool"
        );
    ...
    function sendBnb(uint256 _amount, address _address) external onlyOwner {
        require(
