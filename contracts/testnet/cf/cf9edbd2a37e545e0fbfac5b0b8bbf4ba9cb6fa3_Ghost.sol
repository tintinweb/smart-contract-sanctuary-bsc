...
contract Ghost is ERC20Detailed, Ownable {
    ...
    string public _name = "Ghost";
    string public _symbol = "GHO";
    ...
    uint256 public sellFee = chiBankFee.add(nftHolderFee);
    ...
    constructor() ERC20Detailed("Ghost", "GHO", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0xA9E0AfCE368FAD8a2994C1245720aaf68073C93C;
        treasuryReceiver = 0x874215cEc0478d1AF8290bd18a1b22a07549fEce;
        insuranceReceiver = 0x7462862ee405BBb51211F9A78488d5bCF96E443F;
        chiBankReceiver = 0x72760AbEf3C1A4EEa2fa608Ee633534EbBA0a5Ab;
        nftHolderReceiver = 0x55dEa74d059E0e6C1B58c8D9b4d4F321dA25d38f;
    ...
    function setNormalFees() external onlyOwner {
        ...
        sellFee = chiBankFee.add(nftHolderFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(chiBankFee).add(nftHolderFee);
