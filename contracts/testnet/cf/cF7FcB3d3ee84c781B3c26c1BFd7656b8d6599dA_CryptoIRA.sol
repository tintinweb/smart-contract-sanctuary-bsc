...
//          ? IDEXRouter(_router)
//            : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //testnet 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3   //mainnet 0x10ED43C718714eb63d5aA57B78B54704E256024E
...
contract CryptoIRA is IBEP20, Auth {
	...
	address BUSD = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;   //testnet 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7   //mainnet 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    ...
    string constant _name = "Crypto IRA";
    string constant _symbol = "CIRArc1";
...
//        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);  //testnet 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3  //mainnet 0x10ED43C718714eb63d5aA57B78B54704E256024E
...
//Removed From Fee Receiver  charityFeeReceiver = _charityFeeReceiver; teamFeeReceiver = _teamFeeReceiver;
    ...
    function recoverETHfromCryptoIRACC() public virtual onlyOwner {
        payable(marketingFeeReceiver).transfer(address(this).balance);
    }

    // Withdraw ERC20 tokens that are potentially stuck in the CryptoIRA BUSD Contract
    function recoverTokensFromCryptoIRACC(address _tokenAddress, uint256 _amount) public onlyOwner {                               
