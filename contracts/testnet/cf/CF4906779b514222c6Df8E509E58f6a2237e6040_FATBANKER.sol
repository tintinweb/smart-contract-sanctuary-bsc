...
contract FATBANKER is Token {
    
    uint private startTime = 1663437600000; // Friday, September 30, 2022 9:00:00 PM (GMT)
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                  // e
        DES_1 = 0x37ccD5A989eF4CadcC214cAF407A14C4D4675092;  // 0
        ADM_1 = 0xa1A9d907e78fBA45BA110716BBDba92026B29089;  // o         
        VID_1 = 0xE1636BFF8f663C5E7E7d00113408543C4E2801A8;  // E        
        MAR_1 = 0xE1636BFF8f663C5E7E7d00113408543C4E2801A8;  // t
