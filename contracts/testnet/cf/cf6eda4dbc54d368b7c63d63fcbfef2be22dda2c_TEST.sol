...
contract TEST is IERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public sellFee        = 96000;            // 4% redeem fee 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // set fee to either contract fee if relevant or default to current transfer fee
    ...
    */
    function setFees(uint256 _mintFee, uint256 _transferFee, uint256 _sellFee, uint256 _contractFee) external onlyOwner {
        ...
        require(_transferFee >= 90000);   
        require(_sellFee >= 90000);       
        require(_contractFee >= 90000);   
