...
contract test22 is Initializable, ContextUpgradeable, OwnableUpgradeable, ERC20PausableUpgradeable {

    // CONFIG START
    function initialize () initializer internal{
    __ERC20_init("tewst", "ttt");
    initialSupply = 13000000000 * (10**18);
    _name = "tewst";
    ...
    marketingTaxWallet = 0x7ed5A5a6068c703aFd86e71E7acda14A1BED4607;
    liquidityTaxWallet = 0x7ed5A5a6068c703aFd86e71E7acda14A1BED4607;
    ...
    uint256 private taxLimit;
    
    uint256 private swapThreshold; // The contract will only swap to ETH, once the fee tokens reach the specified threshold
    ...
    function setBuyTax( uint256 marketing, uint256 liquidity) public onlyOwner {
        require( marketing + liquidity  <= taxLimit, "Shrew: sum higher than tax limit");
     ...
     */
    function setTaxWallets(address marketing, address liquidity) public onlyOwner {
