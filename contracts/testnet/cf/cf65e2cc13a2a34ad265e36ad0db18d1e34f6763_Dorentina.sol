...
contract Dorentina is Context, IBEP20, Ownable {
    using SafeMath for uint256;

    address public DEAD = 0x000000000000000000000000000000000000dEaD;

    string _name = "Dorentina";
    string _symbol = "DA";
    uint8 _decimals = 18;
    ...
    uint256 public _maxTxAmount = _currentTotalSupply.div(100); // 1%
    uint256 minimumTokensBeforeSwap = 10 * 10**6 * (10 ** _decimals);
    // whenever it reaches 25BNB, then distribute to all holder
    uint256 rewardsDistributeThreshold = 25 * (10 ** 18);  // 25 BNB
    ...
    address marketingFeeReceiver = 0x835F9d3e72C81faEA08d646360fDf42F6bcB2974;
    address developmentFeeReceiver = 0x0359A648B2a1834b1832edDef8Aea902Ef392763;
    ...
    constructor() {
        // uniswapV2Router = IUniswapV2Router(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);  // pancake router
        // address _router = address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);  // uniswap router
        address _router = address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);  // pancake router
