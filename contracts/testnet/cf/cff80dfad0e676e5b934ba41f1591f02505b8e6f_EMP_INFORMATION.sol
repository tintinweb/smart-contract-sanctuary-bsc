...
//   uint256 public mobile;
  ...
  function addEmployee(uint256 new_empid, string memory new_name, string memory new_email, uint256 new_mobile) public{
      require(empid != new_empid, "Employee Id already exist!!!");

      empid = new_empid;
      empDetails[new_empid] = _empDetails(new_empid, new_name, new_email, new_mobile);
  }
