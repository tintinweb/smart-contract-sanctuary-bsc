...
contract PrivateSale is ERC20, Ownable {
    IERC20 public token;
    uint256 decimalsDiff;
    uint256 public privateSaleStartTimestamp = 1652130061;//todo
    uint256 public privateSaleEndTimestamp = 1652184061;
    ...
    function claim() external returns(bool) {
        ...
        require(claimEnabledStart <= block.timestamp, "Claim not started");
