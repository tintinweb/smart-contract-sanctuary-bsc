...
contract VelhallaLand721 is ERC721PresetMinterPauserAutoId, Ownable, ReentrancyGuard{
    ...
    uint256[][4] public priceOfLandCardStarUpgradeByUsdt = [[20,15,10,5,25],[20,15,10,5,25],[20,15,10,5,25],[20,15,10,5,25]];
    // Price of Land Star Upgrade (SCAR)
    uint256[][4] public priceOfLandCardStarUpgradeByScar = [[MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT], [MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT], [MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT], [MAX_INT, MAX_INT, MAX_INT, MAX_INT, MAX_INT]];
    ...
    uint256[][4] private probabilityOfLandCardStarUpgradeCriticalHit;
    ...
    uint256[][4] private probabilityOfLandCardStarUpgrade;
    ...
    constructor(uint256[4] memory _prOfCHL, uint256[][4] memory _probabilityOfLandCardStarUpgradeCriticalHit, uint256[][4] memory _probabilityOfLandCardStarUpgrade) ERC721PresetMinterPauserAutoId("Velhalla Land 721", "VL721", "")  
    { 
    ...
    function upgradeLandCardStar(uint256 tokenId) nonReentrant external returns(uint256 landCardStarAfterUpgrade){
        ...
        // upgrade star critial hit probability
    ...
    function getProbabilityOfUpgradeByTokenID(uint256 tokenId) external returns(uint256 prOfStarUpgrade){
        uint256 landCardStarIndex = landCardStar[tokenId] - 1;
        uint256 landCardTypeIndex = landCardType[tokenId];
        prOfStarUpgrade = probabilityOfLandCardStarUpgrade[landCardStarIndex][landCardTypeIndex];
    }
    function getProbabilityOfUpgradeByLandtypeAndStar(uint256 landtype, uint256 star) external returns(uint256 prOfStarUpgrade){
    ...
    function setPriceOfLandCardStarUpgradeByUsdt(uint256[][4] memory _priceOfLandCardStarUpgradeByUsdt) external {
    ...
    function getPriceOfLandCardStarUpgradeByUsdt() external view returns(uint256[][4] memory){
        return priceOfLandCardStarUpgradeByUsdt;
    }
    
    function setPriceOfLandCardStarUpgradeByScar(uint256[][4] memory _priceOfLandCardStarUpgradeByScar) external {
    ...
    function getPriceOfLandCardStarUpgradeByScar() external view returns(uint256[][4] memory){
        return priceOfLandCardStarUpgradeByScar;
    }

    function setProbabilityOfLandCardStarUpgradeCriticalHit(uint256[][4] memory _probabilityOfLandCardStarUpgradeCriticalHit) external {
    ...
    function getProbabilityOfLandCardStarUpgradeCriticalHit() external view returns(uint256[][4] memory){
    ...
    function setProbabilityOfLandCardStarUpgrade(uint256[][4] memory _probabilityOfLandCardStarUpgrade) external {
        require(hasRole(MINTER_ROLE, _msgSender()), "web3 CLI: must have minter role to set probability of land card star upgrade");
        probabilityOfLandCardStarUpgrade = _probabilityOfLandCardStarUpgrade;
    }
    function getProbabilityOfLandCardStarUpgrade() external view returns(uint256[][4] memory){
