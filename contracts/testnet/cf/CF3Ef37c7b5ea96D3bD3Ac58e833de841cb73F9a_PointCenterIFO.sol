...
import "./interfaces/IDutyProfile.sol";
...
contract PointCenterIFO is Ownable {
    ...
    constructor(address _dutyProfileAddress, uint256 _maxViewLength) public {
        dutyProfile = IDutyProfile(_dutyProfileAddress);
    ...
    function getPoints(address _contractAddress) external {
        ...
        bool isUserActive = dutyProfile.getUserStatus(senderAddress);
        ...
        dutyProfile.increaseUserPoints(
            senderAddress,
...
interface IDutyProfile {
     ...
     * Callable only by owner admins.
     */
    function updateNumbeVeterans() external;
