...
contract MetaGoldV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    uint256 public feeMultiplier = 99;
...
*/
    ...
    */
    ...
    function updateBNBaddressForPrice(address newAddress) public onlyOwner {
        bnb_address = newAddress;
    }
    function updateMETAaddressForPrice(address newAddress) public onlyOwner {
        meta_address = newAddress;
    }
    ...
    function calcMarketingTokens(uint256 contractTokenBalance) public view returns (uint256) {
    ...
    function setSwapping(bool _swapping) public onlyOwner {
        swapping = _swapping;
    }
    ...
    function doTransfer(uint256 bnbBalance) public onlyOwner {
    ...
    function doTransfer2(uint256 bnbBalance) public onlyOwner {
        transferOutBNB(marketingWallet, bnbBalance);
    }
    function doTransferAll() public onlyOwner {
        transferOutBNB(marketingWallet, getContractBNBBalance());
    }
