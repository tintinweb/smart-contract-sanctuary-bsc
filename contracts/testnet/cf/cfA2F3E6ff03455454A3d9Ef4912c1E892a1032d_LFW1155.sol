    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        _setupRole(
            OPERATOR_ROLE,
            address(0x140c71263DD03F4c35F4eA6B849Ebdaf3e97cb99)
        );
        _setupRole(
            OPERATOR_ROLE,
            address(0xb309DC46fa352615aE3B05665c099658f0cDedA9)
        );
        _setupRole(
            OPERATOR_ROLE,
            address(0x98637C52D85572EEf18C75fdA670EC8C00eB73F3)
        );
        _setupRole(
            OPERATOR_ROLE,
            address(0x09E259672b3e90feDA783bcD5166e98cCbdAbaD3)
        );
        _setupRole(
            OPERATOR_ROLE,
            address(0x1A22509A3DFeEb4D4904201F275Ba51C9c733d88)
        );
    }
    ...
    */
     ...
     */
    function burnItem(uint256 tokenId, uint256 amount) external payable nonReentrant {
        require(
        ...
        if (openChestFee > 0) {
            payable(treasury).transfer(openChestFee);
        }
