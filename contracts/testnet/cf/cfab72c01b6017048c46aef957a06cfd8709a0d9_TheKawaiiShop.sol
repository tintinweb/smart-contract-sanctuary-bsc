...
contract TheKawaiiShop is Ownable, ERC721AQueryable, PaymentSplitter {
    ...
    constructor(address[] memory _team, uint[] memory _teamShares) ERC721A("Kawaii Shop", "KAWAIISHOP") PaymentSplitter(_team, _teamShares){
        // TO DELETE ----------
        ...
        setItem(magicCookieID, "Magic Cookie", "Heals 50% of kawaii HP.", 50, "Common", "Cookie", "ipfs://cookie", 0, 0, 0, 0, 0);
        setItem(reviveScrollID, "Resurrection Scroll", "Revive your Super Kawaii.", 150, "Common", "Scroll", "ipfs://scroll", 0, 0, 0, 0, 0);
