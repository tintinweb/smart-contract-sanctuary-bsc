...
contract BEP721 is Context, BEP165, IBEP721, IBEP721Metadata , Ownable{
    ...
    function MintCommon(address to, bytes memory uri,bool eth) public payable {
        ...
        uint256 tokenId = Common.currentid;
        _safeMint(to, tokenId,uri);
        Common.currentid++;
    }
    function MintRare(address to, bytes memory uri,bool eth) public payable {
        ...
        uint256 tokenId = Rare.currentid;
        _safeMint(to, tokenId,uri);
        Rare.currentid++;

    }
    function MintEpic(address to, bytes memory uri,bool eth) public payable {
        ...
        uint256 tokenId = Epic.currentid;
        _safeMint(to, tokenId,uri);
        Epic.currentid++;
    }
    function MintLegendary(address to, bytes memory uri,bool eth) public payable {
        ...
        uint256 tokenId = Legendary.currentid;
        _safeMint(to, tokenId,uri);
