...
contract Satoshi_LotteryV1 is IERC20 {
    ...
    string internal information = "The winner receives 90% of the accumulated value\n 10% return for system maintenance";
...
constructor(){
    ...
    function system_info() external view returns(string memory){
        return information;
    }
    ...
    function Lottery_Info() public view returns(uint256 ID, uint256 Ticket_value, uint256 Participants, uint256 Accumulated_lottery){
        ID = lotteryID;
        Ticket_value = payValue/decValue;
        Participants = players.length;
        Accumulated_lottery = address(this).balance/decValue;
        return (ID, Ticket_value, Participants, Accumulated_lottery);
    }
