...
contract RoundZero is Ownable, Pausable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for ERC20;
        ...
        nonReentrant
    {
        ...
        require(token.balanceOf(address(this)) >= msg.value*rate,'the smart contract dont hold the enough tokens');
