...
contract Energy3Token is IBEP20, LockToken
{
    using SafeMath for uint256;
    address public burnAddress = 0x1043637BfF126656019c9627480f4afBD1926254;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    uint256 public _totalSupply = 10_000_000 * 10**18;
    string public _name = "Energy3 Token";
    string public _symbol = "Energy3";
