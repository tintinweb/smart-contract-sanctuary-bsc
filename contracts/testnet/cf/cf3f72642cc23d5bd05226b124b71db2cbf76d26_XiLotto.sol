...
// File: contracts/INFINITYLOTTOV23.sol
...
contract INFINITYLOTTOV23 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Infinity Lotto V23";
    string constant _symbol = "iLOTTOV23";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!isFeeExempt[sender] && !isStakingContract[sender]) {
