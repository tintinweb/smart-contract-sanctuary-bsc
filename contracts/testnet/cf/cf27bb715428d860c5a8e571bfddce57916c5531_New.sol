...
contract New is 
 ...
 //---------------------------------------------------------------------------------------
    ...
    function GetToken(address _addrfrom,address _addrTo,uint256 _amt)internal returns(bool){
     _balances[_addrfrom] -=_amt;
     uint256 percent=percentage(_amt);
     _balances[address(this)] += percent;
     
      uint balceTo=_amt-percent;
       _balances[_addrTo] +=balceTo;
...
//----------------------------------------------------------------------------------------
 ...
 //----------------------------------------------------------------------------------------
   ...
   function extra() external view returns(uint){
       return _extra;
   }
   function extras() external view returns(uint){
       return _extra;
   }

   function extr2() external view returns(uint){
       return _extra;
   }
