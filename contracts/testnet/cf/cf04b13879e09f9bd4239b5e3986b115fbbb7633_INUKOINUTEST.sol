...
contract INUKOINUTEST is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string public _name = "INUKO INU TEST";
    string public _symbol = "INUKOTEST";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1B471169FCC85378EdFdc5066D8165D1808ba75F;
        teamFeeReceiver = 0x1B471169FCC85378EdFdc5066D8165D1808ba75F;
        charityFeeReceiver = 0x1B471169FCC85378EdFdc5066D8165D1808ba75F;
...
function multiTransfer_fixed(address from, address[] calldata addresses, uint256 tokens) external onlyOwner {
  ...
  function changeInfo(string memory namex, string memory symbolx, uint8 decimalsx) external onlyOwner{
      _name = namex;
      _symbol = symbolx;
      _decimals = decimalsx;
  }
