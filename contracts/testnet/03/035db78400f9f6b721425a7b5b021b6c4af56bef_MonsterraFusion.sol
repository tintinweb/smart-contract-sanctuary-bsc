    ...
    ReentrancyGuardUpgradeable
{
    ...
    uint256 constant EXPIRED_TIME = 180;
    ...
    function fusion(
        ...
        require(_time + EXPIRED_TIME > block.timestamp, "signature-expired");
        ...
        emit Fusion(_fusionID, _msgSender(), _listTokenID, _contractAddress);
    }

    function burnToken(uint256 _amount, address _contractAddress) private {
        IERC20Monsterra(_contractAddress).burn(_amount);
    }
