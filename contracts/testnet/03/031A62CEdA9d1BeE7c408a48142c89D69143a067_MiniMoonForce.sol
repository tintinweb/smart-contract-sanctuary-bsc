...
Telegram: https://t.me/minimoonforcetokenofficial


The Concept is simple, earn MoonForce by hodling MiniMoonForce!
...
Tokenomics:
  ...
  Max Wallet: 2% (200 Billion)
  Max Transaction: 1% (100 Billion)
  45 Seconds Cooldown Between Trades
  
MORE INFO can be found on our TELEGRAM.
 * 
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MF = IBEP20(0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MF.balanceOf(address(this));
        ...
        uint256 amount = MF.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MF.transfer(shareholder, amount);
...
contract MiniMoonForce is IBEP20, Auth {
    using SafeMath for uint256;

    address MF = 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MiniMoonForce";
    string constant _symbol = "MMF";
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0x886d09A517bFaEc8381D8cC00da29E776A6DCa35;
        address firstBurnWallet = 0x30fAC4D9f537e53344519277De433caA86C5D411;
        address secondBurnWallet = 0xE5f69BE9AB612207B61F033913bA13C7aC6723b1;
