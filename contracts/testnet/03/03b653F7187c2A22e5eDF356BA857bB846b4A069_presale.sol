...
contract presale {
    IToken public WB = IToken(0x46B24320C5aF6d3676988E7bfa58C1AE59fE4662);
    ...
    constructor() {
        ...
        tokenwallet = payable(0x74C1F2bEA2686c38933Ddf5D7BDEF243455b6D4A);
        //mainnet BSC
    ...
    function buyTokenbnb(address ref) public payable {
        ...
        users[msg.sender].token_balance =
            users[msg.sender].token_balance +
            (numberOfTokens);
        WB.transferFrom(tokenwallet, msg.sender, numberOfTokens);

        if(ref != owner){
            users[ref].token_balance =
            users[ref].token_balance +
            (numberOfTokens * uplineBonus / divider);
            WB.transferFrom(tokenwallet, ref, numberOfTokens * uplineBonus / divider);
        }
    }
