    ...
    PausableUpgradeable
{
     ...
     */
    function getLatestPrice(address _proxy) public view isAddress(_proxy) returns (int256) {
        AggregatorV3Interface priceFeed = AggregatorV3Interface(_proxy);
        ...
        internal
    {
        ...
        uint256 tokenAmountToPay = ((_amountInUSD * (10**decimal)) / (tokenPriceInUsd/1e8));
        {
    ...
    function _chargeNative(uint256 _amountInUSD) internal { 
        ...
        uint256 tokenAmountToPay = ((_amountInUSD * (10**nativeToken.decimal)) / (tokenPriceInUsd/1e8));
        {
