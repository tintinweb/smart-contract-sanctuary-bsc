...
contract EAAS is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0xE2d4E879E14Af8691c7550e707A5E7a33263ae8B); 
    address payable public developmentAddress = payable(0xE2d4E879E14Af8691c7550e707A5E7a33263ae8B); 
    address payable public charityAddress = payable(0xE2d4E879E14Af8691c7550e707A5E7a33263ae8B); 
    address payable public vaultRewardAddress = payable(0xE2d4E879E14Af8691c7550e707A5E7a33263ae8B); 
    address payable public liquidityWallet = payable(0xE2d4E879E14Af8691c7550e707A5E7a33263ae8B); 
    ...
    uint256 private constant _tTotal = 1000000000 * 10**2;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "EaaS Global";
    string private constant _symbol = "EAAS";
    ...
    uint256 public _sellVaultFee = 9;
    ...
    uint256 public _bMaxTxAmount = 1000000000  * 10**2;
    uint256 public _sMaxTxAmount = 500  * 10**2;
    uint256 private _trigger = 1000000000  * 10**2;
    uint256 private minimumTokensBeforeSwap = 500  * 10**2; 
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _vaultFee = 0;
        _liquidityFee = 0;
        _bMaxTxAmount = 1000000000 * 10**2; // 1000000
        _sMaxTxAmount = 500 * 10**2;
    }
