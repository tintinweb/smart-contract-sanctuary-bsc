...
uint256 public MoveCost = 2000000000000000;
uint256 public Tax = 10;
//remove and add the , from string
string default_board = "xxxxxxxxxxxx________oooooooooooo";
game[] public games;
...
function _ResetMove(address wallet) internal {from[wallet] = 0;to[wallet] = 0;}
...
require(index < movequeue.length);
movequeue[index] = movequeue[movequeue.length-1];
movequeue.pop();
}
