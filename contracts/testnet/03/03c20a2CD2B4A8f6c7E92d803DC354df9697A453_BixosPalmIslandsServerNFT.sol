...
contract BixosPalmIslandsServerNFT is ERC721, ERC721Enumerable, Ownable {
    ...
    constructor(address tokenAddress) ERC721("Bixos Palm Islands Server NFT", "BXSPIS") {
        _contractAddress = address(this);
        _ubxsToken = IERC20(tokenAddress);
    }

    function startSale(uint256 _remainNft, uint256 _nftPrice) external onlyOwner {
    ...
    function withdrawNftPayments(address paymentWallet) external onlyOwner {
        // slither-disable-next-line unchecked-transfer
        _ubxsToken.transfer(paymentWallet, _ubxsToken.balanceOf(_contractAddress));
    }
