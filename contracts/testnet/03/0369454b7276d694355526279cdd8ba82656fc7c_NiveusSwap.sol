...
contract NiveusSwap is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0xdBA2d8240040A292c175D818Eef19f125C143035;
    ...
    uint256 public immutable MAX_FEE = 20; // Fee can't exceed 20%.
    ...
    constructor() ERC20("Niveus Swap", "NVS") {
    ...
    modifier onlyRise() {
        require(_msgSender() == riseContract, "CALLER_MUST_BE_RISE_CONTRACT_ONLY");
        _;
    }
    ...
    function setLiquiditFee(uint256 value) external onlyOwner{
        require(value <= MAX_FEE, "new value must be <= MAX_FEE");
        liquidityFee = value;
    ...
    function setRiseContract(address _riseContractAddress) external onlyOwner {
        ...
        excludeFromFees(riseContract, true);
    }
