...
//        IPancakeRouter02 _pancakeSwapv2Route = IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        address coinAddr = msg.sender;
        _mint(coinAddr, 10000000 * 10**decimals());
        MarketingWallet = msg.sender;
        EAGLENFTAddress = IEAGLENFT(_eagleNft);
        usdt = IERC20(0xCFd213453e55769fC8b4D8bFce21741CFA42b23B);
        IPancakeRouter02 _pancakeSwapv2Route = IPancakeRouter02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
    ...
    function usdtDistribute(uint256 usdtBalance) private {
        (address[] memory holdAddress, uint256[] memory types) = EAGLENFTAddress
            .getNFTConfig();
        uint128 tigerEaglecardNum = 68;
        uint128 PhoenixEagleCardNum = 688;
