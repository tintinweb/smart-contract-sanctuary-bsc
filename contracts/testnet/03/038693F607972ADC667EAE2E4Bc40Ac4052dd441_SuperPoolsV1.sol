...
contract SuperPoolsV1 is Admin {
    ...
    function _setDistributionsPerDay(
        ...
        uint256[5] memory tokensRewardsCap = _rewardsCaps;
        ...
        tokensRewardsCap = [
            tokensRewardsCap[0] = tokensRewardsCap[0].sub(_rewards[0].mul(4)),
            tokensRewardsCap[1] = tokensRewardsCap[1].sub(_rewards[1].mul(4)),
            tokensRewardsCap[2] = tokensRewardsCap[2].sub(_rewards[2].mul(4)),
            tokensRewardsCap[3] = tokensRewardsCap[3].sub(_rewards[3].mul(4)),
            tokensRewardsCap[4] = tokensRewardsCap[4].sub(_rewards[4].mul(4))
        ];
        ...
        setDailyDistribution(
            ...
            [
                tokensRewardsCap[4].div(dailyRateDays[0].mul(24)),
                tokensRewardsCap[0].div(dailyRateDays[1].mul(24)),
                tokensRewardsCap[1].div(dailyRateDays[2].mul(24)),
                tokensRewardsCap[2].div(dailyRateDays[3].mul(24)),
                tokensRewardsCap[3].div(dailyRateDays[4].mul(24))
            ]
        );
    }
