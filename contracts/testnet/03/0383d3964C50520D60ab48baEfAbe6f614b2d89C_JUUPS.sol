...
contract JUUPS is ERC20, Ownable {
    using SafeMath for uint256;
...
//    address public immutable ETH = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); //ETH
    ...
    constructor() ERC20("Juups Economy", "JUUPS") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "JUUPS: The new dividend tracker must be owned by the JUUPS token contract");
    ...
    function excludeOrIncludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "JUUPS: Account is already the value of 'excluded'");
    ...
    {
        require(_isExcludedFromMaxTx[account] != excluded, "JUUPS: Account is already the value of 'excluded'");
    ...
    {
        require(_isExcludedFromMaxWallet[account] != excluded, "JUUPS: Account is already the value of 'excluded'");
    ...
    {
        _BuyBUSDRewardsFee = buyEthRewardFee;
        _BuyLiquidityFee = buyLiquidityFee;
        _BuyFundFee = buyMarketingFee;
        _BuyDevFee = buyBackSHIBAFee;
    ...
    {
        _SellBUSDRewardsFee = sellEthRewardFee;
        _SellLiquidityFee = sellLiquidityFee;
        _SellFundFee = sellMarketingFee;
        _SellDevFee = sellBackSHIBAFee;
