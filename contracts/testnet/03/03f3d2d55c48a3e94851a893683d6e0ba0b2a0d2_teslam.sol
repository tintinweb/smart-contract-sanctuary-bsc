...
contract teslam is ERC20, Ownable {
    ...
    constructor() ERC20("teslam", "SLM") payable {
        ...
        if(block.chainid == 1){
            ...
            devAddress = address(0x8EE4202590F6600A50A8fE0901016c970800E4B5);
            teslamOwner = address(0x9b5Bc7EC520c17b8dCBAAF1fF4055e9fce25Eca7);
        } else {
        ...
        _createInitialSupply(address(this), totalSupply * 100 / 100);  // update with % for LP
