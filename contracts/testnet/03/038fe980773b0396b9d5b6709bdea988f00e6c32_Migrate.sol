...
contract Migrate is ReentrancyGuard, Context, Ownable{
    ...
    constructor(IBEP20 tokenAddressV1, IBEP20 tokenAddressV2) {
    ...
    function setTokenV1andV2(IBEP20 tokenV1addr, IBEP20 tokenV2addr, uint256 _rate) external onlyOwner{
        tokenV1 = tokenV1addr;
        tokenV2 = tokenV2addr;
...
uint rateconversion = (rate1 / (10 ** 2));
    ...
    function migrateToV2(uint256 v1amount) public nonReentrant(){
        ...
        uint256 amtToMigrate = v1amount * rateconversion * 10 ** tokenV2.decimals();
        ...
        require(!isBlacklisted[msg.sender] == true,  "contact support");
