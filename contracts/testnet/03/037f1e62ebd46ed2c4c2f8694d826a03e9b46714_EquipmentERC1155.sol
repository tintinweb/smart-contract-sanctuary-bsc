...
contract EquipmentERC1155 is ERC1155Upgradeable, AccessControlUpgradeable {
    ...
    struct Equipment {
        ...
        uint8 childType;  // 11 hat, 12 foot, 13 hand
        uint32 aggressivity;
        uint32 defensive;
        uint32 healthPoint;
    ...
    event EquipmentCreated(uint8 childType, uint256 indexed id, address indexed owner, uint256 boxId,  uint256 created);
    ...
    function createEquipment(
        ...
        uint8 aggressivity = Random.createRandom(1, 6, seed, boxId);
        uint8 defensive = Random.createRandom(1, 6, seed, aggressivity);
        uint8 healthPoint = Random.createRandom(1, 6, seed, defensive);
        equipment = Equipment({
            id: totalEquipment,
            equipmentName: _name,
            equipmentDescribe: _describe,
            childType: childType, // 11 hat, 12 foot, 13 hand
        ...
        emit EquipmentCreated(childType, totalEquipment, recipient, boxId, equipment.created);
        nextEquipmentId();
    }
    ...
    function useEquipment(uint256 id) onlyRole(SANDWICHES_ROLE) external {
