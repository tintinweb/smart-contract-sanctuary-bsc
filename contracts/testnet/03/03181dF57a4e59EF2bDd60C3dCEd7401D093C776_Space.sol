...
import "./Vesting.sol";
import "./PlayToEarnVesting.sol";
import "./EcosystemFundVesting.sol";
import "./TeamVesting.sol";
import "./ReserveVesting.sol";
...
contract Space is Ownable {
    ...
    constructor() {
        vestingList.push(new PlayToEarnVesting());
        vestingList.push(new EcosystemFundVesting());
        vestingList.push(new TeamVesting());
        vestingList.push(new ReserveVesting());
    }
...
contract TeamVesting is Vesting {
    constructor(){
        max = toWei(18450000);
        amountList = [toWei(0), toWei(922500), toWei(1845000), toWei(1845000), toWei(2767500), toWei(1383750), toWei(1383750), toWei(1383750), toWei(1383750), toWei(1383750), toWei(1383750), toWei(1383750), toWei(1383750)];
    }
}
...
contract ReserveVesting is Vesting {
    constructor(){
        max = toWei(36900000);
        amountList = [toWei(36900000)];
    }
}
...
contract PlayToEarnVesting is Vesting {
    constructor(){
        max = toWei(184500000);
        amountList = [toWei(46125000), toWei(11531250), toWei(11531250), toWei(11531250), toWei(11531250), toWei(11531250), toWei(11531250), toWei(11531250), toWei(11531250), toWei(11531250), toWei(11531250), toWei(11531250), toWei(11531250)];
    }
}
