...
contract PrivateSale is Ownable, Pausable {
    ...
    uint256 public constant ROUND = 2;
    uint256 public totalSupply = 30000000000000000000000000;
    uint256 public totalSell = 0;
    uint256 public tokenPriceRate = 16000000000000000; // 0.016
    uint256 public minBuy = 10000000000000000000; // $10
    uint256 public openSale = 1674518400; // 2022-01-24 00:00:00
    uint256 public endSale = 1675209599; // 2022-01-31 23:59:59
