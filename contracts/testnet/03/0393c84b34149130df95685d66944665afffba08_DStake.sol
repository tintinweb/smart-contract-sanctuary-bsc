...
contract DStake is IERC721Receiver, Ownable {
        ...
        returns (uint256, uint256)
    {
        ...
        return (exchangeRate, usdValue.mul(decimals).div(exchangeRate));
    }
    ...
    function _getFeeAmount(
        ...
        require(exchangeRate > 0, "not_listed");
        uint256 decimals = uint256(IERC20Extended(token).decimals());
        uint256 tokenAmount = usdValue.mul(decimals).div(exchangeRate);
