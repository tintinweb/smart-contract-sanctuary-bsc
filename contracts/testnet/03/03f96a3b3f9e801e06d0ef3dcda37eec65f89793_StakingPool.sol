...
contract StakingPool is IStakingPool, Initializable, OwnableUpgradeable, UUPSUpgradeable {
    enum StakeType {
        Single, //vns
        LP //vns cpd
    }
    ...
    function withdraw(uint256 poolId, uint256 amount) external needPoolOpen {
        ...
        require(IERC20(STAKED_TOKEN).balanceOf(address(this)) >= amount, "not enough staked token");
    ...
    function pending(
        ...
        public
        view
        returns (uint256 pendingVNS, uint256 pendingCPD, bool includDividendVns)
    {
