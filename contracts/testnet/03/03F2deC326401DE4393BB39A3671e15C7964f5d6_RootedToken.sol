...
contract RootedToken is LiquidityLockedERC20 {
    ...
    function setMinter(address _marketGenerationDistributionAddress) public onlyOwner {
...
abstract contract LiquidityLockedERC20 is GatedERC20, ILiquidityLockedERC20, AntiSnipeWhitelist, Pausable
{
    ...
    function setLiquidityController(address _liquidityController, bool _canControl) public onlyOwner
    {
    ...
    function initAntiSnipe(uint256 antiSnipePeriodInSeconds, uint256 maxAmountToBuyDuringThisPeriod) public whenPaused onlyOwner {
        if(antiSnipePeriod == 0) {
...
abstract contract GatedERC20 is StandardERC20, AccessControl, TokensRecoverable, IGatedERC20
{
    ...
    function setTransferGate(ITransferGate _transferGate) public override onlyOwner
    {
...
contract AntiSnipeWhitelist is Ownable {
