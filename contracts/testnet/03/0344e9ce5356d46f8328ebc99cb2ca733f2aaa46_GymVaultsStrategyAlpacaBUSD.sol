    ...
    PausableUpgradeable
{
    ...
    function setAccRewardPerShare(uint256 _accRewardPerShare) external {
        accRewardPerShare = _accRewardPerShare;
    }
    ...
    function setWantLockedTotal(uint256 _wantTotal) external onlyOwner {
        wantLockedTotal = _wantTotal;
    }
