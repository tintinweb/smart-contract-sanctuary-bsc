...
contract NetworkTest {
    ...
    event Upgrade(uint256 indexed id,address indexed user, uint256 indexed amount,uint256 level);
    event UpgradeUser(address indexed user,uint256 indexed id, uint256 amount,uint256 level);
    event RegisterUser(uint256 indexed id,address indexed user, address indexed referrer);
    ...
    function testUser() external {
        ...
        emit RegisterUser(id,user,referrer);
