...
contract Solmit is IBEP20, Auth {
    ...
    address constant BUSD = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    ...
    uint256 public LockedForLiquidity = 1 * (10 ** _decimals);
    uint256 public RoundBuyLimit = (1000000 * (10 ** _decimals));
    uint256 public roundsPeriod = 2 * 60 * 60;
    ...
    function startPresale() external onlyOwner{
        ...
        unlockData.push([0 , 0]);
        unlockData.push([presaleEndTime + (3 * 60 * 60) , 25]);
        unlockData.push([presaleEndTime + ((3 * 60 * 60) * 2) , 50]);
        unlockData.push([presaleEndTime + ((3 * 60 * 60) * 3) , 75]);
        unlockData.push([presaleEndTime + ((3 * 60 * 60) * 4) , 100]);
    ...
    function addPresaleLiquidity() external onlyOwner {
        ...
        if(firstLiquidityProvide == true){
            liquidityUnlockTime = block.timestamp + (60 * 10);
