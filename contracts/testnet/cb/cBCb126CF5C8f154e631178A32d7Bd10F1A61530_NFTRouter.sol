...
contract NFTRouter is Ownable {
    ...
    //    function _createRequestBundle(RequestType _type, uint256[] memory _data, address _user, uint256[] _salts) internal {
    //        nRequest++;
    //        uint256 _requestId = nRequest;
    //        requests[_requestId] = Request({
    //            id : _requestId,
...
//            _data[0] = _option;
//            _createRequest(RequestType.BUY, _data, msg.sender, _computerSeed(0));
//        }
//    }
    ...
    function createDroidBotBundle(uint256[] memory _pandoBoxIds) internal {
