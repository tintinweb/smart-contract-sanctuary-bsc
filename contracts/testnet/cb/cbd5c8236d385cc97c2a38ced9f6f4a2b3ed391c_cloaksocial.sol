...
contract cloaksocial is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x8BB6219Cd4Fe78b8385a34095ee0c76eb7877a16); 
    address payable public charityAddress = payable(0xA292a9217E893a098c11938BDA44b53FbA01170e); 
    address payable public dev1Address = payable(0x91eB43e50C8d96CB23b5e7a3a7fbc547153FaB50); 
    address payable public dev2Address = payable(0xC0bf88c5E859810463a40Af269d43EAb3C55f2f3); 
    address payable public busdAddress = payable(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
    address payable public liquidityWallet = payable(0xE6840a802262451c6C20e7207cBB5fA71d71a90A); 
    ...
    string private constant _name = "Cloaksocial.com";
    ...
    uint256 public _sellDev1Fee = 500;
    uint256 public _sellDev2Fee = 150;
