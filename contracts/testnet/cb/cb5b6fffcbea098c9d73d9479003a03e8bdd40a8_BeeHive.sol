...
contract BeeHive is IBEP20, Ownable {
    ...
    TaxRatios public _taxRatios = TaxRatios({
        ...
        marketing: 10,
        rewards: 10
        //@Treasury. These are ratios and the divisor will  be set automatically
    });


    TaxWallets public _taxWallet = TaxWallets ({
        Treasury: 0x134059e62a71f6861993d51bc2FE8eb243579aBe,
        Dev: 0xb98DDd1677593Dc75fb59E613C08D945A3353676,
        marketing: 0x4fCB0DCcc991592be25BE00907Fdd1573E1C61B1
    });
    ...
    uint8 private constant BLACKLIST_BLOCKS = 10; //number of blocks that will be included in auto blacklist
...
/////////////////////////////   CONSTRUCTOR  /////////////////////////////////////////
    ...
    constructor () {
        ...
        //setup ratio divisors based on Treasury's chosen ratios
    ...
    //allows Treasury to change token name and symbol. 
...
///// AUTHORIZED FUNCTIONS /////
    ...
    //Allows Treasury to change reward
    ...
    function updateLimits(uint16 newMaxWalletRatio, uint16 newMaxSellRatio, uint16 newMaxBuyRatio, uint16 newDivisor, bool ofCurrentSupply) external authorized {
        ...
        //Treasury can never set sells below 0.1% of circulating/initial supply
        ...
        authorized 
    {
        ...
        totalTaxRatio = newBurn + newBuyback + newTreasury + newLiquidity + newDev + newmarketing + newRewards;
        totalSwapRatio = totalTaxRatio - newBurn;
        distributeRatio = totalSwapRatio - newLiquidity;

        emit RatiosChanged (newBurn, newBuyback, newTreasury, newLiquidity, newDev, newmarketing, newRewards);
    }
    ...
    function withdrawTreasury() external authorized {
        ...
        uint256 amount = lostBalance ? TreasuryBalance + remaining : TreasuryBalance;
        TreasuryBalance = 0;
...
///// OWNER FUNCTIONS /////  
    ...
    function setTreasuryWallet(address payable addr) external onlyOwner {
...
////// VIEW FUNCTIONS /////
    ...
    function getWithdrawBalances() external view returns (uint256 buyback, uint256 Treasury, uint256 Dev, uint256 marketing) {
        return (buybackBalance, TreasuryBalance, DevBalance, marketingBalance);
    }
