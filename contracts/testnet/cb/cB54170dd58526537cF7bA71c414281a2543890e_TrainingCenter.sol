...
contract TrainingCenter is ERC721, Ownable {
    ...
    function updateInterfaces() external {
        trainingManagementAddress = gameAddresses.getAddressOf(AddressesInit.Addresses.TRAINING_MANAGEMENT);
        openAndCloseAddress = gameAddresses.getAddressOf(AddressesInit.Addresses.OPEN_AND_CLOSE);
        ...
        returns (uint256)
    {
        ...
        ITrainingManagement(trainingManagementAddress).initSpotsNumber(_tokenId);
        ...
        returns (bool)
    {
        ...
        require(_numberOfTrainingSpots[_tokenId] + _quantity <= 10, "Max spots already hit");
