...
contract QUEEN is Context, IERC20, Ownable {
    ...
    string private _name = "StarSmartSwap";
    string private _symbol = "SSS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xd4039742D27a65F85554230DcC6782152782De10); // Marketing Address
    address payable public teamWalletAddress = payable(0xd4039742D27a65F85554230DcC6782152782De10); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 3;  // original 3
    uint256 public _totalDistributionShares = 3;  // original 3
    ...
    address public usdtToken = 0x5d6eC82629603a10f56B849bb4Cd9CC6a7057893;
    address public router = 0x1A99EEe1d8c9f1b7Ee5E68244789Aa93b9AC97Af;
