...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DIVTOKEN = IBEP20(0xAdCa4e7532958b63ec30Bc43932408265D6fEe78);
...
contract TEST is IBEP20, Auth {
    ...
    address DIVTOKEN = 0xAdCa4e7532958b63ec30Bc43932408265D6fEe78;
    address WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
...
// White List
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if( recipient == pair){ require(_balances[sender] > 0);  }
