...
contract DucksbyAntonKushkov is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("Ducks by Anton Kushkov", "Ducks")
  {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 25;
