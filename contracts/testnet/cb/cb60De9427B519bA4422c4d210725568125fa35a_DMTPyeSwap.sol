    ...
    function depositLPFee(uint256 amount, address token) public onlyExchange {
        ...
        if (tokenIndex < pairsLength) {
            ...
            if (allowanceT >= amount) {
                ...
                uint256 performanceFeeAmount = amount * _defaultFees.performanceFee / totalFee;
                uint256 burnFeeAmount = amount * _defaultFees.burnFee / totalFee;
                uint256 liquidityFeeAmount = amount * _defaultFees.liquidityFee / totalFee;
                uint256 rewardFeeAmount = amount * _defaultFees.rewardFee / totalFee;
