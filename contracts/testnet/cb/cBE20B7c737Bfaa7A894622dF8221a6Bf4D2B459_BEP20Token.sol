...
contract BEP20Token is Context, IBEP20, Ownable, AccessControl {
  ...
  */
  ...
  function approve(address spender, uint256 amount) override external returns (bool) {
    ...
    require(false,"This method has been disable, please use increaseAllowance and decreaseAllowance instead");
    return false;
  }
  ...
  function mint(uint256 amount) public onlyRole(MINTER_ROLE) returns (bool) {
    require(_totalSupply+amount<=5*1e9, "Max total supply is 5 bilion");
