...
// File: contracts/stakingTokenToGetTokenss.sol
...
contract SmartChefInitializable is Ownable, ReentrancyGuard {
    ...
    uint public withdrawtime = 604800; 
    ...
    function deposit(uint256 _amount) external nonReentrant {
        ...
        user.stakedattime = block.timestamp;

        emit Deposit(msg.sender, _amount);
    }

// reward tokens- 0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B
// staked tokens - 0xd8b934580fcE35a11B58C6D73aDeE468a2833fa8

    function setwithdrawtime(uint256 _timeinsec) public onlyOwner {
       withdrawtime = _timeinsec; 
    ...
    function withdraw(uint256 _amount) external nonReentrant {
        ...
        if (pending > 0 && (user.stakedattime + withdrawtime) < block.timestamp) {
            rewardToken.safeTransfer(address(msg.sender), pending);
        } else {
            rewardToken.safeTransfer(address(msg.sender), pending/2);
        }
