...
interface IERC20 {
    ...
    function balanceOf(address admin) external view returns (uint);
...
interface IRYZRSwapPair {
    ...
    function nonces(address admin) external view returns (uint);

    function permit(address admin, address spender, uint value, uint deadline, uint8 v, bytes32 r, bytes32 s) external;
...
library RYZRSwapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint160(uint(keccak256(abi.encodePacked(
                ...
                hex'1d14ba0ab8836e4820e8795237b7f528d60a325b5e488ee369c6ea53da7c5a08' // init code hash
            )))));
    }
