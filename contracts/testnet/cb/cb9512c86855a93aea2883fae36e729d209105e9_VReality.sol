...
contract VReality is Context, IERC20, Ownable {
    ...
    //max allowed fees to be called on
    ...
    address public router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;   //testnet router
    //address public mainnet router = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    bool public authorizedByCryptoCravers = true;   //confirms smart contract has been created and delployed by the CryptoCravers
    bool public audit = true;  //confirms smart contract has been audited by a third party source
    ...
    address payable public feeWallet;  //pays owner wallet tax fee 
    ...
    constructor (address tokenOwner,string memory tokenName,
        ...
        numTokensSellToAddToLiquidity = amountOfTokenWei.mul(2).div(1000); 
    ...
    function setBuybackUpperLimit(uint256 buyBackLimit) external onlyOwner() {
        buyBackUpperLimit = buyBackLimit * 10**4;
    }
