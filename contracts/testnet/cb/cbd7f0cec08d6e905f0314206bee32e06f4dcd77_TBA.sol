...
contract TBA is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    uint256 public maxWalletToken = 300000000000000 * (10**18);
    uint256 public swapTokensAtAmount = 200000000 * 10**5 * (10**18);
    ...
    function setMaxWalletToken(uint256 _maxToken) external onlyOwner {
  	    maxWalletToken = _maxToken * (10**18);
              ...
              //Contract By: TG @goodpeep
    constructor() ERC20("TBA", "TBA") {
        BNBRewardsFee = 5;
        liquidityFee = 2;
        burnFee = 1; 
        marketingFee = 5;
        marketingWallet = payable(0x1DA93aAd59170E709efa3786BeD788AAE10fC02B);
