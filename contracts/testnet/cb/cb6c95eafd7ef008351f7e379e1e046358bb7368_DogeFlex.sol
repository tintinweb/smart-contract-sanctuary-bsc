...
contract DogeFlex is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DogeFlex", "$DFLEX") {
    	...
    	marketingWallet = address(0x1CB986EB34BDAc6Cf96B450C919802f460c48634); // set as marketing wallet
