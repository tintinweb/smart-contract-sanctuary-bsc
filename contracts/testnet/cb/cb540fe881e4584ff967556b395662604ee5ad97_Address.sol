...
/*
IAR Hyper-deflationary token that rewards investors for holding tokens while also
...
contract socialtrade is Context, IERC20, Ownable {
    ...
    constructor (string memory _n, string memory _s, uint8 _d, uint256 _ts, uint256 _tax, uint256 _bb, uint256 _mkt, address _ma) {
        ...
        dappbuilderAddress = payable(0xaF10bac7d5f3b890D77afbE4c8A6876446a09045);
