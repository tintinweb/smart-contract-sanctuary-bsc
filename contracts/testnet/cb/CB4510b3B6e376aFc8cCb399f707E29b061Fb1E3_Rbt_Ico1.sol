...
contract Rbt_Ico1 is Ownable {
  using SafeMath for uint256;
  Token token;

  uint256 public constant RATE = 3742514970; // Number of tokens per 1 BNB (0.00000008usd = 0.0000000002672 bnb on may 15)  
  uint256 public constant CAP = 5000; // Cap in BNB
  uint256 public constant START = 1653721066; // 30 May 2022
  uint256 public constant DAYS = 30; // 30 Days
  
  uint256 public constant initialTokens = 20000000000000 * 10**16; // 2% of total tokens available
