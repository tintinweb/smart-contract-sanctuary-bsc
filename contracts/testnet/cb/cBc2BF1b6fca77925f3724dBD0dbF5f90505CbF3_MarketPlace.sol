...
contract MarketPlace is Initializable {
  ...
  function initialize(address[] memory addresses, address[] memory whitelistArray) public initializer {
    tokenAddress = addresses[0];
    rewardsPoolAddress = addresses[1];
    // project wallet 0x19229b28ea4aefb4E77346B5313Fabe0e6168dFb
    operationsPoolAddress = address(0x19229b28ea4aefb4E77346B5313Fabe0e6168dFb);
    owner = msg.sender;
  ...
  function assets(address account) public view returns (Assets[] memory) {
    ...
    Assets[] memory assetsActive = new Assets[](countOfUser[account]);
