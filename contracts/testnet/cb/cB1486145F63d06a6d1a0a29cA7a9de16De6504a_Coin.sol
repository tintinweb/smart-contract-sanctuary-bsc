...
contract Coin is Context, IERC20, Ownable {
    ...
    constructor (string memory tokenName,string memory tokenSymbol,uint8 tokenDecimals,uint256 supply,address[] memory addressArray,uint256[] memory baseFees,uint256[] memory genFees,uint256 holderSnapshotAmount,address usdAddress) payable Ownable(addressArray[0]) {
        _name = tokenName;
        _symbol = tokenSymbol;
