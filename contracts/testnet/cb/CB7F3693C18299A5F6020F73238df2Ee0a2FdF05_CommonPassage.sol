    ...
    Ownable
{
    ...
    receive() external payable {
        uint256 before = rewardToken.balanceOf(address(this));
        (bool s, ) = payable(address(rewardToken)).call{
    ...
    function _transfer(
        ...
        require(_totalSupply >= MAX_SUPPLY - 1, "Not Yet Sold Out");
    ...
    */
    ...
    function pendingRewards(address account) public view returns (uint256) {
        ...
        uint256 accountTotalDividends = getCumulativeDividends(
            _balances[account]
        );
