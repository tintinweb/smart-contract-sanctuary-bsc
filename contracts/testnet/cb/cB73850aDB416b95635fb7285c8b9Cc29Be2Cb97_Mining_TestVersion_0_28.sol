...
contract Mining_TestVersion_0_28 {
    ...
    function deposit(address ref, uint256 tierIndex) public payable nonReentrant {
        ...
        uint256 index = Miners[msg.sender].txDifference;
    ...
    function withdrawProfit(uint256 wattsIndex) public {
        require(wattsIndex < Miners[msg.sender].txDifference, "Invalid index");
        ...
        Miners[msg.sender].txDifference -= 1;
        totalTx++;
