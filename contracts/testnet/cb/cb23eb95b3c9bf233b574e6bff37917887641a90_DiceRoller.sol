...
contract DiceRoller is VRFConsumerBaseV2, ReentrancyGuard {
  ...
  function betUp(address _referrer) isUnpaused public payable{
    rollDice(1,_referrer);
  }

  function betDown(address _referrer) isUnpaused public payable{
  ...
  function claimReferral() public nonReentrant isUnpaused{
    uint256 referrelUnclaimedBalance = referralUnclaimedBalance[msg.sender];
    referralUnclaimedBalance[msg.sender] = 0;
    (bool success, ) = msg.sender.call{value: referrelUnclaimedBalance}("");
    require(success, "Transfer failed.");
  }
