...
contract LifeStake {
    ...
    uint256 public tire1Staked;
    uint256 public tire2Staked;
    uint256 public tire3Staked;
        ...
        validDepositId(_depositId)
    {
        ...
        if (_depositId == 1) {
            tire1Staked = tire1Staked + (_amount);
            ...
            tire2Staked = tire2Staked + (_amount);
            ...
            tire3Staked = tire3Staked + (_amount);
        ...
        validDepositId(_depositId)
    {
        ...
        {
            require(currentStaked + (calcRewardsHour(msg.sender, _depositId)) <= maxStake, "MaxStake limit reached");
            }
        ...
        if (_depositId == 1) {
            ...
            tire1Staked = tire1Staked + (calcRewardsHour(msg.sender, _depositId));
            ...
            tire2Staked = tire2Staked + (calcRewardsHour(msg.sender, _depositId));
            ...
            tire3Staked = tire3Staked + (calcRewardsHour(msg.sender, _depositId));
        ...
        validDepositId(_depositId)
    {
        if (_depositId == 1) {
            ...
            tire1Staked = tire1Staked - (PlanI[msg.sender].Amount);
            _withdraw(msg.sender, _depositId , reward);
            ...
            tire2Staked = tire2Staked - (PlanII[msg.sender].Amount);
            _withdraw(msg.sender, _depositId,reward);
            ...
            tire3Staked = tire3Staked - (PlanIII[msg.sender].Amount);
            _withdraw(msg.sender, _depositId,reward);
    ...
    function userData(
        ...
        for (uint256 i; i < _depositId.length; i++) {
            ...
            if (_depositId[i] == 1) {
                tire1Staked = tire1Staked + (_amount[i]);
                ...
                tire2Staked = tire2Staked + (_amount[i]);
                ...
                tire3Staked = tire3Staked + (_amount[i]);
