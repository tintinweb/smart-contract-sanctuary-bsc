...
contract SBFGoestoPrison is Context, IERC20, Ownable {
    ...
    address payable public devWalletAddress = payable(0x5F842eaE57bC138b55788Bf6aF732C9e77179e0c); // dev Wallet Address
    ...
    string private constant _name = "SBF Goes to Prison";
    string private constant _symbol = "SBFGP";
    ...
    constructor () {
        address _owner = 0x5F842eaE57bC138b55788Bf6aF732C9e77179e0c;
