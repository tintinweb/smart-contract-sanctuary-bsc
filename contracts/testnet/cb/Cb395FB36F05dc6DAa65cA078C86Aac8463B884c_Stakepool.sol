...
/**
        Changes:
        1. Added 2 new mappings to store the nft owners and nft balances
        2. Added a new function to stake nft
        3. Added a new function to withdraw nft
        4. Changed the struct Tier to support nft
        5. Added a new function to get the nft balance of a user
        6. Added a new function to get the nft owner of a nft
        7. Added a new function to get all the staked nfts of a user
        8. Rewards functionality is removed
        10. Minor changes in the existing functions
        11. Converted the contract to an upgradeable contract
        12. Added hardhat task to deploy and upgrade the contract
        8. Implemented a new and better folder structure for the contracts
