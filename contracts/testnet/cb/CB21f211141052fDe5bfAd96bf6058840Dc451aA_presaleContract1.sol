...
contract presaleContract1 is Ownable {
    ...
    uint256 public rewardDuration = 3;
    ...
    function buy(uint256 _amount) public {
        ...
        buyToken.transferFrom(address(_user), address(this), _amount);
    }
    ...
    function claim() public payable {
        ...
        if(currentTime > rewardDuration){
            uint256 _claimablePercent = (100 * 1e18 - TGEUnlockPercent);
