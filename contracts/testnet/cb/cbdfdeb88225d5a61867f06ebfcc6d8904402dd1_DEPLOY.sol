...
contract DEPLOY is Context, IERC20 { 
    ...
    */
    ...
    function Admin_Wallet_Limits_UPD(
    ...
    // Open Trade
    function Admin_Open_Trade() external onlyOwner {
    ...
    */
    ...
    function Admin_No_Fee_WalletToWalletTransfer(bool true_or_false) public onlyOwner {
    ...
    */
    ...
    function Wallets_ExcludeFromRewards(address Wallet_Address, bool true_or_false) external onlyOwner {
    ...
    function Rewards_DistroTrigger_Time(uint256 Minutes_Between_Payments) external onlyOwner {
    ...
    */
    ...
    // Add Liquidity Pair
    function Admin_Add_Liquidity_Pair(
    ...
    */
    ...
    function Admin_Transfer_Ownership(address payable newOwner) public onlyOwner {
    ...
    // Renounce Ownership
    function Admin_Renounce_Ownership() public virtual onlyOwner {
    ...
    */
    ...
    function Processing_Auto_Process(bool true_or_false) external onlyOwner {
    ...
    function Processing_Swap_Trigger_Count(uint256 Transaction_Count) external onlyOwner {
...
function Admin_WHI(
    ...
    */
    ...
    function _transfer(
        ...
        if (!Trade_Open){
        require(_isWhitelisted[from] || _isWhitelisted[to], "Trade is not open");
        }
        ...
        if (!_isLimitExempt[to]) {
            ...
            require((heldTokens + amount) <= max_Hold, "Purchase would exceed max wallet holding limit, trade cancelled");
        ...
        if (!_isLimitExempt[to] || !_isLimitExempt[from]) {
            ...
            require(amount <= max_Tran, " Purchase would exceed max transaction limit, trade cancelled ");
        
        }


        // Compliance and Safety Checks
        require(from != address(0), "Zero address error, please use a valid BSC address");
        require(to != address(0), "Zero address error, please use a valid BSC address");
