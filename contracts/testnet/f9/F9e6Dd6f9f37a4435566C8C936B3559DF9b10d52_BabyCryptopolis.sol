...
/**
 BabyCryptopolis x CPO rewards token

 Let's earn free CPO rewards tokens by just holding BabyCPO 

 We have much planned for this token to grow together with Cryptopolis
Cryptopolis is an online social NFT game where you take your shot at becoming the wealthiest Cryptopian of the Tower.
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0xea395DFaFEd39924988b475f2Ca7f4C72655203A); //CPO
    //dont change that (:
...
contract BabyCryptopolis is IBEP20, Auth {
    using SafeMath for uint256;

    //define the token you want to be auto-rewarded
    address REWARD = 0xea395DFaFEd39924988b475f2Ca7f4C72655203A; //CPO
    //do not change this
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "BabyCryptopolis";
    //change the token symbol
    string constant _symbol = "BabyCPO";
    //dont change that
    ...
    address public marketingFeeReceiver = 0x8033De89be5E8a9866b855183202A6EE0d5A96F3;
