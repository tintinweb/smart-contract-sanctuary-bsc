...
contract Token is Context, IBEP20, Ownable {
    ...
    address public _marketingWallet = 0x489ED969bc7817E701Cf928332b64978AF739F09;
    address public _devWallet = 0x6d36Af743B0f285A8295767254De5DD19c616ba6;
    ...
    string private _name     = "Test 00001";
    string private _symbol   = "t0001";
    ...
    uint256 public _swapThreshold   = 500 * 10**9;

    // auto liquidity
    bool public _swapAndLiquifyEnabled = true;
    bool _inSwapAndLiquify = true;
    ...
    function calculateMarketingFee(uint256 amount) private view returns (uint256) {
        return amount.mul(_marketingFee).div(_liquidityFee);
    }

    function calculateDevFee(uint256 amount) private view returns (uint256) {
        return amount.mul(_devFee).div(_liquidityFee);
    }
    ...
    function _transfer(
        ...
        */
        ...
        bool isOverMinTokenBalance = contractTokenBalance >= _swapThreshold;
        if (
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        // take fee
        uint256 marketingFee   	= calculateMarketingFee(newBalance);
        //uint256 devFee   	= calculateDevFee(newBalance);
        ...
        if (marketingFee > 0) {
            ...
            //emit DevFeeSent(_devWallet, marketingFee);
        }
