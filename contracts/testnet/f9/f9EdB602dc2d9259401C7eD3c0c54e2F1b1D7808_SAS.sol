...
contract SAS is ReentrancyGuard, Pausable, Ownable {
    ...
    uint256 public rewardsDuration = 3 minutes;
    ...
    uint256 public constant minDuration = 1 minutes;
    // uint256 public constant minDuration = 1 days;
    // uint256 public constant maxDuration = 365 days;
    uint256 public constant maxDuration = 3 minutes;
    ...
    constructor(
        ...
        rewardsToken.approve(address(this), 2**256 - 1);
    }
