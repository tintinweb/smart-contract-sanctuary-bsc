...
// Telegram : https://TianChain
// Website  : https://tianchain.org
...
/* Token contract */
contract  TianChain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV =  0x4a6fbE6F5018f57f930596023BCF3Bb4491059F2;
    ...
    // Name and symbol
    string constant _name = "Tian Chain";
    string constant _symbol = "TNC";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 10000000 * (10 ** _decimals); // KILL ZERO

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 2 / 1000; // 2% 
    uint256 public _maxSellTxAmount = _totalSupply * 2 / 1000; // 2% 
    uint256 private _maxWalletToken = ( _totalSupply * 2 ) / 1000; // 2% 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x4a6fbE6F5018f57f930596023BCF3Bb4491059F2;
