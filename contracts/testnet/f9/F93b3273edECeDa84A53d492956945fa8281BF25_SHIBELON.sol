...
contract SHIBELON is IBEP20, Auth {
    using SafeMath for uint256;

    // address public WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WBNB address in mainnet
    address public WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DestinyWorldToken";
    string constant _symbol = "DECO";
    ...
    constructor() Auth(msg.sender) {
        ...
        // router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // Testnet Router 1
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Testnet Router <https://pancake.kiemtienonline360.com/#/swap>
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); // Binance-Peg Dogecoin Token (DOGE)
