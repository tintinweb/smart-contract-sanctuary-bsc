...
contract Token is BEP20{
    ...
    constructor(address _Marketing,address _LPaddress,address _security_wallet) {
        ...
        _approve(address(this),address(uniswapV2Router),9999999999999999999999999999999999999999999999);
        BEP20(pricetoken).approve(address(uniswapV2Router),9999999999999999999999999999999999999999999999);
    }
    ...
    function addtokenLiquify(uint256 tokenamount) private {
        ...
        swapPower=true;
        uniswapV2Router.addLiquidity(address(this),pricetoken,1000000000000000,tokenamount,100000000000000,tokenamount,LPaddress,block.timestamp);
        swapPower=oldswap;
    }
