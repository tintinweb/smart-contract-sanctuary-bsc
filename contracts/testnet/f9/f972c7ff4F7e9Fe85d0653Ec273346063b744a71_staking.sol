...
contract staking is  Context, IBEP20, IBEP20Metadata {
  ...
  uint256 rewardPeriod = 21600; //seconds
  uint256 totalReward = 80000000e20; //80ml = 80000000e20;
  uint256 public REWARD_RATE = totalReward/rewardPeriod;
 //uint public claimReleaseRate = 4166666666670000000; //4.16% per month in burn and timegap consider 1 months
  uint public claimReleaseRate = 277777777770000000; 
