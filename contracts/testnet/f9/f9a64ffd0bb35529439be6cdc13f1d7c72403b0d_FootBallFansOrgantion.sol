...
// File: FootBallFansOrgantion.sol


contract FootBallFansOrgantion is ERC721 ,Ownable {
    ...
    //收费地址
    uint256 public price = 0.0011 ether;
    ...
    constructor(address _settleToken,
                ...
                uint256 _maxSupply) 
                public ERC721("FootBallFansOrgantion", "FFONft") {
