...
contract Clover_Seeds_Picker is Ownable {
    ...
    function getBaseURIFieldCarbon() public view returns(string memory) {
        return _baseURIFieldCarbon;
    }
    ...
    function randomLayer(uint256 tokenId) public returns (bool) {
        ...
        if (tokenId <= 1e3) {
            ...
            console.log("clover field uri", uri);
