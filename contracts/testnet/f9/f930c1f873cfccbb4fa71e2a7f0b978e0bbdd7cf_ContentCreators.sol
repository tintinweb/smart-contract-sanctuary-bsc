...
contract ContentCreators is Context, Ownable {
    ...
    address busd = 0x690afF4a3A0d346332b8b3edDF6034Fe48C2caDb; // testnet
	...
	uint256 public CUTOFF_STEP = 4000;//36 * 60 * 60; /** 36 hours  **/
    uint256 public COMPOUND_STEP = 3700;//13 * 60 * 60; /** every 13 hours. **/
