...
contract PruebaR is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PruebaR";
    string private _symbol = "PRBAR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0e4e2BfA40a2f797595e5d0324f1b9a13da3c6E1); // Marketing Address
    address payable public teamWalletAddress = payable(0x406F4EF9CB10764aaE55c7951292fefcf9f9746B); // Team Address
