...
contract BasitTokenV2 is ERC20, ERC20Burnable, Ownable {
    /**
    ...
    event tokenDistributed(uint256 allocationId,address indexed receiver, uint256 indexed amount);

    uint256 private seedTotal = 53000000e18;
    uint256 private privateITotal = 30000000e18;
    uint256 private privateIITotal = 36000000e18;
    uint256 private privateIIITotal = 36000000e18;
    uint256 private rewardsTotal = 47500000e18;
    uint256 private advisorsTotal = 52500000e18;
    uint256 private communityTotal = 60000000e18;
    uint256 private exchangesTotal = 80000000e18;
    uint256 private teamTotal = 140000000e18;
    uint256 private reservesTotal = 250000000e18;
    uint256 private investorsTotal = 215000000e18;
    uint256 private tgeTotal = 30000000e18;

    function distributeToken(uint256 allocationId, address contractAddress, uint256 amountBasit) external onlyOwner{
        uint256 _getSupply = getDistributableAmount(allocationId);

        if(amountBasit==0){amountBasit=_getSupply;}

        require(_getSupply>=amountBasit,"The amount demanded cannot be higher than the distributable supply.");

        _transfer(address(this), contractAddress, amountBasit);

        setDistributableAmount(allocationId,(_getSupply - amountBasit));

        emit tokenDistributed(allocationId, contractAddress, amountBasit);
    }
    ...
    constructor() ERC20("BasitTokenV2", "BTV2") {
