...
contract PBXSmartChef is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
...
contract PBXPoolFactory is Ownable {
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(PBXSmartChef).creationCode;
        ...
        PBXSmartChef(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
