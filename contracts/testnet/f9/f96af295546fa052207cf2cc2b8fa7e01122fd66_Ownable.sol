...
contract  AmberInsurance is ERC20Detailed, Ownable {
    ...
    string public _name = "Noufel Protocol";
    string public _symbol = "NFL";
    ...
    constructor() ERC20Detailed("Amber Protocol", "AMBR", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x53636a647aFc2bb73a1cF275FC5F1bA875cf7bfA;
        treasuryReceiver = 0x53636a647aFc2bb73a1cF275FC5F1bA875cf7bfA; 
        safuuInsuranceFundReceiver = 0x53636a647aFc2bb73a1cF275FC5F1bA875cf7bfA;
        firePit = 0x53636a647aFc2bb73a1cF275FC5F1bA875cf7bfA;
