...
contract DIANATOKEN is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC20PermitUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("DIANA TOKEN", "DIANA");
        __ERC20Burnable_init();
        __Pausable_init();
        __AccessControl_init();
        __ERC20Permit_init("DIANA TOKEN");
