...
contract Poostarter is Context, IERC20, Ownable {
    ...
    address private _devAddress = 0x515Bf1fF2251540fd29F392a159409d76eD84C01;
    ...
    function setSellLiquidityFeePercent(uint256 liquidityFee)
        external
        onlyOwner
    {
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
        require(maxTxPercent > 0, "Cannot set max transaction to 0");
