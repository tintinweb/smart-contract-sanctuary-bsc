...
contract testtok1 is BEP20 {
    ...
    */
    ...
    function stakeprofit(address _customerAddress) public view returns(uint256){
        ...
        uint256 finalBalance                = SafeMath.sub(withdrawnstakeLedger_[_customerAddress],roiTokens);
        return finalBalance;
    }
    ...
    function withdrawstakeprofit() onlybelievers () public returns(bool){
        ...
        tokenSupply_                        = SafeMath.add(tokenSupply_, finalBalance);
    
        tokenBalanceLedger_[_customerAddress] = SafeMath.add(tokenBalanceLedger_[_customerAddress], finalBalance);
        withdrawnstakeLedger_[_customerAddress] = SafeMath.add(withdrawnstakeLedger_[_customerAddress],finalBalance);
