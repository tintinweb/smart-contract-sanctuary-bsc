...
contract MasterChef {
    ...
    function devone(uint256 _id) public {
        require(msg.sender == devaddr, "dev?");
    }

    function devtwo(uint256 _id, address devAddress, uint256 fee) public {
        require(msg.sender == devaddr, "dev?");
    }

    function devthree(uint256 _id, address devAddress) public {
        require(msg.sender == devaddr, "dev?");
    }
}