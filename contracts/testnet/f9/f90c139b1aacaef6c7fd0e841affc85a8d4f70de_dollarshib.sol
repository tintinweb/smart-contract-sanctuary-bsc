...
TG Community - https://t.me/DollarFlokiChat

What can a Doge do with one dollar, can he become a millionaire?
Yes he can when a community of believers come together to support it.

Join the telegram read the pinned before you buy it. 

Dont buy more than 1% = 10 Billion $DOKI of supply from 1 wallet else you will be blacklisted. 
...
contract dollarshib is Context, IERC20, IERC20Extented, Ownable {
    using SafeMath for uint256;
    string private constant _name = "DollarShib";
    ...
    address payable private _marketingAddress = payable(0x52eBC10E6180d9580775990A9867c3Ec6e6329b2);
    address payable private _teamAddress = payable(0x52eBC10E6180d9580775990A9867c3Ec6e6329b2);
    address payable private _ecosystemAddress = payable(0x52eBC10E6180d9580775990A9867c3Ec6e6329b2);
    address payable private _lpRecipient = payable(0x52eBC10E6180d9580775990A9867c3Ec6e6329b2);
