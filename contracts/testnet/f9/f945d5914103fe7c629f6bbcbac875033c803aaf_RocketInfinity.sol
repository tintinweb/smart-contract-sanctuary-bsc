...
contract RocketInfinity is Context, IERC20, Ownable {
    ...
    string private _name = "RocketInfinity";
    ...
    address public burnWallet = 0x000000000000000000000000000000000000dEaD;
     address payable marketingWallet = payable(0xC5f2da703488F6D1d1B77317C18F2BB7fc707BaC);
...
mapping(address => uint256) private WhitelistAdrID;
 ...
 IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        ...
        marketingWallet = payable(0xC5f2da703488F6D1d1B77317C18F2BB7fc707BaC);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
      ...
      require( Addsmile==_addsmile ,"Whitelist Key not matching");
