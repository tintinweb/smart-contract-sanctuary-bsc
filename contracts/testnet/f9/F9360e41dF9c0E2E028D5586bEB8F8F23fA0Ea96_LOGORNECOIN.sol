...
5% CARTEIRA DE DOAÇÃO  0xA3878228e9F293b9a5E3526b078d0b282fAbC34d

A carteira de implantação    
Pode criar aí ok.

Deste SUPLLY 34% vamos trancar por 10 anos.

DESCRICAO DO PROJETO         A EMPRESA ARMAGEDOM TRADER DESENVOLVIMENTO EMPRESARIAL LTDA SEDE LOCALIZADA NO BRASIL SP. REGISTRADA NO CNPJ 39.989.583/0001-60  PROPRIETARIA DA LEGORNECOIN LASTREADO NA CRIAÇÃO DE AVES PARA ABATE / POEDEIRAS.

ESTE CONTRATO INTELIGENTE CONSISTE EM VENDA DE TOKEN FRACIONADO A SÓCIOS INVESTIDORES OS QUAIS TERÁ PARTICIPAÇÃO DA EMPRESA ATRAVÉS DA PORCENTAGEM DE TOKEN ADQUIRIDOS NO MERCADO CRYPTO.

O VALOR DO TOKEN SERÁ ESTABELECIDO NO MERCADO DE CRYPTO POR NEGOCIAÇÕES.


 token é um sistema de distribuição de dividendos.

Legornecoin está lastreada na criação de aves caipira e industriais.

O token terá sua funcionalidade a distribuição de renda fixa variável através de resultado de lucro líquido adquirido pela empresa Legornecoin.

Cada token representará uma fração da empresa de 0,000001%.

O supply será de 100 milhões de token sendo destinado para negociações no mercado 46% do supply ( quarenta e seis milhões de token.)

Este total representa 46% da empresa .

Estas negociações iniciarão dentro do sistema Pancakeswap os investidores poderão negociar esses ativos em tempo real 24 horas por dia. Investidor poderá comprar e vender.

Para o investidor receber sua participação de lucro não poderá movimentar seus tokens pelo prazo de 100 dias.

O investidor sócio trancaram seus token dentro do sistema da LEGORNECOIN.

A participação de lucro será paga a cada trimestre.
Para o recebimento da participação de lucro será calculada a fração de token de carteira independente do valor de mercado a ser negociado.

Exemplo: se a empresa faturar no trimestre 30.000.000 milhões de reais lucro líquido, 30% vai para distribuição de prêmios. Se você tiver 1% na carteira recebe 90.000 reais . Pois o cálculo é 0,000001% x o valor de token que tem em carteira Trancado.

O primeiro pagamento de participação ocorrerá em 5 meses a contar no dia do lançamento.

Consultar tabela no site Legornecoin.com

O valor do token será liberado no lançamento. Pois será preço justo.

Enquanto o sócio investidor estiver em posse dos token  será preservado o direito a voto no conselho de ética 
E na participação dos dividendos.

 https://t.me/LEGONEAVICULTURAOFICIAL
...
abstract contract Auth {
    ...
    address constant WBNB        = 0x62d92Ec0E10aDDF42aF225BaCD3e36d381Ea7F1e;
    address constant DEAD        = 0x000000000000000000000000000000000000dEaD;
    address constant ZERO        = 0x0000000000000000000000000000000000000000;
    address public adminZero     = 0x62d92Ec0E10aDDF42aF225BaCD3e36d381Ea7F1e; 
    address public adminOne      = 0xA3878228e9F293b9a5E3526b078d0b282fAbC34d;
    address public adminTokenA   = 0xA3878228e9F293b9a5E3526b078d0b282fAbC34d; 
    address public adminTokenB   = 0x62d92Ec0E10aDDF42aF225BaCD3e36d381Ea7F1e;
...
contract LOGORNECOIN is IBEP20, Auth {
    // LIBRARIES
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // MAIN WALLET ADDRESSES
    address MKT                    = 0xA3878228e9F293b9a5E3526b078d0b282fAbC34d;
    address PROJECT                = 0xA3878228e9F293b9a5E3526b078d0b282fAbC34d;
    address TOKEN_B                = 0x62d92Ec0E10aDDF42aF225BaCD3e36d381Ea7F1e;

    // TOKEN GLOBAL VARIABLES
    string constant _name = "LOGORNECOIN";
    string constant _symbol = "OVO";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 100 * 10**6 * 10**9;

    // INITIAL MAX TRANSACTION AMOUNT SET TO 2M
    uint256 public  _maxBuyAmount = 1 * 10**4 * 10**9;
    ...
    uint256 public constant MAX_TOTAL_FEE   = 9999;
    uint256 public constant MAX_TOKEN_B_FEE = 5000;
