...
contract StarMoon is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x5f3937742299EB6542b230b5af2716015aF5A30D;

    string private constant _name = "Star Moon";
    ...
    Taxes public sellTaxes = Taxes(0, 4, 1);
    ...
    {
        require(
            maxBuy >= 1_000_000_000,
            "Cannot set max buy amount lower than 1% of total supply"
        );
        require(
            maxSell >= 1_000_000_000,
            "Cannot set max sell amount lower than 1% of total supply"
        );
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(
            amount >= 1_000_000_000,
            "Cannot set max wallet amount lower than 1% of total supply"
        );
