...
abstract contract Ownable is Context {
    ...
    // Set original owner = ganti manual
    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    constructor () {
        _owner = 0xDa34217251450adD6852Ab13dC6081184deaf574;
...
contract Testchain is Context, IERC20, Ownable { 
    ...
    WALLETS
 tinggal ganti atau disamain =wallet dev = wallet marketing
    */


    address payable private Wallet_Dev = payable(0xDa34217251450adD6852Ab13dC6081184deaf574);
    ...
    */
    ...
    // set wallet dev supaya nggak kena gassfee tiap transaksi
    function excludeFromFee(address account) public onlyOwner {
        _isExcludedFromFee[account] = true;
    }
    
    // Set a wallet address so that it has to pay transaction fees
    // set wallet dev supaya nggak kena tax tiap transaksi
