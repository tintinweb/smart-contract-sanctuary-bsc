...
contract RDNDistributor is AccessControlEnumerable {
    ...
    event Distributed(uint indexed userId, address indexed userAddress, address indexed initAddress, uint amount);
        ...
        while (user.parentId > 0 && count < 12) {
            ...
            if (factor > maxFactor) {
                ...
                if (user.activeUntill > block.timestamp) {
                    ...
                    emit Distributed(userId, user.userAddress, _initAddress, bonus);
                }
