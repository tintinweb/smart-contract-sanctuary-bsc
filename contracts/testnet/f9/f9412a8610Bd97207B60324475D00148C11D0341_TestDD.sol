...
contract TestDD is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 225 * 10**6 * 10**9;
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 225 * 10**6 * 10**9;

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'TestDD';
    string private _symbol = 'TestDD';
