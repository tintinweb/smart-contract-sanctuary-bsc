...
//    IBEP20 RWRD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);   //MAINNET BUSD 
    IBEP20 RWRD = IBEP20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);   //TESTNET  BUSD 
    
    //DOGECOIN 0xbA2aE424d960c26247Dd6c32edC70B295c744C43
    
//    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;  //MAINNET WBNB
    address WBNB =   0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;  //TESTNET WBNB
    ...
    uint256 public minPeriod = 720 * 60;                    //twice a day
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);       //TESTNET PancakeSwap router v2 kiemtien
//            : IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);       //TESTNET PancakeSwap router v2 ibhagwan
...
contract JuustKiem is IBEP20, Auth {
    using SafeMath for uint256;
...
//    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;      //MAINNET WBNB
    ...
    string constant _name = "Juust Economy";
    string constant _symbol = "JUUSTKIEM";
    ...
    uint256 public reflectionFee   = 2; //2% reflection in BUSD ~ 36% ROI at stable price level & 3% daytrade
    uint256 public marketingFee    = 2; //dev
    uint256 public ecosystemfee    = 6; //BUSD fund builder
    ...
    constructor () Auth(msg.sender) {
        //router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);    //MAINNET PancakeSwap V2
        //router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);    //TESTNET PancakeSwap V2 ibhagwan
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);      //TESTNET PancakeSwap V2 kiemtien
        ...
        marketingFeeReceiver = 0xeBA37C34C10A08cEBdB2DAA0b3622d18593915ea;
        ecosystemfeeReceiver = 0x953BE6Dc93B1934b1b5aeCC5e7Fe7dA3856CED38;
    ...
    function approveMax(address spender) external returns (bool) {
        ...
        return approve(spender, uint256(type(uint256).max));
    }
