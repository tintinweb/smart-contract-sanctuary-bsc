...
contract Municipality is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function _getPriceForSuperBundle(uint8 _bundleType, address _user) private view returns(uint256, uint256) {
        ...
        (_discountPrice(bundlePrice, _getNewDiscount(_bundleType)), bundlePrice) : (_discountPrice(bundlePrice, bundle.discountPct), bundlePrice);
    }
    ...
    function _updateAdditionLevel(address _user) private {
        ...
        // (uint256 sb13,) = _getPriceForSuperBundle(13, _user);
        // (uint256 sb14,) = _getPriceForSuperBundle(14, _user);
        // (uint256 sb15,) = _getPriceForSuperBundle(15, _user);
        // (uint256 sb16,) = _getPriceForSuperBundle(16, _user);
