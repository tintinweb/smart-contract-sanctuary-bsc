...
library Address{
 ...
 contract DOGI is Context, IERC20, Ownable { 
    ...
    address public devWallet = 0xE72C2024B39cb79D49669dBB1e684C32a46e9d0d;
    ...
    Taxes public buytaxes = Taxes(0, 3, 1, 1);
    Taxes public sellTaxes = Taxes(0, 3, 1, 5);
