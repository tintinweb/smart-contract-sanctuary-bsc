...
contract SoulmetaDividendPool is ERC721Holder, DivestorUpgradeable {
    ...
    function initialize(address usdt_, address soulFrogAddr_, address shareHolderAddr_) public initializer {
        __Divestor_init();
    ...
    function setMeta(address usdt_, address soulFrogAddr_, address shareHolderAddr_, bool isOpen_) public onlyOwner {
        cUsdt = IERC20MetadataUpgradeable(usdt_);
        soulFrogAddr = ISoul721(soulFrogAddr_);
        shareHolderAddr = shareHolderAddr_;
