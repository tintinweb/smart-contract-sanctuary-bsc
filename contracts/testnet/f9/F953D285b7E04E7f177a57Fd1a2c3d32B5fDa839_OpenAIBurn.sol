...
Telegram: https://t.me/+xDSuJ2G6Z2k4ZDE0
...
contract OpenAIBurn is ERC20, Ownable {
    ...
    OpenAIBurnDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Open AI Burn", "OpenAIB") {
        ...
        dividendTracker = new OpenAIBurnDividendTracker(
            payable(this),
            router,
...
contract OpenAIBurnDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    OpenAIBurn public OpenAIBurnContract;
    ...
    constructor(
        ...
        defaultToken = token;
        OpenAIBurnContract = OpenAIBurn(mainContract);
    ...
    function _transfer(
        ...
        require(false, "OpenAIBurn_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "OpenAIBurn_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main OpenAIBurn contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(OpenAIBurnContract);

            uint256 prevBalance = OpenAIBurnContract.balanceOf(address(this));
            ...
            {
                uint256 received = OpenAIBurnContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    OpenAIBurnContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
