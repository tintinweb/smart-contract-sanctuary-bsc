...
contract Efatah33_Lock is IERC20 {
    ...
    constructor(address ownerWallet) {
        ...
        setAccountExempt(pair, true);        
        setAccountExempt(pairBusd, true);
        
        //>>>>>>>>>>>>>>>>>>>>>
        _isAccountExempt[address(router)] = true; 
...
/*
    ...
    //function shouldSwapBack() internal view returns (bool) {        
        emit eventShouldSwapBack(_isLiquidityEnabled, automatedMarketMakerPairs[msg.sender], inSwap,
                                 swapEnabled, _balances[address(this)], _swapThresholdAmt);
