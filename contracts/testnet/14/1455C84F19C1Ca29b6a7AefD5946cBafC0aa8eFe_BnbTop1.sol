...
contract BnbTop1 {
    ...
    constructor(){
        ...
        // admins[0] = AdminStruct("ZM","bnb17a92slnvhg0ga2ttkacy3f48zpqjusrldw0g0j",8);
        // admins[1] = AdminStruct("HM","bnb1d72zl4mpsxgmx9d8wlnmn587vrwh0mrrafq9v5",8);
        // admins[2] = AdminStruct("KL","bnb1s6mhekwj9hy2xfftpzzwf4feyea2aus3zulxpa",4);
        //-Testnet Admin
        admins[0] = AdminStruct("ZM",0x4B0897b0513fdC7C541B6d9D7E929C4e5364D2dB,8);
        admins[1] = AdminStruct("HM",0x583031D1113aD414F02576BD6afaBfb302140225,8);
        admins[2] = AdminStruct("KL",0xdD870fA1b7C4700F2BD7f44238821C26f7392148,4);
