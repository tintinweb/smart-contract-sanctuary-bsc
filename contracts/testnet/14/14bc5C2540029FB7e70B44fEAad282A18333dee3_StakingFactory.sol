...
contract StakingFactory is Context, Ownable {
    ...
    mapping(uint256 => Staking) private stakingList;
    Counters.Counter private stakingIds;
    ...
    function createStaking() external {
        ...
        stakingIds.increment();
        uint256 newStakingId = stakingIds.current();
        stakingList[newStakingId] = _new;
    }
