...
contract IFOV2 is IIFOV2, ReentrancyGuard, Ownable {
    ...
    //profile
    bool public shouldProfileRequired = false;
    ...
    // Event for Profile required
    event ProfileRequiredChanged(bool shouldProfileRequired);
    ...
    function setShouldProfileRequired(bool _required) external onlyOwner {
        shouldProfileRequired = _required;
        ProfileRequiredChanged(shouldProfileRequired);
    }
    ...
    function depositPool(uint256 _amount, uint8 _pid) external override nonReentrant notContract {
        ...
        // Checks whether the block time is not too early
        require(block.timestamp > startTime, "Too early");

        // Checks whether the block time is not too late
    ...
    function updatePointParameters(
        ...
        require(block.timestamp < endTime, "IFO has ended");
