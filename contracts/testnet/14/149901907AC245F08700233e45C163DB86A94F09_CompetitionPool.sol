...
contract CompetitionPool is Ownable, ReentrancyGuard, Metadata {
    ...
    uint256 public gapValidatitionTime = 300; //only for testing, production must be > 6 hours
    ...
    function createNewRegularCompetition(
        ...
        require(
            sportManager.checkSupportedGame(_sportTypeAlias),
            "RCC: Game is not supported"
        );
        ...
        regularCompetitionContract.setGapvalidationTime(gapValidatitionTime);
    ...
    function createNewGuaranteedCompetition(
        ...
        creator[competitionContract] = msg.sender;
        IGuaranteedCompetitionContract guaranteedCompetitionContract = IGuaranteedCompetitionContract(
                competitionContract
            );
        guaranteedCompetitionContract.setBasic(
            _startTimestamp,
            _endTimestamp,
            _entryFee,
            _entrant.minEntrant,
        ...
        guaranteedCompetitionContract.setMaxEntrantAndGuaranteedFee(
            _guaranteedFee,
            _entrant.maxEntrant
        );

        guaranteedCompetitionContract.setCompetition(
            _competitionId,
            _team1,
            _team2,
            _sportTypeAlias,
        ...
        guaranteedCompetitionContract.setOracle(oracle);
        guaranteedCompetitionContract.setBetOptions(_betOptions);
        guaranteedCompetitionContract.setGapvalidationTime(gapValidatitionTime);
        ...
        guaranteedCompetitionContract.start();
    ...
    function Accepted(address _p2pCompetition) public onlyP2P(_p2pCompetition) {
