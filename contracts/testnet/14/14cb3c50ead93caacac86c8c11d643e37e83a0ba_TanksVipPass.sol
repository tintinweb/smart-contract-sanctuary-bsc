...
/**
 *    TANKS WAR ONLINE MINT PASS 
 *    https://tankswar.online
 */
...
contract TanksVipPass is ERC721A
{
    using Strings for uint256;
    ...
    constructor(string memory defaultBaseURI) ERC721A("TanksVipPass", "TVP", maxMintAmount) {
        owner = msg.sender;
