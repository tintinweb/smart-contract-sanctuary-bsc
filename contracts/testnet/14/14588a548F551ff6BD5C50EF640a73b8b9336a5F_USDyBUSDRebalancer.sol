...
*/
contract USDyBUSDRebalancer is Initializable, ReentrancyGuard, AccessControl {
    ...
    */
    ...
    function rebalance() public _isAdminOrOperator returns (bool) {
        ...
        console.log(msg.sender,"msg.sender in rebalancer");
        ...
        console.log(r1 < r2 , (mode == 2 || mode == 3));
        if (r1 < r2 && (mode == 2 || mode == 3)) {
            console.log(sqrt(r1),sqrt(r2));
            // price is > $1.00 i.e. above peg
            uint256 x = (sqrt(r1) * sqrt(r2 * 103 / 100)) - r1; // x is the amount of USDy purchased
            ...
            if(IERC20(Admin.USDy()).allowance(address(this),address(lProvider)) > 0){
                console.log("IERC20(Admin.USDy()).allowance(address(this),address(lProvider))",IERC20(Admin.USDy()).allowance(address(this),address(lProvider)));
            ...
            if(IERC20(Admin.BUSD()).allowance(address(this),address(lProvider)) > 0){
                console.log(IERC20(Admin.BUSD()).allowance(address(this),address(lProvider)),"IERC20(Admin.BUSD()).allowance(address(this),address(lProvider))");
            ...
            uint256 x = (sqrt(r2) * sqrt(r1 * 103 / 100)) - r2; // x is the amount of USDy purchased
            uint256 ratio = r1 / r2;
            x *= sqrt(ratio);
            ...
            if (checkLiquidityImpact(inputAmount, r1)) {
                ...
                console.log(IERC20(Admin.BUSD()).allowance(address(this),address(router)),"IERC20(Admin.BUSD()).allowance(address(this),address(router))");
    ...
    */
    ...
    @param to address of user who will receive lp tokens
    */
