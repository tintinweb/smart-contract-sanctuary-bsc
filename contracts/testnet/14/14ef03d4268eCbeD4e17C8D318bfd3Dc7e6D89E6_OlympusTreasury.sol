...
import "./types/EFINAccessControlled.sol";

import "hardhat/console.sol";

contract OlympusTreasury is EFINAccessControlled, ITreasury {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(
        ...
        uint256 _timelock,
        address _authority
    ) EFINAccessControlled(IEFINAuthority(_authority)) {
    ...
    function deposit(
        ...
        console.log("Treasury:Deposit token %s", _token);
        console.log("Treasury:Deposit sender %s", msg.sender);
        console.log("Treasury:Deposit amount %s", _amount);
        console.log("Treasury:Deposit profit %s", _profit);
...
console.log("Treasury:Deposit OHM.totalSupply() %s",OHM.totalSupply());
console.log("Treasury:Deposit totalReserves before %s",totalReserves);
console.log("Treasury:Deposit totalReserves add value %s", value);
        totalReserves = totalReserves.add(value);
console.log("Treasury:Deposit totalReserves after %s",totalReserves);
    ...
    function excessReserves() public view override returns (uint256) {
        ...
        console.log("OHM address %s", address(OHM));
        console.log("OHM.totalSupply() %s", OHM.totalSupply());
...
import "../interfaces/IEFINAuthority.sol";

abstract contract EFINAccessControlled {
    /* ========== EVENTS ========== */

    event AuthorityUpdated(IEFINAuthority indexed authority);

    string UNAUTHORIZED = "UNAUTHORIZED"; // save gas

    /* ========== STATE VARIABLES ========== */

    IEFINAuthority public authority;

    /* ========== Constructor ========== */

    constructor(IEFINAuthority _authority) {
    ...
    function setAuthority(IEFINAuthority _newAuthority) external onlyGovernor {
