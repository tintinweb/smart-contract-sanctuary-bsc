...
contract IgnoreGALA is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0xef75EFB31Ce52C8EB3CeF1D4d406Bb6f0d9e2A15);
    address payable public Wallet_Dev =
        payable(0x2BBE8A22b18255811d37536977056fC9310A3faD);
    ...
    string private constant _name = "Ignore GALA";
    string private constant _symbol = unicode"IGNOREGALA";
    ...
    constructor() {
        _owner = 0x5Bb6c2a37c36ba59D8472Eb8a4fF1A2EE2CCF405;
