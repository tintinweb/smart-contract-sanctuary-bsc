 ...
 */
 ...
 /**
 * Function modifier to require caller to be contract creator
 */
 modifier onlyCreator() {
 require(isCreator(msg.sender), "!CREATOR"); _;
 }
 /**
 ...
 */
 function authorize(address adr) public onlyCreator {
...
contract DividendDistributor is IDividendDistributor {
 ...
 IBEP20 REWARDS = 
IBEP20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); //the reward token you want distributed 
...
contract SomeBullShitInu is IBEP20, Auth {
 using SafeMath for uint256;
 address REWARDS = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
 address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; 
 address DEAD = 0x000000000000000000000000000000000000dEaD;
 address ZERO = 0x0000000000000000000000000000000000000000;
 address _marketingAdr = 0xDfE11Cf7C28947EB39e415eE90e3392D44192A00;
 address routerv2 = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
 string constant _name = "Some Bullshit Inu";
 string constant _symbol = "BSINU";
...
_marketingFeeReceiver) external authorized {
 ...
 function triggerSwapBack(uint256 amountSold) external authorized {
 swapBack(amountSold);
 }
