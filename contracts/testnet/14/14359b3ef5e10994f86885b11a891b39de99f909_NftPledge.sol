...
contract NftPledge is ERC1155Holder,Ownable {
    ...
    constructor() ERC1155Holder() Ownable(){
        ...
        interval = 90 * 3600;
        wallet = msg.sender;
        NFT = 0x6CFEee9Db6a3ec596C61d19b546fB927B74fA923;
        VLX = 0x68aE9bb43e64b48741B3B378E0dFbfC1907A5294;
        HydroDAO = 0xC86cd12D1E3E8a5D212cFb1398490BbdE59b1e60;
    ...
    function withdrawal(bytes32 _assetId)public{
        ...
        if (fit > 0){
            ...
            IERC20(HydroDAO).transfer(msg.sender, fit);
    ...
    function setTAndM(address _technologyAddress, address _marketAddress)public onlyOwner{
        technologyAddress = _technologyAddress;
        marketAddress = _marketAddress;
    }

    function transferRate(address _to, uint256 _amount)public onlyOwner{
        IERC20(HydroDAO).transfer(_to, _amount.mul(88).div(100));
        IERC20(HydroDAO).transfer(technologyAddress, _amount.mul(1).div(100));
        IERC20(HydroDAO).transfer(marketAddress, _amount.mul(1).div(100));
        IERC20(HydroDAO).burn(_amount.mul(10).div(100));
    }
