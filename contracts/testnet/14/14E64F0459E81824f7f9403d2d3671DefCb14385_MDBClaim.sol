...
contract MDBClaim {
    ...
    address private constant token = 0xBbeb904272FA9888C50DA37D16b9099FcaE78244;
    INFT private constant NFT = INFT(0xe2785698B7A61Aa8b3503899ff153D745a51936d);
    address[] path;
    ...
    function estimate_gas() external {
        ...
        revert(uint2str(gasSpent));
    }

    function run() public {
        NFT.claimRewards();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            IERC20(token).balanceOf(address(this)), 0, path, recipient, block.timestamp + 30
        );
    }
