...
contract NFT is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    address public m_admcAddress = address(0x16227D60f7a0e586C66B005219dfc887D13C9531);
    ...
    function setListPrice(uint256 _price) external onlyByOwner {
        m_nListPrice = _price;
    ...
    function setBuyingFee(uint256 _fee) external onlyByOwner {
        m_nBuyingFee = _fee;
    ...
    function giftNFT(address _to, uint256 _tokenId, uint256 _collectionId) external {
        ...
        _beforeNFTTransfer(msg.sender, _to, _tokenId);
