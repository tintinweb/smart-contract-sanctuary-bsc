...
contract BANK is IERC20, Ownable {
    ...
    string constant _name = "Bankero Finance";
    ...
    uint256 public bankDividendFee = 70;
    uint256 public sellFee = 20;
    uint256 public autofirePitFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(bankDividendFee).add(autofirePitFee);
    ...
    address public bankDividendReceiver;
    ...
    uint256 private constant MAX_SUPPLY = 512 * 10**7 * 10**DECIMALS;
    ...
    constructor() {
        ...
        bankDividendReceiver = address(dividendDistributor);
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(bankDividendFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(bankDividendFee)
            ),
            gas: 30000
        }("");
        (bool sendDividendBnb, ) = payable(address(dividendDistributor)).call{
            value: amountETHToTreasuryAndSIF.mul(bankDividendFee).div(
                treasuryFee.add(bankDividendFee)
            ),
            gas: 30000
        }("");
        ...
        try
            dividendDistributor.deposit(
                amountETHToTreasuryAndSIF.mul(bankDividendFee).div(
                    treasuryFee.add(bankDividendFee)
                )
            )
        {} catch {}
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        require(
            amountToSwap > 0,
            "There is no Everbank token deposited in token contract"
        );
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
