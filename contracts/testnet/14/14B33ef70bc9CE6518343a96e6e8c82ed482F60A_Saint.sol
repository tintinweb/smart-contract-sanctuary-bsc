 ...
 * 
 * 
   A charity-oriented token that is committed to helping children-based organizations. 

  Saint features:
   4% fee auto added to the liquidity pool and locked
   4% fee auto distributed to all hodlers
   2% fee added to dev wallet for charitable giving and future development
   
  visit Saint.finance for more information!
                            ...
                            `s`       -+smmNNNNNNNmdy/   -+-       /:     
                            s`       +: /-omNNNNNNNNNNy    :+       +-    
                           :s:`     o. ./mNNNNNNNNNNNNNmy+. .o     ./y    
                           s `:///-+-.hNNNNNNNNNNNNNNNNNNNNd::/-///- /:   
                          `s      `y:yNNNNNNNNNNNNNNNNNNNNNNNoy`     `o   
                          `o     /hNNNNNNNNNNNNNNNNNNNNNNNNNNmy       s   
                          `s    `oNNNNNNNNNNNNNNNNNNNNNNNNNNNNh:.    .o   
                           s`://-.hNNNNNNNNNNNNNNNNNNNNNNNNNNm.`-///./-   
                           :y`  `/hNNNNNNNNNNNNNNNNNNNNNNNNNm:      :y    
                            o. +yNNNNNNNNNNNNNNNNNNNNNNNNNNd-       o.    
                            `dmNNNNNNNNNNNNNNNNNNNNNNNNNNNs        +-     
                         -symNNNNNNNNNNNNNNNNNNNNNNNNNNNNN-      `o.      
                          :hdmNmdddNNNNNNNNNNNNNNNNNNdNNNo      /+`       
                                 /yNNNNNNNNNNNNNNNNNNo:y/    `/+.         
                                 sNNNNNNNNNNNNNNNNNNNNs.  `://`           
                               `sNNNNNNNNNNNNNNNNNNNNNNNs/:`              
                               /NNNNNNNNNNNdys++omNNNNNNNy.               
                              `NNNNNNNmy+-`     /NNNNNho:`                
                               dNNNdo:          oyo/-`                    
                               /do-                                      
 ...
 were made to make this project inline with the mission of Saint Token -- helping children-based organizations through
 charitable giving.
*/
...
contract Saint is Context, IERC20, Ownable {
    ...
    mapping(address => uint256) private _todayFixedBalance;

    mapping(address => uint256) private _lastTransferTime;

    mapping(address => uint256) private _totalSoldInDay;

    address[] private _excluded;

    address payable charityWallet = 0x47DDeDcad24FC3706D18E275D1fCBd59dBcb003b;
  ...
  */
    ...
    uint256 public _dailyTransferLimit = 10;
    ...
    event AddLiquidityETH(uint256 amountA, uint256 amountB, uint256 liquidity);
    ...
    constructor() public {
        ...
        // v2 bsc testnet 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    ...
    //Struct to hold the values of the fees not percentages but actual calculated amount on transfer amount
    ...
    function getLastTransferTime(address account)
        public
        view
        returns (uint256)
    {
        return _lastTransferTime[account];
    }

    function getTotalSoldInDay(address account) public view returns (uint256) {
        return _totalSoldInDay[account];
    }
  ...
  */
    ...
    function getRemainingLimit(address account) public view returns (uint256) {
        uint256 userBalance = _todayFixedBalance[account];

        // Calculate amount which caller can send daily
        uint256 amountCanTransferDaily = userBalance
            .mul(_dailyTransferLimit)
            .div(100);

        uint256 amountTransferedToday = _totalSoldInDay[account];

        return amountCanTransferDaily.sub(amountTransferedToday);
    }
    ...
    function setDailyLimitPercent(uint256 dailyTransferLimit)
        external
        onlyOwner
    {
    ...
    function _getTValues(uint256 tAmount)
        private
        view
        returns (uint256, TFees memory)
    {
        TFees memory tFees = TFees({
    ...
    function _transfer(
        ...
        //If account is not excluded from fee or not owner, apply sending limits
        if (
            !_isExcludedFromFee[from] &&
            !_isExcludedFromFee[to] &&
            from != owner()
        ) {
            uint256 lastSellTime = _lastTransferTime[from];

            // If he last transfered more than 1 day ago, reset the amount sold today and set last sell time to now
            if (lastSellTime + 1 days < block.timestamp) {
                _totalSoldInDay[from] = 0;
                _lastTransferTime[from] = block.timestamp;
                _todayFixedBalance[from] = balanceOf(from);
            }

            uint256 userBalance = _todayFixedBalance[from];
