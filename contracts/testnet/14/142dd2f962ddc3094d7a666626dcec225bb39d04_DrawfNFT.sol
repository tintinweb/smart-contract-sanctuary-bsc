...
contract DrawfNFT is ERC721Enumerable, Ownable {
    ...
    uint256 public maxSupply = 125000;
    ...
    constructor(string memory baseURI) ERC721("The Giant Drwaf NFT", "TGD") {
        setBaseURI(baseURI);
    }
    ...
    function reserveNFTs() public onlyOwner {
        ...
        require(totalMinted.add(10) < maxSupply, "Not enough NFTs left to reserve");
