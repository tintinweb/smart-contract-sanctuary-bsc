...
contract FileAccessCollectionFactoryUpgradeable is OwnableUpgradeable, SignatureAuth, SignedActions  {
    ...
    function newFileAccessContract(
        ...
        bytes32 message = keccak256(abi.encodePacked(interactionId, CREATE_COLLECTION, workspaceId, _msgSender()));
