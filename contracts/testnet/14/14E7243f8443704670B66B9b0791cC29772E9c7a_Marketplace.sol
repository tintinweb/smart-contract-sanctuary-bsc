...
contract Marketplace is Ownable, Pausable, ReentrancyGuard {
    ...
    function createOrder(
        ...
        require(nftAddresses[_nftAddress], "Marketplace: NFT is not listed");
        require(
            currencyAddresses[_currencyAddress],
            "Marketplace: Currency is not listed"
        );
        ...
        if (publicationFee > 0) {
            ...
            if(_currencyAddress == address(0)) {
                ...
                require(
                    ...
                    "Marketplace: transfering the publication fee to the Marketplace's owner failed"
                );
            }
        }
    ...
    function executeOrder(
        ...
        require(
            ...
            "Marketplace: the price is not correct"
        );
        require(
            seller == nft.ownerOf(_assetId),
            "Marketplace: the seller is no longer the owner"
        );
        ...
        nft.safeTransferFrom(seller, msg.sender, _assetId);
