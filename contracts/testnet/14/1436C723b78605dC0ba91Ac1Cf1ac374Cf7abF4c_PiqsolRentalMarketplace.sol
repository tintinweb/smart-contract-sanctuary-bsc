      ...
      HasTransferApproval(LentNFT_CollateralFeeForSale[id].nftContract, LentNFT_CollateralFeeForSale[id].tokenId)
       IsItemExists(id) {
        ...
        require(
           ...
           uint256 min = (block.timestamp - LentNFT_CollateralFeeForSale[id].expires)/60;
       uint256 fine = LentNFT_CollateralFeeForSale[id].pricePerDay * min;
        require(msg.value >= fine, "Piqsol:Not enough ether to cover fine");
