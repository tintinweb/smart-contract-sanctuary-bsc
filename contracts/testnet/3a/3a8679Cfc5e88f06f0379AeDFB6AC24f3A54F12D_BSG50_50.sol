...
contract  BSG50_50 is Ownable{
    ...
    uint256 private constant dayReward2Percents = 1000000000000000000000;
    uint256 private constant dayRewardPercents = 833333333333333333334;
    ...
    constructor(address _BUSDAddr, address _defaultRefer, address[2] memory _feeReceivers, 
        IPancakeRouter01 _Router,IPancakePair _BNB_BUSD_LP, IPancakePair _ULE_BNB_LP) public {
    ...
    function deposit(uint256 _amount,uint256 _pkgNo) external payable{
    ...
    function getRewards(address _user) public view returns(uint256 , uint256 uleAmt, uint256 FTMamt, uint256){
        ...
        FTMamt = withdrawAmt.mul(BNBperBUSD());
