    ...
    UUPSUpgradeable
{
    ...
    Counters.Counter private _vestingIds; // vesting id's
    mapping(uint256 => address) private vestingIdToAddress;
    ...
    function createVesting(
        ...
        uint256 newVestingId = _vestingIds.current();
        vestingIdToAddress[newVestingId] = address(vesting);
