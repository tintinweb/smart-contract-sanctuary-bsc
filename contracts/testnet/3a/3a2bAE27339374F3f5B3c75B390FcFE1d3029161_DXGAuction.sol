...
contract DXGAuction is Ownable {
     ...
     */
    function bulkSell(uint256[] memory tokenIds, uint256 price, uint256 royalty, SELLING_CURRENCY currecny) external {
        for(uint i = 0; i < tokenIds.length; i++) {
            sell(tokenIds[i], price, royalty, currecny);
        }
    }
     ...
     */
    function sell(uint256 tokenId, uint256 price, uint256 royalty, SELLING_CURRENCY currecny) public {
