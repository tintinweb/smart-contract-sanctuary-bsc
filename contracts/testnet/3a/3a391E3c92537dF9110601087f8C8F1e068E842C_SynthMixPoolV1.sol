...
contract SynthMixPoolV1 is Admin {
    ...
    {
        /*uint256[] memory rewardsProfit = new uint256[](2);*/

        uint256[] memory rewardsToken = new uint256[](5);
        uint256[] memory rewardsReferrer = new uint256[](5);

        /*uint256 rewardsToken = 0;
        uint256 rewardsReferrer = 0;*/
        ...
        /*rewardsToken = rewardsProfit[0];
        rewardsReferrer = rewardsProfit[1];*/
    ...
    function _UserRewardCalculation(
        ...
        uint256 tokensActive = viewTokensCount();

        uint256 StakingDataZero = stakingData[0];
        uint256 StakingDataOne = stakingData[1];

        uint256[] memory tokensEarned = new uint256[](tokensActive);
        uint256[] memory tokensRefEarned = new uint256[](tokensActive);
            ...
            if (noOfDays[0] >= intervalDays[i]) {
                ...
                if (
                    ...
                    if (referrerMain != address(0)) {
                        ...
                        refEarned = (rewarsOnTime.mul(refPercentage)).div(100 ether);
        ...
        /*rewardsProfit[0] = rewardsEarned;
        rewardsProfit[1] = refEarned;*/
