...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x18f6C39758c6e4F1a9b036386a221D8e9024d1E9; // owner address
...
contract TestTokenBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TestTokenBSC";
    string private _symbol = "TeToBSC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xAa76AD4a5A9f898f81dE1998e56842284725cfF9); // 
    address payable public teamWalletAddress = payable(0x18f6C39758c6e4F1a9b036386a221D8e9024d1E9); // 
