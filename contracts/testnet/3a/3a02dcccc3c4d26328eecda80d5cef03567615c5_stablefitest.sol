...
contract stablefitest {
    using SafeMath for uint256;
    uint256 constant launch = 1661965001;
    ...
    constructor() {
            ...
            PercsKey[50] = DivPercs(4320000, 30);
            
            FeesKey[10] = FeesPercs(864000, 50);
            FeesKey[20] = FeesPercs(1728000, 100);
            FeesKey[30] = FeesPercs(2592000, 150);
            FeesKey[40] = FeesPercs(3456000, 200);
            FeesKey[50] = FeesPercs(4320000, 250);
    ...
    function withdrawInitial(uint256 keyy) public {
        ...
        if (currDays < FeesKey[10].daysInSeconds){ // LESS THAN 10 DAYS STAKED
            ...
            uint256 minusAmt = initialAmt.mul(FeesKey[50].feePercentage).div(percentdiv); //25% fee
