...
contract Z001 is ERC20, Ownable {
    ...
    constructor() ERC20("Z will come", "Z001") {
        ...
        marketingWallet = address(0xCdD0E803316f966c66d8621D4FE3eAd7010a27Dd); // set as marketing wallet
        devWallet = address(0x2e3D75Ae22D9dfAd5C2161CF97f07DcCBB202bac); // set as dev wallet
