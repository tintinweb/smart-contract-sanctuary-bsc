...
contract RUGG is IBEP20, Auth {
    ...
    function AutoBuyback(address holder) external onlyOwner{
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _teamFee, uint256 _feeDenominator) external onlyOwner {
    ...
    function setDividen(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver) external onlyOwner {
