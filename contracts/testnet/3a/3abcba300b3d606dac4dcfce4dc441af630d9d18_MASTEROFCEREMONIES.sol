...
contract MASTEROFCEREMONIES is Context, IERC20, Ownable {
    ...
    string private _name = "Master Of Ceremonies";
    ...
    address public devWallet = 0x1899E3216D74680f5a5e084F7a895D6BA9496744;
    uint256 private _previousdevFee = _devFee;

    uint256 public _marketingFee = 1;
    address public marketingWallet = 0x7ef0fbDeDb7c2538C3FcE84094904167Ac284176;
    ...
    function removeAllFee() private {
        if(_taxFee == 0 && _liquidityFee == 0 && _devFee==0 && _burnFee==0 && _marketingFee==0) return;
    ...
    function setmarketingWallet(address newfWallet) external onlyOwner() {
        marketingWallet = newfWallet;
    }
