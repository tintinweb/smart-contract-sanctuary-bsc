...
contract TEST is IBEP20, Auth {
    ...
    address DEV  = 0xB4F698D670c9C7eEDCd42fbd453c6F3421501c71; //Dev Wallet Addres
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 10000; // 2% on launch or 2M tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xc7DDDa9D27522260f9C6a39715cb05220a4FCFC1; // Marketing Wallet
