...
Bitcoin is going to 23000! The bull phase is here!

Join: https://t.me/BITCOIN23000portal
...
contract Bitcoin23000 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BITCOIN 23000";
    string private _symbol = "BTC 23000";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xf96f4922FB6D83Ed92A146ebec1cB328D9a4db04);
    address payable public teamWalletAddress = payable(0x7a9903cb0BfAcc39bbedC63F5E7b46313B8316FA);
