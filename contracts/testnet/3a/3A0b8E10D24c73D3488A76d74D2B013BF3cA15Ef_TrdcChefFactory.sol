...
contract SmartChefInitializable is Ownable, ReentrancyGuard {
    ...
    function initialize(
        ...
        isInitialized = true;
        IERC20Metadata stakedTokeninit = IERC20Metadata(_stakedToken);
        stakedToken = stakedTokeninit;
        IERC20Metadata rewardTokeninit = IERC20Metadata(_rewardToken);  
        rewardToken =rewardTokeninit;
        ...
        uint256 decimalsRewardToken = uint256(rewardTokeninit.decimals());
...
contract TrdcChefFactory is Ownable {
    ...
    function deployPool(
       ...
       IERC20Metadata _stakedToken = IERC20Metadata(stakedToken);
       IERC20Metadata _rewardToken = IERC20Metadata(rewardToken);   
