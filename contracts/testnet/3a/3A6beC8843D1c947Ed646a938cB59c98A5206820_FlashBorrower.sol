...
contract FlashBorrower is IERC3156FlashBorrower {
  ...
  function onFlashLoan(
    ...
    (
      address arbitrageMediatorAddress,
      uint256 minAmountOut,
      address[] memory buyPath,
      address[] memory sellPath,
      uint256 deadline,
      address[2] memory routers
    ) = abi.decode(data, (address, uint256, address[], address[], uint256, address[2]));

    IArbitrageMediator(arbitrageMediatorAddress).executeArbitrage(amount, minAmountOut, buyPath, sellPath, deadline, routers);
