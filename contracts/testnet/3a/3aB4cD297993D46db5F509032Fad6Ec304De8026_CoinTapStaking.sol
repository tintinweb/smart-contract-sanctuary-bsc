...
contract CoinTapStaking is OwnableUpgradeable, StakingModel {
    ...
    StakingPackage[] public _stakingPackages;
    Level[] public levels;
    ...
    function initialize(ERC20 _cointap, ICoinTapTier _tier) public initializer {
        ...
        _stakingPackages.push(StakingPackage("Testing", 300, 500));
        _stakingPackages.push(StakingPackage("7 Days", 604800, 0));
        _stakingPackages.push(StakingPackage("30 Days", 2592000, 500));
        _stakingPackages.push(StakingPackage("60 Days", 604800, 700));
        _stakingPackages.push(StakingPackage("90 Days", 7776000, 1000));
        _stakingPackages.push(StakingPackage("180 Days", 15552000, 2000));
    ...
    {
        require(_pid < _stakingPackages.length, "Package invalid");
        require(_pid >= 0, "Package invalid (0)");
        require(_amount > 0, "Amount must be greater than 0");

        StakingPackage memory package = _stakingPackages[_pid];
