...
contract WayspadStaking is ReentrancyGuard {
    ...
    constructor(address payable _owner, address token1, address token2, uint256 _Bonus) {
        ...
        Bonus = _Bonus;
        totalFee = 0;
        maxStakeableToken = 250000000000000000000000;
        percentDivider = 1000;
        minimumStakeToken = 100000000000000000000;
        maxpoolbalance = 25000000000000000000000000;
        maxaccountbalance = 250000000000000000000000;
    }
