...
contract HST is IERC20, Ownable{
    string  private  name_; // name != name_ != _name
    ...
    constructor(){
        ...
        symbol_            = "HST";
        decimals_          = 18;
        TOTAL_SUPPLY       = 1000000 * 10 ** decimals_;
    ...
    function transfer(address _recipient, uint256 _amount) public virtual override returns (bool) {
        require (_msgSender() != address(0),"transfer from zero address");
        require (_recipient != address(0),"transfer from zero address");
        require (balances[_msgSender()] >= _amount,"Your balance is too low");
    ...
    function approve(address _spender, uint256 _amount) public virtual override returns (bool) {
        require (_msgSender() != address(0), "approve from zero address");
        require (_spender != address(0), "approve from zero address");

        allowances[_msgSender()][_spender] = _amount;
    ...
    function transferFrom(address _tokenOwner,address _recipient,uint256 _amount) public virtual override returns (bool) {
        require(allowances[_tokenOwner][_msgSender()] >= _amount, "transfer amount exceeds allowance");

        allowances[_tokenOwner][_msgSender()] -= _amount;
