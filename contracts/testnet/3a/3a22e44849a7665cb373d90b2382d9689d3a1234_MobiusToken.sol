...
abstract contract MobiusSlippage {
    function tradeSlippage(address _address, uint256 amountToWei) external virtual view returns (address [] memory slippageAddress, uint256 [] memory slippageAmount);
...
contract MobiusToken is IERC20, Ownable, Util {
    ...
    function swapThisToUsdt() private {
        ...
        if(_balances[address(this)] >= toWei(100, 18)) {
