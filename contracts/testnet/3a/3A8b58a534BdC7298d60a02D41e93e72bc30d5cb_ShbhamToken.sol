...
contract ShbhamToken is ERC20, Ownable {
    ...
    constructor() ERC20("shbham Token", "ST1") {
        isSaleable = true;
        _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // BSC Testnet
    ...
    function iswhitelisted(address user) public view onlyOwner returns(bool){
