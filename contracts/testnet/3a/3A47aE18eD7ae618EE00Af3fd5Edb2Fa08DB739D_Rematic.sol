...
contract Rematic is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function __Rematic_init_unchained() internal onlyInitializing {
    	...
    	token1DividendTracker = Token1DividendTracker(payable(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7));
    	token2DividendTracker = Token2DividendTracker(payable(0x8BaBbB98678facC7342735486C851ABD7A0d17Ca));
