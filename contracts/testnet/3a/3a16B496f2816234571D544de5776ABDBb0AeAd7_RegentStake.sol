...
abstract contract IERC20Staking is ReentrancyGuard, Ownable {
    ...
    function stake(uint256 _stakingId, uint256 _amount,address _address,uint256 key) public payable virtual;
...
contract RegentStake is IERC20Staking {
    ...
    function stake(uint256 _stakingId, uint256 _amount, address _address,uint256 _key) public payable override {
