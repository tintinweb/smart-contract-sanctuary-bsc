...
contract RaddixHodlToken is ERC20, ERC20Burnable, Ownable {
    ...
    function buyRHT(uint BUSDamount) external {
        ...
        balanceContract = BUSD.totalSupply();
        _BurnTokenTrigger();
    }
    ...
    function setRegulator() private {
        ...
        else if(totalSupply() < 1000000*multiplikator) regulator = 10;
        else if(totalSupply() < 5000000*multiplikator) regulator = 50;
        else if(totalSupply() < 10000000*multiplikator) regulator = 100;
        else regulator = 1000;
    }
    ...
    function _cashOut(address to, uint amount) private {
        _safeTransferFrom(BUSD, owner1, to, amount);
    }
