...
/**
 * Gallant + Safuu Protocol = SAFUGAL Dual Reward with GAL Dividend
 * SAFUGAL Token
 * First Dual Reward with Auto-Staking, Auto-Compounding & GAL Reflection
 *
 * Website : S
 * Whitepaper : 
 * Twitter : twitter.com/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 GAL = IERC20(0x4832428cA02f1c589f2a0f55e4afa2794564593b);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = GAL.balanceOf(address(this));
        ...
        uint256 amount = GAL.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            GAL.transfer(shareholder, amount);
...
contract SAFUGAL is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("EverGAL", "EverGAL", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xCDb3818557465748767BC5216F489BE81973f8C2;
        treasuryReceiver = 0xCDb3818557465748767BC5216F489BE81973f8C2;   
        autofirePit = 0x000000000000000000000000000000000000dEaD;

        _allowedFragments[address(this)][address(router)] = uint256(-1);
        pairContract = IPancakeSwapPair(pair);

        distributor = new DividendDistributor(0xCDb3818557465748767BC5216F489BE81973f8C2);
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no EverGAL token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
