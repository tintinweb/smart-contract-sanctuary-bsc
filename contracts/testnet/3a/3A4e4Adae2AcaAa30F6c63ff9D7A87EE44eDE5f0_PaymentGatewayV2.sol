...
contract PaymentGatewayV2 is Owner {
  ...
  event PayEvent(string sessionId);
  event SendEvent(string sessionId);
  event BatchSendEvent(string sessionId);
  ...
  function payWithPermit(
    ...
    // Process pay
    return this.pay(amount, merchantAddress, sessionId);
  }
  ...
  function sendWithPermit(
    ...
    // Process send
    return this.send(amount, recipient, sessionId);
  }
