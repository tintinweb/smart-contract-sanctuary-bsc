...
/**                                                                                                                                                                                                              
                ...
                \____\/ \_\/      )_____(   \_\/ \_\/  /_/_/      \/_/    
                            ...
                            Sporty.game - BET - EARN - NFT STAKE - FAN 
                                        Website:  Sporty.game
...
contract SPORTY is IBEP20, Auth {
    ...
    string constant _symbol = "SPORTY";
    ...
    uint256 AZRewardPool = 2;

    uint256 totalBuyFee = liquidityFee + StakingFee + marketingFee + AZRewardPool;
    uint256 totalSellFee = 6;
    uint256 feeDenominator = 100;

    address public autoLiquidityReceiver;
    address public marketingFeeReceiver;
    address public AZRewardPoolFeeReceiver;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x5C7dAbBa4798D19fD4e26a6Aaa427C849D16D883;
        marketingFeeReceiver = 0x6828cB692e930fcE71a9297Fd1C85c7EBcb3a1b6;
        AZRewardPoolFeeReceiver = 0xb3C1BE0D600845e7A857754f2CA76723b37bDE27;
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            uint256 amountAZRewardPool = amountBNB.mul(AZRewardPool).div(totalBNBFee);

            (bool success, /* bytes memory data */) = payable(marketingFeeReceiver).call{value: amountBNBMarketing, gas: 30000}("");
            ( success, /* bytes memory data */) = payable(AZRewardPoolFeeReceiver).call{value: amountAZRewardPool, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _StakingFee, uint256 _marketingFee, uint256 _AZRewardPool, uint256 _feeDenominator, uint256 _totalSellFee) external onlyOwner() {
        liquidityFee = _liquidityFee;
        StakingFee = _StakingFee;
        marketingFee = _marketingFee;
        AZRewardPool = _AZRewardPool;
        totalBuyFee = _liquidityFee + _StakingFee + _marketingFee +_AZRewardPool ;
        feeDenominator = _feeDenominator;
        totalSellFee = _totalSellFee;
        require(totalBuyFee <= feeDenominator / 10, "Buy fee too high");//can't set buy tax more than 10%
        require(totalSellFee <= feeDenominator / 5, "Sell fee too high");//can't set sell tax more than 20%
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _AZRewardPoolFeeReceiver) external onlyOwner(){
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        AZRewardPoolFeeReceiver = _AZRewardPoolFeeReceiver;
    }
