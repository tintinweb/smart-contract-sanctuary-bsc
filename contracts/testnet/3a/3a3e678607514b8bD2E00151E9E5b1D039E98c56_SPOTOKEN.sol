...
// Dependency file: contracts/spo/IterableMapping.sol
...
// Dependency file: contracts/spo/SpoTokenDividendTracker.sol
...
// import "contracts/spo/IterableMapping.sol";
...
contract SpoTokenDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SPOTOKEN contract."
        );
    }
...
// Root file: contracts/spo/SpoToken.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/spo/SpoTokenDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract SPOTOKEN is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    SpoTokenDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        rewardToken = address(0xd2a5bC10698FD955D1Fe6cb468a17809A08fd005);
        _marketingWalletAddress = address(0xd2a5bC10698FD955D1Fe6cb468a17809A08fd005);
        require(
        ...
        dividendTracker = SpoTokenDividendTracker(
            payable(Clones.clone(address(0xd2a5bC10698FD955D1Fe6cb468a17809A08fd005)))
        );
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(address(0xB6BA90af76D139AB3170c7df0139636dB6120F7e));
        ...
        */
        ...
        emit TokenCreated(owner(), address(this), TokenType.spo, VERSION);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "SPOTOKEN: The dividend tracker already has that address"
        );

        SpoTokenDividendTracker newDividendTracker = SpoTokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "SPOTOKEN: The new dividend tracker must be owned by the SPOTOKEN token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "SPOTOKEN: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "SPOTOKEN: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "SPOTOKEN: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "SPOTOKEN: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "SPOTOKEN: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "SPOTOKEN: Cannot update gasForProcessing to same value"
        );
    ...
    function _transfer(
        ...
        try
            dividendTracker.setBalance(payable(from), IERC20(uniswapV2Pair).balanceOf(from))
        {} catch {}
