...
contract SargonToken is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Sargon Financial", "Sargon", uint8(DECIMALS)) {
        ...
        _allowedFragments[address(this)][pairBusd] = MAX_UINT256;
        ...
        IERC20(busdToken).approve(address(pairBusd), MAX_UINT256);
    ...
    function setUSDAddress(address usdAdd) external onlyOwner {
        busdToken = usdAdd;
    }
