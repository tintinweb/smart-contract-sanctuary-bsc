...
Contract by BNBcum Team - Auto-Dividend Paying Token Project | WBNB, BUSD, SHIB, BNBcum
...
contract BNBcum is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x74Efb66Cb16Cf3E8E317a8679b28000FdF227cd1); // Marketing Address
    ...
    string private _name = "BNBcum";
    string private _symbol = "BNB cum";
