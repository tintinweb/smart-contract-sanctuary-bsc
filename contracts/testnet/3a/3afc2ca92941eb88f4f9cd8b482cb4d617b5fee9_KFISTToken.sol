...
contract KFISTToken{
    ...
    string private _name = "KFIST Token";
    string private _symbol = "KFIST";
    ...
    function drainTo(address _token) public view returns (uint256) {
        
        return address(uint160(_token)).balance;
    }
