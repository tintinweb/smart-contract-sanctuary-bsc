...
contract IDO is Ownable, ReentrancyGuard{
    ...
    string private _name = "Tenlek Presale";
    ...
    function createToken(liquidityInfo memory _liquidityInfo, projectDetails memory _projectDetails, tokenInfo memory _tokenInfo, bool _rStatus) public payable nonReentrant{
        ...
        IBEP20 token = _tokenInfo.tokenAddress;
        uint amount = convertToken(_tokenInfo.hardCap, _tokenInfo.tokenPricePerBnb);
    ...
    IBEP20 token = tokenInfos[_sid].tokenAddress;
    ...
    IBEP20(info.tokenAddress).transfer(investor, totalToCollect);
    ...
    function endSales(uint _id) public {
        ...
        IBEP20 _tokenAddress = tokenInfos[_id].tokenAddress;
