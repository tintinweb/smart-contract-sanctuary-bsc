...
contract B8DEXMintFactory is IB8DEXMintFactory, Ownable {
    ...
    function mintNFT(uint8 _nftId) external {
        ...
        uint256 tokenId = b8dMainCollection.mint(address(_msgSender()), tokenURI, _nftId);
    ...
    function setNFTNames(
        string calldata _nftId5,
        string calldata _nftId6,
        string calldata _nftId7,
        string calldata _nftId8,
        string calldata _nftId9
    ) external onlyOwner {
        b8dMainCollection.setNFTName(5, _nftId5);
        b8dMainCollection.setNFTName(6, _nftId6);
        b8dMainCollection.setNFTName(7, _nftId7);
        b8dMainCollection.setNFTName(8, _nftId8);
        b8dMainCollection.setNFTName(9, _nftId9);
    }
