...
contract FGSExchangeV3 is OwnableUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;

    IERC20Upgradeable public constant token = IERC20Upgradeable(0x75F58dcEc150532773642dda53a75205869C31bf);
    AggregatorV3Interface public constant priceFeed = AggregatorV3Interface(0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526);
    ...
    function initialize(uint _tokenprice) public initializer {
        __Ownable_init(); 
    ...
    function BuyAndStake(uint256 _lockingTimeinMonths) external payable {
        ...
        uint256 aprAmount = (userAllocation *
            stakingPeriodsAPY[_lockingTimeinMonths]) / 10000;
...
// [["0x5fFbd9F46aA291B25A313dd05AC8bFC620EA3DA0",100,100,1648796743,0,25,1656686743,1,25,false]]
    ...
    function claimVesting(uint256 _id) internal {
        ...
        uint256 currentTime = (block.timestamp - pd.purchasingTime);

        if (currentTime > 7890000 && currentTime <= 15780000) {
            require(
        ...
        } else if (currentTime > 15780000 && currentTime <= 23670000) {
            require(
                pd.releasedpercentage <= 50,
