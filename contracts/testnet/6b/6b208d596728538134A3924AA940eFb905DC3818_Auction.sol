...
contract Auction is Ownable{
    ...
    event Bid(address indexed _bidder, uint indexed _auctionId, uint _bidTime, uint256 _auctionEndTime, address _lastBidder, uint _remainingBid, uint _totalBidCount);
    ...
    function bid(uint _auctionID) payable public {
        ...
        if(msg.sender == auctionInfo[_auctionID].lastBidder) {
        ...
        emit Bid(msg.sender, _auctionID, block.timestamp, auctionInfo[_auctionID].endTime , auctionInfo[_auctionID].lastBidder, auctionInfo[_auctionID].remainingBid, auctionInfo[_auctionID].bidCount);
    } 
