...
contract FLOKICLONE2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x892dF22F0a9e7e636dCbb16199bd9C21B194b26A); // Marketing Address
    ...
    string private _name = "FLOKICLONE2";
    string private _symbol = "FLOKICLONE2";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x892dF22F0a9e7e636dCbb16199bd9C21B194b26A);
    }
    ...
    function _removeSniper(address account) external onlyOwner() {
        require(account != 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3, 'We can not blacklist Uniswap');
