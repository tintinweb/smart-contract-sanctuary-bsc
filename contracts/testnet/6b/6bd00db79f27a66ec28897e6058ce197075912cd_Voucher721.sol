...
contract Voucher721 is ERC721Tradable{

    mapping(uint256 => uint8) private categories;
    ...
    function mint(address to, uint256 tokenId,uint8 category) public onlyMint returns (bool) {
