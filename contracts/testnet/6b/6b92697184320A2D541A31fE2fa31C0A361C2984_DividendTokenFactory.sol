...
contract DividendTokenFactory is Ownable {
    ...
    function createDividendToken(
        ...
        require(msg.value >= 1 ether, "createDividendToken::Fee is not enough");
        address newToken = Clones.clone(implementation);
        IDividendToken(newToken).initialize(
            name_,
            symbol_,
            decimals_,
            totalSupply_,
