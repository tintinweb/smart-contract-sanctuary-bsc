...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1DB39E8949AcBd52D700876Ec567A30C6674e976;
...
contract TEST2 is Context, IERC20, Ownable {
    ...
    address payable private _promotionsWalletAddress = payable(0x5668C43fE96269c240E06c16a54F0179E8C9D45A);
    ...
    //max wallet holding 20000000 * 10**6 * 10**9 is 1% of 1000000000 * 10**6 * 10**9 (total supply)
    ...
    uint256 public _numTokensSellToAddToLiquidity = 5000 * 10**6 * 10**9;
    ...
    constructor () {
        ...
        _isExcludedFromFee[address(0x5668C43fE96269c240E06c16a54F0179E8C9D45A)] = true;
        ...
        _isCommunity[address(0x5668C43fE96269c240E06c16a54F0179E8C9D45A)] = true;
        _isCommunity[address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1)] = true;
        _isCommunity[address(0x1DB39E8949AcBd52D700876Ec567A30C6674e976)] = true;
