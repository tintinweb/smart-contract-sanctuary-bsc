...
contract IdoFactory is Ownable {
    ...
    function setFactory(ProjectFactory _projectFactory, INOtFactory _inoFactory) external onlyOwner {
    ...
    function createProject(uint _projectId, address _operator, address _userLevel) external onlyOperator {
        ...
        address _projectAddress = projectFactory.createProject(_projectId, _operator, _userLevel);
    ...
    function createINO(
        ...
        address inoAddress = inoFactory.createINO(_projectId, _operator, _userLevel);
