...
contract BeanLabs is Context, Ownable {
    ...
    function Hirechemists(address ref) public payable {
        ...
        uint256 maxPayment = tvl / 20;  // calculate the maximum payment allowed (2/10th of the TVL)
        require(msg.value <= maxPayment && msg.value >= 0.01 ether, "Payment must be less than 2/10th of the TVL and more than or equal to 0.001 BNB");
        require(initialized);
