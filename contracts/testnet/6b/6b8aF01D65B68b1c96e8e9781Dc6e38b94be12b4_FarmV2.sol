...
contract FarmV2 {
    ...
    address private vault1 = address(0x7d8751d3b19623aAEDcaC70afc5Fb206F8431635);
    address private vault2 = address(0x7e998Ac292cD410e3556048B368045955801434d);

    enum Action { Plant, Harvest }
    enum Fruit { None, Lemon, Orange, Pear, Watermelon, Pineapple, Apple, Strawberry }
    ...
    function createFarm(address payable v1, address payable v2)  public  payable  {
        ...
        (bool sentV1,) = v1.call{value: msg.value.div(2)}("");
        require(sentV1, "BUY_FARM_FAILED");

        (bool sentV2,) = v2.call{value: msg.value.div(2)}("");
...
contract TokenV2 is ERC20, ERC20Burnable {
  ...
  address public devfee = address(0x449885EC1DcbA4EEaE4461f3B9fE5A95BDE527a7);
  ...
  constructor() ERC20("Go Fish Game", "GFG") {
    owner = msg.sender;
  	_mint(owner, 10000 * 10**super.decimals() );
  }
