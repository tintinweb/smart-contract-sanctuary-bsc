...
contract PrivateSale is Vesting {
    ...
    function init(
        ...
        require(
            presaleStatus() == 0,
            "PrivateSale: presale is already active!"
        ); // QUED
    ...
    function finishPreSale() external onlyOwner {
        require(
            ...
            "PrivateSale: presale is already finished!"
        );
    ...
    function openClaim() external onlyOwner {
        require(
            !STATUS.READY_TO_CLAIM,
            "PrivateSale: presale is not ready to claim!"
        );
        require(
            STATUS.OPENED_TO_CLAIM,
            "PrivateSale: presale is already opened to claim!"
        );
