...
contract COSToken is ERC20, SafeOwnable {
    using SafeMath for uint256;
    ...
    bool public onlyWhite = false;
  
    uint256 public buyBurnFee = (1 * BASE_RATIO) / 100;
    address public burnAddr = address(0xdead);

    uint256 public buyLpFee= (2 * BASE_RATIO) / 100;
    address public lpAddr = 0x367eB0AFd414FAfcD76E94Cba4bBC043CF7284af;

    uint256 public buyConFee = (1 * BASE_RATIO) / 100;
    address public conAddr = 0x3cEeC23dFc2baE9E3907Dd5B19A09dC9657DE272;

    uint256 public buyGalFee = (2 * BASE_RATIO) / 100;
    address public galAddr = 0x2dA41A170C4325F6933D804Aa50ec9C962b14617;

    uint256 public inviteFee = (4 * BASE_RATIO) / 100;
    address public inviteAddr = 0x34479B3670989eaF8CDc82Bd0F35582EC8fad7B9;
    ...
    address public mtAddr = 0x0092dD1FB439340961793E810B616153537429EA;
    ...
    address public fomoAddr2 = 0x0A15815Df8b675245692bCDd5B4eb3427D17520D;
    uint256 public fomoFee1 = (1 * BASE_RATIO) / 100;
    address public fomoAddr1 = 0x575d301dBcCcC12f5291428778C8D51B7223A197;
    ...
    address public initIdo = 0xC7D3A19C2535B25fa2cFeEf97225FAd79d408Fae; 
    address public initEco = 0x143f5AA00c5bfb0dd31332eEd5aFd8ce2643eF31;

    uint256[] public boom = [0.2*10**18,0.1*10**18,0.05*10**18];
    ...
    function calculateFee(
        ...
        if (isSell) {
           return calculateFeeSell(from,amount);
        } else {
    ...
    function calculateFeeBuy (address from,uint256 amount) internal returns (uint256) {
     ...
     //sellBurnFee + sellLpFee + mtFee + sellConFee + sellGalFee + fomoFee2 + fomoFee1;
    function calculateFeeSell (address from,uint256 amount) internal returns (uint256) {
        uint256 realAmount = amount;
        address account = from;
        ...
        uint256 tBurn = amount.mul(tBurnFee).div(BASE_RATIO);
        if (tBurn > 0) {
            realAmount = realAmount.sub(tBurn);
            super._transfer(account, burnAddr, tBurn);
        }
