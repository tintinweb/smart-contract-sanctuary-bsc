 ...
 */
contract BshareVault is AccessControl, Initializable {
    ...
    // address public BshareS;  // BshareS token address
    // address public BUSD; //BUSD token address
    address public router;
    address public masterNTT;
    address public BshareS;
    ...
    function initialize(
        ...
        INTT(BshareS).initialize(address(this), "BshareS", "BshareS");
    ...
    */
    function Deposit(uint256 _amount) external {
        ...
        IERC20(Admin.BShare()).safeTransferFrom(msg.sender, address(this), _amount);
        IYSLS(BshareS).mint(address(this),(_amount * (100 - depositTax) * (10 ** 18))/ (exchangeRatio * 100));
        exchangeRatio = (IERC20(Admin.BShare()).balanceOf(address(this)) * 100) / IERC20(BshareS).totalSupply();
        UserDeposit[msg.sender] = (_amount * (100 - depositTax) * (10 ** 18))/ (exchangeRatio * 100);
    }
    ...
    */
    function Withdraw(address user,uint256 amount) external {
        ...
        IERC20(Admin.BShare()).transfer(msg.sender, balance);
