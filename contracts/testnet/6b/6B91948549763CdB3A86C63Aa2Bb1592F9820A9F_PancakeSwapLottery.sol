...
contract PancakeSwapLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
     ...
     * @param _bnbAddress: address of the CAKE token
     * @param _randomGeneratorAddress: address of the RandomGenerator contract used to work with ChainLink VRF
     */
    constructor(address _bnbAddress, address _randomGeneratorAddress) {
        bnb = IERC20(_bnbAddress);
        ...
        nonReentrant
    {
        ...
        require(amountCakeToTransfer == msg.value, "Amount is incorrect");
    ...
    function drawFinalNumberAndMakeLotteryClaimable(
        ...
        // bnb.transfer(treasuryAddress, amountToWithdrawToTreasury);
        ...
        onlyOwnerOrInjector
    {
        ...
        bnb.transferFrom(address(msg.sender), address(this), _amount);
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount)
        ...
        onlyOwner
    {
        require(_tokenAddress != address(bnb), "Cannot be CAKE token");
