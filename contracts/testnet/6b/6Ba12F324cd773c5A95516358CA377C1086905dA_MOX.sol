 ...
 * controlled by a central SupplyController. By implementing MOX
...
contract MOX {
    ...
    string public constant name = "Moja"; // solium-disable-line
    string public constant symbol = "MOX"; // solium-disable-line uppercase
