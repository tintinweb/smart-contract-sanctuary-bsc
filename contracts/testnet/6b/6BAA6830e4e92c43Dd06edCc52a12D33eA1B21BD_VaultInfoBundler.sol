...
contract VaultInfoBundler is Ownable {
        ...
        returns (VaultListInfo memory)
    {
        ...
        (address addr1, address addr2, IFeeDistributorV6 addr3) = StakingVaultV6_0_0(
            payable(staking)
        ).getAddresses();
        ...
        returns (VaultPageInfo memory)
    {
        ...
        TokensInfo memory _tokensInfo = TokensInfo({
            ...
            secondTokenSymbol: ERC20(secondToken).symbol()
        });
        ...
        _vaultPageInfo = VaultPageInfo({
            ...
            apyData: _apyData,
            runway: FeeDistributorV6(payable(feeDistributorAddress)).runway(
                _vaultVariables.rewardsPerBlock
            ),
