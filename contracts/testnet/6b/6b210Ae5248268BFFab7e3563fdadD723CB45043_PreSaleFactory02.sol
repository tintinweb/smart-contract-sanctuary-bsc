...
contract PreSalePool02 is Ownable, ReentrancyGuard, Pausable, RedKiteWhitelist {
    ...
    function buyTokenByEtherWithPermission(
        ...
        uint256 preWeiAmount = msg.value;

        uint256 taxFee = _getTaxFee(preWeiAmount);
        uint256 weiAmount = preWeiAmount.sub(taxFee);
    ...
    function buyTokenByTokenWithPermission(
        ...
        uint256 taxFee = _getTaxFee(_preAmount);
        uint256 _amount = _preAmount.sub(taxFee);
