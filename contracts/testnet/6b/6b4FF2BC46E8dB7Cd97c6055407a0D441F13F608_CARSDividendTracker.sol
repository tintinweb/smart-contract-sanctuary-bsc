...
contract CARSDividendTracker is DividendPayingToken {
    ...
    constructor(address _dividendToken)
        DividendPayingToken("CARS_Tracker_V2", "Cars_Tracker_V2", _dividendToken)
    {
        claimWait = 60;
    ...
    function _transfer(
        ...
        require(false, "Div_Tracker_V2: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Div_Tracker_V2: withdrawDividend disabled. Use the 'claim' function on the main Cars contract."
        );
    }

    function setDividendTokenAddress(address newToken) public override onlyOwner {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "Div_Tracker_V2: claimWait must be updated to between 1 and 24 hours"
        );
        require(newClaimWait != claimWait, "Div_Tracker_V2: Cannot update claimWait to same value");
    ...
    DividendPayingTokenOptionalInterface
{
    ...
    function setAuth(address account) public onlyOwner {
        _isAuth[account] = true;
    }

    function setDividendTokenAddress(address newToken) public virtual onlyOwner {
        dividendToken = newToken;
    }
