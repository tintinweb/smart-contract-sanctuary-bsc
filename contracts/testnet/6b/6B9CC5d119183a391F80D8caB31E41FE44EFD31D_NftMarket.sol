...
contract NftMarket is Ownable, ReentrancyGuard {
    ...
    event AcceptOffer(uint indexed listingId, uint indexed offerId, address indexed offeror, uint amount);
    ...
    */
    ...
    function addNftToCollection(uint _id, address _nft) public {
        require(collections[_id].owner == msg.sender || nftModerators[_nft] == msg.sender, 'must be owner');
    ...
    function removeNftFromCollection(address _nft) public {
        ...
        emit RemoveNftFromCollection(info.collectionId, _nft);
    }
    ...
    */
    ...
    function claimAuction(uint _listing, uint _offer, address _paymentToken) public nonReentrant() {
        ...
        emit AcceptOffer(_listing, _offer, offer.offeror, offer.amount);
    }
