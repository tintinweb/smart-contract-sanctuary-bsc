 ...
 * @author Labrado
 */
contract LabradoToken is ERC20, Ownable {
    constructor() ERC20("Labrado Token", "LBRD") {}

    /**
     * @dev create new token to address specified
    ...
    /**
     * @dev transfer token to muilti recipients in a transaction
    ...
    function transferBatch(
        ...
        require(
            ...
            "LBRD: _recipients and _amounts must be of equal"
        );
        uint256 total = 0;
