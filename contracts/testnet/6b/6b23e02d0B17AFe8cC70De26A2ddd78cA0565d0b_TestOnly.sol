...
contract TestOnly is Context, IERC20, Ownable {
    ...
    address payable public autoLiquidityReceiver = payable(0x000000000000000000000000000000000000dEaD); // LP Address
    address payable public marketingWalletAddress = payable(0x000000000000000000000000000000000000dEaD); // Marketing Address
    address payable public operationsWalletAddress = payable(0x000000000000000000000000000000000000dEaD); // operations Address
