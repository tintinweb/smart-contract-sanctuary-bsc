...
contract SafuDoge is ERC20Detailed, Ownable {
    ...
    uint256 public constant safuInsuranceFundFee = 30;
    uint256 public constant sellFee = 0;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(safuInsuranceFundFee);
    ...
    address public safuInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("Safu Doge", "SAFUDOGE", uint8(DECIMALS)) Ownable() {
        ...
        safuInsuranceFundReceiver = 0x3A093d42534757a91E3ce398fF866F4688570362;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.mul(treasuryFee.add(safuInsuranceFundFee)).div(
                feeDenominator
            )
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(safuInsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(safuInsuranceFundReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(safuInsuranceFundFee).div(
                treasuryFee.add(safuInsuranceFundFee)
            ),
            gas: 30000
        }("");
    ...
    function setFeeReceivers(
        ...
        address _safuInsuranceFundReceiver
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        safuInsuranceFundReceiver = _safuInsuranceFundReceiver;
    }
