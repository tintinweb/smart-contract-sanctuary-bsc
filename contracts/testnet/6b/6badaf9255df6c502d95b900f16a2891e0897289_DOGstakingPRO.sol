...
contract DOGstakingPRO is Ownable {
    ...
    address public constant tokenAddress = 0x2f4586945327CA340eE4fB7cF5C301F43A7A14EB;
    // reward rate 20.00% per year
    uint public constant rewardRate = 2000;
    uint public constant rewardInterval = 365 days;
    
    // staking fee 0 percent
    uint public constant stakingFeeRate = 0;
    
    // unstaking fee 2.50 percent
    ...
    // Admin cannot transfer out DOG from this smart contract
    function transferAnyERC20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require (_tokenAddr != tokenAddress, "Cannot Transfer Out DOG!");
