...
5% Marketing | 2% LP | 3% BuyBack & Burn | 2% Reflection
Buy Tax 12% 
Sell Tax: 15% -- 6% Marketing | 3% LP | 4% BuyBack & Burn | 2% Reflection
Max Transaction: 1% Of Total Supply
Twitter: https://twitter.com/KELONofficial
TG: https://t.me/KELONofficial
TG Announcement: https://t.me/KELONannouncementchannel
Smart Contract Developed By: ISAIAH FADAK - Telegram: https://t.me/isaiahttc   |  https://t.me/isaiahfadak   |  Email: [email protected]
*/
...
contract KAITHESONOFELON is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1e13 * 10**_decimals; // 1% of the Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 10_000_000_000_000 * 10**9; // 1% of the Supply
    uint256 public maxBuyLimit = 1_00_000_000_000_000 * 10**9; // 10% of the Supply
    uint256 public maxSellLimit = 1_00_000_000_000_000 * 10**9; // 10% of the Supply
    uint256 public maxWalletLimit = 1_00_000_000_000_000 * 10**9; // 10% of the Supply
    
    uint256 public genesis_block;
    
    address public MarketingAddr = 0x06A77aBBA41939e1f2ec699fac35C0E2671FE26F;
    address private devWallet = 0x803c08EB0A5A12601CfCa8Ad68abA2186952aC44;
    address public buyBurnAddLiQ = 0x7e58D19bA21aa102D8DD076098adE3b86Dba7b9E;

    string private constant _name = "KAITHESONOFELON";
    ...
    Taxes public BuyTaxes = Taxes(2, 5, 2, 0, 3);
    Taxes public sellTaxes = Taxes(2, 6, 3, 0, 4);
    ...
    constructor (address routerAddress) {
        ...
        allowedTransfer[MarketingAddr] = true;
    ...
    function setBuyTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _dev, uint256 _buyback) public onlyOwner {
       BuyTaxes = Taxes(_rfi,_marketing,_liquidity,_dev,_buyback);
        emit FeesChanged();
    }
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(marketingAmt > 0){
            payable(MarketingAddr).sendValue(marketingAmt);
        }
