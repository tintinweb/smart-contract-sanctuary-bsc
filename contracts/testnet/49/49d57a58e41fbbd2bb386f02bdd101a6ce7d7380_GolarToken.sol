 ...
 */
contract GolarToken is BasicMetaTransaction {
    ...
    */
    ...
    {
        require(_to != address(0), "cannot transfer to address zero");
        require(!frozen[_to] && !frozen[_from] && !frozen[_msgSender()], "address frozen");
        require(_value <= balances[_from], "insufficient funds");
        require(_value <= allowed[_from][_msgSender()], "insufficient allowance");
    ...
    function disregardProposeOwner() public {
        require(_msgSender() == proposedOwner || _msgSender() == owner, "only proposedOwner or owner");
    ...
    function setAssetProtectionRole(address _newAssetProtectionRole) public {
        require(_msgSender() == assetProtectionRole || _msgSender() == owner, "only assetProtectionRole or Owner");
    ...
    */
    ...
    function setSupplyController(address _newSupplyController) public {
        require(_msgSender() == supplyController || _msgSender() == owner, "only SupplyController or Owner");
    ...
    function _betaDelegatedTransfer(
        ...
        require(betaDelegateWhitelist[_msgSender()], "Beta feature only accepts whitelisted delegates");
        ...
        require(!frozen[to] && !frozen[_from] && !frozen[_msgSender()], "address frozen");
    ...
    */
    ...
    function setBetaDelegateWhitelister(address _newWhitelister) public {
        require(_msgSender() == betaDelegateWhitelister || _msgSender() == owner, "only Whitelister or Owner");
    ...
    modifier onlyBetaDelegateWhitelister() {
        require(_msgSender() == betaDelegateWhitelister, "onlyBetaDelegateWhitelister");
        _;
    }
    ...
    function setFeeController(address _newFeeController) public {
        require(_msgSender() == feeController || _msgSender() == owner, "only FeeController or Owner");
