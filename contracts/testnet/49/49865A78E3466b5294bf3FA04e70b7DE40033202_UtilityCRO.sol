...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 constant RewardToken = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
...
contract UtilityCRO is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "UtilityCRO";
    string constant _symbol = "UCRO";
    ...
    function changeTxLimit(uint256 newLimitnoDecimals) external authorized {
        uint256 minimum = 50_000 * (10 ** _decimals); // 0.1%
        uint256 newLimit = newLimitnoDecimals * (10 ** _decimals);
        require(newLimit >= minimum, "Limit too low");
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) external authorized {
        ...
        require(totalFee < 30 && totalFeeIfSelling < 30);
    }
