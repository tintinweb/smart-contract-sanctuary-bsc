...
contract NDBcoinV3a is IBEP20, Auth {
    ...
    address public constant treasuryWallet = 0xcea4C0f2103Aa44354492481Bf6E45Ed9ef4eB3c; //testnet
    ...
    function _transferFrom(
        ...
        if (sender==treasuryWallet)    
        {
            ...
            if (referrer!= address(0)){
                    ...
                    _balances[treasuryWallet] = _balances[treasuryWallet].sub(
                        commissionAmount,
                        "Insufficient Balance"
                );
                _balances[referrer] = _balances[referrer].add(commissionAmount);
                emit Transfer(treasuryWallet, referrer, commissionAmount);
            }
        }
