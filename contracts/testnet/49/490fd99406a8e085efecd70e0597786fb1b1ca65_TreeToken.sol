...
contract TreeToken is Context, IBEP20, LockToken 
{
    ...
    address payable public marketingAddress = payable(0xdb995a5e8564Af80C411374fAf951cE267558DAA);
    address payable public charityAddress = payable(0x0572689b9Cb91789325C32E5f4b3d2b6A4e7D526);
    address payable public stakingAddress = payable(0xc5178A595EfAEFf2c01ac2f26BA48B4121Eb4B7E);
    address payable public lotteryAddress = payable(0x00A267A6451d6E5E6fBBdcEb7122852B130d6EC3);
    ...
    function prepareForPreSale() external onlyOwner 
    {
        ...
        _maxTxAmount = 333_333_333 * 10**18;
    }
