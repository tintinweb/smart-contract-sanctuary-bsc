...
contract OsoWallet is Context, IERC20, Ownable {
    ...
    uint256 private feeThreshold = 10000 * PRECISION;
    ...
    bool private presaleSwitch = true;

    mapping(address => bool) private excludedFromFee;

    constructor(address pancake, address _marketFeeAddress, address _burnFeeAddress) {
        _balances[_msgSender()] =  100000000 * PRECISION;
        _totalSupply = 100000000 * PRECISION;
        _name =  "OW";
        _symbol  =  "OW";
        ...
        excludedFromFee[burnFeeAddress] = true;
    }
    ...
    function setPresaleSwitch(bool _b) public onlyOwner {
        presaleSwitch = _b;
    }
    ...
    function setPinksaleAddress(address _a) public onlyOwner {
        pinksale = _a;
    }
    ...
    function swapAndLiquify() private lockTheSwap {
        ...
        _fee = burnFee;
        burnFee = 0;
        swapTokensForEth(_fee, burnFeeAddress);
    }
    ...
    function deduction(address from, address to, uint amount) private returns(uint){
        ...
        uint ramount = amount;
        marketFee =  (amount * 3 / 100) + marketFee;
        burnFee =  (amount * 3 / 100) + burnFee;
        liquidityFee = (amount * 2 / 100) + liquidityFee;
        ramount = amount - (amount * 8 / 100);
        return ramount;
    }
    ...
    function _transfer(
        ...
        if(presaleSwitch && block.timestamp < 1653134405) {
            require(excludedFromFee[from], "Before presale");
        }
