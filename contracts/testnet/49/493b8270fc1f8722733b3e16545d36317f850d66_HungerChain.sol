    ...
    AccessControl
{
    ...
    constructor(
        ...
        address minter
    ) ERC721(_name, _symbol) EIP712("LazyNFT-Voucher", "1") {
    ...
    function safeMint(
        ...
        return _safeMint(redeemer, voucher.uri);
    }
        ...
        returns (bytes32)
    {
        return
            _hashTypedDataV4(
                keccak256(
                    abi.encode(
                        keccak256("NFTVoucher(uint256 price,string uri)"),
                        voucher.price,
