...
interface ITipDatabase {
    function registerTip(address from, address to, uint256 amount, uint8 method) external;
}
...
contract TipSwapper is NBLGovernance {
    ...
    function tipFrom(
        ...
        // Register In DB
        Database.registerTip(from, streamer, toSend, 3);
    ...
    function tip(
        ...
        // Register In DB
        Database.registerTip(msg.sender, streamer, toSend, 1);
    ...
    function tipWithNBL(
        ...
        // Register In DB
        Database.registerTip(msg.sender, streamer, toSend, 0);
    ...
    function tipWithOther(
        ...
        // Register In DB
        Database.registerTip(msg.sender, streamer, toSend, 2);
