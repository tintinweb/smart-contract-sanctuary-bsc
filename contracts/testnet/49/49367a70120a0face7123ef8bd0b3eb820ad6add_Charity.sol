...
contract Charity is Ownable {
    ...
    function buyProduct(address _sponsorAddress, uint256 amount) external payable {
        ...
        uint256 utilityToBurn = _utilityDBMEwei.mul(burnPercent).div(divisor);
        uint256 utilityToCharity = _utilityDBMEwei.mul(charityPercent).div(divisor);
        uint256 utilityToUser = _utilityDBMEwei - utilityToBurn - utilityToCharity;
