...
contract kasohor
 is Context, IERC20, Ownable {
    ...
    string private _name = "Kasohor";
    string private _symbol = "Kasohor";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xF91eC8A3A5Df32b846064971E68EaCCB1Ad38863));
        _ketmatwallet = payable(address(0xF91eC8A3A5Df32b846064971E68EaCCB1Ad38863));
