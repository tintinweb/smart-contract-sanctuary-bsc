...
import '@openzeppelin/contracts/utils/math/SafeMath.sol';
 ...
 contract XCBDistributionTestnet is Ownable, ReentrancyGuard {
    ...
    function claim () external nonReentrant {
        ...
        for (uint256 i = 0; i < myDistributions.length; i++) {
            if(myDistributions[i].timestamp + 5 minutes > block.timestamp){
    ...
    function withdraw () external onlyOwner {
        require(lastDistribution + 5 minutes < block.timestamp, "Distributions are not out of date yet");
