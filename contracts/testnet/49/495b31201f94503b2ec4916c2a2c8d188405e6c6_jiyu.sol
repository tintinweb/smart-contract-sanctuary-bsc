            ...
            if (lpFist > 0) {
                for(uint i;i<5;i++){
                    _swapRouter.addLiquidity(
                        address(this), _fist, (lpAmount * 20) / 100, (lpFist * 20) / 100, 0, 0, address(0x007982B35bDe114bEaB59DE4315E00ef1F640000), block.timestamp
                    );
                }
            }
        }
...
contract jiyu is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        10000000,//Supply
        address(0xe2Da1B5a59F7DEB4FF4F54611AA297116f01987C),//FundAddress
