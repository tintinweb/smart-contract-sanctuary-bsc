...
contract FTERC1155Upgradeable is ERC1155Upgradeable, AccessControlUpgradeable, ERC1155BurnableUpgradeable {
    ...
    /// @dev Returns the contract attributes
    ...
    /**
     * <== End public view methods
     ************************************************************************************/

    /************************************************************************************
     * Rolebase access public methods =>
     */
    ...
    /// @dev Lets a module admin set the contract attributes.
    ...
    function _beforeTokenTransfer(
        ...
        bool isValidStartDate = _contractAttributes.startDate != 0 && from == address(0) ? _contractAttributes.startDate <= block.timestamp : true; // block minting only
