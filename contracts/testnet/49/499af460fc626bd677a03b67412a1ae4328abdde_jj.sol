...
contract jj is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x2Da9D9eBD800C2AA028810BB51a67DA82D61C3BA)); //项目方钱包
        marketingWalletAddress = payable(address(0x2Da9D9eBD800C2AA028810BB51a67DA82D61C3BA)); //营销钱包
