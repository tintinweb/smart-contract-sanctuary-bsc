...
contract HybexSwap is Initializable, UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  event AccountsWhitelistUpdated(address[] indexed accounts, bool status);
  ...
  */
  function excludeAllFromWhitelist(address[] memory accounts) external onlyOwner {
    ...
    emit AccountsWhitelistUpdated(accounts, false);
  }
  ...
  */
  function withdrawBEP0Token(address _tokenContract, uint256 amount) external onlyOwner {
