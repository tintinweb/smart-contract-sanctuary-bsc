...
contract DistributorERC721V1 is AccessControl, ERC721Holder {
    ...
    //Contract of token for distribution
    ERC721 public token;
    ...
    event Claim(address _receiver, uint256 tokenId);
     ...
     * @param _tokenId Id of tokn for claaim
    ...
    function claim(
        ...
        bytes32 message = keccak256(abi.encodePacked(msg.sender, _tokenId, block.chainid));
        ...
        IERC721(token).safeTransferFrom(address(this), msg.sender, _tokenId);
