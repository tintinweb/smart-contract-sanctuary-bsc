...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE50AcF2cf35b3A357c979Cd486775e6919a0edee;
...
contract BARAT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE50AcF2cf35b3A357c979Cd486775e6919a0edee;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Barato Popular";
    string private _symbol = "BARAT";
