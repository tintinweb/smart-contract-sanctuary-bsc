...
contract Token is ERC20, Ownable, ERC20Spendable {
    using SafeMath for uint256;
    using Address for address;

    string private name_ = "Test";
    string private symbol_ = "ESP2";
    ...
    uint256 public _maxSwapLimit = 150000000 * 10**18;
    ...
    uint256 private minimumTokensBeforeSwap = 150000000 * 10**3; 
    ...
    address payable public marketingWalletAddress = payable(0x0D4484Bd852Da942e17Dc7E36Cf5813cf32fB9f8); // Marketing Address
    address payable public teamWalletAddress = payable(0x0D4484Bd852Da942e17Dc7E36Cf5813cf32fB9f8); // Team Address
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        require(newLiquidityTax + newMarketingTax + newTeamTax <= 2500, "Maximum total buy fee is fixed on 25%");
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        require(newLiquidityTax + newMarketingTax + newTeamTax <= 2500, "Maximum total sell fee is fixed on 25%");
    ...
    function setDistributionSettings(uint256 newLiquidityShare, uint256 newMarketingShare, uint256 newTeamShare) external onlyOwner() {
        require(newLiquidityShare + newMarketingShare + newTeamShare <= 2500, "Maximum total distribution fee is fixed on 25%");
