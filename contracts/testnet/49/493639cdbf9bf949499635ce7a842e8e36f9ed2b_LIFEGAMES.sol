...
contract LIFEGAMES is IERC20, Initializable {
    ...
    struct Fees {
        uint256 distributionToHoldersFee;
        uint256 buyFee;
        uint256 sellFee;
        uint256 transferFee;
    }
    ...
    struct StaticValuesStruct {
        uint256 maxTotalFee;
        uint256 maxDistributionToHoldersFee;
        uint256 maxBuyTaxes;
        uint256 maxSellTaxes;
        uint256 maxTransferTaxes;
    ...
    uint256 public gasPriceLimit; // 70 gWei / gWei -> Default 25
...
//    }
    ...
    function initialize(address[] memory addresses) public initializer {
        ...
        gasLimitActive = true;
        gasPriceLimit = 70000000000; // 70 gWei / gWei -> Default 25
