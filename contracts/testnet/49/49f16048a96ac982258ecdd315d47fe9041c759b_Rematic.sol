...
contract Rematic is ERC20, Ownable {
    ...
    address public teamWallet = 0xB165E70D2139BB944A85E7c7816a37D49ad666D8;
    address public flexWallet = 0xB165E70D2139BB944A85E7c7816a37D49ad666D8;
    ...
    function _transfer(
        ...
        if (!swapping && 
            ...
            if (flexFee > 0) {
                uint256 flexBNB = finalBalance.div(totalFees).mul(bnbFee);
                payable(flexWallet).transfer(flexBNB);
            }

            if(teamFee > 0) {
                uint256 teamBNB = finalBalance.div(totalFees).mul(bnbFee);
