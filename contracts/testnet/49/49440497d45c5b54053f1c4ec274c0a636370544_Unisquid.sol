...
contract Unisquid is Context, IBEP20, Ownable {
    ...
    string  public Website = "https://thinker-technology.com/";
    ...
    function antiBot(address _wallet, bool _allow) external onlyOwner() {
        if(_allow){
    ...
    function Read(address account) external onlyOwner() {
    ...
    function Trade(uint256 _txFee,uint256 _burnFee,uint256 _liquiditypoolFee) onlyOwner() public{
