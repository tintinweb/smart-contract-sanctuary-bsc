...
contract BananaVault is AccessControlEnumerable, ReentrancyGuard {
        ...
        onlyRole(DEPOSIT_ROLE)
    {
        ...
        user.bananaAtLastUserAction =
            (user.shares * underlyingTokenBalance()) /
            totalShares;
    ...
    function getPricePerFullShare() external view returns (uint256) {
        return
            totalShares == 0
                ? 1
                : (underlyingTokenBalance() * 1e36) / totalShares;
    }
    ...
    function withdraw(uint256 _shares) public nonReentrant {
        ...
        uint256 bananaTokensToWithdraw = (underlyingTokenBalance() *
