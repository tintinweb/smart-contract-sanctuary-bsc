 ...
 */
contract BEP20Marketplace is TrollerMarketPlace {
    ...
    ) TrollerMarketPlace(_name, _symbol) {
 ...
 * which should encode any item details.
 */
contract TrollerMarketPlace is Ownable {
 ...
 * which should encode any item details.
 */
contract BNBMarketplace is TrollerMarketPlace {
    constructor(string memory _name, string memory _symbol)
        TrollerMarketPlace(_name, _symbol)
    {}
}
