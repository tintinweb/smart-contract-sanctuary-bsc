...
contract MamaKong is Context, IERC20, Ownable {
    ...
    string private constant _name = "MamaKong";
    ...
    bool private prSaleStart = false;
    uint256 public _prSaleStartTime = MAX;
    uint256 public _prSaleMinAmount = 0;
    uint256 public _prSaleFee = 2;
    uint256 public _prSalePrice = 0.3 ether;
    uint256 public _prSaleEndTime = MAX;
    uint256 public _softCap = 350;
    uint256 public _hardCap = 700;
    ...
    function buy() external payable {
        ...
        uint256 tknAmount = ethAmount.div(_prSalePrice);
        _tokenTransfer(address(this), _msgSender(), tknAmount, false);
    ...
    function set_prSaleMinAmount(uint256 minAmount) external onlyOwner {
        _prSaleMinAmount = minAmount;
    }
    ...
    function canSale() external view returns (bool) {
        if (block.timestamp >= _prSaleStartTime && block.timestamp <= _prSaleEndTime)
            return true;
        return false;
    }
