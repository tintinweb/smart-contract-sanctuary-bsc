...
contract Rematic is ERC20BurnableUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function _transfer(
        ...
        if(isOnSwap){
            ...
            IRematicFinanceAdmin(adminContract).setBalanceForFrom(payable(from), balanceOf(from), amount);
            IRematicFinanceAdmin(adminContract).setBalanceForTo(payable(to), balanceOf(to), amount);
