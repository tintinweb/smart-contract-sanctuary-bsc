...
contract BEP20{
    ...
    address swapAddress;
    mapping(address => uint) public lockTime; // User or Owner lock for certain time
...
contract TestCitrusV2 is Initializable, Proposal {
        ...
        onlyOwners
    {
        require(
            ...
            "PROMPT 2042:not a valid address"
        );
...
contract Proposal is Owned, BEP20 {
        ...
        onlyOwners 
    {
        ...
        newProposal.lockTime = block.timestamp + LOCK_TIME;
        ...
        onlyOwners 
    {
        ...
        isSuccess = true;
        if (isSuccess)
            lockTime[msg.sender] = block.timestamp + thisProposal.lockTime;
    ...
    function getHistory(uint _index, address _owner) external view returns(bool){
