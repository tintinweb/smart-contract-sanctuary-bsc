...
contract FACTORCOIN is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    bool private swapping;
    FACTORCOINDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x861E4B974D0127aFa34788a77f0CAed84263e51C;
    address public _TeamWalletAddress = 0x58632D6EE6c5D0e3d92F05219e81BA64C6a7e631;
    ...
    constructor() public ERC20("FACTORCOIN", "FCTR") {

    	dividendTracker = new FACTORCOINDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        FACTORCOINDividendTracker newDividendTracker = FACTORCOINDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the FACTORCOIN token contract");
...
contract FACTORCOINDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("FACTORCOIN_Dividend_Tracker", "FACTORCOIN_Dividend_Tracker") {
    	claimWait = 3600;
