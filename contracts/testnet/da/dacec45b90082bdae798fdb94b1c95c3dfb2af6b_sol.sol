...
contract sol is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x564fb798015f20b47a20Ec89F7EC2A84734E48A6); 
    address payable public Wallet_Dev = payable(0xA8a4Eb65d30736248c574804F7125BF4E48A3058);
    ...
    string private constant _name = "QBE Ecosystem";
    string private constant _symbol = unicode"QBE";

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10;

    /* Change the taxe's to what ever you want! */
    ...
    constructor () {
        _owner = 0xA8a4Eb65d30736248c574804F7125BF4E48A3058;
        emit OwnershipTransferred(address(0), _owner);_tOwned[owner()] = _tTotal;
    ...
    function _transfer(
        ...
        require(amount > 0, "Token value must be higher than zero.");if(
            txCount >= swapTrigger && 
            !inSwapAndLiquify &&
            from != uniswapV2Pair &&
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            emit Transfer(sender, recipient, tAmount);if(recipient == Wallet_Burn)
