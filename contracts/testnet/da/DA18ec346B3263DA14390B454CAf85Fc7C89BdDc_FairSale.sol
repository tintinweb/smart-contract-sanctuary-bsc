    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(address _token) public initializer {
        ...
        // transferOwnership(0x9be49028bB5C5DB2B9643085c35CdD20F5f9ce5D);
    }

    function setFairSale(
        ...
        totalSaleTokens = _totalSaleTokens;
        startDate = _startDate;
        maxContribution = _maxContribution;
        endDate = _endDate;

        currentRate = _totalSaleTokens;
    ...
    function updatePool() public {
        ...
        if (filledBusd > 0) {
            currentRate = (totalSaleTokens / filledBusd) / 10**18;
        }

        if (isStarted && endDate <= block.timestamp) {
            isFilled = true;
        }
    }
