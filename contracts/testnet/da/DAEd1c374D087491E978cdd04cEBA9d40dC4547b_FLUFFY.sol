...
contract FLUFFY is ERC20, Ownable {
    ...
    constructor () ERC20("Plushie Coin", "FLUFFY") 
    {   
        ...
        maxWalletAmount       = 5_000_000_000 * (10 ** decimals());

        maxTransactionLimitEnabled = true;
        maxTransactionAmountBuy = ( 3 * 500_000_000) * (10 ** decimals()) ;
        maxTransactionAmountSell = ( 3 * 500_000_000) * (10 ** decimals()) ;
