...
/**
 *Submitted for verification at BSC Scan on 
*/

/**
*
*   AmeriCoin
*   A cryptocurrency to solve America's Government Debt Problems
*   1 token
*   1 Trillion Dollar starting market cap
*   1 solution to America's financial crisis
*   If the treasury can mint a trillion dollar coin, so can we!
*    
*/
...
contract AmeriCoin is Ownable, IBEP20 {
    ...
    address pancakeAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //PCS V2 Testnet router

    string constant _name = "AmeriCoin";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x35169e94B69E8AB6F45bfFF4B0F3637F355e4580;
        marketingWallet = 0x840058d97b4310a356DD94B2062716E25fCDEcd7;
