    ...
    ERC721HolderUpgradeable
{
    ...
    function setCreatorFee(address tokenAddress, uint256 fee) public {
        address owner = IFeeManager(tokenAddress).owner();
        require(tx.origin == owner, "NOT_OWNER_OF_CONTRACT");
        require(fee <= 10000, "fee too large");
        creatorFee[tokenAddress] = fee;
    }
}
...
interface IFeeManager {
    function creatorFee(address tokenAddress) external view returns (uint256);
