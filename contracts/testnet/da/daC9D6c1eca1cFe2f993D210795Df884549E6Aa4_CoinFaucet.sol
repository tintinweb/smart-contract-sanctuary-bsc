...
contract CoinFaucet is Ownable {
    ...
    mapping(address => mapping(address => uint256)) TokenReceived;
    ...
    function receiveToken(address token, uint256 amount) external {
        ...
        TokenReceived[token][_msgSender()] = TokenReceived[token][_msgSender()]
            .add(amount);
        emit ReceiveToken(token, _msgSender(), amount);
    }
    ...
    function withdrawToken(
        ...
        emit ReceiveToken(token, account, amount);
    }
