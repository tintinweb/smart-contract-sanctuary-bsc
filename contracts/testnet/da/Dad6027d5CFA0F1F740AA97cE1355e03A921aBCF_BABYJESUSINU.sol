...
/**
 Telegram : https://t.me/babyjesusinu
*/
...
contract BABYJESUSINU is Context, IERC20, Ownable {
    ...
    address private feeOne = 0xb486A60ad1d029b10d0583D805231a32bE97e449;
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "Baby Jesus Inu";
    ...
    uint256 public ethPriceToSwap = 0.2 ether; 
    ...
    constructor () {
        address tokenOwner = 0xBDA12e7eB773F89B835C5924b701F1A775896313;
