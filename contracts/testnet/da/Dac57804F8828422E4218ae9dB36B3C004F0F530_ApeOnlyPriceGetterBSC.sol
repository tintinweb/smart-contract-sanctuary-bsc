...
//    using AMMData for AmmData;
    ...
    address public constant FACTORY = 0x81d7099e629eac48B01509D314377E8B526fFB5b; //ApeFactory

    bytes32 public constant INITCODEHASH = hex'4bdfcf9eeea3e4f5ae845b9635119c8f8ff7ffd25588a603c0aafe8145065bde'; // for pairs created by ApeFactory
    ...
    address constant BUSD = 0x98649fde88981790b574c9A6066004D5170Bf3EF;
    ...
    address constant BUSD_WBNB_PAIR = 0x62ECFc28B17c0B1E776Fb7Fc66282381134c960c; // busd is token1
    ...
    function getBNBPrice() public view returns (uint) {
        ...
        uint wbnbTotal =  wbnbReserve1 ;

        uint usdTotal =  busdReserve ;
