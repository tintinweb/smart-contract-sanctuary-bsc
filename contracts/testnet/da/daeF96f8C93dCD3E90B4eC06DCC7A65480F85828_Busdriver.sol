...
contract Busdriver {
    ...
    uint256 public MIN_INVEST_LIMIT = 0 * 1e18; /** 10 BUSD  **/
    ...
    uint256 public WITHDRAWAL_TAX = 890;
    ...
    constructor(address _dev1, address _dev2, address _dev3, address _mkt) {
...
BUSDriver
 Jump on the bus, get fuel, take stops to collect BUSD. 
  ...
  90% feedback for withdrawals that will be done not after 5 consecutive compounds.(12.5%)
