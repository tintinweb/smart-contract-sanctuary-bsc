...
abstract contract Auth {
    ...
    function authorize(address adr) public _onlyOwner {
    ...
    function unauthorize(address adr) public _onlyOwner {
    ...
    function transferOwnership(address payable adr) public _onlyOwner {
        owner = adr;
        authorizations[adr] = true;
