 ...
 *  - postRelayedCall
 */
contract GasRelayPaymaster is Initializable, IPaymaster, TokenHelper {
    ...
    function versionPaymaster() external pure returns (string memory) {
        return "2.2.0+opengsn.azira.ipaymaster";
    }
    ...
    uint256 public constant DEPOSIT = 100000000000000000;
        ...
        returns (bytes memory context, bool rejectOnRecipientRevert)
    {
        ...
        return (abi.encode(_relayRequest.request.from), false);
    }
    ...
    function postRelayedCall(
        ...
        // __depositMax();
        // }
        address spender = abi.decode(_context, (address));
        emit TransactionRelayed(spender, _relayData.paymasterData, _success);
    }
