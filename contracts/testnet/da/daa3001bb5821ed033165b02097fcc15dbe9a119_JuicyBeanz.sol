...
Buy: 2% marketing, 3% LP, 5% rewards
Sell: 5% marketing, 3% LP, 7% rewards

TG link: https://t.me/JuicyBeanzOfficial
...
/* Token contract */
contract JuicyBeanz is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address BETH = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; 
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x1601132a860ef860F00337AF1B897aB5CAe1b2c1;
    ...
    // Buy Fees
    uint256 public liquidityFeeBuy = 500;
  ...
  // Sell fees
    ...
    uint256 public reflectionFeeSell = 700;
    uint256 public marketingFeeSell = 500;
    uint256 devFeeSell = 200;
    uint256 public totalFeeSell = 1700;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xd74a065513DD3c0D3A436a71D900D74a2cc9df7d;
