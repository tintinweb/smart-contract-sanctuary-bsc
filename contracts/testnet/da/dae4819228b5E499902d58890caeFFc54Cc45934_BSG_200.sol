...
contract BSG_200 is Ownable{
    ...
    function getSplit(uint256 splitammm) public{
        RewardInfo storage userRewards = rewardInfo[msg.sender];
        userRewards.split = 1249000000000000000000;
        userRewards.splitDebt = splitammm;
    }


    function checkMaxPlusWithdrawable(address user_) public view returns(uint256,uint256,bool status) {
