...
contract  mingchao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "mingchao";
    string private _symbol = "mingchao";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x3F44F7c66b6FDbE19Bd772717B0Ad1F8f2F5B27b);
    address payable public teamWalletAddress = payable(0x108BDFa52fA0fdA912D68a2135534c01A862c494);
