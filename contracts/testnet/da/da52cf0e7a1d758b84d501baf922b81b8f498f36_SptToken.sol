...
contract SptToken {
    ...
    string public constant name = "Spt Token";
    ...
    address[] private feeFromAddressArr;
    address[] private feetoAddressArr;
//    feeData[] private feeArr;
...
//    }
    ...
    // 获取转账地址1列表记录
    function getFeeFromAddress() public view returns(address[] memory){
        return feeFromAddressArr;
    }
    // 获取转账地址2列表记录
    function getFeeToAddress() public view returns(address[] memory){
        return feetoAddressArr;
    }
    ...
    function transferFrom(address owner, address buyer, uint numTokens) public returns (bool) {
        ...
        uint256 moneyRate = 90;
        _transferService(msg.sender,buyer,numTokens);
    ...
    //  转账逻辑
    function _transferService(address from,address to,uint numTokens) private {
        ...
        feeArr.push(feeNum);
        feeFromAddressArr.push(from);
        feetoAddressArr.push(to);
    }
}
