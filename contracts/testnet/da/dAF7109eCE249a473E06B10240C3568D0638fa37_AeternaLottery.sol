...
contract AeternaLottery is ReentrancyGuard, IAeternaLottery, Ownable {
    ...
    uint256 public minimumPrice = 0.003 ether;
        ...
        nonReentrant
    {
        ...
        if(tokenBalance > 0)
            require(msg.value >= _ticketNumbers.length * minimumPrice, "Insufficient funds for tickets.");
        else
            require(msg.value >= _ticketNumbers.length * 2 * minimumPrice, "Insufficient funds for tickets.");
