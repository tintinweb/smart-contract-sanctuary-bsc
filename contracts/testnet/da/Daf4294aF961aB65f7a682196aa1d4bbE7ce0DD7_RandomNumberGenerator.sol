    ...
    UUPSUpgradeable
{
     ...
     */
    mapping(uint256 => Numbers) public randomNumbers;
        ...
        override
    {
        ...
        if (randomWords.length == 1) {
            randomNumbers[requestId] = Numbers(randomWords[0], 0);
        } else if (randomWords.length == 2) {
            randomNumbers[requestId] = Numbers(randomWords[0], randomWords[1]);
        }
