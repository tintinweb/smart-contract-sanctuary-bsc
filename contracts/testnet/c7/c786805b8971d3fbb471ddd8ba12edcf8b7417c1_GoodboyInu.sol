...
contract GoodboyInu  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Goodboy Inu"; 
    string private constant _symbol = "GoodboyInu"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0x69D1D1D38b305Fa3e2ffC5DDb8e8437ACd2ED2E1;
    ...
    function setMaxWalletBalance(uint256 amount) external {
        require(msg.sender == developer, "homestead");
