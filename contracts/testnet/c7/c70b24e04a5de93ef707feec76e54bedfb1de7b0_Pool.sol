...
contract Pool is Initializable, PoolStorage, OwnableUpgradeable, ReentrancyGuardUpgradeable, IPool {
        ...
        returns (uint256 amountInAfterFee, uint256 feeAmount, uint256 lpAmount)
    {
        ...
        uint256 _fee = _calcAddRemoveLPFee(_tranche, _token, tokenPrice, valueChange, true);
        ...
        returns (uint256 outAmount, uint256 outAmountAfterFee, uint256 feeAmount)
    {
        ...
        uint256 _fee = _calcAddRemoveLPFee(_tranche, _tokenOut, tokenPrice, valueChange, false);
    ...
    function _calcAddRemoveLPFee(
        ...
        uint256 poolValue = _getTrancheValue(_tranche, _isAdd);
        return _calcFeeRate(
            poolValue, _token, _tokenPrice, _valueChange, addRemoveLiquidityFee, fee.taxBasisPoint, _isAdd
        );
    }
