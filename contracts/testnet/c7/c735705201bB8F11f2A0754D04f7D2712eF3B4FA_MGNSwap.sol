...
contract MGNSwap is Pausable, AccessControl, Ownable {
    ...
    Itoken mgn;
    Itoken busd;
    address _globalWallet = 0xdD870fA1b7C4700F2BD7f44238821C26f7392148;
    uint256 swapFee = 3;
    uint256[2] collectingRatio = [10,90];
    // 1 BUSD = 10 MGN
    uint256[2] swapRatio = [1,10];
    ...
    function MGNtoBUSD(uint256 _amount) public {
        ...
        require(_amount > 0, "The amount > 0");
        require(busd.balanceOf(address(this)) >= _amount,"Swap wallet's balance is not enough");
