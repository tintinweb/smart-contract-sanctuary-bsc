    ...
    IMarketplace
{
    ...
    mapping(address => mapping(uint256 => uint256)) public itemStoreLength;
    mapping(address => mapping(uint256 => uint256)) public indexItemStore;
    ...
    function listItem(
        ...
        indexItemStore[_contractNFT][_tokenId] = itemStoreLength[_contractNFT][
            _tokenId
        ];
        itemStoreLength[_contractNFT][_tokenId] += 1;
        emit ListingItem(
            msg.sender,
            address(this),
            1,
    ...
    function cancelItem(
        ...
        emit CancelListing(msg.sender, address(this), myItem.amount, _contractNFT, _tokenId, myItem.contractERC20, myItem.price);
