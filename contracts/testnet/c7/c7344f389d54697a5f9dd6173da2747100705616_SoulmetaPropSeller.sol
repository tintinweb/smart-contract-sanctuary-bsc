...
contract SoulmetaPropSeller is DivestorUpgradeable, RandomGeneratorUpgradeable, ERC1155HolderUpgradeable {
    ...
    function setContracts(address soulController_, address soulToken_, address prop1155_, address soulPair_, address receiver_, address timeBank_) public onlyOwner {
...
//    }
    ...
    /*
     *  购买道具
     *  propId: 1 - 100， 2 - 10， 3 - 50， 4 - 200， 5 - 500，6 - 10000
     **/
    function buyProp(address recommender_, uint propId) public returns (bool){
//        revert();
        ...
        if (b1 != 0 && b2 != 0) {
            ...
            soulCount =  propEffect[propId].prices * 1 gwei * 1 ether / uintPrice;
        } else {
            soulCount = 5 ether;
        }
     ...
     *  批量开启
     **/
    function propBatchBox(uint8 theme_, uint8 group_, uint propId, address recommender_) public returns (bool){
        uint count = externalAddr.prop1155.balanceOf(_msgSender(), propId);
        require(count > 0, "Unauthorized");
        externalAddr.prop1155.burn(_msgSender(), propId, 1);
        return externalAddr.soulController.drawBox(_msgSender(), theme_, group_, propEffect[propId].times, recommender_);
    }
