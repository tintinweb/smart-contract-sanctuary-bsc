...
contract StratX_pancakeLP is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant unirouterbiswap =
        address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //biSWAP
    ...
    address public constant afiFarmAddress =
        0xB64F82d493dcB704416860352768EdAeA622eFDf;
    //address public constant AFIAddress = 0xcf496c03F630C343333a28749a7FC4d589b1137A;//AFIX
    address public constant AFIAddress =
        0xFa60D973F7642B748046464e165A65B7323b0DEE; //AFIB

    address public govAddress = 0x95E2037C17596Fa12014b4421c8581ce06AeB5ca;

    address public constant receiveFee =
        address(0x95E2037C17596Fa12014b4421c8581ce06AeB5ca); //

    address public  fundManager = address(0x95E2037C17596Fa12014b4421c8581ce06AeB5ca);
    address public  fundManager2 = address(0x95E2037C17596Fa12014b4421c8581ce06AeB5ca); 
    address public  fundManager3 = address(0x95E2037C17596Fa12014b4421c8581ce06AeB5ca);
    ...
    address[] public earnedToWbnbPath = [earnedAddress, usdt];
    address[] public wbnbToAFIPath = [usdt, AFIAddress];
    address[] public wbnbToToken0Path = [usdt, wbnb, token0Address];
    address[] public wbnbToToken1Path = [usdt, wbnb, token1Address];
    ...
    constructor() public {
        wantAddress = 0xb98C30fA9f5e9cf6749B7021b4DDc0DBFe73b73e;
        pid = 3;
