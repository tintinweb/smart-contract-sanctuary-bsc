...
contract PolkaSale is Ownable{
    ...
    uint256 internal price=25000; 
    uint256 public minPrice=5*1e17;
    uint256 public maxPrice=10*1e18;
    //uint256 public minInvestment=100*1e18;
    uint256 public maxInvestment=10*1e18;
    uint256 public softCap = 50*1e18;
    uint256 public hardCap = 100*1e18;
    ...
    constructor(address polkaAddress) public{
    ...
    function claimBackBNB() payable public{
        require(user[msg.sender].isExist , "No investment by user!");    
        ...
        address payable userWallet = address(uint160(msg.sender));
