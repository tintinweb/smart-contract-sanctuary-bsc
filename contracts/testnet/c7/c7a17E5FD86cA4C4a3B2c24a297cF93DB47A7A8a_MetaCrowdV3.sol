...
contract MetaCrowdV3 is AccessControl {
    ...
    address public token = 0xDF7936C769b3787c016165fcb507A105Bd5D19EE;
    address public fee = 0x221A126E0F2B4A6c5848689145589f9A229dc3aa;
    address public crowdAccount = 0xc6A55f07B588157aB2a8250c138784Fc799c3A4b;
    address public fundAlloc = 0xb886073a77E0FdF466E635F89344B48Aa5d1E671;
    uint16[] public bonus = [0, 20, 30, 40, 50, 60, 70];
    /**0:前第几期开始返回本金, 1单笔最大投资比例,2:单次最大参与额度(单位1e18),3:最大预约期数,4:最大预约比例,5:亏损保障池补偿比例, 6:抢购时间(分钟)*/
    uint16[] public defaultParams = [2, 10, 100, 5, 500, 600, 10];
    /**公共参数：0:静态奖比例，1:代币分红池比例，2:失败前三期返还本金比例，3:提现手续费比例 ,4:奖励锁定需点灯解锁比例，5:收益平级奖比例，6:亏损返优先积分比例，7:失败返优先积分比例
    8:冷区时间, 9:启用杠杆等级*/
    uint16[] public crowdParams = [110, 30, 700, 10, 200, 100, 3000, 1000, 3, 3];
