...
import "./dividend-paying/DividendPayingToken.sol";
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() DividendPayingToken("Dividend_Tracker", "Dividend_Tracker", 18) {
        claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal pure override {
        require(false, "MCC_Dividend_Tracker: No transfers allowed");
    }
    ...
    function setTokenBalanceForDividends(uint256 newValue) external onlyOwner {
        require(minimumTokenBalanceForDividends != newValue, "MCC_Dividend_Tracker: minimumTokenBalanceForDividends already the value of 'newValue'.");
        minimumTokenBalanceForDividends = newValue;
    }
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "MCC_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "MCC_Dividend_Tracker: Cannot update claimWait to same value");
