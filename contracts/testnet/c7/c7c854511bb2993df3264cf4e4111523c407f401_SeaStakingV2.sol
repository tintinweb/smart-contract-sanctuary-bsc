...
contract SeaStakingV2 is OwnableUpgradeable {
    ...
    function initEpochInfo(uint32 _epochLength, uint _firstEpochNumber, uint32 _firstEpochBlock) external onlyOwner() {
