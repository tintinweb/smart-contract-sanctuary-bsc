...
contract MetaMateFashionItemERC721 is
    ERC721Upgradeable,
    ...
    IMetaMateERC721
{
    ...
    uint256 constant public RARE_RARITY = 2;
    uint256 constant public LUXURY_RARITY = 3;
    uint256 constant public PRESTIGE_RARITY = 4;
    uint256 constant public LIMITED_RARITY = 5;
    ...
    modifier onlyGenesisMinter() {
        require(
            ...
            "MetaMateFashionItem: caller is not genesis minter"
        );
        _;
    }
        ...
        returns (address)
    {
        require(
            ...
            "MetaMateFashionItem: invalid token id"
        );
