...
contract IDO is Ownable {
    ...
    constructor(
        address _tokenAddress, uint256 _startTime, uint256 _cliff,
        uint256 _totalPeriods, uint256 _timePerPeriod, uint256 _firstReturn,
        uint256 _periodReturn, uint256 _exchangeRate,
        address[] memory accounts, uint256[] memory packages
    ) {
        tokenAddress = _tokenAddress;
        MATK = Token(tokenAddress);
