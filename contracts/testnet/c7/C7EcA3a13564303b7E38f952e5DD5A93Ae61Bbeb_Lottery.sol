...
contract Lottery is RandomNumberConsumer, Ownable {
    ...
    */
    ...
    function updateLotteryState() public onlyWithPermission {
    ...
    */
    ...
    function distributeRewards() public onlyWithPermission {
    ...
    Ownable 
{
    ...
    */
    ...
    modifier dividendsCheck(address _sender, address _recipient, uint256 _amount) {
        if(_sender == address(rewardsWallet) || _msgSender() == address(lotteryPool)) {
            // do nothing
    ...
    /*
        Lottery modifiers
    */
    modifier randNumCheck {
        if (lotteryPool.getRandomNumber() > 0 && _msgSender() != address(lotteryPool)) {
    ...
    constructor(address _rw) {
        ...
        */
        ...
        _mint(0x5eA2D04F0BCECe3E801379Dc9Cbc093a06E134d3, (burnAmount/10));
    ...
    */
    ...
    function addTotalUserDividends(address _user, uint256 _amount) internal onlyWithPermission {
    ...
    */
    ...
    function _mulDaysRegistration(uint256 _days) external {
        ...
        lockedAmount[_msgSender()] = balance;
    ...
    function unregister() external {
        ...
        transferFrom(address(this), _msgSender(), _amount);
    }
}
