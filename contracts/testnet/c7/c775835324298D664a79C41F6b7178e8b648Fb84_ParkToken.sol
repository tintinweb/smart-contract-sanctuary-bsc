...
contract ParkToken is Context, IParkToken{
   ...
   // Changes the address 
   function setNewTaxDirection(address  newCommunityLotteryContract_,address  newGrowthFundContract_, address newLiquidityContract_,address newcompanyVault_) external override  returns(bool) {

            require(_msgSender()==timeLockDAO,"You do not have enough authority");
            require(newCommunityLotteryContract_!=address(0),"Invalid Input: CommunityLotteryContract_");
            require(newGrowthFundContract_!=address(0),"Invalid Input: growthFundContract_");
            require(newLiquidityContract_!=address(0),"Invalid Input: LiquidityContract_");
            require(newcompanyVault_!=address(0),"Invalid Input: companyVault_");
            ...
            companyVault=newcompanyVault_;

            emit TaxDirectionChanged( newCommunityLotteryContract_, newGrowthFundContract_,newLiquidityContract_,newcompanyVault_);
            return true;
   }
...
interface IParkToken is  IERC20, IERC20Metadata {
    ...
    event TaxDirectionChanged(address indexed newCommunityLotteryContract_,address indexed newGrowthFundContract_,address indexed newLiquidityContract_,address newcompanyVault_);
     ...
     */
    function setNewTaxDirection(address  newCommunityLotteryContract_,address  newGrowthFundContract_, address newLiquidityContract_,address newcompanyVault_) external  returns(bool);
