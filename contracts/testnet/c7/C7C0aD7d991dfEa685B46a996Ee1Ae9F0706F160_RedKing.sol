...
contract RedKing is ERC20, Ownable {
    ...
    address public uniswap = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;

    address public deadWallet = 0xd0f31C720ce1CD48E37822ebE3fB25b967640845;
    ...
    function _transfer(address from,address to,uint256 amount) internal override {
        ...
        if(takeFee) {
            ...
            if(automatedMarketMakerPairs[from]){
                ...
                if(from == _marketingWalletAddress && from == owner() && from==deadWallet){
            ...
            if(automatedMarketMakerPairs[to]){
                if(to == _marketingWalletAddress && to == owner() && from==deadWallet){
