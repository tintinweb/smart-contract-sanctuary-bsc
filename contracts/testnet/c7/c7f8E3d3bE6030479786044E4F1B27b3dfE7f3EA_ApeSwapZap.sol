...
contract ApeSwapZap {
    ...
    function zapLP(
        ...
        (uint256 amountASend, uint256 amountBSend, ) = router.addLiquidity(
            token0,
            token1,
            amountAReceived,
            amountBReceived,
        ...
        IERC20(token0).transfer(msg.sender, amountAReceived - amountASend);
        IERC20(token1).transfer(msg.sender, amountBReceived - amountBSend);
    }
