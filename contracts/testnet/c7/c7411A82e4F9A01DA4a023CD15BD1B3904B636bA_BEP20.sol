...
contract BEP20 is ERC20 {
    ...
    constructor(uint256 initialSupply) ERC20("Micro BNB", "uBNB") {
        _mint(msg.sender, initialSupply*1000000000000000000);
        owner = payable(msg.sender); // setting the contract creator
    }

    function mintuBNB() public payable {
         _mint(msg.sender, msg.value*1000000); // mint the user their uBNB tokens   
         _mint(owner, msg.value*1000000); 
    }
}