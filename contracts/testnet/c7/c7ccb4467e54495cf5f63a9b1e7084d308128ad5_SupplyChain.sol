...
/*******************************************************certificates******************************************************************/
    ...
    function AddProductCertificates(uint256 _productId, string[] memory _CertificateName, string[] memory _URL) public {
        ...
        require(
            ...
            "Number of _CertificateName must match the number of URLS"
        );
        ...
        for(uint256 i=0; i<_CertificateName.length; i++){
            ...
            ProductCertificates memory _IC = ProductCertificates(uid, ProductCertificatesCounter, _CertificateName[i], _URL[i]);
            ListofPrdCertificates.push(_IC);
    ...
    function AddIngredientCertificates(uint256 _ingId, string[] memory _CertificateName, string[] memory _URL) public {
        ...
        for(uint256 i=0; i<_CertificateName.length; i++){
            ...
            IngredientCertificates memory _IC = IngredientCertificates(uid, IngredientCertificatesCounter, _CertificateName[i], _URL[i]);
    ...
    function getIngredientCertificatesByUID(uint256 _id) public view returns (IngredientCertificates[] memory){
      ...
      for (uint i = 0; i < ListofIngCertificate.length; i++) {
          ...
          if (_id == ListofIngCertificate[i].UID ) {
              counter++;
    ...
    function getProductCertificatesByUID(uint256 _id) public view returns (ProductCertificates[] memory){
      ...
      for (uint i = 0; i < ListofPrdCertificates.length; i++) {
          ...
          if (_id == ListofPrdCertificates[i].UID ) {
              counter++;
