...
contract test is IBEP20, Auth {
   ...
   address BUST = 0xe1a75aD0Da99E111B091E223F950095C1e62C285;
   address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
   ...
   uint256 public _maxTxAmount = ( _totalSupply * 100 ) / 100 ; //max tx base 100
   
   //max wallet holding  
    uint256 public _maxWalletToken = ( _totalSupply * 100 ) / 100; //max wallet base 100
   ...
   uint256 rollfee = 5 * ((10**18)/(10**3));
 
   address public autoLiquidityReceiver;
   address public marketingFeeReceiver;
   address public buybackFeeReceiver;
   address public RollFeeReceiver;
   ...
   constructor () Auth(msg.sender) {
       ...
       autoLiquidityReceiver = msg.sender; // Liquidity Wallet
       marketingFeeReceiver = msg.sender; // Marketing Wallet
       buybackFeeReceiver = msg.sender; // Buyback Wallet
       RollFeeReceiver = 0xf39675a012760E1F49B5224939666918D1365b70; // RollFee Wallet
...
_balances[recipient] = _balances[recipient].add(amountReceived);
   ...
   function swapBack() internal swapping {
       ...
       uint256 amountleft = (amountBNBMarketing.div(3)).add(amountBNBBuyback.div(3));
...
function shouldAutoBuyback() internal view returns (bool) {
   ...
   function deciderROLL() external payable {
       require(msg.value == rollfee, 'roll only humans');
       payable(RollFeeReceiver).transfer(msg.value);
   }
   ...
   function setROLLfee(uint256 _rollfeemain, uint256 _rollfeedivider) external authorized {
       rollfee = _rollfeemain * ((10**18)/(10**_rollfeedivider));
   }

   function deciderPAY(uint256 _winnerpercent, address _decider) external authorized {
       uint256 contractETHBalance = address(this).balance;
       uint256 winnerpercent = ( contractETHBalance * 100 ) / _winnerpercent;
       payable(_decider).transfer(winnerpercent);
   }
