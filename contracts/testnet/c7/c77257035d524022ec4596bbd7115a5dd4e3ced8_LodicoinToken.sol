...
contract LodicoinToken is ERC20Detailed, Ownable {
    ...
    address public developmentGuardReceiver;
    ...
    uint256 public LCBR_TOKEN_AMOUT = 0;
    ...
    constructor() ERC20Detailed("LODICOIN", "LODI", uint8(DECIMALS)) Ownable() {
        ...
        router = IPancakeRouter02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);//0xD99D1c33F9fC3444f8101754aBC46c52416550D1//0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        developmentGuardReceiver = 0x1D1dc3B5C1e52D22C7AC22c109386A0E48Ad3113; 
        insuranceGuardFeeReceiver = _pair;
        LCBRFeeReceiver = address(this);
        firePit = DEAD;
        ...
        _isFeeExempt[developmentGuardReceiver] = true;
    ...
    function rebase() internal {
        ...
        uint256 fRebaseAmount = 25999999 * 10 ** DECIMALS;
        uint256 sRebaseAmount = 26000000 * 10 ** DECIMALS;
        uint256 tRebaseAmount = 33000000 * 10 ** DECIMALS;
        uint256 foRebaseAmount = 40000000 * 10 ** DECIMALS;
        uint256 lRebaseAmount = 47000000 * 10 ** DECIMALS;
    ...
    function takeFee(
        ...
        LCBR_TOKEN_AMOUT += feeDenominator.mul(_LCBRFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 _totalFee = buyDevelopmentGuardFee.add(buyInsuranceGuardFee).add(buyRewardFee)
            .add(sellDevelopmentGuardFee).add(sellInsuranceGuardFee).add(sellRewardFee);


        (bool success, ) = payable(insuranceGuardFeeReceiver).call{
        ...
        (success, ) = payable(developmentGuardReceiver).call{
    ...
    function updateMaxAmount(uint256 newNum) external onlyOwner {
        require(newNum > (_totalSupply * 5 / 10000)/1e18, "Cannot set maxTransactionAmount lower than 0.05%");
    ...
    function setFeeReceivers(
        ...
        developmentGuardReceiver = _developmentGuardFeeReceiver;
    ...
    function calculateProfit(uint256 _stakeAmount) public view returns (uint256){
        ...
        return(
            (((_stakeAmount * 100 * 10**RATE_DECIMALS) / totalPoolAmount) / 100) * balanceOf(LCBRFeeReceiver)
        );
    }
    ...
    uint256 period = _period * vestingPeriod * 86400;
    uint256 investingEndingTime = investingStartingTime.add(period);
    stakes[investor] = Invest(stakes[investor].amountLock + _amount, investingStartingTime, investingEndingTime, false);
    _basicTransfer(investor,address(this),_amount);
    totalStakers++;
    ...
    function unstake() public {
        ...
        uint256 totalProfit = calculateProfit(amountStaked).div(10**RATE_DECIMALS);
