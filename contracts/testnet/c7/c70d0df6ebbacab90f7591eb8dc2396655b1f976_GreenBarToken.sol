...
Green Bar Finance is transforming DeFi with the Green Bar Autostaking Protocol (GAP) that delivers the industry’s highest forever APY, 
rebasing rewards every 10 minutes, and a simple buy-hold-earn system that grows your portfolio in your wallet, fast.
...
If the user invests $1000 worth $GBT for a period of 1 year at 0.018% compounding every 10 minutes. He will have $12,846,157.26 GBT after his investment maturity
...
contract GreenBarToken is BEP20Detailed, Ownable {
    ...
    string public _name = "GREEN BAR";
    string public _symbol = "GBT";
    ...
    uint256 public greenbarInsuranceFundFee = 10;
    ...
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(greenbarInsuranceFundFee).add(
            firePitFee
        );
    ...
    address public greenbarInsuranceFundReceiver;
    ...
    constructor() BEP20Detailed("GREEN BAR", "GBT", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x804aF6CeE286fc34Bc1ecB8D7568A0507EEEB150;
        treasuryReceiver = 0xCAb33E0592d1b09FF70505908450Fd5F3dDf73c4; 
        greenbarInsuranceFundReceiver = 0xd1597b3A03C44C7c1bba17Ba216d6Dc68aD0468F;
        firePit = 0x3a24D33A299E1Bb7CdAbd82f3C1bC413ad3D4249;
    ...
    function takeFee(
        ...
        uint256 _greenbarInsuranceFundFee = greenbarInsuranceFundFee;
        ...
        if (recipient == pair) {
            ...
            _greenbarInsuranceFundFee = greenbarInsuranceFundFee.add(sellFees);
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(greenbarInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(greenbarInsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(greenbarInsuranceFundReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(greenbarInsuranceFundFee).div(
                treasuryFee.add(greenbarInsuranceFundFee)
            ),
            gas: 30000
        }("");
   ...
   antiBotEnabled = _enable;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no GBT token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _greenbarInsuranceFundReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        greenbarInsuranceFundReceiver = _greenbarInsuranceFundReceiver;
        firePit = _firePit;
    }
