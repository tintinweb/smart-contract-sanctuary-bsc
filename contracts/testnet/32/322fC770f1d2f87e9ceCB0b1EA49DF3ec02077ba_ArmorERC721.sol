    ...
    VRFConsumerBaseV2Upgradeable
{
    ...
    mapping(uint256 => SharedStructs.ItemInfo) public armoursInfoMap;
    ...
    function initialize(
        ...
        __ERC721_init("ArmorERC721", "ARMOR");
    ...
    function randomMint(
        ...
        armoursInfoMap[_tokenId].tier = _armorTierConfig.armorTierId;
        armoursInfoMap[_tokenId].rarityId = _armorTierConfig.armorRarityId;
        armoursInfoMap[_tokenId].rarityName = _armorTierConfig.armorRarityName;
        armoursInfoMap[_tokenId].collectionId = _armorTierConfig.collectionId;
        armoursInfoMap[_tokenId].collectionName = _armorTierConfig
            .collectionName;
        armoursInfoMap[_tokenId].firstOwner = to;
