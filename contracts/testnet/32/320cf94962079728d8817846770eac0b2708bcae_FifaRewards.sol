...
interface IDividendDistributor {
    ...
    event Deposit(address distributor, uint256 amount);
}
...
contract FifaRewards is AllTheFees {
    ...
    address public rewardAddress1 = 0xDAcbdeCc2992a63390d108e8507B98c7E2B5584a;
    ...
    address public rewardAddress2 = 0x8a9424745056Eb399FD19a0EC26A14316684e274;
    ...
    address public rewardAddress3 = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    ...
    address public rewardAddress4 = 0xF9f93cF501BFaDB6494589Cb4b4C15dE49E85D0e;
    ...
    function getRewardsForUser(address holder) external view returns (uint256, uint256, uint256, uint256){
        uint256 reward1 = dividendDistributor1.getUnpaidEarnings(holder);
        uint256 reward2 = dividendDistributor2.getUnpaidEarnings(holder);
        uint256 reward3 = dividendDistributor3.getUnpaidEarnings(holder);
        uint256 reward4 = dividendDistributor4.getUnpaidEarnings(holder);
