...
contract UpgradeablePet is Initializable {
  ...
  function initialize(address petOwner, address feeAddress, uint32 defaultFee) public initializer {
    _petOwner = petOwner;
  ...
  function tip(
        ...
        // compute fee amount
        uint256 fee = (tipAmount * _defaultFee) / 10000;
        ...
        IERC20(currency).transferFrom(donator, _feeAddress, fee);
