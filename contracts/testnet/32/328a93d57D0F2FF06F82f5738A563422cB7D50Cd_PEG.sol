...
contract PEG is Context, Ownable, IBEP20, BEP20Detailed {
    ...
    address payable public marketingaddress =
        payable(0x7980Af1494b801895C45B84533596F3F58df152F);
    ...
    function allowance(
        address towner, //@audit typo => change towner to owner
        address spender
    ...
    function setBuyMarketingFeePercent(
        uint256 updatedBuyMarketingFee
    ) external onlyOwner {
        require(updatedBuyMarketingFee <= 6, "Buy fee should be less than 6%");
        buyMarketingFee = updatedBuyMarketingFee;
    }

    function setSellMarketingFeePercent(
        uint256 updatedSellMarketingFee
    ) external onlyOwner {
        require(
            updatedSellMarketingFee <= 6,
            "Sell fee should be less than 6%"
        );
    ...
    function changeNumTokensSellToFee(
        ...
        require(
            _numTokensSellToFee >= 50000 * 10 ** 18 &&
                _numTokensSellToFee <= 10000000 * 10 ** 18,
            "Threshold must be set within 50,000 to 10,000,000 tokens"
        );
