...
interface LogLib  {
    function LogStr (string memory msg1,string memory num1,uint256 num2 ) external;
    function LogNum (string memory msg1,uint256 num1,uint256 num2 )  external ;
    function LogAddr (address target_addr,string memory msg1,uint256 num1,uint256 num2 )  external;
