...
pragma solidity ^0.8.13;
 ...
 contract THBNFT is ERC721Enumerable, Ownable   {
  using Strings for uint256;
  IBEP20 public staking;


  bool public paused = false;
  mapping(address => uint256) public addressMintedBalance;
  uint256 public maxsupply=10000;
  uint256 public MinitngPrice=4000000000000000000000;
  ...
  constructor(
    ...
    function checkBPEnergy(address add) public view returns(uint256){
        return staking.balances(add);
    }

    uint[] public mintids;

  function mint(uint256 _count) public {
      uint256 BRAWLPOINT=staking.balances(msg.sender);
      ...
      require(_count<=MaxLimitPerTransaction,"Max Limit Per Transaction Exceed!");
       ...
       for (uint i = 1; i <= _count; i++) {
        ...
        mintids.push(mintIndex);
        
}
        mintedNFTs[msg.sender] += _count;
       staking.redeembalance(MinitngPrice*_count);
...
//   staking : 0x8D67feF3d7697182EF15880089fF03A073073320
