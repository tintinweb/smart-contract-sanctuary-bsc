...
contract WIZEToken is ERC20, Ownable {
    ...
    uint256 public buyTotalFees = buyDividendRewardsFee + buytreasuryFee  + buyTeamFee + buyLiquidityFee + buyBurnFee + buyMarketingFee;
    // sell fees
    ...
    uint256 public sellTotalFees = sellDividendRewardsFee +selltreasuryFee + sellTeamFee + sellLiquidityFee + sellBurnFee + sellMarketingFee;
    ...
    constructor(address _newOwner) ERC20("Wizefrog", "WIZE") {
        ...
        teamWallet = 0xfadDD1CFBd4D323e166cB63035571286420F9E49;
        treasurywallet = 0x7b09Bf93Fc98056dCdD90e4b27454B04bAb8CF64;
        marketingWallet = 0x9b91B9f48805db9C586eD604Aaa5752EBdee0A59;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to]) {
                ...
                if (sellBurnFee > 0) {
                    burnAmount = amount.div(100).div(sellTotalFees).mul(sellBurnFee);
                }
            } else {
                fees = amount.div(100).mul(buyTotalFees);
                if (buyBurnFee > 0) {
                    burnAmount = amount.div(100).div(buyTotalFees).mul(buyBurnFee);
                }
            }
