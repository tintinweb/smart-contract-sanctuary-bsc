...
contract SANFT is ERC721Full, Governance {
    // for minters
    mapping(address => bool) public _minters;

    uint256 public maxSupply;

    constructor(string memory name,string memory symbol, uint256 _maxSupply) public ERC721Full(name,symbol) {
        require((_maxSupply > 0) , "Operations: Wrong max supply");
     ...
     */
    function safeMint(address to, uint256 tokenId, string memory _tokenURI) public returns (bool) {
