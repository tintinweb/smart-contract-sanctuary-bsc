...
contract SC2 is Ownable {
    ...
    address public _SC1ADDRESS = 0x0000000000000000000000000000000000000000;
    ...
    /////////////////////////stake eABCD, type 1=A, 2=B, 3=C, 4=D, 5=E//////////////////
    ...
    /////////////////////////stake BUSD, type 1=A, 2=B, 3=C, 4=D, 5=E//////////////////
    ...
    function sellOrderForEABCD(uint256 amount) public {
        ...
        uint256 BUSD_For_eABCD = amount * tokenPriceWithOracle * BUSD_decimal * (100 * 1000 - feeForSeller) / 100 / 1000 / eABCD_decimal;
