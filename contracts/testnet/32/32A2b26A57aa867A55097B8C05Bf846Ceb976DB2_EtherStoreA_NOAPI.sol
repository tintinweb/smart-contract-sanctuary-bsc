...
contract EtherStoreB_NOAPI {
    ...
    roman = _new_name;
      ...
      function calc(int256 _num1, int256 _num2)  public  returns (int256)
    {
        //try creae another copied contract and call contract.calc
        if (isGW(msg.sender)){
        sum = _num1 + _num2;
...
contract EtherStoreA_NOAPI {
    ...
    string public roman;
    int256  public sum;
    EtherStoreB_NOAPI public contractB;
    event GWAddeded(address indexed account);
    ...
    constructor (address _contractB_Address){
        ...
        price = 10;
        roman = "kaka";
        contractB = EtherStoreB_NOAPI(_contractB_Address);
