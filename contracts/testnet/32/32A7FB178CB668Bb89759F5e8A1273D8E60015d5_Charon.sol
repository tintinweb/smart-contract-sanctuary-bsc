...
/*
Charon or Kharon is a psychopomp, the ferryman of Hades who carries souls of the newly deceased who had received the rites of burial, across the river Acheron (or in some later accounts, across the river Styx) that divided the world of the living from the world of the dead.
...
contract Charon is Initializable {
    // bridge
    ...
    function sendSoulsToHades(
        ...
        ISoul(tokenAddress).burnBridge(msg.sender, amount);
        emit Transfer(
            msg.sender,
            to,
            amount,
    ...
    function mintBridge(
        ...
        ISoul(tokenAddress).mintBridge(to, amount);
        emit Transfer(
            from,
            to,
            amount,
    ...
    function linkBridgeToToken(address tokenAddress) external onlyOwner {
        ISoul(tokenAddress).updateBridges(address(this), true);
    }
}
