...
contract namehere is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0000000000000000000000000000000000000); // Marketing Address
    address payable public charityAddress = payable(0x0000000000000000000000000000000000000); // Charity/Dev Address
    ...
    uint256 private _tTotal = 44130000 * 10**18; // 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    address payable private developerWallet;
    uint256 private _tFeeTotal;

    string private _name = "namehere";
    string private _symbol = "namehere";
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
         require(welcome,"Trading not open yet");
