...
contract GMT is Context, IERC20, Ownable {
    ...
    address public develop1Address = address(0x266C2A923682C721Eaff00B2a9e708D70DFe6761);
    address public develop2Address = address(0x5124cf64d044EbcCF1Ba25b754F84da3503ea39C);
    address public develop3Address = address(0x21C12467498769CF83cd575E417d6D3CE76b6e4B);
    address public capitalizationAddress = address(0x75A981b14aD5fF82fb6816Ea415A60260A007ea5);
    address public marketingAddress = address(0x161146730Cc4d6d2297A00A6E825F3AE404a3b3d);
    // address public lpRewardAddress = address(0xbf242Bf83C6Bee3161D00fbEA5baD72723A3BdA6);
    address public burnAddress = address(0xf759A52391c3f7d825656Bf7100575818102286E);
    address public platformAddress = address(0x0478d2Dc9b131DCdA7AF184350477531c02dCBA5);
    ...
    constructor() {
        ...
        // _balances[address(0xd0FC877497810cf182BDaCaB109d1A3deAe6eB55)] = _totalSupply;
