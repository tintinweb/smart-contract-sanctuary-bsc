...
// File contracts/CraftCallHelper.sol

pragma solidity ^0.8.0;

contract CraftCallHelper is AccessControl {
    ...
    constructor(address admin) {
        require(admin != address(0), "admin address could not be zero");
