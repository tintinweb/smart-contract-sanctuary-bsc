...
contract Update is IBEP20, Ownable {
    ...
    TierTaxes public _buyTaxes = TierTaxes({first: 6, second: 5, third: 4});

    TierTaxes public _sellTaxes = TierTaxes({first: 7, second: 6, third: 5});
    ...
    TaxWallets public _taxWallet =
        TaxWallets({
            dev: 0x71D3a08D3B8aD9efA6cE36c38e3c957222423e92,
            events: 0xd2E2f9d70166fd00EE3e218E14DADEB1331d82e6,
            marketing: 0xbc8d457A5c087D9bc4F661d15F7f0b431b6515b9
        });
