...
contract Token {
    ...
    constructor() {
        name = "S*Quiz Game"; // Sets the name of the token, i.e Ether
        symbol = "SQUIZ"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 6000000000 * 1e18; // Holds an initial supply of coins
