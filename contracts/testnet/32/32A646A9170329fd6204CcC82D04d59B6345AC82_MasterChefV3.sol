...
contract MasterChefV3 is Ownable {
    ...
    mapping(uint256 => mapping(address => uint256)) public stakeInfo;
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 cakeReward = cakePerBlock.mul(pool.allocPoint).div(totalAllocPoint);
        cake.mint(devaddr, cakeReward.div(10));
        // cake.mint(address(syrup), cakeReward);
        stakeInfo[0][address(this)] += cakeReward;
    ...
    function enterStaking(uint256 _amount) public {
        ...
        stakeInfo[0][msg.sender] += _amount;
    ...
    function safeCakeTransfer(address _to, uint256 _amount) internal onlyOwner {
