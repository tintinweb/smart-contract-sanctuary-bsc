...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   function Swap_payment_to_PYO() public {
       amountx = ee_deelian[msg.sender]/deelian_price;
       token.transferFrom(address(this), msg.sender, amountx);
       ee_deelian[msg.sender] = 0;
...
function Buy_Deelian(uint amount) public {
        
         amountz = amount * deelian_price;
         require(token.balanceOf(msg.sender) >= amountz, "Not Enough Liquidity For this SWAP");
         token.transferFrom(msg.sender, address(this), amountz);
