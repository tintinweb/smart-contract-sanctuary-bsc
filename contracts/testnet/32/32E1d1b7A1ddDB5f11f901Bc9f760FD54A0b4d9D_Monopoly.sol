...
contract Monopoly is ERC1155, Multicall {
  ...
  function checkBalance(uint256 gameId, address account) public view returns (uint256) {
  ...
  function transferProperty(
    ...
    uint256 tokenId = gameId * 100 + property;
  ...
  function dataOf(uint256 gameId, uint8 property) public view returns (Property memory) {
    return _properties[gameId][property];
  }

  function ownerOf(uint256 gameId, uint8 property) public view returns (address) {
    address owner = _owners[gameId * 100 + property];
