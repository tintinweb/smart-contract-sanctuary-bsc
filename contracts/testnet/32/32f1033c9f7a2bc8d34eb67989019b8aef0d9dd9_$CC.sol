...
_decimals = 18;
taxFee = 10;
_tokenvalue = 6 * 10**7* 10 ** _decimals;
...
function checkwhale(uint256 amount) public view returns (uint256) {


uint256 maxTrx = _tokenvalue * 1/100;
...
uint256 userBalance = _balances[recipient];
uint256 maxTrx = _tokenvalue * 1/100;

require(userBalance <= maxTrx, "User Can Hold 1 Percent of total supply!");

require(amount <= maxTrx, "Maximum Transfer Limit Exceeded!");
