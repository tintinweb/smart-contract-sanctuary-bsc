...
contract SuperCat is Context, Ownable{
    ...
    constructor() public {
        ...
        SuperCatVault_addr = 0x8E88c1543a8F4931484366136f4Fda9952F27Ca0;
    ...
    function bindNFT(uint256 usdt_amount,uint256 cat_amount,uint256 _nftId,address _nft_contract) public{
        ...
        if(lp_pool[msg.sender].usdt >= min_lp && lp_pool[msg.sender].receive_time==0){
    ...
    function swap(uint256 _amount,bool _Is) public{
        ...
        if(_Is){
            ...
            path[0] = catToken;
            path[1] = usdtToken;
            Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(_amount,0,path,address(this),block.timestamp+60);  
    ...
    function nftBuy(address contractAddress)  public payable{
        ...
        // uint256 nft_id = IERC721(contractAddress).officalMint(msg.sender);
        // if(nft[_index].pay_type!=1){
        //     nft_pledge[contractAddress][nft_id].is_active = true;
        // }
    }
