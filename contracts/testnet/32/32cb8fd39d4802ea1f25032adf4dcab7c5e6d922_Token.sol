...
contract TaxOptions is Ownable {
    ...
    uint internal previousBurnTax = _burnTax;
    uint256 public _TeamTax = 20;
    uint internal previousTeamTax = _TeamTax;
    uint256 public _liquidityTax = 20;
    uint internal previousLiquidityTax = _liquidityTax;
    uint256 public _rAndDTax = 20;
    uint internal previousRAndDTax = _rAndDTax;
    uint256 public _marketingTax = 20;
    uint internal previousMarketingTax = _marketingTax;
    ...
    /// @dev `remove` {taxes} using this function. Used when the excluded addresses makes a transaction.
    ...
    /// @dev `restore` {taxes} using this function. Usually used in tandem with remove taxes function.
    ...
    Pausable
{
    ...
    constructor(
        ...
        setMaxTxLimit(_totalSupply.div(2));
