...
contract DecCas is Ownable {
    ...
    function play_bet(address token, uint[] memory numbers, uint[] memory amounts) public {
        ...
        require(house_balances[token].mul(30).div(1000) >= bet_total, "0.3% house balance lower than total bet amount. Please decrease bet or donate to house");
        ...
        plays.push(PlayInfo({block_number: block.number + 3, play_numbers: numbers, play_amounts: amounts, result: 0, earnings: 0, 
