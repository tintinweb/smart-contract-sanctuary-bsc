    ...
    DecimalERC20
{
    ...
    function setInflationMonitor(IInflationMonitor _inflationMonitor)
        external
        onlyOwner
    {
    ...
    function balanceOf(IERC20 _quoteToken)
        internal
        view
...
interface IAmm {
    ...
    function migrateLiquidity(
        ...
        Decimal.decimal calldata _priceLimitRatio
    ) external;
...
interface IInflationMonitor {
    ...
    function appendMintedTokenHistory(Decimal.decimal calldata _amount)
        external;
}
...
abstract contract DecimalERC20 {
        ...
        returns (Decimal.decimal memory)
    {
        ...
        return
            Decimal.decimal(_number.mul(10**(uint256(18).sub(tokenDecimals))));
    }
...
contract PerpFiOwnableUpgrade is ContextUpgradeSafe {
    ...
    function setOwner(address newOwner) public onlyOwner {
        ...
        require(
            newOwner != _candidate,
            "PerpFiOwnableUpgrade: same as candidate"
        );
        _candidate = newOwner;
    }
    ...
    function updateOwner() public {
        ...
        require(
            ...
            "PerpFiOwnableUpgrade: not the new owner"
        );
