...
IUniswapV2Router02 public router;
 ...
 BUSD = IERC20(_BUSD);
    ...
    modifier onlyOwner() {
        require(msg.sender == IUSDP(USDP).getOwner(), 'Only Owner');
        _;
    }
    ...
    function _swapToBUSD(address token) internal {
        ...
        if (token == address(BUSD) || balance <= 1000) {
            return;
        }
