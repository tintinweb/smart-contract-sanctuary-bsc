...
contract BUSDFury {
	...
	uint constant public			TIME_STEP						= 10;
	// uint constant public			INVEST_MIN_AMOUNT				= 10 ether;				// 10 BUSD
	uint constant public			INVEST_MIN_AMOUNT				= 0.01 ether;				// 10 BUSD
	uint[] public					REFERRAL_PERCENTS				= [70, 30, 20, 10, 5];	// 7% 3% 2% 1% 0.5%
	uint constant public			PROJECT_FEE						= 90;					// project fee 5% of deposit
	uint constant public			DEV_FEE							= 10;					// dev fee 10% of deposit
