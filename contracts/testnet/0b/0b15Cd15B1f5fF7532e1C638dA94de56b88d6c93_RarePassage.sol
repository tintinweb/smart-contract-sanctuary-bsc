    ...
    Ownable
{
    ...
    // mint NFT
    IERC721 public UnCommonPassage;
    ...
    constructor(address xKeys_, address _rewardsToken) {
    ...
    function mint(uint256[] calldata uncommonTokenIds) external {
        require(address(UnCommonPassage) != address(0), "Uncommon Not Paired");

        uint256 len = uncommonTokenIds.length;
