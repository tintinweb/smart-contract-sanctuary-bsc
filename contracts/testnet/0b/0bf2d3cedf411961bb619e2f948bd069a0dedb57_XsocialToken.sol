...
contract XsocialToken is IBEP20, ReentrancyGuard, Context, Ownable {
    ...
    string private constant _name         = "X Social Networks";
    string private constant _symbol       = "XSN";
	uint8 private constant _decimals      = 9;
	uint256 private constant _totalSupply = 10 * 10**6 * 10**_decimals;
