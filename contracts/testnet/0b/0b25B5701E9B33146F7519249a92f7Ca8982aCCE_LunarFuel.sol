...
contract LunarFuel is IBEP20, Auth {
    using SafeMath for uint256;

    address BUSD = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; 
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x1cB2901ec5aaa58fcFbc159f79A5df418f628F90;

    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;

    // Name and symbol
    string constant _name = "LunarFuel";
    string constant _symbol = "LFUEL";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 1000000000000 * (10 ** _decimals); // 1 trillion

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 100 / 10000; // 1% (10,000,000,000)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (10,000,000,000)
    uint256 public _maxWalletToken = _totalSupply * 200 / 10000; // 2% (20,000,000,000)
    ...
    uint256 public totalFeeBuy = liquidityFeeBuy + buybackFeeBuy + reflectionFeeBuy + marketingFeeBuy + devFeeBuy;
    ...
    uint256 public totalFeeSell = liquidityFeeSell + buybackFeeSell + reflectionFeeSell + marketingFeeSell+ devFeeSell;
    ...
    uint256 public swapThreshold = _totalSupply * 40 / 10000; // 0.25% (2,500,000,000)
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xE5673C02a39b0776815dc0Db49b12335662d73F7;
