...
contract MetafameSaleMTv19_0819 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable, Status{
    ...
    function makeOver( 
        ...
        require(payAmount >= makeOverPrice, "Insufficient pay amount");
    ...
    function refresh( 
        ...
        require(payAmount >= refreshPrice, "Insufficient pay amount");
    ...
    // function payBUSD(uint256 price) private {
    ...
    function payToken(uint256 price, uint256 method) private returns (uint256 finalPrice){
        ...
        if(method == 0){
            ...
            uint256 amountIn = getAmountsIn(price.div(10**18), path); 
