...
contract RiseBUSD is Context, Ownable {
    ...
    constructor(address dev, address part) {
            ...
            PercsKey[10] = DivPercs(20 days, 80, 300);
            PercsKey[20] = DivPercs(40 days, 85, 250);
            PercsKey[30] = DivPercs(60 days, 90, 200);
            PercsKey[40] = DivPercs(80 days, 105, 150);
            PercsKey[50] = DivPercs(100 days,125, 100);
            PercsKey[60] = DivPercs(100 days,150,  50);
    }
