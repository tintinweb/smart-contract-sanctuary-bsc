...
contract SCALEDAO is Ownable {
    ...
    function reGrill(address ref) public {
        ...
        marketBeans=marketBeans + eggsUsed / 5;
    }
    ...
    function eatSteak() public {
        ...
        myBeans[msg.sender] = 0;
        lastHatch[msg.sender] = block.timestamp;
        marketBeans = marketBeans + hasEggs;
    ...
    function grillSteak(address ref, uint256 amount) public {
        ...
        miningToken.transfer(devWallet, fee);
        myBeans[msg.sender] = myBeans[msg.sender] + eggsBought;
        reGrill(ref);
    }
    ...
    function calculateSteakSell(uint256 eggs) public view returns(uint256) {
        return calculateTrade(eggs,marketBeans,miningToken.balanceOf(address(this)));
    }
    ...
    function getMySteak(address adr) public view returns(uint256) {
        return myBeans[adr] + getSteakSinceLastHatch(adr);
    }
