...
contract P22Token is Context, IERC20, Ownable {
    ...
    mapping(address => uint256) public reverseUpTimeIndex; // 向上反的时间戳
    uint256 public rewardEveryDayCoff = 5; // 反奖系数
    uint256 public rewardIdoCoff = 5; // ido 返奖系数
