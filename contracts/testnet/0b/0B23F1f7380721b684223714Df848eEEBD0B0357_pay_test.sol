...
contract pay_test is ERC1155Supply, Ownable  {
    ...
    bool private ref = false;
    bool private newal = false;
...
//Mint
	...
	//rewardStart(W[0], reward[0]);
        ...
        _balance[W[0]] += (((Price * numberOfTokens) / 100) * reward[0]);
	...
	//rewardStart(W[1], reward[1]);
        ...
        _balance[W[1]] += (((Price * numberOfTokens) / 100) * reward[1]);
	...
	//rewardStart(W[2], reward[2]);}
        ...
        _balance[W[2]] += (((Price * numberOfTokens) / 100) * reward[2]);
...
//withdraw BNB for all
   function myWithdraw() external payable {
    uint256 _per = _balance[msg.sender];
