...
contract Web3ShotPassport is Ownable, ERC165, IERC721, IERC721Metadata {
    ...
    bytes32 public constant PASSPORT_HASH = keccak256("PassportUpdated(address signer,uint256 tokenId,uint256 nonce,uint32 level)");
    ...
    function getHash(address signer,uint256 tokenId,uint256 nonce,uint32 level) public view returns (bytes32) {
        return keccak256(abi.encode(PASSPORT_HASH, signer,tokenId, nonce, level));
    }
