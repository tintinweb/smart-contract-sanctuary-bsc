...
contract Ownable is Context {
    ...
    constructor () internal {
        _owner = address(0xC92cC6a8652F1A0639f2f42Cf531160D50aEb4F2);
...
contract Token is Context, IBEP20, Ownable {
	...
	address payable public charitywallet = 0x5cef1C669786492Ea67b6C986eE21Be469dCB4Ba;
    ...
    uint256 public _maxTxAmount = 100000000*1e18;
    uint256 private _numTokensSellToAddToLiquidity = 10*1e18;
    ...
    ///////////////////
    function includeInnFee(address account) internal  {
        _isExcludedFromFee[account] = false;
    }
    ...
    function _takeCharityFee(uint256 tAmount) private {
		...
		uint256 rCharityFee = tCharityFee.mul(_getRate());
			...
			_tTotal = _tTotal.sub(tCharityFee);
		_rTotal = _rTotal.sub(rCharityFee);
        ...
        emit Transfer(_msgSender(), burnAddress, tCharityFee);
    }
...
//new
        _rOwned[owner()] = _rOwned[owner()].sub(totalFeePerTx(tAmount).mul(currentRate));
    ...
    function _transferFromExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        uint256 rTransferAmount = rAmount.mul(currentRate);
...
//new
        ...
        _tOwned[owner()] = _tOwned[owner()].sub(totalFeePerTx(tAmount));
        _rOwned[owner()] = _rOwned[owner()].sub(totalFeePerTx(tAmount).mul(currentRate));
