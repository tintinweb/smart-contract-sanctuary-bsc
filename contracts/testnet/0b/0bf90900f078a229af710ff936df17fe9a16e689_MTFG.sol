...
contract Ownable is Context {
    ...
    constructor () {
        ...
        _owner = 0x6EA392d93De78c0bb202d6EA6F55cc5c1E5D5837;
...
contract MTFG is Context, IERC20, Ownable {
    ...
    string constant private _name = "MedTrust Financial Group";
    string constant private _symbol = "MTFG";
    ...
    address payable public teamAddress = payable(0xFc34C6865220166564fA98e828CEdA654f7F93B7);
    ...
    constructor() {
        ...
        address _uniswapV2RouterAddr=0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    ...
    function totalFees() internal view returns (uint256) {
        return _taxFee.add(_liquidityFee).add(_teamFee);
    }
