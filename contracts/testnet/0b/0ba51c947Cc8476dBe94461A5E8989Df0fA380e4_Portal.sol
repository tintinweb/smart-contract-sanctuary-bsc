...
contract Portal is Typecast, ContextUpgradeable, OwnableUpgradeable {
    ...
    function unsynthesizeWithSwap(
        ...
        unsynthesizeStates[_txID] = UnsynthesizeState.Unsynthesized;
        emit BurnCompleted(_txID, _curveV2, _amount, _token);
        ICurveProxy(_curveV2).tokenSwap(_synthParams, _finalSynthParams, _amount, false);
    }


    function unsynthesizeWithSwapUnwrap(  
        bytes32 _txID,
        address _token,
        uint256 _amount,
        address _curveV2,
        ...
        unsynthesizeStates[_txID] = UnsynthesizeState.Unsynthesized;
        emit BurnCompleted(_txID, _curveV2, _amount, _token);
        ICurveProxy(_curveV2).tokenSwapWithUnwrap(_synthParams, _amount);
    }
    /**
    ...
    function synthBatchMetaExchangeWithSwap(
        ...
        require(IWhitelist(whitelist).tokenList(_synthParams.path), "Token must be whitelisted");
        require(IWhitelist(whitelist).dexList(_synthParams.uniswapRouterV2), "Dex must be whitelisted");
        if (_metaParams.add != address(0)) {
            require(
                IWhitelist(whitelist).checkDestinationToken(_metaParams.remove, _metaParams.x),
                "Destination token must be whitelisted"
        ...
        bytes memory out = abi.encodeWithSelector(
            bytes4(
                keccak256(
                    bytes(
                        "transitSynthBatchMetaExchangeWithSwap((address,address,address,uint256,int128,int128,uint256,int128,uint256,address,address,address,address,uint256),(address,uint256,uint256),bytes32,(address,address,uint256),(address,address,uint256,address,address,uint256,address,address,address,uint256,uint256,address,uint256,address,address,uint256))"
                    )
                )
            ),
            _metaParams,
    ...
    function synthBatchMetaExchangeWithSwapWithUnwrap(
        ...
        bytes memory out = abi.encodeWithSelector(
            bytes4(
                keccak256(
                    bytes(
                        "transitSynthBatchMetaExchangeWithSwapUnwrap((address,address,address,uint256,int128,int128,uint256,int128,uint256,address,address,address,address,uint256),(address,uint256,uint256),bytes32,(address,address,uint256,address,address,uint256,address,address,address,uint256,uint256,address,uint256,address,address,uint256))"
                    )
                )
            ),
            _metaParams,
