...
abstract contract ReentrancyGuard {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isBlacklisted[sender],"Contract is blacklisted");
        ...
        if(ContractBlock&&!isPair[sender]&&!isWhitelist[sender])
        {
    ...
    function BlacklistContract(address _contract, bool yes) external authorized {
    require(isContract(_contract));
        isBlacklisted[_contract] = yes;
    }
