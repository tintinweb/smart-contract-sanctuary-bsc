...
constructor() public payable{}
    ...
    function associate() external payable whenNotClosed {
    ...
    function withdraw(uint _BNB) public{
        ...
        (msg.sender).transfer(_BNB *10**18);
    ...
    function close_Associates() public whenNotClosed returns (bool) {
    listing = true;
    emit Closed();
    return true;}

    function open_Associates() public whenOpen returns (bool) {
    listing = false;
    emit Open();
    return true;}
