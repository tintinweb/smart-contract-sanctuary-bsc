...
contract TestBol is Context, IERC20, Ownable {
    ...
    string internal constant _name = "Test Bol";
    string internal constant _symbol = "Tbol";
    ...
    address payable public _marketingWallet =
        payable(address(0x82044050866a9B083ed3fbceCb55Bc07aEF8d6FD)); // Marketing Wallet 
