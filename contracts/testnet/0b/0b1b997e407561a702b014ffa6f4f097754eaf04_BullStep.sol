...
╚═════╝  ╚═════╝ ╚══════╝╚══════╝╚══════╝   ╚═╝   ╚══════╝╚═╝          ╚═════╝ ╚═╝     ╚═╝     ╚═╝ ╚═════╝╚═╝╚═╝  ╚═╝╚══════╝
                        ...
                        ╚██████╗╚██████╔╝██║ ╚████║   ██║   ██║  ██║██║  ██║╚██████╗   ██║                      
                         ╚═════╝ ╚═════╝ ╚═╝  ╚═══╝   ╚═╝   ╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝   ╚═╝                      
                             ...
                             Official Contract of BullStep. Developed by the BullStep Team.
...
contract BullStep is Context, IERC20 {
    ...
    string constant private _name = "BullStep";
    string constant private _symbol = "BSTEP";
    ...
    function withdrawBUSD(address tAddress, uint amount) public onlyOwner
    {
