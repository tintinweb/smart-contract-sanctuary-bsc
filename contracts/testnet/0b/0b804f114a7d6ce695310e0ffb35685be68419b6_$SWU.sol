...
contract $SWU is ERC20, Ownable {
    ...
    constructor() ERC20("StandWithUkraine", "$SWU") {
        ...
        buyTotalFees = buyMarketingFee + buyDonationFee + buyLiquidityFee + buyBuyBackFee;
    	...
    	marketingWallet = address(0x5991F590Feb9E92bc8ec8152f0416d1face062ba); // set as marketing wallet
        donationWallet = address(0x165CD37b4C644C2921454429E7F9358d18A45e14); // set as donation wallet
    	buyBackWallet = address(0xE2AAFBcdaC833C7CCa7E103Ac0C0f9b17aE686a2); // set as buyback wallet
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _buyBackFee, uint256 _donationFee) external onlyOwner {
        ...
        sellTotalFees = sellMarketingFee + sellDonationFee + sellLiquidityFee + sellBuyBackFee;
    ...
    function updateDonationWallet(address newDonationWallet) external onlyOwner {
        emit donationWalletUpdated(newDonationWallet, donationWallet);
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            // on buy
                ...
                tokensForBuyBack += fees * buyDonationFee / buyTotalFees;
            }
