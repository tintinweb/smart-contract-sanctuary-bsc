  ...
  , IERC20Metadata
{
  ...
  string private _name = "Actio 01";
  string private _symbol = "AIO-01";
  ...
  // SAAT INI ADALAH TESTNET ROUTER DAN FACTORY ROUTER
  // https://twitter.com/pancakeswap/status/1369547285160370182?lang=en
  address ROUTER = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;     // pancake testnet router
  address FACTORY = 0x6725F303b657a9451d8BA641348b6761A6CC7a17;    // pancake testnet factory

  // TENTANG WRAP BNB
  // https://bnbsmartchain.com/what-is-wbnb/
  address WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;       // WBNB testnet
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
    ...
    require(currentAllowance >= subtractedValue, "AIO: decreased allowance below zero");
    unchecked {
  ...
  function _transfer(
    ...
    require(sender != address(0), "AIO: Can not transfer from the zero address");
    require(recipient != address(0), "AIO: Can not transfer to the zero address");
    uint256 senderBalance = _balances[sender];
    require(senderBalance >= amount, "AIOERC20: transfer amount exceeds balance");
  ...
  function _mint(address account, uint256 amount) internal virtual {
    require(account != address(0), "AIO: mint to the zero address");
  ...
  function _burn(address account, uint256 amount) internal virtual {
    require(account != address(0), "AIO: burn from the zero address");

    uint256 accountBalance = _balances[account];
    require(accountBalance >= amount, "AIO: burn amount exceeds balance");
    unchecked {
  ...
  function _approve(
    ...
    require(owner != address(0), "AIO: approve from the zero address");
    require(spender != address(0), "AIO: approve to the zero address");
