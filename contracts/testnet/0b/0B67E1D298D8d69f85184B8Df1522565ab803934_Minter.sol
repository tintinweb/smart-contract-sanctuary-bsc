...
contract Minter is Ownable {
    ...
    uint public membership_price_bnb_two;
    ...
    function setBNBMembershipPrice(uint _price) public onlyOwner {
        console.log("Membership cost 0: ", membership_cost);
        console.log("Membership cost 1: ", (10**8));
        console.log("Membership cost 2: ", (membership_cost * (10**8)));

        console.log("Price cost 0: ", _price);
        console.log("Price cost 1: ", (10**8));
        console.log("Price cost 2: ", (_price * (10**8)));
        membership_price_bnb = membership_cost * (10**8);
        membership_price_bnb_two = _price * (10**8);

        // uint tmp_price = (membership_cost * (10**8)) / _price;
        // membership_price_bnb = tmp_price % (10**8);
    }
