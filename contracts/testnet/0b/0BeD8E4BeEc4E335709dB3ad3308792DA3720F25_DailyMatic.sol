...
contract DailyMatic is Ownable {
    ...
    uint256 private constant MIN_INVESTMENT = 0.03 ether;
    ...
    function whitelistinvest(address _ref) public payable{
    ...
    function invest(address _ref) public payable{
        require(isSaleOpen,"The Farm is preparing, Please wait");
        if (_invest(msg.sender, _ref, msg.value)) {
            emit OnInvest(msg.sender, msg.value);
        }
    }
