...
contract TapOut is Initializable, BEP20FeeableUpgradeable {
    ...
    function initialize(address council_, uint256 totalSupply_)
        ...
        initializer
    {
        string memory name = "TapOut";
        string memory symbol = "TAP";
        uint8 decimals = 8;
        __BEP20Feeable_init(name, symbol, decimals);
        council = council_;
    ...
    function _beforeTokenTransfer(
        ...
        if (_shouldTakeFee(from, to)) {
            ...
            // council fees
            _balances[from] = _balances[from] - councilFee;
            _balances[council] = _balances[council] + councilFee;
            emit Transfer(from, council, councilFee);
...
abstract contract BEP20FeeableUpgradeable is Initializable, BEP20Upgradeable {
    ...
    function __BEP20Feeable_init(
        string memory name_,
        string memory symbol_,
        uint8 decimals_
    ) internal onlyInitializing {
        __BEP20_init(name_, symbol_, decimals_);
