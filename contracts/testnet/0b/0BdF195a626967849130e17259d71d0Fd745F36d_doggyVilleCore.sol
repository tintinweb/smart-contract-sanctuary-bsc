...
contract doggyVilleCore is DoggyMinting{
    ...
    constructor (string memory _baseUri, IERC20 _token, address _pricePool, address _doggyVillePlatform,address _dev,address _signer)DoggyMinting(_dev,_signer) {
