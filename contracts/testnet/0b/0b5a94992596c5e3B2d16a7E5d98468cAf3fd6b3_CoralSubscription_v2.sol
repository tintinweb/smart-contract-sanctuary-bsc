...
contract CoralSubscription_v2 is
    Initializable,
    PausableUpgradeable,
    ...
    OwnableUpgradeable
{
    ...
    uint256[] public subScribeTimes;
    uint256[] public subScribePrices;
    ...
    function initialize(
        ...
        require(busdAddress != address(0), "Invalid Address");
        require(crlAddress != address(0), "Invalid Address");
        require(crlPassAddress != address(0), "Invalid Address");
    ...
    function getBuyState(address _userAddress) external view returns(Buyers memory) {
         require(_userAddress != address(0), "Invalid Address");
         return buyers[_userAddress];
    }
