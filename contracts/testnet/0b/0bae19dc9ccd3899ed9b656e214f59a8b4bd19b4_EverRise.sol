...
contract EverRise is Context, IERC20, Ownable {
    ...
    address payable public treasuryAddress = payable(0x8e4410Fc8f15321Aa9951beA6B95b31089f41165); // Marketing Address
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == uniswapV2Pair) {
            ...
            if (buyBackEnabled && balance > uint256(1 * 10**17)) {
                transferToAddressETH(treasuryAddress, balance.mul(90).div(100));
                buyBackTokens(balance.mul(10).div(100));
            }
        }
