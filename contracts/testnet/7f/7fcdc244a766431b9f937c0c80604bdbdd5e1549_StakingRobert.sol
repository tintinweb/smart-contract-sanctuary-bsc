      ...
      if (_laddress == BUSDA) {
       if (_totalSupplyBUSD == 0) {
        ...
        return
            ...
            (((block.timestamp - lastUpdateTime) * rewardRate * 1e18) / _totalSupplyBUSD);
        ...
        return
            ...
            (((block.timestamp - lastUpdateTime) * rewardRate * 1e18) / _totalSupplyUSDT);
        ...
        return
            ...
            (((block.timestamp - lastUpdateTime) * rewardRate * 1e18) / _totalSupplyBNB);
