...
contract HellowNFT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("HellowNFT", "HiNFT") {
    	...
    	marketingWallet = address(0x627306090abaB3A6e1400e9345bC60c78a8BEf57); // set as marketing wallet
    	buyBackWallet = address(0x29d6a85cAf79f2479c77757281De70eca1E92dCc); // set as buyback wallet
