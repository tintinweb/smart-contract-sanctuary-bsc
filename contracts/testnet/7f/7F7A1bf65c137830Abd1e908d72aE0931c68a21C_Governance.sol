...
/**
   ...
   @dev This contract is being used as role controls
*/
contract Governance is AccessControlEnumerableUpgradeable {
    ...
    function lock() external onlyRole(MANAGER_ROLE) {
        locked = true;
    }

    function unlock() external onlyRole(MANAGER_ROLE) {
        locked = false;
    }
}