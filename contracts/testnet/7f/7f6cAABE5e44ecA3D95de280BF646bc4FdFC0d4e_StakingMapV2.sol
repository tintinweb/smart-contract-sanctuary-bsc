...
contract StakingMapV2 is Ownable, Pausable {
    ...
    IERC20 public TOKEN;
    StakingMapV1Contract STAKING_MAP_V1;
    uint256 public TOKEN_SINGLE_STAKE_AMOUNT = 100000 * 10 ** 18; //100k
    bool public BLOCK_NEW_STAKES = false;
    uint32 public START_TIMESTAMP = 1647687600; //  19 March 2022 11:00:00 UTC (start 1st staking map)
    Map[] MAPS;
    Stake[] public STAKES;
    ...
    function reduceLocalStake(uint256 _stakeId, uint256 _amountToReduce) public whenNotPaused {
        ...
        emit ReducedStake(_stakeId, _msgSender(), STAKES[_stakeId].stakesAmount, _amountToReduce);
        ...
        TOKEN.safeTransfer(_msgSender(), _totalTokenReturnAmount);
    }
