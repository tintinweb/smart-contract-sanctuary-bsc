...
contract TestpadStaking is Ownable, IStakingLockable {
  ...
  // update base on contract Apr 7 days
  ...
  function getFixedAprPendingReward(address account) public view returns (uint256) {
    ...
    // e.g. 15% APR for 7 d ays = 15 / 365 * 7 = 0,28767123%
