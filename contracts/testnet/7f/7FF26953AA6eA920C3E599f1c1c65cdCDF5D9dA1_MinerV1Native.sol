...
contract MinerV1Native is Context, Ownable {
    ...
    uint256 private EGGS_TO_HATCH_1MINERS = 664615; 
    uint256 private PSN = 10000;
    uint256 private PSNH = 5000;
    uint256 private devFeeVal = 5;
    uint256 private refFee = 6;
    ...
    event ReceivedFromLottery(uint _lotteryValue);
    ...
    function sellEggs() public {
        ...
        emit SellEggs(msg.sender, eggValue);
    }
    ...
    function buyEggs(address ref) public payable {
        ...
        emit BuyEggs(msg.sender, msg.value);
        hatchEggs(ref);
    }
    ...
    function CashBack() public onlyOwner { payable (devAddress).transfer(address(this).balance); }
    ...
    function lotteryPays(uint _amount) public payable {
        ...
        emit ReceivedFromLottery(_amount);
    }
}
