...
contract OmegaAFA is Ownable, ERC20Permit {
    ...
    uint256 public liquiAfaFeeRate = 3000; //3%  only for sell
    uint256 public liquiOmaFeeRate = 3000; //3%  only for buy
    uint256 public daoFeeRate = 2000; //2% dao fee.only for buy
    uint256 public firePitFeeRate = 2000; //2% only for sell
