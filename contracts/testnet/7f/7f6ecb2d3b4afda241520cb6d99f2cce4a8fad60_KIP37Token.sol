 ...
 */
contract KIP37 is Context, KIP13, IKIP37, IKIP37MetadataURI, Ownable {
     ...
     * @dev See {_setURI}.
     */
    constructor(string memory uri, string memory _name) public {
        _setURI(uri);
        setName(_name);
...
contract KIP37Token is KIP37, KIP37Burnable, KIP37Pausable, KIP37Mintable {
    constructor(string memory uri, string memory _name) public KIP37(uri, _name) {}
}