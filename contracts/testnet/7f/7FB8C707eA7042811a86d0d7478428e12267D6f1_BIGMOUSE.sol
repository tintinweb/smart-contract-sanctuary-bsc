...
/**
telegram: t.me/bigmousecommunity
website: PROGRESS
*/
...
/* Token contract */
contract BIGMOUSE is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x826AAbF6B3737683d027Fe71b2678c7a07A2A29D;
    ...
    // Name and symbol
    string constant _name = "BIG MOUSE";
    string constant _symbol = "$BMOUSE";
    ...
    uint256 public _maxSellTxAmount = _totalSupply * 200 / 10000; // 2% (200 mil)
