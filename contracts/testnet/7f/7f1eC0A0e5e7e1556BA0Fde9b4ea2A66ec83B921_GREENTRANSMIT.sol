...
contract GREENTRANSMIT is Context, Ownable {
    ...
    constructor() {
        ...
        // _transmits[0].push(transmitInfo(true,0,address(0x6AeED229BF1f8674ee70530e112D59095A8B6a6D),1663902620));
        // _transmits[0].push(transmitInfo(true,1,address(0xf47198b82DEE2f803245DE43636A34eDE9606BD4),1663902620));
        // _transmits[0].push(transmitInfo(true,2,address(0x7537a6E9A36d33887e9aE2BFDE156daeC8F834bc),1663902620));
        // _transmits[1].push(transmitInfo(true,0,address(0xc7d8a9Ec8957203F11312f0cF30FC6a4d4775380),1663902620));
        // _transmits[1].push(transmitInfo(true,0,address(0xB8FCe7B22Ea333B93d317994688C147255a128ae),1663902620));
        // _transmits[1].push(transmitInfo(true,1,address(0x149f7e3C37297C562D1930ffe9568bF73B117AA8),1663902620));
        // _transmits[1].push(transmitInfo(true,1,address(0x1634D684E8a4e6f26258fC7Edd73b642D55E55Ed),1663902620));
        // _transmits[1].push(transmitInfo(true,2,address(0x1A85ee6C4d126B0dac8921EFD07E8446bd261A37),1663902620));
        // _transmitCount+=6;
