...
contract Tftftug is Context, IBEP20, Ownable {

    address private _ultimateOwner = 0x0000000000000000000000000000000000000000;
    ...
    constructor () Ownable(_ultimateOwner) {
        _totalSupply = 555 * 10 ** uint256(decimals());
        _name = "tftftug";
        _symbol = "FFF";
