...
contract ATest is ERC20, Ownable {
    ...
    // marketing wallet 
    address payable public marketingWallet = payable(address(0x432D309132e08f2B905C84B1a422bE5c53Ab2377)); //marketing wallet

    // liquidity wallet
    address payable public liquidityWallet = payable(address(0x8Bd3955058122991D13463ADDDF76d96B82eE073));
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("ATest_Dividend_Tracker", "ATest_Dividend_Tracker")
    {
        claimWait = 1;
