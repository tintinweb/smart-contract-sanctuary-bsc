...
contract TestPTP is ERC20 {
    uint256 internal startDate = 1656314400;                            
    ...
    function createFreeStake(address user,string memory btcAddress,uint balance,address refererAddress) external {
