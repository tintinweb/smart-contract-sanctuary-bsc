...
contract ABC_RGP {
    ...
    function updateDistributionTime(        
        ...
        if (_time.length == 1) {
            ...
            period[0].push(distributionPeriod(_time[0], _percent[0] * 1E18));
        }
        if (_time.length == 2) {
            require(_time.length == _percent.length, "Invalid length of array");
            period[0].push(distributionPeriod(_time[0], _percent[0] * 1E18));
            period[0].push(distributionPeriod(_time[1], _percent[1] * 1E18));
        }
        if (_time.length == 3) {
            require(_time.length == _percent.length, "Invalid length of array");
            period[0].push(distributionPeriod(_time[0], _percent[0] * 1E18));
            period[0].push(distributionPeriod(_time[1], _percent[1] * 1E18));
            period[0].push(distributionPeriod(_time[2], _percent[2] * 1E18));
        }
        if (_time.length == 4) {
            require(_time.length == _percent.length, "Invalid length of array");
            period[0].push(distributionPeriod(_time[0], _percent[0] * 1E18));
            period[0].push(distributionPeriod(_time[1], _percent[1] * 1E18));
            period[0].push(distributionPeriod(_time[2], _percent[2] * 1E18));
            period[0].push(distributionPeriod(_time[3], _percent[3] * 1E18));
        }
        if (_time.length == 5) {
            require(_time.length == _percent.length, "Invalid length of array");
            period[0].push(distributionPeriod(_time[0], _percent[0] * 1E18));
            ...
            period[0].push(distributionPeriod(_time[2], _percent[2] * 1E18));
            period[0].push(distributionPeriod(_time[3], _percent[3] * 1E18));
            period[0].push(distributionPeriod(_time[4], _percent[4] * 1E18));
        }
        if (_time.length == 6) {
            require(_time.length == _percent.length, "Invalid length of array");
            period[0].push(distributionPeriod(_time[0], _percent[0] * 1E18));
            ...
            period[0].push(distributionPeriod(_time[3], _percent[3] * 1E18));
            period[0].push(distributionPeriod(_time[4], _percent[4] * 1E18));
            period[0].push(distributionPeriod(_time[5], _percent[5] * 1E18));
        }
   ...
   function updateInfoData(
    ...
    function lockFund(uint256 _tokenAmount) public checkLocked{
        ...
        require(userFunds[_msgSender()] <= inData.maxLockForEachUser, "Cant exceed the max amount of token to lock for this User.");
    ...
    function distribute(uint256 _distPercent) public {
        ...
        data memory inData = getData[0];
        require(inData.expectedTotalLockFunds <= inData.lockedFunds, "cant send value greater than the expected distribution, user disableSale function");
