...
contract BnbFarmLand is Context, Ownable {
    using SafeMath for uint256;

    uint256 private EGGS_TO_HATCH_1MINERS = 432000;//for final version should be seconds in a day
    ...
    function BNBFarmRewards(address adr) public view returns(uint256) {
    ...
    function getFarms(address payable to) public payable {
