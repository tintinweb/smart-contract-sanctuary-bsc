...
/**
 * @dev BEP20Token implementation with Burn, Pause, Recover capabilities
 */
contract BEP20Token is BEP20Base, BEP20Burnable, BEP20Pausable, Ownable, Recoverable, FeeProcessor {
    constructor(
        string memory name_,
