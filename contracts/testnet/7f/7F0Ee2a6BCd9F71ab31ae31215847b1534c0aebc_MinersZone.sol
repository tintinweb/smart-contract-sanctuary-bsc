...
contract MinersZone is Context, IERC20, Ownable {
    ...
    uint256 public _taxFee = 0; //Disable for this code
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 2;  
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _gameRewardFee = 3; 
    ...
    {   
        ...
        uint256 ethForDev = newBalance.mul(gameRewardTokensCollected);
    ...
    function setAllFeePercent(uint256 liquidityFee, uint256 gameRewardFee) 
    external onlyOwner() 
    {
    ...
    function setSaleFeePercent(uint256 liquidityFee, uint256 gameRewardFee) 
    external onlyOwner() 
    {
        _saleLiquidityFee = liquidityFee;
        _salegameRewardFee = gameRewardFee;
		totalSwapableSaleFee = _saleLiquidityFee.add(_salegameRewardFee);
    ...
    function setSaleLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        _saleLiquidityFee = liquidityFee;
		require(liquidityFee <= 5, "Total fee is over 5%");
    }
    ...
    function setgameRewardWalletAddress(address _gameRewardWallet) external onlyOwner() {
		 require(msg.sender == _gameRewardWallet, "setgameRewardWalletAddress: FORBIDDEN");
    ...
    function setpinkAntiBotAddress(address _AntiBotAddress) external onlyOwner() {
         require(msg.sender == _AntiBotAddress, "setpinkAntiBotAddress: FORBIDDEN");
