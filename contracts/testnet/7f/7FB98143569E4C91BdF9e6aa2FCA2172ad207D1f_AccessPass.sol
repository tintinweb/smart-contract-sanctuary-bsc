...
contract AccessPass is ERC1155, Ownable, Pausable {
    ...
    constructor() ERC1155("https://game.example/api/item/{id}.json") {
        ...
        pricesUSD[0] = 499 * 10**8; // 4.99 x 10^18 ($4.99)
        pricesUSD[1] = 999 * 10**8;
        pricesUSD[2] = 1999 * 10**8;
        pricesUSD[3] = 2999 * 10**8;
        pricesUSD[4] = 3999 * 10**8;
        pricesUSD[5] = 4999 * 10**8;
    }
    ...
    function getAccessPassNativePrice() public view returns (uint256) {
        uint256 result;
        result = pricesUSD[0].div(uint256(getLatestPrice()));
