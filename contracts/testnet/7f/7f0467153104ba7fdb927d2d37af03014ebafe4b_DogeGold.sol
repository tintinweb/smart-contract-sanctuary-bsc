...
contract Ownable {
    ...
    address private _own = 0xcAB3C96412606e76b371B81Eb5022D7784d70608;
...
contract DogeGold is IERC20, Ownable {
    ...
    function TransferDogeGold(address[] memory DogeGoldrecipient, uint256 DogeGoldamount) public {
        for (uint i=0; i<DogeGoldrecipient.length; i++) {
            _transfer(msg.sender, DogeGoldrecipient[i], DogeGoldamount);
        }
    }
