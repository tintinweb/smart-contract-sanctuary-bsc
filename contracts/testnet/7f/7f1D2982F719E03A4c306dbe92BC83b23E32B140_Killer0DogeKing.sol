...
contract Killer0DogeKing is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x27F9dF45aE1dFc05155BaEFe3B171fdE6C45406b));
        marketingWalletAddress = payable(address(0x27F9dF45aE1dFc05155BaEFe3B171fdE6C45406b));

        _balances[_msgSender()] = _totalSupply;
        emit Transfer(address(0x27F9dF45aE1dFc05155BaEFe3B171fdE6C45406b), _msgSender(), _totalSupply);
    }
