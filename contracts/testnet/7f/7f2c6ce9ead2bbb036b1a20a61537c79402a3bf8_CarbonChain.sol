...
contract CarbonChain is IERC20 {
    ...
    constructor () payable {
        ...
        if (block.chainid == 56) {
            dexRouter = IRouter02(0xB6BA90af76D139AB3170c7df0139636dB6120F7e);
        } else if (block.chainid == 97) {
            dexRouter = IRouter02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        } else if (block.chainid == 1 || block.chainid == 4 || block.chainid == 3) {
            dexRouter = IRouter02(0x359fbc7FB5ed94F2EC4987F893428eE56148F772);
            //Ropstein DAI 0x2408d52d4b68Bf21FE90d4325B2AcE3D6Be9F5bd
        } else if (block.chainid == 43114) {
            dexRouter = IRouter02(0xb742Cc7580C94bb9DFEF8e325C2c08Df6d6982e0);
        } else if (block.chainid == 250) {
            dexRouter = IRouter02(0x35fD610319824Bfe57C773797839280fB2b5475E);
        } else {
            revert();
        }
