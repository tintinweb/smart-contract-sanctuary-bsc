...
contract AloraNode is ERC20Upgradeable {
    ...
    uint256 public maxDepositAmount = 0;
    ...
    address public whiteListerfund = 0xBd6fc012F89368eD1E0da4b0d047A09d08366727; 
    uint256 public _totalDeposit = 0;
    function depositToken(bytes32[] calldata merkleProof) public {
        ...
        require(IERC20(stableToken).balanceOf(msg.sender) > maxDepositAmount, "Invalid WhiteLister");
        IERC20(stableToken).transferFrom(msg.sender,whiteListerfund, maxDepositAmount);
        depositAmount[msg.sender] += maxDepositAmount;
        _totalDeposit += maxDepositAmount;
    }
