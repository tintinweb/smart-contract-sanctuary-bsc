...
contract Market is IMarket, Ownable {
    ...
    function setBid(
        ...
        // may be a backend call that approves tokens before bidding and then set him as a bidder
    ...
    function endAuction(
        ...
        require(
            block.timestamp >=
                (_tokenAsks[_tokenID]._firstBidTime -
                    _tokenAsks[_tokenID]._createdAt) +
                    _tokenAsks[_tokenID]._duration,
...
interface Iutils {
    ...
    struct Ask {
        ...
        // max Amount of the currency being asked
        uint256 _askAmount;
