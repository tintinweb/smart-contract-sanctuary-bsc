...
Definitly a long term project to invest.

💠 AMA on our Telegram at 14:45 UTC 08th Feb

💠 Launch time: 15:00 UTC 08th Feb


🦊Auto paid $BNB token on your wallet every hour.  
🥊 Very huge amount of Reward 4% - more than all other tokens. 
🙅🏻 No pre-sale. And Liquidity will locked on launch
💪🏻100% SAFU. Liquidity will locked with Pinksale
👌🏻 Based DEV
🐳 Anti dump and Anti whales too

Greetings from the 🐶MicroShibaInu Metaverse 🐶!

MicroShibaInu is a groundbreaking Metaverse with the goal of being the most fun platform for crypto users and rookies. Our mission is to create an addicting fun platform that provides passive income, assisting people in achieving their financial goals in life . 
...
✅ Building and owning MicroShibaInu Crosschain Metaverse Lands + Identities
...
🐶Official Telegram:  https://t.me/Micro_ShibaInu
...
contract MSHIB is Context, IERC20, Ownable {
    ...
    string private _name = "Micro ShibaInu";
    ...
    uint256 private numTokensSellToAddToLiquidity = 90_000_000_000 * 10**9;
