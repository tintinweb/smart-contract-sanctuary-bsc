...
contract Egg is IBEP20, Auth {
    ...
    string constant _name = "Egg";
    string constant _symbol = "EGG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1_000_000_000 * (10**_decimals);
    uint256 public _maxTxAmount = _totalSupply.mul(2).div(100);
    uint256 public _maxWalletHoldingAmount = _totalSupply.mul(3).div(100);
    ...
    address public marketingFeeReceiver =
        0xB4eB0058C3859A15c73cD3d8Ec688674a2aF7f5d;
    ...
    function launch() public authorized {
        require(launchedAt == 0, "Already launched for Egg");
