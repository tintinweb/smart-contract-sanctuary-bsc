...
abstract contract LUNAToken is IERC20, Ownable {
    ...
    uint256 public _buyFundFee = 100;//100为购买营销钱包税费1%
    uint256 public _buyLPDividendFee = 400;//400为购买加池子LP分红税费4%
    uint256 public _buyLPFee = 0;//
    uint256 public _sellFundFee = 100;//100为卖出营销钱包税费1%
    uint256 public _sellLPDividendFee = 400;//400为卖出加池子LP分红税费4%
    ...
    constructor (
        ...
        _maxTxAmount = 66666 * 10 ** Decimals;
    ...
    function setMaxTxAmount(uint256 a) external onlyOwner {
        _maxTxAmount = a;
    }
...
contract LUNA is LUNAToken {
    constructor() LUNAToken(
        ...
        address(0xb9166C61904CE1311185664618E6ceF2bD442AAf),
        address(0xb9166C61904CE1311185664618E6ceF2bD442AAf)
    ){
