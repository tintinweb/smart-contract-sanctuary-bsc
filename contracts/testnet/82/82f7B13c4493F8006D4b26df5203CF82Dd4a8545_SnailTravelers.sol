...
contract SnailTravelers is Initializable, ERC721Upgradeable {
  ...
  function safeMint(address sender_, uint256 quantity_) internal {
  ...
  function mintFromPublicSale(
    ...
    validateEthPayment(count, mintPrice)
  {
  ...
  function mintFromBreedSale(
    ...
    uint256 parent1Cut = (mintPrice * parent1Percentage) / 100;
    uint256 parent2Cut = (mintPrice * parent2Percentage) / 100;
    uint256 teamCut = (mintPrice * fee) / 100;
