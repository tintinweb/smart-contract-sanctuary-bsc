...
// Main Contract
contract BeersAndCyrptoTears is IERC20Metadata, Ownable {
   ...
   // General
   string private _name = 'Beers and Crypto Tears';
   string private _symbol = 'BCT';
   uint8 private _decimals = 9;
   uint256 public constant _supplyTotal = 100000000000000000000;
   ...
   address payable public liqWallet = payable(0x64162EFBFc16Ab864DA226f2E21A0e10FCF8b728);
   address payable public marketingWallet = payable(0xcB8B8Aa046C79811802d594a5fAb21b28bE689a3);
 
   // Max wallet size
   uint256 public txDenominator = 10000;
   uint256 public maxWalletSize = 2000000000000000000;
   ...
   uint256 public marketingTaxS  = 100; 
   uint256 public marketingTaxB  = 100;
   uint256 public totalSellFee = 300;
   uint256 public totalBuyFee = 300;
   ...
   // Swap
   uint256 public liqSwapAt  = 200000000000000;
   uint256 public marketingSwapAt = 100000000000000;
   ...
   // Tax values
    function changeSellTaxes(uint256 newMarketingS, uint256 newLiqS) public virtual onlyOwner {
        marketingTaxS = newMarketingS;
        liqTaxS = newLiqS;
        totalSellFee = newMarketingS + newLiqS;
        require(totalSellFee <= 5, "Total sell tax needs to be 5% and below");
    }

    function changeBuyTaxes(uint256 newMarketingB, uint256 newLiqB) public virtual onlyOwner {
        marketingTaxB = newMarketingB;
        liqTaxB = newLiqB;
        totalBuyFee = newMarketingB + newLiqB;
        require(totalBuyFee <= 5, "Total sell tax needs to be 5% and below");
    }
