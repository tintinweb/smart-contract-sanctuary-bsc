...
contract dropShare is ERC20Burnable, Operator {
    ...
    constructor(address _BOND, address _DROP, address _BUSD, address _router, address _genesisAddress, address _treasury, address _boardroom, address _shareRewardPool, uint256 _startTime, address _communityFund, address _devFund) ERC20("Golden Drip Share", "GDSHARE") {
