...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        require(account != _dead, "ERC20: burn from the zero address");

        _beforeTokenTransfer(account, _dead, amount);
        ...
        emit Transfer(account, _dead, amount);
    }
...
contract TTTE is ERC20, ERC20Pausable, ERC20Burnable, ERC20Capped, ERC20Snapshot, Ownable {
    ...
    constructor() ERC20("TestTelegramToken34", "TTTE34") ERC20Capped(_maxTotalSupply) {
