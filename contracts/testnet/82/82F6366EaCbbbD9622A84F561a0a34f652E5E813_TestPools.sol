...
contract TestPools is ReentrancyGuard {
    ...
    constructor(address _commissionWallet) {
        ...
        plans[planIndex++] = Plan(14, 7.85714286 * 1E18, PlanType.ENDTIME);
        plans[planIndex++] = Plan(21, 5.71428571 * 1E18, PlanType.ENDTIME);
        plans[planIndex++] = Plan(30, 4.66666667 * 1E18, PlanType.ENDTIME);
        plans[planIndex++] = Plan(30, 5.66666667 * 1E18, PlanType.ANYTIME);
        plans[planIndex++] = Plan(45, 4.44444444 * 1E18, PlanType.ANYTIME);
        plans[planIndex++] = Plan(2, 125 * 1E18, PlanType.ANYTIME);
    }
