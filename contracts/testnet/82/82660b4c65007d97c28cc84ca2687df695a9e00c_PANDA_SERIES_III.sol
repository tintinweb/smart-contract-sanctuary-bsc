...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function transferFrom(
        ...
        require(to != address(this),"The target wallet should not be contract self");
...
contract PANDA_SERIES_III is ERC721, Ownable, ReentrancyGuard {
    ...
    uint256 public maxSupply = 70000;   
    ...
    address private constant withdrawTo = 0xd2e8a469Db672dA6Fac5e7c1D945272a834BDe0C;

    constructor() ERC721("PGNFT CLUB MOVIE PANDA", "PCMP") ReentrancyGuard() {}
    ...
    function mint(bytes32[] memory proof, uint256 _mintAmount) external payable  nonReentrant {
        ...
        require(supply.current() + _mintAmount < maxSupply+1, "Exceeds Max Supply");
    ...
    function tokenURI(uint256 _tokenId) public view virtual override returns (string memory) { 
        ...
        return bytes(uriPrefix).length > 0
            ? string(abi.encodePacked(uriPrefix, _tokenId.toString()))
            : "";
    }
    ...
    function setClaimWhitelist(address _addr, uint256 _amount) external onlyOwner { 
        ClaimedWhitelist[_addr] = _amount;
    ...
    function _mintLoop(address _receiver, uint256 _mintAmount) internal { 
        ...
        ClaimedWhitelist[msg.sender] = ClaimedWhitelist[msg.sender] - _mintAmount;
    }
