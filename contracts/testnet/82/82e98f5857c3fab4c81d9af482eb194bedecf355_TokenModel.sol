...
contract TokenModel is ERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        if (!exemptFee[sender] && !exemptFee[recipient]) {
            ...
            // Cooldown 
            if (_cooldown && !exemptFee[recipient]) {
            require(_lastTx[recipient] < block.timestamp, "Please wait for cooldown to finish.");
            _lastTx[recipient] = block.timestamp + _cooldownTime;
            }
