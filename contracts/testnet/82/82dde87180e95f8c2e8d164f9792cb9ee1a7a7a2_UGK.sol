...
abstract contract DexBase {
    ...
    address public constant USDT = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;
...
abstract contract LpFee is Owned, DexBase, ERC20 {
    ...
    address constant fundAddress = 0x085C7508aA523183DbA299Ab0B381948047AC9C1;
...
contract UGK is ExcludedFromFeeList, BlackList, LpFee {
    ...
    constructor() ERC20("UGK", "UGK", 18) LpFee(1 * 1e18) {
    ...
    function takeFee(address sender, uint256 amount)
        ...
        returns (uint256)
    {
        if (launchedAt + 1200 >= block.number) {
            if (sender == uniswapV2Pair) {
                require(amount <= 5 * 1e18, "purchase limit");
                require(balanceOf[msg.sender] + amount <= 10 * 1e18, "hold limit");
            }
        }
    ...
    function _transfer(
        ...
        uint256 maxSellAmount = balanceOf[msg.sender] * 99999 / 100000;
