...
contract myAdjustmentToken is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"Fourth Attempt Token";
    string private constant _symbol = unicode"FAT";
    uint256 public _maxTxAmount = tokenTotalSupply / 50;
    uint256 public _maxWalletSize = tokenTotalSupply / 50;
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
              taxAmount = amount.mul(totalTaxes / 2).div(100);
