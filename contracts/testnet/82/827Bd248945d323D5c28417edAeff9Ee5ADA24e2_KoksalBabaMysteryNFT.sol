...
contract KoksalBabaMysteryNFT is ERC721Enumerable, Ownable {
    ...
    address public founderAddress = 0x42E21430B56303810A2b1D798131C3E5987F9633;

    constructor(string memory baseURI) ERC721("Koksal Baba Mystery NFT", "KBMNFT") {
        setBaseURI(baseURI);
    }
