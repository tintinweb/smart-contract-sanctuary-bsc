...
contract OrbitPlay is Ownable, ReentrancyGuard {
    ...
    uint256 public diceReturnsPercentage = 1000;
    uint256 public diceBurnOnLossPercentage = 60000;
    uint randDiceNonce = 0;

    bool public coinFlipPlayable = true;
    uint256 public coinFlipReturnsPercentage = 1000;
    uint256 public coinFlipBurnOnLossPercentage = 20000;
    uint randCoinFlipNonce = 0;

    bool public spinPlayable = true;
    uint256 public spinReturnsPercentage = 1000;
    uint256 public spinBurnOnLossPercentage = 40000;
    uint randSpinNonce = 0;

    bool public roshamboPlayable = true;
    uint256 public roshamboReturnsPercentage = 1000;
    uint256 public roshamboBurnOnLossPercentage = 30000;
    ...
    function placeRoshamboBet(uint256 amount, uint256 betGesture) public { //betPlace 1: Rock 2: Yellow: Paper 3: Scissors
		require(
            roshamboPlayable,
		...
		if(destiny == betGesture){ //win (1: heads 2: tails)
