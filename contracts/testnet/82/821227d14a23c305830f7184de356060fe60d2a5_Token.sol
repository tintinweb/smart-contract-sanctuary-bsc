...
contract Token is Context, IERC20, IERC20Metadata {
    ...
    address private _current_minter = address(0);

     modifier onlyMinter() {
        require(_current_minter == _msgSender(), "onlyMinter: caller is not the minter");
        _;
    }
    ...
    constructor(
        ...
        require(maxSupply_ >= totalSupply_,"Total Supply should be less than max supply");
        _name = name_;
        _symbol = symbol_;
        _current_minter = minter;
    ...
    function _approve(
       ...
       function mint(address to, uint256 amount) external onlyMinter   {
        require(
            ...
            "Total Supply can't be greater than max supply"
        );
        _mint(to, amount);
    }
