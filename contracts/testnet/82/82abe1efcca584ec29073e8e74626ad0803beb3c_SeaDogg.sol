...
/*                                         
 .----------------.  .----------------.  .----------------.   .----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. || .--------------. |
| |    _______   | || |  _________   | || |      __      | | | |  ________    | || |     ____     | || |    ______    | || |    ______    | |
| |   /  ___  |  | || | |_   ___  |  | || |     /  \     | | | | |_   ___ `.  | || |   .'    `.   | || |  .' ___  |   | || |  .' ___  |   | |
| |  |  (__ \_|  | || |   | |_  \_|  | || |    / /\ \    | | | |   | |   `. \ | || |  /  .--.  \  | || | / .'   \_|   | || | / .'   \_|   | |
| |   '.___`-.   | || |   |  _|  _   | || |   / ____ \   | | | |   | |    | | | || |  | |    | |  | || | | |    ____  | || | | |    ____  | |
| |  |`\____) |  | || |  _| |___/ |  | || | _/ /    \ \_ | | | |  _| |___.' / | || |  \  `--'  /  | || | \ `.___]  _| | || | \ `.___]  _| | |
| |  |_______.'  | || | |_________|  | || ||____|  |____|| | | | |________.'  | || |   `.____.'   | || |  `._____.'   | || |  `._____.'   | |
| |              | || |              | || |              | | | |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'   '----------------'  '----------------'  '----------------'  '----------------'                                                                                                                    
*/
...
contract SeaDogg is IERC20, Ownable {
    ...
    string constant _name = "SeaDogg";
    string constant _symbol = "$SEA_DOGG";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1 * 10**6 * (10**_decimals);
    uint256 public maxTxAmount = _totalSupply.mul(10).div(1000); // 1%
    uint256 public maxHoldingLimit = _totalSupply.mul(20).div(1000); // 2%
