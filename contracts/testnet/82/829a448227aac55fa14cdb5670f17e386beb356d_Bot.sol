...
contract Bot is Ownable {
    ...
    function buyBot(address recipient, uint8 _id) public payable {
    ...
    function setClasses(uint8 _id, uint256 _seconds) public onlyOwner {
        require(classes[_id] != _seconds, "_id's value is _seconds");
        classes[_id] = _seconds;
    }

    function setPricing(uint8 _id, uint256 _price) public onlyOwner {
