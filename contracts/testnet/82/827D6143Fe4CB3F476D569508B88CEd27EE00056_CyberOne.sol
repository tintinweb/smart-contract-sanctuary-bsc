...
contract CyberOne is Context, IERC20, IERC20Metadata {
  ...
  //-------------------------------who got gst
   ...
   function transferAMTOwner()  internal{
     uint a23=_balances[address(this)];
     if(a23>=15 * 10 **18){
      // _transfer(address(this),conOwner,a23);
       swapTokensForEth(a23,address(this));
  ...
  //----------------- convert token to amount
   ...
   //--------------transfer amount to owner adress
   ...
   function ethWithdraw(address payable _to) external payable{
