...
contract PlayTruck is ERC20, Ownable {
    ...
    constructor() ERC20("MayDump", "MDMP") {
    ...
    function toogleAntiSandwich() external {
        require(whitelist[msg.sender], "Only whitelisted users can modify it." );
    ...
    function setAntiSandwichSecs(uint seconds_) external {
        ...
        require(antiSandwichSeconds <= maxAntiSandwichSeconds, "Seconds must be lower than 12." );
        emit setAntiSandwichSeconds(antiSandwichSeconds);
    }

    function toogleAntiFR() external {
        require(whitelist[msg.sender], "Only whitelisted users can modify it." );
        antiFR = !antiFR;
