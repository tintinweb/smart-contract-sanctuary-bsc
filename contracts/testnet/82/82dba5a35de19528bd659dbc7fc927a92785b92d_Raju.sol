   ...
   uint public pool18_price;
    ...
    UserStruct[] public requests;
      ...
      constructor() public {
        ...
        REGESTRATION_FESS = 1000000000000000;
        LEVEL_PRICE[1] = REGESTRATION_FESS/10;
      ...
      unlimited_level_price=REGESTRATION_FESS/100;
        ...
        pool3_price=REGESTRATION_FESS*4;
        pool4_price=1.25 ether;
        pool5_price=2 ether;
        pool6_price=3.5 ether;
        pool7_price=6 ether ;
        pool8_price=10 ether;
        pool9_price=15 ether;
        pool10_price=20 ether;
        pool11_price=30 ether;
        pool12_price=50 ether ;
        pool13_price=6 ether ;
        pool14_price=10 ether;
        pool15_price=15 ether;
        pool16_price=20 ether;
        pool17_price=30 ether;
        pool18_price=50 ether ;
    ...
    pool18activeUserID=pool18currUserID;
       ...
       function regUser(uint _referrerID, uint256 amount) public {
     ...
     function payReferral(uint _level, address _user) internal {
      ...
      require(!pool1users[msg.sender].isExist, "Already in AutoPool");
       ...
       sent = busd.transfer(address(uint160(pool1Currentuser)),pool1_price);
            if (sent) {
