...
interface ProxyRouterContractInterface {
    ...
    function get_treasuries_length() external view returns (uint256);
}
...
contract GamesPool is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function deposit_reserved_amount(uint256 _toReserve)
        public
        payable
        onlyReservedAmountAccount
    {
        uint256 _treasuriesLength = proxyRouterContract.get_treasuries_length();
        uint256 _newAmount = msg.value;
        uint256 fee = calculate_current_transaction_fee_internal();
    ...
    function withdraw_reserved_amount(uint256 _amount, uint256 _toReserve, address _address)
        public
        payable
    ...
    function set_init_reserved_amount(address _address)
        public
        payable
    ...
    function delete_reserved_amount(address _address)
        public
        payable
        onlyOwnerOrRootCallerAccount
    {
    ...
    function set_new_root_caller(address _newRootCaller) public payable onlyOwner {
        assert_one_yocto();
    ...
    function calculate_current_transaction_fee()
        public
        payable
        returns (uint256)
    {
        assert_one_yocto();
        return calculate_current_transaction_fee_internal();
    }
    ...
    function calculate_current_transaction_fee_internal()
        internal
        returns (uint256)
    {
