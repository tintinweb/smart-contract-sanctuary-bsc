...
contract TeleCrypto {
    ...
    event BuyTickets(address _from, uint256 _tokenamount, string _message);
    event Deposits(address _from, uint256 _tokenamount);
    ...
    function BuyTicket(
        ...
        emit BuyTickets(msg.sender, _tokenamount, "Lucky Numbers");
    }
