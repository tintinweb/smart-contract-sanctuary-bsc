...
contract JBLNFT is ERC721{
    ...
    uint256 public NFT_APY = 13*1*10**17; //基礎APY：130 , 加成APY：0
    ...
    constructor ()  public ERC721("JBL-Albee1", "JBL-Albee1"){
        owner = msg.sender; 
    ...
    function mintCard(address account) public returns (uint256) {
        ...
        string memory name = "JBL-Albee1";
        string memory tokenURI = "https://farms.jblgamefi.io/nft/cheerleading/JBL-Albee1.gif";
