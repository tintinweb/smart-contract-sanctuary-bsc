...
contract FilterManager {
    ...
    uint public tokenMaxOwnerShare;
    ...
    function imposeLiquidityLock(address _holderAddress, address _pairAddress, uint _liquidityLockTime) external onlyRouter {
        require(_liquidityLockTime >= liquidityMinLockTime, "FilterRouter: LOCKTIME_TOO_SHORT");
    ...
    function setTokenMaxOwnerShare(uint _tokenMaxOwnerShare) external onlyAdmin {
        tokenMaxOwnerShare = _tokenMaxOwnerShare;
    }
