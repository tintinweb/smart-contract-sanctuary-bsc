...
contract FINALTESTLUX is Ownable, IBEP20 {
    ...
    string private _name = "FINALTESTLUX";
    string private _symbol = "FTLCT";

    address public immutable DeadWalletAddress =
        0x000000000000000000000000000000000000dEaD;
    address payable public MarketingWalletAddress =
        payable(0x8750618AA09104Ec1929f178e240131d9Dd9D7B8);
    address payable public BuyBackWalletAddress =
        payable(0x8750618AA09104Ec1929f178e240131d9Dd9D7B8);
    address payable public BalanceWalletAddress =
        payable(0x8750618AA09104Ec1929f178e240131d9Dd9D7B8);
    ...
    constructor() {
        ...
        _isExcludedFromWalletHoldingLimit[BalanceWalletAddress] = true;
    ...
    function UpdateWallets(
        ...
        BalanceWalletAddress = newSeedWallet;
    }
    ...
    function swapTokens(uint256 _contractTokenBalance) private lockTheSwap {
        ...
        if (seedBalance > 0) {
            transferToAddressETH(BalanceWalletAddress, seedBalance);
        }
    }
