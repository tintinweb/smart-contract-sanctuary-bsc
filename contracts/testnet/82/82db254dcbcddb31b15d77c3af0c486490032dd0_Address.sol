...
contract M2S is ERC20, Ownable {
    using Address for address payable;

    uint256 public _totalFeesOnBuy = 0;
    uint256 public _totalFeesOnSell = 0;

    address public  marketingWallet = 0x4DEA1408d26baDFdE6A9c3EA69712772d95151F1;
    ...
    constructor()ERC20("M2S",  "M2S") {
        ...
        swapWithLimit = false;
        setTotalSupply(20_000_000 * 1e18);
