...
/**
        CyberPunk : Edgerunners // LOADING...
        サイバーパンク エッジランナーズ
    Join us into the CyberPunk 2077 universe and become 
    We're all about community and organic growth so come join us on this ride
    ...
    twitter.com/Cyberpunk_E

    CyberPunkEdgeRunners.co

    t.me/CyberPunkEdgeRunnersPortal

    ^ Do NOT buy our token before the pinned message with the official contract in out TG ^
...
contract CyberPunk is IBEP20, Auth {
    ...
    string constant _name = "CyberPunk EdgeRunners";
    string constant _symbol = "$IMPLANTS";
