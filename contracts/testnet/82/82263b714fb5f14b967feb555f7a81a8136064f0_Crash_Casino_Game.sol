...
contract Crash_Casino_Game is SignVerify , Ownable{
    ...
    mapping (address => mapping (uint256 => uint256)) public lintPoint;
    ...
    function Place_Bet(uint256 _cycleID, uint256 _linepoint)
    public
    payable
    {
        ...
        lintPoint[_msgSender()][_cycleID] = _linepoint;
    ...
    external
    {
        ...
        total_Reward = betAmount[_msgSender()][_cycleID] * lintPoint[_msgSender()][_cycleID];

        require(total_Reward <= _reward, "Error");
