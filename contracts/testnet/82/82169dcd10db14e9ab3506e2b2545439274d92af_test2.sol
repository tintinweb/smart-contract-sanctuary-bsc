...
contract BNBDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("BNB_Dividend_Tracker", "BNB_Dividend_Tracker") {
        claimWait = 86399;
    ...
    function withdrawDividend() public pure override {
        require(false, "BNB_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main AC contract.");
    }
...
contract test2 is ERC20, Ownable {
    ...
    constructor() ERC20("Senet", "Senet") {
        ...
        */
        _createTokens(owner(), 20000000 * (10**18));
    }
...
//this will be used to exclude from dividends
    function excludeFromDividends(address account) external onlyOwner {
