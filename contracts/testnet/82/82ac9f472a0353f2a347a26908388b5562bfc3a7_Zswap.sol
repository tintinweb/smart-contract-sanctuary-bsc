...
contract Zswap {
    ...
    function sell(uint256 orderno) public {
        ...
        else if(user.balance>=100 && user.balance<500){
            txnfee = 15e17;
        }
        else if(user.balance>=500 && user.balance<1000){
            txnfee = 2e18;
        }
        else if(user.balance>=1000 && user.balance<5000){
           txnfee = 25e17;
        }
