...
contract Flamcoin is Context, IERC20, Ownable,Initializable {   
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance,uint TaxType) internal lockTheSwap {
        ...
        EachPer=100/(_liquidityTax[TaxType].add(_marketingTax[TaxType]).add(_developmentTax[TaxType]).add(_rewardTax[TaxType]));
        ...
        emit SwapAndLiquify(liquidityHalf.add(forMarketing), Balance);
