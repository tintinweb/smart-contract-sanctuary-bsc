...
contract MowaWhealthy is Ownable, ReentrancyGuard {
    ...
    function claimWhealthy() public payable nonReentrant {
        ...
        if(whealthy[_msgSender()].winner == true){
            uint256 price = whealthy[_msgSender()].priceCal.mul(2);
    ...
    function changeWinner(address user) public nonReentrant {
        require(_msgSender() == botChangeWinner, "require address safe");
