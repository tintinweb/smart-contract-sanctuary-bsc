...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6d52741AB15831D6a4A1b8a1b0832B133fAcb75e;
...
contract COMF is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6d52741AB15831D6a4A1b8a1b0832B133fAcb75e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Cattle Inu";
    string private _symbol = "CATU";
