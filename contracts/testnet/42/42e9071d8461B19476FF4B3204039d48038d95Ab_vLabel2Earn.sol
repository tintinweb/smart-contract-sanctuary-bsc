...
contract vLabel2Earn is IBEP20, Auth {
    ...
    string constant _name = "vLabel2Earn";
    string constant _symbol = "vL2E";
    ...
    uint256 public swapThreshold = 320000 * (10 ** _decimals);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {																		  
        ...
        if(sender == pair && competitionRewardPercent != 0 && !isFeeExempt[recipient] && sender != address(this) && recipient != address(this)){
