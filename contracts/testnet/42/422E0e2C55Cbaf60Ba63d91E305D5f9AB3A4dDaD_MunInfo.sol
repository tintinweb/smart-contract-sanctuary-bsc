...
contract MunInfo is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function getBundles() external returns (uint256[6][17] memory bundleStats) {
...
interface IMunicipality {
    ...
    function getPriceForSuperBundle(uint8 _bundleType, address _user) external returns(uint256,uint256);
