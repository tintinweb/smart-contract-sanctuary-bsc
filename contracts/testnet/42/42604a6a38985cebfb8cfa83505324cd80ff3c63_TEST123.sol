...
contract TEST123 is Context, IERC20, Ownable {
    ...
    event setWildlifeAddress(address indexed previous, address indexed adr);
    ...
    string private constant _name = "TEST13";
    ...
    function sendBNBToFee(uint256 amount) private {
        uint256 _wildlifeFund = amount.mul(_wildlifeFee).div(7);
