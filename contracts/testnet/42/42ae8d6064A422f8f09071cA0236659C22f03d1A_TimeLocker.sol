...
contract TimeLocker is Ownable {
    ...
    event Release(address beneficiary, uint256 amount, address locker, uint256 balance);
    ...
    function release() public virtual returns (bool) {
        ...
        tl.released += vested;
        timeLocks[msg.sender] = tl;
        emit Release(msg.sender, vested, address(this), token.balanceOf(address(this)));
