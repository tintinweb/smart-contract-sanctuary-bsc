...
contract DecubateNFT is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  function mint(address _user, uint256 _number) external nonReentrant onlyOwner {
    uint256 supply = uint256(totalSupply());
    require(supply + _number <= maxSupply, "Not enough NFT left.");
    _internalMint(_number, _user);
  }
