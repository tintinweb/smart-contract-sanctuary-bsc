...
contract FLOKIClone7 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x954D5FbF4a71f2E14D52A98923E166D440341Bab); // Marketing Address
    ...
    string private _name = "FLOKIClone7";
    string private _symbol = "FLOKIClone7";
    ...
    //add lines change private to public on the feerate
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x954D5FbF4a71f2E14D52A98923E166D440341Bab);
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        //new lines
        uint256 burnAmt = amount.mul(_taxFee).div(100);
