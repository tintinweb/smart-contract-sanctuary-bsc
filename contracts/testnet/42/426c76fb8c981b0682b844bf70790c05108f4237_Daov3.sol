...
contract  Daov3  is ERC20,  Ownable  {
    ...
    constructor(
       ...
       address _jiAddress
    ) ERC20("FIRE0717A", "FIRE0717A") {
        _mint(msg.sender, 8000000 * 1 ether );
        ...
        //usdt= 0xeDfa2FF20B7DA5e7ba525713718AE8DBea1F3F82; //GANACHE
        //usdt= 0xfCaB3BFa23B574b4F6295A60fE17A80EDF0265AE; //BSC56
        usdt= 0x56E7A21f0731BccF7076cFD8805Eb9DF64FCA028; //BSC97
        //_swapV2Router = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //bsc56
        _swapV2Router= 0x3E2b14680108E8C5C45C3ab5Bc04E01397af14cB; //bsc97
         uniswapV2Router = IUniswapV2Router02(_swapV2Router);//路由合约实例
         _swapV2Pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(
             address(this),
             usdt
         );//配对LP地址
       // _swapV2Pair=0xeDfa2FF20B7DA5e7ba525713718AE8DBea1F3F82;//ganache
        //_swapV2Pair=0xfCaB3BFa23B574b4F6295A60fE17A80EDF0265AE;  //BSC56 usdt
