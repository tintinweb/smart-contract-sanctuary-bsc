...
contract Armies is NI {
    ...
    bool armiespaused = false; // TODO: put on true on release
...
contract SOLDAT is ERC20, AI {
    ...
    address public RewardPool = 0xAf601dBC7Be0194fC41d49F83B4B29dd49289a91;
    ...
    constructor(address _owner) ERC20("Test Coin", "ABC") {   //TODO: CHANGE BEFORE DEPLOY!
        Owner = _owner;
        _mint(msg.sender, 1300000 * 10**_decimals); //TODO: Used for debugging. Remove before deploy
