...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minTokensToGetDividends = 0;
    ...
    function distributeDividend(address shareholder) internal {
        // TODO add a modifiable minimum amount of tokens
...
contract LibEarn is IBEP20, Auth {
    ...
    uint256 public _maxTxAmount = _totalSupply.mul(300).div(Denominator); // 3%
    uint256 public _maxBalanceAmountPeerWallet =
        _totalSupply.mul(1000).div(Denominator); // 10%
    ...
    // Is there some set functions for this?
    ...
    // @notice this is related to swap
    ...
    ///@notice that fees can be set without overpassing the 15%
    ...
    // TODO change to individual sets
