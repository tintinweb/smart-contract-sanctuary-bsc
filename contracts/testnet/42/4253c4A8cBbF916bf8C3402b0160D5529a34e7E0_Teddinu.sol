...
contract Teddinu is ERC20Detailed, Ownable {
    ...
    constructor()
        ...
        Ownable()
    {
        router = IPancakeSwapRouter(0x89e310DB3feB95cf8eFD1EB47d9e0f2261E0f6bb);
        pair = IPancakeSwapFactory(router.factory()).createPair(
            router.WETH(),
            address(this)
        );

        autoLiquidityReceiver = 0x47Bde09a0143A5B83C4fd06e4717D3Db037432E8;
        treasuryReceiver = 0x05C632898F8b5f01f4264eE8948281704F9B0B2e;
        tedRiskFreeValueReceiver = 0x6a4c04FAB0f734b4287315bFed655dab2E0Ed1f8;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.mul(_treasuryFee.add(_tedRiskFreeValueFee)).div(
                feeDenominator
            )
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndRFV.mul(treasuryFee).div(
                treasuryFee.add(tedRiskFreeValueFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(tedRiskFreeValueReceiver).call{
            value: amountETHToTreasuryAndRFV
                .mul(tedRiskFreeValueFee)
                .div(treasuryFee.add(tedRiskFreeValueFee)),
            gas: 30000
        }("");
    }
