...
//0x455129096143277f9aC320Ddc4d7aED2b8F3a5a8
contract FactoryMockToken {
    ...
    mapping(address => bool) public issueAble;

    constructor() {
        owner = msg.sender;
        issueAble[msg.sender] = true;
    }

    function updateIssueAbleAddress(address issueAddress, bool isIssueAble) public {

        require(msg.sender == owner, "Only owner");
        issueAble[issueAddress] = isIssueAble;
    }

    function issueYourToken(string memory name, string memory symbol) public {
        require(issueAble[msg.sender], "Only issue address");
