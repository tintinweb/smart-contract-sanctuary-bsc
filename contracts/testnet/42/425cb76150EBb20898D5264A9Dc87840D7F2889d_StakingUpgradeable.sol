    ...
    UUPSUpgradeable
{
        ...
        returns (address[] memory stakersList, uint256 stakersCount)
    {
        ...
        address[] memory _stakersListWithoutZeroAddress = new address[](
            _stakersCount
        );
        uint256 _stakersCountWithoutZeroAddress;

        for (uint256 i; i < _stakersCount; i++) {
            if (_stakersList[i] == address(0)) {
                continue;
            } else {
                _stakersListWithoutZeroAddress[
                    _stakersCountWithoutZeroAddress
                ] = _stakersList[i];
        ...
        stakersList = _stakersListWithoutZeroAddress;
        stakersCount = _stakersCountWithoutZeroAddress;
    }
