...
contract MyContract {
    ...
    function getEggsSinceLastHatch(address adr) public view returns(uint256){
        ...
        uint256 curHoney = SafeMath.mul( SafeMath.div(users[adr].miners,ETH_TO_10000_MINERS * 1e3)  ,cutoffTime);
    ...
    function calculateTrade(uint256 eth) public view returns(uint256){
        ...
        return SafeMath.div(SafeMath.mul(ETH_TO_10000_MINERS,eth),1e18);
