...
contract LEYECOM is Context, IERC20, Ownable {
    ...
    string private _name = "UNOTI";
    string private _symbol = "UNOTI";
    ...
    OurLinks public links;

    OurMission public mission;
    ...
    constructor() {
        ...
        links.WebSite = "5"; //WebSite Link
        links.Telegram = "abuk"; //Telegram Link
        links.Twitter = "sub"; //Twitter Link
        links.Medium = "sub"; //Medium Link
        links.Github = "sub"; //Github Link
        links.Tiktok = "sub"; //Tiktok Link
        links.WhitePaper = "sas"; //Whitepaper Link
        links.LeyeSwap = "sub"; //LeyeSwap Link
        
        mission.OurMission = "New"; //OurMission
    ...
    uint256 public totalFee        = _marketingFee + _burnFee + _liquidityFee + _taxFee + _marketingLiquifyFee;

    
    function setOurMission(
        string memory SetOurMission
        
    ) external onlyOwner {
        mission.OurMission = SetOurMission;
    ...
    function setOurLinks(
        ...
        links.WebSite = SetWebsite;
        links.Telegram = SetTelegram;
        links.Twitter = SetTwitter;
        links.Medium = SetMedium;
        links.Github = SetGithub;
        links.Tiktok = SetTiktok;
        links.WhitePaper = SetWhitePaper;
        links.LeyeSwap = SetLeyeSwap;
    }
