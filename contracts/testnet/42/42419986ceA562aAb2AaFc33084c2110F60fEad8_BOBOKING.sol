...
contract BOBOKING is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "B0B0";
    string private _symbol = "BB";

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF7A6880de2E28324645457447D2bD8dE84f9F8ad); 
    address payable public BurnedWalletAddress = payable(0xF7A6880de2E28324645457447D2bD8dE84f9F8ad); 
