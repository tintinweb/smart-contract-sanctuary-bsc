...
contract AA_QB is Context, IERC20 { 
    ...
    */
    ...
    uint256 public _fee_Liquidity   = 9; // Auto Liquidity Fee
    ...
    */
    ...
    function _set_Fees(uint256 Marketing, uint256 Liquidity) external onlyOwner() {
        ...
        require(Marketing + Liquidity + _fee_Developer <= 20, "Fees too high");  // XXX CHECK LIMIT
    ...
    */
    ...
    function swapAndLiquify(uint256 Tokens) private lockTheSwap {
        ...
        uint256 totalFees = _fee_Liquidity + _fee_Developer + _fee_Marketing;
        uint256 percent_L = _fee_Liquidity * 100 / totalFees;
        uint256 percent_D = _fee_Developer * 100 / totalFees;
