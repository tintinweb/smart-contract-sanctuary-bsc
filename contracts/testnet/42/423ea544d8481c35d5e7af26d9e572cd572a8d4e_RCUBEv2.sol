...
contract RCUBEv2 is ERC20Detailed, Ownable {
    ...
    mapping(address => bool) public _isNoRebase;
    ...
    function balanceOf(address who) public view override returns (uint256) {
        return
            _isNoRebase[who]
                ? _gonBalances[who]
                : _gonBalances[who].div(_gonsPerFragment);
    }
    ...
    function _basicTransfer(
        ...
        uint256 gonAmount = _isNoRebase[from]
            ? amount
    ...
    function _transferFrom(
        ...
        uint256 gonAmount = _isNoRebase[sender]
            ? amount
            : amount.mul(_gonsPerFragment);
    ...
    function noRebaseAddress(address account, bool value) external onlyOwner {
        _isNoRebase[account] = value;
    }
