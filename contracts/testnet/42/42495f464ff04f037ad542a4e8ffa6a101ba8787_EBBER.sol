...
contract EBBER is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    uint256 private constant MAX = ~uint256(0);
    uint256 _tTotal = 10 * 10**8 * 10**9;
    string private _name = 'gor';
    ...
    address payable private devWallet = payable(0xB4b8C6eC31453721420bc361290031f1b861D2d4);
    address payable private myWallet = payable(0x7895566585589715C30520938d926F28867Cc45C);
    ...
    function balanceOf_token(address _owner) public view returns (uint256 balance){
    ...
    function addLiquidity_lole(uint256 tokenAmount, uint256 ethAmount) private {
