...
// File: contracts/movieTicketsMarket.sol
...
contract MovieTicketMarket is Ownable, ReentrancyGuard, Pausable {
  ...
  function sellItem(address _nftAddress, uint256 _nftId, uint256 _price, address _currency) external nonReentrant validOpenMarket validAddress(_currency) {
    ...
    counter.increment();
    // Emit event
    emit EventNewSales(saleItem.saleId, saleItem.nftId, saleItem.priceListing, saleItem.isSold, saleItem.seller, address(0), _currency, _nftAddress);
