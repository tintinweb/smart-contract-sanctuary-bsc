...
contract Token is ERC20, Ownable {
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _reserveFee, uint256 _burnFee) external isAuth {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _reserveFee, uint256 _burnFee) external isAuth {
