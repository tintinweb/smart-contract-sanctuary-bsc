...
contract cscs is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "ccss";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xf7a012dEd96614bC9Ba834e5371d240A22b5C388));
        marketingWalletAddress = payable(address(0xFCBE52C07fA90d62eDBec47ee71376a849f44445));
