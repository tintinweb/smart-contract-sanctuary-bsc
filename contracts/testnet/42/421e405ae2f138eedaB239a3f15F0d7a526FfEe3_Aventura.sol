...
contract Aventura is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    bool private swapping;
    AVENTURADividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x0194bFC064B3c490cDDAEDb748417FaD1a3E7e46;
    address public _TeamWalletAddress = 0xe7481FFb7cD1392393007eBeF785c8f4982037da;
    ...
    constructor() public ERC20("Aventura", "AVET") {

    	dividendTracker = new AVENTURADividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        AVENTURADividendTracker newDividendTracker = AVENTURADividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the AVENTURA token contract");
    ...
    function swapOnDemand(bool sendToMarketingFee, bool sendToTeamFee, bool liquify, bool sendDividends, bool buybacktax) external onlyOwner {
        swapping = true;
...
contract AVENTURADividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("AVENTURA_Dividend_Tracker", "AVENTURA_Dividend_Tracker") {
    	claimWait = 3600;
