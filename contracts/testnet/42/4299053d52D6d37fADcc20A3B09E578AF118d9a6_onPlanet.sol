...
contract onPlanet is Context, IERC20, Ownable {
    ...
    address payable public devAddress= payable(0xE813d775f33a97BDA25D71240525C724423D4Cd0); 
    address payable public marketingAddress = payable(0xE813d775f33a97BDA25D71240525C724423D4Cd0); 
    ...
    // Update before deployment <<==================================================================<<<<<<<<<<<<<<<<<<<<<<<<<<
    // Update before deployment <<==================================================================<<<<<<<<<<<<<<<<<<<<<<<<<<
    address public _buyback_token_addr = 0x53F7Cf143d43B2BC4c21249DD6F3d2Ea7c080e2d;
