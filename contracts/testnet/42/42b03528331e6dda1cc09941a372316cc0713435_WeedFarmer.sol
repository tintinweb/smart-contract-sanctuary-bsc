...
contract WeedFarmer {
    ...
    uint8 public TOP_DEPOSIT_1_PERCENT = 10;
    ...
    //uint256 public LOTTERY_STEP = 86400; // 24 hrs MAINNET
    uint256 public LOTTERY_STEP = 60; // 24 hrs
    uint256 public LOTTERY_TICKET_PRICE = 20 * 1e15; //  0.02BNB aprox. 5 busd
    uint256 public MAX_LOTTERY_TICKET = 20;
    uint256 public MAX_LOTTERY_PARTICIPANTS = 1000;
    uint256 public MAX_LOTTERY_POOL_PER_ROUND = 5 ether;
   ...
   // uint public startTime = 1671476400; // Monday, 19 December 2022 20:00:00 UTC https://www.unixtimestamp.com/ //mainnet
	...
	constructor(address payable _treasury) {
        ...
        plans.push(Plan( 90, 150,  2 * 1e16, 50 ether, 0, 0, 0, 0, true));
    ...
    function _buyTickets() public payable {
       ...
       // require(msg.value % 0.02 == 0, "wrong ticket amount");
    ...
    function setTopDepositPercent() external{
        require(msg.sender == owner, "Admin use only");
        delete pool_bonuses;
        pool_bonuses.push(TOP_DEPOSIT_1_PERCENT);
        pool_bonuses.push(9);
        pool_bonuses.push(8);
        pool_bonuses.push(7);
        pool_bonuses.push(6);
