...
// 每天10% 回购销毁
    ...
    constructor() public {
        ...
        catToken = 0x667dE2dDA32C02f6658ec9d243adDc1ab6487059;
    ...
    // function receiveProfit(address _addr,uint256 _amount) external returns (bool){
    //     require(devOwner[msg.sender]==true,' not dev');
    //     IERC20(usdtToken).transfer(_addr,_amount);
    // }
