...
contract Token is ERC20, Ownable {
    ...
    uint256 private constant INITIAL_SUPPLY = 100000000 ether; //start supply

    mapping(address => uint256) private _timestamps;

    // корректировка времени в соответсвии с ТЗ
    uint256 public timeDelay = 1 hours; //time of profit

    uint256 public percentages = 10; //10 = 0.01% profit

    // 5%
    uint256 private TAX_FEE = 5000; //5000 = 5% fee
    ...
    constructor() ERC20("Rimer Finance", "Rimer") { //name, simbol
    ...
    // функция расчёта 0,01% от размера эмиссии токена
