...
contract LezmeWalletContract is Ownable {
    ...
    */
    function withdrawToken(string memory _username, address _to, uint256 _amount, string memory _message, uint256 _expiredTime, bytes memory _signature) public {
        ...
        require(ILezmeSignature(lezmeVerifySignature).isWithdrawERC20Valid(_to, _amount, _message, _expiredTime, _signature), "Lezme: signature verification failed");
...
interface ILezmeSignature {
    function isWithdrawERC20Valid(address _to, uint256 _amount, string memory _message, uint256 _expiredTime, bytes memory signature) external view returns (bool);

    function isWithdrawERC721Valid(address _to, uint256 _id, string memory _message, uint256 _expiredTime, bytes memory signature) external view returns (bool);

    function isWithdrawERC1155Valid(address _to, uint256 _id, uint256 _amount, string memory _message, uint256 _expiredTime, bytes memory signature) external view returns (bool);
}
