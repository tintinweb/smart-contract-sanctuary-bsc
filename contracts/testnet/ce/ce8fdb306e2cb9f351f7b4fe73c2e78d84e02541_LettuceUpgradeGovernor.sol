...
// File: contracts\governance\LettuceUpgradeGovernor.sol

pragma solidity 0.8.15;
contract LettuceUpgradeGovernor is Governor, GovernorCompatibilityBravo, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {

    uint256 public votingDelayParam;
    uint256 public votingPeriodParam;
    uint256 public proposalThresholdParam;

    constructor(
        IVotes _token,
        TimelockController _timelock,
        uint256 _quorumFraction,
        uint256 _votingDelayParam,
        uint256 _votingPeriodParam,
        uint256 _proposalThresholdParam)
    Governor("LettuceUpgradeGovernor")
    GovernorVotes(_token)
    GovernorVotesQuorumFraction(_quorumFraction)
    GovernorTimelockControl(_timelock)
    {
        votingDelayParam = _votingDelayParam;
        votingPeriodParam = _votingPeriodParam;
        proposalThresholdParam = _proposalThresholdParam;
    }

    function votingDelay() public view override returns (uint256) {
        return votingDelayParam;
    }

    function votingPeriod() public view override returns (uint256) {
        return votingPeriodParam;
    }

    function proposalThreshold() public view override returns (uint256) {
        return proposalThresholdParam;
    }
