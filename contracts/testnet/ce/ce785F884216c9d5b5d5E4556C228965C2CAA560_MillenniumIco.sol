...
contract MillenniumIco {
    ...
    //Token price in BNB
    uint256 public _price = 0.00036 ether;
    // Token price in USD
    ...
    address public busd = 0xb4F75D33d6B723289568A94D83fF6F93531dC838;
    address public usdt = 0x5730E5C8a37B6f24827809628022ADaF36139111;

    uint256 level1 = 3;
    uint256 level2 = 5;
    uint256 level3 = 10;   

    uint256 public minSaleAmount = 100;
    ...
    constructor () {
        owner = msg.sender;
        token_address = 0xC23D22BeecD8Af4E816e973afEA7D4c9dA1C3226;
    }
    ...
    function getBUSDSaleAmount(uint256 baseAmount) public view returns (uint256 busdAmount) {
        busdAmount = _usdPrice * baseAmount;
    }
    ...
    function buyMLXwithTokens(address _ref, address tokentoBuy, uint256 tokenAmount) external isSale(tokenAmount) {
        IERC20 token = IERC20(token_address);
        uint256 tokensToSend = tokenAmount*10**18;
