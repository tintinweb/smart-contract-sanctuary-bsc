...
contract SilverMoonTamaTest is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SilverMoonTamaTest";
    string constant _symbol = "SMTT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100 * 10**6 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.mul(1).div(25);
    uint256 public _maxWalletToken = _totalSupply.mul(2).div(2);
    ...
    uint8 public cooldownTimerInterval = 61;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x13b03E1Cc97a7De6630f5E66a727483E2d256d20;
        ecosystemfeeReceiver = 0x559FAE021F2CDc51e1bBc5614C7c632b5d8C8821;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (sender == pair &&
            ...
            require(cooldownTimer[recipient] < block.timestamp,"Please wait longer between two buys");
