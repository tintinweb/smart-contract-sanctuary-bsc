...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9035FBCc300dCcb409631227574BCa6Bf2282f16; // owner address
...
contract Ape is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9035FBCc300dCcb409631227574BCa6Bf2282f16); // Marketing Address
    address payable public teamWalletAddress = payable(0x9035FBCc300dCcb409631227574BCa6Bf2282f16); // Team Address
