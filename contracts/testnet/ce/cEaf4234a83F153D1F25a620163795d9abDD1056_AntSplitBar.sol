...
// AntSplitBar with Governance.
contract AntSplitBar is BEP20('AntSplitBar Token', 'ANTSPLIT') {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (MasterAnt).
...
contract AntToken is BEP20('AntFinance', 'ANT') {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (MasterAnt).
    function mint(address _to, uint256 _amount) public onlyOwner {
        _mint(_to, _amount);
        _moveDelegates(address(0), _delegates[_to], _amount);
    ...
    constructor()public{
        mint(msg.sender,10000000000000000000000000000000000000000000000000000000);
    }
