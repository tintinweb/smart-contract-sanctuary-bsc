...
contract PearlMine{
    ...
    function incomes(address _owner) public view returns (uint256 total_income, uint256 direct_income, uint256 pool_income, uint256 all_company_business, uint256 all_users) {
        return (balances[_owner], direct_balances[_owner], pool_balances[_owner], total_business[0], allUsers.length);
    }
