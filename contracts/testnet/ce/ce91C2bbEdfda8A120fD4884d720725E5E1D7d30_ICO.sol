...
// Smart contract address deployed on BSCTestnet: 0xce91C2bbEdfda8A120fD4884d720725E5E1D7d30
...
contract ICO is ERC20, Ownable {
    ...
    constructor() ERC20("CyberConnectTokens", "CCT") { // initializing a child constructor by using the properties of the parent contract
        
        _mint(msg.sender, 9000000000000000000000000000000000000000000000000); // this method is used to create new tokens
