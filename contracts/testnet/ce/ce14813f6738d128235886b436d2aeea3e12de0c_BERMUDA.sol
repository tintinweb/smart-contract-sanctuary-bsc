...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
    ...
    address public RWRD = address(0xE1fa671882aAE000a99194F994565572E322B09d);
...
contract BERMUDA is IERC20Metadata, Ownable {
    ...
    address public RWRD = address(0xE1fa671882aAE000a99194F994565572E322B09d); // Reward Token
    ...
    function setIsTriangle (address triangle, bool isTriangle) external onlyOwner {
        ...
        isBermudaTriangle[triangle] = isTriangle;
