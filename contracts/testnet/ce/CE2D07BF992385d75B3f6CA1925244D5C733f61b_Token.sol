...
contract Token is Initializable, IERC20Upgradeable, OwnableUpgradeable {
    ...
    event UpdateMinimumTokensBeforeSwapAmount(uint256 minimumTokensBeforeSwap);
    ...
    event SetBuyFee(uint256 buyTaxFee, uint256 buyLiquidityFee, uint256 buyMarketingFee);
    event SetSellFee(uint256 sellTaxFee, uint256 sellLiquidityFee, uint256 sellMarketingFee);
    ...
    function initialize(
        ...
        gasLimitActive = true;
        gasPriceLimit = _uint_params[10] * 1 gwei;
        ...
        marketingAddress = payable(_marketingAddress); // update to marketing address
        liquidityAddress = payable(_liquidityAddress); // update to a liquidity wallet if you don't want to burn LP tokens generated by the contract.
        ...
        excludeFromMaxTransaction(address(pancakeRouter), true);
    ...
    function setMinimumTokensBeforeSwapAmount(uint256 _minimumTokensBeforeSwap)
        external
    {
        minimumTokensBeforeSwap = _minimumTokensBeforeSwap;
        emit UpdateMinimumTokensBeforeSwapAmount(minimumTokensBeforeSwap);
    }
        ...
        onlyOwner
    {
        ...
        require(pair != address(0), "The pair cannot be address 0");
    ...
    function removeGasLimit() external onlyOwner returns (bool) {
    ...
    function setMarketingAddress(address _marketingAddress) external onlyOwner {
        require(
            _marketingAddress != address(0),
            "marketing Wallet can not be 0 address!"
        );
