...
contract DexSpace is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500000000 * 10**_decimals;     // Supply do Token = 500 Millions
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _maxTxAmount = 2500000 * 10**_decimals;    // 2.5 millions - Initial max buy
    uint256 public _maxRxAmount = 1250000 * 10**_decimals;    // 1.25 - Initial max sell
	uint256 public _maxWallet = 25000000 * 10**_decimals;     // 25 millions - Initial max Wallet	
    uint256 public numTokensToSwap = 1000000 * 10**_decimals; // 1 million - Swap 
    ...
    string private constant _name = "DexSpace";
    string private constant _symbol = "DKSM";
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0xF485019203482da12244209E68C39F410CD632D6); // testnet
        pancakeswapV2Pair = IUniswapV2Factory(_PancakeSwapV2Router.factory())
            .createPair(address(this), _PancakeSwapV2Router.WETH());

        PancakeSwapV2Router = _PancakeSwapV2Router;
        marketingAddress = payable(0x409d6f2EA0ded3cd8E3fC6F77dBb2a245307820e); // wallet marketing bnb
