...
contract TOKENTEST is ERC20, Ownable {
    ...
    constructor(address _router,address _marketingWallet,uint256 initial_buy_taxes,uint256 initial_sell_taxes,address[] memory _airdrop,uint256[] memory _amounts) ERC20("TOIKEN", "$TKN")    payable{
