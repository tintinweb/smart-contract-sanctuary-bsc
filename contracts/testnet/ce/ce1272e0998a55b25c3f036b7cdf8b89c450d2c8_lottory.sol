...
contract lottory is Context, Ownable , ReentrancyGuard  {
   ...
   address public dev = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
   address public miner = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
...
// lotto 1 
    function lotto1Entry(uint256 _amount) public {
    ...
    function pickWinner_lotto1() public onlyOwner {
    ...
    function lotto2Entry(uint256 _amount) public {
          require(_amount == fixedAmount, "you cannot deposit less or more than 1 BUSD");
    ...
    function pickWinner_lotto2() public onlyOwner {
    ...
    function lotto3Entry(uint256 _amount) public {
          require(_amount == fixedAmount, "you cannot deposit less or more than 1 BUSD");
    ...
    function pickWinner_lotto3() public onlyOwner {
