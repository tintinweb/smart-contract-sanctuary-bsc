...
contract NFTMasterBlindBoxExchange is Ownable, ReentrancyGuard {
    ...
    event BoxExchange(address _user, address _nftToken, uint256 _nftTokenID, address _outputToken, uint256 _outputTokenID, uint256 _at);
    ...
    function setBoxInfo(uint256 _boxId, address _nftAddress, address[] memory _nftList, uint256[] memory _supplyList, bool _openStatus) public nonReentrant onlyAdmin {
        ...
        boxInfoList[_nftAddress] = NftInfo(_nftList, _supplyList, _openStatus);
    ...
    // get box info
    function getBoxInfo(address _nftAddress) public view returns (address, address[] memory, uint256[] memory, bool) {
        address[] memory _nftList = boxInfoList[_nftAddress].NFTList;
        uint256[] memory _supplyList = boxInfoList[_nftAddress].SupplyList;
        bool _openStatus = boxInfoList[_nftAddress].OpenStatus;
        return (_nftAddress, _nftList, _supplyList, _openStatus);
    }
    ...
    function boxExchange(address _nftAddress, uint256 _nftTokenID) public nonReentrant {
        ...
        ( , address[] memory _nftList, uint256[] memory _supplyList, ) = getBoxInfo(_nftAddress);
        ...
        emit BoxExchange(msg.sender, _nftAddress, _nftTokenID, _outputToken, _outputTokenID, block.timestamp);
    }
