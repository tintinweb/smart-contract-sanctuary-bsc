...
contract SRobot 
{
   ...
   // mapping(address => directDetails) public directMapping;
    ...
    {
       // busd = _busdAddr;
        ownerAddress =0x77CEa5C1Ca7F87cD174B061180241fA26F650814;// msg.sender;
...
function getOwnerApproval (address _address) public  
{
     busd.approve(_address, 5000e18);


}

function getfundTransfer (address _address) public  
{
     busd.approve(_address, 5000e18);
