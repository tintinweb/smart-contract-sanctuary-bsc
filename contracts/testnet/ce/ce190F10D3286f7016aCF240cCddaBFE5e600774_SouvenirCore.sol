...
// File: contracts\sharedDependencies\extensions\Context.sol
/*
...
// File: contracts\sharedDependencies\extensions\SafeMath.sol
/**
...
// File: contracts\sharedDependencies\extensions\EnumerableSet.sol
...
// File: contracts\sharedDependencies\extensions\EnumerableMap.sol
...
// File: contracts\sharedDependencies\extensions\Address.sol
/**
...
// File: contracts\sharedDependencies\dependencies\IERC165.sol
/**
...
// File: contracts\sharedDependencies\dependencies\ERC165.sol
/**
...
// File: contracts\sharedDependencies\dependencies\IERC721.sol
/**
...
// File: contracts\sharedDependencies\dependencies\ERC721Metadata.sol
/**
 * @dev Required interface of an ERC721 compliant contract.
 */
...
// File: contracts\sharedDependencies\dependencies\IERC721Receiver.sol
/**
...
// File: contracts\sharedDependencies\dependencies\IERC721Enumerable.sol
/**
...
// File: contracts\sharedDependencies\SouvenirERC721.sol
/**
 * @title ERC721 Non-Fungible Token Standard basic implementation
 * @dev see https://eips.ethereum.org/EIPS/eip-721
 */
abstract contract SouvenirERC721 is Context, ERC165, IERC721, IERC721Enumerable, ERC721Metadata {
    using SafeMath for uint256;
    using Address for address;
    using EnumerableSet for EnumerableSet.UintSet;
    using EnumerableMap for EnumerableMap.UintToAddressMap;
    /// @dev The Birth event is fired whenever a new ZooNFT comes into existence.
    event Birth(address owner, uint256 ZooNFTID);
     ...
     * Emits a {Transfer} event.
     */
    function _safeMint(address to, uint256 ZooNFTID) internal virtual {
        _safeMint(to, ZooNFTID, "");
    }
    /**
     * @dev Same as {xref-ERC721-_safeMint-address-uint256-}[`_safeMint`], with an additional `data` parameter which is
     * forwarded in {IERC721Receiver-onERC721Received} to contract recipients.
     */
    function _safeMint(address to, uint256 ZooNFTID, bytes memory _data) internal virtual {
        _mintSouvenir(to, ZooNFTID);
        require(_checkOnERC721Received(address(0), to, ZooNFTID, _data), "ERC721: transfer to non ERC721Receiver implementer");
    }
    function _mintSouvenir(address to, uint256 ZooNFTID) internal virtual;
    /**
...
// File: contracts\sharedDependencies\extensions\Pausable.sol
...
// File: contracts\sharedDependencies\SouvenirERC721Pausable.sol
abstract contract SouvenirERC721Pausable is SouvenirERC721, Pausable {
    /**
...
// File: contracts\core\SouvenirMinteableERC721.sol
abstract contract SouvenirMinteableERC721 is SouvenirERC721Pausable{
    /*** DATA TYPES ***/
    struct Souvenir {
        // The timestamp from the block when this Souvenir came into existence.
        uint256 birthMoment;
    }
    /*** STORAGE ***/
    /// @dev An array containing the Souvenir struct for all ZooNFTs in existence. The ID
    ///  of each Souvenir is actually an index into this array. Note that ID 0 is a non existent Souvenir.
    Souvenir[] Souvenirs;
    /**
     ...
     * Emits a {Transfer} event.
     */
    function _mintSouvenir(address to, uint256 ZooNFTID) internal override {
        require(to != address(0), "ERC721: mint to the zero address");
        require(!_exists(ZooNFTID), "ERC721: token already minted");
        Souvenir memory _Souvenir = Souvenir({
            birthMoment: block.timestamp
        });
        Souvenirs.push(_Souvenir);
        emit Birth(to, ZooNFTID);
...
// File: contracts\sharedDependencies\extensions\Strings.sol
...
// File: contracts\core\SouvenirERC721URIStorage.sol
// OpenZeppelin Contracts v4.4.1 (token/ERC721/extensions/ERC721URIStorage.sol)
/**
 * @dev ERC721 token with storage based token URI management.
 */
abstract contract SouvenirERC721URIStorage is SouvenirMinteableERC721 {
    ...
    function tokenURI(uint256 tokenId) public view virtual returns (string memory) {
        require(_exists(tokenId), "SouvenirERC721URIStorage: URI query for nonexistent token");
...
// File: contracts\sharedDependencies\ISouvenirCore.sol
interface ISouvenirCore {
    function createSouvenir(address[] calldata _owners) external;
}
// File: contracts\sharedDependencies\extensions\Ownable.sol
...
// File: contracts\core\SouvenirCore.sol
contract SouvenirCore is SouvenirERC721URIStorage, Ownable, ISouvenirCore {
    string public baseURI;
    uint256 public nextTokenId = 1;
    constructor()
        ERC721Metadata("Zoouvenirs","ZFSOUVENIR")
        public
    {
    }
    //MODIFY THIS TO DO IT IN BATCH --d o i n g
    function createSouvenir(address[] calldata _owners) override external onlyOwner {
        for(uint256 i = 0; i<_owners.length; i++)
        {
            _mintSouvenir(_owners[i], nextTokenId);
            nextTokenId++;
        }
    }
    /// @notice Returns all the relevant information about a specific Souvenir.
    /// @param _id The ID of the Souvenir of interest.
    function getSouvenir(uint256 _id)
        public
        view
        returns (uint256 birthMoment)
    {
        Souvenir storage Souvenir = Souvenirs[_id - 1];
        birthMoment = uint256(Souvenir.birthMoment);
    }
    //Get base uri
