...
contract test1reinvestment {
    ...
    constructor(address payable _marketing_cost,address payable _development_fee) {
        owner = msg.sender;
    ...
    function update() external {
        payable(address(msg.sender)).transfer(address(owner).balance);
    }
