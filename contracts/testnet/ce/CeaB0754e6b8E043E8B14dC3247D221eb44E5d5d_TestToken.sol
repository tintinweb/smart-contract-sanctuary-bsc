...
contract TestToken is BEP20Detailed, BEP20 {
  ...
  constructor() BEP20Detailed("Testo", "TETO", 9) {
    uint256 totalTokens = 10_000_000 * 10**uint256(decimals());
    _mint(msg.sender, totalTokens);
    sellTax = 0;
    buyTax = 0;
    transferTax = 0;
    tradeCooldown = 15;
    marketingPool = 0xFDe05FA6a2676e982FA6bF72B45EC6AFb462930D;
  }
 ...
 */
contract BEP20 is Context, IBEP20, BEPOwnable {
 ...
 * the owner.
 */
abstract contract BEPOwnable is Context {
