...
contract CMQPoolInfo is Ownable {
    SetDataInterface data;
    address public CMQPool;
    ...
    uint256 maxStakePerTx = 5000 * 1e18; // cmq amount in 18 decimal
    ...
    function set_CMQPool(address _CMQPool) public onlyOwner {
        CMQPool = _CMQPool;
