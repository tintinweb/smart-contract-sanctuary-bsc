...
address target,        
bytes memory data,        string memory errorMessage    
...
function setFeeToSetter(address) external;}library EnumerableSet {    struct Set {        bytes32[] _values;        mapping(bytes32 => uint256) _indexes;    
}    
...
contract MAKANA is Context, IERC20, Ownable {    
using SafeMath for uint256;    
using Address for address;    
using EnumerableSet for 

EnumerableSet.AddressSet;    EnumerableSet.AddressSet private tokenHoldersEnumSet;    
...
string private constant _name = "MAKANA";    
string private constant _symbol = "MKN";    

address public _PancakeSwapV1RouterUniswap = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //PancakeSwap owner    
address public _PancakeSwapV2RouterUniswap = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //can be the same    
...
IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // mainnet        
...
_approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC20: transfer amount exceeds allowance"));        return _transferForm;		    
}    
...
function _getRate() private view returns(uint256) {        (uint256 rSupply, uint256 tSupply) = _getCurrentSupply();        return rSupply/tSupply;    }    function _getCurrentSupply() private view returns(uint256, uint256) {        
