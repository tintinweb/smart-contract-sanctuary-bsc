...
library SafeMath {
 ...
 contract BBNB is IERC20, Ownable {
    ...
    constructor (
        ...
        //这里记得改
        minimumTokensBeforeSwap = 2 * 10 ** _decimals;
        //bnb分红最低数
        ...
        MarketingAddress = 0x287ad11FD751eA74c0DCc2760145f1bDf2d383Cb;
        RepoAddress = 0xE0262E126858335693F68Ec47560942434148FCC;
    ...
    function set_feeWhiteList(address[] memory addList,bool val) external onlyOwner{
        for (uint i=0; i < addList.length; i++) {
    ...
    function addHolder(address adr) private {
     ...
     function popHolder(address addr) external onlyOwner{
