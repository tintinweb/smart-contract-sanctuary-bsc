...
contract WomexPrivateSale is Ownable {
    ...
    uint256 private minBnbAmount = 1 ether;
    ...
    function buyWomex(string memory userId) public payable {
        ...
        userBalances[userId] += womexAmount;

        emit PurchaseCompleted(userId, womexAmount, msg.value);
    }
    ...
    function getUserBalance(string memory userId)
        public
        view
        returns (uint256)
    {
