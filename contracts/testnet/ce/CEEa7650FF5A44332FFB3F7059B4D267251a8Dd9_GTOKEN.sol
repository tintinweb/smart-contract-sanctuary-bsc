...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF965358185f6a454a6C6e867b35Ffd69AC4F6b99;
...
contract GTOKEN is Context, IERC20, Ownable, Pausable {
    ...
    address private _developmentWalletAddress = 0x497308D119c9b3063690a819f8e441DBcA0F0a35;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TESTR";
    ...
    function isExcludedFromReward(address account) public whenNotPaused view returns (bool) {
        return _isExcluded[account];
    }
    function totalFees() public whenNotPaused view returns (uint256) {
        return _tFeeTotal;
    }
