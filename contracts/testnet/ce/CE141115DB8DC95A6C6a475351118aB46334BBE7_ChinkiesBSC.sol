...
contract ChinkiesBSC is ERC721, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    uint256 public _price = 330000000000000000;
    ...
    function togglePublicSale() public onlyOwner {
        ...
        if (publicMode) {
            adjustMintPriceInWei(330000000000000000);
            whitelistMode = false;
            freemintMode = false;
        }
    }
    ...
    function toggleWhitelist() public onlyOwner {
        ...
        if (freemintMode) {
            adjustMintPriceInWei(200000000000000000);
            publicMode = false;
            freemintMode = false;
        }
    }
