...
contract TokenFactoryDef is Ownable {
    using Address for address;
    using SafeMath for uint256;
    using SafeMath for uint8;
    using SafeMath for uint;
    ...
    function deployProToken(      
        ...
        return address(new proToken(router, name, symbol , decimals , totalSupply , owner , devAddress , feeReflection, feeLiquidity,feeBurn,feeDev));
    }
