...
contract EAGLE is ERC20, Ownable {
    ...
    constructor(
        ...
        MarketingWallet = 0xbe40D7E70e8db723Eff55FB151D905b49D731C97;
        EAGLENFTAddress = IEAGLENFT(0x6BEB2e9885e30d555C9B0f8507dbc1D6cC16601e);
...
//    }
    ...
    public
    {
        ...
        path_[0] = pancakeSwapV2Router.WETH();
        path_[1] = address(usdt);
        // make the swap
        uint256 ethAmount = address(this).balance;
        pancakeSwapV2Router.swapExactETHForTokens{value:ethAmount}(
            0, // accept any amount of token
            path_,
            address(this),
            block.timestamp + 360
    ...
    // TODO to receive ETH from uniswapV2Router when swapping
