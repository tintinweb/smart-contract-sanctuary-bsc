    ...
    IERC721ReceiverUpgradeable
{
    ...
    uint32 public minPricePercentatge;
  ...
  modifier auctionOngoing(address nftContractAddress, uint256 tokenId) {
    ...
    modifier minPricemeetrequirements(
        uint256 startPrice,
        uint256 minPrice
    ) {
        require(_getPortionOfBid(startPrice, 1000) >= minPrice &&
    ...
    function initialize(
        ...
        minPricePercentatge_ = minPricePercentatge;
    }
    ...
    /// Internal Function used to create Auction
    ...
    /// @param minPrice The minimum price in decrease
    /// @param erc20Token Token used to pay
    /// @param decreaseRate Decrease Percentatge
    ...
    uint32 decreaseRate
        ...
        isNFTOwner(nftContractAddress, tokenId, msg.sender)
        minPricemeetrequirements(startPrice, minPrice)
    ...
    onlyOwner
{
    ...
    /// Get funtions to get Auction State
    /// @param nftContractAddress Contract address that will be put on auction
    /// @param tokenId Identifier of the NFT
    ...
    /// Get funtions to get End Auction Time
    /// @param nftContractAddress Contract address that will be put on auction
    /// @param tokenId Identifier of the NFT
    ...
    /// Get funtions to get Start Price
    /// @param nftContractAddress Contract address that will be put on auction
    /// @param tokenId Identifier of the NFT
    ...
    /// Get funtions to get min Bid Price decreased
    /// @param nftContractAddress Contract address that will be put on auction
    /// @param tokenId Identifier of the NFT
    ...
    /// Get funtions to get decreased Price
    /// @param nftContractAddress Contract address that will be put on auction
    /// @param tokenId Identifier of the NFT
    function getCurrentPrice(address nftContractAddress, uint256 tokenId) public view returns(uint256){
        ...
        uint256 decreasecurrentPrice = nftContractAuction.startPrice - decreaseAmount;
    ...
    function _setupAuction(
        ...
        nftContractAuction.feeRecipients = defaultFeeRecipient;
        nftContractAuction.feePercentages = defaultFeePercentages;
        nftContractAuction.decreaseRate = decreaseRate;
        nftContractAuctions[nftContractAddress][tokenId].aucState == AuctionState.OPEN;
        nftContractAuctionTimmings.deadlineTime = (block.timestamp + endTime);
    ...
    /// Internal function to update Default Parameters
    /// @param nftContractAddress Contract address auctioned
    /// @param tokenId Identifier of the NFT
    /// @param decreaseRate Decrease Range Percentatge
    ...
    /// @param payedPrice The highest Price amount payed
