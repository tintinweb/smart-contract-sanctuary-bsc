...
contract FAITH is Context, IBEP20, IBEP20Metadata, Pausable, Ownable{
    ...
    string private constant _name = "Holy Bible Token II";
    ...
    address public communityOutreachWallet;
    ...
    uint256 public communityOutreachfee=1;

   

    uint256 public totalSwapFee = marketingFee + charityFee + buyBackFee + communityOutreachfee + staffWagefee + developmentfee;
    ...
    bool public communityOutreachswapEnabled=true;
    ...
    event SetCommunityOutreachFeePercent(uint256 communityOutreachFeePercent);
    ...
    event EnableFees(bool marketingfeeenabled,bool charityfeeenabled,bool buyBackfeeenabled,bool staffWagefeeenabled,bool developmentfeeenabled,bool communityOutreachfeeenabled);
    ...
    constructor (address _marketingWallet, address _charityWallet, address _buyBackWallet, address _staffWageWallet, address _developmentWallet, address _communityOutreachWallet ) {
        ...
        communityOutreachWallet = _communityOutreachWallet;
    ...
    function setMarketingFeePercent(uint256 fee) external onlyOwner whenNotPaused {
        marketingFee = fee;
        totalSwapFee = marketingFee + charityFee + buyBackFee + communityOutreachfee + staffWagefee + developmentfee;
    ...
    */
    ...
    /**
     * @dev Set development fee percentage.
     * @param fee - development fee percentage.
    */
    ...
    /**
     * @dev Set communityoutreach fee percentage.
     * @param fee - communityoutreach fee percentage.
    */
    function setCommunityOutreachFeePercent(uint256 fee) external onlyOwner whenNotPaused {
        communityOutreachfee = fee;
        totalSwapFee = marketingFee + charityFee + buyBackFee + communityOutreachfee + staffWagefee + developmentfee;
        emit SetCommunityOutreachFeePercent(communityOutreachfee);
    }

  

    function enableswap(bool marketingfeeenabled,bool charityfeeenabled,bool buyBackfeeenabled,bool staffWagefeeenabled,bool developmentfeeenabled,bool communityOutreachfeeenabled) external onlyOwner whenNotPaused {
        ...
        developmentswapEnabled = developmentfeeenabled;
        communityOutreachswapEnabled = communityOutreachfeeenabled;
        emit EnableFees(marketingswapEnabled,charityswapEnabled,buyBackswapEnabled,staffWageswapEnabled,developmentswapEnabled,communityOutreachswapEnabled);
    }
    ...
    function distributeFee() internal {
        ...
        if(contractTokenBalance >= minimumTokensBeforeSwap) {
            ...
            //send bnb to community outreach address
            if(communityOutreachswapEnabled) transferBNBToAddress(payable(communityOutreachWallet), transferredBalance.mul(communityOutreachfee).div(totalSwapFee)); 
