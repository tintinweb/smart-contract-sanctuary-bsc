...
contract Marblef1{
    ...
    function newRace(uint256[] memory _marbleIds, uint256 _raceTime, uint256 _racePrice) public whenNotPaused onlyAdminOrOperator {
        ...
        races[currentRace] = Race(marblesInRace, false, _raceTime, _raceTime + intervalSeconds, _raceTime + bufferSeconds, bets, -1, 0, _racePrice, false);
    ...
    function claimBetAmt(uint256 _raceIndex) public {
        ...
        require(betledger[_raceIndex][msg.sender].amount > 0, "bet is placed in this round");
