...
import "InterfacesABB.sol";
import "ERC20.sol";

contract StakingABB is IStaking {
    ERC20 public tokenX;
    ...
    function _calculateReward(
        ...
        //TODO : Check this. IF the lock up period is over then the user will not get rewards anymore.
    ...
    function withdraw(address account) external {
        ...
        for (uint256 n = 0; n < revisedUserStakingDetails.length; n++) {
            stakeDetailPerUser[account].stakedAmounts[
                    n
