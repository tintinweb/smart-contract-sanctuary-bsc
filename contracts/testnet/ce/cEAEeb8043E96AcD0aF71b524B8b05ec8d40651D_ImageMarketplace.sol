    ...
    UUPSUpgradeable
{
        ...
        public nonReentrant payable
    {
        ...
        require(marketItem.price > 0, "Market item has to exists");
        require(marketItem.seller != msg.sender, "Buyer cannot be seller");
        require(msg.value == marketItem.price, "Submit NFT price asked");

        // Transfer money to seller using dex bnb
        ...
        emit BuyImageNFT(marketItem.marketItemId, marketItem.tokenId, nftContract, marketItem.seller, buyer, marketItem.price);
