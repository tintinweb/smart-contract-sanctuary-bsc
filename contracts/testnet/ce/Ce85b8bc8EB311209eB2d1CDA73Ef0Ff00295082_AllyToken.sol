...
contract AllyToken is Context, IERC20, Ownable {
    ...
    constructor(
        ...
        _maxTxAmount = (_tTotal * setMxTxPer) / 100;
        _maxWalletAmount = (_tTotal * setMxWalletPer) / 100;

        numTokensSellToAddToLiquidity = (amountOfTokenWei * 1) / 1000;
    ...
    function setMaxWalletPercent(uint256 maxWalletPercent) external onlyOwner {
        ...
        _maxWalletAmount = (_tTotal * maxWalletPercent) / 100;
    }
    ...
    {
        return
            _amount * _liquidityFee + _burnFee + _walletFee + _buybackFee * 100;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (_burnFee != 0) {
            spentAmount = (contractTokenBalance / totFee) * _burnFee;
