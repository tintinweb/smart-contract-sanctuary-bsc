...
contract BabyVerse is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5e13 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 125_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0xf5bE8fBFB152b49ab55355064f08117Fa78C1ecf;
    address public operationWallet = 0x25f905372dB15C311f05d37cfA9434C90a73153c;
    address public utilityWallet = 0x93c6373883248DACFA2a650D8561CF9B19BDe143;
    ...
    Taxes public taxes = Taxes(5, 0, 4, 0, 1, 0);
    Taxes public sellTaxes = Taxes(5, 0, 4, 0, 1, 5);
