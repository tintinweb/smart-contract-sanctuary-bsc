...
contract WorldCup is OwnableUpgradeable {
    ...
    function betting(uint amount_, uint team_) public {
        ...
        if (mapPlayerRecord[player].length != 0) {
            isAttend = getParticipate(player);
        }
        ...
        if (competitionType == 128 || competitionType == 64) {
            if (team_ == 1) {
                mapInstantTotal[matchId].team1Amount += leverageAmount;
            } else {
                mapInstantTotal[matchId].team2Amount += leverageAmount;
            }
            // 记录
            ...
            // 总量
            mapInstantTotal[matchId].total += leverageAmount;
        } else if (competitionType == 32) {
            if (team_ == 1) {
                mapInstantTotal[matchId].team1Amount += leverageAmount * 0.53 ether;
            } else {
                mapInstantTotal[matchId].team2Amount += leverageAmount * 0.53 ether;
            }
            mapPlayerRecord[player].push(Instant({
                player: player,
            ...
            // 总量
            mapInstantTotal[matchId].total += leverageAmount * 0.53 ether;
            mapChampionTotal[championIndex].soulAmount += leverageAmount * 0.37 ether;
        } else if (competitionType == 16) {
            if (team_ == 1) {
                mapInstantTotal[matchId].team1Amount += leverageAmount * 0.63 ether;
            } else {
                mapInstantTotal[matchId].team2Amount += leverageAmount * 0.63 ether;
            }
            mapPlayerRecord[player].push(Instant({
                player: player,
            ...
            // 总量
            mapInstantTotal[matchId].total += leverageAmount * 0.63 ether;
            mapChampionTotal[championIndex].soulAmount += leverageAmount * 0.27 ether;
        } else if (competitionType == 8) {
            if (team_ == 1) {
                mapInstantTotal[matchId].team1Amount += leverageAmount * 0.73 ether;
            } else {
                mapInstantTotal[matchId].team2Amount += leverageAmount * 0.73 ether;
            }
            mapPlayerRecord[player].push(Instant({
                player: player,
            ...
            // 总量
            mapInstantTotal[matchId].total += leverageAmount * 0.73 ether;
            mapChampionTotal[championIndex].soulAmount += leverageAmount * 0.17 ether;
        } else if (competitionType == 4) {
            if (team_ == 1) {
                mapInstantTotal[matchId].team1Amount += leverageAmount * 0.83 ether;
            } else {
                mapInstantTotal[matchId].team2Amount += leverageAmount * 0.83 ether;
            }
            mapPlayerRecord[player].push(Instant({
                player: player,
            ...
            // 总量
            mapInstantTotal[matchId].total += leverageAmount * 0.83 ether;
    ...
    function getParticipate(address player_) public view returns (bool) {
        return mapPlayerRecord[player_][0].matchId != 0;
    }
