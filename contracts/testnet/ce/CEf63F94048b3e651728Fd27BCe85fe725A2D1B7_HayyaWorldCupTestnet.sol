...
contract HayyaWorldCupTestnet is ERC20, Ownable, BaseToken {
    ...
    constructor(
    ...
    ) ERC20("Hayya World Cup Testnet", "HYCT") {
        ...
        totalFees = devFee
            ...
            .add(communityFee)
            .add(marketingFee);
        require(totalFees <= 2500, "HYCT: Total fee is over 25%");
        swapTokensAtAmount = 100 ether; // Swap at 100 HYCT
    ...
    function setMaxSellAtStart(uint256 _maxSellAtStart) external onlyOwner {
        require(_maxSellAtStart <= totalSupply(), "HYCT: Max sell at start is over total supply");
        maxSellAtStart = maxSellAtStart;
    }

    function setPumpTime(uint256 _pumpTime) external onlyOwner {
        require(_pumpTime > 0, "HYCT: Pump time is zero or less");
        pumptime = _pumpTime;
    }
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "HYCT: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "HYCT: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "HYCT: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "HYCT: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function _transfer(
        ...
        if (
            ...
            require(tradingOpen, "HYCT: Trading is not open");
...
// for testnet only 
    mapping(address => uint256) claimTime;
    function faucet() public {
        require(block.timestamp - claimTime[msg.sender] > 86400, "already claim today");
