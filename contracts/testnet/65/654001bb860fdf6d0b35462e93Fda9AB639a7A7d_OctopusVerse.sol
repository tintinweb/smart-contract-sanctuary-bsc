...
contract OctopusVerse is ERC20, Ownable {
    ...
    constructor () ERC20("Octopus Verse", "OVERSE") 
    {   
        address newOwner = 0x0FcBfAEA1E71b675557D250EbcfA51df8E095bFA;
        operator = newOwner;
    ...
    function changMarketingWallet(address _marketingWallet) external onlyOwner {
    ...
    function enableTrading() external {
        require(msg.sender == operator || msg.sender == owner(), "Only operator or owner can enable trading");
        tradingEnabled = true;
    }
    ...
    function _transfer(
        ...
        if(takeFee) {
        	...
        	uint256 fees = amount * marketingFee / 100;
