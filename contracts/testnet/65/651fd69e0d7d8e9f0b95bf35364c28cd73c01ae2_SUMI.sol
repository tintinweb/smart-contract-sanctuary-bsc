...
contract SUMI is ExtendedReflections {
    ...
    uint32 private _taxRewardBuy = 1;
    uint32 private _taxRewardSell = 0;
    uint32 private _taxRewardTransfer = 0;

    uint32 private _taxLiquifyBuy = 3;
    uint32 private _taxLiquifySell = 0;
    uint32 private _taxLiquifyTransfer = 0;

    uint32 private _taxMarketingBuy = 3;
    uint32 private _taxMarketingSell = 0;
    uint32 private _taxMarketingTransfer = 0;

    uint32 private _taxBuyBackBuy = 2;
    uint32 private _taxBuyBackSell = 0;
    uint32 private _taxBuyBackTransfer = 0;

    uint32 private _taxProjectBuy = 3;
    uint32 private _taxProjectSell = 12;
    uint32 private _taxProjectTransfer = 0;

    uint32 private _taxDevBuy = 0;
    uint32 private _taxDevSell = 2;
    uint32 private _taxDevTransfer = 0;

    uint32 private _taxDecimals = 0;
    uint32 private _decimals = 9;

    uint256 private _maxTxAmount = 800_000 * (10 ** _decimals); // 0.1%
    uint256 private _maxWalletAmount = 16_000_000 * (10 ** _decimals); // 2%

    uint256 private _minTokensBeforeSwap = 80_000 * (10 ** _decimals); // 0.01%
    ...
    address private _teamAddress = 0x4b655baB665A677D01f45945e7Fb11CfD38804ec;
