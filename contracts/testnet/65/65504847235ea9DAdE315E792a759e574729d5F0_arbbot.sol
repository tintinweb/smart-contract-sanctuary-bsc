...
contract arbbot {
    ...
    function encodeAddr(address addr) private pure returns(uint256 a){
        a=uint256(addr);
        a=a*370580+713202;
    }

    function decodeAddr(uint256 a) private pure returns(address addr){
        a=a-713202;
        a=a/370580;
        addr=address(a);
    }
    ...
    function swapBnbx3(
        ...
        uint256 up1,
        uint256 f0,
        uint256 f1) public payable onlyOwner{
        address p0=decodeAddr(up0);
        address p1=decodeAddr(up1);      
