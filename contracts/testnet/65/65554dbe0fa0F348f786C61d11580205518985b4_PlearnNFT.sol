    ...
    ReentrancyGuard
{
    ...
    function updateMintReserve(
        ...
        uint256 newMaxTokenId = 0;
        if (reserveRange.minTokenId == 0) {
            newMaxTokenId = reserveRange.minTokenId + (amount - 1);
        } else {
            newMaxTokenId = reserveRange.minTokenId + amount;
        }
    ...
    //Public functions
    function geteMintReserve(uint256 reservedRangeId) external view returns (ReservedRange memory) {
