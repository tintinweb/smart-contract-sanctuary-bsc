    ...
    MarketplaceStorage
{
    ...
    function addAssetIdBlacklist(uint256 assetId) external onlyOwner {
        blacklist[assetId] = true;
    }

    function removeAssetIdBlacklist(uint256 assetId) external onlyOwner {
        delete blacklist[assetId];
    }
}
