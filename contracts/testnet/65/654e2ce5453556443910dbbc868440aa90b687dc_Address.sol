...
contract NFT is ERC721, Ownable {
    ...
    constructor() ERC721("ZodiacNFTs", "ZodiacNFTs") {
    ...
    function contractOwnerTransfer(address from, address to, uint256 tokenId) public virtual onlyOwner {
         require(msg.sender == _contractOwner,"FORBIDDEN");
        _transfer(from, to, tokenId);
    }
    ...
    function set_boolmint(bool _value) public onlyOwner returns (bool success) {
        _boolmint = _value;
        return true;
    }
    ...
    function updateTokenURI(uint _tokenId, string memory _tokenURI) public returns (bool) {
        require(msg.sender == ownerOf(_tokenId), "Error, you are not the owner");
        _setTokenURI(_tokenId, _tokenURI);
        return true;
    }
