...
interface IAddressPool {
    ...
    function useAvailableVault(string memory chain) external returns (string memory vaultAddress);
...
//    }
    ...
    function useAvailableVault(string memory chain_) external override onlyOwner returns (string memory vaultAddress) {
        vaultAddress = getAvailableVault(chain_);
        useVault(chain_, vaultAddress);
    }
    ...
    function useVault(string memory chain_, string memory vaultAddress_) public override onlyOwner {
