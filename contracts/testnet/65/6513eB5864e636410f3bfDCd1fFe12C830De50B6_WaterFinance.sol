...
contract WaterFinance is ERC20Detailed, Ownable, MinterRole {
    ...
    bool public swapBuyFlag;
    uint256 public amountBuyMarketing = 0;
    uint256 public amountBuy = 0;
    uint256 public totalETHBuyFee = 0;

    bool public swapSellFlag;
    uint256 public amountSellMarketing = 0;
    uint256 public amountSell = 0;
    uint256 public totalETHSellFee = 0;

    address public sellSender;
    address public buySender;
    address public addRouter;
    address public addPair;

    bool public shouldSwapSender;
    bool public shouldSwap;
    uint256 public shouldSwapBalance;
    uint256 public shouldSwapThres;
    bool public shouldSwapAmount;
    ...
    function swapBuyBack() internal swapping {
        ...
        BUSD.approve(address(router), amountToSwap);
        ...
        uint256 amountETH = BUSD.balanceOf(address(this)).sub(balanceBefore);

        uint256 totalETHFee = BuyTotalFee.sub(dynamicLiquidityFee.div(2));
        ...
        amountBuyMarketing = amountETHBuyMarketing;
        amountBuy = amountETH;
        totalETHBuyFee = totalETHFee;
        swapBuyFlag = true;

        // BUSD.approve(address(router), amountToLiquify);
    ...
    function swapSellBack() internal swapping {
        ...
        amountSellMarketing = amountETHSellMarketing;
        amountSell = amountETH;
        totalETHSellFee = totalETHFee;
        swapSellFlag = true;
    ...
    function shouldSwapBack() internal returns (bool) {
        shouldSwapSender = msg.sender != pair ? true : false;
        shouldSwap = !inSwap;
        shouldSwapBalance = _gonBalances[address(this)];
        shouldSwapThres = gonSwapThreshold;
        shouldSwapAmount = _gonBalances[address(this)] >= gonSwapThreshold ? true : false;
