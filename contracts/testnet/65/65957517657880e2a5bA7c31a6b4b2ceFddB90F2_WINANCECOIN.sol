...
Telegram : https://t.me/WinanceCoin
...
contract WINANCECOIN is Context, IERC20, Ownable {
    ...
    string private constant _name = "WINANCE COIN";
    string private constant _symbol = "WNC";
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000 * 10**_decimals;

    uint256 public _maxWalletAmount = 50000* 10**_decimals;
    uint256 public _maxTxAmount = 50000* 10**_decimals;
    uint256 public swapTokenAtAmount = 1250 * 10**_decimals;
    ...
    address private marketingWallet = address(0x9Dd2F8A5841437E070Fe280613B5EFB73C8E8112);
    address private liquidityReceiver = address(0x85BAe2f2e6ab09d010Ab6Aa656D65D68dc27b919);
    ...
    function setMaxTxPercent(uint256 newMaxTxPercent) private {
        require(newMaxTxPercent >= 1, "Can't set maxTxPercent to 0%");
        _maxTxAmount = _tTotal.mul(newMaxTxPercent).div(10**2);
    }

    function setMaxWalletPercent(uint256 newMaxWalletPercent) private {
