...
//派生的合约Ownable 可以访问合约Context所有非private方法
...
contract bnblemon is Context, Ownable {
    ...
    uint256 private marketEggs;//每个存款或孵化蛋的 20% 将添加到“市场鸡蛋”中
