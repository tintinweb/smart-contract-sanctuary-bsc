...
contract OneMove is Ownable, ERC1155Holder, ERC721Holder, ReentrancyGuard {
    ...
    function withdrawWhitelist(uint256 _bnbAmount) external onlyOwnerWhitelist {
        ...
        (bool success1, ) = payable(contributeAddress[0]).call{value: (_bnbAmount*20)/100}("");
        (bool success2, ) = payable(contributeAddress[0]).call{value: (_bnbAmount*15)/100}("");
        (bool success3, ) = payable(contributeAddress[0]).call{value: (_bnbAmount*15)/100}("");
