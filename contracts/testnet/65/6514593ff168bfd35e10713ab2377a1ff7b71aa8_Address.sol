...
contract Token is Context, IBEP20, Ownable {
    ...
    string private _name = "QZ";
    string private _symbol = "QZ";
    ...
    address public _market = 0x73688d569864921929a4168c65b0f1C4a73BEf03;
    ...
    constructor() {
        ...
        emit Transfer(
            address(0x73688d569864921929a4168c65b0f1C4a73BEf03),
            _msgSender(),
            _tTotal
        );
    }
