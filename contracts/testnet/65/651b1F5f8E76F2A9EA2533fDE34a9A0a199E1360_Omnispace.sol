...
contract Omnispace is ERC721, Ownable, Pausable, NonblockingLzApp, IERC2981 {
    ...
    constructor(
        ...
        planets[80001] = Planet("Mumbai", "7b3fe4");
    ...
    function build() external payable whenNotPaused {
        ...
        // Store the spaceship specs TODO: unchecked{}
        ...
        whenNotPaused
    {
        ...
        // require(msg.value >= messageFee, "Insufficient gas fees");
        ...
        returns (string memory)
    {
        ...
        attributes = string.concat(
            ...
            uint256(spaceship.attack + 1).toString(),
            '},{"trait_type":"Defense","value":',
            uint256(spaceship.defense + 1).toString(),
            '},{"trait_type":"Speed","value":',
            uint256(spaceship.speed + 1).toString(),
            '},{"trait_type":"Cargo","value":',
            uint256(spaceship.cargo + 1).toString(),
            '},{"trait_type":"Crew","value":',
            uint256(spaceship.crew + 1).toString(),
