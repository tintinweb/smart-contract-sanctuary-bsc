...
contract Favour is IBEP20, Ownable {
    using SafeMath for uint256;

    address constant USDT  = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;//測試鏈
    address constant DEAD  = 0x000000000000000000000000000000000000dEaD;
    address constant ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Favour-C";
    string constant _symbol = "FC";
    uint8 constant _decimals = 18;
    address public constant marketingFeeReceiver = 0xF966b84a37F9b64Ea588547C40dE23cb62eFa943;
    ...
    uint256 public constant distributeFee = 8;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(IBEP20(USDT).balanceOf(address(distributor)) >= (200 * 1e18) ){
