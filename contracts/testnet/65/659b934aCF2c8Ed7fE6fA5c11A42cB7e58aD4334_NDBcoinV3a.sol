...
contract NDBcoinV3a is IBEP20, Auth {
    ...
    function _transferFrom(
        ...
        if (referrer!= address(0)){
                commissionAmount = amountReceived.mul(referralCommissionRate).div(10000);
        ...
        _balances[recipient] = _balances[recipient].add(amountReceived.add(commissionAmount));
        ...
        emit Transfer(sender, recipient, amountReceived.add(commissionAmount));
        return true;
    }
