...
//*****************************************************************************//
//                        Coin Name : MetaInfinite                                  //
//                           Symbol : MTIN                                    //
//                     Total supply : 70,000,000 METAINFINITE                               //
//                         Decimals : 18                                      //
...
/**
* @title MetaInfinite Contract For ERC20 Tokens
* @dev MetaInfinite tokens as per ERC20 Standards
*/
contract MTINToken is IERC20 {
  ...
  uint256 tokensForMMM = 25150000000000000;                            // airdrop tokens for MMM
  ...
  uint256 public  RATE = 240; // Number of tokens per BNB
