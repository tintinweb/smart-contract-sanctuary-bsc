...
contract AutoLiquidityAndTax is IERC20, Ownable {
    using SafeMath for uint256;

    address constant _mainnetRouter = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address constant _mainnetWBNB   = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

    address constant _testnetRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    address constant _testnetWBNB   = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    ...
    uint256 public _transferLimit = ((_totalSupply * 10) / 1000) * 5;  // 5% 
    uint256 public _maxWalletSize = ((_totalSupply * 10) / 1000) * 5;  // 5% 
    ...
    constructor (bool isMainnet, address mw, address dw) {
        address deployer = msg.sender;

        if(isMainnet)
        {
            router = IDEXRouter(_mainnetRouter);
            WBNB = _mainnetWBNB;
        }
        else
        {
            router = IDEXRouter(_testnetRouter);
            WBNB = _testnetWBNB;
        }
    ...
    function getTotalFee(bool) internal view returns (uint256) {
        return totalFee;
    }
    ...
    function swapBack() internal swapping {
        ...
        if (marketingFeeReceiver == giveawayFeeReceiver) {
            ...
            (bool success2,) = payable(devFeeReceiver).call{value: amountBNBDev, gas: 30000}("");
            ...
            (bool success3,) = payable(devFeeReceiver).call{value: amountBNBDev, gas: 30000}("");
            require(success && success2 && success3, "receiver rejected ETH transfer");
        }
    ...
    function checkFeeExempt(address holder) public view returns(bool) {
    ...
    function checkTxLimitExempt(address holder) public view returns(bool) {
