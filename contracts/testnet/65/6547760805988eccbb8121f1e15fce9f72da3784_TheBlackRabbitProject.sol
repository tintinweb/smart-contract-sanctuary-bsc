...
contract TheBlackRabbitProject is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Black Rabbit Project", "$TBRP") {
        ...
        marketingWallet = address(0x30E74d6aa9e5C9020068f8DaF95141240c61c4E2); //
        devWallet = address(0xf515B8Ac7B96CCc4eC481ec5B55561b9FaeBc11a); // 
