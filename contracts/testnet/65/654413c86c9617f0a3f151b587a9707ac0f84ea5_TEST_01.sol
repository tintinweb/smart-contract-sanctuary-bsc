...
// SPDX-License-Identifier: MIT
    ...
    contract TEST_01 is Context, IERC20, Ownable {
        ...
        function A06__Price_Impact_Tiers__Percentage_Multiplied_by_100() external view returns (
                 ...
                 Note = "For the actual percentage divide it by 100. Example: 5% = 500"; 
        }
        function A07__Check_If_Price_Impacts_Feature_Is_Used(bool enter_the_word_true) external view returns (
                 ...
                 Price_Impact1__Percentage_Multiplied_by_100 = price_impact1;
                 Price_impact2__Percentage_Multiplied_by_100 = price_impact2;
                 Status = enter_the_word_true; 
                
                 if (price_impact1 != 0) {Price_Impact1__Status = "Price Impact1 feature is used";} 
                 else {Price_Impact1__Status = "Price Impact1 feature is NOT used";}

                 if (price_impact2 != 0) {Price_Impact2__Status = "Price Impact2 feature is used";} 
                 else {Price_Impact2__Status = "Price Impact2 feature is NOT used";}
        }
        function A08__Price_Impact1__Sell_Fees_Actual_Percentage() public view returns (
                 ...
                 Project_Fee_Under_Impact1 = Sell_ProjectFee_Under_Impact1;
                 Reflections_Fee_Under_Impact1 = Sell_ReflectionsFee_Under_Impact1;
                 Price_Impact1_Percentage_Multiplied_by_100 = price_impact1;
                 Project_Fee_Above_Impact1 = Sell_ProjectFee_Above_Impact1;
                 Reflections_Fee_Above_Impact1 = Sell_ReflectionsFee_Above_Impact1;
        }
        function A09__Price_Impact2__Sell_Fees_Actual_Percentage() public view returns (
                 uint256 Project_Fee_Above_Impact2,
                 uint256 Reflections_Fee_Above_Impact2) {

                 Project_Fee_Above_Impact2 = Sell_ProjectFee_Above_Impact2;
                 Reflections_Fee_Above_Impact2 = Sell_ReflectionsFee_Above_Impact2;
        }
        function A10__Sell_Fees__If_Price_Impacts_Feature_Is_Not_Used () public view returns (
                 uint256 Project_Fee_If_Impacts_Not_Used,
                 uint256 Reflections_Fee_If_Impacts_Not_Used) {

                 Project_Fee_If_Impacts_Not_Used = Sell_ProjectFee_If_Impacts_Not_Used;
                 Reflections_Fee_If_Impacts_Not_Used = Sell_ReflectionsFee_If_Impacts_Not_Used;
        }
        function A11__Project_Fee_Distribution_Per_Department() public view returns (
        ...
        function A12__Project_Wallets_Per_Department() public view returns (
        ...
        function A15__Managers_Count() public view returns (
        ...
        function A19__Is_Public_Trading_Enabled() public view returns (bool) {
        ...
        function A23__Wallet_To_Save_Transfer_Fees() public view returns (address) {
                 return WalletToSaveTransferFees;
        }
        function A24__Min_Amount_Tokens_for_Project_Funding_Swap() public view returns (uint256) {
        ...
        function F18__Set_Reserva_Fee_Portion(uint256 fee_percent) external onlySecurityManager {
            // Example: 25% of total Project Fee --> fee_percent = 25
            // IMPORTANT: 
            // ProductDevelopmentFee + MarketingFee + BlockchainSupportFee + ReservaFee = 100   
        ...
        function F19__Set_Product_Development_Wallet(address account) external onlyCEO {
            ProductDevelopmentWallet = account;
        }
        function F20__Set_Marketing_Wallet(address account) external onlyMarketingManager {
            MarketingWallet = account;
        }
        function F21__Set_Blockchain_Support_Wallet(address account) external onlyBlockchainManager {
            BlockchainSupportWallet = account;
        }
        function F22__Set_Reserva_Wallet(address account) external onlySecurityManager {
            // Use a Multisig wallet, e.g Gnosis Safe
            ReservaWallet = account;
        }
        function F23__Set_Wallet_To_Save_Transfer_Fees(address account) external onlyCEO {
        ...
        function F24__Exclude_Account_From_Paying_Fees(address account) external onlySecurityManager {
        ...
        function F25__Enable_Account_Must_Pay_Fees(address account) external onlySecurityManager {
        ...
        function F26__Exclude_Account_from_Receiving_Reflections(address account) external onlySecurityManager {
        ...
        function F27__Enable_Account_will_Receive_Reflections(address account) external onlySecurityManager {
        ...
        function F28__CEO_Change__By_Chief_Security_Officer(address New_CEO) public virtual onlyCSO {
        ...
        function F29__CSO_Change__By_Chief_Security_Officer(address New_CSO)  public virtual onlyCSO {
        ...
        function F30__Add_Security_Manager(address account) external onlySecurityManager {
        ...
        function F31__Remove_Security_Manager(address account) external onlySecurityManager {
        ...
        function F32__Add_Marketing_Manager(address account) external {
        ...
        function F33__Remove_Marketing_Manager(address account) external onlyMarketingManager {
        ...
        function F34__Add_Blockchain_Manager(address account) external {
            require(!Security_Manager[account], "Security personnel cannot have other roles");
            require(account != Chief_Security_Officer, "Security personnel cannot have other roles");
        ...
        function F35__Remove_Blockchain_Manager(address account) external onlyBlockchainManager {
        ...
        function F36__Add_Bridge_Or_Exchange(
                address account, 
                uint256 proj_fee, 
        ...
        function F37__Remove_Bridge_Or_Exchange(address account) external onlySecurityManager {
        ...
        function F38__Set_Min_Amount_Tokens_For_ProjectFundingSwap(uint256 amount) external onlySecurityManager {
            // Example: 10 tokens --> amount = 100000000 (i.e. 10 * 10**7 decimals) = 0.0002%
            minAmountTokens_ProjectFundingSwap = amount;
        }
        function F39__Rescue_Other_Tokens_Sent_To_This_Contract(IERC20 token, address receiver, uint256 amount) external {
