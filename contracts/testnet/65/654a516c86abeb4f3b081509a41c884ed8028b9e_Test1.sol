...
// First dating App and site to use its native token as in platform payment . Now you can hide the credit card recipts from your wife hahaha private is always best
// Meet the love of your life or new friends while keeping your credit card and banking off the internet and away from prying eyes. you must be at least 18 to use the 
//service be respectful and enjoy talking and meeting each other.❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️
...
contract Test1 is IERC20 {
    ...
    string constant private _name = "Test1";
    string constant private _symbol = "Test1";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xE5d3F4e710131929A2Bab2E6286f67B96aB10d88),
        team: payable(0xE5d3F4e710131929A2Bab2E6286f67B96aB10d88)
    });
...
//===============================================================================================================
    ...
    // Function to set an operator to allow someone other then the deployer to create things such as launchpads.
...
//===============================================================================================================
    ...
    function setRatios(uint16 reflection, uint16 liquidity, uint16 marketing, uint16 team) external onlyOwner {
        _ratios.reflection = reflection;
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.team = team;
        _ratios.totalSwap = liquidity + marketing + team;
    ...
    function excludePresaleAddresses(address router, address presale) external onlyOwner {
        ...
        require(router != address(this) 
                ...
                && lpPair != router 
                && lpPair != presale, "Lets Not Do this ");
        if (router == presale) {
    ...
    function finalizeTransfer(address from, address to, uint256 tAmount, bool buy, bool sell, bool other) internal returns (bool) {
        ...
        ExtraValues memory values = takeTaxes(from, to, tAmount, takeFee, buy, sell);
    ...
    function takeTaxes(address from, address to, uint256 tAmount, bool takeFee, bool buy, bool sell) internal returns (ExtraValues memory) {
