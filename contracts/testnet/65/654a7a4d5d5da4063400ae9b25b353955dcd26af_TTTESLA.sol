...
contract TTTESLA is Context, IERC20, Ownable {
    ...
    string private _name = "TinyTesla2";
    string private _symbol = "TTESLA2";
    ...
    address public _marketingWallet =
        payable(address(0x8C34d8C18C0423FC94F61bD00d773C9F5f54b2e6));
    
    address public _donationWallet = payable(address(0x29dd8B4fF5510Ea85C637f94Dd63398C68DeF207));
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0xD99D1c33F9fC3444f8101754aBC46c52416550D1 //Pancakeswap Testnet Router
        );
        ...
        maxSellAmount = totalSupply().mul(50).div(10000);
        maxBuyAmount = totalSupply().mul(50).div(10000);
    ...
    function setBuyFee(
        ...
        require (_totalBuyFee < 430, "total buy fees must be less than 43%");
    ...
    function setSellFee(
        ...
        require (_totalSellFee < 430, "total sell fees must be less than 43%");
    }
