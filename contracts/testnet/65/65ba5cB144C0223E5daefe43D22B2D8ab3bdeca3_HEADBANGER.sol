...
contract HEADBANGER is Context, IBEP20, IBEP20Extented, Ownable {
    using SafeMath for uint256;
    
    string private constant _name = "HeadBanger";
    string private constant _symbol = "HDB";
    ...
    uint256 public _minTokenBeforeSwap = 10**2 * 10**18;
    ...
    constructor() {
        IPancakeRouter02 _pancakeRouter = IPancakeRouter02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //bsc test 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);//bsc main net 0x10ED43C718714eb63d5aA57B78B54704E256024E);
