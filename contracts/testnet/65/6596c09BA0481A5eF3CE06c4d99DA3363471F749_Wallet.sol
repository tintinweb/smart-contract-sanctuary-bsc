...
contract Wallet{
    ...
    using SafeMath for uint256;
     ...
     function withdraw(IERC20 token, uint256 _wantAmt)public{

        require(token.balanceOf(address(this)) >= _wantAmt, "Not enough tokens");

        token.safeTransfer(address(msg.sender), _wantAmt);
