...
contract BSCMiner{
    ...
    uint256 public EGGS_TO_HATCH_1MINERS=1944000;//for final version should be seconds in a day
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    constructor() public{
        ...
        ceoAddress2=address(0x6a28924028B2f9A4F01C364C424A86c594dED8aF);
    }
