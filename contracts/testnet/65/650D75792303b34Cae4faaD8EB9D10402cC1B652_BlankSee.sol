...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x784B3495FcfE237A6Bd4978d7a5315Dc38e8b037; // owner address
...
contract BlankSee is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BlankSee";
    string private _symbol = "BSE";
