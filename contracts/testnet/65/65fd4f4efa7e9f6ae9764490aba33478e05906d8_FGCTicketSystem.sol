    ...
    Ownable
{
    ...
    function SetRuneNFTaddress(address _RuneNFTAddress) public ownerOrApprovedByOwner {
        RuneNFTAddress = _RuneNFTAddress;
    }
    ...
    function burnRune(address[] calldata from, address[] calldata to, uint256[] calldata tokenId) public ownerOrApprovedByOwner {
    ...
    function removeAllRanges() public ownerOrApprovedByOwner {
