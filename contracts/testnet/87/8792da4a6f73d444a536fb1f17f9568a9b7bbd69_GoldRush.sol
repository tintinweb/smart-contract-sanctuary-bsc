...
contract GoldRush is Context, Ownable {
    using SafeMath for uint256;

    uint256 private EGGS_TO_HATCH_1MINERS = 1090000;//for final version should be seconds in a day
    ...
    function hatchEggs(address ref) public {
        ...
        //send referral eggs
        claimedEggs[referrals[msg.sender]] = SafeMath.add(claimedEggs[referrals[msg.sender]],SafeMath.div(eggsUsed*100,427));
