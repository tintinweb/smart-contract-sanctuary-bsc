...
import "./IBigFootNFT.sol";
import "./MultiWhitelist.sol";

contract NFTSale is MultiWhitelist {
    using Address for address;
    using SafeMath for uint256;
    IERC20 public TOKEN;
    IBigFootNFT public NFT;
    ...
    constructor(
        ...
        // NFT + FT Address
        NFT = IBigFootNFT(_nftAddress);
        TOKEN = IERC20(_tokenAddress);
        // PRICES
        prices[NFTType.FLAME] = _prices[0];
        prices[NFTType.AQUA] = _prices[0];
        prices[NFTType.FROST] = _prices[0];
        prices[NFTType.GROUND] = _prices[0];
        prices[NFTType.TOXIC] = _prices[1];
        prices[NFTType.GHOST] = _prices[2];
        prices[NFTType.FOREST] = _prices[3];
        // PLACEHOLDER
        _placeholderURIs[NFTType.FLAME] = placeholderURIs[0];
        _placeholderURIs[NFTType.AQUA] = placeholderURIs[0];
        _placeholderURIs[NFTType.FROST] = placeholderURIs[0];
        _placeholderURIs[NFTType.GROUND] = placeholderURIs[0];
        _placeholderURIs[NFTType.TOXIC] = placeholderURIs[1];
        _placeholderURIs[NFTType.GHOST] = placeholderURIs[2];
        _placeholderURIs[NFTType.FOREST] = placeholderURIs[3];

        // FLAME
        typeCounter[NFTType.FLAME] = 1;
        typeMax[NFTType.FLAME] = 2048;
        // AQUA
        typeCounter[NFTType.AQUA] = 2049;
        typeMax[NFTType.AQUA] = 4096;
        // FROST
        typeCounter[NFTType.FROST] = 4097;
        typeMax[NFTType.FROST] = 6144;
        // GROUND
        typeCounter[NFTType.GROUND] = 6145;
        typeMax[NFTType.GROUND] = 8192;
        // TOXIC
        typeCounter[NFTType.TOXIC] = 8193;
        typeMax[NFTType.TOXIC] = 9216;
        // GHOST
        typeCounter[NFTType.GHOST] = 9217;
        typeMax[NFTType.GHOST] = 9728;
        // FOREST
        typeCounter[NFTType.FOREST] = 9729;
        typeMax[NFTType.FOREST] = 9984;
...
interface IBigFootNFT is IERC721 {
    function mint(
        address recipient,
        uint256 tokenId,
        string memory URI
