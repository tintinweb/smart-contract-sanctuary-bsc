...
contract KFDOGE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KFDOGE";
    string private _symbol = "KFDOGE";
    uint8 private  _decimals = 8;
    address private immutable _owner;
    address payable public marketingWalletAddress = payable(0xA12368C7E1132Ae58D7415039A14D0222d943478); 
    ...
    uint256 private _totalSupply = 999 * 10**12 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 1*10**8 * 10**_decimals; 
    ...
    function removeSniper(address[] calldata addresses,bool value) external onlyOwner {
