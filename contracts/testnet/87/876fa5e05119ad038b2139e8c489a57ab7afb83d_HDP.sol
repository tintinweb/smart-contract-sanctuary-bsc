...
import "../erc20_token/ERC20Token.sol";
...
contract ERC20Token is OwnableUpgradeable, ERC20Upgradeable, PausableUpgradeable {
    ...
    /*                                                   INITIALIZER                                                  */
    /* ============================================================================================================== */
    function __ERC20Token_init(string memory name, string memory symbol) internal initializer {
    ...
    function freeze(address _addr) public onlyOwner {
        require(!frozen[_addr], "ERC20Token: address already frozen");
        frozen[_addr] = true;
    ...
    function unfreeze(address _addr) public onlyOwner {
        require(frozen[_addr], "ERC20Token: address already unfrozen");
        frozen[_addr] = false;
