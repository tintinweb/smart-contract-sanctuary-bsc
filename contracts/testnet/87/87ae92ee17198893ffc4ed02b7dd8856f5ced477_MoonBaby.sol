...
contract MoonBaby is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x9479F7b04A0b4351Ef7C7948079dC18F892e8473;
    uint256 private _previousMarketingFee = _marketingFee;

    uint256 public _charityFee = 1;
    address public charityWallet = 0x7e8E0796bf11B9Fb53083e7fCde996241981EfC7;
    ...
    function setExcludefromMaxTx(address addr, bool value) external onlyOwner {
        excludedFromMaxTx[address(addr)] = value;
    }
