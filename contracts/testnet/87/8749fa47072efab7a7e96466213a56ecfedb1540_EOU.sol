...
contract EOU is Context, IERC20, Ownable {
    ...
    uint256 private _taxCap = taxCap;
    ...
    address public marketingWallet = 0xF3492F9d09c49b859C12780D06A3f532B9c6764D;
    address public liquidityWallet = 0xF3492F9d09c49b859C12780D06A3f532B9c6764D;
    address public developmentWallet = 0xF3492F9d09c49b859C12780D06A3f532B9c6764D;
    ...
    // This function allows the caller to deliver tokens and receive reflections in return.
    ...
    // This function returns the amount of reflections that correspond to a given amount 
    // of tokens, either including or excluding transfer fees.
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        ...
        uint256[6] memory rValues = _getRValues(tAmount, [tFee, tLiquidity, tMarketing, tDevelopment, _getRate()]);
    ...
    function _getRValues(uint256 tAmount, uint256[5] memory tValues) private pure returns (uint256[6] memory) {
        ...
        return [rAmount, rTransferAmount, rFee, 0, 0, 0];
    }
    ...
    function removeAllFee() private {
        if(reflectionFee == 0 && liquidityFee == 0 && marketingFee == 0 && developmentFee == 0) return;
    ...
    function setReflectionFeePercent(uint256 _reflectionFee) external onlyOwner() {
        ...
        require(reflectionFee + marketingFee + liquidityFee + developmentFee <= _taxCap, "Fee total cannot exceed tax cap%");
    ...
    function setTaxCap(uint _tax) external onlyOwner() {
        taxCap = _tax;
        require(taxCap <= 10, "Total taxes cannot be more than 10%");
