...
contract MPLANET is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 2_000_000 * 10**18;
    ...
    address public marketingWallet = 0x2e6EA537103ADb3bdA92A2012458a3E1696455fD;
    address public devWallet = 0x7e6359F2110F02290ac382e0775B2d011Be572e3;
    address public opsWallet = 0x352eB27F9F13cb1369F96CBDf1BA831728Cd3812;
    address public buybackWallet = 0x4f26D9E23BACD95043a8a01E3046ea1D6429F1C8;
    ...
    Taxes public taxes = Taxes(5, 1, 1, 1, 2);
    Taxes public sellTaxes = Taxes(5, 1, 1, 1, 2);
    ...
    constructor(address routerAdd) ERC20("Mando Planet", "MPLANET") {
    ...
    function SetBuyTaxes(
        ...
        require((_marketing + _liquidity + _ops + _buyback + _dev) <= 15, "Must keep fees at 15% or less");
    }
    ...
    function SetSellTaxes(
        ...
        require((_marketing + _liquidity + _ops + _buyback + _dev) <= 30, "Must keep fees at 30% or less");
    }
