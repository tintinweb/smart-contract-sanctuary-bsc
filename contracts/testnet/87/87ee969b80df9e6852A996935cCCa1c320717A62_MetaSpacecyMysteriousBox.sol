...
contract MetaSpacecyMysteriousBox is ERC1155ForBox, ReentrancyGuard {
  ...
  constructor (string memory _baseTokenURI)
    ERC1155ForBox("MetaSpacecy Mysterious Box", "MMB") {
  ...
  function unpack(uint256 _optionId, address _toAddress, uint256 _amount) external {
    ...
    BoxRandomness._mint(state, _optionId, _toAddress, _amount, "");
  ...
  function mint(
    ...
    require(_optionId < state.numOptions, "MMB: invalid option");
