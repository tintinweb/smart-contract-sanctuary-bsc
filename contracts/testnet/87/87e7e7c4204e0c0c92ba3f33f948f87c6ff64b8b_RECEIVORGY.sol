...
external;
 ...
 function clearStuckToken(uint256 amountPercentage) external;
}
contract DividendDistributor is IDividendDistributor {
 ...
 IBEP20 REWARDS = 
IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //the reward token you want distributed 
 address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
 address rewardsReceiver = 0x6C6763cF558517b1Fd3564F0D429f0DD905085b9;
 IDEXRouter router;
...
dividendsPerShare.add(dividendsPerShareAccuracyFactor.mul(amount).div(totalShares
 ...
 function clearStuckToken(uint256 amountPercentage) external override onlyToken{
  uint256 REWARDSLeftoverBalance = REWARDS.balanceOf(address(this));
  uint256 REWARDSLeftoverBalancePC = REWARDSLeftoverBalance * amountPercentage / 100;
  REWARDS.transfer(rewardsReceiver, REWARDSLeftoverBalancePC);  
 }
...
contract RECEIVORGY is IBEP20, Auth {
 using SafeMath for uint256;
 address REWARDS = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
 ...
 string constant _name = "RECEIVERORGY";
 string constant _symbol = "RECORGY";
 ...
 bool public payableSuccess1;
 bool public payableSuccess2;
 ...
 function remaindr() external view returns (uint256) { return remainder; }
...
returns (bool) {
 ...
 function shouldTakeFee(address sender) internal view returns (bool) {
    ...
    // DO NOT USE WHILE COIN IS ACTIVE MAY DISRUPT DISTRIBUTOR
    function clearStuckRewards(uint256 percentage) external authorized {
        distributor.clearStuckToken(percentage);
 ...
 emit AutoLiquify(amountBNBLiquidity, amountToLiquify);
    ...
    function distributorDeposit(uint256 amount) external authorized{
