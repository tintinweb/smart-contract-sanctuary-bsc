...
contract NOTHINGINU is IBEP20, Auth { 
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "Nothing Inu";
    ...
    mapping (address => bool) islaunchExempt;
    ...
    uint256 launchMultiplier = 5;
    
    // Dead blocks
    uint256 deadBlocks = 0;

    uint256 public swapThreshold = _totalSupply * 10 / 10000; //.25 total supply
    ...
    bool public tradingOpen = false; //set false as standard. 
    ...
    function setLaunchMultiplier(uint256 launchM) public onlyOwner{
      launchMultiplier = launchM;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 amountReceived = shouldTakeFee(sender) ? takeFee(sender, recipient, amount, isSell, launchMode) : amount;
    ...
    function setlaunchMode(bool _launchMode) public onlyOwner{
    ...
    function takeFee(address sender, address receiver, uint256 amount, bool isSell, bool LAUNCHMode) internal returns (uint256) {
        uint256 feeAmount;
    ...
    function setSellFees(
        ...
        updateSellFees();
        feeDenominator = _feeDenominator;
        require(totalFeeSell < 50, "Tax cannot be more than 50%");
    }
