...
contract MowseAuctionHouse is Initializable, Payments {
    ...
    */
    ...
    function acceptBid(
        ...
        //@TODO: add require of bidId > 0
        //@TODO: only one time acceptbid
    ...
    function auctionPayout(
        ...
        emit Addresses(_payee, _owner, _royaltyPayee, _buyer);
    ...
    function getAllBids(address _contractAddress, uint256 _tokenId)
        ...
        returns (Bid[] memory)
    {
        uint256 totalItems = auctions[_contractAddress][_tokenId]
            ._bidId
            .current();

        mapping(uint256 => Bid) storage bidMap = auctions[_contractAddress][
            _tokenId
        ].Bids;
