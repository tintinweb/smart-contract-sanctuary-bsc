...
contract DIAMOND is ERC20, Ownable {
    ...
    uint256 public teamFee = 30; //30%  dinger team
    ...
    event BeforeTranfer(address from, address to, uint256 amount);

    constructor(address _feeAddress, address _marketingWalletAddress)
        ERC20(_name, _symbol)
    {
    ...
    function _beforeTokenTransfer(
        ...
        emit BeforeTranfer(from, to, amount);
    }

    // internal / private functions
    function feesDistribution() private {}
