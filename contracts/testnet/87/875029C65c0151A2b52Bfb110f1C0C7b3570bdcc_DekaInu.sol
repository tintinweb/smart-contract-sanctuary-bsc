...
contract DekaInu is Context, IERC20 { 
    ...
    uint256 private _tTotal = 1**9 * 10**_decimals;
    string private constant _name = "DekaInu"; 
    string private constant _symbol = unicode"DEKA"; 
    ...
    uint256 public _maxWalletToken = 1**9 * 10**_decimals;
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = 1**9 * 10**_decimals; 
