...
contract WhitelistAuction is ERC1155, Ownable {
  ...
  address[4] ACCPCETABLE_CURRENCY = [
    0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F, //WBNB(TEST), WETH(RPDOCUT)
    0x337610d27c682E347C9cD60BD4b3b107C9d34dDd, //USDT
    0x07865c6E87B9F70255377e024ace6630C1Eaa37F, //USDC
    0x3697B228C5c3d82Ff0FFb12ff542cf6fC500B917  // GAME
  ];
  ...
  function claimWinning (
    ...
    require(recoverSigner(messageB, signatureB) == owner(), 'moderator_not_signed');
  ...
  function uri(uint256 _id) public view virtual override returns (string memory) {
    ...
    return string(abi.encodePacked('https://ipfs.io/ipfs/', a.ipfs));
  }
