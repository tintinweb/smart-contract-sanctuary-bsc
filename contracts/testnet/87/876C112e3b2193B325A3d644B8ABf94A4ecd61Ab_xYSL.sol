...
contract xYSL is Receipt, Pausable, IEvents {
    ...
    uint256 public lockTransactionTime = 86400 ; 
    ...
    uint256 [] public xYSL_BuyBack = [7500,2500]; //[buyBack and burn, team address]
...
contract Receipt is My20, AccessControl, ReentrancyGuard, Initializable{
    ...
    **/
    ...
    function mint (address to , uint amount) external virtual nonReentrant onlyRole(MINTER_ROLE){
        _mint(to,amount);
    ...
    **/
    ...
    function burn (address from, uint amount ) external virtual nonReentrant onlyRole(BURNER_ROLE){
        _burn(from , amount);
    }
...
contract My20 is Context, IERC20, IERC20Metadata {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        console.log(accountBalance,"user bal",amount,"burn amt");
