...
contract T10AAA is ERC20 , ERC20Burnable, ERC20Permit, Ownable, Pausable, ERC20Snapshot, ERC20Votes, ERC20FlashMint{
    constructor() ERC20("T10AAA", "T10AAA") ERC20Permit("${name}") {
        _mint(0xc936d6737bEC9c7Fc80De955ad617101Ba451181, 99999999999999 * 10 ** decimals());
