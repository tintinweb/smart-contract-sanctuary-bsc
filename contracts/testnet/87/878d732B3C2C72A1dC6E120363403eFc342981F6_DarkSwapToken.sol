...
contract DarkSwapToken is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100.000 DAS
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund) public ERC20("DarkSwap Token", "DAS") {
        _mint(msg.sender, 1 ether); // mint 1 DAS for initial pools deployment
