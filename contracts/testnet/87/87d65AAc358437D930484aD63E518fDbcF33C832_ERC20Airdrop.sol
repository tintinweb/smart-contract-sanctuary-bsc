...
contract ERC20Airdrop is ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, uint256 totalSupply_, bytes32 merkleRoot_) ERC20(name_, symbol_) {
    ...
    function claim(bytes32[] memory proof_) public {
        ...
        require(MerkleProof.verify(proof_, merkleRoot, keccak256(abi.encodePacked(msg.sender, balanceOf(msg.sender)))), "Invalid proof");
