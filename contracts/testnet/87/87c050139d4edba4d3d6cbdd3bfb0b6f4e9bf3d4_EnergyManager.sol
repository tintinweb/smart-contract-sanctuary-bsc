...
contract EnergyManager is EnergyAuth {
  ...
  IMarketPlace public marketPlace; // TODO remove on next mainnet deploy
  mapping (uint => Energy) public energies;
  mapping (address => int) public userTempPoint; // TODO remove on next mainnet deploy
  uint public maxEnergy; // TODO remove on next mainnet deploy
  uint public energyMultiplication; // TODO remove on next mainnet deploy
