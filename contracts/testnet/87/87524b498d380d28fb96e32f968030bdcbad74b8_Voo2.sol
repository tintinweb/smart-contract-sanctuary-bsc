...
contract Voo2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using SafeERC20 for IERC20;
    
    address dead = 0x05fB36755a28F9c3043639E926019fdB132032A1;
    
    //change that
    uint8 public maxLiqFee = 2;                // Transaction fee % that would be used to add liquidity (0-10)
    uint8 public maxTaxFee = 4;                // Transaction fee % that would be distributed to holders (0-10)
