...
contract PassportCNFT is AgencyNFT, TopDownERC721Composable {
  ...
  function adminComposeNFT(
    ...
    _compose(parentTokenId_, composedNft_, composedTokenId_);
  ...
  function adminComposeNFTMany(
    ...
    for (uint256 i = 0; i < composedTokenIdList_.length; i++) {
      ...
      _compose(parentTokenId_, composedNft_, composedTokenIdList_[i]);
    }
  ...
  IERC721Receiver
{
  ...
  function _decompose(
    ...
    // Transfer the composedTokenId_ to the owner wallet of the parentTokenId_
    ...
    delete _parentTokenId_composedNFT[parentTokenId_];
