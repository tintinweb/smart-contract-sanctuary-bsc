...
contract MonsterFootball is ERC721, Ownable {
    ...
    function setFootballerAddress(address footballers) external onlyOwner() {

        _footballers = IFootballer(footballers);
    ...
    function callMonster() public onlyOperator() {
    ...
    function caculatorReward(uint256 nftID, uint256 monsterID) external view returns (uint256 reward) {
        ...
        (uint256 Attribute, , ) = _footballers.getNFTInformation(nftID);
