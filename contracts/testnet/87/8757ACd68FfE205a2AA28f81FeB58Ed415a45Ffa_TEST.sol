...
contract TEST is IBEP20, Auth {
    ...
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //Sphynx router
    ...
    uint256 public totalFees     = WETHRewardsFee + marketingFee + liquidityFee;
    ...
    function setFeeRates(uint256 _WETHRewardsFee, uint256 _liquidityFee, uint256 _marketingFee, uint256 _feeDenominator) public onlyOwner {
            WETHRewardsFee = _WETHRewardsFee;
            liquidityFee = _liquidityFee;
            marketingFee = _marketingFee;
            totalFees = _WETHRewardsFee + _liquidityFee + _marketingFee;
    ...
    function swapBack() internal lockTheSwap {
        ...
        if(marketingFee > 0){
            payable(MarketingWallet).transfer(amountWETHTeam);
        }
