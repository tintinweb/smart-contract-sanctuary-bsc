...
contract SILOSCOIN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MKT              = 0xcF5ecD0fb6560BbD03a972FBbF475cca1DaDF1f8;
    address PROJECT          = 0x2F9D06d54feE75e7Da53f5dD4394dBbAC04E271C;
    address TOKEN_BUSINESS   = 0xBf7D5DbF059D30FEa1c262C8C3689412dB061417;
    address CONTRACT         = address(this);


    uint256 MAX_TB_TAX       = 1;

    string constant _name    = "SILOS Coin";
    string constant _symbol  = "SILOS";
