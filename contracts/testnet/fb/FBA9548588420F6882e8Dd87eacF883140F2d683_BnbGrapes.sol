...
contract BnbGrapes is Ownable {
    ...
    uint256 public GRAPES_TO_HATCH_1MINERS = 1080000; // for final version should be seconds in a day 1728000 (5%)
    ...
    uint256 private MAX_REF_LEVEL = 5;
    uint256[] private refPercent = [5, 2, 1, 1, 1]; // 10% in total
