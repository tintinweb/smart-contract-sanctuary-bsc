...
contract PresaleFactory is OwnableUpgradeable {
    ...
    function initialize () public initializer {
        ...
        end_time = 1672096068;
        presaleOwnerAddress = payable(0x51C0da7D74FB3e77398ee2C1340cAE97796fF5d1);
    ...
    function buyTokensByBNB() external payable {
        ...
        // token amount user want to buy
        uint256 tokenAmount = amountPrice / tokenPrice_BUSD;
        uint256 decimalTokenAmount = tokenAmount * 10 ** 18;
    ...
    function releaseFund() external onlyOwner {
        ...
        if(BNBbalance > 0)
            payable(withdrawAddr).transfer(BNBbalance);
    ...
    function setPresaleOwnerAddress(address _address) external onlyOwner {
        presaleOwnerAddress = payable(_address);

        emit SetPresaleOwnerAddress (_address);
    }
