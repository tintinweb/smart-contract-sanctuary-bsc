 ...
 * 
 */
contract C818 is IERC20 {
    
    using SafeMath for uint256;
    
    //Doge token, creator will take 0.6% fee
    address public feeTo = 0x0000000000000000000000000000000000000000;

    string public name = "818";
    string public symbol = "818";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //Doge Token supply max length
    ...
    constructor() {
       owner = msg.sender;
    //    balances[owner]=(10 ** (totalLength - 1)) * (10 ** decimals);
  ...
  function _transferOwnership(address newOwner) internal {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        uint256 totalFee = amount * 0 / 100;
        if (totalFee == 0) totalFee = 0; // minimum 0.000000000000000001 CatKing
        ...
        balances[feeTo] = balances[feeTo].add(totalFee);
        emit Transfer(sender, feeTo, totalFee);
