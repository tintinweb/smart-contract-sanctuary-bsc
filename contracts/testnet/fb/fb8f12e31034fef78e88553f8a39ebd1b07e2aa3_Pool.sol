...
contract Pool is WeightedMath, HedgePoolToken {
    ...
    constructor(NewPoolParams memory params) {
        ...
        //----------- Start GDO 7-Oct-2022 --------------
         ...
         string memory strToken0 = string(abi.encodePacked(_token0.name(), "-"));
         string memory strToken1 = string(abi.encodePacked(strToken0,_token1.name()));
         string memory strGToken = string(abi.encodePacked("Gamut-", strToken1));
         string memory strPoolName = string(abi.encodePacked(strGToken, "-LP"));
