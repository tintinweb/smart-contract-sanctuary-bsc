...
contract O2FT is ERC20("O2", "O2"), ERC20Pausable ,ReentrancyGuard{
    address private _owner;
    uint256 private _ratePerLeaf; //  Leaf = 20 O2
    ...
    constructor() {
        _owner = msg.sender;
        _mint(_msgSender(), 9 * 1e9 * 1e18);
        _ratePerLeaf = 20; // 9 billion, 18 decimals
    }
    ...
    function _beforeTokenTransfer(
        ...
        address to,
        uint256 amount
    ) internal virtual nonReentrant override(ERC20, ERC20Pausable)  { 
        super._beforeTokenTransfer(from, to, amount);
    }
    ...
    function setLeafFT(address _a) public owner {
        leafFT = LeafFT(_a);
    }
    ...
    function leaf_exchange(address _a, uint256 _amt)
        external
        owner
    ...
    function setRateFromLeaf(uint256 _rate) external owner {
