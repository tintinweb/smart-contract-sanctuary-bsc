...
contract Pool is Ownable {
    ...
    function deposit(uint256 _depositAmount) public {
        ...
        updateUpperPenddingReward(msg.sender, _depositAmount);
    }

    function updateUpperPenddingReward(address _address, uint256 _amount) private {
        address upper = inviterAddress.getUpper(_address);
        UserInfo storage upperInfo = userInfoList[upper];
        uint256 addAmount = 120 * _amount / 100;    //20% reward
