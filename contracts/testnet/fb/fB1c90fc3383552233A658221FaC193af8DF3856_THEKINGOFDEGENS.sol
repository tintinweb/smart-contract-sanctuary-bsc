...
abstract contract Auth {
     ...
     */
    function authorize(address dev) public onlyOwner {
     ...
     */
    function unauthorize(address dev) public onlyOwner {
        authorizations[dev] = false;
    }
     ...
     */
    function isAuthorized(address dev) public view returns (bool) {
        return authorizations[dev];
    }
     ...
     */
    function transferOwnership(address payable dev) public onlyOwner {
        owner = dev;
        authorizations[dev] = true;
        emit OwnershipTransferred(dev);
    }
...
contract THEKINGOFDEGENS is IBEP20, Auth {
    ...
    address DEV  = 0xf91D4fa3D3ecE1515C3866cbeF812f99AbEACa48;

    string constant _name = "The King Of Degens";
    string constant _symbol = "Degen Crowns";
    ...
    address private marketingFeeReceiver = 0x970E6C83135dAaA9A2D9e3D8bbca4D5D47Fc3441;
    address private buybackFeeReceiver = 0x970E6C83135dAaA9A2D9e3D8bbca4D5D47Fc3441;
