...
contract FM is ERC20Detailed ,Owned {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "FlashX Max";
  string constant tokenSymbol = "FSXM";
  uint8  constant tokenDecimals = 8;
  uint256 _totalSupply = 50000000000000000;
  uint256 public basePercent = 100;

  constructor() public payable ERC20Detailed(tokenName, tokenSymbol, tokenDecimals) {
    _mint(0xB3382Ba7b02Baf7bE5F918630414D387d59Ed55f, _totalSupply);
  }
  ...
  function isSupplyLessThan1() public view returns(bool){
      uint256 one = 100000000;
       if(_totalSupply <= one){
           return true;
       }
       return false;
