...
contract EverSAFU is IERC20, Ownable {
    ...
    string constant _name = "EverSAFU";
    ...
    constructor() {
        ...
        treasuryReceiver = 0x1Df925D52a7dade6411Cf669fa796F1e62bBc509;
        ...
        safuDividendReceiver = address(dividendDistributor);
    ...
    function swapBack() internal swapping {
        ...
        (bool sendDividendBnb, ) = payable(address(dividendDistributor)).call{
        ...
        try
            dividendDistributor.deposit(
                amountETHToTreasuryAndSIF.mul(safuDividendFee).div(
                    treasuryFee.add(safuDividendFee)
                )
            )
        {} catch {}
...
contract DividendDistributor {
    ...
    event rewardDistributed(address holder, uint256 amount);
