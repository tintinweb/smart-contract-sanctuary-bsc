...
contract Shikoku is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2; // change later
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        if(!takeFee || _isExcludedFromFee[sender] || _isExcludedFromFee[recipient]){
            removeAllFee();
        } else {
            require(amount <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount.");
        }
