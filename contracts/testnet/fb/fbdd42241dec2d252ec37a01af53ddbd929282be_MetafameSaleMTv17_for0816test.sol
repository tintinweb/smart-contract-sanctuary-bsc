...
contract MetafameSaleMTv17_for0816test is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable, Status{
    ...
    event Refresh(address indexed owner, uint256 tokenId);
    ...
    function initialize(IMF1155 _metafame1155) initializer public {
        ...
        maxPurchaseLimit = 5;
        maxPurchaseLimitWL = 5;
        maxPurchaseLimitVC = 10;
        _FOR_OWNER = 6; //1112
        _makeOver = 200000;

        _endsaled = false;

        publicSaleStart = 1660629600;
        publicSaleEnd = 1660630800;

        vcRoundNumber =  1;
        vcRound[1] = VCRoundInfo({
            startTime: 1660613400,
            endTime: 1660614600,
            limit: 10,
            alreadySaled: 0
        });
        vcRound[2] = VCRoundInfo({
            startTime: 1660615200,
            endTime: 1660616400,
            limit: 2,
            alreadySaled: 0
        });
        vcRound[3] = VCRoundInfo({
            startTime: 1660617000,
            endTime: 1660618200,
            limit: 10,
            alreadySaled: 0
        });
        vcRound[4] = VCRoundInfo({
            startTime: 1660618800,
            endTime: 1660620000,
            limit: 2,
            alreadySaled: 0
        });
        // vcRound[5] = VCRoundInfo({
        //     startTime: 1660629600,
        //     endTime: 1660631400,
        //     limit: 20,
        //     alreadySaled: 0
        // });
        // vcRound[6] = VCRoundInfo({
        //     startTime: 1660632600,
        //     endTime: 1660634400,
        //     limit: 20,
        //     alreadySaled: 0
        // });
        ...
        wlRoundNumber =  1;
        wlRound[1] = RoundInfo({
            startTime: 1660615800,
            endTime: 1660617600,
            limit: 5,
            alreadySaled: 0
        });
        wlRound[2] = RoundInfo({
            startTime: 1660621800,
            endTime: 1660623600,
            limit: 5,
            alreadySaled: 0
        });
    ...
    function purchaseBoxVCsale(
        ...
        require(payAmount == busdPerBoxVC * number, "Insufficient/Wrong BUSD");
    ...
    function purchaseBoxPresale(
        ...
        require(payAmount == busdPerBoxWL * number, "Insufficient/Wrong BUSD");
    ...
    function purchaseBoxPublicSale(
        ...
        require(payAmount == busdPerBox * number, "Insufficient/Wrong BUSD");
    ...
    function makeOver( 
        ...
        require(payAmount == makeOverPrice, "Insufficient/Wrong BUSD");
        uint256 newTokenId = tokenId + _makeOver;
        payToken(makeOverPrice);
    ...
    function refresh( 
        ...
        require(payAmount == refreshPrice, "Insufficient/Wrong BUSD");
        payToken(refreshPrice);
        ...
        emit Refresh(_msgSender(), tokenId);
    }

    function payToken(uint256 price) private {

        IERC20Upgradeable currency = IERC20Upgradeable(busdAddr);
        currency.safeTransferFrom(address(msg.sender), payable(address(owner())), price);
    ...
    function ownerMint(
        ...
        public 
        {
        require(metafame1155.getAllocatedBoxQuantity() <= metafame1155.getMaxSupply(), "Metafame1155: No more nft can be minted");
        require(gender < 2, "MetafameSale: Wrong Gender Type");
        require(skin < 4, "MetafameSale: Wrong Skin Type");
