...
import {IERC20} from '@axelar-network/axelar-utils-solidity/contracts/interfaces/IERC20.sol';
...
abstract contract TokenLinker is AxelarExecutable, Upgradable {
    ...
    function getGateway() public view returns (IAxelarGateway) {
