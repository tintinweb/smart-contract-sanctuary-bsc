...
contract Thor is Context, ERC165, IERC721, IERC721Metadata,Pausable,Ownable{
    ...
    constructor (string memory name_, string memory symbol_){
        _name = name_;
        _symbol = symbol_;
        // URI = "https://gateway.pinata.cloud/ipfs/QmfQT7WKrvkJQq2C7Q8JQRWM4gNmqVj1U5pNZSiRmmjbz4/";
    }
    ...
    function _transfer(
        ...
        require(Thor.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
