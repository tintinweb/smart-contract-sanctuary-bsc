...
contract MythWhiteList {
    ...
    uint256 public dailyBlockTime = 12000;
    //contract name
    ...
    function resolveLootBox(
        ...
        (uint256 lootboxID, uint256 prizeCount) = MythDailyLootbox(
            _lootboxAddress
        ).getWinningPrize(roll);
        //event to show address won lootbox ID X amount
        lootboxCountersBalance[lootboxID][_opener] += prizeCount;
        return roll;
    }
    ...
    function initializeGameLobby(
        ...
        if (_gameType != uint8(RoundType.DAILY)) {
            ...
            require(
                block.number - previousBlockClaimed[msg.sender] > 1000,
...
contract MythDailyLootbox {
    address public owner;
    string public name = "LEVEL 5 DAILY";
    uint256 public prizeCount;
    mapping(uint256 => prize) public prizes;
    uint256 public minPlaced = 150 * 10**18;
    struct prize {
        uint256 lowticket;
        uint256 highticket;
        uint256 lootboxID;
    ...
    constructor() {
        owner = msg.sender;
        prizes[0] = prize(0, 24, 1, 1);
        prizes[1] = prize(25, 49, 1, 3);
        prizes[2] = prize(50, 64, 2, 1);
        prizes[3] = prize(65, 79, 2, 2);
        prizes[4] = prize(80, 87, 2, 3);
        prizes[5] = prize(88, 94, 3, 1);
        prizes[6] = prize(95, 98, 3, 2);
        prizes[7] = prize(99, 99, 3, 3);
...
//     uint256 public prizeCount;
//     mapping(uint256 => prize) public prizes;
//     uint256 public minPlaced = 50 * 10**18;
//     struct prize {
//         uint256 lowticket;
//         uint256 highticket;
//         uint256 lootboxID;
...
//         prizes[1] = prize(25, 49, 1, 1);
//         prizes[2] = prize(50, 64, 1, 2);
//         prizes[3] = prize(65, 79, 2, 1);
//         prizes[4] = prize(80, 89, 2, 2);
//         prizes[5] = prize(90, 94, 2, 3);
//         prizes[6] = prize(95, 97, 3, 1);
//         prizes[7] = prize(98, 99, 3, 2);
...
// contract MythDailyLootbox {
//     address public owner;
//     string public name = "LEVEL 3 DAILY";
//     uint256 public prizeCount;
//     mapping(uint256 => prize) public prizes;
//     uint256 public minPlaced = 15 * 10**18;
//     struct prize {
//         uint256 lowticket;
//         uint256 highticket;
//         uint256 lootboxID;
...
//     constructor() {
//         owner = msg.sender;
//         prizes[0] = prize(0, 59, 0, 0);
//         prizes[1] = prize(60, 79, 1, 1);
//         prizes[2] = prize(80, 89, 1, 2);
//         prizes[3] = prize(90, 94, 2, 1);
//         prizes[4] = prize(95, 98, 2, 2);
//         prizes[5] = prize(99, 99, 3, 1);
...
// contract MythDailyLootbox {
//     address public owner;
//     string public name = "LEVEL 1 DAILY";
//     uint256 public prizeCount;
//     mapping(uint256 => prize) public prizes;
//     uint256 public minPlaced = 1 * 10**18;
//     struct prize {
//         uint256 lowticket;
//         uint256 highticket;
//         uint256 lootboxID;
...
//     constructor() {
//         owner = msg.sender;
//         prizes[0] = prize(0, 94, 0, 0);
//         prizes[1] = prize(95, 98, 1, 1);
//         prizes[2] = prize(99, 99, 1, 2);
...
// contract MythDailyLootbox {
//     address public owner;
//     string public name = "LEVEL 2 DAILY";
//     uint256 public prizeCount;
//     mapping(uint256 => prize) public prizes;
...
//     constructor() {
//         owner = msg.sender;
//         prizes[0] = prize(0, 79, 0, 0);
//         prizes[1] = prize(80, 89, 1, 1);
//         prizes[2] = prize(90, 94, 1, 2);
//         prizes[3] = prize(95, 98, 1, 3);
//         prizes[4] = prize(99, 99, 2, 1);
...
//     function getPrizes() external view returns (prize[5] memory) {
//         prize[5] memory temp;
//         temp[0] = prizes[0];
//         temp[1] = prizes[1];
//         temp[2] = prizes[2];
...
//     uint256 public minBet = 32 * 10**15;

//     constructor() {
//         owner = msg.sender;
//         prizes[0] = prize(0, 19, 1 * 10**14);
//         prizes[1] = prize(20, 29, 5 * 10**14);
//         prizes[2] = prize(30, 49, 210 * 10**14);
//         prizes[3] = prize(50, 74, 350 * 10**14);
//         prizes[4] = prize(75, 79, 400 * 10**14);
//         prizes[5] = prize(80, 84, 650 * 10**14);
//         prizes[6] = prize(85, 93, 750 * 10**14);
//         prizes[7] = prize(94, 98, 850 * 10**14);
//         prizes[8] = prize(99, 99, 1150 * 10**14);
...
//     RoundType public gameType = RoundType.LOOTBOX;
//     uint256 public minBet = 2 * 10**16;

//     constructor() {
//         owner = msg.sender;
//         prizes[0] = prize(0, 19, 1 * 10**14);
//         prizes[1] = prize(20, 39, 5 * 10**14);
//         prizes[2] = prize(40, 49, 10 * 10**14);
//         prizes[3] = prize(50, 74, 250 * 10**14);
//         prizes[4] = prize(75, 79, 300 * 10**14);
//         prizes[5] = prize(80, 84, 450 * 10**14);
//         prizes[6] = prize(85, 93, 500 * 10**14);
//         prizes[7] = prize(94, 98, 650 * 10**14);
//         prizes[8] = prize(99, 99, 850 * 10**14);
...
//         prizes[0] = prize(0, 19, 1 * 10**14);
//         prizes[1] = prize(20, 39, 5 * 10**14);
//         prizes[2] = prize(40, 64, 10 * 10**14);
//         prizes[3] = prize(65, 74, 50 * 10**14);
//         prizes[4] = prize(75, 79, 200 * 10**14);
//         prizes[5] = prize(80, 84, 250 * 10**14);
//         prizes[6] = prize(85, 93, 300 * 10**14);
//         prizes[7] = prize(94, 98, 500 * 10**14);
//         prizes[8] = prize(99, 99, 1150 * 10**14);
