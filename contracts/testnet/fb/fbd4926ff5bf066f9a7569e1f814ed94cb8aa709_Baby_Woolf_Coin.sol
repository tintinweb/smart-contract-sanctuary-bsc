...
contract Baby_Woolf_Coin is BEP20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 42e31;
    ...
    function setFees(uint256 BNBRewards, uint256 liquidity, uint256 metaverse, uint256 vault, uint256 app) public onlyOwner {
