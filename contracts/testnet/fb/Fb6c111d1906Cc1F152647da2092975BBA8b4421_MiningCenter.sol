...
contract MiningCenter is ERC1155Holder {
    ...
    function stakingProperty(
        ...
        manageStakingType(stakingType[_stakingType], _nftNum, 1);
    }
    ...
    function transferNFT(
        ...
        require(i != 9999, "param err");

        incomeIsland.safeTransferFrom(msg.sender, _to, _nftNum, 1, "");
    }
    ...
    function unStakingProperty(uint256 _nftNum, uint256 _nftType) external {
        ...
        uint256 stakingIndex = getStakingIndex(msg.sender, _nftNum, _nftType);
    ...
    function getStakedDays(
        ...
        uint256 stakingIndex = getStakingIndex(_owner, _nftNum, _nftType);
        require(stakingIndex != 9999, "There is no staking history");

        uint256 different = (block.timestamp -
            stakingHistory[stakingIndex].stakedTime) / 1 minutes;
        return (different, stakingHistory[stakingIndex].stakedType);
    }
    ...
    function Init() external {
        ...
        /* Test Network */
        incomeIsland = IIncomeisland(
            0xAbE033075B5c08c4411725D9803AA237D9F39134
        );
        utility = IUtility(0xF874b7702A73A064f12D00CD3124f15AB552f1Fa);
        transfer = ITransfer(0x66C9B437bA4C4a308bB64dedaA065a24096269F0);
        _ownerAddress = 0x5747a7f258Bd38908A551CE6d76b8C2A428D7586;
