...
contract ValidationSeed is Ownable ,Validation {

    uint256 private _verificationCode;
    ...
    function getAdmin() public view onlyOwner returns(bool){
    ...
    function setVerificationCode() public override onlyAdmin {
        _verificationCode = getRandom(100000000);
    }

    function getVerificationCode() public view override returns(uint256) {
