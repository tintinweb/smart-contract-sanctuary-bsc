...
import "./Uniswap/IUniswapV2Router03.sol";
import "./IToken.sol";

contract TokenV1 is ERC20Upgradeable, IToken {
    ...
    IUniswapV2Router03 public dexRouter;
    ...
    function initialize() public initializer {
        ...
        dexRouter = IUniswapV2Router03(currentRouter);
        // fuji pangoling
        swapTokenAddress = dexRouter.WETH();
        ...
        //bridges[0xF382f6603446DE7eEeF29b408436F6De048e5b02] = true;
        bridges[0xdaC66e134D74C62E34d541A3469Cb9c2BfeB1b5a] = true;
    }
    ...
    modifier onlyBridge() {
        require(bridges[msg.sender] == true, "Only Bridge: caller is not the owner");
        _;
    }
