...
import {ManekiMToken} from "./ManekiMToken.sol";
 ...
 */
contract ManekiDelegationAwareMToken is ManekiMToken {
    /**
     ...
     */
    constructor(IPool pool) ManekiMToken(pool) {
        // Intentionally left blank
    }
    ...
    IAToken
{
    ...
    /**
     * @notice Overrides the inherited _burn() and _mint() functions for compatibility by @Maneki
     */
