...
contract XXXXXX is Context, Ownable , ReentrancyGuard {
    ...
    constructor() {
        //dev = payable(0xc3EECD1F92E67c120024D92d8395435F2F67CE04);   mainnet
        dev = payable(0xc3EECD1F92E67c120024D92d8395435F2F67CE04);   // testnet
        //startDate = ; //mainnet
         startDate = block.timestamp;  //testnet
    ...
    function deposit(address _ref, uint256 _amount) public noReentrant  {
        ...
        // uint256 deadline_weekly = block.timestamp + (TIME_STEP * 5);
    ...
    function withdrawal() public noReentrant { 
        ...
        require(totalRewards[msg.sender].amount <= SafeMath.mul(investments[msg.sender].invested,2), "You cant withdraw you have collected two times Already");
        ...
        if(userCompoundCount[msg.sender] < compound_step){
    ...
    function compound() public noReentrant { 
        ...
        userCompoundCount[msg.sender] += 1;
