...
contract FRGW is Ownable, IBEP20 {
    ...
    string constant _name = "ANYA INU";
    string constant _symbol = "ANYA";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xE46F6F8E3769A92EF361833271c1124C13EA873D;
        marketingWallet = 0xE46F6F8E3769A92EF361833271c1124C13EA873D;
        frWallet = 0x8927De3c7005024Ec600001247c2EE7295092fF6;
        
        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(frFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountBNBmf = amountBNB.mul(frFee).div(totalBNBFee);
        
        (bool tmpSuccess1,) = payable(marketingWallet).call{value : amountBNBMarketing, gas : 30000}("");
        tmpSuccess1 = false;

        (bool tmpSuccess2,) = payable(frWallet).call{value : amountBNBmf, gas : 30000}("");
        tmpSuccess2 = false;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newFrFee, uint256 extraSellFee) external onlyOwner {
