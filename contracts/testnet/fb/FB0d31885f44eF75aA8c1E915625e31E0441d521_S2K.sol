...
contract S2K is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 50_000_000_000_000; //50 Trillion, underscores aid readability
    ...
    string private _name = "2K75";
    string private _symbol = "S2K";
    ...
    uint256 private maxMarketingFee = 500;
    ...
    address payable public _marketingWallet = payable(0xADEc5d194552643aC2ba0e7c642526219Ed79cF2);
