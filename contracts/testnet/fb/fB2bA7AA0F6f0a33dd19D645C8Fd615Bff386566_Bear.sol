...
contract Bear is ERC721AQueryable, BaseTokenURI {
  ...
  mapping(uint256 => bool) public isPhasePaused;
  ...
  constructor(
    ...
    phaseCost[1] = 0.1 ether;
    phaseCost[2] = 0.2 ether;
  }
  ...
  function mint(
    ...
    require(!isPhasePaused[_phase], "Minting is paused");
  ...
  function setIsPhasePaused(uint256 _phase, bool _isPaused) external onlyOwner {
    isPhasePaused[_phase] = _isPaused;
  }
