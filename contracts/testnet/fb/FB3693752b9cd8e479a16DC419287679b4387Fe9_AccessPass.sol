...
contract AccessPass is ERC1155, Ownable, Pausable {
    ...
    constructor() ERC1155("https://game.example/api/item/{id}.json") {
        ...
        pricesUSD[0] = uint256(499).div(100); // $4.99
        pricesUSD[1] = uint256(999).div(100); // $9.99
        pricesUSD[2] = uint256(1999).div(100); // $19.99
        pricesUSD[3] = uint256(2999).div(100); // $29.99
        pricesUSD[4] = uint256(3999).div(100); // $39.99
        pricesUSD[5] = uint256(4999).div(100); // $49.99
    }
        ...
        returns (uint256)
    {
        uint256 result;
        if (id == 0) {
            result = (1 / uint256(getLatestPrice())) * pricesUSD[0];
        } else if (id == 1) {
            result = uint256(1).div(uint256(getLatestPrice())).mul(
                pricesUSD[1]
            );
        } else if (id == 2) {
            result = uint256(1).div(uint256(getLatestPrice())).mul(
