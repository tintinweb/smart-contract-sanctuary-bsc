...
// File: contracts/NFT_MARKET_V7.sol
...
contract NFTMarket is Ownable ,ReentrancyGuard {
    ...
    function createMarketItem(
        ...
        if(listingPrice != 0){
            ...
            IBEP20 paytoken;
            paytoken = tokens.paytoken;
            paytoken.transferFrom(msg.sender, address(this), listingPrice);
        }
    ...
    function createMarketSale(address nftContract, uint256 itemId,uint256 inPrice,uint256 _pid)
        public
        payable
        nonReentrant
    {
        ...
        IBEP20 paytoken;
        paytoken = tokens.paytoken;
        paytoken.transferFrom(msg.sender, idToMarketItem[itemId].seller, price);
