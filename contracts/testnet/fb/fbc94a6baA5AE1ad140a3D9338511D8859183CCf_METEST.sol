...
contract NodeManager is Ownable, Pausable {
  ...
  uint256[] public totalNodesCreatedByTier = [0,0,0,0,0];
  ...
  uint256[] public _tiersRewards = [1250,8000,30000,87500,300000]; // 10000 => 1 METAESTATE
...
contract METEST is ERC20, Ownable, PaymentSplitter {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        address uniV2Router
    ) ERC20("MetaEstate", "MESTv1") PaymentSplitter(payees, shares) {

        teamPool = addresses[0]; //0x31f6D1460C2F87788f091bF3C276b3A78ad3A5b3;
        distributionPool = addresses[1]; //0x82Fa82501c29C9d59B339EF1574e92c1ED52040a;
        devPool = addresses[2]; //0x2cA24e6143B30bb8793559f2291d4A88ca11EAc4;
        advisorPool = addresses[3]; //0x7b1aAF4d325142a72C7D30096df17e60d9688777;
    ...
    function getTotalCreatedNodesByTier(uint256 tier) public view returns (uint256) {
        return nodeManager.totalNodesCreatedByTier(tier);
    }
