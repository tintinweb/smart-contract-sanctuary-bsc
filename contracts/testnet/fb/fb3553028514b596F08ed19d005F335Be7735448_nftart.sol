...
contract nftart is Context, IERC20Metadata, Ownable, AccessControlEnumerable {

    string private constant NAME = "NFT-Art.Finance";
    string private constant SYMBOL = "NFTART";
    ...
    uint256 private MAX_SUPPLY = 100000000000 * 10**6 * 10**9;
