...
contract Testnigger is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TEST NIG";
    string constant _symbol = "TNIG";
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xaB4D6C0ee63049147C83Efde427Ae0a629c9427A;
