...
contract MetavelerNft is ERC721, Ownable, ERC721Enumerable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant tokenPrice = 13000000000000000; // 1 BNB
    uint256 public constant maxTokenPurchase = 3;
    uint256 public constant MAX_TOKENS = 10000;

    string public baseURI = "https://mtvlr.herokuapp.com/v1/land/get/land/nft/"; // IPFS URI WILL BE SET AFTER ALL TOKENS SOLD OUT

    bool public saleIsActive = false;
    bool public isRevealed = true; // İlk etapta soru işareti mi olsun ? true = hayır false = evet
    uint256 public devReserve = 64;

    event NFTMinted(uint256 tokenId, address owner);

    constructor() ERC721("MetavelerLandNft", "MVRNFT") {}
        ...
        returns (string memory)
    {
        ...
        if (isRevealed == false) {
            return
                "ipfs://QmR5xYufcCwbagAzMuhxmn8PZ9Mky6DgWsK3JAGMyF9Ri2/hidden.json";
        }
