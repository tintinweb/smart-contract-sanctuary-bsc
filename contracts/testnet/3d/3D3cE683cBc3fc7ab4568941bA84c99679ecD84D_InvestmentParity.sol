...
function distributeAlpha (address[] memory _users) external onlyManager{
      ...
      for (uint256 i = 0; i < _users.length ; ++i) {
        ...
        if ((_depositAlphaTotalOld > 0) && (_depositAlpha > 0)){
        ...
        if ((_withdrawalAlphaTotalOld >0) && (_withdrawalAlpha > 0)){
...
function distributeBeta (address [] memory _users) external onlyManager{
      ...
      for (uint256 i = 0; i < _users.length ; ++i) {
        ...
        if ((_depositBetaTotalOld > 0) && (_depositBeta > 0)){
        ...
        if ((_withdrawalBetaTotalOld > 0) && (_withdrawalBeta > 0)){
...
function distributeGamma 
    (address [] memory _users) external onlyManager{
      ...
      for (uint256 i = 0; i < _users.length ; ++i) {
        ...
        if ((_depositGammaTotalOld >0) && (_depositGamma > 0)){
        ...
        if ((_withdrawalGammaTotalOld >0) && (_withdrawalGamma > 0)){
