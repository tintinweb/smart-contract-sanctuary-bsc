...
// File: https://github.com/hashlips-lab/nft-erc721-collection/blob/main/smart-contract/contracts/YourNftToken.sol
...
contract TestNFT is ERC721A, Ownable, ReentrancyGuard {
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    require(_mintAmount + balanceOf(msg.sender) <= maxMintAmountPerWallet, "Max Wallet limit reached");
 ...
 // public mint
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
    require(!publicMintEnabled, "Public Sale is not live yet");
  ...
  function revealCollection(bool _state) public onlyOwner {
    revealed = _state;
  }
  ...
  function setMaxMintAmountPerWallet(uint256 _maxMintAmountPerWallet) public onlyOwner {
      require (_maxMintAmountPerWallet <= 5, "Max per wallet limit is 5");
  ...
  function setUriExtension(string memory _uriSuffix) public onlyOwner {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // This will transfer ALL contract balance to the owner.
