...
contract Ownable is Context {
    ...
    modifier onlyScott() {
        ...
        require(_msgSender() == 0x04E36963290974466588da38cf41Bb773Dc9b1aa, "Scottable: caller is not Scott");
        _;
    }
...
contract YYT is ERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x4f414a7bA140739D614321506B9F4727d43644A0);
    ...
    constructor() ERC20("YYT", "$YYT") {
        ...
        uniswapV2Router = IUniswapV2Router02(
            ...
            0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 // Main
        );
