...
import "./GovPermissions.sol";
import "./IGovCore.sol";

/// @title Source of truth
/// @notice maintains roles, access control, gov, and the treasury
contract GovCore is IGovCore, GovPermissions, Initializable {
...
import "./IGovPermissions.sol";

/// @title Access control module
contract GovPermissions is IGovPermissions, AccessControlEnumerable {
...
interface IGovCore is IGovPermissions {
    // ----------- Events -----------
...
import "./IGovPermissionsRead.sol";

/// @title Permissions interface
interface IGovPermissions is IAccessControl, IGovPermissionsRead {
    // ----------- Governor only state changing api -----------
