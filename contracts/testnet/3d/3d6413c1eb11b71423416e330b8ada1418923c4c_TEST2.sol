...
contract StandardToken is ERC20Basic {
  ...
  */
    ...
    function transferFrom(
        ...
        address _to,
        uint256 _value
    ) public    virtual override returns (bool trans) {
        require(_to != address(0), "Address Cannot be of 0");
...
contract TEST2 is StandardToken,Ownable {
    using SafeMath for uint256;
    ...
    address public _devWalletAddress =
        0xAD55d566E26B1618a124C5F2a969E6d30D688d25;
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (2**256 - 1) % _tTotal;
    uint256 private _tFeeTotal;
    string private name = "TEST2";
    string private symbol = "TST2";
    uint8 private decimals = 18;
    uint256 public _taxFee = 0;
    uint256 public _previousTaxFee = 0;
    uint256 public _previousDevFee = 0;
    uint256 public _previousLiquidityFee = 0;
    ...
    function setMaxTxPercent(uint256 maxTxPercent) public onlyOwner {
        maxTxAmount = maxTxPercent * 10**decimals;
    }
