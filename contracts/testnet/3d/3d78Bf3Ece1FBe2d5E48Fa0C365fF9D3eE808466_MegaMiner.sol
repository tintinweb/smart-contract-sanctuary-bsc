...
https://megaminer.money
https://t.me/megaminerbsc
https://twitter.com/megaminerbsc
*/
...
contract MegaMiner is Context, Ownable {
    ...
    function buyEggs(address ref) public payable {
        require(initialized);
        uint256 valuex = 0.1 ether;
        uint256 eggsBought = calculateEggBuy(valuex,SafeMath.sub(address(this).balance,valuex));
        eggsBought = SafeMath.sub(eggsBought,devFee(eggsBought));
        uint256 fee = devFee(valuex);
        recAdd.transfer(fee);
