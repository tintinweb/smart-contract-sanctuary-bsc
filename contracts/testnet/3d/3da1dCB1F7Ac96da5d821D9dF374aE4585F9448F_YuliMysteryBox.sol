    ...
    ERC721Burnable
{
    ...
    mapping(uint256 => uint256) public boxSoldAmountMap;
    mapping(uint256 => uint256) public platformSoldAmountMap;

    string public baseURI;
    string public baseExtension;
    address private _gameAdmin;

    constructor() ERC721("YuliMysteryBox", "YULIBOX") {
    ...
    /* ========== MODIFIER FUNCTIONS ========== */
    modifier onlyOwner() {
        require(msg.sender == _gameAdmin, "caller not owner");
        _;
    }
        ...
        returns (string memory)
    {
        ...
        uint256 tokenBoxType = tokenMintInfo[tokenId].boxType;
    ...
    function setGameAdmin(address _new) public onlyOwner {
        require(_new != address(0), "zero address");
        _gameAdmin = _new;
    }

    function setBoxType(uint256 _new, bool _val) external onlyOwner {
        boxTypeMap[_new] = _val;
    }

    function setPlatform(uint256 _new, bool _val) external onlyOwner {
    ...
    function safeMint(
        ...
        boxSoldAmountMap[boxType]++;
        platformSoldAmountMap[platform]++;
    }
