...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x33Ab8191E09FB820eC61F17d551B3786F1D55fe2; // owner address
...
contract FootballKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FootballKing";
    string private _symbol = "FootballKing";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC094eA9e65Bf3c1A8bc21210bF03F100Eb250AE4); // Marketing Address
    address payable public teamWalletAddress = payable(0x07aF8Fb0dDdeaF01bD9CEF824D9985E5a25Ddd73); // Team Address
