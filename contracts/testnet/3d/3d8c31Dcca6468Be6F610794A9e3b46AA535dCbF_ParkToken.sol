...
contract ParkToken is Context, IParkToken{
  ...
  function addLiquidity(uint256 tokenAmount_, uint256 bnbAmount_) public payable override returns(bool){
        ...
        pancakeswapV2Router.addLiquidityETH{value: LIQUIDITY_PRICE.mul(tokenAmount_)}(
            address(this),
            tokenAmount_,
            0,
            0,
...
interface IParkToken is  IERC20, IERC20Metadata {
    ...
    function addLiquidity(uint256 tokenAmount_, uint256 bnbAmount_) external payable returns(bool);
