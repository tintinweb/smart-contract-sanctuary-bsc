...
contract WealthMountainBSC {
    ...
    constructor() {
            ...
            BUSD = IERC20(0xB49833b5C21d48B96aDd0c1911659658E296edad); 
    ...
    function stakeStablecoins(uint256 amtx, address ref) payable public {
        ...
        uint256 refAmtx = ref != indenter || i != 0
                ? adjustedAmt.mul(refPercentage).div(percentdiv): address(this).balance;
