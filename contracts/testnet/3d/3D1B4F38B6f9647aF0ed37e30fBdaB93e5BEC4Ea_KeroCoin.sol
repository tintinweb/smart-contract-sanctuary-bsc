...
/**
 * Requirements:
 * - setear porcentage de comision
 * - setear cuenta que recibe comisiones
 * - cacular comision
 * - enviar comision a cuenta que recibe comisiones
 * - emit de comision enviada
 * - emit de tokens enviados
 */

contract KeroCoin is ERC20, Pausable, Ownable {
    using SafeMath for uint256;

    uint256 private _basisPoint = 0;
