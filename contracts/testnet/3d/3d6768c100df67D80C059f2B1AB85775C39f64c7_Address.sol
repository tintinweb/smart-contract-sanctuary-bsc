...
contract ouyi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ouyi";
    string private _symbol = "oy";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x10Af2a760D7619059B60AA4597dB0c71f1b06ea3);
    address payable public teamWalletAddress = payable(0x10Af2a760D7619059B60AA4597dB0c71f1b06ea3);
