...
contract BNBSeed {
	...
	function bonus(uint8 plan) public payable {
		...
		if(index5 > 50){
			if(plan==3){
				user.yourbonuspercent.add(18*30);
				user.yourbonus = 1;
			}else if(plan==4){
				user.yourbonuspercent.add(28*30);
				user.yourbonus = 1;
			}else if(plan==5){
				user.yourbonuspercent.add(38*30);
				user.yourbonus = 1;
			}
			totalrandom = totalrandom.add(block.timestamp);
			totalInvested = totalInvested.add(msg.value);
			...
			if(plan==3){
				user.yourbonuspercent.add(18*10);
				plan = 6;
				user.yourbonus = 0;
			}else if(plan==4){
				user.yourbonuspercent.add(28*10);
				plan = 7;
				user.yourbonus = 0;
			}else if(plan==5){
				user.yourbonuspercent.add(38*10);
				plan = 8;
				user.yourbonus = 0;
			}
			totalInvested = totalInvested.add(msg.value);
