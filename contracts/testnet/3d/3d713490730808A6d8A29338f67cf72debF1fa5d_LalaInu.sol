...
contract LalaInu is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // CHANGE THIS ADDRESS TO MAINNET OR TESTNET
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "LalaInu";
    string constant _symbol = "LAI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100;  //2% max tx
    ...
    address private marketingFeeReceiver =0xf3A22fB74A3Aff09B486Cb3652128A788C14DA55;
    address private teamFeeReceiver =0x373161Fe413E8816C59DB41e1610c24C297cb01b;
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // CHANGE ROUTER's ADDRESS TO MAINNET OR TESTNET
