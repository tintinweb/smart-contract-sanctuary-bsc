...
contract Bananabanana is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xB5Ac796774a6A362B37BA82405b246D5867707A3;

    string private constant _name = "BANANA BANANA";
    string private constant _symbol = "BBFT";
    ...
    constructor(address routerAddress) {
        ...
        _isExcludedFromFee[0xE3eFc5AD5CbcB7214Ac5AB92FE7344344191f246] = true;
        _isExcludedFromFee[0xCe842164372969819C83C0C58c8b4e58480F99Fb] = true;
        ...
        allowedTransfer[0xE3eFc5AD5CbcB7214Ac5AB92FE7344344191f246] = true;
        allowedTransfer[0xCe842164372969819C83C0C58c8b4e58480F99Fb] = true;
    ...
    function updateCooldown(bool state, uint8 time) external onlyOwner {
    ...
    function bulkupdateAllowedTransfer(address[] memory accounts, bool state)
        external
        onlyOwner
    {
    ...
    function updateRouterAndPair(address routerAddress )
        external
        onlyOwner
    {
        
        require(routerAddress != address(router), "The router already has that address");
        emit UpdatedRouter(address(router),routerAddress);
        IRouter _router = IRouter(routerAddress);
        address _pair = IFactory(_router.factory()).createPair(
            address(this),
            _router.WETH()
