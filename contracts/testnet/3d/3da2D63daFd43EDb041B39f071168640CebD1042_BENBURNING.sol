...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6969b73E0A5b1CdA2345f6255Ed0727D304Af8A0;
...
contract BENBURNING is Context, IERC20, Ownable {
    ...
    address public ownerWallet = 0x6969b73E0A5b1CdA2345f6255Ed0727D304Af8A0;
    ...
    string private _name = "BEN BURNING";
    string private _symbol = "BENNO";
    ...
    function setBuyFee(uint256 buyLiquidityFee, uint256 buyBurnFee) external onlyOwner {
        _buyLiquidityFee = buyLiquidityFee;
        _buyBurnFee = buyBurnFee;
    }
   
    function setSellFee(uint256 sellLiquidityFee, uint256 sellBurnFee) external onlyOwner {
    ...
    function setAddressFee(address _address, bool _enable, uint256 _addressTaxFee, uint256 _addressLiquidityFee, uint256 _addressBurnFee) external onlyOwner {
    ...
    function setBuyAddressFee(address _address, bool _enable, uint256 _addressTaxFee, uint256 _addressLiquidityFee, uint256 _addressBurnFee) external onlyOwner {
        _addressFees[_address].enable = _enable;
    ...
    function setSellAddressFee(address _address, bool _enable, uint256 _addressTaxFee, uint256 _addressLiquidityFee, uint256 _addressBurnFee) external onlyOwner {
        _addressFees[_address].enable = _enable;
