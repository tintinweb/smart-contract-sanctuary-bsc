...
contract DinoV2StakingAuto is Context, Auth, IERC20 {
    ...
    function batchRestake() public {
        uint maxLoop = shareholders.length > maxLoopShare ? maxLoopShare : shareholders.length;
    ...
    function setMaxLoop(uint _maxLoop) external onlyOwner {
        maxLoopShare = _maxLoop;
    }
