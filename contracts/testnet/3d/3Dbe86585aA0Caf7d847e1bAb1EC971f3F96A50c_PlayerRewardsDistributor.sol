...
/**
 * @title PlayerRewardsDistributor
 * @notice It distributes Sesame tokens with rolling Merkle airdrops.
 */
contract PlayerRewardsDistributor is Pausable, ReentrancyGuard, Ownable {
    ...
    event UpdatePlayerRewards(uint256 indexed rewardRound);
    event TokenWithdrawnOwner(uint256 amount);

    /**
     * @notice Constructor
     * @param _sesameToken address of the LooksRare token
     */
        ...
        nonReentrant
    {
        ...
        sesameToken.safeTransfer(msg.sender, adjustedAmount);
    ...
    function updatePlayerRewards(
        ...
        emit UpdatePlayerRewards(currentRewardRound);
    }
