...
contract nimade is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "nimade";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3b7FF2453FA841dF6db8cEB4C7F56249d6096f5b));
        marketingWalletAddress = payable(address(0x888b16f68ABC2c729399814176569e891C070f91));
