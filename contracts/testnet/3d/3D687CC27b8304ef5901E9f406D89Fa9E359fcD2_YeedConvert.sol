...
contract YeedConvert is Ownable {
    ...
    IERC20 public yeedToken = IERC20(0xE61bD93a804Fd3cf05C75F6394F97Bd14eb38b45);
    IERC20 public zeedToken = IERC20(0x8a96A3226f262a60cceCEc33b83aE3C4355A1375);
    IERC20 public hoToken = IERC20(0x81C9c42be475D65bE1F1b4B0F6fA3D84222D03C9);
    IERC20 public usdtToken = IERC20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);

    address _yeedAddress = 0xE61bD93a804Fd3cf05C75F6394F97Bd14eb38b45;
    address _zeedAddress = 0x8a96A3226f262a60cceCEc33b83aE3C4355A1375;
    address _hoAddress = 0x81C9c42be475D65bE1F1b4B0F6fA3D84222D03C9;
    ...
    uint256 public whitelistConverRatio = 2;
    ...
    function setWhitelist(address[] memory _account, uint256[] memory _amount) public onlyOwner {
        for (uint256 i = 0; i < _account.length; i++) {
            ...
            user.whitelistAmount = (_amount[i] * 10 ** 18);
