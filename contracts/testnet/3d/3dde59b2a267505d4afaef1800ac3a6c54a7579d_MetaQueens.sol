...
contract MetaQueens {
    ...
    function userDetails(address _addr) view external returns(uint256 [7] memory pkg,uint256 [7] memory levelteam) {
        for(uint8 i = 0; i < 7; i++) {
    ...
    function poolDetails(address _addr) view external returns(uint256[7] memory clubTeam1,uint256[7] memory clubTeam2) {
        for(uint8 i=0;i<7;i++){
    ...
    function incomeDetails(address _addr) view external returns(uint256 totalInc,uint256 wdl,uint256[7] memory royaltyinc,uint256[7] memory clubinc) {
        for(uint8 i=0;i<7;i++){
