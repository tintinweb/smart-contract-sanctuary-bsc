...
contract BNBWorldCup {
	...
	uint256 public COMPOUND_BONUS_MAX_TIMES = 16;
    ...
    constructor(address payable _dev, address payable _prtnr, address payable _mkt) {
		require(!isContract(_dev) && !isContract(_prtnr) && !isContract(_mkt));
        owner = msg.sender;
        dev = _dev;
        prtnr = _prtnr;
        mkt = _mkt;
