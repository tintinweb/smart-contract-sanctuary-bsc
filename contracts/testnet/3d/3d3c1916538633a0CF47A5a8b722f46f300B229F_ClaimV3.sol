...
contract ClaimV3 is AccessControl {
    ...
    function claimOption2() external {
        ...
        withdrawClaim.emergencyWithdraw(amount);
    ...
    function claimOption1() external {
        ...
        withdrawClaim.emergencyWithdraw(amountPeriod);
    ...
    function safeBurn(uint256 _amount) internal {
        uint256 HEBalance = tokenHeroes.balanceOf(address(claim));
