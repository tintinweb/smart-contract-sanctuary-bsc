...
contract CONTRACTNAME is ERC20, Ownable {
    ...
    constructor() ERC20("CONTRACTNAME", "TOK", 18) {
    	...
    	liquidityWallet = 0x01976b2c219B41149310aF8149b0f87BC077bb0b;
    	operationsWallet = 0x01976b2c219B41149310aF8149b0f87BC077bb0b;
        ...
        _createInitialSupply(owner(), totalSupply * 500 / 1000);
        _createInitialSupply(liquidityWallet, totalSupply * 250 / 1000);
        _createInitialSupply(operationsWallet, totalSupply * 250 / 1000);
    }
