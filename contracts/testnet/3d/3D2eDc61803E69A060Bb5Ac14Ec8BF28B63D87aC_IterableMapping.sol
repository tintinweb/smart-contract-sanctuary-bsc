...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
 ...
 //test WBNB 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F
  address public constant token = address(0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F); // WBNB 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 1e6 * 1e18; //must hold 1,000,000+ tokens 1 *
    }
...
contract ThePeoplesToken is ERC20, Ownable {
    ...
    constructor() ERC20("ThePeoplesToken", "TPT") {
        address newOwner = address(0x584B7d84b2cea5E0bc2A52A1df5B5b70b3EF86a5); 
        minter = msg.sender; // only initially
    
        uint256 totalSupply = 420 * 1e12 * 1e18;
    	...
    	marketingWallet = address(0xB201b22ACc6941C6cB4F8D4467309A4e264B071C); // set as marketing wallet
        charityWallet = address(0x1B7A5754C9a76440dEc702AB5c31029F0457bada); // set as charity wallet
        liquidityWallet = address(0x44113bdB32264a78057cC1C3CC46c1B63BA39078); // set as liquidity wallet
    ...
    receive() external payable {
      ...
      function passMinterRole(address TPBank) public returns (bool) {
  	require(msg.sender == minter, 'Error, only owner can change pass minter role');
  	minter = TPBank;

    emit MinterChanged(msg.sender, TPBank);
    return true;
  }
  ...
  function mint(address account, uint256 amount) public {
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _charityFee) external onlyOwner {
        ...
        require(totalBuyFees <= 3000, "Must keep fees at 30% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _rewardsFee, uint256 _liquidityFee, uint256 _charityFee) external onlyOwner {
        ...
        require(totalSellFees <= 3000, "Must keep fees at 30% or less");
    }
