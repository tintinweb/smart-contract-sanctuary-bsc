...
contract NBDA is BEP20, BEP20Burnable, Pausable, Ownable {
    mapping(address => uint256) public lockedOfamount;
    uint256 public _totalSupply;

    constructor() BEP20("New Blocks Dao Asset", "NBDA") {
    ...
    function transferFrom(
        ...
        require(isUnLockedOf(_msgSender(), amount), "msgSender is locked");
