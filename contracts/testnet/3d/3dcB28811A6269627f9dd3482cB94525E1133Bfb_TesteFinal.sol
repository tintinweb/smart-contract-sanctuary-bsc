...
// Proprietary by Lameni - @lamenicrypto
// SmartContract License. This SmartContract is protected by copyright laws and international copyright treaties,
// as well as other intellectual property laws and treaties. This SmartContract is licensed, not sold.
...
contract TesteFinal is GasHelper, ERC20 {
  ...
  address constant private BUSD = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee; // BSC BUSD TESTET

  string constant private _nameToken = "TesteFinal";
  string constant private _symbolToken = "SMBT";
  ...
  uint256 public rewardWithdrawWaitTime = 3600; // 1 hour
  ...
  constructor()ERC20(_nameToken, _symbolToken) {
    ...
    administrativeWallet = 0x3F7b1b732eA81897D49F565507b5AcA2Bb194759;
    _permissions[administrativeWallet] = 15; // exempt fee, fee receiver, tx limit and wallet limit
    internalFundWallet = 0xA03fF56a3fFd9c498bfF8b3E56C5fC74c8B7DF2B;
