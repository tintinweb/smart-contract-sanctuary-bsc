...
contract itSucks is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "I love Her";
    string private constant _symbol = unicode"butwen?";
    ...
    function LetsFuckinGo() public onlyOwner {
