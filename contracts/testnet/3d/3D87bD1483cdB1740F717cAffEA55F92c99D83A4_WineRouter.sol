...
// File: contracts/router/interfaces/IApePair.sol
...
// File: contracts/router/libraries/ApeLibrary.sol
...
library ApeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'4e816460966a76c68102706db271e3a7b55281333cdc3bdedadc3aa4c3c52945' // init code hash
            ))));
    }
    ...
    function getAmountOut(uint amountIn, uint reserveIn, uint reserveOut) internal pure returns (uint amountOut) {
        ...
        uint denominator = reserveIn.mul(10000).add(amountInWithFee * 10);
...
// File: contracts/router/interfaces/IApeRouter01.sol
...
// File: contracts/router/interfaces/IApeRouter02.sol
...
// File: contracts/router/interfaces/IApeFactory.sol
...
// File: contracts/router/ApeRouter.sol
...
contract WineRouter is IApeRouter02 {
    using SafeMath for uint;
