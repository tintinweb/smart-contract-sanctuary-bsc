...
contract Fastincome is Ownable {
    struct User {
        uint256 cycle;
        address upline;
        uint256 referrals;
    ...
    address payable public devAddr    = payable(0x65b5E95d624169a8b67EfACe39C15B24da125f48);
    ...
    uint256 public constant DEPOSIT_DEV_FEE         = 200; // 2%
