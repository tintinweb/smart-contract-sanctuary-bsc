...
contract PutYourProjectNameHere is ERC721A, Ownable, ERC2981, DefaultOperatorFilterer {
    using Strings for uint256;
    ...
    uint256 public rewards_rate = 300; // 30% Rewards Rate

    constructor(string memory _initBaseURI, string memory _initNotRevealedUri, string memory _contractURI) ERC721A("Put Your Project Name Here", "PYPNH") {
     
    setBaseURI(_initBaseURI);
    setNotRevealedURI(_initNotRevealedUri);   
    setRoyaltyInfo(owner(),1000); // 10% Royalties
    ...
    function swapETHForWUSDT(uint256 bnb_amount_in) private {
