...
////////////////////////////////////////// methods for full balance
        ...
        returns (uint256 _rewardAllowedToClaim, uint256 _rewardInDelay)
    {
        ...
        _period = _calculateNonSuspensionPeriod(stakingStartDate, block.timestamp - rewardDelayPeriod);
        _rewardAllowedToClaim = CompoundPercent.compound(approximateFullBalanceInBase, _totalPercent, _period);
