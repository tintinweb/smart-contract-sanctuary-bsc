...
/* Token contract */
contract xxxVersus is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address VAULT = 0x45aF10e4cD0e7cb6E46002dFE4De32b74f6A9E5b;   //VAULT address  VAULT
    ...
    // Name and symbol
    string constant _name = "xxxVersus";
    string constant _symbol = "xVERSUSx";
    ...
    uint256 public VAULTFeeSell = 10;
    ...
    uint256 public swapThreshold = _totalSupply * 250 / 10000; // 25 000 000 Tokens
    ...
    // Trigger a manual buyback    // -> Remix 1 = .1 BNB Worth
