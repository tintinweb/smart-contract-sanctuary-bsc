...
contract EGGMarketing is Ownable {
    ...
    FountainTokenInterface fountain = FountainTokenInterface(0x552bFb1A18BF5a7B70Bb1B786Af33cebD5Dd537F);
    ...
    function airDrop(address[] memory addrs) public virtual onlyOwner {
         fountain.airDrop(addrs);
    }

    function checkWhiteList(address[] memory whiteList) internal view returns(bool){
        bool isHave = false;
