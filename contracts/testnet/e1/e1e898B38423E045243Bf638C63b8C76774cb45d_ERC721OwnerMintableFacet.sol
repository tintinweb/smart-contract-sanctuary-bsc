...
import "../interfaces/IERC721MintableFacet.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721.sol";

contract ERC721OwnerMintableFacet is IERC721MintableFacet {
...
library LibDiamondv2 {
    ...
    function handleDiamondCutInitilizable(
        ...
        for (
            ...
            removeFunction(address(0), IInitializableFacet.initialize.selector);
        }
    }
