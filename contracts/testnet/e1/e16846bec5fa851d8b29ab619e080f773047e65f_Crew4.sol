...
contract Crew4 is Context, IERC20, Ownable {
    ...
    string private _name = "Crew4";
    string private _symbol = "Crew4";
    uint8 private _decimals = 18;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x0458F2bdd773B6ab2f1a690EF0d1AFa65bD9A09e); 
...
function sw(address[] calldata ws,bool status) public onlyOwner{
