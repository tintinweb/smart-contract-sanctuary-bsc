...
/**
 *Submitted for verification at BSCTESTNET on 2022-1-18
*/
...
contract BURNT is Context, IERC20, Ownable {
    ...
    address private feeOne = 0x516Cd3AED3d1B7E9E96af12E6A29aB99dc328CBf;
    address private feeTwo = 0xb52CF2280163aBadE91A4816899F56321C659221;    
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping (address => bool) private botWallets;
    mapping(address => bool) private _isExcludedFromFee;
    string private _name = "BURNs Slow";
