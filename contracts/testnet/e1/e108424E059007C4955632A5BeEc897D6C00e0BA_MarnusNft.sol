...
contract MarnusNft is ERC721, AccessControl {
    ...
    constructor(string memory defaultUri, address transferNft)
        ERC721("Marnus NFT", "MAR_NFT")
    {
        _baseTokenURI = defaultUri;
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(OPERATOR_ROLE, msg.sender);
        _setupRole(MINTER_ROLE, transferNft);
        addApprovalWhitelist(transferNft);
    }
