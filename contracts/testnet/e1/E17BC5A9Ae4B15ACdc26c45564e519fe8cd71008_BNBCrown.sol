...
contract BNBCrown {
    ...
    function getUserDownlineCount(address userAddress) public view returns (uint256, address, uint256, address, uint256, address) {
        return (users[userAddress].levels[0], users[userAddress].referrer, users[userAddress].levels[1], users[userAddress].referrer, users[userAddress].levels[2], users[userAddress].referrer);
    }
