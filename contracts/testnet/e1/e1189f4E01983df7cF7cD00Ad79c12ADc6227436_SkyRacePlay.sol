    ...
    function creatorWithdrawalMargin (uint256 _roomId, uint256 _amount, uint256 _withdrawalType) public {
        ...
        if (quizList[_quizID].result == 3) {
            ...
            if (_withdrawalType == 1) {
                ...
                require(quizList[_quizID].result != 0, "The result is unknown");
                uint256 _oneFinal = roomList[_roomId].resultOneTotal + roomList[_roomId].roomDeposit - _amount;
                require(_oneFinal * roomList[_roomId].resultTwoFixedOdds == roomList[_roomId].resultTwoTotal * roomList[_roomId].resultOneFixedOdds, "The amount is wrong [3]");
                ...
                require(quizList[_quizID].result != 0, "The result is unknown");
                uint256 _twoFinal = roomList[_roomId].resultTwoTotal + roomList[_roomId].roomDeposit - _amount;
                require(roomList[_roomId].resultOneTotal * roomList[_roomId].resultTwoFixedOdds == _twoFinal * roomList[_roomId].resultOneFixedOdds, "The amount is wrong [4]");
