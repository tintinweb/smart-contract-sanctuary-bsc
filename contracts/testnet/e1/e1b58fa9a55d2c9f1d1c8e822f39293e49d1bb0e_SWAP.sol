...
contract SWAP {
    ...
    function BuyQuantity() external gasTokenRefund returns(bool success){
    }

    //Configure for spam transactions
    function Spam(uint256 _porcent, uint256 _amountIn, uint256 _orders, address _tknToBuy, address _tokenPaired, bool _multiWallet, bool _ForceSwap) external returns (bool success){
    }
}