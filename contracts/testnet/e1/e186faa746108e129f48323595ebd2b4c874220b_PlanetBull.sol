    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        cappedSwapableLiquidityAmount = 1000 * 10**18;

        UNISWAPV2ROUTER = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
        stakingWallet = 0x5118857e679Ac0c6F5E900ad952cFaEeAA4349c0;
        liquidityWallet = 0x5118857e679Ac0c6F5E900ad952cFaEeAA4349c0;
        marketingWallet = 0x5118857e679Ac0c6F5E900ad952cFaEeAA4349c0;
    ...
    function _transfer(
        ...
        if (enableFee && (from == uniswapV2Pair || to == uniswapV2Pair) && !isExcludedFromTax[msg.sender])
            takeFee = true;
    ...
    /**
     *@dev remove all fee (i.e staking fee,burn fee,liquidity fee,developer fee,marketing fee)
    ...
    /**
     *@dev restore all fee (i.e staking fee,burn fee,liquidity fee,developer fee,marketing fee)
    ...
    /**
      ...
      @param _liquidityWalletAddress updates developerWallet address
    ...
    */
    function excludeAllFromTax(address[] memory accounts)
        external
        onlyOwner
    {
        for (uint256 account = 0; account < accounts.length; account++) {
    ...
    /**
     ...
     @param accounts - blacklisting address
     */
    function includeAllInTax(address[] memory accounts)
        external
        onlyOwner
    {
        for (uint256 account = 0; account < accounts.length; account++) {
