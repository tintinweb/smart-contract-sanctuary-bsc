...
contract UFXToken is BEP20 {
    BEP20 public immutable BUSD = BEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
    ...
    function swapAndLiquify() private lockTheSwap transferTaxFree {
        ...
        if (contractTokenBalance >= minAmountToLiquify) {
            ...
            uint256 initialBalance = address(this).balance;//ex) 150 eth

            // swap tokens for ETH
            swapTokensForEth(half); //ex) 50eth
            swapBNBForBUSD(address(this).balance); //ex) 50eth -> xxBNB
