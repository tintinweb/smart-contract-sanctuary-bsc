...
import "./MerkleDistributorERC721V3.sol";

contract MerkleDistributionFactory is Ownable, ReentrancyGuard {
    event ERC20TokenAirdropCreated(
    ...
    event ERC721TokenAirdropCreated(
    ...
    function createERC20TokenAirdrop(
        address _token,
        bytes32 _merkleRoot,
    ...
    function createERC721TokenAirdrop(
        string memory _name,
        ...
        MerkleDistributorERC721V3 airdrop;
        if (_hasTimelock) {
            airdrop = new MerkleDistributorERC721V3(
                _name,
                _symbol,
                _merkleRoot,
                true,
        ...
        emit ERC721TokenAirdropCreated(address(airdrop), _name, _symbol, _merkleRoot);
    }
}
...
contract MerkleDistributorERC721V3 is ERC721 {
    ...
    bool public immutable hasTimelock;
