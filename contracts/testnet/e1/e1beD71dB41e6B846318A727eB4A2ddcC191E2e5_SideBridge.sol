...
/// @dev Interface of the child BEP20 token, for use on sidechains and L2 networks.
interface IBEP20Child is IBEP20 {
  /**
...
contract SideBridge {
    ...
    function initializeBridge (address _childTokenAddress) onlyOwner external {
        sideToken = IBEP20Child(_childTokenAddress);
