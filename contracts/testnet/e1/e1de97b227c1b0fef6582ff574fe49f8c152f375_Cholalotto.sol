    ...
    ReentrancyGuard
{
    ...
    uint256 public ticket1Timeline = 10 minutes;
    uint256 public ticket2Timeline = 15 minutes;
    uint256 public ticket3Timeline = 20 minutes;
    uint256 public ticket4Timeline = 25 minutes;
    uint256 public ticket5Timeline = 30 minutes;
    uint256 public ticket6Timeline = 35 minutes;
    uint256 public ticket7Timeline = 40 minutes;
    uint256 public ticket8Timeline = 45 minutes;

    uint256 public ticket1Time ;
    uint256 public ticket2Time ;
    uint256 public ticket3Time ;
    uint256 public ticket4Time ;
    uint256 public ticket5Time ;
    uint256 public ticket6Time ;
    uint256 public ticket7Time ;
    uint256 public ticket8Time ;
    ...
    function claimWinningAmount(uint256 _contest, uint256 _cycle) external {
        ...
        if(_contest == 1){
            for(uint256 i=0; i<user.purchased.length;i++){
                if(user.purchased[i].ticketid==_contest && user.purchased[i].cycle==_cycle && user.purchased[i].ticketnumber==ticket1Result[_cycle] && !ticket1Claimed[_cycle]){
            ...
            for(uint256 i=0; i<user.purchased.length;i++){
                if(user.purchased[i].ticketid==_contest && user.purchased[i].cycle==_cycle && user.purchased[i].ticketnumber==ticket2Result[_cycle] && !ticket2Claimed[_cycle]){
            ...
            for(uint256 i=0; i<user.purchased.length;i++){
                if(user.purchased[i].ticketid==_contest && user.purchased[i].cycle==_cycle && user.purchased[i].ticketnumber==ticket3Result[_cycle] && !ticket3Claimed[_cycle]){
            ...
            for(uint256 i=0; i<user.purchased.length;i++){
                if(user.purchased[i].ticketid==_contest && user.purchased[i].cycle==_cycle && user.purchased[i].ticketnumber==ticket4Result[_cycle] && !ticket4Claimed[_cycle]){
            ...
            for(uint256 i=0; i<user.purchased.length;i++){
                if(user.purchased[i].ticketid==_contest && user.purchased[i].cycle==_cycle && user.purchased[i].ticketnumber==ticket5Result[_cycle] && !ticket5Claimed[_cycle]){
            ...
            for(uint256 i=0; i<user.purchased.length;i++){
                if(user.purchased[i].ticketid==_contest && user.purchased[i].cycle==_cycle && user.purchased[i].ticketnumber==ticket6Result[_cycle] && !ticket6Claimed[_cycle]){
            ...
            for(uint256 i=0; i<user.purchased.length;i++){
                if(user.purchased[i].ticketid==_contest && user.purchased[i].cycle==_cycle && user.purchased[i].ticketnumber==ticket7Result[_cycle] && !ticket7Claimed[_cycle]){
            ...
            for(uint256 i=0; i<user.purchased.length;i++){
                if(user.purchased[i].ticketid==_contest && user.purchased[i].cycle==_cycle && user.purchased[i].ticketnumber==ticket8Result[_cycle] && !ticket8Claimed[_cycle]){
