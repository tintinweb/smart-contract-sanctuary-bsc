...
\____/\_| |_/\___/\____/\_| |_/ \_| \_/\_| |_/\_/  \___/ \___/\_| \_/
   ...
   #SHIBA NATION features:
        Buy Tax 10
            Marketing : 3%
            Reflection (Rewards for holding): 4%
            Liquidity: 3%
...
contract SHIBANATION is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 500 * 10**6 * 10**5 ;
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**6 * 10**5;
    ...
    constructor () {
        ...
        marketingWallet = payable(0x657e01B35e17a4d60fC3B1550C013Ea2d3FB9E9E);
    ...
    function setSellFee(
        ...
        require( (liquidity + marketing + taxFee )  < 20 , "Total sell tax must be lower than 20%");
    ...
    function setBuyFee(
        ...
        require( (liquidity + marketing + taxFee)  < 20 , "Total buy tax must be lower than 20%");
    ...
    function setBothFees(
        ...
        require( (buy_liquidity + buy_marketing + buy_taxFee)  < 20 , "Total sell tax must be lower than 20%");
        require( (sell_liquidity + sell_marketing + sell_taxFee)  < 20 , "Total buy tax must be lower than 20%");
        buyFee.marketing = buy_marketing;
        buyFee.liquidity = buy_liquidity;
        buyFee.taxFee= buy_taxFee;

        sellFee.marketing = sell_marketing;
        sellFee.liquidity = sell_liquidity;
        sellFee.taxFee = sell_taxFee;
    }
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= _tTotal, "Max wallet should be less or euqal to 100% totalSupply");
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        require(maxTxPercent <= 100, "Max wallet should be less or euqal to 100%");
    ...
    function _takeMarketing(uint256 tMarketing) private {
        uint256 currentRate =  _getRate();
        uint256 _rMarketing = tMarketing.mul(currentRate);
        _rOwned[marketingWallet] = _rOwned[marketingWallet].add(_rMarketing);
