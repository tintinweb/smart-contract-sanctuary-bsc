...
contract Gold is Context, ERC165, IERC721, IERC721Metadata {
    ...
    uint256 public buyTokenUsdt = 10 * 10**18;
    ...
    // 修改是否允许铸造
    function setWhetherMint(bool state_) public Owner returns (bool) {
        whetherMint = state_;
        return true;
    }

    // 修改价格
    function setBuyTokenUsdt(uint256 number_) public Owner returns (bool) {
        buyTokenUsdt = number_;
        return true;
    }
