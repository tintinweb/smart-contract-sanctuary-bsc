...
contract Lottery is RandomNumberConsumer, Ownable {
    ...
    */
    ...
    function getRandomIndex(uint256 randomValue, uint256 n, uint256 lvl) internal view returns(uint256, uint256) {
    ...
    function transferFunds(uint256 _lvl, uint256 _index) internal {
        ...
        uint256 amount = getLotteryEGCLbalance()/2;
