...
contract AniwarNftAdminController is Ownable {
    ...
    // Owner Only
    function createManyAniwarItem(address owner, uint8 _count, string memory _aniwarType) public onlyOwner {
        require(aniwarTypesAllowed[_aniwarType], "Type Not Allowed! Add before continue!");
        require(owner != address(0), "Address Zero!");
        ANIWAR_NFT_CONTRACT.createManyAniwarItem( _count, owner, _aniwarType); 
    }
