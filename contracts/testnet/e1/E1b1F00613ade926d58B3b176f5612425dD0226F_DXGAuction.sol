...
contract DXGAuction is Ownable {
     ...
     */
    function createAuction(uint256 tokenId, uint256 price, uint256 startTime, uint256 endTime) external {
    ...
    function claimAuction(uint256 tokenId) external {
        ...
        require(msg.sender == winner, "Caller has no rights to call this method");
        require(paymentTokenAddress != address(0), "Payment token is not set");
        ...
        IERC20(paymentTokenAddress).transferFrom(winner, seller, profitValue);
        ...
        emit AuctionClaimed(seller, winner, creator, price, royalty, tokenId);
    }
