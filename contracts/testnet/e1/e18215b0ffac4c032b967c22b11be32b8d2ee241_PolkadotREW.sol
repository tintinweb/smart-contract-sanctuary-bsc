...
╚═╝      ╚═════╝ ╚══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝  ╚═════╝    ╚═╝   
 ...
 Polkadot Rewards Token . Extreme  Rewards. grab a bag now!
*/
...
contract PolkadotREW is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "PolkadotREWARDS";
    string constant _symbol = "$PolkadotREWARDS";
