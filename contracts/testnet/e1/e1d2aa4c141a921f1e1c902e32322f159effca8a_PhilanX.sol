...
// main contract
contract PhilanX is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "PhilanX";
    ...
    function setBuyFees(
        ...
        _devBuyFee = _devFee;
        totalBuyFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_devFee).add(_treasuryFee);
