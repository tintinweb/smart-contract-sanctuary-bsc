...
contract NFTAuction {
    ...
    function _payFeesAndSeller(
        ...
        for (
            ...
            uint256 c_fess = nftContractAuctions[_nftContractAddress][_tokenId].feePercentages[i];
            uint256 base_price = _getbasePrice(_highestBid , c_fess );
