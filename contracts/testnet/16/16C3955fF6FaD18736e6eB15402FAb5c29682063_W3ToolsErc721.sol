...
contract W3ToolsErc721 is Ownable, ERC721, IERC2981 {
    using Strings for uint256;
    ...
    function burn(uint256 id) external {
        ...
        require(msg.sender == oldOwner || msg.sender == getApproved(id) || isApprovedForAll(oldOwner, msg.sender), 'NOT_AUTHORIZED');
    ...
    function derivativeRoyaltyInfo(uint256 _salePrice) external view returns (address receiver, uint256 royaltyAmount) {
