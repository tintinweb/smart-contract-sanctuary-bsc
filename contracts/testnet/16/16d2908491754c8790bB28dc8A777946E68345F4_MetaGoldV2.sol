...
contract MetaGoldV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    */
    ...
    function _transfer(
        ...
        if( feesEnabled) {
            ...
            if( canSwap &&
                ...
                swapping = true;
                if(feeMultiplier > 0) {
                    uint256 feeTokens = swapTokensAtAmount.mul(feeMultiplier).div(100);
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        transferOutBNB(payable(directPaymentBNBAddressReceiver), address(this).balance.sub(initialBalance));
    }
