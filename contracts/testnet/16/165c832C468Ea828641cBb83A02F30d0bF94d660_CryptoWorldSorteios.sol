...
contract CryptoWorldSorteios is Ownable, ReentrancyGuard{
    ...
    ICryptoWorldContract cryptoInstance;
    ...
    constructor(address _cryptoWorldContract) ReentrancyGuard()
    {
        ...
        cryptoInstance = ICryptoWorldContract(_cryptoWorldContract);
    ...
    function goodLuck() external payable
    {
        ...
        if(participantsLimit == players.length)
        {
            ...
            cryptoInstance.donation{value: valueTransferContract}();
    ...
    {
        account = cryptoInstance.getAccount(_address);
    }
