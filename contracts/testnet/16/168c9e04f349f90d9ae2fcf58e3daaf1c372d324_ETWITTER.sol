...
contract ETWITTER is Context, IERC20, Ownable {
    ...
    string private _name = "ELONS TWITTER";
    ...
    address payable public devWallet = payable(0x378425548BAed63B3466Da7c33A334488326C655);
    address payable public marketingWallet = payable(0x02eFBC50DD18FBe9DB724E7e1cE8F55D08BB3Fe8); 
    ...
    uint256 public numTokensSellToAddToLiquidity = 20000 *10**18;
