...
contract MLRFactory {
    ...
    address _depository = 0x0C6A572Ba39C14Ef7E73Fff757345ec7a9Bee99A;
    ...
    function createMLR(
        ...
        // MLR
        mlr = address( new MultilevelRoyalty(_nftContract, _tokenID, _maxRoyaltyOwner, _name, _tokenName, _tokenSymbol, _depository) );
...
contract MultilevelRoyalty is Ownable, ERC20 {
    ...
    mapping(uint256 => Offer) public offers;                     // identify offers by offerID
    ...
    event ClaimDownsideProtectionInOfferByVToken(
		uint256 offerID,
		uint256 statusOrder,
		uint256 soldTime,
		address indexed buyerOrSeller,
	...
	function buyOut(
		...
		payable(_previousOwner).transfer(buyoutPrice * realRoyalty / 100);
