...
contract StakeFazel is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0xE9a1F1519fE2A201c896E210Cd7c5E7779031cE3); // token contract address
        // number of tokens Per day
        // to set rarity for tiers you need to start from 0
        // tier0 = 50 , tier1 = 60 ....
        rewardRate = [50, 60, 50, 50, 50];
    }

        function initialize() public onlyOwner {
        RTOKEN.approve(address(this), 100000000000000000000000); // amount of tokens you want to send to contracts for rewarad in wei
    }
