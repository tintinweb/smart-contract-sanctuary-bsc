...
/** 
 *  SourceUnit: /home/abc/Swati/TimeCoin/contracts/TimeToken.sol
*/
...
contract TimeToken is ERC20Burnable, Ownable {
    ...
    constructor(
        ...
        _mint(_crowdsales, (_totalSupply) / 10);
    ...
    function burn(uint256 amount) public virtual override {
        require(
            msg.sender == burnToken,
            "Sorry burning role has not been assigned to you"
        );
        super.burn(amount);
    }
