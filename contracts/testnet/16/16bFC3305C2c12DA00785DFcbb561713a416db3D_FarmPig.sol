...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
      ...
      ///REDE DE TESTE BSC
      ///bytes32 accountHash = 0xd4bb89654db74673a187bd804519e65e3f71a52bc55f11da7601a13dcf505314;
...
contract FarmPig is Context, IBEP20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,uint256 _charityFee,address _FeeAddress,address _FeeAddress2,address _LiquididyAddress,address tokenOwner) {
		_NAME = _name;
		_SYMBOL = _symbol;
		_DECIMALS = _decimals;
		...
		_isCharity[_FeeAddress2] = true;
		_isCharity[_LiquididyAddress] = true;
		FeeAddress = _FeeAddress;
		FeeAddress2 = _FeeAddress2;
		LiquidityAddress = _LiquididyAddress;
		_owner = tokenOwner;
    ...
    function _sendToCharity(uint256 tCharity, address sender) private {
        ...
        _tOwned[FeeAddress] = _tOwned[FeeAddress].add(tCharity);
            ...
            _rOwned[LiquidityAddress] = _rOwned[LiquidityAddress].add(rCharity);
            _tOwned[LiquidityAddress] = _tOwned[LiquidityAddress].add(tCharity);
            
                     _rOwned[FeeAddress2] = _rOwned[FeeAddress2].add(rCharity*3);
                    _tOwned[FeeAddress2] = _tOwned[FeeAddress2].add(tCharity*3);

        emit Transfer(sender, FeeAddress, tCharity);
        emit Transfer(sender, FeeAddress2, tCharity*3);
        emit Transfer(sender, LiquidityAddress, tCharity);
    }
