...
/**
token name:TRIPLX Benefits Token
token symbol:TRIPLX
token supply:200 000 000 000 000 000
decimals:9
*/
...
contract TRIPLX is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 200_000_000_000_000_000 * 10**9;
    uint256 public _maxTxAmount = 200_000_000_000_000_000 * 10**9; 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 2_000_000 * 10**9; // 0.01% of total supply

    string private constant _name = "TRIPLX Benefits Token"; 
    string private constant _symbol = "TRIPLX";
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 0;
    uint256 public _liquidityFee = 8;
    address public _marketingWallet = 0xF6aD66517853F23535B41991EbCaCaDEef68A42c;
    
    uint256 public _buyCooldown = 30 seconds;
    ...
    function update_maxTxAmount(uint256 newNum) external onlyOwner {
        require(
