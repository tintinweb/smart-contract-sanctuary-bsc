...
// LP: 85% LOCKED AND 15% FOR MARKETING - LOW TAXES
...
contract Test5 is ERC20, Ownable {
    ...
    address public marketingAddress = 0xD46e7E12C72dC0fc263EBcD7b025F47fB64b5AB8;
    address public buybackAddress = 0x80Ea61C010E887Ac8AE298B3Ea49eFA0919Bb964;

    bool public limitMaxAmount = true;    //max wallet is 3%
    bool public limitMaxBuyAmount = true; //max buy is 1%
    bool public limitMaxSellAmount = true;
    bool public multiBuys = true;
    bool public blackListActive = true;
    bool public sendToMarketingWallet = true;
    bool public sendToBuyBackWallet = true;
    ...
    uint public buyMarketingFees = 5;
    uint public buyBuyBackFees = 5;
    uint public sellMarketingFees = 5;
    uint public sellBuyBackFees = 5;
    uint public totalSell = buyMarketingFees + buyBuyBackFees;
    uint public totalBuy = sellMarketingFees + sellBuyBackFees;
    uint public maxBuy;
    ...
    uint public intervalSecondsForSwap = 25;
    ...
    mapping (address => bool) public isInBlackList; //dev or owner can manually blacklist sniper bots before launch

    constructor() ERC20("Test5", "ts51") { 
        
        uint totalSupplyAmount = 1000000 * 10 ** 9 * 10 ** decimals();
        // official 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        maxSellAmount = totalSupplyAmount / 100;
        excludedFromFees[address(this)] = true;
        isInBlackList[address(this)] = true;
    ...
    function enableBlackList(bool _state) external onlyOwner {
        blackListActive = _state;
    }
    ...
    function setSendFeeActive(bool _marketingActive, bool _buyBackActive) external onlyOwner {
        sendToMarketingWallet = _marketingActive;
        sendToBuyBackWallet = _buyBackActive;
    }
    ...
    function setBuyTaxes(uint marketing, uint buyBack) external onlyOwner {
        buyMarketingFees = marketing;
        buyBuyBackFees = buyBack;
        totalBuy = buyMarketingFees + buyBuyBackFees;
    }
    ...
    function setSellTaxes(uint marketing, uint buyBack) external onlyOwner {
        sellMarketingFees = marketing;
        sellBuyBackFees = buyBack;
        totalSell = sellMarketingFees + sellBuyBackFees; 
    }    
        ...
        if(!internalTransaction) {
            ...
            //Sell
                ...
                if(!excludedFromFees[from]) {
                    ...
                    if(blackListActive){
                        require(!isInBlackList[from], "Account is BlackListed");
                    }
                }
            }
            //Fees management
            if(address(this).balance > minimumWeiForTokenomics) {
                ...
                //Buyback FEES
                if(sendToBuyBackWallet) {
                    uint256 buybackTokens = minimumWeiForTokenomics * sellBuyBackFees / totalSell;
