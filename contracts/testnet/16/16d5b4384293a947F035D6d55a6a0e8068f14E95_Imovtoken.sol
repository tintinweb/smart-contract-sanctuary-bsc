...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // MAINNET ONLY
        _token = msg.sender;
    }
...
contract Imovtoken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MKT              = 0xbeAD3Cd3E42A90300C96c0fb86F364428A71351C;
    address PROJECT          = 0x64F9aE611E11B455fd9d98dB3afC88a16Be547d0;
    address TOKEN_BUSINESS   = 0x0d0212d45AC49d5B606c6ba6AFA9F737212BB70F;
    address CONTRACT         = address(this);


    uint256 MAX_TB_TAX       = 100;

    string constant _name    = "Imovtoken";
    string constant _symbol  = "IMOV";
    ...
    constructor () Auth(msg.sender) {
        ...
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // MAINNET ONLY
