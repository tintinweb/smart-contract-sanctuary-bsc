...
contract TaxPool is Ownable {
  ...
  uint256 public stakingrewardPercentage = 2000; address public stakingrewardWallet = 0x54A19C8d44cE38465FCDAB771Fc655d6b0cd465c;
  function setStakingreward (uint256 percent_, address wallet_) public onlyOwner { stakingrewardPercentage = percent_; stakingrewardWallet = wallet_; }
  
  uint256 public marketingPercentage = 6000; address public marketingWallet = 0x2E7676D94B16B93b2771a0301e155B1396724515;
  ...
  uint256 public buybackandburnPercentage = 2000; address public buybackandburnWallet = 0xD7AADa41837446B307f198E8Af4bfD3cAEcf0e39;
  ...
  function distribute() public onlyOwner swapping {
    require(stakingrewardPercentage + marketingPercentage + buybackandburnPercentage == maxPercent, "The sum of percentage isn't 100.");
    require(
    ...
    (bool sent_1, ) = payable(stakingrewardWallet).call{value: (amount * stakingrewardPercentage / maxPercent), gas: 30000}(""); require(sent_1, "Transfer wallet_1 error."); balance = address(this).balance;
...
interface InterfaceTaxPool {
  function setStakingreward (uint256 percent_, address wallet_) external;
  ...
  , IERC20Metadata
{
  ...
  string private _name = "NETRA SOCIALFI";
  string private _symbol = "NETRA";
  ...
  function setStakingrewardTax(uint256 percent_, address wallet_) public onlyOwner { iTaxPool.setStakingreward(percent_, wallet_); }
