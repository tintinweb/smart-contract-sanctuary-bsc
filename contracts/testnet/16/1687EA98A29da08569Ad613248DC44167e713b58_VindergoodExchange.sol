...
contract ExchangeMain is ReentrancyGuarded, Ownable {
    ...
    function makeStaticCall(Order memory order) internal returns(bytes memory) {
    ...
    function atomicMatch(
        ...
        assembly {
            ...
            let buyAmount := mload(add(buyCallData, mul(0x20, 5)))

            if eq(signature, 0x474d492f) {
        ...
        require(notExceedsSellAmount, "PaceArtExchange::Exceeds sell current amount");
        ...
        bytes memory returnData = makeStaticCall(sell);
