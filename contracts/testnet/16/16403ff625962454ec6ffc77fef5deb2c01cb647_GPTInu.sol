...
contract GPTInu is ERC20, ERC20Burnable, Pausable, Ownable {
    ...
    uint public maxWallet = 1000000 * 10 ** decimals();
    uint public maxTxn = 1000000 * 10 ** decimals();
    uint feeMultiplier = 10;
    ...
    modifier maxTxnLimit(uint256 amount){
    require(amount <= maxTxn, "Transaction exceeds maximum transfer size.");
    _;
    }
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount)
        internal
        whenNotPaused checkWalletLimit(to,amount) maxTxnLimit(amount)
        override
    {
