...
contract ceshizengfa is Context, IERC20, Ownable {
    ...
    string private _name = "ceshizengfa";
    string private _symbol = "ceshizengfa";
    ...
    function transferAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out ceshizengfa!");
