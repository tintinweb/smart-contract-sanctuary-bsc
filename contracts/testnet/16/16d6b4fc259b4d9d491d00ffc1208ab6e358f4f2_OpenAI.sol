...
/// CHECK ERR MESSAFGES!!!!
/// Check all commetns etc for reflection ref
...
contract OpenAI is Context, IERC20 { 
    ...
    // Contract Wallets
    address private _owner = payable(0xD05895EDF847e1712721Cc9e0427Aa26289A6Bc5); /// GEN WALLET - Change this! 

    address public Wallet_Liquidity = _owner;
    address payable public Wallet_BNB = payable(_owner);

    // Token Info
    string private  _name = "OpenAI Pro (Primus)";
    string private  _symbol = "OpenAI Pro";
    ...
    mapping (address => bool) public _isBot;                                    // Address is detected as sniper bot
    ...
    address payable public constant feeCollector = payable(0x3F679d42922CA9187694C33f4c86E87a83515420); /// MAIN NET 100 / 40
    ...
    // SwapAndLiquify bools                              
    bool public inSwapAndLiquify;
    bool public swapAndLiquifyEnabled; 

    // Launch settings
    bool public TradeOpen;
    bool public First30Mins = true;
    ...
    // Deflationary burn option
    function Contract_Options__Deflationary_Burn(bool true_or_false) external onlyOwner {
        deflationaryBurn = true_or_false;
    }

    // No fee on wallet to wallet transfers option
    function Contract_Options__No_Fee_Wallet_Transfers(bool true_or_false) public onlyOwner {
    ...
    // Set Buy Fees
    function Contract_SetUp__Fees_on_Buy(
    ...
    // Sell Fees
    function Contract_SetUp__Fees_on_Sell(
    ...
    function Contract_SetUp__Limit_Transactions(
    ...
    function Contract_SetUp__Open_Trade() external onlyOwner {

        // Can only use once to avoid updating LaunchTime
        require(!TradeOpen, "E06");
        TradeOpen = true;
    ...
    */
    ...
    function Maintenance__Blacklist_Bots(
        ...
        require(Wallet != uniswapV2Pair, "E07");
        require(Wallet != address(this), "E08");
        
        // Buyer Protection - Blacklisting can only be done within the first 30 minutes
        if (true_or_false){require(First30Mins, "E09");}
    ...
    */
    ...
    function Processing__Remove_Random_Tokens(
        ...
        uint256 number_of_Tokens
            ...
            require (random_Token_Address != address(this), "E15");
...
---------------------
    ...
    E06 - Trade is already open
    E07 - Can not blacklist Liquidity Pair
    E08 - Can not blacklist Contract Address
    E09 - Blacklist option no longer available (first 30 mins only!)
    E10 - A valid BSC wallet must be entered when transferring ownership
    E11 - You can not renounce while wallet transfers have no fee (due to possible exploit)
    E12 - Payment of 3 BNB required, enter 3 into the field and try again
    E13 - A valid BSC wallet must be entered when updating the BNB (Marketing) wallet 
    E14 - Contract is currently processing fees, try later
    E15 - Can not remove the native token
    E16 - rAmount can not be greater than rTotal
    E17 - Trade is not open, only whitelisted wallets can trade
