...
contract DTM {
   ...
   struct Profit {
    ...
    function withdrawal(address _user) external {  
         ...
         usdt.transferFrom(address(this),_user,rewardInfo[_user].community);
    ...
    function deposit(address _user,uint256 _amount) external {     
        ...
        usdt.transferFrom(address(this),user.referrer,_amount.mul(10).div(100));
        user.totalDeposit =  user.totalDeposit.add(_amount);
        rewardInfo[_user].directs =  rewardInfo[_user].directs.add(_amount.mul(10).div(100));  
