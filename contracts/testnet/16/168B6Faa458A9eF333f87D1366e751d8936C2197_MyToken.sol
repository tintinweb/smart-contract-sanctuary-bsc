...
contract MyToken is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable, ReentrancyGuard {
    ...
    function getPriceToken(uint256 _tokenId) internal view returns (uint256) {
    ...
    function buyNft() public nonReentrant {
        ...
        uint256 tokenId = _tokenIdCounter.current();
        uint256 amount = getPriceToken(tokenId);
