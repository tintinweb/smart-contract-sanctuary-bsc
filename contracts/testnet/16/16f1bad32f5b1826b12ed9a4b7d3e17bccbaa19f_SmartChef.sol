...
contract SmartChef is Ownable, ReentrancyGuard {
    ...
    function _updatePool() internal {
        ...
        accTokenPerShare = accTokenPerShare.add(fuelReward.mul(PRECISION_FACTOR).div(stakedTokenSupply));
        lastRewardBlock = block.number;
    }
    ...
    function depositWBNBToStakingContract(uint256 _amount) external onlyDistributor {
    ...
    function setNewDistributor(address _newDistributor) public {
