...
contract NFTCollection is ERC721A, ERC2981, Ownable, VerifyUser {
    ...
    function getCurrencies(uint256 _phaseId, address _currency) external view returns (uint256) {
        require(phases[_phaseId].currencies[_currency],"NFTCollection: Currencies Not Available");
        return phases[_phaseId].currenciesPrice[_currency];
    }

    // function getCurrenyPrice(uint256 _phaseId, address _currency) external view returns ()
