...
contract PriceFeed is OwnableUpgradeable, CheckContract, BaseMath, IPriceFeed {
    ...
    // The last good price seen from an oracle by Vesta
    ...
    /*
    * fetchPrice():
    * Returns the latest price obtained from the Oracle. Called by Vesta functions that require a current price.
    *
    * Also callable by anyone externally.
    *
    * Non-view function - it stores the last good price seen by Vesta.
    *
    ...
    */
    ...
    function _scaleChainlinkPriceByDigits(uint _price, uint _answerDigits) internal pure returns (uint) {
        /*
        * Convert the price returned by the Chainlink oracle to an 18-digit decimal for use by Vesta.
        * At date of Vesta launch, Chainlink uses an 8-digit price, but we also handle the possibility of
        * future changes.
        *
        */
        uint price;
