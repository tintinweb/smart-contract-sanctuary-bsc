...
contract MinerNFT is ERC721Base, OwnableUpgradeable, IMinerNFT, ReentrancyGuardUpgradeable {
    ...
    modifier onlyMining() {
        require(msg.sender == miningAddress, "MinerNFT:: Only Mining is allowed to change token locking");
        _;
    }
    ...
    function changeTokenLocking(uint256 _tokenId, bool _lock) external onlyMining {
        _changeTokenLocking(_tokenId, _lock);
    }
}
