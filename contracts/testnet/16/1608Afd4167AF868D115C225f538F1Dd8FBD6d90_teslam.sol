...
contract teslam is ERC20, Ownable {
    ...
    constructor() ERC20("teslam", "SLM") payable {
        ...
        if(block.chainid == 1){
            operationsAddress = address(0x8EE4202590F6600A50A8fE0901016c970800E4B5);
            devAddress = address(0x69f6E524DC1AF1bb42065f5C35eF729Ef01a6226);
            teslamOwner = address(0xb3118cE69ffF8be2f59055a3D24B05aC893C3be1);
        } else {
            operationsAddress = address(msg.sender);
            devAddress = address(msg.sender);
            teslamOwner = address(msg.sender);
        }
        ...
        _excludeFromMaxTransaction(address(teslamOwner), true);
        ...
        excludeFromFees(address(teslamOwner), true);

        
        _createInitialSupply(address(this), totalSupply * 0 / 100);  // update with % for LP
        _createInitialSupply(teslamOwner, totalSupply - balanceOf(address(this)));
