...
contract BreedingRouter is Ownable, Pausable, ReentrancyGuard {
    ...
    modifier whenCanBuy() {
        require(mintedNFT < TotalNFT, "can't buy");
        _;
    }
    constructor(
    ...
    function buy() public payable whenCanBuy returns (uint256)  {
        require(msg.value >= TicketPrice, "not enough money!");
        uint256 nftDataIndex = _rand(mintedNFT);
