...
contract FloraAni is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x171C793e81b3e6E46fe0ECB72f7894ED89a58434); 
    address payable private Wallet_Dev = payable(0x0B46b7FAA610404c2D65e4c123A8d440c0B90100);
    ...
    string private constant _name = "Flora Ani "; 
    string private constant _symbol = unicode"FLORA"; 
