    ...
    function randomGene(uint256 factor, uint256 geneId) public view returns (uint256) {
        ...
        for (uint256 i = 0; i < 6; i++) {
            ...
            for (uint256 j = 0; j < 3; j++) {
                ...
                if (i == 0) {
                    //Eyes
                    if (j == 0) pet[3] = geneD(factor, data.list2, data.list1);
                    if (j == 1) pet[5] = geneD(factor, data.list2, data.list1);
                    if (j == 2) pet[7] = geneD(factor, data.list2, data.list1);
                } else if (i == 1) {
                    //Mouth
                    if (j == 0) pet[36] = geneD(factor, data.list4, data.list3);
                    if (j == 1) pet[38] = geneD(factor, data.list4, data.list3);
                    if (j == 2) pet[40] = geneD(factor, data.list4, data.list3);
                } else if (i == 2) {
                    //Hair
                    if (j == 1) pet[9] = geneD(factor, data.list6, data.list5);
                    if (j == 1) pet[11] = geneD(factor, data.list6, data.list5);
                    if (j == 2) pet[13] = geneD(factor, data.list6, data.list5);
                } else if (i == 3) {
                    //Hand
                    if (j == 0) pet[15] = geneD(factor, data.list8, data.list7);
                    if (j == 1) pet[18] = geneD(factor, data.list8, data.list7);
                    if (j == 2) pet[21] = geneD(factor, data.list8, data.list7);
                } else if (i == 4) {
                    //Ears
                    if (j == 1) pet[24] = geneD(factor, data.list10, data.list9);
                    if (j == 1) pet[26] = geneD(factor, data.list10, data.list9);
                    if (j == 2) pet[28] = geneD(factor, data.list10, data.list9);
                } else if (i == 5) {
                    //Tail
                    if (j == 1) pet[30] = geneD(factor, data.list12, data.list11);
                    if (j == 1) pet[32] = geneD(factor, data.list12, data.list11);
                    if (j == 2) pet[34] = geneD(factor, data.list12, data.list11);
                }
            }
        }
