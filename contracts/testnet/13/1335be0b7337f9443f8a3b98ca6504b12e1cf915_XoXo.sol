...
contract DevToken is ERC20, ERC20Burnable, Ownable, Pausable {
...
contract XoXo is Ownable {
    ...
    */
    ...
    function buyGlobalSlot(uint16 _pool) public {
        ...
        bool reenter = payGlobalBonus(poolID);
        // Create new Slot
    ...
    function payGlobalBonus(uint16 _pool) private returns(bool reentrance) { 
        Pools storage p = Pool[_pool];
