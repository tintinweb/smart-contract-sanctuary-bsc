...
// BUSD 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
 ...
 // 2 minute rebase reward autostake fixed APY
     _      _ _      __     __             _                            
...
contract deltaZ is ERC20Detailed, Ownable {
    ...
    uint256 public rewardYield = 123456789123;
    uint256 public rewardYieldDenominator = 1000000000000;
    uint256 public maxSellTransactionAmount = 1000000000000 * 10 ** 18;  // 1 trillion
    uint256 public maxBuyTransactionAmount = 1000000000000 * 10 ** 18;   // 1 trillion
    ...
    constructor() ERC20Detailed("deltaZ", "DVLZ", uint8(DECIMALS)) {
