...
contract CPM is Context, IERC20 {
    ...
    uint8 private _decimals;
      ...
      address public pancakePair;
       ...
       uint256 public maxsellAmountpertx=100E18;
...
//         
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal whenNotPaused virtual {
        ...
        if(recipient == pancakePair ){
				require(amount <= maxsellAmountpertx, "You can't sell more than maxTr");
    ...
    function maxsellpertx(uint256 _amount) public whenNotPaused onlyOwner{

        maxsellAmountpertx=_amount*1E18;
