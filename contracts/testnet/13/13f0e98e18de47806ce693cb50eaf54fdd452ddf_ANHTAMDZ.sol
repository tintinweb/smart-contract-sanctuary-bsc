...
contract ANHTAMDZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ANHTAMDZ";
    string private _symbol = "ATDZ";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress = payable(0xe21C2705579Bebac0471e94609E714a65b8de6BE); 
