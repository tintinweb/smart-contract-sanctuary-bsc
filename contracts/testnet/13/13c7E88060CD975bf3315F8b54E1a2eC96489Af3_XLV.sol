...
contract XLV is Context, IBEP20, Ownable {
    ...
    address public _investmentWallet = 0x3F0292fD62e9A3fd0bFE7560b8C7bf43aac5a0cC;
    ...
    function swapAndSendBnb(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 bnbToMarketing = bnbForDistribute.mul(_marketingAndDevelopmentFee).div(
            totalBnbRatio
        );

        uint256 bnbToPrize = bnbForDistribute.mul(_investmentFee).div(totalBnbRatio);
