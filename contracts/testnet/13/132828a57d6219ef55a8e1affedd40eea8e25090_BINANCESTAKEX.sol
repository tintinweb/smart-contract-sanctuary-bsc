...
contract BINANCESTAKEX  {
    ...
    uint256[] public PLAN1_PERCENTS = [75];
    uint256[] public PLAN2_PERCENTS = [78,82];
    uint256[] public PLAN3_PERCENTS = [71,74,77];

    uint256 public MAX_DAYS1 = 0;
    uint256 public MAX_DAYS2 = 1;
    uint256 public MAX_DAYS3 = 2;
