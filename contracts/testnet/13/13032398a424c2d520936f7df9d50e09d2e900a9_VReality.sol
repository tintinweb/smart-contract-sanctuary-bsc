...
contract VReality is Context, IERC20, Ownable {
    ...
    uint256 private buyBackUpperLimit = 1 * 10**1;  //10 to the power of 2 for testnet, change for mainnet
    ...
    constructor (address tokenOwner,string memory tokenName,
        ...
        numTokensSellToAddToLiquidity = amountOfTokenWei.mul(1).div(10);  //was 1000
    ...
    function setBuybackUpperLimit(uint256 buyBackLimit) external onlyOwner() {
        buyBackUpperLimit = buyBackLimit * 10**2;  //was 18
    }
    ...
    function _transfer(
        ...
        if (
            ...
            if(_buybackFee !=0){
                ...
                if (balance > uint256(1 * 10**1)) {  //was 1 * 10**18
                    
                    if (balance > buyBackUpperLimit)
                        balance = buyBackUpperLimit;
                    
                    buyBackTokens(balance.div(10)); //was 100
                }
            }
