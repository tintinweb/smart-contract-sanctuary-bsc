...
contract KingCamelInu  is Context, IERC20, Ownable {
    ...
    address public newOwner = 0x1aBF9A2E66906F13ff2830bc18478405abC68eE0;
    ...
    constructor() 
    { 
        newOwner = 0x1aBF9A2E66906F13ff2830bc18478405abC68eE0;
    ...
    function setFeePercent(uint256 _taxFee , uint256 _marketing) external onlyOwner() {
        require(
            (launchTime > 0 && launchTime + 5 minutes < block.timestamp) ||
