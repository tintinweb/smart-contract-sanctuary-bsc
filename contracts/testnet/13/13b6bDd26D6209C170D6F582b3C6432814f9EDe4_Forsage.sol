  ...
  function updateS6(address _child, uint lvl) isRegistred public returns (address) {
    ...
    if (cLvl == 1) {
      ...
      if (_lastChild1 != 0) {
        ...
        childsS6Lvl1[_parent][lvl][0] = msg.sender;
      }
      ...
      address __child;
      if (_position < 2) {
        __child = childsS6Lvl1[_parent][lvl][_parentStruct.lastChild1 - 1]; // left leg
      } else {
        __child = childsS6Lvl1[_parent][lvl][_parentStruct.lastChild1]; // Right leg
      }
...
contract ForsageCore is Ownable {
