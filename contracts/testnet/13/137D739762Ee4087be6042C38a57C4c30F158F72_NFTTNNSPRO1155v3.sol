...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    */
    ...
    function _mint(address to, uint256 tokenId, uint256 _supply, string memory _uri) internal {
    ...
    */
    ...
    function mintAndTransfer(address from, address to, address[] memory _royaltyAddress, uint256 _royaltyFee, uint256 _supply,string memory _tokenURI, uint256 qty,bytes memory data) external virtual override returns(uint256){
        ...
        setRoyaltyFee(itemId, _royaltyAddress, royaltyFeeArr);
...
contract NFTTNNSPRO1155v3 is ERC1155 {
    ...
    */
    ...
    function mint(string memory uri, uint256 supply, address[] memory royaltyAddress, uint256 royaltyFee, Sign memory sign)  public {
        ...
        _mint(msg.sender, newItemId, supply, uri);
        setRoyaltyFee(newItemId, royaltyAddress, royaltyFeeArr);
