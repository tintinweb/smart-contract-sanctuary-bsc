...
contract IceHockey is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "IceHockey";
    string private _symbol = "IceHockey";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9B6Df271B6fce82847e8Dc4A0Bffb7dECDE54712); 
    ...
    constructor () {
        ...
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // panckage testnet 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // panckage mainnet 0x10ED43C718714eb63d5aA57B78B54704E256024E
