...
contract LiquidityGenerator is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxTxAmount = 10 * 10**6 * (10**9);
    uint256 public walletMax = 10 * 10**6 * (10**9);
    ...
    constructor() ERC20("Test Contract", "TEST1") {
