...
// File: contracts/PoolMaster3.sol
...
contract PoolIDO3 is Ownable, ReentrancyGuard {
  ...
  modifier isRun() {
	...
	function setup(
        ...
        uint256 _totalOfSlot) public onlyOwner {
  ...
  function setStakeTime(uint256 _startStakeTime, uint256 _endStakeTime) public onlyOwner {
      require(_startStakeTime < _endStakeTime, "Input time buy invalid");

      startStakeTime = _startStakeTime;
      endStakeTime = _endStakeTime;
  }

  function setIdoTime(uint256 _startBuyTime, uint256 _endBuyTime, uint256 _startStakeTime, uint256 _endStakeTime) public onlyOwner {
      require(_startBuyTime < _endBuyTime, "Input time buy invalid");
      require(_startStakeTime < _endStakeTime, "Input time buy invalid");
  ...
  function buyIdo() public validBuyTime nonReentrant isRun {
    ...
    require(stakeToken.balanceOf(msg.sender) >= tokenInWalletRequire, "Not enough BAMI token in your wallet");
