...
// File: contracts/InfinityPoolInitializable.sol

pragma solidity 0.6.12;

contract InfinityPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public INFINITY_POOL_FACTORY;
    ...
    constructor() public {
        INFINITY_POOL_FACTORY = msg.sender;
    }
    ...
    function initialize(
        ...
        require(msg.sender == INFINITY_POOL_FACTORY, "Not factory");
