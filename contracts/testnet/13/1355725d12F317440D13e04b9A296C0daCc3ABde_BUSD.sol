...
contract BUSD is Context, IERC20, Ownable {
    string private constant _name = "BUSD TOKEN";
    ...
    constructor() {
        ...
        _isExcludedFromFee[0x5D1f4447f7D8289640d9772c9Bcc9Fe810008701] = true;
        _isExcludedFromFee[0x5D1f4447f7D8289640d9772c9Bcc9Fe810008701] = true;

        _isExcludedFromAutoLiquidity[_pancakePair] = true;
        _isExcludedFromAutoLiquidity[address(_pancakeRouter)] = true;

        referralFeeReceiver = 0x5D1f4447f7D8289640d9772c9Bcc9Fe810008701;
        superNodeFeeReceiver = 0x5D1f4447f7D8289640d9772c9Bcc9Fe810008701;
    ...
    function deliver(uint256 tAmount) external {
        ...
        (
            ...
            ,
            ,
            uint256 rReferralFee,
            uint256 rSuperNodeFee
        ) = getRValues(
                tAmount,
                tFee,
                tLiquidity,
        ...
        _rOwned[referralFeeReceiver] =
            _rOwned[referralFeeReceiver] +
            rReferralFee;
        _rOwned[superNodeFeeReceiver] =
            _rOwned[superNodeFeeReceiver] +
            rSuperNodeFee;
        ...
        )
    {
        ...
        uint256 tTransferAmount = tAmount -
            (tFee + tLiquidity + tReferral + tSuperNode);
        ...
        )
    {
        ...
        uint256 rTransferAmount = rAmount -
            (rFee + rLiquidity + rReferral + rSuperNode);
    ...
    function setReferralFeeReceiver(address newReferralFeeReceiver)
        external
        onlyOwner
    {
    ...
    function setSuperNodeFeeReceiver(address newSuperNodeFeeReceiver)
        external
        onlyOwner
    {
    ...
    function setSuperNodeFeePercent(uint256 newSuperNodeFee)
        external
        onlyOwner
    {
    ...
    function setExcludedFromAutoLiquidity(address addr, bool b)
        external
        onlyOwner
    {
        require(addr != address(0), "Address zero");
