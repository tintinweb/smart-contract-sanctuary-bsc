...
contract KingBNB {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 5 ether; // 5 BNB
	...
	constructor(address payable wallet, address payable _developer) public {
		...
		plans.push(Plan(7, 60)); // 6% per day for 7 days (at the end, compounding)
        plans.push(Plan(14, 80)); // 8% per day for 14 days (at the end, compounding)
        plans.push(Plan(28, 100)); // 10% per day for 28 days (at the end, compounding)
	}
