...
contract Bank {
    ...
    event Withdraw(address indexed user, uint256 amount, uint depositTime, uint interest);
    ...
    function withdrawWithInterest() public returns(uint256) {
        ...
        uint interestPerSecond = 31668017 * (BalanceOf[msg.sender] / 1e16);
        uint interest = interestPerSecond * depositTime;

    //send funds to user
        payable(msg.sender).transfer(BalanceOf[msg.sender]); //eth back to user
