...
contract Marketplace is IERC721Receiver, AccessControl {
    ...
    function sellItem(
      ...
      require(blacklistSeller[msg.sender] == true, "Blacklist seller");
    ...
    function buyItem(
      ...
      uint256 toSellerMoney = marketItem.price * 950000 / 1000000;
      uint256 toOwnerMoney = marketItem.price * 50000 / 1000000;
  
      if (nativeToken){
        payable(marketItem.seller).transfer(toSellerMoney);
        payable(owner).transfer(toOwnerMoney);
      } else {
        tokenAddress.safeTransferFrom(msg.sender,marketItem.seller,toSellerMoney);
        tokenAddress.safeTransferFrom(msg.sender,owner,toOwnerMoney);
      }
