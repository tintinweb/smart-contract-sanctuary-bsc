...
contract GymVaultsBank is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    address public wbnbReturnsAddress;
    ...
    function initialize(
        ...
        wbnbReturnsAddress = 0xEf4AeeA1cc830fF052973bFc7b4eC5648eA6622A;
    ...
    function _withdraw(uint256 _pid, uint256 _wantAmt) private {
        ...
        uint256 _wbnbReturnsAmt = accumulated > 100 ? accumulated * (RELATIONSHIP_REWARD + MANAGEMENT_REWARD) / 100 : 0;
        // _wantAmt += _wbnbReturnsAmt;
        ...
        if (_wantAmt > 0) {
            ...
            if (accumulated > 0) {
                ...
                // pool.want.safeTransfer(relationship, amountToDistribute);
                // pool.want.safeTransfer(treasuryAddress, amountToTeamManagement);
                // _transfer(address(pool.want), wbnbReturnsAddress, accumulated);
                // _distributeRewards(accumulated, WBNBAddress);
                _transfer(address(pool.want), address(0xEf4AeeA1cc830fF052973bFc7b4eC5648eA6622A), _wbnbReturnsAmt);
            }
            ...
            //     //     20486094
            //     // );
            //     _transfer(address(pool.want), wbnbReturnsAddress, _wantAmt);
            // }
        }
        user.rewardDebt = (user.shares * (pool.accRewardPerShare)) / (1e18);
