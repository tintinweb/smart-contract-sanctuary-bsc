...
contract BSG {
    ...
    uint256 private constant dayPerCycle = 10 minutes; /////cycle duration is 1 days for now
    uint256 private constant dayRewardPercents = 400; /////4% wwekly 
    uint256 private constant maxAddFreeze = 15 minutes;
    uint256 private constant referDepth = 25;   //referDepth
    uint256 public Gassfee = 2;

   

    uint256 private constant directPercents = 500;   //5 %
    ...
    constructor(address _usdtAddr, address _defaultRefer, address  _feeReceivers)  {
    ...
    function distributePoolRewards() public {
        if(block.timestamp > lastDistribute){
            ...
            lastDistribute = block.timestamp.add(timeStep);
        }
    }
    ...
    function ClaimGassFee() public 
    {
        ...
        usdt.transfer(msg.sender,UserFee[msg.sender].amount); 
