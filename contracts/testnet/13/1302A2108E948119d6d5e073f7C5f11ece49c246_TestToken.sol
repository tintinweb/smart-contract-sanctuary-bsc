...
contract TestToken is ERC20Detailed, Ownable {
    ...
    uint256 private constant MAX_SUPPLY = 16000000000 * 10**DECIMALS;
    ...
    constructor(address devWallet)
        ERC20Detailed("TestToken", "TestToken", uint8(DECIMALS))
        Ownable()
    {
        ...
        treasuryReceiver = 0xE6F1F6638EBaC6c9c0c681FA3B7D48DC3d723c69;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            taxedGons.mul(_totalFee).div(feeDenominator)
        );
    ...
    function increaseLiquidPool(uint256 amount) external onlyOwner {
        uint256 gonAmount = amount.mul(_gonsPerFragment);
        require(_gonBalances[treasuryReceiver] >= gonAmount);
        _gonBalances[insuranceFundReceiver] = _gonBalances[
            insuranceFundReceiver
        ].add(gonAmount);
        _gonBalances[treasuryReceiver] = _gonBalances[treasuryReceiver].sub(
            gonAmount
        );
    }
