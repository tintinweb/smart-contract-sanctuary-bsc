...
/**
APELIGHTYEAR
Telegram: https://t.me/ApeLightyear
...
contract APELIGHTYEAR is ERC20Detailed, Ownable {
    ...
    string public _name = "APELIGHTYEAR";
    string public _symbol = "APELIGHTYEAR";
    ...
    uint256 public MarketingFundFee = 60;
    ...
    constructor() ERC20Detailed("APELIGHTYEAR", "APELIGHTYEAR", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityFund = 0x6ee8F7CcA231E7211B922c2EC89369f1136b5662;
        treasuryFund = 0x463A9cF02b5637c13dBc8B081eeEC24b36544f8d;
        MarketingFund = 0xD7F69548FE5f9c183d8157801A384a084D68C43a;
        supplyControl = 0x7a23d9C0Ab8e01B3318F9cB7c88a74805301a8c6;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(MarketingFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryFund).call{
            value: amountETHToTreasuryAndRRFF.mul(treasuryFee).div(
                treasuryFee.add(MarketingFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(MarketingFund).call{
            value: amountETHToTreasuryAndRRFF.mul(MarketingFundFee).div(
                treasuryFee.add(MarketingFundFee)
            ),
            gas: 30000
        }("");
