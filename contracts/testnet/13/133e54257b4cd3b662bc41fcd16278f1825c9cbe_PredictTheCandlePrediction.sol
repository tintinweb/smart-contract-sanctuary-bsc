...
// OPERATOR
abstract contract PredictTheCandleOperator
{
   function owner() public view virtual returns (address);
}

// REFERRALS
abstract contract PredictTheCandleReferrals
{
...
//CONTRACT
contract PredictTheCandlePrediction is Ownable, Pausable, ReentrancyGuard 
{
    ...
    // Referrals 
    PredictTheCandleReferrals Referrals;
    ...
    {
        _safeTransferBNB(payable(PredictTheCandleOperator(operator).owner()),  value);
    }
    ...
    {
        Referrals = PredictTheCandleReferrals(_referralsContract);
    }
