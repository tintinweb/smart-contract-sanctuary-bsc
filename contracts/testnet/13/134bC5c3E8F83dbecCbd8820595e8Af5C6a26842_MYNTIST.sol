...
contract MYNTIST is ERC20 {
    uint256 internal startDate = 1660114800;                            
    ...
    constructor() ERC20("MYNTIST", "MYNT")  {
        ...
        verfiyContract = SignatureVerification(0xc5eeBE7764609933B5145c3d34c23b2d0cBDA004);
    }
    ...
    function updateDailyData(uint256 beginDay,uint256 endDay) internal{
        ...
        for(uint256 i = beginDay; i<= endDay; i++){
            ...
            if(i >= 2){
                ...
                emit unclaimedToken(i,unClaimAmount,originAmount);
              }
