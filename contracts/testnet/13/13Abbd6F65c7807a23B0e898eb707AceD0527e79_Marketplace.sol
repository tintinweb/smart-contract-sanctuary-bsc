...
contract Marketplace is ReentrancyGuard, Ownable, Pausable {
    ...
    function setListingFee(uint256 newListingFee) public onlyOwner {
    ...
    function sell(
        ...
        require(msg.value == listingFee, "Listing fee is missed or not enough");
        require(
     ...
     */
    function cancelOrder(address nftContractAddress, uint256 marketItemId)
        public
        payable
        nonReentrant
        whenNotPaused
        ...
        whenNotPaused
    {
        ...
        payable(_owner).transfer(listingFee);
    }
...
contract NFT is ERC721URIStorage {
    ...
    constructor(address _marketplaceAddress) ERC721("NFT GameFi", "NFTG") {
