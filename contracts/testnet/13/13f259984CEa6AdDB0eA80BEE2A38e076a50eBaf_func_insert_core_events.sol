...
contract func_insert_core_events {
    ...
    function insert_borrow(
        ...
        // console.log"----- insert_borrow function -----");
        emit core_events.Borrow(
            owner,
            nftId,
            loanId,
            borrowTokenAddress,
    ...
    function insert_close_loan(
        ...
        // console.log"----- insert_close_loan function -----");
        emit core_events.CloseLoan(
            owner,
            nftId,
            loanId,
            borrowPaid,
    ...
    function insert_repay(
        ...
        // console.log"----- insert_repay function -----");
        emit core_events.Repay(
            owner,
            nftId,
            loanId,
            closeLoan,
    ...
    function insert_adjust_collateral(
        ...
        // console.log"----- insert_adjust_collateral function -----");
        emit core_events.AdjustCollateral(
            owner,
            nftId,
            loanId,
            isAdd,
    ...
    function insert_rollover(
        ...
        // console.log"----- insert_rollover function -----");
        emit core_events.Rollover(
            owner,
            nftId,
            loanId,
            bountyHunter,
    ...
    function insert_liquidate(
        ...
        // console.log"----- insert_liquidate function -----");
        emit core_events.Liquidate(
            owner,
            nftId,
            loanId,
            liquidator,
    ...
    function insert_settle_forw_interest(
        ...
        // console.log"----- insert_settle_forw_interest function -----");
        emit core_events.SettleForwInterest(
            coreAddress,
            interestVaultAddress,
            forwDistributionAddress,
            forwTokenAddress,
            amount
        );
    }
    ...
    function insert_set_membership_address(
        ...
        // console.log"----- insert_set_membership_address function -----");
    ...
    function insert_set_price_feed_address(
        ...
        // console.log"----- insert_set_price_feed_address function -----");
    ...
    function insert_set_router_address(
        ...
        // console.log"----- insert_set_router_address function -----");
    ...
    function insert_set_core_borrowing_address(
        ...
        // console.log"----- insert_set_core_borrowing_address function -----");
    ...
    function insert_set_fee_controller(
        ...
        // console.log"----- insert_set_fee_controller function -----");
    ...
    function insert_set_forw_distributor_address(
        ...
        // console.log"----- insert_set_forw_distributor_address function -----");
    ...
    function insert_set_weth_handler(
        ...
        // console.log"----- insert_set_weth_handler function -----");
    ...
    function insert_set_loan_duration(
        ...
        // console.log"----- insert_set_loan_duration function -----");
    ...
    function insert_set_advanced_interest_duration(
        ...
        // console.log
        //     "----- insert_set_advanced_interest_duration function -----"
        // );
        emit core_events.SetAdvancedInterestDuration(
            sender,
            oldValue,
            newValue
        );
    ...
    function insert_set_fee_spread(
        ...
        // console.log"----- insert_set_fee_spread function -----");
        emit core_events.SetFeeSpread(sender, oldValue, newValue);
    }

    function insert_register_new_pool(address sender, address poolAddress)
        public
    {
        // console.log"----- insert_register_new_pool function -----");
    ...
    function insert_setup_loan_config(
        ...
        // console.log"----- insert_setup_loan_config function -----");
        emit core_events.SetupLoanConfig(
            sender,
            borrowTokenAddress,
            collateralTokenAddress,
            oldSafeLTV,
    ...
    function insert_set_fow_per_block(
        ...
        // console.log"----- insert_set_fow_per_block function -----");
    ...
    function insert_approved_for_router(
        ...
        // console.log"----- insert_approved_for_router function -----");
        emit core_events.ApprovedForRouter(sender, asset, router);
    }

    // -- function insert : membership events --
    function insert_set_new_pool(address sender, address newPool) public {
        // console.log"----- insert_set_new_pool function -----");
        emit core_events.SetNewPool(sender, newPool);
    }

    function insert_set_base_uri(address sender, string memory baseTokenURI)
        public
    {
        // console.log"----- insert_set_base_uri function -----");
        emit core_events.SetBaseURI(sender, baseTokenURI);
    }

    function insert_set_default_membership(address sender, uint256 tokenId)
        public
    {
        // console.log"----- insert_set_default_membership function -----");
        emit core_events.SetDefaultMembership(sender, tokenId);
    }

    function insert_update_rank(
        address sender,
        uint256 tokenId,
        uint8 newRank
    ) public {
        // console.log"----- insert_update_rank function -----");
    ...
    function insert_call_scheduled(
        ...
        // console.log"----- insert_call_scheduled function -----");
        emit core_events.CallScheduled(
            id,
            index,
            target,
            value,
    ...
    function insert_call_executed(
        ...
        // console.log"----- insert_call_executed function -----");
        emit core_events.CallExecuted(id, index, target, value, data);
    }

    function insert_cancelled(bytes32 id) public {
        // console.log"----- insert_cancelled function -----");
        emit core_events.Cancelled(id);
    }

    function insert_min_delay_change(uint256 oldDuration, uint256 newDuration)
        public
    {
        // console.log"----- insert_min_delay_change function -----");
    ...
    function insert_set_token_address(
        ...
        // console.log"----- insert_set_token_address function -----");
    ...
    function insert_set_forw_address(
        ...
        // console.log"----- insert_set_forw_address function -----");
    ...
    function insert_set_protocol_address(
        ...
        // console.log"----- insert_set_protocol_address function -----");
    ...
    function insert_owner_approve(
        ...
        // console.log"----- insert_owner_approve function -----");
        emit core_events.OwnerApprove(
            sender,
            tokenAddress,
            forwAddress,
            amount
    ...
    function insert_settle_interest(
        ...
        // console.log"----- insert_settle_interest function -----");
        emit core_events.SettleInterest(
            sender,
    ...
    function insert_withdraw_token_interest(
        ...
        // console.log"----- insert_withdraw_token_interest function -----");
        emit core_events.WithdrawTokenInterest(
            sender,
            claimable,
            bonus,
            profit
    ...
    function insert_withdraw_forw_interest(address sender, uint256 claimable)
        public
    {
        // console.log"----- insert_withdraw_forw_interest function -----");
        emit core_events.WithdrawForwInterest(sender, claimable);
    }

    function insert_withdraw_actual_profit(
        address sender,
        uint256 profitWithdraw
    ) public {
        // console.log"----- insert_withdraw_actual_profit function -----");
    ...
    function insert_deposit(
        ...
        // console.log"----- insert_deposit function -----");
        emit core_events.Deposit(
            owner,
            nftId,
            depositAmount,
            mintedP,
    ...
    function insert_withdraw(
        ...
        // console.log"----- insert_withdraw function -----");
        emit core_events.Withdraw(
            owner,
            nftId,
            withdrawAmount,
            burnedP,
    ...
    function insert_claim_token_interest(
        ...
        // console.log"----- insert_claim_token_interest function -----");
        emit core_events.ClaimTokenInterest(
            owner,
            nftId,
            interestTokenClaimed,
            interestTokenBonus,
            burnedItp
        );
    }
    ...
    function insert_claim_forw_interest(
        ...
        // console.log"----- insert_claim_forw_interest function -----");
        emit core_events.ClaimForwInterest(
            owner,
            nftId,
            interestForwClaimed,
            interestForwBonus,
    ...
    function insert_activate_rank(
        ...
        // console.log"----- insert_activate_rank function -----");
    ...
    function insert_set_borrow_interest_params(
        ...
        // console.log"----- insert_set_borrow_interest_params function -----");
        emit core_events.SetBorrowInterestParams(
            sender,
            rates,
            utils,
            targetSupply
    ...
    function insert_set_loan_config(
        ...
        // console.log"----- insert_set_loan_config function -----");
        emit core_events.SetLoanConfig(
            sender,
            collateralTokenAddress,
            safeLTV,
            maxLTV,
    ...
    function insert_set_pool_lending_address(
        ...
        // console.log"----- insert_set_pool_lending_address function -----");
    ...
    function insert_set_pool_borrowing_address(
        ...
        // console.log"----- insert_set_pool_borrowing_address function -----");
    ...
    function insert_initialize(
        ...
        // console.log"----- insert_initialize function -----");
        emit core_events.Initialize(
            manager,
            coreAddress,
            interestVaultAddress,
            membershipAddress
    ...
    function insert_mint_p_token(
        ...
        // console.log"----- insert_mint_p_token function -----");
    ...
    function insert_mint_itp_token(
        ...
        // console.log"----- insert_mint_itp_token function -----");
        emit core_events.MintItpToken(minter, nftId, amount, price);
    }

    function insert_mint_ifp_token(
        address minter,
        uint256 nftId,
        uint256 amount,
        uint256 price
    ) public {
        // console.log"----- insert_mint_ifp_token function -----");
        emit core_events.MintIfpToken(minter, nftId, amount, price);
    }

    function insert_burn_p_token(
        address burner,
        uint256 nftId,
        uint256 amount
    ) public {
        // console.log"----- insert_burn_p_token function -----");
        emit core_events.BurnPToken(burner, nftId, amount);
    }

    function insert_burn_itp_token(
        address burner,
        uint256 nftId,
        uint256 amount,
        uint256 price
    ) public {
        // console.log"----- insert_burn_itp_token function -----");
        emit core_events.BurnItpToken(burner, nftId, amount, price);
    }

    function insert_burn_ifp_token(
        address burner,
        uint256 nftId,
        uint256 amount,
        uint256 price
    ) public {
        // console.log"----- insert_burn_ifp_token function -----");
    ...
    function insert_stake(
        ...
        // console.log"----- insert_stake function -----");
    ...
    function insert_un_stake(
        ...
        // console.log"----- insert_un_stake function -----");
        emit core_events.UnStake(sender, nftId, amount);
    }

    function insert_deprecate_stake_info(address sender, uint256 nftId) public {
        // console.log"----- insert_deprecate_stake_info function -----");
        emit core_events.DeprecateStakeInfo(sender, nftId);
    }

    function insert_set_pool_start_timestamp(address sender, uint64 timestamp)
        public
    {
        // console.log"----- insert_set_pool_start_timestamp function -----");
        emit core_events.SetPoolStartTimestamp(sender, timestamp);
    }

    function insert_set_next_pool(address sender, address newPool) public {
        // console.log"----- insert_set_next_pool function -----");
        emit core_events.SetNextPool(sender, newPool);
    }

    function insert_set_settle_interval(address sender, uint256 interval)
        public
    {
        // console.log"----- insert_set_settle_interval function -----");
        emit core_events.SetSettleInterval(sender, interval);
    }

    function insert_set_settle_period(address sender, uint256 period) public {
        // console.log"----- insert_set_settle_period function -----");
    ...
    function insert_set_rank_info(
        ...
        // console.log"----- insert_set_rank_info function -----");
        emit core_events.SetRankInfo(
            sender,
            interestBonusLending,
            forwardBonusLending,
            minimumstakeAmount,
            maxLTVBonus,
            tradingFee
    ...
    function insert_faucet_transfer(
        address to,
        address tokenAddress,
        uint256 value,
        uint256 timestamp
    ) public {
        // console.log"----- insert_faucet_transfer function -----");
        emit core_events.FaucetTransfer(to, tokenAddress, value, timestamp);
    }

    function insert_global_pricing_paused(address sender, bool isPaused)
        public
    {
        // console.log"----- insert_global_pricing_paused function -----");
        emit core_events.GlobalPricingPaused(sender, isPaused);
    }

    function insert_set_price_feed(
        address sender,
        address[] memory tokens,
        address[] memory feeds
    ) public {
        // console.log"----- insert_set_price_feed function -----");
        emit core_events.SetPriceFeed(sender, tokens, feeds);
    }

    function insert_set_decimals(address sender, address[] memory tokens)
        public
    {
        // console.log"----- insert_set_decimals function -----");
        emit core_events.SetDecimals(sender, tokens);
    }

    function insert_owner_approve_vault(
        address sender,
        address pool,
        uint256 amount
    ) public {
        // console.log"----- insert_owner_approve_vault function -----");
        emit core_events.OwnerApproveVault(sender, pool, amount);
    }

    function insert_approve_interest_vault(
        address sender,
        address core,
        uint256 amount
    ) public {
        // console.log"----- insert_approve_interest_vault function -----");
