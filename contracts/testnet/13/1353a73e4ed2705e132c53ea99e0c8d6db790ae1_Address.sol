...
contract coba is Context,IERC20, Ownable{
    using Address for address;
    string private _name = "coba";
    ...
    address payable public marketingAddress = payable(0xc268e47594755e997CA358e7ef05Cc2a7544b2e9);
    address payable public prizePoolAddress = payable(0x11649525f38c5ced8D44b72eaA8D2a40bDA43411);//P2E,ETH FOR STAKING AND TOKENS FOR STAKING
    address payable public gameLiquidityAddress = payable(0x371dfa9121b3864a8A44DB0429996e96aa2c210D);
    ...
    // 0x51C57D555f8d83696e9695C02A1eE7c3f9F7fFD2
    ...
    constructor(uint256 _snipeBlockAmt){
        ...
        //0x51C57D555f8d83696e9695C02A1eE7c3f9F7fFD2 mainnet and all networks
        IUniswapV2Router02 _uniRouter = IUniswapV2Router02(0x51C57D555f8d83696e9695C02A1eE7c3f9F7fFD2);
