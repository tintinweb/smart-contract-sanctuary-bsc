...
contract ChineseSovereignty is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ChineseSovereignty";
    string private _symbol = "cnst";
    uint8 private _decimals = 9;
    address payable private marketingWalletAddress = payable(0x4d537FD0278939C62FE3FF1528CE14E4B5245A25); // Marketing Address
    address payable public teamWalletAddress = payable(0x4d537FD0278939C62FE3FF1528CE14E4B5245A25); // Team Address
