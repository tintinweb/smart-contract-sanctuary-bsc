...
// File: contracts/ME/MeSevenStarConsensus.sol
...
contract MeSevenStarConsensus is Ownable {
  ...
  address private _consensus_pool;//共识池(合约)
  ...
  constructor(address _meToken_address, address _myNftEX_address, address _consensus_pool_address) {
    ...
    _security_fund = address(0x2fE24DDE0bbdDc05596C68E370d627B24678538e);//保障基金
    _dao_reward = address(0xf92DD02Dfd9577Cedcd62E9291261B862E74f0bc);//DAO奖励
    rewardDuration = 300;//静默释放间隔
  }
  ...
  function purchaseStar() public {
    ...
    require(referrer != address(0), "[MeSevenStarConsensus] Cannot purchase because you have no referrer!");
    ...
    require(meToken.balanceOf(msg.sender) >= meAmount, "[MeSevenStarConsensus] Insufficient ME balance to purchase consensus pool!");
  ...
  function claimReward() public {
    ...
    require(tReward > 0, "[MeSevenStarConsensus] No reward to claim!");
    uint256 meAmount = getMeAmountForUsdt(tReward);
    require(meToken.balanceOf(_consensus_pool) >= meAmount, "[MeSevenStarConsensus] Insufficient ME token balance in the contract!");
  ...
  function withdrawByOwner() public onlyOwner {
    ...
    require(amount > 0, "[MeSevenStarConsensus] No ME token to withdraw!");
