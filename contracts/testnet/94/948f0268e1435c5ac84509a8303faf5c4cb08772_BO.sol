...
contract BO is Context, Ownable {
    AggregatorV3Interface internal priceFeed;

    uint256 public constant min = 1 wei;
    ...
    constructor(address _dev, address _mkt, address _mkt2) {
        ...
        tokenAdress = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee; //0x25C7c87B42ec086b01528eE72465F1e3c49B7B9D; //testnet
