...
contract XXXXXBNB is Ownable, ReentrancyGuard {
	...
	//uint256 constant public MIN = 0.05 ether; mainnet
	uint256 constant public MIN = 0.01 ether;  //testnet
    ...
    uint256 constant public TIME_STEP = 10 minutes; //testnet
	//uint256 constant public W_PERIOD = 7 days; mainnet
    uint256 constant public W_PERIOD = 70 minutes; //testnet
