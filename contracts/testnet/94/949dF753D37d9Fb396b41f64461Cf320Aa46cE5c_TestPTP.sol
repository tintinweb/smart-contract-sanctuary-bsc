...
contract TestPTP is ERC20, Ownable {
    ...
    function setDailyShare (uint256 day) public onlyOwner{
        ...
        require(!check,'Available hex can not set twice');
    ...
    function setStakesDailyReward (uint256 day) public onlyOwner{
        ...
        require(!checkDayForReward,'Daily Reward can not set twice');
    ...
    function findLongerPaysBetter(uint256 inputPTP, uint256 numOfDays) public view returns(uint256){
