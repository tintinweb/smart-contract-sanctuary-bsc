...
contract doge is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x4AC77F900BE810E228b33Ace677a610C0373b188);
    address payable private _marketingAddress = payable(0xDb83a811a8b01C1ff9B6E2AF5f9ec5C1D7777777);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 3, "Redis cannot be more than 10.");
	    require(redisFeeOnSell < 3, "Redis cannot be more than 10.");
	    require(taxFeeOnBuy < 3, "Tax cannot be more than 6.");
	    require(taxFeeOnSell < 3, "Tax cannot be more than 6.");
