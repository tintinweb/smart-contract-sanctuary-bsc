...
contract GROOVSWAP is Context, Whitelist {
   ...
   */
   ...
   function buyToken() public payable{
      ...
      require(isWhitelisted(msg.sender),"Error: Caller is not WhiteListed");
      require(!isBlacklisted[msg.sender], "caller is backlisted");
      payable(owner()).transfer(msg.value);
      UserInfo[msg.sender].amount=msg.value.add(UserInfo[msg.sender].amount);
