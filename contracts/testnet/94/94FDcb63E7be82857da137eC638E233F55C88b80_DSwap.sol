...
contract DSwap is Ownable {
 ...
 function addLiquidity( uint _amount0, uint _amount1) external returns(uint bal0, uint bal1) {
    ...
    function getBalanceERC20(address token) public view returns (uint) {
