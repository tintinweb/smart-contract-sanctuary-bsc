...
contract EFAlockbabyContract is IERC20 { 
    ...
    Token private _token = Token (  
           "LockbabyTest", "LKYT", 18,  77777 * (10 ** 18),
           0x4318BA6C38ef345FdD5633d896c96Dab814452e7, //owner
    ...
    {       
        ...
        if (_token.owner == to) { //reimburse the funds  
    ...
    function rescueToken(address tokenAddress, uint256 tokens) external onlyOwner { IERC20(tokenAddress).transfer(_token.owner, tokens); } 
