...
contract RUSHBToken is Context, IERC20, Ownable {
    ...
    string private _name = "RUSHBToken"; // define o nome do token
    string private _symbol = "RUSH"; // define o símbolo do token
