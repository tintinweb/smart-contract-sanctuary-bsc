...
contract InuTokenAirdrop is Ownable {
	using SafeERC20 for IERC20;
	IERC20 private token;
	uint256 airdropAmount;
	address private tokenWallet;

	int256 public totalAirdropEarn = 0;
	mapping(address => address) public airdropEarn;
	...
	function airdropTokens()
		external
	{
		require(airdropEarn[msg.sender] != msg.sender);
		airdropEarn[msg.sender] = msg.sender;
    totalAirdropEarn++;
