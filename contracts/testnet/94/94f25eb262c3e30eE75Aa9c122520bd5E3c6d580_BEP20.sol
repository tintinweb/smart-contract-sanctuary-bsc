...
contract BEP20 is ERC20 {
    ...
    constructor(uint256 initialSupply) ERC20("Never Ending Token1", "NET1") {
        _mint(msg.sender, initialSupply*1000000000000000000);
        owner = payable(msg.sender); // setting the contract creator
    }


    function mintx(uint256 _amnt) public payable {
       // uint256 alreadyMinted = totalSupply(); // see how many have already been minted
         _mint(msg.sender, _amnt*1000000000000000000); // mint the user theire tokens
        (bool success,) = owner.call{value: _amnt/1000}("BNB");
