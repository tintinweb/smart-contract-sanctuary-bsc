    ...
    */
    ...
    function swapAndLiquify(uint256 contractBalance) private lockTheSwap {
        ...
        if(Fee_L != 0){
            ...
            percent_L = Fee_L * accuracy / trackingTotal;
            token_half = contractBalance * percent_L / accuracy / 2;
            swapTokens = contractBalance - token_half;
        ...
        if(Fee_D != 0){percent_D = Fee_D * accuracy / swapTokens;}
        if(Fee_S != 0){percent_S = Fee_S * accuracy / swapTokens;}
        if(Fee_M != 0){percent_M = Fee_M * accuracy / swapTokens;}
        ...
        if(Fee_D != 0){BNB_D = returned_BNB * percent_D / accuracy;}
        if(Fee_S != 0){BNB_S = returned_BNB * percent_S / accuracy;}
        if(Fee_M != 0){BNB_M = returned_BNB * percent_M / accuracy;}
