...
contract test is IBEP20, Auth {
    ...
    uint256 public EducationFee    = 2;
    uint256 public burnFee         = 0;
    uint256 public totalFee        = EducationFee + marketingFee + liquidityFee + teamFee + burnFee;
    ...
    address public EducationFeeReceiver;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc2b093994e63dCF859af66CA3297856C7e4De0D9;
        teamFeeReceiver = msg.sender;
       EducationFeeReceiver = msg.sender;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBDev = amountBNB.mul(EducationFee).div(totalBNBFee);
        ...
        (tmpSuccess,) = payable(EducationFeeReceiver).call{value: amountBNBDev, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _EducationFee, uint256 _marketingFee, uint256 _teamFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        EducationFee = _EducationFee;
        marketingFee = _marketingFee;
        teamFee = _teamFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_EducationFee).add(_marketingFee).add(_teamFee).add(_burnFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _burnFeeReceiver, address _EducationFeeReceiver) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        teamFeeReceiver = _teamFeeReceiver;
        burnFeeReceiver = _burnFeeReceiver;
        EducationFeeReceiver = _EducationFeeReceiver;
    }
