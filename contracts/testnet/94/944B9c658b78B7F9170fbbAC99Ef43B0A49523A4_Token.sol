 ...
 *
 * Finally, the non-standard {decreaseAllowance} and {increaseAllowance}T
...
contract Token is Context, IERC20, IERC20Metadata {
   ...
   N2DRewards token;
     ...
     */
    constructor(string memory name_, string memory symbol_,
                uint256 totalSupply_,uint256 decimals_,N2DRewards token_) {
        _name = name_;
        _symbol = symbol_;
    ...
    function Reward2(uint256 amount) public  {
