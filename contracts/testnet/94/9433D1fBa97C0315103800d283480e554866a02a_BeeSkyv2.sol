...
contract BeeSkyv2 is Ownable {
  ...
  address public USDT = 0xaD938D660c79cDF0D9ff29d7B51Efa0E2A487070;
  address public GLOVERNANCE = 0x22510F2E4828A29B4eA30394e46AF57200eCaB68;
  ...
  function claimTopShared(uint256 _month) external returns (bool) {
    ...
    else if(top_adr[1]==msg.sender){ spenderamount = takefee(spenderamount,30,100); }
    else if(top_adr[2]==msg.sender){ spenderamount = takefee(spenderamount,10,100); }
    else if(top_adr[3]==msg.sender){ spenderamount = takefee(spenderamount,5,100); }
