...
contract ERC20Token is Context, IERC20, Ownable 
{
    ...
    address public marketingWalletAddress = 0x8A911e1afF89a0A58E224Da43E8E4D8A4d756614; // Marketing wallet Address.
    ...
    uint256 public _totalFee = _taxFee.add(_liquidityFee).add(_marketingFee);

    uint256 public _maxTxAmount = 10000 * 10**18; 
    uint256 private minimumTokensBeforeSwap = _tTotal.div(1000);  
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() 
    {
        ...
        _totalFee = _taxFee.add(_liquidityFee).add(_marketingFee);
        require(_totalFee<=25, "Too High Fee");
