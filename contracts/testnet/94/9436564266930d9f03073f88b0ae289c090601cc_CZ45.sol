...
TG https://t.me/ChangpengZhao45

only 45 token total supply. 1 for every year of Changpeng Zhao's time on Earth. 1 for every million this will reach.

0.9 max wallet

1% BNB Rewards

If you buy this token and ask when marketing, you're portfolio will be cursed for 7 years. 
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  ETH = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
contract CZ45 is IBEP20, Auth {
    ...
    address DEV = 0xA18c027BbB102D339bFe565DFE29D875a085F5b8;
    ...
    // Name and symbol
    string constant _name = "Changpeng Zhao 45";
    string constant _symbol = "CZ45";
    uint8 constant _decimals = 18;

    // Total supply
    uint256 _totalSupply = 45 * (10 ** _decimals); // 1m 

    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 200 / 10000; // 2% (0.9 tokens)
    uint256 public _maxSellTxAmount = _totalSupply * 100 / 10000; // 1% (0.45 tokens)
    uint256 public _maxWalletToken = ( _totalSupply * 200 ) / 10000; // 2% (0.9 tokens)
