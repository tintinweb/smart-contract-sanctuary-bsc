...
GotMilk Coin - The hippest reward token on the Milkomeda Cardano Chain!

$GOT ONLINE
🌐 gotmilkcoin.com
📮 t.me/gotmilkcoin (portal)
🐦 twitter.com/gotmilkcoin

$GOT TAX 15%
5% $MilkyToken Rewards
5% Marketing
2% Liquidity Pool
2% Dev
1% BuyBack & Frequent Liquidity Injections
...
contract RWRD_DISTRIBUTOR is IDividendDistributor {
    ...
    IBEP20 RWRD     = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BUSD TESTNET
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            : IPANCAKERouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Bsc Testnet Router
        _token = msg.sender;
    }
...
contract GotMilkCoin is Context, IBEP20, Ownable, ReentrancyGuard{ 
    using SafeMath for uint256;

    address RWRD                                    = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // BUSD TESTNET
    address WBNB                                    = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // WBNB TESTNET
    address zeroAddress                             = 0x0000000000000000000000000000000000000000;
    address burnAddress                             = 0x000000000000000000000000000000000000dEaD;
    address devAddress                              = 0xC56e2DEbaf75312b44Ad289aC16346E6EDbfa6E2;
    address public marketingAddress                 = 0x02Ef67124D03d90d74B63989d110A8fd7718C26c;

    string constant _name                           = "GotMilk Coin";
    string constant _symbol                         = "GOT";
    uint8 constant _decimals                        = 9;

    uint256 _totalSupply                            = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxLimit                      = _totalSupply / 100; //1% (10,000,000)
    uint256 public _maxWallet                       = _totalSupply / 50; //2% (20,000,000)
    ...
    uint256 public totalBNBFee                      = reflectionFee + marketingFee + devFee + liquidityFee;
    ...
    uint256 public minTokensBeforeSwapThreshold     = _totalSupply / 400; // 0.4% (2,500,000)
    bool private inSwap;
    ...
    constructor () {
        router = IPANCAKERouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Bsc Testnet Router
        ...
        isTimeLockExempt[burnAddress]               = true;

        isMaxWalletExempt[msg.sender]               = true;
        isMaxWalletExempt[address(this)]            = true;
        isMaxWalletExempt[marketingAddress]         = true;
        isMaxWalletExempt[devAddress]               = true;
        isMaxWalletExempt[burnAddress]              = true;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(amount <= _maxTxLimit || isTxLimitExempt[sender], "Max limit for this trade exceeded. Try a lower amount.");
        ...
        "Max limit for this account exceeded. Or try lower amount.");
        require(isTimeLockExempt[sender] || block.timestamp >= _transactionCheckpoint[sender] + _timeLock,
        "Wait for the TimeLock time to end before making a transaction.");
        require(isTimeLockExempt[recipient] || block.timestamp >= _transactionCheckpoint[recipient] + _timeLock,
        "Wait for the TimeLock to end before making a transaction.");
    ...
    function takeFee(address sender, uint256 amount, bool isSell) internal returns (uint256) {
        ...
        uint256 feeAmount = amount.mul(totalBNBFee).mul(multiplier).div(feeDenominator * 100);
    ...
    function swapBack() internal swapping {
        ...
        try distributor.deposit{value: amountBNBReflection.add(balanceBefore)}() {} catch {}
            ...
            (tmpSuccess,) = payable(devAddress).call{value: amountBNBDev, gas: 30000}("");
    ...
    function setTimeLock(uint256 transactiontime) public onlyOwner {
        _timeLock = transactiontime;
    }
    ...
    function setFees(uint256 _reflectionFee, uint256 _marketingFee, uint256 _devFee, uint256 _liquidityFee, uint256 _feeDenominator) external onlyOwner {
        reflectionFee           = _reflectionFee;
        marketingFee            = _marketingFee;
        devFee                  = _devFee;
        liquidityFee            = _liquidityFee;
        totalBNBFee             = _reflectionFee + _marketingFee + _devFee + _liquidityFee;
        feeDenominator          = _feeDenominator;
        require(totalBNBFee < feeDenominator, "Fees cannot be more than 30%.");
    }
    ...
    function setDevAddress(address wallet) external onlyOwner {
        devAddress = wallet;
    }
