...
contract Test0811 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    Test0811DividendTracker public dividendTracker;
    ...
    constructor() ERC20("Test0811", "T0811") {
        ...
        dividendTracker = new Test0811DividendTracker(
            payable(this),
            router,
...
contract Test0811DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    Test0811 public Test0811Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        Test0811Contract = Test0811(mainContract);
    ...
    function _transfer(
        ...
        require(false, "Test0811_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Test0811_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Test0811 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(Test0811Contract);

            uint256 prevBalance = Test0811Contract.balanceOf(address(this));
            ...
            {
                uint256 received = Test0811Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    Test0811Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
