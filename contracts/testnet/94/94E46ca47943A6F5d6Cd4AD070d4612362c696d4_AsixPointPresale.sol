...
interface IPresaleAsixPoint {
    function mint(address account_, uint256 amount_) external;
}

contract AsixPointPresale is Ownable {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;


    address devAddress = 0x3c73953e9d9CBE16C60fC2385503e55A99222442;
    address public homeAddress = 0x02c444765C7A89928B34691b29792B5AB59bf847; 
    ...
    uint256 public price = 20 * 1e18; // 20 BUSD per APT
    ...
    bool public claimPresale; // true when APT is claimable
    ...
    /**
     *  @notice set price for APT
     *  @param _price: price for APT
     */
    ...
    function deposit(uint256 _amount) external checkIfPaused {
        ...
        require(
            cap >= users[msg.sender].add(_amount),
        ...
        uint256 payout = _amount.mul(1e18).div(price).div(1e18);
        ...
        APT.transfer(msg.sender, payout);
