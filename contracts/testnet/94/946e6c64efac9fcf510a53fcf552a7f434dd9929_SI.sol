...
// The address of the player and => the user info
   ...
   function() public payable {}
    ...
    function distribute(uint256 idGame, uint256 winnerTeam)public onlyAgent{
        allocatePrizes(idGame, winnerTeam);
    }

    function allocatePrizes(uint256 _gameId, uint256 teamWinner) internal {
        Game storage game = gameInfo[_gameId];
