...
contract FOFSynchData is Ownable {
    ...
    constructor() {
        ...
        FPC0 = FOFPlayerController(payable(0x74b58b15da0F0073069EB7e585ADb17Dc2330EF4));

        FPC1 = FOFPlayerController1(payable(0x68Ed0D201d1FB5f8B240714ad1715bad307134aD));
    }

    function updatenUberTaxiController(address FPC0Address) public onlyOwner {
        FPC0 = FOFPlayerController(payable(FPC0Address));
    }

    function updatenUberTaxiDate(address FPC1Address) public onlyOwner {
    ...
    // function queryMyCommissions(address user) public view returns(uint256[] memory,uint256[] memory,uint256[] memory){
    //     (uint256[] memory a,uint256[] memory b,uint256[] memory c) =  FPC0.queryMyCommissions(user);
    // }
