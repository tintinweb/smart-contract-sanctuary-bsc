...
contract Protonium is ERC20, Ownable {
    ...
    function getMarketPrice(uint amount) public view returns(uint)
    {
        ...
        if(PAIR_CALC){
            ...
            return (((amount*res0)/Res1)) / usdPrice; // return amount of token0 needed to buy token1
        }
        else{
            ...
            return (( ((amount*res1)/Res0) * usdPrice )); // return amount of token1 needed to buy token0
        }
    }
