...
contract  BEP20 {
    ...
    constructor() {
        name = "ZigZagTestToken2"; // Sets the name of the token, i.e Ether
        symbol = "ZZTT2"; // Sets the symbol of the token, i.e ETH
        decimals = 2; // Sets the number of decimal places
        uint256 _initialSupply = 100000000000; // Holds an initial supply of coins
