...
contract COToken is ERC20Pausable {
    address factory;
    address _operator;
    address _pauser;
    uint256 private constant _preMineSupply = 50000000 * 1e18;

    constructor(address operator,address pauser,address tokenReceiveAddress_) public ERC20("Darwin Founers","CO") {
        _operator = operator;
        _pauser=pauser;
        _setupDecimals(18);
        factory=msg.sender;
        _mint(tokenReceiveAddress_, _preMineSupply);
    }
