...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xf0208E4c9b3450869E0581BAC741e79c10A70BB5;
...
contract T$BSF is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xf0208E4c9b3450869E0581BAC741e79c10A70BB5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TEST$BSF";
    string private _symbol = "T$BSF";
