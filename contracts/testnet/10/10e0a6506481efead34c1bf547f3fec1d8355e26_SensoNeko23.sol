...
// Submitted for Telegram: https://t.me/SensoNekoBurn_Bsc
// X100000%
...
contract  SensoNeko23  is Ownable, IERC20 {
    using SafeMath for uint256;
    mapping (address => uint256) private _rOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFrom;
    address private isExcluded;
    string private _name = "SensoNeko X23";
    string private _symbol = "SENEKO23";
