...
contract Staking {
    ...
    function Lock_Token(uint256 plan, uint256 _amount) external {
      if(plan == 1) {
          ...
          sixMonth[msg.sender] = TimeLock_Six_Month(msg.sender,total,startTime,endTime);
          ...
          nineMonth[msg.sender] = TimeLock_Nine_Month(msg.sender,total,startTime,endTime);
          ERC20interface.transferFrom(msg.sender, contractAddress, _amount);
      }
      else if(plan == 3) {
          address contractAddress = address(this);
          ...
          twelveMonth[msg.sender] = TimeLock_Twelve_Month(msg.sender,total,startTime,endTime);
          ERC20interface.transferFrom(msg.sender, contractAddress, _amount);
      }
    }
    ...
    function Reward(address _address , uint256 _plan) public view returns(uint256) {
          if(_plan == 1) {
            ...
            uint256 investedAmount = sixMonth[_address].amount;
            ...
            uint256 investedAmount = nineMonth[_address].amount;
            uint256 total = SafeMath.add(RoiReturn,investedAmount);
            return total;
          }
          else if(_plan == 3) {
            ...
            uint256 investedAmount = twelveMonth[_address].amount;
            uint256 total = SafeMath.add(RoiReturn,investedAmount);
            return total;
          }
          else {
    ...
    function withdraw(uint256 _plan) public {
        ...
        uint256 total = SafeMath.add(RoiReturn,investedAmount);
        ERC20interface.transferFrom(address(this), msg.sender, total);

        sixMonth[msg.sender] = TimeLock_Six_Month(msg.sender,0,0,0);
         }
        ...
        uint256 total = SafeMath.add(RoiReturn,investedAmount);
        ERC20interface.transferFrom(address(this), msg.sender, total);
        nineMonth[msg.sender] = TimeLock_Nine_Month(msg.sender,0,0,0);
         }
        ...
        twelveMonth[msg.sender] = TimeLock_Twelve_Month(msg.sender,0,0,0);
         }
    }
