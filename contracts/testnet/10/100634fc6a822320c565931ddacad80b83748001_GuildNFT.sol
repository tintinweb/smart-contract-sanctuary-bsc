    ...
    GuildNFTStorageV1
{
    ...
    function mint(address to, uint256 level) public returns (uint256) {
        require(msg.sender == owner() || msg.sender == appointAddr || msg.sender == guildFactoryAddr, "no auth");
    ...
    function mintBatch(address[] memory to, uint256[] memory _levels) public onlyOwner {
        require(msg.sender == owner(), "no auth");
