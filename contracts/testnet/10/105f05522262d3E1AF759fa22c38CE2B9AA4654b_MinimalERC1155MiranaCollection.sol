...
import "./MinimalMiranaERC1155.sol";
import "./MinimalMiranaBaseCollection.sol";

contract MinimalERC1155MiranaCollection is
  Initializable,
  MinimalMiranaBaseCollection
{
  ...
  constructor(address _originAddress) initializer {
  ...
  function createCollection(
    ...
    MinimalMiranaERC1155 token = MinimalMiranaERC1155(minimalAddress);
    token.initialize(tokenName, tokenSymbol, baseTokenURI);
...
contract MinimalMiranaERC1155 is
  Initializable,
  ERC1155Upgradeable,
