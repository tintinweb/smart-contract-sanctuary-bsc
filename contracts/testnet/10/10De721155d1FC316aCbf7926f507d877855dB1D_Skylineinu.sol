...
contract Skylineinu {
    ...
    constructor() {
        name = "Skylineinu Token"; // Sets the name of the token, i.e Ether
        symbol = "SKY"; // Sets the symbol of the token, i.e ETH
    ...
    //To increase the total supply of coin
    ...
    //To burn or destory some amount of coin
