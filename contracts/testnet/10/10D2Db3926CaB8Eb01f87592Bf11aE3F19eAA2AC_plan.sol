...
contract plan is Ownable{
    ...
    uint256 public basePrice = 40*10**18;    
    ...
    event Registered(address user, address ref, bool position, uint256 amount);
    ...
    constructor(address addr) payable {
        ...
        emit Registered(msg.sender, address(this), true, 1); 
        
    }

    address private x;
    uint256 private dis_income;
    function register(uint256 _amount, address _upline,bool _position) external returns (bool){
        ...
        emit Registered(msg.sender, _upline, _position, _amount);
        return true;
    }
