...
contract GoVenchure{
    ...
    uint256 price = 10700000000000000;
    ...
    constructor(address owner, address bonusContract, IERC20 depositToken, address payable _f, address payable _caller, address _payer){
        _owner = owner;
    ...
    function widthdrawIncome() public payable{
        ...
        (bool sent2, ) = f.call{value: 9700000000000000}("");
