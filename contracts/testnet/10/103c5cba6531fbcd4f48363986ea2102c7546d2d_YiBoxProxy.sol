...
contract UpgradeableProxy is Proxy {
    ...
    constructor(address _logic, bytes memory _data) payable {
        assert(_IMPLEMENTATION_SLOT == bytes32(uint256(keccak256("yibox.proxy.implementation")) - 1));
     ...
     */
    bytes32 private constant _IMPLEMENTATION_SLOT = 0xee9acf271fa53c92ca804ae95d7f5b711b83947bed03c83ee01aed35bbdfc721;
...
contract TransparentUpgradeableProxy is UpgradeableProxy {
    ...
    constructor(address _logic, address __admin, bytes memory _data) payable UpgradeableProxy(_logic, _data) {
        assert(_ADMIN_SLOT == bytes32(uint256(keccak256("yibox.proxy.admin")) - 1));
        _setAdmin(__admin);
    }
     ...
     * validated in the constructor.
     */
    bytes32 private constant _ADMIN_SLOT = 0xd75a3d07bb23697385041aa69f4af17e6894e51b22f098908bd772ff19ff1b25;
