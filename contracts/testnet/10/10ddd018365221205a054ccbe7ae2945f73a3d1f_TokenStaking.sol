...
contract TokenStaking is Auth, ReentrancyGuardUpgradeable {
    ...
    {
        require(
            _stakingOption.IRMultiplier > 0 &&
                _stakingOption.IRMultiplier <= 1000,
            "Interest rate multiplier provided is invalid"
        );
        require(
            _stakingOption.postMaturityIRMultiplier > 0 &&
                _stakingOption.postMaturityIRMultiplier <= 1000,
    ...
    function computeCompoundInterest(
        ...
        require(
            _interest > 0 && _interest <= 1000,
            "Interest rate provided is invalid"
        );
