...
// ----------------------------------------------------------------------------
// "FCC" 'FITNEESS CLUB COIN' token contract
//
// Symbol      : FCC
// Name        : FITNEESS CLUB COIN
// Total supply: 209,000,000
// Decimals    : 18
// ----------------------------------------------------------------------------
...
contract FITNEESSCLUBCOIN is Context, IERC20, Ownable {
  ...
  constructor() public {
    _name = "FITNEESS CLUB COIN";
    _symbol = "FCC";
    _decimals = 18;
    _totalSupply = 209000000 * 10 ** uint256(_decimals);
