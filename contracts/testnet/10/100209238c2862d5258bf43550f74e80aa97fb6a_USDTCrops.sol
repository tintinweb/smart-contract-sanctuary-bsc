...
contract USDTCrops {
    ...
    IToken public token_USDT;
	//address erctoken = 0x64544969ed7EBf5f083679233325356EbE738930; /** USDT Testnet **/
    address erctoken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; /** USDT Mainnet **/
    ...
    uint256 public MIN_INVEST_LIMIT = 10 * 1e18; /** 10 USDT  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 10000 * 1e18; /** 10000 USDT  **/
    ...
    function sellEggs() public{
        ...
        token_USDT.transfer(msg.sender, eggsPayout);
    ...
    function buyEggs(address ref, uint256 amount) public{
        ...
        token_USDT.transferFrom(address(msg.sender), address(this), amount);
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                ...
                token_USDT.transfer(upline, refRewards);
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_USDT.transfer(dev1, tax);
        token_USDT.transfer(dev2, tax);
        token_USDT.transfer(dev3, tax);
        token_USDT.transfer(dev4, tax);
        token_USDT.transfer(mkt, tax);
        return tax.mul(5);
    }
    ...
    function getBalance() public view returns (uint256) {
        return token_USDT.balanceOf(address(this));
	}
...
/**
USDT Crops Farmer
 Hire Farmers, Gather Crops, Harvest Crops and Sell for USDT. 
  8% daily daily Rate
  ...
  10 USDT minimum investment.
  10,000 USDT max deposits per wallet.
