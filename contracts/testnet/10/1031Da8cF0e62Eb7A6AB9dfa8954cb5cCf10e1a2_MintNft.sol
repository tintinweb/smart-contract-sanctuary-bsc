...
contract Owner {
    ...
    function changePriceResources(bool _increase,uint16 _level , uint8 _percent) external  onlyOwner {
        ...
        if (_increase == true) {
            ...
            AllNfts[_level].amount = AllNfts[_level].amount/1e17*1e17;
