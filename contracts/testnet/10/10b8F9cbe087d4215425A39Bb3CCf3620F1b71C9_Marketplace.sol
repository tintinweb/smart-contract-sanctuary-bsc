    ...
    ERC1155HolderUpgradeable
{
    ...
    function cancelItem(
        ...
        require(myItem.owner == msg.sender, "Marketplace: You are not owner");
        require(
    ...
    function _buyItem(
        ...
        if (myItem.contractERC20 == address(0)) {
            ...
            (bool successTreasury, ) = payable(myItem.owner).call{
            ...
            bool successOwner = IERC20Upgradeable(myItem.contractERC20)
                .transferFrom(msg.sender, myItem.owner, ownerAmount);
            require(successOwner, "Marketplace: can not transfer to owner");
    ...
    function _listItem(
        ...
        require(
            IERC721Upgradeable(_contractNFT).ownerOf(_tokenId) == msg.sender,
    ...
    function _listBulkItems(
        ...
        require(
            IERC1155Upgradeable(_contractNFT).balanceOf(msg.sender, _tokenId) >=
                _amount,
