...
contract TOKEN is Context, IERC20, Ownable {
    ...
    uint8 private _previousTaxFee = _rewardFee;

    uint8 public _rewardFee = 1;
    uint8 private _previousRewardFee = _rewardFee;

    uint8 public _marketingFee = 1;
    uint8 private _previousMarketingFee = _marketingFee;

    uint8 public _TeamFee = 3;
    uint8 private _previousTeamFee = _TeamFee;

    IUniswapV2Router02 public pcsV2Router;
    address public pcsV2Pair;
    address payable public marketingWallet = payable(0xb23Ba8b9CE9F9A812e5215Da3529A04E8cFb3cF3);
    address payable public teamWallet = payable(0x546e39F63E016B5C80a06828E39d1c8238C4E081); 

    bool marketingFeeInBNB = true;
    bool TeamFeeInBNB = true;
    ...
    constructor(
        ...
        numTokensSellToAddToLiquidity = 10000;
    ...
    function setteamWallet(address payable newTeamWallet)
        external
        onlyOwner
    {
    ...
    function setTeamFeeTokenType(bool inBNB) external onlyOwner {
        TeamFeeInBNB = inBNB;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (_marketingFee != 0) {
            ...
            if (!marketingFeeInBNB) {
                uint256 currentBalance = balanceOf(marketingWallet);
                ...
                transferEth(marketingWallet, newBalance);
            }
        ...
        if (_TeamFee != 0) {
            ...
            if (!TeamFeeInBNB) {
                uint256 currentBalance = balanceOf(teamWallet);
                _tokenTransferNoFee(
                    address(this),
                    teamWallet,
                    spentAmount
                ...
                // how much ETH did we just swap into?
                uint256 newBalance = address(this).balance.sub(initialBalance);
                transferEth(teamWallet, newBalance);
            }
            totSpentAmount = totSpentAmount + spentAmount;
        }
