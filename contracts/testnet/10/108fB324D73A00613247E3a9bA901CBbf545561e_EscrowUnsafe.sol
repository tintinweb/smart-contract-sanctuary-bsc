...
contract EscrowUnsafe {
    ...
    function withdrawFunds(bytes32 _escrowID, uint _amount ) external {
        address caller = msg.sender;
         uint _escrowValue = _amount;
        ...
        //(bool result,) = caller.call{value: _escrowValue}("");
        payable(caller).transfer(_escrowValue);
