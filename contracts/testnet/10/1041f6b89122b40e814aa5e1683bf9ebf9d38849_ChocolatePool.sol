...
contract ChocolatePool is Owned {
    ...
    function STAKE(uint256 _amount) external {
        ...
        uint256 deduction = onePercent(_amount).mul(3); // 3% transaction cost
