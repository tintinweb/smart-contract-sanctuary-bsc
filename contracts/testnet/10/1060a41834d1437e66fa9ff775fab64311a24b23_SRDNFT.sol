...
contract SRDNFT is ERC721URIStorage, Ownable {
    ...
    mapping(uint256 => uint256) public typeToOnceNPY;
	...
	constructor() ERC721("SSSNFT", "SSSN"){
        ...
        typeToOnceNPY[1] = 1500;
        typeToOnceNPY[2] = 2000;
    ...
    function addNFTProfit(uint256 tokenId, uint256 profit) public onlyController returns (bool) {
