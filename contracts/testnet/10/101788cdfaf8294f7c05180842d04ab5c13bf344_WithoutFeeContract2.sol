...
contract WithoutFeeContract2 {
    using SafeMath for uint256;

    /** base parameters **/
    uint256 public EGGS_TO_HIRE_1MINERS = 864000; // 10% daily return
    uint256 public EGGS_TO_HIRE_1MINERS_COMPOUND = 864000; //10%
    uint256 public REFERRAL = 115; //11.5% per refer
    uint256 public PERCENTS_DIVIDER = 1000; // 100% 
    uint256 public PARTNER = 0;//10; //1% GOES TO PARTNER WALLET
    uint256 public PROJECT = 0;//50; //5% GOES TO PROJECT ADDRESS
    uint256 public MARKETING = 0; //15; //1.5% GOES TO MARKETING WALLET ADDRESS
    uint256 public LOTTERY = 100; //LOTTERY 
    uint256 public PROJECT_SELL = 0;//50; // 5% ON SELLING
    uint256 public MARKETING_SELL = 0;//15; // 1.5% ON MARKETING SELL
    uint256 public MARKET_EGGS_DIVISOR = 5; // 0.5% ON MARKET EGG DIVISOR
    uint256 public MARKET_EGGS_DIVISOR_SELL = 3; //0.3% ON MARKET EGG DIVISOR SELL
	...
	uint256 public WITHDRAW_COOLDOWN = 1 * 60 ; /** 6 hours  **/
...
event Claimed(address user, uint amount);
    ...
    function CompoundBnb(address ref, bool isCompound) public {
