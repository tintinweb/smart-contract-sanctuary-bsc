...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x69541900219227031D571Dd1ADe894F42b84a75B; // owner address
...
contract LazyRaccon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lazy Raccon";
    string private _symbol = "$RAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x87F800dd47699b8472DF154b173bE008fCdeAB25); // Marketing Address
    address payable public developmentWalletAddress = payable(0x03B79250bAcD3Ec3B2e2b16637e8e4B5Be918D78); // Development Address
