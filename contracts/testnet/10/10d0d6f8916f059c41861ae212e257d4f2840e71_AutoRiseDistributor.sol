...
contract AutoRiseDistributor is Ownable, IMerkleDistributor
{
    ...
    // Ensure requested tokens aren't users AutoRise tokens
    function recoverLostTokensExceptOurTokens(address _token, uint256 amount) public onlyOwner {
         require(_token != address(this), "Cannot recover AutoRise tokens");
