...
contract CardShop is Ownable, User {
    ...
    function sunConverted(address account, uint256 value, uint256 amount) public view returns (uint256, uint256) {
    ...
    function moonConverted(address account, uint256 value, uint256 amount) public view returns (uint256, uint256) {
    ...
    function sunShop(uint256 amount) external {
        ...
        if (isSunConverted(msg.sender)) {
            (uint256 sunPrice, uint256 num) = sunConverted(msg.sender, sunPrice, amount);
    ...
    function moonShop(uint256 amount) external {
        ...
        if (isMoonConverted(msg.sender)) {
            (uint256 moonPrice, uint256 num) = moonConverted(msg.sender, moonPrice, amount);
