...
contract NFTVoting is Ownable {
    ...
    event OpenNewVotingEvent(uint eventid, ERC721 _votingAddress);
    ...
    function createtNewEvent(ERC721 _votingAddress, string[] memory _choices) external onlyOwner {
       totalvotingEvents++;
    ...
    function getEventDetails(uint eventId) public view isEvent(eventId) returns (ERC721, string[] memory, uint[] memory, bool ) {
       VotingDetails storage vd = votingeventDetails[eventId];
