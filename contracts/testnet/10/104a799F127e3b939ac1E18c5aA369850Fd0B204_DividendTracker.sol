...
contract DividendPayingToken is ERC20Upgradeable, OwnableUpgradeable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
    ...
    function _withdrawDividendOfUser(address payable user) internal returns (uint256){
        ...
        if (_withdrawableDividend > 0) {
            ...
            bool success = ERC20Upgradeable(rewardToken).transfer(user, _withdrawableDividend);
...
contract DividendTracker is OwnableUpgradeable, DividendPayingToken {
    ...
    function initialize() external initializer {
        DividendPayingToken.__DividendPayingToken_init(address(0),"DIVIDEND_TRACKER","DIVIDEND_TRACKER");
        claimWait = 3600;
        minimumTokenBalanceForDividends = 100_000*1e18;
    }
    ...
    function withdrawDividend() public pure override {
        require(false,"Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Token contract.");
    }
...
contract COOKIE is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    uint256 public  kodiBuyBackFeeOnBuy;
    uint256 public  kodiBuyBackFeeOnSell;
    ...
    event UpdateBuyFees(uint256 marketingFeeOnBuy, uint256 developmentFeeOnBuy, uint256 rewardFeeOnBuy, uint256 liquidityFeeOnBuy, uint256 kodiBuyBackOnBuy);
    event UpdateSellFees(uint256 marketingFeeOnSell, uint256 developmentFeeOnSell, uint256 rewardFeeOnSell, uint256 liquidityFeeOnSell, uint256 kodiBuyBackOnSell);
    event MarketingWalletChanged(address marketingWallet);
    event DevelopmentWalletChanged(address developmentWallet);
    event KodiAddressChanged(address kodiToken);
    ...
    event SendDevelopment(uint256 amount);
    event KodiBuyBack(uint256 amount);
    ...
    function initialize() initializer public{
        __Ownable_init();
        __ERC20_init("CookieSale", "COOKIE");
        ...
        kodiBuyBackFeeOnBuy    = 1;
        kodiBuyBackFeeOnSell   = 1;
        ...
        marketingWallet = 0xfee1eDA9075244bdD34cf54516F04AE5803a4eC8;
        developmentWallet = 0xfee2879FAAb37E5662BD5E9D2f211cFc897C7340;
        kodiToken = 0x9E550282cd50D544199a466351ebe034776aea97; //! kodi testToken
        rewardToken = 0x8516Fc284AEEaa0374E66037BD2309349FF728eA; //! busd 
        ...
        maxTransactionAmountBuy    = totalSupply() / 500;
        maxTransactionAmountSell   = totalSupply() / 500;
        maxWalletAmount            = totalSupply() / 100;

    	//dividendTracker = DividendTracker(0xbf35E178c5768C8eA13d9117ec080D895439bfE6);//its variable
        //dividendTracker.initialize(rewardToken, 100_000);
...
//=======FeeManagement=======//
    ...
    function updateBuyFees(uint256 _marketingFeeOnBuy, uint256 _developmentFeeOnBuy, uint256 _rewardFeeOnBuy, uint256 _liquidityFeeOnBuy, uint256 _kodiBuybackFeeOnBuy) external onlyOwner {
        require(
             _marketingFeeOnBuy + _developmentFeeOnBuy + _rewardFeeOnBuy + _liquidityFeeOnBuy + _kodiBuybackFeeOnBuy <= 25,
        ...
        kodiBuyBackFeeOnBuy = _kodiBuybackFeeOnBuy;
        _totalFeesOnBuy = marketingFeeOnBuy + developmentFeeOnBuy + rewardFeeOnBuy + liquidityFeeOnBuy + kodiBuyBackFeeOnBuy;
        emit UpdateBuyFees(_marketingFeeOnBuy, _developmentFeeOnBuy, _rewardFeeOnBuy, _liquidityFeeOnBuy, _kodiBuybackFeeOnBuy);
    }

    function updateSellFees(uint256 _marketingFeeOnSell, uint256 _developmentFeeOnBuy, uint256 _rewardFeeOnSell, uint256 _liquidityFeeOnSell, uint256 _kodiBuyBackFeeOnSell) external onlyOwner {
        require(
             _marketingFeeOnSell + _developmentFeeOnBuy + _rewardFeeOnSell + _liquidityFeeOnSell + _kodiBuyBackFeeOnSell <= 25,
            "Fees must be less than 25%"
        );
        marketingFeeOnSell = _marketingFeeOnSell;
        developmentFeeOnSell = _developmentFeeOnBuy;
        rewardFeeOnSell = _rewardFeeOnSell;
        liquidityFeeOnSell = _liquidityFeeOnSell;
        kodiBuyBackFeeOnSell = _kodiBuyBackFeeOnSell;
        _totalFeesOnSell = marketingFeeOnSell + developmentFeeOnSell + rewardFeeOnSell + liquidityFeeOnSell + kodiBuyBackFeeOnSell;
        emit UpdateSellFees(_marketingFeeOnSell, _developmentFeeOnBuy, _rewardFeeOnSell, _liquidityFeeOnSell, _kodiBuyBackFeeOnSell);
    }        
    ...
    function changeKodiAddress(address _kodiAddress) external onlyOwner {
        require(_kodiAddress != kodiToken, "Kodi address is already that address");
        require(isContract(_kodiAddress), "Kodi address cannot be a wallet");
        kodiToken = _kodiAddress;
        emit KodiAddressChanged(kodiToken);
    }
...
//=======Transfer=======//
    function _transfer(
        ...
        if( swapEnabled&&
            ...
            uint256 kodiBuybackShare = kodiBuyBackFeeOnBuy + kodiBuyBackFeeOnSell;
            ...
            uint256 bnbShare = marketingShare + developmentShare + rewardShare + kodiBuybackShare;
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if(kodiBuybackShare > 0) {
                    uint256 kodiBuybackBNB = (newBalance * kodiBuybackShare) / bnbShare;
                    path[0] = uniswapV2Router.WETH();
                    path[1] = kodiToken;

                    uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: kodiBuybackBNB}(
                        0,
                        path,
                        DEAD,
                        block.timestamp);
                    emit KodiBuyBack(kodiBuybackBNB);
                }
            }
        ...
        if((_isExcludedFromFees[from] || _isExcludedFromFees[to])
                                      ||
            (walletToWalletTransferWithoutFee && from != uniswapV2Pair && to != uniswapV2Pair) 
                                      || 
                                    swapping) {
