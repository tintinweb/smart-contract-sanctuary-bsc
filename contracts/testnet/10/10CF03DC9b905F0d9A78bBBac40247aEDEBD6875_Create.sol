...
contract Create is Context, IERC20, IERC20Metadata, Ownable {
    using SafeMath for uint256;

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    BlueAnti blueAnti;
    string private _name = "SLBJ";
    string private _symbol = "SLBJ";
    uint8 private _decimals = 9;
    uint256 private _totalSupply;
    uint256 private _maxSupply = 210000000000 * 10**_decimals;

    constructor() {
        _mint(_msgSender(), 110000000000 * 10**_decimals);
    }
