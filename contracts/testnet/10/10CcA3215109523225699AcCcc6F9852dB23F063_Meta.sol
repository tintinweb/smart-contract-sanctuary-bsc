...
contract Meta is Context, IERC20, Ownable {
    ...
    string private _name = "BNBviolent";
    string private _symbol = "BVILT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xff5d16B47388cBEF7958a931C860075eC2e56795);
    address payable public teamWalletAddress = payable(0x960880F674499Acd04DF3696959B05F936176Dc3);
