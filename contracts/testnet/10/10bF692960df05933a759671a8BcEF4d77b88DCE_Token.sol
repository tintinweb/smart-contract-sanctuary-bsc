...
contract Token is ERC20, Ownable {
    ...
    function convertTokenFeesInETH(address to) internal {
        ...
        if (canSwap && !swapping && to == uniswapV2Pair) {
            ...
            /*sendETHToAddress(buyBackAndBurnAddress, swappedETHBalance.mul(buyBackAndBurnFee).div(100));
            sendETHToAddress(marketingAddress, swappedETHBalance.mul(marketingFee).div(100));
            sendETHToAddress(stakingRewardAddress, swappedETHBalance.mul(stakingRewardFee).div(100));*/
