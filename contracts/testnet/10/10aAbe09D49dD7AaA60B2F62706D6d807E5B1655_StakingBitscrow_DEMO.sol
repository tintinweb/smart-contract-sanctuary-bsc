...
contract StakingBitscrow_DEMO {
    ...
    uint private _tokenaavailableforrewards = 1000000000000;
    uint private _TotalStakedTokens = 0;
    uint private _willWithdraw;
    uint private _seatsLeft = 10;
    ...
    function getInfo(address user) external view returns (uint256, uint256, uint256, uint256) {
        return (block.timestamp, timestart[user], balances[user], PersonalRewards[user]);
    }
