...
contract SilverFoxNFT is ERC721Enumerable, Ownable, Guard, RI, Withdrawable {
    ...
    constructor(address riAddress_) ERC721("Silver Fox NFT V1", "SFOX V1")
    {
        royaltyAddress = riAddress_;

        string memory baseTokenURI = "https://legendaryfox.io/meta/sfox/";
        string memory baseContractURI = "https://legendaryfox.io/meta/sfox/global.json";
