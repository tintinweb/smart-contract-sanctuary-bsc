...
contract DIGIRE is BEP20Upgradeable {
    ...
    function set_admin(DigireAdmin _admin) external onlyOwner {
        admin = _admin;
    }
    ...
    function repay_broker_debt(address broker_address, uint amount) external {
        admin.repay_broker_debt(msg.sender, broker_address, amount);
