...
contract BlueToken is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string public constant name     = "Blue Token Community";
    ...
    // When BlueToken becomes an utility token with 0% tax, withdrawToken function will allow us to remove the remaining token inside the contract address.
