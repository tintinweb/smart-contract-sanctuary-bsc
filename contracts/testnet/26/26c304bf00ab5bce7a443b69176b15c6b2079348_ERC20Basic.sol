...
contract ERC20Basic is IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(LPArr[sender] && _percentTaxBuy>0){
            ...
            _balances[recipient] = SafeMath.add(_balances[_addressTax], amountArr[1]);
            emit Transfer(sender, _addressTax, amountArr[1]);

            _balances[sender] = SafeMath.sub(_balances[sender], amountArr[2], "transfer amount exceeds balance");
