...
contract BRAAAA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BRAAA";
    string private _symbol = "BR";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc59A2ee47f3C215a12c550984Fb9c9028b33E3A5); 
    address payable public buyBackWalletAddress = payable(0xc59A2ee47f3C215a12c550984Fb9c9028b33E3A5); 
