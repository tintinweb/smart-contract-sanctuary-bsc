...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xDAcbdeCc2992a63390d108e8507B98c7E2B5584a);
...
contract LaKaToken is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xA9106aF4D84f3B86218AE1d0E5D18590d261de8E;
    address ROUTER = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;

    string constant _name = "LaKa LaKa2";
    string constant _symbol = "LKL2";
    ...
    mapping (address => bool) isPrepareListed;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!isPrepareListed[sender] && !isPrepareListed[recipient]){
        ...
        if (!isPrepareListed[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != devFeeReceiver  && recipient != autoLiquidityReceiver){
    ...
    function setPrepareListed(address adr, bool status) external onlyOwner {
        isPrepareListed[adr] = status;
    }
