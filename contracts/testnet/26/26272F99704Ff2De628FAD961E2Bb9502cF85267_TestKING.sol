...
contract TestKING is Context, IERC20, Ownable {
    ...
    address public devWallet = 0xA988AA920bbD36e05dfE9923A5cD336Eaefe246d; 
    ...
    string private constant _name = "TestKing";
    string private constant _symbol = "TestK";
    ...
    function setTradingStatus(bool state) external onlyOwner{
        ...
        swapEnabled = state;
        tTimer = block.timestamp + 2 minutes;
    }
