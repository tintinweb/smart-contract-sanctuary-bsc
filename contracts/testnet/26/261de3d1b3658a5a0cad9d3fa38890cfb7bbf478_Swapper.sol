...
function setter (iMoonCoin _MoonCoin) public {
...
IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .getPair(address(PlatformTokenApp), BUSD);
...
uint256 contractTokenBalance = PlatformTokenApp.balanceOf(address(this));
     ...
     function swapTokensForBUSD(uint256 tokenAmount) private  {
        ...
        path[0] = address(PlatformTokenApp);
        path[1] = BUSD;

        PlatformTokenApp.approve(address(uniswapV2Router), tokenAmount);
