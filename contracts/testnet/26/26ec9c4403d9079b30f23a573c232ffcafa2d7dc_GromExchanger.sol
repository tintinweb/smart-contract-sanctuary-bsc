...
contract GromExchanger is Ownable {
    ...
    event NewSwap(address indexed fromAddress, uint amount, uint toChain, uint swapId);
    event NewPayout(address indexed toAddress, uint amount, uint swapId);
    ...
    function swap(
        ...
        emit NewSwap(_msgSender(), _amount, _toChain, swapCount);
    }
    ...
    function payout(
        ...
        emit NewPayout(_toAddress, _amount, _swapId);
    }
