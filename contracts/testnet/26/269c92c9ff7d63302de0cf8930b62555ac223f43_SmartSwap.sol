...
contract Ownable  {
     ...
     */
    constructor ()  {
        address msgSender = 0x956936df700808A2A6DB444C59340FD6d6F65D26;
        _owner = msgSender;
...
contract SmartSwap is Context, IBEP20, Ownable {
    ...
    constructor()
    {
        ...
        excludeReward[owner()] = true;
        emit ExcludeReward(owner(), true);
        currentRate = 10;
        rewardRate = currentRate * NOMINATOR / (NUMBER_OF_BLOCKS * 100);
        airdrop_maker = _msgSender();
        _mint(owner(), 3812290000 ether);
