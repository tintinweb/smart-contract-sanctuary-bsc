...
contract MUSICTRUSTTOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "MUSICTRUST TOKEN";
    string private _symbol = "MTRUST";
    ...
    address public marketingWallet = 0x2099DEB9f7B67c923e638B3B8E9B33df97ae0Aff; // Marketing Wallet
