...
UUPSUpgradeable
{
    ...
    function _createOrder(
        ...
        if (isERC721) {
            ...
            require(
                IERC721Upgradeable(_tokenAddress).ownerOf(_tokenId) ==
                _owner,
    ...
    function createOrder(
        ...
        return _createOrder(msg.sender, _tokenAddress, _paymentToken, _tokenId, _quantity, _price);
    }
                ...
                if (sellerRef != address(0)) {
                    {
                        ...
                        if (
                            ...
                            amountToSellferRef = orderAmount
                            .mul(xCreator)
                            .mul(ZOOM_FEE - yRefRate)
    ...
    function lazyBuy(LazyOrder calldata _order, uint256 _amount, bytes calldata _signature)
    external
    payable
    whenNotPaused
    returns(bool)
