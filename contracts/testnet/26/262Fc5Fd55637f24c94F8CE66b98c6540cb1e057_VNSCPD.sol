...
contract VNSCPD is ERC20, AccessControl, IVNSCPD {
	...
	mapping(address => bool) public senderBL; //liquidity
	...
	function setSenderBlacklist(address addr, bool state) external onlyRole(DEFAULT_ADMIN_ROLE) {
		senderBL[addr] = state;
	}
	...
	function _beforeTokenTransfer(
		...
		require(!senderBL[msg.sender], "sender is blacklisted");
	}
}