...
contract Rebase is ERC20, Ownable {
    ...
    uint256 public swapThreshold =
        calculateAmount(INITIAL_FRAGMENTS_SUPPLY, SWAP_THRESHOLD, SWAP_THRESHOLD_DENOM); // default 0.1%
    uint256 public maxSellTransactionAmount =
        calculateAmount(INITIAL_FRAGMENTS_SUPPLY, MAX_TRANSACTION, MAX_TRANSACTION_DENOM); // default 0.5% of totalSupply.
    ...
    // Fee receiver to be configured later
    ...
    uint256 public constant TOTAL_FEE = 5;
    ...
    constructor() ERC20("Accumulator", "ACC") {
        ...
        pair = IRebaseFactory(router.factory()).createPair(address(this), router.WETH());
    ...
    function takeFee(
        ...
        if (automatedMarketMakerPairs[recipient]) {
            ...
            if (taxBracketFeeEnabled) _totalFee = _totalFee.add(getCurrentTaxBracket(sender));
