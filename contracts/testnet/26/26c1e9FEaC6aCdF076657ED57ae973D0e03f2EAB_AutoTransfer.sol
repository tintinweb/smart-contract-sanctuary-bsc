...
contract AutoTransfer is Auth {
  ...
  function _validateSetupAddressData(address[] memory _addresses, uint[] memory _percentages) private pure {
    ...
    for (uint i = 0; i < _addresses.length; i += 1) {
      ...
      require(percentage > 0 && percentage < oneHundredPercentInDecimal3, "AutoTransfer: percentage must be great than 0 and less than 100000.");
