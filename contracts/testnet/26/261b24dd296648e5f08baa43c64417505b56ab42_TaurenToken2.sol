...
contract TaurenToken2 is Context, IBEP20, Ownable {
    ...
    address public BUSD = 0xe52225889DC34fA282Ca9589f2b74aDA27a13b96;//0x55d398326f99059fF775485246999027B3197955
    ...
    constructor () {
        ...
        TRN = TaurenNFT(0x65B3C403d84C10526E0d49cbE6d0D50dCD7D24BB);//main :0xd8A9e3233457eAED7783d8061B209386089a939d      test:  0xccb681566b9A8252b01F3B29f13Cf51F64B7F806   0xe1a5748e673F7A6F3F15fe9be1a7fd4A9bc1BAcE
    ...
    function _transfer(
        ...
        if(
            ...
            if(amount >= tokenAmount){
                ...
                if(bullPeriodTXAmount[bullPeriodIndex] >= 50 && bullUsers[bullPeriodIndex].length > 0){
                    _activateBullNFT();
                }
            }       
        }
