...
contract SerenityShieldPresale is Ownable {
    ...
    constructor(uint256 _price, address[] memory _allowedTokens) {
        price = _price;
    ...
    function deposit(address usdTokenAddress, uint256 usdAmount) external {
        ...
        uint256 tokenAmount = (usdAmount * price) / 1000;
    ...
    function withdraw(
        ...
        // Transfer token
        IERC20(usdTokenAddress).safeTransfer(recipient, amount);
