...
contract MSDC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2e9 *10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 public _totalBurnt;

    string private _name = "METASTAKE CLASSIC1";
    string private _symbol = "MSDC1";
    ...
    uint256 public numTokensSellToAddToLiquidity = 2e6 *10**8;
