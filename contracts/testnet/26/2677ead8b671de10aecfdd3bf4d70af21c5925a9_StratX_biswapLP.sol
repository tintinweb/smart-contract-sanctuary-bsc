...
contract StratX_biswapLP is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant unirouterbiswap =
        address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //pancake
    ...
    uint256 public buyBackRate = 1400;
    ...
    address[] public earnedToAFIPath = [earnedAddress, wbnb, busd, AFIAddress];
    address[] public earnedToToken0Path;
    address[] public earnedToToken1Path;
    address[] public token0ToEarnedPath;
    address[] public token1ToEarnedPath;
    address[] public earnedToWbnbPath = [earnedAddress, wbnb];
    address[] public wbnbToAFIPath = [wbnb, busd, AFIAddress];
    ...
    function distributeFees(uint256 _earnedAmt) internal returns (uint256) {
        if (_earnedAmt > 0) {
            ...
            if (controllerFee > 0) {
                ...
                IERC20(wbnb).safeTransfer(fundManager, fee.mul(25).div(100));
                IERC20(wbnb).safeTransfer(fundManager2, fee.mul(14).div(100));
                IERC20(wbnb).safeTransfer(fundManager3, fee.mul(7).div(100));
                IERC20(wbnb).safeTransfer(receiveFee, fee.mul(54).div(100));
    ...
    function setffundManager(address _fundManager) public {
        require(msg.sender == govAddress, "!gov");
