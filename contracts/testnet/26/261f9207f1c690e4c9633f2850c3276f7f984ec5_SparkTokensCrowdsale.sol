...
contract Crowdsale is Initializable {
    ...
    function __Crowdsale_init_unchained(
        ...
        require(_rate > 0, "Rate cannot be ");
        require(_wallet != address(0), "Address caannot be zero address");
    ...
    function _changeWallet(address newWalletAddress) internal virtual {
...
contract TimedCrowdsale is Crowdsale {
    ...
    function _extendClosingTime(uint256 newClosingTime) internal virtual {
...
contract SparkTokensCrowdsale is
    Crowdsale,
    PausableUpgradeable,
    ...
    UUPSUpgradeable
{
    ...
    function extendSale(uint256 newClosingTime)
        ...
        whenNotPaused
    {
        _extendClosingTime(newClosingTime);
        _updateFinalization();
    }
    ...
    function changeToken(IERC20Upgradeable newToken)
        external
        virtual
        onlyOwner
        onlyWhileOpen
    ...
    function changeWallet(address newWallet)
        external
        virtual
        onlyOwner
        onlyWhileOpen
