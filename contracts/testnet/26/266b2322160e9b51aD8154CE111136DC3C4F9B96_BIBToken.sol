...
contract BIBToken is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    uint256 amount
        ...
        if(isFromWhiteList[from] || isToWhiteList[to]) {
            if (
                (from == address(0xd8F50550b41482Bc1Cf1498150Cc2F3447CC8985) && to == address(0xc18CBa763B564A909b91a68Ed7bC9f746B030504) )
                || (from == address(0xc18CBa763B564A909b91a68Ed7bC9f746B030504) && to == address(0xd8F50550b41482Bc1Cf1498150Cc2F3447CC8985))
              ) {
                takeFee = !isFromWhiteList[msg.sender];
              } else {
                takeFee = false;
              }
        }
