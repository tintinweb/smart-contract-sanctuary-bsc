...
contract Yue is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x71949C00a5C2D14664e1741bF744DDE38152c215); 
    address payable public Wallet_Dev = payable(0xbc7127D0da704a8812972114f48557B99CE7C620);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**11 * 10**_decimals;
    string private constant _name = "Yue"; 
    string private constant _symbol = unicode"YUE";
