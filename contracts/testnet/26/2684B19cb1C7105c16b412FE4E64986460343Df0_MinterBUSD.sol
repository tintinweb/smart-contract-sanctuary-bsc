...
contract MinterBUSD is Ownable {
    ...
    uint public membership_cost = 2; //$120
    ...
    constructor() {
        ...
        tokenBUSD = IBEP20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
   ...
   function GetUserTokenBalance(address _address) public view returns(uint256){ 
       return tokenBUSD.balanceOf(_address);// balancdOf function is already declared in ERC20 token function
   }
    ...
    function payFees(uint256 _tokenamount) public {
        ...
        tokenBUSD.transfer(address(this), _tokenamount);
