...
contract  MaleDuckToken is IERC20, Ownable {
    ...
    constructor(
            ...
            marketAddr = 0x78cA09D299F0502a5ce58Ba4F0c9a368c8970722;
            teamAddr = 0x3f7DDD77679606e21243bFFCAab1940d246d7840;
            buybackaddress = msg.sender;
            _balances[msg.sender] = _totalSupply;
            
            maxTx = 100* (10**9);
            maxWalletLimited = 100 * 10 ** 9;
            burnEndNumber = 1*(10**9);
        
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
                0xB6BA90af76D139AB3170c7df0139636dB6120F7e//bnb路由pancake
            );
            ...
            TOKEN = 0x11e815a78Cc41D733Db00f06B3A96074855362CE;//分红合约地址，不能是bnb
