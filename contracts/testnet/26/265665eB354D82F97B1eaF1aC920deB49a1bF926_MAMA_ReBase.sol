...
contract MAMA_ReBase is Initializable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
        ...
        )
    {
        ...
        uint256 rebaseFeeUSD = ((281058 * tx.gasprice * fxNT * 13) / 10) / 100000000; // tx price(bnb) * usd/bnb rate => fee in USD for this transaction
