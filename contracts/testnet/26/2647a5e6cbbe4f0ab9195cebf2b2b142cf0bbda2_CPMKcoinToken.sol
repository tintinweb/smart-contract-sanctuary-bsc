...
contract CPMKcoinToken {
 ...
 constructor() {
        name = "Champamongkon Coin 11"; // Sets the name of the token, i.e Ether
        symbol = "CPMKCOIN11"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        // uint256 _initialSupply = 2000000000000 * 10 ** 18; // Holds an initial supply of coins
        uint256 _initialSupply = 5000000000 * 10 ** 18; // Holds an initial supply of coins
 ...
 function transferdapp(address _from, address _to, uint256 _value) public returns (bool success) {
