...
contract ClickBackEcosystem {
   ...
   constructor(address _owner) {
    ...
    function lockTclkoken(address _token, uint256 _amount, uint256 _deadline) external returns(bool)
    {
    ...
    function withdrawclktoken(uint256 _index) external returns(Lock[] memory)
    {
          require(_getBlackStatus(msg.sender) == false , "Address in blacklist");
