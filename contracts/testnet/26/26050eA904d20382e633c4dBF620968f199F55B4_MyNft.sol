...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0x63eE1bFd340DcA5A162Dd3a9b4EfB45F5Ded3aBd, 0x54D8Bd1f2fB8705D8A7643b8FEe510cd74086724, 0x60f141c4fE03505E6c29e7eAA8603815Cd008271];
    uint256[] public withdrawPercentages = [5, 15, 80];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("WAWA", "WW12345678") {
        _baseTokenURI = "https://test-nft-tool-gateway-api.tuoluo.net/generator-server/api/contract/v1/1602642256154152962/metadata/";
        _setDefaultRoyalty(0x60f141c4fE03505E6c29e7eAA8603815Cd008271, uint96(300));
    }
