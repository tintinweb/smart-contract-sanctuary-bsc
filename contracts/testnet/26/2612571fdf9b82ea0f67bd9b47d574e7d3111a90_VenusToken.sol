...
contract VenusToken is ERC20, Ownable {
    ...
    IWrap public wrap = IWrap(0x387F2f65AA0077258f5C2f068a28aAdc404FcF3F);
    IERC20 public usdt = IERC20(0x799e073924357aA838904f8d642EaC490457ef5c);
    IPancakeRouter01 public PancakeRouter01 = IPancakeRouter01(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);

    mapping (address => bool) public isMarketPair; 

    constructor () ERC20("Venus Token", "VT", 8, 10000000 * 10 ** 8){
        address msgSender = _msgSender();
