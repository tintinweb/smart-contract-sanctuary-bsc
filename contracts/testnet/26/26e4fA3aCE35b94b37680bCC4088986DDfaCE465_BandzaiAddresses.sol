...
contract BandzaiAddresses is Ownable {
    ...
    function setStaking(address _stakingAddress) external onlyOwner {
        //require(stakingAddress == address(0x0),"address already setted");
    ...
    function setFightAddress(address _fightAddress) external onlyOwner {
        //require(fightAddress == address(0x0),"address already setted");
    ...
    function setPvPAddress(address _address) external onlyOwner {
        //require(pvPAddress == address(0x0),"address already setted");
        pvPAddress = _address;
    }
    ...
    function setRentMyNftAddress(address _address) external onlyOwner {
        //require(rentMyNFTAddress == address(0x0),"address already setted");
