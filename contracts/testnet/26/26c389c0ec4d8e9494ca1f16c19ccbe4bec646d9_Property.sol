...
contract Property is ERC20, Ownable {
    ...
    constructor(uint _id, string memory _address, string memory _description, uint _price, uint _supply, address _owner) ERC20("Block", "BLC") public {
    ...
    ///@dev Adds sent the amount of ETH to property revenue
