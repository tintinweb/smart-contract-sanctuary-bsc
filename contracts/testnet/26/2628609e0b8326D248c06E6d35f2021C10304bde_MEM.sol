...
contract MEM is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 10e3 * 10e18;
    
    address public marketingWallet = 0xaC6BB41Cf5a3B874a2E5b6F01F810ADDF862aEB1;
    ...
    constructor() ERC20("Member", "Mem") {
        _mint(msg.sender, 100e6 * 10 ** decimals());
