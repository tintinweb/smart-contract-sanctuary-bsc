...
contract GET is ERC20 {
    ...
    constructor(address tokenOwner) ERC20("GetSwap", "GET") {
        ...
        _approve(address(this), address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1), 2100000 * 10**18);
        ...
        // USDT testnet: 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684, USDT mainnet: 0x55d398326f99059fF775485246999027B3197955
        USDT = IERC20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
        pair = IERC20(_uniswapV2Pair);
        uint256 total = 2100000 * 10**18;
        _destroyMaxAmount = 2000000;
    ...
    function _transfer(
        ...
        if (takeFee) {
            if(balanceOf(_destroyAddress) >= _destroyMaxAmount){
                super._transfer(from, address(this), amount.div(500));
                super._transfer(from, address(0x6425676109fF9996497ca43eB5C4103eb13cb0be), amount.div(100));
                amount = amount.div(100).mul(96);
            }else{
                // super._transfer(from, _destroyAddress, amount.div(100));
                _burn(from, amount.div(200));
                super._transfer(from, address(this), amount.div(300));
                super._transfer(from, address(0x6425676109fF9996497ca43eB5C4103eb13cb0be), amount.div(100));
                amount = amount.div(100).mul(96);
            }
        }
