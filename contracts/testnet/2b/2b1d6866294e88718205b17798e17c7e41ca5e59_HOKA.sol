...
contract HOKA is Context, IERC20, Ownable {
    ...
    {        
        ...
        _approve(address(this), address(DEAD), MAX);
        ...
        totalBuyFees = taxFeeonBuy + burnFeeOnBuy + marketingFeeonBuy;
        totalSellFees = taxFeeonSell + burnFeeOnSell + marketingFeeonSell;

        marketingWallet = 0xF6Bb4729c2E190d5C151546aC0F40Ea495064Eda;
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tTransferAmount, uint256 tFee, uint256 tBurn, uint256 tMarketing) = _getTValues(tAmount);
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee) = _getRValues(tAmount, tFee, tBurn, tMarketing, _getRate());
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tBurn, uint256 tMarketing, uint256 currentRate) private pure returns (uint256, uint256, uint256) {
    ...
    function setBuyFee() private{
        if(_taxFee == taxFeeonBuy && _burnFee == burnFeeOnBuy && _marketingFee == marketingFeeonBuy) return;
    ...
    function setSellFee() private{
        if(_taxFee == taxFeeonSell && _burnFee == burnFeeOnSell && _marketingFee == marketingFeeonSell) return;
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 totalShare = marketingShare + burnShare;
            if(totalShare > 0) {
                if(burnShare > 0) {
                    uint256 burnTokens = (contractTokenBalance * burnShare) / totalShare;
                    _tokenTransfer(address(this), DEAD, burnTokens);
                }
