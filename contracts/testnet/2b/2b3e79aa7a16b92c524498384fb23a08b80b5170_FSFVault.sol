...
contract FSFVault is Ownable, Pausable {
    ...
    uint256 public constant MAX_WITHDRAW_FEE_PERIOD = 2160 hours; // 90 days

    uint256 public performanceFee = 200; // 2%
    uint256 public callFee = 25; // 0.25%
    uint256 public withdrawFee = 750; // 75%
    uint256 public withdrawFeePeriod = 24 hours; // 3 days
