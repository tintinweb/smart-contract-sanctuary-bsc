...
contract UniswapV2Locker is Ownable, ReentrancyGuard {
    ...
    function transferLockerOwnership(
        ...
        uint256 lockID = userInfo.locksForToken[_lpToken][_index];
        TokenLock storage lock = tokenLocks[_lpToken][lockID];
        require(lockID == _lockID && lock.owner == msg.sender, "UniswapV2Locker: not the locker owner"); // ensures correct lock is affected
