...
contract NFTMinter is BEP721 {
    ...
    uint256 referral_fees;
    // Name token using inherited BEP721 constructor.
    constructor() BEP721("nft","mynft"){
    ...
    // mint a new nft
    function mintNFT(string memory  name ,string memory symbol,string memory _tokenURI,uint256 _price,address _reeferral) external {
        ...
        uint256 a = 2;
        uint256 b = 100;
        minting_price =a/b* _price;
        _transfer(msg.sender,owner, minting_price);
        _transfer(msg.sender,_reeferral,referral_fees);
    ...
    function buyTokenwithfixedprice(uint256 _tokenId,address _reeferral) public payable {
