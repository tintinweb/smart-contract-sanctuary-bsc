...
contract DDWC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DDWC";
    string private _symbol = "DDWC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xcB44175d240AE76Cd47a2Bc69b216E004149E312);
    address payable public teamWalletAddress = payable(0xcB44175d240AE76Cd47a2Bc69b216E004149E312);
    ...
    function changeRouterVersion(address newRouterAddress) public onlyOwner returns(address newPairAddress) {
        ...
        newPairAddress = IUniswapV2Factory(_uniswapV2Router.factory()).getPair(address(this), uniswapV2Router.WETH());
