...
contract SogaNFTDeployer {
    ...
    function createContract (
        ...
        string memory symbol_,
        string memory contractUri,
        string memory baseUri) public onlyOwner returns (SogaNFT){
        
        SogaNFT soga = new SogaNFT{salt: salt_}(msg.sender,name_,symbol_,contractUri,baseUri);
