...
contract HeroNFT is ERC721, Ownable, ReentrancyGuard {
    ...
    event MintItem(address recipient, uint256 tokenId, uint256 propertyId);
    event MintMulti(address[] recipient, uint256[] tokenIds, uint256[] propertyIds);
    event BurnItem(address _user, address _token, uint256 tokenId, uint256 _at);
    ...
    function mintItem(address recipient, uint256 propertyId) public nonReentrant returns (uint256){
        ...
        emit MintItem(recipient, mintIndex, propertyId);
    ...
    function mintMulti(address[] calldata recipient, uint256[] calldata propertyIds) external nonReentrant returns (uint256[] memory){
        ...
        emit MintMulti(recipient, tokenIds, propertyIds);
    ...
    function burnItem(uint256 tokenId) public nonReentrant returns (uint256)  {
        ...
        emit BurnItem(msg.sender, address(this), tokenId, block.timestamp);
