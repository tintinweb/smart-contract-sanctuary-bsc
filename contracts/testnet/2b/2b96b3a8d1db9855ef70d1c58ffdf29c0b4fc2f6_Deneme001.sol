...
contract Deneme001 is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x6570965037acF74ac43B6F2613d1Db2947c9Beae;

    string constant _name = "Deneme001";
    string constant _symbol = "DNM1";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**11 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _maxWalletToken = 1 * 10**9 * 10**_decimals;
