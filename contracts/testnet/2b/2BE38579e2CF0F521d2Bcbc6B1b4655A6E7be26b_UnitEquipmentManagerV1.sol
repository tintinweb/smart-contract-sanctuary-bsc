...
contract UnitEquipmentManagerV1 is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
  ...
  address public constant SAMURAI_ADDRESS = 0xC3c3B849ED5164Fb626c4a4F78e0675907B2C94E;
   ...
   */
  function initialize(IMarketplace _marketplace) public virtual initializer {
  ...
  function _equip(address _equipmentAddress, uint _equipmentId, uint _nftId) private {
    require(Equipment(_equipmentAddress).ownerOf(_equipmentId) == msg.sender, "UnitEquipmentManager::_equip: sender isn't the owner");
