...
contract ZURE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
	uint256 public bnbRate = 3;
    ...
    string private _name = "ZURE";
    string private _symbol = "ZURE";
    uint8 private _decimals;
    address payable _receive = payable(address(0x5905979Af89020810D154599b88398abc45c86F0));
    address _tokenOwner;
    ...
    constructor (address tokenOwner){
        ...
        _approve(address(this), address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1), _tTotal.mul(200));
	...
	function changeBnbRate(uint256 _bnbRate) public onlyOwner {
        bnbRate = _bnbRate;
    }
    ...
    function _transfer(
        ...
        if(startNumber == 0 && balanceOf(uniswapV2Pair) == 0 && to == uniswapV2Pair){
        ...
        if(_isExcludedFromFee[from] || _isExcludedFromFee[to]){
            ...
            if(from == uniswapV2Pair){
                if(startNumber.add(10) > block.number){amount = amount.div(10);}
