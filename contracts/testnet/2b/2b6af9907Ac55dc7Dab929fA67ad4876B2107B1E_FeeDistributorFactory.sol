...
contract FeeDistributorV6 is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor(
        ...
        uint256 _adminFee,
        uint256 _burnFee,
        uint256[2] memory _entryFee,
        uint256[2] memory _withdrawFee,
        uint256[2] memory _earlyWithdrawExtraFee
    ) {
        token = _token;
        ...
        earlyWithdrawExtraFee = _earlyWithdrawExtraFee;
...
contract FeeDistributorFactory is Ownable {
    ...
    function createFeeDistributor(
        ...
        uint256[2] memory _entryFee,
        uint256[2] memory _withdrawFee,
        uint256[2] memory _earlyWithdraExtraFee
    ) external {
