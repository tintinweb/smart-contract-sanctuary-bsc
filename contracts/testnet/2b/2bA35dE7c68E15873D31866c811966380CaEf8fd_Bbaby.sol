...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x4d503d07A961356C50CE892A0506124116014b01);
    ...
    uint256 public minDistribution = 1 * (10 ** 18); // 1 QG minimum auto send
...
contract Bbaby is IBEP20, MBCAuth {
    using SafeMath for uint256;

    address BUSD = 0x4d503d07A961356C50CE892A0506124116014b01;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x378ddE818Fa75c090722977FE1895F8b7324ddD9;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    string constant _name = "Baby Doge Gas";
    string constant _symbol = "GASS";
    uint8 constant _decimals = 18;

    uint256 _totalSupply =3000000000000000000000000000000; //3 trillion
    uint256 public _maxTxAmount = _totalSupply / 1000; // 0.1%

    // @dev  added max hold so that no single wallet can hold more than 1%.
    uint256 public _maxHold = _totalSupply / 2000; // 5 %
    ...
    address public marketingFeeReceiver =0x378ddE818Fa75c090722977FE1895F8b7324ddD9 ;
    address public buybackFeeReceiver =0x378ddE818Fa75c090722977FE1895F8b7324ddD9 ;
