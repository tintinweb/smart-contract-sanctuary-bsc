...
/*
 ...
 _   _ _____ _  _____  _____ _     ___  _  _____ 
| \ | | ____| |/ / _ \|  ___| |   / _ \| |/ |_ _|
|  \| |  _| | ' | | | | |_  | |  | | | | ' / | | 
| |\  | |___| . | |_| |  _| | |__| |_| | . \ | | 
|_| \_|_____|_|\_\___/|_|   |_____\___/|_|\_|___|
...
contract NEKOFLOKITOKEN is BEP20, Ownable {
    ...
    address public marketingWallet = 0xAe9998CA70872095AcB7f10B092a4812e3eA9d76;
    ...
    uint256 public swapAtAmount =  100 * (10**12);
    ...
    constructor() BEP20("NEKOFLOKI", "NEKOFLOKI", 9) {
    ...
    function updatePancakeswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(pancakeswapV2Router), "NEKOFLOKI: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "NEKOFLOKI: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != pancakeswapV2Pair, "NEKOFLOKI: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }
    
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "NEKOFLOKI: Automated market maker pair is already set to that value");
