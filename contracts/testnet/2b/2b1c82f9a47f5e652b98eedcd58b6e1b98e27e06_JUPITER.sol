...
contract JUPITER is ERC20, Ownable {
    ...
    address public deadAddr = 0x2e37A0513BA9f1c5d9127b679eA7F1DAFf1cC959;
    address public lpManager = 0x94fdc3a7Dc3c6600F3EB3899Cfdf6fe48cB2A38a;
        ...
        ERC20("JUPITER", "JUPITER")
    {
        ...
        isExcludedFromFees[deadAddr]=true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[address(0)] = true;
        isDividendExempt[address(dividendTracker)] = true;

        ammPairs[uniswapV2Pair] = true;
        _cast(0x94fdc3a7Dc3c6600F3EB3899Cfdf6fe48cB2A38a, totalSupply);
    }
