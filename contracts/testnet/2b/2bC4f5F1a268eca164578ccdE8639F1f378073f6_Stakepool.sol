    ...
    ReentrancyGuardUpgradeable
{
    ...
    //Transaction
    function initialize(address _stakeToken, address _nft)
        external
        initializer
    {
    ...
    function withdrawNFT(uint256 _tokenId, uint256 _feeAmount)
        external
        nonReentrant
        whenNotPaused
    {
    ...
    PausableUpgradeable
{
    ...
    function withdrawCollectedFee() external onlyOwner {
        ...
        stakeToken.transfer(msg.sender, collectedFee);
    ...
    ///@dev Admin can add new value for weight or can edit existing value
...
contract StakepoolStorage {
    ...
    //map to store values assigned to each weight
