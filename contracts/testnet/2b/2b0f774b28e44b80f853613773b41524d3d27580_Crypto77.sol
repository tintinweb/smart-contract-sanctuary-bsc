...
// File: default_workspace/Crypto77.sol
...
contract Crypto77 {
    ...
    constructor(){
        owner = msg.sender;
        // accepted = IERC20(address());
        whitelistedSymbols.push('USDT');
        whitelistedTokens['USDT'] = address(0xdAC17F958D2ee523a2206206994597C13D831ec7);
        //crypto royal for test
        whitelistedSymbols.push('CRB');
        whitelistedTokens['CRB'] = address(0x7c0dD54814E980De2f6bcb172AdD5db40A792169);
    ...
    function withdraw(uint amount, address payable destAddr) public {
        ...
        require(amount <= balance, "Insifficient funds");
    ...
    function transferToCustomer(IERC20 token, address to, uint256 amount) public{
        require(msg.sender == owner, "Only owner can withdraw funds");
        uint256 shibuBalance = token.balanceOf(address(this));
        require(amount <= shibuBalance, "Balance to low");
