...
import "../lib/types.sol";
import "../interfaces/IVirtualWine.sol";
import "openzeppelin-contracts/contracts/access/Ownable.sol";
import "openzeppelin-contracts/contracts/utils/Strings.sol";
import "openzeppelin-contracts/contracts/token/ERC1155/extensions/ERC1155Supply.sol";

contract VirtualWineNFT is IVirtualWine, ERC1155Base {
    
    string public name;
    string public symbol;
    string public contractURI_;

    mapping(uint256 => Types.WineSpec) private wineSpecs_;

    constructor(string memory _name, string memory _symbol, string memory _uri, string memory _contractURI) ERC1155(_uri) {
        name = _name;
        symbol = _symbol;
