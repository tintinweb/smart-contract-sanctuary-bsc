...
*/
    ...
    function _hash(FNVvoucher.priListing memory voucher) internal view returns (bytes32) {
        return _hashTypedDataV4(keccak256(abi.encode(
            keccak256(
                "priListing(address nftAddress,address nftOwner,uint256 tokenId,uint256 unitprice,uint256 countervalue,uint256 amount,string tokenUri,address royaltyKeeper,uint256 royaltyFees,bool listed)"
            ),
            voucher.nftAddress,
            voucher.nftOwner,
            voucher.tokenId,
...
*/
    ...
    function buyFixBuy(FNVvoucher.priListing memory _voucher, address redeemer, uint256 nftamount) public payable{

        require(counterstatus[_voucher.countervalue] == false, "Voucher has expired");
        ...
        require(nftamountleft[_voucher.countervalue] >= nftamount, "Owner doesn't have enough NFT balance");
        ...
        _safeMint(signer, _voucher.tokenId,_voucher.amount, _voucher.tokenUri, _voucher.royaltyKeeper, _voucher.royaltyFees);
