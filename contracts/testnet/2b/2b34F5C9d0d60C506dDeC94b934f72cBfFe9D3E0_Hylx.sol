...
contract Hylx is ERC721, NonblockingReceiver, ILayerZeroUserApplicationConfig {
    ...
    function createghost(uint8 _amountMint) external payable {
        require(sales, "HHG: Sales not activated yet.");
        require(_amountMint > 0 && _amountMint < 2, "HHG: Only 1 mint per TX");
        require(nextTokenId + _amountMint <= maxSupply, "HHG: Max supply for this chain");
