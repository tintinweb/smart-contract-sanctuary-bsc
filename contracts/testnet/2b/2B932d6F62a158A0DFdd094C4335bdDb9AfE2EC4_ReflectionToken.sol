...
import "./ReflectionTokenDividendTracker.sol";
import "./BaseToken.sol";

contract ReflectionToken is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    uint256 public constant VERSION = 666;
    ...
    constructor(
        ...
        minimumTokenBalanceForDividends_ = minimumTokenBalanceForDividends_ * 10**18;
        totalFees = tokenRewardsFee.add(liquidityFee).add(marketingFee);
        require(totalFees <= 25, "Total fee is over 25%");
        swapTokensAtAmount = totalSupply_.mul(2).div(10**6);
        gasForProcessing = 300000;
        dividendTracker = ReflectionTokenDividendTracker(payable(Clones.clone(addrs[3])));
        ...
        emit TokenCreated(owner(), address(this), TokenType.DOGEKING, VERSION);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        ReflectionTokenDividendTracker newDividendTracker = ReflectionTokenDividendTracker(
            payable(newAddress)
        );
        require(newDividendTracker.owner() == address(this), "Not owned by contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "ReflectionToken: The router already has that address"
        );
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Cant remove PCS");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Between 200,000 and 500,000");
...
contract ReflectionTokenDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ReflectionToken contract."
        );
    }
    function excludeFromDividends(address account) external onlyOwner {
