    ...
    AccessControl
{
    ...
    uint256 public pricePerBox = 500 * 10**18;
    address private RECIPIENT;
    string private baseURI = "";
    uint256[] private arrTemp;
    uint256[] public indexClan;
    ...
    function setPricePerBox(uint256 price) public onlyOwner {
        pricePerBox = price * 10**18;
    }
    ...
    function buy(uint256 clan) public {
        IERC20 token = IERC20(redeemToken);
        uint256 _totalBalance = pricePerBox.mul(1);
        ...
        string memory text = "EPIC";
        require(bytes(text).length != 0, "Random: text isn't empty");
