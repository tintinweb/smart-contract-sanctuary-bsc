...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract OPIN is Context , IERC20, Ownable {
    ...
    string private _name = "OPINION";
    string private _symbol = "OPIN";
    ...
    uint256 public _maxTxAmount = 50000000 * 10**9; //1% of total supply   //ANTIDUMP
 ...
 function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
    ...
    function setBurnfeePercent (uint burnFee) external onlyOwner() {
        _burnFee = burnFee;
    }
