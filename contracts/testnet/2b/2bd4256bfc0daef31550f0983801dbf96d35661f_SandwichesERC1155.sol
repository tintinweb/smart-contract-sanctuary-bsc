...
contract SandwichesERC1155 is ERC1155Upgradeable,ISandwichesERC1155, AccessControlUpgradeable  {
    ...
    event SandwichesCreated(uint256 indexed id, address indexed owner, uint256[] ingredients, uint256[] equipments,  uint256 created);
    ...
    function merge(
        ...
        //TODO msgsender need approve(address(tableclothAwardsPool), chiAmount);
        ...
        verifyOwner(ingredients, equipments);
        ...
        (_aggressivity, _defensive, _healthPoint, _attributes) = calculate(ingredients, equipments, tableclothType);
        ...
        emit SandwichesCreated(totalSandwiches, recipient, ingredients, equipments, _sandwich.created);
    ...
    function calculate( uint256[] memory ingredients, uint256[] memory equipments, uint128 tableclothType) private view returns (
        ...
        (, , , , , _attributes) = tableclothERC1155.getTypeDeyails(tableclothType);
    }
    ...
    // /**
    //  * @dev Call TableclothERC1155 contract for details.
    //  */
    // function getTablecloth(uint128 tableclothType) internal view returns (
    //      bool[5] memory attr
    // ){
    //     (, , , , , attr) = tableclothERC1155.getTypeDeyails(tableclothType);
    // }
    
    /**
     * @dev Verify whether it is the owner of the Token.
     */
    function verifyOwner(uint256[] memory _ingredients, uint256[] memory _equipments) private view {
     ...
     */
    function getMergePricePrice() external view returns (uint256) {
        return mergePrice;
    }
...
interface ITableclothERC1155 {
     ...
     */
    function getTypeDeyails(uint256 typeId) external view returns (
        string memory tableclothName,
        string memory tableclothDescribe,
