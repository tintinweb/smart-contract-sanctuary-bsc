...
import "./ERC1155Extensions.sol";
import "../Lib/Counters.sol";
import "../Lib/IERC1155Mint.sol";

contract ERC1155Token is IERC1155Mint,ERC1155, ERC1155Extensions, ERC1155Burnable, ERC1155Supply {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;

    mapping(address => uint256) private _nonce;

    constructor(string memory name, string memory symbol,address metaTx) 
    ERC1155(metaTx)
    ERC1155Extensions(name, symbol)
    {}
    ...
    function mintBatch(address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data, string[] memory uris)
        public override
        onlyOwner
    {
...
contract ERC1155 is Ownable, ERC165, IERC1155, IERC1155MetadataURI {
     ...
     * @dev See {_setURI}.
     */
    constructor(address metaTx) ERC2771Context(metaTx) {
    }
