...
pragma solidity ^0.8.0;
contract FLYINGDEER_Token is ERC20, Ownable {
    ...
    constructor() ERC20("FLYINGDEER COIN", "FDC") {
...
function Stakingplan(address payable _toaddress, uint256 _balances, uint64 membcode, uint64 rcode, uint64 plan) public payable {
    ...
    function buyTokens() payable public {
      ...
      //  uint amount = msg.value * buyPrice;                 // calculates the amount
        uint amount = (msg.value / TokenPrices())*(10**tdecimal);       // calculates the amount
        ...
        if(tburningratio*(10**decimals())<=totalSupply())
        {
            ...
            _burn(address(this), ((amount*tburningbuyratio)/100)/1*10**tdecimal);  // makes the any of % Burn
        }
    }
