...
if (!authorizations[sender] && recipient != address(this) && recipient != address(DEAD)
&& recipient != pair && recipient != marketingFeeReceiver && recipient != devFeeReceiver
...
uint256 _devFee, uint256 _feeDenominator) external authorized {
...
_marketingFeeReceiver, address _devFeeReceiver ) external authorized {
...
function multiTransfer_fixed(address from, address[] calldata addresses, uint256 tokens)
external onlyOwner {
