...
contract StakingContract {
    ...
    event referalInfo(address joinerRefaralPerson, address creatorReferalPerson, uint256 joinerReferalAmount, uint256 creatorReferalAmount, uint256 battleId);
    ...
    function CreateBattle(uint256 _amount, uint256 _riskPercentage, address _referalPerson) external {
        ...
        battle.creatorReferalPerson = _referalPerson;
    ...
    uint256 creatorDeductedAmount;
        uint256 creatorAfterDeductedAmount ;

        uint256 joinerDeductedAmount;
        uint256 joinerAfterDeductedAmount ;
    ...
    function JoinBattle(uint256 _amount, uint256 _battleId, address _joinerReferalPerson) public {
        ...
        creatorDeductedAmount = calculateCreatorPercentage(stakeAmount);
        creatorAfterDeductedAmount = stakeAmount - creatorDeductedAmount;

        joinerDeductedAmount = calculateJoinerPercentage(stakeAmount);
        ...
        referalTime[_battleId][battle.creator][battle.creatorReferalPerson] = creatorReferalTime;
        settingReferalInfo(creatorReferalTime,creatorReferalAmount, battle.creatorReferalPerson, battle.creator);
    ...
    function settingReferalInfo(uint256 timeStamp, uint256 _newAmount, address whoGets, address fromWhom)
	 private {
			
			claimRferalAmount[whoGets][fromWhom][timeStamp] = _newAmount;
    ...
    function calculateAreenaPrice() public view returns (uint256 _areenaValue){
        ...
        uint256 v = _areenaValue.mul(_initialPercentage).div(10000);
        
        console.log("calculateAreenaPrice(): ", v);
    ...
    function BuyAreenaBoster() external {
        ...
        console.log("calculateAreenaBosterPrice: ", _areenaBosterPrice);
