...
// File: contracts/DynamicAllocation.sol
...
contract DynamicAllocation is Ownable {
    ...
    constructor() {
        usdt = ERC20(0x0B7E566590D26Ec368e08e23cEa6B18e618f541c);
    }
    ...
    modifier onlyDerivation() {
        require(derivation[msg.sender] == true || msg.sender == owner(), "[DynamicAllocation] This function can be called only from admin!");
        _;
    }
