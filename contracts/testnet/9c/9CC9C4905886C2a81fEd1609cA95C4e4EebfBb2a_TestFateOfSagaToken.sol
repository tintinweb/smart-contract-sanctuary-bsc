...
contract TestFateOfSagaToken is ERC20, ERC20Burnable, Pausable, ERC20Permit, ERC20VotesComp, AccessControlEnumerable {
    bytes32 public constant CEO_CTO_ROLE = keccak256("CEO_CTO_ROLE");
    constructor()
        ERC20("Test Fate of Saga Token", "TOFS")
        ERC20Permit("Test Fate of Saga Token")
