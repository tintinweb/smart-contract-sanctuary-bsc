...
contract DataStorage {
    ...
    mapping (uint256 => mapping(uint256 => uint256)) private droidBotToEnergy;
    ...
    constructor() {
        ...
        droidBotToEnergy[0][0] = 8000;
        droidBotToEnergy[0][1] = 1500;
        droidBotToEnergy[0][2] = 500;

        droidBotToEnergy[1][0] = 7500;
        droidBotToEnergy[1][1] = 1800;
        droidBotToEnergy[1][2] = 700;

        droidBotToEnergy[2][0] = 7000;
        droidBotToEnergy[2][1] = 2000;
        droidBotToEnergy[2][2] = 1000;

        droidBotToEnergy[3][0] = 6500;
        droidBotToEnergy[3][1] = 2200;
        droidBotToEnergy[3][2] = 1300;

        droidBotToEnergy[4][0] = 6000;
        droidBotToEnergy[4][1] = 2500;
        droidBotToEnergy[4][2] = 1500;

        droidBotToEnergy[5][0] = 5000;
        droidBotToEnergy[5][1] = 3000;
        droidBotToEnergy[5][2] = 2000;

        droidBotToEnergy[6][0] = 4000;
        droidBotToEnergy[6][1] = 3500;
        droidBotToEnergy[6][2] = 2500;

        droidBotToEnergy[7][0] = 3000;
        droidBotToEnergy[7][1] = 3500;
        droidBotToEnergy[7][2] = 3500;

        droidBotToEnergy[8][0] = 2000;
        droidBotToEnergy[8][1] = 3500;
        droidBotToEnergy[8][2] = 4500;
    }
    ...
    function getDroidBotToEnergyProbability(uint256 _droidBotLevel) external view returns(uint256[] memory _droidBotToEnergy) {
        _droidBotToEnergy = new uint256[](N_Bonus);
        for (uint256 i = 0; i < N_Bonus; i++) {
            _droidBotToEnergy[i] = droidBotToEnergy[_droidBotLevel][i];
        }
    }
