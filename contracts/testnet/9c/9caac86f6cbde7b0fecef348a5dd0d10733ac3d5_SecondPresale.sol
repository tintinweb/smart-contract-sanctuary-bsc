...
contract SecondPresale is ReentrancyGuard {
    ...
    IERC20 public token; // Time finish presale.
    bool private tokenAvailable = false;
    uint public tokensPerBNB = 80000; // MOW for BNB.
    uint public ending; // Time finish presale.
    bool public presaleStarted = false; // start presale.
    address public deadWallet = 0x000000000000000000000000000000000000dEaD; // Presale burn.
    uint public cooldownTime = 30 days;
    uint public tokensSold;


    mapping(address => uint) public invested; // Amount investor BNB.
