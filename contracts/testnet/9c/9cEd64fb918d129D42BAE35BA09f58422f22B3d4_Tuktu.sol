...
library SmartMatrix {
	...
	function SelectAllChildrenNodeIDInNode(
		...
		uint256[] memory _NodeIDs1 = new uint256[](0);
		uint256 _NodeCount1;
		_NodeIDs1[0] = _Node.NodeID;
		...
		// }
		_NodeCount1 = _NodeIDs1.length;
		return (_NodeIDs1, _NodeCount1);
	}
...
contract Tuktu is TuktuBase, ITuktu {
	...
	function TestSelectAllNode(
		...
		uint256[] memory _NodeIDs1 = new uint256[](0);
		uint256 _NodeCount1;
		// (_NodeIDs1, _NodeCount1) = SmartMatrix.SelectAllChildrenNodeIDInNode(Nodes[_NodeID], Nodes, _Matrix);
		return (_NodeIDs1, _NodeCount1);
	}
