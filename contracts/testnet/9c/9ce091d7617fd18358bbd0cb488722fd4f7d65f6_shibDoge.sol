...
contract shibDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "shibDoge";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x6A507e94f16ed4c3EDBe00C2676653A76Ca5f3AF));
        marketingWalletAddress = payable(address(0x6A507e94f16ed4c3EDBe00C2676653A76Ca5f3AF));
