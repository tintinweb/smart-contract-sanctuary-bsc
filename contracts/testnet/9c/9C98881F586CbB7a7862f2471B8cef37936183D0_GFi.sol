...
GainFi || Crypto + Fintech

Utility based NFTs & Crypto project that creates residual income for investors and community members.

Website     : https://gainfi.net/
Telegram    : https://t.me/GainFi
Twitter     : https://twitter.com/GainFinance
...
contract GFi is Context, IBEP20, Ownable, ReentrancyGuard{ 
    ...
    function setBuyFees(uint256 _buyLiquidityFee, uint256 _buyRewardFee, uint256 _buyEcosystemFee, uint256 _buyReserveFee, uint256 _feeDenominator) external onlyOwner {
        ...
        require(totalFeeSell < _feeDenominator/4, "Fees cannot lesser than 10%");
    }
