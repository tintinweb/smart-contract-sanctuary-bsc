...
contract EPITest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public  marketingWallet = payable(0x1ef21cA86475103f1bb7858237f614E930c30c14);
    ...
    constructor() ERC20("testEmpress Inu", "EPITest") {
    ...
    function changeCooldownSettings(bool newStatus, uint256 _timeInSeconds) external onlyOwner {
        cooldownEnabled = newStatus;
        cooldownTimerInterval = _timeInSeconds;
    }
