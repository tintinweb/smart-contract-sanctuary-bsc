...
contract Contract_WAGIE is ERC20, Ownable {
    using SafeMath for uint256;
    address routerAdress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    address lpToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "NaggerWagie";
    string constant _symbol = "NAGWAG";
    ...
    address internal devFeeReceiver = 0x64Dae2A1e639FE6E736fE093dDe9e1fe630e7440;
    address internal autoLiquidityReceiver = DEAD ;
    ...
    uint256 public remainder = 49000000;
    uint256 modDis = 69000000;
    bool modPro = true;    
    bool inSwap;
    ...
    function setFee(uint256 _liquidityFee, uint256 _marketingFee) external authorized {
