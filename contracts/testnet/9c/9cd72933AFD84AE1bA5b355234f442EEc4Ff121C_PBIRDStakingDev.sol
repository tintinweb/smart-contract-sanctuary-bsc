...
contract PBIRDStakingDev is Ownable, ReentrancyGuard {
   ...
   */
    ...
    uint256 private constant _MIN_STAKE_AMOUNT = 200_000_000 * (10**_DECIMALS); //TODO Make this setable

    uint256 private constant _MAX_STAKE_AMOUNT = 200_000_000_000 * (10**_DECIMALS); //TODO Make this setable

    uint256 private constant _REFERALL_REWARD = 333; //0.333% per day

    uint256 private constant _MAX_TOKEN_SUPPLY_LIMIT = 100_000_000_000_000 * (10**_DECIMALS);
    uint256 private constant _MIDTERM_TOKEN_SUPPLY_LIMIT = 80_000_000_000 * (10**_DECIMALS);
