...
contract ActivatableNFT is ERC721Base, Ownable, IActivatableNFT {
    ...
    modifier onlyBroker() {
        require(msg.sender == branchPublicBuildingContractAddress, "ActivatableNFT: This funcrion can be called only by Broker Public Building Contract");
        _;
    }
    ...
    function mintNFTTo(address _to) external onlyBroker returns(uint tokenId) {
