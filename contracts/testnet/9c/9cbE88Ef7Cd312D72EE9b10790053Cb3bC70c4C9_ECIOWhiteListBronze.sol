...
contract ECIOWhiteListBronze is Ownable {
    ...
    uint256 public constant LIMIT_USER = 3 - 1;
    ...
    function stake(uint256 amount) external {
        ...
        require(userStakeCount <= LIMIT_USER, "Staking: User has reached Maximum Number.");
        require(checkDuplicateUser(msg.sender) == false, "Staking: You can't stake more than once");
