    ...
    ReentrancyGuardUpgradeable
{
    ...
    function stake(
        ...
        insuranceFund.futuresStakingDeposit(amount, userAddress, address(rewardToken));
        user.amount += amount;
        totalStaked += amount;
        ...
        if (
            ...
            if (bonusAmount > 0) {
                ...
                emit ReferralCommissionPaidStake(userAddress, referral, bonusAmount);
            }
        }
    ...
    function unStake(
        ...
        if (
            ...
            if (bonusAmount > 0) {
                ...
                emit ReferralCommissionPaidHarvest(userAddress, referrerAddress, bonusAmount);
            }
        }
    ...
    function setDefaultPairManager(
        address _defaultPairManager
    ) public onlyOwner {
