...
contract NFT is Context, IERC20, Ownable {
    ...
    address private constant BNB = 
    0xBdf1a2e17DECb2aAC725F0A1C8C4E2205E70719C; //testnet
    // 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // wbnb main
    ...
    constructor(address _stable_coin) {
        ...
        otherToken = _stable_coin != address(0) ? _stable_coin : BNB;
