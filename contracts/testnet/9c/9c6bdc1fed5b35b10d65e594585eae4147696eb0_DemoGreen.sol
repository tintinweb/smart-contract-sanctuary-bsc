...
contract DemoGreen is Context, IERC20, Ownable {
    ...
    address payable public rewardAddress = payable(0x2E57BB071b481695333d1b16C5fb3Ae112993865);
    // Contest Address
    address payable public contestAddress = payable(0xAcd1Db94e99a92a16A93b18359F0293A7654Ad9c);
    // Partnership and Licensing Agent Address
    address payable public partnershipAddress = payable(0x8205d4bC847D48E7D60d242E317337A9aB9e5bcb);
    // Company Foundation
    address payable public companyAddress = payable(0x1debB0a7BeAA11CCBC91363c0E2eB2bC08d06d8a);
    // Airdrop Address
    address payable public airdropAddress = payable(0x5439367794F55948498ebF176add72F4eB6038f2);
    // Marketplace Address
    address payable public marketplaceAddress = payable(0xf3C8c03dA5777BDb9931b83c9F0Ef6D8124F64C9);
    // Burn Address
