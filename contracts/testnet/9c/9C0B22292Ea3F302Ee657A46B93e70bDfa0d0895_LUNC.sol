...
contract LUNC is IERC20, Ownable {
    ...
    address public fund1Address = address(0xb189f2a5FBC3e91A201d8DF1b2F9B9810870A6B0);
    
    address public fund2Address = address(0xb189f2a5FBC3e91A201d8DF1b2F9B9810870A6B0);
        ...
        returns (bool)
    {
        if(msg.sender == uniswapV2Pair){
             _transfersell(msg.sender, recipient, amount);//sell
        }else{
    ...
    function transferFrom(
        ...
        if(recipient == uniswapV2Pair){
             _transferbuy(sender, recipient, amount);//buy
        }else{
