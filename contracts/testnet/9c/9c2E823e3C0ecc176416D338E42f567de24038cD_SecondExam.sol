...
contract SecondExam
{
    ...
    function getListRegisterStudent() onlyOwner public view returns(address[] memory) { 
    ...
    //paid tuition fee
    function getOwnerBalances() onlyOwner public view returns (uint) {
        return balances[_owner].total;
    }
    ...
    function withdraw(uint value) onlyOwner payable public {
        ...
        emit LogWithdrawal(_owner, value);
    }
    ...
    function paidTuitionFee() notOwner payable public {
        ...
        emit LogTransfer(msg.sender, _owner, tuitionFee);
    }
