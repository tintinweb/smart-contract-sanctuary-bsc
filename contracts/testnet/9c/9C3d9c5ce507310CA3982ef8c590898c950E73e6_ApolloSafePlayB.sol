...
// File contracts/ApolloSafePlayMultiCurrency/ApolloSafePlayB.sol
...
contract ApolloSafePlayB is Context, IERC20Metadata, Ownable {
    ...
    function _transfer(
        ...
        // if contract balance is more than the limit(i.e. swapTokensAtAmount) then only we will swap
