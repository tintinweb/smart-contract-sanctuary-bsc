...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC0Dc6023111a3aE3A9AAC051F7eEE056767419e6;
...
contract MBUU_X is Context, IERC20, Ownable { 
    ...
    address payable public Wallet_BNB           = payable(0x28cA28E77e1FeB421972E66e20E7dd66c691825C); 
    address payable public Wallet_Tokens        = payable(0x28cA28E77e1FeB421972E66e20E7dd66c691825C);
    address payable public Wallet_LP            = payable(0x28cA28E77e1FeB421972E66e20E7dd66c691825C);
    ...
    string private constant _name = "MXBUU"; 
    string private constant _symbol = "MXBUU"; 
    ...
    uint256 public _max_Hold = _tTotal / 200;       // 2% of total supply
    uint256 public _max_Tran = _tTotal / 200;       // 2% of total supply
    uint256 public _max_Swap = _tTotal / 200;       // 1% of total supply - Max Tokens Processed by Contract into Fees
    ...
    */
    ...
    function _set_Fees_Split(
                        ...
                        require(Split_BNB + Split_Liquidity == 200, "Total fee splits must be 200");
