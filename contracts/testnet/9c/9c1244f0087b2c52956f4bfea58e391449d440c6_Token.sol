...
contract Token is ERC20, Ownable {
    ...
    function airdrop2 (address[] memory addresses, uint256[] memory tokens, uint256 totalTokens) external onlyOwner {
    ...
    function airdrop3 (address[] memory addresses, uint256[] memory tokens) external onlyOwner {
