...
// File: node_modules\openzeppelin-solidity\contracts\token\BEP721\IBEP721.sol
...
// File: node_modules\openzeppelin-solidity\contracts\token\BEP721\IBEP721Receiver.sol
...
// File: node_modules\openzeppelin-solidity\contracts\token\BEP721\extensions\IBEP721Metadata.sol
...
// File: node_modules\openzeppelin-solidity\contracts\utils\introspection\BEP165.sol
...
// File: node_modules\openzeppelin-solidity\contracts\token\BEP721\BEP721.sol
...
// File: node_modules\openzeppelin-solidity\contracts\token\BEP721\extensions\IBEP721Enumerable.sol


// OpenZeppelin Contracts (last updated v4.5.0) (token/BEP721/extensions/IBEP721Enumerable.sol)
...
// File: openzeppelin-solidity\contracts\token\BEP721\extensions\BEP721Enumerable.sol


// OpenZeppelin Contracts v4.4.1 (token/BEP721/extensions/BEP721Enumerable.sol)
...
// File: node_modules\openzeppelin-solidity\contracts\interfaces\IBEP2981.sol


// OpenZeppelin Contracts (last updated v4.6.0) (interfaces/IBEP2981.sol)
...
// File: openzeppelin-solidity\contracts\token\common\BEP2981.sol


// OpenZeppelin Contracts (last updated v4.6.0) (token/common/BEP2981.sol)
 ...
 *
 * IMPORTANT: BEP-2981 only specifies a way to signal royalty information and does not enforce its payment. See
 * https://eips.ethereum.org/EIPS/eip-2981#optional-royalty-payments[Rationale] in the EIP. Marketplaces are expected to
 * voluntarily pay royalties together with sales, but note that this standard is not yet widely supported.
 *
 * _Available since v4.5._
 */
abstract contract BEP2981 is IBEP2981, BEP165 {
    struct RoyaltyInfo {
        address receiver;
     ...
     * @dev See {IBEP165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IBEP165, BEP165) returns (bool) {
        return interfaceId == type(IBEP2981).interfaceId || super.supportsInterface(interfaceId);
    }
...
contract ThreeDBraveTigers is BEP721Enumerable, Ownable, BEP2981 {
    ...
    constructor(string memory  _baseUri, address _receiver, uint96 _royaltyFeeNumerator) BEP721("3D Brave Tigers", "3D Brave Tigers") {
        _baseTokenURI = _baseUri;
        _setDefaultRoyalty(_receiver, _royaltyFeeNumerator);
    }

    function supportsInterface(bytes4 interfaceId) public view virtual override(BEP2981, BEP721Enumerable) returns (bool) {
        return interfaceId == type(IBEP2981).interfaceId || super.supportsInterface(interfaceId);
    }
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        string memory baseURI = _baseURI();
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI, tokenId.toString(), fileExtension)) : "";
    }
