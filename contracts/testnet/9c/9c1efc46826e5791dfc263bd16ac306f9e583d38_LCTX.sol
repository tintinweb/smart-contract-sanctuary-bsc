...
contract LCTX is IERC20 {
    ...
    string constant private _name = "Lxy Cat Token";
    string constant private _symbol = "LCTTEST";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x0063a33378C3529532F632992877Ab0cb1219B16),
        development: payable(0x0063a33378C3529532F632992877Ab0cb1219B16)
    });
    ...
    uint256 public _maxBuyTxAmount = (_tTotal * 1) / 100;
...
//================================================ BLACKLIST
    ...
    function setSwapSettings(uint256 thresholdPercent, uint256 thresholdDivisor, uint256 amountPercent, uint256 amountDivisor) external onlyOwner {
     ...
     function setBuylimit(uint256 maxbuytx) external onlyOwner {
        _maxBuyTxAmount = maxbuytx;
       
    }

    function setSelllimit(uint256 maxselltx) external onlyOwner {
        _maxSellTxAmount = maxselltx;
    }

    function setMaxWalletimit(uint256 maxwalltx) external onlyOwner {
        _maxWalletSize = maxwalltx;
    }
    ...
    function txnStatus(bool _status) public onlyOwner {
        tradingOpen = _status;
        if(tradingOpen){
