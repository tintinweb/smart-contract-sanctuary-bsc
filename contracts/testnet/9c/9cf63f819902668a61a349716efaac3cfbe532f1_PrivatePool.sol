...
contract PrivatePool is OwnableUpgradeable, IPool {
    using SafeMath for uint256;
    ...
    uint256 private feesWithdraw = 1000; // 10% 
    uint256 public ispresale = 2;
    uint256 public isprivatesale = 1;
    ...
    function withdrawContribution() external {
        ...
        uint256 fees = refundAmount.mul(feesWithdraw).div(10000);
        refundAmount = refundAmount.sub(fees); 
