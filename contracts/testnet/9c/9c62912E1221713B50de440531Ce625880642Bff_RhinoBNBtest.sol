...
contract RhinoBNBtest is Context, Ownable , ReentrancyGuard {
    ...
    uint256 public constant max = 40 ether;
    uint256 public roi = 25;
    uint256 public constant fee = 6;
    uint256 public constant withdraw_fee = 7;
    uint256 public daysToWithdraw = 0.1 * 60 * 60;    //Can withdraw every 7 days
    uint256 public daysToClaim = 0.01 * 60 * 60;       //Claim every 1 day
    ...
    function withdrawal() public noReentrant {
        ...
        require(totalRewards[msg.sender].amount <= SafeMath.mul(investments[msg.sender].invested,2), "You cant withdraw you have collected 2 times Already");
    ...
    function unStake() external noReentrant {
        ...
        require(I_investment > t_withdraw, "You already withdrawn more than your investment");
