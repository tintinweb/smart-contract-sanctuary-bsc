...
contract BerserkerGovernance is GovernorInterface, GovernorEvents {
    ...
    uint public constant MIN_VOTING_PERIOD = 1 days; // 24 hours
    ...
    uint public constant MIN_VOTING_DELAY = 1 days; // 24 hours
    ...
    uint public constant INTERVAL_TIME = 1 weeks; // 1 week

    address public BUSD;
    IERC721 public berserker;
      
    constructor() {
        votingPeriod = 5 days;  // 5 days
        votingDelay = 2 days;  // 2 days
