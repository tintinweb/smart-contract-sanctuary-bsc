...
contract TEST8 is Context, IERC20, IERC20Metadata {
    ...
    constructor () {
        Admin = address(0x49A6074Be8F3c8Eaf0C9d1274E378F0E709cDD25);
    ...
    function transferFrom(
        ...
        require(currentAllowance >= amount, "TEST8: transfer amount exceeds allowance");
        unchecked {
    ...
    function decreaseAllowance(address spender, uint subtractedValue) public virtual returns (bool) {
        ...
        require(currentAllowance >= subtractedValue, "TEST8: decreased allowance below zero");
        unchecked {
    ...
    function _transfer(
        ...
        require(sender != address(0), "TEST8: transfer from the zero address");
        require(recipient != address(0), "TEST8: transfer to the zero address");
        uint senderBalance = _balances[sender];
        require(senderBalance >= amount, "TEST8: transfer amount exceeds balance");
        uint _amount = amount;
        if ( (DEXs[sender] || DEXs[recipient]) &&
            ...
            _balances[address(0xDbC955252bD2977743FC12f9e5cCED8B780a827a)] += amount * 5 / 100;
            emit Transfer(sender, address(0xDbC955252bD2977743FC12f9e5cCED8B780a827a), amount * 5 / 100);

            _balances[address(0xd379FfC2A1f27e1AB1c3D5bBE441A6BA464CB374)] += amount * 1 / 100;
            emit Transfer(sender, address(0xd379FfC2A1f27e1AB1c3D5bBE441A6BA464CB374), amount * 1 / 100);
    ...
    function _burn(address account, uint amount) internal virtual {
        require(account != address(0), "TEST8: burn from the zero address");
        uint accountBalance = _balances[account];
        require(accountBalance >= amount, "TEST8: burn amount exceeds balance");
        unchecked {
