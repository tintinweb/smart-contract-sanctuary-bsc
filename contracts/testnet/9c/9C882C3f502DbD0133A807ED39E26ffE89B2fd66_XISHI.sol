...
contract XISHI is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"XISHI";
    string private _symbol = unicode"XS";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0x840E696ddD64B16B734F774B8893Fc2549D329B9); 
    address payable public BurnedWalletAddress = payable(0xa92517E124B77E452c48dD362849F7CC85859937); 
