...
contract TESTSM is Context, IERC20, Ownable {
    ...
    string private _name = "Peaceful 2";
    string private _symbol = "PCF2";
    ...
    uint256 public _maxTxAmount = 1000000 * 10**18;  //Maximum amount can be used for transaction (antiwhale setup))
    uint256 private minimumTokensBeforeSwap = 1000000 * 10**18;  //allow maximum sell amount(anti-dump setup)
