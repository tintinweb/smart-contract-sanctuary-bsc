...
contract FuoIdo is Ownable {
    ...
    uint256 public excInPrice = 9 * 10**14;
    uint256 public excInFee = 0;//1000
    uint256 public excOutPrice = 8 * 10**14;
    uint256 public excOutFee = 20;//1000
    uint256 public swapPoolAmount = 855642 * 10**18;
