    ...
    UUPSUpgradeable
{
     ...
     */
    function __Huuk1155General_init(string memory uri_)
        internal
        onlyInitializing
    {
        __ERC1155_init_unchained(uri_);
        __Pausable_init_unchained();
        __Huuk1155General_init_unchained(uri_);
    }

    function __Huuk1155General_init_unchained(string memory)
        internal
        onlyInitializing
    {
    ...
    function create(
        ...
        require(
            0 <= _loyaltyFee && _loyaltyFee <= 10000,
            "Huuk1155General: invalid-loyalty-fee"
        );
        uint256 _id = _tokenIdTracker.current();
        _tokenIdTracker.increment();
        creators[_id] = _msgSender();
        royaltyFees[_id] = _loyaltyFee;
        tokenURIs[_id] = _uri;
        ...
        emit Create(_msgSender(), _id, _loyaltyFee, _maxSupply, _initialSupply);
        return _id;
    }
