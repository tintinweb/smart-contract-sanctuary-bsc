...
contract JamClockAuction721 is JamMarketplaceHelpers, ERC721Holder {
    ...
    {
        marketplaceId = keccak256("JAM_CLOCK_AUCTION_721");
    }
    ...
    modifier canBeStoredWith64Bits(uint256 value) {
        require(
            ...
            "JamClockAuction721: value is longer than 64 bit"
        );
        _;
    }
    ...
    modifier canBeStoredWith128Bits(uint256 value) {
        require(
            ...
            "JamClockAuction721: value is longer than 128 bit"
        );
        _;
    }
        ...
        )
    {
        ...
        require(
            ...
            "JamClockAuction721: auction not exists"
        );
        return (
            auction.seller,
            auction.currency,
        ...
        canBeStoredWith64Bits(duration)
    {
        ...
        require(
            ...
            "JamClockAuction721: sender is not owner of NFT"
        );
    ...
    function bid(
        ...
        if (auction.currency == address(0))
            require(
                bidAmount == msg.value,
                "JamClockAuction721: bid amount info mismatch"
            );
        else {
            (bool success, ) = payable(msg.sender).call{value: msg.value}("");
            require(success, "JamClockAuction721: return money failed");
        }
        ...
        canBeStoredWith64Bits(duration)
    {
        ...
        require(
            ...
            "JamClockAuction721: only seller can update auction"
        );
        ...
        override
    {
        ...
        require(
            ...
            "JamClockAuction721: only seller can cancel auction"
        );
    ...
    function _addAuction(
        ...
        require(
            ...
            "JamClockAuction721: too short auction"
        );
    ...
    function _bid(
        ...
        require(
            bidAmount >= price,
            "JamClockAuction721: insufficient bid amount"
        );
        ...
        if (bidAmount > price) {
            ...
            if (currency == address(0)) {
                ...
                require(success, "JamClockAuction721: return excess failed");
            } else {
