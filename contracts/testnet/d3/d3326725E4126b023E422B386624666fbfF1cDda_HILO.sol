...
contract HILO is IERC20 {
    
    using SafeMath for uint256;

    string private _name = "HILO";
    string private _symbol = "HILO";
    ...
    address public advisorsAddress ;      // pileaddress
     address public marketingAddress ;      // marketingAddress
    address public teamAddress  ;      // teamaddress
    ...
    constructor( address _advAddress , address _markAddress , address _teamAddress  ) {

        advisorsAddress = _advAddress;
        marketingAddress = _markAddress;
 ...
 function betweencollectFee(address account, uint256 amount) private  returns (uint256) {
    ...
    // marketing 0x0cd1a956BFc918398129E2cF7F9FDdAbdCC559bE
// advisor address 0xDE3DF272A4225852c93b5331750e8a1Ce34504FD
//team address 0xB4c81e9150CC2A1EA32F1A525bDA1bca4Aaaf8dF
