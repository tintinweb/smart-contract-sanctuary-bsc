...
contract FCFSSale is ReentrancyGuard, Ownable, Pausable {
    ...
    uint256[2] public SALE_S1_RANGE = [5000001, 5000100];
    uint256[2] public SALE_S2_RANGE = [5000101, 5000200];
    uint256[2] public SALE_S3_RANGE = [5000201, 5000300];

    uint256 public BOUGHT_S1 = 0;
    uint256 public BOUGHT_S2 = 0;
    uint256 public BOUGHT_S3 = 0;

    mapping(address => bool) private _boughtNFTs;
    ...
    function createMarketSale(
        ...
        require(!_boughtNFTs[_msgSender()], "Can not buy more NFT");
        ...
        require(
            IERC20(PAYMENT_TOKEN).transferFrom(payable(_msgSender()), address(TOP_UP_ADDRESS), PRICE),
