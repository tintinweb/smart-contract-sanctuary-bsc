...
contract TaurenToken is Context, IBEP20, Ownable {
    ...
    constructor () {
        ...
        TRN = TaurenNFT(0xa5DeA8905C99064C8EdE96596658a1E0d50f4F72);
    ...
    function rescueBullNFT(uint256 _bullPeriodIndex) public {
        ...
        ERC20(BUSD).transfer(preOwner, price);

        hammerOwner[_bullPeriodIndex].push(msg.sender);

        uint256 amount = BUSDEqualToToken(price.div(100));

        transfer(deadWallet, amount);
    ...
    function quitPledgeNFT(uint256 tokenId) public {
        ...
        uint256 tokenAmount = tokenIdToPledges[tokenId].KOFAmount;
