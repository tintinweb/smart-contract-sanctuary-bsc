...
contract Rematic is ERC20Upgradeable, OwnableUpgradeable {
    ...
    IToken1DividendTracker public token1DividendTracker;
    IToken2DividendTracker public token2DividendTracker;
    ...
    function __Rematic_init_unchained(address token1DividendTrackerAddr, address token2DividendTrackerAddr) internal onlyInitializing {
    	...
    	token1DividendTracker = IToken1DividendTracker(token1DividendTrackerAddr);
    	token2DividendTracker = IToken2DividendTracker(token2DividendTrackerAddr);
    ...
    function updatetoken1DividendTracker(address newAddress) external onlyOwner {
        ...
        IToken1DividendTracker newtoken1DividendTracker = IToken1DividendTracker(newAddress);
    ...
    function updatetoken2DividendTracker(address newAddress) external onlyOwner {
       ...
       IToken2DividendTracker newtoken2DividendTracker = IToken2DividendTracker(newAddress);
    ...
    function transferDividends(address dividendToken, address dividendTracker, IDividendPayingToken dividendPayingTracker, uint256 amount) private {
