...
contract Admin is OwnableUpgradeable, ERC165Upgradeable, IAdmin {
    ...
    /**
     *  @notice token address to use payment
     */
    ...
    event SetPaymentToken(address indexed oldValue, address indexed newValue);
     ...
     */
    function setPaymentToken(address _paymentToken) external onlyAdmin notZeroAddress(_paymentToken) {
        address oldValue = paymentToken;
        paymentToken = _paymentToken;
        emit SetPaymentToken(oldValue, paymentToken);
    }
