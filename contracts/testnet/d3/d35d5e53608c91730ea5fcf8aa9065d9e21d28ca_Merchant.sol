...
contract Merchant is Pausable, MerchantProperty, ReentrancyGuard {
    ...
    struct TransctionInfo {
        ...
        uint256 amountIn;
        uint256 amountOut;
        uint256 excessRequestToken;
        uint256 residualPlatformTokens;
        uint256 timeStamp;
    }
    ...
    uint256 private excessRequestToken;
    uint256 private residualPlatformTokens;
    ...
    function submitTransaction(
        ...
        (excessRequestToken, residualPlatformTokens) = _slashController.submitTransaction{value: msg.value}(
            _msgSender(),
            payingToken_,
            amountIn_,
            requiredAmountOut_,
        ...
        _txDetails[txNumber].excessRequestToken = excessRequestToken;
        _txDetails[txNumber].residualPlatformTokens = residualPlatformTokens;
