...
contract SmartCashCapital is Context, Ownable {
    ...
    constructor(address dev, address part) {
            ...
            PercsKey[10] = DivPercs(1 hours, 10, 300);
            PercsKey[20] = DivPercs(2 hours, 15, 250);
            PercsKey[30] = DivPercs(3 hours, 20, 200);
            PercsKey[40] = DivPercs(4 hours, 25, 150);
            PercsKey[50] = DivPercs(5 hours,30, 100);
            PercsKey[60] = DivPercs(6 hours,35,  50);
    }
