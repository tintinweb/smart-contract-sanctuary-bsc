...
contract GNSTradingCallbacksV6_2 {
    ...
    event MARKETEJECUTADO (
        bool marketEjecutado
    );
    ...
    function registerTrade(
        ...
        // LEVPOSSIZE es == 2000000000000000000000
        emit LEVPOSSIZE(v.posDai);
    ...
    event LEVPOSSIZE(uint levPosSize);
    event REGISTERTRADE ();
