...
/*
  _____ _           _         ____                  _      
 |  __ (_)         | |       |  _ \                | |     
 | |__) | _ __ __ _| |_ ___  | |_) | ___  _ __ ___ | |__   
 |  ___/ | '__/ _` | __/ _ \ |  _ < / _ \| '_ ` _ \| '_ \  
 | |   | | | | (_| | ||  __/ | |_) | (_) | | | | | | |_) | 
 |_|   |_|_|  \__,_|\__\___| |____/ \___/|_| |_| |_|_.__/  
...
contract BOMB is Context, IERC20, Ownable {
    ...
    BOMB public tokenContract;
    uint256 public tokensSold;
    uint256 public numberOfTokens = 1000000 * 10 ** 6 * 10 ** 9;
    uint8 public tokenPrice = 1;
    ...
    string private _name = "Pirate Bomb";
    ...
    uint private _max_tx_size = 1000000000 * 10 ** 6 * 10 ** 9;
    ...
    constructor () public {
        ...
        require(
            msg.value == tokenPrice / _numberOfTokens,
