...
contract Accumulator is Initializable, OwnableUpgradeable,IERC20MetadataUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize() public initializer {
        ...
        gwTreasury  = 0xc707492FA60B18d5d8C81De6B716166344446Be8;
        ...
        _mint(0x60A82cB4518934E9ae6C8b02b82BfD1A3936a92f, 150);
    ...
    function setFeeOtherExcempt(address account, bool flag) public onlyOwner {
        _isFeeExempt[account] = flag;
    }
    ...
    function swapBack() public swapping {
        ...
        if(amountForPSM > 0) {
            _swapTokensForBusd(amountForPSM, psmTreasury);
        }

        if(amountForProtocol > 0) {
            _swapTokensForBusd(amountForPSM, ptTreasury);
        }
