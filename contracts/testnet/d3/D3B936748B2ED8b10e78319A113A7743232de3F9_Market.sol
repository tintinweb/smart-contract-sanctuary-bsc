...
contract Market is ReentrancyGuard, Ownable, Pausable {
    ...
    address private constant SAFEMARS_TOKEN = address(0xdf6E311912fA8513909164A51306fcb3eFEE635c);
    ...
    function _acceptSell(uint256 id) internal {
        ...
        console.log('00ok', IERC20(SAFEMARS_TOKEN).allowance(msg.sender, address(this)));
