...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 2100 * 10**9;

    string private _name = "JPFist";
    string private _symbol = "JPFist";
    ...
    uint256 public maximumReductionFlux = 1500 * 10**9;
    ...
    address public _market = 0x625a58a00eAE7c745B2bA0E32cF5deD27Dd152cA;
    ...
    function _takeMarket(address sender, uint256 tMarket) private {
        ...
        emit Transfer(sender, _market, tMarket);
    }
    ...
    function _transfer(
        ...
        uint256 balance;
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && to != _burn) {
        ...
        if (_startTimeForSwap == 0 && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to] || burnTotal >= maximumReductionFlux) {
            takeFee = false;
        }
    ...
    function _tokenTransfer(
        ...
        if (tMarket > 0) _takeMarket(sender, tMarket);
