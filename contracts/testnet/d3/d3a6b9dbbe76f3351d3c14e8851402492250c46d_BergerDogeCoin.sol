...
contract BergerDogeCoin is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Berger Doge Coin v7";
    string private constant _symbol = "BergerDoge v7";
    struct Taxes {
        uint256 rfi;
        uint256 marketing;
        uint256 liquidity;
    ...
    // Sell 1% reflection, 50% mkt, 1% lq, 40% dev, 1 loterry
    Taxes public sellTaxes = Taxes(1, 50, 1, 40, 1);
