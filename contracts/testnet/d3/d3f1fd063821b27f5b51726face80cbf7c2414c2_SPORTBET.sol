...
contract SPORTBET {
    ...
    function endGame(uint256 _gameId, uint256 _winner) external onlyAdmin {
        ...
        uint256[] memory teamsW;
        GamesData[_gameId].status = false;
        if(_winner == 0){
            prize = ((GamesData[_gameId].teams[1] + GamesData[_gameId].teams[2]) * prize_percent) / divider;
            lost = GamesData[_gameId].teams[1] + GamesData[_gameId].teams[2];
            GamesData[_gameId].result = GamesData[_gameId].team1;
            prizeDivider = GamesData[_gameId].teams[0];
            teamsW[0] = 0;
            teamsW[1] = 1;
            teamsW[2] = 2;
        }
        if(_winner == 1){
            prize = ((GamesData[_gameId].teams[0] + GamesData[_gameId].teams[2]) * prize_percent) / divider;
            lost = GamesData[_gameId].teams[0] + GamesData[_gameId].teams[2];
            GamesData[_gameId].result = GamesData[_gameId].team2;
            prizeDivider = GamesData[_gameId].teams[1];
            teamsW[0] = 1;
            teamsW[1] = 0;
            teamsW[2] = 2;
        }
        if(_winner == 2){
            prize = ((GamesData[_gameId].teams[1] + GamesData[_gameId].teams[0]) * prize_percent) / divider;
            lost = GamesData[_gameId].teams[1] + GamesData[_gameId].teams[0];
            GamesData[_gameId].result = GamesData[_gameId].drawgame;
            prizeDivider = GamesData[_gameId].teams[2];
            teamsW[0] = 2;
            teamsW[1] = 1;
            teamsW[2] = 0;
        }
        ...
        for(uint256 i = 0; i < GamesData[_gameId].uniqueaddress.length; i++){
            address addr = GamesData[_gameId].uniqueaddress[i];
            user = players[addr];
            uint256 tw = GamesData[_gameId].participants[addr][teamsW[0]];
            if(tw > 0){
                ...
                user.toclaim += touser + GamesData[_gameId].participants[addr][teamsW[0]];
            }
            user.losts += GamesData[_gameId].participants[addr][teamsW[1]];
            user.losts += GamesData[_gameId].participants[addr][teamsW[2]];
        }
    ...
    function betOnGame(uint256 _gameId, uint256 _team, uint256 _bet, address _ref) external {
        ...
        if(_team == 0){
            GamesData[_gameId].participants[msg.sender][0] += _bet;
            GamesData[_gameId].teams[0] += _bet;
        }
        if(_team == 1){
            GamesData[_gameId].participants[msg.sender][1] += _bet;
            GamesData[_gameId].teams[1] += _bet;
        }
        if(_team == 2){
            GamesData[_gameId].participants[msg.sender][2] += _bet;
            GamesData[_gameId].teams[2] += _bet;
        }
