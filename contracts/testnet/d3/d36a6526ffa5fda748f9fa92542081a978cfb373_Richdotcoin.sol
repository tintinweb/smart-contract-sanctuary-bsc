...
contract Richdotcoin is Context, IERC20, Ownable {
    ...
    uint256 public _CoinageDifficulty = _mintweight/1*10**18;
    ...
    uint256 public _maxTxAmount = 100*(30*10**18 + ((_maximumSupply - _tTotal)/(_maximumSupply + _tTotal))*(960000*10**18/_tTotal))/3;
    uint256 private numTokensSellToAddToLiquidity = 30*10**18 + ((_maximumSupply - _tTotal)/(_maximumSupply + _tTotal))*(960000*10**18/_tTotal);
    ...
    function mint(uint256 amount) public returns (bool) {
        ...
        numTokensSellToAddToLiquidity = 30*10**18 + ((_maximumSupply - _tTotal)/(_maximumSupply + _tTotal))*(2500000*10**18/_tTotal);
        _maxTxAmount = 100*(30*10**18 + ((_maximumSupply - _tTotal)/(_maximumSupply + _tTotal))*(2500000*10**18/_tTotal))/3;
        return true;
    }
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner())
            require(amount*10**18 <= _maxTxAmount, "Richdotcoin maximum exceeded, reduce the coins amount");
