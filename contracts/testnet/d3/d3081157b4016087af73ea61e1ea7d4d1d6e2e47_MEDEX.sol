...
contract MEDEX is MedexERC20 {
    ...
    function addLiquidity(uint256 amountA, uint256 amountB, uint256 tokenIN) public {
    ...
    function buy(uint256 tokenIN, uint256 amountInOut, uint256 input,uint256 fromIn) external {
        ...
        if(fromIn==1){
            ...
            BEP20(tokenB).transferFrom(msg.sender, address(this), fromAmt);
