...
contract Marketplace is IERC721Receiver{
    ...
    /* Returns all unsold market items */
     function getAllMarketItem() public view returns (uint256 tokenId) {
       uint itemCount = _itemId.current()+1;
       uint unsoldItemCount = _itemId.current()+1 - _itemsSold.current()+1;
       uint currentIndex = 0;
