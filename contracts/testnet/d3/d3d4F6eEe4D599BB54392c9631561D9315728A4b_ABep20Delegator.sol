...
contract ABep20Delegator is ATokenInterface, ABep20Interface, ADelegatorInterface {
   ...
   /**
    ...
    function _setStrategyVault(address newStrategyVault) public {
        delegateToImplementation(abi.encodeWithSignature("_setStrategyVault(address)", newStrategyVault));
    }
    
    function _transferLiquidityToStrategyVault(uint256 underlyingAmount) external {
        delegateToImplementation(abi.encodeWithSignature("_transferLiquidityToStrategyVault(address)", underlyingAmount));
    }
