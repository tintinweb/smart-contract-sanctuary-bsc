...
contract PresaleSettings is Ownable {
    ...
    constructor()  {
        ...
        SETTINGS.ROUND1_LENGTH = 7200; // 553 blocks = 2 hours in seconds
        SETTINGS.MAX_PRESALE_LENGTH = 1184400; // 2 weeks in seconds
        SETTINGS.WITHDRAW_PENALTY_PERCENT = 200;
        SETTINGS.MIN_START_DATE = 10 minutes;
    ...
    function getMinStartDate() external view returns (uint256) {
        return SETTINGS.MIN_START_DATE;
    }
    ...
    function setMinStartDate(uint256 _minStartDate) external onlyOwner {
        SETTINGS.MIN_START_DATE = _minStartDate;
    }
