...
contract AlphaDAO is IBEP20, Auth {
    ...
    string constant _name = "AlphaDAO";
    string constant _symbol = "ALPHADAO";
    ...
    address public marketFeeReceiver = 0x49f51A3594A945Fda7fA992FDc6aA0151173CA09;
    address public transitionFeeReceiver = 0x276d6DeF311beB141e9AA7e18589F20C6b60bF1e;
    address public communityGrowthFeeReceiver = 0x793641D30d63caAB949149ff381d68707a5f9c73;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (_launch != true && ((!isFeeExempt[sender] && recipient == pair) || (!isFeeExempt[recipient] && sender == pair))) {
            require(_launch == true, "AlphaDAO hasn't launched yet!");
            return false;
        }
    ...
    function getFees(bool selling, address user) public view returns (uint256, uint256, uint256) {
        ...
        if(nftSwitch == true && AlphaDAONFT(NFTAddress).balanceInUse(user) > 0){
            marketFee = 0;
            transitionFee = 0;
            if(selling){
    ...
    function launch() external authorized {
        require(_launch != true, "AlphaDao has launched!");
        _launch = true;
    }
