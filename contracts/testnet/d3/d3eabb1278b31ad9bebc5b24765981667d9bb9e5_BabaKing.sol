...
// Dependency file: contracts/baby/BabaKingDividendTracker.sol
...
contract BabaKingDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main BabaKing contract."
        );
    }
...
// Root file: contracts/baby/BabaKing.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/BabaKingDividendTracker.sol";
// import "contracts/BaseToken.sol";

contract BabaKing is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    BabaKingDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = BabaKingDividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "BabaKing: The dividend tracker already has that address"
        );

        BabaKingDividendTracker newDividendTracker = BabaKingDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "BabaKing: The new dividend tracker must be owned by the BabaKing token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "BabaKing: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "BabaKing: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "BabaKing: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "BabaKing: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "BabaKing: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "BabaKing: Cannot update gasForProcessing to same value"
        );
