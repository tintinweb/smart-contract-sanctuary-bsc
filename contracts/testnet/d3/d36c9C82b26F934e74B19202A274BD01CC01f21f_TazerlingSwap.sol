...
// TazerlingSwap (TazerlingSwap)
// The first TazerlingSwap on the Binance Smart Chain.

// Telegram: https://t.me/TazerlingSwap
// Twitter: @TazerlingSwap
...
interface IERC20 {
     ...
     */
    function tTotal() external view returns (uint256);
...
contract TazerlingSwap is Context, IERC20, Ownable, MinterRole {
    ...
    string private _name = "TazerlingSwap";
    string private _symbol = "TazerlingSwap";
    ...
    function tTotal() public view override returns (uint256) {
        return _tTotal;
    }
        ...
        returns (uint256)
    {
        ...
        if (!deductTransferFee) {
            (uint256 rAmount, , , , , ) = _getValues(tAmount);setSwapAndLiquifyEnabled;
            return rAmount;
        } else {
