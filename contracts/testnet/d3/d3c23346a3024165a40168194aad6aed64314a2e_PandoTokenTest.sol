...
contract PandoTokenTest is ERC20, AccessControl, ERC20Permit {
    ...
    // 买入手续费钱包
    address public receiveBuyFeeWallet = 0x714Ee71e8bEBd7717FF6dcECbEDB7e69ADFe75f0;
    // 卖出手续费钱包
    address public receiveSellFeeWallet = 0x714Ee71e8bEBd7717FF6dcECbEDB7e69ADFe75f0;
    // 黑洞
    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    // wrap对象
    IWrap public wrap = IWrap(0xfB1061c4cB6Dd43124002e183C0Fec71c63dDa51);                   
    // usdt对象 
    ...
    constructor()
        ERC20("Meta Life", "META")
        ERC20Permit("Pandora Token Test")
    {
    ...
    function _transfer(address sender, address recipient, uint amount) internal override {
        ...
        //   是否收费
        bool freeOfCharge = sender == address(this) || hasRole(DEFAULT_ADMIN_ROLE, sender) || sender == receiveBuyFeeWallet || sender == receiveSellFeeWallet || recipient == address(this) || hasRole(DEFAULT_ADMIN_ROLE, recipient) || recipient == receiveBuyFeeWallet || recipient == receiveSellFeeWallet;
        if (!freeOfCharge) {
            ...
            if (currentBalance > 0 && !swaping && sender != pancakePair) {
                swaping = true; 
                if(_buyFeeAmount > 0) {
                    // super._transfer(sender, DEAD, amount);
