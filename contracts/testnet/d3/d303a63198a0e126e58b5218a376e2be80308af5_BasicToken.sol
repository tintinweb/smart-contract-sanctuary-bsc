...
contract BasicToken is ERC20, Ownable {
    ...
    address public marketingWallet = 0x1aBF9A2E66906F13ff2830bc18478405abC68eE0;
    address public developerWallet = 0x1aBF9A2E66906F13ff2830bc18478405abC68eE0;
    ...
    constructor () ERC20("Metawire", "MWIRE") 
    {   
        ...
        swapTokensAtAmount = totalSupply() / 1000000;
    }
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _devFeeOnBuy) external onlyOwner {
        require(
            _liquidityFeeOnBuy + _marketingFeeOnBuy + _devFeeOnBuy <= 15,
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _devFeeOnSell) external onlyOwner {
        require(
            _liquidityFeeOnSell + _marketingFeeOnSell + _devFeeOnSell <= 15,
            "Fees must be less than 25%"
        );
    ...
    function _transfer(
        ...
        if( swapEnabled && 
            ...
            uint256 bnbShare = marketingShare + devShare;
