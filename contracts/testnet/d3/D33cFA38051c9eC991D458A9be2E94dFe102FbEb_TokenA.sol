...
contract TokenA is BEP20, Ownable{
    ...
    constructor (address preSale, address teamWallet, address developmentWallet, address airdropWallet, address lockerWallet, address presaleAndLiquidity)  BEP20("PiratePennies", "PRP") {
