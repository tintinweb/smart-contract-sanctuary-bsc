...
/**
 * @dev The official tiggerpublicv1 smart contract
 */
contract tiggerpublicv1 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "tiggerpublicv1";
    string private _symbol   = "tiggerpublic";
    uint8  private _decimals = 9;

    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for tiggerpublicv1/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0xAFA69060Ee99850905fd7aEe2B74e35CA48fff96); // Marketing address used to pay for marketing
    ...
    uint256 public _tokenSwapThreshold = 10 * 10**6 * 10**9; // 10 million
    
    // Timer Constants 
    uint private constant DAY = 86400; // How many seconds in a day
    
    // Anti-Whale Settings 
    uint256 public _whaleSellThreshold = 1 * 10**6 * 10**9; // 1 million
    ...
    uint256 public _buybackUpperLimit    = 100 * 10**3 * 10**9; // 1 thousand $tiggerpublicv1 will be used to buy at maximum in any one trade
    ...
    uint256 public  _lotteryThreshold    = 10 * 10**3 * 10**9; // 10 thousand tokens required to be in the pool before lottery can be triggered
    uint256 public  _lotteryMinimumSpend = 10 * 10**3 * 10**9; // 10 thousand tokens required to buy before before lottery can be triggered
    ...
    /**
     * @notice Withdraws non-tiggerpublicv1 tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts tiggerpublicv1 balance for buybacks, charity, liquidity and marketing
    ...
    /**
     * @notice Burns tiggerpublicv1 tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of tiggerpublicv1 tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from tiggerpublicv1)
    ...
    function swapBNBForTokens(uint256 amount) private {
        ...
        _pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            0, // Accept any amount of tiggerpublicv1
            path,
