...
contract TKOPower is ERC20, Ownable {
    ...
    function lock(uint256 amount) public {
        ...
        require(TKO.transferFrom(msg.sender, address(this), amount), "Failed transfer");
   ...
   function TKOToPower(uint256 tko) public pure returns (uint256) {
    ...
    function claim() public {
        ...
        uint256 tkoAmount = _stakedAmount[msg.sender];
        // TKO.safeTransferFrom(msg.sender, address(this), tkoAmount);
        require(TKO.transferFrom(address(this), msg.sender, tkoAmount), "Failed transfer");
