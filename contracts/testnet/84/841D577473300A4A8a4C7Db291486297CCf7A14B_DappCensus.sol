...
contract DappCensus is IBEP20, Owned {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        */
        ...
        /* Transfer can only happen if the lockTime has elapsed */
        for(uint i = 0; i < records[sender].length; i++) {
            require(block.timestamp > records[sender][i].lockingPeriod, "DappCensus: Cannot transfer until Lock period has elapsed");
        }
