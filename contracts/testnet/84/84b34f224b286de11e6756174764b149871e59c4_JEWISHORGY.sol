...
contract JEWISHORGY is IBEP20, Auth {
 using SafeMath for uint256;
 ...
 string constant _name = "JEWISHORGY";
 string constant _symbol = "JEWGY";
...
returns (bool) {
 ...
 function shouldTakeFee(address sender) internal view returns (bool) {
    ...
    function clearStuckBalance(uint256 amountPercentage) external authorized {
        ...
        IBEP20(lpTOKEN).transfer(marketingFeeReceiver, BUSDLeftoverBalance);
 }
