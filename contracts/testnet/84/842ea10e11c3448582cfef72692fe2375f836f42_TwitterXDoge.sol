...
contract TwitterXDoge is Context, IERC20, Ownable {
    ...
    string private _name = "TWITTER X DOGE";
    ...
    address payable public devWallet = payable(0x944D0Ee76d73f951f11394bd381151a3CCc4B39f);
    address payable public marketingWallet = payable(0x944D0Ee76d73f951f11394bd381151a3CCc4B39f); 
