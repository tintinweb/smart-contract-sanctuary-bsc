...
contract GoldenAirdrop is Ownable {
    ...
    constructor() {
        ...
        timeSlot = 60 seconds;
        rewardPercentage = 250000000000000000; // 0.25%
        lockTime = 10 minutes; // 365 days
        startStakingTime = 5;  // 90 
        startStakingTime1 = 300 seconds;  // 90 days
        minimumWithdraw = 1e18;
        slotTime = 15; // 365+90 days
        fee = 10;
        taxAddress = 0xc2E3aDdd10F6C48082Ac8173B864dd304930E6d8;
    }

    function airDrop(address[] memory _recipients,uint256[] memory amount) public  {
    ...
    function setFee(uint256 feeAmount) public  {
        fee = feeAmount;
    }

    function setRewardPercent(uint256 percent) public  {
        rewardPercentage = percent;
    }

    function updateMinimumWithdraw(uint256 amount) public  {
    ...
    function getTokensWithAmount(uint256 claimAble) public {
...
// ["0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2","0x6381BfCC0E42a0186Ecb302F5f5Fe54B3DE04414"]