...
contract DividendTracker is DividendPayingToken {
  ...
  constructor(
    ...
    minimumTokenBalanceForDividends = 1_000_000_000 * 10**9; // must hold 1 billion tokens which equates to 0.0001% of the total Zomberman supply
  }
...
interface IZomberman is IERC20, IERC20Metadata {
...
// File: contracts/Zomberman.sol

pragma solidity 0.8.4;

contract Zomberman is
  IZomberman,
  Context,
  AccessControlEnumerable,
  ReentrancyGuard
{
  ...
  constructor(
    ...
    _dividendRewardToken = addresses_;
    _marketingWallet = addresses_;
    _liquidityWallet = addresses_;
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'Zomberman: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs'
    );
  ...
  function _setAutomatedMarketMakerPair(address pair, bool value) private {
    require(
      ...
      'Zomberman: Automated market maker pair is already set to that value'
    );
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'Zomberman: The dividend tracker already has that address'
    );
    ...
    require(
      ...
      'Zomberman: The new dividend tracker must be owned by the token contract'
    );
