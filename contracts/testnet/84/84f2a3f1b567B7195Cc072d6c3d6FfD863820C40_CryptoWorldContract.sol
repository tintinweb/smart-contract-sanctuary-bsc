...
console.log("valorATransferir: ", valorATransferir);
        _contractSecurityLockFunction();
        payable(msgSender).transfer(valorATransferir);
    }

    function _gerarBonusDiario() public {
        address msgSender = _msgSender();
        uint256 valorDepositado = accMapping[msgSender].valorDepositado;
        uint256 totalAcumuladoAReceber = accMapping[msgSender].totalAcumuladoAReceber;
    ...
    function setRenewAccount() external payable nonReentrant {
        ...
        uint256 valorDisponivelSaquePacoteAnterior = totalAReceber(msgSender);
        ...
        accMapping[msgSender].valorDisponivelSaquePacoteAnterior = valorDisponivelSaquePacoteAnterior;
        _controlEnter();
    }
    ...
    function totalAReceber(address _address) public view returns(uint256 totalAReceberLiquido)
    {
        ...
        uint256 valorTotalLiquidoRecebivel = _valorTotalLiquidoRecebivel(valorDepositado, bonusFidelidade);
        ...
        totalAReceberLiquido = bonusDiarioRecebido + totalAcumuladoAReceber + totalSacado <= valorTotalLiquidoRecebivel + valorDisponivelSaquePacoteAnterior
                                    ? bonusDiarioRecebido + totalAcumuladoAReceber
                                    : valorTotalLiquidoRecebivel + valorDisponivelSaquePacoteAnterior - totalSacado;
    }
