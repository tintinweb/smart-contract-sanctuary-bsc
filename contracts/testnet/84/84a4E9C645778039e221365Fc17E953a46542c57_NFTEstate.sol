...
contract NFTEstate is ERC721URIStorage, VRFConsumerBase, Ownable {
    ...
    mapping(bytes32 => string) requestToBuildingName;
    mapping(bytes32 => uint256) requestToCity;
    mapping(bytes32 => address) requestToSender;
    mapping(bytes32 => address) requestAddress;
    mapping(bytes32 => uint256) requestToTokenId;
    mapping(bytes32 => string) requestNftURI;
    mapping(address => mapping(uint256 => Building)) public usersNft;
    ...
    function buyLand(
        ...
        // we need to write code to send token in the contract or pay eth
        // if (msg.sender != owner()) {
        ...
        requestToBuildingName[requestId] = name;
        requestToCity[requestId] = city;
        ...
        override
    {
        ...
        buildings.push(
            Building(
                ...
                rarity,
                worth,
                requestToBuildingName[requestId],
                requestToCity[requestId],
