    ...
    UUPSUpgradeable
{
        ...
        public nonReentrant payable
    {
        ...
        require(price > 0, "This NFT is not available");
        require(tokenId > 0, "Market item has to exists");
        require(idToMarketItem[marketItemId].seller != msg.sender, "Seller cannot be buyer");

        // Transfer money to seller
        payable(idToMarketItem[marketItemId].seller).transfer(msg.value);
        ...
        emit BuyImageNFT(marketItemId , tokenId, nftContract, address(this), msg.sender, price);
