...
contract Launchpad is Ownable {
    ...
    event Modify(uint poolId, address tokenAddress, uint tokenPrice, uint tokenDecimals, uint256 tokenTotalSupply, /*uint64 bidStartTime, */uint64 bidEndTime, uint[8]);
