 ...
 */
contract PRUEBA2 is BEP20, Context, Ownable, ReentrancyGuard {
    ...
    string private constant _name = "PRUEBA2";
    string private constant _symbol = "PRB2";
