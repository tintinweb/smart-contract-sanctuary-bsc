...
contract WDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xA12368C7E1132Ae58D7415039A14D0222d943478); // Marketing Address
    ...
    uint256 private _tTotal = 1000000000 * 10**6 * 10**1;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "WDoge";
