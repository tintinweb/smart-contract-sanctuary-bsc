...
interface IERC1155Custom {
    function safeTransferFrom(address from,address to,uint256 id,uint256 amount,bytes memory data,string memory key_auth) external;
}

contract CTOKEN is Initializable, ERC1155Upgradeable, IERC1155Custom {
