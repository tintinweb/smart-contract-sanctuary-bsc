...
contract xxx is ERC20, Ownable {
    ...
    constructor() payable ERC20("xxx", "xxx") {
        ...
        if (block.chainid == 56) {
            ...
            _dexRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // ETH: Goerli
        } else {
        ...
        operationsAddress = address(0xE0E7Cd593a19A14927B556ad2f58c2e96961069f);
    ...
    function updateBuyFees(
        ...
        buyBurnFee = _burnFee;
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyBurnFee;
        require(buyTotalFees <= 9000, "Must keep fees at 9% or less");
    }
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellBurnFee;
        require(sellTotalFees <= 9000, "Must keep fees at 9% or less");
    }
