...
interface IMasterChefV3 {
    function upkeep(bool _withUpdate) external;
...
contract MasterChefV3Keeper is KeeperCompatibleInterface, Ownable, Pausable {
    ...
    uint256 public upkeepBufferSecond = 1 hours;
    ...
    function performUpkeep(bytes calldata) external override onlyRegister whenNotPaused {
        ...
        if (latestPeriodStartTime + upkeepBufferSecond < block.timestamp) MasterChefV3.upkeep(true);
    }
