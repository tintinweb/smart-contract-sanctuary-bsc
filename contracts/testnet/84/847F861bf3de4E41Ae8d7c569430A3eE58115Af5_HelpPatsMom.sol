...
contract HelpPatsMom is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public totalFees =
        charityFee.add(liquidityFee);

    uint256 public _charityFeeBuy = 1;
    uint256 public _LpFeeBuy = 3;

    uint256 public _charityFeeSell = 25;
    ...
    constructor() ERC20("HelpPatsMom", "HPM") {
        charityWallet = 0x9d737fdDFcd55b3f98557FF108F5167438B832C0;
    ...
    function updatecharityWallet(address _newWallet) external onlyOwner {
        require(
            _newWallet != charityWallet,
            "HPM: The charity wallet is already this address"
        );
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            uint256 tmpcharityRewardPercent;
            uint256 tmpLpRewardInContract;

            tmpcharityRewardPercent = amount.mul(charityFee).div(100);
            tmpLpRewardInContract = amount.mul(liquidityFee).div(100);

            fees = tmpcharityRewardPercent.add(tmpLpRewardInContract);
            ...
            sendBUSDToCharity(tmpcharityRewardPercent);
    ...
    function swapTokensForBUSD(
        ...
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47;
    ...
    function sendBUSDToCharity(uint256 amount) private { 
        swapTokensForBUSD(amount, charityWallet); 
    }
