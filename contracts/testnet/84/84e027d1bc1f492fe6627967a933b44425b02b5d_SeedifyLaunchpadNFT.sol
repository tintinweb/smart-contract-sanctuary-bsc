...
contract SeedifyLaunchpadNFT is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC2981Base { 
    ...
    function mint(uint256 amount, bytes memory data, uint256 royalty)
        public
        whenNotPaused
    {   
        ...
        _mint(msg.sender, tokenIDs, amount, data);
    }
    
    // mint batch items
    function mintBatch(uint256[] memory amounts, bytes memory data, uint256 royalty)
        public
        whenNotPaused
    {
