...
contract HH44 is Context, IERC20, Ownable {
    ...
    string private _name = "HHTEST";
    string private _symbol = "HH44";
    uint8 private _decimals = 9;

    uint256 private constant maxReflectionFee=5;
    uint256 private constant maxLiquidityFee=5;
    uint256 private constant maxMarketingFee=3;
    uint256 private constant minMaxTxAmount= 10000 * 10**9;
    uint256 private constant minMaxWalletToken= 10000 * 10**9;
    ...
    constructor () {
        ...
        _maxWalletToken= 1000000 * 10**9;
        _maxTxAmount = 1000000 * 10**9;

        _burnWalletAddress = 0x000000000000000000000000000000000000dEaD;
        _marketingWalletAddress = 0x807a83b39027541319D4497355056bDA335B0D88;
        ...
        _isExcludedFromFee[address(0x807a83b39027541319D4497355056bDA335B0D88)] = true;
        _isExcludedFromFee[address(0x83F54926cF75944E67854B0d09940819489E4293)] = true;

        _isExcluded[address(this)] = true;
        _isExcluded[address(0x807a83b39027541319D4497355056bDA335B0D88)] = true;
        _isExcluded[address(0x83F54926cF75944E67854B0d09940819489E4293)] = true;
