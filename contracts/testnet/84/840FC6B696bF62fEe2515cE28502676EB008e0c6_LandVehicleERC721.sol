    ...
    VRFConsumerBaseV2Upgradeable
{
    ...
    function initialize(
        ...
        uint32 _numWords,
        string memory _baseURIType0,
        string memory _baseURIType1,
        uint8 _module
    ) public initializer {
        __ERC721_init("LandVehicleERC721", "LandVehicleNFT");
        ...
        module = _module;
        baseURIByType[0] = _baseURIType0;
        baseURIByType[1] = _baseURIType1;
    }
    ...
    function randomMint(
        address to,
        uint8 _tier,
        SharedStructs.VechicleInfo memory _vehiclesInfo
    ) public onlyRole(MINTER_ROLE) {
        uint256 _tokenId = _tokenIdCounter.current();
        _tokenIdCounter.increment();
        _safeMint(to, _tokenId);
        ...
        vehiclesInfoMap[_tokenId].collectionId = _vehiclesInfo.collectionId;
        vehiclesInfoMap[_tokenId].collectionName = _vehiclesInfo.collectionName;
        vehiclesInfoMap[_tokenId].firstOwner = to;
        emit Minted(to, _tokenId);
    }
    ...
    function fulfillRandomWords(
        ...
        vehiclesInfoMap[requestData.tokenId].typeName = _type == 0
            ? "Bike"
            : "Car";
