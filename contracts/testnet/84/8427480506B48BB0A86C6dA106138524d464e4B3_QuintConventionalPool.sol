...
contract QuintConventionalPool is Ownable {
    ...
    IPair public liquidityPair = IPair(0x21566D20776db1244EA2CCe0E23c41BBBF3A8490); // Test
    // IERC20 public token = IERC20(0x64619f611248256F7F4b72fE83872F89d5d60d64); // Main
    IERC20 public token = IERC20(0x3c58D2169aF1085Aad65a188193d10C3053b41dD); // Test
