...
contract Token is ERC20, Ownable {                 //Contract name
    ...
    string public name_ = "wb3";       //Full name
    string public symbol_ = "wb3";      //abbreviation
    ...
    uint256 public lpRewardFee = 1;       //Add LP dividends
    address public lpRewardToken = 0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb;      //Dividend tokens
    ...
    constructor(
        ...
        uint256 totalSupply = 1 * (10**5);       //Supply
        ...
        marketingWalletAddress = 0x254A4F90b79a94151c3D7cB67456FB9f341e6b72;    //Marketing address
