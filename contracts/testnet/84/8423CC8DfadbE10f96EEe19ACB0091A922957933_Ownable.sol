...
contract AnySniper is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2Fa700d7B8267Cddf214C7B6597A9E81A9fBDAE1); // Marketing Address
    address payable public rewardAddress = payable(0x2Fa700d7B8267Cddf214C7B6597A9E81A9fBDAE1); // Reward Address
    address payable public liquidityAddress = payable(0x2Fa700d7B8267Cddf214C7B6597A9E81A9fBDAE1); // Liquidity Address
    ...
    string private constant _name = "PROSniper";
