...
Buy and Sell
5% Reflection (in your token)
5% Auto Liquidity
0% Marketing (in your token) you can set rate in future if you want 
I will make this option in the contract for you

0.5% per transaction 0.5% per wallet Manual Burn option In total 286,000,000 coin


*/

contract ASPIRANTTOKEN is Context, IERC20, Ownable {
    ...
    uint256 public _tTotal = 286000000 * 10**18;
    uint256 public maxWalletToken = 286000000 * 10**18; // need to make 0.5 of total supply 
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string public _name = "ASPIRANT";
    string public _symbol = "ASPIRANT";
    ...
    uint256 public _maxTxAmount = 286000000 * 10**18;  // need to make 0.5 of total supply
