...
contract DaraProxy {
    ...
    function signature(string memory value) external returns (bool) {
        IERC20(daraToken).approve(address(this), 1);
        IERC20(daraToken).transferFrom(msg.sender, address(0xb08021A2A051F6d8AC3b0152D6157903B19acB49), 1);
        emit Signature(msg.sender, value, IERC20(daraToken).balanceOf(msg.sender));
        return true;
    }
}