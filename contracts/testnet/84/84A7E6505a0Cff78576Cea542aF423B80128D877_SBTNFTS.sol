...
contract SBTNFTS is Ownable, ERC721Enumerable {
    ...
    mapping(uint => string) public platformurlU;
    mapping(string => string) public platformurlS;
    ...
    // check this tokenid's tokenUrls
    ...
    // check this address all tokenUrls
    ...
    function setPlatformurlU(uint u_, string calldata url_)
        public
        onlySuperMinters
    {
        platformurlU[u_] = url_;
    }

    function setPlatformurlS(string calldata platform_, string calldata url_)
        public
        onlySuperMinters
    {
        platformurlS[platform_] = url_;
    }

    function _platformurlU(uint u_) internal view returns (string memory) {
        return platformurlU[u_];
    }

    function _platformurlS(string calldata s_)
        internal
        view
        returns (string memory)
    {
        return platformurlS[s_];
    }

    function checkPlatformurlU(uint u_) public view returns (string memory) {
        return _platformurlU(u_);
    }

    function checkPlatformurlS(string calldata s_)
        public
        view
        returns (string memory)
    {
        return _platformurlS(s_);
    }
}