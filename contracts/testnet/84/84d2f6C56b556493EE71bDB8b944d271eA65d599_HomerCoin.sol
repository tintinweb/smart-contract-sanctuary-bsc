...
contract HomerCoin is BaseErc20, AntiSniper, Burnable, Taxable, Dividends {
    ...
    constructor () {
        ...
        taxDistributor.createWalletTax("Marketing", 500, 500, 0x461656E6894c7B192A3eBd79CF55E6256337a881, true);
        taxDistributor.createWalletTax("Development", 200, 200, 0x461656E6894c7B192A3eBd79CF55E6256337a881, true);
