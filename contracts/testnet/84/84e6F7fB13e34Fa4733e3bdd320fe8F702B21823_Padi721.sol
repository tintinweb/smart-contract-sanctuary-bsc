    ...
    IPadi721
{
    ...
    function safeMint(
    ...
    ) public payable override(IPadi721) {
        ...
        require(
            IWhitelist(_whitelistAddress).hasRole(
                GRANT_ROLE,
                getAddressWithSignature(_signature, _req)
            ),
            "Padi721: You don't have grant role"
        );
    ...
    function claim(address _to, string memory _ipfs) public override(IPadi721) {
    ...
    function setMintFee(uint256 _value) public {
        ...
        require(
            ...
            "Padi721: You don't have admin role"
        );
        mintFee = _value;
    }
