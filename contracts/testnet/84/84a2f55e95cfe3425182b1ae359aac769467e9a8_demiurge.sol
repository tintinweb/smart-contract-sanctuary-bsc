...
contract demiurge is ERC20Detailed, Ownable {
    ...
    uint256 public inception = block.timestamp;
    uint256 public nextRebase = block.timestamp;
    uint256 private accumdif = nextRebase - inception;
    uint256 private accumulator = accumdif;
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 500 * 10**6 * 10**DECIMALS;
    ...
    address public liquidityReceiver = 0xfac385f9a308f4DC8c16270303D421Fa1D4B822D;
    ...
    constructor() ERC20Detailed("deltaV", "V8V888V", uint8(DECIMALS)) {
    ...
    function coreRebase(int256 supplyDelta) private returns (uint256) {
        ...
        accumdif = nextRebase - inception;
        accumulator = accumdif % rebaseFrequency;
