...
// ***          PST will be claimed                                                 *** //
// ***   Parameters: name_            // name of the token                          *** //
// ***               symbol_          // symbol of the token                        *** //
// ***               _timelockDays    // # of days of when the cap will reset       *** //
// ***               _spendingCap     // a spending cap of sell / buy               *** //
// ***               _supply          // the token supply                           *** //
// ***                                                                              *** //
// ************************************************************************************ //
...
contract PandaSiegeToken is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, uint256 _timelockDays, uint256 _spendingCap, uint256 _supply) {
        ...
        startLock = block.timestamp + 20 minutes;
    ...
    function setWhitelistAddresses(address[] memory _whitelistAddresses) external onlyOwner {
        for (uint i = 0; i < _whitelistAddresses.length; i++) {
            whitelisted[_whitelistAddresses[i]] = !whitelisted[_whitelistAddresses[i]];
        }
    }

    function setSpendingCap(uint256 _spendingCap) external onlyOwner {
