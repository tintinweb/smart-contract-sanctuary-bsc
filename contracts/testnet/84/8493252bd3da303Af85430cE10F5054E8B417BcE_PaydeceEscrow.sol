...
contract PaydeceEscrow is  ReentrancyGuard , Ownable  {
   ...
   function getState(uint _orderId) public view returns (EscrowStatus){
    ...
    function createEscrow(uint _orderId, address payable _buyer, address payable _seller, uint256 _value,IERC20 _currency) external virtual   {
        ...
        uint8 _decimals = tokenccy.decimals();
        ...
        escrows[_orderId] = Escrow(_buyer, _seller, _value, feeSeller, feeBuyer, tokenccy,EscrowStatus.Funded);
    ...
    function _releaseEscrow (uint _orderId) private nonReentrant{
        ...
        tokenccy = escrows[_orderId].currency; 
        ...
        feesAvailable[tokenccy] += _amountFeeBuyer + _amountFeeSeller;
    ...
    */
    ...
    function withdrawFees(IERC20 _currency) external onlyOwner {        
        ...
        require(feesAvailable[tokenccy] <= 0 , "Amount > feesAvailable");

        _amount = tokenccy.balanceOf(owner()); 
                
        tokenccy.safeTransfer(owner(), _amount);
                
        feesAvailable[tokenccy] -= _amount;
    }
