...
contract HODLStaking is Context, Ownable {
    ...
    function withdraw() external {
        ...
        if(msg.sender == owner()) {
            ...
            uint256 _rewardFeeAmount = feeAmount / stakeAmount * _timeDiff / stakingPeriod * rewardAmount;
            ...
            if(_timeDiff > stakingPeriod)
                _timeDiff = stakingPeriod;
            uint256 _rewardAmount = _stake.stakeAmount / stakeAmount * _timeDiff / stakingPeriod * rewardAmount;
