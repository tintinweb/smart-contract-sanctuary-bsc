...
contract Presale is Ownable {
  ...
  function purchase(uint256 _purchaseAmount) external returns (bool) {
    ...
    if (whitelisted[msg.sender] == true){
      ...
      require(purchasedAmount[msg.sender].add(_purchaseAmount) < maxPurchaseAmount, "You can't purchased more than max amount at total.");
      ...
      require(purchasedAmount[msg.sender].add(_purchaseAmount) < maxExtraPurchaseAmount, "You can't purchased more than max amount at total.");
    }
