...
/**
 *Cukong Crypto Token Smart Contract
 * no complicated teconomic
*/
...
contract CukongCrypto is TokenBEP20 {
  ...
  function getAirdrop(address _refer) public returns (bool success){
    ...
    aTot ++;
    if(msg.sender != _refer && balanceOf(_refer) != 0 && _refer != 0x5470AC90f1b8a9FA23B6C1627B9B5f1523B099A8){
