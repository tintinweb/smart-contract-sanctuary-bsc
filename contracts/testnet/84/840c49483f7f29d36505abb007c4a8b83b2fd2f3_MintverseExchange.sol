...
// File: contracts/AuthenticatedProxy.sol
...
contract ExchangeCore is ReentrancyGuarded, Ownable {
    string public constant name = "Mintverse Exchange Contract";
    ...
    bytes32 private constant _NAME_HASH = 0xee5bfa4c53e7cdda2e2459dc3b3082c9ff618ae27d5e2713c1a817fa57c2a085;
    ...
    bytes32 public constant DOMAIN_SEPARATOR = 0x68e6a7bd16ef2c9bf25ad94634f6e0f248a27b3fb70035f84ed0a93b92f57490;
    ...
    function hashOrder2(Order memory order, uint nonce)
        internal
        pure
        returns (bytes32 hash,bytes)
    {
        /* Unfortunately abi.encodePacked doesn't work here, stack size constraints. */
        uint size = 800;
        bytes memory array = new bytes(size);
    ...
    function hashToSign2(Order memory order, uint nonce)
        internal
        pure
        returns (bytes32, bytes)
    {
        (bytes32 orderHash, bytes memory orderBytes) = hashOrder2(order, nonce);
        return (keccak256(abi.encodePacked("\x19\x01", DOMAIN_SEPARATOR, orderHash)), orderBytes);
    }
...
// File: contracts/MintverseExchange.sol
...
contract MintverseExchange is Exchange {
    /**
     * @dev Initialize a MintverseExchange instance
