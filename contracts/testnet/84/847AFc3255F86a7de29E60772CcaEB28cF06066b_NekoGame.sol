...
// 35% Liquidity
// 25% Pre-sale
// (Estimated Listing Price 0.000000002857)
...
contract NekoGame is ERC20, Ownable {
    ...
    uint256 public lockTokensAtAmount;          // 7% Lock wallet 3 Months() This will be used to add "Liquidity or Burnt"
    uint256 public airdropTokensAtAmount;       // Airdrop Wallet
    ...
    // lock wallet time
    uint public lockWalletInterval = block.timestamp + 3600 * 24 * 30 * 3;
    ...
    constructor() ERC20("$NKG", "NekoGame"){
        // address newOwner = address(0x94cDD0412438Aff7fA353AF01760ad84dfD88a21);
    
        uint256 totalSupply = 400 * 1e12 * 1e12;
        ...
        lockTokensAtAmount = totalSupply * 70 / 1000;           // LOCK WALLET 3 Months () This will be used to add "Liquidity or Burnt"
        airdropTokensAtAmount = totalSupply * 80 / 1000;        // 8% Airdrop Wallet
        ...
        liquidityWallet = address(0x3481A8385c34ebecb63F8Ad4D89652CbE0f6AD38);  // set as liquidity wallet
        ...
        deadWallet = address(0xb12c589Fc05b7dC4865781e9Cf3C3746b1a1F7Ce);       // set as dead wallet
        ...
        */
        ...
        transfer(deadWallet, burnTokensAtAmount);
    ...
    function updateSellFees(uint256 _burnFee, uint256 _liquidityFee, uint256 _marketingFee, uint256 _rewardsFee, uint256 _lockFee, uint256 _charityFee, uint256 _devFee) external onlyOwner {
        ...
        require(totalSellFees <= 1550, "Must keep fees at 16.5% or less");
    }
