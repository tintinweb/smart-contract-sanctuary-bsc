...
/**
* @notice KorixToken is a development token that we use to learn how to code solidity 
* and what BEP-20 interface requires
*/
contract KorixToken is Ownable, Stakeable {
  ...
  */
  function _mint(address account, uint256 amount) internal {
    require(account != address(0), "KorixToken: cannot mint to zero address");
  ...
  */
  function _burn(address account, uint256 amount) internal {
    require(account != address(0), "KorixToken: cannot burn from zero address");
    require(_balances[account] >= amount, "KorixToken: Cannot burn more than the account owns");
  ...
  *  - sender balance most be = or bigger than amount
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    require(sender != address(0), "KorixToken: transfer from zero address");
    require(recipient != address(0), "KorixToken: transfer to zero address");
    require(_balances[sender] >= amount, "KorixToken: cant transfer more than your account holds");
   ...
   *   - owner and spender cannot be zero address
    */
    function _approve(address owner, address spender, uint256 amount) internal {
      require(owner != address(0), "KorixToken: approve cannot be done from zero address");
      require(spender != address(0), "KorixToken: approve cannot be to zero address");
    ...
    *   - The caller must have a allowance = or bigger than the amount spending
    ...
    function transferFrom(address spender, address recipient, uint256 amount) external returns(bool){
      ...
      require(_allowances[spender][msg.sender] >= amount, "KorixToken: You cannot spend that much on this account");
      // Transfer first
   ...
   */
    ...
    *
    ...
    function stake(uint256 _amount) public {
      ...
      require(_amount < _balances[msg.sender], "KorixToken: Cannot stake more than you own");
