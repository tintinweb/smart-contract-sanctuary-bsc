...
contract MyNFT is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable, UUPSUpgradeable, OpenMint {
    // base uri for nfts
...
contract OpenMint is ERC721Upgradeable, OwnableUpgradeable {
    ...
    function mintToSender(bytes32[] calldata _proof, uint256 _proofAmount, uint256 _mintAmount) public payable {
        ...
        require(
            ...
            "out of public available time"
        );

        // check if still have mint quota
        require(currentQuota > 0, "not enough quota");

        // check if there is enough mint quota
        require(remainingMintAmount > 0, "there is no mint quota for fm/wl");
