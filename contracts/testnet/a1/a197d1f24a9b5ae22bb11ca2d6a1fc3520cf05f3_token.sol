...
contract token  is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0xb63B4558Ac80f71B41a1DD41571bB835560a5361); // Marketing Address
        
    address payable private liquidityAddress =
        payable(0xF7872161B1FE5689C152Aca3947Ac7dd18Fd6101); // Liquidity Address
    ...
    uint256 private constant _tTotal = 100000000000000000 * 1e18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "MalteseDoge";
    string private constant _symbol = "MalteseDoge";
    ...
    constructor() {
        address newOwner = address(0x7F3299Fe4a34C3EBED078a3Bfa42e0D7f48A1309);
