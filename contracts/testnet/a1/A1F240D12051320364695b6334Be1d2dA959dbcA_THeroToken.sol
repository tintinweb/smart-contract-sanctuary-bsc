...
contract THeroToken is IBEP20, Auth, Pausable {
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function ConvertFromInGameToken2THRAndTransfer(address recipient, uint256 amount) public returns(uint256) {
        uint256 convertedTHR = amount * 95 / 100;
        this.transfer(recipient, convertedTHR);
        return convertedTHR;
    }
}
