...
contract ExchangePool is AccessControlEnumerableUpgradeable {
    ...
    function initialize() external initializer {
        ...
        // initPrice = 1e17;
        // mai = 0x0F6eE0c5ceCEdd76D5e197C509a188dD76AB066B;
    }
    ...
    function deposit(
        ...
        uint256 effect = (amount * scales[token][method]) / 1e18;

        uint256 mintAmount;
        if (IERC20Upgradeable(mai).totalSupply() == 0) {
            mintAmount = (effect * initPrice) / 1e18;
        } else {
            mintAmount = (effect * IERC20Upgradeable(mai).totalSupply()) / totalUAmount;
        }
        totalUAmount += amount;
