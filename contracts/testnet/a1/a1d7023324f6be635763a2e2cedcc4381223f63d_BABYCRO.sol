...
/**
BABYCRO - $CRO rewards on the cronos blockchain
Hold $BABYCRO earn $CRO

https://www.babycro.fun
...
/* Token contract */
contract BABYCRO is CRC20, Auth {
    ...
    // Name and symbol
    string constant _name = "BabyCRO";
    string constant _symbol = "BABYCRO";
    ...
    uint256 public swapThreshold = _totalSupply * 1 / 10000; // 0.1% of supply
 ...
 // Exempt from dividend
    ...
    function transferForeignToken(address _token) external authorized{
        ...
        uint256 _contractBalance = CRC20(_token).balanceOf(address(this));
    ...
    event AutoLiquify(uint256 amountCRO, uint256 amountBABYCRO);
