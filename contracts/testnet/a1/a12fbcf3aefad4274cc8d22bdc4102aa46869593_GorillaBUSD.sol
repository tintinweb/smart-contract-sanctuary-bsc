...
contract GorillaBUSD is Context, Ownable , ReentrancyGuard {
    ...
    address public dev = 0x4F7c80C6e725535624C16acdCf5242c2A2dFcfb2;
    ...
    approvedWithdrawal[msg.sender] = userWithdrawal(msg.sender,aval_withdraw2); // changed from 0 to half of the amount stay in this contract
