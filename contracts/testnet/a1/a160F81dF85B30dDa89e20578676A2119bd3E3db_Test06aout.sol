...
contract Test06aout is ERC20 , ERC20Burnable, ERC20Permit, Ownable, Pausable, ERC20Snapshot, ERC20Votes, ERC20FlashMint{
    constructor() ERC20("Test06aout", "T6A") ERC20Permit("${name}") {
        _mint(0xc936d6737bEC9c7Fc80De955ad617101Ba451181, 200000 * 10 ** decimals());
