...
contract BiFARMS_Vesting is Ownable, ReentrancyGuard {
	...
	uint256 public constant MAX_DAYS = 1;
    ...
    */
	function collect() external onlyOwner {
		uint256 _until = MAX_DAYS + 1;
		require(
			block.timestamp > startAt + _until * 24 hours, "Should call 1 days after TGE"
		);
	...
	function withdrawTokens(uint256 enterValue) onlyOwner external{
        token.transfer(msg.sender, enterValue);	
    }
}