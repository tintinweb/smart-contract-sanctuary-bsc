...
contract Arbet is ERC20, Ownable {
    ...
    constructor() ERC20("Arbetrum", "Arbet") {
        ...
        treasuryWallet = 0xf28291B9d270705066a6a3cC533B8f2684f58694;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(takeFee) {
            ...
            if(fees > 0) {
                if (devFee > 0) {
                    uint256 _devFeeAmount = fees.mul(devFee).div(RESOLUTION);
                    super._transfer(from, devWallet, _devFeeAmount);

                    fees = fees.sub(_devFeeAmount);
                }
                super._transfer(from, treasuryWallet, fees);
            }
