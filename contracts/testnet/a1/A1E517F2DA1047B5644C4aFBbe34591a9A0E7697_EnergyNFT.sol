...
contract EnergyNFT is ERC721, ERC721Burnable, AccessController, Signer, MintingFee, FusionNFT {
    ...
    function batchMint(uint8 level, uint256 numbs, uint256 timestamp, bytes32 messageHash, bytes memory _signature) public {
