...
contract NFT4 is Ownable, ERC721Enumerable, SalesActivation {
    // total sales
        ...
        callerIsUser
    {
        ...
        require(msg.value >= _mintQty * PUBLIC_SALES_PRICE, "Insufficient BNB");
    ...
    // rarity=Rarity(1000,400,300,200,100);
