...
contract WW_Miner {
    ...
    constructor(address _waltAddress, address payable _owner, address payable _project, address payable _marketing) {
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        return projectFee.add(projectFee).add(marketingFee);
    }
    ...
    **/
    ...
    uint256 public OWNER = 20;
    uint256 public MARKETING = 20;
	uint256 public COMPOUND_BONUS = 50;
	uint256 public COMPOUND_BONUS_MAX_TIMES = 14;
    ...
    uint256 public WALLET_DEPOSIT_LIMIT = 5000 ether;
    uint256 PSN = 10000;
    uint256 PSNH = 5000;
