...
contract solotest is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private SWAPTOKEN = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //WBNB
    address private REWARD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //BUSD

    string constant _name = "SOLO";
    ...
    address public marketingFeeReceiver = 0xcBaC15E0eeAEC3A96D0a7032d883Aef6C02306dF;
    address public devFeeReceiver = 0x40ed85E760De8b015d13E52858527922ed3EFE4c;
    ...
    function getLastProcessedIndex() private view returns (uint256) {
        return dividendDistributor.getLastProcessedIndex();
    }

    function getNumberOfTokenHolders() private view returns (uint256) {
        return dividendDistributor.getNumberOfTokenHolders();
    }

    function totalDistributedRewards() private view returns (uint256) {
    ...
    function purgeBeforeSwitch() private onlyOwner {
    ...
    function ___claimRewards(bool tryAll) private {
