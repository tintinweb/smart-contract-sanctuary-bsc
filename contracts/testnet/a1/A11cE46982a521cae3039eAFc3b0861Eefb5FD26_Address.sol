...
contract DogTest is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DOG Test";
    string private _symbol = "$DOGT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x29cEd214afF4d7Aa2c1420C1766D4280AD571264); // Marketing Address
    address payable public DevWalletAddress = payable(0xaA73B21170B5828e8D04FA6CE33e4ECD9E31B257); // Dev Address
