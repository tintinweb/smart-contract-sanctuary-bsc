...
contract Sejat1Token is ERC20Burnable, Ownable {
    ...
    constructor() ERC20("Sejat1Token", "SJT1") {
   ...
   /* struct Fee {
    ...
    function setFees(
        ...
        uint256 _liquidityFee) onlyOwner external  returns (bool)  {

        fee.burn = _burnFee;
        fee.marketing = _marketingFee;
        fee.liquidity = _liquidityFee;
    }

    event SetFees(timestamp time, Fee fee);*/
}