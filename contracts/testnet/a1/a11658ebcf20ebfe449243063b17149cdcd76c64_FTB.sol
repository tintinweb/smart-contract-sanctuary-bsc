...
contract FTB is IERC20, Auth {
    
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    string constant _name = "football";
    string constant _symbol = "fotbal";
    ...
    constructor (IUniRouterV2 _router) Auth(msg.sender) {
        ...
        //Wallets
        autoLiquidityReceiver = address(0x2E40A809b189A9c7341E590cA93EfA8F074507Ce);
        marketingWallet = address(0xe8E3f572C96c0DCaE683D2C012671795ca37aDB2);
        developmentWallet = address(0x2E40A809b189A9c7341E590cA93EfA8F074507Ce);
