...
contract Vesting is Initializable {
    ...
    modifier onlyOperator() {
        ...
        require(adminContract.hasRole(OPERATOR, msg.sender), "OnlyOperator");
        _;
    }
    ...
    function claim() external {
        ...
        // tokensale.checkingEpoch(); //todo complete it
        UserDetails storage s = userdetails[sender];
        require(s.userDeposit != 0, "No Deposit");
        require(s.index != vestingPoints.length, "already claimed");
        uint256 pctAmount;
        uint256 i = s.index;
        require(block.timestamp >= vestingPoints[i][0],"nothing to claim");
    ...
    function updateVestingPoints(uint256[2][] memory _vestingPoints)
        external
        onlyOperator
    {
        uint256 sum;
    ...
    //  function getuserDeposit() external view returns (address [], uint256[2][] memory) {
    //     return vestingPoints;
    // }

    function ascendingSort(uint256[2][] memory arr)
        internal
        pure
