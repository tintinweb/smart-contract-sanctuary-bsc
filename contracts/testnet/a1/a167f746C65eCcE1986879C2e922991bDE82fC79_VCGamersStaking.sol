...
contract VCGamersStaking is ReentrancyGuard {
    ...
    function getStakingInfo() public view returns (uint256[] memory) {
        uint256[] memory stakingInfo = new uint256[](11);
        stakingInfo[0] = totalStakedToken;
        stakingInfo[1] = totalUnStakedToken;
        stakingInfo[2] = minimumStakeToken;
        stakingInfo[3] = maxStakeableToken;
        stakingInfo[4] = maxpoolbalance;
        stakingInfo[5] = maxaccountbalance;
        stakingInfo[6] = totalStakers;
        stakingInfo[7] = totalClaimedRewardToken;
        stakingInfo[8] = Bonus;
        stakingInfo[9] = totalFee;
        stakingInfo[10] = percentDivider;
        return stakingInfo;
    }
