...
contract GoFirstCoin is Context, IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000000000000000000000; // 100 cr
    ...
    uint256 public _maxTxAmount = 1000000000000000000000; // 1000
    uint256 public _numTokensSellToAddToLiquidity = 100000000000000000000000;
    uint256 public _maxWalletToken = 3000000000000000000000; // 3000)
    
    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = 'GoFirstCoin';
