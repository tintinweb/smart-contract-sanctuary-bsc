...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    string private _name="Farmverse Space";
    string private _symbol= "FVS";
...
contract FVS is ERC20, Ownable {
    ...
    uint16 public bnbfee=70;
        uint16 public teamFee=20;
        uint16 public lpf=30;
    ...
    uint256 public maxSellAmount = 10000000 * 10**9; 
    uint256 public maxWalletAmount = 10000000 * 10**9;
    ...
    address public  _teamWallet = payable(address(0x66A960C6D4e703f1131A34e4039cB902695C1e57)); //change youyr team wallet
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "FVS: The dividend tracker already has that address"
        );
        ...
        require(
            ...
            "FVS: The new dividend tracker must be owned by the FVS token contract"
        );
    ...
    require(newAddress != address(uniswapV2Router), "FVS: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "FVS: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "FVS: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "FVS: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "FVS: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "FVS: Cannot update gasForProcessing to same value"
        );
    ...
    function setteamWallet(address newWallet) external onlyOwner {
        require (_teamWallet != address(0), "teamWallet address can not be zero!");
        _teamWallet = payable(newWallet);
    }
    ...
    function _transfer(
        ...
        require(from != address(0), "FVS: transfer from the zero address");
        require(to != address(0), "FVS: transfer to the zero address");
        require(
    ...
    function swapAndSendToteam(uint256 tokens) private lockTheSwap {
      swapTokensForTokens(tokens, USDT, address(this));
        uint256 teamTokens = IERC20(USDT).balanceOf(address(this));
...
contract DividendLibrary is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("FVS_Dividend_Tracker", "FVS_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "FVS_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "FVS_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main FVS contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "FVS_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "FVS_Dividend_Tracker: Cannot update claimWait to same value"
        );
