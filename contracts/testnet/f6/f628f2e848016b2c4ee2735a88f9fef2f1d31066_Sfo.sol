...
contract Sfo is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress = payable(0xd0ea69edfFA0569439749fba1BBABd7d16D155Ce); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x9DaCf9A9A0D8A6bcFaDCD6fDc2FCA58C1dBe0689); // Reserve Wallet Address
    address payable public daoWalletAddress = payable(0xC2846dBEE96a5a79c3DdF1398C6fF7a446821d4C); // DAO Wallet Address
    address payable public devWalletAddress = payable(0x27C3FD838855fA27508Bfd08D07Ebfd4e197375E); // Dev Wallet Address
    ...
    string private constant _name = "Sfo 2";
    string private constant _symbol = "Sfo";
    ...
    uint256 public totalSwapableFee = _liquidityFee + _devFee + _marketingFee + _daoFee + _reserveFee;
    ...
    uint256 _saleDAOFee = 2;

    uint256 public totalSwapableSaleFee = _saleTaxFee + _saleLiquidityFee + _saleDevFee + _saleMarketingFee + _saleDAOFee + _saleReserveFee;
    ...
    uint256 public daoTokensCollected = 0;

    uint256 private minimumTokensBeforeSwap = 10*2;
    ...
    constructor () {
        address _owner = 0x978C64aF018B54b35d4ccB0ba87f43C0b26DB8DC;
    ...
    // Safu dev will renounce ownership of the token after 360 days
    ...
    {   
        ...
        uint256 walletsTotal = devTokensCollected + marketingTokensCollected + daoTokensCollected + reserveTokensCollected;
        ...
        uint256 ethForDAO = (newBalance * daoTokensCollected)/walletsTotal;
        ...
        transferToAddressETH(daoWalletAddress, ethForDAO);
    ...
    function setSaleFee() private {
        ...
        _daoFee = _saleDAOFee;
        totalSwapableFee = _liquidityFee + _devFee + _marketingFee + _daoFee; 
    }
    ...
    function countUpFeeShare(uint256 amount) private
    {
        ...
        daoTokensCollected += (amount * _daoFee)/100;
    }
    ...
    function setDAOWalletAddress(address _daoWallet) external onlyOwner() {
        require(_daoWallet != address(0), "setDAOWalletAddress: ZERO");
        daoWalletAddress = payable(_daoWallet);
        emit AuditLog("We have Updated the DAOWallet:", daoWalletAddress);
    }
