...
contract TKNStake {
    ...
    uint256[3] public Bonus = [3, 30, 100];
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address BUSD_WBNB = 0xb769fE526263Be024c8DE8962a04A745CC8b98A9; //BUSD_WBNB pancake pool address Pancake LPs (Cake-LP)
        IERC20 BUSDTOKEN = IERC20(0x3D88115F6142B11eb7be323Cb919e28fc12b1C8A); // BUSD Token address TBUSD Token (TBUSD)
        IERC20 WBNBTOKEN = IERC20(0x71B8F6F9aa3bb07A04ABD186335D354a75BFea16); // WBNB Token address
        ...
        address TKN_WBNB = 0xb769fE526263Be024c8DE8962a04A745CC8b98A9; // TKN_WBNB pancake pool address
        IERC20 TKNTOKEN = IERC20(0xA4f224219D5B47cc934320D902f835bdC2aaC5Fe); // TKN Token address 
