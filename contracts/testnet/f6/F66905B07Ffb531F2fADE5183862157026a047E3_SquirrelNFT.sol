...
contract SquirrelNFT is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Squirrel NFT", "NFTSQ") {
        setBaseURI(baseURI);
    }

    function configure(uint256 _max_per_mint) public onlyOwner {
        require(
            _max_per_mint > 0,
            "Max per mint count should be greater than zero!"
        );
