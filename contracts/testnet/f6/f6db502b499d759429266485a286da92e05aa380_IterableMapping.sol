...
contract BinanceShibaInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant BUSDRewardsFee = 7;
    ...
    address public _marketingWallet = 0x1C58891Ac4F2e139E915aA954622E8Adc981B6F3;
    ...
    constructor() public ERC20("BinanceShibaInu", "BSI") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "BSI: The dividend tracker already has that address");

        DividendTracker newDividendTracker = DividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "BSI: The new dividend tracker must be owned by the BSI token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "BSI: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "BSI: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
      require(automatedMarketMakerPairs[pair] != value, "BSI: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "BSI: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "BSI: Cannot update gasForProcessing to same value");
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            swapTokensForBUSD(marketingTokens, _marketingWallet);
    ...
    function swapTokensForBUSD(uint256 tokenAmount, address _wallet) private {
