...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     */
    function getBlackList(address account) public view virtual returns (bool) {
    ...
    function _transfer(
        ...
        require(!_blackList[sender],"Transfer forbidden");
...
contract BanERC20 is ERC20 {
    constructor() ERC20('BANToken', 'BAN' , 100*10**26) {}
}