...
contract GroundHogStaking is IERC721Receiver, Ownable {
    ...
    constructor() {
        ...
        MINIMUM_STAKING_TIME_FOR_REWARDS = 1 hours;
    ...
    function unstake(bytes32 stakeId) public {
        ...
        require(stakedNFTs[stakeId].stakedTimestamp < block.timestamp, "stake period not over");
