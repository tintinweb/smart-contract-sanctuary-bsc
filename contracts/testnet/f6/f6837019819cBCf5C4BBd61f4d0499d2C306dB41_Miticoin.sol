...
contract Miticoin is ERC20,Ownable,IMiticoin {
    ...
    function BypassMINT (uint256 Max_world) public virtual override{
       ...
       _mint(Sale,Max_world*_decimals_);
    }
    ...
    function PrimaryMINT (uint256 PrimaryTotalWorld) public virtual override {
        ...
        _mint(Contr.getZoomLoupe(),PrimaryMITI*10*_decimals_);
        _mint(Contr.getTeam(),PrimaryMITI*10*_decimals_);
        _mint(Contr.getCashback(),PrimaryMITI*35*_decimals_);
        _mint(Contr.getRsearchers(),PrimaryMITI*5*_decimals_);
        _mint(Contr.getSaleMITI(),PrimaryMITI*40*_decimals_);
        Primary=true;
    } 
    ...
    function Add_collection (uint256 MaxWorld) public virtual override  {
        ...
        require(msg.sender==Coll);
        uint256 MITI = MaxWorld*100*_decimals_;
