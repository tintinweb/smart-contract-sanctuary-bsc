...
contract GRITTOKEN is Context, IERC20, Ownable {
    ...
    address public _devWalletAddress = _msgSender();    
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 2000000000 * 10**18;
    uint256 private _rTotal = MAX - (MAX % _tTotal);
    uint256 private _tFeeTotal;
    string private _name = "GRIT Token";
    string private _symbol = "GRIT";
    ...
    constructor () {
        ...
        // testnet 0x9ac64cc6e4415144c455bd8e4837fea55603e5c3 0x10ED43C718714eb63d5aA57B78B54704E256024E
