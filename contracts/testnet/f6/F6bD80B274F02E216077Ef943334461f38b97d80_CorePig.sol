...
contract CorePig is ERC20, Ownable  {
    mapping (address => bool) private _isExcludedFromFee;

    address public constant marketAddress = 0xb305c805781a261Adac37E68f010397FDaD8224C;
    ...
    uint256 public _marketFee = 0; //市场
    uint256 private _previousMarketFeeFee = _marketFee;

    uint256 public _inviterFee = 0; //邀请
    ...
    constructor() ERC20("CorePig", "CorePig") {
