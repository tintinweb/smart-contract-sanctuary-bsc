 ...
 */
    ...
    function mintNFTByBox(address recipient, string memory _tokenURI, uint256 _type, uint256 _rarity)
        external onlyAdmin
        avaiableBox(userNumberBox[msg.sender])
        limitMaxNFT(userNumberNFT[msg.sender])
        returns (uint256)
    {
        _tokenIds.increment();
        uint256 newItemId = _tokenIds.current();
 ...
 */
    ...
    function adminAddTokenId(uint256 _type, uint256 _rarity, string memory _tokenURI)
        public
        onlyAdmin
    {
