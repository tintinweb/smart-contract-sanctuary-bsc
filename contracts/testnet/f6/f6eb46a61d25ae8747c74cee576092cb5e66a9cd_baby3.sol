...
contract baby3 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "Baby3";
    string private _symbol = "BABY3";
    ...
    uint256 public buyMarketingFee = 30; // 3%
    uint256 public buybabyFee = 30; // 3%
    uint256 public buyTeamFee = 10; // 1%
    uint256 public buyLpFee = 10; // 1%
    uint256 private dexBuyFeeTotal; // Sum of all buyfees

    uint256 public sellMarketingFee = 30; // 3%
    uint256 public sellbabyFee = 30; // 3%
    uint256 public sellTeamFee = 10; // 1%
    uint256 public sellLpFee = 10; // 1%
