...
contract SaverEarn is ReentrancyGuard, Ownable {
    IERC20 public stakingToken;
    IERC20 public rewardToken;

    // total staked balance
    uint256 public totalStakedBalance;
    // reward rate given per second, can be changed by the contract owner
    uint256 public rewardRate;
    uint256 public lastUpdateTime;
    uint256 public rewardPerTokenStored;

    // track how much a user has currently staked
    mapping(address => uint256) public userStakedBalance;
    // track total rewards paid to users
    mapping(address => uint256) public userRewardPerTokenPaid;
    // track current rewards of a user
    ...
    function updateRate(uint256 _rewardRate) public onlyOwner {
    ...
    function getTotalRewardsPaid(address account) public view returns (uint256) {
        return userRewardPerTokenPaid[account];
    }

    function getCurrentAvailableRewards(address account) public view returns (uint256) {
