...
contract Sweeth is ERC20, Ownable {
    ...
    constructor() ERC20("Sweeth", "SWEETH") {
        ...
        swapTokensAtAmount = totalSupply * 25 / 1000; // 0.025% swap amount
    ...
    function updateMaxSellAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 1000000000)/1e18, "Cannot set max sell amount lower than 0.1%");
        maxSellAmount = newNum * (10**3);
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _rewardsFee) external onlyOwner {
        ...
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyRewardsFee;
        require(buyTotalFees <= 3, "Must keep fees at 15% or less");
    }
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _rewardsFee) external onlyOwner {
        ...
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellrewardsFee;
        require(sellTotalFees <= 3, "Must keep fees at 20% or less");
    }
