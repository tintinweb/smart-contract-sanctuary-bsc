    ...
    */
    ...
    function contractSwap(uint256 numTokensToSwap) internal swapping {
        ...
        if (autoAddliquidityEnabled) {
             ...
             uint256 tokenPriceInBusd1 = getOutEstimatedTokensForTokens(address(this), busdAddress, 1000000000000000000);
             uint256 tokenPriceInBusd2 = getOutEstimatedTokensForTokens(address(this), busdAddress, 1000000000000000000);
        }
