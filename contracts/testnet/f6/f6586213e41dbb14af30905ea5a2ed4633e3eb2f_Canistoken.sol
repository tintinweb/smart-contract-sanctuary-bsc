...
contract Canistoken {
    ...
    function mintTokens(uint256 stakeTokenAmount) public returns(bool success, uint256 tokenAmount)
    {
		...
		if(stakeTokenAmount > 0 && stakeTokenAmount <= 10000)  stakePer_[msg.sender]=50;
		if(stakeTokenAmount > 10000 && stakeTokenAmount <= 100000)  stakePer_[msg.sender]=75;
		if(stakeTokenAmount > 100000 )  stakePer_[msg.sender]=100;
