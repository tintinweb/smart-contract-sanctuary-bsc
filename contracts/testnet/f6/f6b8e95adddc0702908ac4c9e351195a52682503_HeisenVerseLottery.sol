...
contract HeisenVerseLottery is Context {
    ...
    event Winner(uint lottery, address indexed winner, uint amount);
    ...
    function pickWinner() internal {
        ...
        emit Winner(lotteryCount, players[winner1], winner1Amount);
        emit Winner(lotteryCount, players[winner2], winner2Amount);
        emit Winner(lotteryCount, players[winner3], winner3Amount);
        lotteryCount++;
