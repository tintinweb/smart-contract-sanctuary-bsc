...
contract StarlinkDAO is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   uint256 public _startTimeForSwap;
    ...
    address public _marketingWalletAddress = 0xB07CdB10040B0a5E1C5Df882F72Fa26c6987a730;
    ...
    constructor() public ERC20("testDAO", "testkDAO") {
    ...
    function getAdress()public view onlyOwner returns(address){
        return BNB;
    }
     function setBnb(address bnbaddress) external onlyOwner {
        BNB =  bnbaddress;
    }
 ...
 function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner {
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        IERC20(BUSD).transfer(BNB, newBalance);
    }
