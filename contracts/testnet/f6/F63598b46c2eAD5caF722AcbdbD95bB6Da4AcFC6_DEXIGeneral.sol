...
contract DEXIGeneral is Context, IERC20, Ownable {
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //0xD99D1c33F9fC3444f8101754aBC46c52416550D1(0xcd7d16fB918511BF7269eC4f48d61D79Fb26f918);
    ...
    function _transfer(
        ...
        if (feesEnabledOnlyForSell && ((to != uniswapV2Pair)||(to != uniswapV2Pair))){
            takeFee = false;
        }
