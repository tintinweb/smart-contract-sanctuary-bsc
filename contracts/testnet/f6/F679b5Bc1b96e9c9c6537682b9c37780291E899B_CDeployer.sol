...
contract CDeployer is ICDeployer {
    ...
    function collateralCodeHash() external pure returns (bytes32) {
        return keccak256(type(Collateral).creationCode);
    }
...
import "./interfaces/IFactory.sol";
import "./interfaces/IBombPriceOracle.sol";
import "./interfaces/IBombCallee.sol";
