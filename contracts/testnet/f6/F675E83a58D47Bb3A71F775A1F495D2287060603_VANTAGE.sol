...
contract VANTAGE is IERC20, Ownable {
    ...
    string constant _name = "BTC Vantage";
    string constant _symbol = "$VANTAGE";
    ...
    // sell fees
    uint256 public sellRewardFee = 9;
    ...
    uint256 public maxWalletTokens = (_totalSupply * 1) / 100; // 0.5% of supply
    ...
    constructor() {
        ...
        address deployer = 0xbFCCbc3C7D1C3D5A6E1bFDe218D97CEe7121624d;
        ...
        marketingFeeReceiver = 0x47086D2337449BAbaFA40bDe64Bf90803Ff91051;
        stakePoolAddress = 0xd30aF5899af9ACC0a91876390Ed161E96E0A304C;
        lotteryFeeReceiver = 0xCfc73237fe626cfE1b9644C53114d82b82FD3C3B;
        gameWallet = 0x2B2616BdA09905c8f138B0cDfBC6230b4Eb674a8;
    ...
    function takeFee(
        ...
        if (to == pair) {
            ...
            // burn
            if (sellBurnFee > 0) {
                burnTokens = feeAmount.mul(sellBurnFee).div(sellTotalFees);
            ...
            // burn
            if (buyBurnFee > 0) {
                burnTokens = feeAmount.mul(buyBurnFee).div(sellTotalFees);
                _balances[DEAD] = _balances[DEAD].add(burnTokens);
                emit Transfer(sender, DEAD, burnTokens);
            }
        }
    ...
    function updateBuyFees(
        ...
        buyTotalFees = buyTotalFees.add(gamePool).add(lottery);
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellTotalFees.add(gamePool).add(lottery);

        require(sellTotalFees <= 20, "Fees can not be greater than 20%");
    }
