...
/**
 * @title SportEExchange
 * @author SportE Protocol Developers
 */
contract SportEExchange is Exchange {

    string public constant name = "SportE Exchange";
  
    string public constant version = "0.1";

    string public constant codename = "SportEBeta";
