...
contract SAS is ReentrancyGuard, Pausable, Ownable {
        ...
        returns (uint256)
    {
        ...
        uint256 _poolShare = _lockerScore.div(_totalScore);
        uint256 _rewardShare = _poolShare.mul(_totalSupply);
        uint256 apy = _rewardShare.div(locks[user][lockIdx].balance);
        return apy;
    }
