...
contract WealthUSDT2 is Context, Ownable, IERC20 {
    ...
    constructor() {
        ...
        tarifs[0] = Tarif(803, 4015);  // = 5% daily //  tarifs[0] = Tarif(36135, 72270); = 2% daily
        dev = payable(msg.sender);
		USDT = IERC20(0x0e59Af51d866832e74FB6b74D1b1a7174c03BFB5);
    }
    ...
    function Invest(address _upline, uint256 amount) external {
        ...
        uint256 shares = amount.mul(30).div(100).div(3); // 10% x 3w = 30%
