...
contract BonjourAutoPool is ContextUpgradeable, OwnableUpgradeable {
    ...
    function initialize(address _ownerAddress, address _externalAddress,readContract _bonjour) public initializer {
        ...
        bonjourToken = IBEP20(0x830BEB23d72D79dB719CfDBDf86731f96F52aB89);
        ownerAddress = _ownerAddress;
        BonjourContract = _bonjour;
        bonjourAddress = 0xc656FD21c07763f83b869ccbD57DB09779eCC017;
        currUserID = 0;
        lastuserId = 0;
        adminFee = 200;
        tokenbusdprice = 2;
        minInvestment = 10 * 1e18;
    ...
    function regUser(uint256 _amount) public {
        ...
        BusdAddress.safeTransfer(bonjourAddress, externalAmt);
    ...
    function distributeToParents(uint256 _rewardamount) internal {
      ...
      if(PoolAddress.length < 5){
          uint256 updateLength = 5 - PoolAddress.length;
          if(updateLength > 0){
        ...
        uint256 remainingAmount = (5 - PoolAddress.length) * _rewardamount;
