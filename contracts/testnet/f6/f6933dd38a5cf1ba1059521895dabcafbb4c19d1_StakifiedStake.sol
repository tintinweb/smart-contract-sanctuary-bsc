...
contract StakifiedStake is Ownable, ReentrancyGuard {
    ...
    address baseTokenAddress = 0x140b6166Befbf2f5878834f0dE6157A033Cb3bC8;
    //address baseTokenAddress = 0xd9145CCE52D386f254917e481eB44e9943F39138;
    IERC20 stakeToken = IERC20(baseTokenAddress);

    address rewardTokensAddress = 0x140b6166Befbf2f5878834f0dE6157A033Cb3bC8;
    ...
    //constructor(bool _dynamicApy, bool _unstakePenalty) {
    constructor() {
        /*
    ...
    function isStakedAlready(uint256 _stakePoolId) public view returns(bool, uint256) {
    ...
    function isStakedAlreadyByAddress(address _userAddress, uint256 _stakePoolId) public view returns(bool, uint256) {
    ...
    function stake(uint256 _stakePoolId, uint256 _amount) unpaused external returns (bool) {
        ...
        if(isStaked) {
            ...
            claimRewardsInternal(stakeId);
            
            userStake memory userStakeDetails = userStakeArray[stakeId];
            ...
            uint256 stakeIndexId = getUserStakeIndexFromUserStakeLists(_stakePoolId);

            userStake[] storage userStakeList = userStakeLists[msg.sender];
            userStakeList[stakeIndexId] = userStakeDetails;
    ...
    function claimRewardsInternal(uint256 _stakeId) internal returns (bool){
        address userStakeOwner = getUserStakeOwner(_stakeId);
        require(userStakeOwner == msg.sender,"You don't own this stake");
