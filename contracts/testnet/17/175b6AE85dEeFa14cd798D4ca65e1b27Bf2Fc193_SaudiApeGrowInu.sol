...
contract SaudiApeGrowInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0336c537bB234D11bAaFE3bFfd726CfcD3a6c35b); 
    address payable public Wallet_Dev = payable(0x830E7211737a4F1563383c2e9b84cAc13A9E1B25);
    ...
    string private constant _name = "SaudiApeGrowInu"; 
    string private constant _symbol = unicode"$SEGI"; 
    ...
    constructor () {
        ...
        _owner = 0x830E7211737a4F1563383c2e9b84cAc13A9E1B25;
    ...
    function SyncTax(uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
