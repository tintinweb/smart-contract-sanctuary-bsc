...
contract DinoMiner is Context, Ownable , ReentrancyGuard {
    ...
    constructor() {
    tokenAdress = 0xBfc45BC9F982aF83Cd8fe83C647Fbba7CA1d7251; 
    ...
    function deposit(address _ref, uint256 _amount) public noReentrant  {
        ...
        // weekly withdraw 
        uint256 weeklyStart = 0;
        uint256 deadline_weekly = 0;

        weekly[msg.sender] = weeklyWithdraw(msg.sender,weeklyStart,deadline_weekly);

        // Claim Setting
       uint256 claimTimeStart = 0;
       uint256 claimTimeEnd = 0;
    ...
    BusdInterface.setQuotas(msg.sender,aval_withdraw2);
