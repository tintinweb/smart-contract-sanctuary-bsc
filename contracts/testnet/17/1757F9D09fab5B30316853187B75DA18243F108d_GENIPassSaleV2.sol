...
contract GENIPassSaleV2 is IGENIPassSaleV2, IERC721ReceiverUpgradeable, PermissionGroupUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function getReferalPoint() public view returns (uint stone, uint topaz, uint citrine, uint ruby, uint diamond) {
        return (stonePoint, topazPoint, citrinePoint, rubyPoint, diamondPoint);
    }
