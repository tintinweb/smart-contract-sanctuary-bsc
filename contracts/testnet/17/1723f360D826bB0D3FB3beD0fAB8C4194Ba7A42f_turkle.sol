...
library Address {
     ...
     * [IMPORTANT]
     * ====
     * Woohoo!!     `* It is unsafe to assume that an address for which this function returns
...
contract turkle is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "turkle";
    string constant _symbol = "tutk";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1 * 10**8 * (10 ** _decimals);
    uint256 public _maxTxAmountBuy = _totalSupply * 5 / 1000; // 1%
    uint256 public _maxTxAmountSell = _totalSupply * 5 / 1000; // 1%
