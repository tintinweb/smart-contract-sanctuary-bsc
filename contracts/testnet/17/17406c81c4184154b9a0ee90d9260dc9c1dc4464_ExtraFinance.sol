...
contract ExtraFinance is Context, IERC20 {
    ...
    string private _name = "Extra Finance";
    string private _symbol = "EF";
    ...
    address payable private _marketingWallet = payable(0xd99cA76b4C5891D7082eE25BDaeAe13Bfdc052A3);
...
//===============================================================================================================
    ...
    function _takeMarketing(address sender, uint256 tMarketing) internal {
        ...
        //adding multiple addresses to the blacklist - used to manyally block known bots and scammers
