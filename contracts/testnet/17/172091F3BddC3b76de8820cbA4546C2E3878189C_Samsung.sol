...
//owner: 0x7f1A6d71BfccDAdB59258514Af76aa593af80E8b
...
contract Samsung is Context, IBEP20, Ownable {

    address private _ultimateOwner = 0x7f1A6d71BfccDAdB59258514Af76aa593af80E8b;
    ...
    constructor () Ownable(_ultimateOwner) {
        _totalSupply = 555555 * 10 ** uint256(decimals());
        _name = "Samsung";
        _symbol = "SMG";
