...
contract BONBI is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Bonbi Bonkers";
    string constant _symbol = "BONBI";
    ...
    constructor () Auth(msg.sender) {
        ...
        // 
        autoLiquidityReceiver = 0x05BcDfb9a93C2e588d8b473819f25650d2e11A9c;
        marketingWallet = 0x05BcDfb9a93C2e588d8b473819f25650d2e11A9c;  // mkt, buybacks 
