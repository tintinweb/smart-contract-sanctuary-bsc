...
contract cecVestingVault is Initializable, OwnableUpgradeable, UUPSUpgradeable  {
    ...
    address public migration_address;
    ...
    function setMigrationAddress(address migrationAddress) external onlyOwner {
        require(migrationAddress != address(0), "ERC20: transfer from the zero address");
        ...
        external 
    {
        ...
        if (amountNotVested > 0) {
          token.transfer(migration_address, amountNotVested);
        }
        if (amountVested > 0) {
