...
contract MonareLand is ERC721Enumerable, Ownable {
    ...
    event welcomeToMonareLand(uint256 indexed id);
    event NewPriceEvent(uint256 price);
    event NewMaxElement(uint256 max);

    constructor(string memory baseURI) ERC721("MonareLand", "MonsterMonsterNFT"){
        setBaseURI(baseURI);
    }
    ...
    function _mintAnElement(address _to, uint256 _tokenId) private {
        ...
        emit welcomeToMonareLand(_tokenId);
    }
