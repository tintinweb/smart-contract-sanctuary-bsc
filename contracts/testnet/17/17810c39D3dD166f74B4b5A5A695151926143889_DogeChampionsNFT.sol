...
contract DogeChampionsNFT is ERC721URIStorage, ERC721Enumerable
{
    ...
    function discountMint() public payable returns (uint256)
    {
        ...
        if(mintPhase.current() < 2)
        {
            require(initialMintDiscountWhitelist[msg.sender] > 0, "You are not in whitelist.");
            initialMintDiscountWhitelist[msg.sender] = initialMintDiscountWhitelist[msg.sender] - 1;
        }  
        else
        {
            require(finalMintDiscountWhitelist[msg.sender] > 0, "You are not in whitelist.");
            finalMintDiscountWhitelist[msg.sender] = finalMintDiscountWhitelist[msg.sender] - 1;
        }
