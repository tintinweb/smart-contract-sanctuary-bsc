...
contract LandCore is LandFactory{
    ...
    function createToken(uint8 _landType) public returns (uint) {
        ...
        uint _buyNum = _lt.landNumber.add(1);
        LandTypeInfos[_landType].landNumber = _buyNum;
    
        emit NewLand(msg.sender, newItemId, _landType, _lt.landPrice, _buyNum, block.timestamp);
        return newItemId;
    }
}