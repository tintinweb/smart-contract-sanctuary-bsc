...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 3800 * 10**9;

    string private _name = "CXS";
    ...
    uint256 public _maxTxAmount = 1 * 10**9;//交易限制数量
    uint256 public _maxHavAmount = 3 * 10**9;//一个地址最多持有数量
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**9;

    address public _burn = 0x000000000000000000000000000000000000dEaD;
    //0x4dB9c1F8c86B2E44Fd1b27DafdF649eFe9B9F441
    address public _market = 0x4dB9c1F8c86B2E44Fd1b27DafdF649eFe9B9F441;
    ...
    constructor() {
        ...
        emit Transfer(
            address(0x4dB9c1F8c86B2E44Fd1b27DafdF649eFe9B9F441),
            _msgSender(),
            _tTotal
        );
    }
