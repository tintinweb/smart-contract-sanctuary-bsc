...
contract BNFTVault is Ownable {
    ...
    event RewardsPercentageForTimelock(
    ...
    function setPercentageRewardForTimelock(uint256 timelock, uint256 percentageReward) 
        external 
        onlyOwner
    {
        percentageRewardForTimelock[timelock] = percentageReward;
        emit RewardsPercentageForTimelock(
            percentageReward,
            timelock
        );
    }
    ...
    function switchCanDeposit() external onlyOwner returns (bool) {
