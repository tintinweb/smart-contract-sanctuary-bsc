...
contract TESTUNIERC is Ownable, IBEP20 {
    ...
    string constant _name               = "TESTUNIERC";
    string constant _symbol             = "TESTUNIERC";
    ...
    function setTax(uint256 _liquidityFee, uint256 _marketingFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee    = _liquidityFee;
        marketingFee    = _marketingFee;
        _burnFee        = 0;
        totalFee        = _liquidityFee.add(_marketingFee).add(_burnFee);
        feeDenominator  = _feeDenominator;
        require(totalFee < feeDenominator/5, "Fees cannot be more than 10%");
    }
