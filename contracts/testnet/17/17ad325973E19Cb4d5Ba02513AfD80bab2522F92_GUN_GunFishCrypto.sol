...
contract GUN_GunFishCrypto is ERC721{
    ...
    uint public price_token_per_gun=100000*10**18;
    ...
    uint[] price_upgrade_gun_type0 = [100000*10**18,200000*10**18,300000*10**18,400000*10**18];
    uint[] price_upgrade_gun_type1 = [110000*10**18,210000*10**18,310000*10**18,410000*10**18];
    uint[] price_upgrade_gun_type2 = [120000*10**18,220000*10**18,320000*10**18,420000*10**18];
    uint[] price_upgrade_gun_type3 = [130000*10**18,230000*10**18,330000*10**18,430000*10**18];
    uint[] price_upgrade_gun_type4 = [140000*10**18,240000*10**18,340000*10**18,440000*10**18];
