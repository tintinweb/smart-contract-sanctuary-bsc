...
library Address{
 ...
 contract XWORLD is Context, IERC20, Ownable { //MAIN 0x10ED43C718714eb63d5aA57B78B54704E256024E //TEST 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    using Address for address payable;
    
    string private constant _name = "XWORLD";
    string private constant _symbol = "XWORLD";
    ...
    address public marketingWallet = 0xE72C2024B39cb79D49669dBB1e684C32a46e9d0d;
    address private devWallet = 0xE72C2024B39cb79D49669dBB1e684C32a46e9d0d;
    ...
    uint256 public swapTokensAtAmount = 66_666_666 * 10**9;
    ...
    function _takeDonation(uint256 rdeveloper, uint256 tDev) private {
        totFeesPaid.developer +=tDev;
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tDev = tAmount*temp.developer/100;
    ...
    function _getRValues1(valuesFromGetValues memory s, uint256 tAmount, bool takeFee, uint256 currentRate) private pure returns (uint256 rAmount, uint256 rTransferAmount, uint256 rRfi,uint256 rMarketing, uint256 rLiquidity){
        ...
        uint256 rdeveloper = s.tDev*currentRate;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isSell) private {
        ...
        if(s.rdeveloper > 0 || s.tDev > 0) _takeDonation(s.rdeveloper, s.tDev);
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        uint256 donationAmt = unitBalance * 2 * temp.developer;
        if(donationAmt > 0){
