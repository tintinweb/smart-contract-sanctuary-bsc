...
contract GoldenEggRunMain is ERC721Upgradeable {
    ...
    mapping(uint256 => uint256) public gooseBind;

    mapping(uint256 => uint256) public nestBind;
    ...
    function  feedTheBeans(uint256 _gooseTokenId, uint256 _nestTokenId) external {
        ...
        //Bind
        gooseBind[_gooseTokenId] = _nestTokenId;
        nestBind[_nestTokenId] = _gooseTokenId;
    }
