...
contract BaseV1Factory {
    ...
    function setShouldGasThrottleAndMaxGasPrice(bool _bool, uint256 _gas) external {
    ...
    function setAdmins(address _usdfiMaker, address _feeAmountOwner, address _admin) external {
        require (msg.sender == owner || msg.sender == admin);
