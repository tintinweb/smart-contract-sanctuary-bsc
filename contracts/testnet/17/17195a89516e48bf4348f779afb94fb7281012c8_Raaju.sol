...
contract Raaju is ERC20Capped, ERC20Burnable, Ownable {

    string private _name;

    constructor() ERC20("Raaju", "RAJ") ERC20Capped(500000000 * 10 ** decimals()) {
        _name = "Raaju";
        ERC20._mint(msg.sender, 500000000 * 10 ** decimals());
    }
