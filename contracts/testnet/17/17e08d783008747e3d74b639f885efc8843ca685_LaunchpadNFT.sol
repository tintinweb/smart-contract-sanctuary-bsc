    ...
    ReentrancyGuardUpgradeable
{
     ...
     */
    function buyNFT(uint256 _launchIndex, address _dealToken, uint256 amount)
        public
        payable
        nonReentrant
        whenNotPaused
        returns (uint256, uint256)
    {
        ...
        emit Buy(_launchIndex, msg.sender, amount);

        return (_launchIndex, amount);
    }
