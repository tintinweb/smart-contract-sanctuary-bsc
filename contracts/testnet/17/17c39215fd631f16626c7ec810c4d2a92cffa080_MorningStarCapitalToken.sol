...
/**
 ...
 __   __  _______  ______    __    _  ___   __    _  _______  _______  _______  _______  ______      _______  _______  _______  ___   _______  _______  ___     
|  |_|  ||       ||    _ |  |  |  | ||   | |  |  | ||       ||       ||       ||   _   ||    _ |    |       ||   _   ||       ||   | |       ||   _   ||   |    
|       ||   _   ||   | ||  |   |_| ||   | |   |_| ||    ___||  _____||_     _||  |_|  ||   | ||    |       ||  |_|  ||    _  ||   | |_     _||  |_|  ||   |    
|       ||  | |  ||   |_||_ |       ||   | |       ||   | __ | |_____   |   |  |       ||   |_||_   |       ||       ||   |_| ||   |   |   |  |       ||   |    
|       ||  |_|  ||    __  ||  _    ||   | |  _    ||   ||  ||_____  |  |   |  |       ||    __  |  |      _||       ||    ___||   |   |   |  |       ||   |___ 
| ||_|| ||       ||   |  | || | |   ||   | | | |   ||   |_| | _____| |  |   |  |   _   ||   |  | |  |     |_ |   _   ||   |    |   |   |   |  |   _   ||       |
|_|   |_||_______||___|  |_||_|  |__||___| |_|  |__||_______||_______|  |___|  |__| |__||___|  |_|  |_______||__| |__||___|    |___|   |___|  |__| |__||_______|
...
contract MorningStarCapitalToken is ERC20, ERC20Burnable, Pausable, AccessControl {
    ...
    constructor(address owner_, string memory name_, string memory symbol_, uint8 decimals_, uint256 supply_, uint256 cap_, bool isBurnable_) ERC20(name_, symbol_) {
        require(decimals_ <= 18, "MorningStarCapitalToken: decimals has to be lower or equal than 18");
        _decimals = decimals_;
        _cap = cap_;
    ...
    function burn(uint256 amount) public virtual override {
        require(_isBurnable, "MorningStarCapitalToken: burn option is deactivated");
        super.burn(amount);
    }
