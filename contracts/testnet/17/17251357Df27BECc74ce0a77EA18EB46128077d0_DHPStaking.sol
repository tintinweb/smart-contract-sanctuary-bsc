...
contract DHPStaking is Ownable, ReentrancyGuard {
    ...
    function initialize(
        ...
        lockups.push(Lockup(0, 7, 0, 300, 951293759, 0, 0, 0)); // 1% liquidity
        lockups.push(Lockup(1, 15, 0, 300, 1426940638, 0, 0, 0)); // 1.5% liquidity
        lockups.push(Lockup(2, 30, 0, 300, 1902587518, 0, 0, 0)); // 2% liquidity
        lockups.push(Lockup(3, 90, 0, 300, 1902587518, 0, 0, 0)); // 2.5% liquidity
