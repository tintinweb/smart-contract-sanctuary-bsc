...
contract BEP20Token is Context, IBEP20, Ownable ,blacklists {
  ...
  address marketing = 0x954b19b14E49296102a7F86BDA5d46253B529394;
  uint256 Fee;
  mapping (address => mapping (address => uint256)) private _allowances;
   uint256 maxWallet = 100 ;
  ...
  */
  ...
  function transfer(address recipient, uint256 _amount) external returns (bool) {
      //  require(_balances(recipient) + _amount <= maxWallet, "Max holding cap breached.");
