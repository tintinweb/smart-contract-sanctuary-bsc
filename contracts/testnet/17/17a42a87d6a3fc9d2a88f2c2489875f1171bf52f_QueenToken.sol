...
contract QueenToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        dividendTracker = new TokenDividendTracker(rewardAddr_, tokenBalanceForReward_);
    ...
    function setMaxBuyAmount(uint256 val_) external onlyOwner{
        maxBuyAmount = val_;
    }
    function setMaxSellAmount(uint256 val_) external onlyOwner{
        maxSellAmount = val_;
    }
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if(automatedMarketMakerPairs[to]){
                require(amount <= maxSellAmount , "Invalid Amount");
