...
contract PiFinance is Context, IERC20, Ownable {
    ...
    string private _name = "PiFinance";
    string private _symbol = "PIFI";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0x162BC195d187D724dd80C345E2fBAB5Ab030c5B4);
    address payable public teamWalletAddress = payable(0x42A995F20e14c15027b7Aa051ccF4f55Fb210E79);
