    ...
    ERC2981PerTokenRoyalties
{
    ...
    constructor(string memory _initBaseURI, string memory _initwinnerURI, string memory _initpendingURI) ERC721("LuckyNFT", "LUCKY") {
  ...
  */
    ...
    function Mintforowners(address _to, uint256 _count) external onlyOwner{
