...
contract NFT421 is ERC721Enumerable, Ownable, Adminable {
    ...
    //todo test
    function setConfigs(address _nft, address _token) external  onlyMaster{
        tokenAddress = _token;
    ...
    function mint(
        ...
        require(
            checkNftTypeOwner(msg.sender, _id1, _id2, _id3, _id4),
    ...
    function checkNFTValid(
        ...
        return
            checkNftTypeOwner(_addr, _id1, _id2, _id3, _id4) &&
