...
contract Marketplace is Ownable {
    ...
    function updatePrice(
        ...
        require(_msgSender() == orders[orderId_].seller, "NFTMarketplace: Sender must be owner");
        require(newPrice_ > 0, "Marketplace: Price must be bigger than 0");
        uint256 _oldPrice = orders[orderId_].price;
        orders[orderId_].price = newPrice_;
        emit PriceUpdated(orderId_, _oldPrice, newPrice_);
    }
}
