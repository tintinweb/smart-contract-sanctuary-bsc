...
import "./utils/PausePure.sol";

contract ZTokenPure is ERC20, PausePure {
    ...
    function _transfer(
        ...
        if (
            ...
            ERC20._transfer(sender, _collector, fee);
        }
    }
...
import "./RolesPure.sol";

abstract contract PausePure is Pausable, RolesPure {
