...
contract LegendaryFoxNFT is ERC721Enumerable, Ownable, Guard, RI, Withdrawable {
    ...
    constructor(address riAddress_) ERC721("Legendary Fox NFT V1", "LFOX V1")
    {
        royaltyAddress = riAddress_;

        string memory baseTokenURI = "https://legendaryfox.io/meta/lfox/";
        string memory baseContractURI = "https://legendaryfox.io/meta/lfox/main.json";
