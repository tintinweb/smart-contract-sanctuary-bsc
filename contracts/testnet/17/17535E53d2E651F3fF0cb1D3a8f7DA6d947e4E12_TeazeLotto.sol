...
contract TeazeLotto is Ownable, Authorized, ReentrancyGuard {
    ...
    uint16 winningRoll = 499; //adjustable roll # so SBX win % can be 50/50 
    ...
    constructor(address _farmingContract, address _router, address _pair, address _inserter, address _oracle, uint16 _winningRoll) {
