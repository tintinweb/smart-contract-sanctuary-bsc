         ...
         if (_level==1)
            {
              ...
              fin[_level].total_entry = 100;
              fin[_level].multiple_entry=10;
              fin[_level].time=_time + 7 days;
             ...
             else  if (_level==12)
            {
              ...
              fin[_level].time=_time + 180 days;
              fin[_level].currenttime=block.timestamp;
             ...
             else  if (_level==13)
            {
              ...
              fin[_level].time=_time + 270 days;
              fin[_level].currenttime=block.timestamp;
             ...
             else  if (_level==14)
            {
              ...
              fin[_level].time=_time + 300 days;
              fin[_level].currenttime=block.timestamp;
             ...
             else  if (_level==15)
            {
              ...
              fin[_level].time=_time + 360 days;
              fin[_level].currenttime=block.timestamp;
             ...
             else  if (_level==16)
            {
              ...
              fin[_level].time= _time + 365 days;
              fin[_level].currenttime=block.timestamp;
