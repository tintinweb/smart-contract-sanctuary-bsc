...
contract FlipCoin is VRFConsumerBaseV2, Ownable {
    ...
    uint256 public totalRemainBalance;
    ...
    function flip(uint256 bet) public payable returns(uint256 requestID) {
        ...
        uint256 neededBalance = address(this).balance - betAmount * 2 -fee - totalRemainBalance; // balance need to pay for player
        require(neededBalance >= 0, "FlipCoin: Insufficient account balance");
