...
contract GenesisBill is Initializable, PolicyUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    ITreasury public customTreasury; // pays for and receives principal
    ...
    function initialize(
        ...
        customTreasury = ITreasury(_config[0]);
        payoutToken = IERC20MetadataUpgradeable(ITreasury(_config[0]).payoutToken());
