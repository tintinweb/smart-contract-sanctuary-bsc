...
// File: contracts/interfaces/IafriPay.sol
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the afriPay lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == afriPay, "Only afriPay");
    ...
    /**
     * @notice Set the address for the afriPay
     * @param _afriPay: address of the afriPay lottery
     */
    function setLotteryAddress(address _afriPay) external onlyOwner {
        afriPay = _afriPay;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IafriPay(afriPay).viewCurrentLotteryId();
    }
}