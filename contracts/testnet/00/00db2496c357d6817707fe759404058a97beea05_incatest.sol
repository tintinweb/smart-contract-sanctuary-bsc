...
contract incatest is IBEP20, Auth {
    ...
    string constant _name = "incatest";
    string constant _symbol = "incatest";
    ...
    address private Ecosystem = 0x4ef8731E84a2f13249AF3CCe95EFC9DbCa3a1845;
    address private teamFeeReceiver = 0x4553825CA44FE9a40540b509D12Ad78F1110eD61;
    ...
    function swapBack() internal swapping {
        ...
        (bool MarketingSuccess, /* bytes memory data */) = payable(Ecosystem).call{value: amountBNBMarketing, gas: 30000}("");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFeeReceiver(address _Ecosystem, address _teamFeeReceiver) external authorized {
    ...
    function manualSend() external authorized {
        ...
        payable(Ecosystem).transfer(contractETHBalance);
    }

    function transferForeignToken(address _token) public authorized {
        require(_token != address(this), "Can't let you take all native token");
        uint256 _contractBalance = IBEP20(_token).balanceOf(address(this));
        payable(Ecosystem).transfer(_contractBalance);
    }
