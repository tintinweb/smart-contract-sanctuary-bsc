...
contract Matrix is ERC20PresetMinterPauser, TransactionThrottler {
    constructor() public ERC20PresetMinterPauser('Matrix TEST token', 'MTT') {}

    function _beforeTokenTransfer(
        address from,
        address to,
        uint256 amount
    ) internal virtual override(ERC20PresetMinterPauser) transactionThrottler(from, to, amount) {
        super._beforeTokenTransfer(from, to, amount);
    }
}