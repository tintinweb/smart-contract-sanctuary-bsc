...
contract DistributeAmounts is OwnableUpgradeable, ReentrancyGuardUpgradeable, IAmountsDistributor {
    ...
    event DistributionReceiverAddressesSet(address[11] indexed nftContractAddresses);
    ...
    function setDistributionReceiverAddresses(address[11] calldata _distributionReceiverAddresses) external onlyOwner {
