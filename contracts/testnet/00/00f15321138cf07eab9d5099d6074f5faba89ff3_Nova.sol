...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // router 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
      uniswapV2Router = _uniswapV2Router; 
 
      // Mainnet
 
      rewardTokens.push(address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd)); // WETH mainnet - 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2
  ...
  function distributeDividends() public override payable { 
    ...
    if(nextRewardToken == address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd)) {
...
contract Nova is ERC20, Ownable {
    ...
    constructor() ERC20("Nova", "Nova") {
    	...
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
