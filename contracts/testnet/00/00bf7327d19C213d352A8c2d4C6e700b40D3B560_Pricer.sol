...
contract Pricer {
    ...
    uint basis = 1e12; // 1,000,000,000,000= 100%
    ...
    */
    ...
    function getLpTokens(address lp) public view returns(address token0, address token1){
    ...
    function getLpTokensAmount(address lp, uint amountLp, address router) public view returns (address token0, uint amount0, address token1, uint amount1){
        address factory = getFactory(router);
        (address tokenA, address tokenB) = getLpTokens(lp);
        UniswapV2LiquidityMathLibrary.getLiquidityValue(factory, tokenA, tokenB, amountLp);
    }
