...
abstract contract Ownable is Context {
    ...
    function setAuthorized(address account) public onlyOwner {
        _authorized[account] = true;
    }
}

contract LostMetasAntiBot is Ownable {
    uint256 private timeAntiBot = 180;
    ...
    function checkAntiBotStatus() external view onlyAuthorized returns (bool, bool) {
        ...
        bool isBlacklist = !isBot && block.timestamp <= launchTime + timeAntiBot + 100;
