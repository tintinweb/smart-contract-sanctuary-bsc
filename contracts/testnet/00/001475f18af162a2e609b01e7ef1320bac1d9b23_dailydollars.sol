...
contract dailydollars is notConation {
    ...
    function packageactiveself(uint256 _amount, address[] memory _incleveladd, uint256[] memory _inclevelcomm, address[] memory _incleadadd, uint256[] memory _incleadbonus, uint256 _selfleadbonus, uint256 _lepsCommission) external payable {
    ...
    function packageactivedownline(uint256 _reamount, uint256 _actInvestment, address[] memory _incleveladdress, uint256[] memory _inclevelcommission, address[] memory _incleadaddress, uint256[] memory _incleadbonuses, uint256 _selfleadbonuses, uint256 _lepsCommission1) external payable {
        require(users[msg.sender].is_exist == true,  "User not Exist");
