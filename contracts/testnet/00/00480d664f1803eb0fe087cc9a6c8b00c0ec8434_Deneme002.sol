...
contract Deneme002 is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x6b75A2418B9607AB551a570B51bD571661E686c3;

    string constant _name = "Deneme002";
    string constant _symbol = "DNM2";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 101000000000 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = (0xC502d0Ae13d746d6712Ae4B8C502a04E09f29abb);
        devFeeReceiver = (0x6b75A2418B9607AB551a570B51bD571661E686c3);
