...
contract DLCStaking is Ownable,ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 public emergencyWithdrawFess = 2000; // 20% ~ 200
    uint256 public WithdrawFee = 500;
    uint256 public adminFee = 500;
    uint256 public totalRewardPending;
    address public feesRecevier = 0x5f1EDcb4cE0f4FB800DFE2EA8a6e586C636612B2;
    ...
    uint256 public MIN_REWARD_AMOUNT = 20000000000000000000;
    ...
    */
    ...
    constructor(
      ...
      uint256[] memory _levelRate
        ...
        pooldata[30].returnPer = 3150; // 30%

        //90 days
        pooldata[60].lockupDuration = 60;
        pooldata[60].returnPer = 6600; // 50%

        //180 days

        pooldata[90].lockupDuration = 90;
        pooldata[90].returnPer = 10800; // 80%

        //365 days
        pooldata[180].lockupDuration = 180;
        pooldata[180].returnPer = 26100; // 120%

        pooldata[365].lockupDuration = 365;
        pooldata[365].returnPer = 67525; // 120%
