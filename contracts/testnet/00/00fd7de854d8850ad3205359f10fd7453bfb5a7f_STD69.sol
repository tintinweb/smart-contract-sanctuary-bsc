...
contract STD69 is IBEP20, Ownable {

    address private WETH;

    string private constant _name = "STD69";
    string private constant _symbol = "STD69";
    uint8 private constant _decimals = 6;
    
    uint256 _totalSupply = 42069420 * (10 ** _decimals);
    uint256 maxTx = 1000000 * (10 ** _decimals);
    uint256 maxWallet = 1000000 * (10 ** _decimals);
    ...
    address public marketingWlt = payable(0x383767deb1E0BCcb650A8B440E8FF28884EcCe6F);
    ...
    function preLaunchSequence() external onlyOwner {
    	require(airdrop == 0, "Already launched");
    	tradingOpen = true;
    	airdrop = 1;
    }
    ...
    function launch(uint _pause) external onlyOwner {
	if (airdrop == 2 && launchedAt == 0){
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!bots[sender] && !bots[recipient], "DENIED");
