...
contract BEP721 is Context, ERC165, IBEP721, IBEP721Metadata {
    ...
    function _safeMint(address to,uint256 tokenId,bytes memory data) internal virtual {
        _mint(to, tokenId);
        require(_checkOnBEP721Received(address(0), to, tokenId, data),"BEP721: transfer to non BEP721Receiver implementer");
    }
...
contract NFTCollection is BEP721 {
    struct NFT {
        string name;
        string URI;
    }
    ...
    NFT[] private allNFTs;
    constructor() BEP721("NFT Collection", "NFTC") {}
...
contract NFTAuction is IBEP721Receiver {
