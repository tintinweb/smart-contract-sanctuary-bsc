...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6936a40640C3A160f63936FD85f79cf9af61d338;
...
contract Fiji1 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x92eaD1BAa69C08901F5Ed1d8A09294F0a86B8B75;
	address private _burnWalletAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Fiji1";
    string private _symbol = "FIJI";
    ...
    function _transfer(
		...
		uint256 recipientBalance = _rOwned[to].div(_getRate());
        if(from != owner() && to != owner())
            require(amount <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount.");
		if(from != owner() && to != owner())	
			require((recipientBalance + amount) <= (_maxTxAmount / 500), "Sorry, nobody can own more than 0.2% of the total supply.");
