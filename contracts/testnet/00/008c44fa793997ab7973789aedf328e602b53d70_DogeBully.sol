...
contract DogeBully is ERC20 {
	...
	address payable _receive = payable(address(0xD4F9D82D8f299EE9ABDC571E46E0a3f852aa396f));
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("DogeBully", "DogeBully") {
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            super._transfer(from, address(this), amount.mul(8).div(100));
