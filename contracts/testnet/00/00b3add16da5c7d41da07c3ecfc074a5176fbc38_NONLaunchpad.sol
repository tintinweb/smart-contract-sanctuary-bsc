...
contract NONLaunchpad is Ownable, ReentrancyGuard, Pausable {
    ...
    function registerLaunchpadProxy(address proxy) external onlyOwner {
        ...
        require(
            ...
            NONLaunchpadEnums.PROXY_ID_ALREADY_EXIST
        );
    ...
    function launchpadBuy(
        ...
        require(proxy != address(0), NONLaunchpadEnums.PROXY_ID_NOT_EXIST);
    ...
    // open nft from this launchpad (reset baseURI)
    ...
    function rescueETH(address recipient) external onlyOwner {
        ...
        require(success, NONLaunchpadEnums.TRANSFER_ETH_FAILED);
    }
