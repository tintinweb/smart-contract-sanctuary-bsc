...
contract BNB1 {
    ...
    uint32 constant internal DEPOSIT_PERIOD = 60*60*24; //365 Days
    uint8 constant internal DEPOSIT_RATE = 25; //25% 

    uint256 constant internal MIN_DEPOSIT = 0.0001 ether;
    uint256 constant internal MAX_DEPOSIT = 50 ether;

    address constant internal FEE_ADDRESS = 0x461E1426504adcE355F6616CEE98a14A8e4f8c85;
    uint8 constant internal DEPOSIT_FEE = 15;
    uint8 constant internal WITHDRAW_FEE = 10;

    address constant internal DEFAULT_REFERRER = 0x461E1426504adcE355F6616CEE98a14A8e4f8c85;
