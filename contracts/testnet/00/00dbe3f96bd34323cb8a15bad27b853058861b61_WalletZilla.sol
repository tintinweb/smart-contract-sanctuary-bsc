...
event referalIncome(address userWoGotIncome,uint256 referalincome, address refealaddress  );
    ...
    function InvestBusd (  uint256 amtInvest , uint256 refBy)  public {
        ...
        if(UserDetail[msg.sender].userRefferdBy == 0){
            ...
            // UserDetail[IdToAddress[refBy]].totalTeamBusiness += amtInvest; 
                ...
                UserStakingDetail[msg.sender].expTime = block.timestamp+1500;
          ...
          uint256   totalIncomeWithoutRoi =   UserDetail[_userAddr].totalIncentiveEarned + UserDetail[_userAddr].amountEarnedByRef  + UserStakingDetail[_userAddr].userLastTimeAmountTotalRewardClaimed  +  UserRoyalityDetail[_userAddr].dailyTopFiveIncome + UserRoyalityDetail[_userAddr].userSeniorManagerIncome + UserRoyalityDetail[_userAddr].usermanagerIncome  ;
            uint256 totalPercent =  (UserDetail[_userAddr].userLastAmountInvested*300)/100;
                ...
                if( UserStakingDetail[_userAddr].expTime < block.timestamp ){
                        ...
                        uint256 profit =  (UserDetail[_userAddr].userLastAmountInvested*300/(60*25)*1e18)/100;
    ...
    function ClaimReward  () public {
        ...
        if(UserStakingDetail[msg.sender].timeofLastWithdrwal + 180 < block.timestamp){
    ...
    //  function SetRoyalityIncome (address userAddr ,uint256 _managerIncome ,uint256 _seManagerIncome, uint256 _dailyTopFiveReward) public {
    //        uint256 ProfitValueRemaining = checkProfitForincomeAddition(userAddr);



    //      UserRoyalityDetail[userAddr].usermanagerIncome += _managerIncome;
    //      UserRoyalityDetail[userAddr].userSeniorManagerIncome += _seManagerIncome;
    //      UserRoyalityDetail[userAddr].dailyTopFiveIncome += _dailyTopFiveReward;
    //  } 
            
         function SetManagerIncome (address userAddr ,uint256 _managerIncome ) public {
                ...
                if(ProfitValueRemaining!=0){   
                    if(ProfitValueRemaining >= _managerIncome){
                       UserRoyalityDetail[userAddr].usermanagerIncome += _managerIncome;
                           ...
                           UserRoyalityDetail[userAddr].usermanagerIncome +=  _managerIncome - extra;
                        }
                        }
        } 


     function SetSenManagerIncome (address userAddr ,uint256 _seManagerIncome) public {
                ...
                if(ProfitValueRemaining!=0){
                    if(ProfitValueRemaining >= _seManagerIncome){
                       UserRoyalityDetail[userAddr].userSeniorManagerIncome += _seManagerIncome;
                           ...
                           UserRoyalityDetail[userAddr].userSeniorManagerIncome +=  _seManagerIncome - extra;
                        }
                 }
        } 

        function SetdailyTopFiveReward (address userAddr , uint256 _dailyTopFiveReward) public {
            ...
            if(ProfitValueRemaining!=0){
                    if(ProfitValueRemaining >= _dailyTopFiveReward){
                       UserRoyalityDetail[userAddr].dailyTopFiveIncome += _dailyTopFiveReward;
                           ...
                           UserRoyalityDetail[userAddr].dailyTopFiveIncome +=  _dailyTopFiveReward - extra;
                        }
            }            
        } 
