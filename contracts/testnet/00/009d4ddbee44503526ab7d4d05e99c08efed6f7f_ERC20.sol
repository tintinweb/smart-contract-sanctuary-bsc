...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9095035Be2E82b49cab8A6b36bb3982C51E8bC62;
...
contract TestToken8 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TestToken8", "TTY8") {
        ...
        buyTotalFees = buyTaxFee + buyLiquidityFee + buyMarketingFee;
        
        sellTaxFee = _sellTaxFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellMarketingFee = _sellMarketingFee;
        sellTotalFees = sellTaxFee + sellLiquidityFee + sellMarketingFee;
        
        taxWallet = address(0x840da8b37cF72893b8f43841D0fc33Fe95EC88D9); // set as tax wallet
        devWallet = address(0xdB0a24dC8a6eABfa8E412748567C4288EC97Ff8c); // set as dev wallet
    ...
    function updateBuyFees(uint256 _taxFee, uint256 _liquidityFee, uint256 _marketingFee) external onlyOwner {
        buyTaxFee = _taxFee;
    ...
    function updateSellFees(uint256 _taxFee, uint256 _liquidityFee, uint256 _marketingFee) external onlyOwner {
        sellTaxFee = _taxFee;
    ...
    function _transfer(
        ...
        require(!pause || from == owner(), "Trading is paused");
         if(amount == 0) {
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForTax + tokensForDev;
        bool success;
        ...
        uint256 ethForLiquidity = ethBalance - ethForTax - ethForDev;
