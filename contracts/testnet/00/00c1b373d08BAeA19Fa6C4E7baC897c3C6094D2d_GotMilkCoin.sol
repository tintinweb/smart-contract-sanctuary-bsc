...
contract RWRD_DISTRIBUTOR is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // RWRD TESTNET
...
contract GotMilkCoin is Context, IBEP20, Ownable, ReentrancyGuard{ 
    ...
    address RWRD                            = (0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // RWRD TESTNET
    address WBNB                            = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // WBNB TESTNET
    address zeroAddress                     = 0x0000000000000000000000000000000000000000;
    address burnAddress                     = 0x000000000000000000000000000000000000dEaD;
    address devAddress                      = 0xBBf53C81eD11328Fd870797c69a497302Da83cdc;
    ...
    uint256 private _transferCooldown = 0;

    RWRD_DISTRIBUTOR distributor; 
    uint256 distributorGas = 500000;

    bool public swapEnabled = true;
    uint256 public _TxAmount = _totalSupply / 100; //1% (10,000,000)
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(amount <= _TxAmount || isTxLimitExempt[sender], "Max token limit for this trade exceeded. Try a lower amount.");
        ...
        require(isTimeLockExempt[sender] || block.timestamp >= _transactionCheckpoint[sender] + _transferCooldown,
        "Wait for transaction cooldown time to end before making a transaction.");
        require(isTimeLockExempt[recipient] || block.timestamp >= _transactionCheckpoint[recipient] + _transferCooldown,
        "Wait for transaction cooldown time to end before making a transaction.");
    ...
    function setTimeLock(uint256 transactiontime) public onlyOwner {
        _transferCooldown = transactiontime;
    }

    function setTxLimit(uint256 amount) external onlyOwner {
        _TxAmount = amount.mul(10**_decimals);
    }
    ...
    function setIsExcludedFromTransactionCooldown(address holder, bool exempt) public onlyOwner {
    ...
    function setFees(uint256 _reflectionFee, uint256 _marketingFee, uint256 _devFee, uint256 _liquidityFee, uint256 _feeDenominator) external onlyOwner {
        ...
        require(totalBNBFee < feeDenominator, "Fees cannot be more than 25%");
    }
    ...
    function setRWRDDistributionCriteria(uint256 _minPeriod, uint256 _minDistribution) external onlyOwner {
