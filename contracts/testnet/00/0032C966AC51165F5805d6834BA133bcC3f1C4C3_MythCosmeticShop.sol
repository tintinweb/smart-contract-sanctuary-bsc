...
contract MythCosmeticShop {
    ...
    function unlockFreeCosmetics(address _cosmeticAddress) external {
        require(msg.sender == owner, "only owner");
        MythDegen tempDegen = MythDegen(degenAddress);
        ...
        tempBackgrounds[4] = 5;
        tempBackgrounds[5] = 6;
        tempDegen.setFreeCosmetics(_cosmeticAddress, 0, 6, tempBackgrounds);
        ...
        tmpEyes[8] = 20;
        tmpEyes[9] = 21;
        tempDegen.setFreeCosmetics(_cosmeticAddress, 1, 10, tmpEyes);
        ...
        tmpMouth[8] = 9;
        tmpMouth[9] = 10;
        tempDegen.setFreeCosmetics(_cosmeticAddress, 2, 10, tmpMouth);
        uint256[10] memory tmpNose;
        tmpNose[0] = 1;
        tmpNose[1] = 2;
        tmpNose[2] = 3;
        tempDegen.setFreeCosmetics(_cosmeticAddress, 3, 3, tmpNose);
        ...
        tmpBodyColor[4] = 5;
        tmpBodyColor[5] = 6;
        tempDegen.setFreeCosmetics(_cosmeticAddress, 4, 6, tmpBodyColor);
        ...
        tempBody[5] = 117;
        tempBody[6] = 118;
        tempDegen.setFreeCosmetics(_cosmeticAddress, 5, 7, tempBody);
        ...
        tempHead[5] = 118;
        tempHead[6] = 119;
        tempDegen.setFreeCosmetics(_cosmeticAddress, 6, 7, tempHead);
    }
}
