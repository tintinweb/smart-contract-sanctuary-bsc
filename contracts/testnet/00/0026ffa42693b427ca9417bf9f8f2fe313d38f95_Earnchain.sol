...
contract Earnchain {
    ...
    uint[] public memberChain;
    uint[] public referralChainFirst;
    uint[] public referralChainTwo;
    uint[] public referralChainThree;
    uint[] public leaderBronze;
    uint[] public leaderSilver;
    uint[] public leaderGold;
