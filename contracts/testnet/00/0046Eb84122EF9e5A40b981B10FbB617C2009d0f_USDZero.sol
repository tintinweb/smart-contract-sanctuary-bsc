...
contract USDZero is IERC20, Owned, SafeMath {
    ...
    function buyPresale(uint tokens) public returns (bool success) {
        ...
        require(isContract(msg.sender) == false, "Presale: contracts cannot buy");
        usdc.transferFrom(msg.sender, dead, tokens * (10**(18-6)));
        balances[address(this)] = safeSub(balances[address(this)], tokens);
    ...
    function transferAnyERC20Token(address tokenAddress, uint tokens) public onlyOwner returns (bool success) {
        require(tokenAddress != address(this), "Presale: owner cannot transfer out presale tokens");
