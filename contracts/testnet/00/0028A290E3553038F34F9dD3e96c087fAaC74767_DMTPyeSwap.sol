...
contract DMTPyeSwap is Context, IPYE, Ownable {
    ...
    {
        uint256 performance = calculateFee(tAmount, _defaultFees.performanceFee);
        uint256 reward = calculateFee(tAmount, _defaultFees.rewardFee);
        uint256 liquidity = calculateFee(tAmount, _defaultFees.liquidityFee);
        uint256 burn = calculateFee(tAmount, _defaultFees.burnFee) ;
