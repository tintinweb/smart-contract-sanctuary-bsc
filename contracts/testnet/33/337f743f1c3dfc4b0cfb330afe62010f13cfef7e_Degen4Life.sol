...
//Contract
contract Degen4Life is IBEP20, Ownable {
    ...
    string private constant _name = 'Degen4Life';  
    string private constant _symbol = 'D4L';    
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 420 * 10**_decimals;
    uint256 public _circulatingSupply=_totalSupply;    
    uint8 private constant MaxWalletDivider=100; //1% 
    uint16 private constant SellLimitDivider=100; //1% 
