...
contract AlexQueToken is ERC20, Ownable {
    ...
    address public receiveFeeWallet = 0xDC0cFF6D9e21C7c07Be86c373775907B94f158FA;
    ...
    constructor () ERC20("AlexQueToken", "AQT", 8, 2100000 * 10 ** 8){
        address msgSender = _msgSender();
    ...
    function _transfer(address sender, address recipient, uint amount) internal override {
        ...
        bool freeOfCharge = sender == address(this) || sender == _owner || sender == receiveFeeWallet || recipient == address(this) || recipient == _owner || recipient == receiveFeeWallet;
        if (!freeOfCharge) {
            ...
            if (currentBalance > 0 && !swaping && sender != pancakePair) {
                swaping = true;
                _swapTokensForUsdt(currentBalance, receiveFeeWallet);
                swaping = false;
            }
        }
