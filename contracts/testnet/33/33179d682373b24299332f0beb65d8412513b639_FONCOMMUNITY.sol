...
contract FONCOMMUNITY is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FON COMMUNITY";
    string constant _symbol = "FONc";
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        ...
        devFee = _devFee;
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _buybackFee + _devFee;
