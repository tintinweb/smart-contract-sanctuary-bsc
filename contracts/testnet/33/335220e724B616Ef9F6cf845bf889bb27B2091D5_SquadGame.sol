...
contract SquadGame is SquadGameBasic {
    ...
    ///////////////////////////////////////////ОТПРАВКА ПРОЦЕНТА С ПОКУПКИ УРОВНЯ///////////////////////////////////////////
    function sendETHDividends(uint8 level) private returns (bool) {
        ...
        if((users[prev_user].firstPayment==true) && (users[prev_user].secPayment==true))
        {
            ...
            //800000000000000 30000000000000000  650000000000000   50000000000000000
        }else
        {
    ...
    function payObgonCheck(address prev_user, uint8 level) private returns(bool){
        uint256 mainPercent =levelPrice[level]*74/100;
    ...
    ///////////////////////////////////////////ПОРЯДКОВЫЙ НОМЕР ПОЛУЧАТЕЛЯ ПРОЦЕНТА///////////////////////////////////////////
    ...
    ///////////////////////////////////////////ОТЧЕТ ПО ВЫПЛАТАМ ННА ВСЕХ УРОВНЯХ///////////////////////////////////////////
    ...
    //////////////////////////////////////////СПИСОК ЗАБЛОКИРОВАННЫХ УРОВНЕЙ//////////////////////////////////////////
    ...
    ///////////////////////////////////////////АКТИВИРОВАН-ЛИ УРОВЕНЬ У ИГРОКА///////////////////////////////////////////
    ...
    ///////////////////////////////////////////СПИСОК КУПЛЕННЫХ ИГРОКОМ УРОВНЕЙ///////////////////////////////////////////
    ...
    ///////////////////////////////////////////СКОЛЬКО ОТСЛОСЬ ДО СЛЕДУЮЩЕГО ПОЛУЧЕНИЯ НА КАЖДОМ УРОВНЕ///////////////////////////////////////////
    ...
    ///////////////////////////////////////////ПОРЯДКОВЫЙ НОМЕР ИГРОКА НА УРОВНЯХ///////////////////////////////////////////
