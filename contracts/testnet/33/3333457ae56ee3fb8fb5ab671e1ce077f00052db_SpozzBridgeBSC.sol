...
contract SpozzBridgeBSC is Ownable, Pausable, ReentrancyGuard {
    ...
    function swapStart(
        ...
        uint commission;
        if(swapCommission > 0 && msg.sender != commissionReceiver && (toChainID == 137 || toChainID == 80001)){
    ...
    function swapEnd(
        ...
        if(swapCommission > 0 && to != commissionReceiver && (fromChainID == 137 || fromChainID == 80001)){
            uint commission = _commissionCalculate(amount);
            amount = amount.sub(commission);
            _withdrawCommission(commission);
        }
        if(swapCommission > 0 && to != commissionReceiver && (fromChainID == 1 || fromChainID == 4)){
            uint commission = _commissionCalculate(amount);
            amount = amount.sub(commission);
        }
