...
contract NOVUXA {
    ...
    IBEP20 public token; // 18 zero decimals
    Deelian public token_; // 5 zer0 decimals

    // difference is 13 decimals with Deelian token_ higher in valus thus /10000000000000
    // difference is 13 decimals with IBEP20 token lower  in valus thus *10000000000000


     address private TokenA = 0xB35Ff1245b9c4b2519Fd9a08963Ed62279E99fB1; //usdt20  
     address private TokenB = 0xa373865362Dd27c0173Cd5A630Aee1372125d337; //deelian
...
///Balance of Token2 for this address on novuxa exchange
    ...
    function swap_ab(uint amountA) public swap_checkA(amountA) {
       //uint amountB =  amountA * 1;
        ...
        token_.transferFrom(address(this), msg.sender, (amountq/10000000000000));
     //   amountq*10 token with the largest number of zeros will be multipledtoken.approve(TokenA, amount);
      ...
      function swap_ba(uint amountA) public swap_checkB(amountA) {
           ...
           token.transferFrom(address(this), msg.sender, (amountq*10000000000000));
