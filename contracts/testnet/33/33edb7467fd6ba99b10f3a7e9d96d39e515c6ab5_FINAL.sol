...
//lotteryinfo
    ...
    function lotterycurrentratio() external view returns(uint8 lotteryratioo) {
        if (players.length<11) lotteryratioo=25; //0-10
        else if(10<players.length && players.length<101) lotteryratioo=30; //11-100
        else if(100<players.length && players.length<1001) lotteryratioo=35; //101-1000
