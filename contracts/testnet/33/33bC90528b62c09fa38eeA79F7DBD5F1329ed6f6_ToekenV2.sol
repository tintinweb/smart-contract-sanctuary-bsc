...
contract ToekenV2 is Initializable, ERC20Upgradeable, ERC20SnapshotUpgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() public initializer {
        ...
        _decimals = 9;
        _totalSupply =  3_000_000 * 10**_decimals;
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            feeAmount = amount.mul(_buyLiquidityFee.add(_buyMarketingFee).add(_buyDevFee)).div(100);
        }
        else if(isMarketPair[recipient]) {
            feeAmount = amount.mul(_sellLiquidityFee.add(_sellMarketingFee).add(_sellDevFee)).div(100);
        }
