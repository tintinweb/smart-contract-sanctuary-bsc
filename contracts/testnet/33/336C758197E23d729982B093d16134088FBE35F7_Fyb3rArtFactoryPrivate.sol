...
import "./Fyb3rArtTradablePrivate.sol";

contract Fyb3rArtFactoryPrivate is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice Fyb3r marketplace contract address;
    address public marketplace;

    /// @notice Fyb3r bundle marketplace contract address;
    ...
    */
    ...
    /// @notice Method for deploy new Fyb3rArtTradablePrivate contract
        ...
        returns (address)
    {
        ...
        Fyb3rArtTradablePrivate nft = new Fyb3rArtTradablePrivate(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
    ...
    /// @notice Method for registering existing Fyb3rArtTradable contract
    ...
    /// @notice Method for disabling existing Fyb3rArtTradable contract
    /// @param  tokenContractAddress Address of NFT contract
...
/**
 * @title Fyb3rArtTradablePrivate
 * Fyb3rArtTradablePrivate - ERC1155 contract that whitelists an operator address, 
 * has mint functionality, and supports useful standards from OpenZeppelin,
  like _exists(), name(), symbol(), and totalSupply()
 */
contract Fyb3rArtTradablePrivate is
    ERC1155,
    ERC1155MintBurn,
    ERC1155Metadata,
    Ownable
{
    ...
    // Fyb3r Marketplace contract
    address marketplace;
    // Fyb3r Bundle Marketplace contract
    ...
    /**
     * Override isApprovedForAll to whitelist Fyb3r contracts to enable gas-less listings.
     */
    ...
    {
        // Whitelist Fyb3r marketplace, bundle marketplace contracts for easy trading.
