...
contract proToken is Context, IERC201, Ownable {
    ...
    uint256 public _totalSupply = 10000000000000000;  
...
contract TokenFactory is Ownable {
    ...
    function _deploy(
        ...
        if(tokenType == 3)
            return address(new ERC20Mintable(name, symbol, decimals, supply, _msgSender()));
