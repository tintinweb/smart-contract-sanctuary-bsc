...
contract Romulus is Context, IERC20, Ownable {
    ...
    string private _name = "Romulus Token";
    string private _symbol = "ROM";
    ...
    constructor() {
        ...
        marketingAddress = payable(0x8cC3514aC48026E60F2D576143B97b90F1ad9Ac0);
        developerAddress = payable(0x85fF59870D2F2e8774986e71FE652eF5fD65E13D);
        ownersAddress = payable(0x10F2CCfd54F31f29bF389532a4531046A020e857);
        charityAddress = payable(0xA8570FfF5baA98539Df12D9A969541718BE375a0);
