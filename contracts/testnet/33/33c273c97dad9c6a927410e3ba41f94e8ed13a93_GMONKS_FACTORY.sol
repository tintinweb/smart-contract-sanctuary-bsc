...
contract GMONKS_FACTORY is ERC721, Ownable {
    using SafeMath for uint256;
    uint public MAX_MINT = 333;
    bool public hasSaleStarted = false;
    
    address payableAddress = 0x1FC4E62f7E0e972Ec457544cDb60D4998818FAD4;

    constructor(string memory baseURI) ERC721("GMONKS", "MONKS") {
        setBaseURI(baseURI);
    }
