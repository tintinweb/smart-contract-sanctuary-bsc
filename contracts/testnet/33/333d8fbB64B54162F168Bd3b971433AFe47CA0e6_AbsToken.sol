...
contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        ISwapRouter swapRouter = ISwapRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);//pancakeswap测试网router
        _allowances[address(this)][0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3] = MAX;

        _usdt = 0x4aBe73CD39d9Cb9a2ae44f183E0560BB28A180Ad;//pancakeswap测试网自己发的USDT
        _swapRouter = swapRouter;

        ISwapFactory swapFactory = ISwapFactory(swapRouter.factory());
        address swapPair = swapFactory.createPair(address(this), 0x4aBe73CD39d9Cb9a2ae44f183E0560BB28A180Ad);
        _mainPair = swapPair;
        ...
        _tokenDistributor = new TokenDistributor(0x4aBe73CD39d9Cb9a2ae44f183E0560BB28A180Ad);

        holderRewardCondition = 50 * 10 ** IERC20(0x4aBe73CD39d9Cb9a2ae44f183E0560BB28A180Ad).decimals();
