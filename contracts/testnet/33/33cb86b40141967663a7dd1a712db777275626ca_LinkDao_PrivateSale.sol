...
contract LinkDao_PrivateSale {
    ...
    function deposit(uint amount) public {
        ...
        claim[sender].claimTimes.push(time + 3 minutes);
        claim[sender].claimTimes.push(time + 6 minutes);
        claim[sender].claimTimes.push(time + 9 minutes);
        claim[sender].claimTimes.push(time + 12 minutes);
        claim[sender].claimTimes.push(time + 15 minutes);
        claim[sender].claimTimes.push(time + 18 minutes);
