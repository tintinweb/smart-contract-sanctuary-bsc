...
contract IFOBitdriveProxy is ReentrancyGuard, Initializable {
  ...
  function deposit(uint256 _amount) public {
    ...
    if(userInfo[msg.sender].amount>=1000 && userInfo[msg.sender].amount<50000){
        userInfo[msg.sender].tier =1;
    }else if(userInfo[msg.sender].amount>=50000 && userInfo[msg.sender].amount<100000){
        userInfo[msg.sender].tier =2;
    }else if(userInfo[msg.sender].amount>=100000){
