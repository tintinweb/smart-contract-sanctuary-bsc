  ...
  , IERC20Metadata
{
  ...
  string private _name = "Chronoxia";
  string private _symbol = "CHRX";
  ...
  function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
    ...
    require(currentAllowance >= subtractedValue, "CHRX: decreased allowance below zero");
    unchecked {
  ...
  function _transfer(
    ...
    require(sender != address(0), "CHRX: transfer from the zero address");
    require(recipient != address(0), "CHRX: transfer to the zero address");
    uint256 senderBalance = _balances[sender];
    require(senderBalance >= amount, "CHRXERC20: transfer amount exceeds balance");
  ...
  function _mint(address account, uint256 amount) internal virtual {
    require(account != address(0), "CHRX: mint to the zero address");
  ...
  function _burn(address account, uint256 amount) internal virtual {
    require(account != address(0), "CHRX: burn from the zero address");

    uint256 accountBalance = _balances[account];
    require(accountBalance >= amount, "CHRX: burn amount exceeds balance");
    unchecked {
  ...
  function _approve(
    ...
    require(owner != address(0), "CHRX: approve from the zero address");
    require(spender != address(0), "CHRX: approve to the zero address");
