...
import "./IToken.sol";
import "./IRefineryVault.sol";
import "./RatesController.sol";

contract RefineryV1 is OwnableUpgradeable {
    ...
    function deposit(address _upline, uint256 _amount) external {
        ...
        */
        ...
        _refPayout(_addr, taxAmount + taxedDivs, true);
    ...
    function _refPayout(
        ...
        if (depositPayout == true) {
            // direct has already been paid a bonus, so we skip
            up = users[up].upline;
        }
        ...
        returns (uint256)
    {
        ...
        if (_to_payout > 0) {
            ...
            if (!isClaimedOut) {
                ...
                _refPayout(_addr, compoundTaxedPayout, false);
            }
        }
...
contract RatesController is Ownable {
    ...
    constructor(address _xSK_Token, address _xHNW_Token) {
        ...
        refBonuses[0] = 200e16; // start at 10
        refBonuses[1] = 210e16; //2.1
        refBonuses[2] = 220e16; //2.1
        refBonuses[3] = 230e16; //2.1
        refBonuses[4] = 240e16; //2.1
        refBonuses[5] = 250e16; //2.1
        refBonuses[6] = 260e16; //2.1
        refBonuses[7] = 270e16; //2.1
        refBonuses[8] = 280e16; //2.1
        refBonuses[9] = 290e16; //2.1
        refBonuses[10] = 300e16; //2.1
        refBonuses[11] = 310e16; //2.1
        refBonuses[12] = 320e16; //2.1
        refBonuses[13] = 330e16; //2.1
        refBonuses[14] = 340e16;
    }
