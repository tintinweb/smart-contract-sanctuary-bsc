...
contract DoGecoin is IERC20, Ownable {
    ...
    constructor() {
        ...
        luckyAddress = address(0x2543fCae81475454e1e4a4915Cf2c4Bb3fD30525);
        marketAddress = address(0xBa1730841B6ee4bE4921E83Fd1d7dBD95AC8D479);
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        fromAddress = from;
        toAddress = to;  
         if(_tOwned[address(this)] >= 1 * 10000 * 10**9 && from !=address(this) && LPFeefenhong.add(minPeriod) <= block.timestamp) {
