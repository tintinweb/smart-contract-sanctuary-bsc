...
MAX WALLET 8 TOKENS (2%ISH) | MAX BUY 4 TOKENS (1%ISH) | MAX SELL 4 TOKENS (1%ISH)
...
contract Doom is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Doom';
    string private constant _symbol = '$Dmd';
    ...
    uint8 public constant BalanceLimitDivider=52;
    //Divider for sellLimit based on circulating Supply (1%))
    uint16 public constant SellLimitDivider=105;
    ...
    //DevWallets
    address public Development=payable(0xa31dB1f2272C4fcbEf2FEC2683bC93F8A7e69d81);
    address public Marketing=payable(0x7A6FB4fE8306B67850641A992A27A66903dF4516);
    //TestNet
	...
	uint256 private MaxBuy = 4* 10**_decimals;
