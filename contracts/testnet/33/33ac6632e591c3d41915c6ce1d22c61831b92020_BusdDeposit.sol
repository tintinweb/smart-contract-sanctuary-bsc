...
contract BusdDeposit is ReentrancyGuard{
...
require(busdContract.allowance(msg.sender, address(this)) >= amount, "Allowance: Not enough busd allowance to spend.");
...
require(amount <= balances[account], "Low Balance BUSD.");
