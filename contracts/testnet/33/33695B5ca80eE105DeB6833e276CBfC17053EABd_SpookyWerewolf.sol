...
contract SpookyWerewolf is IBEP20, Auth {
    ...
    string constant _name = "SPWRFTEST";
    string constant _symbol = "$SPWRFTEST";
    ...
    mapping (address => bool) public KickBot;
    ...
    address public marketingFeeReceiver = 0x39A1DCDD0b3800682Af37922400f820026F7CA35;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!KickBot[recipient] && !KickBot[sender], 'Address is excluded.');
   ...
   function setMaxWallet(uint256 amount) external onlyOwner {
    ...
    // Exclude bots
    function isBot(address _address, bool _value) public onlyOwner{
        KickBot[_address] = _value;
    }
