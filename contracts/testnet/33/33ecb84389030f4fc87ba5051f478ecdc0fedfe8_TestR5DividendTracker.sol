    ...
    DividendPayingTokenOptionalInterface
{
    ...
    bool isPromoRewardOn; // true: reward as promoted token, false: reward as BNB
    bool isBUSDpair;
    ...
    function setPromotedToken(address promotedTokenAddress, address ammContractAddress, bool _isBUSDpair) external onlyOwner {
...
contract TestR5 is BEP20, Ownable {
    using SafeMath for uint256;
    ...
    TestR5DividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address public immutable BUSD = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; //BUSD
    ...
    IPancakeswapV2Router02 rewardSwapRouter = IPancakeswapV2Router02(currentPromotedTokenAMM);
    ...
    constructor() BEP20("Test R5", "TR5") {
        dividendTracker = new TestR5DividendTracker();
    ...
    function setPromotedTokenAndAMM(address promotedTokenAddress, address ammContractAddress, bool _isBUSDpair) external onlyOwner {
        ...
        dividendTracker.setPromotedToken(promotedTokenAddress, ammContractAddress, _isBUSDpair);
        emit PromotedTokenChanged(promotedTokenAddress);
        emit ammAddressChanged(ammContractAddress);
    }
...
contract TestR5DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("TestR5_Dividend_Tracker", "TR5_Dividend_Tracker")
    {
        claimWait = 3600;
