...
contract ARTTOOL {
    ...
    event Make(address indexed account,uint256 usdAmount,uint256 amount);
    ...
    function make(uint256 usdAmount,uint256 amount) public returns(bool status){
        ...
        emit Make(msg.sender,usdAmount,amount);
        return true;
    }
