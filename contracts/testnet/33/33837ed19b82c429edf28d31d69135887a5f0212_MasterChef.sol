...
contract MasterChef is Ownable {
    ...
    function changeBitConeSwapAddress(address payable _uniswaprouter1)
        external
        onlyOwner()
    {
        uniswaprouter1 = IUniswapV2Router01(_uniswaprouter1);
    ...
    address[] private arr = [
        ...
        0xc9bCF3f71E37579A4A42591B09c9dd93Dfe27965  // CONE
    ];
    ...
    function updateEmissionRate(uint256 _CONEPerBlock) public onlyOwner {
        massUpdatePools();
        CONEPerBlock = _CONEPerBlock;
    }
