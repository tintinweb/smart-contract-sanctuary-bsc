...
/**
 *Author: https://t.me/wushuang_Solidity
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    uint256 private _totalSupply = 10e9 * 10 ** _decimals;
    /**
...
contract GoldDogeToken is ERC20, Ownable{
    ...
    uint256 public swapThreshold = 10e5 * 10e9;
    
    address public marketingWallet = 0x0132144D6ECAD56513Ad0984FE976e069216fD38;
    ...
    constructor() ERC20("Penguin Token", "Penguin") {
        excludedFromFees[msg.sender] = true;

        IRouter _router = IRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        address _pair = IFactory(_router.factory())
            .createPair(address(this), _router.WETH());
        _allowances[address(this)][address(_router)] = totalSupply();
        router = _router;
        pair = _pair;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override {
        ...
        super._transfer(sender, recipient, amount - fee - burnAmt - reserveAmt);
