...
contract GLXtoken is BEP20 {
    ...
    // Min amount to liquify. (default 50 Seed)
    uint256 public minAmountToLiquify = 50 ether;
    // The swap router, modifiable. Will be changed to SeedSwap's router when our own AMM release
    ...
    constructor() public BEP20("Galaxy token", "GLX") {
        GLXSwapRouter = IPancakeRouter02(
            0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        );
        GLXSwapPair = IPancakeFactory(GLXSwapRouter.factory()).createPair(
            GLXSwapRouter.WETH(),
            address(this)
        );
