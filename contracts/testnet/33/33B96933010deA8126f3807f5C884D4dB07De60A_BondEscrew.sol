...
contract BondEscrew {
    ...
    function BusdAmount() public view onlyOwner returns(uint256) {
         return IERC20(BUSD).balanceOf(address(this));
    }
    function USDTAmount() public view onlyOwner returns(uint256) {
         return IERC20(USDT).balanceOf(address(this));
    }
    function getAmount(address _addr) public view  onlyOwner returns(uint256) {
