...
contract WBTOKEN is Context, IBEP20, Ownable {
    ...
    function setautoburnFee(uint256 _buy , uint256 _sell , uint256 _normal) external onlyOwner {
        autoburnFeeOnBuying = _buy;
        autoburnFeeOnSelling = _sell;
        autoburnFee = _normal;
    }
    function setmarketingwalletFee(uint256 _buy , uint256 _sell , uint256 _normal) external onlyOwner {
        marketingwalletFeeOnBuying = _buy;
        marketingwalletFeeOnSelling = _sell;
        marketingwalletFee = _normal;
    }
    function setRedistributionFee(uint256 _buy , uint256 _sell , uint256 _normal) external onlyOwner {
        redistributionFeeOnBuying = _buy;
        redistributionFeeOnSelling = _sell;
        redistributionFee = _normal;
    }
    function setLiquidityFee(uint256 _buy , uint256 _sell , uint256 _normal) external onlyOwner {
