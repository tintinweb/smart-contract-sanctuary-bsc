...
contract Launchpad is Initializable {
  ...
  /// @notice Operator who can manage configuration of the contract
  ...
  /**
   * @notice Only Operator can change configuration
   */
  ...
  function changeOperator(address _address) external onlyOperator {
    require(_address != address(0), 'OPERATOR_SHOULD_BE_NON_ZERO_ADDRESS');
    OPERATOR = _address;
   ...
   * @param _allowlistSigner Allowlist Signer Address
   */
