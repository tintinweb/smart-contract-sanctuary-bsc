...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x837f50291951cd0632A6D43B77eD1848aB3A7616;
...
contract BabyCrokx is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2B902B5753429Fee7613cA46f55D93cf0D3fc2d7;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Baby Crokx";
    string private _symbol = "CROKX";
