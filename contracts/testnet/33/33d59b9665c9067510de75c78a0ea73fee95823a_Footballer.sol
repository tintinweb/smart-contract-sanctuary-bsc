...
contract Footballer is ERC721, Ownable {
    ...
    address private _tokenReward = 0xa67C45f864Ce8dC1C2A70EA8E40612fdF37E5feb;

    constructor() ERC721("Footballer", "FootballerNFT") {
        baseTokenURI = "https://bafybeifqflhazmiqnirvj66nfq3g5tantpvnxipwpaoagsvppywg45wglq.ipfs.nftstorage.link/metadata/";
    ...
    function Training(uint256 nftID, address user) external onlyOperator {
      ...
      if (characters[nftID].lastestUpdate == 0) {
