...
// 30% - 50% lock for more than a year and 50% lock for more than two year.
    ...
    IDeposit
{
    ...
    uint16 public constant phase = 2;
    ...
    // 50% lock for more than a year and 50% lock for more than two year.
