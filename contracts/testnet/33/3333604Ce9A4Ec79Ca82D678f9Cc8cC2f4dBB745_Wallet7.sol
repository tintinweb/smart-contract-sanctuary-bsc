...
/**
⚓️LETS GET TRENDING AND HYPE WITH CHOPPERVERSE⚓️

⚓️ Did you miss all the boy token moonshot? dont miss out this one

Chopper Verse is the most hype community token.

⚓️Supply 1M
⚓️ Stealth Launch Only
⚓️Low MarketCap [Easy x100]
⚓️5% Fee Marketing
⚓️5% Reflection To Liquidity 

https://t.me/ChopperVerse / @ChopperVerse
...
contract Wallet7 is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyAmount = _tTotal.mul(10).div(10);
    uint256 public maxSellAmount = _tTotal.mul(10).div(10);
    ...
    string private constant _name = "Wallet7";
    string private constant _symbol = "Wallet7";
