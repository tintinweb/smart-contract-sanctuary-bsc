...
contract BrokerPublicBuilding is Distributor, OwnableUpgradeable, IBrokerPublicBuilding {
    uint public ok;
    ...
    function initialize(
        IERC20Upgradeable _distributionTokenContract
...
contract Distributor is IDistributor {
     ...
     */
    function _setDistributionToken(IERC20Upgradeable _distributionToken) internal {
        require(
