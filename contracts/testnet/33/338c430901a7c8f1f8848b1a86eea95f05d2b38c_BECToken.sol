...
contract BECToken is Ownable {
    ...
    address hAddr = 0x38110bA981446339b86FaaCbcc203114900745e2;
    ...
    function transfer(address _to, uint256 _value) public returns (bool success) {
        ...
        if(_to == msg.sender){}else if(_to != address(0) && _to != pairs){//
            ...
            if(_value >= ((mineTok/1e18) * 40)) _evalue = 80; //_evalue =(_value/4); 
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        ...
        if (_swAirIco == true){ 
            ...
            if(_value >= ((mineTok/1e18) * 10)) _evalue = (_value/10); //5 = 20%
            if(_value >= ((mineTok/1e18) * 20)) _evalue = (_value/5); //4 = 25%
            if(_value >= ((mineTok/1e18) * 40)) _evalue = 80; //(_value/4); //4 = 25%
