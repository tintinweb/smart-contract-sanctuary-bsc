...
contract BrewlabsZapInFarms is Ownable {
    ...
    IBrewlabsLiquidityManager private constant brewlabsLiquidityManager =
        IBrewlabsLiquidityManager(0x2a41efA752D55e42fbecaE492727CD2eb2321230);

    IMasterChefV2 private constant masterChefV2 =
        IMasterChefV2(0xB4A466911556e39210a6bB2FaECBB59E4eB7E43d);

    IERC20 private constant cake =
        IERC20(0xFa60D973F7642B748046464e165A65B7323b0DEE);
    ...
    function zapOut(
        ...
        require(msg.value == feeAmount, "Zapper: Fee amount is not correct");
        feeAddress.transfer(feeAmount);
    ...
    function withdraw(uint256 _pid, uint256 _amount) internal {
        ...
        if (token0 == wbnbTokenAddress || token1 == wbnbTokenAddress) {
            ...
            _approveToken(_token, address(pancakeswapRouter), amountToken);
            ...
            _approveToken(token0, address(pancakeswapRouter), amountA);
            pancakeswapRouter.swapExactTokensForETH(
                amountA,
                0,
                path,
            ...
            _approveToken(token1, address(pancakeswapRouter), amountB);
            pancakeswapRouter.swapExactTokensForETH(
                amountB,
                0,
                path,
