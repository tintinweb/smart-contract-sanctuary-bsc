...
contract DEFRAMTest9 is ERC20, Ownable {
    ...
    constructor () ERC20("Decentralized Exchange Wallet", "DEFRAMTest9") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xc7129B46DebB37402134E657103575B1a9620114;
        developmentWallet = 0xfBC9396894eb8D97f925EceA1fD8EEFc2cbd8a4d;
