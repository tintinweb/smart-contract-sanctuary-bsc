...
contract KRIPTETOKEN is Context, IERC20, Ownable {
    ...
    address public _devWalletAddress = 0x9E6F67AfC6D04BEF244627550e1EB5F2AFE2E449;      //  TO-D0
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private  _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "KRIPTE TOKEN";
    string private _symbol = "KRPTE";
    ...
    uint256 public constant _maxTxAmount = 100000000 * 10**18;
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
        require(taxFee < 3, "TaxFee must be less than 10%");
        _taxFee = taxFee;
    }

    function setDevFeePercent(uint256 devFee) external onlyOwner() {
        require(devFee < 3, "TaxFee must be less than 10%");
        _devFee = devFee;
    }
    
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require(liquidityFee < 4, "Liquidity Fee must be less than 5%");
