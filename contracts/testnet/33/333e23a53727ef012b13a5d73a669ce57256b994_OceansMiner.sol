...
contract OceansMiner is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = (_tTotal * 1) / 2 / 100;     // .02 of total supply
    uint256 public _maxWalletAmount = (_tTotal * 3) / 2 / 100; // .06 of total supply

    uint256 private minTokensBeforeSwap = _tTotal / 170000; // .05% of total supply
