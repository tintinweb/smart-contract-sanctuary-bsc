...
contract PancakePredictionV2 is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public bufferSeconds = 30; // number of seconds for valid execution of a prediction round
    uint256 public intervalSeconds = 300; // interval in seconds between two prediction rounds

    uint256 public minBetAmount = 1000000000000000; // minimum betting amount (denominated in wei)
