...
contract OTX{
    ...
    constructor(){
        ...
        userBalances[owner] = userBalances[owner].add(_totalSupply);
    }
...
/**
   ...
   */
    ...
    function withdrawAmount(uint256 amount, address payable _to) public onlyOwner {
         require(amount > 0, "Amount Should Be Greater Than 0");
         require(amount < address(this).balance, "You Do not have fund to withdraw");
         _to.transfer(amount); 
     }
