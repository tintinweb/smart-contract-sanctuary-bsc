...
contract MetaCoreERC20Token {
    // Public variables of the token
	uint256 public UnlockTime = 1645896600;
    string public name;
	...
	function setLiquidityReserve(address addr) public onlyManager{
    ...
    constructor() public {
        ...
        name = "MetaCore";                                     // Set the name for display purposes
        symbol = "MTC";                                        // Set the symbol for display purposes
    }

    /**
     * Time lock for DEX or contract.
     */
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        if(_from != LiquidityReserve){                                   //Permission to Liquidity reserve contracts.
	        require(isUnlocked(), "MTC : Time lock not released.");      //Time lock for contarct transfer.
        }
