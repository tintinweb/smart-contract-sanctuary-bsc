...
contract DexGoRentAndKm is Ownable {
    ...
    function rent(uint256 _tokenId) public payable {
        ...
        IHandshakeLevels(IDexGoStorage(storageContract).getHandshakeLevels()).distributeMoney(msg.sender, IDexGoStorage(storageContract).getFixedAmountProject(), false, false);
    ...
    function repair(uint256 _tokenId, bool isSpeedUp) public payable {
        if (isSpeedUp) {
            ...
            IHandshakeLevels(IDexGoStorage(storageContract).getHandshakeLevels()).distributeMoney(msg.sender, msg.value, false, false);
