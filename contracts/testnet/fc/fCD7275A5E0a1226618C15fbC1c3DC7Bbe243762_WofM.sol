...
import "./common/WoM20Payable.sol";
import "./common/WoMWithdrawable.sol";

contract WofM is WoM20Payable, ERC20Burnable, WoMWithdrawable {
    uint256 public constant TOTAL_SUPPLY = 500_000_000 * 10 ** 18;

    constructor(string memory name, string memory symbol) public WoM20Payable(name, symbol) {
...
abstract contract WoM20Payable is ERC20, ERC20Permit, AccessControlEnumerable {
    struct ChannelData {
        address orderSigner;
        address cashier;
