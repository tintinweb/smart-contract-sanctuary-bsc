...
contract Reactor is ERC1155, Pausable {
    ...
    constructor (
        ...
        Pausable.paused(); // el contrato se deploya sin pausa
    ...
    function setContractActive(bool _scStart) external onlyOwner {
        SC_TIMER = block.timestamp + 1 days;
        isContractActive = _scStart;
    }
