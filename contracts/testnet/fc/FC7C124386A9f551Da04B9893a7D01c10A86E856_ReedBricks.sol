...
contract ReedBricks is Context, IERC20, Ownable {
    ...
    uint256 private totkenSold = 0; // keeping track of BNB raised
    uint256 private raisedAmount = 0; // keeping track of BNB raised
    ...
    function localSell() public payable whenLocalSaleIsActive {
        ...
        totkenSold = totkenSold.add(tokens); // Increment sold amount
    ...
    function withdrawPurchased() public {
        ...
        // _approve(msg.sender, msg.sender, tokens);
        _tokenTransfer(address(this), msg.sender, tokens, false);
        raisedAmount = raisedAmount.add(address(this).balance); // Increment raised amount
        localSales[msg.sender] = localSales[msg.sender].add(tokens);
    }
