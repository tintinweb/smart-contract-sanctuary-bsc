...
/**
* Telegram：https://t.me/CandyAICoin

* Website：https://candyai.finance

* Buy/Sell tax 5%：Marketing 3% Liquidity 2%
...
contract TANKAICOIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TANKAICOIN", "TANKAI") {
 
        router = IUniswapV2Router02(0xB6BA90af76D139AB3170c7df0139636dB6120F7e);
        ...
        maxWalletAmount = totalSupply * 5 / 100; // 1% maxWallet
        ...
        marketingWallet = address(0x96280D5CD44c6DFA0C7c7CB75a2469fF2FbF6D4f);
        contestAIWallet = address(0x96280D5CD44c6DFA0C7c7CB75a2469fF2FbF6D4f);
