...
contract lover is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "lover";
    string private _symbol = "lover";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xb5675aE2c280dF4a6Ef0B95656182A4a53f6FcD0); 
    address payable public teamWalletAddress = payable(0xb5675aE2c280dF4a6Ef0B95656182A4a53f6FcD0); 
