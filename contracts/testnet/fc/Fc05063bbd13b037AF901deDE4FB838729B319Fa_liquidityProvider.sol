...
contract liquidityProvider is AccessControl, Initializable {
   ...
   **/
    ...
    */
    ...
    function addLiquidity(address tokenA, address tokenB, uint amountA, uint amountB, address to) public {
        ...
        console.log(IERC20(tokenA).allowance(address(this),router), "allowance2");
