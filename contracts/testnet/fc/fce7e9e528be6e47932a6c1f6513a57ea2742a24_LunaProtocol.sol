...
contract LunaProtocol is ERC20, Ownable {
    ...
    event SellFeesUpdated(uint256 liquiditySellFee,uint256 treasurySellFee,uint256 ecosystemSellFee,uint256 rewardPoolSellFee,uint256 rewardSellFee,uint256 totalSellFee);
    ...
    {   
        ...
        rewardPoolSellFee = 1;
        rewardSellFee = 3;
        totalSellFee = liquiditySellFee + treasurySellFee + ecosystemSellFee + rewardPoolSellFee + rewardSellFee;

        treasuryWallet = 0x09E626Eb98bCF39d17163C01B8F3c46135218491;
        ecosystemWallet  = 0xF963f145cd74C4c63EbD6AB4867aA846D99e8f66;     
        rewardPoolWallet = 0x37F07949d9094C31696484497158aD63C1414ec6;
    ...
    function updateSellFees(uint256 _liquiditySellFee,
        ...
        uint256 _rewardSellFee ) external onlyOwner {          
        ...
        emit SellFeesUpdated(liquiditySellFee, treasurySellFee, ecosystemSellFee, rewardPoolSellFee, rewardSellFee, totalSellFee);
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 bnbShare = treasuryShare + ecosystemShare + rewardPoolShare + rewardShare;
