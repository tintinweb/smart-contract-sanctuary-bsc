...
contract Football is AccessControlUpgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable {
    ...
    function spawnAxie(uint256 _genes, address _owner,uint256 _axieId) external 
    {
        require(hasRole(SPAWNER_ROLE, msg.sender), "Caller is not a minter");
        _spawnAxie(_genes, _owner,_axieId);
    }

    function _spawnAxie(uint256 _genes, address _owner,uint256 _axieId) private  {
...
//        _axieId = axies.length - 1;
    ...
    string public tokenURIPrefix = "https://football/api/erc/721/";
