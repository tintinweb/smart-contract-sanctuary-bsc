...
contract FortuneCookiesLottery is ReentrancyGuard, IFortuneCookiesLottery, Ownable {
     ...
     * @param _ticketNumbers: array of ticket numbers between 1,000,00 and 1,999,99
        ...
        nonReentrant
    {
        ...
        uint256 amountToShareToWinners = (
            ((_lotteries[_lotteryId].amountCollectedInCalcifire) * (10000 - _lotteries[_lotteryId].treasuryFee))
        ) / 10000;
    ...
    function _calculateRewardsForTicketId(
        ...
        if (transformedWinningNumber == transformedUserNumber) {
            return _lotteries[_lotteryId].calcifirePerBracket[_bracket];
        } else {
            return 0;
        }
    }
