...
contract TripleR is ERC20Detailed, Ownable {
    ...
    uint256 public triplerDividendFee = 70;
    uint256 public sellFee = 20;
    uint256 public autofirePitFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(triplerDividendFee).add(
            autofirePitFee
        );
    ...
    address public triplerDividendReceiver;
    ...
    constructor() ERC20Detailed("3RCrypto", "TripleR", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xdC19f0c541C1d6EDD9c493c7a246C7107c813480;
        treasuryReceiver = 0xC1917e433dbd0b9815B50F1CE8a09F80eA2aBcAE;   
        ...
        triplerDividendReceiver = address(distributor);
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(triplerDividendFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(triplerDividendFee)
            ),
            gas: 30000
        }("");

        try distributor.deposit {
            value: amountETHToTreasuryAndSIF.mul(triplerDividendFee).div(treasuryFee.add(triplerDividendFee))
        } () {} catch {}        
    }
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no TripleR token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
