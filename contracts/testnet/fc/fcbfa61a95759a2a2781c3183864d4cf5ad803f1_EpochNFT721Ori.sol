    ...
    BEP721BurnableUpgradeable
{
    ...
    mapping(string => uint256) private escServiceValue;
    ...
    function serviceFunctionEsc(uint256 _escServiceValue, string memory _type) public onlyOwner {
        escServiceValue[_type] = _escServiceValue;
    }

    function getServiceFeeEsc(string memory _type) public view returns (uint256) {
        return escServiceValue[_type];
    }
    ...
    function newtokenasbid(
        ...
        uint256 servicevalue =escServiceValue[tokenAss];
