...
contract HEMPIRE_BUSD {
    ...
    uint256 public EGGS_TO_HATCH_1MINERS=300;//for final version should be seconds in a day
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    function hire(address ref, uint256 amount) public {
        require(initialized);
        require(amount < 2000 * (10**18), "Max limit is 2000 BUSD");
        require(amount > 25 * (10**18), "Min limit is 25 BUSD");
        // ERC20(busd).approve(address(msg.sender), amount);
