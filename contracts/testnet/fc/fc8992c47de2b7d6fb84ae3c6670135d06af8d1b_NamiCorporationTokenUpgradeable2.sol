...
contract NamiCorporationTokenUpgradeable2 is Initializable, ContextUpgradeable, AccessControlUpgradeable, ERC20BurnableUpgradeable, ERC20PausableUpgradeable, AddressBlockableUpgradeable {
    ...
    function test() public virtual {
        require(hasRole(TESTER_ROLE, _msgSender()), "NAMI: must have pauser role to unpause");
    }
}