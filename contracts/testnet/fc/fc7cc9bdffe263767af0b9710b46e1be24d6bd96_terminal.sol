...
contract terminal is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "terminal";
    ...
    //Tax wallets
    address public teamWallet = 0x60321AD18989002ae5228111196697f5D70184CA;
    address public treasuryWallet = 0x60321AD18989002ae5228111196697f5D70184CA;
