...
// File: contracts/Games/BSCCoinFlipSafe.sol
...
contract BSCCoinFlip is Ownable {
    ...
    address public _houseFeeReceiver = address(0x1c74DC56F99b31D59843b39C1932cd79f46AC102);
    ...
    address public _croupier = address(0xFc421aac65596b199C4d88c0841F4559f19d22Cb);
    ...
    function _onlyCroupier() private view {
      require(_msgSender() == _croupier, "Only the croupier can perform this action");
    }
    ...
    function completeQueuedGames(uint256 seed) external onlyCroupier {
        while (_globalQueueSize > _queueResetSize) {
            ...
            game.winner = (rand(seed) % 2) == game.predictedOutcome;
    ...
    function rand(uint256 seed) public view returns(uint256)
    {
        uint256 value = uint256(keccak256(abi.encodePacked(
            ...
            block.number + _globalQueueSize + seed
        )));
    ...
    function setCroupier(address croupier) external onlyOwner {
      _croupier = croupier;
    }
