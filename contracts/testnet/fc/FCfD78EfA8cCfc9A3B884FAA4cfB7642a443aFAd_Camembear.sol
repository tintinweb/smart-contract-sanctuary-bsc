...
//tg : http://xxxx
// YOU LIKE CAMEMBERT, YOU'LL LOVE CAMEMBEAR
...
/* Token contract */
contract Camembear is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address RWD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    // Name and symbol
    string constant _name = "Camembear Token";
    string constant _symbol = "CMB";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x1746A0Df83c665dD8750eD4A16B5aE65B34Ecae8;
    ...
    function checkBuyCooldown(address sender, address recipient) internal {
        if (sender == pair &&
            ...
            require(cooldownTimer[recipient] < block.timestamp,"Please wait between two buys TY");
