...
contract NEWNFTs is ERC721, Ownable, RoyaltiesV2Impl {
    ...
    function mintPresale(uint256 numberOfMints) public payable {
        ...
        uint256 reserved = presale[msg.sender];
        ...
        presale[msg.sender] = reserved - numberOfMints;
