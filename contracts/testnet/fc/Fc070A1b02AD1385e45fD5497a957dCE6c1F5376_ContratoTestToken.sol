...
contract ContratoTestToken is Context, IERC20, Ownable {
    ...
    constructor (address _marketing, address _treasury) {
        ...
        _name = "Contrato Test Token";
        _symbol = "CTT";
        _decimals = 9;
        _totalSupply = 1000000000 * 10**_decimals;
        _maxTxAmount = 1000000000 * 10**_decimals; 
        _walletMax = 1000000000 * 10**_decimals;
        minimumTokensBeforeSwap = 1000000000 * 10**3; 
        ...
        _totalTaxIfBuying = 15;
        _totalTaxIfSelling = 15;
        _totalDistributionShares = 15;
