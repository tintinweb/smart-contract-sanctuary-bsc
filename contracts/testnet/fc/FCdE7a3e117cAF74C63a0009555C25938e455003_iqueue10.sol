...
contract iqueue10 is IERC20, Ownable {
    ...
    string constant _name = "iqueue10";
    string constant _symbol = "iq10";
    ...
    uint256 public buyAutoBurnFee = 20;
    uint256 public buyBuyBackFee = 20;
    ...
    uint256 public sellTotalFee = 130;

    // swap percentages
    uint256 public buyBackSwap = 20;
    uint256 public devSwap = 10;
    uint256 public liquiditySwap = 10;
    uint256 public totalSwap = 40;
    ...
    constructor() {
        ...
        devFeeWallet = 0xa9494e3fF124B319D391AC5c2dC8c33820F0C69C;
        buyBackFeeWallet = 0xcC336eCa9110c46ec9890297d7335405C91d21De;
    ...
    function swapBack() internal swapping {
        ...
        if (tokensToDev > 0 && devSwap > 0) {
            payable(buyBackFeeWallet).transfer(tokensToDev);
        }
