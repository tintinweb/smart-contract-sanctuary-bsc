...
contract LPTokenWrapper is Ownable, ReentrancyGuard {
    ...
    IERC20 public BSKTASREWARD =
        IERC20(0xca08E5e4E89a7140a8c8C9b94832596026f4a89E); // Approve and Transfer for Stake and Withdraw
...
contract BsktStakingPool is LPTokenWrapper {
    IERC20 public STAKEBSKT =
        IERC20(0xca08E5e4E89a7140a8c8C9b94832596026f4a89E); // BSKT TOKEN ADDRESS
