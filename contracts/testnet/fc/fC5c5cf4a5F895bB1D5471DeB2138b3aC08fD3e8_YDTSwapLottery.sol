...
contract YDTSwapLottery is ReentrancyGuard, IYDTSwapLottery, Ownable {
    ...
    modifier onlyOwnerOrInjector() {
        require((msg.sender == owner()) || (msg.sender == injectorAddress), "Access denied");
        _;
    }
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(YDTtoken), "Cannot be YDT");
        require(_tokenAddress != address(RYDTtoken), "Cannot be RYDT");
