...
contract BetMarketERC20 {
    ...
    function createMarket(
        ...
        require(msg.sender == owner, "Unauthorized");
        require(_endTimestamp > 0, "End timestamp is required");
    ...
    function addYesBet(uint256 _marketId, uint256 _betAmount) public {
        ...
        require(market.endTimestamp > 0, "Market not exist");
        require(market.endTimestamp > block.timestamp, "Market has ended");
        require(market.eventCompleted == false, "Market has finished");
