...
contract SSanta is ERC20, Ownable {
    ...
    constructor () ERC20("SAFU Santa", "SSanta") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x65818E915F80c641F8E35b253B8e3ee73ef713d7;
    ...
    function updateFees(uint256 _marketingFeeOnBuy, uint256 _marketingFeeOnSell) external onlyOwner {
        ...
        require(_marketingFeeOnBuy <= 10 && _marketingFeeOnSell <= 10, "Fees cannot be higher than 10%.");
    }
