...
contract BShare is Receipt, Pausable, IEvents {
    ...
    uint public lockTransactionTime = 86400;  //For testing 24 hours = 10s; for deployment 24 hours = 86400s;
    uint public priceImpactProtection = 10; // Multiply coffiecient by 100
    ...
    uint [] public BShare_BuyBack = [7500,2500]; //[buyBack and burn, team address]
