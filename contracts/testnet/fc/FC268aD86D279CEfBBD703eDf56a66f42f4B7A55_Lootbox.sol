...
contract Lootbox is VRFConsumerBaseV2, Governable{
    ...
    address private paymentReciever;
     ...
     */
    function open(uint containerId) external {
     ...
     * @param containerId   Id of container in liquidifty collection
     */
    function roll(uint containerId) external {
    ...
    function getRollCount(address user, uint containerId) external view returns(uint){
