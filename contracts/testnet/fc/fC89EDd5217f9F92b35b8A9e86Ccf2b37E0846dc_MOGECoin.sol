...
contract MOGECoin is Context, IERC20, Ownable {
    ...
    address public _jackpotAddress = 0x2f6367615bDA5C9C6f98Cd4DAE2C9F1143d88f7B;//???
    ...
    event JackpotAddressUpdate(address jackpotAddress);
    ...
    function setJackpotAddress(address jackpotAddress) external onlyOwner() {
       _jackpotAddress = jackpotAddress;

       emit JackpotAddressUpdate(jackpotAddress);
    }        
