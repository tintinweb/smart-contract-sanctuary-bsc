...
contract CapverseMarket is Ownable, ReentrancyGuard {
    ...
    // order
    event SoldOrder(address fromAddr, address toAddr, address nftToken, uint256 tokenID, address payToken, uint256 payAmount, uint256 newOrderId);
    event SoldOutOrder(address fromAddr, address toAddr, address nftToken, uint256 tokenID, uint256 orderID);
    event PurchaseOrder(address fromAddr, address toAddr, address nftToken, uint256 tokenID, uint256 orderID);
    ...
    function soldOrder(address nftToken, uint256 tokenID, address payToken, uint256 payAmount) public nonReentrant {
        ...
        emit SoldOrder(msg.sender, address(this), nftToken, tokenID, payToken, payAmount, newOrderId);
    }
    ...
    function soldOutOrder(address nftToken, uint256 tokenID) public nonReentrant {
        ...
        emit SoldOutOrder(address(this), msg.sender, nftToken, tokenID, orderID);
    }
    ...
    function purchaseOrder(address nftToken, uint256 tokenID) public payable nonReentrant {
        ...
        emit PurchaseOrder(address(this), msg.sender, nftToken, tokenID, orderID);
    }
