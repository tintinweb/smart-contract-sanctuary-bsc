...
contract __MyToken is ERC20, Pausable, Ownable, Proxy {
    constructor() {
        StorageSlot.getAddressSlot(IMPLEMENTATION_SLOT).value = address(this);
    }
    ...
    function init() public {
        require(!StorageSlot.getBooleanSlot(INITIALIZE).value, "already initialized");
        _initializeERC20("MyToken", "MTK");
        StorageSlot.getBooleanSlot(INITIALIZE).value = true;
    ...
    function transfer(address to, uint256 amount) public override returns (bool) {
        if(_getImplementation() == __self) {
            ...
            _getImplementation().delegatecall(abi.encodeWithSelector(IERC20.transfer.selector, to, amount));
    ...
    function transferFrom(
        ...
        if(_getImplementation() == __self) {
            ...
            (bool success, bytes memory data) =
            _getImplementation().delegatecall(abi.encodeWithSelector(IERC20.transferFrom.selector, from, to, amount));
            require(success && data.length >= 32);
        }
        return true;
    }
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        if(_getImplementation() == __self) {
            ...
            (bool success, bytes memory data) =
            _getImplementation().delegatecall(abi.encodeWithSelector(IERC20.approve.selector, spender, amount));
            require(success && data.length >= 32);
        }
        return true;
    }
    ...
    function increaseAllowance(address spender, uint256 addedValue) public override returns (bool) {
        if(_getImplementation() == __self) {
            ...
            (bool success, bytes memory data) =
            _getImplementation().delegatecall(abi.encodeWithSelector(ERC20.increaseAllowance.selector, spender, addedValue));
            require(success && data.length >= 32);
        }
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public override returns (bool) {
       if(_getImplementation() == __self) {
            ...
            (bool success, bytes memory data) =
            _getImplementation().delegatecall(abi.encodeWithSelector(ERC20.decreaseAllowance.selector, spender, subtractedValue));
            require(success && data.length >= 32);
        }
        return true;
    }
