    ...
    */
    ...
    function executeSingleUserDCA(address _userAddress, uint _DCAStartDate ) public {
        ...
        */
        ...
        require(block.timestamp > _DCAStartDate + userDCA.periodDays * /*86400000*/ 1  * (userDCA.currentOccurence + 1) - 1800,
                                                                                     "Error: Too soon to execute this DCA");

        mapDCA[_userAddress][_DCAStartDate].currentOccurence = userDCA.currentOccurence + 1;
        uint feeCaller = (userDCA.amountPerOccurence * 100000) * userDCA.fee5Decimals / 10000000000;
        uint feeOwner = (userDCA.amountPerOccurence * 100000) * 99500 / 10000000000;
        uint amountWithoutFees = userDCA.amountPerOccurence - feeCaller - feeOwner;
        ...
        emit OccurenceExecuted(_DCAStartDate, _userAddress, userDCA.totalOccurences, userDCA.currentOccurence + 1, block.timestamp, block.timestamp + userDCA.periodDays * 86400000, estimatedMinimumAmountOut);
        ...
        sendFee(owner, userDCA.tokenIn, feeOwner);
    }   
