 ...
 */
contract MoviesN is GeneralERC721, Payment {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    address public OGMoviesN;
    ...
    modifier CheckFreeMint(address _tokenAddr) {
        require(FreeMintCount < FREE_MINT_SUPPLY, "Over free mint supply");
        require(_tokenAddr == Galxe, "Invalid address");
        require(!freeMintStatus[msg.sender][_tokenAddr], "Already Mint");
        _;
    }

    modifier OnlyBurnAddress() {
        require(msg.sender == OGMoviesN, "Not burn address");
        _;
    }
    ...
    function setBurnAddrss(address _OGMoviesN) public onlyOwner {
        OGMoviesN = _OGMoviesN;
    }

    function setFreeMintSupply(uint256 _number) public onlyOwner {
        FREE_MINT_SUPPLY = _number;
    }
    ...
    /**
     * @notice Burning MoviesN NFT get OG PASS NFT
