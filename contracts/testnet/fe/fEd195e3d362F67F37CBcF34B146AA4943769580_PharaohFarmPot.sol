...
contract PharaohFarmPot is Ownable {
    ...
    mapping(address => level1Address) public level1;
    mapping(address => level2Address) public level2;
    mapping(address => level3Address) public level3;
    mapping(address => level4Address) public level4;
    mapping(address => level5Address) public level5;
    mapping(address => level6Address) public level6;
    mapping(address => level7Address) public level7;
    ...
    function deposit(uint256 amount, address referAddress) public {
        ...
        user_data[referAddress].referralRewards += refRewardLevels[0] / 1000;
    ...
    function availableRewards() public view returns (uint256) {
        ...
        return ((initial * time) / 100) + refRew;
    }
    ...
    function doubleUp() public {
        ...
        uint256 totalStakingDays = block.timestamp - startDate / 1 days;
        require(
        ...
        uint256 availableRewards = max - claimed;
        CAFToken.safeTransferFrom(
            msg.sender,
            address(this),
            doubleUpAmount - availableRewards
        );
        uint256 finalAmount = depositAfterTax(doubleUpAmount);
    ...
    function setLvl1Setter(address userAddresss) internal {
        address[] storage array = level1[msg.sender].referred;
        array.push(userAddresss);
    }

    function setLvl2Setter(address userAddresss) internal {
        address[] storage array = level2[msg.sender].referred;
        array.push(userAddresss);
    }

    function setLvl3Setter(address userAddresss) internal {
        address[] storage array = level3[msg.sender].referred;
        array.push(userAddresss);
    }

    function setLvl4Setter(address userAddresss) internal {
        address[] storage array = level4[msg.sender].referred;
        array.push(userAddresss);
    }

    function setLvl5Setter(address userAddresss) internal {
        address[] storage array = level5[msg.sender].referred;
        array.push(userAddresss);
    }

    function setLvl6Setter(address userAddresss) internal {
        address[] storage array = level6[msg.sender].referred;
        array.push(userAddresss);
    }

    function setLvl7Setter(address userAddresss) internal {
        address[] storage array = level7[msg.sender].referred;
        array.push(userAddresss);
    }
