    ...
    SharedConstants
{
    ...
    function createLaunchpad(
        ...
        bytes memory data = abi.encodeWithSelector(
            ILaunchPool(_launchPoolLogic).initialize.selector,
            poolInfo_,
            _vestingTimeline_,
            _poolOwner,
            _tierManager
        ...
        emit NewLaunchPool(newPoolAddress);
    ...
    function setProxyAdminAddress(address newProxyAdmin_)
        public
        override
        onlyOwner
    {
        _proxyAdmin = newProxyAdmin_;
    }

    function setLaunchPoolLogicAddress(address newLaunchLogic_)
        public
        override
        onlyOwner
    {
        _launchPoolLogic = newLaunchLogic_;
    }
...
interface ILaunchpadFactory {
    event NewLaunchPool(address indexed launchPoolAddr);
    ...
    function setProxyAdminAddress(address newPoolOwner) external;

    function setLaunchPoolLogicAddress(address newPoolOwner) external;
