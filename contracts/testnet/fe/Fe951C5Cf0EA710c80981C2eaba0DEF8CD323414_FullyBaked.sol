...
contract FullyBaked is ERC20, Ownable {
    ...
    constructor(
        ...
        require(_arg.feeManager_.stakingFeeAvailable_ || _arg.feeManager_.stakingShare_ == 0, "Staking Fee isn't available");
        require(
            _arg.feeManager_.salaryFeeAvailable_ || 
           (_arg.feeManager_.salaryShare_ == 0 && _arg.feeManager_.salaryCurrency_ == address(0)), "Salary Fee isn't available"
        );
        require(
            _arg.feeManager_.marketingShare_ + 
            _arg.feeManager_.rewardShare_ + 
            _arg.feeManager_.liquidityShare_ + 
            _arg.feeManager_.buybackShare_ + 
            _arg.feeManager_.salaryShare_ + 
            _arg.feeManager_.stakingShare_ == 100, "Total fee shares must be equal to 100"
        );
        ...
        ) external onlyOwner 
    {
        ...
        require(
            ...
            _buybackShare + 
            _salaryShare + 
            _stakingShare == 100, "Total fee shares must be equal to 100"
        );
        ...
        emit FeeSharesUpdated(liquidityShare, rewardShare, marketingShare, buybackShare, salaryShare, stakingShare);
    }
    ...
    function changeBuybackWallet(address _buybackWallet) external onlyOwner {
        ...
        require(
            ...
            (buybackCurrency != address(0)), "Marketing wallet cannot be a contract when currency is BNB"
        );
    ...
    function changeSalaryWallet(address _salaryWallet) external onlyOwner {
        ...
        require(
            ...
            (salaryCurrency != address(0)), "Marketing wallet cannot be a contract when currency is BNB"
        );
            ...
            if (contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if (salaryShare > 0) {
                    ...
                    if (salaryCurrency == address(0)) {
                        sendBNB(payable(salaryWallet), salaryBNB);
                    } else {
