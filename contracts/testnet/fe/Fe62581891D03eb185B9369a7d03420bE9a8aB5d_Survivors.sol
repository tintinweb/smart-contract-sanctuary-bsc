...
contract Survivors is ERC1155Supply, Ownable {
    ...
    // function mint(uint256 amount, string memory hash)
    //     public
    //     onlyOwner
    ...
    //     _setTokenURI(hash, tokenId);
    //     emit Mint(newTokenId, amount, msg.sender);
    //     return newTokenId;
    // }

    // function mintNFT(uint256 amount, string memory hash)
    //     public
    //     payable
    //     returns (uint256 tokenId)
    // {
