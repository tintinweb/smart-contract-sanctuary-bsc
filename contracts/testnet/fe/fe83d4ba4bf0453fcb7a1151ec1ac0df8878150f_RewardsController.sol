...
// File @aave/core-v3/contracts/protocol/libraries/aave-upgradeability/[email protected]
...
abstract contract RewardsDistributor is IRewardsDistributor {
    ...
    returns (uint256)
  {
    ...
    console.log("RewardsDistributor -> getUserAccruedRewards");
    for (uint256 i = 0; i < _assetsList.length; i++) {
      console.log(_assetsList[i]);
      console.log(reward);
      console.log(user);
      console.log(_assets[_assetsList[i]].rewards[reward].usersData[user].accrued);
  ...
  function _invalidateReward(address asset, address reward) internal {
    uint128 availableRewardsCount = _assets[asset].availableRewardsCount;
    uint128 i = 0;
    for(; i < availableRewardsCount; i++) {
      console.log(_assets[asset].availableRewards[i]);
      if(_assets[asset].availableRewards[i] == reward) {
        _assets[asset].availableRewards[i] = _assets[asset].availableRewards[availableRewardsCount-1];
        _assets[asset].availableRewards[availableRewardsCount-1] = address(0);
        break;
      }
    }
    if(i < availableRewardsCount) {// Got it
      _assets[asset].availableRewardsCount--;
    }
  }
  ...
  function _configureAssets(RewardsDataTypes.RewardsConfigInput[] memory rewardsInput) internal {
    for (uint256 i = 0; i < rewardsInput.length; i++) {
      ...
      console.log("RewardsDistributor -> _configureAssets");
      console.log(decimals);
      console.log(rewardsInput[i].asset);
      ...
      console.log(rewardConfig.lastUpdateTimestamp);
  ...
  function _updateData(
    ...
    console.log("RewardsDistributor -> _updateData");
    console.log(asset);
    console.log(address(this));
    console.log(assetUnit);
    console.log(numAvailableRewards);
  ...
  function _getAssetIndex(
    ...
    console.log("RewardsDistributor -> _getAssetIndex");
    console.log(totalSupply);
    console.log(assetUnit);
    console.log(oldIndex);
    console.log(distributionEnd);
    console.log(emissionPerSecond);
...
interface IRewardsController is IRewardsDistributor {
  ...
  function invalidateReward(address asset, address reward) external;
}
...
contract RewardsController is RewardsDistributor, VersionedInitializable, IRewardsController {
  ...
  function configureAssets(RewardsDataTypes.RewardsConfigInput[] memory config)
    ...
    onlyEmissionManager
  {
    console.log("RewardsController -> configureAssets, config num:%d", config.length);
    for (uint256 i = 0; i < config.length; i++) {
      // Get the current Scaled Total Supply of AToken or Debt token
      // config[i].totalSupply = IScaledBalanceToken(config[i].asset).scaledTotalSupply();

      // 稳定债务 Token 根本没继承此接口
      // try IScaledBalanceToken(config[i].asset).scaledTotalSupply() returns (uint256 totalSupply) {
      //   config[i].totalSupply = totalSupply;
      ...
      console.log("RewardsController -> _installTransferStrategy OK");
      ...
      console.log("RewardsController -> _setRewardOracle OK");
    }
    _configureAssets(config);
    console.log("RewardsController OK");
  }
...
console.log("RewardsController -> _claimAllRewards");
    _updateDataMultiple(user, _getUserAssetBalances(assets, user));
...
console.log(asset);
console.log(rewardsList[j]);          
          _assets[asset].rewards[rewardsList[j]].usersData[user].accrued = 0;
console.log(_assets[asset].rewards[rewardsList[j]].usersData[user].accrued);          
        }
      }
    }
  ...
  function _transferRewards(
    ...
    console.log("RewardsController -> _transferRewards");
    console.log(address(this));
    console.log(address(transferStrategy));
  ...
  function invalidateReward(address asset, address reward) external override onlyEmissionManager {
    console.log("RewardsController -> invalidateReward");
    _invalidateReward(asset, reward);
  }
}