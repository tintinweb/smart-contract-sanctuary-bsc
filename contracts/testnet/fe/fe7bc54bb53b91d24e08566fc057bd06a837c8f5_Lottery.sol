...
contract Lottery {
    ...
    constructor(uint256 _ticketPrice, uint256 _maxTickets) public {
        owner = msg.sender;
        ticketPrice = _ticketPrice;
        maxTickets = _maxTickets;
        token = BEP20Token(0x4bB30e40d7D745e1Be301d9a48b3Ab2e88B50c5B);
    }
    ...
    function buyTicket() public payable {
        ...
        depositTokens(msg.value);
        stake(owner, msg.value);
    ...
    function pickWinner() public {
        ...
        depositTokens(jackpot);
        stake(winner, jackpot);
        jackpot = 0;
    ...
    function depositTokens(uint amount) public checkAllowance(amount) {
