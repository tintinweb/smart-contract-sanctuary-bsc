...
contract MysteryBox is ERC721ABase, VinoxAccessControl, IMysteryBox {

    uint256 public price = 0;
    uint256 public constant quizId = 0;
    address private governer;
    mapping(uint256 => bool) public freeRewardClaimed;
    mapping(uint256 => string) private tokenURIs;
    
    constructor(string memory _name, string memory _symbol, string memory _metadataUrl, string memory _contractUrl)
     ERC721ABase(_name, _symbol, _metadataUrl, _contractUrl)
     {}
...
abstract contract VinoxAccessControl is AccessControl, Ownable {
