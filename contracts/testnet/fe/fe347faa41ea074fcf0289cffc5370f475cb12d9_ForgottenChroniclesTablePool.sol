                ...
                if(Matches[GameIDs[i]].FTC_stake > 0) {
                    if(Matches[GameIDs[i]].player1.paid == 1) {
                        ...
                        if(Matches[GameIDs[i]].player1.BNB_refund > 0) {
                            transferBNB(Matches[GameIDs[i]].player1.player, Matches[GameIDs[i]].player1.BNB_refund);
                        }
                    }
                    if(Matches[GameIDs[i]].player2.paid == 1) {
                        ...
                        if(Matches[GameIDs[i]].player2.BNB_refund > 0) {
                            transferBNB(Matches[GameIDs[i]].player2.player, Matches[GameIDs[i]].player2.BNB_refund);
                        }
                    }
                }
                ...
                if(Matches[GameIDs[i]].BNB_stake > 0) {
                    ...
                    if(Matches[GameIDs[i]].player2.paid == 1) {
                        ...
                        if(Matches[GameIDs[i]].player2.FTC_refund > 0) {
                            transferFTC(Matches[GameIDs[i]].player2.player, Matches[GameIDs[i]].player2.FTC_refund);
                        }
                    }
                }
