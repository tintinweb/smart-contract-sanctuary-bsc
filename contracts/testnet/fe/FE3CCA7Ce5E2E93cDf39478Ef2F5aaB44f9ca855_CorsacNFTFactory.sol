    ...
    ReentrancyGuard 
{
    ...
    /**
     * @dev this function creates a new collection of ERC721, ERC1155 to the factory by user
     * @param collectionType - ERC721 = 0, ERC1155 = 1
     * @param _name - collection name
     * @param _symbol - collection symbol
     * @param _uri - base uri of NFT token metadata
     */
    function createNewCollectionByUser(
        ICorsacNFTFactory.CollectionType collectionType,
        string memory _name,
        string memory _symbol,
        string memory _uri
    ...
    /**
     * @dev this function creates/mints new NFT by user
     * @param collectionAddr - collection
     * @param _to - to account
     * @param uri - uri for NFT
     */
    function mintToByUser(address collectionAddr, address _to, string memory uri) external {
        require(collectionOccupation[collectionAddr] == true);
        IERC721Tradable(collectionAddr).mintTo(_to, uri);

        emit MintToByUser(collectionAddr, _to, uri);
    }
}
