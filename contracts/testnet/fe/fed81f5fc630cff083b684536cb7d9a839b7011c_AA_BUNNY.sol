...
contract AA_BUNNY is Context, IERC20 { 
    ...
    */
    ...
    uint256 public Track_Buy    = 1;
    uint256 public Track_Sell   = 1;
    uint256 public Track_P2P    = 1;
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        // Track Fees - try to take these on take fee by knowing if buy or sell
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 Split_Buy   = Track_Buy * 100 / (Track_Buy + Track_Sell + Track_P2P); 
        uint256 Split_Sell  = Track_Buy * 100 / (Track_Buy + Track_Sell + Track_P2P); 
        uint256 Split_P2P   = 100 - Split_Buy + Split_Sell;

        // Split CTB tokens
        uint256 CTB_BUY     = contractTokenBalance * Split_Buy / 100;
        uint256 CTB_SELL    = contractTokenBalance * Split_Sell / 100;
        uint256 CTB_P2P     = contractTokenBalance * Split_P2P / 100;

        // Calculate LP Tokens
        uint256 Tokens_L = ((CTB_BUY * _FeeBuyLiquidity / _Fee_on_Buys) + (CTB_SELL * _FeeSellLiquidity / _Fee_on_Sells) + (CTB_P2P * _Fee_P2P_Liquidity / _P2P_Fee))/2;

        // Calculate Marketing Tokens
        uint256 Tokens_M = (CTB_BUY * _FeeBuyMarketing / _Fee_on_Buys) + (CTB_SELL * _FeeSellMarketing / _Fee_on_Sells) + (CTB_P2P * _Fee_P2P_Marketing / _P2P_Fee);
    ...
    function reset_Trackers() external onlyOwner {
