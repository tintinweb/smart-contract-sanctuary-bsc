...
contract WealthBUSD is Context, Ownable , ReentrancyGuard {
    ...
    uint256 public constant max = 3000 ether;
    uint256 public roi = 4;
    uint256 public constant fee = 3;
    uint256 public constant ref_fee = 10;
    uint256 public withdrawDays = 0 days;
    uint256 public claimDays = 0 days;
    address private dev;
    ...
    constructor(address _dev,address _dev1,address _partner1,address _partner2,address _partner3) {
        tokenAdress = 0x61Ae56e7650EA3Caee32234b48830E8C31B70eD9;
