...
contract StarSmartSwap is Context, IERC20, Ownable {
    ...
    address payable private marketingWalletAddress = payable(0x84b214145CE4e5A6CE326FebEE42b777FE31dA28); // Marketing Address
    address payable public teamWalletAddress = payable(0x84b214145CE4e5A6CE326FebEE42b777FE31dA28); // Team Address
