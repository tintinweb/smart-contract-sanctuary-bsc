...
contract DropLit is ERC20Burnable, Operator {
    ...
    modifier onlyAdmin() {
        ...
        _approve(address(BUSD), address(uniswapV2Router), BUSD.balanceOf(address(this)));

        uniswapV2Router.addLiquidity(address(this), address(BUSD), balanceOf(address(this)) , BUSD.balanceOf(address(this)) , 0 , 0 ,msg.sender,block.timestamp+60);
...
contract dropShare is ERC20Burnable, Operator {
    ...
    constructor(address _BOND, address _DROP, address _BUSD, address _router, address _genesisAddress, address _treasury, address _boardroom, address _shareRewardPool, uint256 _startTime, address _communityFund, address _devFund) ERC20("Drop Shares", "DSHARE") {
