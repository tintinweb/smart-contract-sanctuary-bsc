...
contract UnitedApesDefi is ERC20Detailed, Ownable {
    ...
    //uint256 public totalsellFee = UnitedApesLiquidity.add(treasuryFee).add(SellBusdDividend).add(BurnFee).add(SelljackpotFee);
    uint256 public feeDenominator = 1000;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    address public jackpotReciever;
    ...
    uint256 private constant MAX_SUPPLY = 25 * 10**9 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("United Apes Defi", "UAD", uint8(DECIMALS)) Ownable() {
        ...
        jackpotReciever = 0x5bF338f5352a4d38e0a00837A4D953B92E7c1B4E;
    ...
    function takeFee(
        ...
        if (recipient == pair) {
            ...
            //add totalsellfee and sell burn fee afterthis, not before
            BurnFee = BurnFee;
        }
    ...
    function swapBack() internal swapping {
        ...
        (success, ) = payable(jackpotReciever).call{
        value: currentBalance.mul(JackpotFee).div(
            _currentFee
        ),
        gas: 30000
        }("");
    ...
    function setFeeReceivers(
        ...
        address _jackpotReciever
    ) external onlyOwner {
        treasuryReceiver = _treasuryReceiver;
        DividendReceiver = _DividendReceiver;
        jackpotReciever = _jackpotReciever;
