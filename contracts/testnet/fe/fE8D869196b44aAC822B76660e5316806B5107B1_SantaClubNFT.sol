...
contract SantaClubNFT is ERC721Enumerable, ReentrancyGuard {
    ...
    uint256 public constant MINT_PRICE = 0.25 ether; // 0.25 BNB
    ...
    modifier onlyOwner() {
        require(_owner == msg.sender, "SantaClubNFT: caller is not the owner");
        _;
    }
