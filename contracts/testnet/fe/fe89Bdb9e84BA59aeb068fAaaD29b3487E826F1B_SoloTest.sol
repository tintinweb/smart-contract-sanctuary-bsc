...
// File: contracts\SoloTest.sol

pragma solidity ^0.8.4;
contract SoloTest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "SOLOXToken";
    string private _symbol = "SOLOX";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress =
        payable(0xE4a90538FeF08Da6dB6f6d027B0F4eC3c4014a22); // Marketing Address
    address payable public teamWalletAddress =
        payable(0x8B2bDC0f5A3ae3e4052988E8aA86C615c50492f3); // Team Address
