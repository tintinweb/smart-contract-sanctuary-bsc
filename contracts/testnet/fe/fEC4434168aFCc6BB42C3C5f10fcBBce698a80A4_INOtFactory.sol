...
contract INOtFactory {
    function createINO(
        ...
        _initialize(_types, _supplies, _allocations, _lockTime, _tokens,
            _prices, _isLock, _projectId, _userLevel, _currency, _operator, _times, _projectAddress);
    ...
    function _initialize(
        ...
        bool check = InitialNFTOffering(_projectAddress).initialize(_types, _supplies, _allocations, _lockTime, _tokens,
            _prices, _isLock, _projectId, _userLevel, _currency, _operator, _times);
