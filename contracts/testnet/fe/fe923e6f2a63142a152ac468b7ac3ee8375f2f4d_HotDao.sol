...
contract HotDao is Context, IBEP20, Ownable, PancakeTool {
    ...
    address private _PancakeRouter = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    address[] private _lockAddress;
    address private _making;

    uint8 private _cPercent = 3;

    uint256 private divBase = 100;
    uint256 private size = 1000000000000000000;

    uint256 private _maxDeals = 70 * size;
    uint256 private _maxHold = 200 * size;

    uint256 private rewardMin = 80000000000000000000;
    ...
    function _beforeTransfer(
        ...
        if (sender == PancakePair && recipient == _PancakeRouter) {
            ...
            require(
                aBalance <= _maxHold,
                "The maximum number of holdings is 200"
            );
            ...
            require(amount <= _maxDeals, "The maximum number of deals is 70");
        } else {
            require(amount <= _maxDeals, "The maximum number of deals is 70");
            uint256 aBalance = _balances[recipient] + amount;
            require(
