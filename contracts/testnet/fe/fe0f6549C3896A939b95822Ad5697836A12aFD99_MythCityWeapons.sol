...
contract MythCityWeapons is ERC721 {
        ...
        returns (bool)
    {
        ...
        delete weaponStats[_degenId].degenIdEquipped;
    ...
    function mint(
        ...
        emit weaponMinted(_to, _imageId, _weaponCore, _weaponDamage);
    ...
    function changeWeapon(uint256 _id, string calldata _url)
        external
        isWhitelisted
    {
        emit weaponAdded(_id, _url);
        weaponExists[_id] = true;
        weaponURL[_id] = _url;
    }
}
