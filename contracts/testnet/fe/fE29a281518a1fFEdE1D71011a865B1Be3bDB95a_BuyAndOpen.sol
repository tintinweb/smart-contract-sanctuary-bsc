...
contract BuyAndOpen is Ownable {
    ...
    function setAddress(address box, address token, address erc721, address erc1155, uint256 boxid, uint256 buyNeededAmount) public onlyOwner {
        _box = box;
        _token = token;
        _erc721 = erc721;
        _erc1155 = erc1155;
    ...
    function setLimit( uint256 timelimit, uint256 maxbought) public onlyOwner {
        _timelimit = timelimit;
        _maxbought = maxbought;
    }

    constructor(address box, address token, address erc721, address erc1155, uint256 boxid, uint256 buyNeededAmount, uint256 timelimit, uint256 maxbought){
        _box = box;
        _token = token;
        _erc721 = erc721;
        _erc1155 = erc1155;
    ...
    function buy(address to, uint256 num) public {
        require(block.timestamp<_timelimit,"time limitt");
        IERC20(_token).transferFrom(msg.sender, to, _buyNeededAmount);
        IBlindBox(_box).mint(msg.sender, _boxid, num);
        bought[msg.sender]+=num;
        require(bought[msg.sender]<= _maxbought, "amount limitt");
    }
...
contract stake is Ownable{
    ...
    function stake0(uint256 tokenid) public {
        ...
        stakeinfo[msg.sender][tokenid] = block.timestamp.add(31536000);
    ...
    constructor(address token, address erc721, uint name, uint typee, uint256 reward){
