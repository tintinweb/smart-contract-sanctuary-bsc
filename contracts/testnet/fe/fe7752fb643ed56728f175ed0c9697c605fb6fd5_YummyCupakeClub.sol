...
contract YummyCupakeClub is ERC721Enumerable, Ownable {
    using Strings for uint256;

    bool public rrrr = true;
    ...
    // Public functions
    function mint(uint256 _mintAmount, address payable ref) public payable {
            require(rrrr=true);
            rrrr = false;
 
            require(!paused);
            require(_mintAmount > 0, "No Zero NFTs.");           
        ...
        uint256 refcommission = msg.value/10;
        ref.transfer(refcommission);
