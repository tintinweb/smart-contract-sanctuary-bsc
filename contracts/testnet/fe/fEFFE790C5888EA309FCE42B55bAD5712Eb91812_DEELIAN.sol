...
contract DEELIAN {
    ...
    mapping (address => uint) public return_on_investment; ////mapping of address to return_on_investment
...
////////////////////////////////////////////////////////////////////////////////////////////
///
    function setTokenNovuxa_address(address x) public {
     require(msg.sender == owner, "Only the owner can update Deelian Price.");
    TokenNovuxa = x;
   }

    function getTokenNovuxa_address() public view returns (address) {
...
////////////////////////////////////////////////////////////////////////////////////////////////               
     ...
     event Payment(uint indexed date, address indexed to, uint amount, uint price);
 ...
 //    emit  terminatenclproposal(now, msg.sender, ncl_investment[msg.sender], deelian_price);
    ...
    constructor() public {
        ...
        _token_ = NOVUXA(TokenNovuxa);
    
 }

///////////////////////THIS FUNCTION GETS DEEALIAN PRICE FROM NOVUXA CONTRACT//////////////////
 function  deelian_pricex() external view returns(uint) {
        _token_.nouvaxa_price();
...
///////////////////////////////////////////////////////////////////////////////////////////////////////
       ...
       function dtrading(uint amount) public  {
        ...
        return_on_investment [msg.sender] = ((ee_deelian[msg.sender]*tkd)/deelian_price);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////  
    function payment() public  {           
       ...
       balances[msg.sender] = (balances[msg.sender] + ((ee_deelian[msg.sender]*tkd)/deelian_price));
        ...
        return_on_investment [msg.sender]= 0;
      emit  Payment(now, msg.sender, (((ee_deelian[msg.sender]*tkd)/deelian_price)), deelian_price);
