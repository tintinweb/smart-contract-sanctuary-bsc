...
contract Params is Initializable,OwnableUpgradeable {
    ...
    function initialize()public initializer{
        console.log("start in initialize funciton of implementV1 contract: ");
		__Context_init_unchained();
		__Ownable_init_unchained();
        console.log("end in initialize funciton of implementV1 contract: ");
	}
    ...
    function SetUint256Param(string memory _key,uint256 _value) external onlyOwner{
        console.log("start in SetUint256Param funciton of implementV1 contract: ");
        uint256Params[_key] = _value;
        emit Uint256ParamSetted(_key,_value);
        console.log("end in SetUint256Param funciton of implementV1 contract: ");
    }


    function GetUint256Param(string memory _key)public view returns(uint256){
        console.log("in GetUint256Param funciton of implementV1 contract: ");
