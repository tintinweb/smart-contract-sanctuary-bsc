...
contract SargonBank is ERC20Detailed, IDividendTracker, Ownable{
    using SafeMath for uint256;
    using SafeMathInt for int256;
    uint256 private constant DECIMALS = 18;
    ERC20Detailed public sargonToken;
    ...
    uint256 public rewardYield = 2145500;
    uint256 public rewardYieldDenominator = 10000000000;
    uint256 private constant MAX_UINT256 = ~uint256(0);
    /*attribute        */
    address private constant ZERO = 0x0000000000000000000000000000000000000000;
    address private constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address private _sargonAdd = 0x0Aaf43EF047992b7332317F29d33112F0f3c0b4e;
    ...
    /*constructor */
    constructor() ERC20Detailed("Sargon Bank", "Sargon Finance", uint8(DECIMALS)) {
        sargonToken = ERC20Detailed(_sargonAdd);
    ...
    function unlock(address account) public returns(bool) {
        ...
        require(transferFrom(ZERO, account, xamount), "Transfer Failed");
    ...
    function updateRewards() public override onlyOwner {
        ...
        uint256 rewardedRate = rewardYield.div(rewardYieldDenominator);
        for (uint256 i = 0; i < _currentAcc.length; i++) {
                uint256 reward = (_gonBalances[_currentAcc[i]].add(_gonLockBalance[_currentAcc[i]])).mul(rewardedRate);
                _gonBalances[_currentAcc[i]] = _gonBalances[_currentAcc[i]].add(reward);
                _rewardedBalances[_currentAcc[i]] = _rewardedBalances[_currentAcc[i]].add(reward);
