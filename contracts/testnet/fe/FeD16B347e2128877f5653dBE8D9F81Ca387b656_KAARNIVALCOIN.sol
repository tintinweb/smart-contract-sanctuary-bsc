...
contract KAARNIVALCOIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("KAARNIVAL COIN", "KNC", 18) {
    ...
    function _setAutomatedMarketMakerPair(address _pair, bool value) private {
        require(automatedMarketMakerPairs[_pair] != value, "KNC: Automated market maker pair is already set to that value");
    ...
    function _transfer(
        ...
        require(!_isBot[to] || !_isBot[from], "KNC: To/from address is ignored");
