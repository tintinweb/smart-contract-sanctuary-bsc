...
contract Megatech is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, ERC20Permit, ERC20Votes {
    constructor() ERC20("testMGT", "MGT") ERC20Permit("Megatech") {
        _mint(msg.sender, 177000000 * 10 ** decimals());
    }
