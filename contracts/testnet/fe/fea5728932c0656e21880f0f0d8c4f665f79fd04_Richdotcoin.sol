...
contract Richdotcoin is Context, IERC20, Ownable {
    ...
    mapping(address => uint) public treasuryeOf;
    ...
    function stake(uint _amount) external updateReward(msg.sender) {
        ...
        treasuryeOf[msg.sender] + _amount;
        treasuryeOf[address(this)] + _amount;
    ...
    function withdraw(uint _amount) external updateReward(msg.sender) {
        ...
        treasuryeOf[msg.sender] - _amount;
        treasuryeOf[address(this)] - _amount*90/100;
        _transfer(address(this),msg.sender, _amount*90/100);
    }
