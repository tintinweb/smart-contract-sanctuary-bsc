...
contract Storm is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 15 * 10**6 * 10**3;
    ...
    address public charityWallet = 0xFfD6BF08968CCb542E6Ecc24B3A5a5B8eAf09099;
    ...
    uint256 public _maxTxAmount = 105 * 10**2 * 10**3;
    uint256 private numTokensSellToAddToLiquidity = 105 * 10**1 * 10**3;
