...
contract Test is IBEP20, Auth {
    ...
    address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //Pancake ROUTER
    ...
    uint256 public totalFees     = BNBRewardsFee + developmentFee + lotteryFee + liquidityFee;
    uint256 public feeDenominator = 1000;
    uint256 public reducedFeePercentage = 0;

    address public devWallet = 0xD733289Ccb78CdC849d0C2cd9dB6F0D727123DCE;
    ...
    function setFeeRates(uint256 _BNBRewardsFee, uint256 _liquidityFee, uint256 _developmentFee,  uint256 _lotteryFee, uint256 _feeDenominator) public onlyOwner {
            BNBRewardsFee = _BNBRewardsFee;
            liquidityFee = _liquidityFee;
            developmentFee = _developmentFee;
            lotteryFee = _lotteryFee;
            totalFees = _BNBRewardsFee + _liquidityFee + _developmentFee + _lotteryFee;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(isVested[sender] && blocksSinceStart < lockdays){
                revert("Vested wallets cannot send for 0 days");
            }
