...
contract TutorialERC1155 is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    constructor() ERC1155("https://ipfs.thirdweb.com/ipfs/QmecgHz9dM171cR4JxSaw2B3uzWtQvLYjhBzNZJ3N1EX2c/") {}

    function uri(uint256 tokenId) public view virtual override returns (string memory){
        return(string(abi.encodePacked("https://ipfs.thirdweb.com/ipfs/QmecgHz9dM171cR4JxSaw2B3uzWtQvLYjhBzNZJ3N1EX2c/", Strings.toString(tokenId), ".json")));
    }
...
contract TutorialERC721 is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://ipfs.thirdweb.com/ipfs/QmecgHz9dM171cR4JxSaw2B3uzWtQvLYjhBzNZJ3N1EX2c/";
    }
...
contract TutorialERC20 is Context, IERC20, Ownable{
    ...
    TutorialERC721 _erc721 = TutorialERC721(0x6cd16F8C4e9930D5f84b7eCc8A0A744b940e0367);                                // ERC721 Contract
    TutorialERC1155 _erc1155 = TutorialERC1155(0x4Ac1071dde58316C5eCE2c23E20B8965c14Ec0e7);                              // ERC1155 Contract
    address private _gameAddress = 0xF81630789dE516c0354f24E63b98c61dDaFf924a;                                              // Game Wallet
