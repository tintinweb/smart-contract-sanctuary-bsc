...
// File contracts/OBridgeERC20.sol
...
contract OBridgeERC20 is ERC20, Ownable, MinterRole {
    ...
    constructor(string memory _name, string memory _symbol, address _orgToken, address _routerAddress, uint8 _decimal) ERC20(_name, _symbol) {
        orgToken = _orgToken;
        decimal = _decimal;
