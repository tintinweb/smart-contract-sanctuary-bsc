...
contract HeroCoreMarketPlace is OwnableUpgradeable, PausableUpgradeable  {
    struct Auction {
        uint256 highestBid;
        uint256 closingTime;
    ...
    function initByOwner(HeroCoreNFT _heroCoreNFT, address _tokenBEP20) public onlyOwner{
    ...
    function closeAuctionSudden(uint256 _nftId) external whenNotPaused {
        ...
        heroCoreNFT.transfer(_nftId, auctions[_nftId].originalOwner);
...
function openAuction(
        ...
        require(heroCoreNFT.ownerOf(_nftId) == msg.sender, "Not NFT owner");
        heroCoreNFT.approveMarketPlace(address(this),_nftId);
        // NFT Transfer to contract
        heroCoreNFT.transfer(_nftId, address(this));
    ...
    function buy(uint256 _nftId, uint256 _amount) external whenNotPaused {
        ...
        // Transfer NFT to Highest Bidder
        heroCoreNFT.transfer(_nftId, auctions[_nftId].highestBidder);
    ...
    function setHeroCoreNFT(HeroCoreNFT _heroCoreNFT) public onlyOwner{
    heroCoreNFT=_heroCoreNFT;
    }
