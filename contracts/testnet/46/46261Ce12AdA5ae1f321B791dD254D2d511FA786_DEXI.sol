...
contract DEXI is IERC20, Ownable {
    ...
    uint256 public numTokensToExchangeForMarketing = initialSupply.div(100).div(100);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        if(!takeFee) {
            ...
            if (enableTaxOnlyForSell && recipient == uniswapV2Pair){
                _transferTaxed(sender, recipient, amount, sellTax);
            } else if (enableTaxOnlyForBuy && sender == uniswapV2Pair) {
