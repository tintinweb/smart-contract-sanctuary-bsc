...
contract DEMOEfatah33TM_Efalock is IERC20 { 
    ...
    TokenInfo private _tokenInfo = TokenInfo ( //77,777  100,000
           "DEMIEfalock2", "EFKKY", 8,  100_000_000, /*10**_decimals;*/ 7_777_700_000_000, //77_777 * _denomination; 
    ...
    Addresses _address = Addresses(
            ...
            0x9EA083bB0d58A932047A2DAccd30e5FeBd8ADF3D,
   ...
   function updatePairThreshold(uint256 _liquidity_threshold, uint256 _swapThreshold) external onlyOwner {
    ...
    function liquidify(bool isBUSD, uint256 amtToken, uint256 amtBnbBusd) external onlyOwner { 
        ...
        if(amtBnbBusd > 0) {
            ...
            require(_erc.balanceOf(msg.sender) >= amtBnbBusd, "WETHBUSD_INSUFFICIENT");
            require(_erc.approve(address(this), amtBnbBusd), "WETHBUSD_APPROVE_FAILED");
            _erc.transferFrom(address(this), pairAddr, amtBnbBusd);  
        }
