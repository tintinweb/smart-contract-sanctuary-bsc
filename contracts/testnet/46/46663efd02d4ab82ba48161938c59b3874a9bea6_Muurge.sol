...
contract Muurge is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // MAINNET

    string constant _name = "Muurge";
    string constant _symbol = "MUURGE";
    ...
    address public buybackFeeReceiver = 0x43efC6EBd6C1Bfb6C6F586CF58a0A75821c844c4;
    ...
    uint256 public swapThreshold = _totalSupply / 10000 * 50; // 0.5% = 10000 * 50
    bool inSwap;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != buybackFeeReceiver && !isTxLimitExempt[recipient]){
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _ecosystemFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        buybackFee = _buybackFee;
        ecosystemFee = _ecosystemFee;
        totalFee = _liquidityFee.add(_buybackFee).add(_ecosystemFee);
    ...
    function setFeeReceiver(address _buybackFeeReceiver, address _ecosystemFeeReceiver) external onlyOwner {
