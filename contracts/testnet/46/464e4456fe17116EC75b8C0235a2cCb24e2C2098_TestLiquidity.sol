...
contract TestLiquidity is ERC20, Ownable {
    ...
    constructor() ERC20("TestLiquidity", "TLIQ") {
        ...
        minTokensBeforeSwap = 10000 * (10**decimals());
    ...
    function _transferToken(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            if (to == pair) {
                ...
                uint256 newAmount = amount.sub(amountFees);
                require(
                    amount == (newAmount.add(amountFees)),
