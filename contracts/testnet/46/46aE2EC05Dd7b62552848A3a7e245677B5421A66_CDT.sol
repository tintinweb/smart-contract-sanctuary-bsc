...
/**
  ...
  #PROTOCOL-AMAZON-COIN-SUPER features:
   10% fee automatically added to the liquidity pool to lock in forever when selling;
   3% for marketing;
   1% self-distributed fee for all cardholders;
   1% is sent to the black hole so that the token is emptied on each transaction;
   99,99% Supply is burned at first.

  #Distribution:
  3% for developers;
  12% for reforestation project;
  16% for GAME NFT;
...
contract CDT is Context, IERC20, Ownable {
    ...
    //////////////////////////////////////////////////////////////////////////////////////
    address private _marketWalletAddress = 0xBEf774c3a359108a1E43b5DeE9ddF8B18F62188D;
    //////////////////////////////////////////////////////////////////////////////////////
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "cavalodetroia";
    ...
    //////////////////////////////////////////////////////////////////////////////////////////
    //
    // Developers' wallet: "0x3b72330339AD38d51abACeED836eCE053e1cfcd3";
    //
    // Reforestation Project Wallet: "0x8848E98e490D7b5c57F2a7604C67A18533a6B9c7";
    //
    ///////////////////////////////////////////////////////////////////////////////////////////
    ...
    function _takeMarket(uint256 tMarket) private {
        uint256 currentRate =  _getRate();
        uint256 rMarket = tMarket.mul(currentRate);
        _rOwned[_marketWalletAddress] = _rOwned[_marketWalletAddress].add(rMarket);
        if(_isExcluded[_marketWalletAddress])
            _tOwned[_marketWalletAddress] = _tOwned[_marketWalletAddress].add(tMarket);
    }
