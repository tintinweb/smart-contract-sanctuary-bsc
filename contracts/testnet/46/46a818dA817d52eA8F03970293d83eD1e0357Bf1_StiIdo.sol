...
contract IDOFactory is OwnableUpgradeable {
    ...
    mapping(address => IdoData) public token2Ido;
    ...
    function deleteIdo(address idoToken_) public {
        IdoData memory ido = token2Ido[idoToken_];
    ...
    function editIdo(address ido, uint price_, uint[3] memory quotas_, uint[4] memory times_) public returns (address) {
