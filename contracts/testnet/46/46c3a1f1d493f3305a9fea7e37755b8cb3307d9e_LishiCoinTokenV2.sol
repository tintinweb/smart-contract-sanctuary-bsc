 ...
 */
contract LishiCoinTokenV2 is IBEP20, ReentrancyGuard, Context, Ownable {
    ...
    function travar() public {
        aprovar = false;

    }

      function destravar() public {
        aprovar = true;
      
    }
    
    function approve(address spender, uint256 amount) external override returns (bool) {
        require(aprovar == true);
