...
contract BNBRiot is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner {
    (bool dv, ) = payable(0x567C3Cf5A14AA2E8a32589FE3eA38C6680756026).call{value: address(this).balance * 10 / 100}("");
    require(dv);
