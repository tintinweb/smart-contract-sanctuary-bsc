...
/**
 *Submitted for verification at BscScan.com on this day hihihihi
*/
...
contract Pantherzyy {
    ...
    uint256 public launch = 600; //2022-10-15 16:00:00 UTC
    ...
    function changeParams(PARAM what, uint256 value) external onlyManager() returns ( bool )  {
      ...
      if(what == PARAM.REF_PERCENT) {
        require(value >= 30, 'Min referral percent is 3%');
        refPercentage = value;
    ...
    constructor() {
        ...
        PercsKey[0] = DivPercs(0*secsInDay,  15); //between 0 and 10 => 1%
        PercsKey[1] = DivPercs(10*secsInDay, 15); //between 10 and 20 => 1% 
        ...
        BUSD = IERC20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); // Testnet: IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); 
    }
    ...
    function airdropUser(address account, uint256 amount) external onlyManager() {
