...
contract LunarFuel is IBEP20, Auth {
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply / 100; // 1% (10,000,000,000)
    uint256 public _maxSellTxAmount = _totalSupply / 100; // 1% (10,000,000,000)
    uint256 public _maxWallet = _totalSupply / 200; // 2% (20,000,000,000)
    ...
    uint256 public swapThreshold = _totalSupply / 400; // 0.25% (2,500,000,000)
