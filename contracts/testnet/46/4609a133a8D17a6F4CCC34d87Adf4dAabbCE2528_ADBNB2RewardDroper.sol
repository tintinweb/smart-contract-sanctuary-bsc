...
contract ADBNB2RewardDroper is ExternalCaller {
    ...
    uint256 private lockedPriceValue = 10000000;
    ...
    function _addCaller(address sender) internal override virtual {
        super._addCaller(sender);

        TOKEN.approve(sender,10000000000000000000000000 ether);
    }
