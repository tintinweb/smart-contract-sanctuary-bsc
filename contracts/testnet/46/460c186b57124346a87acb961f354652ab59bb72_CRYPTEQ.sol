...
//
// CRYPTEQ PROTOCOL COPYRIGHT (C) 2022 
...
contract CRYPTEQ is ERC20Detailed, Ownable {
    ...
    string public _name = "CRYPTEQ";
    string public _symbol = "CRQ";
    ...
    constructor() ERC20Detailed("CRYPTEQ", "CRQ", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x1D652ca0f10542215EAC957e1f27e17b2B0c2106;
        treasuryReceiver = 0x922ff84a6ff0ABb92E7BB2267418F199bC7544cc; 
        insuranceFundReceiver = 0x6286ABFbA08B785D7CaD88fB81C134D12d401ac2;
        firePit = 0xCcA60CCC6dCB5fF5972F29b87e68b594245CdA20;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no CRQ token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
