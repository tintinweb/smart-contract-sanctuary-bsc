...
//    address public busdToken = 0xe9e7cea3dedca5984780bafc599bd69add087d56; //mainnet
    ...
    */
    ...
    function showMyLimit() public returns (uint256 yourLimit) {
        (uint256 myLimit,) = protector.getMaxTokenAllowedToSell(msg.sender);
        return myLimit;
    }
...
interface IProtector {
    function getMaxTokenAllowedToSell(address whoWantsToSell) external returns (uint256 maxTokens, uint256 maxTokensFilter);
    function getMyAddress() external returns (address who);
}
