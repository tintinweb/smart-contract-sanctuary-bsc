...
contract XYZ is ERC20Detailed, Ownable {
    ...
    address public liquidityReceiver = 0x8C826a0dAFb295788E71E15feaC90b09d7C48936;
    address public treasuryReceiver = 0x487db7293CE82f3dd9485cc6594b6a2055Cb9828;
    address public riskFreeValueReceiver = 0x58fff3935514f9492D4c4084618B690FFA3c57A6;
    address public busdToken = 0xCF1AeCc287027f797b99650B1E020fFa0fb0e248 ;
    ...
    uint256 private _previousBuyFeeRFV = buyFeeRFV;
    ...
    constructor() ERC20Detailed("XYZ", "xyz", uint8(DECIMALS)) {
    ...
    function removeBuyFee() external onlyOwner {
        if(liquidityFee == 0 && treasuryFee ==0 && buyFeeRFV==0) return;
        
        
        _previousLiquidityFee = liquidityFee;
        _previousTreasuryFee = treasuryFee;
        _previousBuyFeeRFV = buyFeeRFV;
    ...
    function restoreBuyFee() external onlyOwner {
       liquidityFee = _previousLiquidityFee;
       treasuryFee = _previousTreasuryFee;
       buyFeeRFV = _previousBuyFeeRFV;
    }
