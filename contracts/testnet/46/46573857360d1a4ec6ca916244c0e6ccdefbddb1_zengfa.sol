...
contract zengfa is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "zengfa";
    string private _symbol = "zengfa";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xA1e7F52cf9aBcC38BAe90b7B0db5737959E37679));
        marketingWalletAddress = payable(address(0xA1e7F52cf9aBcC38BAe90b7B0db5737959E37679));
