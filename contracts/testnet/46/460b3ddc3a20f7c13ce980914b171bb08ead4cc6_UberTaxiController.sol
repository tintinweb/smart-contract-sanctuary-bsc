...
contract UberTaxiController is Ownable {
    ...
    struct Vehicle {
        ...
        uint256 taixlimited; //taix限购数量

        uint256 utaixlimited; //utaix限购数量
    ...
    constructor() {
        ...
        UTN = UberTaxiNFT(0x6DA5B5278eA434053D149b275ffdE0ccD09d7ff0);

        ids = 10000;

        myaddress = msg.sender;

        TAXI20 = ERC20(0x6549A7Ce3e6D7548fCbB150181cc209E9bE9e0e4);
        ...
        //初始化车辆
        vehicles[1] = Vehicle("Volkswagen",   1, 1000*10**6, 1000*10**6, 5*10, true, 5, 100);
        vehicles[2] = Vehicle("Tesla",        2, 2000*10**6, 2000*10**6, 5.2*10, true, 5, 100);
        vehicles[3] = Vehicle("Audi",         3, 3000*10**6, 3000*10**6, 5.4*10, false, 5, 100);
        vehicles[4] = Vehicle("BMW",          4, 4000*10**6, 4000*10**6, 5.6*10, false, 5, 100);
        vehicles[5] = Vehicle("MercedesBenz", 5, 5000*10**6, 5000*10**6, 5.8*10, false, 5, 100);
        vehicles[6] = Vehicle("RollsRoyce",   6, 10000*10**6, 10000*10**6, 6*10, false, 5, 100);
    }
    ...
    function testUserUtaix() public {
        users[msg.sender].UTAXINum = 10000;
    }
