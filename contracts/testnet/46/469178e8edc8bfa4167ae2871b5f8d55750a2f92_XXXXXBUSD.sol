...
contract XXXXXBUSD is ReentrancyGuard {

    using SafeERC20 for IERC20;
    //address private tokenAddr = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; mainnet
    address private tokenAddr = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; //testnet
    IERC20 public token;
	...
	constructor() {
		//ceoWallet = payable(0x05E3eECD7506CDA1d8a05C6c7ce8DD71cBDFbFC4); mainnet
        ceoWallet = payable(0x47b70fd05C0733D545100F641f40c87eE51A2003); //testnet
		//devWallet = payable(0xb02cBb877479a14541A9ef1B2D7b5c286804aE0F); mainnet
	...
	function getUserInfo(address userAddress) public view returns(uint256 checkpoint, uint256 totalDeposit, uint256 totalWithdrawn, uint256 totalReferrals, uint256 userBonus, uint256 userTotalBonus, uint256 userReserve) {
