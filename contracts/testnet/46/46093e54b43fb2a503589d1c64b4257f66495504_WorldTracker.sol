...
contract WorldTracker is ERC20, Ownable {
    ...
    WorldTrackerDividendTracker public dividendTracker;

    address public constant deadWallet = 0x000000000000000000000000000000000000dEaD;
    address private marketingWallet = 0x3f790f07065Fd1C05b862133d9786Fff642D3891;
    address private opsWallet = 0xba87215F6a65388066962b40AB4fB0318c49Ca06;
    address private devWallet = 0x25f905372dB15C311f05d37cfA9434C90a73153c;
    ...
    Taxes public buyTaxes = Taxes(2, 5, 3, 0, 1);
    Taxes public sellTaxes = Taxes(2, 5, 3, 0, 1);
    ...
    constructor() ERC20("World Tracker", "WDT") {
        dividendTracker = new WorldTrackerDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        WorldTrackerDividendTracker newDividendTracker = WorldTrackerDividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "WorldTracker: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setBuyTaxes(
        ...
        require((_rewards + _marketing + _ops + _liquidity + _dev) <= 30, "Must keep fees at 30% or less");
    }
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "WorldTracker: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[newPair] = value;
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "WorldTracker: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "WorldTracker: Cannot update gasForProcessing to same value"
        );
...
contract WorldTrackerDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("WorldTracker_Dividen_Tracker", "WorldTracker_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "WorldTracker_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "WorldTracker_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "WorldTracker_Dividend_Tracker: Cannot update claimWait to same value"
        );
