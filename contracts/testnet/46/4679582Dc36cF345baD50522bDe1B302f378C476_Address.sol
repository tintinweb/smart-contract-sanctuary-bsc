...
𝐓𝐄𝐋𝐄𝐆𝐑𝐀𝐌: https://t.me/CryptoRacerMiami

Website: htts://CryptoRacerCoin.com
...
contract CryptoRacerCoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x89A50723d027556E3126129474dbFE46526D9b1e); 
    address payable public Wallet_Team = payable(0x723B865C813AbbB0BE895c7cBE58EE75811A293C);
    ...
    string private constant _name = "Crypto Racer Coin"; 
    string private constant _symbol = unicode"CryptoRacerCoin"; 
    ...
    uint256 public Percent_Bear = 70;
    ...
    constructor () {
        ...
        _owner = 0x1c2b84d1A8ff2364a01321727A9D47e6623f6986;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_M = contractTokenBalance * Percent_Bear / 100;
            ...
            uint256 split_M = Percent_Bear * 100 / (Percent_AutoLP + Percent_Bear + Percent_Dev);
            uint256 BNB_M = BNB_Total * split_M / 100;

            uint256 split_D = Percent_Dev * 100 / (Percent_AutoLP + Percent_Bear + Percent_Dev);
