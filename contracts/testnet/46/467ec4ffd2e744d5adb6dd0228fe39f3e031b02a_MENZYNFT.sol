    ...
    ConfirmedOwner
{
    ...
    function requestRandomWords() public returns (uint256 requestId) {
        ...
        number = s_requests[requestId].randomWords[0];
        return numWords;
    }
    ...
    function buyNFT(
        ...
        require(msg.value >= _price, "Price is not set");
        minting(to, _tokenURI);
        valueTransfer(_price, address(this));
    }
    ...
    function transferFrom(
        ...
        valueTransfer(fee, address(this));
        valueTransfer(price, from);
    }
    ...
    function getEasy() public returns (uint256 _random) {
        requestRandomWords();
        uint256 random = getRequestStatus(lastRequestId);
