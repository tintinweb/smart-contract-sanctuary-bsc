 ...
 * @author Evry.Finance
 */
contract EBep20 is EToken, EBep20Interface, EProxyStorage {
    /**
    ...
    function init(address underlying_,
        ...
        initialize(comptroller_, interestRateModel_, initialExchangeRateMantissa_, name_, symbol_, decimals_, depositAllowed_, borrowAllowed_, onlyWhiteListAllowToDeposit_, whiteListDepositAccount_);
