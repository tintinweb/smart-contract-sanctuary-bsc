...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public xmasDate = 1668286032; //1671997113;
    uint256 public minDistribution = 500000000000; //5 * (10 ** 12); // 5 busd
    ...
    function setDistributionCriteria(
        ...
        if(_xmasDate != 0) xmasDate = _xmasDate;
        minPeriod = _minPeriod;
        minDistribution = _minDistribution;
    }

    function deposit() external payable override onlyToken {
        // uint256 balanceBefore = _WBNB.balanceOf(address(this));
    ...
    function distributeXmaxDividend(address shareholder) internal {
        ...
        if (xmaxAmount > 0) {
            ...
            _WBNB.transfer(shareholder, xmaxAmount);
            shareholderClaims[shareholder] = block.timestamp;
            shares[shareholder].totalRealised = shares[shareholder]
                .totalRealised
                .add(xmaxAmount);
...
contract DeerRun is IBEP20, Ownable {
    ...
    function setDistributionCriteria(
        ...
        distributor.setDistributionCriteria(_minPeriod, _minDistribution, _xmasDate);
    }
