...
contract BNBInvestCommon11{
	...
	function walletBalanceOf(address userAddress)public view returns (uint256 amount){
		uint256 totalwallet_balance  = balanceOf[userAddress] - getUserBetPlayAmount(userAddress);
		return totalwallet_balance;
	}
