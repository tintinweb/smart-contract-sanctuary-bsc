...
contract ArbSwapper {
    ...
    function printCrypto(address buyDEXRouterAddress, address sellDEXRouterAddress, address baseToken, address tokenToArb) public payable onlyOwner {
        ...
        buyDEXRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            buyDEXRouter.getAmountsOut(IERC20(baseToken).balanceOf(address(this)), getPathFromTokenToToken(baseToken, tokenToArb))[baseToken == wethAddress ? 1 : 2],
            0,
        ...
        sellDEXRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            buyDEXRouter.getAmountsOut(IERC20(tokenToArb).balanceOf(address(this)), getPathFromTokenToToken(tokenToArb, baseToken))[baseToken == wethAddress ? 1 : 2],
            0,
