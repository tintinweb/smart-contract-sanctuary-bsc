...
contract Fuli is ERC20Detailed, Ownable {
    ...
    uint256 public constant Fuli_MIN_AMOUNT = 10000 * 1e8;
    uint256 public constant FuliD_MIN_AMOUNT = 1e8;
    ...
    constructor(uint256 _initSupply, uint256 _minFuliAmount,uint256 _rebaseInterval)
        ERC20Detailed(_name, _symbol, uint8(_decimals))
        Ownable()
    {
    ...
    function _transfer(
        ...
        //将能量或者代币数量统一输出为代币数量，用代币数量作为交换标准，而不是用能量作为交换标准；
