...
import "../../token/MiranaERC721V2.sol";
import "./MinimalMiranaBaseCollectionV2.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";

contract ERC721MiranaCollectionV2 is Initializable, MinimalMiranaBaseCollectionV2 {
  function initialize(
    address _originAddress,
    address _transferProxy,
    address _lazyTransferProxy,
    address _royaltiesRegister
  ) public initializer {
  ...
  function createCollection(
    ...
    MiranaERC721V2 token = MiranaERC721V2(minimalAddress);
    token.initialize(
      tokenName,
      tokenSymbol,
      baseTokenURI,
...
import "./ERC721LazyMinimalV2.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";

contract MiranaERC721V2 is Initializable, ERC721LazyMinimalV2 {
  ...
  function initialize(
    ...
    __ERC721Lazy_init(royaltiesResgister);
...
abstract contract ERC721LazyMinimalV2 is
  IERC721LazyMint,
  ...
  OwnableUpgradeable
{
  ...
  function __ERC721Lazy_init(address _addRoy) internal onlyInitializing {
   __ERC721Lazy_init_unchained(_addRoy);
  }

  function __ERC721Lazy_init_unchained(address _addRoy) internal onlyInitializing {
    addRoy = _addRoy;
  }
