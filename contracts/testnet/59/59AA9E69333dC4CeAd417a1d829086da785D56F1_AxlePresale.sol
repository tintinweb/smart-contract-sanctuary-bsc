...
contract AxlePresale is Ownable {
    ...
    uint256 public bonusRewardpercentage = 25;

    //@dev ERC20 token address and decimals
    address payable public mainWallet = payable(0x46D3099487DDcf724df70ed11b40109dAb586F79);
    address public tokenAddress=0x35dEeB01504372443002CdDc53DB6Aa1f3e25622;
    uint256 public tokenDecimals = 9;

    //@dev amount of tokens per ether 100 indicates 1 token per eth
    uint256 public tokenRatePerEth = 75000;
    ...
    function buyToken() public payable returns (address) {
        ...
        //@dev calculate the amount of bonus tokens to transfer
        uint256 bonusReward = tokenAmount.mul(bonusRewardpercentage).div(100);
        tokenAmount += bonusReward;
    ...
    function recovertokens(address tokenAddres, uint256 tokenAmount) public  onlyOwner {
        IERC20(tokenAddres).transfer(owner(), tokenAmount);
    }

    function recovereBnb() public onlyOwner {
