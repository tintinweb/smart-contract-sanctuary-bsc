...
contract EverGMT is ERC20Detailed, Ownable {
    ...
    uint256 public everGMTDividendFee = 60;
    uint256 public sellFee = 20;
    uint256 public autofirePitFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(everGMTDividendFee).add(
            autofirePitFee
        );
    ...
    address public everGMTDividendReceiver;
    ...
    constructor() ERC20Detailed("EverGMT", "EGMT", uint8(DECIMALS)) Ownable() {
        ...
        everGMTDividendReceiver = address(distributor);
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(everGMTDividendFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(everGMTDividendFee)
            ),
            gas: 30000
        }("");

        try distributor.deposit {
            value: amountETHToTreasuryAndSIF.mul(everGMTDividendFee).div(treasuryFee.add(everGMTDividendFee))
        } () {} catch {}        
    }
