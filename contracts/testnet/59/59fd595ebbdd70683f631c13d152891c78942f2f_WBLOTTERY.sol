...
contract WBLOTTERY {
    ...
    event WON2(address winner1, address winner2, address winner3);
    ...
    function distribution() external onlyAdmin {
        ...
        uint256 amount = 0;
        address[] memory _participants = new address[](token.balanceOf(address(this)) / pricediscount);
        ...
        //    _participants[i] = msg.sender;
        //}
        emit WON2(winner1, winner2, winner3);
    }
    ...
    function buy(uint256 count, address ref) public {
        ...
        //uint256 bid = betters[msg.sender].better_id;
