...
contract PENSION_SEED is Ownable {
    ...
    event NewTokenTransfered(address indexed operator, uint256 sendAmount);
        ...
        internal view returns (uint256)
      {
        ...
        uint256 public investorMinCap = 1 * 10**18; // 1 bnb
        uint256 public investorMaxCap = 2 * 10**18; // 2 bnb
        uint256 public investorHardCap = 50 * 10**18; // 5 bnb
