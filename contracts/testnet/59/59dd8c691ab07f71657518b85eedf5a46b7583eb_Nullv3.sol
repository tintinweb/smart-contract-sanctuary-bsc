...
contract Nullv3 is IERC20, Ownable {
    ...
    string _name = "Null v3";
    string _symbol = "NULLV3";
    ...
    uint256 smallSwapThreshold = _totalSupply.mul(100000).div(1000000000);
    uint256 largeSwapThreshold = _totalSupply.mul(100000).div(1000000000);
