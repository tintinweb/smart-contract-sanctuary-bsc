...
contract launchpad is Ownable {
    ...
    function unStake(uint256 _amount) external {
        ...
        require(Userstaked[msg.sender] >= _amount, "You haven't staked enough!");
        require(
        ...
        idoTransfer[msg.sender] -= initialIDOAmount;
        totalIDOTokenTransferred -= initialIDOAmount;
        tokenTransferredToPool[msg.sender] -= initialIDOAmount;
    ...
    function pendingClaim(address _user) internal {
        ...
        claimReward = getRewardValue(userStakedIn, _user) * temp;
    ...
    function claim() external {
        ...
        uint256 temp = currentTimeTemp - userStakedTime;
        claimReward = getRewardValue(userStakedIn, msg.sender) * temp;
    ...
    function getRewardValue(uint256 _amount, address _user) internal returns (uint256) {
