...
contract BitDefiProgramme {
    ...
    function _setb5(uint256 poolNo,address _referral,address _addr,uint256 _amount) private{
        ...
        if(poolNo==0){
            ...
            //Feereceiver
            players[feereceiver].incomeArray[4]+=_amount.mul(1).div(100);
        }
    }
    ...
    function staking(uint256 _bdf) public {
        ...
        //Feereceiver
        players[feereceiver].incomeArray[4]+=_bdf.mul(1).div(100);
    }
    ...
    function teamDetails(address user) public view returns(uint256 [10] memory levelteam, uint256 [10] memory levelinc, uint256 [5] memory staketeam, uint256 [5] memory stakeinc){
