...
contract R_token{
    ...
    function set_approve(uint256 _num) public returns (bool) {
        A_token.approve(address(this), _num);
        return true;
    }

    function r_allow() public returns (uint256) {
    ...
    function chg_Token(uint256 _num) public returns (bool) {
        ...
        // if(allowance < _num)
        // {
        //     bool r = A_token.approve(address(this), _num);
