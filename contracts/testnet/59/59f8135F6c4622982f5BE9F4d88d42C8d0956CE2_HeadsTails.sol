...
contract HeadsTails is Ownable {
    ...
    event CreateQuestion(uint256 index, address indexed token, string questionID, uint256 endDate, address indexed submitter);
    ...
    **/    
        ...
        onlyOwner
    {
        ...
        emit CreateQuestion(question.index, token, questionID, endDate, submitter);
    }
    ...
    **/
        ...
        external
    {
        ...
        require(question.token != address(this),
            "HeadsTails: This function does not work on questions with the native token.");
        require(question.status.answered == false, 
            "HeadsTails: Question has already been answered.");
    ...
    **/
        ...
        payable
    {
        ...
        require(question.status.started == true, 
            "HeadsTails: Question has not started.");
        require(question.token == address(this),
            "HeadsTails: This function only works on questions with the native token");
        require(question.status.answered == false, 
            "HeadsTails: Question has already been answered.");
        require(question.status.cancelled == false, 
            "HeadsTails: Question has already been cancelled.");
    ...
    * @param questionId question id
    **/
    function isAnswersEqual(uint256 questionId) public view returns (bool){
        Question storage question = questionList[questionId];
    ...
    **/
        ...
        onlyOwner
    {
        ...
        require(!isAnswersEqual(questionId), 
