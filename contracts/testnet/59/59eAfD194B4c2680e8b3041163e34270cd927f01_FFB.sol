...
contract FFB is BEP20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 360 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address public marketingWallet = 0x6AE831F571B3BBCd36B92E0A6BFB1B271Cd12ef4;
    ...
    constructor() BEP20("FIFA Fan Battle Token", "FFB") {
        _tokengeneration(msg.sender, 360000 * 10**decimals());
