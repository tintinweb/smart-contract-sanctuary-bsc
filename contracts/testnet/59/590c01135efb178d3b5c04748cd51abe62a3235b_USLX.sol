...
USTv2 has been designed to try to fix the phenomena of the pump and dumps that we 
...
Both whale and small investors alike are protected by the USTv2 mechanism hardcoded into the smart contract. 
The moon mission for USTv2 is in the code.

USTv2 TOKENOMICS & TAXES
Total supply: 1,000,000,000 or 1 billion $USTv2 tokens
Decimals: 9
Liquidty: 2% 
Marketing: 2%
Auto-buy backs: 6%
...
contract USLX is IERC20 {
    ...
    string constant private _name = "UST 2.0";
    string constant private _symbol = "USLX";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x3698D27057bD24D2e2e521c97F53f90112dBb518)
        });
