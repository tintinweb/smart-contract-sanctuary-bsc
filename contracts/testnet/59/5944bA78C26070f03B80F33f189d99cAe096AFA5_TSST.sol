...
contract TSST is ERC721Enumerable, ERC721URIStorage, IERC2981, Pausable, Ownable, ERC721Burnable, BridgeNFT, MinterRole, ClampedRandomizer {
    ...
    uint public maxPerPerson = 445;
    uint public price = 0;
    address public royaltyAddress = 0x565A212cCDde3bE3d232354E807c9dABe3a03442;
    ...
    constructor(
        ...
        uint[] memory _fees
    ) ERC721("TSST", "TSST") ClampedRandomizer(maxSupply) {
