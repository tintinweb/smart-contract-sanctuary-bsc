...
contract PNN is ERC20("Pego Node NFT token", "PNN"), Ownable {
    ...
    function _transfer(
        ...
        require(!blackList[from] || whiteList[to], "can not transfer");
    ...
    function updateWhiteList(address user, bool flag) public onlyOwner {
        whiteList[user] = flag;
    }
}