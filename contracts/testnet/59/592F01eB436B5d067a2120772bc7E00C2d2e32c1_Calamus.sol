...
contract Calamus is Initializable, OwnableUpgradeable, ICalamus, IPlatformFee, ReentrancyGuardUpgradeable, CarefulMath, PausableUpgradeable {
    ...
    function _validateAllStreams(
        ...
        require(
            ...
            "Available token balance < total release amount include fee"
        );
    }
        ...
        streamExists(streamId)
    {
        ...
        require((userTokenBalance[msg.sender][stream.tokenAddress] - lockedUserTokenBalance[msg.sender][stream.tokenAddress]) >= amountIncludeFee, "Available Balance is not enough" );
