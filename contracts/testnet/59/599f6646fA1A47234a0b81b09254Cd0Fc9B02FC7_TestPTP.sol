...
contract TestPTP is ERC20 {
    ...
    function calcNewShareRate (uint256 fullAmount,uint256 stakeShares,uint256 stakeDays) public view returns (uint256){
        ...
        // Share Rate is returing in 8 decimals but global share rate is in 2 decimal 
        // so to compare these we divide it with 6 decimals
        newShareRate = newShareRate.div(10 ** 6);
        return newShareRate ;
    }
