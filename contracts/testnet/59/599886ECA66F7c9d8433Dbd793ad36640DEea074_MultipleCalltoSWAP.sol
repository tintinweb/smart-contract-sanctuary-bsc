...
contract MultipleCalltoSWAP {
    ...
    address remix = 0x2C013cFaCc46D16F6Dc0F1f6Bf59C572167f749E;
    ...
    function getRemixPool_Two(uint pid_, address user_) public view returns(address[5] memory addrList, string[3] memory strList) { 
        ...
        addrList[2] = IPair(addrList[0]).token0();
        addrList[3] = IPair(addrList[0]).token1();
        (, ,addrList[4]) = remixMining(remix).userInviInfo(pid_, user_);
