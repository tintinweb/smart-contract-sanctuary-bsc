...
contract ShareRewardPool {
    ...
    function setSharePerSecond(uint256 _sharesPerSecond) onlyOperator public {
        require(_sharesPerSecond <= 0.0009384384 ether ,"sharesPerSecond can only be lowered" );
        require(_sharesPerSecond != 0 ,"sharesPerSecond can not be 0" );
