...
contract AI is ERC20, Ownable {
  ...
  string private _name = "Super Smart AI";
  ...
  constructor(address payable newMarketingWallet, address payable newTeamWallet, address payable newLiqWallet, address newRouter) ERC20(_name, _symbol) {
