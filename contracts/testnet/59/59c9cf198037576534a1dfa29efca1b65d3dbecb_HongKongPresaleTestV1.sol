...
contract HongKongPresaleTestV1 {
    ...
    uint256 public maxPresaleTokenBuy = 1000000;
    ...
    function buyTokens() public payable {
        ...
        require(amountOfTokensToBuy + presaleAmountGathered[msg.sender] <=maxPresaleTokenBuy, "You cant buy more than 1.000.000 Tokens.");
        ...
        IERC20(tokenAddress).transfer(msg.sender, amountOfTokensToBuy*10**18);
        presaleAmountGathered[msg.sender] += amountOfTokensToBuy;
