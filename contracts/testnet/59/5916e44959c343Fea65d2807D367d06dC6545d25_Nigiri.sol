...
contract Nigiri is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "testest";
    string constant _symbol = "testest";
    ...
    function triggerWhaleBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
    ...
    function setFees(uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        buybackFee = _buybackFee;
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        totalFee = _buybackFee.add(_reflectionFee).add(_marketingFee);
