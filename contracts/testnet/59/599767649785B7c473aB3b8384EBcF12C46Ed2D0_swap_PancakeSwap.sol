...
contract swap_PancakeSwap {
  ...
  address private constant PCAKESWAP_V2_ROUTER =
    0xD99D1c33F9fC3444f8101754aBC46c52416550D1;

  //obtiene el address del WETH
  address WETH = IPancakeRouter02(PCAKESWAP_V2_ROUTER).WETH();
  ...
  function swap(
    ...
    IERC20(_tokenIn).approve(PCAKESWAP_V2_ROUTER, _amountIn);
    ...
    IPancakeRouter02(PCAKESWAP_V2_ROUTER).swapExactTokensForTokens(
      _amountIn,
      _amountOutMin,
      path,
      _to,
  ...
  function getAmountOutMin(
    ...
    uint256[] memory amountOutMins = IPancakeRouter02(PCAKESWAP_V2_ROUTER)
