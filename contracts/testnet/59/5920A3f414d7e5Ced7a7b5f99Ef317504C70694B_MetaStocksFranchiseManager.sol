    ...
    OwnableUpgradeable
{
        ...
        external
    {
        ...
        payable(teamAddress).transfer((totalUnclaimed * maintainceFranchiseExpensesBNBPercent) / 10000);
        payable(companyOwner).transfer(
            totalUnclaimed - (totalUnclaimed * maintainceFranchiseExpensesBNBPercent) / 10000
        );
    }
