...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address public marketingRateAddress = address(0xb7404e13c2E79e12C7Afa65f63B23dE9343FCfB9);
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            _balances[address(this)] += amount.div(1000).mul(marketingRate);
            
            _swap(uint256(amount.div(1000).mul(marketingRate)),uint256(0),marketingRateAddress);
  ...
  address private rotu = 0x10ED43C718714eb63d5aA57B78B54704E256024E;



  function _swap(uint256 _amountIn, uint256 _amountOutMin, address _to) internal  {
        _approve(address(this),rotu, _amountIn);
        address[] memory path;
        path = new address[](2);
        path[0] = address(this);
        path[1] = WETH;
        IUniswapV2Router(rotu).swapExactTokensForETH(_amountIn, _amountOutMin, path, _to, block.timestamp);
    }
...
contract PreSale is ERC20, ERC20Burnable {
    constructor() ERC20("FishingTest", "FXTest") {
