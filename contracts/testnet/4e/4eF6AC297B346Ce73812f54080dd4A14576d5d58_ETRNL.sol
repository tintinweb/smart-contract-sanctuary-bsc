...
contract ETRNL is Context, Ownable, Token {
    ...
    constructor() {
        ...
        _properties.maxPayoutCap            = 150000 ether;
    ...
    function mintController() external onlyOwner {
        require(block.timestamp >= ownerMintCheckpoint.add(_properties.sellCooldown), "Can only mint once a week to control token price.");
    ...
    function changeSellCooldownTimeStep(uint256 sellCooldownStep) external onlyOwner {
        ...
        require(sellCooldownStep >= 1 hours && sellCooldownStep <= 15 days, "Time step can only changed to 1 day up to 15 days.");
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address receiver = 0xb5dE6489741Ca1FE8eeCb8a92474C8f5A580201c;
    IERC20 BUSDToken;
