...
contract HardEvaluation is IDFYHardEvaluation, BaseContract {
    ...
    function evaluationAndCreateNFT(
        ...
        DataEvantEvaluationAndCreateNFT
            memory data = DataEvantEvaluationAndCreateNFT(
                collectionAddress,
                amount,
                currency,
                price,
        ...
        emit EvaluationAndCreateNFTEvent(tokenId, data);
    }
}
...
interface IDFYHardEvaluation is BaseInterface {
    ...
    struct DataEvantEvaluationAndCreateNFT {
        address collectionAddress;
        uint256 amount;
        address currency;
        uint256 price;
    ...
    event EvaluationAndCreateNFTEvent(
        uint256 tokenId,
        DataEvantEvaluationAndCreateNFT data
    );
