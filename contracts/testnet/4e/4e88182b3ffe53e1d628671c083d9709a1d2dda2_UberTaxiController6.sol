...
contract UberTaxiController6 is Ownable {
    ...
    constructor() {
        ...
        UTD = UberTaxiDate(0x656542d99a3c33d74Ad9Fdd05fBffd940f82189b);
    ...
    function vehicleGetReward(uint256 index) public isUsers(index) {
        ...
        string memory source = string(abi.encodePacked(tokenId, ''));

        UTD.setUtaxiDetails(msg.sender, 5, source, profit.div(10 ** 18), block.timestamp);

        // UTD.setVehicleDurability(index, durability - 1);

        UTD.setVehicleDurability(index, durability - 20);
