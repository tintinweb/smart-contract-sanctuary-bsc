...
import "./1abstractContract.sol";
import "./2interfaceIerc20.sol";
import "./3librarySafeMath.sol";
import "./4libraryAddress.sol";
import "./5contractOwnableIsContext.sol";
import "./6interfaceIUniswapV2Factory.sol";
import "./7interfaceIUniswapV2Pair.sol";
import "./8interfaceIUniswapV2Router01.sol";
import "./9interfaceIUniswapV2Router02_is_IUniswapV2Router01.sol";

contract SOMINGDER is Context, IERC20, Ownable {
    ...
    string private constant _name = "SOMINGDER";
    string private constant _symbol = "SMGDR";
