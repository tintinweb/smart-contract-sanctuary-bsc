...
contract ZZxKLocksmartContract is IERC20 { 
    ...
    TokenInfo private _tokenInfo = TokenInfo ( //77,777  100,000
           "ZZalock2_Demo", "ZFK", 8,  100_000_000, /*10**_decimals;*/ 7_777_700_000_000, //77_777 * _denomination; 
           14, 16,      1, 86400, //24hrs
    ...
    function transferFrom(address from, address to, uint256 numTokens) external override returns (bool) {  
        assert(_allowances[from][_msgSender()] >= numTokens);
