...
contract TestTokenSale {
    ...
    TestToken public tokenContract; //referência do contrato do token
    ...
    */
    ...
    function buyTokens(uint256 _numberOfTokens) public payable {
        require(
            ...
            "Numero de tokens nao corresponde ao valor"
        );
        require(
            tokenContract.balanceOf(address(this)) >= _numberOfTokens,
            "Contrato nao tem tokens suficientes"
        );
        require(
            tokenContract.transfer(msg.sender, _numberOfTokens),
            "Algum problema com a transferencia de tokens"
        );
    ...
    */
    ...
    function endSale() public {
        require(msg.sender == admin, "Apenas o administrador pode chamar essa funcao");
        require(tokenContract.transfer(msg.sender,tokenContract.balanceOf(address(this))),"Incapaz de transferir tokens para administrador");
        // destroy contract
        selfdestruct(admin);
    }
}