...
contract ShareORsteal is ReentrancyGuard, GameTools {
    ...
    // whenUserNotPlaying(player2)
    {
        ...
        IERC20(erc20Address).transferFrom(player1, address(this), betAmount);
        IERC20(erc20Address).transferFrom(player2, address(this), betAmount);
        ...
        whenGameRoomNotClosed(roomId)
    {
        ...
        uint256 profit = (gameRoom.betAmount *
            pricePerMinute *
            (currentTime - gameRoom.startedTime)) / 60;
        ...
        whenGameRoomNotClosed(roomId)
    {
        ...
        uint256 profit = gameRoom.betAmount * 2;
        ...
        if (gameResult == 0) {
            ...
            IERC20(gameRoom.erc20Address).transfer(gameRoom.player1, profit);
            IERC20(gameRoom.erc20Address).transfer(gameRoom.player2, profit);
        }
