...
contract FOFPlayerController2 is Ownable {
    ...
    function countVehicleAttribute2(uint256 tokenId1, uint256 tokenId2) public view returns(uint256,uint256,uint256,uint256) {

        Vehicle memory vehicle0 = vehicles[tokenId1];
        Vehicle memory vehicle1 = vehicles[tokenId2];
