...
contract SEC is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "SEC";
    string private constant _symbol = "SEC";
    uint8 private constant _decimals = 9;
    uint256 private constant _DECMULTIPLIER = 10**_decimals;

    //SRG pair data
    address private constant SRG = 0x3816B271c3D89726e80f4c79EE303639d05999D0; // CHANGE SRG CONTRACT PER CHAIN
    //Mainnet BSC - 0x9f19c8e321bD14345b797d43E01f0eED030F5Bff 
    //Mainnet ETH - 0xcD682EF09d07668d49A8103ddD65Ff54AebFbfDe
    //Testnet BSC - 0x3816B271c3D89726e80f4c79EE303639d05999D0
    ...
    uint256 public sellMul = 95; // means 5% tax 
    ...
    //Tax wallets
    address public teamWallet = 0xFDC55954c41431cBCbcD64C3a552EF088E0deB68; // change wallet
    address private _uniAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E ; // PCS or uniswap to block the router
    ...
    function changeTaxDistribution(uint256 newteamShare, uint256 newRewardShare)
        external
        onlyOwner
    {
        require(
            newteamShare + newRewardShare == SHAREDIVISOR,
