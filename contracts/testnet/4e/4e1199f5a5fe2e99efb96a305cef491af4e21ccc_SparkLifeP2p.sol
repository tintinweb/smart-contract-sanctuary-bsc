...
contract SparkLifeP2p is Ownable {
    ...
    */
    function offertEscrow(address sellerAddress, uint ID) public returns (bool) {
        ...
        sellerEscrowDatabase[sellerAddress][ID].escrowId = ID; // Guardar el ID o index del array
    ...
    */
    ...
    /**
        ...
        Si es llamada por el buyer, se debe de enviar el id del buyer y no del seller
