...
contract RewardRateConfigurable is Initializable {
    ...
    uint256 private rewardUpdateBlocksInterval;
    ...
    function __RewardRateConfigurable_init_unchained(
        ...
        rewardUpdateBlocksInterval = _rewardUpdateBlocksInterval;
    }
        ...
        internal
    {
        ...
        rewardUpdateBlocksInterval = updateBlocksInterval;

        emit RewardPerBlockUpdated(oldRewardValue, rewardPerBlock);
    }

    function _updateRewardPerBlock() internal {
        if ((block.number - rewardsConfiguration.lastUpdateBlockNum) < rewardUpdateBlocksInterval) {
            return;
        }
