...
// File: contracts/ethwcats.sol



pragma solidity >=0.8.9 <0.9.0;

contract EthwCats is ERC721, AccessControl {
    bytes32 public constant LAUNCHPAD = keccak256("LAUNCHPAD");
    using Strings for uint256;
...
_grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _grantRole(LAUNCHPAD, msg.sender);
