...
import './liquidityGenratorToken.sol';

contract PINKSALELiquidityTokenDeployer{
    ...
    function createSimpleToken (
      string memory name_,
        ...
        require(msg.value == adminFee,"admin fee not paid");
        admin.transfer(adminFee);
        IERC20 newToken = new LiquidityGeneratorToken(
            name_,
            symbol_,
            totalSupply_*10**9,
            router_,
        ...
        getUserToken[msg.sender][++getUserTokenCount[msg.sender]] = newToken;
