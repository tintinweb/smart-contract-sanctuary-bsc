...
contract Metagames is ERC20, Ownable {
    ...
    constructor() ERC20("Metagames","MGS") 
    {
     ...
     */
    function setBuyTaxFees( uint256 liquidity) public onlyOwner {
     ...
     */
    function setBuyTaxWallet( address liquidity) public onlyOwner {
