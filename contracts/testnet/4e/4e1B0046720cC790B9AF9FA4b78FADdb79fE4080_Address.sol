...
contract dogebonkmas is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doge Bonkmas";
    string private _symbol = "DOBOMAS";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0xd5811B7A7e956cf1149588D9E7Fd8f7c714371c4);
