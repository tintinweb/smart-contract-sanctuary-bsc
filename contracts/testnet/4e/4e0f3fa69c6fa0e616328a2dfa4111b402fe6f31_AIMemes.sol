...
contract AIMemes is Context, IERC20, Ownable {

    using Address for address;

    address payable public marketingWalletAddress = payable(0x1Ac7E338d1B2Cfd4a46aEE60116BE4e8ECFbAEdc); // Marketing Wallet Address

    address payable public reserveWalletAddress = payable(0x000000000000000000000000000000000000dEaD); // Marketing Wallet Address

    address payable public charityWalletAddress = payable(0x000000000000000000000000000000000000dEaD); // charity Wallet Address
    ...
    string private constant _name = "AIMemes";

    string private constant _symbol = "AIMEMES";
    ...
    constructor () {
        ...
        address _owner = 0x2A89B38271e21EEE2A796655893A79E93E8a3AA6;
