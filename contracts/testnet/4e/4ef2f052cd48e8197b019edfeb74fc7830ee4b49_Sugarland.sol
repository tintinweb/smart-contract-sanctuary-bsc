...
contract Sugarland is Context, IERC20, Ownable {
    ...
    function testar() external onlyOwner{
        require(!travado == true, "erro erro");
    ...
    function destravar() external onlyOwner{
        travado = false;

    }

    function travar() external onlyOwner{
        travado = true;
