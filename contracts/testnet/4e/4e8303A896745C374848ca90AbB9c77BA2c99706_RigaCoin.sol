...
contract RigaCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Riga";
    string private _symbol = "RGA";
    ...
    uint256 constant numTokensSellToAddToLiquidity = 20000000  * 10**9;
