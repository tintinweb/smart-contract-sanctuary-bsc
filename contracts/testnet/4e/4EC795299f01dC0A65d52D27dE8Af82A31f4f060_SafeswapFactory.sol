...
// File: safemoon/Safeswap_Core_V2/libraries/proxy/Proxy.sol
...
// File: safemoon/Safeswap_Core_V2/interfaces/ISafeswapCallee.sol
...
// File: safemoon/Safeswap_Core_V2/interfaces/IERC20.sol
...
// File: safemoon/Safeswap_Core_V2/libraries/UQ112x112.sol
...
// File: safemoon/Safeswap_Core_V2/libraries/Math.sol
...
// File: safemoon/Safeswap_Core_V2/libraries/Initializable.sol
...
// File: safemoon/Safeswap_Core_V2/interfaces/ISafeswapERC20.sol
...
// File: safemoon/Safeswap_Core_V2/SafeswapERC20.sol
...
contract SafeswapERC20 is ISafeswapERC20 {
    ...
    function permit(
        ...
        require(
            ...
            "Safeswap: INVALID_SIGNATURE"
        );
        _approve(owner, spender, value);
    }
}

// File: safemoon/Safeswap_Core_V2/interfaces/ISafeswapPair.sol
...
// File: safemoon/Safeswap_Core_V2/interfaces/ISafeswapFactory.sol
...
// File: safemoon/Safeswap_Core_V2/libraries/proxy/UpgradeableProxy.sol
...
contract UpgradeableProxy is Proxy {
     ...
     */
    function _UpgradeableProxy_init_(address _factory, bytes memory _data)
        internal
    {
        assert(
            _FACTORY_SLOT ==
                bytes32(uint256(keccak256("eip1967.proxy.factoryfactory")) - 1)
        );
    ...
    bytes32 private constant _FACTORY_SLOT =
        0xb2101b231486a8a17a16c101f8dde1145d21799358462f57035a227f25614da3;
    ...
    function _setFactory(address newFactory) private {
        require(
            Address.isContract(newFactory),
            "UpgradeableProxy: new factory is not a contract"
        );
...
// File: safemoon/Safeswap_Core_V2/libraries/proxy/OptimizedTransparentUpgradeableProxy.sol
 ...
 */
contract OptimizedTransparentUpgradeableProxy is
    UpgradeableProxy,
    Initializable
{
    /**
     ...
     */
    function upgradeToAndCall(address newFactory, bytes calldata data)
        external
        payable
        ifAdmin
    {
...
// File: safemoon/Safeswap_Core_V2/SafeswapPair.sol
...
contract SafeswapPair is ISafeswapPair, SafeswapERC20, Initializable {
    ...
    modifier onlyRouter() {
        require(
            msg.sender == ISafeswapFactory(factory).router(),
            "Safeswap: ONLY_ROUTER"
        );
        _;
    }
    ...
    function _takeFee(
        ...
        uint256 liquidity = Math.min(
            (amountIn * _totalSupply) / reserveIn,
            (burnFee * _totalSupply) / reserveOut
        );
        ...
        if (feeOn) {
            ...
            liquidity = Math.min(
                (amountIn * _totalSupply) / reserveIn,
                (supportFee * _totalSupply) / reserveOut
            );
    ...
    function mint(address to) external lock returns (uint256 liquidity) {
        require(
            ISafeswapFactory(factory).isBlacklistedStatus(to) == false,
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "Safeswap: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "Safeswap: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "Safeswap: INSUFFICIENT_LIQUIDITY"
        );
        ...
        uint256 balance1;
        {
            ...
            if (data.length > 0)
                ISafeswapCallee(to).safeswapCall(
                    msg.sender,
                    amount0Out,
                    amount1Out,
                    data
        ...
        require(
            ...
            "Safeswap: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
...
// File: safemoon/Safeswap_Core_V2/SafeswapFactory.sol
...
contract SafeswapFactory is ISafeswapFactory, Initializable {
    bytes32 public constant INIT_CODE_PAIR_HASH =
        keccak256(
            abi.encodePacked(
                type(OptimizedTransparentUpgradeableProxy).creationCode
            )
        );
    ...
    function initialize(address _feeToSetter, address _feeTo)
        external
        initializer
    {
