...
contract CampaignFactory{
    ...
    event campaignCreated(string, address, address, address, uint256);
    ...
    function getCreatorCampaigndData(address userAddress) external view returns(projectInfo[] memory){
    ...
    function getBuyerCampaigndData(address userAddress) external view returns(projectInfo[] memory){
