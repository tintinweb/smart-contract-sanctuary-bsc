...
contract FairLaunch is IFairLaunch, Ownable {
  ...
  constructor(
    AlpacaToken _alpaca, // alpacaToken address
    address _devaddr, // wallet address
    uint256 _alpacaPerBlock, // 1500000000000000000
    uint256 _startBlock, // start block
    uint256 _bonusLockupBps, // 7000
    uint256 _bonusEndBlock // end block
  ) public {
    bonusMultiplier = 0;
    totalAllocPoint = 0;
    alpaca = _alpaca;
