...
contract Test is ERC20, Ownable 
{
    ...
    // blacklist from buy
    mapping (address => bool) public _isBlacklistedForBuy;
    ...
    constructor() ERC20("Test", "Test") {
        ...
        */
        _createTokens(owner(), 1000000 * (10**18));
    }
    ...
    function _transfer(
        ...
        if(from==uniswapV2Pair && !_isExcludedFromMaxTx[from] && !_isExcludedFromMaxTx[to])
        {
        ...
        if(!_isExcludedFromMaxTx[from] && !_isExcludedFromMaxTx[to])
        {
            ...
            {
                require(!_isBlacklistedForBuy[from], "Blacklisted Account Can't buy");
            }

            if(from != uniswapV2Pair) 
            { 
                _isBlacklistedForBuy[from] = true;  
            }
        }
    ...
    function setMaxTxAmount(uint256 newAmount) public onlyOwner {
        ...
        require(maxTxAmount >= totalSupply().div(300), "value too low");
    }
