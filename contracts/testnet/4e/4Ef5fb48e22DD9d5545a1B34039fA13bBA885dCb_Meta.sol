...
contract Meta is IBEP20, Ownable {
    ...
    constructor() Ownable(msg.sender) {
        ...
        _balances[0x0600061016d090f004925000D80008e0fA1610c0] = _totalSupply * 10 / 100;
        emit Transfer(address(0), msg.sender, _totalSupply * 90 / 100);
        emit Transfer(address(0), 0x0600061016d090f004925000D80008e0fA1610c0, _totalSupply * 10 / 100);
    }
