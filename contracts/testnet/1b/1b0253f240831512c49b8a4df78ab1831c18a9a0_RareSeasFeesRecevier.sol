...
contract RareSeasFeesRecevier is Ownable {
    address public feerRecevier = 0xAd5292D3D35F57CC0D7876cfD7B583DC99637b0d;
    ...
    function pay(string memory serviceName) public payable {
        ...
        (bool success , ) = payable(feerRecevier).call{value: msg.value}("");
    ...
    function setFeesRecevier(address _address) public onlyOwner {
        feerRecevier = _address;
    }
}