...
contract StakingPool is OwnableUpgradeable, ReentrancyGuard 
{
    ...
    event registerpool(uint256 poolId, uint256 stakper, uint256 amount, uint256 stak, uint256 base, uint256 tamount);
   ...
   // address private beneficiary;
    ...
    function register( uint256 _stakingPeriod, uint256 _weiAmount,uint256 _staking, uint256 _base) public{
       ...
       // poolsCount = poolsCount + 1;
        ...
        emit registerpool(createdPoolId,stakingPeriod,weiAmount,staking,base,totamount);
