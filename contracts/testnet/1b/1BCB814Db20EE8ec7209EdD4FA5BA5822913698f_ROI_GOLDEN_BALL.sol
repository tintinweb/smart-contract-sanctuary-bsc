...
contract ROI_GOLDEN_BALL {
    using SafeMath for uint256;
    uint256 constant launch = 1663258020;
  	uint256 constant hardDays = 86400;
    uint256 constant minStakeAmt = 10 * 10**18;
    ...
    constructor() {
            ...
            FeesKey[10] = FeesPercs(864000, 500);
            FeesKey[20] = FeesPercs(1728000, 400);
            FeesKey[30] = FeesPercs(3456000, 300);
