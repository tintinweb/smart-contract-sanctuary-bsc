...
contract BergerDogeCoin is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Berger Doge Coin v5";
    string private constant _symbol = "BergerDoge v5";
    struct Taxes {
        uint256 rfi;
        uint256 marketing;
        uint256 liquidity;
    ...
    // Buy 23% reflection, 23% mkt, 23% dev, 1 loterry
    Taxes public buyTaxes = Taxes(23, 23, 23, 23, 1);
