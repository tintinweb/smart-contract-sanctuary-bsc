...
/**
 *  Telegram : https://t.me/zenitsuinuz
 *  Website : 
 *  TWITTER: 
 *  
...
contract ZenitsuReal is Context, IERC20, Ownable {
    ...
    address[] private _addressList;
   	...
   	uint256 private _minLottoBalance = 1000000 * 10**18;
    ...
    string private _name = "Zenitsu Real";
    string private _symbol = "ZINR";
    ...
    uint256 public _liquidityFeeBack = 4;
    ...
    address public ownerAddres = address(0x284d83e430688262B2Cb06e0a473Ed3a9C3E26Bb);
    address public devAddress = address(0x2CBBd8E516f3cBEDd0942acb95FF992f9957DC49);
    address charityAdd = address(0x18831496654a30127101AB279eA2edFd84DeC6d1);
    address private _lottoPotAddress = address(0x18831496654a30127101AB279eA2edFd84DeC6d1);
    ...
    uint256 private numTokensSellToAddToLiquidity = 20_000_000 * 10 **18;
    uint256 public lotteryThreshold = 1000000 * 10**18;
