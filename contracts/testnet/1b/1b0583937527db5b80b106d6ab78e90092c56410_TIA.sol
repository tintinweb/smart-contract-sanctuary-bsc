...
abstract contract ReentrancyGuard {
    ...
    modifier nonReentrant() {
        ...
        require(_status != _ENTERED, "ReentrancGyuard: reentrant call");
...
contract TIA is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    function _transferFromExcluded(
        ...
        ( uint256 rAmount, uint256 rTransferAmount,Fees memory rFees, uint256 tTransferAmount,Fees memory tFees) = _getValues(tAmount);
    ...
    function _getValues(uint256 tAmount)
        private
        view
        returns (uint256,uint256, Fees memory,uint256,Fees memory ) {
