...
contract Cat is ERC20, Auth {
    ...
    uint256 public totalFee        = teamFee + marketingFee + liquidityFee + burnFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x9cc624cB61f9EC692eb347bE9da6C4D88a575667;
        teamFeeReceiver = 0x9cc624cB61f9EC692eb347bE9da6C4D88a575667;
    ...
    function setFees(uint256 _liquidityFee, uint256 _teamFee, uint256 _marketingFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        teamFee = _teamFee;
        marketingFee = _marketingFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_teamFee).add(_marketingFee).add(_burnFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _burnFeeReceiver, address _teamFeeReceiver) external authorized {
