...
interface IFootball {
    ...
    function betDraw(uint256 epoch) external payable;
...
contract FootballRandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    using SafeERC20 for IERC20;

    address public footballBet;
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == footballBet, "Only footballBet");
    ...
    /**
     * @notice Set the address for the footballBet
     * @param _footballBet: address of the PancakeSwap lottery
     */
    function setLotteryAddress(address _footballBet) external onlyOwner {
        footballBet = _footballBet;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        randomResult = uint32((randomness % 100));
        latestLotteryId = IFootball(footballBet).viewCurrentLotteryId();
    }
}