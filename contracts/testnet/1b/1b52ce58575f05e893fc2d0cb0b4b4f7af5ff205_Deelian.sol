...
contract Deelian {
  ...
  //  mapping (address => uint) public _to;
   ...
   // uint _timelock is set in seconds;
   // uint256 private constant _TIMELOCK = 300;
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////  
    function payment() public  {           
       require(pool_factor > 0,"Pool Factor Not Set");
       require(((Proposal[address(this)]*deelian_price)/100000)/ee_deelian[msg.sender] >= pool_factor/1000, "Approval Still Pending");
     // require(((Proposal[address(this)]*deelian_price)/100000) / ee_deelian[msg.sender]>= pool_factor/1000,"NApproval Still Pending");
     //balances[msg.sender] = balances[msg.sender] + ((ee_deelian[msg.sender]/deelian_price)*100000);
        balances[msg.sender] = (balances[msg.sender] + ((ee_deelian[msg.sender]*100000)/deelian_price));
