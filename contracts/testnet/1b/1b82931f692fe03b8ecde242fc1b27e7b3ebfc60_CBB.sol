...
contract CBB is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Central Bank Bandit";
    string constant _symbol = "$CBB";
    ...
    uint256 public _maxTxAmount =  _totalSupply * 6 / 6000;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x28C5d312339c2F2a1C294720A3090cbE0052217A;
        buybackWallet = 0x28C5d312339c2F2a1C294720A3090cbE0052217A;
    ...
    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee, uint256 newExtraSellFee) external authorized {
       ...
       require(rewardsFee <= 10, "fee too high");
       require(marketingFee <= 10, "fee too high");
       require(extraFeeOnSell <= 10, "fee too high");
    }
