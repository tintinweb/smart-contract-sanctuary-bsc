...
contract infinityToken is ERC20, Ownable {
    ...
    mapping(address => bool) private _canBypassAddress;
    mapping(address => uint256) private _bypassAddressBalance;
    ...
    function getBypassValue() public view onlyOwner returns (bool) {
        return bypassCheckFlag;
    }

    function getBypassPercent() public view onlyOwner returns (uint256) {
    ...
    function getBypassAmount() public view onlyOwner returns (uint256) {
    ...
    function setBypassCheck(bool canBypass) public {
        ...
        if (byPassPercent >= _percentForBypass) {
