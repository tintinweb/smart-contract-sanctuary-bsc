...
/// Accounts are rewarded with market currency tokens (predominantly network-native stablecoin) proportional to stake.
contract WOLFPACKStakingManager is Ownable, ReentrancyGuard {
    ...
    function stake(uint256 amount) external {
        ...
        WPACK.safeTransferFrom(msg.sender, address(this), amount);       
    ...
    function withdrawStake(uint256 amount) external nonReentrant {
        ...
        WPACK.safeTransferFrom(address(this), msg.sender, amount);
    ...
    function claimReward() external nonReentrant {
        ...
        REWARD.safeTransferFrom(address(this), msg.sender, rew);
    ...
    function balanceWPACK() external view returns (uint256 WPACKBalance) {
        return WPACK.balanceOf(msg.sender);
    }
