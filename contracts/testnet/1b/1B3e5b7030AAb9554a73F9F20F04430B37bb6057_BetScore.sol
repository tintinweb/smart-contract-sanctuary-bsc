...
contract BetScore {
    // address public constant BUSD_CONTRACT = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    // address public constant TEST_BUSD_CONTRACT = 0x5FbDB2315678afecb367f032d93F642f64180aa3;
    ...
    address public immutable i_busdContractAddress;
    
    constructor(address busdContractAddress) {
        console.log('constuctor busdContractAddress: ', busdContractAddress);
        i_owner = msg.sender;
        i_busdContractAddress=busdContractAddress;
    }

    function bet(uint16 team1Score, uint16 team2Score) public payable {
        if(!isOpen) {
            revert("The game is closed");
        }
        if(i_busdContractAddress == address(0)) {
            revert("The busd contract address is not set");
        }
        ...
        // send 10 USDC to the contract
        IERC20(i_busdContractAddress).transferFrom(msg.sender, address(this), 10 ether);
    ...
    function removeScoreFromScoreToAddresses(address player) public {
        uint16 prevTeam1Score = addressToScore[msg.sender].team1Score;
        uint16 prevTeam2Score = addressToScore[msg.sender].team1Score;
        address[] memory addressArr = scoreToAddresses[prevTeam1Score][prevTeam2Score];
    ...
    function withdraw() payable onlyOwner public {
        ...
        IERC20(i_busdContractAddress).transferFrom(address(this), msg.sender, balance);
    }
    ...
    function claim() payable public {
        ...
        bool isWin = answer.team1Score == score.team1Score && answer.team2Score == score.team2Score;
    ...
    function setOpen(bool newIsOpen) onlyOwner public {
            isOpen = newIsOpen;
    }
    ...
    function getaddressToScore(address addr) public view returns(Score memory) {
        Score storage score = addressToScore[addr];
        return score;
    }
    function getBalance() public view returns (uint256){
        return IERC20(i_busdContractAddress).balanceOf(address(this));
    }
