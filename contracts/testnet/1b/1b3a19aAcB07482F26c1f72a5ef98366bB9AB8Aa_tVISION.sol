...
contract tVISION is VISION {
    function _getName() pure internal override returns(string memory) {
        return "Test VISION";
    }

    function _getSymbol() pure internal override returns(string memory) {
        return "tVISION";
    }
}
