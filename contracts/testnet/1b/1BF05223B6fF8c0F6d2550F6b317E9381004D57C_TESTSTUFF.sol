...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x81054a3aE2921Ab1352e95D1ADE0d6f3d11F5B1e;
...
contract TESTSTUFF is Context, IERC20, Ownable { 
    ...
    */
    ...
    string private _name = "TESTing Stuff"; 
    ...
    */
    ...
    function blacklist_Add_Wallets(address[] calldata addresses) external onlyOwner returns(uint){
...
function testCall() public view onlyOwner() returns (uint){
    return 2;
}
