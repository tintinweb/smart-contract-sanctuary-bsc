...
contract st1 is Owner, ReentrancyGuard {
    ...
    constructor(
        ...
        Iluckblocks _luckblocks = Iluckblocks(0x85a2649B9556EA182559286eF5fAeAD1f00368f3);
    ...
    function pendingRewardTotal() external view returns (uint256) {
        ...
        uint256 finalRewardTokenPerShare = accRewardTokenPerShare.add(tokenReward.mul(1e30).div(totalStaked));
       
        return finalRewardTokenPerShare;
    }
    ...
    function rewardBalance() public view returns (uint256) {
        ...
        return asset2.balanceOf(address(this)) - finalRewardTokenPerShare;
