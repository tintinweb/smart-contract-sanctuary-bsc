...
contract MONOLuckyBox is
    Initializable,
    OwnableUpgradeable,
    PausableUpgradeable
{
    IERC20Upgradeable public _monoToken;
    IMONO721 public _mono721Token;
    Stage public _stage;
    ...
    function initialize(
        IERC20Upgradeable monoToken,
        IMONO721 mono721Token,
        Box memory luckyBox
    ) public initializer {
        __Ownable_init();
        __Pausable_init();
        ...
        _boxes[BoxLevel.LUCKY] = luckyBox;
        _stage = Stage.PUBLIC;
    ...
    function buy(
        ...
        _monoToken.transferFrom(_msgSender(), address(this), totalPrice);
