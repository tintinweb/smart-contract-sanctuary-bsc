...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x88C810E9DeDF86542a16D4Bd28f3c29807830122;
...
contract SKMST is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x88C810E9DeDF86542a16D4Bd28f3c29807830122;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 50000000 * 10**18; // 50 million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SK Metasoft Token";
    string private _symbol = "SKMST";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 20; //2% reflection
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 10; //1% dev fee
    ...
    uint256 public _maxTxAmount = 1000000 * 10**18; // Owner's choice
    uint256 private numTokensSellToAddToLiquidity = 100000 * 10**18; // Owner's choice
    ...
    constructor () {
        ...
        emit Transfer(owner(), address(0), 2500000 * 10**18);//initial burn of 25 lakhs
    }
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        uint256 tFee = calculateTaxFee(tAmount);//16k
        uint256 tLiquidity = calculateLiquidityFee(tAmount);//24k
        uint256 tDevelopment = calculateDevelopmentFee(tAmount);//8k
