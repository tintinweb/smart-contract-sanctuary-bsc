...
contract YTON is Ownable{
    ...
    function updateRefBaseFee(uint256 _values) public onlyMarket {
        REF_BASE_FEE = _values;  //20
    }
	...
	function withdraw() public {
		...
		uint256 userPercentRate = BASE_PERCENT.div(BASE_FEE);
	...
	function getUserDividends(address userAddress) public view returns (uint256,uint256) {
		...
		uint256 userPercentRate = BASE_PERCENT.div(BASE_FEE);   //10.0001+0.015451  = 10.0001+0.015451=10.015551
