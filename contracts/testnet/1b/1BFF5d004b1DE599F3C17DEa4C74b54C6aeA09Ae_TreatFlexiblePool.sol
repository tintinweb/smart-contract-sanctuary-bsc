...
contract TreatFlexiblePool is SafeOwnable {
    struct DepositInfo {
        ...
        uint256 lastUpdateAccTokenPerShare;     // Value of accTokenPerShare during last rewards harvest
    }
    ...
    struct ExtendedDepositInfo {
        ...
        uint256 lastUpdateAccTokenPerShare;   // Last value of accTokenPerShare during last rewards harvest time
    ...
    function harvestRewards(
        ...
        for (uint i = 0; i < depositIds.length; i++) {
            ...
            uint256 pendingRewards = userDeposit.amount
                * (accTokenPerShare - userDeposit.lastUpdateAccTokenPerShare)
                / PRECISION_FACTOR;
