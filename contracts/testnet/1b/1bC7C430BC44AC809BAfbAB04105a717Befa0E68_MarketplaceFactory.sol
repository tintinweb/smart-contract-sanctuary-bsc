...
contract MarketplaceFactory is Initializable, UUPSUpgradeable, OwnableUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event UpdatedBeaconProxy(address erc721BeaconProxy, address erc1155BeaconProxy);
    event UpdatedBeacon(address erc721Beacon, address erc1155Beacon);
     ...
     */
    function initialize(address operator, address erc721BeaconAddress, address erc721BeaconProxyAddress, address erc1155BeaconAddress, address erc1155BeaconProxyAddress) external initializer {
     ...
     */
    function updateBeacon(address erc721BeaconAddress, address erc1155BeaconAddress) external onlyRole(UPDATER_ROLE) {
        ...
        erc721Beacon = erc721BeaconAddress;
        erc1155Beacon = erc1155BeaconAddress;
        emit UpdatedBeacon(erc721Beacon, erc1155Beacon);
    }
     ...
     */
    function updateBeaconProxy(address erc721BeaconProxyAddress, address erc1155BeaconProxyAddress) external onlyRole(UPDATER_ROLE) {
        ...
        ERC721 = erc721BeaconProxyAddress;
        ERC1155 = erc1155BeaconProxyAddress;
        emit UpdatedBeaconProxy(ERC721, ERC1155);
    }
