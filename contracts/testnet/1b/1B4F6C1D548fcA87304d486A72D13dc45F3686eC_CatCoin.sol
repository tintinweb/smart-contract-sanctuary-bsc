...
$$  __$$\            $$ |                        \__|                $$ | $\  $$ |                    $$ |      $$ |      $$  __$$\ $$ |          $$ |      
$$ /  \__| $$$$$$\ $$$$$$\    $$$$$$$\  $$$$$$\  $$\ $$$$$$$\        $$ |$$$\ $$ | $$$$$$\   $$$$$$\  $$ | $$$$$$$ |      $$ /  \__|$$ |$$\   $$\ $$$$$$$\  
$$ |       \____$$\\_$$  _|  $$  _____|$$  __$$\ $$ |$$  __$$\       $$ $$ $$\$$ |$$  __$$\ $$  __$$\ $$ |$$  __$$ |      $$ |      $$ |$$ |  $$ |$$  __$$\ 
$$ |       $$$$$$$ | $$ |    $$ /      $$ /  $$ |$$ |$$ |  $$ |      $$$$  _$$$$ |$$ /  $$ |$$ |  \__|$$ |$$ /  $$ |      $$ |      $$ |$$ |  $$ |$$ |  $$ |
$$ |  $$\ $$  __$$ | $$ |$$\ $$ |      $$ |  $$ |$$ |$$ |  $$ |      $$$  / \$$$ |$$ |  $$ |$$ |      $$ |$$ |  $$ |      $$ |  $$\ $$ |$$ |  $$ |$$ |  $$ |
\$$$$$$  |\$$$$$$$ | \$$$$  |\$$$$$$$\ \$$$$$$  |$$ |$$ |  $$ |      $$  /   \$$ |\$$$$$$  |$$ |      $$ |\$$$$$$$ |      \$$$$$$  |$$ |\$$$$$$  |$$$$$$$  |
 \______/  \_______|  \____/  \_______| \______/ \__|\__|  \__|      \__/     \__| \______/ \__|      \__| \_______|       \______/ \__| \______/ \_______/ 
...
contract CatCoin is Ownable, ERC721A {  
    using Strings for uint256;

    string private _baseURIextended = "";
    string public unrevealURI = "https://catcoin.mypinata.cloud/ipfs/QmNwH8oUWvXhjJQDdtQaMVzf2x7GQJPkYoyDWdzTb9EUzq/unreveal.json";
    bool public reveal = false;

    bool public pauseMint = true;

    address public charityWallet = 0x7D9657A9D796Bc53F8da3A1da2E81333FF27E680;
    address public communityWallet = 0x5665c0A65e54537E92aa574e22300cE26c3162E3;
    address public teamWallet = 0x933F5A81f4F08537d09Ad6bCd911948e21022E6f;
    address public nftWallet = 0xe28d9f6f177e310A8E2DebC7A21c54e8291F9978;
    ...
    constructor() ERC721A("Catcoin World Club", "CCW") {
        // uint256 _preSaleStartTime = 1657861260;
        uint256 _preSaleStartTime = 1656684262; // for test        
    ...
    function updateWallets(address _charityWallet, address _communityWallet, address _teamWallet, address _nftWallet) public onlyOwner() {
    ...
    function withdraw() public onlyOwner() {
        ...
        uint256 amountToCharity = balance * 50 / 100;
        uint256 amountToCommunity = balance * 15 / 100;
        uint256 amountToTeam = balance * 15 / 100;
        uint256 amountToNFT = balance - amountToCharity - amountToCommunity - amountToTeam;
        payable(charityWallet).transfer(amountToCharity);
        payable(communityWallet).transfer(amountToCommunity);
        payable(teamWallet).transfer(amountToTeam);
        payable(nftWallet).transfer(amountToNFT);
    }
