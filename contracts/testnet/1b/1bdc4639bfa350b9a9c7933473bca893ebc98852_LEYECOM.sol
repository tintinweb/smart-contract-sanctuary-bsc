...
contract LEYECOM is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        OurLinks.WebSite = "leye.io"; //WebSite Link
        OurLinks.Telegram = "t.me/leyeio"; //Telegram Link
        OurLinks.Twitter = "twitter.com/leye_io"; //Twitter Link
        OurLinks.Medium = "medium.com/@leye.io"; //Medium Link
        OurLinks.Github = "github.com/leyeio"; //Github Link
        OurLinks.Tiktok = "tiktok.com/leyeio"; //Tiktok Link
        OurLinks.WhitePaper = "leye.io/whitepaper.pdf"; //Whitepaper Link
