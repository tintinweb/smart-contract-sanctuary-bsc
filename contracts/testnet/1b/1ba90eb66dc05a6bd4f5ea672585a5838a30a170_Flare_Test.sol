...
contract Flare_Test is IERC20, Ownable {
    ...
    string private _name = "Flare_Test";
    string private _symbol = "Flare_Test";
    ...
    address private markingWallet = 0x0c9571De4e2948b6cF7649B872cf151e95D17386;//0x497deD5f554758701219Adaf2216aC3d3f176784;

    address private direWallet = 0xaE7f0e74e3631f9bF8116cB05679d58A84F92007;//0xFaC716a616d9A17d98b256700eD5C04eA6ed2208;
    ...
    //
    bool isStartLiquidity = false;
    //
    bool isStartDividend = false;
    ...
    //
    function setStartLiquidity(bool allow) public onlyOwner {
		 isStartLiquidity = allow;
	}
    
    //
    function setStartDividend(bool allow) public onlyOwner {
		 isStartDividend = allow;
	}
    
    //
    function setLiquidityFee(uint256 number) public onlyOwner {
        amountLiquidityFee = number;
    }
    
    //
    function setLpRewardFee(uint256 number) public onlyOwner {
        amountLpRewardFee = number;
    }
