...
contract SmartContToken is Context, BEP20, Ownable {
    ...
    function updateBuyFee(
        ...
        item.Marketing_Fee = _companyFee;
    }
    ...
    function createSellFee(
        ...
        sellItems[_sellId].Marketing_Fee = _companyFee;
    ...
    function setMarketingAdress(address _liquidityAddress) public onlyOwner {
        MarketAddress = _liquidityAddress;
    }
        ...
        returns (uint256)
    {
        ...
        if (address(this) == _TokenReserv.token0()) {
            ...
            uint256 pricebnb = ResBNB.mul(ResTOKEN);
            return amount.mul(pricebnb); // return amount of BNB needed to Transaction
        }
    }
