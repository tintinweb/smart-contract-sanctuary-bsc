...
contract NwToken is Context, IERC20, Ownable {
    ...
    string private _name = "NwToken";
    string private _symbol = "NWTOKEN";
    ...
    uint16 private _taxFee = 8;
    uint16 private _liquidityFee = 1;
    uint16 private _marketingFee = 8;
    uint16 private _buybackFee = 8;
    ...
    bool public MaxBuyAndSellAmountControl = false;
    ...
    function setMaxBuyControlUpdate(bool value) external onlyOwner {
        MaxBuyAndSellAmountControl = value;
    }
