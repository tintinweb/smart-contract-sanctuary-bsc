...
contract Template is Ownable {
    ...
    function getTemplatesByUser(address user) external view returns (uint256[] memory, string[] memory, address[] memory) {
    ...
    function getAddressesByTemplates(uint256[] calldata _templateIds) external view returns (address[] memory) {
        address[] memory addresses;
    ...
    function getTemplateURIs(uint256[] calldata _templateIds) external view returns (string[] memory) {
        string[] memory URIs;
        for (uint256 i = 0; i < _templateIds.length; i ++) {
