...
// File: contracts/WCards/WCardDraw.sol
...
contract WCardsDrawV1 is VRFConsumerBaseV2, Ownable, Initializable {
    ...
    function drawWinningNumbersAll() external {
        ...
        if (allDraws_[drawTypeZero].closingTimestamp >= block.timestamp && allDraws_[drawTypeOne].closingTimestamp >= block.timestamp && allDraws_[drawTypeTwo].closingTimestamp >= block.timestamp ) {
