...
contract StakePoolTokenForToken is States, Ownable {
    ...
    function setData(uint256 _apy, uint256 _days, address _rewardingTokenWallet, uint256 _maxReward) public onlyOwner {
        apyTier = _apy;
        lockPeriod = _days;
        rewardingTokenWallet = _rewardingTokenWallet;

        require(rewardingToken.allowance(rewardingTokenWallet, address(this))>=_maxReward, "tokens not approved");
