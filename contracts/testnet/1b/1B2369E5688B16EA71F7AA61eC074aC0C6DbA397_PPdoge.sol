...
contract PPdoge is ERC20 {
	...
	address payable _receive = payable(address(0x8d00Fd9d0F1B50aA078d30E325873407CaE0fff9));
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("PPdoge", "PPdoge") {
