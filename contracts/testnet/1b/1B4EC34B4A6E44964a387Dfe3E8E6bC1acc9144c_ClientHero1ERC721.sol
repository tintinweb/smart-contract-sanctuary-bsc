...
contract ClientHero1ERC721 is TokenageERC721FullUpgradeable {
  bytes32 private constant _CONTRACT_NAME_HASH =
    keccak256(bytes('ClientHero1'));

  /// @custom:oz-upgrades-unsafe-allow constructor
  constructor() initializer {}

  function initialize() public initializer {
    __TokenageERC721FullUpgradeable_init('ClientHero1', 'CHERO1');
  }

  function _contractNameHash()
    internal
    pure
    virtual
    override
