...
/**
 * @title Jaguar token contract
 * @dev The Jaguar token has modular systems for tax and treasury handler as well as governance capabilities.
 */
contract Jaguar is IERC20,  Ownable {
    ...
    function transferFrom(
        ...
        require(
            ...
            "Jaguar:transferFrom:ALLOWANCE_EXCEEDED: Transfer amount exceeds allowance."
        );
        unchecked {
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) external returns (bool) {
        ...
        require(
            ...
            "Jaguar:decreaseAllowance:ALLOWANCE_UNDERFLOW: Subtraction results in sub-zero allowance."
        );
        unchecked {
    ...
    function _approve(
        ...
        require(owner != address(0), "Jaguar:_approve:OWNER_ZERO: Cannot approve for the zero address.");
        require(spender != address(0), "Jaguar:_approve:SPENDER_ZERO: Cannot approve to the zero address.");
    ...
    function _transfer(
        ...
        require(from != address(0), "Jaguar:_transfer:FROM_ZERO: Cannot transfer from the zero address.");
        require(to != address(0), "Jaguar:_transfer:TO_ZERO: Cannot transfer to the zero address.");
        require(amount > 0, "Jaguar:_transfer:ZERO_AMOUNT: Transfer amount must be greater than zero.");
        require(amount <= _balances[from], "Jaguar:_transfer:INSUFFICIENT_BALANCE: Transfer amount exceeds balance.");
