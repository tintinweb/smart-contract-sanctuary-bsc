...
contract MEDEX is MedexERC20 {
    ...
    function addLiquidity(uint256 amountInOut, uint256 tokenIN) external payable {
     ...
     function checkCal(uint256 balance0, uint256 _reserve0,uint256 balance1, uint256 _reserve1)
        external
        view
    ...
    function checkCal1(uint256 balance0, uint256 _reserve0,uint256 balance1, uint256 _reserve1)
        external
        view
        returns (uint256,uint256)
    {
