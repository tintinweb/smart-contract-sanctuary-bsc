...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional, Ownable {
  ...
  address public DividendsToken = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
...
contract JoeBurrow is Context, ERC20, Ownable {
    using SafeMath for uint256;
   ...
   JoeBurrowDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("Joe Burrow", "BRR") {
        _buyRewardsFee = 0;
        _buyLiquidityFee = 4;
		_buyMarketingFee = 5;
        ...
        _maxWallet = 180000000 * (10**18);
        _maxBuy = 90000000 * (10**18);
        _maxSell = 90000000 * (10**18);
    	...
    	dividendTracker = new JoeBurrowDividendTracker();

    	liquidityWallet = owner();
		
		marketingWallet = payable(0x8924E50e1C7ef636e7a3A45e160F1c8189Ec1CE5);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Joe Burrow: The dividend tracker already has that address");

        JoeBurrowDividendTracker newDividendTracker = JoeBurrowDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "Joe Burrow: The new dividend tracker must be owned by the Joe Burrow token contract");
    ...
    function updateDividendToken(address newAddress) public onlyOwner {
        require(newAddress != address(DividendsToken), "Joe Burrow: The router already has that address");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Joe Burrow: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "Joe Burrow: Account is already the value of 'excluded'");
    ...
    function addToBlacklist(address account, bool blacklisted) public onlyOwner {
        require(_isBlacklisted[account] != blacklisted, "Joe Burrow: Account is already the value of 'blacklisted'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "Joe Burrow: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Joe Burrow: Automated market maker pair is already set to that value");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "Joe Burrow: The liquidity wallet is already this address");
    ...
    function updateMarketingWallet(address newMarketingWallet) public onlyOwner {
        require(newMarketingWallet != marketingWallet, "Joe Burrow: The marketing wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Joe Burrow: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Joe Burrow: Cannot update gasForProcessing to same value");
...
contract JoeBurrowDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(false, "Boolish_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Joe Burrow contract.");
    }
