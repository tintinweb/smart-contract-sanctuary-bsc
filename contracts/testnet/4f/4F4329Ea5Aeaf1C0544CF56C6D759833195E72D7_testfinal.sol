...
contract testfinal is Context, IERC20, Ownable, LockToken 
{
    ...
    address payable public marketingWallet =  payable(0x02fcAC748F8CF34329a9e1FB5471A6670289b8ef);
    ...
    function mintToken(address target, uint256 mintedAmount) public onlyOwner{
    	require (_tTotal + mintedAmount <= MAX);     
    
        _tOwned[target] = _tOwned[target].add(mintedAmount);
        _tTotal = _tTotal.add(mintedAmount);
