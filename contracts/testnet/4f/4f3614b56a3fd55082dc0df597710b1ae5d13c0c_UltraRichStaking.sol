...
contract UltraRichStaking is Ownable {
    ...
    uint256 public referalLevelCounter = 10;
    ...
    function setRefferalChain(address _referal) internal {
        ...
        for (uint256 i; i < referalLevelCounter; i++) {
    ...
    function referralCounts(address _user) external view returns(uint[100] memory){
    ...
    function getCurrentClaimableAmount(address _user , uint _index) external view returns(uint currentDivident , uint256 withdrawableAmount){
        ...
        withdrawableAmount = ((user.stakes[_index].amount * aprPercent) / percentDivider) * slots;
        ...
        uint256 percentage = (((block.timestamp -
         ...
         currentDivident = ((user.stakes[_index].totalAmount *
    ...
    function changeReferalLevelCounter(uint256 _referalLevelCounter)
        external
        onlyOwner
    {
        require(_referalLevelCounter<=100 , "Max referal Counter is 100");
        referalLevelCounter = _referalLevelCounter;
    }
