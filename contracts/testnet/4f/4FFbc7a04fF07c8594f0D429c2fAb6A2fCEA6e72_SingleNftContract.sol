...
import "./Libs/SingleNftUtils.sol";
...
SingleNftSpecialMint
{
    ...
    override
    {
        ...
        uint256 tokenId = tokenCount();
        string memory uri = getPresetUri(SingleNftUtils.fakeRandom(presetCount()));

        // transfer
        payable(contributeAddress).transfer(msg.value);
...
SingleNftMinimumPrice
{
    ...
    function addPreset(string memory uri, uint256 price)
    external
    onlyOwner
    {
        require(price >= minimumPrice, "wrong price");
