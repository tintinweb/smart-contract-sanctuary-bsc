    ...
    NFTType
{
    ...
    function _sendRoyalties(uint256 tokenId) private {
        uint256 itemId = tokenIdToItemId[tokenId];
        ...
        uint256 fee = (price * defaultFee) / 10000;
        //compute owner sale amount
        uint256 salePrice = price - fee - royaltyAmount;
        ...
        onlyMarketItem(tokenId)
    {
        ...
        // transfer the NFT to the buyer
        _transfertNft(address(this), msg.sender, idToMarketItem[itemId].nftContract, tokenId, idToMarketItem[itemId].amount);
        // if (isERC721(nftContract)) {
        //     IERC721(nftContract).transferFrom(address(this), buyer, tokenId);
        // } else {
        //     bytes memory empty;
    ...
    function _doTrade(
        ...
        // if (isERC721(idToMarketItem[itemId].nftContract)) {
