...
contract BaseWrappedSynthr is ExternWrappedStateToken, MixinResolver {
    ...
    function burnSynths(uint256 amount, bytes32 synthKey) external issuanceActive optionalProxy {
        ...
        liquidatorRewardsManager().updateEntry(messageSender);
    }
    ...
    function burnSynthsOnBehalf(
        ...
        liquidatorRewardsManager().updateEntry(burnForAddress);
    }
        ...
        returns (bool)
    {
        ...
        if (totalRedeemed > 0) {
            ...
            liquidatorRewardsManager().updateEntry(account);
...
contract WrappedSynthr is BaseWrappedSynthr {
    ...
    constructor(
        ...
        address _owner,
        address _resolver
    ) BaseWrappedSynthr(_proxy, _owner, _resolver) {}
    ...
    function issueSynthsOnBehalf(
        ...
        liquidatorRewardsManager().updateEntry(issueForAddress);
        return;
    }
