...
contract GDSDAO is Ownable, IERC20, IERC20Metadata{
    ...
    string private _name = "GDSDAO";
    string private _symbol = "GDSDAO";
    ...
    constructor() 
    {
        ...
        _mint(msg.sender,350000000 * 10 ** _decimals);
        _mint(destoryPoolContract,  500000000 * 10 ** _decimals);
        _mint(lpPoolContract,  150000000 * 10 ** _decimals);

        currentEpoch = 1;
        lastMiningAmount = 500000000 * 10 ** decimals();
