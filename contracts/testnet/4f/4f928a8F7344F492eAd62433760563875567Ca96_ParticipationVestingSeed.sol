...
contract factory is Ownable {
    ...
    function create_project (
        ...
        uint _numberOfPortions,//total vesting units
        uint timeBetweenPortions,
        uint distributionStartDate,//linear startdat
        uint _initialPortionUnlockingTime, // startdate
        address _token ,
        uint _initialRelease) external iswhitlisted(msg.sender) {

    ParticipationVestingSeed projects = new ParticipationVestingSeed(_numberOfPortions,
                                                                      timeBetweenPortions,
                                                                      distributionStartDate,
                                                                      _initialPortionUnlockingTime,
                                                                      _token ,
                                                                      _initialRelease
                                                                       );
