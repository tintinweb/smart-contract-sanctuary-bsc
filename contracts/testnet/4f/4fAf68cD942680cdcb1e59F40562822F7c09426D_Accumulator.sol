...
contract Accumulator is Initializable, ERC20Upgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function _getSupplyInStage(
        ...
        for(uint256 i = 0; i < count; i ++) {
            amount = amount.mul(10**18 + rate) / rateDeno;
        }
        return amount;
    }
