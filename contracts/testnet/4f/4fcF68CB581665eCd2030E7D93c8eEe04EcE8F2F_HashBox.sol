...
contract  HashBox is Ownable{
  ...
  function buyOrder(uint amount, uint coin, string memory uuid) public  {
      uint num = amount.mul(algebra).div(100);
      if(coin == 1){
        tbx.transferFrom(msg.sender, official, amount - num);
        tbx.transferFrom(msg.sender, 0x000000000000000000000000000000000000dEaD, num);
      } else if(coin == 2){
        tbs.transferFrom(msg.sender, official, amount - num);
        tbx.transferFrom(msg.sender, 0x000000000000000000000000000000000000dEaD, num);
      } else {
