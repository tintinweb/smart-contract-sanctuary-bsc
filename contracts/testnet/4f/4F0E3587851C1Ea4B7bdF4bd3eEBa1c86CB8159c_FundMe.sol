...
contract FundMe {
    ...
    uint public constant MINIMUM_USD = 1 * 1e18; // 50 USD
    ...
    function fund() public payable {
        console.log("Raw Amount: %s", msg.value);
        console.log("::::: Calling Fund... Caller: %s, Amount: %s, Minimum: %s",
            msg.sender, msg.value.getConversionRate(s_priceFeed), MINIMUM_USD);
