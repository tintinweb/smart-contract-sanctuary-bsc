...
contract ChoseRewardCoin is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0xf255A7EC7bE6D940830589Fee582a5798c65ff4A;
    address public devWallet = 0x7713086e096Ebe718cCd4830CD1ba071D3052f26;
    address public operationWallet = 0x4cd789a61157b6dBd21CbD8472eebAaA25088464;
    address public charityWallet = 0xbE827BF34Ea4d18DD4c7080fC6579921E8530cD2;

    string private constant _name = "ChoseRewardCoin";
    ...
    Taxes public taxes = Taxes(0, 6, 0, 0, 4, 2);
    Taxes public sellTaxes = Taxes(0, 10, 0, 0, 6, 2);
