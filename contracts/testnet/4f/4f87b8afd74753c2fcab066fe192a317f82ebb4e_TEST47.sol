...
contract TEST47 is Context, IERC20, Ownable {
    ...
    address payable private _wildlifeFundAddress = payable(0x70250Eb9C114906d4Cc4386AA0e049EBaF8dA4A8);
    ...
    constructor (){
        ...
        _isExcludedFromFee[_wildlifeFundAddress] = true;
    ...
    function sendBNBToFee(uint256 amount) private {
        ...
        _wildlifeFundAddress.transfer(amount);
    }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        _takeWildlifeFund( _rValues.rWildlife);
    ...
    function _takeWildlifeFund(uint256 rWildlife) private {
    ...
    function _getTValues(uint256 tAmount) private view returns (TValuesStruct memory _tValues) {
        ...
        _tValues.tWildlife = tAmount.mul(_wildlifeFundFee).div(100);
    ...
    function _getRValues(uint256 tAmount, TValuesStruct memory _tValues, uint256 currentRate) private pure returns (RValuesStruct memory _rValues) {
        ...
        _rValues.rTransferAmount = (((((_rValues.rAmount.sub(_rValues.rFee)).sub(_rValues.rDev)).sub(_rValues.rMkt)).sub(_rValues.rWildlife)).sub(_rValues.rBurn));
    }
