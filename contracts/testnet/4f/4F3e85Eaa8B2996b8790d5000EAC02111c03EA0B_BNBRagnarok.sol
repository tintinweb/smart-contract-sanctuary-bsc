...
contract BNBRagnarok is ERC20Detailed, Ownable {
    ...
    IGamePool public gamePoolReceiver;
    ...
    constructor() ERC20Detailed("BNBRagnarok", "ZENY", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xF8bb8092cADe07636177Af937ea4aC843Ea3a181;
        treasuryReceiver = 0xF8bb8092cADe07636177Af937ea4aC843Ea3a181; 
        gamePoolReceiver = IGamePool(0x275077B3c2b2E1A974e35335587E1a143913f5dc);
    ...
    function swapBack() internal swapping {
        ...
        try gamePoolReceiver.deposit {
            value: amountETHToTreasuryAndGamePool.mul(gamePoolFee).div(treasuryFee.add(gamePoolFee))
        } () {} catch {}         
    }
    ...
    function setFeeReceivers(
        ...
        gamePoolReceiver = IGamePool(_gamePoolReceiver);
