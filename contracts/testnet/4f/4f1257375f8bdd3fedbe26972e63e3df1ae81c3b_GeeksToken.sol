...
contract GeeksToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    GeeksTokenDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Geeks", "GEEKS") {
        dividendTracker = new GeeksTokenDividendTracker();

        teamWallet = 0x4BD60D7378de771EfB3cAe8520Cce2aA2797fcF7;
        lotteryWallet = 0xFB3928e88356A9151d57A76fc863B8A67Efe6f86;
        marketingWallet = 0x93ca205758597B73C15c1f2051Bcd041117c661c;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "GEEKS: The dividend tracker already has that address"
        );

        GeeksTokenDividendTracker newDividendTracker = GeeksTokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "GEEKS: The new dividend tracker must be owned by the GEEKS token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "GEEKS: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "GEEKS: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "GEEKS: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "GEEKS: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "GEEKS: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "GEEKS: Cannot update gasForProcessing to same value"
        );
...
contract GeeksTokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("GEEKS_Dividend_Tracker", "GEEKS_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "GEEKS_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main GEEKS contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "GEEKS_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "GEEKS_Dividend_Tracker: Cannot update claimWait to same value"
        );
