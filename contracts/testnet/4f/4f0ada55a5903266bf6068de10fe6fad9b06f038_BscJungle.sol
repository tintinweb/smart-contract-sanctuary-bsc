...
contract BscJungle {
    ...
    function launch() external {
        ...
        require(isSealed, "Cannot launch before seal");
    ...
    function setFeesAndWallets(uint16 _dev_fee, address payable devAddr, uint16 _mrk_fee, address payable markAddr) external {
        require(msg.sender == contractOwner, "Owner only");
    ...
    function setTokenAndTarifs(address tokenCAddr, uint16 _tarif_min_days, uint16 _tarif_max_days, uint16 _tarif_perc_increase, uint16 _tarif_starting_roi) external {
        require(msg.sender == contractOwner, "Owner only");
        require(!isSealed, "Cannot change parameters after contract is sealed");
    ...
    function setRefBonuses(uint8[] memory _ref_bonuses) external {
        require(msg.sender == contractOwner, "Owner only");
        require(!isSealed, "Cannot change parameters after contract is sealed");
