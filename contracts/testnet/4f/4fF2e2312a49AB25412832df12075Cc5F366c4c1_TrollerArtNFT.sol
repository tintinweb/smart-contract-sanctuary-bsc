...
contract ERC20Marketplace is Marketplace {
    ...
    constructor(
        ...
        tokenHandler = new TrollerArtMarketPlace(_name, _symbol);
    }
...
import "@openzeppelin/contracts/utils/Counters.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "./TrollerArtMarketPlace.sol";

/**
 * @title TrollerArtMarketPlace
...
contract Marketplace is Ownable {
    ...
    TrollerArtMarketPlace tokenHandler;
...
import "./TrollerArtStore.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract TrollerArtMarketPlace is TrollerArtStore, Ownable {
    constructor(string memory _name, string memory _symbol)
        TrollerArtStore(_name, _symbol)
    {}
...
contract TrollerArtStore is ERC721URIStorage, ERC721Enumerable {
    struct TrollerLab {
        string cid;
        string metadataCid;
        bool image;
    ...
    mapping(uint256 => TrollerLab) private _nfts;
    uint256[] images;
     ...
     * {xref-TrollerLabStore-TrollerLab} for reference
     */
    function mint(address to, TrollerLab memory nft) public {
     ...
     */
    function getNFTById(uint256 id) public view returns (TrollerLab memory) {
...
contract TrollerArtNFT is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
...
contract Tournament {
    ...
    uint8  MAX_NUMBER_OF_PLAYERS =100;
