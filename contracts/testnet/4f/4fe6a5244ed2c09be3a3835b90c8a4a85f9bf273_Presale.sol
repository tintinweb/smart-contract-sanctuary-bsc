...
contract Presale is IPreIDOBase, Ownable {
    ...
    uint256 public tokenSalePrice = 30000000000000000;
    ...
    function countGetToken(address _tokenAddress , address _fundAddress ,uint256 _amount , uint8 _discountsRate  ) public view returns(uint256){
        ...
        if(_tokenAddress != address(0)){
           ...
           _priceDecimals = IERC20Metadata(_fundAddress).decimals();
           _amountDecimals = tokenInfo.decimals;
           price = getPriceToken(_fundAddress);
        }
