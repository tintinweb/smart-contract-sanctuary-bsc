...
contract GMA is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xcd2c0b383B1ccfE4BA9996A2392CA3Be45B2e37C); // Marketing Address
    address payable public teamWalletAddress = payable(0xcd2c0b383B1ccfE4BA9996A2392CA3Be45B2e37C); // Team Address
    ...
    uint256 private _intervalSecondsForSwap = 300;
    ...
    uint256 public _maxTxAmount = 28000 * 10**6 * 10**6* 10**_decimals; 
    uint256 public _walletMax = 28000 * 10**6 * 10**6* 10**_decimals;
