...
interface IUniswapV2Router02 is IUniswapV2Router01 {
   ...
   // % to holders
    ...
    function setFees(address from , address to) private {
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "KOA is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFees[from] || _isExcludedFromFees[to] || isTokenLive, "KOA is not live yet");
