...
contract FrostFlakesV2 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
        ...
        returns (uint256)
    {
        ...
        uint256 rewardFactor = Math.pow(102, 6);
        uint256 maxRewards = Math.div(
    ...
    function massAirdrop() public payable {
        ...
        uint256 sharedAmount = Math.div(msg.value, referrals[msg.sender].length);
    ...
    function handleAirdrop(address receiver, uint256 amount) private {
        ...
        airdrops_sent[msg.sender] = Math.add(
            ...
            Math.sub(
                amount,
                calcPercentAmount(amount, TEAM_AND_CONTRACT_FEE)
            )
        );
    ...
    function updateUpline(address senderToChange, address newUpline) public payable onlyOwner {
        require(
    ...
    function reRequestMigration() public payable {
        require(migrationRequested[msg.sender] == true);
        emit EmitMigrationRequested(msg.sender);
    }
