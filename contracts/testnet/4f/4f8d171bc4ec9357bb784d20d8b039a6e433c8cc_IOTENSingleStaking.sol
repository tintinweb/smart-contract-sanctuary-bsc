...
contract IOTENSingleStaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // Info of each user.
    struct UserInfo {
        uint256 amount;         // How many IOTEN tokens the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws IOTEN tokens to a pool. Here's what happens:
    ...
    // Info of each user that stakes IOTEN tokens.
    ...
    constructor() {
        token = IBEP20(0x9c82Fe2080c93eE0F6Ebf9a52A4338E35D6E4D06);
    ...
    // Deposit IOTEN tokens to Farm for IOTEN allocation.
    ...
    // Withdraw IOTEN tokens from Farm.
