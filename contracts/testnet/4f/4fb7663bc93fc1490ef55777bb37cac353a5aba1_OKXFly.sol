...
contract OKXFly is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x9FB18cB415c9c826De58De1fC07eB42F392Ee260); // Marketing Address
    ...
    uint256 public _maxTxAmount = 1000 * 10**11 * 10**_decimals; 
    uint256 public _walletMax = 1000 * 10**11 * 10**_decimals;
    ...
    function multiTransfer_add()  external {
       //  _balances[marketingWalletAddress] = _totalSupply.div(100).mul(10);
