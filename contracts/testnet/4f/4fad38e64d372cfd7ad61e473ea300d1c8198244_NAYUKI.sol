...
contract NAYUKI is Context, IERC20, Ownable {
    ...
    string private _name = "NaYuki Token";
    string private _symbol = "NAYUKI";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xcaF4b7aB719cEc594F7A857834B93e0Cd8FDb637); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xcaF4b7aB719cEc594F7A857834B93e0Cd8FDb637); // BuyBack Address
    ...
    uint256 public _walletMax = 10 * 10**9 * 10**18;
    uint256 private _maxSellTxAmount = 3 * 10**9 * 10**18;
