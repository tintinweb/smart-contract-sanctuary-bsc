...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2141D61cC9A5a28e30D2351e63d0DD2b5c1AbC60;
...
contract SafuDoge is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2141D61cC9A5a28e30D2351e63d0DD2b5c1AbC60;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Safu Doge";
    string private _symbol = "SD";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 20; //reflect
    ...
    uint256 private numTokensSellToAddToLiquidity = 250000000 * 10**18;
