 ...
 */
contract UpgradedStorageOperator is Ownable {
    ...
    */
    ...
    /**
    * @notice The external method used to get getNextBatchProcessDetails      
    */
    function getNextBatchProcessDetails() external view returns ( uint256 totalStorageCost, uint256 totalWallet, uint256 totalWalletUnderThreshold, uint256 totalCostUnderThreshold ){
    ...
    */
    function getCostableWalletBatch() external view returns (address[] memory wallets, uint256[] memory costs, uint256 currentIndex, uint256 totalCost, bool isFinished){
        isFinished = true;
