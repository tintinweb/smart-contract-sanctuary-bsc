...
contract DXGINFT is ERC721URIStorage, ERC721Enumerable, IERC721TokenCreator, Ownable {
    using Address for address;
     ...
     */
    constructor() ERC721("DXG NFT", "DXG") {}
     ...
     */
    function setNftContractAddress(address _marketContractAddress) external onlyOwner {
     ...
     * Emits a {Transfer} event.
     */
    function bulkMint(string memory _tokenURI, uint256 _numberOfToken) external {
