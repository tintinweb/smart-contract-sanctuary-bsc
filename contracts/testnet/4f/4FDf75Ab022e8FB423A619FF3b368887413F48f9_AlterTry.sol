...
contract AlterTry is ERC20, Ownable {
    ...
    constructor() ERC20("AlterTry", "ALTRY") {
    ...
    function updateFees(uint256 taxes) external onlyOwner {
        taxAmount = taxes;
        require(taxAmount <= 5, "Must keep fees at 5% or less");
    }
...
*/
        ...
        uint256 fees = 0;
        if (takeFee) {
            fees = amount.mul(taxAmount).div(100);
            
            if (fees > 0) {
                //super._transfer(from, address(this), fees);
                super._transfer(from, address(0x000000000000000000000000000000000000dEaD), fees);
            }
