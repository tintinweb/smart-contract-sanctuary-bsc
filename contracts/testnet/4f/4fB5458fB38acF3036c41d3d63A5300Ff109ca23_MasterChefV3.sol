...
import "./Enumberable.sol";

contract MasterChefV3 is INonfungiblePositionManagerStruct, Multicall, Ownable, ReentrancyGuard , Enumberable{
    ...
    function add(uint256 _allocPoint, IUniswapV3Pool _v3Pool, bool _withUpdate) external onlyOwner {
        if (_allocPoint > 0) upkeepOperation(_withUpdate);
    ...
    function upkeepOperation(bool _withUpdate) internal {
