...
pragma solidity 0.5.16;
  ...
  contract MyCoin is Context, IBEP20, Ownable {
    ...
    constructor() public {
      ...
      settings(3000000000000, 20000, 100, 100);
      setFees(5, 0, 800, 30);
    ...
    function getGain() internal view returns (uint256) {
      ...
      uint256 g =  (1000000 * 10000 * 1e18 * (1e19 + diffA) / (1e19 + diffB)) / (2000000 + 1000000 * c / getPriceEst() );
      return (g * v + g ** 2) / (v + 1);
    }
    ...
    function calcBalance(address account) internal {
      ...
      if((profit + 1e22) > (loss + 1e22) * profitLimit / 10 || (gL + 1e19) > gG * profitLimit / 10) {
        emergencyStop(true);
        return;
      }
