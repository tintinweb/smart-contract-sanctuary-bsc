...
BUSD Minerhood
 Hire CATS, Gather Beans, Harvest Beans and Sell for BUSD. 
  ...
  NO feedback TAX for withdrawals that will be done not after 0 consecutive compounds.
...
contract Minerhood {
    ...
    uint256 public EGGS_TO_HIRE_1MINERS = 720000; //12% REWARDS
    ...
    address public mkt = 0x69Ba7E86bbB074Cd5f72693DEb6ADc508D83A6bF;
    ...
    constructor() {
        owner = 0x69Ba7E86bbB074Cd5f72693DEb6ADc508D83A6bF;
    }
    ...
    function sellEggs() public {
        ...
        require(users[msg.sender].lastHatch + WITHDRAW_COOLDOWN >= block.timestamp, "Cannot Withdraw, please wait");
        User storage user = users[msg.sender];
