...
library BlockstarLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'fc3654839210068d272378700e972e06924c19d348b8899efab746c4552704a2' // init code hash
            ))));
    }
...
contract BlockstarRouter is IBlockstarRouter02,OwnableUpgradeable {
    ...
    constructor(address _factory, address _WETH) public {
        ...
        reflectionsWallet = payable(0xf41C38753bb3C9C2d418F6EcC34A3648CD70D69e);
