...
contract StakingOptionsNFT is Ownable {
    ...
    constructor() {
        ...
        infoOptions[0] = OptionsStaking(uint256(10000000000000000000000),uint256(300),heroic,uint256(1),uint256(1649934077),uint256(1682849182));
        infoOptions[1] = OptionsStaking(uint256(20000000000000000000000),uint256(450),titan,uint256(2),uint256(1649934077),uint256(1682849182));
        infoOptions[2] = OptionsStaking(uint256(30000000000000000000000),uint256(600),poseidon,uint256(3),uint256(1649934077),uint256(1682849182));
        infoOptions[3] = OptionsStaking(uint256(40000000000000000000000),uint256(700),chaos,uint256(3),uint256(1649934077),uint256(1682849182));
