...
// File: contracts/KXLanchpadNFT.sol


contract KXLaunchpadNFT is KXERC721Token {
    ...
    constructor(string memory name,
        ...
        _maxLaunchpadSupply = maxSupply;
    }

    function setMaxLaunchpadSupply(uint256 maxSupply) public {

        require(hasRole(OPERATOR_ROLE, _msgSender()),
            "KXLaunchpadNFT: setMaxLaunchpadSupply must have operator role");
    ...
    function mintTo(address to, uint size) external  {
        ...
        require(hasRole(LAUNCHPAD_ROLE, _msgSender()),
            "KXERC721Token: mintTo must have operator role");
        
        require(to != address(0), "KXLaunchpadNFT: mintTo can't mint to empty address");
        require(size > 0, "KXLaunchpadNFT: mintTo size must greater than zero");
        require(_launchpadSupply + size <= _maxLaunchpadSupply, "KXLaunchpadNFT: mintTo max supply reached");
