...
contract AyaTEST is Context, IERC20, Ownable {
    ...
    address public _marketingWallet =
        payable(address(0xb5582409e2ac06c56aBF4C1530Ed1f85Eb7014f1));
    address public _opsWallet =
        payable(address(0xb5582409e2ac06c56aBF4C1530Ed1f85Eb7014f1));
    ...
    function _takeRewardAndMarketing(uint256 tOps, uint256 tMarketing) private {
        uint256 currentRate = _getRate();
        uint256 rOps = tOps.mul(currentRate);
        uint256 rMarketing = tMarketing.mul(currentRate);
    ...
    function calculateOpsFee(uint256 _amount) private view returns (uint256) {
    ...
    function swapTokensForBUSD(uint256 tokenAmount, address recepient)
        private
        lockTheSwap
    {
        address[] memory path = new address[](2);
