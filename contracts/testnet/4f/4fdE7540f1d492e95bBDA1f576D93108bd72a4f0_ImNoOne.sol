...
contract ImNoOne is ERC721A, NonblockingReceiver, ILayerZeroUserApplicationConfig {
    ...
    // Enter the whitelist to mint a maximum of 10!
    uint256 public CAP_WHITELIST = 10;
    // We are cost efficient, you can mint 10 NFTs in one transaction
    uint256 public MAX_MINT_AT_ONCE = 10;
    ...
    function _mint(uint256 _quantity) internal {
        ...
        require(MAX_SUPPLY >= totalSupply() + _quantity, "Ouch, sold out :( ");
...
//        require(MAX_SUPPLY >= totalSupply() + _quantity, "Cannot mint over supply of 5555");
