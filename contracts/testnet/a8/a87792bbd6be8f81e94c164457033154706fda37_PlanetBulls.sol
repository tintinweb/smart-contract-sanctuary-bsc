    ...
    UUPSUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        stakingWallet = 0x7727c312Cedbec6E37753AC65a2861eEb0288241;
        marketingWallet = 0xF7fdd4a7dE0C51F7a4150C267fCBc319C162132e;
    ...
    function _calculateAndDistributeTotalFeeAmount(
        ...
        swapTokensForEthToMarketingWallet(currentMarketingFee, marketingWallet);
    ...
    */
    ...
    function swapTokensForEthToMarketingWallet(uint256 tokenAmount,address _marketingWallet) private {
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
