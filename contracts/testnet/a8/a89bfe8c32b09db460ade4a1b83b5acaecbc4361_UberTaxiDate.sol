...
contract UberTaxiDate is Ownable {
    ...
    function queryUserUtaxiDetailsByPage(address addr, uint256 pageNumber) public view returns(UtaxiDetail[6] memory details) {

        uint256 num = userUtaxiDetails[addr].length;
