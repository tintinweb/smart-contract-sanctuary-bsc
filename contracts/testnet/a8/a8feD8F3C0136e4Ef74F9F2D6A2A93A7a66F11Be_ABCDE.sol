...
contract ABCDEDividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ABCDE contract."
        );
    }
...
contract ABCDE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ABCDEDividendTracker public dividendTracker;
    ...
    constructor(
        ...
        rewardToken = address(0x0293b6431E94d3c9Dc4b5290C49B77E5a1C7FeBB);
        _marketingWalletAddress = 0xE03dB3DDB7C948cC1C848Cf4ae2BECcb23DD97B8;
        _fundWalletAddress = 0x4D7093BF6bbC4cDe4193e55B6B9eC4472F603F17;

        buyTokenRewardsFee = 200;
        buyMarketingFee = 300;
        sellTokenRewardsFee = 200;
        ...
        dividendTracker = ABCDEDividendTracker(
            payable(Clones.clone(0x8A0F95D71EEA0C7549818E4a7Bd9C9409a2608Dd))
        );
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x59E601Be15D1720Bb1C41266820634561966F70a);
        ...
        excludeFromFees(0xa0c7007D8449D3742562006c4D579BE63b3ce3AC, true);
        _mint(0xa0c7007D8449D3742562006c4D579BE63b3ce3AC, totalSupply);
    }
    ...
    function setBuyTaxes(uint256 liquidity, uint256 rewardsFee, uint256 marketingFee, uint256 deadFee, uint256 _fundFee) external onlyOwner {
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        uint256 funFee = newBalance.mul(fundFee).div(sellMarketingFee);
        IERC20(rewardToken).transfer(_fundWalletAddress, funFee );
        IERC20(rewardToken).transfer(_marketingWalletAddress, newBalance-funFee);
