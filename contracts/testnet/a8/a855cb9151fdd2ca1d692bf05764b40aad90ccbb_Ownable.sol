...
contract AIVoice is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "AI Voice";
    string private _symbol = "AI Voice";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5e1f3e0Af8E48Af4fd510B3cd64f853B18a4653B);
    address payable public liqWalletAddress = payable(0x5e1f3e0Af8E48Af4fd510B3cd64f853B18a4653B);
