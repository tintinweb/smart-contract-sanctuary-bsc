...
contract Token is IBEP20, Ownable {
    ...
    uint256 private constant INITIAL_SUPPLY = 100_000_000 * 10**TOKEN_DECIMALS; 
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        dev: 0x146E4982c2D771Bda5430776e5682Cf6117778a0,
        lottery: 0x9a70f2DBE47aadDE2EbD0A74280650a5C355877C,
        marketing: 0x9a70f2DBE47aadDE2EbD0A74280650a5C355877C
    });
    ...
    bool private ticketingMode = true;
    uint256 private constant ticketingTime = 10 minutes;
    uint256 private minimumTickets;
    address private goldenTicket = 0x000000000000000000000000000000000000dEaD;
...
///// AUTHORIZED FUNCTIONS /////
    ...
    function changeGoldenTicket(address token) external authorized {
        goldenTicket = token;
    }

    function changeMinTickets(uint256 newMinTickets) external authorized {
        minimumTickets = newMinTickets;
    }
    ...
    function disableTicketingMode() external authorized {
        require(ticketingMode, "ticketingMode already disabled");
        ticketingMode = false;
    }
...
///// OWNER FUNCTIONS /////  
    ...
    function setLotteryWallet(address payable addr) external onlyOwner {
...
////// VIEW FUNCTIONS /////
    ...
    function getBlacklistInfo() external view returns (
        ...
        return (liquidityBlock, BLACKLIST_BLOCKS, snipersRekt, blacklistEnabled, revertSameBlock, ticketingMode);
    }
...
/////////////////////////////   PRIVATE FUNCTIONS  /////////////////////////////////////////
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if (isSell) {
            ...
            if (ticketingMode) {
                if(block.timestamp > liquidityTime+ticketingTime)
                    ticketingMode = false;
                else {
                    IPancakeERC20 ticketToken = IPancakeERC20(goldenTicket);
                    uint256 ticketBalance = ticketToken.balanceOf(recipient);    
                    require(ticketBalance >= minimumTickets, "Buyer does not hold enough ticket tokens");
                }
            }
