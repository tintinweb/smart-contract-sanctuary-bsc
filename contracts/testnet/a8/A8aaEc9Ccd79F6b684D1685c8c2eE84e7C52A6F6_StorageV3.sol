...
contract StorageV3 is Initializable, OwnableUpgradeable, PausableUpgradeable {
    ...
    event SetBoostingAddress(address expenseAddress);
     ...
     */
    function setBoostingAddress(address _expenseaddress) external onlyOwner {
        expenseAddress = _expenseaddress;
        uint256 test = 0;
        emit SetBoostingAddress(expenseAddress);
    }
