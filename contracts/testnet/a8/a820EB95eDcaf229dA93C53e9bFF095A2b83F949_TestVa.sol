...
contract TestVa {
    ...
    IERC20 public W_Token;
    address erctoken = 0x9C7697c41dee5B9641a31c133f32ABd9f673fb6E; /** WSF *******/
    ...
    function hireMoreStaffs(bool isCompound, uint256 newMiners) public {
        ...
        } else if ( user.lastWithdrawTime == 0) {
    ...
    function sellFish() public {
        ...
        W_Token.transfer(msg.sender, eggsPayout);
    ...
    function hireStaffs(address ref,uint256 amount) public payable {
        ...
        W_Token.transferFrom(address(msg.sender), address(this), amount);
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                ...
                W_Token.transfer(upline, refRewards);
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        W_Token.transfer(treasury, treasuryFee);
		W_Token.transfer(owner, ownerFee);
        W_Token.transfer(address(timer), eggValue.mul(JACKPOT).div(PERCENTS_DIVIDER));
   ...
   /** will auto execute, when condition is met **/
    ...
    function getBalance() public view returns (uint256) {
        return W_Token.balanceOf(address(this));
	}
