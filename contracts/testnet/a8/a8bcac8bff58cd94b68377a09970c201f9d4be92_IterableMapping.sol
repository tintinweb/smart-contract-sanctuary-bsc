...
contract StreetPunks is ERC20, Ownable, SafeToken, LockToken {
    ...
    uint256 public maxSellTransactionAmount = totalSupply() / 100000;
    uint256 public swapTokensAtAmount = totalSupply() / 50000;
    ...
    constructor() ERC20("Street Punks", "PUNKS") {
        BNBRewardsFee = 5;
        liquidityFee = 4;
        extraFeeOnSell = 0; // extra fee on sell
        marketingFee = 3;
        marketingWallet = payable(0x2909F0F72fE53F41e093dE06aDEA2758680DeF46);
