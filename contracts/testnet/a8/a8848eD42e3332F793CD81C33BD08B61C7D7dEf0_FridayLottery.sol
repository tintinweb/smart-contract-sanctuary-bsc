...
contract FridayLottery is ReentrancyGuard {
    ...
    uint16 private constant maintenanceStakeAndGoodCausesFee = 2000;
    address public maintenanceStakeAndGoodCauses;

    distributionPercentage private distributionFee = //distribution fee for each prize winner
    ...
    guessRandomNumberAndStars private winningNumbersAndStars = guessRandomNumberAndStars(0, 0, 0, 0, 0,0,0);
        ...
        onlyOwner
    {
        ...
        lotteryEndTime = (_lotteryEndTime + 7 days);
    ...
    function distributePrize(
        ...
        for (uint256 i = 0; i < _totalWinner; i++) {
            uint256 _length=yourHistoryPerRound[roundNumber][winners[i]].length;
    ...
    function getMaintenanceStakeAndGoodCausesFee() external pure returns(uint16) {
