...
contract Labs2642Faucet is AccessControl, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        require(address(_token) != address(0), "Labs Faucet: Address invalid");
    ...
    function claim() external nonReentrant {
        require(!claimedAmounts[_msgSender()], "Labs Faucet: User is claimed");
