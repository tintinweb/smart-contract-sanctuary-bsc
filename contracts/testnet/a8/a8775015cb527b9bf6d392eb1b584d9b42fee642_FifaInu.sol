...
contract FifaInu is ERC20, Ownable {
    ...
    constructor() ERC20("FIFA Inu", "FINU") {
        ...
        address newOwner = address(0x999619733a2df505229967Db54b84D6F4709DC45);
    ...
    function updateSwapSize(uint val) public onlyOwner {
        require(val <= 50 * 1e6, "Can't set too high");
