...
contract FusionNft is Ownable {
    ...
    function setFusionContract(address _fusionContract) public onlyOwner {
...
contract EnergyNFT is ERC721, ERC721Burnable, Ownable, Signer, MintingFee, FusionNft {
    ...
    constructor() ERC721("EnergyNFT", "ENFT") {}
