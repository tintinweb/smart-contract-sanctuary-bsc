...
contract TestCoin is ERC20, Ownable {
    ...
    address public ccbRouterAddress = 0x6D7A00FD1C03Af5B5283d9018AD9484aB26F57f4;
    ...
    function addToBridgeNative(uint256 amount) public onlyOwner {
        ccbRouter.addLiquidityNative(amount); 
    }
    ...
    function getBridgeLPAddress(address contractAddress) view public {
        ccbRouter.getLPToken(contractAddress);
    }
}