...
contract BallKingPool  is Ownable {
    ...
    onlyOwner 
    {  
        stakeToken = 0xAB225c908D68Ef718749FFa51B3c794A6d150FB0;
    ...
    function stake(uint _type) external
    {
        ...
        BallKing token = BallKing(stakeToken);
        token.transferFrom(msg.sender, address(this), _stakeType.stakeAmount); 
        // 设置质押信息
