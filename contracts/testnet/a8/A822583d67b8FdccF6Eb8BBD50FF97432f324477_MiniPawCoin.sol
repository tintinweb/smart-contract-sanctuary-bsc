...
contract MiniPawCoin is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Mini PawCoin";
    string private _symbol = "PAWS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbf35d7aFc22e0557E2408fa34c60733838eB3E89);
    address payable public teamWalletAddress = payable(0x878E93693cf4A1b545c2d7426e247b74AA2f4644);
