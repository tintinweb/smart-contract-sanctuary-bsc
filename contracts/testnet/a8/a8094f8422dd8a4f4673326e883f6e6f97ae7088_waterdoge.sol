...
contract waterdoge is ERC20, Ownable {
    ...
    // exlcude from fees,  max transaction amount and blacklist
    ...
    uint256 public cooldowntimer = 86400; //default cooldown 86400s = 1 Day
    ...
    function setmaxWallet(uint256 value) external onlyOwner {
        ...
        require(value <= _totalSupply / 20, "max wallet cannot be higher than 5%");
        maxWallet = value;
    }

    // set max Tx, can not be lower than 0.005% of supply & higher than 20%
    function setmaxTX(uint256 value) external onlyOwner {
        ...
        require(value <= _totalSupply / 5, "max TX cannot be set higher than 20%");
