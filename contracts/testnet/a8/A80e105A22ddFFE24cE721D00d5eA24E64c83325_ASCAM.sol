...
contract ASCAM is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ASCAM";
    string private _symbol = "NTSC2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFc357b1Ae54403c4a1E29594831ab904987DF1DB); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xd517BB8BC41b2E7040F277712a216a52b9E475af); // BuyBack Address
    address public immutable deadAddress = 0xA2DCFF1f23b7c96a10842B1788715353B4BE275A;
