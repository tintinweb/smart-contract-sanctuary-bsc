...
contract TECHLABBSCTLB  is IBEP20, Auth {
    ...
    string constant _name = "Tech Lab Bsc";
    string constant _symbol = "TLB";
    ...
    uint256 public totalFee         = utilityFee + marketingFee + liquidityFee + teamFee + burnFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x09E626Eb98bCF39d17163C01B8F3c46135218491;
        teamFeeReceiver = 0xF963f145cd74C4c63EbD6AB4867aA846D99e8f66;
        utilityFeeReceiver = 0x37F07949d9094C31696484497158aD63C1414ec6;
    ...
    function setFees(uint256 _liquidityFee, uint256 _utilityFee, uint256 _marketingFee, uint256 _teamFee, uint256 _burnFee, uint256 _feeDenominator) external onlyOwner {
        liquidityFee = _liquidityFee;
        utilityFee = _utilityFee;
        marketingFee = _marketingFee;
        teamFee = _teamFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_utilityFee).add(_marketingFee).add(_teamFee).add(_burnFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _burnFeeReceiver, address _utilityFeeReceiver) external onlyOwner {
