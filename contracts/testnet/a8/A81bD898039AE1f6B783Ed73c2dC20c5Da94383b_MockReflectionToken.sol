...
contract MockReflectionToken is IERC20, Ownable {
    ...
    INovationRouter02 public uniswapV2Router;
    ...
    constructor(string memory name_, string memory symbol_, address _router) payable {
        // string memory name_ = "CryptoFan Token";
        // string memory symbol_ = "CFT";
        uint256 totalSupply_ = 1 * 10**9 * 10**9;
        // address router_ = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
        // address charityAddress_ = 0x7210F2c0C34A80711B67745b7e5d22383410dd0e;
        ...
        INovationRouter02 _uniswapV2Router = INovationRouter02(_router);
        // Create a uniswap pair for this new token
        uniswapV2Pair = INovationFactory(_uniswapV2Router.factory())
