...
contract CrownCoin is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CrownCoin";
    string constant _symbol = "CrownCoin";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 10000000 * 10**8 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply.mul(1).div(10000);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xCc793A57D05f5C5b0919C54D395cD387D0AeBB9A;
        ecosystemfeeReceiver = 0xCc793A57D05f5C5b0919C54D395cD387D0AeBB9A;
