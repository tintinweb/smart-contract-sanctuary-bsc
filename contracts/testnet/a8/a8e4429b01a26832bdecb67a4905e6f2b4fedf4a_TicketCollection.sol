...
contract TicketCollection is ERC721AUpgradeable, OwnableUpgradeable {
    ...
    function mint(
        ...
        // Get current token id before minted
    ...
    function _afterTokenTransfers(
        ...
        if (quantity == 1 && from != address(0)) {
            ...
            lottery.updateTicketOwner(from, to, startTokenId);
        }
    }
}
...
interface ICryptonaireLottery {
     ...
     * @notice View lottery info
     */
    function updateTicketOwner(address _oldOwner, address _newOwner, uint256 _ticketId) external;
}
