...
// File: @pbexswap/pbexswap-swap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/PbexswapProfile.sol


/** @title PbexswapProfile.
@dev It is a contract for users to bind their address 
to a customizable profile by depositing a NFT.
*/
contract PbexswapProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public pbexToken;
