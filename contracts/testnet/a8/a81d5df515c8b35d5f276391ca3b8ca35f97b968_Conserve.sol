...
interface IUniswapV2Router01 {
    ...
    function swapExactConserveForConserve(
        uint amountIn,
        uint amountOutMin,
    ...
    function swapConserveForExactConserve(
        uint amountOut,
        uint amountInMax,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForConserve(uint amountOutMin, address[] calldata path, address to, uint deadline)
        external
        payable
        returns (uint[] memory amounts);
    function swapConserveForExactETH(uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
        external
        returns (uint[] memory amounts);
    function swapExactConserveForETH(uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
        external
        returns (uint[] memory amounts);
    function swapETHForExactConserve(uint amountOut, address[] calldata path, address to, uint deadline)
        external
        payable
        returns (uint[] memory amounts);
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    function removeLiquidityETHSupportingFeeOnTransferConserve(
        address token,
        uint liquidity,
        uint amountPoletoInuMin,
        uint amountETHMin,
    ...
    function removeLiquidityETHWithPermitSupportingFeeOnTransferConserve(
        address token,
        uint liquidity,
        uint amountPoletoInuMin,
        uint amountETHMin,
    ...
    function swapExactConserveForConserveSupportingFeeOnTransferConserve(
        uint amountIn,
        uint amountOutMin,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForConserveSupportingFeeOnTransferConserve(
        uint amountOutMin,
        address[] calldata path,
        address to,
        uint deadline
    ) external payable;
    function swapExactConserveForETHSupportingFeeOnTransferConserve(
        uint amountIn,
        uint amountOutMin,
        address[] calldata path,
        address to,
...
contract Conserve is Ownable {
    constructor(
        ...
        bloomberg = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
