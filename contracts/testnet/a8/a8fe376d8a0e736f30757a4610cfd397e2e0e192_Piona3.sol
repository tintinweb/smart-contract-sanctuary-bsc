...
contract Piona3 is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x4a70905daeC0ad2190Ac5AD906f91441d6360515); 
    address payable private Wallet_Dev = payable(0x9a36582BB9De00ee8916c487FFFa979aC32568d9);
    ...
    string private constant _name = "Piona3"; 
    string private constant _symbol = unicode"PNA3"; 
    ...
    uint256 private Percent_Marketing = 10;
    ...
    constructor () {
        ...
        _owner = 0x257017473C4c1C8950713401df24FFf7fb84Db50;
