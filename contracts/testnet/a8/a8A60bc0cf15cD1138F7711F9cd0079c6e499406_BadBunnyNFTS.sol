...
contract BadBunnyNFTS is Auth, ERC721, ERC721Enumerable {
    ...
    constructor(string memory name, string memory symbol, string memory assetsBaseURI, address _token) ERC721(name, symbol) Auth(msg.sender){
