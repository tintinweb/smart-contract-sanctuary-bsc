...
contract ToonPresale is OwnerWithdrawable {
    ...
    uint256 public totalTokenstoSellR;
    uint256 public saleTokenAmtR;
    ...
    function stopSale() external onlyOwner {
        ...
        if(block.timestamp < preSaleEndTime){
            ...
            lockingPeriod1 = block.timestamp;
            lockingPeriod2 = block.timestamp;
        }
    }
    ...
    function buyToken(address _token, uint256 _amount) external payable saleDuration{
        ...
        totalTokenstoSell = totalTokensforSale - totalTokensSold;
        totalTokenstoSellR = totalTokenstoSell /1000000000000000000 ;
        saleTokenAmtR = saleTokenAmt /1000000000000000000 ;
    ...
    function setLiquidity(uint256 _totalTokenstoSellR) external onlyOwner{
        totalTokenstoSellR =_totalTokenstoSellR;
    }
