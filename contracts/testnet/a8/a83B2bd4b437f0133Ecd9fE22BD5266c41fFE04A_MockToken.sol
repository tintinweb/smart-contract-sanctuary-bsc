...
import {OceanDriveToken} from '../token/OceanDriveToken.sol';

contract MockToken is OceanDriveToken {
 ...
 */
contract OceanDriveToken is GovernancePowerWithSnapshot {
  using SafeMath for uint256;

  string internal constant NAME = 'OceanDrive Token';
  string internal constant SYMBOL = 'OCDR';
  ...
  function initialize(
    ...
    _setInitialTotalSupply(INITIAL_SUPPLY);
  }
  ...
  /**
   * @dev Override internal burn to add snapshot after burn
   *
   * See {ERC20-_burn}.
   */
  function _burn(address account, uint256 amount) internal override {
    super._burn(account, amount);
    _writeTotalSupplySnapshot();
  }
}
