...
contract NFTTrees is ERC721, Ownable {
    ...
    uint256 public availSupply = 1950;
    ...
    constructor() ERC721("NFTTrees", "NTT") {}
    ...
    function mint(uint256 count) public payable {
        require(!publicSaleEnded, "Sale ended");
        require(availSupply >= count, "Supply exceeded");
        require(maxPerTx >= count, "Too many tokens");
        if (!presaleEnded) {
            // presale checks
