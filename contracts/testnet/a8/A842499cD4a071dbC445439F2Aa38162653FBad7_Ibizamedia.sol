...
contract Ibizamedia is 
    ...
    constructor(
        ...
        _setAmount(normal, 1000);
        _setAmount(white, 100);
    }
    ...
    function buy() external checkInTime(normalGroup){
    ...
    function batchBuy(uint amount) external checkInTime(normalGroup){
        statistics.addAmount(normal, amount);
        _BuyerPayUsdt(50e18 * amount);
    ...
    function whiteListBuy() external checkInTime(whiteGroup) checkInWhiteList{
        statistics.addAmount(white, 1);
        _BuyerPayUsdt(50e18);
        _mintToken(_msgSender(), "white.json");
    }
