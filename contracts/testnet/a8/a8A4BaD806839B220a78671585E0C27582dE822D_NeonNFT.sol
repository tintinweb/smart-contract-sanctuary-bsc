...
//   mapping(uint256 => string) public CID;
//   mapping(address => mapping(uint256 => string)) private link;
  constructor(
    string memory _name,
  ...
  // public
  function mint(uint256 _mintAmount, string memory cid) public payable {
  ...
  function tokenCID(uint256 tokenId) view public returns(string memory){
    return CID[tokenId];
  }
