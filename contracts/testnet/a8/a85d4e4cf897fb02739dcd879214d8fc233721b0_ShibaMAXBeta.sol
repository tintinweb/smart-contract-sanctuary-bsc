...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "ShibaMAX";
    string internal constant SYMBOL = "SBAMAX";
     ...
     */
    uint256 internal constant maxTransactionAmount = TOTAL_SUPPLY / 250; // 2.5% of the total supply
     ...
     */
    uint256 internal constant maxWalletBalance = TOTAL_SUPPLY / 250; // 2% of the total supply
    ...
    address internal marketingAddress = 0x0e47f92E37379b14486b16180b5382d0508A8455;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 25, marketingAddress );
...
abstract contract ShibaMAX is BaseRfiToken, Liquifier, Antiwhale {
...
contract ShibaMAXBeta is ShibaMAX{

    constructor() ShibaMAX(Env.Testnet){
