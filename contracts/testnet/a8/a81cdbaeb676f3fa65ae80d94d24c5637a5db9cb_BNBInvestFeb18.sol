...
contract BNBInvestFeb18{
                                ...
                                uint256 randomno= random(totalUserAutoPool);
                                    if(totalUserAutoPool>0){
                                        if(randomno>=1 && randomno!=0 && randomno!=lastautopoolid){
                                            ...
                                            users[getUserAddress(randomno)].userautopool = users[getUserAddress(randomno)].userautopool.add(1);
                                            ...
                                            if(lastautopoolid==0 && totalUserAutoPool==0){
                                                ...
                                                //transferAmount(getUserReferrer(msg.sender),amount);
                                                lastautopoolid = getUserID(getUserAddress(1));
                                                users[getUserReferrer(referrer)].transType="depositwithautopooladmin";    
                                                break;
                                            }else{
                                                ...
                                                lastautopoolid = getUserID(referrer);
                                                //transferAmount(getUserReferrer(msg.sender),amount);
                                                users[getUserAddress(1)].userautopool = users[getUserAddress(1)].userautopool.add(1);
                                                users[getUserReferrer(referrer)].transType="depositwithautopooladmin";
    ...
    function getUserAutoPoolList(uint256 iduserautopool) public view returns(uint256 downlineautopooluserid) {
		...
		//return downlineautopooluser[iduserautopool].downlineautopooluserid;
	}
