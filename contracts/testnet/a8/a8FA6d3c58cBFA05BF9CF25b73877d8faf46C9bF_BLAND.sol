...
contract BLAND is BEP20, Ownable {
    ...
    constructor() BEP20("Badass Land", "BLAND") {
        _tokengeneration(msg.sender, 1e9 * 10**decimals());
        whitelist[msg.sender] = true;

        IRouter _router = IRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //BSCTEST
        // IRouter _router = IRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //BSCMAIN
