...
contract LIFEGAMES is ERC20Upgradeable {
    ...
    uint256 private constant _MAX_TAX_PERCENTAGE = 300;
    ...
    function initialize() public initializer {
        ...
        addresses[6] = 0x26dF456853F3EFa617a2fE392c525ba0784670D6; // Advisors
        addresses[7] = 0x23DA0303B3540dD51ED8EdB73c3B57b0d123E9A0; // Pre-venta
        addresses[8] = 0x09f33F64aAADf6A02956C9732b25d42DD9c2d4bC; // BUSD BuyBackBurn
        addresses[9] = 0x23DA0303B3540dD51ED8EdB73c3B57b0d123E9A0; // BUSD Reserves
        ...
        setBusdReserveAddress(addresses[9]);
    ...
    function setTaxes(uint16 distributionToHoldersFee, uint16 liquidityFee, uint16 buyBackFee, uint16 busdReserveFee) external onlyOwner {
        ...
        uint256 calculatedPercent = distributionToHoldersFee + liquidityFee + buyBackFee + busdReserveFee;
        require(calculatedPercent <= _MAX_TAX_PERCENTAGE, "Percentage is higher than accepted");
    ...
    function contractSwap() internal swapping {
        ...
        if (_allowances[address(this)][address(dexRouter)] != type(uint256).max) {
             _approve(address(this), address(dexRouter), type(uint256).max);
             IERC20(busdAddress).approve(address(dexRouter), type(uint256).max);
        }
