...
contract AnubisStake {
    ...
    uint256[4] public Bonus = [0, 0, 0, 0];
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address BUSD_WBNB = 0x652D9532118E7D52042F74C2a2a01352281Bc9Ef; //BUSD_WBNB pancake pool address
        ...
        IERC20 TKNTOKEN = IERC20(0x4b6a72c7271Ae82F5A7396edEC2Dc9322922A192); // ANUBISTKN Token address 
