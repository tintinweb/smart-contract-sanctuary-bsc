...
abstract contract Ownable is Context {
     ...
     */
    function owner1() private view  returns (address) {
        return _owner;
    }
...
contract Blockchaincert is Ownable{
    ...
    function buyCOURSE(BuyCOURSEStruct calldata data) public payable {
        ...
        if (data.tokenAddress == token1 || data.tokenAddress == token2) {
            ...
            if (partnerPrice != 0) {
                IERC20(data.tokenAddress).transferFrom(msg.sender, partner, partnerPrice);
            }
            if (price1 != 0) {
        ...
        else 
        {
            ...
            if (partnerPrice != 0) {
                payable(partner).transfer(partnerPrice);
            }
            if (price1 != 0) {
