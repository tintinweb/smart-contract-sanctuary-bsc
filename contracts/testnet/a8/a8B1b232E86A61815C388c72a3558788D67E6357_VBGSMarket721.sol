...
contract VBGSMarket721 is ReentrancyGuard {
    ...
    constructor() public {
        ...
        POOL_MARKET = 0x0B707c987b013B64082f1d6A07988d640Dc854E0;
        VERIFY_SIGNATURE = 0x4f0736236903E5042abCc5F957fD0ae32f142405;
        address[] memory _nfts = new address[](2);
        _nfts[0] = 0x230559609F2469f0c48321b2dCEfc87FF4db185F;
        _nfts[1] = 0xA9f6a41b02212625b2788169C1146Ce06BeaD183;
    ...
    */
        ...
        onlyOwner
    {
        ...
        require(
            sale.isActive && !sale.isSold,
            "forceCancelTokenSale: sale inactive or already sold"
        );
        address _nft = sale.nft;
        //
        sale.isActive = false;
