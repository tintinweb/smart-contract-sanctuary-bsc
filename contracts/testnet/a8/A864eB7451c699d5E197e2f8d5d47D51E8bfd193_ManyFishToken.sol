...
contract ManyFishToken is Context, IERC20, Ownable {
    ...
    string private _name = "ManyFish";
    string private _symbol = "MFISH";
    ...
    address public tokenInPair = 0x3c58D2169aF1085Aad65a188193d10C3053b41dD; //usdt
    ...
    constructor() {
        ...
        //     .createPair(address(this), address(tokenInPair));
    ...
    function openTrading() external onlyOwner {
        ...
        IERC20(address(tokenInPair)).approve(
        ...
        pancakeswapV2Router.addLiquidity(
            ...
            IERC20(address(tokenInPair)).balanceOf(address(this)),
            0,
            0,
            owner(),
            block.timestamp
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 initialBalance = IERC20(address(tokenInPair)).balanceOf(
            address(this)
        );
        ...
        uint256 newBalance = IERC20(address(tokenInPair)).balanceOf(
            address(this)
        ) - initialBalance;
    ...
    function swapTokensForUsdt(uint256 tokenAmount) private {
        // generate the pancakeswap pair path of token -> usdt
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = address(tokenInPair);
