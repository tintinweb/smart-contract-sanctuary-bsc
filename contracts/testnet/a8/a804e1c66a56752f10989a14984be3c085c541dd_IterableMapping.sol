...
contract OhMyShitcoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ohmy", "OhMyGame"){
        ...
        liquidityTokensAtAmount = totalSupply * 35 / 100;       // 24% Liquidity
        presaleTokensAtAmount = totalSupply * 25 / 100;         // 25% Pre-sale
        maxTransactionAmount = totalSupply * 20 / 1000;         // 2% maxTransactionAmountTxn
        lockTokensAtAmount = totalSupply * 80 / 1000;           // 15% LOCK WALLET 6 Months () This will be used to add "Liquidity or Burnt"
        airdropTokensAtAmount = totalSupply * 70 / 1000;        // 12% Airdrop Wallet
        ...
        presaleWallet = address(0x6BCB4A25590a1f0Fe6e41012277605B2C16fb104);  // set as presale wallet
