...
contract DAOVoting is Ownable, DAO  {
  ...
  function deposit(uint256 _amount) public onlyOwner {
      ...
      uint256 perShare = (_amount.mul(1e12)).div(totalSupply);
  ...
  function claim() public {
    ...
    uint256 reward = (share.mul(PROFIT_PER_SHARE).div(1e12)).sub(user.lastRewardedAmount);
    ...
    user.lastRewardedAmount = (share.mul(PROFIT_PER_SHARE).div(1e12));
