...
contract ProtocolOwnedDEXLiquidity is Ownable {
    ...
    IUniswapLPToken constant public lpToken = IUniswapLPToken(0xF87a9621b0d955A9f660650116D5FD40e94AFbdb);
    IERC20 constant public gFTM = IERC20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
    IMultiFeeDistribution constant public treasury = IMultiFeeDistribution(0x3c1d8e613C21E29336829d3D5dF47e5A6F321e9f);
    ...
    constructor(
        ...
        IChefIncentivesController chef = IChefIncentivesController(0xe259e2F02623C8B1e11e6E1c6BD5a47B9dDbc5B3);
