...
contract GlobalHas is Context, ERC20, Ownable {
    ...
    // Address that include in ondel LP list
    mapping(address => bool) private _includeInOndelLpList;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 8000000000000000 * 10 ** 8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "GLOBAL HAS";
    string private _symbol = "G-HAS";
    ...
    // Minimum ONDEL sell order to trigger buyback
    ...
    constructor () public {
        ...
        _includeInOndelLpList[uniswapV2Pair] = true;
    ...
    function isIncludedInOndelLpList(address _address) public view returns (bool) {
        return _includeInOndelLpList[_address];
    }

    function setIncludeInOndelLpList(address _address, bool _isIncludedOrNot) public onlyOwner {
        ...
        _includeInOndelLpList[_address] = _isIncludedOrNot;
    }
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= MIN_TX_AMOUNT_HARD_CAP, "maxTxAmount have to be greater than 1 ondel");
