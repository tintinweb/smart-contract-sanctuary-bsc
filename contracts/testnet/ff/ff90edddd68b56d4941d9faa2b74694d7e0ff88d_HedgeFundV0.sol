...
contract HedgeFundV0 is Ownable {
  ...
  function testSwapToBUSD() public onlyOwner {
  ...
  function testSwapToWBNB() public onlyOwner {
  ...
  function wasteGasAndSwapFee(uint256 iterations) external onlyOwner {
  ...
  function letsGoBrandon() external onlyOwner {
  }
