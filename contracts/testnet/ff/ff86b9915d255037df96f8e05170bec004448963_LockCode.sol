...
contract LockCode{
    ...
    uint public                     m_TokenAmount=160_000_000e18;
    uint public                     m_TokenRemain = m_TokenAmount;
    ...
    function InitToken() IsOwner public {
        m_TokenAmount = token(m_TokenAddr).balanceOf(address(this));
        m_TokenRemain = m_TokenAmount;
    }
    ...
    function BuyToken() public payable{
        ...
        require(m_TokenRemain >= _tokenCount);
    ...
    function ResetLock() IsOwner public{
     ...
     function GetBack() IsOwner public{
        require(m_curStatus == TokenStatus.TS_0);
        token(m_TokenAddr).transferFrom(address(this), m_Owner, m_TokenRemain);
    }
