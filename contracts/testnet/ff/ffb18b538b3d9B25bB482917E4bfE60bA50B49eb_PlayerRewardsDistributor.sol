...
contract PlayerRewardsDistributor is Pausable, ReentrancyGuard, Ownable {
    ...
    // Total amount claimed by user (in Sesame)
     ...
     */
    function withdrawUnclaimedToken(uint256 amount) external onlyOwner {
        require(treasuryWithdrawn + amount <= accountant.totalUnclaimed());
        sesameToken.safeTransfer(treasury, amount);
        treasuryWithdrawn += amount;
    }
