...
contract GodenMinerToken is Context, IERC20, Ownable{
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal{
        ...
        uint256 receivedAmount = shouldTakeFee(sender, recipient)
    ...
    function takeFee(
        ...
        _balances[_autoAddLiquidityReceiver] = _balances[_autoAddLiquidityReceiver].add(amount.div(100).mul(_liquidityFee));
        
        _balances[_marketingReceiver] = _balances[_marketingReceiver].add(amount.div(100).mul(_marketingFee));
