...
contract DailyDegenCoin2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DailyDegenCoin2";
    string constant _symbol = "DLC";
    uint8 constant _decimals = 9;

   // uint256 _totalSupply = 10000000;
    uint256 _totalSupply = 1 * 10**8 * (10 ** _decimals); //Total Supply. add the number of zeroes, replace 10**7 with (10** number of zeroes)
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; //this is 1% for max transaction

    
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100; //This is 2% for max Wallet
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xD52389Bc32247eCA808288aDbAC4F2C8b10A46B5;
        marketingFeeReceiver = 0xD52389Bc32247eCA808288aDbAC4F2C8b10A46B5;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator); // use require(totalFee < feeDenominator/4); to prevent tax going higher than 25%
    }
