...
import {IOceanDriveGovernance} from '../interfaces/IOceanDriveGovernance.sol';
 ...
 * @dev Main point of interaction with OceanDrive protocol's governance
 * - Create a Proposal
 * - Cancel a Proposal
 * - Queue a Proposal
 * - Execute a Proposal
 ...
 * @author Aave
 **/
contract OceanDriveGovernance is Ownable, IOceanDriveGovernance {
  ...
  string public constant NAME = 'OceanDrive Governance';
...
import {IOceanDriveGovernance} from './IOceanDriveGovernance.sol';
...
interface IExecutorWithTimelock {
   ...
   **/
  function isProposalOverGracePeriod(IOceanDriveGovernance governance, uint256 proposalId)
    external
    view
    returns (bool);
  /**
...
interface IProposalValidator {
  ...
  function validateCreatorOfProposal(
    IOceanDriveGovernance governance,
    address user,
    uint256 blockNumber
   ...
   **/
  function getMinimumPropositionPowerNeeded(IOceanDriveGovernance governance, uint256 blockNumber)
    external
    view
    returns (uint256);
   ...
   **/
  function isProposalPassed(IOceanDriveGovernance governance, uint256 proposalId)
    external
    view
    returns (bool);
   ...
   **/
  function isQuorumValid(IOceanDriveGovernance governance, uint256 proposalId)
    external
    view
    returns (bool);
   ...
   **/
  function isVoteDifferentialValid(IOceanDriveGovernance governance, uint256 proposalId)
    external
    view
    returns (bool);
...
interface IOceanDriveGovernance {
