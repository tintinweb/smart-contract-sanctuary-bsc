...
contract IShopmetaNFT is ERC721Enumerable, Ownable {
    ...
    uint public constant MAX_PER_MINT = MAX_SUPPLY;
    
    string public baseTokenURI;
    
    constructor() ERC721("IShopmetaNFT", "ISHOP") {
    ...
    function mintNFTs(uint _count,string memory _baseTokenURI) public payable {
