...
contract NFTStaking is ERC721HolderUpgradeable,OwnableUpgradeable {
    IBEP20 constant BVG = IBEP20(0x31C5F8C0cd7eE0daA37Df1174114252B3E780E12);
    ...
    I721 constant OAT = I721(0x9F471abCddc810E561873b35b8aad7d78e21a48e);
    I721 constant IGO = I721(0x927a7f35587BC7E59991CCCdd2D4aDd1f0e7bc66);
    I721 constant info = I721(0xaf84c52D2117dADBD22FC440825e901E8d4E3BD2);
    mapping(address =>mapping(uint => address)) public cardOwner;
    uint constant IGOPower = 12700;
