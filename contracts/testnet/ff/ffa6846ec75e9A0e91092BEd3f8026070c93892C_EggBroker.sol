...
contract EggBroker is Ownable {
    ...
    address public mebTokenAddress = 0xdA0B47eD306F2bF6b128e5a84389b1f270932Cb6;
    address public eggMebPairAddress = 0x265aF587516788D22c3f4e38F178150dBa674345;
    address public eggTokenAddress = 0xe308c371c026d46B45295c199abd61A8b1A85d2E;
    ...
    function applyGoldAgent() public {
        ...
        require(levelOneFriendCount[msg.sender] >= 50, "You don't invite enough friends");
    ...
    function processGoldAgentBalance() public {
        ...
        for (uint256 i = 0; i < goldAgentAddress.length; i++) {
            if (!_verifySatisfyAgentLevel(goldAgentAddress[i], 3) || levelOneFriendCount[msg.sender] < 50) {
