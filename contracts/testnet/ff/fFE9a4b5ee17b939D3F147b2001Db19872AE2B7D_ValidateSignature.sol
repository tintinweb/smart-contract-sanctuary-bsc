    ...
    ReentrancyGuardUpgradeable
{
    ...
    function validateSignature(
        ...
        bytes memory encoded = abi.encodePacked(
            _sender, _toChain, _toRouter, _amountIn, _amountOut, _to
            );
            
        encoded = bytes.concat(encoded, encodeTightlyPacked(_path1));
        ...
        emit ValidateSignatureEvent(signerAddress);
    }
    ...
    event ValidateSignatureEvent(address signer);
}
