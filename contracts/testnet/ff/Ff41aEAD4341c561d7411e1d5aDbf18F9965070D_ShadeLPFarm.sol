...
// ------------------------------------- LP Staker -------------------------------------------
// -------------------------------------------------------------------------------------------
contract ShadeLPFarm is ERC20, Ownable {
	...
	constructor() ERC20("ShadeDummy", "SHD") {
		shade = IERC20(0x3A3841f5fa9f2c283EA567d5Aeea3Af022dD2262);
		masterChef = IMasterChef(0x1719ab3C1518eB28d570a1E52980Dbc137B12e66);
		lpToken = IERC20(0x20aa395F3bcc4dc44a94215D129650533B3da0b3);
	}
	...
	// View function to see pending SHADEs on dApp UI.
	...
	function contractData() public view returns (uint256 _lpDeposited, uint256 _shadePerSecond) {
