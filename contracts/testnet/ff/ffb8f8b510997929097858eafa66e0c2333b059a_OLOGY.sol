...
contract OLOGY is Context, Ownable, IERC20, ERC20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingAddress = payable(0x893dBB201653d4422c2D1Baf1A1cE3EbCF8Bdf22);
    ...
    constructor () ERC20Detailed("Coinology", "OLOGY", 9) {
	...
	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //BSC_MAINNET
    ...
    function setBuyFeePercent(uint256 updatedMarketingFee, uint256 updatedLiquidityFee) external onlyOwner {
        ...
        require(buyTotalFee <= 15, "Fee is crossing the boundaries");
    }
    ...
    function setSellFeePercent(uint256 updatedMarketingFee, uint256 updatedLiquidityFee) external onlyOwner {
        ...
        require(sellTotalFee <= 15, "Fee is crossing the boundaries");
    }
