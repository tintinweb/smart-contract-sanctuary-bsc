...
/* Token contract */
contract BullsVerse is IBEP20, Auth {
    ...
    address DEV = 0x226235b21aF729B87e897d209Cda023B933f5b53;
    ...
    // Name and symbol
    string constant _name = "BullsVerse";
    string constant _symbol = "BVERSE";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 20 / 10000; // 2% (2 mil)
    uint256 public _maxSellTxAmount = _totalSupply * 10 / 10000; // 1% (1 mil)
    uint256 public _maxWalletToken = ( _totalSupply * 20 ) / 10000; // 2% (2 mil)
    ...
    /* Token constructor */
    constructor (address _lp, address _presaler) Auth(msg.sender) {
        ...
        isFeeExempt[_lp] = true;
        isTxLimitExempt[_presaler] = true;
        isTxLimitExempt[_lp] = true;
        ...
        uint256 presaleAmount = _totalSupply.mul(10).div(100);
        uint256 lpAmount = _totalSupply.mul(90).div(100);
        _balances[_presaler]+= presaleAmount;
        _balances[_lp]+=lpAmount;

        emit Transfer(address(0), _presaler, presaleAmount);
        emit Transfer(address(0), _lp, lpAmount);
    }
    ...
    // if the sender is not pair
    // if not inswap
    // if swap is enabled
    // if balance of this contract is greater than or equal to threshold
...
contract DividendDistributor is IDividendDistributor {
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            require(success, "Failed to transfer earned bnb dividend`");
