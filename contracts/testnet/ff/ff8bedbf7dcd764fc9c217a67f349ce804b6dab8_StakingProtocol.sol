...
////////////////////////////////////////// fields definition
    ...
    uint256 private approximateFullBalanceInBase;
...
////////////////////////////////////////// view methods
    ...
    function getNFTBondManager()
        internal
        view
        returns (INFTBondManager)
    {
        return INFTBondManager(nftBondManager);
    }
...
////////////////////////////////////////// fullBalance
        ...
        returns(uint256)
    {
        ...
        return (
                (stakingLastUpdateDate - stakingStartDate) * approximateFullBalanceInBase // cumulativePreviousFullBalance
                +
                (block.timestamp - stakingLastUpdateDate) * currentFullBalanceInBase // cumulativeCurrentFullBalance
            ) / (
                block.timestamp - stakingLastUpdateDate
            );
    }
...
////////////////////////////////////////// info
    ...
    // todo rm in prod
    function getCurrentAmountInBaseDev(
        address _account
    )
        public
        view
        returns (uint256)
    {
        ...
        return __getAmountInBase(_accountPeriodInfo);
    }
