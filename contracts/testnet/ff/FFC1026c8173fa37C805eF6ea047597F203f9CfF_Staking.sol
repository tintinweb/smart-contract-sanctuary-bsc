...
contract Staking is IStaking, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    function addPool(
        ...
        pool.stakingLimit = _stakingLimit;
        ...
        updateReward(_pid, msg.sender)
    {
        ...
        require(pool.staked[msg.sender].add(_amount) <= pool.stakingLimit, "Stake: _amount is too high");
        require(pool.totalStaked < pool.poolLimit, "Stake: pool already filed");
