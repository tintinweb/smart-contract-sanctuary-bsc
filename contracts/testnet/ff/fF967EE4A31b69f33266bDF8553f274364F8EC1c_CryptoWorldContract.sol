...
contract CryptoWorldContract is Ownable, ReentrancyGuard {
    ...
    function setRenewAccount() external payable nonReentrant {
        ...
        //uint256 valorDisponivelSaquePacoteAnterior = totalAcumuladoAReceber;//totalAReceber(msgSender);
        ...
        accMapping[msgSender].valorDisponivelSaquePacoteAnterior = totalAcumuladoAReceber;
        _controlEnter();
    }
