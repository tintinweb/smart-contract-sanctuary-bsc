...
contract PreSaleTokensMorgan is Ownable, ReentrancyGuard {
    ...
    /**
     * --------------------
     * Returns Total On PreSale
     * --------------------
     */
    function getTotalOnPreSale() public view returns (uint256) {
        return totalOnPreSale;
    }
    ...
    function claimTokens(uint256 amount) public isPausable() isClaiming() {
        ...
        ContractAdd.transfer(wallet, amount*_DECIMALFACTOR);
        pendingBalance[wallet] -= amount;

        emit WithdrawnUser(wallet, amount*_DECIMALFACTOR);
    }
