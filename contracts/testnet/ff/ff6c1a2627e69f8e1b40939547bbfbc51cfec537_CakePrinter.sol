...
/**
    ...
    50 tickets max per user. 25 CAKE = 50 tickets.
    0.5 CAKE deposit = 1 per ticket. based on user deposit/compound.
...
contract CakePrinter {
    ...
    address erctoken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; //0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82; /** mainnet CAKE **/
    ...
    uint256 public LOTTERY_TICKET_PRICE = 5 * 1e17; /** 0.5 CAKE **/
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
		...
		token_CAKE.transfer(owner, ownerFee);
