...
contract Dynamic is IERC20, Ownable {
    ...
    address public communityAddress = 0x97b2186C4EA96b44989216490Ad2A770f1779fd5;
    address public defaultAddress = 0x938aa29af17b004c6A0fFfa3ae5D808B2B81e42B;
    address public USDT = 0x55d398326f99059fF775485246999027B3197955;

    string private _name = "dynamic HT";
    ...
    uint256 public holderAmount = 10 * 10**18;
    
    uint256 currentIndex;  
    uint256 private _tTotal = 21000 * 10 ** 18;
    uint256 public swapProcess = 50 * 10**18;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _takeInviterFee(
        ...
        uint256 accurRate;
		uint16[5] memory inviteRate = [300, 200, 100, 50, 50];
