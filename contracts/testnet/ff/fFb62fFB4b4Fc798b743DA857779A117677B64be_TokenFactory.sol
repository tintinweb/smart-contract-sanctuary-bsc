...
contract TokenFactory {
  ...
  Gtoken[] public list_of_tokens;


//function createToken(address _owner, uint256 _funds) external {

 function createToken(uint256 _initialSupply, string memory _tname, string memory _tiker) external {
    gtoken = new Gtoken(_initialSupply, _tname, _tiker);
    gtoken.transfer(msg.sender, _initialSupply);
    list_of_tokens.push(gtoken);
  }
}