...
contract UberTaxiDate is Ownable {
    ...
    function querySellVehiclesByTokenId(uint256 tokenId) public view returns(MyVehicle memory mySellVehicle){
...
contract UberTaxiController6 is Ownable {
    ...
    constructor() {
        ...
        UTD = UberTaxiDate(0x4E45Adc691cbF565AfD626588f097B7124D623Fd);
