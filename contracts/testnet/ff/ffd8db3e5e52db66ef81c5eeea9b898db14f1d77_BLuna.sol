...
contract BLuna is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x0abF485dB1b16a42af1A8cCBb486e5722abfc80c); 

    uint8 private constant _decimals = 18;
    uint256 private _tTotal = 10**14 * 10**_decimals;
    uint256 private OriginalSupply = _tTotal;
    string private constant _name = "BLUNA"; 
    string private constant _symbol = "Burn The Supply"; 
    ...
    constructor () {
        _owner = 0x0abF485dB1b16a42af1A8cCBb486e5722abfc80c;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal -  10000000000000000000000;
        _tOwned[address(this)] = 10000000000000000000000;
        ...
        _isLimitExempt[Wallet_Dev] = true; 
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (Percent_AutoLP != 0){
            ...
            emit SwapAndLiquify(tokens_to_LP_Half, BNB_Total, tokens_to_LP_Half);
        } 
    }
    ...
    */
    ...
    function addLiquidityExternal(uint256 tokenAmount) external payable {
