...
contract Busdriver {
    ...
    uint256 public WITHDRAWAL_TAX = 850;
...
BUSDriver
 Jump on the bus, get fuel, take stops to collect BUSD. 
  ...
  2.0% stacking compound bonus every 12 hrs, max of 5 days. (20%)
  48 hours cut off time.
  10 BUSD minimum investment.
  15,000 BUSD max deposits per wallet.
  90% feedback for withdrawals that will be done not after 7 consecutive compounds.(12.5%)
