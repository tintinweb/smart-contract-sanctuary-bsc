...
contract FourJAlliance is Ownable {
    ...
    function create4JID(string memory _initialURI) lock public payable {
        ...
        uint256 _characterID = characterCount + 5001;
    ...
    function burn4JID(uint256 _tokenID) public {
        ...
        require(fourJID.identityLevel(_tokenID) == 0, "FourJAlliance: only normal NFT.");
        require(_tokenID > 5000, "FourJAlliance: token id error.");
