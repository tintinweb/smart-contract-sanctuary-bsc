...
contract Tokentest is Ownable, ERC20 {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Tokentest", "$TST"){
    	...
    	marketingWallet = address(0xA0ebeA363143F7f5DB7166c0C9f03f702Df60dD4);
    	developmentWallet = address(0x0e8Ab3997Fa3c8c6f9313f46E618bf7f8C9C310a);
    ...
    function airdropTokentest(address[] memory airdropWallets, uint256[] memory amounts) external onlyOwner() {
    ...
    function swapBack(uint256 contractTokenBalance) internal {
        ...
        if (amountToBurn > 0){
            transfer(address(0x7B1C79935eEb2528307C434860812A3797B29B54), amountToBurn);
        }
    ...
    function buyBackTokens(uint256 bnbAmountInWei) external onlyOwner {
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: bnbAmountInWei}(
            ...
            path,
            address(0x7B1C79935eEb2528307C434860812A3797B29B54),
            block.timestamp
        );
    }
    ...
    function AirdropTokentest(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
