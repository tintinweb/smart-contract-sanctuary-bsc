...
contract LyLevel is Initializable, OwnableUpgradeable, IERC20 {
    ...
    /// @notice v4: enable vesting duration
    function upgrade_useBatchVesting(uint256 _batchVestingDuration) external reinitializer(4) {
        batchVestingDuration = _batchVestingDuration;
        // epochDuration = 1 days;
        // epochReward = 20_000 ether;
    }
