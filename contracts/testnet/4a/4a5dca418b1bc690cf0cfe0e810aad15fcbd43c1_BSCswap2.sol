...
contract BSCswap2 {
    ...
    uint256[5] private balReached = [1000e18, 2000e18, 4000e18, 6000e18, 10000e18];
    uint256[5] private balFreezeStatic = [700e18, 1400e18, 2800e18, 4200e18, 7000e18];
    uint256[5] private balFreezeDynamic = [400e18, 800e18, 1600e18, 2400e18, 4000e18];
    uint256[5] private balRecover = [700e18, 1400e18, 2800e18, 4200e18, 7000e18];
    ...
    function _setReferral(address _user,address _referral, uint256 _refAmount, bool _isReDept) private {
        for(uint8 i = 0; i < level_bonuses.length; i++) {
            ...
            if(userInfo[_referral].isLeader==0 || userInfo[_referral].isManager==0){
                ...
                if(userInfo[_referral].isCo==0 && userInfo[_referral].myActDirect[0]>=1 && userInfo[_referral].myLastDeposit>=300e18 && (lbA+lbB)>=2000e18){
                ...
                if(userInfo[_referral].isLeader==0 && userInfo[_referral].myActDirect[1]>=3 && userInfo[_referral].myLastDeposit>=1000e18 && (ltA+ltB)>=5 && (lbA+lbB)>=6000e18){
                   userInfo[_referral].isLeader=1;
                   userInfo[userInfo[_referral].referrer].myActDirect[2]++;
                }
                if(userInfo[_referral].isManager==0 && userInfo[_referral].myActDirect[2]>=3 && userInfo[_referral].myLastDeposit>=2000e18 && (ltA+ltB)>=15 && (lbA+lbB)>=20000e18){
