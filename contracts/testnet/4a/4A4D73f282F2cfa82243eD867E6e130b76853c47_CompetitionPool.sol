...
contract CompetitionPool is Ownable, ReentrancyGuard, Metadata {
    ...
    function betSlip(Bet[] memory _betSlipList) public nonReentrant {
    ...
    function createNewRegularCompetition(
        ...
        ICompetitionContract.SportType _sportTypeAlias,
        IRegularCompetitionContract.BetOption[] memory _betOptions
    ) public returns (address) {
        require(_betOptions.length <= limitOption, "CP: Exceed limit");
        ...
        regularCompetitionContract.setBetOptions(_betOptions);
    ...
    function createNewP2PCompetition(
        ...
        P2PcompetitionContract.setEntryFee(_entryFee);
