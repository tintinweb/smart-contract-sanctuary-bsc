...
contract BlackDiamond is Ownable, IERC20 {
    ...
    string constant private _name = "Black Diamond";
    string constant private _symbol = "Diamond";
    uint8 constant private _decimals = 18;
    uint256 constant private _initialSupply = 5000000*10**18;
    ...
    constructor () {
        ...
        _mint(address(this), 3000000*10**18);
    }
    /* EXCLUSIVE FUNCTIONS */
    ...
    function manual_mint(uint256 amount) public virtual onlyOwner {
        require(_totalSupply + amount <= _initialSupply, "Total supply cannot be more than 5000000.");
    ...
    function firstMintExecute() public virtual onlyOwner returns (bool) {
        ...
        require(_totalSupply + 5000000*10**18 <= _initialSupply, "Total supply cannot be more than 5000000.");
        require(address(this).balance >= 5000000*10**18, "You need to have at least 5000000 to mint.");
        _transfer(address(this), owner(), 5000000*10**18);
        firstMint_Sent = true;
        return true;
    }
