...
contract PresaleFactory is Ownable {
    ...
    function claim() public returns (bool) {
        ...
        return _gocAddress.transferFrom(address(this), msg.sender, _userPaidUSDT[msg.sender]);
    }
    ...
    function withdrawTokens() public onlyOwner returns (bool) {
        ...
        return _gocAddress.transferFrom(address(this), msg.sender, _gocAddress.balanceOf(address(this)));
    }
