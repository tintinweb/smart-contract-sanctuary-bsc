    ...
    ShopContract
{
    ...
    function setUAddress(address tempAddress_) external onlyMinter {
        _setUAddress(tempAddress_);
    }

    function getUAddress() external view onlyMinter returns (address) {
        return _getUAddress();
    }
