...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, Ownable {
  ...
  constructor(string memory _name, string memory _symbol)  ERC20(_name, _symbol) {
      IRouter _router = IRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // BSC router                               0x10ED43C718714eb63d5aA57B78B54704E256024E
      router = _router;
...
contract FUCA is ERC20, Ownable {
    ...
    FUCA_DividendTracker public dividendTracker;
    ...
    constructor() ERC20("FUCA", "FUCA Token") {
        dividendTracker = new FUCA_DividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        FUCA_DividendTracker newDividendTracker = FUCA_DividendTracker(
            payable(newAddress)
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "FUCA: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
 ...
 uint256 holders;
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(automatedMarketMakerPairs[newPair] != value,"FUCA: Automated market maker pair is already set to that value");
    ...
    function setGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "FUCA: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "FUCA: Cannot update gasForProcessing to same value"
        );
...
contract FUCA_DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("FUCA_Dividen_Tracker", "FUCA_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "FUCA_Dividend_Tracker: No transfers allowed");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "FUCA_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "FUCA_Dividend_Tracker: Cannot update claimWait to same value"
        );
