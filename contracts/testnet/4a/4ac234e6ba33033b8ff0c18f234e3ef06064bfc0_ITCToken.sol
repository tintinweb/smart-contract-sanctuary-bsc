...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x923e4656b01787F44aCe960C036d57e110dC45b6;
...
contract ITCToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x923e4656b01787F44aCe960C036d57e110dC45b6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 2000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ITC Token";
    string private _symbol = "ITCT";
