...
contract Test is Ownable {
    ...
    uint256 private constant DAILY_AUTO_REINTEREST_RATE = 80;
    ...
    function reinvest() public {
		require(investors[msg.sender].lastWithdrawDate.add(MIN_WITHDRAW) <= block.timestamp,"Reinvest limit is 1 withdrawal in 24 hours");
