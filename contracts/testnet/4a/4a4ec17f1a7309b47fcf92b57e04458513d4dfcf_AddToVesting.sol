...
// File: contracts/AddToVesting.sol




contract AddToVesting is Ownable {
    ...
    constructor (address MTVTAddress) {
        ...
        limitStack = 200000000 ether ; // Vesting Limit Token  
    ...
    function getReceivableToken(address _user) public view returns(uint256){
        ...
        totalToken = totalToken - getClaimed(_user);
        return totalToken;
    ...
    function getClaimed(address _user) public view onlyUser(_user) returns(uint256) {  
        uint256 totalToken=0;
