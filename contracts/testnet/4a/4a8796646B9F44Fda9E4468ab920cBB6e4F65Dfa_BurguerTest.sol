...
contract BurguerTest is Context, IERC20, Ownable {
    ...
    string private constant _name = "BurguerTest"; // 
    string private constant _symbol = "BURT"; //
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public _marketingWallet = 0xB1A2e3dE86535fB7A0b5FAEF990Fd9672e914B93;
