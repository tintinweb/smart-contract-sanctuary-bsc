...
contract vmmNFTMarketplace is Ownable, ReentrancyGuard {
    ...
    function resultAuction(address _nft, uint256 _tokenId) external {
        ...
        payToken.transferFrom(auction.lastBidder, feeRecipient, platformFeeTotal);

        // Transfer to auction creator
        payToken.transferFrom(auction.lastBidder, auction.creator, totalPrice - platformFeeTotal);

        // Transfer NFT to the winner
        nft.transferFrom(auction.creator, auction.lastBidder, auction.tokenId);
