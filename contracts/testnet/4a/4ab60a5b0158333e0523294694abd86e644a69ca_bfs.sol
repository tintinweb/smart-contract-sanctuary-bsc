...
contract bfs{  
    ...
    constructor(WERC20 _payAddress, WERC20 _hostAddress, IPancakeRouter02 _swapToken) {
        ...
        products.push(Product(1, 100000000000000000000));
        emit ProductLog( 1, 100000000000000000000);
        products.push(Product(2, 500000000000000000000));
        emit ProductLog( 2, 500000000000000000000);
        products.push(Product(3, 1000000000000000000000));
        emit ProductLog( 3, 1000000000000000000000);
