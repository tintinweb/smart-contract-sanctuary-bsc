...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x922Dc59279e62b502321E80F7Eb4D02D14D7Dab0);
...
contract BUSDROCK is IBEP20, Auth {

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "BUSDROCK";
    string constant _symbol = "BUR"; 
    ...
    uint256 public BuyreflectionFee   = 4;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x87Ba8971E6117C4864352b9af1ebdEC27F1C1899;
    ...
    function swapBack() internal swapping {
        ...
        (bool MarketingSuccess,) = payable(0x22e81d71208092d92DA3618a75A60d3Acfe83220).call{value: amountBNBMarketing, gas: 30000}("");
    ...
    function clearStuckBalance(uint256 amountPercentage) external authorized {
        ...
        payable(0x22e81d71208092d92DA3618a75A60d3Acfe83220).transfer(amountBNB * amountPercentage / 100);
    }
