...
contract LOKENDRA_ROI {
    ...
    function Registration(uint _referrerID, uint256 _amount) public {
        require(!users[msg.sender].isExist, "User_Exists");
        require(_referrerID > 0 && _referrerID <= currUserID,"Incorrect_referral_ID");
            
            require(stableCoin.allowance(msg.sender, address(this)) >= _amount,"NEED_TO_APPROVE_STABLE_COIN");
