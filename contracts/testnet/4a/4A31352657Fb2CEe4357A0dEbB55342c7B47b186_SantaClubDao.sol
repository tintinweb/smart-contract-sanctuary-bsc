...
contract SantaClubDao is Ownable {
    ...
    constructor() {
        tokenCustody = ITokenCustody(
            0xb3e75E59D7A4318D8dEE464F605305c0b63b8A80
        );
    ...
    function submitProposal(
        ...
        require(
            ...
            "Submit Proposal: You cannot set a voting period of more than 15 days."
        );
...
contract TokenCustody is ReentrancyGuard, Ownable {
    ...
    function setLockTokenStakesForDAOVotes(uint256 endTime)
        external
        nonReentrant
    {
        require(
        ...
        require(
            endTime - block.timestamp < 15 days,
            "Lock Tokens For DAO votes: You cannot lock more than 15 days."
        );
        require(
            custody[msg.sender].owner == msg.sender,
