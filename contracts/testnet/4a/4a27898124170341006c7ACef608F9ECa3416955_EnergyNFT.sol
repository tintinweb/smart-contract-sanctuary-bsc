...
import "./signature/Signer.sol";
import "./transferFee/MintingFee.sol";
import "./fuse/FuseNFT.sol";

contract EnergyNFT is ERC721, ERC721Burnable, AccessControl, Signer, MintingFee, FusionNft {
...
contract FusionNft is AccessControl {
