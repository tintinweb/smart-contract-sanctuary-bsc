...
contract PlayerBook {
    ...
    //    (_|(_| | (_|  _\(/_ | |_||_)  .
    //=============================|================================================
    //uint256 public registrationFee_ = 10;           // price to register a name
    ...
    constructor() {
        ...
        plyr_[1].addr = 0x322dAb6325De6f5BC2Ba8efECC2bCbECac4f89F3;
        plyr_[1].name = "justo";
        plyr_[1].names = 1;
        pIDxAddr_[0x322dAb6325De6f5BC2Ba8efECC2bCbECac4f89F3] = 1;
        pIDxName_["justo"] = 1;
        plyrNames_[1]["justo"] = true;
        plyrNameList_[1][1] = "justo";

        plyr_[2].addr = 0x6723dd56EA8b764cA1b7E9D541fb56451E3cf9E5;
        plyr_[2].name = "mantso";
        plyr_[2].names = 1;
        pIDxAddr_[0x6723dd56EA8b764cA1b7E9D541fb56451E3cf9E5] = 2;
        pIDxName_["mantso"] = 2;
        plyrNames_[2]["mantso"] = true;
        plyrNameList_[2][1] = "mantso";

        plyr_[3].addr = 0x9Eb6396Af3AFF45d2126C6c377F2f4D678cE30Ea;
        plyr_[3].name = "sumpunk";
        plyr_[3].names = 1;
        pIDxAddr_[0x9Eb6396Af3AFF45d2126C6c377F2f4D678cE30Ea] = 3;
        pIDxName_["sumpunk"] = 3;
        plyrNames_[3]["sumpunk"] = true;
        plyrNameList_[3][1] = "sumpunk";

        plyr_[4].addr = 0xa21A74b14147D4EDB24B505801b685ece6184FcE;
        plyr_[4].name = "inventor";
        plyr_[4].names = 1;
        pIDxAddr_[0xa21A74b14147D4EDB24B505801b685ece6184FcE] = 4;
    ...
    function determinePID(address _addr) private returns (bool) {
        console.log("Called Determine playbook");
    ...
    //  (/_>< | (/_| | |(_||  (_(_|||_\  .
    //==============================================================================
    function another() external pure returns (string memory) {
        return "Prosper";
    }
    ...
    function getPlayerID(
        ...
        console.log("running getPlayer Id");
        determinePID(_addr);
    ...
    */
    ...
    //  _\(/_ | |_||_)  .
    //=============|================================================================
    function addGame(address _gameAddress, string memory _gameNameStr) public {
        require(
