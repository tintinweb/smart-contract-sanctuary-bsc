...
contract Dalchand {
    ...
    constructor(address payable ownerAddress) public {
        ...
        userIdsRowWise[1][0]=3;
        userIdsRowWise[1][0]=4;
        userIdsRowWise[1][0]=5;
    ...
    function getReferral() internal returns(uint256)
    {
        ...
        else
        {
            ...
            if(lastIDCount4x4==(minId)+(4**(activeParentRowNo))+(4**(activeChildRowNo)))
            {
                ...
                uint256 index = (lastIDCount4x4 - minId)-(4**activeParentRowNo);
                return userIdsRowWise[activeParentRowNo][index];
            }
        }
    }
