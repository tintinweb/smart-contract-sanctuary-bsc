...
contract KingBack is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KingBack";
    string private _symbol = "KingBack";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x216c759da7c939d38828Cd11e3FdaF16AAdfFF6E);
    address payable public teamWalletAddress = payable(0x183CdCc1adDae8dCe52fcc52d3136e88A9442a6A);
    ...
    constructor () {
        ...
        emit Transfer(address(0xc748673057861a797275CD8A068AbB95A902e8de), _msgSender(), _totalSupply);
    }
