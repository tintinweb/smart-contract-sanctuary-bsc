...
contract ISP is ERC20, Ownable {
    ...
    uint256 private _totalFeesOnBuy     = liquidityFeeOnBuy + devFeeOnBuy + marketingFeeOnBuy;
    uint256 private _totalFeesOnSell    = liquidityFeeOnSell + devFeeOnSell + marketingFeeOnSell;

    address public  marketingWallet = 0xA8328A8bF82859e869Cd07eF87d8518e9901Be32;
    address public  devWallet = 0x3D8bb0Cec54eC75c7e5e064e2dE7600E2B67435b;
    ...
    event UpdateSellFees(uint256 liquidityFeeOnSell, uint256 marketingFeeOnSell, uint256 devFeeOnSell);
    ...
    constructor()ERC20("Island Punk",  "ISP") {
        operator = msg.sender;
    ...
    modifier onlyAuthorized(){
        require(operator == _msgSender() || owner() == _msgSender(), "Caller is not authorized");
        _;
    }
    function setEnableTrading() external onlyAuthorized{
        require(enableTrading == false, "Trading is already enabled");
        enableTrading = true;
    }

    function changeOperator(address newOperator) onlyOperator external {
    ...
    function updateBuyFees(uint256 _liquidityFeeOnBuy, uint256 _marketingFeeOnBuy, uint256 _devFeeOnBuy) external onlyOwner {
        require(
            _liquidityFeeOnBuy + _marketingFeeOnBuy + _devFeeOnBuy <= 10,
        ...
        emit UpdateBuyFees(_liquidityFeeOnBuy, _marketingFeeOnBuy, _devFeeOnBuy);
    }

    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _marketingFeeOnSell, uint256 _devFeeOnSell) external onlyOwner {
        require(
            _liquidityFeeOnSell + _marketingFeeOnSell + _devFeeOnSell <= 10,
            "Fees must be less than 10%"
        );
        liquidityFeeOnSell = _liquidityFeeOnSell;
        devFeeOnSell    = _devFeeOnSell;
        marketingFeeOnSell = _marketingFeeOnSell;
        _totalFeesOnSell   = liquidityFeeOnSell + marketingFeeOnSell + devFeeOnSell;
        emit UpdateSellFees(_liquidityFeeOnSell, _marketingFeeOnSell, _devFeeOnSell);
    }
    ...
    function changeMarketingWallet(address _marketingWallet) external onlyOwner {
        ...
        require(_marketingWallet != address(0),"Makrketing wallet cannot be zero address");
    ...
    function _transfer(
        ...
        if (swapEnabled && 
            ...
            uint256 devTokens = contractTokenBalance - (liquidityTokens + marketingTokens);
