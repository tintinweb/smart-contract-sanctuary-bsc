...
contract  APOToken is StandardToken, SafeMath {
    ...
    // metadata
    string  public constant name = "APO";//修改
    string  public constant symbol = "APO";//修改
    ...
    function changeOwner(address _newFundDeposit) isOwner() external {
     ...
     function transferAnyERC20(address _tokenAddres,address _to, uint256 _value) public returns (bool success) {
