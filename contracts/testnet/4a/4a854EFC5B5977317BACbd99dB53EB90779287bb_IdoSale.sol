...
contract IdoSale is Pausable, AccessControl {
    ...
    uint256 public allocationCoefficient;
    ...
    constructor(
        ...
        endTime = _endTime;
        allocationCoefficient = _allocationCoefficient;
    }
    ...
    function setallocationCoefficient(uint256 _allocationCoefficient) external onlyOperator {
        allocationCoefficient = _allocationCoefficient;
    ...
    function purchase(uint256 amount) external whenNotPaused {
        ...
        require(purchasedAmounts[_msgSender()] + amount <= whitelist[_msgSender()], "MAX_WL");
        uint256 purchaseTokenAmount = amount * idoPrice * allocationCoefficient;
