...
contract DX is Context, IERC20, Ownable {
    ...
    address payable private _devAddress = payable(0xCEc467ed00B54B68889d6209dD7464B462FCdd22);
    
    string private constant _name = "DX";
    ...
    function manualswap() external {
        require(_msgSender() == _devAddress || _msgSender() == owner());
