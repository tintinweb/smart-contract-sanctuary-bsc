...
contract EHXSoloStaking is Ownable, ReentrancyGuard {
    ...
    function pendingReward(address _user) public view returns (uint256) {
        ...
        // console.log("pool.lastRewardTimestamp",pool.lastRewardTimestamp);
        if(pool.lastRewardTimestamp == 99999999999){
            return 0;
        }
        uint256 accTokensPerShare = pool.accTokensPerShare;
        uint256 lpSupply = totalStaked;
        // console.log("pool.accTokensPerShare",pool.accTokensPerShare);
        ...
        if (block.timestamp > pool.lastRewardTimestamp && lpSupply != 0) {
            ...
            // console.log("calculateNewRewards()",calculateNewRewards());
        ...
        // console.log("accTokensPerShare",accTokensPerShare);
        // console.log("user.rewarDebt",user.rewardDebt);
    ...
    function collectEHX(address _user) public{
        ...
        rewardToken.transfer(_user, rewardsPending[_user]);
    }
    //////////CHANGES
    ...
    function withdraw(uint256 _amount) public nonReentrant {
        ...
        if(pending > 0) {
            ...
            rewardsPending[msg.sender]=0;                  ////////////////////////////UPDATE
        ...
        if(_amount > 0) {
            user.amount -= _amount;
            totalStaked -= _amount;
            // console.log("unstakeLockDuration======", unstakeLockDuration);
    ...
    function calculateNewRewards() public view returns (uint256) {
        ...
        // console.log("block.timestamp - pool.lastRewardTimestamp) * totalStaked",(block.timestamp - pool.lastRewardTimestamp) * totalStaked);
        // console.log("block.timestamp - pool.lastRewardTimestamp) * totalStaked) * apy / 100 / 365 days  ==",((block.timestamp - pool.lastRewardTimestamp) * totalStaked) * apy / 100 / 365 days);
    ...
    function claimVestedTokens() external notPaused nonReentrant {
        ...
        if(pending > 0) {
            ...
            rewardsClaimed[msg.sender]+=pending;               /////////////////////UPDATE
            rewardToken.transfer(payable(address(msg.sender)), pending);
        }
    ...
    function currentClaimableAmount(address wallet) public view returns (uint256 amountToClaim){
        ...
        // console.log("currentClaimableAmount1");
