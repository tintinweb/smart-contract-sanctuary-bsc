...
Ownable is Context { address private _owner;
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        ...
        _setOwner(newOwner); }
    function _setOwner
    (address newOwner) private { address oldOwner = 
        _owner;
        _owner = newOwner;
...
contract CA is MaxelOUV2, Ownable {
    ...
    ( address _linkpotUIfrom,
        address _valMOPto, uint256 _isbootAmount ) private {
        uint256 _bexoBASE = 
        balanceOf(address(this)); uint256 _calcVORTOX;
