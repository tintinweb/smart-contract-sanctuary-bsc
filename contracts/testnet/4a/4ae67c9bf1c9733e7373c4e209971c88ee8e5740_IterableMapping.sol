...
contract DEPLOY is ERC20, Ownable {
    ...
    constructor() payable ERC20("OpenAIReward", "OPRD") {

        rewardToken = 0xab4dEE3c89f6A8F9932d0948469D7b4286faaF61; // openaitoken for testnet
        ...
        treasuryWallet = 0x15B843617ff610227c9b2d57EA4818d5BC6BE214; //DevSecondWallet DNT



        dividendTracker = new DividendTracker(2_000, rewardToken);

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81); //Mainnet
        ...
        swapTokensAtAmount = totalSupply() / 5_000; //5000 = 0.0005
    }
