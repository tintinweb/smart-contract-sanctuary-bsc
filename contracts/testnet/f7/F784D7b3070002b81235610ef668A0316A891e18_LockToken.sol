...
contract LockToken is Ownable, ReentrancyGuard {
    ...
    */
    function lockToken(
        ...
        uint256 _amount,
        uint256 _unlockTime)  external  payable  nonReentrant  returns (uint256 _id) {
        require(_amount > 0);
    ...
    function extendLockDuration(uint256 _id, uint256 _unlockTime) external {
        ...
        require(_msgSender() == lockedERC20.withdrawalAddress, "Unauthorised to extend"  );
        require( _unlockTime > lockedERC20.unlockTime,  "ERC20: smaller unlockTime than existing"  );
    ...
    */
    ...
    function withdrawTokens( uint256 _id, uint256 _amount ) external nonReentrant {
        Items storage lockedERC20 = lockedToken[_id];
        require( _msgSender() == lockedERC20.withdrawalAddress, "Unauthorised to unlock" );
    ...
    function _addERC20Deposit ( address _tokenAddress, address _withdrawalAddress, uint256 amountIn,  uint256 _unlockTime ) 
    ...
    function _removeDepositsForWithdrawalAddress( uint256 _id, address _withdrawalAddress ) private {
