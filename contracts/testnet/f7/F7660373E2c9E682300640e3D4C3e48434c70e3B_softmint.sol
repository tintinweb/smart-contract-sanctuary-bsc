...
function safeMint(
        ...
        NftInfo[mintCount].tokenid = mintCount ;
        ...
        NftInfo[mintCount].nftHolder = _nftHolder[i];
        NftInfo[mintCount].isAvailable = true;
        nftOwner[_nftHolder[i]][mintCount]._flag = true ;
        _mint(_nftHolder[i], mintCount, 1);
        uriListMapping[_nftHolder[i]].push(_fileUri);
        nftCount[_nftHolder[i]]++;
        emit safeMinted(NftInfo[mintCount].tokenid, NftInfo[mintCount].emissionDate);
        mintCount++;
        totalSupply++;
      ...
      require(_nftHolder.length == id.length ,"address and id length not match"); 
        ...
        burnCount++;
        nftCount[NftInfo[i].nftHolder]--;
        NftInfo[i].nftHolder = 0x0000000000000000000000000000000000000000;
        NftInfo[i].licenseNo = "";
        NftInfo[i].cLFIValue = 0;
        NftInfo[i].emissionDate = 0;
        NftInfo[i].baseValue = 0;
        NftInfo[i].baseTokenEmmission = 0;
        NftInfo[i].licensePurchaseDate = 0;
        NftInfo[i].licenseExpiryDate = 0;
        NftInfo[i].licensePurchaseDate = 0;
        NftInfo[i].licenseExpiryDate = 0;
        NftInfo[i].fileUri = "";
        NftInfo[i].isAvailable = false;
        totalSupply--;
    }
      }
