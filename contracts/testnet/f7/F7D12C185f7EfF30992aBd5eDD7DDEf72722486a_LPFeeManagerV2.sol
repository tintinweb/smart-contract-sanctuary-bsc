...
contract LPFeeManagerV2 is SweeperUpgradeable {
    ...
    function initialize(
        ...
        __Ownable_init();
        router = IDigichainRouter02(_router);
        factory = IDigichainFactory(router.factory());
    ...
    function removeLiquidityTokens(
        ...
        for (uint256 i = 0; i < _lpTokens.length; i++) {
            IDigichainPair pair = IDigichainPair(_lpTokens[i]);
