...
contract PrivatesaleDNDV2 is IPreIDOBase, Initializable, OwnableUpgradeable {
    ...
    function initialize (
        ...
        minInvestment = 100;
        latestOrderId = 0;
        tokenSalePrice = 10000000000000000000;
    }
    ...
    function GetCurrentBlockTime()
        public
        view
        returns (uint256 currentBlockTime)
    {
