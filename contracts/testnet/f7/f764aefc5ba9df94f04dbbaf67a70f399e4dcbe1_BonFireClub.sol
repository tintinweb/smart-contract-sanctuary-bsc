...
abstract contract ERC721Tradable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    uint256 public price = 10**18; //ETH
    bool public pre_mint = true;
    ...
    function claim() public payable {
        ...
        require(tokenId > 0 && tokenId < 10001, "Exceeds token supply");
        require(msg.value >= price, "Not enough ETH sent: check price.");
        require(isWhitelisted(_msgSender()) == true, "Address not in whitelist");
        addMintCounter(_msgSender());
        claimMintTo(_msgSender());
    }

    function setPriceInWei(uint256 value) public onlyOwner {
        require(value >= 0, "Price must be more then -0");
        price = value;
    }

    function setPreMint(bool value) public onlyOwner {
        pre_mint = value;
    }
    ...
    function addMintCounter(address wallet) public {
        require(whitelist[wallet] < 3, "Address is full; Only 2 mint per WL Address");
