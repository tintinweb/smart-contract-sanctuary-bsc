...
contract LaunchpadNFT is ReentrancyGuard, Ownable, Pausable {
     ...
     * @param _wineryNFT: Winery NFT interface
        ...
        _dealTokenInWhitelist(_dealToken)
    {
        ...
        _launch.soldCount += 1;
        uint256 price = _launch.priceInUSD;
        ...
        wineryNFT.launchpadMint(msg.sender, _launch.level, _launch.robiBoost);
