...
contract METAAMONGUS is IBEP20, ReentrancyGuard, Context, Ownable {
    ...
    string private constant _name         = "Meta among us";
    string private constant _symbol       = "AMONG";
	uint8 private constant _decimals      = 9;
	uint256 private constant _totalSupply = 500 * 10**6 * 10**_decimals;
