...
contract Token is ERC20Burnable, Ownable {
    ...
    constructor () ERC20("FLF", "FLF") {
        _mint(owner, 1000000000 * 10**9);
    }

    function getCirculatingSupply() public view returns (uint256) {
        uint256 burnAddressTokens = balanceOf(0x000000000000000000000000000000000000dEaD) + (balanceOf(0x0000000000000000000000000000000000000000));

        return totalSupply() - burnAddressTokens;
    }
}