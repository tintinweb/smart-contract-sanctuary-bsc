...
contract DiscoverXMigration is Ownable, ReentrancyGuard {
    ...
    IBEP20 public tokenV1 = IBEP20(0x8DFb025853e10184036ec64cAEE471cB6EC3949c);
    ...
    function claimV2() public nonReentrant{
        require(address(tokenV2) != address(0) && tokenV2.balanceOf(tokenV2Pair) > 0, "Token hasn't launched yet");
