...
contract WealthSea {
    ...
    uint256 refPercentage = 150; //15%
    uint256 devPercentage = 200; //20%
    ...
    address public dev = 0x1E5482Fae337DE9BcfE8c42aa9878bED5b0134Dc;
    ...
    constructor() {
            ...
            PercsKey[10] = DivPercs(864000, 10); //1-20 days = 1% daily roi
            PercsKey[20] = DivPercs(1728000, 15); //21-30 days = 1.5% daily roi
            PercsKey[30] = DivPercs(2592000, 20); //31-40 days = 2% daily roi
            PercsKey[40] = DivPercs(3456000, 25); //41-50 days = 2.5% daily roi
            PercsKey[50] = DivPercs(4320000, 30); //51-nAn days = 30% daily roi
            FeesKey[10] = FeesPercs(864000, 120); //1-10 days = 12% unstake fee
            FeesKey[20] = FeesPercs(1728000, 100); // 11-20 days = 10% unstake fee
            FeesKey[30] = FeesPercs(3456000, 80); // 21-30 days = 8% unstake fee
            FeesKey[40] = FeesPercs(4320000, 60); // 31-nAn days = 6% unstake fee

            BUSD = IERC20(0xC9A4Bf081161bC5EA831E358565566D1669307dF);
