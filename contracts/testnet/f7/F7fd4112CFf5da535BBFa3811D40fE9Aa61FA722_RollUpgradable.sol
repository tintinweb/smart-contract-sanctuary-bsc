...
// File: contracts/libraries/CommonError.sol
...
// File: contracts/libraries/RLPReader.sol
...
// File: contracts/RollUpStorage.sol
...
// File: contracts/interfaces/IRollUpgradable.sol
...
interface IRollUpgradable {
  ...
  function isVerified(bytes32 hash)external returns(bool);
}
...
// File: contracts/access/SafeOwnableUpgradeable.sol
...
// File: contracts/RollUpgradable.sol
  ...
  UUPSUpgradeable
{
  ...
  /**
   * @dev check if the transaction has been verified
   */
  function isVerified(bytes32 hash)public  virtual override view returns(bool){
    return _verified[hash] != address(0);
  }
  /**
