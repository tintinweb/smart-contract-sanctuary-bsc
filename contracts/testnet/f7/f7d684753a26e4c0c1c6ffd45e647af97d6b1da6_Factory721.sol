...
// File: Pink/ERC721Enumerable.sol
...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    mapping(uint256 => string) _cids; // Mapping from token ID to IPFS CID
     ...
     * Emits a {Transfer} event.
     */
    function _safeMint(address to, uint256 tokenId, string memory cid) internal {
        _safeMint(to, tokenId, "", cid);
    }
     ...
     */
    function _safeMint(address to, uint256 tokenId, bytes memory data, string memory cid) internal {
        _mint(to, tokenId);
        _cids[tokenId] = cid;
...
contract Factory721 is Context, IFactory {
