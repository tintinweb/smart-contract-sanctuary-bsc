...
contract LIFEGAMES is ERC20Upgradeable {
    ...
    uint256 private _PunkFee;
    uint256 private _previousTaxFee;
    uint256 private _previousPunkFee;
    ...
    function _finalizeTransfer(address from, address to, uint256 amount, bool takeFee) internal returns (bool) {
        ...
        if (inSwap) {
            console.log("*********** IN SWAP _finalizeTransfer **********");
        ...
        console.log("*********** takeFee is %s **********", takeFee);
        if (takeFee) {

            // BUY
            if (from == lpPair) {
                console.log("*********** if (from == lpPair) _finalizeTransfer **********");

                
            }
            // SELL
            else if (to == lpPair) {
                 console.log("*********** else if (to == lpPair) _finalizeTransfer **********");
                // sell / add liquidty
