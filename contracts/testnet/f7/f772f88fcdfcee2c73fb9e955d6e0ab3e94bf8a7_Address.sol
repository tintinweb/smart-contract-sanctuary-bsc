...
contract WetPussyCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "WetPussyCat";
    string private _symbol = "WPC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEF7f8fE085426b017ad85818AD234596dA01DE06); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xEF7f8fE085426b017ad85818AD234596dA01DE06); // BuyBack Address
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xEF7f8fE085426b017ad85818AD234596dA01DE06); 
