...
contract SayomedTest2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sayomed Test 2";
    string private _symbol = "SAYT2";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x76ad9Da37fCCfc82cB843475Fafe8629D5DE3A37);
    address payable public teamWalletAddress = payable(0x76ad9Da37fCCfc82cB843475Fafe8629D5DE3A37);
