    ...
    OwnableUpgradeable
{
    ...
    function initialize(
        ...
        _startTimeICO = 1649048729;
        _endTimeICO = 1651615525;
        _totalAmountPerBUSD =10;
        _percentClaimPerDate = 10;
        _busdContractAddress = 0xF5433CA87EbcEf5F013150291B92809C8f5Aa843;
        _operatorAddress = msg.sender;
        _priceFeedAddress = msg.sender;
/*
