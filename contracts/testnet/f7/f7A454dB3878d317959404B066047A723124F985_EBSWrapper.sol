...
abstract contract NonceHandler {
...
contract EBSWrapper is ERC1155, Ownable, NonceHandler, AccessControl {
    bytes32 public constant OPERATOR_ROLE = keccak256("OPERATOR_ROLE");

    uint256 internal nTokens = 1;                         
    uint256 constant internal ETH_ID = 0x1;               
    address constant internal ETH_ADDRESS = address(0x1); 
    ...
    address constant public EBS_PREORDER = 0x6b312fDccc94fBca2B63dD764767aC17bc83C6A1;

    event TokenRegistration(address token_address, uint256 token_id);

    constructor() ERC1155("EBS Wrapper") {
    ...
    function supportsInterface(bytes4 interfaceID) public override(AccessControl, ERC1155) pure returns (bool) {
        return  interfaceID == type(IERC165).interfaceId ||
        interfaceID == type(IERC1155).interfaceId || 
