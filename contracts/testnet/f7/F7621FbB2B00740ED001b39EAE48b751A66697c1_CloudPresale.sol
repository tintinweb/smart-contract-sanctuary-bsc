...
contract CloudPresale is Owned {
    ...
    event WLPaid(address indexed from, uint256 value, uint256 totalPresale);
    ...
    function payWL(uint256 _amount) public {
        ...
        totalFund += _amount;
        emit WLPaid(msg.sender, _amount, totalFund);
    }
    ...
    function withdrawAny(address _token, uint256 _amount) public onlyOwner {
