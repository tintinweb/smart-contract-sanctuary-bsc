...
contract Dex {
    ...
    bytes32 constant public DAI = bytes32('DAI'); // saves gas, as the code is not computed at runtime anymore (but at compile time)
    

    bytes32 constant public USDT = bytes32('USDT'); 
