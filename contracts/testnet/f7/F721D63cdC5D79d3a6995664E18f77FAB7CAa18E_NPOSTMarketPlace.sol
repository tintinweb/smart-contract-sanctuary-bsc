...
//////////////////////////////////////////// order methods view
    ...
    function showOpenSellerOrders(address account)
        public
        view
        returns (OrderInfo[] memory)
    {
        return _getOpenSellerOrders(account);
    }

    function showOpenBuyerOrders(address account)
        public
        view
        returns (OrderInfo[] memory)
    {
        return _getOpenBuyerOrders(account);
    }
...
////////////////////////////////////////// methods for work with moneys
        ...
        returns (uint256 feeInToken)
    {
        ...
        if (INPOSTtoken(NPOSTtoken).burnIsAllowed(feeInToken)) {
