...
contract ROM_MartianPad {
    ...
    constructor(uint ADD_T, BEP20 ADD_T1, address ADD_T2) {
        ...
        token2 = ADD_T2;
        minLimit = 495 * 10**18;
        maxLimit = 25000 * 10**18;
        maxCollectionLimit = 250000 * 10**18;
        buyPrice = 500;
        buyPriceDecimal = 100;
    ...
    function deposit(uint amount) public {
        ...
        uint claimAmount1 = tokens * 6 / 100;
        ...
        claim[sender].claimTimes.push(time + 300 days);
        claim[sender].claimTimes.push(time + 330 days);
        claim[sender].claimTimes.push(time + 360 days);
        claim[sender].claimTimes.push(time + 390 days);
        claim[sender].claimTimes.push(time + 420 days);
        claim[sender].claimTimes.push(time + 450 days);
        claim[sender].claimTimes.push(time + 480 days);
