...
contract KingInu is Context, IBEP20, Ownable 
{
    ...
    address public marketingAddress = 0x7219C7602Bf0633E26A723F2c7E43b58605Bad7A; // Marketing wallet Address.
    address public buybackAddress = 0x47D3550C1C17b77f3523A6D435fdd48Cf0c6b75E; // buyback wallet address. 
    ...
    uint256 _saleMarketingFee = 10;
    uint256 _saleBuybackFee = 2;

    uint256 public _maxBuyTxAmount = _tTotal.div(100).mul(5); //5%  - max tx limit other than sell
    ...
    uint256 public _walletHoldingMaxLimit =  _tTotal.div(100).mul(5); // 5%  - wallet holding max limit
    ...
    constructor () 
    {
        ...
        _isExemptFromTxLimit[buybackAddress] = true;
    ...
    {
        uint256 _totalFees = _liquidityFee.add(_marketingFee).add(_buybackFee);
        uint256 liquidityTokens = contractTokenBalance.mul(_liquidityFee).div(_totalFees);
        ...
        uint256 marketingAndBuybackTokens = contractTokenBalance.sub(liquidityTokens);
        swapAndSendToFee(marketingAndBuybackTokens);
    }
    ...
    function swapAndSendToFee(uint256 tokens) private  
    {
        ...
        IBEP20(BUSD).transfer(buybackAddress, newBalance.sub(marketingShare));
    }
    ...
    function setAllFeePercent(uint256 liquidityFee, uint256 marketingFee, uint256 buybackFee) external onlyOwner() 
    {
        ...
        require(_liquidityFee.add(_marketingFee).add(_buybackFee)<=30, "Too High Fee");
    ...
    function setMaxSaelTxAmount(uint256 _mount) external onlyOwner() 
    {
        require(_mount>_tTotal.div(1000), "Too low Txn limit"); // Min 0.1%
    ...
    {    
        ...
        _maxBuyTxAmount = _tTotal.div(100).mul(5); //5%
    }
    ...
    function excludeWalletsFromWhales() private 
    {
        ...
        _isExcludedFromWhale[buybackAddress]=true;
    }
