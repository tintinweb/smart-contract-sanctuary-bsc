...
contract MAGLC is Ownable {
    ...
    address constant WETH_ADDRESS = 0x4c6289890009d7358e522d8BA97287a29F1988bB;
    address constant USDT_ADDRESS = 0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb;
    ...
    mapping(address => bool) public MagicNFT;
    address[] private MagicNFTAdrs;

    //config
    uint public payId = 0;
    uint public magicPrice = 1;
    ...
    function setMagicPrice(uint _value) external onlyOwner {
        magicPrice = _value;
    }

    function getMagicNFTAdrs() external view returns(uint){
        return MagicNFTAdrs.length;
    }
    ...
    function getMagicNFT() external {
        require(!MagicNFT[msg.sender], "marketMaker: orderId expired!");
        uint magicNum =  magicPrice * DECIMALS;
        IERC20(USDT_ADDRESS).transferFrom(msg.sender, marketAdr,magicNum);
        MagicNFTAdrs.push(msg.sender);
        MagicNFT[msg.sender] = true;
