...
contract TrueCityNFT is Owner,Blacklist  {
    ...
    constructor() {
        ...
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),4248742 * 10**9));
        // are unlocked to date 9/9/2022 the amount of 1.116.494
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),1116494 * 10**9));
        // are unlocked to date 21/10/2022 the amount of 6.885.998
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),6885998 * 10**9));
        // are unlocked to date 3/12/2022 the amount of 1.674.750
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),1674750 * 10**9));
        // are unlocked to date 14/1/2023 the amount of 6.168.262
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),6168262 * 10**9));
        // are unlocked to date 26/2/2023 the amount of 1.196.250
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),1196250 * 10**9));
        // are unlocked to date 9/4/2023 the amount of 5.354.244
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),5354244 * 10**9));
        // are unlocked to date 22/5/2023 the amount of 1.196.250
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),1196250 * 10**9));
        // are unlocked to date 3/6/2023 the amount of 4.706.617
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),4706617 * 10**9));
        // are unlocked to date 15/8/2023 the amount of 837.375
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),837375 * 10**9));
        // are unlocked to date 26/9/2023 the amount of 3.697.382
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),3697382 * 10**9));
        // are unlocked to date 8/11/2023 the amount of 837.375
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),837375 * 10**9));
        // are unlocked to date 20/12/2023 the amount of 3.617.613
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),3617613 * 10**9));
        // are unlocked to date 1/2/2024 the amount of 598.125
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time *2),598125 * 10**9));
        // are unlocked to date 14/3/2024 the amount of 3.073.132
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),3073132 * 10**9));
        // are unlocked to date 26/4/2024 the amount of 598.125
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),598125 * 10**9));
        // are unlocked to date 7/6/2024 the amount of 2.620.750
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),2620750 * 10**9));
        // are unlocked to date 20/7/2024 the amount of 478.500
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),478500 * 10**9));
        ...
        frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 2),318988 * 10**9));
