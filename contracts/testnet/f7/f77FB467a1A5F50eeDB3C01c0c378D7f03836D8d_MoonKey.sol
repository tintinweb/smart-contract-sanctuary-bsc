...
contract MoonKey is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xaaa86E4B3872b1B0e49271721a1c134f7f7930c8); 
    address payable public charityAddress = payable(0x25a3b1aa55f6A479CFA56dB9bcA1693df7Fd9427); 
    address payable public dev1Address = payable(0x968aa8cc1a7Aa8e7F37fEa1109a69df83B982cC1); 
    address payable public dev2Address = payable(0x1E92d1C8737b05F58795C69AC12b965106b88A74); 
    ...
    string private constant _symbol = "MKEY";
