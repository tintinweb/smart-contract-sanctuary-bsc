...
library Array256Getters {
    ...
    function getLength(uint256[] calldata array) public pure returns (uint256) {
        return array.length;
    }
    ...
    // function getAmountAt(uint256[] calldata array, uint256 index, uint256 amount) public pure returns(uint256[] memory) {
    //     for ...
    //     return ...
    // }
}
...
import "../libraries/Array256Getters.sol";

contract RefundableNftSale is Ownable, Pausable, IERC721Receiver {
    using SafeERC20 for IERC20;
    using Array256Getters for uint256[];
