...
contract TAUPI is ERC20{
    ...
    constructor() ERC20("freedomdao", "FMD"){
        _mint(0xa817600ddD4106d7ADd7FB9a8DBd461522D9ebAd,uint112(6280000000 ether)); //初始化mint
        _mint(0xa817600ddD4106d7ADd7FB9a8DBd461522D9ebAd,uint112(5024000000 ether)); //twitter分发
        backAddr = _msgSender();
    }
