...
contract Token is ERC20, Ownable {
    ...
    uint256 public buyMystFee;
    uint256 public buyTotalFees;

    uint256 public sellBurnFee;
    uint256 public sellMystFee;
    ...
    constructor() ERC20("Inferno", "INFERNO") {
        ...
        uint256 _buyMystFee = 4;

        uint256 _sellBurnFee = 2;
        uint256 _sellMystFee = 4;
        ...
        buyMystFee = _buyMystFee;
        buyTotalFees = buyBurnFee + buyMystFee;
        
        sellBurnFee = _sellBurnFee;
        sellMystFee = _sellMystFee;
        sellTotalFees = sellBurnFee + sellMystFee;
        
        devWallet = 0xE0E7Cd593a19A14927B556ad2f58c2e96961069f;
    ...
    function updateBuyFees(uint256 _burnFee, uint256 _mystFee) external onlyOwner {
        buyBurnFee = _burnFee;
        buyMystFee = _mystFee;
        buyTotalFees = buyBurnFee + buyMystFee;
    ...
    function updateSellFees(uint256 _burnFee, uint256 _mystFee) external onlyOwner {
        sellBurnFee = _burnFee;
        sellMystFee = _mystFee;
        sellTotalFees = sellBurnFee + sellMystFee;
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForDev += fees * sellMystFee / sellTotalFees;
            }
            ...
            // on buy
                ...
                tokensForDev += fees * buyMystFee / buyTotalFees;
            }
