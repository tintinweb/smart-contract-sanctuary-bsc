...
contract DANO is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    address public liquidityReceiver = 0x937dEa79c77Da1116dF54aD262130d474b17347F;
    address public treasuryReceiver = 0x6bFe01e23c92DF8A78FD13bed513BdA60f18E5f2;
    address public riskFreeValueReceiver = 0x73cF5d32d91Ca36e51886ef9D443b7a9C466E03F;
    address public charityReceiver = 0x91b97180AF19D84Aaee0ddCF1fC489D876F042F7;
    ...
    modifier canTransfer() {
        require(isDisableTransfer == true, "Can not transfer");
        _;
    }
    ...
    constructor() ERC20Detailed("Dano", "DANO", uint8(DECIMALS)) {
    ...
    function transfer(address to, uint256 value) external override validRecipient(to) canTransfer returns (bool){
    ...
    function setCanTransfer(bool _isDisableTransfer) external onlyWhitelisted {
        isDisableTransfer = _isDisableTransfer;
    }
