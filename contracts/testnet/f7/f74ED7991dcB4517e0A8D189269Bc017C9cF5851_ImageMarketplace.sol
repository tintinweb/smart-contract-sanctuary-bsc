    ...
    UUPSUpgradeable
{
        ...
        public nonReentrant
    {
        ...
        require(idToMarketItem[marketItemId].seller != msg.sender, "Buyer cannot be seller");

        // Transfer money to seller
        require(msg.sender.balance > 0, "Your balance not enough to transfer");
        payable(idToMarketItem[marketItemId].seller).transfer(idToMarketItem[marketItemId].price);  // withdraw from contract to seller
