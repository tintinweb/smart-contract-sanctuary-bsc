...
contract SieveLauncher {
    ...
    address sieveToken = 0x2f72130c350EC027b2d0C5948BE60b6077Db858a;
    ...
    function finalizePresale() public onlyOwner {
        ...
        IFilterRouter(routerAddress).addLiquidityETH(sieveToken, totalTokens, 0, 0, 0x0000000000000000000000000000000000000000, block.timestamp, type(uint).max);
    }
