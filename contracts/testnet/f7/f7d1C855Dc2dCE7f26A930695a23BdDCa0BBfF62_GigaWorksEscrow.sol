...
contract GigaWorksEscrow is Ownable {
    ...
    mapping(address => Escrow[]) public addressToEscrow; //works great when an escrow is created, pushes it to both buyer/seller. but how do I update this for those addresses when it is sold or disputed
