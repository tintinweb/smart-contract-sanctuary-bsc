...
contract DOGEMOVE is Context, IBEP20, Ownable {
    ...
    address payable public MarketingWallet =
        payable(0xC8B2AD8FE43531BFe3629207847d7879Db5c46Fa);
    ...
    string private constant _name = "DOGEMOVE";
    ...
    uint256 private numTokensSellToAddToLiquidity = 10 * 10**3 * 10**9;
    uint256 public _maxWalletHoldingLimit = 1 * 10**6 * 10**9;

    event numTokensSellToAddToLiquidityUpdated(uint256 thresholdValueUpdated);
    ...
    function allowance(address allowncer, address spender)
        public
        view
        override
        returns (uint256)
    {
        return _allowances[allowncer][spender];
    }
    ...
    function takeMarketing(
        ...
        uint256 tMarketingFee = tAmount.mul(_MarketingFee).div(feeDenominator);
