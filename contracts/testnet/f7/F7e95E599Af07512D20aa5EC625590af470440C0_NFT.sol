...
contract NFT is ERC721URIStorage, ERC2981PerTokenRoyalties {
    ...
    constructor(address marketplaceAddress, address[] memory addresses)
        ERC721("OuseToken", "OT")
    {
        owner = msg.sender;
    ...
    function createToken(string memory _tokenURI, RoyaltyInfo[] memory _royals)
        public
        returns (uint256)
    {
        if (msg.sender != owner) {
        ...
        // _setTokenRoyalty(newItemId, 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4, 199);
        // _setTokenRoyalty(newItemId, 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2, 9000);
        ...
        returns (string memory)
    {
        ...
        if (revealeds[tokenId].revealed == false) {
            return revealeds[tokenId].notRevealedUri;
        } else {
            return super.tokenURI(tokenId);
        }
    }
