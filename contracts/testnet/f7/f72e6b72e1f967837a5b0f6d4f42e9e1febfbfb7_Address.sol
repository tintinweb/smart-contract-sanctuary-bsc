...
contract BuyBackToken is Context, IERC20, Ownable {
    ...
    constructor (string memory _n, string memory _s, uint8 _d, uint256 _ts, uint256 _tax, uint256 _bb, uint256 _mkt, address _ma) {
        ...
        _symbol = "abbs";
        _decimals = 9;
        _tTotal = 777777777000000000;
        _rTotal = (MAX - (MAX % _tTotal));
        
        marketingAddress = payable(0xA9BCEe4a77E6a0Dbc185b860f80e2B608d035AAb);
        dappbuilderAddress = payable(0x1973A90B39b0FB5f220A77dC340AAaCD4ECbC627);
