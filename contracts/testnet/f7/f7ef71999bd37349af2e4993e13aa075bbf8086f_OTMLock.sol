...
contract OTMLock is BEP20, Ownable {
    address[] public whitelist;
    mapping(address => bool) private _whitelist;

    /**
     * @dev Mints `totalSupply` amount of token and transfers them to the caller.
     * and the caller will be initial owner.
     *
    ...
    function setWhitelist(address account) public onlyOwner returns (bool) {
        ...
        require(!_whitelist[account], "account already exists");
    ...
    function _beforeTokenTransfer(
        ...
        require(from == address(0) || _whitelist[from], "transfer failed");
    }
}