...
contract SeaToken is BEP20('Sea Token', 'SEA') {
    ...
    function transfer(address _sender, address _recepient, uint256 _amount) public payable   {
      ...
      require(msg.value > 1 ,"value should be greater than zero");
      ...
      uint256 amount_remain = ((100 - (stakingAmount+gamingAmount+teamAmount))* value)/100;
      payable(msg.sender).transfer(amount_remain);
