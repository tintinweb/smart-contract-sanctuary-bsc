...
contract Staking2Years is Staking {
    uint32 constant MATURATION_DAYS = 730; // 2 years
    uint32 constant STARTING_BURN_RATE = 80_000; // 80% starting burn rate
    uint32 constant REWARD_RATE = 50_000; //50% reward for 2 years = 25% reward per year
