...
contract JECKHAS is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    JECKHASDividendTracker public dividendTracker;

    address public liquidityWallet;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address payable public marketingAddress = payable(0x8bFFA29A17210aFa32204dC501D3eE4A8395952D);
    ...
    constructor() ERC20("Token Jeckhas", "TJ") {
        dividendTracker = new JECKHASDividendTracker();
        ...
        //Mainnet
    	//IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C79714eb63d5aA57B78B54704E256024E);
        //Testnet
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        JECKHASDividendTracker newDividendTracker = JECKHASDividendTracker(
            payable(newAddress)
        );
...
contract JECKHASDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()  DividendPayingToken("JECKHAS_Dividend_Tracker", "JECKHAS_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 1 * (10**9); //must hold 10000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "JECKHAS_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "JECKHAS_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main JECKHAS contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "JECKHAS_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "JECKHAS_Dividend_Tracker: Cannot update claimWait to same value");
