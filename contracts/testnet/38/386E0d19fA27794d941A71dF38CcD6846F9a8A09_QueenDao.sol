...
contract QueenDao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "QueenDao";
    string private _symbol = "QueenDao";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0699f807BF9AFdf2218ddCb483Eec195EF87cb94);
    address payable public teamWalletAddress = payable(0x513d2489f743E1324C8768f8DC184307bf0dc026);
