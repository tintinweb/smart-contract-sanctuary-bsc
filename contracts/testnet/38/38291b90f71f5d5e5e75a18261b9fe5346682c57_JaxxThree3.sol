...
contract JaxxThree3 is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    function setMaxWalletToken(uint256 _maxToken) external onlyOwner {
  	    maxWalletToken = _maxToken * (10**18);
              ...
              //Contract By: TG @don000777
    constructor() ERC20("Jaxx Three3", "JAXX3") {
        BNBRewardsFee = 5;
        liquidityFee = 2;
        extraFeeOnSell = 5; // extra fee on sell
        marketingFee = 3;
        marketingWallet = payable(0x9c026DeD2b78d11d516967bcc827c690FE998EBa);
