    ...
    IForwarder
{
    ...
    function onERC721Received(
        ...
        if (autoFlush721) {
            IERC721Upgradeable instance = IERC721Upgradeable(msg.sender);
            require(
                instance.supportsInterface(
    ...
    function onERC1155Received(
        ...
        IERC1155Upgradeable instance = IERC1155Upgradeable(msg.sender);
        require(
            instance.supportsInterface(type(IERC1155Upgradeable).interfaceId),
            'The caller does not support the Upgradeable interface'
        );
    ...
    function flushERC721Token(address tokenContractAddress, uint256 tokenId)
        ...
        onlyParent
    {
        IERC721Upgradeable instance = IERC721Upgradeable(tokenContractAddress);
        require(
            instance.supportsInterface(type(IERC721Upgradeable).interfaceId),
    ...
    function flushERC1155Tokens(address tokenContractAddress, uint256 tokenId)
        ...
        onlyParent
    {
        IERC1155Upgradeable instance = IERC1155Upgradeable(
            tokenContractAddress
        );
        require(
            instance.supportsInterface(type(IERC1155Upgradeable).interfaceId),
