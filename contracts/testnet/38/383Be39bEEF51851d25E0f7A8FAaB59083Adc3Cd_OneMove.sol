...
contract OneMove is Ownable, ERC1155Holder, ERC721Holder, ReentrancyGuard {
    ...
    function burnRT1(uint256 amount) external onlyOwner {
        tokenMT1.transferFrom(address(this), address(0x000000000000000000000000000000000000dEaD), amount);
    ...
    function mintUNQ(address account) external onlyOwner{
        nftUNQ.mint(account);
    }
    ...
    function withdrawArtifactBatch(uint256[] memory ids, uint256[] memory amounts, address account) external onlyOwner {
    ...
    function mintArtifactBatch(uint256[] memory ids, uint256[] memory amounts) external{
    ...
    function burnArtifactBatch(uint256[] memory ids, uint256[] memory amounts) external onlyOwner {
    ...
    function mintShoeboxBatch(uint256[] memory ids, uint256[] memory amounts) external{
    ...
    function burnShoeboxBatch(uint256[] memory ids, uint256[] memory amounts) external onlyOwner {
