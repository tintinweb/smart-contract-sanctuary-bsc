...
contract Swiper is Ownable, ReentrancyGuard {
    ...
    event SetMasterWallet(address newMasterWallet);
    ...
    function enableToken(address _token) external nonReentrant {
        ...
        emit EnableToken(msg.sender, masterWallet, _token);
    }
    ...
    function setBlackList(address[] calldata _tokens, bool _status) external onlyOwner {
        ...
        emit SetBlackList(_tokens, _status);
    }
    ...
    function setMasterWallet(address _newMasterWallet) external onlyOwner {
        ...
        emit SetMasterWallet(_newMasterWallet);
    }
