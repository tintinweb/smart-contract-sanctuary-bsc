...
// File: CFGNinjaLpTokenLocker.sol
...
contract CFGNinjaLocker is Ownable, ReentrancyGuard {
  ...
  /**
   * @notice referrers need to hold the specified token and hold amount to be eligible for referral fees
   */
  ...
  function splitLock (address _lpToken, uint256 _index, uint256 _lockID, uint256 _amount) external payable nonReentrant {
    ...
    payable(devaddr).transfer(gFees.ethFee);
