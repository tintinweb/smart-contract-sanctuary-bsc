...
contract PoolLogic is ERC20ExtendedUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function calculatePerformanceFee() external nonReentrant {
        ...
        uint256 totalValueBefore = sharePriceLatest.mul(totalShare).div(10**18);
        uint256 totalValueAfter = IPoolManagerLogic(poolManagerLogic).totalPoolValue();

        // calculate profit
        require(totalValueAfter > totalValueBefore, "no profit");
 ...
 */
contract ERC20ExtendedUpgradeable is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, OwnableUpgradeable {
