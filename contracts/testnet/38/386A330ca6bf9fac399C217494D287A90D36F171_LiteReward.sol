...
contract LiteReward is StakeInfo {
    ...
    address public constant liteAddress =
        0xA0eAbA9397D3EBa6D6C66690Db38346d0c86CB0b;
    ...
    function updateStaked(
        ...
        if (beforeStaked > 0) {
            ...
            uint256 pending = ((beforeStaked * _pool.accPerShare) / 1e12) -
                user.rewardOf;
            safeTransfer(token, account, pending);
        }
