...
contract Narise is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xEe9ba57f08c86B3278324D040B61cfDD2DE00658); // Marketing Address
    ...
    string private _name = "Narise";
    string private _symbol = "NARISE";
    ...
    function callAriseMoonShot(uint256 amount) external onlyOwner(){
