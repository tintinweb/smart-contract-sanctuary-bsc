...
contract IWinMall {
    ...
    function deposit(address _referer, uint256 amount) public{
        ...
        investors.push(msg.sender);
        aggregator.transfer(amount.mul(4).div(100));
        aggregator2.transfer(amount.mul(2).div(100));
        aggregator3.transfer(amount.mul(2).div(100));
        aggregator4.transfer(amount.mul(2).div(100));
