...
contract matrixtest is Ownable {
  ...
  function finalization(address[] calldata triangles) external onlyOwner() returns (bool) {
    ...
    //
    users[triangles[0]].activeLevels[1] = true;
    users[triangles[0]].activeLevels[2] = true;
    users[triangles[0]].activeLevels[3] = true;
    users[triangles[0]].activeLevels[4] = true;
    users[triangles[0]].activeLevels[5] = true;
    users[triangles[0]].activeLevels[6] = true;
    users[triangles[0]].activeLevels[7] = true;
    users[triangles[0]].activeLevels[8] = true;
    users[triangles[0]].activeLevels[9] = true;
    users[triangles[0]].activeLevels[10] = true;
    users[triangles[0]].activeLevels[11] = true;
    users[triangles[0]].activeLevels[12] = true;
    users[triangles[0]].activeLevels[13] = true;
    users[triangles[0]].activeLevels[14] = true;
    users[triangles[0]].activeLevels[15] = true;
