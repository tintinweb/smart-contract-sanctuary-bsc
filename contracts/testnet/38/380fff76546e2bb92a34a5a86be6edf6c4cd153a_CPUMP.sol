...
contract CPUMP is iBEP20, ContextUpgradeable, OwnableUpgradeable {
    ...
    function mint(address _receiver, uint256 _amount) public returns (bool) {
        ...
        require(msg.sender == mintOwner, "Invalid mint owner");
    ...
    function changeMintaddress(address _mintOwner) public returns (bool) {
        require(_mintOwner != address(0), "Invalid Address");
