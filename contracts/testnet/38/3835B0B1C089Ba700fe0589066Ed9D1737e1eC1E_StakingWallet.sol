...
contract StakingWallet is Ownable {
     ...
     */
    constructor(IERC20 _stakeToken, address _stakingContract) {
    ...
    modifier onlyStakingContract() {
        require(
            ...
            "ReflectionsDistributor: caller is not the stakingContract"
        );
        _;
    }
     ...
     */
    function deposit(address _user, uint256 _amount) external onlyStakingContract {
     ...
     */
    function withdraw(address _user, uint256 _amount) external onlyStakingContract {
        UserInfo storage user = userInfo[_user];
