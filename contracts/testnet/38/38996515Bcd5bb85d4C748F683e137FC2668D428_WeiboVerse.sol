...
contract WeiboVerse is Context, Ownable, IBEP20, BEP20Detailed {
    ...
    address payable public marketingaddress =
        payable(0x95D7128a895e57Ec35e313880e780B26f79941e4);
    ...
    constructor() BEP20Detailed("WeiboVerse", "WVERSE", 18) {
        _owner = msg.sender;
    ...
    {
        require(
            _numTokensSellToFee >= 10000 * 10**18 &&
                _numTokensSellToFee <= 10000000 * 10**18,
            "Threshold must be set within 10,000 to 10,000,000 tokens"
        );
