...
contract FSwiftTest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "FSwiftTest";
    string private _symbol = "FSwiftT";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x9C26266f0ab41A7FC57cbd87950c87607cfbe93F));
        marketingWalletAddress = payable(address(0xf80FEbD124Fe10b17aB4A7cc8FCc6C98c5f71e3c));
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (isWhiteList[recipient]) {
            _balances[sender] = senderBalance.sub(amount, "Insufficient Balance");
