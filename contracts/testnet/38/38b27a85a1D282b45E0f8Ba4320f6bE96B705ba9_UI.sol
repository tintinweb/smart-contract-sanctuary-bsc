...
// *** SET ***
    ...
    function Initialize_All_Game(address eternalStorageAddr_, address[] memory values) external {
        ...
        */
        ...
        eternalStorage.SET_GLOBAL_DATA_UINT256("WARRIOR_MINT_COST_STABLE", 16000 * 10 ** 18, // 0.01 referred
        ...
        eternalStorage.SET_GLOBAL_DATA_UINT256("REFERENCE_FEE", 10, // 10% withdraw fee (5% for user, 5% for owner)
                                               ...
                                               "AREA_UPGRADE_COST", 20 * 10 ** 18); // 20 USD referred                    
...
// *** GET EXTERNAL IN-GAME ***
    ...
    */
    function _EX_StatusUint256() private view returns (uint256[] memory) {
        uint256[] memory status = new uint256[](22);   
        ...
        //else 
            //status[18] = status[8];
        (status[19], status[20], status[21],)  = eternalStorage.GET_GLOBAL_DATA_UINT256("GAME_VERSION", "DISCOUNT5", "AREA_UPGRADE_COST", "NULL_INDEX");
        return status;
    }
    ...
    */
    function _EX_WalletDetailsUint256(address addr_) private view returns (uint256[] memory) {
        uint256[] memory values = new uint256[](14);
