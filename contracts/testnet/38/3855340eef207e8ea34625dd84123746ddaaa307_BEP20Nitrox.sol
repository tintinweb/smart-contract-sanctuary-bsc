...
contract BEP20Nitrox is Context, IBEP20, Ownable {
  ...
  string private _name = "NitroxCoin";
  ...
  */
  ...
  bool public isTradingEnable = true;
  ...
  constructor(address initialDevAddress) {
  ...
  */
  ...
  function setLiquidityBuyFee() private {
    _liquidityFee = _liquidityBuyFee;
  }

  function setLiquiditySellFee() private {
