...
// File: contracts/dualRoles/IERC_DualRoles.sol
...
// File: contracts/dualRoles/ERC_DualRoles.sol
...
contract WrapERC721DualRole is ERC_DualRoles,OwnableContract,IWrapNFT{
    ...
    constructor(string memory name_, string memory symbol_,address originalAddress_) ERC_DualRoles(name_,symbol_){
    ...
    function setBaseURI(string memory newBaseURI) public virtual onlyAdmin {
