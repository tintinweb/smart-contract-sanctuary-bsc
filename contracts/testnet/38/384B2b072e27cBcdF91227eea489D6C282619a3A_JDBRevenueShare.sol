...
contract JDBRevenueShare is Ownable {
    ...
    event LogTransfer(address _devWallet, uint256 _amount);
    ...
    function transfer(uint256 amount) private{
        safeTransferBNB(devWallet, amount);
        emit LogTransfer(devWallet, amount);
    }

    function swapTokensForEth(uint256 ethAmount) private {
