 ...
 */
        ...
        returns(uint256)
    {
        ...
        if (randomNumber >= legendaryThreshold){
            ...
            uint256 res = nftCollection.mintNFTByBox(recipient, _tokenURI, _type, _rarity);
            return res;
        }
 ...
 */
    ...
    function adminChangeThreshold(uint256 _legendary, uint256 _ultrarare, uint256 _superrare, uint256 _rare, uint256 _common)
        public
        onlyAdmin
    {
