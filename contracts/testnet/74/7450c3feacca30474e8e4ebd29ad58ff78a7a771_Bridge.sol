...
contract Bridge is Pausable, AccessControl, SafeMath {
    ...
    mapping(uint8 => uint256) public _feeByChain;
    ...
    function adminChangeFeeByChain(uint8 chainID, uint fee) external onlyAdmin {
        _feeByChain[chainID] = fee;
    }
    ...
    function deposit(uint8 destinationChainID, bytes32 resourceID, bytes calldata data) external payable whenNotPaused {
        require(msg.value == _feeByChain[destinationChainID], "Incorrect fee supplied");
