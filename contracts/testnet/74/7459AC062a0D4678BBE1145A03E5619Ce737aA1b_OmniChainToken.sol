...
contract OmniChainToken is ERC20, NonblockingReceiver, ILayerZeroUserApplicationConfig {
	...
	address public marketingWallet = payable(0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC);
	
	address private uniswapV2Router = 0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0;
	//New Features
    ...
    constructor(string memory name_, string memory symbol_, address _layerZeroEndpoint) ERC20(name_, symbol_){
        ...
        _mint(msg.sender, fixedSupply); // mint the deployer some tokens.
		
		maxTxAmount = fixedSupply * 1 / 100; //1% of supply
		maxWallet = fixedSupply * 2 / 100; //2% of supply
