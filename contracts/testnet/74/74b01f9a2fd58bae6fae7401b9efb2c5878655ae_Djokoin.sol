...
contract Djokoin is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Djokoin';
    string private constant _symbol = 'BanShing';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 1389 * 10**_decimals;

    //Amount to Swap variable
    uint256 currentAmountToSwap = 100 * 10**_decimals;
