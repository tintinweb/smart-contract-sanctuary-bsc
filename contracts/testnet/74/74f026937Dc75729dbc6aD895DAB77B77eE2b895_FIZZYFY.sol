...
contract FIZZYFY  {
    ...
    uint256 private constant minDeposit = 5e18;
    uint256 private constant maxDeposit = 50e18;
    ...
    constructor(IBEP20 _busdAddr, address _defaultRefer, address _feeReceiver1, address _feeReceiver2) public {
        busd = _busdAddr;
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 50e18){
            ...
            if(total >= 50e18 && user.teamNum >= 2 && maxTeam >= 50e18 && otherTeam >= 50e18){
                levelNow = 5;
            }else if(user.teamNum >= 1 && maxTeam >= 20e18 && otherTeam >= 20e18){
                levelNow = 4;
            }else{
                levelNow = 3;
            }
    ...
    function _distributeDeposit(uint256 _amount) private {
        ...
        busd.transfer(feeReceiver1, fee.div(2));
        busd.transfer(feeReceiver2, fee.div(2));
