...
contract SmartBeComBee {
    ...
    function usersB3MatrixReinvest2(address userAddress, uint8 level) public view returns(uint) {
        return 3;
    }
    ...
    function usersB6MatrixReinvest2(address userAddress, uint8 level) public view returns(uint) {
        return 3;
    }
