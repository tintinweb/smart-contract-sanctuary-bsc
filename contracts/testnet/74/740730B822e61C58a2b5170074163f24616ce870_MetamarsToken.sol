...
// File: contracts/MetamarsToken.sol
...
contract MetamarsToken is ERC20, Ownable {


    uint private _tokenPrice=0.0001 ether;
    bool private _mintStatus=true;

    constructor() ERC20("Meta Mars Token", "MMT") {}
    ...
    modifier mintCompliance(uint256 amount){
        require(_mintStatus,"Mint functionallity is disabled for now");
        _;

        require(msg.value >= amount * _tokenPrice,"Not enough balance to mint");
        _;
    }
}