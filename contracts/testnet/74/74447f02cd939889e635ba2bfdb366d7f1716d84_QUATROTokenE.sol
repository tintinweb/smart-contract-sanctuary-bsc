...
contract QUATROTokenE is Token {
    ...
    uint private constant ADV_FEE           = 490;                   // Base 7% multipled * 7 = 49% total
    uint private constant ADV_FEESM         = 80; 
    ...
    constructor() public {
        ...
        FIND_1 = 0x9804bB5d60D56EBf9e1059ed2b13AF7402E0fdB6; // ll 8%
        MAR_1 = 0x27658B1FB266C2828164843Cbd673370F9Ce8746;  // DESB   8%   
    ...
    function stakeBUSD(address referrer,  uint256 _amount) public payable {
        ...
        token.transfer(FIND_1, feesm);    // new - 8%%
        token.transfer(MAR_1, feesm);     // changed 8%%
