...
contract SOSOToken is ERC20 {
    ...
    constructor() ERC20("SOSOToken", "SOSO") {
    ...
    function getVestingTransaction(uint _id) public view returns(address, uint, string memory, uint) 
    {
     ...
     function getPendingVestingTransactions() public view returns( uint, uint, uint) 
    {
        ...
        if(PendingTransactionList[i] != 0 && i != 0){  
            if(FirstTRX==0) {
                FirstTRX==i;
            }
        count++;
