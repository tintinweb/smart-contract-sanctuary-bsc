...
contract EKTA_ERC721 is Initializable, UUPSUpgradeable, ERC721Upgradeable, ERC721URIStorageUpgradeable, PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function safeMint(address to, string memory uri) public onlyOwner nonReentrant {
    ...
    function updateBaseURI(string memory _baseUri) external onlyOwner nonReentrant {
        baseURI = _baseUri;
    }
    ...
    /**
       ...
       @param enable bool
     */
    function updateEnableWhitelisting(bool enable) external onlyOwner nonReentrant {
    ...
    */
    function includeInWhitelist(address account) external onlyOwner nonReentrant {
    ...
    /**
       ...
       @param account whitelisting address
    */
    function excludeFromWhitelist(address account) external onlyOwner nonReentrant {
        require(account != address(0), "ERC721: Account cant be zero address");
    ...
    */
    function includeAllInWhitelist(address[] memory accounts) external onlyOwner nonReentrant {
    ...
    */
    function excludeAllFromWhitelist(address[] memory accounts) external onlyOwner nonReentrant {
        for (uint256 account = 0; account < accounts.length; account++) {
             if(whitelisted[accounts[account]]) {
    ...
    function getUri() view external returns(string memory) {
        return baseURI;
    }
}
