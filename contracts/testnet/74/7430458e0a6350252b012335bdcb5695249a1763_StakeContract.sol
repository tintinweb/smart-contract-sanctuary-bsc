...
contract StakeContract is Owner, ReentrancyGuard, ERC1155Holder {
    ...
    constructor(address _rewardToken, address _nfts) {
        setTokenContracts(_rewardToken, _nfts);
    ...
    function setTokenContracts(address _rewardToken, address _nfts) public isOwner {
        rewardToken = _rewardToken;
        nfts = _nfts;
        emit Set_TokenContracts(_rewardToken, _nfts);
    }
