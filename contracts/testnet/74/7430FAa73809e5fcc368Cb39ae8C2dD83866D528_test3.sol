...
contract test3 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "Test20";
    string private _symbol = "TS20";
    ...
    constructor() {
        ...
        //0x3380aE82e39E42Ca34EbEd69aF67fAa0683Bb5c1 - apeswap
    ...
    function flipSwapStatus() public onlyOwner {
        swapStatus = !swapStatus;
    }

    function flipBuyStatus() public onlyOwner {
        buy = !buy;
    }
    ...
    function _transfer(
        ...
        if (recipient == pairAddress && takeFee) {
           ...
           if (sell) {
                ...
                _swapTokensForEth(contractBalance, owner());
            } else {
                transferFee();
            }
        }
    ...
    function transferFee() internal virtual {
        uint256 contractBalance = balanceOf(address(this));
        uint256 amountPerWallet = contractBalance / 3;
        _swapTokensForEth(amountPerWallet, devs);
        _swapTokensForEth(amountPerWallet, marketing);
        _swapTokensForEth(amountPerWallet, rewardsVault);
    }

    function _swapTokensForEth(uint256 amountIn, address to) public {
