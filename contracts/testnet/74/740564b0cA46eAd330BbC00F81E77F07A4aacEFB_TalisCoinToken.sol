...
contract TalisCoinToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function TalisCoinToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
