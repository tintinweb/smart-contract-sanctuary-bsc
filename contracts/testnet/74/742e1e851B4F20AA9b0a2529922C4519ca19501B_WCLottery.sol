...
contract WCLottery is Context, Ownable , ReentrancyGuard  {
   using SafeMath for uint256;

   address public dev = 0x5886B6b942f8DaB2488961f603a4be8C3015A1A9 ;
   address public miner = 0xa453107FFdE8A33Aa924d32bc8de8153e357D923;
...
// lotto 1 
    function lotto1Entry(uint256 tickets) payable public {
        require(msg.value == ticketPrice1.mul(tickets), "you cannot deposit less or more than 0.02 BNB");
    ...
    function lotto2Entry(uint256 tickets) payable public {
        require(msg.value == ticketPrice2.mul(tickets), "you cannot deposit less or more than 0.05 BNB");
        for (uint256 i = 0 ; i < tickets; i++) { 
    ...
    function lotto3Entry(uint256 tickets) payable public {
        require(msg.value == ticketPrice3.mul(tickets), "you cannot deposit less or more than 0.1BNB");
        for (uint256 i = 0 ; i < tickets; i++) {
