...
// https://bscscan.com/address/0x05ad901cf196cbDCEaB3F8e602a47AAdB1a2e69d#code

contract DogeRunner  is ERC20Burnable, Ownable {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        (uint transferAmount, uint fee) = _getValues(amount, _taxFee);
        super._transfer(sender, recipient, transferAmount);
        if(fee > 0) {
            super._transfer(sender, beneficiary, fee);
            _tFeeTotal = _tFeeTotal.add(fee);
        }
    }
    ...
    function setExcludesFee(address[] calldata accounts, bool isExcluded) public onlyOwner {
