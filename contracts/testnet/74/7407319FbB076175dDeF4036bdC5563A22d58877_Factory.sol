...
contract Factory is AccessControl {
    ...
    function createCollection(string calldata _name, string calldata _symbol, address _default_admin) external returns (address collection) {
        bytes memory bytecode = abi.encodePacked(
            type(Shares).creationCode,
            abi.encode(_name, _symbol, _default_admin)
        );
