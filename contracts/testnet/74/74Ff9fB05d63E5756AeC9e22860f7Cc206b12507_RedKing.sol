...
contract RedKing is ERC20, Ownable {
    ...
    constructor(
        ...
        // address[4] memory addr_ = [0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684, 0xb5E3AAad5025f35A24b689A571b9B522F4634e4e, 0xe9aAe1cF234E36D4A15b59D7CfB7447b7C697e20, 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3];
        rewardToken = addr_[0];
        ...
        uint256 tokenBalanceForReward_ = 10 ** decimals;
    ...
    function swapManual() public onlyOwner {
        ...
        if(AmountInspireFee > 0) swapAndSendInspireFee(AmountInspireFee);
        swapping = false;
    }
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            if(AmountInspireFee > swapTokensAtAmount) swapAndSendInspireFee(AmountInspireFee);
            swapping = false;
        }
    ...
    function swapAndSendInspireFee(uint256 tokens) private  {
        require(tokens <= AmountInspireFee, "Not have enough tokens to send fees");
        uint256 initialCAKEBalance = IERC20(rewardToken).balanceOf(address(this));
        swapTokensForEth(tokens);
        uint256 newBalance = (IERC20(rewardToken).balanceOf(address(this))).sub(initialCAKEBalance);
