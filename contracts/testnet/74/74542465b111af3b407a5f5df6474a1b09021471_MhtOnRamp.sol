...
// File contracts/MHTOnRamp/interfaces/IERC20Dec.sol
...
// File contracts/MHTOnRamp/MHTOnRamp.sol
...
contract MhtOnRamp is Initializable, PausableUpgradeable, AccessControlUpgradeable {
  ...
  // EVENTS
  event Deposited(address indexed playerAddress, uint256 amount);
  ...
  function deposit(uint256 _amount) external whenNotPaused {
    ...
    paymentToken.transferFrom(msg.sender, farmingContract, _amount);
  }
