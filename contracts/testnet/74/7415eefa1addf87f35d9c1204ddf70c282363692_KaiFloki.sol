...
contract KaiFloki is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KaiFloki";
    ...
    address payable public marketingWalletAddress = payable(0x13dF8e1e085F47bbf93fCc41C59d8dBE3955c35C);
    address payable public teamWalletAddress = payable(0xE9F5C4C491A2083a12b7A3e718EDa4d12b2ED933);
