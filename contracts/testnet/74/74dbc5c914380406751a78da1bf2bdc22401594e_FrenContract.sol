...
contract FrenContract is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Fren Token";
    ...
    //changes the developmentFee which goes to a specific wallet
    uint256 developmentFee = 5;
    // "liquidityFee + reflectionFee + marketingFee + developmentFee" = totalFee
    uint256 public totalFee = 15;
    //dont change that
    uint256 feeDenominator = 100;

    //defines the development wallet (a specific wallet)
    address public developmentFeeReceiver =
        0xd6e00a9d4A153e29B0d9A6FB3d4d6dbd8E651200;

    //defines the marketing wallet (a specific wallet)
    address public marketingFeeReceiver =
        0x395028131D195716bf760F282a3C4325EF8Fd5E5;
    ...
    function clearStuckBalance(uint256 amountPercentage) external onlyOwner {
        ...
        payable(developmentFeeReceiver).transfer(
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess, ) = payable(developmentFeeReceiver).call{
