...
contract PreSaleXYT is Ownable{
    ...
    function preSale(uint256 _payAmount) public returns(bool) {
        // check time
        ...
        uint256 payAmount = _payAmount.mul(10**18);
        require(payAmount >= MINAMOUNT && payAmount <= MAXAMOUNT, "The payment amount is not within the specified range");
        // check msg.sender
        ...
        // event log
        emit CreatePreSaleXYT(msg.sender, payAmount, quantity);
        return true;
    }
