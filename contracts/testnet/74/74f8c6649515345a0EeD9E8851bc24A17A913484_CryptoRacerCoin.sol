...
https://t.me/CryptoRacerMiami

https://cryptoracercoin.com

https://twitter.com/cryptoracercoin

https://instagram.com/cryptoracercoin
...
contract CryptoRacerCoin is ERC20, Ownable {
//custom
...
//address
    ...
    address public marketingAddress = 0x89A50723d027556E3126129474dbFE46526D9b1e;
    address public devAddress = 0x723B865C813AbbB0BE895c7cBE58EE75811A293C;
    address public liquidityAddress = 0x723B865C813AbbB0BE895c7cBE58EE75811A293C;
//uint
    uint public minimumWeiForTokenomics = 1 * 10**16; // 0.01 BNB
    uint public buyMarketingFee = 7;
    uint public sellMarketingFee = 7;
    ...
    uint public maxSellTxAmount;// 3% tot supply (constructor)
    uint public maxWallet; // 3% tot supply (constructor)
    uint public minimumTokensBeforeSwap = 500_000_000 * 10 ** decimals();
...
// constructor
    constructor() ERC20("CryptoRacerCoin", "Miami") {
        uint total_supply = 1_000_000_000_000 * 10 ** decimals();
        // set gvars
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        uniswapV2Router = _uniswapV2Router;
        maxSellTxAmount = total_supply / 100; // 3% supply
        maxBuyTxAmount = total_supply / 100; // 3% supply
        maxWallet = total_supply / 100; // 3% supply
        //spawn pair
...
// operational functions
    ...
    function isThisCryptoRacerCoin() public pure returns(bool) {
        return true;
    }
}