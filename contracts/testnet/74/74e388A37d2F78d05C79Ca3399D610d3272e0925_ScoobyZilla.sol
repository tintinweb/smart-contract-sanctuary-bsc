...
contract ScoobyZilla is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 800000000000 * 10**18; // 800 bilhoes
    ...
    // growth fund
    uint256 public _marketingFee = 1; // 1%
    ...
    uint256 public _maxTxAmount = 16000000000 * 10**18; // 2% max transaction size
    uint256 public _maxWalletSize = 40000000000 * 10**18; // 5% max wallet size
    uint256 private numTokensSellToAddToLiquidity = 800000000 * 10**18; // 0.1%
