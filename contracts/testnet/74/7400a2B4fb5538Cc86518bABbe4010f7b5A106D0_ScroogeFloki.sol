...
//𝗧𝗢𝗞𝗘𝗡:   𝗦𝗰𝗿𝗼𝗼𝗴𝗲𝗙𝗹𝗼𝗸𝗶 [𝗦𝗖𝗥𝗢𝗢𝗚𝗘]

//𝗧𝗚:        𝗵𝘁𝘁𝗽𝘀://𝘁.𝗺𝗲/𝘀𝗰𝗿𝗼𝗼𝗴𝗲𝗳𝗹𝗼𝗸𝗶

//𝗪𝗘𝗕𝗦𝗜𝗧𝗘:  𝗵𝘁𝘁𝗽𝘀://𝘄𝘄𝘄.𝘀𝗰𝗿𝗼𝗼𝗴𝗲𝗳𝗹𝗼𝗸𝗶.𝗰𝗼𝗺

//𝗧𝗪𝗜𝗧𝗧𝗘𝗥:  𝗵𝘁𝘁𝗽𝘀://𝘁𝘄𝗶𝘁𝘁𝗲𝗿.𝗰𝗼𝗺/𝘀𝗰𝗿𝗼𝗼𝗴𝗲𝗳𝗹𝗼𝗸𝗶
...
contract ScroogeFloki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ScroogeFlokiDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Scrooge Floki", "SCROOGE") {
        MarketingWallet = payable(0x55A9Ba965aB2C65A57F4a6f9745c36003dc1992C);
        DevelopmentWallet = payable(0xc6112F759F9D9aB8cC91f1c73A80fB0502E5F8d7);
        ...
        dividendTracker = new ScroogeFlokiDividendTracker(
            payable(this),
            router,
    ...
    function _transfer(
        ...
        if (amount == 0) {
            ...
            uint256 totalFees = RewardsFee
                .add(liquidityFee + MarketingFees + developmentFees);
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        if (buyRewardsFee > 0) {
            ...
            .div(totalAmount)
            .mul(buyRewardsFee)
            .div(buyRewardsFee + buyMarketingFees + buyDevelopmentFee);
        }
        if (sellRewardsFee > 0) {
            ...
            .div(totalAmount)
            .mul(sellRewardsFee)
            .div(sellRewardsFee + sellMarketingFees + sellDevelopmentFee);
        }
        ...
        uint256 _completeFees = sellMarketingFees.add(sellDevelopmentFee) +
            buyMarketingFees.add(buyDevelopmentFee);
        ...
        emit SendDividends(
            dividends,
            MarketingPayout + developmentPayout,
...
contract ScroogeFlokiDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    ScroogeFloki public ScroogeFlokiContract;
    ...
    constructor(
        ...
        defaultToken = token;
        ScroogeFlokiContract = ScroogeFloki(mainContract);
    ...
    function _transfer(
        ...
        require(false, "ScroogeFloki_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "ScroogeFloki_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ScroogeFloki contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(ScroogeFlokiContract);

            uint256 prevBalance = ScroogeFlokiContract.balanceOf(address(this));
            ...
            {
                uint256 received = ScroogeFlokiContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    ScroogeFlokiContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
