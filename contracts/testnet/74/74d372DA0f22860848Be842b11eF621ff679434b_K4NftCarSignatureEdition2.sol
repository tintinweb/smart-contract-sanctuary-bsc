...
contract K4NftCarSignatureEdition2 is ERC721, Ownable, ReentrancyGuard {
    ...
    function removeHotwalletAddress(address user)
        public
        onlyOwner
        returns (address[] memory)
    {
        ...
        uint256 lastPayeeIndex = hotWalletAddress.length - 1;
        address lastPayeeId = hotWalletAddress[lastPayeeIndex];
        hotWalletAddress[index] = lastPayeeId;
