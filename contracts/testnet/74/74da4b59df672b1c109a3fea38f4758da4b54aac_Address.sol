...
contract BANSHING is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Ban Shing';
    ...
    //DevWallets
    address public TeamWallet=payable(0x39E60458426d26C27d8A6A767697Abf2796D228A);
    address public walletTwo=payable(0x39E60458426d26C27d8A6A767697Abf2796D228A);
    //TestNet
    address private PancakeRouter=0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    //MainNet
