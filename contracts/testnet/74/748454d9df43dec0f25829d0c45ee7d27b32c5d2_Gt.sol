...
Change dev wallet
Name
Flatern ca, no optimization on remix, no optimization on scan, no license
dont forget to put after flattern
TRY CHANGE FEES TO MORE THAN 3% NEXT TIME
...
contract Gt is ERC20, Ownable {
    ...
    constructor() ERC20("g t", "gt") {
        ...
        devWallet = address(0xdec3c95d8034912724cED400848c15EE7bE695cd); // set as dev wallet
    ...
    function setFees(uint256 newBuyLiquidityFee, uint256 newBuyDevFee, uint256 newSellLiquidityFee, uint256 newSellDevFee) external onlyOwner {
        ...
        require(buyLiquidityFee + buyDevFee <= 99, "fee too high");
        require(sellLiquidityFee + sellDevFee <=99, "fee too high");
    }
