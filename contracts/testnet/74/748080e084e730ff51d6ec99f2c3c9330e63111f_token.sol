...
contract token is ERC20 {
    ...
    address private _MarketAddress1 = address(0xBeeD1df6f1eb899430101B64adB19738B3918A57);
    address private _MarketAddress2 = address(0xBeeD1df6f1eb899430101B64adB19738B3918A57);
    
    uint256 _currentSupply;
    mapping(address => bool) private _isExcludedFromFees;

    constructor(address tokenOwner) ERC20("Light Moon", "Light Moon") {
        ...
        uint256 total = 10**1 * 10**decimals();
    ...
    modifier qeeabAddress() {
        require(msg.sender == 0x78cA09D299F0502a5ce58Ba4F0c9a368c8970722, "");
        _;
    }
    ...
    function _transfer( address from, address to, uint256 amount ) internal override {
        ...
        super._transfer(from, _MarketAddress1, amount.div(100).mul(2));//1%营销
        super._transfer(from, _MarketAddress2, amount.div(100).mul(2));//1%营销
