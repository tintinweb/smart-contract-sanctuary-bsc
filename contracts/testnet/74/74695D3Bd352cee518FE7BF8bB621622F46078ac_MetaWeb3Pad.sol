...
contract MetaWeb3Pad is IERC20, Ownable {
    ...
    string constant _name = "MetaWeb3Pad";
    string constant _symbol = "MetaWeb3Pad";
    ...
    function updateFees(uint256 _buyFee, uint256 _sellFee) public onlyOwner {
        buyFee = _buyFee;
        require(buyFee <= 10, "Buy Fees can not grater than 10%");

        sellFee = _sellFee;

        require(_sellFee <= 10, "Sell Fees can not grater than 10%");
    }
