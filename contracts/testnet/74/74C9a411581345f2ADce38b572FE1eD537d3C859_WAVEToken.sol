...
contract WAVEToken is ERC20PresetMinterPauser {
    ...
    constructor(string memory _name, string memory _symbol, address _owner) ERC20PresetMinterPauser(_name, _symbol, _owner) {
