    ...
    VRFConsumerBaseV2Upgradeable
{
    ...
    function randomMint(
        address to,
        uint8 _tier,
        SharedStructs.ItemInfo memory _weaponsInfoMap
        ...
        weaponsInfoMap[_tokenId].tier = _weaponsInfoMap.tier;
        weaponsInfoMap[_tokenId].rarityId = _weaponsInfoMap.rarityId;
        weaponsInfoMap[_tokenId].rarityName = _weaponsInfoMap.rarityName;
        weaponsInfoMap[_tokenId].collectionId = _weaponsInfoMap.collectionId;
        weaponsInfoMap[_tokenId].collectionName = _weaponsInfoMap
            .collectionName;
        weaponsInfoMap[_tokenId].firstOwner = to;
