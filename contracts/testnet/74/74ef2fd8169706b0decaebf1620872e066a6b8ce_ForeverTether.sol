...
contract ForeverTether is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Forever1Tether";
    string constant _symbol = "Forever1Tether";
    uint8 constant _decimals = 2;

    uint256 public constant MAX_UINT256 = ~uint256(0);
    uint8 public constant RATE_DECIMALS = 7;   

    uint256 private constant MAX_SUPPLY = 375 * 10**RATE_DECIMALS * 10**_decimals;
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 375 * 10**3 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x09232EC6158483000bD079451BcD8c9c120a90a2;
        teamFeeReceiver = 0x09232EC6158483000bD079451BcD8c9c120a90a2;
        charityFeeReceiver = 0x09232EC6158483000bD079451BcD8c9c120a90a2;
    ...
    function doRebase() external authorized {
        inSwap = false;
        rebase();
    }
