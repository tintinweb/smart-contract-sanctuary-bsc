...
contract FinnCottonV4 is ERC721Enumerable,ReentrancyGuard,AccessControl, Ownable{
    using Strings for uint256;
    ...
    uint256 public collectionSupplies = 10000;// <----------- SHOULD CHANGE
    uint256 public tokenIdPartner; 
    
    uint256 public cost = 0.002 ether;// <----------- SHOULD CHANGE
    uint256 public whiteListCost = 0.001 ether; // <----------- SHOULD CHANGE
    ...
    string private _CONTRACT_URI = "ipfs://bafkreicbkzj3ettpwd7me3wjn55zfltw5g23vhrhfwcha45dndcea4bvgi";  //<----------- SHOULD CHANGE
    ...
    constructor( )  ERC721("FFFFF", "FFFFF")   {   
