...
//    IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); 
   IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); 
    ...
    // Buy Fees
    function Contract_SetUp_01__Fees_on_Buy(uint256 BNB_on_BUY, uint256 Liquidity_on_BUY, uint256 Burn_on_BUY, uint256 Tokens_on_BUY, uint256 Rewards_on_BUY ) external onlyOwner {
 ...
 // Auto Fee Processing Switch
  ...
  event AllRecord (address from , address to , uint256 FromBalance , uint256 toBalance);
    ...
    event LPTokenEvent(uint256 Lptokens);
    ...
    function swapAndLiquify(uint256 Tokens ) private {
        ...
        emit BNBValuesEvent(BNB_Liquidity , BNB_Contract ,BNB_Rewards);
        // Add Liquidity 
        if (LP_Tokens != 0){
