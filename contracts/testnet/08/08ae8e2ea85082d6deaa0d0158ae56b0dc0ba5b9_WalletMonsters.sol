...
// File: contracts/artifacts/WM_bsc.sol
...
contract WalletMonsters is ERC1155, Ownable, IERC1155Receiver{
    ...
    constructor() ERC1155("https://p7vqo9fd8fws.usemoralis.com/{id}.json") {
        ...
        tokenApproved[0x16cAe79EE263312d12339fB1fb62329f59eDfB18] = true;
...
function trainerMarket(uint256 itemId, uint256 amount) public  {
   ...
   function useWaly(address token, uint amount, uint tokenId) public {
        require(tokenApproved[token] == true, "We don't accept those");
        require(tokenId != 0 && tokenId < 6);

        IERC20(token).transferFrom(msg.sender, reserves, amount);
