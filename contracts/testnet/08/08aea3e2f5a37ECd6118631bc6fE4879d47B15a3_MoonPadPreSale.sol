...
contract MoonPadPreSale is Ownable {
    ...
    uint256 public maxMoonPadToBuy;
    ...
    constructor(
        ...
        moonPad = _moonPad;
        maxMoonPadToBuy = _maxMoonPadToBuy;
    ...
    function swapPulsemoonToMoonPad(uint256 amountToSwap) external {
        ...
        require(
            maxMoonPadToBuy >= preBoughtTokens[msg.sender] + moonPadAmount,
            "Over maximum MoonPad amount"
        );
     ...
     */
    function setMaxMoonPadToBuy(uint256 _maxMoonPadToBuy) external onlyOwner {
        maxMoonPadToBuy = _maxMoonPadToBuy;
    }
