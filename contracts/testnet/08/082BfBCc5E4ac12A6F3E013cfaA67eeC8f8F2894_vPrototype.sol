...
contract vPrototype {
    ...
    //owner: 0x30E8608A202003D7D7393B9306F7778700C64A50
    ...
    uint256[3] MineDuration = [365 days, 182 days, 121 days];
    uint256[3] MinimumHashRatePerTier = [20, 25, 30];
    uint256[3] MinimumDepositPerTier = [0.05 ether, 0.2 ether, 1 ether];
    uint256[3] RefBonusPercentage = [100, 10, 10]; //10, 1 and 1%
    
    uint256 public totalClaimed;
    uint256 public totalWithdrawn;
    uint256[3] public totalDepositsPerTier;
