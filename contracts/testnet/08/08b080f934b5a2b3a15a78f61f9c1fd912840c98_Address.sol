...
contract JustTest is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "JustTest";
    string private _symbol = "JT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x66EDB25a18e46D4cdc8BEe11827adbbf992db777);
    address payable public teamWalletAddress = payable(0x66EDB25a18e46D4cdc8BEe11827adbbf992db777);
