...
abstract contract Ownable is Context {
  ...
  address private _prvOwner;
  uint256 private _lockTime;

  event OwnershipTransferred(address indexed prvOwner, address indexed newOwner);
  ...
  */
  ...
  function unlock() public virtual {
    require(_prvOwner == msg.sender, "You don't have permission to unlock the token contract");
    require(block.timestamp > _lockTime , "Contract is locked until 7 days");
    emit OwnershipTransferred(_owner, _prvOwner);
    _owner = _prvOwner;
  }
}
