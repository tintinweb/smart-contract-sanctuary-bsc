...
contract HeroMarketPlace is OwnableUpgradeable, PausableUpgradeable  {
    struct Auction {
        uint256 highestBid;
        uint256 closingTime;
    ...
    function initByOwner(HeroNFT _heroNFT, address _tokenBEP20) public onlyOwner{
        heroNFT=_heroNFT;
    ...
    function closeAuctionSudden(uint256 _nftId) external whenNotPaused {
        ...
        heroNFT.transfer(_nftId, auctions[_nftId].originalOwner);
...
function openAuction(
        ...
        require(heroNFT.ownerOf(_nftId) == msg.sender, "Not NFT owner");
        heroNFT.approveMarketPlace(address(this),_nftId);
        // NFT Transfer to contract
        heroNFT.transfer(_nftId, address(this));
    ...
    function buy(uint256 _nftId, uint256 _amount) external whenNotPaused {
        ...
        // Transfer NFT to Highest Bidder
        heroNFT.transfer(_nftId, auctions[_nftId].highestBidder);
    ...
    function setHeroNFT(HeroNFT _heroNFT) public onlyOwner{
    heroNFT=_heroNFT;
    }
