...
contract Seniorage is Ownable, Pausable {
    ...
    uint256 private constant FIRST_SWAP_ON_ZOINKS_PERCENT = 2000;
    uint256 private constant SECOND_SWAP_ON_ZOINKS_PERCENT = 1500;
    uint256 private constant SNACKS_SENIORAGE_PERCENT = 7500;
    uint256 private constant SNACKS_PULSE_PERCENT = 2500;
    uint256 private constant BTC_SNACKS_SENIORAGE_PERCENT = 6667;
    uint256 private constant BTC_SNACKS_PULSE_PERCENT = 3333;
    uint256 private constant ETH_SNACKS_SENIORAGE_PERCENT = 6667;
    uint256 private constant ETH_SNACKS_PULSE_PERCENT = 3333;
    uint256 private constant BTC_ETH_PERCENT = 750;
    uint256 private constant LUNCH_BOX_PERCENT = 3000;
    ...
    */
    ...
    function distributeNonBusdCurrencies() external whenNotPaused onlyAuthority {
        for (uint256 i = 0; i < _nonBusdCurrencies.length(); i++) {
            address currency = _nonBusdCurrencies.at(i);
            uint256 balance;
            if (currency == zoinks) {
