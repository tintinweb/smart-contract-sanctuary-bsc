...
contract IKONICVesting is Ownable,ReentrancyGuard{
    ...
    function linearVestingDetails(address _userAddress) public view returns (uint) {
        uint lastClaimTime = InvestorDetails[_userAddress].lastClaimTime;
        uint timeDifference;
        uint[11] memory linearTime =[0,globalStartTime+ 60 minutes ,globalStartTime + 1 minutes ,globalStartTime + 1 minutes,globalStartTime +  1 minutes ,globalStartTime + 180 minutes,globalStartTime + 365 minutes,globalStartTime + 30 minutes,globalStartTime + 180 minutes, globalStartTime + 90 minutes,globalStartTime + 1 minutes];
