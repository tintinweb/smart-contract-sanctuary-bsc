...
contract Token is Context, IBEP20, Ownable {
    ...
    constructor () {
        ...
        _SECOND_STAGE_BURN_FEE = 25;
        _MAX_T_LIMIT = 50;
        _CONTINUOUS_PERCENT = 25;
		
		_feeAddress = 0x40EE0A26cea66540465ab45d90381ac406C3C080;
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[_msgSender()] = true;
        emit Transfer(address(0),_msgSender(), _tTotal);

        _publicSaleWallet = 0x27370F005842c6211D5f10D0Af1c5022853CADad;
        uint256 publicSaleAmount = _tTotal.mul(20).div(10**2);
        transfer(_publicSaleWallet , publicSaleAmount);

        _preSaleWallet = 0x7aA30B673aDd322760ED0Dc43D288F14C9E2cEe2;
        uint256 privateSaleAmount = _tTotal.mul(10).div(10**2);
        transfer(_preSaleWallet, privateSaleAmount);
        _totalOffer = publicSaleAmount.add(privateSaleAmount);
        
        _teamWallet = 0xD455a78d16bAB8EF3e0E3f6918C27da38374aECf;
        uint256 teamAmount = _tTotal.mul(5).div(10**2);
        transfer(_teamWallet , teamAmount);

        _developmentWallet = 0x5872aB44209195Caf6827315D8958aDB8EeF5F9B;
        uint256 developmentAmount = _tTotal.mul(5).div(10**2);
        transfer( _developmentWallet, developmentAmount);

		_marketingWallet = 0x36b0Ac1565ae168880EdE783f8bb4e273F9e5c1b;
    ...
    function includedFromFee(address account) external onlyOwner{
    ...
    function isLimitEnabled()public view returns (bool){
        return _hasLimit;
    }
