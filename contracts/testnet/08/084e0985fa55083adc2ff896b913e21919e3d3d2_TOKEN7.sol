...
contract TOKEN7 is Context, IERC20, Ownable {
    ...
    string private constant _name = "TOKEN7";
    string private constant _symbol = "MDB7";
    ...
    //input in Single Token Percentage
    function setVipLiquidityTokenPerent(uint256 liquidityTokenPercent) external onlyOwner {
        vipLiquidityTokenEntry = 10**18 * liquidityTokenPercent / 100;
    }    
    ...
    //input in Wei amount
    function fireBuyback(uint256 weiAmount) external onlyOwner {
    	if (weiAmount > 0) {
