...
contract Test is ERC20, Ownable {
    ...
    address public toBurnMemeAddress = 0xb9654A42f0F5dCDEf5617DebF8bd048E33F180E7;
    uint256 public toBurnMemeFee = 2;
    ...
    constructor() ERC20("Christmas_Meme_family.app", "Christmas_Meme_family") {
        a80DividendTracker = new A80DividendTracker();
        b20DividendTracker = new B20DividendTracker();

        marketingWallet = 0xA67625255D0ca1B6dA42C475A4AdC7aA8359ecFc;
        teamWallet = 0xC9f19D1f492dcc9Ff782B6F832D784AF390cFa4A;
        ...
        if (
            ...
            if (!swapping && contractTokenBalance >= swapTokensAtAmount) {
                ...
                if(marketingEnabled && buyBackAndLiquifyEnabled && toBurnMemeFee > 0 && buyBackMode){
                    ...
                    if(increaseAmount > 0){
                        uint256 teamPortion = increaseAmount.mul(marketingFee).mul(80).div(total3Fees).div(10**2);
                    ...
                    if (marketingEnabled) {
                        ...
                        if(increaseAmount > 0){
                            uint256 teamPortion = increaseAmount.mul(80).div(10**2);
...
contract A80DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("ADA80_Dividend_Tracker", "ADA80_Dividend_Tracker", 0x55d398326f99059fF775485246999027B3197955) {
        claimWait = 3600;
...
contract B20DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("ADA20_Dividend_Tracker", "ADA20_Dividend_Tracker", 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
