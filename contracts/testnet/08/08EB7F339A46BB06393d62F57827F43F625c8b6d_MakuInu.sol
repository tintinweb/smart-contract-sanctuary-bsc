    ...
    UUPSUpgradeable
{
    ...
    function initialize(
        ...
        _maxSellTransaction = 1_000_000 * 10**decimals(); // 1M $MAKU
        ...
        _swapThreshold = 1_000_000 * 10**decimals(); // 1M $MAKU ( 0.1% )
        ...
        _mint(owner(), 1_000_000_000 * 10**decimals()); // 100B $MAKU
    }
    ...
    function isExcludedFromBuyFees(address account) external view returns (bool) {
    ...
    function enableTrading(bool isEnabled) external onlyOwner {
        require(
            ...
            "MakuInu: Trading enabled is already the value of 'isEnabled'"
        );
    ...
    function enableTakeFees(bool isEnabled) external onlyOwner {
        require(
            ...
            "MakuInu: Take fees enabled is already the value of 'isEnabled'"
        );
    ...
    function enableSwap(bool isEnabled) external onlyOwner {
        require(
            ...
            "MakuInu: Swap enabled is already the value of 'isEnabled'"
        );
    ...
    function updateMaxSellTransaction(uint256 amount) external onlyOwner {
        require(
            ...
            "MakuInu: Max sell transaction is already the value of 'amount'"
        );
    ...
    function updateUniswapV2Router(address router_) external onlyOwner {
        require(
            router_ != _router,
            "MakuInu: The router already has that address"
        );
    ...
    function updateTeamWallet(address payable newWallet) external onlyOwner {
        require(
            ...
            "MakuInu: The team wallet already has that address"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "MakuInu: The marketing wallet already has that address"
        );
    ...
    function updateChestWallet(address payable newWallet) external onlyOwner {
        require(
            ...
            "MakuInu: The chest wallet already has that address"
        );
    ...
    function updateKsosWallet(address payable newWallet) external onlyOwner {
        require(
            ...
            "MakuInu: The ksos wallet already has that address"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "MakuInu: Account is already the value of 'excluded'"
        );
    ...
    function updateBuyFees(
        ...
        require(
            ...
            "MakuInu: Buy fees has already the same values"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "MakuInu: Liquidity buy fees has already the same value"
        );
    ...
    function updateTeamBuyFees(uint256 feesPerTenThousand) external onlyOwner {
        require(
            ...
            "MakuInu: Team buy fees has already the same value"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "MakuInu: Marketing buy fees has already the same value"
        );
    ...
    function updateChestBuyFees(uint256 feesPerTenThousand) external onlyOwner {
        require(
            ...
            "MakuInu: Chest buy fees has already the same value"
        );
    ...
    function updateKsosBuyFees(uint256 feesPerTenThousand) external onlyOwner {
        require(
            ...
            "MakuInu: ksos buy fees has already the same value"
        );
    ...
    function updateSellFees(
        ...
        require(
            ...
            "MakuInu: Sell fees has already the same values"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "MakuInu: Liquidity sell fees has already the same value"
        );
    ...
    function updateTeamSellFees(uint256 feesPerTenThousand) external onlyOwner {
        require(
            ...
            "MakuInu: Team sell fees has already the same value"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "MakuInu: Marketing sell fees has already the same value"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "MakuInu: Chest sell fees has already the same value"
        );
    ...
    function updateKsosSellFees(uint256 feesPerTenThousand) external onlyOwner {
        require(
            ...
            "MakuInu: ksos sell fees has already the same value"
        );
    ...
    function _setAutomatedMarketMakerPair(address newPair, bool value) private {
        require(
            ...
            "MakuInu: Automated market maker pair is already set to that value"
        );
        _isAutomatedMarketMakerPairs[newPair] = value;
    ...
    function _transfer(
        ...
        require(
            sender == owner() || _tradingEnabled,
            "MakuInu: Trading is not enabled"
        );
        require(
            sender != address(0),
            "MakuInu: Transfer from the zero address"
        );
        require(
            recipient != address(0),
            "MakuInu: Transfer to the zero address"
        );
        require(amount > 0, "MakuInu: Transfer zero token");
        require(
            !_isBlacklisted[sender] && !_isBlacklisted[recipient],
            "MakuInu: Blacklisted address"
        );
        require(
            sender == owner() || !(_isSelling && amount > _maxSellTransaction),
            "MakuInu: Can't sell more than max sell transaction"
        );
