...
contract Marketplace is Ownable {
    ...
    function matchTransaction(
        ...
        require(
            ...
            "Marketplace: signature used. This item is not available for sale now"
        );
        ...
        require(
            ...
            "Marketplace: invalid seller approval"
        );
        ...
        // emit sale event
        emitEvent(addresses, values, fee, 721);
        return true;
    }
    ...
    function matchTransaction1155(
        ...
        bytes32 criteriaMessageHash = getMessageHash1155(
            addresses[1],
            values[0],
            addresses[2],
            values[3],
        ...
        require(
            nft.balanceOf(addresses[0], values[0]) >= values[3],
            "Marketplace: seller balance is not enought for this transaction"
        );
        ...
        // emit sale event
        emitEvent(addresses, values, fee, 1155);
        return true;
    }
    ...
    function cancelSale(
        ...
        if (values[3] > 0) {
            ...
            usedSignatures[signature] = true;
            emit CancelSale(addresses[0], values[0], 721, 0, _msgSender());
        }
    }
