...
TG : https://t.me/TianInu
Website : https://tianinu.com/
*/
...
contract TianInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tian Inu";
    string private _symbol = "TianInu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC35dd751F76b03EfaB3A7B2cf84F4a911906C587); 
    address payable public buyBackWalletAddress = payable(0xC35dd751F76b03EfaB3A7B2cf84F4a911906C587); 
    ...
    uint256 public _extraFeeOnSell = 8; 
    uint256 public _totalTaxIfBuying = 0;
    uint256 public _totalTaxIfSelling = 0;

    uint256 private _totalSupply = 6666666666666666;
    uint256 public _maxTxAmount = 6666666; 
    uint256 public _walletMax = 6666666; 
