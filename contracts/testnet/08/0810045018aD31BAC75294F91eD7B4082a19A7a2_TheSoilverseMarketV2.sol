...
contract TheSoilverseMarketV2 is
    ...
    function mintNFTToAddressWithFixedPrice (
        ...
        marketItemMetadata.unlockAt = block.timestamp + (noOfMonths * 60); // 18 * 60 seconds = 1080 seconds
    ...
    function refundNFT(uint256 tokenId) external nonReentrant whenNotPaused {
        ...
        require((marketItemMetadata.listedAt + (refundDays * 60)) >= block.timestamp, "You cannot refund anymore."); // 7 * 60 seconds = 420 seconds
