...
abstract contract EBSAddress {
    ...
    IERC20Wrapper constant public EBS_WRAPPER = IERC20Wrapper(payable(0x0e61a0287C07C11b991aF8294B3a3F0ad89428CD));
...
contract EBSWrapper is ERC1155, EBSPauser, NonceHandler {
    ...
    function initialize() public {
        require (EBS_CONTROL.isOperator(msg.sender), "Wrapper: Must have OPERATOR_ROLE");
        _setURI("EBS Wrapper");
