...
contract EVOXCOIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x2cce468597Dc69002278907C2C1B7247E40E06bc); // Marketing//Dev//controller  Address
    address payable public charityAddress = payable(0x2cce468597Dc69002278907C2C1B7247E40E06bc); // Charity/client Address
    
    address public immutable deadAddress = 0x2cce468597Dc69002278907C2C1B7247E40E06bc;
    ...
    string private _name = "EVOX COIN";
    string private _symbol = "EVX";
