...
contract Shibmas is IBEP20, Ownable
{
    ...
    function ChangeMarketingWallet(address newWallet) public{
        ...
        //TODO: XmaxWallet
    address public XmaxWallet;
    //Only XmaxWallet can change XmaxWallet
    function ChangeXmaxWallet(address newWallet) public{
        require(msg.sender==XmaxWallet);
        XmaxWallet=newWallet;
    }
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==marketingWallet||addr==XmaxWallet;
    }
    
...
///////////////////////////////YeaaaahBrooooooo//////////addd
    ...
    event OnSetTaxes(uint buy, uint sell, uint transfer_, uint burn, uint marketing,uint xmax,uint liquidity);
    function SetTaxes(uint buy, uint sell, uint transfer_, uint burn, uint marketing,uint xmax,uint liquidity) public onlyTeam{
        ...
        burnTax=burn;
        emit OnSetTaxes(buy, sell, transfer_, burn, marketing,xmax,liquidity);
    }
    ...
    function _swapContractToken(bool ignoreLimits) private lockTheSwap{
        ...
        uint totalTax=liquidityTax+marketingTax+XmaxTax;
        ...
        uint tokenForXmax=
        isOverLiquified()?0
        :(tokenToSwap*XmaxTax)/totalTax;

        uint tokenForMarketing= tokenToSwap-tokenForLiquidity-tokenForXmax;

        uint LiqHalf=tokenForLiquidity/2;
        //swaps marktetingToken and the liquidity token half for BNB
        uint swapToken=LiqHalf+tokenForMarketing+tokenForXmax;
        ...
        }else if(tokenForXmax>0){
            (bool send,)=XmaxWallet.call{value:address(this).balance/2}("");
            send=true;
        }else{
