...
interface IStrategy {
    ...
    function deposit2(uint256 _wantAmt) external returns (uint256);
...
contract AFIFarmV2 is Ownable, ReentrancyGuard {
    ...
    //Testnet BSC
    address public AFI =0xF2701B6Be28840695928269e65DFb290e22392e6 ; // bAFI 1:1 migration to AFIv2
    address public AFIv2 =0x6d6ac949027e412414be6087DC5f1C69075bfa34 ;
    ...
    function deposit(uint256 _pid, uint256 _wantAmt) public nonReentrant {
        //console.log("deposit:", _pid, _wantAmt);
        updatePool(_pid);
        PoolInfo storage pool = poolInfo[_pid];
        UserInfo storage user = userInfo[_pid][msg.sender];

        //console.log("deposit:", user.shares);
        if (user.shares > 0) {
            uint256 pending =
