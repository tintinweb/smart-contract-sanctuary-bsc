...
contract LuckyCoin is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000*10**(9+8);
    ...
    address public charityWallet = 0xaEd90D6bd247CDE21CE65ec2c907b9d19Cb63878;
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000*10**(9+8);
