...
contract BTD_MINER {
    ...
    function getPrice(address adr) public view returns (uint256){
        ...
        addition =min(2 * baseAmount, baseAmount * addition/100);
    ...
    function getBasePrice() public  view returns (uint256){
        ...
        if(btdAmount > 60000000 * btdDecimal){
            return 200* btdDecimal;
        }else if(btdAmount > 50000000 * btdDecimal){
            return 150 * btdDecimal;
        }else if(btdAmount > 40000000 * btdDecimal){
            return 100 * btdDecimal;
        }else if(btdAmount > 30000000 * btdDecimal){
            return 50 * btdDecimal;
        }else if(btdAmount > 20000000 * btdDecimal){
            return 30 * btdDecimal;
        }else if(btdAmount > 10000000 * btdDecimal){
            return 20 * btdDecimal;
        }
            
        return 10 * btdDecimal;
    }
