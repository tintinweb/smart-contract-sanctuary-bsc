...
contract crowdFunding is Ownable {
    ...
    mapping(address => uint256) public weekWidthdraw;
    ...
    function invest(uint256 _amount, string memory _password) external {
        ...
        require(
            ...
            "Maximum investment Amount is 1M busd"
        );
        require(_amount >= 50 ether, "Minimum investment Amount is 50 busd");
        require(
        ...
        userInvestment[msg.sender].withdrawable+     userInvestment[msg.sender].amount +
                _amount -
                ((userInvestment[msg.sender].amount *
                    userInvestment[msg.sender].loss) / 100),
    ...
    function monthlyWithdraw(uint256 _amount) external  {
        ...
        require(
            userInvestment[msg.sender].timeperiod + 15 minutes <
                block.timestamp,
    ...
    // reInvest
    function reInvestMonthly(uint _amount) external  {
        // require(userInvestment[msg.sender].invested, "Not Invested");
        require(50 ether<=_amount, "Amount should be minimum 50 busd");
        require(
            userInvestment[msg.sender].timeperiod + 15 minutes <
                block.timestamp,
        ...
        // userInvestment[msg.sender].loss = 0;
    }
    ...
    function weeklyWithdraw() external  {
        ...
        weekWidthdraw[msg.sender] = block.timestamp;
    }
    ...
    function updateMaxInvestment(uint256 _maxInvestment) external onlyOwner {
        maxInvestment = _maxInvestment * 1 ether;
    }
