...
contract DianoBusd is Context, Ownable {
    ...
    BusdInterface.transferFrom(address(this),msg.sender,totalAmountToWithdraw);
    BusdInterface.transferFrom(address(this),dev,wFee);
    ...
    function unStake() public {
        ...
        uint256 UnstakeValue = SafeMath.sub(I_investment,t_withdraw);

        uint256 UnstakeValueCore = SafeMath.div(UnstakeValue,2);

        BusdInterface.transferFrom(address(this),msg.sender,UnstakeValueCore);

        BusdInterface.transferFrom(address(this),dev,UnstakeValueCore);
    ...
    function Ref_Withdraw() public {
        ...
        BusdInterface.transferFrom(address(this),msg.sender,value);
