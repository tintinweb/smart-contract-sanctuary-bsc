...
contract InvestorManager is
Ownable, AccessControlEnumerable, ERC1155Holder {
...
contract IDORanking is IDOWithReward {
  ...
  constructor(IERC20 _man, IERC20 _usdt, IERC20 _mon, IERC1155 _erc1155ForReward, Randomizer _randomizer)
  IDOWithReward(_man, _usdt, _mon, _erc1155ForReward, _randomizer) {}
