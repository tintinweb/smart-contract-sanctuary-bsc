...
contract swaap is Ownable, ReentrancyGuard {
    ...
    constructor() {
        address tokenAddress = 0xb618141A141bE610eFE348a370227907c8039a15;
    ...
    function deposit(address _ref, uint256 _amount) external noReentrant alreadyInit {
    ...
    function depositAfterArbitrage(uint256 _amount, uint256 _id) public onlyOwner noReentrant {
        token.transferFrom(msg.sender, address(this), _amount);
    ...
    function trade(bytes calldata _id, uint256 _amount, address _to, address _contract) external onlyOwner noReentrant {
        ...
        require(balanceAfter >= balanceBefore, "Amount after the trade is not enough");
