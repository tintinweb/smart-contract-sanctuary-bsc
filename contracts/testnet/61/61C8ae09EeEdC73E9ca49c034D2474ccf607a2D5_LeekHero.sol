...
contract LeekHero is IERC20, Ownable {
...
=> uint256)) private _allowances;
    ...
    address public fundAddress = 0x7b7E2d6A9AC8304a4Ba8393e2E056167D453a37a;

    IPancakeRouter02 internal uniswapV2Router = IPancakeRouter02(0xB6BA90af76D139AB3170c7df0139636dB6120F7e);
 ...
 constructor() public {
        ...
        uint256 total = 4096000000000000000000;
...
spender, uint256 amount) external override returns (bool) {
...
(currentAllowance >= amount, "ERC20: transfer amount exceeds allowance");
    ...
    function _transferNormal(address sender, address recipient, uint256 
...
Transfer(sender, address(this), fundAmount);
    ...
    function pairFor(address 

factory, address tokenA, address tokenB) internal pure returns (address pair_) {
        (address token0, address token1) = tokenA < tokenB ? (tokenA, tokenB) : (tokenB, tokenA);
        pair_ = address(uint160(uint(keccak256
