...
import "./IGetKicksCollection.sol";
import "./ERC2981PerTokenRoyalties.sol";

contract GetKicksCollection is
    IGetKicksCollection,
    AccessControl,
    ERC721Enumerable,
    ERC721URIStorage,
    ERC2981PerTokenRoyalties
{
    ...
    modifier onlyController(address controller_) {
        ...
        require(
            ...
            "GetKicksCollection: not a controller address."
        );
        _;
    }
    ...
    /**
     * @dev See {GetKicksCollection-tokenIds}.
     */
    ...
    /**
     * @dev See {GetKicksCollection-ownersHistory}.
     */
    ...
    /**
     * @dev See {GetKicksCollection-locked}.
     */
    ...
    /**
     * @dev See {GetKicksCollection-setRoomInfos}.
     */
    function setCollectionInfos(uint256 tokenId, bool locked_)
        external
        onlyController(_msgSender())
    {
        // solhint-disable-next-line reason-string
        require(tokenId != 0, "GetKicksCollection: tokenId is the zero value");
        Collection storage collection = _collections[tokenId];
        collection.locked = locked_;
    }

    /**
     * @dev See {GetKicksCollection-setController}.
     */
        ...
        onlyController(_msgSender())
    {
        ...
        require(
            ...
            "GetKicksCollection: controller is the zero address"
        );
        // solhint-disable-next-line reason-string
        require(
            controller_ != controller(),
            "GetKicksCollection: controller already updated"
        );
        _controller = controller_;
    ...
    /**
     * @dev See {GetKicksCollection-lockTokenId}.
     */
    function lockTokenId(uint256 tokenId)
        external
        onlyController(_msgSender())
    {
        // solhint-disable-next-line reason-string
        require(
            _exists(tokenId),
            "GetKicksCollection: change for nonexistent token"
        );
    ...
    /**
     * @dev See {GetKicksCollection-releaseLockedTokenId}.
     */
    function releaseLockedTokenId(uint256 tokenId)
        external
        onlyController(_msgSender())
    {
        // solhint-disable-next-line reason-string
        ...
        require(
            _collections[tokenId].locked == true,
            "GetKicksCollection: tokenId not locked"
        );
    ...
    /**
     * @dev See {GetKicksCollection-controller}.
     */
    ...
    /**
     * @dev See {GetKicksCollection-replicas}.
     */
    ...
    /**
     * @dev See {GetKicksCollection-baseURI}.
     */
    ...
    /**
     * @dev See {GetKicksCollection-exists}.
     */
    ...
    /**
     * @dev See {GetKicksCollection.setBaseURI}.
     */
    ...
    /**
     * @dev See {GetKicksCollection.setTokenURI}.
     */
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ...
        require(
            _exists(tokenId),
            "GetKicksCollection: change uri for nonexistent token"
        );
        _setTokenURI(tokenId, tokenURI_);
    }

    /**
     * @dev See {GetKicksCollection-mint}.
    ...
    function mint(
        ...
        require(
            tokenId <= replicas(),
            "GetKicksCollection: all tokens already minted."
        );
    ...
    function bulkMint(
        ...
        // solhint-disable-next-line reason-string
        require(tos.length > 0, "GetKicksCollection: empty tos");
        // solhint-disable-next-line reason-string
        for (uint256 i = 0; i < tos.length; i++) {
            mint(tos[i], uri, royaltyRecipient, royaltyValue);
        }
    }

    /**
     * @dev See {GetKicksCollection-safeMint}.
     */
    function safeMint(
        string memory uri,
        address to,
