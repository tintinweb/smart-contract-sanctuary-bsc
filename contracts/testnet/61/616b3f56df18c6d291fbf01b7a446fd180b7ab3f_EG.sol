...
*/
contract EG is ERC20Upgradeable, OwnableUpgradeable {
    ...
    /**
        ...
        @dev to receive MATIC from pancakeV2Router when swapping
    */
    receive() external payable {}

    /**
        @notice initialization
        @dev set address of router, create a pancake pair
        and exclude from fee owner and EG contract addresses.
    ...
    */
        ...
        checkZeroAddress(_owner)
    {
        ...
        swapAndLiquifyEnabled = false; // Swap & Liquify Disabled
        ...
        __ERC20_init("EG", "EG");
        __Ownable_init();
        IPancakeRouter02 _pancakeV2Router = IPancakeRouter02(_router);
    ...
    */
        ...
        checkZeroAddress(_router)
    {
        ...
        emit ChangeRouter(address(pancakeV2Router));
    }
    ...
    */
    ...
    /**
        ...
        Or withdraw of EG tokens in case if swapAndLiquifyEnabled is disable
    ...
    */
    ...
    /**
        ...
        @dev add approve, generate pancake pairand swap
    ...
    */
    function addLiquidity(uint256 tokenAmount, uint256 maticAmount) private {
        ...
        (
            ...
            uint256 amountETH,
            uint256 liquidity
        ) = pancakeV2Router.addLiquidityETH{value: maticAmount}(
                address(this),
                tokenAmount,
                0,
                0,
    ...
    */
    ...
    {
        if (
            sender == address(pancakeV2Pair) ||
            recipient == address(pancakeV2Pair)
        ) {
