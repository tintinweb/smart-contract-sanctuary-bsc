...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner =0x61967696cDA6592B2ffE151260411D5b953b5954;
...
contract TFC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress =0x56c9a82E3bf34ACC7e7c3b5aFBA49F40e35D761b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 28000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "FatCoin";
    ...
    uint256 public _maxTxAmount = 28000000000000 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 280000000000 * 10**18;
