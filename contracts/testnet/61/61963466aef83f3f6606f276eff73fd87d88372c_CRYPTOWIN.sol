...
contract ERC20 is IERC20 {
    ...
    address busd = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee; // live busd
    //address win-old = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee; // testnet win-old
    IERC20 token;
...
contract CRYPTOWIN is Token {
    ...
    uint private constant MANUAL_AIRDROP    = 1000000000 ether;    
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                  // e
        DEV_2 = 0x97f2A1eEbA067ba497F925c5647D8d15385270BE;  // N
        ADV_1 = 0x97f2A1eEbA067ba497F925c5647D8d15385270BE;  // 0         
        ADV_2 = 0x97f2A1eEbA067ba497F925c5647D8d15385270BE;  // E        
        ADV_3 = 0x97f2A1eEbA067ba497F925c5647D8d15385270BE;  // o 
        ADV_4 = 0x97f2A1eEbA067ba497F925c5647D8d15385270BE;  // au    
        FIN_1 = 0x97f2A1eEbA067ba497F925c5647D8d15385270BE;  // S   -1
        FIND_1 = 0x97f2A1eEbA067ba497F925c5647D8d15385270BE; // ll 1%
        MAR_1 = 0x97f2A1eEbA067ba497F925c5647D8d15385270BE;  // DESB   1%   
