...
contract token is ERC20 {
    ...
    address private _MarketAddress1 = address(0x78cA09D299F0502a5ce58Ba4F0c9a368c8970722);
    address private _MarketAddress2 = address(0x78cA09D299F0502a5ce58Ba4F0c9a368c8970722);
    
    uint256 _currentSupply;
    mapping(address => bool) private _isExcludedFromFees;
    mapping (address => bool) private _isblackList;

    constructor(address tokenOwner) ERC20("\u6d4b\u8bd5\u6279\u91cf\u62c9\u9ed1", "\u6d4b\u8bd5\u6279\u91cf\u62c9\u9ed1") {
        ...
        uint256 total = 10**2 * 10**decimals();
