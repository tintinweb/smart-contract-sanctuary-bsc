...
contract SOEZ is ERC20, Ownable {
    uint256 public fee;
    uint256 public marketingFee;
    uint256 public linasFee;
    ...
    constructor () ERC20("SOEZ", "SOZ") 
    {   
        operator = msg.sender;
        swapTokensAtAmount = 100_000_000 * (10 ** 18);
        marketingWallet = 0x472990601839684Cf695BCBD34A81d745452af18;
    ...
    function updateFees(uint256 _marketingFee,uint256 _linasFee) external onlyOwner {

        fee = _marketingFee + _linasFee;
        require( fee <= 25, "Fees must be less than 25%");
    ...
    function _transfer(
        ...
        if(takeFee && to == uniswapV2Pair && fee > 0) {
