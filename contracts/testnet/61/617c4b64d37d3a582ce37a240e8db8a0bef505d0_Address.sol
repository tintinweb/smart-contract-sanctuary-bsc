...
contract POW3RRANGERS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "POW3R RANGERS";
    string private _symbol = "POW3R";
    ...
    uint256 public _maxTxAmount = 50000000000000 * 10**9; // 1%
