...
import { Console } from "./libs/Console.sol";
    ...
    StorageLayer
{
    ...
    function borrowOtherChainAsset(
        ...
        Console.log("remotes[_chainId]", remotes[_chainId]);
        Console.log("address(0x0)", address(0x0));
    }
...
library Console {
    ...
    function toHexString(uint256 value, uint256 length) public pure returns (string memory) {
      ...
      require(value == 0, "Strings: hex length is insufficient");
      return string(buffer);
    }
