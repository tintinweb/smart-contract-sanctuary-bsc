...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    function unstake(uint256 _wantAmt, bool instantly) public virtual onlyOwner nonReentrant returns (uint256, uint256, uint256) {
        ...
        uint256 withdrawAmount = IERC20(AQUAAddress).balanceOf(address(this)) - balBefore;
    ...
    function setSettings(uint256 _entranceFeeFactor, uint256 _withdrawFeeFactor, uint256 _instantWithdrawFeeFactor) public virtual onlyAllowGov {
...
contract AquaStrategy_GAMMA is StratX2 {
    ...
    constructor(
        ...
        AQUAAddress = _addresses[4];
        wantAddress = _addresses[5];
        rewardsAddress = _addresses[6];
        iAquaAddress = _addresses[7];
        gammaTrollerAddress = _addresses[8];
