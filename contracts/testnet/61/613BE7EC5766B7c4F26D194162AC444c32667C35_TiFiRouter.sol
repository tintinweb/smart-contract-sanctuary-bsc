...
contract TiFiRouter is IPancakeRouter02 {
        ...
        returns (uint[] memory amounts)
    {
        ...
        if (fee > 0) {
            TransferHelper.safeTransferETH(feeReceiver, fee * receiverFee / totalFee);
            TransferHelper.safeTransferETH(LPfeeReceiver, fee * LPreceiverFee / totalFee);
        }
    }
