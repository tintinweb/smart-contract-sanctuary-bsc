    ...
    ReentrancyGuardUpgradeable
{
  ...
  /// @custom:oz-upgrades-unsafe-allow constructor
    ...
    */
     ...
     */
    function balanceStakableToken(uint256 _pid)public returns(uint256){
       return balanceStakableAmount[_pid] = poolInfo[_pid].poolStakableAmount - totalStakedAmountInPool[_pid];
    }
