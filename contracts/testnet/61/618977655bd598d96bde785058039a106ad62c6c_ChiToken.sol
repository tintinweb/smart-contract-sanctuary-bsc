...
//modified by @0xsolcurity follwer me on twitter
contract ChiToken is IERC20, ERC20WithoutTotalSupply {
    ...
    bytes32 bytesCodehash;
    event created(bytes bt);

    constructor() {
        owner = msg.sender;
    }

    function freeAll() external {
    ...
    function mint(uint256 value) public returns (bytes memory result) {
        uint256 offset = totalMinted;
        //                0x7A6d4946c0e9F43F4Dee607b0eF1fA1c3318585733ff6000526015600bf30000
        bytes memory createbytes = bytes.concat(
            bytes2(0x7A73),
            bytes20(address(this)),
            bytes16(0x3318585733ff600052601B6005f30000)
        );
        result = createbytes;
        bytesCodehash = keccak256(abi.encodePacked(createbytes));
        emit created(createbytes);
        assembly {
            //bytes32 salt = keccak256(abi.encodePacked(msg.sender, i+oldN));

            // mstore(
            //     0,
            //     0x7473 4946c0e9F43F4Dee607b0eF1f A1c3318585733ff6000526015600bf30000
            // )

            //mstore(0, createbytes)
            ...
            for {
                ...
                // pop(create2(0, 0, 38, add(offset, 0)))
                // pop(create2(0, 0, 38, add(offset, 1)))
                // pop(create2(0, 0, 38, add(offset, 2)))
                // pop(create2(0, 0, 38, add(offset, 3)))
                // pop(create2(0, 0, 38, add(offset, 4)))
                // pop(create2(0, 0, 38, add(offset, 5)))
                // pop(create2(0, 0, 38, add(offset, 6)))
                // pop(create2(0, 0, 38, add(offset, 7)))
                // pop(create2(0, 0, 38, add(offset, 8)))
                // pop(create2(0, 0, 38, add(offset, 9)))
                // pop(create2(0, 0, 38, add(offset, 10)))
                // pop(create2(0, 0, 38, add(offset, 11)))
                // pop(create2(0, 0, 38, add(offset, 12)))
                // pop(create2(0, 0, 38, add(offset, 13)))
                // pop(create2(0, 0, 38, add(offset, 14)))
                // pop(create2(0, 0, 38, add(offset, 15)))
                // pop(create2(0, 0, 38, add(offset, 16)))
                // pop(create2(0, 0, 38, add(offset, 17)))
                // pop(create2(0, 0, 38, add(offset, 18)))
                // pop(create2(0, 0, 38, add(offset, 19)))
                // pop(create2(0, 0, 38, add(offset, 20)))
                // pop(create2(0, 0, 38, add(offset, 21)))
                // pop(create2(0, 0, 38, add(offset, 22)))
                // pop(create2(0, 0, 38, add(offset, 23)))
                // pop(create2(0, 0, 38, add(offset, 24)))
                // pop(create2(0, 0, 38, add(offset, 25)))
                // pop(create2(0, 0, 38, add(offset, 26)))
                // pop(create2(0, 0, 38, add(offset, 27)))
                // pop(create2(0, 0, 38, add(offset, 28)))
                // pop(create2(0, 0, 38, add(offset, 29)))
                // pop(create2(0, 0, 38, add(offset, 30)))
                // pop(create2(0, 0, 38, add(offset, 31)))
                pop(
                    create2(
                        0,
                        add(createbytes, 32),
            ...
            for {
                ...
                //pop(create2(0, 0, 38, offset))
                pop(
                    create2(0, add(createbytes, 32), mload(createbytes), offset)
                )
                offset := add(offset, 1)
            }
        }
