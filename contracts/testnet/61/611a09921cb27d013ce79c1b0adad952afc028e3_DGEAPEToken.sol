...
abstract contract Tokenomics {
    ...
    uint256 internal TOTAL_SUPPLY = 690000000 * 10**18;
    uint256 internal _reflectedSupply = (MAX - (MAX % TOTAL_SUPPLY));
    
    uint256 public maxTransactionAmount = 40142 * (10**18);
    uint256 public swapTokensAtAmount = 690000 * (10**18);
    uint256 public maxWalletBalance = 4014201 * (10**18); // 1.5% of total supply
    
    address public marketingWallet = 0x98C644d1032CEE4AEaD51d521EA5F5E5FCdD8e34;
    address public partyWallet = 0x30727Cd45F9c6646131FBaBf084293e5c3E1F472;
    address public charityWallet = 0x4f122acCA6F5dD70BB4056ea2D16bA49b1aCDdf8;
    address public buyBackWallet = 0xFfC9eF0efd9A1b73A35689FD249346EaB373C20f;
    ...
    constructor() {
        totalFees = buyBackFee.add(dividendRewardsFee).add(marketingFee).add(charityFee);
        sellersTotalFees = totalFees.add(antiDumpFee);
    }
...
abstract contract ERC20 is Context, IERC20, Tokenomics {
    using SafeMath for uint256;
...
// File: contracts/DGEAPEToken.sol
