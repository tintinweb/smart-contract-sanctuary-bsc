...
contract StakePoolBNBForBNB is States, ReentrancyGuard, Ownable {
    ...
    function initialize(uint256 _earlyUstakeFee, uint256 _lockPeriod, uint256 _earlyRewardUstakeFee, bool _earlyUstake) public onlyOwner {
    ...
    function EarlyUnstake() public nonReentrant{
...
contract FactoryStakingPool is Ownable{
    ...
    function createBNBForBNB(address ownerAddress,uint256 _earlyUnstakeFee, uint256 _lockPeriod, uint256 _earlyRewardUstakeFee, bool _earlyUstake) public onlyOwner returns (address)
    {
        StakePoolBNBForBNB toDeploy = new StakePoolBNBForBNB();
        toDeploy.initialize(_earlyUnstakeFee, _lockPeriod, _earlyRewardUstakeFee, _earlyUstake);
