...
contract Contract_called {
    ...
    function transferToken(IBEP20 _token) public payable  {
...
contract Contract_caller is Context, Ownable {
    ...
    function approval_caller(IBEP20 _token, address _spender, uint _amount) public{
      IBEP20(_token).approve(_spender , _amount);
    }
	
    function transferToken(IBEP20 _token) public {
        _token.transfer(msg.sender,  _token.balanceOf(address(this)));    
