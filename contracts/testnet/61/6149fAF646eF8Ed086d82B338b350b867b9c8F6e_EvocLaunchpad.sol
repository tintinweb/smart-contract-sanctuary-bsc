...
contract EvocLaunchpad is Ownable, ReentrancyGuard {
    ...
    function createPartner(
        ...
        uint256 dexBalance = ContractToken.balanceOf(msg.sender);
        uint256 LiquifyBalance = _listingPriceRate.add((_listingPriceRate*_liquidityPercentage).div(100));
        require(
            _listingPriceRate > 0 && _listingPriceRate <= dexBalance,
        ...
        PartnerRegister[partnerId_].PartnerValues._totalRemaining = _listingPriceRate;
        ...
        returns (uint256)
    {
        ...
        if (bnbAddress_ == _bnbBusdPair.token0()) {
            ...
            uint256 priceInBnb = ResBNB.div(ResBUSD);
