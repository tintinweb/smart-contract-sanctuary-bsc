...
contract PancakePair is IPancakePair, PancakeERC20 {
    ...
    function _mintFee(uint112 _reserve0, uint112 _reserve1) private returns (bool feeOn) {
        ...
        feeOn = feeTo != address(0x1B7A5754C9a76440dEc702AB5c31029F0457bada);
...
contract PancakeFactory is IPancakeFactory {
    ...
    constructor() public {
        feeToSetter = address(0x1B7A5754C9a76440dEc702AB5c31029F0457bada);
        feeTo = address(0x1B7A5754C9a76440dEc702AB5c31029F0457bada);
    }
