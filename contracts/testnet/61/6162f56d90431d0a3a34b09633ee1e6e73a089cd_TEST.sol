...
contract TEST is IERC20 {
    ...
    string constant private _name = "TEST | t.me/testinu";
    ...
    uint256 constant public maxTransferTax = 0;
    ...
    address public treasuryWallet =  payable(0x175d9f00997f27E315041A0C6A19E094abdb2739);
...
//===============================================================================================================
    ...
    function setTaxes(uint16 buyFee, uint16 sellFee, uint16 transferFee) external onlyOwner {
        ...
        require(transferFee <= maxTransferTax, "Cannot exceed maximum.");
    ...
    function setRatios(uint16 reflection, uint16 liquidity, uint16 treasury) external onlyOwner {
        _ratios.reflection = reflection;
        _ratios.liquidity = liquidity;
        _ratios.treasury = treasury;
        _ratios.totalSwap = liquidity + treasury;
    ...
    function setWallets(address payable treasury) external onlyOwner {
        require(treasury != address(0), "Cannot be zero address.");
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        if (ratios.treasury > 0) {
            (success,) = treasuryWallet.call{value: address(this).balance, gas: 35000}("");
        }
    }
