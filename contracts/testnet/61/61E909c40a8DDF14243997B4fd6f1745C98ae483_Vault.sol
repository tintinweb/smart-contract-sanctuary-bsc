...
contract Vault is Ownable, AccessControlEnumerable{
    // de set Vault se nhan nap va rut ra nhung token nao de khi nao thay doi hoac nang cap token 
    //  thi chi can set lai token thoi ko can viet lai smart contract khac.
    ...
    modifier onlyWithdrawer {
        // nguoi co quyen withdraw hoac chi chu smart contract 
    ...
    function deposit(uint _amount) external {
        // kiem tra user co du token de nap khong.
