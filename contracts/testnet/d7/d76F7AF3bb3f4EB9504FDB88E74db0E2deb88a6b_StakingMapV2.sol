/** #$#
#$# Stakes on V1 and here are separated but indexes might conflict between these maps.
#$# Getter function has local or global version. Global version mix together results from V1 and this.
#$# To reduce stake on V1 map use localStake() here.
#$# To reduce stake on this map use reduceLocalStake() here.
#$# After deploy:
#$# 1. For tests: setStartTimestamp()
#$# 2. For tests: setMaps()
#$# 3. Run setBlockNewStakes() on V1 map
#$# */
