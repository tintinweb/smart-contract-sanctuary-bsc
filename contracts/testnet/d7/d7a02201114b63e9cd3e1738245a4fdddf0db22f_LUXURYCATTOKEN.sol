...
// PANCAKE SWAP ROUTER ADDRESS MAINNET 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
...
contract LUXURYCATTOKEN is IBEP20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Luxury Cat Token";
    ...
    uint256 public swapThreshold = (_totalSupply * 10) / 1; // 0.01% of supply
    bool inSwap;
    modifier swapping() {
        inSwap = true;
        _;
