...
contract KARA is Context, IERC20, Ownable {
    ...
    string private _name = "KARA";
    string private _symbol = "KRA";
    ...
    uint256 public _maxTxAmountBuy = 100000 * 10**9 * 10**9;
    uint256 public _maxTxAmountSell = 5560 * 10**8 * 10**9;

    uint256 private minimumTokensBeforeSwap = 200000000 * 10**9; 
    uint256 public _maxWalletToken = 50000 * 10**9 * 10**9;
    
    uint256 public numTokensSellToAddToLiquidity001 = 1 * 10**10 * 10**9; // 0.001%
    ...
    uint256 public numTokensSellToAddToLiquidity15 = 15 * 10**12 * 10**9; // 1.5%
    uint256 public numTokensSellToAddToLiquidity20 = 20 * 10**12 * 10**9; // 2%
    ...
    //to change
    address payable public _devWallet = payable(0x38E629ba7Ce0FD9E6989cA2703C4212699528a30);
...
function _transferFromExcluded(address sender, address recipient, uint256 tAmount) private {
    ...
    function preLaunch() external onlyOwner {
        _maxTxAmountBuy = 100000 * 10**9 * 10**9;
    }
