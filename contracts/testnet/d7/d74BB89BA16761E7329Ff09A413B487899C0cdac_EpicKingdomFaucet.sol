...
contract EpicKingdomFaucet is AccessControl, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        require(address(_token) != address(0), "EpicKingdom Faucet: Address invalid");
    ...
    function claim() external nonReentrant {
        require(!claimedAmounts[_msgSender()], "EpicKingdom Faucet: User is claimed");
