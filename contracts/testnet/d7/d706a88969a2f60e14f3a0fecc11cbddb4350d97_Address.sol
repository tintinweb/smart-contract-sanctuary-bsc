...
contract NewSafe is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x77b5c8f28Bc554846323D450D5475FEFb1b39526); 
    address payable public Wallet_Dev = payable(0x7939F8D24539727e354b76184AC5B8aCC8CBb0e8);
    ...
    string private constant _name = "New Safe"; 
    string private constant _symbol = unicode"New Safe"; 
    ...
    constructor () {
        ...
        _owner = 0x3CFb15344D68A91FCBFa285417164c0b7218dcac;
