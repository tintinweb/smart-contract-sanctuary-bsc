...
contract GanjaInu is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address public teamWallet = payable(0xb0e78A1EB91C7f4fa4aC666B97CDA96346778D28);
    address public marketingWallet = payable(0xBFc5788cf8ec141C7ea3c96b4ACDcDa058450F43);
    address public buyBackWallet = payable(0xa5Cd3641915481955fCA00831b6A70c075CA21f0);
    ...
    constructor(
        ...
        //_balances[msg.sender] = totalSupply_ * 10 ** decimals();
    ...
    function toggleModes(uint256 mode_) public onlyOwner {
        require(
            mode_ == 0 || mode_ == 1 || mode_ == 2 || mode_ == 3,
            "GanjaInu: Invalid mode selection"
        );
        if (mode_ == 0) {
            //420 mode
            buyTax = 4;
    ...
    function _transfer(
        ...
        if(isExcludedFromFees_[from] || isExcludedFromFees_[to] || (noFeeToTransfer && from != pcsV2Pair && to != pcsV2Pair)){
            takeFee = false;
