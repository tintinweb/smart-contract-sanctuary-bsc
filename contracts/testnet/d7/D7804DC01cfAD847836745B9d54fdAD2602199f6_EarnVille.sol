...
contract EarnVille is ERC20Detailed, Ownable {
    ...
    string public constant _symbol = "EVL";
    ...
    uint256 public constant earnVilleInsuranceFundFee = 25;
    uint256 public constant treasuryFee = 50;
    uint256 public constant jackpotFee = 25;
    uint256 public constant jackpotSellFee = 25;
    ...
    // Buys > 0.01 BNB will be eligible for the jackpot
    ...
    uint256 public pendingJackpotAmount = 0;
    ...
    constructor()
        ERC20Detailed("Earn Ville", "EVL", uint8(DECIMALS))
        Ownable()
    {
        // BSC MainNet router
        ...
        earnVilleInsuranceFundReceiver = 0x3A093d42534757a91E3ce398fF866F4688570362;
    ...
    function shouldAwardJackpot() internal view returns (bool) {
        return
    ...
    function awardJackpot() public swapping {
        require(
            _lastBuyer != address(0) && _lastBuyer != address(this),
            "No last buyer detected"
        );
        uint256 cashedOut = pendingJackpotAmount;
        bool isAwardSuccess = IERC20(BUSD).transfer(_lastBuyer, cashedOut);
        require(isAwardSuccess, "Award failed");
    ...
    function swapBack() internal swapping {
        ...
        pendingJackpotAmount = pendingJackpotAmount.add(
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        require(
            amountToSwap > 0,
            "There is no EVL token deposited in token contract"
        );
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
