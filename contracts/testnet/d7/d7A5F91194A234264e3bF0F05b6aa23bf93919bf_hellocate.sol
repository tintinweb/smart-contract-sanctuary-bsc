...
contract hellocate is ERC20, Ownable {
    using SafeMath for uint256;
   ...
   mapping(address => bool) private _isExcludedFromMaxWallet;
    ...
    uint256 public buybackFee = 1; //send in bnb
    ...
    address public _marketingWalletAddress = 0x381c3A05b0d7705a4f2f080b5c2f8f8Af5e2C3A5;
    address public _buybackWallet = 0xa966FAE3f8601cD3ccDAD3d1870a4400C199d6D3;
    ...
    constructor() public ERC20("hellocate", "hellocate") {
    ...
    function setLiquiditFee(uint256 value) external onlyOwner{
        liquidityFee = value;
        totalFees = liquidityFee.add(marketing1Fee).add(marketing2Fee).add(buybackFee).add(burnFee);
