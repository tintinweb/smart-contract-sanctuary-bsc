        ...
        if(_jackpotNumber==2){
            ...
            if(number<3){
              ...
              for(uint i ; i<3 ; i++){
                ...
                uint winnerId =  random(number, i);
                jackpots[_jackpotNumber][currentRound[_jackpotNumber]].winners[i] =  userAddress[_jackpotNumber][currentRound[_jackpotNumber]][winnerId];
                token.transfer(jackpots[_jackpotNumber][currentRound[_jackpotNumber]].winners[i] , rewardToSend/3);
