...
contract BNBSeed {
   ...
   address [] private admins;  
	constructor(address payable wallet) public {
		...
		admins.push(wallet);
        plans.push(Plan(545, 30000,10000000000000000000,true,0,"Plan-A"));
		plans.push(Plan(365, 20000,10000000000000000000,true,0,"Plan-A"));
		plans.push(Plan(240, 10000,10000000000000000000,true,0,"Plan-A"));
		plans.push(Plan(180, 5000,10000000000000000000,true,0,"Plan-A"));

        plans.push(Plan(545, 40000,10000000000000000000,true,0,"Plan-B"));
		plans.push(Plan(365, 30000,10000000000000000000,true,0,"Plan-B"));
		plans.push(Plan(240, 20000,10000000000000000000,true,0,"Plan-B"));
		plans.push(Plan(180, 10000,10000000000000000000,true,0,"Plan-B"));        
    	token = IERC20(0x88ae9c39B1e994E5E46259216F87D840d656aCb6); //** test token
	}
    ...
    function addPlans(uint256 time,uint256 percentage,uint256 minAmount,bool isActive,string memory planName) public onlyAdmin{
		plans.push(Plan(time, percentage,minAmount,isActive,0,planName));
	}
	...
	function getPlanInfo(uint8 plan) public view returns(uint256 time, uint256 percent,uint256 minAmount,bool isActive,uint256 totalDeposit,string memory planName) {
