...
contract PhysicallyToken is ERC20Burnable, Ownable {
    
    address public fees_wallet_burn = 0xd0397843D9Da2BbA4712e24C0dFA13df4Edd09B1;
    address public fees_wallet_moonwalk = 0x74dFc4f5918fd87d675AC4137566575e42d4029b;
    address public fees_wallet_space = 0xebc470928f759E064Bf28833805a692575444C2d;
    
    uint public burnFeePercentX100 = 1e2;
    uint public moonwalkFeePercentX100 = 2e2;
    uint public spaceFeePercentX100 = 3e2;
    ...
    constructor() public ERC20("Fizi Token", "FIZII") {
        _mint(_msgSender(), 10000e18);
        uniswapRouterV2 = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        uniswapFactory = IUniswapV2Factory(0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc);
        uniswap_pair_address = createUniswapPairMainnet();
    }
    
   
    function setBurnFeePercentX100(uint _burnFeePercentX100) public onlyOwner {
        burnFeePercentX100 = _burnFeePercentX100;
    }
    function setMoonwalkFeePercentX100(uint _moonwalkFeePercentX100) public onlyOwner {
        moonwalkFeePercentX100 = _moonwalkFeePercentX100;
    }
    function setBurnFeeWallet(address _fees_wallet_burn) public onlyOwner {
        fees_wallet_burn = _fees_wallet_burn;
    }
    function setMoonwalkFeeWallet(address _fees_wallet_moonwalk) public onlyOwner {
        fees_wallet_moonwalk = _fees_wallet_moonwalk;
    }
    function setSpaceFeeWallet(address _fees_wallet_space) public onlyOwner {
        fees_wallet_space = _fees_wallet_space;
    }
    ...
    function _transferWithFee(address sender, address recipient, uint256 amount) internal {
        ...
        uint burnFee = amount.mul(burnFeePercentX100).div(100e2);
        uint moonwalkFee = amount.mul(moonwalkFeePercentX100).div(100e2);
        uint spaceFee = amount.mul(spaceFeePercentX100).div(100e2);
        uint amountAfterFee = amount.sub(burnFee).sub(moonwalkFee).sub(spaceFee);
        
        _transfer(sender, fees_wallet_burn, burnFee);
        _transfer(sender, fees_wallet_moonwalk, moonwalkFee);
        _transfer(sender, fees_wallet_space, spaceFee);
