...
// Telegram: https://t.me/GoldenDogeInu
...
contract Gold is IBEP20, Auth {
    ...
    string constant _name = "GOLDOGE INU";
    string constant _symbol = "$GOLDOGEINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 400000000000000  * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 100; 
    uint256 public _maxWalletSize = 400000000000000  * (10 ** _decimals);
    ...
    address public marketingFeeReceiver = 0x087799C921b87Af8b425560B881046982683a459;
    address public devFeeReceiver = 0xb37aFac94D502D3dF8D66b27ad16cf6FA8D57EfF;
    ...
    function swapTokensForEth(uint256 tokenAmount,address to) private swapping {
		address[] memory path = new address[](2);
		path[0] = address(this);
		path[1] = WBNB;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner {
    ...
    function createLiquidityPair() external onlyOwner {
		...
		IBEP20(pair).approve(address(router), type(uint).max);
	}
