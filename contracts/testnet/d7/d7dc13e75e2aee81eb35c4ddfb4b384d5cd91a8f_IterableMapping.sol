...
contract Aquacoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Aquacoin", "AQC") {
        ...
        marketingWallet = address(0x9B57085d97D11545221599470953553CC7E2DD4c);
    ...
    function swapAndSendDividends(uint256 tokens) private {
        ...
        uint256 btcBalance = IERC20(USDT).balanceOf(address(this));
        ...
        success = IERC20(USDT).transfer(marketingWallet, marketings);
        if (success) {
