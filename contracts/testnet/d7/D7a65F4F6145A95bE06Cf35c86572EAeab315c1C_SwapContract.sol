...
contract SwapContract is Ownable {
    ...
    constructor(IPancakeRouter _router) {
        router = _router;
    }
...
//        uint value = msg.value;
        amounts = router.getAmountsOut(msg.value, path);
        require(amounts[1] > 0, "Require amount [1] > 0");
//        for(uint i = 0; i < 1000; i++) {
//            amounts = router.getAmountsOut(value, path);
//            if(amounts[1] > 0) {
//                break;
//            }
//        }
    ...
    function withdrawToken(address token, address to)public  onlyOwner  {
        ...
        erc20.transferFrom(address (this), to, erc20.balanceOf(address(this)));
    }
}
