...
contract WinBinary is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        uint256[3] memory feeSettings, // rewards, liquidity, jackpot
    ...
    function _transfer(
        ...
        if (
            ...
            _approve(address(this), address(uniswapV2Router), jackpotTokens);
    ...
    function swapETHForTokensAndBurn(uint256 ethAmount)
        public
    ...
    function burn(uint256 amount) public {
        ...
        super._transfer(msg.sender, DEAD_ADDRESS, amount);
    }
