...
contract VELAToken is ERC20, ERC20Burnable, ERC20Snapshot, AccessControl, Pausable {
    bytes32 public constant SNAPSHOT_ROLE = keccak256("SNAPSHOT_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");

    constructor() ERC20("VELA Token", "VELA") {
    ...
    */
    function rescueStuckErc20(address _token) external whenNotPaused onlyRole(DEFAULT_ADMIN_ROLE) {
