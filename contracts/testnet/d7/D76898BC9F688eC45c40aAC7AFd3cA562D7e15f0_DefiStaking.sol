...
contract DefiStaking is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function GetPercentage(uint256 userAmount, uint256 userTotalStakedAmountTest) private pure returns (uint256){
        uint256 divide = userAmount * 100;
        uint256 percent = divide / userTotalStakedAmountTest;
        return percent;
    }
