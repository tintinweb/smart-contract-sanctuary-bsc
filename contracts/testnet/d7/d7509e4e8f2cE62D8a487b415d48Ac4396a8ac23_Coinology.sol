...
contract Coinology is ERC20, Ownable {
    ...
    uint256 public  marketingTaxOnBuy = 3;
    uint256 public  marketingTaxOnSell = 3;
    ...
    constructor (address router_)ERC20("Coinology",  "OLOGY"){  

        _mint(owner(), 100_000_000 * (10 ** 18));

        marketingWallet = 0xB6B7e1A0E991483F9B81520216ebFDb8785B7BC6; // Address to collect marketing taxes in BNB
