...
contract NewBlockchainCoin is ERC20Interface , Ownable{
    string public name = "New Blockchain Coin";
    ...
    constructor(uint256 _taxAmount, address _taxWallet) {
        totalSupply = 120000000 * 10 ** decimals;
        founder = msg.sender;
