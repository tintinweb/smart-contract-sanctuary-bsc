...
contract Marblef1{
    ...
    address public betbAddress; // address of the betb token
    bool public pause;
    ...
    constructor(address payable _ecoSystemAddress, uint256 _ecoSystemFeePercentage, address _betbAddress){
    ...
    function createRace(uint256[] memory _marbleIds, uint256 _raceTime, uint256 _racePrice) public whenNotPaused onlyAdminOrOperator {
        ...
        uint256[] memory bets;
        uint256[] memory _distinctMarbleIds = _marbleIds;
        ...
        races.push(Race(marblesInRace, false, _raceTime, _raceTime + intervalSeconds, _raceTime + (2 * intervalSeconds), bets, -1, 0, _racePrice));
