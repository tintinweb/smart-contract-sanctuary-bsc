...
//    address public REWARD = 0x55d398326f99059fF775485246999027B3197955;
    ...
    string constant _name = "TESTOKENv4";
    string constant _symbol = "TESTOKENv4";
    ...
    function updateBuyFees(
        ...
        require(buyTotalFees <= 250, "Total Fee must be less than 25%");
    }
    ...
    function updateSellFees(
        ...
        require(sellTotalFees <= 250, "Total Fee must be less than 25%");
    }
    ...
    function swapBackInBnb() internal swapping {
        uint256 totalFees = buyTotalFees.add(sellTotalFees);
        uint256 totalLiquidityFee = buyLiquidityFee.add(sellLiquidityFee);
        uint256 totalMarketingFee = buyMarketingFee.add(sellMarketingFee);
        uint256 totalCharityFee = buyCharityFee.add(sellCharityFee);     
        uint256 totalDividendRewardsFee = buyDividendRewardsFee.add(sellDividendRewardsFee);
    ...
    function swapAndSendFees(uint256 tokensForFee) private {
        uint256 totalSwapFee = buyMarketingFee.add(buyDevFee).add(buyCharityFee)
                               .add(sellMarketingFee).add(sellDevFee).add(sellCharityFee);
        uint256 totalMarketingFee = buyMarketingFee.add(sellMarketingFee);
        uint256 totalCharityFee = buyCharityFee.add(sellCharityFee);        
