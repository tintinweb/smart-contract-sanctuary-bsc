...
contract Stake is Ownable {
    ...
    function deposit(uint256 amount) public {
        ...
        stakeData[msg.sender] =
            stakeData[msg.sender] +
            (amount * (100 - fee)) /
            100;
        // _tokenAddr.transferFrom(msg.sender, address(this), amount);
        IERC20(_tokenAddr).transfer(_ceoAddr, ((amount * fee) / 100));
    }

    function withdraw(uint256 amount) public {
        // require(
        //     stakeData[msg.sender] >= amount,
        //     "Can not withdraw more than stake amount"
        // );
    }
