...
pragma solidity 0.5.16;
  ...
  contract MyCoin is Context, IBEP20, Ownable {
    ...
    uint256 private globalLoss = 1e22;
    uint256 private globalGain = 1e22;
    uint256 private decreaseRate = 5000;
    uint256 private w = 14000;
    uint256 private v = 7;
    uint256 private l = 30000;
    uint256 private N;
    ...
    function nextIncrease(uint256 R) internal view returns (uint256) {
      ...
      uint256 temp = (R - c);
      if(temp > c) temp = c;      
      uint256 i = temp * (getNow() - lastUpdate) * l / 10000000000000;
      if(R + i >= R) return i; 
      return 0;
    }
