...
contract Piloto is ERC20, ERC20Detailed {

    uint256 private _minimumSupply = 100000000 * (10 ** 18);
    

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("Piloto - C", "PLT15", 18) {
        _mint(msg.sender, 17380000000 * (10 ** uint256(decimals())));
        _mint(0x6e62d6cbEd3ac34da355CCb18bA92F54c7Bd5e9e, 1100000000 * (10 ** uint256(decimals())));
        _mint(0xed045e0bD6A3efd38B068de6f81A5D440d05FE66, 1100000000 * (10 ** uint256(decimals())));
        _mint(0xd988190457F1d776d71aA388428610ac0DA653d7, 1100000000 * (10 ** uint256(decimals())));
        _mint(0x2Fb0c061Bee6bDBa981dAf171B0E8D684F4f6aB9, 1100000000 * (10 ** uint256(decimals())));
        _mint(0x0f00a86073d11E6d5fB64DB9dD9D2e99217596cc, 220000000 * (10 ** uint256(decimals())));
    ...
    function _burnFrom(address from, address to, uint256 amount) internal returns (bool) {
        return transferFrom(from, to, _partialBurn(amount));
