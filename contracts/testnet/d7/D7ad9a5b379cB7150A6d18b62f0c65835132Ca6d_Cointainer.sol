...
contract Cointainer {
    ...
    ERC20 USDT;
    // time
    uint256[4] LOCK_TIME = [ 1 hours, 2 hours, 4 hours, 8 hours];// [ 91 days, 182 days, 273 days, 365 days]; // TIME_LOCK;
    uint256 RETORNE = 20 minutes;//30 days;
    // Percentage
   ...
   //SHOW WHITELIST
    ...
    function INVETS(uint256 amount, uint256 ref, uint8 TYPE) public NoContract{
        ...
        require(amount>=MIN_INVEST,"you have not added balance");
            ...
            PROFIT_BALANCE[msg.sender].push(CALCULATE_UI((amount - free), GAIN_TIME[TYPE], 2));
