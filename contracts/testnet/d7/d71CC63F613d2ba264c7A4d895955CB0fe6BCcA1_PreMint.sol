...
contract PreMint is Pausable {
  uint256 public _premintAmount = 0.02 ether;
  uint256 public _gearPremintAmount = 0.01 ether;
  ...
  function mintNewGears(uint256 qty, uint256 gearType) public whenNotPaused {
    // Check busd balance
    uint256 tokenBalance = IERC20(_tokenContract).balanceOf(msg.sender);
    uint256 tokenAmountToPay = qty * _gearPremintAmount;
   ...
   */
  function setPremintAmount(uint256 amount) public onlyAdmin {
