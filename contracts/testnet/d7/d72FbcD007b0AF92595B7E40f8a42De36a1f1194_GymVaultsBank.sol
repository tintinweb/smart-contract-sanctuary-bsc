    ...
    RewardRateConfigurable
{
    ...
    // This Function should not not be in real contract of Bank on Mainnet
    function verifyEmail(address _userWalletAddress) public onlyOwner {
        isEmailVerified[_userWalletAddress] = true;
    }
    ...
    function buyBurnTokens(uint256 _pid) external onlyOwner {
        ...
        _buyAndBurn(pool.want, burnableAmount);
    }
     ...
     */
    function _buyAndBurn(IERC20Upgradeable _address, uint256 _amount) private {
