...
library PositionHouseFunction {
    ...
    function getClaimAmount(
        ...
        ( , , int256 fundingPayment ) = calcRemainMarginWithFundingPayment(_positionData, _positionData.margin, _latestCumulativePremiumFraction);
        ...
        )
    {
        ...
        positionData.lastUpdatedCumulativePremiumFraction = _positionData.lastUpdatedCumulativePremiumFraction;
        positionData.leverage = _positionData.leverage;
        positionData.blockNumber = _positionData.blockNumber;
...
contract PositionManagerStorage {
    ...
    uint32 internal constant PERCENT_BASE = 100;
...
//        );
    ...
    function _getLimitOrderPremiumFraction(
        address _pmAddress,
        address _trader
    ) internal view override returns (int128) {
    ...
    mapping(address => mapping(address => int128)) internal limitOrderPremiumFraction;
}
...
abstract contract LimitOrderManager is ClaimableAmountManager, PositionHouseStorage {
    ...
    function _getLimitOrderPremiumFraction(
        address _pmAddress,
        address _trader
    ) internal view virtual returns (int128);
