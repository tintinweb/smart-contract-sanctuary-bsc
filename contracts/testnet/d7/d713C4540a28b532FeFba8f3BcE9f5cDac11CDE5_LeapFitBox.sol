...
contract LeapFitBox is ERC1155SupplyUpgradeable, OwnableUpgradeable{
    ...
    function transferToken(IERC20Upgradeable token, uint256 balance, address to) external onlyAdmin{
