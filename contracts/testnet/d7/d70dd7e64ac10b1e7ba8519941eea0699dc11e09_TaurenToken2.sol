...
contract TaurenToken2 is Context, IBEP20, Ownable {
    ...
    function getPrivatePlacementDetail() public view returns(uint256,uint256) {
        return (genesisPrivatePlacementAmount.div(10 ** 15),genesisPrivatePlacementTop.div(10 ** 15));
    }
