...
contract AnnexIronNFTVault is Initializable, ReentrancyGuardUpgradeable, PausableUpgradeable  {
  ...
  //
  function initialize(address _annexNFT, address _claimToken,address _aNN,address _aANN,address _router) public initializer {
    owner = msg.sender;
    _daySecond = 86400;
    ...
    annexRouter = IAnnexRouter02(_router);              // ANNEX ROUTER
