...
contract PositionBondFactory is BondFee, ReentrancyGuard, Ownable {
    ...
    function issueBond(
        ...
        PositionBondLending positionBond = new PositionBondLending(
            bondInformation,
            assetInformation,
            issuer
        );
        ...
        if (assetInformation.underlyingAssetType == 0) {
            ...
            ).balanceOf(address(positionBond));
        }
        ...
        positionBond.initialize(
            positionBondFunction,
            chainLinkPriceFeed,
            positionAdmin,
            bondFee,
            assetInformation.collateralAmount
        ...
        require(positionBond.isNotReachMaxLoanRatio(), "!LTV");
    ...
    ReentrancyGuard
{
    ...
    function initialize(
        ...
        positionAdmin = positionAdmin_;
        fee = fee_;
        UnderlyingAssetLending.updateUnderlyingAmount(collateralAmount_);
    }
    ...
    function _bondTransferable()
        internal
        override(BondUnit, BondStatusLending)
        returns (bool)
    {
