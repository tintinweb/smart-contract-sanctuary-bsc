...
contract VOLT is Context, IERC20, Ownable {
    ...
    address _creator;
    address public marketingAddress = 0xf29a323a0704A8f436631F29cbfFD2A3AA314A05; // Marketing Address
    address public burningAddress = 0x0000000000000000000000000000000000000000; // burn Address
    address public devAddress = 0xC6CaA85C4f56aF5B766bb480142a4c3C95952A86; // Dev Address
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // -4
        transferForMarketingETH(payable(marketingAddress), transferredBalance.div(2));

        uint256 initialBalanceAfterMarket = address(this).balance;

        // Send to Treasury Address -4
        transferForMarketingETH(payable(devAddress), initialBalanceAfterMarket);
    }
