    ...
    AccessControlUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        excludeFromMaxWalletLimit(msg.sender, true);
        excludeFromMaxWalletLimit(taxWallet, true);
        ...
        onlyRole(OPERATOR_ROLE)
    {
        require(
            ...
            "ExcludeFromMaxWalletLimit:: Already excluded from Maxwallet limit"
        );
        _isExcludedFromMaxWalletLimit[account] = excluded;
    ...
    function setTaxWallet(address _newTaxAddress)
        public
        onlyRole(OPERATOR_ROLE)
    {
        taxWallet = _newTaxAddress;
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(
            ...
            "BeforeTokenTransfer:: Blacklisted address"
        );

        if (!_isExcludedFromMaxWalletLimit[to]) {
            require(
                balanceOf(to) + amount <= maxWalletBalance,
                "BeforeTokenTransfer:: Max wallet balance exceed"
            );
        }

        bool isExcludedFromFee = true;
        ...
        if (isExcludedFromFee) {
            ...
            super._beforeTokenTransfer(from, taxWallet, taxAmount);
            emit TaxPayed(from, taxWallet, taxAmount);
