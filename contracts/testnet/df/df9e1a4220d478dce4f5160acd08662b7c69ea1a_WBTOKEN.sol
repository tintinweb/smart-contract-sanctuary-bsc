...
contract Ownable is Context {
    ...
    constructor() {
        _owner = payable(0xabc4B357D7419cfD3747DC1338e9e6308612D87c);//main
...
contract WBTOKEN is Context, IBEP20, Ownable {
    ...
    address payable public marketWallet =
        payable(0xabc4B357D7419cfD3747DC1338e9e6308612D87c);
    ...
    function StartTrading() external onlyOwner {
        ...
        tradingOpen = true;
        // buy tax fee
        redistributionFeeOnBuying = 30; // 3% will be distributed among holder as token divideneds
        liquidityFeeOnBuying = 40; // 4% will be added to the liquidity pool
        marketingwalletFeeOnBuying = 30; // 3% will go to the marketingwallet address

        // sell tax fee
        redistributionFeeOnSelling = 30; // 3% will be distributed among holder as token divideneds
        liquidityFeeOnSelling = 40; // 4% will be added to the liquidity pool
        marketingwalletFeeOnSelling = 30; // 3% will go to the market address

        // normal tax fee
        redistributionFee = 30; // 3% will be distributed among holder as token divideneds
        liquidityFee = 40; // 4% will be added to the liquidity pool
        marketingwalletFee = 30; // 3% will go to the market address
    }
