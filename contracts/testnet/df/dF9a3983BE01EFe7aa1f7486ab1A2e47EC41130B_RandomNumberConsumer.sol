...
contract RandomNumberConsumer is VRFV2WrapperConsumerBase,ConfirmedOwner {
    ...
    // function.
    uint32 callbackGasLimit = 1000000; //2500000 - 40000
    ...
    // Address LINK - BscTestnet LINK Token
    address linkAddress = 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06;

    // address WRAPPER - BscTestnet VRF Wrapper
    ...
    function requestRandomWords() external returns (uint256 requestId) {
        require(msg.sender == governance.lottery() || msg.sender == owner(), "request not allowed.");
    ...
    function fulfillRandomWords(uint256 _requestId, uint256[] memory _randomWords) internal override {
        ...
        lottery_interface(governance.lottery()).fulfill_random(_randomWords[0]);
