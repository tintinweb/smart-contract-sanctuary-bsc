...
contract Intento2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Intento2";
    string private _symbol = "WC";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0xCdD7a5Ebea2EeA145509e1af3d7A6Fe3f258b18A);
