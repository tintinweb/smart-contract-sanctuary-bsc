...
contract TOKEN_Staking is Ownable {
	...
	address public constant TOKEN = 0x4DeE6Cbf0E65eC546Fe762928EEa2c95a0c35F81; //token to stake

	//STAKING PARAMETERS
	uint256 public constant stakingPeriod = 1 days; //period over which tokens are locked after staking
	uint256 public stakingEnd; //point after which staking rewards cease to accumulate
	uint256 public rewardRate = 10; //14% linear return per staking period
	uint256 public totalStaked; //sum of all user stakes
	uint256 public maxTotalStaked = 40000000000000 * 10**18;
	uint256 public minStaked = 400000000000 * 10**18;
