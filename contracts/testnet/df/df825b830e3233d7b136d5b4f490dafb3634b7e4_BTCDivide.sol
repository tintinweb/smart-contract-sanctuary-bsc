...
contract BTCDivide is Context, IBEP20, Ownable {
    ...
    address payable public marketingWallet = payable(0x1211C4E63C675274FA57810622d261a233666666);

    string private _name = "BTCDivide";
    string private _symbol = "BTCDivide";
    ...
    uint256 public _maxWalletHoldingAmount = 10000000 * 10**18;
