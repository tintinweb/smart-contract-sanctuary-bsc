...
contract DuckSender {
   ...
   receive() external payable {
	...
	function multisendEther(address[] memory _contributors, uint[] memory _balances) external payable {
	...
	function multisendToken(address token, address[] memory _contributors, uint[] memory _balances) external payable {
