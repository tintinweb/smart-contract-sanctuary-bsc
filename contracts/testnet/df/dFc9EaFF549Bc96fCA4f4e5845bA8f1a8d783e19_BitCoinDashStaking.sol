    ...
    OwnableUpgradeable
{
    ...
    //user functions
    function rentMiner(address referral)
        public
        nonReentrant
    {
        ...
        uint256 referralBonus = onePercentFee * (25);
        ...
        private
    {
        ...
        if (user.referrer != address(0)) {
            ...
            for (uint256 i = 0; i < REF_BONUSES.length; i++) {
                ...
                uint256 amount = referralBonus * (REF_BONUSES[i]) * (4);
    ...
    function feedMiner(uint256 _minerIndex)
        public
        nonReentrant
    {
    ...
    function viewUserEarningByAddress(address _userAddress)
        public
        view
        onlyOwner
        returns (
