...
contract ROI {
    ...
    constructor() {
        ...
        // owner = _owner1;
        // dev = _dev;
        owner = (0xf6524C80574268B85a1a3513ccE2850E9E2d5E97);
        project = (0x76FE6d023e50d14C35D20515CcbF401dA0e81B96);
        dev = (0xb27A5715DeE0B91CC60da06c1bb860aBa44DB804);
    }
    ...
    function invest(address referrer, uint256 _amount) public {
        ...
        }else if (users[referrer].deposits.length == 0 && user.referrer == address(0)) {
            referrer = owner;
    ...
    function withdraw() public {
        ...
        if (users[user.residualbonusreceiver].directs.length >= 5 && Active(user.residualbonusreceiver)) {
