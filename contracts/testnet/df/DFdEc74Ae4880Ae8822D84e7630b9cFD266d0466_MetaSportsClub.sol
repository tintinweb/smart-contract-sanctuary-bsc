    ...
    ReentrancyGuard
{
    ...
    uint256 public salePrice = 8 ether;
    uint256 public mintPrice = 4 ether;
    uint256 public rewardRate = 20;
    uint256 public rewardMinted = 0;
    ...
    event BuyMST(address user, uint256 amountIn, uint256 amountOut);
    event Reward(
        address user,
        address club,
        address inviter,
    ...
    function createClub(uint256 _clubId, uint256 _clubRewardRate)
        external
        nonReentrant
        whenNotPaused
    {
    ...
    function addMintInfo(
        ...
        mintInfos.push(MintInfo(_maxBuyByDay, _startTime, _endTime, 0));
    }
