...
// all initialize parameters are mandatory
    function initialize(
        ...
        ggymnetAlloc = [76923076920000000, 90909090910000000, 105263157900000000, 125000000000000000, 153846153800000000, 200000000000000000]; // GGYMNET ALLOCATION AMOUNT
    ...
    */
    ...
    function pendingReward(uint256 _depositId, address _user) public view returns (uint256) {
        ...
        return (depositDetails.ggymnetAmt * _accRewardPerShare) / (1e18) - (depositDetails.rewardDebt);
    }
    ...
    function _updateLevelPoolQualification(address wallet) internal {
        uint256 userLevel = IGymMLMQualifications(mlmQualificationsAddress).getUserCurrentLevel(wallet);
