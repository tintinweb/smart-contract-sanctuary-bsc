...
contract PsyBulls is ERC721Base {
    ...
    uint256 public immutable presaleMaxSpots = 500;
    ...
    function mintPresale(uint256 _amount) external payable onlyWhitelisted {
        require(saleIsActive, "Mint not started yet");
        require((block.timestamp - presaleStartedAt) < presaleDuration, "Presale ended");
    ...
    function presaleIsActive() external view returns (bool) {
        return saleIsActive 
            ...
            && (block.timestamp - presaleStartedAt) < presaleDuration;
    }
