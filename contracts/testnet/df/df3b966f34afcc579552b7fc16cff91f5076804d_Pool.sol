...
contract Pool is Ownable {
    ...
    constructor(
        ...
        stakeToken = IERC20(_stakeTokenAddr); //0x789e1dfC67f3411bBdF2A3E79A167Be628415664 //0xd9dE2B1973E57Dc9DBA90c35d6Cd940ae4A3CBe1
    ...
    function stake(uint256 _amount) external {
        ...
        require(!shareForWhite[msg.sender], "sender is white");
    ...
    function getBalance(address _addr) external view returns (uint256) {
        return stakeToken.balanceOf(_addr);
    }

    function getShare(address _addr) external view returns (uint256) {
        return shares[_addr];
    }

    function getShareTime(address _addr) external view returns (uint256) {
        return shareTime[_addr];
    }
