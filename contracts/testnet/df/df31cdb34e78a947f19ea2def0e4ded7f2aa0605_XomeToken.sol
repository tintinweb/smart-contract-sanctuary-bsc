...
contract XomeToken is BEP20('Xome', 'XOME') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "XOME::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "XOME::delegateBySig: invalid nonce");
        require(now <= expiry, "XOME::delegateBySig: signature expired");
