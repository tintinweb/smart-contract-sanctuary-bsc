...
contract Marketplace1155 is ERC1155HolderUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function cancel(uint256 listingId) external {
        ...
        emit ListingCanceled(listingId, msg.sender, listings[listingId].tokenAmount);
    }
    ...
    function _buy(uint256 listingId_, uint256 amount_) private {
        ...
        emit ListingBought(listingId_, msg.sender, listings[listingId_].seller, amount_, listings[listingId_].minimalBid.mul(amount_));
    }
    ...
    function _bid(uint256 listingId, uint256 amount) private {
        ...
        emit ListingBid(listingId, msg.sender, listings[listingId].seller, listings[listingId].tokenAmount, amount, listings[listingId].timeEnd);
    }
