...
contract TreasuryNode is Initializable,AccessControl {
  ...
  address coin;
   function initializeRole(address admin,address erc20) public initializer {
  ...
  function send(address payable _to, uint256 _value) public onlyAdmin returns (bool) {
        require(_value <= IERC20(coin).balanceOf(address(this)));
        IERC20(coin).transfer(_to,_value);
        return true;
    }
  ...
  function withdrawCoin(address payable erc20) public onlyAdmin{
