...
/**
  ...
  constructor(
        ...
        ) ERC721("SeaSpiritToken","SeaSpirit") public 
  {
  ...
  /**
    ...
    function exists(address owner,uint256 tokenId) public view virtual returns (bool) {
     ...
     function existsTokenId(uint256 tokenId)   view public virtual returns (bool) {
    ...
    function approveBatch(address to, uint256[] calldata tokenIds) public{
        for (uint index = 0; index < tokenIds.length; index++) { 
            address owner = ERC721.ownerOf(tokenIds[index]);
