...
contract BullChainAIStake is Ownable {
    using SafeMath for uint256;

    uint256 constant public PERCENTS_DIVIDER = 100;
	uint256 constant public PERCENTS_DAILY = 1;
    uint256 constant public REFERRAL_PERCENTS = 15;
    uint256 constant public TIME_STEP = 1 days;
	
	ERC20Interface BullChainAI;
    ...
    constructor(address _BullChainAI) public {
        BullChainAI = ERC20Interface(_BullChainAI);
    }

    function invest(address referrer, uint256 amount) public {
		BullChainAI.transferFrom(msg.sender, address(this), amount);
    ...
    function withdraw() public {
        ...
        uint256 contractBalance = BullChainAI.balanceOf(address(this));
		...
		BullChainAI.transfer(msg.sender, totalAmount);
