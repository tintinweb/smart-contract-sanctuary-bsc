...
contract TheMemes is ERC20, ERC20Burnable, Ownable, Pausable, EmergencyGuard {
    ...
    uint256 internal constant MAX_TOKEN_ALLOWED_TO_BUY_PER_WALLET = 20000000000000000000000000;

    // Allowed token Threshold
    uint256 internal constant ALLOWED_TOKEN_THRESHOLD = 500000000000000000000000;

    // Max token allowed to buy/sell per transaction
    uint256 public maxTransactionAllowed = 10000000000000000000000000;
    ...
    // Max Fees To sell
    uint256 public maxFeesToSell = 500000000000000000000000;
    ...
    * @param user address of the user than will now have to pay transaction fees.
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        return handleTransfer(_msgSender(), recipient, amount);
    }
    ...
    function handleTransfer(address from, address to, uint256 amount) private returns (bool) {
        ...
        //In the first minutes of launch the recipient can buy up to 500K Tokens
