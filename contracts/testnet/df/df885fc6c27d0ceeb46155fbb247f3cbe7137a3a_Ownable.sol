...
Telegram : https://t.me/hexa
Website : https://hexa.xyz/
...
contract Gilanetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "GILANETWORK";
    string private _symbol = "Gila";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDd41852C2Ca3d7e54861Fc3dc04E5De6e07D6bd7);
    address payable public teamWalletAddress = payable(0xDd41852C2Ca3d7e54861Fc3dc04E5De6e07D6bd7);
