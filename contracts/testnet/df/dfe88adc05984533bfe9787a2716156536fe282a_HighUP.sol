...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0x29C03DA9b1077b479455898b6BEC37c747095448;
        _owner = msgSender;
...
contract HighUP is Context, IBEP20, Ownable 
{
    using SafeMath for uint256;
    using Address for address;

    address public marketingWalletAddress = 0xE061BAEb09F1708A3C2297f2cCeC59b824D21919; // Marketing wallet Address.
    ...
    string private _name = "HighUP";
    string private _symbol = "HUP";
    ...
    function updateAllFeePercentages(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee, uint256 burnFee) 
    external onlyOwner() 
    {
        _taxFee = taxFee;
    ...
    function excludeWalletsFromWhales() private 
    {
        ...
        _isExcludedFromWhale[marketingWalletAddress]=true;
