...
contract CactusRewardToken is ERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint256 public cap = 100000000000000000000000000;
    uint256 public airdropCap = 400000000000000000000000;
    ...
    constructor(address _payableAddress) ERC20("Cactus Reward Token", "CRT") {
    ...
    function claim() public payable returns (bool) {
        require(
            ...
            "0.0176 BNB ($5) is required to claim"
        );
        require(
            mintableAirdropTokens >= _airdropToken,
        ...
        mintableAirdropTokens = mintableAirdropTokens.sub(_airdropToken);
