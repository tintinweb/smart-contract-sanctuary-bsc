...
contract OpenBiSeaAuction is Ownable,IERC721Receiver,IERC1155Receiver {
    ...
    function getNFTsAuctionList(address contractNFT) public view returns (AuctionFullData[] memory) {
        ...
        for (uint i=0; i< contractsTokenIdList[contractNFT].length; i++) {
            ...
            seller: contractsPlusTokenIdsAuction[index].seller,
            latestBidder: contractsPlusTokenIdsAuction[index].latestBidder,
            latestBidTime: contractsPlusTokenIdsAuction[index].latestBidTime,
            deadline: contractsPlusTokenIdsAuction[index].deadline,
            price: contractsPlusTokenIdsAuction[index].price,
            token: contractsPlusTokenIdsAuction[index].token,
