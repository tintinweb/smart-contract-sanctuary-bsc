...
contract RealboxVaultFactory is AccessControlEnumerable {
    ...
    function deployVault(
        ...
        require(block.number < _privateStartBlock, 'RealboxVaultFactory: privateStartBlock must be higher than current block');
        require(_privateStartBlock <= _publicStartBlock, 'RealboxVaultFactory: Private sale parameters incorrect');
