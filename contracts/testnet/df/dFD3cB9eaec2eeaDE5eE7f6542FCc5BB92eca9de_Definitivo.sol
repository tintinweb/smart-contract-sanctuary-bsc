...
contract Definitivo is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress = payable(0x15d5A6444A479B1F7E40dAa317Fc13ECb6974Dde); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x15d5A6444A479B1F7E40dAa317Fc13ECb6974Dde); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0xc2379f29457c56C37288c6109249AC6E66A6E355); // charity Wallet Address
    address payable public devWalletAddress = payable(0xbE6c18eb57f932CA3711C899795E8766dA323Dc1); // dev Wallet Address
    ...
    string private constant _name = "Esperemos que este sea el definitivo :(";
