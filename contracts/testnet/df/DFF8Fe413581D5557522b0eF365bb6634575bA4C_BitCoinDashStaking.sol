    ...
    OwnableUpgradeable
{
    ...
    function claimReward() public nonReentrant {
        ...
        uint256 bonusTokenForReward = calculateTokenToDollarsNeeded(
            _bonus * 100
        );
    ...
    function approveContractToSpendToken(uint256 _tokenAmount)
        public
        returns (bool)
    {
        BITD_TOKEN.safeIncreaseAllowance(address(this), _tokenAmount);
        return true;
    }
}
