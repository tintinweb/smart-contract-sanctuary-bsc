 ...
 */
contract BackupAmetaTokenLock {
    using SafeERC20 for IERC20;

    string public name = "Backup Ameta Token Lock";
    ...
    // total lock 30M token
    uint256 public totalAllocation = uint256(30_000_000 * 10**18);
    ...
    function withdraw(uint256 _amount) public {
        ...
        uint256 totalAmount = _unlockedAmount - totalWithdrawn;
        require(totalAmount >= _amount, "TokenLock: over tokens to release");
