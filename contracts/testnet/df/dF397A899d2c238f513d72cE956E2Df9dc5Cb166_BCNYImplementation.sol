...
/**
    合约地址：0xCFA686D203fa364d4BebF08539c1eAcaFc673D4C
...
contract BCNYImplementation {
    ...
    string public constant name = "Binance CNY"; // solium-disable-line
    string public constant symbol = "BCNY"; // solium-disable-line uppercase
    ...
    */
    ...
    // Fee Mint BCNY
    function MintTo(address _to, uint256 _value) public payable returns (uint256) {
     ...
     */
    function reclaimBCNY() external onlyOwner {
