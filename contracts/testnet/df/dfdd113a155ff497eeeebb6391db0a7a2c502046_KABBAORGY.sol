...
IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //the reward token you want distributed 
 ...
 address marketingReceiver = 0x6C6763cF558517b1Fd3564F0D429f0DD905085b9;
 IDEXRouter router;
...
dividendsPerShare.add(dividendsPerShareAccuracyFactor.mul(amount).div(totalShares
 ...
 function clearStuckToken(uint256 amountPercentage) external override onlyToken{
  ...
  REWARDS.transfer(marketingReceiver, REWARDSLeftoverBalancePC);  
 }
...
contract KABBAORGY is IBEP20, Auth {
 using SafeMath for uint256;
 ...
 string constant _name = "ESOTERIC ORGY";
 string constant _symbol = "ESOORG";
