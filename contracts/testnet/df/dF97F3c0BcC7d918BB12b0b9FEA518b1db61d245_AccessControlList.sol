...
contract AccessControlList is OmniteAccessControl {
    constructor(address admin) OmniteAccessControl() {
        ...
        _setupRole(COLLECTIONS_CREATOR_ADMIN_ROLE, admin);
        _setupRole(CONTRACT_FACTORY_ROLE_ADMIN_ROLE, admin);
        ...
        _setRoleAdmin(CONTRACT_FACTORY_ROLE, CONTRACT_FACTORY_ROLE_ADMIN_ROLE);
