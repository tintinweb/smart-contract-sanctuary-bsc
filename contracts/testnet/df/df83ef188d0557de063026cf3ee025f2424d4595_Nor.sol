...
contract Nor is IERC20, Auth {
    using SafeMath for uint256;

    string constant _name = "Nor";
    string constant _symbol = "NOR";
    ...
    uint256 public rudolphFee = 0; // Biggest buy sum
    uint256 public santaFee = 0; // Biggest buy
