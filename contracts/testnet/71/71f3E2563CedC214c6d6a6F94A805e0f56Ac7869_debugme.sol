...
IBEP20(honeyaddress).approve(address(uniswapV2Router), tokenAmount);
// make the swap
...
function excludeFromFee(address addr) public {
...
function testRetour(address sender, address recipient, uint256 amount) public {
