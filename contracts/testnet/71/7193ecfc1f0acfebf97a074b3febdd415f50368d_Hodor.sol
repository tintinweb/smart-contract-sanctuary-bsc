...
contract Hodor is Context, IERC20, Ownable {
    ...
    uint8 public maxLiqFee = 3;                // Transaction fee % that would be used to add liquidity (0-10)
    ...
    uint8 public maxWalletFee = 4;             // Transaction fee % that would be sent to a marketing or charity wallet (0-10)
        
    uint8 public minMxTxPercentage = 5;         // Transaction allowed as % of supply (1-100). Anti-Whale mechanics
