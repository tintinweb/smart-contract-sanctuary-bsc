...
contract PresaleUpgradable is Referral, UUPSUpgradeable {
    ...
    function addReferrerOnlyAdmin(address _referree, address payable referrer)
        external
        onlyOwner
        returns (bool)
    {
    ...
    function ChangeTokenContractAddress(address _address) external onlyOwner {
    ...
    function withdrawOnly() external onlyOwner {
