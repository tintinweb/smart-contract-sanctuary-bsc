...
contract METToken is ERC777, IERC777Recipient {
    ...
    constructor(address[] memory defaultOperators_) ERC777("test MET", "tMET", defaultOperators_) {
        _mint(msg.sender, 5000000000*10**18, "", "", false);
    }
    ...
    function tokensReceived(
      ...
      emit METReceived(operator, from, to, amount, userData, operatorData);
  }
}