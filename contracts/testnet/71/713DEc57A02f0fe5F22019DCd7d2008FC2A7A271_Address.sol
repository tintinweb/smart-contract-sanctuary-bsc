...
contract Alpargata6 is Context, IERC20, Ownable {
    ...
    string private _name = "Alpargata6";
    string private _symbol = "ALP6";
    ...
    constructor (address payable charityWalletAddress) public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xEd1a36D7CE974De5a5A14585CFA8b9472ba52B40);
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xEd1a36D7CE974De5a5A14585CFA8b9472ba52B40, 'We can not exclude Uniswap router.');
