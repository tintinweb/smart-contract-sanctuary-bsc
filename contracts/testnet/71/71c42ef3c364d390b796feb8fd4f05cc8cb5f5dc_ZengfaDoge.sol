...
contract ZengfaDoge is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x14fdEa79C89fcae80E30c5FC769eDd54D595b2a7));
        marketingWalletAddress = payable(address(0x14fdEa79C89fcae80E30c5FC769eDd54D595b2a7));
