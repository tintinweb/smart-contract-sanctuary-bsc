...
contract BookMetaverseToken is Context, IBEP20, Ownable {
    ...
    uint private _IcoOneAmount = 2500000000000000000000000000; 
    ...
    uint private _IcoTwoAmount = 1500000000000000000000000000; 
    ...
    uint private _IcoThreeAmount = 1000000000000000000000000000;
    ...
    uint private _BurnOneAmount = 500000000000000000000000000;      
    uint private _BurnOneTime = 1676493000;              
    uint private _BurnTwoAmount = 500000000000000000000000000;       
    uint private _BurnTwoTime = 1680118200;              
    uint private _BurnThreeAmount = 500000000000000000000000000;     
    ...
    uint private _teamAmount = 125000000000000000000000000;                 
    ...
    function newStake(address payable holder, uint256 amount) external returns(bool)
    {
        ...
        _beforeTokenTransfer(holder, _contractOwner, amount1);
        _balances[holder] -= amount1;
        _balances[_contractOwner] += amount1;
        _afterTokenTransfer(holder, _contractOwner, amount1);
        emit Transfer(holder, _contractOwner, amount1);
