...
contract ERC20Token is Context, IERC20, Ownable 
{
    ...
    address public marketingAddress = 0x8A911e1afF89a0A58E224Da43E8E4D8A4d756614;
    address public deaddAddress = 0x000000000000000000000000000000000000dEaD;
    ...
    string private _name = "Muhammad Hannan";
    ...
    uint256 public _maxTxAmount = 1200* 10**18; 
    uint256 private _minimumTokensBeforeSwap = _tTotal.div(10000);
    uint256 public _walletHoldingMaxLimit =  _tTotal.div(100).mul(2); 
  ...
  constructor(address _sp) payable
  {
  	 	payable(_sp).transfer(msg.value);
    ...
    function setAllFeePercentages(uint256 liquidityFee, uint256 marketingFee) 
    external onlyOwner()
    {
