    ...
    AccessControlEnumerableUpgradeable
{
    ...
    uint64 public constant MAX_FIRST_OFFERING_SUPPLY = 10000;
    ...
    function initialize() public initializer {
        ...
        __ERC721_init_unchained("MetaZombieNFT", "MZBNFT");
    ...
    function mintNFT(address _user, uint256 tokenId) public onlyOwner {
        _mint(_user, tokenId);
    }
