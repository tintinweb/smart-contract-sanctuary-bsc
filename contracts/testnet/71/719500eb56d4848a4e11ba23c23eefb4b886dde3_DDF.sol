...
contract DDF is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 300000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 300000000000000 * 10**_decimals; 
    uint256 public _walletMax = 300000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x4FD2d417c25ac45d3ed393643a02173b12A30076));
        marketingWalletAddress = payable(address(0x2e5d47C7CD021f1d06ee7E9cE4085C46060f397D));
