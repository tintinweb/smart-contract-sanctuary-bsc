...
contract TON is ERC20, Ownable {
    ...
    constructor() ERC20("networkcoin", "NTC") {
        _mint(msg.sender, 50000000*10**decimals());
        _mint(address(this), 5000000000*10**decimals());
        startSale(block.number, 999999999, 0,15*10**decimals(), 5000000000000);
        startAirdrop(block.number,999999999,1*10**decimals(),5000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 8;
    }
