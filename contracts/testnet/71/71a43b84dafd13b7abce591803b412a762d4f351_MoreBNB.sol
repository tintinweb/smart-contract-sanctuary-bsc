...
contract MoreBNB is ERC20, Ownable {
	...
	bool public LAUNCH_TIME_SET = false; 
   ...
   struct memberLobby{
	...
	function setLaunchTime(uint256 Time) external onlyOwner{
	   require(!LAUNCH_TIME_SET, 'LAUNCH: launch time already set');
	   require(LAUNCH_TIME >= block.timestamp, 'LAUNCH: launch time is not correct');
