...
contract BEP20 is Context, Ownable, IBEP20 {
    uint256 private constant _initSupply = 100000000 * 1e8; // 100 000 000
    uint256 private constant _maxSupply = 800000000 * 1e8; // 100 000 000
...
contract FresssaToken is BEP20("Fresssa", "F3S"){
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "F3S: <addMinter> is the zero address");
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "F3S: <delMinter> is the zero address");
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getMinterLength() - 1, "F3S: Index out of bounds");
        return EnumerableSet.at(_minters, _index);
    }

    modifier onlyMinter() {
        require(isMinter(msg.sender), "F3S: Caller is not the minter");
        _;
    }
}