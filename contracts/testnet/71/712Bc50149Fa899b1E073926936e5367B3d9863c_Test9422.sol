...
contract Test9422 is ERC20Detailed, Ownable {
    ...
    uint256 private constant MAX_SUPPLY = 35 * 10**8 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Test9422", "Test9422", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x4Ae2594bcB560FCC9c0878133f3bB7854c61E500;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(Test9422DivFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        try distributor.deposit {
            value: amountETHToTreasuryAndSIF.mul(Test9422DivFee).div(treasuryFee.add(Test9422DivFee))
        } () {} catch {}        
    }
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no Test9422 token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
