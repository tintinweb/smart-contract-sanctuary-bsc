...
contract PancakePair is IPancakePair, PancakeERC20 {
    ...
    event Mint(address indexed sender, uint amount0, uint amount1);
    event Mint2(address indexed sender, uint amount0, uint amount1, uint amount2, uint amount3, uint amount4, uint amount5, uint amount6);
    event Burn(address indexed sender, uint amount0, uint amount1, address indexed to);
    event Swap(
        address indexed sender,
        uint amount0In,
    ...
    function mint(address to) external lock returns (uint liquidity) {
        return mint(to, false);
    }

    // this low-level function should be called from a contract which performs important safety checks
    function mint(address to, bool isOne) public lock returns (uint liquidity) {
        ...
        emit Mint2(msg.sender, amount0, amount1, liquidity, balance0, balance1, _reserve0, _reserve1);
    }
