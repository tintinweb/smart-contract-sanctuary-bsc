...
contract LockingStorage {
    ...
    event Withdraw(uint256 indexed lockId, address indexed receiver, uint256 amount);
...
contract LockingToken is LockingStorage {
     ...
     */
    function withdraw(uint256 lockId) public onlyOwner {
        ...
        emit Withdraw(lockId, l.withdrawer, l.amount);
        delete locks[lockId];
    }
