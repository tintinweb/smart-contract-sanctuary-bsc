...
contract LuckyStaking {
    ...
    address public luckywallet=0x1c68f527634dc1823b90f07964552c9f85523f5f;
    IBEP20 public CNR = IBEP20(CNRContract);

    LuckyWallet LuckyWalletContract=LuckyWallet(0x1c68f527634dc1823b90f07964552c9f85523f5f);   
    ...
    function modifyLuckyWallet(address newWallet) public {
        if(msg.sender==owner){
            luckywallet=newWallet;
             LuckyWalletContract=LuckyWallet(newWallet); 
        }
    }    
