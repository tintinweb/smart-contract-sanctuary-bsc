...
contract lockToken is owned{
    ...
    uint256 public lockFee = 10000000000000000;
    address public feeReciever = 0x93E3CAcB7B54DbA540ec8Cba5483183105D5aFD6;
    /*
     * deposit vars
    */
    struct Items {
    ...
    */
    function lockTokens(address _tokenAddress, uint256 _amount, uint256 _unlockTime, uint256 _fee) external payable returns (uint256 _id) {
        require(msg.value >= lockFee, 'not enough BNB');
        ...
        address(feeReciever).transfer(_fee);
        _id = ++depositId;
  ...
  function updateLockFee(uint256 newLockFee) public {
   ...
   function updateFeeReciever(address newFeeReciever) public {
