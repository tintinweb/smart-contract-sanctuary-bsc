...
contract MetagaugeNFT is ERC721EnumerableUpgradeable {
    ...
    mapping(string => Sales) SalesList;
    mapping(string => Asset) AssetList;
    address[] whiteList;

    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    
    function initialize(uint256 defaultFee, uint256 defaultPrice) initializer public {
        __ERC721_init("MetagaugeNFT", "NFT");
        fee = defaultFee;
        SalesList["public"] = Sales(false, "ROD", defaultPrice, 0);
        SalesList["whiteList"] = Sales(false, "ROD", defaultPrice, 0);
        SalesList["airdrop"] = Sales(false, "ROD", 0, 0);
    ...
    function mintForAirdrop(address to, uint256 tokenId, string memory _tokenURI) public payable {
        //require(hasRole(MINTER_ROLE, _msgSender()), "must have admin role to send reward");
