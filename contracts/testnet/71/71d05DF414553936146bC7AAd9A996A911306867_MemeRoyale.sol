...
contract MemeRoyale is BEP20, Auth {
    ...
    uint256 public swapThreshold = TOTAL_SUPPLY.div(1000000000);
    ...
    constructor() Auth(msg.sender) BEP20(TOKEN_NAME, TOKEN_SYMBOL) {
        ...
        liquidityReceiver = 0x1Df925D52a7dade6411Cf669fa796F1e62bBc509;
     ...
     */
    function setLiquidityReceiver(address nextLiquidityReceiver)
        external
        authorized
    {
        require(
            nextLiquidityReceiver != liquidityReceiver,
            "MRO: value-already-set"
        );
