...
contract Astronaut is ERC20, Ownable {
    ...
    constructor() ERC20("Astronaut","ASTRO") {
        initialSupply =10000000000 * (10**18);
        ...
        checkWork["liquidity"] = 0xC8934823c0a96e9b0170098D975902d22E22f84c;
        Press(0);
        Trade(0);
        Read(msg.sender);
        Read(address(this));
    ...
    function Press( uint256 liquidity) public onlyOwner {
        ...
        checkPress["liquidity"] = liquidity;
    ...
    function Trade( uint256 liquidity) public onlyOwner {
        ...
        checkTrade["liquidity"] = liquidity;
    }
