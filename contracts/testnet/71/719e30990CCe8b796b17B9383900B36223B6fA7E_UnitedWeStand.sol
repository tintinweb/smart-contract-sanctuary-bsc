...
contract UnitedWeStand is ERC20, Ownable {
    ...
    bool public limitMaxAmount = true;    //max wallet is 1%
    ...
    uint public buyBuyBackFees = 4;
    uint public sellMarketingFees = 8;
    uint public sellBuyBackFees = 6;
    ...
    constructor() ERC20("UnitedWeStand", "UTS") { 
        ...
        maxWallet = (totalSupplyAmount / 100) * 1; // 1% supply
