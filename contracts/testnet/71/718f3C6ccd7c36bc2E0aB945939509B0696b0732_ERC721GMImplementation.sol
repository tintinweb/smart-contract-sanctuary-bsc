...
import "ERC721GMCore.sol";

/**
 * @dev ERC721Creator implementation
 */
contract ERC721GMImplementation is AdminControlUpgradeable, ERC721Upgradeable, ERC721GMCore {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721Upgradeable, ERC721GMCore, AdminControlUpgradeable) returns (bool) {
        return ERC721GMCore.supportsInterface(interfaceId) || ERC721Upgradeable.supportsInterface(interfaceId) || AdminControlUpgradeable.supportsInterface(interfaceId);
    }
...
import "GMCore.sol";
import "IERC721GMCore.sol";

/**
 * @dev Core ERC721 creator implementation
 */
abstract contract ERC721GMCore is GMCore, IERC721GMCore {
 ...
 * @dev Core ERC721 creator interface
 */
interface IERC721GMCore is IGMCreatorCore {
