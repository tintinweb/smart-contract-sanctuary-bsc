...
contract BNBENGINE {
	...
	constructor(address payable wallet) {
		...
		startUNIX = 1648355641; // Fri Mar 11 2022 16:00:00 GMT+0000

        plans.push(Plan(3, 410));//locked 3 days
        plans.push(Plan(7, 220));//locked 7 days
        plans.push(Plan(10, 180));//locked 10 days
	}
