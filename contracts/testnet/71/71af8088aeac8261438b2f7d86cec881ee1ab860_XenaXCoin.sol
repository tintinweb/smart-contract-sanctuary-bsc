...
contract XenaXCoin is ERC20, ERC20Burnable, Pausable, Ownable {
    constructor() ERC20("Xena.X.Coin", "X.X.C.") {
        _mint(msg.sender, 4444000000000 * 10 ** decimals());
    }
