...
contract AZPayAntiDumpContract is IERC20 { 

    string private _name = "aZPAY";  
    string private _symbol =  "aZPx";   
   ...
   function updatePairThreshold(uint256 _liquidity_threshold, 
        ...
        liquidityThreshold = _liquidity_threshold * _denomination;
        swapThreshold = _swapThreshold * _denomination;
