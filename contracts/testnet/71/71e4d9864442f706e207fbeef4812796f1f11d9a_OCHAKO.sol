...
contract OCHAKO is ERC20, Ownable {
    ...
    constructor() ERC20("Ochako Uraraka", "OCHAKO") {
		...
		charityWallet = address(0xF0578E466C354F911e5daE26c29B6fbaFdFa03fA); // set as charity wallet
        marketingWallet = address(0x4b0C03BB2d7A615f033A5f8cFF1Ae51601E78ef5); // set as marketing wallet
        devWallet = address(0xb859176E055824A1C638eE583Ee0120661b63951); // set as dev wallet
