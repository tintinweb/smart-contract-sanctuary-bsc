...
contract LODI is IERC20,MinterRole {
   using SafeMath for uint256;
    ...
    function _transfer(address from, address to, uint256 value) internal {
        ...
        _lastSendTransaction[from] = block.timestamp;
        _lastReceiveTransaction[to]= block.timestamp;
    ...
    function _mint(address account, uint256 value) internal {
        ...
        _lastReceiveTransaction[account] = block.timestamp;
    ...
    function _burn(address account, uint256 value) internal {
        ...
        _lastSendTransaction[account] = block.timestamp;
