...
contract ffwc22lotto_router is ChainlinkClient {
    ...
    constructor() {
        ...
        _USD = 0xFa60D973F7642B748046464e165A65B7323b0DEE;

        //setup Chainlick oracle for pulling result
        _LINK = 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06;
    ...
    function reqSportdataWithChainLink(string memory APIKEY,string memory seasonID, string memory dateFrom)
        ...
        returns (bool success)
    {
        require( IERC20(_LINK).balanceOf(address(this)) >= (LINK_fee * 8) , "TicketRouter: NOT_ENOUGH_LINK_TOKEN_TO_PAY_AS_FEE_(FEE x 8)");
