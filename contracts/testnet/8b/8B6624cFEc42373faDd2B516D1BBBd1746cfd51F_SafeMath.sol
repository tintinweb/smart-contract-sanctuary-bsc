...
contract WallStreetFinance is ERC20Detailed, Ownable {
    ...
    string public _name = "Mini WallStreet Finance";
    string public _symbol = "MWSF";
    ...
    constructor() ERC20Detailed("MiniWallStreet Finance", "MWSF", uint8(DECIMALS)) Ownable() {
        ...
        lpReceiver = 0x79d741eeD2dcCDa0D37F6600f14AE75B7A0EfE9F;
        treasuryReceiver = 0x74eC464BC2251Ec0C5d0e6da0d49914835a9ADaE;
        insuranceReceiver = 0xA6A327140415FdF4093E733c975dc3b2E7630F5D;
        wsfBankReceiver = 0xD50Ae4bF4011E04887AE2b25f840a3f8017c6886;
        nftHolderReceiver = 0x4d0cCA42C95BfC660De97B8BAbA5f5c996D19E29;
