...
contract DoctorCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DoctorCat";
    string private _symbol = "DCAT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x26339439a8488A670f0f0C60F898F231655B6189);
    address payable public teamWalletAddress = payable(0xAf3D2e023d82C5cc807F09321113433FeC1DddB5);
