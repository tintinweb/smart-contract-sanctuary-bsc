...
contract iSmarten is ERC20, Ownable {
    ...
    constructor() ERC20("iSmarten", "iSmart") {
        ...
        maxBuyTransactionAmount = 750000000 * (10**18);
    	...
    	marketingWallet = address(0xc6a416C23e9d203f2850C6ac9bb14ab2B64e2E1C); // set as marketing wallet
        charityWallet = address(0xadF3220B9942e63eD1195FDc1071906Aa3408E58); // set as project wallet
        ...
        excludeFromFees(address(charityWallet), true);
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _projectFee) external onlyOwner {
        buyMarketingFee = _marketingFee;
        buyLiquidityFee = _liquidityFee;
        buyCharityFee = _projectFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyCharityFee;
        require(buyTotalFees <= 25, "Must keep fees at 15% or less");
    }
    
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _projectFee) external onlyOwner {
        sellMarketingFee = _marketingFee;
        sellLiquidityFee = _liquidityFee;
        sellCharityFee = _projectFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellCharityFee;
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForProject += fees * sellCharityFee / sellTotalFees;
            }
            // on buy
                ...
                tokensForProject += fees * buyCharityFee / buyTotalFees;
            }
            ...
            if(tokensForProject > 0){
                super._transfer(from, charityWallet, tokensForProject);
            }
