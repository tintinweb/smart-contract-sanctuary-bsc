...
contract BitaXSeed {
    ...
    uint256 public prequalAmt = 2e18;
    ...
    function _register(address buyer, address _refer) internal {
        uint256 amt = (users[buyer].prequal==true)?prequalAmt:fixedAmt;
        busd.transferFrom(msg.sender,address(this),amt);
        
        uint256 scaledAmount = amt.mul(price).div(10);
        ...
        emit Sold(buyer, amt, scaledAmount);
