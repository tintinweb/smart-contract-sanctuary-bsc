...
//viene chiamato coi decimali o senza???
    function buySwink(uint256 usdcAmount) public {
        ...
        //da correggere, non va inserito 10 ** 18 perché usdcAmount deve essere già con 18 cifre
        uint256 swinkAmount = usdcAmount * 100 / price;// /*/ 10 ** (USDC.decimals() - SWINK.decimals())*/ / price;
