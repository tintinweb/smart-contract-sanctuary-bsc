...
contract QQ1 is ERC20, Ownable {
    ...
    constructor() ERC20("Q1", "Q1") {
        ...
        uint256 totalSupply = 1 * 1e12 * 1e18; // 1,000,000,000,000 (1 trillion supply)
	    ...
	    marketingWallet = 0x71c5898CEAEb62f5359e28f5995a646c922f9840; // set as marketing wallet
        devWallet = 0x8362a4812434925Ace637Bb2499eE4CE7747319a ; // set as dev wallet
