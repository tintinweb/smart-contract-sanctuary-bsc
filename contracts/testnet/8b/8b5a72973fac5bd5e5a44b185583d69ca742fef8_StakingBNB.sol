...
contract StakingBNB is Ownable {
    ...
    uint256 public constant TIME_UNIT = 3 minutes; // don vi thoi gian toi thieu
    ...
    function withdrawStake(uint256 id) external {
        ...
        console.log("amountDAK", amountDAK);
        ...
        console.log("balanceDAK",dakshow.balanceOf(address(this)));
