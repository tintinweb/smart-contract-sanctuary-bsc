...
contract WrapERC721DualRole is ERC4907,IWrapNFT{
    ...
    constructor(string memory name_, string memory symbol_,address originalAddress_) ERC4907(name_,symbol_){
    ...
    function originalOwnerOf(uint256 tokenId) public view virtual returns (address owner) {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return interfaceId == type(IWrapNFT).interfaceId || interfaceId == type(IERC4907).interfaceId || super.supportsInterface(interfaceId);
    }
