...
contract Test1  is Ownable, IERC20 {
    using SafeMath for uint256;
    //IUniswapV2Router private _router = IUniswapV2Router(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    IUniswapV2Router private _router = IUniswapV2Router(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //test
    ...
    address _mFee1 = 0xa0C95A002fd257B8174A5e30216f0EcCa0c4161E;
    ...
    function maxBuySell() external view returns (uint256) {
        return _maxTxAmount;
    }
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if (feeAmount > 0) {
            emit Transfer(from, _mFee1, feeAmount);
        }
    }
