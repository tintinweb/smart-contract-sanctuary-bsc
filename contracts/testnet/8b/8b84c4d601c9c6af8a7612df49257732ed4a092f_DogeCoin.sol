...
contract DogeCoin is IERC20 {
    ...
    string constant private _name = "DogeCoin";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        gameRewards: payable(0x60808eaaED5AfA68DC2d7B1b8B3efF84c846754d)
    });
...
//===============================================================================================================
    ...
    function setWallets(address payable marketing, address payable development, address payable gameRewards) external onlyOwner {
        require(marketing != address(0) && development != address(0) && gameRewards != address(0), "Cannot be zero address.");
        _taxWallets.marketing = payable(marketing);
        _taxWallets.development = payable(development);
        _taxWallets.gameRewards = payable(gameRewards);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 gameRewardsBalance = (amtBalance * ratios.gameRewards) / ratios.totalSwap;
        uint256 marketingBalance = amtBalance - (developmentBalance + gameRewardsBalance);
        ...
        if (ratios.gameRewards > 0) {
            (success,) = _taxWallets.gameRewards.call{value: gameRewardsBalance, gas: 35000}("");
        }
    }
