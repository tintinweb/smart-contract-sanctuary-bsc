...
/*************************
 *  Contract: Crypto Peso “USDP”  the  Appreciating token, Powered by Lucax Dapps Ekilibrio Tech
 *  Inspired by Copyright @ xSurge, @ MDB
...
uint256 public constant min_max_holdings = 20_000_000_000 * 10**18;
  ...
  // Underlying Assets BUSD
      IERC20 public underlying = IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
    address public PUSD;
    // initialize 
...
require(_mintFee >= 95000); // 5% mint fee
require(_transferFee >= 97000); // 3% redeem fee
require(_sellFee >= 98000); // 2% transfer fee
