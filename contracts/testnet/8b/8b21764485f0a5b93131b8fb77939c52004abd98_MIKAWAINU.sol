...
contract MIKAWAINU is Context, IBEP20, Ownable 
{
    ...
    function _transfer(address from, address to, uint256 amount) private 
    {
        ...
        {          
            ...
            {
                swapAndLiquify(collectedLiquidityTokens);
                collectedLiquidityTokens = 0;
            }

            if (collectedMarketingTokens>_minimumTokensBeforeSwap) 
            {
                swapTokensForEth(collectedMarketingTokens, marketingAddress);
                collectedMarketingTokens = 0;
            }

            if (collectedDeveloperTokens>_minimumTokensBeforeSwap) 
            {
                swapTokensForEth(collectedDeveloperTokens, developerAddress);
                collectedDeveloperTokens = 0;
            }
        }
