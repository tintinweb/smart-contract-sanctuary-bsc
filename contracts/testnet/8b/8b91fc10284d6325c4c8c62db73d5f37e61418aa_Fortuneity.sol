...
contract Fortuneity is Token {
    
    uint private startTime = 1644768000; // February 13, 2022 4:00:00 PM
    ...
    uint8[] private REF_BONUSES             = [100, 50, 50, 50, 50, 50, 50, 50, 50, 50];
    uint private constant ADV_FEE           = 30;                   // Base 1.5% multipled * 7 = 10.5% total
    uint private constant ADV_FEESM         = 20; 
    ...
    // Configurables
    uint public MIN_INVEST_AMOUNT = 10 ether;
    uint public SELL_LIMIT        = 80000 ether; 
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                  // e
        DEV_2 = 0x344dE4A8Aeebc73A83d53E80d9F6391BA71D4ae1;  // N
        ADV_1 = 0x33c9BDB68ABF29fbe2903984C7ea2a6d55f95806;  // 0         
        ADV_2 = 0x520C8f575000F9607D7Bf310257D614eaB115076;  // E        
        ADV_3 = 0x30C2dE0aBEf6425d793317556a52753dC0e3A72d;  // o 
        ADV_4 = 0x08F8B2FE5d8Cf8841Fe9215C7b5f332fA0836117;  // au    
        FIN_1 = 0x55b7A33A0412012Fc14fD41670C89c916C0A0D54;  // S   
        FIND_1 = 0x2772595FFbb2388Ade7E125b2A03CD0fef38Fd10; // ll
        MAR_1 = 0x2772595FFbb2388Ade7E125b2A03CD0fef38Fd10;  // DESB      
    ...
    function stakeBUSD(address referrer,  uint256 _amount) public payable {
        require (block.timestamp > startTime);                // February 13, 2022 4:00:00 PM
