...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 public rewardToken = IERC20(0xA9e8F380fB7D25870330C16632dC52d607ce372f); // TODO
    IRouter02 router;
...
contract Rich is ERC20, Ownable { // BabyCookieSale
    ...
    address payable public teamWallet = payable(0x8171894d6316F73d2F69b3cA60b8633064962Ab4);
    address payable public marketingWallet = payable(0x027AbF2e784803d90cB4e14BB081F5F142dA0062);
    ...
    constructor() ERC20("Baby Richard", "BRICH") { // "Baby CookieSale", "BABY COOKIE"
        // Create supply
        _mint(msg.sender, 100_000_000 * 10**18);

        dexRouter = IRouter02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        ...
        _isExcludedFromReward[pair] = value;
    ...
    function setMaxWalletLimit(uint256 amount) external onlyOwner {
        require(amount >= 10_000 && amount <= 100_000_000, "BABY COOKIE: Amount must be bewteen 10 000 and 100 000 000");
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(!isSellTransfer && !isBuyTransfer && !_isExcludedFromMaxWalletLimit[to]) {
