...
contract ProjectLaunchFactory {
  ...
  function createSale(
    ...
    saleVault = (_seed_details[5] == 0 ? address(0) : iSaleVaultFactory(vaultContract).createVault(msg.sender, _sale_token));
    ...
    totalTokens = (_seed_details[4] * _seed_details[0]) + ((10000 - round1MultT[_sale_details[0]]) * (_seed_details[4] * _seed_details[0]));
    totalTokens = totalTokens + (_presale_details[4] * _presale_details[0]) + ((10000 - round1MultT[_sale_details[0]]) * (_presale_details[4] * _presale_details[0]));
    totalTokens = totalTokens + (_community_details[4] * _community_details[0]) + ((10000 - round1MultT[_sale_details[0]]) * (_community_details[4] * _community_details[0]));
