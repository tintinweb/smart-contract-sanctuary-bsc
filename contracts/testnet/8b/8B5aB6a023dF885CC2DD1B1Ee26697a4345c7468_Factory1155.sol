...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new NAFTUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        NAFTUser1155Token token = NAFTUser1155Token(address(addr));
