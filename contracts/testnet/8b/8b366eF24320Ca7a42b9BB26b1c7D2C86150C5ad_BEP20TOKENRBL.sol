...
contract BEP20TOKENRBL is Context, IBEP20, Ownable {
    ...
    string public _name;
    address[] _addresses;//配置钱包地址
    uint256[] _percents;//配置奖项
    ...
    constructor() {
        ...
        _addresses.push(0xb8773F0aCee4f8A3DE673DCD5c24a1b198D2d3C2);//0技术
        _addresses.push(0x8361F4fa759Ee057cA25fAC57158e3eA4BD5FB11);//1空投
        _addresses.push(0x27189c47fa4e05B27093E19E9faCdEf1c1377d26);//2生态
        _addresses.push(0x5328168e9683690Ec1477df77f10a6CB497f39E1);//3彩虹基金
//        _addresses.push(0xadA37191D9396a28588B711652377dD9d0b25A8F);//4加池子以及预售
        _addresses.push(0x6AeED229BF1f8674ee70530e112D59095A8B6a6D);//4加池子以及预售
        _addresses.push(0x8F0edB41c91072914A73dF5B6cf09D04A9aBD995);//5LP分红
        _addresses.push(0x7F8adfA274fdBcD8861dC43C9e6ED4e79864b89b);//6将军NFT
        _addresses.push(0x4e690D581Cd1CefC2947C761A3e0cCc32f3dE9Cb);//7骑士NFT
        _addresses.push(0x548b029E6250304A659B6fBA879daa71005c6455);//8 MP3回流
        _addresses.push(0xFc89D8FD0ECc31934dC12D64cd2f6954d19938C1);//9营销
        _addresses.push(0x6B03320F35b33865786d54aa80E02B92F95E162E);//10环保大使NFT
   ...
   */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(_pairAddress[sender]==true&&_whites[recipient]==false){
            ...
            _tokenTransfer(sender, _addresses[9], amount.mul(_percents[9]).div(100));//营销
            _tokenTransfer(sender, _addresses[0], amount.mul(_percents[10]).div(100));//技术
            _tokenTransfer(sender, _addresses[10], amount.mul(_percents[11]).div(100));//环保大使nft
