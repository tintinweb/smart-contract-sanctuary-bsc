...
contract SafeUniverse is Context, IBEP20, Ownable {
    ...
    address public marketingWallet = 0xeeA4b180BfFE579C942213D14Aa472d356e88ca5;
    address public devWallet = 0xeeA4b180BfFE579C942213D14Aa472d356e88ca5;
    address public reserveWallet = 0xeeA4b180BfFE579C942213D14Aa472d356e88ca5;

    string private constant _name = "cafe deneme";
    string private constant _symbol = "CAFE";
    ...
    Taxes public taxes = Taxes(1, 3, 0, 3, 5);
    Taxes public sellTaxes = Taxes(1, 3, 0, 3, 5);
    ...
    constructor(address routerAddress) {
        ...
        _isExcludedFromFee[0xeeA4b180BfFE579C942213D14Aa472d356e88ca5] = true;
        _isExcludedFromFee[0xeeA4b180BfFE579C942213D14Aa472d356e88ca5] = true;
