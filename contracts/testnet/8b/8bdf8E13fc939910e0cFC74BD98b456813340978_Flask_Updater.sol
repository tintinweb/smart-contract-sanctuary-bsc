...
abstract contract With_RoyaltyContract is Base, AccessControl, With_DAORole, I_With_RoyaltyContract{
    I_Flask_Royalty public royalty;

    function setRoyalty(I_Flask_Royalty _royalty) external onlyRole(DAO_ROLE){
        royalty = _royalty;
    }
}// Version: 1.0.0
...
contract Flask_Updater is Base, Math, Adressable, Payable, Gas_Refundable, AccessControl, With_DAORole, With_DAOContract,
                             With_FundContract, With_TradeManagerContract, With_StackingContract, With_RoyaltyContract, With_CompetitionContract, I_Flask_Updater{
    ////
    ////
    ////
    //////////////// Public variables ////////////////
    ...
    modifier onlyGovernor(){
        require(isGovernor[msg.sender], "Flask_DAO: Only governor are allowed to call this function.");
        _;
    }
    ...
    function updateOneCompetitionCycle() external onlyGovernor gasRefundable{
        require(updateCompetitionCycleNeeded(), "Flask_DAO: A Competition cycle update is not required. Gas will not be refunded.");
        _updateOneCompetitionCycle();
    }

    function updateCompetitionCycle() external onlyGovernor gasRefundable{
        require(updateCompetitionCycleNeeded(), "Flask_DAO: A Royalty cycle update is not required. Gas will not be refunded.");
    ...
    function updateOneRoyaltyCycle() external onlyGovernor gasRefundable{
        require(updateRoyaltyCycleNeeded(), "Flask_DAO: A Royalty cycle update is not required. Gas will not be refunded.");
    ...
    function updateOneStackingCycle() external onlyGovernor gasRefundable{
        require(updateStackingCycleNeeded(), "Flask_DAO: A Stacking cycle update is not required. Gas will not be refunded.");
    ...
    function updateStackingUpdate() external onlyGovernor gasRefundable{
        require(stacking.updateStackingNeeded(), "Flask_DAO: A Stacking update is not required. Gas will not be refunded.");
    ...
    function updateOneStackingUpdate(uint256 groupId) external onlyGovernor gasRefundable{
        require(stacking.updateOneStackingNeeded(groupId), "Flask_DAO: A Stacking update is not required. Gas will not be refunded.");

        _updateOneStackingUpdate(groupId);
    }
    
    function updateOneClaimReward(uint256 groupId) external onlyGovernor gasRefundable{
        require(stacking.updateOneClaimRewardNeeded(groupId), "Flask_DAO: A Claim reward is not required. Gas will not be refunded.");

        _updateOneClaimReward(groupId);
    }
    ...
    function updateEndTradeNeeded() public view returns (bool){
        ...
        for (uint256 i=0; i<l; i++){
            (I_Flask_Trade_Manager.TradeData memory data,) = tradeManager.getOpenTrade(i);
    ...
    function getFirstEndTradeNeeded() external view returns (uint256){
        uint256 l = tradeManager.getNbOpenTrades();
        ...
        require(false, "Flask_Updater: not trade end needed");
        return 0;
    }
    
    function updateOneEndTrade(uint256 tradeId) external onlyGovernor gasRefundable{
        I_Flask_Trade_Manager.TradeData memory data = tradeManager.getTrade(tradeId);
        
        require(data.trade.endTradeNeeded(), "Flask_DAO: A end trade update is not required. Gas will not be refunded.");
    ...
    function updateEndTrade() external onlyGovernor gasRefundable{
        ...
        while(i>0){
            i--;
            (I_Flask_Trade_Manager.TradeData memory data, uint256 id) = tradeManager.getOpenTrade(i);
            if (data.trade.endTradeNeeded()){
                updateApplied = true;
        ...
        require(updateApplied, "Flask_DAO: A end trade update is not required. Gas will not be refunded.");
    }
    ...
    function getFirstUpdateTradeNeeded() external view returns (uint256){
        uint256 l = tradeManager.getNbOpenTrades();
        ...
        require(false, "Flask_Updater: not trade update needed");
        return 0;
    }
    ...
    function updateOneTrade(uint256 tradeId) external onlyGovernor gasRefundable{
        ...
        require(data.trade.updateNeeded(), "Flask_DAO: A trade update is not required. Gas will not be refunded.");
    ...
    function updateTrade() external onlyGovernor gasRefundable{
        ...
        require(updateApplied, "Flask_DAO: A trade update is not required. Gas will not be refunded.");
    }
    ...
    function updateOneDAOCycle() external onlyGovernor gasRefundable{
        require(updateDAOCycleNeeded(), "Flask_DAO: A DAO cycle update is not required. Gas will not be refunded.");
        _updateOneDAOCycle();
    }
    ...
    function getFirstDAOOpenProposalId() external view returns (uint256){
        uint256 l = DAO.getNbOpenProposalIds();
        ...
        require(false, "Flask_Updater: not DAO proposal update needed");
        return 0;
    }
    ...
    function updateDAO() external onlyGovernor gasRefundable{
        require(updateDAONeeded(), "Flask_DAO: A DAO update is not required. Gas will not be refunded.");
    ...
    function _updateOneClaimReward(uint256 groupId) internal{
        stacking.updateOneClaimReward(groupId);
    }
