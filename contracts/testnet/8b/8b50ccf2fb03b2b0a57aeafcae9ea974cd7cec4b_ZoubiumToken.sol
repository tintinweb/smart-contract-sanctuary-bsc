...
contract ZoubiumToken is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 195 * 10**2 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Zoubium Finance", "ZBM", uint8(DECIMALS)) {
    ...
    function _rebase() private {
        ...
        if (nextRebase < 1677881400) {
            rewardYield = 10000000;
        } else if (nextRebase >= 1677881400) {
            rewardYield = 255000;
        }
    ...
    function HourlyRebase() external {
