...
contract YDN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "YDN";
    string private _symbol = "YDN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x639181F0d44371dC0D63E4650b5d1818EC0D920D); // Marketing Address
    address payable public teamWalletAddress = payable(0x2c871ce77F9f85Bfc03A4b0096D81E6d69f3D834); // Team Address
