...
contract hitmonkey is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Hit Monkey";
    string private _symbol = "HMY";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf8324d65Ff6C042C002F05e57565909BbDD4B0e8);
    address payable public teamWalletAddress = payable(0xf8324d65Ff6C042C002F05e57565909BbDD4B0e8);
   ...
   //     }
    ...
    function setTradeLock(bool lock)private onlyOwner returns(bool){
