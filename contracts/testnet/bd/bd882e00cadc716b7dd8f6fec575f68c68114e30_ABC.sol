...
contract ABC is ERC20 {
    ...
    constructor() ERC20("ABC", "ABC") {
        ...
        _tokenOwner = address(0xE908f2C1364168934204939dde4E0Ec2D798De9E);
        marketAddress = address(0x5D1326bA78DE0ab6e3f303B286984F6DdcCD6D17);
        ...
        _mint(_tokenOwner, 5000000 * 10**18);
