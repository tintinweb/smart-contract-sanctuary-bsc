  ...
  Pausable
{
  ...
  address public liquidityPool = 0x68aCE5f7b794Fce0c4090f3C95CB8d7EA0C21C5b;
  address private splitter = 0x68aCE5f7b794Fce0c4090f3C95CB8d7EA0C21C5b;
...
contract Staking is Ownable, IERC721Receiver, Pausable {
  ...
  function claimManyFromStaking(uint16[] calldata tokenIds, bool unstake)
    external
    nonReentrant
    _updateEarnings
  {
