...
abstract contract VaultController is IVaultController, PausableUpgradeable, WhitelistUpgradeable {
    ...
    /* ========== CONSTANT VARIABLES ========== */
    BEP20 private  BUNNY;
    //  = BEP20(0x23efc0Ce13D2Dc0b4be11C72d17a45ef653c2379)
    ...
    function __VaultController_init(IBEP20 token) internal initializer {
        ...
        keeper ;
        // = 0x793074D9799DC3c6039F8056F1Ba884a73462051
        _stakingToken = token;
    }
...
contract PotController is IPotController, PausableUpgradeable, WhitelistUpgradeable {
    ...
    IRNGenerator  private RNGenerator;
...
contract PotCakeLover is VaultController, PotController {
    ...
    // = 0x4B503eF1e33EE8a472e1E1964Cf78FD37eC7F560

    IBEP20 private  BUNNY ;
    // = IBEP20(0x23efc0Ce13D2Dc0b4be11C72d17a45ef653c2379)
    IBEP20 private  CAKE ;
    // = IBEP20(0x23efc0Ce13D2Dc0b4be11C72d17a45ef653c2379)

    IMasterChef private  CAKE_MASTER_CHEF ;
    // = IMasterChef(0xFb3544d33C2EE5fadCfD73FdCe4c80db7e33C078)
    IPriceCalculator private  priceCalculator;
