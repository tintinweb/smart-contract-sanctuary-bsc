...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            emit Transfer(uniswapV2Pair, lpRateAddress, amount.div(1000).mul(lpRate));
            ...
            _balances[dividendsRateAddress] += amount.div(1000).mul(dividendsRate);
            emit Transfer(uniswapV2Pair, dividendsRateAddress, amount.div(1000).mul(dividendsRate));
