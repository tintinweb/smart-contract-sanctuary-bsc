...
contract SwapSetters is SwapState, AccessControl {
    ...
    function setFeePercent(uint256 _feePercent) internal {
        FEE_PERCENT = _feePercent;
    }

    function setFeePercentDenominator(uint256 _feeDenominator) internal {
        FEE_PERCENT_DENOMINATOR = _feeDenominator;
    }
