...
contract RewardDistributor is IERC20 {
    ...
    constructor(
        ...
        // name + symbol
        _name = string.concat("Pending ", IERC20(rewardToken_).symbol());
        _symbol = string.concat("p", IERC20(rewardToken_).symbol());
    ...
    */
    function setRewardToken(address newRewardToken, address newRewardSwapper) external onlyOwner {
        ...
        _name = string.concat("Pending ", IERC20(newRewardToken).symbol());
        _symbol = string.concat("p", IERC20(newRewardToken).symbol());
