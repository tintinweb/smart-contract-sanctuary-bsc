...
import "IBasisERC20.sol";

contract KeeperManagerTest is OwnableUpgradeable, PausableUpgradeable {
    IBasisERC20 public want;
    ...
    event WantSet(address indexed want);
        ...
        )
    {
        ...
        upkeepNeeded = (block.timestamp - lastTimestamp) > cooldown && wallet != address(0);
