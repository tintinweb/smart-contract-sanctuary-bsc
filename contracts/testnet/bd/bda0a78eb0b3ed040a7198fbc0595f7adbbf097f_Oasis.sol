...
contract Oasis is ERC20, Ownable {
    ...
    address internal constant OasisTeam_addr_1 = 0x08D1d3E1E886Cd9e76D1042e417Cc2b3468d4Ba5; // 39%
    address internal constant OasisTeam_addr_2 = 0xF965Bc8CA113e03C34ce705F2FE0D07D40e01C27; // 35%
    address internal constant OasisTeam_addr_3 = 0xF150AdD5213a65b51D1d43669B87e551f0702586; // 10%
    address internal constant OasisTeam_addr_4 = 0xE3FBd96774938De9FAA5C9726A53b56219060fEA; // 16%
    address internal marketing_addr = 0xa0CcfbEB2EE5dC1B987c41A89778f209d03DfbE9;
    address internal buyBack_addr = 0x46b685cA25F3aFD38371D709638C563A335BBFC1;
    ...
    /* % from every day's lobby entry dedicated to Oasis team, marketing and buy back */
    uint256 internal constant DM_OasisTeam_percentage = 4;      
    ...
    function flushFirstDayLobbyEntry() external onlyOwner() nonReentrant {
        ...
        payable(OasisTeam_addr_1).transfer((lobbyEntry[1] * 94) /100);  
    }
    ...
    /* Gets called once a day and withdraws Oasis team's share for the privious day of lobby */ 
    function _sendDevShare() internal nonReentrant {
        require(currentDay > 0);

        // OasisTeamPercentage = 4% of every day's lobby entry
        uint256 OasisTeamPercentage = (lobbyEntry[currentDay - 1] * DM_OasisTeam_percentage) /100;
        
        // [39%, 35%, 10%, 16%] 
        payable(OasisTeam_addr_1).transfer((OasisTeamPercentage * 39) /100);
        payable(OasisTeam_addr_2).transfer((OasisTeamPercentage * 35) /100);
        payable(OasisTeam_addr_3).transfer((OasisTeamPercentage * 10) /100);
        payable(OasisTeam_addr_4).transfer((OasisTeamPercentage * 16) /100);
    }
     ...
     * @param amount Amount of SYS tokens to stake
    ...
    function EnterStake(uint256 amount, uint256 stakingDays) external {
        ...
        /* On stake SYS tokens get burned */
    ...
    /**
     * @dev Calculating a stakes Bonus SYS tokens based on stake duration and stake amount
     * @param StakeDuration The stake's days
     * @param StakeAmount The stake's SYS tokens amount
     */
