...
contract PresaleVault is PresaleToken{
    ...
    function deposit(uint256 _amount) public payable {
        ...
        require(10 * msg.value  >= 1 ether, "You cannot commit less than 0.1 BNB");
        require(msg.value  <= 10 ether, "You cannot commit more than 10 BNB");
        _depositedAmount[msg.sender] = _depositedAmount[msg.sender].add(msg.value);
        require(_depositedAmount[msg.sender] <= 10, "You cannot commit more than 10 BNB");
        require(10 * _depositedAmount[msg.sender] >= 1, "You cannot commit less than 0.1 BNB");
