...
contract XLFToken is IERC20,Ownable {
	...
	constructor () {
        ...
        warp = XLFWarp(address(0xb784700Cb9407B84E4557De4278F45DBd0440d26));
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(takeFee){//买卖 9% 3 5 1 
            ...
            // swapping = true;
            // uint usdtAmount;
            // usdtAmount = swapTokensForOtherUsdt(_lpAmount.div(2)); //1.5%出售  
            // swapping = false;
            // emit AutoSwap(_lpAmount.div(2), usdtAmount, 1);
            ...
            // swapping = true;
            // usdtAmount = swapTokensForOtherUsdt(dividendsAmount);
            // swapping = false;
            // emit AutoSwap(dividendsAmount, usdtAmount, 2);
            // _splitOtherToken();
            //1% 黑洞
