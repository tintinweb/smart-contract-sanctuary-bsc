...
//
//Boremon didn't ask to be born - it's not his fault he looks like this! Join the low tax $BOREMON moonshot stealth launch today 9-11pm UTC. 
//
//Brother Kevin died after 800x, Boremon is here to kick his ass!
//
//The goal? Send $BOREMON far enough whereby we create higher resolution and animated NFTs that can be staked to earn  $BNB 
//
...
contract Boremon is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Boremon";
    string constant _symbol = "$BOREMON";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7B9A1b4712B719E8246F3E4B3Da0A2C56f7c20BA;
        ecosystemfeeReceiver = 0x7B9A1b4712B719E8246F3E4B3Da0A2C56f7c20BA;
