...
contract LevelStake is Initializable, OwnableUpgradeable, ILevelStake {
    ...
    uint256 private constant MAX_REWARD_PER_SECOND = uint256(30_000_000 ether) / 2 hours;

    uint256 public constant COOLDOWN_SECONDS = 10 minutes;
    uint256 public constant UNSTAKE_WINDOWN = 5 minutes;
