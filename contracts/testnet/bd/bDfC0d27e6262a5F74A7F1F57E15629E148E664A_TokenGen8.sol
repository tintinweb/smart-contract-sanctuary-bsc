...
import {ERC20_Swap2_Own_Liq_OneWal} from './ERC20_Swap2_Own_Liq_OneWal.sol';
...
contract TokenGen8{
 modifier onlyFactory() {
    ...
    function generateToken(
        ...
        ERC20_Swap2_Own_Liq_OneWal newtok = new ERC20_Swap2_Own_Liq_OneWal(name, symbol, decimals, totalSupply, owner, raddr, lbfee, lsfee, w1addr, w1bfee, w1sfee);
...
contract ERC20_Swap2_Own_Liq_OneWal is IERC20, Ownable {
    ...
    function setBuyFees(uint256 _liquifyFee, uint256 _wallet1Fee) external onlyOwner {
    ...
    function setSellFees(uint256 _liquifyFee, uint256 _wallet1Fee) external onlyOwner {
    ...
    function _getValues(uint256 tAmount) private view returns (FeeValues memory) {
        ...
        values.transferAmount = tAmount.sub(values.liquify).sub(values.wallet1);
        return values;
    }
    ...
    function getTotalFee(address account) public view returns (uint256) {
        ...
        return _defaultFees.liquifyFee.add(_defaultFees.wallet1Fee);
        }
    }
