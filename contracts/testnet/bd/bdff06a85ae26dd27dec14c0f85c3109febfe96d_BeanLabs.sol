...
contract BeanLabs is Context, Ownable {
    ...
    function setteamwallet(address adr) public onlyOwner {
        team = payable(adr);
    }
    ...
    function instabrew() public {
      require(boostpoints[msg.sender] >= 5, "Not enough boost points");
      lastinstabrew[msg.sender] = block.timestamp;
      exppoints[msg.sender] = exppoints[msg.sender] - 5;
    }

    function instabatch() public {
      require(boostpoints[msg.sender] >= 10, "Not enough boost points");
      lastinstabatch[msg.sender] = block.timestamp;
      exppoints[msg.sender] = exppoints[msg.sender] - 10;
    }

    function BoostChemists() public {
        require(boostpoints[msg.sender] >= 15, "Not enough boost points");
        ...
        boostpoints[msg.sender] = boostpoints[msg.sender] - 15;
