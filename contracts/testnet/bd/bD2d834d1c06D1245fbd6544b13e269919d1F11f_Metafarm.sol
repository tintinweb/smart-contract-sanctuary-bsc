...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1088ff66A5Afc972402C76Df8CD74D7fe8F7d8F7;
...
contract Metafarm is Context, IERC20, Ownable {
    ...
    string private _name = "Metafarm";
    string private _symbol = "Metafarm";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81);//0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner())
            require((recipientBalance + amount) <= _maxTxAmount, "Transfer amount exceeds the maxTxAmount.");
	...
	function swapTokensForBUSD(uint256 tokenAmount) private {
        ...
        path[2] =  0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47; //0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; BUSD cotract address
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
		...
		uint256 burnAmt = amount.mul(_burnFee).div(100);
         ...
         require(_burnFee > 0, "burn fee is not > 0");
        // require(burnAmt > 0, "burn amount is not > 0");
