...
/**
 * @title Best smart contract ever
 */
contract SigmaDAO is ERC20, Ownable {

    // Liquidity wallet address used to hold tokens for PancakeSwap.
    address public liquidityWalletAddress;

    // The PancakeSwap router address.
    address public uniswapRouterAddress;

    // transaction fee - deployed at 3%.
    uint256 public transactionFee = 3;

    // Mapping to exclude some fees.
    mapping (address => bool) public excludedFromFees;

    // PancakeSwap router.
    IUniswapV2Router02 private uniswapRouter;

    // Address of the token pair on PancakeSwap.
    address public uniswapPair;

    constructor(uint256 initialSupply, address _liquidityWalletAddress, address _uniswapRouterAddress) ERC20("Sigma DAO", "SIGMA") {
        ...
        _mint(liquidityWalletAddress, initialSupply / 100);
    ...
    /**
    * @dev Adds a user to be excluded from all transaction fees.
     */
    ...
    /**
    * @dev Removes a user from all transaction fees.
     */
    ...
    /**
     * @dev Overrides the ERC20 transfer function to include transaction fees.
     */
    ...
    function transferFrom(
        ...
        uint256 totalFee = (amount * transactionFee) / 100;
