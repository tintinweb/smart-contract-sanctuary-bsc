...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function findindex(uint256 _u,address _address)private returns(bool){
        ...
        if(l == 0 && useridlist[_address].ids[l]==_u){
            return updateArray2(l,_address);
        }
    ...
    function updateArray2(uint index,address _address) private returns(bool){
...
contract palce is MuskMelon{
    ...
    constructor () MuskMelon("MUSKMELONNFT","NFTMELON"){
        nativecommision = 100;
    }
    ...
    function findindexid(uint256 _u,address _address)private returns(bool){
        uint256 l;
    ...
    function updateArray(uint index,address _address) private{
    ...
    function openid(uint256 _u,address _address)private returns(bool){
        uint256 l;
    ...
    function updateOArray(uint index,address _address) private{
