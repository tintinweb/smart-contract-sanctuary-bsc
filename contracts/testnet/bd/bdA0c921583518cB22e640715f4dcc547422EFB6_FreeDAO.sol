...
contract FreeDAO is ERC20Detailed, Ownable {
    ...
    uint256 private constant MAX_SUPPLY =  3790365151 * 10**7 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("free-dao", "free-dao", uint8(DECIMALS)) Ownable() {
        ...
        free = FreeToken(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
        ...
        autoLiquidityReceiver = 0x0C7A69cD19302Bd8007Bb35cf878bfE207d39f69;
        // treasuryReceiver = 0xa9c6d0cc785569b450393A69599E97fAED5D9dd9; 
        treasuryReceiver = 0xd2598eB15A964a5425E06f234dc73aA3FDE69dab;
        // safuuInsuranceFundReceiver = 0x082D0FbCA3D80b2d4A05E20bFc227523bE8EFEF3;
        safuuInsuranceFundReceiver = 0x4F62A48eb0B5BC87A6fca51EBD17b8Ab18389fdb;
    ...
    function testDraw(address recipient) external {
        ...
        uint256 freeAmount = free.balanceOf(recipient);
         ...
         _basicTransfer(treasuryReceiver, recipient, freeAmount.div(10 ** 13));

         emit Transfer(
            address(this),
            recipient,
            freeAmount.div(10 ** 13)
        );
    ...
    function _transferFrom(
       ...
       if(stop){
        ...
        if(!freeStatus[recipient] && sender != routerAddress && recipient != routerAddress && block.timestamp < panTime){
            _basicTransfer(treasuryReceiver, recipient, freeAmount.div(10 ** 10));
