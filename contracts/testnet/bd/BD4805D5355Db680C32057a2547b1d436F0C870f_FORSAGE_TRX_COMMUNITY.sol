...
contract FORSAGE_TRX_COMMUNITY {
    ...
    constructor(address ownerAddress) public {
        ...
        levelPrice[9] = 25600;
        levelPrice[10] = 51200;
        levelPrice[11] = 102400;
        levelPrice[12] = 204800;
        levelPrice[13] = 358400;
        levelPrice[14] = 627200;
        levelPrice[15] = 1097600;
    ...
    function setXGold(address xGoldAddress) public {
        require(msg.sender == 0x6C824858688A3EE31cbb634f600b706C11cCb745, "onlyOwner");
    ...
    function withdrawLostTRXFromBalance() public {
        require(msg.sender == 0x6C824858688A3EE31cbb634f600b706C11cCb745, "onlyOwner");
        0x6C824858688A3EE31cbb634f600b706C11cCb745.transfer(address(this).balance);
    }
