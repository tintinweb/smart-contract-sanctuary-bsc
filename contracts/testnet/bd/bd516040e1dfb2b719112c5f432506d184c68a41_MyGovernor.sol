...
abstract contract Governor is Context, ERC165, EIP712, IGovernor, IERC721Receiver, IERC1155Receiver {
    ...
    function _descriptionHash(string memory _description) public pure returns(bytes32 stringHash){
        stringHash = keccak256(bytes(_description));
    }
