...
contract BBTest is ERC20, Ownable {
    ...
    constructor() payable ERC20("BBTest", "BBT") {

        rewardToken = 0x570A5D26f7765Ecb712C0924E4De545B89fD43dF; // DOGE
        ...
        treasuryWallet = 0x63F0f37f3Ca661FdC9D5457a9A659614E656CA7f;

        dividendTracker = new DividendTracker(1_000_000_000_000, rewardToken);

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // PCS testnet
        ...
        transferOwnership(0x63F0f37f3Ca661FdC9D5457a9A659614E656CA7f);
