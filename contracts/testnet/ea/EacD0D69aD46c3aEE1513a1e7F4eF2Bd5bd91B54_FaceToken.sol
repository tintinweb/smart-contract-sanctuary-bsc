...
contract FaceToken is Context, IBEP20, Ownable {
    ...
    string private _name = 'reflect.facebook';
    ...
    constructor (address routerAddress, address payable feeAddress) public {
