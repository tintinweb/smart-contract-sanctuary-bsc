...
contract BUSDVYNCSTAKE is ReentrancyGuard, Ownable {
        ...
        nonReentrant
    {
        ...
        if (unstakeOption == 1) {
            require(busd.transfer(msg.sender, _amount));
            ...
            require(busd.transfer(msg.sender, busdAmount));
            require(vync.transfer(msg.sender, _vyncAmount));
        } else if (unstakeOption == 3) {
            uint256 vyncAmount = swapBusdToVync(_amount);
            require(vync.transfer(msg.sender, vyncAmount));
        }
