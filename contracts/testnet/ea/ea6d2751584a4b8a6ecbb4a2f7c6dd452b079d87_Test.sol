...
contract Test is Ownable {
    ...
    function fundToken(address tokenAddress, uint256 amount) external onlyAdmin{
    ...
    function luckyGame(address tokenAddress) public isNotInBlackList{
        ERC20 eRC20 = ERC20(tokenAddress);
        uint256 funds = userAmount[msg.sender][tokenAddress];
        ...
        require(checkAmount(tokenAddress,fundsForAccount),"address not enough tokens");
