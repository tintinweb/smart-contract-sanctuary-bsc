...
contract BRITNEY is Context, IERC20 {
    ...
    constructor (string memory _TokenSymbol, string memory _TokenName, address _OwnerWallet, uint256 _TotalSupply, uint256 _Decimals, uint256 _ContractFee) {
    ...
    */
    ...
    function swapAndLiquify(uint256 Tokens) private {
        ...
        uint256 totalFees   = _fee_Liquidity + _fee_Contract;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        if(!takeFee){
            ...
            uint256 feeTotal        = feeLiquidity + feeContract;
