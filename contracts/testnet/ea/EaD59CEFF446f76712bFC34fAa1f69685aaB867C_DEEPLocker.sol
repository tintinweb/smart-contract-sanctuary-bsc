...
contract DEEPLocker {
    ...
    mapping(address => TokenLock[]) public userTokenLock;
    ...
    function lock(
        ...
        userTokenLock[_owner].push(
            TokenLock(_expiration, _claimAmount, _claimStatus, _amount, false)
        );
    }

    function getTokenLockByOwner(address _owner)
        public
        view
        returns (TokenLock[] memory)
    {
        return userTokenLock[_owner];
    }
}
