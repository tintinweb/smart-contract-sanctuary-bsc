...
pragma solidity ^0.6.12;
    ...
    contract BITCONEY is Context, IERC20, Ownable {
        ...
        uint256 private _tTotal = 210000 * 10**2 * 10**9;
        uint256 private _rTotal = (MAX - (MAX % _tTotal));
        uint256 private _tFeeTotal;

        string private _name = 'BITCONEY';
        string private _symbol = 'BITCONEY';
        ...
        uint256 private _maxTxAmount = 21000000e9;
        // We will set a minimum amount of tokens to be swaped => 5M
        uint256 private _numOfTokensToExchangeForCharity = 5 * 10**2 * 10**9;
