...
contract Binary_Land is Context {
    ...
    constructor() {
        // address headOfUpline, address _tetherToken
        owner = _msgSender();
        registrationFee = 70 ether;

        tetherToken = IERC20(0x8125bCDf55335b2A63AeAD5679A33f80d90a8cC5);
        lastRun = block.timestamp;
        numberOfRegisteredUsersIn_24Hours = 0;
        numberOfNewBalanceIn_24Hours = 0;
        constMaxBalanceForCalculatedReward = 10;
        
        _users[0x8125bCDf55335b2A63AeAD5679A33f80d90a8cC5] = Node({
        ...
        _usersAddresses.push(0x8125bCDf55335b2A63AeAD5679A33f80d90a8cC5);
    }
