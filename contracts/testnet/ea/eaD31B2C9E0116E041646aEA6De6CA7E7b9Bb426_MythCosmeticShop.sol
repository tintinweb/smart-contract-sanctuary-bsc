...
contract MythCityMods is ERC721 {
    ...
    function equipMod(uint256 _modId, uint256 _degenId) external isWhitelisted {
        require(
            modStats[_modId].degenIdEquipped == 0,
            "Mod is already Equipped"
        );
...
contract MythCosmeticShop {
    ...
    function unlockFreeCosmetics(uint256 _degenId) external {
        MythDegen tempDegen = MythDegen(degenAddress);
        MythDegen.stats memory tempDegenToken = tempDegen.getStats(_degenId);
        require(tempDegenToken.owner == msg.sender);
        uint256[] memory tempBackgrounds;
        tempBackgrounds[0] = 1;
        tempBackgrounds[1] = 2;
        tempBackgrounds[2] = 3;
        tempBackgrounds[3] = 4;
        ...
        tmpEyes[11] = 25;
        tmpEyes[12] = 30;
        tempDegen.unlockCosmetics(cosmeticAddress, _degenId, 1, tmpEyes);
        uint256[] memory tmpMouth;
        tmpMouth[0] = 1;
        tmpMouth[1] = 2;
        tmpMouth[2] = 3;
        tmpMouth[3] = 4;
        ...
        tmpMouth[12] = 13;
        tmpMouth[13] = 14;
        tempDegen.unlockCosmetics(cosmeticAddress, _degenId, 2, tmpMouth);
        uint256[] memory tmpNose;
        tmpNose[0] = 1;
        tmpNose[1] = 2;
        tmpNose[2] = 3;
        tempDegen.unlockCosmetics(cosmeticAddress, _degenId, 3, tmpNose);
        uint256[] memory tmpBodyColor;
        tmpBodyColor[0] = 1;
        tmpBodyColor[1] = 2;
        tmpBodyColor[2] = 3;
        tmpBodyColor[3] = 4;
        tmpBodyColor[4] = 5;
        tmpBodyColor[5] = 6;
        tempDegen.unlockCosmetics(cosmeticAddress, _degenId, 4, tmpBodyColor);
        uint256[] memory tempBody;
        tempBody[0] = 112;
        tempBody[1] = 113;
        tempBody[2] = 114;
        tempBody[3] = 115;
        ...
        tempBody[5] = 117;
        tempBody[6] = 118;
        tempDegen.unlockCosmetics(cosmeticAddress, _degenId, 5, tempBody);
        uint256[] memory tempHead;
        tempHead[0] = 113;
        tempHead[1] = 114;
        tempHead[2] = 115;
        tempHead[3] = 116;
        ...
        tempHead[5] = 118;
        tempHead[6] = 119;
        tempDegen.unlockCosmetics(cosmeticAddress, _degenId, 6, tempHead);
    }
}
