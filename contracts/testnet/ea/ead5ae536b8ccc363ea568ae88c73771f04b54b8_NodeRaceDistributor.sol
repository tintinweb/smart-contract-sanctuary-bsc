...
import {INodeRaceDistributor} from "../src/interfaces/INodeRaceDistributor.sol";
...
/**
 * @title FireCat's NodeRaceDistributor contract
 * @notice main: setNodeReward, claim
 * @author FireCat Finance
 */
contract NodeRaceDistributor is INodeRaceDistributor, FireCatAccessControl, FireCatTransfer, ModifyControl {
    ...
    /// @inheritdoc INodeRaceDistributor
    ...
    function setNodeReward(
        ...
        require(userArray_.length == rewardPerUser_.length, "NODE:E06");
        require(superUserArray_.length == rewardPerSuperUser_.length, "NODE:E06");
        ...
        for (uint256 i = 0; i < userArray_.length; i++) {
            ...
            userData[user_].receiveRewardThisCycle = rewardPerUser_[i];
        }
        ...
        for (uint i = 0; i < superUserArray_.length; i++) {
            ...
            superUserData[superUser_].receiveRewardThisCycle = rewardPerSuperUser_[i];
        }
...
/**
* @notice INodeRaceDistributor
*/
interface INodeRaceDistributor {
