...
contract Alora is ERC20Upgradeable {
  ...
  function setDepositAmount(uint256 _toDepositAmount) public onlyOwner {
    toDepositAmount = _toDepositAmount;
  }
  ...
  function depositToken(bytes32[] calldata merkleProof) public {
    ...
    require(IERC20(stableToken).balanceOf(msg.sender) >= toDepositAmount, "Insufficient balance");
    IERC20(stableToken).transferFrom(msg.sender, whiteListerfund, toDepositAmount);
