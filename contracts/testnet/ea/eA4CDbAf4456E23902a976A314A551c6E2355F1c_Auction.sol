...
contract Auction is Ownable{
    ...
    event Bid(address indexed _bidder, uint indexed _auctionId, uint256 time, address _lastBidder, uint _remainingBid, uint _bidCount);
    ...
    function bid(uint _auctionID) payable public {
        ...
        emit Bid(msg.sender, _auctionID, block.timestamp, msg.sender, auctionInfo[_auctionID].remainingBid, auctionInfo[_auctionID].bidCount);
    } 
