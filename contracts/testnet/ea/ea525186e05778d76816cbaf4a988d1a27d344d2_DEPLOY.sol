...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1_000 && newClaimWait <= 86_400, "claimWait must be updated to between 1 and 24 hours");
...
contract DEPLOY is ERC20, Ownable {
    ...
    constructor() payable ERC20("OpenAIReward2", "OPR2") {

        rewardToken = 0x0Eece39f8323012Ee0900EaD1DccD6e1E6e16eAb; // openaitoken for testnet
