    ...
    ERC721URIStorageUpgradeable
{
    ...
    function mintN(
        ...
        for (uint256 i = 0; i < _amount; i++) mint(_minter, _edition, _rarity);
    }

    function mint(address _minter, uint256 _edition, uint256 _rarity)
        public
        gameMasterOnly
        whenNotPaused
    {
        ...
        emit WeaponMinted(tokenId, _minter, _edition, _rarity, true, uint64(block.timestamp));
    }
    ...
    function mintFromChest(
        ...
        emit WeaponMinted(tokenId, _minter, _edition, _rarity, (_tradeable == 1), uint64(block.timestamp));
        return tokenId;
    }
