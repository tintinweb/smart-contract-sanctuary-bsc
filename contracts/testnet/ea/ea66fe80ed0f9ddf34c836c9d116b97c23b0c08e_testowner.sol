...
contract testowner is ERC20,Ownable {
    using SafeMath for uint256;

    address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // IDEX Router
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xd0250353fc8Ac86CB417FB9444be2d617E48dA6f;

    string private _name = "testowner";
    string private _symbol = "testowner";
