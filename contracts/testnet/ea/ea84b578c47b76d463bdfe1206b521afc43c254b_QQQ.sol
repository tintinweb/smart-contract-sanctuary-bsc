...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public _fundAddress2 = 0x9168Bb06fEBfeC3E76A8d2aAD9C32d694E0CeeD8;
    ...
    constructor (
        ...
        maxBuyAmount = 1888 * 6** Decimals;
        walletLimit =  1888 * 6** Decimals;
    ...
    function _funTransfer(
        ...
        uint256 feeAmount = tAmount * 500 / 1000;
        _takeTransfer(
            sender,
            fundAddress,
            feeAmount
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = usdtBalance * 300 * 2 / swapFee;
        uint256 fundAmount2 = usdtBalance * 200 * 2 / swapFee;
        USDT.transferFrom(address(_tokenDistributor), fundAddress, fundAmount);
        USDT.transferFrom(address(_tokenDistributor), _fundAddress2, fundAmount2);
        USDT.transferFrom(address(_tokenDistributor), address(this), usdtBalance - fundAmount-fundAmount2);
...
contract QQQ is AbsToken {
    constructor() AbsToken(
        ...
        6,
        100000,
        address(0x071b2A25D0c317D4295860304de117a7cE494F99),
        address(0x071b2A25D0c317D4295860304de117a7cE494F99)//ReceiveAddress
    ){
