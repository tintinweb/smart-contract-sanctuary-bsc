...
contract FIFAXXX is Context, IERC20, Ownable {
    using Address for address;

  // Need CHANGE  
    address payable public marketingWalletAddress = payable(0x6f7Ae91172b26041757AD306902e194d846aF32e); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x9aaC40B502da25A53124b7D855d674ed0eC8f129); // Reserve Wallet Address
    address payable public charityWalletAddress = payable(0x880B7D3F7fcE55Fb80e415Ee091594A446064964); // Charity Wallet Address
    address payable public devWalletAddress = payable(0xE8d4cc45032181771156B2913685504c6Bf07735); // Dev Wallet Address
 ...
 //   uint256 private _tTotal = 10**17 * 10**9;
    ...
    string private constant _name = "FIFA World Cup XXX";
    string private constant _symbol = "FIFAXXXH";
    ...
    constructor () {
      ...
      // Need CHANGE    
        address _owner = 0xb011ff100b33181Ae53C761A1a4F40d407131225;
