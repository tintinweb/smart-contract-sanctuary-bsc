...
contract LiquidityGeneratorToken is Context, IERC20, Ownable {
    ...
    address public router =  0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 ; //0x10ED43C718714eb63d5aA57B78B54704E256024E; // PCS v2 mainnet
    ...
    constructor (
        ...
        IPancakeRouter02 _pancakeRouter02 = IPancakeRouter02(router);
        
         // Create a uniswap pair for this new token
        pancakePair = IPancakeFactory(_pancakeRouter02.factory())
            .createPair(address(this), _pancakeRouter02.WETH());
        // emit PairAddress( paid)
