...
contract FOLLOW is Context, IERC20, Ownable {
    ...
    uint8 private constant _decimals = 18;
     ...
     //  buy fee
    uint256 public _buyLiquidityFee = 250;
    uint256 public _buyMarketingFee = 100;
    uint256 public _buyDevFee = 150;
    
    // sell fee
    uint256 public _sellLiquidityFee = 250;
    ...
    address public _devwallet = 0xbcf57C661A68E68A8EC1fC9fbE003F05de91F2c5;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10a0B96b730171C1B15AaD0ef56884827f92A7e8); // 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && !swapping){
            ...
            if (to == uniswapV2Pair) {
                ...
                uint256 tFee = amount.mul(_sellDevFee + _sellreflectFee + _sellLiquidityFee + _sellMarketingFee).div(1000);
