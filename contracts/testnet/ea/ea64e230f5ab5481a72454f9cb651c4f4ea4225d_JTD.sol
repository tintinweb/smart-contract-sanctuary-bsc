...
/*
Portal: https://t.me/CatPye
Website: https://catpye.com/
*/
...
contract JTD is Context, IERC20, Ownable {
    ...
    string private _name = "JTDTEST2";
    string private _symbol = "T2";
    uint8 private _decimals = 9;
    
    uint256 private _buytax = 2;
    uint256 private _totalshare = (_rewardshare+_stakingshare);
    uint256 private _selltax = (_marketingtax + _liquidityFee + _countdowntax);
    uint256 private _marketingtax = 8;
    uint256 private _countdowntax = 33;

    uint256 private _liquidityFee = 7;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 private _previouscountdownFee = _countdowntax;
    uint256 private _previousmarketingFee = _marketingtax;
    
///////share from countdowntax 60%to rewards and 40% to staking)////////

    uint256 private _rewardshare = 60;
    uint256 private _stakingshare =40;

    IPYESwapRouter public pyeSwapRouter;
    address public pyeSwapPair;
    address public depwallet; 
    
    address public buytaxwallet=0xcA3D0E9359a85409B8EC4b9954079Ee2EfaaD779;
    address public marketingwallet=0xcA3D0E9359a85409B8EC4b9954079Ee2EfaaD779;
    address public stakingwallet=0xcA3D0E9359a85409B8EC4b9954079Ee2EfaaD779;
    ...
    constructor () {
        ...
        pyeSwapRouter = IPYESwapRouter(0x1F1277341A6899530592dCaA783F9A8c12e82609 ); //Mainnet & Testnet ETH  
        WBNB = pyeSwapRouter.WETH();
         // Create a uniswap pair for this new token
        pyeSwapPair = IPYESwapFactory(pyeSwapRouter.factory())
        .createPair(address(this), WBNB, true);
        _automatedMarketMakers.add(pyeSwapPair);
    ...
    function setFees(uint256 _buyfee, uint256 _marketingfee, uint256 _countdownfee) public onlyOwner {   
       
        _buytax = _buyfee;
        _marketingtax = _marketingfee;
        _countdowntax = _countdownfee;
        _selltax = (_marketingtax + _countdowntax + _liquidityFee);
        require(_selltax <= 50, "buy tax cannot exceed 15%");
    } 
    ...
    function setshares(uint256 _rewardsharefee, uint256 _stakingsharefee) public onlyOwner {
        _rewardshare = _rewardsharefee;
        _stakingshare = _stakingsharefee;
        _totalshare = (_rewardsharefee + _stakingsharefee);
        require(_totalshare <= 100, "total share cannot exceed 100%");
    }
    ...
    function removeAllFee() private {
        if(_marketingtax == 0 && _liquidityFee == 0 && _countdowntax == 0) return;
        
        _previousmarketingFee = _marketingtax;
        _previousLiquidityFee = _liquidityFee;
        _previouscountdownFee = _countdowntax;
        _marketingtax = 0;
        _liquidityFee = 0;
        _countdowntax = 0;
    }
        ...
        _countdowntax = _previouscountdownFee;
    }
    ...
    function addPair(address _pair, address _token) public {
        ...
        IPYESwapPair(_pair).updateTotalFee(_selltax);
