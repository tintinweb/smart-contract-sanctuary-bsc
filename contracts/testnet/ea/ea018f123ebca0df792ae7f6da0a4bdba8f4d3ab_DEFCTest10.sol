...
contract DEFCTest10 is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    DEFCTest10DividendTracker public dividendTracker;
    ...
    constructor() BEP20("DEFCTest10", "DFCt10") 
    {
        dividendTracker = new DEFCTest10DividendTracker();
    ...
    {
        require(newAddress != address(dividendTracker), "DEFCTest10: The dividend tracker already has that address");
        DEFCTest10DividendTracker newDividendTracker = DEFCTest10DividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "DEFCTest10: The new dividend tracker must be owned by the DEFCTest10 token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "DEFCTest10: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "DEFCTest10: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "DEFCTest10: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "DEFCTest10: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "DEFCTest10: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "DEFCTest10: Cannot update gasForProcessing to same value");
...
contract DEFCTest10DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("DEFCTest10_Dividend_Tracker", "DEFCTest10_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000_000 * (10**18); //must hold 2 Millions+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "DEFCTest10_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "DEFCTest10_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DEFCTest10 contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "DEFCTest10_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "DEFCTest10_Dividend_Tracker: Cannot update claimWait to same value");
