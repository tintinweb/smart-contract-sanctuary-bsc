...
contract WethEthConverter is Ownable{
    ...
    function withdrawAndSendToSender2(uint256 _value) external onlyOwner { 
    ...
    /*
    function withdraw_approve(uint256 _value) external { 
    ...
    function withdraw_payable(uint256 _value) external { 

        IWETH(payable(WETH)).withdraw(_value);
    }

    function withdraw_approveAndPayable(uint256 _value) external { 
