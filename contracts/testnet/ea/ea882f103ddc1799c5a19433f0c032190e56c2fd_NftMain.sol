...
contract NftMain is ERC721URIStorage, Ownable, Authorized {
  ...
  constructor(address marketplaceAddress, address propWallet_, string memory name_, string memory symbol_) ERC721(name_, symbol_) {
...
contract MarketPlaceMain is ReentrancyGuard, Ownable , Authorized{
