...
import "./utils/ERC721Min.sol";
import "./lib/FullMath.sol";

/// @title ERC721StakingPool
/// @author zefram.eth
/// @notice A modern, gas optimized staking pool contract for rewarding ERC721 stakers
/// with Native tokens periodically and continuously
contract ERC721StakingPoolNativeReward is Ownable, IERC721Receiver {
    /// -----------------------------------------------------------------------
    /// Errors
    /// -----------------------------------------------------------------------
    ...
    uint256 private blocksPerDay = 28750;
    /// -----------------------------------------------------------------------
    /// Immutable parameters
    /// -----------------------------------------------------------------------
    ERC721Min immutable stakeToken;
    uint64 duration;
    ...
    constructor(
        ...
        stakeToken = ERC721Min(_stakeToken);
        duration = uint64(_duration * _blocksPerDay);
