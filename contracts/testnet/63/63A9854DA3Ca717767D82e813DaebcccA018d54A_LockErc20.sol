...
contract LockErc20 is Ownable, Pausable, WithSigner {
    ...
    mapping(IERC20 => mapping(address => uint256)) public depositBalances;
    mapping(IERC20 => mapping(address => uint256)) public lastDepositAmount;
    mapping(IERC20 => mapping(address => uint256)) public totalWitdraws; //can be more with depositBalances
    ...
    event Lock(IERC20 _token, uint256 _amount, address _from);
    ...
    function unLock(
        ...
        _token.transferFrom(msg.sender, address(this), _unLockAmount);
