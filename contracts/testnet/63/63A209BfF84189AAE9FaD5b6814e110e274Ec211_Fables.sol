...
//only minter
    ...
    function mintBatch(
        ...
        require(_tokenIdTracker.current() < 3000,"NFT is already limited");
        for(uint i = 0; i < _amount; i++){
            _mintToken(recipients);
        }
    }
...
//other
    function _mintToken(
        ...
        string memory i = uintToString(_tokenIdTracker.current());
        _setTokenURI(_tokenIdTracker.current(), string(abi.encodePacked( i, ".json")));
