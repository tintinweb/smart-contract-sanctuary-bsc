...
contract FOFPlayerController2 is Ownable {
    ...
    constructor() {
        FPN = FOFPlayerNFT(0x8918337F9aF8BC5a70EE804dc284B1d017665B27);
        FPC = FOFPlayerController(payable(0x74b58b15da0F0073069EB7e585ADb17Dc2330EF4));
...
contract FOFPlayerController3 is Ownable {
    ...
    constructor() {
        ...
        FPC2 = FOFPlayerController2(payable(0xEc945710A5eFA02c39fcE623714Ba120Bad77576));
