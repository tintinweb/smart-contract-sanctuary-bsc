...
contract Luxurytokentest is Context, IERC20, Auth {
    ...
    address payable public marketingWalletAddress = payable(0x8750618AA09104Ec1929f178e240131d9Dd9D7B8); // 
    address payable teamWalletAddress = payable(0x3dD96e68A2Ec6AdA0Ad37F357b1DF6a29E4313e9); //
    ...
    uint256 public _maxTxAmount = 5 * 10**9 * 10**9; //1 * 10**6 * 10**9;
    uint256 public _walletMax = 5 * 10**9 * 10**9;
