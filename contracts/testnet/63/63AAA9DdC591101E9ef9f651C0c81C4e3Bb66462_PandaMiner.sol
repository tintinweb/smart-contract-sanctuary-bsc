...
contract PandaMiner is Ownable, ReentrancyGuard {
    ...
    constructor() {
        address tokenAddress = 0x40C929d7A74BE7c5C73e12491fc3776522241b4c;
    ...
    // Claim daily reward
    function claimDailyRewards() public noReentrant alreadyInit {
        require(
            investors[msg.sender].lastClaim <= block.timestamp,
            "You cant claim"
        );
    ...
    function withdraw() public noReentrant alreadyInit {
        require(
    ...
    function unStake() external noReentrant alreadyInit {
