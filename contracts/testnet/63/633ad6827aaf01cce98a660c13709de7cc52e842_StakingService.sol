...
contract StakingService is PausableByOwner, RecoverableByOwner {
	...
	uint128 supplyPercent_01 = 1;
	uint128 supplyPercent_02_04 = uint128(ABDKMath64x64.divu(12, 10));
	uint128 supplyPercent_05_50 = uint128(ABDKMath64x64.divu(103, 100));
	uint128 supplyPercent_51_134 = uint128(ABDKMath64x64.divu(9999, 10000));
	uint128 supplyPercent_135_200 = uint128(ABDKMath64x64.divu(998, 1000));
	uint128 supplyPercent_201_429 = uint128(ABDKMath64x64.divu(996, 1000));
	uint128 supplyPercent_430_755 = uint128(ABDKMath64x64.divu(99978, 100000));
	uint128 supplyPercent_756_1557 = uint128(ABDKMath64x64.divu(9996, 10000));
	uint128 supplyPercent_1558_2200 = uint128(ABDKMath64x64.divu(9994, 10000));
	uint128 supplyPercent_2201_3274 = uint128(ABDKMath64x64.divu(99943, 100000));
	uint128 supplyPercent_3275_3728 = uint128(ABDKMath64x64.divu(999429, 1000000));
	...
	function _makeProgress(
        ...
        if (time <= state.time) return state.totalTokenSupply;
		uint40 shift = time - DISTRIBUTION_START_TIME;
		uint16 tdays = uint16(shift / DAY) ;
		uint16 week = 0;
		uint128 percent;
		//uint256 tokenSupply = 0;
		uint256 tempAmount = firstTokenSupply;
		for (uint i = 0; i < tdays; i++) {
			week = uint16(i / 7);
			if (week == 1) {
				percent = supplyPercent_01;
			} else if (week > 1 && week <= 4) {
				percent = supplyPercent_02_04;
			} else if (week >= 5 && week <= 50) {
				percent = supplyPercent_05_50;
			} else if (week >= 51 && week <= 134) {
				percent = supplyPercent_51_134;
			} else if (week >= 135 && week <= 200) {
				percent = supplyPercent_135_200;
			} else if (week >= 201 && week <= 429) {
				percent = supplyPercent_201_429;
			} else if (week >= 430 && week <= 755) {
				percent = supplyPercent_430_755;
			} else if (week >= 756 && week <= 1557) {
				percent = supplyPercent_756_1557;
			} else if (week >= 1558 && week <= 2200) {
				percent = supplyPercent_1558_2200;
			} else if (week >= 2201 && week <= 3274) {
				percent = supplyPercent_2201_3274;
			} else if (week >= 3275 && week <= 3728) {
				percent = supplyPercent_3275_3728;
			}
			tempAmount *= percent;
			tokenSupply += tempAmount;
		}

		uint40 restOfDay = shift - (tdays * DAY);
		tokenSupply += uint256(tempAmount * restOfDay / DAY);
		state.time = time;
