...
contract ConditionalTokenGovernance is GovernorVotes, Roles {
    uint256 private _votingDelay;
    uint256 private _votingPeriod;
    uint256 private _votingThreshold;
    ...
    ) public override onlyRole(GUARDIAN_ROLE) returns (uint256) {
    ...
    ) public payable override onlyRole(GUARDIAN_ROLE) returns (uint256) {
        uint proposalId = super.execute(targets, values, calldatas, descriptionHash);
        return 0;
    }
    ...
    function _countVote(
        ...
        require(weight >= votingThreshold(), "GovernorVotingSimple: Minimum Holding not reached");
     ...
     */
    function setVotingDelay(uint256 newVotingDelay) public virtual onlyRole(GUARDIAN_ROLE) {
     ...
     */
    function setVotingPeriod(uint256 newVotingPeriod) public virtual onlyRole(GUARDIAN_ROLE) {
     ...
     */
    function setVotingThreshold(uint256 newVotingThreshold) public virtual onlyRole(GUARDIAN_ROLE) {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(AccessControl, Governor) returns (bool) {
