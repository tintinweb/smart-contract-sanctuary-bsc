...
contract Token is ERC20, Ownable, ReentrancyGuard {
    ...
    function swapBack() internal {
        ...
        uint256 totalOut = marketingOut[1] + teamOut[1] + liquifyOut[1];
        ...
        uint256 toMarketing = (newBalance * marketingOut[1]) / totalOut;
        uint256 toTeam = (newBalance * teamOut[1]) / totalOut;
        uint256 toLiquify = (newBalance * liquifyOut[1]) / totalOut;
        ...
        returns (uint256, uint256)
    {
        ...
        uint256 tempTeamToken = (fees * marketingBuyTax) / tempDenominator;
        uint256 tempLiquifyToken = fees - tempMarketingToken - tempTeamToken;
        marketingToken += tempMarketingToken;
        liqudityToken += tempTeamToken;
        teamToken += tempLiquifyToken;
        ...
        returns (uint256, uint256)
    {
        ...
        fees =
            ...
            taxDenominator;
        marketingToken += (fees * marketingSellTax) / tempDenominator;
        liqudityToken += (fees * liquiditySellTax) / tempDenominator;
        teamToken += (fees * teamSellTax) / tempDenominator;
