...
contract Archie_Staking is Ownable{
    ...
    mapping(uint256 => uint256) public allocationAmount;
    mapping(uint256 => uint256) public Amountlimit;
    ...
    constructor(ITRC20 _token)  {
        ...
        Amountlimit[1]=500;
        Amountlimit[90]=1000;
        Amountlimit[180]=1500;
        Amountlimit[360]=5000;
    ...
    function farm(uint256 _amount, uint256 _lockableDays) public 
    {
        ...
        require(allocation[_lockableDays] > 0, "Invalid day selection");
         allocationAmount[_lockableDays]+=_amount;
        require( allocationAmount[_lockableDays]<Amountlimit[_lockableDays],"Limit exceed!");
