...
contract SoulCore is DivestorUpgradeable, RandomGeneratorUpgradeable {
    ...
    interStruct public interInfo;

    function initialize(address USDT_, address defaultAddress) public initializer {
        __Divestor_init();
        coreInfo = coreStruct({
    ...
    function createToken(uint gender, uint amount, uint soulCount, address recommender) public returns(bool){
        ...
        interInfo.soul721.mint(_msgSender(), tokenId);
        interInfo.soul1155.mint(_msgSender(), tokenId, amount);
        ...
        if(soulCount > 0){
            ...
            //销毁soul
            interInfo.soulToken.burn(soulCount);
        }
    ...
    function extractToken(uint gender, address recommender) public returns(uint){
        ...
        //给抽取者1枚soul========================================
        interInfo.soulToken.transfer(_msgSender(), 1);
       ...
       interInfo.soul1155.safeTransferFrom(address(this), _msgSender(), tokenId, 1, '');
    ...
    function getFree(uint gender_, address recommender_, uint isJump_) private returns(uint){
        ...
        if(gender_ == 1){
            ...
            address caster = interInfo.soul721.ownerOf(tokenId);
...
contract SoulmetaItem1155 is Ownable, ERC1155Burnable {
    using Address for address;
    using Strings for uint256;
...
// SPDX-License-Identifier: GPL-3.0
pragma solidity ^0.8.4;
import "../soul/soul_item_builder_721.sol";
...
// SPDX-License-Identifier: GPL-3.0
pragma solidity ^0.8.4;
import "../soul/soul_item_1155.sol";
