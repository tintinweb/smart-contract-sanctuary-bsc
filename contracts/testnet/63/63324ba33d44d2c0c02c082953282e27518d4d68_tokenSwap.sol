...
contract tokenSwap {
   ...
   function swap() external {
     ...
     IUniswapV2Router(PANCAKE_V2_ROUTER).swapExactTokensForTokensSupportingFeeOnTransferTokens(amountIn, amountOutBUSDFromBNB, path1, address(this), block.timestamp);    
     ...
     IERC20(BUSD).approve(PANCAKE_V2_ROUTER, amountOutBUSDFromBNB);  
