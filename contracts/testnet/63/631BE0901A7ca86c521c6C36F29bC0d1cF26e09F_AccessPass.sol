...
contract AccessPass is ERC1155, Ownable, Pausable {
        ...
        returns (uint256)
    {
        uint256 result;
        if (id == 0) {
            result = pricesUSD[0].div(uint256(getLatestPrice())).mul(10**8);
        } else if (id == 1) {
            result = pricesUSD[1].div(uint256(getLatestPrice())).mul(10**8);
        } else if (id == 2) {
            result = pricesUSD[2].div(uint256(getLatestPrice())).mul(10**8);
        } else if (id == 3) {
            result = pricesUSD[3].div(uint256(getLatestPrice())).mul(10**8);
        } else if (id == 4) {
            result = pricesUSD[4].div(uint256(getLatestPrice())).mul(10**8);
        } else if (id == 5) {
            result = pricesUSD[5].div(uint256(getLatestPrice())).mul(10**8);
        }
