...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * @dev Returns the name of the token.
     */
    function name() public view virtual override(IERC20Metadata, IERC20) returns (string memory) {
        return _name;
    }
...
contract Pool is WeightedMath, HedgePoolToken {
    ...
    constructor(NewPoolParams memory params) {
        ...
        //setName("LP - " + _token0.name());
        setName(string(bytes.concat(bytes("Hedge LP "), bytes(_token0.name()), " - ", bytes(_token1.name()))));
    }
