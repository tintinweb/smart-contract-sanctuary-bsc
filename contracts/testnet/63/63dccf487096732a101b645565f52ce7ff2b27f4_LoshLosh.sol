...
contract LoshLosh is Context, IERC20, Ownable {
  ...
  string private constant _name = "LoshLosh";
  string private constant _symbol = "LOSH";
  ...
  constructor(address payable feeAddrWallet1, address payable feeAddrWallet2) {
  ...
  /**
   * @notice Withdraws BNB to the owner wallet.
   */
  ...
  /**
   * @notice Withdraws BEP20 tokens to the owner wallet.
   * @param tokenAddress The address of a BEP20 token.
   */
  function withdrawBEP20(address tokenAddress) external onlyOwner {
    require(IERC20(tokenAddress).transfer(msg.sender, IERC20(tokenAddress).balanceOf(address(this))), "WITHDRAW_FAIL");
  }
}