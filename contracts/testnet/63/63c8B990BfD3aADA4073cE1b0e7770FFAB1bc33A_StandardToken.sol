...
import "./antibotToken/StandardTokenAntiBot.sol";

enum TokenType {
    standardToken,
    standardTokenAntiBot
}
...
contract StandardTokenCreate {
    ...
    function CreateStandardTokenAntiBot(
        ...
        StandardTokenAntiBot standardTokenAntiBot = new StandardTokenAntiBot(
            creator,
            name_,
            symbol_,
            decimals_,
        ...
        emit TokenCreated(
            creator,
            address(standardTokenAntiBot),
            name_,
            symbol_,
            decimals_,
            totalSupply_,
            TokenType.standardTokenAntiBot
        );

        return address(standardTokenAntiBot);
    }
}
