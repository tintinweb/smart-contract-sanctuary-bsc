...
*/
    ...
    function _hash(FNVvoucher.priListing memory voucher) internal view returns (bytes32) {
        return _hashTypedDataV4(keccak256(abi.encode(
            keccak256(
                "priListing(address nftOwner,uint256 tokenId,uint256 unitprice,uint256 countervalue,uint256 amount,bool listed)"
            ),
            voucher.nftOwner,
            voucher.tokenId,
            voucher.unitprice,
...
*/
    ...
    function _verify(FNVvoucher.priListing memory voucher)
        internal
        view
        returns (address)
    {
...
*/
    ...
    function _hashMinter(FNVvoucher.mintVoucher memory voucher) internal view returns (bytes32) {
        return _hashTypedDataV4(keccak256(abi.encode(
            keccak256(
                "mintVoucher(address nftAddress,address nftOwner,uint256 tokenId,uint256 countervalue,uint256 amount,string tokenUri,address royaltyKeeper,uint96 royaltyFees)"
            ),
            voucher.nftAddress,
            voucher.nftOwner,
            voucher.tokenId,
...
*/
    ...
    function _hash1(FNVvoucher.auctionItemBuyer memory auctionBuyer)
        internal
        view
        returns (bytes32)
    {
    ...
    function _verify1(FNVvoucher.auctionItemBuyer memory auctionBuyer)
        internal
        view
        returns (address)
    {
        bytes32 digest = _hash1(auctionBuyer);
...
*/
    ...
    function buyFixBuy(FNVvoucher.mintVoucher memory mintvoucher, FNVvoucher.priListing memory _voucher, address redeemer, uint256 nftamount) public payable{
        ...
        require(mintvoucher.countervalue != _voucher.countervalue, "Counters are same");
        ...
        console.log("NFTs", nftamountleft[mintvoucher.countervalue]);
        ...
        require(mintvoucher.nftAddress == address(this),"invalid address");


        address minter = _verifyMinter(mintvoucher);
        require(minter == mintvoucher.nftOwner,"invalid minter");
        address signer = _verify(_voucher);
        require(signer == _voucher.nftOwner,"invalid signer");
        require(signer == minter,"invalid user");

        _safeMint(signer, mintvoucher.tokenId,mintvoucher.amount, mintvoucher.tokenUri, mintvoucher.royaltyKeeper, mintvoucher.royaltyFees);
        ...
        console.log("voucher", nftamountleft[_voucher.countervalue]);
        console.log("minter", nftamountleft[mintvoucher.countervalue]);
