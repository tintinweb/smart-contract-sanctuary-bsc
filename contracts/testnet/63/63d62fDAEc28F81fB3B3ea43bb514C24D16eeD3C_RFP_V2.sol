...
contract RFP_V2 is IBEP20, Ownable {
    ...
    address  charityAddress = 0x783071c98dDf4ad067E73EbFf8DfDd6011fB54f6;
    ...
    constructor() {
       // router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //mainent
        ...
        isFeeExempt[charityAddress]=true;
    ...
    function takeFee(address sender,uint256 amount, address to) internal returns (uint256) {
        ...
        burnAmount =feeAmount.mul(2).div(100);
    ...
    function swapBackInBnb() internal swapping {
        ...
        uint256 tokensToMarketing = contractTokenBalance.mul(marketingSwap).div(totalSwap);
        
        uint256 tokensToDev = contractTokenBalance.sub(tokensToLiquidity).sub(tokensToReward).sub(tokensToMarketing);
    ...
    function setCharityAddress(address _stakePool) external onlyOwner {
        charityAddress = _stakePool;
    }
