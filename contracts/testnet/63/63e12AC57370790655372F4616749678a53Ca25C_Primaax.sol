...
contract Primaax is ERC20, Ownable {
    ...
    returns(uint gTotalBonus, uint sTotalBonus, uint totalBonus, uint rClaimed, uint gSales, uint gEnd) {
        ...
        for(uint256 i = 0; i < downline[puser].length; i++) {
            ...
            else if(direct_down.flushAmt >= theSecond) {
        ...
        if(user.flushDeathline < block.timestamp) {
            ...
            if(lowest > 10000e18 && gi.claimed[0] < 1 && gi.level < 1 && user.totalStake >= 2500e18) {
                groupBonus += 10000e18;
            }

            if(lowest > 100000e18 && gi.claimed[1] < 3 && gi.level < 2 && user.totalStake >= 25000e18) {
                groupBonus += 100000e18;
            }

            if(lowest > 500000e18 && gi.claimed[2] < 2 && gi.level < 3 && user.totalStake >= 125000e18) {
                groupBonus += 500000e18;
            }

            if(lowest > 1000000e18 && gi.claimed[3] < 1 && gi.level < 4 && user.totalStake >= 250000e18) {
                groupBonus += 1000000e18;
            }

            if(lowest > 5000000e18 && gi.claimed[4] < 1 && gi.level < 5 && user.totalStake >= 1250000e18) {
                groupBonus += 5000000e18;
            }

            if(lowest > 10000000e18 && gi.claimed[5] < 1 && gi.level < 6 && user.totalStake >= 2500000e18) {
    ...
    function userGroupInfo(address _user) external view returns(
        ...
        for(uint256 i = 0; i < downline[puser].length; i++) {
            ...
            else if(direct_down.flushAmt >= real_second) {
                if(gi.legOne != downline[puser][i]) {
                    real_rest += real_second;
