...
contract Randomable is VRFConsumerBase, Initializable {
    ...
    function __Randomable_init() internal onlyInitializing {
        __Randomable_init_unchained();
    }

    function __Randomable_init_unchained() internal onlyInitializing {
        VRFConsumerBase.initialization(
...
abstract contract VRFConsumerBase is VRFRequestIDBase {
   ...
   */
  function initialization(address _vrfCoordinator, address _link) public {
