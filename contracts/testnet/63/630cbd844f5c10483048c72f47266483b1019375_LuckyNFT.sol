 ...
 */
    ...
    function mintNFTByBox(address recipient, string memory tokenURI)
        public
        onlyAdmin
...
================================================================
 */
    function getLuckyNFT(string memory tokenURI)
        public
        onlyLuckyWallet(msg.sender)
        eventGoingOn
        returns (uint256)
    {
        address recipient = msg.sender;
        uint256 res = nftCollection.mintNFT(recipient, tokenURI);
