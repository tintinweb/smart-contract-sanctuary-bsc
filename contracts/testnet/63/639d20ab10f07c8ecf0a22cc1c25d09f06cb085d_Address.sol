...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xcEE348B197B737F264e9A36713b8cC6A75F81Fd2;
...
contract ZackToken is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x883856de661731939D268B4AcBD37Ea4D421d6BB;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "ZackToken";
    string private _symbol = "ZTK";
