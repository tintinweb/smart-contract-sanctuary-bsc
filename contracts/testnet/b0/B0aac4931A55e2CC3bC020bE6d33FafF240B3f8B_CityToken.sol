...
contract CityToken is ERC20Upgradeable {
    // ADDRESSESS -------------------------------------------------------------------------------------------
    ...
    function setW1(address newAddress)
        public
        virtual
    {
    ...
    function setW2(address newAddress)
        public
        virtual
    {
        require(w1Percent >= 0, "Burn amount should be greater than ZERO_ADDRESS");
    }

    function setW3(address newAddress)
        public
        virtual
    {
        require(w1Percent >= 0, "Burn amount should be greater than ZERO_ADDRESS");
    ...
    function setW4(address newAddress)
        public
        virtual
    {
        require(w1Percent >= 0, "Burn amount should be greater than ZERO_ADDRESS");
    ...
    function setW5(address newAddress)
        public
        virtual
    {
        require(w1Percent >= 0, "Burn amount should be greater than ZERO_ADDRESS");
