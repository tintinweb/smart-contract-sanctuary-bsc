...
contract Z2_msp is IBEP20, Auth {
    ...
    string constant _name = "Z2_MSP";
    string constant _symbol = "Z2msp";
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function transferForeignToken(address _token) external onlyOwner returns (bool) {
        ...
        _balances[address(this)] = _balances[address(this)].sub(_contractBalance);
        return true;
    }
