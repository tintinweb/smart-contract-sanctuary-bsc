...
contract OpenBiSea is Ownable  {
    ...
    event ClaimFreeTokens(uint256 amount, address investor,bool result, uint256 amountTotalUSDwei, uint256 incomeInOBSfromUser, uint256 percentOfSales);
...
//        uint256 usdPriceOBS = newPriceOBS.mul(priceMainToUSD).div(10 ** decimals);
        ...
        emit ClaimFreeTokens(tokensToPay, msg.sender,result, amountTotalUSDwei, incomeInOBSfromUser, percentOfSales);
        return result;
    }
