...
contract SleepToken is ERC20Capped, Auth {
    using SafeMath for uint256;

    uint256 public cappedSupply = 300000000 * 10**18;

    uint256 public presaleTokens = 85000000 * 10**18;
    uint256 public marketingTokens = 6500000 * 10**18;
    uint256 public initialBurnTokens = 4500000 * 10**18;
    uint256 public teamAllocatedTokens = 5000000 * 10**18;
    uint256 public initialTokenSupply =
        presaleTokens.add(marketingTokens).add(initialBurnTokens).add(
            teamAllocatedTokens
        );
    ...
    uint256 public maxTxAmount = cappedSupply;
    uint256 public maxWalletToken = cappedSupply;
    ...
    uint256 public swapThreshold =
        (cappedSupply.mul(uint256(50))).div(uint256(10000));
    bool inSwap = false;
    ...
    constructor()
        ERC20("Sleep Token", "SLEEP")
        ERC20Capped(cappedSupply)
        Auth(msg.sender)
    {
        pancakeSwapRouter = IUniswapV2Router(ROUTER);
        createdPairAddress = IUniswapV2Factory(pancakeSwapRouter.factory())
    ...
    function _transfer(
        ...
        if (
            ...
            require(
                ...
                "Please wait for 1 block between two buys"
            );
        ...
        uint256 amountReceived = shouldTakeFee(_sender)
            ...
            : _amount;
        _mint(_recipient, amountReceived);
