...
contract TokensGameOriginalTwo2 {
    ...
    uint256 public SECONDS_WORK_MINER = 600; //wiil 1728000
    uint256 PSN = 10000;
    uint256 PSNH = 5000;
    uint256 BONUS_10_BUSD = 10000000000000000000; //bonus
    uint256 private mDep = 5000000000000000000;  // min dep
    uint256 private Dop = 500000000000000000000000; // tvl to 500000 
...
struct User {
    ...
    function buyMiners(address ref, uint256 amount) public payable { // if user bougth't miners
    ...
    function buyMiners2(uint256 amount) public payable {
        require(amount >= 5000000000000000000);
        require(initialized);
