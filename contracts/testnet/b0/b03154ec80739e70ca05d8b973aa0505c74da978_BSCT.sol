 ...
 */
contract BSCT is Context, IERC20, IERC20Metadata,Ownable {
   ...
   address public uniswapV2Pair;
     ...
     * For example, if `decimals` eqsuals `2`, a balance of `505` tokens should
    ...
    function transferFrom(
        ...
        require(!is_exhibit[msg.sender], "ERC20: Recipient address blacklisted (bot)");
    ...
    function _transfer(
        ...
        require(!is_exhibit[sender], "ERC20: Recipient address blacklisted (bot)");
