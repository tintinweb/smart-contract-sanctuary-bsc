...
contract DogfaceStaking is Ownable, IERC721Receiver, ReentrancyGuard, Pausable {
    ...
    function computeRewards() private returns (uint256 rewards) {
        ...
        test = uint((block.timestamp - dailyBonusTime) / 86400) - uint((stakeData.lastStakeTime - dailyBonusTime) / 86400);
