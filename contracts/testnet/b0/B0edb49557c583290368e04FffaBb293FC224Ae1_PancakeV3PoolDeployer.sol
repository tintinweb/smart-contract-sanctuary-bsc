...
contract PancakeV3Pool is IPancakeV3Pool {
    ...
    function swap(
        ...
        SwapCache memory cache = SwapCache({
            ...
            feeProtocol: zeroForOne ? (slot0Start.feeProtocol % 65535) : (slot0Start.feeProtocol >> 16),
    ...
    function flash(
        ...
        if (paid0 > 0) {
            uint32 feeProtocol0 = slot0.feeProtocol % 65536;
    ...
    function setFeeProtocol(uint32 feeProtocol0, uint32 feeProtocol1) external override lock onlyFactoryOwner {
        ...
        emit SetFeeProtocol(feeProtocolOld % 65536, feeProtocolOld >> 16, feeProtocol0, feeProtocol1);
    }
