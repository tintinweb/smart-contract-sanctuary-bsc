...
interface IMarnusToken is IERC20 {
...
import {IMarnusToken} from "../interfaces/IMarnusToken.sol";

contract MarnusToken is ERC20, Ownable, IMarnusToken {
     ...
     */
    constructor(uint256 _cap) ERC20("MARNUS", "MAR") {
