...
contract IWrap{
    ...
    address public usdt = 0x51A6088FA137D19a2D5CCb21458Ce7E5cB5ecA8c;    // bsctestnet
    ...
    function withdraw() public onlyOwner returns(bool) {
        ...
        IERC20(usdt).transfer(mafia, usdtAmount);
        return true;
    }
    ...
    function setMafia(address _mafia) public onlyOwner{
        mafia = _mafia;
    }
