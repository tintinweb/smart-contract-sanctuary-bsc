...
contract InsuranceFundV1 is Ownable {
    ...
    function changeRewardRate(uint256 rewardRate) external onlyOwner {
        generalNFTReward.changeRewardRate(rewardRate);
    }
...
interface IGeneralNFTReward {
    ...
    function changeRewardRate(uint256 rewardRate) external;
