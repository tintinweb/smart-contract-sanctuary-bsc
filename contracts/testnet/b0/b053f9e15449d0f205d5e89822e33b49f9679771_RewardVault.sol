...
// File: interfaces/IRewardVault.sol
...
contract RewardVault is IRewardVault, Ownable, AccessControl, Initializable{
    ...
    function setNewRound(uint256 _phaseSupply, uint8 _phaseCount, uint256[] memory _coeffs) override external onlyRole(SUPPLY_ROLE) {
    ...
    function mineGoldX(address sender, uint256 fuseGAmount) override external {
    ...
    function changeOwner(address newOwner) override external {
