...
contract ChocolateSwap is ERC20, Ownable {
    ...
    address public marketingWallet = 0xF16E43c0D1e8240E6100B65539d6168A5D22C764;
    ...
    constructor() payable ERC20("ChocolateSwap", "Chocolate") {
    	...
    	dividendTracker = new DividendTracker(totalSupply() / 50000, rewardToken);//minimum dist 1 BUSD
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if(LiquidityShare > 0){
                    uint256 LiquidityBNB = newBalance * LiquidityShare / bnbShare;
                   swapAndLiquify(LiquidityBNB);
                }
            }
