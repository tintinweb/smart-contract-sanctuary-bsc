...
Ryoshiba Nakamoto INU 0.5 $HALFSATS

This Community Driven Memecoin launched on the Binance Smart Chain, was created to pay homage to the
greatest meme dev of all time, as well as the individual(s) who brought to the world, the blockchain.
Together, these people have created generational wealth a million times over for tens of thousands
of people. 

Let’s show them our love by taking their names to the moon, and creating the same opportunity for
Generational Wealth for many more in the ever-thriving Defi space.

Telegram: https://t.me/RyoshibaNakamotoPortal
Twitter: https://twitter.com/0point5sats?s=21&
Website: https://ryomoto.com/
...
contract RyoshibaNakamotoINU0point5 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    RyoshibaNakamotoINU0point5DividendTracker public dividendTracker;
    ...
    constructor() ERC20("RyoshibaNakamotoINU0point5", "HALFSATS") {
        marketingWallet = payable(0x8D865E55672DBfc0A064F39134eFce83405A9e57); 
        ...
        dividendTracker = new RyoshibaNakamotoINU0point5DividendTracker(
            payable(this),
            router,
            0x7a0750F32e8016AC5DEb5517Edf9b7005c95E680,
            "RyoshibaNakamotoINU0point5TRACKER",
            "HALFSATSTRACKER"
        );
        ...
        swapTokensAtAmount = totalTokenSupply / 400; // .25%;
...
contract RyoshibaNakamotoINU0point5DividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    RyoshibaNakamotoINU0point5 public RyoshibaNakamotoINU0point5Contract;
    ...
    constructor(
        ...
        defaultToken = token;
        RyoshibaNakamotoINU0point5Contract = RyoshibaNakamotoINU0point5(mainContract);
    ...
    function _transfer(
        ...
        require(false, "RyoshibaNakamotoINU0point5_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "RyoshibaNakamotoINU0point5_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main RyoshibaNakamotoINU0point5 contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(RyoshibaNakamotoINU0point5Contract);

            uint256 prevBalance = RyoshibaNakamotoINU0point5Contract.balanceOf(address(this));
            ...
            {
                uint256 received = RyoshibaNakamotoINU0point5Contract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    RyoshibaNakamotoINU0point5Contract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
