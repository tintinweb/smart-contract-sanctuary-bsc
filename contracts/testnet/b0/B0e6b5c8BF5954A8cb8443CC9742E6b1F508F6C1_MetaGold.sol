...
//    address public busdToken = 0xe9e7cea3dedca5984780bafc599bd69add087d56; //mainnet
    ...
    uint256 public minimalMarketCap = 6000000; //1%
    ...
    function getPriceMETAUSD(uint256 inAmount) public view returns (uint256) {
    ...
    function getPriceMETAUSD_direct(uint256 inAmount) public view returns (uint256) {
    ...
    function getMarketCapUSD() public view returns(uint256 marketCap) {
        ...
        uint256 currentPrice = getPriceMETAUSD(1 * 10**18);
        uint256 mc = totalsupply.mul(currentPrice).div(1*10**18);
        return mc;
    }
