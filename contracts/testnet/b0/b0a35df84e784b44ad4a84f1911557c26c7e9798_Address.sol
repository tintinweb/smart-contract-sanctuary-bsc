...
contract VRS is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xe0287FD73659b391129860c80dEFE512bB1fe47c); 
    address payable public developmentAddress = payable(0xe0287FD73659b391129860c80dEFE512bB1fe47c); 
    address payable public charityAddress = payable(0xe0287FD73659b391129860c80dEFE512bB1fe47c); 
    address payable public vaultRewardAddress = payable(0xe0287FD73659b391129860c80dEFE512bB1fe47c); 
    ...
    string private constant _name = "VIRTUALSTUDIO";
    string private constant _symbol = "VRS";
