...
contract ContractsRegistry is IContractsRegistry, AccessControlUpgradeable {
    ...
    bytes32 public constant CLAIM_VOTING_FACADE_NAME = keccak256("CLAIM_VOTING_FACADE");
    ...
    function getClaimVotingFacadeContract() external view override returns (address) {
        return getContract(CLAIM_VOTING_FACADE_NAME);
    }
