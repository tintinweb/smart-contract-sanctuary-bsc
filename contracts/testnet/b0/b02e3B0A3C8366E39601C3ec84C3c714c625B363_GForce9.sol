...
contract GForce9 is Ownable {
    ...
    constructor() {
        ...
        setPricePerDraw(1,50000000000000000);
        setPricePerDraw(2,150000000000000000);
        setPricePerDraw(3,350000000000000000);
        setPricePerDraw(4,750000000000000000);
        setPricePerDraw(5,1550000000000000000);
        setPricePerDraw(6,3150000000000000000);
        setPricePerDraw(7,6350000000000000000);
        setPricePerDraw(8,12750000000000000000);
        setPricePerDraw(9,25550000000000000000);
        setPricePerDraw(10,51150000000000000000);
        setPricePerDraw(11,102350000000000000000);
        setPricePerDraw(12,204750000000000000000);
    }
  ...
  function printUser(uint256 level, address id) public view returns(string memory) {
    ...
    function claim1(uint256 amount) public onlyOwner {
