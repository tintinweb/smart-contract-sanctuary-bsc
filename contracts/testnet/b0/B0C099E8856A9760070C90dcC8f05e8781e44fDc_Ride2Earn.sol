...
contract Ride2Earn is BEP20Detailed, Ownable, WhitelistedRole {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 5000000000 * 10**DECIMALS;
    ...
    uint256 public buyFeemarketing = 1;
    uint256 public sellFeeDevelopmentAdded = 3;
    uint256 public sellFeemarketingAdded = 3;
 ...
 uint256 public maxSellTransactionAmount = INITIAL_FRAGMENTS_SUPPLY;
    ...
    constructor() BEP20Detailed("Ride2Earn", "RDN", uint8(DECIMALS)) {
