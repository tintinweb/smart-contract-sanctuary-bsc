    ...
    ReentrancyGuard
{
    ...
    function liquidate() external nonReentrant {
        ...
        if (getUnderlyingAssetType() == 1) {
            ...
            UnderlyingAssetLending.approveBurnNFT(posiNftFactory);
            ...
            uint256 balanceAfter = IERC20(tokenMapped).balanceOf(address(this));
            UnderlyingAssetLending.updateUnderlyingAmount(balanceAfter - balanceBefore);
        }
...
//    ) internal {}
    ...
    function approveBurnNFT(address positionFactory) internal {
...
interface IPositionBondFunction {
    ...
    external
    view
    returns (uint256 totalPairAmount);
}
...
abstract contract BondStatusLending {
    ...
    event BondMatured(uint256 matured);
    enum Status {
        Pending,
        OnSale,
        Active,
