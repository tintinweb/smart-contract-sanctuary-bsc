...
contract LupiToken is IERC20{
    ...
    string public constant name = "LupiToken 02";    // Nombre del token
    string public constant simbol = "LUPT2";      // Acrónimo del token
    uint8  public constant decimals = 10;       // Cantidad de decimales con los que se puede operar
    uint   public constant totalsupply = 10000000000000;  // Cantidad total de tokens existentes
