...
contract DragpnsPresale is Presaleable, Pausable {
	...
	uint256 public constant PRICE_TRAINER = 260000000000000000; // 0.26 BNB
	uint256 public constant PRICE_EXPERT = 540000000000000000; // 0.54 BNB
	uint256 public constant PRICE_MASTER = 1340000000000000000; // 1.34 BNB
	uint256 public constant PRICE_GRANDMASTER = 2700000000000000000; // 2.70 BNB
	...
	constructor() {
		...
		PRESALE_START_TIMESTAMP = 1648818212;
		PRESALE_END_TIMESTAMP = 1690895012;
	 ...
	 */
	function buyPackage(uint8 _type)
		external
		payable
		onlyWhitelisted
		onlyDuringPresale
