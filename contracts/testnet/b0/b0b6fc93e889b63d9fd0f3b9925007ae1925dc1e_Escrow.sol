...
contract Escrow {
    ...
    function cancelDealBeforeDelivery(uint256 _dealID) instate(_dealID, State.await_delivery) public {
    ...
    // Function for super-admin to cancel deal
    function cancelDealAfterDelivery(uint256 _dealID)  onlyAdmins instate(_dealID, State.delivered) public {
        require(deals[_dealID].startTime != 0, "INVALID_DEAL_ID");
        deals[_dealID].dealState = State.cancelled;
    }
