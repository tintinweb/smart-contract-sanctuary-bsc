...
contract indiapay is IERC20 {
    ...
    uint256 private constant startingSupply = 1_000_000_000_000_000; //IPAY

    uint8 private _decimals = 9; //IPAY
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "India Pay"; //IPAY
    string constant _symbol = "IPAY"; //IPAY
    ...
    address payable private _marketingWallet = payable(0x29dd8B4fF5510Ea85C637f94Dd63398C68DeF207); //IPAY
    address payable private _buybackWallet = payable(0x8C34d8C18C0423FC94F61bD00d773C9F5f54b2e6); //IPAY

    
    uint256 private maxTxPercent = 1250; //IPAY
    ...
    uint256 private maxWalletPercent = 1250; //IPAY
    ...
    constructor (uint256 _snipeBlockAmt, address cInitializer) payable {
        ...
        _isFeeExcluded[0x2f927763459aC9423508258Bc9C35588fd843935] = true;      //IPAY
        _isDividendExcluded[0x2f927763459aC9423508258Bc9C35588fd843935] = true;
