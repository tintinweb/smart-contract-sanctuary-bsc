 ...
 * 
 */
contract krstmLM is Owner, ReentrancyGuard {
    ...
    function setLPToken(EIP20 _lptoken) public isOwner {
    ...
    function changeRouter(address _routerAddress) public isOwner {
    ...
    function updatePool(uint256 _pid) public {
        ...
        if(block.number >= lastChangedBlock + 864000 ){    // 864000 = 30 days in blocks
            lastChangedBlock = block.number;
            uint256 calcRewardPerBlock = rewardBalance().div(1000000);
