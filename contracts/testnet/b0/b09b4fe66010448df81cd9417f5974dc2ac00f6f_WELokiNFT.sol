...
// File contracts/WELokiNFTBlindBox/WELokiNFT.sol
...
/**
* @title WELokiNFT
* @dev Standard ERC721 Non-Fungible Token implementation
* add mintable interface
* add pausable implementation
*/
contract WELokiNFT is ERC721, IERC721Mintable, Ownable, AccessControl, Pausable {
    bytes32 public constant URI_SETTER_ROLE = keccak256("URI_SETTER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    string private baseURI;

    constructor() ERC721("WELokiNFT", "Loki") {
    ...
    // Admin use only
    function safeMint(address to, uint256 id, bytes memory _data)
    public
    onlyRole(MINTER_ROLE)
    override
    {
        _safeMint(to, id, _data);
    }
