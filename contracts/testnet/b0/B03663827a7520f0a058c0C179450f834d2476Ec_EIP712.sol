...
contract EIP712 is EIP712Upgradeable, OwnableUpgradeable {
    ...
    function initialize(address _backendAddress) public initializer {
    ...
    function test(SignatureMessage calldata signatureMessage) external {
        ...
        require(_messageSigner == backendAddress, "GymVaultBank:: Invalid signer");
