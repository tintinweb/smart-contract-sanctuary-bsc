...
contract BXMigration is OwnableUpgradeable, Pausable {
    ...
    /*
        description: MIGRATE token1 to token2
        requirement: there should be gap of restictionTime between two tranction
    */
    function migrate(uint256 amount) external whenNotPaused {
        ...
        IERC20(token2).transfer(msg.sender, newTokenAmount);
