...
contract TokenTimeLockAdvisor is Ownable, Pausable, ReentrancyGuard {
    using SafeMath for uint256;

    uint256 public constant PERIOD = 86400; // 1 days,
    uint256 public constant TIME_LINEAR = 300; // 300 days,
    uint256 public constant START_TIME = 1649820478; // 7:30:00 GMT 9/2/2022
