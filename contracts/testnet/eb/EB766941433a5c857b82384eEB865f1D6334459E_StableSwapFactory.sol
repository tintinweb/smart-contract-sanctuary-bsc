...
contract StableSwap is Ownable, ReentrancyGuard {
    ...
    function add_liquidity(uint256[] memory amounts, uint256 min_mint_amount, address _lpTokenReceiver) external nonReentrant {
        ...
        emit AddLiquidity(_lpTokenReceiver, amounts, fees, D1, token_supply + mint_amount);
    }
