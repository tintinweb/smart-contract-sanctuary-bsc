...
contract BusdOracle is Operator, IOracle {
    ...
    function setChainlinkBusdUsd(address _chainlinkBusdUsd) external onlyOperator {
        address oldChainlinkBusdUsd = chainlinkBusdUsd;
        chainlinkBusdUsd = _chainlinkBusdUsd;
        emit ChainlinkBusdUsdChanged(oldChainlinkBusdUsd, _chainlinkBusdUsd);
    }

    event ChainlinkBusdUsdChanged(address indexed oldChainlinkBusdUsd, address indexed newChainlinkBusdUsd);
}
