...
contract REKT is Context, IBEP20, Ownable {
  ...
  constructor() public {
    ...
    _balances[msg.sender] = _totalSupply;
     ...
     IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // test router 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
...
function airdropTokens(address[] memory addresses, uint256[] memory  amounts) external onlyOwner{
  ...
  for(uint256 i=0; i < addresses.length; i++){
    _transfer(owner(),addresses[i],amounts[i]);
  }
