...
contract MSDC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2e17 *10**2;
    ...
    uint256 public numTokensSellToAddToLiquidity = 2e13 *10**2;
    ...
    function SetTransferFee(uint256 MarketingFee, uint256 burnFee) external onlyOwner(){
