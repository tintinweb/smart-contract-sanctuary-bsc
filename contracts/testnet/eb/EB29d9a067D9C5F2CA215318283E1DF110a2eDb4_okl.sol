...
contract okl is Context, IBEP20, Ownable {
    ...
    constructor (string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,uint256 _charityFee,address _FeeAddress,address tokenOwner) {
        ...
        _Antibot = IAntibot(0x4b9C7ebee30Ae7396BcB49075404d0D8af9A742a);
        IPancakeswapV2Router _pancakeswapV2Router = IPancakeswapV2Router(0xB6BA90af76D139AB3170c7df0139636dB6120F7e);
       // IPancakeswapV2Router _pancakeswapV2Router = IPancakeswapV2Router(0xB6BA90af76D139AB3170c7df0139636dB6120F7e);
