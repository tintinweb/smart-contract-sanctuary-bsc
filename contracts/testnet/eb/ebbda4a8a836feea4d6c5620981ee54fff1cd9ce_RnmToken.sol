...
/**
 * RnmToken = The integrated Finance Token
 * A new type of contract that designed and implemented by RNM Community
 */
contract RnmToken is IBEP20, Context, Ownable {
    struct Values {
        uint256 rSendAmount;
    ...
    string private constant _NAME = "RNM Token";
    ...
    uint256 private _tTotal = (10**7) * _DECIMALFACTOR; // Total supply
