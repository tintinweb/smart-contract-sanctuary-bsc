...
contract CreateMiranaCollection is ICollection, Ownable {
  ...
  function createCollection(
    ...
    emit CollectionCreated(_id, tokenType, tokenName, tokenSymbol, owner);
  }
...
contract MockERC721 is ERC721, ERC721Burnable, Ownable {
  ...
  Counters.Counter public _tokenIdTracker721;
  ...
  function mint(address recipient) external {
    _mint(recipient, _tokenIdTracker721.current());
    _tokenIdTracker721.increment();
  }
