...
contract TokenMGR is IMGR, ERC20, Ownable {
    ...
    function initilize(
        ...
        _mint(airdrop, Constant.AIRDROP_MINT_TOKEN_AMOUNT);
    ...
    function mintToken(address receiver, uint256 amount) external override  onlyMinter{
        require(totalSupply() + amount <= Constant.MAX_TOKEN_TOTAL_SUPPLY, "Cap exceeded");
