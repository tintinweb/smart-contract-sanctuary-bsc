...
contract SusumiCrowdfunding is Ownable, ReentrancyGuard, ISusumiCrowdfunding {
    ...
    function initialize(
        ...
        uint128 _busdDecimals = uint128(10**(Token(BUSDAddress).decimals()));
        ...
        addUpdateVestingInfo(500 * _busdDecimals, 30 minutes, 1); //; Vesting Counter 1
        addUpdateVestingInfo(2000 * _busdDecimals, 30 minutes, 2); // Vesting Counter 2
        addUpdateVestingInfo(10000 * _busdDecimals, 30 minutes, 3); // Vesting COunter 3
    }
