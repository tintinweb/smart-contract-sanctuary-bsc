...
contract WKM is Context, IERC20, Ownable {
    ...
    function excludeFrombuytaxReward(address account) public onlyOwner() {
    ...
    function includeInbuytaxReward(address account) external onlyOwner() {
        require(_isExcluded[account], "Account is already excluded");
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        uint256 tFee = calculatebuyfee(tAmount);
        uint256 tLiquidity = calculatesellfee(tAmount);
