...
contract Stacking is Ownable {
    ...
    IBEP20 public stakedToken=IBEP20(0xeA871b31b6Dfd656097115B1dF98E4e1A74ee796);
    struct stack{
        uint256 amount;
        address userAddress;
        uint256 time;
    ...
    function deposite(uint256 amount,uint256 time) public  {
        ...
        Stack[currentID].withdrawalTime=block.timestamp.add(time.mul(1 days));
    ...
    function calclulateReward(uint256 id) public view returns(uint256){
       ...
       uint256 reward = depositeAmount.mul(currentTime.sub(depositeTime)).mul(APY).div(divider);
        return (reward);
    }
    ...
    function claim(uint256 id) public{
        ...
        Stack[currentID].isWithdrawal=true;
