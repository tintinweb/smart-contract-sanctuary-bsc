...
contract Offer is Initializable, OwnableUpgradeable, UUPSUpgradeable, IOffer {
    ...
    function makeOffer(
        ...
        Offer memory newOffer = Offer(msg.sender, _contractERC20, _price, OfferStatus.CREATED);
    ...
    function cancelOffer(
        ...
        uint offerLength = totalOffersFromUsers[_contractERC721][_tokenId][offer.from];
