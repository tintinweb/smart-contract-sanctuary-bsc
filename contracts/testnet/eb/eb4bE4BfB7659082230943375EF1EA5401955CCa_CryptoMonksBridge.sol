    ...
    function onERC1155BatchReceived(
        ...
        bytes calldata _data
           ...
           for (uint256 i = 0; i < _tokenIds.length; i++) { 
                triggerReceived1155(_sender, _tokenIds[i]);
                emit ReceivedFromOS(_sender, _receiver, _tokenIds[i], 1);
                return super.onERC1155Received(_sender, _receiver, _tokenIds[i], 1, _data);
           }
    }   
