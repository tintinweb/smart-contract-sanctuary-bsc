...
contract ArbitronStaking is Ownable {
  using SafeMath for uint256;
  ...
  function setChicksContract(address chicksAddress) public onlyOwner{
    ...
    _arbitronContract = IArbitron(chicksAddress);
  }
  ...
  function stakeArray(
    ...
    require(_arbitronContract.ownerOf((_tokenIds[i])) == msg.sender || msg.sender == owner(), "Sender is not owner of current NFT token");
  ...
  function stake(
    ...
    require(_arbitronContract.ownerOf((_tokenId)) == msg.sender || msg.sender == owner(), "Sender is not owner of current NFT token");
  ...
  function _stake(
    ...
    _arbitronContract.transferFrom(user, address(this), _tokenId);
    addStakeUsers(user);
  ...
  function _unstake(
    ...
    _arbitronContract.transferFrom(address(this), user, _tokenId);
