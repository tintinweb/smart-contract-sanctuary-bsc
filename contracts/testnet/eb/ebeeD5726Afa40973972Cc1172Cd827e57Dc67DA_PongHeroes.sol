...
contract PongHeroes is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x79c9eC90DC2eBe3427aBf8d14E2cE2d33CC57E58); //change wallet2
...
uint256 initialBalance = address(this).balance;
       ...
       if(checkIT == 5){
           swapTokensForBNB3(contractTokenBalance);
       }
       if(checkIT == 6){
           swapTokensForBNB4(contractTokenBalance);
       }
       if(checkIT == 7){
           swapTokensForBNB5(contractTokenBalance);
       }
    ...
    function swapTokensForBNB3(uint256 tokenAmount) private {
     ...
     // Swapping tokens for BNB using PancakeSwap 
    function swapTokensForBNB4(uint256 tokenAmount) private {
     ...
     // Swapping tokens for BNB using PancakeSwap 
    function swapTokensForBNB5(uint256 tokenAmount) private {
