...
contract BoredEyeIsERC721V2 is Initializable, ERC721Upgradeable, ERC721RoyaltyUpgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable {
  ...
  function safeMintNFT(uint96 _royaltyAmount, uint256 _nftId, uint256 _sellPrice) public returns(uint256) {
    ...
    super._setTokenRoyalty(_nftId, to, _royaltyAmount);
