...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 //COLLECT TAX IN TOKENS WHEN SWAP LIQUIFY SET TO FALSE THIS IS FOR SLOW PERIODS AND COMMUNITY BURNS
    uint256 public defaultFundingFee = 10;
  ...
  function restoreAllFee() private {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        _transferStandard(sender, Team1Address, fundingPiece.mul(2)); // change to 4 
        _transferStandard(sender, Team2Address, fundingPiece.mul(2)); // Marketing Wallet         
        _transferStandard(sender, Team3Address, fundingPiece.mul(2)); // Marketing Wallet         
        _transferStandard(sender, MarketingAddress, fundingPiece.mul(2)); // Team Wallet 
