...
contract MetaproINS is Ownable, ERC1155Holder, ReentrancyGuard {
    ...
    function create(
        ...
        uint256[] storage currentInsIdsPerTokenId = insIdsPerTokenId[tokenId];
        currentInsIdsPerTokenId.push(currentInsId);

        insIdsPerTokenId[tokenId] = currentInsIdsPerTokenId;
