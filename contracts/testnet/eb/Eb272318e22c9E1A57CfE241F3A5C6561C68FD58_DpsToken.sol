...
contract ERC20 is Context, IERC20 {
    ...
    //DPS token, creator will take 0.1% fee
    address public feeTo = 0xa2FF140d3452B9464bfdbb983293F99689275Af2;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 DPS
...
//DPS代币,可增发,可销毁
contract DpsToken is
    ERC20,
    ERC20Detailed,
    ERC20Burnable
{

    constructor() public ERC20Detailed("DpsToken","Dps",18) {
