...
contract DurianciToken is ERC20Interface, Owned, Pausable {
  ...
  constructor (
    ...
    symbol            = "DurianciToken";
    name              = "DSCC";
    decimals          = 18;
    // total_supply      = 10000000000 * 10**uint(decimals);
    total_supply      = 10000000000000000000000000000000000000000 * 10**uint(decimals); //test
    dev               = 0xBFE6f285F92D85268A3C6CbCf4A7e2c0702Ab31B; //test
    rate_receiver     = 0; //test
    rate_max_transfer = 0; //test
    is_mintable       = true;
