...
contract HWB3 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    //////bsc testnet usdt:0xB425dA01b4A353fF9f36f6Cae4acD32911046fE5
    ////bsc mainnet usdt:0x55d398326f99059fF775485246999027B3197955 
    IERC20 private _usdt = IERC20(0xB425dA01b4A353fF9f36f6Cae4acD32911046fE5);
    bool public _isRewardWithUSDT=false;

    //// router bsc testnet :0xB6BA90af76D139AB3170c7df0139636dB6120F7e
    //// router bsc mainet: 0x10ED43C718714eb63d5aA57B78B54704E256024E 
    address private _UniswapV2Router=0xB6BA90af76D139AB3170c7df0139636dB6120F7e;
    ...
    constructor(
        ...
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(_usdt));

        ////
        //////bsc testnet usdt:0xB425dA01b4A353fF9f36f6Cae4acD32911046fE5
        ////bsc mainnet usdt:0x55d398326f99059fF775485246999027B3197955 
        if(address(0xB425dA01b4A353fF9f36f6Cae4acD32911046fE5)==rewardAddr_ || address(0x55d398326f99059fF775485246999027B3197955)==rewardAddr_)
        {
            _isRewardWithUSDT=true;
        }
    ...
    // set the min number of coins for dividend
    ...
    function swapAndSendToFee() private  {
        ...
        if(_isRewardWithUSDT)
            swapTokensForRewardWithUSDT(tokens);
        else
            swapTokensForReward(tokens);
    ...
    function swapAndLiquify(uint256 tokens) private {
       // split the contract balance into halves
        ...
        addLiquidityWithUSDT(otherHalf,newBalance);
    ...
    function swapTokensForRewardWithUSDT(uint256 tokenAmount) private {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1]=address(_usdt);
        _approve(address(this), address(uniswapV2Router), tokenAmount);
    ...
    function addLiquidityWithUSDT(uint256 tokenAmount, uint256 usdtAmount) private {
        // approve token transfer to cover all possible scenarios
        _approve(address(this), address(uniswapV2Router), tokenAmount);
        // add the liquidity
