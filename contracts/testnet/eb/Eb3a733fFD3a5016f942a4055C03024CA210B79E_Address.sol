...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x170A20c21B1d715c2cD62cfda354659BfC75FD8e;
...
contract JELES is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x170A20c21B1d715c2cD62cfda354659BfC75FD8e;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "jeles";
    string private _symbol = "JELES";
