...
contract SpinTheWheel {
    ...
    event SpinComplete(uint256 rewardIndex, uint256 rewardType, uint256 value);
    ...
    bool private _isSpinning = false;
    ...
    function spin(uint256 amount) external notPaused spinning{
        ...
        emit SpinComplete(rewardPos, reward.rewardType, reward.value);
