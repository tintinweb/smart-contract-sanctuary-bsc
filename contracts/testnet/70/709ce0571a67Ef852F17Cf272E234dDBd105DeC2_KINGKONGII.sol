...
contract Accounting {
    function doTransfer(address caller, address from, address to, uint256 amount) public returns (bool);
    function balanceOf(address who) public constant returns (uint256);
}

contract KINGKONGII is BEP20 {
    using SafeMath for uint256;

    address public owner = msg.sender;
    string public name = "KINGKONGII";
    string public symbol = "KINGKONGII";
