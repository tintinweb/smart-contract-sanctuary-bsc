...
contract Updated_LPStaking2 is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function addPool(IBEP20 _lpToken, uint16 _depositFeeBP, uint256 _harvestInterval, bool _withUpdate,
    ...
    function set(uint256 _pid, uint16 _depositFeeBP, uint256 _harvestInterval, bool _withUpdate, 
        uint256 _withdrawLockPeriod, uint256 _tokenPerBlock ) external onlyOwner {
