...
//
// Copyright of The LUCKYDUCKINU Team
...
//
// There is an automated LuckyDraw alongside every LUCKYDUCKINU buy transaction
// 
// LUCKYDUCKINU has 9% tax split across 7 awesome protocols
...
/**
 * @dev The official LUCKYDUCKInu smart contract
 */
contract LUCKYDUCKInu is Context, IERC20, Ownable {
    ...
    // General Info
    string private _name     = "LUCKYDUCKInu";
    string private _symbol   = "LDUCK";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for LDUCK/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x7617BcD3f5e8f8C5272Ea04626E18bf63B9ee59b); // Marketing address used to pay for marketing
    ...
    /**
     * @notice Withdraws non-LUCKYDUCKINU tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts LUCKYDUCKINU balance for buybacks, liquidity and marketing
    ...
    /**
     * @notice Burns LUCKYDUCKINU tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of LUCKYDUCKINU tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from LUCKYDUCKINU)
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
        // Generate the Pancakeswap pair for LDUCK/WBNB
    ...
    function swapBNBForTokens(uint256 amount) private {
        ...
        _pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            0, // Accept any amount of LUCKYDUCKINU
            path,
