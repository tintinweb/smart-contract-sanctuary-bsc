...
abstract contract TheZaibatsu is Context {
    ...
    mapping(address => bool) internal BridgeContract;
    ...
    /**
     * @dev Function modifier to require caller to be the bridge contract.
     */
     modifier OnlyBridgeContract() {
        require(isBridgeContract (_msgSender()),
    ...
    /**
     * @dev Return address' bridge status.
     */
     function isBridgeContract(address adr) public view returns (bool) {
        return BridgeContract[adr];
    }
     ...
     */
     function setBridgeContract(address adr) public OnlyJin {
        BridgeContract[adr] = true;
    }
     ...
     */
    function removeSenshiMaster(address adr) public OnlyJin {
    ...
    /**
     * @dev Remove bridge contract
     */
     function removeBridgeContract(address adr) public OnlyJin {
        BridgeContract[adr] = false;
    }
     ...
     */
    function renounceOwnership() public virtual OnlyJin {
     ...
     */
    function transferOwnership(address newOwner) public virtual OnlyJin {
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _Router) {
        ...
        : KazamaRouter(0xB6BA90af76D139AB3170c7df0139636dB6120F7e);
        _token = msg.sender;
    }
...
contract BEP20 is IBEP20, TheZaibatsu {
    ...
    address public BURN = 0x0000000000000000000000000000000000000000;
    ...
    * InSwap modifier boolean.
    ...
    constructor (string memory name, string memory symbol) payable {
        ...
        address _KazamaRouter = 0xB6BA90af76D139AB3170c7df0139636dB6120F7e;
    ...
    * if needed with the {setBurnPercentage} function.
    ...
    function burnPercentage(uint256 value) public view returns (uint256)  {
        ...
        uint256 percentValue = roundValue.mul(BurnPercentSettings).div(100000); // = 2.75% (See line 911 for info).
        return percentValue;
   }
    ...
    *
    * NOTE: All fees added together can never be set higher than 12% (TotalFee).
    * See {TotalFee < FeeDenominator/10}
     */
    function setFees(uint256 _LiqGeneratorFee, uint256 _BuyBackBurnFee, uint256 _TreasuryFee, uint256 _RewardsFee, uint256 _FeeDenominator) external OnlyJin {
    ...
    function setFeeReceivers(address _LiquidityReceiver, address _TreasuryReceiver) external OnlyJin {
