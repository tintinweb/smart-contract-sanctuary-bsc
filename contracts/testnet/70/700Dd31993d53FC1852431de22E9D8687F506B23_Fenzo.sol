...
contract Fenzo is ERC1155, Ownable {
    ...
    uint256 public constant Fenzo = 0;
    constructor()
        ERC1155("https://ipfs.io/ipfs/QmWspyvCZfLiMj8w73pNcsTfus1S5f3gSQsEZuWfMLvvSM?filename=fenzol2.json")
    {_mint(msg.sender, Fenzo, 3, "");}
