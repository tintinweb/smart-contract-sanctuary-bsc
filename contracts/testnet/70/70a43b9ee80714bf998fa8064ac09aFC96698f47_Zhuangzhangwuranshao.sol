...
contract Zhuangzhangwuranshao is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Zhuangzhangwuranshao";
    string private _symbol = "Zhuangzhangwuranshao";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x882eec614ca73b286cc2A98e6dc6d880e8535855));
        marketingWalletAddress = payable(address(0x015c88055CCe9C7996e1AE6b257ADd1428698Ae7));
