...
contract ParalaxExchange is ExtensionPercent, EIP712, AccessControl {
    ...
    event LimitOrderP2P(bytes sign1, bytes sign2, SignerData signerData1, SignerData signerData2);
    ...
    function _validateInitDCA(bytes memory sign) internal view returns (bool) {
        return _ordersDCA[sign].price == 0 && _timeMultipliers[sign].amount == 0;
    }
