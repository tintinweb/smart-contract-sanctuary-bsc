...
contract Storage is Ownable {
    ...
    function getTotalCarCombination(uint256 _carId) public view returns(uint256) {
        return totalCarCombination[_carId];
    }

    function getCarPrice(uint256 _combinationHash) public view returns(uint256) {
        return carPrices[_combinationHash];
    }

    // 
    function checkCombination(uint256 _combinationHash) public view returns(bool) {
