...
contract K0pro is IBEP20, Auth {
    ...
    string private _name = "K0pro";
    string private _symbol = "K0pro";
    uint8 private _decimals = 9;

    uint256 _totalSupply = 99000000 * 10**29 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver =0xd80D0810463Da21546120e2c516cf1f24CCfA5eC; 
