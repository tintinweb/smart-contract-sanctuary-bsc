...
contract PlayMusic is ERC20, Ownable {
    ...
    uint256 public  teamFeeOnBuy      = 8;
    uint256 public  teamFeeOnSell     = 8;

    uint256 public  marketingFeeOnBuy   = 6;
    uint256 public  marketingFeeOnSell  = 6;

    uint256 private _totalFeesOnBuy     = 24;
    uint256 private _totalFeesOnSell    = 24;

    address public marketingWallet=0x31bc8F888ADB74BC06F8b9ABc8A42961AAa758A4;
    address public teamWallet=0xE63fE6dC9605F4D36B5fF70fC866Cdd7b11401B0;
    ...
    constructor (address newOwner) ERC20("ceshi", "CS"){  
