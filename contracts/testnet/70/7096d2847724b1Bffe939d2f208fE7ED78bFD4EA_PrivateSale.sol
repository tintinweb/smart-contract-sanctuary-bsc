...
contract PrivateSale is Ownable {
    ...
    constructor(
        ...
        wallet = _wallet;
        token = _token;
        _startTime = block.timestamp + startTime;
        _endTime = block.timestamp + startTime + endTime;
    }
    ...
    modifier isVestingFinished() {
        require(block.timestamp > _endTime, "Vesting period is over");
        _;
    }
    ...
    function sendTokensBack() public onlyOwner isVestingFinished {
