...
contract CTENA_NFT is IERC721Metadata, ERC721Full, Ownable {
    ...
    string[] hashes = [
        "QmQkWkR25SsFM5kLTQ3WSrhGTJiwaJUU8kj351xFEQBW9L", // Gold
        "QmUvF4WcJieQA2VT5r58RV5AYQgmJ1ZwSDWVFYuVtqy56f", // Silver
        "QmTE5SjQ2aUGrorxdhGNiVNhAHbvTF82mj2KCyFbBXTkxV" ,// Purple
        "QmTE5SjQ2aUGrorxdhGNiVNhAHbvTF82mj2KCyFbBXTkxV" ,// Purple
        "QmTE5SjQ2aUGrorxdhGNiVNhAHbvTF82mj2KCyFbBXTkxV" ,// Purple
        "QmUvF4WcJieQA2VT5r58RV5AYQgmJ1ZwSDWVFYuVtqy56f" // Silver
    ];
    ...
    string[] names = [
        "ORO MERAVIGLIOSO", // Gold
        "ARGENTO LUCE", // Silver
        "VELLUTO VIOLA" ,// Purple
        "VELLUTO VIOLA" ,// Purple
        "VELLUTO VIOLA" ,// Purple
        "ARGENTO LUCE" // Silver
    ];
    ...
    string[] desc = [
        "Old but Gold", // Gold
        "Silver Silver Silver in my eyes", // Silver
        "Purple haze all around" ,// Purple
        "Purple haze all around" ,// Purple
        "Purple haze all around" ,// Purple
        "Silver Silver Silver in my eyes" // Silver
    ];
    ...
    modifier onlyAuthorized(address _address) {
        require(authorized[_address] == true, "Not Authorized");
        _;
    }
    ...
    function mintSpecial() external payable {
        ...
        metadata memory md;
        md.name = names[rnd];
        md.description = desc[rnd];
        md.url = string(abi.encodePacked("ipfs://", hashes[rnd]));
        md.price = price;
        ...
        _setTokenURI(_id, string(abi.encodePacked("ipfs://", hashes[rnd])));
        _imageExists[string(abi.encodePacked("ipfs://", hashes[rnd]))] = true;
    }
    ...
    function mint(
        ...
        uint256 _clones,
        string memory _hash
    ) public onlyAuthorized(address(msg.sender)) {
