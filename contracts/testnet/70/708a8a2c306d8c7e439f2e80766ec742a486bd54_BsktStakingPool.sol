...
contract LPTokenWrapper is Ownable, ReentrancyGuard {
    ...
    IERC20 public BSKTASREWARD =
        IERC20(0xd1649695B57c37A64435f120F6F9408bBd4E7DB9); // Approve and Transfer for Stake and Withdraw
...
contract BsktStakingPool is LPTokenWrapper {
    IERC20 public STAKEBSKT =
        IERC20(0xd1649695B57c37A64435f120F6F9408bBd4E7DB9); // BSKT TOKEN ADDRESS
