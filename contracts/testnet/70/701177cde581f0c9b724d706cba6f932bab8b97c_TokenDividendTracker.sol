...
contract TokenTest_01 is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TokenTest_01", "TT1") {
        BNBRewardsFee = 5;
        liquidityFee = 2;
        extraFeeOnSell = 5; // extra fee on sell
        marketingFee = 3;
        marketingWallet = payable(0x77D2BDE43A2aF516b5E19a5e3F4a4C7537E02C95);
