...
contract MVP_DEELANCE {
    ...
    function create_transaction(uint256 ID, address client_address, address freelance_address, uint256 escrow) external {
        ...
        client.contracts.push(ID);
        freelance.contracts.push(ID);
