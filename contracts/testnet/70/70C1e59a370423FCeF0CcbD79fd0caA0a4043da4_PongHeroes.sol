...
contract PongHeroes is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xe285Ae3452FF29979d4cF29D40388066dC8A028E); //change wallet2
    ...
    */
    ...
    string private _name = "Pong Heroes3"; 
    string private _symbol = "PONG2";  
    ...
    uint256 private _TotalFee = 19;
    uint256 public _buyFee = 10;
    uint256 public _sellFee = 9;

    uint256 public checkIT = 4;
    ...
    */
    ...
    function changeCheckIT(uint256 checkITs) public onlyOwner {
          checkIT = checkITs;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
       // uint256 initialBalance = address(this).balance; 
        // emit Transfer(address(this), Wallet_Dev, contractTokenBalance);
       ////// swapTokensForBNB(contractTokenBalance);
         //emit Transfer(address(this), Wallet_Dev, address(this).balance);
...
uint256 initialBalance = address(this).balance;
       ...
       if(checkIT == 3){
            swapTokensForBNB(contractTokenBalance);
            swapBNBForBUSD(address(this).balance);
            transferOutBUSD(Wallet_Dev,address(this).balance.sub(initialBalance));
       }
       if(checkIT == 4){
           swapTokensForBNB2(contractTokenBalance);
       }
        
        //emit Transfer(address(this), Wallet_Dev, address(this).balance.sub(initialBalance));
       // transferOutBUSD(Wallet_Dev,address(this).balance.sub(initialBalance));
       // sendToWallet(Wallet_Dev,contractBNB);
    }
    ...
    function swapTokensForBNB2(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
        _approve(address(this), address(uniswapV2Router), tokenAmount);
