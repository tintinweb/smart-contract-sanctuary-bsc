...
contract lB is VRFConsumerBase,ReentrancyGuard,Ownable {
	using SafeMath for uint256;
    ...
    uint256 minimumPot = 1000 * 10**18;
    uint256 botReward = 3 * 10**18;
    ...
    function autoSpin(address _caller) public nonReentrant {
        ...
        require(getJackpotinUSD() >= minimumPot && registeredsAccts.length > 15 && block.timestamp > lastAutoSpin + 300,"autoSpin parameters not met");
