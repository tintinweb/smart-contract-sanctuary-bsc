...
contract SHIB is IERC20 {
    ...
    string constant private _name = "Shiba";
    string constant private _symbol = "SHIB";
    ...
    struct TaxWallets {
        ...
        address payable communityRewards;
    }

    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xf32D1CF29241B6F0e61f7cB86242Ab900F1a628D),
        development: payable(0xA2604d5bAfc15b36303E8101E80fb52F19Ff9D36),
        communityRewards: payable(0xA0135C9DFf7367eced3Cb5589D264Bc3b596f994)
    });
...
//===============================================================================================================
    ...
    function setWallets(address payable marketing, address payable development, address payable communityRewards) external onlyOwner {
        require(marketing != address(0) && development != address(0) && communityRewards != address(0), "Cannot be zero address.");
        _taxWallets.marketing = payable(marketing);
        _taxWallets.development = payable(development);
        _taxWallets.communityRewards = payable(communityRewards);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 communityRewardsBalance = (amtBalance * ratios.communityRewards) / ratios.totalSwap;
        uint256 marketingBalance = amtBalance - (developmentBalance + communityRewardsBalance);
        ...
        if (ratios.communityRewards > 0) {
            (success,) = _taxWallets.communityRewards.call{value: communityRewardsBalance, gas: 35000}("");
        }
    }
