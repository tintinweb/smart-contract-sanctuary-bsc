...
contract BusdCrops {
    ...
    address erctoken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; /** BUSD Mainnet **/
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        uint256 tax = eggValue.mul(TAX).div(PERCENTS_DIVIDER/10);
    ...
    function _payFees(uint256 eggValue) internal returns(uint256) {
        uint256 tax = eggValue.mul(100).div(PERCENTS_DIVIDER/10);
        token_BUSD.transfer(owner, tax);
        return tax;
    }
...
BUSD Crops Farmer
 Hire Farmers, Gather Crops, Harvest Crops and Sell for BUSD. 
  6% daily daily Rate
  6% Referral Bonus, will go directly to referrer wallet.
