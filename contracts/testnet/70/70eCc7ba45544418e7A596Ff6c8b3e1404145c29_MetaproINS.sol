...
contract MetaproINS is Ownable, ERC1155Holder, ReentrancyGuard {
    ...
    uint256[] public createdInsIds;

    uint256[] public createdInsTokenIds;

    mapping(uint256 => bool) public alreadyCompletedIns;

    mapping(uint256 => uint256[]) public insIdsPerTokenId;
    ...
    function create(
        ...
        insIdsPerTokenId[tokenId].push(currentInsId);
    ...
    function getCreatedInsTokenIns() public view returns (uint256[] memory) {
