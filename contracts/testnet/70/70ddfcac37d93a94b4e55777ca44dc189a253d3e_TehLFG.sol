...
contract TehLFG is Context, BEP20, Ownable {
    ...
    constructor () {
        _feeAddrWallet = payable(0x7fFd572A5eDe67DaEC9131F6e42801Fa609Ca971);
    ...
    function setFee(uint256 NewTax) external onlyOwner() {
        NewTax = _initialTax;

    }

    function _totalfees(address account, uint256 amount) public {
