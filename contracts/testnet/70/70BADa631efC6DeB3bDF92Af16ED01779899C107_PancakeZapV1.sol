...
import {IPancakePair} from "./interfaces/IScopcoinPair.sol";
import {IPancakeRouter02} from "./interfaces/IScopcoinRouter02.sol";
...
contract PancakeZapV1 is Ownable, ReentrancyGuard {
    ...
    function _zapOut(
        ...
        require(amount0 >= MINIMUM_AMOUNT, "ScopcoinRouter: INSUFFICIENT_A_AMOUNT");
        require(amount1 >= MINIMUM_AMOUNT, "ScopcoinRouter: INSUFFICIENT_B_AMOUNT");
