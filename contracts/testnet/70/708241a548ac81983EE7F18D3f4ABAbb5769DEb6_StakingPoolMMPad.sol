...
contract StakingPoolMMPad is OwnableUpgradeable, PausableUpgradeable {
    ...
    function claim(uint32 _stakingInfoId) external whenNotPaused {
        ...
        uint256 reward = amount
            ...
            .mul(timePoolConfig.timeCycle)
            .div(timePoolConfig.timeUnit)
        ...
        )
    {
        ...
        reward = amount
            ...
            .mul(timePoolConfigs[poolConfigId].timeCycle)
            .div(timePoolConfigs[poolConfigId].timeUnit)
            .mul(stakingInfos[_stakingInfoId].numeratorStake)
            .div(stakingInfos[_stakingInfoId].denominatorClaim);
    }
    ...
    function setTotalSecondTimeCyclePoolConfig(
        uint32 _id,
        uint32 _totalSecond,
        uint32 _timeCycle,
        uint32 _timeUnit,
        ...
        timePoolConfigs[_id].timeUnit = _timeUnit;
