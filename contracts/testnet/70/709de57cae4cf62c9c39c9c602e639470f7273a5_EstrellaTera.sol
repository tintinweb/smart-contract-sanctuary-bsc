...
contract EstrellaTera is Ownable, Pausable, ReentrancyGuard{
    ...
    constructor()
    {
        USDTToken = IERC20(0x47c8318aE65Ba8d2e51905939D5957eD9D635bEe);
        USDACEToken = IERC20(0xa5F54B843a3072c4bB712fe154Fa772c5e5D8aAB);
        ETAToken = IERC20(0xC27C98BbEeC35C873Ec529A43Af08D4002CCdc68);
