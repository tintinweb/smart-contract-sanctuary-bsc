...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = (address(this).balance).sub(currentBalance);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            (bool sendDiv, ) = payable(shareholder).call{ value: amount }("");
...
contract TESTXenomorph1 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Xenomorph";
    string constant _symbol = "XENO1";
    ...
    uint256 public rSupply = 1_000_000_000 * (10**_decimals);
    uint256 public _totalSupply = rSupply;
    
    uint256 public swapThreshold = rSupply * 10 / 10000;

    // Max wallet & Transaction
    uint256 public _maxTxAmount = rSupply.mul(2).div(1000);
    uint256 public _maxWalletToken = rSupply.mul(3).div(100);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0b32fE0c67dD3F858034091aBeC0b5fB6E384d30;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBMarketing = amountBNB.sub(amountBNBReflection).sub(amountBNBLiquidity);
    ...
    function _burn(address _who, uint256 _value) internal {
        require(_value <= _rBalance[_who]);
        _rBalance[_who] = _rBalance[_who].sub(_value);
