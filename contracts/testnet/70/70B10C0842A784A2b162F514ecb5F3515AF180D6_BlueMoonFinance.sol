...
contract BlueMoonFinance is Context, IBEP20, Ownable {
    ...
    string private _name = "Blue Moon Finance";
    ...
    uint256 public marketFeeOnBuying = 50; // 5% will be added to the market address
    ...
    uint256 public marketFeeOnSelling = 50; // 5% will be added to the market address
