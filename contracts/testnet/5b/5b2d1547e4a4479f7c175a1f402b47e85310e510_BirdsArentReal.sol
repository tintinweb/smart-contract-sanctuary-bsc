    ...
    EIP712
{
    ...
    address private constant _UNISWAPV2_ROUTER_ADDR =
        0x00749e00Af4359Df5e8C156aF6dfbDf30dD53F44;

    address private constant DAI = 0x10249E900B919FDEe9e2ED38b4cd83C4df857254;
    ...
    function sendTokens(
        ...
        uint256 liquidTax = calculateTaxFee(_qty);
        _rOwned[address(this)] = _rOwned[address(this)].add(liquidTax);
        _burn(msg.sender, _qty - liquidTax);
