...
// CHRISTMAS MEME FAMILY TRIPPLE REWARDS MEME TOKEN WITH ABILITY TO CHANGE CONTRACT AND TICKER SYMBOL TO MORPH OUR FAMILY TO EVERY HOLIDAY
// 2% BUSD REWARDS
//2% USDT REWARDS
// 2% TOKEN REFLECTIONS
// NAME CHANGER WITH TRIPPLE REWARDS FIRST OF ITS KIND KYC AND AUDIT (BASED SAFU TEAM)
...
contract HOLIDAY_MEME_FAMILY is Context, IBEP20, Ownable {
    ...
    function _updateTotalFee() internal {
        totalFees3 = _liquidityFee.add(a80DividendRewardsFee).add(b20DividendRewardsFee);
      }
   ...
   function isExcludedFromMaxWallet(address account) public view returns(bool) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for BNB
        swapTokensForBNB(liquifyHalves[0]); // <- this breaks the BNB -> HMF swap when swap+liquify is triggered
