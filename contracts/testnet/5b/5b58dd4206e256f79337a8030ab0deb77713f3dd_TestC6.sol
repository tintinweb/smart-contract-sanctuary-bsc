...
contract TestC6 is Context, IERC20, Ownable {
    ...
    string private _name = "TESTC6";
    string private _symbol = "tc6";
    ...
    address public Wallet_Development = payable(address(0xd7506f23d80FF15A35Da169C408A323A707494f3));
    address public Wallet_Treasury = payable(address(0x36364Ad7A6713E95A27d1ECF361699BE2C3daA9f));
    address public Wallet_Prize = 0x9F500010fB9D41EB489825C0a70a163B6888ac9A;
    address public Wallet_Employment1 = 0xbf3A61907Bf62359b83e0243791528874217a6F2;
