...
contract CryptoWorldContract is Ownable, ReentrancyGuard {
    ...
    function _addStartSystem() private {
        Account memory acc = Account({
            entryDate: block.timestamp,
            ultimoSaque: block.timestamp,
            accountAddress: 0x7f00DC09a372c986b134D416d793c46Cdec8D256,
        ...
        acc.level[0] = 1;
        accMapping[0x7f00DC09a372c986b134D416d793c46Cdec8D256] = acc;
        accMappingExist[0x7f00DC09a372c986b134D416d793c46Cdec8D256] = true;
    }
