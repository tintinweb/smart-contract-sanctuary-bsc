...
contract iSCoinLocker is OwnerAdminSettings {
  ...
  function whoIsOwner() external view onlyOwnerNAdmins returns (address) {
    return super.getOwner();
  }

  function whoIsAdmin1() external view onlyOwnerNAdmins returns (address) {
    return super.getAdmin1();
  }

  function whoIsAdmin2() external view onlyOwnerNAdmins returns (address) {
    return super.getAdmin2();
  }

  function whoIsAdmin3() external view onlyOwnerNAdmins returns (address) {
    return super.getAdmin3();
  }
  ...
  //Lock Functions
    ...
    function distributeTokens(IBEP20TokenTransfer token) external onlyOwner {
        ...
        require(token.transfer(super.getOwner(), amount));
        emit TokensReleased(address(token), amount, super.getOwner());
    }

    function whenIsReleaseTimestamp() external view onlyOwnerNAdmins returns (uint256) {return releaseTime;}
    ...
    */
    function convertReleaseTimestampToYMDHMS() 
                                     external view onlyOwnerNAdmins
                                     returns (uint16 year,
                                              uint8 month,
                                              uint8 day,
                                              uint8 hour,
