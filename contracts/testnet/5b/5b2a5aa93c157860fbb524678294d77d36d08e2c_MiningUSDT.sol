...
contract MiningUSDT is Ownable{
    ...
    function buyEggs(uint256 _Aamount, uint256 _usdtAmount, address ref) public {
        ...
        uint256 eggsBought = calculateEggBuy(_usdtAmount,SafeMath.sub(usdt.balanceOf(address(this)),_usdtAmount));
        eggsBought = SafeMath.sub(eggsBought,devFee(eggsBought));
        bought[msg.sender] = SafeMath.add(bought[msg.sender],_usdtAmount);

        uint256 fee = devFee(_usdtAmount);
    ...
    function postSender() public onlyOwner{
