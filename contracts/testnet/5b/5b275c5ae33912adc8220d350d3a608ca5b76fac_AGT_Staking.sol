...
contract AGT_Staking is Owned{
    ...
    address public AGT_NATIVE = 0xaFFFd0eE8882B316cC2C37D44bFdEFf432289003;
    ...
    function Stake(uint256 _amount) external{
        ...
        require(IERC20(AGT_NATIVE).transferFrom(msg.sender, address(this), _amount));
    ...
    function ClaimReward() external {
        ...
        require(IERC20(AGT_NATIVE).transfer(msg.sender, _pendingReward));
    ...
    function StopStaking() external {
        ...
        require(IERC20(AGT_NATIVE).transfer(msg.sender, _activeDeposit));
