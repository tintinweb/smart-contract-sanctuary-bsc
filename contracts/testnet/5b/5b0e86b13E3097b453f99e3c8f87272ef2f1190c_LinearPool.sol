    ...
    PausableUpgradeable
{
    ...
    function linearAssignStakedData(
        ...
        require(_from != address(0), "LinearStakingPool: invalid address");
        require(_to != address(0), "LinearStakingPool: invalid address");
        require(_from != _to, "LinearStakingPool: invalid address");
        ...
        linearValidatePoolById(_poolId)
    {
        ...
        // TODO: transfer penaltyFee to treasury
        IERC20(linearAcceptedToken).safeTransfer(
            treasury,
            penaltyFee
        );
