...
contract FrictionlessToken is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "AIDS";
    string private _symbol = "AIDS";
    ...
    uint256 private _minTokensForLiquify = 100000 * 10**9;
    ...
    function transfer(
        ...
        if (contractTokenBalance >= primaryLpAmount && from != _uniswapV2Pair && contractTokenBalance > _minTokensForLiquify) 
        {
            liquify(primaryLpAmount, _primaryLpAddress);
            primaryLpAmount = 0;
        }
