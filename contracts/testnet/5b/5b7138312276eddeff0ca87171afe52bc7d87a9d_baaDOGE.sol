...
contract baaDOGE is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BabaDoge";
    string constant _symbol = "baGE";
    ...
    uint256 _totalSupply = 100000000 * (10 ** _decimals); //10 million
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = msg.sender; // dev wallet .5 percent ser
