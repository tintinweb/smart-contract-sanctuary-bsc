...
contract FunkyFlies is Context, IERC20, LockToken {
    ...
    address public stackingAddress = address(0x47D3550C1C17b77f3523A6D435fdd48Cf0c6b75E); // stacking
    ...
    uint256 public _stackingFee = 2;
    uint256 private _previousStackingFee = _stackingFee;  
    ...
    uint256 private _saleStackingFee = 2;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        uint256 stackingTokens = amount.mul(_stackingFee).div(100);
        ...
        if(burnTokens > 0)
        {
            ...
            if(stackingTokens > 0)
        {
            _transferStandard(sender, stackingAddress, stackingTokens);
        }    
        restoreAllFee();
    ...
    {
        _amount = _amount.mul(100).div(100-_burnFee-_stackingFee);
    ...
    function restoreAllFee() private 
    {
        ...
        _stackingFee = _previousStackingFee;
    ...
    external onlyOwner() 
    {
        ...
        _stackingFee = stackingFee;
        _previousStackingFee = stackingFee;
    ...
    {    
        ...
        _stackingFee = 2;
        _previousStackingFee = _stackingFee;        
