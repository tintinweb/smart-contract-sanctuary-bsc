...
contract FactoryStakingPool is Ownable{
    ...
    function createTokenForToken(address ownerAddress, IBEP20 _stakingToken, IBEP20 _rewardingToken, uint256 _lockPeriod, uint256 _unlockDate) public onlyOwner returns (address)
    {
