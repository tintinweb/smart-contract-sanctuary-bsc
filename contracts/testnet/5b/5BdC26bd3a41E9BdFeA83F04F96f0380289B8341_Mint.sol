...
contract Token is ERC20, Ownable {
    constructor(string memory tokenName, string memory tokenSymbols, uint8 decimals__, uint totalSupply) ERC20(tokenName, tokenSymbols, decimals__) {
...
contract Mint{
    ...
    function createNewToken(string calldata tokenName, string calldata tokenSymbols, uint8 decimals__, uint totalSupply) external returns(address){
        Token newToken = new Token(tokenName, tokenSymbols, decimals__, totalSupply);
