...
contract BHOStaking is OwnableUpgradeable {
    ...
    uint256 public emergencyUnstakeFee; // 25%
    ...
    function updateEmergencyUnstakeFee(uint256 _emergencyUnstakeFee)
        ...
        onlyOwner
    {
        require(_emergencyUnstakeFee <= 100, "Percent of fee invalid (100)");
    ...
    function emergencyUnstake() external {
        ...
        uint256 total = userInfo.amount.mul(emergencyUnstakeFee).div(100);
    ...
    function _calInterestBHO(
        ...
        return pending.mul(_apy).div(100);
    }
}
