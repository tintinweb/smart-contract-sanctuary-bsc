...
contract ClaimNFT is OwnableUpgradeable, PausableUpgradeable {
    ...
    function initByOwner(bool _isClaim, PassportNFT _passportNFT)
        public
        // ,IBEP20 _bep20
        onlyOwner
    {
    ...
    function claimNFT() external whenNotPaused {
        ...
        require(index == 0, "Receiver only claim one time");
        ...
        infoClaimNFTs[newInfoClaimNFT].timeClaim = block.timestamp;
