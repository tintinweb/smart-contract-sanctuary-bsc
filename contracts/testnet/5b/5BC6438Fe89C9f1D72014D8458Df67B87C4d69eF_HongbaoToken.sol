...
contract HongbaoToken is IERC20, Ownable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    address public fundAddress = 0xa56D9B16222F07701799c4d1240D2E5DA5f177Db;
    ...
    uint256 public _limitAmount = _totalSupply / 1000;
...
/*contract TMNTToken is AbsToken {
    ...
    //USDT
        ...
        1000000,
    //Fund
        address(0xa56D9B16222F07701799c4d1240D2E5DA5f177Db),
    //Receive
        address(0xa56D9B16222F07701799c4d1240D2E5DA5f177Db)
    ){
