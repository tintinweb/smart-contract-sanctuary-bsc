...
contract MiLe is ERC20, ERC20Burnable, Ownable {
    using SafeMath for uint; 
    MktCap public mkt;
    ...
    constructor(string memory name_,string memory symbol_,uint total) ERC20(name_, symbol_) {
        ceo=_msgSender();  
        address _baseToken=0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb;
        address _router=0xB6BA90af76D139AB3170c7df0139636dB6120F7e;
