...
contract lpmarkbn is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd43c67F90784d03510b8E2C79F20Fdd32D106fa0); 
    address payable public Wallet_Dev = payable(0x77171e9CF63Ddf7Ef9e3D2d1213a96C5cd78F193);
    ...
    string private constant _name = "lpmarketingburn2"; 
    string private constant _symbol = unicode"lpmb2"; 
    ...
    constructor () {
        ...
        _owner = 0x128aE22aBfC70Ebc2CFfc2B0037DB51f38575640;
