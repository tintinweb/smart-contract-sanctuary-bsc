...
contract XPRO_Staking is Ownable {
    ...
    address public constant TOKEN = 0x7C1b2f618569789941B88680966333F3e8FEdc61; //token to stake

    //STAKING PARAMETERS
    uint256 public constant stakingPeriod = 120 days; //period over which tokens are locked after staking
    uint256 public stakingEnd; //point after which staking rewards cease to accumulate
    uint256 public rewardRate = 5; //14% linear return per staking period
