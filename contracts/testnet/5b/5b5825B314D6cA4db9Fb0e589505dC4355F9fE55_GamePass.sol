    ...
    ReentrancyGuard
{
    ...
    constructor() ERC721("Sheesh Game Pass", "GAMEPASS") {
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://api.cryptosheesh.net/nft/game_pass/";
    }
    ...
    function mintGamePass(address to) external onlyOperators returns (uint256) {
