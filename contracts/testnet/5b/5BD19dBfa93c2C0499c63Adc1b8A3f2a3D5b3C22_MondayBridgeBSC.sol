...
contract MondayBridgeBSC is NonblockingLzApp {

    IERC20 public mondayToken;
    ...
    function setToken(address _mondayToken) onlyOwner external {
        mondayToken = IERC20(_mondayToken);
    }
    ...
    function sendCrossChain(uint16 _dstChainId, uint _amount) public payable {
        ...
        mondayToken.transferFrom(msg.sender, address(this), _amount);
    ...
    function _nonblockingLzReceive(uint16 _srcChainId, bytes memory _srcAddress, uint64 _nonce, bytes memory _payload) internal virtual override {
        ...
        mondayToken.transfer(toAddress, amount);
