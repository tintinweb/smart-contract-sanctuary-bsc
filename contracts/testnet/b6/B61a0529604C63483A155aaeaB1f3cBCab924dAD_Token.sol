...
// File: 终可变回流token_bsc_new-248.sol
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        bool cannotSwap = (!address(sender).isContract() && !address(recipient).isContract());
...
contract Token is ERC20, ERC20Detailed {
    ...
    constructor(
        ...
        uint256 _MAX_STOP_BURN_FEE_TOTAL, // 最大销毁数，例如达到总发行量的80%即8000万时停止销毁
