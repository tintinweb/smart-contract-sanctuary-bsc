...
contract DOGI is IERC20, Ownable {
    ...
    address private _taxAddress = address(0x0665d03bDDFd7bA36b1bDC7aDdB26C48273111c8);
    address private _devsAddress = address(0x0665d03bDDFd7bA36b1bDC7aDdB26C48273111c8);
    address private _lpAddress = address(0x77c21c770Db1156e271a3516F89380BA53D594FA);    
    ...
    constructor(address tokenOwner) {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), _lpAddress);
