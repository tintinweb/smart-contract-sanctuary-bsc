...
contract TokenName is Context, IERC20, Ownable, AntiWhale {
    ...
    uint256 private _totalburned =   20 * (10**18);
    uint256 private _totaldev = 10 * (10**18);
    uint256 private _totalmarketing = 10 * (10**18);
    uint256 private _totalReflection = (MAX - (MAX % _totalSupply));
    uint256 private _totalFee;

    address payable public _marketing = payable(address(0xC2E5e94F4A0523f6Fb2090f899B09D6D03886A55));
    address payable public _dev = payable(address(0xC2E5e94F4A0523f6Fb2090f899B09D6D03886A55));
