...
contract Messaging is Ownable {
    ...
    mapping (address => string) public registrationCodes;
    mapping (address => string) public aliases;
    mapping (string => address) public aliasesReverse;

    mapping (address => mapping (string => string)) public channels;
    ...
    function getMessagesByAddress(address _sender) public view returns (Message[] memory) {
        return messages[_sender];
    }

    function getMessagesByAlias(string memory _sender) public view returns (Message[] memory) {
        return messages[aliasesReverse[_sender]];
    }
