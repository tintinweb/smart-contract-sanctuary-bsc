...
/**
 * 
 * -------------- Panda Girl, the sexiest token in the cryptoverse. ---------------
 * 
...
contract PandaGirl is ERC20, Ownable, Pausable {

    // CONFIG START
    
    uint256 private initialSupply = 100000000000 * (10**6);
    ...
    // uint256 private devTaxBuy = 30;
    // uint256 private marketingTaxBuy = 70;
    // uint256 private liquidityTaxBuy = 0;
    // uint256 private charityTaxBuy = 0;
    
    // uint256 private devTaxSell = 30;
    // uint256 private marketingTaxSell = 70;
    // uint256 private liquidityTaxSell = 0;
    // uint256 private charityTaxSell = 0;
    
    // address private devTaxWallet = 0x170121a945B6AeEfAe41006B616D3916Dfc4770e;
    // address private marketingTaxWallet = 0x8Cd93367Ff4Fe7A59A1fCdCd7E46b04FC8Db0ABC;
    // address private liquidityTaxWallet = 0x170121a945B6AeEfAe41006B616D3916Dfc4770e;
    // address private charityTaxWallet = 0x170121a945B6AeEfAe41006B616D3916Dfc4770e;
    ...
    constructor() ERC20("Panda Girl", "PGIRL")
    {
        ...
        // setBuyTax(devTaxBuy, marketingTaxBuy, liquidityTaxBuy, charityTaxBuy);
        // setSellTax(devTaxSell, marketingTaxSell, liquidityTaxSell, charityTaxSell);
        // setTaxWallets(devTaxWallet, marketingTaxWallet, liquidityTaxWallet, charityTaxWallet);
    ...
    function _transfer(
        ...
        require(!paused(), "Panda Girl: token transfer while paused");
        require(!isBlacklisted(msg.sender), "Panda Girl: sender blacklisted");
        require(!isBlacklisted(recipient), "Panda Girl: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "Panda Girl: sender blacklisted");
    ...
    function pause() public onlyOwner {
        require(!paused(), "Panda Girl: Contract is already paused");
        _pause();
    }
    ...
    function unpause() public onlyOwner {
        require(paused(), "Panda Girl: Contract is not paused");
        _unpause();
    }
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "Panda Girl: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "Panda Girl: Account is not blacklisted");
    ...
    function exclude(address account) public onlyOwner {
        require(!isExcluded(account), "Panda Girl: Account is already excluded");
    ...
    function removeExclude(address account) public onlyOwner {
        require(isExcluded(account), "Panda Girl: Account is not excluded");
    ...
    //     require(!taxStatus, "Panda Girl: Tax is already enabled");
    //     taxStatus = true;
    // }
    ...
    //     require(taxStatus, "Panda Girl: Tax is already disabled");
    //     taxStatus = false;
    // }
