...
contract SeaChain is Context, IERC20, Ownable {
    ...
    uint256 private _marketingPercentageOfLiquidity = 20;
    uint256 private _governancePercentageOfLiquidity = 20;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the ETH -> SeaChain swap when swap+liquify is triggered
        ...
        newBalance = newBalance.sub(balanceToCharity + balancetoGovernance + balanceToMarketing);
