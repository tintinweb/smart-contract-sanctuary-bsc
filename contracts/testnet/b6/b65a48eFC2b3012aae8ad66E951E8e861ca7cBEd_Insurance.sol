...
contract Insurance is Ownable {
    ...
    struct InsuranceStruct {
        uint256 idInsurance;
        address buyer;
        uint256 cover_payout;
        string asset;
        uint256 insurance_value;
    ...
    **/
    ...
    function createInsurance(
        address _buyer,
        uint256 _cover_payout,
        string memory _asset,
        uint256 _current_price,
        uint256 _insurance_value,
        uint256 _expire
    ) external payable onlyContractCaller(_buyer) returns (bool) {
        require(msg.value >= _cover_payout, "Value is not enough");
