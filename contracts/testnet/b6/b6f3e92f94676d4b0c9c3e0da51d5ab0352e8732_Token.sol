...
contract Token is Context, IERC20, Ownable {
    ...
    uint8 private _burnFee = 0;
    uint8 private _previousBurnFee = _burnFee;

    uint8 private _walletFee = 0;
    uint8 private _previousWalletFee = _walletFee;

    uint8 private _walletCharityFee = 0;
    ...
    constructor (string memory tokenName,
        ...
        uint256 _minimumTokenBalanceForDividends,  address payable _feeReceiver
        ) payable {
            
        require(msg.value >= 0.0001 ether, "BNM");
        transferEth(_feeReceiver, 0.0001 ether);
        if(msg.value > 0.0001 ether) { // transfer excess back
            transferEth(_msgSender(), msg.value.sub(0.0001 ether));
        }
        ...
        walletCharityFeeInBNB = wallet.walletCharityFeeInBNB;
         ...
         buyFee.setLiqFee = 2;
         buyFee.setBurnFee = 1;
         buyFee.setWalletFee = 3;
         buyFee.setBuybackFee = 2;
         buyFee.setWalletCharityFee = 2;
         buyFee.setRewardFee =2;

         sellFee.setTaxFee = 5;
         sellFee.setLiqFee = 2;
         sellFee.setBurnFee = 1;
         sellFee.setWalletFee = 3;
         sellFee.setBuybackFee = 2;
         sellFee.setWalletCharityFee = 2;
         sellFee.setRewardFee =2;
  ...
  function enabledTrading () external onlyOwner {
    ...
    function setBuyFeePercent(uint8 taxFee, uint8 liquidityFee, uint8 burnFee, uint8 walletFee, uint8 buybackFee, uint8 walletCharityFee, uint8 rewardFee) external onlyOwner() {
        require(taxFee >= 0 && taxFee <=10,"TF err");
        require(liquidityFee >= 0 && liquidityFee <=10,"LF err");
        require(burnFee >= 0 && burnFee <=10,"BF err");
        require(walletFee >= 0 && walletFee <=10,"WF err");
        require(buybackFee >= 0 && buybackFee <=10,"BBF err");
        require(walletCharityFee >= 0 && walletCharityFee <=10,"WFT err");
        require(rewardFee >= 0 && rewardFee <=10,"RF err");
        
        buyFee.setTaxFee = taxFee;
        buyFee.setLiqFee = liquidityFee;
        buyFee.setBurnFee = burnFee;
        buyFee.setBuybackFee = buybackFee;
        buyFee.setWalletFee = walletFee;
        buyFee.setWalletCharityFee = walletCharityFee;
        buyFee.setRewardFee = rewardFee;
    }

    function setSellFeePercent(uint8 taxFee, uint8 liquidityFee, uint8 burnFee, uint8 walletFee, uint8 buybackFee, uint8 walletCharityFee, uint8 rewardFee) external onlyOwner() {
        require(taxFee >= 0 && taxFee <=10,"TF err");
        require(liquidityFee >= 0 && liquidityFee <=10,"LF err");
        require(burnFee >= 0 && burnFee <=10,"BF err");
        require(walletFee >= 0 && walletFee <=10,"WF err");
        ...
        sellFee.setLiqFee = liquidityFee;
        sellFee.setBurnFee = burnFee;
        sellFee.setBuybackFee = buybackFee;
        sellFee.setWalletFee = walletFee;
        sellFee.setWalletCharityFee = walletCharityFee;
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        require(maxTxPercent >= 100 && maxTxPercent <=10000,"err");
    ...
    function setMaxWalletPercent(uint256 maxWalletPercent) external onlyOwner() {
        require(maxWalletPercent >= 100 && maxWalletPercent <=10000,"err");
    ...
    function setBuy () private {
        ...
        _liquidityFee =  buyFee.setLiqFee  ;
        _burnFee = buyFee.setBurnFee;
        _walletFee = buyFee.setWalletFee;
        _buybackFee = buyFee.setBuybackFee;
        _walletCharityFee =  buyFee.setWalletCharityFee;
    ...
    function setSell() private {
        ...
        _liquidityFee =  sellFee.setLiqFee  ;
        _burnFee = sellFee.setBurnFee;
        _walletFee = sellFee.setWalletFee;
        _buybackFee = sellFee.setBuybackFee;
        _walletCharityFee =  sellFee.setWalletCharityFee;
