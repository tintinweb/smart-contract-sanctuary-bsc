    ...
    UUPSUpgradeable
{
        ...
        public nonReentrant payable
    {
        ...
        require(_tokenId > 0, "Market item has to exists");
        require(idToMarketItem[_tokenId].seller != msg.sender, "Seller cannot be buyer");
        ...
        emit BuyImageNFT(idToMarketItem[_tokenId].marketItemId, _tokenId, nftContract, address(this), msg.sender, price);
