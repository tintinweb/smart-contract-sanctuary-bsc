...
/*
_____________   _________     ______________________________________
___  __ )__  | / /__  __ )    ___  __ \_  __ \__  __ )_  __ \__  __/
__  __  |_   |/ /__  __  |    __  /_/ /  / / /_  __  |  / / /_  /   
_  /_/ /_  /|  / _  /_/ /     _  _, _// /_/ /_  /_/ // /_/ /_  /    
/_____/ /_/ |_/  /_____/      /_/ |_| \____/ /_____/ \____/ /_/    
...
contract robo {
	...
	uint256[] public PASSIVE_PERCENTS 		= [2000, 1500, 1200, 1000, 900, 850, 800, 750, 700, 650, 600, 550, 500, 450, 400, 350, 300, 250, 200, 100, 100, 100, 100, 100, 100, 50, 50, 50, 50, 50];
    uint256 constant public PROJECT_FEE = 500;
    uint256 constant public OWNER_FEE 	= 1000;
	...
	constructor(address payable wallet, address payable owner) public {
	...
	function withdraw() public {
		User storage user = users[msg.sender];
		 ...
		 // 86400 sec is 24hrs.
        require(now >= (user.checkpoint + 86400), "you can withdraw once in 24hrs");
	...
	function getUserPASSIVEIncome(address userAddress) public view returns (uint256){
		...
		for	(uint256 y=1; y<= count; y++)
		{
		   ...
		   if((user.checkpoint3 != 0) && (user.checkpoint5 != 0) && (user.checkpoint7 != 0)) { 
				if(level <=1){
	...
	function getUserDepositInfo(address userAddress, uint256 index) public view returns(uint8 plan, uint256 percent, uint256 amount, uint256 start, uint256 finish) {
		...
		finish = user.deposits[index].start.add(user.lastdate.mul(1 days));
	}
