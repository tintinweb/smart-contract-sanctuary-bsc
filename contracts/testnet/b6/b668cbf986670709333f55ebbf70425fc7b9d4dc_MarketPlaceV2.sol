...
contract MarketPlaceV2 is MarketPlaceV2Auth, EIP712Upgradeable, PausableUpgradeable {
  ...
  function _takeFund(uint _orderTrustFee) private {
    require(fotaToken.allowance(msg.sender, address(this)) >= _orderTrustFee, "MarketPlaceV2: please approve fota first");
    require(fotaToken.balanceOf(msg.sender) >= _orderTrustFee, "MarketPlaceV2: insufficient balance");
    require(fotaToken.transferFrom(msg.sender, address(this), _orderTrustFee), "MarketPlaceV2: transfer fota failed");
  }
