 ...
 */
contract CronTaskFactory is ConfirmedOwner {
  ...
  constructor() ConfirmedOwner(msg.sender) {
    s_cronDelegate = address(new CronTaskDelegate());
  }

  /**
   * @notice Creates a new CronTask contract, with msg.sender as the owner
   */
  function newCronTask() external {
   ...
   */
  function newCronTaskWithJob(bytes memory encodedJob) public {
