...
contract SkyG is ERC20Burnable, Operator {
    ...
    // TOTAL MAX SUPPLY = 1,000,000 SkyG
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 550000 ether;
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 175000 ether;
    ...
    uint256 public constant VESTING_DURATION = 3000 days; // ~8 years 3 months
    ...
    constructor(uint256 _startTime, address _daoFund, address _devFund, address _insuranceFund) public ERC20("DarkGang Share", "SKYG") {
        _mint(msg.sender, 1 ether); // mint 1 SKYG for initial pools deployment
