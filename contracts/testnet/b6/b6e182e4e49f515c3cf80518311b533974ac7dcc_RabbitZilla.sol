...
contract RabbitZilla is Context, IERC20, Ownable {
    ...
    function sendETHToFee(uint256 amount) private {
        uint256 devAmount = amount.mul(0).div(7);
        uint256 mktAmount = amount.mul(7).div(7);
        uint256 buybackAmount = amount.mul(0).div(7);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(taxFeeOnBuy < 50, "Tax cannot be more than 11.");
	    require(taxFeeOnSell < 50, "Tax cannot be more than 11.");
