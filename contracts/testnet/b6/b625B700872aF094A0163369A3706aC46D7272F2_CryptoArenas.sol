...
contract CryptoArenas is ERC721A, Ownable {
    ...
    uint256 public price = 0.20 ether; //set NFT price
    ...
    */
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        if (!isRevealed) {
            return hiddenURI; // return not revealed URI
        }
    ...
    */
    ...
    /**
    * Change hiddenURI of collection if not revealed yet
    */
    ...
    */
    ...
    /**
    * Change public sale state of collection
    */
