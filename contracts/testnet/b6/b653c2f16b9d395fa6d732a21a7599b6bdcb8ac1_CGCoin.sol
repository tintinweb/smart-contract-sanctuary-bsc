...
contract CGCoin is Context, IBEP20, Ownable {
    ...
    string private constant _name = "CG coin";
    string private constant _symbol = "CG06";
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            //0x10ED43C718714eb63d5aA57B78B54704E256024E // mainnet router
             0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81  // testnet router
        );
    ...
    function swapBack() private lockTheSwap {
        ...
        (success,) = address(0xA7BcAB973CDb20332346E01Ce8659A586cFfd2B8).call{value: bnbForDev}("");
