...
pragma solidity ^0.8.0;
contract LOYNETWORK is ERC20, Ownable {
    ...
    constructor() ERC20("LOY NETWORK", "LOY") {
        _mint(msg.sender, 100000000*10**decimals());
        _mint(address(this), 0*10**decimals());
        startSale(block.number, 999999999, 0,250*10**decimals(), 2000000000000);
