...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 //COLLECT TAX IN TOKENS WHEN SWAP LIQUIFY SET TO FALSE THIS IS FOR SLOW PERIODS AND COMMUNITY BURNS
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal * 3 / 1000**uint256(_decimals); //contract balance to trigger swap & liquify + wallet transfer.
    ...
    modifier lockTheSwap {
     ...
     constructor() IBEP20 () {
        ...
        _setAutomatedMarketMakerPair(address(uniswapV2Pair), true);
         ...
         maxTransactionAmount = _tTotal * 3 / 100** uint256(_decimals);// 3% maxTransactionAmount
  ...
  function restoreAllFee() private {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        _transferStandard(sender, Team3Address,fundingPiece.mul(2));       
