...
contract FounderVesting is ReentrancyGuard, Ownable {
    ...
    constructor(
        uint _tgeTimestamp,
        uint _tokenPercentUnlockOnTge,
        uint _cliffInSeconds,
        uint _periodDuration,
        uint _numberOfEmmissions,
        uint _totalSupply, 
        IBEP20 _token) 
    {
        token = _token;

        settings = VestingSetting({
            tgeTimestamp: _tgeTimestamp,
            tokenPercentUnlockOnTge: _tokenPercentUnlockOnTge,
            cliffInSeconds: _cliffInSeconds,
            periodDuration: _periodDuration,
            numberOfEmmissions: _numberOfEmmissions,
