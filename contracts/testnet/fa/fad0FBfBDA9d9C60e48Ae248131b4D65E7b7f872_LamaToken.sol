...
contract LamaToken is ERC20, ERC20Burnable, Ownable, Pausable, EmergencyGuard {
    ...
    //Max Token allowed to buy at launch for whitelisted addresses
    uint256 private constant MAX_TOKEN_ALLOWED_AT_LAUNCH = 1_000 ether;
    ...
    // Time allowed to whitelisted to buy at launch before it goes public
    uint256 public launchWhitelistTime;
    ...
    address private liquidityWalletAddress; // 1 month locked
    ...
    * @param user address of the user than will now have to pay transaction fees.
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        // Stops investors from owning more than 5% of the total supply from purchasing Lama Tokens from the DEX.
        //        if (pairAddresses[_msgSender()] && !excludedFromFees[_msgSender()] && !excludedFromFees[recipient]) {
        //            require((balanceOf(recipient) + amount) < (totalSupply() / 100), "You can't have more than 1% of the total LAMA Token supply after a DEX swap.");
        //        }
        ...
        _transfer(_msgSender(), contractAddress, contractFee);
    ...
    function swapLamaTokensForBnb(uint256 amount) internal {
    ...
    */
    function setRouter(address router) internal {
        ...
        _approve(contractAddress, address(uniswapV2Router), totalSupply());
