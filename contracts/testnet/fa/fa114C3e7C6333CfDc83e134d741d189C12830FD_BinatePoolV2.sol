...
// File: contracts/AM2X/binateV2X.sol
...
contract BinatePoolV2 is Ownable {
    ...
    IERC20 public token;
    uint public price;
    uint public maxUnits = 20;
    uint public minUnits = 2;
    ...
    uint commitLeft;
    address public marketingWallet = 0x1901E838983D04FF777C6B4b4b6b35af92dD2Af0;
    address public firstWallet = 0x995B0AE703Ef3FfcC2AaC178cF5d7bC26D54e2EA;
    PoolV1 public poolv1 = PoolV1(0x995B0AE703Ef3FfcC2AaC178cF5d7bC26D54e2EA);
    bool enabled = false;
    bool shareLevel6 = true;
    bool fixedCommit = true;

    bool public contributeEnabled = false;
    uint public contributeIndex;
    uint public maxContributeIndex;
    uint public contributeRate = 50;
