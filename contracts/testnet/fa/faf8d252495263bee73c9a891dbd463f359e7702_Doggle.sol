...
contract Doggle is Context, IBEP20, Ownable {
    ...
    address public MarketingWallet =
        0x87101a399a08933649F3886784BF8f0Fd380B017;
    ...
    string private constant _name = "Doggle";
    string private constant _symbol = "DOGL";
    ...
    uint256 public _maxWalletHoldingLimit = 20 * 10**9 * 10**18;
    ...
    function UpdateMaxWalletHoldingAmount(uint256 maxWalletAmount)
        external
        onlyOwner
    {
        require(
        ...
        _maxWalletHoldingLimit = maxWalletAmount * 10 ** _decimals;
