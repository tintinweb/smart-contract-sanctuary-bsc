...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  uint8 private _txAdmin;
  uint8 private _txBurn;
  ...
  */
   ...
   * 
   */
  function setTxAdmin(uint8 amount) public onlyOwner returns (bool) {
    _setTxAdmin(amount);
    return true;
  }
   ...
   * 
   */
  function _setTxAdmin(uint8 newTxAdmin) internal {
    _txAdmin = newTxAdmin;
  }
   ...
   * @dev 
   */
  function txAdmin() external view returns (uint8) {
    return _txAdmin;
  }
