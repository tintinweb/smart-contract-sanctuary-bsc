...
contract BIBToken is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    uint256 amount
        ...
        if(swapEnabled && !swapping && !noProcessList[to] && !noProcessList[from] && canSwap) {
            swapping = true;
        ...
        if(isFromWhiteList[from] || isToWhiteList[to]) {
            if (
                (from == 0xc18CBa763B564A909b91a68Ed7bC9f746B030504 && to == 0xd8F50550b41482Bc1Cf1498150Cc2F3447CC8985 )
                || (from == 0xd8F50550b41482Bc1Cf1498150Cc2F3447CC8985 && to == 0xc18CBa763B564A909b91a68Ed7bC9f746B030504)
              ) {
                takeFee = !isFromWhiteList[tx.origin];
              } else {
                takeFee = false;
              }
        }
        ...
        if(!swapping && !noProcessList[to] && !noProcessList[from]) {
