...
// V4S FINANCE
contract V4SToken is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // Supply used to launch in LP
    uint256 public constant INITIAL_LAUNCH_DISTRIBUTION = 2000000000 ether; // 1 billion of V4S

    // Have the rewards been distributed to the pools
    bool public rewardPoolDistributed = false;

    /**
     * @notice Constructs the V4S ERC-20 contract.
     */
    constructor() public ERC20("V4SToken", "V4S") {
        _mint(msg.sender, 500000000 ether);
    }

    /**
     * @notice Operator mints V4S to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of V4S to mint to
