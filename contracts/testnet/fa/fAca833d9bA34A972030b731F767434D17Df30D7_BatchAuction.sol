...
//contract BatchAuction {
  ...
  constructor() {
    ...
    // this is required to create/add liquidity!
    IERC20(HOTBODY).safeApprove(PancakeRouterV2Address, 0);
    IERC20(HOTBODY).safeApprove(PancakeRouterV2Address, type(uint256).max);
    IERC20(USDT).safeApprove(PancakeRouterV2Address, 0);
    IERC20(USDT).safeApprove(PancakeRouterV2Address, type(uint256).max);
