...
contract BNBBankv2{
    ...
    uint256 private constant DEVELOPER_RATE = 15;
    uint256 private constant MARKETING_RATE = 15;
    uint256 private constant RESERVE_RATE = 180;
    uint256 private constant REFERENCE_LEVEL1_RATE = 50;
    uint256 private constant REFERENCE_LEVEL2_RATE = 10;
    uint256 private constant REFERENCE_LEVEL3_RATE = 0;
    uint256 private constant REFERENCE_LEVEL4_RATE = 0;
    uint256 private constant REFERENCE_LEVEL5_RATE = 0;
    uint256 private constant MIN_WITHDRAW = 0.00002 ether;
    uint256 private constant MIN_ADEP = 0.00002 ether;
    uint256 private constant MIN_DEP = 0.04 ether;
    uint256 private constant MAX_DEP = 36000000 ether;
    uint256 private constant MAX_DEP_CNT = 365000000;
    uint256 private constant REFERRER_CODE = 1000;
    uint256 private constant PLAN_INTEREST = 5;
    uint256 private constant POOL_MAX = 25;
    uint256 private constant PLAN_TERM = 180 days;
    ...
    function _invest(address _addr, uint256 _referrerCode, uint256 _amount) private returns (bool) {
        ...
        if(pool_last_draw + TIME_STEP_DRAW < block.timestamp) {
            _drawPool();
        }
    ...
    function withdraw() public {
        ...
        //only once a day
		require(block.timestamp > uid2Investor[uid].checkpoint + TIME_STEP , "Only once in 12 hours");
    ...
    function _calculateDividends(uint256 _amount, uint256 _dailyInterestRate, uint256 _now, uint256 _start) private pure returns (uint256) {
        return (_amount * _dailyInterestRate / 1000 * (_now - _start)) / (TIME_STEP_DRAW);
    }
