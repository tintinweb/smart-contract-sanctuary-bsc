...
contract BuyCredit is EIP712MetaTransaction("BuyCredit", "1"), ReentrancyGuard {
    ...
    bytes32 private immutable _BUY_CREDIT_TYPEHASH =
        keccak256("BuyCredit(address from,address to,uint256 amount,uint256 deadline)");
    ...
    function buyCredit(
        ...
        bytes32 msgHash = keccak256(abi.encode(_BUY_CREDIT_TYPEHASH, from, to, amount, deadline));
