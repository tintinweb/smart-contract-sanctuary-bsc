...
contract Ownable is Context {
    ...
    constructor () {
        _owner = payable(0xabc4B357D7419cfD3747DC1338e9e6308612D87c);
...
contract WBTOKEN is Context, IBEP20, Ownable {
    ...
    string private _symbol = "o1WB"; // token ticker
    ...
    function setautoburnFee(uint256 _autoburnFee) external onlyOwner() {
        require(redistributionFee+liquidityFee+marketingwalletFee+_autoburnFee <= maxFee, "MaxFee: cannot be more than 10");
    ...
    function setMarketFee(uint256 _marketFee) external onlyOwner() {
        require(redistributionFee+liquidityFee+_marketFee+autoburnFee <= maxFee, "MaxFee: cannot be more than 10");
        marketingwalletFeeOnBuying = _marketFee;
        marketingwalletFeeOnSelling = _marketFee;
        marketingwalletFee = _marketFee;
    }

    function setLiquidityFee(uint256 _liquidityFee) external onlyOwner() {
        require(redistributionFee+_liquidityFee+marketingwalletFee+autoburnFee <= maxFee, "MaxFee: cannot be more than 10");
    ...
    function setRedistributionFee(uint256 _redistributionFee) external onlyOwner() {
        require(_redistributionFee+liquidityFee+marketingwalletFee+autoburnFee <= maxFee, "MaxFee: cannot be more than 10");
