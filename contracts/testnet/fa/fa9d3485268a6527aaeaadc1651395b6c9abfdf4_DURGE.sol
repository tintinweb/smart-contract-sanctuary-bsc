...
contract DURGE is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "DURGE";
    ...
    //Tax wallets
    address public teamWallet = 0x1aE329F3a761b1a0346e2C2C82628B105f566a33;
    address public treasuryWallet = 0x1aE329F3a761b1a0346e2C2C82628B105f566a33;
    ...
    address public constant MIGRATION_WALLET =
        0x1aE329F3a761b1a0346e2C2C82628B105f566a33;
