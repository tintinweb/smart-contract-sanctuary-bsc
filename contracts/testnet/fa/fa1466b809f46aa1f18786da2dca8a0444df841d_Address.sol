...
interface IERC20 {
    ...
    function alalowance(address owner, address spender) external view returns (uint256);
...
contract Reddoge is Context, IERC20, Ownable {
    ...
    function alalowance (address owner, address spender) public view override returns (uint256) {
