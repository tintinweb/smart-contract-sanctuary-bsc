...
/*
Token created for testing purposes!
*/
...
contract Test is ERC20Burnable, Operator {
    ...
    // Initial distribution for Genesis LP pool
    uint256 public constant INITIAL_FARM_POOL_DISTRIBUTION = 5000 ether;
    // Distribution for airdrops wallet (marketing, airdrop etc)
    ...
    function setTokenOracle(address _tokenOracle) public onlyOperator {
    ...
    function distributeReward(
        ...
        require(!rewardPoolDistributed, "Rewards already distributed!");
        require(_genesisPool != address(0), "!_genesisPool");
        require(_farmPool != address(0), "!_farmPool");
        require(_airdropWallet != address(0), "!_airdropWallet");

        //Mint tokens for genesis, airdrop and bird pool
        _mint(_genesisPool, INITIAL_GENESIS_POOL_DISTRIBUTION);
        _mint(_farmPool, INITIAL_FARM_POOL_DISTRIBUTION);
