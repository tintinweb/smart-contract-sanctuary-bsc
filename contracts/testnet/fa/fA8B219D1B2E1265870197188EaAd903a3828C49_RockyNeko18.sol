...
// File: contracts/RockyNeko18.sol
...
// ▀         ▀  ▀▀▀▀▀▀▀▀▀▀▀  ▀▀▀▀▀▀▀▀▀▀▀  ▀    ▀       ▀            ▀        ▀▀  ▀▀▀▀▀▀▀▀▀▀▀  ▀    ▀  ▀▀▀▀▀▀▀▀▀▀▀                                                                                                               
//
//electronic https://patorjk.com/software/taag/#p=testall&f=Banner3-D&t=ROCKY%20NEKO%201
...
contract RockyNeko18 is ERC20, Ownable
{
    ...
    address public wallet_marketing = 0x14e5c221538b153454B32Be7bDf1F2F547f14b9b;  //*** CEL Marketing team wallet
    address public wallet_charity = 0xfB856d10F77d83b79CDA43bB19B0e4AB1A9b9486;   //*** MC2 Charity wallet
    address public wallet_liq = 0x1a0c08AC136ad66254D7Cc17c112786D0c742806;   //*** autoliquidity wallet
	address public orouter = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;   //*** ROUTER PANCAKE TEST kiemtiem  0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
	...
	ILottery lottery;
    address public pair;
    uint256 public minTokensBeforeSwap = 700 ether; //*** autoliquidity trigger minimum collected tokens
    ...
    constructor (address Lotteryaddress) ERC20("Rocky Neko 18b", "MEOW18b")
    {
        ...
        _mint(msg.sender, 690_000 ether); //to liquidity and presales pool
        _mint(wallet_a, 100_000 ether); //to team wallet
        _mint(LotteryReceiver, 180_000 ether); //to lottery rewards contract
        _mint(wallet_marketing, 10_000 ether); //to marketing wallet
	    _mint(wallet_charity, 20_000 ether); //to charity wallet
        setMaxWalletPercentage(8000); //*** Max wallet ammount transfer allowed up to 80%
