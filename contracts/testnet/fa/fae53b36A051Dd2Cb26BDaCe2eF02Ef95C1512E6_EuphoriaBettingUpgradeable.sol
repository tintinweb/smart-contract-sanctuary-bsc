...
contract EuphoriaBettingUpgradeable is UUPSUpgradeable, OwnableUpgradeable {
    enum PaymentType {
        BALANCE,
        WALLET,
        WALLET_BALANCE
    ...
    function __EuphoriaBetting_init(
        ...
        Reward[] memory _balances,
        LibBet.Bet[] memory _bets,
        uint256[] memory _betsOdds
    ...
    function transferCommission(
        address recipient,
        LibBet.TokenAsset[] memory assets
    ) external onlyOwner {
    ...
    function addMatches(Match[] memory _matches) public onlyOwner {
