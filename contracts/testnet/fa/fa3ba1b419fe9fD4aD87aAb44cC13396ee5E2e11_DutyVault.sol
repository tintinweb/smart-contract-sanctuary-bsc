...
contract DutyVault is Ownable, Pausable {
    ...
    uint256 public constant MAX_WITHDRAW_FEE_PERIOD = 120 hours; // 7 days

    uint256 public performanceFee = 100; // 1%
    uint256 public callFee = 19; // 0.19%
    uint256 public withdrawFee = 10; // 0.1%
    uint256 public withdrawFeePeriod = 120 hours; // 7 days
    ...
    /**
     * @notice Withdraws from funds from the Duty Vault
