...
contract PGRID is ERC20, ERC20Burnable, Pausable, Ownable, ERC20Permit, ERC20Snapshot {
    ...
    event TokenPurchase(uint coinSent, uint256 feeValue, uint256 remainingCoin, uint256 priceForOneTokenInWei, uint256 tokenToBuy, uint256 totalRefund, uint256 fundToTransfer, bool fundAutoTransfer, uint256 totalSupply);
...
// ---------- Helper functions  ---------- //
    ...
    function buyTokens() public payable {
        ...
        if (preValidatePurchase(msg.sender, msg.value)) {
            ...
            //calculate total to refund to the user
            uint256 totalRefund = remainingCoin.sub(tokenToBuy.div(1 ether).mul(priceForOneTokenInWei));
            ...
            if (postValidatePurchase(msg.sender, tokenToBuy)) {
                ...
                emit TokenPurchase(msg.value, feeValue, remainingCoin, priceForOneTokenInWei, tokenToBuy, totalRefund, fundToTransfer, fundAutoTransfer, totalSupply());
            }
        }
    }
}
