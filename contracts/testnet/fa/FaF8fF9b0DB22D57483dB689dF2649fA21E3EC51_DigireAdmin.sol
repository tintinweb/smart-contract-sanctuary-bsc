...
contract DigireAdmin is OwnableUpgradeable{
    ...
    event Set_Agent_To_Broker(address agent, address broker);
    ...
    event Create_Request_Set_Agent_Status(address agent, AgentStatus status);
    ...
    modifier onlyExchanger() {
        require(msg.sender == exchanger, "Only Exchanger");
        _;
    }
    ...
    function request_loan(address brokerOrOpex, uint amount) external {
