...
contract Marketplace is ReentrancyGuard, Ownable {
    ...
    function listItem(
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            s_listings[concept][tokenId] = Listing(price, concept);
            emit ItemListed(concept, nftAddress, tokenId, price);
            s_counts[concept] += 1;
        }
    ...
    function buyItem(
        ...
        uint256 tokenId,
        string memory concept
    ) external payable isItiemListed(concept, tokenId) nonReentrant {
    ...
    function updateListing(
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            emit ItemListed(concept, nftAddress, tokenId, newPrice);
        }
    }
