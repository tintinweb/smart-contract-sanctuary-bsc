...
contract WealthBUSD {
    ...
    IERC20 public token = IERC20(0xC9A4Bf081161bC5EA831E358565566D1669307dF); //BUSD Token Contract

	uint256 public INVEST_MIN_AMOUNT = 10 ether; // 10 BUSD
	uint256[] public REFERRAL_PERCENTS = [100, 40, 10];
	uint256 constant public DEV_FEE = 250;
	...
	function wealthBUSD(IERC20 _token) public owner() {
