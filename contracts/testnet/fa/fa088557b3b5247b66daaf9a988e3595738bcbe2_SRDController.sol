...
contract SRDQuery is Ownable {
    ...
    address public SRDAddr = address(0x46914fa8141796440c28F1c502b2ECB3D11C58Ae);
    // address public USDTAddr = address(0x55d398326f99059fF775485246999027B3197955);
    address public USDTAddr = address(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47);
    address public SRDNAddr = address(0xAC985965841A55Fe792EEcFabc16a4E0936E9B83);
...
contract SRDController is Ownable {
    ...
    constructor() {
        ...
        // SRDN = SRDNFT(0xAC985965841A55Fe792EEcFabc16a4E0936E9B83);

        SRDQ = SRDQuery(0x7E3836620e69bFcf6AADaAebDe1C2B061c7d3A99);
    ...
    uint256 nextTime, uint256 pledgeNPY, uint256 bnbProfit, uint256 tokenProfit, uint256 tatus) {
        ...
        pledgeNPY = bnbProfit.mul(100).mul(SRDN.typeToDrawTimesLimit(types)).div(SRDN.typeToPrices(types));
