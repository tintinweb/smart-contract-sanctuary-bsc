...
contract DhanuVesting{
    address public constant dhanuAddress = 0x0F7FA6DA645288DAa2a37402c478D9Ceb10Fe194;
    ...
    constructor(){
        ...
        vestingtTypesToDetails[vestingTypes[0]] = VestingDetails(vestingTypes[0], block.timestamp, block.timestamp + (1 hours / 2), block.timestamp + 2 hours, 77_000_000 * decimalFactor, 0, 0, 0, vestingtTypesToDetails[vestingTypes[0]].assignedAddresses);
        ...
        vestingtTypesToDetails[vestingTypes[2]] = VestingDetails(vestingTypes[2], block.timestamp, block.timestamp + 1 hours, block.timestamp + 1 hours, 50_000_000 * decimalFactor, 0, 0, 0, vestingtTypesToDetails[vestingTypes[2]].assignedAddresses);
        vestingtTypesToDetails[vestingTypes[3]] = VestingDetails(vestingTypes[3], block.timestamp, block.timestamp + (1 hours / 4), block.timestamp + 1 hours, 41_000_000 * decimalFactor, 0, 0, 0, vestingtTypesToDetails[vestingTypes[3]].assignedAddresses);
        ...
        vestingtTypesToDetails[vestingTypes[6]] = VestingDetails(vestingTypes[6], block.timestamp, block.timestamp + 1 hours, block.timestamp + 1 hours, 7_350_000 * decimalFactor, 0, 0, 0, vestingtTypesToDetails[vestingTypes[6]].assignedAddresses);
    ...
    function addVestingAddress(uint256 indexOfVestingType, address assignedAddress) public onlyOwner validAddress(assignedAddress) validIndex(indexOfVestingType){
        // address[] storage addresses = vestingtTypesToDetails[vestingTypes[indexOfVestingType]].assignedAddresses;
        ...
        // vestingtTypesToDetails[vestingTypes[indexOfVestingType]].assignedAddresses = addresses;
    }
    ...
    function checkMintableTeamFund() public view returns(uint256){
        // VestingDetails memory vestingDetails = vestingtTypesToDetails[vestingTypes[0]];
        ...
        if(currentTime < lockTime){
            ...
            uint256 percentageAllowed = ((currentTime - startTime) / (1 hours / 2)) * 25;
     ...
     function checkMintableCommunityFund() public view returns(uint256){
        // VestingDetails memory vestingDetails = vestingtTypesToDetails[vestingTypes[1]];
    ...
    function checkMintableEcoSystemFund() public view returns(uint256){
        // VestingDetails memory vestingDetails = vestingtTypesToDetails[vestingTypes[2]];
        uint256 currentTime = block.timestamp;
    ...
    function checkMintableLiquidityFund() public view returns(uint256){
        // VestingDetails memory vestingDetails = vestingtTypesToDetails[vestingTypes[3]];
        uint256 currentTime = block.timestamp;
        ...
        if(currentTime < lockTime){
            ...
            uint256 percentageAllowed = ((currentTime - startTime) / (1 hours / 4)) * 25;
    ...
    function checkMintableInvestorFund() public view returns(uint256){
        // VestingDetails memory vestingDetails = vestingtTypesToDetails[vestingTypes[4]];
    ...
    function checkMintableInfrastructureFund() public view returns(uint256){
        // VestingDetails memory vestingDetails = vestingtTypesToDetails[vestingTypes[5]];
    ...
    function checkMintableAirdropFund() public view returns(uint256){
        // VestingDetails memory vestingDetails = vestingtTypesToDetails[vestingTypes[6]];
        uint256 currentTime = block.timestamp;
    ...
    function checkMintableReservedFund() public view returns(uint256){
        // VestingDetails memory vestingDetails = vestingtTypesToDetails[vestingTypes[7]];
