...
contract StrategyHelper is LogicUpgradeable {
    ...
    function setVenusAddress(address _venusComp, address _venusOracle) 
        ...
        onlyOwnerAndAdmin
    {
        require(venusComp == address(0), "SH1");
        require(venusOracle == address(0), "SH1");
     ...
     * @param _vToken Address of Venus Token
     */   
    function getBaseTokenDecimal(address _vToken) public view returns(uint256) {
     ...
     * @param _vToken Address of Venus Token
     */   
    function getBaseTokenName(address _vToken) public view returns(string memory) {
        address baseAddress = IXToken(_vToken).underlying();
