...
contract MultiDividends_BNB {
    ...
    uint256 public constant DEV_FEE = 15;
    uint256 public constant MKT_FEE = 25;
    uint256 public constant REINVEST_BONUS = 20;
    ...
    function FeePayout(uint256 msgValue) internal {
        ...
        emit FeePayed(msg.sender, dFee.add(mFee));
    }
    ...
    function invest(address referrer, uint8 plan) public payable {
        ...
        if(block.timestamp > startDate){
            ...
            user.deposits.push(Deposit(plan, msg.value, startDate));
        }
    ...
    function reinvest(uint8 plan) public {
        ...
        if(block.timestamp > startDate){
            ...
            user.deposits.push(Deposit(plan, totalAmount, startDate));
        }
