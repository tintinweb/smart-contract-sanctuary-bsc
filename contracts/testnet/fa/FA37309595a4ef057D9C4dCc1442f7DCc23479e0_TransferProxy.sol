...
contract TransferProxy {
    ...
    */    
    ...
    function ownerTransfership(address newOwner) public onlyOwner returns(bool){
     ...
     function erc721mintAndTransfer(IERC721 token, address from, address to, address[] memory _royaltyAddress, uint256 _royaltyfee, string memory tokenURI, bytes calldata data) external onlyOperator {
    ...
    function erc1155mintAndTransfer(IERC1155 token, address from, address to, address[] memory _royaltyAddress, uint256 _royaltyfee , uint256 supply, string memory tokenURI, uint256 qty, bytes calldata data) external onlyOperator {
