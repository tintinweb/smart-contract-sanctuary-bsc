...
import "./libs/SafeERC20UpgradeableLockToken.sol";

contract LegendVerseICO is Initializable, ContextUpgradeable, OwnableUpgradeable {
    using SafeMathUpgradeable for uint256;

    using SafeERC20Upgradeable for IERC20Upgradeable;
    IERC20Upgradeable public tokenBUSD;

    using SafeERC20UpgradeableLockToken for IERC20UpgradeableLockToken;
    ...
    function initialize(
        ...
        tokenLegendVerse = IERC20UpgradeableLockToken(_tokenLegendVerseContract);
    ...
    function buyByBUSD(uint256 amount) external {
        ...
        tokenLegendVerse.transferLockToken(sender, buyAmountToken);
    ...
    function claimToken() external onlyAdmin {
        ...
        tokenLegendVerse.safeTransfer(sender, remainAmountToken);
    }
 ...
 */
library SafeERC20UpgradeableLockToken {
    using AddressUpgradeable for address;

    function safeTransfer(
        IERC20UpgradeableLockToken token,
        address to,
        uint256 value
    ) internal {
        _callOptionalReturn(
