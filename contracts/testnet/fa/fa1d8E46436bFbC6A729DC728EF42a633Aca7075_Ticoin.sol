...
contract Ticoin  is Context, IERC20, IERC20Metadata, Ownable{
    ...
    uint256 public _maxTxAmount = 600000000000 * 10**18; 
    uint256 public _maxWalletSize = 600000000000 * 10**18; 
    ...
    constructor () {
        ...
        _symbol = "TICO";
        _totalSupply;
        _mint(owner(), 600000000000 * 10 ** (decimals()) ); 
