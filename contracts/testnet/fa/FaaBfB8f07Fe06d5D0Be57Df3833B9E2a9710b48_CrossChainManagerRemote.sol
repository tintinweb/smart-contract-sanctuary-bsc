...
contract CrossChainManagerRemote is
    Initializable,
    UUPSUpgradeable,
     ...
     */
    function buyToken(bytes calldata _payload, bytes calldata _adapterParams, uint256 _tax) external payable whenNotPaused nonReentrant {
    ...
    function _nonblockingLzReceive(
        ...
        (address targetSale,,,,,) = abi.decode(_payload, (address, uint128, uint128, address[], uint128[], uint128[]));

        IGovSaleRemote(targetSale).receiveCall(_payload);
    }
