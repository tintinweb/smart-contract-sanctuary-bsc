...
contract GymVaultsBank is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        relationship = 0xee253bdEbD515CA654f833bafD4Be4905EBE8c33; 
    ...
    function claimUserBnbReward(uint256 _pid, address _user) public {
        ...
        if (user.shares > 0) {
            ...
            if (accumulated >= 100) {
                ...
                accumulated = IERC20Upgradeable(pool.want).balanceOf(address(this));
    ...
    function claimAndDeposit(
        ...
        if (pending > 0) {
            ...
            IERC20Upgradeable(rewardPoolInfo.rewardToken).safeTransfer(relationship, distributeRewardTokenAmt);
            _distributeRewards(pending, rewardPoolInfo.rewardToken);

            IERC20Upgradeable(rewardPoolInfo.rewardToken).approve(farming, (pending - distributeRewardTokenAmt));
    ...
    function _deposit(
        ...
        _transfer(address(pool.want), treasuryAddress, IERC20Upgradeable(pool.want).balanceOf(address(this)));
