...
contract OneDayCashbackNFT is ERC721, IERC5192, ERC721Enumerable, AccessControl {
    ...
    constructor(string memory _uri) ERC721("One Day Cashback", "ODCB") {
        baseURI = _uri;
     ...
     */
    function mintTo(address _to) public onlyRole(FACTORY_ROLE) {
    ...
    function _beforeTokenTransfer(
        ...
        require(!soulbound, "Token is locked");
