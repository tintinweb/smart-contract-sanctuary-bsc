...
contract TestOnly is Context, IERC20, Ownable {
    ...
    address payable public autoLiquidityReceiver = payable(0x6876414b57cEAc9Cff0e23d03FF113F19f479BE3); // LP Address
    address payable public marketingWalletAddress = payable(0x6876414b57cEAc9Cff0e23d03FF113F19f479BE3); // Marketing Address
    address payable public operationsWalletAddress = payable(0x6876414b57cEAc9Cff0e23d03FF113F19f479BE3); // operations Address
