...
contract ERC721Proxy is LibAuthorizable, IAssetProxy {
    ...
    address private _erc721TradeableAddress;
    // Id of this proxy.
    ...
    function transferFrom(
        ...
        if (
            _erc721TradeableAddress == address(0) ||
            _erc721TradeableAddress == tokenAddress
        ) {
            require(
                ERC721Tradeable(tokenAddress).ownerOf(tokenId) == from,
                "ERC721Proxy#owner_tradeable: INVALID OWNER"
            );
            ...
            require(
                ...
                "ERC721Proxy#owner: INVALID OWNER"
            );
    ...
    function setTradeableAddress(address erc721TradeableAddress)
        external
        onlyOwner
    {
        _erc721TradeableAddress = erc721TradeableAddress;
    }
}
