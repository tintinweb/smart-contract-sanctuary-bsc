...
contract PresaleL5 is Ownable {
    using SafeMath for uint;

    address public tokenAddr;
    address public BusdAddress;
    
    uint256 public tokenPriceBnb = 18181818200; 
    ...
    constructor(address _tokenAddr, address _BusdAddress)  {
 ...
 /* This Function will exchange BUSD to Token */    
    function ExchangeBUSDforToken(address _BusdAddress, uint256 _amount) private {
        uint256 amount = _amount;
        address userAdd = _BusdAddress;
        uint256 bnbAmount = 0;
