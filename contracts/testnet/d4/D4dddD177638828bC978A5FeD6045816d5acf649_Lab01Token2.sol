...
// File: contracts\Lab01Token2.sol


pragma solidity >=0.4.22 <0.9.0;
contract Lab01Token2 is
    ERC1155,
    AccessControl,
    Pausable,
    ERC1155Burnable,
    ERC1155Supply
{
    ...
    function addNewToken(string memory _name, uint256 _tokenType)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        uint256 id = totalToken;
        totalToken++;
        tokens.push(Token(id, _name, TokenType(_tokenType)));
        emit AddNewToken(id, _name, _tokenType, msg.sender);
    }
