...
contract BTS11TOKEN is Context, Ownable, IERC20 {
    ...
    string private _name = "BTS11TOKEN";
    string private _symbol = "BTS11";
    ...
    feeRatesStruct public buyFees = feeRatesStruct(
     {taxFee: 0,
	  ...
	  liquidityFee: 2000,
      marketingFee: 1000, 
      swapFee: 10000, // burnFee+devFee+liquidityFee+marketingFee
      totFees: 2
    });
    ...
    uint256 public maxSellPerDay = 12000 * 10**9;
    uint256 public maxTrPerDay = 500 * 10**9;
    
    address payable public burnWallet = payable(0x13F97F01BE4CdE5e8a7b4FCDbC9A35899A5dc34E);
    address payable public marketingWallet = payable(0x99C8C103B54044B9cE87eAfA4a73AFbcAcf76f52);
    address payable public liquidityWallet = payable(0xa802d12d5Cbe4460E1b98dC7F33893AFF2D11E3F);
    address payable public DevWallet = payable(0xa802d12d5Cbe4460E1b98dC7F33893AFF2D11E3F);
    ...
    uint256 private minTokensToSwap = 500 * 10**9;
   ...
   function setMarketingWallet(address payable _address) external onlyOwner returns (bool){
    ...
    function setBuyFees(uint256 taxFee, uint256 burnFee, uint256 devFee, uint256 marketingFee, uint256 liquidityFee) external onlyOwner{
        ...
        buyFees.swapFee = marketingFee+devFee+burnFee+liquidityFee;
        require(buyFees.swapFee+buyFees.taxFee == 10000, "sum of all percentages should be 10000");
    }
    
    function setSellFees(uint256 sellTaxFee, uint256 sellBurnFee, uint256 sellDevFee, uint256 sellMarketingFee, uint256 sellLiquidityFee) external onlyOwner{
        ...
        sellFees.swapFee = sellMarketingFee+sellDevFee+sellBurnFee+sellLiquidityFee;
