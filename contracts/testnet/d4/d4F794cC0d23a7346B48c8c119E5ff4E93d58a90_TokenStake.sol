...
contract TokenStake {
    ...
    function getPriceinUSD() public view returns (uint256) {
        ...
        address Token_WBNB = 0x16b9a82891338f9bA80E2D6970FddA79D1eb0daE; // Token WBNB pancake pool address
        IERC20 TokenTOKEN = IERC20(0x55d398326f99059fF775485246999027B3197955); // Token Token address
