...
contract MinterRole is Ownable {
    ...
    constructor() {
        setMinterLimit(_msgSender(), 1000000000000000000000000000);
    }
...
contract OOG is ERC20("O Of Game", "OOG"), MinterRole {
    
    function mint(address account, uint256 amount) external onlyMinter(amount) {
        super._mint(account, amount);
		_reduceMintNum(amount);
    }
