...
contract Referrals is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    mapping(address => Structs.ReferralFatherDataInternal)
        public childReferralPerFather; // rename to normal "fatherReferralMapping"
    mapping(address => address) public fatherReferralByChild;
    mapping(address => uint32) public refferalLevelForFather; // Delete because unused
    mapping(address => uint256) public referralFatherProfit; // Delete because unused
    mapping(uint32 => uint32) public referralLevelsAndPercents; 
    mapping(address => uint32) public referralPercentsForAdmins; // Delete because unused
    ...
    function storage_referral_deposit() public payable nonReentrant {
        ...
        childReferralPerFather[fatherReferral].level = referralLevel;
    ...
    function update_level_referral_father(
        ...
        childReferralPerFather[fatherReferral].level = newLevel;
    ...
    function update_percent_referral_admin(
        ...
        childReferralPerFather[fatherReferral].percentForAdmin = newPercent;
        ...
        onlyOwnerOrProxyRouterAccount
    {
        ...
        childReferralPerFather[fatherReferral].profit += msg.value;
    ...
    function calculate_referral_father_fee(
        ...
        uint32 fatherReferralLevel = childReferralPerFather[fatherReferral].level;
        uint32 levelPercent = referralLevelsAndPercents[fatherReferralLevel];
        uint32 levelPercent2 = childReferralPerFather[fatherReferral].percentForAdmin;
