...
contract AFI is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        LOCK_PERIOD = 2 days; //TODO: Change back to 60!
        DEPOSIT_FEE = 1;
        CLAIMREWARDS_FEE = 1;
        UNSTAKING_FEE = 1;
        REF_BONUS = 2;
    ...
    function claimRewards() public nonReentrant {
        ...
        require(
            daysSinceLastClaim(msg.sender) >= 1, //TODO: Change back to 10!
    ...
    function unstake(uint8 index) public nonReentrant {
        ...
        require(
            block.timestamp.sub(depositStake.start) >= 2 days, //TODO: Change back to 60!
