...
// MasterChef is the master of RewardTokens. He can make RewardTokens and he is a fair guy.
//
// Note that it's ownable and the owner wields tremendous power. The ownership
// will be transferred to a governance smart contract once RewardTokens is sufficiently
...
contract MasterChef is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 apr;       // How many allocation points assigned to this pool. RewardTokenss to distribute per block.
    ...
    // Deposit LP tokens to MasterChef for RewardTokens allocation.
