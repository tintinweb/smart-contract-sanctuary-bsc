...
contract FlashMall is AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize() external initializer {
        ...
        tradeMemberContributeLimit = 1000e18;
   ...
   function register(address addr) external {
        ...
        require((members[addr] && contributes[addr] >= tradeMemberContributeLimit) || merchants[addr], "parent not satified");
    ...
    function tradeContributeReward(
        ...
        processSpeedUp(mdao, daoSpeedUpAmount);
