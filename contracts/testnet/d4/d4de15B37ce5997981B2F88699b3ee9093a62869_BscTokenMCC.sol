...
contract BscTokenMCC is Context, Ownable, BEP20 {
...
abstract contract BEP20 is Context, IERC20, Ownable {
    ...
    string public _name = "MCC";
    string public _symbol = "Metaverse Cloud Computing";
    ...
    uint256 public _totalSupply = 1314520 * 10**_decimals;
    uint256 public _maxTxAmount = 520 * 10**_decimals;
    uint256 public _walletMax = 1314 * 10**_decimals;
    uint256 public minimumTokensBeforeSwap = 1314520 * 10**3;
