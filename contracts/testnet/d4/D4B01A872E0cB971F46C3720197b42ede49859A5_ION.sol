...
contract ION is ERC20, AccessControl{
    ...
    function setBuyTax(uint256 _buyTax) public onlyOperator {
        buyTax=_buyTax;
    }

    function setSellTax(uint256 _sellTax) public onlyOperator {
        sellTax=_sellTax;
    }

    function setTxTax(uint256 _txTax) public onlyOperator {
        txTax=_txTax;
    }
    ...
    function getTokenPrice() public view returns (uint256){
        ...
        uint256 tokenPrice = uniswapV2Router.getAmountsOut(price,path)[1];
