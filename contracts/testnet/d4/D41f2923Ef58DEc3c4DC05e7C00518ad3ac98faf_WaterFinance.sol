...
contract WaterFinance is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed() {
        ...
        autoLiquidityReceiver = 0xda019dC84934A0483a351b21D8A73185f588fDbf;
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(TreasuryReceiver).call{
            value: amountETHSellTreasury,
            gas: 30000
        }("");
        (success, ) = payable(MarketingReceiver).call{
            value: amountETHSellMarketing,
            gas: 30000
        }("");
        (success, ) = payable(DevReceiver).call{
            value: amountETHSellDev,
            gas: 30000
        }("");
    ...
    function shouldSwapBack() internal view returns (bool) {
        return
            ...
            !inSwap &&
            swapEnabled &&
            _gonBalances[address(this)] >= 10 ** DECIMALS;
    }
