...
contract CryptoSabongI is Ownable {
   ...
   function() public payable {}
    ...
    function allocatePrizes(uint256 _gameId, uint16 teamWinner) public onlyAgent {
        ...
        for(i = 0; i < count; i++){
            ...
            rewards = (bets*((totalBets / totalBetsOne)*fee)) / 10000000;
        ...
        for( i = 0; i < count; i++){
            ...
            rewards = (bets*((totalBets / totalBetsTwo)*fee)) / 10000;
            _pendingBalance[add] += rewards;
            }
        }
