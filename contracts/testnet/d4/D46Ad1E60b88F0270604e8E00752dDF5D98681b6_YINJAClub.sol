    ...
    ILaunchpadNFT
{
    ...
    function setMaxLaunchpadSupply(uint256 _launchMaxSupply)
        external
        onlyOwner
    {
        launchMaxSupply = _launchMaxSupply;
    }
    ...
    function mintTo(address recipient, uint256 size)
        external
        override
        onlyLaunchpad
    {
        require(recipient != address(0), "YINJAClub: recipient address");
        require(size > 0, "YINJAClub: size");
        require(
            launchSupply + size <= launchMaxSupply,
            "YINJAClub: max supply"
        );
    ...
    modifier onlyLaunchpad() {
        require(launchpad != address(0), "YINJAClub: launchpad");
        require(msg.sender == launchpad, "YINJAClub: only launchpad");
        _;
    }
