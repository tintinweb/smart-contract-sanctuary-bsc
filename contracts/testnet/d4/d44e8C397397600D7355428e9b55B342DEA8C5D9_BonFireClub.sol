...
abstract contract ERC721Tradable is ERC721, ContextMixin, NativeMetaTransaction, Ownable {
    ...
    function claim() public payable {
        ...
        require(tokenId > 0 && tokenId < 11, "Exceeds token supply");
    ...
    function setPriceInWei(uint256 _value) public onlyOwner {
        require(_value >= 0, "Price must be more then -0");
        price = _value;
    }
    ...
    /**
     * @dev This will return the current price.
     */
    ...
    function addMintCounter(address wallet) private {
        require(whitelist[wallet] < 3, "Address is full; Only 2 mints per WL Address");
...
contract BonFireClub is ERC721Tradable {
    ...
    constructor() ERC721Tradable("Bon Fire Club", "BFC") { 
        _tokenURI = "https://mocki.io/v1/31f7acab-559d-4794-95ea-fb8ec21327a0";
    }
