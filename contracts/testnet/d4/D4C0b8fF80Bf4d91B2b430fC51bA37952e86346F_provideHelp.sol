     ...
     function clearGetHelp() internal{
        if(!getHelp[currentGetHelp].isPaid && getHelp[currentGetHelp].amount !=0 && address(this).balance != 0)
        {
            if((getHelp[currentGetHelp].amount-getHelp[currentGetHelp].paidAmount)<=address(this).balance)
            {
                ...
                currentGetHelp++;
                emit clearGetHelpEvent(_msgSender(),address(this).balance,getHelp[currentGetHelp].amount-getHelp[currentGetHelp].paidAmount,getHelp[currentGetHelp].userAddress,currentGetHelp);
            ...
            else
            {
                ...
                emit clearGetHelpEvent(_msgSender(),address(this).balance,address(this).balance,getHelp[currentGetHelp].userAddress,currentGetHelp);
            }
