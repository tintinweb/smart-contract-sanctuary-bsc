...
contract XStudio is IERC20, Ownable {
    ...
    string constant _name = "XStudio";
    string constant _symbol = "$TXS";
    ...
    address public utilityWallet = 0x75dF5847982Bf7Ee6244799Fa69bD9022124515d;
    ...
    function swapBackInBnb() internal swapping {
        ...
        uint256 devFeeBnb = swappedBnbAmount.sub(devSwap).sub(swappedFees);
