...
contract PopularHoldingXBLC is Ownable, ReentrancyGuard {
    address payable principalWallet = payable(0x7b1B4aaf4Fb3fC94A92f8b9d7fF9cDA8053ec989); 
    ...
    uint public pay1 = msg.value * 9 /2;
    uint public pay2 = msg.value * 9 /2;
    uint public pay3 = msg.value * 9 /2;
    uint public pay4 = msg.value * 9 /2;
    uint public pay5 = msg.value * 9 /2;
    uint public pay6 = msg.value * 9 /2;
    uint public pay7 = msg.value * 9 /2;
    uint public pay8 = msg.value * 9 /2;
    uint public pay9 = msg.value * 9 /2;
    uint public pay10 = msg.value * 19 /2;
        ...
        if(_referrer != address(0)){
            ...
            if(referrerLevel[_referrer]!= address(0)){
                ...
                if(referrerLevel[pay2Address]!= address(0)){
                    ...
                    if(referrerLevel[pay3Address]!= address(0)){
                        address pay4Address = referrerLevel[pay3Address];
                        payable(pay4Address).transfer(pay4);
                        totalReceive = totalReceive - pay4;
                        if(referrerLevel[pay4Address]!= address(0)){
                            address pay5Address = referrerLevel[pay4Address];
                            payable(pay5Address).transfer(pay5);
                            totalReceive = totalReceive - pay5;
                                if(referrerLevel[pay5Address]!= address(0)){
                                address pay6Address = referrerLevel[pay5Address];
                                payable(pay6Address).transfer(pay6);
                                totalReceive = totalReceive - pay6;
                                    if(referrerLevel[pay6Address]!= address(0)){
                                    address pay7Address = referrerLevel[pay6Address];
                                    payable(pay7Address).transfer(pay7);
                                    totalReceive = totalReceive - pay7;
                                        if(referrerLevel[pay7Address]!= address(0)){
                                        address pay8Address = referrerLevel[pay7Address];
                                        payable(pay8Address).transfer(pay8);
                                        totalReceive = totalReceive - pay8;
                                            if(referrerLevel[pay8Address]!= address(0)){
                                            address pay9Address = referrerLevel[pay8Address];
                                            payable(pay9Address).transfer(pay9);
                                            totalReceive = totalReceive - pay9;
                                                if(referrerLevel[pay9Address]!= address(0)){
                                                address pay10Address = referrerLevel[pay9Address];
                                                payable(pay10Address).transfer(pay10);
                                                totalReceive = totalReceive - pay10;        
                                            }
                                        }              
                                    }     
                                }     
