...
contract SpaceLottery {
	...
	//address erctoken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; /** 9 decimal test token address **/
    address erctoken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; /** 9 decimal main token address **/
    uint256 public PERCENTS_DIVIDER = 1000;
    uint256 public PROJECT   = 20;
    uint256 public MIN_BUY = 3 * 1e9; /** 3 BUSD **/
    uint256 public MAX_BUY = 150 * 1e9; /** 100 BUSD **/
    ...
    uint256 public LOTTERY_TICKET_PRICE = 3 * 1e9; /** 3 BUSD **/
