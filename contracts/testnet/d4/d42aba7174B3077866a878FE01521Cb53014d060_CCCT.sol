 ...
 */
 contract CCCT is ERC20, Ownable {
    ...
    address public devWallet = 0x82fE9cc7ca4C9350530E99Ff8817ec877b0bb0FD;
    address public tressuryWallet = 0x5127c03D12a026B934CDD1F02220777B8499e541;
    address public burnWallet = 0xCf8ea993D84a2B11a695d02B826B5c6eEC46caA1;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if ((_pairToInclude[from] == true || _pairToInclude[to] == true) && !inSwapAndLiquify) {
            ...
            if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
                ...
                super._transfer(from, address(this), (marketingShare + liquidityShare + burnShare));
    ...
    function _swapAndTransferWBNB() public returns(bool){
