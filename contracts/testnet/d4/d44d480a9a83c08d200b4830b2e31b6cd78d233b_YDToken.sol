 ...
 contract YDToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        if (_swapPairList[sender]) {//Buy
            ...
            _takeTransfer(sender, address(this), NFTAmount);
            uint256 leftAmount =_balances[address(this)];
    ...
    function swapTokenForFund() private lockTheSwap {
        ...
        if (tokenBalance >= 10) {
            ...
            USDT.transfer(_YXAddress,usdtBalance);
    }
    }
