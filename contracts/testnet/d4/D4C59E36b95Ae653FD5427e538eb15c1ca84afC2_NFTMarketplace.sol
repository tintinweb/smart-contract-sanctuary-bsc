...
contract NFTMarketplace is ERC721URIStorage, Ownable {
  ...
  function createToken(string memory tokenURI, uint256 price, uint256 auctionEndDate, string memory category)
    public
    returns (uint256)
  {
    _tokenIds.increment();
    ...
    createMarketItem(newTokenId, price, auctionEndDate, category, tokenURI);
    return newTokenId;
  }

  function createMarketItem(uint256 tokenId, uint256 price, uint256 auctionEndDate, string memory category, string memory tokenURI) public {
    ...
    emit MarketItemCreated(tokenId, msg.sender, address(this), auctionEndDate, category, tokenURI, price, false);
  }

  /* Creates the sale of a marketplace item */
  /* Transfers ownership of the item*/
  function createMarketSale(uint256 _tokenId, address _buyer, uint256 _amount) public {
