        ...
        if(!isExcluded(from) && !isExcluded(to)) {
            ...
            if(from == address(uniswapV2Pair)) {
                ...
                if(ethValue >= swapThreshold) {
                    ...
                    (bool successMkt, ) = taxWallets["marketing"].call{value: marketingETH}("");
                    require(successMkt, "Address: unable to send value, recipient may have reverted");
                    (bool successDev, ) = taxWallets["dev"].call{value: devETH}("");
                    require(successDev, "Address: unable to send value, recipient may have reverted");
                    (bool successCharity, ) = taxWallets["charity"].call{value: charityETH}("");
                    require(successCharity, "Address: unable to send value, recipient may have reverted");
                    
                    if(ethGained - (marketingETH + devETH + liquidityETH + charityETH) > 0) {
                        (bool successMkt2, ) = taxWallets["marketing"].call{value: ethGained - (marketingETH + devETH + liquidityETH + charityETH)}("");
                        require(successMkt2, "Address: unable to send value, recipient may have reverted");
                    }
