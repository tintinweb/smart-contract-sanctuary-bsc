...
contract FitnessConnect is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable  {
    
    uint256 private _tokenIds;
    bytes16 private constant alphabet = "0123456789abcdef";
    bool public mintingEnabled = false;
    event PupMinted(address indexed to, uint256 indexed _tokenid);
    ...
    string public  contractURIstorefront = '{ "name": "Fitness Connect", "description": "Samson", "image": "https://cloudflare-ipfs.com/ipfs/QmSxdcxPGzLtnXGhALupyfVDQBP3e4Vgs7zxNPpyWUd2Cf", "external_link": "https://cloudflare-ipfs.com/ipfs/QmSxdcxPGzLtnXGhALupyfVDQBP3e4Vgs7zxNPpyWUd2Cf", "seller_fee_basis_points": 300, "fee_recipient": "0xe5B8D0CFab2498b81Cf8F7d9dB785CFFfE6bf75A"}'; 
    string public _tokenURI = "https://cloudflare-ipfs.com/ipfs/QmSxdcxPGzLtnXGhALupyfVDQBP3e4Vgs7zxNPpyWUd2Cf";
    
    constructor( address _EcosystemContractAddress ) ERC721("KISHU MALES GEN1", "KISHU MALES GEN1") {
        EcosystemContractAddress = _EcosystemContractAddress;
        ecosystem = EcosystemContract ( EcosystemContractAddress );
        EmergencyAddress = msg.sender;
        price = 200000000000000000;
    }

    function setEcosystemContract( address _address ) public onlyOwner {
        EcosystemContractAddress = _address;
        ecosystem = EcosystemContract ( EcosystemContractAddress );
    }
    ...
    function pupMint ( ) public payable returns ( uint256){
        require( msg.value==price , "Incorrect native amount");
        require ( _tokenIds < maxDogs );
        _tokenIds++;
        uint256 newTokenId = _tokenIds;
        _safeMint( msg.sender , newTokenId);
        _setTokenURI(newTokenId, buildURI( newTokenId ));
       
        emit PupMinted (  msg.sender , newTokenId );
        return newTokenId;
    }
    ...
    modifier onlyEcosystem() {
        EcosystemContract _engine = EcosystemContract ( EcosystemContractAddress );
