...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2AE8f4Bb9096f1fA4EEbb618a8029791c71c40d6;
...
//1_Create a mapping to keep track of who is blacklist
...
//1_End
    ...
    address private _developmentWalletAddress = 0x4508b5993B8CdD7fC876cac5dA235aE4fc684966;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Edu_BL-AW-T1";
    ...
    /** Anti-Whale enabled 1 */
    bool public swapAWEnabled = true;
    /** End */
    ...
    event SwapAndLiquifyEnabledUpdated(bool enabled);
     /** Anti-Whale enabled 2 */
    event SetSwapAWEnabled(bool enabled);
    /** End */
    ...
    //2_Remove from Blacklist
    function removeFromBlackList(address account) external onlyOwner {
     _isBlacklisted[account] = true;
    }
    //2_End

    //3_Adding multiple addresses to the blacklist - Used to manually block known bots and scammers
   ...
   function setMaxWalletToken(uint256 _maxToken) external onlyOwner {
    ...
    /** End */
    /** Anti-Whale enbaled 3 */
    function setSwapAWEnabled(bool _enabled) external onlyOwner() {
        swapAWEnabled = _enabled;
        emit SetSwapAWEnabled(_enabled);
    }
    /** End */
    ...
    //4_Add the require statement into the transfer function
    ...
    /** Anti-Whale 3 */
        if(!swapAWEnabled && (to == uniswapV2Pair || from == uniswapV2Pair))
