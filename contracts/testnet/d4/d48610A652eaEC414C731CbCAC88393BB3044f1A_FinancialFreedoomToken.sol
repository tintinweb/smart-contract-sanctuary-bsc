...
// File: contracts/FinancialFreedoomToken.sol
...
contract FinancialFreedoomToken is IBEP20, Auth { using SafeMath for uint256;
    ...
    string constant _name = "Financial Freedoom Token";
