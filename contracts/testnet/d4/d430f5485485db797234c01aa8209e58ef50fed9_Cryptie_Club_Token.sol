...
◼️Website : https://cryptie.club/


◼️Telegram Group : https://https://t.me/cryptieclub
...
contract Cryptie_Club_Token is Context, BEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Cryptie Club Token";
    ...
    uint256 public _marketingFee = 500; // 500 = 5%
    uint256 public _liquidityFee = 500; // 500 = 5%
    
    uint256 public _taxFeeTotal;
    uint256 public _marketingFeeTotal;
    uint256 public _liquidityFeeTotal;
    
    address public marketingAddress = 0x6B9bD6BC479D7e4ab6BECd9863f6b608b7dE9a51; // marketing Address
    address public liquidityAddress = 0x3e61Eab7C9F1228518AD22ddc7991Cd97F916812; // Liquidity Address
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x6B9bD6BC479D7e4ab6BECd9863f6b608b7dE9a51,"CHAR: Uniswap router cannot be excluded.");
