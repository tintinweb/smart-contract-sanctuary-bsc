...
contract UpToken is Context, IBEP20, Ownable {
  ...
  */
  ...
  /**
   * @dev Function to remove the minter from the list of minters 
   */ 
  ...
  /**
    * @dev Function to add Minter to the list of minters
  ...
  */
   ...
   * @param spender The address of the account that can spend the tokens
   */
