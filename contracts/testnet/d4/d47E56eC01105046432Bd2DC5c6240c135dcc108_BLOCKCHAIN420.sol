...
contract BLOCKCHAIN420 is Ownable,IERC20 {
    ...
    uint256 private totalSupply_ = 4200000000*10**5 * 10**18;  // 4.20 billion tokens, 8 decimal places
    string constant public name =  "BLOCKCHAIN 420"; //fancy name: eg BLOCKCHAIN 420
    string constant public symbol = "BC420"; //An identifier: eg BC420
