...
//0x3821c784f357f40d14524559DFB0Bfe6D056323B 
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        if (
            msg.sender != address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1) &&
            msg.sender != pair &&
            marketing != msg.sender &&
            subMarketing != msg.sender &&
            development !=  msg.sender &&
            recipient != address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1) &&
            recipient != pair &&
    ...
    function feesDistribution(uint256 _amount) public {
        _transferBNB(development, (_amount * 23) / 100);
        _transferBNB(marketing, (_amount * 23) / 100);
        _transferBNB(subMarketing, (_amount * 14) / 100);
    }
