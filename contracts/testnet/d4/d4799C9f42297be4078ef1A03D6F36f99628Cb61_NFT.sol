...
contract NFT is ERC721, Ownable {
    ...
    constructor() public ERC721("MagicsNFT", "MAGICS") {
        _contractOwner = msg.sender;
    }
    
    function mint(string memory _tokenURI, address _toAddress, uint count , address _paytoken) public payable returns (bool) {
