...
contract Game is Ownable {
    ...
    function withdrawETH(address _receiveAddress, uint256 _amount) external onlyOwner {
    ...
    function withdrawERC20(address _receiveAddress, address _tokenAddress, uint256 _amount) external onlyOwner {
