...
contract Coin99 {
    ...
    mapping(address => uint256) public userTokenWallet;
    uint256 bnbBalance;
    ...
    function bnbWalletBalance() public view returns(uint256) {
        return bnbBalance;
    }
    ...
    function activateUser() public payable returns(bool) {
    ...
    function withdrawBNB() public payable onlyOwner returns(bool)  {
    ...
    function transferTokensToUser(address to, uint256 amount) public payable onlyOwner {
