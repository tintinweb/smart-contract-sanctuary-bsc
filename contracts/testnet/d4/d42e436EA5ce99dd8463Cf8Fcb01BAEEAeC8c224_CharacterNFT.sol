...
contract CharacterNFT is ERC721Upgradeable, ERC721BurnableUpgradeable, OwnableUpgradeable, PausableUpgradeable {
  ...
  function updateCharacter(address owner,uint256 nftId, uint256 id, uint256 characterType, uint256 rank, uint256  star,uint256 exp,uint256 isDeleted) public onlyOwner returns (uint256) {
...
function updateCharacterIndexToOwner(uint256 nftId,address owner) public onlyOwner  {
  ...
  /**
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return bytes(baseURI).length > 0 ? string(abi.encodePacked(baseURI,character.rank.toString(),"_",character.rank.toString(),json))  : "";
    }  
}
