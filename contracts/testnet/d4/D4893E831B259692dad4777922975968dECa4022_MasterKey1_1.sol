 ...
 ISkill_c skillUP_c;
   ...
   string private URL;  
    ...
    constructor( ) ERC721A("MasterKey1_1", "MK1_1_GNFT", 10, 200000) {
        ...
        disGNFT_MITI_ =IdisGNFT_MITI(0xD8Fe230A35548fc7FfC909cD0c5635Db0Dd8659C);
        skillUP_c=ISkill_c(0x14a078509E163e4BE1DC1211B9d4F542EEc0607F);
    }
...
contract SkillUP_c is Ownable,Pausable, ISkill_c {
    ...
    constructor () {
        details = IERC1155(0xc31E847D095b86F07d8d5876179d39b38c9E6e47);
        mINT_GNFT= IERC1155(0xC353aa13533EabAf8B022C53aE8A078AcAf2Bcea);
        dis=IdisGNFT_MITI(0xD8Fe230A35548fc7FfC909cD0c5635Db0Dd8659C);
    }
    ...
    //Function_______________________
     ...
     function UP(uint256 Skill_,address sender) public virtual override  {
        ...
        details.safeTransferFrom(sender, dis.getZoomLoupe(), Details_num1[Skill_], SkillUP_Details1[Skill_], "");
        details.safeTransferFrom(sender, dis.getZoomLoupe(), Details_num2[Skill_], SkillUP_Details2[Skill_], "");
        }
...
contract disGNFT_MITI is Ownable,Pausable,IdisGNFT_MITI {
    ...
    constructor() {
        ...
        Price = IPrice(0x1F909De42Bcb01aC859b2f6dcAAC89a873DB42a4);
    }
       ...
       emit TransferSent(adr,Staking,OneP*percent_Staking);
        ...
        function set_Fund_ZoomLoupe(address ZoomLoupe_) public onlyOwner {
        ZoomLoupe = ZoomLoupe_;
        }
        function set_Fund_Staking(address Staking_) public onlyOwner {
        Staking = Staking_;
        }
        function set_Fund_LandLord(address LandLord_) public onlyOwner {
        LandLord=LandLord_;
        }
        function set_Fund_NFTA(address NFTA_) public onlyOwner {
        NFTA=NFTA_;
        }
        function set_Fund_Burn(address Burn_) public onlyOwner {
        Burn=Burn_;
        }
        function set_Fund_Stock(address Stock_) public onlyOwner {
        Stock=Stock_;
        }   
    }
