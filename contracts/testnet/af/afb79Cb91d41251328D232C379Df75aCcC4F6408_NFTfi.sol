...
contract NFTfiAdmin is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor() internal {
        // Whitelist mainnet WETH - WBNB
        erc20CurrencyIsWhitelisted[address(0xc1ce24870600ff9b49A9C6A057557F4d0ea105B7)] = true;

        // Whitelist mainnet DAI - BUSD
        erc20CurrencyIsWhitelisted[address(0xB1BD810Eb926Ca0933B6bBCaDB0fc8287cB8747e)] = true;

        // Whitelist mainnet CryptoKitties
        nftContractIsWhitelisted[address(0xfde30991E7daF7F0A2b3D00d0E4c5c54c38e3c92)] = true;
    }
