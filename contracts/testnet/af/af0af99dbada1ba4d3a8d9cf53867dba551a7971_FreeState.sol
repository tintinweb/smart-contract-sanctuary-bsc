...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3D727cC209FAEE2Df5b44ECb6B448B7E2EAaFcbB;
...
contract FreeState is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x331aeD76b444BE133b04cf3Ff935A082d97f2D00;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 2000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Freestate Finance";
    string private _symbol = "FSTATE";
