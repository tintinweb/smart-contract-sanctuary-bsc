...
contract Crowdfunding is AccessControlEnumerable {
    ...
    address public /*constant*/ META_POINT = 0x0a29702D828C3bd9bA20C8d0cD46Dfb853422E98; //metaPoint address
    address public /*constant*/ DONATE = 0x8DDeaD5dA29A08E35110eE0c216A85cBE2C65884; //捐赠池 功能?
    address public /*constant*/ STAKE = 0x9c88692C6740359D849230139171176a77a96d63; //质押池
    ...
    uint256 public maxFundAmount = 500e18; //单用户最大投资金额
    ...
    function processBrokerReward(
        ...
        for (uint256 i = 0; i < 45; i++) {
            address parent = accounts[addr].head;
            if (parent == address(0)) {
