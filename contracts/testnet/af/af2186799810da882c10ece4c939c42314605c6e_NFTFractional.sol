...
contract NFTFractional is Upgradable {
    ...
    */
    ...
    function minNFT(
        address _receiver,
        uint256 _tokenId,
        bytes memory _data) external onlyController {
        nftToken.minNFT(_receiver, _tokenId, _data);
        emit MintNFT(_receiver, _tokenId, nftToken.nameToken(), nftToken.symbolToken(), _data);
    }
