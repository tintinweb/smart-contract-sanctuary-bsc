...
contract FortPolis is Token {
    ...
    uint private constant ADV_FEE           = 80;
    uint private constant ADV_FEE_DEV       = 20;
    ...
    constructor() public {
        ...
        ADMIN = msg.sender; // OWNER
        DEV_1 = 0x92bFDF9e446abAa1F10691afE21aD906118425be; // DEV 1
        DEV_2 = 0x1A32279E54Bd4164dceEd6374895254f38b688Ce; // DEV 2
    ...
    function stakeBUSD(address referrer,  uint256 _amount) public payable {
        ...
        uint fee_dev = _amount.mul(ADV_FEE_DEV).div(PERCENT_DIVIDER);

        token.transfer(ADMIN, fee);
        token.transfer(DEV_1, fee_dev);
        token.transfer(DEV_2, fee_dev);
