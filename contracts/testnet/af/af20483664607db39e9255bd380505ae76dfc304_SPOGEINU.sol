...
contract SPOGEINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc7d5A5dc0d831aC3a89daed0dA64C48bCD8c7267); 
    address payable public Wallet_Dev = payable(0x8375d665DC70745d9c1D25acB9BD4a0eA933EEEa);
    ...
    string private constant _name = "Spoge Inu"; 
    ...
    constructor () {
        ...
        _owner = 0x8375d665DC70745d9c1D25acB9BD4a0eA933EEEa;
