...
contract Municipality is OwnableUpgradeable, ReentrancyGuardUpgradeable, EIP712Upgradeable {
    ...
    function setDistributionReceiverAddresses(address[10] memory _distributionReciverAddresses) external onlyOwner {
        ...
        _requireNewAddressValid(_distributionReciverAddresses[8], vBTCBuyAndBurnWallet);
        _requireNewAddressValid(_distributionReciverAddresses[9], liquidityWallet);
    ...
    function applyVoucher(uint256 numRequestedVouchers, uint256 minerId) external notZeroAddress {
        ...
        require(msg.sender == userAddress, "Invalid owner of the miner");
...
interface IMinerNFT {
    ...
    function updateTokenLocking(uint256 _tokenId, bool _locking) external;
    function lastMiner() external returns(uint256);
}
