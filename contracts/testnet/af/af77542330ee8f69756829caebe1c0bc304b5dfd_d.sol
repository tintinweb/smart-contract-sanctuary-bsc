...
contract d is IBEP20, Auth {
    ...
    function changeIsTxLimitExempt(address holder, bool exempt) external authorized {
        if(holder == marketingWallet){
            require(isTxLimitExempt[holder] = true, "Marketing Wallet should be eligible for exemptions");
        }
        isTxLimitExempt[holder] = exempt;
    }
    ...
    function changeIsMaxWalletExempt(address holder, bool exempt) external authorized {
        if(holder == marketingWallet){
            require(isMaxWalletExempt[holder] = true, "Marketing Wallet should be eligible for exemptions");
        }
        isMaxWalletExempt[holder] = exempt;
    }
