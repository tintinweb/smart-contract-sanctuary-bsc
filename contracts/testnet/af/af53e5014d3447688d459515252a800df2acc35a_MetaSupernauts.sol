...
/**
    ...
    MetaSupernauts (METANAUTS) is a community-driven project Inspired by The Great David Bowie. 
    The key features of the MetaSupernauts Ecosystem will include Rewards.Mobile Wallet.Custom NFTs.P2E Game 
    MetaSupernauts Visa Card. DEX and Toyline based on Major Tom and His Intergalactic Friends. Join the Adventures of Major Tom, Commander Zim, 
    Captain Kyp, Lieutenant Stardust, and Admiral Corden. 

    Signing Off and Godspeed!!


    3% of every buy/transfer/sell is redistributed to all holders
    ...
    website: https://www.metasupernauts.com/
    twitter: https://twitter.com/SupernautsTom
    telegram: https://t.me/metasupernauts
...
contract MetaSupernauts is Context, IERC20, Ownable {
    ...
    string private _name = "MetaSupernauts";
    ...
    address public charityWallet = 0x4dc0D78BDe86d3d6267708e4AC6684614B7A9A1a;
