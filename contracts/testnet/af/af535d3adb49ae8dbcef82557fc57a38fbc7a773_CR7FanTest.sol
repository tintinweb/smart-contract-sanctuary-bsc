...
contract CR7FanTest is IBEP20, Ownable {
    ...
    uint256 private constant _tTotal = 7777777 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    
    // Basic Contract Info
    string private constant _name = "CR7 Fan Test Token2";
    string private constant _symbol = "CR7T2";
    ...
    // Transaction Limits
    uint256 private _maxTxAmount = _tTotal / 150 * 1; //changed
    uint256 private _maxWalletSize = _tTotal / 150 * 1; //changed
    ...
    // Fee Receiver
    address private marketingFeeReceiver = 0x7AEFf9B17A94F2e9b10951e7FEDd390e7EA362c1; // Marketing Address
    ...
    uint256 public swapThreshold = _tTotal / 3000 * 1; // 0.3% changed
    ...
    constructor () Ownable(msg.sender) {
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Mainnet:0x10ED43C718714eb63d5aA57B78B54704E256024E || TestNet:0xD99D1c33F9fC3444f8101754aBC46c52416550D1 
