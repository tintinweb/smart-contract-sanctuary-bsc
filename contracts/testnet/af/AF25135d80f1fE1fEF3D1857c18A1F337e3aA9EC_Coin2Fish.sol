...
contract Coin2Fish is ERC20, Ownable {
    ...
    function buyCommonEgg(uint amount) public payable {
        ...
        uint256 liquidityTokens = eggCommonPresalePrice.mul(eggCommonPriceC2FR).div(eggCommonPrice);
        addLiquidity(liquidityTokens, eggCommonPresalePrice);
    ...
    function buyRareEgg(uint256 amount) public payable {
        ...
        uint256 liquidityTokens = eggRarePricePresale.mul(eggRarePriceC2FR).div(eggRarePrice);
        addLiquidity(liquidityTokens, eggRarePricePresale);
