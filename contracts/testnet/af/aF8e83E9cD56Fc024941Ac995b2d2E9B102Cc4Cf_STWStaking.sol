...
contract STWStaking is Ownable {
    ...
    IUniswapV2Router public uniswapV2Router = IUniswapV2Router(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
    IUniswapV2Pair public LABs = IUniswapV2Pair(0x2421B171645DC02644c09360F776938880c06e71);
    IERC20 public token = IERC20(0x2e5853DDfd73805d525b09e93366215f10541E86);

    uint256 public minimumDeposit = 1321854654795936;//10 * 10**18;
    ...
    function unstake() public {
        ...
        if(block.timestamp < userStaking[account].timestamp + pool.lockPeriod) {
