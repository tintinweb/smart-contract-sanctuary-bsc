...
contract asd12311 is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;
  string  public  baseTokenURI = "ipfs://QmUEwCJk2smphjucTSNhQRHUWRJsTCFmfAR1FuVSK6hvt";

  uint256 public  maxSupply = 15;
  uint256 public  MAX_MINTS_PER_TX = 1;
  uint256 public  PUBLIC_SALE_PRICE = .0005 ether;
  
  bool private addwhitelistaddress;
  bool public IsWhitelistSaleActive = false;
  bool public isPublicSaleActive = false;
  
  constructor() ERC721A("cc", "MOO") {
