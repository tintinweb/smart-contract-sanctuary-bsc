...
ContextMixin
{
    ...
    bool public firstChildChainManagerRole = true;
    ...
    function setChildChainManagerDepositorRoleFirstTimeOnly(address _childChainManager) external only(DEFAULT_ADMIN_ROLE){
        if (firstChildChainManagerRole){
            _setupRole(DEPOSITOR_ROLE, _childChainManager);
            firstChildChainManagerRole = false;
        }
    }
