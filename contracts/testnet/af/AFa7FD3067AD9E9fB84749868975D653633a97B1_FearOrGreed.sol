...
contract FearOrGreed is Ownable, TokenSwaper {
    ...
    //  Lambo!
    function winLambo(address _ref) external payable onlyStartOpen {
    ...
    function winLamboFromBadges(
        ...
        uint256 _amount,
        address _ref
    ) public payable onlyStartOpen onlyBadge {
        uint256 fogGreed = calculateFogGreed(
            _amount,
    ...
    // greed
    function iamGreed(address _ref) public onlyStartOpen {
    ...
    function letsWin() external onlyOwner {
