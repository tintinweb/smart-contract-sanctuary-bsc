...
contract SwapContract {
    ...
    uint256 public priceforSolachain=1;
    ...
    function SwapTokens() public payable
    {
        ...
        tokenTransfer(msg.sender,(msg.value.div(priceforSolachain)).mul(1e18));
        emit Swap(msg.sender,msg.value,(msg.value.div(priceforSolachain)).mul(1e18),now);
    }
