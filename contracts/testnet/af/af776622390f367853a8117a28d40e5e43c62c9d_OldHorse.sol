...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xe5B4096A55483E08aB9E7067dae8c047B9400505; // owner address
...
contract OldHorse is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "OldHorse";
    string private _symbol = "OH";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x26450E2Bf0E4a50398f89bcF5DB11267bFe2aC3D); // Marketing Address
    address payable public teamWalletAddress = payable(0x820AB9ae2FbacFcf81449a7AA5d0C38eBF804a15); // Team Address
