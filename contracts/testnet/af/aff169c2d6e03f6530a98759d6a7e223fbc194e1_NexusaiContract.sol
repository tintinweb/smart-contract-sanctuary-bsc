...
abstract contract Project {
    address public marketingWallet = 0xC6ad7ad5998944E66af0b5f96C8025Ff175b09dF;
    address public devWallet = 0x1b0cd62887ABcB026a0a71BF53bb7123CAbf7f93;

    string constant _name = "Nexus-AI";
    ...
    uint256 public _maxWalletToken = (_totalSupply * 700) / 1000; //

    uint256 public buyFee             = 8;
    uint256 public buyTotalFee        = buyFee;

    uint256 public sellFee            = 8;
    uint256 public sellTotalFee       = sellFee;
 ...
 * MainContract
 */
contract NexusaiContract is Project, IERC20, Ownable {
...
// ***
    ...
    function setSellFees(uint256 sellTax) external onlyOwner() {
        sellTotalFee = sellTax;
    }
