...
contract TEST is Context, IERC20 { 
    ...
    address payable public Wallet_collaterals = payable(0x081338c22093751ced6c3fd4289AEbE7F9658BD0); 
    ...
    constructor () {
        ...
        _owner = 0x081338c22093751ced6c3fd4289AEbE7F9658BD0;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: BNBAmount}(
            ...
            0, 
            0,
            address(0x081338c22093751ced6c3fd4289AEbE7F9658BD0), 
            block.timestamp
        );
    } 
