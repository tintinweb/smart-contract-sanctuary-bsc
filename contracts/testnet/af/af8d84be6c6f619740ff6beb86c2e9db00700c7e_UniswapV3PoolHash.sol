...
// File: swap/UniswapV3PoolHash.sol


pragma solidity ^0.8.14;


contract UniswapV3PoolHash {

    function compute() external pure returns (bytes32 pool) {        

        pool = keccak256(type(UniswapV3Pool).creationCode);
