    ...
    ERC721URIStorageUpgradeable
{
    ...
    event MarketItemDeleted(address indexed nftContract, uint256 indexed tokenId, address owner);
    ...
    function createMarketSale(
        ...
        bool sold = idToMarketItem[itemId][nftContract].sold;
        address sender = msg.sender;
        ...
        idToMarketItem[itemId][nftContract].sold = true;
    ...
    function handleDelete(address nftContract, uint256 tokenId) public payable {
        ...
        _itemsSold++;
        nftSold[nftContract]++;
        emit MarketItemDeleted(nftContract, tokenId, sender);
    }
