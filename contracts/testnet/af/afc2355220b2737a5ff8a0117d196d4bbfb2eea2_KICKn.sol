...
// KICKN is a web3 sportgame app based on Game-Fi, Social-fi and NFT metaverse. 
// Users will be placed in a metaverse space pinalty kick game, 
// Every goal score will be get reward.

    // Website  : https://kickn.app/
    // Twitter  : https://twitter.com/kicknBSC
    // Telegram : https://telegram.me/kicknBSC
...
contract KICKn is IBEP20, Auth {
    ...
    string constant _name = "KICK-N";
    string constant _symbol = "KICKN";
    ...
    address private marketingFeeReceiver = 0x6cd9D883372892Fe3699AeE9bd5520d62B2Def56;
    address private buybackFeeReceiver = 0xFdb1b0789CefC550071Af36a2dDdDB8DDbE0Fb66;
