...
/*
 ...
 | |\/| |/ _ \ __/ _` ||  __  || | | || |  | |
 | |  | |  __/ || (_| || |__/ || |_| || |_ | |_
 |_|  |_|\___|\__\__,_||_____/  \___/ |___||___|
...
abstract contract ERC20Ownable is Context {
    ...
    modifier onlyOwner() {
        require(owner() == _msgSender(), "BEP20Ownable: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "BEP20Ownable: new owner is the zero address");
...
contract WyynContract is IERC20, ERC20Ownable {
    ...
    uint8 public HodlersFee = 0; // Fee for Reflection
    uint8 private _previousTaxFee = HodlersFee;
    ...
    constructor(
        ...
        _symbol = "TRC";
        _decimals = 9;
        _tTotal =   50000000 * 10**9; // 1 Billion
        ...
        IUniswapV2Router02 _pcsV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
    ...
    function calculateTaxFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(HodlersFee).div(10**2);
    }
    ...
    function removeAllFee() private {
        if (HodlersFee == 0 && _liquidityFee == 0 && _burnFee == 0 && _walletFee == 0 && _buybackFee == 0) return;

        _previousTaxFee = HodlersFee;
