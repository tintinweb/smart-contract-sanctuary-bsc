...
contract StrayFriends is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    constructor() ERC721("NFTBV1", "NFTBM") {}
    ...
    function batchTransfer(address[] calldata from, address[] calldata to, uint256[] calldata tokenId)
        external
        onlyOwner
    {
    ...
    function safeBatchMint(address to, uint256[] calldata tokenId, string[] calldata uri)
        external
        onlyOwner
    {
        for (uint256 i = 0; i < tokenId.length; i++) {
