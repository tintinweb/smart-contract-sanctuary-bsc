...
contract StackProStaking is Ownable, ERC721Holder {
    ...
    function _stake(address _user, uint256 _tokenId, uint256 _tokenPrice) internal {
        ...
        staker.tokernPrices.push(_tokenPrice);
    ...
    function updateReward(address _user) public {
        ...
        for (uint256 i = 0; i < ids.length; i++) {
            ...
            // ) {
                ...
                staker.balance += staker.tokernPrices[i] * ((1 + rewardRateAPY/rewardRateDenominator) ** (timeTaken/stakingAPYPeriod)) - staker.tokernPrices[i];
