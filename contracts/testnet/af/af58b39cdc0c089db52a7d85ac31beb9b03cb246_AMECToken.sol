...
Token name : African middle Easter coin 
Token : AMEC 
...
contract AMECToken is Context, IERC20, Ownable {
    ...
    string private _name = "African middle Easter coin";
    string private _symbol = "AMEC";
