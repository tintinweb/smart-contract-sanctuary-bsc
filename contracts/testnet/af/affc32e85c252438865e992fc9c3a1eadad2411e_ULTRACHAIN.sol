...
contract ULTRACHAIN {
	...
	address payable public ceoWallet_deposit=0x834849dA14bE1e75c3d92D226AE334Bee07d2C94;
	address payable public devWallet_deposit=0x834849dA14bE1e75c3d92D226AE334Bee07d2C94;
	address payable public devWallet2_deposit=0x834849dA14bE1e75c3d92D226AE334Bee07d2C94;
	address payable public ceoWallet_withdraw=0x834849dA14bE1e75c3d92D226AE334Bee07d2C94;
	address payable public devWallet_withdraw=0x834849dA14bE1e75c3d92D226AE334Bee07d2C94;
	address payable public devWallet2_withdraw=0x834849dA14bE1e75c3d92D226AE334Bee07d2C94;
	address payable public masterWallet=0x834849dA14bE1e75c3d92D226AE334Bee07d2C94;
	address public TokenContract=0xD6BEB6CDaB0F23e0663A9aA1D201A3bf10e34eFE;
	...
	function participate(address referrer, uint256 tokenAmount) public {
		...
		if (user.referrer != address(0)) {
            ...
            for (uint256 i = 0; i < 10; i++) {
				if ((canuserredeposit(upline) == false) && (upline != address(0)) && (BASE_CONDITION_AMOUNT[i] <= users[upline].directbusiness) && (BASE_CONDITION_LEVEL[i] <= users[upline].levels[0]))
                {
					...
					amount=amount.min( (getUserTotalDeposits(upline).mul(2)).sub(getUserTotalWithdrawn(upline)).sub(getUserAvailable(upline)));
