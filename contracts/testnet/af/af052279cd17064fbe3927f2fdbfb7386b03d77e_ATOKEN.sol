...
contract ATOKEN is ERC20Detailed, Ownable {
    ...
    // address private busdToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //PROD
    address private busdToken = 0x21eD37De1FCc9B8A3D10268a62a8058474698daA; //Dev
    ...
    uint256 private sellFeeTreasuryAdded = 8;
    uint256 private sellFeeRFVAdded = 7;
    ...
    uint256 public price = 900000000000000;
    ...
    constructor() ERC20Detailed("Limit Hard", "Hard Limit", uint8(DECIMALS)) {
        //router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Prod
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //Dev
