...
contract CatKiller is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CatKiller";
    string private _symbol = "CatKiller";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x3eBD83088b98B467FA71F888D33E7a8708478C8a); // Marketing Address
    address payable public teamWalletAddress = payable(0x3eBD83088b98B467FA71F888D33E7a8708478C8a); // Team Address
