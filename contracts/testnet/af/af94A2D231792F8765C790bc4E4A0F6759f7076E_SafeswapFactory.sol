...
contract SafeswapFactory is ISafeswapFactory {
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        require(_approvePartner[msg.sender], "Waiting for partner approval");
...
interface ISafeswapFactory {
    ...
    function _approvePartner(address walletAddress) external view returns (bool);
    ...
    function unApproveLiquidityPartner(address) external;
}
