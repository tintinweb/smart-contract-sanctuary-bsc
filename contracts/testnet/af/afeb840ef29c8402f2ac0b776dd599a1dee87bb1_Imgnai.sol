 ...
 *                                                                                                                
 *                                                                                                                
 * RRRRRRRRRRRRRRRRR     iiii                      hhhhhhh                            AAA               IIIIIIIIII
 * R::::::::::::::::R   i::::i                     h:::::h                           A:::A              I::::::::I
 * R::::::RRRRRR:::::R   iiii                      h:::::h                          A:::::A             I::::::::I
 * RR:::::R     R:::::R                            h:::::h                         A:::::::A            II::::::II
 *   R::::R     R:::::Riiiiiii     cccccccccccccccc h::::h hhhhh                  A:::::::::A             I::::I  
 *   R::::R     R:::::Ri:::::i   cc:::::::::::::::c h::::hh:::::hhh              A:::::A:::::A            I::::I  
 *   R::::RRRRRR:::::R  i::::i  c:::::::::::::::::c h::::::::::::::hh           A:::::A A:::::A           I::::I  
 *   R:::::::::::::RR   i::::i c:::::::cccccc:::::c h:::::::hhh::::::h         A:::::A   A:::::A          I::::I  
 *   R::::RRRRRR:::::R  i::::i c::::::c     ccccccc h::::::h   h::::::h       A:::::A     A:::::A         I::::I  
 *   R::::R     R:::::R i::::i c:::::c              h:::::h     h:::::h      A:::::AAAAAAAAA:::::A        I::::I  
 *   R::::R     R:::::R i::::i c:::::c              h:::::h     h:::::h     A:::::::::::::::::::::A       I::::I  
 *   R::::R     R:::::R i::::i c::::::c     ccccccc h:::::h     h:::::h    A:::::AAAAAAAAAAAAA:::::A      I::::I  
 * RR:::::R     R:::::Ri::::::ic:::::::cccccc:::::c h:::::h     h:::::h   A:::::A             A:::::A   II::::::II
 * R::::::R     R:::::Ri::::::i c:::::::::::::::::c h:::::h     h:::::h  A:::::A               A:::::A  I::::::::I
 * R::::::R     R:::::Ri::::::i  cc:::::::::::::::c h:::::h     h:::::h A:::::A                 A:::::A I::::::::I
 * RRRRRRRR     RRRRRRRiiiiiiii    cccccccccccccccc hhhhhhh     hhhhhhhAAAAAAA                   AAAAAAAIIIIIIIIII
 *                                                                                                                
 *   
 * 
 * Telegram Bot:
 ...
 * - AI image generator
 * - Visual customizations
 * - No login required (first time only)
*/
 ...
 */
 contract Imgnai is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "RichAI | richai.app";
    string private _symbol = "RICHAI";
    uint8 private _decimals = 18;
    uint256 private _supply = 1000000000;
    uint256 public taxForLiquidity = 1; //sniper protection, to be lowered to 1% 
    uint256 public taxForMarketing = 1; //sniper protection, to be lowered to 1% 
    uint256 public maxTxAmount = 10000001 * 10**_decimals;
    uint256 public maxWalletAmount = 10000001 * 10**_decimals;
    address public marketingWallet = 0x616010Fe7072fAd682153f18914EC94983Ec0B0b;
