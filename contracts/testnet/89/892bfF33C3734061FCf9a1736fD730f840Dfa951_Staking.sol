...
contract Marketplace is IMarketplace, Ownable, ERC1155Holder {
    ...
    function depositToken(uint256 _amount) public payable override {
        require(_amount > 0, "MARKETPLACE: INVALID AMOUNT");
        require(
            ERC20(currency).allowance(msg.sender, address(this)) >= _amount,
            "MARKETPLACE: MUST APPROVE FIRST"
        );
        // Transfer currency from buyer to marketplace
        bool result = ERC20(currency).transferFrom(msg.sender, address(this), _amount);
...
import "hardhat/console.sol"; //for testing, remove when product
...
contract Staking is IStaking, Ownable, ERC1155Holder {
    ...
    function stake(
        ...
        ERC1155(nft).safeTransferFrom(msg.sender, address(this), _nftId, _amount, _data);
