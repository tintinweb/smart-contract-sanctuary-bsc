...
// File: contracts/lib/HasContractURI.sol
...
// File: contracts/SampleStore.sol

pragma solidity 0.6.12;
pragma experimental ABIEncoderV2;

contract ERC1155Con is Ownable, SignerRole, StoreBase {
    string public name;
    ...
    constructor(string memory _name, string memory _symbol, address signer, string memory contractURI, string memory tokenURIPrefix) StoreBase(contractURI, tokenURIPrefix) public {
        name = _name;
        symbol = _symbol;
    ...
    function mint(address from, address to, uint256 id, uint256 supply, string memory uri) 
