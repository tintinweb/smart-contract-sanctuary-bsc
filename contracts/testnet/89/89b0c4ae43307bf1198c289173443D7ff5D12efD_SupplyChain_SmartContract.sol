...
/*******************************************************certificates******************************************************************/
    ...
    ProductCertificates[] public ListofPrdCertificates;
    ...
    IngredientCertificates[]  ListofIngCertificate;
    ...
    function AddIngredientCertificates(uint256 _ingId, string[] memory _CertificateName, string[] memory _URL) public {
        ...
        //IngredientCertificatesList[_ingId] = IngredientCertificates(uid, _CertificateName, _URL);
