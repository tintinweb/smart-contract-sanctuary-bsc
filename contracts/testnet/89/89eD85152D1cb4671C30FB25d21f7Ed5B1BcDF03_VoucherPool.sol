...
contract VoucherPool is ReentrancyGuard, Ownable, Pausable {
    address public NFT_SERVICE_CONTRACT = 0xF8715e631F2A3B1f3a9C8Fe2229567184B4055Cf;
    address public VOUCHER_SERVICE_CONTRACT = 0x4E213F92723daD3965ed7952bd38D7dC6c73C2a5;
    uint256 public TOTAL_SALE_1 = 3300;
    uint256 public TOTAL_SALE_2 = 3300;
    uint256 public TOTAL_SALE_3 = 3400;
    ...
    function createMarketSale(
        ...
        IVoucherService(VOUCHER_SERVICE_CONTRACT).usedVoucher(poolType, _msgSender(), appliedVoucher);
