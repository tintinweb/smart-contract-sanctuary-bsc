...
contract ECCOIN is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd2d3A1345C507dD940Ca17Bd349B7e8EB788288D;
    uint256 private constant MAX = ~uint256(900000000);
    uint256 private _tTotal = 900000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "EC COIN";
