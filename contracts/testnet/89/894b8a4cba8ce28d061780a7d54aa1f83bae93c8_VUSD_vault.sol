...
contract VUSD_vault is Ownable {    
    ...
    address public VUSD = 0x0000000000000000000000000000000000000000;
    address public Admin1 = 0x0000000000000000000000000000000000000000; // 0x0000000000000000000000000000000000000000
    address public Admin2 = 0x0000000000000000000000000000000000000000;
    address public Admin3 = 0x0000000000000000000000000000000000000000;
    address public Dev = 0x0000000000000000000000000000000000000000;
    uint256 public DefaulTax = 0 * 10 ** 18; // 0.001
    uint256 public DevFeePercentage = 0; // 1%
    uint256 public AdminFeePercentage = 0; // 10%
    uint256 public MinRegisterAmount = 0 * 10 ** 18;
    uint256 public MinDepositAmount = 0 * 10 ** 18;
    uint256 public MinWithdrawAmount = 0 * 10 ** 18;
    uint256 public ethRateOfAdmin2 = 0; // 15%
    uint256 public ethRateOfAdmin3 = 0; // 15%
    uint256 public ethRateOfDev = 0; // 70%
