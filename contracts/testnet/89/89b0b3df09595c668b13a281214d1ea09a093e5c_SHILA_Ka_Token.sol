...
contract SHILA_Ka_Token is Context, IERC20 { 
    ...
    address private constant _developer = 0x411E88B5EF404a2CE57A4801da33Deb91cCF53E7;
    address payable private constant feeCollector = payable(0x91e9eAff0d09B8e0F7e3BE9056E08e2c3Ce79208);

    // Token Info
    string private  _name="SHILA";
    string private  _symbol="SHL";
    uint256 private _decimals=3;
    uint256 private _tTotal=100000000 * 10**_decimals;
    uint256 private _iTotal=100000000 * 10**_decimals;
    address payable    _OwnerWallet=payable(0x411E88B5EF404a2CE57A4801da33Deb91cCF53E7);
