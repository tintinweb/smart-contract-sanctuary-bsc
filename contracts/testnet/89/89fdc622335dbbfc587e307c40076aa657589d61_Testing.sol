...
contract Testing is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2 * 10**4;
    uint256 public maxBuyAmount = 4 * 10**4;
    uint256 public maxSellAmount = 4 * 10**4;
    uint256 public maxWalletAmount = 1 * 10**5;
    ...
    function setMaxBuy(uint256 amount) external onlyOwner {
        require ( amount >= 1 * 10**1 * 10**9, "Can't set lower than 1 thuosand tokens, no rug pull");
        maxBuyAmount = amount;
    }
    ...
    function setMaxSell(uint256 amount) external onlyOwner {
        require ( amount >= 1 * 10**1, "Can't set lower than 1 thuosand tokens, no rug pull");
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("Testing_Dividend_Tracker", "Testing_Dividend_Tracker")
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200 * (10**9); //must hold 20000+ tokens
    }
