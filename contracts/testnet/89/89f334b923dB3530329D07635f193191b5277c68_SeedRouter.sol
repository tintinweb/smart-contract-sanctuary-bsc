...
/**
 *From SeedSwap Dev Team - SeedRouter V2 - 17 September 2022
*/

/**
 *From SeedSwap Dev Team - Solidity Version Compiler 0.6.6
*/
...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'b2e881bf5d6992de25d378d89b895b5b4610e074055c2d5db91c611ccda8437c' // init code hash
            ))));
    }
...
contract SeedRouter is IPancakeRouter02 {    
    using SafeMath for uint;
