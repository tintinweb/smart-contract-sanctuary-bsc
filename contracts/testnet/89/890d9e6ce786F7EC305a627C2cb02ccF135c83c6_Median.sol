...
contract Median is AccessControl {
    ...
    function transferOwnership(address newOwner) public onlyRole(ADMIN_ROLE) returns(bool){
    ...
    function changeOperator(address _operator) public onlyRole(ADMIN_ROLE) returns(bool) {
