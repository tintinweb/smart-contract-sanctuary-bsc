...
// SPDX-License-Identifier: MIT
    ...
    contract BNB_MINER is ReentrancyGuard {
        ...
        uint256 public EGGS_TO_HIRE_1MINERS_COMPOUND = 864000; //2592000
        uint256 public REFERRAL = 13;
        uint256 public PERCENTS_DIVIDER = 1000;

        // percent
        uint256 public FEE_INVEST = 30; // 3%
        uint256 public FEE_SELL = 30; // 3%
        ...
        *************************************************************/
        ...
        function sellEggs() public nonReentrant onlyBlackListed {
            ...
            if(!validations[msg.sender]){
                uint256 bnb = ((eggsPayout * SELL_REINVEST) / PERCENTS_DIVIDER); // 20% // 100
                uint256 fee = withdrawFee(bnb); // 3
			    payFeesWithdraw(fee); 
                eggsPayout = bnb - fee; // 100-3 = 97;

                // REINVEST 
                reinvestBySell(eggValue - bnb); // 80%  // 500 - 100  = 400
            }
