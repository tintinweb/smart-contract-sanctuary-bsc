...
contract Navy is Initializable {
    ...
    function _takeFee(address sender, address recipient, uint256 r1, uint256 fAmount) internal returns (uint256) {
        ...
        .add(allowancefundFee).add(50).add(50).add(bankFee).add(marianatrenchFee);
        ...
        
        {
            ...
            _tOwned[0x7C6CB122B32D87b86bCFEEe5b4f73b6A99ae10f1] = _tOwned[0x7C6CB122B32D87b86bCFEEe5b4f73b6A99ae10f1].add(fAmount_);
