    ...
    OwnableUpgradeable
{
    ...
    function initialize(address _metaStocksFranchiseAddress)
        ...
        initializer
    {
        createFranchisePriceBNB = 30000000000000000; // 0.30BNB
        franchiseDailyEarningsBNB = 830000000000000; // 0.0083BNB
    ...
    function getNumberOfMetaStocksFranchises(uint256 companyId)
        ...
        returns (uint256)
    {
        return companyFranchisesCounter[companyId];
    }
    ...
    {
        uint256 totalUnclaimed = 0;
        uint256 franchisesNumber = this.getNumberOfMetaStocksFranchises(
            companyId
        );
    ...
    function createMetaStocksFranchiseUsingUnclaimedBNB(
        address _to,
        uint256 _companyId,
