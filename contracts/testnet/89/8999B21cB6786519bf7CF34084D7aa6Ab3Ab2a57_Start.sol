...
/**
    🎒RUFUS INU 🎒$RUFUS 🎒LAUNCHING TODAY

TG: @RufusInuETHann

The team plans to donate a portion of the taxes to animals, so definitely looking forward to that. They delayed launch a bit until after holidays and are doing a few Shill contests. Check them out! 

Rufus Inu refuses to give up to uncertainty and fear. Though the market may be hell, we know that the winners are the ones who KEEP GOING! We refuse to give up and will push no matter what.

$RINU is here to embody the spirit of the great Winston Churchill and his love for his dog, Rufus. Just like Churchill, we are strong, but we have a soft spot for man's best friend.
*/
...
contract Start is ERC20, Ownable {
    ...
    function LiquidityFee(uint256 _value) external onlyOwner {
    ...
    function maxTxAmount (address _address, bool _value) external onlyOwner {
