...
contract iNf4mation_NFT is BEP721, BEP721Enumerable, BEP721URIStorage, Pausable, Ownable, BEP721Burnable {
    using SafeMath for uint256;

    mapping (address => bool) public minters;

    constructor() BEP721("iNf4mation NFT", "$SNFT") {
    }
    ...
    function addURI_(uint256 tokenId, string memory uri) public onlyMinter {
