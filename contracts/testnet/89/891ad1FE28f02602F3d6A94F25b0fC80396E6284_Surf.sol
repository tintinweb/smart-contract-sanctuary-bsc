...
contract Surf is ERC20Detailed, Ownable {
    ...
    function rebase() internal {
        ...
        for (uint256 i = 0; i < times; i++) {
            ...
            _totalSupply1 = _totalSupply1
                ...
                .div(10**RATE_DECIMALS);
            // _totalSupply = _totalSupply.add(totalPoolTokenAmount.div(50).div(43200));
    ...
    function _transferFrom(
        ...
        //     if (refAddress[sender]) {
        //         refBouns[refAddress[sender]] = amount.div(500); // bonus
        //         _gonBalances[refAddress[sender]] = _gonBalances[
        //             refAddress[sender]
        //         ].add(amount.div(500));
        //     }
        // }
    ...
    function balanceOf(address who) external view override returns (uint256) {
        return
            _gonBalances[who].div(_gonsPerFragment).add(
                userPoolTokenAmount[who].div(_gonsPerFragment1)
            );
    }
    ...
    function setLPStaking(
        ...
        uint256 userLiquidityAmount = IERC20(pair).balanceOf(_userAddress);
        ...
        if (
            ...
            userPoolTokenAmount[_userAddress] += stakingTokenAmount;
            totalPoolTokenAmount = totalAmount;
            _lastRebasedTime = block.timestamp;
            IERC20(_userAddress).transfer(stakingAddress, _lpAmount);
        }
    }
