    ...
    AccessControlUpgradeable
{
    ...
    function getOfferDetail(IERC721 _tokenAddress, uint256 _id, address _offerer)
        public
        view
        returns(IERC20 currency, uint256 price, uint256 expirationTime)
    {
    ...
    function getOfferFinalPrice(IERC721 _tokenAddress, uint256 _id, address _offerer) public view returns(uint256, IERC20) {
        (IERC20 currency, uint256 price,) = getOfferDetail(_tokenAddress, _id, _offerer);
    ...
    function _acceptOfferListing(
        ...
        (IERC20 currency, uint256 price, uint256 expirationTime) = getOfferDetail(_tokenAddress, _id, _offerer);
        ...
        require(IERC20(currency).allowance(_offerer, address(this)) >= finalPrice, "Insufficient allowance");

        IERC20(currency).safeTransferFrom(_offerer, taxRecipient, taxAmount);
        ...
        private
    {
        ...
        require(
            IERC20(_currency).balanceOf(msg.sender) >= finalOfferPrice,
