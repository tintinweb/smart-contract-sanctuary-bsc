...
contract TresorFinance is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Tresor Finance";
    string constant _symbol = "TRESOR";
    ...
    event BotCheckin(address guest, uint256 rentPaid);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6C193Bea0965891D8f8D09CB409B07Cd85f7E2CC;
    ...
    // NO Sniping
        if(AntiBotMode){
            ...
            if(tx.gasprice > maxRoomRent && sender == pair){
                ...
                emit BotCheckin(recipient, tx.gasprice);
            }
        }
