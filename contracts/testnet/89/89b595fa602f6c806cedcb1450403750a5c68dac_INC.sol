...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD06cAEbB121b944fd0378634d88977D7bD494a3c;
...
contract INC is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xE9089ba26FFBAbBB79A6ec71a66b5D6cD4e72671;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 21000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "pruebaI6";
    string private _symbol = "PI6";
    uint8 private _decimals = 9;
    uint256 public _taxFee = 28;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 12;
    ...
    uint256 public _maxTxAmount = 1350000000000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 2000000000000 * 10**9;
