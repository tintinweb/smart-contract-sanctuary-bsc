...
contract GKSToken is IERC20, Ownable {
    ...
    address public profitAddress = 0x811558487a9b7c89165c9EDde05FFdD9738c89b0;
    ...
    constructor(address liquidityReceiveAddress_) {
        ...
        _swapWhiteList[_uniswapV2Pair] = true;
    ...
    function process(uint256 gas) private {
        ...
        if(shareholderCount == 0 || gkAddress == address(0)) return;
