...
contract Epos is Ownable {
    ...
    function register(
        ...
        require(icoStarted == true, "ICO Limit ended");
    ...
    function withdrawalBackup(address _userAddress) public returns (bool) {
    ...
    function setIcoSaleStatus(uint256 _status) public returns (bool) {
