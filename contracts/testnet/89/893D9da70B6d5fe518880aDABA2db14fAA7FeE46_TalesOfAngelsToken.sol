...
contract TalesOfAngelsToken is BEP20Detailed, BEP20 {

    uint256 private totalTokens;

    constructor() public BEP20Detailed("Tales Of Angels Token", "ANGT", 18) {

        totalTokens = 50000000 * 10 ** uint256(decimals());
