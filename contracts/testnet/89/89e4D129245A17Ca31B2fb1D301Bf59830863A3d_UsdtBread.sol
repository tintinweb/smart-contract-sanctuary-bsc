...
contract UsdtBread {
	...
	address erctoken = 0xAE7be2256640D3Ea3D74DAc6583944CeC3305d39; /** USDT Testnet **/
    //address erctoken = 0x55d398326f99059fF775485246999027B3197955; /** USDT Mainnet **/
    
    uint256 public EGGS_TO_HIRE_1MINERS = 959000;
    ...
    uint256 public MIN_INVEST_LIMIT = 1 * 1e18; /** 10 USDT  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 20000 * 1e18; /** 20000 USDT  **/

	uint256 public COMPOUND_BONUS = 33; /** 3.3% **/
	uint256 public COMPOUND_BONUS_MAX_TIMES = 8; /** 8 times / 4 days. **/
    uint256 public COMPOUND_STEP = 1 * 1 * 60; /** every 12 hours. **/

    uint256 public WITHDRAWAL_TAX = 500;
    uint256 public COMPOUND_FOR_NO_TAX_WITHDRAWAL = 4; // compound days, for no tax withdrawal.
	...
	uint256 public WITHDRAW_COOLDOWN = 1 * 1 * 60; /** 3 hours  **/
...
USDT Crops Farmer
 Hire Farmers, Gather Crops, Harvest Crops and Sell for USDT. 
  ...
  3.3% stacking compound bonus every 12 hrs, max of 4 days. (26.4%)
  48 hours cut off time.
  10 USDT minimum investment.
  20,000 USDT max deposits per wallet.
  50% feedback for withdrawals that will be done not after 4 consecutive compounds.(12.5%)
