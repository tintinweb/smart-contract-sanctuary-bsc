...
contract MockTrapezaZap is TrapezaControlled {
  ...
  IStakingV2 private stakingV2 = IStakingV2(0x11a161c85B2a507CFd8944A942C18991A4832874);
  ...
  constructor() {
    ...
    //BUSD
    addBond(IBond(0xeA7DD42C252C96bB65C006Eb3cFb2f6a9EF8F126), false);
  }
  ...
  function _swapByPath(address[] calldata path, uint256 amount) internal returns (uint256) {
    //no need to swap
    if (path.length == 1 || path[0] == path[1]) return amount;
