...
import "./FurVaultManager.sol";
import "./FurSortedVaults.sol";

contract FurMultiVaultGetter {
    ...
    FurVaultManager public vaultManager; 
    IFurSortedVaults public sortedVaults;

    function setContract(FurVaultManager _vaultManager, IFurSortedVaults _sortedVaults) public {
...
contract FurSortedVaults is BaseContract, IFurSortedVaults {
    ...
    function insert (address _id, uint256 _NICR, address _prevId, address _nextId) external override whenNotPaused {
        IFurVaultManager vaultManagerCached = vaultManager;

        _requireCallerIsBOorVaultM(vaultManagerCached);
        _insert(vaultManagerCached, _id, _NICR, _prevId, _nextId);
    }

    function _insert(IFurVaultManager _vaultManager, address _id, uint256 _NICR, address _prevId, address _nextId) internal {
    ...
    function _validInsertPosition(IFurVaultManager _vaultManager, uint256 _NICR, address _prevId, address _nextId) internal view returns (bool) {
     ...
     */
    function _descendList(IFurVaultManager _vaultManager, uint256 _NICR, address _startId) internal view returns (address, address) {
     ...
     */
    function _ascendList(IFurVaultManager _vaultManager, uint256 _NICR, address _startId) internal view returns (address, address) {
    ...
    function _findInsertPosition(IFurVaultManager _vaultManager, uint256 _NICR, address _prevId, address _nextId) internal view returns (address, address) {
        address prevId = _prevId;
        address nextId = _nextId;
    ...
    function _requireCallerIsBOorVaultM(IFurVaultManager _vaultManager) internal view {
