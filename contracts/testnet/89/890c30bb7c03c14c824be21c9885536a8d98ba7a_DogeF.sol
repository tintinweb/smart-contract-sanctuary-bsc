 ...
 */
contract DogeF is IBEP20, ReentrancyGuard, Context, Ownable {
	...
	string private constant _name         = "DogeF";
    string private constant _symbol       = "DGE";
	uint8 private constant _decimals      = 10;
	uint256 private constant _totalSupply = 1 * 10**16 * 10**_decimals; // 10Q
	...
	uint256 public buyBurnFee   = 1;  // 1% Fee to Burn wallet on buy
	uint256 public sellBurnFee  = 3;  // 3% Fee to Burn wallet on sell
	uint256 public otherBurnFee = 3;  // 3% Fee to Burn wallet on other transaction

	uint256 public buyRewardsFee   = 1;  // 1% Fee to Rewards wallet on buy
	uint256 public sellRewardsFee  = 3;  // 3% Fee to Rewards wallet on sell
	uint256 public otherRewardsFee = 3;  // 3% Fee to Rewards wallet on other transaction

	uint256 public buyMarketingFee   = 1;  // 1% Fee to Marketing wallet on buy
	uint256 public sellMarketingFee  = 3;  // 3% Fee to Marketing wallet on sell
	uint256 public otherMarketingFee = 3;  // 3% Fee to Marketing wallet on other transaction
	...
	// Dev's wallets
	address payable public constant marketingWallet = payable(0xC29572Fbda92594e7562da00FAD00751B011f42f);
