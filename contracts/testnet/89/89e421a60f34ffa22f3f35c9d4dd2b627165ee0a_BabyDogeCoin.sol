...
contract BabyDogeCoin is Context, IERC20, Ownable {
    ...
    string private _symbol = "Baby Doge Coin";
    ...
    address public marketingWallet = 0x42A426dBdb9d8F59267902E80d1e65142b9ED86c;
    ...
    function deactivate() external onlyOwner{
        require(antiwhale == true, "already deac");
        antiwhale = false;

    }

    function active() external onlyOwner{
        require(antiwhale == false, "already act");
        antiwhale = true;
