...
function process(uint256 gas) external;
 ...
 contract DividendDistributor is IDividendDistributor {
    ...
    // IERC20 WBNB = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
 ...
 contract PROFY is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("PROFY", "PROFY", uint8(DECIMALS)) Ownable() {
       ...
       // router = IPancakeSwapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        autoLiquidityReceiver = 0x92e8b414f65721dc05f79fC19504cBd7FF9c92E6;
        treasuryReceiver = 0x46E8f69f286b059ED531de66c28C6FcDdd786216;
...
function withdrawAllToTreasury() external swapping onlyOwner {
         ...
         uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
    require(amountToSwap > 0, "There is no PROFY token deposited in token contract");
    address[] memory path = new address[](2);
    path[0] = address(this);
    path[1] = router.WETH();
    router.swapExactTokensForETHSupportingFeeOnTransferTokens(
