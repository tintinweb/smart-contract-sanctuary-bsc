...
Pause
{
    ...
    function initialize(address _tokenProject, address _withdrawWallet, uint256 _totalsupply, uint256 _timeLock, uint256 _lengthVesting)
    public
    initializer
    {
    ...
    function validate(IERC20 tokenRaise_, uint256 amount_) internal {
        ...
        require(totalsupply >= allocation, "Don't have enough tokens for sell");
    }
