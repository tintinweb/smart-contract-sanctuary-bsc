...
import "./Strategy/StableFuriofiStrategy.sol";

/// @title Stable FurioFi strategy furiofinance contract
contract StableFFStrategyFurioFinance is
    Initializable,
    StableBaseConfig,
    StableFuriofiStrategy,
...
abstract contract StableFuriofiStrategy is Initializable, StableBaseConfig {
    using SafeERC20Upgradeable for IERC20Upgradeable;
