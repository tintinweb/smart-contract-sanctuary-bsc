...
contract WorldCup is OwnableUpgradeable {
    ...
    function betting(uint amount_, uint team_) public {
        ...
        if (competitionType == 128 || competitionType == 64) {
            ...
            if (team_ == 1) {
                mapInstantTotal[matchId].team1Amount += amount_ * 0.53 ether;
            } else {
                mapInstantTotal[matchId].team2Amount += amount_ * 0.53 ether;
            }
            mapPlayerRecord[player].push(Instant({
                player: player,
                amount: amount_ * 0.53 ether,
                leverageAmount: leverageAmount * 0.53 ether,
                team: team_,
                matchId: matchId
            }));

            // 总量
            mapInstantTotal[matchId].total += amount_ * 0.53 ether;
            mapChampionTotal[championIndex].soulAmount += amount_ * 0.37 ether;
        } else if (competitionType == 16) {
            if (team_ == 1) {
                mapInstantTotal[matchId].team1Amount += amount_ * 0.63 ether;
            } else {
                mapInstantTotal[matchId].team2Amount += amount_ * 0.63 ether;
            }
            mapPlayerRecord[player].push(Instant({
                player: player,
                amount: amount_ * 0.63 ether,
                leverageAmount: leverageAmount * 0.63 ether,
                team: team_,
                matchId: matchId
            }));

            // 总量
            mapInstantTotal[matchId].total += amount_ * 0.63 ether;
            mapChampionTotal[championIndex].soulAmount += amount_ * 0.27 ether;
        } else if (competitionType == 8) {
            if (team_ == 1) {
                mapInstantTotal[matchId].team1Amount += amount_ * 0.73 ether;
            } else {
                mapInstantTotal[matchId].team2Amount += amount_ * 0.73 ether;
            }
            mapPlayerRecord[player].push(Instant({
                player: player,
                amount: amount_ * 0.73 ether,
                leverageAmount: leverageAmount * 0.73 ether,
                team: team_,
                matchId: matchId
            }));

            // 总量
            mapInstantTotal[matchId].total += amount_ * 0.73 ether;
            mapChampionTotal[championIndex].soulAmount += amount_ * 0.17 ether;
        } else if (competitionType == 4) {
            if (team_ == 1) {
                mapInstantTotal[matchId].team1Amount += amount_ * 0.83 ether;
            } else {
                mapInstantTotal[matchId].team2Amount += amount_ * 0.83 ether;
            }
            mapPlayerRecord[player].push(Instant({
                player: player,
                amount: amount_ * 0.83 ether,
                leverageAmount: leverageAmount * 0.83 ether,
                team: team_,
                matchId: matchId
            }));

            // 总量
            mapInstantTotal[matchId].total += amount_ * 0.83 ether;
            mapChampionTotal[championIndex].soulAmount += amount_ * 0.07 ether;
        } else if (competitionType == 2) {
            if (team_ == 1) {
                mapInstantTotal[matchId].team1Amount += amount_ * 0.88 ether;
            } else {
                mapInstantTotal[matchId].team2Amount += amount_ * 0.88 ether;
            }
            mapPlayerRecord[player].push(Instant({
                player: player,
            ...
            // 总量
            mapInstantTotal[matchId].total += amount_ * 0.88 ether;
            mapChampionTotal[championIndex].soulAmount += amount_ * 0.02 ether;
        }
