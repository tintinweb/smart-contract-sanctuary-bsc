...
/** 
Telegram Portal: https://t.me/FREEDOMTRUCKERS
TikTok: https://vm.tiktok.com/ZMLYSWEcx/
*/ 
...
contract FreedomTruckers is Context, IERC20, Ownable {
   ...
   address payable public _marketingAddress =
        payable(address(0x4da5Ab456c532419d4FCeC281876Cf577b5ea161));
    address payable public _teamwallet =
        payable(address(0x352f43CB9B1538a8645c6Bbb3CcEd18a04Fe1aA8));
    address _partnershipswallet =
        payable(address(0xc7218ff19D53439847C6f84Bd4E92f5daFB6C040));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "Freedom Truckers";
    string private _symbol = "FreeTruckers";
