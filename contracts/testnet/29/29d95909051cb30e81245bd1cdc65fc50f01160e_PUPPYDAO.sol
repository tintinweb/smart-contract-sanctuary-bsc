...
contract PUPPYDAO is Context, IERC20, Ownable {
    ...
    string private constant _name = "PUPPY DAO";
    string private constant _symbol = "PUPPYDAO";
   ...
   function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
    ...
    function setMaxBuyAndSellAmount(uint256 _maxBuyamount, uint256 _maxSellAmount) external onlyOwner{
        ...
        maxSellAmount = _maxSellAmount * 1**1;
    }
