...
contract NFTTricket is ERC721("BABY-TRICKET", "BABY-TRICKET"), Ownable {
    ...
    function initialize(
        ...
        require(msg.sender == SMART_TICKE_FACTORY, "Not factory");
...
contract INO is Ownable {
    ...
    function createINO(
        ...
        inoInfos[inoIds].harcatPerUsers = harcatPerUsers;
    ...
    function mintForVault(
        ...
        uint256 tokenId = nftAddress.tokenOfOwnerByIndex(vault, 0);
