...
contract LymToken is Ownable, ERC20, ERC20Burnable {
    ...
    // constructor() ERC20("TRS TOKEN", "TRS") {
    constructor(
        address router_,
        address usdt_,
        address helper_,
    ...
    function _processTransfer(
        ...
        if (meta.whiteContract) {
            require(
                !_msgSender().isContract() || whiteContracts[_msgSender()],
                "not white contract"
            );
        ...
        if (_isSwap(from, to)) {
            ...
            if (
                meta.autoAddLiquidity && balanceOf(address(meta.helper)) >= meta.addLiquidityAmount
            ) {
