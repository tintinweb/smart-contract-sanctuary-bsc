...
// File: eternallove/ETLFans-token.sol
...
contract ETLFans is CfoTakeable,IERC20Metadata {
    ...
    uint256 private constant _totalSupply = 131400000 * 1e18;
    ...
    uint public goldNFTRate = 2 * 1e16;
    uint public diamondNFTRate = 1 * 1e16;
    uint public burnRate = 2 * 1e16;
    uint public fundRate = 1 * 1e16;
    uint public personRate = 6 * 1e16;
