    ...
    IGrittiMetathonFactory
{
    ...
    function createEvent(
        ...
        require(!equal(eventSlug, ""), "Invalid eventSlug");
        require(!equal(eventName, ""), "Invalid eventName");
        require(!equal(rootHash, ""), "Invalid rootHash");
        require(!equal(name, ""), "Invalid name");
        require(!equal(symbol, ""), "Invalid symbol");
        require(!equal(baseURI, ""), "Invalid baseURI");
