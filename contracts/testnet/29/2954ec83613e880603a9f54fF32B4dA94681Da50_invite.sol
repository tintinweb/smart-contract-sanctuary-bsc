...
contract invite  is Ownable {
    ...
    event PrintUpdateValidInvite(address, address, address, address, address, address);
  ...
  /*重启数据*/
   ...
   /*初始化*/
    ...
    function _UpdateValidInvite(InviteData storage data , address _address) private {
        ...
        emit PrintUpdateValidInvite(inviteAdress, data.school._nextStudents[inviteAdress], oldTop1Address, newTop1Address, oldRankAddress, newRankAddress);
    }
