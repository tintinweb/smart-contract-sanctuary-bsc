...
contract Gold is ERC20, Pausable, AccessControl {
    ...
    constructor() ERC20("GOLD", "GLD") {
        //set quyen admin va pauser_role cho token owner
        _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);
        _setupRole(PAUSER_ROLE, msg.sender);

        //khoi tao token cho token owner
        _mint(msg.sender, 1000000000 * 10**decimals());
    }

    //chi nhung nguoi co role PAUSER_ROLE thi moi dc pause token
    ...
    function _beforeTokenTransfer(
        ...
        require(
            ...
            "Gold: account sender was not on blacklist"
        );
        require(
            _blacklist[to] == false,
            "Gold: account recipent was not on blacklist"
        );
        ...
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
        ...
        require(
            ...
            "Gold: account was on blacklist already"
        );
