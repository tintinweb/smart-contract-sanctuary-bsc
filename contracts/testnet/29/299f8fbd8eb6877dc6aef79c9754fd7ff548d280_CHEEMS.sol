 ...
 * Telegram : @cheemsecosystem
 * Twitter  : @cheemstokeninu
  * 
 * Cheems Token is the first BSC dog coin for the people, by the people with 50% of the total supply is Burn.
 * Cheems is also brother of BONK. I'm here to help fight FUD.
 * 
 ...
 * 
 *  
 * Tax Structure | BIG Marketing | CEX Listing
 * ---------------
 * Development : 1%
 * Marketing : 2%
 * Community Reward : 5%
 ...
 * Contributor(5%)       :        		        5%
 * 
 * Want Contribute ? Find us at t.me/cheemsecosystem 
 *  
 * Don't miss your opportunity to the Moon!
 * 
*/
...
contract CHEEMS is ERC20, Ownable {
    ...
    uint256 private _tTotal = 42e10 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    uint8 private _decimals = 18;

    uint256 public _taxFee = 50; // 5% To Holder Reward
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 10; // 2% for Development
    uint256 private _previousDevelopmentFee = _developmentFee;
    uint256 public _marketingFee = 20; // 3% for Marketing
    ...
    uint256 private numTokensSellToAddToLiquidity = _tTotal / 5000;
