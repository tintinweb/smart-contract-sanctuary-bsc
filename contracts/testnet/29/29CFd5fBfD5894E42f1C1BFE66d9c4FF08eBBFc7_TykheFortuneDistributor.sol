...
contract TykheFortuneDistributor is Initializable {
    string public constant TOO_MUCH_GREED =
        "too much greed, fees cannot be higher than 45% (maximum in pancake swap)";
    ...
    function calcBuySellTransferFee(
        ...
        if (this.isExcludedFromFee(from) || this.isExcludedFromFee(to)) {
            return 0;
        }
