...
contract Mestu is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    constructor() ERC20Detailed("Mestu", "MST", uint8(DECIMALS)) Ownable() {
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        pair = IDEXFactory(router.factory()).createPair(address(this), router.WETH());
        address pairBusd = IDEXFactory(router.factory()).createPair(address(this), busdToken);
        address _owner = 0x90b4B9bc41FbC5C9cFe22B67F50E3a3068625480;
