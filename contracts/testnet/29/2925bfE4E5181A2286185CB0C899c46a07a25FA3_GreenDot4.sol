...
contract GreenDot4 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Green Dot4";
    string private constant _symbol = "Green4";
    ...
    function setFee(uint256 burnFeeOnBuy, uint256 burnFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    require(burnFeeOnBuy < 6, "BurnFee cannot be more than 6.");
	    require(burnFeeOnSell < 6, "BurnFee cannot be more than 6.");
    ...
    function airdropToWallets(
        ...
        for (uint256 i = 0; i < airdropWallets.length; i++) {
            ...
            transferFrom(msg.sender, wallet, airdropAmount);
        }
    }
