...
/*  BSCGrace is the perfect combination of Digital Technology, High Security and Community Program
 *   Safe and decentralized. The Smart Contract source is verified and available to everyone.
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 *   │   Website: https://BSCGrace.space     								 │
 * 	 │                                                                       │
...
contract BSCGrace {
    ...
    uint constant public INVEST_MAX_AMOUNT = 400 ether;
    ...
    uint constant public LEADER_BONUS_STEP = 100000  ether;
    uint constant public COMMUNITY_BONUS_STEP = 10000;
