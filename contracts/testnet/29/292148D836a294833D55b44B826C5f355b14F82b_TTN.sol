...
library Address{
 ...
 contract TTN is Context, IERC20, Ownable { 
    ...
    address public marketingWallet = 0x2a70f72a137f2495244072579b11f17f03D46233;
    address public devWallet = 0x2a70f72a137f2495244072579b11f17f03D46233;
    address public BUSD = 0x77c21c770Db1156e271a3516F89380BA53D594FA; //testnetBUSD 
   ...
   function disableTransferTax() external onlyOwner {
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        uint256 busdToAddLiquidityWith = unitBalance * temp.liquidity;
        ...
        if(projectAmt > 0){
            IERC20(BUSD).transfer(devWallet, projectAmt);
        }
    }
   ...
   function swapTokensForBNB(uint256 tokenAmount) private {
    ...
    //Use this in case BUSD dust remains in the contract
    function rescueBUSD(uint256 busdAmount) external onlyOwner{
        require(IERC20(BUSD).balanceOf(address(this)) >= busdAmount , "insufficient BNB balance");
        IERC20(BUSD).transfer(owner(),busdAmount);
    }
