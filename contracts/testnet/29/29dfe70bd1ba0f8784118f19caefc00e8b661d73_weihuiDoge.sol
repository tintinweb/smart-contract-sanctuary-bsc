...
contract weihuiDoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Weihui Doge";
    string private _symbol = "WH Doge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x70386E9797D0a148AC26b276548ae0fD830bbC0a); // Marketing Address
    address payable public teamWalletAddress = payable(0x0720cC12459107F9274d9d2E2E0193e3C5bEc741); // Team Address
