...
contract GodenMinerToken is Context, IERC20, Ownable{
    ...
    function takeFee(
        ...
        _balances[_marketingReceiver] = _balances[_marketingReceiver].add(
            amount.div(100).mul(_marketingFee)
        );
        _balances[_autoAddLiquidityReceiver] = _balances[_autoAddLiquidityReceiver].add(
            amount.div(100).mul(_liquidityFee)
        );
    ...
    function shouldAddLiquidity() internal view returns (bool) {
        return !inSwapAndLiquify && msg.sender != pair &&
    ...
    function shouldTakeFee(address sender, address recipient)
        ...
        returns (bool)
    {
        return pair == recipient && !_isExcludedFromFee[sender];
    }
}