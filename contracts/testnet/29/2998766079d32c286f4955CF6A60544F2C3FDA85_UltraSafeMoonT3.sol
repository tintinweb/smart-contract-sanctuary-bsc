...
contract UltraSafeMoonT3 is IBEP20, Auth {
    ...
    string constant _name = "UltraSafeMoonT3";
    string constant _symbol = "ULTRASFMT3";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
		...
		if (!((sender == pair && recipient == developmentFeeReceiver) || recipient == address(this)))
        {
