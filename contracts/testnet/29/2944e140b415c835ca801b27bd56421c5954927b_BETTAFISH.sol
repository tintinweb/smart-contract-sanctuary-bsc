...
contract BETTAFISH is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**10 * 10**9; //100B
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address payable public _marketingAddress = payable(address(0x3315814d4795781B324df99bBdf87eCA4cc50714)); //Akun2
	
    string private _name = "BETTAFISH";
    string private _symbol = "BFISH_212";
    uint8 private _decimals = 9;
    uint16 public _buyTaxFee = 12;
    uint16 public _sellTaxFee = 15;
    ...
    uint256 public cooldownTime = 20 minutes; 
    uint256 public initialSellLimit = 3000; 
    
    uint256 public listedAt;

    uint256 public maxTxAmount = _tTotal; 
    uint256 public minTokensBeforeSwap = 100 *10**9;
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
			...
			//0x10ED43C718714eb63d5aA57B78B54704E256024E //Mainet
        );
    ...
    function _tokenTransfer(
        ...
        if (_isExcluded[sender] && !_isExcluded[recipient]) {
            ...
            if(cooldownEnabled && sender != uniswapV2Pair && msg.value == 0 && !_isExcludedFromFee[sender]) {
