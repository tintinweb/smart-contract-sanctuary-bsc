...
contract Escrow {
   ...
   // Struct typed data structure to represent each Escrow and its information inside
    ...
    function acceptProposal(uint256 _id) public {
        require(msg.sender == getEscrow[_id].buyer || msg.sender == getEscrow[_id].seller,"neither buyer or seller");
    ...
    function raiseDispute(uint256 id) public{
     ...
     function approveForWithdraw(uint256 id,bool withdrawParty) public onlyAdmin { //onlyOwner function
