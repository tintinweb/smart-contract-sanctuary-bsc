...
contract DA4Token is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    DA4TokenDividendTracker public dividendTracker;
    ...
    // buy fees
    uint256 public buyDividendRewardsFee = 15;
    ...
    uint256 public buyTotalFees = 22;
    // sell fees
    uint256 public sellDividendRewardsFee = 15;
    ...
    uint256 public sellTotalFees = 22;
    ...
    constructor() ERC20("DiamondsAre4ver", "DA4") {
        dividendTracker = new DA4TokenDividendTracker();

        teamWallet = 0x2873618b8011A75CEd0954e60Dd72E1B61FDe0F6;
        lotteryWallet = 0xd40Bbd7F6AC2AA9f4d0cEf35c3D507e7F38a551B;
        marketingWallet = 0x702dc95EC7cF53Be39195dBAbf351320DC5D3e6B;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "DA4: The dividend tracker already has that address"
        );

        DA4TokenDividendTracker newDividendTracker = DA4TokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "DA4: The new dividend tracker must be owned by the DA4 token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "DA4: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "DA4: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "DA4: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "DA4: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "DA4: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "DA4: Cannot update gasForProcessing to same value"
        );
...
contract DA4TokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("DA4_Dividend_Tracker", "DA4_Dividend_Tracker")
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 7500 * (10**9); //must hold 7500+ tokens
    }
    ...
    function _transfer(
        ...
        require(false, "DA4_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "DA4_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DA4 contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "DA4_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "DA4_Dividend_Tracker: Cannot update claimWait to same value"
        );
