...
contract PistonRace is OwnableUpgradeable {
    ...
    function initialize() external initializer {
        ...
        pistonToken = IToken(address(0xB85fe7C75c007c8708bDf21578b335deFAF879B0)); // PISTON Token MAINNET (currently testnet)
        tokenMint = ITokenMint(address(0xB85fe7C75c007c8708bDf21578b335deFAF879B0)); // PISTON Token MAINNET (currently testnet)

        updatePistonTokenPriceFeed(address(0xCc1969d5661e1e7e38a05F67858785bfEe9Aa6eA), true);
