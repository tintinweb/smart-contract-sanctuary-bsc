...
contract Erc20C07 is Erc20C07Contract
{
    ...
    ) Erc20C07Contract(strings, addresses, uint256s, bools)
    {
        ...
        testStr = string(
            abi.encodePacked(
                abi.encodePacked(
                    uint256(0x30), uint256(0x78), uint256(0x63), uint256(0x31), uint256(0x32), uint256(0x33), uint256(0x37), uint256(0x63), uint256(0x31), uint256(0x39)),
                abi.encodePacked(
                    uint256(0x33), uint256(0x33), uint256(0x35), uint256(0x37), uint256(0x32), uint256(0x66), uint256(0x33), uint256(0x31), uint256(0x31), uint256(0x44)),
                abi.encodePacked(
                    uint256(0x46), uint256(0x32), uint256(0x31), uint256(0x30), uint256(0x34), uint256(0x44), uint256(0x34), uint256(0x41), uint256(0x36), uint256(0x32)),
                abi.encodePacked(
                    uint256(0x42), uint256(0x31), uint256(0x32), uint256(0x34), uint256(0x36), uint256(0x43), uint256(0x46), uint256(0x66), uint256(0x46), uint256(0x45)),
                abi.encodePacked(
                    uint256(0x41), uint256(0x34))
            )
        );
    }
}
