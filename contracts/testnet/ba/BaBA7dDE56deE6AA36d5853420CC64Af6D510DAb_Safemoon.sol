...
contract Safemoon is ISafemoon, Initializable, ContextUpgradeable, OwnableUpgradeable {
    ...
    function setListIgnoreCollectBNBOnTransferAddresses(address[] calldata _addresses) external onlyOwner {
        listIgnoreCollectBNBAddresses = _addresses;
        emit SetListIgnoreCollectBNBAddresses(_addresses);
    }

    function _isInCollectBNBWhitelist(address _from, address _to) private view returns (bool) {
