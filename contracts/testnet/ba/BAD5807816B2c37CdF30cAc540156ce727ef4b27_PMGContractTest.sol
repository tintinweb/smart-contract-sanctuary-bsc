...
contract PMGContractTest is ReentrancyGuard{
    ...
    function delistNFT(uint256 _listItemId) external  {
        ...
        IERC721(listItem[_listItemId].nftContract).safeTransferFrom(address(this),msg.sender,listItem[_listItemId].tokenId);
    ...
    */
    ...
    function claimAuctionNFT(uint256 _auctionItemId) external  {
        ...
        IERC721(auctionitem.nftContract).safeTransferFrom(address(this),auctionitem.highestBidder,auctionitem.tokenId);
    ...
    function auctionFail(uint256 _auctionItemId,uint256 _action,uint256 _price,uint256 _min_bid,uint256 _day ,address _tokenContract) external {
        ...
        if(_action == 0){
            IERC721(auctionitem.nftContract).safeTransferFrom(address(this),msg.sender,auctionitem.tokenId);
