...
contract Orca is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xbb0A6F1Da80f55B54759D8604589af9dF3B5403F); 
    address payable public Wallet_Dev = payable(0xbb0A6F1Da80f55B54759D8604589af9dF3B5403F);
    ...
    string private constant _name = "Orca Inu"; 
    string private constant _symbol = unicode"OrcaInu"; 
    ...
    constructor () {
        ...
        _owner = 0xbb0A6F1Da80f55B54759D8604589af9dF3B5403F;
