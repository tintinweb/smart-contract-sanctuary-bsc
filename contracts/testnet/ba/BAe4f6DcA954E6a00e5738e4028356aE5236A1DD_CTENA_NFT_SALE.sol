...
contract CTENA_NFT_SALE is Ownable {
    ...
    function buyImage(address  _owner, address payable _creator, uint256 _tokenId, uint256 _price) public payable {
    ...
    function bid(address payable  _owner, address payable _creator, uint256 _price, uint256 _tokenId) public payable {
...
contract CTENA_NFT is IERC721Metadata, ERC721Full, Ownable{
  ...
  constructor() ERC721("CTENA NFT", "CTENA_NFT")  {
  ...
  function setAuthorized(address _address) onlyOwner public {
  ...
  function mint(string memory _name, string memory _description, string memory _url, uint256 _price, uint _clones) public onlyAuthorized(address(msg.sender))  {
