...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("BUSD_Dividen_Tracker", "BUSD_Dividen_Tracker") {
    	claimWait = 3600;
    ...
    function withdrawDividend() pure public override {
        require(false, "BUSD_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main  contract.");
    }
...
contract testDigitalatto is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxTransactionAmount = 100000000000 * (10**9);
    uint256 public swapTokensAtAmount = 40000000 * (10**9);
    uint256 private buyBackUpperLimit = 1 * 10**16; // equal to 0.01 bnb
    ...
    constructor() ERC20("testDigitalatto", "tDGTL") {
    	dividendTracker = new DividendTracker();

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);//0x10ED43C718714eb63d5aA57B78B54704E256024E); // pancakeswap router address
    ...
    function swapAndLiquify(uint256 tokens) private {
       ...
       // split the contract balance into two equal parts
