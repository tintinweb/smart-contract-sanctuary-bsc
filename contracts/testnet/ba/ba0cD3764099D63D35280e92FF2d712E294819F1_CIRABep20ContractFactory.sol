...
contract SAFUCFGTax is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress =
        payable(_NewMarketingWallet); // Marketing Wallet Address
    address payable public teamWalletAddress =
        payable(_NewTeamWallet); // Team Wallet Address
...
uint256 private _NewMarketingFee;
uint256 private _NewTeamFee;
address private _NewMarketingWallet;
address private _NewTeamWallet;
...
//end of constructor variables
    ...
    uint256 public _marketingFee = _NewMarketingFee;
    uint256 private _previousMarketingFee = _marketingFee;

    uint256 public _teamFee = _NewTeamFee;
    ...
    constructor(uint256 _NewTotalSupply1, address _NewMarketingWallet1, address _NewTeamWallet1, string memory _NewName1, string memory _NewSymbol1, uint8 _NewDecimals1, uint256 _NewLiquidityFee1, uint256 _NewMarketingFee1, uint256 _NewTeamFee1 ) {
 _NewTotalSupply = _NewTotalSupply1;
 _NewMarketingWallet = _NewMarketingWallet1; 
 _NewTeamWallet = _NewTeamWallet1;
 _NewName = _NewName1 ;
 _NewSymbol = _NewSymbol1;
 _NewDecimals = _NewDecimals1;

_NewLiquidityFee = _NewLiquidityFee1;
 _NewMarketingFee = _NewMarketingFee1;

_NewTeamFee = _NewTeamFee1;
