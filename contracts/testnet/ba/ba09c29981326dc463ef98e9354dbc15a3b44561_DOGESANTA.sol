...
contract DOGESANTA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xd64f29A71F01f2E287f91266Ce1757ccCc1A3B7A); 
    address payable public Wallet_Dev = payable(0x76eEF8049eE7B7F6bb2A4D79799c75bc1042aFf9);
    ...
    string private constant _symbol = unicode"$DOSA"; 
