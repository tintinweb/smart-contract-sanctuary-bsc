...
// File: contracts/interfaces/I3SwapRouter1.sol
...
// File: contracts/C3SwapRouter1.sol
...
contract C3SwapRouter1 is I3SwapRouter1 {
    ...
    )
  {
    ...
    if (reserveA == 0 && reserveB == 0 && reserveC == 0)
      ...
      uint amountCOptimal = L3SwapLibrary.quote(
        amountsDesired.amountA,
        amountsDesired.amountB,
        reserveA,
        reserveB,
        reserveC
      );
      uint amountBOptimal = L3SwapLibrary.quote(
        amountsDesired.amountA,
        amountsDesired.amountC,
        reserveA,
        reserveB,
        reserveC
      );
      if (amountCOptimal <= amountsDesired.amountC) {
        ...
        uint amountAOptimal = L3SwapLibrary.quote(
          amountsDesired.amountB,
          amountsDesired.amountC,
          reserveA,
          reserveB,
