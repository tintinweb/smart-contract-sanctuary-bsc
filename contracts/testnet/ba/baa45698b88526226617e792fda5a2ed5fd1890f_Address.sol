...
contract Qmark is IBEP20, Ownable
{
    ...
    uint256 public constant InitialSupply= 999 * 10**_decimals;

    //Amount to Swap variable
    uint256 currentAmountToSwap = 50 * 10**_decimals;
    ...
    //DevWallets
    address public TeamWallet=payable(0x887C6c6f12127Fa9763D4aF20A2E0E11eE64E300);
    address public walletTwo=payable(0x887C6c6f12127Fa9763D4aF20A2E0E11eE64E300);
    //TestNet
	...
	uint256 private antiWhale = 10 * 10**_decimals;
