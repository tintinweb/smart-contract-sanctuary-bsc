...
contract Unicorn is Ownable {

    using SafeMath for uint256;

    uint256 public decimals = 18;   //How many decimals to show.
    uint256 private totalSupply_ = 4200000000*10**5 * 10**18;  // 4.20 billion tokens, 18 decimal places
    string constant public name =  "Unicorn Token"; //fancy name: eg Unicorn Token
    string constant public symbol = "Unicorn"; //An identifier: eg Unicorn
    ...
    function transferFrom(address _spenderOwner, address _recipient, uint256 _amount) external  returns (bool) { 
        require(_amount > 0, "Transfer amount must be greater than zero");  // Don't allow 0Amount transfer 
