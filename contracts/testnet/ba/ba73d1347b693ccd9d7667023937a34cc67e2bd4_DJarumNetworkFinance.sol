...
// 
//  _______      _____   ______   _______   __    __  __       __        ________  ______   __    __  ________  __    __ 
// /       \    /     | /      \ /       \ /  |  /  |/  \     /  |      /        |/      \ /  |  /  |/        |/  \  /  |
// $$$$$$$  |   $$$$$ |/$$$$$$  |$$$$$$$  |$$ |  $$ |$$  \   /$$ |      $$$$$$$$//$$$$$$  |$$ | /$$/ $$$$$$$$/ $$  \ $$ |
// $$ |  $$ |      $$ |$$ |__$$ |$$ |__$$ |$$ |  $$ |$$$  \ /$$$ |         $$ |  $$ |  $$ |$$ |/$$/  $$ |__    $$$  \$$ |
// $$ |  $$ | __   $$ |$$    $$ |$$    $$< $$ |  $$ |$$$$  /$$$$ |         $$ |  $$ |  $$ |$$  $$<   $$    |   $$$$  $$ |
...
// $$$$$$$/   $$$$$$/  $$/   $$/ $$/   $$/  $$$$$$/  $$/      $$/          $$/    $$$$$$/  $$/   $$/ $$$$$$$$/ $$/   $$/ 
// 
// Create By Mr. Mbah Don - CopyRight 2021 - V1.001
// 
interface IERC20 {
...
contract DJarumNetworkFinance is Context, IERC20, Ownable, Versionable {
    using SafeMath for uint256;
    ...
    // 2,000,000,000,000,000 (000,000,000,000)
   	uint256 private _tTotal = 2 * 10**9 * 10**6 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DJarum Network Finance";
    string private _symbol = "DJarum";
    ...
    function setNumTokenSell(uint256 amount) public onlyOwner {
        numTokensSellToAddToLiquidity = amount * 10**10;
    }
    ...
    function _transfer(address from, address to, uint256 amount, bool noEvent) private {
        ...
        if(from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router)) {
                require(amount <= balanceOf(uniswapV2Pair).mul(pImpB).div(100),"Price impact too high.");
            } else if (to == uniswapV2Pair) {
                require(amount <= balanceOf(uniswapV2Pair).mul(pImpS).div(100),"Price impact too high.");
            }
