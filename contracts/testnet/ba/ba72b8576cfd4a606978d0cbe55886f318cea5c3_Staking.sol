...
contract Staking is Ownable {
    ...
    function sortAmount(uint256 _amount) internal pure returns (AmountPlane) {
        if (_amount < 1_000 * 1e18) {
            return AmountPlane.Small;
        } else if (_amount < 10_000 * 1e18) {
            return AmountPlane.Medium1;
        } else if (_amount < 100_000 * 1e18) {
            return AmountPlane.Medium2;
        }
    ...
    function checkSmallRate(AmountPlane plane) internal pure returns (uint256) {
        if (plane == AmountPlane.Small) {
            return 2;
        } else if (plane == AmountPlane.Medium1) {
            return 2;
        } else if (plane == AmountPlane.Medium2) {
            return 2;
        }
        return 2;
    }

    function checkMedium1Rate(AmountPlane plane)
        internal
        pure
        returns (uint256)
    {
    ...
    function checkMedium2Rate(AmountPlane plane)
        internal
        pure
        returns (uint256)
    {
        ...
        returns (uint256)
    {
        if (day == 90) {
            ...
            return checkMedium1Rate(plane);
        } else if (day == 360) {
            return checkMedium2Rate(plane);
        }
