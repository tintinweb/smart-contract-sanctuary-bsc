...
contract VoteScatter is
    ...
    ERC1155 immutable  membershipNFT;
...
/// @dev Returns the module type of the contract.
    ...
    function contractVersion() public pure override returns (uint8) {
     ...
     modifier nftHolderOnly {
        require(membershipNFT.balanceOf(msg.sender, tokenId) > 0, "You need to own an ERC1155 token before you perform x ");
        _;
    }
    ...
    function propose(
        ...
        bytes[] memory calldatas,
        string memory description
    ) public virtual nftHolderOnly override  returns (uint256 proposalId) {
...
import "./VoteScatter.sol";


contract Votefinal is VoteScatter {
    ...
    constructor(uint256 _tokenId,   
        ...
        uint256 _initialProposalThreshold,
        address _token,
        uint256 _initialVoteQuorumFraction) VoteScatter(
         _tokenId, 
         _serumAddress, 
        //  _contractURI, 
         _trustedForwarders, 
