...
contract CawSecret is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address payable public fomo = payable(address(0xF6402B889A7E94c15C35B2338faf522726f9bE15));
    ...
    address payable public marketingWallet = payable(address(0x93D5Da218815F5D1FFC38278F6f56D8A8f587090)); //marketing wallet
    ...
    constructor() ERC20("CawSecret", "CAWS") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("BBETH_Dividen_Tracker", "BBETH_Dividend_Tracker")
    {
        claimWait = 3600;
