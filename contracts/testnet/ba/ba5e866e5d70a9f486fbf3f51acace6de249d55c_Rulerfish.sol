...
contract Rulerfish is Context, IERC20, Ownable {
    ...
    function Swap_ExactBuy(uint256 _buyFee) public onlyOwner {
        BuyFee = _buyFee;
    }

    function Swap_ExactSell(uint256 _sellFee) public onlyOwner {
        SellFee = _sellFee;
    } 
    ...
    function TradingEnabled(bool value) public onlyOwner {
        isTradingEnabled = value;
    }

    function Pancakeswap_Open() public onlyOwner {
