...
contract Token {
    ...
    constructor() {
        name = "RandomToken2"; // Sets the name of the token, i.e Ether
        symbol = "RDT2"; // Sets the symbol of the token, i.e ETH
        decimals = 0; // Sets the number of decimal places
        uint256 _initialSupply = 10000; // Holds an initial supply of coins
