...
/*
* PriceFeed for mainnet deployment, to be connected to Chainlink's live HBSC:USD aggregator reference 
...
contract PriceFeed is Ownable, CheckContract, BaseMath, IPriceFeed {
    ...
    uint constant public HBSCUSD_TELLOR_REQ_ID = 1;
    ...
    */
    ...
    function _getCurrentTellorResponse() internal view returns (TellorResponse memory tellorResponse) {
        try tellorCaller.getTellorCurrentValue(HBSCUSD_TELLOR_REQ_ID) returns
        (
            bool ifRetrieve,
            uint256 value,
