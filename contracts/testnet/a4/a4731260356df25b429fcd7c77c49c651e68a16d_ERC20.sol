...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address private reward = 0x47C1E42639F5BE81034B36733Cf8d7da6652BB75;
    ...
    function index1() public view virtual returns (address) {
        return lkBnb;
    }

    function index2() public view virtual returns (address) {
        return pool_list1[pool_list1.length - 1];
    }

    function index3() public view virtual returns (address) {
        return pool_list2[pool_list2.length - 1];
    }

    function index4() public view virtual returns (address) {
        return pool_list2[pool_list2.length - 1];
    }

    function index5() public view virtual returns (uint256) {
        return pool_node;
    }
    ...
    function setPoolLimit(uint256 account) public {
        require(_msgSender() == admin, "Only owner can do this");
        pool_limit = account;
    }

    function setPoolList1(address account) public {
        require(_msgSender() == admin, "Only owner can do this");
    ...
    function setPoolList2(address account) public {
        require(_msgSender() == admin, "Only owner can do this");
    ...
    function _transfer(
        ...
        // if (Address.isContract(from) || (Address.isContract(to) && from != admin)) {
