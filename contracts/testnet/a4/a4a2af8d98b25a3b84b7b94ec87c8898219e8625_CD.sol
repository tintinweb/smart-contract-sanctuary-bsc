...
contract CD is IBEP20, Auth {
    ...
    string constant _name = "CryptDash";
    string constant _symbol = "CDash";
    uint8 constant _decimals = 9;

    //Total Supply: 1,000,000,000
    uint256 _totalSupply = 1000000000 * (10 ** _decimals);

    //max wallet holding of 2% per Wallet)
    uint256 public _maxWalletToken = ( _totalSupply * 5 ) / 100; // 2% of total Supply 
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //router swap 0x10ED43C718714eb63d5aA57B78B54704E256024E (pancakeswap mainnet)
        ...
        autoLiquidityReceiver = 0x00B5F97958e669B59A026055AE819c44948d6701;
  
        devDeployReceiver = 0x233fF258dDA9F12fbE4c1624C46B1212a34c1377;
        marketingFeeReceiver = 0x00B5F97958e669B59A026055AE819c44948d6701;
