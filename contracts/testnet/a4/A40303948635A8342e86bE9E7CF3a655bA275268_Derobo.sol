...
contract Derobo is BEP20Token {
    ...
    // Users who can get DEROBO in exchange for a ROBO token.
    ...
    /**
     * @dev Adds addresses that are allowed to swap a ROBO token.
    ...
    /**
     * @dev Removes addresses that are allowed to swap a ROBO token.
     * @param _addresses An array of addresses.
     */
    ...
    /**
     * @dev Mints new token as an exchange of ERC20 ROBO token on Ethereum for BEP20 DEROBO token on BSC.
    ...
    function swap(address _account, uint256 _amount) external {
        ...
        require(whiteList[_account], "User is not in the whiteList.");
     ...
     */
    function getPercent(uint256 _value, uint256 _percent) internal pure returns(uint256) {
