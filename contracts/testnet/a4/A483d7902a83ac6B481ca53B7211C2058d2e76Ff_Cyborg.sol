...
contract Cyborg is ERC721Enumerable, Ownable, PullPayment {
    using Strings for uint256;
    ...
    //Price
    uint256 public publicCost = 300 ether;
    uint256 public EbisusbayMemberPrice = 250 ether;
    uint256 public whiteListCost = 200 ether;
    ...
    address public memberShipAddress = 0x8d9232Ebc4f06B7b8005CCff0ca401675ceb25F5;
