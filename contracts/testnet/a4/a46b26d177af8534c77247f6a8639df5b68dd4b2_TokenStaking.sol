...
/**
  @title BX Farming contract which helps to Deposit & Reward tokens
  @author BlockchainX
...
contract TokenStaking is
    ...
    UUPSUpgradeable
{
    string public constant name = "BX - Farming";
    ...
    mapping(IERC20Upgradeable => mapping(IERC20Upgradeable => bool))
        public hasLPPair;
    ...
    */
    function getUserDepositedTokensInPool(uint256 _pid, address account)
        external
        view
        returns (uint256)
    {
        return userInfo[_pid][account].amount;
    }
    ...
    */
    function _beforeAddPool(
        ...
        require(
            !hasLPPair[_lpToken][_rewardToken],
    ...
    */
        ...
        returns (uint256, uint256)
    {
        ...
        if (balances > 0) {
            ...
            rewards = ((user.amount * poolInfo[_pid].rewardRate * timeFactor) /
                (1 * 10**4));
        }
