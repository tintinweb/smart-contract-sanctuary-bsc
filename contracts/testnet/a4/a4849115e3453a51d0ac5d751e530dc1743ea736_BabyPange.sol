...
contract BabyPange is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Atlas V2";
    string private _symbol = "ATL2";
    uint8 private _decimals = 18;

    address payable public treasuryWallet = payable(0x8C200576f10bf39EAB6EA5F0f44aFe44B137c8e0);
