...
contract SmartBeComBee {
    ...
    function updB6Referrer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (users[referrerAddress].b6Matrix[level].firstLevelReferrals.length < 2) {
            ...
            users[referrerAddress].b6Matrix[level].toLevelReferrals.push(100+usertype*10+uint8(users[referrerAddress].b6Matrix[level].firstLevelReferrals.length));
    ...
    function updB6(address userAddress, address referrerAddress, uint8 level, bool x2) private {
        if (!x2) {
            ...
            users[users[referrerAddress].b6Matrix[level].firstLevelReferrals[0]].b6Matrix[level].toLevelReferrals.push(120+ uint8(users[users[referrerAddress].b6Matrix[level].firstLevelReferrals[0]].b6Matrix[level].firstLevelReferrals.length));
            users[referrerAddress].b6Matrix[level].toLevelReferrals.push(220+ 2 + uint8(users[users[referrerAddress].b6Matrix[level].firstLevelReferrals[0]].b6Matrix[level].firstLevelReferrals.length));
            ...
            users[referrerAddress].b6Matrix[level].toLevelReferrals.push(120+ uint8(users[users[referrerAddress].b6Matrix[level].firstLevelReferrals[1]].b6Matrix[level].firstLevelReferrals.length));
            users[referrerAddress].b6Matrix[level].toLevelReferrals.push(220+ 4 + uint8(users[users[referrerAddress].b6Matrix[level].firstLevelReferrals[1]].b6Matrix[level].firstLevelReferrals.length));
