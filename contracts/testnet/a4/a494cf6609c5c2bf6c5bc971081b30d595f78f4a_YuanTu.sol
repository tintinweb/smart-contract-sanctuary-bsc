...
contract YuanTu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = unicode"元兔";
    string private _symbol = unicode"Meta Rabbit";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x66dD251F206515fD5e1431Cd1e1BBA70fBF85bf6);
