...
contract LaunchpadFactory is ILaunchpadFactory, ReentrancyGuard, Context{
    ...
    */
    function getAcceptedRouter() public override view returns(MyStandardStruct[] memory) 
    {
    ...
    */
    function addAcceptedRouter(address contractAddress) onlyOwner public override
    {
     ...
     * must be existing contract address to be successfully remove
    */
    function removeAcceptedRouter(address contractAddress) onlyOwner public override
    {
    ...
    */
    function createLaunchpad(
        ...
        bool whitelist
    ) nonReentrant() public override payable returns (address)
    {
        ...
        emit LaunchpadCreated(clone, _msgSender(), block.timestamp);
