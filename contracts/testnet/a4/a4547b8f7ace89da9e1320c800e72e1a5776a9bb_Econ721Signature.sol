...
contract Econ721Signature is EconBaseContract, Econ721Enumerable, ERC721HolderUpgradeable {
    ...
    function withdraw(
        ...
        require(!_handled[ethSignedMessageHash]);
        ...
        _handled[ethSignedMessageHash] = true;
        ...
        try IERC721(_contractAddress).safeTransferFrom(address(this), _msgSender(), _tokenId) {
            ...
            emit Withdrawn(ethSignedMessageHash, _msgSender(), _contractAddress, _tokenId);
        } catch {
            emit WithdrawFailed(ethSignedMessageHash, _msgSender(), _contractAddress, _tokenId);
        }
    }
