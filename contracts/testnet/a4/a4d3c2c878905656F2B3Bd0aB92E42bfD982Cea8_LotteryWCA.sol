...
contract LotteryWCA is ReentrancyGuard {
    ...
    uint8 public constant marketingPercents = 4;	
    uint8 public referralRewardPercents = 10;	
    uint8 public referralRewardProfitPercents = 15;	
