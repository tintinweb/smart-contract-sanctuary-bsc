...
contract KINGKBA is Context, IERC20, Ownable {
    ...
    uint8   public BuyOrSell = 2;
     address payable public _markWallet = payable(0xFDE9De9dF81eE4853d2fE0a4Cd4E5d17c6D756e3);
     address payable public _Wallet = payable(0x4eb195eE5C338Ec4A306cDEAbE2FC7A5899BCd59);
