  ...
  ReentrancyGuardUpgradeable
{
  ...
  bytes32 public constant ADMIN_DATA = keccak256("ADMIN_DATA");
  ...
  function changeData(uint256 index, string memory carType, string memory carModel ) public onlyRole(ADMIN_DATA){
    _nft[index].carType = carType;
    _nft[index].carModel = carModel;
  }
