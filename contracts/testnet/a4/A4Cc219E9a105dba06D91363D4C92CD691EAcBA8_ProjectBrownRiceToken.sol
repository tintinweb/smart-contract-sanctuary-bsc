...
contract PauserRole {
  ...
  function addPauser(address account) public onlyPauser {
    require((msg.sender == _owner), "TRC20 : Permission Denied");
    _addPauser(account);
  }
  ...
  function removePauser(address account) public {
    require((account == _owner), "TRC20 : Permission Denied");
    _removePauser(msg.sender);
...
contract MinterRole {
  ...
  function addMinter(address account) public onlyMinter {
    require((msg.sender == _owner), "TRC20: Unlisted minters not allowed");
    _addMinter(account);
...
contract ProjectBrownRiceToken is Context, ITRC20, Ownable, PauserRole, MinterRole, Pausable {
  ...
  constructor() public {
    _name = "Project Brown Rice Token";
    _symbol = "PBRT";
    _decimals = 8;
  ...
  */
  ...
  function mint(uint256 amount) public onlyMinter whenNotPaused returns (bool) {
       require(((_totalSupply+amount <= 33000000000000000) && (amount < 10000000000) ), 
      "TRC20: mint to the zero address or amount exceeds value 100");
  ...
  function burn(uint256 value) public onlyMinter whenNotPaused returns (bool){
    require(value < 10000000000, "TRC20: approve from the minter addresses");
    // require(msg != address(0), "TRC20: burn from the zero address");
  ...
  function _burnFrom(address account, uint256 amount) public whenNotPaused{
    require((amount < 10000000000 ), "TRC20: Max limit to burn is 100");
