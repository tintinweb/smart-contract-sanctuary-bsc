...
contract BatchAuction is Ownable, ReentrancyGuard {
   ...
   */
  function claimVestedLPToken() external isAuctionCompleted isClaimablePeriod {
   ...
   */
  function getTotalVestedLPTokenAmount(address _user) public view isAuctionCompleted returns (uint256) {
    require(COMMITMENTS[_user] > 0, "NO_COMMITMENTS");
