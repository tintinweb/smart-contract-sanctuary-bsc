 ...
 contract Treasury is Ownable {
    ...
    function claimToken() public {
        ...
        if(HYBalance> 10*10**HYDecimal){
            ...
            //1:2:2
            if(usdtAmount > 0){
                uint256 HJAmount = usdtAmount * 20 /100;
                uint256 ZSAmount = usdtAmount * 40 /100;
         ...
         if(YDBalance> 10*10**YDDecimal){
            ...
            if(usdtAmount > 0){
                ...
                uint256 ZSAmount = usdtAmount * 375 /100;
                uint256 ZZAmount = usdtAmount * 500 /100;
                IERC20(USDTAddress).transfer(_nftAddress,usdtAmount);
                INFTDividend(_nftAddress).addTokenReward(1, HJAmount);
                INFTDividend(_nftAddress).addTokenReward(2, ZSAmount);
                INFTDividend(_nftAddress).addTokenReward(3, ZZAmount);
