...
contract YOU is Context, IERC20, IERC20Metadata, Ownable 
{
    ...
    address public treasuryAddress = 0x75cB561E6ea1e81bb45337aaB8d310b4616cb2A5;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual 
    {
        ...
        if(takeFee)
        {
            uint256 feeTokens = amount.mul(_treasuryFee).div(100);
            _transferTokens(sender, treasuryAddress, feeTokens);
    ...
    function setAllFees(uint256 treasuryFee) external onlyOwner
    {
        _treasuryFee = treasuryFee;
        require(_treasuryFee<=10, "Too High Sell Fee");
    }
