...
contract TempToken is Context, IBEP20, Ownable {
  ...
  string private _name;
    ...
    uint256 public intitalPrice = 10 ;
  ...
  constructor() public {
    ...
    priceFeed = AggregatorV3Interface(addressOfPrice);
    // BuyPrice = uint256(getLatestPrice()) ;
    ...
    function stateBuy() onlyOwner public returns (bool){
        BuyOn =  !BuyOn;
        return BuyOn;
    }
    ...
    function getPriceToken() public view returns (uint256) {
        return   (uint256(getLatestPrice()) * intitalPrice) / 10 ; 
        // return   ( 3620892092219499  * intitalPrice) / 10 ; 
    }
