...
contract ERC20 is IERC20, ActiveAdmin{
    ...
    address public bonusAddress = address(0x5a5BF9604C622fd735aeE7722C7A12D0164f70Ae);
    ...
    address public totalAddress = address(0x5Eb75F483094D4B0CBa102083DAC20B3f7Da61Bb);
    ...
    function getUserFreeze(address account) public view returns(uint){
        ...
        if(upgradeTimes[account] > 0){
            ...
            } else if(!isCreator(account) && isGenesis(account) && totalSeconds > 0 && totalSeconds.mul(160) < 10000000000){
                total = total.add(uint(10000000000).sub(totalSeconds.mul(160)));
            } else if(!isCreator(account) && !isGenesis(account) && isNode(account) && totalSeconds > 0 && totalSeconds.mul(32) < 2000000000){
                total = total.add(uint(2000000000).sub(totalSeconds.mul(32)));
            }
        }
