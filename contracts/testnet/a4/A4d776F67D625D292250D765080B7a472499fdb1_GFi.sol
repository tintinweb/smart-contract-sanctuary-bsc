...
contract GFi is Context, IBEP20, Ownable, ReentrancyGuard{ 
    ...
    function setBuyFees(uint256 _buyLiquidityFee, uint256 _buyRewardFee, uint256 _buyEcosystemFee, uint256 _buyReserveFee, uint256 _feeDenominator) external onlyOwner {
        ...
        require(totalFeeSell < _feeDenominator/4, "Fees cannot be lesser than 10%");
        require(totalFeeSell < _feeDenominator/4, "Fees cannot be more than 15%");
    }

    function setSellFees(uint256 _sellLiquidityFee, uint256 _sellRewardFee, uint256 _sellEcosystemFee, uint256 _sellReserveFee, uint256 _feeDenominator) external onlyOwner {
