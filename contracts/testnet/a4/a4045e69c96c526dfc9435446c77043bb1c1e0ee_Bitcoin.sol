...
contract Bitcoin is IBEP20, Ownable {
    ...
    address public marketingFeeReceiver =
        0x2ecD4D0451cbcC727818d84C8bdACD1671706dc8;
    ...
    function setMaxBuyTxPercent_base1000(uint256 maxBuyTXPercentage_base1000)
        external
        onlyOwner
    {
        _maxBuyTxAmount =
            (_totalSupply / (1000)) *
            (maxBuyTXPercentage_base1000);
    }

    function setMaxSellTxPercent_base1000(uint256 maxSellTXPercentage_base1000)
        external
        onlyOwner
    {
        _maxSellTxAmount =
            (_totalSupply / (1000)) *
            (maxSellTXPercentage_base1000);
    }
