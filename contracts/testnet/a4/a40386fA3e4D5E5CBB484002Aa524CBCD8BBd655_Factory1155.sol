...
import "./MintyardUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new MintyardUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        MintyardUser1155Token token = MintyardUser1155Token(address(addr));
...
contract MintyardUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
