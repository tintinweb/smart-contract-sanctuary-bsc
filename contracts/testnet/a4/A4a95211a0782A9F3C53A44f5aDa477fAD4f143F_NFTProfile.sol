...
contract NFTProfile is Initializable, ERC721URIStorageUpgradeable, OwnableUpgradeable {
    ...
    function lastTokenOf(address user) public returns (uint256) {
        return lastTokens[user];
    }

    function _beforeTokenTransfer(address from, address to, uint256 tokenId) internal override onlyOwner() {
