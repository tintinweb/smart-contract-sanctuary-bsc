...
contract TKNStake {
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address BUSD_WBNB = 0x19c174123f520Fe17069D7E8f8E1513E6Dd2e2F8; //BUSD_WBNB pancake testnet pool address
        ...
        address TKN_WBNB = 0xF98151805FAa46551ce2d7B6095F949AF18bF299; // TKN_WBNB pancake pool address
        IERC20 TKNTOKEN = IERC20(0x43B3629bb8E1d889Ebc9299e0E2406491b0152d4); // TKN Token address 
