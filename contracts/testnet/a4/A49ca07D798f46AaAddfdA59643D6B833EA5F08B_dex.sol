...
contract dex {
    ...
    event ClaimWithDraw(address indexed address_, uint256 amount_);
    ...
    function claimWithdraw(address spender_, uint256 amount_) public isOwner {
        require(amount_ > 0, "Amount is  grater than 0");
        uint256 totalAmount = _token.balanceOf(address(this));
        require(
            amount_ < totalAmount,
        ...
        emit ClaimWithDraw(spender_, amount_);
    }
