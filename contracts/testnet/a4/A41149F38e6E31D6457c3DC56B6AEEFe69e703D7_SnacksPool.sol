...
contract SnacksPool is MultipleRewardPool {
    ...
    */
        ...
        updateRewardPerToken(rewardToken_, address(0))
    {
        ...
        uint256 leftover = balance - reward_;
        rewardRates[rewardToken_] = (reward_ + leftover) / rewardsDuration;
        if (rewardRates[rewardToken_] > balance / rewardsDuration) {
    ...
    */
    ...
    function deactivateLunchBox() public whenNotPaused {
        require(
        ...
        for (uint256 i = 0; i < _rewardTokens.length(); i++) {
            ...
            if (reward > 0) {
                ...
                if (rewardToken == snacks) {
                    ...
                    btcSnacksReward = reward;
                } else if (rewardToken == ethSnacks) {
                    ethSnacksReward = reward;
                } else {
