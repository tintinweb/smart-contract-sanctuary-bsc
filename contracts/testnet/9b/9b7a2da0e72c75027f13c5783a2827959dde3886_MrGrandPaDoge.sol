 ...
 *  https://grandpa-doge.com/
 *  https://t.me/stealyourgrandmadoge
 * https://twitter.com/mrgrandpadoge
 */
...
abstract contract MrGrandPaDogeAuth {
...
contract DividendDoge_El is IDividendDoge_El {
    ...
    uint256 public minPeriod = 60 minutes; // min 30 minutes delay
    uint256 public minDistribution = 60 / 1000000 * (10 ** 18); // 1 USD of BTCB minimum auto send
...
contract MrGrandPaDoge is IBEP20, MrGrandPaDogeAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "MrGrandPaDoge";
    string constant _symbol = "MRBTC";
    ...
    constructor () MrGrandPaDogeAuth(msg.sender) {
