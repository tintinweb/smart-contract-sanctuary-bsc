...
contract BTSSwapRouter {
    ...
    function Snipe(address routerAddress, address baseToken, address snipeToken, uint buyAmount, uint txRevertTime, uint testSwapAmount, uint testSwapFailThreshold) public payable {
