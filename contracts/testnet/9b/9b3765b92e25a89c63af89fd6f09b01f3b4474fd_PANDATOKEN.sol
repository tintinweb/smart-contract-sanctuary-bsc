...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant ETH = address(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2); //ETH
...
contract PANDATOKEN is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1000 * (10**9); //0.01% of the supply
    ...
    address public _devWallet = payable(address(0xB899dd2822b2fc60403ad8fFb34914d710823f3B)); // developmentWallet
    address public _marketingWallet = payable(address(0xB899dd2822b2fc60403ad8fFb34914d710823f3B)); //marketingWallet
...
//        _mint(owner(), 1 * 10**14 * (10**9)); // 100 Trillion Tokens
   ...
   function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
    ...
    function swapAndSendToWallets(uint256 tokens) private lockTheSwap {
        ...
        IERC20(ETH).transfer(_marketingWallet, marketingShare);
        IERC20(ETH).transfer(_devWallet, devShare);
}
