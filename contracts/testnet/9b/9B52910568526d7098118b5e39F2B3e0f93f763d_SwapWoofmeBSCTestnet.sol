...
contract SwapWoofmeBSCTestnet is SwapWoofmeBase {
    ...
    function Woofme() public pure override returns (address) {
        return 0xF8Ab80B42Dcd1cD8918f0957Dd7063ACbe607187;
    }

    function UNISWAP_V2_ROUTER() internal pure override returns (IUniswapV2Router02) {
        return IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    }

    function UNISWAP_FACTORY() internal pure override returns (IUniswapV2Factory) {
        return IUniswapV2Factory(0x6725F303b657a9451d8BA641348b6761A6CC7a17);
    }
}