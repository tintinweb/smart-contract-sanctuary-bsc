    ...
    Ownable 
{
    ...
    bool public disableFunctionality = false;
    ...
    */
    ...
    modifier dividendsCheck(address _sender, address _recipient, uint256 _amount) {
        if (disableFunctionality == true) {
            // do nothing
        } else if(_sender == address(rewardsWallet) || _msgSender() == address(lotteryPool)) {
            // do nothing
    ...
    */
    modifier randNumCheck {
        if (disableFunctionality == true) {
            // do nothing
        } else if (lotteryPool.getRandValues(11) > 0 && _msgSender() != address(lotteryPool)) {
    ...
    */
    ...
    function _disableFunctionality(bool _state) external onlyOwner {
        disableFunctionality = _state;
    }
    ...
    function _transfer(
        ...
        address recipient,
        uint256 amount
    ) internal dividendsCheck(sender, recipient, amount) randNumCheck {
