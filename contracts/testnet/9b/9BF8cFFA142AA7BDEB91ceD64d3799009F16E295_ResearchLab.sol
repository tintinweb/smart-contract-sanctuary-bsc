...
contract ResearchLab is OwnableUpgradeable, ReentrancyGuard {
    ...
    function getUserInfo(uint256 _pid, address _address) public view returns (IERC20 lpToken,uint256 amount,uint256 bridgedAmount,uint256 depositTime,uint256 depositBlock,
        ...
        return (user.lpToken,user.amount,user.bridgedAmount,user.depositTime,user.depositBlock,
    ...
    function safeLockedTransfer(address _to, uint256 _pid, uint256 _amount) external {
        ...
        if (_amount <= user.lockedAmount) {
          ...
          transferSuccess = ecto.transfer(_to, user.lockedAmount);
          user.lockedAmount = 0;
          user.vestedAmount = 0;
        }
