...
contract XIAOLIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "XIAOLIN";
    string private _symbol = "XIAOLIN";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 5;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x76EBc8A85153a40F7F7AAFF7D70c2635C4C8D9a5);
    address payable public teamWalletAddress = payable(0x76EBc8A85153a40F7F7AAFF7D70c2635C4C8D9a5); 
