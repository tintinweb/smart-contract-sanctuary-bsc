...
contract TESTKNK is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        __ERC20_init("TestKNK", "KNK");
        __Pausable_init();
        __Ownable_init();
        __UUPSUpgradeable_init();

        _mint(msg.sender, 9000008 * 10 ** decimals());
    }
