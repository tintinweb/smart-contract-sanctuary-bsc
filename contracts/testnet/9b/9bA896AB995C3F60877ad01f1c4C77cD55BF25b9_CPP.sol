...
contract CPP is IBEP20 , Auth, BaseToken {
    ...
    constructor(
        ...
        _name ="CPP";
        _symbol = "CPP"; 
        _totalSupply = 1 * 10 ** 3 *10**_decimals;
        uint256 _real= 1 * 10 ** 3 *10**_decimals;
        ...
        marketingWallet = 0x8D140504EC6E244C3f86a8561ec88f4B417901Bb;  //marketingwallet
        another = [0xe17c0056ad4fD3106f80cAB31a87143DfD85aBC6,0xaBF6e6Aa6179F7Eae008e3514C2A3429e755D254];     
