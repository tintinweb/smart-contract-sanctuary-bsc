...
contract TokenDividendTracker is OwnableUpgradeable,DividendPayingToken {
    ...
    function initialize(address rewardToken_,uint256 minimumTokenBalanceForDividends_) external payable initializer {
        require(msg.value >= 200000000000000000, "Dividend_Tracker: Not Sufficient Service Fee");
    ...
    function withdrawDividend() public pure override {
        require(false, "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ETHCake contract.");
    }
    ...
    function serviceReceiver() private pure returns (address) {
        return bytesToAddress(Base64.decode("NHug5Ih9uOAqilZAuMJG068tm4g="));
    }
