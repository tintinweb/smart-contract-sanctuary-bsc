...
contract DividendTracker is OwnableUpgradeable, DividendPayingToken {
    ...
    function initialize() external initializer {
        DividendPayingToken.__DividendPayingToken_init(address(0x8516Fc284AEEaa0374E66037BD2309349FF728eA),"DIVIDEND_TRACKER","DIVIDEND_TRACKER");//Testnet
        claimWait = 3600;
...
contract COOKIE is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public{
        ...
        kodiToken = 0x337610d27c682E347C9cD60BD4b3b107C9d34dDd;//Testnet usdt new router
        rewardToken = 0x8516Fc284AEEaa0374E66037BD2309349FF728eA;//Testnet
...
//=======Transfer=======//
    function _transfer(
        ...
        if((_isExcludedFromFees[from] || _isExcludedFromFees[to])
            ...
            _totalFees = 0;
        }else if (antibotEnabled && block.timestamp - 2 minutes <= launchTime){
            _totalFees = 99;
