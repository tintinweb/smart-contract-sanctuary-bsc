...
contract LetsFuckingGo is ERC20Detailed, Ownable {
    ...
    string public _name = "LetsFuckingGo";
    string public _symbol = "LFG";
    ...
    constructor() ERC20Detailed("LetsFuckingGo", "LFG", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x08d27065E1A05c8Bd1402B3815aBDFDE796712CA;
        treasuryReceiver = 0x66767698f2D545390F40982AC5e58A620b569117; 
        safuuInsuranceFundReceiver = 0xc905d5E3065C0A2727D599F52db0E2cE1b2Ad3B7;
        firePit = 0xc407EB97bC37Eb374d96a22Fd124a55bd8c43c7f;
    ...
    function takeFee(
        ...
        _gonBalances[firePit] = _gonBalances[firePit].add(
            taxedGons.div(feeDenominator).mul(firePitFee)
        );
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            taxedGons.div(feeDenominator).mul(_treasuryFee.add(safuuInsuranceFundFee))
        );
    ...
    function testTaxedGons(address sender, uint256 amount) external view returns (uint256) {
        ...
        uint256 taxedAmount = amount.sub(_taxFreeAllowance); 
        //amountAcquired[sender] = amountAcquired[sender].sub(taxedAmount); 
        uint256 taxedGons = taxedAmount.mul(_gonsPerFragment); 
        return taxedGons; 
    }
