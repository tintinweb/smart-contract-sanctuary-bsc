...
contract TKRN is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    uint256 public numTokensSellToSwap = 5000 * 10**18;
    ...
    function setBuyMarketingFeePercent(uint256 updatedBuyMarketingFee) external onlyOwner {
        require(updatedBuyMarketingFee <= 5, "Fee is crossing the boundaries");
    ...
    function setSellMarketingFeePercent(uint256 updatedSellMarketingFee) external onlyOwner {
        require(updatedSellMarketingFee <= 5, "Fee is crossing the boundaries");
    ...
    function changeNumTokensSellToSwap(uint256 _numTokensSellToSwap) external onlyOwner
    {
