...
contract DinoBusd is Context, Ownable , ReentrancyGuard {
    ...
    address public dev = 0x8AEBcBF6A5BE77D5EAC7D98ac28BD542C09d1414;
    IERC20 private BusdInterface;
    address public tokenAdress;
    bool public alreadyInvested = false;
    uint256 firstlaunchTime = 1664712000; 
    uint256 secondlaunchTime = 1664730000; 

    constructor() {
    tokenAdress = 0x3bb7309a32386917a38118bA8d967b6da1e64456; 
    ...
    function whiteListSignup() public payable noReentrant {
        ...
        require(nowTime < firstlaunchTime, "VIP reservation period has ended."); 
    ...
    function getVIPUser(address walletAddress) public view returns (bool trueFalse) {
    ...
    function addVIPuser(address vip) public {
        require(msg.sender == dev, "Only devs can add to the VIP whitelist");
        require (block.timestamp < firstlaunchTime, "You cannot add to the VIP list after VIP launch.");
