...
contract GovernorBravoDelegateStorageV1 is GovernorBravoDelegatorStorage {
    ...
    /// @notice The address of the Fkdswap Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Fkdswap governance token
    FkdInterface public fkd;
    ...
    GovernorBravoEvents
{
    ...
    string public constant name = "Fkdswap Governor Bravo";

    /// @notice The minimum setable proposal threshold
    uint256 public constant MIN_PROPOSAL_THRESHOLD = 100e18; // 10,000 Fkd

    /// @notice The maximum setable proposal threshold
    uint256 public constant MAX_PROPOSAL_THRESHOLD = 1000e18; //100,000 Fkd

    /// @notice The minimum setable voting period
    uint256 public constant MIN_VOTING_PERIOD = 3; // About 24 hours

    /// @notice The max setable voting period
    uint256 public constant MAX_VOTING_PERIOD = 403200; // About 2 weeks

    /// @notice The min setable voting delay
    uint256 public constant MIN_VOTING_DELAY = 1;

    /// @notice The max setable voting delay
    uint256 public constant MAX_VOTING_DELAY = 201600; // About 1 week

    /// @notice The number of votes in support of a proposal required in order for a quorum to be reached and for a vote to succeed
    uint256 public constant quorumVotes = 5000e18; // 50,000,000 = 5% of Fkd
     ...
     * @param fkd_ The address of the Fkd token
    ...
    function initialize(
        ...
        require(
            fkd_ != address(0),
            "GovernorBravo::initialize: invalid fkd address"
        );
        require(
    ...
    function propose(
        ...
        require(
            fkd.getPastVotes(msg.sender, sub256(block.number, 1)) >
                proposalThreshold,
    ...
    function cancel(uint256 proposalId) external {
        ...
        require(
            msg.sender == proposal.proposer ||
                fkd.getPastVotes(proposal.proposer, sub256(block.number, 1)) <
                proposalThreshold,
    ...
    function castVoteInternal(
        ...
        uint256 votes = fkd.getPastVotes(voter, proposal.startBlock);
