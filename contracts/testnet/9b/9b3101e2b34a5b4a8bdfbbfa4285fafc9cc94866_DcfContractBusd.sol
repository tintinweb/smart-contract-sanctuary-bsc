...
contract DcfContractBusd {
    ...
    uint256 constant private _minimumDepositBusd = 5e18;
    ...
    function getUserRoiBusd(address user, uint256 id) private view returns(uint256) {
        ...
        if (timeNow > _userMaps[user].accounts[id].roiLevel5Timer) {
            roiBusd = roiBusd.add(depositBusd.permill(40).mul(timeNow.subNoNegative(_userMaps[user].accounts[id].roiLevel5Timer)).div(30 days));
            roiBusd = roiBusd.add(depositBusd.permill(35).mul(_userMaps[user].accounts[id].roiLevel5Timer.subNoNegative(_userMaps[user].accounts[id].roiLevel4Timer)).div(30 days));
            roiBusd = roiBusd.add(depositBusd.permill(30).mul(_userMaps[user].accounts[id].roiLevel4Timer.subNoNegative(_userMaps[user].accounts[id].roiLevel3Timer)).div(30 days));
            roiBusd = roiBusd.add(depositBusd.permill(25).mul(_userMaps[user].accounts[id].roiLevel3Timer.subNoNegative(_userMaps[user].accounts[id].roiLevel2Timer)).div(30 days));
            roiBusd = roiBusd.add(depositBusd.permill(20).mul(_userMaps[user].accounts[id].roiLevel2Timer.subNoNegative(_userMaps[user].accounts[id].depositTime)).div(30 days));
        } else if (timeNow > _userMaps[user].accounts[id].roiLevel4Timer) {
            roiBusd = roiBusd.add(depositBusd.permill(35).mul(timeNow.subNoNegative(_userMaps[user].accounts[id].roiLevel4Timer)).div(30 days));
            roiBusd = roiBusd.add(depositBusd.permill(30).mul(_userMaps[user].accounts[id].roiLevel4Timer.subNoNegative(_userMaps[user].accounts[id].roiLevel3Timer)).div(30 days));
            roiBusd = roiBusd.add(depositBusd.permill(25).mul(_userMaps[user].accounts[id].roiLevel3Timer.subNoNegative(_userMaps[user].accounts[id].roiLevel2Timer)).div(30 days));
            roiBusd = roiBusd.add(depositBusd.permill(20).mul(_userMaps[user].accounts[id].roiLevel2Timer.subNoNegative(_userMaps[user].accounts[id].depositTime)).div(30 days));
        } else if (timeNow > _userMaps[user].accounts[id].roiLevel3Timer) {
            roiBusd = roiBusd.add(depositBusd.permill(30).mul(timeNow.subNoNegative(_userMaps[user].accounts[id].roiLevel3Timer)).div(30 days));
            roiBusd = roiBusd.add(depositBusd.permill(25).mul(_userMaps[user].accounts[id].roiLevel3Timer.subNoNegative(_userMaps[user].accounts[id].roiLevel2Timer)).div(30 days));
            roiBusd = roiBusd.add(depositBusd.permill(20).mul(_userMaps[user].accounts[id].roiLevel2Timer.subNoNegative(_userMaps[user].accounts[id].depositTime)).div(30 days));
        } else if (timeNow > _userMaps[user].accounts[id].roiLevel2Timer) {
            roiBusd = roiBusd.add(depositBusd.permill(25).mul(timeNow.subNoNegative(_userMaps[user].accounts[id].roiLevel2Timer)).div(30 days));
            roiBusd = roiBusd.add(depositBusd.permill(20).mul(_userMaps[user].accounts[id].roiLevel2Timer.subNoNegative(_userMaps[user].accounts[id].depositTime)).div(30 days));
        } else {
            roiBusd = roiBusd.add(depositBusd.permill(20).mul(timeNow.subNoNegative(_userMaps[user].accounts[id].depositTime)).div(30 days));
        }
