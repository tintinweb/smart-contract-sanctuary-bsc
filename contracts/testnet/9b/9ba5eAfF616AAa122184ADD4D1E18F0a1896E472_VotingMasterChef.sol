...
contract VotingMasterChef is BasicMetaTransaction, AccessControl {
    ...
    returns (uint256)
  {
    ...
    uint256 starsReward = (currRateEndStarsPerShare -
      currRateStartStarsPerShare);
    ...
    isInitialized
  {
    ...
    uint256 pending = ((user.amount * pool.accStarsPerShare) /
      ACC_STARS_PRECISION) - user.rewardDebt;
