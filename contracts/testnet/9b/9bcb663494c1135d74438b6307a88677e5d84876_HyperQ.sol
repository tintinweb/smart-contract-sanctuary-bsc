...
// File: contracts/HyperQToken.sol
...
contract HyperQ is IERC20Upgradeable, OwnableUpgradeable {
    ...
    {
        address owner_ = 0xC29576653f746f89dd2cCf77d441f59623C83626;    // Owner address.        
        _router = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;           // QuickSwap router.
        _marketingAddress = 0xC29576653f746f89dd2cCf77d441f59623C83626; // Marketing wallet.
        _name = "HyperQ";
        _symbol = "HPQ";                          
        _tTotal = 1000000000* 10**9;                                    // 1 Billion.
        ...
        // Buy fees.
        _taxFeeBuy = 0;
        _liquidityFeeBuy = 500;
        _marketingFeeBuy = 0;
        // Sell fees.
        _taxFeeSell = 0;
        _liquidityFeeSell = 500;
        _marketingFeeSell = 0;
        // Tx fees.
        _taxFeeTx = 0;
        _liquidityFeeTx = 0;
    ...
    //adding multiple addresses to the blacklist - Used to manually block known bots and scammers or hackers.
    ...
    {
          require(liquidityFeeBps <= 500, "Set Lower Fees Max Fees is Set to 5%");
          require(taxFeeBps <= 500, "Set Lower Fees Max Fees is Set to 5%");
          require(marketingFeeBps <= 500, "Set Lower Fees Max Fees is Set to 5%");
          require(liquidityFeeBps + taxFeeBps + marketingFeeBps <= 500,"Set Total Fees Max Fees is Set to 5%");
