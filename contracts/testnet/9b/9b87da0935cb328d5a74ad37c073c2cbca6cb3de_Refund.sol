...
contract Refund is Initializable, OwnableUpgradeable {
    ...
    function changeClaimStatus(bool _status) public onlyOwner {
        claimStaus = _status;
    }
    ...
    function claimInjection(uint256 _injection) public {
        ...
        require(claimStaus,"Claim status is false");
        ...
        require(user.claimedAmount >= user.share, "The amount is claimed");
