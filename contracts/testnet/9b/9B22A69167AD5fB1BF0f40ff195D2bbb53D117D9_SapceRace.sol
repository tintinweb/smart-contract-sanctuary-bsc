...
contract SapceRace is Context, Ownable {
    ...
    mapping(uint256 => bool) private coinState;
    ...
    function getCoinResult(uint256 raffleTicket) public view returns (bool) {
