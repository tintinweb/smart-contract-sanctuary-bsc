...
contract Swap is UUPSUpgradeable, OwnableUpgradeable {
    ...
    function addLiquidity(address tokenAddress, uint256 tokenAmount) public onlyOwner {
        ...
        IERC20(rematicFinanceAddress).approve(address(pancakeSwapV2Router), liquidityToken);
