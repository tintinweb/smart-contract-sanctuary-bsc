...
contract ClaimGameReward is Ownable, ReentrancyGuard {
    ...
    event withdrawECIOEvent(uint256 amount);
    event withdrawLAKRIMAEvent(uint256 amount);
    ...
    function getLastClaim(address user) public view returns (uint256) {
        return userInfo[user].lastClaimTime;
    }
