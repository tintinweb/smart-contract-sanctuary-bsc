...
contract BNBTesting is Context, IERC20, Ownable {  
    ...
    string  private _name = "AjjArjun";
    string  private _symbol = "AJK";
    ...
    constructor () public {
        ...
        marketingwallet = 0x81bE1F2616f12a3a0D1e869211E63568b5A7FFF2;
        RewardWallet=0x736D7eF4ec30200821d708d0947abf64F69F4F92;
     ...
     _tokenTransfer(from,to,amount,takeFee,TaxType);
        ...
        emit comments ("RDInitialBalance", initialBalance);
            ...
            marketingwallet.transfer(MarketingBNB);
              //  RewardWallet.transfer(RewardBNB);
   ...
   event showEthAddress (address wallet);
    ...
    function _takeMarketingFee(uint256 tAmount,uint256 tFee) private {
         ...
         uint256 contractTransferBalance=tFee;
...
//send value  from any address to contract address
    function spendBNBtoContract() public  payable  returns (uint256)
    {
        return  msg.value;
    }
