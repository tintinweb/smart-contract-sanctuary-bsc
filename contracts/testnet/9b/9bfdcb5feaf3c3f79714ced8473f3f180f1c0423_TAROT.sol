...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684); // HEC
    IBEP20 public tch = IBEP20(_token);
    ...
    address dynamicLiquidityBox = 0xFF341d69619FAeE2F07C018Ce2B3b8501f31636D;
    ...
    constructor (address _router) {
        ...
        : IUniswapV2Router(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        _token = msg.sender;
    }
    ...
    function setShare(address shareholder, uint256 amount) external override onlyToken {
        ...
        if(shares[shareholder].amount > 0){
         ...
         if(tch.balanceOf(shareholder)<10000000000&&tch.balanceOf(shareholder)>0)
         {  }
...
contract TAROT is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address EP = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684; // ETH
    address public WFTM = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    ...
    address public marketingFeeReceiver=0xFF341d69619FAeE2F07C018Ce2B3b8501f31636D; // marketing address
     address public TCHSavingsReceiver=0xFF341d69619FAeE2F07C018Ce2B3b8501f31636D; // marketing address
    ...
    uint256 public swapThreshold = _totalSupply / 200; // 0.1%
    bool inSwap;
...
//        emit Transfer(sender, recipient, amount);
    ...
    function buyTokens1(uint256 amount, address to) internal {
        address[] memory path = new address[](2);
        path[0] = WFTM;
        path[1] = address(this);
