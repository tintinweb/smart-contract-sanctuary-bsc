...
contract Betcash is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Bet Cash";
    string private _symbol = "BCT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x07F157002c6bc6D02E661cd8874581C3B6F394e3); 
    ...
    uint256 public _totalBurnRate = 40;
    ...
    constructor () {
        ...
        _totalTaxIfBuying = _buyMarketingFee.add(_buyBurnFee);
        _totalTaxIfSelling = _sellMarketingFee.add(_sellBurnFee);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 tokensForBurn = tAmount.mul(_totalBurnRate).div(100);
