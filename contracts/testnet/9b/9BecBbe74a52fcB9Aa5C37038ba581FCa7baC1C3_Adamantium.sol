...
contract Adamantium is ERC20Detailed, Ownable {
    ...
    uint256 public rewardYield = 405861;
    uint256 public rewardYieldDenominator = 1e9;
    ...
    function manualRebase(uint256 epoch, int256 supplyDelta)
        external
        onlyOwner
        returns (uint256)
    {
    ...
    function rebase() external isExecutor {
        if (!inSwap) {
