...
contract FMAN2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xa2863d726eb6E5D13ebB265A07E0F84F19840251); // Marketing Address
    ...
    uint256 private constant _tTotal = 100000000000000000 * 10 ** 10; // 1,000,000,000 tokens;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    bool public limitsInEffect = true;
    
    string private constant _name = "FM Man2";
    string private constant _symbol = "FM2";
    ...
    uint256 public _buyTaxFee = 7; // reflect 
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 5 / 100; // 5% maxTransactionAmountTxn
        maxWallet = _tTotal * 1 / 100;  // 1% Max wallet
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
            //0x10ED43C718714eb63d5aA57B78B54704E256024E real router
        );
