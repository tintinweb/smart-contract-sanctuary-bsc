...
contract ERC20 is IERC20 {
    ...
    //address busd = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee; // testnet busd
    IERC20 token;
...
contract PiggyBankMachine is Token {
    
     // Configurables
     uint public startTime = 1644670801; // SATURDAY, February 12, 2022 13:00:00 GMT
    ...
    uint public AIRDROP_VALUE = 100 ether;
    ...
    uint private constant MANUAL_AIRDROP    = 10000 ether;    
    uint private constant MANUAL_AIRDROP_MARKETING    = 10000 ether; 
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = 0x9F5C2d18F35462C2Ca4be68777abd35FEaC716bC;                                  // e
        DEV_2 = 0xE335C53e3Ffe9a44F6ba5a7D4011603A3770794b;  // N
        ADV_1 = 0x9A61FB81207d4F3a693C19fB71e8531C3614Cd4A;  // 0         
        ADV_2 = 0x38406f8a86a44bd96EF940fC58FF14565f959D68;  // E        
        ADV_3 = 0x5c091630F61F150AF14854F569e3CC6d6844BA11;  // o 
        ADV_4 = 0x057430b8A2be9DaC61A7e0fAE1614D6dA70DdFB5;  // au    
        FIN_1 = 0x91cE5D1C825c79a8e66b1F422f3fe85BC0402472;  // S   
        FIND_1 = 0x91cE5D1C825c79a8e66b1F422f3fe85BC0402472; // ll
        MAR_1 = 0x1a613174903691906b2C113B0Da0D80f357c5c3e;  // DESB      

        _mint(msg.sender, MANUAL_AIRDROP);  
        _mint(MAR_1, MANUAL_AIRDROP_MARKETING);  
    }       
    ...
    function stakeBUSD(address referrer,  uint256 _amount) public payable {
        require (block.timestamp > startTime);                // SATURDAY, Februar 12, 2022 13:00:00 GMT
