...
contract Stake is Ownable {
    ...
    function unstake() public payable{
        ...
        R_Token.transfer(msg.sender,final_reward + (rec._previousReward));
    ...
    function checkpercentbnb(address _user) public view returns (uint){
        ...
        uint256 res = subtotal * (_fee) / (_denominator);
        return res;
    }
