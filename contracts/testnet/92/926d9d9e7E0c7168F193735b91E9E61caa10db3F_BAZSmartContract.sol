...
/** 
DC for final testing
10b total supply 
3% liquidity 3% reward 2% marketing 2% dev 2%
...
contract BAZSmartContract is Context, IERC20, Ownable {
  ...
  uint8 private constant _decimals = 9;
    ...
    string private constant _name = "$Dreamcation Final Test";
   ...
   function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
    ...
    function contractSwap(uint256 tokens) private lockTheSwap{
        ...
        uint256 ctrrewardBalance = amtBalance - (marketingBalance - devBalance);
