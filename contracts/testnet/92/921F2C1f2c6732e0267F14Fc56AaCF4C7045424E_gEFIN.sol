...
contract gEFIN is IgEFIN, ERC20 {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(address _migrator, address _sWeFIN) ERC20("Governance EFIN", "gEFIN", 18) {
        require(_migrator != address(0), "Zero address: Migrator");
        approved = _migrator;
        require(_sWeFIN != address(0), "Zero address: sWeFIN");
        sWeFIN = IsOHM(_sWeFIN);
    }
     ...
     * @param _sWeFIN address
     */
    function migrate(address _staking, address _sWeFIN) external override onlyApproved {
        ...
        require(_sWeFIN != address(0), "Zero address found");
        sWeFIN = IsOHM(_sWeFIN);
    }
    ...
    /**
     * @notice pull index from sWeFIN token
     */
