...
contract BNBSeed {
   ...
   address [] private admins;  
	constructor(address payable wallet) public {
		...
		admins.push(wallet);
        plans.push(Plan(10000, 180,100000000000000000000,true,0));
		plans.push(Plan(150, 280,500000000000000000000,true,0));
		plans.push(Plan(80, 380,1000000000000000000000,true,0));
