...
contract VVFIT is ERC20, Pausable, Ownable, ERC20Permit {
    ...
    uint256 public constant PERCENT_DIVIDER_DECIMALS = 100000;
    ...
    uint256 public percentOfTotalSupplyForAutoLiquidity;
    ...
    //Emitted when owner `setpercentOfTotalSupplyForAutoLiquidity`
    event percentOfTotalSupplyForAutoLiquidityChanged(uint256 newValue);
    ...
    constructor(
        ...
        uint256 _percentOfTotalSupplyForAutoLiquidity
    ) checkPercent(_purchaseTaxPercent) 
    checkPercent(_salesTaxPercent) 
    ERC20(_name, _symbol) 
    ERC20Permit(_name){
        ...
        require(
            _percentOfTotalSupplyForAutoLiquidity >= 100,
            "Invalid max transaction amount percent"
        );
        //Record amount of tokens which trigger autoLiquidity
        percentOfTotalSupplyForAutoLiquidity = _percentOfTotalSupplyForAutoLiquidity;
    ...
    function setPercentageOfPurchaseTax(uint256 _purchaseTaxPercent)
        external
        onlyOwner
        checkPercent(purchaseTaxPercent) {
        purchaseTaxPercent = _purchaseTaxPercent;
    ...
    /**
     * @notice This function sets new value for percentOfTotalSupplyForAutoLiquidity
     * @dev Only can be called by the Owner
     * @param _value New value for percentOfTotalSupplyForAutoLiquidity
     */
    function setPercentOfTotalSupplyForAutoLiquidity(uint256 _value)
        external
        onlyOwner
    {
        require(
            percentOfTotalSupplyForAutoLiquidity >= 100,
            "Invalid percent"
        );
        percentOfTotalSupplyForAutoLiquidity = _value;

        emit percentOfTotalSupplyForAutoLiquidityChanged(_value);
    }
    ...
    function checkWhitelistAndTransfer(
        ...
        bool overMinTokenBalance = contractTokenBalance >= transferThreshold;
