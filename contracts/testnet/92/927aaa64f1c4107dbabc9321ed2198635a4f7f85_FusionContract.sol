    ...
    IERC721ReceiverUpgradeable
{
    ...
    function test(bytes32 _itemIdBytes32) public pure returns (string memory) {
        return string(abi.encodePacked("https://planetsandbox.infura-ipfs.io/ipfs/", _itemIdBytes32));
    }
    ...
    function handleFusion(bytes32 _requestId, bytes32 _itemIdBytes32) public recordChainlinkFulfillment(_requestId) {
        ...
        emit TEST(string(abi.encodePacked(_itemIdBytes32)));
        ...
        //     nftContract.mint(
        //         request.user,
        //         string(abi.encodePacked("https://planetsandbox.infura-ipfs.io/ipfs/", bytes32ToString(_itemIdBytes32))),
        //         1
        //     )[0]
        // );
