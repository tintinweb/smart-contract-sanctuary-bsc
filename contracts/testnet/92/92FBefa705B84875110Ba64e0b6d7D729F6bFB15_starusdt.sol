...
contract starusdt {
    ...
    function _refPayout(address _addr, uint256 _amount) private {
	    ...
	    uint referalLevel;
		if (users[msg.sender].deposit_amount < 1e8 )
			referalLevel = 5;
		else if (users[msg.sender].deposit_amount < 5e8 )
			referalLevel = 7;
		else if (users[msg.sender].deposit_amount < 1e9 )
			referalLevel = 10;
		else if (users[msg.sender].deposit_amount < 5e9 )
			referalLevel = 15;
		else 
			referalLevel = 20;
