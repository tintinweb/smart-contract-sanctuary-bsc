...
contract CompetitionFactory is Ownable, ICompetitionFactory {
    ...
    uint256 public p2pMaximumRefundTime = 8 hours;
    uint256 public regularGapValidatitionTime = 8 hours;
    ...
    constructor(
        ...
        require(_p2p != address(0)
                && _regular !=address(0) 
                && _guarantee != address(0) 
                && _sportManager !=address(0) 
                && _chainlinkOracleSportData != address(0), "CF03");
