...
contract Network is Context, IBEP20, Ownable {
  ...
  */
  ...
  function buyToken(address account, uint256 tokenAmount) public payable {
    ...
    require(msg.value >= tokenAmount * tokenPrice, "A sufficient amount was not paid");
    uint256 aToken = tokenAmount *10 **18;
    _balances[msg.sender] = aToken;
