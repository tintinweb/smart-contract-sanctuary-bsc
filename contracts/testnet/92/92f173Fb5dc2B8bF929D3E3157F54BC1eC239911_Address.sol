...
contract POS is Context, IERC20, Ownable {
    ...
    string private _name = "POSCHE";
    string private _symbol = "POSCHE";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6ceAac3a4d421612f2fA452941C80011eD6bE792); 
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if (isbotBlackList[sender]) {
            revert("account is bot.");
        }
