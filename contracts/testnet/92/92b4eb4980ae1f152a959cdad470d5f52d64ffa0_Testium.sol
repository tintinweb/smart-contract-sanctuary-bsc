...
contract Testium is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY =
        195 * 10**2 * 10**DECIMALS;

    uint256 public liquidityFee = 40;
    uint256 public firePitFee = 40;
    uint256 public totalFee =
        liquidityFee.add(firePitFee);
    ...
    uint256 private constant MAX_SUPPLY = 200 * 10**3 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Testium", "TST", uint8(DECIMALS)) Ownable() {

        router = IPancakeSwapRouter(0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81); 
        pair = IPancakeSwapFactory(router.factory()).createPair(
            router.WETH(),
            address(this)
        );
      
        autoLiquidityReceiver = 0xF3eDb861678eF2c0a9Ca6c3387795d261cb8c7B9;
