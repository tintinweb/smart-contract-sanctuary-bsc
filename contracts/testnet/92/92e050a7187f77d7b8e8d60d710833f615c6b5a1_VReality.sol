...
library Address {
    ...
    /**
        ...
        * Requirements:
        *
        * - the calling contract must have an Binance BNB balance of at least `value`.
...
contract VReality is Context, IERC20, Ownable {
    ...
    bool public OfficialVRealityToken = true;

    bool public Authorized_CryptoCravers = true;
    ...
    uint256 private buyBackUpperLimit = 1 * 10**2;  //10 to the power of 2 for testnet, change for mainnet
    ...
    constructor (address tokenOwner,string memory tokenName,
        ...
        //After a set number of transactions, contract sells to liquidity
    ...
    function setBuybackUpperLimit(uint256 buyBackLimit) external onlyOwner() {
        buyBackUpperLimit = buyBackLimit * 18**2;  
    }
