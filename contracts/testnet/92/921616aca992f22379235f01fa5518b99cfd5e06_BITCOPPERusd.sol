...
constructor() {
     name = "BITCOPPERusd"; // Sets the name of the token, i.e Ether
     symbol = "BCusd"; // Sets the symbol of the token, i.e ETH
     decimals = 5; // Sets the number of decimal places
     totalSupply = 1000000000000; // Holds an initial supply of coins

      /* Sets the owner of the token to whoever deployed it */
owner = payable(msg.sender);
balanceOf[owner] = totalSupply; // Transfers all tokens to owner
totalSupply = balanceOf[owner]; // Sets the total supply of tokens
