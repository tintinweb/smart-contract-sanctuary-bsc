...
contract PandaInu is ERC20, Ownable {
    ...
    constructor() ERC20("Panda Inu", "PANDA") {
        ...
        marketingWallet = address(0xd6028526AcA646E4f3474d911fa8883Ac53f424a); // set as marketing wallet
        treasuryWallet = address(0x1D108B6f6466C5964fCc3c1De99691C5A845defe); // set as treasury wallet
