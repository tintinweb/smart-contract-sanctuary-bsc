...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0x41b6bAE20F4E3cCa68F63a163F6978E5cbC502B9;
...
contract NuclearWarInu is Context, IERC20, Ownable { 
    ...
    string private constant _name = unicode"Nuclear War INU"; 
    string private constant _symbol = unicode"Nuclear War INU"; 
 ...
 function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            sendToWallet(payable(0x405925794DEbb1B3E2cdEDeA63b5Dc0C29AF6595), BNB_Tot);
            }
