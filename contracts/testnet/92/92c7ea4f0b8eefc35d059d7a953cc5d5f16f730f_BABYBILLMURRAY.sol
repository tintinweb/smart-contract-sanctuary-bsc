...
contract BABYBILLMURRAY is ERC20, Ownable {
    ...
    constructor(
        ...
        swapTokensAtAmount = (_totalSupply * 8) / 10000; // 0.08% swap tokens amount  //TODO change this to 0.1%
    ...
    function swapBack() private {
        ...
        uint256 burnedTokens = (contractBalance * tokensForBurn) /
            totalTokensToSwap;

        uint256 amountToSwapForETH = contractBalance.sub(
            liquidityTokens.add(burnedTokens)
        );
        ...
        if (balanceAfterSwap > 0 && ethForLiquidity > 0) {
            addLiquidityRCC(balanceAfterSwap, ethForLiquidity);
