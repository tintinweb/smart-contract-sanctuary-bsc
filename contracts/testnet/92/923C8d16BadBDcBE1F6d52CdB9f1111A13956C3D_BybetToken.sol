...
contract BybetToken is ERC20, Ownable {
    ...
    constructor() ERC20("Bybet", "BBET") Ownable() {
        ...
        // 
        LIQUID_ADDRESS = 0x9dfEDd82602647988CD6D31fcEf642693114B437; // Will update when deploy
        MARKETING_ADDRESS = 0x9dfEDd82602647988CD6D31fcEf642693114B437; // Will update when deploy
        REWARDS_ADDRESS = 0x9dfEDd82602647988CD6D31fcEf642693114B437; // Will update when deploy
        TEAM_ADDRESS = 0x9dfEDd82602647988CD6D31fcEf642693114B437; // Will update when deploy
