...
PledgePoolBase
{
    ...
    returns (uint256)
    {
        ...
        return pledgeInfos[pledger].pledgeAmount * pledgeInfos[pledger].profitPerSecond * pledgeInfos[pledger].pledgePeriod * pledgeInfos[pledger].profitRate / 100 / (10 ** decimals_);
