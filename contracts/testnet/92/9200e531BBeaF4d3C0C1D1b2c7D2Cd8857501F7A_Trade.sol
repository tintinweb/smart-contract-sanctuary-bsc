...
contract Trade {
    ...
    function swapToken(Swapping memory swapMetaData, Sign memory sign) public returns(bool) {
        ...
        averageAmount = (swapMetaData.swapingAmount0 + swapMetaData.swapingAmount1) / 2;
        fee = averageAmount * swappingFeePermille / 1000;
        transferProxy.erc20safeTransferFrom(IERC20(swapMetaData.erc20Address), swapMetaData.from, owner, fee);              
        transferProxy.erc20safeTransferFrom(IERC20(swapMetaData.erc20Address), swapMetaData.to, owner, fee);                
