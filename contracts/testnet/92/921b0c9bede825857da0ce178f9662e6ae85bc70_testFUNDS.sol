...
contract testFUNDS is Context, IBEP20, Ownable {

    using SafeMath for uint256;
    using Address for address;
    
    string private _name     = "testFREEDOM FUND TOKEN";
    string private _symbol   = "tFUNDS";
    uint8  private _decimals = 18;
    
    IUniswapV2Router02 public _pancakeswapV2Router; 
    address public _pancakeswapV2LiquidityPair; 
    
    address public _nftReflectionAddress = 0xe5E5419cbAdaA9A16b47B2BD2940265fCc6a480D; 
    address payable public _growthFundAddress = payable(0x66010855F936C4A8946B0E99379474F28a0591e5); 
    ...
    constructor () {
        ...
        IUniswapV2Router02 pancakeswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);//0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    //recieve BNB from PancakeSwap V2 Router when swaping
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_enableLiquidity && tokenBalance >= _tokenSwapThreshold && !swapping && to == _pancakeswapV2LiquidityPair) {
