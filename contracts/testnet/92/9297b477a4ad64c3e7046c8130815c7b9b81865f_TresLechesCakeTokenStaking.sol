...
contract TresLechesCakeTokenStaking is Ownable, ReentrancyGuard { 
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;
    string public name = "Tres Leches Cake Yield Farming / Token dApp";

    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    // The Tres Leches Cake Token
    IBEP20 public token;
    // The block number when 3LechesCake mining starts.
	...
	address public StakeToken = 0x3B8Ec22EA36800e0B59d33E8bbcF06da240BDC1f;

    constructor() {
        token = IBEP20(StakeToken); //Tres Leches Cake Token Test
...
//        require(msg.sender == owner, "Only contract creator can redistribute");
    ...
    //customAPY airdrop
    function customRewards() external onlyOwner {
  //    require(msg.sender == owner, "Only contract creator can redistribute");
...
//        require(msg.sender == owner, "Only contract creator can change APY");
	...
	function setStakeToken(address _staketoken) external onlyOwner() {
		require(_staketoken != address(0), "setStakeTonen: ZERO");
