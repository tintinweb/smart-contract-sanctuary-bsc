...
contract Bizforce is Context, IERC20, Ownable,Initializable {   
    ...
    mapping (address => uint256) private UserrewardPoolOnLastClaim; 
    uint256 private _rewardPool;
    uint256 private _claimedRewardPool;
    ...
    uint256[4] private _TaxType = [0,1,2,3];
    uint256[4] public _TaxFee = [0,0,5,0];
    uint256[4] private _previousTaxFee = [0,0,0,0];
    uint256 [4] private _liquidityTax  = [0,0,0,0];
    uint256 [4] public _marketingTax  = [0,0,3,0];
    uint256 [4] private _rewardTax  = [0,0,0,0];
    uint256 [4] public _autoBurnTax  = [0,0,2,0];
    ...
    function update_WalletAddress(address _marketingWalletAddress) onlyOwner public {
        marketingwallet = payable(_marketingWalletAddress);
        emit UpdateWalletAddress();
    }

    function _IncludedPair(address account,bool flag) private onlyOwner {
    ...
    */
    ...
    function updateFee(uint TaxType,uint TaxFee,uint marketingTax,uint autoBurnTax) onlyOwner public {
    ...
    function includeForReward(address account) private onlyOwner() {
    ...
    function myRewards(address _wallet) private view returns(uint256 _reward){
