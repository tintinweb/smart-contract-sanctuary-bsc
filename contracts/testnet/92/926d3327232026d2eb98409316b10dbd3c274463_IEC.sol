...
/**
   #IEILLEGAL ELIEN COIN (IEC)
   3% fee auto add to the liquidity pool
   2% distribute to a holders wallet 
   2% Distribute to Marketing wallet
   TTL supply = 200,000,000,000
   Decimals 18
*/
...
contract IEC is Context, IERC20, Ownable {
    ...
    string private _name = "ILLEGAL ELIEN COIN";
    string private _symbol = "IEC";
    ...
    uint256 public maxWalletToken = 200000000000 * (10**18);
