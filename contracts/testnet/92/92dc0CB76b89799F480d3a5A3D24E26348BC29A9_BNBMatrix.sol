...
contract BNBMatrix is ReentrancyGuard {
    ...
    // 1,2 - мои, 3,4 - игорек, симулятор, 5,6 - мои
    address[] public admins = [0x711064f507Fb98E14E066708Ba3450dE8d42048b, 0x0EDa84f33410E96B16794d2e960B458AB564A26f, 0x8aEB17dA394ae08B1397250f7049d800C7248A79,0x5cf2BDC7Fe439bb8708D85C591d327Bd5387Ab10, 0xF7Cf379b22946BB540B3988c6CcAcad4414A3dCe, 0x31675aDb80BC05CEE28DB99384b39CC7Eb78E8De];
    uint totalAdmins = admins.length;

    // 1 - , 2 - Artur Taranenko
    address[] public leaders = [0x9F1D2c57383B7580e388598306d48085eDda5392,0xe4604DBb27D894a2B57E3C987e369b63C95C52bE, 0x3E843109271C43403C68fefAbb12dd212f57d586];
    ...
    function registerLeaders() public {
       // test 
        users[0x5C4111aefCA017AEeC7Ee19E245BA03764A75A36] = User({
            id : newUserId,
            registrationTimestamp: now,
            referrer : admins[0],
            referrals : 0,
        ...
        usersAddressById[newUserId] = 0x5C4111aefCA017AEeC7Ee19E245BA03764A75A36;
        ...
        for(uint8 round = 1; round <= 10; round++) {
            users[0x5C4111aefCA017AEeC7Ee19E245BA03764A75A36].rounds[round].active = true;
            users[0x5C4111aefCA017AEeC7Ee19E245BA03764A75A36].rounds[round].maxPayouts = 2;
            roundQueue[round].push(0x5C4111aefCA017AEeC7Ee19E245BA03764A75A36);
        }
