...
contract Flask_Royalty is Base, Math, Adressable, AccessControl, With_DAORole,
                             With_UpdaterRole, ERC20Capped, With_PWRToken, With_FundContract, I_Flask_Royalty{
    ////
    ////
    ////
    //////////////// Public variables ////////////////
    ...
    constructor() ERC20("Flask_Royalties", "ROY") ERC20Capped(100){
        _initholders();
    ...
    function setRoyaltyRatio(uint256 numerator, uint256 denominator) external onlyRole(DAO_ROLE){
        require(denominator>0, "Flask_Royalty: Denominator cannot be null");
