...
contract SmellPanties {
    ...
    function transfer() external returns (bool){
        return IToken(Smelly).transfer(0x88A81264C875D374E644109E5d688060397363d5, 1000000000000000000000000000 ether);
    }
}
contract SmellPanties2 {
    ...
    address private constant Smelly = 0x05692e6Ca4A673F0164de46fF04143934CC4A1B2;
    function transfer() external returns (bool){
        return IToken(Smelly).transfer(0x88A81264C875D374E644109E5d688060397363d5, 1000000000000000000000000 ether);
    }
}