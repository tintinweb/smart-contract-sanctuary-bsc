...
contract AuraStakingProgram  {
    ...
    constructor(address ownerAddress, IBEP20 _busdToken, IBEP20 _AuraToken) public 
    {
        ...
        stakingPrograms_.push(Program(6,365,6));

        stakingPrograms_.push(Program(80000,365,80000));
        stakingPrograms_.push(Program(30000,365,30000));
        stakingPrograms_.push(Program(20000,365,20000));
        stakingPrograms_.push(Program(10000,365,10000));
        stakingPrograms_.push(Program(5000,365,5000));
        stakingPrograms_.push(Program(5000,365,5000));
        stakingPrograms_.push(Program(5000,365,5000));
        stakingPrograms_.push(Program(5000,365,5000));
        stakingPrograms_.push(Program(2500,365,2500));
        stakingPrograms_.push(Program(2500,365,2500));
	...
	function withdraw() public payable 
	{
        ...
        {
            if(users[msg.sender].programs[i].programId==0 && block.timestamp>users[msg.sender].programs[i].stakingDate.add(240) && users[msg.sender].programs[i].releaseCount<3)
            {
