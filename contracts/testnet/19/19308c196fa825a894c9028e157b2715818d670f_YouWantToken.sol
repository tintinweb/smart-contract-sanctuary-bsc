...
contract BEP20 is Context, IBEP20, Ownable {
    ...
    address private airdropAddress = 0x8a9768c3e92cBca958921a9e104954fEb2D1686a;
    
    address private liquiditylockAddress = 0xCEA4B2753688634eBD8B887de22fb798dcA1F30D;
    
    address private marketingAddress = 0xdF96EC81d67BB821A6cb8Fba0195D27ce1Bb072f;
...
// YouWantToken token with Governance 
contract YouWantToken is BEP20('YouWant', 'YWT') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "YWT::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "YWT::delegateBySig: invalid nonce");
        require(now <= expiry, "YWT::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "YWT::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "YWT::_writeCheckpoint: block number exceeds 32 bits");
