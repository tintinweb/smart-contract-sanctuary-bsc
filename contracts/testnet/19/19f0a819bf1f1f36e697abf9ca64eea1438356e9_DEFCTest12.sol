...
contract DEFCTest12 is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    DEFCTest12DividendTracker public dividendTracker;

    address public deadWallet = 0x820a0Da2a4fBB1b1E696435e8507795A25A8d1bc;

    address public immutable BUSD = address(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); //BUSD

    uint256 public _totalSupply = 10_000_000_000 * (10**18);
    uint256 public swapTokensAtAmount = 10_000 * (10**18); //100 millions. 
    ...
    address payable public _marketingWalletAddress = payable(0xc7129B46DebB37402134E657103575B1a9620114);
    address payable public _buybackWalletAddress = payable(0xfBC9396894eb8D97f925EceA1fD8EEFc2cbd8a4d);
    ...
    constructor() BEP20("DEFCTest12", "DFCt12") 
    {
        dividendTracker = new DEFCTest12DividendTracker();
    ...
    {
        require(newAddress != address(dividendTracker), "DEFCTest12: The dividend tracker already has that address");
        DEFCTest12DividendTracker newDividendTracker = DEFCTest12DividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "DEFCTest12: The new dividend tracker must be owned by the DEFCTest12 token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "DEFCTest12: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "DEFCTest12: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "DEFCTest12: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "DEFCTest12: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "DEFCTest12: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "DEFCTest12: Cannot update gasForProcessing to same value");
...
contract DEFCTest12DividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("DEFCTest12_Dividend_Tracker", "DEFCTest12_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000_000 * (10**18); //must hold 2 Millions+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "DEFCTest12_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "DEFCTest12_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main DEFCTest12 contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "DEFCTest12_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "DEFCTest12_Dividend_Tracker: Cannot update claimWait to same value");
