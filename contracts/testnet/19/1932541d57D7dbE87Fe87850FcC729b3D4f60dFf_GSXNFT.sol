...
contract GSX is Context, IERC20, Ownable {
    ...
    string private _name = "GSX";
    string private _symbol = "GSX";
...
contract GSXNFT is ERC721URIStorage{
    ...
    modifier onlyOwner() {
        require(owner == msg.sender, "#GSXNFT: ONLY_OWNER_CAN_ACCESS_THIS_FUNCTION");
        _;
    }
    ...
    function createNFT(string memory _tokenURI, uint256 _royaltyPercentage)
        ...
        returns (uint256)
    {
        require(msg.value == NFTCreationFees, "#GSXNFT : INVALID_NFT_CREATION_FEES_SENT");
        require(_royaltyPercentage <= 5, "#GSXNFT : ROYALTY_PERCENTAGE_SHOULD_BE_LESS_THAN_5");
        _tokenIds.increment();
