...
contract BTToken is IERC20, Ownable {
  ...
  //交易控制
    ...
    string private _name = "UBT";
    string private _symbol = "UBT";
    ...
    address constant private inviterAdd = 0x0c2D0EeB8558c727f8C66Cd610F703611fc89A32;
    //1
  ...
  //  uint256 public _Address1Fee = 100;
    ...
    address constant public marketAddress1 = 0x4923CCb1c320Ac5E06f349f92f3d355411670571; //营销地址

    //基金会
    uint256  constant private _previousAddress2Fee = 1000;
    address constant public marketAddress2 = 0x4a89cea0828E6F69511624359964167DD052cD3A; //基金会地址
    //节点
 
    address public nodegetAdd = 0xfEC50eEB3ba333354Eb9B4d0EB98d16B9CFBDcf2;
