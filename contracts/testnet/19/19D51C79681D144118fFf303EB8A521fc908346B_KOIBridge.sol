...
contract TokenLock is Ownable, ReentrancyGuard {
    ...
    constructor(address rewardToken_, uint256 lockDuration) {
...
contract KOIBridge is TokenLock {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;
    ...
    function exchange(uint256 amount) external nonReentrant {
        ...
        token0.safeTransferFrom(msg.sender, recipient, amount * 3);
        cap = cap + amount;
        locking(msg.sender, amount);
    }
