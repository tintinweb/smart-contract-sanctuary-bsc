...
contract MatchcupToken is ERC20, Ownable {
    ...
    constructor () ERC20("Matchcup", "MATCH") 
    {   
        transferOwnership(0x4a82B31fd4a71A5539330Ce0961804d5f71e045e);
    ...
    function updateSellFees(uint256 _marketingFeeOnSell) external onlyOwner {
        ...
        require(marketingFeeOnSell <= 10, "Marketing fee on sell cannot be more than 10%");
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        ...
        payable(owner()).sendValue(newBalance);
