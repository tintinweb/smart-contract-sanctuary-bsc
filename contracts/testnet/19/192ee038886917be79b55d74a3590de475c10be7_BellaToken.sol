...
contract BellaToken is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    string public constant name     = "Bella Token Community";
    ...
    // When BellaToken becomes an utility token with 0% tax, withdrawToken function will allow us to remove the remaining token inside the contract address.
    ...
    function _transfer(
        ...
        */
        ...
        // R E W A R D S B U N N Y = BellaToken
        bool takeFee = true;
