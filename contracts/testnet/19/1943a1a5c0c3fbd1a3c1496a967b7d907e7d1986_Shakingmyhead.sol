...
contract BUSDDividendTracker is DividendPayingToken  {
    ...
    constructor(address _dividentToken) DividendPayingToken("SMH_Busd_Dividend_Tracker", "SMH_Busd_Dividend_Tracker",_dividentToken) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 1 * (10**18); //must hold 20,000,000 tokens
    }
 
    function _transfer(address, address, uint256) pure internal override {
        require(false, "SMH_Busd_Dividend_Tracker: No transfers allowed");
    }
 
    function withdrawDividend() pure public override {
        require(false, "SMH_Busd_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Boda contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "SMH_Busd_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "SMH_Busd_Dividend_Tracker: Cannot update claimWait to same value");
...
contract Shakingmyhead is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 private maxBuyTranscationAmount = 1000000000 * (10**18);
    ...
    constructor() ERC20("Shaking my head", "SMH") {
        	
    	marketingWallet = 0xD17AAfaF68fC85149B52AF96c4212217A4E03298 ; 
        devWallet = 0xd2377bDA64928EeE9460a43f4bE8E217c8EEBa8e;
    ...
    receive() external payable {
  	...
  	function updateMarketingWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != marketingWallet, "smh: The marketing wallet is already this address");
 ...
 function updatedevWallet(address _newWallet) external onlyOwner {
  	    require(_newWallet != devWallet, "smh: The dev wallet is already this address");
        excludeFromFees(_newWallet, true);
