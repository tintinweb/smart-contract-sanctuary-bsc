...
///
contract VendorA is ReentrancyGuard, Ownable {
    // Token Contract
    TAGEN tokenAA;
    ...
    // Token price for BNB
    // 0.000001 ether
    uint256 public tokensPerBNB = 10**9 wei;
...
contract VendorB is ReentrancyGuard, Ownable {
    ...
    constructor(address tokenAddress, address _vendorA) {
