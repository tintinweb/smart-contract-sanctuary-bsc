 ...
 */
contract DefVaultV1 is ERC20, Operator, ReentrancyGuard {
    ...
    function inCaseTokensGetStuck(address _token) external onlyOperator {
        require(_token != address(want()), "DefVault: STUCK_TOKEN_ONLY");
