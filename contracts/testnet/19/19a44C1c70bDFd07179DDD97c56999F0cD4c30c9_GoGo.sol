...
/**
Contract Go Chart Go Developed by KReATOR @ [email protected]
Telegram at 10K 
Buy tax
13
...
interface IERC20 {
    /**
     * @dev KReATOR- Returns the amount of tokens in existence.
     */
...
library SafeMath {
    ...
    contract GoGo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Go Chart Go", "GoGo") {

    	marketingWallet = (0xC993c93cCa1296530BcA70daF059A94E3C0aC014);
    	rewardsWallet = (0xCC1559548dB2038BA11d4924CD72E2834aE4Beb1);
    	
    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//0x10ED43C718714eb63d5aA57B78B54704E256024E); //0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
            ...
            if (!swapping && canSwap) {
                ...
                if (marketingEnabled) {
                    if(block.timestamp < _firstBlock + (1 days)) {
                        ...
                        address payable addr = payable(0xC993c93cCa1296530BcA70daF059A94E3C0aC014); // dev fee lasts for one day only
