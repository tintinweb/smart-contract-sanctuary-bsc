...
contract Marketplace is IERC721Receiver, AccessControl {
    ...
    uint256 public totalTransactionTime;
    ...
    uint256 private tax = 7; // percentage
    ...
    function setNft(IERC721Enumerable _nft) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Do not have operator role");
        nft = _nft;
    }
    ...
    function withdrawErc20(IERC20 _token) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender), "Do not have operator role");
