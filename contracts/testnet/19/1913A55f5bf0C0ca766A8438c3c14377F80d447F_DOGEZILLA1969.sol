...
Telegram: https://t.me/dogezilla1969bsc
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xba7375fadF400aC32C027bfD279CeB8d044473f9; // owner address
...
contract DOGEZILLA1969 is Context, IERC20, Ownable {
    ...
    string private _name = "DOGEZILLA 1969";
    string private _symbol = "$DZ69"; 

    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xba7375fadF400aC32C027bfD279CeB8d044473f9); // Marketing Address
    address payable public teamWalletAddress = payable(0xba7375fadF400aC32C027bfD279CeB8d044473f9); // Team Address
