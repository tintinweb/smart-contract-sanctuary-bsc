...
contract NFTV1 is ERC2981, ERC721Tradable {
    ...
    ) public ERC721Tradable(_name, _symbol, _owner) {
        gameOwner = _owner;
        supportsInterface(INTERFACE_ID_ERC2981);
    }
    ...
    function unpack(
        ...
        require(_cardIndex.length == _amount, "ERC721: values length mismatch");
    ...
    // ======== Burning =========
    function burn(address _account, uint256 _tokenId) public {
