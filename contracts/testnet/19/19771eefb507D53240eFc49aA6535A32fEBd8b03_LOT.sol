...
contract LOT is ERC1155, Ownable, ERC1155Burnable {

        uint256 public constant GOLD = 1;//黄金卡牌
        uint256 public constant SILVER = 2;//白银卡牌
        uint256 public constant HONORABLE = 3;//尊贵卡牌

    constructor() ERC1155("http://cjd.nmall.vc/kp/{id}.json") {
        _mint(msg.sender,GOLD,10000000,"");
        _mint(msg.sender,SILVER,10000000,"");
        _mint(msg.sender,HONORABLE,10000000,"");
    }
