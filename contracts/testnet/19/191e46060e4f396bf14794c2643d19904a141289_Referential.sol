...
// File: ../leveraged/contracts/referential.sol
...
/**
* @title Referential contract
* @notice Contains contract addresses
**/
contract Referential is Ownable {
    ...
    * @param _contractName the contract name
