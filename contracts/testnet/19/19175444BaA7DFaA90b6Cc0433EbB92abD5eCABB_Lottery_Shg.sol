...
contract Lottery_Shg is IVRFConsumer, Ownable {
    ...
    function startNewLottery(
        ...
        TicketCount += 1;
        uint256 car_1 = _getRand(nimNum, maxNum+1);
        uint256 car_2 = _getRand1(nimNum, maxNum-1);
        while(car_2 == car_1){
            car_2 = _getRand2(nimNum, maxNum-2);
        }
    ...
    function _getRand(uint256 minNumber, uint256 maxNumber)
        private
        view
    ...
    function _getRand2(uint256 minNumber, uint256 maxNumber)
        private
        view
        returns (uint256 result)
    {
