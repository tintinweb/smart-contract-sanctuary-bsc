...
// NeverWage token - FOR A COMFY LIFE
// 8% BUSD REWARDS
// 4% liquidity
// 1.5% marketing 
...
contract EverFlush is IBEP20, Ownable {
    using SafeMath for uint256;
    string constant _name = "EverFlush";
    string constant _symbol = "EVERFLUSH";
...
//		router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Testnet
    ...
    function FlushToken (uint256 amount) public onlyOwner() {
        _transferFrom(address(this), ZERO, amount);
    }
