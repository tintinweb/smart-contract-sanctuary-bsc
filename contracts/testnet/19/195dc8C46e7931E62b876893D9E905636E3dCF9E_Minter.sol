...
contract Minter is Ownable {
    ...
    PriceConsumerV3 public price_consumer = new PriceConsumerV3(0x14e613AC84a31f709eadbdF89C6CC390fDc9540A);
    ...
    function getPrice() public view onlyOwner returns(int256 newPrice) {
        int256 price = price_consumer.getLatestPrice();
        uint8 decimals = price_consumer.decimals();
        // int256 newPrice = ethers.utils.formatUnits(price, decimals);
        return price;
        // nft_contract.mint(1);
    }
