...
// Openzepplin token contract testtoken.sol 

/* 
 * @title Test Token TESTT to solved lowcap EVM liquidity proble.
 * @dev All 1 billion TESTT emiited to owner in first txn.
*/
