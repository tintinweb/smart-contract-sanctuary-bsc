...
contract GameWallet is OwnableUpgradeable {
    ...
    function winPrize(
        ...
        if ((sum * prizeFee) / 1e4 != 0 && treasury != address(0)) {
            ...
            console.log("$prizeFee", (sum * prizeFee) / 1e4);
            sum -= (sum * prizeFee) / 1e4;
        }

        console.log("sum minus prize fee", sum);
        console.log("winners length", _winners.length);
        ...
        for (i = 0; i < _winners.length; i++) {
            if (i == _winners.length - 1) {
                ...
                console.log(sum / _winners.length, "sum / _winners.length");
