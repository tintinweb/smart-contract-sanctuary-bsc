...
contract FishermanBro {
    IERC20 public token_CATFISH;
    using SafeMath for uint256;
    address erctoken = address(0xCD4b2C8e37a6D4C19c2734C0A49C982DC6bB27ba); //CATFISH
    ...
    constructor() {
        ...
        ceoAddress2=address(0x9C866A37098CB367dc9B81f2D12e437373a1DF2D);
        ceoAddress3=address(0x4AEf3133b1bC2cF78f88552fDd75a1B146c9333a);

        token_CATFISH = IERC20(erctoken);
    ...
    function invest(
        ...
        token_CATFISH.transferFrom(address(msg.sender), address(this), amounterc);

        // dev fee
        uint256 fee = amounterc.mul(PROJECT_FEE).div(PERCENTS_DIVIDER);

        token_CATFISH.transfer(ceoAddress, fee);
        token_CATFISH.transfer(ceoAddress2, fee);
        token_CATFISH.transfer(ceoAddress3, fee);
    ...
    function withdraw() public {
        ...
        token_CATFISH.transfer(msg.sender, totalAmount);
