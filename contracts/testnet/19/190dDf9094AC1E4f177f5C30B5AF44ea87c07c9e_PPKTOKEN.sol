...
contract PPKTOKEN is  Context, Ownable  {
    ...
    /* --------- max tx info --------- */
	uint public _maxTxAmount = 1e6 * 1e9;
	uint public numTokensSellToAddToLiquidity = 1e5 * 1e9;
    ...
    constructor () public {
        _name = "Progressive Portfolio Expansion";
        _symbol = "PPX";
        _decimals = 9;
        _totalSupply = 1e9*1e9; /// initial supply 100,000
