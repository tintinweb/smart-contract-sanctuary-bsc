...
contract YOGBoxLaunchPadOfficial is Pausable, Ownable {
    /* ========== LIBs ========== */
    ...
    constructor() {
        ...
        boxPriceMap[3] = 1 ether;
        boxPriceMap[4] = 1 ether;
        boxPriceMap[5] = 1 ether;
    ...
    function buyBox(uint256 boxType, uint256 amount) external whenNotPaused {
        ...
        // mint box
        IERC721YULIBOX(NFTBoxAddress).safeMint(msg.sender, boxType, 1);
