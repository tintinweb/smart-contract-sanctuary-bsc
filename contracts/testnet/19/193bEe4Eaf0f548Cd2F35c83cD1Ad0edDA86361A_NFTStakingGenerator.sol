...
contract NFTStakingGenerator is Ownable {
    ...
    function createWithImplementation(
        ...
        return _create(nft, name, symbol, implementation, rewardToken, lockTime, min, max);
    }
    ...
    function create(
        ...
        return _create(nft, name, symbol, proxyImplementation, rewardToken, lockTime, min, max);
    }
    ...
    function _create(
        ...
        IStaking(project).__init__(nft, rewardToken, lockTime, name, symbol);
