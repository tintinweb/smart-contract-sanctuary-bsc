...
contract OnePunchGrow is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ONEPUNCH GROW";
    string private _symbol = "$OPG";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0xEB9cBa40d0E5754747030c0Fc68aCf2529aDeBD7); // Marketing Address
    address payable public teamWalletAddress = payable(0xEB9cBa40d0E5754747030c0Fc68aCf2529aDeBD7); // Team Address
