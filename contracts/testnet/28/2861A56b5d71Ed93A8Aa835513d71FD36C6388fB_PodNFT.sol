...
contract PodNFT is LaunchpadNFT {
    ...
    constructor(string memory name_, string memory symbol_, string memory baseURI_, string memory suffix_, address launchpad, uint256 maxSupply) LaunchpadNFT(name_, symbol_, baseURI_, suffix_, launchpad, maxSupply) {                           
        baseURI = baseURI_;
        suffix = suffix_;
        LAUNCHPAD = launchpad;
        LAUNCH_MAX_SUPPLY = maxSupply;
