...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //the reward token you want distributed 
...
contract BSCToken is IBEP20, Auth {
    ...
    address _marketingAdr = 0x63743bFd1D3E496A246a799D637658272913Fcc4;

    address routerv2 = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;

    string constant _name = "BSCToken";
    string constant _symbol = "$BSC";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 168137035 * (10 ** _decimals);
    ...
    uint8 public cooldownTimerInterval = 15; //this is in seconds. 
