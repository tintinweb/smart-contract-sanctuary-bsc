...
contract StakeWar is Initializable, OwnableUpgradeable, Member {
    ...
    event Fight(address attcker, uint256 attckerTokenId,address defender,uint256 defenderTokenId, bool result, uint256 bonus);
    ...
    function fight() public {
        ...
        emit Fight(msg.sender, IMasterChef(manager.members("NFTStakePool")).userStakeTokenId(msg.sender), originB, tokenIdB, isWinner, bonus);
    }
