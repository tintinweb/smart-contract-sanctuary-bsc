...
contract NFT is ERC721URIStorage, RoyaltiesV2Impl {
    ...
    // Change Name
    constructor(address marketplaceAddress_) ERC721("NFT Marketplace", "NFTM") {
        owner = _msgSender();
        ...
        returns (uint256)
    {
        ...
        if (_percentageBasisPoints > 0) {
            uint96 percent = 100 * _percentageBasisPoints;

            require(
                percent < 10000,
                "Token royalty: Royalty should be less than 100 %"
            );
