...
abstract contract Auth {
     ...
     */
    modifier onlyOwner() {
        require(isOwner(msg.sender), "Not the owner"); _;
    }
     ...
     */
    modifier authorized() {
        require(isAuthorized(msg.sender), "Unauthorized"); _;
    }
...
contract BETX is IBEP20, Auth {
    ...
    string constant _name = "Betix.gg";
    string constant _symbol = "BETX";
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountBETX);
