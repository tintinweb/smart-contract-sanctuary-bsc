...
contract METAPUNK is Context, IERC20, Ownable {
    ...
    string private _name = "METAPUNK";
    string private _symbol = "MetaPunk";
    ...
    uint256 private buyBackUpperLimit = 1000000 * 10**9;
