...
abstract contract BaseFunction is IBaseUser, IBaseAdmini, Ownable {
    ...
    function startBetWhichlGames(uint256 round, uint256 which) public virtual override onlyOwner {
        ...
        require(GAME_STATE_INIT == _gameRoundInfo.roundGameMap[round].gameMap[which].gameState, "BaseFunction: startBetWhichlGames gameState is not bet");
    ...
    function setWhichlGamesResult(uint256 round, uint256 which, uint256 result) public virtual override onlyOwner {
        ...
        require(GAME_STATE_CLOSE_BET == _gameRoundInfo.roundGameMap[round].gameMap[which].gameState, "BaseFunction: setWhichlGamesEnd gameState is not bet");
    ...
    function endWhichlGames(uint256 round, uint256 which) public virtual override onlyOwner {
        ...
        require(GAME_STATE_CLOSE_BET == _gameRoundInfo.roundGameMap[round].gameMap[which].gameState, "BaseFunction: endWhichlGames gameState is not bet");
