...
contract FreeManager is Ownable {
    ...
    address  public swapTokenAddr=0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
...
contract FireToken is ERC20, ERC20Detailed  {
    ...
    constructor ()  ERC20Detailed("Firx", "Firx", 18) {
    ...
    function buy(address _address) public returns(bool){   
        address[] memory path = new address[](2);
        path[0] = address(this); 
