...
contract SNH is ERC20Burnable, Ownable {
    ...
    uint256[7] public stakingDPR = [93933,151739,246575,394521,657534,986301,1972603];
    ...
    {   
        ...
        airdropEnd = block.timestamp + 60 days;
        withdrawEnd = block.timestamp + 90 days;
        ...
        public
    {
        ...
        require(stakeTime >= 1 days, "Minimum stake time is one day!");
        ...
        returns(uint256)
    {
        ...
        reward += (((end-stakeStart) / 1 days) * stake) * selectedStakingDPR / 1000000000; 
        return reward;
    }
