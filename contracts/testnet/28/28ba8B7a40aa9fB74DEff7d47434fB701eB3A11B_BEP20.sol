...
contract BEP20 is ERC20, Ownable {
    ...
    uint256 public liquidityFee = 1;//回流
    uint256 public marketingFee = 1;//营销
    uint256 public foundationFee = 5;//滑点
    uint256 public lpRewardFee = 3;//lp分红
    ...
    address public lpRewardToken = _usdt;
    address public swapToken = _usdt;

    uint256 public AmountLiquidityFee;
    uint256 public AmountLpRewardFee;
    uint256 public AmountMarketingRewardFee;

    address public marketingWalletAddress=0xc7d8a9Ec8957203F11312f0cF30FC6a4d4775380;//营销钱包
    address public foundationWalletAddress=0xc7d8a9Ec8957203F11312f0cF30FC6a4d4775380;//滑点接收钱包
    address public liquidityReceiveAddress=0xc7d8a9Ec8957203F11312f0cF30FC6a4d4775380;//回流钱包
    ...
    constructor() payable ERC20('aa', 'aa')  {
