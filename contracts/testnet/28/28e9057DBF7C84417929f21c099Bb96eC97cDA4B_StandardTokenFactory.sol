...
contract StandardTokenFactory {
    ...
    constructor(address _owner, address _tokenFactoryManager) {
    ...
    function createStandard(
        ...
        tokenFactoryManager.assignTokensToOwner(creator_,address(token),0);
...
contract StandardToken is Context, IERC20, IERC20Metadata{
    ...
    function _beforeTokenTransfer(address sender, address to, uint256 amount) internal virtual { 
        ...
        if( state.blacklistflag > 0 ) {
            require (!isBlackListed(sender), "Token transfer refused. Sender is on blacklist");
