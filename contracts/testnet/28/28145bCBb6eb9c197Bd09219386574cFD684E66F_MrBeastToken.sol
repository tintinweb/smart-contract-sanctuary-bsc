...
contract MrBeastToken is IERC20, Ownable {
    ...
    uint256 public constant holdingCapPercent = 2;
    ...
    function _getMaxHolding(address account) public view returns (uint256) {
