...
contract DelegateMiddleman is Ownable {
    ...
    constructor(BEP20 rt, BEP20 st, WttMaster mc, uint256 pid) {
        oracle = msg.sender;
        robiniaToken = rt;
        stakingToken = st;
        masterChef = mc;
    ...
    function getUserPendingReward(address u) public view returns(uint256) {
        ...
        uint256 pendingOnMasterchef = masterChef.pendingToken(poolId, address(this));
    ...
    function deposit(address userAddress, uint256 amount) public onlyOracle {
        ...
        masterChef.deposit(poolId, 0); // kontrol edelim bu fonksiyonu harvest için kullandım.
