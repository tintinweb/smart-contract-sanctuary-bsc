...
contract sAsixPlusToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked AsixPlus", "sAsix+", 18) ERC20Permit() {
    ...
    /**
        @notice increases sAsixPlus supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sAsixPlus
