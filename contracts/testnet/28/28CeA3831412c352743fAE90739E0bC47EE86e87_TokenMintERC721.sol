...
contract TokenMintERC721 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, ERC721EnumerableUpgradeable, ERC2981Upgradeable {
     ...
     */
    function initialize(address _owner, string memory _name, string memory _symbol, address _treasury, uint96 _feeNumerator) public initializer {   
    ...
    function buy() public payable nonReentrant {
        require(msg.value == FIXED_PRICE, "Payment not equal to ETH price to pay !");
