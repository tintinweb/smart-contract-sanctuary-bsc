...
contract GemStaking is Ownable{
    ...
    */
    ...
    function StakeGem(uint256 tokenId) public bookKeeping{
        ...
        // cycles[curCycle].totalCycleScore += 9;
    ...
    function claimReward() public{
        ...
        require(block.timestamp >= user.endTime, "Claim time has not reached");
    ...
    function unStakeGem() public {
        require(block.timestamp >= userInfo[msg.sender].endTime, "Unstake time has not reached");
        claimReward();
        StakedInfo storage user = userInfo[msg.sender];
