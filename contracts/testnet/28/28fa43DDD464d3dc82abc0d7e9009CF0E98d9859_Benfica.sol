...
contract Benfica is Ownable, Rebasable
{
    ...
    */
    ...
    function forceSwapBack(uint256 contractTokenBalance) external onlyOwner {
        uint256 contractBalance = balanceOf(address(this));
        require(contractBalance >= totalSupply() / 100000, "Can only swap back if more than .001% of tokens stuck on contract");
        swapTokens(contractTokenBalance);
