...
contract Bumpingbunny is Context, IERC20, Ownable {
    ...
    string private _name = "Bumpingbunny";
    ...
    address public _devWalletAddress =
        address(0xe6309B3DEbD3c6652c892e9E3bb9d093a61A9F07);
    ...
    //Etherum (v2 tất cả địa chỉ giống nhau)
