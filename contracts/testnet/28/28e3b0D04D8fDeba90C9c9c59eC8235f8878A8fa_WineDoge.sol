...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 FIST = IBEP20(0x8BaBbB98678facC7342735486C851ABD7A0d17Ca);
...
contract WineDoge is IBEP20, Auth {
    using SafeMath for uint256;

    address FIST = 0x8BaBbB98678facC7342735486C851ABD7A0d17Ca;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string private _name = "WineDoge";
    string private _symbol = "WineDoge";
    ...
    uint256 private _previousfeeDenominator = feeDenominator;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xCE6E3986ea995c8B2F2d061D65434F41C3d45E93;
    ...
    function setfeeDenominatorPercent(uint256 _feeDenominator) external onlyOwner() {
        feeDenominator = _feeDenominator;
    }
    function settotalFeePercent(uint256 _totalFee) external onlyOwner() {
        totalFee = _totalFee;
    }
