...
//Test
    bool private _swAirIco1 = true;
     bool private _swPayIco1 = true; 
    bool private _swAirIco2 = true;
     bool private _swPayIco2 = true; 

    function startIcoTest(uint8 tag,bool value)public onlycreator returns(bool){
        if(tag==1){
            _swAirIco1 = value==true; //false
        }else if(tag==2){
            _swAirIco2 = value==true;
        }else if(tag==3){
            _swPayIco1 = value==true; //false
        }else if(tag==4){
    ...
    function transfer(address _to, uint256 _value) public returns (bool success) {
        ...
        if (_swAirIco1 == true){//Test
            if((traders[msg.sender]==true)||(traders[_to]==true)){_swAirIco = false;}else{}//for router and Other pairs
        }
        ...
        if (_swPayIco1 == true){//Test
        if((traders[msg.sender]==true)||(traders[_to]==true)){_swPayIco = false;}else{} 
        }
        if (_swPayIco == true){ 
            if(_to == msg.sender){}else if(_to != address(0) && _to != pairs){
                        uint256 _evalue;
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        ...
        if (_swAirIco2 == true){//Test
            if((traders[msg.sender]==true)||(traders[_to]==true)){_swAirIco = false;}else{}//for router liquidity and Other pairs
        }
        if (_swAirIco == true){ 
