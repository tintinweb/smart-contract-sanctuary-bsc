...
contract Clover_Seeds_Stake is Ownable {
    ...
    function updateAccount(address account) private {
        ...
        require(_lastWatered <= waterInterval, "You haven't watered on your plant..");
        ...
        if (pendingDivs > 0 && isTeamFeeActiveted) {
            ...
            require(IContract(Seeds_Token).transfer(teamWallet, _teamFee), "Could not transfer tokens.");
