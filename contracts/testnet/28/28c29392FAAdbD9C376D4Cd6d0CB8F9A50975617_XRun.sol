    ...
    Pausable
{
    ...
    function whitelistMintPack() public whenNotPaused {
        ...
        _mintShoes(_msgSender(), blindBox, shoesPerPack);
    }
    ...
    function giftPacks(address _to, uint256 _id, uint256 _numPacks) public onlyRole(DEV) {
        _mintShoes(_to, _id, _numPacks * shoesPerPack);
    }

    function _mintShoes(address _to, uint256 _id,uint256 _amount) internal {
        require(_to == address(0x0),"Token is already minted");
