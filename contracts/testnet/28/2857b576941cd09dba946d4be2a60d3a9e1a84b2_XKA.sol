...
contract XKA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Xiaokeai Coin";
    string private _symbol = "XKA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x132D3833edF11679dDA131cf4380a1d6b49E6CcA); // Marketing Address
    address payable public teamWalletAddress = payable(0xFF9D245234f0c0A9431bC02B51Aa1ee62b23492C); // Team Address
	address public OwnerAddress = 0x6E747A905b854595259a087e3A4658fd2FA0b2b1;
