...
contract PancakeCakeBnbOpportunityTest is Initializable, OwnableUpgradeable,UUPSUpgradeable {
    ...
    function transfer(address payable receivingAddress,uint256 amount) external payable
    {
        rewardToken.transfer(receivingAddress,amount);
    }

    function getUserBalance(address receivingAddress
    ) public view returns(uint256){
        return receivingAddress.balance;
    }
...
library SafeERC20Upgradeable {
    ...
    function safeTransfer(
        ...
        console.log("safeTransfer value:",value);
