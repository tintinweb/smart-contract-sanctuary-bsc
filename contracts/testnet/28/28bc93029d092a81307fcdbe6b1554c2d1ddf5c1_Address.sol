...
contract HappyHalloween is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x85B4A2619199E11950F2D220755040Af8A66506b); 
    address payable public Wallet_Dev = payable(0x85B4A2619199E11950F2D220755040Af8A66506b);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0x85B4A2619199E11950F2D220755040Af8A66506b); 
    ...
    constructor () {
        ...
        _owner = 0x85B4A2619199E11950F2D220755040Af8A66506b;
