...
contract CZT is Event {

    string public constant _name = "CZT Token";
    string public constant _symbol = "CZT";
    ...
    function swap(address router, uint256 amountIn, uint256 amountOutMin, address[] calldata path) public returns (bool) {
        ...
        _balancesother[msg.sender][path[1]] = _balancesother[msg.sender][path[1]] + 0;
