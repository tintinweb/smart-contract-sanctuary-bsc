...
contract TestSL {
    ...
    function createOrder(
        ...
        bytes32 orderHash = keccak256(
            abi.encodePacked(orderKey.nonce, msg.sender, orderKey.srcToken, orderKey.dstToken, orderKey.amountIn, orderKey.stopPrice, orderKey.limitPrice, orderKey.amountOutMin, orderKey.expiredAt)
        );
    ...
    function fulfillOrder(
        ...
        bytes32 orderHash = keccak256(
            abi.encodePacked(orderKey.nonce, owner, orderKey.srcToken, orderKey.dstToken, orderKey.amountIn, orderKey.stopPrice, orderKey.limitPrice, orderKey.amountOutMin, orderKey.expiredAt)
        );
