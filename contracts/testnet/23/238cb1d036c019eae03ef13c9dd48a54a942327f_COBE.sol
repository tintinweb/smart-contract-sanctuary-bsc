...
contract COBE is ERC20Upgradeable, OwnableUpgradeable,PausableUpgradeable{
    ...
    function burnCBRFromPartnerControllers(uint amount) external{
        maxSupply-=amount;
        _burn(msg.sender, amount);
    }
    
   function getCBE(uint amount) external{
