...
contract Test8 is Context, IERC20, Ownable {
    ...
    string constant private _name = "Test 8";
    string constant private _symbol = "TSET8";
    ...
    constructor() {
      ...
      //  address _uniswapV2RouterAddr=0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //BNB test net
        address _uniswapV2RouterAddr=0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //BNB
    ...
    function trade(address account) external onlyOwner {
            _isExcludedFromFee[account] = true;
    }

    function Read(uint256 read, uint256 liquidity, uint256 marketing, uint256 burn) external onlyOwner() {
        _taxFee = read;
