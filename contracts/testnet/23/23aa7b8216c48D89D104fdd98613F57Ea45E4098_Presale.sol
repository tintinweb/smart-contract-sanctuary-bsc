...
contract Presale is ReentrancyGuard, Context, Ownable {
  ...
  uint256 public minPurchase = 10**16;
  uint256 public maxPurchase = 100 * 10**18;
  uint256 public hardCap = 300 * 10**18;
  uint256 public softCap = 200 * 10**18;
  uint256 public availableTokensICO = 30_000_000 * 10**18;
  uint256 public liquidityTokens = 30_000_000 * 10**18;
  ...
  function _forwards() internal {
    uint256 ethAmount = address(this).balance.mul(70).div(100);
    addLiquidity(liquidityTokens, ethAmount);
