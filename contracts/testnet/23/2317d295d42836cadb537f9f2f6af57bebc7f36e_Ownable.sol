...
contract RingContract is ERC20Detailed, Ownable {
    ...
    string public _name = "Ringfi";
    string public _symbol = "RINGFI";
    ...
    constructor() ERC20Detailed("Ringfi", "RINGFI", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityFund = 0xBaEa1f482c6E355bAD3Bf2ebAe4ffce612C838Bd;
        treasuryFund = 0x45425670f5d7D29f3a4b9790c5157288c5232f79;
        ringRiskFreeFund = 0x02F174Db35c7a6A26c15a96B7fD32B9fe3941cFd;
        supplyControl = 0x02C0969C76c4272EE543208f3eA11e93115070E1;
