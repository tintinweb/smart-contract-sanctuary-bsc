...
contract StakingPool is Upgradable {
    ...
    */
        ...
        returns (uint256)
    {
        ...
        if (pool.poolType == 0) {
            ...
            amount = (block.timestamp - data.lastUpdateTime) * data.balance * pool.apr * pool.configs[4] / ONE_YEAR_IN_SECONDS / 1e4;
        }
    ...
    */
    ...
    function setDAYINSECOND(uint256 _value) public onlyController {
