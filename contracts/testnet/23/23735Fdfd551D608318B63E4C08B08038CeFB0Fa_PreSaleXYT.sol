...
contract PreSaleXYT is Ownable{
    ...
    uint8 public length = 0;
    uint8 public issuetime = 0; // Time of each distribution
    uint8 public issuePercent; // Percentage of each distribution
    uint8 public issueInterval; // next 
