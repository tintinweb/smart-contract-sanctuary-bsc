...
/// @title PrivateSaleApeVerse Contract
...
contract PrivateSaleApeVerse is Ownable {
    using SafeMath for uint256;

    IApeVerse public token;
    ...
    constructor(IApeVerse _token, uint256 _rate) public {
        presaleStartTimestamp = now;
        presaleEndTimestamp = now.add(35 days);
        token = _token;
    ...
    function deposit() public payable {
        ...
        require(whitelist[msg.sender] == false, "invalid deposit address");
        require(
    ...
    function withdraw() public {
        ...
        require(whitelist[msg.sender] == false, "invalid withdraw address");
        ...
        returns (uint256)
    {
        ...
        if (
            now > presaleEndTimestamp.add(4 days) && withdraws[msg.sender] == 0
        ) {
...
contract PreSaleApeVerse is Ownable {
    using SafeMath for uint256;
