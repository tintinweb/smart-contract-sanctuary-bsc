...
contract BuyBack {
    ...
    function buyAndBurnToken(
        ...
        if (_wantAdd != _rewardToken) {
            ...
            IERC20(_wantAdd).safeIncreaseAllowance(0x10ED43C718714eb63d5aA57B78B54704E256024E, _wantAmt);
            _path = [_wantAdd, _rewardToken];

            IPancakeRouter02(0x10ED43C718714eb63d5aA57B78B54704E256024E).swapExactTokensForTokensSupportingFeeOnTransferTokens(
                _wantAmt,
                _minBurnAmt,
                _path,
                address(this),
