...
function initialize(address routerAddress) public initializer {
       ...
       // set the rest of the contract variables
        ...
        _tTotal = 90900000 * uint256(10)**_decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        swapTokensAtAmount = 90_900 * uint256(10)**_decimals;
        maxBuyLimit = 9_09_000 * uint256(10)**_decimals;
        maxSellLimit = 9_09_000 * uint256(10)**_decimals;
        maxWalletLimit = 9_09_000 * uint256(10)**_decimals;
