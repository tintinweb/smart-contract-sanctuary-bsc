...
contract SURFLPStaking is Ownable {
    ...
    struct UserReferralInfo {
        ...
        uint referrerReward;           // referrerReward that you received
    }
    ...
    mapping (address => mapping(address => UserReferralInfo)) public userReferralInfo;
    ...
    function depositWithReferrer(uint256 _amount, address _referrer) public {
        ...
        UserReferralInfo storage userReferral = userReferralInfo[_referrer][msg.sender];
        ...
        userReferral.referrerAddress = msg.sender;
        userReferral.stakingAmount = _amount;
        userReferral.referrerReward = _referrerReward;
        totalReferrerNum += 1;
        totalReferrerRewards += 1;
