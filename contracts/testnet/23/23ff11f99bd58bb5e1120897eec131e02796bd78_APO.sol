...
contract APO is ERC20, Ownable, SafeToken {
    ...
    uint256 private sellTimeCycle = 300 seconds;
    ...
    function setDelay(bool _bool) public onlyOwner {
        delaySell = _bool;
    }
    ...
    constructor() ERC20("Apocalypse", "APO") {
        ...
        buybackWallet = payable(0xA47B3E535C1804a57B67c7bC48e887f0346A4078);
...
//this will be used to exclude from dividends the presale smart contract address
    ...
    function _transfer(
        ...
        if(delaySell == true && from != owner()){
            require(block.timestamp >= lastSell[from] + sellTimeCycle);
