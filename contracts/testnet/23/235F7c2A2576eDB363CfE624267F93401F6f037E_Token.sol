...
contract Token is Ownable{
    ...
    uint256 public UsdtDividendPool = 5 * 10 ** 18;
    ...
    address private USDTaddr = address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);//0x55d398326f99059fF775485246999027B3197955   0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684
    ...
    constructor(){
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);//0x10ED43C718714eb63d5aA57B78B54704E256024E   0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    ...
    function _transfer(address _from, address _to, uint256 _value) private returns (bool) {
        ...
        if(DividendList.size() > 0 && USDT.balanceOf(address(this)) >= UsdtDividendPool){
            for(uint256 i; i < DividendList.size() ;i++){
                //uniswapV2Paircontract.balanceOf(DividendList.getKeyAtIndex(i)) / ;
