    ...
    UUPSUpgradeable
{
    ...
    uint256 private totalParticipant;
    ...
    function initialize() external initializer {
        tokenContract = 0x7DD8097f59638eaC315F477816CAD12136Ad3D00;
    ...
    function _payReward(uint256 _value, address _referee) private {
        ...
        if (
            ...
            _payRewardTokens(randomGlobalAddress, rewardValue);
            userReferrerAccount.payReward = true;
            userReferrerAccount.globalId.push(totalParticipant);
            ...
            emit RewardPaid(randomGlobalAddress, _referee, rewardValue);
