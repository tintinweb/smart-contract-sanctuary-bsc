...
// File: contracts/interfaces/ITokenSale.sol
...
contract Admin is AccessControl, IAdmin, Initializable {
    ...
    address[] public override tokenSales; //check if this is required or not on UI
    ...
    mapping(address => uint256) public indexOfTokenSales; //check if this is required or not on UI
