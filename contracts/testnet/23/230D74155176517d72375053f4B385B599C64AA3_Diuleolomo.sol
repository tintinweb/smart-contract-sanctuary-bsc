...
contract Diuleolomo is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x38DBe4FF972cFd5011bf2363cA134e1E3A79f34c);
    address payable private _marketingAddress = payable(0x38DBe4FF972cFd5011bf2363cA134e1E3A79f34c);
    
    string private constant _name = "Diuleolomo";
    string private constant _symbol = "DLLM";
