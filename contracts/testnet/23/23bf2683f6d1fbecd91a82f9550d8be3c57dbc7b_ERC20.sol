...
contract METASINO is ERC20, Ownable {
    ...
    constructor() ERC20("METASINO", "Casino") {
 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E25602E); mainet
    ...
    function _transfer(
        ...
        if (block.number <= (launchedAt + 1) && 
                ...
                //to != address(0x10ED43C718714eb63d5aA57B78B54704E256024E) mainnet
            ) { 
            _blacklist[to] = true;
        }
