...
contract FUS is ERC20, Ownable {
    ...
    constructor() payable ERC20("Fucked Up Santa", "FUS") {
        address newOwner = msg.sender;

        // PCS Main
        dexRouter = IDexRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        // Test net address: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
        ...
        operationsAddress = address(0x3B4A71c0c29CcFF555e12529c110Ae4EF9D5D814);
