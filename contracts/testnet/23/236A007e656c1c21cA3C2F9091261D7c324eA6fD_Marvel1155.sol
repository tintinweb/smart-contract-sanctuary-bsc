...
contract Marvel1155 is ERC1155PresetMinterPauser {
    ...
    uint256 public constant BT = 1;
    //uint256 public constant ERIC = 2;
    //uint256 public constant DANY = 3;
    
    constructor() ERC1155PresetMinterPauser( "https://ipfs.io/ipfs/QmQwHBB8rjekUum27Aq5aqtED73HcGbN2f9YJqYPFM3bTi/1.json") {
        //_mint(msg.sender, CAPTAIN_AMERICA, 10**18, "");
        _mint(msg.sender, BT, 50, "");
        //_mint(msg.sender, ERIC, 5, "");
        //_mint(msg.sender, DANY, 10, "");
    }
