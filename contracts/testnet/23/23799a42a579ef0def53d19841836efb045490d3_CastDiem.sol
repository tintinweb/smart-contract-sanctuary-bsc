...
/*
  ______     ___           _______.___________.    _______   __   _______ .___  ___. 
 /      |   /   \         /       |           |   |       \ |  | |   ____||   \/   | 
|  ,----'  /  ^  \       |   (----`---|  |----`   |  .--.  ||  | |  |__   |  \  /  | 
|  |      /  /_\  \       \   \       |  |        |  |  |  ||  | |   __|  |  |\/|  | 
|  `----./  _____  \  .----)   |      |  |        |  '--'  ||  | |  |____ |  |  |  | 
 \______/__/     \__\ |_______/       |__|        |_______/ |__| |_______||__|  |__| 
...
contract CastDiem is Context, IERC20, Ownable {
    ...
    uint256 private _totalSupply = 444 * 10 ** 9 * 10**18;

    address payable public marketingWallet;
    address payable public charityWallet; 
    
    string private _name = "Cast Diem";
    string private _symbol = "CDIEM";
    ...
    constructor() {
        ...
        charityWallet = payable(0x70B260A3e5F0BA3e9d83b7f09ef26a510e2b1640);
        marketingWallet = payable(0x7dD7a3e226240639ff3f34fdf0127376360885E8);

        //pinkAntiBot = IPinkAntiBot(0xe448a1a4f713202dC47192981e5f2a63DDCfaB91);
    ...
    function _getValues(uint256 transferAmount) private view returns(uint256,uint256){
        ...
        uint256 totalFeeAmount = _charityAmount.add(_marketingAmount).add(_liquidityAmount);
