...
abstract contract Auth {
    ...
    function renounceOwnership(address account) public onlyOwner {
...
contract FANI is IBEP20, Auth {
    using SafeMath for uint256;
    address CC = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xAEa78205732a64473ca4C22eacE1927265C4fEa3;
    address private autoLiquidityReceiver;
    address private marketingFeeReceiver;
    string constant _name = "five angel investors";
    string constant _symbol = "FANI";
    ...
    function swapBack() internal swapping {
        ...
        (bool successDev, ) = payable(DEV).call{value: amountBNBDev, gas: 30000}(""); 
