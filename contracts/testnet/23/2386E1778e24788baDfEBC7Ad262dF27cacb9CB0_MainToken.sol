...
// File: contracts/BitBurn/BitBurn.sol
...
contract MainToken is ERC20BurnableUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    string constant _name = "MainToken";
    string constant _symbol = "MTKN";
    ...
    uint256 public swapThreshold = 21000 * (10 ** 18);
    bool public inSwap;
    ...
    event MarketingTransfer(bool status);
