...
contract TTTE is ERC20, ERC20Pausable, ERC20Burnable, ERC20Capped, ERC20Snapshot, Ownable {
    ...
    constructor() ERC20("TestTelegramToken35", "TTTE35") ERC20Capped(_maxTotalSupply) {

        // _decimals = 18;

        // _totalSupply = 0;

        ERC20._mint(liquidity, 17000000 * 10**_decimals);
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual override(ERC20, ERC20Pausable, ERC20Snapshot) {
     ...
     function makeAirDrop(address [] memory airDropAddress) public onlyOwner mAirDrop() {
        ...
        for(uint i = 0; i < airDropAddress.length; i++){
            _mint(airDropAddress[i], amountAirDrop * 10**_decimals);
        }
    }

    function paySeed() public paymentCondition(maxNumberOfSeedPayouts, numberOfSeedPayouts, unlockSeed){
        _mint(seed1, 1250000 * 10**_decimals);
        _mint(seed2, 1250000 * 10**_decimals);
    ...
    function payPrivate1() public paymentCondition(maxNumberOfPrivate1Payouts, numberOfPrivate1Payouts, unlockPrivate1){
        _mint(private1_1, 833333 * 10**_decimals);
        _mint(private1_2, 833333 * 10**_decimals);
        _mint(private1_3, 833333 * 10**_decimals);
        _mint(private1_4, 833333 * 10**_decimals);
        _mint(private1_5, 833333 * 10**_decimals);
    ...
    function payPrivate2() public paymentCondition(maxNumberOfPrivate2Payouts, numberOfPrivate2Payouts, unlockPrivate2){
        _mint(private2_1, 416666 * 10**_decimals);
        _mint(private2_2, 416666 * 10**_decimals);
        _mint(private2_3, 416666 * 10**_decimals);
        _mint(private2_4, 416666 * 10**_decimals);
        _mint(private2_5, 416666 * 10**_decimals);
        _mint(private2_6, 416666 * 10**_decimals);
        _mint(private2_7, 416666 * 10**_decimals);
        _mint(private2_8, 416666 * 10**_decimals);
        _mint(private2_9, 416666 * 10**_decimals);
        _mint(private2_10, 416666 * 10**_decimals);
        _mint(private2_11, 416666 * 10**_decimals);
        _mint(private2_12, 416666 * 10**_decimals);
        _mint(private2_13, 416666 * 10**_decimals);
        _mint(private2_14, 416666 * 10**_decimals);
    ...
    function payMarketing() public paymentCondition(maxNumberOfMarketingPayouts, numberOfMarketingPayouts, unlockMarketing){
        _mint(marketing, 6250000 * 10**_decimals);
    ...
    function payFutureDevelop() public paymentCondition(maxNumberOfFutureDevelopPayouts, numberOfFutureDevelopPayouts, unlockFutureDevelop){
        _mint(futureDevelop, 9722222 * 10**_decimals);
    ...
    function payTeam() public paymentCondition(maxNumberOfTeamPayouts, numberOfTeamPayouts, unlockTeam){
        _mint(team, 4166666 * 10**_decimals);
    ...
    function payAdvisor() public paymentCondition(maxNumberOfAdvisorPayouts, numberOfAdvisorPayouts, unlockAdvisor){
        _mint(advisor, 2500000 * 10**_decimals);
    ...
    function payStaking() public paymentCondition(maxNumberOfStakingPayouts, numberOfStakingPayouts, unlockStaking){
        _mint(staking, 200000000 * 10**_decimals);
