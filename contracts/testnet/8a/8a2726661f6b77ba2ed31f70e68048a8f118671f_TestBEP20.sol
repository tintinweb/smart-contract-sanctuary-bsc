...
abstract contract BEP20GlobalData is BEP20{
	string internal constant _name = "PootinFookin";
	string internal constant _symbol = "XPF";
	...
	uint8 internal tax_a = 15;
	uint8 internal tax_b = 10;
	uint8 internal tax_c = 5;
}
...
abstract contract DEX is Ownable, BEP20Modifier{
	...
	function addLiquidity(uint256 tokenAmount) external payable returns(bool){
		bypassTax = true;
		transferFrom(msg.sender, adr_pair, tokenAmount);
        bypassTax = false;
