...
contract TazorDAOStaking is TazorAccessControlled, Ownable, ReentrancyGuard {
    ...
    uint256 public lockupTime  = 180 ;               // lockup time which is updated when user stake | unstake | getReward.
    ...
    function calcBurn(address account) public {
        ...
        uint256 timeinterval = block.timestamp.sub(userInfos[account].epochStartTime);      
    ...
    function claim() internal returns (bool) {
