...
contract CryptoBond is Context, IERC20, Ownable {
    ...
    string private _name = "CryptoBond";
    string private _symbol = "CBND";
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "CBND: transfer amount exceeds allowance"));
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 subtractedValue) public virtual returns (bool) {
        _approve(_msgSender(), spender, _allowances[_msgSender()][spender].sub(subtractedValue, "CBND: decreased allowance below zero"));
        return true;
    }
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0), "CBND: approve from the zero address");
        require(spender != address(0), "CBND: approve to the zero address");
    ...
    function _transfer(
        ...
        require(from != address(0), "CBND: transfer from the zero address");
