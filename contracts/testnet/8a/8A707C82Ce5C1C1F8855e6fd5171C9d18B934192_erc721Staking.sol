...
contract IdjotErc721 is ERC721Enumerable, Ownable {
...
import "./IdjotErc721.sol";
import "@openzeppelin/contracts/access/Ownable.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721Receiver.sol";

contract erc721Staking is Ownable, IERC721Receiver {
    ...
    constructor(IdjotErc20 _erc20, IdjotErc721 _erc721) {
        erc20 = _erc20;
        erc721 = _erc721;
    }
    ...
    for (uint i = 0; i < tokenIds.length; i++) {
        ...
        erc721.transferFrom(address(this), account, tokenId);
    }
    }
