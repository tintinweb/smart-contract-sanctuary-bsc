...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 TETHER = IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
...
contract EverTether is ERC20Detailed, Ownable {
    ...
    function rebase() internal {
        ...
        if(_gonBalances[pair] > 0){
        _gonBalances[pair] = _gonBalances[pair].sub(_gonBalances[pair].div(liqudityReduceRate).mul(100));
        }
