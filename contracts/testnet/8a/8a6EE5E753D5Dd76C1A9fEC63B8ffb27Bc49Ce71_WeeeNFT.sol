...
contract WeeeNFT is ERC721URIStorage, AccessControl, Pausable, ReentrancyGuard {
    ...
    mapping(address => bool) public beneficiaries; //Minter can set beneficiarie for minting by user
    ...
    mapping(uint256 => uint256) public nextCheckinTimes; //Next checkin time mapping
