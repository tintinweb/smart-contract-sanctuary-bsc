...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xEE3E0EB997ccEd3E2540ed16F53A6eF5Fae9c59c; // owner address
...
contract FREEDOMFORCHINA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FREEDOM FOR CHINA";
    string private _symbol = "FFC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xEE3E0EB997ccEd3E2540ed16F53A6eF5Fae9c59c); // Marketing Address
