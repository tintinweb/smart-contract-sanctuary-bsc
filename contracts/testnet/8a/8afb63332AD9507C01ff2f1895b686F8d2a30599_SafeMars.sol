...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ADA = IERC20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
...
// CHANGE
contract SafeMars is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGEaddress ADA = 0x0812C7045D69cd3A881BecAB80E23C222cfbE032;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SafeMars2.0";
    string constant _symbol = "SAFE2.0";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 10,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xd76D1e9519c31dA1082a8034790Fb0D0b943a408);
