...
contract ION is ERC20, AccessControl{
   ...
   function marketcap() public returns (uint256) {
       marketCap=getTokenPrice()*totalSupply();
       return marketCap;
   }
    ...
    function getTokenPrice() public view returns (uint256){
        ...
        console.log("balance2",balanceOf(address(this)));

            path[0] = address(this);
            path[1] = uniswapV2Router.WETH();
        uint256 tokenPrice = uniswapV2Router.getAmountsOut(balanceOf(address(this)),path)[1];
