...
contract GSwap is Ownable {
    ...
    function migrate() public {
        ...
        bool success = IBEP20(V1).transferFrom(account, address(this), amount);
        require(success, "Failed to migrate v1");

        _receivedV1Token[account] = amount;

        success = IBEP20(V2).transferFrom(V2Treasury, account, v2Amount);
        require(success, "Failed to transfer v2");

        _sentV2Token[account] = amount;
