...
contract ZBSTOKEN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
    ) payable ERC20("ZBS","ZBS")  {
        // test
        rewardToken = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;
        // pro
        //rewardToken = 0x55d398326f99059fF775485246999027B3197955;
        _marketingWalletAddress = payable(0x255d71fC06c907eEE8eF3Ce866f45E5ea5907f2b);
        _lpWalletAddress=payable(0xA1694B395247B03e785F14A216f2B3AD11246458);
    ...
    function swapManual() public onlyOwner {
        ...
        if(AmountTokenRewardsFee > 0) swapAndAddReward(AmountTokenRewardsFee);
    ...
    function swapAndAddReward(uint256 tokens) private{
        swapTokensForCake(tokens);
        uint256 uValue = IERC20(rewardToken).balanceOf(address(this));
        IERC20(rewardToken).transfer(_tokenRewardWalletAddress, uValue);
