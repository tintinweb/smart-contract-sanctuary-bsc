...
interface IPOLYCONTRACTRING {
    ...
    function crossCallDirectReferralCheck(address user) external view returns (uint);
}
...
contract VaraGoldRingContract is IPOLYCONTRACTRING {
    ...
    uint public rewardRing1 = 10000000;
    uint public rewardRing2 = 45000000;
    uint public rewardRing3 = 45000000;
    uint public rewardRing4 = 225000000;
    uint public rewardRing5 = 225000000;
    uint public rewardRing6 = 1125000000;
    uint public rewardRing7 = 1125000000;
    uint public rewardRing8 = 1125000000;
    uint public rewardRing9 = 5625000000;
    uint public rewardRing10 = 100000000000;
    ...
    constructor() public {
      ...
      maincontract=IPOLYCONTRACTMAIN(0x09821685FB807EbBcD34bEaaa8eC158Ff5dEB7fe);
    ...
    //Get No of Direct For Cross Ring
    function crossCallDirectReferralCheck(address user) public view override returns (uint) {
      uint noofdirect=maincontract.getTotalDirect(user);
      return noofdirect;
    }
