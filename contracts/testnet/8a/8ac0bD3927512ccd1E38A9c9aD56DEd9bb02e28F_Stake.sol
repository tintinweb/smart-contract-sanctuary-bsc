...
contract Stake is Context, Ownable,ReentrancyGuard {
    ...
    // mapping(address=>uint[5]) getUserStakeList;
    ...
    function getStakeDataLP(address _user)public view returns(uint,uint,uint,bool,uint) {
        return (lpRequire,allStakedAmountLP,mainPairC.balanceOf(_user),isLpStaker[_user],lpStakeAmount[_user]);
    }
    ...
    function setData(address _fmtAddress,address _mainPair,address _managerAddr,uint _computeCycle)public onlyOwner{
    ...
    function withdrawLpStaked()public nonReentrant{
        ...
        require(block.timestamp-lpStakeTime[_sender]>=31536000);
    ...
    function withdrawStaked(uint8 _num) public nonReentrant {
        ...
        FMT.basicTransfer(address(this),_sender,_principal);
