...
contract FarmContract is ERC20, Ownable{
    ...
    address public mainToken;//主质押代币
    uint256 public lockApy = 132;//锁定日利率1.32% 1.32*365=481.8
    uint256 public Apy = 2;//普通日利率 0.02 年利率 0.02*365=7.3
    uint256 public totalStaking;//当前总质押
    uint256 public totalReceives;//总已领取奖励
    ...
    struct FarmInfo{
        string farmName;//矿名
        string farmSymbol;//别称
        uint256 rebates;//返佣率
        uint256 rebatesLevel;//返佣级别
        address mainToken;//主质押代币
        uint256 lockApy;//锁定日利率1.32% 1.32*365=481.8
        uint256 Apy;//普通日利率 0.02 年利率 0.02*365=7.3
    ...
    function getFarmInfo()
        public
        view
        returns (FarmInfo memory info)
    {
        info = FarmInfo(_name,_symbol,rebates,
        rebatesLevel,
        mainToken,
        lockApy,
        Apy,
