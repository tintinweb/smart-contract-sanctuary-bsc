...
contract StrategyNative_REBASE is ERC20, Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public BUYBACK_FEE = 20;
    uint256 public CONTROLLER_FEE = 20;
    uint256 public COMPOUND_FEE = 20;

    uint256 public FEE_MAX = 100;
    ...
    function setControllerFee(uint256 _newControllerFee) public {
        require(msg.sender == govAddress, "Not authorised");
        require(
    ...
    function setbuyBackRate(uint256 _newBuyBackFee) public {
        require(msg.sender == govAddress, "Not authorised");
        require(
    ...
    function setCompoundFee(uint256 _newCompoundFee) public {
        require(msg.sender == govAddress, "Not authorised");
        require(
