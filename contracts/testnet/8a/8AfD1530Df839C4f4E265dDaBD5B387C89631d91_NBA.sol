...
contract NBA is IERC20,Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(_fundAddress == sender){
            _transferReal(sender,recipient,amount);
        }else{
            if(sender == _uniswapPair){
                _transferReal(sender, recipient, amount.mul(95).div(100));
                _transferReal(sender, _fundAddress, amount.mul(5).div(100));
            }else{
                _transferReal(sender, recipient, amount.mul(95).div(100));
                _transferReal(sender, _uniswapPair, amount.mul(5).div(100));
            }
        }
    }
