...
contract OG_Token is Context, IERC20, Ownable {
    ...
    address[9] private wallets;     // wallets
    ...
    // Future Burn Wallet 0x6948E7B59968221B30CeC65c70F57c8E196554f4                        -  25%
    // Team Wallet 0x3e694F10537C8C918E5D543E6012d0d4c9Ee959d                               -  10%
    // Marketing Wallet 0x723d6d58aA27E822fF6dfbAe66B35d96F7821A32                          -  7%
    // Development Wallet 0x82a5f714446c1c9745a5a92DeA5e2978fa1F0A9D                        -  5%
    // Investors & Partnerships Wallet 0xED5B91452729a818254f5C86981bF5De64852Ca6           -  10%
    // Launch on PANCAKESWAP 0xBDAF27BFB4E89449bf0aae5eAa3A70f275aEc9e7                     -  10%
    // Exchanges Wallet 0x7fFf840D4f4daeef103907640dd0D0EF5BE4560d                          -  16%
    // Presale Wallet for Launchpad UNICRYPT 0xfF4ce78737Db09Ddd0BEc6Dd97Bf29E31a36815d     -  15.04%
    // Private Sale Wallet (already collected) 0xc425438ABD4cF1eC211818e8b76737B61d7a8920   -  1.96%
    // Buyback Wallet 0x2eF6EFe374D4C11ED4cBe86e7beF576295d87956
    
    constructor (address _BUSD)  {

        wallets = [0x6948E7B59968221B30CeC65c70F57c8E196554f4,0x3e694F10537C8C918E5D543E6012d0d4c9Ee959d,0x723d6d58aA27E822fF6dfbAe66B35d96F7821A32,
            0x82a5f714446c1c9745a5a92DeA5e2978fa1F0A9D,0xED5B91452729a818254f5C86981bF5De64852Ca6,0xBDAF27BFB4E89449bf0aae5eAa3A70f275aEc9e7,
            0x7fFf840D4f4daeef103907640dd0D0EF5BE4560d, 0xfF4ce78737Db09Ddd0BEc6Dd97Bf29E31a36815d, 0xc425438ABD4cF1eC211818e8b76737B61d7a8920];

        for(uint i = 0; i < wallets.length; i++){
            require(wallets[i] != address(0x0),"Invalid wallet address");
        }
        BUSD = _BUSD;
        teamWallet = wallets[1];
        marketingWallet = wallets[2];
        developmentWallet = wallets[3];
        buybackWallet = 0x2eF6EFe374D4C11ED4cBe86e7beF576295d87956;
    ...
    function initialize() internal {
        ...
        _rOwned[wallets[0]] = (_tTotal*25/100)*currentRate;
        _rOwned[wallets[1]] = (_tTotal*10/100)*currentRate;
        _rOwned[wallets[2]] = (_tTotal*7/100)*currentRate;
        _rOwned[wallets[3]] = (_tTotal*5/100)*currentRate;
        _rOwned[wallets[4]] = (_tTotal*10/100)*currentRate;
        _rOwned[wallets[5]] = (_tTotal*10/100)*currentRate;
        _rOwned[wallets[6]] = (_tTotal*16/100)*currentRate;
        _rOwned[wallets[7]] = (_tTotal*1504/10000)*currentRate;
        _rOwned[wallets[8]] = (_tTotal*196/10000)*currentRate;
        
      for(uint i = 0; i < wallets.length; i++){
            excludeFromReflection(wallets[i]);
        }
    ...
    function setSellFeePercent(uint256[5] calldata _fees) external onlyOwner() {
        ...
        _buybackFee = _fees[4];
        totalSellFee =  _fees[1] + _fees[2] + _fees[3] + _fees[4];
    ...
    function setBuyFeePercentage(uint256[5] calldata _fees) external onlyOwner() {
        ...
        _teamFee = _fees[0];
        _marketFee = _fees[0];
        _developmentFee = _fees[0];
        _buybackFee = _fees[0];

        totalBuyFee =  _fees[1] + _fees[2] + _fees[3] + _fees[4];
    ...
    function sentToWallets(uint256 totalBUSD) private {
        ...
        uint256 developmentShare = totalBUSD.mul(_developmentFee.add(_sellDevelopmentFee)).div(totalBuyFee.add(totalSellFee));
