...
import './int/IUniswapV2Pair.sol';
import './int/IUniswapV2Factory.sol';
...
contract Pricer {
    ...
    */
    ...
    function getRatio(address tokenIn, uint amountIn, address tokenOut, address router) public view returns(uint ratio){ //SHOULD WORK
    ...
    function getAmtsOut(uint amountIn, address token0, address token1, address router) public view returns(uint amoutOut){ //WORKS
        IUniswapV2Router02 Router = IUniswapV2Router02(router);
    ...
    function getLpTokensAmount(address lp, uint amountLp) public view returns ( uint amountA, uint amountB){
