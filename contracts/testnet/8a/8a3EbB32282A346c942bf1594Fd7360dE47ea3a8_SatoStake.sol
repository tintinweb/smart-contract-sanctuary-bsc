...
contract SatoStake is Context, Ownable, ReentrancyGuard {
    ...
    constructor(address _dev, address _dev1) {
        ...
        tokenAdress = 0x6ce8dA28E2f864420840cF74474eFf5fD80E65B8; //testnet BTCB
        //tokenAdress = 0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c; mainnett BTCB
    ...
    function claimDailyRewards() public noReentrant{
        ...
        uint256 claimTimeStart = block.timestamp;
        uint256 claimTimeEnd = block.timestamp + 0 days;
