...
contract INFINITYLOTTO2 is IBEP20, Auth {
    ...
    constructor (address _router) Auth(msg.sender) {
        ...
        teamDivWallets[0] = 0x1A6891c4C91787E7e21611f9e94aF2A55fbD56F8;
        teamDivWallets[1] = 0xEdc13e391D5CA5d8B9d788d8B401863C81135Bf4;
        teamDivWallets[2] = 0xb69e48FF665249cF00a30C813D15C8Ef5eAE08cD;
        teamDivWallets[3] = 0xdC02164AA8a73a688ae54eBfCbf19C82aE727bF2;
    ...
    function removeTeamDivWallet(address oldTeamDivWallet) external onlyOwner {
        ...
        teamDivWallets[r] = teamDivWallets[l-1];
        teamDivWallets.pop();
