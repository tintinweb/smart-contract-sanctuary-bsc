...
contract Test is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmountBuy                  = 100000000 * 10**_decimals;
    uint256 public _maxTxAmountSell                 = 100000000 * 10**_decimals;
    uint256 public _numTokensSellToAndTransfer      = 20000 * 10**_decimals;
    uint256 public _maxTokensPerAddress             = 100000000 * 10**_decimals;
