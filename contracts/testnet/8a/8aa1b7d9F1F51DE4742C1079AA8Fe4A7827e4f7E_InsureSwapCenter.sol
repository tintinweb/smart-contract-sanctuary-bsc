...
contract InsureSwapCenter is Ownable {
    ...
    function swap(uint256 amount) public {
        require(isSwapEnable == true,'swap disable');
    ...
    function updateSwapToken(address addr) public onlyAdminer {
     ...
     function updateSwapTokenLeftToChange(uint256 amount) public onlyAdminer {
        swapTokenLeftToChange = amount;
    }
