    ...
    Details
{
    ...
    function swapTokensForETH() private {
        ...
        address[] memory linkWETHPath = new address[](2);
        linkWETHPath[0] = uniswapRouter.WETH();
        linkWETHPath[1] = linkTokenAddress;

        TOKEN.approve(address(uniswapRouter), LINKToSubscription);

        uniswapRouter.swapTokensForExactETH(
            uniswapRouter.getAmountsIn(LINKToSubscription, linkWETHPath)[0],
