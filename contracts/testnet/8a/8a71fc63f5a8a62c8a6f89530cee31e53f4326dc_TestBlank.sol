...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6CF86e89Ac099b0dC0AA350020d9786d11689EcE; // owner address
...
contract TestBlank is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TestBlank";
    string private _symbol = "TMO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6CF86e89Ac099b0dC0AA350020d9786d11689EcE); // Marketing Address
    address payable public teamWalletAddress = payable(0x6CF86e89Ac099b0dC0AA350020d9786d11689EcE); // Team Address
    ...
    uint256 private _totalSupply = 1000000000000000000000 * 10**_decimals;
    uint256 public _maxTxAmount = 30000000000000000000 * 10**_decimals; 
    uint256 public _walletMax = 30000000000000000000 * 10**_decimals;
