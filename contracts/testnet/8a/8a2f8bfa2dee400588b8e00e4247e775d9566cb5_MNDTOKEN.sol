...
contract MNDTOKEN is Context, IERC20, Ownable {
  ...
  address public daoAddress=0x4f0B0Dc6058aF6C1Dc03feb36881256E22bE11D7;
  address public nodeAddress=0x0EFd5bB7c0d8c538B08bA130f2f9C2D5Fde47fA0;
  address public foundationAddress=0x49f61e12FA4eAcc29ea2a5227B7c2e832a956D11;
  constructor() {
    name = "MND TOKEN";
    symbol = "MNDs";
    decimals = 18;
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(autoBurn){
        ...
        if(totalSupply<=5000*10e18){
            autoBurn=false;
        }
    }else{
        uint256 fee=amount.div(100);
        baseTransfer(sender, foundationAddress, fee);
        baseTransfer(sender, daoAddress, fee);
        baseTransfer(sender, nodeAddress, fee);
    }
