...
contract LUNAFREEToken is BEP20Detailed, BEP20 {
    ...
    constructor() BEP20Detailed("LUNA Free Union Token", "LUNAFREE", 18) {
        ...
        transferTax = 4;
        tradeCooldown = 15;
        marketingPool = 0x0Be6a730dd7A12EeaB7312d03255E2b4691d2122;
    }
    ...
    function _transfer(
        ...
        } else if (sender == marketingPool || receiver == marketingPool) {
            taxAmount = 0;
        } else {
