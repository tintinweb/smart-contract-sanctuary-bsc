...
contract NFTLaunchPad is Initializable, OwnableUpgradeable {
    ...
    function initialize(uint256 _brokerage, address _brokerAddress)
        public
        initializer
    {
        __Ownable_init();
    ...
    function setBrokerage(address newBrokerAddress) external onlyOwner {
...
//     },
//   });
//   contract = await contractFactory.deploy(blacklist.address);
...
contract NFTCollection is ERC721A, ERC2981, Ownable {
    ...
    function verifyWhiteListUser(
        ...
        bytes32 hash = keccak256(abi.encodePacked(whitelistUser, nonce));
