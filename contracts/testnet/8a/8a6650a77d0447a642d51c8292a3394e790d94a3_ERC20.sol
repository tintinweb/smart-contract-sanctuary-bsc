...
contract token is ERC20{
    ...
    constructor() ERC20("KAMIL_AZMI", "KAR", 9 ){
    ...
    function burning(uint256 Token)public {
        require(owner() == msg.sender,"Error: User is not the Owner");
        _burn(msg.sender, Token);
    }

    // function transfer(address User,uint256 Token)public{
    //     _transfer(msg.sender, User, Token);
