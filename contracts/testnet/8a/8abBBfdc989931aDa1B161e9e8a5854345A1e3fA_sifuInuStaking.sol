...
contract sifuInuStaking is Ownable, ReentrancyGuard{
 ...
 //   STORE DATA
    ...
    function getStakerInfo(uint _id)public view returns(uint, address,uint,uint,bool,bool) {
        Invest storage stakerInvestment = isInvested[_id];
        return(stakerInvestment.id,stakerInvestment.owner,stakerInvestment.amountTokenInvested,stakerInvestment.releaseDate,stakerInvestment.releaseStatus,stakerInvestment.lock);
