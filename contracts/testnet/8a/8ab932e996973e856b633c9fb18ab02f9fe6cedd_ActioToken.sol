...
contract ActioToken is Context, Ownable, IERC20, IERC20Metadata
{
    ...
    string private _name = "Actio82"; // testnet
    //string private _name = "Actio";  

    string private _symbol = "AIO82"; // testnet
    ...
    constructor() {
        ...
        // sambungkan dengan tax collector
        setTaxCollector(0xD98912d937a4Ce2dcE04A0500848D4ed4AFe15F5);
    }
    ...
    function _transfer(
        ...
        require(senderBalance >= amount, "AIOC20: transfer amount exceeds balance");
    ...
    function _transferTax(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!_excludedSellFee[sender]) {
            ...
            if (_excludedSellFee[sender] || _excludedBuyFee[recipient] || _excludedSellFee[recipient] || _excludedBuyFee[sender]){
         // normal transfer
