...
contract LIQUIDEZ_1 is IERC20 {
    ...
    string private constant _name = "LIQUIDEZ_1";
    string private constant _symbol = "LIQUIDEZ_1";
    ...
    function setMaxTxAmountBuy(uint256 amountPercent) external onlyOwner {
        _maxTxAmountBuy = (_tTotal * amountPercent) / 100;
    }
