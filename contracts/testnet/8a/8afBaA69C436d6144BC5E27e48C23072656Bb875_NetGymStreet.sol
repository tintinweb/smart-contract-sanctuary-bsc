...
contract NetGymStreet is INetGymStreet, OwnableUpgradeable {
    ...
    address public brokerBuildingNftAddress;
    address public minerBuildingNftAddress;
    ...
    function setBrokerAddress(address _contract) external onlyOwner {
        brokerBuildingNftAddress = _contract;
    }

    function setMinerAddress(address _contract) external onlyOwner {
        minerBuildingNftAddress = _contract;
    }
    ...
    function hasNFT(address _user) private view returns (bool) {
        return (IERC721Base(standardParcelAddress).balanceOf(_user) != 0 ||
            ...
            IERC721Base(brokerBuildingNftAddress).balanceOf(_user) != 0 ||
            IERC721Base(minerBuildingNftAddress).balanceOf(_user) != 0);
    }
    ...
    function checkPurchaseDate(address _user) private view returns (bool) {
        ...
        contracts[2] = brokerBuildingNftAddress;
        contracts[3] = minerBuildingNftAddress;
