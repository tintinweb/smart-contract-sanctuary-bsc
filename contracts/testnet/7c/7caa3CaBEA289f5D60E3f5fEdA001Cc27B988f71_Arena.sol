...
contract Arena is Ownable{
    constructor() {
        initArRewardSet();
        arenaOpneTime = block.timestamp + cycleTime;
        weekOpneTime = block.timestamp + cycleTime;
    }
    ...
    // uint256 public cycleTime = 7 * 86400 ; // 周期时间
    uint256 public cycleTime = 1600 ; // 周期时间
    ...
    function openWeeklyTasks() public onlyOwner{
        ...
        weekRound +=1;
        weekOpneTime = weekOpneTime+cycleTime;
    }
    ...
    function upArenaTime() public onlyOwner{
        arenaOpneTime = arenaOpneTime+cycleTime;
