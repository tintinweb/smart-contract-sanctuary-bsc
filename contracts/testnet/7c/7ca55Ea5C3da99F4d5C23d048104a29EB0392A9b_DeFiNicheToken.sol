...
contract DeFiNicheToken {
    ...
    /* This event is always fired on a successful call of the transfer, transferFrom, mint, and burn
    methods */
    ...
    constructor() {
        name = "DeFiNiche";                   // Sets the name of the token, i.e "Ether
        symbol = "DFN";                       // Sets the symbol of the token, ie. ETH
        ...
        /* Whenever tokens are created, burnt, or transferred, the Transfer event is fired */
    ...
    function burn(uint256 _amount) public returns (bool success) {
        ...
        require(accountBalance > _amount, "Burn amount exceed balance");
