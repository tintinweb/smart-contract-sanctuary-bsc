...
contract BoardGame is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("Board Game", "BOARD") {
        ...
        swapTokensAtAmount = totalSupply() / 10_000; // 0.01% of Total Supply
    ...
    function changeTeamWallet1(address _teamWallet) external onlyOwner {
        address oldTeamWallet = _teamWallet;
        ...
        emit teamWalletChanged(oldTeamWallet, _teamWallet);
    }
    ...
    function _swapBack(uint256 tokenAmount) internal {
        ...
        if (team2Shares > 0) {
            sendBNB(teamWallet2, team2Shares);
        }
