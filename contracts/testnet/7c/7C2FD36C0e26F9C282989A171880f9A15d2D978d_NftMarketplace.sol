...
contract NftMarketplace is ReentrancyGuard {
    ...
    address public constant nftAddress = 0xe349542E03B07af54E17322c253336DE1df402c2;
    ...
    function getAllOnSale () public view virtual returns( Listing[] memory ) {
        Listing[] memory tokensOnSale = new Listing[](IERC721Enumerable(nftAddress).totalSupply());
        for(uint i = 0; i < IERC721Enumerable(nftAddress).totalSupply() -1; i++) {
            if(s_listings[i].price > 0) {
                tokensOnSale[i] = s_listings[i];
            }
        }
        return tokensOnSale;
    }
