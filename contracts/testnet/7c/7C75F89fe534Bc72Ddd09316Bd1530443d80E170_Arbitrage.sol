...
contract ProtocolFeesCollector is Authentication, ReentrancyGuard {
    ...
    constructor(IVault _vault) internal
...
contract Arbitrage is Ownable {
  ...
  modifier startEnable {
      require(_startEnable, "First you must call startArbitrage.");
      _;
  }
  ...
  function startArbitrage(
    ...
    IERC20(inputToken).transferFrom(msg.sender, address(this), inputTokenAmount);
    IERC20(inputToken).approve(_pcsRouter, inputTokenAmount);

    IPancakeRouter02(_pcsRouter).swapExactTokensForTokens(
      inputTokenAmount,
      0,
      path,
      address(this),
