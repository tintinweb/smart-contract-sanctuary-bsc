...
contract FurFiStabilityPool is BaseContract, FurFiLiquityBase, IFurFiStabilityPool {

    using SafeMath for uint;
    using LiquitySafeMath128 for uint128;
    using SafeERC20Upgradeable for IERC20Upgradeable;

    IFurFiBorrowerOperations public borrowerOperations;
    ...
    */
    ...
    function setAddresses(
        ...
        onlyOwner
    {
        borrowerOperations = IFurFiBorrowerOperations(_borrowerOperationsAddress);
