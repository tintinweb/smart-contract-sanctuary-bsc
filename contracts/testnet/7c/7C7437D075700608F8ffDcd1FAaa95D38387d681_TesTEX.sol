...
contract TesTEX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TesTEX";
    //change the token symbol
    string constant _symbol = "TesTEX";
    //dont change that
    uint8 constant _decimals = 8;

    //defines the total supply --> 100 = 100e8 <-- THE e8 HAS TO BE THERE
    uint256 _totalSupply = 1_000_000_000_000e8;

    //10% of all token can be bought with one transaction
    uint256 public _maxTxAmount = _totalSupply * 5 / 100;

    //one wallet can only hold 10% of all token
    ...
    address public marketingFeeReceiver = 0x25197a9a9f5942088E1ED1C3B192529fa185c035;
