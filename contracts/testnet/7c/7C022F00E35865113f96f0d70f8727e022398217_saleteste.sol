...
contract saleteste is IBEP20, ReentrancyGuard, ERC721Holder, Context, Ownable {
    ...
    uint256 public emitStake = (10 * 10 ** _decimals) / 25 days; // EMISSION_RATE
    uint256 public emitStake2 = (15 * 10 ** _decimals) / 35 days; // tier 2
    uint256 public emitStake3 = (25 * 10 ** _decimals) / 50 days; // tier 3
    uint256 public emitStake4 = (70 * 10 ** _decimals) / 30 days; // tier 4

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    // NFT staking
    mapping(uint256 => address) public nftOwner; // tokenOwnerOf
    mapping(uint256 => address) public nftOwner2;
    mapping(uint256 => address) public nftOwner3;
    mapping(uint256 => address) public nftOwner4;

    mapping(address => uint256) public tokenCheck1; // tokenSla1
    ...
    mapping(address => bool) public claimedStake1; // staked1
    ...
    mapping(uint256 => uint256) public stakePool; // token StakedAt
    ...
    function unstake(uint256 tokenId, uint256 pool) external {
        ...
        if (pool == 1) {
            ...
            require(claimedStake1[msg.sender] != false, "You already claim your tokens");
            ...
            require(claimedStake2[msg.sender] != false, "You already claim your tokens");
            ...
            require(claimedStake3[msg.sender] != false, "You already claim your tokens");
            ...
            require(claimedStake4[msg.sender] != false, "You already claim your tokens");
