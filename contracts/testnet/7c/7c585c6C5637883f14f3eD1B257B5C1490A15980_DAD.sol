...
contract DAD is ERC20, Ownable, ERC20Burnable {
    uint256 private constant totalSupply_ = 100000000 * 1e8;
    ...
    address private router = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // Todo: Update Router Pancake
    ...
    constructor() ERC20("Diamond Alpha Token", "DAD") {
        ...
        // uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            // .createPair(address(this), _uniswapV2Router.WETH()); // Todo: Update WBNB
