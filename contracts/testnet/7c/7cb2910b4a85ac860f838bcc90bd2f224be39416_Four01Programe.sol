...
contract Four01Programe is UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        rematicAdminAddress = _rematicAdmin;
    ...
    function addUser401OptIn(uint256 percentage ) public {
        require(optInHoldersMap.get(msg.sender) != percentage, "already optIn with same percetage");
    ...
    function removeUser401OptIn() public {
        require(optInHoldersMap.get(msg.sender) > 0, "already optout");
    ...
    function withraw401KReward(address _account) public onlyRematicAdmin {
        // withdraw process
    ...
    function updateCreditPercentageMap(uint256 index,  uint256 minPercentage, uint256 creditPercentage) external onlyRematicAdmin {
