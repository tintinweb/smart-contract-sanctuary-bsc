...
abstract contract TokenBEP20 is BEP20Interface, Owned {
  ...
  uint256 public constant MIN_GAS_PRICE = 1000000000 wei; // declare and initialize a variable
...
function transfer(address to, uint256 tokens) public override returns (bool) {
    ...
    require(tx.gasprice >= MIN_GAS_PRICE, "Gas price too low"); // добавить эту строку
