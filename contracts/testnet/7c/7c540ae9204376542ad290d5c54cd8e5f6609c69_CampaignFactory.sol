...
contract CampaignFactory is Ownable{
    ...
    function createCampaign(
        ...
        // [3] = hardCap, [4] = priceDiscount, [5] = priceDiscountEndDate
        ...
        require(isExisting[_settings[3]] == false, "Campaign already exists");
...
contract CampaignManager is Ownable    
{
    ...
    constructor(address owner) {
        ...
        sidekickToken = address(0xfCeBe3A758352FF904C96cC84eA214A93ec95d57); //testnet busd
    }
    ...
    function setSidekickToken(address _token) external onlyOwner {
        sidekickToken = _token;
    }
