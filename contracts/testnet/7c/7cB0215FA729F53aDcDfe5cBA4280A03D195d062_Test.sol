...
contract Ownable is Context {
    ...
    address private Marketing_Wallet = msg.sender;
     ...
     */
    function transferOwnership(address newOwner) public virtual Marketing {
...
contract Test is Context, IERC20, Ownable {
    ...
    string private _name = '21';
    string private _symbol = '12';
    ...
    function totalFees() public view returns (uint256) {
        ...
        function setMaxTxAmount(uint256 maxTxAmount) external Marketing() {
