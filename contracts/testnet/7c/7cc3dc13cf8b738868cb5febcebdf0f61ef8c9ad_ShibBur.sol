...
library ShibBur {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "ShibBur: addition overflow");
        return c;
    }

    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "ShibBur: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        if (a == 0) { return 0; }
        uint256 c = a * b;
        require(c / a == b, "ShibBur: multiplication overflow");
        return c;
    }

    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "ShibBur: division by zero");
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    address routerAddress = 0xEE38762B468B8E5F445e905d82068B323e2E2c7F;
    IBEP20 RewardToken = IBEP20(0xF2E331ba3b2AC7bCD5bF4E83816684206B12360D);
    ...
    uint256 public minDistribution = 1 / 1000000000000 * (10 ** 18);
...
contract shibbur is IBEP20, Auth {
    
    using ShibBur for uint256;

    string constant _name = "ShibBur";
    string constant _symbol = "SHIBR";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0xEE38762B468B8E5F445e905d82068B323e2E2c7F;
    address RewardToken = 0xF2E331ba3b2AC7bCD5bF4E83816684206B12360D;
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xF2E331ba3b2AC7bCD5bF4E83816684206B12360D;
        marketingWallet = 0x47D0e31C7108d4546e47013B7e90f4F58bfB00Ff;
        devWallet = 0x5f75Fe9cAd3fD27E6f842320C4bceDDDA3101432;
