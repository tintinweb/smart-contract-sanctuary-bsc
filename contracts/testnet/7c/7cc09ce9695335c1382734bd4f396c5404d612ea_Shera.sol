...
contract Shera is IERC20 {
    ...
    uint256 constant private startingSupply = 2_000_000_000_000;

    string constant private _name = "Shera";
    string constant private _symbol = "SHR";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        treasury: payable(0xE1D2cBd9b9A5A4C7064Ea5Ef05adbD4D9677E727)
        });
    ...
    constructor () payable {
        ...
        _basicTransfer(_owner, DEAD, (_tTotal * 0) / 100);
    }
