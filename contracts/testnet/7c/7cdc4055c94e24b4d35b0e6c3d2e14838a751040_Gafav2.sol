...
/*
    ...
    Contract Name: Gafav2
    Instagram: https://www.instagram.com/gafacoin
    Twitter: https://twitter.com/gafaexperience
    Telegram: https://t.me/gafalinks
...
contract Gafav2 is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress =
        payable(0x96e59516fDd189E552339bEB24687c18b1c0183a); // Marketing Wallet Address
    address payable public gafalaWalletAddress =
        payable(0x88640d01e699eFC01083796EBb987306877CE4c8); // gafala Wallet Address
    ...
    string private constant _name = "gafa";
    string private constant _symbol = "GAFA";
    ...
    uint256 public totalSwapableFee =
        _liquidityFee + _marketingFee + _gafalaFee;

    uint256 public contractCurrentBalance = balanceOf(address(this));
    uint256 public liquidityTokensCollected = 0;
    uint256 public marketingTokensCollected = 0;
    uint256 public gafalaTokensCollected = 0;
    ...
    function swapAndLiquify() public lockTheSwap {
        ...
        uint256 walletsTotal = marketingTokensCollected + gafalaTokensCollected;

        uint256 ethForMarketing = (newBalance * marketingTokensCollected) /
            walletsTotal;
        uint256 ethForgafala = (newBalance * gafalaTokensCollected) /
            walletsTotal;

        transferToAddressETH(marketingWalletAddress, ethForMarketing);
        transferToAddressETH(gafalaWalletAddress, ethForgafala);

        liquidityTokensCollected = 0;
        marketingTokensCollected = 0;
        gafalaTokensCollected = 0;
    }
    ...
    function countUpFeeShare(uint256 amount) private {
        ...
        gafalaTokensCollected += (amount * _gafalaFee) / 100;
    }
    ...
    function restoreAllFee() private {
        ...
        totalSwapableFee = _liquidityFee + _marketingFee + _gafalaFee;
    }
    ...
    function setgafalaWalletAddress(address _gafalaWallet) external onlyOwner {
        require(_gafalaWallet != address(0), "setgafalaWalletAddress: ZERO");
        gafalaWalletAddress = payable(_gafalaWallet);
        emit AuditLog("We have Updated the gafalaWallet:", gafalaWalletAddress);
    }
