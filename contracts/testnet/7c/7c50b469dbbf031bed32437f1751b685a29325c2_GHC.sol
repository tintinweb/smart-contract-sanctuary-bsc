...
contract GHC is IBEP20, Ownable {
    ...
    string private _name = "Galaxy Heroes";
    string private _symbol = "GHC";
    uint8 private _decimals = 18;
    uint256 private _tTotal = 700000000000000 * 10**_decimals;

    uint256 public _marketFee = 5;
    uint256 private _previousMarketFee = _marketFee;

    IUniswapV2Router public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    address public _market = 0x0dAC62360961544132a1283205501f3FcDC9817c;
    ...
    function _tokenTransfer(
        ...
        uint256 tTransferAmount = amount.sub(tMarket);
