...
contract AeternaLottery is ReentrancyGuard, IAeternaLottery, Ownable {
        ...
        nonReentrant
    {
        ...
        if(tokenBalance > 0)
            require(msg.value >= _ticketNumbers.length * minPriceTicket * multiplier, "Insufficient funds for tickets.");
        else
            require(msg.value >= _ticketNumbers.length * 2 * minPriceTicket * multiplier, "Insufficient funds for tickets.");
