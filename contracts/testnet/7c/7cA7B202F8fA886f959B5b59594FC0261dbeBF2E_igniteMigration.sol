...
contract igniteMigration is Ownable{
    IERC20 public tokenToMigrateAddress = IERC20(0x358B82F302b71cd65d485D320C9EA921B6dAb741); 
    IERC20 public newToken = IERC20(0x43E4855828D0fE2942f210C693e18B5107989371);
    ...
    function returnCurrentTokenBalance()public view returns(uint256){
        return tokenToMigrateAddress.balanceOf(address(this));
    }
