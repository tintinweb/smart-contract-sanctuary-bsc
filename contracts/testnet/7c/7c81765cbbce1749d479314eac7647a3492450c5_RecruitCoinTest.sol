...
contract RecruitCoinTest is ERC20, Ownable, ReentrancyGuard {
        ...
        onlyIfVestingScheduleNotRevoked(vestingScheduleId)
    {
        ...
        uint256 amount = computeReleasableAmount(vestingSchedule); //0.000018148148148148147 
        ...
        returns (uint256)
    {
        ...
        if (
            ...
            uint256 timeFromStart = currentTime.sub(vestingSchedule.start); // 1663938548//1663938848 - 1663937959 == 589
            uint256 secondsPerSlice = vestingSchedule.slicePeriodSeconds;   //300 
            uint256 vestedSlicePeriods = (timeFromStart.div(secondsPerSlice)).div(2); //589 / 300 = 1.96
            uint256 vestedSeconds = vestedSlicePeriods.mul(secondsPerSlice);    // 1.96 * 300 == 0.006533333333333333
