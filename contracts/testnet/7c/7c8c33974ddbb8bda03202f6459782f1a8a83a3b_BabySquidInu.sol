...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  CAKE = IBEP20(0x0B7d18a8237f06722A212bfD3FEE138b139b5968);
...
/* Token contract */
contract BabySquidInu is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address CAKE = 0x0B7d18a8237f06722A212bfD3FEE138b139b5968; 
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x87Ba8971E6117C4864352b9af1ebdEC27F1C1899; 
    ...
    // Name and symbol
    string constant _name = "Baby Squid Inu";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 10000 / 1000; 
    uint256 public _maxSellTxAmount = _totalSupply * 10000 / 10000; 
    uint256 public _maxWalletToken = ( _totalSupply * 10000 ) / 1000; 
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x87Ba8971E6117C4864352b9af1ebdEC27F1C1899;  
