...
*    ___  / / /______ _______ ___ ___(_)_____ __ |     / /______ _________________       
*    __  /_/ / _  __ \__  __ `__ \__  / _  _ \__ | /| / / _  __ `/__  ___/__  ___/       
*    _  __  /  / /_/ /_  / / / / /_  /  /  __/__ |/ |/ /  / /_/ / _  /    _(__  )        
*    /_/ /_/   \____/ /_/ /_/ /_/ /_/   \___/ ____/|__/   \__,_/  /_/     /____/         
*                                                                                    
*    Web: homiewars.com | Tg: @homiewars | Twitter @ HomieWars
*/
...
contract HomieCoin is ERC20, Ownable {
    ...
    HomieDividend public dividendTracker;
    ...
    uint256 public buyPrizePoolFee = 2;
    ...
    uint256 public sellprizepoolFee = 1;
    ...
    constructor() ERC20("HomieCoin", "HomieCoin") {
        dividendTracker = new HomieDividend();

        teamWallet = 0xC37F8f14d92b435f268DEceab0D03a84E054507F;
        prizePoolWallet = 0xF97B900e952e5C9B68b4B88A295feDd36aa38ef4;
        marketingWallet = 0x16c06c6724A5cB20CA3d2E8F7D65Ca12E9192aaC;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "HomieWars: The dividend tracker already has that address"
        );

        HomieDividend newDividendTracker = HomieDividend(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "HomieWars: The new dividend tracker must be owned by the Homie token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "HomieWars: The router already has that address"
        );
    ...
    function updatePrizePoolAddress(address newAddress) public onlyOwner {
        excludeFromFees(prizePoolWallet, false);
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "HomieWars: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "HomieWars: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "HomieWars: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "HomieWars: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "HomieWars: Cannot update gasForProcessing to same value"
        );
    ...
    function _transfer(
        ...
        if (tradingIsEnabled && automatedMarketMakerPairs[to]) {
            ...
            if (!swapping && canSwap) {
                ...
                uint256 bnbSwap = buyPrizePoolFee.add(buyTeamFee).add(
                    buyMarketingFee
                );
    ...
    function swapAndSendBnb(uint256 tokenAmount, uint256 totalFee) private {
        ...
        transferToWallet(
            payable(prizePoolWallet),
            address(this).balance.div(totalFee).mul(buyPrizePoolFee)
        );
        transferToWallet(
...
contract HomieDividend is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("Homie_Dividend_Tracker", "Homie_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "Homie_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Homie_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Homie contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "Homie_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "Homie_Dividend_Tracker: Cannot update claimWait to same value"
        );
