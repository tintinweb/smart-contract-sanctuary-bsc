...
//contract BatchAuction {
  ...
  uint256 private WITHDRAW_CAP_INTERCEPT = 14; // (14/49)x
  uint256 private WITHDRAW_CAP_INTERCEPT_PLUS = 175; // +(175/49)
   ...
   */
    ...
    if (total <= WITHDRAW_CAP_MIN) {
      ...
      return (total.mul(WITHDRAW_CAP_INTERCEPT).add(WITHDRAW_CAP_INTERCEPT_PLUS)).div(WITHDRAW_CAP_INTERCEPT_DIV);
    } else { 
   ...
   */
    ...
    return total.mul(WITHDRAW_CAP_INTERCEPT);
   ...
   */
    ...
    return total.mul(WITHDRAW_CAP_INTERCEPT).add(WITHDRAW_CAP_INTERCEPT_PLUS);
