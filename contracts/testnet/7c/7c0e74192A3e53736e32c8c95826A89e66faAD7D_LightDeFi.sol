...
contract LightDeFi is CollectionToken {
    using SafeMath for uint256;
    using Strings for uint256;

    string public LIGHT_PROVENANCE = "";
     ...
     */
    function tokenURI(uint256 tokenId) public view virtual override(CollectionToken) returns (string memory) {
    ...
    */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        LIGHT_PROVENANCE = provenanceHash;
    }
}
...
abstract contract CollectionToken is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;
