...
// File: FeeBeneficiary.sol
    ...
    contract FeeBeneficiary is Ownable {
        ...
        address public poolLiquidityMint;
        ...
        function tranferFoundOfMint(uint _amount, IERC20 _token) public {
            if(address(poolLiquidityMint)!= address(0)) {
                _token.transfer(poolLiquidityMint, _amount * poolLiquidityMintPercentage / 100);
            }
            if(address(houseFounds)!= address(0)) {
                _token.transfer(houseFounds, _amount * houseFoundsPercentage / 100);
            }
        }
        ...
        function setPoolLiquidityMint(address _poolLiquidityMint)public onlyOwner{ 
            poolLiquidityMint = _poolLiquidityMint;
        }
