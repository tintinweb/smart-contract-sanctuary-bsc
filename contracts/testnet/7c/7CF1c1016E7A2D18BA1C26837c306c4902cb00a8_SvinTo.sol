...
contract DividendDistributor is IDividendDistributor {
   ...
   IBEP20 FLOKI = IBEP20(0xd66c6B4F0be8CE5b39D52E0Fd1344c389929B378);
...
contract SvinTo is IBEP20, Auth {
   using SafeMath for uint256;
 
   address FLOKI = 0xd66c6B4F0be8CE5b39D52E0Fd1344c389929B378;
   address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
   address DEAD = 0x000000000000000000000000000000000000dEaD; 
   address ZERO = 0x0000000000000000000000000000000000000000;
 
   string constant _name = "SvinTo";
...
uint256 reflectionFee = 400;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaIer = 0x401ac53e1623e26c498b9bD6dFe0f840BD37B790;
       pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
       _allowances[address(this)][address(router)] = type(uint256).max;
 
       distributor = new DividendDistributor(address(router));
       
       address _presaler = 0x401ac53e1623e26c498b9bD6dFe0f840BD37B790;
       ...
       marketingFeeReceiver = 0x144018D2557C75222B0566B9169d3DE04Ef39F3E;
