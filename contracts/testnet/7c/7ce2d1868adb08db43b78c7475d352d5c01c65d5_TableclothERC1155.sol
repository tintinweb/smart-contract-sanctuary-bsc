...
contract TableclothERC1155 is ERC1155Upgradeable, AccessControlUpgradeable, ITableclothERC1155, EIP2981 {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155Upgradeable, AccessControlUpgradeable, EIP2981) returns (bool) {
        return interfaceId == type(ITableclothERC1155).interfaceId || super.supportsInterface(interfaceId);
    }
    ...
    function buyTablecloth(
        ...
        SafeERC20.safeTransferFrom(cswCoin, _msgSender(), address(this), cswAmount);
        _setAuthor(idIndex, _msgSender());
