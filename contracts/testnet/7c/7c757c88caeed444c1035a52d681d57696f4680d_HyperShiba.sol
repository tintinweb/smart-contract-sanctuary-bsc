...
contract DividendDistributor is IDividendDistributor {
    ...
    uint256 public minDistribution = 5000000000 * (10**18);
...
contract HyperShiba is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 200000000000000 * (10**_decimals);
    uint256 private swapThreshold = rSupply / 1000;
    uint256 public rebase_count = 0;
    uint256 public rate;
    uint256 public _totalSupply;
    uint256 private constant MAX_UINT256 = ~uint256(0);
    uint256 public constant MAX_SUPPLY = 1000000000000000 * (10**_decimals);
    ...
    constructor (address newOwner) Auth(newOwner) {
        ...
        autoRebase = false;
        rebaseRate = 243120;
        rebaseTimerInterval = 15 minutes;
        _lastRebasedTime = block.timestamp;

        marketingFeeReceiver = 0xb4bccf24729EA7f420023D9225b17bf9ecBA9bC5;
        buybackFeeReceiver = 0x059a23c5DE92b436B24584cff66C1E63F0865ceE;
    ...
    function setFees(uint256 _reflectionFee, uint256 _marketingFee, uint256 _buybackFee) external authorized {
        reflectionFee = _reflectionFee;
        marketingFee = _marketingFee;
        buybackFee = _buybackFee;
        totalFee = _reflectionFee.add(_marketingFee).add(_buybackFee);
        require(totalFee <= 25, "Fees cannot be more than 25%");
    }

    function setFeeReceivers(address _marketingFeeReceiver, address _buybackFeeReceiver ) external authorized {
