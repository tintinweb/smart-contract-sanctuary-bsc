...
contract FightClub is IBEP20, Auth {
    ...
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    address RewardToken = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47;
    ...
    mapping (address => bool) public isBettingContract;
    bool public antiRug;
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0x0000000000000000000000000000000000001004;
        marketingWallet = 0x44140Eee349977c52C7b160A7D91ad5d97485f75;  // marketing wallet
    ...
    modifier onlyContract() {
        require(isBettingContract[msg.sender], "You are not authorized to call this function"); _;
    }
    ...
    function changeTxLimit(uint256 newLimit) external authorized {
        require(!antiRug, "Cannot call this function anymore");
        _maxTxAmount = newLimit;
    }
    
    function setBettingContract(address contr, bool isForBetting) external authorized {
        isBettingContract[contr] = isForBetting;
    }
    ...
    function changeTradingStatus(bool _newStatus) external authorized {
        require(!antiRug, "Trading status cannot be changed");
        tradingStatus = _newStatus;
    }

    function activateAntiRug() external authorized {
        antiRug = true;
    }
    ...
    function setBlacklisted(address holder, bool blacklisted) external authorized {
        isBlacklisted[holder] = blacklisted;
        isDividendExempt[holder] = blacklisted;
    }

    function changeFees(uint256 newLiqFee, uint256 newRewardFee, uint256 newMarketingFee) external onlyOwner() {
        require(newLiqFee.add(newRewardFee).add(newMarketingFee) <= 15, "total fee would be too high");
    ...
    function feelessTransfer(address sender, address recipient, uint256 amount) external onlyContract() returns (bool) {
