...
contract ForkTest is Context, Ownable , ReentrancyGuard {
    using SafeMath for uint256;
    uint256 public constant min = 1 wei; //min deposit
    uint256 public constant max = 10000 ether; //max deposite 10000 busd
    ...
    uint256 public constant ref_fee = 14; //referral reward 14%
    address public dev = 0xfF1359491cf6a65aBc8fD7330aA631cb19913375;
    address public dev2 = 0xfF1359491cf6a65aBc8fD7330aA631cb19913375;
    address public popV1 = 0xfF1359491cf6a65aBc8fD7330aA631cb19913375;
    ...
    function deposit(address _ref, uint256 _amount) public noReentrant  {
       ...
       // fees 
        ...
        uint256 total_contract = SafeMath.sub(_amount,total_fee*5);
 ...
 function withdrawal() public noReentrant {
    ...
    require(totalRewards[msg.sender].amount <= SafeMath.mul(investments[msg.sender].invested,365), "You cant withdraw you have collected 365 times Already"); 
    ...
    uint256 totalAmountToWithdraw = SafeMath.sub(aval_withdraw2,wFee*5); 
