...
contract PancakeERC20 is IPancakeERC20 {
    ...
    string public constant name = 'Astraswap LPs';
    string public constant symbol = 'ASP-LP';
...
contract ASPPair is IPancakePair, PancakeERC20 {
    using SafeMath  for uint;
...
contract Astraswapfactory is IPancakeFactory {
    bytes32 public constant INIT_CODE_PAIR_HASH = keccak256(abi.encodePacked(type(ASPPair).creationCode));
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        bytes memory bytecode = type(ASPPair).creationCode;
