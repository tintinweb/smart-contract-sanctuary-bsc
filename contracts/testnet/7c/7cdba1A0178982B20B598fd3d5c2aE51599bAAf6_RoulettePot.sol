...
contract RoulettePot is Ownable, ReentrancyGuard {
    ...
    address constant busdAddr = 0xaB1a4d4f1D656d2450692D237fdD6C7f9146e814; // testnet: 0xaB1a4d4f1D656d2450692D237fdD6C7f9146e814, mainnet: 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    ...
    function _getRandomNumber() internal view returns (uint256) {
        ...
        uint256 number = uint256(keccak256(abi.encodePacked(block.timestamp, diff, hash, getBNBPrice(), totalBetSum))) %
            37;
    ...
    function placeBetsWithTokens(uint256 tokenId, Bet[] calldata bets) external nonReentrant {
        ...
        IPRC20 usdtToken = IPRC20(busdAddr);
        ...
        require(totalUSDValue >= casinoInfo.minBet * 10**usdtToken.decimals(), "Can't be lower than min bet limit");
        ...
        emit RouletteSpinned(
            ...
            totalReward,
            totalUSDValue,
            (totalReward * tokenPrice) / 10**token.decimals()
        );
    }
