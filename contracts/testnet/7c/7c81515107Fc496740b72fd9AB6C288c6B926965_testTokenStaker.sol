...
contract testTokenStaker is Ownable {
    using SafeMath for uint256;
    ...
    */ 
    ...
    uint256 private contractLockPeriod = 600; // 6-month in seconds 
    ...
    constructor(
        ...
        */ 
        ...
        claimableTime = block.timestamp + 300;//1296000; // 15 Days = 60*60*24*15
    }
    ...
    */
    ...
    /*
    * returns the calculation factor # TODO: remove?
    */
    ...
    */
    function deposit(uint256 _amount) public {
        ...
        //user.rewardEarned = user.rewardEarned.add(calculateClaimableReward(msg.sender, 0));
...
/* Other TODO:
* 1. How to withdraw other tokens sent by mistake to the contract address? (low prio)
* 2. From an initial timestamp, wait N seconds before allowing claim. (initial lock period)
* 3. Testing the new functionality:
*   3.1 Trying new reward token
*   3.2 Trying the initial lock period 
*   3.3 Testing the claim
*/