...
/**
 *https://t.me/shibastepnsatoshi
*/

/**
 *https://twitter.com/shibastepn
*/
/**
 *https://shibastepn.com/
*/
...
contract ShibaStepn is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4d600C16bFC70C92182fb9617e9c8fdd0653a2F8); // Marketing Address
    address payable public charityAddress = payable(0x4d600C16bFC70C92182fb9617e9c8fdd0653a2F8); // Charity/Dev Address
    
    address public immutable deadAddress = 0x4d600C16bFC70C92182fb9617e9c8fdd0653a2F8;
    ...
    string private _name = "SHIBA STEPN SATOSHI";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private salePrice = 250000;// 0.01*250000=2500 token for 0.01 bnb (set as per requirements)
