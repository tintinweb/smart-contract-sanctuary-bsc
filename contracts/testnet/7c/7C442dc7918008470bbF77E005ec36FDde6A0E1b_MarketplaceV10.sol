    ...
    OwnableUpgradeable
{
    ...
    modifier nonReentrant() {
        require(!locked, "Marketplace: No re-entrancy");
        locked = true;
        _;
        locked = false;
    }
    ...
    function cancelOffer(uint256 tokenId) external nonReentrant {
        ...
        _custodialContract.custodialPayment(sender, currentOffer);
     ...
     * @param tokenId Token ID.
     */
    function tokenBurn(uint256 tokenId) external nonReentrant {
     ...
     * @param tokenId Token ID.
     */
    function resetOffer(uint256 tokenId) external onlyOwner {
        // Get existing buyer
        address buyer = _tokenOffer[tokenId].offerFrom;
        ...
        // Emit offer cancel event
        emit OfferCanceled(tokenId, buyer);
    }
}
