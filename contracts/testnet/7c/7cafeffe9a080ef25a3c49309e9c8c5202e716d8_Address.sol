...
contract JUMP is Context, IERC20, Ownable {
    ...
    string private constant _name = "adoptonetoken"; 
    string private constant _symbol = "ADPTKN"; 
    ...
    Taxes public taxes = Taxes(0,96,3,0); 
    ...
    constructor () {
        ...
        IRouter _router = IRouter(0x40c973B13aE3F13AA64db8fe4789e4e32691DE44);
