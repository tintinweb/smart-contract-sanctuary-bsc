...
contract LotteryProgram is ReentrancyGuard, ILotteryProgram, Ownable {
     ...
     * @param _playTokenAddress: address of the CAKE token
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address(playToken), "Cannot be CAKE token");
     ...
     * @dev Only callable by owner
     * @param _minPriceTicketInToken: minimum price of a ticket in CAKE
     * @param _maxPriceTicketInToken: maximum price of a ticket in CAKE
     */
