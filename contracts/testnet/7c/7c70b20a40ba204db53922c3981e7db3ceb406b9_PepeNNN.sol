...
contract PepeNNN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xCc3Ff186dE549D13dB4E6da768BCa336d93a730A); // Marketing Wallet Address
    address payable public airdropWalletAddress = payable(0x8bE5AD3a518f66E9c46eB5727fDC601630B4d41d); // Airdrop Wallet Address
    address payable public devWalletAddress = payable(0xa9F001a6Dff912Fd156b0bceb26116f3F4bfFded); // Dev Wallet Address
    ...
    string private constant _name = "PepeNNN";
    string private constant _symbol = "PNNN";
    ...
    uint256 public totalSwapableFee = _liquidityFee + _devFee + _marketingFee + _airdropFee;

    uint256 _saleTaxFee = 2;
    uint256 _saleLiquidityFee = 0;
    uint256 _saleAirdropFee = 0;
    uint256 _saleDevFee = 2;
    uint256 _saleMarketingFee = 3;


    uint256 public totalSwapableSaleFee = _saleTaxFee + _saleLiquidityFee + _saleDevFee + _saleMarketingFee + _saleAirdropFee;


    uint256 public liquidityTokensCollected = 0;
    uint256 public devTokensCollected = 0;
    uint256 public marketingTokensCollected = 0;
    uint256 public airdropTokensCollected = 0;
    ...
    constructor () {
        address _owner = 0xa9F001a6Dff912Fd156b0bceb26116f3F4bfFded;
    ...
    function countUpFeeShare(uint256 amount) private
    {
        ...
        airdropTokensCollected += (amount * _airdropFee)/100;
    }
    ...
    function setAirdropWalletAddress(address _airdropWallet) external onlyOwner() {
        require(_airdropWallet != address(0), "setAirdropWalletAddress: ZERO");
        airdropWalletAddress = payable(_airdropWallet);
        emit AuditLog("We have Updated the AirdropWallet:", airdropWalletAddress);
