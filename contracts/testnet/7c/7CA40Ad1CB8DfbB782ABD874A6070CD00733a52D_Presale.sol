...
contract Presale is Initializable {
    ...
    uint256 public limitperwallet = 25e19;
    event WhitelistedAddressAdded(address addr);
    event WhitelistedAddressRemoved(address addr);

    function initialize(address dai_addr) public initializer {
        dai = IToken(dai_addr);
  ...
  function unpause() onlyowner public {
    ...
    function Buy() public
    {
       ...
       dai.transferFrom(msg.sender,address(this), limitperwallet);
    ...
    {
        dai.transfer(address(msg.sender),amount);
    }
