...
contract CloneFactory {
  ...
  function createClone16(address target) public returns (address result) {
  ...
  function createClone18(address target) public returns (address result) {
  ...
  function createClone17(address target) public returns (address result) {
  ...
  function isClone16(address target, address query) public view returns (bool result) {
    bytes20 targetBytes = bytes20(target)<<32;
    assembly {
      let clone := mload(0x40)
  ...
  function isClone17(address target, address query) public view returns (bool result) {
    bytes20 targetBytes = bytes20(target)<<24;
    assembly {
      let clone := mload(0x40)
  ...
  function isClone18(address target, address query) public view returns (bool result) {
    bytes20 targetBytes = bytes20(target)<<16;
    assembly {
      let clone := mload(0x40)
