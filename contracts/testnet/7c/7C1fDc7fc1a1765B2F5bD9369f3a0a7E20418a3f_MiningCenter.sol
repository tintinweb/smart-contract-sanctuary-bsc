...
contract MiningCenter is ERC1155Holder {
     ...
     * @param _nftType the property type
     */
    function unStakingProperty(uint256 _nftNum, uint256 _nftType)
        external
        payable
    {
    ...
    function unStakingPropertyByAdmin(
        ...
        unStakingPropertyIntern(_owner, _nftNum, _nftType);
    }
    ...
    function unStakingPropertyIntern(
        ...
        ) = getExpectedInStakingReward(_owner, _nftNum, _nftType);
