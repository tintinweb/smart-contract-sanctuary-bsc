...
contract WQNFTMarketplace is ERC721 {
  ...
  mapping(uint256 => Item) public allItems;
  ...
  constructor() ERC721("Warqube NFT collection", "WQNFT") {
    collectionName = name();
    collectionNameSymbol = symbol();
  }

  function mintItem(string memory _name, string memory _tokenURI, uint256 _price, string[] calldata _colors) public {
  ...
  function buyToken(uint256 _tokenId) public payable {
    ...
    Item memory item = allItems[_tokenId];
    ...
    // get owner of the token
    address payable sendTo = item.currentOwner;
