...
//  BUY Tax 2% BUSD 2% USDT 4% MARKETING/TEAM 0% AUTOBUYBACK N BURN
//  SELL TAX 2% BUSD 2% USDT 4% MARKETING/TEAM 0% AUTOBUYBACK N BURN
...
contract Meme_Family_Holiday is Context, ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("","") {
        ...
        marketingWallet = 0xc097cf7440de0bc62C9C6E887c9E14B9f3B2906d;
        teamWallet = 0x148F7552cf0c943d726e46eE4f95A317d2e67a68;
    ...
    function setMaxBuyTransaction(uint256 _maxTxn) external onlyOwner {
        require(_maxTxn >= (totalSupply() * 5 / 1000)/1e18, "Cannot set maxTransactionAmount lower than 0.5%");
