...
contract ERC721Base is IERC721Base {
    ...
    /// @param user  The new user of the NFT
    /// @param expires  UNIX timestamp, The new user could use the NFT before expires
    function setUser(uint256 tokenId, address user, uint256 expires) internal { 
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function setUserforRental(uint256 tokenId, address user, uint256 expires) external onlyMunicipality {
