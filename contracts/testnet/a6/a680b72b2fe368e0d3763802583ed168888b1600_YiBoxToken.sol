...
// File: YiBoxToken/YiBoxToken.sol
pragma solidity ^0.6.6;
contract YiBoxToken is ERC20, Ownable {
    using SafeMath for uint256;

    /**
     * The time interval from each 'mint' to the 'YoBox mining pool' is not less than 365 days
     */
    ...
    /**
     * All of the minted 'Ybox' burned in the corresponding mining pool if the released amount is not used up in the current year 
     * 
     */
    ...
    constructor() 
        public 
        ERC20("SabarWomanCoin", "SWC", 18) 
    {
        uint256 decimal = 10 ** uint256(decimals);
        /**
        * There will distribute 400,000,000 Ybox in year 1
        *                       225,000,000 Ybox in year 2
        *                       175,000,000 Ybox in year 3
        *                       125,000,000 Ybox in year 4
        *                       75,000,000  Ybox in year 5
        *  In the future, up to 50,000,000 Ybox can be released each year
        */
    ...
    function setMainPool(address pool_) external onlyOwner {
        transferOwnership(pool_);
    }

    /**
     * Distribute YBOX to the main mining pool according to the YBOX limit that can be released every year
     */
    function mint(address dest_) external onlyOwner {
