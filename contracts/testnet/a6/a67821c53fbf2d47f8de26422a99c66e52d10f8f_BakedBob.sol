...
contract BakedBob is Context, Ownable {
    ...
    function bobRewards(address adr) public view returns(uint256) {
        uint256 hasEggs = getMyEggs(adr);
        uint256 eggValue = calculateEggSell(hasEggs);
        return eggValue;
    }
    
    function buyBobs(address ref) public payable {
        require(initialized);
