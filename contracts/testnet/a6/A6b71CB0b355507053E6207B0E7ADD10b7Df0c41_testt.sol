...
contract testt is ERC20, Ownable {
    ...
    constructor() ERC20("testt", "$testt") {
        ...
        swapTokensAtAmount = 250_000 * 1e18;

        marketingWallet = address(0xa70884Be83d7639bb495D7b6BdFDa0147337d00a); // set as marketing wallet
        devWallet = address(0xC7b3db3Ec163b834F937Dc40705F9a59769336C8); // set as dev wallet
        treasuryWallet = address(0xfcdbBBC4a838409E14aBD9b94AA8BE8a9743C0c1);
        ...
        */
        _mint(0x0024b734a76e1279f7aab0bFFbc4638154A0D3dB, totalSupply);
    }
    ...
    function updateTreasuryWallet(address newWallet) external onlyOwner {
        emit treasuryWalletUpdated(newWallet, devWallet);
