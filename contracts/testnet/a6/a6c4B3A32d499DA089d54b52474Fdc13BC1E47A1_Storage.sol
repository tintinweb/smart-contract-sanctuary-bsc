...
contract Storage {
    ...
    function store(uint chainId, uint internalId) public currentOwner(chainId, internalId)  returns (bool){

    	require(archive.getCurrentStatus(chainId, internalId) == 2);
    ...
    function release(uint chainId, uint internalId) public currentOwner(chainId, internalId) returns (bool){
