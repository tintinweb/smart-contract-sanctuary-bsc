...
contract Token is ERC20 {
	...
	address _baseToken = address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
	//address _pancakeRouter = address(0x10ED43C718714eb63d5aA57B78B54704E256024E);
	address _pancakeRouter = address(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
    IERC20 public ETH;
    EthWarp warp;
    ...
    constructor(address tokenOwner) ERC20("A888", "A888") {
		...
		uint256 total = 10**33;
        _approve(address(this), address(_pancakeRouter), total.mul(1000));
        ETH = IERC20(_baseToken);
        ETH.approve(address(_pancakeRouter),total.mul(1000));
