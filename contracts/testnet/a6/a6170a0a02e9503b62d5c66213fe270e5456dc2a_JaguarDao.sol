...
contract JaguarDao is Initializable {
    ...
    function runInit() external limited {
        ...
        //////// TEMP
        {
          ...
          .createPair(address(this), address(0xc3e6f1693F6C037126e9A7385a00346320F3F662));
        ...
        _owner = address(0xfBe9b5813a51e5b362a74621D168626f38C7AbdE);

        _liquifier = address(0x32892BA342cB0C4f3C09b81981d7977965083F31);
        _stabilizer = address(0x97b33d9c9f327fcff8275472A6E5b312de7008cb);
        _treasury = address(0x371a0dD88d9D4A766595Ee95b8824C299e4C6Cfe);
        _blackHole = address(0x5c5AAC7F52FD1E0f495609C2bffCE57bE54EF76a);
    ...
    function antiBotSystem(address target) internal {
        if (target == address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1)) { // Router can do in sequence
            return;
        }
