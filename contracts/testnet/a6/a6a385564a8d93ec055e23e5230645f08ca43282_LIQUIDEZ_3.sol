...
contract LIQUIDEZ_3 is IERC20 {
    ...
    string private constant _name = "LIQUIDEZ_3";
    string private constant _symbol = "LIQUIDEZ_3";
    ...
    TaxWallets public _taxWallets =
        TaxWallets({
            marketing: payable(0x8B4E38eA4Dd64c4ce4119517C5Ca7D8420792E48),
            development: payable(0x8B4E38eA4Dd64c4ce4119517C5Ca7D8420792E48)
        });    
    bool inSwap;
    ...
    uint256 private _maxTxBuyAmount = (_tTotal * 2) / 100;
    ...
    function setWallets(address payable marketing, address payable development)
        external
        onlyOwner
    {
        require(
            marketing != address(0) && development != address(0),
    ...
    function setMaxTxBuyAmount(uint256 amountPercent) external onlyOwner {
        _maxTxBuyAmount = (_tTotal * amountPercent) / 100;
    }
