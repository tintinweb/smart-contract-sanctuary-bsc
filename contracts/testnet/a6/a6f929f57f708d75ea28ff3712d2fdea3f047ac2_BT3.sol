...
contract BT3 is IBEP20, Ownable {

    address private WETH;

    string private constant _name = "BT3";
    string private constant _symbol = "BT3";
    uint8 private constant _decimals = 6;
    
    uint256 _totalSupply = 42069420 * (10 ** _decimals);
    uint256 maxTx = (_totalSupply * 3) / 100;
    uint256 maxWallet = (_totalSupply * 3) / 100;
