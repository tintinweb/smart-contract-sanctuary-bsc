...
contract AbellBNBPool is ReentrancyGuard{
    ...
    constructor(address _abc,uint256 _start,uint256 _amount)  {
        ABC = IERC20(_abc);
        startTime = _start;
        rewardRate = _amount.div(rewardsDuration);
    ...
    function getReward() public nonReentrant updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            ABC.safeTransfer(msg.sender, reward);
