...
contract EnergyGreen is Context, IERC20 { 
    ...
    */
    ...
    address public suggested_New_Owner_Wallet = 0xD68ead5CC1fc29e307CB04596858Fc2833f7D8dc; // XXXXX

    // Update Confirmation Wallet for Multi-Sig - Suggested new wallet (must be confirmed)
    address public suggested_New_MultiSig_2nd_Wallet = 0xD68ead5CC1fc29e307CB04596858Fc2833f7D8dc; // XXXX

    // Confirmation wallet for Multi-Sig (Required for Transfer/Renounce Ownership)
    address public Wallet_MultiSig = 0xD68ead5CC1fc29e307CB04596858Fc2833f7D8dc;  // XXX
    
    // Fee processing wallets
    address payable public Wallet_Marketing     = payable(0x406D07C7A547c3dA0BAcFcC710469C63516060f0); // XXX
    address payable public Wallet_Contract_Dev  = payable(0xD05895EDF847e1712721Cc9e0427Aa26289A6Bc5); 
    address payable public Wallet_Developer     = payable(0xde491C65E507d281B6a3688d11e8fC222eee0975); 
    address payable public Wallet_Liquidity     = payable(0x06376fF13409A4c99c8d94A1302096CB4dC7c07e); // XXX
    address payable public Wallet_Team          = payable(0x981Ab956D6575b40F49AcBb769342BE91db95828); // XXX
    address payable public Wallet_Treasury      = payable(0x7D15025D421c5fF186017e8809C584De9036772A); // XXX
    address payable public Wallet_Tokens        = payable(0x5CAbbF2Bed506783038B48f51569Fe5b9283825b); // XXX
    ...
    For pre-sale compliance, contract is deployed with all fee set to 0 and no transaciton limits
    ...
    */
    ...
    // Min tokens for swap 1000 Tokens
    uint256 public min_SWAP = 1000 * 10 ** _decimals;
    ...
    */
    ...
    Deflationary Burn Switch - By default this is set to true
    ...
    */
    ...
    function Set_Fees_For_Buys_x100(uint256 BUY_Marketing,
                                    uint256 BUY_Liquidity,
                                    uint256 BUY_Treasury,
                                    uint256 BUY_Team,
                                    uint256 BUY_Tokens,   
                                    uint256 BUY_Burn
                      ...
                      uint256 Total_BUY =  BUY_Marketing +
                                           BUY_Liquidity +
                                           BUY_Treasury  +
                                           BUY_Team      +
                                           BUY_Tokens    +
                      ...
                      // Update fees
                      Fee_BUY_Marketing  = BUY_Marketing;
                      Fee_BUY_Liquidity  = BUY_Liquidity;
                      Fee_BUY_Treasury   = BUY_Treasury;
                      Fee_BUY_Team       = BUY_Team;
                      Fee_BUY_Tokens     = BUY_Tokens;
                      Fee_BUY_Burn       = BUY_Burn;
    ...
    function Set_Fees_For_Sells_x100(uint256 SELL_Marketing,
                                     uint256 SELL_Liquidity,
                                     uint256 SELL_Treasury,
                                     uint256 SELL_Team,
                                     uint256 SELL_Tokens,   
                                     uint256 SELL_Burn
                      ...
                      uint256 Total_SELL = SELL_Marketing +
                                           SELL_Liquidity +
                                           SELL_Treasury  +
                                           SELL_Team      +
                                           SELL_Tokens    +
                      ...
                      // Update fees
                      Fee_SELL_Marketing = SELL_Marketing;
                      Fee_SELL_Liquidity = SELL_Liquidity;
                      Fee_SELL_Treasury  = SELL_Treasury;
                      Fee_SELL_Team      = SELL_Team;
                      Fee_SELL_Tokens    = SELL_Tokens;
                      Fee_SELL_Burn      = SELL_Burn;
    ...
    */
    ...
    function Trade_Open() external onlyOwner {
        ...
        // Set the contract fee at 0.25% on buys and sells
