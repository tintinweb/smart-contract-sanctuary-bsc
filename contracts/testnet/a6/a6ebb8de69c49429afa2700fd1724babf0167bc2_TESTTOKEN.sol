...
contract TESTTOKEN is IERC20 {
    ...
    address public dividendAddr = 0x61eB9bdB31435c982f2d780C605eb1a14992D912; //持币分红派发地址
    address public capitalPoolAddr = 0x61eB9bdB31435c982f2d780C605eb1a14992D912; //资金池地址
    ...
    constructor (uint256 initialAmount, string tokenName, uint8 decimalUnits, string tokenSymbol) public {
        ...
        agentRate[0] = 25; //1代分红比例
        agentRate[1] = 15; //2代分红比例
        agentRate[2] = 12;
        agentRate[3] = 8;
        agentRate[4] = 8;
        agentRate[5] = 8;
