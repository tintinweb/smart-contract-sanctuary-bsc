...
contract fitngoICO is Context, Ownable {
  ...
  constructor()  {
    ...
    priceFeedBUSD = AggregatorV3Interface(0x9331b55D9830EF609A2aBCfAc0FBCE050A52fdEa);
    // testnet 0x9331b55D9830EF609A2aBCfAc0FBCE050A52fdEa
    // mainnet 0xcBb98864Ef56E9042e7d2efef76141f15731B82f
    Token=IBEP20(0x5f66292146AEC3bf9c99C86CDf3cdECe26d3658b); // need to change with deploy token
    tokenPerUsd = 3;
  }
   ...
   */
   function buyToken() public payable{
      ...
      uint256 amount=bnbToToken(msg.value,0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526); // testnet 0x2514895c72f50D8bd4B4F9b1110F0D6bD2c97526
      // mainnet 0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE
   ...
   // Revert tokens which are received by contract
    ...
    function airdropTokens(address ref_address) public returns(bool){
        ...
        require(dropTokens<=Token.totalSupply().mul(5).div(100), "No more tokens for airdrop");
        bool _isExist = false;
        ...
        uint256 totalTokens = airdrop*(10**18);
        dropTokens = totalTokens.add((airdrop*(10**18)*rewards)/100);
