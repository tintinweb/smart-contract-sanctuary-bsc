...
contract AMTToken is ERC20, Ownable {
    ...
    constructor() public ERC20("AMT", "AMT") {
        ...
        unitIncrease = 26 * 10 ** uint256(decimals());
    ...
    function burn(uint256 amount) public {
        ...
        if(burnNowNum >= 1000 * 10 ** uint256(decimals())){
            subscriptionPrice = subscriptionPrice.add(unitIncrease.mul(burnNowNum.div(1000 * 10 ** uint256(decimals()))));
            burnNowNum = burnNowNum.sub(1000 * 10 ** uint256(decimals()));
        }
