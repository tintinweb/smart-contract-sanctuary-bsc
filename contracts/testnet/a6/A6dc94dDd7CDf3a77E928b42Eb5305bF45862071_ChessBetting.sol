...
contract ChessBetting {
    ...
    function claim() public {
        uint256 val = claims[msg.sender];
        require(val > 0, "no claim");
        claims[msg.sender] = 0;
        _token.transfer(msg.sender, val);
    ...
    function setWinner(string memory _gameId, address addr) private {
    ...
    function bet(string memory _gameId, uint _level, uint256 _betamount) public {
