...
contract HeadsTails is Ownable {
    ...
    event AddStakeToken(address indexed token, uint256 maxStakeAmount);
    ...
    **/
    ...
    function addStakeToken(address token, uint256 maxStakeAmount) external onlyOwner {
        ...
        emit AddStakeToken(token, maxStakeAmount);
    }
    ...
    **/
    function setStakeable(uint256 questionId, bool stakeable) external onlyOwner {
        ...
        require(question.started == true, 
            "HeadsTails: Question is not started.");
        require(question.answered == false, 
    ...
    **/
    function harvest(uint256 questionId) external {
        ...
        require(question.answered == true,
