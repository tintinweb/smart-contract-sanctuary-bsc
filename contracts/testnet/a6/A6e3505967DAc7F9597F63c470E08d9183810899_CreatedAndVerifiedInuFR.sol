...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "CreatedAndVerifiedInuFR";
    string internal constant SYMBOL = "CVINUFR";
...
abstract contract CreatedAndVerifiedInuFRAbstract is BaseRfiToken, Liquifier, Antiwhale {
...
contract CreatedAndVerifiedInuFR is CreatedAndVerifiedInuFRAbstract {
    constructor() CreatedAndVerifiedInuFRAbstract(Env.Testnet) {
