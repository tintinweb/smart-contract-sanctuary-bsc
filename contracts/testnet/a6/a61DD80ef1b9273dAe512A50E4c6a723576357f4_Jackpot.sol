...
contract Jackpot is ReentrancyGuard {
    ...
    event PurchaseJackpot(uint256 gid, address userAddress);
    event PurchaseGrandJackpot(uint256 gid, address userAddress);
    ...
    event SetJackpotFee(uint256 fee);
    event SetGrandJackpotFee(uint256 fee);
