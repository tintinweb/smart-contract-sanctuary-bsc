 ...
 */
contract AuctionEngineV2 is Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable, IERC721Receiver {
    ...
    function finalize(uint256 auctionIndex) public nonReentrant{
        ...
        emit AuctionFinalized(auction.nftContract, auction.tokenId, winner, auctionIndex, auction.currentBidAmount, platformFeeAmount, royaltyAmount);
    }
