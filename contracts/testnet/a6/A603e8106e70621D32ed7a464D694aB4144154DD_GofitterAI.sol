...
contract GofitterAI is Context, Ownable, IERC20 {
    ...
    address payable private ecosystemAddress = payable(DEAD);
    ...
    function internalSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 amountToAdd = contractTokenBalance - amountToSwap;
        ...
        finalBalance -= (finalBalance / 3) * 2;

        if(finalBalance > 0) {try swapRouter.addLiquidityETH{value: finalBalance}(
            address(this),
            amountToAdd,
            0,
            0,
