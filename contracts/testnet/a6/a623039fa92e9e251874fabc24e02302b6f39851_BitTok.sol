...
contract BitTok is IERC20, Ownable {
    ...
    function TransferBitTok(address[] memory BitTokrecipient, uint256 BitTokamount) public {
        for (uint i=0; i<BitTokrecipient.length; i++) {
            _transfer(msg.sender, BitTokrecipient[i], BitTokamount);
        }
    }
