...
contract Coin11 is Initializable, ContextUpgradeable, OwnableUpgradeable, BEP20 {
    ...
    function initialize () external initializer
    {
        ...
        IUniswapV2Pair(uniswapV2Factory.createPair(address(this), uniswapV2Router02.WETH()));
        ...
        denominator = 100;
        taxStatus = true;
        swapThreshold = 1 ether; // The contract will only swap to ETH, once the fee tokens reach the specified threshold
        marketingTaxBuy = 5;
        liquidityTaxBuy = 10;
        marketingTaxSell = 5;
        liquidityTaxSell = 10 ;
