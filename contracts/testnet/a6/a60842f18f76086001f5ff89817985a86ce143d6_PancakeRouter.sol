...
library TransferHelper {
    ...
    uint256 value
        ...
        token.call(abi.encodeWithSelector(0x095ea7b3, to, value)); // call approve fn in low level, ref: https://github.com/ethereu
        require(
...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'5c9b1cf02ea9055b3f4e4613cb44d100a1bbc842d3d277f287be89d053ab35e4' // MY Factory's init code hash
            ))));
    }
