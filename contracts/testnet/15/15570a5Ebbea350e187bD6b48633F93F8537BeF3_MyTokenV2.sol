...
contract MyTokenV2 is ERC20PresetMinterPauserUpgradeable, ERC20SnapshotUpgradeable, UUPSUpgradeable, OwnableUpgradeable {

    uint testValue;

    function init() initializer public {
        __ERC20PresetMinterPauser_init("MyToken", "MTK");
        __Ownable_init();
