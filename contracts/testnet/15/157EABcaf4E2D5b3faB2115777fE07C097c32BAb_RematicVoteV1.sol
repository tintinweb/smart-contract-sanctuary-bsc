...
contract RematicVoteV1 is ReentrancyGuard, Ownable {
    ...
    address private signer = 0xC1d3D7DDD33deE362A5573660Fd1a2B2019F261A;
    ...
    address public TEAM_WALLET = 0x5219f96327feCF0E590B71490F6b774706959666;
    ...
    function _signatureWallet(address sender, bytes calldata _signature)
        private
        pure
        returns (address)
    {
    ...
    function voteQuestions(
        ...
        address signatureVerifier = _signatureWallet(_msgSender(), _signature);
        require(signatureVerifier == signer, "You're not authorized to vote.");
        ...
        returns (bool)
    {
        ...
        bool success = _safeTransferETH(_msgSender(), _amount);
