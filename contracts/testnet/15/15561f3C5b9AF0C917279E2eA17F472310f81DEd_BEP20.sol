...
contract BEP20 is IERC20,Initializable, OwnableUpgradeable {
    using SafeMath for uint256;
    ...
    function initialize() public initializer {
        ...
        _usdt = 0xD05A097B1Dc5Bd0733b9460fa562497278F55E36;
        lpRewardToken = _usdt;
        swapToken = _usdt;

        marketingWalletAddress=0xc7d8a9Ec8957203F11312f0cF30FC6a4d4775380;//营销钱包
        foundationWalletAddress=0xc7d8a9Ec8957203F11312f0cF30FC6a4d4775380;//滑点接收钱包
        liquidityReceiveAddress=0xc7d8a9Ec8957203F11312f0cF30FC6a4d4775380;//回流钱包
    ...
    function takeAllFee(address from,uint256 amount) private returns(uint256 amountAfter) {
        ...
        _transfer_init(from, address(this), LFee.add(LPFee).add(MFee));
    }
