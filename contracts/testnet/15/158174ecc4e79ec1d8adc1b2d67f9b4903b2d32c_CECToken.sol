...
contract CECToken is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
     ...
     * @param fee Number's for Liquidity percentage.
     */
    ...
    /**
       @dev Liquidity wallet fee enable & disabled function
       @param enable give true or false
     */
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) internal {
        (uint256 tTransferAmount, uint256 tFee, uint256 tSwapFee, uint256 tLiquidityFee) = getTValues(tAmount);
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 rSwapFee, uint256 rLiquidityFee) = getRValues(tAmount, tFee, tSwapFee, tLiquidityFee);
        {
            address from = sender;
    ...
    function getTValues(uint256 amount) internal view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 tTransferAmount = tAmount - tFee - tSwapFee - tLiquidityFee;
        return (tTransferAmount, tFee, tSwapFee, tLiquidityFee);
    }

    function getRValues(uint256 amount, uint256 tFee, uint256 tSwapFee, uint256 tLiquidityFee) internal view returns (uint256, uint256, uint256, uint256, uint256) {
        ...
        uint256 rTransferAmount = rAmount - rFee - rSwapFee - rLiquidityFee;
