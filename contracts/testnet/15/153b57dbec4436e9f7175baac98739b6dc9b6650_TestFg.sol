...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE1Dbff33599F20f070C703E64478ADFE9DAC6454; // owner address
...
contract TestFg is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TestFG";
    string private _symbol = "TESTFge";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE1Dbff33599F20f070C703E64478ADFE9DAC6454); // Marketing Address
    address payable public teamWalletAddress = payable(0xE1Dbff33599F20f070C703E64478ADFE9DAC6454); // Team Address
