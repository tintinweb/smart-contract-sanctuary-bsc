...
contract TokenGen7{
 modifier onlyFactory() {
    ...
    function generateToken(
        ...
        ERC20_Swap2_Own_Liq newtok = new ERC20_Swap2_Own_Liq(name, symbol, decimals, totalSupply, owner, raddr, bbbfee, bbsfee);
...
contract ERC20_Swap2_Own_Liq is IERC20, Ownable {
    ...
    function setBuyFees(uint256 _buybackFee, uint256 _liquifyFee) external onlyOwner {
    ...
    function setSellFees(uint256 _buybackFee, uint256 _liquifyFee) external onlyOwner {
