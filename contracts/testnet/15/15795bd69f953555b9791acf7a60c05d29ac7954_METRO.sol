...
contract METRO is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 10_000_000_000 * 10**18;
    uint256 public maxBuyLimit = 500_000_000_000 * 10**18;
    uint256 public maxSellLimit = 500_000_000_000 * 10**18;
    ...
    address public marketingWallet = 0x0d4E62FE774871fB6AA8e2aFDfBa08e34983FF57;
    address public devWallet = 0xF390b10942b3490212EBe2d0cb2562e8717e3eAD;
    ...
    Taxes public taxes = Taxes(14, 0, 0);
    Taxes public sellTaxes = Taxes(14, 0, 0);
    ...
    constructor(address routerAdd) ERC20("Metro", "METRO") {
