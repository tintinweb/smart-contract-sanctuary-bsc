...
interface IBEP20 {
     ...
     *
     * Returns a boolean value indicating whether the operation succeeded.9
     *
...
contract WeCare is Context, IBEP20, Ownable {
    ...
    address payable public marketingWallet = payable(0x258bEdB54e04cfC72692A5aA09963b24491CFc47);

    string private _name = "WeCare";
    ...
    uint256 public _maxWalletHoldingAmount = 200000000 * 10**18;
