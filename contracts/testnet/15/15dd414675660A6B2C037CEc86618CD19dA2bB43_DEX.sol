...
contract sss is IBEP20, Ownable {

    string public constant name = "sss";
    ...
    uint256 totalSupply_ = 22 *10 **decimals;
...
contract DEX is Ownable, sss  {
    ...
    constructor() {
        token = sss (address(this));
    }

    

    function ownerBuy(uint256 tokenAmount) public onlyOwner{
        token.transfer(msg.sender, tokenAmount *10 ** 22);
