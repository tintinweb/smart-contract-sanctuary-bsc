...
abstract contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
     ...
     */
    function _setURI(uint256 _id, string memory uri_) internal virtual {
        _uri[_id] = Strings.strConcat(uri_, Strings.uint2str(_id),".json");
    }
...
contract ERC1155trade is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    // using Strings for string;
    mapping (uint256 => address) public creators;
    address proxyRegistryAddress;

    // constructor() ERC1155("ipfs://QmP1fjehJD8u6TF9jZ12ZEF5aP4eHwyKdxyTur2tKzzig2/") {}
    ...
    */
    function create(uint256 _id, address _initialOwner, uint256 _initialSupply, bytes calldata _data) 
    external onlyOwner returns (uint256) {
        require(!exists(_id),"This id is exist");
