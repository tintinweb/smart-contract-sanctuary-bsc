...
contract WIZARDZ is Context, IERC20, Ownable {
  ...
  uint256 public maxWalletAmount = 100 * 10**9 * 10**9;
  string private _name = 'Wizardz';
  string private _symbol = '$WIZARDZ';
  ...
  address private _marketingWalletAddress = 0xB899dd2822b2fc60403ad8fFb34914d710823f3B;
  ...
  constructor() {
      address _newOwner = 0xEeE24561F7CF7675D99c505C11e7f12Ce9B88d87; // must change owner wallet
