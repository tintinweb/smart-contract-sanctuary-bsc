    ...
    OperatorFilterer
{
    ...
    constructor(
        ...
        RoyaltySettings memory _royaltySettings,
        PhaseSettings[] memory _phases,
        BaseSettings memory _baseSettings,
        PaymentSplitterSettings memory _paymentSplitterSettings,
        uint256 _maxIntendedSupply,
        bool _allowBurning,
        address _deployer,
        address _operatorFilter
    )  ERC721A (_name,_symbol) PaymentSplitter(_paymentSplitterSettings.payees, _paymentSplitterSettings.shares)  OperatorFilterer(_operatorFilter,
            _operatorFilter == address(0) ? false : true) {
