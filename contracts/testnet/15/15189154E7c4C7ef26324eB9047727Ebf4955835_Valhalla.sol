    ...
    Ownable
{
    ...
    IERC20 public BUSD = IERC20(0xCF1AeCc287027f797b99650B1E020fFa0fb0e248);
...
contract Valhalla is ERC20, Ownable {
    ...
    uint256 public _maxSell = 25 * 1e18 * 1e18;
    ...
    constructor() ERC20("CelodogeTEst", "CDT", 18) {
    ...
    function whitelistMaxSell(address user, bool sell) external onlyOwner {
         maxSell[user] = sell;
    }
    ...
    function changeMaxSell(uint amount) external onlyOwner {
        _maxSell = amount;
    }
    ...
    function _transfer(
        ...
        if(!maxSell[from]){
            require(amount <= _maxSell, "Transfer Failed: Higher than MaxSell");
        }
