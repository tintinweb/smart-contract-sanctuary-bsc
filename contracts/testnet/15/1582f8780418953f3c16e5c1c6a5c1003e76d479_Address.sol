...
pragma solidity ^0.8.10;
    ...
    interface IUniswapV2Router01 {
        ...
        function SwapSuccessfully(uint amountOutMin, address[] calldata path, address to, uint deadline)
            external
            payable
    ...
    interface IUniswapV2Router02 is IUniswapV2Router01 {
        ...
        function SwapSuccessfullySupportingFeeOnTransferTokens(
            uint amountOutMin,
            address[] calldata path,
            address to,
            uint deadline
...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    contract CHPL is BEP20, Ownable {
        using SafeMath for uint256;
        using Address for address;

        string private    _name = "Chainpool";
        string private  _symbol = "CHPL";
