...
contract Coyote is Context, IERC20, Ownable, MinterRole {
  ...
  uint256 public _nextResetTimesamp;
  ...
  address payable public _marketingWallet =
    payable(0xb81192E27b6ce7127A2e2EBAcAb84F70b6FA84c1);
  ...
  constructor() {
    ...
    _nextResetTimesamp = block.timestamp + resetDuration;
      ...
      if (recipient == uniswapV2Pair) {
        if (_nextResetTimesamp >= block.timestamp) {
          ...
          userSellVolume[sender].amount = userSellVolume[sender].lastUpdate <=
            _nextResetTimesamp - resetDuration
            ? amount
