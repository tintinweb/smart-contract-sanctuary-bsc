...
contract TESTANO is Context, IBEP20, Ownable {
    ...
    string private constant _symbol   = "TESOO";
    uint8  private constant _decimals = 9;
    
    uint256 private  _percentageOfLiquidityForTeam       = 1200;
    ...
    uint256 public _antiWhaleThreshold = _tTotal * 1 / 200; // 1% of total supply
