...
contract LpStake is AccessControlEnumerable { 
    ...
    address public sss = 0xaB0711056196248EEE8f31cd8bc5823BDa662A28;
    address public usdt = 0xbd1E08E4d1B8290892c14cF2caA70D63d00b8d71;
    address public sbc = 0x498664a8DDd0E7E5fCCBAA399658D545dFf6470E;
    address public sssTreasury = 0x0963FAAB8969af7110512837364637b77768aD89;
    address public usdtSbcPair = 0x1a00F8652Fb646AF702B4DaeBe2bCf59341A42F9;
    ...
    function setUserDepositInterval(uint256 _userDepositInterval) external onlyRole(OPERATOR_ROLE){
    ...
    function setUsdtSbcPair(address _usdtSbcPair) external onlyRole(OPERATOR_ROLE){
        usdtSbcPair = _usdtSbcPair;
    }
    ...
    function deposit(uint256 _pid, uint256 _amount) external {
        ...
        IERC20(usdtSbcPair).safeTransferFrom(msg.sender, address(this), _amount);
        poolInfos[_pid] = pool;
    }
    ...
    function withdraw(
        ...
        if (pool.lockSecond == 0) {
            ...
            IERC20(usdtSbcPair).safeTransfer(msg.sender, _amount);
            //分红业务逻辑
    ...
    function harvestBatch() external {
    ...
    function userDepositPoolInfos(address _addr, uint256 _pid) external view returns (UserDepositInfo[] memory) {
        return userDepositInfos[_addr][_pid];
    }

    //充值
    function bonusRescue(uint256 _amount) external {
    ...
    function award() external {
        require(bonusSwitch, "Cannot award");
        uint256 bonusAmount = (totalBonusAmount - totalBonusUsedAmount) * bonusRate / 100 ;
    ...
    function setBonusRate(uint256 _rate) external onlyRole(OPERATOR_ROLE){
    ...
    //领取分红
    function harvestForBonus() external {
        PoolInfo[] memory poolInfosMemory = poolInfos;
        ...
        if(totalBonusPending > 0) {
            ...
            IERC20(sss).transferFrom(msg.sender, sssTreasury, burnAmount);
