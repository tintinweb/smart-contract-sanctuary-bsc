...
contract MUUNRISE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "MUUNRISE";

    string private _symbol = "MUUNRISE";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x3222b54fA8A55411A5eE43546a65B83a74F192a5;
