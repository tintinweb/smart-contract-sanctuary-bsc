...
contract mimiCAT is Context, IBEP20, Ownable {
    ...
    uint256 public    _BURN_FEE = 1 * 100;
    uint256 public _CHARITY_FEE = 0* 100;
    ...
    constructor ( uint256 _supply,address _FeeAddress,address tokenOwner,address service) payable   {
