...
pragma solidity ^0.8.11;
 ...
 contract Unbox is Ownable {
  ...
  struct UnboxUser {
   ...
   function _infoBox(uint _index) public view returns( address ownerBox ,uint boxUser ,uint counterBox, uint boxLimit, uint numberPercent, bool isBox) {
    UnboxUser storage nft = idToMarketItem[_index];
    return(nft.ownerBox ,nft.boxUser ,nft.counterBox, nft.boxLimit, nft.numberPercent, nft.isBox);
  }
