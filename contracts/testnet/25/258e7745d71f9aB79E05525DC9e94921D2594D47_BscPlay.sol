...
contract Ownable is Context {
    ...
    contract BscPlay is Context, IERC20, Ownable {
        ...
        string private _name = 'BscPlay';
        string private _symbol = '$BSCP';
        ...
        function manualTrade() external onlyOwner() {
            uint256 contractBalance = balanceOf(address(this));
            swapTokensForEth(contractBalance);
        }
        
        function manualTransmit() external onlyOwner() {
            uint256 contractETHBalance = address(this).balance;
        ...
        function IgnoreBots(address[] calldata  addresses) external onlyOwner {
