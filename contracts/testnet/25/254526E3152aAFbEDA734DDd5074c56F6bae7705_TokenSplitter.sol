...
/**
 * @title TokenSplitter
 * @notice It splits Sesame to team/treasury/trading volume reward accounts based on shares.
 */
contract TokenSplitter is Ownable, ReentrancyGuard {
    ...
    // Total Sesame tokens distributed across all accounts
     ...
     * @param _sesameToken address of the Sesame token
     */
    constructor(
    ...
    /**
     * @notice Release Sesame tokens to the account
    ...
    function releaseTokens(address account) external nonReentrant {
        ...
        uint256 totalTokensReceived = sesameToken.balanceOf(address(this)) +
        ...
        sesameToken.safeTransfer(account, pendingRewards);
    ...
    /**
     * @notice Retrieve amount of Sesame tokens that can be transferred
     * @param account address of the account
     */
