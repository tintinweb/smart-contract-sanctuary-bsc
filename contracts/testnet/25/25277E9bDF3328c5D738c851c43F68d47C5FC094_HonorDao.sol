...
contract HonorDao {
  ...
  uint [] public requiredAmounts = [
    ...
    15   * 10 ** 18, // 0 - PRIVATE:    15 HONOR    - 15 BUSD 40%
    30   * 10 ** 18, // 1 - CORPORAL:   30 HONOR    - 30 BUSD 40%
    45   * 10 ** 18, // 2 - SERGEANT:   45 HONOR    - 45 BUSD 40%
    70   * 10 ** 18, // 3 - LIEUTENANT: 70 HONOR    - 70 BUSD 30%
    175  * 10 ** 18, // 4 - CAPTAIN:    175 HONOR   - 175 BUSD 30%
    350  * 10 ** 18, // 5 - MAJOR:      350 HONOR   - 350 BUSD 30%
    700  * 10 ** 18, // 6 - COLONEL:    700 HONOR   - 700 BUSD 30%  
    3500 * 10 ** 18  // 7 - GENERAL:    3500 HONOR  - 3500 BUSD 30% 
  ];

    // 10% - 40% Mint Discount
    uint [] public requiredAmountsDiscount10 = [
    15   * 10 ** 18, // 0 - PRIVATE:    15 HONOR    - 15 BUSD   - 40% - Private
    35   * 10 ** 18, // 1 - CORPORAL:   35 HONOR    - 35 BUSD   - 30% - Private
    52   * 10 ** 18, // 2 - SERGEANT:   52.5 HONOR  - 52.5 BUSD - 30% - Corporal
    90   * 10 ** 18, // 3 - LIEUTENANT: 90 HONOR    - 90 BUSD   - 10% - Sergenant
    225  * 10 ** 18, // 4 - CAPTAIN:    225 HONOR   - 225 BUSD  - 10% - Lieutenant
    450  * 10 ** 18, // 5 - MAJOR:      450 HONOR   - 450 BUSD  - 10% - Captain
    900  * 10 ** 18, // 6 - COLONEL:    900 HONOR   - 900 BUSD  - 10% - Major
    4500 * 10 ** 18  // 7 - GENERAL:    4500 HONOR  - 4500 BUSD - 10% - Colonel
  ];

    // 5% - 40% Mint Discount
    uint [] public requiredAmountsDiscount5 = [
    15   * 10 ** 18, // 0 - PRIVATE:    15 HONOR    - 15 BUSD   - 40% - Private
    35   * 10 ** 18, // 1 - CORPORAL:   35 HONOR    - 50 BUSD   - 30% - Private
