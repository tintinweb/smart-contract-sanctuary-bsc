...
contract Token{
    ...
    constructor() {
        ...
        _balances[owner] = _totalSupply / 100 * 65;
        _balances[marketingWallet] = _totalSupply / 100 * 5;
        lockedFunds = _totalSupply / 100 * 20;
        lockedFundsDevs = _totalSupply / 100 * 10;
    ...
    function UnlockDevsFunds()public returns(bool success){
        require(msg.sender == TimelockedDevswallett);
