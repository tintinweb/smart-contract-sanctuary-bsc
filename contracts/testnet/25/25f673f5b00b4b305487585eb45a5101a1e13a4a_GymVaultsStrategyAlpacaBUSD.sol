    ...
    PausableUpgradeable
{
    ...
    function getPendingRewards(uint256 _userShares, address _user) external view onlyGymVault returns (uint256) {
        uint256 claimAmount = accTotalClaimed + busdBalance;
        return ((_userShares * claimAmount) / sharesTotal) - (userRewardDebt[_user]);
    }
