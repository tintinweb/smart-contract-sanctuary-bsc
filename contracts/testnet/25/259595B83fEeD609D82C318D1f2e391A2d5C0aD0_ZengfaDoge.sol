...
contract ZengfaDoge is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xd337A343940931ac2E1524AaC749778C6DC1Ec78));
        marketingWalletAddress = payable(address(0xd337A343940931ac2E1524AaC749778C6DC1Ec78));
