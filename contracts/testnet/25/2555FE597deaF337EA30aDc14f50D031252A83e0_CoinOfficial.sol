...
contract CoinOfficial is ERC20, Ownable {
    ...
    constructor() ERC20("Coin Official", "VOTE") {
        ...
        COAntiBot =  0xD9F679536b58eb81bb07Aa4cb55F44fc14b200E8;
        CoinOfficialAntiBot(COAntiBot).setTokenOwner(msg.sender);
        antiBotEnabled = true;

        treasuryWallet = 0xc34c892eE51FfF31a5185380fEABb4E0ea77f8cf;
       ...
       // Mint Function Only Called Once
        _mint(0xc34c892eE51FfF31a5185380fEABb4E0ea77f8cf, totalSupply);
    }
