...
pragma solidity ^0.6.12;
    ...
    contract FlyPaper is Context, IERC20, Ownable {
        ...
        constructor (address payable charityWalletAddress) public {
            ...
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x18272e99414d943626f8A03E55564638E78CCFdF); // UniswapV2 for BSC network
        ...
        function excludeAccount(address account) external onlyOwner() {
            require(account != 0x18272e99414d943626f8A03E55564638E78CCFdF, 'We can not exclude Uniswap router.');
