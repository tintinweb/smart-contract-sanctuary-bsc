...
function transferTrx(address payable _to) public payable {
...
contract TronExpert is TronAbstract{
    ...
    function Donation(uint256 _planId,address _phAddress,uint256 _timestamp) public override {
        ...
        transferTrx(payable(_ghAddress));
       
        if(plan.HelpHash[index].gotHelp1 == address(0)){
            plan.HelpHash[index].gotHelp1= _phAddress;
        }
        else{
            plan.HelpHash[index].gotHelp2= _phAddress;
        }
