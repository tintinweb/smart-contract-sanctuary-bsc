 ...
 */
contract WrappedinCube is Context, AccessControl, ERC20Burnable, ERC20Pausable {
     ...
     */
    constructor() public ERC20("Wrapped inCube", "wINC") {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "WrappedinCube: must have minter role to mint");
        _mint(to, amount);
    }
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "WrappedinCube: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "WrappedinCube: must have pauser role to unpause");
        _unpause();
    }
