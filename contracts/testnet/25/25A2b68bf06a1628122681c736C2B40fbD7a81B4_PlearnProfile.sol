...
import "contracts/utils/SafeBEP20.sol";
...
contract PlearnProfile is AccessControl, ERC721Holder {
    ...
    uint256 public numberPlearnToReactivate;
    uint256 public numberPlearnToRegister;
    uint256 public numberPlearnToUpdate;
    ...
    constructor(
        IBEP20 _plearnToken,
        uint256 _numberPlearnToReactivate,
        uint256 _numberPlearnToRegister,
        uint256 _numberPlearnToUpdate
    ) {
        plearnToken = _plearnToken;
        numberPlearnToReactivate = _numberPlearnToReactivate;
        numberPlearnToRegister = _numberPlearnToRegister;
        numberPlearnToUpdate = _numberPlearnToUpdate;
    ...
    function createProfile(
        ...
        plearnToken.safeTransferFrom(_msgSender(), address(this), numberPlearnToRegister);
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        plearnToken.safeTransferFrom(_msgSender(), address(this), numberPlearnToUpdate);
    ...
    function reactivateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        plearnToken.safeTransferFrom(_msgSender(), address(this), numberPlearnToReactivate);
    ...
    function claimFee(uint256 _amount) external onlyOwner {
        plearnToken.safeTransfer(_msgSender(), _amount);
    }
     ...
     * Callable only by owner admins.
     */
    function updateNumberPlearn(
        uint256 _newNumberPlearnToReactivate,
        uint256 _newNumberPlearnToRegister,
        uint256 _newNumberPlearnToUpdate
    ) external onlyOwner {
        numberPlearnToReactivate = _newNumberPlearnToReactivate;
        numberPlearnToRegister = _newNumberPlearnToRegister;
        numberPlearnToUpdate = _newNumberPlearnToUpdate;
    }
