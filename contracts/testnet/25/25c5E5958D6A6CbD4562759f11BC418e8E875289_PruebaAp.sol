...
contract PruebaAp is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _maxTxAmount = 2000000 * 10**_decimals; // 2% of total supply
        _maxWalletBalance = 4000000 * 10**_decimals; // 4% of total supply
        _marketingWalletAddress = 0x2F48005C6B3927BB451A0427bD58991A30c70e13; // Marketing wallet 
        _devWalletAddress = 0x2F48005C6B3927BB451A0427bD58991A30c70e13; // Dev wallet 
    ...
    function setMaxWalletBalance(uint256 maxBalancePercent) external onlyOwner {
     ...
     function setSellFeePercent(uint256 tFee, uint256 lFee, uint256 mFee, uint256 dFee) external onlyOwner {
        _sellTaxFee = tFee;
