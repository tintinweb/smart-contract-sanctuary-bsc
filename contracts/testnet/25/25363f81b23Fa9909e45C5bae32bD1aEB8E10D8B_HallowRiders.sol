...
// t.me/HallowRiders
// http://hallowriders.site/
// https://www.twitter.com/hallowriders
...
contract HallowRiders  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x2fff846a60819468D0e951A2FA85cFF775Fa0e95); 
    address payable public Wallet_Dev = payable(0x0eb273Cb232A136Ee6f829aFe31ea24bd288BED1);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address private _authorized = 0x1b95b891491972901B6F9767038B206A40032477;


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**6 * 10**_decimals;
    string private constant _name = "HallowRiders"; 
    string private constant _symbol = unicode"$LORIDE"; 
    ...
    constructor () {
        ...
        _owner = 0x1b95b891491972901B6F9767038B206A40032477;
