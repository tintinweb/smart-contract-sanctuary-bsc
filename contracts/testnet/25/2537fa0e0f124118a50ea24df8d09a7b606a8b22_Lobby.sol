...
contract Lobby is ReentrancyGuard {
    ...
    address public immutable wethAddress = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    ...
    uint256 public minBetAmount;       // Minimum required bet amount.
    uint256 public decisionBlock;      // This block's blockhash will be used to decide winner.
     ...
     */
    function placeBet(uint256 amount) public onlyHuman unbanned nonReentrant payable {
    ...
    function joinToGame(address player, uint256 amount) internal returns(bool) {
        ...
        decisionBlock = block.number + (currentRound.remainSeconds / 3);
        currentRound.winnerSelectedTime = block.timestamp + currentRound.remainSeconds;
    ...
    function _decideCurrentWinner() internal returns(bool) {
        ...
        uint256 seed = uint256(keccak256(abi.encode(decisionBlock, currentRound.totalPlayers)));
    ...
    function isDOGELobby() public view returns(bool) {
