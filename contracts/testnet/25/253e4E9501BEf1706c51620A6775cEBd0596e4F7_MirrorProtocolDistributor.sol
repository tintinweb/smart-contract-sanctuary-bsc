...
contract MirrorProtocolDistributor is ERC20Upgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function initialize(address rewardRouter_, address rewardToken_, string memory distributorName_) public initializer {
        __Ownable_init();
