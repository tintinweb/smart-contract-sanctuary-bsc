...
contract LPMining is Ownable {
    ...
    function setbonusCoe(uint pid_, uint first_, uint second_) public onlyOwner{
        poolInfo[pid_].bonusCoe[0] = first_;
        poolInfo[pid_].bonusCoe[1] = second_;
    }

    function setlevel(uint pid_, uint inviteRequirement_, uint levelTwoDividend_) public onlyOwner {
