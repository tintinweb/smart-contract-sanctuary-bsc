...
contract HIGH is Context, IERC20, Ownable {
    ...
    address public marketing = 0x5C8FF66C27525960ee5dAfaCE1F02a4fC5182d2e;
    ...
    event SetMaxBal(uint256 maxBalPercent);
    ...
    function setMaxBal(uint256 maxBal) external onlyOwner() {
        _maxBalAmount = maxBal;
        emit SetMaxBal(maxBal);   
    }
