...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ETH = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); // ETH
    address WBNB;
    IDexRouter router;
...
contract ETHEREUMAFRICA is IBEP20, Ownable {
    ...
    address ETH = 0x2170Ed0880ac9A755fd29B2688956BD959F933F8; // ETH
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address public WBNB;

    string constant _name = "Ethereum Africa"; // Name
    string constant _symbol = "EA"; // Symbol
    uint8 constant _decimals = 9; // Decimals

    uint256 _totalSupply = 100000000 * (10**_decimals); // Total Supply
    ...
    // buy tax fee
    uint256 public reflectionFeeOnBuying = 50; // 5% will be distributed among holder as ETH divideneds
    uint256 public liquidityFeeOnBuying = 0; // 3% will be added to the liquidity pool
    uint256 public burnFeeOnBuying = 0; // 2% will go to the award pool address
    uint256 public marketFeeOnBuying = 50; // 2% will go to the market wallet address

    // sell tax fee
    uint256 public reflectionFeeOnSelling = 50; // 8% will be distributed among holder as ETH divideneds
    uint256 public liquidityFeeOnSelling = 0; // 3% will be added to the liquidity pool
    uint256 public burnFeeOnSelling = 0; // 2% will go to the award pool address
    uint256 public marketFeeOnSelling = 50; // 2% will go to the market wallet address
