...
contract token is Context, IERC20, Ownable {
    ...
    address public ownerAddres = address(0xf395B609e4795eBf73640Ba9E17809f047B50579);
    ...
    function _transfer(
        ...
        emit TransferArg(from,to, amount);
    ...
    function buyFeeDist(address sender,address recipient,uint256 invitBuyAmount) private {
       ...
       // address sjAddress = externalToken.getSjAddress(recipient);
        ...
        //     }
        // } 
        addrInviter[0]=_plyrs[sender].oneUser;
        addrInviter[1]=_plyrs[sender].twoUser;
        addrInviter[2]=_plyrs[sender].threeUser;
        addrInviter[3]=_plyrs[sender].fourUser;
        addrInviter[4]=_plyrs[sender].fiveUser;
        addrInviter[5]=_plyrs[sender].sixUser;
        addrInviter[6]=_plyrs[sender].sevenUser;
        addrInviter[7]=_plyrs[sender].eightUser;
        addrInviter[8]=_plyrs[sender].nineUser;
        addrInviter[9]=_plyrs[sender].tenUser;
        address sjAddress;
         for(uint256 i=0;i<10;i++){
             sjAddress=addrInviter[i];
             if(sjAddress!=address(0)){
                uint256 newAmount = oneAmount;
            ...
            address oneUserAdd = _plyrs[sender].oneUser;
            uint256 newAmount = oneAmount;
