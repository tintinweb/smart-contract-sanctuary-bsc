...
contract Degen is Ownable {
    ...
    IUni public PanCake = IUni(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //main network address for panCake
    address public USDT = address(0x46176868317B37e80D429aF8C32E1969624F40B4); // USDT token on BSC main net
