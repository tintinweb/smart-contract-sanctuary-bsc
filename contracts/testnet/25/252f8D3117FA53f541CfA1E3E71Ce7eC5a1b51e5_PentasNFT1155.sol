    ...
    ERC1155SupplyUpgradeable
{
    ...
    /**
     * @dev Helper function to check if token exist. This function is available for ERC721 but not in ERC1155
     */
    function _exists(uint256 tokenId) internal view returns (bool) {
        return _tokenData[tokenId].minter != address(0);
    }
    ...
    function burn(uint256 tokenId, uint256 amount) public {
        ...
        require(
            ...
            "Pentas: Token balance is not enough"
        );
