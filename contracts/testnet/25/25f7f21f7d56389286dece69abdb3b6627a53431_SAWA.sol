...
contract SAWA {  
    ...
    function transferERC20( address _to, uint _amount) public {
    ...
    function transferBUSD( address _to, uint _amount) public {
    ...
    function buyTocken(uint _amount) public {
        ...
        transferBUSD(msg.sender, _amountBUSD); 

        _amount = (_amount - _tgeSum) / countSteps;
    ...
    function withdrawTokensBUSD(uint _step, uint _amount) public {
        require(balances[msg.sender][_step] >= 0, "Balance equal zero");
        require(timeLocksForSteps[_step] < block.timestamp, "Tokens is locked");
        balances[msg.sender][_step] = balances[msg.sender][_step] - _amount;
        transferBUSD(msg.sender, _amount);
    }
