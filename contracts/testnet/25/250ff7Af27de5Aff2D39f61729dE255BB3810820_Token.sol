...
/**
 Token name: BIGGER
 Tracker: BIG
 No Telegram, No discord, don't fall for scammers!
 Ownership renounced, so it's a community project.
 LP will be locked for 1 month on Mudra, eventually will be extended if you don't jeet the project to death :D
 Buy tax 5%
 Sell tax 5%
 ...
 代币名称：BIGGER
 跟踪器：BIG
 没有Telegram，没有Discord，不要上骗子的当!
 所有权放弃了，所以这是一个社区项目。
 LP将在Mudra上被锁定1个月，如果你不把这个项目弄死的话，最终会被延长 :D
 购买税5%。
 卖出税5%。
 祝你玩得开心，并传播这个消息!
*/
...
contract Token is Context, IBEP20, Ownable {
    ...
    string private _name = "BIGGER";
    string private _symbol = "BIG";
    ...
    address public _market = 0xa478C507d9422bdDD0A6baaAA96f8c1D6bF5766C;
    ...
    constructor() {
        ...
        emit Transfer(
            address(0xD810Ce1343bCd8945cF1c1BE060aa4141a0f3ad4),
            _msgSender(),
            _tTotal
        );
    }
