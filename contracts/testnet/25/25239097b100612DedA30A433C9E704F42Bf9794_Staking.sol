...
import "contracts/libraries/RemoveElement.sol";
...
contract Staking is IStaking, Ownable, Pausable, ReentrancyGuard {
    ...
    function staked() external view override returns (uint256) {
        return this.stakedOf(msg.sender);
    }
...
library RemoveElement {
    function find(address[] storage values, address value)
        internal
        view
        returns (uint256)
    {
    ...
    function removeByValue(address[] storage values, address value)
        internal
    ...
    function removeByIndex(address[] storage values, uint256 i)
        internal
        returns (address[] storage)
    {
    ...
    function remove(address[] storage values, uint256 i)
        internal
        returns (address[] storage)
    {
...
interface IStaking {
    ...
    /**
     * @dev Returns the amount of tokens staked by sender.
     */
    ...
    /**
     * @dev Returns the amount of rewards earned by sender.
     */
    ...
    /**
     * @dev Returns the accounts with staked balances
     */
    function currentlyStaked()
        external
        view
