...
contract StarBank is ERC20Detailed, Ownable {
    ...
    string public _name = "Star Bank";
    string public _symbol = "SBANK";
    ...
    uint256 public starbankInsuranceFundFee = 10;
    ...
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(starbankInsuranceFundFee).add(
            firePitFee
        );
    ...
    address public starbankInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("Star Bank", "SBANK", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x9b91B9f48805db9C586eD604Aaa5752EBdee0A59;
        treasuryReceiver = 0xfadDD1CFBd4D323e166cB63035571286420F9E49; 
        starbankInsuranceFundReceiver = 0x7b09Bf93Fc98056dCdD90e4b27454B04bAb8CF64;
        firePit = 0x9b91B9f48805db9C586eD604Aaa5752EBdee0A59;
    ...
    function takeFee(
        ...
        uint256 _starbankInsuranceFundFee = starbankInsuranceFundFee;
        ...
        if (recipient == pair) {
            ...
            _starbankInsuranceFundFee = starbankInsuranceFundFee.add(sellFees);
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(starbankInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(starbankInsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(starbankInsuranceFundReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(starbankInsuranceFundFee).div(
                treasuryFee.add(starbankInsuranceFundFee)
            ),
            gas: 30000
        }("");
   ...
   antiBotEnabled = _enable;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no BANK token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _starbankInsuranceFundReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        starbankInsuranceFundReceiver = _starbankInsuranceFundReceiver;
        firePit = _firePit;
    }
