   ...
   
{
    ...
    mapping (address => uint256) private tOwner;
    ...
    function setTeamFeePercent(uint256 updatedBUYTeamFee, uint256 updatedSELLTeamFee) external onlyOwner {
        _BUYTeamFee = updatedBUYTeamFee;
        _SELLTeamFee = updatedSELLTeamFee;
        
    }

    
    function setLiquidityFeePercent(uint256 updatedBUYLiquidityFee, uint256 updatedSELLLiquidityFee) external onlyOwner {
        _BUYLiquidityFee = updatedBUYLiquidityFee;
        _SELLLiquidityFee = updatedSELLLiquidityFee;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal override{
        ...
        if (
            ...
            collectBNB(contractTokenBalance);(contractTokenBalance);
        }
    ...
    function _approve(address towner, address spender, uint256 amount) internal override {
