...
contract TEST is IBEP20, Auth {
    ...
    function enable_nuisance(bool _status) public onlyOwner {
     ...
     function onOff_meta(bool _status) public onlyOwner {
        metaMode = _status;
    }
    ...
    function tx_exempt(address holder, bool exempt) external authorized {
        isTxLimitExempt[holder] = exempt;
    }

    function cooldown_exempt(address holder, bool exempt) external authorized {
