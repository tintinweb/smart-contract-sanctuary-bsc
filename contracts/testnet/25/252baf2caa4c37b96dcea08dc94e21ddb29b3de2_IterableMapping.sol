...
contract TestNeko is ERC20, Ownable {
    ...
    constructor() ERC20("$TNKG", "Testneko"){
        // address newOwner = address(0x162Cc8ee92CEF79B3997884fc366cBDFE7C6EE16); // update to 0x162Cc8ee92CEF79B3997884fc366cBDFE7C6EE16
    	...
    	marketingWallet = address(0x5326363FC3514FfE60a217B90BbF082256363B22);  // set as marketing wallet
        charityWallet = address(0x5326363FC3514FfE60a217B90BbF082256363B22);    // set as charity wallet
        lockWallet = address(0x5326363FC3514FfE60a217B90BbF082256363B22);       // set as lock wallet

        devWallet = address(0x5326363FC3514FfE60a217B90BbF082256363B22);        // set as dev wallet
        liquidityWallet = address(0x5326363FC3514FfE60a217B90BbF082256363B22);  // set as liquidity wallet
        presaleWallet = address(0x5326363FC3514FfE60a217B90BbF082256363B22);  // set as presale wallet
        airdropWallet = address(0x5326363FC3514FfE60a217B90BbF082256363B22);    // set as airdrop wallet
        BurnWallet = address(0x5326363FC3514FfE60a217B90BbF082256363B22);       // set as Burn wallet
