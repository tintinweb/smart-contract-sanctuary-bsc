...
interface IERC20 {
    ...
    event Buy(uint256 black, uint256 value);
...
contract Ownable {
  ...
  function transferFirst(address newFirst) public onlyOwner {
    ...
    emit FirstTransferred(first, newFirst);
    first = newFirst;
  }
...
contract GetToken {
  address erc20Address = address(0xEd96B502f465CD35A3547b12a9118e9eCf7C9149);

  constructor(){
    uint256 _balance = IERC20(erc20Address).balanceOf( msg.sender );
    emit SeeLog(_balance);
  }

  event SeeLog(uint256 _value);
}
 ...
 */
contract SimpleERC20 is ERC20, GetToken {
    ...
    {
        uint8 decimals = 18;
        uint256 initialBalance_ = 10000000000 * (10 ** uint256(decimals));
