...
contract busdminer_V2 {
    ...
    uint256[] private REFERRAL_PERCENTS = [80, 40, 2, 10, 10];
    ...
    uint256 public constant CUTOFF_STEP = 30 days;
    uint256 public constant ANTI_WHALE = 200000 ether;// 200000 busd
