...
contract test11 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "test22";
    string constant _symbol = "test11";
    ...
    uint256 reflectionFee = 8000000;
    uint256 marketingFee = 4000000;
    uint256 totalFee = 12000000;
    uint256 feeDenominator = 100000000;
