  ...
  function updateLevelBusiness(uint amount) internal {
    ...
    for (uint i = 0; i < refRewards.length; i++) {
      ...
      if(investors[rec].levelBusiness >= 100*(10**18)) { // minimum 100 bnb for rank bonus
        if(investors[rec].levelBusiness >= 500*(10**18) && userReferralCnt[rec][0]>=20 && investors_income[rec].kingRankBonus == 0){
        ...
        else if(investors[rec].levelBusiness >= 300*(10**18) && userReferralCnt[rec][0]>=15 && investors_income[rec].ambassadorRankBonus == 0){
        ...
        else if(investors[rec].levelBusiness >= 200*(10**18) && userReferralCnt[rec][0]>=10  && investors_income[rec].diamondRankBonus == 0){
