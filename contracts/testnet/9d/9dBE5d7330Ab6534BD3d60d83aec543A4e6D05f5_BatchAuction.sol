...
//contract BatchAuction {
  ...
  uint256 private WITHDRAW_CAP_INTERCEPT = 28571428571e7; // (14/49)x
  uint256 private WITHDRAW_CAP_INTERCEPT_PLUS = 357142857143e7; // +(175/49)
  ...
  function _withdrawableAmount(address _user) internal view returns (uint256) {
    ...
    if (total <= WITHDRAW_CAP_MIN) {
      ...
      return (total.mul(14).add(175)) / 49;
    } else { 
