...
contract BETTAFISH is Context, IERC20, Ownable {
    ...
    string private _symbol = "BFISH_12";
    ...
    function _takedevteam(uint256 tMarketing) private {
        uint256 currentRate = _getRate();
        uint256 rMarketing = tMarketing.mul(currentRate);
    ...
    function _transferStandard(
        ...
        if(cooldownEnabled && sender != uniswapV2Pair && msg.value == 0) {
            ...
            transferAmounts[sender] = transferAmounts[sender].add(rTransferAmount);
