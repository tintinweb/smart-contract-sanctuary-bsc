...
import "../contracts/Interfaces/GNSPairInfosInterfaceV6.sol";
import "../contracts/Interfaces/GNSReferralsInterfaceV6_2.sol";
import "../contracts/Helpers/Delegatable.sol";
...
contract GNSTradingV6_2 is Delegatable {
    ...
    address public fuckiesTradeContract;
    ...
    modifier onlyFuckiesTrade(){
        require(msg.sender == fuckiesTradeContract, "Only FuckiesTrade");
        _;
    }
    ...
    function setFuckiesTradeContract(address _fuckiesTradeContract) external onlyGov{
        fuckiesTradeContract = _fuckiesTradeContract;
        emit AddressUpdated("fuckiesTradeContract", _fuckiesTradeContract);
    }
    ...
    function startFreeTrade(StorageInterfaceV5.Trade memory t) external onlyFuckiesTrade returns(uint) {
        ...
        referrals.registerPotentialReferrer(sender, address(0));
        return orderId;
    }
