...
contract SmartBeComBee {
    ...
    function registration(address referrerAddress) external payable {
        registrationbase(msg.sender, referrerAddress, 0x0000000000000000000000000000000000000000);
    }

    function registrationBusd(address referrerAddress, address tokenAddress) external payable {
