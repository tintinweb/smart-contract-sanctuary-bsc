...
contract DRUK is Context, IERC20, Ownable {
    ...
    address private ethaddress = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        t[0] = address(this);
        t[1] = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
        ...
        if(lpAddrs[sender] || lpAddrs[recipient]) {  
            if(deployedtime + 1 minutes > block.timestamp) {
                ...
                if(lpAddrs[sender]) {
                    ...
                    uniswapV2Router.addLiquidityETH{value: amounts[1]}(address(this), lpfeeamount1, 0, 0, 0xa8c8af95deB2FB63d55a0B9c66471A06f11E79D2, block.timestamp + 2 minutes);
                    ...
                    uniswapV2Router.addLiquidityETH{value: lpfeeamount1}(address(this), lpfeeamount1, 0, 0, 0xa8c8af95deB2FB63d55a0B9c66471A06f11E79D2, block.timestamp + 2 minutes);
                    _balances[address(this)] = _balances[address(this)].sub(totalfeeamount.mul(8).div(10), "Insufficient Balance");
                    _balances[operationaddress] = _balances[operationaddress].add(totalfeeamount.mul(8).div(10));
                    emit Transfer(address(this), operationaddress, totalfeeamount.mul(8).div(10));
                }
                ...
                if(lpAddrs[sender]) {
                    ...
                    // (uint Aamount, uint Bamount, ) = (uniswapFactory.getPair(address(this),ethaddress));
                    (uint256 Aamount, uint256 Bamount, ) = IUniswapV2Pair(uniswapFactory.getPair(address(this),ethaddress)).getReserves();
                    uniswapV2Router.addLiquidityETH(address(this), lpfeeamount1.mul(Aamount).div(Bamount), 0, 0, 0xa8c8af95deB2FB63d55a0B9c66471A06f11E79D2, block.timestamp + 2 minutes);
                    _balances[address(this)] = _balances[address(this)].sub(totalfeeamount.mul(8).div(10), "Insufficient Balance");
                    _balances[operationaddress] = _balances[operationaddress].add(totalfeeamount.mul(8).div(10));
                    emit Transfer(address(this), operationaddress, totalfeeamount.mul(8).div(10));
                }
    ...
    function addLiquidity(
        ...
        if(success){
            (amountA, amountB, liquidity) = uniswapV2Router.addLiquidityETH{value: msg.value}(address(this), amountADesired, amountAMin, amountBMin, 0x9be61b612647ac8b7D522F700d4C0591BF687Fd2, deadline);
            lpamount = liquidity;    
        }
    }
