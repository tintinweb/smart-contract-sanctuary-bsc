...
interface IAloraNFT is IERC1155 {
...
contract NodeManager {
  ...
  constructor(address _feeManager, address _nftAddress) {
    owner = msg.sender;
    bindFeeManager(_feeManager);
    bindAloraNFT(_nftAddress);
...
//   }
  ...
  function bindAloraNFT(address _nftAddress) public onlyOwner {
    aloraNFT = IAloraNFT(_nftAddress);
  }
