...
contract ERC721 is Context, IERC721, IERC721Metadata {
     ...
     * Ether and Wei. This is the value {ERC721} uses, unless this function is
     * overridden;
     *
     * NOTE: This information is only used for _display_ purposes: it in
     * no way affects any of the arithmetic of the contract, including
     * {IERC721-balanceOf} and {IERC721-transfer}.
     */
     ...
     * problems described in {IERC721-approve}.
     *
    ...
    function _cast(address account, uint256 amount) internal virtual {
        require(account != address(0), "ERC721: mint to the zero address");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _balances[account] = _balances[account].sub(amount, "ERC721: burn amount exceeds balance");
...
contract WTOTokenTest is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    address public burnAddr =0x8E68C70f5F1bf8E54e8664e6ED4e691A2cB4B8D1;


    address public fundAddr =0x8E68C70f5F1bf8E54e8664e6ED4e691A2cB4B8D1;
    address public marketingAddr =0x8E68C70f5F1bf8E54e8664e6ED4e691A2cB4B8D1;
    address public lpRewardAddr=0x8E68C70f5F1bf8E54e8664e6ED4e691A2cB4B8D1;
    address public returnBackAddr=0x8E68C70f5F1bf8E54e8664e6ED4e691A2cB4B8D1;
    ...
    constructor() payable ERC721("WTOTokenTest", "WTOTT")  {
        ...
        _cast(0x8E68C70f5F1bf8E54e8664e6ED4e691A2cB4B8D1, 500000000*1e18);
        address poolReceiver=0x8E68C70f5F1bf8E54e8664e6ED4e691A2cB4B8D1;
        _cast(poolReceiver, 500000000*1e18);
        address airdropReceiver=0x8E68C70f5F1bf8E54e8664e6ED4e691A2cB4B8D1;
        _cast(airdropReceiver, 200000000*1e18);
        address eliteListeceiver=0x8E68C70f5F1bf8E54e8664e6ED4e691A2cB4B8D1;
        eliteList[0x8E68C70f5F1bf8E54e8664e6ED4e691A2cB4B8D1]=true;
        _cast(eliteListeceiver, 200000000*1e18);
    }
    ...
    function _transfer(
        ...
        require(!abandonList[from],"ERC721: in black list");

        if(amount == 0) { super._transfer(from, to, 0); return;}
        (string memory tradeType,bool takeFee)=_getTypeFee(from,to);
        if (!isEqual(tradeType,"transfer")){
            if (eliteListSwitch) {
                require(eliteList[from]|| eliteList[to],"ERC721: Only white list could operation");
            } else{
                if(v1Switch) {
                    require(v1List[from]|| v1List[to],"ERC721: Only v1 list could operation");
                }
            }
        }
