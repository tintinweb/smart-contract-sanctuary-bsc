...
contract Token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2022 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "DR";
    string private _symbol = "DR";
    ...
    address public ownerAddres = address(0x532c3cd2CF36fc5A1F90d026FF9fF097bF10ec12);
    ...
    uint256 public _maxTxAmount = 2022 * 10 **18;
    uint256 private numTokensSellToAddToLiquidity = 8 * 10 **17;
    uint256 public  maxBurn = 1023 * 10 **18;
