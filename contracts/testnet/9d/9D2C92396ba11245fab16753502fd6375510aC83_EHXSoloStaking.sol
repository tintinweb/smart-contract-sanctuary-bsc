...
// File: contracts/EHXSoloStaking.sol
...
contract EHXSoloStaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(address _stakingToken, uint256 _apy, uint256 _lockDuration, uint256 _exitPenalty) {
    ...
    function emergencyRewardWithdraw(uint256 _amount) external onlyOwner {
        ...
        rewardsClaimed[msg.sender]+=_amount;      /////////UPDATE
        user.rewardsClaimTime= block.timestamp;                ////////////////////////////UPDATE
    ...
    function claimVestedTokens() external notPaused nonReentrant {
        ...
        if(pending > 0) {
            ...
            rewardsClaimed[msg.sender]+=pending;  
            user.rewardsClaimTime= block.timestamp;                ////////////////////////////UPDATE             /////////////////////UPDATE
            rewardToken.transfer(payable(address(msg.sender)), pending);
        }
