...
contract TestRole is ERC721, Ownable {
    uint currentTokenId;

    event Mint(address indexed addr, uint tokenId);
    ...
    function mint() public {
        uint id = currentTokenId + startTokenId();
    ...
    function startTokenId() public pure returns (uint) {
        return 1;
    }
}
