...
contract UberTaxiController7 is Ownable {
    ...
    constructor() {
        ...
        UTD = UberTaxiDate2(0x3e1B848fd1A6Ae7be557eDdfA4F9BE91C63fCdBd);
    }
    ...
    // function querryDataVehicle(uint256 index) public view returns(uint256 types,uint256 buyDays,uint256 vehicleState,uint256 expireTime,uint256 durability,uint256 tokenId,address hold,uint256 buyPrice,uint256 profit,uint256 totalProfit,uint256 sellPrice) {
    //     (types, buyDays, vehicleState, expireTime, durability, tokenId, hold, buyPrice, profit, totalProfit, sellPrice) = UTC.allVehicles(index);
    // }
