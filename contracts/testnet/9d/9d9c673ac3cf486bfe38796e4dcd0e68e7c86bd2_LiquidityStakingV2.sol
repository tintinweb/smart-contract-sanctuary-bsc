...
contract LiquidityStakingV2 is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public unlockDuration = 24 hours;
...
contract LiquidityPoolFactory is Ownable, AccessControl {
    ...
    address public teamWallet = 0x100DAF80419D16262B93Db9915BE959164D421B3;
    ...
    function deploy(
        ...
        LiquidityStakingV2 pool = new LiquidityStakingV2(_lp, _rewardToken, startTime.div(1 minutes));
        
        if (_rewardToken != address(0)) {
            require (_tokenAmountForPool > 0, "!reward");
            pool.setRewardRate(_tokenAmountForPool.div(_period));
