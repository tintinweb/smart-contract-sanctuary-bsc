    ...
    RewardRateConfigurable
{
    ...
    function activateRockstarRank(
        ...
        IStrategy(pool.strategy).buyAndBurn(gymNetworkAddress, _amount);
    ...
    function buyBurnTokens(uint256 _pid) external onlyOwner {
        ...
        IStrategy(pool.strategy).buyAndBurn(gymNetworkAddress, burnableAmount);
    }
...
interface IStrategy {
    ...
    function buyAndBurn(address _burnableToken, uint256 _amount) external;
