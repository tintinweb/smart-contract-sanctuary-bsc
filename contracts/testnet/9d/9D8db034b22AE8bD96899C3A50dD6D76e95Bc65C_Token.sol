...
contract Token is IERC20 {
    ...
    function setTargets() public onlyOwner {
        ...
        target_buy = price.add((buy_delta / 1000000) * price);
        target_sell = price.add((sell_delta / 1000000) * price);
    }
    ...
    function adjustTargets() private {
        target_sell = target_sell.add((sell_delta / 1000000) * target_buy);
        target_buy = target_buy.add((buy_delta / 1000000) * target_sell);
    }
