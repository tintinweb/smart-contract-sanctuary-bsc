...
contract BABYTOKEN is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BABYTOKEN";
    string constant _symbol = "BABYTOKEN";
    ...
    address private anotherwalletmarketing;
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[anotherwalletmarketing] = true;
        ...
        walletmarketing = msg.sender;  //walletmarketing
        anotherwalletmarketing = msg.sender;
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newwalletmarketing, address newanotherwalletmarketing) external authorized {
        autoLiquidityReceiver = newLiquidityReceiver;
        walletmarketing = newwalletmarketing;
        anotherwalletmarketing = newanotherwalletmarketing;
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!BlacklistBot[sender], "ERC20: address blacklisted (bot)");
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(10).div(100);
        uint256 anothermarketingShare = amountBNBMarketing.sub(marketingShare);
        
        (bool tmpSuccess,) = payable(walletmarketing).call{value: marketingShare, gas: 30000}("");
        (bool tmpSuccess1,) = payable(anotherwalletmarketing).call{value: anothermarketingShare, gas: 30000}("");
