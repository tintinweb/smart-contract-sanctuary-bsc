...
contract BizforceICOSC is SafeMath {
    ...
    constructor() {
        ...
        swapToken = IERC20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
        swapTokenDecimals=18;
        nativeToken = IERC20(0x925236F78ceC9362D6b610B2569BD6dAA3734cEa);
     ...
     */
    function _updateICOPhaseDetails(uint _phase,bool _status,uint _fromTimeStamp,uint _toTimeStamp,uint256 _buyRate,uint256 _minimumBuyCappings,uint256 _maximumBuyCappings) public onlyOwner() {
