...
contract RpayBEP20 is BEP20 {
    ...
    constructor() BEP20("Roundpay", "RPAY", 9) {
        ...
        DOMAIN_SEPERATOR = keccak256(
            abi.encode(
                keccak256(
                    "EIP712Domain(string memory name, string version, uint256 chainID, address verifyingContract)"
                ),
                keccak256(bytes("Roundpay")),
                keccak256(bytes("1")),
                chainID,
                address(this)
            )
