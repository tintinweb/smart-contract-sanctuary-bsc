...
contract FINAL is Context, IBEP20, Ownable  {
    ...
    uint256 private holder=1 ; 
    uint256 private notransfer=1 ;
...
//web3tokeninfo
    ...
    function TotalVolumeTransfer() public view  returns (uint256){
    return volume/10**18;
    }
    ...
    function TotalStakeWallet() public view  returns (uint256){
        return _walletstake;
    }
