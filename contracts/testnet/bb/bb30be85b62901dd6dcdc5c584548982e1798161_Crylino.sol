...
contract Crylino is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Crylino";
    string private _symbol = "crylino";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x89D4E258d626f46dFD72c89E1F960058F07C8f99); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x89D4E258d626f46dFD72c89E1F960058F07C8f99); // BuyBack Address
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (4 * 10**6 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
