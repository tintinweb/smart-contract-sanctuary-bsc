...
contract LFR is ERC20, Ownable {
    ...
    address public DIVIDEND_TOKEN = address(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); //Initially set to BSC BTCB (Binance Pegged BTC)
    ...
    uint256 public constant _maxWalletToken = 5000000 * (10**18); // 5% of total supply
