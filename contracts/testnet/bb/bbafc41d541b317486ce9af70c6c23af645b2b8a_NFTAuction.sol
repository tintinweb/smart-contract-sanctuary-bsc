...
contract NFTAuction {
    ...
    function _highestBidTransferNftAndPaySeller(
        address _nftContractAddress,
        uint256 _tokenId
    ) internal {
        address _nftSeller = nftContractAuctions[_nftContractAddress][_tokenId]
        ...
        uint256 addFees = _getPortionOfBid(_nftHighestBid , feesPercentage );
        _resetBids(_nftContractAddress, _tokenId);
        _payFeesAndSeller(
            _nftContractAddress,
            _tokenId,
            _nftSeller,
            _nftHighestBid + addFees
        );
        //reset bid and transfer nft last to avoid reentrancy
        uint256[] memory batchTokenIds = nftContractAuctions[
            _nftContractAddress
    ...
    {
        _highestBidTransferNftAndPaySeller(_nftContractAddress, _tokenId);
