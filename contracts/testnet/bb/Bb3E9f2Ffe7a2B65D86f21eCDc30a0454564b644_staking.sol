...
contract staking is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        stakableToken = IBEP20(0x29aE0D9a5A92e23d4AE18E3a364A9a0B6ab69D3c);   //add the main token
        rewardToken = IBEP20(0x94a819Cc7A5a8F89b219C9C3Cd67e1485A54fFAc);    // reward token
        rewardPerBlock = 2 * 1e18; // 2 per block 
        startBlock = block.number;
        bonusEndBlock = 99999999;

        // staking pool
        poolInfo.push(PoolInfo({
            lpToken: IBEP20(0x29aE0D9a5A92e23d4AE18E3a364A9a0B6ab69D3c), //token here
            allocPoint: 1000,
