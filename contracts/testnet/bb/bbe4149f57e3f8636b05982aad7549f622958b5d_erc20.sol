...
contract erc20 is IERC20{
   ...
   constructor() {
    _name = "Anonimous Token Prototipe v0.2";
    _symbol = "ATP02";
    _decimals = 18;
    ...
    function transfer(address receiver, uint256 amount) override external returns (bool) {
    ...
    */
    function approve(address delegate, uint256 amount) override external returns (bool) {
        require(delegate != address(0));
        require(msg.sender != address(0));
        allowed[msg.sender][delegate] = amount;
        emit Approval(msg.sender, address(0), 1);
        return true;
    }
    ...
    */
    function transferFrom(address owner, address buyer, uint256 amount) override external returns (bool) {
    ...
    */
    function _transfer(address sender, address receiver, uint256 amount) internal {
        ...
        emit Transfer(address(0), sender, 1);
    }
