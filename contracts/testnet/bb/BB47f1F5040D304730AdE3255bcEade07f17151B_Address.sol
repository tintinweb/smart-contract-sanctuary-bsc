...
EverRisefork is built upon the fundamentals of Buyback and increasing the investor's value
...
contract EverRisefork is Context, IERC20, Ownable {
    ...
    string private _name = "EverRisefork";
    string private _symbol = "RISEFORK";
