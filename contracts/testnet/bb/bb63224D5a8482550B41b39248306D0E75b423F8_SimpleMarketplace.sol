...
/** 
 *  SourceUnit: c:\Users\scobr\Documents\GitHub\wavi-contracts\contracts\SimpleMarketplace.sol
*/
...
contract SimpleMarketplace is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable{
    ...
    function listToken(address contractAddress, uint256 tokenId, uint256 amount, uint256 price) public nonReentrant returns(uint256) {
        ERC1155Upgradeable token = ERC1155Upgradeable(contractAddress);
    ...
    function purchaseToken(uint256 listingId, uint256 amount) public payable nonReentrant {
        ERC1155Upgradeable token = ERC1155Upgradeable(idToListing[listingId].contractAddress);
