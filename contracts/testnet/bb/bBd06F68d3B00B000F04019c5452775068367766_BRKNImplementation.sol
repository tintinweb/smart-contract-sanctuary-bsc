...
// File: contracts/BRKNImplementation.sol
...
/**
 * @title BRKNImplementation
 * @dev this contract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing BRKNImplementation
...
contract BRKNImplementation {
    ...
    string public constant name = "BRKN"; // solium-disable-line
    string public constant symbol = "BRKN"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all BRKN at the contract address.
     * This sends the BRKN tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimBRKN() external onlyOwner {
