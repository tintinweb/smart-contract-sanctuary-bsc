 ...
 */
contract tata is IBEP20, ReentrancyGuard, Context, Ownable {
    using Address for address;
	...
	uint256 public buyRewardFee   = 1; // 1% fee to distribute for holders on buy
    ...
    uint256 public buyBurnFee   = 1; // 1% fee will to burn on buy
	uint256 public sellBurnFee  = 5; // 5% fee will to burn on sell
	uint256 public otherBurnFee = 1; // 1% fee will to burn on other transaction

	uint256 public buyMarketingFee   = 1; // 1% fee to distribute for Marketing wallet on buy
	uint256 public sellMarketingFee  = 5; // 5% fee to distribute for Marketing wallet on sell
	uint256 public otherMarketingFee = 1; // 1% fee to distribute for Marketing wallet on other transaction
