...
contract DreamHorseController is Ownable {
    ...
    function selectMonster(uint256 monsterID,uint256 tokenId,uint256 forageNumber, uint256 horseshoeNumber) public {
        ...
        require(forageNumber <= forageOnceLimit && horseshoeNumber <= horseshoeOnceLimit,"This hero is unavailable");
        ...
        if(playResult){
            ...
            profit = (userSelectMonster.reward * 10 ** 4).mul(100 + 3 * forageNumber).div(100);
