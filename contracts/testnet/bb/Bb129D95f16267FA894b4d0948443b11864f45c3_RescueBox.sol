...
contract RescueBox is Ownable {
    ...
    function rescueBox(uint256 box1Quant,  uint256 box2Quant) public {
        emit historicRescueBox(msg.sender, box1Quant,   box2Quant);
    }

    event historicRescueBox(address indexed from, uint256 box1Quant,  uint256 box2Quant);
}