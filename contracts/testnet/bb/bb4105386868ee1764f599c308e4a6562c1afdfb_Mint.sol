...
contract Mint is Initializable, AccessControlUpgradeable {
    ...
    function  tokenURIByNameOfLand(string memory landsName) public view returns (string memory) {
    ...
    function  tokenURIByNameOfNode(string memory mintNodesName) public view returns (string memory) {
        return mintNodeName.tokenURIByDomain(mintNodesName);
    }

    function  tokenURIByNameOfMetaLoot(string memory metaLootsName) public view returns (string memory) {
