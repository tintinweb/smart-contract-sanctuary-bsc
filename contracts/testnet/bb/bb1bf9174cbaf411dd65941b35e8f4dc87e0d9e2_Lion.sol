...
// File: contracts/activity/lion/ERC721L.sol
...
// File: contracts/activity/lion/Lion.sol
  ...
  \  \:\    \  \::/      \  \:\  /:/      |  |:/:/ 
   \  \:\    \  \:\       \  \:\/:/       |__|::/  
    \  \:\    \__\/        \  \::/        /__/:/   
     \__\/                  \__\/         \__\/                                                                     
 */
contract Lion is Operator, ERC721L, ReentrancyGuard {

  uint256 public maxSupply = 5300;
  string private _baseTokenURI;

  constructor() ERC721L("LION", "LION", 100) {
    _baseTokenURI="https://api.hezi.io/v1/nft/box/test/tu/";
  }
  ...
  function mintLion(address _owner,uint256 amount) external nonReentrant onlyMiner{
