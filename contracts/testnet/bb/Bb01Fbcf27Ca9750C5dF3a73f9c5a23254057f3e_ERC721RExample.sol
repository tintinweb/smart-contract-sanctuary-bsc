...
contract ERC721RExample is ERC721A, Ownable {
    uint256 public constant maxMintSupply = 299;
    
    uint256 public constant stakingPrice = 0.15 ether;
    uint256 public constant salePrice = 0.15 ether;
    uint256 public constant discountPrice = 0.15*0.8 ether;

    uint256 public constant saleSupply = 269;
    uint256 public constant discountSupply = 10;
    uint256 public constant freeSupply = 20;

    uint256 public maxSaleMintAmount = 3;
    uint256 public maxDiscountMintAmount = 1;
    uint256 public maxFreeMintAmount = 1;

    uint256 public constant MINT_TYPE_SALE = 1;
    uint256 public constant MINT_TYPE_DISCOUNT = 2;
    uint256 public constant MINT_TYPE_FREE = 3;
    ...
    uint256 public discountCount = 0;
    uint256 public freeCount = 0;

    mapping(uint256 => bool) public stakingExchanged; 
    mapping(uint256 => bool) public stakingRefunded;

    mapping(address => uint256) public saleMintedCount;
    mapping(address => uint256) public discountMintedCount;
        ...
        payable
    {
        ...
        if(mintType == MINT_TYPE_DISCOUNT) {
            ...
            discountMintedCount[msg.sender] += 1;
