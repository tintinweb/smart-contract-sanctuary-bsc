...
contract TEST is IERC20, Ownable, MinterRole, PauserRole, Pausable {
    ...
    function mint(address to, uint256 value) public onlyMinter returns (bool) {
        require(value + _totalSupply <= 10000000000000000000000000000, "max supply exceeding");
        _mint(to, value);
        return true;
    }
