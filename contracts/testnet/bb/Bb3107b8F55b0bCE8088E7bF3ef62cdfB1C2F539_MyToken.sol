...
contract MyToken is Context, Ownable, IERC20 {
    ...
    uint256 public maxTransferingAmount = _tTotal.div(100); 
    uint256 public maxWalletToken = _tTotal.div(20); 
    ...
    constructor() {
        ...
        _isExcludedFromFee[dexPair] = true;
