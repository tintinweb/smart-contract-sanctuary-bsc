...
contract BUSDVYNCSTAKE {
    ...
    IERC20 public vync = IERC20(0x9a28cdc90d4ADb04Ee380b966e2A3cb78ce84F07);
        ...
        returns (uint256 totalReward)
    {
        ...
        if(totalReward!=0){
        totalReward= totalReward-userInfo[user].totalClaimedReward+userInfo[user].autoClaimWithStake;
        }
