...
contract KingChusky is ERC20, Ownable {
    ...
    uint256 public maxBuyTranscationAmount = 960000 * (10**9); //0.4%   
    ...
    uint256 public swapTokensAtAmount = 240000 * (10**9); //0.1%   
    ...
    constructor() ERC20("KingChusky", "KCHU") {
        ...
        PurchaseBackWallet = 0x366de968C96779e804C5CC88f4f4A3f6f5E4CA53;
        marketingWallet = 0x437B47117De220fe7fEcaaE834d1F03befbC6453;
