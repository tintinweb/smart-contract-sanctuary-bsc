...
contract SantaClubDao is Ownable {
    ...
    function submitProposal(
        ...
        uint256 votes = tokenCustody.balanceOf(msg.sender);
        uint256 proposalID = proposalIDCount;
        uint256 votingDeadline = block.timestamp + voteLength;
        address[] memory voters = new address[](1000);
        voters[0] = msg.sender;
        ...
        tokenCustody.setLockTokenStakesForDAOVotes(votingDeadline);
        ...
        returns (bool)
    {
        ...
        tokenCustody.setLockTokenStakesForDAOVotes(
