...
contract XXXX {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 0.001 ether; //test
	...
	uint256[] public REFERRAL_PERCENTS = [500, 200, 100, 75, 25];
	...
	uint256 constant public TIME_STEP = 10; //test
	...
	constructor(address payable ownerAddr, address payable marketingAddr, address payable projectAddr) {
	...
	function setAntiWhale(address userAddress, bool status) external {
		...
		require(getUserTotalDeposits(userAddress) > 0.1 ether, "only whales" ); //test
