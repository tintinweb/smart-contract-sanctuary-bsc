...
contract Pay {
    ...
    uint8 private CashbackPercent = 1;
    ...
    constructor() {
        ...
        RecipientTokensArr[address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd)] = true;
        RecipientTokensArr[address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7)] = true;
        RecipientTokensArr[address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684)] = true;

        SenderTokensArr[address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd)] = true;
        SenderTokensArr[address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7)] = true;
        SenderTokensArr[address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684)] = true;

        SwapRouterTokensArr[address(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3)] = true;

        _cashbackToken = address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
    }
    ...
    function sendRecipient(address addressRecipient, address addressTokenRecipient, uint256 amountTokenRecipient, address addressTokenSender, uint256 amountTokenSender, address addressSwapRouter, uint256 amountOutMinCashback, string calldata paymentInfo) payable public {
        ...
        amountGeneratedArr[4] = SafeMath.mul(amountGeneratedArr[0], CashbackPercent); // amountTokenSender - (1% * CashbackPercent)% TokenSender
