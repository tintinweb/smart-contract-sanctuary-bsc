...
// File: interfaces/IStakingContract.sol
...
// File: interfaces/IPYESwapRouter01.sol
...
// File: interfaces/IPYESwapRouter.sol
...
// File: interfaces/IPYESwapFactory.sol
...
//--------------------------------------BEGIN CONSTRUCTOR AND RECEIVE FUNCTION---------|    
    ...
    constructor() ERC20("PYE", "PYE") {
        ...
        pyeSwapRouter = IPYESwapRouter(0x6950FBfA908c799eBE37D7B698d2c4A35Dd3C2Ba);
...
//--------------------------------------BEGIN FEE FUNCTIONS---------|
    ...
    // set the reflection fee on buys
    function setBuyReflectionPercent(uint256 _reflectionFee) external onlyOwner {
    ...
    // set development fee on buys
    function setBuyDevelopmentPercent(uint256 _developmentFee) external onlyOwner {
    ...
    // set buyback fee on buys
    function setBuyBuyBackPercent(uint256 _burnFee) external onlyOwner {
        _defaultFees.buybackFee = _burnFee;
        _buyFees.buybackFee = _burnFee;
        _outsideBuyFees.buybackFee = _burnFee;
    }

    // set the reflection fee on sells
    function setSellReflectionPercent(uint256 _reflectionFee) external onlyOwner {
        _sellFees.reflectionFee = _reflectionFee;
        _outsideSellFees.reflectionFee = _reflectionFee;
    }

    // set development fee on sells
    function setSellDevelopmentPercent(uint256 _developmentFee) external onlyOwner {
        _sellFees.developmentFee = _developmentFee;
        _outsideSellFees.developmentFee = _developmentFee;
    }

    // set buyback fee on sells
    function setSellBuyBackPercent(uint256 _burnFee) external onlyOwner {
        _sellFees.buybackFee = _burnFee;
