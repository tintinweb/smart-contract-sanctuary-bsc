...
contract Launch is Initializable{
    ...
    function createNewICO(DataParam calldata newICOData, uint[] calldata _time, uint[] calldata _percent) external{
        ...
        ICO(payable(newcontract)).initialize(_icoBase, _time, _percent);
