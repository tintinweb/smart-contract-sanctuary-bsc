...
contract SHIBSC is Context, IERC20, Ownable {
    ...
    string private _name = "SHIBA BSC";
    string private _symbol = "SHIBSC";
    ...
    uint256 public _maxTxAmount = 5 * 10 ** 12 * 10 ** 18;//0.5%
    uint256 private numTokensSellToAddToLiquidity = 1 * 10 ** 10 * 10 ** 18;//0.001%
