...
contract LIFEGAMES is IERC20 {
    ...
    function setNewRouter(address newRouter) external onlyOwner() {
        ...
        address get_pair = IFactoryV2(_newRouter.factory()).getPair(_newRouter.WETH(), address(this));
        if (get_pair == address(0)) {
            lpPair = IFactoryV2(_newRouter.factory()).createPair(_newRouter.WETH(), address(this));
        }
        else {
            lpPair = get_pair;
        }
