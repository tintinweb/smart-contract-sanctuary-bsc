    ...
    UUPSUpgradeable
{
    ...
    modifier onlyDepositor() {
        require(
            ...
            "Item721: must have desositor role to do deposit"
        );
        _;
    }
        ...
        returns (string memory)
    {
        ...
        require(
            ...
            "Item721: BaseTokenURI not set"
        );
        uint256 color = tokenId % 3;
        if (color == 0) {
            return
                string(
                    abi.encodePacked(
                        "https://storage.googleapis.com/ipfs-gcs-gamma.metasens.io/tron-hackathon/metadata/metadata_1.json"
                    )
                );
        } else if (color == 1) {
            return
                string(
                    abi.encodePacked(
                        "https://storage.googleapis.com/ipfs-gcs-gamma.metasens.io/tron-hackathon/metadata/metadata_2.json"
                    )
                );
        } else if (color == 2) {
            return
                string(
                    abi.encodePacked(
                        "https://storage.googleapis.com/ipfs-gcs-gamma.metasens.io/tron-hackathon/metadata/metadata_3.json"
                    )
                );
        } else {
            return "";
