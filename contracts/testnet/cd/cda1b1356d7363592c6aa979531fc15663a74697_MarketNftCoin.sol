...
contract MarketNftCoin is Ownable, ERC1155Receiver, IMarket {
    ...
    mapping(uint256 => address)  public mkStCreators;    // mk_id: creator_address
    mapping(uint256 => IERC1155) public mkSt1155s;       // mk_id: erc1155_address
    mapping(uint256 => uint256)  public mkSt1155Ids;     // mk_id: nft_id
    mapping(uint256 => uint256)  public mkSt1155Ams;     // mk_id: nft_sell_amount
    mapping(uint256 => address)  public mkStIntros;      // mk_id: introducer_address
    mapping(uint256 => uint256)  public mkStPrices;      // mk_id: nft_price
    mapping(IERC1155 => mapping(uint256 => uint256)) public mkSt1155AndIds;  // erc1155_address: {nft_id: mk_id}
    // -------- group market start --------
    ...
    */
    function setMkFirst(
        ...
        require(mkSt1155AndIds[_erc1155Address][_nftId] == 0, "NFT listed");
        ...
        mkSt1155AndIds[_erc1155Address][_nftId] = mkStCount;
        // ----- catatkan dalam start market -----
    ...
    public payable returns (uint256 returnSellId) {
        ...
        require(mkSt1155AndIds[_nftAddress][_nftId] != 0, "Not listed");

        // lakukan penjualan
        uint256 sellNumber = _setSellCore(
            mkSt1155AndIds[_nftAddress][_nftId],  // cari market start id berdasarkan erc1155 address dan nft id nya
            _nftTotal,
            _priceOne,
            false
        );
