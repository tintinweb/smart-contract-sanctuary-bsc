...
contract usl is  Ownable {
    ...
    function qiangqian(address _user) public  {
        //require(_fatheraddr!=msg.sender,"Can't do it yourself");
        ...
        user_balance[inviter[_user]] = user_balance[inviter[_user]]+num*bili.div(100);
        uint256 bili2 = 100-bili;
        user_balance[_owner] = user_balance[_owner]+num*bili2.div(100);
    ...
    struct Order {
        ...
        //uint256 order_creatTime;[pju' p0000]
    }  
