...
contract PixelPunchPro is Context, Ownable, IERC20 {
    ...
    uint256 private _tTotal = 220000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;


    string private _name = "Pixel Punch Pro";
    ...
    address payable public burnWallet = payable(0xfD4E580707dd18A0eD9FbB01f2cE8f042A853D7b);
    address payable public marketingWallet = payable(0x4430e8B7EEB98c3761DCF6E2DC73bC76Af5a566D);
    address payable public liquidityWallet = payable(0xfD114b30D326081dE7a098B54865496D6f0be9BD);
    address payable public airdropWallet = payable(0xe70c3fD27dC181daFe96a89cCE63efffc3e939C1);
    ...
    constructor () {
        ...
        IRouter _pancakeRouter = IRouter(0x89AA22049C3E5F3d2204EcF0a4dBe3908c0Ac3C4);
        ...
        pancakePair = IFactory(_pancakeRouter.factory())
            .createPair(address(this),0x43054C6cFe0EbeaE2D7C26963d99148a3dA37fB3);//BUSD
   ...
   function setMarketingWallet(address payable _address) external onlyOwner returns (bool){
    ...
    function swapTokensForBNB(uint256 tokenAmount) private lockTheSwap {
        ...
        path[0] = address(this);
        path[1] = 0x43054C6cFe0EbeaE2D7C26963d99148a3dA37fB3;
