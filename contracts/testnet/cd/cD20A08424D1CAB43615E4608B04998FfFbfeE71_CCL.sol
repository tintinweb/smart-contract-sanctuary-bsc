...
contract CCL is Context, Ownable, ReentrancyGuard {
   ...
   IERC20 private WBNBToken = IERC20(address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd)); // WBNB CONTRACT TEST NET
    ...
    function _isScamAddress(address _addr) external view returns (bool) { return isScam[_addr]; } // IF THIS ADDRESS IS VERIFIED BY THE CCL 
    ...
    function payInLTS() private { TransferHelper.safeTransfer(address(LTSToken), transactionAddressForTESTNET, LTSCost); }
