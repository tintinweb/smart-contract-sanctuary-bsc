...
contract ZombieHelper is ZombieFeeding {
  ...
  //onlyOwner and owner() are in ownable.sol
...
contract ZombieOwnership is ZombieAttack, ERC721 {
	...
	//add and sub defined in safemath.sol to prevent from overflow and underflow (lesson/5/chapter/10 in cryptozombies.io)
