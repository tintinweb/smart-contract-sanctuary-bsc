...
contract GoldenNugget is Context, Ownable {
    ...
    function BuryGold(address ref) public payable {
        require(initialized);
        ...
        uint256 GoldUsed = getMyGold(msg.sender);  //9038484
        uint256 newMiners = SafeMath.div(GoldUsed,Gold_To_Mine);  //8
    ...
    function getMyMiners(address adr) public view returns(uint256) {
        return Working_Miners[adr];    ///3738
    }
