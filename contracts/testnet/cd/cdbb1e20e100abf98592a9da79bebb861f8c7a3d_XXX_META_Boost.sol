...
////////////////x6forsage///////////////
 struct Userr {
     ...
     //x6Matrix[msg.sender][i].currentReferrer = address(0);
     //x6Matrix[msg.sender][i].firstLevelReferrals.push(address(0));
...
function registration(address userAddress, address referrerAddress) private {      
       ...
       // activeX6Levels[userAddress][1] = true;
