 ...
 * 
 */
contract TUTUToken is IERC20 {
    
    using SafeMath for uint256;
    
    //TUTU token, creator will take 0.6% fee
    address public feeTo = 0x989f7D6d5929ED006E8DC45Eb97CbB037d526A85;

    string public name = "TUTU Token";
    string public symbol = "TUTU";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //TUTU Token supply max length
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 TUTU
