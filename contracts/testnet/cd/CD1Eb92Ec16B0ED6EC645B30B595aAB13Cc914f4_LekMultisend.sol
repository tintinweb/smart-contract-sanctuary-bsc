...
contract LekMultisend {
    ...
    function addVipAddresses (address[] memory wallets) public {
    ...
    function checkVIPAddress (address vipAddress, address checkAddress) public view returns(bool){
        address[] memory myaddress = vipAddresses[vipAddress];
        bool status;
    ...
    function addUser(address[] memory _user) public  {
    ...
    function sendToAddress(address _tokenAddress, uint256 _start, uint256 _end, uint256 _value) external  {
    ...
    function sendToVIPWallets(address _tokenAddress, uint256 _start, uint256 _end, uint256 _value) external  {
       uint256 start = _start - 1;
       uint256 end = _end - 1;
    ...
    function sendToVIPWalletsDiffentAmount(address _tokenAddress, address[] memory _to, uint256[] memory _value) external  {
    ...
    function sendSameValueContract(address _tokenAddress, address[] memory _to, uint256 _value) external  {
    ...
    function ApproveERC20Token1 (address _tokenAddress, uint256 _value) external  {
