...
contract AthTraderCEXFactory {
    ...
    /**
     * @dev Fired in _deployTrader() when a new trader smart contract is created
     *
     * @param traderAddress address of trader
     * @param contractAddress address of smart contract
     */
    event CreateTrader(address traderAddress, address contractAddress);
        ...
        returns (AthTraderCEX)
    {
        ...
        emit CreateTrader(traderAddress, address(trader));
        return trader;
    }
