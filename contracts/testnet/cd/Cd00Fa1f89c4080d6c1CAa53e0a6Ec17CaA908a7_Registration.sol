...
contract Registration is OwnableUpgradeable {
    ...
    event RegisterWithReferrer(address indexed userAddress, address referrerAddress);
    event RegisterWithoutReferrer(address indexed userAddress);

    bool public _pause;
    
    function  initialize ()  public initializer {
        __Ownable_init();
        registrationFeeWithoutReferrer = 0.075 ether;
        registrationFeeWithReferrer = 0.025 ether;
    }
