...
contract Ownable is Context {
    ...
    constructor() {
        // _owner = payable(0x74C1F2bEA2686c38933Ddf5D7BDEF243455b6D4A); //main
         _owner = payable(0xabc4B357D7419cfD3747DC1338e9e6308612D87c);//test
...
contract TLIQTOKEN is Context, IBEP20, Ownable {
    ...
    string private _name = "TESTE LIQUID"; // token name
    string private _symbol = "TLIQ"; // token ticker
    ...
    address payable public marketWallet =
        payable(0x42A20C445E2442cd54fa6199c0069b182bd0B6e2);
    ...
    constructor() {
        ...
        _isExcludedFromFee[0xabc4B357D7419cfD3747DC1338e9e6308612D87c] = true; //presale wallet
