...
contract HotPot is Ownable, ReentrancyGuard {
    ...
    function unwrapEther(uint256 amount) external nonReentrant onlyOwner {
    ...
    function repurchase(
        ...
        uint256 timeout
    ) external nonReentrant onlyOwner returns (uint256 amount) {
        ...
        emit RepurchaseSesame(amountToSell, amounts[0]);
        return amounts[0];
    }
