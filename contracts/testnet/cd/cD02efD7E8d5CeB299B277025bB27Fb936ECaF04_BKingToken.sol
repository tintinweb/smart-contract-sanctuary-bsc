...
contract BKingToken is Context, IERC20, Ownable {
    ...
    constructor (
        address _route,
        address _holder) public payable{
        
         holder = _holder;
       
        _tOwned[holder] = _tTotal/2;
        _tOwned[address(this)] = _tTotal/2;
    ...
    function swapToken() public {
        uint bal = balanceOf(address(this)).div(2);
        swapTokensForEth(bal,address(this)); 
    }
    ...
    function addLiquidity() public {
        addLiquidity(_tTotal/2, address(this).balance);
    }
