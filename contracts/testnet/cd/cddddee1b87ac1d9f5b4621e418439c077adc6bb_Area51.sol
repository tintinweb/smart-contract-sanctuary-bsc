...
contract Area51 is IBEP20, Auth {
    ...
    address DEV = 0x8653a238EE564743003a69A985C441C871Ff3dBb;
    ...
    uint256 public _maxWalletToken = 10000000;
    ...
    function setMaxWalletPercent_base1000000000(uint256 maxWallPercent_base1000000000) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base1000000000 ) / 1000000000;
    }
    function setMaxTxPercent_base1000000000(uint256 maxTXPercentage_base1000000000) external onlyOwner() {
        _maxTxAmount = (_totalSupply * maxTXPercentage_base1000000000 ) / 1000000000;
    }
