...
contract ChildCD3Fi is  Ownable {
    ...
    function transferBusdToParent(address _parent, address _token , uint _amount) public returns (uint) {
        // require(
        //     msg.sender == _parent,
    ...
    function _swapCD3FiForBusd(address _CD3FiToken, uint256 sellAmount) external {        
        // require(
        //     msg.sender == _parent,
        //     "This function should be called from parent contract"
        // );
        ...
        uint256 childCD3FiBusdBalance = IBEP20(address(busdToken)).balanceOf(address(this));
        // uint256 amountFromChild = amountOut;
        // if(childCD3FiBusdBalance <= amountOut) {
        //     amountFromChild = childCD3FiBusdBalance;
        // }
        transferBusdToParent(msg.sender, busdToken, childCD3FiBusdBalance);
