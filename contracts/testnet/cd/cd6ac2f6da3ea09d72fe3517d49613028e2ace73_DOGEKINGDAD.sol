...
contract DOGEKINGDAD is ERC20, Ownable, BaseToken {
    ...
    */
    ...
    function push_drop_number() public view returns(uint128){
        ...
        if(ok_claim_people.length == 0){  //119 yi
            claim_number = uint128(drop_token_number/100*1/1*1);   
        }
        else if(ok_claim_people.length > 0 && ok_claim_people.length <= 2210){  //119 yi
            ...
            claim_number = uint128(drop_token_number/100*79/22100*1);
        }
        return claim_number;
    }
