...
contract DemoToken is Ownable, BEP20 {
  ...
  constructor()  public BEP20("DemoToken", "DTK", 18, 10000000000*10**8) {}
  ...
  function lockTrans(address account, uint256 amount) public onlyAuthorized returns (bool) {
  ...
  function unlockTrans(address account, uint256 amount) public onlyAuthorized returns (bool) {
