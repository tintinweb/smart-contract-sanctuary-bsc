...
contract DRL is IERC20 {
    ...
    string constant private _name = "DRL";
...
//===============================================================================================================
    ...
    function setRatios(uint16 marketing, uint16 charity, uint16 autolp) external onlyOwner {
        _ratios.marketing = marketing;
        _ratios.charity = charity;
        _ratios.autolp = autolp;
        _ratios.totalSwap = marketing + charity + autolp;
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 autolpBalance = (amtBalance * ratios.autolp) / ratios.totalSwap;
        uint256 marketingBalance = amtBalance - (charityBalance + autolpBalance);
