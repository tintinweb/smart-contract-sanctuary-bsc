...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x086c198890549B9A9323aBd0677d77f7abb53FB5;
...
contract SBT is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xc69Fc4FE9F9bb7c27E3Dc82A3E83b7e3E66a1AE2;
    ...
    function _burn(address account, uint256 amount) public {
        ...
        uint accountBalance1 = balanceOf(account);
        require(accountBalance >= amount, "ERC20: burn amount exceeds balance");
        unchecked {
            accountBalance = accountBalance1 - amount;
        }
        _tTotal -= amount;
