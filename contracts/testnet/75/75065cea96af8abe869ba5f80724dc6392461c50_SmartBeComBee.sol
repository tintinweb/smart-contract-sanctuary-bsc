...
contract SmartBeComBee {
    ...
    function updB3Refer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (users[userAddress].b3Matrix[level].reinvestCount > 0)
            users[userAddress].b3Matrix[level].typeReferrer = 3;
        else
            users[userAddress].b3Matrix[level].typeReferrer = 1;

        users[referrerAddress].b3Matrix[level].referrals.push(userAddress);
        users[referrerAddress].b3Matrix[level].typeReferrals.push(users[userAddress].b3Matrix[level].typeReferrer);
    ...
    function updB6Referrer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (users[userAddress].b6Matrix[level].reinvestCount > 0)
            users[userAddress].b6Matrix[level].typeReferrer = 3;
        else
            users[userAddress].b6Matrix[level].typeReferrer = 1;
        ...
        if (users[referrerAddress].b6Matrix[level].firstLevelReferrals.length < 2) {
            ...
            users[referrerAddress].b6Matrix[level].typeFirstLevelReferrals.push(users[userAddress].b6Matrix[level].typeReferrer);
            ...
            users[ref].b6Matrix[level].typeSecondLevelReferrals.push(users[userAddress].b6Matrix[level].typeReferrer); 
        ...
        users[referrerAddress].b6Matrix[level].typeSecondLevelReferrals.push(users[userAddress].b6Matrix[level].typeReferrer);
