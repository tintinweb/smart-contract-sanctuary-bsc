...
contract GoldFoxNFT is ERC721Enumerable, Ownable, Guard, RI, Withdrawable {
    ...
    constructor(address riAddress_) ERC721("Gold Fox NFT V1", "GFOX V1")
    {
        royaltyAddress = riAddress_;

        string memory baseTokenURI = "https://legendaryfox.io/meta/gfox/";
        string memory baseContractURI = "https://legendaryfox.io/meta/gfox/global.json";
