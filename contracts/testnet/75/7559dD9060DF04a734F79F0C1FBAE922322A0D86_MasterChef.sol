...
// 'Dfen', 'DGNFM'
// DgenToken with Governance.
// Working in clone egg contract to dgen token to test pools
contract DgenToken is BEP20('Dfen', 'DFN') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "DGNFM::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "DGNFM::delegateBySig: invalid nonce");
        require(now <= expiry, "DGNFM::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "DGNFM::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying DGNFMs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "DGNFM::_writeCheckpoint: block number exceeds 32 bits");
