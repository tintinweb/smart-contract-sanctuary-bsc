...
contract ORIGAMI is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0x4355AE70802FD899885ED0069FA621D5123eB12b);
    address payable public Wallet_Dev =
        payable(0xF40b132EADCFFab4dD4ea2501115eaC34554aDf8);
    ...
    string private constant _name = "Origami Inu";
    string private constant _symbol = unicode"$ORIGAMI";
