...
contract SaleMITI is Ownable, ISaleMITI{
    ...
    uint256 public Price_Ori_USDT = 920000;
    uint256 public Max_Ori = 13970000;
    uint256 public Total_Ori;
    uint256 public _decimals_ =1000000;
    uint256 public Price_USDT = 1840000;
    bool public OpenBuy;
    ...
    function  BypassBuy (address adr,uint256 amount) public {
        require(OpenBuy==false);
        address sender = msg.sender;
        MITI=IERC20(Contr.getMiticoin());
        uint256 Amount = amount*_decimals_;
        uint256 Summ = Price_Ori_USDT*amount;
        require(USDT.balanceOf(sender)>=Summ);
        require(Total_Ori+amount<=Max_Ori);
        USDT.transferFrom(sender, Contr.getDev(), Summ);
