...
contract ZaiNFT is ERC721Enumerable, Ownable {
    ...
    function createNewChallenger() external returns (uint256) {
        require(msg.sender == zaiMetaAddress, "Only ZaiMeta authorized");
    ...
    function mintZai(
        ...
        zaiMeta.createZaiDatas(_newItemId, _name, _state, _to, 0);
    ...
    {
        return zaiMeta.getStatus(_tokenId);
    }
    ...
    function getZaiState(uint256 _tokenId)
        ...
        returns (string memory)
    {
        return zaiMeta.getZaiState(_tokenId);
    }
