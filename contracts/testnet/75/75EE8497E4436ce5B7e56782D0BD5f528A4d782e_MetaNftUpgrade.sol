...
contract MetaNftUpgrade is Ownable, ERC1155Holder, ERC721Holder {
    ...
    event NFtMintAfterUpgrade(address upgrader,address nftAddress,uint256 nftId,uint256 nftAmount);
	...
	function mintAfterUpgrade(uint8 weaponCat,uint256 weaponType,uint256 weaponSkin,uint8 weaponColor,uint8 tier,uint8 slots,uint256 points) external{
