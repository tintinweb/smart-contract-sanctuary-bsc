...
* The minting functions can only be called by the owner.
*/
contract OrbedNFT is Initializable, ERC721Upgradeable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
  ...
  */
  ...
  // ???? Not sure | used in constructor
  string public uri;

  ///Custom Contract Roles
  /*
  Transaction Role for 
  */
  ...
  */
  ...
  /** @notice Used when triggering a deposit to the contract.
    * @dev Custom Event
    * @param fromAddress - the wallet address from which the event comes from
    * @param amount - amount being deposited
  */
  event UserDeposit(address indexed fromAddress, uint256 amount);
  ...
  */ 
  ...
  /** @notice replaces constructor for an upgradeable contract
    * @dev oz-contracts-upgrades are initialized here along with some private variables
  ...
  */
  ...
  /** @notice  Generic Deposit function
    * @dev deposits resolve aganist the public balance member
  */
  ...
  */
  ...
  /*
  * Contract Standard Implementations 
