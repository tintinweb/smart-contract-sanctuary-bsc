...
contract JeetCoinStake is Ownable, ReentrancyGuard {
    ...
    address baseTokenAddress = 0x214CB76B1fC2932D345a9ec12F88D1bfc3ECB7D4;
    IERC20 stakeToken = IERC20(baseTokenAddress);

    address rewardTokensAddress = 0x214CB76B1fC2932D345a9ec12F88D1bfc3ECB7D4;
    ...
    function setStakeCreatedTime(uint256 _stakeId, uint256 _pastDays) public onlyOwner{ //Function for testing rewards
        userStake memory userStakeDetails = userStakesById[_stakeId];
        userStakeDetails.createdTime = (block.timestamp - (_pastDays * 86400));
        userStakesById[_stakeId] = userStakeDetails; 
    }
