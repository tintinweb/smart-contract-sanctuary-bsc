...
contract Live is Context, IERC20, Ownable {
  ...
  uint256 private _tTotal = 10**8 * 10**18; //100,000,000
  uint256 private _rTotal = (MAX - (MAX % _tTotal));
  uint256 private _tFeeTotal;
  uint256 public maxWalletAmount = _tTotal.mul(500).div(10000);
  string private _name = 'Live';
 ...
 uint256 public reflectFeeBuy = 3;
 uint256 public reflectFeeSell = 3;
  ...
  address public _teamWallet = 0x000000000000000000000000000000000000dEaD;
  ...
  uint256 public _maxTxAmount = 1 * 10**6 * 10**18; //1% (0.005x) of Total circulating supply, after burn
  ...
  constructor() {
      address _newOwner = 0xD162bc16497C6820753e63CE76aFeAeE0d1aC22c;
