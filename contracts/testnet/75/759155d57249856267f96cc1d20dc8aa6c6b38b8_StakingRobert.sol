...
contract StakingRobert {
    ...
    uint private _totalBalanceBUSD;
    uint private _totalBalanceUSDT;
    uint private _totalBalanceBNB;
    ...
    //     if (_laddress == BUSDA) {
    //         if (_totalBalanceBUSD == 0) {
    //             return rewardPerTokenStoredBUSD;
    //         }
    //         return
    //             rewardPerTokenStoredBUSD +
    //             (((block.timestamp - lastUpdateTimeBUSD) * rewardRate * 1e18) / _totalBalanceBUSD);

    //     } else if (_laddress == USDTA) {
    //         if (_totalBalanceUSDT == 0) {
    //             return rewardPerTokenStoredUSDT;
    //         }
    //         return
    //             rewardPerTokenStoredUSDT +
    //             (((block.timestamp - lastUpdateTimeUSDT) * rewardRate * 1e18) / _totalBalanceUSDT);

    //     } else {
    //         if (_totalBalanceBNB == 0) {
    //             return rewardPerTokenStoredBNB;
    //         }
    //         return
    //             rewardPerTokenStoredBNB +
    //             (((block.timestamp - lastUpdateTimeBNB) * rewardRate * 1e18) / _totalBalanceBNB);
    //     }      
    // }
