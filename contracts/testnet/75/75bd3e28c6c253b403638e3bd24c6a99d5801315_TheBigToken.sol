...
contract TheBigToken is IBEP20, SafeMath {
    ...
    uint256 public _totalSupply = 1000000000000 *10 **10; // 1 Trilhões de TheBigToken in supply
    address public TheBigToken_wallet = 0x52d5E5380843EF5D644DcBEFD0579E317b65b68a;

    // An array of the verified charities
    address[] public charities = [0xaC9B745280F523e6cb4E952a4a0E511c19512214]; //Carteira de teste Minha mesmo
    ...
    function _transfer(
        ...
        uint256 amountToDonate   = safeDiv(tokens, 0);      // 0% of the transaction will be Donate
        ...
        balances[TheBigToken_wallet] = safeAdd(balances[TheBigToken_wallet], amountToHolder);
        balances[TheBigToken_wallet] = safeAdd(balances[TheBigToken_wallet], amountToBurn);
