...
// File: contracts/nameservice.sol
...
contract NameService is Ownable, ERC721("Alpaca Name Service", "APNS") {
    mapping(string => uint256) tokensMetadata;
    ...
    function mintName(string calldata name) public {
        ...
        tokensMetadata[string.concat(name, ".alpaca")] = tokenCounter;
        ownings[msg.sender].push(tokenCounter);
        tokenCounter = tokenCounter + 1;
    }

    function resolveName(string calldata name) public view returns (address) {
        uint256 id = tokensMetadata[name];
