...
/**
 * @title testbplsx ERC20 token
 * @dev
 *      Written By ANON GRV Holo Dev where as Admin we hit 120 Mil
 */
contract testbplsx is ERC20Detailed, Ownable {
    ...
    uint256 private constant DECIMALS = 10;
    uint256 private constant MAX_UINT256 = ~uint256(0);

    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**10 * 12**DECIMALS;
    ...
    constructor (address router, address payable _marketingAddress)
        ERC20Detailed("BabyPulseX", "testbplsx", uint8(DECIMALS))
        payable
        public
    {
