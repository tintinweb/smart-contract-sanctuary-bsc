...
// File: contracts/interfaces/IkabolaLottery.sol

pragma solidity ^0.8.4;

interface IkabolaLottery {
    /**
    ...
    /**
     * @notice Draw the final number, calculate reward in kabola per group, and make lottery claimable
     * @param _lotteryId: lottery id
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject in kabola token
     * @dev Callable by operator
     */
     ...
     * @param _priceTicketInkabola: price of a ticket in kabola
...
// File: contracts/RandomNumberGenerator.sol kabola
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the kabolaLottery lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == kabolaLottery, "Only kabolaLottery");
    ...
    /**
     * @notice Set the address for the kabolaLottery
     * @param _kabolaLottery: address of the kabolaLottery lottery
     */
    function setLotteryAddress(address _kabolaLottery) external onlyOwner {
        kabolaLottery = _kabolaLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IkabolaLottery(kabolaLottery).viewCurrentLotteryId();
    }
}