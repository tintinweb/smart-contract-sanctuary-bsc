...
// 
contract WaveLock is IWaveLock {
    ...
    // ID padding from Wave v1, as there is a lack of a pausing mechanism
    ...
    mapping(address => CumulativeLockInfo) public cumulativeLockInfo; // token => info
    mapping(address => EnumerableSet.UintSet) private _tokenToLockIds; // token => ID
