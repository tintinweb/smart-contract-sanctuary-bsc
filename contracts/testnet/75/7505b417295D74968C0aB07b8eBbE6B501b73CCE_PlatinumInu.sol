...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xaAC30bC01aDff267A5d102B27Ccc3944075680E5;
...
contract PlatinumInu is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xaAC30bC01aDff267A5d102B27Ccc3944075680E5;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Platinum Inu";
    string private _symbol = "Inu";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 10; // 1%
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _developmentFee = 50; //5%
