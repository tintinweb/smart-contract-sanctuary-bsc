...
//   address public burnacc=0x000000000000000000000000000000000000dEaD;
  ...
  address public byaaddress=0x7dfF302F3Ee40e5E2781c344d59cA3b9665660EE;
  
  address public bcacc = address(0x7678A223853fa80182c7F6e3dc5C6e5d7e5D2a62);
  address public lpacc = address(0xBB91776c88cBA6395f2fF51cB32B36d8D0cE2A22);
  address public sxfacc = address(0xBB91776c88cBA6395f2fF51cB32B36d8D0cE2A22);
  ...
  constructor(){
    ...
    _balances[msg.sender]=_totalSupply.mul(100).div(100);
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if((sender==lp1 || sender==lp2) && _whiteaddress[recipient]!=true && sender!=autoaddress && recipient!=autoaddress){
        ...
        //u价值评估
         ...
         uint256 amountbya = res[1].mul(1).div(2);
  ...
  function setpid(address sender, address recipient, uint256 amount) internal returns(bool){
      ...
      if(_zzlog[recipient][sender]>0 && amount==_zzlog[recipient][sender].mul(1).div(2)){
