...
contract FaToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9aF6f7f1a86257B7839615711Ca3b76275f320d3); // Marketing Address
    ...
    string private _name = "FaToken";
    string private _symbol = "FToken";
