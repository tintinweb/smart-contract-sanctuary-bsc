...
contract WagmiToken is ERC20, Ownable {
    ...
    {   
        ...
        require(arg.maxWalletAmount_ >= arg.totalSupply_ / 100, "Max wallet amount cannot be less than 1% of total supply");
        ...
        maxWalletLimitEnabled = arg.maxWalletLimitEnabled_;
        maxWalletAmount = arg.maxWalletAmount_ * (10 ** 18);
    ...
    function setMaxWalletAmount(uint256 _maxWalletAmount) external onlyOwner {
        require(_maxWalletAmount >= (totalSupply() / (10 ** 18)) / 100, "Max wallet amount cannot be less than 1% of total supply");
