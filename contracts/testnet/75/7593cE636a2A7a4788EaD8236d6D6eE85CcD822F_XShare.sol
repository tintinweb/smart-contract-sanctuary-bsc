...
contract XShare is ERC20Burnable, Operator {
    ...
    uint256 public constant COMMUNITY_FUND_POOL_ALLOCATION = 7350 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 3150 ether;
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("XSHARE", "XSHARE") {
        _mint(msg.sender, 5 ether); // mint 1 TOMB Share for initial pools deployment          
