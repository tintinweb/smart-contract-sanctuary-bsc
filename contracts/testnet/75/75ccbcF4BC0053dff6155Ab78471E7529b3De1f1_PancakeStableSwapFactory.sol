...
contract PancakeStableSwapFactory is Ownable {
    ...
    function createSwapPair(
        ...
        bytes32 salt = keccak256(abi.encodePacked(_tokenA, _tokenB, msg.sender, block.timestamp));
        address swapContract;
        assembly {
...
contract PancakeStableSwap is Ownable, ReentrancyGuard {
    ...
    uint256 public constant ADMIN_ACTIONS_DELAY = 3 minutes;
    // uint256 public constant MIN_RAMP_TIME = 1 days;
    uint256 public constant MIN_RAMP_TIME = 3 minutes;
    ...
    uint256 public constant KILL_DEADLINE_DT = 10 minutes;
    ...
    function initialize(
        ...
        bytes32 salt = keccak256(abi.encodePacked(_coins, msg.sender, block.timestamp));
        address lpToken;
        assembly {
