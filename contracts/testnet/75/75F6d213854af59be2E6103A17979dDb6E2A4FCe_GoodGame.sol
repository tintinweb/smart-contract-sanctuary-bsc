    ...
    function participate() external {
        ...
        for (uint256 i = 1; i <= levlToAmount[1] + 1; i++) {
            if ((levlToIdToTable[1][i].leader == address(0))) {
                ...
                token.transferFrom(
                    msg.sender,
                    levlToIdToTable[1][levlToAmount[1]].leader,
                ...
                levlToIdToTable[1][levlToAmount[1]].isPaid[
                    adrToInfo[msg.sender].idInTable
                ] = true;
                uint256 count;
                for (uint256 j = 1; i < 7; i++) {
                    if (levlToIdToTable[1][levlToAmount[1]].isPaid[j] == true) {
                        count++;
                    }
                }
                if (count == 6) {
                    levlToIdToTable[1][levlToAmount[1]].isPaidAll = true;
                    closeTable();
                }
        ...
        for (
            ...
            if (
                ...
                if (adrToInfo[msg.sender].level == 6) {
                    ...
                    ].tableId = levlToAmount[adrToInfo[msg.sender].level + 1];
                    break;
                }
            } else if (
