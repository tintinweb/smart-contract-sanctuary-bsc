...
contract ArtexStaking is Ownable, ReentrancyGuard {
    ...
    constructor() {
        token = IERC20(0x1cb70F34bD9aae516AaC63e2504705C2b0E55eCb);
    }
    ...
    function getTotalLiveStakingAmount() external view returns(uint256) {
        PoolInfo[] storage pool = poolInfo;
    ...
    function stakeLenght(address _user) public view returns (uint256) {
