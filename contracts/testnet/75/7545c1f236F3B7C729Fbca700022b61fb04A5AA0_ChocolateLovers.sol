...
contract ChocolateLovers is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = 0xc4091892CfBC7576C01F0dC93474f688Ae6022Bd;
    ...
    constructor() public ERC20("Chocolate Lovers", "CHOCO") {
    ...
    function _transfer(
		...
		uint256 contractTokenBalanceforlp = balanceOf(address(this)).sub(pendingMarketingFee);
        ...
        {
            swapping = true;
            uint256 swapTokens = contractTokenBalanceforlp;
            swapAndLiquify(swapTokens);
            claimMarketingFees();
            swapping = false;
        }
        ...
        if(takeFee) {
            ...
            // marketing fee
            uint256 fees2 = amount.mul(marketingfee).div(100);
            pendingMarketingFee = pendingMarketingFee.add(fees2);
    ...
    function migrateGsToken(address payable _newadd,uint256 amount) public onlyOwner {    
