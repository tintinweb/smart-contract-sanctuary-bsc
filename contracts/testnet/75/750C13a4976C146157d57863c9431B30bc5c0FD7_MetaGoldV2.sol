...
contract MetaGoldV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    */
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        uint256 initialBalance = IERC20(bnb_address).balanceOf(address(this));
        swapTokensForBNB(tokens);
        uint256 newBalance = (IERC20(bnb_address).balanceOf(address(this))).sub(initialBalance);
        IERC20(bnb_address).transfer(directPaymentBNBAddressReceiver, newBalance);
    }
