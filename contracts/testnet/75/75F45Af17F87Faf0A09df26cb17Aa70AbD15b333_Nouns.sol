...
contract Nouns is ERC721, ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties, ERC721Pausable {
    ...
    event CreateNouns(uint256 indexed id);
	
    constructor() ERC721("Nouns DAO", "NOUNS") {
        pause(true);
    }
    ...
    function burn(uint tokenidtoburn) public {
        require(ERC721.ownerOf(tokenidtoburn) == msg.sender);
        _burn(tokenidtoburn);
    }
