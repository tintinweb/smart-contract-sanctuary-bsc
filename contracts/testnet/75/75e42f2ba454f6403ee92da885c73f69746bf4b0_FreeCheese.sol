...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xe8877346dd021499ff8aFA6dB88AaE2e074A1406);
...
contract FreeCheese is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x644Ed892BBCd26373D6eF244B3c4CEfD5E2B9456;

    string constant _name = "Free Cheese";
    string constant _symbol = "FREES";
