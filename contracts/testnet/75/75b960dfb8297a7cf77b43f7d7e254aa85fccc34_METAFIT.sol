...
contract METAFIT is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    event LogRebase(uint256 indexed epoch, uint256 totalSupply);

    string public _name = "METAFIT";
    string public _symbol = "METAFIT";
    ...
    constructor() ERC20Detailed("METAFIT", "METAFIT", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0xBdE67aFE0B579eE8bA982FD300d46CC441Ae3c06;
        TreasuryReceiver = 0x0Ca3Be8d394800D8B608cbEF02BF58F9B1D184f3;
        RiskFreeValueReceiver = 0xBbf47E1cE56980acEB07C7A0983e21209A21bA39;
        ...
        
    {
        ...
        _gonsPerFragment = TOTAL_GONS.div(_totalSupply);
        _lastRebasedTime = _lastRebasedTime.add(times.mul(24 hours));
        pairContract.sync();
   ...
   function setAutoRebase(bool _flag) external onlyOwner {
    ...
    function shouldRebase() internal view returns (bool) {
        return
            ...
            msg.sender != pair  &&
            !inSwap &&
            block.timestamp >= (_lastRebasedTime + 24 hours);
    }
