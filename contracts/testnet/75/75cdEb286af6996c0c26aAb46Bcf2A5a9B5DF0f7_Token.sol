...
contract Token is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        if(_burnFee != 0){
            ...
            _tokenTransferNoFee(address(this), address(0xA9F35bCb4211E7B7352bD32e6672350a63cb901D), spentAmount);
            totSpentAmount = spentAmount;
        }

        if(_walletFee != 0){
            spentAmount = contractTokenBalance.div(totFee).mul(_walletFee);
            _tokenTransferNoFee(address(this), marketingAddress, spentAmount);
