...
contract LEYECOM is Context, IERC20, Ownable {
    ...
    **/
    ...
    function FreezeSuspiciousWallet (address wallet) external onlyOwner {
        frozen[wallet] = true;
    }
    ...
    **/
    ...
    function unfreezeSuspiciousWallet (address wallet) external onlyOwner {
        frozen[wallet] = false;
    }
    ...
    function _transfer(
        ...
        require (!frozen[from], "Your wallet is frozen, cant move tokens. You should contact on Telegram and find out why.Telegram = @leye.io");
