...
// File contracts/games/DiceGame.sol
...
contract DiceGame is Initializable, UUPSUpgradeable, BaseGame {
    ...
    function initialize(address betSlipsAddr, uint256 rtp) initializer external{
        owner = msg.sender;
        ...
        returns (uint256)
    {
        ...
        uint256 odds = ((_rtp * LUCKY_NUMBERS_AMOUNT * 10) / probability + 5) / 10 ;
