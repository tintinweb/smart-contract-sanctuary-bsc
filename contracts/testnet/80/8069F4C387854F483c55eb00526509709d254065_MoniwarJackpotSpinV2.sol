...
contract MoniwarJackpotSpinV2 is Ownable, ReentrancyGuard {
    ...
    mapping(address => mapping(uint256 => AlphabetSpin)) public alphabetSpin;
    ...
    function getSpin(uint256 time) internal {
        ...
        if (reward1 <= 10 && reward2 <= 60 && reward3 <= 40 && reward4 == 1) {
            ...
            //  row 1
            if (reward1 <= 10) {
                alphabetSpin[_msgSender()][time].qtyM += 1;
            ...
            // row 2
            if (reward1 <= 60) {
                alphabetSpin[_msgSender()][time].qtyO += 1;
            ...
            // row 3
            if (reward1 <= 40) {
                alphabetSpin[_msgSender()][time].qtyW += 1;
            ...
            // row 4
            if (reward1 <= 1) {
                alphabetSpin[_msgSender()][time].qtyA += 1;
