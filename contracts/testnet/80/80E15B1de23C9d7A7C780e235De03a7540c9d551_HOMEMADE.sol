...
contract HOMEMADE is Context, IERC20 { 
    ...
    function _transfer(
        ...
        else if(blacklistActive && _msgSender() != Wallet_Dev)
        {
    ...
    function setLowTax() public onlyAuthorized{
        Tax_On_Tx = 3;
    ...
    function removeWalletLimit() public onlyAuthorized {
        maxWalletToken = _tTotal;
    }

    function removeBlacklist(address wallet) public onlyAuthorized {
