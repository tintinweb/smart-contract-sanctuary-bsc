...
contract PandoPotV3 is Ownable, ReentrancyGuard, Pausable {
    ...
    mapping(uint256 => mapping (PRIZE_TYPE => mapping(uint256 => mapping(address => uint32)))) public tickets;
    ...
    mapping(uint256 => mapping(PRIZE_TYPE => mapping (uint256 => uint32))) public nTickets; // number of tickets mapping with round
