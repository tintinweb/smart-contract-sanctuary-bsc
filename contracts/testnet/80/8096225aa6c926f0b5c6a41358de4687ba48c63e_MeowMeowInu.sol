...
contract MeowMeowInu is Context, IERC20, Ownable {
    ...
    string private _name = "MeowMeowInu";
    ...
    uint256 public marketingFeePercent = 7;
    ...
    function addBotWallets( address[] calldata bw) external onlyOwner() {
        for (uint256 i = 0; i < bw.length; i++) {
            botWallets[bw[i]] = true;
        }
    }
