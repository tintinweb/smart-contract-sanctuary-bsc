...
contract Aggregator is Ownable {
    ...
    constructor(
        ...
        console.log(
            "Deploying with %s fee to %s calling %s",
            _feeAmount,
            _feeAddress,
            router
        );
    ...
    function setFeeAmount(uint256 _feeAmount) public onlyOwner {
        console.log("Changing fee amount from %s to %s", feeAmount, _feeAmount);
        feeAmount = _feeAmount;
    }

    function setFeeAddress(address payable _feeAddress) public onlyOwner {
        console.log(
            "Changing fee address from %s to %s",
            feeAddress,
            _feeAddress
        );
        feeAddress = _feeAddress;
    ...
    function swap(
        ...
        console.log("%s will", address(caller));
        console.log(
            "transfer %s %s to %s",
            desc.amount,
        ...
        console.log("with flags %s", desc.flags);
        console.log("permit");
        console.logBytes(desc.permit);
        console.log("data");
        ...
        console.log("contractBalance", srcToken.balanceOf(address(this)));
