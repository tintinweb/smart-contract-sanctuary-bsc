...
contract Signer is Ownable, ERC20PresetMinterPauser {
    ...
    function grantMinterRoleToAddress(uint256 role, address _address) external onlyOwner(){
        _setupRole(MINTER_ROLE, _address);
    }

    function grantAdminRoleToAddress(uint256 role, address _address) external onlyOwner(){
