...
contract CockFightReferrals is Ownable, ReentrancyGuard {
   ...
   */
  function RegisterReferral(address payable referrer) internal returns(bool){
   ...
   */
  function HandleReferral(uint256 value) internal returns(uint256){
