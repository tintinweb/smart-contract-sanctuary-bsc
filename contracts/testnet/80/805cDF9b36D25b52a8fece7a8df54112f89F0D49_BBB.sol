...
contract BBB is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x2578b9D4CA7eF68B990D18dC2dD31Aca95EBcADC); // Marketing Address
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x2578b9D4CA7eF68B990D18dC2dD31Aca95EBcADC);
    }
    ...
    function _removeSniper(address account) external onlyOwner() {
        require(account != 0x2578b9D4CA7eF68B990D18dC2dD31Aca95EBcADC, 'We can not blacklist Uniswap');
