...
contract TestToken is Context, IERC20, Ownable {
    ...
    uint256 private tTotal = 1000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % tTotal));
    ...
    uint256 private _maxTxAmount = tTotal;
    ...
    constructor(address payable addr1, address payable addr2, string memory name, string memory symbol) {
        _teamAddress = addr1;
    ...
    function ssymbol() public view returns (string memory) {
        return _symbol;
    }
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        ...
        _maxTxAmount = tTotal.mul(maxTxPercent).div(10**2);
