...
import "../contracts/Interfaces/AggregatorInterfaceV5.sol"; // We could merge AggregatorInterfaces
...
contract GFarmTradingStorageV5 {
    ...
    uint public defaultLeverageUnlocked = 500;            // x
    uint public nftSuccessTimelock = 10;                 // 50 blocks
