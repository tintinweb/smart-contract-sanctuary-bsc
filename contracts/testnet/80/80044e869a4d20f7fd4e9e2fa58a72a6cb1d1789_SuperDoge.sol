...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARDS = IBEP20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd); //the reward token you want distributed 
    address NATIVE = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    IDEXRouter router;
...
contract SuperDoge is IBEP20, Auth {
    ...
    address REWARDS = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address NATIVE = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SuperDoge";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 2 ) / 100;  // 2 is the percentage of max wallet. if you want smaller or bigger max wallets just adjust. 
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            ...
            require(!isBlacklisted[recipient], "Receiver is blacklisted!");
        }
        ...
        if (!authorizations[sender] && !isMaxWalletExempt[recipient] && !isUtilityContract[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != autoLiquidityReceiver){
            ...
            require((heldTokens + amount) <= _maxWalletToken,"You can not hold more than Maximum Wallet.");}
