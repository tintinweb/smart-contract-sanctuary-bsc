...
contract recursive
{
    ...
    function binaryEntry(address _referredBy, uint256 _stakeAmount) public
    {
        ...
        {
            require(referralInfos[msg.sender].referredBy == address(0),"Already referred");
...
contract StakeUSDT is recursive {
    ...
    function claimReward() public{
        ...
        uint256 totalTokens = stakeInfos[msg.sender].amount + stakeInfos[msg.sender].interestAmount;
    ...
    function stakeToken(
        ...
        public
    {
        uint256 stakeAmount = _stakeAmount * (10 ** USDT.decimals());
        require(stakeAmount >= 20 * (10 ** USDT.decimals()), "Min stake 20$");
        ...
        require(isUser[_referredBy] == true || _referredBy == address(0),"Referrer is not User");
        ...
        if(stakeAmount >= 50 * (10 ** USDT.decimals())  && stakeAmount < 600 * (10 ** USDT.decimals()))
        {
        ...
        else if (stakeAmount >= 600 * (10 ** USDT.decimals()) && stakeAmount < 1100 * (10 ** USDT.decimals()))
        {
            USDT.transferFrom(msg.sender, address(this), stakeAmount);
        ...
        else if (stakeAmount >= 1100 * (10 ** USDT.decimals()) && stakeAmount < 3100 * (10 ** USDT.decimals()))
        {
            USDT.transferFrom(msg.sender, address(this), stakeAmount);
            ...
            stakeInfos[msg.sender].designationReward = 100 * (10 ** RAMT.decimals());
            stakeInfos[msg.sender].staked = true;
            stakeInfos[msg.sender].claimed = false;
            isUser[msg.sender] = true;
        ...
        else if (stakeAmount >= 3100 * (10 ** USDT.decimals()) && stakeAmount < 5100 * (10 ** USDT.decimals()))
        {
            USDT.transferFrom(msg.sender, address(this), stakeAmount);
            ...
            stakeInfos[msg.sender].designationReward = 200 * (10 ** RAMT.decimals());
            stakeInfos[msg.sender].staked = true;
            stakeInfos[msg.sender].claimed = false;
            isUser[msg.sender] = true;
        ...
        else if (stakeAmount >= 5100 * (10 ** USDT.decimals()) && stakeAmount < 11000 * (10 ** USDT.decimals()))
        {
            USDT.transferFrom(msg.sender, address(this), stakeAmount);
            ...
            stakeInfos[msg.sender].designationReward = 500 * (10 ** RAMT.decimals());
            stakeInfos[msg.sender].staked = true;
            stakeInfos[msg.sender].claimed = false;
            isUser[msg.sender] = true;
        ...
        else if (stakeAmount >= 11000 * (10 ** USDT.decimals()) && stakeAmount < 21000 * (10 ** USDT.decimals()))
        {
            USDT.transferFrom(msg.sender, address(this), stakeAmount);
            ...
            stakeInfos[msg.sender].designationReward = 1000 * (10 ** RAMT.decimals());
            stakeInfos[msg.sender].staked = true;
            stakeInfos[msg.sender].claimed = false;
            isUser[msg.sender] = true;
        ...
        else if (stakeAmount >= 21000 * (10 ** USDT.decimals()))
        {
            USDT.transferFrom(msg.sender, address(this), stakeAmount);
            ...
            stakeInfos[msg.sender].designationReward = 1500 * (10 ** RAMT.decimals());
            stakeInfos[msg.sender].staked = true;
            stakeInfos[msg.sender].claimed = false;
            isUser[msg.sender] = true;
        ...
        if(_referredBy != address(0))
        {
            ...
            {
                RAMT.transfer(referralInfos[msg.sender].referredBy, ((10 * stakeAmount)/ 100));
                referralInfos[_referredBy].referralRewardAClaimed = true;
            }
            else
            {
                RAMT.transfer(referralInfos[msg.sender].referredBy, ((10 * stakeAmount)/ 100));
                RAMT.transfer(referralInfos[msg.sender].directReferrer, referralInfos[referralInfos[msg.sender].directReferrer].binaryReward);
                referralInfos[_referredBy].referralRewardBClaimed = true;
                
                if(stakeInfos[_referredBy].businessReward >= 5000 * (10 ** USDT.decimals()) && stakeInfos[_referredBy].businessReward <10000 * (10 ** USDT.decimals()))
                {
                    stakeInfos[_referredBy].businessReward = 100 * (10 ** USDT.decimals());
                    RAMT.transfer(_referredBy, stakeInfos[_referredBy].businessReward);
                }
                else if (stakeInfos[_referredBy].businessReward >=10000 * (10 ** USDT.decimals()) && stakeInfos[_referredBy].businessReward <15000 * (10 ** USDT.decimals()))
                {
                    stakeInfos[_referredBy].businessReward = 250 * (10 ** USDT.decimals());
                    RAMT.transfer(_referredBy, stakeInfos[_referredBy].businessReward);
                }
                else if (stakeInfos[_referredBy].businessReward >=15000 * (10 ** USDT.decimals()) && stakeInfos[_referredBy].businessReward <20000 * (10 ** USDT.decimals()))
                {
                    stakeInfos[_referredBy].businessReward = 500* (10 ** USDT.decimals());
                    RAMT.transfer(_referredBy, stakeInfos[_referredBy].businessReward);
                }
                else if (stakeInfos[_referredBy].businessReward >=20000* (10 ** USDT.decimals()) && stakeInfos[_referredBy].businessReward <25000 * (10 ** USDT.decimals()))
                {
                    stakeInfos[_referredBy].businessReward = 1000 * (10 ** USDT.decimals());
                    RAMT.transfer(_referredBy, stakeInfos[_referredBy].businessReward);
                }
                else if (stakeInfos[_referredBy].businessReward >=25000 * (10 ** USDT.decimals()) && stakeInfos[_referredBy].businessReward <30000 * (10 ** USDT.decimals()))
                {
                    stakeInfos[_referredBy].businessReward = 1500 * (10 ** USDT.decimals());
                    RAMT.transfer(_referredBy, stakeInfos[_referredBy].businessReward);
                }
                else if (stakeInfos[_referredBy].businessReward >=30000 * (10 ** USDT.decimals()) && stakeInfos[_referredBy].businessReward <100000 * (10 ** USDT.decimals()))
                {
                    stakeInfos[_referredBy].businessReward = 2000 * (10 ** USDT.decimals());
                    RAMT.transfer(_referredBy, stakeInfos[_referredBy].businessReward);
                }
                else if (stakeInfos[_referredBy].businessReward >=100000 * (10 ** USDT.decimals()) && stakeInfos[_referredBy].businessReward <300000 * (10 ** USDT.decimals()))
                {
                    stakeInfos[_referredBy].businessReward = 2500 * (10 ** USDT.decimals());
                    RAMT.transfer(_referredBy, stakeInfos[_referredBy].businessReward);
                }
                else if (stakeInfos[_referredBy].businessReward >=300000 * (10 ** USDT.decimals()) && stakeInfos[_referredBy].businessReward <500000 * (10 ** USDT.decimals()))
                {
                    stakeInfos[_referredBy].businessReward = 6000 * (10 ** USDT.decimals());
                    RAMT.transfer(_referredBy, stakeInfos[_referredBy].businessReward);
                }
                else if (stakeInfos[_referredBy].businessReward >=500000 * (10 ** USDT.decimals()) && stakeInfos[_referredBy].businessReward <1000000 * (10 ** USDT.decimals()))
                {
                    stakeInfos[_referredBy].businessReward = 10000 * (10 ** USDT.decimals());
                    RAMT.transfer(_referredBy, stakeInfos[_referredBy].businessReward);
                }
                else if (stakeInfos[_referredBy].businessReward >=1000000 * (10 ** USDT.decimals()))
                {
                    stakeInfos[_referredBy].businessReward = 20000 * (10 ** USDT.decimals());
                    RAMT.transfer(_referredBy, stakeInfos[_referredBy].businessReward);
                }
            }
        }  
    ...
    function setBusinessIncentive(
        address _referredBy)
        internal
    {
        if(referralInfos[_referredBy].myReferrals == 2)
        {
            stakeInfos[_referredBy].businessReward = min(referralInfos[_referredBy].referralStakeAmount[0] , referralInfos[_referredBy].referralStakeAmount[1]);
        }
        else if (referralInfos[_referredBy].myReferrals == 6)
        {
            stakeInfos[_referredBy].businessReward = min4(referralInfos[_referredBy].referralStakeAmount[2],
    ...
    function getReferralInfo() public view returns(referralInfo memory)
    {
        return referralInfos[msg.sender];
    }
