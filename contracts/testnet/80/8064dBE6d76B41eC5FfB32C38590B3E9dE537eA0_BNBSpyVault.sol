...
contract BNBSpyVault is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    ISpyPool public vaultReferralTreasury;
    ...
    function initialize(
        ...
        vaultReferralTreasury = ISpyPool(_vaultReferralTreasury);
    ...
    function updateReferralTreasury(ISpyPool _treasury) external onlyOwner {
