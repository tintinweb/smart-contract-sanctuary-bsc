...
contract NaysapayLottery is ReentrancyGuard, INaysapayLottery, Ownable {
    ...
    constructor(address _lotteryTokenAddress,address _randomGeneratorAddress) {
         LotteryToken = IBEP20(_lotteryTokenAddress);
        ...
        nonReentrant
    {
        ...
        // Transfer knigtex tokens to this contract
         LotteryToken.safeTransferFrom(address(msg.sender), address(this), amountKnigtexToTransfer);
    ...
    function claimTickets(
        ...
        // Transfer money to msg.sender
         LotteryToken.safeTransfer(msg.sender, rewardInKnigtexToTransfer);
    ...
    function recoverWrongTokens(address _tokenAddress, uint256 _tokenAmount) external onlyOwner {
        require(_tokenAddress != address( LotteryToken), "Cannot be Knigtex token");
    ...
    function updateLotteryTime(uint256 _lotteryID, uint256 _startTime, uint256 _endTime) external onlyOwner {
        Lottery storage _lot = _lotteries[_lotteryID];
        _lot.startTime = _startTime;
        _lot.endTime = _endTime;
    }
