...
contract MotoDEXnft is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    constructor(uint256 networkId, address[] memory _gameServers) ERC721("motoDEXnft", "MOTO") {
        ...
        setupType(RED_BULLER, startPrice, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/RedBuller");
        setupType(ZEBRA_GRRR, startPrice + 1 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/ZebraGrrrr");
        setupType(ROBO_HORSE, startPrice + 2 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/RoboHorse");
        setupType(METAL_EYES, startPrice + 3 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/MetalEyes");
        setupType(BROWN_KILLER, startPrice + 4 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/BrownKiller");
        setupType(CRAZY_LINE, startPrice + 5 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/CrazyLine");
        setupType(MAGIC_BOX, startPrice + 6 ether, 0, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/MagicBox");
        ...
        setupType(TRACK_BEIJIN, 50 ether, 3, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/Beijing");
        ...
        if (networkId == 97) {
            ...
            setupType(TRACK_LONDON, 0.05 ether, 300, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/London");
        }
        if (networkId == 80001) {
        ...
        if (networkId == 1313161555) {
            ...
            valueDecrease = 100000000000000;
            setupType(TRACK_LONDON, 0.000005 ether, 300, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/London");
        }
        if (networkId == 1029) {
            setupType(TRACK_LONDON, 0.05 ether, 300, "https://openbisea.mypinata.cloud/ipfs/QmTfCQ4cposTtYQy79G1RAxXQTN85TPw5qJSdnff1GnAty/London");
    ...
    function purchaseToken (uint8 typeNft, address referral, address token) public {
        //0x8bec47865ade3b172a928df8f990bc7f2a3b9f79 AURORA
        require(token == address(0x8BEc47865aDe3B172A928df8f990Bc7f2A3b9f79), "NA");
        ...
        if (referral != address (0x0) || _referrals[msg.sender] != address (0x0)) {
            ...
            IERC20(token).transferFrom(msg.sender, referral, referralFee);
            IERC20(token).transferFrom(msg.sender, owner(), getPriceForTypeToken(typeNft, token).sub(referralFee));
        } else {
            IERC20(token).transferFrom(msg.sender, owner(), getPriceForTypeToken(typeNft, token));
        }
    ...
    function purchaseTokenBatch (uint8[] memory typesNft, address referral, address token) public {
        //0x8bec47865ade3b172a928df8f990bc7f2a3b9f79 AURORA
        require(token == address(0x8BEc47865aDe3B172A928df8f990Bc7f2A3b9f79), "NA");
        ...
        if (referral != address (0x0) || _referrals[msg.sender] != address (0x0)) {
            ...
            IERC20(token).transferFrom(msg.sender, referral, referralFee);
            IERC20(token).transferFrom(msg.sender, owner(), totalValueToPay.sub(referralFee));
        } else {
            IERC20(token).transferFrom(msg.sender, owner(), totalValueToPay);
        }
    ...
    function purchaseBatch(uint8[] memory typesNft, address referral) payable public {
        ...
        require(msg.value >= totalValueToPay.sub(valueDecrease), "MotoDEXnft: wrong value to send");
        ...
        for(uint256 y=0;y<typesNft.length;y++) {
            ...
            _safeMintType(msg.sender, "", finalTypeNft, false);
            emit Purchase(msg.sender, msg.value, typesNft[y], finalTypeNft, address(0));
        }
