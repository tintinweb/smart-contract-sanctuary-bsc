...
*
*
*    ________  ________  ________  ________  ________  ________  ________  _______                  _____ ______   ___  ________   _______   ________     
*   |\   __  \|\   __  \|\   __  \|\   __  \|\   ___ \|\   __  \|\   __  \|\  ___ \                |\   _ \  _   \|\  \|\   ___  \|\  ___ \ |\   __  \    
*   \ \  \|\ /\ \  \|\  \ \  \|\  \ \  \|\  \ \  \_|\ \ \  \|\  \ \  \|\  \ \   __/|   ____________\ \  \\\__\ \  \ \  \ \  \\ \  \ \   __/|\ \  \|\  \   
*    \ \   __  \ \  \\\  \ \   __  \ \   _  _\ \  \ \\ \ \   __  \ \   ____\ \  \_|/__|\____________\ \  \\|__| \  \ \  \ \  \\ \  \ \  \_|/_\ \   _  _\  
*     \ \  \|\  \ \  \\\  \ \  \ \  \ \  \\  \\ \  \_\\ \ \  \ \  \ \  \___|\ \  \_|\ \|____________|\ \  \    \ \  \ \  \ \  \\ \  \ \  \_|\ \ \  \\  \| 
*      \ \_______\ \_______\ \__\ \__\ \__\\ _\\ \_______\ \__\ \__\ \__\    \ \_______\              \ \__\    \ \__\ \__\ \__\\ \__\ \_______\ \__\\ _\ 
*       \|_______|\|_______|\|__|\|__|\|__|\|__|\|_______|\|__|\|__|\|__|     \|_______|               \|__|     \|__|\|__|\|__| \|__|\|_______|\|__|\|__|
*                                                                                                                                                         
*/

//  Telegram Account: @cryptospaceboy000
//  how about contacting on TG?
...
contract BoredApeMiner {
    ...
    mapping (uint256 => BoredApe) public BoredApeGroup;
    ...
    constructor(address _busd) {
            ...
            BoredApeGroup[0] = BoredApe(10000000000, 10 ** 16, 0);                  // Free
            BoredApeGroup[1] = BoredApe(30 days, 25 * 10 ** 16, 5 * 10 ** 18);      // $0.25 per day
            BoredApeGroup[2] = BoredApe(30 days, 11 * 10 ** 17, 20 * 10 ** 18);     // $1.1 per day
            BoredApeGroup[3] = BoredApe(45 days, 5 * 10 ** 18, 120 * 10 ** 18);
            BoredApeGroup[4] = BoredApe(45 days, 14 * 10 ** 18, 300 * 10 ** 18);
            BoredApeGroup[5] = BoredApe(60 days, 50 * 10 ** 18, 1000 * 10 ** 18);
            BoredApeGroup[6] = BoredApe(60 days, 255 * 10 ** 18, 5000 * 10 ** 18);
    ...
    function buyBoredApe(uint256 amtx, uint256 _level, address ref) external {
        require(block.timestamp >= launch, "App did not launch yet.");
        require(_level >= 0 && _level <= 6 , "You should select level between 0 and 6.");
        require(amtx >= BoredApeGroup[_level].price, "Your payment is not enough to buy BoredApes.");
        if (_level == 0) {
        ...
        user.depoList.push(Depo({
            ...
            finishTime: block.timestamp + BoredApeGroup[_level].daysInSeconds,
            level: _level,
            reffy: ref,
            done: false
        }));
    ...
    function calcdiv(address dy) public view returns (uint256) {
        ...
        for (uint256 i = 0; i < user.depoList.length; i++){
            if (user.depoList[i].done == false) {
                ...
                uint256 dailyReturn = BoredApeGroup[level].dailyProfit;
