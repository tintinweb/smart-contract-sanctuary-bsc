...
contract EleContract is Ownable{
    ...
    mapping (address => uint256) public lastGiveReward;
    ...
    function rewardRef(address ref) public{
        ...
        lastGiveReward[msg.sender]=now;

        
        rewards[referrals[msg.sender]]=SafeMath.add(rewards[referrals[msg.sender]],SafeMath.div(SafeMath.mul(eggsUsed,20),100));
    ...
    function invest(uint256 amount, address ref) public {
        require(initialized);
        ...
        rewards[msg.sender]=SafeMath.add(rewards[msg.sender],eggsBought);
    ...
    function getMyEggs() public view returns(uint256){
        ...
        return SafeMath.add(rewards[msg.sender],getEggsSincelastGiveReward(msg.sender));
    }
    function getEggsSincelastGiveReward(address adr) public view returns(uint256){
        
        uint256 secondsPassed=min(EGGS_TO_HATCH_1MINERS,SafeMath.sub(now,lastGiveReward[adr]));
