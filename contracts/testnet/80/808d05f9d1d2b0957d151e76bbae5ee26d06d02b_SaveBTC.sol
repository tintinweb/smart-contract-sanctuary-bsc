...
/*
   ...
   SaveBTC
   Launch on Binance Smart Chain with Tiny Initial Market Cap
   
   Great features:
   2% fee auto add to the liquidity pool.
   2% BTC Rewards every 30 min.
   4% fee for marketing.
   2% fee Extra Sell fee foor dumpers.
   Total 8% Buy and 10% Sell Tax.

   Telegram : https://t.me/BTCsave
   We want the coommuntiy to support this project and lets go to the moon together!!
 */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //BTCB
...
contract SaveBTC is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SaveBTC";
    string constant _symbol = "SaveBTC";
    ...
    uint256 _totalSupply = 10000000 * (10 ** _decimals); //10 million
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x1628A3a7Cafb013DCaaae765DcD195716B71BC2A;  //marketingwallet
        anothermarketingWallet = 0x1628A3a7Cafb013DCaaae765DcD195716B71BC2A; // dev wallet .5 percent ser
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 marketingShare = amountBNBMarketing.mul(6).div(7);
