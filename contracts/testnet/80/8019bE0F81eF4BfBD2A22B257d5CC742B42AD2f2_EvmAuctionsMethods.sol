...
contract EvmAuctionsMethods is ERC721Holder, ERC1155Holder, Ownable, ReentrancyGuard, TokensHandler {
    uint public id;
    uint public fee = 20;
    ...
    function finish(uint auctionId) external {
        ...
        transferTokens(auctions[auctionId].owner,address(this),auctions[auctionId].nftAddresses,auctions[auctionId].nftIds,auctions[auctionId].nftTypes);
