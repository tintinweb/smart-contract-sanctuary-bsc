...
// File: contracts/Chooky/RoyaltyStake.sol
...
contract ChookyRoyaltySharing is ReentrancyGuard, Ownable {
    ...
    function stakeChookyForRoyalty(uint256 _amount) external nonReentrant {
        ...
        else if(chookyHolders[msg.sender].userStakedBalance < ChookySupply / 80 && chookyHolders[msg.sender].userStakedBalance >= ChookySupply / 125) {
            chookyHolders[msg.sender].tier = 1;
            tierIIHolders ++;
        }
        else if(chookyHolders[msg.sender].userStakedBalance < ChookySupply / 125 && chookyHolders[msg.sender].userStakedBalance >= ChookySupply / 200) {
            chookyHolders[msg.sender].tier = 2;
            tierIIIHolders ++;
        }
        else if(chookyHolders[msg.sender].userStakedBalance < ChookySupply / 200 && chookyHolders[msg.sender].userStakedBalance >= ChookySupply / 400) {
