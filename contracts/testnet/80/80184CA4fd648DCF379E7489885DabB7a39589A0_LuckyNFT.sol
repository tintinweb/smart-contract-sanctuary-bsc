...
================================================================
 */
    function getLuckyNFT(address recipient, uint256 _type, uint256 _rarity)
        public
        onlyAdmin
        ...
        returns (uint256)
    {
        ...
        uint256 res = nftCollection.mintNFT(recipient, _tokenURI, _type, _rarity);
        luckyWallet[recipient] -= 1;

        emit LuckyNFTOpened(msg.sender, recipient, _tokenURI);
        return res;
    }
