...
contract TokenMapping{
 ...
 onlyOwner public view returns(address,address,uint256){
 ...
 function buyNft(uint256 zynsNum,uint256 zhnsNum)
 public returns(bool){
 ...
 onlyOwner public view returns(address,address,address,address){
