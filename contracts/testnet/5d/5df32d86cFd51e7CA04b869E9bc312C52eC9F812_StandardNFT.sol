...
contract StandardNFT is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public immutable quantityPerWallet;
    ...
    constructor(
        ...
        uint256 _quantityPerWallet
    ) ERC721(_name, _symbol) {
        require(_mintStartTime > 0);
        require(_mintEndTime > 0);
        require(_totalSupply > 0);
        require(_quantityPerWallet > 0);
        ...
        quantityPerWallet = _quantityPerWallet;
    }
    ...
    function mint(
        ...
        require(
            numberOfTokens > 0 &&
                numberMinted[msg.sender] + numberOfTokens <= quantityPerWallet,
