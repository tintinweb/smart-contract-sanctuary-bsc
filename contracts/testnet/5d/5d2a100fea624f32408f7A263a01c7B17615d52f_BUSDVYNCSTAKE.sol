...
contract BUSDVYNCSTAKE {
        ...
        returns (uint256 totalReward)
    {
        ...
        if(totalReward >= userInfo[user].totalClaimedReward) {
        totalReward= totalReward-userInfo[user].totalClaimedReward;
        }
        else
        {
            totalReward= userInfo[user].totalClaimedReward-totalReward;
        }
    }
    ...
    function rewardCalculation(address user) internal {
        ...
        userInfo[user].totalClaimedReward = userInfo[user].totalClaimedReward + userInfo[user].lastClaimedReward;
            ...
            userInfo[user].lastClaimedReward= userInfo[user].totalClaimedReward - totalReward;
            userInfo[user].totalClaimedReward = userInfo[user].totalClaimedReward + userInfo[user].lastClaimedReward;
        }
    }
    ...
    function claim() public {
        ...
        require(compoundTime >= 60,"wait for next compound"); //86400
