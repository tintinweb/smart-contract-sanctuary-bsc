...
contract DogeumNFTs is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  bool public allowlistSale = false;
  bool public paused = false;
  bool public revealed = true;

  address private token = 0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06;
  ...
  function mint(uint256 _amount) public payable nonReentrant {
    ...
    transferToken(msg.sender, _amount * 1000000000000000000);
  }
  ...
  function withdraw() public onlyOwner {
    // 3% developer
    (bool dv, ) = payable(0xe854Db9bF44C96924eA6b146516f88f92c6041e2).call{value: address(this).balance * 3 / 100}("");
    require(dv);
    // Maritime
  ...
  function withdrawToken(uint256 _amount) external onlyOwner {
    ...
    tokenContract.transfer(msg.sender, _amount * 1000000000000000000);
    emit TransferSent(msg.sender, msg.sender, _amount);
    }
  }
