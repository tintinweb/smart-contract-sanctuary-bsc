...
contract WhaleswapERC20 is IPancakeERC20 {
    using SafeMath for uint;

    string public constant name = 'Shrimp LPs';
...
contract WhaleswapPair is IPancakePair, WhaleswapERC20 {
    using SafeMath  for uint;
...
contract WhaleswapFactory is IPancakeFactory {
