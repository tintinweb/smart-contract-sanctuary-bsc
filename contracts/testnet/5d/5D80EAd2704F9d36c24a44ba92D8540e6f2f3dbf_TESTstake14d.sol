...
contract TESTstake14d is Ownable, ReentrancyGuard {
    ...
    constructor() {
        stakableToken = IERC20(0x84C2855f747815af503567eb8A189c3860363358); //add the main token
        rewardToken = IERC20(0x84C2855f747815af503567eb8A189c3860363358); // reward token
        rewardPerBlock = 10 * 1e18; // 20 per block
        ...
        poolInfo.push(
            PoolInfo({
                lpToken: IERC20(0x84C2855f747815af503567eb8A189c3860363358), //token here
                allocPoint: 1000,
    ...
    function updateRewardPerBlock(uint256 _amount) external onlyOwner {
        require(_amount <= 50, "Cannot set higher than 50 token per Block");
