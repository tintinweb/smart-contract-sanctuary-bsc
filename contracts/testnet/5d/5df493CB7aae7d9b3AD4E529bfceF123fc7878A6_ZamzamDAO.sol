...
interface IZamzamDAO is IAccessControl {
   ...
   */
  function createProject(uint256 goalAmount) external returns (uint256);
   ...
   * @return Returns the projectId of the created project
   */
  function updateProjectGoalAmount(uint256 _projectId, uint256 _goalAmount) external returns (uint256);
   ...
   * @return Returns the projectId of the created project
   */
  function updateProjectUnpublished(uint256 _projectId, bool _unpublished) external returns (uint256);
