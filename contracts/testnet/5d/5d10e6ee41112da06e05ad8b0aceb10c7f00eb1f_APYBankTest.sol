...
// SPDX-License-Identifier: None
    ...
    contract APYBankTest is ERC20Detailed, Ownable {
        ...
        uint256 private minSupplyForReferralReward = 1 * 10 **18 ; //0.05% of the supply needs to be updated depending on rebasing
        bool public minReferralActive = true; 
        ...
        constructor(address _referralCA) ERC20Detailed("APYBankTEST", "APYTEST", uint8(DECIMALS)) {
