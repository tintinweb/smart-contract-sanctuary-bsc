...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
      //router = _router != address(0) ? IPancakeSwapRouter(_router) : IPancakeSwapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        router = _router != address(0) ? IPancakeSwapRouter(_router) : IPancakeSwapRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);//testnet
        _token = msg.sender;
    }
    ...
    function distributeDividend(address shareholder) internal {
        address addr_taxes = 0xF9273086aF61217826c40f7C3a0aD653ebB9bBAe; // La Caisse =)
...
contract AugBeta is ERC20Detailed, Ownable {
    ...
    uint256 public treasuryFee = 25;     // 2.5% Achats + 2% Vente
    uint256 public safuDividendFee = 90; // -> 5.4% Holders 3.6% Dev
    uint256 public sellFee = 20;
    uint256 public autofirePitFee = 25;  //  2.5% Burn
...
//  address public kimporte = 0xF9273086aF61217826c40f7C3a0aD653ebB9bBAe;
    ...
    constructor() ERC20Detailed("blablabla", "blablabla", uint8(DECIMALS)) Ownable() {
       ...
       //router = IPancakeSwapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); 
        ...
        autoLiquidityReceiver = 0x2F6ff480051Be214De3a8649889D9B6Ce43b062b;
        treasuryReceiver = 0x0f33442eF02AF2fd92Bc42CEda5c44926ae0FF29;   
        autofirePit = 0x000000000000000000000000000000000000dEaD;

        _allowedFragments[address(this)][address(router)] = uint256(-1);
        pairContract = IPancakeSwapPair(pair);

        distributor = new DividendDistributor(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //Router Pancakeswap
 ...
 /*   function changeSousous(address newaddress) public onlyOwner { 
         kimporte = newaddress;
        }
*/
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no Aug token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
