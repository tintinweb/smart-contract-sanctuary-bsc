...
contract NftSales is PriceConsumerV3, OwnPause, ReentrancyGuard {
  ...
  event EventUpdateMerkleRoot(bytes32 root_);
  ...
  modifier isInWhitelist() {
        require(_whitelist[msg.sender] == true, "OwnPause: not owner");
        _;
    }
  ...
  function buyInNativeWithMerkleProof()
    external
    payable
    whenNotPaused
    isInWhitelist
