...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (string memory Name, string memory Symbol, uint8 Decimals, uint256 Supply, address FundAddress, address DividendAddress){
        ...
        _swapRouter = ISwapRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);          //0x10ED43C718714eb63d5aA57B78B54704E256024E
        usdt = address(0x8516Fc284AEEaa0374E66037BD2309349FF728eA);                     //0x55d398326f99059fF775485246999027B3197955
...
contract AddUsdtLP is AbsToken {
    ...
    //总量 120亿
        120 * 10 ** 8,
    //营销钱包
        address(0xdD2FD4581271e230360230F9337D5c0430Bf44C0),        //0x5A198036702A6354315B584Fe602Cfbc90D5183A
    //分红钱包,
        address(0x8626f6940E2eb28930eFb4CeF49B2d1F2C9C1199)      //0x3086389895D9Dc240993F60F1633fb1Cf0ADec9A
    ){
