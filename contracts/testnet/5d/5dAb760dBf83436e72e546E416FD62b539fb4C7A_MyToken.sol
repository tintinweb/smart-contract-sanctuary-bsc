...
contract MyToken is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable,OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(string memory _name,string memory _symbol,uint8 _decimal,address _router) initializer public {
        __ERC20_init(_name, _symbol);
        _decimals = _decimal;
        _mint(_msgSender(),100000000000000000000 * 10 ** decimals());
        __Ownable_init();
    ...
    function setRoute(address _router) internal onlyOwner{
        ...
        _tokenBalance[owner()] = totalSupply();
        maxTxAmountPercentage = 500;
        maxTxAmount = totalSupply().mul(maxTxAmountPercentage).div(100); // 0.05%
        ...
        sellCooldownAmount = totalSupply().mul(5).div(100);
        isFeeActive = true;
