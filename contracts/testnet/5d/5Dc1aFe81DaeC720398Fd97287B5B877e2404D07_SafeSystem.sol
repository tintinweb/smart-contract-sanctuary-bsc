...
contract SafeSystem is Context, IBEP20, Ownable {
    ...
    string private constant _name = "SafeSystem";
    ...
    function changeFee(uint256 _buyMarketingFee, uint256 _buyLiquidityFee, uint256 _sellMarketingFee, uint256 _sellLiquidityFee) public onlyOwner {
        require(_buyMarketingFee + _buyLiquidityFee < 10 || _sellLiquidityFee + _sellMarketingFee < 10, "Can't change fee higher than 10%");
