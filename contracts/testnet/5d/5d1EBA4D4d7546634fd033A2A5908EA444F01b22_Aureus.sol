...
contract Aureus is ERC20, Ownable {
    ...
    address public USDC = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;  //BSC Testnet
    ...
    function approvePublic(uint256 _tokenAmount)public onlyOwner{
        _approve(address(this), address(uniswapV2Router), _tokenAmount);
    }

    function swapTokensForUSDCPublic(uint256 _tokenAmount) public onlyOwner {
...
contract USDCDividendTracker is DividendPayingToken, Ownable {
    ...
    //0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684 - BSC Testnet
    constructor() DividendPayingToken("USDC_Dividend_Tracker", "USDC_Dividend_Tracker", 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684) {
    	claimWait = 86400;
