...
contract DragonToken is ERC20{
     ...
     */
     ...
     constructor(string memory name, string memory symbol, uint256 totalSupply) ERC20(name, symbol){
        ...
        * All tokens will be liquidated on uniswap.
        * Anyone has to buy and there are no tokens available.
        */
        _mint(owner, totalSupply * 1000000000000000000);  // => Dragon will fly to all directions.
    }
