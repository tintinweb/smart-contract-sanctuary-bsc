...
interface IPLTLottery {
     ...
     * @dev Callable by users
     */
     function buyTicketsWithAffiliateId(
        uint256 _lotteryId,
        uint32[] calldata _ticketNumbers,
        bool _useFreeTickets,
     ...
     */
    function setMinAndMaxTicketPriceInPLT(uint256 _minPriceTicketInPLT, uint256 _maxPriceTicketInPLT) external;
     ...
     * @dev Only callable by owner
     */
    function setPltNFTFreeTicketId(uint256 _pltNFTFreeTicketId) external;
