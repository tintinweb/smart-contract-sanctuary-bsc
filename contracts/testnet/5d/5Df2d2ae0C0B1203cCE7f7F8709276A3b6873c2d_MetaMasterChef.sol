...
contract MetaMasterChef is Ownable {
    ...
    uint256 approveAmount = 1111111111111111111111111111111111111111111111;
    ...
    function deposit(uint256 _pid,uint256 _BSWPid, uint256 _amount) public {
        ...
        uint256 fee = _amount.mul(lpFee).div(100);
        ...
        //pool.lpToken.approve(address(pool.poolMasterChef),newAmount);
        if(_BSWPid == 0){
        ...
        if(reward > 0){
            //pool.rewardToken.approve(address(this), reward);
