...
// File: localhost/contracts/interfaces/IPYESwapRouter01.sol
...
// File: localhost/contracts/interfaces/IPYESwapRouter.sol
...
// File: localhost/contracts/interfaces/IPYESwapPair.sol
...
// File: localhost/contracts/interfaces/IPYESwapFactory.sol
...
// File: localhost/contracts/interfaces/IPYE.sol
...
// File: localhost/contracts/Magic_Swap.sol
...
contract PyeMoon is IPYE, Context, Ownable {
    ...
    string constant _name = "PyeMoon";
    string constant _symbol = "PyeMoon";
    ...
    constructor(address _router) public {
        ...
        _defaultFees = Fees(800);

        IPYESwapPair(pyeSwapPair).updateTotalFee(800);
    ...
    function _getValues(uint256 tAmount) private view returns (FeeValues memory) {
        ...
        values.transferAmount = tAmount.sub(values.reflection);
        return values;
    }
