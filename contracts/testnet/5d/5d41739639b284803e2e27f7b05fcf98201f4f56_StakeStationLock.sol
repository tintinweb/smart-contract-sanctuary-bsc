...
contract StakeStationLock is Ownable, ReentrancyGuard {
    ...
    function initialize(
        ...
        lockups.push(Lockup(0, 30, 0, 0, 380517503805175000000000, 0, 0, 0)); // 0.4% liquidity
        lockups.push(Lockup(1, 60, 0, 0, 570776255707762000000000, 0, 0, 0)); // 0.6% liquidity
