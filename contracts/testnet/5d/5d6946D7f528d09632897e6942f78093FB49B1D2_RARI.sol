...
contract BaseToken is Ownable {
    ...
    string constant public name = 'RARI1';

    string constant public symbol = 'RARI1';

    uint8 constant public decimals = 18;

    uint256 public totalSupply = 10000000000*10**uint256(decimals);

    uint256 public constant MAXSupply = 11111 * 10 ** uint256(decimals);
    ...
    address public projectAddress = 0x0f6D0D39C0D04bCBB79B79C6babCEa6800D1c462;
