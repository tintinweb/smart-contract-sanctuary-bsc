...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xDfA1D82CAd63732A6fD76F13315206c21E2E3a21;
...
contract BITCOIN is Context, IERC20, Ownable {
    ...
    address private _MarketingWalletAddress = 0xBBfe78E390Df9DE6D92af2001A5E6FA645575bCA;
    ...
    string private _name = "BITCOINTEST";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xDfA1D82CAd63732A6fD76F13315206c21E2E3a21, 'We can not exclude Uniswap router.');
