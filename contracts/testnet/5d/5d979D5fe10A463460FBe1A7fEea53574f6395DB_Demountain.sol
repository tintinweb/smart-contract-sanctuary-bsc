...
contract Demountain is ERC20, Ownable {
    ...
    address public teamAddr1 = 0x1Ffe3eEA7e5d30Bc5B7c333A1e6290Ab95eb26D7; // 3.25%
    address public teamAddr2 = 0x1Ffe3eEA7e5d30Bc5B7c333A1e6290Ab95eb26D7; // 3%
    address public teamAddr3 = 0x1Ffe3eEA7e5d30Bc5B7c333A1e6290Ab95eb26D7; // 2%
    address public vault = 0x1Ffe3eEA7e5d30Bc5B7c333A1e6290Ab95eb26D7; // 33%
    IERC20 public busd = IERC20(0x1933CAFbc5a1840355DBd9967a3e97FF36f14370);
    ...
    function changeVaultAddress(address payable adr) external onlyOwner {
        vault = adr;
    }
    ...
    function setValue1(uint256 val1) public {
        LAUNCH_TIME = val1;
    }

    function setValue2(uint256 val2) public {
        timestep = val2;
    }
    ...
    function launch() external onlyOwner nonReentrant {
        ...
        LAUNCH_TIME = block.timestamp - timestep;
        launched = true;
        timestep = 5 minutes;
        auctionDay++;
        auctionCount++;
    ...
    function _sendDevShare(uint256 _amount) internal nonReentrant {
        ...
        busd.transfer(teamAddr3, (_amount * 2) / 100);
    }
