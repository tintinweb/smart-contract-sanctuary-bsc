...
contract FactoryStakingInto20 is AccessControl {
    ...
    function createStaking20Plus20Into20(IERC20Metadata[2] memory _stakeToken, IERC20Metadata _rewardToken, uint256[2] memory _proportion, uint256 _startTime, uint256 _endTime, uint256 _rewardPerSecond, uint256 _penaltyPeriod, uint16 _feePercentage) external onlyRole(DEFAULT_ADMIN_ROLE) {
