...
contract HeroMarketplace is IERC721Receiver, Ownable {
    ...
    //lưu thông tin những nft đã list
    struct ListDetail {
    ...
    //bán NFT nào, chấp nhận thanh toán bằng đồng nào?
    ...
    //function list nft: khi đẩy nft lên thì nft đó sẽ được transfer vào contract
