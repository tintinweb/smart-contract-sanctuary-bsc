...
contract AstronautICOBinance is
    Initializable,
    ...
    PausableUpgradeable
{
   uint256 public salePrice;
    ...
    function initialize(
        ...
        salePrice = 0.01 * (10**18); //0.0025 USD
        baseDecimals = (10**18);
    ...
    function changeSalePrice(uint newprice) external onlyOwner {
        salePrice = newprice;
    }
    ...
    {
        return ((_amount * 1 ether)/salePrice);
    }
        ...
        returns (bool)
    {
        ...
        uint256 allocatedamount = (usdAmount * 1 ether)/ salePrice;
        userDeposits[_msgSender()] += allocatedamount;  
        userInvested[_msgSender()] += (usdAmount);
        ...
        returns (bool)
    {
        ...
        uint256 ourAllowance = BUSDInterface.allowance(
            _msgSender(),
            address(this)
        );
        require(amount <= ourAllowance, "Make sure to add enough allowance");
    ...
    {   
        ...
        uint etherToUsd = ((amount * getLatestPrice()));
        uint256 allocatedamount = (etherToUsd)/ salePrice;
        userDeposits[_msgSender()] += allocatedamount;  
        userInvested[_msgSender()] += (amount);
        totalTokensSold += allocatedamount;
