...
// SPDX-License-Identifier: Unlicensed
    ...
    */
        //test
        address public  Wallet_Gldy=0xe4690E451CF3027aED3c1d5BD3D0eeCa88aEADEd; 
        address public  Wallet_Usdt=0x469C9A4Dc2EDAa633627d93aF307299e9C001aE8; 
        address public  Wallet_Qualify=0xf3Ac1cD5F066794132Ac9554AEd5F5a71D576d35; 
        address public  Wallet_Rand=0x8E5defc8c6903F439E492a5709704590AC2f7D9D; 
        address public Wallet_GboyPool=0x906E766c1686f18a9e067A8AD54acAD45c077d30;
        address public Wallet_FirstEcology=0x12358d1fC69689C286db5A42cF5c5B9F9D170B3a;
        address  public Wallet_Project = 0x36f2dAE586cC46fA9fbfe10DdadBbBbfFd178AD8;
        address  public Wallet_SharePoolWithdraw = 0x6AbDeb1FA303e45032545C070508BB01429143Bc;
        address  public  Wallet_Suby=0x4e8f4149Aa48F4eFf1435F18a74fF91b6e4a11d2;
       ...
       event OpenBlindBox(address indexed user,uint256 count,uint256[10] result);
        ...
        function bonus111(address useraddr,uint256 tokenAmount) private  {
        ...
        function openBlindBoxtest() public  view returns(uint256){
            (uint256 rand,)=tokenInterFace(Wallet_Rand).rand(msg.sender,randcount);
            return(rand);
       
        }

        function openBlindBoxtest2() public   returns(uint256){
            (uint256 rand,)=tokenInterFace(Wallet_Rand).rand(msg.sender,randcount);
