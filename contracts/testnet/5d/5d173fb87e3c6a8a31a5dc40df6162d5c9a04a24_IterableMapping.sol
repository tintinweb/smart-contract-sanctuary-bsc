...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1000 && newClaimWait <= 86400, "claimWait must be updated to between 1 and 24 hours");
...
contract MAI is ERC20, Ownable {
    ...
    constructor() payable ERC20("TestMai", "MAI") {

        rewardToken = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // WBNB
        ...
        treasuryWallet = 0x1A2e740d431e2b9e8EdD5646E15565D1CFFe6141; //DevSecondWallet DNT



        dividendTracker = new DividendTracker(20000, rewardToken); //MinBalance 0.0002% and rewardToken address getting created here
        ...
        _isWhitelisted[DEAD] = true;
        _isWhitelisted[address(this)] = true;
        _isWhitelisted[treasuryWallet] = true;

    
        _mint(owner(), 1000000000 * (10 ** 18)); //1 Billion
        swapTokensAtAmount = totalSupply() / 5000; //50000 = 0.0005
    }
