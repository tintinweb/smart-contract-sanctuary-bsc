...
contract StakePoolTokenForBNB is States, ReentrancyGuard, Ownable {
    ...
    function initialize( IBEP20 _stakingToken, uint256 _lockPeriod, uint _unlockDate) public onlyOwner {
...
contract FactoryStakingPool is Ownable{
    ...
    function createTokenForBNB(address ownerAddress, IBEP20 _stakingToken, uint256 _lockPeriod, uint _unlockDate ) public onlyOwner returns (address)
    {
        StakePoolTokenForBNB toDeploy = new StakePoolTokenForBNB();
        toDeploy.initialize( _stakingToken, _lockPeriod,_unlockDate);
