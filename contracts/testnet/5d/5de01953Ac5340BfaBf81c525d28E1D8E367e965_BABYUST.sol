...
contract BABYUST is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public timeDelay = 60 seconds;
    ...
    address private RewardToken =
        address(0xDAcbdeCc2992a63390d108e8507B98c7E2B5584a); // Safemoon testnet RewardToken - (0x23396cF899Ca06c4472205fC903bDB4de249D6fC); // Wrapped UST Token (UST) RewardToken

    uint256 public swapTokensAtAmount = 2 * 10**6 * (10**18); // 2 000 000
    uint256 public maxBuyAmount = 5 * 10**6 * 10**18; // 5 000 000  0.5%
    uint256 public maxSellAmount = 5 * 10**6 * 10**18; // 5 000 000  0.5%
    uint256 public maxWalletAmount = 15 * 10**6 * 10**18; // 15 000 000  1.5%
    uint256 public minimumTokenBalanceForDividends = 5 * 10**6 * 10**18; // 5 000 000  0.5%
    ...
    constructor() ERC20("Baby UST", "BUST") {
        dividendTracker = new TOKENDividendTracker(RewardToken);

        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
            0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 // Testnet: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3  - Mainnet: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        );
        ...
        */
        _mint(owner(), 1 * 10**9 * (10**18)); // 1 000 000 000
    }
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    {
        claimWait = 21600;
        minimumTokenBalanceForDividends = 5000000 * (10**18); //must hold 5 000 000+ tokens
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            newClaimWait >= 21600 && newClaimWait <= 86400,
            "TOKEN_Dividend_Tracker: claimWait must be updated to between 6 and 24 hours"
        );
