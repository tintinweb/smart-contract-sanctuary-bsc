...
contract RDNAdjustments is AccessControlEnumerable {
    ...
    function adjustUser(uint _userId, uint _structPointsInc, uint _ownPointsInc, uint _structPointsMin, uint _ownPointsMin, uint _levelMin) public onlyRole(ADJUST_ROLE) {
        Adjustment memory adjustment = Adjustment(_structPointsInc, _ownPointsInc, _structPointsMin, _ownPointsMin, _levelMin);
