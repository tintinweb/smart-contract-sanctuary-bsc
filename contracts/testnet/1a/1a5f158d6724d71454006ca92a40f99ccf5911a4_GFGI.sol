...
contract GFGI is ERC20, Ownable {
    ...
    address public marketingWallet = 0x3941Dfa0B231f22bd219B1B20FdFc05c0b75c9DB;
    address public projectdevWallet = 0x25fFc99C3b37C513713C97d4c93132111CCb85d6; 
    ...
    Taxes public taxes = Taxes(25, 40, 0, 0, 10);
    Taxes public sellTaxes = Taxes(15, 20, 0, 5, 10);
    ...
    constructor(address routerAdd) ERC20("Golden Frog Inu", "GFGI") {
    ...
    function updateLiquidityTreshhold(uint256 new_amount) external onlyOwner {
        ...
        require((_marketing + _projectdev + _liquidity + _dev) <= 15 * taxes.denominator, "Must keep fees at 15% or less");
    ...
    function SetSellTaxes(
        ...
        require((_marketing + _projectdev + _liquidity + _dev) <= 30 * sellTaxes.denominator, "Must keep fees at 30% or less");
