...
/**
 *Token nativo BabydogeSwapBNB/ Plataform nasceu com intuito de garantir a 
 privacidade de dados criptografados utilizando a blockchain a favor de segurança,
 O novo metodo de comunicaçao do futuro,totalmente descentralizado,  troca de chaves seguras entre usuários ,
 em troca de mensagens entre usuarios e recompensa em tokens e NFTs ,por garantir nossa rede segura e útil.
/ site ;https://www.Babydogeswapbnbethchakal.com/
/ grupo Social Telegram 
/ Twitter 
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            : IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // MAINNET ONLY
        _token = msg.sender;
    }
...
contract BabydogeSwapBNB is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address MKT  = 0x41F66fb3692A0B9D3F5c1c6A8d0Bc50c7CC3780c;

    string constant _name = "BabydogeSwapBNB/";
    string constant _symbol = "BabydogeSwapBNB/";
    ...
    constructor () Auth(msg.sender) {
        ...
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // MAINNET ONLY
