...
contract NFT is customERC721, Initializable{
    ...
    function initialize(string memory name , string memory symbol, address _operator) external initializer{
        _name = name;
        _symbol = symbol;
        operator = _operator;
    }
    ...
    function mint(address to, string memory _tokenURI) public returns (uint256) {
        ...
        _mint(to, newItemId);
        _creators[newItemId] = to;
        _setTokenURI(newItemId, _tokenURI);
        // Give the marketplace approval to transfer NFTs to users
...
abstract contract customERC721 is ERC721("FanverseNFT", "FNFT") {
