...
contract Trade {
    ...
    function setSFMToken(address _sfmv2) external onlyOwner {
        sfm = _sfmv2;
    }
        ...
        returns (uint256[] memory output)
    {
        ...
        ISafeswapRouter02 sr =
            ISafeswapRouter02(0x6b22BE9CA44eF99076Cbe0C0A92E4caB786bF65A);
    ...
    function bnbTransaction(address token, uint256 amount, address payable seller) internal {
        // Pancake Interface
        ISafeswapFactory sf =
            ISafeswapFactory(0x5A4cfB39cA25F33B459eC29Cb3f30aA80b59be6E);

        // check if (BNB/SFM) pair present in pancakeswap
        address pair =
            sf.getPair(sfm, 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889);
        ...
        internal
    {
        ...
        IERC20(token).approve(0x6b22BE9CA44eF99076Cbe0C0A92E4caB786bF65A, amt);
    ...
    function tokenTransaction(
        ...
        address pair1 =
            sf.getPair(token, 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889);
        require(
            pair1 != address(0),
        ...
        returns (uint256[] memory output)
    {
        ...
        pathbnb[0] = address(0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889);
        pathbnb[1] = sfm;
