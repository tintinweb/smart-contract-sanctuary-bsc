...
contract GladiatorDexCrate is ERC721, Pausable, Ownable, ERC721Enumerable, ERC721Burnable, ReentrancyGuard {
    ...
    event PackageMinted(address to, uint256 token_id, uint256 upline_id, uint256 package_id, bool paid);
    ...
    constructor() ERC721("GladiatorDex Free Crate", "GDEXFREECRATE") {
    ...
    function mintPackage(address to, uint256 upline_id, uint256 package_id, bool paid) external onlyOperators returns(uint256) {
        _tokenIdCounter.increment();
        uint256 tokenId = _tokenIdCounter.current();
        _safeMint(to, tokenId);
        packageInfo[tokenId] = PackageInfo(tokenId, upline_id, package_id);
        emit PackageMinted(to, tokenId, upline_id, package_id, paid);
        return tokenId;
    }
