...
contract stake is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        stakingToken = IBEP20(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d);
        rewardToken = IBEP20(0xAf379Eb6d72E6046B746bCdC83a3f9FEAc86eA16);

        apy = 360;      //set apy
        lockDuration = 7 days; //Set lock duration
        exitPenaltyPerc = 0;  //set early withdraw penalty fee
    ...
    function updateExitPenalty(uint256 newPenaltyPerc) external onlyOwner {
        require(newPenaltyPerc <= 2, "May not set higher than 2%");
