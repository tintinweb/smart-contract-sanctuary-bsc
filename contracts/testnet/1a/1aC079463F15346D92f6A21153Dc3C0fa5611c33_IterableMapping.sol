...
contract DxNativeDividendToken is ERC20, Ownable {
    ...
    constructor(address _rewardToken, string memory name_, string memory symbol_, uint8 decimals_, uint256 _totalSupply, uint8 _tokenRewardsFee, uint8 _liquidityFee, uint256 _mktAndTeamFee, address _router, address _basePair) ERC20(name_, symbol_) {
        tokenRewardsFee = _tokenRewardsFee;
        liquidityFee = _liquidityFee;
        mktAndTeamFee = _mktAndTeamFee;
        ...
        // _mint(mktAndTeamWallet, _totalSupply);
