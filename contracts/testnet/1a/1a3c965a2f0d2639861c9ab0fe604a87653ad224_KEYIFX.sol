...
contract KEYIFX  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private constant ETH = address(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); //DOGE

    uint256 public swapTokensAtAmount = 100 * 10**6 * (10**9);
    uint256 public maxTxAmount;

    address payable public marketingWallet = payable(address(0x134166d55D4536d48daDfE20e6deaf47EfeDf5c4)); //marketing wallet
    ...
    constructor() ERC20("keyif X", "keyif") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("KEYIFX_Dividend_Tracker", "KEYIFX_Dividend_Tracker")
    {
        claimWait = 3600;
