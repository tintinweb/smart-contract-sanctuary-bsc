...
contract PaymentGatewayV2 is Owner {
  ...
  event PayEvent(uint256 amount, string sessionId);
  event SendEvent(uint256 amount, string sessionId);
  ...
  function pay(
    ...
    emit PayEvent(amount, sessionId);
  }
  ...
  function payWithPermit(
    ...
    // Process pay
    pay(amount, merchantAddress, sessionId);
  }
  ...
  function send(
    ...
    emit SendEvent(amount, sessionId);
  }
  ...
  function sendWithPermit(
    ...
    // Process send
    send(amount, recipient, sessionId);
  }
  ...
  function batchSend(
    ...
    emit BatchSendEvent(amounts, recipients, sessionId);
  }
