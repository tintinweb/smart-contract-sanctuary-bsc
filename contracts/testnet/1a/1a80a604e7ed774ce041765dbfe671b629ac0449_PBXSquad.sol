...
/**
 * @title PBX Squad
 * @notice PBXSwap NFT collection
 */
contract PBXSquad is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        require((_maxSupply == 100) || (_maxSupply == 1000) || (_maxSupply == 100000), "Operations: Wrong max supply");
