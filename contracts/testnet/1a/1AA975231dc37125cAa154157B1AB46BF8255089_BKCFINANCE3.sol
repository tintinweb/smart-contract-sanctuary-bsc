...
contract BKCFINANCE3 is OwnableUpgradeable {
        ...
        )
    {
        ...
        if (releasePoolInfo[msg.sender][_slot].amount != 0) {
            amounts[2] = releasePoolInfo[msg.sender][_slot].amount;
            times[2] = releasePoolInfo[msg.sender][_slot].day;
            amounts[4] = releasePoolInfo[msg.sender][_slot].claimedAmount;
        } else {
            amounts[2] = userInfo[msg.sender][_slot].stakeAmount;
        ...
        times[0] =
            userInfo[msg.sender][_slot].stakeTime +
            userInfo[msg.sender][_slot].lockTime;

        if (userInfo[msg.sender][_slot].stakeTime != 0) {
