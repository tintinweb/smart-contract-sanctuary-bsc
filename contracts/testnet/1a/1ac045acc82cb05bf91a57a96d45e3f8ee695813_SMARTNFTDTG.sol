...
// DECENTRALIZE TOKEN GAME Renewable NFT staking Contract
...
contract SmartNFTPoolRenewable is IERC721Receiver ,Ownable, ReentrancyGuard {
   ...
   // Subscription
    ...
    function RenewOrExtendSubscriptionSixWeeks() external payable onlySub {
        address treasury = SMARTNFTDTG(SMART_CHEF_FACTORY).treasury();
    ...
    */
    ...
    function stake(uint256[] memory tokenIds) public {
        ...
        address vault = SMARTNFTDTG(SMART_CHEF_FACTORY).vault();
...
contract SMARTNFTDTG is Ownable {
    ...
    function createNFTPool(IDTGNFT nftContract, IBEP20 partnerToken,address PayToken , uint256 payTokenAmount) external onlyOwner {
            SmartNFTPoolRenewable pool = new SmartNFTPoolRenewable();
            _SmartPools.push(pool);
