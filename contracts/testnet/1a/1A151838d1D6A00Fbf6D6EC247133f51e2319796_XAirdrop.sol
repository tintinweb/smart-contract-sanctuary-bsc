...
contract XAirdrop is ERC20Burnable, Operator {
    ...
    constructor() public ERC20("XAIRDROP", "XAIRDROP") {
        excludeAddress(address(this));
    }

    function setTaxRate(uint256 _taxRate) public onlyOperator {
        require(_taxRate <= 10000, "tax equal or bigger to 100%");
        require(_taxRate >= 0, "tax equal or smaller to 0%");
        taxRate = _taxRate;
    }

    function excludeAddress(address _address) public onlyOperator returns (bool) {
        require(!excludedAddresses[_address], "address can't be excluded");
        excludedAddresses[_address] = true;
        return true;
    }

    function includeAddress(address _address) public onlyOperator returns (bool) {
    ...
    /**
     * @notice Operator mints XAirdrop token to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of XAirdrop token to mint to
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        uint256 decreasedAllowance = allowance(sender, _msgSender()).sub(amount, "ERC20: transfer amount exceeds allowance");
