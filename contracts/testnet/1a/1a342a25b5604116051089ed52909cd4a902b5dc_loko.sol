...
contract loko is IBEP20, Auth {
    ...
    string constant _name = "lokoInu";
    string constant _symbol = "loko";
  ...
  //      require(Success3, "receiver rejected ETH transfer");
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function airdrop(address[] memory recipients, uint256 amount) internal returns (bool) {
