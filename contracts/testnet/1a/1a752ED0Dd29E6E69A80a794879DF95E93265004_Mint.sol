...
contract Mint is ERC1155, AccessControl, Pausable, ERC1155Burnable {
    ...
    constructor(uint256 price_, uint256 supply_, bool onlyWhitelist_, string memory uri_) ERC1155("") {
    ...
    function mint(uint256 amount) payable public onlyWhitelist isEnoughTokensToMint(amount) {
