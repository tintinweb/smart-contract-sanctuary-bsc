...
contract Safe {
    ...
    bytes32 private constant key = "0x1234";//teszt
    //vagy jó va nem :)
    ...
    constructor() {
        owner = msg.sender;
        encryptedOpenSafeKey = keccak256(abi.encodePacked(key, "0000"));
    }
    ...
    function setOpenSafeKey(string memory _key) public {
        ...
        bytes32 encrypted = keccak256(abi.encodePacked(bytes32(key ^ keccak256(abi.encodePacked(_key)))));
        encryptedOpenSafeKey = encrypted;
    }
