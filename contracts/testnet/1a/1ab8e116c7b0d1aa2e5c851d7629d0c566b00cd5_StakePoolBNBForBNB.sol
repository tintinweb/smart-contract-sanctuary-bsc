...
contract StakePoolBNBForBNB is Ownable {
    using SafeMath for uint256;
...
contract FactoryStakingPool{
    ...
    function createBNBForBNB(address ownerAddress, uint256 _lockPeriod, uint256 _maxReward, bool _withUpdate, uint256 _rewardPerBlock) public returns (address)
    {
        StakePoolBNBForBNB toDeploy = new StakePoolBNBForBNB(ownerAddress, _rewardPerBlock, block.number, _lockPeriod);
