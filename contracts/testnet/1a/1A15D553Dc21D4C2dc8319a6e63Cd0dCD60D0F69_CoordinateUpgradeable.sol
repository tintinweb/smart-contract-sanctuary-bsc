...
contract CoordinateUpgradeable is Initializable, ICoordinate, OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
	...
	/// @inheritdoc	ICoordinate
	function updateItem(uint256 _tokenId, uint256 _price) external override whenNotPaused {
	...
	/// @inheritdoc ICoordinate
	function removeItem(uint256 _tokenId) external override whenNotPaused {
		uint256 index = _allTokensIndex[_tokenId];
		require(index > 0, "Coordinate Marketplace: non exist marketplace item");
