    ...
    UUPSUpgradeable
{
    ...
    function _addReferrer(
        ...
        referrerAccount.payGlobalReward = true;
    ...
    function _payReward(uint256 _value, address _user) private {
        ...
        if (hasReferrer(_user) && !userReferrerAccount.payGlobalReward) {
            ...
            userReferrerAccount.payGlobalReward = true;
        ...
        if (hasReferrer(_user) && userReferrerAccount.payGlobalReward) {
            ...
            userReferrerAccount.payGlobalReward = false;
