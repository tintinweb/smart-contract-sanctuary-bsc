...
contract NovaLandToken is Initializable, ERC20Upgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable {
    
    constructor () initializer {
        __ERC20_init("NOVALAND", "NOVA");
        __Ownable_init();
    ...
    {
        lockTime[to] = block.timestamp + 30 seconds;
    ...
    function _transfer(
        ...
        assert(block.timestamp >= lockTime[sender]);
