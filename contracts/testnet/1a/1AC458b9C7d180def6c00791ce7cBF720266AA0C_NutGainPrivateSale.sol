...
contract NutGainPrivateSale {
    ...
    function PrivateSale(address _tokenAddress, uint256 _start, uint256 _end, uint256 _value) external onlyOwner {
    ...
    function ethPrivateSaleValue(address[] memory _to, uint256 _value) external payable onlyOwner {
    ...
    function PrivateSaleValue(address _tokenAddress, address[] memory _to, uint256 _value) external onlyOwner {
    ...
    function PrivateSaleValueContract(address _tokenAddress, address[] memory _to, uint256 _value) external onlyOwner {
    ...
    function sendPrivateSaleDifferentValue(address _tokenAddress, address[] memory _to, uint256[] memory _value) external onlyOwner {
