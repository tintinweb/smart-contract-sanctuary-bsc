...
contract PUBG2 is Context, IERC20, Ownable {
    ...
    uint256 private _taxFeeOnTrx = 3;    
    uint256 private _taxFee;
    uint256 private _minSwap = 1 * 10**5 * 10**9;
    uint256 private _maxTrx = 1 * 10**6 * 10**9;
    
    string private constant _name = "PUBG2";
    string private constant _symbol = "PUBG2";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(amount <= _maxTrx, "Amount exceeds the limit");
    ...
    function setFee(uint256 taxFeeOnTrx) public onlyOwner {
        _taxFeeOnTrx = taxFeeOnTrx;
    }
    ...
    event SetMaxTrx(uint256 _bAmount, uint256 _aAmount);
    function setMaxTrx(uint256 _amount) public onlyOwner {
        emit SetMaxTrx(_maxTrx, _amount);
        _maxTrx = _amount;
    }
