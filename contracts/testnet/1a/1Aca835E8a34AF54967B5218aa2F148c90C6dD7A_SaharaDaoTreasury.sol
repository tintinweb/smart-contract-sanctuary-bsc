/**
 *Submitted for verification at cronoscan.com on 2022-04-26
*/
...
// File contracts/treasury/SaharaDaoTreasury.sol

pragma solidity 0.8.4;

/*  SaharaDaoTreasury.sol ============================================
    The contract is to store the reserve of SaharaDao Protocol
...
==================================================================== */
contract SaharaDaoTreasury is Ownable {
    using SafeERC20 for IERC20;
    using Address for address;

    mapping(address => bool) public strategies;
    address[] public strategiesArray;
    ISaharaDaoStaking public staking;

    constructor(ISaharaDaoStaking _staking) {
        staking = _staking;
    }

    // ========== PUBLIC VIEW FUNCTIONS ============

    /// @notice Return ERC-20 balance of SaharaDaoTreasury
    /// @param _token Address of the ERC-20 token
    /// @return Balance of the SaharaDaoTreasury
    ...
    function requestFund(address _token, uint256 _amount) external {
        require(strategies[msg.sender], "SaharaDaoTreasury::requestFund: Only strategies can request fund");
        require(_amount <= balanceOf(_token), "SaharaDaoTreasury::requestFund: Request more fund than balance");
    ...
    function addStrategy(address _strategy) external onlyOwner {
        require(_strategy != address(0), "SaharaDaoTreasury::addStrategy: invalid address");
        require(!strategies[_strategy], "SaharaDaoTreasury::addStrategy: strategy was previously added");
    ...
    function removeStrategy(address _strategy) external onlyOwner {
        require(strategies[_strategy], "SaharaDaoTreasury::removeStrategy: strategy not found");
    ...
    function allocateFee(address _token, uint256 _amount) external onlyOwner {
        require(address(staking) != address(0), "SaharaDaoTreasury::allocateFee:Fee distributor not set");
        require(_amount > 0, "SaharaDaoTreasury::allocateFee: invalid amount");
