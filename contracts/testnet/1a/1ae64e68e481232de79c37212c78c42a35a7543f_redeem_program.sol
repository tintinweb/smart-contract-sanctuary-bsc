...
contract redeem_program is Ownable, ReentrancyGuard {
     ...
     */
    function addToken(IERC20 _token_address, string memory _token_name) external onlyAdmin{
        ...
        emit AddNewToken(token_count, _token_address, _token_name);
    ...
    function addProduct(
        ...
        AddToken memory add_token = token_info[_product_token];
        bool status = true;
        ...
        productAdd.token_name = add_token.token_name;
        productAdd.token_address = add_token.token_address;
