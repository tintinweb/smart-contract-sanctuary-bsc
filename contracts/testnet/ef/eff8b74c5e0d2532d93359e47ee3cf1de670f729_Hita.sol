...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //busd router
...
contract Hita is IBEP20, Auth {
    ...
    address MAR  = 0xC502d0Ae13d746d6712Ae4B8C502a04E09f29abb;

    string constant _name = "Hita";
    string constant _symbol = "HT";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = address(MAR);
