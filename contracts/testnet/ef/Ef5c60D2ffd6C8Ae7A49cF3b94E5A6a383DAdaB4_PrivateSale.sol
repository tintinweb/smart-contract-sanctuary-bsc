...
contract PrivateSale is Ownable, Pausable {
    ...
    IERC20 public token = IERC20(0x2920C4381a773152acb2Ca06336204922455276c);
    IERC20 public paymentToken = IERC20(0x1f408ff21B14685Bb0521092a38664aBF82Dc690);

    address public receiver;
    address public otherInvestmentContract;
    address public userContract = 0x7cE853626211E56b3d07fcc2E1c8e600E5E80da2;

    uint256 public constant ROUND = 3;
    uint256 public totalSupply = 20000000000000000000000000;
    uint256 public totalSell = 0;
    uint256 public tokenPriceRate = 17000000000000000; // 0.017
    uint256 public minBuy = 10000000000000000000; // $10
    uint256 public openSale = 1675728000; // 2022-02-07 00:00:00
    uint256 public endSale = 1676419199; // 2022-02-14 23:59:59
