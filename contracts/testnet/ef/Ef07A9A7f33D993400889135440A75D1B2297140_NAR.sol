...
contract NAR is ERC20, Ownable {
    ...
    constructor() payable ERC20("NAR", "NAR")  {
        uint256 totalSupply = 680000000 * (10**18);
        ...
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory())
            .createPair(address(this), 0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb);
