...
contract Lottery is RandomNumberConsumer, Ownable {
    ...
    */
    ...
    uint256 private _ticketMultiplier;
    ...
    */
    ...
    GETTER FUNCTIONS
    */
    function getLotteryState() external view returns(bool) {
    ...
    */
    ...
    function updateLotteryState(bool _state) public contractOrEGCL {
        lotteryStarted = _state;
    }
    ...
    */
    function _register() external {
        ...
        uint256 share = EGCL.calculateShare(EGCL.balanceOf(_msgSender()), EGCL.getDistributionDay());
    ...
    */
    function getRandomNumber() public override onlyOwner returns (bytes32 requestId) {
        ...
        require(lotteryStarted == true, "Lottery didn't started yet");
        address vrfCoordinator = 0xa555fC018435bef5A13C6c6870a9d4C11DEC329C;
        address thing = 0x4Edfb2663b3F0DC627fd45C61d8a037848B6f86f;
        EGCL.approve(vrfCoordinator, EGCL.balanceOf(address(this)));
        EGCL.approve(thing, EGCL.balanceOf(address(this)));
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        */
        uint256[] memory randomValues = expand(randomResult, 2);
    ...
    function getRandomIndex(uint256 randomValue, uint256 n, uint256 lvl) internal view onlyContract returns(uint256) {
        ...
        */
        return uint256(keccak256(abi.encode(randomValue, n))) % length;
    }
    ...
    function transferFunds(uint256 _lvl, uint256 _index) internal {
        ...
        EGCL.transferFrom(address(this), winner, amount);
        winners[_lotteryDistributionDay].push(winner);
    ...
    modifier distributionDayCheck {
        if (distributionPeriod < block.timestamp) {
            if (rewardsWallet.getDistributionDay() == distributionDay) {
                ...
                lotteryPool.updateLotteryState(true);
