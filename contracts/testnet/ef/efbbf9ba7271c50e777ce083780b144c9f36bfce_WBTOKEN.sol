...
contract WBTOKEN is Context, IBEP20, Ownable {
    ...
    uint256 public marketingwalletFeeOnBuying = 60; // 2% will go to the marketingwallet address
    ...
    uint256 public marketingwalletFeeOnSelling = 60; // 1% will go to the market address
    ...
    uint256 public marketingwalletFee = 60; // 2% will go to the market address
    ...
    uint256 private _currentmarketingwalletFee = 60;
    ...
    function totalFeePerTx(uint256 tAmount) internal view returns(uint256) {
        uint256 percentage = tAmount*((_currentLiquidityFee)+(_currentmarketingwalletFee)+(_currentautoburnFee))/(1e3);
        return percentage;
    }
    ...
    function setautoburnFee(uint256 _autoburnFee) external onlyOwner() {
        require(liquidityFee+marketingwalletFee+_autoburnFee <= maxFee, "MaxFee: cannot be more than 10");
    ...
    function setMarketFee(uint256 _marketFee) external onlyOwner() {
        require(liquidityFee+_marketFee+autoburnFee <= maxFee, "MaxFee: cannot be more than 10");
    ...
    function setLiquidityFee(uint256 _liquidityFee) external onlyOwner() {
        require(_liquidityFee+marketingwalletFee+autoburnFee <= maxFee, "MaxFee: cannot be more than 10");
