...
https://t.me/TrueGoldTokengroup

https://truegoldtokens.com/
...
contract TrueGoldToken is ERC20, Ownable { 
    ...
    event UpdateFees(uint256 sellMarketingFees, uint256 buyMarketingFees,
                     uint256 buyDevFee, uint256 sellDevFee, uint256 buyBurnFee, uint256 sellBurnFee);
    ...
    constructor() ERC20("True Gold Token", "TGT") { 
        marketingWallet = payable(0x720956bc86d390587C2b303Ed0B40946Cb9D1101); 
        devWallet = payable(0x720956bc86d390587C2b303Ed0B40946Cb9D1101); 
        address router = block.chainid == 57 ? 
    ...
    function setmaxWallet(uint256 value) external onlyOwner {
        value = value * (10**18);
        require(value >= totalSupply() / 200, "max wallet cannot be set to less than .5%");
        maxWallet = value;
    }
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 devBuy, uint256 devSell,
                        uint256 burnSell, uint256 burnBuy) public onlyOwner {
        ...
        require(burnBuy <= 4 && burnSell <= 4, "Burn Fees cannot exceed 4%");

        emit UpdateFees(sellMarketingFees, sellDevFee, sellBurnFee, buyMarketingFees, buyDevFee, buyBurnFee);
    }
    ...
    function sharesCount() external view returns (uint) {
