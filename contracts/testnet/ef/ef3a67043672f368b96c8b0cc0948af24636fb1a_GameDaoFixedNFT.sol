...
contract GameDaoFixedNFT is Configurable, IERC721ReceiverUpgradeable {
    ...
    function initialize(address _governor, address _feeAccount)
        public
        initializer
    {
        require(
    ...
    function triggerDisableErc721() external governance {
        if (config[DisableErc721] != 0) {
            config[DisableErc721] = 0;
        } else {
            config[DisableErc721] = 1;
        }
    }
