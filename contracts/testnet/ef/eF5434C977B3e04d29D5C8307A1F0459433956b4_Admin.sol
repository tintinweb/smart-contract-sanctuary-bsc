 ...
 */
    ...
    function setBuyBackActivation(bool _value) external {
        require(hasRole(DEFAULT_ADMIN_ROLE, msg.sender) || msg.sender == USDy || msg.sender == YSL ||
                msg.sender == bYSL || msg.sender == xYSL || msg.sender == xBUSD ||
                msg.sender == BShare || msg.sender == swapPage,"Do not have role");
