...
contract IslandGirlAirdrop is VRFConsumerBaseV2, Ownable ,KeeperCompatibleInterface  {
  ...
  */
  ...
  uint public intervalTokenAmount = 1000;
  ...
  function setIntervalTokenAmount(uint tokenAmount) external{
    intervalTokenAmount = tokenAmount;
  }
  function getIntervalTokenAmount() public view returns (uint) {
    return intervalTokenAmount;
  }
}