...
contract YHIDO is OwnableUpgradeable {
  ...
  function isAvailToIDO300() public view returns(bool) {
    return investors[msg.sender].level == 3;
  }
  ...
  function claimYh() public {
    ...
    yhToken.transferFrom(owner(), msg.sender, investors[msg.sender].claimAmount);
