...
Telegram : https://t.me/NetflixPortal
...
contract dracula is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5393a6725516d5471716e0Fd43BF2C0DcbAB5756);
    address payable public Wallet_Dev = payable(0x5393a6725516d5471716e0Fd43BF2C0DcbAB5756);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**12 * 10**_decimals;
    uint256 private _rtotal;
    string private constant _name = "Dracula grow inu1"; 
    string private constant _symbol = unicode"DRAGINU1";
    ...
    constructor () {
        _owner = 0x5393a6725516d5471716e0Fd43BF2C0DcbAB5756;
