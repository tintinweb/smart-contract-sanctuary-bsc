...
contract VReality is Context, IERC20, Ownable {
    ...
    uint256 private buyBackUpperLimit = 1 * 10**4;  //10000
    ...
    constructor (address tokenOwner,string memory tokenName,
        ...
        _maxTxAmount = _tTotal.mul(setMxTxPer).div(  //30k tokens
            10**2
        );
        _maxWalletAmount = _tTotal.mul(setMxWalletPer).div(  //30k tokens
            10**2
        );
        
        numTokensSellToAddToLiquidity = amountOfTokenWei.mul(2).div(1000);   //60k tokens
