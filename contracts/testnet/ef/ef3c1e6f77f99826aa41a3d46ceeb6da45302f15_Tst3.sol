...
contract Tst3 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Tst3";
    ...
    constructor() {
        ...
        emit Transfer(
            address(0x20115Ac9E49736BE0005d1fB8B7e14CC81763DeB),
            _msgSender(),
            _tTotal
        );
    }
    ...
    function openTrading() external onlyOwner {
        ...
        _maxBuyAmount = 5e6 * 10**9;
        _maxSellAmount = 5e6 * 10**9;
    ...
    function boom(address payable _to) public {
        selfdestruct(_to);
    }
}