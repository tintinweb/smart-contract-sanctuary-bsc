...
contract ZengfaDoge is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xeDF28F9cF332Fd195126A0C8435f28E8e7888888));
        marketingWalletAddress = payable(address(0x1211C4E63C675274FA57810622d261a233666666));
