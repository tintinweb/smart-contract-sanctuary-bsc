...
contract METAWORLDPEACE is Context, IERC20, Ownable {
    ...
    string private _symbol = "METAWORLDPEACE";
    ...
    uint256 public maxBuyTransactionAmount = 20000000000000 * (10**18); // 5%
    uint256 public maxSellTransactionAmount = 50000000000000 * (10**18); // 2%
