...
contract BatchFetcher {
    ...
    function fetchUserInfo(address _userAddress) external returns (uint256 lockEndTime, uint256 lockedAmount, bool isActive) {
...
interface IPancakeProfile {
     ...
     */
    function getUserStatus(address _userAddress) external returns (bool);
