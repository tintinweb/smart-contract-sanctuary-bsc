...
contract ESCRAVANINHA3 is ERC721URIStorage, Ownable, RoyaltiesV2Impl  {
    ...
    constructor() ERC721("ESCRAVANINHA3", "ES3") {
      account = payable(msg.sender);
    }

    /* Updates the listing price of the contract */
    function updateListingPrice(uint _listingPrice) public payable {
      require(account == msg.sender, "Only ECB owner can update listing price.");
    ...
    function createMarketSale(
      ...
      payable(account).transfer(listingPrice);
