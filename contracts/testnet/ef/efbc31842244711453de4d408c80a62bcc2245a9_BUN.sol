...
contract BUN is IBEP20, Auth {
    ...
    string constant _name = "BUN";
    string constant _symbol = "BUN";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {        
        ...
        if(walletTransferEnabled){
            require(walletTransferBanned[sender] == false, "You are banned, please contact support.");
        }
