...
contract cyPokerClub is Initializable, ERC721Upgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function safeMint(address userAddr) public onlyOwner {
    ...
    function safeTransferFrom(address from, address to, uint256 id)  public onlyOwner override {
        require(leash == true, "need to unleash");
    ...
    // function unleash(uint256 tokenId ) public onlyOwner{
    //     _requireMinted(tokenId);
    //     leashed[tokenId] = true;
    // } 

     function unleash() public onlyOwner{
        require(leash == false, "already unleash");
        leash = true;
    } 
