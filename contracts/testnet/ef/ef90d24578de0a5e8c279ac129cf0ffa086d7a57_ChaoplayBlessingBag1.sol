...
contract ChaoplayBlessingBag1 is Context, IERC20, IERC20Metadata, AccessControl {
    ...
    constructor (address _cbb) {
        ...
        liquidityAddress = address(0x8C5728a98F16d04B88A18f574fAD74f566f423eD);

        USDT_ADDRESS = address(0x9f37055A4BA925E0678E7447e2164CD833bf3F18);
        CBB = _cbb;
        totalSwapFee = 0;
        totalRewardFee = 0;
        totalNftFee = 0;
        ...
        // uniswapV2Router = IUniswapV2Router02("0xB6BA90af76D139AB3170c7df0139636dB6120F7e");
        uniswapV2Pair = IUniswapV2Pair(IUniswapV2Factory(_uniswapV2Router.factory()).createPair(
                address(this),
                USDT_ADDRESS
            ));
    }
    ...
    function CBBBuyTicket(address blessingBag, uint num) public {
        ...
        require(IERC20(CBB).allowance(blessingBag, address(this)) >= num*15 ,"USDT allowance no enough");
