...
contract WinningEleven2022 is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 1000_000_000 * 10**9; // 
    uint256 private constant SWAP_TOKENS_AT_AMOUNT = 5 * 10**9; //
    string private constant _name = "WINNING ELEVEN 2022"; // 
    string private constant _symbol = "WINEL"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 8;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x3340990b6BE83a0d7F1Dc1aCcF917D4aB4324082;
