...
contract SoccerStar is ERC721A, Ownable, Initializable {
    ...
    * @dev setPaused makes the contract paused or unpaused
    ...
    function PubMint(BlindBoxesType _blindBoxes, uint256 quantity) external payable {
