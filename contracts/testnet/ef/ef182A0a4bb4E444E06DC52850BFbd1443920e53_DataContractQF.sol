...
contract DataContractQF is AccessControl {
    ...
    // Initialize
    function initialize(address _sender, address _sender1) public {
        require(!initialized, "Already Initialized");
        _setupRole(DEFAULT_ADMIN_ROLE, _sender);
        _setupRole(ADMIN_ROLE, _sender);
        _setupRole(ACCESS_ROLE, _sender);

        _setupRole(DEFAULT_ADMIN_ROLE, _sender1);
        _setupRole(ADMIN_ROLE, _sender1);
        _setupRole(ACCESS_ROLE, _sender1);
        initialized = true;
    }
