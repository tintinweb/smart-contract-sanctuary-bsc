...
contract SlotMachine is IERC20{
    ...
    function Recive(uint256 amount) private returns(bool){
        ...
        {
           uint256 rewards_tx =  lockssm.mul(txfee).div(100);
    ...
    {       
        ...
        uint256 allowaceeth = address(this).balance.sub(lockssm,"Insufficient Balance").mul(tokendecimals).div(bnbdecimals);
