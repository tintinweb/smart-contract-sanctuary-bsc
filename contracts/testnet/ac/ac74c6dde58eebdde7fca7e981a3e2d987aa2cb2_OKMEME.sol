...
contract OKMEME is Context, IBEP20, Ownable {
    ...
    string private _name = "OKMEME";
    string private _symbol = "OKMEME";
    ...
    uint256 public numTokensSellToAddToLiquidity = 500 * 10**_decimals;
    ...
    address private _usdt = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;
