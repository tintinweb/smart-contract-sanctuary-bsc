...
contract GemFlowsCapital  is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("GemFlowsCapital", "GFC2") {
...
//        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);   //BSC Testnet
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "TOKEN: gasForProcessing must be between 200,000 and 900,000"
        );
        require(
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("GemFlows_Dividend_Tracker", "GemFlows_Dividend_Tracker")
    {
        claimWait = 3600;
