...
contract DubaiDoge is Context, IERC20, Ownable {
    ...
    address public _marketingWallet =
        0x70F5fD58120AC0956eF9B1782498A09350D4F070;
    address public _devWallet = 0x568D569fEA1F517096eC2ad131d453ae3d487263;
    address public buyBackWallet = 0x2550bcA4990892B694f4A9B5432110F0af433CCb;
    ...
    function swapAndSendBnb(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 bnbForBuyBack = swappedBnb.mul(buyBackSwap).div(totalSwap);
        uint256 bnbForMarketing = swappedBnb.mul(marketingSwap).div(totalSwap);
        uint256 bnbForDev = swappedBnb.sub(bnbForBuyBack).sub(bnbForMarketing);
        ...
        if (bnbForBuyBack > 0) payable(buyBackWallet).transfer(bnbForBuyBack);
    }
