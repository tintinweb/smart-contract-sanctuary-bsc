...
contract BDTToken is ERC20, Ownable, BaseToken {
    ...
    address public router_address = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address public rewardWallet = 0x27A2b2CE8aa4c169a58a788Bd66cA479c43242D5;
    address public marketingWallet = 0x051134441B2c581A5e63301BC13d65A17ca72f78;
    ...
    constructor() payable ERC20("Brew Your Day", "BRW") {
        buyFee = 0;
        sellFee = 4;
        ...
        rewardWallet = 0x27A2b2CE8aa4c169a58a788Bd66cA479c43242D5;
        marketingWallet = 0x051134441B2c581A5e63301BC13d65A17ca72f78;
        ...
        // swapTokensAtAmount = totalSupply * (10 ** 18) / 5000;
    ...
    function _transfer(
        ...
        if (
            ...
            if (rewardShare > 0) {
                uint256 rewardTokens = (contractTokenBalance * rewardShare) /
                    100;
                super._transfer(address(this), rewardWallet, rewardTokens);
            }
            if (burnShare > 0) {
                uint256 burnTokens = (contractTokenBalance * rewardShare) /
                    100;
