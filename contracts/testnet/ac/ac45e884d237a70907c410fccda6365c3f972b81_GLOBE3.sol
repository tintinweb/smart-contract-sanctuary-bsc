...
contract GLOBE3  {
    ...
    uint256 private constant feePercents = 2500; 
    uint256 private constant minDeposit = 20e18;
    ...
    function withdraw() external {
        ...
        if(msg.sender == defaultRefer) {
            busd.transfer(feeReceivers[0], withdrawable.div(2));
            busd.transfer(defaultRefer, withdrawable.div(2)); 
        } else {
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 1000e18){
            ...
            if(total >= 2000e18 && user.teamNum >= 200 && maxTeam >= 50000e18 && otherTeam >= 50000e18){
                levelNow = 5;
            }else if(user.teamNum >= 50 && maxTeam >= 5000e18 && otherTeam >= 5000e18){
                levelNow = 4;
            }else{
                levelNow = 3;
            }
