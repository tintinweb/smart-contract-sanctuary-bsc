...
contract SpinelGovernorV3 is  SpinelGovernorV2 {
    function test(address) public pure returns (uint256){
        return 1;
    }
}
    ...
    GovernorTimelockCompoundUpgradeable, OwnableUpgradeable
{
    ...
    function _cancel(
        ...
        bytes[] memory calldatas,
        bytes32 descriptionHash
    ) internal override(GovernorUpgradeable, GovernorTimelockCompoundUpgradeable) onlyOwner returns (uint256) {
