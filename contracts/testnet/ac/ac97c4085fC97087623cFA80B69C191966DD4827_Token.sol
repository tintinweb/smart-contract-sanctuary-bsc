...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 500000000*1e18; // 50cr
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "METAEYE";
    string private _symbol = "METE";
    ...
    address payable public treasuryWallet = 0x5cef1C669786492Ea67b6C986eE21Be469dCB4Ba; 
    ...
    function _takeTreasuryFee(uint256 tAmount) private {
        uint256 tTreasuryFee = tAmount.mul(_treasuryFee).div(100);
		uint256 rTreasuryFee = tTreasuryFee.mul(_getRate());
		
			_tTotal = _tTotal.sub(tTreasuryFee);
		_rTotal = _rTotal.sub(rTreasuryFee);
    ...
    }// 200000000360000002286  200000000480000003289
    // 0xC305A9a8C2Fa93e8370aa8312f4b0648E579fDe3

    // 9999899816829600311791154987 -  9999899809829540228603890638  9999899802829480143616566194  9999899795829420056829181654
