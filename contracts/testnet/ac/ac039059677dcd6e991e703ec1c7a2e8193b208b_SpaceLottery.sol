...
contract SpaceLottery {
    ...
    uint256 public MIN_BUY = 2 * 1e9; /** 2 SPACE **/
    uint256 public MAX_BUY = 200 * 1e9; /** 200 SPACE **/

    /* lottery */
	bool public LOTTERY_ACTIVATED;
    uint256 public LOTTERY_START_TIME;
    uint256 public LOTTERY_PERCENT = 900;
    uint256 public LOTTERY_STEP = 2 * 60 * 60; /** every 4 hours. **/
    uint256 public LOTTERY_TICKET_PRICE = 2 * 1e9; /** 2 SPACE **/
