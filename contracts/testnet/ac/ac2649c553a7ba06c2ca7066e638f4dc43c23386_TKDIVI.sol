...
contract TKDIVI is ERC20, Ownable {
    ...
    // added
    uint256 public sellLimitTime = 60;
    ...
    uint256 public _transferTimeLimit = 120;
    uint256 public _transferAmountLimit = 100 * (10**18);
    uint256 public _transferOverLimitTax = 10;    
    ...
    function updateFees(uint256 _tokenRewardsFee, uint256 _liquidityFee, uint256 _marketFee, uint256 _charityFee, uint256 _buyBackFee, uint256 _burnFee) external onlyOwner {
        ...
        previousTotalFees = _tokenRewardsFee.add(_liquidityFee).add(_marketFee).add(_charityFee).add(_buyBackFee).add(_burnFee);
    }    
