...
contract War is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x47d126AB1b823624fAD9c6C520cdcd1f1dea246d);
    address payable public teamWalletAddress = payable(0xE50f7B3ee7c1ccE76DA746479EBBD787F19B8BC6);
    //address payable public marketingWalletAddress = payable(0x2Af789F9E966b074F5745678716f8652Ad4F105a);
    //address payable public teamWalletAddress = payable(0x38224366Ad8658AFC115b9F2B15893d11aA4476e);
    ...
    uint256 public _liquidityShare = 60;
    ...
    uint256 private _totalSupply =  50000000000000 * 10**_decimals;
