...
contract Staking {
    ...
    function getAllStakesByAddress(uint256 _stakeId) public view returns(uint256 _amountByStakeId, uint256 _timeByStakeId , bool _flagByStakeId){
            _amountByStakeId = amountByStakeId[_stakeId];
            _timeByStakeId = timeByStakeId[_stakeId];
            _flagByStakeId = flagByStakeId[_stakeId];
    }
}
