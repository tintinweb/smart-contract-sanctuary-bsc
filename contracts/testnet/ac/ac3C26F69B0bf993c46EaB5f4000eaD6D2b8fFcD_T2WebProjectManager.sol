  ...
  AccessControlUpgradeable
{
  ...
  function mintBatch(address to, uint256 amount) external onlyRole(OPERATOR_ROLE) {
    uint256 remain = maxSupply - totalSupply;
    require(remain >= amount, "ERC721: out of supply");
  ...
  OwnableUpgradeable
{
  ...
  function claimItems(uint256 projectId, uint256 amount) external {
    ...
    IT2WebERC721(project.contractAddress).mintBatch(msg.sender, amount);
  }
