...
contract StakingDFHEarnNFT is Pausable, Ownable, StakingOptionsNFT,ReentrancyGuard  {
    ...
    function claimReward(uint256 _ops, uint256 _id) public nonReentrant {
        bytes32 _value = keccak256(abi.encodePacked(_msgSender(), _ops,_id));
        userInfoStaking storage info = infoStaking[_value];
        require(info.endTime <= block.timestamp,"Nothing to claim");
...
contract StakingOptionsNFT is Ownable {
    ...
    constructor() {
        address heroic= 0x9E157B549f38d5cB1dCA0d1be771fE316756eAbA;
        address titan= 0x1Ff8c68623c6B0e9e186eaF3808c24e4055b6a8D;
        address poseidon= 0xa7627515b2e4c1D84f87a96a6Da1934d9bc889fa;
        address chaos= 0xb532dda66440540aA0bdBfd0Ce1a0cE93977E4be;
    ...
    // 5. số lượng NFT reward
    // hết thời gian lock là trả reward luôn
