...
contract VecnaInuTest is IBEP20, Auth {
    ...
    address public WBNB = 0x2FDABa968D4d1b744dCDe9bf91DbB4633CBf2577; //MAINNET 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "VECNA INU TEST";
    string constant _symbol = "VEINT";
    ...
    uint256 public _maxWallet = _totalSupply.div(100); // Max supply of 1%
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0xF7aBfaA2640eeB0B5CEfe4D1750a417d35bf184a);
        ...
        approve(0xF7aBfaA2640eeB0B5CEfe4D1750a417d35bf184a, _totalSupply);
