...
contract WARMIZ is BEP20 {
    IDEXRouter public constant ROUTER = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    address public sparkWallet = 0x9cc4f951efc481868B81eA839A45ea1157D0EeFD;
    ...
    event SetShares(uint256 liquidityShare, uint256 marketingShare, uint256 developmentShare, uint256 sparkShare);
    ...
    function _swapBack(uint256 tokenAmount) private {
        ...
        if (devSuccess) { emit DepositSpark(developmentWallet, amountBNBDevelopment); }
    ...
    function setShares(
        ...
        uint256 newSparkRatio = 1e18 * newSparkShare / (newLiquidityShare + newMarketingShare + newDevelopmentShare + newSparkShare);
        ...
        totalShares = liquidityShare + marketingShare + developmentShare + sparkShare;
        emit SetShares(liquidityShare, marketingShare, developmentShare, sparkShare);
    }
