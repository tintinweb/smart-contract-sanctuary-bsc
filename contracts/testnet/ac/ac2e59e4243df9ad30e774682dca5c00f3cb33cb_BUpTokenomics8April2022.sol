...
contract BUpTokenomics8April2022 is Context, IBEP20, Ownable {
    ...
    address public routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //testnet router address
    

    address public previousRouterAddress;


    string private constant _name = "BUpTokenomics8April2022";
    string private constant _symbol = "BUpT8A22";
    ...
    address public targetToken = 0xEC5dCb5Dbf4B114C9d0F65BcCAb49EC54F6A0867; // dai token address Test net
...
//  include and exclude fee
    ...
    function addLiquidityCustome(address _tokenA,address _tokenB,uint _amountA,uint _amountB) external {
        ...
        IBEP20(_tokenA).approve(routerAddress, _amountA);
        IBEP20(_tokenB).approve(routerAddress, _amountB);

        (uint amountA, uint amountB, uint liquidity) = pancakeV2Router.addLiquidity(_tokenA,_tokenB,_amountA,_amountB,1,1,address(this),block.timestamp);
        feeEnabled = _temp_feeEnabled;
