...
contract BABYTOKEN is ERC20, Ownable {
    ...
    address public _marketingWalletAddress2 = 0x0637C3a654B9A3E8213304a1e12632E77Cd89c0F;
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        ...
        uint256 a1 = newBalance.mul(sellMarketingFee).div(100);
        uint256 a2 = newBalance.sub(a1);
        IERC20(rewardToken).transfer(_marketingWalletAddress, a1);
        IERC20(rewardToken).transfer(_marketingWalletAddress2, a2);
