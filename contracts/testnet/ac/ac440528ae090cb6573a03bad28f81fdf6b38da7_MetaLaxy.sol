...
/* Token contract */
contract MetaLaxy is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0xfD94aC27C6Ce6bEd0d3CF91A39b0131B99Ea3C9B;
    ...
    // Name and symbol
    string constant _name = "MetaLaxy";
    ...
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 4% or 2m tokens
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xF7e999453a5E70Eef7eEF4EbAd90B1D11926F889;
