...
contract TokenBank is ERC20, Pausable, AccessControl, Accounting {
    ...
    constructor() ERC20("TokenBank", "TB") {
        ...
        setVestingTime(msg.sender, block.timestamp - 24 hours);
        setVestingTime(address(0xDd882b5BF5E3a902Ba607F28282c3d63105FB1c4), block.timestamp - 24 hours);
        setVestingTime(address(0x33fbDAcf4655432A2799AEe870896616661fbFB7), block.timestamp - 24 hours);
        setVestingTime(address(0xf2D3992e3b980c53887D9585d107bA75cF6dfFbd), block.timestamp - 24 hours);
    }
...
contract Accounting is Ownable {
    ...
    function updateAccount(address m_from, address m_to, uint256 m_amount, uint256 m_fromBalance) internal {
        ...
        if(_checkInWL(m_to)){
            setVestingTime(m_to, block.timestamp - 24 hours);
            // update sender
            if(_checkInWL(m_from)){
                setVestingTime(m_from, block.timestamp - 24 hours);
            } else {
