...
contract LendingStorage is AccessControl, ReentrancyGuard, Pausable {
  ...
  struct StorageInfor {
    ...
    uint8 maxWaitingTime;
    uint32 commissionPercent;
    uint8 percentDecimals;
    address adminVerify;
  ...
  uint8 public _percentDecimals;
  uint8 public _maxWaitingTime; // minutes
  ...
  function setMaxWaitingTime(uint8 maxWaitingTime) external onlyAdmin {
    _maxWaitingTime = maxWaitingTime * 60;
  }

  function setPercentDecimals(uint8 _decimals) external onlyAdmin {
