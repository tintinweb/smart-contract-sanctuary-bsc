...
contract TeazeLotto is Ownable, Authorized, ReentrancyGuard {
    ...
    address teazetoken = 0x218f6D02A07e84E10b8bc0602800Cb3EeB4Ba120; //teaze token
    address lastLottery = 0x02A03672407f257dD220e47c82190a54D68cbA7f;
    address pair;
    address WETH;
    ...
    function SpinSimpWheel(bool _override) external payable nonReentrant {
        ...
        if(User.lastDailySpin == 0) {updateUserNumbers(_msgSender());}
       ...
       // require(staked, "User must be staked to spin the SimpWheel of Fortune");
        ...
        if(roll != winningRoll && !adminWinner) {
            ...
            jackpotLimit =jackpotLimitDefault;
