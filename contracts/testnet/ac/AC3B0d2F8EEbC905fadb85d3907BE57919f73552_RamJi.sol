...
contract RamJi is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 FullExp = contractTokenBalance.mul(40).div(100);
    ...
    function _takeMarketingFee(uint256 tMarketing) private {
        ...
        uint256 Marketing=tMarketing.mul(40).div(100);
        uint256 Burn=tMarketing.mul(20).div(100);
        uint256 Reflection=tMarketing.mul(40).div(100);
        _rOwned[address(this)] = _rOwned[address(this)].add(rMarketing);
        // if(_isExcludedFromReward[address(this)]){
        //     _tOwned[address(this)] = _tOwned[address(this)].add(tMarketing);
        // }
        _totalMarketing=_totalMarketing.add(Marketing);
