...
contract PancakePair is IPancakePair {
    ...
    function getSwapOutUsdt(address token, uint256 coinNum) public view returns (uint256, uint256) {
        ...
        uint256 need_usdt = nowPrice + nowPrice * coinNum/(10**decimal) + (floatPrice + coinNum*floatPrice/(10**decimal))*coinNum/(10**decimal)/2;
        uint256 _nowPrice = nowPrice + nowPrice * coinNum/(10**decimal);
