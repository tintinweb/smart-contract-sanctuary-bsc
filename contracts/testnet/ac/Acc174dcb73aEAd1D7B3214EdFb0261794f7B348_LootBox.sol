    ...
    PriceControl
{
    ...
    function _paymentWithToken(uint256 price) internal {
        uint256 amountInOther = oracle.getAmountsOutByBUSD(
            (price * discount) / 10000,
            address(paymentToken)
        );
        paymentToken.safeTransferFrom(msg.sender, address(this), amountInOther);
    }
    ...
    function changePaymentToken(IERC20Upgradeable newPaymentToken)
        external
        onlyOwner
    {
