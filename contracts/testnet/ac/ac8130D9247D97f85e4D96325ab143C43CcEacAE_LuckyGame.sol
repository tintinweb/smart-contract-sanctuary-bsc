...
contract LuckyGame is Ownable, Pausable, ReentrancyGuard {
    ...
    event BuyLotterty(address user, uint256 qty, uint256 price);
    event ClaimERC20(address user, uint256 amount);
        ...
        nonReentrant
    {
        ...
        emit BuyLotterty(_msgSender(), qty, lotteryPrice);
    }
    ...
    function claimERC20(
        ...
        emit ClaimERC20(_msgSender(), amount);
    }

    function claimFreeLottery(uint256 qty, bytes32 sig) external {
        // TODO
    }
