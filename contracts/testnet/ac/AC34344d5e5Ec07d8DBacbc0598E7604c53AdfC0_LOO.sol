...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _tokenTransfer(
        ...
        _takeTransfer(sender, recipient, tAmount - feeAmount - iFee);
    }
    function computeInviteFee(address sender, uint256 amount) private returns(uint256) {
		uint256 takeAmount ;
