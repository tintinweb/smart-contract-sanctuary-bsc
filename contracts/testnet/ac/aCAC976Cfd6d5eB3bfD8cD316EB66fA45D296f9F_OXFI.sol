...
contract OXFI is IERC20, Ownable, AccessControl {
    ...
    uint256 _fixedTotalSupply = 900_000 ether;  // Fixed Total Supply to manage static allowances
    ...
    // Threshold for liquidity injection
    uint256 public liquidityThreshold = _totalSupply / 2000; // 0.005%
    ...
    constructor() {
        ...
        vault = new OXFIvault(address(this), 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
    ...
    */
    ...
    function _takeBuyFee(address sender, uint256 tAmount) internal {
        ...
        emit Transfer(sender, address(this), vFee.add(mFee));
    }
    ...
    function setSwapBackSettings(bool _enabled, uint256 _amount)
        ...
        onlyOwner
    {
        swapEnabled = _enabled;        //default to true at the moment
