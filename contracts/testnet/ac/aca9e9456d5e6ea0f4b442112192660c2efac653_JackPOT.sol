...
contract JackPOT is Ownable {
    ...
    function finalizedJackpot(uint _jackpotNumber) external onlyOwner {
        ...
        if(_jackpotNumber==2){
            ...
            if(number<3){
                ...
                for(uint i=0 ; i<number ; i++){
                  ...
                  jackpots[_jackpotNumber][currentRound[_jackpotNumber]].winners[i] = userAddress[_jackpotNumber][currentRound[_jackpotNumber]][i+1];
                  token.transfer(jackpots[_jackpotNumber][currentRound[_jackpotNumber]].winners[i] , rewardToSend/number);

                }
                
                jackpots[_jackpotNumber][currentRound[_jackpotNumber]].numberOfWinners = number;
                ...
                jackpots[_jackpotNumber][currentRound[_jackpotNumber]].winners[0] =  userAddress[_jackpotNumber][currentRound[_jackpotNumber]][random(number, 1)];
                jackpots[_jackpotNumber][currentRound[_jackpotNumber]].winners[1] =  userAddress[_jackpotNumber][currentRound[_jackpotNumber]][random(number, 2)];
                jackpots[_jackpotNumber][currentRound[_jackpotNumber]].winners[2] =  userAddress[_jackpotNumber][currentRound[_jackpotNumber]][random(number, 3)];
                ...
                jackpots[_jackpotNumber][currentRound[_jackpotNumber]].numberOfWinners = 3;
        ...
        else
        {
           ...
           uint256 winnerId = random(number,2);
    ...
    function random(uint256 _number  , uint _blend) internal view returns (uint256) {
