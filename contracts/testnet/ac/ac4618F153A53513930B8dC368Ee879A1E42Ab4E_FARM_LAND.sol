...
contract FARM_LAND is Ownable, ERC721, IERC721Receiver {
    ...
    bool public isCheckMiner = true; //是否仅Miner可以铸造
    ...
    uint256 public maxNft = 7777; //最大NFT数量
    uint256 public superLand = 0; //高级土地
    address public tempOwner = 0x000000000000000000000000000000000000dEaD; //临时土地所有者

    constructor() ERC721("FARM-LAND-NFT", "FARM LAND") {}
        ...
        returns (uint256)
    {
        ...
        //铸造个数限制
        if (maxNft > 0 && caller != tempOwner) {
            require(superLand < maxNft, "maxNft overflow error");
            superLand += 1;
        }
