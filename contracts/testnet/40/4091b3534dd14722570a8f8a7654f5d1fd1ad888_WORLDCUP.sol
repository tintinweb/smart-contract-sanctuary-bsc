...
// File: .deps/contract/WorldCup.sol
...
contract WORLDCUP is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xb506D9e0a5930A0519fa0b5A296f26F3570ff54f);
    address payable public teamWalletAddress = payable(0x62c21d8D14FE664Fd8B97C2CE096712437Cf3429);
