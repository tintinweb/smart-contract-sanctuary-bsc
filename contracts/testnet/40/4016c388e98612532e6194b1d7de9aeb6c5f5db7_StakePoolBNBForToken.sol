...
contract FactoryStakingPool{
    ...
    function createBNBForToken(address ownerAddress, uint256 _earlyUstakeFee, IBEP20 _rewardingToken, uint256 _lockPeriod,  uint256 _earlyRewardUstakeFee,  bool _earlyUstake) public returns (address)
    {
