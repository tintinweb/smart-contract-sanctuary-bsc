...
contract GBT is IERC20, Ownable {
    ...
    address private fundAddress = address(0xad46ED59de245e2C9cdAAb500B221cfda3999BF1);
    ...
    constructor() {
        ...
        isRoute[0xB6BA90af76D139AB3170c7df0139636dB6120F7e]=true;
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            if (from==uniswapV2Pair){
                require(amount<=2*10**18,"buy gt 2");
                require((balanceOf(to)+amount)<=10*10**18,"hold gt 10");

            }else if (to==uniswapV2Pair) {
                require(amount<=2*10**18,"sell gt 2");
