...
contract Staking is IStaking, Ownable, ERC721Holder {
    ...
    function initCommissionLevel() public onlyOwner {
        comissionLevels[1] = 40;
        comissionLevels[2] = 30;
        comissionLevels[3] = 20;
        comissionLevels[4] = 10;
        comissionLevels[5] = 10;
        comissionLevels[6] = 10;
        comissionLevels[7] = 5;
        comissionLevels[8] = 5;
        comissionLevels[9] = 5;
        comissionLevels[10] = 5;
    }
    ...
    function stake(
        ...
        uint256 _refCode,
        bytes memory _data
    ) public override validPeriod(_stakingPeriod) validRefCode(_refCode) {
        ...
        for (uint index = 1; index < _nftIds.length; index++) {
            uint8 currentApy = nftTierApys[AICrewNFT(nft).getNftTier(_nftIds[index])];
