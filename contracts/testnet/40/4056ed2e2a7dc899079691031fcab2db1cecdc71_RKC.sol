...
contract RKC is ERC20 {
    ...
    address payable public marketAddress = payable(0xd4FDa2e6Ea57259731499658C764f60898b2D3f3);
    address payable public repoAddress =payable(0xA98d56DF91C32F976b266BDbF1f7e56749d5F1d8); 
    address payable public fundAddress =payable(0x3c0BD7A84FbEeF91b8B45B8b0873518aEA001340);
    ...
    //name,symbol
    string internal tokenName = "Rocket Coin";
    string internal tokenSymbol = "RKC";
