...
abstract contract IERC20Staking is ReentrancyGuard, Ownable {
    ...
    function stake(uint256 _stakingId, uint256 _amount,uint256 key) public virtual;
...
contract RegentStake is IERC20Staking {
    ...
    function referralStake(uint256 _stakingId, uint256 _amount, address _referrer,uint256 _key) public {
        ...
        stake(_stakingId, _amount,_key);
    }
    
 function stake(uint256 _stakingId, uint256 _amount, uint256 _key) public override {
