...
contract Flexvis is Ownable, FlexvisERC20("Flexvis", "FLX") {
    ...
    function setMarketingWallet(address _newMarketingWallet) external onlyOwner{
        _marketingWallet = _newMarketingWallet;
    }

    function setMarketingPercentage(uint256 _percentage) external onlyOwner{
        _marketingPercentage = _percentage;
    }
...
contract FlexvisERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        uint256 marketingFee = (amount * _marketingPercentage) / 100;

        uint256 amountToSend = amount - marketingFee;
