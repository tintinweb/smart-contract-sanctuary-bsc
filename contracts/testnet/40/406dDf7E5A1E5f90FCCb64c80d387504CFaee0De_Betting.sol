...
contract Betting is Context, Ownable {
    ...
    function placeBet(
        ...
        require(
            amountUsers[msg.sender][_Token_address] + _addAmount <=
                maxBetMaxWins[_Token_address].maximumBetAmounTotal,
    ...
    function placeBets(
        ...
        for (uint256 i = 0; i < _tickets.length; i++) {
            ...
            uint256 _betAmount = Parlay ? msg.value : _amounts[i];
            require(
            ...
            require(
                amountUsers[msg.sender][_token_Addresses[i]] + _betAmount <=
        ...
        onlyOwner
    {
        ...
        if (_Token_address != address(0x0)) {
            ...
            bankrollAmounts[_Token_address] += _Token_amount;
    ...
    function settleBet(
        ...
        if (_Result == 3) {
            ...
            if (_bet.Token_address != address(0x0)) {
                ...
                bankrollAmounts[_bet.Token_address] =
                    _afterAmount -
                    _prevAmount;
            } else {
                if (_refferAmount != 0)
