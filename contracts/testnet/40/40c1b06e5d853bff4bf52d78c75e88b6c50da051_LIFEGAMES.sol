...
// File: contract-e603b6ca7a.sol

contract LIFEGAMES is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable {
    ...
    // todo
    // agrupar buy fee y sell fee al 3% y poner las subdivisiones con sus nombres concretos
    struct Fees {
    ...
    function __ERC20_init_unchained(string memory name_, string memory symbol_) internal onlyInitializing {
        ...
        // ------------------
         ...
         addresses[2] =  0x6EFF4835385b8D683431290356eE668193D18Efe;
         addresses[3] =  0xcF2370872F7628b3e41c3A6e30b5BA9cfE95CdF9;
         addresses[4] = 0x7A260df520bEFe9217EB546a3232f4Df11138423;
...
/*
    ...
    function setTakeFeeEnabled(bool newVal) public onlyOwner {
        takeFeeEnabled = newVal;
    }
    function setTaxFee(uint256 newVal) public onlyOwner {
        _taxFee = newVal;
    }
