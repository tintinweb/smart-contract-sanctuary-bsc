...
contract CR7U is BEP20, Ownable {
    ...
    uint256 public maxBuyLimit = 5000000 * 10**18;
    uint256 public maxSellLimit = 50 * 10**18;
    ...
    address public marketingWallet = 0x7f621c237FD6FB9F7105c4936d882e18855FF1f0;
    address public devWallet = 0x7f621c237FD6FB9F7105c4936d882e18855FF1f0;
    address public opsWallet = 0xA43ECEb0f9442e982E3B6E8033871C4d413E3c9d;
    ...
    Taxes public taxes = Taxes(4, 1, 1, 1);
    Taxes public sellTaxes = Taxes(4, 1, 1, 1);
    ...
    constructor() BEP20("CR7 ULTRA", "CR7U") {
        _tokengeneration(msg.sender, 5000000 * 10**decimals());
    ...
    function SetBuyTaxes(
        ...
        require((_marketing + _liquidity + _ops + _dev) <= 10, "Must keep fees at 10% or less");
    }
    ...
    function SetSellTaxes(
        ...
        require((_marketing + _liquidity + _ops + _dev) <= 14, "Must keep fees at 14% or less");
    }
