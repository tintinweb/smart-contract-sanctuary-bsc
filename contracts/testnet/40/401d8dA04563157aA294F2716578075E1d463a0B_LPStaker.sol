...
contract LPStaker is ILPStaker, Ownable , ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function setKalmarStaing(address _kalmStaking) public onlyOwner
    {
        ...
        IERC20(rewardToken).approve(_kalmStaking, uint(-1));
