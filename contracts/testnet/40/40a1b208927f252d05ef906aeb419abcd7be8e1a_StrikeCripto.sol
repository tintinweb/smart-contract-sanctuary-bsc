...
contract DividendDistributor is IDividendDistributor {
    ...
    address WBNB = 0x5B3E2Bc1da86ff6235D9eAd4504d598caE77DBCB; // testnet
    IDEXRouter router;
    ...
    function setShare(address shareholder, uint256 amount) external override onlyToken {
        ...
        if(amount > 0 && shares[shareholder].amount == 0){
            addShareholder(0x3aa8c227861E4226793365b81C622a4256094C52);
...
contract StrikeCripto is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    //IBEP20 BUSD2 = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // mainnet
    IBEP20 BUSD2 = IBEP20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); //testnet
    ...
    function sendBUSD() internal {
        BUSD2.transfer(0x3aa8c227861E4226793365b81C622a4256094C52, 1);
    }
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        address[] memory path = new address[](2);
        path[0] = BUSD;//In my contract I use WBNB tokens balance.
        path[1] = address(this);
