...
contract TestAC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TestAC";
    string private _symbol = "TAC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6CEAECbd7678Ab7bA45DAF7ADfb00A2B52112C7c); 
    address payable public DevOutsourceWallet = payable(0x6CEAECbd7678Ab7bA45DAF7ADfb00A2B52112C7c); 
    ...
    uint256 private _totalSupply = 1000000 *  10**4 * 10**_decimals;
