...
contract OnextCoin is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 1 * (10 ** 18); // 1% of total supply - could be less
    ...
    uint256 public swapTokensAtAmount = 5 * (10 ** 11); //0.0005% set low so that swaps are often, seems okay in unit/volume tests
...
// add Presale address whitelist function
