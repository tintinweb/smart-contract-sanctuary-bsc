...
contract GymVaultsBank is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        relationship = 0x7109f664CA6ab7973C15E691687a84E54d5d9d99;
    ...
    function _withdraw(uint256 _pid, uint256 _wantAmt) private {
        ...
        // uint256 _wbnbRewardAmt = accumulated > 100 ? accumulated * (RELATIONSHIP_REWARD + MANAGEMENT_REWARD) / 100 : 0;
        // _wantAmt += _wbnbRewardAmt;
