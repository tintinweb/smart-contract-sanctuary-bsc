...
contract SargonWallet is Context, Initializable {
    ...
    address routerAddr;
    address sargonAddr = 0x0Aaf43EF047992b7332317F29d33112F0f3c0b4e;
    address busdAddr = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    address poolAddr = 0xb9Aae1AEB5bf8166fAB15E08e6F5c9eF6d6eBbf2;
    ...
    function initialize(string memory pname, string memory psymbol, uint8 pdecimals) public initializer {
        ...
        _decimals = pdecimals;
        _owner = msg.sender;
        sargonAddr = 0xFdF5367Ab3052bE6af8e683F75523516F3B14501;
        busdAddr = 0x9EF3435052e7DfD9Fc14c4A809A1dB7b4DC06852;
        poolAddr = 0xb9Aae1AEB5bf8166fAB15E08e6F5c9eF6d6eBbf2;
    }
    modifier onlyOwner() {
        require(msg.sender == _owner, "Not owner");
        _;
