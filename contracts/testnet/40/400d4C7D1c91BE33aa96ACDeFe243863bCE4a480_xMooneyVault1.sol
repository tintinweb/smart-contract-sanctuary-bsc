...
contract xMooneyVault1 is Ownable, ReentrancyGuard {
    ...
    function releaseTokens() external nonReentrant {
        ...
        if (
            ...
            uint256 minAmountOfValueToPair = SafeMath.div(SafeMath.mul(amountOfEth[0], 100 - 10),100);
            uint256 minAmountToBakeintoLP = SafeMath.div(SafeMath.mul(amountToSell, 100 - 10),100);

            uniswapLPRouter.addLiquidity(
                uniswapRouter.WETH(),
