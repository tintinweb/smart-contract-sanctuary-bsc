...
contract Blackboobs is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Blackboobs';
    string private constant _symbol = 'bbb';
    uint8 private constant _decimals = 18;
    uint public constant InitialSupply= 1 * 1000000 * 18**_decimals;
