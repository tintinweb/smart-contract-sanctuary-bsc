...
contract Convert is EternalStorage, Initializable, IConvert, ConvertMock {
    ...
    function convertNew(address _miner, uint256 _amount) public override payable onlyCaller {
...
interface IConvert {
    function convertNew(address _miner, uint256 _amount) external payable;
