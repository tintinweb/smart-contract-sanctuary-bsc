...
contract GALI is ERC20, Ownable {
    ...
    address payable public MarketingWallet = payable(0xe363eE2e2E7a8299cBe142e238bFadaECA9846Dc);
    address payable private devWallet = payable(0xe363eE2e2E7a8299cBe142e238bFadaECA9846Dc);
    ...
    constructor() ERC20("GALIGEIGEI", "GALI") {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "GALIGEIGEI: The router already has that address");
        emit UpdateUniswapV2Router(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }

    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "GALIGEIGEI: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "GALIGEIGEI: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "GALIGEIGEI: Automated market maker pair is already set to that value");
