...
contract DD is ERC20, Ownable {
    ...
    address public immutable rewardToken;
    uint256 public gasForProcessing = 3_000;
    ...
    constructor() payable ERC20("Doge Defi", "DD") {
        ...
        _mint(owner(), 1_000_000_000 * (10 ** 7));
        swapTokensAtAmount = totalSupply() * (10 ** 7) / 5000;
    }
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 2_000 && newValue <= 5_000, "gasForProcessing must be between 200,000 and 500,000");
