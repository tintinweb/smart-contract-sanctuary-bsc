    ...
    ReentrancyGuard
{
    ...
    bool private _isBuyingAllowed = true; // This is used to make sure that the contract is activated before anyone makes a purchase on PCS.  The contract will be activated once liquidity is added.

    // marketing and moonshield address
    address private _marketingWallet =
        0xdD05d097e2E293F53Cd362847fa3B743939F33a6;
    address private _salaryWallet = 0xF8A2645dC25B54CcF5851682B3b3Eb61A902fdB7;
    ...
    constructor(address routerAddress, address pinkAntiBot_) {
        ...
        setBuyFees(1, 3, 0, 0, 0);
        setSellFees(1, 3, 0, 0, 0);
...
contract SpaceDoge is SpaceDogeBase {
    ...
    uint256 private _minRewardBalance = (100000000000 * 10**decimals()) / 1000; //5 billion The minimum balance required to be eligible for rewards
