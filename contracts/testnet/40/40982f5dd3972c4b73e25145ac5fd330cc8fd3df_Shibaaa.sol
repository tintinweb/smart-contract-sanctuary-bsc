...
contract Shibaaa is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress = payable(0xd88a3eD2Fb046Ab49d0b8859fed18CD912Ff6F96); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x68b0c130231509819f0D6c87Cfffb53Cd7e0f188); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0x6126b405487BdCeB708aB1fC482Bd853e72ACa52); // charity Wallet Address
    address payable public devWalletAddress = payable(0x74727125aa6C806249A52CFEB3a7D877173CEe5f); // dev Wallet Address
    ...
    string private constant _name = "Shibaaa";
    string private constant _symbol = "SHIBAAA";
    ...
    constructor () {
        address _owner = 0xf32D1CF29241B6F0e61f7cB86242Ab900F1a628D;
