...
contract FST is Context, IBEP20, Ownable {
    using SafeMath for uint256;

    string private _name = "FST";
    ...
    constructor(address _owner, address _feeReceiver) Ownable(_owner) {
        ...
        // Create a dex pair for this new FST
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "FST: transfer amount exceeds allowance"
            )
        );
        return true;
    }
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "FST: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function _approve(
        ...
        require(owner != address(0), "FST: approve from the zero address");
        require(spender != address(0), "FST: approve to the zero address");
    ...
    function _transfer(
        ...
        require(from != address(0), "FST: transfer from the zero address");
        require(to != address(0), "FST: transfer to the zero address");
        require(amount > 0, "FST: Amount must be greater than zero");
