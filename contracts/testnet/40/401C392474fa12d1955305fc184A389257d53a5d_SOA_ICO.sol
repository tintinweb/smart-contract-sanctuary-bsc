...
contract SOA_ICO is Ownable {
  ...
  uint256 public  RATE = 100; // Number of tokens per 1 BNB 
  uint256 public  CAP = 50000; // Cap in BNB
  uint256 public  START = 1655679030; // June 20, 2022
  ...
  uint256 public constant initialTokens = 1000000000 * 10**18; // 10% of total tokens available
