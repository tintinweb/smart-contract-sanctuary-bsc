...
contract TKOPower is ERC20, Ownable {
    ...
    event onLock(address indexed sender, uint256 amount);
    event onUnlock(address indexed sender, uint256 amount);
    event onClaim(address indexed sender, uint256 amount);
   ...
   function TKOToPower(uint256 tko) public pure returns (uint256) {
    ...
    function unlock() public {
        ...
        emit onUnlock(msg.sender, tkoAmount);
    }
    ...
    function claim() public {
        ...
        emit onClaim(msg.sender, tkoAmount);
    }
