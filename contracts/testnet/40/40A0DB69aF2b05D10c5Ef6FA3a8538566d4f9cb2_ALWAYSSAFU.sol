...
contract ALWAYSSAFU is ERC20Detailed, Auth {
    ...
    uint256 public bankFee = 20;
    uint256 public DestructorFee = 10;
    ...
    uint256 public swapThreshold = INITIAL_FRAGMENTS_SUPPLY * 600 / 100000;
    uint256 public minAmounttoSwap = INITIAL_FRAGMENTS_SUPPLY * 20 / 100000;
    ...
    constructor() ERC20Detailed("ALWAYSSAFU", "SAFE", uint8(DECIMALS)) Auth(msg.sender) {

        router = IPancakeSwapRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 ); 
        pair = IPancakeSwapFactory(router.factory()).createPair(
        router.WETH(), address(this));
        autoLPReceiver = 0xB25AcBc5dF4f6f1dEb1368aE54122e334Ff435c9;
        marketingReceiver = 0x1c33D07533097ec04C49ccEe3F9AC895c12DDBAA; 
        CentralBank = 0x4Bd372cf6Cdae4bba4C0Fd9A5534f783c1307d02;
        destructor = 0x84940BedC65B283b04649eedDF4af409cC91E83f;
        master = 0xB25AcBc5dF4f6f1dEb1368aE54122e334Ff435c9;
        ...
        _isInternal[master] = true;
        _isInternal[msg.sender] = true;
        _isInternal[CentralBank] = true;
        _isFeeExempt[marketingReceiver] = true;
        _isFeeExempt[master] = true;
        _isFeeExempt[address(this)] = true;

        Auth(master); Auth(CentralBank); Auth(marketingReceiver);
    ...
    function takeFee(address sender,address recipient,uint256 tAmount) internal  returns (uint256) {
        ...
        _balances[destructor] = _balances[destructor].add(
            tAmount.div(feeDenominator).mul(DestructorFee));
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountToLiquify = swapThreshold.mul(dynamicLiquidityFee).div(Divisor).div(2);
    ...
    function setFeeReceivers(address _autoLPReceiver, address _marketingReceiver, address _CentralBank, address _destructor) external authorized {
