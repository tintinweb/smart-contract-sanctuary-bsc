...
// File: contracts/BlackBoxNetwork.sol

/*

Black Box Network is a brand new blockchain with Proof-of-Stake mechanism which will mainly focusing on NFT, P2E and Online Shopping using $BLACKB as main currency on Black Box Network ecosystem.


*/

//Telegram : https://t.me/blackboxnetwork
//Website : https://blackboxnetwork.live/
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract Black_Box_Network is Context , IERC20, Ownable {
    ...
    string private _name = "Black Box Network";
    ...
    address public devWallet = 0xE3D0d3C912201E1103A16e862760e7988065F175; // marketing wallet
    ...
    uint256 public _maxTxAmount = 2 * 10**9 * 10**9; //2% of total supply
    uint256 private numTokensSellToAddToLiquidity = 2430 * 10**9 * 10**9;
    uint256 public _maxWalletToken = 2 * 10**9 * 10**9; //2% of total supply
