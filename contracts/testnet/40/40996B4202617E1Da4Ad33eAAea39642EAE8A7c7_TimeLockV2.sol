...
contract TimeLockV2 is AccessControl {
    ...
    function schedule(
        ...
        emit Scheduled(_id, _target, _value, _data, _predecessor, _salt);
    }
    ...
    event Scheduled(bytes32 indexed id, address target, uint256 value, bytes data, bytes32 predecessor, bytes32 salt);
