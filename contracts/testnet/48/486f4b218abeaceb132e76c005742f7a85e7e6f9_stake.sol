...
contract stake is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        stakingToken = IBEP20(0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06); // ChainLink.
        rewardToken = IBEP20(0x6d630CAA9bed9bB32F04e97e393E2C254ea95E17); // KIKF.

        apy = 300;      //set apy
        lockDuration = 0.1 days; //Set lock duration
        exitPenaltyPerc = 1;  //set early withdraw penalty fee
