...
contract PPXPresale is Ownable {
    ...
    uint256 public constant MIN_CONTRIBUTION = 50000000000000000;
    ...
    function purchasePPXTokens() external payable {
          // Validations.
            require(
                msg.sender != address(0),
                "PPXPresale: beneficiary is the zero address"
            );
            
            require(isOpen() == true, "Presale has not yet started");
            
            require(msg.value >= MIN_CONTRIBUTION, "PPXPresale: minimum contribution is 0.05 BNB");
            require(msg.value <= MAX_CONTRIBUTION, "PPXPresale: maximum contribution is 10 BNB");
