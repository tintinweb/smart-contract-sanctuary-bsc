...
abstract contract AbsToken is IERC20, Ownable {
    ...
    address public fundAddress = address(0xE6A81D85EafEdc558aC3929ceC2DdA5ec90259bE);
    string private _name = "LH";
    ...
    uint256 private _tTotal = 5888 * 10 ** _decimals;
    uint256 public maxWalletAmount = 5888 * 10 ** _decimals;
    ...
    constructor (){
        ...
        holderRewardCondition = 0 * 10 ** IERC20(_usdt).decimals();
