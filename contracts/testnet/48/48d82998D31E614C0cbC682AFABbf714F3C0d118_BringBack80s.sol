...
contract BringBack80s is IBEP20, Ownable {
    ...
    uint256 public _maxSellTxAmount = _totalSupply / (200) * (1); //0.5%
    uint256 public _maxWalletToken = _totalSupply / (100) * (1); // 1%

    // Fees receivers
    address public autoLiquidityReceiver = 0x9A833152c22b51780548ce1997915C384194e7e1;
    address public marketingFeeReceiver = 0x1BE5436ca5c0949375B472cBdb644034501612cC;
    address public devFeeReceiver = 0xC5F155345E154C4f598113D0DDD5dEb0dD79Bf04;
    address public buybackFeeReceiver = 0x476E71Bc24028C2797b6d2f8DE2dCb346cf53c1E;
