        ...
        if (newConfigs[3] != 0 || newConfigs[0] != 0 || newConfigs[1] != 0) {
            ...
            if (pool.poolType != 0) {
                ...
                if (newConfigs[3] != 0) {
                    ...
                    stakingLimit  = newConfigs[3];
                } else {
                    stakingLimit = pool.stakingLimit;
                }
                newRewardFund  = stakingLimit * pool.apr * pool.configs[4] * poolDuration / ONE_YEAR_IN_SECONDS / 1e4;
                pool.stakingLimit = stakingLimit;
            } else {
