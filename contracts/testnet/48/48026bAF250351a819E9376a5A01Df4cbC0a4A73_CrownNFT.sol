...
contract CrownNFT is ERC721Votes, ERC721Enumerable {
    ...
    function stakeOrUnstake(uint256 tokenId, bool status) external {
        ...
        _stakeOrUnstake(tokenId, status);
    }
    /**
     *  @dev change status of stake token
     */
    function _stakeOrUnstake(uint256 tokenId, bool status) internal {
