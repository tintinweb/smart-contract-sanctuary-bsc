...
//        uint256 usdPriceOBS = newPriceOBS.mul(priceMainToUSD).div(10 ** decimals);
        uint256 incomeInOBSfromUser = (amountTotalForCustomerUSDwei * (10 ** 18) * percentOfSales) / (priceMainToUSD * newPriceOBS * 10000 * (10 ** decimals));
        //                                  21250000000000000 * (10 ** 8) * 5000 = 1.0625e28   (3.995185570218078e30) must be amountTotalForCustomer main coin / 0.0888
