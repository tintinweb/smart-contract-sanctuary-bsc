...
//        uint256 amount,
    ...
    function unlockRoomReverse_IyMI(bytes32 roomId)
        internal
    {
        require(
            rooms[roomId].roomReverseMutex,
...
//    }
    ...
    function unlockUserBalance_Wwha(
        bytes32 roomId,
        address userAddress
    ) internal {
        require(
...
//    }
        ...
        external
    {
        ...
        for (uint i = 0; i < signingBets.length; i = unchecked_inc(i)) {
	...
	function unchecked_inc(uint i) pure internal returns (uint) {
		unchecked {
			return i + 1;
		}
	}
...
//        checkBetDayLimit(_amount, matchInfo.roomId);
		...
		userBalances[matchInfo.roomId][bettorAddress] = userBalance;
...
//        myBet.amount = _amount;
        ...
        rooms[matchInfo.roomId].reverse += (transferAmount + _amount);
...
//            odds
    ...
    function resolveBet_X3EB(
        ...
        for (uint i = 0; i < targetLength; i = unchecked_inc(i)) {
