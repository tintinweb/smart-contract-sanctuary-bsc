...
contract Rebase is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 5000000 * 10**DECIMALS;   // default 0.5% of totalSupply.  
    uint256 public maxBuyTransactionAmount = 5000000 * 10**DECIMALS;    // default 0.5% of totalSupply.  
    ...
    constructor() ERC20("Rebase Finance", "REBASE") {
        ...
        router = IRebaseRouter02(0x338B90e6b57E77E96b125E1A72B4ec33bCA157FA);
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(riskFreeValueReceiver).call{
    ...
    function takeFee(address sender,  address recipient, uint256 gonAmount) internal returns (uint256) {
        ...
        if (automatedMarketMakerPairs[recipient]) {
            ...
            if(launchFeeEnabled) 
                totalFee = _totalFee.add(launchFee);

            // Add tax bracket if enabled, only applicable to sell
            if (taxBracketFeeEnabled) 
                totalFee = _totalFee.add(getCurrentTaxBracket(sender));
        ...
        uint256 feeAmount = calculateAmount(gonAmount, totalFee, FEE_DENOMINATOR);
