...
//
// ETH Token - Rewards + Utility Tools on ETH
//
// 5% Tax on Buys and Sells - Use +5% Slippage
// 2.5% Max Wallet per user - 25 000 000 (25 million) tokens!
//
// More info about X in the links below:
//
// Website: https://
// Twitter: https://
// Telegram: https://t.me/
...
abstract contract Auth {
    ...
    /**
     * Authorize address. Authorized owner only
     */
    ...
    /**
     * Remove address' authorization. Authorized owner only
     */
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 USDC = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // USDC rewards
    IDEXRouter router;
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // CHNG router
        _token = msg.sender;
    }
...
contract Polizmeth is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address USDC = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // USDC Rewards
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEAD_NON_CHECKSUM = 0x000000000000000000000000000000000000dEaD;

    string constant _name = "Polizmeth"; 
    string constant _symbol = "PMTH";
    uint8 constant _decimals = 9; 

    uint256 _totalSupply = 1_000_000_000 * (10 ** _decimals); // 1 000 000 000 total supply
    uint256 public _maxTxAmount = _totalSupply.div(40); // 2.5% max tx start
	uint256 public _maxWallet = _totalSupply.div(40); // 2.5% max wallet start
    ...
    // Starting Tax - 9% both buys and sells
    ...
    address public autoLiquidityReceiver=0x0657771fc16E325efd8888Ad05890514fE50fbAc; // change
    address public marketingFeeReceiver=0x0657771fc16E325efd8888Ad05890514fE50fbAc; // change
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // UNI v2 ROUTER
        pair = IDEXFactory(router.factory()).createPair(router.WETH(), address(this));
        _allowances[address(this)][address(router)] = _totalSupply;
        distributor = new DividendDistributor(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // UNI v2 ROUTER
        ...
        marketingFeeReceiver = 0x0657771fc16E325efd8888Ad05890514fE50fbAc; // change

        approve(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3, _totalSupply); // UNI v2 ROUTER
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
		...
		// Max  tx check
		address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D; // UNI v2 ROUTER
