...
contract MarketplaceSecondaryWhitelist is Ownable, IMarketplaceSecondaryWhitelist {
     ...
     */
    function addCollectionToWhitelist(address _token, bool _is721) external onlyOwner {
        if (_is721) {
     ...
     * @param _is721 True if the collections is an ERC721, false if it is an ERC1155
     */
    function removeCollectionToWhitelist(uint _index, bool _is721) external onlyOwner {
        address token;
     ...
     */
    function removePaymentTokenToWhitelist(uint _index) external override onlyOwner {
