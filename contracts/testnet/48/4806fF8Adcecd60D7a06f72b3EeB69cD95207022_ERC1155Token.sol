...
contract Treasury is Initializable, OwnableUpgradeable {
    ...
    payable
  {
    ...
    uint256 lastTokenId = ids[ids.length - 1];
    require(
      lastTokenId <= IERC1155Token(tokenAddress).totalSupply(),
