...
function take_detal (uint256 num) public virtual override {
    require( detal[msg.sender] >= num);
     detal[msg.sender] =  detal[msg.sender]-num;
}
...
function Take_chest (uint256 num_track, uint256 num_chest) public virtual override {
    if (num_chest == 1) {
    require(chest1[msg.sender][num_track]>=1);
    chest1[msg.sender][num_track]--;
    }
    if (num_chest == 2) {
        require(chest2[msg.sender][num_track]>=1);
    chest2[msg.sender][num_track]--;
    }
    if (num_chest == 3) {
        require(chest3[msg.sender][num_track]>=1);
    chest3[msg.sender][num_track]--;
    }
    if (num_chest == 4) {
        require(chest4[msg.sender][num_track]>=1);
    chest4[msg.sender][num_track]--;
    }
    if (num_chest == 5) {
        require(chest5[msg.sender][num_track]>=1);
    chest5[msg.sender][num_track]--;
    }
    if (num_chest == 6) {
        require(chest6[msg.sender][num_track]>=1);
    chest6[msg.sender][num_track]--;
    }
    if (num_chest == 7) {
        require(chest7[msg.sender][num_track]>=1);
    chest7[msg.sender][num_track]--; 
    }
    if (num_chest == 8) {
        require(chest8[msg.sender][num_track]>=1);
    chest8[msg.sender][num_track]--;
    }
    if (num_chest == 9) {
        require(chest9[msg.sender][num_track]>=1);
    chest9[msg.sender][num_track]--;
    }
    if (num_chest == 10) {
        require(chest10[msg.sender][num_track]>=1);
    chest10[msg.sender][num_track]--;
    }
}
...
function take_detal (uint256 num) external;    

function Take_chest (uint256 num_track, uint256 num_chest) external;
