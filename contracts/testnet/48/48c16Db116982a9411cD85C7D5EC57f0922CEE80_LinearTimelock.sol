...
// File: contracts/LinearTimelock.sol
...
contract LinearTimelock is Initializable {
    ...
    function initialize(IERC20 _erc20_contract_address) initializer public {
    ...
    constructor() {
        ...
        timestampSet = false;
        require(address(msg.sender) != address(0), "owner address can not be 0");
    ...
    function setErc20Contract(address erc20) public onlyOwner {
        require(erc20 != address(0), "ERC20: transfer to the zero address");
    ...
    function setTimestamp(int _cliffTimePeriod, int _releaseTimePeriod) public onlyOwner timestampNotSet  {
        ...
        require(_releaseTimePeriod != 0, "Time periods can not be zero");
