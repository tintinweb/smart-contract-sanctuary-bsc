...
using Strings for uint256;
    ...
    address implementation
        ...
        bytes memory signature = "updateContract(address,string,string)";
         ...
         setBaseURISig = "transferFrom(address,address,uint256)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "safeTransferFrom(address,address,uint256)";
         constructorRegisterFunction(setBaseURISig, implementation);
         setBaseURISig = "safeTransferFrom(address,address,uint256,bytes)";
         constructorRegisterFunction(setBaseURISig, implementation);
