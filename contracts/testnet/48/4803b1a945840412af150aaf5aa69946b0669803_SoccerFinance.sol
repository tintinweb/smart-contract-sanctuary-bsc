...
contract SoccerFinance is ERC20, Ownable {
    ...
    constructor () ERC20("Soccer Finance", "SFI") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0xFefd42Cbbb162Ebc906c8A477404e6366dA239Ca;
...
//------------------Swap------------------//
    function setSwapTokensAtAmount(uint256 newAmount) external onlyOwner{
        require(newAmount > totalSupply() / 100_000_000, "SwapTokensAtAmount must be greater than 0.0001% of total supply");
