...
contract Shera is Context, IERC20, ERC20Ownable {
    ...
    function setFee(uint8 , uint256 , uint8 , uint8 , uint8) public onlyOwner {
        _previousMarTax = _marTax;
       _previousBurnFee = _burnTax;
        _previousDevTax = _devTax;
        _previousLiqTax = _liqTax;
       ...
       totalFees =  _previousBurnFee.add(_previousMarTax).add(_previousDevTax).add(_previousLiqTax).add(_previousRefTax); // total fee transfer and buy
    }
