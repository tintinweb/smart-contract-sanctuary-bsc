...
contract LEYECOM is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        OurLinks.Telegram = "sdf"; //Telegram Link
        OurLinks.Twitter = "sdf"; //Twitter Link
        OurLinks.Medium = "sdf"; //Medium Link
        OurLinks.Github = "sf"; //Github Link
        OurLinks.Tiktok = "sdf"; //Tiktok Link
        OurLinks.WhitePaper = "FDG"; //Whitepaper Link
