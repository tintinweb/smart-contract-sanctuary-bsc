...
contract StakeContract {
    ...
    mapping (string => uint256) public APY;  // anual percentage yield
    ...
    // staking.
    function deposit(uint256 _amount, string memory _type) public {
        ...
        uint256 _reward = info.amount * APY[_type] * (curBlock - info.lastCalcBlock) / ( 100 * secondInYear);
    ...
    function withdraw(string memory _type) public {
    ...
    function unstake(uint256 _amount, string memory _type) public {
        UserInfo storage info = userInfo[_type][msg.sender];
    ...
    // unstaking all
    function unstakeAll(string memory _type) public {
        UserInfo storage info = userInfo[_type][msg.sender];
    ...
    function calcCurrentReward(address _addr, string memory _type) public view returns(uint256) {
    ...
    function setAPY(uint256 _APY, string memory _type) public onlyOwner {
        APY[_type] = _APY;
    }
