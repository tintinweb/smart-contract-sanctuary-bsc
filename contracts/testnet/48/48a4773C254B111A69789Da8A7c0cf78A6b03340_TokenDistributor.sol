 ...
 * @notice It handles the distribution of Sesame token.
...
contract TokenDistributor is ReentrancyGuard {
    ...
    /**
     * @notice Constructor
     * @param _sesameToken Sesame token address
    ...
    constructor(
        ...
        endBlock = block.number + _periodLengthesInBlocks[0];
     ...
     * @param amount amount to deposit (in Sesame)
     */
    function deposit(uint256 amount) external nonReentrant {
        ...
        // Transfer Sesame tokens to this contract
    ...
    function withdraw(uint256 amount) external nonReentrant {
        ...
        // Transfer Sesame tokens to the sender
