...
contract Game is AccessControl,Ownable {
  ...
  struct FightingEndInfo{
    ...
    function fighting(uint256 tokenId,uint256 enemyId) public isUnlock(tokenId) isteam(tokenId,msg.sender) {
    ...
    // 做任务
    function DoTask(uint256 tokenId,uint256 enemyId) public isUnlock(tokenId) isteam(tokenId,msg.sender) {
