...
contract MetaGladiator11 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MetaGladiator11";
    string constant _symbol = "MGDT";
    uint8 constant _decimals = 9;
    uint256 _totalSupply = 5_000_000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply.sub(3000000000000000); // 0.25%
...
//        emit Transfer(sender, recipient, amount);
    ...
    function triggerExtremeBuyback(uint256 amount, bool triggerBuybackMultiplier) external authorized {
