...
contract Unileech is IUnileech {
    ...
    function leech(
        ...
        require(amount > 0, "Unileech:: Invalid-amount");
        IERC20(pairAddr).safeTransferFrom(msg.sender, address(this), amount);
        IEmpirePair pair = IEmpirePair(pairAddr);
        ...
        (uint256 amount0Consumed, uint256 amount1Consumed, ) = router
            .addLiquidity(
                token0,
                token1,
                amount0,
