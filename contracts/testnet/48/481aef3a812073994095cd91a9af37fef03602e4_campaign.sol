...
contract campaign is oracleClient {
    ...
    function getGains(bytes32 idProm) public {
        ...
        require(block.timestamp -proms[idProm].lastHarvest > 86400);
    ...
    function getRemainingFunds(bytes32 idCampaign) public {
        ...
        require(block.timestamp - campaigns[idCampaign].endDate > 86400 * 15 ,"Withdraw not allowed under 15 days");
