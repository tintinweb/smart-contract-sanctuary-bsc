...
contract Marblef1{
    ...
    constructor(address payable _ecoSystemAddress, uint256 _ecoSystemFeePercentage, address _tokenAddress){
        ...
        minTokenAmount = 0;
        pause = false;
        intervalSeconds = 20*60; //racetime+5mins
        bufferSeconds = 60*60; //racetime+10mins
        currentRace = 0;
    }
    ...
    function setIntialValues(uint256 _intervalSeconds, uint256 _bufferSeconds) public onlyOperator {
    ...
    function newRace(uint256[] memory _marbleIds, uint256 _raceTime) public whenNotPaused onlyAdminOrOperator {
        ...
        races[currentRace] = Race(_distinctMarbleIds, false, _raceTime, _raceTime + intervalSeconds, _raceTime + bufferSeconds, bets, -1, 0, false);
