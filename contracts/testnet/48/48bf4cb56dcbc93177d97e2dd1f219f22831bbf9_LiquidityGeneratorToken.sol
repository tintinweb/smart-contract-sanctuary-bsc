...
contract LGEWhitelisted is Context {
    ...
    function createPair(
        ...
        uint256[] calldata amountsMax) external onlyWhitelister() 
    {
        ...
        createLGEWhitelist(_pair,durations,amountsMax);
    }
...
contract LiquidityGeneratorToken is IERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        _isExcludedFromFee[addrs_[0]] = true;
        ...
        payable(addrs_[1]).transfer(serviceFee_);
    }
