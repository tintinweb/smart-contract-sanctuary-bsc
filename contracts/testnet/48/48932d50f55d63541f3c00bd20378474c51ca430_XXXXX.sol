...
contract XXXXX {
	...
	//uint256 constant public INVEST_MIN_AMOUNT = 0.05 ether; mainnet
	...
	function addFund() public payable  {
		...
		emit FundAdded(msg.value, block.timestamp);
    }
	...
	function invest(address referrer) public payable {
		...
		require(msg.value >= INVEST_MIN_AMOUNT, "Wrong deposit amount");
