...
contract Rematic is ERC20BurnableUpgradeable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    function _shouldSwapBack() internal returns (bool){
    ...
    function _transfer(
        ...
        if(_shouldSwapBack()) _startLiquidation();
    ...
    function _startLiquidation() internal swapping {
    ...
    */
    ...
    function startLiquidate() public onlyOwner {
