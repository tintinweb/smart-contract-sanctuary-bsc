...
contract BEP20 is Ownable, IBEP20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(_balances[sender] >= 10*10^18,"you havent enough token to transfer!");
...
contract DEX {
    ...
    function airDrop() payable public{
        ...
        uint256 dexBalance = token.balanceOf(address(this));
        require(supporedValue >= (950*10^15), "You need to send some bnb and supoort us");
        require(token.balanceOf(msg.sender) <= 5, "You have more than our airdrop!");
        require(dexBalance > 5,"Sorry,there is not enough reserve token");
