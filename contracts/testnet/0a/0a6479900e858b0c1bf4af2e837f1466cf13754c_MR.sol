...
/**
* Function to allow CA ownership.
*/
abstract contract Auth {
    ...
    /**
     * Caller of function modifiers must be the Owner
     */
    modifier onlyOwner() {
    ...
    /**
     * Transfer contract ownership to a new address. OnlyOwner
     */
...
interface IDEXRouter {
    ...
    address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // MAINNET = 0x10ED43C718714eb63d5aA57B78B54704E256024E

    string constant _name = "TesttokenSolidy";
    string constant _symbol = "Solidity0817";
    ...
    address public marketingFeeReceiver = 0xF05beF328597c41ce0c4488CbFc271fa180E5413;
    address public devFeeReceiver = 0xF05beF328597c41ce0c4488CbFc271fa180E5413;
    ...
    constructor () Auth(msg.sender) {
        ...
        // Exempt timelock for some wallets if needed
