...
contract TestBUSD is ERC20,AccessControl{
    ...
    modifier perDayLimit(){
        require(block.timestamp > UserTimestamp[msg.sender] + 5 minutes );
        _;
        UserTimestamp[msg.sender] = block.timestamp;
    }
    modifier perDayLimitBNB(){
        require(block.timestamp > UserTimestampBNB[msg.sender] + 5 minutes );
        _;
    ...
    function receiveBNB() public perDayLimitBNB{
