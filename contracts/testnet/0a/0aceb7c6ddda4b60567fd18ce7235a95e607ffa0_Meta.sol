...
contract Meta is Context, IERC20, Ownable {
    ...
    string private _name = "QC";
    string private _symbol = "QC";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x8F35FF21e2e0100e674fB9187cCE1b51fAAD1bFc);
    address payable public teamWalletAddress = payable(0xC0294901C4AFf3328594EaBF1E41dc423e604722);
