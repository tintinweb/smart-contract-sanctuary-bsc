...
contract Sonlar is ERC20, Ownable {
    ...
    {   
        ...
        mXWalletTokens = totalSupply() / 100;
    }
    ...
    function _transfer(
        ...
        bool canSwap = contractTokenBalance >= swapTokensAtAmount && contractTokenBalance <= mXWalletTokens;
    ...
    function setmXWalletTokens(uint256 newAmount) external onlyOwner{
        require(newAmount < totalSupply() / 100, "mXWalletTokens must be less than 1% of the total supply.");
        mXWalletTokens = newAmount;
    }
}