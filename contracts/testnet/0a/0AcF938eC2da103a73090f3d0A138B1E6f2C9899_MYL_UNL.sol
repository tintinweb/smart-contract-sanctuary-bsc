...
contract MYL_UNL is MYL_LottoInterface {
    ...
    uint256 private _tokenReward=10;          
    ...
    */
    function setGovementWallet(address _wallet) public onlyOwner returns(bool){
    ...
    */
    function getGovementWallet() public view returns(address){
