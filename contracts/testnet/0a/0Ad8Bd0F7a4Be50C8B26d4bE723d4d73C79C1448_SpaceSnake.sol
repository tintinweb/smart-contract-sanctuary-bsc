...
contract SpaceSnake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SpaceSnake";
    string constant _symbol = "$SSNAKE";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1_000_000_000_000 * (10**_decimals);
    uint256 public _maxTxAmount = _totalSupply.mul(1).div(100);
    uint256 public _maxWalletHoldingAmount = _totalSupply.mul(1).div(100);
    ...
    uint256 internal reflectionFee = 2;
    ...
    address public MarketingFeeReceiver =
        0x19cD8a5d5a55ff3B3667A105752b70E24cc716c8;
    ...
    function _transferFrom(
        ...
        if (!authorizations[sender]) {
            require(tradingStatus, "tradingStatus is off");
        }
        if (inSwap) {
