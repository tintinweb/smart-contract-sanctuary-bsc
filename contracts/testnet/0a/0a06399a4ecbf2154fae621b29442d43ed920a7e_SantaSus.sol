...
/*
    ...
    |  $$$$$$  |____  $$| $$__  $$|_  $$_/   |____  $$      |  $$$$$$ | $$  | $$ /$$_____/
     ...
     /$$  \ $$ /$$__  $$| $$  | $$  | $$ /$$ /$$__  $$       /$$  \ $$| $$  | $$ \____  $$
    |  $$$$$$/|  $$$$$$$| $$  | $$  |  $$$$/|  $$$$$$$      |  $$$$$$/|  $$$$$$/ /$$$$$$$/
     \______/  \_______/|__/  |__/   \___/   \_______/       \______/  \______/ |_______/ 

TG: https://t.me/SUSpriseLaunch
*/                                                                                       
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xF182182C0Fc1bfA1d9DAF29C67d95CD3c6861409);
...
contract SantaSus is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV  = 0x1aE329F3a761b1a0346e2C2C82628B105f566a33;

    string constant _name = "SANTA SUS";
    string constant _symbol = "SS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 11 * 10**5 * 10**_decimals;

    uint256 public _maxTxAmount = _totalSupply;
    uint256 public _maxWalletToken = _totalSupply;

    bool public ItsXmasTime = false;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(ItsXmasTime,"Not yet, you degen!");
        }

        
        // Blacklist
        if(blacklistMode){
            require(!isBlacklisted[sender] && !isBlacklisted[recipient],"Not today!");    
        }
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != devFeeReceiver  && recipient != autoLiquidityReceiver){
            ...
            require((heldTokens + amount) <= _maxWalletToken,"Let's not get greedy!");}
        
        if (sender == pair &&
            buyCooldownEnabled &&
            !isTimelockExempt[recipient]) {
            require(cooldownTimer[recipient] < block.timestamp,"You're going to fast! Please wait for 1min between two buys");
    ...
    // Xmas Fun
    function LetXmasBegin(bool _status) public onlyOwner {
        ItsXmasTime = _status;
    }
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _feeDenominator, uint256 _devFee) external authorized {
