...
contract ENE is Context, ERC20, Ownable {
   ...
   ENEDividendTracker public dividendTracker;
    ...
    constructor() ERC20 ("Elons Naughty Elves", "ENE") {
        _buyRewardsFee = 2;
        _buyLiquidityFee = 2;
        _buyMarketingFee = 1;
        _buyDevFee = 1;
        ...
        contractTokenBalanceAmount = 420000000 * 10**18;
       
        swapTokensAtAmount = 42000000 * (10**18);
        _maxWallet = 8400000 * (10**18);
        _maxBuy = 4200000 * (10**18);
        _maxSell = 4200000 * (10**18);
    ...
    function letsGoLive() external onlyOwner() {
        updateBuyFees(2,2,1,1);
        updateSellFees(4,3,4,4);
 
        updateMaxWallet(8400000);
        updateMaxBuySell(4200000, 4200000);
