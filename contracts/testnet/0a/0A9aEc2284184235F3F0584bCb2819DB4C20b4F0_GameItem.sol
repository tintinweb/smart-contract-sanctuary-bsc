...
contract GameItem is ERC721URIStorage, Ownable {
  ...
  //  }
    ...
    function safeMint(address to) public payable {
        require(msg.value >= 100*minRate, "Not enough ETH sent; check price!"); 
        _tokenIds.increment();
        _safeMint(to,_tokenIds.current());
    }
    
    function safeMintGivenValue(address to) public payable {
        require(msg.value >= minRate, "Not enough ETH sent; check price!"); 
        _tokenIds.increment();
        _safeMint(to,_tokenIds.current());
    }
