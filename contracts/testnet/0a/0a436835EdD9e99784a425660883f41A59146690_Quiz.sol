...
contract Quiz is ERC721URIStorage, Ownable {
    ...
    function createQuizRoom (uint256 _roomId, uint256 _quizID, uint256 _nftID, uint256 _oddsType, uint256 _maxRoomNumber, uint256 _roomTax, uint256 _minUserJoinAmount) public {
        ...
        require(_roomTax <= 60, "Room Tax exceeds the limit");
    ...
    function userWithdrawal (address _address, uint256[] memory _indexList) public {
        ...
        for (uint256 _index = 0; _index < _indexList.length; _index = _index + 1) {
            ...
            if (quizList[_quizID].result == userRecordList[_address][_recordIndex].result) {
                ...
                uint256 _platformAmount =  _winAmount / 1000 * platformTax;
                platformAmount = platformAmount + _platformAmount;

                _totalAmount = _totalAmount + _amount + _winAmount - _roomAmount - _platformAmount;
            }
        }
