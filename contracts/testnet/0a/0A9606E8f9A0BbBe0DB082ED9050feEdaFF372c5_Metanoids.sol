...
contract Metanoids is ERC721Base, ERC721Reservable, ERC721Whitelist, GallerLaunchpad, ReentrancyGuard {
    ...
    constructor(
        ...
        GallerLaunchpad(_launchpad, _launchpadMaxSupply)
    {
    ...
    function _mintTo(address _to, uint256 _amount) internal override(ERC721Reservable, GallerLaunchpad) nonReentrant {
        require(mintActive || msg.sender == owner(), "Mint not started yet");
        require(_amount > 0 && _amount <= maxMintPerTx, "Invalid amount");
        require((totalSupply() + _amount + reservedOpen + _launchpadSupplyOpen()) <= maxSupply, "Exceeds maxSupply");
