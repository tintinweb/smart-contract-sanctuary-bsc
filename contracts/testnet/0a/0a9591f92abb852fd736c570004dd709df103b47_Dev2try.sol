...
abstract contract Auth {
    ...
    function _msgSender() internal view returns (address payable) { //en raktam be!!!!!!!!!!!!!!!!!
    return msg.sender;
    }
...
contract Dev2try is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Dev2try";
    string constant _symbol = "D2T";
