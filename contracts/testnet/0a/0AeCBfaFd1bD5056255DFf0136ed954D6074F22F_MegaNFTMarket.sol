...
// File: contracts/TreasuryNode.sol
...
// File: contracts/NFTMarketAuction.sol
...
// File: @manifoldxyz/royalty-registry-solidity/contracts/IRoyaltyRegistry.sol
...
// File: contracts/NFTMarketCore.sol
...
// File: contracts/SendValueWithFallbackWithdraw.sol
...
// File: contracts/OZ/ERC165Checker.sol
...
// File: contracts/NFTMarketFees.sol
...
abstract contract NFTMarketFees is TreasuryNode, SendValueWithFallbackWithdraw {
  ...
  function _distributeProtocolFees(
    ...
    if (buyReferrer != address(0) && buyReferrer != msg.sender && buyReferrer != seller && buyReferrer != creator) {
      ...
      unchecked {
        ...
        // Fallsback to sending the referral fee to  on failure.
   ...
   * @return protocolFee How much will be sent to the  treasury.
...
// File: contracts/NFTMarketBuyPrice.sol
...
// File: contracts/NFTMarketOffer.sol
...
// File: contracts/NFTMarketPrivateSaleGap.sol
...
// File: contracts/NFTMarketReserveAuction.sol
 ...
 * @dev All sales in the  market will pay the creator 10% royalties on secondary sales. This is not specific
