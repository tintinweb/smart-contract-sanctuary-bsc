...
Welcome to Baby Cards of BSC (babyCOB)!

- Taxes -
Buy % Sell: 10%
Slippage: 12-15%
Split: 2% LP, 3% Marketing/Dev, 5% COB Rewards

- Tokenomics - 
Total Supply: 1 Billion BabyCOB
Locked up for 4 Years: 200 Million BabyCOB 
Reserved for Staking: 100 Million BabyCOB
Initial Liquidity: 700 Million BabyCOB + 1 BNB
Max Wallet: 0.5% at Launch, 1% after 30 Minutes, 2% after 12 Hours

- Reward Token -
You receive Cards of BSC (COB) Tokens for holding BabyCOB!
Contract: 0x4312b655c6de6ea86b8159d16fcadf5b937a6721

Telegram: https://t.me/BabyCoB_official
...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20  COB = IBEP20(0x4312b655c6de6eA86b8159D16FcAdF5B937a6721);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = COB.balanceOf(address(this));
        ...
        uint256 amount = COB.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            COB.transfer(shareholder, amount);
...
/* Token contract */
contract BabyCardsOfBSC is IBEP20, Auth {
    using SafeMath for uint256;

    // Addresses
    address COB = 0x4312b655c6de6eA86b8159D16FcAdF5B937a6721; 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xB2C5a1E638c59e4A76BFDee17B5169f8036cC940;
    ...
    // Name and symbol
    string constant _name = "Baby Cards of BSC";
    string constant _symbol = "Baby COB";
