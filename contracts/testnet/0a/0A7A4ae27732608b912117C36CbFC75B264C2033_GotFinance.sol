...
contract GotFinance is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Got Finance", "GFN", uint8(DECIMALS)) Ownable() {

        // router = IPancakeSwapRouter(0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc);
