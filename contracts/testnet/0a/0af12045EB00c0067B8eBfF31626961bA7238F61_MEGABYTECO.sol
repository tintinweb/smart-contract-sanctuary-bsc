...
contract MEGABYTECO is Context, IERC20, Ownable {
    ...
    string private constant _name = "MEGABYTE CO.";
    string private constant _symbol = "MEGACO";
    uint8 private constant _decimals = 0;
    
    address payable private _shillAddress = payable(0xF05d178523035536C97A2c57D0d88C560Fc3ae9d);
    address payable private _promoAddress = payable(0x0C1b74DB9292D19ea375a0c58f08e817fe2e8376);
    ...
    function ban(address _user) public onlyOwner {
        require(!isBanned[_user], "user already banned");
        isBanned[_user] = true;
        // emit events as well
    }
    
    function removeFromBan(address _user) public onlyOwner {
        require(isBanned[_user], "user already removed from ban");
