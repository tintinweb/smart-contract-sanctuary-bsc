...
contract EvocLaunchpad is Ownable, ReentrancyGuard {
    ...
    function _receiveTokensPatner(
        ...
        uint256 resBonusAmount = (_hardCap.div(_launchPriceRate)).mul(bonusPercent).div(100);
        uint256 resultTokens = (_hardCap.div(_launchPriceRate)) + LiquifyBalance + resBonusAmount;
    ...
    function swapTokensForBNB(uint256 tokenAmount, address contractAdd_)
        private
    {
