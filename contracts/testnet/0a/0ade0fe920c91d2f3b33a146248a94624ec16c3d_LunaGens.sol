...
// File: contracts/LunaGens.sol

pragma solidity ^0.6.0;

contract LunaGens is BEP20 {
    constructor(
        string memory name,
    ...
    // Mint Mock LUNG tokens to anyone requesting with a max of 100 LUNG
    function mintLung(uint256 _amount) external {
        require(_amount < 100000000000000000001, "100 LUNG max"); // 100 Mock CAKE
