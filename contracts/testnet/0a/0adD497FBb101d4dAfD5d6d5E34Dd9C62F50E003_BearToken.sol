...
contract BearToken is Context, IERC20, Ownable {
    ...
    constructor (address tokenOwner,string memory tokenName,
        ...
        _maxTxAmount = _tTotal.mul(setMxTxPer).div(  //max amount of tokens someone can send, 1%
            10**2
        );
         emit maxTxAmountUpdate(_maxTxAmount);  
        _maxWalletAmount = _tTotal.mul(setMxWalletPer).div(   //max amount of tokens someone can hold, 1%
            10**2
