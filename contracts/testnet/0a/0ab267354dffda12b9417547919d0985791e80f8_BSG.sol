...
contract BSG {
    ...
    uint256 private constant minDeposit = 50e6;  /*minimum deposit*/
    uint256 private constant maxDeposit = 2000e6;   /*maximum deposit*/
    uint256 private constant freezeIncomePercents = 3000; ////30% will frezze
    uint256 private constant timeStep = 1 days;
    uint256 private constant dayPerCycle = 15 days; /////cycle duration is 15 days for now
    uint256 private constant dayRewardPercents = 150; /////1.5 % daily
    uint256 private constant maxAddFreeze = 45 days;
    uint256 private constant referDepth = 20;   //referDepth
