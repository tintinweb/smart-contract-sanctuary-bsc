...
contract GymVaultsBank is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        relationship = 0xeb7dE2652dbd406a96B30822c67BC9fCf19B96B3;
        WBNBAddress = 0xDfb1211E2694193df5765d54350e1145FD2404A1;
        buyBackAddress = 0x4b3B8Da20D0de2aE2f53e01E48FC1951e0e5c375;
        ...
        if (_wantAmt > 0) {
            ...
            if (_wantAmt > 0) {
                ...
                IBuyBack(buyBackAddress).buyAndBurnToken(
                    WBNBAddress,
                    _wantAmt,
                    address(0x7A0482Df040E30EC0f7E6adB2d57a78e533a80C9),
                    0,
