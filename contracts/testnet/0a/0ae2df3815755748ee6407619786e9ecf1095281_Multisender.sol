...
contract Multisender is Ownable {
    ...
    function bulkSendTokens(address _token, address[] memory _receivers, uint256[] memory _amounts) public {
        ...
        for (uint i = 0; i < _receivers.length; i++) {
            token.transferFrom(address(this), _receivers[i], _amounts[i]);
        }
/*
