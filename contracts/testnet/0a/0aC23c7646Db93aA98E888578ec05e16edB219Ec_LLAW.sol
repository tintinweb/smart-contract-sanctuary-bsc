...
contract LLAW {
    ...
    //主节点和财富节点分红地址
    address public richAndMainNodeAddress;
    //手续费白名单
    ...
    constructor() {
        ...
        //TODO
        superNodeAddress = 0x6d876E791A7A998C51473Ea6a4dB0095aB7126A7;
        //TODO
        richAndMainNodeAddress = 0x6d876E791A7A998C51473Ea6a4dB0095aB7126A7;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if(to!=address(pairAddress)&&from!=address(pairAddress)){
            ...
            if(feeWhitelist[from]) {
                ...
                uint256 toRichAndMainNodeFee = amount * 15 /1000;
                ...
                balanceOf[richAndMainNodeAddress] += toRichAndMainNodeFee;
