...
contract BABYSIFU is IBEP20, Auth {
    ...
    */
    ...
    require(_interestRate > 0, "You can't invest now. No interestRate is available for the investment plan");
    ...
    function getInvestment() public view returns(InvestType[] memory){
