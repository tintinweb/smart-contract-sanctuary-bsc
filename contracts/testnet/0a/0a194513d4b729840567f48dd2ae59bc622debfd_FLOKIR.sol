...
╚═╝     ╚══════╝ ╚═════╝ ╚═╝  ╚═╝╚═╝    ╚═╝  ╚═╝╚══════╝ ╚══╝╚══╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ ╚══════╝
 ...
 Floki Rewards Token . Extreme  Rewards.
*/
...
contract FLOKIR is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Floki Rewards";
    string constant _symbol = "$FLOKIR";
    ...
    uint256 _totalSupply = 10000000000000 * 10**9;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x6C6e8ea1e9040A168D7A05449aea4354fD310996;
        buybackWallet = 0x6C6e8ea1e9040A168D7A05449aea4354fD310996;
