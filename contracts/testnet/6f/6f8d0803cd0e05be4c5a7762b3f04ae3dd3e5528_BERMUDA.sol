...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
    ...
    address public immutable RWRD = address(0xf48B5cABA0B7720E7E1F9834A51c82E739A6C045);
...
contract BERMUDA is IERC20Metadata, Ownable {
    ...
    address public immutable RWRD = address(0xf48B5cABA0B7720E7E1F9834A51c82E739A6C045); // Reward Token
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBInsurance  = amountBNB.mul(insuranceFee).sub(amountBNBReflection).sub(amountBNBMarketing).sub(amountBNBLiquidity);
