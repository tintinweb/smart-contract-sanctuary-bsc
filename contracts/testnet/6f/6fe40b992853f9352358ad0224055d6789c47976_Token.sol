...
// File @openzeppelin/contracts-upgradeable/utils/introspection/IERC16[email protected]
...
contract WhitelistRoleUpgradeable is Initializable, ContextUpgradeable, AccessControlUpgradeable {
	...
	function __WhitelistRole_init() public onlyInitializing {
	...
	modifier onlyWhitelist() {
		require(hasRole(WHITELIST_ROLE, _msgSender()), "WhitelistRole: Caller is not a whitelist role");
		_;
	}
