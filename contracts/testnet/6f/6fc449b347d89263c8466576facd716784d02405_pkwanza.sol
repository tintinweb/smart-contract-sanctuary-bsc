...
Tokenomics:  
        Total Fees: 0.50%   
        --->Holders Rewards: 0.30%  
        -->Marketing & development: 0.20000%   
*/
 ...
 */
abstract contract RGBEP20 is Context, IBEP20, Ownable {
    ...
    uint256 public constant _maxSupply = 10 * 10**12 * 10**18;
   ...
   // Burn address
    ...
    address public marketingWallet = 0x7aDC74122cfFFd75c61A7ED6967adc7E331F4b31;
    uint256 private _previousmarketingFee = _marketingFee;

    uint256 public transferFeeRate = _taxFee + _marketingFee;
    
    event OperatorTransferred(address indexed previousOperator, address indexed newOperator);

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10 * 10**12 * 10**18; // 10 Trillion
  ...
  //  event sendViaCall(address indexed to, uint256 amount);
    ...
    constructor(string memory name, string memory symbol) public {
        ...
        _rOwned[marketingWallet] = _rTotal;

        _excludedFromAntiWhale[marketingWallet] = true;
   ...
   function name() public view override returns (string memory) {
    ...
    //Burn Tokens that are stuck in contract
    ...
    */
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax, dev/mkt
...
// token with Governance and reflect fees.
contract pkwanza is RGBEP20('PKWANZA', 'PKWZ') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "PKWANZA::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "PKWANZA::delegateBySig: invalid nonce");
        require(now <= expiry, "PKWANZA::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "PKWANZA::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying PKWANZAs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "PKWANZA::_writeCheckpoint: block number exceeds 32 bits");
