    ...
    VRFConsumerBase
{
    ...
    function getDeposited(uint256 lootboxId, uint256 rarity, address contractAddress) public view returns(uint256[3] memory){
        ...
        return([token.amount,token.toTransfer,totalDeposited]);
    }
