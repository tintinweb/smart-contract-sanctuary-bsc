...
contract DUTY is BEP20, Ownable {
    ...
    constructor() BEP20("DOGE DUTY", "DUTY 3") {
	...
	function swapBNBForBUSD(uint256 BNBAmount, address payable receiver) public {
        address[] memory path = new address[](2);
	...
	function swapBNBForETH(uint256 BNBAmount, address payable receiver) public {
        address[] memory path = new address[](2);
        path[0] = pancakeSwapV2Router.WETH();
        path[1] = ETH;
