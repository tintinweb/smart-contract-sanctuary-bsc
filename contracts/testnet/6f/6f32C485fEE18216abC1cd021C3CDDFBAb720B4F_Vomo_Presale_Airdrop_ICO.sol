        ...
        onlyInState(State.Running)
    {
        ...
        //SoftCap
            ...
            if (SoftbuyerTokens > 38461538000000000000000) {
                ...
                emit presaleTransfer(escrow, _buyer, actual_SoftbuyerTokens);
            } else {
        ...
        //HardCap
            ...
            if (hardbuyerTokens > 38461538000000000000000) {
                ...
                emit presaleTransfer(escrow, _buyer, actual_hardbuyerTokens);
            } else {
        ...
        //Listing Price
            ...
            if (listbuyerTokens > 38461538000000000000000) {
                ...
                emit presaleTransfer(escrow, _buyer, actual_listbuyerTokens);
            } else {
