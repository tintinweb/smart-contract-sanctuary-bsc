...
contract NFTAirdrop is Ownable {
    ...
    function verify(
        ...
        if (!isFromAdmin) isPermittedUser = false;
        else isPermittedUser = msg.sender == _to;
        ...
        console.log("Airdrop - verify() - isAuthenticUser: ", isAuthenticUser);
        console.log("Airdrop - verify() - isPermittedUser: ", isPermittedUser);

        return isFromAdmin && isAuthenticUser && isPermittedUser;
    }
