...
contract GovSaleRemote is
    ...
    // TESTING
    uint128 internal remoteRaisedC;
    uint128 internal remoteRevenueC;
    uint128 internal remoteSoldC;
    address[] internal remoteUsersC;
    uint128[] internal remoteUsersBoughtC;
    uint128[] internal remoteUsersReceivedC;
    uint128[] internal remoteUsersFeeC;
