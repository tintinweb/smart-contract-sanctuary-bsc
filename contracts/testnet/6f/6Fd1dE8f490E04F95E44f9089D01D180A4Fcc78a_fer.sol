...
contract fer is IBEP20, Auth {
    ...
    string constant _name = "Fer token";
    string constant _symbol = "FER";
    ...
    function swapBack() internal swapping {
        ...
        require(tmpSuccess, " Marketing receiver rejected ETH transfer");
        (tmpSuccess,) = payable(ecosystemfeeReceiver).call{value: amountBNBDev, gas: 30000}("");
        require(tmpSuccess, " Dev receiver rejected ETH transfer");
