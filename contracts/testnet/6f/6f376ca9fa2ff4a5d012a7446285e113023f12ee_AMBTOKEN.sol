...
contract AMBTOKEN is ERC20, Ownable {
    ...
    address public feeWallet = payable(0x0B47E6574084b3dC5337B3944E9e1a6a055e8125);
    ...
    constructor() ERC20("Ambrionic Token ", "AMBToken ") {
        ...
        maxTransactionAmount = totalSupply.mul(1).div(100);   // 1% maxTransactionAmountTxn
        maxWallet = totalSupply.mul(3).div(100);              // 3% maxWallet
        swapTokensAtAmount = totalSupply.mul(5).div(10000);   // 0.05% swap wallet
    ...
    function swapBack() private {
        ...
        super._transfer(address(this), feeWallet ,_tokensForDev);
