...
contract TestERC20 is Context, IERC20, Pausable, Ownable, ReentrancyGuard {
    ...
    function calculateTax(uint256 _amount) internal virtual returns (uint256) {
         return (_amount * taxFee) / 10**3;
    }

    function updateTaxFee(uint256 _fee) external {
        taxFee = _fee;
    }
