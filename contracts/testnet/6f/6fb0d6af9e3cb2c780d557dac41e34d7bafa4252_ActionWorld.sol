...
contract ActionWorld {
    ...
    function withdrawal() external {
        ...
        uint256 actualAmountToSend = TotalBonus.sub(_fees).sub(poolAmount);
        ...
        t.transferFrom(address(this),msg.sender, actualAmountToSend.mul(withdrwal).div(100));
        t.transferFrom(address(this),admin2, _fees);
