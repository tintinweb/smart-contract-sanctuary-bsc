    ...
    StakingTierModels
{
    ...
    ProjectInfo public _projectInfo;
    ...
    uint16 constant EMERGENCY_WITHDRAW_FEE = 1500;
    ...
    constructor(
        ...
        require(
            ...
            "LaunchPad: invalid unsold token action"
        );
        require(
            poolInfo_.registerRound.startAt > block.timestamp,
            "LaunchPad: invalid register time"
        );
        require(
        ...
        require(
            ...
            "LaunchPad: invalid tier round time"
        );
        require(
        ...
        require(
            ...
            "LaunchPad: invalid community round time"
        );
        require(
        ...
        require(
            ...
            "LaunchPad: softcap and hardcap invalid"
        );
        require(
            poolInfo_.softCap < poolInfo_.hardCap,
            "LaunchPad: softcap must be less than hard cap"
        );
        require(poolInfo_.salePrice > 0, "LaunchPad: invalid sale price");
        require(
    ...
    function updateSaleType(SaleType _saleType)
        ...
        onlyManagerOrOwner
    {
        require(_status == Statuses.COMMING, "LaunchPad: pool is started");
    ...
    function collectToken() external virtual override onlyOwner {
        ...
        require(amount > 0, "LaunchPad: balance is zero");
        ...
        onlyRegistered
    {
        ...
        if (_depAmounts[user].commnunity <= 0) {
            _communityRoundParticipants += 1;
        }
        _depAmounts[user].commnunity += amount;
        _totalRaised += amount;
        _communityRoundRaised += amount;
    ...
    function claim(uint8 _index) external virtual override {
        ...
        require(depAmt > 0, "LaunchPad: did not buy");
        require(
        ...
        require(
            ...
            "LaunchPad: it is not time to claim"
        );
    ...
    function _calAlloc(address user_) internal view returns (uint256) {
        ...
        uint256 alloc = _registers[user_].slot * _baseAlloc();
        return alloc;
    }
    ...
    function _depositedAmount(address user_) internal view returns (uint256) {
        return _depAmounts[user_].tier + _depAmounts[user_].commnunity;
    }
    ...
    modifier onlyRegistered() {
        require(
            _registers[_msgSender()].timestamp > 0,
...
contract Whitelist is Permissionable {
    ...
    function enableWhitelist(bool newValue) public onlyManagerOrOwner {
        _enableWhitelist(newValue);
    }

    function _enableWhitelist(bool newValue) internal {
        enabled = newValue;
    }
