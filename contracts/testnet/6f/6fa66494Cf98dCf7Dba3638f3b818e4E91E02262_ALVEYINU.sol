...
/**
  ...
  Bullion Pay [SNCK]
  Decentralized Swap Exchange is a Finance project created to launch Farm infrastructures,
  DApp programs. It aims to be one of the leading DEFi projects thanks to its new generation
  features. Users can borrow for peer-to-peer farms or take out a Bullion Pay loan.
  It provides high profit returns for high leverage farms.
  www.bullionpay.finance
...
contract ALVEYINU is Context, IERC20, Ownable {
    ...
    address public teamWallet = 0xA3b4288328A4A6a0d5e02F1174B34F060FbA5011;
