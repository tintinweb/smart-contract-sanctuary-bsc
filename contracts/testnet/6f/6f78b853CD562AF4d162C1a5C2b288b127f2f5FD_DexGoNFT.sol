...
contract DexGoNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    mapping(uint8 => string) imageForType;
    function setImageForType(string memory _imageForType, uint8 typeNft) public onlyOwner {
        imageForType[typeNft] = _imageForType;
    }
    ...
    constructor(uint256 networkId, address _gameServer) ERC721("dexGoNFT", "DEXGO") {
        ...
        setupType(SHOES0, 0.01 ether, 0, "Downtrodden nerds", "10 km", "https://openbisea.mypinata.cloud/ipfs/QmVww6AoULsNxeMfQeyXfk6EN7syspR285MbiqqMdU1Vob/Shoes1.gif");
        setupType(SHOES1, 0.011 ether, 0, "Inconspicuous walkers", "11 km", "https://openbisea.mypinata.cloud/ipfs/QmVww6AoULsNxeMfQeyXfk6EN7syspR285MbiqqMdU1Vob/Shoes2.gif");
        setupType(SHOES2, 0.012 ether, 0, "High runners", "12 km", "https://openbisea.mypinata.cloud/ipfs/QmVww6AoULsNxeMfQeyXfk6EN7syspR285MbiqqMdU1Vob/Shoes3.gif");
        setupType(SHOES3, 0.013 ether, 0, "Pink walkers", "13 km", "https://openbisea.mypinata.cloud/ipfs/QmVww6AoULsNxeMfQeyXfk6EN7syspR285MbiqqMdU1Vob/Shoes4.gif");
        setupType(SHOES4, 0.014 ether, 0, "White boosters", "14 km", "https://openbisea.mypinata.cloud/ipfs/QmVww6AoULsNxeMfQeyXfk6EN7syspR285MbiqqMdU1Vob/Shoes5.gif");
        setupType(SHOES5, 0.015 ether, 0, "Rushing forward", "15 km", "https://openbisea.mypinata.cloud/ipfs/QmVww6AoULsNxeMfQeyXfk6EN7syspR285MbiqqMdU1Vob/Shoes6.gif");
        setupType(SHOES6, 0.016 ether, 0, "Elegant Winners", "16 km", "https://openbisea.mypinata.cloud/ipfs/QmVww6AoULsNxeMfQeyXfk6EN7syspR285MbiqqMdU1Vob/Shoes7.gif");
        setupType(SHOES7, 0.017 ether, 0, "Robots", "17 km", "https://openbisea.mypinata.cloud/ipfs/QmVww6AoULsNxeMfQeyXfk6EN7syspR285MbiqqMdU1Vob/Shoes8.gif");
        setupType(SHOES8, 0.018 ether, 0, "Hidden pioneers", "18 km", "https://openbisea.mypinata.cloud/ipfs/QmVww6AoULsNxeMfQeyXfk6EN7syspR285MbiqqMdU1Vob/Shoes9.gif");
        setupType(SHOES9, 0.019 ether, 0, "Top Talkers", "19 km", "https://openbisea.mypinata.cloud/ipfs/QmVww6AoULsNxeMfQeyXfk6EN7syspR285MbiqqMdU1Vob/Shoes10.gif");
        setupType(MAGIC_BOX, 0.013 ether, 0, "Magic Box", "? km", "https://openbisea.mypinata.cloud/ipfs/QmVww6AoULsNxeMfQeyXfk6EN7syspR285MbiqqMdU1Vob/MagicBox.gif");
    ...
    mapping(uint => bool) approvedPathOrMovie;
    ...
    function tokenURIForType(uint8 typeNft, string memory nameReplaced)
    public
    view
    ...
    returns (string memory)
    {
        ...
        if (tempEmptyStringTest.length == 0) {
            return tokenURIForType(typeForId[tokenId], namesChangedForNFT[tokenId]);
        }
    ...
    function repair(uint256 _tokenId, bool isSpeedUp) public payable {
        ...
        kmLeavesForId[_tokenId] = priceForType[typeForId[_tokenId]];
        latestPurchaseTime[msg.sender] = block.timestamp;
    }
