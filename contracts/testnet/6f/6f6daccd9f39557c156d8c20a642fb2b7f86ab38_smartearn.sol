...
contract smartearn{
    ...
    uint256 public REFERRAL = 160;//16% referral bonus
	...
	uint256 public COMPOUND_BONUS = 14; /** 1.4% **/
	uint256 public COMPOUND_BONUS_MAX_TIMES = 4; /** 4times / 4 days. **/
    uint256 public COMPOUND_STEP = 20 * 60 * 60; /** every 20 hours. **/
    ...
    function PUBLIC_EGGS() public {
        ...
        _safeTransferFrom(token_BUSD, PUBLIC, TREASURY, PUBLIC_AMOUNT);
    }
