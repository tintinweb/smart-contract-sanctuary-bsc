...
abstract  contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "NML: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(
            newOwner != address(0),
            "NML: new owner is the zero address"
        );
...
contract NORMAL is Context, IBEP20, Ownable {
    ...
    string private _name = "NORMAL COIN";
    string private _symbol = "NML";
    ...
    address public charityWallet = 0x6D2b556cA76a381d81D884C2DB2F85445751bac2;
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "NML: transfer amount exceeds allowance"
            )
        );
        return true;
    }
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "NML: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function excludeFromReward(address account) public onlyOwner {
        require(
            account != 0x6D2b556cA76a381d81D884C2DB2F85445751bac2,
    ...
    function _approve(
        ...
        require(owner != address(0), "NML: approve from the zero address");
        require(spender != address(0), "NML: approve to the zero address");
    ...
    function _transfer(
        ...
        require(from != address(0), "NML: transfer from the zero address");
        require(to != address(0), "NML: transfer to the zero address");
