...
interface IProtectToken {
    ...
    function checkSell(address sell) external view returns (bool _sell);
}
...
contract ProtectToken is IProtectToken, Ownable {
    ...
    function checkTransferToken(
        ...
        if(numberTransfer > maxNumberTransferToday || (partner && numberTransferTodayForPartner > maxNumberTransferTodayForPartner)){
            return false;
        }
        return true;
    }
    ...
    function checkSell(address sell) public override view returns (bool _sell){
