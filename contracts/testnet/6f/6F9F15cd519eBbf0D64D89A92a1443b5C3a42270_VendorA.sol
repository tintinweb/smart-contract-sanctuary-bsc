...
contract TAGEN is ERC20, ERC20Burnable {
    ...
    constructor() ERC20("Token A", "TAGEN") {
...
contract VendorA is ReentrancyGuard, Ownable, TestPayable {
        ...
        returns (uint256 tokenAmount)
    {
        ...
        /* TODO: Might be a logic-flaw, might be division instead of / check this. */
     ...
     */
    function sellTokens(uint256 tokenAmountToSell)
        public
        payable
        nonReentrant
        isUser
    ...
    function _withdrawBuy() public payable nonReentrant onlyOwner {
        uint256 fullBalance = address(this).balance;
        require(
            fullBalance > 0,
            "Vendor: Contract does not have balance to withdraw."
    ...
    /// @dev This function can not be called from outside,
    ///TODO: withdraw might require onlyOwner
    function _withdrawSell() public payable nonReentrant onlyOwner {
        uint256 fullBalance = address(this).balance;
        require(
            fullBalance > 0,
            "Vendor: Contract does not have balance to withdraw."
