...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Emet", "EMET") {
        ...
        address _owner = 0x18b5680dcaf35e9E01220458305560A695889f6E;
        ...
        marketingWallet = address(0x742ec0c95b342E90266d9d43898bD391b89Fb275); // set as marketing wallet
    	devWallet = address(0xdc08d511f260C485F61b5a8cbE386e42CE2d00d6); // set as dev wallet
    	charityWallet = address(0x83AD312E8691A96099a24fEe166363b451F6D23f); // set as charityWallet
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _charityFee) external isAuth {
        buyMarketingFee = _marketingFee;
        buyLiquidityFee = _liquidityFee;
        buyDevFee = _devFee;
        buyCharityFee = _charityFee;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee + buyCharityFee;
        require (_marketingFee >0 && _liquidityFee >0 && _devFee >0 && _charityFee >0);
        require(buyTotalFees <= 100, "Must keep fees at 10% or less");
    }
    
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee, uint256 _charityFee) external isAuth {
