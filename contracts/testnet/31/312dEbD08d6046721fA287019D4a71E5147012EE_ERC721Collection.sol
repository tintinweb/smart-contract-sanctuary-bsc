...
contract ERC721Collection is ERC721URIStorage, ERC721Enumerable, Ownable, ICollectionRoyalty721 {
    ...
    modifier ownerOnly(uint256 _id) {
        require(ownerOf(_id) == msg.sender, "ownersOnly");
        _;
    }

    modifier creatorOnly(uint256 _id) {
        require(creators[_id] == msg.sender, "creatorOnly");
        _;
    }
    ...
    function createAndSetRoyal(
        ...
        uint id = mintTo(_initialOwner, _uri);
        royalties[id] = _royalty;
        creators[id] = _initialOwner;
        return id;
    }
    ...
    returns (bool)
    {
        return interfaceId == type(ICollectionRoyalty721).interfaceId || super.supportsInterface(interfaceId);
    }
}
