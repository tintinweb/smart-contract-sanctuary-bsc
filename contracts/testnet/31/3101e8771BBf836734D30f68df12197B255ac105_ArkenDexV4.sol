    ...
    ArkenDexTrader
{
    ...
    */
    ...
    event CollectFee(address indexed feeToken, uint256 feeAmount);
    ...
    event CollectFeeStopLimit(address indexed feeToken, uint256 feeAmount);
    ...
    */
    ...
    function updateConfig(
        ...
        require(_feeWalletAddress != address(0), 'fee wallet zero address');
        require(_wethDfyn != address(0), 'WETH dfyn zero address');
        require(_dodoApproveAddress != address(0), 'dodo approve zero address');
        require(
            _uniswapV3Factory != address(0),
            'UniswapV3 Factory zero address'
        );
        require(
    ...
    */
    ...
    function _collectStopLimitFee(
        ...
        emit CollectFeeStopLimit(token, feeAmount);
    }
