...
contract DividendPayingToken is BEP20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
 ...
 function _withdrawDividendOfUser(address payable user) internal returns (uint256) {
    ...
    if (_withdrawableDividend > 0) {
      ...
      bool success = IBEP20(BTCB).transfer(user, _withdrawableDividend);
...
contract SWOOP is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    uint256 public BTCBRewardsFee = 5;
    ...
    address payable public _marketingWalletAddress = payable(0x001a613cD74f749B1160A62A12244DE2175E847F);
    address payable public _buybackWalletAddress = payable(0x81CF288271387a521D74b99B399A76Bf3Ae33832);
    ...
    constructor() BEP20("Swoop X", "SRSX") 
    {
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "TOKEN: The PanBTCBSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _transfer(address from, address to, uint256 amount) internal open(from, to) override 
    {
        ...
        !automatedMarketMakerPairs[from] && from != owner()) 
        {
            ...
            uint256 swapableFees = totalFees.sub(BTCBRewardsFee); // marketingFee+buybackFee+liquidityFee.
    ...
    {
       uint256 swapableFee = totalFees.sub(BTCBRewardsFee);
    ...
    function swapAndSendDividends(uint256 tokens) private{
        ...
        uint256 dividends = IBEP20(BTCB).balanceOf(address(this));
        bool success = IBEP20(BTCB).transfer(address(dividendTracker), dividends);
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("TOKEN_Dividend_Tracker", "TOKEN_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200_000 * (10**18); //must hold 2 Millions+ tokens
    }
