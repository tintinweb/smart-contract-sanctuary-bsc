...
https://t.me/PooChainPortal

PooChain is the OFFICIAL MEME TOKEN BLOCKCHAIN. This is a project that is created on the Binance Smart Chain which is formed to deliver a solid COMMUNITY to build around before MainNet goes live!! 

A Project fully backed by its Community, we believe in Unity.
...
contract MockPooChain  is IBEP20, Auth {
    using SafeMath for uint256;
    string private constant _name = 'MockPooChain';
    string private constant _symbol = 'MockPOOP';
