...
contract BridgePayV2 is Ownable, ReentrancyGuard, Pausable {
    ...
    address public taxAddress = 0x9936B2c4A817DbC0043293Ff63d7Cd25BFD6A57b;
    address public tokenAddress = 0xA6d416a7B0ad227a1c2475A7CD986E9BFc39B3C9;
    ...
    function sendToPartner(uint256 _amount, uint256 _iPartner) public {
        ...
        uint256 tax = _amount.mul(bridgePartnerTax).div(100);
