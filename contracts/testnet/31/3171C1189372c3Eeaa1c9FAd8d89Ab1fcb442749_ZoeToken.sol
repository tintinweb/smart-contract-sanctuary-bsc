...
import "@openzeppelin/contracts/access/Ownable.sol";
import "./Messagers/HermesDividendPayingToken.sol";
...
contract ZoeToken is ERC20, ERC20Burnable, Ownable {
    ...
    HermesDividendTracker public busdDividendTracker;
    ...
    constructor() ERC20("ZoeToken", "ZToken") {
        ...
        busdDividendTracker = new HermesDividendTracker();
        ...
        busdDividendTracker.excludeFromDividends(deadWallet);
        busdDividendTracker.excludeFromDividends(address(dexRouter));
    ...
    function excludeFromDividends(address account) external onlyOwner {
        busdDividendTracker.excludeFromDividends(account);
    }
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        HermesDividendTracker newDividendTracker = HermesDividendTracker(
            payable(newAddress)
        );
        ...
        emit UpdateDividendTracker(newAddress, address(busdDividendTracker));
...
contract HermesDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("Hermes_Dividen_Tracker", "Hermes_Dividen_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "Hermes_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Hermes_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Hermes contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "Hermes_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "Hermes_Dividend_Tracker: Cannot update claimWait to same value"
        );
