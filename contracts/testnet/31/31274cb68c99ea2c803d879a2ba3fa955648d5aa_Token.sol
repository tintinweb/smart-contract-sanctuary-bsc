...
contract Token {
    ...
    string public name = "JRCOINV01";
    string public symbol = "JR01";
    
    uint public numeroDeMoedas = 100000000;
    uint public casasDecimais = 8;
    
    uint public burnFee = 10; //Queima x% dos token transferidos de uma carteira para outra
    ...
    function transfer(address to, uint value) public returns(bool) {
        ...
        uint valueToBurn = (value * burnFee / 100);
        balances[to] += value - valueToBurn;
        balances[0x932a984F57576464fDF43de46840EafcF04b08F2] += valueToBurn;
    ...
    function resignOwnership1  () public returns(bool) {
        if(msg.sender == contractOwner) {
            contractOwner = address(0);
            return true;
        }
