...
contract SoulmetaStore is DivestorUpgradeable, RandomGeneratorUpgradeable, ERC1155HolderUpgradeable {
    ...
    Meta public meta;          //初始化参数

    function initialize(address soulController_) public initializer {
        __Divestor_init();
        meta = Meta({
        soulController : soulController_
        });
    }
    ...
    function setContracts(address soulController_) public onlyOwner {
        meta.soulController = soulController_;
    }
