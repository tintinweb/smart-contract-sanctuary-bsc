...
pragma solidity ^0.4.19;
    ...
    address private garbageAddress;  //20
    bool private gate1Unlocked;  //1
    uint16 private gateKey1;  //2        
    uint72 public rouletteStartTime;  // Constructor-set  //9

        //SLOT 1
    uint64 private gateKey2; //8
    uint64 private gateKey3; //8
    bool private gate2Unlocked;  //1
    uint64 private gateKey4; //8
    uint56 private gateKey5;  //7

        // SLOT 2
    uint256 private rouletteSecretNumber;
    uint256 private buffer1;
    uint256 private buffer2;
    uint256 private garbageDivisor; // garbageDivisor = 2**160-2**153
    uint256 private garbageMultiplier; // garbageMultiplier = 2**160-2**153;
    uint256 private masterDivisor; // masterDivisor = 60001;
    uint256 private masterMultiplier; //masterMultiplier = 60001;
    uint256 public masterNonce;
    uint256 public garbageNonce;
    uint72 private backupRouletteTIme; // Constructor-set
