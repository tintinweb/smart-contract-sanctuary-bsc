...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xb707972F7E904007e72fA25C973235cB21bB94BF;
...
contract WOM is Context, IERC20, Ownable {
    ...
    address public _operationsWalletAddress = 0xb9a638b9773F40cF5cfD1b15055c36F3Ce8f8aCB;
  

    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _liquidityFee = 0; // 1% buyback + 1% liquidity
    ...
    constructor() {
        _rOwned[0x75AbA5803779fF26F8DD4319dE4f158E248b16b5] = _rTotal;
       ...
       // address _uniswapV2RouterAddr=0x10ED43C718714eb63d5aA57B78B54704E256024E; //BNB
        ...
        emit Transfer(_blackholeZero, 0x75AbA5803779fF26F8DD4319dE4f158E248b16b5, _tTotal);
}
