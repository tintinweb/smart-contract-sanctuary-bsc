...
//MoonExchangeToken.sol
contract MoonExchangeToken is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    address private REWARD = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;



    string constant _name = "Moon Exchange Token";
    string constant _symbol = "M.E.T";
    ...
    address public marketingFeeReceiver = 0x6788270D249d534357594d78DE54CaF8a0f3128d;
    address public devFeeReceiver = 0x6788270D249d534357594d78DE54CaF8a0f3128d;
    ...
    function updateBuyFees(
        ...
        buyBNBRewardsFee = bnbreward;
        buyMarketingFee = marketing;
        buyLiquidityFee = liquidity;
        buyDevFee = dev;
        buyBurnFee = burn;
        buyTotalFees = bnbreward.add(marketing).add(liquidity).add(dev).add(burn);
    ...
    function updateSellFees(
        ...
        sellBNBRewardsFee = bnbreward;
        sellMarketingFee = marketing;
        sellLiquidityFee = liquidity;
        sellDevFee = dev;
        sellBurnFee = burn;
        sellTotalFees = bnbreward.add(marketing).add(liquidity).add(dev).add(burn);
