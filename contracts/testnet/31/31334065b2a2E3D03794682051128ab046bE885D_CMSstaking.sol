...
contract CMSstaking {
    ...
    ICMSsubscription public CMSsub;
    ...
    uint256[5] public Bonus = [330, 1000, 2000, 5000, 12500];
    ...
    constructor(
        ...
        owner = _owner;
        rewardToken = _token;
        isTokenValid[_token] = true;
        percentDivider = 10000;
        CMSsub = ICMSsubscription(_CMSsub);
    }
    ...
    function stake(
        ...
        require(isTokenValid[token], "Not a valid token");
        if (token != rewardToken) {
            require(CMSsub.isExpired(msg.sender), "Subscription expired");
        }
    ...
    function unstake(uint256 index) public {
        ...
        address _token = stakersRecord[msg.sender][index].token;
    ...
    function validateToken(address _token, bool _state) external onlyOwner {
        isTokenValid[_token] = _state;
    }
    ...
    function changeSubscriptionAddress(address _subscription) external onlyOwner {
        CMSsub = ICMSsubscription(_subscription);
    }
