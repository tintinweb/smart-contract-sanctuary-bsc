...
contract Dex is Ownable,ReentrancyGuard{
     ...
     uint256 public tokenPerEth = 100; // initial value defined for tokens per specific crypto
    ...
    // set the per token price ( only owner can change the tokenPerteth price )
    function setTokenPerEthPrice(uint _tokenPerEthPrice) onlyOwner public{
    ...
    // buy the tokens in exchange of ethers , our main payable function 
