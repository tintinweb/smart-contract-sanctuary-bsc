...
contract Token is Context, IERC20, Ownable {
    ...
    address public lpAddress =
        address(0x006f4dfDe982dbB4530b161911cC1Dad65883657);
    ...
    function _takeReward(uint256 rewardFee) private {
        ...
        swapTokensForU(rewardFee, lpAddress);
    ...
    function _takeLiquidity(address sender, uint256 liquidityFee) private {
        ...
        uint256 rewardAmount = newBalance.div(3);
        uint256 liquidityAmount = newBalance.sub(rewardAmount);
        usdt.transfer(swapPair, rewardAmount);
        usdt.transfer(lpAddress, liquidityAmount);
        LP(lpAddress).getKLN(sender, liquidityAmount);
        inSwapAndLiquify = false;
    }
