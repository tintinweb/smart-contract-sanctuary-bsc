...
contract Tothemoon is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2_000_000_000 * 10**_decimals;
    ...
    address public marketingAddress = 0x30D6C9ED6ed2F3619Dee674b2Cd8b69013EcE3F9;
    address public devAddress = 0x30D6C9ED6ed2F3619Dee674b2Cd8b69013EcE3F9;
    ...
    Taxes public sellTaxes = Taxes(0,2,5,2);
    ...
    // Owner cannot transfer out TOTHEMOON from this smart contract
    function rescueAnyBEP20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require(_tokenAddr != address(this), "Cannot transfer out TOTHEMOON!");
