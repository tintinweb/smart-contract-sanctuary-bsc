...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        address secFundAddress = 0x9De3C22f6B527EBdE8740F6DD2DE8eF728cC0044;//
...
contract TOKEN is AbsToken {
    constructor() AbsToken(
        ...
        address(0x473051A3f06C1a099F26D1004347a8E95905C194),//usdtAddress
        unicode"ooo",//Name
        unicode"ooo",//Symbol
        9,//Decimals
       7799,//Supply
        address(0x9De3C22f6B527EBdE8740F6DD2DE8eF728cC0044),//FundAddress
        address(0x9De3C22f6B527EBdE8740F6DD2DE8eF728cC0044)//ReceiveAddress
    ){
    }
}