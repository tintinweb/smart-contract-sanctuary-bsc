   ...
   
{
    ...
    function totalFee() internal view returns(uint256)
    {
      ...
      function swapAndLiquify() public onlyOwner lockTheSwap {
        ...
        require(ethBalance >= numOfBnbToSwapAndEvolve,"BNB balance is not reach for S&E Threshold");

        ethBalance = numOfBnbToSwapAndEvolve;
        ...
        _approve(address(this), address(uniswapV2Router), swapeedToken);
