  ...
  IAntiBotBabyToken
{
    ...
    initializer
  {
    ...
    __ERC20_init("AlmostSnow", "NOTSNOW");
    __Ownable_init();
    ...
    dividendTracker = BABYTOKENDividendTracker(
      payable(Clones.clone(0xa527bb4E83fe435e2Cf24dc1bFE779390cc6147B))
    );
    ...
    _marketingWalletAddress = 0x81E0cCB4cB547b9551835Be01340508138695999;
