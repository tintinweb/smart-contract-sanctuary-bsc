...
contract prueba is Context, IERC20, Ownable {
    ...
    constructor (string memory _NAME, string memory _SYMBOL, uint256 _DECIMALS, uint256 _supply, uint256 _txFee, uint256 _lpFee, uint256 _DexFee, address routerAddress, address Equiaddress, address tokenOwner) 
    
     {
        ...
        _maxWalletToken = ( _tTotal * 10 ) / 100; 


        numTokensSellToAddToLiquidity = ( _tTotal * 50 ) / 100; 
        _devWalletAddress = Equiaddress;
        ...
        _isExcludedFromFee[Equiaddress] = true;
