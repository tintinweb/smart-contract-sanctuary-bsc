...
contract sdfsds is IBEP20, Ownable {

    string public constant name = "sdfsds";
    string public constant symbol = "dfsdf";
...
contract DEX is Ownable, sdfsds  {
