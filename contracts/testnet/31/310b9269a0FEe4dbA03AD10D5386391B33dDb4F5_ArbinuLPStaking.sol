...
contract ArbinuLPStaking is Initializable, OwnableUpgradeable {
    ...
    address public arbinuLpPairAddress;
    address public arbinuTokenAddress;
    address public arbinuStakingAddress;
    ...
    function initialize(
        ...
        arbinuTokenAddress = _arbinuTokenAddress;
        arbinuToken = IERC20(_arbinuTokenAddress);
        arbinuLpPairAddress = _lpPairAddress;
        arbinuLpPair = IUniswapV2Pair(_lpPairAddress);
        arbinuStakingAddress = 0x0000000000000000000000000000000000000000;
