...
contract SpacePad is Pausable, Ownable, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        if (_referrer == address(0)) {
            IBEP20(BUSD_ADDRESS).transferFrom(
                msg.sender,
                address(this),
                _amount
            );
            ...
            IBEP20(BUSD_ADDRESS).transferFrom(msg.sender, _referrer, fee);
            IBEP20(BUSD_ADDRESS).transferFrom(
                msg.sender,
                address(this),
                depositAmount
    ...
    function withdraw(address _recipient) external whenNotPaused onlyOwner {
        ...
        uint256 balance = IBEP20(BUSD_ADDRESS).balanceOf(address(this));
        IBEP20(BUSD_ADDRESS).transfer(_recipient, balance);
