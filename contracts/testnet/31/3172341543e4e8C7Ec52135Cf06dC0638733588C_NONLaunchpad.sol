...
contract NONLaunchpad is Ownable, ReentrancyGuard, Pausable {
    ...
    // open nft from non launchpad (reset baseURI)
    ...
    function rescueETH(address recipient) external onlyOwner {
        ...
        require(success, LaunchpadEnums.TRANSFER_ETH_FAILED);
    }
...
library LaunchpadEnums {
    ...
    // 'transfer eth failed'
    string public constant TRANSFER_ETH_FAILED = "3";
}
