...
contract BPAY is ERC20, Ownable {
    ...
    uint256 public burnTaxFeeOnBuy;

    uint256 public rewardFeeOnSell;
    uint256 public marketingFeeOnSell;
    uint256 public liquidityFeeOnSell;
    uint256 public burnTaxFeeOnSell;
    ...
    constructor() ERC20("BUSD PAY", "BPAY") {
        rewardToken = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    	dividendTracker = new DividendTracker(4_000, rewardToken);
        ...
        marketingWallet = 0x3C1619D25837390C55850809fCD9a19875b8Be0B;
    ...
    function updateBuyFees(uint256 _rewardFeeOnBuy,uint256 _marketingFeeOnBuy,uint256 _liquidityFeeOnBuy,uint256 _burnTaxFeeOnBuy) external onlyOwner {
        ...
        require(totalBuyFee <= 100, "Fees must be equal or less than 10%");
    ...
    function updateSellFees(uint256 _rewardFeeOnSell, uint256 _marketingFeeOnSell, uint256 _liquidityFeeOnSell, uint256 _burnTaxFeeOnSell) external onlyOwner {
        ...
        require(_rewardFeeOnSell + _marketingFeeOnSell + _liquidityFeeOnSell + _burnTaxFeeOnSell <= 150, "Fees must be equal or less than 15%");
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 rewardBNB;
            if(rewardShare > 0) {
                rewardBNB = address(this).balance - initialBalance;
