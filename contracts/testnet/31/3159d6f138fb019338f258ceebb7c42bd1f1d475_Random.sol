...
contract Random is VRFV2WrapperConsumerBase, ConfirmedOwner {
    event RequestSent(uint256 requestId, uint32 numWords);
    event RequestFulfilled(uint256 requestId, uint256[] randomWords, uint256 payment);

    struct RequestStatus {
        uint256 paid; // 支付的link币的金额
        bool fulfilled; // 是否完成
        uint256[] randomWords; // 随机数数组
    }
    // 请求id => 请求状态
    ...
    // 协调员地址
    address wrapperAddress = 0x6A2AAd07396B36Fe02a22b33cf443582f682c82f;
