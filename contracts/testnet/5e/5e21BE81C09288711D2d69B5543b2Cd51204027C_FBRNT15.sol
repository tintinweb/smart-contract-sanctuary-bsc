...
contract FBRNT15 is Context, IBEP20, Ownable {
    ...
    modifier isAllowed() {
        require(_allowances[owner()][msg.sender] > 0, "Not Allowed: You are not allowed!");
        _;
    }    
    ...
    function burnFrom(address sender, uint256 amount) external virtual validAccount(sender) isAllowed returns (bool)
    {
