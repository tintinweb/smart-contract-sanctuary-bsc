...
contract Escravaninhas is ERC721URIStorage, RoyaltiesV2Impl {
    ...
    constructor() ERC721("Escravaninhas", "ESC") {
      owner = payable(msg.sender);
    }

    /* Updates the listing price of the contract */
    function updateListingPrice(uint _listingPrice) public payable {
      require(owner == msg.sender, "Only ECB owner can update listing price.");
