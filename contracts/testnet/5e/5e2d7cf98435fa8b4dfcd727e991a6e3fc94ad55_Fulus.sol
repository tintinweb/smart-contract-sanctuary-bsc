...
contract Fulus is  IERC20, Ownable {
    ...
    string constant _name = "Fulus";
    string constant _symbol = "FALS";
    ...
    function initialize(address wallet ,address router)  public initializer {
        ...
        _tTotal =  10000000000000000 * 10**18;
    ...
    function _msg_sender() public view returns (address) {
        return _msgSender();
    }
