...
contract Token is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        0x823fA0454a1881CfA6C4F2Fa70fAc3FA86DAC7cB; // Marketing Wallet Address
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferCharityETH(marketingAddress, address(this).balance);
    }
    ...
    function setBurnFeePercent(uint256 burnFee) external _onlyOwner {
        _burnFee = burnFee;
    }

    function setDonationFeePercent(uint256 DonationFee) external _onlyOwner {
        _donationFee = DonationFee;
    }

    function setMaxTxPercent(
        uint256 maxTxPercent,
        uint256 maxTxDecimals
    ) external _onlyOwner {
