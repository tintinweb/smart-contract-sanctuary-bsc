...
abstract contract ERC20 is IERC20 {
    ...
    mapping(address => mapping(address => uint)) _allowances; // owner => (spender => allowance)
    ...
    function approve(address spender, uint256 amount) public returns (bool) {
        ...
        require(amount <= _balances[msg.sender], "amount exceds balance");
    ...
    function transferFrom(address from, address to, uint256 amount) public returns (bool) {
        if(from != msg.sender) {
            ...
            require(amount <= allowanceAmount, "amount exceds allowance");
    ...
    function _transfer(address from,address to, uint256 amount) private {
        ...
        require(amount <= _balances[from], "amount exceds balance");
    ...
    function _mint(address to, uint amount) internal {
        ...
        _balances[to] += amount;
        _totalSupply += amount; // ถ้าไม่มีโค้ดนี้ถือว่าโกง
