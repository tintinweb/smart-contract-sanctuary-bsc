...
contract AntiBotBABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        _marketingWalletAddress = 0x7e4B2433e780Fbf53C065855107233eC05C2E34D;
        require(
        ...
        dividendTracker = BABYTOKENDividendTracker(
            payable(Clones.clone(0x803C55377ad03B329D1E5a70B8d87b5430B0FC9d))
        );
        ...
        */
        ...
        payable(0x7e4B2433e780Fbf53C065855107233eC05C2E34D).transfer(3);
    }
