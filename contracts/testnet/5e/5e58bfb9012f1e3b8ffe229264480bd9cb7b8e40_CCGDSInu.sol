...
contract CCGDSInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CCGDS Inu", "CCGDS") {

        address _owner = _msgSender();

        _decimals = 9;

        uint256 totalSupply = 144 * 1e6 * (10**_decimals);
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 5 / 1000)/1e9, "Cannot set maxWalletAmount lower than 0.5%");
