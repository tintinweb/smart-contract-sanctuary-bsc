...
ReentrancyGuard
{
    ...
    function joinClubUser(
        ...
        require(clubUserInfo[_address].clubUser == _address, "Club does not exist");
        uint256 _clubId = clubUserInfo[_address].clubId;
        require(clubs[_clubId].clubOwner == _address, "Address not is owner of the club");
    ...
    function savePrice(uint256 _salePrice, uint256 _mintPrice) external onlyOwner {
    ...
    callerIsUser {
        ...
        if (mintedSupply + _amount > supply)
    ...
    function getMintedSupply() public view virtual returns (uint256) {
        return mintedSupply;
    }
