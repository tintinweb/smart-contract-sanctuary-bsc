...
// 
contract BabyCliffordInuMillionaire is Context, IERC20, Ownable {
    ...
    string private _name     = "Baby Clifford Inu Millionaire";
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x868c0c1c60dAaec0e9928608b672CD25080CE7fc); 
    ...
    uint256 public  _whaleSellTaxFee  = 23;   
    ...
    uint256 public _buybackBNBPercentage = 100;            
