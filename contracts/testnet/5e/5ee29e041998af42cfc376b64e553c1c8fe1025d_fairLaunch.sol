...
contract fairLaunch is Ownable, ReentrancyGuard
{
    ...
    ERC20 public token;
    ERC20 public claimingToken;

    mapping(address => userInfor) public userInfoList;
    uint256 public totalAmountToken;
    ...
    constructor()
    {
        totalAmountToken = 250_000_000 * 1e5;
    ...
    {
        userInfoList[msg.sender].amount = msg.value;
    }
