...
abstract contract Keys is Context {//enhanced ownable contract
    ...
    modifier onlyOwner() {
        require(_owner == _msgSender(), "Keys: You are not a designated Keyholder.");_;}
    function DestroyKeys() public virtual onlyOwner {
        //@POA: This can only be done once! You cannot reverse this! 
        //if keys are handed over to upper echelon,
        //they will need ability in ACP to "renounce ownership"
    ...
    function DCAunlockACP() public virtual {
        ...
        //requires the previous owner (POA), which will then advise:
         "The Guardians begin to radiate an energetic glow, lighting the way - the Admin Control Panel Keys have transferred.");
...
interface IUniswapV2Router01 { //all things spawn from uni
...
contract BEP20USHIBA is Context, IERC20, Keys{
    ...
    address private _router = address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//ready for testnet simulations
...
//0xD99D1c33F9fC3444f8101754aBC46c52416550D1 testnet
    ...
    function Step1OneCREATE() external onlyOwner() {//step #1 makes the pair
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//ready for testnet simulations.
    ...
    function Step2TwoANTIBOTS() external onlyOwner() {//step #2 adds antibot list
        ...
        _CharityAddress = payable (0x290b081Ae2CA36A68280C107F9523A698F7c765A);// CAT
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        if(!takeFee)
            Coinbase();//easter egg - remove all fee
	...
	//set CAT to Charity Arm Guardian multisig address.
    ...
    function whatisTeamDevMultiSigWalletBal() public view returns (uint256) {//You're ~15 lines away from the end of the code!
        return _teamDev;
    }
