...
contract Demountain is ERC20, Ownable {
    ...
    function launch() external onlyOwner nonReentrant {
        ...
        LAUNCH_TIME = block.timestamp - 10 minutes;
        launched = true;
        auctionDay++;
        auctionCount++;
        currentDay++;
    ...
    function _sendDevShare() internal nonReentrant {
        ...
        payable(owner()).transfer(paramountTeamShare * 2 / 100);
        paramountMarketAndBuyBack.transfer(paramountTeamShare * 4 / 100);
        paramountTeamAddr1.transfer(paramountTeamShare * 2 / 100);
        paramountTeamAddr2.transfer(paramountTeamShare * 2 / 100);
        paramountTeamAddr3.transfer(paramountTeamShare * 5 / 1000);
        paramountTeamAddr4.transfer(paramountTeamShare * 5 / 1000);
        paramountTeamAddr5.transfer(paramountTeamShare * 4 / 1000);
    }
