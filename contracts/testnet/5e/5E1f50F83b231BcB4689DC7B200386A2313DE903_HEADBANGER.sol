...
contract HEADBANGER is Context, IBEP20, IBEP20Extented, Ownable {
    ...
    uint256 private totalFee = _liquidityFee + _marketingFee + _rfiFee;
    
    uint256 public _minTokenBeforeSwap = 10**4 * 10**18;

    address public marketingFeeReceiver = (0xfD22068Bf2C956bD6f4ab812F11354FB7d7dea35);
    IPancakeRouter02 private pancakeRouter;
    address public pancakePair;
    uint256 private _maxTxAmount = _tTotal.div(1000); // 0.1%
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockTheSwap {
        uint256 amountToLiquify = tokenAmount.mul(_liquidityFee).div(totalFee).div(2);
