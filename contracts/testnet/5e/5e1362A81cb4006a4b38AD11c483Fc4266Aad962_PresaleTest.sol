...
contract PresaleTest is Context, ReentrancyGuard, VRFConsumerBase {
    ...
    constructor(
        ...
        require(
            _info.openTime >= block.timestamp + 25 minutes &&
                _info.openTime + 35 minutes <= _info.closeTime &&
    ...
    function initialize() external nonReentrant onlyPresaleCreator {
        ...
        generalInfo.openTime = intermediate.closeTimeVoting + 20 minutes;
        generalInfo.closeTime = generalInfo.openTime + 25 minutes;
        dexInfo.liquidityAllocationTime = generalInfo.closeTime + 5 minutes;
    ...
    function calculateLotteryResults() external {
        ...
        require(
            random > 0 &&
                !expandCalled &&
                generalInfo.openTime <= currentTime + 5 minutes &&
                _msgSender() == generalInfo.backend,
            "WRONG PARAMS"
        );
        _expand();
    }
        ...
        notCreator
    {
        ...
        if (_isClosingAvailable(round)) _closePresale();
        ...
        initialized
    {
        ...
        intermediate.lpUnlockTime =
            ...
            1 minutes;
        TransferHelper.safeApprove(BUSD, dexInfo.dex, paymentAmount);
