...
//            buyOrSell = true;
//        }
        if (to == uniswapV2Pair && from != address(uniswapV2Router)) { //sell
            sell = true;
        }

        //transfer amount, it will take tax, burn, liquidity fee
        _tokenTransfer(from, to, amount, sell);
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool sell) private {
