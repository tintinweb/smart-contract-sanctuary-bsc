...
contract FeeWizard is ContextUpgradeable {
    ...
    mapping(IERC20 => address[]) public tokenSwapPaths;
    ...
    function addToken(
        ...
        tokenSwapPaths[token] = _swapRoute;
    }
        ...
        returns (address[] memory)
    {
        ...
        return tokenSwapPaths[ercToken];
    }

    function _setUniRouter(address _unirouter) internal {
        require(
