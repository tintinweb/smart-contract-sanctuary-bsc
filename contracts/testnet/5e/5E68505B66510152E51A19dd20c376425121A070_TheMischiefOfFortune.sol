...
/**
    ...
    *50% all deposits used for rehypothecation to reduce or remove ponzi *
    ...
    33 days cut off time 
    30 Days withdraw cooldown.
...
contract TheMischiefOfFortune {
	...
	constructor(address erc20Token,address payable _dev1, address payable _mkt) {
		require(!isContract(_dev1) && !isContract(_mkt));
        contractOwner = msg.sender;
        dev1 = _dev1;
        mktAndBuyBack = _mkt;
        plans.push(Plan(360, 100,  300 * 1e17, 100000 ether, 0, 0, 0, 0, true));
    }
