...
contract YYTS is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x07570e803260c2706C891240C72Db4b9FA3ef8a2));
        marketingWalletAddress = payable(address(0x07570e803260c2706C891240C72Db4b9FA3ef8a2));
