...
contract PancakeSmartRouter {
    ...
    IWETH internal constant weth = IWETH(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);

    IPancakeswapV2Factory internal constant pancakeswapV2 = IPancakeswapV2Factory(0x6725F303b657a9451d8BA641348b6761A6CC7a17);
    IStableSwapFactory internal constant stableswapFactory = IStableSwapFactory(0x0cc504acECC8302e42809334416B07354D4483f7);

    event SmartSwap(address indexed sender);
    ...
    function smartSwapMulti(
        ...
        for (uint256 i = 1; i < tokens.length; i++) {
            ...
            smartSwap(tokens[i - 1], tokens[i], returnAmount, 0, flags[i - 1]);
...
//            _smartSwapOnStableSwap(srcToken, dstToken, remainingAmount, flags);
//        } else if (flags == FLAG_V2_EXACT_IN) {
//            _smartSwapOnV2ExactIn(srcToken, dstToken, remainingAmount, flags);
//        }
//
...
//        srcToken.universalTransfer(msg.sender, srcToken.universalBalanceOf(address(this)));
    ...
    function _smartSwapOnStableSwap(
        IERC20 srcToken,
        IERC20 dstToken,
        uint256 amount,
        uint256 /*flags*/
    ...
    function _smartSwapOnV2ExactIn(
        IERC20 srcToken,
        IERC20 dstToken,
        uint256 amount,
        uint256 /*flags*/
