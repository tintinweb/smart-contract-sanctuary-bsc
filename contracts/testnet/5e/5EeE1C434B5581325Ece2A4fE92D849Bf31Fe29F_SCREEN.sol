...
contract SCREEN is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "SCREEN";
    string private constant _symbol = "SCREEN";
    ...
    address payable private _developmentAddress = payable(0x9D3BeEcF500a927098571804c9420Ac1f3873074);
    address payable private _marketingAddress = payable(0x8a51fC24861b824Ef6514785cB02D19343C8Ef1e);
