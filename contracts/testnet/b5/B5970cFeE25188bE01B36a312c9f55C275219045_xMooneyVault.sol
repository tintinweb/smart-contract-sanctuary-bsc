...
contract xMooneyVault is Ownable, ReentrancyGuard {
        ...
        returns (uint256)
    {
        ...
        tokensThatShouldBeCirculating += (FOUNDER_ALLOTMENT + CREATION_UNIT_ALLOTMENT);
    ...
    function releaseTokens() external nonReentrant {
        ...
        if (
            ...
            IERC20(contractTokenAddress).approve(address(uniswapLPRouter), amountToBakeintoLP);
    ...
    function addLP(uint256 addLPTokenAmount) external nonReentrant {
        ...
        IERC20(contractTokenAddress).approve(address(uniswapLPRouter), addLPTokenAmount);
