...
import "./utils/VRFRequestIDBase.sol";
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the YDT lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == YDTLottery, "Only YDTLottery");
     ...
     * @param _YDTLottery: address of the YDT lottery
     */
    function setLotteryAddress(address _YDTLottery) external onlyOwner {
        YDTLottery = _YDTLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IYDTSwapLottery(YDTLottery).viewCurrentLotteryId();
    }
}
