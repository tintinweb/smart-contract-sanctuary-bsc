...
interface INonFungible is IERC721 {
    ...
    function isNftOfRarity(uint256) external view returns (bool);
...
contract NFTStaking is ReentrancyGuard, Ownable, Initializable {
    ...
    // The nft contract
    INonFungible public NFT_CONTRACT;
    ...
    uint256 public maxStakedAmount = 1440;
