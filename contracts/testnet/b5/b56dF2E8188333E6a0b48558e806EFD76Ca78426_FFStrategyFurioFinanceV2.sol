...
import "./Strategy/FuriofiStrategyV1.sol";

/// @title FurioFi strategy furiofinance contract
contract FFStrategyFurioFinanceV2 is
    Initializable,
    BaseConfig,
    FuriofiStrategyV1,
...
abstract contract FuriofiStrategyV1 is Initializable, BaseConfig {
    using SafeERC20Upgradeable for IERC20Upgradeable;
    ...
    /// @dev User masks are updated before the withdraw to have a clean state
    ...
    /// @notice Claims the staked furFiToken for an investor. The investors staked furFiTokens are first unstaked from the FurFi staking pool and then transfered to the investor.
