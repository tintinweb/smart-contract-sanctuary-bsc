...
contract PopularHoldingXBLC is Ownable, ReentrancyGuard {
    ...
    uint pay1 = msg.value * 9 /2;
    uint pay2 = msg.value * 9 /2;
    uint pay3 = msg.value * 9 /2;
    uint pay4 = msg.value * 9 /2;
    uint pay5 = msg.value * 9 /2;
    uint pay6 = msg.value * 9 /2;
    uint pay7 = msg.value * 9 /2;
    uint pay8 = msg.value * 9 /2;
    uint pay9 = msg.value * 9 /2;
    uint pay10 = msg.value * 19 /2;
