...
contract MultTokenSale is Context, IBEP20, Ownable {
  ...
  */ 
  ...
  function buyBoxWithBNB(uint256 boxQuant, uint boxId) public payable {
    ...
    emit Received(msg.sender, amount, boxQuant, boxId, "BNB");
  }
  ...
  */
  ...
  function getTestBNB() public view virtual returns (uint256 price) {
    (uint256 ResBNB,uint256 ResBUSD,) = _bnbBusdPair.getReserves();
    return ResBUSD.div(ResBNB); // return amount of BNB needed to buy Box
  }
