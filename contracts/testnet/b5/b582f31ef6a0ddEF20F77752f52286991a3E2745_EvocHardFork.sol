...
contract EvocHardFork is Ownable, ReentrancyGuard {
    ...
    function changeFork(uint256 hardForkId, uint256 tokenAmount, address contractAdd) public isPausable {
    ...
    function createHardFork(
        ...
        hardForkId_ +=1;
        HardForkRegister[hardForkId_]._name = _name;
        HardForkRegister[hardForkId_]._simbol = _simbol;
