...
// File: contracts/34_Cri3xTokenVesting.sol
...
// will be transferred to a governance smart contract once CRI3X is sufficiently
// distributed and the community can show to govern itself.
//
// Have fun reading it. Hopefully it's bug-free. God bless.
contract Cri3xFarm is Ownable {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of CRI3Xs
    ...
    struct PoolInfo {
        ...
        uint256 lastRewardBlock;  // Last block number that CRI3Xs distribution occurs.
    ...
    event NewPool(uint256 rewardTokenPerBlock, IERC20 depositToken, IERC20 rewardToken, bool with_update);
    ...
    // View function to see pending CRI3Xs on frontend.
