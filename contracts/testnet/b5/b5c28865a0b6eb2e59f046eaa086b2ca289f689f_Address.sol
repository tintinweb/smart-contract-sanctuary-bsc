...
contract WETSHIBA is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xa59dacb6840776D86e9Eb89D0B624f1083EcF1A2); 
    address payable public Wallet_Dev = payable(0xa59dacb6840776D86e9Eb89D0B624f1083EcF1A2);
    ...
    string private constant _name = "WetShiba"; 
    string private constant _symbol = unicode"WET"; 
    ...
    constructor () {
        ...
        _owner = 0xa59dacb6840776D86e9Eb89D0B624f1083EcF1A2;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            _tOwned[Wallet_zero] = _tOwned[Wallet_zero] + tokens_to_Burn;
            ...
            bnbswap(tokens_to_LP_Half + tokens_to_M + tokens_to_D);
    ...
    function bnbswap(uint256 tokenAmount) private {
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyfee = tAmount*_buytax/100;
            ...
            uint256 sellfee = tAmount*_selltax/100;
