...
contract BEP20 is Context, IBEP20{
    ...
    function _initialize(string memory name_, string memory symbol_, uint8 decimals_, uint256 amount, address owner_) internal virtual {
        _owner = owner_;
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
...
contract ERC1363Implementation is 
    ...
    function initialize(
        ...
        _mintable = false;
        _initialize(name, symbol, decimals, amount, _msgSender());
