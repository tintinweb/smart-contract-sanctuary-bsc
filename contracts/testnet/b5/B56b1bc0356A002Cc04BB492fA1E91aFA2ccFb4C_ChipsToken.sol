...
contract ChipsToken is BEP20, Referral {
    ...
    constructor(uint256 initialSupply, address ref_token) BEP20("ChipsToken", "CHS") Referral(ref_token) public {
    ...
    function faucet() public {
        require(balanceOf(_msgSender()) == 0, "balance should be zero!");
        _mint(_msgSender(), faucet_amount);
    }

    function mint_4game() public{

        uint game_balance = balanceOf(game_address);
        require(game_balance < mint_threshold, "balance should be under 1 mil !");
        _mint(game_address, mint_threshold - game_balance);
    }
