...
contract INFINITYLOTTO is IBEP20, Auth {
    ...
    string constant _name = "InfinityLotto";
    ...
    uint256 public totalFee       = marketingFee + teamFee + reflectionFee + liquidityFee + lotteryFee + burnFee;
    ...
    bool public FairLaunchMode = true;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8B15F0c6966faD22Bc2D9D6A68d2364aF993cb8e;
        teamFeeReceiver = 0xBaB1989182f16cF803ac28D0af72cdE19E42fAcA;
        lotteryFeeReceiver = 0xc701163EeF5C56046cE6ff31C37FE71505488dC4;
    ...
    function ClearMarketingBalance(uint256 amountPercentage) external authorized {
        ...
        payable(lotteryFeeReceiver).transfer(amountBNB * amountPercentage / 100);
            ...
            function ClearTeamBalance(uint256 amountPercentage) external authorized {
        uint256 amountBNB = address(this).balance;
        payable(teamFeeReceiver).transfer(amountBNB * amountPercentage / 100);
    }
    ...
    function setIsFeeExempt(address holder, bool exempt) external authorized {
        ...
        function setFairLaunchDisableForever() external onlyOwner{
        require(FairLaunchMode == false);
        FairLaunchMode = false;
    }
    ...
    function setContractFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _lotteryFee, uint256 _teamFee, uint256 _burnFee) external authorized {
        ...
        feeDenominator = 100;
        require(totalFee + burnFee < feeDenominator/3, "Max Fees = 33%");
    }
 
    function setFeeContract(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _teamFeeReceiver, address _lotteryFeeReceiver, address _burnFeeReceiver ) external authorized {
