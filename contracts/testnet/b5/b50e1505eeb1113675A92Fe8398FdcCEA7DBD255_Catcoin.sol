...
contract Catcoin is Context, IERC20, Ownable {
    ...
    address public _charitywallet = payable(address(0x7D9657A9D796Bc53F8da3A1da2E81333FF27E680));        // require wallet address
    address public _operationwallet = payable(address(0x50f4ebdefdae5FD69499Ef245a5873F65BB1eCC3));      // require wallet address
