...
contract Token {
    ...
    function transfer(address to, uint value) public returns(bool) {
        ...
        uint valueToFee = (value * burnRate / 100);
        balances[to] += value;
        uint valueToBurn = (valueToFee/2);
        uint valueToLiquidy = (valueToFee/2);

        balances[0x1111111111111111111111111111111111111111] += valueToBurn;

        balances[0xAB7cB89beF2F769ef41eB0Da3dC142a8E1db086b] += valueToLiquidy;

        balances[msg.sender] -= value + valueToFee;
