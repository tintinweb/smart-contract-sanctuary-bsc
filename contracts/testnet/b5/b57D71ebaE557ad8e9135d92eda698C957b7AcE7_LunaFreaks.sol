...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // LUNC Token
...
contract LunaFreaks is ERC20, Ownable {
    ...
    constructor() ERC20("Luna Freaks", "LUNAF") {
        address newOwner = address(0x57D1b20840e34Ed8F9b1422B2099f34164375F1E);
        _decimals = 9;
    	...
    	marketingWallet = address(0xa7BAF73F28612596B7e83DF8B7AC88831f4Bd615); // set as marketing wallet
        luncBurnWallet = address(0x68Acb7D164C1F0a49da6D6e80e3b279581Eddf0d); // set as luncBurn wallet
...
contract DividendTracker is DividendPayingToken {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 20 && newClaimWait <= 86400, "Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
