...
contract BWORKER is Context, IERC20, IERC20Metadata, Ownable, IBWORKER {
    ...
    bool public _autoBuyBack = false;
    ...
    function setAuto(bool flagAddLiquidity, bool flagBuyBack)
        external
        onlyOwner
    {
        _autoAddLiquidity = flagAddLiquidity;
        _autoBuyBack = flagBuyBack;
    }
