...
contract MS is Context, IERC20, Ownable {
    ...
    string private _name = "A S U";
    string private _symbol = "$ASU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7dE20977E12baf256171cD36E4FDd5D2664ce662); // Marketing Address
    address payable public buyBackWalletAddress = payable(0x7dE20977E12baf256171cD36E4FDd5D2664ce662); // buyback Address
