...
contract OG_Token is Context, IERC20, Ownable {
    ...
    uint256 private _developmentFee = 5;        //0.5% of tokens will goes to the developement wallet at buy the tokens.
    uint256 private _sellDevelopmentFee = 10;   //1% of tokens will goes to the developement wallet at sell the tokens.
    ...
    event updateSellTax(address indexed owner,uint256 reflection,uint256 team,uint256 market,uint256 developement,uint256 buyBack,uint256 totalSellFee);
    event updateBuyTax(address indexed owner,uint256 reflection,uint256 team,uint256 market,uint256 developement,uint256 buyBack,uint256 totalBuyFee);
    ...
    function sentToWallets(uint256 totalBUSD) private {
        ...
        uint256 developementShare = totalBUSD.mul(_developmentFee.add(_sellDevelopmentFee)).div(totalBuyFee.add(totalSellFee));
