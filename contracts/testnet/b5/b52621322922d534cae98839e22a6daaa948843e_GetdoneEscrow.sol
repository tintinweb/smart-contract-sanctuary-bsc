...
contract GetdoneEscrow is OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, AccessControlEnumerableUpgradeable, GetdoneApp{
    ...
    event ContractDisputationSent(uint256 merchantId, uint256 appId, uint256 contractId, uint256 amount, address caller, address sender, bool isTalentVoted, bool isCustomerVoted);
    ...
    function createDisputation(uint256 merchantId, uint256 appId, uint256 contractId, address customer, address sender) 
        external
        payable
        whenNotPaused
        nonReentrant
        returns (uint256)
    {
        ...
        contractDisputation.sender = sender;
        ...
        emit ContractDisputationSent(merchantId, appId, contractId, amountRefund, _sender, sender, contractInfo.talent == sender, contractInfo.customer == sender);
