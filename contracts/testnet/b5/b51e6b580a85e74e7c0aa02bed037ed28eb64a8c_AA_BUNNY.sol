...
contract AA_BUNNY is Context, IERC20 { 
    ...
    */
    ...
    function swapAndLiquify(uint256 contractBalance) private lockTheSwap {
        ...
        // Get fee trackers
        uint256 trackingTotal = (Fee_L + Fee_D + Fee_S + Fee_M);
        ...
        // Get other fee splits
        uint256 percent_D = Fee_D * accuracy / swapTokens;
        uint256 percent_S = Fee_S * accuracy / swapTokens;
        uint256 percent_M = Fee_M * accuracy / swapTokens;
