...
contract BunnyRivenEgg is Ownable {
    ...
    uint256 public eggPrice = 80 ether; // ~ $80
     ...
     */
    function setValidator(string calldata _key, bool _active)
        external
        onlyOwner
    {
    ...
    function buyEgg(uint256 quantity, string calldata key) external {
        ...
        if (totalSell.add(quantity) >= TOTAL_SUPPLY) revert("Maximum limited");
        ...
        totalSell = totalSell.add(quantity);
