...
SingleNftPrimaryTokenSpecialMint
{
    ...
    override
    {
        ...
        uint256 tokenId = tokenCount();
        string memory uri = getPresetUri(getPresetIndexByAcquireValue(
                SingleNftUtils.fakeRandom(getPresetGlobalAcquireMaxValue()), 0));
...
SingleNftPrimaryTokenMinimumPrice
{
    ...
    mapping(uint256 => uint256) private _presetAcquireMinValues;
    mapping(uint256 => uint256) private _presetAcquireMaxValues;

    uint256 private _acquireMaxValue;
    ...
    function addPreset(
        ...
        uint256 acquireMinValue,
        uint256 acquireMaxValue
    )
    external
    onlyOwner
    {
        ...
        setPresetAcquireRange(index, acquireMinValue, acquireMaxValue);
    ...
    public
    view
    returns (uint256 acquireMinValue, uint256 acquireMaxValue)
    {
        require(index < presetCount(), "wrong index");
    ...
    function setPresetAcquireMinValue(uint256 index, uint256 acquireMinValue)
    public
    onlyOwner
    {
        require(index < presetCount(), "wrong index");
    ...
    function setPresetAcquireMaxValue(uint256 index, uint256 acquireMaxValue)
    public
    onlyOwner
    {
        require(index < presetCount(), "wrong index");
    ...
    function setPresetAcquireRange(uint256 index, uint256 acquireMinValue, uint256 acquireMaxValue)
    public
    onlyOwner
    {
        require(index < presetCount(), "wrong index");
    ...
    function forceSetAcquireMaxValue(uint256 acquireMaxValue)
    public
    onlyOwner
    {
    ...
    function getPresetIndexByAcquireValue(uint256 acquireValue, uint256 fallbackIndex)
    public
    view
    returns (uint256)
    {
    ...
    function _getIndexByAcquireValue(uint256 acquireValue, uint256 fallbackIndex)
    private
    view
