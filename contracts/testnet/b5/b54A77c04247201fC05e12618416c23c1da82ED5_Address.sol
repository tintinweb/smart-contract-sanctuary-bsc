...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x38111b390416EdDF652E69926b961FAE3b37b964;
...
contract BabyPaul02 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6C8E891A6237CC579a2C50b5E36A92a2e5BDbC57;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BabyPaulTest02";
    string private _symbol = "BPT02";
