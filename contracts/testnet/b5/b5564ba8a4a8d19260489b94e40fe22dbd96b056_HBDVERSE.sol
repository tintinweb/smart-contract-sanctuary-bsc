...
contract HBDVERSE {
    ...
    IBEP20 public BUSD = IBEP20(0xa41B2B17589851fb56DA25b22DdFa415Da184a09); 
    

	uint256 constant public INVEST_MIN_AMOUNT = 5000 ether; //5000 BUSD
	...
	uint256 constant public RESTAKE_MIN_AMOUNT = 100 ether; // 100 BUSD
	...
	constructor(address wallet, address _developer, address _marketing, address _owner) public {
