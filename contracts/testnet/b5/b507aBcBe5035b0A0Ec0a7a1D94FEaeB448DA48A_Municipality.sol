...
contract Municipality is OwnableUpgradeable, ReentrancyGuardUpgradeable, EIP712Upgradeable {
    ...
    function setGymNetworkAddress(address _gymNetworkAddress) public onlyOwner {
    ...
    function setNftReflectionPoolAddress(address _nftReflectionPoolAddress) public onlyOwner {
        nftReflectionPoolAddress = _nftReflectionPoolAddress;
    }

    function setNetGymStreetAddress(address _netGymStreetAddress) public onlyOwner {
        netGymStreetAddress = _netGymStreetAddress;
    }

    function setAmbassadorWalletAddress(address _ambassadorWalletAddress) public onlyOwner {
        ambassadorWalletAddress = _ambassadorWalletAddress;
    }

    function setReserveWalletAddress(address _reserveWalletAddress) public onlyOwner {
    ...
    function setGymTurnoverPoolAddress(address _gymTurnoverPoolAddress) public onlyOwner {
        gymTurnoverPoolAddress = _gymTurnoverPoolAddress;
    }

    function setVbtcAddress(address _vbtcAddress) public onlyOwner {
        vbtcAddress = _vbtcAddress;
    }

    function setStandardParcelSlotsCount(uint8 _standardParcelSlotsCount) public onlyOwner {
        standardParcelSlotsCount = _standardParcelSlotsCount;
    }

    function setUpgradedParcelSlotsCount(uint8 _upgradedParcelSlotsCount) public onlyOwner {
        upgradedParcelSlotsCount = _upgradedParcelSlotsCount;
    }

    function setUpgradePrice(uint _upgradePrice) public onlyOwner{
        upgradePrice = _upgradePrice;
    }

    function setVoucherPrice(uint _voucherPrice) public onlyOwner{
        voucherPrice = _voucherPrice;
    }

    function setMinerPrice(uint _minerPrice) public onlyOwner{
        minerPrice = _minerPrice;
    }

    function setMinerRepairPrice(uint _minerRepairPrice) public onlyOwner{
        minerRepairPrice = _minerRepairPrice;
    }

    function setElectricityVoucherPrice(uint _electricityVoucherPrice) public onlyOwner{
