...
contract SVCToken is BEP20 {
    uint256 private totalAmount = 100000000 ether;

    constructor() public BEP20("Savvy coin", "SVC") {
...
contract Farming is Ownable {
    ...
    // Stake SVC tokens to MasterChef
    ...
    // Withdraw SVC tokens from Staking.
    ...
    function setRewardWallet(address newRewallWallet) public onlyOwner {
        require(
            newRewallWallet != address(0),
            "DevAddress: new devAddress is the zero address"
        );
        rewardWallet = newRewallWallet;
    }
}