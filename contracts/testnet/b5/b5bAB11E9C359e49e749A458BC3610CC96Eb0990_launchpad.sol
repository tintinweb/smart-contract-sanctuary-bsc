...
contract launchpad is Ownable {
    ...
    function unStake(uint _amount) external {
        ...
        uint256 unstaked = 0;
        uint256[1000] memory unstakeFrom;
        uint256 j = 0;
        uint256[1000] memory unstakeFromPenalty;
        uint256 jp = 0;
        ...
        idoBalance[msg.sender] = idoBalance[msg.sender] - (initialAmount * idoMulti); 
        IDO(address(idoToken)).burn(address(this), (initialAmount * idoMulti));
