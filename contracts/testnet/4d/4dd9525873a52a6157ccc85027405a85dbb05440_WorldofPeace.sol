...
// File: contracts/WorldofPeace.sol
...
// Website : https://world-of-peace.com/
 * World of Peace $WDP is developed to help people all over the world. Investments invested in the $WDP 90% will be directed and used for assistance to children, women, elderly people were left homeless and are deprived of opportunity to live on their land. Left without food, medicine, money and livelihood. Forced to flee and evacuate to the safe territories of Europe and other countries. Investments will benefit humanity.
 * 10% will be used to support the $WDP inside Blockchain.
 * 
 *
 */
...
contract WorldofPeace is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    constructor () BEP20Detailed("World of Peace", "WDP", 18) {
      _owner = msg.sender ;
    ...
    function setMarketingFeePercent(uint256 updatedMarketingFee) external onlyOwner {
        require(updatedMarketingFee <=1, "Fee is crossing the boundaries");
    ...
    {
        require(maxTx >= 1000000 * (10**8), "Not Allowed");
        _maxTxAmount = maxTx;
    }
    ...
    function _transfer(address sender, address recipient, uint amount) internal{
        ...
        if(!isExcludedFromMaxTx[sender])
        {
         ...
         // cooldown timer, so a bot doesnt do quick trades! 60 seconds gap between 2 trades.
        ...
        if (recipient == uniswapV2Pair&&
            ...
            require(cooldownTimer[sender] < block.timestamp,"Please wait for 60 seconds between two buys");
    ...
    function cooldownEnabled(bool _status, uint8 _interval) public onlyOwner {
        require(_interval <= 300, "Limit reached");
