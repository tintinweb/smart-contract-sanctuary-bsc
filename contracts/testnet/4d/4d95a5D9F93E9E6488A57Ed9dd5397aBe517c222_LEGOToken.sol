...
// File: contracts/NFTGenerator_V1.sol
...
contract LEGOToken is IERC20 {
    ...
    string constant private _name = "Lego Coin Testnet";
    string constant private _symbol = "TLEGO";
    ...
    uint256 private _maxTxSellAmount = (_tTotal * 1) / 1000;
...
//================================================ BLACKLIST
    ...
    function setMaxSellTxPercent(uint256 percent, uint256 divisor) external onlyOwner {
        ...
        _maxTxSellAmount = (_tTotal * percent) / divisor;
    }

    function getMaxSellTX() external view returns (uint256) {
        return _maxTxSellAmount / (10**_decimals);
    }
