...
contract P66 is Ownable, ERC721, NonblockingReceiver {
    using Strings for uint256;
    ...
    uint256 nextTokenId = 10;
    uint256 MAX_NETWORK_MINT = 15;
    ...
    function mint(uint8 numTokens) external payable {
        require(numTokens < 2, "Peexels: Max 1 NFT per transaction");
        require(
            nextTokenId + numTokens <= MAX_NETWORK_MINT,
            "Peexels: Mint exceeds supply for this network"
        );
        if (msg.sender != owner()) {
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "Peexels: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    // This will pay Peexels Team 5% of the initial sale.
    // =============================================================================
    (bool hs, ) = payable(0xB21830531fB573A4Cb328f93E556383446550288).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
