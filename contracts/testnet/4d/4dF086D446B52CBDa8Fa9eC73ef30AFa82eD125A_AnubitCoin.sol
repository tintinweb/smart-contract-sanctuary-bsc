...
contract AnubitCoin is Context, IERC20, Ownable {
    ...
    string private _name   = "AnubitDev";
    ...
    uint256 public _percentageOfLiquidityForCharityFee = 5;
    ...
    address public _holdersReceiver       = 0x0000000000000000000000000000000000000000;
    ...
    function setTeamWallet(address teamFeeReceiver) external onlyOwner {
        _ownersFeeReceiver = teamFeeReceiver;
    }
    ...
    function setCommunityAndReferralWallet(address communityAndReferralFeeReceiver) external onlyOwner {
        _charityFeeReceiver = communityAndReferralFeeReceiver;
    }
