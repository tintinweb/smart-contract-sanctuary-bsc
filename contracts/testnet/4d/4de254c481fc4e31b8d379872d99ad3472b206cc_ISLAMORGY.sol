...
contract ISLAMORGY is IBEP20, Auth {
 using SafeMath for uint256;
 ...
 string constant _name = "ISLAMORGY";
 string constant _symbol = "ISLORGY";
...
returns (bool) {
 ...
 function swapBack(uint256 internalThreshold) internal swapping {
   ...
   try distributor.deposit{value: amountBNBReflection}() {} catch {}
        ...
        payable(fundraiserFeeReceiver).call{value: amountBNBFundraiser, gas: 30000}("");
