...
contract BovineVerseMysteryBox is Ownable, ERC721Enumerable, ERC721URIStorage {
    // for inherit
    ...
    mapping(uint => uint) public tokenToCard;
    ...
    function tokenURI(uint256 tokenId_) override(ERC721URIStorage, ERC721) public view returns (string memory) {
        ...
        string memory cURI = cardInfoes[tokenToCard[tokenId_]].tokenURI;
