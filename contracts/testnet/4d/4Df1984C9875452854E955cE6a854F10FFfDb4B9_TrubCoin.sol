...
contract TrubCoin is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TrubCoin";
    string private _symbol = "TRUB";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xD9a4abf2157f49a4b17F0010363e513E0EB8e44B);
    address payable private teamWalletAddress = payable(0xD9a4abf2157f49a4b17F0010363e513E0EB8e44B);
