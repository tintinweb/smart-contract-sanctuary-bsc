...
contract C401Token is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    C401TokenDividendTracker public dividendTracker;
    ...
    constructor() ERC20("CryptoIRA", "C401") {
        dividendTracker = new C401TokenDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "C401: The dividend tracker already has that address"
        );

        C401TokenDividendTracker newDividendTracker = C401TokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "C401: The new dividend tracker must be owned by the C401 token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "C401: The router already has that address"
        );
 ...
 //   }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "C401: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "C401: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "C401: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "C401: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "C401: Cannot update gasForProcessing to same value"
        );
...
contract C401TokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("C401_Dividend_Tracker", "C401_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "C401_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "C401_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main C401 contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "C401_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "C401_Dividend_Tracker: Cannot update claimWait to same value"
        );
