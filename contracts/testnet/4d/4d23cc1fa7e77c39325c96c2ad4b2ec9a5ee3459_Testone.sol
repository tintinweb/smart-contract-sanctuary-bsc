...
contract Testone is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "TEST META ONE";
    string constant _symbol = "testmeta1";
    ...
    // buy fees
    uint256 public buyBusdDividendRewardsFee = 3;
    uint256 public buyMarketingFee = 3;
    uint256 public buyLiquidityFee = 2;
    uint256 public buyPartnershipFee = 0;
    uint256 public buyTotalFees = 8;
    // sell fees
    uint256 public sellBusdDividendRewardsFee = 3;
    uint256 public sellMarketingFee = 3;
    uint256 public sellLiquidityFee = 2;
    uint256 public sellPartnershipFee = 0;
    uint256 public sellTotalFees = 8;

    address public marketingFeeReceiver;
    address public devFeeReceiver;
    address public PartnershipFeeReceiver;
    ...
    constructor() {
        ...
        marketingFeeReceiver = 0x247DCd0EC25b42c727abbC292c7Db72EeB4c1480;
        devFeeReceiver = 0x247DCd0EC25b42c727abbC292c7Db72EeB4c1480;
        PartnershipFeeReceiver = 0x247DCd0EC25b42c727abbC292c7Db72EeB4c1480;
    ...
    function updateBuyFees(
        ...
        buyPartnershipFee = Partnership;
        buyTotalFees = busdReward.add(marketing).add(liquidity).add(Partnership);
    }
    ...
    function updateSellFees(
        ...
        sellPartnershipFee = Partnership;
        sellTotalFees = busdReward.add(marketing).add(liquidity).add(Partnership);
    }
    ...
    function swapBackInBnb() internal swapping {
        ...
        uint256 totalSwapFee = buyMarketingFee.add(buyPartnershipFee);
        ...
        uint256 bnbForPartnership = swappedBnbAmount.sub(marketingFeeBnb);
        ...
        if (bnbForPartnership > 0) {
            (bool PartnershipSuccess, ) = payable(PartnershipFeeReceiver).call{
                value: bnbForPartnership,
                gas: 30000
            }("");
            // only to supress warning msg
            PartnershipSuccess = false;
        }
    ...
    function setFeeReceivers(
        ...
        address _PartnershipFeeReceiver
    ) external onlyOwner {
        marketingFeeReceiver = _marketingFeeReceiver;
        devFeeReceiver = _devFeeReceiver;
        PartnershipFeeReceiver = _PartnershipFeeReceiver;
    }
