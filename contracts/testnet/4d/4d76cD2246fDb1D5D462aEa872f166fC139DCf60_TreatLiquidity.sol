...
// File contracts/utils/IBabyDogeRouter.sol
...
// File contracts/utils/IBabyDogeFactory.sol
...
// File contracts/TreatLiquidity.sol
...
contract TreatLiquidity is Ownable, ReentrancyGuard {
        ...
        )
    {
        ...
        (amountA, amountB, liquidity) = IBabyDogeRouter(router)
            .addLiquidity(
                treatToken,
                tokenB,
                IERC20(treatToken).balanceOf(address(this)),
    ...
    function removeLiquidity(
        ...
        IERC20(treatToken).safeTransfer(msg.sender, IERC20(treatToken).balanceOf(address(this)));
