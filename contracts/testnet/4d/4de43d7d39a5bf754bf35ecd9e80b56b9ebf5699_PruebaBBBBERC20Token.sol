...
contract PruebaBBBBERC20Token is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("Prueba BBBB", "BBBB", 9) 
    ERC20Permit("Prueba BBBB") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority,100000000000000000); 
