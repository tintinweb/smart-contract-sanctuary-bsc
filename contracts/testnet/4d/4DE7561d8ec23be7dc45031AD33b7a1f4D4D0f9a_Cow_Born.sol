...
contract Cow_Born is OwnableUpgradeable {
    ...
    uint shred;
    uint shredId;
    event Born(address indexed sender, uint indexed reward, uint indexed cattleId);//1 for creation cattle, 2 for normal ,3 for shred
