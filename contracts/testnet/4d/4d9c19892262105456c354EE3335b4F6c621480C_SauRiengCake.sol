...
contract SauRiengCake {
    ...
    function buyXuWithXeng() public payable {
        uint minBNB = minXu / bnbPerXuRatio;
        require(msg.value >= minBNB * 10**18, "Minimum purchase of 1000 XU required!");
    ...
    function buyXengWithXu() public payable {
        uint minBNB = minXeng / bnbPerXengRatio;
        require(msg.value >= minBNB * 10**18, "Minimum purchase of 2000 XENG required!");
