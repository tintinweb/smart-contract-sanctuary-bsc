...
contract ONE is ABS {
    constructor(address[] memory addr) ABS("ONE Coin", "ONE", "One Coin", 0xD13677e9feB14ef768179ce6Eb081B924fee29c2) {
        _mint(msg.sender, 1000000 * 10**decimals());
        setEnableWhitelist(false);
        setMarketingWallet(0xf30B0E89eAeDcE7103A7c62DA3ef6023E0e4D479);
        setDevWallet(0x210d8E108546564F402362874b4f5be12fBBB8fF);
        setBuySlippage(3);
        setSellSlippage(3);
        setCurrency(0xe60A39A1D724817FeafA9Bc614eeb378A95F7a91);
