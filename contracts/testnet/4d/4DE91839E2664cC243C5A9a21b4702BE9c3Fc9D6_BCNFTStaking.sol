...
contract BCNFTStaking is Context, Ownable {
    ...
    function stake(uint256 period) external {
        ...
        require(IERC20(rewardTokenAddress).balanceOf(msg.sender) > 0, "Must have some Token");
    ...
    function checkLevels(address _owner, uint256[] memory levels) public returns(uint256) {
