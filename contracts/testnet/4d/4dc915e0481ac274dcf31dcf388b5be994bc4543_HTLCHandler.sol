...
contract HTLCHandler is BaseRelayRecipient, BasePaymaster {
    ...
    function getRequiredRelayAmount(GsnTypes.RelayData calldata relayData) public view returns (uint256 amount) {
        amount = relayHub.calculateCharge(_requiredRelayGas, relayData);
    }
    ...
    returns (bytes memory context, bool revertOnRecipientRevert) {
        ...
        uint256 requiredRelayerAmount = getRequiredRelayAmount(relayRequest.relayData);
