...
import "./interfaces/IRototoXV8Dex.sol";

import "./RototoXV8Dex.sol";
import "./ReentrancyGuard.sol";

contract RototoXV8 is IERC20, ReentrancyGuard {
...
import "./RototoXV8.sol";

contract RototoXV8Dex is IRototoXV8Dex {
    /// @dev 0.001 bnb
    ...
    uint256 private SELL_DEVELOPER_AND_MARKETING_FEE = 3;
    ...
    constructor(
        ...
        token = RototoXV8(payable(_tokenSmartContract));
