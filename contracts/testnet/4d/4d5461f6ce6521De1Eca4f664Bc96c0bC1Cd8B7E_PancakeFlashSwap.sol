...
contract PancakeFlashSwap {
    ...
    function startArbitrage(address _tokenBorrow, uint256 _amount) external {
        ...
        //This will trigger the pancake swap function
    ...
    function checkPossibleTrade(
        ...
        uint256 amountRequired = IUniswapV2Router01(PanCakeSwaprouter).getAmountsOut(
            _amountIn,
            path
        )[1];
        ...
        path[0] = _Token02 ;
        path[1] = _Token03;
        uint256 amountRequired2 = IUniswapV2Router01(PanCakeSwaprouter).getAmountsOut(
            amountRequired,
            path
        )[1];
        ...
        path[0] = _Token03 ;
        path[1] = _Token01;
        uint256 amountRequired3 = IUniswapV2Router01(PanCakeSwaprouter).getAmountsOut(
            amountRequired2,
            path
        )[1];
    ...
    function pancakeCall(
        ...
        bool result = checkPossibleTrade(
            BUSD,
            CROX,
            CAKE,
            loanAmount,
