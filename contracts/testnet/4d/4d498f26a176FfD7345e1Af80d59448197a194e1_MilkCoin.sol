...
contract MilkCoin is ERC20, Ownable {
    ...
    string public _name = "SheepMilk";
    string public _symbol = "SMilk";
    uint8 public _decimals = 18;

    uint256 public liquidityFee = 70;
    uint256 public feeDenominator = 1000;
    uint256 public LIQUIDITY_MINIMUM = 10000; // todo debug
    ...
    function _transfer(
        ...
        require(senderBalance >= exceptAmount, "ERC20: transfer amount exceeds balance");
        unchecked {
    ...
    function addLiquidity() internal swapping {
        ...
        if( autoLiquidityAmount <  LIQUIDITY_MINIMUM) {
            return;
        }
    ...
    function takeFee(
        ...
        uint256 liquidityAmount = exceptAmount.mul(liquidityFee).div(feeDenominator);
