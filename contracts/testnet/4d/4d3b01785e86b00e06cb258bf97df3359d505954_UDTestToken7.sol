...
contract UDTestToken7 is IERC20 {
    ...
    constructor(uint256 _supply) payable {
        ...
        //cashOut = CashOut(payable(cashOutAddress));
    ...
    function setAmountAMin(uint amountAMin) public onlyOwner {
    }

    function setAmountBMin(uint amountBMin) public onlyOwner {
    }
  ...
  //  }
    ...
    function claimBUSD() public payable {
        uint256 BUSDEarned = (UDdeposited * Rate) / RateMod;
        IERC20(BUSD).transfer(payable(msg.sender), BUSDEarned);
    }
