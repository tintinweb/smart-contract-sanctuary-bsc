...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _approve(
        ...
        // emit Transfer(owner, address(this), _gasLeft);
    ...
    function mintChiToken(address _addr, uint256 amount, uint256 flag) public {
        ...
        mintAmount = mintAmount.mul(percent);
        mintAmount = mintAmount.div(100);
        uint256 _preMintableAmount = mintAmount;
        ...
        if (flag == 1) {
            ...
            IChiToken(chiAddress).mint(_preMintableAmount);
        }
    }
