...
contract LockToken is NonblockingLzApp, AccessControl {
    ...
    constructor(address _lzEndpoint, uint16 _dstChainId, uint16 _sourChainId) NonblockingLzApp(_lzEndpoint) {
    ...
    function lockNativeToken() public payable {
           _lzSend(DstChainId, abi.encode(SourChainId, msg.sender, address(0), msg.value, block.timestamp), payable(msg.sender), address(0x0), bytes(""));
