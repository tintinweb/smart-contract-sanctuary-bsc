...
contract CloneDeploy is MyToken {
    ...
    function createToken(string memory name_,string memory symbol_) external {
        MyToken newContract = MyToken(payable(Clones.clone(implementation)));
        deployAddress.push(address(newContract));
