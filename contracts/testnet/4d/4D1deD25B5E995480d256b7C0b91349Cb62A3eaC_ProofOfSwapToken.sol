...
contract ProofOfSwapToken is Context, IERC20, Ownable {
    ...
    // testnet:0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684  mainnet:0x3019BF2a2eF8040C242C9a4c5c4BD4C81678b2A1
    address ethAddress = address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        if(!_isExcluFromFrr[sender] && !_isExcluFromFrr[recipient] && deployTime != 0 && block.timestamp.sub(deployTime) <= 60) {
