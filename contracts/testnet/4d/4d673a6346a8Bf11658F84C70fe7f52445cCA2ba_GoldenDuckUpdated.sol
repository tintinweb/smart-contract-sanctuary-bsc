...
abstract contract Project {
    address public marketingWallet = 0x7f30174D3Ca49052eE11dAbFE709E7E87E9F0227;
    address public treasuryWallet = 0x21f4f9117a9dE35ecA20ed940C4d2a9a4c4E9c33;

    string constant _name = "goldenduck";
    ...
    function distributeDividend(address shareholder) internal  {
        ...
        if(amount > 0){
            ...
            //if(shareInfo.hasCustom) {
                address shareholderRwrd = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F; //shareInfo.currentRWRD;

                // If the shareholder has a custom RWRD we will have to do a 
                // transfer through a purchase using the core BUSD
                address[] memory path = new address[](2);
                path[0] = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // BUSD
...
contract GoldenDuckUpdated is Project, IBEP20, Auth {
    using SafeMath for uint256;
    ...
    constructor () Auth(msg.sender) {
        ...
        burnTo = 0x21f4f9117a9dE35ecA20ed940C4d2a9a4c4E9c33;
