...
/**
 * @title Winery NFT Launchpad
 * @notice Pre-market sell Winery NFT tokens.
 */


//SPDX-License-Identifier: UNLICENSED
contract SnailHouseLaunchpadIDONFT is
    Initializable,
    ...
    ReentrancyGuardUpgradeable
{
    ...
    address public usdt = 0x98649fde88981790b574c9A6066004D5170Bf3EF; 
    ...
    function leftToSell(uint256 _index) public view returns (uint256) {
        ...
        return
            launches[_index].totalCount -
            launches[_index].soldCount -
            launches[_index].sendCount;
    }
        ...
        returns (uint256)
    {
        ...
        uint256 nftId = wineryNFT.launchpadMint(
            msg.sender,
            _launch.level,
            _launch.robiBoost,
            false
