...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 public RWRD = IBEP20(0x5CAdA4AC7F88D398b41E90d9c28dE978f977dE24);
    ...
    function setRewardtoken(address _rwrdtoken) external onlyToken {
        // Payout the current rewards
...
/* Token contract */
contract HVASKJERKEK2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "APESTRONAUTS";
    string constant _symbol = "APESTRO";
