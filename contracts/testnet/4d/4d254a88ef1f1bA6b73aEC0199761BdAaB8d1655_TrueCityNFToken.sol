...
contract TrueCityNFToken is Owner {
    ...
    // fees wallets
    address public constant liquidityW = 0x87A38AC6006cA154be152e73d2f2164C20848CF9;
    address public constant aditionalFeeforbots = 0xC21a384D2755c8fDE0bd3fb5886CdA111cEa7E5E;
    //wallets
    address public constant investmentsTruCity_wallet = 0xeC9D318b884EB650F154f0Ec9eaF2897271cD866;
    address public constant liquidez_w = 0x184500B821bDAfed164Ca836B78583eebB41a73a;
    //supply
    ...
    constructor() {
        ...
        uint256 tge_time = 1646078623;//ojoooo modificar fecha de lanzamiento
        // 2592000 = 1 days
        uint256 six_weeks_time = 1; //ojoooo modificar fecha de lanzamiento
...
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 3),1116494 * 10**9));
// are unlocked to date 10mts the amount of 6.885.998
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 4),6885998 * 10**9));
// are unlocked to date 10mts the amount of 1.674.750
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 5),1674750 * 10**9));
// are unlocked to date 10mts the amount of 6.168.262
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 6),6168262 * 10**9));
// are unlocked to date 10mts the amount of 1.196.250
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 6),1196250 * 10**9));
// are unlocked to date 10mts the amount of 5.354.244
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 7),5354244 * 10**9));
// are unlocked to date 10mts the amount of 1.196.250
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 8),1196250 * 10**9));
// are unlocked to date 10mts the amount of 4.706.617
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 9),4706617 * 10**9));
// are unlocked to date 10mts the amount of 837.375
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 10),837375 * 10**9));
// are unlocked to date 10mts the amount of 3.697.382
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 11),3697382 * 10**9));
// are unlocked to date 10mts the amount of 837.375
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 12),837375 * 10**9));
// are unlocked to date 10mts the amount of 3.617.613
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 13),3617613 * 10**9));
// are unlocked to date 10mts the amount of 598.125
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 14),598125 * 10**9));
// are unlocked to date 10mts the amount of 3.073.132
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 15),3073132 * 10**9));
// are unlocked to date 10mts the amount of 598.125
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 16),598125 * 10**9));
// are unlocked to date 10mts the amount of 2.620.750
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 17),2620750 * 10**9));
// are unlocked to date 10mts the amount of 478.500
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 18),478500 * 10**9));
// are unlocked to date 10mts the amount of 478.500
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 19),478500 * 10**9));
// are unlocked to date 10mts the amount of 478.500
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 20),478500 * 10**9));
// are unlocked to date 10mts the amount of 318.988
frozenAddress[investmentsTruCity_wallet].push(Unlock(tge_time + (six_weeks_time * 21),318988 * 10**9));
