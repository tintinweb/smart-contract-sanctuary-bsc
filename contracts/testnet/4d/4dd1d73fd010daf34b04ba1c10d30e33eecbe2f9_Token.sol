...
/**
/*
Elon Ponzi - Yes! It is a Ponzi, but one with Elon's name in it.

High reflection token that aims to reward diamond hands and discourage sellers.
Being a high reflection token ensures high and regular returns.

Telegram: t.me/elonponzi.com
Website: elonponzi.com
...
contract Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "Elon Ponzi";
    string private constant _symbol = "ELONPONZI";
    ...
    Taxes public taxes = Taxes(2, 7, 1, 4, 1);
    Taxes public sellTaxes = Taxes(2, 7, 1, 4, 1);
