...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setDividendAddress(address addr) external onlyFunder {
    ...
    function setLeagueAddress(address addr) external onlyFunder {
        leagueAddress = addr;
        _feeWhiteList[addr] = true;
    }
    ...
    function tokenData() public view returns (uint256 supply, uint256 circulation, uint256 burn, uint256 marketValue) {
        ...
        marketValue = tokenEqualsToBnb(circulation);
    }
...
contract FFFToken is AbsToken {
    constructor() AbsToken(
        ...
        address(0xC5a89985D57FdddEFCE3E9f26faB99EbF471516A)//ReceiveAddress
    ){
