...
contract MoonopolyNFT is ERC721, ERC721Enumerable, Ownable, ERC2981PerTokenRoyalties, ERC721Pausable {
    ...
    event CreateMoonopolyNFT(uint256 indexed id);
	
    constructor() ERC721("Moonopoly OG NFT", "MOON") {
        pause(true);
    }
