...
contract Windmill_Updater is Base, Math, Adressable, Payable, Gas_Refundable, AccessControl, With_DAORole, With_DAOContract,
    ...
    function getFirstEndTradeNeeded() external view returns (uint256){
        ...
        require(false, "Windmill_Updater: not trade end needed");
        return 0;
    }
    ...
    function getFirstUpdateTradeNeeded() external view returns (uint256){
        ...
        require(false, "Windmill_Updater: not trade update needed");
        return 0;
    }
    ...
    function getFirstDAOOpenProposalId() external view returns (uint256){
        ...
        require(false, "Windmill_Updater: not DAO proposal update needed");
        return 0;
    }
