...
contract ExchangeCore is ReentrancyGuarded, Ownable {
    ...
    bytes32 public constant DOMAIN_SEPARATOR =
        0xacf33f3ccf5f83be4940384074a6ef11b9fe414058c73584f9f1b26b468d9514;
    ...
    event LogByte32(bytes32 logBytes32);
    event LogByte4(bytes4 logBytes4);
        ...
        returns (bool)
    {
        ...
        if (order.exchange != address(this)) {
            emit LogAddress(order.exchange);
    ...
    function _tryContractSignature(
        ...
        emit LogByte4(result);
        emit LogByte4(_EIP_1271_MAGIC_VALUE);
