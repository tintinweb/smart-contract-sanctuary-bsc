    ...
    UUPSUpgradeable
{
    ...
    function initialize(
        ...
        __ERC20_init("Maximus Invest Token", "MXI");
        __ERC20Permit_init("Maximus Invest Token");
        __Ownable_init();
        ...
        /** method from OwnerToken.sol */
        setOwner_init(); /** set owner = msg.sender */
        /** method from OwnerToken.sol */
        stakeHolderPush_init(); /** add owner to stakeHolders array */

        // Set the reward rate
        setRewardrRate(_rewardRate);
    }
...
contract Stakeable {
    ...
    function stakeHolderPush_init() internal  {
        stakeholders.push();
    }
 ...
 */
contract OwnerToken is OwnableUpgradeable {
    ...
    function setOwner_init() internal {
        _owner = msg.sender;
