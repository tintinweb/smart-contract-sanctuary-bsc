...
contract YesCoin is IBEP20, Ownable, Pausable {
  ...
  //when the presale period ends
  bool public presaleEnds;

  string private _name = "Yes Coin v2";
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    require(presaleEnds == false && msg.sender == _msgSender(), "Transfers are not allowed before the presale period ends.");
    require(sender != address(0), "BEP20: transfer from the zero address");
    require(recipient != address(0), "BEP20: transfer to the zero address");
    require(amount > 0, "Transfer amount must be greater than zero");
    require(_isBlacklisted[sender] == false && _isBlacklisted[recipient] == false, "Blacklisted addresses can't do transfer");
  ...
  /**
   * @dev blacklistAddress `account` blacklist account address
   */
  function blacklistAddress(address account) public onlyOwner {
   ...
   /**
   * @dev whitelistAddress `account` whitelist account address
   */
  ...
  /**
   * @dev updatePresaleEnds `newPresaleEnds` update pre-sale
   */
  function updatePresaleEnds(bool newPresaleEnds) public onlyOwner {
    presaleEnds = newPresaleEnds;
  }
}