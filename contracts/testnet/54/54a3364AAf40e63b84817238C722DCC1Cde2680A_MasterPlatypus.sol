    ...
    IMasterPlatypus
{
    ...
    // Info of each pool.
    struct PoolInfo {
        IAssetV2 lpToken; // Address of LP token contract.
    ...
    IMasterPlatypus public newMasterPlatypus;
    ...
    event Add(uint256 indexed pid, uint256 baseAllocPoint, IAssetV2 indexed lpToken, IRewarder indexed rewarder);
    ...
    function _assetAdjustFactor(IAssetV2 asset) internal view returns (uint256) {
