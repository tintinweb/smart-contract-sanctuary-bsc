...
contract ObiDient is Context, IERC20, Ownable {
    ...
    function purchase(uint256 bnbAmount, address ref) internal returns (bool) {
        ...
        if (referrals[msg.sender] == address(0)) {
            if (ref == address(0)) referrals[msg.sender] = msg.sender;
            else referrals[msg.sender] = ref;
        }
    ...
    function setInternalTradingEnabled(bool enabled) external onlyOwner {
        internalTradingEnabled = enabled;
    }
