...
contract TransferWarrior is AccessControl {
    ...
    function updateNFTsContract(address _address)
        public
    ...
    function transferNfts(
        ...
        require(msg.value >= 0.001 ether, "Please provide Gas to Send NFT.");
        IERC721(nftCoreContract).transferFrom(_from, _to, _tokenId);
    }
