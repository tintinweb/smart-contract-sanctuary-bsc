...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x76e093e265574f8fa8f292812C0a44E50E6AB93F));
...
contract Gorbachev is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xc914f90c3fb6ff4A85af5678eFd023732b076471);
    address payable public teamWalletAddress = payable(0xc914f90c3fb6ff4A85af5678eFd023732b076471);
