...
library Address{
 ...
 contract KAITH is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 40_000_000 * 10**9; //4%
    uint256 public maxSellLimit = 5_000_000 * 10**9; //0.5%
    uint256 public maxWalletLimit = 50_000_000 * 10**9; //5%
    
    uint256 public genesis_block;
    
    address public marketingWallet = 0xAB5EBF13421E2F62159C70b4cEdAc3c5bcED131c;
    address public buybackWallet = 0x583e4bB50E8FcAd28944a661014DDe13b2e3c0A7;

    string private constant _name = "KAITH";
    string private constant _symbol = "$KAITH";
    ...
    Taxes public taxes = Taxes(0, 4, 2, 4);
    Taxes public sellTaxes = Taxes(0, 4, 2, 4);
