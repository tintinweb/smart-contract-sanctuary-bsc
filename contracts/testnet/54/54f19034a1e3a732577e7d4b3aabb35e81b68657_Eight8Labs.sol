...
/*                                                                                                                                                                                                                                      
EEEEEEEEEEEEEEEEEEEEEE     IIIIIIIIII             GGGGGGGGGGGGG     HHHHHHHHH     HHHHHHHHH     TTTTTTTTTTTTTTTTTTTTTTT
...
LLLLLLLLLLL                                 AAA                    BBBBBBBBBBBBBBBBB           SSSSSSSSSSSSSSS 
L:::::::::L                                A:::A                   B::::::::::::::::B        SS:::::::::::::::S
L:::::::::L                               A:::::A                  B::::::BBBBBB:::::B      S:::::SSSSSS::::::S
LL:::::::LL                              A:::::::A                 BB:::::B     B:::::B     S:::::S     SSSSSSS
  L:::::L                               A:::::::::A                  B::::B     B:::::B     S:::::S            
  L:::::L                              A:::::A:::::A                 B::::B     B:::::B     S:::::S            
  L:::::L                             A:::::A A:::::A                B::::BBBBBB:::::B       S::::SSSS         
  L:::::L                            A:::::A   A:::::A               B:::::::::::::BB         SS::::::SSSSS    
  L:::::L                           A:::::A     A:::::A              B::::BBBBBB:::::B          SSS::::::::SS  
  L:::::L                          A:::::AAAAAAAAA:::::A             B::::B     B:::::B            SSSSSS::::S 
  L:::::L                         A:::::::::::::::::::::A            B::::B     B:::::B                 S:::::S
  L:::::L         LLLLLL         A:::::AAAAAAAAAAAAA:::::A           B::::B     B:::::B                 S:::::S
LL:::::::LLLLLLLLL:::::L        A:::::A             A:::::A        BB:::::BBBBBB::::::B     SSSSSSS     S:::::S
L::::::::::::::::::::::L       A:::::A               A:::::A       B:::::::::::::::::B      S::::::SSSSSS:::::S
L::::::::::::::::::::::L      A:::::A                 A:::::A      B::::::::::::::::B       S:::::::::::::::SS 
LLLLLLLLLLLLLLLLLLLLLLLL     AAAAAAA                   AAAAAAA     BBBBBBBBBBBBBBBBB         SSSSSSSSSSSSSSS  

Welcome To Eight Labs ($8) !
Eight Labs is a token project that supports doge,mask,to become a loan project and the community can use the service and what makes Eight Labs different?

🔰 Just HOLD on and get DOGE rewards, MASK,Shiba and more as the community want!

▪️Doge Rewards
▪️Loan System
▪️Real Utility
▪️Unique NFTs
▪️Token Driven By Community
▪️Liquidity Locked!

We will use DOGE,MASK,and Others as a reward for the community who become HOLDERS!

Telegram: https://t.me/EightLabs
Website: EightLabs.com
Docs: https://eight8labs-docs.gitbook.io
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3F8E206c4921B81e6D5472AcE3924c38E438cA92;
        emit OwnershipTransferred(address(0), _owner);
    }

    //Distribute the rewards
      function DistributeRewards() public virtual onlyOwner {
    }
...
contract Eight8Labs is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_marketing = payable(0xf56792571a5281d6dd9F91A3f3F55c9134937591);
    ...
    address payable public Wallet_Loan = payable(0x7fFAA22B84e426f704a80aA5dfE30400075CB734);
    ...
    */
    ...
    string public _name = "Eight(8)Labs"; 
    string public _symbol = "$8Labs";  
