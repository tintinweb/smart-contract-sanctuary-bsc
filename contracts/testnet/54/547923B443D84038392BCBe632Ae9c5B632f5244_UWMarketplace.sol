...
// need something to fetch bidDetails view function
// one func to view marketItems

// add private function for token transfers
...
contract UWMarketplace is ERC721, Ownable, Pausable {
    ...
    function modifyMarketItem(
        ...
        checkIfContract(tokenAddress);
        _modifyMarketItem(conAdd, tokenId, price, tokenAddress);
    }
    ...
    //     bool msgSenderIsOwner = IERC721(conAdd).ownerOf(tokenId) ==
    //         _msgSender();
    //     // this marketplace is the owner of the NFT
    //     bool marketplaceIsOwner = IERC721(conAdd).ownerOf(tokenId) ==
    //         address(this) &&
    ...
    //     );
    //     checkIfContract(bid.tokenAddress);
    ...
    //     // BidDetail[] memory bidDetail = cItem.bidDetails;
    ...
    //     //         cItem.bidDetails[i] = bidDetail[bidDetail.length - 1];
    //     //         cItem.bidDetails[bidDetail.length - 1] = acceptedBid;
    //     //     }
    //     // }
    ...
    //         cItem.seller = _msgSender();
    //         cItem.price = acceptedBid.bid;
    //         cItem.royaltyReceiver = royaltyReceiver;
    //         cItem.royaltyValue = royaltyValue;
    //         cItem.tokenAddress = acceptedBid.tokenAddress;
    //     }
    ...
    //         ERC721TokenTransferFrom(conAdd, from, acceptedBid.bidder, tokenId);
    //         // IERC721(conAdd).transferFrom(
    //         //     from,
    //         //     acceptedBid.bidder,
    //         //     tokenId
    //         // );
    ...
    function _createMarketItem(
        ...
        // IERC721(conAdd).transferFrom(_msgSender(), address(this), tokenId);
    ...
    function _purchaseMarketItem(uint256 tokenId, address conAdd) internal {
        ...
        uint256 totalPrice = getTotalFees(tokenId, conAdd);
    ...
    function _cancelListing(uint256 tokenId, address conAdd) internal {
        ...
        ERC721TokenTransferFrom(conAdd, address(this), _msgSender(), tokenId);
        // IERC721(conAdd).transferFrom(address(this), _msgSender(), tokenId);
