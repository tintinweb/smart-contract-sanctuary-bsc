...
contract ZaiStats is Ownable{
    ...
    function updateCounterWinLoss(uint256 _zaiId,uint256 _challengerId, uint256[30] memory _fightProgress, IRanking IRank) external onlyFight returns(bool){
    ...
    function _updateTotalFights(IRanking IRank) internal {
        (uint256 dayNumber,uint256 weekNumber) = IRank.getDayAndWeekRankingCounter();
