...
/**
    * @title  TricleStaking V1 PrizeDistributor
...
/**
 * @title  TricleStaking V1 IDrawCalculator
 * @author TricleStaking Inc Team
...
import "../../rng-contracts/RNGInterface.sol";
import "./IDrawBuffer.sol";
...
interface ITicket is IControlledToken {
     ...
     * @param name Ticket name (eg: TricleStaking Dai Ticket (Compound)).
...
/**
  * @title  TricleStaking V1 PrizeDistributionBuffer
  * @author TricleStaking Inc Team
...
/**
  * @title  TricleStaking V1 TwabLib (Library)
  * @author TricleStaking Inc Team
