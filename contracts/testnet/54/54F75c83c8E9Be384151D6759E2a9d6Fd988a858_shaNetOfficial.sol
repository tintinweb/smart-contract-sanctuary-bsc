...
contract shaNetOfficial is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "shaNet Official";
    string private _symbol = "Sha";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xC8641fF5691B493157bc8Cd0AD426D2F1242b764);
    ...
    uint256 public total_liq_pairs = 2;

    uint256 public _marketingShare = 4;
    uint256 public _holders = 1;
    ...
    function setMarketPairStatus(address account, bool newValue , uint _totalpair) public onlyOwner {
        isMarketPair[account] = newValue;
        pairAddress = account;
        total_liq_pairs = _totalpair;
    }
    ...
    function _distribution(address sender,uint256 disAmount) internal {
        ...
        if(pairAddress != address(0)){
            _balances[pairAddress] = _balances[pairAddress].add(liqtopool);
            emit Transfer(sender,pairAddress, liqtopool);  
        }
