      ...
      for (uint256 i = 0; i < _users.length ; ++i) {
        ...
        if ((_depositAlphaTotal > 0) && (_depositAlpha > 0)){
            ...
            _depositAlpha = _depositAlpha + ((_depositAlpha) * _feeRateParity)
                /_factorFeesDecimals;
            token.setUserAmountDeposit( _user, _depositAlpha, 0);
            token.setUserAmount(_user, _alpha, 0);
        }
        ...
        if ((_withdrawalAlphaTotal >0) && (_withdrawalAlpha > 0)){
            ...
            token.setUserAmountWithdraw(_user, _withdrawalAlpha, 0);
      ...
      for (uint256 i = 0; i < _users.length ; ++i) {
        ...
        if ((_depositBetaTotal > 0) && (_depositBeta > 0)){
            ...
            _depositBeta = _depositBeta + ((_depositBeta) * _feeRateParity)
                /_factorFeesDecimals;
            token.setUserAmountDeposit( _user, _depositBeta, 1);
            token.setUserAmount(_user, _beta, 1);
        }
        ...
        if ((_withdrawalBetaTotal > 0) && (_withdrawalBeta > 0)){
            ...
            token.setUserAmountWithdraw(_user, _withdrawalBeta, 1);
      ...
      for (uint256 i = 0; i < _users.length ; ++i) {
        ...
        if ((_depositGammaTotal >0) && (_depositGamma > 0)){
            ...
            _depositGamma= _depositGamma + ((_depositGamma) * _feeRateParity)
                /_factorFeesDecimals;
            token.setUserAmountDeposit( _user, _depositGamma, 2);
            token.setUserAmount(_user, _gamma, 2);
        }
        ...
        if ((_withdrawalGammaTotal >0) && (_withdrawalGamma > 0)){
            ...
            token.setUserAmountWithdraw(_user, _withdrawalGamma, 2);
