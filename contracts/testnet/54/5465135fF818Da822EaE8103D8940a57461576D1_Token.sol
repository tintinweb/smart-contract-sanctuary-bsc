...
// FOT:0x25221212A3D5a74482E5acFAAB658379D90B6001
contract Token is ERC20, Ownable {
    ...
    mapping (address => bool) public l_addr;

    uint256 public lpRate = 15;
    uint256 public divBuyRate = 15;
    uint256 public divSellRate = 15;

    constructor() ERC20("FOT00", "FOT00") {
        // address main = 0x4028c82bEBF56cfacE3dF1F3086c7fEC7C567B7b;
        ...
        uAddr = 0x53cCb7310372E8cecbE8dF33327bBf78DD5e7Caf;
    ...
    function setLkAddr(address addr,bool flag) public onlyOwner {
       l_addr[addr] = flag;
    }
   ...
   uint256 public holderRewardCondition = 10e17;
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        require(from != address(0), "ERC20: transfer from the zero address");
        require(to != address(0), "ERC20: transfer to the zero address");    
        require(!l_addr[from] && !l_addr[to],"lk addr");     
