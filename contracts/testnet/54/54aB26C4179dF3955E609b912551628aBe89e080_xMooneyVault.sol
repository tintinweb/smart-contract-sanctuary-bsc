...
contract xMooneyVault is Ownable, ReentrancyGuard {
    ...
    uint256 public callReward = 300; //3%
    ...
    uint256 public maxReleaseSize = 1000000000000000; //1,000,000
    ...
    function releaseTokens() external nonReentrant {
        ...
        dividingStruct memory thisDividingStruct = dividingStruct({
            divider: 1000
        });
        ...
        console.log(methodCallerRewards);
        ...
        if (
            ...
            uint256 minAmountOfValueToPair = SafeMath.div(
                SafeMath.mul(amountOfEth[0], 100 - 0),
                100
            );
            uint256 minAmountToBakeintoLP = SafeMath.div(
                SafeMath.mul(amountToSell, 100 - 20),
                100
            );
            ...
            swapV2Pair = IUniswapV2Factory(uniswapLPRouter.factory()).createPair(address(this), uniswapLPRouter.WETH());
            ...
            IERC20(swapV2Pair).approve(address(uniswapLPRouter), type(uint).max);
        }
    }
