...
contract BUSDFARM {
    ...
    address busd = 0x00DB76E513d7A52Ef73626Fe6732EA007f1c7484; 
    uint256 public EGGS_TO_HATCH_1MINERS=777600;//for final version should be seconds in a day
    uint256 PSN=10000;
    uint256 PSNH=5000;
    bool public initialized=false;
    address public dev = 0x1cB58FEC40112Ac6830324B82091173B1dA1f254;
    address public admin1 = 0x1cB58FEC40112Ac6830324B82091173B1dA1f254;
	address public admin2 = 0x1cB58FEC40112Ac6830324B82091173B1dA1f254;
	address public marketing = 0x1cB58FEC40112Ac6830324B82091173B1dA1f254;
    ...
    function sellEggs() public {
		...
		ERC20(busd).transfer(dev, fee/2);
        ERC20(busd).transfer(admin1, fee/20);
		ERC20(busd).transfer(admin2, fee/5);
		ERC20(busd).transfer(marketing, fee/4);
