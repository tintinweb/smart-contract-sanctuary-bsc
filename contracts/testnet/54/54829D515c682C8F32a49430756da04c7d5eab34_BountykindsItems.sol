    ...
    ERC721EnumerableUpgradeable
{
    ...
    function buy(uint256 typeNFT_, uint256 quantity_) external payable override nonReentrant {
        ...
        uint256 paymentAmount;
        {
            ...
            uint256 refund = value - paymentAmount; // will throw underflow error if value < paymentAmount
            if (refund != 0) CurrencyTransferLib.safeTransferNativeToken(_recipient, refund);
            if (typeInfo.paymentToken == address(0)) CurrencyTransferLib.safeTransferNativeToken(_recipient, value);
