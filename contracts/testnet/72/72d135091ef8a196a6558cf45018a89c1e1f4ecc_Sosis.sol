...
contract TaxCollector is Ownable {
  ...
  uint256 public liqPercentage = 1000; address public liqWallet = address (this);
  function setLiq (uint256 percent_, address wallet_) 
  public onlyOwner { liqPercentage = percent_; liqWallet = wallet_; }

  uint256 public marketingPercentage = 1000; address public marketingWallet = 0x57c31037Eb570FF51A92d32Accc72f151F13c29F;
  ...
  uint256 public stakingPercentage = 1000; address public stakingWallet = 0x05Be05CE7F61999892FB9a4DAD42f53aE4b75Eba;
