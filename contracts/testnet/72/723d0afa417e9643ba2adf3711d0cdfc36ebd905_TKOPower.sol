...
contract TKOPower is ERC20, Ownable, ReentrancyGuard {
    ...
    function lock(uint256 amount) external nonReentrant {
        ...
        uint256 power = 0;
        if (amount >= 100e18 && amount < 400e18) {
            power = (amount / 100);
        } else if (amount >= 400e18 && amount < 1200e18) {
            power = (amount * 11 / 1000) ;
        } else if (amount >= 1200e18 && amount < 4000e18) {
            power =  amount * 115 /10000;
        } else if (amount >= 4000e18 && amount < 12000e18) {
            power = (amount * 12 / 1000) ;
        } else if (amount > 4000e18) {
            power = (amount * 125 / 10000);
        }
