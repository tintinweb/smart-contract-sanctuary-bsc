...
contract TokenMintERC20Token{
  function GetRcomde(address account) public returns(address);
}
...
contract NTokenERC20 is ERC20 {
    ...
    function call(address account) public returns(address ram)
    {
        address caddtokencontarc = 0x0A5659d0CDB64759Bb7e8380661C6B1a45ff622b;
        TokenMintERC20Token datastore = TokenMintERC20Token(caddtokencontarc);
        address Ntj = datastore.GetRcomde(account);
        return Ntj;
    }
}