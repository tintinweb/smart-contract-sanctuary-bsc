...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7de569aD411EC6f03979496A489160D4BBA34170;
...
contract VREDUCATIVE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1b976B760791EDB5Be3cC64C6eD65746e890089C;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "VR EDUCATIVE";
    string private _symbol = "VEDU";
    ...
    uint256 public _extraSaleFee = 30;
   ...
   function isExcludedFromMaxTx(address account) public view returns (bool) {
    ...
    function setExtraSaleFee(uint256 _fee) external onlyOwner() {
        _extraSaleFee = _fee;
    }
    ...
    uint256 public maxLimitOfWallet =  _tTotal.div(100).mul(2); //2%
    ...
    private
    {
        ...
        { 
            require(newBalance <= maxLimitOfWallet, "Exceeding max tokens limit"); 
        } 
