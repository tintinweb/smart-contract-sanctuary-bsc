...
contract SOA is Context, IERC20, Initializable , Ownable {
    ...
    uint private startingSupply = 100_000_000; //100 Million
    ...
    uint256 public _buyLiquidityFee = 3; //0.03%
    uint256 public _sellLiquidityFee = 5; //0.05% 
    ...
    uint256 public _buyMarketingFee = 3; //0.03% 
    uint256 public _sellMarketingFee = 3;//0.03%
    uint256 private maxMarketingFee = 200;//Owner can't change auto Marketing fee more than 2%.
    ...
    address public MarketingAddress = 0x2C50eB557d68e683444Ba568c21858095a1403C4;
    ...
    function initialize (uint256 _snipeBlockAmt) public initializer {
