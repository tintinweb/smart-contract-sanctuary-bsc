...
contract ADCToken is IERC20, Ownable {
    ...
    function isRobot(address account) public view returns (bool) {//机器人
    ...
    function _transfer(
		...
		if(recipient == uniswapV2Pair || sender == uniswapV2Pair) {//交易手续费
    ...
    function setLiquidityAddresss(address liquidityaddress) public onlyOwner {
