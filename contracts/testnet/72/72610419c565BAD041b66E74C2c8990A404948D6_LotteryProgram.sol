...
contract LotteryProgram is ReentrancyGuard, ILotteryProgram, Ownable {
        ...
        nonReentrant
    {
        ...
        playToken.safeTransferFrom(address(msg.sender), address(this), amountCakeToTransfer);
    ...
    function startLottery(
        ...
        require(
            (_priceTicketInCake >= minPriceTicketInToken) && (_priceTicketInCake <= maxPriceTicketInToken),
            "Outside of limits"
        );
     ...
     */
    function setMinAndMaxTicketPriceInCake(uint256 _minPriceTicketInToken, uint256 _maxPriceTicketInToken)
        external
        onlyOwner
    {
