...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xdCB8325311729304A4f0CF27119710d545375Fa6;
...
contract PERKOMI is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xdCB8325311729304A4f0CF27119710d545375Fa6;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PERKOMI";
    string private _symbol = "PERKOMI";
