...
contract DinoLokey_Miner_V2 is Context, Ownable , ReentrancyGuard {
    using SafeMath for uint256;
    uint256 public constant min = 5 ether; //min deposite 10 busd
    uint256 public constant max = 10000 ether; //max deposite 10000 busd
    uint256 public roi = 16; //16% daily reward
    uint256 public constant fee = 4; //4%*1 dev fee, 4%*1 dev2 fee = Total 8% Deposite Fee
    uint256 public constant withdraw_fee = 4; //4%*1 dev fee, 4%*1 dev2 fee
    uint256 public constant ref_fee = 15; //referral reward 15%
    address public dev = 0xdf73a2C442BC763C5f6a03322EFE87f60ee85DBA;
    address public dev2 = 0xdf73a2C442BC763C5f6a03322EFE87f60ee85DBA;
 ...
 function withdrawal() public noReentrant {
    ...
    uint256 totalAmountToWithdraw = SafeMath.sub(aval_withdraw2,wFee*2); 
