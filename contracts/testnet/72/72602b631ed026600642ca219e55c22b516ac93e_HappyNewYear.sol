...
/**
Happy New Year SmartContract on Binance Smart Chain
...
contract HappyNewYear is ERC20, Ownable {
    ...
    HappyNewYearDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Happy New Year", "HNY") {
        marketingWallet = payable(0xDEAD82177fbc1226b60589c6a1C7bEb2F02ffe87);
        devWallet = payable(0xDEAD82177fbc1226b60589c6a1C7bEb2F02ffe87);
        ...
        dividendTracker = new HappyNewYearDividendTracker(
            payable(this),
            router,
            0xDEAD82177fbc1226b60589c6a1C7bEb2F02ffe87,
            "HappyNewYearTRACKER",
            "HNYTRACKER"
        );
        ...
        uint256 totalTokenSupply = (202_300) * (10**18);
...
contract HappyNewYearDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    HappyNewYear public HappyNewYearContract;
    ...
    constructor(
        ...
        defaultToken = token;
        HappyNewYearContract = HappyNewYear(mainContract);
    ...
    function _transfer(
        ...
        require(false, "HappyNewYear_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "HappyNewYear_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HappyNewYear contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(HappyNewYearContract);

            uint256 prevBalance = HappyNewYearContract.balanceOf(address(this));
            ...
            {
                uint256 received = HappyNewYearContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    HappyNewYearContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
