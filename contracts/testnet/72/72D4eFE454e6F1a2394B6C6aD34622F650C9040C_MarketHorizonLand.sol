...
contract MarketHorizonLand is Ownable, AccessControl, Pausable {
    ...
    event TokenBought(uint256 id, int256 x, int256 y, uint256 indexSale, address buyer);
    event Offered(uint256 id, int256 x, int256 y, uint256 indexSale, uint256 offerId, uint256 amount, address offerOwner);
    event OfferSelected(uint256 id, int256 x, int256 y, uint256 indexSale, uint256 offerId);
    ...
    // itemToOffer[itemId][indexSale][offerId] to get offer
    ...
    function buyNFTisSale(int256 x, int256 y) external {
        ...
        emit TokenBought(tokenId, x, y, indexSale, _msgSender());
    }
    ...
    function offerLand(
        ...
        emit Offered(tokenId, x, y, indexSale, offerId, amountOffer, _msgSender());
    }
    ...
    function selectOfferWhenAdminSale(
        ...
        emit OfferSelected(tokenId, x, y, indexSale, offerId);
    }
