...
contract Token is ERC20Burnable, Operator {
    ...
    uint256 public INITIAL_GENESIS_POOL_DISTRIBUTION;
...
// File contracts/Tokens/BitATOMToken.sol

pragma solidity 0.6.12;

contract BitATOMToken is Token {
    constructor(
        string memory name_,
        string memory symbol_,
        uint8 decimals_,
        ...
        // Initial distribution for the first 24h genesis pools
        INITIAL_GENESIS_POOL_DISTRIBUTION = 35000 ether;
