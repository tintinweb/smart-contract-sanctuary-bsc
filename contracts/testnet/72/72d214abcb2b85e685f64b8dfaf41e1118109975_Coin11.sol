...
contract Coin11 is Initializable, ContextUpgradeable, OwnableUpgradeable, BEP20 {
    ...
    address payable  marketingTaxWallet;
    address payable liquidityTaxWallet;

    address public _marketingTaxWallet;
    ...
    function initialize () external initializer
    {
        ...
        _symbol = "Test9191";
        _supply = 10000000;
        _liquidityTaxWallet = liquidityTaxWallet;
        _marketingTaxWallet = marketingTaxWallet;
        _marketingTaxWallet = 0x7ed5A5a6068c703aFd86e71E7acda14A1BED4607;
        _liquidityTaxWallet = 0x7ed5A5a6068c703aFd86e71E7acda14A1BED4607;
        initialSupply =_supply * (10**18);
        uniswapV2Router02 = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        uniswapV2Factory = IUniswapV2Factory(uniswapV2Router02.factory());
        denominator = 100;
        taxStatus = true;
        swapThreshold = 100 wei; // The contract will only swap to ETH, once the fee tokens reach the specified threshold
        marketingTaxBuy = 5;
        liquidityTaxBuy = 10;
        marketingTaxSell = 5;
        liquidityTaxSell = 10 ;
        ...
        if(!isExcluded(from) && !isExcluded(to)) {
            ...
            if(from == address(uniswapV2Pair)) {
                ...
                liquidityTokens += baseUnit * liquidityTaxBuy;
                 ...
                 if(tax > 0) {
                    _transfer(from, marketingTaxWallet, marketingTokens); 
                    _transfer(from, liquidityTaxWallet, liquidityTokens); 
                }
     ...
     */
    function setTaxWallets(address payable marketing) public  onlyOwner {
