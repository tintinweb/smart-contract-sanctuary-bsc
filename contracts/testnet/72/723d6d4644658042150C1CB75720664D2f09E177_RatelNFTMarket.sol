...
contract RatelNFTMarket is IERC721Receiver, Ownable, ReentrancyGuard, Pausable{
  ...
  function createMarketItem(
    ...
    //触发事件
    emit MarketItemCreated(itemId, nftContract, tokenId, msg.sender, address(this), price, priceHRGT, false); 
    ...
    returns(bool)
  {
    ...
    //触发事件
    emit OnMarketItemSold(itemId, nftContract, tokenId, msg.sender, address(this), price, priceHRGT);    
