...
contract EXP is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _totalSupply = 42500000000*10**18;
    ...
    address payable public blockchaindevelopmentAddress;
    ...
    function SetMarketingPercent(uint256 _marketingPercent) onlyOwner public {
     ...
     function SetBlockChainDevelopmentAddress(address payable  _blockchaindevelopmentAddress) onlyOwner public {
        blockchaindevelopmentAddress = _blockchaindevelopmentAddress;
    }
    
    function SetBlockChainDevelopmentPercent(uint256 _blockchaindevelopmentPercent) onlyOwner public {
        blockchaindevelopmentPercent = _blockchaindevelopmentPercent;
    }
