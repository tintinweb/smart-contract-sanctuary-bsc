...
contract PhantomClub is ERC1155Supply, Ownable, Pausable {
    ...
    function setGOLDPASSSaleState() public onlyOwner {
        saleIsActive_GOLDPASS = !saleIsActive_GOLDPASS;
    }
    ...
    function MintStandardPass(uint16 numberOfTokens) external payable {
        require(saleIsActive_STANDARDPASS, "Inactive");
    ...
    function MintGoldPass(uint16 numberOfTokens) external payable {
        require(saleIsActive_GOLDPASS, "Inactive");
