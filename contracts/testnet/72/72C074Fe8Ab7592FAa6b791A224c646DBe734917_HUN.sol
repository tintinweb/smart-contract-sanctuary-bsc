...
contract HUN is Context, IERC20 {
    ...
    string private constant _name = "Hun"; 
    string private constant _symbol = "HTC"; 
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount.mul(_Tax_On_Buy).div(10**2);
            uint256 tTransferAmount = tAmount-buyFEE;

            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tTransferAmount;
            _tOwned[address(Wallet_Marketing)] = _tOwned[address(Wallet_Marketing)]+buyFEE; 
            ...
            uint256 sellFEE = tAmount.mul(_Tax_On_Sell).div(10**2);
            uint256 tTransferAmount = tAmount-sellFEE;

            _tOwned[sender] = _tOwned[sender]-tAmount;
            _tOwned[recipient] = _tOwned[recipient]+tTransferAmount;
            _tOwned[address(Wallet_Dev)] = _tOwned[address(Wallet_Dev)]+sellFEE; 
