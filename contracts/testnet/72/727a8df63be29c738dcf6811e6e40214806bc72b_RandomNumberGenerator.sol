...
// File: contracts/interfaces/IPriziumLottery.sol
//RNG-01
pragma solidity 0.8.4;

interface IPriziumLottery {
    /**
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Prizium lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == priziumLottery, "Only PriziumLottery");
    ...
    /**
     * @notice Set the address for the PriziumLottery
     * @param _priziumLottery: address of the Prizium lottery
     */
    function setLotteryAddress(address _priziumLottery) external onlyOwner {
        priziumLottery = _priziumLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPriziumLottery(priziumLottery).viewCurrentLotteryId();
    }
}