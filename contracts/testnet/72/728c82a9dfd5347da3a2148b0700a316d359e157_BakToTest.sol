...
//This is first ever Brain Freezing thing for you got it. It will major headache and you will crack yourself up if you aren't a anime fan. So better avoid it. Join our Telegram @BakaToTest for more info.
...
contract BakToTest is IERC20, Ownable {
    using SafeMath for uint256;
