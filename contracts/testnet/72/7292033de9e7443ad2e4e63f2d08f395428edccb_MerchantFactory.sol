...
contract MerchantFactory is MerchantSharedProperty {
    constructor() {
        ...
        updateMainSwapRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Default main swap router, pancakev2 router
        addSwapRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Default swap router, pancakev2 router
