...
//        b8dToken.burn(amount);
    ...
    function _buy(
        ...
        uint256 actualPrice = _prices[status];
        uint256 b8dAmount = busdCount.div(actualPrice) * 10**uint(decimals);
        uint256 b8dAmount1 = busdCount.div(1000000000000000000);
        uint256 b8dAmount2 = busdCount / 1000000000000000000;
        uint256 b8dAmount3 = actualPrice / 1000000000000000000;
