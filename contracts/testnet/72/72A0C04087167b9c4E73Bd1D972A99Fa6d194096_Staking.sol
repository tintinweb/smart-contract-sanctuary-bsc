...
contract Staking {
    ...
    uint256 thirtyDaysRewardPercentage = 9;
    uint256 fortyfiveDaysRewardPercentage = 18;
    uint256 sixtyDaysRewardPercentage = 27;
    uint256 seventyfiveDaysRewardPercentage = 36;
    ...
    function updateRewardPercentage(uint256 _thirtyDaysRewardPercentage, uint256 _fortyfiveDaysRewardPercentage, uint256 _sixtyDaysRewardPercentage, uint256 _seventyfiveDaysRewardPercentage) public onlyOwner() {
        thirtyDaysRewardPercentage = _thirtyDaysRewardPercentage;
        fortyfiveDaysRewardPercentage = _fortyfiveDaysRewardPercentage;
        sixtyDaysRewardPercentage = _sixtyDaysRewardPercentage;
        seventyfiveDaysRewardPercentage = _seventyfiveDaysRewardPercentage;
    }
    ...
    function stakeToken(uint256 _amount, uint256 _timePeriod) public returns(uint256) {
        require(_timePeriod == 30 || _timePeriod == 45 || _timePeriod == 60 || _timePeriod == 75);
    ...
    function calculateReward(uint256 _stakeID) public view returns(uint256) {
        ...
        if(stakes[_stakeID].numberOfDays == 30) {
            rewardPercentage = thirtyDaysRewardPercentage;
        } else if(stakes[_stakeID].numberOfDays == 45) {
            rewardPercentage = fortyfiveDaysRewardPercentage;
        } else if(stakes[_stakeID].numberOfDays == 60) {
            rewardPercentage = sixtyDaysRewardPercentage;
        } else {
            rewardPercentage = seventyfiveDaysRewardPercentage;
        }
