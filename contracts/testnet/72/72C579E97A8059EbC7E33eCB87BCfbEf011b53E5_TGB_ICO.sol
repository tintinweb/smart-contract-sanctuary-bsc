...
contract TGB_ICO is Ownable {
  ...
  uint256 public  RATE = 5555; // Number of tokens per 1 BNB At Aug 30, 2022 00:00
  uint256 public  CAP = 540; // Cap in BNB
  uint256 public  START = 1661812465; // Aug 30, 2022
  uint256 public  DAYS = 30; // 30 Days , 1 month
  // The minimum amount of Wei you must pay to participate in the TGB_ICO
  uint256 public  MinPurchase = 35 * 1e16; /** 0.035 BNB  **/
