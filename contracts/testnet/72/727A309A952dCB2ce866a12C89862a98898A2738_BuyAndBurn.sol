...
contract BuyAndBurn is OwnableUpgradeable {
    ...
    function buyAndBurnToken(
        ...
        if (_wantAdd != _rewardToken) {
            uint256 burnAmt = IERC20Upgradeable(_rewardToken).balanceOf(address(this));
            IERC20Upgradeable(_wantAdd).safeIncreaseAllowance(pancakeRouter, _wantAmt);
            ...
            burnAmt = IERC20Upgradeable(_rewardToken).balanceOf(address(this)) - burnAmt;
