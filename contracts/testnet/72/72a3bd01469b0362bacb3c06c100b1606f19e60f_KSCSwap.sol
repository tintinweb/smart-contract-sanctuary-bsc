...
contract KSCSwap is Ownable {
    ...
    AggregatorV3Interface public priceFeedBNBUSD;

    constructor() Ownable(msg.sender) {
        token = IERC20(0x261b038d3cB4741795802eb52473BbD37Df06587);
        ...
        usdt = IERC20(0x2Ee56026B92BaDff9c30a61f82058451A70fAbb5);
        tokenPerUsd = 3;
    ...
    function addTokenUSDT(address _token) public onlyOwner {
        usdt = IERC20(_token);
    }
    ...
    function transferTokensusdt() public onlyOwner {
        ...
        usdt.transfer(msg.sender, getContractBalacneusdt());
    }
