...
contract HUHU is IBEP20, Auth {
    ...
    string constant _name = "HUHU";
    string constant _symbol = "$HUHU";
    ...
    function MTXP(uint256 MTXP_1) external onlyOwner() {
        _maxTxAmount = (_totalSupply * MTXP_1 ) / 1000;
    }
    ...
    function CDE(bool CDE_1, uint8 CDE_2, bool CDE_3, uint8 CDE_4) public onlyOwner {
        buyCooldownEnabled = CDE_1;
        buyCooldownTimerInterval = CDE_2;
        sellCooldownEnabled = CDE_3;
        sellCooldownTimerInterval = CDE_4;
    }
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBTurd = amountBNB.mul(turdFee).div(totalBNBFee);
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _turdFee, uint256 _feeDenominator) external authorized {
