...
contract BurnHeaIngame is AccessControl {
    using SafeMath for uint;
    using SafeBEP20 for IBEP20;
    IERC721 public heroesNFT;
    bytes32 public constant BURNER = keccak256("BURNER");
    constructor(address _heroesNft) {
    ...
    function burnHero(uint256[] memory tokenId) external {
        require(hasRole(BURNER, address(msg.sender)), "Caller is not a buner");
