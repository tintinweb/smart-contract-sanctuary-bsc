...
contract DefiProStaking is  Ownable {
  ...
  event Stake (address user,uint256 optionId, uint256 stakeAmount);
  event capitalWithdraw (address user,uint256 capitalAmount);
  event unstake (address user,uint256 unstakeAmount);

  IERC20 public busdToken = IERC20(0xA877fB848CEce74237b9be5B608857b3758f543e);
...
//   uint public InterestPercent = 43200;// in Hours ;
  ...
  constructor() {  
        ...
        coinlist["BUSD"] = CoinList(2,"BUSD",AggregatorV3Interface(0x9331b55D9830EF609A2aBCfAc0FBCE050A52fdEa),IERC20(0xA877fB848CEce74237b9be5B608857b3758f543e),true);
        coinlist["CAKE"] = CoinList(3,"CAKE",AggregatorV3Interface(0x81faeDDfeBc2F8Ac524327d70Cf913001732224C),IERC20(0x2EF7CA476457192Ebf3B5D437699102E5d997B29),true);
        coinlist["BTC"] = CoinList(4,"BTC",AggregatorV3Interface(0x5741306c21795FdCBb9b265Ea0255F499DFe515C),IERC20(0xf999Dc75e3Cb1273386f33C1e04bA44A61eF5d50),true);
        coinlist["ETH"] = CoinList(5,"ETH",AggregatorV3Interface(0x143db3CEEfbdfe5631aDD3E50f7614B6ba708BA7),IERC20(0x34E1AF1B2ccd5186f8632d32668B0eFd9F2bE5EC),true);
