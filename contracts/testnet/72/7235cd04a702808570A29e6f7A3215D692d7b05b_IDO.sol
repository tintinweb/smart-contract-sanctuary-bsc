...
contract IDO is Ownable, ReentrancyGuard {
     ...
     * @param _superior superior address
     */
    function deposite(address _superior) payable external {
        // open time
        ...
        require(address(this).balance <= crowdFundMax, "Crowdfund end");
        ...
        require(userDep.superior == address(0), "You can only participate once");
