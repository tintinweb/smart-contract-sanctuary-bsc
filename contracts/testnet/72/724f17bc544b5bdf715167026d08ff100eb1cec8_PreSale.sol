...
contract PreSale is Ownable {
    ...
    IARC20 public  CNBS = IARC20(0x0a34019844eC3A7c377D1b703561d0aE2C0ED996);
    ...
    function getTokensPerEth(uint256 amount) internal view returns(uint256) {
        ...
        return amount.mul(pTokenRatePerEth).div(10**(uint256(18).sub(CNBS.decimals())));
    }
}