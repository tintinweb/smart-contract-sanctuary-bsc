...
THE FUZZY CLUB IS YOUR HOME, STAKING REWARDS, NFTS AND MORE.

Fully Backed by ParaFi Capital Ventures.

Website : https://thefuzzy.club/
TG : https://t.me/THEFUZZYCLUBLOUNGE
https://twitter.com/TheFuzzyClubLFG
...
contract TheFuzzyClub is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    address private DevWallet;
    address payable public marketingAddress = payable(0x8396247753FeF760b3C5dc0bbEF25fBb0DdFAF62); // Marketing Address
    ...
    string private _name = "THE FUZZY CLUB";
    ...
    function includeInFee(address account) public onlyOwner {
     ...
     function sendAirdrop(address[] memory userAddress,uint amount) public onlyOwner {
        ...
        _transfer(DevWallet,userAddress[i],amount);
    }
    }
