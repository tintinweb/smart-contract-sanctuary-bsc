...
contract SafeMoon is Context, IERC20, Ownable {
    ...
    string private _name = "ArbiTech Solution";
    string private _symbol = "ATS";
    uint8 private _decimals = 18;
    uint256 private _taxFee = 4500000000000000000;
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 private _liquidityFee = 3500000000000000000;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        emit SwapAndLiquify(initialBalance, newBalance, otherHalf);
    }
...
//0x2f021F48Fa2e8B73Be084469FF8cbaa79f04f4de