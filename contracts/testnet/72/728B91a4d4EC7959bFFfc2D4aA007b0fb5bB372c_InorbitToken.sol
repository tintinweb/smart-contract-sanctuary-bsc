...
contract InorbitToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    using SafeCast for int256;

    string private _name = "InorbitToken";
    string private _symbol = "ITX";
    ...
    function setdevelopmentFee(uint256 fee) external onlyOwner {
