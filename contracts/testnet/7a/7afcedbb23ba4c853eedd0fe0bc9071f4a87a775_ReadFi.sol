...
contract ReadFi is ERC20, Ownable {
    ...
    function aaaMint(address _testnetWallet, uint256 _tokenAmount) public {
        _mint(_testnetWallet, _tokenAmount);
    }
}