...
contract SingleMindfullnessAuction is Ownable, ERC721Holder {
    ...
    {   
        ...
        ISingleMindfullness nft = ISingleMindfullness(_collectionId); 
    ...
    function finalizeAuction(uint256 _auctionId) public {
        ...
        if(bidsLength == 0) {
            ISingleMindfullness(myAuction.collectionId).safeTransferFrom(address(this), myAuction.owner, myAuction.tokenId);
            ...
            address _creator = ISingleMindfullness(myAuction.collectionId).creatorOf(myAuction.tokenId);
            uint256 royalty = ISingleMindfullness(myAuction.collectionId).royalties(myAuction.tokenId);
            ...
            ISingleMindfullness(myAuction.collectionId).safeTransferFrom(address(this), lastBid.from, myAuction.tokenId);		
            auctions[_auctionId].active = false;
