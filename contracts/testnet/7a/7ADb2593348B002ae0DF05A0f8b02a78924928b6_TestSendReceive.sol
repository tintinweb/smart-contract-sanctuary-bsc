...
// File sgn-v2-contracts/contracts/interfaces/IPeggedTokenBrid[email protected]
...
contract TestSendReceive {
    ...
    function sendMoney(
        ...
        bytes memory message = abi.encode(nonce, 123, "hey");
    ...
    event ShouldTransfer(address token, address account, uint256 amount);
