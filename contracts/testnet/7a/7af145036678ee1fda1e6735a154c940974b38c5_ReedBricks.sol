...
contract ReedBricks is ERC20Burnable, ERC20Pausable, ERC1363, TokenRecover {
    ...
    address payable public BDA = payable(0x63841FFdDfB1e275a9eC163e0332962E27fD5AAb);
    // Staking Address (STK)
    address payable public STK = payable(0x63841FFdDfB1e275a9eC163e0332962E27fD5AAb);

    // REED tokens to balance the economy of the assets
    // Minting can only be done to the TRS and burning are
    // done from the TRS too.
    address payable public TRS = payable(0x63841FFdDfB1e275a9eC163e0332962E27fD5AAb); // Treasury Address (TRS)
    ...
    modifier canMint() {
        require(!_mintingFinished, "REED: minting is finished");
        _;
    }
    ...
    // Minting can be locked forever and more minting cannot happen to protect investors//
     ...
     */
    function lockMinting() external canMint{
        _lockMinting();
    }
     ...
     * @dev Function to stop minting new tokens.
     */
    function _lockMinting() internal virtual {
