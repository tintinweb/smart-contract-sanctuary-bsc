...
contract MasterKey2_2 is ERC721A, Ownable,Pausable,IMK {
 IContracts_TITIMITI Contr;
   ...
   string private URL;
    ...
    constructor( ) ERC721A("MasterKey2_2 - NFT by TITIMITI", "MK2_2", 10, 500000) {
