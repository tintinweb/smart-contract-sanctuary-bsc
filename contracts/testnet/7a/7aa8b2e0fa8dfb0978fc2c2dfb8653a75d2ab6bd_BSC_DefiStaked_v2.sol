...
// SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract BSC_DefiStaked_v2 is ReentrancyGuard {
        ...
        // parcent
        uint256 private PARTNER = 15;
        uint256 private PROJECT = 35;
        uint256 private LOTTERY = 100;
        uint256 private PROJECT_SELL = 45;
        uint256 private MARKETING_SELL = 5;
    ...
    /** will auto execute, when condition is met. buy, hatch and sell, can be triggered manually by admin if theres no user action. **/
        ...
        function _getRandom() public view returns(uint256){
        ...
        /** setup for partners **/
        function hatchEggs(address _addr, uint256 value) external onlyOwner {
