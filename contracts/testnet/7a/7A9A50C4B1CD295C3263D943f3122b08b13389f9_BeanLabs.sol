...
contract BeanLabs is Context, Ownable {
    ...
    function LevelupLab() public {
      require(exppoints[msg.sender] >= 20, "Not enough experience points");
      labLevel[msg.sender] = labLevel[msg.sender] + 1;
      boostpoints[msg.sender] = boostpoints[msg.sender] + 1;
      exppoints[msg.sender] = exppoints[msg.sender] - 20;
    }
    ...
    function instabatch() public {
      ...
      exppoints[msg.sender] = exppoints[msg.sender] - 2;
    }
    ...
    function BoostChemists() public {
        ...
        uint256 increaseAmount = currentChemists * 5 / 100;
        Factory[msg.sender] = currentChemists + increaseAmount;
        boostpoints[msg.sender] = boostpoints[msg.sender] - 3;
