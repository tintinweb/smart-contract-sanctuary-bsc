...
contract TRDCvalut is BEP20 {
    ...
    address public currency = 0x64544969ed7EBf5f083679233325356EbE738930; //0x7e8DB69dcff9209E486a100e611B0af300c3374e; TRDC
    address public dEaD= 0x000000000000000000000000000000000000dEaD;
    uint256 public paymentAmount = 1;
    uint256 fractions = 10** 18;
    uint256 public cardPrice = 1 * fractions;
    uint256 cardPower;
    uint number;
  ...
  function buyCard(uint256 payInTRDC) external {
      require(payInTRDC >= cardPrice, "Please pay the right price of the Playing Card");
      getPower();
      iBEP20(currency).approve(address(this), payInTRDC);
      emit BuyCard(msg.sender, 1);
      iBEP20(currency).transferFrom(msg.sender, address(this), payInTRDC);//Trasfer from User to this contract TRDC token (price of game card)
