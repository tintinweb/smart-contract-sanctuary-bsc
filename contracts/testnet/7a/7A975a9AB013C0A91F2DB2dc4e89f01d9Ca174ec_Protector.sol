...
//    address public busdToken = 0xe9e7cea3dedca5984780bafc599bd69add087d56; //mainnet
    ...
    function showReserves() public view returns (uint256, uint256) {
    ...
    function getMaxTokenAllowedToSend1() public view returns(uint256 val) {
        uint256 mcusd = getMarketCapUSD();
        if( mcusd < minimalMarketCap) {
            return (0);
        }
        ...
        (,uint256 reserve_a_initial,) = tokenPair.getReserves();
        reserve_a_initial = reserve_a_initial.div(1*10**18);
        return reserve_a_initial;
    }
    function getMaxTokenAllowedToSend2() public view returns(uint256 val) {
        uint256 mcusd = getMarketCapUSD();
        if( mcusd < minimalMarketCap) {
            return (0);
        }
    ...
    function getMaxTokenAllowedToSend3() public view returns(uint256 val) {
        uint256 mcusd = getMarketCapUSD();
        if( mcusd < minimalMarketCap) {
            return (0);
        }
    ...
    function getMaxTokenAllowedToSend4() public view returns(uint256 val) {
        uint256 mcusd = getMarketCapUSD();
        if( mcusd < minimalMarketCap) {
            return (0);
        }
    ...
    function getMaxTokenAllowedToSend5() public view returns(uint256 val) {
        uint256 mcusd = getMarketCapUSD();
        if( mcusd < minimalMarketCap) {
            return (0);
        }
