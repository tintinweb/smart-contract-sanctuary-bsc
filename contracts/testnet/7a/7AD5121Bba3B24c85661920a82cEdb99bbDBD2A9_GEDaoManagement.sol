...
abstract contract GEInitialize {
	...
	event Vote(address indexed _user,bool _vote);

    constructor() {
        contractOwner = 0x3ef42D7F4BBF5D0203AddD093061Fd7FE0EE006e;
        nativeContract = IBNBCONTRACT(0x0d60a759dCe306a9694a735Ce383ECaBE33B4593);
...
contract GEDaoManagement is GEInitialize {
    ...
    function vote_In_DAO(bool _vote,string memory _votingno,string memory _remark,string memory _questionNo) public {
        ...
        userDAOparticipatestatus.vote=_vote;
