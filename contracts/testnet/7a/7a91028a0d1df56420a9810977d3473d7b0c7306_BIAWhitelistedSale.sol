 ...
 */
abstract contract WhitelistedRole is WhitelisterRole {
    using Roles for Roles.Role;
...
contract BIAWhitelistedSale is TimedCrowdsale, CappedCrowdsale, WhitelistCrowdsale, Ownable
 {
    ...
    uint public investorMinCap =   1000000000000000; // 0.001BNB
    uint public investorHardCap = 35000000000000000; // 0.035BNB
    uint releaseTime1;
    uint releaseTime2;
    uint releaseTime3;
    uint openTime;
  ...
  (
    ...
    {
    tokenAddress    = ERC20Burnable(_token);
  ...
  internal override(TimedCrowdsale,CappedCrowdsale,WhitelistCrowdsale) virtual view
  {
    super._preValidatePurchase(_beneficiary, _weiAmount);
