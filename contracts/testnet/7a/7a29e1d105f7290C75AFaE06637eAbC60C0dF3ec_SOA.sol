...
contract SOA is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 10_000_000_000; //10 Billion
    ...
    string private _name = "System Of All";
    string private _symbol = "SOA";
    
    // ALL FEES ARE DIVIDED BY 10**5 FOR MORE ACCURACY
    // EXAMPLE: 100 / 10**5 = 1%
    uint256 private _reflectFee = 0; // Set dynamically
    uint256 public _buyReflectFee = 5; //0.05% 
    uint256 public _sellReflectFee = 10; //0.1%
    uint256 private maxReflectFee = 200; //Owner can't change reflection fee more than 2%.
    
    uint256 private _liquidityFee = 0; // Set dynamically
    uint256 public _buyLiquidityFee = 30; //0.3%
    uint256 public _sellLiquidityFee = 50; //0.5% 
    uint256 private maxLiquidityFee = 300; //Owner can't change auto lp tax more than 3%.

    uint256 private _marketingFee = 0; // Set dynamically
    uint256 public _buyMarketingFee = 20; //0.2% 
    uint256 public _sellMarketingFee = 30; //0.3% 
    uint256 private maxMarketingFee = 300;//Owner can't change marketing fee more than 3%.

    uint256 private _burnFee = 0; // Set dynamically
    uint256 public _buyBurnFee = 5; //0.05% 
    uint256 public _sellBurnFee = 10;//0.1%
    uint256 private maxBurnFee = 200;//Owner can't change auto burn fee more than 2%.

    uint256 private _liquidityRatio = _liquidityFee;
    uint256 private _marketingRatio = _marketingFee;
    ...
    uint256 private maxTxPercent = 15; // You can't send more than 1.5% of the total supply in one transaction.
    ...
    uint256 private maxWalletPercent = 25; // You can't hold more than 2.5% of the total token supply.
...
,        address to,
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        marketingWallet.transfer(fromSwap.sub(liquidityBalance));
    }
