...
contract Pirateer is Ownable, ERC721A, PaymentSplitter {
    ...
    uint private constant MAX_PUBLIC = 878;

    uint public publicSalePrice = 0.0035 ether;
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, string memory _baseURI) ERC721A("Pirateers", "AHOY")
    ...
    function mintForOpensea() external onlyOwner{
        if(totalSupply() != 0) revert("Only 8 mint for deployer");
        _mint(msg.sender, 8);
    }
