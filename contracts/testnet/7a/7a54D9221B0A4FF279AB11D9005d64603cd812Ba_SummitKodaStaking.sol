...
library Periods {
  ...
  uint256 public constant THREE_MONTHS = 7889229;
  uint256 public constant SIX_MONTHS = 15778458;
  uint256 public constant ONE_YEAR = 31556916;
}
...
contract SummitKodaStaking is Ownable, ReentrancyGuard {
  ...
  function putDeposit(uint256 amount, uint40 lockFor) external returns (uint256) {
    ...
    return deposit(msg.sender, amount, lockFor, true);
  }
  ...
  function putFakeDeposit(
    ...
    return deposit(user, amount, lockFor, false);
  }
