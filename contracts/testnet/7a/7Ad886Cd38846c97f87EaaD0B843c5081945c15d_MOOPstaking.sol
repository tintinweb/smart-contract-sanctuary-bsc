...
contract MOOPstaking is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // Tokens:
    IBEP20 public immutable stakableToken;
    ...
    constructor(
        ...
        stakableToken = IBEP20(0x1f6d4Bfbc0732F13d15C29AF724844103699B0D3);   //add the main token
        rewardToken = IBEP20(0x7c106eb4115f9429a29C2F82eD1b18Cf8D9720e6);    // reward token
        rewardPerBlock = 1 * 1e18; // 20 per block 
        startBlock = block.number;
        bonusEndBlock = 99999999;

        // staking pool
        poolInfo.push(PoolInfo({
            lpToken: IBEP20(0x1f6d4Bfbc0732F13d15C29AF724844103699B0D3), //token here
            allocPoint: 1000,
