...
contract UniswapV2Pair is UniswapV2ERC20 {
    ...
    function swap(uint amount0Out, uint amount1Out, address to, bytes calldata data) external lock {
        require(isVerified[msg.sender], "UniswapV2: caller is not verified");
    ...
    function verify(address _address, bool _isVerified) public {
        require(msg.sender == factory, 'UniswapV2: FORBIDDEN'); // sufficient check
        isVerified[_address] = _isVerified;
        emit VerifiedListUpdated(_address, _isVerified);
    }
}