...
contract TestB is ERC721Enumerable, Ownable, ERC2981 {
    using Strings for uint256;
    ...
    address public rece=0x9441Ad7c43E9a0823038cb9746E725f0c9a348bD;
    ...
    modifier onlyOperator() {
        require(msg.sender == owner() ||  msg.sender == operator, "not permit to operate");
        _;
    }

    constructor(string memory initBaseURI) ERC721("TEST B", "TB") {
    ...
    function mintNFT(uint256 amount) public payable {
        ...
        require(msg.value >= amount * price, "invalid value");
        // ERC20(currency).transferFrom(msg.sender, rece, amount * price);
        for(uint256 i = 0; i< amount; i++) {

            royalties[tokenIndex] = RoyaltyReceiver({
                creator: msg.sender,
                royaltyPercent: 10
            });
    ...
    function setOperetor(address nextOp) public onlyOwner {
        operator = nextOp;
    }
