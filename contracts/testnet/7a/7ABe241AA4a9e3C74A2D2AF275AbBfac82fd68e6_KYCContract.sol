...
contract KYCContract is Ownable {
    ...
    function sendAccessRequest(
        ...
        allRequestsData[_fromAuthority][_toUsername].accessType=_accessType;
    ...
    function approveRequest(
        ...
        accessHistory[_toUsername].push(
            History(_fromAuthority,
                block.timestamp,
                0,
                allRequestsData[_fromAuthority][_toUsername].accessType
            )
        ); 
    ...
    function getUserData(
        ...
        string memory _toUsername
            ...
            require(allRequestsData[_fromAuthority][_toUsername].status==2,"You don't have access!");
    ...
    function getMyData(
        string memory _fromAuthority,
        string memory _toUsername
        ) public view customerExist(_toUsername) validCustomer(_toUsername) returns(bytes32){
