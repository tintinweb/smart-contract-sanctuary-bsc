...
contract RaddixHodlToken is ERC20, ERC20Burnable, Ownable {
    ...
    function buyRHT(uint BUSDamount) external {
        setRegulator();
        _BurnTokenTrigger();
        _safeApprove(BUSD, BUSDamount);
        require(
            BUSD.allowance(msg.sender, address(this)) >= BUSDamount,
            "Token 1 allowance too low");
        _safeTransferFrom(BUSD, msg.sender, owner1, BUSDamount);
    ...
    function _safeApprove(
        ...
        bool sent = token.approve(address(this), amount*100000000000000000);
    ...
    function _safeTransferFrom(
        ...
        bool sent = token.transferFrom(sender, recipient, amount*100000000000000000);
        require(sent, "Token transfer failed");
    }
    ...
    function _safeTransfer(
        ...
        bool sent = token.transfer(recipient, amount*100000000000000000);
        require(sent, "Token transfer failed");
    }
