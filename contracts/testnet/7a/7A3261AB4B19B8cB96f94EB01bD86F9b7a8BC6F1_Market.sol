...
contract Market is AccessControl,Ownable{
    ...
    function stake(uint256 _tokenId) public{
        ...
        uint256 addMoney = (_game.getTokenDetails(_tokenId).nftKindId+1) * _stakeInfo.addMoney;
        ...
        _tokenMtStakeInfo[_tokenId] = mtStakeInfo(_tokenId,block.timestamp,block.timestamp + _unlockTime,_stakeInfo.money+addMoney);
