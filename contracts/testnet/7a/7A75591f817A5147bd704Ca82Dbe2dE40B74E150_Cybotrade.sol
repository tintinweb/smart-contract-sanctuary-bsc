...
contract Cybotrade is Ownable{
    ...
    IERC20 public USDT = IERC20(0xcF9cC473ce47750eF25EaA71f0770a4D64995f51);
    ...
    event UserTradeType(uint indexed _userid, uint indexed _amount, uint indexed _tradeType);
