...
contract SOMNft is ERC721URIStorage, AccessProtected {
    ...
    constructor(address _feeToken, address _whitelistAddress1, address _whitelistAddress2) ERC721("SOM NFT", "SNFT") {
        ...
        whitelist2 = Whitelist(_whitelistAddress2);
    }
    ...
    function ClaimNft(string memory uri) external {
    ...
    function Mint(string memory uri, FEE rare) external {
        ...
        IBEP20(FeeToken).transferFrom(msg.sender, address(this), setFee(rare));
        mint(msg.sender, uri);
    }
