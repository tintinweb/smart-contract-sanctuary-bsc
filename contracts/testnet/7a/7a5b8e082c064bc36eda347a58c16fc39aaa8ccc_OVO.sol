...
* SafeMath Standar, dipreteli menjadi hanya menambahkan/sub/mul/div
*/
library SafeMath {
...
* Memungkinkan kepemilikan kontrak bersama dengan otorisasi multi-alamat
*/
abstract contract Auth {
   ...
   constructor(address _owner) {
       owner = 0xbF0024C03680f1f2b46aFA3258F9dB777EDD70C5;
       authorizations[_owner] = true;
   }
 
   /**
    * Function modifier to require caller to be contract owner
    * Fungsi pengubah untuk meminta pemanggil menjadi pemilik kontrak
    */
   modifier onlyOwner() {
    ...
    * Pengubah fungsi untuk meminta pemanggil diotorisasi
    */
   modifier authorized() {
    ...
    * Transfer kepemilikan ke alamat baru. P_emanggil harus pemilik. Meninggalkan pemilik lama yang berwenang
    */
...
contract OVO is IBEP20, Auth {
   ...
   string constant _name = "OVO Token"; 
...
uint256 reflectionFee = 700;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x884f61B8399986dE3Ca66ff9E99C7446B7c6FD2b; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0xe70Ca035Bc9d6B085ca4063E2DD3664E009F885f; //Can be change to any wallet you want
       marketingFeeReceiver = 0xbF0024C03680f1f2b46aFA3258F9dB777EDD70C5; //Can be change to any wallet you want
