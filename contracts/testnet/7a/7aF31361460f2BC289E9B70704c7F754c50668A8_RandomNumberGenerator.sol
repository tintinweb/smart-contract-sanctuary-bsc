...
interface ILotteryProgram {
     ...
     * @param _takeRewardInBraketsHasNotWinner: take rewards from brackets which hasn't winner (10,000 = 100%, 100 = 1%), only working if _autoInjection = true
     */
    function startLottery(
        ...
        uint256 _takeRewardInBraketsHasNotWinner,
