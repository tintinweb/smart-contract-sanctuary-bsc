...
contract WavindGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes {
    constructor(IVotes _token)
        Governor("Wavind Governor")
        GovernorSettings(1 /* 1 block */, 100800 /* 2 week */, 30)
