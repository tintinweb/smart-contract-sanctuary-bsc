...
contract Miticoin is ERC20,Ownable,IMiticoin {
    ...
    function PrimaryMINT (uint256 PrimaryTotalWorld) public virtual override {
        ...
        uint256 zero =_decimals_*XMITI;
        _mint(Contr.getZoomLoupe(),PrimaryMITI*10*zero);
        _mint(Contr.getTeam(),PrimaryMITI*10*zero);
        _mint(Contr.getCashback(),PrimaryMITI*35*zero);
        _mint(Contr.getRsearchers(),PrimaryMITI*5*zero);
        _mint(Contr.getSaleMITI(),PrimaryMITI*40*zero);
        Primary=true;
    } 
