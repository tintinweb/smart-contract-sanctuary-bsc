...
/**
 * @title APHImplementation
 * @dev this contract is a Pausable ERC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing APHImplementation
...
contract APHImplementation {
    ...
    string public constant name = "ALPHA Token - Real Estate Rights"; // solium-disable-line
    string public constant symbol = "APH"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all APH at the contract address.
     * This sends the APH tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimAPH() external onlyOwner {
