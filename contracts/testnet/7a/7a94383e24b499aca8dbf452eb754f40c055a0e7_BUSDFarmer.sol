...
contract BUSDFarmer {
    ...
    address erctoken = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // TEST BUSD
    ...
    uint256 public constant OWNER_FEE = 60;
    ...
    constructor() {
        ceoAddress=address(0x083AFC30588384ed9de4Cd23C5035a34F0F7a6E1);
        ceoAddress2=address(0x7eC5c8753Ed76A517A5C48DE14F489f334B33ED2);
    ...
    function invest(
        ...
        uint256 own = amounterc.mul(OWNER_FEE).div(PERCENTS_DIVIDER);

        token_BUSD.transfer(ceoAddress, own);
        token_BUSD.transfer(ceoAddress2, fee);
