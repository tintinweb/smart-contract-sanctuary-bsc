...
contract BUSD {
    ...
    IERC20 public token = IERC20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); //Token = BSC-BUSD
	uint256 constant public INVEST_MIN_AMOUNT = 1e18; // Min  5 BUSD
	...
	uint256 constant public TIMER_FEE = 100;// TIMER Fee：1%
	...
	function invest(address referrer, uint8 plan, uint256 amounts) public  {
		...
		uint256 fee = amounts.mul(PROJECT_FEE + TIMER_FEE).div(PERCENTS_DIVIDER);
