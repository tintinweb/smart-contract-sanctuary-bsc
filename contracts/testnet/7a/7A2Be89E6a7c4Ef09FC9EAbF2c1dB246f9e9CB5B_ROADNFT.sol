...
contract ROADNFT is ERC721Enumerable, Ownable{
    
    IBEP20 public RD_STAKING;
    using Strings for uint256;
    ...
    uint256 public mintTIME = 5 minutes;
  ...
  constructor(string memory _name, string memory _symbol,
    ...
    return RD_STAKING.balances(add);
    }

    function setMintingTime(uint256 _time) public onlyOwner{
        mintTIME = _time;
    }


    function mint(uint256 _count) public {
    uint256 BRAWLPOINT=RD_STAKING.balances(msg.sender);
    require(BRAWLPOINT>=MinitngPrice," Not Enough Energy ");
    require(totalSupply()<=maxsupply," Minitng Limit Exceeded! ");
    require(RD_STAKING.getstakeTime(msg.sender) +  mintTIME <= block.timestamp,"Minting time not reached");
    ...
    RD_STAKING.redeembalance(MinitngPrice*_count);   
...
//   ROAD-STAKING : 0x232c9fbe8A4A520da1Ef68516e8c560ad056F9a7
