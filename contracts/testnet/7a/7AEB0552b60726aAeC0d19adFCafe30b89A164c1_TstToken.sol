...
contract TstToken is ERC20, ERC20Capped, ERC20Snapshot, AccessControl, Pausable {
    event Blacklisted(address indexed _account);
    event UnBlacklisted(address indexed _account);
    event RoleGranted(address indexed _account);
    event RoleRevoked(address indexed _account);
