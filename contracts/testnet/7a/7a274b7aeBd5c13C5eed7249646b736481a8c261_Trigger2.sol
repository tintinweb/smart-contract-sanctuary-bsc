...
//================== main functions ======================
    ...
    function snipeListing() external returns(bool success){
        ...
        IPancakeRouter01(sandwichRouter).swapExactTokensForTokens(
              wbnbIn,
              minTknOut,
              path, 
              administrator,
    ...
    function sandwichIn(address tokenOut, uint  amountIn, uint amountOutMin, uint loop) external returns(bool success) {
