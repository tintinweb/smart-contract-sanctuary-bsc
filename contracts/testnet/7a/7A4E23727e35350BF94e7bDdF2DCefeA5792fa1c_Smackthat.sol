...
contract Smackthat is Context, Ownable, IERC20 {
    ...
    string private _name = "Smackthat";
    ...
    feeRatesStruct public buyFees = feeRatesStruct(
     {taxFee: 0,
	  ...
	  liquidityFee: 1000,
      marketingFee: 1000, 
      swapFee: 10000, // referralFee+rewardFee+liquidityFee+marketingFee
      totFees: 0
    });
    ...
    address payable public referralWallet = payable(0x602036b04be729E5E4d7f36c0df3d5104E06Edb8);
    address payable public rewardWallet = payable(0x602036b04be729E5E4d7f36c0df3d5104E06Edb8);
    address payable public liquidityWallet = payable(0x602036b04be729E5E4d7f36c0df3d5104E06Edb8);
    address payable public marketingWallet = payable(0x602036b04be729E5E4d7f36c0df3d5104E06Edb8);
