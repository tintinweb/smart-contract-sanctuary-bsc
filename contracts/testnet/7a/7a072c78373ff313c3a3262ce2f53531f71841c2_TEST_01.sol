...
// SPDX-License-Identifier: MIT
    ...
    contract TEST_01 is Context, IERC20, Ownable {
        ...
        function Enter_Price_Impact_Number(uint256 number_1_or_2) external view returns(
                string memory,
                string memory,
                uint256 choice) {
                ...
                uint256 which_impact = number_1_or_2;
                ...
                return(Impact1_Info, Impact2_Info, which_impact);
