...
contract BinanceFootballFiesta is Ownable, ERC721S, ReentrancyGuard {
    enum ContractStatus {
        Paused,
        Public
    }
    ...
    uint256 public totalMintSupply = 3;
    ...
    ERC721S ("BinanceFootballFiesta", "BFF") {
        baseURI = contractBaseURI;
    }

    function contractURI() public view returns (string memory) {
        return "ipfs://bafybeibbdcasvo3c55gfi7mtymaxswk2h5ngrjaaugjv7cdk65aqjbw4sa/contract.json";
    }
