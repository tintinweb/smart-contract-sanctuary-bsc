...
contract CryptoSoccer is IERC20 {
    ...
    string constant private _name = "Crypto Soccer";
    string constant private _symbol = "$CRS";
    ...
    address public marketingWallet = payable(0xC2E1265431B5714825864b969Fff0D2CC06EB275);
