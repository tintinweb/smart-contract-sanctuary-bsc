...
contract JOKER is IERC20 {
    ...
    uint256 public _pileFee = 700; // 700 = 7.00%
    uint256 public _teamFee = 100; // 100 = 1.00%
    uint256 public _burningFee = 300; // 300 = 3.0%
    uint256 public _lpFee = 200; // 200 = 2%
    uint256 public _marketingFee = 300; // 300 = 3%
  ...
  //  uint256 public _sellinsuranceFeeTotal;
   ...
   // uint256 public _referalFeeTotal;
    ...
    // arena = pile ; winner = team ; 

    address public arenaAddress  = 0x2501E79052e090de1529F9bc2EE761A89F62d82e;      // pileaddress
     address public marketingAddress  = 0x2501E79052e090de1529F9bc2EE761A89F62d82e;      // arenaAddress
    address public winnerAddress  = 0x79F1f75afEaed3494db6eC37683Bf9420F29e7A6;      // teamaddress
