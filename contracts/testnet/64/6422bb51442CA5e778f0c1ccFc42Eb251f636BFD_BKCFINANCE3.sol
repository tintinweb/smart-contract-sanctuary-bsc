...
contract BKCFINANCE3 is OwnableUpgradeable {
    ...
    function init() public initializer {
        ...
        setAddress(
            0x0a348b99344D63001A099f34c54dB3dC04D4D377,
            0x90650aFb07d3aba7279e65b0a6BE30E19760b7f4,
            0xCb63e518894EF3b1b5e81D04Af25D3c2099499e7,
        ...
        releaseTime = [(86400 * 5), (86400 * 13), (86400 * 15), (86400 * 20)];
        releaseAmount = [
            10000000000 ether,
            100000000000 ether,
            400000000000 ether,
    ...
    function calculateRelease(uint slot_) public view returns (uint) {
    ...
    function unStake(uint slot_) public onlyEOA {
        ...
        uint _amount = calculateRelease(slot_);
    ...
    function _after(uint slot_) internal {
        ...
        // uint last = releasePoolInfo[msg.sender][slot_].lastTime;
        if (release.amount != 0 && release.amount == release.claimedAmount) {
            releasePoolInfo[msg.sender][slot_] = ReleasePoolInfo({
                day: 0,
                amount: 0,
                startTime: 0,
        ...
        if (user.rewardValue != 0 && user.rewardValue == user.claimedValue) {
            userInfo[msg.sender][slot_] = UserInfo({
                stakeAmount: 0,
                stakeValue: 0,
                profitRatio: 0,
        ...
        if (user.stakeAmount == 0 && release.amount == 0) {
        ...
        )
    {
        ...
        amounts[3] = calculateRelease(_slot);
