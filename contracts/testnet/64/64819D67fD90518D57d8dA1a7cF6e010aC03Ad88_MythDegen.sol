...
contract MythDegen is ERC721 {
    ...
    constructor() ERC721("Myth City Degen", "MYDG") {
        ...
        defaultBackground = "https://mythcity.mypinata.cloud/ipfs/QmUXAVkKUwgUvum2XBCMtQaJTFH7VfyP8RoWiEnbGyDsjB/BACKGROUND/BACKGROUND%202-min.png";
        defaultEye = "https://mythcity.mypinata.cloud/ipfs/QmUXAVkKUwgUvum2XBCMtQaJTFH7VfyP8RoWiEnbGyDsjB/EYES/DEFAULT-min.png";
        defaultMouth = "https://mythcity.mypinata.cloud/ipfs/QmUXAVkKUwgUvum2XBCMtQaJTFH7VfyP8RoWiEnbGyDsjB/MOUTH/DEFAULT-min.png";
        defaultSkinColor = "https://mythcity.mypinata.cloud/ipfs/QmUXAVkKUwgUvum2XBCMtQaJTFH7VfyP8RoWiEnbGyDsjB/BODY%20COLOR/DEFAULT-min.png";
        defaultNose = "https://mythcity.mypinata.cloud/ipfs/QmUXAVkKUwgUvum2XBCMtQaJTFH7VfyP8RoWiEnbGyDsjB/NOSE/DEFAULT-min.png";
    ...
    function setCosmeticAddress(address _address)
        external
        isWhitelisted
        returns (bool)
    {
        cosmeticAddress = _address;
    }
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '",',
                        '"attributes": [{"trait_type": "Degen Id equipped to", "value": ',
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '},{"trait_type": "Equipped to Degen Id", "value": ',
                        Base64.uint2str(tempStats.degenIdEquipped),
                        "}",
                        "]",
                        ',"image_data" : "',
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '},{"trait_type":"Weapon Type","value":',
                        uint2str(tempStats.weaponType),
                        '},{"trait_type":"Degen Equipped To","value":',
                        uint2str(tempStats.degenIdEquipped),
                        '},{"trait_type":"Weapon Skin Equipped","value":',
                        uint2str(weaponSkins[_weaponId].weaponSkin.idOfItem),
                        "}"
                    )
                )
            )
            ...
            bytes(
                string(
                    abi.encodePacked(
                        ...
                        '",',
                        '"attributes": [{"trait_type": "Weapon Id equipped to", "value": ',
