    ...
    IERC1155ReceiverUpgradeable
{
    ...
    // @dev make it true so everyone can list
    bool public listable;
    /*///////////////////////////////////////////////////////////////
                                Mappings
    //////////////////////////////////////////////////////////////*/
    ...
    // owner function to enable/disable public listing
    function publicListing(bool _state) public {
        listable=_state;
    }
    ...
    /*///////////////////////////////////////////////////////////////
                minting erc721  logic
    //////////////////////////////////////////////////////////////*/
    /*///////////////////////////////////////////////////////////////
                Listing (create-update-delete) logic
    //////////////////////////////////////////////////////////////*/
    // @dev ["0xbAaf3B1a89a9C3816D11D8C7C527E8f5DC85c43A",0,1665553520,1665576785,1,"0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd",1,1,0] parameter to pass
    ...
    function createListing(ListingParameters memory _params) external override {
        ...
        require(listable==true||hasRole(LISTER_ROLE, address(0)) || hasRole(LISTER_ROLE, _msgSender()), "!LISTER");
        require(listable==true||hasRole(ASSET_ROLE, address(0)) || hasRole(ASSET_ROLE, _params.assetContract), "!ASSET");
