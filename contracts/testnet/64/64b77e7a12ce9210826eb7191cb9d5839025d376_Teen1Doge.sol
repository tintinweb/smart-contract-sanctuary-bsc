...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6496959cE6DDecB1bF4A213B58238fB89989FB01; // owner address
...
contract Teen1Doge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Teen1Doge";
    string private _symbol = "TDog1";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xee937544f3674305F14dFffE6958EFFe058E0B8F); // Marketing Address
    address payable public teamWalletAddress = payable(0x6496959cE6DDecB1bF4A213B58238fB89989FB01); // Team Address
    ...
    uint256 public _totalTaxIfSelling = 80;  
