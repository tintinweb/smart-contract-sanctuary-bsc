...
contract CCB is IERC20, Ownable {
    ...
    function _feeDistributionTransfer(address sender, address recipient, uint256 amount) internal returns (uint256 recipientAmount){
        ...
        uint256 relation1Fee = amount.mul(_relation1).div(1000);
        uint256 relation2Fee = amount.mul(_relation2).div(1000);
        uint256 relation3Fee = amount.mul(_relation3).div(1000);
        uint256 totalFee = fundFee + ecology1Fee + ecology2Fee + businessFee + nodeFee + relation1Fee + relation2Fee + relation3Fee*6;
    ...
    function setFeeRate(
        uint256 fundFee_,
        uint256 ecology1Fee_, 
        uint256 ecology2Fee_, 
        uint256 businessFee_, 
        uint256 nodeFee_, 
        uint256 relation1_, 
        uint256 relation2_, 
        uint256 relation3_) external onlyOwner {
        _fundFee = fundFee_;
        _ecology1Fee = ecology1Fee_;
        _ecology2Fee = ecology2Fee_;
    ...
    function setAccountAddress(
        ...
        address ecology1Address_, 
        address ecology2Address_, 
        address businessAddress_, 
        address nodeAddress_) external onlyOwner{
        fundAddress = fundAddress_;
        ecology1Address = ecology1Address_;
        ecology2Address = ecology2Address_;
