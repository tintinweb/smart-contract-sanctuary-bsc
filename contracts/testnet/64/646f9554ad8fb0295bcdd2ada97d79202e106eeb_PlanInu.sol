 ...
 * allowances. See {IERC20-approve}.
 */
 contract PlanInu is ERC20, Ownable {
    // TOKENOMICS START ==========================================================>
    string private _name = "Plan Inu";
    ...
    address public marketingWallet = 0xCC455181CD6983Ab7603C9629EE197C1C2b1937F;
    // TOKENOMICS END ============================================================>
    ...
    uint256 private _numTokensSellToAddToLiquidity = 0 * 10**_decimals;
    uint256 private _numTokensSellToAddToETH = 0 * 10**_decimals;
