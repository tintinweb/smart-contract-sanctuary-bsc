...
contract DesirePredictionV2 is Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public constant MAX_TREASURY_FEE = 1500; // 15%
    ...
    /**
     * @notice Recover BNB for an emergency case
     * @param amount: array of epochs
     */
    function recoverBNB(uint256 amount) external nonReentrant notContract onlyAdmin {
        if (amount > 0) {
