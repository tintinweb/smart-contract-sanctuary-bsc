...
contract StableFuel {
	...
	uint256 public COMPOUND_BONUS = 5; /** 0.5% **/   //Not USE
	...
	uint256 public WITHDRAW_COOLDOWN = 4 * 60 * 60; /** 4 hours  **/  //Not USE
    ...
    uint256 diamondhonorvalue = 68000 * 1e18;  //10000
    ...
    IBEP20 quantic = IBEP20(0xB95d249af48939BcA1b680a130da739728094dfA);
    ...
    constructor(address _bbadr, address _devadr, address _mktadr, address _autoadr, address _defaultaddress) {
    ...
    function turn_on_off(bool _turn) external {
        require(msg.sender == owner, "Admin use only");
        turnon = _turn;
    }

    function change_defaultaddress(address value) external {
        require(msg.sender == owner, "Admin use only.");
