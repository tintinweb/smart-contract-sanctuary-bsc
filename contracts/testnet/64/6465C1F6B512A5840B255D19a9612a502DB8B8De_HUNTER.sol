...
contract HUNTER is Context, IERC20 {
    ...
    string private constant _name = "Hunter"; 
    string private constant _symbol = unicode"HTC"; 
    ...
    uint256 private Percent_Dev = 15;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            uint256 buyFEE = tAmount.mul(_tax).div(10**2);
            ...
            uint256 sellFEE = tAmount.mul(_tax).div(10**2);
