...
contract INDIP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Indep Inu";
    string private _symbol = "$INDI";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfd61E860aD8c7ed701Ec152bA673Ac30547BF00B); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xfd61E860aD8c7ed701Ec152bA673Ac30547BF00B); // BuyBack Address
