...
contract MockBUSD is LibNote {
  ...
  event Transfer(address indexed src, address indexed dst, uint wad);
    ...
    // --- ERC20 Data ---
    string  public name     = "BUSD Mock Stablecoin";
    string  public symbol   = "MockBUSD";
    ...
    constructor(uint256 chainId_, string memory name_, string memory symbol_) {
        wards[msg.sender] = 1;
