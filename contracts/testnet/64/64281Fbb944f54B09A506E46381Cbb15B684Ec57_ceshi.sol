...
contract ceshi is Context, IERC20, Ownable {
    ...
    string private _name = "ceshi V8";
    string private _symbol = "ceshi V8";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3f7DDD77679606e21243bFFCAab1940d246d7840));
        m = payable(address(0x3f7DDD77679606e21243bFFCAab1940d246d7840));
