...
contract FIFAKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FIFAKing";
    string private _symbol = "FIFAKing";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0x31bc8F888ADB74BC06F8b9ABc8A42961AAa758A4);
    address payable public marketingWallet2 = payable(0xE63fE6dC9605F4D36B5fF70fC866Cdd7b11401B0);
    ...
    uint256 public _marketing2Fee = 2;
    uint256 public _lpFee = 1;

    uint256 public _totalTax = _marketingFee.add(_marketing2Fee).add(_lpFee);
    ...
    constructor () {
        ...
        _totalTax = _marketingFee.add(_marketing2Fee).add(_lpFee);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBForMarketing2 = BNBBalance.mul(_marketing2Fee).div(_totalTax);
