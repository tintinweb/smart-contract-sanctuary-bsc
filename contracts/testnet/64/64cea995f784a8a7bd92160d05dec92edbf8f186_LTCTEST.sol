...
contract LTCTEST is Ownable, IBEP20 {
    ...
    address payable public MarketingWalletAddress =
        payable(0x0063a33378C3529532F632992877Ab0cb1219B16);
    ...
    uint256 internal _MarketingFee = 500;
    

    uint256 public TotalTaxFee =
        _liquidityFee + _BurnFee + _TeamFee + _MarketingFee;
    ...
    uint256 public _maxSellLimit = 6 * 10**6 * 10**_decimals;
...
//0x10ED43C718714eb63d5aA57B78B54704E256024E main
    ...
    function UpdateWallets(
        ...
        BuybackWalletAddress = newTeamWallet;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            require(
                balanceOf(recipient) + amount <= _maxWalletHoldingLimit || amount <= _maxSellLimit,
                "limit exceeded"
            );
        ...
        if (
            ...
            if (_isExcludedFromFee[sender] || _isExcludedFromFee[recipient]) {
                ...
                totalTax =
                    (amount *
                        (_liquidityFee + _TeamFee + _MarketingFee)) /
                    (feeDenominator);
        ...
        if (
            ...
            if (overMinTokenBalance) {
                ...
                if (_MarketingFee + _TeamFee + _liquidityFee > 0) {
                    remainingLiquidityToken =
                        (contractTokenBalance *
                            (_MarketingFee + _TeamFee)) /
                        (_MarketingFee + _TeamFee + _liquidityFee);
                }
    ...
    function swapTokens(uint256 _contractTokenBalance) private lockTheSwap {
        uint256 combineFee = _MarketingFee + _TeamFee;
