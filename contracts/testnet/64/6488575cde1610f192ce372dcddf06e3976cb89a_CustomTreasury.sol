...
contract CustomTreasury is Initializable, Policy {
    /* ======== DEPENDENCIES ======== */
    ...
    function initialize(address _payoutToken, address _initialOwner) public initializer {
        ...
        returns (uint256 value_)
    {
        ...
        value_ = _amount.mul(10**IERC20Metadata(payoutToken).decimals()).div(
            10**IERC20Metadata(_principleTokenAddress).decimals()
        );
    }
