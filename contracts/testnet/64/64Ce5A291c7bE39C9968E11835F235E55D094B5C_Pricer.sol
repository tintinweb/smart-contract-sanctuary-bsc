...
contract Pricer {
    ...
    */
    ...
    function getLpTokensAmount(address lp, uint amountLp, address router) public view returns ( uint amountA, uint amountB){
        address factory = getFactory(router);
        (address tokenA, address tokenB) = getLpTokens(lp);
        ( amountA, amountB) = UniswapV2LiquidityMathLibrary.getLiquidityValue(factory, tokenA, tokenB, amountLp);
    }
