...
contract BrokerPublicBuilding is Distributor, Ownable, IBrokerPublicBuilding {
    ...
    IBusinessParcel businessParcelContract;
    IStandardParcel standardParcelContract;
    uint256 public upgradePriceInBNB;
    IActivatableNFT[6] nftContracts;
...
interface IActivatableNFT is IERC721Base {
    ...
    function setBrokerPBContractAddress(address _brokerPBContractAddress) external;
    function getBrokerPBContractAddress() external view returns (address);
...
interface IMiner is IActivatableNFT {
