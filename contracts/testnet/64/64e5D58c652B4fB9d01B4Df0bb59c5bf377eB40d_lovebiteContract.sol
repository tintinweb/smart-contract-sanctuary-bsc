...
contract lovebiteContract is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Lovebite";
    //change the token symbol
    string constant _symbol = "LBT";
    //dont change that
    ...
    address public marketingFeeReceiver = 0x1CAe0658392bc6cb59653EcD581319b3e730423B;
