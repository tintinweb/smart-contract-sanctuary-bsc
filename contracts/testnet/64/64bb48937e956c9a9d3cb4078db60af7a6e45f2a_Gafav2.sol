...
contract Gafav2 is Context, IERC20, Ownable {
    ...
    uint256 public _salegafalaFee = 1;

    uint256 public totalSwapableSaleFee =
        _saleLiquidityFee + _saleMarketingFee + _salegafalaFee;
    ...
    function setAllFeePercent(
        ...
        _gafalaFee = gafalaFee;
        _previousgafalaFee = _gafalaFee;
        totalSwapableFee =
            _liquidityFee +
            _devFee +
            _marketingFee +
    ...
    function setgafalaWalletAddress(address _gafalaWallet)
        external
        onlyOwner
    {
        ...
        emit AuditLog(
            "We have Updated the gafalaWallet:",
            gafalaWalletAddress
        );
    }
