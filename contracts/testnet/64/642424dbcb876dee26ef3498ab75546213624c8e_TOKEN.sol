...
contract TOKENDividendTracker is OwnableUpgradeable, DividendPayingToken {
  ...
  function updateClaimWait(uint256 newClaimWait) external onlyOwner {
    require(
      ...
      "Reward Tracker: The claimWait must be updated to between 1 and 60 seconds"
    );
    require(
...
contract TOKEN is BEP20, Ownable, BaseToken {
  ...
  // onTotalSupply
  uint256 public onTotalSupply = 10**18 * 5000;

  uint256 public changeTaxOne = 500;
  uint256 public changeTaxTwo = 100;
  uint256 public changeTaxThree = 900;
  uint256 public changeTaxFour = 600;
  ...
  uint256 public PercentageTwo = 2000;
  uint256 public PercentageThree = 1800;
  uint256 public PercentageFour = 1200;
