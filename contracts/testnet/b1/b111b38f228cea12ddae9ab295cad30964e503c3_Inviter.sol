...
contract Inviter is OwnableUpgradeable, DivestorUpgradeable {
    ...
    function setAdmin(address addr_, bool flag_) public onlyOwner {
        admin[addr_] = flag_;
    }

    function setInviter(address inviter_, address account_) public onlyAdmin {
        require(userInfo[account_].inviter == address(0), "activated");
        require(userInfo[inviter_].inviter != account_, "wrong inviter");

        userInfo[account_].inviter = inviter_;

        userInfo[inviter_].amount += 1;
    }
