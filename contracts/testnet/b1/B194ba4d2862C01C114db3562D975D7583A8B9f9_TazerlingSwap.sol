...
library SafeMath {
    ...
    /**
     * @dev Returns the subtraction of two unsigned integers, reverting with cusTazerling message on
     * overflow (when the result is negative).
     *
     * CAUTION: This function is deprecated because it requires allocating memory for the error
     * message unnecessarily. For cusTazerling revert reasons use {trySub}.
     *
     * Counterpart to Solidity's `-` operator.
     *
     * Requirements:
    ...
    /**
     * @dev Returns the integer division of two unsigned integers, reverting with cusTazerling message on
     * division by zero. The result is rounded towards zero.
     *
    ...
    /**
     * @dev Returns the remainder of dividing two unsigned integers. (unsigned integer modulo),
     * reverting with cusTazerling message when dividing by zero.
     *
     * CAUTION: This function is deprecated because it requires allocating memory for the error
     * message unnecessarily. For cusTazerling revert reasons use {tryMod}.
     *
     * Counterpart to Solidity's `%` operator. This function uses a `revert`
     * opcode (which leaves remaining gas untouched) while Solidity uses an
     * invalid opcode to revert (consuming all remaining gas).
...
contract TazerlingSwap is Context, IERC20, Ownable, MinterRole {
    ...
    constructor(address payable _marketing
        ...
        maxWalletAmount = 6000000 * 10 ** _decimals;
        _rOwned[_msgSender()] = _rTotal;

        maxBuyAmount = 3000000 * 10 ** _decimals;
        maxSellAmount = 1500000 * 10 ** _decimals;
