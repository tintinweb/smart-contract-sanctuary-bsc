...
contract BUSDDividendTracker is DividendPayingToken  {
    ...
    constructor(address _dividentToken) DividendPayingToken("Boda_Busd_Dividend_Tracker", "Boda_Busd_Dividend_Tracker",_dividentToken) {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 3000000 * (10**18); //must hold 3,000,000+ tokens
    }
...
contract BodaV2 is ERC20, Ownable {
    ...
    function includeInDividends(address account) public onlyOwner {
        busdDividendTracker.includeInDividends(account);
    }
    ...
    function setBuyFees(uint256 busdDividendRewardsFeeBuy, uint256 marketingFeeBuy, uint256 LpFeeBuy) external onlyOwner{
      ...
      function setSellFees(uint256 busdDividendRewardsFeeSell, uint256 marketingFeeSell, uint256 LpFeeSell) external onlyOwner{
    ...
    function withdrawBNB(uint256 amount) public onlyOwner  {
	    amount = amount * (10**18);//starting from 1st decimal
