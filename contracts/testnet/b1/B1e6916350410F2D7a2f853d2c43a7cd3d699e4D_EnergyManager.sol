...
//    marketPlace = IMarketPlace(0x57573e2239C0A9E67E74D8AC8EA590E8FD99fA63);
  ...
  function _calculateUserTodayEnergy() private view returns (uint) {
    ...
    return (owned + rented - point) * energyMultiplication;
  }
