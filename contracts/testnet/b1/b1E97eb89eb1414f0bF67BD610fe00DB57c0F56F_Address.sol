...
contract BasicNetwork is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BasicNetwork";
    string private _symbol = "BN";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0x83eF5919d7Be109291ce13CBD81EF5A70331f3c2); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x2Ff7591ec20A7F862A469A0AaAA7913902798657); // BuyBack Address
