...
contract ICO {
    ...
    */    
    ...
    function getMyInvestments() public view returns(uint256, uint256[] memory){
        return (my_investments[msg.sender].total_investments, my_investments[msg.sender].myinvestments);
    }
