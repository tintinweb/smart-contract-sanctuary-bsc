...
contract Rtweet is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x1C0b526bFEC789069989A296a2Cd8a629a98aD12); // Marketing Address
    address payable public charityAddress = payable(0x8200dB4f2fFF1Aae458408bF1b96A5BCf9222EF0); // Charity/Dev Address
    ...
    string private _name = "RTweet";
    string private _symbol = "RTweet";
