    ...
    SharedConstants
{
    ...
    function setProxyAdminAddress(address newProxyAdmin_) public override onlyOwner {
        _proxyAdmin = newProxyAdmin_;
    }

    function setLaunchPoolLogicAddress(address newLaunchLogic_) public override onlyOwner {
