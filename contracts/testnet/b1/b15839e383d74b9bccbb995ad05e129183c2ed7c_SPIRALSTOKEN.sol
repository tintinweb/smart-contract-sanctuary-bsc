...
contract SPIRALSTOKEN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SPIRALS";
    string private _symbol = "$SPIRALS";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 0;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x034298cA6f4311AE701e31Dbc49b2c6E5709984e); // Marketing Address
    address payable public teamWalletAddress = payable(0x034298cA6f4311AE701e31Dbc49b2c6E5709984e); // Team Address
