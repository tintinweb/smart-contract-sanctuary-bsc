...
contract CollectionsCreator is ICollectionsCreator {
    ...
    function createCollectionId(string calldata name, address owner)
        public
        view
        override
        returns (bytes32)
    {
        return keccak256(abi.encodePacked(block.timestamp, name, owner));
    }
    ...
    function createNativeCollection(
        ...
        return _createNativeCollection(initParams, name, owner);
    }
    ...
    function createNativeCollectionWithSignature(
        ...
        DeployedCollection memory deployedCollection = _createNativeCollection(
            initParams,
            name,
            owner
        );
    ...
    function _createNativeCollection(
        bytes calldata initParams,
        string calldata name,
        address owner
    ...
    function _createCollectionFromBlueprint(
        ...
        bytes32 collectionId = createCollectionId(name, owner);
        ...
        (
            ...
            ).deployFromBlueprint(blueprintName, initParams, collectionId);
        ...
        return
            keccak256(
                abi.encodePacked(
                    ...
                    keccak256(
                        abi.encode(
                            "createNativeCollectionWithSignature(bytes memory initParam, string calldata name, address owner, uint256 value, bytes calldata signature)",
                            initParams,
                            name,
                            owner,
                            value
