...
contract UniswapV2Factory is IUniswapV2Factory {
    uint override public feeBP = 30;
    uint override public feeToPercent = 20;
    address override public feeToAddress;
    address override public feeAdmin;
    ...
    function setFeeBP(uint _feeBP) override external {
        require(msg.sender == feeAdmin, 'UniswapV2: FORBIDDEN');
        require(_feeBP < 1000, 'UniswapV2: FEE_TOO_LARGE');
        feeBP = _feeBP;
    }

    function setFeeToAddress(address _feeToAddress) override external {
        require(msg.sender == feeAdmin, 'UniswapV2: FORBIDDEN');
        feeToAddress = _feeToAddress;
    }

    function setFeeToPercent(uint _feeToPercent) override external {
        require(msg.sender == feeAdmin, 'UniswapV2: FORBIDDEN');
        require(_feeToPercent <= 100, 'UniswapV2: ADMIN_FEE_OVERFLOW');
