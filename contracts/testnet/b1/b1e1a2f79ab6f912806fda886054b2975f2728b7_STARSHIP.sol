...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);//random
...
contract STARSHIP is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "STARSHIP";
    ...
    uint256 _totalSupply = 10000000 * (10 ** 9); //10 million
    uint256 public _maxTxAmount = _totalSupply / 100000;
    uint256 public _walletMax = _totalSupply * 2 / 100000;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xBBB315fb5157455cEDC2D91BD03644edE7289F2E;
