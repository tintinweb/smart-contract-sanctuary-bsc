...
contract Game_Imperator is BEP20Token {
    ...
    event Referalsum(address referal, uint256 revards, uint256 number_imperia, uint256 date);
    ...
    ///плата рефералу///   
         if (my_inviter[msg.sender] != address(0)){
           ...
           emit Referalsum(msg.sender,all_game[a].referal_gift,a+1,block.timestamp);
       }
