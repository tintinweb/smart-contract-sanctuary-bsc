...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x3cCEF4a3859f2C1B7De8b2FDD25D0fdA8FD8D1c7;
...
contract Frensi is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x267063ef445874645921cbb09E1d09819D24a918;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Frensi";
    string private _symbol = "ENI";
