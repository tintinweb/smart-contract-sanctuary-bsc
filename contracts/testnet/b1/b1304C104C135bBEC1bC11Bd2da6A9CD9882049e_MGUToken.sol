...
contract MGUToken is ERC20, ERC20Burnable, Pausable, Ownable {
     ...
     */
    function _setCategoriesDefault() private onlyOwner {
        category["PublicSale"]
    ...
    function pauseAddress(address sender) public onlyOwner {
        _isPausedAddress[sender] = true;
    }

    function unPauseAddress(address sender) public onlyOwner {
