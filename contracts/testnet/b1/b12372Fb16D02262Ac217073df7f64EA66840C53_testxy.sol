...
contract testxy is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x81e87cE7b80F3dF526daA65f0851Cced0B4E8785));
    address payable public devWallet =
        payable(address(0xC482F93921C5125e98C1663F174c75FeA62b3164));
    address public liquidityReceiver =
        0x65f04bee2Cc5d112c0315825dd0e5450D07c5DAC;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "testxy";
    string private _symbol = "testxy";
    ...
    uint256 private numTokensSellToAddToLiquidity = 400000;
    uint256 public _maxWalletSize = 30000000;
