...
/**
 * TiTiToken = The integrated Finance Token
 * A new type of contract that designed and implemented by TiTi Community
 */
contract TiTiToken is IBEP20, Context, Ownable {
    struct Values {
        uint256 rSendAmount;
    ...
    string private constant _NAME = "TiTi Token";
