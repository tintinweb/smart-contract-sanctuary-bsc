	...
	function bonus() public payable {
		...
		if(index5 > 50){
			...
			for (uint256 i = 0; i < users[msg.sender].deposits.length; i++) {
				...
				if(user.deposits[i].plan==0){
					t_bonus = t_bonus.add(18*30*(users[msg.sender].deposits[i].amount/ (10**18)));
					...
					t_bonus = t_bonus.add(28*30*(users[msg.sender].deposits[i].amount/ (10**18)));
					...
					t_bonus = t_bonus.add(38*30*(users[msg.sender].deposits[i].amount/ (10**18)));
			...
			for (uint256 i = 0; i < users[msg.sender].deposits.length; i++) {
				...
				if(user.deposits[i].plan==0){
					t_bonus = t_bonus.add(18*10*(users[msg.sender].deposits[i].amount/ (10**18)));
					//daily_percent = daily_percent.add(18);
					user.yourbonus = 0;
					user.deposits.push(Deposit(6, (users[msg.sender].deposits[i].amount)*18/1000, block.timestamp));
				}else if(user.deposits[i].plan==1){
					t_bonus = t_bonus.add(28*10*(users[msg.sender].deposits[i].amount/ (10**18)));
					//daily_percent = daily_percent.add(28);
					user.yourbonus = 0;
					user.deposits.push(Deposit(7, (users[msg.sender].deposits[i].amount)*28/1000, block.timestamp));
				}else if(user.deposits[i].plan==2){
					t_bonus = t_bonus.add(38*10*(users[msg.sender].deposits[i].amount/ (10**18)));
					//daily_percent = daily_percent.add(38);
					user.yourbonus = 0;
