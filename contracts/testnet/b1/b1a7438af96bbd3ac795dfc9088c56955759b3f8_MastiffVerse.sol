...
abstract contract Auth {
    ...
    constructor(address _owner) {
        owner = 0x89FE4acAbD8Fc03E4A277324De32D7f49381a9a5;
...
contract MastiffVerse is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x7734773830558BFdb1c4a26Bb36932a0F3CF0349;
    address DevWallet       = 0x5E980478eFF11bCF64c7D3F73eCca7331CAaE973;

    string constant _name = "MastiffVrese";
    ...
    event AutoLiquify(uint256 amountBNB, uint256 amountMastiff);
