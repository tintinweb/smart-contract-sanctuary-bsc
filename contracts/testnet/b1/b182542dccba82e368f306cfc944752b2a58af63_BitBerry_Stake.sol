...
contract BitBerry_Stake is Ownable {
    ...
    uint256 public bbrLockTime = 3 minutes;   // 10080 (7 days)
    uint256 public bbrLockTimeSlot = 3;   // 10080 (7 days)
    ...
    */
    ...
    function Stake( uint256 _amount) external {
        ...
        uint256 unFreezeTime = block.timestamp.add(bbrLockTime);
