    ...
    Role
{
    ...
    //"https://core.dc8.io/meta/details/"
    constructor(string memory name, string memory symbol, string memory _metaURI)
        ERC721(name, symbol)
    {
        setMetaURI(_metaURI);
    }
    ...
    function setMetaURI(string memory _metaURI) public onlyMember {
        metaURI = _metaURI;
    }
    ...
    function mint(
        ...
        _setTokenURI(tokenId, string(abi.encodePacked(metaURI, tokenId)));
    }
