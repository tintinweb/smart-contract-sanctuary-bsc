...
contract ClaimTemplate is Ownable {
    ...
    function claim( uint256 _claimId,string memory funcName,uint256 amount, uint256 deadline, uint8 v, bytes32 r, bytes32 s) public {
        require(claimId[_claimId] == 0,"claim id have been used");
        claimId[_claimId] = 1;
        permitClaim(msg.sender, address(this),funcName,_claimId,amount,deadline, v, r, s);
