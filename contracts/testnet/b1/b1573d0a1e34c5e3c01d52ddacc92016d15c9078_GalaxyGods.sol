...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PROFIT = IBEP20(0x672e69622758D13cf53dA6ac514f747C690dFcDb);
    ...
    uint256 public minDistribution = 2000 * (10 ** 9);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = PROFIT.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(PROFIT);
        ...
        uint256 amount = PROFIT.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            PROFIT.transfer(shareholder, amount);
...
contract GalaxyGods is IBEP20, Auth {
    using SafeMath for uint256;

    address PROFIT = 0x672e69622758D13cf53dA6ac514f747C690dFcDb;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Galaxy Gods";
    string constant _symbol = "GLXGOD";
    ...
    uint256 public swapThreshold = _totalSupply / 400; // 0.5%
    bool inSwap;
