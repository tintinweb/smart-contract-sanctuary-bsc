...
// File: everjog/IterableMapping.sol
...
// File: everjog/DividendPayingTokenInterface.sol
...
// File: everjog/DividendPayingToken.sol
...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, Ownable {
  ...
  constructor(string memory _name, string memory _symbol)  ERC20(_name, _symbol) {
      ...
      router = _router;
      rewardToken = 0x3D7f3f0E8145ea3fC6b4f2A747E2CF5a5d55cA8E;
  }
...
contract EVERJOG is ERC20, Ownable {
    ...
    address public opsWallet = 0xfee2879FAAb37E5662BD5E9D2f211cFc897C7340;
    address public devWallet = 0xfee3d95BABd86Ca3a071233449F9A4ac32592cBC;
    ...
    constructor() ERC20("Everjog", "EJ") {
    	...
    	IRouter _router = IRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //Testnet: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
