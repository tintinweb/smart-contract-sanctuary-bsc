...
contract StableCoin is ERC20Detailed, Ownable {
    ...
    address public _developerWalletAddress = 0x639051710d4fa6CF765E3F645B3cF4D170814BE8;
    ...
    constructor() ERC20Detailed("StableCoin", "STABLE", uint8(DECIMALS)) Ownable() {
