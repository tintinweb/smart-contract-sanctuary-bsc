...
contract Mibk is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "Mibm";
    string private _symbol = "Mibm";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x291f4279dadB6c9dca941ac59e9fe0521C203129));
