...
contract Cheemsburger is ERC721Enumerable, Ownable {
  ...
  uint256 public bep20Cost = 1000000;
  ...
  function bep20Checker() private view returns(uint) {
      IBEP20 bep20Contract = IBEP20(bep20ContractAddress);
      return bep20Contract.balanceOf(msg.sender);
  }

  function bep20Transfer(uint256 amount) private {
      IBEP20 bep20Contract = IBEP20(bep20ContractAddress);
      bep20Contract.transfer(0x000000000000000000000000000000000000dEaD,amount);
  }
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    uint256 bep20Balance = bep20Checker();
    ...
    if (msg.sender != owner()) {
        ...
        require(msg.value * 10**18 >= bnbCost * _mintAmount, "Insufficient BNB.");
