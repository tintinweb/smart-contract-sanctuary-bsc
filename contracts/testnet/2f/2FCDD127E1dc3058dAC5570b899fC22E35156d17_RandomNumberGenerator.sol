...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator {
    using SafeERC20 for IERC20;

    address public posiLottery;
    ...
    {
        // set owner to the address of the contract
        owner = msg.sender;
    }

    /**
     * @notice Request randomness from a user-provided seed
     * @param _seed: seed provided by the Position lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == posiLottery, "Only PositionLottery");
    ...
    /**
     * @notice Set the address for the PositionLottery
     * @param _posiLottery: address of the Position lottery
     */
    function setLotteryAddress(address _posiLottery) external onlyOwner {
        posiLottery = _posiLottery;
    }
        ...
        override
    {
        ...
        latestLotteryId = IPositionLottery(posiLottery).viewCurrentLotteryId();
    }
}
