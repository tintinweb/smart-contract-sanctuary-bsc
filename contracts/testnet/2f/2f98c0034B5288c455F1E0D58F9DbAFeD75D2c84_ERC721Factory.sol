...
contract ERC721URIStorage is ERC721Enumerable{
 ...
 * account.
 */
abstract contract ERC721Enumerable is ERC721Init, IERC721Enumerable {
     ...
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165, ERC721Init) returns (bool) {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual override returns (uint256) {
        require(index < ERC721Init.balanceOf(owner), "ERC721Enumerable: owner index out of bounds");
    ...
    function _addTokenToOwnerEnumeration(address to, uint256 tokenId) private {
        uint256 length = ERC721Init.balanceOf(to);
    ...
    function _removeTokenFromOwnerEnumeration(address from, uint256 tokenId) private {
        ...
        uint256 lastTokenIndex = ERC721Init.balanceOf(from) - 1;
