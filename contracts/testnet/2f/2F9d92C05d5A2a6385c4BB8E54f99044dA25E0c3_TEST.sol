...
contract TEST is ERC721Enumerable, Ownable {
    ...
    //Dutch auction logic
    uint256 public startingPrice = 200000000000000000; // 0.2 eth testing only
    uint256 public decrease_interval = 600; // In seconds
    uint256 public decrease_per_interval = 1000000000000000; // 0.01 eth
    uint256 public ending_price = 60000000000000000; // 0.06 eth
    uint256 public starting_block;

    //Whitelist
    uint256 public whitelistPrice = 100000000000000000; // 0.1 eth
