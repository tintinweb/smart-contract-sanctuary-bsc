...
contract MiranaERC1155 is ERC1155, ERC1155Burnable, Ownable {
  // Contract name
  string public name;
  // Contract symbol
  ...
  constructor(
    ...
    require(owner != address(0), "ERC1155: address is not zero");
    name = _name;
    symbol = _symbol;
  ...
  function mintNewId(address recipient, uint256 amount) external onlyOwner {
    _mint(recipient, _tokenIdTracker.current(), amount, "");
