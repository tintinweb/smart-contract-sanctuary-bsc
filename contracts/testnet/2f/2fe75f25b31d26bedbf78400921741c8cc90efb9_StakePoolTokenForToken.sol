...
contract StakePoolTokenForToken is States, Ownable {
    ...
    function setTokens(uint256 _apy, uint256 _earlyUstakeFee, IBEP20 _stakingToken, IBEP20 _rewardingToken, address _rewardingTokenWallet, uint256 _lockPeriod, uint256 _maxReward, uint256 _earlyRewardUstakeFee, bool _autoCompund) public onlyOwner {
        apyTier = _apy;
    ...
    function _claim(address _address) internal {
        ...
        info.lastClaimTime = info.lockPeriod;
          ...
          info.lastClaimTime = info.lastClaimTime;
        }
...
contract FactoryStakingPool{
    ...
    function createTokenForToken(address ownerAddress, uint256 _apy, uint256 _earlyUstakeFee, IBEP20 _stakingToken, IBEP20 _rewardingToken, address _rewardingTokenWallet, uint256 _lockPeriod, uint256 _maxReward, uint256 _earlyRewardUstakeFee, bool _autoCompund) public returns (address)
    {
        StakePoolTokenForToken toDeploy = new StakePoolTokenForToken();
        toDeploy.setTokens(_apy, _earlyUstakeFee, _stakingToken, _rewardingToken, _rewardingTokenWallet, _lockPeriod, _maxReward, _earlyRewardUstakeFee, _autoCompund);
