...
// File: contracts/ScoutHubToken.sol
...
contract ScoutHubToken is Context, IERC20, IERC20Metadata, Ownable, Pausable {
    ...
    uint256 private constant MAX_SUPPLY = 1_250_000_000;
    ...
    constructor(
        ...
        balances[msg.sender] = initialSupply * 1e18;
    }
        ...
        onlyOwner
    {
        ...
        require(totalAmount <= MAX_SUPPLY, "ERC20: unsufficient max supply");
    ...
    {
        require(from != address(0), "ERC20: from address is not valid");
        require(from != address(this), "ERC20: from address is not related");
