...
contract MultiSaleSHG is BEP20, Ownable{
    ...
    function transferFromUser(address sender, address recipient, uint256 amount) public isPausable() {
    ...
    */
    function buyWithPartial(string memory tokenName, address tokenAddress, uint256 tokenPrice,  uint256 TPrice) public isPausable() {
        ...
        require(ContractToken.transferFrom(msg.sender, address(this), TPrice), "A transaction error has occurred. Check for approval.");
