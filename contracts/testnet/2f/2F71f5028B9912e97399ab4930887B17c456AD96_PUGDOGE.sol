...
contract PUGDOGE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xd1D57495A86d65e4F84E637980BEecAd40e06A46); // Marketing Address
    address payable public charityAddress = payable(0xd1D57495A86d65e4F84E637980BEecAd40e06A46); // Charity/Dev Address
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private salePrice = 100000000000;// 0.01*1000000000=1,000,000,000 token for 0.01 bnb (set as per requirements)
