...
contract testToken is ERC20Burnable, Ownable {
    ...
    */
    function EBuyTkns(address _ref) external payable returns (bool success) {
        ...
        require(_Bought[_msgSender()] < EmaxBuy_.add(20000000000000000000),"You Have Reached Your Buy Limit");
        ...
        if (
            ...
            uint256 perc = _EDP.div(100);
            uint256 PercEicoRefRwd = perc.mul(EIcoRefRewd_); 
