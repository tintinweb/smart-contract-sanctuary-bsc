...
contract Vault is Ownable, AccessControlEnumerable {
    ...
    function setWithDrawEnable(bool withdrawEnabled) public onlyOwner {
        withdrawEnable = withdrawEnabled;
    }

    function setMaxWithdrawAmount(uint256 amount) public onlyOwner {
    ...
    function withdraw(address to, uint256 amount) public onlyWithdrawer {
        require(amount <= maxWithdrawAmount, "Exceed maximum amount");
    ...
    function deposit(uint256 amount) external {
        ...
        require(_token.balanceOf(msg.sender) >= amount, "Insufficient account balance");
