...
contract BetCoVerse is Context, IBEP20, Ownable {
    ...
    address public burnAddress = 0xBFcCb70B305f6Ac64431F42fa8FcC8E1B436Ac0b;
    ...
    constructor(
        ...
        address payable _loyaltyWallet,
    ...
    function _takeMarketFee(uint256 tAmount) internal {
        uint256 tCharityFee = (tAmount * (_currentmarketingFee)) / (1e3);
        blanaces[marketWallet] = blanaces[marketWallet] + (tCharityFee);
