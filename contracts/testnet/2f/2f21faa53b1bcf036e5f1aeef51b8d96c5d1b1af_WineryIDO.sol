...
contract WineryIDO is ReentrancyGuard, Initializable {
    ...
    IWineryIDONFT public wineryDAONFT;
    ...
    constructor(IWineryNFT _wineryNFT, IWineryIDONFT _wineryDAONFT) {
        wineryNFT = _wineryNFT;
        wineryDAONFT = _wineryDAONFT;
    }
    ...
    function isWhitelist(address _user,uint256 _nftId) public view returns (bool) {
        ...
        uint256 balanceOfOwner = wineryDAONFT.balanceOf(_user);
        // User not only has owned and staked wineryNFT but also has owned wineryDAONFT
        return tokenOwner == _user && stakeFreeze == true && balanceOfOwner > 0;
    }
