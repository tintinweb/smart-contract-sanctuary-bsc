...
function _payFeesAndSeller(
        ...
        uint256 ownerAmount= _highestBid.mul(_ownerPercentage).div(1000000000000);
        
        uint256 platformFee= _highestBid.mul(platformFeePercentage).div(1000000000000);
        uint256 sellerAmount= _highestBid.sub((ownerAmount).add(platformFee));
        // Reset Sale Data
