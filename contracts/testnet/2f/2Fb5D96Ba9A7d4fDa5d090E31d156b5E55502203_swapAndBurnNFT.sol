...
contract swapAndBurnNFT {
    ...
    constructor(address _burnAddress, address _adminAddress, address _tokenContractAddress, bool _autoFlush, uint256 _swapCost) {
    ...
    onlyAdmin
    {
        ...
        address ownerAddress = instance.ownerOf(_tokenId);
        instance.transferFrom(ownerAddress, burnAddress, _tokenId);
    }
    ...
    payable
    {
        ...
        if (autoFlush) {
            ...
            instance.transferFrom(msg.sender, burnAddress, _tokenId);
        } else {
