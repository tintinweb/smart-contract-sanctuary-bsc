...
contract VS_TOKEN is ERC20, Ownable {
    ...
    constructor() ERC20("VS_TOKEN", "VS_TOKEN") {
    	...
    	buyBackWallet = address(0x499174CF158A0dc8B24B55Ca180C1ed58414a86d); // xxx buyback wallet
...
//================UPDATE FEES========================
    ...
    function zeroBuyFees() external onlyOwner {
        buyMarketingFee = 0;
        buyLiquidityFee = 0;
        buyBuyBackFee = 0;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyBuyBackFee;
    ...
    function regularBuyFees() external onlyOwner {
        buyMarketingFee = 5;
        buyLiquidityFee = 5;
        buyBuyBackFee = 0;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyBuyBackFee;
    ...
    function regularSellFees() external onlyOwner {
        sellMarketingFee = 2;
        sellLiquidityFee = 8;
        sellBuyBackFee = 5;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellBuyBackFee;
...
//========================================
    ...
    function buyBackTokens() external onlyOwner {
        ...
        // make the swap
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: address(buyBackWallet).balance}(
            0, // accept any amount of Ethereum
            path,
            address(0xdead), // send somewhere
            block.timestamp
        );
        emit BuyBackTriggered(address(buyBackWallet).balance);
    }
}