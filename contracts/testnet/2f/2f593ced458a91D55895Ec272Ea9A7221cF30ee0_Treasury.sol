...
contract Treasury is Initializable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize() public initializer {
        ...
        //init variable
        REWARD_INTERVAL = 24 * 3600;
        rewardPercent = 1000;

        //test
        _grantRole(DEFAULT_ADMIN_ROLE, 0x02759bEEcCeAa2E17931fE9dC1ab52eC8cd43f2F);
    ...
    function updatePool(
        ...
        poolInfo[pid].duration = duration;
    }
    ...
    function getInterval(uint256 time) internal view returns (uint256) {
        return (time + REWARD_INTERVAL - 1) / REWARD_INTERVAL;
    }

    //Test
    function setRewardInterval(uint16 _rewardInterval) external onlyRole(OPERATOR_ROLE) {
