...
contract Stake is Ownable {
    ...
    function setRate(address token, uint256 APR, uint256 period, uint256 withdrawFee) external {
    ...
    function removeRate(address token, uint256 period) external isTokenStakeable(token, period) {
