...
contract TestToken is ERC20, Ownable {
    ...
    function enableSwapBack(bool isEnabled) external onlyOwner {
        require(_swapBackEnabled != isEnabled, "RetroNeko: Swap Back enabled is already the value of 'isEnabled'");
    ...
    function _shouldSwapBack(address sender, address recipient) private view returns (bool) {
        return _swapBackEnabled && sender != owner() && recipient != owner() && !_isAutomatedMarketMakerPairs[sender];
    }
