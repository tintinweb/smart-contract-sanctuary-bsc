...
contract  LunarProbe is Ownable{
  IERC20 public usdt;
  IERC20 public lpe;
  ...
  constructor() public  {
    ...
    lpe = IERC20(0x172A4691c4c3BFA94Da16F2D030AA6C471cA6970);
  ...
  function buyXhOrder(uint amount, string memory uuid) public  {
    lpe.transferFrom(msg.sender, 0x000000000000000000000000000000000000dEaD, amount);
