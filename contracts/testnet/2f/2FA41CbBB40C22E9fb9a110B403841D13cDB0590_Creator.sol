...
contract Creator is Ownable {
        ...
        payable
    {
        ...
        StakingVaultV600(payable(_vault)).setFeeDistributor(payable(_feeDistributor));
...
contract StakingVaultV600 is Ownable, Pausable, ReentrancyGuard {
    ...
    */
    ...
    //VotingToken _votingToken
    {
        ...
        //votingToken = _votingToken;
        BOOST_WEIGHT = boostWeight * 100 * 10**10;
    ...
    function deposit(
        ...
        if (_slot == 0) {
            ...
            require(msg.sender == bondingContract, 'bond');
    ...
    function depositOperation(
        ...
        require(totalLockDuration <= MAX_LOCK_DURATION, '>maxlck');
        ...
        if (_amount > 0) {
            ...
            require(_amount == currentAmount, 'fees'); //only custom vaults can have fees on still
    ...
    function withdrawOperation(
        ...
        if (
            ...
            require(user.lockEndTime[_slot] < block.timestamp, 'lock');
        }
    ...
    function setMinMaxLockDuration(
        ...
        require(_maxLockDuration * 1 days <= MAX_LOCK_DURATION_LIMIT, 'mx');
    ...
    function setBoostWeight(uint256 _boostWeight) external onlyOwner {
        require(_boostWeight <= BOOST_WEIGHT_LIMIT, 'mx');
