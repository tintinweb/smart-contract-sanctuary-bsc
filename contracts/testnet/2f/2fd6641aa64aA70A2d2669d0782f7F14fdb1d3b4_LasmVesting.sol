...
contract LasmVesting is ReentrancyGuard, Ownable {
    ...
    uint256 private constant PUBLIC_SALE_ALLOCATION_1    =   8_000_000 * E18;
    uint256 private constant PUBLIC_SALE_ALLOCATION_2    =  72_000_000 * E18;
    ...
    address private constant managerWallet           = address(0xfDE865aB14d5dDF0F9fAD822DD9597EA6874393a);
    ...
    function initVestingSchedule() public onlyOwner {
        ...
        _createSchedule(managerWallet, Schedule({
            templateName         :  "PublicSale_1",
            claimedTokens        :  uint256(0),
            startTime            :  block.timestamp,
            allocation           :  PUBLIC_SALE_ALLOCATION_1,
            duration             :  0,            // 0 Months
            cliff                :  0,            // 0 Months
            linear               :  0,            // 0 Months
            lastClaimTime        :  0
        ...
        _createSchedule(managerWallet, Schedule({
            templateName         :  "PublicSale_2",
            claimedTokens        :  uint256(0),
            startTime            :  block.timestamp,
            allocation           :  PUBLIC_SALE_ALLOCATION_2,
            duration             :  12960000,     // 5 Months (5 * 30 * 24 * 60 * 60)
            cliff                :  0,            // 0 Months
            linear               :  12960000,     // 5 Months (5 * 30 * 24 * 60 * 60)
            lastClaimTime        :  0
        }));
