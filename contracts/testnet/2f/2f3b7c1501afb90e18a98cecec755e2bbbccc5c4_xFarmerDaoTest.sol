...
// ----------------------------------------------- xFarmerDao ---------------------------------------------------------
// ---------------------------------------------------------------------------------------------------------------
contract xFarmerDaoTest is BEP20 { 
    using SafeMath for uint256; 
    ...
    constructor(IDAO d){
        _name = 'xFarmerDaoTest';
        _symbol = 'XFDTEST';
        _decimals = 18;
        _totalSupply = 200000000 * 1e18;
        _balances[_msgSender()] = _totalSupply;
        pancakeSwapV2Router = IPancakeSwapV2Router(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//0x10ED43C718714eb63d5aA57B78B54704E256024E
        DAO = d;
