...
string constant TOKEN_NAME = "CoinFixe";
string constant TOKEN_SYMBOL = "FIXE";
uint256 constant TOTAL_SUPPLY = 1000_000_000;

// tax
uint16 constant DENOMINATOR = 10000;
uint16 constant MAX_FEE = 1000; // 10%
uint16 constant BUY_FEE = 1000; // 6%
uint16 constant ADMIN_SELL_FEE = 500; // 3%
...
contract COINFIXE is TradeManagedToken {
