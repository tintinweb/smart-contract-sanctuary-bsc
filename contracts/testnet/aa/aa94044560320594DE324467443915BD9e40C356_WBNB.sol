...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Wrapped BNB";
    string internal constant SYMBOL = "WBNB";
...
abstract contract WBNBAbstract is BaseRfiToken, Liquifier, Antiwhale {
...
contract WBNB is WBNBAbstract {
    constructor() WBNBAbstract(Env.Testnet) {
