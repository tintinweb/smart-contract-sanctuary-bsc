...
contract PAYPASS is PausableToken, MintableToken {
    // public variables
    string public name = "PAYPASSTOKEN";
    string public symbol = "PPT";
    uint8 public decimals = 18;

    constructor() public {
        totalSupply_ = 1000000000 * (18 ** uint256(decimals));
    }
