...
contract LoanCore is ILoanCore, AccessControl, Pausable {
    ...
    IERC721 public override assetWrapperToken;
    IFeeController public override feeController;

    // 10k bps per whole
    uint256 private constant BPS_DENOMINATOR = 10_000;

    constructor(IERC721 _assetWrapperToken, IFeeController _feeController) {
        ...
        assetWrapperToken = _assetWrapperToken;
        ...
        emit Initialized(address(assetWrapperToken), address(borrowerNote), address(lenderNote));
    }
