...
contract PundexFellasVault is Ownable, IERC721Receiver {
    ...
    function stake(uint256[] calldata tokenIds) external {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            pundexInterfaces(nftContract).safeTransferFrom(
                msg.sender,
                address(this),
                tokenId
            );
        ...
        internal
    {
        ...
        for (uint256 i = 0; i < tokenIds.length; i++) {
            ...
            pundexInterfaces(nftContract).safeTransferFrom(address(this), account, tokenId);
        }
    }
    ...
    function onERC721Received(
        ...
        require(
            from == address(0x0),
            "Cannot send NFTs to Pundex Vault directly"
        );
