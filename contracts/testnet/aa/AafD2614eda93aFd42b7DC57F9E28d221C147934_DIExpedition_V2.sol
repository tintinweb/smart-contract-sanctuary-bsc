    ...
    ERC1967UpgradeUpgradeable
{
    ...
    function fillDreamPoint(uint8 equipedCharIndex, uint256 dpValue) external {
        ...
        //console.log("ec.inLevelId",  ec.inLevelId);
        //console.log("ec.totalCombatPower*conf.dreamPointPerCombatPower",ec.totalCombatPower,conf.dreamPointPerCombatPower);
        //console.log("dpValue>=conf.minDreamPoint",dpValue,conf.minDreamPoint);
        //console.log("levelStatus.userStatus[_msgSender()].userDreamPoint+dpValue<=maxDreamPoint",
        //    levelStatus.userStatus[_msgSender()].userDreamPoint,dpValue,maxDreamPoint);
