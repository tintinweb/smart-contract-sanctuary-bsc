...
contract MarketStore is ERC1155Receiver, IERC721Receiver {
    ...
    */
    function createMarketItem(
        ...
        emit MarketItemCreated(itemId, tokenId, msg.sender, price, quantity);
    }
    ...
    function buyMarketItem(uint256 itemIndex) public payable {
        ...
        uint256 price = idToMarketItem[itemIndex].price;
        require(
            msg.value >= price,
            "Please submit the asking price in order to complete the purchase"
        );
        // sell successfully => tax sell 5% of market item's price
        uint256 taxSell = (price / 100) * 5;
        ...
        // send BNB to seller
        (bool success,) = payable(idToMarketItem[itemIndex].seller).call{value:price - taxSell}("");
        require(success,"Market:Transfer BNB to seller failed");
        // send tax sell to DAO treasury
        (bool successDao, )= payable(_DAOTreasury).call{value:taxSell}("");
         require(successDao,"Market:Transfer BNB to seller failed");
