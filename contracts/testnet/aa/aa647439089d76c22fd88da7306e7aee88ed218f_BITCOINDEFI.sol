...
contract BITCOINDEFI is ERC20Detailed, Ownable {
    ...
    function rebase() public {
        ...
        uint256 fRebaseAmount = 3500000 * 10 ** DECIMALS;
        uint256 sRebaseAmount =  8750000 * 10 ** DECIMALS;
        uint256 tRebaseAmount =  15312500 * 10 ** DECIMALS;
        uint256 foRebaseAmount = 21054688* 10 ** DECIMALS;
        uint256 lRebaseAmount = 25002441 * 10 ** DECIMALS;
        ...
        if (_totalSupply < fRebaseAmount) {
            ...
            rebaseRate = getRebaseRate(totalAvailable, 1875).div(10**RATE_DECIMALS);
            currentAPY = 1875;
        } else{
        rebaseRate = getRebaseRate(lRebaseAmount, 1250).div(10**RATE_DECIMALS);
            currentAPY = 1250;
        }
