...
contract BiFARMS_Sale {
    ...
    constructor(BEP20 ADD_T, address ADD_T2) {
        owner = msg.sender;
        claimTokenAddr = ADD_T2;
        minLimit = 100 * 10**18;
        maxLimit = 10000 * 10**18;
        maxCollectionLimit = 10000 * 10**18;
        buyPrice = 20;
        buyPriceDecimal = 100;
        time = 1648840799;
        busd = ADD_T;
    ...
    function deposit(uint amount) public {
        ...
        claim[sender].claimTimes.push(time + 3600);
        claim[sender].claimTimes.push(time + 7200);
        claim[sender].claimTimes.push(time + 10800);
        claim[sender].claimTimes.push(time + 14400);
        claim[sender].claimTimes.push(time + 18000);
        claim[sender].claimTimes.push(time + 21600);
        claim[sender].claimTimes.push(time + 25200);
        claim[sender].claimTimes.push(time + 28800);
        claim[sender].claimTimes.push(time + 32400);
