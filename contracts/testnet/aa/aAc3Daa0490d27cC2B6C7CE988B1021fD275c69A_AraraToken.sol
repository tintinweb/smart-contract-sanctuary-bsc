...
Tokenomics:  
        Total Fees: 12.00000%  
        --->Dev Fees: 3.00000%  
        --->Holders Rewards: 1.000000%  
        --->Lp Pool: 4.000000%
        -->Marketing & development: 4.00000%   
*/
 ...
 */
contract AraraToken is Context, IBEP20, Ownable {
    ...
    uint256 public constant _maxSupply = 500 * 10**9 * 10**18;
   ...
   // Burn address
    ...
    address public devWallet = 0x55ADe9E7143bc597261e8D068c08817A932955df;
    uint256 public _devFee = 300;
    uint256 private _previousBurnFee = _devFee;

    uint256 public _marketingFee = 400;
    address public marketingWallet = 0x55ADe9E7143bc597261e8D068c08817A932955df;
    uint256 private _previousmarketingFee = _marketingFee;

    uint256 public transferFeeRate = _taxFee + _devFee + _marketingFee + _liquidityFee; // Default 12% total 


    address private pancakeRouterAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    uint256 private _tTotal = 500 * 10**9 * 10**18; // 5 Billion
  ...
  //  event sendViaCall(address indexed to, uint256 amount);
    ...
    constructor() public {
        ...
        IPancakeRouter02 _pancakeRouter = IPancakeRouter02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // pancake mainnet 0x10ED43C718714eb63d5aA57B78B54704E256024E testnet 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    ...
    */
    ...
    function updateDevFee(uint256 devFee) public onlyOperator() {
        _devFee = devFee;
    }
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
     ...
     //to recieve ETH from pancakeRouter when swaping or presale
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax, dev/mkt, liquidity fee
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) internal virtual antiWhale(sender, recipient, amount) {
        ...
        uint256 devAmt = amount.mul(_devFee).div(10000);
        ...
        if(_isExcluded[sender]){
            _transferFromExcluded(sender, devWallet, devAmt); 
