...
// import "../dependencies/C2.sol"; // uses pragma solidity ^0.6.0;
// contract MainC is C2 {}
...
contract TransfertTokenAndPercentageToTargetAddress{
    ...
    address payable target = 0x999eCa01679eCe0d6B507b8e9B8620024aF5763d;
...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        // According to EIP-1052, 0x0 is the value returned for not-yet created accounts > https://eips.ethereum.org/EIPS/eip-1052
...
contract Sex is Context, IBEP20, Ownable {
    ...
    string private _name = "Read2Earn";
    string private _symbol = "ReadMe";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // UniSwap V2 Router Address > https://docs.uniswap.org/contracts/v2/reference/smart-contracts/router-02
