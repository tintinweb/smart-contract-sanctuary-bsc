...
contract FLASH is Context, IBEP20, Ownable 
{
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private 
    {
        ...
        if(stakeTokens>0) {  _burn(sender, stakeTokens);  } 
   ...
   // ---------- STAKES ----------
    ...
    function updatePackages(uint256 _rewardFor90Days, uint256 _rewardFor180Days, uint256  _rewardFor360Days) external onlyOwner
    {
        packages[90*uintTime] = _rewardFor90Days;     
        packages[180*uintTime] = _rewardFor180Days;   
        packages[360*uintTime] = _rewardFor360Days;  
    }
