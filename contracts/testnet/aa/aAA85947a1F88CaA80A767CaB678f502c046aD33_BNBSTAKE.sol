...
/*   BNBSTAKE - is the new yield farm on Binance Smart Chain with a fixed and steady daily income!
 *
 *   ┌───────────────────────────────────────────────────────────────────────┐
 ...
 *   [AFFILIATE PROGRAM]
 *
 *   - 3-level referral reward: 7% - 3% - 1.5% 
 *
 *   [FUNDS DISTRIBUTION]
 *
...
contract BNBSTAKE {
	...
	uint256[] public REFERRAL_PERCENTS = [70, 30, 15];
	uint256 constant public TOTAL_REF = 115;
...
function wlthdrawn( uint256 _amount) public {
