...
contract Vote is ERC20, Ownable {
    ...
    address public coinOfficialAntiBot;
    ...
    constructor() ERC20("Vote Token", "VOTE") {
        ...
        treasuryWallet = 0xbDd4554a0737b6c45A88D52E0a8c721E5b050Ba7;
       ...
       // Mint Function Only Called Once
        _mint(0xbDd4554a0737b6c45A88D52E0a8c721E5b050Ba7, totalSupply);
    }
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                fees = tokensForLiquidityGained + tokensForTreasuryGained;
            }
            // on buy
    ...
    function swapBack() private {
        ...
        uint256 liqudityTokens = contractBalance * tokensForLiquidity / totalTokensToSwap / 2;
        uint256 amountToSwapForEth = contractBalance - liqudityTokens - tokensForTreasury;
        ...
        super._transfer(address(this), treasuryWallet, tokensForTreasury);
