...
contract INFLIVReferrals is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function addMember(address teamMember, address sponsor) public isModerator nonReentrant{
