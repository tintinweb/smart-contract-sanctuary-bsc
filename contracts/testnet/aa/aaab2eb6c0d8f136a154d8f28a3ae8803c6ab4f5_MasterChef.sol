...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    function initializePools() external onlyOwner {
        add(86400*30, 100, true);
        add(86400*30*3, 200, true);
        add(86400*30*6, 300, true);
        add(86400*30*12, 500, true);
        add(86400*30*18, 650, true);
        add(86400*30*36, 800, true);
        add(86400*30*60, 1000, true);
    }

    function add(uint256 _duration, uint256 _apy, bool _withUpdate) public onlyOwner {
    ...
    function checkUserAllowance(address _user) public view returns(uint256) {
