...
contract UrlRequests is usingProvable {
    ...
    //         provable_query("URL", _url, _jsonData);
    //     }
    // }
    ...
    function requestPost()
        ...
        payable
    {
        requestForDemo("json(https://www.pipsr.cloud/api/v1/address-security).data.trust_level", '{"chain_id":"56","address":"0x312bc7eaaf93f1c60dc5afc115fccde161055fb0"}');
    }
}