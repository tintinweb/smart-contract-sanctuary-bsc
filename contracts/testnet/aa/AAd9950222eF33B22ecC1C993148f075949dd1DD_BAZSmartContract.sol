...
TOKENOMICS:
1% AUTOBURN
2% Club Treasury Reward – This is for our mission wallet for the sustainability of the dream destination experiences.
...
contract BAZSmartContract is Context, IERC20, Ownable {
    ...
    string private constant _name = "Updated reburn2";
    string private constant _symbol = "REB3";
   ...
   function increaseAllowance(address spender, uint256 addedValue) public virtual returns (bool) {
    ...
    function takeTaxes(address from, address to, uint256 amount) internal returns (uint256) {
        ...
        uint256 burnTokens = amount * currentBurn / masterTaxDivisor;
        if (burnTokens > 0) {
