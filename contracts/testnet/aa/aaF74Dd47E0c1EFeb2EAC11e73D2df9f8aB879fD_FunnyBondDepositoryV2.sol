...
abstract contract FrontEndRewarder is FunnyAccessControlled {
    /* ========= STATE VARIABLES ========== */
    ...
    constructor(IFunnyAuthority _authority, IERC20 _ohm) FunnyAccessControlled(_authority) {
        ohm = _ohm;
    }
...
contract FunnyBondDepositoryV2 is IBondDepository, NoteKeeper {
    /* ======== DEPENDENCIES ======== */
