...
contract BetStaking is ReentrancyGuard, Runnable {
    ...
    constructor(address tokenAddress) {
        ...
        //Init data
        _stakingPackages[1] = StakingPackage(1, true, 96e18, 10000e18, 604800);
        _stakingPackages[2] = StakingPackage(
            2,
            true,
            370e18,
            10000e18,
        ...
        _stakingPackages[3] = StakingPackage(
            3,
            true,
            1479e18,
            10000e18,
        ...
        _stakingPackages[4] = StakingPackage(
            3,
            true,
            5260e18,
            10000e18,
        ...
        returns (uint256)
    {
        ...
        require(
            _totalVesting > (_totalProfits + stakingPackage.rewardAmount),
            "Staking filled this month"
        );
        require(
            _token.balanceOf(msg.sender) >= stakingPackage.stakingAmount,
            "Not enough balance"
        );
        ...
        //Set staking detail
        _stakingCount += 1;
        _totalProfits += stakingPackage.rewardAmount;
        StakingDetail memory stakingDetail = StakingDetail(
            _stakingCount,
            package,
            msg.sender,
            stakingPackage.rewardAmount,
            stakingPackage.stakingAmount,
            1,
            block.timestamp,
