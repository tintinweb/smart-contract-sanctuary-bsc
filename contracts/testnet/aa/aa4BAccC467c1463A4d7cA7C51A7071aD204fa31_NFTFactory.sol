...
contract NFTFactory is Governance, INFTFactory {
    ...
    function gmMintMulti(uint256 ruleId, uint256 resBaseId, uint256 quantity, uint256 grade, uint256 quality, uint256 expiringDuration, address author) public {
        MintData memory mintData;
        mintData.amount = 0;
        mintData.resBaseId = resBaseId;
        mintData.nftType = 0;
