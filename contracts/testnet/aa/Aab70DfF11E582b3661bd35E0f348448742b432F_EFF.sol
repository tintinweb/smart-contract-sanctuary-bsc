...
contract EFF is IERC20, Ownable {
    ...
    address public BURN = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    address public LOTTERY = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    ...
    function updateSellFees(
        ...
        sellTotalFees = sellTotalFees.add(buyBack).add(gamePool).add(lottery);
