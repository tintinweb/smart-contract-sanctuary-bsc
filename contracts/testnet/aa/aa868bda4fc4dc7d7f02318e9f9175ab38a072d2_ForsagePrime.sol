...
contract ForsagePrime is Ownable {
  ...
  using SafeMath for uint256;
  IBEP20 usdt = IBEP20(0x12eb5988e972607f0Eaa40aDf359f902dD7a4E24);
  ...
  constructor() public {
        ...
        rebirth = msg.sender;
        // LevelPrice
        levelPrice[1]  =  15000000000000000000;
  ...
  function joinProgram(uint depAmount, uint _referrerID) public {
       ...
       function upgradePackage(uint8 _level,uint depAmount) public {
        uint _userId = autoPoolId[msg.sender];
        usdt.transferFrom(msg.sender, address(this), levelPrice[_level]);
