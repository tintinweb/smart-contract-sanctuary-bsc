...
contract MyToken is ERC20Upgradeable, OwnableUpgradeable, ERC20BurnableUpgradeable {
    ...
    function burn(uint256 _amount) public override onlyOwner {
        require (_amount <= _maxSupply * 5 / 100, "is not allowed to burn more than 5%");
        require (_maxSupply > 10**6);
