...
*/
    ...
    constructor() ERC721("DebtCity", "BANKERS") {
        ...
        payableWallet = payable(address(0x756B7775c93C6Fb0ef7207f566402FE1cC87e4Ce));

        // 9 skin vals
        TIERS[0] = [20, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000];
        // 9 eye vals
        TIERS[1] = [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000];
        // 4 mouth vals
        TIERS[2] = [2000, 4000, 6000, 8000];
        // 4 shoes vals
        TIERS[3] = [2000, 4000, 6000, 8000];
        // 4 pants vals
        TIERS[4] = [2000, 4000, 6000, 8000];
        // 8 dress shirt vals
        TIERS[5] = [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000];
        // 4 glasses vals
        TIERS[6] = [2000, 4000, 6000, 8000];
        // 10 t-shirt vals
        TIERS[7] = [500, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000];
        // 10 polo vals
        TIERS[8] = [500, 1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000];
        // 6 tie vals
        TIERS[9] = [1500, 3000, 4500, 6000, 7500, 9000];
        // 7 vest vals
        TIERS[10] = [1500, 3000, 4500, 5500, 7000, 8000, 9000];
        // 5 jacket vals
        TIERS[11] = [1500, 4000, 5500, 7000, 8500];
        // 6 pock square vals
        TIERS[12] = [1500, 3000, 4500, 6000, 7500, 9000];
        // 9 hair vals
        TIERS[13] = [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000];
        // 5 watch vals
        TIERS[14] = [2000, 4500, 7000, 8000, 9000];
    }
