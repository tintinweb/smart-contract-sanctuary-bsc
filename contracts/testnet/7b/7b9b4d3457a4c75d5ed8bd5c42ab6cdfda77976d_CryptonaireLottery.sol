    ...
    ICryptonaireLottery
{
     ...
     */
     ...
     function changeTicketCollection(address _ticketCollectionAddress)
        ...
        onlyOwner
    {
        uint256 currentTokenId = ITicketCollection(_ticketCollectionAddress).currentTokenId();
        require(
    ...
    function updateTicketOwner(
        ...
        if (_ticketOwner != address(0)) {
            ...
            address _winningAddress = _lotteries[_lotteryId].winningAddress;

            // Update winning address if winning tick & not claimed
            if (_oldOwner == _winningAddress) {
