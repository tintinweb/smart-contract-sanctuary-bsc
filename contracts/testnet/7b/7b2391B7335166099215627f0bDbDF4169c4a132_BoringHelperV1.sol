...
contract BoringHelperV1 is Ownable {
    ...
    IMasterChef public chef = IMasterChef(0x0000000000000000000000000000000000000000);
    address public maker = 0x0000000000000000000000000000000000000000;
    IERC20 public sushi = IERC20(0x0000000000000000000000000000000000000000);
    IERC20 public WETH;
    IERC20 public WBTC = IERC20(0x0000000000000000000000000000000000000000);
    IFactory public sushiFactory = IFactory(0x0000000000000000000000000000000000000000);
    IFactory public uniV2Factory = IFactory(0x0000000000000000000000000000000000000000);
    IERC20 public bar = IERC20(0x0000000000000000000000000000000000000000);
