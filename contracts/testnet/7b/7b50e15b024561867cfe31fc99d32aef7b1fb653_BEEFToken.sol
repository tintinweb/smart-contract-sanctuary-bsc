...
/**Beefswap Platform
	*LBeefswap is a one stop decentralized trading platform on Binance Smart Chain that helps users swap between two tokens.*
*/
...
// Beefswap token with Governance.
contract BEEFToken is BEP20('Beefswap', 'BEEF') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying BEEFFs (not scaled);
    ...
    function addMinter(address _addMinter) public onlyOwner returns (bool) {
        require(_addMinter != address(0), "BEEF: _addMinter is the zero address");
        return EnumerableSet.add(_minters, _addMinter);
    }

    function delMinter(address _delMinter) public onlyOwner returns (bool) {
        require(_delMinter != address(0), "BEEF: _delMinter is the zero address");
    ...
    function getMinter(uint256 _index) public view onlyOwner returns (address){
        require(_index <= getMinterLength() - 1, "BEEF: index out of bounds");
