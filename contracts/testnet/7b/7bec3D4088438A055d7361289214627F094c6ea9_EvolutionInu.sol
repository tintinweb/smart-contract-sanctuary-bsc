...
contract EvolutionInu is ERC20, Ownable {
    ...
    constructor() ERC20("EvolutionInu", "EVO") {
        ...
        maxTransactionAmount = totalSupply * 25 / 10000; // 0.5% Of token supply per transaction (to be disabled sometime after launch this allows for fair entries)
