...
contract MythEngrams is ERC721 {
    ...
    event engramResolved(
        uint256 engramId,
        uint256 numberRolled,
        bytes32 resolutionSeed
    );
    event engramUpgraded(uint256 engramId);
    ...
    function upgradeWeapon(uint256 _engramId) external returns (bool) {
        ...
        require(
            currentEngram.owner == msg.sender,
...
contract EngramTable {
    ...
    constructor() {
        owner = payable(msg.sender);
        prizes[0] = prize(0, 24999, 102000);
        prizes[1] = prize(25000, 49999, 104000);
        prizes[2] = prize(50000, 74999, 106000);
        prizes[3] = prize(75000, 99999, 108000);
        prizeCount = 4;
    }
