...
import "./modules/SpotManagerModule.sol";
...
contract BUSDPosiVaultV2 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, SpotManagerModule, VestingScheduleBase {
    ...
    uint256 public constant POSI_BUSD_PID = 4;
    //
    //    // TESTNET
    ...
    function initialize(
        ...
        address _spotHouse,
        address _prtPOSIPair
    ) public initializer {
        __ReentrancyGuard_init();
        __Ownable_init();
        __SpotManagerModule_init(_spotHouse, _prtPOSIPair);
        /*
        MAINNET
    ...
    */
    ...
    function updateSpotManager(address newSpotManager) public onlyOwner {
        __SpotManagerModule_init(address(spotHouse), newSpotManager);
    }
...
abstract contract SpotManagerModule {
    ...
    function approveRewardTokenForSpotHouse() public {
