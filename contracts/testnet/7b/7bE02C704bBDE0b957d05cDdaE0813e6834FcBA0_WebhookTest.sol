...
contract WebhookTest {
    ...
    function emitTestEvent1(uint256 data1) external {
        emit SampleEvent1(data1);
    }

    function emitTestEvent2(uint256 data1, uint256 data2) external {
        emit SampleEvent2(data1, data2);
    }
