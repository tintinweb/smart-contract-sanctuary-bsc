...
contract Timekeeper is Ownable, ITimekeeper {
    event Log(string str);

    int256 constant EARLY_OFFSET = 14;
    int256 constant LATE_OFFSET = -12;
    int256 public _utcOffset = 0;
    uint256 public _openingHour = 9;
    uint256 public _openingMinute = 30;
    uint256 public _closingHour = 16;
    uint256 public _closingMin = 0;
