...
contract Arties is ERC721Burnable, Ownable {
    ...
    function mint(uint256 tokenId, bytes32 hash) external payable {
        (address signer, ) = ECDSA.tryRecover(hash, abi.encodePacked(msg.sender, address(this), tokenId, nonces[tokenId]));
