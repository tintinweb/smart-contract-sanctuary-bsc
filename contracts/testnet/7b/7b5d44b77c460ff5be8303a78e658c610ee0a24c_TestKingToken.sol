...
contract TestKingToken is IERC20, Ownable {
    ...
    // token data
    string private constant _name = "NewKingToken2";
    string private constant _symbol = "NKT32";
    uint8  private constant _decimals = 18;
    uint256 public constant MAX_TOTAL_SUPPLY = 1 * 1**_decimals;
    address private constant _BackingBusd = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
