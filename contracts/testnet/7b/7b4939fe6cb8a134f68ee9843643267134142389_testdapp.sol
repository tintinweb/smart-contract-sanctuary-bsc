...
contract testdapp  {
    ...
    uint256[] public  package_amount = [35,50,100,250,500,1000,5000];
    uint256[] public X1_level_income = [10,1,1,1,1,1,1,1,1,1];
    ...
    uint256[] public X6_level_income = [400,400,400,400,400,400,400];
    uint256[] public X7_level_income = [2000,2000,2000,2000,2000,2000,2000];
   

    uint256 public  max_package_amount = 500;
    ...
    uint public constant X6_LEVEL_SUM = 400;
    ...
    uint256[] public X6_LEVEL = [40,40,40,40,40,40,40,40,40,40];
    ...
    uint public X6_LEVEL_POOL_SUM = 400;
