...
contract RGPSpecialPool is Ownable {
    ...
    function stake(uint256 _quantity, address _referral) public  {
        ...
        uint256 convAmt = ((_quantity * 80E18) / 100E18);
        uint256 devPct = ((_quantity * 20E18) / 100E18);       
        ...
        devWithdrawal = devWithdrawal.add(devPct);        
    ...
    function unStake(uint256 _amount) public {
        require (userUnstake == false, "Not eligible to unstake");
