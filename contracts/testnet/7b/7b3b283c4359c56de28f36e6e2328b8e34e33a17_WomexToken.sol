...
contract WomexToken is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress =
        payable(0x7c70BA447d649552E307FB0aa53E63C9e8181544); // Marketing Address
    address payable public teamWalletAddress =
        payable(0x375635c2112B1E30Fc5DeDD3E1440FD06EE68F70); // Team Address
    ...
    function transferWomexFromGameToUser(address to, uint256 amount)
        public
        onlyOwner
    {
    ...
    function transferEthFromGameToUser(address to, uint256 amount)
        public
        onlyOwner
    {
