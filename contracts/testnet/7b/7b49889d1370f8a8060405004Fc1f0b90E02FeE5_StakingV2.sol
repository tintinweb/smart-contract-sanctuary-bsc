...
contract StakingV2 is Ownable {
    ...
    function aTest(uint256 _pid) external view returns(IOldStaking.UserInfo memory) {
        IOldStaking.UserInfo memory info;
        info = g_oldContract.userInfo(_pid, msg.sender);
        return info;
    }
