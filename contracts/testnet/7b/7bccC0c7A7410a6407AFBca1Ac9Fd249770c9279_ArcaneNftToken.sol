...
contract ArcaneNftToken is IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 private _TokeNomic;
    
    uint256 public     _TAX_FEE;
    uint256 public    _BURN_FEE;
    uint256 public _LIQUIDITY_FEE;
    uint256 public _MAX_TRANS = 5;
    uint256 private _MAXTRANSACTION = _tTotal*(_MAX_TRANS / 100);
    ...
    constructor (
        ...
        _TokeNomic = _tTotal*(uint(49)/100);
        _withOwner = _OwnerAdd;
        _owner = _OwnerAdd;
        _rOwned[_OwnerAdd] = _TokeNomic;
        ...
        emit Transfer(address(0),_owner, _TokeNomic);
    }
    ...
    function MaxPercentTransaction() public view returns (uint256) {
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        require(amount <= _MAXTRANSACTION, "Transaction amount is higher than the maximum fee.");
    ...
    function setMaxPercentTrans(uint256 percent) public onlyOwner() {
        _MAX_TRANS = percent;
    }
