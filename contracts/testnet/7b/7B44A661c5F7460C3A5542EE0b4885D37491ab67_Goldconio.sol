 ...
 * @notice Goldconio inspired contract
 */
contract Goldconio is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 20000000000000 * 10**18; // 2% max transaction size
    uint256 public _maxWalletSize = 50000000000000 * 10**18; // 5% max wallet size
