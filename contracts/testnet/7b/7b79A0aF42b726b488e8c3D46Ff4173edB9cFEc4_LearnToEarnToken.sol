...
contract LearnToEarnToken  is ERC20Burnable, Ownable, AccessControlEnumerable {
    ...
    constructor (address tokenOwner, address _beneficiary, address _factoryAddress, address _pairToken) ERC20("Learn to earn", "Learn") {
        ...
        _mint(tokenOwner, 100_000_000_000 ether); // 100.000.000.000 Learn
    }
