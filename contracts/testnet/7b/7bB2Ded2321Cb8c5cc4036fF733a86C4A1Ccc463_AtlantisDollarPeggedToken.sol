...
import "../Token/AtlantisToken.sol";

contract AtlantisDollarPeggedToken is AtlantisPayToken {
...
contract AtlantisPayToken is Context, ERC20, Ownable {
    ...
    modifier onlyMasterMinter() {
        require(
            ...
            "TokenToken: caller is not the masterMinter"
        );
        _;
    }
