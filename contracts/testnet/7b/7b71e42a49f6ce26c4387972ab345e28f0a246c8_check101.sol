...
contract check101 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x048A767Fe70642105f7dAC18A5FAbB6f1a598b8D;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "check101";
    string private _symbol = "chk101";
