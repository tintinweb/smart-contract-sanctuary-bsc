...
contract LandRecord{
    // contract address bnb 0x7b7730DBaA72Fb18cd80f889752cAe606ff1136C
    ...
    constructor() public {
        lands[0]=Lands(0,0.0001 ether, address(0),msg.sender,msg.sender,false);
        lands[1]=Lands(1,0.0001 ether,address(0),msg.sender,msg.sender,false);
        lands[2]=Lands(2,0.0001 ether,address(0),msg.sender,msg.sender,false);
        lands[3]=Lands(3,0.0001 ether,address(0),msg.sender,msg.sender,false);
        lands[4]=Lands(4,0.0001 ether,address(0),msg.sender,msg.sender,false); 
    }
