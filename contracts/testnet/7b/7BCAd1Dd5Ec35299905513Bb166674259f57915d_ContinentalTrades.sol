...
// Main Contract
contract ContinentalTrades is IERC20Metadata, Ownable {
   ...
   // General
   string private _name = 'Continental Trades';
   ...
   address payable public liqWallet = payable(0x484D419518212Ea43ECd5dDAf756BA33b4153D0B);
   address payable public marketingWallet = payable(0x2500ec9082e0f3A7CD4C6011300cF8d7Db037ac9);
 
   // Max wallet size
   uint256 public txDenominator = 10000;
   uint256 public maxWalletSize = 100;
