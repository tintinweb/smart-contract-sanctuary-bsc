...
contract GHOST is IBEP20, Auth {
    ...
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + buybackFee + stakingFee + devFee;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x6f568F61De2d21FF2d7888B02F40f3B911D3103F;
        buybackFeeReceiver = 0x6f568F61De2d21FF2d7888B02F40f3B911D3103F;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _buybackFee, uint256 _devFee, uint256 _stakingFee, uint256 _feeDenominator) external authorized {
        ...
        totalFee = _liquidityFee + _reflectionFee + _marketingFee + _buybackFee + _stakingFee + _devFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 49%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _buybackFeeReceiver, address _stakingFeeReceiver, address _devFeeReceiver ) external authorized {
