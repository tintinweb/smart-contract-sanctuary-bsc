...
contract HordConfiguration is HordUpgradable, Initializable {
    ...
    uint256 public leniencePercent;
    ...
    function initialize(
        ...
        leniencePercent = configValues[13];
        maxDurationValue = configValues[14];
        minTimeToStake = configValues[15];
        minAmountToStake = configValues[16];
        platformStakeRatio = configValues[17];
        maxSupplyHpoolToken = configValues[18];
    ...
    onlyHordCongress
    {
        minChampStake = minChampStake_;
        emit ConfigurationChanged("_minChampStake", minChampStake);
    }
    ...
    onlyHordCongress
    {
        minFollowerUSDStake = minFollowerUSDStake_;
        emit ConfigurationChanged("_minFollowerUSDStake", minFollowerUSDStake);
    }
    ...
    onlyHordCongress
    {
        maxFollowerUSDStake = maxFollowerUSDStake_;
        emit ConfigurationChanged("_maxFollowerUSDStake", maxFollowerUSDStake);
    }
    ...
    onlyHordCongress
    {
        gasUtilizationRatio = gasUtilizationRatio_;
        emit ConfigurationChanged("_gasUtilizationRatio", gasUtilizationRatio);
    }

    // Set percent precision
    function setPercentPrecision(
        uint256 percentPrecision_,
        uint256 championFeePercent_,
        uint256 protocolFeePercent_,
        uint256 leniencePercent_,
        uint256 percentBurntFromPublicSubscription_,
        uint256 gasUtilizationRatio_
    )
    external
    onlyHordCongress
    {
        require(percentPrecision_ > 100 && percentPrecision_ < 10000000, "Precision is not within the permitted range.");
        require(championFeePercent_ <= percentPrecision_, "value is smaller than percentPrecision");
        require(protocolFeePercent_ <= percentPrecision_, "value is smaller than percentPrecision");
        require(leniencePercent_ <= percentPrecision_, "value is smaller than percentPrecision");
        require(percentBurntFromPublicSubscription_ <= percentPrecision_, "value is smaller than percentPrecision");
        require(gasUtilizationRatio_ <= percentPrecision_, "value is smaller than percentPrecision");

        percentPrecision = percentPrecision_;
        championFeePercent = championFeePercent_;
        protocolFeePercent = protocolFeePercent_;
        leniencePercent = leniencePercent_;
        percentBurntFromPublicSubscription = percentBurntFromPublicSubscription_;
        gasUtilizationRatio = gasUtilizationRatio_;
    ...
    onlyHordCongress
    {
        maxUSDAllocationPerTicket = maxUSDAllocationPerTicket_;
    ...
    onlyHordCongress
    {
        totalSupplyHPoolTokens = totalSupplyHPoolTokens_;
        emit ConfigurationChanged("_totalSupplyHPoolTokens", totalSupplyHPoolTokens);
    }

    // _endTimeTicketSale setter function
    function setEndTimeTicketSale(
        uint256 endTimeTicketSale_
    )
    external
    onlyIfDurationIsValid(endTimeTicketSale_)
    onlyHordCongress
    {
        ticketSaleDurationSecs = endTimeTicketSale_;
        emit ConfigurationChanged("_endTimeTicketSale", ticketSaleDurationSecs);
    }

    // _etEndTimePrivateSubscription setter function
    function setEndTimePrivateSubscription(
        uint256 endTimePrivateSubscription_
    )
    onlyIfDurationIsValid(endTimePrivateSubscription_)
    external
    onlyHordCongress
    {
        privateSubscriptionDurationSecs = endTimePrivateSubscription_;
        emit ConfigurationChanged("_endTimePrivateSubscription", privateSubscriptionDurationSecs);
    }

    // _setEndTimePublicSubscription setter function
    function setEndTimePublicSubscription(
        uint256 endTimePublicSubscription_
    )
    onlyIfDurationIsValid(endTimePublicSubscription_)
    external
    onlyHordCongress
    {
        publicSubscriptionDurationSecs = endTimePublicSubscription_;
        emit ConfigurationChanged("_endTimePublicSubscription", publicSubscriptionDurationSecs);
    }
    ...
    {
        percentBurntFromPublicSubscription = percentBurntFromPublicSubscription_;
        emit ConfigurationChanged("_percentBurntFromPublicSubscription", percentBurntFromPublicSubscription);
    }
    ...
    {
        championFeePercent = championFeePercent_;
        emit ConfigurationChanged("_championFeePercent", championFeePercent);
    }
    ...
    {
        protocolFeePercent = protocolFeePercent_;
        emit ConfigurationChanged("_protocolFeePercent", protocolFeePercent);
    }

    //_tradingFeePercent
    function setTradingFeePercent(
        uint256 tradingFeePercent_
    )
    external
    onlyHordCongress
    {
        tradingFeePercent = tradingFeePercent_;
        emit ConfigurationChanged("_tradingFeePercent", tradingFeePercent);
    }

    //_leniencePercent
    function setLeniencePercent(
        uint256 leniencePercent_
    )
    external
    onlyHordCongress
    {
        leniencePercent = leniencePercent_;
        emit ConfigurationChanged("_leniencePercent", leniencePercent);
    }

    //_maxDurationValue
    function setMaxDurationValue(
        uint256 maxDurationValue_
    )
    external
    onlyHordCongress
    {
        maxDurationValue = maxDurationValue_;
        emit ConfigurationChanged("_maxDurationValue", maxDurationValue);
    }

    //_minTimeToStake
    function setMinTimeToStake(
        uint256 minTimeToStake_
    )
    external
    onlyIfDurationIsValid(minTimeToStake_)
    onlyHordCongress
    {
        minTimeToStake = minTimeToStake_;
        emit ConfigurationChanged("_minTimeToStake", minTimeToStake);
    }
    ...
    onlyHordCongress
    {
        ...
        emit ConfigurationChanged("_minAmountToStake", minAmountToStake);
    }
    ...
    onlyHordCongress
    {
        platformStakeRatio = platformStakeRatio_;
    ...
    onlyHordCongress
    {
        maxSupplyHpoolToken = maxSupplyHpoolToken_;
        emit ConfigurationChanged("maxSupplyHpoolToken", maxSupplyHpoolToken);
    }

    // Function calculates amount with lenience
    function lenience(uint256 amount)
    external
    view
    returns (uint256)
    {
        uint256 lenience = amount.mul(leniencePercent).div(percentPrecision);
        return lenience;
    }
