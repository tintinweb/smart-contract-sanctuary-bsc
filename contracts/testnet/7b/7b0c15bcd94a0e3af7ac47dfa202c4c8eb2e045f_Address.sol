...
contract GoldConio is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000000 * 10**18; // 1 quadrillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "GOLDCONIO";
    string private _symbol = "GCNIO";
    ...
    address public marketingWallet = 0x5Fb0D95ACA845626F0fb84aBc723E8A96cC2AF78;
    ...
    uint256 public _maxTxAmount = 10000000000000 * 10**18; // 1%
    uint256 public _maxWalletSize = 30000000000000 * 10**18; // 3%
    uint256 private numTokensSellToAddToLiquidity = 1000000000000 * 10**18; // 0.1%
    ...
    constructor () {
        ...
        _isExcludedFromFee[0x3784Da5794E90Cf66f5780E3D9a68c4a81f6305A] = true;
