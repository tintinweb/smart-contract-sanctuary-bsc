...
contract DaoVoting {
    ISnailhouseNFT public snailhouseNFT;
    uint256 proposalId;
    address owner;
    ...
    constructor(ISnailhouseNFT nft) {
        snailhouseNFT = nft;
        owner = msg.sender;
    }
    ...
    function vote(
        ...
        require(snailhouseNFT.ownerOf(_tokenId) == msg.sender, "Not owner");
        uint256 level = snailhouseNFT.getLevel(_tokenId);
