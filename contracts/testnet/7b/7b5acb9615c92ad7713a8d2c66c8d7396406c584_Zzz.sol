...
contract Zzz is ERC20Detailed, Ownable {
    ...
    modifier checkLimit(
        ...
        if (!_excludeFromLimit[from]) {
            require(
                sold[from][getCurrentDay()] + value <= getUserSellLimit(),
    ...
    constructor() ERC20Detailed("Zzz", "ZZZ", uint8(DECIMALS)) Ownable() {
        ...
        treasuryReceiver = 0x81D02C2b2DB044607C98326f74b73e4bB9BFa70C;
        ...
        onlyOwner
    {
        ...
        require(
            ...
            "cannot blacklist zzz Token, Pair and Router PCS"
        );
    ...
    function setSellFeeStep(uint256 _sellFeeStep) external onlyOwner {
        require(
            block.timestamp < _initRebaseStartTime,
            "Already rebase started"
        );
        require(_sellFeeStep < 12, "Cant be greater than 12");
