...
*/
  // function getTokenPrice(address tokenA, uint256 amount)
  //   public
  //   view
  //   returns (uint256)
  // {
  ...
  // //   //uniswapV2Router
  // //   uint256[] calldata calc = uniswapV2Router.getAmountsOut(1,[tokenA, tokenB]);
  // // //  IERC20 token1 = IERC20(pair.token1());
  // //  // (uint256 Res0, uint256 Res1, ) = pair.getReserves();

  // //   // decimals
  // //   //uint256 res0 = Res0 * (10**pair.decimals());
  // //   return calc; // return amount of token0 needed to buy token1
  // return 1;
  //  }
