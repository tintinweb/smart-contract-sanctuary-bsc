...
//   _________                          _____         .__   .__       __________                  __                         .__    
//  /   _____/  ____    ____ __  _  ___/ ____\_____   |  |  |  |      \______   \_______   ____ _/  |_  ____    ____   ____  |  |   
//  \_____  \  /    \  /  _ \\ \/ \/ /\   __\ \__  \  |  |  |  |       |     ___/\_  __ \ /  _ \\   __\/  _ \ _/ ___\ /  _ \ |  |   
//  /        \|   |  \(  <_> )\     /  |  |    / __ \_|  |__|  |__     |    |     |  | \/(  <_> )|  | (  <_> )\  \___(  <_> )|  |__ 
// /_______  /|___|  / \____/  \/\_/   |__|   (____  /|____/|____/     |____|     |__|    \____/ |__|  \____/  \___  >\____/ |____/ 
//         \/      \/                              \/                                                              \/               
...
contract SnowFallProtocol is Context, IBEP20, Ownable {
    ...
    uint256 public _taxFee = 20; // 1% will be distributed among holder as token divideneds
    ...
    function setTaxFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 marketFee, uint256 burnFee) external onlyOwner {
        _taxFee = taxFee;
    ...
    function totalFeePerTx(uint256 tAmount) internal view returns(uint256) {
        uint256 percentage = tAmount.mul(_taxFee.add(_liquidityFee).add(_marketFee).add(_burnFee)).div(1e3);
        return percentage;
    }
