...
contract Safoo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Safoo";
    ...
    uint256 public totalSwapableFee = _liquidityFee + _devFee + _marketingFee + _reserveFee;
    ...
    uint256 public totalSwapableSaleFee = _saleTaxFee + _saleLiquidityFee + _saleDevFee + _saleMarketingFee +_saleReserveFee;
    ...
    {   
        ...
        uint256 walletsTotal = devTokensCollected + marketingTokensCollected + reserveTokensCollected;
