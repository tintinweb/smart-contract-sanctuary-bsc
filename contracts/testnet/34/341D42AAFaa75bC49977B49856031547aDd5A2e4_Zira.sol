...
contract Zira is IERC20 {
    ...
    string constant private _name = "Zira";
    string constant private _symbol = "Zira";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        staking: payable(0x428FFb9fC17C8e4bC41f05E9E5ef78f5C0F9F331)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 reflection, uint16 liquidity, uint16 marketing, uint16 development, uint16 staking, uint16 burn) external onlyOwner {
