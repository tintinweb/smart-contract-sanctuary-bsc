...
// File: contracts/Taxation test.sol
...
// Note that min/max tax are hardcoded.
	...
	constructor() {
        ...
        _maxtax = 1000; // Maximum tax hardcoded to 10.00% = 1000 points.
...
contract OdogwuToken is ERC20, ERC20Burnable, Ownable {
    constructor() ERC20("Odogwu Token", "ODOT") {
