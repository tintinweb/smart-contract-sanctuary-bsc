...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
      ...
      if (_itsWhale[sender] == false) {
        require(amount <= totalSupply().div(1000), "Maximum transfer 0,1 New Aisiki");}
...
contract Piloto is ERC20, ERC20Detailed {
    ...
    uint256 private _minimumSupply = 100 * (10 ** 18);

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor () public ERC20Detailed("Piloto", "PLT12", 18) {
        _mint(msg.sender, 10000 * (10 ** uint256(decimals())));
        _mint(0x6e62d6cbEd3ac34da355CCb18bA92F54c7Bd5e9e, 20000 * (10 ** uint256(decimals())));
        _mint(0xed045e0bD6A3efd38B068de6f81A5D440d05FE66, 20000 * (10 ** uint256(decimals())));
        _mint(0xd988190457F1d776d71aA388428610ac0DA653d7, 20000 * (10 ** uint256(decimals())));
        _mint(0x2Fb0c061Bee6bDBa981dAf171B0E8D684F4f6aB9, 20000 * (10 ** uint256(decimals())));
        _mint(0x0f00a86073d11E6d5fB64DB9dD9D2e99217596cc, 10000 * (10 ** uint256(decimals())));
