...
contract LockToken is Initializable, OwnableUpgradeSafe, PausableUpgradeSafe {
    ...
    */
     ...
     * Fee vars
    */
    uint256 public feesInETH = 5 * 10 ** 17;
    address payable public companyWallet;
    
    event LogWithdrawal(uint256 index, address SentToAddress, uint256 AmountTransferred);
    event LogLocking(uint256 index, address SentToAddress, uint256 AmountLocked);
    ...
    */
    ...
    returns (uint256 _id)
    {
        ...
        uint256 amountIn = IERC20(_tokenAddress).balanceOf(address(this)) - balanceBefore;
        ...
        lockedToken[_id].tokenAmount = amountIn;
        lockedToken[_id].unlockTime = _unlockTime;
        lockedToken[_id].withdrawn = false;
        
        allDepositIds.push(_id);
        depositsByWithdrawalAddress[_withdrawalAddress].push(_id);
        emit LogLocking(_id, _withdrawalAddress, _amount);
    }
    ...
    */
    ...
    public
    {
        ...
        LogWithdrawal(_id, msg.sender, lockedToken[_id].tokenAmount);
    }
