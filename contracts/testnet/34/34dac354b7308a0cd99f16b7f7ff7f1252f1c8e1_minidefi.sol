...
contract DividendDistributor is IDividendDistributor {
    ...
    // IBEP20 RewardToken = IBEP20(0x0778668760aC2D1a6bC0a35aD5Be96fb6CB525BA); //defi
...
contract minidefi is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "minidefi";
    string constant _symbol = "minidefi";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    // address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    // address RewardToken = 0x0778668760aC2D1a6bC0a35aD5Be96fb6CB525BA;
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    address RewardToken = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x620Cf0dE241b749736abB0cE4D747093554F0a96;
