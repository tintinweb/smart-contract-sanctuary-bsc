...
// File: contracts/libs/IDEXRouter.sol
...
// File: contracts/libs/IDEXFactory.sol
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 EP = IBEP20(0xC5e2B037D30a390e62180970B3aa4E91868764cD); // HEC
...
address dynamicLiquidityBox = 0xDdA59146430904B305a16e0314538f3327fe4d3a;
 ...
 function processA(uint256 gas) external onlyToken {
...
contract Bloom is IERC20Metadata, Auth, Pausable {
    ...
    constructor () Auth(msg.sender) {
        ...
        _transferFrom(msg.sender,address(this),100000000000000);
        //_addLiquidity();
    ...
    function setSwapBackSettings(uint256 _amount,bool _swapEnabled) external authorized {
    ...
    function addLiquidity() payable external onlyOwner {
        uint256 amountToLiquify = 100000000000000;
          router.addLiquidityETH{value: msg.value}(
            address(this),
            amountToLiquify, 0, 0, autoLiquidityReceiver, block.timestamp);
            emit AutoLiquify(msg.value, amountToLiquify);
    }
