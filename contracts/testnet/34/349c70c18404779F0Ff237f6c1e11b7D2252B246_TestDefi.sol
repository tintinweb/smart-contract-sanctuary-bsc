...
contract TestDefi is Context, IERC20, Ownable {
    ...
    string private _name = "Test Defi";
    string private _symbol = "$T357";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 5; //5% Distributed to holders
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 public _liquidityFee = 5; //5% Added to liquidity
    uint256 private _previousLiquidityFee = _liquidityFee;
    
    uint256 public _charityFee = 0; //0% Donated to Charity
    uint256 private _previousCharityFee = _charityFee;
    
    uint256 public _marketingAndDevBudget = 2; //2% Added to Marketing
    ...
    uint256 public _maxTxAmount = 20 * 10**13 * 10**9;
