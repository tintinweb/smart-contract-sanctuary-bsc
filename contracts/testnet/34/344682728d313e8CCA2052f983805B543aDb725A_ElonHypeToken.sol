...
contract ElonHypeToken is Context, IERC20, Ownable {
    ...
    uint256 private _buyDevelopmentFee = 4;
    ...
    uint256 public _DevelopmentFee = _buyDevelopmentFee;
    ...
    constructor() {
        ...
        _maxTxAmount = 150000000 * 10**_decimals; // 1.5%
        _maxWalletBalance = 300000000 * 10**_decimals; // 3% 
        _marketingWalletAddress = 0xBF361D089dA3dAE872Bdc428DB2Bc33965686589;
        _DevelopmentWalletAddress = 0x5222B556261cDb609e2055365dB8D67E8ad2aC4a;
    ...
    function setSellFeePercent(
        ...
        _sellDevelopmentFee = cFee;
        uint256 totalSellFee = _sellTaxFee.add(_sellLiquidityFee).add(_sellMarketingFee).add(_sellDevelopmentFee);
    ...
    function setBuyFeePercent(
        ...
        _buyDevelopmentFee = cFee;
        uint256 totalBuyFee = _buyTaxFee.add(_buyLiquidityFee).add(_buyMarketingFee).add(_buyDevelopmentFee);
    ...
    function setDevelopmentWalletAddress(address _addr) external onlyOwner {
        _DevelopmentWalletAddress = _addr;
    }
    ...
    function setNumTokensSellToAddToLiquidity(uint256 amount)
        ...
        onlyOwner
    {
        require(amount >= 10000000000000, "Swap amount cannot be lower than 0.0001% total supply.");
