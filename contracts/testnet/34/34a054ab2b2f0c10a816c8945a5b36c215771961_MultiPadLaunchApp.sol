...
contract MultiPadLaunchApp is IBEP20{
    ...
    */
    ...
    function claimPurchasedTokens(uint256 _lockNumber) external validateClaim(msg.sender,_lockNumber) returns (bool){
        ...
        if(_lockNumber == 6)
        calculation  = (_finalSoldAmount[msg.sender]).mul(5).div(100);
        else
        calculation  = (_finalSoldAmount[msg.sender]).mul(20).div(100);
    ...
    modifier validateClaim(address _userAddress, uint256 _lockNumber)
    {
        ...
        if(_lockNumber == 2){    // 15 Days
            require(block.timestamp > saleEndTime + _claimTime1 +  1296000  && reEntrance[_userAddress][_lockNumber] != true , "Insufficient Unlocked Tokens");
        }
        if(_lockNumber == 3){    // 1 month
            require(block.timestamp > saleEndTime + _claimTime1 +  3888000  && reEntrance[_userAddress][_lockNumber] != true , "Insufficient Unlocked Tokens");
        }
        if(_lockNumber == 4){    // 2 month
            require(block.timestamp > saleEndTime + _claimTime1 +  6480000  && reEntrance[_userAddress][_lockNumber] != true , "Insufficient Unlocked Tokens");
        }
        if(_lockNumber == 5){    // 3 month
            require(block.timestamp > saleEndTime + _claimTime1 +  9072000  && reEntrance[_userAddress][_lockNumber] != true , "Insufficient Unlocked Tokens");
        }
        if(_lockNumber == 6){    // 4 month
            require(block.timestamp > saleEndTime + _claimTime1 +  11664000  && reEntrance[_userAddress][_lockNumber] != true , "Insufficient Unlocked Tokens");
        }
        _;
    }
    ...
    function getUserTokensByAdd(address _userAddress) external view returns(uint256 _div1, uint256 _div2, uint256 _div3, uint256 _div4, uint256 _div5, uint256 _div6){
        ...
        _div2 = _finalSoldAmount[_userAddress].mul(20).div(100);
        _div3 = _finalSoldAmount[_userAddress].mul(20).div(100);
        _div4 = _finalSoldAmount[_userAddress].mul(20).div(100);
        _div5 = _finalSoldAmount[_userAddress].mul(20).div(100);
        _div6 = _finalSoldAmount[_userAddress].mul(5).div(100);
    ...
    function getClaimDates() view external returns(uint256 _d1, uint256 _d2, uint256 _d3, uint256 _d4, uint256 _d5, uint256 _d6){
        ...
        _d2 = saleEndTime + _claimTime1 +  1296000;
        _d3 = saleEndTime + _claimTime1 +  3888000;
        _d4 = saleEndTime + _claimTime1 +  6480000;
        _d5 = saleEndTime + _claimTime1 +  9072000;
        _d6 = saleEndTime + _claimTime1 +  11664000;
