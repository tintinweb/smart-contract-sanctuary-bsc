...
contract FEToken is Context, IERC20,Ownable {
    ...
    address public FEAddress = address(0xDe1d22E3195A15E4CA1595142E695fDE0322183D);
    ...
    function setFEPair(address FEPair) public onlyOwner {
        FEuniswapV2Pair = FEPair;
    }
    function setHBTPair(address HBTPair) public onlyOwner {
        HBTuniswapV2Pair = HBTPair;
    }
    function setUSDTPair(address USDTPair) public onlyOwner {
        USDTuniswapV2Pair = USDTPair;
    }
        ...
        if(sender == FEuniswapV2Pair || sender == HBTuniswapV2Pair || sender == USDTuniswapV2Pair){
         ...
         if(recipient == USDTuniswapV2Pair){
          ...
          if(addressPair != address(0)){
              isAdd = _isLiquidity(addressPair);
          }
    ...
    function _isLiquidity(address uniswapV2Pair)internal view returns(bool){
    ...
    function _fenhong() internal {
        ...
        require(fenhongAmount > 0, "fenhongAmount must be more than 0");
