...
contract StakePoolBNBForBNB is States, ReentrancyGuard, Ownable {
    ...
    function initialize( uint256 _lockPeriod, uint _unlockDate) public onlyOwner {
...
contract FactoryStakingPool is Ownable{
    ...
    function createBNBForBNB(address ownerAddress ,uint256 _lockPeriod, uint _unlockDate) public onlyOwner returns (address)
    {
        StakePoolBNBForBNB toDeploy = new StakePoolBNBForBNB();
        toDeploy.initialize( _lockPeriod,  _unlockDate);
