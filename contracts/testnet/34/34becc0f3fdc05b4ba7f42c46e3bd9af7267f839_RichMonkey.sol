...
contract RichMonkey is Context, Ownable{
    ...
    constructor() public {
        ...
        Vault_addr = 0x4758eCeEB81d14b7A98Be7c6ea7F315b16a5B065;
    ...
    function bindNFT(uint256 usdt_amount,uint256 rmt_amount,uint256 minusdt_amount,uint256 minrmt_amount,uint256 _nftId,address _nft_contract) public{
    ...
    function addLPLiquidity(uint256 usdt_amount,uint256 rmt_amount,uint256 minusdt_amount,uint256 minrmt_amount) public{
    ...
    function swap(uint256 _amount,uint256 min_amount,bool _Is) public{
        ...
        if(_Is){
            ...
            if(usdt>0&&rmt>0){
                ...
                else usdt_fee = usdt / rmt * _amount;
            }
    ...
    function receiveProfit() public {
        ...
        if(_amount>0){
            ...
            re_amount = re_amount *  (_amountA *  token_price) /  (usdt_price * _amountB);
