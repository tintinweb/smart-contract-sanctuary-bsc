...
contract MetaEdgeTech is Context, IBEP20, Ownable {
    ...
    function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256, uint256) {
        (uint256 tFee, uint256 tBurn, uint256 tCharity) = _getTBasics(tAmount, _TAX_FEE, _REWARD_FEE, _MARKETING_FEE);
    ...
    function removeAllFee() private {
        if(_TAX_FEE == 0 && _REWARD_FEE == 0 && _MARKETING_FEE == 0) return;
