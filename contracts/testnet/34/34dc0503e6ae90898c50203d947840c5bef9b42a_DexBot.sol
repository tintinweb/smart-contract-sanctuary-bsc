    ...
    function withdrawStakeRewards(uint8 _pid, bool _unStake) public {
        ...
        if(!pool.isMine) {
            ...
            if(multiplier > 0) {
                ...
                userPending = ((userstake.stakeReward * referalEarnings[0]) /100) + userstake.gainReward;
            ...
            if(multiplier > 0) {
                ...
                userPending = ((userstake.mineReward * referalEarnings[0]) / 100) + userstake.gainReward;
    ...
    function getrewardAmount(uint8 _pid) public view returns (uint256) {
        ...
        if(!pool.isMine) {
            ...
            if(multiplier > 0) {
                ...
                userPending = ((reward * referalEarnings[0]) /100) + userstake.gainReward;
            }
