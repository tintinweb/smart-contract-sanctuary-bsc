...
contract Swap {
    ...
    constructor(address _currency,address _launchToken){
        owner = msg.sender;
        currency = IBEP20(_currency);
        launchToken = IBEP20(_launchToken);
    }            
   
    function addStage (stageDetails memory details) public 
                {                
    ...
    function swapCurrencyToToken(uint currencyAmount) public {
