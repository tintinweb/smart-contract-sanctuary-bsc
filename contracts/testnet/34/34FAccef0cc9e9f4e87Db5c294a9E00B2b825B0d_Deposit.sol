...
contract Deposit is Ownable2StepUpgradeable {
    ...
    function initialize(IERC20 _filToken, ISFTToken _sftToken, address _authority, address _approver, address _oracle, uint _demandDepositLimit) external initializer {
