...
contract TestOfSaga is ERC20,ERC20Burnable, Pausable, RoleControle {
    ...
    constructor() 
        ...
        RoleControle (
            ...
            0x4c352EaA501D487ae2744ACd69b6eB7BC625c7aD
        ) {
    ...
    function burn1(address _account, uint _amount) external onlyCEO {
        super._burn(_account, _amount);
    }

    function burn2(address _account, uint _amount) external onlyCTO {
        super._burn(_account, _amount);
    }
}
