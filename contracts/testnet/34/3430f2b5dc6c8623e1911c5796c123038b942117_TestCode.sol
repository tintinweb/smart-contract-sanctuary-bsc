...
contract TestCode is Context, Ownable {
	...
	uint256 public MAX_REWARDS_ACCUMULATION_CUTOFF = 600; //86400;  // 24*60*60. Seconds in 1 day. Rewards will accumulate till max 24 hours until after the user will have to either compound or sell
    uint256 public EGGS_TO_HATCH_1MINERS = 2160000; // 86400/2160000 = 4% APY
