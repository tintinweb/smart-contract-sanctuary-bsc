    ...
    Ownable
{
        ...
        onlyOwner
    {
        require(
            ...
            "Test1Kb: The router already has that address"
        );
...
contract Test1Kb is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    Test1KbDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Test1Kb", "Test1Kb", 9) {
        dividendTracker = new Test1KbDividendTracker();
        ...
        onlyOwner
    {
        require(
            ...
            "Test1Kb: setWhiteListAMM:: AMM is a wallet, not a contract"
        );
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "Test1Kb: The dividend tracker already has that address"
        );

        Test1KbDividendTracker newDividendTracker = Test1KbDividendTracker(
                payable(newAddress)
            );

        require(
            newDividendTracker.owner() == address(this),
            "Test1Kb: The new dividend tracker must be owned by the Test1Kb token contract"
        );
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "Test1Kb: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "Test1Kb: The liquidity wallet is already this address"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "Test1Kb: The operations wallet is already this address"
        );
    ...
    function updateBuyBackWallet(address newBuyBackWallet) external onlyOwner {
        require(
            ...
            "Test1Kb: The buyback wallet is already this address"
        );
    ...
    function updateFees(
        ...
        require(
            ...
            "Test1Kb: updateFees:: Liquidity Perc must be equal to or higher than operations and buyback combined."
        );
        emit FeesUpdated(
            bnbRewardPerc,
            liquidityPerc,
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "Test1Kb: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "Test1Kb: Cannot update gasForProcessing to same value"
        );
    ...
    function setRewardToken(address rewardTokenAddress) public returns (bool) {
        require(
            ...
            "Test1Kb: setRewardToken:: Address is a wallet, not a contract."
        );
        require(
            rewardTokenAddress != address(this),
            "Test1Kb: setRewardToken:: Cannot set reward token as this token due to Router limitations."
        );
        require(
            !isIgnoredToken(rewardTokenAddress),
            "Test1Kb: setRewardToken:: Reward Token is ignored from being used as rewards."
        );
    ...
    function setRewardTokenWithCustomAMM(
        ...
        require(
            ammContractAddress != address(uniswapV2Router),
            "Test1Kb: setRewardToken:: Use setRewardToken to use default Router"
        );
        require(
            rewardTokenAddress != address(this),
            "Test1Kb: setRewardToken:: Cannot set reward token as this token due to Router limitations."
        ...
        require(
            ...
            "Test1Kb: setRewardToken:: AMM is not whitelisted!"
        );
        dividendTracker.setRewardToken(
            msg.sender,
            rewardTokenAddress,
    ...
    function buyBackTokensWithNoFees() external payable returns (bool) {
        ...
        require(
            ...
            "Test1Kb: buyBackTokensWithNoFees:: Cannot Spend more than earned."
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Test1Kb: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function _transfer(
        ...
        require(
            ...
            "Test1Kb: To/from address is ignored"
        );
    ...
    function swapAndLiquify(uint256 tokens) private {
        if (liquidityFee > 0) {
            ...
            if (operationsFee > 0) {
                ...
                require(
                    success,
                    "Test1Kb: SwapAndLiquify:: Unable to send BNB to Operations Wallet"
                );
            }
            ...
            if (buyBackFee > 0) {
                ...
                require(
                    success,
                    "Test1Kb: SwapAndLiquify:: Unable to send BNB to BuyBack Wallet"
                );
            }
...
contract Test1KbDividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "Test1Kb_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "Test1Kb_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Test1Kb contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "Test1Kb_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "Test1Kb_Dividend_Tracker: Cannot update claimWait to same value"
        );
