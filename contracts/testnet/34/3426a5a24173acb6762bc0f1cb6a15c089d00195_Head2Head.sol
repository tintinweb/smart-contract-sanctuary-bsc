...
contract Head2Head is Initializable, UUPSUpgradeable, AccessControlUpgradeable, PausableUpgradeable {
    /**
    ...
    event Head2HeadGameCreated(
        ...
        uint256 updateMulAfterAmountInWei,
    ...
    event Head2HeadRewardsDistributed(uint256 indexed gameId);
    event Head2HeadBatchGameIds(uint256[] createdGameIds);

    function initialize(address payable treasury, address bnbUsdOracle) public initializer {
    ...
    function createGameBatch(
        bytes12[2][] memory stockIds,
        string[2][] memory stockSymbols,
        ...
        emit Head2HeadBatchGameIds(temp_createdGameIds);
    }
    ...
    function createGame(
        ...
        require(_updateMulAfterAmountInWei != 0, "updateMulAfterAmountInWei cannot be 0");
        ...
        onlyRole(OPERATOR_ROLE)
    {
        ...
        emit Head2HeadRewardsDistributed(_gameId);
    }
