...
/** Tokenomics
 * Redistribution (RFI)     4% - auto distribute to all Voken holders
 * Fund                     5% - used to increase the total fund value
 * Liquidity                4% - auto add to the locked liquidity pool
 * R&D                      2% - used for marketing and research
 * AntiWhale measures:
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Voken-T1"; // Voken Testnet V1
    string internal constant SYMBOL = "VKN-T1";
    ...
    // --------------------- Fees Settings ------------------- //
    address internal rndAddress = 0x7BD9A52c185E3135f2b23542D117BA26b991Fa89;
    address internal fundAddress = 0x6daE480fA27A1314D8c1E5a291Ec18ec0e489735;
    ...
    function _addFees() private {
        ...
        _addFee(FeeType.External, 20, rndAddress);
    }
    ...
    function _getFeeStruct(uint256 index) private view returns (Fee storage) {
        require(index >= 0 && index < fees.length, "Fee index out of bounds");
        return fees[index];
    }
...
/**
 * The fee tokenomics start after the token auction. To achieve this, a "isInPresale" flag is used.
 * As soon as the auction ends, the contract manager can set this value to false. This will start
 * ->fee deduction<- as per the tokenomics mentioned above.
 */
    ...
    Tokenomics
{
    ...
    constructor() {
        ...
        _exclude(address(this)); // exclude contract from rewards
        _exclude(definitiveBurnAddress); // excluded, the more Vokens in the burn wallet, the more dividends
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    function _addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        (uint256 tokenAmountSent, uint256 ethAmountSent, uint256 liquidity) = _router
            ...
            owner(), //TODO: put: multiSigWallet instead of owner()
            block.timestamp
        );
...
contract VokenV1 is Voken {
    constructor() Voken(Env.Testnet) {
        //change to mainnet when deplotinh
