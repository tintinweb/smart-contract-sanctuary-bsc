...
contract HireKillers is Context, Ownable {
    ...
    uint256 devFeeNumerator = 50;
    uint256 devFeeDenominator = 1000;
    uint256 referralReturn = 12;
    bool private initialized = false;
    address public recAdd;
    ...
    function hireMoreKillers(address ref) public {
        ...
        claimedKillers[referrals[msg.sender]] = SafeMath.add(claimedKillers[referrals[msg.sender]],SafeMath.div(killersUsed,referralReturn));
    ...
    function getMyBalance(address adr) public view returns(uint256) {
        return ERC20(busd).balanceOf(adr);
    }
