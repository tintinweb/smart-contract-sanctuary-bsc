...
contract TestToken8 is ERC20, Ownable {
    ...
    constructor() ERC20("TestToken8", "TYT8") {
        ...
        taxWallet = address(0xdB0a24dC8a6eABfa8E412748567C4288EC97Ff8c); // set as tax wallet
        devWallet = address(0x9095035Be2E82b49cab8A6b36bb3982C51E8bC62); // set as dev wallet
