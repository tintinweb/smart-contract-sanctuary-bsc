...
contract AtpadNft is ERC721, ReentrancyGuard, Ownable, Pausable {
    ...
    function mint(uint256 _amount) external nonReentrant whenNotPaused {
        require(_amount >= price, "!price");

        require(supply < totalSupply, "!supply");
        ...
        emit Minted(msg.sender, tokenId.current(), _amount);
    }
    ...
    function resetDevWallet(address _devAddress) external onlyOwner {
