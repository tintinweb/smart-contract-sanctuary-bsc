...
contract PresaleFactoryTest is AccessControl, IStructs, IPresaleFactory {
    ...
    function setFeeParams(address receiver, uint256 perc) external onlyRole(DEFAULT_ADMIN_ROLE) {
        require(receiver != address(0) && perc < DENOMINATOR, "WRONG PARAMS");
        feeReceiver = receiver;
        feePercent = perc;
    }

    function changeBackendAddress(address back) external onlyRole(DEFAULT_ADMIN_ROLE) {
