 ...
 * 
 */
contract Godmeng is IERC20 {
    
    using SafeMath for uint256;
    
    //Godmeng, creator will take 0.6% fee
    address public feeTo = 0xbb30Ec995282f7d679178Bb3c0eB15799E9857Bc;

    string public name = "Godmeng";
    string public symbol = "Godmeng";
    uint256 public decimals = 18;
    uint256 private _totalSupply = 0;
    
    //Godmeng token supply max length
