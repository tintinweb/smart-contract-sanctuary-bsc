...
contract BingoStaking is Initializable, ReentrancyGuardUpgradeable {
    ...
    function initialize(IERC20 _stakeToken, address _accountFee, address _accountStake) public initializer {
        __ReentrancyGuard_init();
        //in order to use them in other functions
        stakeToken = _stakeToken;
        owner = msg.sender;
        accountFee = _accountFee;
    ...
    function setAccountFee(address _accountFee) public onlyOwner {
        accountFee = _accountFee;
    }
    ...
    function claimProfit(uint256 _profileId) public nonReentrant whenNotPaused {
        ...
        stakeToken.transferFrom(accountFee, msg.sender, remainProfit);
