...
contract tesupdate is Ownable, IBEP20 {
    ...
    string constant _name = "Golden Rabbit";
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xAC7C4043054e36296AE83d2745cf783Ca6C0Ae9e;
        marketingWallet = 0xAC7C4043054e36296AE83d2745cf783Ca6C0Ae9e;
    ...
    function setFees(uint256 newLiqFee, uint256 newMaintenanceFee) external onlyOwner {
        liquidityFee = newLiqFee;
        marketingFee = newMaintenanceFee;
    ...
    function updateAboutMe(string memory _telegram,string memory _website) external onlyOwner {
        telegram = _telegram;
        website = _website;
    }
