...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _transfer(
        ...
        /* Chi co marketplace moi duoc transfer gun
        require(msg.sender==addresss_marketplace, "Only marketplace can transfer gun");
        */

        //require(from==address(0), "Sorry, FGC event does not allow you to transfer gun, thank you.");
...
contract GUN_GunFishCrypto is ERC721{
    ...
    function reward_guns(address receiver, uint amount) public checkOwner{
        require(amount>=1, "Wrong gun amount.");
        uint[] memory arrayGunIds = new uint[](amount);
        for(uint count=1; count<=amount; count++){
            _tokenIds.increment();
