...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xC36c76daEB3e643D11eAFc55Ab905b10Ba6Ed976;
...
contract Biryani is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x1228ce8B04519C872d22d2c587aE7436D11BdD4b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Biryani";
    string private _symbol = "BYN";
