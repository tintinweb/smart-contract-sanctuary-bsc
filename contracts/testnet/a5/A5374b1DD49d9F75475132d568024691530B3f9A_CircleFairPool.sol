...
import "./interfaces/IFairPool.sol";
...
contract CircleFairPool is OwnableUpgradeable, IFairPool , ReentrancyGuard {
    ...
    event PoolStartAtChanged(uint256 timestamp, uint256 start_at);
    ...
    function initialize(
        ...
        require(presale.softCap > 0 , "Softcap must be >= 0");
...
//        useWhitelisting = presale.useWhitelisting;
    ...
    function getDecimal() public view returns(uint8){
        uint8 decimals = IERC20Info(token).decimals();
        return decimals;
    }
...
//        IPoolFactory(factory).addTopPool(address(this), totalRaised);
        emit Contributed(address(this), requiredFunds, msg.sender, totalRaised);
    }
    ...
    function claim() public nonReentrant {
        ...
        emit Claimed(address(this), totalClaimed, avalible, msg.sender);
    }
