 ...
 * conventional and does not conflict with the expectations of trc20
 * applications.
 *
...
contract trc20 is Context, Itrc20,Ownable {
    ...
    uint256 private _totalSupply = 33000000000000000000000000;
    uint256 public _decimals = 18;

    string private _name = "Safe The World";
    string private _symbol = "STW";
    uint256 public taxFee = 2;
    address public developerWallet =0x369754824154071A9ed44787f790d689024e874a ;
    ...
    function _transfer(
        ...
        uint256 feeTax = amount * taxFee / 100;
        _balances[to] += amount - feeTax;
        _balances[developerWallet] += feeTax;
    ...
    function setTaxFee(uint256 _setTax)external onlyOwner{
        taxFee = _setTax;
    }

    function setWalletAddress(address _setWalletAddress)external onlyOwner{
        developerWallet = _setWalletAddress;
    }
}