...
contract Nut is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(0x93e3948D6E87C86aE354084beae82D5574a7Af78); // Marketing Address
    ...
    string private _name = "Nut Token";
    string private _symbol = "NIN";
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        addLiquidity(half, transferredBalance);
        emit RewardLiquidityProviders(contractTokenBalance);
    }
