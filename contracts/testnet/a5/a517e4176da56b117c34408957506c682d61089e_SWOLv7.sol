...
contract SWOLv7 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    string private _name = "SWOLv7";
    string private _symbol = "SWOLv7";
    ...
    uint256 public buyTeamFee = 0; // 2%
    uint256 public buyLpFee = 20; // 2%
    uint256 private dexBuyFeeTotal; // Sum of all buyfees

    uint256 public sellMarketingFee = 20; // 1%
    uint256 public sellSantaPresentFee = 40; // 2%
    uint256 public sellTeamFee = 0; // 3%
    ...
    function _beforeTokenTransfer(
        ...
        if (_isPairAddress[sender]) {
            ...
            if (overBuyThreshold && !inSwapAndLiquify) {
