...
Lets All Get In On This Together - Show Them What Community Is About!

We can bring this market back to where it belongs!
...
contract Eatme is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Eat Me';
    string private constant _symbol = '$EATME';
    ...
    //DevWallets
    address public MarketingWallet=payable(0xfd61E860aD8c7ed701Ec152bA673Ac30547BF00B);
    address public Development=payable(0xfd61E860aD8c7ed701Ec152bA673Ac30547BF00B);
    //Testnet
