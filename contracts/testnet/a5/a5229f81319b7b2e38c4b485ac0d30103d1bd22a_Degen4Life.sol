...
contract Degen4Life is IBEP20, Ownable {
    ...
    address public MainReward=0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;   //change this address to desired reward token
    address public MiscReward=0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;   //Only MiscReward can be changed to BNB
