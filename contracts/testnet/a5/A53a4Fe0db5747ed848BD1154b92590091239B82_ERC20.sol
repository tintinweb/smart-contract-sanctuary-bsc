...
contract Stakes is Owner, ReentrancyGuard {
    ...
    // contract parameters
    ledgerParams public ledgerFor3DaysParams;
    ledgerParams public ledgerFor7DaysParams;
    ledgerParams public ledgerFor14DaysParams;
    ledgerParams public ledgerFor30DaysParams;

    mapping(address => Record[]) public ledgerFor3Days; //Type 1
    mapping(address => Record[]) public ledgerFor7Days; //Type 2
    mapping(address => Record[]) public ledgerFor14Days; //Type 3
    mapping(address => Record[]) public ledgerFor30Days; //Type 4
