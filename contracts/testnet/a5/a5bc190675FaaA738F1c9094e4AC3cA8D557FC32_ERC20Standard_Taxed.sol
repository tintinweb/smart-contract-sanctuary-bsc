...
contract ERC20Standard_Taxed is Context, IERC20, IERC20Metadata,Ownable {
    ...
    uint256 private _swapTokensAmount;
    ...
    uint8 buyTax_,uint8 sellTax_,address routerAddress_) 
    {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
        ...
        _swapTokensAmount = totalSupply_ * 5 / 1000;  //0.05% of the total supply
        ...
        _balances[owner()] += totalSupply_ * (10**_decimals);
        emit Transfer(address(0),owner(), totalSupply_ * (10**_decimals));
    }
    ...
    function _swapAndLiquify() private lockTheSwap{
        ...
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(_swapTokensAmount, 0, path, treasuryWallet, block.timestamp);
