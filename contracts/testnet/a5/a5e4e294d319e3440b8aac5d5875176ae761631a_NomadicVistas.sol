...
// Nomadic Vistas - bringing digital art to the public space, more info at www.NomadicVistas.online
...
contract NomadicVistas is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x6b406012B188C16aBB877B3728d07Bc7B5F52EFA); 
    address payable public Wallet_Dev = payable(0x63671ed448338D1871e662d8B9e34B4f0fBE985D);
    ...
    uint256 private _tTotal = 10**8 * 10**_decimals; //100m
    string private constant _name = "Nomadic Vistas"; 
    string private constant _symbol = unicode"NOMAD"; 
    ...
    constructor () {
        ...
        _owner = 0x91CAC128C0cfC76A2992cc0373e60b3841DE736F;
