...
contract DividendDistributor {
    ...
    IERC20 ftm = IERC20(0xA532cfaA916c465A094DAF29fEa07a13e41E5B36); // Binance wrapped BNB
...
contract SPHYNXCAT is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "Sphynx Cat";
    string constant _symbol = "SPHYNXCAT";
    ...
    uint256 public _devFeesell = 400;
    ...
    address payable private _marketingWallet = payable(0x2225D3633B356762AaFfe520270253fd5f9435ed);
    ...
    uint256 private maxTxPercent = 500;
    ...
    uint256 private maxWalletPercent = 500;
    ...
    uint256 private immutable snipeBlockAmt = 80;
