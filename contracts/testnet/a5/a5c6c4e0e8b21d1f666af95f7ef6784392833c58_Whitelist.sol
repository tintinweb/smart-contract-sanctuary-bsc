...
contract Whitelist {
    ...
    function isWhitelisted(address _address) public view returns (bool) {
        require (whitelisted[_address] == true, "error.notWhitelisted");
        return true;
    }
    ...
    function addAdministrator(address _address) public {
        require (msg.sender == getOwner(), "error.notOwner");

        admins[_address] = true;
    }

    function removeAdministrator(address _address) public {
        require (msg.sender == getOwner(), "error.notOwner");
