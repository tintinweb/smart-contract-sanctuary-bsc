// SPDX-License-Identifier: multiverseexpert.com
    ...
    AccessControl
{
    ...
    function safeMint(
        ...
        require(clans[index].open == true, "Clan: clans isn't open");
    ...
    function buy(uint256 clan) public {
        ...
        uint256 _index = random("EPIC").mod(clans[clan].tokenId.length);
        ...
        delete clans[clan].tokenId[_index];
    }

    function random(string memory text) private view returns (uint256) {
