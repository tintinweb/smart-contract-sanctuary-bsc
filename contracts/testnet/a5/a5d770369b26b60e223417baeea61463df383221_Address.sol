...
/*
    Website: https://www.muqcoin.com
    Contract Name: Muqcoin $MUQ
    Contract Version: 1.2
    Contract Supply: 313,000,000
    Contract Tokenomics:
...
contract Muqcoin is Context, IERC20, Ownable
{
    ...
    uint256 private _tTotal = 313_000_000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Muqcoin";
    string private _symbol = "MUQ";
    ...
    uint256 public _MUQFee = 2;
    uint256 private _previousMUQFee = _MUQFee;
    
    uint256 public totalBuyFee = _taxFee.add(_liquidityFee).add(_marketingFee).add(_MUQFee); //5% Total Buy Fee
    
    
    

    address payable public marketingWallet =  payable(0x96e59516fDd189E552339bEB24687c18b1c0183a);
    address payable public MUQWallet =  payable(0xad236B83C10850FCAE1de4b7f472b4e12DB710B9);
    ...
    constructor () 
    {
        ...
        _isExcludedFromWhale[MUQWallet]=true;
    ...
    {  
        return _amount.mul(_liquidityFee.add(_marketingFee).add(_MUQFee)).div(100);
    }
    ...
    {
        uint256 allFee = _liquidityFee.add(_marketingFee).add(_MUQFee);
        ...
        MUQWallet.transfer(newBalance.div(allFee).mul(_MUQFee));
    }
    ...
    function setMUQWallet(address newWallet) external onlyOwner() 
    {
        MUQWallet = payable(newWallet);
    }
