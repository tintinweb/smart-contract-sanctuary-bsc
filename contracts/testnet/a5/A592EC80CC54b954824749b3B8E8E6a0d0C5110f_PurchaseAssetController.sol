    ...
    UUPSUpgradeable
{
    ...
    event SoFarSoGood(uint256 _ix, address _account, uint256[] _randomNumbers);
    ...
    function fulfillRandomness(
        ...
        emit SoFarSoGood(0, _msgSender(), _randomNumbers);
        return;
    ...
    function _finishPurchaseGuineaPig(
        ...
        emit SoFarSoGood(_ix, _account, _randomNumbers);
        return;
        (
            uint256 _guineaPigId,
