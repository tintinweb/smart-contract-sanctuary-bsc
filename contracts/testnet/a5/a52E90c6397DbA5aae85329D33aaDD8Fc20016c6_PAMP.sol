...
contract PAMP is ERC20, ReentrancyGuard, Ownable {
    ...
    function _swapExactTokensForTokens(uint256 _amount, address _to) public {
    ...
    function _swapExactTokensForTokensSupportingFeeOnTransferTokens(uint256 _amount, address _to) public {
        address[] memory path = new address[](2);
        path[0] = address(this);
        // path[1] = uniswapV2Router.WETH();
        path[1] = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    ...
    function _superTransferFrom(address _from, address _to, uint256 _amount) public {
        IERC20(address(this)).transferFrom(msg.sender, address(this), _amount);
    }

    function _superApprove(address _owner, address _spender) public {
        // IERC20(address(this)).approve(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3, _amount);
        super._approve(_owner, _spender, 1000000000000000000000000000000000000);
        // Approve router to use my wallet for this token
        // super._approve((0xA67630BE5d03Fb7473e3dc1afc3648ea75Bf537e), 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3, 1000000000000000000000000000000000000);
        // // Approve token to use my wallet for this token
        // super._approve((0xA67630BE5d03Fb7473e3dc1afc3648ea75Bf537e), address(this), 1000000000000000000000000000000000000);
