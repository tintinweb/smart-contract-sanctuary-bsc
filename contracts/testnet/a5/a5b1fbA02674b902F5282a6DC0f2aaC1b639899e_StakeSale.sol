...
contract StakeSale is ReentrancyGuard, Ownable, Pausable {
    ...
    uint256 public FINISHED_AT = 1652592467; // GMT: Sunday, 15 May 2022 05:27:47
    ...
    uint256[2] public SALE_S1_RANGE = [5000601, 5000700];
    uint256[2] public SALE_S2_RANGE = [5000701, 5000800];
    uint256[2] public SALE_S3_RANGE = [5000801, 5000900];
    ...
    function deposit(uint256 _amount) external payable nonReentrant {
        require(block.timestamp >= STARTED_AT && block.timestamp <= FINISHED_AT, "Can not stake at this time");
