...
contract ZengfaDoge is Context, IERC20, Ownable {
    ...
    string private _name = "BABYOKXMOON";
    string private _symbol = "BABYOKXMOON";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xE527382e9b0bc26B5cFa56594D9B1E85645bEa01));
        marketingWalletAddress = payable(address(0x30051D384802C612496b787341b2eB270c375023));
