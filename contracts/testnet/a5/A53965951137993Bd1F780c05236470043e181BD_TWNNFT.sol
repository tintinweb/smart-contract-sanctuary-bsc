...
contract TWNNFT is ERC721, Ownable,VRFv2Consumer {
    struct ShareRecord{
        uint256 now;
    ...
    address public jobaddress = 0x909cA82EeAE739C80058F368397AD8706511C045;
    address public bscusdaddress = 0x909cA82EeAE739C80058F368397AD8706511C045;
    address public Msg_contract = 0xBf81029c25A32Fb27Ba6136F1Fccf6B334D509E6;
    address public Msp_contract = 0xBf81029c25A32Fb27Ba6136F1Fccf6B334D509E6;
    ...
    constructor() VRFConsumerBaseV2(vrfCoordinator) ERC721("TweetFi NFT", "TWN")
    {
    ...
    function CreateNft(uint256 _tokenId) internal {
        ...
        address tokenid_owner = ERC721.ownerOf(_tokenId);
        require(tokenid_owner == msg.sender || msg.sender == owner() ,"is not owner");
        ...
        _nftTokens[tokenid_owner].add(_tokenId);
        _boxTokens[tokenid_owner].remove(_tokenId);
        emit Transfer(msg.sender,tokenid_owner, _tokenId);
    }
