...
contract SpacePadFriends is Pausable, Ownable, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        require(currentRound.active, "No active round at the moment");
        ...
        if (
            ...
            if (currentRound.currentCap == currentRound.roundMaxCap)
        ...
        uint256 roundUnitsLeft = getRoundUnitsLeft(currentRound);
    ...
    function setSpacePadTreasuryAddress(address _spacePadTreasuryAddress)
        external
        onlyOwner
    {
