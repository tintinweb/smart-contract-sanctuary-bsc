...
contract ABC is Context, IERC20, LockToken {
    ...
    uint256 private _saleTaxFee = 0;
    uint256 private _saleLiquidityFee = 7;
    uint256 private _saleMarketingFee = 2;
    uint256 private _saleBurnFee = 1;

    uint256 public _maxTxAmount = 10_000_000 * 10**9;
    uint256 private minimumTokensBeforeSwap = 100_000 * 10**9; 
