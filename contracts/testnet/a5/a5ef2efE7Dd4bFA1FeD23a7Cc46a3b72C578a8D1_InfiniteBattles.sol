...
contract InfiniteBattles is Ownable {
    ...
    function initiateBattle(uint256 blockId_, uint256 attackerId_, uint256 battleFee_) external {
        ...
        rewardToken.transferFrom(msg.sender, address(this), battleFee_);
        // get event into that
    ...
    function pendingRewards(address user_) view public returns(uint256) {
        ...
        return rewards + users[user_].pendingRewards;
    }

    function claimRewards() external {

        uint256 amountToClaim = pendingRewards(msg.sender);
        blsToken.transferFrom(address(this), msg.sender, amountToClaim);
        // get event into that
