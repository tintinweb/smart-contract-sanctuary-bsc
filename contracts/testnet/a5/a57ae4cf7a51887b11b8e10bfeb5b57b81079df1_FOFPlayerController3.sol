...
contract FOFPlayerController2 is Ownable {
    ...
    mapping(uint256 => uint256) public tokenIdToStatus;//0正常，1出售中，2报名比赛中
...
contract FOFPlayerController3 is Ownable {
    ...
    function sellMyNFT(uint256 tokenId, uint256 price) public {
        ...
        require(FPC2.tokenIdToStatus(tokenId) == 0,"This user dont hava a hero ");
    ...
    function cancelSellNFT(uint256 tokenId) public {
        ...
        require(FPC2.tokenIdToStatus(tokenId) == 1 && tokenIdToPrice[tokenId] > 0,"This user dont hava a hero ");
    ...
    //         NFTStatus[i] = FPC2.tokenIdToStatus(NFTIDs1[i]);
    //     }
