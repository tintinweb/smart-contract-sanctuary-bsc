...
// https://t.me/MetaflokishuToken

// TOKENOMICS: 14% Buy/Sell Transaction Fee 
// 12% REWARD - BUSD [1% MARKETING] 
// 1% Auto-Liquidity Tax Buy Back to LP 
// *must hold a minimum of 1,000,000,000 MetaFlo

// Total Supply: 1,000,000,000,000,000 $METAFLO
// LaunchPad: https://metaflo.app
// Presale IDO: https://presale.metaflo.app
...
contract MetaFloKishu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxBuyAmount = 5 * 10**13 * 10**9; // 5% of the supply
    uint256 public maxSellAmount = 5 * 10**13 * 10**9; // 5% of the supply
    ...
    address public _charityWallet = payable(address(0xb08C4C7a2D97Ded294709C62225f80425993974E)); // CharityWallet
    address public _marketingWallet = payable(address(0x83918E10ef2E30CcAE79E65B07C6Ae1cb70729C0)); // MarketingWallet
    ...
    constructor() ERC20("MetaFloKishu", "MetaFlo") {
        buyFee.rewardFee = 12;
        buyFee.devfee = 0;
        ...
        */
        _mint(owner(), 1 * 10**15 * (10**9)); // 1 Quadrillion Tokens ~ 1000 Trillion Tokens
    }
   ...
   function setSwapTokensAtAmount(uint256 amount) external onlyOwner {
    ...
    function swapAndSendToWallets(uint256 tokens) private lockTheSwap {
        ...
        IERC20(BUSD).transfer(_charityWallet, devShare);
}
...
contract TokenDividendTracker is Ownable, DividendPayingToken {
    ...
    {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 1000000000 * (10**9); //must hold 1,000,000,000+ tokens
    }
