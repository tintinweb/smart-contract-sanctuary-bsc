...
//    bytes4 private constant _INTERFACE_ERC1155_METADATA = 0x5b5e139f;
    ...
    */
    ...
    /**
        ...
        @notice If the corresponding {tokenAddress} for the parsed {resourceID} supports {_INTERFACE_ERC1155_METADATA},
    ...
    function deposit(bytes32    resourceID,
        ...
        assembly {
            ...
            amount := 1 // todo передать параметр через data
...
//            IERC1155Metadata erc1155 = IERC1155Metadata(tokenAddress);
//            metaData = bytes(erc1155.tokenURI(tokenID));
//        }

        if (_burnList[tokenAddress]) {
            burnERC1155(tokenAddress, depositer, tokenID, amount);
        } else {
            lockERC1155(tokenAddress, depositer, address(this), tokenID, amount, metaData);
        }
    ...
    function executeProposal(bytes32 resourceID, bytes calldata data) external override onlyBridge {
        ...
        assembly {
            ...
            amount := 1 //todo получить из  data
        ...
        if (_burnList[tokenAddress]) {
            mintERC1155(tokenAddress, address(recipientAddress), tokenID, amount, metaData);
        } else {
            releaseERC1155(tokenAddress, address(this), address(recipientAddress), tokenID, amount, metaData);
        }
    }
