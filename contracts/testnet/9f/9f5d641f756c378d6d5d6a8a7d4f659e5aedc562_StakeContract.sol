...
contract StakeContract is Ownable {
    ...
    uint256 public startBlock = 16926654 ; // set start block
    uint256 public minimum_deposit = 1; //minimum deposit
    uint256 public endBlock =   99999999999 ;  // set end block
    uint256 public rewardperblock = 1*10**18; // set block reward
    uint256 private unlockblockperiod = 1296000; 
    address public rewardaddress = 0xa744DEB80e5D2d6fA2c379A07af08b5B071e9209;  //reward
    address public stakeaddress = 0xa744DEB80e5D2d6fA2c379A07af08b5B071e9209;   //staked token
    uint256 public totalpoolstacked = 0;
    uint256 public lastRewardBlock = 16926654;  // set start block/*  */
    bool public poolended = false;
    ...
    function stake(uint256 _amount) public updatePool {
        require(endBlock > lastRewardBlock, "Staking pool ended - time");
        require(poolended == false, "Staking pool ended - poolended");
    ...
    function changeEndBlock(uint256 _end) public updatePool onlyOwner {
            require(block.number < _end, "Cannot set lower than current block");
            endBlock = _end;
        }

    function changeendblock(uint256 _end) public onlyOwner{
        endBlock = _end;
    }
