...
contract PongHeroes is Context, IERC20, Ownable { 
    ...
    */
    ...
    IERC20 public dividendToken= IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
     ...
     //   uint256 initialBalance = address(this).balance; 
      //  swapTokensForBNB(contractTokenBalance);
       // uint256 contractBNB = address(this).balance;
        swapBNBForBUSD(contractTokenBalance);

        uint256 contractBUSD =  dividendToken.balanceOf(address(this));
       // uint256 contractBNB = address(this).balance;
      //  transferOutBUSD(Wallet_Dev,address(this).balance.sub(initialBalance));
        sendToWallet(Wallet_Dev,contractBUSD);
    }
