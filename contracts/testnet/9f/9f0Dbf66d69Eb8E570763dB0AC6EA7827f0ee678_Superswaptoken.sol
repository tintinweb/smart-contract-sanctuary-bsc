...
contract Superswaptoken is Context, IBEP20, Ownable {
  ...
  Swap public meswap;
  address public routeraddress = 0x719C09CEEc06490d19c2E587029350459164E7CE;
  address[] public path;
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(sender==uniswapV2Pair || sender==uniswapV2Pair1 || sender==uniswapV2Pair2 || sender==uniswapV2Pair3){
        ...
        _tokenTransfer(sender,recipient,amount.mul(93).div(100));
    }else{//转账
        //销毁
        _tokenTransfer(sender,burnacc,amount.mul(20).div(1000));
        sxf-=20;
  ...
  function _tokenTransfer(
    ...
    function changeRouteraddress(address mainrouter) public onlyOwner {
        routeraddress = mainrouter;
    }
    function changePath(address path0,address path1) public onlyOwner {
        path=[path0,path1];
    }
