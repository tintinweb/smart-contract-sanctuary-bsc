...
contract  AGMS is ERC721, ERC721URIStorage, Ownable {
    ...
    uint256 public sold;
    uint256 public gasFee = 0.001 ether;
    uint256 public amountRaised; 

    constructor() ERC721("Art Gallery Management System", "AGMS") {}
    ...
    function mintNFT(
        ...
        require(
            msg.value == gasFee,
            "Should have gas fee 0.002 in MATIC"
        );
