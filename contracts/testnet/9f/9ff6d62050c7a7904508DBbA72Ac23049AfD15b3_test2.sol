...
contract test2{
    ...
    uint public X1_LEVEL_SUM = 25;
    uint public X2_LEVEL_SUM = 20;
    uint public X3_LEVEL_SUM = 40;
    uint public X4_LEVEL_SUM = 100;
    uint public X5_LEVEL_SUM = 200;
    uint public X6_LEVEL_SUM = 1000;
    uint public X7_LEVEL_SUM = 2000;
    ...
    uint public X1_LEVEL_POOL_SUM = 10;
    uint public X2_LEVEL_POOL_SUM = 20;
    uint public X3_LEVEL_POOL_SUM = 40;
    ...
    // address public depositToken = 0x8Edf0e8e01d45387c5cEbe0b9Fc46bb6B804f752;
 ...
 function register(address sponser_id) public payable {
 ...
 function upgradeAccount(uint8 plan ) public payable {
        require(msg.sender != address(0), "Invaild Wallet Address!");
        require(allUsers.length != 0, "First User not registered by admin!");
