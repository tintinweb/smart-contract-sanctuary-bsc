...
contract SpacePadFriends is Pausable, Ownable, ReentrancyGuard {
    ...
    uint256 public level4ReferrerFee = 100; // 100 = 1%
    //
        ...
        if (_referrer != address(0)) {
            ...
            if (level2Referrer != address(0)) {
                ...
                if (level3Referrer != address(0)) {
                    ...
                    // Level 4
                    address level4Referrer = depositers[level3Referrer];
                    if (level4Referrer != address(0)) {
                        uint256 level4Fee = depositOnReferrer(
                            level4Referrer,
                            level3Referrer,
                            _amount,
                            level4ReferrerFee,
    ...
    function depositOnReferrer(
        ...
        uint8 level = 1;
        if (_referralFee == level2ReferrerFee) level = 2;
        if (_referralFee == level3ReferrerFee) level = 3;
        if (_referralFee == level4ReferrerFee) level = 4;
