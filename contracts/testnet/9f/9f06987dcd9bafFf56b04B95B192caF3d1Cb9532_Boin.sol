...
contract Boin is Context, Ownable {
  ...
  constructor() public {
    ...
    function makeContract(uint256[] memory  _plan,uint256[] memory  _value,address []  memory  _contributors  ) public payable returns (bool) {
