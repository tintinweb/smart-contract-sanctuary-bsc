...
contract sol1 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xcBaC15E0eeAEC3A96D0a7032d883Aef6C02306dF));
    address payable public devWallet =
        payable(address(0x40ed85E760De8b015d13E52858527922ed3EFE4c));
    address public liquidityReceiver =
        0xE1075828ADcbC904A85Ba1e072aBc2e07507C211;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "SOLO1";
    string private _symbol = "SOL1";
