...
contract BTCFVesting is Context, Ownable, ReentrancyGuard {
    ...
    event VestingCreated(uint packageId, uint256 totalAmount, uint256 cliffAmount);
    event VestingOverridden(uint packageId, uint256 totalAmount, uint256 cliffAmount);
    ...
    */
    function createVestingSchedule(
        ...
        emit VestingCreated(_packageId, _totalAmount, _cliffAmount);
        } else {
            ...
            emit VestingOverridden(_packageId, _totalAmount, _cliffAmount);
        }           
