...
contract ChainedX is ERC20, Ownable {
    ...
    // TODO update staking and treasury addresses here
    address public stakingAddress = 0x537E16585Cbe79Ef99f163772d3f714B0Ae64dC1;
    address public treasuryWallet = 0x537E16585Cbe79Ef99f163772d3f714B0Ae64dC1;
    ...
    function _transfer(
        ...
        if (canSwap && !swapping && !automatedMarketMakerPairs[from]) {
            ...
            if (treasuryShare > 0) {
                uint256 treasuryTokens = (contractTokenBalance *
                    treasuryShare) / 100;
                swapAndSendToWallet(treasuryTokens, treasuryWallet);
            }

            if (stakingShare > 0) {
                uint256 stakingTokens = (contractTokenBalance * stakingShare) /
                    100;
