...
contract OArtsLabCuteGhosty is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner {
    ...
    payable(owner()).transfer(address(this).balance);  // rest = 49%
  }
  }
