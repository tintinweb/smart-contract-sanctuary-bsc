...
contract CHRONODAO is ERC20Detailed, Ownable {
    ...
    uint256 public sellFeel = 30;
    uint256 public sellFeet = 30;
   
    uint256 public sellFeef = 30;
    ...
    uint256 private constant MAX_SUPPLY = 500000 * 10**7 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("CHRONODAO", "CHRD", uint8(DECIMALS)) Ownable() {
        ...
        marketingReceiver = 0x639670bEc0d40fD8A32e2f591C956dEDeb880FA3; 
