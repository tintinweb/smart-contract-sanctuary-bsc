...
import "../interfaces/ISRPAccessControlList.sol";

contract MarketplaceStoreV1 is Initializable {
    ...
    ISRPAccessControlList public accessControl;
    ...
    function initialize(address _accessControl) public initializer {
        accessControl = ISRPAccessControlList(_accessControl);
    }

    function setGov(address _newGov) external onlyManager {
        accessControl = ISRPAccessControlList(_newGov);
    }
...
*/
interface ISRPAccessControlList {
