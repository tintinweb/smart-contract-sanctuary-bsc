...
contract Product is ERC721Tradable {
    ...
    constructor()
    ERC721Tradable("TestPrd", "TestPrd")
    {
 ...
 */
abstract contract ERC721Tradable is  ERC721Data,ContextMixin, NativeMetaTransaction, Ownable,AccessControl{
...
contract ProductLootBox is ERC721Tradable{
    ...
    constructor(address _factoryAddress)
        ERC721Tradable("Test Lootbox", "TestLB")
    {
