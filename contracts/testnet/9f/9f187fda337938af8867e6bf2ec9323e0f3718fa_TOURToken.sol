...
contract TOURToken is ERC20, SafeOwnable {
    ...
    uint256 public guardPoolFeePercent = (5* BASE_RATIO) / 100;
    ...
    address public subCoinAddress=0x32DC0F8EDB71c408129DF1E760e8Fc6F62718abd;
    ...
    constructor() ERC20("TOUR", "TOUR") {
        ...
        setRewardBlacklist(lpReceiver, true);
    ...
    function swapAndLiquify() private lockTheSwap {
        ...
        swapTokensForToken(contractTokenBalance, address(this), address(usdtToken), address(this));


        addLiquidity(usdtToken.balanceOf(address(this)), IERC20(subCoinAddress).balanceOf(address(this)));

        emit SwapAndLiquify(contractTokenBalance, usdtToken.balanceOf(address(this)), contractTokenBalance);
    }
    ...
    function setGuadPool(bool _enabled) public onlyOwner {
        guardPool = _enabled;
    }
