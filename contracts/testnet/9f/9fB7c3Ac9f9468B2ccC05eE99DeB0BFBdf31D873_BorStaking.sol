...
contract BorStaking {
    ...
    constructor(IERC20 _bor, IIridium _rewardsToken) {
        bor = _bor;
    ...
    function stake(uint256 amount) public {
        require(amount > 0 && bor.balanceOf(msg.sender) >= amount);
        ...
        bor.transferFrom(msg.sender, address(this), amount);
    ...
    function unstake(uint256 amount) public {
        require(isStaking[msg.sender] = true && stakingBalance[msg.sender] >= amount);
        uint256 rewards = getTotalRewards(msg.sender);
        startTime[msg.sender] = block.timestamp;
        stakingBalance[msg.sender] -= amount;
        bor.transfer(msg.sender, amount);
    ...
    function withdrawRewards() public {
        ...
        require(toWithdraw > 0 && userRewards[msg.sender] > 0);
        ...
        startTime[msg.sender] = block.timestamp;
        rewardsToken.mint(msg.sender, toWithdraw);
...
contract Iridium is IIridium, ERC20, Ownable {
    ...
    function mint(address to, uint256 amount) external override onlyFarmOrOwner{
        _mint(to, amount);
        _startSupply += amount;
    }
