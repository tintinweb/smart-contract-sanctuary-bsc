...
contract Clover_Seeds_Picker is Ownable {
    ...
    uint256 public totalCloverFieldCarbonCanMint = 330; // 33% for total Clover Field
    uint256 public totalCloverFieldPearlCanMint = 330; // 33% for total Clover Field
    uint256 public totalCloverFieldRubyCanMint = 330; // 33% for total Clover Field
    uint256 public totalCloverFieldDiamondCanMint = 10; // 1% for total Clover Field
    ...
    function getLuckyNumber() public view returns (uint256) {
        uint256 luckyNumber = randomNumber();
        return luckyNumber;
    }
    ...
    function randomLayer(uint256 tokenId) public returns (bool) {
        ...
        if (tokenId <= 1e3 && index == 0 && totalCloverFieldCarbonMinted == totalCloverFieldCarbonCanMint) {
            index = random2() % layersPearl.length;
        }

        if (tokenId <= 1e3 && index == 1 && totalCloverFieldPearlMinted == totalCloverFieldPearlCanMint) {
            index = random3() % layersRuby.length;
        }

        if (tokenId <= 1e3 && index == 2 && totalCloverFieldRubyMinted == totalCloverFieldRubyCanMint) {
            index = 3;
        }

        if (tokenId > 1e3 && tokenId <= 11e3 && index == 0 && totalCloverYardCarbonMinted == totalCloverYardCarbon) {
            index = random2() % layersPearl.length;
        }

        if (tokenId > 1e3 && tokenId <= 11e3 && index == 1 && totalCloverYardPearlMinted == totalCloverYardPearl) {
            index = random3() % layersRuby.length;
        }

        if (tokenId > 1e3 && tokenId <= 11e3 && index == 2 && totalCloverYardRubyMinted == totalCloverYardRuby) {
            index = 3;
        }

        if (tokenId > 11e3 && tokenId <= 111e3 && index == 0 && totalCloverPotCarbonMinted == totalCloverPotCarbon) {
            index = random2() % layersPearl.length;
        }

        if (tokenId > 11e3 && tokenId <= 111e3 && index == 1 && totalCloverPotPearlMinted == totalCloverPotPearl) {
            index = random3() % layersRuby.length;
        }

        if (tokenId > 11e3 && tokenId <=111e3 && index == 2 && totalCloverPotRubyMinted == totalCloverPotRuby) {
            index = 3;
        }
        ...
        if (tokenId <= 1e3 && index == 3 && totalCloverFieldDiamondMinted < totalCloverFieldDiamondCanMint) {
        ...
        if (tokenId > 1e3 && tokenId <= 11e3 && index == 3 && totalCloverYardDiamondMinted < totalCloverYardDiamond) {
        ...
        if (tokenId > 11e3 && tokenId <= 111e3 && index == 3 && totalCloverPotDiamondMinted < totalCloverPotDiamond) {
