...
contract GameZoneAddressRegistry is Ownable {
    ...
    /// @notice GameZoneAuction contract
    address public auction;

    /// @notice GameZoneMarketplace contract
    address public marketplace;

    /// @notice GameZoneMarketplace contract
    address public plan;

    /// @notice GameZoneBundleMarketplace contract
    address public bundleMarketplace;

    /// @notice GameZoneNFTFactory contract
    address public factory;

    /// @notice GameZoneNFTFactoryPrivate contract
    address public privateFactory;

    /// @notice GameZoneArtFactory contract
    address public artFactory;

    /// @notice GameZoneArtFactoryPrivate contract
    address public privateArtFactory;

    /// @notice GameZoneTokenRegistry contract
    address public tokenRegistry;

    /// @notice GameZonePriceFeed contract
    ...
    /**
     @notice Update GameZoneAuction contract
     @dev Only admin
     */
    ...
    /**
     @notice Update GameZoneMarketplace contract
     @dev Only admin
     */
    ...
    /**
     @notice Update GameZonePlan contract
     @dev Only admin
     */
    function updatePlan(address _plan) external onlyOwner {
        plan = _plan;
    }

    /**
     @notice Update GameZoneBundleMarketplace contract
     @dev Only admin
     */
    ...
    /**
     @notice Update GameZoneNFTFactory contract
     @dev Only admin
     */
    ...
    /**
     @notice Update GameZoneNFTFactoryPrivate contract
     @dev Only admin
     */
    ...
    /**
     @notice Update GameZoneArtFactory contract
     @dev Only admin
     */
    ...
    /**
     @notice Update GameZoneArtFactoryPrivate contract
     @dev Only admin
     */
