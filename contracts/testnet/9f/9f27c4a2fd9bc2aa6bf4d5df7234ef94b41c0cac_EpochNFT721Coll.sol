...

{
    ...
    function setTokenLimitMin(uint256 _amount) public onlyOwner {
        tokenLimitMin = _amount;
    }

    function setDiscountPercentage(uint256 _percentage) public onlyOwner {
    ...
    function stakeNft(uint256 tokenId) public{
        if(whiteListuserArray[msg.sender] == true && isStaking[tokenId] == true && balances[tokenId][msg.sender] > 0) {
