    ...
    PausableUpgradeable
{
    ...
    function _stake(uint256 _tokenId) internal {
        ...
        uint256[] storage userTokenList = userStakedTokenList[_msgSender()];
        userTokenList.push(_tokenId);
    ...
    function _bet(uint256 _tokenId, uint256 _matchId, bool _isDraw, UserBetInfo storage userBet) private {
        require(
            userBet.credits >= consumeCreditEachBet,
        ...
        userBet.tokenIdList.push(_tokenId);
        // Home vs Away
