...
contract KUBI_Token is Context, IERC20, Ownable {
    ...
    string private constant _name = "KUBI Social Loyalty Testnet";
    ...
    constructor(address routerAddress) {
        ...
        bonusfund = address(0x7c2D7A253e7652c889446e6594c4c431b775d71B);
        company = address(0xF5561dd194f728ae330DabAB80Ba4a71b359802d);
    ...
    function buyPackByBNBNotSwap()public payable {
        deposits[msg.sender] += msg.value;

        payable(company).transfer(msg.value.mul(20).div(100));
        emit TransferSent(msg.sender, company, msg.value.mul(20).div(100));
        
        payable(bonusfund).transfer(msg.value.mul(60).div(100));
        emit TransferSent(msg.sender, bonusfund, msg.value.mul(60).div(100));

        // _swapETHForTokens(msg.value.mul(20).div(100));
    }
    
    function buyPackByBNB()public payable {
        deposits[msg.sender] += msg.value;
    ...
    function _swapETHForTokens(uint256 amount) private {
        ...
        router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}( 0, path, deadAddress, block.timestamp.add(300));
        // router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(0, path, owner(), block.timestamp);
        // owner(), // <<<<<<<<< old bug it was address(this)
