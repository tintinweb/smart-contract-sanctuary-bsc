...
contract TestPresale is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable {
	...
	function initialize(
		...
		feeWallet = address(0xB17f2d2A5205dc4F4fA74424af131909C04E4234);
	...
	function _addInviteInit() private {
		_addInvite(_initInviteArr);
	}
	/**
