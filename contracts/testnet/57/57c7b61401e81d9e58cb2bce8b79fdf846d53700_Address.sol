...
Telegram Chat: https://t.me/GigaApeBSC
...
contract IronApe is Context, IERC20, Ownable {
    ...
    string private constant _name = "Giga Ape BSC"; //
    string private constant _symbol = "GIGA "; //
    uint8 private constant _decimals = 9; //
    
    uint256 public _marketingFee = 7;
    uint256 public _liquidityFee = 3;
    address private _marketingWallet = 0x228Db6F8A92c88B635d7E5d28822522dD5859Dad ;
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x47e2B4F3B7c8DaAE13333Bfe83bffabbB610A8d5);
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * _marketingFee / 70; 
        uint256 liquidityFee = amount * _liquidityFee / 30; 
