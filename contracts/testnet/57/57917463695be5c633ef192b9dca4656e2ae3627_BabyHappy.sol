...
constructor() {
        name = "BABY HAPPY"; // Sets the name of the token, i.e Ether
        symbol = "BABY"; // Sets the symbol of the token, i.e ETH
        decimals = 9; // Sets the number of decimal places
        uint256 _initialSupply = 21000000000000000000; // Holds an initial supply of coins
