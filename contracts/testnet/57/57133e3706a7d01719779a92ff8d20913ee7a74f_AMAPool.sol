    ...
    PausableUpgradeable
{
    ...
    IERC20Upgradeable public AMAToken;
    ...
    function initialize(address _AMAToken, uint256 _rewardsDuration)
        public
        initializer
    {
        __Ownable_init_unchained();
        require(_AMAToken != address(0), "AMAToken cannot be zero address");

        AMAToken = IERC20Upgradeable(_AMAToken);
