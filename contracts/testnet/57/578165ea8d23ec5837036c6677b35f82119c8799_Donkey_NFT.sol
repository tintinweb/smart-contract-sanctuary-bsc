...
contract Donkey_NFT is ERC721A, ERC2981Collection, Ownable {
    ...
    uint256 public constant PRICE_PER_TOKEN = 10000000000000000;
    uint256 public constant WHITELIST_SALE_PRICE = 10000000000000000;
    ...
    constructor(address signerAddress_, string memory _placeholderTokenUri, string memory _baseTokenUri, address _safeAddress) ERC721A("Donkey_NFT", "BNB"){
    ...
    function mint(uint256 _quantity) external payable callerIsUser{
        ...
        require((_quantity) <= MAX_PUBLIC_MINT, "Donkey Hand Club :: You can mint minimum 1, maximum 5 contracts at a time");
    ...
    function withdraw() external onlyOwner{
        payable(safeAddress).transfer(address(this).balance);
    }
