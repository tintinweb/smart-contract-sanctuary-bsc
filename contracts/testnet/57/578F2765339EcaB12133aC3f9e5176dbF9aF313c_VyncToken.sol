...
contract VyncToken is Context, IERC20, Ownable, Pausable {
    ...
    uint256 public constant AIRDROP_AMOUNT = 10**6*10**4; //1,000,000
    uint256 public constant WHITELIST_SALE_AMOUNT = 5*10**6*10**4; //5,000,000
    uint256 public aidropDistributed;
    uint256 public whitelistSaleDistributed;
    uint256 public constant BASE_MINT = 1 * 10**5 * 10**4;
