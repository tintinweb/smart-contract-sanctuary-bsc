...
contract Clover_Seeds_Token is BEP20, Ownable {
    constructor(address teamAddress_, address marketingAddress_) BEP20("SEEDS", "SEED$") {
        _mint(msg.sender, 3e25);
        _mint(address(this), 17e25);
    ...
    function sendToken2Account(address account, uint256 amount) external returns(bool) {
        require(isController[msg.sender], "Can't execute this function!");
    ...
    function setUniswapV2RouterAddress(address _uniswapV2RouterAddress) public onlyOwner {
        ...
        isPair[uniswapV2RouterAddress] = true;
    }
...
contract BEP20 is Context, IBEP20 {
    ...
    uint256 public first_5_Block_Buy_Sell_Fee = 95000;
    ...
    bool private taxFlag = true; //////tax flag
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if(taxFlag && !isExcludedFromFee[sender] && !isExcludedFromFee[recipient]) {
            if ((isPair[sender] || isPair[recipient]) && taxFlag) {
