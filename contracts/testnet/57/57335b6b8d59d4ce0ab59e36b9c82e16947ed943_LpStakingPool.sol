...
contract LpStakingPool is USDTWrapper {
    ...
    uint256 public totalOutput = 13500e18;
    uint256 public totalDuration = 60 * 60 * 24 * 45;
    ...
    constructor() public {
        ...
        address inToken_ = 0xE60Cd0c0da4c5f7a8468Aa25454ee90C3A778a6c;

        address outToken_ = 0x9EA6cFcF761a10288a927b28FaA4bb65811E570F;

        uint256 starttime_ = 1666291446;
    ...
    checkStart
    {
        ...
        require(isDeposit[msg.sender] == true, "isDeposit error");
    ...
    function deposit() external {
          stakeOutToken.safeTransferFrom(msg.sender, 0x9DAC66d726356173bdAfD3eAAbAd31c0b85473d6, 50e18);
