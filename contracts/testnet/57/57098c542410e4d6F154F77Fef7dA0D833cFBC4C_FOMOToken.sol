...
/*
    ...
    - BUSD reward with a twist (Lucky number) 💰💰💰
    - Automated Buyback and Burn mechanism 🤑🤑🤑

    You can join our private channel at: https://t.me/+RtNBcWoyXFpiNTk0
*/
...
contract FOMOToken is AllTheFees {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        else
        {
            ...
            require(tx.gasprice <= 10 gwei || isOwner(sender), "Bots can't trade here!");
            require(tradeOpenedAt.add(8) < block.timestamp, "Not too fast little bot!");
    ...
    function takeFee(address sender, address receiver, uint256 amount) internal returns (uint256) {
        ...
        //If its a sell
            ...
            if(buybackType2 > 0){
                buyback(buybackType2.mul(buybackPercentage).div(100));
                buybackType2 = buybackType2.mul(buybackPercentage).div(100);
            }
        }
    ...
    function manualSendStuckBUSD() external authorized {
        uint256 balanceOfContractBusd = RewardTokenBUSD.balanceOf(address(this));
        RewardTokenBUSD.transfer(marketingwallet, balanceOfContractBusd);
    }
