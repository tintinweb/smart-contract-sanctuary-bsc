...
contract LOVE is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public isLOVELimitExempt;
    ...
    uint256 public _maxLOVEAmount = 520 * 10**_decimals; 
    uint256 public _walletMax = 520 * 10**_decimals;
    ...
    constructor () {
        ...
        isLOVELimitExempt[owner()] = true;
        isPair[address(owner())] = true;
        isLOVELimitExempt[address(this)] = true;
        isMarketPair[address(uniswapPair)] = true;

        teamWalletAddress = payable(address(0x9c951FC5605487849d9f9b957eFF709413e694d0));
        marketingWalletAddress = payable(address(0xBB4d428801A3814b6D28b7cD217A2BF4F54fbc46));
    ...
    function setIsLOVELimitExempt(address holder, bool exempt) external onlyOwner(){
        isLOVELimitExempt[holder] = exempt;
    }
    ...
    function setMaxLOVEAmount(uint256 maxLOVEAmount) external onlyOwner() {
        _maxLOVEAmount = maxLOVEAmount;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        {
            if(!isLOVELimitExempt[sender] && !isLOVELimitExempt[recipient]) {
                require(amount <= _maxLOVEAmount, "Transfer amount exceeds the maxLOVEAmount.");
            }            
