...
contract Rewarder is ReentrancyGuard, Ownable {
    ...
    constructor(address _adminAddress, address _fundraiser) {
...
contract Fundraiser is Ownable, Pausable, ERC20, ReentrancyGuard {
  ...
  function multiWalletMint(multiWalletMintStruct[] memory walletInfo) external whenNotPaused onlyOwner {
