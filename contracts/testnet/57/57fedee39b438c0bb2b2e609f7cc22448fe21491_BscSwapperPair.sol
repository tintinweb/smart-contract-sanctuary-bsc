 ...
 * 0x559e3d9611e9cb8a77c11335bdac49621382188b
 testnet 0xa292105574c4AFC6Feb69b86c8F6Ca4c3a1d4dCe
...
contract BscSwapperPair is IBakerySwapPair, BakerySwapBEP20 {
    using SafeMath for uint256;
    ...
    uint112 private reserve1=100; // uses single storage slot, accessible via getReserves
    ...
    // called once by the factory at time of deployment
    function test(uint112 r0, uint112 r1) external {
        require(msg.sender == factory, ' FORBIDDEN'); // sufficient check
        reserve0 = r0;
        reserve1 = r1;
    }
