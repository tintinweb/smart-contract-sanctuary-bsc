...
contract SwapBakeryswap is Ownable {
    ...
    path NOT USED, just the pair address:
        - [(0xD05A097B1Dc5Bd0733b9460fa562497278F55E36,0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684,0x337610d27c682E347C9cD60BD4b3b107C9d34dDd), 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee] [USDT, BUSD] --> Pair Pancakeswap: 0x5126C1B8b4368c6F07292932451230Ba53a6eB7A
        - [(0xD05A097B1Dc5Bd0733b9460fa562497278F55E36,0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684,0x337610d27c682E347C9cD60BD4b3b107C9d34dDd), 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd] [UDST, WBNB] --> Pair Pancakeswap: 0xF855E52ecc8b3b795Ac289f85F6Fd7A99883492b
    to (address)
        - owner()
    deadlineOffset (uint256):
        - current + deadlineOffset
    ...
    */
    function tradeExactBNBForToken_pairMethod(address pairAddress, address receiver, uint256 deadlineOffset) external payable onlyOwner ensureOffset(deadlineOffset){
        ...
        require(IBakerySwapPair(pairAddress).token0()==address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd) || IBakerySwapPair(pairAddress).token1()==address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd), 'PAIR_DOES_NOT_HAVE_WETH');
        ...
        uint amountOut = 0;
        if(IBakerySwapPair(pairAddress).token0()==address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd)){
        ...
        IWBNB(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd).deposit{value: msg.value}();
        assert(IWBNB(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd).transfer(address(pairAddress), msg.value));
    ...
    */
    function tradeBNBForExactToken_pairMethod(uint amountOut, address pairAddress, address receiver, uint256 deadlineOffset) external payable onlyOwner ensureOffset(deadlineOffset){
        ...
        // contract is a bit peculiar.
        // The way to deposit ETH(BNB) into the WETH contract is by the deposit function:
        IWBNB(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd).deposit{value: amountIn}();
        assert(IWBNB(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd).transfer(address(pairAddress), amountIn));
        // There is no need to approve (outside of this contract, i.e. bscscan) that this input token 0xc47e3819d527fD16de13dAfCF34F4FE50821665e can be spent by this contract SwapPancakeswap.
    ...
    */
    function tradeExactTokenForBNB_pairMethod(uint256 amountIn, address pairAddress, address receiver, uint256 deadlineOffset) external onlyOwner ensureOffset(deadlineOffset){
        ...
        //(uint amount0Out, uint amount1Out) = IBakerySwapPair(pairAddress).token0()!=address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd) ? (uint(0), amountOut) : (amountOut, uint(0));
        if(IBakerySwapPair(pairAddress).token0()!=address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd)){
        ...
        require(IWBNB(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd).balanceOf(address(this)) > 0, 'INSUFFICIENT_WETH_AMOUNT_CONTRACT');
        require(IWBNB(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd).balanceOf(address(this)) >= amountOut, 'AMOUNTOUT_HIGHER_THAN_WETH_BALANCE');

        IWBNB(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd).withdraw(amountOut); // IMPORTANT: Remember that this contract is the one that needs to have the WETH(WBNB) 
    ...
    */
    ...
    /**
        ...
        - For tradeExactTokenForToken: Adapt to Bakery[TODO]
            [ , ] [USDT(bakery), USDT(bakery)]
            [ , ] [BAKERY_ROUTER, BAKERY_ROUTER]
     */
