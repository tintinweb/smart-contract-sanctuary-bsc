...
contract FiberRouter is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function swap(
        ...
        uint currentChainId = getChainId();
        require(currentChainId != targetNetwork && token != targetToken, "ERROR: SAME TOKEN WITH SAME NETWORK");
    ...
    function swapAndCross(
        ...
        uint currentChainId = getChainId();
        require(currentChainId != crossTargetNetwork && path[0] != crossTargetToken, "ERROR: SAME TOKEN WITH SAME NETWORK");
