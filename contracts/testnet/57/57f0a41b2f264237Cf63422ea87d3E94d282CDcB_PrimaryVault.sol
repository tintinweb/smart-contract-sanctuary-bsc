    ...
    **/
    function reportSnapshot() virtual public payable onlyOwner {
        ...
        if (chainId == primaryChainId) {
            ...
            uint256 _gasAmount = 123;   // CHECKLATER: default gas amount
            bytes memory _adapterParams = txParamBuilderType1(_gasAmount);
            _lzSend(primaryChainId, lzPayload, payable(msg.sender), address(0x0), _adapterParams, msg.value);
        }
    }
