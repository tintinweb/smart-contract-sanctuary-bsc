...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x3019BF2a2eF8040C242C9a4c5c4BD4C81678b2A1); 
...
contract testtoken is IBEP20, Auth {
    ...
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    address RewardToken = 0x3019BF2a2eF8040C242C9a4c5c4BD4C81678b2A1;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0x67A2FeAc846A1B308cfaBDC9269A8A579eD34992;
        
        totalFee = liquidityFee.add(marketingFee).add(rewardsFee);
        totalFeeIfSelling = totalFee.add(extraFeeOnSell);
        require(totalFee <= 15, "Must keep fees at 15% or less");
