    ...
    ReentrancyGuardUpgradeable
{
    ...
    event TemporaryMergeExecuted(
        address _to,
        uint256[] _tokenIds,
        uint256 indexed _newTokenId,
        string indexed _sessionId
    );
    event PermanentMerged(address _to, uint256[] _tokenIds, uint256 indexed _newTokenId, string indexed _sessionId);
