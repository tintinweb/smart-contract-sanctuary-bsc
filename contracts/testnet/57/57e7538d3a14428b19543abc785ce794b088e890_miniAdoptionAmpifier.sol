...
contract miniAdoptionAmpifier is Ownable , ReentrancyGuard{
  ...
  mapping(bytes32 => bool) public executed;
    ...
    */
    ...
    event PointsEarned(address indexed _user, uint indexed _amount);
...
//   ************** Reward Claim Pool **************
    ...
    // Earn Points
    function earnPoints(uint256 _amount, Signature memory _sign, uint256 nonce) public nonReentrant {
        ...
        if (verifySignature(msg.sender, _amount, _sign) == owner()) {
