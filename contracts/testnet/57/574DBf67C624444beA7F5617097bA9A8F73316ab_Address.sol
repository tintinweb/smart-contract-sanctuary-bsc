...
contract ChiggaInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Chigga Inu";
    string private _symbol = "CHNK";
    uint8 private _decimals = 4;

    address public marketingWallet = 0x2244b5cc053096A41D895A82372eE8cCaD58D18B;
    address public devWallet = 0x5A5a6589B528EA1bFeF1B80831fc36C68dB9f49a;
    ...
    function setBuyFee(uint _newLP , uint _newMarket , uint _newDev) public onlyOwner {     
    ...
    function setSellFee(uint _newLP , uint _newMarket, uint _newDev) public onlyOwner {        
    ...
    function setWallets(address _market,address _liquidityRec,address _devW) public onlyOwner {
