...
contract CONTRACT2 is Context, IERC20 { 
    ...
    */
    ...
    address public Wallet_Multi_Sig = 0xa945336d1dDFD721FDe7f89901EBdd8122ed0415;                       // Used to verify ownership transfer

    address payable public Wallet_Marketing = payable(0x43aA8f04b23aFd5cEF193982403BF22eC4c23951);      // Marketing Wallet
    address payable public Staking_Wallet_Contract = payable(0x0ae46dAa2A1D26a4A112aA84cc5729654Bad5B88);   // Staking Wallet 
    address payable public Wallet_Development = payable(0xa945336d1dDFD721FDe7f89901EBdd8122ed0415);    // Solidity Developer
    address payable public Wallet_CakeLP = payable(0xa945336d1dDFD721FDe7f89901EBdd8122ed0415);         // Auto Liquidity CakeLP Destination
    ...
    string  private constant _name = "CONTRACT2"; 
    string  private constant _symbol = "CT2";  
    ...
    constructor () {
        ...
        Contract_Developer = 0x0ae46dAa2A1D26a4A112aA84cc5729654Bad5B88;

        _owner = 0x6914F6f5A687bd782f7ca6E6b503D9473065427D;
    ...
    */
    ...
    function set_Fee_Distribution(uint256 _percent_Marketing,
        ...
        percent_Staking_Wallet = _percent_Development;
    ...
    */
    ...
    event E_Wallet_Update_DeployerDev(address indexed oldWallet, address indexed newWallet);
    ...
    //Update the development and Staking wallet
    function Wallet_Update_Development(address payable wallet) external onlyOwner {
        ...
        Staking_Wallet_Contract = wallet;

    }

    //Update developer fee wallet
    function Wallet_Update_DeployerDev(address payable wallet) external {
        ...
        emit E_Wallet_Update_DeployerDev(Wallet_Development,wallet);
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 BNB_D = returned_BNB * percent_Staking_Wallet * 2 / fee_Split; 
        uint256 BNB_C = returned_BNB * 10 * 2 / fee_Split;

        if(BNB_D > 0){sendToWallet(Staking_Wallet_Contract, BNB_D);}

        if(BNB_C > 0){sendToWallet(Wallet_Development, BNB_C);}
