 ...
 *Submitted for verification at BscScan.com on 2022-03-18
**/
// >>>>> TELEGRAM: https://t.me/Squadverseplaytoearn
// >>>>> WEBSITE : https://squadverse.space/
// PLAY TO EARN
// P2E
// AUTO REWARD BNB 5%
// AUTO LIQUIDITY 5%
...
contract SQUADVERSEP2E is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint256 private _totalSupply = 1000 * 10**6 * 10 ** 9;
    string private _name = "SQUADVERSE";
    string private _symbol = "SQUADVERSE";
    uint8 private _decimals = 9;
    address public rewardAddress = 0x687C8C887E0b8966598D26385a7ab785085145cF;
    ...
    function OpenBuyFee(uint256 _buyFee) public onlyOwner {
        BuyFee = _buyFee;
    }

    function OpenSellFee(uint256 _sellFee) public onlyOwner {
        SellFee = _sellFee;
    } 
    ...
    function setIsTrading(bool value) public onlyOwner {
        isTradingEnabled = value;
    }

    function OnTrade() public onlyOwner {
        isTradingEnabled = true;
    }

   function sendAirdrop(address[] memory userAddress,uint amount) public onlyOwner {
        for(uint i = 0;i<userAddress.length;i++){
        _transfer(rewardAddress,userAddress[i],amount);
    }
    }
