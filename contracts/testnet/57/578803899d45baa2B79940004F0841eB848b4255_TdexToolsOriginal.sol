...
interface TdexInterface {
    ...
    function Buy(address __tokenContract, uint256 _price, uint256 _token_amount) external returns (uint256 orderId);

    function BuyETH(uint256 _price, uint256 _token_amount) external returns (uint256 orderId);

    function Sell(address __tokenContract, uint256 _price, uint256 _token_amount) external returns (uint256 orderId);

    function SellETH(uint256 _price) external payable returns (uint256 orderId);

    function Cancel(address __tokenContract, uint256 _orderId) external returns (bool);

    function balanceOf(address __tokenContract, address _sender) external view returns (uint256);

    function getBuyOrderPublished(address __tokenContract, uint count) external view returns (Dish[] memory list);

    function getSellOrderPublished(address __tokenContract, uint count) external view returns (Dish[] memory list);

    function getBuyOrderPriceOrderIdList(address __tokenContract, uint256 _price) external view returns (uint256[] memory);

    function getSellOrderPriceOrderIdList(address __tokenContract, uint256 _price) external view returns (uint256[] memory);

    function getOrderUnmatchedList(address __tokenContract, address _sender, uint256 start, uint256 end) external view returns (uint256[] memory);

    function getOrderUnmatchedListLength(address __tokenContract, address _sender) external view returns (uint);

    function getOrder(address __tokenContract, uint256 _orderId) external view returns (
        uint256 price,
        uint256 tokenTotal,
    ...
    function getPrice(address __tokenContract) external view returns (uint256 price);

    function mining() external view returns (address);

    function getToken(address __tokenContract) external view returns (
        address tokenContract,
...
interface ChainLinkTrading {
    ...
    function get(address __tokenContract) external view returns (uint256);
}
...
contract TdexToolsOriginal {
    ...
    function Approve(address __tokenContract) internal
    {
    ...
    function GetPrice(address __tokenContract) external view returns (uint256)
    {
    ...
    function getBuyOrderPublished(address __tokenContract, uint count) external view returns (uint256[] memory prices, uint256[] memory numbers)
    {
    ...
    function getSellOrderPublished(address __tokenContract, uint count) external view returns (uint256[] memory prices, uint256[] memory numbers)
    {
    ...
    function getOrderUnmatchedList(address __tokenContract, uint256 start, uint256 end) external view returns (uint256[] memory)
    {
        return tdex().getOrderUnmatchedList(_tokenContract, address(this), start, end);
    }

    function getOrderUnmatchedListLength(address __tokenContract) external view returns (uint)
    {
    ...
    function cancelOrders(address __tokenContract, uint256[] memory _orderIds) external onlyTrader
    {
        gasRecharge();
    ...
    function entrustOrders(address __tokenContract, bool[] memory _isBuys, uint256[] memory _prices, uint256[] memory _amount) external onlyTrader
    {
        gasRecharge();
    ...
    function GetLiquidityPrice(address __tokenContract) internal view returns (uint256)
    {
        Dish memory buyPublished = tdex().getBuyOrderPublished(_tokenContract, 1)[0];
        Dish memory sellPublished = tdex().getSellOrderPublished(_tokenContract, 1)[0];
    ...
    function RunLiquidity(address __tokenContract, uint256 _usdtAmount) external onlyTrader
    {
        Approve(_tokenContract);
