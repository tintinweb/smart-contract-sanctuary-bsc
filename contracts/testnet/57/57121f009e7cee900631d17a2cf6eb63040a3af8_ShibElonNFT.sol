...
contract ShibElonNFT is ERC721A {
    using Strings for uint256;
    ...
    constructor() ERC721A("ShibElon", "Shib Elon", maxMintAmount) {
        owner = msg.sender;
        maxSupply = 3000;

        receiverAddress = 0xBd1d184bD749c163C24D6ae5133C6b81Da26d638; // Marketing Wallet
        ...
        */
        ...
        baseTokenAddress = 0xaB1a4d4f1D656d2450692D237fdD6C7f9146e814; //BUSD
    ...
    function mint(uint256 _mintAmount) external payable {
        require(saleOpen == true, "mint not live");
        require(msg.value >= getPrice() * _mintAmount,"Less amount passed");
