...
contract VBGGAME721V2 is ReentrancyGuard {
    ...
    constructor() public {
        ...
        POOL_GAME = 0x0e9BDcD576273b69bE5D3f25DE798d96162D430a; 
    ...
    */
    ...
    function depositNFTsToGame(address _nft, uint256 _tokenId)
        public ifNotPaused onlySupportedNFT(_nft) returns (bool)
    {
        require(_isContract(msg.sender) == false, "depositNFTsToGame: anti bot");
        require(IERC721(_nft).isApprovedForAll(msg.sender, address(this)) == true, "depositNFTsToGame: Check the nft approve ");
        ...
        userInfo[msg.sender].nftDeposit[_nft] += 1;
    ...
    ) public ifNotPaused returns (uint256) 
    {
        ...
        userSigned[msg.sender][signature] = true;
        userInfo[msg.sender].nftRewardClaimed[_nft] += amount;
        userInfo[msg.sender].lastUpdatedAt = block.timestamp;
        return _tokenId;
    }
