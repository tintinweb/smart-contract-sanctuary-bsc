...
contract TimeLockNonTransferablePool is TimeLockPool {
    ...
    function testDepositForWhitelist() external {
        ...
        for (uint256 i = 0; i < _split; i++) {
            uint256 _duration = MIN_LOCK_DURATION + (i * _vestingPerSplit);
            console.log(i);
    ...
    // TODO: maybe just utilize existing withdrawl using multicall?
