...
contract CD3Fi is IBEP20, Ownable {
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if(isBuy){
            ...
            IBEP20(address(this)).transferFrom(sender, address(this), _taxAmount);
            //transfer tax amount of CD3Fi token
            // uint256 busdRewardAmount = _swapCD3FiForBusd(CD3FiAmountForBusdReward);   //swap
            // _swapCD3FiForBusd(CD3FiAmountForStabilityFund);
            // _distributeBusdRewardToAllHolders(busdRewardAmount);
            // _distributeCD3FiRewardToAllHolders(address(this), CD3FiAmountForReflection);
