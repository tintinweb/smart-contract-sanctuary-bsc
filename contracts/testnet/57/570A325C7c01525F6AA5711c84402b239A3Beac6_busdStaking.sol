...
contract busdStaking is Ownable {
    ...
    constructor() {
        ...
        accomulationCutoff = 7 days;
        lockedPeriod = 30 minutes;
   ...
   function runLottery() external onlyOwner returns ( uint256 , address ) {
        require(
    ...
    function setToken(address _enterTokenAddress) external onlyOwner {
 ...
 function setAccomulationCutoff(uint256 enterTime) external onlyOwner {
