...
contract MyDog2022 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "MyDog2022";
    string private _symbol = "MyDog2022";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xd30Fa7f4F7748636a0434E73c00fF1FEc64EC679));
        marketingWalletAddress = payable(address(0xd30Fa7f4F7748636a0434E73c00fF1FEc64EC679));
