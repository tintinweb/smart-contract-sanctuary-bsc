...
contract TOKEN_Staking is Ownable {
	...
	//STAKING PARAMETERS
	uint256 public constant stakingPeriod = 30 minutes; //period over which tokens are locked after staking
	...
	uint256 public maxTotalStaked = 100000000000;
	uint256 public minStaked = 1000000000;
	...
	constructor(){
		stakingEnd = (block.timestamp + 60 minutes);
	}
