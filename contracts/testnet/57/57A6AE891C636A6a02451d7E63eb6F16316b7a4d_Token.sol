...
contract Token is IERC20, Ownable {
  ...
  /// @notice Define is an address should be excluded from fees
  /// @param user Address to be defined
  /// @param value Is excluded
  function setIsExcludedFromFeee(address user, bool value) public onlyOwner {
    isExcludedFromFee[user] = value;
  } 

  /// @notice Define is an address should considered as a liquidityPair
  /// @param user Address to be defined
  ...
  /// @notice Define is an address should be blacklisted
  /// @param user Address to be defined
