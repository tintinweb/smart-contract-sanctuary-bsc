...
contract Ninneko is Initializable, ERC721Upgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    uint256 public percentRebornWild;
    uint256[] public class;
    uint256[] public part;
    uint256[] public bGenes;
    ...
    function setMataRebornFee(uint256 _mataRebornFee) external onlyOwner {
    ...
    function setDataGene(uint256[] memory _class , uint256[] memory _part , uint256[] memory _bGenes , uint256 _percentRebornWild) external onlyOwner {
        class = _class;
        part = _part;
        bGenes = _bGenes;
        percentRebornWild = _percentRebornWild;  //ratio 10000
    }

    function reborn(
        uint256 _petId
    ) external whenNotPaused whenNotPausedReborn onlyPetOwner(_petId) notInBlackList(_petId) nonReentrant{
        ...
        uint256 currentClassId = Genes.getCurrentClassId(pets[_petId].geneId);
        uint256 newGeneId = Genes.randomGene(counter++ ,percentRebornWild , currentClassId , class, part, bGenes );
