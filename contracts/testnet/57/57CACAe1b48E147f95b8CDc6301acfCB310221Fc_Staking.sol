...
contract Staking is  ProxyBaseStorage, Ownable, ReentrancyGuard, Pausable, GlobalsAndUtils {
    ...
    constructor(address _stakingToken, address _rewardingToken) {
        ...
        totalStakedAmount = 17376800000000000000000000;
        totalPenaltiesClaimed = 29;
 ...
 /**
    ...
    function migratePenaltyHistory(
        address user, uint256 penaltyId, uint256 penaltyAmount, uint256 penalty, uint256 stakedAmount, uint256 totalStaked, uint256 penaltyTime, uint256 campaignId
    ) external onlyOwner {
        penaltyHistoryIds[user].push(penaltyId);
        penaltyHistories[user][penaltyId] = penaltyHistory(penaltyTime, totalStaked, stakedAmount, penalty, penaltyAmount, campaignId);
        userClaimedPenalty[user][campaignId] = true;
    }
