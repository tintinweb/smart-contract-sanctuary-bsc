...
contract NabanaVesting is Ownable {
    ...
    // addresses for lock
    address public immutable managementAllocationWallet;
    address public immutable advisorsWallet;
    address public immutable influencersWallet;
    address public immutable strategicPartnersWallet;
    ...
    constructor() {
        ...
        getVestings[managementAllocationWallet] = Vesting(managementAllocationWallet, 70000000 * (10**18), 36, 25, 61, 4);
        getVestings[advisorsWallet] = Vesting(advisorsWallet, 5000000 * (10**18), 12, 50, 62, 2);
        getVestings[influencersWallet] = Vesting(influencersWallet, 25000000 * (10**18), 6, 25, 31, 4);
        getVestings[strategicPartnersWallet] = Vesting(strategicPartnersWallet, 25000000 * (10**18), 6, 25, 31, 4);
        getVestings[reserveWallet] = Vesting(reserveWallet, 150000000 * (10**18), 12, 25, 37, 4);
    }
