...
contract CSGOToken is Context, IERC20, Ownable {
    ...
    string private _name = "CSGOToken"; // define o nome do token
    string private _symbol = "CSGO"; // define o símbolo do token
    ...
    uint256 public _taxFee = 4; // tax fee padrão, esse valor não é utilizado no contrato, ele é sobrescrito pelo buytaxfee e selltaxfee
