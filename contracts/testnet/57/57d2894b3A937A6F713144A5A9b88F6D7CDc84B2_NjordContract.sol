...
contract NjordContract is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Njord", "NJORD", uint8(DECIMALS)) Ownable() {
    ...
    function shouldAddLiquidity() internal view returns (bool) {
        return _autoAddLiquidity && !inSwap && msg.sender != pair && block.timestamp >= (_lastAddLiquidityTime + 1 days);
    }
