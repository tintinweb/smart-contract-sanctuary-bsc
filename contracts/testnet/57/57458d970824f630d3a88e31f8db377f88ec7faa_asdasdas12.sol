...
contract asdasdas12 {
    ...
    uint256 constant launch = 1664340700; 
    ...
    function redeemmmInitial (uint256 num ) public {
      	  
      	UserInfo storage user = UsersKey[msg.sender];
		
        
      	require(user.treasuryList[num].depositSign == false, "already redeemed.");
    ...
    function sadsadasd50() public view returns (uint256){
        return FeesKey[50].daysInSeconds;
    }
    function sadsadasd40() public view returns (uint256){
        return FeesKey[40].daysInSeconds;
    }
