...
abstract contract BaseGateway is ERC721Holder, ERC1155Holder, ReentrancyGuard, Pausable, UUPSUpgradeable, IBaseGateway {
    ...
    function baseValue(address _nft, uint256 _tokenId, uint256 _amount) external supportInterface(_nft) view override returns (uint256, uint256) {
        bytes32 infoHash = keccak256(abi.encodePacked(_nft, _tokenId));
    ...
    function redeem(address _nft, uint256 _tokenId, uint256 _amount) external override nonReentrant {
        ...
        require(poolsWeights[fomulaA] >= tokenInfo[infoHash].weightsFomulaA, "poolsWeightsA insufficent");
        poolsWeights[fomulaA] = poolsWeights[fomulaA] - tokenInfo[infoHash].weightsFomulaA;

        if (poolsWeights[fomulaB] > tokenInfo[infoHash].weightsFomulaB) {
            poolsWeights[fomulaB] = poolsWeights[fomulaB] - tokenInfo[infoHash].weightsFomulaB;
        }
        if (poolsWeights[fomulaC] > tokenInfo[infoHash].weightsFomulaC) {
            poolsWeights[fomulaC] = poolsWeights[fomulaC] - tokenInfo[infoHash].weightsFomulaC;
        }

        tokenInfo[infoHash].weightsFomulaA = tokenInfo[infoHash].weightsFomulaA - tokenInfo[infoHash].weightsFomulaA;
        tokenInfo[infoHash].amounts = tokenInfo[infoHash].amounts - _amount;

        contractInfo[_nft].weightsFomulaA = contractInfo[_nft].weightsFomulaA - tokenInfo[infoHash].weightsFomulaA;
        contractInfo[_nft].weightsFomulaB = contractInfo[_nft].weightsFomulaB - tokenInfo[infoHash].weightsFomulaB;
        contractInfo[_nft].weightsFomulaC = contractInfo[_nft].weightsFomulaC - tokenInfo[infoHash].weightsFomulaC;
        contractInfo[_nft].amounts = contractInfo[_nft].amounts - _amount;
