...
contract Governance {
    ...
    event RefundProduct(address indexed product);
    ...
    function refundProduct(address _product) public onlyVoter {
        IProduct(_product).refund();
        emit RefundProduct(_product);
    }
