...
contract Dortol is Context, IERC20, Ownable {
    ...
    string private _name = "Dortol";
    string private _symbol = "DRTL";
    ...
    address public charityWallet = 0x77171e9CF63Ddf7Ef9e3D2d1213a96C5cd78F193;
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0xd43c67F90784d03510b8E2C79F20Fdd32D106fa0, 'We can not exclude Pancake router.');
