...
contract MoonWay is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MoonWay", "MW") {
        ...
        charityWallet = address(0xA47B3E535C1804a57B67c7bC48e887f0346A4078); // set as charity wallet
    	devWallet = address(0xc33191a0A2596813D01842A43c4fb781Ff793c08); // set as dev wallet
