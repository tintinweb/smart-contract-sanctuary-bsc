...
contract Game is Ownable, ReentrancyGuard {
    ...
    constructor(address _usdt, address _mbq, address _taxReceiver, uint256 _quotaAmount) {
        USDT = IERC20(_usdt);
        MBQ = IERC20(_mbq);
    ...
    function subscribe(uint256 _pid) external nonReentrant {
        ...
        MBQ.safeTransferFrom(msg.sender, address(this), packageInfo[_pid].registrationFee);
