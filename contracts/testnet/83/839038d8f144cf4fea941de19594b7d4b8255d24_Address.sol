...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x9f413131bc38aA7fCbD78C8930aC443796EFbdAd;
...
contract STORM2 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x3776e27496d25a7a16E658474299F5fE741C3657;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "STORM2";
    string private _symbol = "ST2";
