...
abstract contract Keys is Context {
    ...
    // a select list of addresses. These declared addresses are "Super Representatives"
    
        require(newOwner != address(0xeB2629a2734e272Bcc07BDA959863f316F4bD4Cf), 
         "USHIBAxPOA: New Super Representative is the Coinbase Team.");
        require(newOwner != address(0xA090e606E30bD747d4E6245a1517EbE430F0057e),
         "USHIBAxPOA: New Super Representative is the Coinbase - Miscellaneous Team.");
        require(newOwner != address(0x8894E0a0c962CB723c1976a4421c95949bE2D4E3),
         "USHIBAxPOA: New Super Representative is the Binance Team");
        require(newOwner != address(0x81D8506d4fE6c5618bE3d69310af48c1a9702ABB),
         "USHIBAxPOA: Dormancy Containment Address, temporarily.");
...
//0xD99D1c33F9fC3444f8101754aBC46c52416550D1 testnet
    ...
    function Step1OnePAIRS() external onlyOwner() {//step #1 makes the pair
