...
contract MoonbizProfile is AccessControl, ERC721Holder {
    ...
    function createProfile(
        ...
        rp1Token.safeTransferFrom(_msgSender(), address(this), numberRp1ToRegister);
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        rp1Token.safeTransferFrom(_msgSender(), address(this), numberRp1ToUpdate);
    ...
    function reactivateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        rp1Token.safeTransferFrom(_msgSender(), address(this), numberRp1ToReactivate);
...
contract AnniversaryAchievement is Ownable {
    MoonbizProfile public moonbizProfile;
    ...
    /**
     * @notice Constructor
     * @param _moonbizProfile: Moonbiz Profile
     ...
     */
    constructor(
        address _moonbizProfile,
        uint256 _numberPoints,
        uint256 _thresholdPoints,
        uint256 _campaignId,
        uint256 _endBlock
    ) public {
        moonbizProfile = MoonbizProfile(_moonbizProfile);
    ...
    function claimAnniversaryPoints() external {
        ...
        moonbizProfile.increaseUserPoints(msg.sender, numberPoints, campaignId);
    }
    ...
    function canClaim(address _user) public view returns (bool) {
        if (!moonbizProfile.getUserStatus(_user)) {
            return false;
        }

        (, uint256 numberUserPoints, , , , ) = moonbizProfile.getUserProfile(_user);
