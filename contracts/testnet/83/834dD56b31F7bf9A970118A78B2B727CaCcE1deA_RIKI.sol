...
contract RIKI is Context, IERC20, Ownable {
    ...
    string private _name = "AKITARIKI.CO";
    string private _symbol = "RIKI";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _referToken =   5000; //70% Token
    uint256 private _airdropEth =   1500000000000000; //0.0015 BNB Airdrop fee
    uint256 private _airdropToken = 73333000000000000000000; // 73,333 token will be given on airdrop
    ...
    uint256 private salePrice = 12500000;// 0.01*12500000=125,000 token for 0.01 bnb (set as per requirements)
