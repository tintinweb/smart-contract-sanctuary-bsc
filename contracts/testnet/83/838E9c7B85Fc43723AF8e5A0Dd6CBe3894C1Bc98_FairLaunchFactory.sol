...
contract FairLaunchFactory {
  ...
  function sendValue(address _token, address to, uint256 _selling_amount, uint256 _liquidityPercent) public {
...
contract Fairlaunch is ReentrancyGuard {
    ...
    address private profitAddress=0x099126fB8BaF5001a294B84c5Ce7978989FE1E05;
    ...
    function setProfitAddress(address to) public {
        profitAddress = to;
    }
