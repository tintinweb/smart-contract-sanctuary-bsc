...
contract Contract is ERC1155, IERC2981, Ownable, IERC1155Receiver {
    ...
    mapping (uint256 => uint256) private blockedCellsFee;
    ...
    */
    ...
    ) external payable returns (uint256)
    {
        ...
        cellsCount[_id] = _cellsCount;
        uris[_id] = uri;
        emit URI(uri, _id);

        _tokenIds.increment();

        blockedCellsFee[_id] = cellsPrice;
    ...
    function approveNft(uint256 _tokenId) public onlyOwner {
        ...
        (bool sent, ) = payable(owner()).call{value: blockedCellsFee[_tokenId]}("");
    ...
    function rejectNft(uint256 _tokenId) public onlyOwner {
        ...
        (bool sent, ) = payable(creators[_tokenId]).call{value: blockedCellsFee[_tokenId]}("");
