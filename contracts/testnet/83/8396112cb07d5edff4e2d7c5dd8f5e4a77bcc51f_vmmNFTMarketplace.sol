...
// File: contracts/vmmNFTMarket.sol
...
contract vmmNFTMarketplace is Ownable, ReentrancyGuard {
        ...
        isAuction(_nft, _tokenId)
    {
        ...
        require(block.timestamp > auction.endTime, "auction still working");
    ...
    function resultAuction(address _nft, uint256 _tokenId) external {
        ...
        payToken.transferFrom(msg.sender, feeRecipient, platformFeeTotal);

        // Transfer to auction creator
        payToken.transferFrom(msg.sender, auction.creator, totalPrice - platformFeeTotal);
