...
contract MataRabbitKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MataRabbitKing";
    string private _symbol = "MataRabbitKing";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 3;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x8A1b586738B20b4054D73cc31e77F2F6849276D7); // Marketing Address
    address payable public teamWalletAddress = payable(0xb1571335DbA589F32bcDe3f1262108d71DB8e1Df); // Team Address
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xeAf1569b52eEd63bDff879d38697a71C1Dbd889a),
            block.timestamp
        );
    }
