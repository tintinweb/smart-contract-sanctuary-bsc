...
contract liquidWithdrawal is Ownable, ReentrancyGuard {
    ...
    modifier thirtyDaysPassed() {
        require(block.timestamp - lastWithdrawalTimestamp >= 30 minutes, "30 days have not passed");
        _;
    }
    ...
    function allowedWithdrawalTimestamp() public view returns(uint256) {
        return lastWithdrawalTimestamp + 30 minutes;
    }
    ...
    function sendRevenue(uint8 percent) public thirtyDaysPassed avrInstanceInited  onlyOwner nonReentrant returns(bool){
        ...
        _avrToken.transfer(0x2E0af5a9DDf961Ba6b231A6CAd94851ad27dA1f1, allowedAmount);
