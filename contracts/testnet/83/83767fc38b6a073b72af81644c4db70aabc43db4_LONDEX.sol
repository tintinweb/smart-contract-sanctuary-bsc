...
contract LONDEX is IBEP20, Auth {
    ...
    uint256 public weeklyCooldownTimerInterval = 60;
    uint256 public weeklyCooldownLimit = 34 * 10**8;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient == pair &&
            ...
            !isTimelockExempt[sender]) {
            require(weeklyCooldownTimer[sender] < weeklyCooldownLimit,"Weekly cap reached");
