...
contract LazyNFT is ERC721, ERC721URIStorage, Ownable, EIP712 {
    ...
    event VoucherCreated(uint256 tokenId, uint256 price, string uri, address buyer);

   function createVoucher(uint256 tokenId,
        uint256 price,
        string memory uri,
        address buyer) public  {

        emit VoucherCreated( tokenId, price, uri, buyer);
    }
