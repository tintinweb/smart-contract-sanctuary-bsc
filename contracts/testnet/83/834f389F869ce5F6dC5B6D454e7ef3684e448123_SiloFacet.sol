...
contract TopcornSilo is LPSilo {
    ...
    function _withdrawTopcorns(uint32[] calldata crates, uint256[] calldata amounts) internal {
        ...
        (uint256 topcornsRemoved, uint256 stalkRemoved) = removeTopcornDeposits(crates, amounts);
    ...
    function removeTopcornDeposits(uint32[] calldata crates, uint256[] calldata amounts) private returns (uint256 topcornsRemoved, uint256 stalkRemoved) {
