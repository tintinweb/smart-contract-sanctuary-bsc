...
contract DividendDistributor is IDividendDistributor {
    ...
    address _token;
    address crea = 0x65C32DBAb3d11c917b70C68C272FeeE806C85792;
...
contract FomoFTM is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    uint256 private constant MAX_SUPPLY = 1000000000 * 10**7 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        isFeeExempt[superfarmerReceiver] = true;
        ...
        autoLiquidityReceiver = 0x65C32DBAb3d11c917b70C68C272FeeE806C85792;
        superfarmerReceiver = 0x65C32DBAb3d11c917b70C68C272FeeE806C85792;
...
function setLP(address _address) external onlyOwner {
    ...
    function swapBack() internal swapping {
        ...
        (bool tmpSuccess,) = payable(superfarmerReceiver).call{value: amountBNBMarketing, gas: 30000}("");
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _superfarmerReceiver) external authorized {
