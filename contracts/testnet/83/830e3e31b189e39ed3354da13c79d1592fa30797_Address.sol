...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x36D7A1D1Fce2F4A8bd3DAc1C393F125352d837A9;
...
contract Lot is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x36D7A1D1Fce2F4A8bd3DAc1C393F125352d837A9);
    ...
    */
    ...
    string private _name = "SmartDegen"; 
    string private _symbol = "SDN";  
    uint8 private _decimals = 9;
    uint256 private _tTotal = 200000 * 10**_decimals;
    ...
    */
    ...
    // Maximum transaction amount (0% at launch)
    uint256 public _maxTxAmount = _tTotal.mul(0).div(100); 
    ...
    */
    ...
    function _set_Fees(uint256 Buy_Fee, uint256 Sell_Fee) external onlyOwner() {
        ...
        require((Buy_Fee + Sell_Fee) <= maxPossibleFee, "Cannot raise above 20%.");
        _sellFee = Sell_Fee;
        _buyFee = Buy_Fee;
    ...
    function set_Max_Transaction_Percent(uint256 maxWallTransctn) external onlyOwner() {
        _maxTxAmount = maxWallTransctn * (10**_decimals);
    }    
    ...
    function _transfer(
        ...
        */
        ...
        if (to != owner() &&
            ...
            require((heldTokens + amount) <= _maxWalletToken,"Maximum wallet limit has been exceeded");
            }


        // Limit the maximum number of tokens that can be bought or sold in one transaction
        if (from != owner() && to != owner())
            require(amount <= _maxTxAmount, "Maximum transaction limit has been exceeded for this transaction");
    ...
    UPDATE PANCAKESWAP ROUTER AND LIQUIDITY PAIRING IN CASE OF FUTURE UPGRADES
