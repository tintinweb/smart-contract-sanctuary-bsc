...
contract DividendDistributor is IDividendDistributor {
    ...
    address routerAddress = 0xB6BA90af76D139AB3170c7df0139636dB6120F7e;
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0x0132144D6ECAD56513Ad0984FE976e069216fD38)); _;
    }

    constructor (address _router,address _RewardTokenSET) {
        
        router = _router != address(0) ? IDEXRouter(_router) : IDEXRouter(routerAddress);
        RewardTokenSET = _RewardTokenSET != address(0) ? address(_RewardTokenSET) : address(0x1e2f7cc55560AF452857Cbb2e0F4008b9FdD1E99);
...
contract MetaDAO is IBEP20 , Auth, BaseToken {
    ...
    string public _name = "QQQ Token";
    string public _symbol = "QQQ";
    uint8 constant _decimals = 0;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress= 0xB6BA90af76D139AB3170c7df0139636dB6120F7e;
    address RewardToken = 0x1e2f7cc55560AF452857Cbb2e0F4008b9FdD1E99;
    ...
    constructor(
        ...
        // address marketing_addr, // reward, router, marketing wallet, dividendTracker
