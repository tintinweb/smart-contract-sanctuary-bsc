...
//1671062400
    ...
    constructor (address addr) payable {
        ...
        addresses[hax]=admin;
        stakingToken = IERC20(0x325a4deFFd64C92CF627Dd72d118f1b8361c5691);
        stakingFromToken = IERC20(0x325a4deFFd64C92CF627Dd72d118f1b8361c5691);
        startTime = uint32(block.timestamp);
        endTime = uint32(block.timestamp + stakingTime);
        ICO_status = true;
        ratePerToken = 142857;
    ...
    */    
    ...
    function _buy(address sender, uint256 amount) internal {
        ...
        //stakingToken.transfer(sender, tokens * (10 ** 18));        
