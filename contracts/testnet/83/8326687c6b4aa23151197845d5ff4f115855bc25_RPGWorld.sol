...
/**Discover The RPG World
  *Discover The RPG World is a brand new type of match-3 RPG game. In this unique RPG game, the classic match-3 puzzle gameplay is mixed with battle,
   Magic, and dragons as you fearlessly charge into the enemies. Are you ready? It's time to reveal the secrets of Discover The RPG World!.*
*/
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xE131C1521953f2088893B8F3a707997D094418f3); // Marketing Address
    address payable public devAddress = payable(0x4eA8Ec728f0e63F0c9703BCDc14a599335Ee3143); // Dev Address
    ...
    uint256 private minimumTokensBeforeSwap = 75 * 10**6 * 10**9; 
    uint256 private buyBackUpperLimit = 1 * 10**7 * 10**9;
    uint256 private minimumBeforeBuyBack = 1 * 10**7 * 10**9;
...
contract RPGWorld is ERC1363, TokenRecover {
    constructor ()
        ERC1363("RPGWorld", "RPGW")
    {
    }
}