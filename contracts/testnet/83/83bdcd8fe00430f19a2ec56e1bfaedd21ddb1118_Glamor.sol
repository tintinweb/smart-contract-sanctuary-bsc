...
contract Glamor {
    ...
    BEP20 public token = BEP20(0x8E69E142be42035661019dDBa1c83C068B59c560);
    ...
    function deposit(address _referral, uint256 _amount) public  {
        require(_amount>=10e9, "Minimum 10 and multiple of 10");
        require(players[msg.sender].referral == address(0) || players[msg.sender].referral == _referral, "Sponsor id not valid");
        require(totalDeposit<250e9, "Smart Contract Balance full");
    ...
    function withdraw(uint256 _amount) public{
        require(_amount >= 10e9, "Minimum 10 need");
    ...
    function airdrop(address _address, uint _amount) external onlyAdmin{
