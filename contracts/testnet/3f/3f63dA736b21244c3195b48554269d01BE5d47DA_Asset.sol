...
// 资产托管
contract Asset is IAsset, IERC721Receiver, Caller, Fallback {
    bytes4 private constant onERC721Received_ = 0x150b7a02;
    ...
    function claimMainOrERC20(
        ...
        TransferV1.transfer_(token, to, amount);
    }
