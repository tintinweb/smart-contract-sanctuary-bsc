...
contract TOURReferral is Referral, SafeOwnable {
    using SafeERC20 for IERC20;
    uint public bindReward;
    IERC20 public USDTToken;
    ITOURToken public TOURToken;
    ...
    constructor() {
        ...
        TOURToken = ITOURToken(0x9f187fda337938AF8867e6bf2Ec9323e0F3718FA);
    }
    ...
    function setReferrer(address _referrer) public override {
        ...
        if (bindReward > 0) {
            TOURToken.mint(msg.sender, bindReward);
        }
    }
