...
contract Storm is ERC20, Ownable {
    ...
    address public _teamWalletAddress = address(0x73856E2416335D667046752faBd5211Ec1dcA17b); // Team Wallet
    address public _projectWalletAddress = address(0x73856E2416335D667046752faBd5211Ec1dcA17b); //Project Wallet
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "SMC: The router already has that address");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "SMC: Automated market maker pair is already set to that value");
