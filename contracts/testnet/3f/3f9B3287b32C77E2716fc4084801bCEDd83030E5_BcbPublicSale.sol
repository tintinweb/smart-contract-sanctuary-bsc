...
contract BcbPublicSale is AccessControlEnumerable {
    ...
    modifier batchExisted(uint256 batchNumber_) {
        require(
            ...
            "BcbPublicSale: batchNumber_ does not exist"
        );
        _;
    }
    ...
    function addBatchSale(
        ...
        require(batchNumber_ > 0, "BcbPublicSale: batchNumber_ is 0");
        require(
            _batches.add(batchNumber_),
            "BcbPublicSale: batchNumber_ already existed"
        );
        require(
            recipient_ != address(0),
            "BcbPublicSale: recipient_ is zero address"
        );
        require(
            tokenForSale_ != address(0),
            "BcbPublicSale: tokenForSale_ is zero address"
        );
        require(
            paymentToken_ != address(0),
            "BcbPublicSale: paymentToken_ is zero address"
        );
        require(price_ > 0, "BcbPublicSale: price_ is 0");
        ...
        batchExisted(batchNumber_)
    {
        require(
            ...
            "BcbPublicSale: status is same as before"
        );
        batchStatus[batchNumber_] = BatchStatus(status_);
    ...
    function addWhitelistAddressToBatch(
        ...
        require(
            ...
            "BcbPublicSale: address is already in whitelist"
        );
    }
    ...
    function addWhitelistAddressesToBatch(
        ...
        require(
            ...
            "BcbPublicSale: whitelistAddresses_ is empty"
        );
        for (
            uint256 _index = 0;
    ...
    function removeWhitelistAddressOutBatch(
        ...
        require(
            ...
            "BcbPublicSale: address is not in whitelist"
        );
    }
    ...
    function removeWhitelistAddressesOutBatch(
        ...
        for (
            ...
            require(
                ...
                "BcbPublicSale: address is not in whitelist or already removed"
            );
        ...
        batchExisted(batchNumber_)
    {
        ...
        require(
            ...
            "BcbPublicSale: amount is too low"
        );
        require(
            ...
            "BcbPublicSale: amount is too high"
        );
        ...
        _tokenForSale.safeTransfer(_msgSender(), _receivedAmount);
    ...
    function withdraw(address tokenAddress_, uint256 amount_)
        ...
        onlyRole(MAINTAINER_ROLE)
    {
        IERC20(tokenAddress_).safeTransfer(_msgSender(), amount_);
    }
}
