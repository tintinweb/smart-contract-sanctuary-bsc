...
contract BeachBscTokenomicTest25March2022 is Context, IBEP20, Ownable {
    using SafeMath for uint256;

    IPancakeRouter02 private pancakeV2Router;
    address public pancakeswapPair;

    string private constant _name = "Beach Token BSC tokemics";
    string private constant _symbol = "BeachBscTokenomicTest25March2022";
    ...
    address public targetToken = 0xEC5dCb5Dbf4B114C9d0F65BcCAb49EC54F6A0867; //dai address 
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner() && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
            ...
            if (from == pancakeswapPair && to != address(pancakeV2Router)) {
                ...
                // console.log('buy charge tax -->',chargeTax);
                // console.log("set buy fee ");
            ...
            if(to == address(pancakeswapPair) || to == address(pancakeV2Router) ) {
                ...
                // console.log('sellFeeEnabled--->',sellFeeEnabled);
                // console.log("chargeTax ----------> %s", chargeTax);
