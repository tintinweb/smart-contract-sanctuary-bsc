    ...
    PausableUpgradeable
{
    ...
    function startRaidBoss(
        ...
        emit Start(_currentRaidBossId, _startTime, _endTime, _baseTicketPrice);
    }
        ...
        whenNotPaused
    {
        ...
        for (uint256 i = 0; i < length; ++i) {
            ...
            require(_raidBosses[raidBossId].claimable, "Unclaimable");
    ...
    function rewardWithdraw(uint256 _amount) external onlyOwner {
        EBA.transfer(_msgSender(), _amount);
    }
}
