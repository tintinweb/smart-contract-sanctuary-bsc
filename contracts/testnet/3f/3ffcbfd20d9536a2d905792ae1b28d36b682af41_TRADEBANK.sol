...
contract TRADEBANK  is ERC20 {

    using SafeMath for uint256;
	using SafeERC20 for IERC20;
	IUniswapV2Router02 public tradeSwapRouter;
	...
	address trade_TOKEN= 0xBE420C673726c919abAD2029B0DcEA4b8494a810;
	...
	constructor()  {
      ...
      //BUSD = IERC20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
		...
		IUniswapV2Router02 _tradeSwapRouter = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // testnet
		tradeSwapRouter = _tradeSwapRouter;
	...
	function invest(uint8 plan ,uint256 _amount) external payable {
      ...
      //  add_liquidity(BUSD_LIQUDITY,amount);
	    ...
	    ///tradeSwapRouter.swapExactETHForTokens{value: msg.value}(0, path, to, deadline);
    ...
    function buy_token(uint256 tokenAmount) private{
		...
		_approve(address(this), address(tradeSwapRouter), tokenAmount);

		tradeSwapRouter.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            tokenAmount,
      ...
      function add_liquidity(uint256 tokenAmount,uint256 amount) private{
		...
		_approve(address(this), address(tradeSwapRouter), tokenAmount);
	     ...
	     tradeSwapRouter.addLiquidityETH{value: tokenAmount}(
                0xcea9ec6BB80EC3520E6Ad148820B967d66AAED05,
                tokenAmount/amount,
                0,
                0,
