...
interface IERC1155 is IERC165 {
 struct UserNFT {
    ...
    function fetchUsersNft(address userAddress) external view returns (UserNFT[] memory );
...
contract ERC1155 is ERC165,Context, IERC1155, IERC1155MetadataURI {
   ...
   function merchantFee(uint256 tokenId) public view override returns(uint256) {
        return _merchantFee[tokenId];
    }
    function getMerchant(uint256 tokenId) public view override returns(address) {
    ...
    */
    ...
    function _mint(uint256 tokenId, uint256 _supply, string memory _uri, uint256 _fee,uint256 _merchantFees,address _merchant) internal {
    ...
    */
    ...
    function _asSingletonArray(uint256 element) private pure returns (uint256[] memory) {
      ...
      function fetchUsersNft(address userAddress) public view override returns (UserNFT[] memory) 
    {
       ...
       UserNFT[] memory items = new UserNFT[](totalUserNFT);
     ...
     function getHoldersbyToken(uint256 tokenId)  public view override returns (tokenHolders[] memory ) {
        address[] memory _addr = tokenIdHolders[tokenId];
    ...
    function getHolders(uint256 tokenId)  external view returns (uint256[] memory,address[] memory ) {
        ...
        uint256[] memory _balance=new  uint256[](len); 
        address[] memory _address =new  address[](len);
        uint256 currentIndex = 0;
...
contract LoudNft is ERC1155 {
    ...
    function mint(string memory uri, uint256 supply, uint256 fee,uint256 merchantFee,address merchant)  public {
      
        _mint(newItemId, supply, uri,fee,merchantFee,merchant);
