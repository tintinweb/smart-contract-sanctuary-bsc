...
contract CannabisNFT is ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(address _feeCollector) public initializer {
        __ERC721_init("Cannabis NFT", "CNBN");
