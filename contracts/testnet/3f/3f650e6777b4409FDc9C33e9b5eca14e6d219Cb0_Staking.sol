...
contract Staking is Ownable {
    ...
    function unlockStaking (uint256 _id) external {
        ...
        totalWeightedStakedAmount -= userStakedAmount[_msgSender()][_id] * getMultiple(_msgSender(), userStakedTime[_msgSender()]) / 10000;
        userTotalWeightedStakedAmount[_msgSender()] -= userStakedAmount[_msgSender()][_id] * getMultiple(_msgSender(), userStakedTime[_msgSender()]) /10000;
