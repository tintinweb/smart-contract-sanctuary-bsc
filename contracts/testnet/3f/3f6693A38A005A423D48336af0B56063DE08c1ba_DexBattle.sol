...
contract DexBattle is ERC1155, Ownable, Pausable, ERC1155Supply {
    ...
    uint256 public Legendary_items_cost = 0.01 ether;
    uint256 public Epic_items_cost = 0.004 ether;
    uint256 public Rare_items_cost = 0.003 ether;
    uint256 public Uncommon_items_cost = 0.002 ether;
    uint256 public Common_items_cost = 0.001 ether;
