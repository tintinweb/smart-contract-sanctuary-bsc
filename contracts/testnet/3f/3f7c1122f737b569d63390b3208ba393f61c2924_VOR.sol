...
contract VOR is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //0x25232F28f0860f4C6F6384c3aE2AB587c6376Cc8
    address payable public marketingAddress =
        payable(0x4FAd5B36b2c20CD0b0103EEea620e4457000b72D); // Marketing Address
    ...
    string private _name = "VORTICES";
    string private _symbol = "VOR";
    ...
    uint256 public _taxFee = 0; //marketing+liquidity
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _liquidityFee = 0;
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public _buyTaxFee = 0; //marketing+liquidity
    uint256 public _buyLiquidityFee = 0;

    uint256 public _sellTaxFee = 0; //marketing+liquidity
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 ethAmount = transferredBalance.div(100).mul(_liquidityFee);
        if (LiquifyEnabled) {
