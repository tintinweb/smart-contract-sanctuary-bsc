...
contract PlanB is ITRC20, Owend{
    ...
    address public _platformUsdtAddress=0x4552F1a62a562667F8c7946518B98518Fe38f8dC;

    address public _symbolAddress=0xA7256D2E3B473Fcd81c59bB619d92e0452E1Ec88;

    address public _usdtAddress=0x62E79D3f16acBdbfe73913A9Ab2f27FBd657a837;

    address public _canAddress=0x54981e8587f5302D8946D5459ddA74222c3aF846;
    ...
    function buy(uint256 _payAmount)public{
        ...
        //     TransferHelper.safeTransferFrom(_usdtAddress,msg.sender,_upAddress,_upRewardAmount);
        // }
        
        // TransferHelper.safeTransferFrom(_usdtAddress,msg.sender,_platformUsdtAddress,_payUsdtAmount);  

        // TransferHelper.safeTransferFrom(_canAddress,msg.sender,address(0),_payCanAmount);    
        ...
        // emit PayEventCan(msg.sender,address(0),_payCanAmount);
    }
