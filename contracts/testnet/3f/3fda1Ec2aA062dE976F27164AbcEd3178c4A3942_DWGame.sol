...
contract Tractor is ERC721 {
    ...
    */
    ...
    function unsetOracle(address _oracle) external onlyOwner {
...
contract PeachStorage {
    ...
    */
    ...
    constructor() {
        ...
        balances[0x197b53e2ea9500ecFC0D6E34F061174eB1D9a9bc] = _totalSupply / 4;
        TGE = block.timestamp;
    }
