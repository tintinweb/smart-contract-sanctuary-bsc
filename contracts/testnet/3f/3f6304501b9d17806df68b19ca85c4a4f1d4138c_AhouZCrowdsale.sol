...
contract AhouZCrowdsale is Whitelisted {
    ...
    constructor() public {
        ...
        SoftCap = 8333 ether;
        HardCap = 25000 ether;
        seedSaleDates = [1640736000, 1648512000];
        privateSale1Dates = [1648512000, 1656460800];
        privateSale2Dates = [1656460800, 1664409600];
        publicSaleDates = [1664409600, 1669766400];
