...
/*
    ...
    ⚽️#Footballinu ⚽️Pre-Sale Soon
    Footballinu is a P2E 3D multiplayer football metaverse that joins billions of football enthusiasts in a 
    community where you can develop your NFT football avatar, manage your own club or arena, build fanbase, 
    attract sponsorships and earn real income

    🎮#Play & #Develop your FootballPlayer
    Unique NFT tokens, Play amateur or pro, Earn through wins, Upgradable through play, Get sponsorship and 
    branding deals, Build a fanbase

    🏌️Become a #club owner
    Earn through league wins, Brand the club, Sell merchandise, Recruit top players, Attract sponsorship 
    deals/partnershipsGrow the fanbase

    🏟Manage your own #arena
    Generate passive income from games, Rent space for practiceSell merchandise ad space, Upgrade facilities
    for more revenueReal-world football arenas sponsorships, Sell sponsored consumables

    🌆🖼 #NFT Marketplace
    In-game avatars will be NFT. All avatars will be exclusive and unique to their owner. Do you want to become 
    a legend with in-game achievements and our unique item collections? We welcome you to the unique NFT 
    Marketplace of the Footbalinu.

    In addition, a special NFT collection for football fans will be created for legendary football players.
    (The income from this will be used for project development)
    Our NFT sales and game beta will launch with a big Youtube deal. Our Legends special NFT sales will start 
    earlier and revenue will be generated for our marketing efforts.

    🌍Web           : https://www.Footballinu.io
    🔎Telegram      : t.me/Footballinu
    🕊Twitter        : twitter.com/Footballinu
    🖼️Instagram     : https://www.instagram.com/FootballinuBSC/
    🎮Discord       : https://discord.gg/xrDqkZ2tUJ
    🎦Youtube       : https://www.youtube.com/channel/UC8p2t07AKQixwWSZNlGlPnw/about
    📺Twitch        : https://www.twitch.tv/footballinu
    🎄Linktree      : https://linktr.ee/Footballinu
...
contract Footballinu is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Footballinu";
