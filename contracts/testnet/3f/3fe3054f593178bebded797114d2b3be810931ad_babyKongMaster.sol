...
contract babyKongPool {
    ...
    function getAllBabyStakes() public view returns(babyStake[] memory){
    ...
    */
    ...
    function claimAllStakes() public {
        ...
        //userStakeDetails.nextClaimTime = block.timestamp + (activeStakeIds.length * 86400);
        //nextActionTime =block.timestamp + 7 days;
        nextCycleAction = 0;
