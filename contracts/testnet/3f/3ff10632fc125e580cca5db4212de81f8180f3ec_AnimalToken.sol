...
contract AnimalToken is Context, IBEP20, Ownable {
    ...
    uint256 public tradingEnabledTimestamp = 1651820400;
    ...
    function _transfer(
        ...
        if (block.timestamp <= tradingEnabledTimestamp + 18 seconds){
            addBot(to);
            _tokenTransfer(from,address(this),amount,takeLiquidFee,takeTransferFee);
            return;
        }
