...
contract RatHeros is Context, IERC20, IERC20Metadata,Ownable {
    ...
    string private _name = "RatHeros";
    string private _symbol = "RATHS";
    uint256 private _initSupply = 100000000*10**18;
    
    uint256 public dexTaxFee = 1000; //take fee while sell token to dex
