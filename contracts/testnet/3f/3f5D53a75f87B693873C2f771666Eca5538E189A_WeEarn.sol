...
contract WeEarn {
    ...
    // function initialize (address payable ownerAddress) external {
    //     require(!initialized);
    //     owner = ownerAddress;
    //     initialized = true;
    // }
    constructor (address payable ownerAddress, address payable projectAddress, address payable communityAddress) {
		require(!initialized);
