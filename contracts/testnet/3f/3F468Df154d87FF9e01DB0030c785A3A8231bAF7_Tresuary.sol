...
contract Tresuary is ITresuary, Ownable { 
    ...
    function updateStakingToken(address _stakingToken) external onlyOwnerOrDeployer{
        stakingToken = IERC20(_stakingToken);
     ...
     */
    function withdrawToken(address token, address account, uint256 amount) external onlyOwnerOrDeployer {
