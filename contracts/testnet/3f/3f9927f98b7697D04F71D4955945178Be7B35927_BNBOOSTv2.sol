...
contract BNBOOSTv2 is Ownable, Pausable, ReentrancyGuard {
    ...
    function withdraw(
        ...
        require(!signatureUsed[_signature], "Signature already used");
        require(_user != address(0), "Invalid address");
        require(verifySignature(_amount, _user, _deadline, _signature), "Invalid signature");
