...
contract GFarmTradingStorageV5 {
    ...
    modifier onlyTrading(){ require((isTradingContract[msg.sender] && token.hasRole(MINTER_ROLE, msg.sender)) || msg.sender == gov); _; }
    ...
    function handleDevGovFees(uint _pairIndex, uint _leveragedPositionSize, bool _dai, bool _fullFee) external returns(uint fee){
        ...
        // fee == 2000000000000000000000 * 300000000 / 18 / 100 == 3,3333333333e26
