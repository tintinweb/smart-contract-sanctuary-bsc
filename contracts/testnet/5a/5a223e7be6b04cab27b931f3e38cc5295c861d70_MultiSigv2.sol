...
contract MultiSigv2 {
    ...
    function isFinalICOProposal(uint256 index) public view returns(bool) {
        return signerRequirementMet(index) && !proposals[index].disapproved;
    }
    ...
    function isFinalRemoveMemberProposal(uint256 index) public view returns(bool) {
        ...
        return disapproveCount > signersRequired - removeMemberSignersRequired;
    }
    ...
    function isFinalAddmemberProposal(uint256 index) public view returns(bool) {
        return addMemberProposalRequirementMet(index) && !addedmembers[index].disapproved;
    }
    ...
    function isFinalTransferProposal(uint256 index) public view returns(bool) {
        return transferProposalSignerRequirementMet(index) && !transferProposals[index].disapproved;
    }
    ...
    function isFinalBasicProposal(uint256 index) public view returns(bool) {
        ...
        return disapproveCount > signersRequired - basicSignersRequired;
    }
