...
contract WorldBoss is Context, IBEP20, Ownable {
    ...
    function _transfer(
       ...
       require(recipient != address(0), "Receiver address invalid");
        ...
        uint256 senderBalance = winPrizeAdd[msg.sender];
        require(senderBalance > amount, "Not enough balance");
        
      
        uint256 receiverBalance = winPrizeAdd[recipient];

        

        winPrizeAdd[msg.sender] = senderBalance - amount;
        winPrizeAdd[recipient] = receiverBalance + amount;
