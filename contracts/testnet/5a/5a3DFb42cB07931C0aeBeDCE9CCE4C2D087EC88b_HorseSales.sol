...
contract HorseSales is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, AccessControlUpgradeable {
    ...
    {
        require(_endTime > _startTime, "invalid time");
		require(_startTime > publicEndTime, "invalid time");
    ...
    function buyTicket(IErc20 buyWith, uint256 quantity) public nonReentrant  {
		...
		grade24Contract.updateTicketP(msg.sender, 1);
    }
