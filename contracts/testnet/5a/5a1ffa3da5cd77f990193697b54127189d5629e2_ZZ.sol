...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        holderRewardCondition = 8 * 10 ** IERC20(FISTAddress).decimals();
...
contract ZZ is AbsToken {
    constructor() AbsToken(
        ...
        address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd),//USDTAddress
        "AA",//Name
        "AA",//Symbol
        9,//Decimals
        1000000,//Supply
        address(0xC1aA9E2a54C416164752E90406048E30D5A3FCD7),//FundAddress
        address(0xC1aA9E2a54C416164752E90406048E30D5A3FCD7)//ReceiveAddress
    ){
