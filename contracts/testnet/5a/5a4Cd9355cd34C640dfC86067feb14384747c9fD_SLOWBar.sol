...
// SLOWBar is the coolest bar in town. You come in with some POPS, and leave with more! The longer you stay, the more POPS you get.
//
// This contract handles swapping to and from sPOPS, POPSSwap's staking token.

//SushiBar
contract SLOWBar is ERC20("sPOPS", "sPOPS"){
