...
contract Owned is Initializable {
  ...
  function _Owned_init() public initializer {
    owner = msg.sender;
  }
...
contract TokenBEP20 is Initializable, BEP20Interface, Owned {
 ...
 function _TokenBEP20_init() public initializer {
    _Owned_init();
    symbol = "DUSD";
    name = "DUSD Network";
    decimals = 18;
...
contract DusdNetwork is Initializable, TokenBEP20 {
