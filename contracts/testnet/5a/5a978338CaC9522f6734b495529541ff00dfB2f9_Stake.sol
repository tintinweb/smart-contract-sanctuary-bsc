...
contract Stake is Initializable, OwnableUpgradeable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(address _stakingToken, address _rewardsToken) initializer external {
        __Ownable_init();
        __UUPSUpgradeable_init();
        __Stake_init(_stakingToken, _rewardsToken);
    }

    function __Stake_init(address _stakingToken, address _rewardsToken) internal initializer {
