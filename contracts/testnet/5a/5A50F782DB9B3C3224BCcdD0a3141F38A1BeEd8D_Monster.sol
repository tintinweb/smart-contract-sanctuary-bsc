...
contract Monster is Ownable  {
    ...
    // 战斗
    function fighting(uint256 tkId,uint256 enemyId,address addr) public   isFullHp(tkId) returns(bool,uint256,uint256,uint256,uint256){
        ...
        emit Test(_figInfo.isSuccess,randNumber,_figInfo.totalSuc);
        // 判断是否胜利
