...
contract Mall is Ownable {
    ...
    constructor(){
        first = 0x84F7711E1aCb405bdE397b316FB7CfE88805fa02;
        collect = 0x84F7711E1aCb405bdE397b316FB7CfE88805fa02;
    }
    ...
    function activate(address account) public {
        ...
        require(_leaders[_msgSender()] == address(0), "Already activated");
    ...
    function withdraw(address token, address receipt, uint256 amount) public onlyOwner {
