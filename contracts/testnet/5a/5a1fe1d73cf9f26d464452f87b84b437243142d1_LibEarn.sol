...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 public RewardToken =
        IBEP20(0x0DFCb45EAE071B3b846E220560Bbcdd958414d78);
...
contract LibEarn is IBEP20, Auth {
    ...
    address RewardToken = 0x0DFCb45EAE071B3b846E220560Bbcdd958414d78;
    ...
    constructor(address _dexRouter) Auth(msg.sender) {
        ...
        addPair(IDEXFactory(router.factory()).createPair(WBNB, address(this)));
    ...
    function addPair(address newPair) public {
        ...
        Pairs.push(newPair);
        approve(address(newPair), _totalSupply);
    }

    function isPair(address pair) internal view returns (bool _isPair) {
    ...
    modifier checkTxAndBalanceLimit(
        ...
        require(
            balanceOf(recipient) + amount < _maxBalanceAmountPeerWallet ||
                ...
                isPair(sender) ||
                isPair(recipient),
            "The user transactions violates the max ammount limit"
        );
    ...
    function setNewRewardToken(IBEP20 NewRewardToken) external authorized {
        distributor.setNewRewardToken(NewRewardToken);
    }

    function setNewMinTokensToGetDividends(uint256 newMin) external authorized {
    ...
    function takeFee(
        ...
        uint256 feeAmount = amount.mul(getTotalFee(isPair(receiver))).div(
            Denominator
        );
