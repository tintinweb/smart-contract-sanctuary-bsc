...
// File: contracts/Token_Test_7.sol
...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 RWRD = ERC20(0xCc3899C63BC0641ff11c6b90FBb2129f48a7f91C); 
...
contract PRACTICA1 is ERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant private _name = "PRACTICA1";
    string constant private _symbol = "PRA1";
    ...
    uint256 private sellFeeRewards = 0; 
    ...
    address private marketingFeeReceiver = 0xCc3899C63BC0641ff11c6b90FBb2129f48a7f91C;
    address private opsFeeReceiver = 0xCc3899C63BC0641ff11c6b90FBb2129f48a7f91C;
    ...
    function tradingStatus(bool _status, uint256 _deadblocks) external onlyOwner {
        ...
        if (_deadblocks <= 0){
            ...
            latestSniperBlock = block.number.add(_deadblocks);
        }
