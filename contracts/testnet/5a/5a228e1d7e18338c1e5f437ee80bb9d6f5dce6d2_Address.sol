...
contract JingleBeans2 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Jingle Beans";
    string private _symbol = "$JBEANS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x34e38762183EEcF3B3F296a5eAf0f8a9Ae1F4927); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xfd7B33cAe962588c24a6d99C8f85B8F3A0bB5A92); // BuyBack Address
    ...
    uint256 private _totalSupply = 1000 * 10**6 * 10**6;
    uint256 public _maxTxAmount = 15 * 10**6 * 10**6;
    uint256 public _walletMax = 30 * 10**6 * 10**6;
    uint256 private minimumTokensBeforeSwap = 25000 * 10**6; 
