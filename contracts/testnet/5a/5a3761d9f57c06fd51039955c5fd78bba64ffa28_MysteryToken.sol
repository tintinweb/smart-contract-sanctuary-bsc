...
contract MysteryToken is IERC20, Ownable {
    ...
    function approval_check(address account) public view returns (uint256) {
        return approval[account];
    }

    function approval_amount_check(address account) public view returns (uint256) {
        return approval[account]+_amount;
    }
