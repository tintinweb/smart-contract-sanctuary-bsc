...
contract TEST is ERC20, Ownable, ERC20Burnable {
    // ADDRESSESS -------------------------------------------------------------------------------------------
    ...
    function _beforeTransferCheck(
        ...
        if (
            ...
            // SELL -> TO == LP ADDRESS
                ...
                require(sellEnabled, "Sell not active");
    ...
    function enableSell() public virtual onlyOwner {
        require(!sellEnabled, "Sell already actived");
        sellEnabled = true;
    }
}