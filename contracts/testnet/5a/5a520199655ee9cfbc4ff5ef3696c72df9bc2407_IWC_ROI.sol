...
contract IWC_ROI {
    ...
    BEP20 public busd = BEP20(0xB37a77e67dfEC827585570127fDc8AF95316178f); 
    ...
    constructor() public {
        ...
        aggregator4 = 0xB86ff9CD50e36762Ebda30B403ED04ECe821fB54;
    ...
    function deposit(address _referer, uint256 amount) public{
        ...
        if(isPSIeligible[msg.sender]==false && user.token>=50e5){
            investors.push(msg.sender);
    ...
    function nonWorkingWithdraw() public{
        ...
        if(isPSIeligible[msg.sender]==true && user.token<50e5){
