...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Test", "ABS") {

        address _owner = 0xB67e54EEdcAeF21E185D50De424eD23C9Ef4a563;
        safuDevAddress = _msgSender();

        _decimals = 9;

        uint256 totalSupply = 1 * 1e16 * (10**_decimals);
        ...
        buyPortfolioFee = 10;
        buyburnFee = 1;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyMaintenanceFee + buyPortfolioFee +buyburnFee;
        ...
        sellPortfolioFee = 10;
        sellburnFee = 1;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellMaintenanceFee + sellPortfolioFee +sellburnFee;

        marketingWallet = address(0xB67e54EEdcAeF21E185D50De424eD23C9Ef4a563); // set as marketing wallet
    	maintenanceWallet = address(0xB67e54EEdcAeF21E185D50De424eD23C9Ef4a563); // set as maintenance wallet
    	portfolioWallet = address(0x7F394957A1Dd298f00d48226411e3088170241bb); // set as portfolioWallet
