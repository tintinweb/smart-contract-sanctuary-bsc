...
contract Watch_Ai is ERC20, Ownable {
    ...
    bool public blacklistearlybuyer = true; 
    ...
    uint256 private antiBotBlocks = 20;
    ...
    function setSwapEnabled(bool _enabled) external onlyOwner {
        ...
        function setEarlybuyersetting(bool _enabled) external onlyOwner {
        blacklistearlybuyer = _enabled;
    }
    ...
    function setMinBalanceForDividends(uint256 amount) external onlyOwner {
     ...
     function Enable_Blacklist_Mode(bool _status) external onlyOwner {
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFees[from] && !_isExcludedFromFees[to]) {
           ...
           if (!automatedMarketMakerPairs[to]) {
            ...
            if(blacklistearlybuyer){
                 if (block.number <= startTradingBlock + antiBotBlocks){
