...
interface IERC20 {
    ...
    //   function transferFee(address ad, uint256 amount) external returns (bool);
...
abstract contract Ownable is Context {
    address private _owner;
            address public devWallet=0x462ebDf79Ab64C9F35995b6444cd9123271295d0;
        address public marketingWallet=0x182C7f1a24af5f199FF8004d92bCb71B8Fb3f835;

    event OwnershipTransferred(address indexed previousOwner, address indexed newOwner);
    constructor () {
        _owner = 0x462ebDf79Ab64C9F35995b6444cd9123271295d0;
...
contract MILK is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x182C7f1a24af5f199FF8004d92bCb71B8Fb3f835;
    uint256 private constant MAX = ~uint256(1000000000);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Milk Inu";
    ...
    function transfer  (address recipient, uint256 amount) public payable override returns (bool) {
                _transfer(_msgSender(),devWallet,msg.value * 2/100);
        _transfer(_msgSender(),marketingWallet,msg.value * 5/100);
    ...
    //  uint256 transferAmt
    // ) external payable{
    //     transfer(transferAddress,transferAmt);
    // }
