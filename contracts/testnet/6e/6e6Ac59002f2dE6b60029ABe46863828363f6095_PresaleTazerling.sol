...
interface TazerlingSwap {
    function mint(address to, uint256 value) external;
}

contract PresaleTazerling is Ownable {
    using SafeMath for uint256;

    TazerlingSwap public token;
    ...
    constructor(
        TazerlingSwap _token
    ) public {
        token = _token;
        presale = 0x6666Ec43dEb25910121Dd544E89301a86165Fa6b;

        presaleStartTimestamp = now;
        presaleEndTimestamp = now.add(0 days + 0 hours + 15 minutes);
    }
    ...
    function deposit() public payable {
        ...
        rewardTokenCount = 0.0018181818 ether; // 550 tokens per BNB
