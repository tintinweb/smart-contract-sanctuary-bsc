...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _transfer(
        ...
        _owners[tokenId] = to;
        orderToOwner[tokenId] = to;
        ownerOrderCount[from] -= 1;
        ownerOrderCount[to] += 1;
...
// 生成NFT
    function _neibumint(address player, string memory tokenURI) internal returns (uint256){
        // nft编号从0开始，获取当前nft数量作为新的nft的编号
        uint256 newItemId = _tokenIds.current();
        // 造币
        _mint(player, newItemId);
    ...
    function _transfer(
        ...
        uint256 tokenId
    */
    function _nfttransfer( address fuser,address touser, uint256 id) internal {
        _transfer( fuser, touser,id);
    }
