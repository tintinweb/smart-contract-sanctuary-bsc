...
contract NATION0x is BEP20, LockToken {
    using SafeMath for uint256;
    ...
    NATION0xDividendTracker public dividendTracker;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;

    address public immutable BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD

    uint256 public _totalSupply = 18_000_000 * (10**18);
    uint256 public swapTokensAtAmount = 100_00 * (10**18); //10 mil
    ...
    address payable public _marketingWalletAddress = payable(0xaf34b77B25289a3b8700eF363d0AB568BE01456c);
    address payable public _buybackWalletAddress = payable(0x66412478f0f0b435511a2E5B7fbBBC35006fEd23);
    ...
    constructor() BEP20("NATION 0x", "N0X") 
    {
        dividendTracker = new NATION0xDividendTracker();
    ...
    {
        require(newAddress != address(dividendTracker), "NATION0x: The dividend tracker already has that address");
        NATION0xDividendTracker newDividendTracker = NATION0xDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "NATION0x: The new dividend tracker must be owned by the NATION0x token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "NATION0x: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "NATION0x: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "NATION0x: The PanBUSDSwap pair cannot be removed from automatedMarketMakerPairs");
        _setAutomatedMarketMakerPair(pair, value);
    }
    

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "NATION0x: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "NATION0x: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "NATION0x: Cannot update gasForProcessing to same value");
...
contract NATION0xDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() DividendPayingToken("NATION0x_Dividend_Tracker", "NATION0x_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 2000_000 * (10**18); //must hold 2 Millions+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "NATION0x_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "NATION0x_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main NATION0x contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "NATION0x_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "NATION0x_Dividend_Tracker: Cannot update claimWait to same value");
