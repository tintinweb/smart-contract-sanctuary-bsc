...
contract testNeoTech is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress = payable(0x15e475271B1Aae171AAA6Ca5ed4cF7263617f562); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x000000000000000000000000000000000000dEaD); // Marketing Wallet Address
    address payable public buybackandburnWalletAddress = payable(0x15e475271B1Aae171AAA6Ca5ed4cF7263617f562); // BuyBackAndBurn Wallet Address
    address payable public devWalletAddress = payable(0x15e475271B1Aae171AAA6Ca5ed4cF7263617f562); // dev Wallet Address
    ...
    string private constant _name = "testNeoTechFuture";
    ...
    uint256 private _previousBuyBackAndBurnFee = _buybackandburnFee;

    uint256 public totalSwapableFee = _liquidityFee + _devFee + _marketingFee + _buybackandburnFee + _reserveFee;

    uint256 _saleTaxFee = 5;
    uint256 _saleLiquidityFee = 0;
    uint256 _saleReserveFee = 0;
    uint256 _saleDevFee = 2;
    uint256 _saleMarketingFee = 1;
    uint256 _saleBuyBackAndBurnFee = 2;

    uint256 public totalSwapableSaleFee = _saleTaxFee + _saleLiquidityFee + _saleDevFee + _saleMarketingFee + _saleBuyBackAndBurnFee + _saleReserveFee;
    ...
    uint256 public buybackandburnTokensCollected = 0;
    ...
    constructor () {
        address _owner = 0x15e475271B1Aae171AAA6Ca5ed4cF7263617f562;
    ...
    {   
        ...
        uint256 walletsTotal = devTokensCollected + marketingTokensCollected + buybackandburnTokensCollected + reserveTokensCollected;
        ...
        uint256 ethForBuyBackAndBurn = (newBalance * buybackandburnTokensCollected)/walletsTotal;
        ...
        transferToAddressETH(buybackandburnWalletAddress, ethForBuyBackAndBurn);
        ...
        buybackandburnTokensCollected = 0;
    ...
    function setSaleFee() private {
        ...
        _buybackandburnFee = _saleBuyBackAndBurnFee;
        totalSwapableFee = _liquidityFee + _devFee + _marketingFee + _buybackandburnFee; 
    }
    ...
    function countUpFeeShare(uint256 amount) private
    {
        ...
        buybackandburnTokensCollected += (amount * _buybackandburnFee)/100;
    }
    ...
    function restoreAllFee() private {
        ...
        _buybackandburnFee = _previousBuyBackAndBurnFee;
        totalSwapableFee = _liquidityFee + _devFee + _marketingFee + _buybackandburnFee;
    }
    ...
    function setBuyBackAndBurnWalletAddress(address _buybackandburnWallet) external onlyOwner() {
        require(_buybackandburnWallet != address(0), "setBuyBackAndBurnWalletAddress: ZERO");
        buybackandburnWalletAddress = payable(_buybackandburnWallet);
        emit AuditLog("We have Updated the BuyBackAndBurnWallet:", buybackandburnWalletAddress);
    }
