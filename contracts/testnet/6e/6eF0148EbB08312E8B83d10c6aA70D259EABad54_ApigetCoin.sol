...
contract ApigetCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        uint256[4] memory buyFeeSetting_, //dividend, liquidity, marketing, dead
    ...
    function recoverBNB() public onlyOwner {
        ...
        require(amount > 0, "No BNB available");       
        payable(msg.sender).transfer(amount);
    }

    function recoverBEP20(address tokenAddress, uint256 tokenAmount) public onlyOwner {
        require(tokenAddress != address(this), "Self withdraw");//not allow recovering self token
