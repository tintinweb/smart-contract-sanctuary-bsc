...
contract Token is ERC20, Ownable {
    ...
    event reserveWalletUpdated(address indexed newWallet, address indexed oldWallet);
    ...
    constructor() ERC20("Canine Master", "CM") {
        ...
        address _owner = 0xf363e34A855F9355d0e86E991Ec5A09e8B5EBa54;
        ...
        buyReserveFee = 2;
        buyBurnFee = 1;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyReserveFee + buyBurnFee;
        
        sellMarketingFee = 6;
        sellLiquidityFee = 0;
        sellReserveFee = 0;
        sellBurnFee = 1;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellReserveFee + sellBurnFee;

        marketingWallet = address(0x0f8c6dc591a8dDc3a9078513B493d3f47ACa53B1); // set as marketing wallet
    	reserveWallet = address(0x46F2e364a520982bb47a381AF52e31d8B3bd854A); // set as reserve wallet
    ...
    function updateReserveWallet(address newWallet) external onlyOwner {
        emit reserveWalletUpdated(newWallet, reserveWallet);
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketing + tokensForReserve + tokensForBurn;
        bool success;
        ...
        _swapTokensForBNB(amountToSwapForETH, address(this));
        super._transfer( address(this), deadAddress, burnTokens);
        
        uint256 ethBalance = address(this).balance.sub(initialETHBalance);
        
        uint256 ethForMarketing = ethBalance.mul(tokensForMarketing).div(totalTokensToSwap);
        uint256 ethForReserve = ethBalance.mul(tokensForReserve).div(totalTokensToSwap);
        
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForReserve;
        ...
        (success,) = address(reserveWallet).call{value: ethForReserve}("");
        
        if(liquidityTokens > 0 && ethForLiquidity > 0){
            _addLiquidityBusd(liquidityTokens, ethForLiquidity);
