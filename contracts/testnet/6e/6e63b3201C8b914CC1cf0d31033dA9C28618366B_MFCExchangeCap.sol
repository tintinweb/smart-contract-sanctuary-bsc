...
contract MFCExchangeCap is Treasury, BackendAgent, WithdrawAgent, ExchangeCheck {
  ...
  function _tradeOffer(uint256 quantity, uint256 price) private returns (uint256) {
    ...
    _mfc.transfer(_mfcLoanTreasuryAddress, takerFee);
    _mfcExchangeFloor.increaseMfcCirculation(buyQuantity);
