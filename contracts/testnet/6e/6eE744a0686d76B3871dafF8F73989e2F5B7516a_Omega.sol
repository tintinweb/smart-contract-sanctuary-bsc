...
contract Omega is ERC20 {
  ...
  function setNodeContract(address _omegaNodes) public{
    require(msg.sender == owner, 'You must be the owner to run this.');
    omegaNodes = _omegaNodes;
  }
  ...
  function mint(uint256 _amount) public {
    require(msg.sender == omegaNodes || msg.sender == owner, 'Can only be used by the Omega Protocol.');
