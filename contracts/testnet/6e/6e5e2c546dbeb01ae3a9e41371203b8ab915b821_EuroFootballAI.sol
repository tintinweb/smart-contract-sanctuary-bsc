...
contract EuroFootballAI is IERC20, Ownable {
    ...
    string _name = "EuroFootball AI";
    string _symbol = "EFBAI";
    ...
    uint256 _liquidityFeeSell, uint256 _reflectionFeeSell, uint256 _marketingFeeSell, uint256 _TeamFeeSell) external onlyOwner {
        ...
        require(totalFeeBuy < feeDenominator / 2, "Buy Fees can not be more than 50%"); 
        require(totalFeeSell < feeDenominator / 2, "Sell Fees can not be more than 50%"); 
