...
contract MockOracle is IOracle {
    ...
    function consult(address, uint256 _amountIn) public view override returns (uint144) {
        return uint144(price.mul(_amountIn).div(1e18));
    }

    function twap(address, uint256 _amountIn) public view override returns (uint144) {
        return uint144(price.mul(_amountIn).div(1e18));
    }

    function getPegPrice() external override view returns (int256) {
        return consult(address(0), 1e18);
    }

    function getPegPriceUpdated() external override view returns (int256) {
        return twap(address(0), 1e18);
    }
