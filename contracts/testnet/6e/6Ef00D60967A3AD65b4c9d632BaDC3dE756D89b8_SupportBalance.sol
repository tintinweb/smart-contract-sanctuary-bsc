...
contract SupportBalance {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // Info of each user.
    struct UserInfo {
        uint256 amount;   // How many BALANCESPLIT tokens the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws BALANCESPLIT tokens to a pool. Here's what happens:
    ...
    // Info of each user that stakes BALANCESplit tokens.
    ...
    // Deposit BALANCESplit tokens to SupportApe for Reward allocation.
    ...
    // Withdraw BALANCESplit tokens from SupportApe.
