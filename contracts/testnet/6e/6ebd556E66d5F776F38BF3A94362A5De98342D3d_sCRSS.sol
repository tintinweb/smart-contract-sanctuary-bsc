...
contract sCRSS is Ownable, IsCRSS {
    ...
    constructor(IERC20 _crssToken) {
        ...
        accountant = 0x66c8d4E8340d35A5b711fd4efE680268888aba6D;
    ...
    function leave(uint256 _amount) public override {
        ...
        if (priceImpactFeeIsOn) {
            ...
            _mint(impactFeeReceiver, _amount - impactAdjusted);
            //initial rate
    ...
    function _transfer(
        ...
        require(
            amount <= _maxTxAmount || _isExcludedFromFees[sender],
            "sCRSS:Exceeds max tx amount"
        );
        ...
        require(
            ...
            "sCRSS:Exceeds max wallet amount"
        );
...
contract DividendTracker is Ownable, IERC20 {
    ...
    constructor(address _crssAddress, address _sCrssAddress) {
        minTokenBalanceForDividends = 10000 * (10**18);
        crssToken = IERC20(_crssAddress);
        sCrssToken = IsCRSS(_sCrssAddress);
    }
