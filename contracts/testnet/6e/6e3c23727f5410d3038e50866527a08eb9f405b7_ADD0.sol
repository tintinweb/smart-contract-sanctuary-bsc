...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xA80B000aDecf9B9866dbC3Ae9015258548F0B1b2);
...
contract ADD0 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ADD0";
    string constant _symbol = "A0";
    ...
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    address RewardToken = 0xA80B000aDecf9B9866dbC3Ae9015258548F0B1b2;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xBB7796b0f9d2243D9153eC83C6CDC26A6A875bd3;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isKilled[recipient] && !isKilled[sender], "bot killed");
