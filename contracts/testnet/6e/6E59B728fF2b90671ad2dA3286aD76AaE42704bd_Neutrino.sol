...
pragma solidity ^0.8.0;
contract Neutrino is ERC20, Ownable {
    ...
    constructor() ERC20("Neutrino Project", "NRN") {
        _mint(msg.sender, 12000000*10**decimals());
        _mint(address(this), 1188000000*10**decimals());
        startSale(block.number, block.number+1215000, 0,4000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,block.number+1215000,1500*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 6;
    }
