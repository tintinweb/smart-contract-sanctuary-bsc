...
contract WlTst is IBEP20, Ownable {
...
//dynamicLiqEnabled = true will stop autoLP if targetLiquidityRatio is met   
    ...
    uint16 private targetLiquidityRatio = 85;
...
/////////////////////////////   EVENTS  /////////////////////////////////////////
    ...
    event EnableWhitelist(bool enabled);
    event AddedAccountWhitelist(address account, bool isWhitelisted);
...
///// AUTHORIZED FUNCTIONS /////
    ...
    function enableWhitelist(bool enabled) public authorized {
        whitelistEnabled = enabled;
        emit EnableWhitelist(enabled);
    }
    ...
    function setWhitelistStatus(address[] calldata addresses, bool status) public authorized {
        for (uint256 i=0; i < addresses.length; ++i) {
...
////// PUBLIC VIEW FUNCTIONS /////
    ...
    function getWhitelistinfo() public view returns (
...
/////////////////////////////   PRIVATE FUNCTIONS  /////////////////////////////////////////
    ...
    function _taxedTransfer(address sender, address recipient, uint256 amount,bool isBuy,bool isSell) private{
        ...
        if (isSell) {
            ...
            if (whitelistEnabled) {
                require(isWhitelisted[recipient], "user not whitelisted");
            }
