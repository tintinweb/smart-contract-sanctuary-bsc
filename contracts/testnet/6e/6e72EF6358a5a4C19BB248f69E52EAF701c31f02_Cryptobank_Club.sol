...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    function _transfer(
        ...
        require(!lockUsers[from],"BEP20 : Address is Locked");
...
// File: CryptoBankExchangeToken/Contract1/Cbank.sol


pragma solidity ^0.8.4;


contract Cryptobank_Club is BEP20, BEP20Burnable, Pausable, Ownable {
    constructor() BEP20("Cryptobank Club", "CTBC") {
    ...
    function SetLocked(address _user,bool _status) public onlyOwner{
        lockUsers[_user] = _status;
    }
