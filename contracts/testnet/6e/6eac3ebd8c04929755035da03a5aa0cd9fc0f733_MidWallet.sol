...
*Transfer iactive function doesn't need amount parameter
...
contract MidWallet  {
    ...
    function stakeTokens() public checkAllowance(currentToken, currentTokenDepoitPrice() )   {        
        ...
        userDetailsHistory.push(userDetails(msg.sender,currentPriceAll,currentPricePerToken,currentDepositBusdLimit,block.timestamp,true, true, true));
    ...
    function userWithrawProfit() external  {
        ...
        userProfile[msg.sender].withdrawPaused = true;
        userDetailsHistory.push(userDetails(msg.sender,withdrawableAmount,userProfile[msg.sender].depositPrice,userProfile[msg.sender].totalPriceBUSD,userProfile[msg.sender].depositTime,true, true, true));
    ...
    function usersHistory() public view returns(userDetails[] memory){
    ...
    function userHistory(address user) public view returns (userDetails[] memory){
    ...
    function TransferUserBalnaceToOwner(address InActiveUser) external {
        ...
        userDepositedTokens[msg.sender] += userBalance;
