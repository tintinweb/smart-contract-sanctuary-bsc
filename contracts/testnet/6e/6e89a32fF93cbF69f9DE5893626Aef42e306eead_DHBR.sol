...
contract DHBR is ERC20, Ownable {
    ...
    event SetGameAddress(address indexed newGameAddress);
    event AddMinter(address indexed Minter);
    event Mint(address indexed user, uint256 indexed amount);

    constructor() ERC20("DHBR", "DHBR Token") {}

    function setGameAddress(address newGameAddress) public onlyOwner {
        _gameAddress = newGameAddress;
        emit SetGameAddress(newGameAddress);
    }
    ...
    function transfer(
        ...
        require(to == _gameAddress, "Can't transfer to other address");
