...
contract InitialNFTOffering is Initializable, ERC721Holder {
    ...
    function initialize(
        ...
        require(_operator != address (0),"InitialNFTOffering: !zero");
        ...
        require(_times.length == 2 && _times[0] > block.timestamp && _times[0] < _times[1], "InitialNFTOffering: length not equal _tokens");
        if(_isLock) {
    ...
    function buy(uint _typeId, uint _amount) public checkTypeId(_typeId){
