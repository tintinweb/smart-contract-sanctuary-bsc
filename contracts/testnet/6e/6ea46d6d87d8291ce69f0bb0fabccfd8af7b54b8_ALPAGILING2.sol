...
contract ALPAGILING2 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "ALPA DI BAKAR 2";
    string constant _symbol = "$bAKAR2";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xB3621acC1ac07959962B50eE643C11783fC31FAc;  //marketingwallet
        anothermarketingWallet = 0xB3621acC1ac07959962B50eE643C11783fC31FAc; // dev wallet 
