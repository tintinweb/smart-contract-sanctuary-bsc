...
contract LSP is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lao Se PI";
    string private _symbol = "LSP";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6d7ee2136Ed220Cef6671618a0575974757C112F);
    address payable public teamWalletAddress = payable(0x41C04981e2b54C7F9be696de01Ae40A2C5Fa042d);
