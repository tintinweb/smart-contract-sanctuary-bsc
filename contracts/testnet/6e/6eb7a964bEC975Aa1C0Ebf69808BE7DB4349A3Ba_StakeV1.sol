...
contract Stake is Initializable,OwnableUpgradeable{
   ...
   // mapping (uint256=>uint256) TheDaysAllAmount;
    ...
    function setThetheStakeProjectTokenAmountByTheday(uint256 project,uint256 day,uint256 amount) public onlyOwner {
        ProjectInfor storage _projectinfor = getProjectInforByProjectId[project];
        _projectinfor.theStakeProjectTokenAmountByTheday[day]=amount;
    }
}
