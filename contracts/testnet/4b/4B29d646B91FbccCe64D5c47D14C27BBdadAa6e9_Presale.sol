    ...
    PausableUpgradeable
{
    ...
    uint256[4][2] public rounds; ////////////////--------------change number of rounds

    // uint256[4] public rounds[0];
    // uint256[4] public rounds[1];
    ...
    function initialize(
        ...
        maxTokensToBuy = 160_000_00000000;
        baseDecimals = (10**18);
        rounds = _rounds;

        // rounds[0] = [160_000_000, 280_000_000, 360_000_000, 400_000_000];
        // rounds[1] = [
    ...
    function ___length() public view returns(uint256){
        ...
        returns (uint256 totalValue)
    {
        ...
        if (_amount + totalTokensSold > rounds[0][currentStep]) {
            require(currentStep < (rounds[0].length -1), "Insufficient token amount.");
