...
contract TEST_CLASSIC_MINER {
    ...
    constructor() public{
        minerDev=msg.sender;
        minerAdmin=address(0xa16B0D11fbe73d02A4A5FDB59744f3E7928c80E0);
        minerAddress=address(0xbbC4aa6adE81F618d3bCfc349b36961aC26ecD9a);
        cminerAddress=address(0x0F04Abd6163482e91bc70EbbaA33fbeFd90B82cD);
    }
