...
contract OCEAN_FINANCE is ERC20Detailed, Ownable {
    ...
    address public blueholeaddress;
    ...
    constructor() ERC20Detailed("Ocean Finance", "OCEANS", uint8(DECIMALS)) Ownable() {
        ...
        blueholeaddress = 0x000000000000000000000000000000000000dEaD;
    ...
    function takeFee(
        ...
        if (recipient == pair) {
            ...
            _treasuryFee = treasuryFee.add(sell);
            _oceanDividendFee = oceanDividendFee.add(sell);
            _liquidityFee = liquidityFee.add(sell);
        }

        uint256 feeAmount = gonAmount.div(feeDenominator).mul(_totalFee);
       
        _gonBalances[blueholeaddress] = _gonBalances[blueholeaddress].add(
