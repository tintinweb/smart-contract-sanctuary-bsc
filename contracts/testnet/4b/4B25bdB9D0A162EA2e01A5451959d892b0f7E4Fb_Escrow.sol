...
contract Escrow {
 ...
 mapping(uint256 => Payment) private payments;
  ...
  constructor() {
     ...
     StriptoToken  = ERC20(0x65329C66933d8fE9BaA666dFEB2d0F57f315f27e); // Strip token address
  ...
  function depositPayment(uint256 _itemId, uint256 _amount)  external returns (uint256) {
