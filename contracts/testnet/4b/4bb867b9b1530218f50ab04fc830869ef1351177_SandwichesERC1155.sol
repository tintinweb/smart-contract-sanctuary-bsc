...
contract SandwichesERC1155 is ERC1155Upgradeable,ISandwichesERC1155, AccessControlUpgradeable, HoldEnumerable, IERC1155ReceiverUpgradeable {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155Upgradeable, AccessControlUpgradeable, IERC165Upgradeable) returns (bool) {
        return interfaceId == type(ISandwichesERC1155).interfaceId || interfaceId == type(IERC1155ReceiverUpgradeable).interfaceId || super.supportsInterface(interfaceId);
    }
    ...
    function merge(
        ...
        _addHold(totalSandwiches, _msgSender());
