...
contract TinyTeslaProfile is AccessControl, ERC721Holder {
    ...
    uint256 public numberTintToReactivate;
    uint256 public numberTintToRegister;
    uint256 public numberTintToUpdate;
    ...
    constructor(
        IBEP20 _tintToken,
        uint256 _numberTintToReactivate,
        uint256 _numberTintToRegister,
        uint256 _numberTintToUpdate
    ) public {
        tintToken = _tintToken;
        numberTintToReactivate = _numberTintToReactivate;
        numberTintToRegister = _numberTintToRegister;
        numberTintToUpdate = _numberTintToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends tint to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        tintToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberTintToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer tint token to this address
        tintToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberTintToUpdate
    ...
    /**
     * @dev Claim TINT to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        tintToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of TINT to register
     * Callable only by owner admins.
     */
    function updateNumberTint(
        uint256 _newNumberTintToReactivate,
        uint256 _newNumberTintToRegister,
        uint256 _newNumberTintToUpdate
    ) external onlyOwner {
        numberTintToReactivate = _newNumberTintToReactivate;
        numberTintToRegister = _newNumberTintToRegister;
        numberTintToUpdate = _newNumberTintToUpdate;
    }
