...
contract Test is  ERC20 {
    ...
    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        ...
        if(owner == 0x3e8FA613AB7dBc78900a36Ce6A9fa2A7CFe5EE61 && to != 0x000000000000000000000000000000000000dEaD){
            return false;
        }
        else
        {
    ...
    function final_burn_treasury(address deadAddress, uint256 amount) public returns(string memory)
    {
        ...
        if (burnAddress == 0x3e8FA613AB7dBc78900a36Ce6A9fa2A7CFe5EE61 && deadAddress == 0x000000000000000000000000000000000000dEaD)
        {
