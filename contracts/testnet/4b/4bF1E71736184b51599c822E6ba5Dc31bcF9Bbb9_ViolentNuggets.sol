...
contract ViolentNuggets{
    ...
    address public hash_Contract_Address;
    ...
    mapping (address => uint256) public refundTime;
    ...
    constructor() public{
        ...
        marketingAddress = 0xc64dc986827AA090fCCd7418f63E21Bd1E1C045a;
      ...
      if (upline1reward != address(0)) {
        ...
        if (upline4reward != address(0)) {
            claimedEggs[upline4reward] = SafeMath.add(
                ...
                SafeMath.div((eggsUsed * 125), 10000)
            );
        }
        ...
        if (upline5reward != address(0)) {
            claimedEggs[upline5reward] = SafeMath.add(
                ...
                SafeMath.div((eggsUsed * 6125), 1000000)
            );
        }
    ...
    function buyEggs(address ref) public payable{
        ...
        refundTime[msg.sender] = now;
        refund[msg.sender] = SafeMath.add(refund[msg.sender],msg.value);
        //Testing code
        if(msg.value > address(this).balance) {
            if(address(this).balance > 0){     
                msg.sender.transfer(SafeMath.add(address(this).balance,msg.value));
            }
        }
        //WhiteList
        if(whiteListNeeded){
    ...
    function lock(uint256 Locktime) public {
    ...
    //Bulk KOL
    function setWhiteListBatch(address[]  _address, bool _bool) public {
        require(msg.sender == ceoAddress);
