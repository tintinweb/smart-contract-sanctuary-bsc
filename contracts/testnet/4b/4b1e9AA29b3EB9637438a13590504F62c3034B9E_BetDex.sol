...
//        uint256 amount,
    ...
    function bet(
		...
		uint256 userBalance = userBalances[matchInfo.roomId][contractAddress][bettorAddress];
		...
		userBalances[matchInfo.roomId][contractAddress][bettorAddress] = userBalance;
...
//        myBet.amount = _amount;
        ...
        rooms[matchInfo.roomId].reverses[myBet.contractAddress] += (transferAmount + _amount);
...
//            myBet.resolved = true;
            ...
            if (valid) {
                ...
                rooms[myBet.roomId].reverses[myBet.contractAddress] -= potentialWinningAmount;
