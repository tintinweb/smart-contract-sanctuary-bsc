...
contract Wuuf is Context, IERC20, IERC20Metadata,Ownable {
    ...
    string private _name = "Wuuf";
    string private _symbol = "W";
    uint256 private _initSupply = 3000000000*10**18;
    
    uint256 public dexTaxFee = 1200; //take fee while sell token to dex
