...
contract BombArmory is Initializable {
    ...
    uint256 public MIN_INVEST_LIMIT; /** 0.01 LP  **/
    uint256 public WALLET_DEPOSIT_LIMIT; /** 1000 LP  **/
    ...
    function initialize(address _dev, address _prize) public initializer {
        ...
        EGGS_TO_HIRE_1MINERS = 4320000; // 2% daily
    ...
    function PRC_EGGS_TO_HIRE_1MINERS(uint256 value) external {
        ...
        require(value >= 1440000 && value <= 4320000); /** min 2% max 6%**/
