...
interface IKPIProjectActions {
    ...
    /// repository The project repository link, members The number of members in this project, taskContract The task contract address, owner The project owner address
    function getProject()
        external
        view
        returns (
...
contract KPIProjectFactory is IKPIProjectFactory, NoDelegateCall {
    ...
    /// @inheritdoc IKPIProjectFactory
    function userAddedToProject(address user, address project) external override {
