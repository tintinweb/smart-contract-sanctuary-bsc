...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    // IBEP20 RWRD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD BSC Token address
    // address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //WBNB address
    // IDEXRouter router;

/* FOR TESTNET */
    IBEP20 RWRD = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //BUSD TESTNET BSC Token address
...
/* FOR TESTNET */
    constructor(address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //BSC TESTNET router address
        _token = msg.sender;
    }
...
contract REWARD_TOKEN is IBEP20, Auth {
    ...
    // Addresses
    // address RWRD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //BUSD BSC Token address
    // address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //WBNB address
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

/* FOR TESTNET */
    address RWRD = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; //BUSD BSC Token address
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //WBNB address
...
/* FOR TESTNET*/
    ...
    // Launch Trading
    function LaunchToken() public authorized returns (bool){
        tradingOpen = true;
        swapEnabled = true;
