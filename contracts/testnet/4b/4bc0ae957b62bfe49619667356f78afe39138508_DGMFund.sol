...
contract DGMFund is ReentrancyGuard, Context, Ownable {
    ...
    constructor (uint256 rate, address wallet,address payable _masterAccount, IERC20 token) {
    ...
    function dGSignup() public payable {
		...
		//Transfer Main Token//
		uint256 weiAmount=msg.value.mul(20).div(100);
