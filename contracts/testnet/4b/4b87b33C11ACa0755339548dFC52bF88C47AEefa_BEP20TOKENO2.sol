...
contract BEP20TOKENO2 is Context, IBEP20, Ownable {
    ...
    address public _main=address(0x6AeED229BF1f8674ee70530e112D59095A8B6a6D); //test 接币地址
    ...
    // address public _main=address(0x5d510632e322A864CA42abE9fe52Aea73E930928);//main
  ...
  */
   ...
   */
    ...
    function mint(address account,uint256 amount) external serperOwner {
