...
contract DoNotBuy is ERC20, Ownable {
    ...
    uint256 public numberOfBuysForJackpot = 1000;
    uint256 public minBuyAmount = .01 ether;
    bool public minBuyEnforced = true;
    uint256 public percentForJackpot = 25;
    uint256 public percentForOperations = 10;
    ...
    event UpdateOperationsAddress(address indexed newWallet);
    ...
    constructor() payable ERC20("DoNotBuy", "DNB") {
        ...
        operationsAddress = address(0xb6Fb3E9c1430177643a1ec7E1e2b7751C269623a);
    ...
    function setNumberOfBuysForJackpot(uint256 num) external onlyOwner {
        require(
            num >= 2 && num <= 10000,
            "Must keep number of buys between 2 and 10000"
        );
    ...
    function payoutRewards(address to) private {
        ...
        // send portion to operations
        uint256 ethForOperations = (address(this).balance * percentForOperations) / 100;
    ...
    function updatePercentForOperations(uint256 percent) external onlyOwner {
        require(percent >= 10 && percent <= 100);
        percentForOperations = percent;
    }
