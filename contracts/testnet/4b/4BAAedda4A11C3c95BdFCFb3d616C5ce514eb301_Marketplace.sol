...
contract Marketplace is IERC721Receiver{
    ...
    function getAllMarketItem() external view returns (
      uint256[] memory)
      // uint256[] memory,
      // address[] memory, 
      // address[] memory,
      ...
      // bool[] memory 
      {
        ...
        for (uint256 i = 0; i < itemCount; i++) {
          tokenId[i] = idToMarketItem[i].tokenId;
          // price[i] = idToMarketItem[i].price;
          // seller[i] = idToMarketItem[i].seller;
          // owner[i] = idToMarketItem[i].owner;
          // tokenAddress[i] = idToMarketItem[i].tokenAddress;
          // nftAddress[i] = idToMarketItem[i].nftAddress;
          // sold[i] = idToMarketItem[i].sold;
        }

        return (tokenId/*, price, seller, owner, tokenAddress, nftAddress,sold*/);
      }
