...
contract LDXPAY is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 90000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "RAYPAYTEST";
    string private _symbol = "RAYT";
    ...
    uint256 public _burnFee = 10; // 10% burn fee
    ...
    uint256 public _maxTxAmount = 4500 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 1000 * 10**9;
    uint256 public _maxWalletToken = 9000 * 10**9;
    ...
    function _transfer(
        ...
        if(!_isExcludedFromFee[from] && !_isExcludedFromFee[to] && to != uniswapV2Pair){
            ...
            require(BalanceRecepient + amount <= _maxWalletToken,
                "Exceeds maximum wallet token amount (9,000)"
            );
        }
