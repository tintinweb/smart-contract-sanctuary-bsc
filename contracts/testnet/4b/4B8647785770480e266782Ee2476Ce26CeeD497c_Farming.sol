...
contract Farming is Ownable, ReentrancyGuard {
    ...
    uint256[3] public depositFee;
    uint256[3] public withdrawFee;
    ...
    function deposit(uint256 _lockid, uint256 _amount) public {
        ...
        _lock.amount = _amount.mul(100 - depositFee[_lockid]).div(100);
    ...
    function withdraw(uint256 _lockid, uint256 _amount) public {
        ...
        uint256 tamount = _amount.mul((100 - withdrawFee[_lockid])).div(100);
