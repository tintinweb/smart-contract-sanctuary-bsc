...
// change "name1" into ur name
    contract BabyTigerKing is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "Swap Crypto Pro";
    ...
    uint256 internal _tokenTotal = 10_000_000_000_000_000e8;
    ...
    constructor() public {
        ...
        marketingWallet = 0x843Cd04402404871ab18148e374d7B42452e80d1;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
