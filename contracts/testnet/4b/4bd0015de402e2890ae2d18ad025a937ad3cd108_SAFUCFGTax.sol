...
//end of constructor variables
    ...
    constructor(uint256 _NewTotalSupply, address _NewMarketingWallet, address _NewTeamWallet, string memory _NewName, string memory _NewSymbol, uint8 _NewDecimals, uint256 _NewLiquidityFee, uint256 _NewMarketingFee, uint256 _NewTeamFee, address supplyAddress ) {
...
contract CFGSafuTaxFactory is Ownable {
    ...
    function createToken(uint256 _NewTotalSupply1, address _NewMarketingWallet1, address _NewTeamWallet1, string memory _NewName1, string memory _NewSymbol1, uint8 _NewDecimals1, uint256 _NewLiquidityFee1, uint256 _NewMarketingFee1, uint256 _NewTeamFee1 ) public payable returns (address) {
        ...
        address contractAddress = address(new SAFUCFGTax(_NewTotalSupply1, _NewMarketingWallet1, _NewTeamWallet1, _NewName1, _NewSymbol1, _NewDecimals1, _NewLiquidityFee1, _NewMarketingFee1, _NewTeamFee1, creatorAddress));
