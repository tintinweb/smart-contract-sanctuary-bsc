    ...
    ILaunchpadCrowdsaleNonEth
{
    ...
    modifier onlyBy(address account) {
        require(
            msg.sender == account,
            "LaunchpadCrowdsaleNonEth: sender unauthorized"
        );
        _;
    }
    ...
    function buyTokens(
        ...
        require(
            ...
            "LaunchpadCrowdsaleNonEth: empty non ETH address"
        );
        ...
        onlyBy(governanceAccount)
    {
        require(
            account != address(0),
            "LaunchpadCrowdsaleNonEth: zero account"
        );
        ...
        isWhitelisted(beneficiary)
    {
        ...
        if (
            ...
            revert("LaunchpadCrowdsaleNonEth: beneficiary cap exceeded");
        }
...
/**
 * @title ILaunchpadCrowdsaleNonEth
 * @author Enjinstarter
 */
interface ILaunchpadCrowdsaleNonEth is ICrowdsale {
    function buyTokens(
        address paymentToken,
        uint256 lots,
        string calldata nonEthAddress
