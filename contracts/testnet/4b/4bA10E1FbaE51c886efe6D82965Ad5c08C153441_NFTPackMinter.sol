...
contract NFTPackMinter is Ownable, IERC1155Receiver {
    ...
    constructor(address _nftPackAddress, address _tokenAddress, address _editionAddress) {
        ...
        setApprovalForAll(nftPackAddress,true);
    }

    function approve(address _spender, uint256 _amount) public{
        IERC20(tokenAddress).approve(_spender,_amount);
    }
    ...
    function mintPack() public{
        approve(nftPackAddress,100 ether);
