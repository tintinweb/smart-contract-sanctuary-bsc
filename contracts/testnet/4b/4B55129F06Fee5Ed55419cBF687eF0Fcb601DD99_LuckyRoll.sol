...
contract LuckyRoll {
    ...
    ERC20 MIUXToken = ERC20(0x798490fDA05B05AB707E38F3fdE456C67D0a5394);
    
    /// *** Constants section
    uint256 constant BASE_UNIT = 10 ** 18; // 10 ** 18
    ...
    // function placeBet(uint betMask, uint modulo, uint commitLastBlock, uint commit, bytes32 r, bytes32 s, uint8 v, uint amount) external {
