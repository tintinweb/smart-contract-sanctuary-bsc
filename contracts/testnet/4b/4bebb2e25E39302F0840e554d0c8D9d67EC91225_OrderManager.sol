...
contract OrderManager is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
     ...
     * @dev the msg.value needs to be larger than minExecutionFee. If the purchaseToken is ETH, the msg.value needs
     * to be larger than purchaseAmount + minExecutionFee.
    ...
    */
     ...
     * @dev The oracle contract must implement the ILevelOracle interface.
    ...
    /** 
     * @notice Sets the minimum execution fee.
     * @param _fee The minimum execution fee.
     * @dev Only the owner can call this function.
