...
contract ICO is Ownable, ReentrancyGuard{
  ...
  //  using SafeBEP20 for IBEP20;
   ...
   // Invest[] public invests;
    ...
    function createToken(IBEP20 _tokenAddress,  string memory _projectUrl, uint256 _softCap, uint256 _hardCap, uint256 _tokenPricePerBnb,
    uint256 _minBuy, uint256 _maxBuy, address _admin, uint256 _startTime, uint256 _endTime, bool _referralStatus) public payable nonReentrant{
        require(msg.value >= launchCharges || owner()==msg.sender, "You must have min of 1 BNB to create a token");
        countType++;
        tokenInfos.push(tokenInfo(countType,_tokenAddress, _projectUrl, _softCap, _hardCap,_tokenPricePerBnb, _minBuy, _maxBuy, _admin, _startTime, _endTime, false));
        tokenReferral[countType] = _referralStatus;
    }
    ...
    function endSales(uint _id) public onlyOwner{
    ...
    referer[referBy] += 1; 
    uint refererShare = (msg.value * referPercent) / 100;
    uint deliverShare = msg.value - refererShare;
    ...
    //isInvested[_buysCount] = Invest(_buysCount,_txHash, investor, amount, _interestRate, investedTime, endTime, totalTokenToEarned, releaseStatus, false );
