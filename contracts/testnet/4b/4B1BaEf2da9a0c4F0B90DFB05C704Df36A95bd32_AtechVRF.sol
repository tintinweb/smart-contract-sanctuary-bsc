...
contract AtechVRF is VRFConsumerBaseV2 {
    ...
    // Storage parameters
    uint64 public s_subscriptionId = 1141;
    ...
    function addConsumer(address consumerAddress) external onlyAdmin {
        // Add a consumer contract to the subscription.
        COORDINATOR.addConsumer(s_subscriptionId, consumerAddress);
    }

    function removeConsumer(address consumerAddress) external onlyAdmin {
        // Remove a consumer contract from the subscription.
        COORDINATOR.removeConsumer(s_subscriptionId, consumerAddress);
    }

    function cancelSubscription(address receivingWallet) external onlyAdmin {
