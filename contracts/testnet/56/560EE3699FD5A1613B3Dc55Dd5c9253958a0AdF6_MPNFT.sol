...
contract MPNFT is ERC721,Member {
    ...
    function distribute(uint256 needpay) internal{
        ...
        uint256 PromoteAmount = needpay.mul(25).div(105);   // 25/105
        uint256 LPAmount = needpay.mul(5).div(105); // 5/105
        uint256 burnAmount = needpay.sub(OfficalAmount).sub(PromoteAmount).sub(LPAmount); // 70/105
