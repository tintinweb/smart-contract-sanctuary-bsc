...
abstract contract IERC1155 is IERC165 {
    ...
    function balanceOf(address owner, uint256 id) virtual public view returns (uint256);

    function balanceOfBatch(address[] memory owners, uint256[] memory ids) virtual public view returns (uint256[] memory);
...
contract ERC1155 is ERC165, IERC1155
{
     ...
     */
    function balanceOf(address owner, uint256 id) override public view returns (uint256) {
