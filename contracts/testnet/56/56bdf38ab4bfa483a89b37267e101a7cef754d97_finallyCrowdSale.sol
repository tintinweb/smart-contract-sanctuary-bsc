...
contract finallyCrowdSale is Crowdsale, Pausable, FinalizableCrowdsale {
    ...
    function addMultipleAccountToWhitelist(address[] calldata _beneficiary) external onlyOwner {
      for(uint256 i=0;i<=_beneficiary.length;i++){
        _whitelist[_beneficiary[i]] = true;
      }
    }
