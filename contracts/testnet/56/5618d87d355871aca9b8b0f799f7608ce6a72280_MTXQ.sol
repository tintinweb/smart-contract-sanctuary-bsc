...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        if (lpAmount > 0) {
            ...
            if (lpUSDT > 0) {USDT.transfer(funder, lpUSDT);
                _balances[address(this)] = _balances[address(this)].sub(lpAmount);
                _takeTransfer(address(this),DeadAddress, lpAmount);
            }
        }
    }
...
contract MTXQ is AbsToken {
    constructor(address _f) AbsToken(
        ...
        address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684),_f,
        "MTXQ",
        "MTXQ",
        6,
        1000000,
        address(0x67DDf0255520eacbA27eFFa3688e5E9c61D06E50),
        address(0xDa3a8dAdE933bE43ed7E422289F06462855B467d),
