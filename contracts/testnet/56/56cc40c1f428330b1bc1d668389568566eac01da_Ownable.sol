...
contract Topogigio is Context, IERC20, Ownable {
    ...
    string private constant _name = "Topogigio"; // 
    string private constant _symbol = "TOPO"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 4;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x6CaaaddcE69c8d1cFd21f37A5bBC3F2f3a8226DC;
