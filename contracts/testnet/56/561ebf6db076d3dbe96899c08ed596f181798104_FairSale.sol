...
contract FairSale is Ownable {
    ...
    constructor () {
        GOUDA = IERC20(0x54ccDddc3338230239D37090Fb4105df315c3C10);
        BUSD = IERC20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
        pair = ICowswapV2Pair(0xf51afC6Bbad5D90ba5265E721819D9249143E885);
        cowswapV2Router = ICowswapRouter02(0x6B3122BCFDB74FE8C260956cbAbEBc6BE38e772c);
    }
...
//        uint80 answeredInRound
    ...
    function BNB2GOUDA(uint _amountBNB) public view returns(uint _amountGouda) {
        uint256 expectedRate = BNB2USD();
        uint256 usdAmount = expectedRate * _amountBNB / 1 ether;
    ...
    function buy() public payable{
        ...
        GOUDA.transfer(msg.sender, amountGouda);
    ...
    function limitCheck(uint256 amount) public view returns(bool){
        (uint112 reserve0, uint112 reserve1,) = pair.getReserves();
        uint112 r0 = reserve0;
        uint112 r1 = reserve1;
        uint256 bnbAmount = cowswapV2Router.getAmountIn(amount, uint256(r1), uint256(r0));

        return bnbAmount * 199 < uint256(reserve1); //  Max ~ 1% of BNB in pool
    }
