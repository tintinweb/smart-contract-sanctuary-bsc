...
contract TTC is IERC20{

    string public constant name = "UPKOIN";
    string public constant symbol = "Upk";
    ...
    function increaseTotalSupply(uint newTokensAmount) onlyAdmin public {
    ...
    function transferFrom(address owner, address buyer, uint256 numTokens) public override returns (bool){
        require(numTokens <= balances[owner], "Not enought tokens to transfer");
        require(numTokens <= allowed[owner][msg.sender], "Not enought tokens allowed from the user");
