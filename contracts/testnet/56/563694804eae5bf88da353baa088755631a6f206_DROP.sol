...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    contract DROP is BEP20, Ownable {
        using SafeMath for uint256;
        using Address for address;

        string private    _name = "Droptoken";
    ...
    uint256 public _maintenanceFee = 1; 
    uint256 private _previousMaintenanceFee;

//   This maintenance wallet is where my transaction fee goes to my trustwallet BNB smart chain
   address payable maintenanceWallet = payable(0xCbE45BB332Ae80F94C14A5891f1622d5C4B336B4);
    ...
    //  Pancakeswap router testnet address 
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);

    // // Pancakeswap router mainnet address 
    ...
    function changeMaintenanceFee(uint256 _percentage) public onlyOwner{
        _maintenanceFee = _percentage;     
    }
    ...
    function swapBack(uint256 tokensToLiquify) internal lockTheSwap {
        ...
        uint256 bnbForMaintenance = bnbBalance;
