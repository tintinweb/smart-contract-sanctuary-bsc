...
/*
    ...
    Website: 
    Telegram: https://t.me/felinecatbsc
...
contract FelinCat is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Felin Cat";
    string private _symbol = "FELIN";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE3d8eBec778a131De45DC2De25257C3398B4a8A8); 
    address payable public DevOutsourceWallet = payable(0x2db6A125D7ee3129db79A3362b7BD2E6d4aa6493); 
