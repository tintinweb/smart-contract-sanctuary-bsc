...
contract LemonHaze is Context, IERC20, Ownable {
    ...
    constructor () {
        // address gameContract = address(0x1230D9af3E4Ce97802a85b0Cd8Cd715a2b9a5B02);
        // uint256 ownerBalance = _rTotal * 70 / 100;
        // _rOwned[_msgSender()] = ownerBalance;
        // _rOwned[gameContract] = _rTotal - ownerBalance;
