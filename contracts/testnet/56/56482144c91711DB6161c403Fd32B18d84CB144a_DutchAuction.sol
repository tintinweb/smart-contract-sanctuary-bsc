    ...
    onlyOwner
{
    ...
    function getCurrentPrice(address nftContractAddress, uint256 tokenId) public view returns(uint256){
        ...
        uint256 decreaseAmount = nftContractAuction.decreaseRate*block.timestamp;
        if ((nftContractAuction.startPrice - decreaseAmount) >= nftContractAuction.minPrice){
            return nftContractAuction.startPrice - decreaseAmount;
        }else{
