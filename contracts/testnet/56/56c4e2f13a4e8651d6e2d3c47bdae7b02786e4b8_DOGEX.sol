...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant ETH = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //DOGE
...
contract DOGEX  is ERC20, Ownable {
    ...
    address private constant ETH = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //DOGE

    uint256 public swapTokensAtAmount = 100 * 10**6 * (10**9);
    uint256 public maxTxAmount;

    address payable public marketingWallet = payable(address(0x072217e9E539435154545327DA71FEE9a6be50cE)); //marketing wallet
