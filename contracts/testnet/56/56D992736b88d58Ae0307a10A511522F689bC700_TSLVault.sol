...
contract TSLVault is Initializable, OwnableUpgradeable, ReentrancyGuard {
    ...
    function deposit(
        ...
        require(userLevel[msg.sender] >= level_ || level_ <= pubLevel, "unauthorized user level");
        require(
    ...
    function configLevel(uint256[] memory num_,uint256[] memory bal_, uint256 pubLevel_) public onlyOwner {
