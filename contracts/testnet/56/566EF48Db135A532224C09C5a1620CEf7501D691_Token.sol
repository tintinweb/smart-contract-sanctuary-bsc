...
/**
 * @title New Lepricon Token
 * @author Pedrojo01
 */

contract Token is ERC20Permit, Ownable {
    /**
     * @dev Constructor that mint the tokens and send them to the treasury;
     * @param _treasury Main tokens reserve, behind a multisig (3 out of 5);
     */
    constructor(address _treasury) ERC20Permit("Lepricon") ERC20("Lepricon", "LPR") {
        _mint(_treasury, 7_777_777 * 10**decimals());
...
/**
 * NOTE: Two functions have been added to the OpenZeppelin ERC20 contract:
 * - batchTranfer
 * - batchtransferFrom
 */
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    /**
     * @dev Send tokens to multiple recipients in a single tx;
