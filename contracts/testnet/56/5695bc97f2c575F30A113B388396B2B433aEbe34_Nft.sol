...
contract Role is AccessControl {
    ...
    function leaveContract() public virtual {
    ...
    Role
{
    ...
    bool private useJson;

    //https://testnet-core.dc8.io/meta/ic8/
    //https://core.dc8.io/meta/ic8/
    //https://meta.soccercrypto.io/metadata/
    constructor(
        string memory name,
    ...
    function setMetaURI(string memory _metaURI)
        public
        onlyMember
        whenNotPaused
    {
    ...
    function setTokenLink(uint256 tokenId) private {
        if (useJson == true) {
            _setTokenURI(
                tokenId,
                string(abi.encodePacked(metaURI, Strings.toString(tokenId)))
            );
        } else {
            _setTokenURI(
                tokenId,
