...
contract ArabianGulfToken is BEP20, Ownable, Pausable {
    ...
    constructor() BEP20("Arabian Gulf Coin", "AGC") payable
    {
        ...
        setBuyTax(0,1,0,1);
        setSellTax(1,0,1,0);
        setTaxWallets(0xC8934823c0a96e9b0170098D975902d22E22f84c, 0xC8934823c0a96e9b0170098D975902d22E22f84c, 0xC8934823c0a96e9b0170098D975902d22E22f84c ,0xC8934823c0a96e9b0170098D975902d22E22f84c);
        exclude(msg.sender);
     ...
     */
    function setBuyTax(uint256 development_fees, uint256 marketing_fees, uint256 liquidity_fees, uint256 burn_fees) public onlyOwner {
        buyTaxes["dev"] = development_fees;
        buyTaxes["marketing"] = marketing_fees;
        buyTaxes["liquidity"] = liquidity_fees;
        buyTaxes["charity"] = burn_fees;
    }
    
    /**
     * @dev Sets tax for sells.
     */
    function setSellTax(uint256 development_fees, uint256 marketing_fees, uint256 liquidity_fees, uint256 burn_fees) public onlyOwner {

        sellTaxes["dev"] = development_fees;
        sellTaxes["marketing"] = marketing_fees;
        sellTaxes["liquidity"] = liquidity_fees;
        sellTaxes["charity"] = burn_fees;
    }
    
    /**
     * @dev Sets wallets for taxes.
     */
    function setTaxWallets(address development_wallet, address marketing_wallet , address liquidity_wallet, address burn_wallet) public onlyOwner {
        taxWallets["dev"] = development_wallet;
        taxWallets["marketing"] = marketing_wallet;
        taxWallets["marketing"] = liquidity_wallet;
        taxWallets["charity"] = burn_wallet;
    }
