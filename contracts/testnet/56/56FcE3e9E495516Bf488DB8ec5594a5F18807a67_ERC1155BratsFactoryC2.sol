...
abstract contract ERC1155Base is OwnableUpgradeable, ERC1155DefaultApproval, ERC1155BurnableUpgradeable, ERC1155Lazy, HasContractURI {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155Lazy,IERC165Upgradeable,ERC165Upgradeable) returns (bool) {
...
contract ERC1155Brats is ERC1155Base, IsPrivateCollection, MinterAccessControl {
    event CreateERC1155Brats(address owner, string name, string symbol);
    event CreateERC1155BratsUser(address owner, string name, string symbol);

    function __ERC1155BratsUser_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address[] memory operators, address transferProxy, address lazyTransferProxy) external virtual {
        __ERC1155Brats_init_unchained(_name, _symbol, baseURI, contractURI, transferProxy, lazyTransferProxy);
        for(uint i = 0; i < operators.length; i++) {
            setApprovalForAll(operators[i], true);
        }

        isPrivate = true;
        emit CreateERC1155BratsUser(_msgSender(), _name, _symbol);
    }
    
    function __ERC1155Brats_init(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address transferProxy, address lazyTransferProxy) external virtual {
        __ERC1155Brats_init_unchained(_name, _symbol, baseURI, contractURI, transferProxy, lazyTransferProxy);

        isPrivate = false;
        emit CreateERC1155Brats(_msgSender(), _name, _symbol);
    }

    function __ERC1155Brats_init_unchained(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address transferProxy, address lazyTransferProxy) internal initializer {
        __Ownable_init_unchained();
...
contract ERC1155BratsFactoryC2 is Ownable{
    address public beacon;
    address transferProxy;
    address lazyTransferProxy;

    event Create1155BratsProxy(address proxy);
    event Create1155BratsUserProxy(address proxy);
    ...
    function createToken(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, uint salt) external {        
        ...
        ERC1155Brats token = ERC1155Brats(beaconProxy);
        token.transferOwnership(_msgSender());
        emit Create1155BratsProxy(beaconProxy);
    }
    ...
    function createToken(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address[] memory operators, uint salt) external {
        ...
        ERC1155Brats token = ERC1155Brats(address(beaconProxy));
        token.transferOwnership(_msgSender());
        emit Create1155BratsUserProxy(beaconProxy);
    }
    ...
    function getData(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI) view internal returns(bytes memory){
        return abi.encodeWithSelector(ERC1155Brats(address(0)).__ERC1155Brats_init.selector, _name, _symbol, baseURI, contractURI, transferProxy, lazyTransferProxy);
    }
    ...
    function getData(string memory _name, string memory _symbol, string memory baseURI, string memory contractURI, address[] memory operators) view internal returns(bytes memory){
        return abi.encodeWithSelector(ERC1155Brats(address(0)).__ERC1155BratsUser_init.selector, _name, _symbol, baseURI, contractURI, operators, transferProxy, lazyTransferProxy);
    }
