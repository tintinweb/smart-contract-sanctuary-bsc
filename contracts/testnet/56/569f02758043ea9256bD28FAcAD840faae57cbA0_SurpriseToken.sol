...
contract SurpriseToken is IERC20Extended, Auth {
    ...
    function setBuyAccFee(uint256 _amount) internal {
        ...
        _surpriseFeeCount = _surpriseFeeCount.add(_amount.mul(_surpriseBuyFee).div(feeDenominator));
    }
    ...
    function setSellAccFee(uint256 _amount) internal {
        ...
        _surpriseFeeCount = _surpriseFeeCount.add(_amount.mul(_surpriseSellFee).div(feeDenominator));
    }
