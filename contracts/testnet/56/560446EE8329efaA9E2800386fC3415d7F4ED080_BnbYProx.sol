...
// SPDX-License-Identifier: MIT
    ...
    abstract contract ReentrancyGuard {
        ...
        contract BnbYProx is Initializable, OwnableUpgradeable, ReentrancyGuard{
            uint256 internal initDate;
            
            //address public owner;
            address private marketing_wallet;
            address private secure_wallet;
            ...
            function initialize(address payable _marketing_cost,address payable _secure_wallet) initializer public {
                require(!isContract(_marketing_cost) && !isContract(_secure_wallet));
                //owner = _owner;
                //initUNIX = timestamp;
            ...
            function withdraw() external nonReentrant NonBlackListed {
                ...
                payable(secure_wallet).transfer(insurance_amt);
                ...
                payable(secure_wallet).transfer(amount_taxWithdrawWhale+amount_taxWithdrawVip);
