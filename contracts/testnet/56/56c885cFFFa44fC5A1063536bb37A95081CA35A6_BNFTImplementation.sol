...
import "./BRC721EnumerableUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/security/PausableUpgradeable.sol";
import "@openzeppelin/contracts/utils/Strings.sol";

contract BNFTImplementation is BRC721EnumerableUpgradeable, PausableUpgradeable {
    ...
    function initialize(
        ...
        __BRC721_init(admin_, name_, symbol_);
        __BRC721Enumerable_init();
        __Pausable_init();
 ...
 */
contract BRC721Upgradeable is Initializable, ContextUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
     ...
     */
    function __BRC721_init(
        address admin_,
        string memory name_,
        string memory symbol_
    ) internal onlyInitializing {
        __BRC721_init_unchained(admin_, name_, symbol_);
    }

    function __BRC721_init_unchained(
        address admin_,
        string memory name_,
        string memory symbol_
    ) internal onlyInitializing {
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = BRC721Upgradeable.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(BRC721Upgradeable.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(BRC721Upgradeable.ownerOf(tokenId), to, tokenId);
    }
...
import "./BRC721Upgradeable.sol";

import "@openzeppelin/contracts-upgradeable/token/ERC721/extensions/IERC721EnumerableUpgradeable.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";

abstract contract BRC721EnumerableUpgradeable is Initializable, BRC721Upgradeable, IERC721EnumerableUpgradeable {
    function __BRC721Enumerable_init() internal onlyInitializing {}

    function __BRC721Enumerable_init_unchained() internal onlyInitializing {}
     ...
     * @dev See {IERC165-supportsInterface}.
     */
    function supportsInterface(bytes4 interfaceId) public view virtual override(IERC165Upgradeable, BRC721Upgradeable) returns (bool) {
    ...
    function tokenOfOwnerByIndex(address owner, uint256 index) public view virtual override returns (uint256) {
        require(index < BRC721Upgradeable.balanceOf(owner), "ERC721Enumerable: owner index out of bounds");
    ...
    function tokenByIndex(uint256 index) public view virtual override returns (uint256) {
        require(index < BRC721EnumerableUpgradeable.totalSupply(), "ERC721Enumerable: global index out of bounds");
    ...
    function _addTokenToOwnerEnumeration(address to, uint256 tokenId) private {
        uint256 length = BRC721Upgradeable.balanceOf(to);
    ...
    function _removeTokenFromOwnerEnumeration(address from, uint256 tokenId) private {
        ...
        uint256 lastTokenIndex = BRC721Upgradeable.balanceOf(from) - 1;
