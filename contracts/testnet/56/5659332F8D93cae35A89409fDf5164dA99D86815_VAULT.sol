...
contract VAULT is ERC20, Ownable {
    ...
    constructor () ERC20("VAULTEUM", "VAULT") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        ERC20USDT.approve(address(this), type(uint256).max);
    ...
    function swapAndSendMarketing(uint256 tokenAmount) private {
        uint256 initialBalance = ERC20USDT.balanceOf(address(this));
        ...
        uint256 newBalance = ERC20USDT.balanceOf(address(this)) - initialBalance;

        ERC20USDT.transfer(marketingWallet, newBalance);
