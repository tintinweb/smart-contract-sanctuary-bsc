...
contract TeamFolks{
   ...
   struct User {
    ...
    uint[14] public matrixprice = [0,0.0025 ether,0.005 ether,0.01 ether,0.02 ether,0.04 ether,0.10 ether,0.20 ether,0.40 ether,0.80 ether,1.60 ether,3.20 ether,6.40 ether,12.80 ether];
    uint[14] public uplineben = [0,0,0.0025 ether,0.05 ether,0.01 ether,0.02 ether,0,0,0.20 ether,0.40 ether,0.80 ether,1.60 ether,3.20 ether,6.40 ether];
