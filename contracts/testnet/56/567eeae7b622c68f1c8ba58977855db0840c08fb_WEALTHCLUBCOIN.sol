...
/* 
 * Website  : https://www.wealthclub.pro/  
...
contract WEALTHCLUBCOIN is BEP20,Ownable,BEP20Burnable,BEP20Mintable {


    constructor()
         BEP20("WEALTH CLUB COIN", "WCC", 8) {
             /* 2,500,000,000 WCC Total Supply */
            _mint(msg.sender, 25 * (10 ** uint256(8)) * (10 ** uint256(8)));
        }
