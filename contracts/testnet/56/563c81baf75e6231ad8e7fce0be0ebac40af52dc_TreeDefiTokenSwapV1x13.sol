...
// File: contracts/TreeDefiTokenSwapTestProxied.sol


// Treedefi Token Swap v. 1.13
// Code: SCSE-01
// Usage Testnet
// Author: Treedefi 
...
contract TreeDefiTokenSwapV1x13 is Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable {
...
function _authorizeUpgrade(address newImplementation) internal view override {
    ...
    require(
        TreeDefiTokenSwapV1x13(newImplementation).admin() == admin,
        "New implementation contract must have the same admin"
    );
}
