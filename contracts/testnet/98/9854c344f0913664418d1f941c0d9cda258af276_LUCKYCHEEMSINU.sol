...
//
// Copyright of The LUCKYCHEEMSINU Team
...
//
// There is an automated LuckyDraw alongside every LUCKYCHEEMSINU buy transaction
// 
// LUCKYCHEEMSINU has 6% tax split across 7 awesome protocols
// (Sells incur 7% tax and DumpSells incur 13%)
// 
// 3%: LuckyDraw
// 1%: Burn
// 1%: Buyback
...
/**
 * @dev The official LUCKYCHEEMSINU smart contract
 */
contract LUCKYCHEEMSINU is Context, IERC20, Ownable {
    ...
    // General Info
    string private _name     = "LUCKYCHEEMSINU";
    ...
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for LCHEEMS/WBNB
    ...
    uint256 public  _whaleSellTaxFee  = 13;                   // 13% tax 
    ...
    uint    public  _lotteryChance       = 130;                 // 5% chance to win on a buy
    ...
    /**
     * @notice Withdraws non-LUCKYCHEEMSINU tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts LUCKYCHEEMSINU balance for buybacks, liquidity and marketing
    ...
    /**
     * @notice Burns LUCKYCHEEMSINU tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of LUCKYCHEEMSINU tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from LUCKYCHEEMSINU)
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
        // Generate the Pancakeswap pair for LCHEEMS/WBNB
    ...
    function swapBNBForTokens(uint256 amount) private {
        ...
        _pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            0, // Accept any amount of LUCKYCHEEMSINU
            path,
