...
contract BeefSwap is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 1000000; //1 Million Total token supply
    ...
    // PCS ROUTER4
       ...
       //pcs testnet router address: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        //pcs mainnet router v2 address: 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function setDevWallet(address payable newDevWallet) external onlyOwner {
        require(_devWallet != newDevWallet, "Wallet already set!");
