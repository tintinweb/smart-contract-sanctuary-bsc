...
mapping(uint256 => MarketItem) private idToMarketItem;
    ...
    function listItemOnSale(
        ...
        require(nativeToken.balanceOf(msg.sender) >= listingPrice, "Amount doesn't meet listing fees requirements (1 token)");
        
        IERC721(nftContract).safeTransferFrom(msg.sender, address(this), idToMarketItem[itemId].tokenId);
        // marketOwner.transfer(msg.value);
        //nativeToken.safeTransferFrom(msg.sender,marketOwner,listingPrice);
        nativeToken.transferFrom(msg.sender,marketOwner,listingPrice);
    ...
    function sellMarketItem(
        ...
        //address nftContract
            ...
            //require(msg.value == idToMarketItem[itemId].price, "Amount must be equal to price");
             require(nativeToken.balanceOf(msg.sender) >=idToMarketItem[itemId].price, "Amount doesn't meet listing fees requirements (1 token)");
            ...
            nativeToken.transferFrom(msg.sender, idToMarketItem[itemId].owner, idToMarketItem[itemId].price);
