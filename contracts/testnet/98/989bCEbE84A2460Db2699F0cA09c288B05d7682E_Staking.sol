...
abstract contract GlobalsAndUtils {
    ...
    /******************* State Variables **********************/
    uint256 internal constant MIN_STAKE_DAYS = 10 minutes;
    uint256 internal constant COOLDOWN_PERIOD = 10 minutes;
...
contract Staking is GlobalsAndUtils, Ownable, ReentrancyGuard, IERC721Receiver, Pausable {
    ...
    constructor(address _rewardingToken) {
...
/**
 ...
 /**
    ...
    function emergencyWithdrawStakedAmount(address receiver, uint256 campaignId) external onlyOwner campaignEnded {
        ...
        (bool success, ) = msg.sender.call{value: totalStakedAmount + penaltyAccumulated[campaignId]}("");
        require(success, "couldn't transfer tokens");
    }
