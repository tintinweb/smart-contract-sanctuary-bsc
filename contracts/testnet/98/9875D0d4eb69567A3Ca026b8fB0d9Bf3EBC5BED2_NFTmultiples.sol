...
contract NFTmultiples is BEP721 {
  ...
  constructor() BEP721(collectionName, collectionNameSymbol) {
   ...
   struct NFT {
    ...
    // create collection 
    // mint a new nft
    function createmultipleNFT(string memory  name ,string memory symbol,string memory _tokenURI,uint256 _price,uint256 _numberofNFT) external {
