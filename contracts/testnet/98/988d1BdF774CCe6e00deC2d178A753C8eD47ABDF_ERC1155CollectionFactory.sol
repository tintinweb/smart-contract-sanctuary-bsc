...
contract ERC1155CollectionFactory is Context {
    /// @notice Events of the contract
    event ERC1155CollectionCreated(address creator, address nft);
    ...
    function createERC1155Collection(
        ...
        emit ERC1155CollectionCreated(_msgSender(), nftCollectionAddress);
