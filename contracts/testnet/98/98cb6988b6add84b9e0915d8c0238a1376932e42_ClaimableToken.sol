...
contract ClaimableToken {
    ...
    // constructor to set the address of the ERC20 token being claimed and the owner of the contract
    ...
    function claim() public {
        ...
        // check if the user holds more than 500 tokens
        // require(tokenBalance >= 500, "User must hold more than 500 tokens to claim");
    ...
    function claimAmount(uint256 amount) public {
        ...
        // update the caller's remaining balance
