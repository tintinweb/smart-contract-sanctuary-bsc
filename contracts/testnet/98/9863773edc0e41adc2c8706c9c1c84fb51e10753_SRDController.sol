...
contract SRDController is Ownable {
    ...
    constructor() {
        ...
        SRD = ERC20(0x76f255772da7d2F383A9fc7c2279A840bbdc9Ae7);
        ...
        pair = address(0xAe68A3315FA3c54737Bec5DB22276482F7aD727c);
    ...
    function queryMyData(address user) public view returns(uint256 nftAmount, uint256 prNftAmount, uint256 grNftAmount, uint256 unclaimedAmount, uint256 bnbAmount) {
        ...
        bnbAmount = bnbEqualsToUsdt(tokenEqualsToBnb(unclaimedAmount));
    }
    ...
    function queryPoolData() public view returns(uint256 currentAmount, uint256 miningAmount, 
    uint256 nftAmount) {
    ...
    function queryNFTDataByType(uint256 types) public view returns(uint256 amount, uint256 bnbBuyBackAmount, 
    uint256 tokenBurnAmount, uint256 profit) {
