...
import {LibAccessControlList} from "../libraries/LibAccessControlList.sol";
import {LibMeta} from "../libraries/LibMeta.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721.sol";

contract ERC721MinterRoleMintableFacet {
    ...
    function initialize(bytes calldata initBytes) external {
        ...
        for (uint256 i = 0; i < length; ++i) {
            LibAccessControlList.grantRole(MINTER_ROLE, addresses[i]);
        }
    }
    ...
    function mint(uint256 tokenId, address account) external {
        require(
            LibAccessControlList.hasRole(MINTER_ROLE, LibMeta.msgSender()),
