...
contract Roulette {
    ...
    function emergencyStop(address _address) public payable {
    ...
    function betNextGame(uint _bet) public payable {
        ...
        if(_bet == 15) {
            ...
            g.possibleWin[msg.sender] += msg.value * 14;
            g.balanceZero += msg.value;
        } else if (_bet % 2 == 0) {
            g.bet[msg.sender] = betName.even;
            g.possibleWin[msg.sender] += msg.value * 2;
    ...
    function fundBalance() public payable {}
