...
contract StakingPool is Upgradable {
    ...
    */
    function canGetReward(string memory poolId) public view returns (bool) {
        ...
        if (pool.poolType == 0 || (pool.poolType == 1 && 
            data.stakedTime + pool.configs[2] * ONE_DAY_IN_SECONDS >= block.timestamp)) return true;
    ...
    */
    ...
    function setDAYINSECOND(uint256 _value) public onlyOwner {
        ONE_DAY_IN_SECONDS = _value;
    }
