...
contract bbit is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "bbit";
    string private _symbol = "bbit";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x109F7711DfA80Bc30b146212659784ef99B82Da0); 
    address payable public teamWalletAddress = payable(0x109F7711DfA80Bc30b146212659784ef99B82Da0); 
