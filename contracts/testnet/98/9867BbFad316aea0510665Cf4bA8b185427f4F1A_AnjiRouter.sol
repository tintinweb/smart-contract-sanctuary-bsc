...
contract AnjiRouter is IPancakeRouter02, Ownable {
        ...
        returns (uint[] memory amounts)
    {
        ...
        return PancakeLibrary.getAmountsOut(dex.initHash, dex.factory, amountIn, path, dex.fee);
    }
    ...
    {
        DEX memory dex = dexList[dexId];
        return PancakeLibrary.getAmountsIn(dex.initHash, dex.factory, amountOut, path, dex.fee);
    }
}