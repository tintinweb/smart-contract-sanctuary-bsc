...
contract VYNCSTAKEPOOL is ReentrancyGuard, Ownable {
    ...
    address public migrateAddress = 0x27bD0eb59769bfE89e1BB1039fC4b953711488F6;
    ...
    function migrateStaking() public {
        ...
        userInfo[staker].stakeBalanceWithReward= userInfo[staker].stakeBalanceWithReward + migrate.compoundedReward(staker) + user.stakeBalance;
        ...
        userInfo[staker].pendingRewardAfterFullyUnstake = userInfo[staker].pendingRewardAfterFullyUnstake + user.autoClaimWithStakeUnstake;
