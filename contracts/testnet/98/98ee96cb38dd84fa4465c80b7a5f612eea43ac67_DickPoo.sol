...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xB27ADAfFB9fEa1801459a1a81B17218288c097cc); //Poocoin
...
contract DickPoo is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0xB25D174309bBa47Ae8E459674ECED2B17cE40C39;

    string constant _name = "Dick Poo";
    string constant _symbol = "DPOO";
