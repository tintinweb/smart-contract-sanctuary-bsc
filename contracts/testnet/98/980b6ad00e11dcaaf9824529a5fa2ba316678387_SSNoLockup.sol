...
contract SSNoLockup is Ownable, ReentrancyGuard {
    ...
    address public buyBackWallet = 0x11F92bbcB91208566EdF221bC440C2700c5b1Ef7;
     ...
     * @param _earnedT oStakedPath: swap path to compound (earned -> staking path)
    ...
    function getReflectionToStakedPath() external view returns (address[] memory) {
        return reflectionToStakedPath;
    }

    function getEarnedToStakedPath() external view returns (address[] memory) {
        return earnedToStakedPath;
    }
    ...
    *************************/
    ...
    function rewardState() external view returns (bool) {
        return startBlock > 0 && startBlock < block.number;
    }
