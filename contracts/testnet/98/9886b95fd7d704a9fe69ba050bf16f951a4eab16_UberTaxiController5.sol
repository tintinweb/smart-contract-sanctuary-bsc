...
contract UberTaxiController5 is Ownable {
    ...
    constructor() {
        ...
        UTD = UberTaxiDate(0x1B3B6EF920BA71763a91024AFC4f10419C27500f);
    ...
    function openBlindBox() public {
        ...
        UTD.setUtaxiDetails(msg.sender, 6, "Open BlindBox", 0, UTD.blindBoxPrice().div(10 ** 18), block.timestamp);
    ...
    function buyVehicle(uint256 index, uint8 tokenType) public {
        ...
        if (tokenType == 1) {
            ...
            UTD.setUtaxiDetails(msg.sender, 6, '', index, uPrice.div(10 ** 18), block.timestamp);
        }  
        ...
        if (welMember != address(0)) {
            ...
            UTD.setUtaxiDetails(welMember, 4, UTBC.toString(msg.sender), 0, commissionFee.div(10 ** 20), block.timestamp);
        }
    ...
    function exchange(uint256 exchangeNum) public {
        ...
        UTD.setUtaxiDetails(msg.sender, 3, UTBC.toString(msg.sender), 0, exchangeNum, block.timestamp);
    ...
    function playerTransfer(address addr, uint256 transferNum) public {
        ...
        UTD.setUtaxiDetails(msg.sender, 2, UTBC.toString(addr), 0, transferNum, block.timestamp);

        UTD.setUtaxiDetails(addr, 1, UTBC.toString(msg.sender), 0, transferNum, block.timestamp);
    ...
    function addUserUTAXINum(address addr, uint256 UTAXINum) public onlyOwner {
        ...
        UTD.setUtaxiDetails(addr, 1, UTBC.toString(msg.sender), 0, UTAXINum, block.timestamp);
    }
