...
contract SuperLoverToken is ERC20, Ownable {
    ...
    uint256 private totalSupply_ = 10E24 * (10**2);
    ...
    uint256 public minimumTokenBalanceForDividends = 10E20 * (10**2);
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if(ammPairs[from]){
                ...
                finalAmount = amount.sub(_LiquidityFee).sub(_USDTBonusFee).sub(_MarketingFee).sub(_DeadFee);
