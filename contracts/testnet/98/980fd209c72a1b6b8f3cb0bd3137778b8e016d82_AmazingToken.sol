...
contract AmazingToken is StandardToken {
    using SafeMath for uint256;
    string constant public name = "Amazing Token";
    string constant public symbol = "AMZG";
    ...
    function setSwap(bool input) public onlyOwner returns (bool) {
        swapEnable = input;
        return true;
    }
