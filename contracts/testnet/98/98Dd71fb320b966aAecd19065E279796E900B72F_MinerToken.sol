...
contract MinerToken is ERC20, Ownable {
    ...
    uint256 public _totalFeesOnBuy = 0;
    uint256 public _totalFeesOnSell = 0;

    address public  marketingWallet = 0x2DC79ae7b46e7B1d92724D499156e13c7b2Ef93D;
    ...
    constructor()ERC20("MToken",  "Mtoken") {
        operator = msg.sender;
        ...
        swapWithLimit = false;
        setTotalSupply(1_000_000_000 * 1e18);
        setBalance(owner(),totalSupply());
        emit Transfer(address(0), owner(), totalSupply());
        swapTokensAtAmount = totalSupply() / 5000;   //  200_000 Tokens
    ...
    function setEnableTrading() public onlyOperator{
