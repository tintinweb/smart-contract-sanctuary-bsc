...
contract Caviar is ERC20, ERC20Burnable, Ownable{

    event SetMinter(address indexed admin, address indexed minter, bool authorized);
    event SetMarket(address indexed admin, address indexed market);
    ...
    function setMarket(IMarket _market) external onlyOwner {
        ...
        emit SetMarket(msg.sender, address(_market));
    }
}
