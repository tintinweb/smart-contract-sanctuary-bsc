    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        openChestFee = 15000000000000000;
        _setupRole(
            OPERATOR_ROLE,
            address(0xE3612c68f112a7A7fe65713B90fd16211600a6A3)
        );
        _setupRole(
            OPERATOR_ROLE,
            address(0x92ff745EdC6E840e436d00781d7326019A7202C7)
        );
        _setupRole(
            OPERATOR_ROLE,
            address(0xda2c9d85A2B0ff1a1b0215423723DFa59035e14b)
        );
    }
    ...
    */
    ...
    //@dev update treasury wallet address.
    function setLockChest(bool _lockChest) external onlyOwner {
        lockChest = _lockChest;
    }
