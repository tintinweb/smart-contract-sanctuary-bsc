...
contract CEEKLandGateTest {
    using Address for address payable;
    using Address for address;

    function buyTF(EIP20 currency, address spender) public {
        require(currency.transferFrom(msg.sender, spender, 100), "CEEKLANDGATE_022");
    }

    function buyT(EIP20 currency, address spender) public {
        require(currency.transfer(spender, 100), "CEEKLANDGATE_022");
    }
