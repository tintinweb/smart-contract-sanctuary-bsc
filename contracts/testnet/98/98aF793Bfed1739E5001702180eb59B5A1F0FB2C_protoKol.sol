...
contract protoKol is iProtoKol {
   ...
   */
    function updateCampaign(
        ...
        require(_tgeDate >= campaignDetails.campaignData.startDate + 21 * 1 days, "TGE>21 days start date");
        require(_tgeDate + 14 days <= campaignDetails.campaignData.endDate, "TGE>14 days end Date");
  ...
  @param _campaignId - Campaign Id 
   */
    function claimKOLInvestment(uint256 _campaignId) external nonReentrant onlyCampaignOwners(_campaignId) {
        require(
   ...
   */
    function blackListKOL(
        ...
        if (campaigns[_campaignId].campaignData.preSaleToken != _USDT) {
            ...
            uint256 presaleShare = (((_reward + investedCampaignDetails[msg.sender][_campaignId].claimedReward) *
                10000) / eligibleRwd);
    ...
    function _blackListedKOLFundsHandling(
        ...
        if (campaigns[_campaignId].campaignData.preSaleToken != _USDT && presaleShare != 10000) {
            leftOverInvestment =
