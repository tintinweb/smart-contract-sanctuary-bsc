...
interface IGetdoneDisputation {
    function create(uint256 merchantId, uint256 appId, uint256 contractId, address customer, address sender)  external returns(address);
}
...
contract GetdoneEscrow is OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, AccessControlEnumerableUpgradeable, GetdoneApp{
        ...
        returns (uint256)
    {
        ...
        address disputationBanker = IGetdoneDisputation(disputationAddress).create(merchantId, appId, contractId, customer, sender);
