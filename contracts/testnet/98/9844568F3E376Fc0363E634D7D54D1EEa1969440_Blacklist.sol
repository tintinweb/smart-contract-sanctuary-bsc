...
contract Blacklist is Ownable {
    ...
    function getBlacklistDetails(address _address, address _contract) external view returns (BlacklistType blacklist_type, uint256 blacklistStart, uint256 blacklistEnd, uint256 blacklistCount, uint is_blacklisted) {
        BlacklistInfo memory blacklist = _blacklistInfo[_address][_contract];

        return (blacklist.blacklist_type,blacklist.blacklistStart,blacklist.blacklistEnd,blacklist._blacklistCount,blacklist._isBlacklisted);
    }
