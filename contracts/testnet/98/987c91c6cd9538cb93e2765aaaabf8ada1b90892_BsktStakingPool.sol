...
contract LPTokenWrapper is Ownable, ReentrancyGuard {
    ...
    IERC20 public BSKTASREWARD =
        IERC20(0x2873d85EcFFC2c16Ed3077e9bCF7AfC0c945dC31); // Approve and Transfer for Stake and Withdraw
...
contract BsktStakingPool is LPTokenWrapper {
    IERC20 public STAKEBSKT =
        IERC20(0x2873d85EcFFC2c16Ed3077e9bCF7AfC0c945dC31); // BSKT TOKEN ADDRESS
