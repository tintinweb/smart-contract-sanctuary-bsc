...
contract KyotoLaunchpad {
     ...
     * @param idoID ID of the IDO
     */
    function invest(string calldata idoID, uint256 _amount) external payable {
        _checkForIDOExist(idoID);
        require(
            _amount > 0,
        ...
        require(
            ...
            "KyotoLaunchPad: Public investment has not started yet"
        );
        require(
            _idos[idoID].idoCloseTimestamp > block.timestamp,
            "KyotoLaunchPad: Public investment has ended"
        );
