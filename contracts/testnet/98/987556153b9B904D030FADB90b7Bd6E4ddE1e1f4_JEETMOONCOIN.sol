...
contract JEETMOONCOIN is IBEP20, Auth {
    ...
    string constant _name = "JeetMoon";
    string constant _symbol = "JMOON";
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        ...
        if(selling) { totalFee = totalFee.add(sellFee); } else { totalFee = totalFee.add(buyFee); } 
        return totalFee;
    }
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _buyFee, uint256 _sellFee, uint256 _feeDenominator) external authorized {
