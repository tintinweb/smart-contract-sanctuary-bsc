...
/**
    ...
    ███████║╚██████╔╝███████╗╚██████╔╝  ╚██████╗╚██████╔╝██║ ╚████║   ██║   ██║  ██║██║  ██║╚██████╗   ██║
    ╚══════╝ ╚═════╝ ╚══════╝ ╚═════╝    ╚═════╝ ╚═════╝ ╚═╝  ╚═══╝   ╚═╝   ╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝   ╚═╝
				                        Official Contract for SOLOMETAVERSE.

    📣 Telegram: https://t.me/EverCashOfficial
    🌐 Website: https://solometaverse.net/
    🐤 Twitter: https://twitter.com/MetaverseSolo
    📷 Instagram: https://www.instagram.com/solo_metaverse/
      
    6% tax on all transactions:

    (2%) locked liquidity pool
    (2%) kickback to wallet for marketing + developer
    (2%) kickback to wallet for buy back and burn
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5BC11153d246A6B3B51E447c02ae743d9BEeC39f;
...
contract SOLOMETAVERSE is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x40ed85E760De8b015d13E52858527922ed3EFE4c;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "SOLOMETAVERSE";
