...
contract RewardManager is Context, Ownable, ReentrancyGuard, ERC721Holder, ERC1155Holder {
    ...
    /// @param winningPositions_ as number of winners.
    ...
    function depositRewards(
        ...
        // Update reward count.
        depositedRewardsCount += tokenIDs.length;
    }
    ...
    function claimRewards(uint256 position) external nonReentrant {
        ...
        if (depositedRewardsCount == claimedRewardsCount)
...
contract Race is IRace, Context, Ownable, RewardManager, TokenWithdrawer {
    ...
    function reclaimFee() external override nonReentrant {
        require(raceState == RaceState.CANCELLED, "Race is not cancelled");
        require(raceAccess == RaceAccess.OPEN, "Admin-access races have no fees.");
