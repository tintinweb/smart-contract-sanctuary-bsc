...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xF0f9681aaaEfF594AA5e184d8F7a0BDDa7258760;
...
contract WalletGem is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xd78B64abE6127F15e0c2D5C6b482fFd3F7711389;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "WalletGem";
    string private _symbol = "WGEM";
