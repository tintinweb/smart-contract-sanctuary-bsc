...
contract RototoXAlphaV1 is IERC20, ReentrancyGuard {
        ...
        returns (bool)
    {
        ...
        bool success = dex.transferOwnership(newOwner);
        owner = newOwner;
    ...
    function renounceOwnership() public override onlyOwner returns (bool) {
        ...
        bool success = dex.renounceOwnership();
        owner = address(0);
...
contract RototoXDex is IRototoXDex {
    ...
    mapping(address => uint256) remainingTokensPermittedToSell;
    ...
    constructor(
        ...
        token = RototoXAlphaV1(payable(_tokenSmartContract));
