...
contract Quiz is ERC721URIStorage, Ownable {
    ...
    function createQuizRoom (uint256 _quizID, uint256 _nftID, uint256 _oddsType, uint256 _maxRoomNumber, uint256 _roomTax, uint256 _minUserJoinAmount) public {
    ...
    function userWithdrawal (address _address, uint256[] memory _indexList) public {
        ...
        for (uint256 _index = 0; _index < _indexList.length; _index = _index + 1) {
            ...
            if (quizList[_quizID].result == userRecordList[_address][_recordIndex].result) {
                ...
                _totalAmount = _totalAmount + _amount + _winAmount / 1000 * (1000 - platformTax);
            }
        }
