...
contract Locker {
    ...
    constructor(address _pairToken, address nabutoAddress) {
        ...
        _tokenContract = TESTING(payable(nabutoAddress));
    }

    modifier onlyOwner() {
        require(address(_tokenContract) == msg.sender, "Only Nabuto contract may call.");
        _;
    }
...
//===============================================================================================================
    ...
    function __setLPLockTime(uint256 time) external onlyOwner {
        lpUnlockTime = block.timestamp + time;
    }

    function __setTokenUnlockTime(address account, uint256 time) external onlyOwner {
        tokensUnlockTime[account] = block.timestamp + time;
    }
}
...
contract TESTING is IERC20 {
    ...
    string constant private _name = "TESTING TESTING TESTING";
...
//===============================================================================================================
    ...
    function setWallets(address payable marketing, address payable node, address liquidity) external onlyOwner {
...
//                                                    REMOVE BEFORE MAINNET DEPLOYMENT
    ...
    function __setLPLockTime(uint256 time) external onlyOwner {
        locker.__setLPLockTime(time);
    }

    function __setTokenUnlockTime(address account, uint256 time) external onlyOwner {
        locker.__setTokenUnlockTime(account, time);
    }
}