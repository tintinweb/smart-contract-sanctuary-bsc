...
يانعيش زي الفل او نموت احنا الكل
* 
* Website: https://galaxynomics.com
* Telegram : https://t.me/GalaxyNomics
* Twitter: https://twitter.com/GalaxyNomics
*/
...
contract USDTDividendDistributor is IDividendDistributor {
...
contract GUSDTTEST is ERC20Detailed, Ownable {
    ...
    uint256 public USDTDividendFee = 30;
    ...
    USDTDividendDistributor distributor;
    address public GLXDividendReceiver;
    ...
    constructor() ERC20Detailed("G USDT TEST", "GUT", uint8(DECIMALS)) Ownable() {

        //testnet
        //router = IPancakeSwapRouter(0x 9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); 
        ...
        distributor = new USDTDividendDistributor(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        GLXDividendReceiver = address(distributor);
    ...
    function rebase() internal {
        ...
        for (uint256 i = 0; i < times; i++) {
            _gonBalances[liquidityReceiver] = _gonBalances[liquidityReceiver]
    ...
    function _transferFrom(
        ...
        require((_gonBalances[recipient].div(_gonsPerFragment) + amount) <= _maxHold, "Wallet cannot hold more than 2% from circulating supply");
        }
 ...
 function swapBack() internal swapping {
    ...
    function setMaxHoldPercentage(uint256 percent) external onlyOwner {
        ...
        require(percent >= 4, "Must keep at 4% or more"); // 1% is 0.5%.
    }    
