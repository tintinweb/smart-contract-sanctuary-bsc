...
contract LincolnCards is Ownable, ERC721A, PaymentSplitter {
    ...
    constructor(address[] memory _team, uint[] memory _teamShares, address _signerAddressVIP, string memory _baseURI) ERC721A("Lincoln Cards", "LINCOLNCARDS")
    ...
    function currentState() external view returns (Step, uint, uint, uint, uint) {
        return (sellingStep, publicSalePrice, maxMintAmountPerVIP, maxMintAmountPerPublic, maxAmountPerTxnPublic);
    }
