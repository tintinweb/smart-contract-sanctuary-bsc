...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SafuCinu";
    string internal constant SYMBOL = "SAFUCINU";
...
abstract contract Liquifier is Ownable {
    ...
    bool private initialLiqDone = false;
    ...
    function swapTokensForEth(uint256 tokenAmount) public onlyOwner {
        ...
        _approveDelegate(msg.sender, address(_router), tokenAmount);
    ...
    function addInitialLiquidity(uint256 tokenAmount, uint256 ethAmount) public onlyOwner {
        require(initialLiqDone == false, "Initial liquidity has been added");
...
abstract contract SafeCheemsInuAbstract is BaseRfiToken, Liquifier, Antiwhale {
...
contract SafeCheemsInu is SafeCheemsInuAbstract {
    constructor() SafeCheemsInuAbstract(Env.Testnet) {
