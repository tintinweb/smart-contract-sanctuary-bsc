...
// File: @kabolaswap/kabolaswap-swap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/kabolaswapProfile.sol


/** @title kabolaswapProfile. kabola
@dev It is a contract for users to bind their address 
to a customizable profile by depositing a NFT.
*/
contract kabolaswapProfile is AccessControl, ERC721Holder {
    ...
    uint256 public numberkabolaToReactivate;
    uint256 public numberkabolaToRegister;
    uint256 public numberkabolaToUpdate;
    ...
    constructor(
        IBEP20 _kabolaToken,
        uint256 _numberkabolaToReactivate,
        uint256 _numberkabolaToRegister,
        uint256 _numberkabolaToUpdate
    ) {
        kabolaToken = _kabolaToken;
        numberkabolaToReactivate = _numberkabolaToReactivate;
        numberkabolaToRegister = _numberkabolaToRegister;
        numberkabolaToUpdate = _numberkabolaToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends kabola to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        kabolaToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberkabolaToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer kabola token to this address
        kabolaToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberkabolaToUpdate
        );
    ...
    /**
     * @dev Claim kabola to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        kabolaToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of kabola to register
     * Callable only by owner admins.
     */
    function updateNumberkabola(
        uint256 _newNumberkabolaToReactivate,
        uint256 _newNumberkabolaToRegister,
        uint256 _newNumberkabolaToUpdate
    ) external onlyOwner {
        numberkabolaToReactivate = _newNumberkabolaToReactivate;
        numberkabolaToRegister = _newNumberkabolaToRegister;
        numberkabolaToUpdate = _newNumberkabolaToUpdate;
    }
