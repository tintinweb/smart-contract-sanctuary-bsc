...
contract DividendDistributor is IDividendDistributor {
    ...
    ERC20 RWRD = ERC20(0x2b591e99afE9f32eAA6214f7B7629768c40Eeb39);
    ...
    uint256 public dividendsPerShareAccuracyFactor = 10 ** 36;                               //contract by @smartpepe
...
contract mytoken is ERC20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Kalia";
    string constant _symbol = "KTA";
    ...
    receive() external payable { }                                     //contract by @smartpepe
