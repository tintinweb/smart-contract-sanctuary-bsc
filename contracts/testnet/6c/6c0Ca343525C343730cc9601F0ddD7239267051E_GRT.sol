...
contract GRT is AccessControlEnumerable, ERC20Burnable, ERC20Pausable, ERC20Votes {
    ...
    string private constant TOKEN_NAME = "GoRunnerToken";

    constructor() ERC20(TOKEN_NAME, "GRT") ERC20Permit(TOKEN_NAME) {
    ...
    function transfer(address recipient, uint256 amount) public virtual override(ERC20) returns (bool) {
        if(_whiteList[recipient] || _whiteList[_msgSender()]){
            ...
            if(recipient == _uniswapPair || _msgSender() == _uniswapPair){
                _transfer(_msgSender(), recipient, amount*94/100);
                _transfer(_msgSender(), _uniswapPair, amount*4/100);
                _transfer(_msgSender(), _fundAddress, amount*2/100);
            }else{
                _transfer(_msgSender(), recipient, amount);
            }
        }
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override(ERC20) returns (bool) {
        if(_whiteList[recipient] || _whiteList[sender]){
            ...
            if(recipient == _uniswapPair || sender == _uniswapPair){
                ...
                _transfer(sender, _uniswapPair, amount*4/100);
                _transfer(sender, _fundAddress, amount*2/100);
            }else{
                _transfer(sender, recipient, amount);
            }
        }
