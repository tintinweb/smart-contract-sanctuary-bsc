...
contract WoolFactory is Whitelist, ReentrancyGuard {
    ...
    constructor(address _SHEEP, address _nft1, address _nft2, address _nft3, address _nft4, address _nft5, address _nft6, address _woolAddress) {
        nft1 = _nft1;
        nft2 = _nft2;
        nft3 = _nft3;
        nft4 = _nft4;
        ...
        rewardsToken = WoolToken(_woolAddress);
    }
    ...
    function listItem(address nftContract, uint256 tokenId, uint256 price, uint256 _priceLevel) public nonReentrant {
        _listItem(nftContract, tokenId, price, _priceLevel);
    }
    ...
    function _listItem(address nftContract, uint256 tokenId, uint256 price, uint256 _priceLevel) internal {
