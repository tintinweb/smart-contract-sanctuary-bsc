...
contract Airdrops is Initializable {
    ...
    function setShareForEBSCReward(address user,uint _prevLock, uint256 _amount) public onlyStaking{
        uint lock;
        uint amount;
        ...
        console.log("totalstakeEBSC",_prevLock, totalstakeEBSC, _amount);
        if(lock == 3){
            amount = amount * 15 / 10;
        }else if(lock == 4){
            amount = amount * 30 / 10;
        ...
        console.log("totalstakeEBSC", totalstakeEBSC);
        s1EBSC[user] = SEBSC;
    }
