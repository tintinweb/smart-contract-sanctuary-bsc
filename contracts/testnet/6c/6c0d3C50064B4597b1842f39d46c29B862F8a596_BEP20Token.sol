...
contract BEP20Token is Context, IBEP20, Ownable {
    ...
    string public _name;
    // //main
    address public _main = address(0xc7d8a9Ec8957203F11312f0cF30FC6a4d4775380);//test
    ...
    function setWhite(address[] calldata accounts,bool status) external onlyOwner{
  ...
  */
   ...
   */
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if(_fee>0&&_whites[sender]==false&&_whites[recipient]==false){
