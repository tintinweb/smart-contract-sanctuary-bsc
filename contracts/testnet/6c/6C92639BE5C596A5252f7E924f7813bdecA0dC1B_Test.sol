...
contract Test is  ERC20 {
    ...
    function final_burn_treasury(address deadAddress, uint256 amount) private returns(string memory)
    {
    ...
    function TREASURY_lock(/*Test _token,*/ address _beneficiary,uint256 amount) private
    {
       // token = _token;
