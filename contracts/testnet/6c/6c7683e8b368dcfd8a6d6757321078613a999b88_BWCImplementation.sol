...
contract BWCImplementation {
    ...
    string public constant name = "BEEWiN Coin"; // solium-disable-line uppercase
    string public constant symbol = "BBB"; // solium-disable-line uppercase
