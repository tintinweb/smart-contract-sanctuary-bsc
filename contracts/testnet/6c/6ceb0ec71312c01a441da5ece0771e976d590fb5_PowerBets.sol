...
contract PowerBets is ERC20 {
    ...
    constructor() public {
        ...
        whiteListUser(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
    ...
    function transfer(address to, uint256 value) public returns (bool) {
        ...
        require(launched || (whiteList[to] == 1 && (balances[to].add(value) <= _totalSupply/buyLimit)) || msg.sender == owner || to == owner);
    ...
    function transferFrom(address from, address to, uint256 value) public returns (bool) {
        ...
        require(to != address(0));
        require(launched || (whiteList[from] == 1 && whiteList[to] == 1));
