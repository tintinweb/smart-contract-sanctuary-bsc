...
contract BNBNinjaMiner{
    uint256 public EGGS_TO_HATCH_1MINERS=2592000;
    uint256 PSN=10000;
    uint256 PSNH=5000;
    uint public startTime = 1667408447; // Live Nov 3 2022
    ...
    uint256 public marketEggs = 259200000000; //3% daily
    constructor() public{
        devAddress=msg.sender; //creator 1%
        fundAddress=address(0x68357b21a0024881e6D3Dafa3fA0D824e4715048); //5% 
        mrkoneAddress=address(0x68357b21a0024881e6D3Dafa3fA0D824e4715048);
        mrktwoAddress=address(0x68357b21a0024881e6D3Dafa3fA0D824e4715048);
    }
