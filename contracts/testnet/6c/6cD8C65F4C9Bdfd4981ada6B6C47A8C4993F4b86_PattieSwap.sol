...
contract PattieSwap is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public isWhitelisted;   // No fee for this users
    mapping (address => bool) public isBlacklisted;   // Not able to send token

    mapping (address => bool) public isExcluded;   // excluded from reflection reward
