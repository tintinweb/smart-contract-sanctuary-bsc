...
contract BMX is Ownable, Stakeable {
    ...
    /**
     * @notice adminAccount will return the admin account address
     */
     ...
     */
    function publicSaleStart(uint256 token_price) external {
    ...
    function buyToken(uint256 amount) external payable {
        require(
            ...
            "BMX: Insufficient fond"
        );
        _transfer(_adminAccount, msg.sender, amount);
    }
