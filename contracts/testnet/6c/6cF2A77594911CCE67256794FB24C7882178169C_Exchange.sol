...
*/
	function exchange1To2(uint256 v0) public {
		...
		ERC20(0x3D17cF5d030Cc7320F82A2966fc3c2798e4cB20F).transferFrom(msg.sender, address(this), v0);
		from1To2AmtInBank  = (from1To2AmtInBank + ((v0 * tax1To2rate * uint256(100)) / uint256(100000000)));
		require((ERC20(0x50b596Bc1969253d99D0B9c50f7d50DBB38960cc).balanceOf(address(this)) >= ((((v0 * (uint256(1000000) - tax1To2rate)) / uint256(1000000)) * exchange1To2rate) / uint256(1000000000000000000))), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0x50b596Bc1969253d99D0B9c50f7d50DBB38960cc).transfer(msg.sender, ((((v0 * (uint256(1000000) - tax1To2rate)) / uint256(1000000)) * exchange1To2rate) / uint256(1000000000000000000)));
...
*/
	function withdrawReferral1To2(uint256 _amt) public {
		...
		require((ERC20(0x3D17cF5d030Cc7320F82A2966fc3c2798e4cB20F).balanceOf(address(this)) >= _amt), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0x3D17cF5d030Cc7320F82A2966fc3c2798e4cB20F).transfer(msg.sender, _amt);
...
*/
	function from1To2WithdrawAmt() public onlyOwner {
		require((ERC20(0x3D17cF5d030Cc7320F82A2966fc3c2798e4cB20F).balanceOf(address(this)) >= from1To2AmtInBank), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0x3D17cF5d030Cc7320F82A2966fc3c2798e4cB20F).transfer(msg.sender, from1To2AmtInBank);
...
*/
	function withdrawToken1(uint256 _amt) public onlyOwner {
		require((ERC20(0x3D17cF5d030Cc7320F82A2966fc3c2798e4cB20F).balanceOf(address(this)) >= (_amt + totalUnclaimedRewards1To2 + from1To2AmtInBank)), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0x3D17cF5d030Cc7320F82A2966fc3c2798e4cB20F).transfer(msg.sender, _amt);
	}
...
*/
	function withdrawToken2(uint256 _amt) public onlyOwner {
		require((ERC20(0x50b596Bc1969253d99D0B9c50f7d50DBB38960cc).balanceOf(address(this)) >= _amt), "Insufficient amount of the token in this contract to transfer out. Please contact the contract owner to top up the token.");
		ERC20(0x50b596Bc1969253d99D0B9c50f7d50DBB38960cc).transfer(msg.sender, _amt);
	}
