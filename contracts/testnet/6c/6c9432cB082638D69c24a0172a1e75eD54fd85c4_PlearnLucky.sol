...
contract PlearnLucky is IPlearnLucky, ReentrancyGuardUpgradeable, OwnableUpgradeable {
     ...
     */
    function buyTickets(uint256 _luckyId, uint32 _numberTickets) external override notContract nonReentrant {
     ...
     */
    function closeLucky(uint256 _luckyId) external override onlyOperatorOrOwner nonReentrant {
...
interface IPlearnLucky {
     ...
     * @dev Callable by users
     */
    function buyTickets(uint256 _luckyId, uint32 _numberTickets) external;
