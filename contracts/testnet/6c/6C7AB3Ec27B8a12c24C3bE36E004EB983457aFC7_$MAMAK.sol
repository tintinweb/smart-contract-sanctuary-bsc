...
contract $MAMAK is Context, IERC20, Ownable {
    ...
    uint256 private _prSaleStartTime = MAX;
    uint256 private _prSaleMinAmount = 20000 * 10**18;
    uint256 private _prSaleFee = 2;
    uint256 private _prSalePrice = 0.3 ether;
    uint256 private _prSaleEndTime = MAX;
    uint256 private _softCap = 0;
    uint256 private _hardCap = MAX;
    uint256 private _totalRaised = 0;
    ...
    function cap() external view returns (uint256, uint256) {
