...
contract Staking is Context, Pausable, Ownable {
    ...
    address public FeeCollector2 = address(0);
    address public Dev = address(0xC726Ac99258552bFa2AbaABA47126a8335400299);
    ...
    function renounceDEV() external onlyDev {
        Dev = address(0);
    }
    ...
    function changeFeeCollector1(address newFeeAddress) external onlyOwner { 
