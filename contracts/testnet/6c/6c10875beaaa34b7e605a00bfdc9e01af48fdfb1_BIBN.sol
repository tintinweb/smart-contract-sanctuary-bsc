...
// solhint-disable
contract BIBN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xBCd288919D49F4880517780694557aD5268dAf21);
    ...
    string private constant _name = "Biba Inu";
    string private constant _symbol = "BIBN";
