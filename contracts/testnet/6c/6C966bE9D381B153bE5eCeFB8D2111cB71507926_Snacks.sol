...
contract Snacks is ERC20 {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    // The ZOINKS TOKEN!
    IERC20 public _zoinks;
    ...
    address public ZOINKSBUSD;

    address public SNACKSPOOL;

    address public ZOINKSPOOL;

    address public SENIORAGE = 0x1562C9d2525D37d7f610D0e8b170C7f583FDDcC2;
    ...
    constructor(IERC20 zoinks_) ERC20("SNACKS", "SNACKS") {
        _zoinks = zoinks_;
    }
    ...
    function buy(uint256 amount_) public {
        ...
        require(_zoinks.balanceOf(address(msg.sender)) >= zoinksAmount, "ERC20: lack zoinks in contract");  

        _zoinks.safeTransferFrom(address(msg.sender), address(this), zoinksAmount);
       ...
       // _mint(ZOINKSPOOL, feeAmount.mul(5).div(100));
        _mint(SENIORAGE, feeAmount.mul(85).div(100));
    ...
    function redeem(uint256 amount_) public {
        ...
        require(_zoinks.balanceOf(address(this)) >= zoinksAmount, "ERC20: lack zoinks in contract");  
        ...
        _zoinks.transfer(address(msg.sender), zoinksAmount);   
