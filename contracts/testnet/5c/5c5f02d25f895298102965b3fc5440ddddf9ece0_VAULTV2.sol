...
contract VAULTV2 is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 24000000000000 * 10**9;
    ...
    uint256 public numTokensSellToAddToLiquidity = 2400000000 * 10**9;
    ...
    function setMarketingWallet(address _marketingWallet) external onlyOwner {
        require (_marketingWallet != address(0), "ERC20: Marketing wallet cannot be zero address");
    ...
    function blacklistAddress (address account, bool blacklist) external onlyOwner {
        require (_isBlacklisted[account] != blacklist, "Already blacklisted ");
        require (account != uniswapV2Pair, "Can't be blacklisted");
    ...
    function withdrawExcessBNB() external onlyOwner {
        ...
        if (contractBNBBalance > 0)
            payable(devWallet).transfer(contractBNBBalance);
    ...
    function withdrawOtherTokens(address _token) external onlyOwner {
        ...
        require (_token != address(0), "ERC20: cannot withdraw to zero address");
    ...
    function _approve(
        ...
        private
        preventBlacklisted(owner, "VOLT: Owner address is blacklisted")
        preventBlacklisted(spender, "VOLT: Spender address is blacklisted")
    {
    ...
    function _transfer(
        ...
        private
        preventBlacklisted(_msgSender(), "VOLT: Address is blacklisted")
        preventBlacklisted(from, "VOLT: From address is blacklisted")
        preventBlacklisted(to, "VOLT: To address is blacklisted")
    {
