...
contract LUNADAO is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x620498550906939Fa777c8005ecFe87910FFE47d));
        marketingWalletAddress = payable(address(0x620498550906939Fa777c8005ecFe87910FFE47d));
