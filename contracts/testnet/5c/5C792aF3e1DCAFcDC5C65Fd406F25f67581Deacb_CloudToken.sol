...
contract CloudToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CP USDX";
    string private _symbol = "CP";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x35c4B504A3a30F0B0803d40de089Df75f723c04d);   //change the wallet address
    ...
    uint256 public total_liq_pairs = 0;
