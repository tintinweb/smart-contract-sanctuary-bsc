...
* The smart contracts that run LASM implement the latest trend in BSC tokens, 
...
contract LASM is ERC20, ERC20Burnable, Ownable {
    ...
    address public manager = address(0xfDE865aB14d5dDF0F9fAD822DD9597EA6874393a);
    address public teamDevWalletAddress = address(0x53C45210937c365AA70d148a533130704E742Ae2);
    address public buyBackWalletAddress = address(0x2a163d7ba400Ae20A22085366ccbAAf52Db41aba);

    // vesting wallets
    address public constant locked = address(0x35eb4C5e5b240C6Ec155516385Db59327B3415B1);
    address public constant team = address(0xb37F5a0Da2630a9474791f606048538AEc5F1ca9);
    address public constant partners = address(0x6C53d1F3323Ca6F8a0d10Ed12B1248254DCd0453);
    address public constant marketing = address(0x51f68ddA6470C0aE5B7383F2af3614C582D80A0F);
    address public constant development = address(0xEf3fE1A4B8393ac016Ef57020c28E0487e0EdbDa);
    address public constant stakingRewards = address(0x4168CAc6FB9c95d19d8cAA39BfC0418ab41564C9);
    address public constant airdrop = address(0xe7bB7d8be65A11b4BA7141EE6E1CD85D13ad650C);
    ...
    constructor(address _vestingContract) ERC20("testtoken", "test") {
    ...
    function setRewardsFee(uint256 value) external onlyOwner{
        require(value < 100, "Invalid percentage");
        rewardsFee = value;
