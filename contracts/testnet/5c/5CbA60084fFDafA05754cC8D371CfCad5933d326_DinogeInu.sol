...
contract DinogeInu is IBEP20, Ownable {
    ...
    string constant _name = "Dinoge Inu";
    string constant _symbol = "DINU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 2) / 2;  //100% max tx
    uint256 public _maxWalletAmount = (_totalSupply * 2) / 2;  //100% max wallet
    ...
    address public marketingFeeReceiver = 0x02Fc6368405A3ef48901a5d9e8855437D15bC077;
