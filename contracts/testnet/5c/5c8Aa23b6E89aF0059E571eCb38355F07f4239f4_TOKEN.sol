...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function setMaxAmount(uint256 _maxSellAmount,uint256 _maxBuyAmount,uint256 _walletLimit) public onlyOwner{
    ...
    function _tokenTransfer(
        ...
        if (takeFee) {
            ...
            if (isSell) {
                ...
                require(tAmount <= maxBuyAmount,"over max sell amount");
            } else {
                swapFee = _buyFundFee + _buyLPDividendFee;
                require(tAmount <= maxSellAmount,"over max buy amount");
            }
