...
contract SharedPlan is Ownable {
    ...
    IERC20 public QSQToken = IERC20(0x5C54769AD1ab671AA9C5138967E61d9C021Db0E6);
    IERC20 public usdtToken = IERC20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
    mapping (uint8 => uint256) comboMap;    // 套餐组合

    address platformAddress14 = 0x9AEA43C2F194B60691c43E0532fd5E51492870B3;
    ...
    address public QSQAddress = 0x5C54769AD1ab671AA9C5138967E61d9C021Db0E6;
    ...
    function buyIdentity (uint8 _key) public {
        ...
        // 20% 购买A币返回给用户
        swapTokensForU((_amount * 20)/100, msg.sender);
        // 14% 给平台
        usdtToken.transferFrom(msg.sender, platformAddress14, (_amount * 14)/100);
        // 19.8% 组LP 给用户锁仓
    ...
    function transferToken(address _address) public onlyOwner {
        ...
        QSQToken.transfer(_address, QSQToken.balanceOf(address(this)));
        lpAToken.transfer(_address, lpAToken.balanceOf(address(this)));
    }
}
