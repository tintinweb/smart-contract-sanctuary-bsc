...
// File @openzeppelin/contracts/utils/math/[email protected]0
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            hex"ecba335299a6693cb2ebc4782e74669b84290b6378ea3a3873c7231a8d7d1074" // bsc test
                        )
                    )
                )
            )
...
abstract contract Mt2TxFee is Mt1Dex {
    ...
    function _takeFee(
        ...
        super._transfer(from, feeReceiver, amount.sub(fee));
