...
// File contracts/SheraSwapper.sol
...
contract SheeraSwapper is Ownable {
    ...
    constructor(address sheera_v1, address sheera_v2, address owner) {
        ...
        require(_sheera_v2.decimals() == 9, "SheeraSwapper: invalid address of Shera V2");
    ...
    function doSwap() public {
        ...
        require(balance > 0, "SheeraSwapper: caller doesn't hold sheraV1");
        require(_sheera_v1.transferFrom(sender, address(this), balance), "SheeraSwapper: failed transferFrom");
        require(_sheera_v2.transferFrom(owner(), sender, balance), "SheeraSwapper: failed transfer");
