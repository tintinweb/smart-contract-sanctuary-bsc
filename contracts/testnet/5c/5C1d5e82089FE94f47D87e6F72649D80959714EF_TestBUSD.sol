...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); //busd test
...
contract TestBUSD is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "TestBUSD";
    string constant _symbol = "TB";
    ...
    uint256 public swapThreshold = _totalSupply * 1 / 20000;
    ...
    constructor () Auth(msg.sender) {
        ...
        anothermarketingWallet = 0xa0C95A002fd257B8174A5e30216f0EcCa0c4161E;
