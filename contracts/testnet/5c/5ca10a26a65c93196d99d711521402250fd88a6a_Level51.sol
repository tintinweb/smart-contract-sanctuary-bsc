...
contract Level51 is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Level 51';
    string private constant _symbol = 'L-51';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x375a49041ecE8eB4297A90259caB01CC0eD5ecED, 'We can not exclude Uniswap router.');
