...
contract XDIT is ERC20, Ownable {
    ...
    uint256 private _totalFeesOnBuy     = rewardFeeOnBuy + liquidityFeeOnBuy + marketingFeeOnBuy + developmentFeeOnBuy;
    uint256 private _totalFeesOnSell    = rewardFeeOnSell + liquidityFeeOnSell + marketingFeeOnSell + developmentFeeOnSell;

    address public marketingWallet = 0x29224fC97BcB2Df0ceCB56BC1E7b579708fFa3ea;
    address public developmentWallet = 0x29224fC97BcB2Df0ceCB56BC1E7b579708fFa3ea;
    ...
    function _transfer(
        ...
        if (launchedAt + 2 minutes > block.timestamp && antibotEnabled) {
            if(from == uniswapV2Pair) {
                ...
                require(amount <= 1e12, "Max sell amount at launch is 1000 Doxit");
                require(block.timestamp - lastTransactionTime[msg.sender] >= 30, "You need to wait 15 seconds before selling at launch");
                lastTransactionTime[msg.sender] = block.timestamp;
            }
        }
