...
/**
 *Join Our Comunity
Telegram: https://t.me/Cyber_Rodeo
Twitter: https://twitter.com/CyberRodeoBSC

Cyber Rodeo designed for multiple usecases such as DeFi, NFT, and Charity, 
and all integrated with blockchain, it`s time to unlock the power of your crypto.
...
contract CyberRodeo  is Context, IERC20, Ownable {
    ...
    string private _name = "CyberRodeo";
    string private _symbol = "$Rodeo";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF2f9f2fAC7fbf8E399A5542765315718F5388F0C);
    address payable public teamWalletAddress = payable(0xF2f9f2fAC7fbf8E399A5542765315718F5388F0C);
