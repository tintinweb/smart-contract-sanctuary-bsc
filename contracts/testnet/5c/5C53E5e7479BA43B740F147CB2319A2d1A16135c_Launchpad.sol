...
//contract BatchAuction {
  ...
  // BNB case
  uint256 private WITHDRAW_CAP_MIN = 2000e18; // 5 BNB, 2000 USDT
  uint256 private WITHDRAW_CAP_MAX = 100000e18; // 250 BNB, 10000 USDT
  uint256 private WITHDRAW_CAP_LIMIT = 300000e18; // 75 BNB, 30000 USDT
  uint256 private WITHDRAW_CAP_INTERCEPT = 2; // 2: BNB, USDT
  uint256 private WITHDRAW_CAP_INTERCEPT_PLUS = 10000e18; // 175 BNB, 10000 USDT
  uint256 private WITHDRAW_CAP_INTERCEPT_DIV = 7; // 7: BNB, USDT  
