...
contract Safuu is ERC20Detailed, Ownable {
    ...
    uint256 private constant MAX_SUPPLY = 1000000000000 * 10**7 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Safuu", "SAFUU", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x94Fb636125d2BE4c455617C7bca4152B82ae1B2A;
        treasuryReceiver = 0x62a611706e406F00765C40c247d4b37c3f831e10; 
        safuuInsuranceFundReceiver = 0xecE6899B5d697cC3DC2260b7E15aEE34886D6187;
        firePit = 0x0387dE770c38D1757cFc2beA7f41476FFdfF25cF;
