...
interface IUniswapV2Pair {
    ...
    event Transfer(address indexed from, address indexed to, uint256 value);//uint
    ...
    function totalSupply() external view returns (uint256);//uint

    function balanceOf(address owner) external view returns (uint256);//uint
    ...
    function approve(address spender, uint256 value) external returns (bool);//uint
    ...
    function nonces(address owner) external view returns (uint256);//uint

    function permit(
        address owner,
        address spender,
        uint256 value,//uint
        uint256 deadline,//uint
        uint8 v,
        bytes32 r,
        bytes32 s
    ) external;
    ...
    event Burn(
        ...
        uint256 amount0,//uint
        uint256 amount1,//uint
        address indexed to
    );
    event Swap(
        address indexed sender,
        uint256 amount0In,//uint
        uint256 amount1In,//uint
        uint256 amount0Out,//uint
        uint256 amount1Out,//uint
        address indexed to
    );
    event Sync(uint112 reserve0, uint112 reserve1);

    function MINIMUM_LIQUIDITY() external pure returns (uint256);//uint
    ...
    function price0CumulativeLast() external view returns (uint256);//uint

    function price1CumulativeLast() external view returns (uint256);//uint

    function kLast() external view returns (uint256);//uint

    function mint(address to) external returns (uint256 liquidity);//uint

    function burn(address to)
        external
        returns (uint256 amount0, uint256 amount1);//uint //uint
...
interface IUniswapV2Router01 {
    ...
    function addLiquidity(
        address tokenA,
        address tokenB,
        uint256 amountADesired,//uint
        uint256 amountBDesired,//uint
        uint256 amountAMin,//uint
        uint256 amountBMin,//uint
        address to,
        uint256 deadline//uint
    )
        external
        returns (
            uint256 amountA,//uint
            uint256 amountB,//uint
            uint256 liquidity//uint
        );

    function addLiquidityETH(
        address token,
        uint256 amountTokenDesired,//uint
        uint256 amountTokenMin,//uint
        uint256 amountETHMin,//uint
        address to,
        uint256 deadline//uint
    )
        external
        payable
        returns (
            uint256 amountToken,//uint
            uint256 amountETH,//uint
            uint256 liquidity//uint
        );
    ...
    function removeLiquidityETH(
        ...
        address to,
        uint256 deadline//uint
    ) external returns (uint256 amountToken, uint256 amountETH);//uint//uint
    ...
    function swapExactTokensForTokens(
        uint256 amountIn,//uint
        uint256 amountOutMin,//uint
        address[] calldata path,
        address to,
        uint256 deadline//uint
    ) external returns (uint256[] memory amounts);//uint

    function swapTokensForExactTokens(
        uint256 amountOut,//uint
        uint256 amountInMax,//uint
        address[] calldata path,
        address to,
        uint256 deadline//uint
    ) external returns (uint256[] memory amounts);//uint
    ...
    function swapExactETHForTokens(
        ...
        address to,
        uint256 deadline//uint
    ) external payable returns (uint256[] memory amounts);//uint
    ...
    function quote(
        uint256 amountA,//uint
        uint256 reserveA,//uint
        uint256 reserveB//uint
    ) external pure returns (uint256 amountB);//uint

    function getAmountOut(
        uint256 amountIn,//uint
        uint256 reserveIn,//uint
        uint256 reserveOut//uint
    ) external pure returns (uint256 amountOut);//uint

    function getAmountIn(
        uint256 amountOut,//uint
        uint256 reserveIn,//uint
        uint256 reserveOut//uint
    ) external pure returns (uint256 amountIn);//uint

    function getAmountsOut(uint256 amountIn, address[] calldata path)//uint
        external
        view
        returns (uint256[] memory amounts);//uint

    function getAmountsIn(uint256 amountOut, address[] calldata path)//uint
        external
        view
        returns (uint256[] memory amounts);//uint
}
