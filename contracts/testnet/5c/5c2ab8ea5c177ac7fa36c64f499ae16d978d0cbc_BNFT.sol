...
contract BNFT is Context, AccessControlEnumerable, ERC721Enumerable {
    ...
    mapping(uint256 => NFTDetails) public getNFTDetailsById;
    ...
    /// @return (uint)
    function getTokenProductivity(uint256 tokenId) external view returns (uint32) {
        NFTDetails memory currentNFTDetails = getNFTDetailsById[tokenId];
        return currentNFTDetails.productivity;
    }
    ...
    /// @param productivity Productivity of the NFA
    function mint(
        uint256 tokenId,
        address to,
        string memory name,
        ...
        _mint(to, tokenId);
        getNFTDetailsById[tokenId] = NFTDetails(
        name,
        rarity,
        productivity,
        other
