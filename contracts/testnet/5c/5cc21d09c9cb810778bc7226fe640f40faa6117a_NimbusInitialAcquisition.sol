...
contract NimbusInitialAcquisition is Initializable, NimbusInitialAcquisitionStorage {
    ...
    function isAllowedToRedeemVestingNFT(address user) public view returns (bool isAllowed, uint256 unclaimedBonus, uint256 unclaimedBonusNew) { 
    ...
    function updateNFTVestingContract(address nftVestingAddress, string memory nftUri) external onlyOwner {
        require(AddressUpgradeable.isContract(nftVestingAddress), "NimbusInitialAcquisition: NFTVestingContractAddress is not a contract");
        nftVesting = IVestingNFT(nftVestingAddress);
    ...
    function updateNFTCashbackContract(address nftCashbackAddress) external onlyOwner {
        require(AddressUpgradeable.isContract(nftCashbackAddress), "NimbusInitialAcquisition: NFTCashbackContractAddress is not a contract");
    ...
    function updateNFTSmartStakerContract(address nftSmartStakerAddress) external onlyOwner {
        require(AddressUpgradeable.isContract(nftSmartStakerAddress), "NimbusInitialAcquisition: NFTSmartStakerContractAddress is not a contract");
