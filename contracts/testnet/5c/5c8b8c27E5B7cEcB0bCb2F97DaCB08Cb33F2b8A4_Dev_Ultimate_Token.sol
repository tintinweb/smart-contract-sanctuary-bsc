...
contract Dev_Ultimate_Token is ERC20, ERC20Burnable, Ownable, Mintable {
    ...
    constructor()
        ERC20("Dev Ultimate Token", "DUT") 
        Mintable(1230000)
    {
        address supplyRecipient = 0x813Ad0f745d35EBab457843D5641a9A9913c6ba7;
        
        updateSwapThreshold(500 * (10 ** decimals()));

        devAddressSetup(0x813Ad0f745d35EBab457843D5641a9A9913c6ba7);
        devFeesSetup(1000, 1000, 1000);
        ...
        _transferOwnership(0x813Ad0f745d35EBab457843D5641a9A9913c6ba7);
    }
    ...
    function _transfer(
        ...
        bool canSwap = 0 + _devPending >= swapThreshold;
