...
contract ShibaEggs is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public routerCA = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 uniswap
    ...
    constructor() ERC20("ShibaEggs", "ShibEggs") {
        ...
        mktgWallet = address(0x9ba23a61c2dFcb7323894AFc08487032bb01586a); 
        devWallet = address(0x9ba23a61c2dFcb7323894AFc08487032bb01586a); 
        liqWallet = address(0x9ba23a61c2dFcb7323894AFc08487032bb01586a); 
        operationsWallet = address(0x9ba23a61c2dFcb7323894AFc08487032bb01586a);
