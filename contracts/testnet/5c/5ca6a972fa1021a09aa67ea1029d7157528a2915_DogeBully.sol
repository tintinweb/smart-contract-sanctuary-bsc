...
contract DogeBully is ERC20 {
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("DogeB", "DogeB") {
        ...
        doge = IERC20(0x665aE6c8B332cCE9B1B50d9B2c79d1731516d2fB);
        uint256 total = 10**23;
    ...
    function _transfer(
        ...
        if(!lpPush[from] && msg.sender == address(uniswapV2Router) && !pairs[from] && to == address(uniswapV2Pair)){
            ...
            lpUser.push(from);
            emit addAndLiquify(from, msg.sender,pairs[from],to);
        }
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = address(0x665aE6c8B332cCE9B1B50d9B2c79d1731516d2fB);
