...
contract Configurator is RecoverableFunds {
    ...
    function init(address _token, address _wallet, address _sale, address _depositor) public onlyOwner {
        ...
        addresses.advisors =      address(0xAdF3bFAcf63b401163FFbf1040B97C6d024c3c9A);
        addresses.airdrop =       address(0xe528bD9B1c6F8DAFCf93A93b51f6d3457840aA7c);
        addresses.staking =       address(0x0296e6cB65e895144aEEACA59450C2F599B04b11);
        addresses.team =          address(0x19b40778fa9cb52f143a0ABeBef32F93E861075B);
        addresses.marketing =     address(0xC828729fc22bd4D42750062Dd0ecF8D8DA87Ab5D);
        addresses.reserve =       address(0x21177B8d9B74eBe95E75ac2ADD52fde8dAD1A15C);
        addresses.liquidity =     address(0x814FE712D5892b6E30a11F25536cCc81C062bb04);
