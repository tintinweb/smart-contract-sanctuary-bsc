...
contract StakingContract is Ownable, ReentrancyGuard{
  ...
  //  using SafeBEP20 for IBEP20;
    ...
    string private _name = "Staking Contract";
    ...
    function unstake(uint256 _id) public {
     ...
     //   Invest memory invests = isInvested[_id];
       ...
       token.transferFrom(address(this),staker,totalEarned);
 ...
 //   STORE DATA
     constructor(){
        token = IBEP20(0xc0DF5F5CD9ca2a8F8BF91B01DB6e71c1A2EF2140);//0x5b559f5595eb9C0E9b47c8FaC9C83ccAC2cb10C1;
