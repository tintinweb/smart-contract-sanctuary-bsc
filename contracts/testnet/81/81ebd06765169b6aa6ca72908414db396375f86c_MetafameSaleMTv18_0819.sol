...
contract MetafameSaleMTv18_0819 is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable, Status{
    ...
    function payToken(uint256 price) private returns (uint256){
        ...
        //uint256 finalPrice = amountIn.div(10**18); 

        currency.safeTransferFrom(address(msg.sender), payable(address(owner())), amountIn * 10**18);
