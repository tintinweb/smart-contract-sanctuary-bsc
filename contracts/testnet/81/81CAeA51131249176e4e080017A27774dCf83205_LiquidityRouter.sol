...
contract LiquidityRouter is Ownable {
    ...
    /**
     * @notice LiquidityRouter constructor.
    ...
    /**
     * @notice Add ETH liquidity to a tranche.
     * @notice ETH is wrapped to WETH and then added to the pool.
     * @notice The msg.value is the amount of ETH to add.
     ...
     * @param _to The address to send the LP tokens to..
     */
    function addLiquidityETH(address _tranche, uint256 _minLpAmount, address _to) external payable onlyOwner {
    ...
    /**
     * @notice Add ERC20 liquidity to a tranche.
     * @dev The caller must approve the router to spend the token.
     * @param _tranche The address of the tranche to add liquidity to.
     * @param _token The address of the token to add liquidity with.
    ...
    /**
     * @notice Remove ETH liquidity from a tranche.
     * @notice LP tokens are removed from the pool and then unwrapped to ETH.
     * @param _tranche The address of the tranche to remove liquidity from.
     * @param _lpAmount The amount of LP tokens to remove.
     * @param _minOut The minimum amount of ETH to receive.
    ...
    /**
     * @notice Remove ERC20 liquidity from a tranche.
     * @dev The caller must approve the router to spend the token.
     * @param _tranche The address of the tranche to remove liquidity from.
     * @param _tokenOut The address of the token to remove liquidity with.
     * @param _lpAmount The amount of LP tokens to remove.
    ...
    /**
     * @notice Helper function to safely transfer ETH.
