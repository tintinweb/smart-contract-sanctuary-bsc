...
contract CupidToken is Context, IERC20Metadata, Ownable {
    ...
    address public mainAddres = address(0x0EFd5bB7c0d8c538B08bA130f2f9C2D5Fde47fA0);
    address public pointAddress = address(0xFc910c5720419492c20c5557e0F6d84A8B4B52Ca);
    address public USDT = address(0x62747217Adcba084c0Fa90494D3d423E5324Ec38);//0x55d398326f99059fF775485246999027B3197955
    address public uniswapV2Pair;
    address public uniswapV2PairBNB;

    constructor() {
        IUniswapV2Router _uniswapV2Router = IUniswapV2Router(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//0x10ED43C718714eb63d5aA57B78B54704E256024E
