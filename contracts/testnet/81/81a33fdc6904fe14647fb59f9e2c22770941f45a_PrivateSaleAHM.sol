...
contract PrivateSaleAHM is Ownable {
    ...
    uint256 public minimumDepositEthAmount = uint256(1 ether).div(10);
    uint256 public maximumDepositEthAmount = uint256(50 ether).div(10);
    uint256 public tokenPerBNB = 100000000000;
    ...
    function claim() external returns(bool) {
        ...
        tokens[msg.sender] = tokens[msg.sender].sub(claimAmount);
        return true;
    }
    ...
    function deposit() public payable {
        ...
        uint256 tokenAmount = take.mul(tokenPerBNB).div(10 ** decimalsDiff);
        
        tokens[msg.sender] = tokens[msg.sender].add(tokenAmount);
