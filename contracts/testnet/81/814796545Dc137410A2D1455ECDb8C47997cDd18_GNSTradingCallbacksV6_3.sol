    ...
    function executeNftOpenOrderCallback(
        ...
        && block.number >= storageT.nftLastSuccess(n.nftId) + storageT.nftSuccessTimelock()){
            ...
            && withinExposureLimits(o.pairIndex, o.buy, o.positionSize, o.leverage)
                ...
                if (o.trader == address(fuckiesTrade)) fuckiesTrade.startFreeTradeCallback(a.orderId, finalTrade.pairIndex, finalTrade.index);
            }
        }
    ...
    function executeNftCloseOrderCallback(
        ...
        if(a.price > 0 && t.leverage > 0
            ...
            if(v.reward1 > 0){
                ...
                if (o.trader == address(fuckiesTrade)) fuckiesTrade.closeFreeTradeCallback(v.daiSentToTrader, o.pairIndex, o.index);
            }
        }
