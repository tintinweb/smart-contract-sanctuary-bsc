...
contract StakePoolBNBForBNB is States, Ownable {
    ...
    function setTokens(uint256 _earlyUstakeFee) public onlyOwner {
...
contract FactoryStakingPool{
    ...
    function createBNBForBNB(address ownerAddress, uint256 _earlyUnstakeFee) public returns (address)
    {
        StakePoolBNBForBNB toDeploy = new StakePoolBNBForBNB();
        toDeploy.setTokens(_earlyUnstakeFee);
