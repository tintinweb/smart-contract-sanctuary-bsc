...
contract Gambleone is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Gambleone";
    string private _symbol = "$GBO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xF27c5E1109Ec5e33D601A4Fe1b8443b9333A0706); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x66Fc3974F59a447521606Dabc5D1C05827CAfFe2); // BuyBack Address
