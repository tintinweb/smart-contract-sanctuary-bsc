...
contract OctaBoxAirdropWL is Context, Ownable, Pausable {

  IOctaBox public octaBox;
  ...
  modifier onlyAdmin() {
    require(msg.sender == adminAddress, "OctaAir: only Admin");
    _;
  }
