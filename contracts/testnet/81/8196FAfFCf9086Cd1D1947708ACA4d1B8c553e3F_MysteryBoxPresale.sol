...
contract MysteryBoxPresale is Ownable {
    ...
    event MysteryBoxReceipt(address buyer, uint256 boxId, uint256 amount, uint256 price);
    ...
    function buyMysteryBox(uint256 _boxId, uint256 _amount) external {
        ...
        token.transferFrom(msg.sender, address(this), purchasePrice);
        emit MysteryBoxReceipt(msg.sender, _boxId, _amount, purchasePrice);
    }
