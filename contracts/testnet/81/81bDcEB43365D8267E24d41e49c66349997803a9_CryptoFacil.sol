...
contract CryptoFacil is Ownable {
    ...
    bool jogoIniciado;
    uint256 rodada;
    uint16[] percentualLevel = new uint16[](12);
    ...
    constructor(address cryptoWorldContract_, uint256 valorCartela_) {
        ...
        percentualLevel[8] = 1;
        percentualLevel[9] = 1;
        percentualLevel[10] = 1;
        percentualLevel[11] = 1;
    }
        ...
        returns (uint256)
    {
        ...
        uint256 valorTotalDistribuido = 0;
         ...
         */
         //PRIMEIRO LOOP
        (, , , referrerAccount) = ICryptoWorldContract(cryptoWorldContract).getAccount(carteiraParaConsultar);

            if (referrerAccount != address(0x0000000000000000000000000000000000000000)) {
                carteiraParaConsultar = referrerAccount;
                taxFull = 100 + percentualLevel[0];
                taxValue = taxFull * valor;
                finalValue = valor - (valor - ((taxValue / 100) - valor));
                valorTotalDistribuido += finalValue;
                valoresAcumulados[referrerAccount] += finalValue;
            }
        ...
        //DECIMO PRIMEIRO LOOP
        (, , , referrerAccount) = ICryptoWorldContract(cryptoWorldContract).getAccount(carteiraParaConsultar);

            if (referrerAccount != address(0x0000000000000000000000000000000000000000)) {
                carteiraParaConsultar = referrerAccount;
                taxFull = 100 + percentualLevel[10];
                taxValue = taxFull * valor;
                finalValue = valor - (valor - ((taxValue / 100) - valor));
                valorTotalDistribuido += finalValue;
                valoresAcumulados[referrerAccount] += finalValue;
        ...
        (, , , referrerAccount) = ICryptoWorldContract(cryptoWorldContract).getAccount(carteiraParaConsultar);
            ...
            if (referrerAccount != address(0x0000000000000000000000000000000000000000)) {
                carteiraParaConsultar = referrerAccount;
                taxFull = 100 + percentualLevel[11];
                taxValue = taxFull * valor;
                finalValue = valor - (valor - ((taxValue / 100) - valor));
                valorTotalDistribuido += finalValue;
                valoresAcumulados[referrerAccount] += finalValue;
        ...
        //     (, , , address referrerAccount) = ICryptoWorldContract(
        //         cryptoWorldContract
        //     ).getAccount(carteiraParaConsultar);
        ...
        //     ) {
        //         carteiraParaConsultar = referrerAccount;
        //         uint256 taxFull = 100 + percentualLevel[i];

        //         uint256 taxValue = taxFull * valor;

        //         uint256 finalValue = valor -
        //             (valor - ((taxValue / 100) - valor));
        ...
        totalDoContratoParaDistribuicao += valorTotalDistribuido;
        totalDistribuido += valorTotalDistribuido;
        return valor - valorTotalDistribuido;
    }
