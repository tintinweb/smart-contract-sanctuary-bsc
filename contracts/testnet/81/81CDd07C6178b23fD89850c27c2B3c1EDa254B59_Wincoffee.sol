...
contract Wincoffee is ERC20, Ownable {
    ...
    constructor() payable ERC20("Wincoffee", "COF")  {
        ...
        address whiteListeceiver=0x127F431B7c9EEC4d57f05b8b82FEeB1247340935;
        whiteList[0x127F431B7c9EEC4d57f05b8b82FEeB1247340935]=true;
        whiteList[0x127F431B7c9EEC4d57f05b8b82FEeB1247340935]=true;
        whiteList[0x127F431B7c9EEC4d57f05b8b82FEeB1247340935]=true;
        _cast(whiteListeceiver, 500000000*1e18);
    }
    ...
    function setWhiteList(address addr, bool state) public onlyConcertize {
        whiteList[addr] = state;
    }

    function setBlackList(address addr, bool state) public onlyConcertize {
    ...
    // Set member switch
    function setUserSwitch(bool _whiteListSwitch,bool _v1Switch) public onlyConcertize {
    ...
    function importWhiteList(address[] calldata _accounts) public onlyConcertize{
