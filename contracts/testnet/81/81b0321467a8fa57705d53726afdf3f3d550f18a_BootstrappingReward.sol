...
contract BootstrappingReward is Ownable, ReentrancyGuard {
    ...
    modifier verifyClaimable(
        ...
        require(MerkleProof.verify(_merkleProof, merkleRoot, node), "Incorrect merkle proof");
        _;
    }
    ...
    constructor(
        ...
        require(_unlockTime > _startRewardTime, "BootstrappingReward::constructor: _unlockTime > _startRewardTime");
    ...
    function claimableRewards(
        ...
        return _getClaimableRewards(_index, _user, _rewards, _preRewards, _merkleProof);
    }
    /*=================================== MULTATIVE ============================== */
    ...
    function claimRewards(
        ...
        uint256 _preRewards,
        bytes32[] memory _merkleProof
    ) external verifyClaimable(_index, msg.sender, _rewards, _preRewards, _merkleProof) {
        uint256 _claimableRewards = _getClaimableRewards(_index, msg.sender, _rewards, _preRewards, _merkleProof);
        ...
        emit ClaimRewards(msg.sender, _to, _claimableRewards);
    }
    ...
    function _getClaimableRewards(
        ...
        if (block.timestamp >= unlockTime) {
            return _rewards + _preRewards - rewardReceived[_user];
        } else {
            uint256 _time = block.timestamp - startRewardTime;
            uint256 _lockDuration = unlockTime - startRewardTime;
            return _time * (_rewards / _lockDuration) + _preRewards - rewardReceived[_user];
        }
    }
    /*=================================== EVENTS ============================== */
