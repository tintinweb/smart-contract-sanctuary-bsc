...
contract PresaleFactory is Ownable {
    ...
    uint256 public tokenPrice_BUSD = 7 * 10 ** 16;
    ...
    address payable presaleOwnerAddress = payable(0xAd305856B22Ab89062265992dfCA23eEACE8069F);
    ...
    function buyTokensByBUSD(uint256 _amountPrice) external {
        ...
        uint256 tokenAmount = _amountPrice * 10 ** 18 / tokenPrice_BUSD;
    ...
    function buyTokensByBNB() external payable {
        ...
        // token amount user want to buy
        uint256 tokenAmount = amountPrice * 10 ** 18 / tokenPrice_BUSD;
