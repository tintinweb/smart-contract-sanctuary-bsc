...
contract TestVReality is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    
    address dead = 0x000000000000000000000000000000000000dEaD;
    
    int256 minMxTxNumber = 10;
    int256 minMxTxNumber2 = 10000;
    ...
    constructor (address tokenOwner,string memory tokenName,
        ...
        _maxTxAmount = _tTotal.mul(setMxTxPer).div(  //max amount of tokens someone can send, 5% - 50,000,000
            20
        );
         emit maxTxAmountUpdate(_maxTxAmount);  
        _maxWalletAmount = _tTotal.mul(setMxWalletPer).div(   //max amount of tokens someone can hold, 10% - 100,000,000
            10
