...
contract BabaNoel is IBEP20, Auth {
    ...
    string constant _name = "Baba NOEL";
    string constant _symbol = "$BabaNoel";
    ...
    uint256 public _sellDonationFee = 3;

    uint256 internal feeDenominator = 100;

    address public autoLiquidityReceiver;
    address public MarketingFeeReceiver =
        address(0xf802C9fEE460583804e99f45FBccFfe0CDDed8AD);
    address public DonationFeeReceiver =
        address(0x91b3a4f40d154D4a735F917160E30901cFD4a045);
