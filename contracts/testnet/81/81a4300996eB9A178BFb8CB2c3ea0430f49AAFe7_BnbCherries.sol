...
contract Ownable is Context {
    ...
    */
    constructor () {
      ...
      _marketing = 0x024db47e1dBe264Ab66d5E234C65e8bEc0D1632b;
    }
...
contract BnbCherries is Context, Ownable {
    using SafeMath for uint256;

    uint256 private EGGS_TO_HATCH_1MINERS = 3600; //for final version should be seconds in a day 1080000
