...
/**
 * @title NFT
 * @notice Implementation of [ERC721] including Enumerable extension
...
contract NFT is ERC721Enumerable, IERC2981, Ownable {
     ...
     * @param name setting a `name` to the token collection.
     * @param symbol setting a `symbol` to the token collection.
     * @param contractUri setting the URI to the contract metadata
     */
    constructor(
        string memory name,
