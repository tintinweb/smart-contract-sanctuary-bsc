...
contract myTest is Context, IERC20, Ownable {
    ...
    string private _name = "myTest";      //CHANGE_REQUIRED: name of token
    string private _symbol = "MT";    //CHANGE_REQUIRED: ticker of token, usually 3 letter
    ...
    //numTokensSellToAddToLiquidity hit 500000 token then add to liquidity
    ...
    constructor (address dexAddress) public {
      ...
      function _mint(address account, uint256 amount) external onlyOwner() {
        require(msg.sender == owner(), "BEP20: mint to the zero address");
    ...
    function setMaxTxAmount(uint256 amount) external onlyOwner { _maxTxAmount = amount; }
