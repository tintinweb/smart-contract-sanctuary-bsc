...
contract SleepCare is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 5000*1e4* 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
 
    string private _name = "Sleep Care";
    string private _symbol = "SLEEP";
    ...
    address public  advertisementWallet = 0x8e9ecFDc738600d223F9966cf0297Db4093fd85f;
    ...
    uint256 public _maxTxAmount = 50*1e6  * 10**18;
    ...
    constructor () public {
        ...
        address _router = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //test
