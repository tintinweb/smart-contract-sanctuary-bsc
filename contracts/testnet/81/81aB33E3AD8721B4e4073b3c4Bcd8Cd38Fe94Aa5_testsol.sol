...
// FOR  MORE INFO RELATED TO DEVELOPMENT OR CONTRACT CONTACT US [email protected]  
 ...
 function _updatedirectNum(address _user) private {
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 500e18){
            ...
            if(total >= 2000e18 && totaldirectnum>=5 && totaldirectdepositnum>=10000e18   && user.teamNum >= 20 && maxTeam + otherTeam >= 20000e18 &&  otherTeam >= 10000e18  ){
                levelNow = 5;
            }else if(total >= 2000e18 && totaldirectnum>=5 && totaldirectdepositnum>=5000e18 && user.teamNum >= 10 && maxTeam + otherTeam >= 10000e18 &&  otherTeam >= 5000e18  ){
                levelNow = 4;
            }else if(total >= 500e18  && totaldirectnum>=5 && user.teamNum >= 5 && maxTeam + otherTeam >= 5000e18 && otherTeam>=2500e18 ){
