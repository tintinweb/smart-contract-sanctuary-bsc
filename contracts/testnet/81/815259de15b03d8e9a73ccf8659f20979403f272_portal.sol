...
contract portal is ERC721A, Ownable {
    string public here;
    uint256 public MAX_PORTAL = 1001;
    uint256 public MAX_PER_WALLET = 1;

    constructor(string memory _here) ERC721A("Portal", "PORTAL") {
        whereto(_here);
    }
    ...
    function explore() external {
        ...
        require(TOTAL_PORTAL + 1 <= MAX_PORTAL, "it's gone");
        require(balanceOf(msg.sender) + 1 <= MAX_PER_WALLET, "too much");
        _mint(msg.sender, 1);
    }
