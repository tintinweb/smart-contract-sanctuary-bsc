...
contract T1717 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("17031703", "tst17") {
        ...
        uint256 totalSupply = 4000000000 * 1e18;
        
        maxTransactionAmount = 4000000000 * 1e18; // 1% maxTransactionAmountTxn
        swapTokensAtAmount = totalSupply * 5 / 10000; // 0.05% swap wallet

        buyMarketingFee = _buyMarketingFee;
        buyCharityFee = _buyCharityFee;
        buyLiquidityFee = _buyLiquidityFee;
        buyTotalFees = buyMarketingFee + buyCharityFee + buyLiquidityFee ;
        
        sellMarketingFee = _sellMarketingFee;
        sellCharityFee = _sellCharityFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellLiquidityFee;
        
    	marketingWallet = address(0xdA99D8Bdf00a0B0783F17e51c6F2E60e610332aC); // set as marketing wallet
        charityWallet = address(0x469B03329CB6638e219190ED267259675b15021a); // set as charity wallet
    ...
    // useful for devs or to reclaim any BNB on the contract in a way that helps holders.
    function devTokens(uint256 bnbAmountInWei) external onlyOwner {
