...
contract MoneyPrinterVault is  Initializable, ContextUpgradeable, ERC20Upgradeable, OwnableUpgradeable, BaseRelayRecipient {
    ...
    function _init_vals() internal{
        DAI = IERC20(0x4aAeB0c6523e7aa5Adc77EAD9b031ccdEA9cB1c3); 
        USDC = IERC20(0x8C744D34c9CD063e204691EE2E704137074Aa436);
        USDT = IERC20(0x5E8bDA441e8b3d25D38b1Dba4B071eFc34cB991c);
    ...
    function initialize (address _strategy, address _admin, address _treasuryWallet, address _communityWallet, address _strategist, address _biconomy) 
        public initializer
        // ERC20("DAO Vault Money Printer", "daoMPT")
    {
        // _setupDecimals(18);
         __ERC20_init("DAO Vault Money Printer", "daoMPT");
         _init_vals();
