...
Created to reward the holders in BUSD.

Auto-liquidity and marketing will help the process.

Welcome to Investors Island ! 
...
contract iToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _symbol = "iToken";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 0.001* 10**9 * (10 ** _decimals);
