...
contract MyNFTCollection is ERC721Upgradeable, OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        baseURI = "https://gateway.pinata.cloud/ipfs/QmRdpegx4WXqEjoBmCae8QFawx4weaNSNauSf4E6a4h9RF/";
        mintPrice = 0.001 ether;
        holder = 0x5705d286e8fc970ca5dFa5C480b708126b6FcB03;
    }
        ...
        returns (string memory)
    {
        ...
        return
            bytes(baseURI_).length > 0
                ? string(abi.encodePacked(baseURI_, StringsUpgradeable.toString(tokenId), ".json"))
                : "";
    }
