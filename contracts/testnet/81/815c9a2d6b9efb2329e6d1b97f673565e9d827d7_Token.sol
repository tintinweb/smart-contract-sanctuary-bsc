...
contract Token is ERC20, Ownable {
    ...
    event EcosystemTriggered(uint256 amount);
    ...
    constructor() ERC20("TikToken", "TT2E") {

        address _owner = 0xCdd070B305E5D3eFd5CF56CAdA3CB6be45FabF5D;
        ...
        buyDevFee = 0;
        buyEcosystemFee = 2;
        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee + buyEcosystemFee;
        
        sellMarketingFee = 2;
        sellLiquidityFee = 0;
        sellDevFee = 0;
        sellEcosystemFee = 2;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee + sellEcosystemFee;

        marketingWallet = address(0xDd75c7b54245Ea2805aA50EdB94ceE500Ea2a054); // set as marketing wallet
    	devWallet = address(0xDd75c7b54245Ea2805aA50EdB94ceE500Ea2a054); // set as dev wallet
    	ecosystemWallet = address(0xDb0057a28E3DBcc93B4365b314003b231395255b); // set as ecosystemWallet
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForMarketing + tokensForDev + tokensForEcosystem;
        bool success;
        ...
        uint256 amountToSwapForETH = contractBalance.sub(liquidityTokens).sub(tokensForEcosystem);
        
        uint256 initialETHBalance = address(this).balance;

        if (tokensForEcosystem > 0) {
            super._transfer(address(this), ecosystemWallet, tokensForEcosystem);
        }
        ...
        uint256 ethForLiquidity = ethBalance - ethForMarketing - ethForDev - ethForEcosystem;
