...
// File: contracts/bacon-nft-base.sol
...
contract BaconNFTBase is Initializable, ERC721Upgradeable, PausableUpgradeable, AccessControlUpgradeable, ERC721BurnableUpgradeable {
    ...
    function setBaseUri(string memory _url) public onlyRole(DEFAULT_ADMIN_ROLE) {
        baseURI = _url;
    }
