...
// Contract compiled by @EVMlord for https://nftytribe.io/
...
contract BrokerV2 is ERC721Holder, BrokerModifiers {
    ...
    constructor(uint _brokerage, address erc20DefaultPayMethod) public {
        erc20TokensArray.addERC20Tokens(erc20DefaultPayMethod);
       // brokerage[address(0)] = _brokerage;

        brokerage[erc20DefaultPayMethod] = _brokerage;
    ...
    function withdrawERC20(address _erc20Token, uint256 amount) public onlyOwner {
       /* require(
            erc20TokensArray.exists(_erc20Token),
       ...
       if(erc20TokensArray.exists(_erc20Token)) {
           erc20Token.transfer(msg.sender, brokerageBalance[_erc20Token]);
    ...
    function putOnSale(
        ...
        address _erc20Token,
        bool _isPhysical
    ) public erc20Allowed(_erc20Token) tokenOwnerOnlly(_tokenID, _mintableToken) {
        IMintableToken Token = IMintableToken(_mintableToken);
...
/*
        ...
        */
        ...
        auctions[_mintableToken][_tID] = auction (
            msg.sender,
            _startingPrice,
            address(0),
            _auctionType,
        ...
        TokenDetArrayLib.TokenDet memory _tokenDet = TokenDetArrayLib.TokenDet(_mintableToken, _tID);
