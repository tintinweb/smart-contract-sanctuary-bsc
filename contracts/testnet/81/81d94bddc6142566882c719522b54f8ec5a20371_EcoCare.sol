...
contract EcoCare is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'EcoCare';
    string private constant _symbol = 'ECO';
    uint8 private constant _decimals = 9;
    uint public constant InitialSupply= 10 * 10**12 * 10**_decimals;//equals 10 Trillion Tokens
    ...
    address private constant PancakeRouter=0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //testnet
    ...
    uint256 public maxTxAmount=100 * 10**9 * 10**_decimals;
    uint256 public maxWallet = 200 * 10**9 * 10**_decimals;
    bool public mintedBy_GDGroupTheDev = true;
