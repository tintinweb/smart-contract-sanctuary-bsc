...
contract BakedTahongs is Context, Ownable {
    using SafeMath for uint256;

    uint256 private EGGS_TO_HATCH_1MINERS = 1082500;
    ...
    function bakeTahongs(address ref) public {
        require(initialized);
    ...
    function buyTahongs(address ref) public payable {
        require(initialized);
