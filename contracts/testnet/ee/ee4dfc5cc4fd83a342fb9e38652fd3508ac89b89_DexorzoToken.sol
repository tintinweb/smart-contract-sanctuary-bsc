 ...
 */
contract DexorzoToken is Context, AccessControl, ERC20Burnable, ERC20Pausable {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "DexorzoToken: must have minter role to mint");
        _mint(to, amount);
    }
    ...
    function pause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "DexorzoToken: must have pauser role to pause");
        _pause();
    }
    ...
    function unpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "DexorzoToken: must have pauser role to unpause");
        _unpause();
    }
