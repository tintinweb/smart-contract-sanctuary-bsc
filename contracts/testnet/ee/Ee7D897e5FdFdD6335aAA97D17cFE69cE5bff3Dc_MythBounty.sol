...
contract MythBounty {
    ...
    function initializeBounty(uint256 _bountyId, uint256 _degenId) external {
        ...
        require(
            currentBlockNumber - lastBlockOfModId[equippedItems.faceModData] >=
                bountyCooldownBlocks,
        ...
        blockToCountToId[block.number][blockNumberCount[tempCount]] = tempCount;
        ...
        emit bountyStarted(_bountyId, msg.sender, block.number);
        bountyCount++;
    }
}
