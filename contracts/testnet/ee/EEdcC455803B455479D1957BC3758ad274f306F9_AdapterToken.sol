...
contract AdapterToken is ERC20PresetMinterPauser("TEST ADAPTER DIGITAL TOKEN", "TADT") {

    mapping (address => uint256) public replayNonce;

    function metaTransfer(bytes memory signature, address to, uint256 value, uint256 nonce, uint256 reward) public returns (bool success) {
