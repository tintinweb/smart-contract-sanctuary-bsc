...
/**
    ...
    Telegram: https://t.me/KitsuneInuBSC
    Kitsune Inu is a story driven, NFTs/game, based upon a popular Novel Hotarubi no Mori e.
*/
...
contract Catanashiva is IBEP20, Auth {
    ...
    string constant _name = "Catanashiva";
    string constant _symbol = "$CS";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 4) / 400;     //1%
    uint256 public _maxWalletSize = (_totalSupply * 4) / 200;   //2%
    ...
    address private marketingFeeReceiver = 0x95E192bdb45dA408906cC9F4569572d232709DD6;
    address private teamFeeReceiver = 0x2034476F69EB9b8Cff02639c08519Bf410278BF5;
