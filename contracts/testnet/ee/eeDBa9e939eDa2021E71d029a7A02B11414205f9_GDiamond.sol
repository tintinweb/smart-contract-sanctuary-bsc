...
contract GDiamond is ERC20Detailed, Ownable {
    ...
    string public _name = "Gold Diamond";
    ...
    uint256 public insuranceFee = 20;
    ...
    constructor() ERC20Detailed("Gold Diamond", "GDMD", uint8(DECIMALS)) Ownable() {
        ...
        insuranceReceiver = 0xD4d275CFC360815872eF152934859c819ACC97ca;
        ...
        managers[treasuryReceiver] = true;
    ...
    function takeFee(
        ...
        if (recipient == pair) {
            ...
            _insuranceFee = insuranceFee.add(sellFees);
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no GDMD token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function addManger(address _addr) external onlyOwner {
        managers[_addr] = true;
    }
    ...
    function setFeeReceivers(
        ...
        require(managers[msg.sender] == true, "This address is not allowed");
