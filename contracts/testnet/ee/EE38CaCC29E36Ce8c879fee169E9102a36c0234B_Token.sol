    ...
    Draw
{
    ...
    function redeemGated(
        ...
        require(
            ...
            "Token: Cannot redeem more than you own"
        );
    ...
    function redeemNormal(uint256 _amount) public {
        require(
            _amount <= balanceOf(msg.sender),
            "Token: Cannot redeem more than you own"
        );
...
contract Stakeable is Initializable {
    ...
    function _stake(uint256 _amount) internal {
        require(_amount > 0, "Token: Cannot stake nothing");
        ...
        returns (uint256)
    {
        ...
        require(
            ...
            "Token: Cannot withdraw more than you have staked"
        );
