...
contract APU is Context, IBEP20, Ownable {
    ...
    string private _name = "Apeiro Universe";
    string private _symbol = "APU";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 59000000 * 10**18;
    ...
    uint256 public BurningFee = 10; // 1% will be added to the burn address
    ...
    constructor( 
        ...
        // Create a pancake pair for this new APU
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "APU: transfer amount exceeds allowance"
            )
        );
        return true;
    }
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "APU: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function _approve(
        ...
        require(owner != address(0), "APU: approve from the zero address");
        require(spender != address(0), "APU: approve to the zero address");
    ...
    function _transfer(
        ...
        require(from != address(0), "APU: transfer from the zero address");
        require(to != address(0), "APU: transfer to the zero address");
        require(amount > 0, "APU: Amount must be greater than zero"); 
    ...
    function _takeBurnFee(address sender, uint256 amount) internal {
        uint256 fee = amount.mul(BurningFee).div(percentDivider);
