...
contract SUNEKU is Context, IBEP20, Ownable {
    ...
    uint256 public minTokenToSwap = 1250000000 * 1e9; // 10000k amount will trigger the swap and add liquidity
