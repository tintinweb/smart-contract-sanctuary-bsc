...
contract PreSaleXYT is Ownable{
    ...
    uint256 private constant serfee = 5000000000000000; 
    ...
    uint256 public issuetime = 0; // Time of each distribution
    uint256 public issuePercent; // Percentage of each distribution
    uint256 public issueInterval; // next 
    ...
    function configIssue(
        ...
        uint256 _issueInterval
    ) public onlyOwner{
        issuetime = _issuetime;
        issuePercent = _issuePercent;
        issueInterval = _issueInterval;
    }
    ...
    function issueXYT() public returns(bool){
        require(issuetime != 0, "Please config the issue params");
        // check time
        ...
        uint256 XYTIssueNum = totalXytAmount.mul(issuePercent.div(100));
        ...
        issuetime.add(issueInterval.mul(3600));
        return true;
    }
