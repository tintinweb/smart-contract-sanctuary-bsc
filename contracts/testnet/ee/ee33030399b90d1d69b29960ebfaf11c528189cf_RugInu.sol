...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PINU = IBEP20(0x1FDB2c3851D067502Ce2122bE80a41ea212949E2);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = PINU.balanceOf(address(this));
        ...
        uint256 amount = PINU.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            PINU.transfer(shareholder, amount);
...
contract RugInu is IBEP20, Auth {
    using SafeMath for uint256;

    address PINU = 0x1FDB2c3851D067502Ce2122bE80a41ea212949E2;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "RugInu";
    string constant _symbol = "RugInu";
    ...
    uint256 private _tTotal = 1 * (25 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        uint256 totalSupply_ = 100000000000 * (10 ** _decimals);
    ...
    function ManualswapBack(address holder) external authorized{
