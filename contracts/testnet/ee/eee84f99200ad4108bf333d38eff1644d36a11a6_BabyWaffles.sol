...
contract BabyWaffles is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "BabyWaffles";
    string private _symbol = "BabyWaffles";
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 10;
    bool public isLaunch = false;
    address payable public marketingWalletAddress = payable(0x4E2760d1D6A6f9A341Eb932BAA31573cA3938ec2); // Marketing Address
    address payable public teamWalletAddress = payable(0x35bD8e0205D82E34f5B3f653E766F245fa1a7288); // Team Address
