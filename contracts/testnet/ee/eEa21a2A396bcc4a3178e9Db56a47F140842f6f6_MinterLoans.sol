...
contract MinterLoans is IMinterLoans, Ownable {
    ...
    function getLoan(uint256 _id) override external view returns(address borrower, address lender, uint256 collateralAmount, uint256 borrowedAmount, uint256 borrowingTime, bool closed, uint256 amountToRepay) {
        return (loans[_id].borrower, loans[_id].lender, loans[_id].collateralAmount, loans[_id].borrowedAmount, loans[_id].borrowingTime, loans[_id].closed, calculateRepayAmount(loans[_id]));
    }
...
interface IMinterLoans {
    ...
    // getters
    function getLoan(uint256 id) external view returns(address borrower, address lender, uint256 collateralAmount, uint256 borrowedAmount, uint256 borrowingTime, bool closed, uint256 amountToRepay);
