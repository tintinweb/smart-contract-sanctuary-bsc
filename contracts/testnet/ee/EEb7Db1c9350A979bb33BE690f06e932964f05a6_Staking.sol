...
/**
     ...
     */
    function getRewardClaimable(uint256 campaignId) public view  returns(uint256[] memory, uint256, uint256) {
        if(rewardsReceived[msg.sender][campaignId] > 0){
            uint256[] memory tempArray;
            return (tempArray, campaigns[campaignId].startTime, campaigns[campaignId].endTime);
        }
       ...
       uint256 count;
        ...
        return (_userXticketsIds, campaigns[campaignId].startTime, campaigns[campaignId].endTime );
    }
