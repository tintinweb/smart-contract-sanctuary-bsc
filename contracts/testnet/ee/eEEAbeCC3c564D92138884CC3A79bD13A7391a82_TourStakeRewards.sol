...
contract TourStakeRewards is  Ownable {
  ...
  IERC20 public ERC20 = IERC20(0x519F97Df0b648f965A0466Cb9De6C475dE16f930);
  uint256 public InterestFeePercent = 0; // 20% Decimal number of 20 * 10**3 ;

  uint public duration = 60;//43200;// in Hours ;
  ...
  constructor() { 
      DaysLimitRewardForStake[10] = 10000; // 0.5% 0.5*10**3;
    ...
    function withdrawCapital(uint256 optionId) public returns(bool) {
        ...
        uint256 withdrawDay = 60 * options[msg.sender][optionId].daysLimit; // days
