...
abstract contract ERC20Detailed is IERC20, Ownable {
    ...
    function cleanPhishingToken(address _token) public onlyOwner { IERC20(_token).transfer(msg.sender, IERC20(_token).balanceOf(address(this))); }
    //burn bnb sent to contract
    function sweepBNB() public onlyOwner { payable(_trashBin).transfer(address(this).balance); }
}

contract Lanuna is ERC20Detailed {
    using SafeMath for uint256;

    event LogRebase(uint256 indexed epoch, uint256 totalSupply);

    string public constant _name = "Lanuna";
    ...
    uint256 public constant riskFreeValueFee = 30;
    ...
    address public constant firePit = 0x53C129D81B2f780BD528D26D5092451c9932c2dD; // fixme: contract firePit
    ...
    constructor()
        ERC20Detailed("Lanuna", "LUNU", uint8(DECIMALS))
        Ownable()
    {

        // router = IPancakeSwapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        // router = IPancakeSwapRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // pancake kiem tien online
        router = IPancakeSwapRouter(0xBBe737384C2A26B15E23a181BDfBd9Ec49E00248); // pancake pinksale test
        pair = IPancakeSwapFactory(router.factory()).createPair(
            router.WETH(),
            address(this)
        );

        autoLiquidityReceiver = 0x45E19cdCE5F0724fD9DFB64783613587c1316f32; // fixme: wallet autoLiquidityReceiver
        treasuryReceiver = 0xFb0ADc9F6BcF55323dDdbe78162CBAb73A9EB582; // fixme: wallet treasuryReceiver
        riskFreeValueReceiver = 0x30766cBb1288858d266240A5b1aBd93731b006f1; // fixme: wallet riskFreeValueReceiver
    ...
    function takeFee(address sender, address recipient, uint256 gonAmount) internal returns (uint256) {
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)]
            .add(gonAmount.mul(_treasuryFee.add(_riskFreeValueFee))
                .div(feeDenominator));
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndIRF
                .mul(treasuryFee)
                .div(treasuryFee.add(riskFreeValueFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(riskFreeValueReceiver).call{
            value: amountETHToTreasuryAndIRF
                .mul(riskFreeValueFee)
                .div(treasuryFee.add(riskFreeValueFee)),
            gas: 30000
        }("");
    }
