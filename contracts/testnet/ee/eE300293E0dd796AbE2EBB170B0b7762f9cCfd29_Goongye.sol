...
contract Goongye is Ownable, Pausable, ERC721Enumerable{
    ...
    uint256 public upgradsupply = 40;
    uint256 public upgrademaxsupply = 50;
    function UpgradeKing(uint256 _id) public{
        ...
        // require(upgradsupply == upgradsupply + 10);
        ERC721._burn(_id);
        
        _safeMint(msg.sender, ( upgradsupply + 1));
        upgradsupply += 1 ;
