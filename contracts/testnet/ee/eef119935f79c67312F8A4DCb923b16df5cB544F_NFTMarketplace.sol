...
contract NFTMarketplace is ReentrancyGuard {
    ...
    function createMarketItem(
        ...
        uint256 collectionId,
        address owner
    ) public isExistCollection(collectionId) nonReentrant {
        require(_nftContract.ownerOf(tokenId) == owner, "sender is not owner");
        ...
        nonReentrant
    {
        ...
        if (saleToken == WBNB) {
            ...
            if (royaltyValue > 0)
                IERC20(saleToken).transferFrom(buyer, minter, royaltyValue);
