...
contract Decentradit  {
    ...
    function createPost(bytes32 _parentId, string calldata _contentUri, bytes32 _categoryId, bool _timeDependent, uint256 _timePeriod  ) external {
    ...
    function getPost(bytes32 _postId) public view returns(address, bytes32, bytes32, int72, uint256, bytes32) {   
        return (
