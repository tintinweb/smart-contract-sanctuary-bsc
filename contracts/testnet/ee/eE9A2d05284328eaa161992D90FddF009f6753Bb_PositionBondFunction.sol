    ...
    Ownable
{
    ...
    function setWhileListAsset(address asset, bool isWhileList)
        public
        onlyOwner
    {
    ...
    function verifyRequire(
        ...
        // TODO change to 1h
        if (bondInformation.startSale < block.timestamp + 3 minutes) return false;
