 ...
 */
contract CarbonToken is ERC1363, EIP2612, EIP3009, AccessControl {
	/**
	 ...
	 *      it is implied version is concatenated to the name field, like "CarbonToken"
	 */
	...
	constructor(address _initialHolder, uint256 _initialSupply) {
		...
		DOMAIN_SEPARATOR = keccak256(abi.encode(DOMAIN_TYPEHASH, keccak256(bytes("CarbonToken")), block.chainid, address(this)));
