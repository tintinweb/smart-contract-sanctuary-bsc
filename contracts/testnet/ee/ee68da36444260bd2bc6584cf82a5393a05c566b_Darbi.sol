...
contract Darbi is Safe {
  ...
  //  address _darbiMinter
    ...
    UP_CONTROLLER = UPController(payable(0x56Fc30BC3ACAd4880D45c684a4EF38d0B2D24D9a));
    //UP_TOKEN = IERC20(payable(0xA518e974D0465935432C4eC2C51ED83209A202eB));
    //UP_CONTROLLER = UPController(payable(0x0Df5B9969699FAC7D8827CCd0c01E145aB6DdD8c));
  ...
  function arbitrageView() public view returns(      bool aToB,
      uint256 amountIn,
      uint256 reserves0,
      uint256 reserves1,
      uint256 backedValue) {
  ...
  function _arbitrageBuy(
    ...
    uint256[] memory amounts = router.swapExactETHForTokens{value: 10000}(
      0,
      path,
      address(this),
      block.timestamp + 150
    ...
    )
  {
    ...
    (aToB, amountIn) = computeTradeToMoveMarket(
     ( (reserves1*1e18)/reserves0), // Ratio = 1:UPVirtualPrice kerk change here
      upPrice,
      reserves0,
      reserves1
    );
