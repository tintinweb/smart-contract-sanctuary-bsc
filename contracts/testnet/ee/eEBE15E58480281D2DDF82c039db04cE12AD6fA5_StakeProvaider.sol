...
contract StakeProvaider is IERC20, Ownable {
    ...
    function mint(address _to, uint256 amount) external onlyOwner onlyStakeService returns (bool) {
    ...
    function burn(address _from, uint256 amount) external onlyOwner onlyStakeService returns (bool) {

        _balances[_from] = _balances[_from].sub(amount, "BEP20: burn amount exceeds balance");
