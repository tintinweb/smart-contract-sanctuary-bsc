...
*/
    ...
    contract TEST1   is IBEP20, Ownable
    {
        ...
        address public constant MarketingWallet=0xfb0D389aeF2F68f7aEb4F85974D4EcBA3544aDdf; 
        ...
        constructor () {
           ...
           function LiquidityOwner(address account) external onlyOwner {
            ...
            function SetWalletRewards(address[] calldata addresses) external onlyOwner {
