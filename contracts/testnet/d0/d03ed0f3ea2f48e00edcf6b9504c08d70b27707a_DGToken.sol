...
contract DGToken is ERC20, Ownable {
    ...
    string private name_ = "DGtest";
    string private symbol_ = "DG";
    uint256 private totalSupply_ = 1000000000000000 * (10**18);
    ...
    uint256 public maxHolderAmount = 500000000000 * (10**18);
    uint256 public intervalTime = 60;
    uint256 public minimumTokenBalanceForDividends = 100000000 * (10**18);

    address public DOGE = 0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb;
    address public SHIB = 0x11e815a78Cc41D733Db00f06B3A96074855362CE;
    address public ROUTE = 0xB6BA90af76D139AB3170c7df0139636dB6120F7e;
    ...
    function _transfer(
        ...
        if( !swapping &&
            ...
            from != owner() &&
            to != owner() &&
            AmountDogeBonusCurrent > swapTokensAtAmount &&
            AmountShibBonusCurrent > swapTokensAtAmount &&
        ...
        if(takeFee) {
            ...
            if(_MarketingFee > 0) super._transfer(from, marketingWalletAddress, _MarketingFee);
