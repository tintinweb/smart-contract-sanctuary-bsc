...
contract liuking is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x633e8d697d57214B6289A051482c715B422C5f87);
    address payable public teamWalletAddress = payable(0x633e8d697d57214B6289A051482c715B422C5f87);
    ...
    uint256 public liq1 = 0;

    uint8 private _decimals = 9;
    uint256 private _totalSupply =  19960227 * 10**_decimals;
    uint256 public _maxTxAmount =   19960227 * 10**_decimals;     
    uint256 public _walletMax =     19960227 * 10**_decimals;      
    ...
    string private _name = "liuking";
    string private _symbol = "liuking";
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if(isMarketPair[sender]) {
            ...
            if(launchAt.add(3) >= block.number || launchAt == 0) {
