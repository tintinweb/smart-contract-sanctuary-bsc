...
contract BabySheikhInu is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 25_000_000_000 * 10**9;
    uint256 public maxBuyLimit = 300_000_000_000 * 10**9;
    uint256 public maxSellLimit = 100_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 300_000_000_000 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x43889dA1eCE89C5a247b505835Fdfa27FF3D7A81;
    address public operationWallet = 0x43889dA1eCE89C5a247b505835Fdfa27FF3D7A81;
    address public utilityWallet = 0x43889dA1eCE89C5a247b505835Fdfa27FF3D7A81;
    ...
    Taxes public taxes = Taxes(3, 0, 3, 0, 0, 0);
    Taxes public sellTaxes = Taxes(3, 0, 3, 0, 0, 0);
