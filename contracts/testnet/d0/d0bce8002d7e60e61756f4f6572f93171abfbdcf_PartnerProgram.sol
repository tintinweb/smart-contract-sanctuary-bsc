...
contract PartnerProgram is Context {
    ...
    function executePaymentsTokens(address _contractAddress, string memory _code, uint256 _amount) internal {
        ...
        _token.transfer(partnerProgramOwner, partnerProgram);
        _token.transfer(_project.paymentsWallet, amount);
    }
    ...
    function depositTokens(uint _amount, string memory _code, address _contractAddress) public {
        IERC20 _token = IERC20(_contractAddress);
