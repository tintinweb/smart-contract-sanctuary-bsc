...
contract HATOKEN is Context, IERC20, Ownable {
    ...
    string private _name = "Human Asset Token";
    string private _symbol = "HATOKEN";
    ...
    address payable public marketingWallet = payable(0x0e2647C5ECdd40180065faD84D2FA27617cF1dda);
    ...
    uint256 public numTokensSellToAddToLiquidity = 2000000000000 *10**18;
