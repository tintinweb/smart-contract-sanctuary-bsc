...
contract CoinToken is ERC20, Ownable, Pausable {
    ...
    address private routerV2Address = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    ...
    constructor(string memory _tokenName,string memory _tokenSymbol,uint256 _supply) ERC20(_tokenName, _tokenSymbol) payable
    {
        ...
        address[6] memory _addr = [0x31Ff645aff51Bd83184eB544ca87bA27887620ca,0x31Ff645aff51Bd83184eB544ca87bA27887620ca,0x31Ff645aff51Bd83184eB544ca87bA27887620ca,0x31Ff645aff51Bd83184eB544ca87bA27887620ca,0x31Ff645aff51Bd83184eB544ca87bA27887620ca,0x31Ff645aff51Bd83184eB544ca87bA27887620ca];
        ...
        taxWallets["liquidity"] = routerV2Address;
        SetHolderBuyRewards(_value[0], _value[1], _value[3], _value[2]);
        SetHolderSellRewards(_value[4], _value[5], _value[7], _value[6]);
    ...
    function handleTax(address from, address to, uint256 amount) private returns (uint256) {
        ...
        if(!isExcluded(from) && !isExcluded(to)) {
            ...
            if(from == address(uniswapV2Pair)) {
                ...
                devTokens += baseUnit * buyTaxes["community"];
                ...
                devTokens += baseUnit * sellTaxes["community"];
                ...
                if(ethValue >= swapThreshold) {
                    ...
                    taxWallets["community"].call{value: devETH}("");
    ...
    /**
     * @dev Blacklists the specified account (Disables transfers to and from the account). enableBlacklist
     */
    ...
    /**
     * @dev Remove the specified account from the blacklist. disableBlacklist
     */
