...
// https://linktr.ee/luna2renounced
...
contract LUNA2 is Context, IERC20, Ownable {
    ...
    uint256 public constant totalSupply =  1 * 10**11;

    uint256 private _rTotal = (MAX - (MAX % totalSupply));
    uint256 private _tFeeTotal;

    string public name = 'LUNA2';
    string public symbol = 'LUNA2';
    ...
    function manage_bots(address[] calldata addresses, bool status) external onlyOwner {
