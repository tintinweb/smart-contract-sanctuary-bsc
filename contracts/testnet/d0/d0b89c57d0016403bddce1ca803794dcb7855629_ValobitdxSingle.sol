    ...
    BEP721BurnableUpgradeable
{
    ...
    function initialize() public initializer  {
        __Ownable_init();
        BEP721Upgradeable.__BEP721_init("VALOBIT", "VALOBIT");
        _tid = 1;
    ...
    function setTokenAddress(address _valobitdexaddress,address _Wethaddress) public onlyOwner{
    ...
    function salewithToken(string memory tokenAss,address from , uint256 tokenId, uint256 amount,address tokenAddress) public{
        newtokenasbid(tokenAss,from,owner(),amount,tokenId,tokenAddress);
    ...
    function newtokenasbid(string memory tokenAss,address from, address admin, uint256 amount, uint256 tokenId,address tokenAddress) internal {
        require(
    ...
    function _acceptBId(string memory tokenAss,address from, address admin, uint256 amount, uint256 tokenId,address tokenAddress) internal{
         uint256 fee = serviceValue;
         if(tokenAddress == Valobitdxaddress ){
            fee = valobitdxserviceValue;
        }
    ...
    function tokenTrans(
     ...
     function acceptBId(string memory bidtoken,address bidaddr, uint256 amount, uint256 tokenId,address tokenAss) public{
        _acceptBId(bidtoken, bidaddr, owner(), amount, tokenId,tokenAss);
