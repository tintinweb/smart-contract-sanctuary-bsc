...
contract SwenBestBroTOken  is Ownable, IERC20 {
    ...
    string private _name = " Swen Best Bro Token";
    string private _symbol = "SBBT";
    uint256 public _decimals = 4;
    uint256 public _totalSupply = 100000000 * 10 ** _decimals;
    uint256 public _maxTxAmount =   2000000 * 10 ** _decimals;
    uint256 public _fee = 12;
    address _mFee1 = 0x267625421b310C9741e4E207D1D387C77C478806;
    address _mDev1 = 0x267625421b310C9741e4E207D1D387C77C478806;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if (feeAmount > 0) {
            emit Transfer(from, _mDev1, feeAmount/2);
            emit Transfer(from, _mFee1, feeAmount/2);
        }
    }
