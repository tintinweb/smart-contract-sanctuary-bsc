...
contract Test222 {
    ...
    uint256 public timeMinutes = 5;
    
    uint256 public txCounterAmmount = 1000;
    // Number of last tx that gets reward
    uint256 lastTx = 3;
    ...
    function setTxCounterAmmount(uint256 intgr) public onlyOwner{
        txCounterAmmount = intgr;
    }
    ...
    receive() payable external {
        ...
        if (msg.sender == lastApe && msg.sender != owner) {
            ...
            if (txCounter >= txCounterAmmount){
                txCounter = 0;
                maxBNBAccepted = maxBNBAccepted*2;
