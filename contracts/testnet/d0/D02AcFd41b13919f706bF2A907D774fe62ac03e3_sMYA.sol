...
contract sMYA is ERC20Permit, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1000000000 * 10**18;
    ...
    constructor() ERC20("Staked MYA", "sMYA", 18) ERC20Permit() {
    ...
    function burn(address account, uint256 amount)external onlyStakingContract {
        ...
        _gonBalances[ account ] = _gonBalances[ account ].sub( gonValue, "ERC20: burn amount exceeds balance");
