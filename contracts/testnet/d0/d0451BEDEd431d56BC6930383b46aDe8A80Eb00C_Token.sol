...
contract Token is ERC20, Ownable {
    ...
    bool public restrictionOn; //todo test
    uint256 public minBuy;


    constructor (address _router) ERC20("test", "test") Ownable() {
    ...
    function _beforeTokenTransfer(
        ...
        if (restrictionOn && from == pPAIR) {
            require(checkRestriction(amount),"Buying amount is less than minimum");
        }
