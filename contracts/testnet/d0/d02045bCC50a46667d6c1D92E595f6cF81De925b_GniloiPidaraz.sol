...
contract GniloiPidaraz is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Gniloi Pidaraz";
    string private _symbol = "GNIL";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress =
        payable(0x902cd52FB44A1D2559F6bF576CEBe8c075cdbdE8);
