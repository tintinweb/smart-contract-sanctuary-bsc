...
contract Darbi is Safe {
  ...
  //  address _darbiMinter
    ...
    factory = 0x98Ec2b264005Dbf5F005755D293D74F8e0267aCf;
    WETH = 0xC578c6e2505Fd2B227A64350ABf85e7221D17c91;
    router = IUniswapV2Router02(0x9e85aEeA00799f057D213CD6a7309DD7fD13485e);
    UP_CONTROLLER = UPController(payable(0x56Fc30BC3ACAd4880D45c684a4EF38d0B2D24D9a));
    DARBI_MINTER = UPMintDarbi(payable(0xC974fb9800BE52e0a3f8e2d417AF74b76D2fe6cD));
    UP_TOKEN = IERC20(payable(0x391664073d8f3FF60755B9FC01911DDF8cdF2F5A));
    admins[msg.sender] = true;
  }

  receive() external payable {}

  function arbitrage() public payable onlyAdmin {
    (
      bool aToB,
      uint256 amountIn,
      uint256 reserves0,
  ...
  function _arbitrageBuy(
    ...
    uint256 expectedReturn = getAmountOut(actualAmountIn, reserves0, reserves1); // Amount of UP expected from Buy
    ...
    if (upControllerBalance < expectedNativeReturn) {
      ...
      actualAmountIn = getAmountOut(upOutput, reserves1, reserves0); // Amount of UP expected from Buy
    }
    ...
    )
  {
    ...
    (reserves0, reserves1) = getReserves(factory, swappedTokens[0], swappedTokens[1]);
  ...
  function pairFor(
    ...
    bytes32 initCodeHash = IFactory(_factory).INIT_CODE_PAIR_HASH();
    pair = address(
      uint160(
        uint256(
          keccak256(
