...
contract JPP is Context, IERC20, LockToken {
    using SafeMath for uint256;
    using Address for address;

    address public marketingWallet = 0xcfcD2087F6004CD57c6327D68f2851dEA0652fB4; 
    address public developerWallet = 0x91b7d5cDf8FCf45587732F98047a28B1b7cD3346;
    address public teamWallet = 0x23C3aBAB99ECC97cc81e89F436edAa9bdE45834F; 
    address public burnWallet = 0x122ADea260F3Bdba88DC3A95182A07E3A37b9507;
    ...
    string private _name = "JPP"; //token name
    string private _symbol = "JPP"; // token symbol. 
    uint8 private _decimals = 18;

    uint256 public _BUSDRewardsFee = 1;
    uint256 private _previousBUSDRewardsFee =_BUSDRewardsFee;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        _transferStandard(sender, burnWallet, burnTokens);
        restoreAllFee();
    ...
    function setburnWalletWalletAddress(address _burnAddress) external onlyOwner() 
    {
