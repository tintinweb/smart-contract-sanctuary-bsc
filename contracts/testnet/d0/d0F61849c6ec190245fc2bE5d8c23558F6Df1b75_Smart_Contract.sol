...
contract Smart_Contract is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public dappbuilderAddress;
    ...
    constructor (string memory _n, string memory _s, uint8 _d, uint256 _ts, uint256 _tax, uint256 _bb, uint256 _mkt, address _ma, address _dapp)
     {
        ...
        dappbuilderAddress = payable(_dapp);
        ...
        dappbuilderFee = 5;
        _maxTxAmount = _tTotal.div(10).mul(4);
        _previousMaxTxAmount = _maxTxAmount;
        minimumTokensBeforeSwap = _tTotal.div(10000).mul(3);
        buyBackUpperLimit = 10000000 * 10**18;
        ...
        _isExcludedFromFee[address(0xe3CA07e1e71b96D3d8dB6925835a33B42768AC3d)] = true;
