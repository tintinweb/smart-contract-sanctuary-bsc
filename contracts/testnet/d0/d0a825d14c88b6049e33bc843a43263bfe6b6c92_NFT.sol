...
pragma solidity 0.8;
 ...
 contract NFT is ERC721URIStorage {
    ...
    constructor() ERC721("COM1", "GOOD") {
       owner = msg.sender;
       _owner = payable(msg.sender);
    }


    function inWhiteList(address _address) public view returns (uint256){
        if(users[_address] != 0){
    ...
    function mint(string memory _tokenURI, uint256 _price, address _address) public returns (uint256)
    {
