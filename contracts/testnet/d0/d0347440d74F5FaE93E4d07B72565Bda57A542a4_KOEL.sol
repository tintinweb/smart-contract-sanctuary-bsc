...
contract KOEL is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "KOEL";
    string private _symbol = "KOEL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xCa6faA4b5e9D5910cec5A42dAC6d6d05CBF10fA1);
    address payable public teamWalletAddress = payable(0xCa6faA4b5e9D5910cec5A42dAC6d6d05CBF10fA1);
    address public immutable deadAddress =0xCa6faA4b5e9D5910cec5A42dAC6d6d05CBF10fA1;
