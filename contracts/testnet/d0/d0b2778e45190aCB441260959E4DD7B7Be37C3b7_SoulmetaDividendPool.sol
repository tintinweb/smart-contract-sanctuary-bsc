...
contract SoulmetaDividendPool is ERC721Holder, DivestorUpgradeable {
    ...
    // 质押nft
    function pledgeNft(uint[] memory tokenIds_) public {
    ...
    // function setUserData(address player, uint accumulate, uint cumulative, uint[] memory nftIdList, uint lastSettleMonth) public onlyOwner {
