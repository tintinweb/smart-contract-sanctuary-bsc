...
contract TradingCoreFacet is ITradingCore {
    ...
    function updatePairPositionInfo(
    ...
    ) external override returns (int256 longAccFundingFeePerShare){
        LibAccessControlEnumerable.checkRole(Constants.SELF_ROLE);
        ...
        LibTradingCore.updatePairQtyAndAvgPrice(ppi, qty, marketPrice, isOpen, isLong);
