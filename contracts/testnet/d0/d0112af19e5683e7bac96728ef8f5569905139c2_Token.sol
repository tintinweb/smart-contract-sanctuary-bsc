...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "HQNS5";
    string private _symbol = "HQNS5";
    ...
    address public _marketingWallet = payable(address(0x25eD9FCfD4997Ca7321C3B8b21703ecFcf1D5779));
    address public _rewardWallet = payable(address(0x25eD9FCfD4997Ca7321C3B8b21703ecFcf1D5779));
    ...
    function refer_son(address referrer) public{
        ...
        bool shouldSetInviter = balanceOf(referrer) == 0 &&
            inviter[referrer] == address(0) &&
            referrer != uniswapV2Pair;
        if (shouldSetInviter) {
            inviter[msg.sender] = referrer;//msg.sender
        }
    }
    ...
    function _takeInviterFee(
        ...
        _tOwned[address(0)] = _tOwned[address(0)].add(tAmount.div(100).mul(_inviterFee.sub(accurRate)));
        emit Transfer(sender, address(0), tAmount.div(100).mul(_inviterFee.sub(accurRate)));
    }
