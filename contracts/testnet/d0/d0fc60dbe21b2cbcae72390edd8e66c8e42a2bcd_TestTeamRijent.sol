...
contract TestTeamRijent{
  ...
  uint public principalWithdrawalInterval = 7 minutes;
  ...
  constructor() {
    ...
    tariffs.push(Tariff(360 seconds, 12*3));
    tariffs.push(Tariff(720 seconds, 24*5));
    tariffs.push(Tariff(1440 seconds, 48*6));

    //token = 0x913aFbBA462d6ae230344209d0Bd11CE3CE92Ed1; // RTC Token
    token = 0x7eB52D196Da259840b0c15588f1a02b05683cf50; // Test Token
    owner = msg.sender;
    depositStatus = true;
  }
