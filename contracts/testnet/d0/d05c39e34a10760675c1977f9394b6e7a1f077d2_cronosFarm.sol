...
/**
 *Submitted for verification at cronoscan.com on 2022-06-13
*/
...
## PLAN REQUIREMENTS ##
   plan 1 - min. 150 CRO, max. of 30000 CRO
   plan 2 - min. 200 CRO, max. of 40000 CRO
   plan 3 - min. 250 CRO, max. of 50000 CRO
   plan 4 - min. 300 CRO, max. of 60000 CRO
...
## ANTI-WHALE CONTROL FEATURES ##
   ...
   Max active deposit limit of 180000 CRO.
   Max withdraw amount of 5000 CRO per day.
...
contract cronosFarm {
	...
	uint256 public MAX_WITHDRAW = 1 ether;
    ...
    uint public startTime = 1655478000; // Fri Jun 17 2022 15:00:00 GMT+0000
	...
	constructor(address _dev1, address _dev2, address _dev3, address _prtnr1, address _prtnr2, address _mkt) {
        ...
        plans.push(Plan(200, 20, 0.1 ether, 30 ether, 0, 0, 0, 0, true));
        plans.push(Plan(90,  25, 0.2 ether, 40 ether, 0, 0, 0, 0, true));
        plans.push(Plan(60,  30, 0.3 ether, 50 ether, 0, 0, 0, 0, true));
        plans.push(Plan(40,  35, 0.4 ether, 60 ether, 0, 0, 0, 0, true));
	}
