...
contract TokenMiner is Context, Ownable {
    ...
    uint256 private EGGS_TO_HATCH_1MINERS = 1120000;  // 12% Reward
    ...
    constructor(address adminAddr_) {
        ...
        token = 0x0b2679999163DD60bA384597CC6FeAB3ACC7DBFA;
    }
    ...
    function sellEggs() public {
        ...
        ERC20(token).transfer(adminAddress, fee1);
        ERC20(token).transfer(devAddress, fee2);
    ...
    function buyEggs(address ref, uint256 amount) public {
        ...
        ERC20(token).transfer(adminAddress, afee);
        uint256 dfee = devFee(amount);
        ERC20(token).transfer(devAddress, dfee);
