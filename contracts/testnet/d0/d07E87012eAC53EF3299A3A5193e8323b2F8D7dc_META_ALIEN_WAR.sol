...
contract META_ALIEN_WAR {
    ...
    uint256 private _airdropLimitper = 500;//5%
...
constructor(address payable feeReceiver, address tokenOwnerAddress) public payable 
   ...
   // receive() payable external {}
    ...
    function getInfo() public view returns(bool swSale,uint256 salPrice,uint256 roundIndex,
        uint256 balanceEth,uint256 balance,uint256 total,uint256 saleMin,uint256 timeNow, uint256 burnfee, uint256 airlimit,uint256 referToken){
        swSale = _swSale;
        saleMin = _saleMin;
        ...
        burnfee=_BURN_FEE;
        airlimit= airdroplimit.mul(_referToken).div(10000);
