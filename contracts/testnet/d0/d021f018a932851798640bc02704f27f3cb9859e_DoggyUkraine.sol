...
contract DoggyUkraine is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Doggy Ukraine";
    string private _symbol = "MINT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2126eeeE6DA4447531432c515d308F0D50b2d67E);
    address public dividend = 0x2126eeeE6DA4447531432c515d308F0D50b2d67E;
    ...
    function setSelTaxes(uint256 newLiquidityTax, uint256 newMarketingTax) external marketing() {
    ...
    function setMarketingWalletAddress(address newMarketing) external onlyOwner() {
        _marketing = payable(newMarketing);
    }
