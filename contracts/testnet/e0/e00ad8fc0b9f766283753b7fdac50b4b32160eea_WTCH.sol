...
contract WTCH is ITOKEN {
    using SafeMath for uint256;

    address public bloomAddress = 0x8984C2d278260B88dBC17a0d68fA4ad0A61E9A0a;
    ITOKEN2 bloom = ITOKEN2(bloomAddress);
    string _name = "Wrapped TarotCash";
    string _symbol = "WTCH";
    uint8 _decimals = 6;
    ...
    function wrap(uint256 _amount) external returns(bool){
       ...
       bloom.wrap(msg.sender,address(this),_amount * 10 ** bloom.decimals());
    ...
    function unwrap(uint256 _amount) external returns(bool){
       ...
       bloom.unwrap(address(this),msg.sender,_amount * 10 ** bloom.decimals());
