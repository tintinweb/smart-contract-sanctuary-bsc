...
contract NFTAuction {
    ...
    */
    ...
    // Call approve of citrus token before calling this function
    function makeBidWithCitrus(address nftContractAddress, uint tokenId, uint tokenAmount) external auctionOngoing(nftContractAddress, tokenId) {
        ...
        if(nftPrevHighestBidder != address(0)){
            citrus.transfer(nftPrevHighestBidder, nftPrevHighestBid);
        }
    }
    /**
        BID FUNCTIONS END
