...
contract StakingERC20 {
    ...
    Stake[] allstake;
    constructor(IERC20 _rewardToken,uint256 _amount) {
    ...
    function unstakeToken() public {
        ...
        require(block.timestamp >= releasetime+86400,"you can unstake after 1 day" );       
        Token.transferFrom(address(this),msg.sender, balance); //transfer back token to use
        rewardToken.transferFrom(address(this),(msg.sender), (1*amount)/100 );
        _balances[msg.sender] = (1*amount)/100;
