...
contract LiteExchange is BEP20, Whitelist {

    string public constant name = "EToken Liquidity Token";
    string public constant symbol = "ET LP";
    ...
    function addLiquidity(uint256 min_liquidity, uint256 max_tokens) isNotPaused public payable returns (uint256) {
        ...
        if (total_liquidity > 0) {
            ...
            require(msg.value >= 1e14, "INVALID_VALUE");
