...
contract ERC20 is IERC20, AccessControl {
    ...
    /// @dev Function emits Transfer event
    function mint(address owner, uint256 value) public override onlyRole(MINTER_ROLE) {
        _mint(owner, value);
    }
    ...
    /// @dev Function emits Transfer event
    function burn(address owner, uint256 value) public override onlyRole(BURNER_ROLE) {
        _burn(owner, value);
    }
