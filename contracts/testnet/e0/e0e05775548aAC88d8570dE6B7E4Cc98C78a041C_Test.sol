...
contract BNBDividendDistributor is IDividendDistributor {
    ...
    IERC20 BUSD = IERC20(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
...
contract Test is ERC20Detailed, Ownable {
    ...
    BNBDividendDistributor distributor;
    ...
    constructor() ERC20Detailed("TEST Token", "TST", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x487db7293CE82f3dd9485cc6594b6a2055Cb9828;
        treasuryReceiver = 0xa1BEDb70b4857AFA8AaCbfa9d049772900Ea2fB4;   
        autofirePit = 0x58fff3935514f9492D4c4084618B690FFA3c57A6;

        _allowedFragments[address(this)][address(router)] = type(uint256).max;
        pairContract = IPancakeSwapPair(pair);

        distributor = new BNBDividendDistributor(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no TST token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
