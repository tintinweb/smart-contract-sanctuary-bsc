...
contract SuperBowlPool {
    ...
    uint40 sbDate = 1643950740;
    // uint40 sbDateStart = 1643694722; //1644771600;
    uint40 sbDateStart = 1643950500;
    constructor(address payable ceoAddress, address payable devAddress){
        ...
        USDC = IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // Binance testnet BUSD contract
    }
    ...
    function makeBet(uint8 selection, uint256 amount) external {
        ...
        require (amount >= 2, "Amount needs to be higher than 2");
        // require (amount >= 20);
