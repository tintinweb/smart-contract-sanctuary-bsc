...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    address public auctionToken=0xC5a3A07E0Fc104Fa70e8619f29502ea76236F6d7;
    constructor() {
        _name = "TESTNFT";
        _symbol = "TESTNFT";
    }
    ...
    function transfer(
        ...
        require((ERC721.ownerOf(tokenId) == _msgSender()), "k025");
    ...
    function _transfer(
        ...
        if(msg.sender!=auctionToken){
            require(INOMarketV2(auctionToken).isTokenLocked(address(this),tokenId),"k029");
            _approve(address(0), tokenId);
        }
        _balances[from] -= 1;
        _balances[to] += 1;
...
contract CoSoNFTFactory is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function mintForMiner(address _to) public nonReentrant returns (bool) {
        require(MinerList[msg.sender] == true, "e002");
        require(_to != address(0), "e003");
         uint _tokenid=tokenIdNow+1;
