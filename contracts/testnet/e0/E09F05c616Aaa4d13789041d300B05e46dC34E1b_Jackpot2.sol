...
contract Jackpot2 is IBEP20, Auth {
    ...
    uint256 public jackpotFee      = 7;
    uint256 public burnFee         = 0;
    uint256 public totalFee        = jackpotFee + marketingFee + liquidityFee + burnFee;
    ...
    address public jackpoFeeReceiver;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xDb63821949F870a36b321876AD9c69a482D582C5; //Miha
        jackpoFeeReceiver = msg.sender;
    ...
    function swapBack() internal swapping {
        ...
        (tmpSuccess,) = payable(jackpoFeeReceiver).call{value: amountBNBjackpot}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _jackpotFee, uint256 _marketingFee, uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        jackpotFee = _jackpotFee;
        marketingFee = _marketingFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_jackpotFee).add(_marketingFee).add(_burnFee);
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Buy Fees cannot be more than 50%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _jackpotFee, address _burnFeeReceiver) external authorized {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        jackpoFeeReceiver = _jackpotFee;
