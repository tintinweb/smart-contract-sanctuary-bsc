...
contract ShillaVault is Ownable {
    ...
    function _setGame(address _game) external onlyOwner {
        game = IShillaGame(_game);
    }
    ...
    function _mintGame(
        ...
        id = game.mint(entryPriceNoDecimals, countDownDuration, ownerPercentage, primaryWinnerPercentage, secondaryWinnerPercentage);
    ...
    function _burnGame(uint256 gameId) external onlyOwner {
