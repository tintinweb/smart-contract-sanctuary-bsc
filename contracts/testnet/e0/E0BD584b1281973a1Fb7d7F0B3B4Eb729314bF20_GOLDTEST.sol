...
contract GOLDTEST is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "GOLD TEST";
    string private _symbol = "GOLDTEST";
    ...
    uint256 internal _tokenTotal = 60000000 *10**18; // 60 Million totalSupply
    ...
    uint256 public _LiquidityFee = 300; // 300 = 3%
    ...
    address public buybackv1Address  = 0xa6153B18D900d00083fc301b8017C14C3C72b6Ce;      // BuyBackv1 Address
    address public LiquidityFeeAddress  = 0x8B327a9EF4aE2eFc402a1D71Dc1780bB12A99543;      // Liquidity Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0xCd2045C9EBCd099FAfBC063BDc58A421054336c5;      // SMarketing Address
