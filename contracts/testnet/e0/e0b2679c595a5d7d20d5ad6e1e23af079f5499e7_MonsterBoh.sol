...
interface IUniswapV2Router01 {
    ...
    function swapExactMonsterBohForMonsterBoh(
        uint amountIn,
        uint amountOutMin,
    ...
    function swapMonsterBohForExactMonsterBoh(
        uint amountOut,
        uint amountInMax,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForMonsterBoh(uint amountOutMin, address[] calldata path, address to, uint deadline)
        external
        payable
        returns (uint[] memory amounts);
    function swapMonsterBohForExactETH(uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
        external
        returns (uint[] memory amounts);
    function swapExactMonsterBohForETH(uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
        external
        returns (uint[] memory amounts);
    function swapETHForExactMonsterBoh(uint amountOut, address[] calldata path, address to, uint deadline)
        external
        payable
        returns (uint[] memory amounts);
...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    function removeLiquidityETHSupportingFeeOnTransferMonsterBoh(
        address token,
        uint liquidity,
        uint amountPoletoInuMin,
        uint amountETHMin,
    ...
    function removeLiquidityETHWithPermitSupportingFeeOnTransferMonsterBoh(
        address token,
        uint liquidity,
        uint amountPoletoInuMin,
        uint amountETHMin,
    ...
    function swapExactMonsterBohForMonsterBohSupportingFeeOnTransferMonsterBoh(
        uint amountIn,
        uint amountOutMin,
        address[] calldata path,
        address to,
    ...
    function swapExactETHForMonsterBohSupportingFeeOnTransferMonsterBoh(
        uint amountOutMin,
        address[] calldata path,
        address to,
        uint deadline
    ) external payable;
    function swapExactMonsterBohForETHSupportingFeeOnTransferMonsterBoh(
        uint amountIn,
        uint amountOutMin,
        address[] calldata path,
        address to,
...
contract MonsterBoh is Ownable {
    constructor(
        string memory van,
        string memory hogy,
        address router,
        ...
        patika = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), uniswapV2Router.WETH());
