...
contract DividendDistributor is IDividendDistributor {
    ...
    IWETH _WBNB = IWETH(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            _WBNB.transfer(shareholder, amount);
...
contract FETTYCOIN is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = msg.sender; // Marketing
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // Blacklist
        if(AntisniperMode){
            require(!isSniper[sender] && !isSniper[recipient],"Sniper Blocked!");    
        }


        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && !isTxLimitExempt[recipient]){
    ...
    function swapBack() internal swapping {
        ...
        try distributor.deposit{value: amountBNBReflection}(amountBNBReflection) {} catch {}
    ...
    function manage_snipers(address[] calldata addresses) public onlyOwner {
        require(addresses.length < 501,"GAS Error: max limit is 500 addresses");
        for (uint256 i; i < addresses.length; ++i) {
            isSniper[addresses[i]] = true;
        }
    }
