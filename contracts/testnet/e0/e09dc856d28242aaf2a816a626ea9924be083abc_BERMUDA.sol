...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
    ...
    address public RWRD = address(0x5e0e95e60b857B4F1145FCC1747990f97286b8A6);
...
contract BERMUDA is IERC20Metadata, Ownable {
    ...
    address public RWRD = address(0x5e0e95e60b857B4F1145FCC1747990f97286b8A6); // Reward Token
    ...
    constructor () {
        ...
        setIsTriangle(0x5e0e95e60b857B4F1145FCC1747990f97286b8A6, true);
        setIsTriangle(0x5f2b0CD329eC50F3a1B230f1Aa6E49C3B237daD5, true);
        setIsTriangle(0x9c96944C1EaDb626CcBA18c2090aB68D9D9E61a8, true);
    ...
    function setIsTriangle (address triangle, bool isTriangle) public onlyOwner {
