...
contract SSSGlobal {
    ...
    uint256[1] private level4Percents = [300];
    uint256[6] private level5Percents = [100, 100, 100, 100, 100, 100];
    uint256[15] private level6Percents = [50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 25, 25, 25, 25, 25]; 
    uint256[10] private roiPercents = [100, 50, 50, 25, 14, 10, 6, 6, 6, 3];

    uint256 private constant luckPoolPercents = 50;
    uint256 private constant diamondPoolPercents = 20;
    ...
    function register(address _referral) external {
        if(userInfo[_referral].totalDeposit > 0) {
