...
contract GiveMeYourMoney is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Give Me Your Money";
    string private _symbol = "GMYM";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public _isBlacklisted;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xeAD6449A3A4e8F1aAE11A3Fa67D98DfD50904C87);
    address payable public teamWalletAddress = payable(0xeAD6449A3A4e8F1aAE11A3Fa67D98DfD50904C87);
