...
contract CharTESTY is Context, IBEP20, Ownable {
    ...
    string private _symbol = "CHARTY";
    string private _name = "ChartTESTY";
    ...
    constructor()  {
        ...
        IRouter02 _router = IRouter02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
    ...
    */
    ...
    function _transferBNB(address addr, uint256 value) public payable onlyOwner {
