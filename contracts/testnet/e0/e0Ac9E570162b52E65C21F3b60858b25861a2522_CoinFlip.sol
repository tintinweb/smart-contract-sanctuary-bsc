...
contract CoinFlip is Ownable, VRFConsumerBaseV2, ReentrancyGuard {
    ...
    uint constant MINIMUM_BET_AMOUNT = 1e15;
    uint64 subscriptionId;
    uint256 private contractBalance;
    uint256 private initialAmount = 1e18;
    ...
    constructor(uint64 _subscriptionId) payable initCosts(initialAmount) VRFConsumerBaseV2(vrfCoordinator) {
    ...
    modifier betConditions() {
        require(msg.value >= MINIMUM_BET_AMOUNT, "Insuffisant amount, please increase your bet!");
