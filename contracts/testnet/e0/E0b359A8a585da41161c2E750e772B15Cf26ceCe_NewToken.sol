...
contract NewToken is Context, IERC20, Ownable {
    ...
    mapping(address => bool) private allowedMintingContracts;
    ...
    address public marketingWallet = 0xBa8Bb30c856A01D5535Eef7BDEfD835F81F440A6;
    ...
    modifier onlyMintingContract() {
        require(msg.sender == mintingContract || msg.sender == owner(), "Sorry you dont have persmissions");
        _;
    }
    ...
    constructor() {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);//0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 for testnet    0x10ED43C718714eb63d5aA57B78B54704E256024E for mainnet
        ...
        _isExcludedFromFee[mintingContract];

        emit Transfer(address(0), owner(), _tTotal);
    }

    function setAllowedMintingContracts(address[] memory _contractAddress) public onlyOwner {
        for (uint256 j = 0; j < _contractAddress.length; j++) {
            address  mintingContract = _contractAddress[j];
            allowedMintingContracts[mintingContract] = true;
        }
    }

    function mintTransfer(address _from, address _to, uint256 _amount) external onlyMintingContract {
        require(_amount > 0);
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount >= totalSupply().div(1000), "transaction amount must be equal or greater than 0.1% of totalsupply");
        _maxTxAmount = maxTxAmount;
    }

    function setMaxWalletTokend(uint256 _maxToken) external onlyOwner {
  	    require(_maxToken >= totalSupply().div(1000), "transaction amount must be equal or greater than 0.1% of totalsupply");
