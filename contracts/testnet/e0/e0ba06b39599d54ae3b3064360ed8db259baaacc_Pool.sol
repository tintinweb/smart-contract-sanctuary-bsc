...
//        console.log("_slippageAmount            = %s", _slippageAmount);
//        console.log("_mainCollateralAmount      = %s", _mainCollateralAmount);
//        console.log("_totalMainCollateralAmount = %s", _totalMainCollateralAmount);
