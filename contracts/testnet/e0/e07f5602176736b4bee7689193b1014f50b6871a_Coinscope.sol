...
contract Coinscope is Context, IERC20, Ownable {
    ...
    string private _name = "LENOTEST";
    string private _symbol = "LENOTEST";
    ...
    function getCirculatingSupply() public view returns (uint256) {
        return _tTotal.sub(balanceOf(deadAddress)* 10**18);
    }
