...
interface ITigerDao {
    ...
    function datas()  external view returns(address daoToken, string memory name, uint[7] memory infos);
...
contract TigerDao  {
    ...
    function datas()  external view returns(address daoToken, string memory name, uint[7] memory infos) {
        ...
        infos[6] = meta.quota / buyDecimals;
