...
contract TORA is Context, IERC20, Ownable {
    ...
    address public marketingaddress = 0xc4091892CfBC7576C01F0dC93474f688Ae6022Bd;
    ...
    function _transferFromExcluded(address sender, address recipient, uint256 tAmount) private {
      ...
      function changemarketingwallet(address _newaddress) public onlyOwner {
        ...
        marketingaddress = _newaddress;
          // exclude marketing from fee
        _isExcludedFromFee[marketingaddress] = true;

        // exclude marketing from standard 4% reflection distribution reward
