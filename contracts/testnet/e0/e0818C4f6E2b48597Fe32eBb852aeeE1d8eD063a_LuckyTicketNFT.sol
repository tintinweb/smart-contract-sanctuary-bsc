    ...
    VRFConsumerBase
{
    ...
    function setNewCrownBonus() public onlyValidTarget {
        _CrownToken.mintValidTarget(1);
        uint256 _newTokenId = _CrownToken.tokenOfOwnerByIndex(
            address(this),
            _CrownToken.balanceOf(address(this)) - 1
        );
        todayTokenId = _newTokenId;
    }
    ...
    function randomWinner() external returns (uint256) {
        if (ticketSoldPerDay > 0) {
