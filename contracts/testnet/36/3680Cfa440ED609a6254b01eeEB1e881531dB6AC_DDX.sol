...
contract DDX is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        swapEnabled = true;
        swapTokensAtAmount = _tTotal / 50000;
    ...
    function _tokenTransfer(
        ...
        if (_isExcludedFromFees[sender] || _isExcludedFromFees[recipient]) {
            ...
            _rOwned[DEAD] += ((amount * burnFeeonSell) / 100);
            amount -= ((amount * burnFeeonSell) / 100);
            setSellFee();
        } else if (sender == uniswapV2Pair) {
            _rOwned[DEAD] += ((amount * burnFeeonBuy) / 100);
            amount -= ((amount * burnFeeonBuy) / 100);
            setBuyFee();
        } else {
            setSellFee();
        }
