...
contract Scabbaro is Context, IBEP20, Ownable {
    ...
    address payable public MarketingWallet = payable(0xCdd36F7e5f0EcAF8E068994dA4349807045223a7);
    ...
    string private _name = "SCABBARO";
    string private _symbol = "SCAB";
