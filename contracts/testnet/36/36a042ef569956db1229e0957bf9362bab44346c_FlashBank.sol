...
// File: Flash/SignatureVerifier_V2.sol
...
contract FlashBank is Ownable, SignatureVerifier_V2 {
    address public USDT;
    mapping(address => uint256) public nonces;

    event Claim(address indexed account, uint256 amount, uint256 nonce);

    constructor (address _signer) SignatureVerifier_V2(_signer) {
    ...
    function claim(address account, uint256 amount, bytes calldata signature) public {
