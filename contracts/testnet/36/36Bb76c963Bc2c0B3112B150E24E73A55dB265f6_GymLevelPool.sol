...
contract GymLevelPool is ReentrancyGuardUpgradeable, OwnableUpgradeable {
    ...
    function initialize(
        ...
        poolLevelDividers[14] = 6;
        poolLevelDividers[15] = 3;
        poolLevelDividers[16] = 2;
        ...
        returns (QualifiedCandidates memory)
    {
        return
            QualifiedCandidates({
                totalGold: poolWallets[14].length(),
                totalPlatin: poolWallets[15].length(),
        ...
        returns (UniqueCandidates memory)
    {
        ...
        return
            UniqueCandidates({
                ...
                blackLevel: poolWallets[16].length()
            });
    }
