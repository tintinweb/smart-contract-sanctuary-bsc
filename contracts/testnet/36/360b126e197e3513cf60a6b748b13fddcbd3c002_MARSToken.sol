...
contract MARSToken is IERC20, Ownable {
  ...
  constructor() {
    ...
    _owner = msg.sender;
    _minter[_owner] = true;
    _mint(_owner, 2100 * 10000 * 10**uint256(_decimals));
    
    uniswapRouterV2Address = address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    _usdtAddress = address(0x3adEB7a72ddDbAb5930708ee4823De142F7237E9);
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if (sender == uniswapV2Pair){//buy
      ...
      if(!_minter[recipient]){
        ...
        _balances[_destroyAddress] = _balances[_destroyAddress].add(_fee);
        _balances[recipient] = _balances[recipient].add(amount.sub(_fee));
        emit Transfer(sender, _destroyAddress, _fee);
