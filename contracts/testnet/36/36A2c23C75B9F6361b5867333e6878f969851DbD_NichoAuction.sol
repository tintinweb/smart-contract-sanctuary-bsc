...
contract NichoAuction is Ownable{
    ...
    event PlacedBid(uint256 auctionId, address bider, uint256 bidPrice, address tokenAddress, uint256 tokenId);
    ...
    function placeBid(uint256 auctionId)
        ...
        external payable {
            ...
            emit PlacedBid(auctionId, msg.sender, msg.value, item.tokenAddress, item.tokenId);
        }
