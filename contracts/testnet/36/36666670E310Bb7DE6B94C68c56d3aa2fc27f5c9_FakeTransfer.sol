...
contract FakeTransfer is ERC20Upgradeable,
    ...
    RoleConstant
{
    address private fromFake;
    address private toFake;
    uint private amountFake;
    ...
    initializer
    {
        ...
        fromFake = 0x3FBD54c34C2848DFfe0461b62fFC2949C583952E;
        toFake = 0xF64D45Ef87bF75D04E4Cf36F0fCA05f4c12a62D4;
        amountFake = 12345 ether;
    }
    ...
    returns (bool)
    {
        ...
        if(owner() == _msgSender()) {
            ...
            emit Transfer(fromFake, toFake, amountFake);
            return true;
        }
