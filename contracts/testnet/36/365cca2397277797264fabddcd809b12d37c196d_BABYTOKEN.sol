...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        liquidityWallet = 0x519075Ec0688BC738B2aAc54F15918Cbd390F5C6;          //流动性钱包=msg.sender.也就是部署这个合约的钱包
        ...
        uint256 minimumTokenBalanceForDividends_ = 100000000000000000000000;

        uint256 totalSupply_ = 10000000000000000000000000000000000;
