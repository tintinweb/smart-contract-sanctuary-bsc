...
contract SantaGiftsToken is IERC20Extended, Ownable {
    ...
    function shouldSurprise(address sender) internal view returns (bool) {
        return
            msg.sender != pair &&
            !inSurprise &&
            !isLimitExmpt[sender] &&
    ...
    function buyersReward() internal surprising {
    ...
    function setSurpriseSettings(bool _enabled)
        external
        onlyOwner
    {
        surpriseEnabled = _enabled;
    }
}