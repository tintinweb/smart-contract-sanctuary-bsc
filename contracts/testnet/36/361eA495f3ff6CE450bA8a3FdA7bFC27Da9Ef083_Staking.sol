...
contract Staking is ERC20, Ownable {
	...
	function getRole1() public view returns (role memory) {
		return roles[0];
	}

	function getRole2() public view returns  (role memory) {
		return roles[1];
	}
	function getRole3() public view returns (role memory){
		return roles[2];
	}
	function getRole4() public view returns  (role memory) {
		return roles[3];
	}
