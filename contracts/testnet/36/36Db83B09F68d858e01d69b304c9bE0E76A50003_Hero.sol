...
contract Hero is BEP721 {
    ...
    function buyBox(uint256 _type) public {
        if (_type == 1) {
    ...
    function buyBoxMulti(uint256 _type, uint256 _quantity) public {
        if (_type == 1) {
            ...
            require(
                HBG.balanceOf(msg.sender) * _quantity >= silverPrice,
                "invalid Price "
            );
            ...
            require(_quantity > 0, "Quantity at least greater than 1");
            require(
                HBG.balanceOf(msg.sender) * _quantity >= goldPrice,
                "invalid Price "
            );
            ...
            require(_quantity > 0, "Quantity at least greater than 1");
            require(
                HBG.balanceOf(msg.sender) * _quantity >= platinumPrice,
                "invalid Price "
            );
            ...
            require(_quantity > 0, "Quantity at least greater than 1");
            require(
                HBG.balanceOf(msg.sender) * _quantity >= diamondPrice,
                "invalid Price "
            );
