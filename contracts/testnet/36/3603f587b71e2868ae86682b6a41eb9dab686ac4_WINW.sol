...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable BUSD = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //WBNB
...
contract WINW is ERC20, SafeToken {
    using SafeMath for uint256;
    ...
    WINWDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x0211DeBf044cC153A11402573e21f1Fa1C9C2F42;
    address public _devWalletAddress = 0xe663CC8d426692Fc6c6a5b0B9B75a6848647f01A;
    ...
    constructor() public ERC20("WIN-WIN HELPING", "WINW08") {

    	dividendTracker = new WINWDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "WINW: The dividend tracker already has that address");

        WINWDividendTracker newDividendTracker = WINWDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "WINW: The new dividend tracker must be owned by the WINW token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "WINW: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "WINW: Account is already the value of 'excluded'");
    ...
    function setMaxTxPercent(uint256 maxTxAmount) external onlyOwner() {
        ...
        require(_maxTxAmount >= 100000, "maxTxAmount should be 1% of total supply or more");
    }

    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "WINW: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "WINW: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 800000, "WINW: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "WINW: Cannot update gasForProcessing to same value");
...
contract WINWDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("Reward Tracking System", "RTS") {
    	claimWait = 300;
