...
contract BabyReau is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Baby Reau";
    string constant _symbol = "$BABYREAU";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xCDCb1c7bd88731a357cf3Fe37aBD08137d4b9647;  //marketingwallet
        anothermarketingWallet = 0xCDCb1c7bd88731a357cf3Fe37aBD08137d4b9647; // change for your markt wallet
