...
contract ERC1155Style is Ownable, ERC1155Supply, ERC2981 {
    ...
    function setNftIdPrice(uint256 saleOrderId, uint256 nftId, uint256 price) public {
        ...
        require(balanceOf(msg.sender, nftId) > 0, "nftId number must be greater than 0");
...
contract MgNftDex is DEXConfig, OrderHelper, ReentrancyGuard, OrderValidator, TransferHelper {
    ...
    */
    ...
    nonReentrant {
        ...
        if (ContractType(_makerOrder.contractType) == ContractType.ERC721) {
...
abstract contract TransferHelper is DEXConstantsAndStructs {
    ...
    function transferNFT(
        ...
        // erc1155 transfer
        if (ContractType(_order.contractType) == ContractType.ERC1155) {
            transferERC1155(
                _order.assets.nft,
                _nftOwner,
                _nftRecipient,
