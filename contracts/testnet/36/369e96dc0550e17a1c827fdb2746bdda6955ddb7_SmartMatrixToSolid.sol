...
contract SmartMatrixToSolid is Initializable {
    ...
    function findFreeX3Referrer(address userAddress, uint8 level) public view returns(address referaddress) {
        while (true) {
    ...
    function usersX6Matrix(address userAddress, uint8 level) public view returns(address, address[] memory, bool, address, uint) {
