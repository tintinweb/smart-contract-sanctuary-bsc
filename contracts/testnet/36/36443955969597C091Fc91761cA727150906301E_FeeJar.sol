 ...
 */
contract FeeJar is AccessControl, Initializable {
    ...
    uint256 public maxPercetage;
    // uint256 public maxPercetage = 10000;
    ...
    function initialize(
        ...
        // fees validation
        require(
            _networkFee <= _maxPercetage && _lpFee <= _maxPercetage && _supportFee <= _maxPercetage,
