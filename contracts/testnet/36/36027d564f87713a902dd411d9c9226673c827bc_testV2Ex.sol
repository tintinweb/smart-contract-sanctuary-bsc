...
contract testV2Ex is IERC20Metadata, Ownable {
    ...
    string constant _name = "testV2Ex";
    string constant _symbol = "TVX";
    ...
    constructor () {
        ...
        IPancakeRouter _newPancakeRouter = IPancakeRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        pair = IPancakeFactory(_newPancakeRouter.factory()).createPair(address(this), _newPancakeRouter.WETH());
    ...
    function updateRouterAddress(address newAddress) external onlyOwner {
        ...
        router = IPancakeRouter(newAddress);   
    }
