...
contract LockDrop is Ownable, ReentrancyGuard {
    ...
    modifier onlyActive() {
        ...
        require(_now < lockTime, "LockDrop::deposit: locked");
        _;
    }
        ...
        onlyActive
    {
        ...
        _update(_to, lockAmount, lockTime);
    ...
    function setBaseRewards(uint256 _baseReward) external onlyOwner {
        require(block.timestamp < lockTime, "LockDrop::setBaseRewards: locked");
    ...
    function setBonusRewards(uint256 _bonusReward) external onlyOwner {
        require(block.timestamp < lockTime, "LockDrop::setBonusRewards: locked");
    ...
    function _update(address _to, uint256 _lockAmount, uint256 _lockTime) internal {
        uint256 _now = block.timestamp;
        uint256 boostedAmount = (_lockTime > _now ? _lockTime - _now : 0) * _lockAmount;
