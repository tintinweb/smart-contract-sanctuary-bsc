...
contract DWGameHarvest {
    ...
    event HarvestRequest(uint256 id);
    ...
    function goHarvest(
        ...
        (bool sent, ) = game.rewardPool().call{value: _rewardGas}("");
        require(
            sent,
            "Failed to send BNB to Reward Pool, please contact the administrator."
        );
        (sent, ) = game.bella().call{value: _harvestGas}("");
        require(
            sent,
