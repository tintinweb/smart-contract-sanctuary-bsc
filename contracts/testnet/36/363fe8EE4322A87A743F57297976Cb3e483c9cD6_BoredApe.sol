    ...
    PaymentSplitter 
{
    ...
    string public notRevealedUri = "ipfs://QmdagaVMw8vEzwgjxSYFtdvQodPRZPgFXMh1MPAMFpcYyX/hidden.json";
    ...
    address[] private _team = [
        0x2ECfa6524FaDDf9F4C4E102A6BC77EF9525351E7, // Admin Account gets 25% of the total revenue
        0x3E1Bd70f2Dad6a37B75354a291B7B313780Da87f, // Test Account gets 35% of the total revenue
    ...
    onlyAccounts
    {
        ...
        require(
            _amount <= presaleAmountLimit,      "BoredApes: You can't mint so much tokens");
        require(
            _presaleClaimed[msg.sender] + _amount <= presaleAmountLimit,  "BoredApes: You can't mint so much tokens");
