...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public NaysapayLottery;
     ...
     * @param _seed: seed provided by the Naysapay lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == NaysapayLottery, "Only NaysapayLottery");
    ...
    /**
     * @notice Set the address for the NaysapayLottery
     * @param _NaysapayLottery: address of the Naysapay lottery
     */
    function setLotteryAddress(address _NaysapayLottery) external onlyOwner {
        NaysapayLottery = _NaysapayLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = INaysapayLottery(NaysapayLottery).viewCurrentLotteryId();
    }
}