...
contract Miticoin is ERC20,Ownable,IMiticoin {
    ...
    function PrimaryMINT (uint256 PrimaryTotalWorld) public virtual override {
        ...
        require(msg.sender==Coll);
         ...
         uint256 d =decimals();
        uint256 PrimaryMITI = PrimaryTotalWorld-Collection.Get_Total_world();
        _mint(Contr.getZoomLoupe(),PrimaryMITI*10*d);
        _mint(Contr.getTeam(),PrimaryMITI*10*d);
        _mint(Contr.getCashback(),PrimaryMITI*35*d);
        _mint(Contr.getRsearchers(),PrimaryMITI*5*d);
        _mint(Contr.getSaleMITI(),PrimaryMITI*40*d);
        Primary=true;
    } 
    ...
    function Add_collection (uint256 MaxWorld) public virtual override  {
        ...
        require(msg.sender==Coll);
        uint256 d =decimals();
        uint256 MITI = MaxWorld*100*d;
        _mint(Contr.getMiningPool(),MITI);
    }
