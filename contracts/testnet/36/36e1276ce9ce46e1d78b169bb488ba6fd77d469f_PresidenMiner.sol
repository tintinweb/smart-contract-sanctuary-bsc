...
contract PresidenMiner is Ownable {
	...
	uint256[] public REFERRAL_PERCENTS = [500, 200, 100, 75, 50, 30, 25, 20, 15, 10];
	uint256[] public SEED_PERCENTS = [500, 100, 100, 100, 100, 100, 0, 0, 0, 0];
	uint256 constant public PROJECTIN_FEE = 900;
    uint256 constant public PROJECTOUT_FEE = 200;
	...
	uint256 constant public	WITHDRAW_COOLDOWN = 1 days; // claim 3 time per day
