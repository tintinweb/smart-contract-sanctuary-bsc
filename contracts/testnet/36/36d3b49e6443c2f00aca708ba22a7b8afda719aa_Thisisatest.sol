...
contract Thisisatest is Context, IERC20, Ownable {
    ...
    string private _name = "Magnusson";
    string private _symbol = "3M";
    uint8 private _decimals = 9;
    bool public market_active;
    mapping (address => bool) public premarket_user;

    address payable public marketingWalletAddress = payable(0xE54516e3e6167B695c71B2Ab9d74405A8C3405bD);
    address payable public devWalletAddress = payable(0x2D94a49E4591a371B457994BcBEE53FC2d3F1583);
    ...
    uint256 private _totalSupply =  15080 * 10**_decimals;
    uint256 public _maxTxAmount =   60 * 10**_decimals;     
    uint256 public _walletMax =     151 * 10**_decimals;      
    uint256 private minimumTokensBeforeSwap = 45 * 10**_decimals; // 0.3%
