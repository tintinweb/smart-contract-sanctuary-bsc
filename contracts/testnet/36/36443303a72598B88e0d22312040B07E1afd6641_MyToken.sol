...
contract MyToken is ERC721r, Ownable {

    string public uriPrefix = "";

    uint public cost = 8000000000000000;
    uint public maxMintAmountPerTx = 10;
    bool public paused = false;

    mapping(address => bool) private blockList;

    constructor () ERC721r("NFTMint", "NFT", 6660) {
         _mintRandom(msg.sender, 1);
    }

    modifier mintCompliance(uint _quantity) {
        require(blockList[msg.sender] == false, "This address blocked!");
    ...
    function ownerMint(uint256 _quantity) public mintCompliance(_quantity) onlyOwner {
        _mintRandom(msg.sender, _quantity);
    }

    function freeMint(uint _quantity) public payable mintCompliance(_quantity) {
