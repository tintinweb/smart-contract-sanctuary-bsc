...
contract BCNFTStaking is Context, Ownable {
    ...
    constructor() {
        iBCNFT = IBCNFT(0xd7b54f8D2344855882506D9ef18eD5cd8c62E902);
        iBCToken = IBCToken(0xB52D6769E203F01931F101b24500bAA4264c28aA);

        rewardTokenAddress = 0xB52D6769E203F01931F101b24500bAA4264c28aA;
        NFTTokenAddress = 0xd7b54f8D2344855882506D9ef18eD5cd8c62E902;
    }

    function stake(uint256 period) external {
        bool isStake = isStakable(msg.sender);
        require(isStake, "You can't Stake");

        stakers[msg.sender].tokenIds = iBCNFT.getTokensOfOwner(msg.sender);
    ...
    function isStakable (address owner) public returns(bool) {
        ...
        uint256 tokensOfOwner = iBCNFT.balanceOf(owner);
        require(tokensOfOwner > 1, "You must have at least 2 tokens");
    ...
    function getTokensOfOwner(address _owner) internal view returns(uint256[] memory) {
    ...
    function setStakeLevel(address _owner) internal returns (uint256) {
        uint256 level = levelCountOfOwner[_owner];
        require(level >=2, "You have at least 2 NFTs");
    ...
    function isClaimable(address owner) public view returns(bool) {
        require(stakers[owner].isStaking, "You did not stake");
    ...
    function claimReward() external returns(bool) {
        ...
        uint256 totalToken = iBCToken.totalSupply();
