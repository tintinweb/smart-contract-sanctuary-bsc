...
contract CrobaInu is ERC20, Auth {
  using SafeMath for uint256;

  address public constant DEAD = 0x000000000000000000000000000000000000dEaD;

  string constant _name = "CrobaInu";
  string constant _symbol = "CROBA";
  ...
  FeeWallets public _feeWallets =
    FeeWallets({
      marketing: payable(0x12c57E2C0CE19ad0E59F1C9472CBFdcDaC87E8ff),
      community: payable(0x12c57E2C0CE19ad0E59F1C9472CBFdcDaC87E8ff),
