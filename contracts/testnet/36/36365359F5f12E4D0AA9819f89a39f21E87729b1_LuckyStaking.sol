...
contract LuckyStaking {
    ...
    address public luckywallet=0x000Af8236e56E673b48BE0df82F075dba78F002c;
    IBEP20 public CNR = IBEP20(CNRContract);

    LuckyWallet LuckyWalletContract=LuckyWallet(0x000Af8236e56E673b48BE0df82F075dba78F002c);   
