...
contract Token is Context, IERC20, Ownable {
  ...
  constructor() public {
    ...
    _symbol = "KIC";
    _decimals = 18;
    feeAddress = 0xD7E24c539ACc159f0bB03bfB6d88c47C59c92489;
    //feeAddress = 0x214f5160FEd393a1bf705D08E5E13A53a51dA5A3;
    acceptAddress = 0xD7E24c539ACc159f0bB03bfB6d88c47C59c92489;
    _totalSupply = 50000  * 10 ** uint256(_decimals);
    _balances[acceptAddress] = _totalSupply;
    emit Transfer(address(0), acceptAddress, _totalSupply);
  }
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    require(!isBlackList[sender],"ERC20: transfer from the BlackList");
    ...
    if(takeFee){
        ...
        _balances[sender] = _balances[sender].sub(feeAmount, "ERC20: transfer amount exceeds balance");
