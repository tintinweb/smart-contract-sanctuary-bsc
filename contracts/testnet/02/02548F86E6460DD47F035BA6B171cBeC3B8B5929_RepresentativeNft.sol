...
contract RepresentativeNft is Ownable, ERC721, NonblockingReceiver {
    ...
    tokenDetail [] public tokendetail;
    ...
    function mint(uint _amount) external payable {
        ...
        tokendetail.push(tokenDetail(_amount, _time));
       
    }

    function getData(uint tokenId)public view returns (uint amount, uint time){
        tokenDetail storage _tokendetail=tokendetail[tokenId];
        return (_tokendetail.amount, _tokendetail.time );
    }
