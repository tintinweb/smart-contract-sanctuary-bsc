...
import "./slow/interfaces/ISlowERC20.sol";
import "./slow/interfaces/ISlowPair.sol";
import "./slow/interfaces/ISlowFactory.sol";
...
contract IceCreamVan is Ownable {
    ...
    // V1 - V5: OK
    ISlowFactory public immutable factory;
    ...
    constructor(
        ...
        require(_factory != address(0) && _bar != address(0) && _pops != address(0) && _weth != address(0) , "SlowMaker: zero address");
        factory = ISlowFactory(_factory);
        bar = _bar;
        pops = _pops;
        weth = _weth;
    }
    ...
    modifier onlyEOA() {
        ...
        require(msg.sender == tx.origin, "SlowMaker: must use EOA");
        _;
    }
    ...
    //     As the size of the SLOWBar has grown, this requires large amounts of funds and isn't super profitable anymore
    ...
    function _convert(address token0, address token1) internal {
        // Interactions
        // S1 - S4: OK
        ISlowPair pair = ISlowPair(factory.getPair(token0, token1));
        require(address(pair) != address(0), "SlowMaker: Invalid pair");
        // balanceOf: S1 - S4: OK
        // transfer: X1 - X5: OK
    ...
    function _swap(
        ...
        // X1 - X5: OK
        ISlowPair pair =
            ISlowPair(factory.getPair(fromToken, toToken));
        require(address(pair) != address(0), "SlowMaker: Cannot convert");
