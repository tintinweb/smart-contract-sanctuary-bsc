...
// SPDX-License-Identifier: MIT
    ...
    abstract contract ReentrancyGuard {
        ...
        contract BnbYProx_v2 is Initializable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuard{
            ...
            uint256 public DEPOSIT_BONUS_PERCENT; //1% 
            uint256 public PRC_PARTN; //1% 
            uint256 public PRC_BONUS_HOLDER; //1%
            uint256 public REINVEST_PERCENT; //10%
            uint8 public TimeReInvest = 24; //24 days

            uint256 public VIP_TARIF; // 20 days hold
            uint256 public VIP_TARIF_PRICE; // access with 20bnb
            uint256 public VIP_WITHDRAW_TIME_STEP; // 20 days hold
            uint256 public VIP_FeeWithdraw; // 30% of fee for withdraw user vip

            uint256 public TaxWithdrawWhale; //45%
            uint256 public TaxDepositWhale; //40%
