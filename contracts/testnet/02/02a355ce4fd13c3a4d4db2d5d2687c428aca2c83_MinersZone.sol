...
contract MinersZone is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 200_000_000 * 10**18; //200 Million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;



    string private constant _name = "MinersZone";
    string private constant _symbol = "MZN";
    uint8 private _decimals = 18;


    uint256 private constant _taxFee = 0; //Disable for this code
    ...
    uint256 constant _saleLiquidityFee = 2;
    uint256 constant _salegameRewardFee = 3;
...
//    address public pinkAntiBot_ = 0xbb06F5C7689eA93d9DeACCf4aF8546C4Fe0Bf1E5; 
    ...
    uint256 public minimumTokensBeforeSwap = 100_000 * 10**18;
...
//Updated on 1.22 to address concerns.
...
//Updated on 1.22 to address minor audit recommendation of external vs public funciton
