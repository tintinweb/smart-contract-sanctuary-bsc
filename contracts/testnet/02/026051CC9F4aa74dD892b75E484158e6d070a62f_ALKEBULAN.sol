...
contract ALKEBULAN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xb0E0284390CD10B5B0209aCE80e7FA5902C78c08); // Marketing Address
    address payable public liquidityAddress = payable(0xD77097d194C827c4F40830CDFf84Cd8c5b525148); // Liquidity Address
    ...
    string private _name = "ALKEBULAN";
    string private _symbol = "LAN";
