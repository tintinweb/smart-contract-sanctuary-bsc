    ...
    Ownable
{
    ...
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == lottery, "Only LotteryProgram");
    ...
    /**
     * @notice Set the address for the LotteryProgram
     * @param _lottery: address of the lottery program
     */
        ...
        override
    {
        ...
        latestLotteryId = ILotteryProgram(lottery).viewCurrentLotteryId();
    }
}