...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
	...
	/**
	* @dev Burn tokens Nft for ID
	*/
	function burn_token(uint256 tokenId) internal virtual {
		_burn(tokenId);		
	}
...
contract TokenRecover is Ownable {
     ...
     */
    function _recoverERC20(address tokenAddress, uint256 tokenAmount) public virtual onlyOwner {
...
pragma solidity ^0.8.0;
contract CryptoBullRunNFT is ERC721Enumerable, Ownable, TokenRecover, ReentrancyGuard {
    ...
    constructor() ERC721("Crypto Bull Run", "BULLRUN"){
    }	
