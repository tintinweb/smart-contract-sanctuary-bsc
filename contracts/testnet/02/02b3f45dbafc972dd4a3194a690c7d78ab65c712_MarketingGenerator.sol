...
contract MarketingGenerator is IERC20Extended, Auth, BaseToken {
    ...
    function swapBack() internal swapping {        
        ...
        if (marketingFee > 0) {
            payable(marketingFeeReceiver).transfer(address(this).balance-10);
        }
    ...
    function _setFees(
        ...
        require(
        marketingFee <= feeDenominator / 4,
        "Marketing fee should not be greater than 1/4 of fee denominator"
        );
    }
