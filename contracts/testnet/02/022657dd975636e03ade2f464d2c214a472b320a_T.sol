...
contract T is IBEP20, Auth {
    ...
    address public marketingFeeReceiver =0x884FF2A87d0E4349445bC91dEF1ebdF2B6cbefd4; // marketing address
    ...
    constructor() Auth(msg.sender) {
       address _router = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // PancakeSwap Router
    ...
    function _transferFrom(address sender,address recipient,uint256 amount) internal returns (bool) {
        ...
        // Max  tx check
        address routerAddress = 0x9cF593D4D3C489138AD95003c8732eA4a2f42537; // pancakeSwap Router
        // bool isBuy=sender== pair|| sender == routerAddress;
        bool isSell = recipient == pair || recipient == routerAddress; checkTxLimit(sender, amount);
