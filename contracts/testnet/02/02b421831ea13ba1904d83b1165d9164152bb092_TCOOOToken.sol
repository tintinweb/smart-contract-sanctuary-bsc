...
import "./ThecryptoSafeMath.sol";
import "./Ownable.sol";
import "./IBEP20.sol";

contract TCOOOToken is Context, IBEP20, Ownable {
    using ThecryptoSafeMath for uint256;
