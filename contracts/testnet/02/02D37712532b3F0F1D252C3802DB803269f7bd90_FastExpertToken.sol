...
/**
            ...
            ╚═╝░░░░░╚═╝░░╚═╝╚═════╝░░░░╚═╝░░░  ╚══════╝╚═╝░░╚═╝╚═╝░░░░░╚══════╝╚═╝░░╚═╝░░░╚═╝░░░
                            ...
                            Telegram Chat
                            https://t.me/hizliuzmantoken

                            Telegram News
                            https://t.me/hizliuzman

                            Twitter
                            https://twitter.com/hizliuzman

                            Website
                            https://www.hizliuzman.com/token

                            Total Supply                  : 210.000.000.000
                            Team Fee                      :   2.100.000.000
                            Scholarship Fee for Students  :   8.400.000.000
...
contract FastExpertToken is Context, IBEP20, Ownable {
    ...
    address public MarketingWallet =
        0x359799CA506f6BF464574f4Fcfc63361BA713F91;
    address public immutable DeadWallet =
        0x000000000000000000000000000000000000dEaD;

    uint256 private constant MAX = ~uint256(0);
    uint256 private constant _tTotal = 210 * 10**12 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Fast Expert Token";
    string private constant _symbol = "HZL";
    ...
    uint256 private numTokensSellToAddToLiquidity = 100 * 10**9 * 10**8;
    uint256 public _maxTxAmount = 3 * 10**12 * 10**8;
    uint256 public _maxWalletHoldingLimit = 11 * 10**12 * 10**8;
