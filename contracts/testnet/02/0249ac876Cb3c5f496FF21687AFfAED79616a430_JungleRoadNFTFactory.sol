...
import "./openzeppelin-4.4.2/access/Ownable.sol";
import "./openzeppelin-4.4.2/security/ReentrancyGuard.sol";
import "./openzeppelin-4.4.2/utils/Strings.sol";
import "./opensea-creature/IFactoryERC1155.sol";
import "./opensea-creature/ERC1155Tradable.sol";

/**
 * @title JungleRoadNFTFactory
 * CreatureAccessory - a factory contract for Creature Accessory semi-fungible
 * tokens.
 */
contract JungleRoadNFTFactory is FactoryERC1155, Ownable, ReentrancyGuard {
    ...
    constructor(address _nftAddress, address _lootBoxAddress) {
    ...
    function _mint(
        ...
        require(_canMint(_msgSender(), _option, _amount), "JungleRoadNFTFactory#_mint: CANNOT_MINT_MORE");
    ...
    function _isOwnerOrProxy(address _address) internal view returns (bool) {
        if (proxyRegistryAddress != address(0)) {
            ...
            return address(proxyRegistry.proxies(owner())) == _address;
        }
...
import "../openzeppelin-4.4.2/access/Ownable.sol";
import "../openzeppelin-4.4.2/token/ERC1155/ERC1155.sol";
import "../openzeppelin-4.4.2/utils/math/SafeMath.sol";
import "../openzeppelin-4.4.2/utils/Strings.sol";
...
import {SafeMath} from "../../../openzeppelin-4.4.2/utils/math/SafeMath.sol";
