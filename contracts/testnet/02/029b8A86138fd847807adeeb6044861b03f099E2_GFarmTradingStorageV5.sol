...
contract GFarmTradingStorageV5 {
    ...
    function storeTrade(Trade memory _trade, TradeInfo memory _tradeInfo) public {
    ...
    function updateOpenInterestDai(uint _pairIndex, uint _leveragedPosDai, bool _open, bool _long) public {
