...
contract BilliardCrypto2 is ERC20, Ownable {
    ...
    address public marketingWallet = 0x7A9cFe282e7a6A53D591C38EB90C75C7c9F3EC1A;
    ...
    constructor() ERC20("Billiard Crypto2", "BIC") {
        _tokengeneration(msg.sender, 1e7 * 10**decimals());
        
        exemptFee[msg.sender] = true;
        address routerAdd = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
        address _liquidityPairToken = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47;
