...
contract Muugrow is IBEP20, Auth {
    ...
    string constant _name = "Muugrow";
    string constant _symbol = "MUU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 10) / 100;  //10% max tx
    ...
    address private marketingFeeReceiver = 0x8e9EB86dDFfE1a82eE15Dad9fa4e30FE1A5A953e;
    address private teamFeeReceiver = 0xD915618Ef35b30415fAd2ed223A53D38837CE5eF;
