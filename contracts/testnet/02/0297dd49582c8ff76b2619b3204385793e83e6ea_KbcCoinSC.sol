...
/******************************************************************************
Token Name : KBA COIN
Short Name/Ticker : KBA
Total Supply : 210000
Decimal : 18
Platform : BEP20 
Project Name : KBA COIN
...
contract KbcCoinSC is Context, IERC20, Ownable {  
    ...
    uint256 public _developmentBuyPer = 1;
    uint256 public _developmentSellPer = 2;
    
    uint256 public _marketingBuyPer = 1;
    ...
    constructor () public {
        ...
        marketingwallet = 0x045FE1442A3010f1e10b62C8C47eDe5163288280;
        developmentwallet= 0x5a6F0ca7F707FBFCb14ce5E296bA0712CBE2AAaD;
    ...
    function updateBuyFee(uint buyTaxFee,uint marketingBuyPer, uint developmentBuyPer,uint autoBurnBuyPer) onlyOwner public {
    ...
    function swapAndLiquify(uint256 contractTokenBalance,uint TaxType) private lockTheSwap {
        ...
        uint256 DevelopmentBNB = Balance.sub(MarketingBNB);
        if(MarketingBNB>0)
    ...
    function _takeMarketingFee(uint256 tAmount,uint256 tFee,uint TaxType) private {
      ...
      if(TaxType==1){
        ...
        uint256 FeeMarketing=MarketingShare+DevelopmentShare;
        uint256 contractTransferBalance = FeeMarketing;
