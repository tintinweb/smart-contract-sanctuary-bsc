...
contract USDTSeed {
  ...
  IERC20 public tokens = IERC20(0x772CE11645f3735E5b1cc3Ca4EF428c003e60800); 
	uint256 constant public INVEST_MIN_AMOUNT = 5e16; // 5 USDT
	...
	function invest(address referrer, uint8 plan, uint256 amounts) public  {
        ...
        //tokens.transfer( address(this), amounts);
