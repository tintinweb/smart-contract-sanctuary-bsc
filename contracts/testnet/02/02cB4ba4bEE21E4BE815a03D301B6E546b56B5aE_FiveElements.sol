...
contract FiveElements is Permission {
    ...
    IHash private hashAddress = IHash(0x2604c2dAf6dC7Ea2861bBDA91B627872dFd44E93);
    ...
    function _buyTicket(uint8 camp, uint16 amount) private {
        if(endTime + 10 * amount > block.timestamp + 400000){
            endTime = block.timestamp + 400000;
        }else{
