...
contract Migrator is GiftPack {
    ...
    //     // Set Token
    //     _setTokenCount(tokenCount);

    //     // Set Dna
    //     _setDnaCount(dnaCount);
    //     _setDnasKeys(dnasKeys);
    ...
    //     }
    //     _setDnas(dnasKeys, dnasArr);

    //     // Set Zombie
    //     _setZombieCount(zombieCount);
    //     _setZombiesKeys(zombiesKeys);
    ...
    //         );
    //     }
    //     _setZombies(zombiesKeys, zombiesArr);
    // }

    function setERC20Data() external {
        for (uint i = 1; i <= userCount; i++) {
    ...
    function setERC721Data() external {
...
contract ZombieAttack is ZombieHelper {
    ...
    function findBattle(uint _zombieId) external view returns (uint) {
        ...
        // Find Zombie
        require(findRandomZombie(_zombieId) <= tokenCount);
        return findRandomZombie(_zombieId);
    }
...
contract ZombieHelper is ZombieFeeding {
    ...
    // function _setTokenCount(uint _tokenCount) internal {
    //     tokenCount = _tokenCount;
    // }

    // function _setDnaCount(uint _dnaCount) internal {
    //     dnaCount = _dnaCount;
    // }

    // function _setZombieCount(uint _zombieCount) internal {
    //     zombieCount = _zombieCount;
    // }

    // function _setDnasKeys(uint[] memory _dnasKeys) internal {
    //     dnasKeys = _dnasKeys;
    // }

    // function _setZombiesKeys(uint[] memory _zombiesKeys) internal {
    //     zombiesKeys = _zombiesKeys;
    // }

    // function _setDnas(uint[] memory dnasKeys, Dna[] memory _dnas) internal {
    //     for (uint i = 0; i < dnaCount; i++) {
    //         dnas[dnasKeys[i]] = _dnas[i];
    //     }
    // }

    // function _setZombies(uint[] memory zombiesKeys, Zombie[] memory _zombies)
    //     internal
    // {
    //     for (uint i = 0; i < dnaCount; i++) {
...
contract UserBase is Ownable {
     ...
     *  @return user
     */
    function createUser(address _creator, string memory _name)
        external
        returns (User memory)
    {
        // TODO: Check if wallet address already exists
        userCount++;
