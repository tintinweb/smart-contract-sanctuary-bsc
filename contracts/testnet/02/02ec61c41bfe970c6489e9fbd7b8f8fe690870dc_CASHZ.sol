...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x99b86de777982B3DD358c636AeafB70cE5e8760a); //Reward Token
...
contract CASHZ is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "KingZ Cash";
    string constant _symbol = "CASHZ";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0xca2aBa53a744EbFD223a5E934e4c5B9ADb6CDB00;  // Marketing wallet
