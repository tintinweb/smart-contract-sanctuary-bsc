...
contract RefundC is StandardToken { // CHANGE THIS. Update the contract name.
...
event LogDeposit(address sender, uint amount);
    ...
    */
    ...
    function RefundC() {
        ...
        name = "RefundC";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "RFC";                                             // Set the symbol for display purposes (CHANGE THIS)
...
function refund(uint amountRequested) public  returns(bool success) {
    ...
    LogRefund(msg.sender, amountRequested);
     uint256 mbnb = amountRequested /  unitsOneEthCanBuy;
     msg.sender.transfer(mbnb);
