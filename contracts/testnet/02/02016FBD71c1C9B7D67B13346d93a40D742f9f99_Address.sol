...
contract ThisBeCrazy is Context, IERC20, Ownable { 
    ...
    address public marketingWallet = 0x34EA6Efc02418551406e25aFcaAD94D44364b917;
    address public devWallet = 0xA6569D41D2E2960AdaA2af29C600696fBFB02A5e;
    address public buybackWallet = 0xBcD08213e2201a44137F1eE91FE76EfF89f4D74D;

    string private constant _name = "ThisBeCrazy2";
    string private constant _symbol = "TBC2";
    ...
    Taxes public taxes = Taxes(0, 2, 2, 1, 0);
    Taxes public sellTaxes = Taxes(0, 4, 4, 2, 0);
