...
contract GOOGLEFALSETEST is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xc6f3688A8F531Bc5Bb062407028CcBE805142C55);  //marketing wallet
    address payable public Wallet_Dev = payable(0xc6f3688A8F531Bc5Bb062407028CcBE805142C55); //dev wallet
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**6 * 10**_decimals; //total supply 1 million
    string private constant _name = "Google False Test"; 
    string private constant _symbol = unicode"GF Test";

    uint8 private txCount = 0;
    uint8 private swapTrigger = 10; 

    uint256 public _Tax_On_Buy = 3; //tax buy 3%
    uint256 public _Tax_On_Sell = 3; //tax sell 3%
    ...
    uint256 public _maxWalletToken = _tTotal * 4 / 100; //max wallet 4%
    uint256 private _previousMaxWalletToken = _maxWalletToken;

    uint256 public _maxTxAmount = _tTotal * 2 / 100; //max tx 2%
    ...
    function _transfer(
        ...
        if (to != owner() && //LP will not able to be rugged
            to != Wallet_Burn &&
            to != address(this) &&
            to != uniswapV2Pair &&
            from != owner()){
