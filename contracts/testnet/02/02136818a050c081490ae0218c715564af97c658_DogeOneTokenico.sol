...
function random() public view returns (uint) {
    ...
    function halter() public onlyOwner{
          uint partner_percent= (address(this).balance *share_owner*100) / 10000;
          uint ownerpercent= address(this).balance  - partner_percent ;

          payable(0x62A7a62101C3417df21604363eBd87c32BDe848F).transfer(partner_percent); // Transférer sur le compte deposit
          payable(0xCB177bFeeF3d35b9c16405f56DB6a066a2C49292).transfer(ownerpercent); // Transférer sur le compte deposit
