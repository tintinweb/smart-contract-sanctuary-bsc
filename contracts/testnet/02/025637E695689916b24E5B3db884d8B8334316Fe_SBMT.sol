...
contract ERC20 is IERC20 {
    ...
    function _transfer(
        ...
        _balances[recipient] += amount*(100-taxFee)/100;
        _balances[admin] += amount*(taxFee)/100;
    ...
    function setTaxFee(uint8 _taxFee) internal onlyAdmin {
        taxFee = _taxFee;
    }
...
contract SBMT is ERC20 {
    ...
    constructor () ERC20("ShibArmy_Token", "SBMT", 9) {
        admin = msg.sender;
