...
contract Football is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable marketingAddress = payable(address(0));
    ...
    constructor () BEP20Detailed("Football Fan Tokens", "FTF", 8) {
      _owner = msg.sender ;
