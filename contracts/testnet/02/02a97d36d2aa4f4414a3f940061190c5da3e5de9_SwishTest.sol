...
contract SwishTest is Context, IERC20, Ownable, BaseToken {
    ...
    constructor() payable { 
        ...
        marketingWallet = 0x1f3fC38F618B251d5ecE8D049401E9fA1E632a66;

        walletToWalletTransferWithoutFee = true;
        maxTransactionAvailable    =  true;
        maxTransactionLimitEnabled = true;
        maxTransactionRateBuy      = 10;
        maxTransactionRateSell     = 10;
        maxWalletAvailable         = true;
        maxWalletLimitEnabled      = true;
        maxWalletLimitRate         = 10;
