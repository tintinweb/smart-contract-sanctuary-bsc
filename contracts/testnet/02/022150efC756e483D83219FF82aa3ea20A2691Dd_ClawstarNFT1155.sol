...
contract ERC1155Metadata {
  ...
  event URIMetadata(string _uri, uint256 indexed _id);
  ...
  function _logURIs(uint256[] memory _tokenIDs) internal {
    ...
    for (uint256 i = 0; i < _tokenIDs.length; i++) {
      ...
      emit URIMetadata(tokenURI, _tokenIDs[i]);
    }
  }
  ...
  function _logURIs(uint256[] memory _tokenIDs, string[] memory _URIs) internal {
    ...
    for (uint256 i = 0; i < _tokenIDs.length; i++) {
      emit URIMetadata(_URIs[i], _tokenIDs[i]);
    }
  }
...
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable {
    ...
    */
    ...
    function ownerMint( 
        ...
        _mint(_initialOwner, _id, _amount, _data);
        tokenSupply[_id] = 1;
        }
        return 0;
    }
  ...
  /**
    ...
    */
    ...
    function AddTotalSupply(uint _id, uint _quantity) internal onlyOwner{
 ...
 */
contract ClawstarNFT1155 is ERC1155Tradable {
  constructor(string memory _name)//address _proxyRegistryAddress)
  ERC1155Tradable(
    _name,
    "CSNFT"
  ) public {
    _setBaseMetadataURI("https://api.ClawstarNFT1155.io/nft/");
  }
