...
contract SatoStake is Context, Ownable, ReentrancyGuard {
    ...
    constructor(address _dev, address _dev1) {
        //tokenAdress = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; //testnettBUSD    
        //tokenAdress = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //mainnettBUSD
        tokenAdress = 0x6ce8dA28E2f864420840cF74474eFf5fD80E65B8; //testnet BTC
        //tokenAdress = 0x7130d2a12b9bcbfae4f2634d864a1ee1ce3ead9c; mainnett BTC
    ...
    uint256 aval_withdraw2 = SafeMath.mul(SafeMath.div(aval_withdraw,100),75); // aval_withdraw2 receive 75%
