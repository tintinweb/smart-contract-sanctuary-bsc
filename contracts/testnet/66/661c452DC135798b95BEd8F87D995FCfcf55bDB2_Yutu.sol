...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // DOGE Token
...
contract Yutu is ERC20, Ownable {
    ...
    constructor() ERC20("Yutu", "YUTU") {
        address newOwner = address(0x1aBF9A2E66906F13ff2830bc18478405abC68eE0);
    	...
    	marketingWallet = address(0x29224fC97BcB2Df0ceCB56BC1E7b579708fFa3ea); // set as marketing wallet
        stakingWallet = address(0x43BCc53C9C6F034Cf6F3d3E736e0230133C626D4); // set as staking wallet
...
contract DividendTracker is DividendPayingToken {
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1 && newClaimWait <= 86400, "Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
