...
contract CloverDarkSeedToken is IBEP20, Auth, Pausable {
    ...
    // @Dev Sell tax..
    uint16 public _sellTeamFee = 6000;
    uint16 public _sellLiquidityFee = 16000;
    uint16 public _sellMarketingFee = 6000;
    ...
    uint256 public first_5_Block_Buy_Sell_Fee = 28000;
    ...
    function collectFeeOnSell(uint256 amount) private returns (uint256) {
        ...
        if (_sellMarketingFee != 0) {
            uint256 marketingFee = amount.mul(_sellMarketingFee).div(100000);
