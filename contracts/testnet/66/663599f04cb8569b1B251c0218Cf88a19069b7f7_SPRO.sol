...
contract SPRO is ERC20Detailed, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 500000 * 10 ** DECIMALS;
    ...
    constructor() ERC20Detailed("Staking Pro", "SPRO", uint8(DECIMALS)) Ownable() {
        ...
        safuuInsuranceFundReceiver = 0x8AdeaF792d63c95171478284c66a84574528b617;
        firePit = 0xDD99c20f1C37E6C5b094C6b29D670a9259c1a46d;
