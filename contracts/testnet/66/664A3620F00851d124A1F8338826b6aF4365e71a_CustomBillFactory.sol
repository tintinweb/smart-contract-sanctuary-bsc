...
contract CustomBillFactory is Policy {
    ...
    address public immutable DAO; // solhint-disable-line
    ...
    constructor(
        ...
        require(_treasury != address(0), "CustomBillFactory: Treasury cannot be zero address");
        treasury = _treasury;
        require(_factoryStorage != address(0), "CustomBillFactory: Factory Storage cannot be zero address");
        factoryStorage = _factoryStorage;
        require(_subsidyRouter != address(0), "CustomBillFactory: Subsidy router cannot be zero address");
        subsidyRouter = _subsidyRouter;
        require(_DAO != address(0), "CustomBillFactory: DAO cannot be zero address");
        DAO = _DAO;
        require(_billImplementationAddress != address(0), "CustomBillFactory: Bill implementation address cannot be zero address");
        billImplementationAddress = _billImplementationAddress;
        require(_treasuryImplementationAddress != address(0), "CustomBillFactory: Treasury implementation address cannot be zero address");
