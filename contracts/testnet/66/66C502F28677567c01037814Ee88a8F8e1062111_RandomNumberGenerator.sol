    ...
    Ownable
{
    ...
    address private _callableAddress1;
    address private _callableAddress2;
    constructor(
    ...
    modifier onlyCallable() {
        require((msg.sender == _callableAddress1) || (msg.sender == _callableAddress2));
        _;
    }
    ...
    function setNumWords (uint32 amount) external override {
        numWords = amount;
    }
}
...
interface IRandomNumberGenerator {
    ...
    function setNumWords(uint32 amount) external;
}
