...
contract TicketMarketplace is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function updatePaymentToken(address _paymentToken, bool _status) public onlyOwner{
        paymentTokens[_paymentToken] = _status;
    }
}
