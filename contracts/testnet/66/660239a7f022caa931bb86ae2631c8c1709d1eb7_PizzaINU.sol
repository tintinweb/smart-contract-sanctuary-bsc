...
/*
          ...
          Website: https://inu.pizza/
         Telegram: https://t.me/PizzaINUproject
...
contract PizzaINU is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"PizzaINU";
    ...
    address payable public _pizzaWallet;
    ...
    function setPizzaWallet(address payable _address) external onlyOwner {
        _pizzaWallet = _address;
    }
    ...
    function swapTokensForEth(uint256 tokenAmount) private lockTheSwap {
        ...
        uint256 buyback = amount.sub(marketing).div(2); // 1%
        uint256 pizza = amount.sub(marketing).sub(buyback); // 1%
        _buybackWallet.transfer(buyback);
        _marketingWallet.transfer(marketing);
        _pizzaWallet.transfer(pizza);
    }
