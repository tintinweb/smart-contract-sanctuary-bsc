...
contract Brt is ERC20Detailed, Ownable {
    ...
    string public _name = "Brt";
    string public _symbol = "BRT";
    ...
    address public totalfeeReceiver;
    ...
    uint256 public n_passed;
    uint256 public n_passed_fee;

    mapping(address => uint256) private _gonBalances;
    mapping(address => mapping(address => uint256)) private _allowedFragments;
    mapping(address => bool) public blacklist;

    constructor() ERC20Detailed("Brt", "BRT", uint8(DECIMALS)) Ownable() {

        // router = IPancakeSwapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);   // Mainnet
        router = IPancakeSwapRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);      // testnet
        ...
        InsuranceFundReceiver = 0x082D0FbCA3D80b2d4A05E20bFc227523bE8EFEF3;
        firePit = 0xaA32C984AfDfa6B95e88B8aB7faBfa65De89b98C;
        totalfeeReceiver = 0xb304c8E72582F9640d06aB80e0ba55812EE1e7C0;
    ...
    function takeFee(
        ...
        _gonBalances[totalfeeReceiver] = _gonBalances[totalfeeReceiver].add(feeAmount);
        
        // emit Transfer(sender, address(this), feeAmount.div(_gonsPerFragment));
        emit Transfer(sender, totalfeeReceiver, feeAmount.div(_gonsPerFragment));
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no Brt token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function setTotalfeeRecevier(address _totalfeeReceiver) external onlyOwner
    {
