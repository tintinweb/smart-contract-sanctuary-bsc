...
contract Implementation is Initializable, UUPSUpgradeable, GetterSetter {
     ...
     * @param (0) name, (1) symbol, (2) baseURI
     * @param 0: 721, 1: 1155
     ...
     * @param (0) token id, (1) onSaleQuantity, (2) price, (3) token type, (4) amount, (5) royalty fee, (6) isOffer, (7) total copies
     ...
     * @param (0) tokenId, (1) totalCopies, (2) amount
     * @param (0) buyer, (1) signer, (2) token address
     * @param (0) nftId, (1) transactionId
     * @param (0) signature
     */
...
import {SaleOrder, BuyRequest } from "../common/Structs.sol";
...
contract Upgradeable is OwnableUpgradeable {
