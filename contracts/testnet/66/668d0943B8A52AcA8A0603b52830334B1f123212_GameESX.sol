...
import "./ElonSpaceX.sol";
import "@openzeppelin/contracts/access/Ownable.sol";

contract GameESX is Ownable {
    // admin address
    address private admin;
    // balance of tokens held in escrow
    uint256 public contractBalance;
    // this is the erc20 ElonSpaceX contract address
    address constant tokenAddress = 0x9115b79DaEf4EA3C701Bb16BD57d0e701a59A6eC; // <-- INSERT DEPLYED ERC20 TOKEN CONTRACT HERE
   uint256 public maxSupply = 100000000000000000000; // <-- temporaily set manually for flexibility while in pre-alpha development
    ...
    function createGame(
        ...
        ElonSpaceX token = ElonSpaceX(tokenAddress);
        //unit = token.unit();
...
contract ElonSpaceX is ERC20, Ownable {
    constructor() ERC20("Elon SpaceX", "ESX") {
