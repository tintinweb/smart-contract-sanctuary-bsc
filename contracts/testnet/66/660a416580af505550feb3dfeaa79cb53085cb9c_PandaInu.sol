...
contract PandaInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Panda Inu ", "PANDA") {
        ...
        marketingWallet = address(0x471253e4233B4095Eafc802074D7f92d0aA449B7); // set as marketing wallet
        treasuryWallet = address(0xf01a253837A4A7d421CaDEDd3940A7ac16392748); // set as dev wallet
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            bool isAnti = (launchedAtTime + 60) > block.timestamp;
            if(isAnti){
                _storeFees = _fees;
                if((launchedAtBlock + 10) >= block.number){
                    // 4 block taxes
