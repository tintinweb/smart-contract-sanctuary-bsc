...
contract BlockChatUpgradeable3 is IBlockChatUpgradeable3, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function createMessageToList(bytes20[] memory recipientHashList, string calldata content) public override {
        emit MessageCreated(msg.sender, uint48(block.timestamp), recipientHashList, content);
    }
