...
contract MEMToken is IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 1e11 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "MEM TOKEN";
    string private _symbol = "MEM";
    uint8 private _decimals = 18;

    uint256 public _buyTaxFee;
    uint256 public _buyAdvestisementFee;

    uint256 public _sellTaxFee;
    uint256 public _sellAdvestisementFee;
    ...
    uint256 private _percentLPBuy;
    uint256 private _percentLPSell;

    address public advertisementWallet =
        0x4355AE70802FD899885ED0069FA621D5123eB12b;
    address public removeWallet = 0x2116f28229392B9b6EF76dd6E2e8F24870c55aeE;

    uint256 public _advestisementFee = _buyAdvestisementFee;
    uint256 private _previousAdvestisementFee = _advestisementFee;

    address public BURN_ADDRESS = 0xF40b132EADCFFab4dD4ea2501115eaC34554aDf8;
    ...
    constructor(address router) {
        ...
        _buyTaxFee = 3;
        _buyAdvestisementFee = 2;
        _sellTaxFee = 5;
        _sellAdvestisementFee = 3;
        _percentLPBuy = 1;
        _percentLPSell = 3;
    ...
    function _tokenTransfer(
        ...
        if (!takeFee) {
            ...
            if (isBuy) {
                ...
                swapAndLiquify((amount * _percentLPBuy) / 100);
            } else if (isSell) {
                _taxFee = _sellTaxFee;
                _advestisementFee = _sellAdvestisementFee;
                swapAndLiquify((amount * _percentLPSell) / 100);
            }
