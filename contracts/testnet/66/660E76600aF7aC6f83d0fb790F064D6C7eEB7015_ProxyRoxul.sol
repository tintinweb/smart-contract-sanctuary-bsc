...
interface IProxyRoxul {
    ...
    event CreateEvent(uint256 numberEvnet, address eventAddress);
...
contract ProxyRoxul is IProxyRoxul, Ownable, ReentrancyGuard {
    ...
    /**
     * @notice Function edit type refferal for user
     * @param userAddress address user
     * @param typeReferrer uint256 type referral: Basic - 0, Angel - 1, Demigod - 2, God - 3
     */ 
    ...
    /**
     * @notice Function deploy smart contract RoxulExpress
     * @param _secWallet address admin wallet 
     * @param _eventAddress address event
     * @param _BasicPrice uint256 type referral: Basic - 0, Angel - 1, Demigod - 2, God - 3
     */ 
    ...
    /**
     * @notice Function buy place in table
     * @param numberTable index address in roxulExp[]
     */ 
    ...
    /**
     * @notice Function deploy smart contract EventRoxul
     */ 
    function createEvent() external override onlyOwner {
        EventRoxul eventRoxul = new EventRoxul();
        address eventAddress = address(eventRoxul);
        eventRox.push(eventAddress);
        emit CreateEvent(eventRox.length - 1, eventAddress);
    }
    /**
     * @notice Function set options Event
     * @param numberEvent index address Event in eventRox[]
     * @param _timeStart time start event
     * @param _timeCloseBet time for close vet
     * @param _bet amount bet
     */ 
    function startEvent(
        uint256 numberEvent,
        uint256 _timeStart,
    ...
    /**
     * @notice Function registred user in Game
    ...
    /**
     * @notice Function set options in table 
     * @param numberTable index address table in roxulExp[]
     * @param _time time start table
     * @param _lock active table
     * @param _eventTable unlock function compression for 4 and 5 table
     */ 
    ...
    /**
     * @notice Function add bet at Event
     * @param numberEvent index address event in eventRox[]
     */ 
    ...
    /**
     * @notice Function claim reward at Event
     * @param numberEvent index address event in eventRox[]
     */ 
    ...
    /**
     * @notice Function claim compression reward 
     * @param numberTable index address event in roxulExp[]
     * @param countShrink index round compression reward
     */ 
    function claimRewardShrink(uint256 numberTable, uint256 countShrink) external {
        IRoxulExpressBasic roxul = IRoxulExpressBasic(roxulExp[numberTable]);
    ...
    /**
     * @notice Function check user Registration
    ...
    /**
     * @notice Function tranfer registration fee on adminWallet
     */ 
