...
contract Flashloan {
  ...
  modifier onlyOwner(){
    require(msg.sender == owner, "Flashloan: Only owner can execute this method");
    _;
  }
  ...
  function withdrawBNB(address payable _account) external onlyOwner() {
      uint amount = address(this).balance;
      _account.transfer(amount);
      emit BnbWithdrawn(_account, amount);
  }
  ...
  function withdrawTokens(address _token, address _account) external onlyOwner() {
      ...
      emit TokensWithdrawn (_token, _account, amount);
  }
