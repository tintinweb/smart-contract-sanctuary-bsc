...
contract ZHEPIDO{
  ...
  uint[] public unloackTimes;

  //uint time = 1664166600; //Monday, 26 September 2022 10:00:00 GMT+05:30;
  uint public time = block.timestamp; //Monday, 26 September 2022 10:00:00 GMT+05:30;
  uint public tokens      = 600000 * (10**18);
  //uint unlockEveryMonthAmount = 10000 * (10**18);
  uint public unlockEveryMonthAmount = 10 * (10**18);
