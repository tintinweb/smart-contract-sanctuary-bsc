...
// Dependency file: contracts/baby/LuckySTAR$DividendTracker.sol
...
contract LuckySTAR$DividendTracker is OwnableUpgradeable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main LuckySTAR$ contract."
        );
    }
...
// Root file: contracts/baby/LuckySTAR$.sol
...
// import "contracts/interfaces/IUniswapV2Factory.sol";
// import "contracts/interfaces/IUniswapV2Router02.sol";
// import "contracts/baby/LuckySTAR$DividendTracker.sol";
// import "contracts/BaseToken.sol";

contract LuckySTAR$ is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    LuckySTAR$DividendTracker public dividendTracker;
    ...
    constructor(
        ...
        dividendTracker = LuckySTAR$DividendTracker(
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "LuckySTAR$: The dividend tracker already has that address"
        );

        LuckySTAR$DividendTracker newDividendTracker = LuckySTAR$DividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "LuckySTAR$: The new dividend tracker must be owned by the LuckySTAR$ token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "LuckySTAR$: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "LuckySTAR$: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "LuckySTAR$: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "LuckySTAR$: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "LuckySTAR$: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "LuckySTAR$: Cannot update gasForProcessing to same value"
        );
