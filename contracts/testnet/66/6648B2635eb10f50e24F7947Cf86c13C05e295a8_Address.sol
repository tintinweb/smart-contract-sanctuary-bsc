...
contract NematToken is Context, IERC20, Ownable, LockToken 
{
    ...
    string private _name = "NematToken";
    string private _symbol = "Nemat";
    ...
    address payable public marketingWallet =  payable(0xceFAed6D2930c5A1586B0e7B45f98F95dF1d05A7);
