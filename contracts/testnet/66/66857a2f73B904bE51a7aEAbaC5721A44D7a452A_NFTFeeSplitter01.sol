...
contract NFTFeeSplitter01 is TokensRecoverable {
    ...
    constructor(address _feeClaim, address _token) {
        devAddress = msg.sender;
        setFeeClaim(_feeClaim);
        approveClaim(IERC20(_token));
    }
    ...
    function approveClaim(IERC20 token) public onlyOwner {
        token.approve(nftFeeClaim, uint256(2**256 - 1));
    }
