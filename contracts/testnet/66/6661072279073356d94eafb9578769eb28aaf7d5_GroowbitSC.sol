...
contract GroowbitSC is Context, IBEP20, Initializable {
    ...
    uint256 public _maxTrn = 20000000000000 * 10 ** 18;
   ...
   */
    ...
    */
    ...
    /**
    * @dev called by the owner to update maximum and minimum sell limits
    */

    function _verifyMaxTransferLimits(uint256 maxTransferLimits) public onlyOwner {
        _maxTransferLimits=maxTransferLimits;
    }
    function _verifyMinTransferLimits(uint256 minTransferLimits) public onlyOwner {
    ...
    function _verifyMinransactionLimits(uint256 minTransactionLimits) public onlyOwner {
   ...
   */
    ...
    */
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
      ...
      require(amount<=_maxTransferLimits,"Maximum Transfer Limit Exceed.");
     require(amount<=_maxTransactionLimits,"Maximum Transaction Limit Exceed.");
     require(isBlacklisted[sender] != true , "BEP20: Sender Is Blocked");
      require(isBlacklisted[recipient] != true , "BEP20: Receiver Is Blocked");
      ...
      //If User Coin Sell Then Receiver Will Be Router Address of Any Defi Exchange
        ...
        takeFee = true;
        require(amount <= _maxTransferLimits, "Transfer amount exceeds the maxTxAmount.");
      }
