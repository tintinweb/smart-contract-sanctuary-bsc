...
contract CRSSCompensator is Ownable, ReentrancyGuard {
    ...
    uint256 public compensationLengthInBlocks;
    uint256 public vestDuration = 5 * (6 * 6 * 24 * 3044); //5months
    UserCompensation[] public orderedCompensations;
    uint256 public totalVesting;
    uint256 public totalWithdrawn;
    mapping(address => UserCompensation) public userCompensation;
    mapping(address => VestingObject[]) public userVestingInstances;

    constructor(address _crssToken, uint256 _compensationLength)
        Ownable()
        ReentrancyGuard()
    {
