...
contract Picuki is IERC20, Ownable {
    ...
    string _name = "Picuki";
    string _symbol = "Picuki";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);   // 1,000,000 SUPPLY
    ...
    function setFeeAddress(address _marketingAddressFee) public onlyOwner{
