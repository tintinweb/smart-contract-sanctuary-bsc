...
contract LunaInu is ERC20, Ownable {                                                                                          
    ...
    uint256 public maxTx = 50 * TOTAL_SUPPLY / 1000 * (DECIMALS);               // 0.5%  of total supply
    uint256 private swapTokensAtAmount = 5 * TOTAL_SUPPLY / 1e4 * (DECIMALS);   // 0.05% of total supply                                             /////////
    uint256 public maxWallet = 50 * TOTAL_SUPPLY / 1000 * (DECIMALS);          // 2.0%  of total supply
    uint256 private rewardsFee;
    uint256 private liquidityFee;  
    uint256 private marketingFee; 
    uint256 private TreasuryFee; 
    uint256 private devFee; 
    uint256 private sellFeeIncrease;
    ...
    bool private intensify = false;
    bool private shouldBurnFee = false;
    uint256 private intensifyDuration;
    uint256 private intensifyStart;
    ...
    uint256 private gasForProcessing = 4e5;
