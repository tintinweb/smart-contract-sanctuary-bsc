...
contract Meltable {
    ...
    modifier onlyMelter() {
        require (_melters[msg.sender] == false, "can't perform melt");
        _;
    }
...
contract Token_PreSale is Ownable {
    ...
    uint256 public _openBlockFirst;
    ...
    constructor(address _tokenSale) public {
		...
		_tokenPrice = 4 * 10 ** 10;
        // _meltStatus = false;
		_endSaleBlock = 19401489;
        _openBlockFirst = block.timestamp.add(20*86400);
		_openBlockArr[0] = _openBlockFirst.add(30 *86400);
		_openBlockArr[1] = _openBlockFirst.add(60*86400);
		_openBlockArr[2] = _openBlockFirst.add(90*86400);
		_openBlockArr[3] = _openBlockFirst.add(120*86400);
	}
