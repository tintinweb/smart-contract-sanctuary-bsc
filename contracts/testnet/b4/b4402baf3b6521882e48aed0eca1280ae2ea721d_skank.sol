...
/**
 * SKANK TOKEN - for all crypto Rudeboys and Rudegirls Oi!
*/
...
library Address {
     ...
     * The Developer of this contract is a 3rd party and not directly involved with Skank Token.
     * _Available since v3.4._
     */
...
contract skank is IBEP20, Ownable {
    ...
    string private constant _name = "Skank Token";
    string private constant _symbol = "SKANK";
   ...
   function setdevAddress(address payable devAddress) public onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the ETH -> SKANK swap when swap+liquify is triggered
