...
contract DECENTRACOIN{
  ...
  address public buyTokenAddr = 0x429cf92D06De965985558f5679eC8322C3ba6A51; // TESTNET
 ...
 function buyToken(uint busdAmount) external {
        require( busdAmount >= MIN_DEPOSIT_BUSD, "Minimum limit is 1");
