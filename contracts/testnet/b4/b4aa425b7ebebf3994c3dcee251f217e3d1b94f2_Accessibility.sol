...
/**
*
* BNB CRYPTOCURRENCY DISTRIBUTION PROJECT
* Web              - 
* Twitter          - 
* Telegram_channel - 
* EN  Telegram_chat: 
...
* Email:             
* 
*  - GAIN 3,33% PER 24 HOURS 
*  - Life-long payments
*  - The revolutionary reliability
*  - Minimal contribution 0.01 
...
contract Revolution is Accessibility, PaymentSystem {
  ...
  uint public constant minInvesment = 10 finney; // 0.01 bnb
    uint public constant maxBalance = 333e5 ether; // 33,300,000 bnb
  ...
  function getMyDividends() public notOnPause atPaymode(Paymode.Pull) balanceChanged {
    ...
    uint256 daysAfter = now.sub(investor.paymentTime).div(1 hours);
  ...
  function payout() public notOnPause onlyAdmin(AccessRank.Payout) atPaymode(Paymode.Push) balanceChanged {
    ...
    if (m_paysys.latestKeyIndex == m_investors.iterStart()) {
      require(now>m_paysys.latestTime+1 hours, "the latest payment was earlier than 1 hours");
