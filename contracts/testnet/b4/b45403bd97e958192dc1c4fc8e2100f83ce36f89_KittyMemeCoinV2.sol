...
abstract contract Manageable is Context {
    ...
    function transferManagement(address newManager) external virtual onlyManager {
        require(newManager != address(0), "not zero address");
...
abstract contract Ownable is Context {
    ...
    function lock() public virtual onlyOwner {
        //remove token previous owner == owner so only unlock can regain ownership
...
abstract contract Tokenomics is Manageable {
    ...
    string internal constant NAME = "Kitty Meme Coin";
    string internal constant SYMBOL = "KITTY";
    ...
    uint256 internal constant TOTAL_SUPPLY = 2000000000000 * ZEROES;
     ...
     */
    uint256 public  maxTransactionAmount = TOTAL_SUPPLY / 1500; // 15% of the total supply
    ...
    address internal charityAddress = 0x2D6BCb31e68115c391288cE43EbC978315784E62;
    address internal marketingAddress = 0x614595769CCB96Dd545cb6083D51D3aEbc7EEeA7;
    address internal devAddress = address(this);
    ...
    enum FeeType { Antiwhale, Burn, Liquidity, Rfi, External, ExternalToETH, DevFee }
    struct Fee {
        FeeType name;
        uint256 value;
        address recipient;
    ...
    function setCharityAddress(address _charityAddress) public onlyManager{
        require(_charityAddress != address(0), "Not zero address");
        charityAddress = _charityAddress;
    }
    function setMarketAddress(address _marketingAddress) public onlyManager{
        require(_marketingAddress != address(0), "Not zero address");
        marketingAddress = _marketingAddress;
    }
    function setBurnAddress(address _burnAddress) public onlyManager{
        require(_burnAddress != address(0), "Not zero address");
        burnAddress = _burnAddress;
    }

    function setMaxLimit(uint256 _maxlimit) public onlyManager {
        // Base Denom is 100 ;as  100 = 1%, 1000 = 10% 
        maxTransactionAmount = (TOTAL_SUPPLY / _maxlimit);
    }
    ...
    function RemoveFees() public onlyManager {
        sumOfFees = 0;
    }
    function RestoreFees() public onlyManager {
        _addFees();
    }
    function _addFees() private {
         ...
         */ 
        _addFee(FeeType.DevFee, 10, devAddress);
...
abstract contract KittyMemeCoin is BaseRfiToken, Liquifier, Antiwhale {
...
contract KittyMemeCoinV2 is KittyMemeCoin{

    constructor() KittyMemeCoin(Env.Testnet){
