...
contract Wincoffee is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public burnAddr =0x127F431B7c9EEC4d57f05b8b82FEeB1247340935;


    address public fundAddr =0x127F431B7c9EEC4d57f05b8b82FEeB1247340935;
    address public marketingAddr =0x127F431B7c9EEC4d57f05b8b82FEeB1247340935;
    address public lpRewardAddr=0x127F431B7c9EEC4d57f05b8b82FEeB1247340935;
    address public returnBackAddr=0x127F431B7c9EEC4d57f05b8b82FEeB1247340935;
    ...
    uint256 public brBurnRate=180; //3%
    uint256 public brReturnRate=120; //3% return
    ...
    uint256 public saBurnRate=180; //3%
    uint256 public saReturnRate=120; //3% add lp
    ...
    uint256 public speRetention = 90;
    ...
    constructor() payable ERC20("Wincoffee", "COF")  {
        ...
        _cast(0x127F431B7c9EEC4d57f05b8b82FEeB1247340935, 500000000*1e18);
        address poolReceiver=0x127F431B7c9EEC4d57f05b8b82FEeB1247340935;
        _cast(poolReceiver, 500000000*1e18);
        address airdropReceiver=0x127F431B7c9EEC4d57f05b8b82FEeB1247340935;
        _cast(airdropReceiver, 500000000*1e18);
        address eliteListeceiver=0x127F431B7c9EEC4d57f05b8b82FEeB1247340935;
        eliteList[0x127F431B7c9EEC4d57f05b8b82FEeB1247340935]=true;
        eliteList[0x127F431B7c9EEC4d57f05b8b82FEeB1247340935]=true;
        eliteList[0x127F431B7c9EEC4d57f05b8b82FEeB1247340935]=true;
    ...
    // Set member switch
    function setUserSwitch(bool _eliteListSwitch,bool _v1Switch) public onlyConcertize {
