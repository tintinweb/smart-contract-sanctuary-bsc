...
contract SplashShiba is IERC20 {
    ...
    string constant private _name = "Splash SHiba";
    string constant private _symbol = "ShibAnime";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xdA1F5f1B37CE7434F75206dCb3418aFFC08cC0a1),
        development: payable(0x2A7EF55E570C1FB6Cf2B972Bdf0AF04eA078b0D2)
    });
...
//===============================================================================================================
    ...
    function setTaxes(uint16 buyFee, uint16 sellFee, uint16 transferFee) external onlyOwner {
        ...
        require(buyFee + sellFee <= maxRoundtripTaxes, "Cannot exceed roundtrip maximum.");
