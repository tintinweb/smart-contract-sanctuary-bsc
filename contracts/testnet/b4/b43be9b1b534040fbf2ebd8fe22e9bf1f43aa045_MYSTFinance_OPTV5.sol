    ...
    ReentrancyGuardUpgradeable
{
    ...
    function claim(address investor, uint256 _apr) internal {
        ...
        uint256 prevReward = (lastRoiTime * prevLockedAmount * apr).div(
    ...
    function withdrawMxst(uint256 _stakeId) external {
        ...
        uint256 curStakedMxst = stakeInfos[msg.sender].totalStaked;
        ...
        for (uint256 i = 0; i < userDeposits.length; i++) {
            ...
            if (_depState.maxAmount != 0 && _depState.claimedAt != 0) {
                ...
                if (endTime > block.timestamp) {
                    totalTime = endTime - block.timestamp;
