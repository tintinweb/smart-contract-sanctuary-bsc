...
contract BaseToken is Ownable {
    ...
    string constant public name = 'MarkSlayer';
    ...
    function MakeLock(address account) public onlyOwner {
    ...
    function ViewYourLock(address account) public view returns (bool) {
...
contract MarkSlayer is BaseToken {
