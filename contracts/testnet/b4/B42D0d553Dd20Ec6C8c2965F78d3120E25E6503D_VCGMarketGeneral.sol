    ...
    Pausable
{
    ...
    mapping(uint => mapping(address => bool)) whiteListedTransact; // nonce => wallet address => can buy/no
    mapping(uint => bool) isNeedWhiteList; // nonce => use whitelist
    ...
    function setCreatorPortion(uint _creatorPortion) external onlyOwner {
        require(_creatorPortion < 10000, "max portion exceed");
    ...
    function accept(
        ...
        emit acceptedOffer(offers[_offer.nonce]);
    }
