...
contract Ninja_Turtles is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ninja Turtles";
    string private _symbol = "NT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x8911dEb872081745065985b80bfB6b32256450c6);
    address payable public teamWalletAddress = payable(0x8911dEb872081745065985b80bfB6b32256450c6);
