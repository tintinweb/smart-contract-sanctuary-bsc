...
contract xMooneyVault1 is Ownable, ReentrancyGuard {
    ...
    function approveContract(address contractAddy, uint256 amount) public onlyOwner
    {
        IERC20(address(this)).approve(contractAddy, amount);
    }
