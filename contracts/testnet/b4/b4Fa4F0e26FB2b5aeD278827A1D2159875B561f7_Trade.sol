    ...
    function txFees(
        ...
        for (uint8 i = 0; i < 4; i++) {
            if (
                ...
                buyerFee = buyerFees[category] - (buyerFees[category] * paymentAssets[erc20Address][category][i].buyerFeePermileOffer) / 1000;
            }
            if (
                sellerBalance >=
                paymentAssets[erc20Address][category][i].minimumAmount &&
                ...
                sellerFee = sellerFees[category] - (sellerFees[category] * paymentAssets[erc20Address][category][i].sellerFeePermileOffer) / 1000;
            }
        }
