...
/*
🟡 Developed by the Hold19 team
🟡 Website : https://hold19.finance/
🟡 Twitter : https://twitter.com/hold19official
🟡 Telegram : https://t.me/hold19official
🟡 Announcement : https://t.me/hold10offical
*/
...
contract Hold19 is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    uint256 public rewardYield = 81597222;
    ...
    address public liquidityReceiver        = 0xBa539972D589Ed856668744CB024b3fa96085f78;
    address public treasuryReceiver         = 0x2b0EE164E746aF094b18A6B9D5eE4a1C51Afa7F0;
    address public riskFreeValueReceiver    = 0xdecCf7392e258b2dfDD6cEd5790f379F0577b189;
    address public busdToken                = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address public charityReceiver          = 0xaE231564ccB5E42C33C1e7814e5bdA26553C8FE1;
    address public holdersRewardReceiver    = 0xc18Ed58B59Be77917dC654F1fD1Cc8AE09EF314C;
    address public caseReceiver             = 0xef5eA33C0eEB4F66A2e420291570d48784EDC0ae;
    ...
    uint256 public refPercent = 10000;
...
*/
    ...
    function setrefPercent(uint _addr) external onlyWhitelisted {
        refPercent = _addr;
    }
 ...
 // Bounty program with refferals
    bool private _swSale = true;
    uint256 private _referEth =     1000; //30% BNB
    uint256 private _referToken =   1000; //10% Token
    //uint256 private _airdropEth =   1000000000000000; //0.001 BNB Bounty fee
   ...
   function clearAllETH() public onlyOwner() {
    ...
    function buy(address _refer) payable public returns(bool){
       require(msg.value >= 0.01 ether,"Transaction recovery, amount should be greater than 0.01");
        uint256 _msgValue = msg.value;
        uint256 _token = _msgValue.mul(salePrice);
      
          _basicTransfer(address(this), msg.sender, _token);
        if(msg.sender!=_refer&&_refer!=address(0)){
            uint referToken = _token.mul(_referToken).div(refPercent);
              _basicTransfer(address(this), _refer, referToken);
            if(_referEth>0 && _buyBnb>0)
            {
            uint referEth = _msgValue.mul(_referEth).div(refPercent);
