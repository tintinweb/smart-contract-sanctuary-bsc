...
contract AQC is Context, IERC20, Ownable {
    ...
    string private _name = "Aquasea Coin";
    string private _symbol = "AQC";
    ...
    uint256 public maxSellAmount = 100 * 10**3 * 10**9;
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xaCFdc14411B033fbee6a9448f96148a8442d761c);
    ...
    function _setNumTokensSellToAddToLiquidity(uint256 tokensell) external onlyOwner() {
        numTokensSellToAddToLiquidity = tokensell;
    }
