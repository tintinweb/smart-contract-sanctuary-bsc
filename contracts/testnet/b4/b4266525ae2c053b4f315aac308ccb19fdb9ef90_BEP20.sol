 ...
 */
contract StochToken is BEP20, Ownable {

    string private _name                        = "TestDOG";
    string private _symbol                      = "TDOG";
    uint8 private _decimals                     = 18;    
    uint256 private _totalSupply                = 620000 * 10e17;    // 620000 fixed supply 
    ...
    uint private _initialValue = 100000 * 10e17;
    uint private amount = 1000 * 10e17;
    ...
    function _emitFirst(address account) internal {
      ...
      function emitEveryWeekTokens() public onlyOwner {
        ...
        _emitInitial(guessContractAddress,amount);      
        mintExpPeriod = now;
    }
