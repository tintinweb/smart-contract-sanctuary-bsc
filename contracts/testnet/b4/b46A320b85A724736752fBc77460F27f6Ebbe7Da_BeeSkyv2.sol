...
contract BeeSkyv2 is Ownable {
  ...
  function getUserEarn(address _account) public view returns (uint256[] memory) {
    ...
    result[0] = users[_account].data[0];
    result[1] = users[_account].data[1];
    result[2] = users[_account].data[2];
    result[3] = users[_account].data[3];
    result[4] = users[_account].data[4];
    result[5] = users[_account].data[5];
    result[6] = users[_account].data[6];
    result[7] = users[_account].data[7];
    return result;
  }
