...
contract CIRAToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CIRATokenDividendTracker public dividendTracker;
    ...
    constructor() ERC20("CryptoIRA", "CIRA") {
        dividendTracker = new CIRATokenDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "CIRA: The dividend tracker already has that address"
        );

        CIRATokenDividendTracker newDividendTracker = CIRATokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "CIRA: The new dividend tracker must be owned by the CIRA token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "CIRA: The router already has that address"
        );
 ...
 //   }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "CIRA: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "CIRA: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "CIRA: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "CIRA: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "CIRA: Cannot update gasForProcessing to same value"
        );
...
contract CIRATokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("CIRA_Dividend_Tracker", "CIRA_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "CIRA_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "CIRA_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CIRA contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "CIRA_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "CIRA_Dividend_Tracker: Cannot update claimWait to same value"
        );
