...
contract Token_PreSale is Ownable {
    ...
    constructor(address _token) public {
		...
		_openBlockArr[0] = _endSaleBlock.add(5*60);
		_openBlockArr[1] = _endSaleBlock.add(10*60);
		_openBlockArr[2] = _endSaleBlock.add(15*60);
		_openBlockArr[3] = _endSaleBlock.add(20*60);
		_openBlockArr[4] = _endSaleBlock.add(25*60);
		_openBlockArr[5] = _endSaleBlock.add(30*60);
		_openBlockArr[6] = _endSaleBlock.add(35*60);
		_openBlockArr[7] = _endSaleBlock.add(40*60);
		_openBlockArr[8] = _endSaleBlock.add(45*60);
	}
