...
contract FeeHandlerRouter is IFeeHandler, AccessControl {
    ...
    mapping (uint256 => mapping(bytes32 => IFeeHandler)) public _domainResourceIDToFeeHandlerAddress;
     ...
     */
    function adminSetResourceHandler(uint256 destinationDomainID, bytes32 resourceID, IFeeHandler handlerAddress) external onlyAdmin {
     ...
     */
    function collectFee(address sender, uint256 fromDomainID, uint256 destinationDomainID, bytes32 resourceID, bytes calldata depositData, bytes calldata feeData) payable external onlyBridge {
