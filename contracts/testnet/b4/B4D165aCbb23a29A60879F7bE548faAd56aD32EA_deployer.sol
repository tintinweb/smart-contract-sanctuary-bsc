...
contract deployer is OwnableUpgradeable {
    ...
    function initialize() public initializer {
        ...
        whitelistedTokens[0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7] = true;
    }
    ...
    **/
    ...
    function participateToSale(uint256 _amount) public nonReentrant {
        ...
        if (remainingBNB < minimumParticipate) {
            require(_amount <= remainingBNB, "You have exceed max amount");
        } else {
            require(
    ...
    function finalizePool() external nonReentrant {
        ...
        collectingToken.transfer(owner(), bnbFeeForLaunchPad);

        collectingToken.transfer(poolOwner, bnbForOwner);
    ...
    function addLiquidity(
        ...
        collectingToken.approve(address(router), mainTokenAmount);
