...
contract MoveMoveToken is BEP20Detailed, BEP20 {
  ...
  constructor() BEP20Detailed("MoveMove", "MMO", 18) {
    uint256 totalTokens = 4000000000 * 10**uint256(decimals());
    _mint(msg.sender, totalTokens);
    sellTax = 8;
    buyTax = 0;
    transferTax = 0;
    tradeCooldown = 15;
    marketingPool = 0x7bE19E3d8FE1874FcAA135B141E4355BEdDb75a3;
  }
