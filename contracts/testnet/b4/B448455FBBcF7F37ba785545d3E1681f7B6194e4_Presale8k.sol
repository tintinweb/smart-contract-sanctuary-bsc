...
contract Presale8k is AccessControlEnumerable {

   using SafeMath for uint256;
   IERC20 public tokenERC20;
   IPancakeSwap public pancakeswap;
   address internal constant PANCAKESWAP_ROUTER_ADDRESS = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;

   bytes32 private constant ADMIN_ROLE = keccak256("ADMIN_ROLE");
   bytes32 public constant PROJECT_ROLE = keccak256("PROJECT_ROLE");

   address ADMIN_ADDRESS = 0x543f9A731BE5d7C88741CB8Ac7D3d4577F68D51A;

   address public addressProject;
   ...
   uint256 public isWhitelist = 0; // 0-1
   ...
   uint256 private totalTokenForPresale;  
   uint256 private maxBalanceAmount;
   uint256 private totalTokenUserBuy;
   uint256 private totalAmountUserBuy;
   ...
   //mapping(address => UserBuyPresale) public userBuyPresales;
   ...
   constructor(
      ...
      uint256 _endTime,
      uint256 _lockLPTime,
      uint256 _percentFirstRelease,
      uint256 _vestingEachCycle,
      uint256 _percentEachCycle,
      uint256[] memory _saleInfo,
      address[] memory _addressInfo,
      string[] memory _projectInfo
   ) {
      pancakeswap = IPancakeSwap(PANCAKESWAP_ROUTER_ADDRESS);
      ...
      // totalTokenForPresale = tokenERC20.balanceOf(address(this));
      // maxBalanceAmount = totalTokenForPresale.div(presaleRate);
      
      addressOwnerProject = _addressInfo[0];
      addressProject = _addressInfo[1];
      router = _addressInfo[2];
      ...
      percentFirstRelease = _percentFirstRelease;
      vestingEachCycle = _vestingEachCycle;
      percentEachCycle = _percentEachCycle;
   ...
   function finalizePresale(address token,
      uint amountTokenDesired,
      uint amountTokenMin,
      uint amountETHMin,
      address to,
      ...
      IERC20(tokenERC20).approve(PANCAKESWAP_ROUTER_ADDRESS, amountTokenDesired);

      pancakeswap.addLiquidityETH{ value: msg.value }(
         token,
         amountTokenDesired,
         amountTokenMin,
         amountETHMin,
