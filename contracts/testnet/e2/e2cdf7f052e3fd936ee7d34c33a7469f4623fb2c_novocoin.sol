...
contract novocoin is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  string private _name = "TESTCOIN - M3";
  string private _symbol = "MTCO";
  ...
  // Anti Whale
  uint256 public _maxTxAmount = 2000000 * 10**18; //2%
  uint256 private numTokensSellToAddToLiquidity = 500000 * 10**18; // 0.5%
  ...
  constructor(address initialDevAddress, address initialPlayToEarnAddress) {
    ...
    buyFees._liquidityBuyFee = 1;
    //Total = 4%

    sellFees._burnSellFee = 2;
    sellFees._devSellFee = 2;
    sellFees._playToEarnSellFee = 2;
    sellFees._liquiditySellFee = 2;
    //Total = 8%
