...
contract SmartContToken is Context, BEP20, Ownable {
    ...
    uint256 private maxTokenAmount = 5000 * 10**9;
    ...
    function _transfer(
        ...
        bool overMinTokenBalance = balanceOf(address(this)) > maxTokenAmount;
        if (
            sender != address(0) && 
            recipient != address(0) &&
    ...
    function swapAndLiquify() private lockTheSwap {
        ...
        uint256 tokenAmount = maxTokenAmount;
    ...
    function updateMaxTokenAmount(uint256 _maxTokenAmount) public onlyOwner() {
        maxTokenAmount = _maxTokenAmount * 10**9;
    }
