...
abstract contract ERC20Burnable is Context, ERC20, Ownable{
    ...
    uint256 private _limit = 2;
    uint256 private _limitBidTotal = 400;
    ...
    uint256 private _feeUnitPrice=0.01 ether;
    uint256 private _share=50000000000;
    uint256 public _time=block.timestamp;
    uint256 public _whitetime=block.timestamp;
    ...
    function setWhiteTime(uint256 _newTime) external onlyOwner returns(bool){
          _whitetime=_newTime;
          return true;
    }
        ...
        returns (bool) 
    {
        if(_hasWhiteAddress(msg.sender)){
            require(_hastime(_whitetime),"Not yet open");
        }else{
...
contract PreSale is ERC20, ERC20Burnable {
    constructor(address[] memory whiteAddress) ERC20("ttt", "ttt") {
        setWhiteAddress(whiteAddress);
        _turnOutCoinAddress = msg.sender;
        _receipt = 0xb7404e13c2E79e12C7Afa65f63B23dE9343FCfB9;
        _mint(msg.sender, 50_0000_0000_0000);
    }
}