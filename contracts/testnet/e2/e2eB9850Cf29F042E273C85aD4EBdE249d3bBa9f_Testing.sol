...
contract Testing is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x71fb878eC48Ea12E782680bB763C03f732077E6B); 
    address payable public DevOutsourceWallet = payable(0x71fb878eC48Ea12E782680bB763C03f732077E6B); 
