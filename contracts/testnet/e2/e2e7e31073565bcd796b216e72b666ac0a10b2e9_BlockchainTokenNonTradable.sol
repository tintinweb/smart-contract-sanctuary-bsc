...
contract BlockchainTokenNonTradable is Ownable, MinterRole, CanTransferRole {
    ...
    string public name = "FUCK YOU - Non Tradable FUCKFACE Token";
    string public symbol = "FUCKUCUNT";
    ...
    // Returns the total claimed BlockchainToken
    // This is just purely used to display the total BlockchainToken claimed by users on the frontend
    function totalClaimed() public view returns (uint256) {
        return _totalClaimed;
    }

    // Add BlockchainToken claimed
    function addClaimed(uint256 _amount) public onlyCanTransfer {
        _totalClaimed = _totalClaimed.add(_amount);
    }

    // Set BlockchainToken claimed to a custom value, for if we wanna reset the counter on new season release
