...
contract EverStaking is Ownable {
    ...
    uint256 public _14DaysApr = 3718;
    uint256 public _30DaysApr = 6424;
    uint256 public _60daysApr = 10311;
    uint256 public _unlimitedDaysApr = 770;
    ...
    function newStake(uint256 amount, uint256 time) public {
        uint256 maxBusdAmountToStake = priceCalculator.getLatestPrice(
            address(TOKEN),
