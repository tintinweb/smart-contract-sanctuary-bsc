...
contract HashGameTokenSwap is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
   ...
   *play hash game
    */
   function playgame(string memory internalTx_, address receiver_, uint256 amount_, bytes memory userSignature_) external nonReentrant validTx(internalTx_) swapDataNotExisted(internalTx_) returns(uint256)
   {
