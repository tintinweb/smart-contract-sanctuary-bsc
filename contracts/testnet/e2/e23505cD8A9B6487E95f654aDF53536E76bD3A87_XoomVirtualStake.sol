...
contract XoomVirtualStake {
    ...
    constructor(address _metersAddress, address _platformToken, uint dappId)
    {
    ...
    function setDappId(uint value) external onlyOwner noReentrancyForOwner validWallet
    {
        DAPP_ID = value;
        emit DappIdChange(value);
    }
