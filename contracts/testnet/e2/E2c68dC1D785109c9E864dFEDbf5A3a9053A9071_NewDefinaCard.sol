...
contract NewDefinaCard is ERC721EnumerableUpgradeable, OwnableUpgradeable, NewDefinaCardEventsAndErrors {
    ...
    function toMint(uint256 mintStartTokenId, uint256 amount_, bool forWhitelist_, uint256[] calldata randomness_) external onlyOperator {
    ...
    function toMerge(uint256 tokenIdA, uint256 randomness_) external onlyOperator{
...
interface INewDefinaCard {
    function toMint(uint256 mintStartTokenId_, uint256 amount_, bool forWhitelist_, uint256[] calldata randomness_) external;
...
//    uint32 numWords = 1;
    ...
    function fulfillRandomWords(uint256 _requestId, uint256[] memory _randomWords) internal override {
        ...
        if(isMerge[_requestId]){
            ...
            INewDefinaCard(operator).toMint(mintInfo.mintStartTokenId, _randomWords.length, mintInfo.forWhitelist, _randomWords);
        }
