...
contract GPlantsDesign is AccessControlUpgradeable, UUPSUpgradeable, IGDesign {
  ...
  uint256 private constant SKIN_RARE_COUNT        = 9; // Rudelaris
  uint256 private constant SKIN_SUPER_RARE_COUNT  = 9; // Sativas
  ...
  function initialize() public initializer {
    ...
    // common - sativas
    rarityStats[0] = Stats(StatsRange(50, 65), StatsRange(1, 9), 0, 0);

    // rare - indicas
    // harvestDays
    // skin
    rarityStats[1] = Stats(StatsRange(50, 65), StatsRange(10, 19), 0, 0);

    // super rare - rudelaris
    // harvestDays
    // skin
    rarityStats[2] = Stats(StatsRange(30, 3), StatsRange(20, 29), 0, 0);
