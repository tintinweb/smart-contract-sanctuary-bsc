...
contract HoldexLaunchPad is Ownable {
    ...
    */
    ...
    // function setholdexAddress(address _holdexToken) external onlyOwner {
    //     holdexToken = IERC20(_holdexToken);
    // }
    ...
    function poolStatus(uint256 poolId)
        public
        onlyOwner{
            
            poolData2[poolId].isDeleted = true;  
    }
    function statusIsEnabled(uint256 poolId) public view
        returns (bool) {
        return poolData2[poolId].isDeleted == true;
    }
    function statusIsDisabled(uint256 poolId) public view
        returns (bool) {
        return poolData2[poolId].isDeleted == false;
    }
}