...
contract WINB is Context, IBEP20, Ownable {
    ...
    //  tax fee
    uint256 public redistributionFee = 2; // 2% will be distributed among holder as token divideneds
    uint256 public marketingwalletFee = 5; // 5% will go to the market address
