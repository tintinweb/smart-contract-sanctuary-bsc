...
contract ETHFanBurn is IERC20, Ownable {
    ...
    uint256 public maxTxAmount = (_totalSupply * 500) / 10000; // 0.5% of supply
    ...
    constructor() {
        ...
        stakePoolAddress = 0x2550bcA4990892B694f4A9B5432110F0af433CCb;
    ...
    function updateBuyFees(
        ...
        require(buyTotalFees <= 10, "Fess can not be grater than 10");
    }
    ...
    function updateSellFees(
        ...
        require(sellTotalFees <= 10, "Fess can not be grater than 10");
    }
    ...
    function swapBackInBnb() internal swapping {
        ...
        if (tokensToSwapOtherTokens > 0) {
          ...
          uint256 tokensToStaking = swappedTokensAmount.sub(tokensToReward).sub(
                tokensToBurn
            );
            ...
            if (tokensToStaking > 0 && swapForStake>0) {
                // send token to reward
                IERC20(REWARD).transfer(address(stakePoolAddress), tokensToStaking);
            }
        }
    ...
    function setMaxTxAmount(uint256 amount) external onlyOwner {
        require(amount >= 50000, "Limit can not be less than 0.5%");
