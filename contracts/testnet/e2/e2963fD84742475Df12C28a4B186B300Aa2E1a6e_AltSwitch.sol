    ...
    Ownable
{
    ...
    constructor(
        ...
        ] = true; // PCS Testnet router @note enabled
    }
    ...
    function excludeRewardToken(address tokenAddress, bool isExcluded)
        external
        onlyOwner
    {
...
contract AltSwitch is ERC20, Ownable {
    ...
    function registerEnterprise(address account, bool included)
        public
        onlyOwner
    {
     ...
     */
    function updateMinimumRebate(uint16 percentRebate) public onlyOwner {
     ...
     */
    function setEnterpriseRebate(address addr, uint16 percentRebate)
        external
        onlyEnterprise
    {
     ...
     */
    function getPercentRebateByEnterprise(address addr)
        public
        view
        virtual
        returns (uint16)
     ...
     */
    function isEnterpriseWithRebate(address addr)
        public
        view
        virtual
        returns (bool)
    ...
    // @note update migrationSwapContract
    ...
    function _transfer(
        ...
        if (
            ...
            canSwap &&
            !swapping &&
            automatedMarketMakerPairs[to] && // @note !automatedMarketMakerPairs[from]
