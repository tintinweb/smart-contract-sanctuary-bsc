...
contract ParkToken is Context, IParkToken{
  ...
  function addLiquidity(uint256 amountTokenDesired_,uint amountTokenMin_,uint amountETHMin_) public payable inLiquidating override returns(bool){
...
interface IParkToken is  IERC20, IERC20Metadata {
     ...
     *
     */
    function addLiquidity(uint256 amountTokenDesired_,uint amountTokenMin_,uint amountETHMin_)  external payable returns(bool);
