...
contract MstationNFT is Initializable, OwnableUpgradeable {
    ...
    CharacterContract[] characterContracts;
     ...
     * for mint new hero
     */
    function Breed() public payable nonReentrant {}

    function BreedLimited()
        public
        payable
        nonReentrant
    ...
    function _updateReferral() internal {}
    ...
    function _updateSupply(uint256 _totalSupply) internal {
        //create random slot for mint by rarity
        uint16 extraSlot = uint16(_totalSupply.sub(maxSupply));
