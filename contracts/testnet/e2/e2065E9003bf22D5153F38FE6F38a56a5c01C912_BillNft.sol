 ...
 */
contract BillNft is AccessControlEnumerableUpgradeable, ERC721EnumerableUpgradeable {
    ...
    modifier onlyAdmin() {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "BillNft: Only admin role");
        _;
    }

    modifier onlyMinter() {
        require(hasRole(MINTER_ROLE, _msgSender()), "BillNft: Only minter role");
        _;
    }
     ...
     * See {ERC721-tokenURI}.
     */
    function initialize(string memory name, string memory symbol, string memory baseTokenURI, address factory, address owner) public initializer {
    ...
    function lockURI() public onlyAdmin {
        uriUnlocked = false;
    }

    function addMinter(address minter) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()) || hasRole(FACTORY_ROLE, _msgSender()), "BillNft: Only admin or factory role");
