...
contract Oracle is SoftAdministered {
    ...
    function parseAmountToUSD(
        ...
        uint256 tokenDecimalsLeft = whiteListService.getWhiteListTokenInfo(_token).tokenDecimalsLeft;

        /// @dev Parse amount to WEI
        uint256 _parseTo18 = transformAmountTo18Decimal(_amount, tokenDecimalsLeft);
