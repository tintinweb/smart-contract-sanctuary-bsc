...
contract  dnaDapp is Ownable{
    ...
    function withdrawal() public {
      ...
      require(minWithdrawal >= price,"Not meeting the minimum withdrawal amount");
