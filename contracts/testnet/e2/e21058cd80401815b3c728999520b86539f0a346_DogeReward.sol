...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 DOGE = IBEP20(0xbA2aE424d960c26247Dd6c32edC70B295c744C43); // Set To Reward
...
contract DogeReward is IBEP20, Auth {
    using SafeMath for uint256;

    address DOGE = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43; // Rewards
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Doge Reward";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
