...
contract StakingPool is OwnableUpgradeable, ReentrancyGuard 
{
   ...
   // address private beneficiary;
    ...
    function register(uint256 _weiAmount, uint256 _stakingPeriod) public{
    ...
    function applyForStaking( uint256 _weiAmount, uint256 _stakingPeriod, uint256 poolId) external {
       ...
       // PoolInfo storage poolInfo = poolInfos[poolId];
        ...
        emit progressOfStaking(createdPoolId,msg.sender, weiAmount, stakingPeriod);
       ...
       // uint256 unreleased = _releasableAmount(token);
        ...
        if(base > 0){
            ...
            uint256 basecal = totalAmount /base ;
             ...
             stakingInstallment = (basecal * _staking) / 100;

        }
        else{

            stakingInstallment = (totalAmount * _staking)/100;
        }
