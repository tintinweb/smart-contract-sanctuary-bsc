...
contract AOG721 is Ownable, ERC721Enumerable {

    uint256 public LAUNCH_MAX_SUPPLY;    // max launch supply
    uint256 public LAUNCH_SUPPLY;        // current launch supply
    uint256 private index;               // index of tokenIds

    uint256[] private tokenIds;          // list of token ID that wanted to be minted outside of system

    address public controller;
    address public LAUNCHPAD;

    string public baseURI = _baseURI();
    ...
    function ownerOfTokenID(uint256 _tokenId) public view returns (address) {
        address owner_ = _ownerOfTokenID[_tokenId];
        return owner_;
    }
    ...
    function mint (
        ...
        _ownerOfTokenID[_tokenId] = _receiver;
        return _tokenId;
    }
    ...
    function mintBatch (
        ...
        for(uint256 i = 0; i < _tokenIds.length; i++) {
            ...
            _ownerOfTokenID[_tokenIds[i]] = _receiver;
        }
    }
    ...
    function burn (uint256 _tokenId) public virtual {
        ...
        _burn(_tokenId);
        delete _ownerOfTokenID[_tokenId];
    }
