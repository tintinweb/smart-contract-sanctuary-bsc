...
contract Burner {
    ...
    function burn(uint256 amount) external {
        require(msg.sender == owner, "Owner =/= caller.");
        TOKEN.transfer(DEAD, amount);
    }
}

contract EternityProtocol is IERC20 {
    ...
    address payable public marketingWallet = payable(0xFE120d81fBe446dC3398cCDbcC5171Fa973FB6E4);
    ...
    Burner immutable public burner;
    ...
    constructor () payable {
        ...
        burner = new Burner(address(this), _owner);
        ...
        _isExcludedFromFees[address(burner)] = true;
        _liquidityHolders[_owner] = true;
        _liquidityHolders[address(burner)] = true;
    }
...
//===============================================================================================================
    ...
    function sendToBurner(uint256 amountInTokens) external onlyOwner {
        finalizeTransfer(msg.sender, address(burner), amountInTokens * 10**_decimals, false, false, true);
    }

    function burnFromBurner(uint256 amountInTokens) external onlyOwner {
        burner.burn(amountInTokens * 10**_decimals);
    }
}