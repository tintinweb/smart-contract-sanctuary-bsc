    ...
    ERC2981PerTokenRoyalties
{
  ...
  */
    function mint(uint256 _mintAmount) public payable {
        ...
        require(
            ...
            "ERROR: You cant mint that many NFT"
        );
        ...
        require(
            ...
            "ERROR: Not enough NFT left to mint!"
        );

        require(
                msg.value >= cost * _mintAmount,
                "ERROR: Please send more BNB"
        );
  ...
  */
    ...
    */
    function send_to_wallet() public onlyOwner {
    ...
    function runlottery() public onlyOwner {
        if (lotteryActive) {
            ...
            (bool success, ) = payable(_winner).call{value: _balance * (70) / (100)}(
            ""
            );
            (success, ) = payable(dev1).call{value: _balance * (15) / (100)}(
            ""
            );
            (success, ) = payable(dev2).call{value: _balance * (15) / (100)}(
            ""
            );
            require(success);
    ...
    */
    ...
    function setdevwallets(address _dev1, address _dev2) public onlyOwner {
        dev1 = _dev1;
        dev2 = _dev2;
    }
