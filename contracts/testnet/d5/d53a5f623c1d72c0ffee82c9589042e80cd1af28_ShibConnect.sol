...
contract ShibConnect is ERC20, Ownable {
    ...
    constructor() ERC20("ShibConnect", "ShibConnect") {
        ...
        uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //0xD99D1c33F9fC3444f8101754aBC46c52416550D1 testnet
    ...
    function stake(uint256 duration) public {
     ...
     function updateMaxsellAmount(uint256 newNum) public onlyOwner {
        require (newNum >= 100000000, "cannot set max sell below 1%");
    ...
    function updateReferralTreeFees(int256 index, uint256 fee) public onlyOwner {
        require(fee <= 5,"Cannot set referal tree fee over 5%"); 
...
contract ShibConnectDividendTracker is DividendPayingToken, Ownable {
        ...
        )
    {
        ...
        uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//mainnet 0x10ED43C718714eb63d5aA57B78B54704E256024E);
