...
interface IIYAL { 
    ...
    function totalAmounts(uint256) external returns(uint256);
...
contract FeeContract is Ownable {
    ...
    function claimToken() external {
        calcMonth();
        uint256 amount = iyal.feeHistory(currentMonth) * iyal.c_amountHistory(msg.sender) / iyal.totalAmounts(currentMonth);
