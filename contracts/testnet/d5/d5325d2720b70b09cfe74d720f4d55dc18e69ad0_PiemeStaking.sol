...
contract PiemeStaking is OwnableUpgradeable, EIP712Upgradeable {
    ...
    //ori: 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    {
        bool pay = false;
        return _openPosition(to, pieAmount, block.timestamp, pay);
    }
...
contract PiemeRewardVault is PiemeVault, IPiemeRewardVault {
    ...
    uint256 public constant MONTHS12 = 360 days; // 300000
    uint256 public constant DAILYRWD = 4822530864197519; //  daily reward

    constructor(address token_, address owner_) PiemeVault(token_, owner_) {
        // refreshed = block.timestamp; for tests
        refreshed = 1668983756; // Thu Jul 07 2022 11:08:57 GMT+0000
    }
