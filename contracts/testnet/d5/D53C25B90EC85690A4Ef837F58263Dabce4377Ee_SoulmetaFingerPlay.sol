...
contract SoulmetaFingerPlay is DivestorUpgradeable {
    ...
    function setMeta(address serverAddr_, address soulToken_, address fishPondBonus_, address timeBank_, uint maxRoomCount_, bool isOpen_) public onlyOwner {
        serverAddr = serverAddr_;
        soulTokenAddr = ISoulToken(soulToken_);
        aFishPondBonus = fishPondBonus_;
        aTimeBank = timeBank_;
        MAX_ROOM_COUNT = maxRoomCount_;
        isOpen = isOpen_;
    }
