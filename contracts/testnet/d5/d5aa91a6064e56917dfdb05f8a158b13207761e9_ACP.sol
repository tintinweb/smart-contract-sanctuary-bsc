...
contract ACP is Context, IERC20, Ownable {
	...
	function setAddLiquidityUser(address _user, bool _status)public onlyOwner{
		addLiquidityUser[_user] = _status;
	}
	
	function setIsAddLiquidity(bool _status)public onlyOwner{
		isAddLiquidity = _status;
	}
