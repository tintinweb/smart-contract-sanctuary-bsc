    ...
    IExenoFinanceNode
{
        ...
        internal
    {
        ...
        if (params.length > 1) {
            ...
            if (action == ACTION_DEBIT_REWARD) {
                ...
                (bytes32[2] memory id, address[2] memory token, uint256[2] memory amount, uint32 timeout) = abi.decode(args, (bytes32[2], address[2], uint256[2], uint32));
        ...
        internal pure returns(ExenoFinance.Data memory)
    {
        (
            ...
            bytes32 method,
            bytes memory memo
        ) = abi.decode(payload, (bytes32, address, address, bytes32[2], address[2], address[2],  uint256[2], int32[2], bool[2], bytes32, bytes));
...
library ExenoFinance {
    ...
    function emitDebit(Data calldata d)
        external
    {
        emit Debit(d.id, d.platform, d.affiliate, d.network, d.beneficiary, d.token, d.amount, d.timeout, d.explicit, d.method, d.memo);
    }
    ...
    function emitCredit(Data calldata d)
        external
    {
        emit Credit(d.id, d.platform, d.affiliate, d.network, d.beneficiary, d.token, d.amount, d.timeout, d.explicit, d.method, d.memo);
    }
    ...
    function emitSwap(Data calldata d)
        external
    {
        emit Swap(d.id, d.platform, d.affiliate, d.network, d.beneficiary, d.token, d.amount, d.timeout, d.explicit, d.method, d.memo);
    }
    ...
    function emitOption(Data calldata d)
        external
    {
        emit Option(d.id, d.platform, d.affiliate, d.network, d.beneficiary, d.token, d.amount, d.timeout, d.explicit, d.method, d.memo);
    }
    ...
    function emitRevoke(Data calldata d)
        external
    {
        emit Revoke(d.id, d.platform, d.affiliate, d.network, d.beneficiary, d.token, d.amount, d.timeout, d.explicit, d.method, d.memo);
    }
