...
contract FuckUsa is Context, IERC20 {  
    ...
    address payable public Wallet_Marketing = payable(0x22E223708f27cC97bc86D4Cbe775395a214eFac0); 
    address payable public Wallet_Dev = payable(0x22E223708f27cC97bc86D4Cbe775395a214eFac0);
    ...
    string private constant _name = "FuckUsa"; 
    string private constant _symbol = unicode"FUCKUSA"; 
    ...
    constructor () {
        ...
        _owner = 0x22E223708f27cC97bc86D4Cbe775395a214eFac0;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //这里修改正式/测试服务端路由。即博饼的地址
