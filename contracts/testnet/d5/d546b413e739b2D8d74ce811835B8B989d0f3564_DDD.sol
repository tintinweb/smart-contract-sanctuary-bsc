...
contract DDD is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xF195fAD5bEbD779b2029e3772ab3fc02afeeCa6B));
        marketingWalletAddress = payable(address(0xF195fAD5bEbD779b2029e3772ab3fc02afeeCa6B));
