...
import "./interfaces/token/ERC20/ERC20.sol";
import "./interfaces/IEAGLENFT.sol";
import "./interfaces/utils/Strings.sol";
import "./interfaces/access/Ownable.sol";
...
contract EAGLE is ERC20,Ownable {
    ...
    constructor() ERC20("EAGLE", "EAGLE") {
        ...
        EAGLENFTAddress = IEAGLENFT(0x22975841cd951f2Cf67Bbd33BE9876D8597D82f4);
