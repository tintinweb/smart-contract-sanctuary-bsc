...
contract ImplAndTermsH01 is Storage, Ownable, DoTransfer, ERC20Init {
    ...
    function initialize(
        ...
        maxDefaultApprovedReward = 1000000e18;
    ...
    function getRate() public view returns (uint) {
        ...
        if (18 >= power) {
            factor = 10**(18 - power);
            rate = totalStaked * 1e18 * factor / totalSupply;
        } else {
            factor = 10**(power - 18);
            rate = totalStaked * 1e18 / totalSupply / factor;
        }
