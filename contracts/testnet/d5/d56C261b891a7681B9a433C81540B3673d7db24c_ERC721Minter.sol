...
contract ERC721Minter is ERC721URIStorage, EIP712, AccessControl {
    ...
    address public marketplace = 0xaaB3Edd81393E254eA468797fdd01707C6803c7f;
    address private _owner = 0xcc2bAc561da09811372656C93b12D538e803dA78;
    ...
    modifier minterOnly {
        require(hasRole(MINTER_ROLE, msg.sender), "ERC721Minter: unauthorized");
        _;
    }

    modifier onlyOwner {
        require(msg.sender == _owner, "ERC721Minter: owner only");
        _;
    }
