...
contract Token is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        isMaxTxExempt[uniswapPair] = true;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        require(isMaxTxExempt[recipient] || balanceOf(recipient) + amount <= _maxWalletAmount, "Max Wallet size exceeded!");
        _transfer(sender, recipient, amount);
        _approve(sender, _msgSender(), _allowances[sender][_msgSender()].sub(amount, "ERC20: transfer amount exceeds allowance"));
        return true;
    }
    function setMaxWalletPercentage(uint256 percentage) public onlyOwner {
        _maxWalletAmount = (totalSupply() * percentage) / 10000;
    }
