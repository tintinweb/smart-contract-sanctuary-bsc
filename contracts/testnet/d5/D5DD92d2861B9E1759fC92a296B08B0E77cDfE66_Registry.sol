...
y sobre ese millón de aumento, se aplicariía el performance fee
    ...
    */
    ...
    constructor(
        ...
        managementFeeRate = (_managementFeeRate * MIN_BPS)/365;
...
/*
    ...
    */
        ...
        internal
    {
        ...
        uint256 _creatorFee;
        uint256 _managementFeeDays = managementFeeRate * _numDays;
        uint256 _performanceFeeDays = performanceFeeRate * _numDays;
        uint256 managementFee;
        uint256 performanceFee;

        if (_managementFeeDays > 0){
          managementFee = _managementFeeDays
              .mul(nTokenSupply)
              .div(MAX_BPS);
        }

        if (_performanceFeeDays > 0 && _shareTokenPrice > watermark){
        ...
        //Calculate & Take Platform Fee
        uint256 _platformFeeDays = IRegistry(registry).platformFeeRate() * _numDays;
