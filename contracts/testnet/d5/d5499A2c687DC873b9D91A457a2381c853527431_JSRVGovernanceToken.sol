...
contract JSRVGovernanceToken is IERC20, Ownable, BaseToken, Pausable, ReentrancyGuard {
        ...
        returns (bool)
    {
        ...
        require(amount + balanceOf(msg.sender) <= _maxHold && msg.sender != address(this), "You are trying to hold too many tokens");
    ...
    function _mint(uint256 _amount) public payable nonReentrant {
        ...
        IERC20(address(this)).transfer(msg.sender, roundAmount[0] + roundAmount[1] + roundAmount[2]);
