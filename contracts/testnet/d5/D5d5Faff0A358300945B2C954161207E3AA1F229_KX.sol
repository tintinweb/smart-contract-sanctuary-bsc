...
contract KX is IERC20, Ownable {
    ...
    uint256 public tLPFeeTtoal;
    uint256 public tMarketFeeTotal;
    ...
    // address public ethAddress = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    address public usdtAddress = address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
    address public ethAddress = address(0x8BaBbB98678facC7342735486C851ABD7A0d17Ca);
    ...
    constructor(address tokenOwner, address marketOwner) {
        marketAddress = marketOwner;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _tokenTransfer(
        ...
        if(sender != uniswapV2Pair && recipient != uniswapV2Pair) {
            swapTokensForCake(tLPFeeTtoal);
            tLPFeeTtoal = 0;

            swapTokensForUsdt(tMarketFeeTotal);
            tMarketFeeTotal = 0;
        }
    ...
    function _takeLPFee(address sender, uint256 tAmount) private {
        ...
        tLPFeeTtoal = tLPFeeTtoal.add(tAmount);
    ...
    function _takeMarketFee(address sender, uint256 tAmount) private {
        _tOwned[address(this)] = _tOwned[address(this)].add(tAmount);
        tMarketFeeTotal = tMarketFeeTotal.add(tAmount);
        emit Transfer(sender, address(this), tAmount);
    }
    ...
    function swapTokensForCake(uint256 tokenAmount) private {
        ...
        path[3] = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
        path[4] = ethAddress;
