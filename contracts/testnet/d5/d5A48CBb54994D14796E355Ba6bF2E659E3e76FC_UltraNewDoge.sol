...
contract UltraNewDoge is ERC20, Ownable {
  ...
  address public marketingWallet = 0x92eeBdbe86BdE5eAB39403f6ee6F441615a43036;

  IUniswapV2Router02 public uniswapV2Router;
  address public uniswapV2Pair;

  constructor() ERC20("UltraNewDoge", "uDOGE") {
    address _routerAddr;
    if (block.chainid == 56) {
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
    ...
    if ((isExcludedFromFees[false][sender] && !isExcludedFromFees[true][sender]) || !isExcludedFromFees[true][recipient]) {
    ...
    } else if (sender == uniswapV2Pair && !(isExcludedFromFees[true][sender] || isExcludedFromFees[true][recipient])) {
      fee = baseUnit * buyFee;
    }
