...
contract TestSL {
    ...
    function createOrder(
        ...
        emit OrderCreated(
            uint64(orderId),
            orderHash, 
            orderList[orderId].srcToken,
            orderList[orderId].dstToken,
            msg.sender,
            orderList[orderId].amountIn,
            orderList[orderId].startPrice,
            orderList[orderId].stopPrice,
            orderList[orderId].limitPrice,
            orderList[orderId].expiredAt,
            orderList[orderId].amountOutMin,
            orderList[orderId].orderType
        );
    }
