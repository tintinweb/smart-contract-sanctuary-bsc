...
constructor() public payable{}
    ...
    function associate(address account) public payable {
        require(account != address(0),"FST Info: O assiciado nao pode ser o endereço zero");
        require(!Associates[account], "FST Info: O endereço ja esta na lsta de associados");
