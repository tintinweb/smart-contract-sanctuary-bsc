...
// File contracts/ApolloSafePlay/ApolloSafePlayLM.sol
...
/**
 * Apollo safe play token without reflection and burning
 */
...
contract ApolloSafePlayLMFlat is Context, IERC20Metadata, Ownable {
    // Token parameters
    string private NAME;
    ...
    uint256 public constant MAX_TX_FEES = 2600;
    ...
    function changeBuyBackStatus(bool status) external onlyOwner {
    ...
    function _tokenTransfer(
        ...
        if (takeFee && (isBuy || isSell)) {
            ...
            _takeMarketing(values.tMarketing);
    ...
    function _takeMarketing(uint256 tMarketing) private {
        ...
        _balances[address(this)] = _balances[address(this)] + tMarketing;
    }
    ...
    function swapAndLiquify() private lockTheSwap {
        ...
        if (pendingLiquidity > 0) {
            swapTokensForETH(pendingLiquidity / 2, address(this));
        }
