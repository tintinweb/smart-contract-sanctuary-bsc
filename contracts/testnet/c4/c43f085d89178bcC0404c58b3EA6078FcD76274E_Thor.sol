...
contract Thor is Context, ERC165, IERC721, IERC721Metadata,Pausable,Ownable{
    ...
    constructor (string memory name_, string memory symbol_){
        _name = name_;
        _symbol = symbol_;
        URI = "https://gateway.pinata.cloud/ipfs/QmcDzXyMmrLKmbiwGDgdTiACaiqkWZqemK6TkXNLmrbM75";
    }
     ...
     * Emits a {Transfer} event.
     */
    function safeMint( uint256 tokenId) public virtual payable whenNotPaused {
