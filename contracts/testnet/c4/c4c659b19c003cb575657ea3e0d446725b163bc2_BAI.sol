...
contract BAI is ERC20, Ownable {
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _developerFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _liquidityFee, uint256 _developerFee, uint256 _earlySellLiquidityFee, uint256 _earlySellMarketingFee) external onlyOwner {
