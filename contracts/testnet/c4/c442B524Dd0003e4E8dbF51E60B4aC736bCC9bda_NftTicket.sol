...
contract NftTicket is ERC721, Ownable, ReentrancyGuard {
    ...
    EventDetails public eventDetails; // only one event in allowed in this contract!
    ...
    price and max no for each ticket category can be queried. Vip 1 - 2 - 3 has different ticketsCategory
    */
