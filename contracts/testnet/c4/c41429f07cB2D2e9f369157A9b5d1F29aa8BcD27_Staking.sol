...
contract Staking is Ownable, ReentrancyGuard{
    ...
    function getPendingRewardsById(uint256 tokenId) public view returns (uint256){
        ...
        if(currentCycle == 0) {
            ...
            return rewards * multiplierPerLevel[IHappyMonkey(HAPPY_MONKEY).getNftLevel(tokenId)] / 10000;
        }
        ...
        rewards = rewards * multiplierPerLevel[IHappyMonkey(HAPPY_MONKEY).getNftLevel(tokenId)] / 10000;
