...
contract Staking is Ownable, ReentrancyGuard {
    ...
    function stake(uint256 _pid, uint256 _amount) external nonReentrant {  
        ...
        _poolInfo.token.transferFrom(msg.sender, address(this), _amount);

        emit Stake(msg.sender, _pid, block.timestamp, _amount);
    }
    ...
    event Stake(address indexed account, uint256 pid, uint256 startTime, uint256 amount);
