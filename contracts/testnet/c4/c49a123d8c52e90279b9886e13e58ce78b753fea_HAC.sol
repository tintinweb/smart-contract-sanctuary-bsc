...
// File: HaresGame/SignatureVerifier_V2.sol
...
// File: HaresGame/HaresGameERC20.sol
...
contract HAC is ERC20, Ownable, SignatureVerifier_V2 {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _maxSupply, address _signer) ERC20(_name, _symbol) SignatureVerifier_V2(_signer) {
