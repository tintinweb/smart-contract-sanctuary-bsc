...
abstract contract GretAccessControlled {

    /* ========== EVENTS ========== */

    event AuthorityUpdated(IGretAuthority indexed authority);

    string UNAUTHORIZED = "UNAUTHORIZED"; // save gas

    /* ========== STATE VARIABLES ========== */

    IGretAuthority public authority;


    /* ========== Constructor ========== */

    constructor(IGretAuthority _authority) {
    ...
    function setAuthority(IGretAuthority _newAuthority) external onlyGovernor {
...
contract GretTreasury is GretAccessControlled, ITreasury {
    /* ========== DEPENDENCIES ========== */
    ...
    constructor(
        ...
        uint256 _timelock,
        address _authority
    ) GretAccessControlled(IGretAuthority(_authority)) {
