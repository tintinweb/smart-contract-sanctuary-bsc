...
contract Tournament is AccessControl {
    ...
    function claimAfterWithDrawTournament() external {
       require(
        ...
        uint256 calculatedPlatformFee = (tokenWithdrawAmount * pPenaltyFeeRate) /
            100;
        uint256 calculatedTournamentFee = (tokenWithdrawAmount * tPenaltyFeeRate) /
            100;
    ...
    function distributeTokensReward(
        ...
        require(!isDistributed, "DISTRIBUTED");
        ...
        for (uint256 i = 0; i < tokens.length; i++) {
            ...
            else 
            {
                if(_remainPercentages > 0) 
                {
                    ...
                    uint256 transferAmount = remainAmount - calculatedPlatformFee;
                    ...
                    {
                        // Transfer fee to Fee Wallet
                        payable(ITournamentFactory(factory).getpWallet()).transfer(calculatedPlatformFee);
