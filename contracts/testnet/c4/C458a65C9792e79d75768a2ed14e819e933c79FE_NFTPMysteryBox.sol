...
contract NFTPMysteryBox is ERC1155, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        require(minter_ != address(0), "Minter address cannot be 0");
    ...
    */
    ...
    /**
    * @notice Allows admin wallet to fulfill the reveal request
    * @param to Receiver of the Mystery box
    * @param id Id of collection to be minted
    * @param amount Amount to be minted
    */
    function authorizedMint(address to, uint256 id, uint256 amount) external onlyMinter {
        MysteryBox.Collection storage c = collections[id];
        _mint(to, c, id, amount);
        emit BoxMint(id, amount, 0, to, false);
    }
    ...
    modifier onlyMinter() {
        require(msg.sender == minter, "Not authorized to perform the action");
        _;
    }
    ...
    */
    function _mint(address to, MysteryBox.Collection storage c, uint256 id, uint256 amount) internal nonReentrant {
