     ...
     Alexa.transferFrom(msg.sender, address(this), _amount);
      ...
      // =========== start ==================
        if(referrer != address(0) && referrer != msg.sender){
             ...
             uint amount = _amount.mul(REFERRAL_PERCENTS[1]).div(PERCENTS_DIVIDER);
           ...
           if (refToRef[referrer] == address(0) ) {
                uint amount1  = _amount.mul(REFERRAL_PERCENTS[2]).div(PERCENTS_DIVIDER);
               ...
               if (refToRef[lev2] == address(0)) {
                uint amount2 = _amount.mul(REFERRAL_PERCENTS[3]).div(PERCENTS_DIVIDER);
