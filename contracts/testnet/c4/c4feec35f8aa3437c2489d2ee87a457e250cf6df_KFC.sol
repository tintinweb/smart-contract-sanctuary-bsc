...
contract KFC is Context, IERC20, Ownable {
    ...
    string private _name = "KFC";
    string private _symbol = "KFC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9999999eAD67707549BC8fdE7D3eF60350115D44); 
    address payable public teamWalletAddress = payable(0x9999999eAD67707549BC8fdE7D3eF60350115D44); 
    ...
    uint256 private _totalSupply = 1000 *  10**4 * 10**_decimals;
    ...
    constructor () {
        ...
        isExcludedFromFee[address(0xbBDbdE4dAc92F37692f7e7aFe30913e253ca7763)] = true;
        isExcludedFromFee[address(0x99999999a2245E63Ad1E22Db47c1E163c30d3f11)] = true;
        ...
        isTxLimitExempt[address(0xbBDbdE4dAc92F37692f7e7aFe30913e253ca7763)] = true;
