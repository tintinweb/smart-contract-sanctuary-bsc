...
contract tex is ERC20, Ownable {
    ...
    uint256 public maxBuyAmount = 1 * 10**13 * 10**9; // 1% of the supply
    ...
    address payable _marketingWallet = payable(address(0x683d1Aa9C89781D2661C7cAC84B967A76A809918)); // MarketingWallet
