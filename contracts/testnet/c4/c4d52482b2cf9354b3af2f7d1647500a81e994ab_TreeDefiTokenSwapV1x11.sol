...
// File: contracts/TreeDefiTokenSwap.sol


// Treedefi Token Swap v. 1.11
// Code: SCSE-01
// Usage Testnet
// Author: Treedefi 
...
contract TreeDefiTokenSwapV1x11  is ReentrancyGuard {
    ...
    function depositSEED(uint256 _amountInSEED) public nonReentrant returns (uint256) {
        ...
        swapTimeAmount.push(KV(amountOut, block.timestamp, 0));
