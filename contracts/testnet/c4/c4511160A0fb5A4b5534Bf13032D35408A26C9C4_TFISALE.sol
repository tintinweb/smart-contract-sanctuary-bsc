...
contract TFISALE  {
	...
	uint public MINIMUM_BUY = 1000*1e18;
	uint public tokenPrice = 2228344124184;
    address public owner;
    uint256[] public refPercent=[150,100,50];
   ...
   mapping(address => uint256) public boughtOf;
    ...
    function _calculateReferrerReward(uint256 _investment, address _referrer) private 
	{
	     for(uint8 i=0;i<3;i++)
	     {
             ...
             TFIToken.transfer(_referrer,(_investment*refPercent[i])/1000); 
    ...
    function buyToken(uint256 tokenQnt,address referrer) public payable
	{
	     ...
	     TFIToken.transfer(msg.sender ,tokenQnt);
	     if(msg.sender!=owner)
