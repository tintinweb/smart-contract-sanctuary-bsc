...
contract NINEToken is IBEP20 {
	
	uint256 private _totalSupply;
    uint8 private _decimals = 9;
    string private _symbol = "NINE";
    string private _name= "NINE COIN";
...
contract NINETokenSale {
    address payable admin;
    NINEToken public tokenContract;
    ...
    constructor(NINEToken _tokenContract, uint256 _tokensSold)  {
    ...
    function buyTokens(uint256 _bnbvalue) public payable {
		uint256 _numberOfTokens=(_bnbvalue*1000000000)/tokenPrice;
