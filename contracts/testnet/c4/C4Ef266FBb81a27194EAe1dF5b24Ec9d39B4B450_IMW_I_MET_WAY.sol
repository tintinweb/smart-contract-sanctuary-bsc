...
/**
 * VIX_CODE - https://github.com/VIXCODE
 * Fork     - https://bscscan.com/token/0xc748673057861a797275cd8a068abb95a902e8de
*/
        /*
            _NAME (string): I MET WAY
            _SYMBOL (string): IMW
            _DECIMALS (uint256): 10
            _supply (uint256):  125000000000000
            _txFee (uint256): 3
            lpFee (uint256): 2
            _MAXAMOUNT (uint256):    10000000000000
            SELLMAXAMOUNT (uint256): 1000000000000
            routerAddress (address): 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 //TESTNET

            // PancakeSwap Router address:
                    // (BSC testnet) 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
                    // (BSC mainnet) V2 0x10ED43C718714eb63d5aA57B78B54704E256024E
                    
            tokenOwner (address): 0x52d5E5380843EF5D644DcBEFD0579E317b65b68a //DEV_WALLET - ON TESTNET
        */
...
contract IMW_I_MET_WAY is Context, IBEP20, Ownable {
