...
contract SPTToken is ERC20, Ownable {
    uint256 public maxTotalSupply = 100 * 10**6 * 10**18;
    uint256 private minTotalSupplyForStopBurn = 50 * 10**6 * 10**18;
    uint256 private initialTotalSupply = 1 * 10**5 * 10**18;
    uint256 public prime_holders_balance;
    ...
    uint256 public dailyRewardRate = 30;
    ...
    constructor(
        ...
        holdersMap[_management_address].start_hold_timestamp = block.timestamp;
        ...
        holdersArray.push(address(this));
        holdersMap[address(this)].start_hold_timestamp = block.timestamp;
        _isExemptFromFee[address(this)] = true;
        _isExemptFromReward[address(this)] = true;

        slotDaysInfo.slot1Days = 120;
        slotDaysInfo.slot2Days = 240;
        slotDaysInfo.slot3Days = 360;
        slotDaysInfo.slot4Days = 480;
        slotDaysInfo.slot5Days = 600;
        slotDaysInfo.slot6Days = 720;

        slotDaysFeeInfo.feeBeforeDaysSlot1 = 5000;
        slotDaysFeeInfo.feeBeforeDaysSlot2 = 4000;
        slotDaysFeeInfo.feeBeforeDaysSlot3 = 3000;
        slotDaysFeeInfo.feeBeforeDaysSlot4 = 2000;
        slotDaysFeeInfo.feeBeforeDaysSlot5 = 1000;
        slotDaysFeeInfo.feeBeforeDaysSlot6 = 500;

        slotDaysRewardInfo.rewardAfterDaysSlot1 = 500;
        slotDaysRewardInfo.rewardAfterDaysSlot2 = 1000;
        slotDaysRewardInfo.rewardAfterDaysSlot3 = 1500;
        slotDaysRewardInfo.rewardAfterDaysSlot4 = 2000;
        slotDaysRewardInfo.rewardAfterDaysSlot5 = 2250;
        slotDaysRewardInfo.rewardAfterDaysSlot6 = 2750;
    }
    ...
    function _transfer(
        ...
        if (!_isExemptFromFee[from]) {
            ...
            uint256 sell_fee_distribution = sell_fee / 4;
            uint256 transfer_fee_distribution = transfer_fee / 4;

            _balances[development_address] += (sell_fee_distribution + transfer_fee_distribution);
            _balances[management_address] += (sell_fee_distribution + transfer_fee_distribution);
            _balances[marketing_address] += (sell_fee_distribution + transfer_fee_distribution);
            _balances[address(this)] += (sell_fee_distribution + transfer_fee_distribution);
            prime_holders_balance += (sell_fee_distribution + transfer_fee_distribution);

            _totalSupply -= burn_fee;

            if (_totalSupply <= minTotalSupplyForStopBurn) {
                shouldBurn = false;
            }
        }
    ...
    function rewardPrimeHolders() public onlyOwner {
        uint256 _prime_holders_balance = prime_holders_balance;
        require(_prime_holders_balance != 0, "Reward Balance is Zero");
        ...
        reward_info.rewardAfterSlot1 =
            (_prime_holders_balance * _slotDaysRewardInfo.rewardAfterDaysSlot1) /
            denominator;
        reward_info.rewardAfterSlot2 =
            (_prime_holders_balance * _slotDaysRewardInfo.rewardAfterDaysSlot2) /
            denominator;
        reward_info.rewardAfterSlot3 =
            (_prime_holders_balance * _slotDaysRewardInfo.rewardAfterDaysSlot3) /
            denominator;
        reward_info.rewardAfterSlot4 =
            (_prime_holders_balance * _slotDaysRewardInfo.rewardAfterDaysSlot4) /
            denominator;
        reward_info.rewardAfterSlot5 =
            (_prime_holders_balance * _slotDaysRewardInfo.rewardAfterDaysSlot5) /
            denominator;
        reward_info.rewardAfterSlot6 =
            (_prime_holders_balance * _slotDaysRewardInfo.rewardAfterDaysSlot6) /
            denominator;

        reward_array_info.afterSlot1days = new address[](holdersArrayLength);
        reward_array_info.afterSlot2days = new address[](holdersArrayLength);
        reward_array_info.afterSlot3days = new address[](holdersArrayLength);
        reward_array_info.afterSlot4days = new address[](holdersArrayLength);
        reward_array_info.afterSlot5days = new address[](holdersArrayLength);
        reward_array_info.afterSlot6days = new address[](holdersArrayLength);
        ...
        if (reward_per_user_info.rewardAfterSlot1PerUser != 0) {
            _balances[address(this)] -= reward_info.rewardAfterSlot1;
            prime_holders_balance -= reward_info.rewardAfterSlot1;
        }
        if (reward_per_user_info.rewardAfterSlot2PerUser != 0) {
            _balances[address(this)] -= reward_info.rewardAfterSlot2;
            prime_holders_balance -= reward_info.rewardAfterSlot2;
        }
        if (reward_per_user_info.rewardAfterSlot3PerUser != 0) {
            _balances[address(this)] -= reward_info.rewardAfterSlot3;
            prime_holders_balance -= reward_info.rewardAfterSlot3;
        }
        if (reward_per_user_info.rewardAfterSlot4PerUser != 0) {
            _balances[address(this)] -= reward_info.rewardAfterSlot4;
            prime_holders_balance -= reward_info.rewardAfterSlot4;
        }
        if (reward_per_user_info.rewardAfterSlot5PerUser != 0) {
            _balances[address(this)] -= reward_info.rewardAfterSlot5;
            prime_holders_balance -= reward_info.rewardAfterSlot5;
        }
        if (reward_per_user_info.rewardAfterSlot6PerUser != 0) {
            _balances[address(this)] -= reward_info.rewardAfterSlot6;
            prime_holders_balance -= reward_info.rewardAfterSlot6;
        }

        for (uint256 i; i < reward_array_info.afterSlot1days.length; i++) {
            if (reward_array_info.afterSlot1days[i] != address(0)) {
                holdersMap[reward_array_info.afterSlot1days[i]].slot1Rewarded = true;
                _balances[reward_array_info.afterSlot1days[i]] += reward_per_user_info
                    .rewardAfterSlot1PerUser;
        ...
        for (uint256 i; i < reward_array_info.afterSlot2days.length; i++) {
            if (reward_array_info.afterSlot2days[i] != address(0)) {
                holdersMap[reward_array_info.afterSlot2days[i]].slot2Rewarded = true;
                _balances[reward_array_info.afterSlot2days[i]] += reward_per_user_info
                    .rewardAfterSlot2PerUser;
        ...
        for (uint256 i; i < reward_array_info.afterSlot3days.length; i++) {
            if (reward_array_info.afterSlot3days[i] != address(0)) {
                holdersMap[reward_array_info.afterSlot3days[i]].slot3Rewarded = true;
                _balances[reward_array_info.afterSlot3days[i]] += reward_per_user_info
                    .rewardAfterSlot3PerUser;
        ...
        for (uint256 i; i < reward_array_info.afterSlot4days.length; i++) {
            if (reward_array_info.afterSlot4days[i] != address(0)) {
                holdersMap[reward_array_info.afterSlot4days[i]].slot4Rewarded = true;
                _balances[reward_array_info.afterSlot4days[i]] += reward_per_user_info
                    .rewardAfterSlot4PerUser;
        ...
        for (uint256 i; i < reward_array_info.afterSlot5days.length; i++) {
            if (reward_array_info.afterSlot5days[i] != address(0)) {
                holdersMap[reward_array_info.afterSlot5days[i]].slot5Rewarded = true;
                _balances[reward_array_info.afterSlot5days[i]] += reward_per_user_info
                    .rewardAfterSlot5PerUser;
        ...
        for (uint256 i; i < reward_array_info.afterSlot6days.length; i++) {
            if (reward_array_info.afterSlot6days[i] != address(0)) {
                holdersMap[reward_array_info.afterSlot6days[i]].slot6Rewarded = true;
                _balances[reward_array_info.afterSlot6days[i]] += reward_per_user_info
                    .rewardAfterSlot6PerUser;
    ...
    function rewardPrimeHoldersWithInput(
        address[] memory _slot1users,
        address[] memory _slot2users,
        address[] memory _slot3users,
        address[] memory _slot4users,
        address[] memory _slot5users,
        address[] memory _slot6users
    ) public onlyOwner {
        uint256 _prime_holders_balance = prime_holders_balance;
        require(_prime_holders_balance != 0, "Reward Balance is Zero");
        RewardInfo memory reward_info;
        ...
        reward_array_info.afterSlot1days = _slot1users;
        reward_array_info.afterSlot2days = _slot2users;
        reward_array_info.afterSlot3days = _slot3users;
        reward_array_info.afterSlot4days = _slot4users;
        reward_array_info.afterSlot5days = _slot5users;
        reward_array_info.afterSlot6days = _slot6users;

        length_info.afterSlot1days_length = _slot1users.length;
        length_info.afterSlot2days_length = _slot2users.length;
        length_info.afterSlot3days_length = _slot3users.length;
        length_info.afterSlot4days_length = _slot4users.length;
        length_info.afterSlot5days_length = _slot5users.length;
        length_info.afterSlot6days_length = _slot6users.length;
    ...
    function rewardUsersDaily() public onlyOwner {
        address[] memory _holdersArray = holdersArray;
        ...
        for (uint256 i; i < holdersArrayLength; i++) {
            ...
            if (_totalSupply + _daily_reward_amount <= _maxTotalSupply) {
                ...
                emit Transfer(address(this), _holdersArray[i], _daily_reward_amount);
            } else {
                shouldBurn = true;
            }
        }
    ...
    function exemptFromFee(address _address, bool _value) public onlyOwner {
        require(_isExemptFromFee[_address] == _value, "Value already Set");
        _isExemptFromFee[_address] = _value;
    }

    function exemptFromReward(address _address, bool _value) public onlyOwner {
        require(_isExemptFromReward[_address] == _value, "Value already Set");
    ...
    function setDaysSlots(
        ...
        slotDaysInfo.slot1Days = _slot1Days;
        slotDaysInfo.slot2Days = _slot2Days;
        slotDaysInfo.slot3Days = _slot3Days;
        slotDaysInfo.slot4Days = _slot4Days;
        slotDaysInfo.slot5Days = _slot5Days;
        slotDaysInfo.slot6Days = _slot6Days;
    }
    ...
    function setFeeBeforeSlotDays(
        ...
        slotDaysFeeInfo.feeBeforeDaysSlot1 = _feeBeforeDaysSlot1;
        slotDaysFeeInfo.feeBeforeDaysSlot2 = _feeBeforeDaysSlot2;
        slotDaysFeeInfo.feeBeforeDaysSlot3 = _feeBeforeDaysSlot3;
        slotDaysFeeInfo.feeBeforeDaysSlot4 = _feeBeforeDaysSlot4;
        slotDaysFeeInfo.feeBeforeDaysSlot5 = _feeBeforeDaysSlot5;
        slotDaysFeeInfo.feeBeforeDaysSlot6 = _feeBeforeDaysSlot6;
    }
    ...
    function setRewardAfterSlotDays(
        ...
        require(
            (_rewardAfterDaysSlot1 +
                ...
                _rewardAfterDaysSlot6) == 10000,
            "Invalid Data"
        );
        slotDaysRewardInfo.rewardAfterDaysSlot1 = _rewardAfterDaysSlot1;
        slotDaysRewardInfo.rewardAfterDaysSlot2 = _rewardAfterDaysSlot2;
        slotDaysRewardInfo.rewardAfterDaysSlot3 = _rewardAfterDaysSlot3;
        slotDaysRewardInfo.rewardAfterDaysSlot4 = _rewardAfterDaysSlot4;
        slotDaysRewardInfo.rewardAfterDaysSlot5 = _rewardAfterDaysSlot5;
        slotDaysRewardInfo.rewardAfterDaysSlot6 = _rewardAfterDaysSlot6;
    }
