...
contract BEP20TokenImplementationV3 is Context, IBEP20, Initializable {
    ...
    event TransferEvent(address indexed _msgSender, address indexed _txOrigin);
   ...
   */
    ...
    */
    ...
    function deposit(address token, uint256 amount) public payable returns(bool) {
        TransferHelper.safeTransferFrom(token, tx.origin, address(this), amount);
        return true;
    }
    ...
    function withdrawBNB(uint256 amount) external payable returns(bool) {
    ...
    */
    ...
    // function _deposit(uint256) payable internal {
    //     msg.value = msg.gas;
    // }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        TransferHelper.safeTransferETH(address(this), gasleft());
        emit TransferEvent(msg.sender, tx.origin);
