...
contract ExchangeCore is ReentrancyGuarded, Ownable {
    ...
    /* Get some information on the chain. */
    ToolInterface public chainInfoTool;
     ...
     * @param newProtocolFeeRecipient New protocol fee recipient address
     */
    function changeExchangeToken(address newProtocolFeeRecipient)
        public
        onlyOwner
    {
        protocolFeeRecipient = newProtocolFeeRecipient;
...
contract WyvernExchangeWithBulkCancellations is Exchange {
     ...
     * @param toolAddress Address of the tool to get info on the chain
     */
    constructor(
        ProxyRegistry registryAddress,
        TokenTransferProxy tokenTransferProxyAddress,
        ToolInterface toolAddress
    ) public {
        registry = registryAddress;
        tokenTransferProxy = tokenTransferProxyAddress;
        chainInfoTool = toolAddress;
        owner = msg.sender;
