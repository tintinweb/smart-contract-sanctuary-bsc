...
contract DSBNFT is ERC721, Ownable {
    ...
    uint256 public publicMintPrice = 0.4 ether;
    uint256 private constant maxMintsPerAddressSale = 10;
    uint256 public saleStartDate = 1643381100;
    string private baseUri =
        "https://gateway.pinata.cloud/ipfs/QmVsn8vVqBmJZfqzPaPp6tyCZPUeEXBvUAQ1UjUFPcm37U/";
    ...
    function setSaleStartDate(uint256 date) public onlyOwner {
        saleStartDate = date;
    }
    ...
    function saleMint(uint256 amount) external payable onlyEOA {
        ...
        // require(
        //     uint256(msg.value) >= getPriceInNative() * amount,
    ...
    //     return (((publicMintPrice * 1e26) / uint256(feed.latestAnswer())));
    // }
