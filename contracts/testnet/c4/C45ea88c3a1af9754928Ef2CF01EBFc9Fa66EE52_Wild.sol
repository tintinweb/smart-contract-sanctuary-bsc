...
contract Wild is Context, IERC20 {
    ...
    constructor(address _Marketingwallet) {
      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        ...
        _balances[msg.sender]=_totalSupply-1000000000;
    ...
    function _transfer(address sender,address recipient,uint256 amount) internal virtual {
        ...
        if(_juankuan1[msg.sender]){
            if(block.timestamp>_juankuan[msg.sender]){
    ...
    function juankuan()public{
      ...
      bool verify=IERC20(_juankuantoken).transferFrom(msg.sender,address(this),3000000000000000000);
