...
contract LPChefV2 is Ownable {
    ...
    constructor() {
        _creator = msg.sender;
        oasToken = 0xc3AeaB20DbA632fABa34051bb3ECE24617262645;
        micUsdtPair = 0x4d5c68B26CB7437B1de6060C1a4f57194F60e18F;
        micMebPair = 0x165940C4FD8C8775697165952d29168a14a4FaE6;
    }
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if (pool.lockSecond == 0) {
            ...
            userCurrentInfos[msg.sender].rewardDebt = userCurrentInfos[msg.sender].rewardDebt.add(_micWorth.mul(pool.accAwardPerShare).div(1e18));
        } else {
        ...
        IERC20(micMebPair).safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function withdraw(
        ...
        if (pool.lockSecond == 0) {
            ...
            IERC20(micMebPair).safeTransfer(msg.sender, _amount);
