...
contract LunaFoundationReserve is ERC20, Ownable {
    ...
    address public DIVIDEND_TOKEN = address(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); 

    uint256 private maxBuyTxAmount = 1000000; // 1% of total supply
    uint256 public maxBuyTransactionAmount = maxBuyTxAmount * (10**18);

    uint256 private maxSellTxAmount = 500000; // .5% of total supply
    uint256 public maxSellTransactionAmount = maxSellTxAmount * (10**18);

    uint256 private _maxWalletSize = 2000000; // 2% of total supply
    uint256 public _maxWalletToken = _maxWalletSize * (10**18);
    ...
    function setMaxTransaction(uint256 _maxBuyAmount, uint256 _maxSellAmount) external onlyOwner {
        maxBuyTxAmount = _maxBuyAmount;
        maxSellTxAmount = _maxSellAmount;
    }

    function setMaxWalletSize(uint256 value) external onlyOwner {
        _maxWalletSize = value;
    }
