...
contract plugxrCoin is Initializable, ERC20Upgradeable, ERC20BurnableUpgradeable, PausableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(string memory _name,string memory _symbol,uint8 _decimal,uint256 _totalSupply,address _router) initializer public {
        ...
        admin = _msgSender() ;
        _tokenTotal = _totalSupply*(10**_decimals);
    ...
    function _burn(address account, uint256 amount) internal virtual override{
        ...
        uint256 accountBalance = _tokenBalance[account];
        require(accountBalance >= amount, "BEP20: burn amount exceeds balance");
        unchecked {
            _tokenBalance[account] = accountBalance - amount;
        }
        _tokenTotal -= amount;
