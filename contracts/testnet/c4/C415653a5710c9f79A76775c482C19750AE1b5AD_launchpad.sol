...
contract launchpad is Ownable {
    ...
    function transferBackIDOToken(uint256 _pool, uint256 _amount) external {
        ...
        if (transferBackIDOAddress[_pool] == address(this)) {
            ...
            idoTokenTransferredFromFixed[transferBackIDOAddress[_pool]][_user] -= _amount;
    ...
    function transferIDOTokenToFixed(address _fixedContract, address _user, uint256 _amount) external {
