...
contract Ownable is Context {
     ...
     */
    //todo 管理员：0xc287c00b33cadd15a1c9e18cd2d0b80c8e2429ac
    modifier onlyOwner() {
...
contract Spark is ERC20 {
    ...
    address constant public uniswapV2Router = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    address constant usdtToken = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;
    ...
    constructor(address tokenOwner) ERC20("sparks of fire", "SPARKs")  {
        ...
        uint256 total = 8888888888 * 10 ** decimals();
        _mint(tokenOwner, total);
    }

    receive() external payable {}
    //todo 设置自动出货和分红开关 setSwapAndLiquifyEnable 0xc95479e7
    ...
    //todo 设置池子地址 setUniswapV2Pair 0xa29a6089
    function setUniswapV2Pair(address _uniswapV2Pair) public onlyOwner {
        uniswapV2Pair = _uniswapV2Pair;
    }

    //todo 设置开始时间 setStartTime 0x3e0a322d
    function setStartTime(uint256 _startTime) public onlyOwner {
        startTime = _startTime;
    }

    //todo 设置第三方分红合约地址 注意：设置错误的地址可导致交易暂停 setDividendDistributor 0x32516d48
    ...
    function _transfer(
        ...
        if (_isExcludedFromFees[sender] || _isExcludedFromFees[recipient]) {
            ...
            //todo 交易开关 买入开始时间：2022-09-25 20:28:09（设置时间+5个小时开始可买入）
        ...
        if (takeFee) {
            ...
            //todo 杀区块 手续费30% 杀前20分钟(杀设置时间+5个小时+20分钟之前） 当前：2022-09-25 20:48:09开始可正常交易
            if (5 * 60  * 60 + 20 * 60 + startTime > block.timestamp && !isDelLdx) {
                marketPercent = 3000;
            }
            //todo 手续费 5% 买卖一体 转 0%（万分率）
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private {
        ...
        bool success;
        bytes memory data;
        //todo 当前自动出货和分红合约地址为0x0地址未设置，触发自动出货
