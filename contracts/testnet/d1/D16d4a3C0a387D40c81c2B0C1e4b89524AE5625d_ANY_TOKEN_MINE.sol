...
contract ANY_TOKEN_MINE {
    address busd = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //BUSD_address
    ...
    function sellEggs() public {
        ...
        uint256 fee = SafeMath.div(SafeMath.mul(eggValue,8),100);
        claimedEggs[msg.sender]=0;
        lastHatch[msg.sender]=block.timestamp;
        marketEggs=SafeMath.add(marketEggs,hasEggs);
        IERC20(busd).transfer(ceoAddress, fee);
        IERC20(busd).transfer(address(msg.sender), SafeMath.sub(eggValue,fee));
    }
