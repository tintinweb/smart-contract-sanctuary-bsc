...
contract PeggyToken is ERC20("Peggy Token #2", "PGT2"), Ownable {
  using SafeMath for uint256;

  uint256 private constant CAP = 250_000_000e18;

    modifier trustedCaller {
  ...
  function mint(address _to, uint256 _amount) public trustedCaller {
    require(totalSupply().add(_amount) <= cap(), 'cap exceeded');
    require(_to != address(0), 'ERC20: mint to the zero address');
    _mint(_to, _amount);
  }

  function burn(address _account, uint256 _amount) public trustedCaller {
