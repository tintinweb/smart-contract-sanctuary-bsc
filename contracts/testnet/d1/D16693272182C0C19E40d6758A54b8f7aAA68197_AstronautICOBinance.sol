    ...
    PausableUpgradeable
{
    ...
    function buyWithUSDC(uint256 amount) external whenNotPaused returns (bool) {
    ...
    function buyWithBUSD(uint256 amount) external whenNotPaused returns (bool) {
        uint256 usdAmount = amount;
        uint256 allocatedamount = (usdAmount * 1 ether) / salePrice;
        userDeposits[_msgSender()] += allocatedamount;
        userInvested[_msgSender()] += (usdAmount);
        ...
        returns (bool)
    {
        ...
        userDeposits[_msgSender()] += allocatedamount;
        userInvested[_msgSender()] += (bnbToUsd / 1 ether);
        totalTokensSold += allocatedamount;
