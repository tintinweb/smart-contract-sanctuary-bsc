...
contract CSM_MasterV25{
    ...
    function claim(address _useraddress) internal returns(uint){
            ...
            if(businessLogsCount[_useraddress] ==0){
                ...
                businessLogs[_useraddress][businessLogsCount[_useraddress]-1].matching = groupRewardIncome;
                businessLogs[_useraddress][businessLogsCount[_useraddress]-1].received = groupRewardReceived;
                businessLogs[_useraddress][businessLogsCount[_useraddress]-1].groupA = incomeA_;
                businessLogs[_useraddress][businessLogsCount[_useraddress]-1].groupB = incomeB_;
                businessLogs[_useraddress][businessLogsCount[_useraddress]-1].groupC = groupCIncome(_useraddress);
                businessLogs[_useraddress][businessLogsCount[_useraddress]-1].isclaim = true;
            }
            ...
            return businessLogsCount[_useraddress];
    }
