...
// will be transferred to a governance smart contract once OverPowered is sufficiently
// distributed and the community can show to govern itself.
//
// Have fun reading it. Hopefully it's bug-free. God bless.
contract OverPoweredFarm is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    // Update the given pool's OP allocation point and deposit fee. Can only be called by the owner.
    ...
    // View function to see pending OP on frontend.
    ...
    // View function to see if user can harvest OP.
    ...
    // Deposit LP tokens to MasterChef for OP allocation.
