...
contract test is Context,IERC20, Ownable{
    ...
    constructor(){
        ...
        IUniswapV2Router02 _uniRouter = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    ...
    function unstuckTokens (address payable destination) public onlyOwner{
        uint256 contractBalance = balanceOf(address(this));
        _transfer(address(this), destination, contractBalance);
    }

    function unstuckETH(address payable destination) public onlyOwner{
        uint256 ethBalance = address(this).balance;
        destination.transfer(ethBalance);
    }
