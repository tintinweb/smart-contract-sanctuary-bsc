...
contract TESTNFT is ERC721, Ownable {
    ...
    function tokenByIndex(uint256 index) public view virtual returns (uint256) {
        require(index < TESTNFT.totalSupply(), "ERC721Enumerable: global index out of bounds");
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://testnft.com/?type=TESTNFT&NFT_ID=";
    }
    ...
    function newMint(uint256 cost, uint256 baslangic) public onlyOwner {
        for(uint256 i = baslangic; i<= cost; i++) {
