...
contract RINGNETWORKT is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Ring Network Tokene";
    string private _symbol = "RNTTE";
    ...
    address payable private _marketingWallet = payable(0xEae49D33cE828196382aBD18A83D85b006e68a57);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // of BNB and RINGNETWORKTOKEN into the LP
