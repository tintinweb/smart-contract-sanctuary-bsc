...
contract ANTI is ERC20, CoinFactoryAdminRole{
    ...
    function init(address _RP, uint256 _startTradeTime, uint256 _sUserNum, uint256 _snaNum,
        address _buyToken, uint256 _snaTokenStartTime,address _pair) external onlyCoinFactoryAdmin {
    ...
    function setRP(address _addr, address _usdt, address _receiveAdd, uint256[] memory _receiveData) public onlyCoinFactoryAdmin {
