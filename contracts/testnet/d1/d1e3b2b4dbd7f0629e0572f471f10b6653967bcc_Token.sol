...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "3M Company";
    ...
    address public mainAddres = address(0x197E7F2596d065b64663f4fEb4338Dba1F035d08);
    address public marketAddress = address(0x1417497B70d47Cb40428bF68C4F8767289c19b39);
    address public fundAddress = address(0xF3291010a7Eb2C61FAcEA1c510C0b1dCF72285D7);
    address public liquidAddress = address(0x8ABF41C0458291f4F8a59E80C5234E55Fc818307);
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        _takeLiquidity(sender, tElseFee / 3); // 2%
        _takeBurn(sender, tElseFee / 3);      // 2%
        _takeMarket(sender, tElseFee / 3);   // 1%
        _takeFund(sender, tElseFee / 3);     // 1%
