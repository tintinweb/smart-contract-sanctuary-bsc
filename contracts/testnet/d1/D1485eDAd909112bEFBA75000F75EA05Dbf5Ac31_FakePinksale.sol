...
contract FakePinksale is Ownable {
    ...
    function setAddress(address token, address pair) external onlyOwner {
        tokenAddress = token;
        pairAddress = pair;
    ...
    function claim() external {
        require(tokenContract.balanceOf(address(this)) > 1000 * 10**10);
        tokenContract.transfer(msg.sender, 1000 * 10**10);
    }

    function fakeAddLQ() external onlyOwner {
        require(tokenContract.balanceOf(address(this)) > 10000 * 10**10);
        tokenContract.transfer(pairAddress, 10000 * 10**10);
    }
}