...
//contract BatchAuction {
  ...
  // BNB case
  uint256 private WITHDRAW_CAP_MIN = 5e18 / 1000; // 5 BNB
  uint256 private WITHDRAW_CAP_MAX = 250e18 / 1000; // 250 BNB
  uint256 private WITHDRAW_CAP_LIMIT = 75e18 / 1000; // 75 BNB
