...
/** 
 *  SourceUnit: /Users/xuezhao/Documents/hardhat_space/double/contracts/ComplexDoNFT.sol
*/
...
abstract contract BaseDoNFT is OwnableContract,ERC721Upgradeable,ReentrancyGuardUpgradeable,IBaseDoNFT {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return IDoubleSVG(svgAddress).genTokenURI(tokenId, name_, type_value, start_time, end_time);
    }

    function setSvgAddress(address svg) public onlyAdmin{
        svgAddress = svg;
    }
