...
contract PYESwap_Base is IPYE, Context, Ownable {
    ...
    constructor(address _marketing, uint256 _marketingFee, uint256 _liquifyFee) {
    ...
    function buyAndLiquify(uint256 balanceWBNB) private swapping {
    ...
    function buyTokens(uint256 amountToSwap) private {
