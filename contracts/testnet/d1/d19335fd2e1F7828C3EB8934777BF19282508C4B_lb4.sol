...
interface IluckblocksNodes {
    function updateNodeInfoM(address caller, uint256 reward) external returns (bool);
...
contract lb4 is VRFConsumerBase,ReentrancyGuard,Ownable {
    ...
    IERC20 wmatic = IERC20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
    ...
    address wmaticTrading = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    ...
    address internal krstmContract = 0xa2e79B3214E0E3c99855e1d4101C237643857DCe;
    address internal btcContract = 0x048157067e5eeb2CF44e4c1dD3333020c5E6E408;
    address internal ethContract = 0x31E6Cd4E61DDf67903a65Dd520e3D9417CE69599;
    ...
    function autoSpin(address _caller, uint256[] calldata _nodes) public nonReentrant {
        ...
        if(lbNodes.getUserActivation(_caller) == false){
            lbNodes.activateNodes(_caller,_nodes,4);
        }

        if(block.timestamp > lastAutoSpin + 1860){
            lbNodes.resetQueue(4);
        } else if(lbNodes.updateNodeInfoM(_caller,botReward) == true){
    ...
    // Play Function
    function BuyTicket(address player,uint number1,uint number2,uint number3,uint number4) public nonReentrant {
    ...
    function ForfeitTicket(uint256 index) public nonReentrant {
       ...
       require(getJackpotinUSD() >= 3500 * 10**18, "Contract need to have atleast 3500 USD in value.");
        ...
        if(totalDraws == 0){
            ...
            refundValue = TICKET_VAL.mul(20).div(100);
        }
