...
contract BNBDoge is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x32fE923a07e1509286F3d70b287579E89134149A); // Marketing Address
    ...
    function enableBlackWalletLimit(bool newValue) external onlyOwner {
        _walletLimit = newValue;
    }
