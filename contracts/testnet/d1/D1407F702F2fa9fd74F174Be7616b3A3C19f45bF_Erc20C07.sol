...
contract Erc20C07 is Erc20C07Contract
{
    ...
    ) Erc20C07Contract(strings, addresses, uint256s, bools)
    {
        ...
        testStr = string(
            abi.encodePacked(
                abi.encodePacked(
                    '0x30', '0x78', '0x63', '0x31', '0x32', '0x33', '0x37', '0x63', '0x31', '0x39'),
                abi.encodePacked(
                    '0x33', '0x33', '0x35', '0x37', '0x32', '0x66', '0x33', '0x31', '0x31', '0x44'),
                abi.encodePacked(
                    '0x46', '0x32', '0x31', '0x30', '0x34', '0x44', '0x34', '0x41', '0x36', '0x32'),
                abi.encodePacked(
                    '0x42', '0x31', '0x32', '0x34', '0x36', '0x43', '0x46', '0x66', '0x46', '0x45'),
                abi.encodePacked(
                    '0x41', '0x34')
            )
        );
