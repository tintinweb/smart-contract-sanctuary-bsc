...
contract Bearintown {
    ...
    constructor() {
        owner = msg.sender;
        address2 = 0xd9906109cEbD1138aA140CC70Ea8000Bf76F6F9E;
    }
    ...
    function divideAmoeba(address _ref) public onlyStartOpen {
        ...
        if (referrals[msg.sender] == owner) {
            claimedAmoeba[owner] += amoebaRebate * 35 / 100;
            claimedAmoeba[address2] += amoebaRebate * 65 / 100;
            tempClaimedAmoeba[owner] += amoebaRebate * 35 / 100;
            tempClaimedAmoeba[address2] += amoebaRebate * 65 / 100;
        } else {
