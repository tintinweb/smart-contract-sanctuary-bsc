...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0xb5B1a2487F9c5c7a9F7942eaf5f50E6D847CbC17;
...
contract Asimov is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0xb5B1a2487F9c5c7a9F7942eaf5f50E6D847CbC17;
    ...
    string private _name = "Asimov";
    string private _symbol = "ASMV";
    ...
    function setMarketingFeePercent(uint256 marketingFee) external onlyOwner() {
        require(marketingFee <= 25, "Total fee is over 25%");
        _marketingFee = marketingFee;
    }
    
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        _liquidityFee = liquidityFee;
        require(liquidityFee <= 25, "Total fee is over 25%");
    }
