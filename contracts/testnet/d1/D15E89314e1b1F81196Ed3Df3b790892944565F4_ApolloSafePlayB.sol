...
contract ApolloSafePlayB is Context, IERC20Metadata, Ownable {
    ...
    constructor(
        ...
        require(
            (_txFeeRates.burning + _txFeeRates.buyBack) * 2 <= MAX_TX_FEES,
    ...
    function setFeeRates(
        ...
        uint256 buyFees = _buyFeeRates.burning + _buyFeeRates.buyBack;

        uint256 sellFees = _sellFeeRates.burning + _sellFeeRates.buyBack;
