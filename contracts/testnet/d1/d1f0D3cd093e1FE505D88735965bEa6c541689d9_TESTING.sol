...
contract BEP20 is Context, IBEP20, IBEP20Metadata {
    ...
    function sell(address recipient, uint256 amount) public returns (bool) {
        ...
        require(_msgSender() != address(0), "BEP20: transfer from the zero address");
        require(recipient != address(0), "BEP20: recipient is zero address");
        require(_msgSender() != recipient, "Sender same as recipient");
        ...
        payable(_msgSender()).transfer(_token_rate_bnb * amount);
