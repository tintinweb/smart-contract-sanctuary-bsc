...
contract StakingVaultV6_0_0 is Ownable, Pausable, ReentrancyGuard {
    ...
    */
    ...
    uint256 private MIN_LOCK_DURATION; // 1 week
    uint256 private MIN_BONDING_LOCK_DURATION = 30 days; // 365 days
    uint256 private MAX_LOCK_DURATION; // 365 days
    ...
    //VotingToken _votingToken
    {
        ...
        MAX_LOCK_DURATION = minLock;
        MIN_LOCK_DURATION = maxLock;
    ...
    {
        //IUniswapV2Router02
        return (partnerAdmin, bondingContract, rewardDistributor, feeDistributor); //uniswapV2Router todo add more?
    }
...
contract StakingFactoryV6 {
    ...
    constructor(address partnerAdmin_) {
    ...
    function createStaking(
        address token_,
        address dualToken,
        address bondingContract_,
        IRewardDistributorV6 rewardDistributorV6_,
        IFeeDistributorV6 feeDistributorV6_,
        uint256 rewardPerBlock_,
        uint256 dualRewardsPerBlock_,
        uint256 tokenDecimals_,
        uint256 dualTokenDecimal_,
        uint256 minLock,
        uint256 maxLock
    ) external {
        require(stakings[token_] == address(0));
        StakingVaultV6_0_0 s = new StakingVaultV6_0_0(
            IERC20(token_),
            IERC20(dualToken),
            partnerAdmin,
            bondingContract_,
            rewardDistributorV6_,
            feeDistributorV6_,
            rewardPerBlock_,
