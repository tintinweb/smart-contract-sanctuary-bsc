...
contract NFTCollection is ERC721Enumerable, Ownable {
    ...
    constructor () ERC721 ("Bronze Membership Card", "BFRND") {
        // price = initial_price;
    }

    modifier onlyMinter() {
        require(msg.sender == minter_contract_address, "!Minter"); _;
    }
    ...
    function mint(address to) public payable onlyMinter returns(bool) {
        uint256 supply = totalSupply();
    ...
    function setMinter(address _minter_contract_address) public onlyOwner {
        minter = MinterNFT(_minter_contract_address);
        minter_contract_address = _minter_contract_address;
    }
}