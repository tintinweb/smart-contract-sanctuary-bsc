...
interface IGetdoneDisputation {
    function create(uint256 merchantId, uint256 appId, uint256 contractId, address customer) external payable;
}
...
contract GetdoneEscrow is OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, AccessControlEnumerableUpgradeable, GetdoneApp{
        ...
        nonReentrant
    {
        ...
        IGetdoneDisputation(disputationAddress).create(merchantId, appId, contractId, customer);
