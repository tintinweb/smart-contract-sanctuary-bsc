...
contract MoonWalkAccessory is ERC721, Ownable {
  ...
  uint256 customTokenDecimals = 10**18;

  uint256 public priceInWEI = 1000000000000000000 wei;

  uint256 public priceInCustomToken = 30 * customTokenDecimals;

  mapping(uint => bool) public blackList;

  constructor() 
    ERC721("MoonWalk Accessory", "Accessory")
    {
      customToken = 0xCF1AeCc287027f797b99650B1E020fFa0fb0e248;
      mint(msg.sender);
    }
