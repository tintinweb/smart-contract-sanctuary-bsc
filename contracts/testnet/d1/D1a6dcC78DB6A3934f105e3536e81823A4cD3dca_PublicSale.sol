...
contract PublicSale is Vesting {
    ...
    function init(
        ...
        require(presaleStatus() != 0, "PublicSale: presale is already active!"); // QUED
    ...
    function updateTime(uint256 _startTime, uint256 _endTime)
        ...
        onlyOwner
    {
        require(presaleStatus() == 0, "PublicSale: presale is already started!");
        INFO.START_TIME = _startTime;
        INFO.END_TIME = _endTime;
    }
    ...
    function addLiquidity() external onlyOwner {
        require(STATUS.LP_GENERATION_COMPLETE, "PublicSale: pool exists!");
        ...
        // create pair
        address pair = UNI_FACTORY.createPair(
            address(_baseToken),
            address(_saleToken)
        );
