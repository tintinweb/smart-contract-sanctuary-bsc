...
contract CoinSniperToken is Context, IERC20, Ownable {
    ...
    string  private _name     = "Coin Sniper";
    ...
    event SwapWithLimitUpdated(bool enabled);
    ...
    function setSwapWithLimit(bool _swapWithLimit) external onlyOwner {
        require(swapWithLimit != _swapWithLimit, "SwapWithLimit is already set to that state");
