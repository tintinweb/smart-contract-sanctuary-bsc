...
contract AETHR_Airdrop is Ownable, Pausable {
    // ONLY ALLOW BUSD
    ...
    function claimToken() public whenNotPaused {
        ...
        ATH.transferFrom(address(this), msg.sender, amountATHClaim);
