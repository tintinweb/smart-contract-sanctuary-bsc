...
contract SmartBeComBee {
    ...
    mapping(address => mapping(uint => mapping(uint => B3))) public b3MatrixReinvest;
    mapping(address => mapping(uint => mapping(uint => B6))) public b6MatrixReinvest;
    ...
    function updB3Refer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        //block matrix B3
         ...
         b3MatrixReinvest[referrerAddress][level][inv] = users[referrerAddress].b3Matrix[level];
    ...
    function updB6ReferrerSecondLevel(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (b6.length == 2) {
         ...
         b6MatrixReinvest[referrerAddress][level][inv] = users[referrerAddress].b6Matrix[level];
    ...
    function usersB3MatrixReinvest2(address userAddress, uint8 level, uint reinvest) public view returns(address[] memory, uint, uint8) {
        return (b3MatrixReinvest[userAddress][level][reinvest].referrals,
                reinvest, 
                level);
    }
    ...
    function usersB6MatrixReinvest2(address userAddress, uint8 level, uint reinvest) public view returns(address[] memory, address[] memory, uint[] memory, uint[] memory, uint, uint8) {
        return (b6MatrixReinvest[userAddress][level][reinvest].firstLevelReferrals,
                b6MatrixReinvest[userAddress][level][reinvest].secondLevelReferrals,
                b6MatrixReinvest[userAddress][level][reinvest].typeFirstLevelReferrals,
                b6MatrixReinvest[userAddress][level][reinvest].typeSecondLevelReferrals,
                reinvest,
                level);
    }
