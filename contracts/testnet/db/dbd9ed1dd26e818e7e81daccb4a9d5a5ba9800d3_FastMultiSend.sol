...
contract FastMultiSend {
    ...
    function MultiSendToken(IERC20 token, address[] memory recipients, uint256[] memory values,bool revertOnfail) external payable collectFee  {
    ...
    function returnExtraBNB () internal {
    ...
    function MultiSendBNB(address[] memory recipients, uint256[] memory values, bool revertOnfail)  external payable collectFee {
