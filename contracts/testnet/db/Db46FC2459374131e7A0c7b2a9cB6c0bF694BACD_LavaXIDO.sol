...
contract LavaXIDO is Ownable {
    ...
    function sendStaking() external onlyOwner{
        ...
        if (_status != PoolStatus.Live && _status != PoolStatus.Pending){
            ...
            uint256 stakingTokenBalance = _rewardsToken.balanceOf(address(this));
            
            bool transferStatus = _rewardsToken.transfer(_stakingTokenDestinationAddress, stakingTokenBalance);
    ...
    function stake(uint256 amount) external{
        uint allowance = _rewardsToken.allowance(msg.sender, address(this));
        ...
        bool transferStatus = _rewardsToken.transferFrom(msg.sender, address(this), amount);
