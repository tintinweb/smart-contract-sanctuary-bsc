...
/*
    ...
    uint256[64] public _revealDates = [
                                        1657386000, 1657429200, 1657472400, 1657515600, 1657558800, 1657645200, 1657731600, 1657818000,
                                        1657904400, 1658077200, 1658250000, 1658422800, 1658595600, 1658854800, 1659114000, 1659373200,
                                        1659459600, 1659632400, 1659805200, 1659978000, 1660150800, 1660323600, 1660496400, 1660669200,
                                        1660842000, 1661014800, 1661187600, 1661360400, 1661533200, 1661706000, 1661878800, 1662051600,
                                        1662224400, 1662397200, 1662570000, 1662742800, 1662915600, 1663088400, 1663261200, 1663434000,
                                        1659459600, 1659632400, 1659805200, 1659978000, 1660150800, 1660323600, 1660496400, 1660669200,
                                        1660842000, 1661014800, 1661187600, 1661360400, 1661533200, 1661706000, 1661878800, 1662051600,
                                        1662224400, 1662397200, 1662570000, 1662742800, 1662915600, 1663088400, 1663261200, 1663434000
                                    ];
*/
    address private _developerWallet = 0x294658373ADBDBe836e2E841BB1996ceA9e56Fe3;
    ...
    constructor(address initialOwner) Ownable(initialOwner) {
        uint256 first = block.timestamp+300;
        for (uint i = 0; i < 64; i++) {
            _prices[i] = (i + 1) * 10 ** 15;
            _revealDates[i] = first + i * 6000;
        }
    }
    ...
    function claimReward() external nonReentrant {
        require((users[_msgSender()].id > 0 && users[_msgSender()].isActive), "Unauthorized request");
