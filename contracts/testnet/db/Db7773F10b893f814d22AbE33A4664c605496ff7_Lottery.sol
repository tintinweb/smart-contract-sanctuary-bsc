...
contract Lottery is RandomNumberConsumer, Ownable {
    ...
    */
    ...
    mapping(address => uint256) private amountOfWinnings;
    ...
    */
    ...
    function getAmountOfWinnings(address _user) external view returns(uint256) {
        return amountOfWinnings[_user];
    }
    ...
    */
    ...
    function transferFunds(uint256 _lvl, uint256 _index, uint256 _amount) internal onlyWithPermission {
        ...
        if (winnersExcludedFromLottery[winner] >= _lotteryDistributionDay || unregisterLockPeriod[winner] >= _lotteryDistributionDay) {
            ...
            amountOfWinnings[winner] += _amount;
    ...
    Ownable 
{
    ...
    */
    ...
    constructor(address _rw) {
        ...
        */
        ...
        uint256 preSale = 4000000000000000*10**9; // 400000000000000 EGCL ---> Pre-sale
    ...
    */
    ...
    DIVIDENDS FUNCTIONS
    */
    function addTotalDividends(uint256 _amount) internal onlyWithPermission {
    ...
    function _claimDividends(address _beneficiary) internal {
        ...
        if (dividendsTotal == 0) {
            ...
            addTotalDividends(dividendsTotal);
        }
    }
...
contract RewardsWallet is Ownable {
    ...
    */
    ...
    IBEP20 public EGC = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
    ...
    */
    ...
    function setConvertionState(bool _state) external onlyEGCL {
