...
contract metaminerengine is Context, IBEP20, Ownable {
  ...
  mapping (uint256 => uint256) public _Struct_Miner_Rarity;
  mapping (uint256 => uint256) public _Struct_Miner_Power;
  mapping (uint256 => address) public _Struct_Miner_Owner;
  mapping (uint256 => uint256) public _Struct_Miner_Age;
  mapping (uint256 => uint256) public _Struct_Miner_PickaxeLv;
  mapping (uint256 => uint256) public _Struct_Miner_PickaxeUp;
  mapping (uint256 => uint256) public _Struct_Miner_Durability;
  mapping (uint256 => uint256) public _Struct_Miner_Price;
  mapping (uint256 => uint256) public _Struct_Miner_TAX;
  mapping (uint256 => uint256) public _Struct_Miner_Layer_1;
  mapping (uint256 => uint256) public _Struct_Miner_Layer_2;
  mapping (uint256 => uint256) public _Struct_Miner_Layer_3;
  mapping (uint256 => uint256) public _Struct_Miner_Layer_4;
  ...
  function durOf(address account) external view returns (uint256) {
    return _Struct_Miner_Durability[_minerId[account]];
  }

  function powerOf(address account) external view returns (uint256) {
    return _Struct_Miner_Power[_minerId[account]];
  }

  function taxOf(address account) external view returns (uint256) {
    return _Struct_Miner_TAX[_minerId[account]];
  }

  function priceOf(address account) external view returns (uint256) {
    return _Struct_Miner_Price[_minerId[account]];
  }

  function durMaxOf(address account) external view returns (uint256) {
    return _Struct_Miner_Rarity[_minerId[account]].add(8);
  }
  ...
  function _currentblock(address account) internal view returns (uint256) {
    uint256 output = block.timestamp - _mining[account];
  ...
  function _newMiner(uint256 newRarity,address newOwner) internal {
      ...
      _Struct_Miner_Layer_1[_MinerCount] = random();
      _Struct_Miner_Layer_2[_MinerCount] = random();
      _Struct_Miner_Layer_3[_MinerCount] = random();
      _Struct_Miner_Layer_4[_MinerCount] = random();
  }
