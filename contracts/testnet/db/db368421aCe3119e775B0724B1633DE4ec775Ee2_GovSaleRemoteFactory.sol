...
contract GovSaleRemoteFactory is Initializable, UUPSUpgradeable, PausableUpgradeable, OwnableUpgradeable, AdminProxyManager, IGovSaleRemoteFactory{
    // d2 = 2 decimal
    uint128 public override operationalPercentage_d2 = 4000;
    uint128 public override marketingPercentage_d2 = 3000;
    ...
    address public override crossChainManagerRemote; // dst cross chain manager
    ...
    function init(
        ...
        address _crossChainManagerRemote, // src cross chain manager
        ...
        require(
            ...
            _crossChainManagerRemote != address(0) &&
        ...
        crossChainManagerRemote = _crossChainManagerRemote;
     ...
     */
    function config(
        address _crossChainManagerRemote,
        address _savior,
        address _keeper,
        address _operational,
        address _marketing,
...
interface IGovSaleRemote {    
    ...
    function receiveCall(bytes calldata) external;
}
