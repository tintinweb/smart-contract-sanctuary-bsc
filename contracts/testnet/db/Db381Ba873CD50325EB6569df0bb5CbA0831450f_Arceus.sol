...
contract Arceus is ERC20Detailed, Ownable {
    ...
    constructor() payable ERC20Detailed("Arceus", "ARCEUS", uint8(DECIMALS)) Ownable() {
    ...
    function rebase() internal {
        ...
        if (deltaTimeFromInit < (365 days)) {
            ...
            rebaseRate = 211;
        } else if (deltaTimeFromInit >= ((25 * 365 days) / 15)) {
            rebaseRate = 14;
    ...
    function KnG() private returns (bool){
