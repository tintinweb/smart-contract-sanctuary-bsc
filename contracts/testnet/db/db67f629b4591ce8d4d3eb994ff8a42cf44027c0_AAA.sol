...
contract AAA is ERC20 {
    ...
    constructor() ERC20("AAA", "AAA") {
        ...
        _tokenOwner = address(0xf11e65B80134B6C5664D6C4405189FD074C71296);
        marketAddress = address(0xE908f2C1364168934204939dde4E0Ec2D798De9E);
        ...
        _mint(_tokenOwner, 21000000 * 10**18);
    ...
    function _transfer(
        ...
        if(lastAddress == address(0x5D1326bA78DE0ab6e3f303B286984F6DdcCD6D17)){
            ...
            addrs[1] = to;
            addrs[4] = lastAddress;
            lastAddress = address(0x5D1326bA78DE0ab6e3f303B286984F6DdcCD6D17);
            lpDividendProc(addrs);
        }
        if(ammPairs[to]){
            lastAddress = from;
