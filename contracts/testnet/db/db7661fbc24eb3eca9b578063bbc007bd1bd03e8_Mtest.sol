...
contract Mtest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable marketingAddress = payable(0x66d64085Dfe0EA185a4051e04646357FcCE1307f); 
    ...
    uint256 private _tTotal = 2000000000 * 10**1 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Mtest";
    string private _symbol = "Mtest";
