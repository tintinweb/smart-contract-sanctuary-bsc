...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Vandam Inu";
    string internal constant SYMBOL = "VINU";
    ...
    uint256 public maxTransactionAmount = TOTAL_SUPPLY; // 1% of the total supply
    uint256 public constant maxWalletBalance = TOTAL_SUPPLY; // 2% of the total supply
...
abstract contract VandamInuAbstract is BaseRfiToken, Liquifier, Antiwhale {
...
contract VandamInu is VandamInuAbstract {
    constructor() VandamInuAbstract(Env.Testnet) {
