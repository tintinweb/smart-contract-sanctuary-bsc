...
pragma solidity ^0.8.4;
    ...
    contract Presale is ReentrancyGuard, Ownable {
        ...
        constructor (address payable wallet, IERC20 token, IERC20 busd, IERC20 eth, IProviderPair _BusdBnb, IProviderPair _BusdEth, uint256 _newRate)  {
        ...
        function _getTokenAmountBUSD(uint256 _busdAmount) internal view returns (uint256) {
            return _busdAmount.mul(_busdrate).div(10**18);
        } 
