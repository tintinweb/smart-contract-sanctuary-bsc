...
contract PandaNft is Initializable, OwnableUpgradeable, AccessControlUpgradeable, ERC721EnumerableUpgradeable {
	...
	function initialize(string memory name, string memory symbol, string memory baseURI_, address[] memory _signers) public virtual initializer {
	...
	function mint(uint256 uniqueId, uint256 value, uint8[2] memory vs, bytes32[2] memory rs, bytes32[2] memory ss) public {
		...
		hashMsg = keccak256(abi.encodePacked(this, value, msg.sender, vs[0], rs[0], ss[0]));
