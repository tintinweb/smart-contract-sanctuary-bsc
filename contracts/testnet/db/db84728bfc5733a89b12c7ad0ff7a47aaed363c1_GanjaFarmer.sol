...
contract GanjaFarmer {
    ...
    TopDeposit[] internal topDepositPool;
   ...
   // uint public startTime = 1671476400; // Monday, 19 December 2022 20:00:00 UTC https://www.unixtimestamp.com/ //mainnet
	...
	constructor(address payable _treasury) {
        ...
        plans.push(Plan(150, 18,  2 * 1e17, 45 ether, 0, 0, 0, 0, true));
        plans.push(Plan(120, 17,  2 * 1e17, 45 ether, 0, 0, 0, 0, true));
