...
contract Marketplace is Ownable {
    ...
    constructor(
        ...
        _orderIdCount.increment(); //orderId start is 1
    }
    ...
    function addOrder(
        ...
        //make sure nguoi add order nay phai la owner cua token
        require(
            nftContract.ownerOf(tokenId_) == _msgSender(),
            "NFTMarketplace: sender is not owner of token"
        );

        // //tokenid nay phai dc approve cho contract maketplace su dung
        require(
