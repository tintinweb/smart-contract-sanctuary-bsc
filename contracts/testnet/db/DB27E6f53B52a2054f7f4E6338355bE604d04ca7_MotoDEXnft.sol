...
//        limitForType[MAGIC_BOX] = 88;
        ...
        priceForType[HEALTH_PILL_5] = 500000000000000000; // $0.5
        priceForType[HEALTH_PILL_10] = 1000000000000000000; // $1
        priceForType[HEALTH_PILL_30] = 3000000000000000000; // $3
        priceForType[HEALTH_PILL_50] = 5000000000000000000; // $5
    ...
    function purchaseBatch(uint8[] memory typesNft) payable public {
    ...
    function _checkTypeHealth(uint256 tokenId) private {
