...
contract KOMODOCOPY is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x555cd056CbDB16d612f5CC6Ccd38Ef6F37cfbFCA); // Marketing Address
    ...
    string private _name = "The Last Dragon Copy";
    string private _symbol = "KMDC";
