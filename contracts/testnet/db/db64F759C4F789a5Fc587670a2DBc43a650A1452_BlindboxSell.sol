...
contract BlindboxSell is ERC1155Receiver, Ownable, ReentrancyGuard, Pausable {
        ...
        whenNotPaused
    {
        ...
        uint256 walletPurchasedBoxes = totalPurchasedBoxes[msg.sender];
        require(
            walletPurchasedBoxes + _amount <= globalBuyLimit,
        ...
        totalPurchasedPerBox[_tokenId] += 1;
        totalPurchasedBoxes[msg.sender] = walletPurchasedBoxes + _amount;
        purchasedPerBox[msg.sender][_tokenId] = walletPurchasedBox + _amount;
        // transfer fund to owner wallet
        IERC20(currency).transferFrom(msg.sender, owner(), box.price);
