...
contract WeSwap is Ownable, Lockable, Strings, SafeMath {
    ...
    function _claimFeeFromTokenLiquidity(
        ...
        ) = wsData.getUserLiquidityTokenByIndex(account, index);
    ...
    function _claimFeeFromCoinLiquidity(
        ...
        ) = wsData.getUserLiquidityCoinByTokenAddress(account, tokenAddress);
    ...
    function _withdrawLiquidityToken(
        ...
        (
            ...
            uint256 _fee2Total,
            uint256 _fee2Claimed
        ) = wsData.getUserLiquidityTokenByIndex(
                account,
