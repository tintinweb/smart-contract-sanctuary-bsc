...
contract TokenPoolRewardVault is Ownable {
    ...
    constructor(IBEP20 _rewardToken) public {
        ...
        // Infinite approve
        rewardToken.safeApprove(_msgSender(), uint256(-1));
    }
...
contract TokenPoolV1 is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;
    ...
    // The block number when EGG mining ends.
    ...
    function initialize(
        ...
        rewardVault = new TokenPoolRewardVault(_rewardToken);
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        if (block.number > lastRewardBlock && stakedTokenSupply != 0) {
            ...
            uint256 adjustedTokenPerShare =
                accTokenPerShare.add(heggReward.mul(PRECISION_FACTOR).div(stakedTokenSupply));
