...
// File: @openzeppelin/contra[email protected]/token/ERC20/ERC20Upgradeable.sol
...
contract BBKK is Initializable, ERC20Upgradeable, ERC20PermitUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize() initializer public {
        __ERC20_init("BBKKTL", "BKTL");
        __ERC20Permit_init("BBKKTL");
        __Ownable_init();
