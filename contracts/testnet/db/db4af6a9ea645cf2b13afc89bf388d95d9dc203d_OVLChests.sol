...
contract OVLChests is ERC1155PresetMinterPauser {
    uint256 public constant COMMON = 0;
    uint256 public constant RARE = 1;
    uint256 public constant EPIC = 2;

    constructor()
        ERC1155PresetMinterPauser("https://metadata.overleague.com/")
    {
        _mint(msg.sender, COMMON, 10**18, "");
        _mint(msg.sender, RARE, 10**27, "");
        _mint(msg.sender, EPIC, 10**27, "");
    }
}