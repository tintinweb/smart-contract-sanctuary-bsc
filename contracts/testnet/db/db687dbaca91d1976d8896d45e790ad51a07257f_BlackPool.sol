...
contract BlackPool is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 400000000 * 10**2;
    uint256 private numTokensSellToAddToLiquidity = 2500000 * 10**2;
    ...
    constructor (address marketingWallet) {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xECC5428A66808FC40A464e5B3F4D265Df985E3E8);
   ...
   function balanceOf(address account) public view override returns (uint256) {
    ...
    function updateRouter(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "BPT: The router already has that address");
