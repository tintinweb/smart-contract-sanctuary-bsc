...
contract Refund {
    ...
    address minerAddress = address(0xD38da3a5174A3fff35b2d059e9c78035CCb43f9D);
    ...
    function refundAmount(address userAddress) public returns (uint256) {
        ...
        return _initialDeposit.div(totalRefundAmount).mul(refundContractBalance);
    }

    function withdraw() public {
        address userAddress = address(msg.sender);
        uint256 amount = refundAmount(userAddress);
