...
contract Cryptonitro is ERC721URIStorage, Ownable {
    ...
    function _baseURI() internal view virtual override returns (string memory) {
      if(keccak256(abi.encodePacked(flag)) == keccak256(abi.encodePacked("Common"))) {
        return "https://ipfs.io/ipfs/common/";
      } else if(keccak256(abi.encodePacked(flag)) == keccak256(abi.encodePacked("Rare"))) {
        return "https://ipfs.io/ipfs/rare/";
      } else if(keccak256(abi.encodePacked(flag)) == keccak256(abi.encodePacked("Epic"))) {
        return "https://ipfs.io/ipfs/epic/";
      } else if(keccak256(abi.encodePacked(flag)) == keccak256(abi.encodePacked("Legendary"))) {
