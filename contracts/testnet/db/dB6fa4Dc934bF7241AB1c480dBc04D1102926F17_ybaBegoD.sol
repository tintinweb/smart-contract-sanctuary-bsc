...
/**
 Based on Inverted Doge - egoD hype! 

 Meet Inverted Baby Doge - ybaB egoD! 

 tg: https://t.me/ybaBegoD 
...
contract ybaBegoD  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe19D563400880EE625b01162017d4fD47481692c); 
    address payable private Wallet_Dev = payable(0xe19D563400880EE625b01162017d4fD47481692c);
    ...
    string private constant _name = "ybaB egoD"; 
    string private constant _symbol = unicode"ybaBegoD"; 
    ...
    constructor () {
        ...
        _owner = 0xe19D563400880EE625b01162017d4fD47481692c;
