...
// File: contracts/interfaces/IERC721Upgradeable.sol
...
// File: contracts/token/ERC721/extensions/IERC721EnumerableUpgradeable.sol
...
contract BlindBox is Initializable, AccessControlUpgradeable {
    ...
    function getBox(address nft) public view returns (IERC721Upgradeable, IERC20Upgradeable, uint256, uint256, uint256, uint256, bool) {
        return (
    ...
    function buy(address nft, uint256 quantity) external validBox(nft) {
        ...
        require(sellingNft.balanceOf(address(this)) >= quantity, "BlindBox: Insufficient boxes");
    ...
    function withdraw(address nft) external onlyRole(ADMIN_ROLE) {
        ...
        require(boxes[nft].listingToken.transferFrom(address(this), msg.sender, boxes[nft].listingToken.balanceOf(address(this))), "BlindBox: Failed to withdraw.");
    }
