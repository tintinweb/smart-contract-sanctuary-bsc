...
contract LotteryEditThree {
    event lotteryHistoryTotal(uint lotteryId, address indexed lastWinner, uint256 lastWinnerAmount, uint timeStamp);
    ...
    function DrawWinnerTicket() public isOperator {
        ...
        delete tickets;
        expiration = block.timestamp + duration;
        emit lotteryHistoryTotal(lotteryId, lastWinner, lastWinnerAmount, block.timestamp);
    }
