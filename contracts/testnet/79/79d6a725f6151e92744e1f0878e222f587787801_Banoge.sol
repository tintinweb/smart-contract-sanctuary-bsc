...
contract Banoge is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Banoge";
    string constant _symbol = "Banoge";
    ...
    constructor () Auth(msg.sender) {
        // FIXME: Use non testnet pancake address
        ...
        // FIXME: Use different addresses for these fees
