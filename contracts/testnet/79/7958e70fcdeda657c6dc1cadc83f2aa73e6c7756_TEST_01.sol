...
// SPDX-License-Identifier: MIT
    ...
    contract TEST_01 is Context, IERC20, Ownable {
        ...
        function _transfer(
            ...
            if (!is_Buy_Trade && !is_Impact2_Sell) {
        ...
        function Amount_Security_Managers() public view returns (uint256) {
            return Security_Managers_Count;
        }
        ...
        function Transfer_Project_Fee() public view returns (uint256) {
        ...
        function F02_Blacklist_Malicious_Account(address account) external ExceptAccounts(account) onlySecurityManager {
        ...
        function F14_Set_Fees_For_Sells_Above_Impact2(
            ...
            if (project_fee_above_impact2 == 0) {
                ...
                Sell_ReflectionsFee_Above_Impact2 = project_fee_above_impact2;
            }
        }
        ...
        function F47_Update_Amount_Loyalty_Days(address account, uint256 amount_days) external {
            require(CEO == msg.sender || Security_Manager[msg.sender] || Chief_Security_Officer == msg.sender);
            require (balanceOf(account) > 0, "Account has no tokens");
        ...
        function F48_Set_Loyalty_Days_Loss_When_Sell_Or_Move_Tokens(uint256 amount_days_loss) external {
            require(CEO == msg.sender || Security_Manager[msg.sender] || Chief_Security_Officer == msg.sender);
            Loyalty_Days_Loss_When_Sell_Or_Move_Tokens = amount_days_loss;
        }
        function F49_Set_Project_Fee_Discount_Contract(address external_contract) external onlySecurityManager {
