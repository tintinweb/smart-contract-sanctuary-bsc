...
contract KWT_TOKEN is Context, IERC20, Ownable, LockToken {
    ...
    string private _name = " KATZ Wallet Token";
    string private _symbol = "KWT";
    uint8 private _decimals = 18;

    address payable public treasury = payable(0xb65Da9F0477e2238c1c38e69b610Ea993e224828);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 tokensForLiquidity = contractTokenBalance.mul(_saleLiquidityFee).div(_saleLiquidityFee.add(_treasuryFee));
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private 
    {
        ...
        {
            setAllFees(_saleTaxFee, _saleLiquidityFee, _treasuryFee);
        }
    ...
    function setNewTreasury(address payable newWallet) external onlyOwner() {
        treasury = newWallet;
    }
    ...
    function setSaleFees(uint256 taxFee, uint256 liquidityFee, uint256 treasureFee) 
    external onlyOwner() {
        require(taxFee.add(liquidityFee).add(_treasuryFee) <= 40, "tax too high");
        _saleTaxFee = taxFee;
        _saleLiquidityFee = liquidityFee;
        _treasuryFee = treasureFee;
    }     
