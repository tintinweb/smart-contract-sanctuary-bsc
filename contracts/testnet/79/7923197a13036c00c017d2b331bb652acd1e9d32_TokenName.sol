...
contract TokenName is Context, IERC20, Ownable {
    ...
    //define the fees accodingly your benefits.
    ...
    //Define Wallet Addresses, Address can be changed afterwards
    //change Addresses to your needs. 
    address payable private _devAddress = payable(0x7BA860b3750881a4e62C36782DE0ce94d439128B);
    address payable private _mktAddress = payable(0x7BA860b3750881a4e62C36782DE0ce94d439128B);
    ...
    function setUpdateDevAddress(address payable devAdress) public onlyOwner {
        ...
        function setUpdateMktAddress(address payable mktAdress) public onlyOwner {
        emit setDevAddress(_mktAddress, mktAdress);	
        _mktAddress = mktAdress;
        _isExcludedFromFee[_mktAddress] = true;
    }
