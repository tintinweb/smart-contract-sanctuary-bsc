...
//toDo change add minutes to add months
    ...
    */
    ...
    function pendingReward(uint256 _depositId, address _user) public view returns (uint256) {
        ...
        uint256 currentBlockNumber = currentBlock(_user);
        if (currentBlockNumber > pool.lastRewardBlock && sharesTotal != 0) {
            uint256 _multiplier = currentBlockNumber - pool.lastRewardBlock;
    ...
    function claimAndReinvest(bool reinvest,uint8 periodId) public {
     ...
     /*
     * @notice Get Actual Block Number
     */
