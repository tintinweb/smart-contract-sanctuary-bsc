...
contract ForTubeGovernor is Initializable, ForTubeGovernorStorage, ForTubeGovernorEvents {
    ...
    function cancel(uint proposalId) external {
        require(state(proposalId) != ProposalState.Executed && state(proposalId) != ProposalState.Canceled, "ForTubeGovernor::cancel: cannot cancel executed or canneled proposal");
