...
contract TESTStaking is Ownable{
    ...
    constructor(IERC20 _TT){
        TT = _TT;
    }
    
    function geteAmount(address addr) public view returns (uint256) {
    ...
    function deposit(uint256 amount) external {
        ...
        TT.transferFrom(msg.sender, address(this), amount);
    ...
    function claim(uint256 amount) external {
        require(amount != 0 , "amount must not 0");
        require(_stakers[msg.sender].amount - amount >= 0, "There is no amount to claim");
