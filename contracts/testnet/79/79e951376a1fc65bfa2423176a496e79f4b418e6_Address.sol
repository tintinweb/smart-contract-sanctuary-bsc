...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x5b6797408dD3b8B13B8B79b370EA267f2f4E14DE;
...
contract mohamadi is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x5b6797408dD3b8B13B8B79b370EA267f2f4E14DE;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "mohamadi";
    string private _symbol = "nhd";
