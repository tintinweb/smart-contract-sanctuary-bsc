...
contract CSSJQ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "CSSJQ";
    string private _symbol = "CSSJQ";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7cA2479d1FEd757530B4F3230daa8710053Aa0b8); // Marketing Address
    address payable public teamWalletAddress = payable(0x3A82a84EcF051c9b825E6f33017CD786D336d226); // Team Address
