...
contract Qube{
	...
	//address erctoken = 0xEbc449F380B7E7150Dd422D0A2647F15f3063c3E; /** BUSD Testnet **/
    ...
    uint256 public MARKET_QUBIC_DIVISOR = 2; // 20%
    uint256 public MARKET_QUBIC_DIVISOR_SELL = 1; // 50%

    uint256 public MIN_INVEST_LIMIT = 10 * 1e18; /** 10 BUSD  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 20000 * 1e18; /** 20000 BUSD  **/

	uint256 public COMPOUND_BONUS = 30; /** 0.5% **/
    ...
    function buyQubic(address ref, uint256 amount) public{
        ...
        uint256 qubicPayout = payFees(amount); /** set to 0 **/
