...
contract PUTINU is Context, IBEP20, Ownable {
    ...
    string public constant name     = "PUTINU";
    string public constant symbol   = "PUTINU";
    uint8  public constant decimals = 18;
    
    // transfer fee
    uint256 public _taxFeeTransfer       = 300;
    uint256 public _liquidityFeeTransfer = 300; 
    uint256 public _marketingFeeTransfer = 400; 

    // buy fee
    uint256 public _taxFeeBuy       = 300; 
    uint256 public _liquidityFeeBuy = 300; 
    uint256 public _marketingFeeBuy = 400; 
