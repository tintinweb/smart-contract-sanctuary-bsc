...
contract AngelNFT is ERC721AQueryable, Ownable, ReentrancyGuard, DefaultOperatorFilterer {
  ...
  uint256 public currentTempSupplyCap = 1000;
  ...
  function withdraw() public onlyOwner nonReentrant {
    // This will pay the DEV 1% of the initial sale.
    // =============================================================================
    (bool hs, ) = payable(0x691Cf5D1C298a752F2F9f2aa7a33b3ebe11a4019).call{value: address(this).balance * 1 / 100}('');
    require(hs);
    // =============================================================================
