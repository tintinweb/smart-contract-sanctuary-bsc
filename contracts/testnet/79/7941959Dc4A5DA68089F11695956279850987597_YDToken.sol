...
interface IPresale {
 ...
 contract YDToken is IERC20, Ownable {
    ...
    function swapTokenForFund() private lockTheSwap {
            ...
            path[1] = _usdt;
         //池子超过最大之行量
        if (tokenBalance >= 10 * 10 ** _decimals) {
            ...
            USDT.transferFrom(TokenDistributor,_YXAddress,usdtBalance);
    }
    }
