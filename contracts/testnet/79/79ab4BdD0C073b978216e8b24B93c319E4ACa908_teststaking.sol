...
// File: contracts/teststaking.sol
...
contract teststaking is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0xfbFb84369585881d47feDd257f55646aC89251ee); // token contract address
        ...
        RTOKEN.approve(address(this), 1000000000000000000000000000); // amount of tokens you want to send to contracts for rewarad in wei
    }
