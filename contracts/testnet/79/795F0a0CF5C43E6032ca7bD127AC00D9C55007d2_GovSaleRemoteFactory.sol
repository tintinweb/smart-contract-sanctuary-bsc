...
contract GovSaleRemoteFactory is
    ...
    address public override saleGatewayRemote; // dst cross chain manager
    ...
    function init(
        ...
        address _saleGatewayRemote, // src cross chain manager
        ...
        saleGatewayRemote = _saleGatewayRemote;
