...
//https://t.me/MetaFotballGame

//http://www.metafootballgame.link
...
contract MetaFootballToken is IBEP20, Auth { using SafeMath for uint256;

    address WBNB = 0xBdf1a2e17DECb2aAC725F0A1C8C4E2205E70719C;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81; // TESTNET

    string constant _name = "MetaFootball Token";
    string constant _symbol = "MFL";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 25) / 100; 
    uint256 public _maxWalletSize = (_totalSupply * 25) / 100; 
    ...
    address public devFeeReceiver = 0x29936db3dB24C0414bD560D00cA89aA0e17c7b1D;
    address public buybackFeeReceiver = 0x29936db3dB24C0414bD560D00cA89aA0e17c7b1D;
