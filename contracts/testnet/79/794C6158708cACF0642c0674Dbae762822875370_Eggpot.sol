...
contract Eggpot is ERC20, Ownable {
  ...
  uint256 public numberOfBuysForJackpot = 2;
  ...
  constructor() payable ERC20('Eggpot', 'EGGPOT') {
    ...
    operationsAddress = address(0x7CC75c12e39E36558A13E5DCd7de9835Ac7714de);
    ...
    swapTokensAtAmount = (totalSupply * 20) / 10000000; // 0.025%
    ...
    originalSellOperationsFee = 500;
    originalSellLiquidityFee = 500;
