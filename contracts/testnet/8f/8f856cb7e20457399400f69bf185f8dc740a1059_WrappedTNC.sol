...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        require(maxSupply >= (_totalSupply + amount), "ERC20: minting amount exceeding max supply");
    ...
    function _updateMaxSupply(uint256 newMaxSupplyAmount) internal virtual {
        require(newMaxSupplyAmount >= maxSupply, "ERC20: Max supply amount greater then total supply");
...
contract WrappedTNC is Pausable, Ownable, Burnable, Lockable, ERC20 {
     ...
     */
    function updateMaxSupply(address account) public onlyOwner whenNotPaused {
        _addBurner(account);
    }
