...
contract GulfStacking is ReentrancyGuard, Ownable {
    ...
    function renewPackage(uint32 newPackage) public {
        ...
        require(stackingUserDeatil[msg.sender].status = true, "You can not renew your package because your current package is not finish");
    ...
    function approvedStackingRequest(address walletAddress) external onlyOwner{
        require(stackingUserDeatil[walletAddress].amountStaked > 0, "You do not have any Stacked tokens for withdraw");
