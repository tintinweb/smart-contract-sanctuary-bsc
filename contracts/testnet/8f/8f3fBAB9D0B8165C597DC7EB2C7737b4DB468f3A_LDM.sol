...
contract LDM is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'LDXPAY METAVERSE TOKEN';
    string  private constant _SYMBOL = 'LDM';
    ...
    uint256 private constant _MAX_TX_SIZE = 900000 * _DECIMALFACTOR;
