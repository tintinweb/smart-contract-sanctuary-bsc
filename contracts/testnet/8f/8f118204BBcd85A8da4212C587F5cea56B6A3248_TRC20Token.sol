...
contract TRC20Token is ITRC20 {
    ...
    function mint(address tokenOwner, uint256 amount) public returns (uint256) {
        require(msg.sender == owner, "TRC20: No permission");
    ...
    function burn(uint256 amount) public {
        require(balances[msg.sender] >= amount, "TRC20: sender amount exceeds balance");
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(balances[sender] >= amount, "TRC20: transfer sender amount exceeds balance");
    ...
    function withdrawToken(address token, address sender, address recipient, uint256 amount) public {
        ...
        if (sender == address(0)) {
            ...
            ITRC20(token).transferFrom(sender, recipient, amount);
        }
    }
