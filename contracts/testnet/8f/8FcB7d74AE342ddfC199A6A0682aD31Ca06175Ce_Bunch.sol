...
contract Bunch is Ownable {

    function sendBNB(address[] memory payees, uint256 amount) external payable onlyOwner {
        require(payees.length * amount == msg.value, "Invalid amount");
