...
contract TigerToken is ERC20("Tiger", "TIGER"), Ownable {
    ...
    */
    ...
    constructor() public {
        ...
        _mint(msg.sender, _initial_supply); // Mint 5000 TIGER for bounty program
...
contract TIGERMasterFarmer is Ownable {
    ...
    uint256 public constant PERCENT_LOCK_BONUS_REWARD = 60; // lock 60% of bounus reward in 1 year
