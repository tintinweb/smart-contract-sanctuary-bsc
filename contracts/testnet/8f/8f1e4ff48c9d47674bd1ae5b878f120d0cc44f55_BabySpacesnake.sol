...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x0c00ab6480966649c72A9251D2CC5562523a1E1b; // owner address
...
contract BabySpacesnake is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0c00ab6480966649c72A9251D2CC5562523a1E1b); // Marketing Address
    address payable public teamWalletAddress = payable(0x0c00ab6480966649c72A9251D2CC5562523a1E1b); // Team Address
