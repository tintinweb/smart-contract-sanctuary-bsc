...
contract CollieContext {
    ...
    struct Pool {
        ...
        uint256 currentNumberOfWallets;
    }
...
contract CollieSTAKE is CollieContext, Ownable, ReentrancyGuard {
    ...
    constructor() {
        ...
        pools[1]  = Pool(30,  1000, 1,  0, 10000000000000000000000, 3, 0, 900000000000000000000000000000, 100, 0);
        pools[2]  = Pool(60,  1500, 2,  0, 10000000000000000000000, 3, 0, 900000000000000000000000000000, 100, 0);
        pools[3]  = Pool(90,  2000, 3,  0, 10000000000000000000000, 3, 0, 900000000000000000000000000000, 100, 0);
        pools[4]  = Pool(120, 2500, 4,  0, 10000000000000000000000, 3, 0, 900000000000000000000000000000, 100, 0);
        pools[5]  = Pool(150, 3000, 5,  0, 10000000000000000000000, 3, 0, 900000000000000000000000000000, 100, 0);
        pools[6]  = Pool(180, 3500, 6,  0, 10000000000000000000000, 3, 0, 900000000000000000000000000000, 100, 0);
        pools[7]  = Pool(210, 4000, 7,  0, 10000000000000000000000, 3, 0, 900000000000000000000000000000, 100, 0);
        pools[8]  = Pool(240, 4500, 8,  0, 10000000000000000000000, 3, 0, 900000000000000000000000000000, 100, 0);
        pools[9]  = Pool(270, 5000, 9,  0, 10000000000000000000000, 3, 0, 900000000000000000000000000000, 100, 0);
        pools[10] = Pool(300, 5500, 10, 0, 10000000000000000000000, 3, 0, 900000000000000000000000000000, 100, 0);
        pools[11] = Pool(330, 6000, 11, 0, 10000000000000000000000, 3, 0, 900000000000000000000000000000, 100, 0);
        pools[12] = Pool(365, 6500, 12, 0, 10000000000000000000000, 3, 0, 900000000000000000000000000000, 100, 0);
    }
    ...
    function _stakeTokens(uint256 _amount, uint256 _tier) internal {
        ...
        uint256 claimcurrentReward = checkReward(_msgSender(), _tier);

        require(pool.currentNumberOfWallets < pool.maxAllowedWallets, "Already Staked");
