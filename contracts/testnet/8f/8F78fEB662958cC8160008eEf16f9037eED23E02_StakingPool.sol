...
contract StakingPool is Upgradable {
    ...
    */
    function restakeToken(string[] memory strs) external poolExist(strs[0]) notBlocked payable {
        ...
        totalStaked += addingAmount;
        totalTokenStaking += addingAmount;
    ...
    */
    ...
    function setTotalTokenStaking(uint256 amount) public onlyController {
        totalTokenStaking = amount;
    }
    ...
    function viewTotalTokenStaking() external view returns(uint256) {
        return totalTokenStaking;
    }
...
contract Upgradable is Ownable {
    ...
    uint256 public totalTokenStaking; //total token stake in contract at the momment
