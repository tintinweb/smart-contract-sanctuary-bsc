...
contract TRC20 is ITRC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 value) internal {
        ...
        require(from != to, "Sender and Receiver cannot be same");
        require(!frozenAccount[msg.sender], "Account is freeze");
...
contract ABCD is TRC20 {
    constructor() public TRC20 ("ABCD COIN", "ABCD", 9) {
        _mint(msg.sender, 540000000 * (10 ** uint256(9)));
    }
}