...
contract OriginationController is Context, IOriginationController, EIP712 {
    ...
    bytes32 private immutable _LOAN_TERMS_TYPEHASH =
        keccak256(
            ...
            "LoanTerms(uint256 durationSecs,uint256 principal,uint256 interest,address collateralTokenAddress,uint256 collateralTokenId,address payableCurrency,uint256 deadline)"
        );
    ...
    function initializeLoan(
        ...
        bytes32 loanHash = keccak256(
            abi.encode(
                ...
                loanTerms.principal,
                loanTerms.interest,
                loanTerms.collateralTokenAddress,
