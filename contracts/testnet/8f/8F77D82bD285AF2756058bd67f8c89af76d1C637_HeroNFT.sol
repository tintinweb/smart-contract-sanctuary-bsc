...
contract HeroNFT is BaseNFT {
  ...
  function reachMaxProfit(uint _tokenId) public view returns (bool) {
    ...
    return hero.totalProfited >= _getMaxProfitable(hero);
  }
  ...
  function _beforeTokenTransfer(
    ...
    if (_to == address(0)) {
      ...
      energyManager.updatePoint(_to, int(heroes[_tokenId].level));
    ...
    if (_from == address(0)) {
      ...
      energyManager.updatePoint(_from, int(heroes[_tokenId].level) * -1);
  ...
  function _levelUp(uint _tokenId) private {
    ...
    emit LevelUp(_tokenId, heroes[_tokenId].level);
  }

  function _initData() private {
    countId = 18;

    mappingHeroRace[1] = 'Human';
    mappingHeroRace[2] = 'Human';
    mappingHeroRace[3] = 'Human';
    mappingHeroRace[4] = 'Human';
    mappingHeroRace[5] = 'Demon';
    mappingHeroRace[6] = 'Demon';
    mappingHeroRace[7] = 'Demon';
    mappingHeroRace[8] = 'Beast';
    mappingHeroRace[9] = 'Beast';
    mappingHeroRace[10] = 'Beast';
//    mappingHeroRace[11] = 'Beast';
//    mappingHeroRace[12] = 'Beast';
//    mappingHeroRace[13] = 'Beast';
//    mappingHeroRace[14] = 'Keen';
//    mappingHeroRace[15] = 'Orge';
//    mappingHeroRace[16] = 'Elf';
//    mappingHeroRace[17] = 'Dragon';
//    mappingHeroRace[18] = 'Omni';

    mappingHeroClass[1] = 'Hunter';
    mappingHeroClass[2] = 'Priest';
    mappingHeroClass[3] = 'Warlock';
    mappingHeroClass[4] = 'Assassin';
    mappingHeroClass[5] = 'Assassin';
    mappingHeroClass[6] = 'Assassin';
    mappingHeroClass[7] = 'Warlock';
    mappingHeroClass[8] = 'Warrior';
    mappingHeroClass[9] = 'Chemist';
    mappingHeroClass[10] = 'Warrior';
//    mappingHeroClass[11] = 'Warrior';
//    mappingHeroClass[12] = 'Hunter';
//    mappingHeroClass[13] = 'Warrior';
//    mappingHeroClass[14] = 'Mech';
//    mappingHeroClass[15] = 'Warrior';
//    mappingHeroClass[16] = 'Mage';
//    mappingHeroClass[17] = 'Mage';
//    mappingHeroClass[18] = 'Mage';

    mappingHeroName[1] = 'Eira';
    mappingHeroName[2] = 'Aedus';
    mappingHeroName[3] = 'Malhela';
    mappingHeroName[4] = 'Keisha';
    mappingHeroName[5] = 'Cyril';
    mappingHeroName[6] = 'Ciara';
    mappingHeroName[7] = 'Grimm';
    mappingHeroName[8] = 'Orson';
    mappingHeroName[9] = 'Zel';
    mappingHeroName[10] = 'Aprum';
//    mappingHeroName[11] = 'Octonus';
//    mappingHeroName[12] = 'Amaltheus';
//    mappingHeroName[13] = 'Tigris';
//    mappingHeroName[14] = 'Farrer';
//    mappingHeroName[15] = 'Kekor';
//    mappingHeroName[16] = 'Alva';
//    mappingHeroName[17] = 'Kyla';
//    mappingHeroName[18] = 'Gideon';
    for (uint16 i = 1; i <= 10; i++) {
      heroNames[mappingHeroName[i].toBytes24()] = true;
    }
  }
  ...
  function syncExistHeroes(uint16[] calldata _classIds) external onlyMainAdmin {
    for (uint i = 0; i < _classIds.length; i++) {
      Hero storage hero = heroes[_classIds[i]];
  ...
  function updateTotalProfited(uint _tokenId, uint _totalProfited) onlyMintAdmin external {
    require(!reachMaxProfit(_tokenId), "400");
    Hero storage hero = heroes[_tokenId];
    uint maxProfitable = _getMaxProfitable(hero);
    if (maxProfitable >= _totalProfited) {
      _totalProfited = maxProfitable;
    }
    hero.totalProfited = _totalProfited;
    emit TotalProfitedUpdated(_tokenId, _totalProfited);
  }
  ...
  function updateHeroInfo(uint _tokenId, uint8 _level, uint32 _experience, uint[3] calldata _skills) external onlyMainAdmin {
  ...
  function _getMaxProfitable(Hero storage _hero) private view returns (uint) {
    return _hero.ownPrice * profitRate / 100;
  }
}
