...
contract Staking {
    ...
    uint256[2] public Bonus = [153,460];
    uint256 public unStakePercentage = 700;
    uint256[2] public totalStakedPerPlan;
    uint256[2] public totalStakersPerPlan;
    ...
    constructor() {
        owner = payable(0x74C1F2bEA2686c38933Ddf5D7BDEF243455b6D4A);
        stakeToken = IERC20(0xFD5821f1E21aA6B812FE4887b872Bda531aD8258);
        percentDivider = 1000;
    }
    ...
    function unstake(uint256 index) public {
        ...
        stakeToken.transfer(
            msg.sender,
            (stakersRecord[msg.sender][index].amount * unStakePercentage / percentDivider)
        );
    ...
    function SetUnStakePercentage(
        uint256 _percentage
    ) external onlyowner {
        require(unStakePercentage <= percentDivider , "Percentage is more than 100%");
        unStakePercentage = _percentage;
    }
