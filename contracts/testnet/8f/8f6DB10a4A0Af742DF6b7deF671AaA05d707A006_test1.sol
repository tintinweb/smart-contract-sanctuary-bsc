...
contract test1 is Context,IERC20, Ownable{
    ...
    address _owner;
    address payable public marketingAddress = payable(0xc4C9249b4572C9D9D3b88052773682C853042B11);
    address payable public prizePoolAddress = payable(0xc4C9249b4572C9D9D3b88052773682C853042B11);
    ...
    uint256 private _totalSupply = 500000 * 10**4 * 10**18; //5B supply
    uint256 public requiredTokensToSwap = currentThreshold * 10 ** 5 * 10 ** 18; //threshold of around 1000000 0.02% tokens 
