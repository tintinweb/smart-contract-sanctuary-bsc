...
_Mintpaused = false;
     ...
     */
    function _requireRedeemPaused() public view virtual returns (bool) {
     ...
     */
    function _requireNotRedeemPaused() internal view virtual {
        require(!_requireRedeemPaused(), "Pausable: paused");
    }
     ...
     * - The contract must not be paused.
     */
    function _redeempause() internal virtual whenRedeemNotPaused {
        _redeempaused = true;
     ...
     * - The contract must be paused.
     */
    function _redeemunpause() internal virtual whenRedeemPaused {
        _redeempaused = false;
        emit RedeemUnpaused(msg.sender);
    }

function Redeempaused() public view virtual returns (bool) {
        return _Mintpaused;
    }
    /**
...
contract CryptoPeso is IERC20, Ownable, Pausable,ReentrancyGuard {
    ...
    function toggleRedeemPause()public onlyOwner{
        if(Redeempaused()){
            _redeemunpause();
        }
        else{
    ...
    */
    ...
    function _sell(address seller, uint256 tokenAmount, address recipient) internal whenRedeemNotPaused returns (uint256) {
