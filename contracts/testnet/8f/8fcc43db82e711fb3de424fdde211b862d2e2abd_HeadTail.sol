...
struct betdata{
    ...
    function bet_data(uint256 bet_amount, address payable player1_address, string memory player1_coin_side, address payable player2_address, string memory player2_coin_side, string memory result) public payable{
        betCount += 1;
	    // address payable Winner;
		uint256 admin_amount;
		uint256 winner_amount;
