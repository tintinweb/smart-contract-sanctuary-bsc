...
abstract contract ZapBaseV2_1 is Ownable {
    ...
    address internal constant ZapperAdmin =
        0x59Df59559f30dCd88dC089E1Bc00ee9Fe1f61ACC; //QUI METTERE INDIRIZZO DAO MULTISG
...
contract Wonderland_ZapIn_V1 is ZapInBaseV3_1 {
    ...
    IUniswapV2Factory private constant joeFactory =
        IUniswapV2Factory(0x6725F303b657a9451d8BA641348b6761A6CC7a17); //PANCAKE FACTORY

    IUniswapV2Router02 private constant joeRouter =
        IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);//PANCAKE ROUTER
