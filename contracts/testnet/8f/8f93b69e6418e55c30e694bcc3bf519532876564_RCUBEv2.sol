...
contract RCUBEv2 is ERC20Detailed, Ownable {
    ...
    address public liquidityReceiver = 0x2bA3131eF09aDAeB561b50fc57d544b02Ad99DdE;
    address public treasuryReceiver = 0x189227101ad63E329BD51B0a84Fe34c445b79aeC;
    address public riskFreeValueReceiver = 0x3D510CF3d5e4f11Ac7c2559d7C09217328eedfA7;
    ...
    constructor() ERC20Detailed("RCUBE2.0", "RCUBE2.0", uint8(DECIMALS)) {
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        pair = IDEXFactory(router.factory()).createPair(address(this), router.WETH());
        address pairusdt = IDEXFactory(router.factory()).createPair(address(this), usdtToken);
