...
contract Pool is Ownable, Pausable, ReentrancyGuard{
    ...
    function recoverToken(address _token, uint256 _amount) external onlyAdmin nonReentrant whenNotPaused{
        IERC20(_token).transfer(address(msg.sender), _amount);
        emit TokenRecovery(_token, _amount);
    }


    function transferToken(address _token, address _to , uint256 _amount) external onlyAdmin nonReentrant whenNotPaused {
