...
abstract contract ASKToken is IERC20, Ownable {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    address public fundAddress = address(0xb742Cc7580C94bb9DFEF8e325C2c08Df6d6982e0);
    string private _name = "ASK";
    ...
    uint256 private _tTotal = 3888 * 10 ** _decimals;
    uint256 public maxWalletAmount = 30 * 10 ** _decimals;

    ISwapRouter public _swapRouter;
    address public _usdt = address(0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb);
...
contract Token is ASKToken {
    constructor() ASKToken(){}
}