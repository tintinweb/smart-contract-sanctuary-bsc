...
contract Rematic is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function __Rematic_init_unchained(address token1DividendTrackerAddr, address token2DividendTrackerAddr) internal onlyInitializing {
    	...
    	token1DividendTracker = IToken1DividendTracker(payable(token1DividendTrackerAddr));
    	token2DividendTracker = IToken2DividendTracker(payable(token2DividendTrackerAddr));
    ...
    function updatetoken1DividendTracker(address newAddress) external onlyOwner {
        ...
        IToken1DividendTracker newtoken1DividendTracker = IToken1DividendTracker(payable(newAddress));
    ...
    function updatetoken2DividendTracker(address newAddress) external onlyOwner {
       ...
       IToken2DividendTracker newtoken2DividendTracker = IToken2DividendTracker(payable(newAddress));
