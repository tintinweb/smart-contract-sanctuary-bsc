...
contract Contract is Context, IERC20 { 
    ...
    */
    ...
    To protect investors, buy and sell fees have a hard-coded limit of 15% 
    ...
    */
    ...
    function Contract_SetUp_03__Wallet_Limits(
        ...
        require(Max_Tokens_Per_Transaction >= _tTotal / 200 / 10**_decimals, "E04");
        require(Max_Total_Tokens_Per_Wallet >= _tTotal / 200 / 10**_decimals, "E05");
    ...
    */ 
    ...
    ---------------------------------------
    BLACKLIST BOTS - FIRST 10 MINUTES ONLY!
    ---------------------------------------

    You have the ability to blacklist wallets for the first 10 minutes only.
    This provides plenty of time after launch to detect and remove any bots. 

    To blacklist, enter a wallet address and set to true. 
    To remove blacklist, enter a wallet address and set to false.

    If you have previously blacklisted a wallet, the wallet can be un-blacklisted at any time.
    ...
    */
    ...
    function Launch_Settings_01__Blacklist_Bots(
        ...
        // Buyer Protection - Blacklisting can only be done within the first 10 minutes
        if (true_or_false){require(block.timestamp <= LaunchTime + (60*10), "E08");}
