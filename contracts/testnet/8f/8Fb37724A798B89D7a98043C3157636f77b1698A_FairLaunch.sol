...
contract FairLaunch is Ownable, ReentrancyGuard {
    ...
    function buyToken(address refaddr, uint ln) public payable {
        ...
        emit TokensPurchased(beneficiary, weiAmount, totalRaised,  totalRaised / sellToken.balanceOf(address(this)));
    }

    function getBuyInfo(address account) public view returns (uint256 raised, UserBuy memory) {
