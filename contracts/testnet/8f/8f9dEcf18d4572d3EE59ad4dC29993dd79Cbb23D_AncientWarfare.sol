...
contract AncientWarfare is ERC20, Ownable {
    uint256 public buyFee  = 5;
    uint256 public sellFee = 5;
    
    uint256 public devShare       = 30;
    uint256 public marketingShare = 70;

    address public marketingWallet = 0x29224fC97BcB2Df0ceCB56BC1E7b579708fFa3ea;
    address public devWallet       = 0x43BCc53C9C6F034Cf6F3d3E736e0230133C626D4;
    ...
    constructor () ERC20("Ancient Warfare", "ACW") 
    {   
    ...
    function updateFeeShares(uint256 _marketingFeeShare, uint256 _liquidityFeeShare) external onlyOwner {
        ...
        devShare = _liquidityFeeShare;
        emit FeeSharesUpdated(marketingShare, devShare);
    }
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if(fees > 0) {
                uint256 marketingTokens = fees * marketingShare / 100;
                uint256 devTokens       = fees * devShare / 100;
