...
contract PAMP is ERC20, ReentrancyGuard, Ownable {
    ...
    uint256 public claimCooldown = 3600; // TODO

    bool public takeFees = true;
    bool public taxETHOnly = true;
    ...
    address public treasuryContractAddress = 0x0000000000000000000000000000000000000000;
    ...
    constructor() ERC20("SHEEP", "SHEEP") {
        ...
        dividendsHoldersInfo[owner()].claimable = 0;
        dividendsHoldersInfo[owner()].cooldown = 0;
    ...
    function updateWhales(address _address, bool _value) external onlyOwner {
        whales[_address] = _value;
    }
    ...
    function updateTaxETHOnly (bool _value) external onlyOwner {
        taxETHOnly = _value;
    }
    ...
    function claim() external nonReentrant {
        ...
        super._transfer(address(rewardsContractAddress), msg.sender, claimableDividends);
    }
