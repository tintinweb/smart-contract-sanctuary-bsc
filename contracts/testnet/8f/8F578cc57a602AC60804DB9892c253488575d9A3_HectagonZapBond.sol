...
contract HectagonZapBond is Ownable {
    ...
    IUniswapV2Router private constant pancakeswapRouter = IUniswapV2Router(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    function _fillQuote(
        ...
        _approveToken(_fromTokenAddress, address(pancakeswapRouter), _amount);
