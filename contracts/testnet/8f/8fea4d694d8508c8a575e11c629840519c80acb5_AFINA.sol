...
contract AFINA is ERC20, Ownable, SafeToken {
    using SafeMath for uint256;
   ...
   function setMarketingWallet(address payable _newMarketingWallet) public onlyOwner {
    ...
    constructor() ERC20("AFINA BSC", "AFINA") {
        ...
        marketingWallet = payable(0x1C1bBafD23140b4B32b593a7439f63bAfC1124e8);
        DAOWallet = payable(0x1C1bBafD23140b4B32b593a7439f63bAfC1124e8);
