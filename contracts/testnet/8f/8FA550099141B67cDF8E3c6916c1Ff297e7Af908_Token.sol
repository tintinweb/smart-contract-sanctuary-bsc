...
contract Token is IERC20, Ownable {
    ...
    // token data
    string private constant _name = "Token 2";
    string private constant _symbol = "TKN 2";
    ...
    constructor() {
        ...
        // permissions
        permissions[0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3]
    ...
    function _transferFrom(
        ...
        uint256 finalAmount = balanceOf(recipient).add(amount);
        require(
            finalAmount <= _getMaxHolding(recipient),
