...
contract Shira is Context, IERC20, Ownable {
    ...
    function _getValues(uint256 tAmount, bool[2] memory isSale_isSniper) public view returns (uint256, uint256, uint256, uint256, uint256, uint256[4] memory) {
    ...
    function _getTValues(uint256 tAmount, bool[2] memory isSale_isSniper) public view returns (uint256, uint256, uint256[4] memory) { //Contains 3 values!
