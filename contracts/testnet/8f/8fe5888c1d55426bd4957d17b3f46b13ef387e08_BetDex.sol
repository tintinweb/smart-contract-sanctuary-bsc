...
//        uint256 amount,
    ...
    function unlockRoomReverse(bytes32 roomId)
        internal
    {
        require(
            rooms[roomId].roomReverseMutex,
...
//    }
    ...
    function withdrawReserves(
        ...
        uint256 roomBalance = roomAvailableReserve(roomId, contractAddress);
    ...
    function roomAvailableReserve(bytes32 roomId, address contractAddress)
        public
        view
        returns (uint256)
    {
...
//        );
        ...
        require(
            roomAvailableReserve(matchInfo.roomId, contractAddress) >=
...
//        checkBetDayLimit(_amount, matchInfo.roomId);
        ...
        lockUserBalance(matchInfo.roomId, bettorAddress);
        ...
        unlockUserBalance(matchInfo.roomId, bettorAddress);
        if (transferAmount > 0) {
...
//        myBet.amount = _amount;
        ...
        lockRoomReverse(matchInfo.roomId);
...
//        rooms[matchInfo.roomId].lastBettingTime = block.timestamp;
        unlockRoomReverse(matchInfo.roomId);
