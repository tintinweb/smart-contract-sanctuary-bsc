...
contract BSCGiveGame {
    ...
    function getTablesInfo() public view returns(uint256[] memory, uint256[] memory, uint256[] memory, uint256[] memory, uint256[] memory){
        uint256[] memory thValue = new uint256[](tables.length-1);
        uint256[] memory maxProfit = new uint256[](tables.length-1);
        uint256[] memory refProfit = new uint256[](tables.length-1);
        uint256[] memory randomProfit = new uint256[](tables.length-1);
        uint256[] memory randomRefProfit = new uint256[](tables.length-1);
