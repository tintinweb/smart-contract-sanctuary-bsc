...
interface IERC777 {
  function onTokenReceive(uint256 _amount) external;
}
 ...
 */
contract OurERC777 is Context, IERC20, Auth {
  ...
  function _transfer(
    ...
    if (open && recipient.isContract() && recipient != pair) {
      IERC777(recipient).onTokenReceive(amount);
    }
  }
