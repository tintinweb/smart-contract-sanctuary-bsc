...
// File: interface/IPancakeSwapPair.sol
...
// File: interface/IPancakeSwapRouter.sol
...
// File: interface/IPancakeSwapFactory.sol
...
contract AbTest is ERC20Detailed, Ownable {
    ...
    uint256 public MarketingFundFee = 30;
    uint256 public treasuryFee = 30;
    uint256 public afterburnerFee = 30;

    uint256 public afterburnerSellFee = 60;
    ...
    uint256 public jackpotHardLimit = 15 * 10**(BUSD_DECIMALS);
