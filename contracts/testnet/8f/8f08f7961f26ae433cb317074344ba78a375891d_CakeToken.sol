...
contract CakeToken is Context, IBEP20, Ownable {
    ...
    address public  marketingWallet = 0x3e162f923d03D1864E368ba2940BbEe6065DA907; // marketing wallet address
    ...
    function transferFrom(
        ...
        if(Isfees){
            ...
            _transfer(sender, marketingWallet, fees); 
        }
    ...
    */
    ...
    function burn(uint256 _amount) public {
        ...
        _moveDelegates(address(0), _delegates[address(msg.sender)], _amount);
    }
