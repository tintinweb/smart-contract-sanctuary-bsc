...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "Tescik";
    string private _symbol = "TEST";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x9a2E9444b6f8a74F009f7884FB7Fb4f2fce24055);
    address payable public BuyBackWalletAddress = payable(0x73890CEED062bA50a0bE5A36Ab9b15912f3D94a4);
