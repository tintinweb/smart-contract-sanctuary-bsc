...
contract SAFESeptember11 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SAFE 11/9";
    string constant _symbol = "SAFE 11/9";
    ...
    uint256 internal sellMarketingFee = 3;

    uint256 internal feeDenominator = 100;

    address public autoLiquidityReceiver;
    address public MarketingFeeReceiver =
        0x8847433b3ae32728A283b4E95645ead49faac606;
    ...
    constructor() Auth(address(0x8847433b3ae32728A283b4E95645ead49faac606)) {
        ...
        isFeeExempt[address(0x8847433b3ae32728A283b4E95645ead49faac606)] = true;
        isTxLimitExempt[address(0x8847433b3ae32728A283b4E95645ead49faac606)] = true;
        isDividendExempt[pair] = true;
        isDividendExempt[address(this)] = true;
        isDividendExempt[DEAD] = true;
        autoLiquidityReceiver = address(0x8847433b3ae32728A283b4E95645ead49faac606);
        isWalletHoldingLimitExempt[pair] = true;
        isWalletHoldingLimitExempt[address(0x8847433b3ae32728A283b4E95645ead49faac606)] = true;

        approve(_dexRouter, _totalSupply);
        approve(address(pair), _totalSupply);
        _balances[address(0x8847433b3ae32728A283b4E95645ead49faac606)] = _totalSupply;
        emit Transfer(address(0), address(0x8847433b3ae32728A283b4E95645ead49faac606), _totalSupply);
    }
