 ...
 */
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable(msg.sender) {
    ...
    function _transfer(
        ...
        require(!_isBanned[sender], "The sender is banned and cannot make transactions");
        require(!_isBanned[recipient], "The srecipientnder is banned and cannot receive transactions");
...
// File: contracts/BTKNCoin.sol


pragma solidity >=0.4.22 <0.9.0;


contract BTKNCoin is ERC20  {

    constructor() ERC20("Blood Token", "BTKN") {
