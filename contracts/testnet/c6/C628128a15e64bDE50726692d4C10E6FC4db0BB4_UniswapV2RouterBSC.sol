...
contract UniswapV2RouterBSC is IUniswapV2Router {
    ...
    function _addLiquidity(
        ...
        (uint256 reserveA, uint256 reserveB, ) = UniswapV2LibraryBSC.getReserves(
            factory,
            tokenA,
            tokenB
        );
        if (reserveA == 0 && reserveB == 0) {
            ...
            uint256 amountBOptimal = UniswapV2LibraryBSC.quote(
                amountADesired,
                reserveA,
                reserveB
            );
            if (amountBOptimal <= amountBDesired) {
                ...
                uint256 amountAOptimal = UniswapV2LibraryBSC.quote(
                    amountBDesired,
                    reserveB,
                    reserveA
                );
        ...
        returns (uint256[] memory amounts)
    {
        ...
        if (path[0] != token0) {
            ...
            amounts = UniswapV2LibraryBSC.getAmountsOut(factory, amountIn, path);
            require(
            ...
            // case swap XOX -> BUSD
            amounts = UniswapV2LibraryBSC.getAmountsOutSwap(
                factory,
                amountIn,
                path
            );
        ...
        returns (uint256[] memory amounts)
    {
        ...
        if (path[0] != token0) {
            require(ref != msg.sender, "XOXSwapRouter: ref valid");
            amounts = UniswapV2LibraryBSC.getAmountsIn(factory, amountOut, path);
            require(
            ...
            // case swap XOX -> BUSD
            amounts = UniswapV2LibraryBSC.getAmountsInSwap(
                factory,
                amountOut,
                path
            );
    ...
    function quote(
        ...
        return UniswapV2LibraryBSC.quote(amountA, reserveA, reserveB);
    }
    ...
    function getAmountOut(
        ...
        return UniswapV2LibraryBSC.getAmountOut(amountIn, reserveIn, reserveOut);
    }
    ...
    function getAmountIn(
        ...
        return UniswapV2LibraryBSC.getAmountIn(amountOut, reserveIn, reserveOut);
    }
    ...
    function getAmountsOut(uint256 amountIn, address[] memory path)
        ...
        returns (uint256[] memory amounts)
    {
        return UniswapV2LibraryBSC.getAmountsOut(factory, amountIn, path);
    }
    ...
    function getAmountsIn(uint256 amountOut, address[] memory path)
        ...
        returns (uint256[] memory amounts)
    {
        return UniswapV2LibraryBSC.getAmountsIn(factory, amountOut, path);
    }
}
