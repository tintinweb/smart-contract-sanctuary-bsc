...
// SupportDigichain is the chef of new tokens. He can make yummy food and he is a fair guy as well as MasterDigichain.
contract SupportDigichain {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // Info of each user.
    struct UserInfo {
        uint256 amount;   // How many JAMUSPLIT tokens the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws JAMUSPLIT tokens to a pool. Here's what happens:
    ...
    // Info of each user that stakes JamuSplit tokens.
    ...
    // Deposit JamuSplit tokens to SupportDigichain for Reward allocation.
    ...
    // Withdraw JamuSplit tokens from SupportDigichain.
