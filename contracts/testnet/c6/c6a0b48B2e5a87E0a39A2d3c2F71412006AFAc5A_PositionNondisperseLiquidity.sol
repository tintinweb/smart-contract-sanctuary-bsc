    ...
    function shiftRange(
...

        {
            if (
                ...
                uint256 amountNeed = state.resultAddLiquidity.quoteAmountAdded -
                    quoteAmountRemoved -
                ...
                if (!isBase) {
                    ...
                    uint256 amountTransferred = depositLiquidity(
                        state.liquidityData.pool,
                        state.user,
                        Asset.Type.Quote,
                        amountNeed
            ...
            if (
                ...
                uint256 amountNeed = state.resultAddLiquidity.baseAmountAdded -
                    baseAmountRemoved -
