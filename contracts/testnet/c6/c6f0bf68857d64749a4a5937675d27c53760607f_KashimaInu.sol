...
Marketing
3% Funds sent to marketing wallet: 0x97430d52011242C40c4D74B95d336B56eADC4B16

Rewards
2% Per transaction paid to the holders

Use when the price drops & charity

2% Will use when the price drops : 0x3CD0d9A99f89538FF4527A1dF84C008A811Ed1F7

1% Charity Fundraising: 0x5C318d1c8ACACD46C46119d492505907FBBc7789

Dev Wallet: 0x8b5C2E1018D76f52A2296CC3375a2353693CBC6A

Reserve Wallet: 0x053e321FD1B194810713C74fC8c110d663bB78B0

Development Fee
2% Towards further development.
...
contract KashimaInu is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x97430d52011242C40c4D74B95d336B56eADC4B16); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0x053e321FD1B194810713C74fC8c110d663bB78B0); // Reserve Wallet Address
    address payable public charityWalletAddress = payable(0x5C318d1c8ACACD46C46119d492505907FBBc7789); // charity Wallet Address
    address payable public devWalletAddress = payable(0x8b5C2E1018D76f52A2296CC3375a2353693CBC6A); // dev Wallet Address
    ...
    string private constant _name = "Kashima Inu";
    ...
    constructor () {
        address _owner = 0xF572a157622C260186b6de19F999a328E035910D;
