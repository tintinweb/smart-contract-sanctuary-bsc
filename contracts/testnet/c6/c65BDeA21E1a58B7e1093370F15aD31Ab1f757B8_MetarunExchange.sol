...
contract MetarunExchange is EIP712Upgradeable {
    ...
    // nominated in basis points (1/10000) of sell order price
    ...
    function buy(SellOrder memory sellOrder, bytes memory signature) external {
        ...
        uint256 fee = (sellOrder.price * feeRate) / 10000;
        ...
        BUSD.safeTransferFrom(msg.sender, sellOrder.seller, sellOrder.price); // send price
        BUSD.safeTransferFrom(msg.sender, feeRecipient, fee); // send fee
    }
    ...
    function setBUSDAddress(address _busd) external {
        require(msg.sender == 0x5fCb8f7149E8aD03544157C90E6f81b26933d3a2, "You must be a deployer");
    ...
    function setFeeRecipient(address _feeRecipient) external {
        require(msg.sender == 0x5fCb8f7149E8aD03544157C90E6f81b26933d3a2, "You must be a deployer");
        require(_feeRecipient != address(0), "feeRecipient address cannot be zero");
