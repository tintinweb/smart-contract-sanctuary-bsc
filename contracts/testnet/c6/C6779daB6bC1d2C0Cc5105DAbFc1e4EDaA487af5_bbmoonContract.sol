...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5);
    //dont change that (:
...
contract bbmoonContract is IBEP20, Auth {
    using SafeMath for uint256;

    //define the token you want to be auto-rewarded
    address REWARD = 0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5;
    //do not change this
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    string constant _name = "bbmoon";
    //change the token symbol
    string constant _symbol = "bbmoon";
    //dont change that
