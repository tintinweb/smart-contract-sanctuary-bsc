...
contract LendBorrowFarmStrategy is LogicUpgradeable {
     ...
     */
    function destroy(uint256 _percentage) external onlyOwnerAndAdmin {
...
*/
        ...
        onlyOwnerAndAdmin
    {
        ...
        for (uint256 i = 0; i < length; ) {
            ...
            ILogicContract(_logic).approveTokenForSwap(
                _farmingPairs[i].rewardsToken
            );
    ...
    function claimInternal(uint8 mode) private {
        ...
        if (mode == 0 || mode == 1) {
            ...
            ILogicContract(_logic).swapExactTokensForETH(
                rewardsSwapRouter,
                IERC20Upgradeable(rewardsToken).balanceOf(_logic),
                0,
        ...
        if (mode == 0 || mode == 2) {
            for (index = 0; index < count; ) {
                ...
                // ILogicContract(_logic).swapExactTokensForETH(
                //     reserve.swap,
                //     IERC20Upgradeable(reserve.rewardsToken).balanceOf(_logic),
                //     0,
