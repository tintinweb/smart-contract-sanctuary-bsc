...
/*
* 
* $DEWO Token - The native token to DecentraWorld and its ecosystem
...
*░░░░░░░░░░░░░░░╚═╝░░░╚═╝░░░╚════╝░╚═╝░░╚═╝╚══════╝╚═════╝░░░░░░░░░░░░░
*░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
* DecentraWorld DAO Liquidity Pool Farming BNB/$DEWO
*/
...
contract YieldFarmLP {
    ...
    // 10,000,000 $DEWO Tokens (10% Of Total Supply) Are Dedicated To This Pool
    uint public constant TOTAL_DISTRIBUTED_AMOUNT = 10000000;
    // Every Week 100K $DEWO Tokens Are Released To All Pool Participants Over 100 Weeks
    uint public constant NR_OF_EPOCHS = 100;

    // PancakeSwap Liquidity Pair Contract Address
    address private _pcsLP;

    // Community Vault Contract Address
    address private _communityVault;

    // $DEWO Token Contract Address
    IERC20 private _dewo;
    ...
    // Harvest Rewards For Pool Participants
    event MassHarvest(address indexed user, uint256 epochsHarvested, uint256 totalValue);
    event Harvest(address indexed user, uint128 indexed epochId, uint256 amount);

    // Constructer: Can only be executed when the contract deploys
    constructor(address dewoTokenAddress, address pcsLP, address stakeContract, address communityVault) public {
        _dewo = IERC20(dewoTokenAddress);
        _pcsLP = pcsLP;
    ...
    function massHarvest() external returns (uint){
        ...
        if (totalDistributedValue > 0) {
            _dewo.transferFrom(_communityVault, msg.sender, totalDistributedValue);
        }
    ...
    function harvest (uint128 epochId) external returns (uint){
        ...
        if (userReward > 0) {
            _dewo.transferFrom(_communityVault, msg.sender, userReward);
        }
    ...
    function _harvest (uint128 epochId) internal returns (uint) {
        ...
        // if it fails either user either a DecentraWorld account will init not init epochs
    ...
    function _getPoolSize(uint128 epochId) internal view returns (uint) {
        // retrieve pcslp token balance
        return _staking.getEpochPoolSize(_pcsLP, _stakingEpochId(epochId));
    }


    function _getUserBalancePerEpoch(address userAddress, uint128 epochId) internal view returns (uint){
        // retrieve pcslp token balance per user per epoch
        return _staking.getEpochUserBalance(userAddress, _pcsLP, _stakingEpochId(epochId));
    }
