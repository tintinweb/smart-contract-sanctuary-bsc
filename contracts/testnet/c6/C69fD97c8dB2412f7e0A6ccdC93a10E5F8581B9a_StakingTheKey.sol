...
contract StakingTheKey{
    ...
    constructor(address owner, FrozenToken depositToken){
        _owner = owner;
    ...
    function withdrawOneStakingPercents(uint256 stakingNum) public{
        ...
        .call(abi.encodeWithSignature("depositPools(address,uint256)",
    ...
    function withdrawLostTokens(IERC20 tokenAddress) public onlyOwner {
        if (tokenAddress != IERC20(address(0)) || tokenAddress != IERC20(_depositToken)) {
