...
contract DOGXpresale is Ownable {
    ...
    uint256 public _liquidityPercentage = 70;
    address public _liquidityReceiver = 0xC89b8F320CF53aB054FE111Ca2173E05942b5FfC;
    address public tokenPresale = 0x0Eb685f7d23f6d24b8DBe199ef0f165e0E8010A5;
    ...
    function forceWithdraw() external {
        ...
        uint amount = _holdersInfo[msg.sender]._amounts.mul(10).div(100);
