...
contract Farming is ReentrancyGuard, Ownable {
    ...
    uint constant MASTERCHEF_PID = 0;
    
    address constant HAPPY_COW_ADDRESS = 0x091551a095f19133e3482Ac91c4A5dB438e94b79; // Deployed on testnet, For TEST
    address constant AIR_NFT_ADDRESS = 0x46D8A7a26336e43953B91e5fb198B15DF8D0d9Db; // Deployed on testnet, For TEST
    address constant COW_TOKEN_ADDRESS = 0x7D43051BBbbE2804C14eF7A99F56fFE456767A89; // Deployed on testnet, For TEST
    address constant MILK_TOKEN_ADDRESS = 0x9Bb61D36F739F682295722ED7f5A5a48A142D85F; // Deployed on testnet, For TEST
    address constant MASTERCHEF_ADDRESS = 0xc6438Ac9Db413Efc13F2e0727e7E70Bc85d747fE; // Deployed on testnet, For TEST
