...
contract HighStreetPet is Context, ERC721Enumerable, Ownable, MinterAccessControl {

  /// @dev a string of base uri for this nft
  string private baseURI;

  /// @dev maximum ERC721 token supply
   ...
   * @param max_ maximum ERC721 token supply
   */
  constructor (
    string memory name_,
  ...
  function safeMint(address to_, uint256 tokenId_) external virtual onlyMinter {
    require(totalSupply() <= maxSupply, "exceed max amount");
