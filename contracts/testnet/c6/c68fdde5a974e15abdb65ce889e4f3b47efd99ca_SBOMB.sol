...
contract SBOMB is ERC20Detailed, Ownable {
    ...
    uint256 public sBombInsuranceFundFee = 20;
    uint256 public sellFee = 60;
    uint256 public bombFireFee = 20;
    ...
    constructor() ERC20Detailed("SuperBomb", "sBOMB", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x0D8e060CA2D847553ec14394ee6B304623E0d1d6;
        treasuryReceiver = 0x0D8e060CA2D847553ec14394ee6B304623E0d1d6; 
        sBombInsuranceFundReceiver = 0x0D8e060CA2D847553ec14394ee6B304623E0d1d6;
        bombFire = 0x0D8e060CA2D847553ec14394ee6B304623E0d1d6;
    ...
    function takeFee(
        ...
        _gonBalances[bombFire] = _gonBalances[bombFire].add(
            gonAmount.div(feeDenominator).mul(bombFireFee)
        );
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(sBombInsuranceFundFee))
        );
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no sBomb token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
