...
contract MyNFT is ERC721, Ownable {
    ...
    uint256 public constant NFTPrice = 1e16; //0.01 ETH
    ...
    function reserveNFTs(uint reserveTokens) public onlyOwner {        
        require(saleIsActive, "Sale must be active to mint NFT");    
        uint supply = totalSupply();
        uint i;
        for (i = 0; i < reserveTokens; i++) {
    ...
    function mint(uint numberOfTokens) public payable {
		...
		uint256 totalCost = NFTPrice.mul(numberOfTokens);
