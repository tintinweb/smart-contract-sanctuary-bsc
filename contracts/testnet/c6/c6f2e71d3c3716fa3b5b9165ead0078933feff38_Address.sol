...
contract BRANCH is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0x1C10e6D3597D3c25DF8fF444f85fab906c4fE0fc); // Marketing Wallet
    address payable private crowdfundWallet = payable(0xc96c71221b04629D4E3Be0b8186c3C80e9524692); // Crowd Fund Wallet
    address payable private devWallet = payable (0x1C10e6D3597D3c25DF8fF444f85fab906c4fE0fc); // Dev Wallet
    ...
    uint256 public _buyDevFee = 0;    //1.5%
    uint256 public _buyMarketingFee = 0;   //1.5%
    uint256 public _buyReflectionFee = 0;

    uint256 public _sellLiquidityFee = 0; //1%
    uint256 public _sellMarketingFee = 0;  //1.5%
    uint256 public _sellDevFee = 0;   //1.5%
    uint256 public _sellReflectionFee = 0;
    
    uint256 private crowdfundfee = 0;   //2% same for buys and sells
