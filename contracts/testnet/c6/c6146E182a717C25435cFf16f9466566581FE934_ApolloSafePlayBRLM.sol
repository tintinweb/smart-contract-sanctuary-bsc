...
// File contracts/ApolloSafePlay/ApolloSafePlayBRLM.sol
...
contract ApolloSafePlayBRLM is Context, IERC20Metadata, Ownable {
    ...
    function _transfer(
        ...
        // If trading is disabled, and thresold is reached, even normal user to user transfer won't work as it will call swapAndLiquify
