    ...
    UUPSUpgradeable
{
    ...
    function setTaxes(
        ...
        require(
            _liquidity + _marketing + _development < 25,
            "Taxes can't be over 25"
        );
    ...
    function _transfer(
        ...
        require(!isBlacklist[sender] || !isBlacklist[receiver], "User blacklisted");
    ...
    function _tokenTransfer(
        ...
        if (whitelist[sender] || whitelist[receiver]) {
            taxAmount = 0;
            liquifyAmount = 0;
        }
