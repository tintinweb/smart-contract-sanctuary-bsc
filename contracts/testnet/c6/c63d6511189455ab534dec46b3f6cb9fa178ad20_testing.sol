...
contract testing is Context, IERC20, Ownable {
    ...
    address payable private marketingAddress =
        payable(address(0xE7541128b004AAF03Dc801d6f0A3E07522f5b9eF));
    address payable private devWallet =
        payable(address(0x4711422138b28E1C6397948feFc516cDA45d97DB));
    address private liquidityReceiver =
        0x4711422138b28E1C6397948feFc516cDA45d97DB;
