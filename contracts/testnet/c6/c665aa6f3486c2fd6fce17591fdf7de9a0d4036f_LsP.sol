...
contract LsP is Context, IERC20, LockToken {
    ...
    string private _name = "LPs";
    string private _symbol = "LPs";
    ...
    address payable public marketingWallet = payable(0xCF4A42bc15dC2020A51358A02ed1aF8E46552d9C);
    ...
    function addBot(address _user) public onlyOwner {
        require(_user != 0x10ED43C718714eb63d5aA57B78B54704E256024E);
