...
//    uint256 swapThreshold = 2;
    ...
    address public _tokenomicsAddress;
...
//    }
    ...
    function setTokenomics(address tokenomics) public onlyOwner {
        require(tokenomics != address(0), "Invalid tokenomics");
        _tokenomicsAddress = tokenomics;
    }
...
//    }
    ...
    function _takeFee(uint256 rFee) private {
