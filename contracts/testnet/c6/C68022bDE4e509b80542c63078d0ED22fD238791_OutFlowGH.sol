...
/** 
 * Contract: USD OutFlowGH Token
 * Developed By: SafemoonMark
 * 
 * Liquidity-less Token, DEX built into Contract
 * Send BNB to contract and it mints OutFlowGF Token to your receive Address
 ...
 * 
 */
contract OutFlowGH is IERC20, Context, Ownable {
    ...
    // token data
    string constant _name = "OutFlowGH";
    string constant _symbol = "OFGH";
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        require(sender == msg.sender, 'cannot move funds for other accounts with OutFlowGH :D');
    ...
    /** Purchases OutFlowGH Tokens and Deposits Them in Sender's Address */
    function purchase(address buyer, uint256 bnbAmount) internal returns (bool) {
        ...
        // revert if under 1
        if (tokensToSend < 1) {
            revert('Must Buy More Than One OutFlowGH');
        }
    ...
    /** Sells OutFlowGH Tokens And Deposits the BNB into Seller's Address */
