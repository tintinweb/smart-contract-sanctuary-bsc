...
contract RDNRegistry is IRDNRegistry, AccessControlEnumerable {
    ...
    bytes32 public constant POINTSRATEUPDATE_ROLE = keccak256("ACTIVEUNTILLUPDATE_ROLE");
    ...
    function setTariff(uint _userId, uint _tariff) public onlyRole(TARIFFUPDATE_ROLE) {
        users[_userId].tariff = _tariff;
    }

    function setActiveUntill(uint _userId, uint _activeUntill) public onlyRole(ACTIVEUNTILLUPDATE_ROLE) {
