...
contract SpringPlot is ERC721Enumerable, Owners, ISpringPlot, HandlerAware {
    ...
    constructor(
    ...
    ) HandlerAware(_handler) ERC721("Spring Plot", "SPRING-P") {
        ...
        _setPlotType(
            ...
            PlotTypeSpec({
                ...
                additionalGRPTime: Percentages.from(0),
                waterpackGRPBoost: Percentages.from(0)
            })
        );
    }
    ...
    function _moveNodeToPlot(
        ...
        PlotTypeSpec storage plotType = _getPlotType(tokenIdToType[plotTokenId]);
