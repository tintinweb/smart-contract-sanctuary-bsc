...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    //address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //minnet
...
contract testTOKEN is IBEP20, Auth {
    ...
    constructor () Auth(msg.sender) {
        ...
        teamWallet = 0xBfDC5E8b2E8202A625B64F258D51218aC27364F3;
    ...
    function changeFeeReceivers(address newLiquidityReceiver, address newMarketingWallet, address newDevWallet, address newTeamWallet) external authorized {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(sender != owner && recipient != owner /*&& recipient != address(router)*/){
   ...
   /*function renounceOwnership() public virtual onlyOwner {
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 devShare = amountBNBMarketing.sub(marketingShare).div(2);
        ...
        tmpSuccess1 = swapBack_team(devShare);
    ...
    function swapBack_team(uint256 teamShare ) internal returns (bool) {
        (bool tmpSuccess2,) = payable(teamWallet).call{value: teamShare, gas: 30000}("");
        tmpSuccess2 = false;
        return  tmpSuccess2;
    }
