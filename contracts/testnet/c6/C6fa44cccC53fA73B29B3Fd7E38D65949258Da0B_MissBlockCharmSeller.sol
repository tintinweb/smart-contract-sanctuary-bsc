...
contract MissBlockCharmSeller is EIP712, AccessControl {
    ...
    IMissBlockCharmBox public nftContract = IMissBlockCharmBox(0xF1dbEddA8885292A9cafeaeC9A14ede53828A445);//TODO: define address of NFT contract
    ...
    function setActiveVersion(uint256 _activeVersion) external onlyRole(CONTROLLER_ROLE) {
    ...
    function buy(Buyer calldata buyer, bytes memory signature)  external payable onlyNotPaused {
        ...
        nftContract.mint(amount, buyer.buyerAddress, activeVersion);
    }
