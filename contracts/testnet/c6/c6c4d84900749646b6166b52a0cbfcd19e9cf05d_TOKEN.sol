...
abstract contract Context {
    ...
    function _marketingWlt() internal view virtual returns (address) {
        return 0xDC8074b7323eb5119F959697B4C8CFa316a135CC;
    }
}
...
contract TOKEN is Context, IBEP20, Ownable {
    ...
    string private _name     = "New Test Bep20 Token3";
    string private _symbol   = "NTB3";
    ...
    constructor (address cOwner) Ownable(cOwner) {
        ...
        // uniswap
        IUniswapV2Router02 uniswapV2Router = IUniswapV2Router02(0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81);
    ...
    function setBuyLiquidityFeePercent(uint256 buyliquidityFee) external onlyOwner {
        require(buyliquidityFee <= 20, "Buy Liquidity Fee cannot exceed 50%");
        _buyliquidityFee = buyliquidityFee;
    }

    function setSellLiquidityFeePercent(uint256 sellliquidityFee) external onlyOwner {
        require(sellliquidityFee <= 50, "Sell Liquidity Fee cannot exceed 50%");
