    ...
    */
    ...
    function placeBid(
        ...
        //     );
            emit AuctionBid(
                 newBidId,
                _contractAddress, //contractAddress indexed
                _bidder,      // bidder indexed
                _tokenId,         //tokenID indexed
                _amount,         //amount
                true,           //startedAuction boolean
                0,              //newAuctionlength
                prevBid.bidder // previousBidder
            );
        // }
    ...
    function updateBid(
        ...
        require(bid.bidder != address(0) || bid.amount != 0 , 'bid doesnot exist');
    ...
    function acceptBid(
        ...
        require(
            ...
            "Aunction creator can only accept bid once."
        );
