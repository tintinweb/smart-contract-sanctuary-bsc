    ...
    DividendPayingTokenOptionalInterface
{
    ...
    address public immutable busdTracker; //ETH
    ...
    function distributeDividends(uint256 amount) public onlyOwner {
        require(totalSupply() > 0,"Nobody eligible for dividends");
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            bool success = IERC20(busdTracker).transfer(user, _withdrawableDividend);
...
// File: contracts/BUSDRewards.sol
...
contract RewardToken is ERC20, Ownable {
    ...
    constructor() ERC20("TOKEN4", "TKN4") {
        busdTracker = new BUSDTracker();
        dividendTracker = new TOKENDividendTracker(address(busdTracker));
        ...
        */
        ...
        maxWalletAmount = totalSupply().mul(10).div(1000);
    }
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            if( !automatedMarketMakerPairs[from] && !inSwapAndLiquify){
    ...
    function swapAndLiquify(uint256 tokens) private {
        ...
        // swap tokens for ETH
        swapTokensForBNB(half); // HATE swap when swap+liquify is triggered
    ...
    function swapAndSendDividends(uint256 tokens) private {
        busdTracker.mint(address(dividendTracker), tokens);
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    function withdrawDividend() public pure override {
        require(
            false,
            "TOKEN_Dividend_Tracker: Use the 'claim' function on the main TOKEN contract."
        );
    }
