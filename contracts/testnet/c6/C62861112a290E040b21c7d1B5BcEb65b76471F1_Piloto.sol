...
contract Piloto is ERC20, ERC20Detailed {
     ...
     */
    constructor () public ERC20Detailed("Piloto - B", "PLT50", 18) {
        _mint(msg.sender, 60 * (10 ** uint256(decimals())));
        _mint(0x6e62d6cbEd3ac34da355CCb18bA92F54c7Bd5e9e, 10 * (10 ** uint256(decimals())));
        _mint(0xed045e0bD6A3efd38B068de6f81A5D440d05FE66, 10 * (10 ** uint256(decimals())));
        _mint(0xd988190457F1d776d71aA388428610ac0DA653d7, 10 * (10 ** uint256(decimals())));
        _mint(0x2Fb0c061Bee6bDBa981dAf171B0E8D684F4f6aB9, 10 * (10 ** uint256(decimals())));
        _mint(0x0f00a86073d11E6d5fB64DB9dD9D2e99217596cc, 2 * (10 ** uint256(decimals())));
