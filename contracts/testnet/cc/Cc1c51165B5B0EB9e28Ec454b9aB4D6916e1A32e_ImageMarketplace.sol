    ...
    UUPSUpgradeable
{
    ...
    event CancelListImageNFT(uint256 tokenId, address nftContract);
    ...
    function cancelListImageNFT(uint256 _tokenId) public {
        // Verify
        require(idToMarketItem[_tokenId].seller == msg.sender, "You do not own this NFT");
        require(idToMarketItem[_tokenId].price > 0, "Invalid NFT");
        ...
        // Emit
        emit CancelListImageNFT(_tokenId, nftContract);

        _itemsCancelled.increment();
    }

    // Buy ImageNFT
    function buyImageNFT(uint256 _tokenId)
        public nonReentrant payable
    {
        require(idToMarketItem[_tokenId].seller != msg.sender, "Buyer cannot be seller");
        require(msg.value == idToMarketItem[_tokenId].price, "Submit NFT price asked");
        ...
        emit BuyImageNFT(
            idToMarketItem[_tokenId].marketItemId,
