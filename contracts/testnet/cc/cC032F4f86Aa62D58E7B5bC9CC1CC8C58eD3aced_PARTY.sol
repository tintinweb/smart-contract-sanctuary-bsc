...
contract PARTY is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    event LogRebase(uint256 indexed epoch, uint256 totalSupply);

    string public _name = 'Party Shiba';
    string public _symbol = 'PARTY';
    ...
    uint256 public PARTYInsuranceFundFee = 60;
    uint256 public firePitFee = 10;
    uint256 public totalFee = liquidityFee.add(gameTreasuryFee).add(PARTYInsuranceFundFee).add(firePitFee);
    ...
    address public PARTYInsuranceFundReceiver;
    ...
    constructor(
        ...
        PARTYInsuranceFundReceiver = msg.sender;
        infernoPit = ZERO;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_gameTreasuryFee.add(PARTYInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(gameTreasuryReceiver).call{
            value: amountETHTogameTreasuryAndSIF.mul(gameTreasuryFee).div(gameTreasuryFee.add(PARTYInsuranceFundFee)),
            gas: 30000
        }('');
        (success, ) = payable(PARTYInsuranceFundReceiver).call{
            value: amountETHTogameTreasuryAndSIF.mul(PARTYInsuranceFundFee).div(
                gameTreasuryFee.add(PARTYInsuranceFundFee)
            ),
            gas: 30000
        }('');
    }
