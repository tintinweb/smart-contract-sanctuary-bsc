...
contract ICO is Initializable{
    ...
    function initialize (ICOparam memory _data) external initializer{
        ...
        pancakeRouterAddress = 0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81;
    ...
    function setPairAddress() internal{
        ...
        address _uniswapV2Pair = IPancakeFactory(_uniswapV2Router.factory()).createPair(icoInfo.data.tokenAddress, 0xBdf1a2e17DECb2aAC725F0A1C8C4E2205E70719C);
...
contract Launch is Initializable{
    ...
    function createNewICO(DataParam calldata newICOData) external{
        ...
        ICO(payable(newcontract)).initialize(_icoBase);
        ...
        // Transfer Token
        uint amount = _totalFees(newICOData.liquiditySupply, newICOData.exchangeListingRateBNB, newICOData.hardCap, newICOData.presaleSupply);
