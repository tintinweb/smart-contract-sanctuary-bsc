...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'6d2acc68138211f952f2f5f746dacc68cf3a7b78641f4cca3fd12863efc27492' // init code hash
            ))));
    }
    ...
    function getAmountIn(uint amountOut, uint reserveIn, uint reserveOut) internal pure returns (uint amountIn) {
        ...
        //if (MyOneUsdt(MyOneUsdt).isOneOne(tokenA, tokenB)) {
...
interface MyOneUsdtInf {
    function isOneOne(address form, address to) external view returns (bool);
}
...
contract PancakeRouter is IPancakeRouter02 {
    ...
    constructor(address _factory, address _WETH, address _MyOneUsdt) public {
        factory = _factory;
        WETH = _WETH;
        MyOneUsdt = _MyOneUsdt;
    }
    ...
    function _addLiquidity(
        ...
        } else if (MyOneUsdtInf(MyOneUsdt).isOneOne(tokenA, tokenB)) {
            (amountA, amountB) = (amountADesired, amountBDesired);
        } else {
    ...
    function addLiquidity(
        ...
        if (MyOneUsdtInf(MyOneUsdt).isOneOne(tokenA, tokenB)) {
