...
contract BonfireMetaRouter is IBonfireMetaRouter, Ownable {
    ...
    //address public constant override WETH = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); //mainnet
    address public constant override tracker =
        address(0xA322D370bdB38Bee40b1E687cBdc22dA92302956); //testnet
    //address public constant override tracker = address(0xBF0089F09D4D90BB51b098F09e05eb40C641627a); //mainnet
    address public constant override logbook =
        address(0x66ce28A793BA06c3873281cb8646613B01b751F3); //testnet
    //address public constant override logbook = address(); //mainnet
    address public constant override wrapper =
        address(0xA79117c79d3FB12b09f20b21A5231beF73784d93); //testnet
    //address public constant override wrapper = address(0xBF00C4F91B8bB3DD00aF4dD5922bBc8c7f3aCAF4); //mainnet
    address public constant override paths = address(0x1F04239De40c7E221589D5222273F5fBB6D614e8); //testnet
    //address public constant override paths = address(0); //TODO mainnet
    address public accumulator;
    uint256 public maxAccumulationCount;
    //address public constant defaultToken = address(0);
    address public constant defaultToken =
        address(0x4E35C0060E377f15425fC073443573CA30528C15); //Bonfire testnet

    //address public constant defaultToken = address(0x5e90253fbae4Dab78aa351f4E6fed08A64AB5590); //Bonfir mainnet

    constructor(
        //        address wrappedETH,
        //        address transferLogbook,
        //        address routerPaths,
        address admin
    ) Ownable() {
        //        WETH = wrappedETH;
        //        logbook = transferLogbook;
        //        paths = routerPaths;
        //        wrapper = IBonfireRouterPaths(paths).wrapper();
        //        tracker = IBonfireRouterPaths(paths).tracker();
