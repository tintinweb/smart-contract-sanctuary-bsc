...
contract HitKing is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("HitKing", "HitKing") {

        address newOwner = address(0xc884fddcbfCa719EC7FaFcD86055845d1Be5C7E0);
    	...
    	marketingWallet = address(0x8CB212A6B5C3935485852e89A4E7154cCf3E27ca); // Marketing Wallet
    	buyBackWallet = address(0x8CB212A6B5C3935485852e89A4E7154cCf3E27ca); // Development Wallet
