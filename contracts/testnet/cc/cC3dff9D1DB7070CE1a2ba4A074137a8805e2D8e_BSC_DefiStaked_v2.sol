...
// SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract BSC_DefiStaked_v2 is ReentrancyGuard {
        ...
        uint256 private LOTTERY_TICKET_PRICE = 100 * 1e15; /** 0.005 BNB **/
        ...
        *************************************************************/
        ...
        function getUserInfoPlus(address _adr) public view returns(uint256 _migrate, address _walletUser, uint256 _withdrawLast) {
            User_plus storage user_plus = users_plus[_adr];
            User storage user = users[_adr];

            return (user_plus.migrate,
                    user_plus.wallet_user, user.lastWithdrawTime);
        }
    ...
    /** will auto execute, when condition is met. buy, hatch and sell, can be triggered manually by admin if theres no user action. **/
        ...
        *************************************************************/
        ...
        function LIQUIDEZ() external payable returns(bool){
            return true;
        }
