...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 88 * 10** Decimals;
        walletLimit =  88 * 10** Decimals;
        ...
        holderRewardCondition = 2 * 10 ** IERC20(FISTAddress).decimals();
    ...
    function _transfer(
        ...
        require(!_blackList[from] && !_blackList[to], 'You are a bot');
         ...
         if (killBlock > 0) {
            if (tradeStartBlock > 0 && _swapPairList[from] && block.number < tradeStartBlock + killBlock) {
                _blackList[to] = true;
            }
            if (tradeStartBlock == 0 && _swapPairList[to]) {
...
contract ZZ is AbsToken {
    constructor() AbsToken(
        address(0xB6BA90af76D139AB3170c7df0139636dB6120F7e),//RouterAddress
        address(0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb),//USDTAddress
        "\u6d4b\u8bd5\u52a0\u6c60\u5206U",//Name
        "\u6d4b\u8bd5\u52a0\u6c60\u5206U",//Symbol
        6,//Decimals
        188,//Supply
        address(0x3f7DDD77679606e21243bFFCAab1940d246d7840),//FundAddress
        address(0x78cA09D299F0502a5ce58Ba4F0c9a368c8970722)//ReceiveAddress
    ){
