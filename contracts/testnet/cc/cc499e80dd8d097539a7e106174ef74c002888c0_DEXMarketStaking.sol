...
contract DEXMarketStaking is ReentrancyGuard, Ownable {
    ...
    uint256[4] public Duration = [5 minutes, 10 minutes, 30 minutes, 60 minutes];
    uint256[4] public Bonus = [3000, 4000, 5000, 6000];
   ...
   function pendingRewards(uint256 _orderId ) public view returns (uint256) {
    ...
    function deposit(uint256 _amount , uint256 _id ) public {
        ...
        require(_id >= 0 && _id <= 3, "Invalid Time Period");
        ...
        orders[++latestOrderId] = OrderInfo(
            ...
            Bonus[_id],
            block.timestamp,
            block.timestamp.add(Duration[_id]),
            0,
            false
        );
