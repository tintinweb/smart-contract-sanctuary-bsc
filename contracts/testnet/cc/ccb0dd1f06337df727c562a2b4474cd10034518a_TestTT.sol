...
* Rewards in USDT 
* Tax: 12% buy / 12% sell
* LP 2/2 Marketing 3/3 Reflection 7/7
* 5% of total supply locked on dxsale
* LP locked for 7 days (will be extended)
* https://t.me/rehteT
* --------------------------------------------------------
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
...
contract TestTT is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TestTT";
    string constant _symbol = "TestTT";
