...
contract WordlCupMiner {
   ...
   // uint256 constant finalGameTime = 1671386400; // fixed to December 18st 18:00:00 gmt // mainnet 
    ...
    uint256 public MIN_INVEST = 0.01 ether; /** 0.01 BNB  **/
	uint256 public ACTION_COOLDOWN = 60; /** 24 hours  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 50 ether; /** BNB  **/
  ...
  //  uint256 public WALLET_DEPOSIT_LIMIT = 50 * 1e18; /** 50 BNB  **/
    ...
    uint256 public GOALS_BNB = 1000; // ammount of goals for 1 BNB
    uint256 public goalsValue = GOALS_TO_HIRE_1MINERS * GOALS_BNB; //GOALS_TO_HIRE_1MINERS * GOALS_BNB
    ...
    address private genesis;
     ...
     uint256 public MAX_LOTTERY_POOL_PER_ROUND = 50 ether;
    ...
    uint256 public max_pool_balance = 50 ether; /** 50 BNB  **/
    ...
    constructor(address payable _treasury, address _genesis) {
    ...
    function buyGOALS(address ref) public payable {
        ...
        uint256 eggsBought = calculateGoalsBuy(msg.value);
        ...
        uint256 goalsPayout = payFees(msg.value);
        totalStaked = totalStaked.add(msg.value.sub(goalsPayout));
        compoundGoals(false);
    ...
    function sellGoals() public nonReentrant {
        ...
        payable(address(msg.sender)).transfer(goalsPayout);
    ...
    function PRC_GOALS_TO_HIRE_1MINERS(uint256 value) external {
        ...
        goalsValue = GOALS_TO_HIRE_1MINERS * GOALS_BNB;
    }

    function VAR_GOALS_BNB(uint256 value) external {
        require(msg.sender == owner, "Admin use only.");
