...
contract Sale is State, Ownable, ReentrancyGuard {
    ...
    function saleDetails() external view returns (address[2] memory, uint256[10] memory, bool, uint) {
        return (
            [
                address(_saleToken),
    ...
    */
    ...
    function claim() external nonReentrant whenFinalized {
        ...
        // uint256 claimable = _claimable[_msgSender()];
        // uint256 lock = _claimable[_msgSender()];
