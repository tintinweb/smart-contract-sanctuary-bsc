...
contract Vault is Ownable  {
    ...
    function updatedDividendsOf(address _user) public view returns (uint256) {
        ...
        if (timeFromLastPayout > payoutFrequency && currentTotalStaked > 0) {
            ...
            uint256 profitPerShare = SafeMath.add(profitPerShare_, (profit * magnitude) / currentTotalStaked);

            return (uint256) ((int256) (profitPerShare * balanceOf_[_user]) - payoutsOf_[_user]) / magnitude;
        }
