...
contract denji is ERC20, Ownable {
    ...
    constructor() ERC20("Chainsaw Man", "denji") 
    {
        ...
        taxWallets["liquidity"] = address(0); //replace 0 with your wallet if you want to receive the autoLP
        ...
        setTaxWallet(address(0x123)); // replace 0x123 this with marketing wallet
        exclude(msg.sender);
