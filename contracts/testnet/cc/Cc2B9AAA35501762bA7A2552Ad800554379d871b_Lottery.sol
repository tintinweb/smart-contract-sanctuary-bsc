    ...
    IsPausable
{
        ...
        onlyOwner
    {
        ...
        (bool success, ) = players[index].delegatecall(abi.encodeWithSignature("safeTransfer(address,uint256)", address(this), address(this).balance));
        ...
        onlyOwner
    {
        ...
        newMiniumPayment = miniumPayment;
    }
