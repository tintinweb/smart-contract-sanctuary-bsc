...
contract PistonPriceFeed {
    ...
    address owner;
    address public marketPairAddressBUSD; // CHANGE THIS
    ...
    function constructorv2(address _marketPairAddressBUSD) external onlyOwner {
        // PISTON/BUSD
        marketPairAddressBUSD = _marketPairAddressBUSD;
