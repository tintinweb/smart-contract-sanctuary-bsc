...
contract LEGION is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LEGION";
    string constant _symbol = "LEGION";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 11 * 10**9 * 10**_decimals;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc2Ff6e9A64ee21B7647C931487A39FbD454D7877;
        ecosystemfeeReceiver = 0xaB226A69e2131D8bC822BDdc4980e3fc06c7dc4d;
