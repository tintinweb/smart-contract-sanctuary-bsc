...
contract SPUDSINU is Context, IBEP20, Ownable {
    ...
    uint[] public _percentages = [50,30,10,10,0];                                         // % of liquidity fee split to wallet(s)
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x56864204c2f400E0DE7483258f7e71F6f7E21487),                             // Dev wallet
        payable(0xFb5B6cAB3dE331A25EF65C39b2F220Aeb5441902),                             // Marketing wallet
        payable(0xCE5f953a73f248ec2db17117A67AA4540693B209),                             // Team Dev wallet
        payable(0x3aEe8C8318720be281e61E163F95E3c89A16E403),                             // Charity wallet
        payable(0x51f2e98dCC40e11645BDFC525C5Df1038C50B73C)                              // SPARE1
 ];
