...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7724A947c7Db45345eeb1056eA8550b75007E7CA;
...
contract VGreen1 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x0Bc02F042a026A75AB179B85eEe9fa9Bd3658Da9;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "VGreen1";
    string private _symbol = "VGEN";
