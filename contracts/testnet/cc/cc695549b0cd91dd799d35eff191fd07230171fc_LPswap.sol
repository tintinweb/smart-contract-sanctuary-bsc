...
//0x857a8f6c20e976b94ead372412ac19ece70ad139
...
contract LPswap {
    ...
    address public bbyToken = 0xEE814D3dc1DBbFDa6a5eB1357077b9f835203619;//0x14DE6D664A03494900058651B67928432a6a56dd  //0xDaC328078613a95EC63dF19AbcBe66d65646A6EF
    ...
    function pledgeNode(uint256 amount) public{
        ...
        IERC20(usdtToken).transferFrom(msg.sender, address(this), amount*10 ** usdtToken_decimals);
    ...
    function AddLPLiquidity(uint256 input_amount) public {
        ...
        Router.addLiquidity(usdtToken,bbyToken,uset_amount,_quote,uset_amount,_quote,msg.sender,block.timestamp);
