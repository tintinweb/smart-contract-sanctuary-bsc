...
contract BTCX is Context, IERC20, Ownable {
    ...
    uint256 private _previousRewardFee = _liquidityFee;
    ...
    function removeAllFee() private {
        if(_liquidityFee == 0 && _liquidityFee == 0) return;
        
        _previousRewardFee = _liquidityFee;
    ...
    function restoreAllFee() private {
       _liquidityFee = _previousRewardFee;
