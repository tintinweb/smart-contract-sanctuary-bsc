   ...
   function  novuxa_Balance_Token1() external view returns(uint) {
    ...
    function SwapAB(uint amountA) public swap_checkA(amountA) {
      //  uint256 allowance = token.allowance(msg.sender, address(this));
        ...
        require(token_.balanceOf(address(this))*tkdA >= amountq, "Not Enough Liquidity For this SWAP");
      ...
      function SwapBA(uint amountB) public swap_checkB(amountB) {
           ...
           require(token.balanceOf(address(this))*tkdB >= amountq, "Not Enough Liquidity For this SWAP");
