...
contract StakeLP is Ownable, IStakeLP, ReentrancyGuard {
    ...
    struct UserInfo {
        ...
        uint256 totalCollect; // Total collected
    }

    IUniswapV2Router01 public constant uniswapV2Router =
    ...
    function initialize(
        ...
        bonusEndBlock = _startBlock + ((365 * 24 * 60 * 60) / 3);

        uint256 _poolLimitPerUser = 0;
        uint256 _numberBlocksForUserLimit = 0;
