...
contract Marketplace is Ownable, ReentrancyGuard {
    ...
    function mintMarketItem(
        ...
        // ArtLuxNFT().mintToken(_tokenId);
        // Count_Minted.increment();

        //putting it up for sale
        idToMarketItem[_tokenId].holder = payable(msg.sender);
        idToMarketItem[_tokenId].nftContract = ArtLuxNFTAddr;
        idToMarketItem[_tokenId].price = 1 ether;
        idToMarketItem[_tokenId].tokenId = _tokenId;
        // NFT transaction
