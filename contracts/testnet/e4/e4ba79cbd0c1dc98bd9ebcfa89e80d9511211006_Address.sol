...
contract LiquidityGeneratorToken is IERC20Upgradeable, OwnableUpgradeable {
    ...
    function initialize (
        ...
        _taxFee = 500; // represents a 5% tax fee
        _previousTaxFee = _taxFee;

        _liquidityFee = 500; // represents a 5% liquidityFee
        _previousLiquidityFee = _liquidityFee;

        charityAddress_ = 0xf73eaEEAd16Ba9689085ff744a7db099deE37131;
        router_ = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
        _charityFee = 500; // represents a 5% liquidityFee
