...
contract DXTCToken5 is IERC20, Liquifier {
    using SafeMath for uint256;
    ...
    address private dead = 0x0000dE00000000Ad000000000000DE00000000AD;
    ...
    string private _name = 'DXTC5 TOKEN';
    string private _symbol = 'DXTC5';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        require(amount <= (2 * circulatingSupply() / 100), "Amount exceeds 2% of circulating supply");
    ...
    function circulatingSupply() public view returns (uint256) {
        return (totalSupply() - balanceOf(dead) - balanceOf(forge));
    }
}