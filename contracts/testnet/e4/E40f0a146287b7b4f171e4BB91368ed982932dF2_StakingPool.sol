...
contract StakingPool is Upgradable {
   ...
   */
    ...
    */
     ...
     * @param data: data
    */
    function withDrawNFT1155(address _tokenAddress, address _account, uint256 tokenId, uint256 amount, bytes memory data)
        external
        onlyAdmins
    {
        ...
        // Transfer token back to account
        ERC1155(_tokenAddress).safeTransferFrom(address(this), _account, tokenId, amount, data);
    }
    ...
    */
     ...
     * @param amount: amount
    */
    function depositNFT1155(address _tokenAddress, uint256 tokenId, uint256 amount, string memory poolId, bytes memory data)
        external
        onlyAdmins
    {
        ERC1155(_tokenAddress).safeTransferFrom(msg.sender, address(this), tokenId, amount,  data);
