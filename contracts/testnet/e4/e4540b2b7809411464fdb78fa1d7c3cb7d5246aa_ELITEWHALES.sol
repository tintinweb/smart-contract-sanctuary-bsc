...
contract DividendTracker is DividendPayingToken {
  ...
  constructor(
    ...
    minimumTokenBalanceForDividends = 1_000_000_000 * 10**9; // must hold 1 billion tokens which equates to 0.0001% of the total  ALD supply
  }
...
// File: contracts/IALD.sol


interface IALD is IERC20, IERC20Metadata {
...
// File: contracts/ ELITEWHALES.sol


contract ELITEWHALES is
  IALD,
  Context,
  ...
  ReentrancyGuard
{
  ...
  constructor() {
    ...
    _numTokensSellToAddToLiquidity = 100000 * (10**uint256(_decimals));
    _dividendRewardToken = 0x33251bA4824D2BC7Db89Ab3919564571e552785C;
    _marketingWallet = 0x879A78CABD929870772e6b207E77709cF5027566;
    _liquidityWallet = msg.sender;
    
    _liquidityFee = 3;
    _marketingFee = 5;
    _dividendRewardsFee = 2;
   
    _setupRole(DEFAULT_ADMIN_ROLE, msg.sender);

    _setupDividendTracker();

    setMaxTxPercent(10000 * (10**uint256(_decimals)));
    setMaxWalletPercent(1000000000000000 * (10**uint256(_decimals)));
    changeFees(_liquidityFee, _marketingFee, _dividendRewardsFee);
  ...
  function _setupPancakeswap() private {
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      'ALPD: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs'
    );
  ...
  function _setAutomatedMarketMakerPair(address pair, bool value) private {
    require(
      ...
      'ALPD: Automated market maker pair is already set to that value'
    );
    ...
    onlyRole(DEFAULT_ADMIN_ROLE)
  {
    require(
      ...
      ' ALD: The dividend tracker already has that address'
    );
    ...
    require(
      ...
      ' ALD: The new dividend tracker must be owned by the token contract'
    );
