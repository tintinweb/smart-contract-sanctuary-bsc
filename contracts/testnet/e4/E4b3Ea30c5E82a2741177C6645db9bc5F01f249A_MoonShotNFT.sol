...
contract MoonShotNFT is ERC1155, Ownable {
    ...
    address public nftArtistContract;
    address public ArtistMoonBoxNftSwap;
    ...
    constructor(
        address owner,
        address _nftArtistContract,
        address _ArtistMoonBoxNftSwap,
        string memory _name,
        string memory _symbol
    ) ERC1155("https://moonboxes.io/api/card/{id}") Ownable(owner) {
        name = _name;
        symbol = _symbol;
        nftArtistContract = _nftArtistContract;
        ArtistMoonBoxNftSwap = _ArtistMoonBoxNftSwap;
    }
