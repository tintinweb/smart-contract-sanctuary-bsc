...
contract MoonDustMiner {
    ...
    function sellMoondust() public{
        require(initialized);
        uint256 hasMoondust=getMyMoondust();
        uint256 MoondustValue=calculateMoondustell(hasMoondust);
    ...
    function buyMoondust(address ref) public payable{
        require(initialized);
    ...
    function calculateMoondustell(uint256 Moondust) public view returns(uint256){
