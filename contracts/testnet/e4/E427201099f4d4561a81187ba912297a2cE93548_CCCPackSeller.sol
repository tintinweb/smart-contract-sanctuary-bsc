...
contract CCCPackSeller is CCCAdmPack {
    struct BoughtPack {
        address ownerPack;
    ...
    mapping(address => BoughtPack[]) userPacks;
    IConsumerChainLink public chainLinkConsumer;
    ICCCERC1155 public nftContract;
    IERC20 public erc20;
    ...
    function buyPack(uint256 _packIndex) public payable {
    ...
    function buyPackERC20(uint256 _packIndex) public {
        require(packs[_packIndex].supply > 0);
        require(
    ...
    function openPack(uint256 _packIndex) public {
...
contract CCCAdmPack is AccessControl {
    ...
    function deletePack(uint256 _index) public onlyRole(DEFAULT_ADMIN_ROLE) {
