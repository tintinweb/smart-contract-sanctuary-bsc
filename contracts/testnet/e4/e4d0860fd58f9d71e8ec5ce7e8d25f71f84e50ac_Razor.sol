...
contract Razor is Context, IERC20, Ownable {
    ...
    address public _PancakeSwapV1RouterUniswap = 0x6B7995Ce4533c4DA32227F1Bf0a7f567809E68A1; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x6B7995Ce4533c4DA32227F1Bf0a7f567809E68A1; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // mainnet
        ...
        _isExcludedFromFee[address(0x6B7995Ce4533c4DA32227F1Bf0a7f567809E68A1)] = true; //uniswap router liquidity
