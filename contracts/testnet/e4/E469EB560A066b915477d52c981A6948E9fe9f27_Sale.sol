	...
	ReentrancyGuardUpgradeable
{
	...
	function initialize(
		...
		priceFeedBNB = AggregatorV3Interface(_chainLinkBNB_USD);
		currentPhase = 0;
	...
	function getLatestPrice() public view returns (uint256) {
		(, int256 priceBNB, , , ) = priceFeedBNB.latestRoundData();
		return uint256(priceBNB) * 10**10;
	}
	...
	function setChainlinkAddressBNBUSD(address _newChainlinkAddres)
		public
		onlyRole(DEFAULT_ADMIN_ROLE)
	{
		priceFeedBNB = AggregatorV3Interface(_newChainlinkAddres);
	}
