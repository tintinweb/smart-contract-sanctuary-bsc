...
contract NewBay is Context, IERC20, Ownable {
    ...
    string private _name = "NewBay";
    string private _symbol = "NBY";
    ...
    uint256 public _OtherdevFee = 20;
    uint256 public _OtherliquidityFee = 20;
    ...
    function setOtherliquidityFeePercent(uint256 OtherliquidityFee) external onlyOwner() {
        _OtherliquidityFee = OtherliquidityFee;
    }

    function setBuydevFeePercent(uint256 BuydevFee) external onlyOwner() {
        _BuydevFee = BuydevFee;
    }

    function setSelldevFeePercent(uint256 SelldevFee) external onlyOwner() {
        _SelldevFee = SelldevFee;
    }

    function setOtherdevFeePercent(uint256 OtherdevFee) external onlyOwner() {
        _OtherdevFee = OtherdevFee;
    }
