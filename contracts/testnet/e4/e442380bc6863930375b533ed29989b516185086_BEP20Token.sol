...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  function getAmounts(uint256 index)  public view returns (uint256, uint256, uint256, uint256, uint256) {
    ...
    return (amount2, r0, r1, amount * 1000, amount * slippage);
  }
