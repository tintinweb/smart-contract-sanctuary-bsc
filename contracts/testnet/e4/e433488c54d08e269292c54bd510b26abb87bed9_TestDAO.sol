...
contract TestDAO is Context, IBEP20, Ownable {
    ...
    function setTaxes(uint256[5] memory targetTaxes) external onlyOwner() {
        ...
        _totalTax = 0;
        _totalTax.add(targetTaxes[0]);
        _totalTax.add(targetTaxes[1]);
        _totalTax.add(targetTaxes[2]);
        _totalTax.add(targetTaxes[3]);
        _totalTax.add(targetTaxes[4]);
