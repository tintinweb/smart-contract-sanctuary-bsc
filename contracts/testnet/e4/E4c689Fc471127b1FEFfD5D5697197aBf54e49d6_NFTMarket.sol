...
contract NFTMarket is ReentrancyGuard {
    ...
    Counters.Counter private _itemsSold; //total number of items sold
     ...
     address payable owner; //owner of the smart contract(owner receives paments)
    //people have to pay to puy their NFT on this marketplace
    uint256 listingPrice = 0.025 ether;
    // address payable operater;
    // bool approved;
    ...
    mapping(uint256 => MarketItem) private idMarketItem;//ex: idMarketItem[4] returns the item 4 in MarketItem
   ...
   /// @notice function to create market item
    function createMarketItem(
        address nftContract, //contract address of the person how put item for sale
        uint256 tokenId,
        ...
        function fetchMarketItems() public view returns (MarketItem[] memory){
            ...
            //total number of items that are unsold = total items ever been created - total items ever been sold
        ...
        // cal how much the person selling nft
       // how much they made in the platform buying nft
}
