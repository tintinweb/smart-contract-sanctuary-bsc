...
contract EquipmentERC1155 is ERC1155Upgradeable, AccessControlUpgradeable, IEquipmentERC1155, HoldEnumerable, EIP2981 {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC1155Upgradeable, AccessControlUpgradeable, EIP2981) returns (bool) {
        return interfaceId == type(IEquipmentERC1155).interfaceId || super.supportsInterface(interfaceId);
    }
    ...
    function createEquipment(
        ...
        nextEquipmentId();
        uint256 typeIndex = Random.createRandom(1, length, seed, totalEquipment) - 1;
        ...
        {
            uint8 aggressivity = Random.createRandom(1, 50, seed, totalEquipment);
            uint8 defensive = Random.createRandom(1, 50, seed, aggressivity);
            uint8 healthPoint = Random.createRandom(1, 50, seed, defensive);
        ...
        _addHold(totalEquipment, recipient);
        _setAuthor(totalEquipment, recipient);
        _mint(recipient, totalEquipment, 1, "");
        emit EquipmentCreated(childType, totalEquipment, recipient, boxId);
    }
