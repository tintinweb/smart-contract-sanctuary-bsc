 ...
 * @notice: This is to replace the contract abstract splitter for [ReDaCtEd]
 */
...
contract RedactedSplitter is PaymentSplitterV3 {
...
abstract contract PaymentSplitterV3 is MaxAccess
  ...
  , address account
    ...
    return (totalReceived * _shares[account]) / _totalShares - _erc20TotalReleased[token];
  }
