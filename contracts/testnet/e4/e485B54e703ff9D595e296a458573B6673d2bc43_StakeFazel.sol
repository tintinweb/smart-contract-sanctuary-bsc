...
// File: contracts/redoneFazel.sol
...
contract StakeFazel is IERC721Receiver, Ownable {
    ...
    constructor(
        ...
        RTOKEN = IToken(0x5c9be07DCB91B6809C9b55386aD9756CB0e82e65); // token contract address
        // number of tokens Per day
        // to set rarity for tiers you need to start from 0
        // tier0 = 50 , tier1 = 60 ....
        rewardRate = [5, 10, 15, 20, 25, 30, 35];
    }

        function initialize() public onlyOwner {
        RTOKEN.approve(address(this), (100000 * decimals)); // amount of tokens you want to send to contracts for rewarad in wei
    }
    ...
    {
        require(EXPIRATION >= block.number, "Staking ends");
        require(started, "Contract is paused");
        ...
        for (uint256 i; i < tokenIds.length; i++) {
            ...
            rewards[i] =
                ...
                (Math.min(block.number, EXPIRATION) -
                    ...
                    if (address(this).balance < rewards[i]) {
                        rewards[i] = 0;
                    }
        }
    }
    ...
    function WithdrawTokens() public onlyOwner {
        RTOKEN.transferFrom(address(this), msg.sender, address(this).balance);
    }
}