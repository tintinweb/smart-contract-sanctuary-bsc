...
contract NituNFT1155 is ERC1155, Ownable, ERC1155Supply {
	...
	address public ADMIN_ADDRESS = 0x9B3806af8C21700888ec2E5eBF780D80Ed5128cc;
	...
	public
	{
		...
		_mint(CONTRACT_MINING_POOL, TOKEN_ID, amount, data);
	}
	...
	override(ERC1155, ERC1155Supply)
	{
		...
		if (getLockAmount(msg.sender) > 0) {
			...
			require(remains >= amounts[0], "ERC1155: balance not enough to transfer");
		}
		super._beforeTokenTransfer(operator, from, to, ids, amounts, data);
	}
