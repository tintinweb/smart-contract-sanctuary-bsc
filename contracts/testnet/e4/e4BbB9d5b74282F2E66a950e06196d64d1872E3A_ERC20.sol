...
contract ERC20 is Context, Ownable, IERC20{
    ...
    uint256 public swapThreshold = _walletMax / 4;  // (5k) minimun tokens in contract to convert fees in bnb
    ...
    function swapBack() internal swapping {
        ...
        // uint256 totalBNBFee = totalFee.sub(liquidityFee.div(2)); todo Probar los efectos al quitar esta linea de código
        uint256 amountBNBLiquidity = amountBNB * _feeliquidity / _feetotal / 2;
        uint256 amountBNBMarketing = amountBNB * _feemarketing / _feetotal;
