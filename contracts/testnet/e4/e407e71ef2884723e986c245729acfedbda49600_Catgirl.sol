...
contract Catgirl is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x826F5230B6179C8C7e97C985386C65446223824f); // Marketing Address
    address payable public teamWalletAddress = payable(0xf98a6199894083F5503AdCbBD2EF82a399E59f8B); // Team Address
