...
// File: https://github.com/Alexander-Herranz/OpenZeppelin-Crowdsale-updated-solidity-v8/blob/0.8.0/Crowdsale-v8.sol
...
// File: contracts/ERC20Crowdsale.sol
...
contract ERC20Crowdsale is Crowdsale, Ownable {
    
    uint256 public myRate = 10;    
    address payable public myWallet = payable(0x617F2E2fD72FD9D5503197092aC168c91465E7f2);    
    IERC20 public myToken = IERC20(0xd9145CCE52D386f254917e481eB44e9943F39138);

    constructor()Crowdsale(myRate, myWallet, myToken){}

    function updateRate(uint256 newRate) external onlyOwner returns (bool) {
        _rate = newRate;
        return true;
    }

    function updateWallet(address newWallet) external onlyOwner returns (bool) {
        _wallet = payable(newWallet);
        return true;
    }
