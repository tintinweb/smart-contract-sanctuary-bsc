...
contract Test{
    ...
    constructor(address ownerAddress, IBEP20 _TestToken, address _first_wallet, address _second_wallet, address _third_wallet, address _fourth_wallet, address _fifth_wallet, uint256 _totalToken, uint256 _dailyPercent) 
    {
        owner = ownerAddress;        
