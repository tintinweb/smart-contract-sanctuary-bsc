...
contract StarNFTV3 is ERC721, IStarNFT, Ownable, ERC721Enumerable {
    ...
    /* ============ Constructor ============ */
    constructor() ERC721("", "") {
        myBaseURI = "https://graphigo.prd.galaxy.eco/metadata/0x9f471abcddc810e561873b35b8aad7d78e21a48e/";
    }
    ...
    function tokenURI(uint256 id) public view override returns (string memory) {
        ...
        if (bytes(_myBaseURI()).length == 0) {
            return "";
        } else {
            return string(abi.encodePacked(_myBaseURI(), uint2str(id), ".json"));
        }
    }
