...
contract OlympiaXPsychic is IBEP20, Auth {
    using SafeMath for uint256;

    //address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //live
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;  //test
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "OlympiaXPsychic";
    ...
    constructor () Auth(msg.sender) {
        //router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //live
