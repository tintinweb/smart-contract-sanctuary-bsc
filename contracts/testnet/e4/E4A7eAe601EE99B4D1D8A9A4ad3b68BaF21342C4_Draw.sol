...
contract Withdrawable is BusinessRole {
    ...
    function withdraw(uint256 amount, address[] memory erc20s, uint256[] memory amountErc20s) public onlyOwner {
        _withdraw(amount);
...
contract Draw is  Signer, Withdrawable {
    ...
    IERC20 public OwaDrawErc20 = IERC20(0xc111cb11E22B622fb66083777A2BBf52665a611d);
    IERC721 public OwaDrawErc721 = IERC721(0x0d13c60d120d1F23517D244945e4a49468ca881c);
