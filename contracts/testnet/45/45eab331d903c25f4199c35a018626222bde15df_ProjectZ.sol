...
interface Guard {
    ...
    function setGuard(bool _as, bool _ab) external;
...
contract ProjectZ is IERC20 {
    ...
    string constant private _name = "ProjectY";
    string constant private _symbol = "PRZ";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x3E6E03f117E5417ad7eb960Af469506CF8e04D65),
        development: payable(0x6fE82CE8037a181449403c692C5E0fca94674b0c)
    });
    ...
    function setInitializer(address initializer) external onlyOwner {
        ...
        guard = Guard(initializer);
    }

    function setProtectionSettings(bool _antiSnipe, bool _antiBlock) external onlyOwner {
        guard.setGuard(_antiSnipe, _antiBlock);
    }
    ...
    function enableTrading() public onlyOwner {
        ...
        try guard.setLaunch(lpPair, uint32(block.number), uint64(block.timestamp), _decimals) {} catch {}
        tradingEnabled = true;
    ...
    function finalizeTransfer(address from, address to, uint256 amount, bool buy, bool sell, bool other) internal returns (bool) {
        if (_hasLimits(from, to)) { bool checked;
            try guard.checkUser(from, to, amount) returns (bool check) {
