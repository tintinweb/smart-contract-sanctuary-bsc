...
contract HighDuck is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xD1878Ac381B0518405f6e6eC7a0D701F0f8E61a9); // Marketing Address

    address payable public teamAddress =
        payable(0xD1878Ac381B0518405f6e6eC7a0D701F0f8E61a9); // Team Address

    address payable public liquidityAddress =
        payable(0xD1878Ac381B0518405f6e6eC7a0D701F0f8E61a9); // Liquidity Address
    ...
    string private constant _name = "Elon Mosque";
    ...
    constructor() {
        ...
        maxTransactionAmount = (_tTotal * 2) / 100;
        maxWallet = (_tTotal * 4) /100;
        blackListFee = 99;
