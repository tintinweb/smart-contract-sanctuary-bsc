...
contract SAUDIFLOKI is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x77d1a6FAdf2889cd0a1916C1ea8B5093CcE2c89E); 
    address payable public Wallet_Dev = payable(0x77d1a6FAdf2889cd0a1916C1ea8B5093CcE2c89E);
    ...
    string private constant _name = "SaudiFloki"; 
    string private constant _symbol = unicode"SAUDIFLOKI"; 
    ...
    constructor () {
        ...
        _owner = 0x77d1a6FAdf2889cd0a1916C1ea8B5093CcE2c89E;
