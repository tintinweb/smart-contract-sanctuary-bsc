...
contract LaunchPool {
    ...
    function _finalize() internal {
        ...
        if (IERC20(tokenB) == IERC20(wBNB)) {
            ...
            uint256 forLiquidity = balance
                .sub(forFee)
                .mul(addToLiquidityPercentage)
                .div(100);
            uint256 forOwner = balance.sub(forFee).sub(forLiquidity);

            payable(launchPoolFactory).transfer(forFee);
            ...
            IERC20(tokenB).transfer(launchPoolFactory, forFee);
