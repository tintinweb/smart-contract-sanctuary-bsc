...
contract ClaimToken is Ownable {
    ...
    uint256 public amountClaim = 1000 * 10**18;
    mapping(address => bool) private userClaim;
   ...
   function claim() external {
       require(userClaim[_msgSender()] == false, "User exits");
       IERC20(gameToken).transfer(_msgSender(), amountClaim);
       userClaim[_msgSender()] = true;
   }
