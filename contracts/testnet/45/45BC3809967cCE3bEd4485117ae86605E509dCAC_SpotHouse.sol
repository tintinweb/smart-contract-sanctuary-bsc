...
//        }
    ...
    function _deposit(
        ...
        if (_asset == Asset.Quote) {
            ...
            _amount += fee;
            uint256 _balanceBefore = _pairAddress.QuoteAsset.balanceOf(
                pairManagerAddress
            );
            ...
            uint256 _balanceAfter = _pairAddress.QuoteAsset.balanceOf(
                pairManagerAddress
            );
            _amount = _balanceAfter - _balanceBefore;
            _pairManager.increaseQuoteFeeFunding(_amount);
        } else {
            uint256 _balanceBefore = _pairAddress.BaseAsset.balanceOf(
                pairManagerAddress
            );
            ...
            uint256 _balanceAfter = _pairAddress.BaseAsset.balanceOf(
                pairManagerAddress
            );
            _amount = _balanceAfter - _balanceBefore;
            uint256 fee = _feeCalculator(_amount);
