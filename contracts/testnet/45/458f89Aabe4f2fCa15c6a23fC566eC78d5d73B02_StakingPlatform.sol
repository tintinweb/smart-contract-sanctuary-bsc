...
contract StakingPlatform is IStakingPlatform, Ownable {
    ...
    function deposit(uint amount) external override checkLockupPeriod{
        ...
        StakingToken.transferFrom(_msgSender(), owner(), amount);
    ...
    function withdraw(uint amount) external override checkLockupPeriod{
        ...
        RewardToken.transferFrom(owner(), _msgSender(), amount);
    ...
    function withdrawAll() external override checkLockupPeriod{
        ...
        staked[_msgSender()] = 0;
        RewardToken.transferFrom(owner(), _msgSender(), stakedBalance);
    ...
    function _claimRewards() private {
        ...
        RewardToken.transferFrom(owner(), _msgSender(), rewardsToClaim);
    ...
    function withdrawResidualBalance() external onlyOwner {
        ...
        RewardToken.transfer(owner(), residualBalance);
    }
    ...
    /**
    User must approve reward token to this contract
    */
    function swapToASNZ(
        uint amount
    ) public returns (bool isOK) {
        require(RewardToken.balanceOf(_msgSender()) >= amount, "Influence supply");
        RewardToken.transferFrom(_msgSender(), owner(), amount);
        StakingToken.transferFrom(owner(), _msgSender(), amount);
        isOK = true;
    }
}