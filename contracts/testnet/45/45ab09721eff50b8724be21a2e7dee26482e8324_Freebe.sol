...
contract Dao {
    ...
    constructor(string memory _daoName,string memory _daoLogo,string memory _daoMission,uint8 _daoColor,address _daoCreater) {
        baseInfo=baseDao(_daoName,_daoLogo,_daoMission,_daoColor,_daoCreater);
        owner=msg.sender;
    }
...
contract Freebe {
    ...
    function createDao(string memory _daoName,string memory _daoLogo,string memory _daoMission,uint8 _daoColor) public {
        Dao newdao=new Dao(_daoName,_daoLogo,_daoMission,_daoColor,msg.sender);
