...
contract SexnToken is BEP20Detailed, BEP20 {
  ...
  constructor() BEP20Detailed("LUBINGO", "LUB", 18) {
    uint256 totalTokens = 18000000 * 10**uint256(decimals());
    _mint(msg.sender, totalTokens);
    sellTax = 3;
    buyTax = 3;
    transferTax = 0;
    tradeCooldown = 15;
    marketingPool = 0x44e64B4EB3D5992D96d4C5839E78b39337577179;
  }
