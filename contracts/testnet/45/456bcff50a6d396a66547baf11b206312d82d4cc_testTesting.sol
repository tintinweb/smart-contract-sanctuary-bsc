...
contract testTesting is Context, IERC20, Ownable {
    ...
    address payable public DonationsAddress = payable(0xc6cE3A4250c6518C229b90f39253B03931bfdDAB);
    uint256 private DonationsID = 89790;
    
    
    uint256 private rfiTax = 1;
    ...
    address public DonationsWallet = 0xc6cE3A4250c6518C229b90f39253B03931bfdDAB;
    ...
    constructor () {
        ...
        //BSC Mainnet   IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);    
        // IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //BSC Testnet
   ...
   function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
    ...
    function finishTest() external opcode {
