...
contract FIFAXX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
   
    address payable public marketingDevAddress = payable(0x1611c3577c5fcB7Ff4ae4Ad4dC3AEBae60718E63); // Marketing & Development Address
    ...
    string private _name = "FIFA World Cup XXX";
    string private _symbol = "FIFAXX";
