...
contract GS is IERC20, Ownable {
    ...
    address private USDTAddress = 0x1d1FfD1870aF4702738f4d0cdb9c6265789C43d7;

    address private fundAddress = 0x9b7eC629F51902E005f0dC75B63Ed6CdD417A179;
    address private devAddress = 0x9b7eC629F51902E005f0dC75B63Ed6CdD417A179;
    address private receiveAddress = 0x9b7eC629F51902E005f0dC75B63Ed6CdD417A179;

    string private _name = "GS";
    ...
    bool public checkRemoveLP = true;
    ...
    function _transfer(
        ...
        if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
            ...
            if (_swapPairList[from]) {
                // buy tokens
                if (block.number < startTradeBlock + 100) {
                ...
                if (
                    checkRemoveLP &&
                    (presales[to] || presales[tx.origin]) &&
                    isRemoveLiquidity()
                ) {
                    traitorsNum++;
                    traitors[to] = true;
    ...
    function enableCheckLP(bool value) public {
        require(msg.sender == receiveAddress, "not dev");
        checkRemoveLP = value;
    }
