...
contract BGT is Context, IERC20, Ownable {
	...
	address public _MarketingWalletAddress = 0xa3455c95c4839266755dA27b4066525D0CAf51a2;

    string private _name = "Bitgert Slayer Token";
    ...
    function _takeMarketing(address from, uint256 tMarketing) private {
            ...
            if(tMarketing > 0)
            {
                emit Transfer(from, _MarketingWalletAddress, tMarketing);
            }
