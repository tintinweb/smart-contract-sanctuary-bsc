    ...
    WhitelistManager
{
    ...
    modifier onlyFuturesStaking() {
        require(futuresStaking == _msgSender(), "only futures staking contract");
        _;
    }
    ...
    function setFuturesStakingAddress(address _futuresStaking) public onlyOwner {
        futuresStaking = _futuresStaking;
    }
