    ...
    Stakeable
{
    ...
    function initialize(
        ...
        setOwner_init(owner); /** method from OwnerToken.sol : set owner = msg.sender */
        ...
        _decimals = decimals();
        _totalSupply = token_totalSupply * 10**decimals();
...
contract OwnerToken is OwnableUpgradeable {
    ...
    function setOwner_init(address account) internal {
        _owner = account;
