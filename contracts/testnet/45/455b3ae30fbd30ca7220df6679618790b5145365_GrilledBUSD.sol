...
/*
    ...
    SPECS:
    - 3-6% daily
    - 100k BUSD Max Wallet TVL
    - 2000 BUSD Max Reward Accumulation 
...
contract GrilledBUSD is Initializable, OwnableUpgradeable {
    ///@dev no constructor in upgradable contracts. Instead we have initializers
    function initialize() public initializer {
        ///@dev as there is no constructor, we need to initialise the OwnableUpgradeable explicitly
        __Ownable_init();
        BUSD = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
        DEV_ADDRESS = 0xB20ad2502d19a495d7172F60c74958C944038156;
        MARKETING_ADDRESS = 0xB20ad2502d19a495d7172F60c74958C944038156;
        CEO_ADDRESS = 0xB20ad2502d19a495d7172F60c74958C944038156;
        GIVEAWAY_ADDRESS = 0xB20ad2502d19a495d7172F60c74958C944038156;
