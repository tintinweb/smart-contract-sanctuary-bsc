...
contract Box is Ownable{
    ...
    Game public  _game;
    BADHero _badHero;
    GetFee public router = GetFee(0x0a2231B33152d059454FF43F616E4434Afb6Cc64);
    ...
    function buyBox()  public returns(uint,uint) {
        ...
        uint num ;
        amount = router.getUsdtPrice1(_boxPrice);
    ...
    function openBox(uint32 _index)  public {
        ...
        _game.createCard(tokenId,_monster.ce,_monster.armor,_monster.luk,block.timestamp+_lockTime, nftKindId,_monster.name,_temNum);
        //删除盲盒
    ...
    function getBoxPrice() public view returns(uint[] memory amounts){
        amounts = router.getUsdtPrice(_boxPrice);
        return amounts;
    }
