...
contract BUSDPay is ERC20, Ownable {
    ...
    constructor() ERC20("BUSD Pay", "B pay") {
    ...
    function updateBuyFees(uint256 _rewardFeeOnBuy,uint256 _marketingFeeOnBuy,uint256 _liquidityFeeOnBuy,uint256 _burnTaxFeeOnBuy) external onlyOwner {
        require(_rewardFeeOnBuy + _marketingFeeOnBuy + _liquidityFeeOnBuy + _burnTaxFeeOnBuy <= 100, "Fees must be equal or less than 10%");
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            uint256 rewardBNB;
            if(rewardShare > 0) {
                rewardBNB = (newBalance * rewardShare) / shares;
