...
contract Overload is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Overload";
    string private _symbol = "Overload";
    uint8 private _decimals = 9;

    uint public killblock = 2;
    address payable public marketingWalletAddress = payable(0x7AFd6849Fe5A80769CBC4171C17292D296B801c9); // Marketing Address
    address payable public teamWalletAddress = payable(0xBaEd38Dc67242b918C5111a999137Cd4c9503550); // Team Address
