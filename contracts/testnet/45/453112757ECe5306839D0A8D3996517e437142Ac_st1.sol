...
contract st1 is Owner, ReentrancyGuard {
    ...
    constructor(
        ...
        Iluckblocks _luckblocks = Iluckblocks(0x7eeD9fab53670de3C367ab6Fa1758036C69c3ee8);
    ...
    function btLk() public {
        uint256 amountNecessary = 5000000000000000000;
        asset2.safeTransferFrom(address(msg.sender), address(this), amountNecessary);
        asset2.approve(address(luckblocks), amountNecessary);
        luckblocks.BT2(amountNecessary,3);
    }
    // JUST FOR TEST //
