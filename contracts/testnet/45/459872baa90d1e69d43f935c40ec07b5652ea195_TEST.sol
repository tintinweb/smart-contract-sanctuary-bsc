...
contract TEST is IBEP20, Auth {
    ...
    address public potFeeReceiver = 0x392Ca783f0D40D422214Dfff17886319a34aDd25;
...
*/
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _potFee,uint256 _burnFee, uint256 _feeDenominator) external authorized {
        liquidityFee = _liquidityFee;
        marketingFee = _marketingFee;
        potFee = _potFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee.add(_marketingFee).add(_potFee).add(_burnFee);
    ...
    function setFeeReceiver(address _marketingFeeReceiver, address _devFeeReceiver, address _burnFeeReceiver) external authorized {
