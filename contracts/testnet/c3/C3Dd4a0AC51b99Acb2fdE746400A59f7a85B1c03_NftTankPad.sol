...
contract NftTankPad is ERC721Enumerable, Ownable{
    ...
    // Function to view contract current balance
    function viewbalance() public view returns(uint256){
        return address(this).balance;
    }

   // Function to mint new NFTs during the public sale
    function mint(uint256 _numOfTokens) public payable returns(uint256){
        ...
        require(mainSaleClaimed[msg.sender].add(_numOfTokens) <= MAINSALE_PURCHASE_LIMIT,"Maximum NFT Purchaged");
