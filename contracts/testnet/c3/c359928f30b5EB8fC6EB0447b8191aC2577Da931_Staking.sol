...
contract Staking is AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    */
    ...
    /// @notice Checks whether the address is a candidate for DEV_ROLE
    /// @param _account address to check
    /// @return Returns true if address is in candidates set else false
    function isCandidate(address _account) external view returns(bool) {
        return _candidates.contains(_account);
    }
