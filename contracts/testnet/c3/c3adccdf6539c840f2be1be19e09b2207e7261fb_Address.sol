...
contract BSCTest is Context, IERC20, Ownable {
    ...
    string private _name = "BSCTest";
    string private _symbol = "BSCT";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x56B6460ecD0516F4CAD3048718ddEfEBd4cc1980);
    address payable public liqWalletAddress = payable(0x56B6460ecD0516F4CAD3048718ddEfEBd4cc1980);
