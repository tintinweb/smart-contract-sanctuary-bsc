...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 WBNB = IERC20(0xBdf1a2e17DECb2aAC725F0A1C8C4E2205E70719C);
    ...
    constructor (address _router) {
        ...
        : IPancakeSwapRouter(0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81);
        _token = msg.sender;
    }
...
contract RASDFDIV is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("RASDF DIV", "RASDFDIV", uint8(DECIMALS)) Ownable() {
        ...
        teamReceiver = 0x23D56a5Ce0c69f6bC03269fa79d652Faa56cfcb2;
        marketingReceiver = 0xa6A61aD6A6293F45a48F17650Cd8a313535185A6;  
        burnAddress = 0x000000000000000000000000000000000000dEaD;
        admin = 0x5907a17f559C448955Bd3bab785798Bf007aBB8a;

        _allowances[address(this)][address(router)] = uint256(-1);
        pairContract = IPancakeSwapPair(pair);

        distributor = new DividendDistributor(0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81);
    ...
    function withdrawAllTomarketing() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _balances[address(this)];
        require( amountToSwap > 0,"There is no RASDFDIV token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
