...
contract AccessPass is ERC1155, Ownable, Pausable {
    ...
    function getAccessPassNativePrice(uint256 id)
        ...
        returns (uint256)
    {
        require(id < 6, "ID must be less than 6.");

        if (id == 0) {
            return pricesUSD[0].div(uint256(getLatestPrice())).mul(10**8);
        } else if (id == 1) {
            return pricesUSD[1].div(uint256(getLatestPrice())).mul(10**8);
        } else if (id == 2) {
            return pricesUSD[2].div(uint256(getLatestPrice())).mul(10**8);
        } else if (id == 3) {
            return pricesUSD[3].div(uint256(getLatestPrice())).mul(10**8);
        } else if (id == 4) {
            return pricesUSD[4].div(uint256(getLatestPrice())).mul(10**8);
        } else if (id == 5) {
            return pricesUSD[5].div(uint256(getLatestPrice())).mul(10**8);
        }
    }
