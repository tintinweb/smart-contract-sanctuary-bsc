...
contract BuyBack {
    ...
    function buyAndBurnToken(
        ...
        if (_wantAdd != _rewardToken) {
            ...
            IERC20(_wantAdd).safeIncreaseAllowance(0xD00C7e4c6bDd8FE20159E31FaD5389482CDbE46B, _wantAmt);
            _path = [_wantAdd, _rewardToken];

            IPancakeRouter02(0xD00C7e4c6bDd8FE20159E31FaD5389482CDbE46B).swapExactTokensForTokensSupportingFeeOnTransferTokens(
                _wantAmt,
                _minBurnAmt,
                _path,
                address(this),
