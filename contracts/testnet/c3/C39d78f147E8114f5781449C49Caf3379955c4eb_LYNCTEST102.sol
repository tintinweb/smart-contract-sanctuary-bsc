...
contract LYNCTEST102 is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    address public liquidityReceiver     = 0x3094b95229DEE87b8bcb8D4bf264620AE334FD04;
    address public treasuryReceiver      = 0xcD688eEe212403334CefA934756979123FBAd80d;
    address public riskFreeValueReceiver = 0x22A3B676157A2d4D59688550310cC8b3b160Ef73;
  ...
  //address public busdToken             = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // mainnet
    address public charityReceiver       = 0xE11fc4B8e0EaB2A920bC4014bA9eAf8601377345;
    address public caseReceiver          = 0x8620C5b9b195831b36a3060D5281A57cda23776a;
    ...
    uint256 public amountLimitMin = 10 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("LYNCTEST102", "LT102", uint8(DECIMALS)) {
        ...
        setWhiteListedUser(msg.sender, true);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (
            ...
            uint256 amountLimit = balanceOf(sender).mul(SellLimit).div(100); //Should use variable
            if( amountLimit < amountLimitMin ) {
                amountLimit = amountLimitMin;
            }
            require(amount <= amountLimit, "ERR: Can't sell more than set %");
            ...
            if( blkTime >= tradeData[sender].lastTradeTime + TwentyFourhours) {
                ...
                require(tradeData[sender].tradeAmount + amount <= amountLimit, "ERR: Can't sell more than set % in One day");
                tradeData[sender].tradeAmount = tradeData[sender].tradeAmount + amount;
            }
            else {
                // Failed conditions. error.
                require(false, "ERR: Can't sell; unexpected condition; wait and try again.");
            }
        }
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            ...
            _swapTokensForBNB(quarter.add(quarter), charityReceiver);
    ...
    function addWhitelisted(address account) public onlyWhitelisted {
        ...
        setWhiteListedUser(account, true);
    }

    function removeWhitelisted(address account) public onlyWhitelisted {
        _removeWhitelisted(account);
        setWhiteListedUser(account, false);
    }

    function setSellLimit(uint256 _SellLimit) external onlyWhitelisted {
        SellLimit = _SellLimit;
    }

    function setAmountLimitMin(uint256 _amountLimitMin) external onlyWhitelisted {
        amountLimitMin = _amountLimitMin;
    }
    ...
    function setFeeReceivers(address _liquidityReceiver, address _treasuryReceiver, address _riskFreeValueReceiver, address _charityReceiver, address _caseReceiver) external onlyWhitelisted {
        liquidityReceiver = _liquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        riskFreeValueReceiver = _riskFreeValueReceiver;
        charityReceiver = _charityReceiver;
        caseReceiver = _caseReceiver;
    }
