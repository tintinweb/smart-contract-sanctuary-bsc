...
contract TokenTatStaker is Ownable {
    using SafeMath for uint256;
    ...
    */ 
    ...
    uint public minimumBalance = 10**5;
    string constant public lockPeriod = '1 Year';  // locked period in text to be shown by the GUI
    uint256 private contractLockPeriod = 3110400; // 1 year in seconds 
