...
contract Versus_Vault {
   ...
   IVSToken public vtoken = IVSToken(V_Token); //** V Token
   IVSToken public stoken = IVSToken(S_Token); //** S Token    
...
//////WINNER - Initiate BUYBACKsss after game over

//////Battle over --  24 hours after end of game LP WILL BE DRAINED to prepare for next BATTLE!!!
