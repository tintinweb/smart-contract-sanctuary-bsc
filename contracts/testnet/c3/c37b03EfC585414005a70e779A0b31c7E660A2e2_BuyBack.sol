...
contract BuyBack {
    ...
    function buyAndBurnToken(
        ...
        if (_wantAdd != _rewardToken) {
            ...
            IERC20(_wantAdd).safeIncreaseAllowance(0xD99D1c33F9fC3444f8101754aBC46c52416550D1, _wantAmt);
            _path = [_wantAdd, _rewardToken];

            IPancakeRouter02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1).swapExactTokensForTokensSupportingFeeOnTransferTokens(
                _wantAmt,
                _minBurnAmt,
                _path,
                address(this),
