...
contract TradeLine is BEP20, LockToken {
    ...
    address payable public _marketingWalletAddress = payable(0xF66eDB5bc556143263babbd232F5A124d24Ec15b);
    address payable public _buybackWalletAddress = payable(0x350d9EfF951955f88abFe76645E258f8779aC332);
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "TradeLine: Account is already the value of 'excluded'");
