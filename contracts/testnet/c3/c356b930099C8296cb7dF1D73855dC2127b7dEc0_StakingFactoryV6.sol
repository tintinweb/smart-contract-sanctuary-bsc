...
contract StakingVaultV600 is Ownable, Pausable, ReentrancyGuard {
    ...
    */
    ...
    {
        //require(_slot ==0 || _slot ==1);
        //Get block based rewards from distributor contract - updateDualTokenPerShare() is called in here too
        distributeRewards();
    ...
    function updateUserShareAndSendDualToken(address _user, uint256 _slot) internal {
        ...
        if (dualTokenVault == true) {
            ...
            // else {
            //     user.dualTokenDebt[_slot] = 0; //todo this it could be vuln?
            // }
            updateDualTokenPerShare();
    ...
    function distributeRewards() internal whenNotPaused {
        ...
        //updateDualTokenPerShare(); not doing this here here so that it doesn't get repeated on all deposits and withdraws
...
interface IFeeDistributorV6 {
    ...
    function earlyWithdrawExtraFee(uint256) external view returns (uint256);
    ...
    function entryFee(uint256) external view returns (uint256);

    function entryFeeContract() external view returns (uint256);
    ...
    function payoutInNativeToken() external view returns (bool);
    ...
    function performanceFeeOnLocked() external view returns (bool);
    ...
    function rewardFeePerformance() external view returns (uint256);
    ...
    function timedWithdrawFeeOnly() external view returns (bool);
    ...
    function vaultLaunched() external view returns (bool);

    function withdrawFee(uint256) external view returns (uint256);
