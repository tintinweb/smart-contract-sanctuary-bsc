...
contract rug is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x16C4DB808DA631a4A4E9DC0351Ab008A0f1b86F1));
        marketingWalletAddress = payable(address(0x16C4DB808DA631a4A4E9DC0351Ab008A0f1b86F1));
