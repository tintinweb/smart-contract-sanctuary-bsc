...
contract Trator is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Trator";
    string private _symbol = "Trator";
    ...
    uint256 private _Dec = (10 ** _decimals);
    uint256 private _AmountofTokens = 1000000000000;
    uint256 private _totSupply = _AmountofTokens * _Dec;
