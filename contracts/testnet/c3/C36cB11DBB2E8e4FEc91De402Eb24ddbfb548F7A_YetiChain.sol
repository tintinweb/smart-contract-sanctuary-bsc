...
contract YetiChain is IERC20 {
    ...
    string constant private _symbol = "wYETI";
...
//===============================================================================================================
    ...
    function setGenerationRatios(uint16 buySwap, uint16 buyDev, uint16 buyBurn, uint16 sellSwap, uint16 sellDev, uint16 sellBurn) external onlyOwner {
        require(buySwap + buyDev + buyBurn == 10000, "Must equal 100%.");
        require(sellSwap + sellDev + sellBurn == 10000, "Must equal 100%.");
    ...
    function externalLoad(uint256 busdAmount) external onlyOwner {
        IERC20 IERC20_BUSD = IERC20(BUSD);
        IERC20_BUSD.transfer(address(cashier), busdAmount);
        try cashier.load(busdAmount) {} catch {}
    }
