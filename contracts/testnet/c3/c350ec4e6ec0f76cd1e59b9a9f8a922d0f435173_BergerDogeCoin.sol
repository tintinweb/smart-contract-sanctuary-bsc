...
contract BergerDogeCoin is Context, IBEP20, Ownable {
    ...
    string private constant _name = "Berger Doge Coin v2";
    string private constant _symbol = "BergerDoge v2";
    struct Taxes {
        uint256 rfi;
        uint256 marketing;
        uint256 liquidity;
    ...
    // Buy 0% reflection, 0% mkt, 0% dev, 0 loterry
    Taxes public buyTaxes = Taxes(0, 0, 0, 0, 0);
    // Sell 1% reflection, 1% mkt, 45% lq, 45% dev, 1 loterry
    Taxes public sellTaxes = Taxes(1, 1, 45, 45, 1);
