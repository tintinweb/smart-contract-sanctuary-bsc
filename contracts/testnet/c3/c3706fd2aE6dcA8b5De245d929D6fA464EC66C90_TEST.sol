...
contract TEST is IERC20, Ownable {
	...
	address public nft;
    constructor(address tokenOwner,address fundAddressA,IERC20 _usdt,address _nft ) {
        _name = "TEST";
        _symbol = "TEST";
        _decimals = 18;
    ...
    function _tokenTransferBuy(
        ...
        uint256 sumbuyfee;
        sumbuyfee=_baseFee-_markFee-30-20;

         
            processFee(sender, tAmount.div(100).mul(30), 1);
            processFee(sender, tAmount.div(100).mul(20), 2);
   ...
   //     uint256 nftfee,
    ...
    uint256 sumsellfee;
        ...
        sumsellfee=_baseFee-_markFee-_burnFee;
