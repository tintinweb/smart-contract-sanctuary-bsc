...
contract SincereShib is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SincereShib";
    string private _symbol = "SShib";
    uint8 private _decimals = 9;

    address payable  marketingWalletAddress = payable(0x9608B55768255587027c92E2D957B82a487bf2D7);
    address payable  teamWalletAddress = payable(0x8EF2E44771ade052A694Bb2ac80f1cEa216D6264);
    ...
    uint256  _maxTxAmount =   100000000000000000 * 10**_decimals;     
