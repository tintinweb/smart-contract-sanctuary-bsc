...
////////////////////////////////////////////////////////////////////////////////////////////////////////
contract BurningMoon is IERC20, Ownable
{
    ...
    //MainNet
    address private constant PancakeRouter=0x1F1277341A6899530592dCaA783F9A8c12e82609  ;
    ...
    constructor () {
        ...
        _pancakePairAddress = IPancakeFactory(_pancakeRouter.factory()).createPair(address(this), _pancakeRouter.WETH(), true);
    ...
    function ClaimPromotionToken(uint256 amountWei) public payable{
        ...
        IERC20 tokenToClaim=IERC20(promotionToken);
    ...
    function _claimTokenViaContract(address addr, address token, uint256 amountWei,uint256 boostWei) private{
        ...
        path[0] = _pancakeRouter.WETH(); //BNB
        path[1] = token;  
        IERC20 claimToken=IERC20(token);
    ...
    function SetupCreateLP(uint8 ContractTokenPercent, uint8 TeamTokenPercent) public payable onlyTeam{
        require(IERC20(_pancakePairAddress).totalSupply()==0);
