    ...
    ReentrancyGuardUpgradeable
{
    ...
    function addPackItem(uint256 _packId, PackItem memory _packItems)
        public
        gameMasterOnly
    {
        require(_packItems.quantity > 0, "E7003");
        nftPackItems[_packId].push(_packItems);
    ...
    function mintNftPack(uint256 _packId) public nonReentrant {
        require(nftPacks[_packId].exist, "E7004");
        require(
    ...
    function openNftPack(uint256 _tokenId) public nonReentrant {
        ...
        emit NFTPackOpened(packId, _tokenId, msg.sender, uint64(block.timestamp));
    }
