...
contract BadBullsNFTStaking is IERC721Receiver, Ownable {
    ...
    constructor(address _erc721 ) {
        ...
        RTOKEN = IToken(0x9CdA090d70FFEf0B333A2025C7a0C3E3310af9EE); // token contract address
    ...
    function InitializeFirstRound(uint256 _startInBlocks) public onlyOwner() {
        ...
        r.endBlock = Math.max(block.number + (newTokens / r.currentRewardRate), 9999999999);
        isInitialized = true;
    }
    
    function StartPool(uint256 _startInBlocks) public onlyOwner() {
        ...
        r.startBlock = block.number + _startInBlocks;
        lastRewardBlock = r.startBlock;
        r.endBlock = block.number + (newTokens / r.currentRewardRate);
    }
