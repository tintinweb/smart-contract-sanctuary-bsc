...
contract StakingPool {
    ...
    //绑定上级
    function bindParent(address _parentAddr,uint _egnAmount) external{
        //未绑定
        ...
        //给上级转账数量符合
        require(_egnAmount==minEnabledAmount,"The transfer amount must be 0.01");
    ...
    //双币质押
    function addStakingDouble(uint _usdtAmount,uint _egnAmount) external payable{
        ...
        require(msg.value >= 5*10**16 wei,"please provide gas to pool");
    ...
    //单币质押
    function addStakingSingle(uint _egnAmount) external payable{
