...
contract MockPaymentToken is ERC20, ERC20Burnable, Ownable {
    //address public           DEV_ADDRESS = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266; // hardhat
    address public           DEV_ADDRESS = 0x95e9450e2737e2239Be1CE225D79E4B2bE171f71; // EOA
    uint256 public           DEV_TEST_AMOUNT = 10000000000 ether;

    constructor()            ERC20("MockPaymentToken", "MPT") {
      _mint(DEV_ADDRESS, DEV_TEST_AMOUNT);

      transferOwnership(DEV_ADDRESS); // comment out for hh 
    }
