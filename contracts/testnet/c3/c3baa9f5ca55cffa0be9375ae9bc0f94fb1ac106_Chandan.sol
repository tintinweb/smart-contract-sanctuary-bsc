...
contract Chandan is Context, IERC20, Ownable {
    ...
    string  private constant _name = "Chandan"; 
    string  private constant _symbol = "CGD";   
    ...
    uint8   public BuyOrSell = 2;
     address payable public _markWallet = payable(0x81bE1F2616f12a3a0D1e869211E63568b5A7FFF2);
     address payable public _Wallet = payable(0x81bE1F2616f12a3a0D1e869211E63568b5A7FFF2);
    ...
    uint256 public makeLL=100;
    uint256 public _tokenForLiquidity = makeLL;
 ...
 event _addedLiquidity(address thisAddress, uint256 _tokenAmount, uint256 _ETHamount, address pancakRouter);
    ...
    function flowofMkell (uint256 param4) external onlyOwner{
        makeLL=param4;
    }
