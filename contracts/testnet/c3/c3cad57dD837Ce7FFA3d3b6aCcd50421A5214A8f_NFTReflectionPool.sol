    ...
    EIP712Upgradeable
{
    ...
    modifier poolExists(uint256 _pid) {
        require(_pid < poolInfo.length, "NFTReflectionPool: Unknown pool");
        _;
    }
    ...
    function deposit(
        uint256 _pid,
        uint256 _amount
    ) external poolExists(_pid) onlyMunicipality {
    ...
    function claim(
        uint256 _pid,
        uint256 _amount
    ) external poolExists(_pid) onlyEmailVerified(msg.sender) {
