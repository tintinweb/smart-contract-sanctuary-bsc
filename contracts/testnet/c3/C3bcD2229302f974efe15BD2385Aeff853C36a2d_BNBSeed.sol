...
contract BNBSeed {
	...
	function getcurrentwithdrawntime(address userAddress) public view returns (uint256, uint256){
	    return (users[userAddress].withdrawntimes, users[userAddress].withdrawnblocktime);
	}	
