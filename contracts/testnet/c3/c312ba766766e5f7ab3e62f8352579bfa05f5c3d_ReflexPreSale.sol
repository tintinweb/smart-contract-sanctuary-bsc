...
abstract contract Crowdsale {
  ...
  // total user balance
  uint256 public totalUserTokenBalance;
...
contract ReflexPreSale is Crowdsale, Pausable, FinalizableCrowdsale {
  ...
  function dexListing() private {
    ...
    uint256 bnbForLiquidity = ((bnbBalanceInContract - fee) * liquidityPercentage) / 10 ** 2;
    ...
    uint256 refundBalance = tokenBalanceInContract - totalUserTokenBalance - tokensForReflexOwner - tokenForLiquidity;
    if(refundType == 1){
