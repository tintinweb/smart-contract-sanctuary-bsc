...
contract TATOKEN is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0xF7BB9335b558F0480737a76F638a6324ef93Eb32);
    address payable public Wallet_Marketing = payable(0xF7BB9335b558F0480737a76F638a6324ef93Eb32); 
    address payable public constant Wallet_Burn = payable(0xF7BB9335b558F0480737a76F638a6324ef93Eb32);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 3000000000 * 10**_decimals;
    string private constant _name = "TA"; 
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x8ea7eee2A5ac76DD74d8978b9dc3CC933ebE2a4f);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 BNBAmount) private {
        ...
        uniswapV2Router.addLiquidity(
            0xCc7Ba6Ac44E5ed2AC6F61377070420431F9f1A3B,
            address(this),
            BNBAmount,
            tokenAmount,
            0, 
    ...
    function addLiquidity2TESTBNB(uint256 tokenAmount, uint256 BNBAmount) public {
