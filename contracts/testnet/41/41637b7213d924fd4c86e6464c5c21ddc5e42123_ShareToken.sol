...
contract ShareToken is Ownable, ERC20
{
    ...
    constructor(address fairLaunch) ERC20("AMPT Share Token", "AMPT" ) 
    {
        ShareVal = 10 ** decimals();
        FairLaunch = fairLaunch;
        
    }
    function SetFairLaunch_Test(address fairLaunch) public onlyFairlaunch{
        FairLaunch = fairLaunch;
    }
    function mint(address account, uint256 amount) public onlyFairlaunch
    {
