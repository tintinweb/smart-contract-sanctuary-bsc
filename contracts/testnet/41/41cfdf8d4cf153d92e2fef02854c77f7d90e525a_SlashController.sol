...
contract SlashController is ISlashController, Ownable {
        ...
        )
    {
        {   // prevent deep stack error
            ...
            ISlashCore.PaymentInfo memory info;
            info.merchant = _msgSender();
            info.account = account_;
            info.payingToken = payingToken_;
            info.amountIn = amountIn_;
            info.requiredAmount = requiredAmountOut_;
            info.path = path_;
            info.feePath = feePath_;
            info.paymentId = paymentId_;
            info.optional = optional_;
