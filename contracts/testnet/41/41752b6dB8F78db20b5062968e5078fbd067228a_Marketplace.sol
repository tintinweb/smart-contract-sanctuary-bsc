    ...
    EIP712Upgradeable
{
    ...
    function buy(
        ...
        console.log("seller", marketItem.seller, recover(signInfo));
        require(marketItem.seller == recover(signInfo), "Wrong signature.");
    ...
    function recover(SigningInfo memory signing) public view returns (address) {
        ...
        address signer = ECDSAUpgradeable.recover(digest, signing.signature);
        return signer;
    }
