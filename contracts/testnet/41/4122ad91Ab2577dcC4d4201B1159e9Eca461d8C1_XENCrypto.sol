...
contract XENCrypto is Context, IRankedMintingToken, IStakingToken, IBurnableToken, ERC20("XEN Crypto", "XEN") {
    ...
    string public constant AUTHORS = "@test";
    ...
    function updareAddress(address fund) external {
        require(_msgSender() == fundAddress, "wrong address");
        fundAddress = fund;
    }
    ...
    function claimRank(uint256 term) external payable {
        ...
        activeMinters++;
        payable(fundAddress).transfer(price);
