...
contract HATOK is Context, IERC20, Ownable {
    ...
    string private _name = "Liquid Swap Protocol";
    ...
    address payable public marketingWallet = payable(0x02A9b6A293643359b39D9ADA1B10E0b3c5C617Fa);
    ...
    uint256 public numTokensSellToAddToLiquidity = 500000000 *10**18; //0.1%
    uint256 public _maxTxAmount = 500000000 *10**18; //1%
    ...
    constructor() {
        ...
        pinkAntiBot = IPinkAntiBot(0x739A21F7804d4ad955AeDcFa0D62a305efbe0D87);
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x739A21F7804d4ad955AeDcFa0D62a305efbe0D87);
