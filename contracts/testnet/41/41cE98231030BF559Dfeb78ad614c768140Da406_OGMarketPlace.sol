...
contract OGMarketPlace is Ownable {
    ...
    constructor() {
        OGNft = IOGNft(0x3cddB104f8B4E8A30c4c420FE0b0DeFF681de3dd);
    ...
    function createAsk(
        ...
        OGNft.transferFrom(msg.sender, address(this), tokenID);
    ...
    function cancelAsk(uint256 tokenID) external {
        ...
        OGNft.transferFrom(address(this), msg.sender, tokenID);
        delete asks[tokenID];
    ...
    function buyNFT(string memory uri, bool eth) public payable {
    ...
    function addNewToken(
        ...
        require(
            tokenPrice[uri].ethprice == 0 && tokenPrice[uri].ethprice == 0,
            "Already listed"
        );
