...
contract HEAIssuer is AccessControl {
    ...
    //         heroesNFT.addHeroesNumber(_tokenId[i], _numberHero[i], heroes[_numberHero[i]].name, heroes[_numberHero[i]].race, heroes[_numberHero[i]].class, _tier[i], heroes[_numberHero[i]].tier);
    //         emit summonhero(
    //             msg.sender,
    //             _tokenId[i],
