...
contract contract3 is Ownable {
    ...
    //allocateTokens
    address public recAddress = 0xFF6607b192DFA1D3766d9B5C9f3945fe3e14C506;  //LP cliam
    ...
    constructor() public {
        allocateRate[0] = 120e8;
        allocateRate[1] = 130.944e8;
        allocateRate[2] = 142.8860928e8;
        allocateRate[3] = 155.9173045e8;
        allocateRate[4] = 170.1369626e8;
        allocateRate[5] = 185.6534536e8;
        allocateRate[6] = 202.5850486e8;
        allocateRate[7] = 221.060805e8;
        allocateRate[8] = 241.2215504e8;
        allocateRate[9] = 263.2209558e8;
        allocateRate[10] = 287.226707e8;
        allocateRate[11] = 313.4217827e8;
        allocateRate[12] = 342.0058493e8;
        allocateRate[13] = 373.1967827e8;
        allocateRate[14] = 407.2323293e8;
        allocateRate[15] = 444.3719178e8;
        allocateRate[16] = 484.8986366e8;
        allocateRate[17] = 529.1213923e8;
