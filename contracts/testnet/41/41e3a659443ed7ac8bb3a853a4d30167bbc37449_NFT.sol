...
contract NFT is ERC721, Ownable {
     ...
     * Set some NFTs aside
     */
    function reserveNFT(uint256 numberOfNfts, address[] memory _senderAddress) external onlyOwner {        
    ...
    */
    function mintNFT(uint256 numberOfNFT) external payable {
        ...
        require(getNFTPrice(numberOfNFT) == msg.value, "Value sent is not correct");
