...
contract HMTIdo is Ownable {
    ...
    address public tokenAddr = address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
    Inv public inv = Inv(0x0F992965f1300aF7000B065Cca831143F4dA710b);
    ...
    function purchase(uint tid, uint amount) external returns (bool) {
        ...
        uint v = tid.mul(5e18).add(5e18).mul(amount);
