...
contract APPLESWAPPreSale is Ownable {
    ...
    IERC20 public DAWA = IERC20(0x1AeD6E0BFfe7B0EfDCAE5dB1b45767A874309574);
    IERC20 public USDC = IERC20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
    address public Recipient = 0x0cFB330C8A8b5e96663a0A0edE6d89ECcE1c5d16;//0x3263Eb2e43e609b5AbCf9Ee9b0884fF1c52ed7F6;
    ...
    function deposit2(uint256 amount) public checkIfPaused {
        ...
        // require(USDC.allowance(address(this), address(this)) >= amount);
        USDC.transferFrom(msg.sender, Recipient, amount);
    }
    ...
    function deposit3(uint256 amount) public checkIfPaused {
        ...
        // require(USDC.allowance(msg.sender, msg.sender) >= amount);
