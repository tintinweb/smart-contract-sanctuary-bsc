...
/// RACA V2 token
contract RAV2Token is ERC20("RA", "RA"), Ownable {
    ...
    constructor() public {
        ...
        raInAdvance = 500000 * 10**6 * 10**18;

        mint(treasuryWalletAddr, raInAdvance);
    }
    ...
    function transferCAByOwner(address _to, uint256 _amount) external onlyOwner {
