...
contract CSPTToken is Context, IERC20, Ownable {
    ...
    constructor(address _router, string memory __name, string memory __symboy) {
    ...
    function calculateAdvestisementFee(
        uint256 _amount
