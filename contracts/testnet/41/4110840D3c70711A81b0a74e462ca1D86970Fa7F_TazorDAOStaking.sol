...
contract TazorDAOStaking is TazorAccessControlled, Ownable, ReentrancyGuard {
    ...
    uint256 public lockupTime  = 600 ;               // lockup time which is updated when user stake | unstake | getReward.
    ...
    function calcBurn(address account) public {
        ...
        if ( timeinterval >= lockupTime && _totalTazorSupply > 0) {
    ...
    function claim() internal {
        ...
        if (msg.sender != address(0)) {
            ...
            if ( canClaim(msg.sender) ) {
                ...
                userInfos[msg.sender].reward = reward;
            }
