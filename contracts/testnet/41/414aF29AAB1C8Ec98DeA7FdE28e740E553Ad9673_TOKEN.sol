...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x45aF10e4cD0e7cb6E46002dFE4De32b74f6A9E5b;  // xxxDevWallet
...
contract TOKEN is Context, IERC20, Ownable {
    ...
    address public _developmentWalletAddress = 0x45aF10e4cD0e7cb6E46002dFE4De32b74f6A9E5b;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 10000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "TheToken";
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // BSC Testnet Router 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
