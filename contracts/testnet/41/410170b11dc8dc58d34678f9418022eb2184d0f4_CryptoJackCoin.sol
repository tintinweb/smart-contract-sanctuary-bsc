...
Token Name: Crypto Jack Coin
Token Symbol: Crypto Jack Coin

*/
contract CryptoJackCoin is Context, IERC20, IERC20Metadata, Ownable, Pausable{
    ...
    constructor () {
        _name = "Crypto Jack Coin";
        _symbol = "Crypto Jack Coin";
        _totalSupply;
