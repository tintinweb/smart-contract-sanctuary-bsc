...
abstract contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    address public wantAddress=0x527B5f9226817c52003D9707d73189D453665324;
     address public MCDAOFarmAddress=0x815Df8BB4430fcFB2cbAF2ad0084C5dcC16b42Dc;
    address public MCDAOAddress = 0x1e503F6C1ee44D6F3ed823c80CECc73EB01E8CdB;
    address public govAddress=0x6f2F0Cd65c5E55A46E9e78C6903475A4A4E30daE; 
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(MCDAOFarmAddress, _wantAmt);
