...
contract GovSaleRemoteFactory is Initializable, UUPSUpgradeable, PausableUpgradeable, OwnableUpgradeable, AdminProxyManager, IGovSaleRemoteFactory{
    ...
    address public override dstCrossChainManager; // dst cross chain manager
    ...
    function init(
        ...
        address _dstCrossChainManager, // src cross chain manager
        ...
        require(
            ...
            _dstCrossChainManager != address(0) &&
            _endpoint != address(0) &&
