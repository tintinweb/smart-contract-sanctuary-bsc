...
contract AuctionTreasury is Initializable, OwnableUpgradeable {
    ...
    function withdrawFund(address _token, address _to, uint256 _amount) external {
        require(msg.sender == admin || msg.sender == owner(), "Only Owner or Admin can operate");
        require(_token != address(LVL) && _token != address(LGO), "Not allow to withdraw LVL or LGO");
        IERC20(_token).safeTransfer(_to, _amount);
        emit FundWithdrawn(_token, _to, _amount);
    }
