...
contract MyNFTStorage is ERC1155Holder, ReentrancyGuard {
    ...
    event CancelOrder(uint256 indexed uuidTransaction);

    event BuyOrder(uint256 indexed uuidTransaction);
    ...
    function createOrder(
        ...
        emit ListedForSale(uuidTransaction, myOrder.indexer, orderId);
    }
    ...
    function cancelOrder(uint orderId) public {
        ...
        emit CancelOrder(myOrder.uuidTransaction);
    }
