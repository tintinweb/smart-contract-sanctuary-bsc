...
contract MCT  is IERC20, Ownable {
    ...
    string constant _name = "MicaToken";
    string constant _symbol = "MCT";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals); // 10,000,000
    uint256 public _maxTxAmount = (_totalSupply * 5) / 100; // 5% MAX 500,000
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100; // 5% MAX 500,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xb4c01A3192A4ACE4c9Ff5Eac38B163bE5980067B); //Change
