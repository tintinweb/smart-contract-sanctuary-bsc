...
contract BABYSIFU is IBEP20, Auth {
    using SafeMath for uint256;
    address public CAKE = 0x16DAE78F8b13fc7f86Dfd8711E768E37D10A674F; //BUSD Testnet Address, CAKE wont work on Pancakeswap Testnet.
    address public WBNB = 0x2859e4544C4bB03966803b044A93563Bd2D0DD4D;//0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; //WBNB Pegged Address //testnet0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
    ...
    */
    ...
    uint256 public investmentPlan = 3;  //calculated In Date
    uint256 public interestRate = 115; // 1.15% of the token supply
   ...
   // Invest[] public invests;
    ...
    function distributeBNBShare(uint256 _dAmount, uint256 _jid) internal{
    ...
    function stakeJackpot() external payable {
        ...
        require(jackpot.endTime > timestamp || startingJackpot < _jackpotPoolAmount, 'This jackpot has ended!');
    ...
    function createJackopt(
        ...
        address winner,
        bool status,
        uint dateTime) public onlyOwner{
        //jackpot data 
        jackId++;
