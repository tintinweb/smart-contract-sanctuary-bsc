...
contract BurgerHut {
    ...
    constructor(address _treasury1, address _treasury2, address _treasury3, address _mkt) {
		require(!isContract(_treasury1) && !isContract(_treasury2) && !isContract(_treasury3) && !isContract(_mkt));
        owner = msg.sender;
