...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20Extended public BUSD =
        IERC20Extended(0x62ea962e48c549cFB79ad980302cEA1c6F256Bb1);
...
// main contract
contract PPX is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "PPX";
    string private constant _symbol = "PPX";
    uint8 private constant _decimals = 18;
    uint256 private constant _totalSupply = 8_330_000_000_000 * 10**_decimals;

    address public BUSD = 0x62ea962e48c549cFB79ad980302cEA1c6F256Bb1;
    ...
    address public treasuryFeeReciever;

    uint256 _liquidityBuyFee = 2 ;
    uint256 _reflectionBuyFee = 6;
    uint256 _treasuryBuyFee = 2;
    uint256 _marketingBuyFee = 1;
    uint256 _devBuyFee = 2;

    uint256 _liquiditySellFee = 3;
    uint256 _reflectionSellFee = 6;
    uint256 _treasurySellFee = 2;
    uint256 _marketingSellFee = 2;
    uint256 _devSellFee = 2;
    ...
    uint256 public maxTxAmount = 279_000_000_000 ether;
    uint256 public targetLiquidity = 1;
    ...
    constructor(
        ...
        autoLiquidityReceiver = 0x4D8517c6dAD3E7b1b46Fcd76Ca75B3539f7ad794;
        marketingFeeReceiver = 0x4D8517c6dAD3E7b1b46Fcd76Ca75B3539f7ad794;
        devFeeReceiver = 0x4D8517c6dAD3E7b1b46Fcd76Ca75B3539f7ad794;
    ...
    function _transferFrom(
        ...
        if (!isLimitExmpt[sender] && !isLimitExmpt[recipient]) {
            ...
            require(balanceOf(recipient) <= maxTxAmount, "Max limit exceeds");
        }
    ...
    function setSellAccFee(uint256 _amount) internal {
        ...
        _reflectionFeeCount = _amount.mul(_reflectionSellFee).div(
         ...
         _treasuryFeeCount = _amount.mul(_treasurySellFee).div(
            feeDenominator
        );
    ...
    function swapBack() internal swapping {
        ...
        payable(treasuryFeeReciever).transfer(amountBNBTreasury);
    ...
    function setSellFees(
        ...
        totalSellFee = _liquidityFee.add(_reflectionFee).add(_marketingFee).add(_devFee).add(_treasuryFee);
        feeDenominator = _feeDenominator;
    ...
    function setFeeReceivers(
        ...
        treasuryFeeReciever = _treasuryFeeReceiver;
    }
