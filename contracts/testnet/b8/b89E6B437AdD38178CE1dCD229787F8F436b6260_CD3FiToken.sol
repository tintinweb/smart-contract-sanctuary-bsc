...
contract CD3FiToken is Context, IERC20, Ownable {
    ...
    string public constant _name ="CinemaDraft Decentralized Finance Token";
    string public constant _symbol = "CD3Fi";
    ...
    constructor ()  {       
        ...
        excludedFromDividends[address(dead)] = true;
    ...
    function setStabilizer(bool _status) public onlyOwner() {
    ...
    function swapAndLiquify() private lockTheSwap {
        ...
        if(AmountForReward > 0) swapForDividend(AmountForReward);
        if(AmountForMarketing > 0) sendToMarketing(AmountForMarketing);
        if(AmountForBuyBackBurn > 0) swapBNBandBurn(AmountForBuyBackBurn);

    }

    function stabilitySwap() internal {
