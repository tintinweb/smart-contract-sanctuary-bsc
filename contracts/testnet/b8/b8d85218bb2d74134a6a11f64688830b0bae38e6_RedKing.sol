...
/**
     ...
     *(买入费率)BUYFEESETTING_:[4,2,3,1]  分红 流动性 营销 销毁
     *(卖出费率)SELLFEESETTING:[4,1,3,1]
...
contract RedKing is ERC20, Ownable {
    ...
    //
    uint public Price = 0.01 ether;//1000000000000000wei
    ...
    function getBalanceConcrat() external onlyOwnerOf{
