...
contract AdroverseOpenPack is Initializable , OwnableUpgradeable, ReentrancyGuardUpgradeable {
    
    constructor() initializer {}

    address public AdroverseCard;
    mapping (uint256 => bool) public packNFTID;
    ...
    function configGeneral(address _adroverseCard) public onlyOwner{
    ...
    function openPack(
        ...
        IAdroverseCard.Property memory cardInfo = IAdroverseCard(AdroverseCard).properties(tokenId);
        require(packNFTID[cardInfo.cardID], "NFT is not pack.");
        IAdroverseCard(AdroverseCard).transferFrom(msg.sender, address(this), tokenId);
    }
