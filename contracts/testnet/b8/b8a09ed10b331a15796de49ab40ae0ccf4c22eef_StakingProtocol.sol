...
////////////////////////////////////////// view methods
    ...
    function getAccountBalances(address _account)
        public
        view
        returns (address[] memory assets, uint256[] memory balances, uint256[] memory nftBonds)
    {
...
////////////////////////////////////////// deposit/withdraw
        ...
        returns (AccountPeriodInfo storage currentPeriod)
    {
        ...
        currentPeriod.containsSmartNFT = previousPeriod.containsSmartNFT;
        currentPeriod.smartNFT = previousPeriod.smartNFT;
    ...
    function __deposit(
        ...
        if (_needDepositSmartNFT) {
            ...
            currentPeriod.containsSmartNFT = true;
            currentPeriod.smartNFT = _smartNFT;
        }
    ...
    function __withdraw(
        ...
        if (_needWithdrawSmartNFT) {
            ...
            currentPeriod.containsSmartNFT = false;
            currentPeriod.smartNFT = 0;
        }
