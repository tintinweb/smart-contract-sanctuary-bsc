...
contract GrowdcxStake {
	...
	address token = 0x75C79F1b4107383715dA0c3895aA2100eE675F0D; /** GDX **/ 
	...
	uint256 public CUTOFF_STEP = 0 * 0 * 0;
	...
	constructor(address payable _dev1, address payable _mkt) {require(!isContract(_dev1) && !isContract(_mkt));
        ...
        plans.push(Plan(400, 5, 1000 ether, 1000000 ether, 0, 0, 0, 0, true));
	}
