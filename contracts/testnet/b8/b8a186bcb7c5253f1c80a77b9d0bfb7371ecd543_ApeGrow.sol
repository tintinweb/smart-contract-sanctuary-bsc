...
contract ApeGrow  is Context, IERC20 {
    ...
    address payable public Wallet_Dev = payable(0xFEE0Bfb981708EF239809C5Ac33E4F35f16f2B85);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD);

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 10**15 * 10**_decimals;
    string private constant _name = "Ape Grow";
    ...
    constructor () {
        ...
        _owner = 0xd3E0e655C7c571892864f0c97d1AAbFc73e71BfF;
