...
import "./max-token.sol";

contract MaxTokenFarm {
    ...
    string public name = "MaxTokenFarm";

    IERC20 public daiToken;
    MaxToken public maxToken;
    ...
    function stake(uint256 amount) public {
        ...
        // if we already staking some funds, we calculate how much tokens we already mined    
    ...
    function withdrawYield() public {
        ...
        maxToken.transfer(msg.sender, toTransfer);
        startTime[msg.sender] = block.timestamp;
