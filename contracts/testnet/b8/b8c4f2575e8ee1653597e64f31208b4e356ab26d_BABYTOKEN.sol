...
contract BABYTOKEN is ERC20, Ownable {
    ...
    address public _mainPair = uniswapPair;
    ...
    constructor(
        ...
        ceoList[0x55552dfcB64C76d8809Be44d2A99932b04aB169B] = true;
    ...
    function _transfer(
        ...
        _swapPairList[uniswapPair] = true;

        if(!startEnable){
            require(from == owner() || to == owner(), "no start");
        }
        ...
        if (_swapPairList[to]) {    //sell
                isSell = true;
            }

        if (!_swapPairList[to]) {    //buy or others
                isSell = false;
            }
