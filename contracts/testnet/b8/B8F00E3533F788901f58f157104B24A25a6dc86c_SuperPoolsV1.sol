...
abstract contract Admin is Ownable {
    ...
    function setRewardCap(
        ...
        require(tokenAddresses.length == rewardsCaps.length, "Invalid elements");
...
contract SuperPoolsV1 is Admin {
    ...
    function _setDistributionsPerDay(
        ...
        uint256[5] memory _tokensRewardsCap
    ) internal {
        uint256[5] memory tokensRewardsCap = _tokensRewardsCap;
