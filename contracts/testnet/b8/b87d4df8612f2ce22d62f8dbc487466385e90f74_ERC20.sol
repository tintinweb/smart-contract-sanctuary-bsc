...
/*
 * This is test only dont use it. We only check bugs etc. No option to refund etc. So please dont use contract
 */
...
contract ERC20 is Context, IERC20, IERC20Metadata, ReentrancyGuard {
    ...
    string private _name = "AVARICEFORK";
    string private _symbol = "SEED2";
...
contract AVARICEFORK is ERC20, Ownable {
    ...
    address internal constant avariceTeam_addr = 0x55E3F3Fc1A404A91018c2232EA1541e4A56231aC; // 
																									 
																									 
																									 
    address internal marketing_addr = 0x7D8C5B47F8227568Be66237031E0b398fF702c48;
    address internal buyBack_addr = 0x55E3F3Fc1A404A91018c2232EA1541e4A56231aC;
