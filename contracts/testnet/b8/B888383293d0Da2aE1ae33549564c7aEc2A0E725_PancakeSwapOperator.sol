...
contract PancakeSwapOperator is Context, IPancakeSwapOperator {
        ...
        returns (uint256[] memory amounts, address[] memory tokens)
    {
        ...
        uint256 buyBalanceBeforePurchase = buyToken.balanceOf(_msgSender());
        uint256 sellBalanceBeforePurchase = sellToken.balanceOf(_msgSender());
        ...
        uint256 amountBought = buyToken.balanceOf(_msgSender()) -
            buyBalanceBeforePurchase;
        uint256 amountSold = sellBalanceBeforePurchase -
            sellToken.balanceOf(_msgSender());
