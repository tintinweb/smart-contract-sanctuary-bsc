...
/**
/*
Elon Rate - Tired of buying low-performing tokens from Elon tweets?
Join our project and use our auto-rating tool for Elon' tweets.

Telegram: t.me/elonrate
Twitter: twitter.com/elonrate
Website: elonrate.com
...
contract TokenFinal is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 2_000_000_000 * 10**9;
    ...
    address public marketingWallet = 0x70C359EA4e4495CceCF9ED7944ADAeC449192C43;
    address public devWallet = 0x9Ea0be688655b91D1C637F9a43941e70db1b92C8;
    address public buybackWallet = 0x8522dad6F6492393A1106B2d4E9A8568c8FF18f1;

    string private constant _name = "Elon Rating";
    string private constant _symbol = "ELONRATING";
    ...
    Taxes public taxes = Taxes(1, 7, 2, 3, 1);
    Taxes public sellTaxes = Taxes(1, 7, 2, 3, 1);
