...
contract NsBEinu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Ns BE inu";
    string private _symbol = "$NsBEinu";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x378ae79731db2BF619d48Fa79B50AdA7B60ddeEe); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0x378ae79731db2BF619d48Fa79B50AdA7B60ddeEe); // BuyBack Address
