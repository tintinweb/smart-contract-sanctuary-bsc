...
contract Fench is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string  private constant _name = "Fench"; 
    ...
    address payable public   PromWalletAddress =payable(0xF42333307367c2083683deA58588C63F4919A8E3);
    address payable public   _devWallet           =payable(0x2BE2160AAC7afF6bEbB96d388bBeA1Aa3dBeA929);
