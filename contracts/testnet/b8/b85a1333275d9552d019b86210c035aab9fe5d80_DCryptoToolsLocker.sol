...
// File: IDCryptoToolsLock.sol


pragma solidity =0.8.4;

interface IDCryptoToolsLock {
    function lock(
        address owner,
        address token,
        bool isLpToken,
...
contract DCryptoToolsLocker is IDCryptoToolsLock {
    ...
    uint256 private constant ID_PADDING = 1_000;
    ...
    function _lockLpToken(
        ...
        tokenInfo.cycle = cycle;
        tokenInfo.tgeDate = tgeDate;
