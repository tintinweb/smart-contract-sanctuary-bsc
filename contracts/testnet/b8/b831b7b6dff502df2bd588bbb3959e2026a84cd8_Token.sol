...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Ture Dao";
    string private _symbol = "T-Dao";
    ...
    address public _marketingWallet = payable(address(0x5Be949619f6926Fc51A82A2c4fd1996b822e9C0A));
    address public _burnWallet = payable(address(0x0000000000000000000000000000000000000000));
    ...
    constructor() {
        ...
        // Create a uniswap pair for this new token 0xD99D1c33F9fC3444f8101754aBC46c52416550D1 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        private
    {
        ...
        _rOwned[_burnWallet] = _rOwned[_burnWallet].add(rReward);
        _rOwned[address(this)] = _rOwned[address(this)].add(rMarketing);

        _tOwned[_burnWallet] = _tOwned[_burnWallet].add(tReward);
