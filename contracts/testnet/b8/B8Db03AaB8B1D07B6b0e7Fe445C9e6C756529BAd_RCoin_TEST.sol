...
contract RCoin_TEST is ERC20PresetMinterPauser {
    bytes32 public constant WITHDRAW_ROLE = keccak256("WITHDRAW_ROLE");

    constructor () ERC20PresetMinterPauser("RCoin", "RCN"){
    ...
    function transferAnyERC20Token(address tokenAddress, uint256 amount) public returns (bool success) {
        require(hasRole(WITHDRAW_ROLE, _msgSender()), "RCoin: must have withdraw role to transfer"); 
