...
contract Polling is Ownable, ReentrancyGuard{
    ...
    function createPoll(string memory _type1, string memory _type2, string memory _type3, uint _endTime) public onlyOwner nonReentrant{
