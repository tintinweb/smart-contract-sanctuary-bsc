...
contract USDTWrapper {
    ...
    IERC20 public hbToken;
    address[] public _fundAddress=[address(0),address(0),address(0)];
    uint256[] public _rate=[70,20,10];
    ...
    function stake(uint256 amount,uint tp) public virtual {
        ...
        if(tp==0){
            hsToken.safeTransferFrom(msg.sender, address(this), amount*75/100);
            uToken.safeTransferFrom(msg.sender, address(this), amount*25/100*(10**10));
        }else{
            hsToken.safeTransferFrom(msg.sender, address(this), amount*75/100);
            hbToken.safeTransferFrom(msg.sender, address(this), amount*25/100*(10**10)/price());
        }
    ...
    function withdraw(uint256 amount) public virtual {
        ...
        hbToken.safeTransfer(msg.sender, amount*90/100);
        for(uint i=0;i<_fundAddress.length;i++){
            hbToken.safeTransfer(_fundAddress[i], amount*_rate[i]/1000);
        }
        if (_balances[msg.sender] == 0) {
...
contract StakingPool is USDTWrapper,Ownable {
    ...
    constructor() public {
        ...
        uToken = IERC20(0x52A7B1F6bF5F5c0d25380Cfd1c9fd923aD276304);
        hsToken = IERC20(0x045169103d90C40a87700e3D72E8DD3c71d78Ad5); 
        hbToken = IERC20(0x4f048a70BfaFb0e4A6cb219E56733bDef391c39f);
        pair = IPair(0xc90b764A776B3Ed3B09ABff5bB750342F409f397);
    }
    ...
    modifier updateReward(address account) {
        ...
        perSecondRewardAll=288*10**8/(2**x)/24/60/60;
    ...
    function getReward() public updateReward(msg.sender) checkStart {
        ...
        if (reward > 0) {
            ...
            super.withdraw(reward*price()/(10**10));
