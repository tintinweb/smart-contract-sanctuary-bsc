...
contract TokenGadielEsteban is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        // Editable
        string memory e_name = "Token Gadiel Esteban";
        string memory e_symbol = "TGE";
        marketing_wallet = 0x77cDAD2638686cE10C62649D4aF720Fb013b0807;
        donation_wallet = 0x77cDAD2638686cE10C62649D4aF720Fb013b0807;
        liquidity_wallet = 0x77cDAD2638686cE10C62649D4aF720Fb013b0807;
        uint e_totalSupply = 100_000_000_000 ether;
        ...
        _donationFee.push(600);
        _donationFee.push(600);
        _donationFee.push(0);

        _liquidityFee.push(600);
        _liquidityFee.push(600);
