...
contract Frognobi is Context, IERC20, Ownable {
    ...
    string private _name = "Frognobi Inu";
    string private _symbol = "FROGNOBI";
    ...
    uint256 totalSwapableFee = _liquidityFee.add(_charityFee);

    uint _saleTaxFee = 1;
    uint _saleLiquidityFee =1;
    uint _saleCharityFee = 7;
    uint _saleBurnFee = 0;
    ...
    address public pinkAntiBot_ = 0xbb06F5C7689eA93d9DeACCf4aF8546C4Fe0Bf1E5; //testnet 0xbb06F5C7689eA93d9DeACCf4aF8546C4Fe0Bf1E5 //mainnet 0x8EFDb3b642eb2a20607ffe0A56CFefF6a95Df002
    ...
    uint256 private numTokensSellToAddToLiquidity = 1000 * 10**18; //0.001%
    ...
    function _transfer(
        ...
        if(to == uniswapV2Pair) {
            require(amount <= _maxTxAmount, "Amount to sell is beyond max. Transaction Amount.");
        }
    ...
    function setSaleFee() private {
        ...
        totalSwapableFee = _liquidityFee.add(_charityFee);
    }

    function setSaleFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 charityFee, uint256 burnFee) 
    external onlyOwner() 
    {
        _saleTaxFee = taxFee;
