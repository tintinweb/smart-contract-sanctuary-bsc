    ...
    ReentrancyGuardUpgradeable
{
    ...
    function shouldTakeFee(address _sender, address _recipient)
        ...
        returns (bool)
    {
        return !(isFeeExempt[_sender] || isFeeExempt[_recipient] || ignoreFees);
    }
    ...
    ) external hasStorageAccess ignoringFees returns (uint256 tokensBurned) {
