...
contract Snowball is Context, Ownable {
    ...
    function shovelingSnow(address ref) public {
        require(initialized);
    ...
    function buyShovel(address ref) public payable {
        require(initialized);
    ...
    function resetSeedMarket() external onlyOwner {
