...
contract TestnetToken1 is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "TestnetToken1";
    string private _symbol = "TNT1";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xefBCFD2370e82969FbF9C4ea75580030d731c445); // Marketing Address
    address payable public DevWalletAddress = payable(0xefBCFD2370e82969FbF9C4ea75580030d731c445); // Dev Address
    ...
    uint256 public _maxTxAmount = 30 * 10**9; //5 * 10**6 * 10**9;
    uint256 public _walletMax = 60 * 10**9;
    uint256 private minimumTokensBeforeSwap = 25 * 10**6;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (30 * 10**6 * 10**9), "Max wallet should be less or euqal to 6% totalSupply");
