...
contract Unitnumbersgame is Ownable, ERC721A, ReentrancyGuard {
    using SafeMath for uint256;
   
    uint256 public constant maxSupply = 1999;
    ...
    uint256 public AMOUNT1 = 50;
    uint256 public AMOUNT2 = 50;
    uint256 public AMOUNT3 = 50;
    uint256 public AMOUNT4 = 50;
    ...
    string public BASE_URI="https://data.unitnumbersgame.net/metadata/";
    string public CONTRACT_URI ="https://data.unitnumbersgame.net/api/contracturl.json";
   ...
   struct Info {
    ...
    constructor() ERC721A("Unitnumbersgame", "unitnumbersgame") {
    ...
    function info(address user) public view returns (Info memory) {
        if(_step == 1){
             ...
             return  Info(maxSupply,totalSupply(),PRICE2,0,WALLET2_CAP[user],_step,LIMIT,MINTED2,AMOUNT2);
        }else if(_step == 3){
             return  Info(maxSupply,totalSupply(),PRICE3,0,WALLET3_CAP[user],_step,LIMIT,MINTED3,AMOUNT3);
        }else if(_step == 4){
             return  Info(maxSupply,totalSupply(),PRICE4,0,WALLET4_CAP[user],_step,LIMIT,MINTED4,AMOUNT4);
        }
    }
    ...
    function mintbatch(uint256 amount) external payable {
        ...
        require(MINTED3.add(amount) <= AMOUNT3,"Max supply for mintbatch reached!");
        require(totalSupply().add(amount) <= maxSupply, "max supply would be exceeded");
    ...
    function mint(uint256 amount) external payable {
        ...
        require(MINTED4.add(amount) <= AMOUNT4,"Max supply for mint reached!");
        require(totalSupply().add(amount) <= maxSupply, "max supply would be exceeded");
