...
contract Chameleo is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chameleo";
    string private constant _symbol = "CHAMELEO";
    ...
    address payable private _devwallet = payable(address(0xdc580F72A14d93DE6a66e8967f023f6f33ff9eC4));
    address payable private _buybackWallet = payable(address(0xdc580F72A14d93DE6a66e8967f023f6f33ff9eC4));
