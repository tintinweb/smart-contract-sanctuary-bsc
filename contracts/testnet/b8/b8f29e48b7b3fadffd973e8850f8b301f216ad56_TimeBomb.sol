...
contract TimeBomb {
    ...
    receive() payable external {
        ...
        if (msg.sender == lastBuyer && msg.sender != owner) {
            ...
            if (totalSpent[msg.sender] > biggestBuyerThreeAmmount && totalSpent[msg.sender] > biggestBuyerTwoAmmount){
                 biggestBuyerOne = msg.sender; 
                 biggestBuyerOneAmmount = totalSpent[msg.sender];
                }

            if (totalSpent[msg.sender] > biggestBuyerThreeAmmount && totalSpent[msg.sender] < biggestBuyerOneAmmount ) {
            ...
            if (totalSpent[msg.sender] < biggestBuyerTwoAmmount && totalSpent[msg.sender] > biggestBuyerThreeAmmount) { 
