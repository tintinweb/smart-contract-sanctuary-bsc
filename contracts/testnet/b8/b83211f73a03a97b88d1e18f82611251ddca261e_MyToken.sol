...
abstract contract Upgradeable {
    ...
    function initializePro() virtual public ;

    function replaceImplementation(address Implementation) public {
        _dest = Implementation;
        Implementation.delegatecall(abi.encodeWithSelector(bytes4(keccak256("initializePro()"))));
    }
}
...
contract Proxy is Upgradeable {
    ...
    constructor(address Implementation) {
        replaceImplementation(Implementation);
    }

    function initializePro() override public{
