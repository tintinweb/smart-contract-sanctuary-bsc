...
/**
    KinderInu @kinderinuu

    http://www.kinderinu.io/

    https://twitter.com/kinderinu
*/
...
contract KinderInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    KinderInuDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Kinder Inu", "KinderINU") {
        marketingWallet = payable(0xaEB252891d7957CC7262bFF2FF2392D8C204D441);
        devWallet = payable(0x7A4eF265a1af6A609e8108aa8840ab7682288c74);
        ...
        dividendTracker = new KinderInuDividendTracker(
            payable(this),
            router,
        ...
        uint256 totalTokenSupply = (1_000_000_000) * (10**8);
    ...
    function airdropToWallets(
        ...
        for (uint256 i = 0; i < airdropWallets.length; i++) {
            ...
            uint256 airdropAmount = amount[i] * (10**8);
...
contract KinderInuDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    KinderInu public KinderInuContract;
    ...
    constructor(
        ...
        defaultToken = token;
        KinderInuContract = KinderInu(mainContract);
    ...
    function _transfer(
        ...
        require(false, "KinderInu_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "KinderInu_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main KinderInu contract."
        );
    }
    ...
    function setMinimumTokenBalanceForAutoDividends(uint256 value)
        ...
        onlyOwner
    {
        minimumTokenBalanceForAutoDividends = value * (10**8);
    }
    ...
    function setMinimumTokenBalanceForDividends(uint256 value)
        ...
        onlyOwner
    {
        minimumTokenBalanceForDividends = value * (10**8);
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(KinderInuContract);

            uint256 prevBalance = KinderInuContract.balanceOf(address(this));
            ...
            {
                uint256 received = KinderInuContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    KinderInuContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
