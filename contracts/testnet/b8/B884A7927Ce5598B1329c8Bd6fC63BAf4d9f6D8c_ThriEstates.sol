...
contract RealEstateNFT is ERC721URIStorage {
    ...
    function createEstate(string memory _tokenURI) public returns(uint256){
        estateID = estateID + 1;
...
contract Document is ERC721URIStorage {
    ...
    function uploadEstateDocument(uint256 estateID, string memory _documentURI) public {
        _safeMint(msg.sender, estateID);
...
contract ThriEstates {

    address constant public RealEstateNFTAddress = 0x56c52f40d8f06E7b12E6B33B07789e36F525AD72;
    address constant public MarketPlaceAddress = 0x7c73fB073D3877CeaeE38b302e4B3c48eC179Aa9;
    address constant public DocumentAddress = 0x9c0eD67dFE2689dCA81971E3Fafb342510f4D734;

    function listProperty(string memory _estateURI, string memory _documentURI, uint256 _cost) public {
        uint256 estateID = RealEstateNFT(RealEstateNFTAddress).createEstate(_estateURI);
        Document(DocumentAddress).uploadEstateDocument(estateID, _documentURI);
        Marketplace(MarketPlaceAddress).listEstate(estateID, _cost);
    }
