...
contract SuperBNB is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "SuperBNB";
    string private _symbol = "SuperBNB";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0xcc872b45d759C7B8689012C66B4A561f480Ddf7D));
        marketingWalletAddress = payable(address(0xcc872b45d759C7B8689012C66B4A561f480Ddf7D));
