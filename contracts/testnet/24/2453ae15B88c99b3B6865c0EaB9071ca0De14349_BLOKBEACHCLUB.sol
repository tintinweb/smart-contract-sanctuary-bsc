...
contract BLOKBEACHCLUB is IERC20 {
    ...
    string constant private _name = "BLOK BEACH CLUB";
    string constant private _symbol = "BLOK";
    ...
    struct TaxWallets {
        ...
        address payable nftRewards;
    }

    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x1737d4A11ba4B5847f99b1717E21abe21381BDBD),
        development: payable(0x0D7DDf7073fd692360a8EA1C61acC7F5A5deF3D1),
        nftRewards: payable(address(0))
    });
...
//================================================ BLACKLIST
    ...
    function setRatios(uint16 development, uint16 marketing, uint16 nftRewards) public onlyOwner {
        _ratios.development = development;
        _ratios.marketing = marketing;
        _ratios.nftRewards = nftRewards;
        _ratios.totalSwap = development + marketing + nftRewards;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable marketing, address payable development, address payable nftRewards) external onlyOwner {
        _taxWallets.marketing = payable(marketing);
        _taxWallets.development = payable(development);
        _taxWallets.nftRewards = payable(nftRewards);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        if (_taxWallets.nftRewards == address(0)) {
            setRatios(ratios.development, ratios.marketing, 0);
        }
        ...
        bool success;
        uint256 nftRewardsBalance = (amtBalance * ratios.nftRewards) / ratios.totalSwap;
        uint256 developmentBalance = (amtBalance * ratios.development) / ratios.totalSwap;
        uint256 marketingBalance = amtBalance - (nftRewardsBalance + developmentBalance);
        ...
        if (ratios.nftRewards > 0) {
            (success,) = _taxWallets.nftRewards.call{value: nftRewardsBalance, gas: 35000}("");
        }
    }
