...
/**
    ...
    @param isReceipt  deposited token is a receipt or not 
    */
...
// function for purchasing receipt tokens
/**
...
//function for selling receipt tokens and getting tokens
/**
...
//function for setting receipt token address
    ...
    function swapWantToBUSD() external onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        path[0] = address(want);
        path[1] = Admin.BUSD();
        uint256 wantBalance = IPancakeMaster(Admin.MasterChef()).userInfo(id, address(this)).amount - totalStaked;
