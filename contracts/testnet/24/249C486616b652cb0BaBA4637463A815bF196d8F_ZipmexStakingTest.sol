...
contract ZipmexStakingTest is ReentrancyGuardUpgradeable {
        ...
        )
    {
        ...
        if (block.timestamp < stakeData.stakeUnlockTime) {
            ...
            if (stakeData.stakeUnlockTime > block.timestamp)  interval = block.timestamp - claimTime;
            else if(stakeData.stakeUnlockTime > claimTime) interval = stakeData.stakeUnlockTime - claimTime;
            penalty = 0;
            unspentReward = 0;
            unlockOver = true;
        }
