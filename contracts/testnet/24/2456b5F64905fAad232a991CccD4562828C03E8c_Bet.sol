...
/**
 * @dev Based on https://programtheblockchain.com/posts/2018/02/17/signing-and-verifying-messages-in-ethereum/
 */
contract Bet is Ownable {
  ...
  uint256 public coliseumAndTeamFees;
   ...
   *
   * 10% of `amount` goes for team and coliseum owners.
   */
  function depositPayment(uint256 amount) external {
    uint256 fee = (amount * 10) / 100;
    coliseumAndTeamFees += fee;
  ...
  function withdrawFees() external onlyOwner {
    uint256 coliseumShares = coliseumAndTeamFees / 2;
    uint256 teamShares = coliseumAndTeamFees - coliseumShares;
    coliseumAndTeamFees = 0;
