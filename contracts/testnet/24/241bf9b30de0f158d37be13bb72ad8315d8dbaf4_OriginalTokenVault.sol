...
abstract contract MultichainRouter is Pausable, Ownable {
...
contract OriginalTokenVault is ReentrancyGuard, Initializable, MultichainRouter {
    ...
    //uint64 _nonce
        ...
        uint64 depId = _deposit(NATIVE, amount, toChainId);

        emit Deposited(depId, msg.sender, NATIVE, amount, toChainId, recipient);
    ...
    function withdraw(
        ...
        uint256 totalCost = EXECUTION_OVERHEAD * tx.gasprice + _amount * 1 / 1000;
