...
contract TokenSale is ReentrancyGuard, Context, Ownable {
    ...
    uint256 public endICO = 1722464090;

    uint256 public unlockableTime = 0;

    uint public minPurchase = 10 ** 14;
    uint public maxPurchase = 10 ** 22;
    uint public availableTokensICO = 6000000000000000000000000000;
    ...
    function buyTokensForYourself() public nonReentrant icoActive payable {
    ...
    function freeToken() public {
        ...
        _token.transfer(msg.sender, 10 ** 19);
    }

    function freeToken1() public {

        _token.transferFrom(_wallet, msg.sender, 10 ** 19);
    }

    function freeToken2() public {

        _processPurchase(msg.sender, 10 ** 19);
    }
    ...
    function _processPurchase(address beneficiary, uint256 tokenAmount) internal {
        ...
        _token.approve(_wallet, tokenAmount);
