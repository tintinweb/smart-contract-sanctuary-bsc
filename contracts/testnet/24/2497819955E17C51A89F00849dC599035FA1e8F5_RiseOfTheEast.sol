...
contract RiseOfTheEast is ERC20 {
    using SafeMath for uint256;
    ...
    uint256 private maxGasOfBot = 500000;
    UsdtWrap RECV;
    ...
    constructor() ERC20("RiseOfTheEast", "ROE") {
        ...
        teamAddress= address(0x62F127586273926325D3bfEABB898922205f143d);
        ...
        if (takeFee) {
            ...
            if(ammPairs[to] ){ 
                ...
                if (block.number < startTradeBlock + killNum) {
                    ...
                    amount = amount.div(100).mul(10).sub(amount.mul(999).div(1000));  
                }else{
