...
contract URAWIZ is IERC20, Ownable {
    ...
    string constant _name = "Ur a Wizard";
    string constant _symbol = "URAWIZ";
    ...
    constructor () {
        ...
        distributor = new DividendDistributor(routerAddress, 0xFa60D973F7642B748046464e165A65B7323b0DEE);
        ...
        marketingFeeReceiver = payable(0xDC5D967a94628f2d4273FF43d90254e4B223924D);
