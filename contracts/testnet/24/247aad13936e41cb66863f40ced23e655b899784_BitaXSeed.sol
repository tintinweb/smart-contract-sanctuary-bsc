...
contract BitaXSeed {
    ...
    BEP20 public bitaX = BEP20(0x11689452dbAe586bE43cBDaA07027400970B08D6);  // BitaX 
    ...
    uint256 public timeStep = 30 days; // 1 months
    ...
    function distributeReferral(address direct, uint256 _bitaX, bool isReg) internal{
        for(uint8 i=0; i<referral.length; i++){
            ...
            if(isReg==true){
                if(i == 0 && users[users[direct].refer].levelTeam[0] >= 10 && users[users[direct].refer].dividend[0]==0){ // Minimum 10 directs
                    users[users[direct].refer].dividend[0]=25e17;
                }
                else if(i == 1 && users[users[direct].refer].levelTeam[1] >= 50 && users[users[direct].refer].dividend[1]==0){ // Minimum 50 members at level 2
                    users[users[direct].refer].dividend[1]=125e17;
                }
                else if(i == 2 && users[users[direct].refer].levelTeam[2] >= 200 && users[users[direct].refer].dividend[2]==0){ // Minimum 200 members at level 3
                    users[users[direct].refer].dividend[2]=50e18;
                }
                else if(i == 3 && users[users[direct].refer].levelTeam[3] >= 500 && users[users[direct].refer].dividend[3]==0){ // Minimum 500 members at level 4
                    users[users[direct].refer].dividend[3]=125e18;
                }
                else if(i == 4 && users[users[direct].refer].levelTeam[4] >= 1000 && users[users[direct].refer].dividend[4]==0){ // Minimum 1000 members at level 5
