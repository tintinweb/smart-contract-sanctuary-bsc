...
contract ZengfaDoge is Context, IERC20, Ownable {
    ...
    string private _name = "niuy";
    string private _symbol = "niuy";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x87947860a5AAb065615879a3b36311cb7a494C0F));
        marketingWalletAddress = payable(address(0xB46be4C5bcD64f004AB00F5FD0bdBf434F04187B));
