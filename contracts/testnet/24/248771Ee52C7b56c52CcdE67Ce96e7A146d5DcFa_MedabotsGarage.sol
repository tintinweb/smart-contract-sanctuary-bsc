...
// File: Garage/MedabotsMetadata.sol
...
// File: Garage/IERC721Receiver.sol
...
// File: Garage/IMedabotsGarage.sol
...
// File: Garage/IERC721Metadata.sol
...
// File: Garage/ERC721Pausable.sol
...
// File: Garage/MedabotsGarage.sol
...
contract MedabotsGarage is ERC721Pausable, Ownable {
    ...
    constructor(IMedabots _medabots) ERC721("Medabots Robots", "MERBT") {
        medabots = _medabots;
    }
    ...
    /// @param _familyId - Family for new robot.
    /// @param _tokenParts - Must be in this order [Core, rightArm, leftArm, Head].
    function assemble(uint8 _familyId, uint256[4] memory _tokenParts) external whenNotPaused {
    ...
    function disassemble(uint256 _robotId) external whenNotPaused {
    ...
    function _transferRobotParts(
        ...
        medabots.transferFrom(_from, _to, robots[_robotId].tokenPartOne);
        medabots.transferFrom(_from, _to, robots[_robotId].tokenPartTwo);
        medabots.transferFrom(_from, _to, robots[_robotId].tokenPartThree);
        medabots.transferFrom(_from, _to, robots[_robotId].tokenPartFour);
    }
...
//Importan tokenParts debe tener el orden [Core,RightArm,LeftArm,Legs] o fallara
    ...
    function _validateRobotPart(
        ...
        require(medabots.ownerOf(_tokenId) == _owner, "GARAGE: You must be the owner of the token part");
        require(medabots.familyOf(_tokenId) == _familyId, "GARAGE: All tokens must have the same family");
        require(medabots.partOf(_tokenId) == MedabotsMetadata.Part(_partId), "GARAGE: Wrong Part setted");
    }
