...
contract BUSDFarm {
    ...
    address erctoken = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //BUSD
    uint256 public constant INVEST_MIN_AMOUNT = 10 ether;
    uint256 public REFERRAL_PERCENT = 70;
    uint256 public constant PROJECT_FEE = 55; // each
    ...
    function invest(
        ...
        token_BUSD.transfer(ceoAddress, fee);
        token_BUSD.transfer(ceoAddress2, fee);
        token_BUSD.transfer(ceoAddress3, fee);
