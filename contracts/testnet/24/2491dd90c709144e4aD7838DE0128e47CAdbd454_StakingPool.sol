...
contract StakingPool is Ownable {
    ...
    constructor (address _cypherContract) {
        ...
        _stakeInfo.types.push( stakeType(30, 75) );
        _stakeInfo.types.push( stakeType(60, 102) );
        _stakeInfo.types.push( stakeType(90, 137) );
    ...
    function stake (address _sender, uint256 _amount, uint256 _stakingType) public onlyRouter returns(bool) {
        ...
        uint256 _calculateRewards = (_amount * _stakeInfo.types[_stakingType]._apy) / 100;
        require(_stakeInfo.totalUnclaimedRewards + _calculateRewards <= cypherToken.balanceOf(address(this)), "No more rewards available");
        //require(cypherToken.transferFrom(msg.sender, address(this), _amount));
