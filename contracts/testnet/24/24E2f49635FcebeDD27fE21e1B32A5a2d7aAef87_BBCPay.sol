...
contract BBCPay is Context, IBEP20, Ownable {
    ...
    address payable public MarketingWallet =
        payable(0xcDA84B0a0D58d0d4390D1Af9E1EB6A95a7fB9E04);
    ...
    string private constant _name = "BBCPay";
    ...
    function UpdateWallets(address payable newMarkeitngWallet)
        external
        onlyOwner
    {
    ...
    function UpdateBuyTaxFeePercentage(
        ...
        require(
            taxFee.add(liquidityFee).add(burnFee).add(MarketingFee) <= 15,
    ...
    function UpdateSellTaxFeePercentage(
        ...
        require(
            taxFee.add(liquidityFee).add(burnFee).add(MarketingFee) <= 20,
    ...
    function _transfer(
        ...
        if (balanceOf(DeadWallet) >= _tTotal.mul(20).div(100)) {
            _burnFee = 0;
        }
