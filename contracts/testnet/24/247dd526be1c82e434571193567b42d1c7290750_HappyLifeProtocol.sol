...
contract HappyLifeProtocol is ERC20Detailed, Ownable {
    ...
    string public _name = "Happy Life Protocol";
    string public _symbol = "HAPPY";
    ...
    uint256 public happyInsuranceFundFee = 10;
    ...
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(happyInsuranceFundFee).add(
            firePitFee
        );
    ...
    address public happyInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("HAPPY", "HAPPY", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x7b09Bf93Fc98056dCdD90e4b27454B04bAb8CF64;
        treasuryReceiver = 0xfadDD1CFBd4D323e166cB63035571286420F9E49; 
        happyInsuranceFundReceiver = 0xfadDD1CFBd4D323e166cB63035571286420F9E49;
        firePit = 0xfadDD1CFBd4D323e166cB63035571286420F9E49;
    ...
    function takeFee(
        ...
        uint256 _happyInsuranceFundFee = happyInsuranceFundFee;
        ...
        if (recipient == pair) {
            ...
            _happyInsuranceFundFee = happyInsuranceFundFee.add(sellFees);
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(happyInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(happyInsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(happyInsuranceFundReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(happyInsuranceFundFee).div(
                treasuryFee.add(happyInsuranceFundFee)
            ),
            gas: 30000
        }("");
   ...
   antiBotEnabled = _enable;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no HAPPY token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _happyInsuranceFundReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        happyInsuranceFundReceiver = _happyInsuranceFundReceiver;
        firePit = _firePit;
    }
