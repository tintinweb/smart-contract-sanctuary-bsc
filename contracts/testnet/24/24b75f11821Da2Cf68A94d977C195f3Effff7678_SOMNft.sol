...
contract SOMNft is ERC721URIStorage, AccessProtected {
    ...
    address immutable BUSD = 0x5d34f2fab8534b6955CF23FbC5aD88F6aE107e91;

    constructor() ERC721("SOM NFT", "SNFT") {}
    ...
    function AdminMint(address recipient, string memory uri) external {
        mint(recipient, uri);
    }

    function Mint(string memory uri, FEE rare) external {
        IBEP20(BUSD).transferFrom(msg.sender, address(this), setFee(rare));
        mint(msg.sender, uri);
    }
