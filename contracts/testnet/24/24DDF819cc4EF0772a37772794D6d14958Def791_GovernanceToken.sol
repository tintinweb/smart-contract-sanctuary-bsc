    ...
    AccessControlEnumerableUpgradeable
{
    ...
    modifier whenTaxEnabled() {
        require(taxesEnabled, "ERC20: TAXES_DISABLED");
        _;
    }
    ...
    function toggleTaxes(bool status_) external onlyRole(OPERATOR_ROLE) {
        taxesEnabled = status_;

        emit TaxStatusSet(status_);
    }
    ...
    function transferFrom(
        ...
        bool isTaxEnabled = taxesEnabled;
...
interface IGovernanceToken {
    ...
    function toggleTaxes(bool status_) external;
