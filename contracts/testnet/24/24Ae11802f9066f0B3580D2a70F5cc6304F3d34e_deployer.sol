    ...
    **/
    ...
    function participateToSale() public payable nonReentrant {
        ...
        if (remainingBNB < minimumParticipate) {
            require(msg.value <= remainingBNB, "Exceeding max amount");
        } else {
            require(
    ...
    function claimTokens() public nonReentrant {
        ...
        if (isVesting) {
            ...
            shares[msg.sender].vestingTokens = shares[msg.sender]
                .remainingClaim;
    ...
    function claimVesting() public nonReentrant {
        ...
        if (shares[msg.sender].remainingClaim < tokensToClaim) {
            tokensToClaim = shares[msg.sender].remainingClaim;
        }
        ...
        shares[msg.sender].lastClaimTime = block.timestamp;
        shares[msg.sender].totalClaim += tokensToClaim;

        shares[msg.sender].remainingClaim -= tokensToClaim;

        shares[msg.sender].nextClaimTime += releaseCycle;
    }
    ...
    function withdrawBnb() public onlyOwner {
        require(address(this).balance > 0, "Not enough in presale");
