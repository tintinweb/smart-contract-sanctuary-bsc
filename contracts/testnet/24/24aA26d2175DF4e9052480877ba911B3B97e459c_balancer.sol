...
contract balancer is Ownable {
  ...
  function setAuth(address _auth) public onlyOwner {
	...
	function getProposalAbove() public view returns (uint256) {
      ...
      uint256 desiredAmountOut = FictiveBalanceTokenBusd - balanceTokenLit; 
      uint256 desiredAmountOutBUSD = desiredAmountOut / 2;

      
      return getAmountInMin(_router, BUSD, LIT, desiredAmountOutBUSD);
    

	  }

  // balanceTokenLit 300
  // balanceTokenBusd 600
