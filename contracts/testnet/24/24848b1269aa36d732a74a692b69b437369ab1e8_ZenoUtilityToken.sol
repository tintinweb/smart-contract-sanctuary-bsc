...
contract ZenoUtilityToken is ERC20Burnable, MultiOperator
{
    constructor() ERC20("ZenoUtilityToken", "ZUT")
    {}
...
abstract contract MultiOperator is Ownable
{
    ...
    function _addOperator(address _operator) internal {
        require(_operator != address(0), "Operator: zero address given for new operator");
