...
contract sReincarnate is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Reincarnate", "sBETS", 9) ERC20Permit() {
    ...
    /**
        @notice allows pools to be blocked from receiving, but not sending, sBETS
    ...
    /**
        @notice increases sBETS supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sBETS
