...
// When bids were made and expiry was caught inside of the claim function
    ...
    function setOnBid(address payable _minter, uint256 _tokenId) external onlyContract {
...
// functions
 ...
 modifier onlyContract {
        require(msg.sender == address(tomiDomain), "onlyContract::Only TDNS contract can call this function ");
        _;
    }
