...
contract OracleAverage is IOracle, Initializable {
    ...
    function initialize(address _swapFactory, address _token, address _quoteToken, address _ceresFactory) external initializer {
        ...
        priceFeed = AggregatorV2V3Interface(ceresFactory.getPriceFeed(_quoteToken));
    }
    ...
    function period() public view override returns (uint256){
        return ceresFactory.oraclePeriod();
    }
