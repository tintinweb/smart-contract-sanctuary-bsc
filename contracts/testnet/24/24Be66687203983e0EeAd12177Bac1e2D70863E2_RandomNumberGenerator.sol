...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the QuadrixSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == QuadrixLottery, "Only QuadrixSwapLottery");
    ...
    /**
     * @notice Set the address for the QuadrixSwapLottery
     * @param _QuadrixSwapLottery: address of the QuadrixSwap lottery
     */
    function setLotteryAddress(address _QuadrixSwapLottery) external onlyOwner {
        QuadrixLottery = _QuadrixSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IQuadrixLottery(QuadrixLottery).viewCurrentLotteryId();
    }
}