...
contract NFT721ADemo is ERC721A, Ownable {
    using Strings for uint256;
    uint256 public price = 0 ether; //设置价格
    uint256 public maxPerWallet = 5; //单个钱包 最大 mint 数量
    uint256 public immutable supply = 10000; //设置总量
    bool public paused = true; //是否暂停mint
