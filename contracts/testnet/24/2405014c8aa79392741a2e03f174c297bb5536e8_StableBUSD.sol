...
contract StableBUSD {
    ...
    IERC20 public token = IERC20(0xC9A4Bf081161bC5EA831E358565566D1669307dF); // BUSD
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(90, 225)); // 2.25% for 90 days = 202.5% roi
		plans.push(Plan(60, 250)); // 2.5% for 60 days = 150% roi
		plans.push(Plan(30, 400)); // 4% for 30 days = 120% roi
