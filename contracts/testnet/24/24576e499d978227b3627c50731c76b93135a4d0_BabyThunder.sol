...
TG: https://t.me/babythunderofficial
Website: https://www.babythunder.co/

  Revolutionary defi token that rewards holders in Wrapped Ethereum.
...
contract BabyThunder is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyThunder";
    string constant _symbol = "BTE";
