...
contract IPStaking {
    ...
    constructor(IP _ipToken) payable {
        ipToken = _ipToken;
    ...
    function stakeTokens(uint256 _amount) public {
        ...
        ipToken.transferFrom(msg.sender, address(this), _amount);
    ...
    function unstakeTokens() public {
        ...
        ipToken.transfer(msg.sender, balance);
    ...
    function redistributeRewards() public {
        ...
        for (uint256 i = 0; i < stakers.length; i++) {
            ...
            if (balance > 0) {
                ipToken.transfer(recipient, balance);
            }
        }
    }
...
contract IP is IERC20 {
    ...
    string private constant _name = "Island Paradise";
    ...
    uint256 public constant maxRoundtripTax = 1400;
    ...
    address payable public marketingWallet =
        payable(0x827cd279670FDA424223466dE0d460035E14855d);
    ...
    function takeTaxes(
        ...
        if (
            address(antiSnipe) == address(this) &&
