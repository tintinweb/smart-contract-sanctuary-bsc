...
//   Stacking your deelian to  the Contract Address for reward.25670
...
// 
    ...
    function terminate_stk_proposal() public payable {
        ...
        require(stk_timelock[msg.sender] - block.timestamp > _TIMELOCK,"You have to wait for 168 hours to terminate proposal");
      //  require(block.timestamp - timelock >= 7 days,"You have to wait for 168 hours to terminate proposal");
...
function terminate_bot_proposal() public payable {
    require(bot_timelock[msg.sender] - block.timestamp <= _TIMELOCK,"You have to wait for 168 hours to terminate proposal");
   //     require(block.timestamp - timelock >= 7 days,"You have to wait for 168 hours to terminate proposal");
