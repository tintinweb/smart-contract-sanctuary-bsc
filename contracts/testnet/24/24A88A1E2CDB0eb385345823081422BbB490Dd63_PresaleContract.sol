...
contract PresaleContract is Ownable, ReentrancyGuard, IPresaleContract {
    /* ========== STATE VARIABLES ========== */
    ...
    /* ========== MUTATIVE FUNCTIONS ========== */
    function buyTALTokenByBNB(uint256 _amountTAL)
        external
        payable
        nonReentrant
    {
        ...
        emit BuyTALTokenByBNB(msg.sender, _amountTAL, msg.value);
    }
    ...
    function buyTALTokenByCash(uint256 _amountTAL) external nonReentrant {
        require(_amountTAL > 0, "Amount TAL must be more than 0");
        ...
        emit BuyTALTokenByCash(msg.sender, _amountTAL);
    }
...
interface IPresaleContract {
    ...
    /* ========== MUTATIVE FUNCTIONS ========== */
    function buyTALTokenByBNB(uint256 _amount) external payable;
    ...
    function buyTALTokenByCash(uint256 _amountTAL) external;
