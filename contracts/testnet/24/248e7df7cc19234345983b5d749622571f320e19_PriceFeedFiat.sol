...
/*
    ...
    - nho set private sau khi test
*/


contract PriceFeedFiat is Ownable {
    ...
    function getTokenPrice(address tokenAddress) public view returns (uint256) {
     ...
     function getTokenPriceWithDecimals(address tokenAddress) public view returns (uint256, uint8) {
        uint256 tokenPrice;
        uint8 tokenDecimals;
