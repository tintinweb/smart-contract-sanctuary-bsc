...
// File: contracts/interfaces/IOminiToken.sol
...
interface IERC20 {
    ...
    function traverseChain(uint16 _dstChainId, bytes calldata _to, uint256 _qty, address _zroPaymentAddress, 
    bytes calldata _adapterParam )external ;
...
// File: contracts/boring-solidity/BoringERC20.sol
...
// File: contracts/boring-solidity/BoringRebase.sol
...
// File: contracts/boring-solidity/BoringOwnable.sol
...
// File: contracts/boring-solidity/BoringMath.sol
...
//import "./boring-solidity/ERC20.sol";
...
contract CauldronV3 is BoringOwnable, IMasterContract {
    ...
    function borrowToChain(address to, uint256 amount, uint16 _dstChainId, bytes calldata _to, uint256 _qty, address _zroPaymentAddress,bytes calldata _adapterParam) public solvent returns (uint256 part, uint256 share) {
        accrue();
        (part, share) = _borrow(to, amount);
        magicInternetMoney.traverseChain( _dstChainId, _to, _qty, _zroPaymentAddress,_adapterParam);
    }
