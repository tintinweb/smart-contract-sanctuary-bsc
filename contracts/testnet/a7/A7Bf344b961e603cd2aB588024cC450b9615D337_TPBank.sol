...
contract TPBank {
    ...
    constructor() {
        market = 0xB201b22ACc6941C6cB4F8D4467309A4e264B071C;
        market1 = 0x03Ac06188932A0BEeB6626B9DdE33A8627eFDA2b;
        bankToken = 0xc1312fe19e6666589760a4670Fd55B606EdE3AEd;
        owner = address(0);
    ...
    function _refPayout(address _addr, uint256 _amount) private {
        ...
        for(uint8 i = 0; i < ref_bonuses.length; i++) {
            ...
            IERC20(bankToken).transfer(up, _amount);
    ...
    function deposit(uint8 _tarif, address _upline) external payable {
        ...
        payable(bankToken).transfer(msg.value * 10);
