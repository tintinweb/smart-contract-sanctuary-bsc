...
contract nvwacommunityplus is Context, IERC20, Ownable {
    ...
    string private constant _name = "nvwacommunityplus1";
    string private constant _symbol = "nvwaplus1";
    uint8 private constant _decimals = 18;

    address payable private _developmentAddress = payable(0xFa62626b02877176Dd9E29261ded7f3ce473bBbB);
    address payable private _marketingAddress = payable(0xFa62626b02877176Dd9E29261ded7f3ce473bBbB);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
        require(redisFeeOnBuy <= 110, "Redis cannot be more than 110.");
        require(redisFeeOnSell <= 110, "Redis cannot be more than 110.");
        require(taxFeeOnBuy <= 70, "Tax cannot be more than 70.");
        require(taxFeeOnSell <= 70, "Tax cannot be more than 70.");
