...
contract MvccHashGame is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(address _busd, address _mvcc, address _mvcr,
    ...
    function joinGame(uint256 _amount) external nonReentrant {
        ...
        // Transfer fund
        BUSD.safeTransferFrom(msg.sender, address(ITreasury), _amount);
