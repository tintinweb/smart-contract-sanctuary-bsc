...
contract CHEEMSINUTWO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "Cheems Inu 2.0";

    string private _symbol = "$CINU";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x76fb82ac5d9f8A6bB8F4DC85b5F8F2036Ed6ED0B;
