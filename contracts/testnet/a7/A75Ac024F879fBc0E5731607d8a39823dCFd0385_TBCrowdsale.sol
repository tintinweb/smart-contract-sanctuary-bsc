...
contract TBCrowdsale is Ownable {
    ...
    function buyTokenByUSDT() external payable {
        ...
        // nguoi gui co du usdt de chuyen
        require(
          token.balanceOf(msg.sender) >= usdtAmount,
            "Insufficient account balance"
        );
        ...
        // transfer USDT tu buyer cho wallet cua dev
        SafeERC20.safeTransferFrom(usdtToken,address(this), wallet, usdtAmount);

        // gui lai ico token cho buyer
