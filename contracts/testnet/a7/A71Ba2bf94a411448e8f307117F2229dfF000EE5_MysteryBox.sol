...
interface IMysteryBox {
    function mintMysteryBox(uint256 _boxType, string calldata _boxName, string calldata _boxDescription,  uint256 _quantity, bool _status, string calldata _tokenURI) external;
