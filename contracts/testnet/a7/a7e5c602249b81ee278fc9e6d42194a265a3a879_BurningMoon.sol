...
contract BurningMoon is IBEP20, Ownable
{
    ...
    IPYESwapRouter private  _pancakeRouter; 
    ...
    constructor () {
        ...
        _pancakeRouter = IPYESwapRouter(PancakeRouter);
        _pancakePairAddress = IPYESwapFactory(_pancakeRouter.factory()).createPair(address(this), _pancakeRouter.WETH(),true);
