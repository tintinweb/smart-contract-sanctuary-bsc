 ...
 */
contract Trigger is AccessControl,ReentrancyGuard,  Initializable, KeeperCompatibleInterface {
    using SafeERC20 for IERC20;
    bytes32 constant public POL_ROLE = keccak256("POL_ROLE");
    uint256 reBalancePercentage; // Ratio between treasury and POL
 ...
 */
    ...
    */
    ...
    function setTeamTax(uint _value) external onlyRole(DEFAULT_ADMIN_ROLE){
        require(_value != 0, "Trigger: invalid value");
        teamTax = _value;
    }
    ...
    Note Need to call setReBalanceValues first for 
        ...
        only admin can call 
     */
    function reBalancePool() internal nonReentrant  {
        uint256 netBalance;
