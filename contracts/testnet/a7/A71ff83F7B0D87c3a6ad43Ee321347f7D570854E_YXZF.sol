...
contract YXZF is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "ZF Coin";
    string private _symbol = "ZFC";
    ...
    constructor (address teamWalletAddress,address marketingWalletAddress) payable public {
