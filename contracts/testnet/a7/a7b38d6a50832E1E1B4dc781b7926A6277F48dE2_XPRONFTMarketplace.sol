...
* Developed By XPRO Community
* https://t.me/xprojectofficial
*/
...
contract XPRONFTMarketplace is ReentrancyGuard {
    ...
    uint256 private listingFee = 0.075 ether;
...
contract XPRONFT is ERC721URIStorage {
    using Counters for Counters.Counter;
    ...
    constructor(address _marketplaceAddress) ERC721("XPROJECT NFT", "XPRONFT") {
