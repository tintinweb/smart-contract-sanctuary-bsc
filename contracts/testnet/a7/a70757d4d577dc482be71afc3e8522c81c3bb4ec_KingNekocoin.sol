...
contract KingNekocoin is Context, IERC20, Ownable {
    ...
    string private constant _name = "King Neko Coin"; // 
    string private constant _symbol = "$KINGNEKO$"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 10;
    uint256 public _liquidityFee = 0;
    address public  _marketingWallet = 0xf60ECF169cE293307afBB0126C99cFA53d8Dd674;
