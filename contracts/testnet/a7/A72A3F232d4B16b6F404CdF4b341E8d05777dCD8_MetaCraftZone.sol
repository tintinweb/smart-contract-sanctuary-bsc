...
contract ERC20Ex is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        uint256 feeAmount = pool == address(0) ? 0 : amount / 100;
        unchecked {
 ...
 */
contract MetaCraftZone is ERC20Ex, Pausable, AccessControl {
    ...
    constructor() ERC20Ex("MetaCraftZone", "MCZ") {
