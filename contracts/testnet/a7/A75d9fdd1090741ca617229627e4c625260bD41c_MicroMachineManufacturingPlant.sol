...
contract MicroMachineManufacturingPlant is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable  {
    ...
    constructor(address _EngineEcosystemContractAddress ) ERC721("MicroMachineWarBots", "MMWarBot") {
        ...
        //initEngineEcosystemContractAddress ( _EngineEcosystemContractAddress  ); 

        _EngineEcosystemContractAddress;
    ...
    function initEngineEcosystemContractAddress ( address _address ) internal {
        require ( _address != address(0) , "No Zero Address");
        EngineEcosystemContractAddress = _address;
        EngineEcosystemContract _enginecontract = EngineEcosystemContract ( EngineEcosystemContractAddress );
    ...
    address public RequestDataAddress = 0x6961EB7d7Ba1FA7683a2B0427B1D7EFFcd776f8A;
