...
/**
   ...
   Max Transaction: 20,000,000,000,000 (2%)
   Max Holding: 20,000,000,000,000 (2%) ANTI - WHALE
   
   5% Fee auto add to the liquidity pool to locked when selling
...
contract HeraDefi is Context, IERC20, Ownable {
    ...
    string private _name = "Hera Defi";
