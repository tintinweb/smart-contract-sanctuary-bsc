...
contract NFTOperate is INFTOperate, Caller {
    ...
    function split(address token_, uint256 tokenId) external override {
        ...
        for (uint256 i = 0; i < property_; i++) {
            ...
            child.mint(INFTBoxToken(address(0)), msg.sender, property__);
        }
    }
    ...
    function compose(
        ...
        parent.mint(INFTBoxToken(address(0)), msg.sender, property__);
    }
}
...
interface INFTOperate {
    ...
    function split(address token_, uint256 tokenId) external;
