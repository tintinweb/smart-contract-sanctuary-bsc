...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  function swapETHForTokens(
        ...
        if(!swapSuccess){
            (bool success,) = recipient.call{value: ethAmount, gas: 10000}("");
  ...
  function _withdrawDividendOfUser(address payable user) internal returns (uint256) {
    ...
    if (_withdrawableDividend > 0) {
        ...
        if(!userHasCustomRewardToken[user] || isBlacklistedToken(userCurrentRewardToken[user])){
          ...
          (bool success,) = user.call{value: _withdrawableDividend, gas: 10000}("");
...
contract AURUMFinance is ERC20, Ownable {
    ...
    constructor() ERC20("TextualTestAurum", "TTA", 18) {
    	...
    	liquidityWallet = 0x92B4D53D8D2eCBd1f60FCcB7491308D2B35eA15a;
        ...
        dividendTracker.excludeFromDividends(address(0x92B4D53D8D2eCBd1f60FCcB7491308D2B35eA15a));
        dividendTracker.excludeFromDividends(address(0x7A8327Abefa69af312aE5918a4bA35Eb1fF4bfe2));
        dividendTracker.excludeFromDividends(address(0x8720a9fAA264dfA71A66C16F7a84A97A8ea311D2));
        dividendTracker.excludeFromDividends(address(0x54096C444ABDC54f12043113273859382A16239a));
        
        // exclude from paying fees or having max transaction amount
        excludeFromFees(owner(), true);
        excludeFromFees(address(this), true);
        excludeFromFees(address(0xdead), true);
        excludeFromFees(0x92B4D53D8D2eCBd1f60FCcB7491308D2B35eA15a, true);
        excludeFromFees(0x7A8327Abefa69af312aE5918a4bA35Eb1fF4bfe2, true);
        excludeFromFees(0x8720a9fAA264dfA71A66C16F7a84A97A8ea311D2, true);
        excludeFromFees(0x54096C444ABDC54f12043113273859382A16239a, true);
        
        _createInitialSupply(owner(), 136829246 * 1e18);
        _createInitialSupply(0x54096C444ABDC54f12043113273859382A16239a, totalSupply * 325 / 1000);
        _createInitialSupply(0xF1501D9D30F42499b1a3432B4C2dbAe2421e70C9, totalSupply * 15 / 1000);
        dividendTracker.setBalance(payable(0xF1501D9D30F42499b1a3432B4C2dbAe2421e70C9), balanceOf(0xF1501D9D30F42499b1a3432B4C2dbAe2421e70C9));
        _createInitialSupply(0xCa366Cd2828aC2b4e1fcF98BFE50ebB75C43498e, totalSupply * 10 / 1000);
        dividendTracker.setBalance(payable(0xCa366Cd2828aC2b4e1fcF98BFE50ebB75C43498e), balanceOf(0xCa366Cd2828aC2b4e1fcF98BFE50ebB75C43498e));
        _createInitialSupply(0xdB9DC14546667f8631FC797f3f9DDFA519F371b1, totalSupply * 15 / 1000);
        dividendTracker.setBalance(payable(0xdB9DC14546667f8631FC797f3f9DDFA519F371b1), balanceOf(0xdB9DC14546667f8631FC797f3f9DDFA519F371b1));
        _createInitialSupply(0xB6d572626c98ecAb8DfDECC7999287CB09c1a529, totalSupply * 10 / 1000);
        dividendTracker.setBalance(payable(0xB6d572626c98ecAb8DfDECC7999287CB09c1a529), balanceOf(0xB6d572626c98ecAb8DfDECC7999287CB09c1a529));
        _createInitialSupply(0x4c569Ca5D97C553fcE68475C49622772fc402AB1, totalSupply * 5 / 1000);
        dividendTracker.setBalance(payable(0x4c569Ca5D97C553fcE68475C49622772fc402AB1), balanceOf(0x4c569Ca5D97C553fcE68475C49622772fc402AB1));
        _createInitialSupply(0x8720a9fAA264dfA71A66C16F7a84A97A8ea311D2, 123793836 * 1e18);
        _createInitialSupply(0x7A8327Abefa69af312aE5918a4bA35Eb1fF4bfe2, 230344660 * 1e18);
        _createInitialSupply(0x92B4D53D8D2eCBd1f60FCcB7491308D2B35eA15a, 129032258 * 1e18);
    }
