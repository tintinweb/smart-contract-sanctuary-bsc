...
contract SaFuTrendz is ERC20, Ownable {
    ...
    constructor() ERC20("SaFuTrendz", "STZ") {
        ...
        buyBuyBackFee = _buyBBackFee;
        buySalaryFee = _buySalaryFee;
        buyVaultFee = _buyVaultFee;
        buyLiquidityFee = _buyLiquidityFee;
        buyTotalFees = buyDevFee + buyMarketingFee + buyBuyBackFee + buySalaryFee + buyVaultFee + buyLiquidityFee;

        sellDevFee = _sellDevFee;
        sellMarketingFee =_sellMarketingFee;
        sellBuyBackFee = _sellBBackFee;
        sellSalaryFee = _sellSalaryFee;
        sellVaultFee = _sellVaultFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellTotalFees = sellDevFee + sellMarketingFee + sellBuyBackFee + sellSalaryFee + sellVaultFee + sellLiquidityFee;

        devWallet = address(0xA60aBa7Cca5998E86E77Eac10e56dDF2576621b9); // set as dev wallet
        marketingWallet = address(0xadCB955285336fE9EacD70778051971d2F6424d6); // set as marketing wallet
        buybackWallet = address(0xA60aBa7Cca5998E86E77Eac10e56dDF2576621b9); // set as buyback wallet
        salaryWallet = address(0xadCB955285336fE9EacD70778051971d2F6424d6); //set as salary wallet
        vaultWallet = address(0xadCB955285336fE9EacD70778051971d2F6424d6); //set as vault wallet
        ...
        returns (bool)
    {
        require(
            ...
            "Swap amount cannot be lower than 0.0000001% total supply."
        );
        require(
    ...
    function updateSalaryWallet(address newSalaryWallet)
        external
        onlyOwner
    {
    ...
    function _transfer(
        ...
        uint256 tokensForSalary = 0;
        uint256 tokensForVault = 0;
