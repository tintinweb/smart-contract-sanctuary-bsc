...
contract WaterDoge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    WaterDogeDividendTracker public dividendTracker;
    ...
    uint256 public antiDumpCycle = 5 minutes;
    ...
    constructor() ERC20("WaterDoge", "WTDoge") {
        ...
        maxTransactionAmount = totalTokenSupply / 100; // 1%
...
contract WaterDogeDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    WaterDoge public WaterDogeContract;
    ...
    constructor(
        ...
        defaultToken = token;
        WaterDogeContract = WaterDoge(mainContract);
    ...
    function _transfer(
        ...
        require(false, "WaterDoge_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "WaterDoge_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main WaterDoge contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(WaterDogeContract);

            uint256 prevBalance = WaterDogeContract.balanceOf(address(this));
            ...
            {
                uint256 received = WaterDogeContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    WaterDogeContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
