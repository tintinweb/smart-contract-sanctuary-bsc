...
contract Staking is IStaking, Ownable {
    ...
    uint public veryEarlyWithdrawlDays = 14 days;
    uint public littleEarlyWithdrawlFee = 15;
    uint public littleEarlyWithdrawlDays = 28 days;
    ...
    function updateStakingDetails(uint8 apy, uint8 _durationInDays, uint _veryEarlyFeeDays, uint _veryEarlyFee,uint _littleEarlyFeeDays, uint _littleEarlyFee, uint _normalFee ) external onlyOwner returns(bool) {
        fixedAPY = apy;
