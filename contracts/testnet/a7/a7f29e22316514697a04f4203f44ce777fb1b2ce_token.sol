...
contract token is ERC20,WhiteList {
    ...
    address private _marketWallet = address(0x6f5eaf337B5BBa1d59b2cF0B89222074335092e7);

    //name,symbol
    string internal tokenName = "HCH";
    string internal tokenSymbol = "HCH";
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            amount = amount.div(100).mul(97);//96%
        }
    ...
    function swapAndLiquifyV3(uint256 contractTokenBalance) public {
        uint256 usdtNumber = contractTokenBalance.div(100).mul(60);
        swapTokensForOther(usdtNumber);
    }
