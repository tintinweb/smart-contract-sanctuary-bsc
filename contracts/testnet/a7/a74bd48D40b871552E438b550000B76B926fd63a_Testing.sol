...
contract Testing is ERC20, Ownable {
    ...
    event Rewarded(address indexed player, uint256 dappPoints, uint256 realTokens);
    event DailyTotalAdd(address indexed player, uint256 dappPoints);
    ...
    function addRewardTotal(uint256 _dappPoints, address _addr) external {
        ...
        emit DailyTotalAdd(_addr, _dappPoints);
    }
