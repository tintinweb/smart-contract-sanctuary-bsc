...
contract TouchSky {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 120e18; // 5 USDT
	uint256[] public REFERRAL_PERCENTS 	= [4031, 201, 100, 100, 100, 50, 50, 25, 25, 25];
	uint256[] public SEED_PERCENTS 		= [400, 400, 400, 400, 400, 400, 400, 0, 0, 0];
	uint256 constant public PROJECT_FEE = 1350;
	...
	struct User {
		...
		uint256 autopoolCount;
		uint256 autopool;
		uint256 autopooldownline;
		address autopoolreferrer;
	}
