...
contract TetrixNamespaceRegistry is 
  INamespaceMinter,
  Ownable,
  ...
  ERC721Pausable
{
  ...
  function _description() private pure returns(string memory) {
    return "Tetrix Network. Holders of this collection namespace have the rights to customize the content available.";
  }
  ...
  function _svg64(string memory namespace) private pure returns(string memory) {
    ...
    svg = abi.encodePacked(svg,
      '<text font-family="', "'Courier New'", '" font-weight="bold" font-size="30" y="60%" x="50%" fill="#444" dominant-baseline="middle" text-anchor="middle">tetrix.xyz</text>',
