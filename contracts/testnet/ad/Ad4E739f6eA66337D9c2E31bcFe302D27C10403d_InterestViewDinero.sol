...
contract InterestViewDinero is PriceAware, MainDemoConsumerBase {
    ...
    IERC20 private constant ETH =
        IERC20(0x87e28B2242b0aB1f77360a1c3bB118FE662Ae0c7);
        ...
        )
    {
        ...
        for (uint256 i; i < markets.length; i++) {
            ...
            if (syntheticType == SyntheticMarketType.RedstonePriceAware) {
                summary.TVL = ETH.balanceOf(address(market));
            } else {
...
abstract contract PriceAware {
    ...
    uint256 constant _MAX_DATA_TIMESTAMP_DELAY = 15 * 60; // 15 minutes
    uint256 constant _MAX_BLOCK_TIMESTAMP_DELAY = 10 * 60; // 10 min
