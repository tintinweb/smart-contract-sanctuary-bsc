...
contract InfinityRaiseDividendTracker is Ownable, DividendPayingToken, ERC20TokenRecover, IInfinityRaiseDividendTracker {
    ...
    constructor(address dividendToken, address _parentToken)
        DividendPayingToken("InfinityRaise Dividend Tracker", "IRAISEDT", dividendToken)
    {
        claimWait = 3600;
    ...
    function recoverERC20(address tokenAddress, uint256 tokenAmount)
        ...
        onlyOwner
    {
        require(tokenAddress != dividendToken, "InfinityRaiseDividendTracker: Cannot retrieve RBA");
    ...
    function _transfer(
        ...
        require(false, "InfinityRaiseDividendTracker: No transfers allowed");
    }
    ...
    function excludeFromDividends(address account) external override onlyOwnerOrDeployer {
        require(!excludedFromDividends[account], "InfinityRaiseDividendTracker: Account already excluded");
    ...
    function includeInDividends(address account) external override onlyOwnerOrDeployer {
        require(excludedFromDividends[account], "InfinityRaiseDividendTracker: Account not excluded");
    ...
    function updateClaimWait(uint256 newClaimWait) external override onlyOwnerOrDeployer {
        require(
            ...
            "InfinityRaiseDividendTracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(newClaimWait != claimWait, "InfinityRaiseDividendTracker: Cannot update claimWait to same value");
