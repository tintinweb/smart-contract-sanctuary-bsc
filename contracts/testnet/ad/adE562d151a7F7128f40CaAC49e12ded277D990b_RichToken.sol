...
contract RichToken is Context, IERC20, Ownable {
    ...
    uint256 private _tFeePermille = 15; //15 permille = 1.5%

    string private constant _name = 'Rich Token';
    ...
    function tokenFromReflection(uint256 rAmount) public view returns (uint256) {
        require(rAmount <= _rTotal, "Amount must be less than or equal to total reflections");
    ...
    function _getTValues(uint256 tAmount, bool isFeeless_) private view returns (uint256, uint256) {
        ...
        uint256 tFee = (tAmount * _tFeePermille) / 1000;
    ...
    function setFeePermille(uint256 fee) external onlyOwner {
        require(fee >= 10, 'Fee is too small');
        require(fee <= 90, 'Fee is too big');
        _tFeePermille = fee;
    }
}
