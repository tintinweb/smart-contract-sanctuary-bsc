...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        uint256 maxSellAmount = senderBalance * 9999 / 10000;
...
contract MyToken is ERC20, Ownable{
    ...
    uint256 public totalSuply = 1000000000000000;

    uint256 public swapThreshold = totalSuply / 20000000000 * 10e9; // 1/10000 thredshold
    
    address public marketingWallet = 0xfaCA2872eD10aCf65F7B1AbFaCBFBa7cE09182D5;
    ...
    constructor() ERC20("S2Kjihua", "S2Kjihua") {
