...
contract Ricecoin is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x51CcA2dcB786807C25F3035b69543091701f198d); 
    address payable public Wallet_Dev = payable(0x51CcA2dcB786807C25F3035b69543091701f198d);
    ...
    string private constant _name = "Ricecoin"; 
    ...
    constructor () {
        ...
        _owner = 0x51CcA2dcB786807C25F3035b69543091701f198d;
        emit OwnershipTransferred(address(0), _owner);

        _tOwned[owner()] = _tTotal;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); 
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x5D20f117612a67096e673F50676a78a0496f2034); // Testnet
