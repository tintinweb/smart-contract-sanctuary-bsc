...
contract DecentralizedUnited is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x0E8682f438B4D1e6061242096974Ffb7ed20eC65); // Marketing Wallet Address
    address payable public devWalletAddress = payable(0xE192d3ADE050508AE5783B59ACE04AAEF7bDE281); // dev Wallet Address
    ...
    constructor () {
        address _owner = 0x4D26D5D678aF9696817cf38F9d59Ed8D3f4cAc5a;
