...
contract TitanoTest is ERC20Detailed, Ownable {
    ...
    string public _name = "TitanoTest";
    ...
    constructor() ERC20Detailed("TitanoTest", "TT", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x121efC6B9D062196bf2FE9C0Da2C4EEF773675b2;
        treasuryReceiver = 0xD089C6a943f826d4dA93d35038618AAe214B19Fc; 
        riskFreeValueReceiver = 0x2AD59b2B1846626B6bc3E24818B59986B97C3536;
        firePit = ZERO;
    ...
    function rebase() internal {
        ...
        if (deltaTimeFromInit > (2 hours)) {
            rebaseRate = 7970;
            times = deltaTime.div(10 minutes);
        } else if (deltaTimeFromInit > (1 hours)) {
            times = deltaTime.div(7 minutes);
            rebaseRate = 6140;
        } else {
            rebaseRate = 4190;
        } 
