...
contract Pi is ERC20, Ownable {
    ...
    uint256 public buyMarketFee = 20;
    uint256 public sellMarketFee = 20;
    ...
    function setTakeTax(bool value) public onlyOwner {
        require(takeTax != value, "takeTax is this value.");
        takeTax = value;
        if (takeTax) {
            buyLiquidityFee = 0;
            sellLiquidityFee = 0;
