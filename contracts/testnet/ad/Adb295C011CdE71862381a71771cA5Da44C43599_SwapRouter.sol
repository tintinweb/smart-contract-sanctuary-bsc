...
contract SwapRouter is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    event Swap(string indexed aggregatorId, address indexed caller);
    event Swap1(string aggregatorId, address indexed caller);


    function test() external {
        emit Swap("test", _msgSender());
        emit Swap1("test1", _msgSender());
    }
}