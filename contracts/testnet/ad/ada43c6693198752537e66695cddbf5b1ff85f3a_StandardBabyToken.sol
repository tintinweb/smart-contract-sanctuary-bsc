...
contract StandardBabyToken is IERC20Upgradeable, OwnableUpgradeable, BaseToken {
    using SafeMath for uint256;
    ...
    function initialize(
        ...
        address[] memory addrs, // reward, router, marketing wallet, dividendTracker
        uint256[] memory feeSettings, // rewards, liquidity, marketing
        uint256 minimumTokenBalanceForDividends_
    ) external initializer {
        _name = name_;
        _symbol = symbol_;
    ...
    function _transfer(
        ...
        if (takeFee) {
            ...
            transfer_(from, address(this), fees);
        }
