...
contract DelegationOrder is Ownable {
    ...
    mapping(uint256 => DelegationInfo) public records;
    ...
    constructor(address _merchantStorage) {
    ...
    function release(
        ...
        DelegationInfo memory _record = DelegationInfo({
            ...
            status: 1,
            terms: _terms,
            legal_currency_name: _legal_currency_name,
    ...
    function modify(
        ...
        DelegationInfo memory _record = records[_recordNo];
        require(_record.recordNo != 0, "order does not exist");        
        require(_record.userAddr == msg.sender, "You do not have permission");

        _payFee("modify");

        _record.total_money = _total_money;
        ...
        _record.legal_currency_name = _legal_currency_name;
    ...
    function getDelegationInfo(uint recordNo) public view returns(DelegationInfo memory){
        return records[recordNo];
    }
