...
contract Test is ERC20, Ownable {
    ...
    uint256 public maxBuyTranscationAmount = 50000000000000 * (10**18);
    uint256 public maxSellTransactionAmount = 4000000000000 * (10**18);
    uint256 public maxWalletBalance = 100000000000000 * (10**18);
    ...
    constructor() ERC20("Test Doge Token", "TESTDOGE") {
        	
    	marketingWallet = 0x0088Dc2d02f83769337C4CBd115e520FA1b281f1; 
