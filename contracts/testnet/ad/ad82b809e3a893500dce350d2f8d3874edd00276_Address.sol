...
/**
BSC original Code for Kimo Inu, the first daily ever-changing Token!
Website: 
Telegram: https://t.me/
...
contract KimoInu is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xe24f24d68b8E94da775787D411A65c0f60cAb24A); 
    address payable public Wallet_Dev = payable(0xe24f24d68b8E94da775787D411A65c0f60cAb24A);
    ...
    string private constant _name = "KiTest"; 
    string private constant _symbol = unicode"KTST"; 
    ...
    constructor () {
        ...
        _owner = 0xe24f24d68b8E94da775787D411A65c0f60cAb24A;
