...
// File: My Learning/Flashloan/interfaces/IPancakeRouter02.sol
...
// File: My Learning/Flashloan/interfaces/IPancakeFactory.sol
...
// File: My Learning/Flashloan/interfaces/IPancakePair.sol
...
// File: My Learning/Flashloan/FlashLoan.sol
...
contract Flashloan is Ownable{
    ...
    event Borrowed(uint amount);
    event Log(string message, uint val);

    function startArbitrage(address _tokenBorrow, uint _amount) public onlyOwner{
        address pairAddress = IPancakeFactory(address(0x6725F303b657a9451d8BA641348b6761A6CC7a17)).getPair(_tokenBorrow,WBNB);
    ...
    function fundTheContract(address _token, uint256 _amount) public payable {
