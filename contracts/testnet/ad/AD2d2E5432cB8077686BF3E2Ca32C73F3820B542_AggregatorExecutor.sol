...
//    IWBNB public WBNB = IWBNB(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    ...
    //=========== external functions ============//
    function swap(SwapStep[] calldata _swaps, address payable _receiver, bool _isFromETH, bool _isToETH) external payable {
        //check input eth
        if(_isFromETH) {
        ...
        //send eth to user
        if (_isToETH && _swaps[_length - 1].toToken == address(WBNB)) {
