...
contract ALTROZ is BEP20 {
    ...
    uint256 constant internal tokenPriceInitial_            = 3.5 finney; 
    uint256 internal tokenPriceIncremental_                 = 0.0001 finney;
    ...
    */
	...
	function StopICO(uint8 phase) onlyDeveloper() public{
		if (phase ==1){
			P1_ICO = 0;
			P2_ICO = 1;
			tokenPriceIncremental_     = 0.00015 finney;
		}
		else if (phase ==2){
			P2_ICO = 0;
			P3_ICO = 1;
			tokenPriceIncremental_     = 0.0002 finney;
		}
		else {
			P3_ICO = 0;
			startdapp = 1;
