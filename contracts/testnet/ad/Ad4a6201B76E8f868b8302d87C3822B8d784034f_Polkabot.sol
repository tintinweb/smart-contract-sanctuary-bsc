...
=== 'Polkabot' Token contract with following features ===
    => BEP20 Compliance
...
-------------------------------------------------------------------
 Copyright (c) 2021 onwards MMMToken
-------------------------------------------------------------------
*/ 
...
contract Polkabot is owned {
    
    using SafeMath for uint256;

    string constant private _name = "Polkabot";
    string constant private _symbol = "PBOT";
