...
/**
 *  Taxes : 8% Buy | 8% Sell                          
 *  Telegram : https://t.me/fanpinetwork
 *  Website : http://www.fanpinetwork.vip/
 *  Welcome to FanPiNetwork
 *  Very happy that the Fan Pi Network Token project officially has a Telegram community and super nice updates.
...
contract FanPiNetwork is Context, IERC20, Ownable {
    ...
    string private _name = "FanPiNetwork";
    ...
    address public ownerAddres = address(0x3c23CE384283b70D426ff8428E5798073c414523);
    address public devAddress = address(0xf857A75864f19841Bd9c6C07fCa5f0c636566A75);
    ...
    constructor () public {
     ...
     //   IPancakeRouter02 _uniswapV2Router = IPancakeRouter02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);// testnet
