...
//// Test token: copying it may result in losing money. do it at your own resposability.
...
contract TLC is ERC20, Ownable {
    ...
    uint256 public tradingEnabledTimestamp = 1665421199000;
    ...
    constructor() public ERC20("Terra Cash", "TCL") {
        // LP burn address
...
contract TLCDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() public DividendPayingToken("TLC_Dividend_Tracker", "TLC_Dividend_Tracker") {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 10 * (10**18); //must hold 100000+ tokens
    }
