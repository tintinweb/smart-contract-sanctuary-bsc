...
// File contracts/HoldexLaunchPad.sol
...
contract HoldexLaunchPad is AccessControl, Pausable, ReentrancyGuard {
    ...
    function purchase(uint256 amount) external nonReentrant whenNotPaused {
        ...
        require(
            whitelist[_msgSender()] || isKycDisabled,
