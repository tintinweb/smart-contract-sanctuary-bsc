...
contract foodfitokenstaking is Ownable {
    ...
    uint256[3] public tokenReward = [50,58,63];
    ...
    function claim(uint256 _plan) public {
        require(_plan < 3, "Stake plan must be less than 3");
        require(users[msg.sender].tokenStakes[_plan].time + timestep < block.timestamp, "harvest duration not completed");
