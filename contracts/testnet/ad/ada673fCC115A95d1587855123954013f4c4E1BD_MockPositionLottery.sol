...
contract MockPositionLottery is PositionLottery {
    ...
    function setMinTimeLottery(uint256 newMinTime) external {
        MIN_LENGTH_LOTTERY = 1 minutes;
    }
    ...
    PositionLotteryStorage
{
        ...
        )
    {
        ...
        return (prizes, totalRewards, _lotteries[lotteryId].endTime,  _lotteries[lotteryId].finalNumber);
    }
