...
contract FiveElements is Permission {
    ...
    IERC20 public usdtContract = IERC20(0xB4F4E09e421D91A90755DC06E89F312A54c270f4);
    ...
    function allocation() private{
        ...
        dividendBouns[clubAddress] = dividendBouns[clubAddress] + ticketPrice * 25 / 1000;
        dividendBouns[maintainAddress] = dividendBouns[maintainAddress] + ticketPrice * 70 / 1000;
    }
    ...
    function allocationRecommender(address recommender) private{
        ...
        dividendBouns[clubAddress] = dividendBouns[clubAddress] + ticketPrice * 25 / 1000;
        dividendBouns[maintainAddress] = dividendBouns[maintainAddress] + ticketPrice * 50 / 1000;
    }
    ...
    function endGame() public {
        ...
        uint club = dividendBouns[clubAddress];
        uint maintain = dividendBouns[maintainAddress];
        dividendBouns[clubAddress] = 0;
        dividendBouns[maintainAddress] = 0;
        transferUsdt([clubAddress, maintainAddress], [club, maintain]);
    }
