...
contract LiteStaking is StakeInfo {
    ...
    uint256 public constant unstakeDuration = 600; // 解压周期 86400
    ...
    mapping(uint256 => mapping(address => UserInfo)) userInfo; // 用户信息 deposit_duration=>user=>user
    ...
    constructor(address token_) {
        ...
        _addPool(600, 20); //30d 2592000
        _addPool(1200, 35); //60d 5184000
        _addPool(1800, 45); //90d 7776000
    }
