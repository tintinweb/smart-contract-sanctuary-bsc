...
import {ERC20_Swap2_Own_AutoBB_TwoWal} from './ERC20_Swap2_Own_AutoBB_TwoWal.sol';
...
contract TokenGen6{
 modifier onlyFactory() {
    ...
    address factory= 0xBb03D72Fc79e17C08F45fcf7e08E7AC27Ee368fe;
    ...
    function generateToken(
       string memory name,
        ...
        ERC20_Swap2_Own_AutoBB_TwoWal newtok = new ERC20_Swap2_Own_AutoBB_TwoWal(name, symbol, decimals, totalSupply, owner, raddr, w1addr, w1bfee, w1sfee, w2addr, w2bfee, w2sfee, bbbfee, bbsfee);
...
// Swap 2.0, Ownable, 2 Wallet, autobuyback

contract ERC20_Swap2_Own_AutoBB_TwoWal is IERC20, Ownable {
    ...
    function setBuyFees(uint256 _wallet1Fee, uint256 _wallet2Fee, uint256 _buybackFee) external onlyOwner {
    ...
    function setSellFees(uint256 _wallet1Fee, uint256 _wallet2Fee, uint256 _buybackFee) external onlyOwner {
    ...
    function _getValues(uint256 tAmount) private view returns (FeeValues memory) {
        ...
        values.transferAmount = tAmount.sub(values.wallet1).sub(values.buyBack).sub(values.wallet2);
        return values;
    }
    ...
    function getTotalFee(address account) public view returns (uint256) {
        ...
        return _defaultFees.wallet1Fee.add(_defaultFees.buybackFee).add(_defaultFees.wallet2Fee);
        }
    }
