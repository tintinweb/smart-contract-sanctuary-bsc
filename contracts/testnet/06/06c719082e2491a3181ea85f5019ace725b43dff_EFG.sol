...
contract EFG {
    ...
    uint256 private constant dayPerCycle = 700; 

    uint256 private constant dayRewardPercents = 114;


    uint256 private constant maxAddFreeze = 2200;
  ...
  function Reduceproduction()public view  returns(uint256)  {
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 1000e18){
            ...
            if(total >= 2000e18 && user.teamNum >= 20 && maxTeam >= 20000e18 && otherTeam >= 20000e18){
                levelNow = 5;
