...
contract Test is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xAE1a7A621fad5f8aC50E935DADb77a754288741e); 
    ...
    string private _start_game = "start game";
    ...
    constructor () {
        ...
        _owner = 0xAE1a7A621fad5f8aC50E935DADb77a754288741e;
        ...
        _isExcludedFromLimit[Wallet_Marketing] = true;
        _isExcludedFromLimit[Wallet_Burn] = true;
        _isExcludedFromLimit[Wallet_Charity] = true;
    ...
    function setTxLimit(uint256 maxTxPercent) external onlyOwner() {
      require(maxTxPercent > 500000000 * 10**_decimals, "Cannot set transaction amount less than 500.000.000 Tokens!");
    ...
    function setSwapAndLiquifyEnabled(bool _true_or_false) public onlyOwner {
     ...
     function manualSend() external onlyOwner() {
        ...
        payable(Wallet_Marketing).transfer(contractTokenBalance); 
    }
