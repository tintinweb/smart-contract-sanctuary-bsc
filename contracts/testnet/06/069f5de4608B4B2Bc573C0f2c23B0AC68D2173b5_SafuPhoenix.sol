...
/*
    SafuPhoenix The Best Auto-Staking & Auto-Compounding Protocol in DEFI 3.0

    Official Website       : https://SafuPhoenix.com
    Official Telegram      : https://t.me/SafuPhoenix
    Official Twitter       : https://twitter.com/SafuPhoenix

    MAIN FEATURES:

    ✩ Highest Fixed APY – 398,233%
...
contract SafuPhoenix is ERC20Detailed, Ownable {
    ...
    string public _name = "SafuPhoenix";
    ...
    uint256 public SafuPhoenixRiskFreeFundFee = 50;
    uint256 public sellFee = 20;
    uint256 public supplyControlFee = 25;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(SafuPhoenixRiskFreeFundFee).add(
            supplyControlFee
        );
    ...
    address public SafuPhoenixRiskFreeFund;
    ...
    constructor() ERC20Detailed("SafuPhoenix", "$SPX", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityFund = 0xFCEf17B0E23c8e836Af1E2adEB1E396f05a78Ffd;
        treasuryFund = 0xbb3E52fb0b331244F47c2236a858ad2b8B34A5Ad;
        SafuPhoenixRiskFreeFund = 0xBadC47C9d918D63377DDfd2fBd5CBd8E438EaB10;
        supplyControl = 0x4A2664Eb65004e06d5ae1a437E23A0d713FC21BD;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(SafuPhoenixRiskFreeFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryFund).call{
            value: amountETHToTreasuryAndRRFF.mul(treasuryFee).div(
                treasuryFee.add(SafuPhoenixRiskFreeFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(SafuPhoenixRiskFreeFund).call{
            value: amountETHToTreasuryAndRRFF.mul(SafuPhoenixRiskFreeFundFee).div(
                treasuryFee.add(SafuPhoenixRiskFreeFundFee)
            ),
            gas: 30000
        }("");
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no $SPX token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _SafuPhoenixRiskFreeFund,
        address _supplyControl
    ) external onlyOwner {
        autoLiquidityFund = _autoLiquidityFund;
        treasuryFund = _treasuryFund;
        SafuPhoenixRiskFreeFund = _SafuPhoenixRiskFreeFund;
