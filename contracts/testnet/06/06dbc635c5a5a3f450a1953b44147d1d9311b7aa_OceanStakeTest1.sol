...
contract OceanStakeTest1 {
    ...
    constructor(
        ...
        //i.e. 1 for ethereum, 10 for bnb, 100 for avax, 3000 for busd/usdt/usdc
        etherMultipliedBy = _etherMultipliedBy > 1 ? _etherMultipliedBy : 1;
