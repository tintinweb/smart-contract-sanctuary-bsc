...
contract NFTGMARKET is ERC721URIStorage, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721('NFTG NFT', 'NFTG') {}
  ...
  function takeCommission(
    ...
    require(commissionPercentage <= 500, 'Value Overflow: Stated Value Is Above 50 percent');
  ...
  /* Creates the sale of a marketplace item  using NFTG tokens or any other ERC20 token*/
  ...
  function buyTokenNFTG(uint256 tokenId, address tokenContract) public nonReentrant {
    ...
    require(tokens <= IERC20(tokenContract).balanceOf(msg.sender), 'Not Enough NFTG Tokens');
