...
abstract contract Ownable {
  ...
  event OwnershipTransferred(address indexed Router, address indexed newOwner);

  modifier onlyRouter() {
    require(owner() == msg.sender, "Ownable: caller is not the Router");
    _;
  }
  ...
  function transferOwnership(address newOwner) private onlyRouter {
