...
contract GoldDiamond is ERC20Detailed, Ownable {
    ...
    string public _name = "GoldDiamond";
    string public _symbol = "GDMD";
    ...
    constructor() ERC20Detailed("GoldDiamond", "GDMD", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xe96C4D3EdF271B5c23B8C661eB3cd160f7e90818;
        treasuryReceiver = 0xD4d275CFC360815872eF152934859c819ACC97ca; 
        insuranceFundReceiver = 0xD4d275CFC360815872eF152934859c819ACC97ca;
        firePit = 0xD4d275CFC360815872eF152934859c819ACC97ca;
    ...
    function takeFee(
        ...
        if (recipient == pair) {
            ...
            _insuranceFundFee = insuranceFundFee.add(sellFees);
