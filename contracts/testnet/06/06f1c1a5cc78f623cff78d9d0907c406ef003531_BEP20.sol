...
contract BABYDOGE is BEP20, Ownable {
	...
	BEP20(name_, symbol_) {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(address(0x2C0C4f071364AfD4B1dBb56F983788549dA68FA1));
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1));
