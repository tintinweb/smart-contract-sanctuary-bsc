...
contract TEST is Context, IERC20, Ownable {
    ...
    string private _name = "TestSol"; // token name
    string private _symbol = "TES"; // token ticker
    ...
    constructor() {
        ...
        wheelWallet = payable(0x7A8B2b4E3E505a42ABA6a22e26f0354eA7f09ee4);
        creatorWallet = payable(0xdA692f6f20777c63D2F68CFB9757D6eEc2572D76);
        marketingWallet = payable(0x45E88580411796Fc2CD80650Bd49A27C47251089);
