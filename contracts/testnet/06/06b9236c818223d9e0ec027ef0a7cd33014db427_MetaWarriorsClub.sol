...
// File: MetaWarriorsClub.sol

pragma solidity ^0.8.10;

contract MetaWarriorsClub is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 10**8 * 10**9; //1 Million Supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string internal constant _name = "Meta warriors Club";
    string internal constant _symbol = "$MWC";
    ...
    address payable public _marketingWallet =
        payable(address(0xfadDD1CFBd4D323e166cB63035571286420F9E49)); // Marketing Wallet 

    bool internal inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;

    uint256 public _maxTxAmount = 1 * 10**7 * 10**9; // 1% Of the supply
    uint256 public numTokensSellToGetBnb = 2 * 10**3 * 10**9; //2000 Tokens
    ...
    constructor() {
        ...
        _isExcluded[address(0xfadDD1CFBd4D323e166cB63035571286420F9E49)] = true;
        _isExcluded[address(0x7b09Bf93Fc98056dCdD90e4b27454B04bAb8CF64)] = true;
