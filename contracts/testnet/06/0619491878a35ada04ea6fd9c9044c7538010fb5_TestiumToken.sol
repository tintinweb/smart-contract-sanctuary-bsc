...
contract TestiumToken is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Testium DAO", "TESTIUM", uint8(DECIMALS)) {
    ...
    function _rebase() private {
        ...
        if (deltaTimeFromInit < ((1 days) / 144)) {
            rewardYield = 10000000;
        } else if (deltaTimeFromInit >= ((1 days) / 144)) {
            rewardYield = 255000;
        }
