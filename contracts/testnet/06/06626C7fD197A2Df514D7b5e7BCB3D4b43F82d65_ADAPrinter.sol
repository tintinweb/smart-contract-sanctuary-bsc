...
contract ADAPrinter {
    ...
    IERC20 public token_ADA;
    address erctoken = 0xE482249ceB9A8995161FC2Cf5f9b2B1312446c9B; /** mainnet ADA **/
    ...
    uint256 public LOTTERY_TICKET_PRICE = 5 ether; /** 5 ADA **/
	...
	uint256 public CUTOFF_STEP = 28 * 60 * 60; /** 28 hours  **/
    uint256 public MIN_INVEST = 10 ether; /** 10 ADA  **/
	uint256 public WITHDRAW_COOLDOWN = 12 * 60 * 60; /** 12 hours  **/
    uint256 public WALLET_DEPOSIT_LIMIT = 5000 ether; /** 5,000 ADA  **/
    ...
    function sellEggs() public{
        ...
        token_ADA.transfer(msg.sender, eggsPayout);
    ...
    function buyEggs(address ref, uint256 amount) public payable{
        ...
        token_ADA.transferFrom(address(msg.sender), address(this), amount);
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                /** referral rewards will be in ADA **/
                uint256 refRewards = amount.mul(REFERRAL).div(PERCENTS_DIVIDER);
                token_ADA.transfer(upline, refRewards);
                /** referral rewards will be in ADA value **/
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_ADA.transfer(project, projectFee);
		token_ADA.transfer(owner, ownerFee);
   ...
   /** will auto execute, when condition is met. buy, hatch and sell, can be triggered manually by admin if theres no user action. **/
    ...
    function getBalance() public view returns (uint256) {
        return token_ADA.balanceOf(address(this));
	}
    ...
    /** How many miners and eggs per day user will recieve based on ADA deposit **/
