...
contract STR is Context, IERC20, Ownable {
    ...
    function _mint(uint256 amount) public onlyOwner virtual {
     ...
     function _burn(uint256 amount) public onlyOwner virtual {
    ...
    function setNumTokensSellToAddToPool(uint256 _minimumTokensBeforeSwap) external onlyOwner() {
