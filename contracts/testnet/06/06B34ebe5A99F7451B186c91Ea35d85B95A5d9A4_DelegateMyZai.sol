...
contract DelegateMyZai is Ownable {
    ...
    event ZaiInDelegation(uint256 indexed zaiId, address indexed owner, uint256 percentageForScholar, uint256 duration);
    ...
    function openMyZaiToDelegation(
        ...
        address _scholar) external onlyZaiOwner(_zaiId) {
            ...
            emit ZaiInDelegation(_zaiId, msg.sender, _percentageForScholar, _contractDuration);
    }
