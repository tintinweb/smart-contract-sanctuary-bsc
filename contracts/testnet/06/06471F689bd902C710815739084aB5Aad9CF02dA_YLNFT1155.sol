...
contract YLNFT1155 is ERC1155, Ownable, ReentrancyGuard {
    ...
    event minted1155(address indexed minter, uint256 tokenId, uint256 amount, uint256 mintedGas);
    event Burned1155(address admin1, address admin2, uint256 tokenId, uint256 burnGas);
    ...
    constructor(string memory _yluri ) ERC1155(_yluri) {
        ...
        proxy = IProxy(0x5Cc10A0C9924F179Cef349dC128ec466d6E9a904);
    }
    ...
    function getCategoryAmount(string memory _sport, string memory _cnft) public view returns (uint) {
    ...
    //mint
    function create1155Token(uint256 _amount, string memory _sport, string memory _cnft) public returns(bool) {
    ...
    //mintBatch
    // function create1155TokenBatch(uint256[] memory _tokenIds, uint256[] memory _amounts, string memory _sport, string memory _cnft) private returns(bool) {
    //     uint256 startGas = gasleft();
    ...
    //transfer
    function ylnft1155Transfer(address _to, uint256 _tokenId, uint256 _amount) public nonReentrant returns(bool) {
    ...
    //transferBatch
    function ylnft1155BatchTransfer(address _to, uint256[] memory _tokenIds, uint256[] memory _amounts) public nonReentrant returns(bool) {
        require(proxy.isTransferAccount(msg.sender), "you can't transfer YL NFT, please contact the Admin");
        require(getPauseContract() == false, "NFT721 Contract was paused!");
        require(_to != address(0), "Can't transfer NFT1155 to address(0)");
