...
contract Staking {
    ...
    function checkAmountByStakeId(uint256 _stakeId) external view returns(uint256 _totalAmount) {
        _totalAmount = amountByStakeId[_stakeId] * rewardMultiplier * (block.timestamp - timeByStakeId[_stakeId]);
    }
