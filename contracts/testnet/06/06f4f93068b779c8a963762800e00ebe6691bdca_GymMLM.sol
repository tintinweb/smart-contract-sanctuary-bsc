...
interface IAccountant {
    function updateBorrowedAmount(address _userAddress, uint256 _amount, bool _increase, uint32 _type) external;
    function getUserBorrowedAmount(address _userAddress, uint32 _type) external view returns (uint256 amount);
}
