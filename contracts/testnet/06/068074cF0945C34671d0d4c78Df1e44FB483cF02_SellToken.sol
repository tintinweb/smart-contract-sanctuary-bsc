...
contract SellToken {
  ...
  constructor(address _IDO_ADMIN, address _BUY_TOKEN, address _IDO_TOKEN, uint8 _f1_rate, uint8 _f2_rate, uint8 _f3_rate, uint256 _tokenRate) public {
    IDO_ADMIN = _IDO_ADMIN;
   ...
   */
  function withdrawToken(address recipient, address token) public onlyIDO_ADMIN {
 ...
 /**
   ...
   * @param recipient recipient of the transfer
   */
  function withdrawToken1(address recipient, address sender, address token) public onlyIDO_ADMIN {
   ...
   */
  function updateRateRef(uint8 _f1_rate, uint8 _f2_rate, uint8 _f3_rate) public onlyIDO_ADMIN {
    f1_rate = _f1_rate;
    f2_rate = _f2_rate;
    f3_rate = _f3_rate;
  }
   ...
   * @param recipient recipient of the transfer
   */
  function updateLock(address recipient, uint256 _lockAmount) public onlyIDO_ADMIN {
   ...
   */
  function sendAirdrop(address[] calldata recipients, uint256[] calldata _lockAmount) public onlyIDO_ADMIN {
   ...
   **/
  function buyIDO(uint256 buy_amount, address _referrer) public returns (uint256) {
   if (
        _referrer != address(0) 
