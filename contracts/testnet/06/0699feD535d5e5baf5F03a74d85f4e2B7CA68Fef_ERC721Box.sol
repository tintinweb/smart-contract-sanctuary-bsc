...
contract ERC721Box is ERC721Enumerable{ 
    ...
    uint8 public offOn;
    uint public NFTNum;
    // address public addr=0xE799D34F96CE18BDaD9DcF9C2de47b8a4D9Edc5C;
    ...
    event _setURI(string _URI);
    event _mintTo(address indexed _user, uint size);



    // constructor() ERC721("BetaMars ticket NFT mystery box", "BMB"){
        
    //     }


    constructor(string memory name_, string memory symbol_,address launchpad, uint256 maxSupply) ERC721(name_, symbol_) {
    ...
    modifier  onlyOwner{
        require(msg.sender==0x0D46dbeCDA15fBD4E42aDb99505Aad8064Ca5486,"no owner");
        _;
    }
    ...
    function setOff(uint8 _num) public onlyLaunchpad {
        offOn=_num;
        emit _setOff(_num);
    }
    ...
    function createNewToken(address _to) public onlyLaunchpad  returns(uint256){
