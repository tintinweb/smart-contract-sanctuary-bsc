...
contract BnbFortune {
    ...
    uint256 public constant WITHDRAW_FEE = 700; // 7% withdraw fee
    ...
    constructor(address payable _platform, uint256 _time) {
        ...
        plans.push(Plan(10, 1254));
        plans.push(Plan(16, 1157));
        plans.push(Plan(21, 1276));
        plans.push(Plan(26, 1298));
        plans.push(Plan(10, 2402));
        plans.push(Plan(16, 2036));
        plans.push(Plan(21, 1828));
        plans.push(Plan(26, 1596));
    }
