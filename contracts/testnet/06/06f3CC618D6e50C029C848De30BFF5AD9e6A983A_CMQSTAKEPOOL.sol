...
contract CMQSTAKEPOOL is ReentrancyGuard, Ownable {
    ...
    address public CMQBusdPriceAddress =
        0xF6059C85086F5cdD956671c00BeDab00f1f5331c; // lp address cmq-busd
    CMQBusdPriceInterface cmqPrice = CMQBusdPriceInterface(CMQBusdPriceAddress);
    ...
    IERC20 public cmq = IERC20(0x0d929eAf73fA9171cD410a2Bf84a3B619407f7B2);
