...
contract NEWWWWW is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x3463d7FBeE2bc304e2FD2353f41Fe211165939C2);
    address payable private _marketingAddress = payable(0x39D46D623E0721cdfe518932Ec5897aC85c2A59a);
    address payable private _autoLiquidityReceiver = payable(0x45CD441ea53f2E1F4Fa4203D84416835175dE9c8);
