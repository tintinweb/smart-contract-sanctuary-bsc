...
contract Seaanimal is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sea Animal";
    string private _symbol = "SAL";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xB53b291b6A04fc92FBD7E1f31A108847FD27333d); // 
    address payable public teamWalletAddress = payable(0xB53b291b6A04fc92FBD7E1f31A108847FD27333d); // 
