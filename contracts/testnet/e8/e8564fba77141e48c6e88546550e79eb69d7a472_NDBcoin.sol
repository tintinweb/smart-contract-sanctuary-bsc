...
contract NDBcoin is IBEP20, Auth {
    ...
    function initialize(address _dexRouter, address _marketing) public {
        require(_dexRouter != address(0), "DEX Router address empty.");
        require(_marketing != address(0), "Marketing address empty.");

        BUSD = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; //testnet
        ...
        swapThreshold = _totalSupply / 400000; // 0.005% testnet
