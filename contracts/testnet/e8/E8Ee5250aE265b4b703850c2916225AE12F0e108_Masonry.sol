...
contract Masonry is ShareWrapper, ContractGuard {
    ...
    function getEverestPrice() external view returns (uint256) {
        return treasury.getEverestPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            everest.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        everest.safeTransferFrom(msg.sender, address(this), amount);
    ...
    function governanceRecoverUnsupported(
        ...
        require(address(_token) != address(everest), "EVEREST");
