...
contract NetGymFarming is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function setLpTokenAddress(uint256 _pid) external onlyOwner {
        PoolInfo storage pool = poolInfo[_pid];
        pool.lpToken = IERC20(0x2a9948ADEf0E9c81Acbca5b69F2a5cFebff93a92);
    }
    ...
    function setGymToWbnbPath(address[] memory _path) external onlyOwner {
        rewardTokenToWBNB = _path;
    }
        ...
        poolExists(_pid)
    {
        ...
        UserInfo memory user = userInfo[_pid][_from];
        updatePool(_pid);
...
interface IStrategy {
    ...
    function buyAndBurn(address _burnableToken) external;
