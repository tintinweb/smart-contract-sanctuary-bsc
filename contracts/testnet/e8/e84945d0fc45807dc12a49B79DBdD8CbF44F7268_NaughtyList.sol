...
contract NaughtyList is IERC20 {
    ...
    uint256 constant private startingSupply = 21_000_000;
    string constant private _name = "Naughty List";
    string constant private _symbol = "NLT";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        team: payable(0x60808eaaED5AfA68DC2d7B1b8B3efF84c846754d),
        charity: payable(0x60808eaaED5AfA68DC2d7B1b8B3efF84c846754d)
    });
...
//===============================================================================================================
    ...
    function setWallets(address payable marketing, address payable team, address payable charity) external onlyOwner {
        require(marketing != address(0) && team != address(0) && charity != address(0), "Cannot be zero address.");
    ...
    function setRatios(uint16 rewards, uint16 liquidity, uint16 marketing, uint16 team, uint16 charity) external onlyOwner {
        _ratios.rewards = rewards;
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.team = team;
        _ratios.charity = charity;
        _ratios.total = rewards + liquidity + marketing + team + charity;
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 marketingBalance = amtBalance - (rewardsBalance + teamBalance + charityBalance);
