...
contract Auction is Ownable{
    ...
    function bid(uint _auctionID) payable public {
        ...
        if(auctionInfo[_auctionID].endTime < _endTime){
            ...
            emit Bid(msg.sender, _auctionID, auctionInfo[_auctionID].endTime , auctionInfo[_auctionID].lastBidder, auctionInfo[_auctionID].remainingBid, auctionInfo[_auctionID].bidCount);
    } 
