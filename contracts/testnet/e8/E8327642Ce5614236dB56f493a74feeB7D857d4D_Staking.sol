...
contract Staking is IStaking, Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    mapping(address => StakingData) public stakingDatas;
    ...
    function initialize(address _acceptedTokenAddress, uint128 _lockDuration) public initializer {
    ...
    function getUserTotalStaked(address _address) external view override returns (uint128) {
