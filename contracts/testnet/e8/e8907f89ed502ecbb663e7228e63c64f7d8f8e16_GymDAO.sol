    ...
    GovernorTimelockControlUpgradeable
{
    ...
    function initialize(TimelockControllerUpgradeable _timelock, address _singlePoolAddress) public initializer {
        singlePoolAddress = _singlePoolAddress;
        __Governor_init("GymDAO");
        __GovernorSettings_init(6575, 46027, 0);
    ...
    function quorum(uint256 blockNumber) public view virtual override returns (uint256) {
        uint256 totalGGymnetInPoolLocked = IGymSinglePool(singlePoolAddress).totalGGymnetInPoolLocked();
        return (8 * totalGGymnetInPoolLocked) / 10;
    }
    ...
    function _getVotes(
        ...
        uint256 voterGGymnet = IGymSinglePool(singlePoolAddress).getUserInfo(account).totalGGYMNET;
        uint256 totalGGymnetInPoolLocked = IGymSinglePool(singlePoolAddress).totalGGymnetInPoolLocked();
        return (voterGGymnet * 1e18) / totalGGymnetInPoolLocked; // weight in 1e18
    }
}
