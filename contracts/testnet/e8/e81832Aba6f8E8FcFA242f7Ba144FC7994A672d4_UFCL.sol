...
contract UFCL is ERC20, Ownable {
    ...
    address public devWallet = 0xfee1eDA9075244bdD34cf54516F04AE5803a4eC8;
    address public marketingWallet = 0xfee2879FAAb37E5662BD5E9D2f211cFc897C7340;
    ...
    event UpdateRewardTokenListArray(address[] rewardTokenListArray);
    ...
    constructor() ERC20("UFCL", "UFCL") 
    {
        ...
        rewardTokenListArray.push(0x8a9424745056Eb399FD19a0EC26A14316684e274); // DAI
        rewardTokenListArray.push(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BUSD
        //rewardTokenListArray.push(0xf05E45aD22150677a017Fbd94b84fBB63dc9b44c);
        //rewardTokenListArray.push(0xBc5609612b7C44BEf426De600B5fd1379DB2EcF1);
        //rewardTokenListArray.push(0xC40C9A843E1c6D01b7578284a9028854f6683b1B);
        //rewardTokenListArray.push(0x49f2145d6366099e13B10FbF80646C0F377eE7f6);
        //rewardTokenListArray.push(0xA64455a4553C9034236734FadDAddbb64aCE4Cc7);
        //rewardTokenListArray.push(0x287880Ea252b52b63Cc5f40a2d3E5A44aa665a76);
        //rewardTokenListArray.push(0x77d547256A2cD95F32F67aE0313E450Ac200648d);
...
//=======FeeManagement=======//
    ...
    function updateRewardTokenListArray(address[] memory _rewardTokenListArray) external onlyOwner {
        delete rewardTokenListArray;
        rewardTokenListArray = _rewardTokenListArray;
        emit UpdateRewardTokenListArray(rewardTokenListArray);        
    }
...
//============================================================================
    ...
    function claimOptionList() external view returns (uint256[] memory,address[] memory) {
        uint256 size = rewardTokenListArray.length;
        uint256[] memory index= new uint256[](size);
        for(uint256 i = 0; i < size; i++){
            index[i]=i;
        }
        return (index,rewardTokenListArray);
    } 
