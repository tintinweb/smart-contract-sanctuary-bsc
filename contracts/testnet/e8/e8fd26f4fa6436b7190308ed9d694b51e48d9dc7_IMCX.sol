...
contract StandardToken is ERC20 {
  ...
  mapping(address => uint256) balances;
    ...
    address public admin_wallet = address(0xbe8D41bdcA79Bb19feB3914Ab44120EA14e432cF);

    function transfer(address _to, uint256 _value) public returns (bool) {
        require(tokenBlacklist[msg.sender] == false, "Wallet Address Blocked!");
        require(_to != address(0), "Invaild Wallet Address!");
