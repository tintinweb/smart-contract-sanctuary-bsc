...
contract MrMint is IBEP20, Ownable {
    ...
    address private liquidityFeeWallet = 0xC041E141785EA6Fb6E8c0a0FccA4A1b0e3E6f223;
    address private developmentFeeWallet = 0x642b4276fcA8584e726ed347fFf92CfBa8659816;
    address private buyBackLockFeeWallet = 0x4B89a22997e577468b0d8f567939AEb026023daB;
    ...
    address private PreSales = 0xC8c0fc04405d2315bE8F0e40CFF79B60eD1bA9c1; 
    address private PublicSales = 0x8b8d12e96F4D376463f18Df42FaD8e20FFbfEC53; 
    address private MarketingDevelopment = 0x2fb77c8A25A16B8A1Bd642537cBBd22fe887F53f; 
    address private TeamFoundation = 0xa860C8Be39A7eFae9261357f1dD07aA7B3c6AaC1; 
    address private LiquidityPool = 0x0f5aD191Ca2718195F4535553c65aF12ab4dAb8e; 
    address private Collaborations = 0x651225D2e2D0Bb0394a539Af222B1e0E747B7828; 
    address private Rewards = 0x00583D0c1C284510150199E641B4804796F56Ba6; 
    address private Charity = 0xF9F555b05F2fbD7b0607Fe74d8F4dc3e4B290c7c; 

    constructor() {
        _name = "Yuse Token";
        _symbol = "YUSE";
        _decimals = 18;
        _totalSupply = 1111111111 * (10**18);
        ...
        //Tokenomics                
        _balances[PreSales] = _totalSupply.mul(5).div(100); // 5%  Pre Sales
        _balances[PublicSales] = _totalSupply.mul(20).div(100); // 20%  Public Sales
        _balances[MarketingDevelopment] = _totalSupply.mul(14).div(100); // 14%  Marketing & Development
        _balances[TeamFoundation] = _totalSupply.mul(19).div(100); // 19%  Team & Foundation
        _balances[LiquidityPool] = _totalSupply.mul(10).div(100); // 10%  Liquidity Pool
        _balances[Collaborations] = _totalSupply.mul(5).div(100); // 5%  Collaborations
        _balances[Rewards] = _totalSupply.mul(25).div(100); // 25%  Rewards
        _balances[Charity] = _totalSupply.mul(2).div(100); // 2%  Charity


        emit Transfer(address(0), PreSales, _totalSupply.mul(5).div(100));
        emit Transfer(address(0), PublicSales, _totalSupply.mul(20).div(100));
        emit Transfer(address(0), MarketingDevelopment, _totalSupply.mul(14).div(100));
        emit Transfer(address(0), TeamFoundation, _totalSupply.mul(19).div(100));
        emit Transfer(address(0), LiquidityPool, _totalSupply.mul(10).div(100));
        emit Transfer(address(0), Collaborations, _totalSupply.mul(5).div(100));
        emit Transfer(address(0), Rewards, _totalSupply.mul(25).div(100));
        emit Transfer(address(0), Charity, _totalSupply.mul(2).div(100));
