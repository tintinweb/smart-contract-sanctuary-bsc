...
contract CyberWorld is ERC20Detailed, Ownable {
    ...
    string public _name = "CyberWorld";
    string public _symbol = "CYW";
    ...
    constructor() ERC20Detailed("CyberWorld", "CYW", uint8(DECIMALS)) Ownable() {
...
//Variables have been defined now we move on the rest of the configuration	
        ...
        autoLiquidityReceiver = 0x33aC66834B5fdfF53aFa1Cdd2693E15323248c9D;
        treasuryReceiver = 0x1cFB5F7AA8c8D3e4518FAec41DB198DD8C1B5E9A; 
        clockInsuranceFundReceiver = 0x05810c3A86318d3729134C7DA46B9B4CacACBFa4;
        firePit = 0xdea5cb823A74cDe98e07b289E89984eD1578B574;
