...
contract Matchup is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    event TreasuryTriggered(uint256 amount);
    
    event OwnerForcedSwapBack(uint256 timestamp);

    constructor() ERC20("Matchup", "Matchup") {

        address _owner = address(0xA64D25eDBA08436cd01Bc0A742d1D3347A0c33E9);
        ...
        marketingWallet = address(0x5D0099a30F50e7e5613a4B1042caA1DBEad60123); // set as marketing wallet
    	treasuryWallet = address(0x890F0AEF8906356a629945DEE1fF57A4883C0faE); // set as treasuryWallet
