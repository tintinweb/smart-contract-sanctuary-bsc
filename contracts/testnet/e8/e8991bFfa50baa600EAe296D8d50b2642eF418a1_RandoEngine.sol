...
contract RandoEngine is Ownable {
    ...
    function requestDice(uint8 _type, uint8 _numberofdie, uint8 _diesides ) public returns ( uint256) {
    ...
    modifier onlyEngine() {
        require ( ecosystem.isRandoContract(msg.sender), "Not an Engine Contract");
         _;
    }
