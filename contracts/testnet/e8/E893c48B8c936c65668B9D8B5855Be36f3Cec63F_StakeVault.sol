...
contract StakePosition is ERC721Enumerable, Ownable {
    using Strings for uint256;
...
import "./interfaces/IStakePosition.sol";
import "./StakePosition.sol";
...
contract StakeVault is ReentrancyGuard, Ownable {
    ...
    mapping(address => uint256[]) public allStakePositionIds;

    modifier onlyPositionContract() {
        require(
    ...
    function deployStake(
        ...
        StakePosition newStake = new StakePosition(
            _name,
            _symbol,
            _stakeToken,
            address(this),
    ...
    function _addDefaultLocks(StakePosition _stakePosition) internal {
    ...
    function registerAsset(
        ...
        allStakePositionIds[_stakeToken].push(stakeAssets.length - 1);
    }
    ...
    function updateAsset(
        ...
        stakeAssets[_stakeId].capacity = _capacity;
        stakeAssets[_stakeId].endTime = _endTime;
        stakeAssets[_stakeId].active = _active;
