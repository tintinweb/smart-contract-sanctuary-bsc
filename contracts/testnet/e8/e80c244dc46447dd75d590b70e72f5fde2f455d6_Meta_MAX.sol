...
// File: service/MetaMaxGeneratorInfo.sol
...
// File: service/MetaMaxHelper.sol


pragma solidity ^0.8.0;

abstract contract MetaMaxHelper {
...
contract Meta_MAX is IERC20, ERC20Ownable, MetaMaxHelper, MetaMaxGeneratorInfo {
    ...
    ) payable MetaMaxHelper("Meta_MAX", __metaMax_target) {
        _name = __metaMax_name;
        _symbol = __metaMax_symbol;
        _decimals = __metaMax_decimals;
        _tTotal = __metaMax_initial;
