...
contract FeeReceiver is Ownable {
    ...
    function trigger() external {
        ...
        _send(adr1, (address(this).balance * fee1) / 90);
        _send(adr2, (address(this).balance * fee1) / 90);
        _send(adr3, (address(this).balance * fee2) / 90);
        _send(adr4, (address(this).balance * fee3) / 90);
    }
