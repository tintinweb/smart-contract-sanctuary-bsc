...
interface ITokenCustody {
    function setLockTokenStakesForDAOVotes(uint256 votingDeadline) external;
...
contract TokenCustody is ReentrancyGuard, Ownable {
        ...
        nonReentrant
    {
        require(
            ...
            "Lock Tokens For DAO votes: You cannot vote on overdue proposals."
        );
        require(
            votingDeadline - block.timestamp < 15 days,
