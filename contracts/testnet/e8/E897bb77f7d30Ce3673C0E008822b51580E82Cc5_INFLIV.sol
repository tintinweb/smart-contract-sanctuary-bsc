...
contract INFLIV is Initializable, ERC20Upgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, UUPSUpgradeable {
	...
	function setCharitAddress(address newAddress) public onlyOwner {
	    require(newAddress != address(0), "INFLIV: Zero address");
	...
	function setPartnersInvestorsAddress(address newAddress) public onlyOwner {
	    require(newAddress != address(0), "INFLIV: Zero address");
	...
	function withdrawalTokenFromBountyBonusesPool(address to, uint256 amount) public onlyOwner{
