    ...
    Pausable
{
    ...
    constructor(address _tokenA, address _tokenB, uint256 _intervalSeconds) {
        tokenA = _tokenA;
        tokenB = _tokenB;
    ...
    function setToken(address _tokenA, address _tokenB) external whenPaused onlyAdmin {
        tokenA = _tokenA;
        tokenB = _tokenB;
        emit NewToken(tokenA, tokenB);
    }

    function setCurrentPrice(int256 _price) external whenNotPaused onlyAdmin {
        price = _price;
        emit NewPrice(price);
    }
