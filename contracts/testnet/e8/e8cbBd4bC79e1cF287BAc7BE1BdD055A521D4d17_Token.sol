...
contract Token is Context, IERC20, Ownable {
    ...
    constructor(address gnosisSafeAddress_) {
        require(gnosisSafeAddress_ != address(0x0), "Token: gnosisSafeAddress is not valid!");

        // Gnosis Safe Proxy Address
        ...
        // Transfer token contract's owner to Gnosis Safe Proxy
