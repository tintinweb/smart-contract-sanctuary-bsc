...
contract H4GToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    H4GTokenDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Hodl4Gold", "H4G") {
        dividendTracker = new H4GTokenDividendTracker();

        teamWallet = 0x9A24337BbF6A553182692b5B9d20BC6818b1d853;
        lotteryWallet = 0x9cEc888042De4BF5941608B30A3dA50A39FCF9a5;
...
contract H4GTokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
