...
/* Token contract */
contract testxxx is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address DEV = 0x3503Aa6378258ad5e6f99f2A9273b6D4E871088f;
    ...
    string constant _symbol = "testxxx";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 3%
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 3%
    uint256 public _maxWalletToken = ( _totalSupply * 500 ) / 10000; // 3%
  ...
  // Sell fees
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x30D9F252C51bF24b735136dA38cE5d94ECF2bE26;
