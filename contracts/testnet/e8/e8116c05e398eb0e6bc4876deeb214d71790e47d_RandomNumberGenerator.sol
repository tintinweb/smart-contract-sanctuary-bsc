...
// File: contracts/interfaces/ISMBSwapLottery.sol
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the SMBSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == SMBSwapLottery, "Only SMBSwapLottery");
    ...
    /**
     * @notice Set the address for the SMBSwapLottery
     * @param _SMBSwapLottery: address of the SMBSwap lottery
     */
    function setLotteryAddress(address _SMBSwapLottery) external onlyOwner {
        SMBSwapLottery = _SMBSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ISMBSwapLottery(SMBSwapLottery).viewCurrentLotteryId();
    }
}