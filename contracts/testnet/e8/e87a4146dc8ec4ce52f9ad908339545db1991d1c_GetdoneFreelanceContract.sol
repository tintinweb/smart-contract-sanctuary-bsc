...
contract GetdoneFreelanceContract is OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable{
    ...
    function depositContract(uint256 contractId, uint256 orderId, uint256 price, address erc20) 
        public
        payable
        whenNotPaused
        nonReentrant
        ...
        allowDeposit(contractId, _msgSender())
    {
        ...
        if (contractInfo.init == false) {
            contractInfos[customer][contractId] = ContractInfo(contractId, customer, address(0), erc20, 0, price, 0, 0, false, false, true);
        } else {
