...
contract FROG is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0xEd916D6B93d59D051f2d821e1109C3A341b66233);
  
    bool inSwapAndLiquify;
    bool private swapAndLiquifyEnabled = true;

    uint256 public numTokensSellToFee = 150000 * 10**18;
    ...
    constructor () BEP20Detailed("Frogcoin", "FROG", 18) {
      _owner = msg.sender ;
    ...
    {
        require(_numTokensSellToFee >= 10000 * 10**18 && _numTokensSellToFee <= 2000000 * 10**18, "Threshold must be set within 10,000 to 2,000,000 tokens");
