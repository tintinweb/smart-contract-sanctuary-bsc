...
/*
      ...
      | $$  | $$| $$    $$| $$      | $$  | $$| $$\  $$$ /$$  \ $$      | $$\  $ | $$  | $$  | $$\  $$$| $$      | $$  \ $$      
      |  $$$$$$/|  $$$$$$/| $$$$$$$$| $$  | $$| $$ \  $$|  $$$$$$/      | $$ \/  | $$ /$$$$$$| $$ \  $$| $$$$$$$$| $$  | $$      
       \______/  \______/ |________/|__/  |__/|__/  \__/ \______/       |__/     |__/|______/|__/  \__/|________/|__/  |__/      
...
contract MoceansDividendTracker is Ownable, DividendPayingToken {
    ...
    address public _rewardTokenAddress = 0x3034405C89b321BCbf81A738ea2F55E0FA34f88A;
...
contract MOCEANS is ERC20, Ownable {
    ...
    address public rewardToken = 0x3034405C89b321BCbf81A738ea2F55E0FA34f88A;
    ...
    address public _marketingWalletAddress = 0xe92d0a76B04D3d89fC199060a229D50e78355238;
    address public _gasFeeCollector = 0xe92d0a76B04D3d89fC199060a229D50e78355238;
    ...
    function setSelTaxes(uint256 liquidity, uint256 rewardsFee, uint256 marketingFee, uint256 gasFee) external onlyOwner {
        require(rewardsFee.add(liquidity).add(marketingFee).add(gasFee) <= 25, "Total sel fee is over 25%");
    ...
    function swapAndSendToFee(uint256 tokens) private  {
        uint256 initialREFBalance = IERC20(rewardToken).balanceOf(address(this));
        swapTokensForReflection(tokens);
        uint256 newBalance = (IERC20(rewardToken).balanceOf(address(this))).sub(initialREFBalance);
