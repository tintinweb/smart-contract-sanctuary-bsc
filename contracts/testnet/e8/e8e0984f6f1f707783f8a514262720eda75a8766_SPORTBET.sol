...
contract SPORTBET {
    ...
    function endGame(uint256 _gameId, uint256 _winner) external onlyAdmin {
        ...
        if(_winner == 0){
            ...
            lost = GamesData[_gameId].bteam2 + GamesData[_gameId].bdrawgame;
        ...
        if(_winner == 1){
            ...
            lost = GamesData[_gameId].bteam1 + GamesData[_gameId].bdrawgame;
        ...
        if(_winner == 2){
            ...
            lost = GamesData[_gameId].bteam2 + GamesData[_gameId].bteam1;
        ...
        for(uint256 i = 0; i < GamesData[_gameId].uniqueaddress.length; i++){
            ...
            if(_winner == 0){
                if(GamesData[_gameId].participants[user.player_address].team1 > 0){
                    touser = prize * (GamesData[_gameId].participants[user.player_address].team1 / prizeDivider);
                    ...
                    user.gains += touser;
                    touser += (GamesData[_gameId].participants[user.player_address].team1 * refferal_bet_percent) / divider;
                    user.toclaim += touser + GamesData[_gameId].participants[user.player_address].team1;
                }
                user.losts += GamesData[_gameId].participants[user.player_address].team2;
                user.losts += GamesData[_gameId].participants[user.player_address].drawgame;
            }
            if(_winner == 1){
                if(GamesData[_gameId].participants[user.player_address].team2 > 0){
                    touser = prize * (GamesData[_gameId].participants[user.player_address].team2 / prizeDivider);
                    if(reffral[msg.sender] != address(0)){
                        toref = (touser * refferal_prize_percent) / divider;
                        players[reffral[msg.sender]].toclaim += toref;
                        refferal_part[reffral[msg.sender]].fromPrize += toref;
                    ...
                    user.gains += touser;
                    touser = touser + (GamesData[_gameId].participants[user.player_address].team2 * refferal_bet_percent) / divider;
                    user.toclaim += touser + GamesData[_gameId].participants[user.player_address].team2;
                }
                user.losts += GamesData[_gameId].participants[user.player_address].team1;
                user.losts += GamesData[_gameId].participants[user.player_address].drawgame;
            }
            if(_winner == 2){
                if(GamesData[_gameId].participants[user.player_address].drawgame > 0){
                    touser = prize * (GamesData[_gameId].participants[user.player_address].drawgame / prizeDivider);
                    if(reffral[msg.sender] != address(0)){
                        toref = (touser * refferal_prize_percent) / divider;
                        players[reffral[msg.sender]].toclaim += toref;
                        refferal_part[reffral[msg.sender]].fromPrize += toref;
                    ...
                    user.gains += touser;
                    touser = touser + (GamesData[_gameId].participants[user.player_address].drawgame * refferal_bet_percent) / divider;
                    user.toclaim += touser + GamesData[_gameId].participants[user.player_address].drawgame;
                }
                user.losts += GamesData[_gameId].participants[user.player_address].team2;
                user.losts += GamesData[_gameId].participants[user.player_address].team1;
            }
