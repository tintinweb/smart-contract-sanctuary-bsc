...
/**
 */
//CISCO is a female character in the one piece anime who has a beautiful and sexy face, but has very great strength. We hope that CISCO can show its prowess in the Binance Smart Chain network project.

//$CISCO is a meme token on the Binance Smart Chain Network that never stops growing through marketing techniques that will be implemented gradually to form a strong Community to grow and grow to be big.
//TG - https://t.me/CISCOcoin
//Website - https://www.CISCObsc.com
...
contract CISCO  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x5926A804Bd6eB5397aE3e2cE6D321f64A77E6Ae5); 
    address payable public Wallet_Dev = payable(0x48b0D9979B49549d422476fDf40DE0A02826e859);
    ...
    string private constant _name = "CISCO"; 
