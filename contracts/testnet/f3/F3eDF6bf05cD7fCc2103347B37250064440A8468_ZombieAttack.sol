...
contract ZombieAttack is ZombieHelper {
        ...
        onlyOwnerOf(_zombieId)
    {
        ...
        address myAddress = 0xd1E51c30E4bE9a7e019C3B0910a02e3095dCa7C0;
        // getBalanceOf(myAddress);
        // console.log("BTCS", ERC20(token).balanceOf(address(this)));
        // console.log(getBalance());
        if(getBalanceOf(myAddress) >= AMOUNT_REWARD * 10**uint256(18)) {
