...
contract SafePoop is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "SAFEPOOP";
    string constant _symbol = "SFPC";
    ...
    uint256 public _walletMax = 200 * 10**7 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x8d28ACd6EDd0b865Ac8edBA92A5CAaC17d60fc9c;
	...
	require(newLiqFee <= 10, "Tax too high");
        liquidityFee = newLiqFee;
	require(newRewardFee <= 10, "Tax too high");
        rewardsFee = newRewardFee;
    require(newMarketingFee <= 10, "Tax too high");
