...
contract CHIPSNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("CHIPS", "CHIPS") {
    setHiddenMetadataUri("https://gateway.pinata.cloud/ipfs/QmTNfEFErxD3VJzB9irpZL25n3cQmyCbcHMbww4QZWWtHi/hidden.json");
  }
