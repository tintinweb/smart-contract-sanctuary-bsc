    ...
    Auth
{
    ...
    uint256 public TOTAL_SUPPLY = 10000; // The total supply left to mint (Can be burned)
    ...
    uint256[] ITEM_AMOUNTS = [20, 20, 20, 20, 20, 25, 25, 25, 25, 5, 5, 2, 1]; // The amount of Founders items avaliable to acquire
    ...
    //TODO: change back to uint8
    function mintLootBox(uint256 numLootBoxes) public payable {
    ...
    function burn(uint256 numLootBoxesToBurn) external onlyOwner {
        ...
        //TODO: change 25 to 2500
        require(NewMaxLootBoxes >= 25, "Cannot burn anymore"); //Must be greater than the highest number in ITEM_AMOUNTS
        require(
