...
contract LuckToken1 is Token {
	...
	function swapTokens() internal lockTheSwap{
		...
		//uint256 amountBNBToLuckyShares = amountofBNBtoCalculate.mul(feeTokens.TokensToLuckySharesInPercentage);
		//uint256 amountBNBToNewcomerShares = amountofBNBtoCalculate.mul(feeTokens.TokensToNewcomerSharesInPercentage);
		
		//uint256 amountBNBToWinnersReward = amountofBNBtoCalculate.mul(feeTokens.TokensToWinnersRewardInPercentage);
		//uint256 amountBNBToJackpotReward = amountofBNBtoCalculate.mul(feeTokens.TokensToJackpotRewardInPercentage);
