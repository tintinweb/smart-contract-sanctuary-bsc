...
contract BSG is Ownable{
    ...
    uint256 private timeStep = 1 minutes;
    uint256 public dayPerCycle = 5 minutes;

    uint256 private dayReward2Percents = 540000000000000000000;
    uint256 private dayRewardPercents = 440000000000000000000;
    ...
    constructor()
    {
        BUSD = IERC20(0x6dBdB14Fb1999cE4f213EbFeD0FeD61f0c59B72c);
        feeReceivers = [0xC353bC8E1C4d3C6F4870D83262946E8C32e126b3,0xC353bC8E1C4d3C6F4870D83262946E8C32e126b3];
    ...
    function _calLevelNow(address _user) public view returns(uint256) {
        ...
        if(total >= 200e18){
            ...
            if(total >= 250e18 && user.teamNum >= 4 && maxTeam >= 300e18 && otherTeam >= 300e18){
                levelNow = 5;
            }else if(user.teamNum >= 3 && maxTeam >= 200e18 && otherTeam >= 200e18){
                levelNow = 4;
            }else{
                levelNow = 3;
            }
