...
contract LoliCoin is ERC20, Ownable {
    ...
    address public constant BUSD = address(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.getOwner() == address(this), "The new dividend tracker must be owned by the LoliCoin token contract");
