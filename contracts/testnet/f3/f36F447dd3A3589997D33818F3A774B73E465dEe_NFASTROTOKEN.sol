...
contract NFASTROTOKEN is ERC20, Ownable, ERC20Burnable {
    // ADDRESSESS -------------------------------------------------------------------------------------------
    ...
    // CONSTRUCTOR ------------------------------------------------------------------------------------------
    constructor() ERC20("NFASTROTOKEN", "NFAT") {
        ...
        // 5% on SELL
        // 0% on Transfer
        _feesRates = Fees({buyFee: 200, sellFee: 500, transferFee: 0});
        ...
        maxTransactionAmount = calculatePercent(totalSupply(), 500); // 5% of total supply
        maxWalletAmount = calculatePercent(totalSupply(), 500); // 5% of total supply
    }
