...
contract Ownable is Context {
    ...
    address payable private _charity = payable(0xD3dBca546Df6Ce5394De8AA1e0A6339D9c4A6955);
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "4TR";
    string private _symbol = "4TR";
    ...
    uint256 private _charityPercentageOfLiquidity = 70;
    ...
    function totalMarketingCollected() public view onlyCharity returns (uint256)
    {
    ...
    function collect() public onlyCharity
    {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 balanceToCharity = (newBalance.mul(marketingPercentageOfLiquidity())).div(10**2);
