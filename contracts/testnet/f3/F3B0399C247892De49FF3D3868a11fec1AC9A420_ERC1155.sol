...
contract SpaceNFT is ERC1155, Ownable, ERC1155Supply, ISpaceNFT {

    address private _market;

    constructor() 
        ERC1155("https://arweave.net/ssRBBgkPcueFYF4x1SAA50LTMfBD9tsa8bfZSwpw__c/") {}
    ...
    function mint(address account, uint256 id, uint256 amount, bytes memory data)
        public virtual override
    {
        require(market() == _msgSender(), "ERC1155: Mint: dcaller is not the market contract");
    ...
    function mintBatch(address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data)
        public
    {
        require(market() == _msgSender(), "ERC1155: MintBatch: dcaller is not the market contract");
