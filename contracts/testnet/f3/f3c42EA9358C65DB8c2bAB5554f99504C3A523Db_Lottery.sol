...
contract Lottery is Ownable{
  ...
  struct  _player{
    ...
    constructor(IBEP20 _Token) {
            ...
            //   min_entries = entry;
            // }
            function set_time(uint256 _level,uint256 _time) public onlyOwner{
              
              fin[_level].time = _time;
            }
    ...
    function randomNumberSelector(uint256 _level)
        ...
        {
          return uint256(keccak256(abi.encodePacked(block.timestamp,block.difficulty,fin[_level].players)));
        }
