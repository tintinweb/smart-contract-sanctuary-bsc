...
contract TEST_AGL is ERC20, Auth {
    using SafeMath for uint256;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    // address pair_address = 0x0000000000000000000000000000000000000000;



    string constant _name = "TEST_AGL";
    string constant _symbol = "TEST_AGL";
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // if (!authorizations[sender] && recipient != pair_address){
    ...
    // function setPairAddress(address holder) external authorized {
    //     pair_address = holder;
    // }
