...
contract DividendDistributor is IDividendDistributor {
    ...
    address WBNB = 0x6981A8dbeB3C435F44aF0DFcc206E89730432cDF;
    IDEXRouter router;
...
contract StarTestToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "StarTestToken";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x48C3034B981E49fC176A825a676aC7d3E16C2ceC;
        teamFeeReceiver = 0x48C3034B981E49fC176A825a676aC7d3E16C2ceC;
        charityFeeReceiver = 0x48C3034B981E49fC176A825a676aC7d3E16C2ceC;
