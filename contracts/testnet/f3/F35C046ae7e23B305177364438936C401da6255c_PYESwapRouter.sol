...
library PYESwapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint160(uint(keccak256(abi.encodePacked(
                ...
                hex'ab961676494e961ecba9fbe27506f1ac94f0422d35a7a2cbf1b3077f2945ef59' // init code hash
            )))));
    }
...
contract PYESwapRouter is SupportingSwap {
    ...
    constructor(address _factory, address _WETH, address _BUSD, uint8 _adminFee, address _adminFeeAddress) {
