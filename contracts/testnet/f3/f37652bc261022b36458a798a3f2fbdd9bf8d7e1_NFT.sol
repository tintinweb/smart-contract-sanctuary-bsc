...
contract NFT is Ownable, Pausable, RoyaltiesAddon, ERC2981 {
    ...
    uint256 public constant TOTAL = 100; // Set total nfts

    IERC20 public tokenAddress = IERC20(0x479Dc9f5d96D49BD9BD7A4bFdDeAE338D3e4a7b0);
    ...
    uint256 public startTime = 1670058300; // Set start

    event onMinted(uint256 tokenId);


    constructor(uint256 _startTime) ERC721("NFT Collection", "NFT") {
