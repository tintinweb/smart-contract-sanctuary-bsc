...
contract WINCToken is IERC20, Ownable {
    ...
    address public marketAddress = 0x79596fef4dAcab08b353233CA1Fd617b5Fa31b53;
   

    uint256 private _tFeeTotal;

    string private _name = "WINC";
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function process(uint256 gas) private {
        ...
        uint256 contractLp = IERC20(uniswapV2Pair).balanceOf(address(this));
    ...
    function _takeburnFee(
        ...
        if(_tFeeTotal >= 499950000000 * 10**9)_burnFee = 0;
    ...
    function _transferStandard(
        ...
        _takeLPFee(sender, tAmount.div(10000).mul(_LPFee.add(_addLPFee)));
