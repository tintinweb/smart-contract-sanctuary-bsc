...
contract SoulmetaPropSeller is DivestorUpgradeable, RandomGeneratorUpgradeable, ERC1155HolderUpgradeable {
    ...
    function setContracts(address soulController_, address soulToken_, address prop1155_, address soulPair_, address receiver_, address timeBank_, address soulTeam_) public onlyOwner {
...
//        revert();
        ...
        if (receiver != address(0)) {
            (receiver,,) = soulTeam.teams(_msgSender());
            if(receiver != address(0)){
    ...
    function propBatchBox(uint8 theme_, uint8 group_, uint propId_, address recommender_) public returns (bool){
        ...
        return externalAddr.soulController.drawBox(_msgSender(), theme_, group_, propEffect[propId_].times, recommender_);
    }
