...
/*
	Website: https://besteverapy.com
	Twitter: https://twitter.com/besteverapy
	Instagram: https://www.instagram.com/besteverapy/
    Telegram: https://t.me/BestEverAPY
	
	Rebase Contract Version 1.6
	Initial Supply 1,000,000,000
    Rebase Fees:
    liquidityFee 3%
    treasuryFee  4%
    BESTAPYInsuranceFundFee 4%
    sellFeel 0.5 %
    sellFeet 0.5 %
    sellFees 0.5 %
    sellFeef 0.5 %
...
contract BESTAPY is ERC20Detailed, Ownable {
    ...
    string public _name = "Best Ever APY";
    string public _symbol = "BESTAPY";
    ...
    uint256 public BESTAPYInsuranceFundFee = 40;
    ...
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(BESTAPYInsuranceFundFee).add(
            firePitFee
        );
    ...
    address public BESTAPYInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("Best Ever APY", "BESTAPY", uint8(DECIMALS)) Ownable() {
...
//Variables have been defined now we move on the rest of the configuration	
        ...
        autoLiquidityReceiver = 0x5a8fCBc8B767C2d7A2812b0DE0B31E832602FB83; //Liquidity Reciever will get LP tokens
        treasuryReceiver = 0xcbFA1ce0b8bFb9C09E713162771C31F176fB1ADE; //Treasury Receiver
        BESTAPYInsuranceFundReceiver = 0xF7e8DC7120B1502405F121c2cc512d72D286ff71; //Insurance Receiver
        firePit = 0x3AA712eD5940E1A55e8DeFa8562c05edD16399E4; //Fire Pit
    ...
    function takeFee(
        ...
        uint256 _BESTAPYInsuranceFundFee = BESTAPYInsuranceFundFee;
        ...
        if (recipient == pair) {
            ...
            _BESTAPYInsuranceFundFee = BESTAPYInsuranceFundFee.add(sellFees);
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_treasuryFee.add(BESTAPYInsuranceFundFee))
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(BESTAPYInsuranceFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(BESTAPYInsuranceFundReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(BESTAPYInsuranceFundFee).div(
                treasuryFee.add(BESTAPYInsuranceFundFee)
            ),
            gas: 30000
        }("");
   ...
   antiBotEnabled = _enable;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no BESTAPY token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _BESTAPYInsuranceFundReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        BESTAPYInsuranceFundReceiver = _BESTAPYInsuranceFundReceiver;
        firePit = _firePit;
    }
