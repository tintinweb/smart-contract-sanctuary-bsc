...
contract CSRFarm is Ownable {
    ...
    uint256[] public periodDays = [30 minutes, 60 minutes, 180 minutes];
    uint256[] public powerRate = [1, 2, 3];
    uint256 public burnPowerRate = 4;
    IBEP20 public coesToken = IBEP20(0x5af98B3Ad8a62cF326fdAb6129FEf6740D529F16);
    IBEP20 public coesLpToken = IBEP20(0xf2c2a31687aba1cE731d86151E5B3aE2244A33c2);
    IBEP20 public usdtToken = IBEP20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
    IBEP20 public csrToken;
    address public burnAddress = address(0x000000000000000000000000000000000000dEaD);
    uint256 public FEE = 0.002 ether;
    uint256 public minBurnAmount = 2 ether;
    ...
    function cancelStake(uint256 _index) public payable {
    ...
    function director(uint256 _amount) public {
        ...
        require(usdtAmount >= minBurnAmount, 'burn too low');
