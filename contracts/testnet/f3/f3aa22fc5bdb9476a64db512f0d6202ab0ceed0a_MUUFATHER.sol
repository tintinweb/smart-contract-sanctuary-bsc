...
contract MUUFATHER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string public _name = "MUUFATHER";

    string private _symbol = "MUUF";

    uint8 private _decimals = 9;

    address public MarketAddress = 0x87Ba8971E6117C4864352b9af1ebdEC27F1C1899;
