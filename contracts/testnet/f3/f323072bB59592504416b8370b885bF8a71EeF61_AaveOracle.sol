...
library Errors {
  ...
  string public constant SUPPLYING_NOT_ENABLED = '91'; // 'Supplying is not enabled'
}
...
// console.log("AaveOracle getAssetPrice asset: %s", asset);
...
// console.log("AaveOracle source.latestAnswer");
