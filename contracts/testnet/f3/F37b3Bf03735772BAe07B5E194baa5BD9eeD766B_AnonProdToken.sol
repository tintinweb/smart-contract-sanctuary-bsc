//** Author ishanshahzad :  BEP20) Contract 2022.6 */
...
contract AnonProdToken is Context, IBEP20, Initializable {
    ...
    // constructor()  {
    //     initialize("AnonTestToken","AT",18,100000000 * 10 **18,false,msg.sender);
