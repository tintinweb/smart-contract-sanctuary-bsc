...
contract SakaiStaking is ERC20, Ownable {
        ...
        returns (uint256)
    {
        ...
        uint256 availableDay = (block.timestamp - startCountTime) / 5 minutes;
        ...
        returns (uint256)
    {
        ...
        uint256 availableDay = (timeEnd - block.timestamp) / 5 minutes;
    ...
    function _claimReward(address account) internal {
        ...
        payable(walletReceiver).transfer(bnbFee);
