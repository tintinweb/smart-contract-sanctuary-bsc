...
contract Pool is Ownable, Pausable, ReentrancyGuard {
    ...
    event Transfer(address indexed token, address to, uint256 amount);
    ...
    constructor(address _BUSDtoken, address _USDTtoken, address _CCOINtoken, address _CCXStoken){
    ...
    function packageSold(address _token, address _buyer, uint8 _package) external onlyAdmin nonReentrant {
        ...
        emit Transfer(_token, _buyer ,Packages[_package].PayoutAmount);
    }


    function ccoinExchange(uint256 _amount) public {
