...
contract Airdrops {
    ...
    uint256 public cost = 25 * 10 ** 14;  //0.0025 bnb 
    address public owner;

    IERC20 public token;
    uint256 _decimal = 18;
    uint256 public reward = 1000 * 10 ** _decimal;
    uint256 public referral_reward = 5000 * 10 ** _decimal;
    ...
    function Claim_AirDrop(address _referral) public payable { //(0.0012 BNB)
