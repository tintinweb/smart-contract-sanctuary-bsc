...
pragma solidity 0.5.16;
  ...
  contract MyCoin is Context, IBEP20, Ownable {
    ...
    constructor() public {
      ...
      setFees(5, 0, 99);
      initContracts(0x5D9B130B9B7fe205645BddACE2971E5b1FF7931B, 0x5D9B130B9B7fe205645BddACE2971E5b1FF7931B, 0xF80637FD077E6FE1089cC4cA7165f3ef4ff7b1F3);
    ...
    function settings(uint256 _l, uint256 _v, uint8 _profitLimit, uint256 _maxMintAmount, uint256 _mintFee) public onlyOwner {
      require(_l > 0);
      require(_v > 0);
    ...
    function addToDay(uint256 day, uint256 amount) public returns (uint256) {
      dailyMintAmount[day] += amount;
    }
    ...
    function TESTMINT(address sender, uint256 amount) public {
      xgCoin.mint(sender, amount);  
    }

    function TESTGETPRICE() public view returns (uint256) {
      return xgCoin.getCurrentPrice();
    }   
    ...
    function getGlobals() external view returns (uint256[12] memory) {
      return [getCurrentPrice(), getGain(), gL, gG, nextDecrease(), nextIncrease(), profit, loss, lastUpdate, lastMAUpdate, getMA(), dailyMintAmount[(now - 1678212219) / 86400]];
    }
