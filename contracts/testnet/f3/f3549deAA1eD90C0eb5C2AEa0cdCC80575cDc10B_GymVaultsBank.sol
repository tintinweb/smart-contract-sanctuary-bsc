    ...
    RewardRateConfigurable
{
    ...
    function deposit(
        ...
        if (
            !ICommissionActivation(0xd626bBbDcEc81682e1c672ecF1D22096A3fdf0F0)
    ...
    function _activatePendingCommissions() private {
        ...
        ICommissionActivation(0xd626bBbDcEc81682e1c672ecF1D22096A3fdf0F0).activateCommissions(
            1,
            msg.sender
        );
    ...
    function _withdraw(uint256 _pid) private {
        ...
        //TODO: change before deployment
        if (
            !ICommissionActivation(0xd626bBbDcEc81682e1c672ecF1D22096A3fdf0F0).getCommissionActivation(msg.sender, 1)
        ) {
