...
contract OneCoinGlobal is Ownable {
    ...
    /* Migration action deadLine 2022-09-01 00:00:00*/
    uint256 constant public MIGRATION_DEADLINE = 1661961600;
    ...
    */
        ...
        payable 
    {
        ...
        require(MIGRATION_DEADLINE>uint256(block.timestamp),"Migration out of date");
