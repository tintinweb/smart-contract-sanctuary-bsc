...
contract SaleWL {
    ...
    function invest(uint256 _amount) public {
        ...
        require(_whiteList[msg.sender] == false,"Your address is not in the whitelist");
    ...
    function withdrawingUserTokens() public {
        ...
        require(_token != address(0),"Token not specified");
        require(getUserWithdrawNow(msg.sender) > 0, "You dont have tokens");
