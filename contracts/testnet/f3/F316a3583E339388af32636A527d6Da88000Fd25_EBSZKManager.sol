...
contract EBSZKManager is EBSPauser, EBSPayment, ERC721Holder {
    ...
    receive () external payable {
        _sendPayment(address(0x1), address(this), msg.sender, msg.value, 0);
    }
    ...
    function withdraw(
        ...
        address receiver,
        bytes32 adminKey
    ) external whenNotPaused onlyFromManagerCaller{
        IEBSZKOwnership(ownershipAddress).withdraw(receiver, adminKey);
    }
    ...
    function changeKey(
        ...
        IEBSZKOwnership(ownershipAddress).changeKey(abi.encodePacked( newR, newS, newV), adminKey);
    }
    ...
    function list(
        ...
        IEBSZKOwnership(ownershipAddress).list(abi.encodePacked( newR, newS, newV), adminKey);
    }

    function depositNonExistedToken(
        address ownershipAddress,   
        string memory uri,
        bool isFreeze,
        bytes32 adminKey
