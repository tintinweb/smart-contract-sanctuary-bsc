...
contract LANDSPRIVATESALE1 is Ownable {
    ...
    function FEGetReleasedAmount(bytes32 vestingScheduleId)
        external
        view
        returns (uint256)
    {
        return vestingSchedules[vestingScheduleId].released;
    }
    ...
    function FEGetReleasedAndAmountLeft(address holder)
        external
        view
        returns (
            uint256,
        ...
        )
    {
        ...
        return (totalAmount, totalReleasedAmount, totalAmountLeft);
    }
