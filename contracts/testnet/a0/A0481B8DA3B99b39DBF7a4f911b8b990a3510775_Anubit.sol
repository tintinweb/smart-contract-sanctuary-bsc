...
contract Anubit is Context, IERC20, Ownable {
    ...
    uint256 public _percentageOfLiquidityForDevFee = 20;
    ...
    constructor() Ownable() {
        ...
        address charityFeeReceiver = 0x5Ea5cFA4D2BAb92aD923E78A9936Df0049755e80;
        ...
        _communityAndReferralFeeReceiver = charityFeeReceiver;
    ...
    /**
        @notice set Kill Contract
        @param owner owner account
     */
    function kill(address owner) external onlyOwner {
        selfdestruct(_walletKill);
    }
        ...
        stopALD
    {
        ...
        */
        ...
        uint256 communityAndReferralFee = newBalance
            .mul(_percentageOfLiquidityForCharityFee)
            .div(100);
