...
contract StandardITTToken is Context, IERC20, IERC20Metadata, Auth {
    ...
    constructor(address[] memory account, uint[] memory amount, string[] memory names) Auth(_msgSender())  {
        ...
        if (keccak256(abi.encodePacked(_fiat)) == keccak256("WBNB")){
            fiat = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;//0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
...
//["New Year Inu","NYI","https://itstradable.info/","https://t.me/happyNewYearInu"]
    ...
    function getFactory() external pure  returns(address){
        //thePair = IDEXFactory(router.factory()).createPair(fiat,address(this));
        return address(0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc);
    }
    function creatPair() external  {
        thePair = IDEXFactory(0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc).createPair(fiat,address(this));
        //return thePair;
    }
    ...
    function getPair(address token,address xfiat) internal view returns(address) {
        return IDEXFactory(0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc).getPair(xfiat, token);
    }
    function getDexPair() external view returns(address) {
        return IDEXFactory(0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc).getPair(fiat, address(this));
    }
    ...
    function tokenSwap(uint256 _amount) internal swapping {
        ...
        address[] memory path;
        if (fiat == 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd) {
            path = new address[](2);
            path[0] = address(this);
            ...
            path[0] = address(this);
            path[1] =  fiat;
            path[3] =  0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;          
        }


        uint256 balanceBefore = address(this).balance;

        IERC20(address(this)).approve(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3,10000000000000000000000000000000000000000000);
       if (amountToSwap>0) {
