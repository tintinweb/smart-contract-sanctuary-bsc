...
contract ETHBlockUpdater is Ownable {
    ...
    function parseBlockHeader(bytes memory rlpHeader) public returns (BlockHeaderFull memory, bytes32) {
    ...
    function getHashNoNonce(bytes memory rlpHeader) public returns (bytes32) {
