...
contract PandoraTokenTest is ERC20, AccessControl, ERC20Permit {
    ...
    IWrap public wrap = IWrap(0x91A0aAd567b4677A52d59FD6Ab9c866C1ad4dcc8);                     // 注意  请先部署完wrap合约再部署本合约
    IERC20 public usdt = IERC20(0xF03E0Fc04757184ff64A58385d5553F661878f1A);
