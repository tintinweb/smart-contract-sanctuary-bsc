...
contract ZNFT is ERC721URIStorage, Pausable, Ownable {
    ...
    constructor(
        ...
        baseURI = string(abi.encodePacked(__baseURI, "/"));
    }
    ...
    function mint(address recipient) external onlyOwner returns (uint256){
        ...
        string memory _tokenURI = string(abi.encodePacked(baseURI, "/", newItemId));
