...
library ExternalFuncs {
    ...
    */
    ...
    function isStakeSizeOk (uint256 amount, uint256 decimals) public pure returns (bool) {
        return
        amount == 1000 * 10 ** (decimals-6)   ||
        amount == 3000 * 10 ** (decimals-6)   ||
        amount == 5000 * 10 ** (decimals-6)   ||
        amount == 10000 * 10 ** (decimals-6)  ||
        amount == 20000 * 10 ** (decimals-6)  ||
        amount == 50000 * 10 ** (decimals-6)  ||
        amount == 100000 * 10 ** (decimals-6) ||
        amount == 250000 * 10 ** (decimals-6) ||
        amount >= 1000000 * 10 ** (decimals-6);
    }
