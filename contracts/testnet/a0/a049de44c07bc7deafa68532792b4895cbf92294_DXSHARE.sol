...
// Igo Finance
contract DXSHARE is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 100,000 Igo
    uint256 public constant FARMING_POOL_REWARD_ALLOCATION = 50000 ether;
    uint256 public constant DAO_FUND_POOL_ALLOCATION = 5000 ether;
    uint256 public constant INSURANCE_FUND_POOL_ALLOCATION = 0 ether;
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 0 ether;

    uint256 public constant VESTING_DURATION = 21390 days; // 2 years
    ...
    ) public ERC20("Igo  Share", "Igo") {
        _mint(msg.sender, 1 ether); // mint 1 Igo for initial liquidity deployment
