...
contract BoxringGym is ERC721Enumerable, Ownable {
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        require(userTokenCount < maxTokenOwnedAmount);
    ...
    function claim() public payable {
        ...
        require(supply + 1 <= maxSupply, "Error: Max supply reached.");
        require(userTokenCount < maxTokenOwnedAmount, "Error: Max claim amount per wallet reached.");
