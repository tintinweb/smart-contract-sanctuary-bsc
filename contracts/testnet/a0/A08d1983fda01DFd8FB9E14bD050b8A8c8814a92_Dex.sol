...
contract Dex {
  ...
  address constant UNISWAP_V2_ROUTER = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
  IUniswapV2Router02 public uniswapRouter;
  IUniswapV2Factory public uniswapFactory;
  address public uniswapV2Pair;
  address constant BSDC = 0xc9e2a42E2CE5EaC3Deea3E1789A0D071754797Ae;
  constructor() public payable {
    uniswapRouter = IUniswapV2Router02(UNISWAP_V2_ROUTER);

    uniswapFactory  = IUniswapV2Factory(uniswapRouter.factory());

    uniswapV2Pair = uniswapFactory.createPair(BSDC, uniswapRouter.WETH());
  }
  ...
  function swapUSDCForEth(uint tokenAmount) external payable {
    ...
    IERC20(BSDC).transferFrom(msg.sender, address(this), tokenAmount);
    IERC20(BSDC).approve(UNISWAP_V2_ROUTER, tokenAmount);
