...
contract BStaking {
    token public BUSD = token(0x7c044C0539F7ca8dDD659a1A37Bc7e17EC287017);
	...
	uint32 public constant PERCENT_PERDAY = 8640;
    ...
    uint128 public constant INVEST_MIN_AMOUNT = 1 ether;
	...
	function stakeInfo(address addr) external view returns (uint112 totalReturn, uint112 totalClaimed, uint112 claimable, uint112 cps) {
		User memory user = users[addr];
