...
contract Botra is  Ownable {
    ...
    uint256 public consensusPrices;//共识价格
    uint256 public joinNodePrices;//加入节点价格
    ...
    constructor(address utopiaToken_, address utopiaRalationship_, address utopiaPlanet_, address operatingFund_) {
        ...
        setInvitationRestrictions(true);
    ...
    function setRecommender(address recommender) public {
        ...
        require(consensusTotalNum[recommender] != 0 || owner() == recommender, "[Botra] Invalid recommender!");
    ...
    function consensus(uint256 num) public {
        ...
        invitePermissionNum[msg.sender] += invitedAddNum;
        invitePermissionNum[recommender_address] += invitedAddNum;
    }
