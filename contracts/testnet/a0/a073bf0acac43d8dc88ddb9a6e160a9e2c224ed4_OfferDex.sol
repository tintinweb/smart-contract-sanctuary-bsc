...
contract OfferDex is Initializable, ReentrancyGuardUpgradeable {
	uint256 public totalOffers;
	IXanaliaAddressesStorage xanaliaAddressesStorage;
	...
	function acceptOffer(uint256 _offerId) external onlyXanaliaDex returns (address, address, address, uint256, uint256) {
