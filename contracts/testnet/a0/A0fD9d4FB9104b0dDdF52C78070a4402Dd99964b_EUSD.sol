...
contract EUSD is ERC20, AuthorizedAccess {
	constructor(uint256 initialSupply) ERC20("EUSD", "EUSD") {
	...
	// TODO: RBA can be added here
	// buy for now authorized is enough
	function mint(address _mintTo, uint256 _amount) public onlyAuthorized {
