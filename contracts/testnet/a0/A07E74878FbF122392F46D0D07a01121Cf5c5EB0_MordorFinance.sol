...
contract MordorFinance {
    ...
    uint256 private immutable secondsByDay             = 60;           // A day is 86400 seconds.
    ...
    uint256 private immutable autoclaimMinInvest       = 3 * 1e15 wei; // = 3.00 BNB / The amount that must be stacked to unlock the autoclaim feature.
    uint256 private immutable fightPrice               = 2 * 1e15 wei; // = 0.02 BNB / The fixed price to fight in a battle.
    uint256 private immutable minStackAmount           = 5 * 1e15 wei; // = 0.05 BNB / The minimum amount to stack.
