...
/**
 * CLSToken = The integrated Finance Token
 * A new type of contract that designed and implemented by CLS Community
 */
contract CLSToken is IBEP20, Context, Ownable {
    struct Values {
        uint256 rSendAmount;
    ...
    string private constant _NAME = "CLS Token";
