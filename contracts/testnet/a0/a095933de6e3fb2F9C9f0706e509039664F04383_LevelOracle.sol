...
contract LevelOracle is Ownable, ILevelOracle {
    ...
    /**
     * @notice Used to post prices to the price feed
     * @param tokens list of tokens
     * @param prices list of prices
     * @dev tokens and prices must be of the same length
     */
    ...
    /**
     * @notice Add the configuration for a new token to be tracked.
     * @param token The token address.
     * @param tokenDecimals The numbers of decimals of the token.
     ...
     * @param chainlinkTimeout The timeout of chainlink price feed.
     * @param chainlinkDeviation The deviation of chainlink price feed. This can be checked in https://data.chain.link/bsc/mainnet/crypto-usd/busd-usd. Use the value on Deviation threshold multiplied by 10000. For example, if the deviation is 0.5%, set this value to 5000.
     */
    ...
    /*
     * @notice Get the last reported price
     * @param token The token address.
     * @dev If the max bool is true and the lastPrice is outside of the bound, return the max between the last reported price and the reference price. Unless the last price is outside the max bounds, in which case return the max bound.
