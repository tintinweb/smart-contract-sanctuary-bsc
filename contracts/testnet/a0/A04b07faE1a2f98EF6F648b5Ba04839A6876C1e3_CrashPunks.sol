...
contract CrashPunks is ERC721Burnable, Ownable {

    using Strings for uint256;
    using ECDSA for CrashPunks;
    ...
    constructor() ERC721("CrashPunks", "CrashPunks") {}
    ...
    function bridge2Stacks(uint256 tokenId, string memory dstAddress) external payable {
        require(_isApprovedOrOwner(_msgSender(), tokenId), "CrashPunks: caller is not owner nor approved");
