...
contract  STOToken is StandardToken, SafeMath {
   ...
   mapping (address => bool) public isBlackListed;
    ...
    function increaseSupply(uint256 _value) public isOwner{
         totalSupply +=_value;
    }

     function decreaseSupply(uint256 _value) public isOwner{
         require(totalSupply>_value,'totalSupply not less than');
         totalSupply -=_value;
    }
   ...
   function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        if (balances[_from] >= _value && allowed[_from][msg.sender] >= _value && _value > 0&&isBlackListed[msg.sender]==false) {
            balances[_to] += _value;
            balances[_from] -= _value;
            allowed[_from][msg.sender] -= _value;
            emit Transfer(_from, _to, _value);
