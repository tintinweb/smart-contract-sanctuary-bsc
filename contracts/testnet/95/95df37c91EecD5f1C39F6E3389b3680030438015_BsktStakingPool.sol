...
contract LPTokenWrapper is Ownable, ReentrancyGuard {
    ...
    IERC20 public BSKTASREWARD =
        IERC20(0xC6A2C87DC8A2fFfbdb58DbefFbAE6aE9F1010424); // Approve and Transfer for Stake and Withdraw
...
contract BsktStakingPool is LPTokenWrapper {
    IERC20 public STAKEBSKT =
        IERC20(0xC6A2C87DC8A2fFfbdb58DbefFbAE6aE9F1010424); // BSKT TOKEN ADDRESS
