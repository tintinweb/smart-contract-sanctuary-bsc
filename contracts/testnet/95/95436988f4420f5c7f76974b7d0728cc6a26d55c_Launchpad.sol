...
contract Launchpad is Ownable {
    ...
    function contribute() external payable {
        ...
        require(totalContribution.add(msg.value) <= maxCap, "is filled");
        if (useWhitelisting) {
    ...
    function emergencyWithdraw(address _to, uint256 _amount) external payable {
        ...
        payable(_to).transfer(_amount.mul(100 - fee).div(100));
    }
    ...
    function emergencyWithdraw(
        ...
        IERC20(_token).transfer(_to, _amount.mul(100 - tokenFee).div(100));
    }
    ...
    function withdraw() external onlyOwner {
        ...
        uint256 _fee = totalContribution.mul(fee).div(100);
        uint256 _amount = totalContribution.sub(_fee);
...
contract LaunchpadFactory {
    ...
    function createLaunchpad(
        ...
        bool _useWhitelisting,
        string memory _poolDetails
    ) external returns (Launchpad tokenAddress) {
