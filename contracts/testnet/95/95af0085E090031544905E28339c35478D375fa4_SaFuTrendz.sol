...
contract SaFuTrendz is ERC20, Ownable {
    ...
    // to recover stuck tokens in contract
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _salaryFee, uint256 _vaultFee, uint256 _liquidityFee, uint256 _devFee, uint256 _earlySellLiquidityFee, uint256 _earlySellMarketingFee, uint256 _earlySellSalaryFee, uint256 _earlySellVaultFee, uint256 _earlySellDevFee) external onlyOwner {
    ...
    function swapBack() private {
        ...
        (success,) = address(salaryWallet).call{value: address(this).balance}("");
        (success,) = address(vaultWallet).call{value: address(this).balance}("");
