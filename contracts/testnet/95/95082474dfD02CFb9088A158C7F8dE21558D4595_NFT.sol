...
contract NFT is ERC1155, Ownable {
    ...
    uint256 private constant LIFE_1 = 14;
    // NFTs level 2
    ...
    */
    constructor(
        ...
        address _recipient2,
        uint256 _amount
    ) ERC1155("ipfs://QmZLSaLh5qkeVc5xxTvzuUniJp5toGxhgkjSAUJTXLiduE/metadata/{id}.json") {
        _mint(_recipient, TIME_1, _amount, "");
        _mint(_recipient, LIFE_1, _amount, "");
        _mint(_recipient, TIME_2, _amount, "");
        _mint(_recipient, TIME_3, _amount, "");
        _mint(_recipient2, TIME_1, _amount, "");
        _mint(_recipient2, LIFE_1, _amount, "");
        _mint(_recipient2, TIME_2, _amount, "");
        _mint(_recipient2, TIME_3, _amount, "");
    }
    ...
    */
    ...
    function _isPerksValid(uint256 _perks) private pure returns (bool) {
        if ((_perks > 10 && _perks <= 14) || (_perks > 20 && _perks <= 23) || (_perks > 30 && _perks <= 33)) {
            return true;
        } else {
            return false;
        }
