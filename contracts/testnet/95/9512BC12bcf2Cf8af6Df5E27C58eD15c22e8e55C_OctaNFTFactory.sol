...
contract OctaNFTFactory is Ownable, AccessControl {
    ...
    */
        ...
        returns (address)
    {
        ...
        IERC20(octaToken).safeTransferFrom(msg.sender, feeRecipient, platformFee);
...
contract OctaNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable, ReentrancyGuard, EIP712 {
    ...
    mapping(string => bool) public isNonceUsed;
    ...
    function buy(NFTVoucher calldata voucher) external payable {
        ...
        uint mintFeeAmount = (octaFactory.mintFee() * voucher.price) / 10000; 
        ...
        if (octaFactory.octaToken() == address(0)) {
            ...
            uint creatorFee = (voucher.price) - mintFeeAmount;
        ...
        _setTokenURI(voucher.tokenId, voucher.tokenUrl);
    ...
    */
    ...
    function _hash(NFTVoucher calldata voucher) internal view returns (bytes32) {
        ...
        //     voucher.tokenId,
        //     voucher.price,
        //     keccak256(bytes(voucher.tokenUrl)),
    ...
    function _verify(NFTVoucher calldata voucher) internal view returns (address) {
        ...
        bytes memory message = abi.encodePacked(voucher.tokenId,voucher.price,voucher.tokenUrl,voucher.creatorAddress,voucher.nonce);
        ...
        return ECDSA.recover(prefixedHashMessage, voucher.signature);
    }
