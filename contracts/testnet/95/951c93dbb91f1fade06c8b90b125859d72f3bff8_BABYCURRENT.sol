...
contract BABYCURRENT is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Baby current thing";
    string private _symbol = "$BBC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x5d498AF7a94d71431AAcB903FbB1f2e50DCe10a4);
    address payable public teamWalletAddress = payable(0x5d498AF7a94d71431AAcB903FbB1f2e50DCe10a4);
