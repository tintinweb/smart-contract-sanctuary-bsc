...
contract balahap {
    ...
    event PlaceOffer(uint256 _offerNo, uint256 _offerAmount,uint256 _closeBetTime,string _condition);
    event PlaceBet(uint256 _offerNo, uint256 _betAmt, uint256 offerAmtLeft);
    event SubmitResult(uint256 _offerNo, address _msgSender ,result _result);
    ...
    function makeOffer(uint256 _offerAmount,uint256 _closeBetTime,string memory _condition) external {
        ...
        emit PlaceOffer(_id, _offerAmount, _closeBetTime, _condition);
    }
    ...
    function bet(uint256 _offerNo, uint256 _betAmt) external {
        ...
        emit PlaceBet(_offerNo, _betAmt, _offerAmtLeft - _betAmt);
    }
    ...
    function submitResult(uint256 _offerNo, result _result) external {
        ...
        emit SubmitResult(_offerNo, msg.sender, _result);
    ...
    function claimPrize(uint256 _offerNo) external {
        ...
        /* No dispute claim yet*/
            ...
            require(!biddersList[_offerNo][_num].isBidderClaimed, "You already claim this prize");
