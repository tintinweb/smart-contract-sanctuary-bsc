...
contract NFT is Initializable, ERC721Upgradeable, ERC721RoyaltyUpgradeable, ERC721URIStorageUpgradeable, OwnableUpgradeable {
  ...
  function safeMintNFT(uint96 _royaltyAmount, uint256 _nftId, uint256 _sellPrice, address _artistAddress) public returns(uint256) {
    ...
    super._setTokenRoyalty(_nftId, _artistAddress, _royaltyAmount);
