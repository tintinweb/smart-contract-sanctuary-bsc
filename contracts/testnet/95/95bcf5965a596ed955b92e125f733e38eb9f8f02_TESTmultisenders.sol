...
contract TESTmultisenders {
    ...
    IERC20 tokenaddress; // available token address, for example cake address
    uint256 quantity; // available token quantity, for example 100 cake tokens
