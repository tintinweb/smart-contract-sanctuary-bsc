...
contract TokenGeneral721 is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    ...
    function pause() public {
        require(
            ...
            "TokenGeneral721: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function mintWithTokenURI(
        ...
        if (!_publicMint) {
            require(
                ...
                "TokenGeneral721: must have minter role to mint"
            );
        }
        _safeMint(to, tokenId);
