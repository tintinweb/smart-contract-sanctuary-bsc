...
contract Dutuchn is Ownable, Pausable, ERC721Enumerable{
    ...
    function StartAuction(uint256 _startP, uint256 _discP, uint256 _Ftime) public onlyOwner {
    ...
    function Dutuch_Mint(uint256 _count) public {
        ...
        require(
        totalSupply() + _count <= Dutuch_Max_supply
