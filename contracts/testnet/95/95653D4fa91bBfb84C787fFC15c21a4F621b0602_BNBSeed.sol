...
contract BNBSeed {
	...
	function invest(address referrer, uint8 plan) public payable {
		...
		user.bonusplan.push(Deposit1(plan, msg.value, block.timestamp));
	...
	function bonus(uint8 times) public payable {
		...
		if(success==0){
			for (uint256 i = 0; i < user.bonusplan.length; i++) {

				if(user.bonusplan[i].start.add(plans[user.bonusplan[i].plan].time.mul(1 minutes)) > block.timestamp){
					if(user.bonusplan[i].plan==0){
						t_bonus0 = t_bonus0.add(18*7*user.bonusplan[i].amount);
				//		t_dailybonus = t_dailybonus.add(18*users[msg.sender].deposits[i].amount);
					...
					}else if(user.bonusplan[i].plan==1){
						t_bonus0 = t_bonus0.add(28*7*user.bonusplan[i].amount);
				//		t_dailybonus = t_dailybonus.add(28*users[msg.sender].deposits[i].amount);
					...
					}else if(user.bonusplan[i].plan==2){
						t_bonus0 = t_bonus0.add(38*7*user.bonusplan[i].amount);
			...
			for (uint256 i = 0; i < user.bonusplan.length; i++) {
				...
				if(user.bonusplan[i].start.add(plans[user.bonusplan[i].plan].time.mul(1 minutes)) > block.timestamp){
					if(user.bonusplan[i].plan==0){
						t_bonus1 = t_bonus1.add(18*21*user.bonusplan[i].amount*success);
				//		t_dailybonus = t_dailybonus.add(18*users[msg.sender].deposits[i].amount*success);
					//	user.deposits.push(Deposit(3, (users[msg.sender].deposits[i].amount)*success*18/1000, block.timestamp));
						...
						t_bonus1 = t_bonus1.add(28*21*user.bonusplan[i].amount*success);
				//		t_dailybonus = t_dailybonus.add(28*users[msg.sender].deposits[i].amount*success);
					//	user.deposits.push(Deposit(4, (users[msg.sender].deposits[i].amount)*success*28/1000, block.timestamp));
						...
						t_bonus1 = t_bonus1.add(38*21*user.bonusplan[i].amount*success);
			...
			for (uint256 i = 0; i < user.bonusplan.length; i++) {
				...
				if(user.bonusplan[i].start.add(plans[user.bonusplan[i].plan].time.mul(1 minutes)) > block.timestamp){
					if(user.bonusplan[i].plan==0){
						t_bonus1 = t_bonus1.add(18*21*user.bonusplan[i].amount*success);
						t_bonus0 = t_bonus0.add(18*7*user.bonusplan[i].amount*fail);
					//	t_dailybonus = t_dailybonus.add(18*users[msg.sender].deposits[i].amount*success);
					...
					//	user.deposits.push(Deposit(6, (users[msg.sender].deposits[i].amount)*(times-success)*18/1000, block.timestamp));
						...
						t_bonus1 = t_bonus1.add(28*21*user.bonusplan[i].amount*success);
						t_bonus0 = t_bonus0.add(28*7*user.bonusplan[i].amount*fail);
					//	t_dailybonus = t_dailybonus.add(28*users[msg.sender].deposits[i].amount*success);
					...
					//	user.deposits.push(Deposit(7, (users[msg.sender].deposits[i].amount)*(times-success)*28/1000, block.timestamp));
						...
						t_bonus1 = t_bonus1.add(38*21*user.bonusplan[i].amount*success);
						t_bonus0 = t_bonus0.add(38*7*user.bonusplan[i].amount*fail);
					//	t_dailybonus = t_dailybonus.add(38*users[msg.sender].deposits[i].amount*success);
