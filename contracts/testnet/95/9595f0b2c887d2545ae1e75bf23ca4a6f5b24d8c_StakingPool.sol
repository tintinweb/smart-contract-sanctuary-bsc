...
contract Upgradable {
    ...
    struct PoolInfo {
        ...
        uint256[] configs; // startDate(0), endDate(1), duration(2), endStakeDate(3), stakingLimit(4), exchangeRateRewardToStaking(5)
...
contract StakingPool is Upgradable {
   ...
   */
    ...
    */
        ...
        returns (uint256)
    {
        ...
        if(pool.pool == 0) {
            ...
            amount = (currentTimestamp - lastUpdateTime) * item.balance * pool.apr * pool.configs[4] / ONE_YEAR_IN_SECONDS / 1e4 + item.reward;
        }
    ...
    */
     ...
     * @param configs: startDate(0), endDate(1), duration(2), endStakedTime(3), stakingLimit_for_Linear(4),exchangeRateRewardToStaking(5)
   */
