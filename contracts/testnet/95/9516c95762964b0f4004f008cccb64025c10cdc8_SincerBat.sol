...
contract SincerBat is Context, IERC20, Ownable {
    ...
    uint256  public  _redisFeeOnBuy;
    uint256  public  _taxFeeOnBuy ;
    
    uint256  public  _redisFeeOnSell ;
    uint256  public  _taxFeeOnSell ;
    
    uint256  public  _redisFee;
    ...
    constructor (string memory name_, string memory symbol_,uint256 _total,uint8 decimals_,
    uint256 redisFeeOnBuy_ ,uint256 taxFeeOnBuy_,uint256 redisFeeOnSell_, uint256 taxFeeOnSell_
                ,address developmentAddress_,address marketingAddress_)   {
         _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
        _redisFeeOnBuy=redisFeeOnBuy_;
        _taxFeeOnBuy=taxFeeOnBuy_;
        _redisFeeOnSell=redisFeeOnSell_;
        _taxFeeOnSell=taxFeeOnSell_;
        _developmentAddress=payable(developmentAddress_);
        _marketingAddress=payable(marketingAddress_);
        _tTotal = _total * 10 ** _decimals;
