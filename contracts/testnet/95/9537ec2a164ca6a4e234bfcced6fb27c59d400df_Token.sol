...
contract  Token is IERC20, Ownable {
    ...
    uint256 public _limitTimeMaxTx = 600;
   ...
   // uint256 public minDividendNum  = 1000000 ether ;
    ...
    //address fhAddress =0x2537767f44264f72f951a4171Ef357137904B9f5;
    uint256 fenmu ;
    ...
    event SwapAndLiquify(
     ...
     constructor()  public{
             ...
             //adminAddress =0x3077AEa4e48A05D734F51E31a0804FDAC0E77b31;
            ...
            _inviterFee = 600;
            _liqFee = 500;
           // marketAddr = payable(0x942DCd38BB74D19318A5914B5F149456d48956C5);
            marketAddr = payable(0x942DCd38BB74D19318A5914B5F149456d48956C5);
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        if(canSwap &&from != address(this) &&from != uniswapV2Pair  &&from != owner() && to != owner() ){
            swapTokensForTokens(balanceOf(address(this))/2,marketAddr);
    ...
    function dividend() private {
        if(IERC20(usdt).balanceOf(address(this)) > 0 ) {
            ...
            // if(dividendCount>100) dividendCount= 100;
            // for(uint256 i = 0; i< dividendCount;i++){
            //     if(_tOwned[dividendKeys[i]]>10000e18){
            //             dividendKey.push(dividendKeys[i]);
            //             if(dividendKey.length>=100){
            //                 break;
            //             }
            //     }
            // }
            // if(dividendKey.length == 0)return;
   ...
   function _takeburnFee(
    ...
    function getUsdtPrice() public view returns(uint256){
        //10000个usdt 100000个LP  1lp = 0.1U  50lp = 5U 
