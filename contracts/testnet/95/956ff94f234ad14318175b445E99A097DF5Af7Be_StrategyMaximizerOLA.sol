...
contract StrategyMaximizerOLA is BaseBananaMaximizerStrategy {
        ...
        )
    {
        ...
        // RAIN_MAKER = SingleAssetDynamicRainMaker(
    ...
    function vaultDeposit(uint256 _amount) public {
        _approveTokenIfNeeded(STAKE_TOKEN, _amount, address(STAKE_TOKEN2));
        STAKE_TOKEN2.mint(_amount);
    }
    ...
    function _vaultWithdraw(uint256 _amount) internal override {
        STAKE_TOKEN2.redeemUnderlying(_amount);
    }
    ...
    {
        uint256 rewards = 0;
        // _rewardTokenBalance() + RAIN_MAKER.compAccrued(address(this)); //THIS ONE IS WRONG
    ...
    function _emergencyVaultWithdraw() internal override {
        STAKE_TOKEN2.redeemUnderlying(STAKE_TOKEN.balanceOf(address(this)));
    }
...
interface CErc20Delegator {
    function mint(uint256 _amout) external view returns (uint256);
