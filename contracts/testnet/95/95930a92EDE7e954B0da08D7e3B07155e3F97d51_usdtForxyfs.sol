...
contract usdtForxyfs {
    ...
    function exchange(uint256 amount)  public{
        TransferHelper.safeTransferFrom(_usdtToken,msg.sender,_poolToken, amount);//--U到资金池地址
        // uint256 num = amount.mul(getPriceFromPancake());  //正式才能获取价格
        uint256 num = amount;
    ...
    function test3(uint256 amount)  public{
        uint256 num = amount;
        TransferHelper.safeTransfer(_seaToken,msg.sender, num);//拿相应的sea
    }
