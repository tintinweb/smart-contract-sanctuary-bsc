...
contract Checkuints is Ownable, ERC721A, ReentrancyGuard {
   ...
   uint256 public maxSupply = 99;
    ...
    uint256 public PRICE4 = 0.004 ether;
    ...
    uint256 public AMOUNT1 = 9;
    uint256 public AMOUNT2 = 19;
    uint256 public AMOUNT3 = 29;
    uint256 public AMOUNT4 = 99;
   ...
   struct Info {
    ...
    function mint1(uint256 amount) external payable {
        ...
        require(msg.value >= PRICE1 * amount, "value not met");
   ...
   function withdraw() public onlyOwner nonReentrant {
    ...
    function setPrice1(uint256 price) public onlyOwner
    {
        PRICE1 = price;
    }
