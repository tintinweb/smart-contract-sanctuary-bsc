...
contract routerTest is Ownable {
    ...
    address public _PANCAKEROUTER = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;  //testnet
    // address public _PANCAKEROUTER = 0x10ED43C718714eb63d5aA57B78B54704E256024E;  //mainnet
    address public _SC2ADDRESS = 0x59f8EdAaF514fAAc1B5b1512Bc9F9af307887045;
    ...
    function swapBUSDForTHALES(uint256 amount) public{
        ...
        IPancakeRouter02(_PANCAKEROUTER).swapExactTokensForTokensSupportingFeeOnTransferTokens(
            amount,
