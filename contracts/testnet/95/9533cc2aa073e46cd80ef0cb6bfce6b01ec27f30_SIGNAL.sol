...
abstract contract MyToken is IERC20, Ownable {
...
//                }
    ...
    function addHolder(address adr) private {
     ...
     function p1() public view  returns(uint256 a2Len, address[] memory){
        address[] memory a2 = new address[](holders.length);
