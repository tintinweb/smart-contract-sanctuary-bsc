...
contract stakingtest is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        stakingToken = IBEP20(0xFadd66AD02C46Cb5D16fa180f376949980A3Ef43);
    ...
    function updatetotalAllocPoint(uint256 newtotalAllocPoint) external onlyOwner {
        require(newtotalAllocPoint <= 1, "totalAllocPoint must be below 1");
