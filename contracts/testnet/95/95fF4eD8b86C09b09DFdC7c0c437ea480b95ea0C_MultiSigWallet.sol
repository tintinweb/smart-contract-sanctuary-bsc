...
contract MultiSigWallet {
    ...
    event TimeLimitForEachTransactionChange(uint256 newValue);
    ...
    uint256 public timeLimitForEachTransaction = 86400;
    ...
    function _createNewTransaction(
        ...
        uint256 confirmationsNeeded = (timeLimitForEachTransaction == 0)
            ? MAX_UINT
        ...
        transactions.push(
            Transaction({
                ...
                deadline: confirmationsNeeded
            })
        );
        emit SubmitTransaction(msg.sender, txIndex, _to, _value, _data, confirmationsNeeded);
    }
