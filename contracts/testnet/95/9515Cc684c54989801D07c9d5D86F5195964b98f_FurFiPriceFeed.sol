...
import "./Interfaces/IFurFiAveragePriceOracle.sol";
...
* Chainlink oracle.
*/
contract FurFiPriceFeed is BaseContract, BaseMath, IFurFiPriceFeed {
    ...
    IFurFiAveragePriceOracle public averagePriceOracle;
        ...
        onlyOwner
    {
        ...
        averagePriceOracle = IFurFiAveragePriceOracle(_averagePriceOracle);
...
interface IFurFiAveragePriceOracle {
