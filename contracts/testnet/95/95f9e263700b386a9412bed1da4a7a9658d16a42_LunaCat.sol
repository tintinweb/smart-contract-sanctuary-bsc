...
contract LunaCat is ERC721Enumerable, Ownable {
    ...
    uint256 public price_tier1 = 0.3 ether;
    uint256 public price_tier2 = 0.5 ether;
    uint256 public price_tier3 = 0.7 ether;
    uint256 public tier1_limit = 400;
    uint256 public tier2_limit = 300;
    uint256 public tier3_limit = 300;
    string baseTokenURI;
    ...
    constructor(string memory baseURI) ERC721("Luna Cat", "LUNAC") {
        setBaseURI(baseURI);
    }
    ...
    function setTier1Limit(uint256 _newLimit) public onlyOwner {
        tier1_limit = _newLimit;
    }

    function setTier2Limit(uint256 _newLimit) public onlyOwner {
        tier2_limit = _newLimit;
    }

    function setTier3Limit(uint256 _newLimit) public onlyOwner {
        tier3_limit = _newLimit;
    }

    function setTier1Price(uint256 _newPrice) public onlyOwner {
        price_tier1 = _newPrice;
    }

    function setTier2Price(uint256 _newPrice) public onlyOwner {
        price_tier2 = _newPrice;
    }

    function setTier3Price(uint256 _newPrice) public onlyOwner {
        price_tier3 = _newPrice;
    }
    ...
    function getPrice() public view returns(uint256){
        if(totalSupply() <= tier1_limit){
            return price_tier1;
        }else if(totalSupply() <= tier2_limit){
            return price_tier2;
        }else {
            return price_tier3;
        }
