...
contract MarketplaceV3 is Ownable {
   ...
   */
  function cancelSelling(address _nftAddress, uint256 _tokenId) public {
    require(
      sellingTokens[_tokenId].isExist,
      'the token is sold or already bought'
    );
   ...
   */
  function buy(uint256 _tokenId) external returns (bool) {
    ...
    // require(
    //   nft.ownerOf(_tokenId) == nftSold.owner,
    //   'seller is not owner of this item now'
    // );
    ...
    // nft.safeTransferFrom(nftSold.owner, _msgSender(), _tokenId);
