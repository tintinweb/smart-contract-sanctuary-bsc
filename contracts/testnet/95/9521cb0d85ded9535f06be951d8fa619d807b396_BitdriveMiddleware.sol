...
contract BitdriveMiddleware is ContextUpgradeable, OwnableUpgradeable {
    ...
    function initialize(address payable _admin) public initializer {
        ...
        biswaprouter = 0x912A5515093E29daCF5f9975A2ab3512B01c84ec;
        pancakerouter = 0x912A5515093E29daCF5f9975A2ab3512B01c84ec;
        bitdriverouter = 0x912A5515093E29daCF5f9975A2ab3512B01c84ec;
        biswapfactory = 0x912A5515093E29daCF5f9975A2ab3512B01c84ec;
        adminAddress = _admin;
    }
    ...
    function estimategetAmountOut(
        ...
        if(router==biswaprouter){
            ...
            IBiswapPair pair = IBiswapPair(BiswapLibrary.pairFor(biswapfactory, inputToken, outputToken));
    ...
    function estimategetAmountOut1(
        address router,
        address pair,
        address inputToken,
        address outputToken,
    ...
    function bitdriveSettings(uint256 _fee,address _router,uint256 _changetype) public {
    ...
    function biswapSettings(uint256 _fee,address _router,uint256 _changetype) public {
        require(msg.sender == adminAddress, 'FORBIDDEN');
        require(_changetype==1 || _changetype==2, 'FORBIDDEN');
        if(_changetype==1){
            biswapfee = _fee;
    ...
    function pancakeSettings(uint256 _fee,address _router,uint256 _changetype) public {
        require(msg.sender == adminAddress, 'FORBIDDEN');
        require(_changetype==1 || _changetype==2, 'FORBIDDEN');
        if(_changetype==1){
            pancakefee = _fee;
