...
contract WOLFPACKRewardManager is Ownable, ReentrancyGuard {
    ...
    uint256 predictionRew = 1000000 * 10**18;
    uint256 liquidityRew = 1000000 * 10**18;
    uint256 managementRew = 300000 * 10**18;
    IERC20 public WPACK;
    ...
    function synchronizeRewardNotification(address rewardee, bool predictionQualified, bool liquidityQualified, bool managementQualified) public {
