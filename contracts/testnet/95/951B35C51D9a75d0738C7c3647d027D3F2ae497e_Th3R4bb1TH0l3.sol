...
contract Th3R4bb1TH0l3 is IERC20, Context, Ownable, ReentrancyGuard {
    event Bought(
    ...
    // token data
    string private constant _name = "Th3 R4bb1T H0l3 TEST1";
    string private constant _symbol = "TRH";
    ...
    //Tax wallets
    address public teamWallet = 0x6C378B8CDF56985A4180ae8b9d12657Ad5F33F7b;
    address public treasuryWallet = 0x804779079136226c9ad2ead3358875528B34d1B5;
