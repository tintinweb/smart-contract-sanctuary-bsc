...
contract YSLBUSDVault is AccessControl, Initializable {
    ...
    uint256 public rewardsPerEpoch;//rewardsPerEpoch as uint
    uint256 public tradeTax = 5;// setting tradetax as uint
    uint256 public depositTax = 10;//setting deposit tax as uint
    uint256 public exchangeRatio = 10 ** 18;//setting exchange ratio as uint
    address public router;// router address
    address public yslBUSD_A;//Reciept address
    IUniswapV2Pair yslBUSD;//Pair address
    ...
    function withdraw(address user, bool isReciept,uint _amount) external{
        ...
        if(isReciept){
            ...
            INTT(yslBUSD_A).burn(address(this),_amount);
        }
