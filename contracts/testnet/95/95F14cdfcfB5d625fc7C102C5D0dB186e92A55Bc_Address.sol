...
contract Amazing is Context, IERC20, Ownable {
    ...
    string private _name = "Mad Dogcoin";
    string private _symbol = "MDC";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x950528a1dA7419e99CeF2abBcB18288Be94A90E3);
    address payable public teamWalletAddress = payable(0xB6f8139815887595A49db0490751e7535522bF64);
