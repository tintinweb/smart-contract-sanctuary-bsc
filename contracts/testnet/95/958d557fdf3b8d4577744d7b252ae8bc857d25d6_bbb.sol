...
contract bbb is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3E445865086911CE66121B7a8A2C617fEcdB54d0));
        marketingWalletAddress = payable(address(0x3E445865086911CE66121B7a8A2C617fEcdB54d0));
