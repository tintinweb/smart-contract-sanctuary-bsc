...
contract DAGON is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000 * 10**12 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0xbb73af24E13e7CeD8A968ae363b934EAEB6559B9));


    string private _name = "Dagon Token";
    string private _symbol = "DAGON";
