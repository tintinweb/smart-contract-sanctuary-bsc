...
contract veFroyo is MinterRole {
    ...
    mapping(address => uint256) public acounttotallock;
    ...
    function lock(uint256 _selection, uint256 _amount) public {
    ...
    function unlock(uint256 _counter) public {
        require(
