...
contract PharaohFarmPot is Ownable {
    ...
    constructor () {
        user_data[msg.sender] = User(
          ...
          0,
          365,
          0,0,0,address(0),block.timestamp,block.timestamp
        );
    }
    ...
    function deposit(uint256 amount, address referAddress) public {
        ...
        user_data[referAddress].referralRewards += finalAmount * refRewardLevels[0] / 1000;
    ...
    function availableRewards() public view returns (uint256) {
        ...
        uint256 time = (block.timestamp +30 days - deposit_time) / 1 days;
    ...
    function doubleUp() public {
        ...
        uint256 totalStakingDays = block.timestamp +365 days - startDate / 1 days;
        require(
