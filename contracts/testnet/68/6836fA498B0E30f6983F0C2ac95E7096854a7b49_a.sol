...
contract a is Ownable, ERC721, ERC721Enumerable, ReentrancyGuard {
    ...
    uint256 public afinPrice = 1000000000000000000;
    uint256 public mvpPrice = 1000000000000000000;
    address public afin;
    address public mvp;
    ...
    function mintPreWithToken(uint256 count, address token) external nonReentrant {
        require(block.timestamp >= MINT_PRE_START_TIME, "Pre-Mint not started");
        require(block.timestamp < MINT_START_TIME, "Pre-Mint ended");
        require(
            count <= whitelistPre[msg.sender],
