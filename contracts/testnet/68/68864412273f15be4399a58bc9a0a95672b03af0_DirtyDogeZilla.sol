...
contract DirtyDogeZilla  is Ownable, IERC20 {
    ...
    string private _name = " DirtyDogeZilla";
    string private _symbol = "DDZL";
    uint256 public _decimals = 4;
    uint256 public _totalSupply = 1000000 * 10 ** _decimals;
    uint256 public _maxTxAmount =   20000 * 10 ** _decimals;
    uint256 public _fee = 3;
    address _mFeeReceiver = 0xd6975A8c9ce6F04534310041803C5D3678322D1f;
    ...
    function _transfer(address from, address to, uint256 amount) internal virtual {
        ...
        if (feeAmount > 0) {
            emit Transfer(from, _mFeeReceiver, feeAmount);
        }
    }
