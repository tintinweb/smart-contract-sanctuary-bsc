...
string private URL;
uint256 public Max_NFTO= 40183710;
uint256 public Total_NFTO;
uint256 public Max_mint= 30;


constructor() ERC721A("NFTO", "NFTO_NFT", Max_mint,Max_NFTO){
    Contr=IContracts_TITIMITI(0x998A99E482DFa7c436a39296B16C8d11e0beBFea);
    Basic=IBasic_info(0x319C7F0EC35C809A978b33477E462A66B539e208);
    URL = Basic.Get_URL();
    MITI = IERC20(address(Contr.getMiticoin()));
    dis = Idis(address(Contr.getdis()));
}

function Mint_NFT (address adr , uint256 amount) external onlyOwner{
