...
// File: contracts/interfaces/IDasaralloSwapLottery.sol

pragma solidity ^0.8.4;

interface IDasaralloSwapLottery {
    /**
...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public DasaralloSwapLottery;
     ...
     * @param _seed: seed provided by the DasaralloSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == DasaralloSwapLottery, "Only DasaralloSwapLottery");
    ...
    /**
     * @notice Set the address for the DasaralloSwapLottery
     * @param _DasaralloSwapLottery: address of the DasaralloSwap lottery
     */
    function setLotteryAddress(address _DasaralloSwapLottery) external onlyOwner {
        DasaralloSwapLottery = _DasaralloSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IDasaralloSwapLottery(DasaralloSwapLottery).viewCurrentLotteryId();
    }
}