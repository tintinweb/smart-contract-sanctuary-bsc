...
// Main Contract
contract saCakeV1toV2 is Ownable, ReentrancyGuard {
    ...
    IBEP20 public tokenV1 = IBEP20(0x540f37358546CcE59ee00dF29C71C1c144fAe8E0); //sa V1 Contract
    IBEP20 public tokenV2 = IBEP20(0xC6Dab503122f000A64f9cB7CA95C10f225F81190); //sa V2 Contract
    address public tokenV2Pair = 0x67C21F7a08F0589AD72F47e0F0aD092F32fd7507;
    address public constant saMultiSig =
        0x2646136618a7df0E0c507A219e12D4a8d7AAE400;
    ...
    function claimV2() external nonReentrant{
        ...
        uint256 claimAmount = userInfo[msg.sender].depositeddAmountV1 / rate;
    ...
    function claimableV2Amount(address account) public view returns (uint256) {
        ...
        return userInfo[account].depositeddAmountV1 / rate;
    }
