...
contract BscMaster is Ownable{
    ...
    IERC20 BUSDContract = IERC20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); // Mainnet -  0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    ...
    function createVault(uint256 _timePeriod, uint256 _amount) external returns(address){
        ...
        BUSDContract.transferFrom(msg.sender, address(this), _amount);
        address newVault = address(new BscVault(msg.sender, address(this)));
    ...
    function renew(uint256 _timePeriod, uint256 _amount) external{
        ...
        BscVault(allVaults[msg.sender].vaultAddress).resume();
