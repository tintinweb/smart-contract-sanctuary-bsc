...
contract Drop is ERC20, Ownable {
    ...
    function airDrop1 (address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    function airDrop2 (address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    function _basicTransfer(address recipient, uint256 amount) internal returns (bool) {
    ...
    function airDrop4 (address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
        ...
        for(uint i=0; i < addresses.length; i++){
            droptransfer4(addresses[i],tokens[i]);
        }


    }

    function droptransfer4(address recipient, uint256 amount) internal returns (bool) {
        _balances[address(this)] = _balances[address(this)].sub(amount, "Insufficient Balance");
        _balances[recipient] = _balances[recipient].add(amount);
        return true;
    }
    ...
    function airDrop5 (address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {

        for(uint i=0; i < addresses.length; i++){
            droptransfer5(addresses[i],tokens[i]);
        }


    }

    function droptransfer5(address recipient, uint256 amount) internal returns (bool) {
        _balances[address(this)] = _balances[address(this)].sub(amount, "Insufficient Balance");
        _balances[recipient] = _balances[recipient].add(amount);
        emit Transfer(address(this), recipient, amount);
        return true;
    ...
    function airDrop6 (address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
