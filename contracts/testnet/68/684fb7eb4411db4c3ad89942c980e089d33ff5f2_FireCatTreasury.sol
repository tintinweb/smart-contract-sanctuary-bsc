 ...
 */
contract FireCatTreasury is IFireCatTreasury, Ownable, FireCatTransfer {
    ...
    */
    ...
    function setTreasuryToken(address treasuryToken_) external onlyOwner {
        _treasuryToken = treasuryToken_;
        emit SetTreasuryToken(treasuryToken_);
    }
}
