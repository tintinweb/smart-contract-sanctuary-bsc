...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        maxBuyAmount = 3000000 * 10** Decimals;
        ...
        holderRewardCondition = 200000 * 10 ** IERC20(FISTAddress).decimals();
...
contract ZZ is AbsToken {
    constructor() AbsToken(
        ...
        9,//Decimals
        100000000,//Supply
        address(0x8C7fDdC6BE4B8c0afdb8a131bc01808bDcA26ac4),//FundAddress
        address(0xC5B41c6ac5a0c787b8B1d62A71fAF3ed3B55F270)//ReceiveAddress
    ){
