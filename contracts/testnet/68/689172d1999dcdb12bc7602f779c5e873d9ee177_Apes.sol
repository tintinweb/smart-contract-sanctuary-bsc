...
// File: contracts/GorillazContract.sol
...
contract Apes is ERC721Enumerable, Ownable {  
    ...
    string public baseTokenURI = "http://164.90.139.77/";
    ...
    constructor () ERC721 ("Gorillaz Evolution", "GORI") {
        price = initial_price;
    }
    ...
    // Set a different price in case BNB changes drastically
