 ...
 */
contract Unitroller_EIP1967 is UnitrollerAdminStorage, ComptrollerErrorReporter {
    ...
    /**
    * @notice Sets new implementation of comptroller. msg.sender must be admin
    * @dev Admin function for setting new implementation
    * @return uint 0=success, otherwise a failure (see ErrorReporter.sol for details)
    */
