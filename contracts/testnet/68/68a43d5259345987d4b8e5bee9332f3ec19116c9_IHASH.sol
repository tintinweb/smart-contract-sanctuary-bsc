...
contract IHASH is ERC20, Ownable {
    ...
    address public marketingWallet = 0x80170474b6d5bc2aC0762CCD174B886b0f659083;
    ...
    constructor() ERC20("Infinite Hashpower", "IHASH") {
    ...
    function _transfer(
        ...
        if(overMinTokenBalance && !inSwap && to==uniswapV2Pair && swapEnabled) {
            ...
            swapTokensForBUSD(contractTokenBalance, marketingWallet);
        }
    ...
    function swapTokensForBUSD(uint256 tokenAmount, address _to) private lockTheSwap {
        ...
        path[2] = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; //0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    ...
    function setFees(uint256 _markFee, uint256 _burnFee) public onlyOwner() {
        require(marketingFee+burnFee <= 1000, "buy tax too high");
