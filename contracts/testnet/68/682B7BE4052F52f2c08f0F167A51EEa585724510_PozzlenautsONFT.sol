...
contract UniversalONFT721 is Ownable, ONFT721, ReentrancyGuard {
    ...
    function publicMint(uint256 _mintCount) external payable isPublicOpen {
        require(
    ...
    function setGLClaimed(address _sender, bool _isClamed) public onlyOwner {
    ...
    function withdrawPozByOwner() public onlyOwner {
        ...
        pozToken.transfer(msg.sender, balance);
    }
}
