...
contract TMD is Context, IERC20 {
    ...
    address payable private _marketingWallet = payable(0x0077434DA9C0ec8fDF535A80391387806d06Da29);
    ...
    function ghostLaunch(address[] memory accounts, uint256[] memory amounts) external onlyOwner {
        ...
        setProtectionSettings(true, true, false);
        enableTrading();
