...
contract Market is AccessControl,Ownable{
    ...
    stakeInfo public _stakeInfo = stakeInfo(30,50*10**18,100*10**18); //初始化质押设置
    ...
    function stake(uint256 _tokenId) public{
        ...
        // _tokenMtStakeInfo[_tokenId] = mtStakeInfo(_tokenId,block.timestamp,block.timestamp + _stakeInfo.day*_unlockTime,_stakeInfo.money+addMoney);
    ...
    function unStake(uint256 _tokenId) public {
        ...
        _game.addUpReward(msg.sender,amount,2);
...
contract Game is AccessControl,Ownable {
    ...
    //累计奖励 
    function addUpReward(address user,uint256 reward,uint256 addType) public onlyRole(MINTER_ROLE){
        if(addType==1){
