...
contract TokenPoolUpgradeable is
    UUPSUpgradeable,
    OwnableUpgradeable,
    PausableUpgradeable,
    EIP712Upgradeable
{
    ...
    function __TokenPool_init() external initializer {
        __Ownable_init();
        __Pausable_init();
        __TokenPool_init_unchained();
    }

    function __TokenPool_init_unchained() internal onlyInitializing {}
