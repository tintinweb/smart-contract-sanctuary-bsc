...
contract FLASH is IERC20 {
    ...
    string constant private _name = "FLASH";
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 staking, uint16 burn) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.totalSwap = liquidity + marketing + staking + burn;
    ...
    function contractSwap(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        if (toLiquify > 0) {
            dexRouter.addLiquidityETH{value: amount}(
                address(this),
                toLiquify,
                0,
                0,
