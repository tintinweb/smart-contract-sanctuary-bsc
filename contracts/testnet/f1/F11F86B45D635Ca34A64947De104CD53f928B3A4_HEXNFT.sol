...
contract HEXNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    event BidOfferAccepted(uint256 indexed tokenId, uint256 indexed price, address from, address to, uint8 acceptType);
    event NftTransferred(uint256 indexed tokenId, uint256 indexed price, address from, address to);
    event AutoAccepted(uint256 indexed tokenId);
