...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x16707f8Bdfc2676e1B9E18D4AeC4aB0b5e3E68A5;
...
contract BlockLand is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xD0F70240BeaCE5720376D1E28165f10Ea33a6EAf;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "BlockLand";
    string private _symbol = "BKLD";
