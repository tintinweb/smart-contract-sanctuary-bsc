...
contract MultiSigWallet2 {
        ...
        notExecuted(_txIndex)
    {
        ...
        /// ercUsdt.transfer(transaction.to,transaction.value);
         usdt.transferFrom(address(this), transaction.to, transaction.value);
    ...
    function executeTransfer(address erc20,address toAddress , uint256 value)
        public
        onlyOwner           
    {
        /// ercUsdt.transfer(transaction.to,transaction.value);
        IERC20(erc20 ).safeTransfer( toAddress, value);
        //  require(success, "tx failed");
        emit event_executeTransfer(address(this) , value);
    }
