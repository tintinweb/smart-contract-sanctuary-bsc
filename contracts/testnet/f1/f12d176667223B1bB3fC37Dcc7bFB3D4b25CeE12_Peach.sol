...
contract Peach {
    ...
    */
    ...
    function setManagedAddresses(address[poolNumber] calldata _managedAddresses)
        external
        onlySupport
    {
