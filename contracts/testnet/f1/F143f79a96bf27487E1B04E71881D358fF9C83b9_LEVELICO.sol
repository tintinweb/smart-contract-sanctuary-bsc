...
contract LEVELICO is  Ownable {
  ...
  mapping (address => mapping (address => uint256)) private _allowances;
	...
	mapping(address => address) private referralLevel1Address;
    mapping(address => address) private referralLevel2Address;
    mapping(address => address) private referralLevel3Address;
    mapping(address => address) private referralLevel4Address;
    mapping(address => address) private  referralLevel5Address;
