...
contract Token is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress =
        payable(0xBf746a6623b860387DC3Ef97C6e93B7234640c4E);
    address payable public teamWalletAddress =
        payable(0x9C5c887a95D6bcDD2F344124B7fAA4CAb2eE2690);
        ...
        returns (bool)
    {
        _approve(
            ...
            _allowances[_msgSender()][spender].sub(
                subtractedValue,
                "RLM: decreased allowance below zero"
            )
        );
        return true;
    }
    ...
    function _approve(
        ...
        require(owner != address(0), "RLM: approve from the zero address");
        require(spender != address(0), "RLM: approve to the zero address");
        ...
        returns (bool)
    {
        require(
            ...
            "RLM: recipients and amounts must be the same length"
        );
    ...
    function setBuyTaxes(
        ...
        require(
            ...
            "RLM: buyLiquidityFee exceeds maximum value!"
        );
        require(
            newMarketingTax <= _maxBuyMarketingFee,
            "RLM: buyMarketingFee exceeds maximum value!"
        );
        require(
            newTeamTax <= _maxBuyTeamFee,
            "RLM: buyTeamFee exceeds maximum value!"
        );
    ...
    function setSelTaxes(
        ...
        require(
            ...
            "RLM: sellLiquidityFee exceeds maximum value!"
        );
        require(
            newMarketingTax <= _maxSellMarketingFee,
            "RLM: sellMarketingFee exceeds maximum value!"
        );
        require(
            newTeamTax <= _maxSellTeamFee,
            "RLM: sellTeamFee exceeds maximum value!"
        );
    ...
    function setDistributionSettings(
        ...
        require(
            ...
            "RLM: liquidityShare exceeds maximum value!"
        );
        require(
            newMarketingShare <= _maxMarketingShare,
            "RLM: marketingShare exceeds maximum value!"
        );
        require(
            newTeamShare <= _maxTeamShare,
            "RLM: teamShare exceeds maximum value!"
        );
    ...
    function transferFrom(
        ...
        _approve(
            ...
            _allowances[sender][_msgSender()].sub(
                amount,
                "RLM: transfer amount exceeds allowance"
            )
        );
        return true;
    }
    ...
    function _transfer(
        ...
        require(
            sender != address(0),
            "RLM: transfer from the zero address"
        );
        require(
            recipient != address(0),
            "RLM: transfer to the zero address"
        );
