 ...
 * @dev Ensures exchange of mystery box for a random character token
 */

contract MysteryBoxReveal is AccessControlUpgradeable, ERC1155HolderUpgradeable {
    ...
    mapping(uint8 => Character) characters;

    event RevealMysteryBox(address owner, uint256 boxTokenId, uint256 characterTokenId);
    ...
    function initialize(address _collection) public initializer {
        ...
        characters[1].kind = collection.IGNIS_CLASSIC_COMMON();
        characters[2].kind = collection.PENNA_CLASSIC_COMMON();
        characters[3].kind = collection.ORO_CLASSIC_COMMON();
        characters[4].kind = collection.IGNIS_CLASSIC_RARE();
        characters[5].kind = collection.PENNA_CLASSIC_RARE();
        characters[6].kind = collection.ORO_CLASSIC_RARE();
        characters[7].kind = collection.IGNIS_CLASSIC_MYTHICAL();
        characters[8].kind = collection.PENNA_CLASSIC_MYTHICAL();
        characters[9].kind = collection.ORO_CLASSIC_MYTHICAL();
        characters[10].kind = collection.IGNIS_EPIC_COMMON();
        characters[11].kind = collection.PENNA_EPIC_COMMON();
        characters[12].kind = collection.ORO_EPIC_COMMON();
        characters[13].kind = collection.IGNIS_EPIC_RARE();
        characters[14].kind = collection.PENNA_EPIC_RARE();
        characters[15].kind = collection.ORO_EPIC_RARE();
        characters[16].kind = collection.IGNIS_EPIC_MYTHICAL();
        characters[17].kind = collection.PENNA_EPIC_MYTHICAL();
        characters[18].kind = collection.ORO_EPIC_MYTHICAL();
        characters[19].kind = collection.IGNIS_LEGENDARY_COMMON();
        characters[20].kind = collection.PENNA_LEGENDARY_COMMON();
        characters[21].kind = collection.ORO_LEGENDARY_COMMON();
        characters[22].kind = collection.IGNIS_LEGENDARY_RARE();
        characters[23].kind = collection.PENNA_LEGENDARY_RARE();
        characters[24].kind = collection.ORO_LEGENDARY_RARE();
        characters[25].kind = collection.IGNIS_LEGENDARY_MYTHICAL();
        characters[26].kind = collection.PENNA_LEGENDARY_MYTHICAL();
        characters[27].kind = collection.ORO_LEGENDARY_MYTHICAL();

        characters[1].remaining = 7500;
        characters[2].remaining = 7500;
        characters[3].remaining = 7500;
        characters[4].remaining = 2500;
        characters[5].remaining = 2500;
        characters[6].remaining = 2500;
        characters[7].remaining = 1000;
        characters[8].remaining = 1000;
        characters[9].remaining = 1000;
        characters[10].remaining = 250;
        characters[11].remaining = 250;
        characters[12].remaining = 250;
        characters[13].remaining = 175;
        characters[14].remaining = 175;
        characters[15].remaining = 175;
        characters[16].remaining = 125;
        characters[17].remaining = 125;
        characters[18].remaining = 125;
        characters[19].remaining = 100;
        characters[20].remaining = 100;
        characters[21].remaining = 100;
        characters[22].remaining = 50;
        characters[23].remaining = 50;
        characters[24].remaining = 50;
        characters[25].remaining = 25;
        characters[26].remaining = 25;
        characters[27].remaining = 25;
    ...
    function revealMysteryBox(uint256 boxTokenId) external {
        uint256 boxKind = collection.MYSTERY_BOX_KIND();
        require(collection.getKind(boxTokenId) == boxKind, "Incorrect mystery box token id");
        uint256 characterTokenId = _getRandomCharacter();
        collection.safeTransferFrom(msg.sender, address(this), boxTokenId, 1, "");
        collection.burn(address(this), boxTokenId, 1);
        collection.mint(msg.sender, characterTokenId, 1);

        emit RevealMysteryBox(msg.sender, boxTokenId, characterTokenId);
    }
    ...
    function _getRandomCharacter() internal returns (uint256) {
        ...
        uint256 characterKind;
        uint8 characterKindInt;
        uint256 characterId;
        uint256 randomCharacterInt = randomInt % 35175;

        if (randomCharacterInt < 7500) {
            characterKindInt = 1;
        } else if (randomCharacterInt < 15000) {
            characterKindInt = 2;
        } else if (randomCharacterInt < 22500) {
            characterKindInt = 3;
        } else if (randomCharacterInt < 25000) {
            characterKindInt = 4;
        } else if (randomCharacterInt < 27500) {
            characterKindInt = 5;
        } else if (randomCharacterInt < 30000) {
            characterKindInt = 6;
        } else if (randomCharacterInt < 31000) {
            characterKindInt = 7;
        } else if (randomCharacterInt < 32000) {
            characterKindInt = 8;
        } else if (randomCharacterInt < 33000) {
            characterKindInt = 9;
        } else if (randomCharacterInt < 33250) {
            characterKindInt = 10;
        } else if (randomCharacterInt < 33500) {
            characterKindInt = 11;
        } else if (randomCharacterInt < 33750) {
            characterKindInt = 12;
        } else if (randomCharacterInt < 33925) {
            characterKindInt = 13;
        } else if (randomCharacterInt < 34100) {
            characterKindInt = 14;
        } else if (randomCharacterInt < 34275) {
            characterKindInt = 15;
        } else if (randomCharacterInt < 34400) {
            characterKindInt = 16;
        } else if (randomCharacterInt < 34525) {
            characterKindInt = 17;
        } else if (randomCharacterInt < 34650) {
            characterKindInt = 18;
        } else if (randomCharacterInt < 34750) {
            characterKindInt = 19;
        } else if (randomCharacterInt < 34850) {
            characterKindInt = 20;
        } else if (randomCharacterInt < 34950) {
            characterKindInt = 21;
        } else if (randomCharacterInt < 35000) {
            characterKindInt = 22;
        } else if (randomCharacterInt < 35050) {
            characterKindInt = 23;
        } else if (randomCharacterInt < 35100) {
            characterKindInt = 24;
        } else if (randomCharacterInt < 35125) {
            characterKindInt = 25;
        } else if (randomCharacterInt < 35150) {
            characterKindInt = 26;
        } else {
            characterKindInt = 27;
        }

        while (!(characters[characterKindInt].remaining > 0)) {
            if (characterKindInt != 27) {
                characterKindInt += 1;
            } else {
                characterKindInt = 1;
            }
        ...
        characterKind = characters[characterKindInt].kind;

        uint256 currentIdInt = characters[characterKindInt].currentId;

        characterId = ((characterKind << 16) | (currentIdInt));

        while (collection.exists(characterId)) {
            characterId += 1;
            characters[characterKindInt].currentId += 1;
        }
        characters[characterKindInt].currentId += 1;
        characters[characterKindInt].remaining -= 1;
