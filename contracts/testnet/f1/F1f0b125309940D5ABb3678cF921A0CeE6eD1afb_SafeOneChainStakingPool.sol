...
contract SafeOneChainStakingPool {
    ...
    IWETH public immutable WBNB = IWETH(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd); // mainnet: 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
   ...
   /* ========== MUTATIVE FUNCTIONS ========== */
    ...
    function claimRewards() public updateReward(msg.sender) {
        ...
        if (rewards > 0) {
            ...
            if(rewardToken == IERC20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd)) {
