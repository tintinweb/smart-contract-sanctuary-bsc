...
contract AnimatedPunkzCoin is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "AnimatedPunkzCoin"; // token name
    string private _symbol = "APC"; // token symbol
    ...
    uint256 public _buyBackFee = 0; // buyback fee 0%
    ...
    uint256 public _minTokensSwapToAndTransferTo = 21000 * 10**_decimals; // min token liquidity fee collected before swapandLiquify
