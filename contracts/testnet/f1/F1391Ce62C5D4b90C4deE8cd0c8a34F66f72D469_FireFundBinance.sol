...
contract FireFundBinance{
    ...
    constructor() {
        ...
        PercsKey[15] = DivPercs(4320000, 15); /* 15 percent */
        ...
        USDC = IERC20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); // BUSD Testnet now, USDC is 0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174
    ...
    function withdrawInitial(uint256 keyy) public {
        ...
        if (currDays < FeesKey[10].daysInSeconds){ // LESS THAN 10 DAYS STAKED
            ...
            uint256 minusAmt = initialAmt.mul(FeesKey[30].feePercentage).div(percentdiv); //6% fee
    ...
    function stakeRefBonus() public { 
        ...
        user.keyCounter += 1;
        main.ovrTotalDeps += 1;
        main.ovrTotalStaked += refferalAmount;
    }
