...
contract proofTokenFactory is Ownable {
    ...
    constructor(address initialRouterAddress, uint256 initialBurnThreshold, address initialLockerAddress) {
    ...
    function createToken(string memory tokenName, string memory tokenSymbol, uint256 initialSupply, 
        ...
        TokenCutter newToken = new TokenCutter(tokenName, tokenSymbol, initialSupply, msg.sender, operationsWallet, mainWallet, routerAddress, hldAdmin, fees);
