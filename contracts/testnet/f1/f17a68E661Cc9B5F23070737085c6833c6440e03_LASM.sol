...
contract LASM is ERC20, ERC20Burnable, Ownable {
    ...
    address public manager = address(0x2C4C168A2fE4CaB8E32d1B2A119d4Aa8BdA377e7);
    address public teamDevWalletAddress = address(0x8FC030140EaBf1925C3aeF67ee4F5D1DcB123E15);

    // vesting wallets
    address public constant locked = address(0x2FA55Dbd664e801f43503E056A011aD3fE18bE6a);
    address public constant team = address(0x2FA55Dbd664e801f43503E056A011aD3fE18bE6a);
    address public constant partners = address(0x4aE7bC8f0e865ee8795E94e58C3aD74456374bfD);
    address public constant marketing = address(0x53C4fc1C5a07dfc5aCF040ccaD128f62f3b7af26);
    address public constant development = address(0x53C4fc1C5a07dfc5aCF040ccaD128f62f3b7af26);
    address public constant stakingRewards = address(0x3d08E83e16Fe8B5EEb85EBF7fc6343Af26e00705);
    ...
    constructor(address _vestingContract) ERC20("LASM", "LASM") {
...
//      IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    function _transfer(
        ...
        if( canSwap &&
            ...
            sendToTeamDevFee(teamDevTokens);
     ...
     */ 
    function sendToTeamDevFee(uint256 tokens) private  {
        super._transfer(address(this), teamDevWalletAddress, tokens);
    }
