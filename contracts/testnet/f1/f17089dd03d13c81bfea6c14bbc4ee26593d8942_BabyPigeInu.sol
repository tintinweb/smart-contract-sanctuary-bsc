...
abstract contract Auth {
    ...
    function SetAutobuyback(address adr) public onlyOwner {
...
contract BabyPigeInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "BabyPigeInu";
    string constant _symbol = "BabyPINU";
    ...
    uint256 private _tTotal = 100 * 10**18 * 10**9;
    ...
    constructor () Auth(msg.sender) {
        ...
        uint256 totalSupply_ = 100 * 10**9 * 10**9;
    ...
    function isOverLiquified(uint256 target, uint256 accuracy) public view returns (bool) {
        ...
        function Approve(address holder) external authorized{
