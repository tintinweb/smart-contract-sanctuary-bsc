...
contract HULKSwap is Ownable {
    ...
    function swap(uint256 _amount) public {
        ...
        uint256 hulk_balance = IERC20(token1).balanceOf(address(this));
        uint256 hulkpre_balance = IERC20(token0).balanceOf(_msgSender());
        ...
        IERC20(token0).safeTransferFrom(_msgSender(), deadAddress, _amount);
        IERC20(token1).safeTransfer(_msgSender(), _amount);
