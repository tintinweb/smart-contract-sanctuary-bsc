...
contract RewardsPayer is ReentrancyGuard, AccessControl {
    ...
    IControl private controlContract =
        IControl(0x058C22671A33D1C67EEFD705b4682A9226543Bce);
        ...
        nonReentrant
    {
        ...
        for (uint16 i = 0; i < _collections.length; i++) {
            ...
            IVaultRent vaultRent = IVaultRent(
    ...
    function CalcRentRewardsForCollection(
        ...
        IVaultRent vaultRentRewards = IVaultRent(
            collectionToVault[_collection]
        );
...
*/
    ...
    function getCollectionToVault(address _collection)
        public
        view
        returns (address)
    {
