 ...
 * behavior.
 */
contract CryptoSprintCrowdSale is ReentrancyGuard, OwnerContract {
    using SafeMath for uint256;
...
contract CryptoSprintPresale is CryptoSprintCrowdSale {
    constructor (
        uint256 rate,
        ...
        public
        CryptoSprintCrowdSale(rate, wallet, token)
    {
    }
}