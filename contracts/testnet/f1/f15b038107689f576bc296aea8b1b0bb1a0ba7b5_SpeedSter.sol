...
contract SpeedSter is ISpeedSter, Initializable, ContextUpgradeable, OwnableUpgradeable {
    ...
    function __SpeedSter_tiers_init() internal initializer {
        _defaultFees = _addTier(100, 200, 300, 200, 200, address(0), address(0)); 
    ...
    //AntiBot
    function setAntiBot(address antiBot_) external onlyOwner() {
     ...
     // Use this function to control whether to use AntiBot or not instead
    // of managing this in the AntiBot contract
    ...
    isRouter(_msgSender())
    {
        ...
        // Only use AntiBot if this state is true
        if (antiBotEnabled) {
