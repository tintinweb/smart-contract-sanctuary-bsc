...
import "./v0.6/LinkTokenReceiver.sol";
import "./v0.6/interfaces/ChainlinkRequestInterface.sol";
import "./v0.6/interfaces/OracleInterface.sol";
import "./v0.6/interfaces/LinkTokenInterface.sol";
import "./v0.6/interfaces/WithdrawalInterface.sol";
import "./v0.6/vendor/Ownable.sol";
import "./v0.6/vendor/SafeMathChainlink.sol";

/**
 * @title The Chainlink Oracle contract
 * @notice Node operators can deploy this contract to fulfill requests sent to them
 */
contract EconOracle is ChainlinkRequestInterface, OracleInterface, Ownable, LinkTokenReceiver, WithdrawalInterface {
     ...
     */
    constructor(address _link, address _node) public Ownable() {
    ...
    function fulfillOracleRequest(
        ...
        (bool success, ) = _callbackAddress.call(abi.encode(_data)); // solhint-disable-line avoid-low-level-calls
        return success;
    }
