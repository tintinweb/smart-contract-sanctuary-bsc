...
interface ICrossChainManagerRemote {    
	function buyToken(bytes calldata, bytes calldata, uint256) external payable;
...
contract GovSaleRemote is
    ...
    function buyToken(uint128 _amountIn) external payable whenNotPaused nonReentrant {
        ...
        ICrossChainManagerRemote(factory.crossChainManagerRemote()).buyToken{value: feeNeeded}(getPayload(_amountIn, sender), getAdapterParams(), tax);
    }
