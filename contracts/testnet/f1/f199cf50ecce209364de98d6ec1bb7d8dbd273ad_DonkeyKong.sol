...
contract DonkeyKong is Context, IBEP20, Ownable {
    ...
    uint256 public maxWallet = _tTotal * 1 / 95; // 1.5% Max wallet;
    uint256 public maxTransactionAmount = _tTotal * 10 / 100;// 10% maxTransactionAmount
    ...
    uint[] public _percentages = [20,20,20,20,20,0,0,0,0,0];                             // % of liquidity fee split to wallet(s)
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0x542F304F77C710F25d261fA8dF9E167b0bFc1aCF),                             // Team Member Wallet 1
        payable(0x542F304F77C710F25d261fA8dF9E167b0bFc1aCF),                             // Team Member Wallet 2
        payable(0x542F304F77C710F25d261fA8dF9E167b0bFc1aCF),                             // Team Member Wallet 3
    ...
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum > (totalSupply() * 1 / 95)/1e9, "Cannot set maxWallet lower than 1%");
...
//when buy
     ...
     if (uniswapV2Pair == from && !_isExcludedMaxTransactionAmount[to]) {
      ...
      //when sell
        else if (uniswapV2Pair== to && !_isExcludedMaxTransactionAmount[to] ) {
