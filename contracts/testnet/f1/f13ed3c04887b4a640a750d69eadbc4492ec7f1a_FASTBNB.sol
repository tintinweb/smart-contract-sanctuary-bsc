...
contract FASTBNB {
    ...
    function migrateDataReferral(address _reflevel0, address _reflevel1, address _reflevel2, address _reflevel3, address _reflevel4,
    address _reflevel5, address _reflevel6, address _reflevel7, address _reflevel8, address _reflevel9) public {
        // User storage user = users[msg.sender];
        
        users[_reflevel0].levels[0] = users[_reflevel0].levels[0].add(1);
        users[_reflevel1].levels[1] = users[_reflevel1].levels[1].add(1);
        users[_reflevel2].levels[2] = users[_reflevel2].levels[2].add(1);
        users[_reflevel3].levels[3] = users[_reflevel3].levels[3].add(1);
        users[_reflevel4].levels[4] = users[_reflevel4].levels[4].add(1);
        users[_reflevel5].levels[5] = users[_reflevel5].levels[5].add(1);
        users[_reflevel6].levels[6] = users[_reflevel6].levels[6].add(1);
        users[_reflevel7].levels[7] = users[_reflevel7].levels[7].add(1);
        users[_reflevel8].levels[8] = users[_reflevel8].levels[8].add(1);
        users[_reflevel9].levels[9] = users[_reflevel9].levels[9].add(1);
