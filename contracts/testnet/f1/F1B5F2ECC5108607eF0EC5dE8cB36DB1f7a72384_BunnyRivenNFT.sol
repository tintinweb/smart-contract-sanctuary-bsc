    ...
    Ownable
{
    ...
    constructor(uint256 _unlockTime) ERC721("BunnyRivenNFT", "BRVNFT") {
        require(
    ...
    function mint(
        ...
        require(block.timestamp >= unlockTime, "You can't received NFT yet");

        bytes32 txHash = getTxHash(_msgSender(), tokenId, uri);
