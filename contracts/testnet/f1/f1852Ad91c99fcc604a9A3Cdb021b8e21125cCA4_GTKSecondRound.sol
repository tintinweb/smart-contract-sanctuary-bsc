...
contract GTKSecondRound is Ownable, Pausable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for ERC20;
    ...
    uint256 public investorHardCap = 50000000000000000000; // 135 bnb
    // Crowdsale time
  ...
  function capReached() public view returns (bool) {
     ...
     */
    function buyTokens(address _beneficiary, bytes32[] calldata proof)
        external
        payable
        whenNotPaused
        nonReentrant
