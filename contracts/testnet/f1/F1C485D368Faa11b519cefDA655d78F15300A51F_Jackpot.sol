...
event tikectBuyInfo(uint256 bnbprice, uint256 bnbamountLog, uint256 ticketAMount, uint256 tAmount, uint256 tAmountDec);
function _tokenTransfer(
    ...
    //   emit isbuy(isBuy);
uint256 tAmountDec = tAmount/(10**18);
    if (!takeFee) {
      ...
      emit tikectBuyInfo(tokenBNBprice, bnbAmount[recipient], ticketAmount,  tAmount, tAmountDec);
