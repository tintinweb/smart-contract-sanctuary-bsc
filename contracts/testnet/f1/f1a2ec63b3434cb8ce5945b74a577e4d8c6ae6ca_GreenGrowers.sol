...
contract GreenGrowers is Ownable, ERC721, ERC721Enumerable {
    ...
    function _actualMintPrice() public view returns (uint) {
        return 110000000000000000; // 0.11 BNB
    }
   ...
   function teamPayout() public onlyOwner {
        uint p = _balanceTeam;
        payable(0xCa82d4565D9C173B5E90c8D7901AE20Ec5a5159b).transfer((p*7500)/10000);
        payable(0xB80C9CdE1B7867490ab64A41c482C50DA2701fBc).transfer((p*2500)/10000);
        _balanceTeam = 0;
    }
