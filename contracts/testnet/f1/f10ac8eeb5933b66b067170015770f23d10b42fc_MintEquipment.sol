...
contract MintEquipment is TransferOwnable {
    ...
    function mint() public  returns (uint256, uint256, uint256, uint256)  {
        ...
        uint256 model = randomize(0, model_count * block.timestamp) % model_count;
        ...
        if(number2 <= 43){
            ...
            //0 - 43
            capacity = randomize(200, 801);

        }else if(number2 <= 78){
            
            //44 - 78
            value = 2;
            capacity = randomize(500, 1000);

        }else if(number2 <= 93){
            
            //79 - 93
            value = 3;
            capacity = randomize(850, 1501);

        }else if(number2 <= 98){
            
            //94 - 98
            value = 4;
            capacity = randomize(1550, 1751);

        }else{

            //99
            value = 5;
            capacity = randomize(1750, 2501);
