...
contract WORK is ERC721Holder,Ownable{
    ...
    IERC721 public nftContract = IERC721(0x1a6A4E51EE50897aA3C106F9065504FCEe0F36c1);
	...
	constructor() {
		...
		_setPledgeMap(2, 12*30*86400, 2625*10**17 / monForSec);
		_setPledgeMap(3, 14*30*86400, 3500*10**18 / monForSec);
		_setPledgeMap(4, 16*30*86400, 52500*10**18 / monForSec);
	...
	function setPledgeMap(uint256 _typeId, uint256 _cycle, uint256 _output)public onlyOwner{
		_setPledgeMap(_typeId,_cycle,_output);
	
	}
	
	
	function _setPledgeMap(uint256 _typeId, uint256 _cycle, uint256 _output)internal{
