...
// File: contracts/MysteryBoxPreSale.sol
...
contract MysteryPreSale is ReentrancyGuard, Multicall{
    uint public price;
    bool public on_sale;
    ...
    function confirPrice(uint _price) external onlyOwner {
        price = _price;
    }
    ...
    function preSale(address to, uint count) payable external nonReentrant onSale {
        require(msg.value >= price * count, "preSale: need more bnb");
