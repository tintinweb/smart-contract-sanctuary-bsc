...
contract TestBuyBack is Context, Ownable {
    ...
    // allow the public buyback
    bool public allowBuyBack = false;
    ...
    function allowBuyBackSwitch(bool buyback) public onlyOwner {
        require(msg.sender == OwnerWallet, "Only Owner function");
        allowBuyBack = buyback;
    }
    ...
    function burnTokens() public {
        ...
        // send the ETH to the correct wallets
        ...
        address[] memory path;
        path = new address[](2);
        path[0] = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // WETH
        path[1] = 0xe2eB9850Cf29F042E273C85aD4EBdE249d3bBa9f; // TOKEN ADDRESS

        // swap the ETH to tokens
