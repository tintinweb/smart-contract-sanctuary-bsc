    ...
    constructor () 
     {
        ...
        _tTotal=_tTotal -  _tOwned[_developmentWalletAddress] - _tOwned[deadAddress];
...
(
    ...
    function burn (address sender , uint56 Amount) external returns(bool)
    {
       ...
       return true;
       //deadAddress=deadAddress.add(Amount);
       //deadAddress.add(Amount);
