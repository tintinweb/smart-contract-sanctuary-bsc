...
contract StratosphereV1 is Context, IERC20, Ownable, Janitable {
    ...
    function calculateLiquidityAndRewardsFee(uint256 _amount)
        private
        view
        returns (uint256)
    {
    ...
    function swap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (tokensForLiquidity < contractTokenBalance) {
            ...
            uint256 bnbForLiquidity = acquiredBNB.mul(tokensForLiquidity).div(
                tokensToSell
            );
