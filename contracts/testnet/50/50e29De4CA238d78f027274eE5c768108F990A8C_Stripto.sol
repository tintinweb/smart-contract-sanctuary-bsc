...
contract Stripto is ERC20, Ownable {
    ...
    constructor() ERC20("STRIPTO", "$STRIPTEST") {
        
        address newOwner = msg.sender; // can leave alone if owner is deployer.
        
        //IDexRouter _uniswapV2Router = IDexRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //Mainnet address
        IDexRouter _uniswapV2Router = IDexRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //Testnet Uniswap address
