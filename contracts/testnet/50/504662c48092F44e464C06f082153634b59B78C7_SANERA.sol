...
contract SANERA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Sanera";
    string private _symbol = "$SAN";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xf1aDd7A2D3957089e9F80850310c0F6EF52c5576);
    address payable public teamWalletAddress = payable(0xf1aDd7A2D3957089e9F80850310c0F6EF52c5576);
