...
contract Farm is Ownable {
    ...
    function initialize() external virtual {
        ...
        setFarmToken(IERC20(0x943a0D36AC29949F23de1dCa8B7E92d60fB4e3F2));
        setVaultAddress(0x2952239aB3E23B844c52ce941a40EFD64c32A8Cc);
        addAdmin(_msgSender());
    }
     ...
     */
    function setFarmToken(IERC20 _farmToken) public onlyWhenServiceEnabled onlyOwner {
     ...
     * NOTE: Can only be called by the current owner.
     */
    function setVaultAddress(address _address) public onlyWhenServiceEnabled onlyOwner {
    ...
    function addPair(
        ...
        pairs[_id] = Pair(_name, _isActive, IERC20(_contractAddress), _TVL, _APY, _maxPoolAmount, _farmServiceId);
        pairsCount++;
