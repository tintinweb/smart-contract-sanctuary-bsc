...
contract Token is ERC20, Ownable {
    ...
    event CharityTriggered(uint256 amount);
    ...
    constructor() ERC20("Advanced Health Bitcoin", "AHBTC") {
        ...
        uint256 totalSupply = 153770 * (10**_decimals);
        ...
        marketingWallet = address(0xCFb33f291D271b858FF0a236a030103964AEfCF2); // set as marketing wallet
    	devWallet = address(0x27B159F2D2C62500072Edd4799E824Bd4548e087); // set as dev wallet
    	charityWallet = address(0x99a82e54Cd284e34469992f25e2D3E134684DA47); // set as charityWallet
    ...
    function swapBack() private {
        ...
        uint256 amountToSwapForETH = contractBalance.sub(liquidityTokens).sub(devTokens);
