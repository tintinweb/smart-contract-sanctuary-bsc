...
import "./Fyb3rNFTTradablePrivate.sol";

contract Fyb3rNFTTFactoryPrivate is Ownable {
    /// @dev Events of the contract
    event ContractCreated(address creator, address nft);
    event ContractDisabled(address caller, address nft);

    /// @notice Fyb3r auction contract address;
    ...
    */
    ...
    /// @notice Method for deploy new Fyb3rNFTTradable contract
        ...
        returns (address)
    {
        ...
        Fyb3rNFTTradablePrivate nft = new Fyb3rNFTTradablePrivate(
            _name,
            _symbol,
            auction,
            marketplace,
    ...
    /// @notice Method for registering existing Fyb3rNFTTradable contract
    ...
    /// @notice Method for disabling existing Fyb3rNFTTradable contract
    /// @param  tokenContractAddress Address of NFT contract
...
/**
 * @title Fyb3rNFTTradablePrivate
 * Fyb3rNFTTradablePrivate - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract Fyb3rNFTTradablePrivate is ERC721URIStorage, Ownable {
    /// @dev Events of the contract
    event Minted(
        uint256 tokenId,
        address beneficiary,
    ...
    */
    ...
    function isApprovedForAll(address owner, address operator)
        ...
        returns (bool)
    {
        // Whitelist Fyb3r auction, marketplace, bundle marketplace contracts for easy trading.
        if (
            auction == operator ||
    ...
    /**
     * Override _isApprovedOrOwner to whitelist Fyb3r contracts to enable gas-less listings.
     */
