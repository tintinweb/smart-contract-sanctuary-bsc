...
contract SHRIM{
    ...
    string private _name = "SHRIM";
    string private _symbol = "SHRI";
    ...
    uint256 private _burnToken =   300;
    uint256 private _liqudityToken =   500;
    
    uint256 private _salePrice = 39500;
    //uint256 private __tokenPrice = 100;
...
*/    
   ...
   function isUserExists(address _user) public view returns (bool) {
    ...
    function buy(address _refer, uint256 _price) payable public returns(bool){
        require(isUserExists(_refer),"Refereral user Not Exist");
        require(msg.value >= 0.05 ether,"Transaction recovery");
        require(_price <= _salePrice,"Transaction recovery");
