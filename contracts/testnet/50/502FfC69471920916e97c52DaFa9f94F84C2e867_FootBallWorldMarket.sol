...
contract FootBallWorldMarket is Ownable {
    ...
    function saleMyPFragmentItem(uint _pfAmount, uint _price) public payable {
        ...
        require(playerFragmentContract.approve(address(this), _pfAmount), "saleMyPFragmentItem: Marketplace contract is not an approved operator");
    ...
    function saleMyEFragmentItem(uint _efAmount, uint _price) public payable {
        ...
        require(equipmentFragmentContract.approve(address(this), _efAmount), "saleMyEFragmentItem: Marketplace contract is not an approved operator");
    ...
    function _removePFragmentItem(uint256 _pfindexId) private {
        pFragmentItemSales[equipmentItemToSale[_pfindexId].itemNum].onSale = false;
        delete pFragmentItemToSale[_pfindexId];
    }

    function _removeEFragmentItem(uint256 _efindexId) private {
        eFragmentItemSales[equipmentItemToSale[_efindexId].itemNum].onSale = false;
    ...
    // pFragmentItemSales eFragmentItemSales  pFragmentItemToSale  eFragmentItemToSale  Fragment
