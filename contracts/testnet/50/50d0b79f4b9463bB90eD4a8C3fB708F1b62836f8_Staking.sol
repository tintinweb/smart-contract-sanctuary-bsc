...
contract Staking is AccessControl {
    ...
    uint256 public minAmountToEnableBuyDexo = 10 ether;
    ...
    constructor(){
        ...
        DEXO = IERC20(0x38927F2e3A10fF85b39550A7b1d2C5BF0D1CdeC1);
        oneXD = IERC20(0x31e0eFC6Bfea5060439f383aA57B4Cd405dB78B2);
    ...
    function stake(uint256 amount, address _address, uint256 tokenId) public stakingStarted {
        ...
        if (tokenId == 1) {
            ...
            require(amount >= minAmountToStakeWithDexo, 'Insufficient Stake Amount');
            token = DEXO;
        }
        else {
