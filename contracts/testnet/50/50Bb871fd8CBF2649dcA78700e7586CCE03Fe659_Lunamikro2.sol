...
contract Lunamikro2 is Context, IERC20, Ownable {
    ...
    string private constant _name = "Luna Mikro2";
    string private constant _symbol = "LUNAMIKRO2";
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
	    ...
	    require(redisFeeOnSell < 6, "Redis cannot be more than 99.");
	    require(taxFeeOnBuy < 0, "Tax cannot be more than 5.");
	    require(taxFeeOnSell < 0, "Tax cannot be more than 8.");
