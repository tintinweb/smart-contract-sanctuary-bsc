...
contract Star is Token {
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                 
        DEV_2 = 0xfD27cdd0039167822454C6c267bB27DC3325b41B;  // P
        DEV_3 = 0xef8B63B28f81BFc189D5e353C008E2B698779000;  // P
        DEV_4 = 0x9E7c0403432e25d6DFA2698c41E1D9cA281eAe11;  // D         
