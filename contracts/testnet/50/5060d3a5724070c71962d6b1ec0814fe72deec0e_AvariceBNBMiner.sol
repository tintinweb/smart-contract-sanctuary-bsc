...
contract AvariceBNBMiner {
    ...
    uint256 public COMPOUND_STEP = 5 minutes; /** 24 Hours Compound Timer **/
    ...
    function getAVCForLevelsList() public view returns (uint256[8] memory) {
        ...
        uint256 AVCPerBNB = previousAVCAmount.div(previousBNBAmount);
        return [
            AVCPerBNB.div(10),
            AVCPerBNB.div(4),
            AVCPerBNB.div(2),
