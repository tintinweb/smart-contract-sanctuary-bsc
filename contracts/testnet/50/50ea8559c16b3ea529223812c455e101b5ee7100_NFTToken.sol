...
// File: contracts/nft-token/INFTToken.sol
...
// File: contracts/nft-token/NFTToken.sol
...
contract NFTToken is ERC721URIStorage, INFTToken {
    ...
    modifier onlyControllers() {
        require(controller == msg.sender, "ERC721: Only controllers");
        _;
    }
    ...
    */
    function transferController(address _newController) external override {
    ...
    function burn (uint256 _tokenId) external onlyControllers override {
    ...
    function setBaseURI(string memory _uri) external onlyControllers override {
        baseURI = _uri;
    }
}