...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    uint256 public min;
    uint256 public minBuy = 0.01 ether; // 215 ether;
    uint256 public maxBuy = 0.05 ether; // 430 ether;
    uint256 public price_0 = 0.0035 ether; 
    uint256 public price_1 = 0.0040 ether;
    uint256 public price_2 = 0.0045 ether;
    ...
    uint256 public buyTime = block.timestamp + 20 minutes; //15 days * 1 seconds; //+ 15 days
    
    constructor (uint256 lockTime, uint8 price_type, address payable wallet_, 
        IERC20 token_, address payable manager_, uint256 _min) {
   ...
   function buyTokens() public payable nonReentrant {
        ...
        require(msg.value >=minBuy && msg.value <=maxBuy,"buy amount wrong range");

        uint256 tokens =  msg.value / sale_price;
    ...
    function claim() public nonReentrant {
        ...
        uint256 tokenAmount = purchase[_msgSender()];  
    ...
    function finalize() public returns(bool) {
        ...
        (bool successTransfer, ) = _wallet.call{value: _weiRaised}("");
