            ...
            GovernorTimelockControl
{
    ...
    /*
     * Params
     * ERC20Votes _token - Address of EARLY. EARLY balance is the voting power of a user
     * TimelockController _timelock - TimelockController contract address
     * uint256 proposalThreshold - Minimum amount of EARLY balance, required to submit proposals
     */
    constructor(ERC20Votes _token, TimelockController _timelock, uint256 proposalThreshold)
    Governor("EarlyGovernor")
    ...
    /*
     * Sets new value for proposal threshold
     */
    function setProposalThreshold(uint256 amount) external {
        require(msg.sender == timelock(), 'Set only by voting');
            _proposalThreshold = amount;
    }
