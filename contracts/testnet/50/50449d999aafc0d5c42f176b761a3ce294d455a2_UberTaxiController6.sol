...
contract UberTaxiController6 is Ownable {
    ...
    constructor() {
        ...
        UTD = UberTaxiDate(0xe71Eb7289eBB6b56a6b26a2e5B6b513FcfC57868);
    ...
    function vehicleGetReward(uint256 index) public isUsers(index) {
        ...
        if (welMember != address(0) && UTD.recommenderFee() > 0 && UTD.queryUserRentVehicleAmount(welMember) > 0) {
            ...
            UTD.setUtaxiDetails(welMember, 4, UTBC.toString(msg.sender), 0, profit.mul(UTD.recommenderFee()).div(10 ** 18), block.timestamp);
        }
