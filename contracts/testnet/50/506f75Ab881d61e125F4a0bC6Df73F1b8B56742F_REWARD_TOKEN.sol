...
contract DividendDistributor is IDividendDistributor {
    ...
    // EARN
    IBEP20 RWRD = IBEP20(0xaB1a4d4f1D656d2450692D237fdD6C7f9146e814); //BUSD BSC Token address
    ...
    constructor(address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //router address
        _token = msg.sender;
    }
...
contract REWARD_TOKEN is IBEP20, Auth {
    ...
    // Addresses
    address RWRD = 0xaB1a4d4f1D656d2450692D237fdD6C7f9146e814; //BUSD BSC Token address
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //WBNB address
    ...
    constructor() Auth(msg.sender) {
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //ROUTER ADDRESS
