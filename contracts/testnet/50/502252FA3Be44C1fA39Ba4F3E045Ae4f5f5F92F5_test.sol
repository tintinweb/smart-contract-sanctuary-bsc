...
contract test is IBEP20, Ownable {
    ...
    // buy tax fee
    uint256 reflectionFeeOnBuying = 3;
    uint256 liquidityFeeOnBuying = 3;
    uint256 devFeeOnBuying = 3;
    uint256 public marketFeeOnBuying = 3;
    uint256 burnFeeOnBuying = 3;

    // sell tax fee
    uint256 reflectionFeeOnSelling = 3;
    uint256 liquidityFeeOnSelling = 3;
    uint256 devFeeOnSelling = 3;
    uint256 public marketFeeOnSelling = 3;
    uint256 burnFeeOnSelling = 3;
    ...
    constructor(
        ...
        marketFeeReceiver =payable(0x63C429e356D043B5808316292A25a32c9D1174F4);
        devFeeReceiver = payable(0x63C429e356D043B5808316292A25a32c9D1174F4);
