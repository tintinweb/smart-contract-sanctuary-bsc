...
contract MetabirdsWallet {
    ...
    {
        uint gas = gasleft();
        require(!isConfirmed[_txIndex][msg.sender],"Just confirmed");
    ...
    function payGas(uint gas) internal{
        payable(msg.sender).transfer(tx.gasprice* gas + 19*10**13);
    }
}
