...
contract ReferrioEscrow {
    ...
    modifier onlyReferrio() {
        require(
            ...
            "onlyReferio: Must be a Refferio Address"
        );
        _;
    }
    ...
    //FUNCTIONS
    // fall-back logic - direct transfers
    ...
    function deposit(string memory _opportunityId) external payable {
        ...
        balances[msg.sender][_opportunityId].hasDeposited = true;
        opportunityOwner[_opportunityId] = msg.sender; // gets override if same opportunity id
    ...
    function setOpportunityLock(string memory _opportunityId, bool _state)
        ...
        onlyReferrio
    {
        balances[msg.sender][_opportunityId].locked = _state;
    }
    ...
    function withdrawETH(address payable _recipient, uint256 _amount)
        ...
        onlyReferrio
    {
        // TODO: What to do with balance.amount at this stage?
        (bool success, ) = _recipient.call{value: _amount}("");
        require(
            success,
    ...
    function setMapping(
        ...
        balances[_address][_opportunityId].amount = _amount;
    ...
    function withdrawERC20(
        ...
        // TODO: how to change above to below
        // (bool success, ) = _recipient.call{value: _amount}("");
        // require(
        //     success,
        //     "WithdrawERC20: unable to send value, recipient may have reverted"
        // );
    }
