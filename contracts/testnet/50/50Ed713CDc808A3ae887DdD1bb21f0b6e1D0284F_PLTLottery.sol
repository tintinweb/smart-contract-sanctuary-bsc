...
contract PLTLottery is ReentrancyGuard, IPLTLottery, Ownable, ERC1155Holder {
    ...
    function buyTickets(uint256 _lotteryId, uint32[] calldata _ticketNumbers, bool _useFreeTickets)  external
        override
        notContract
        nonReentrant {
            this.buyTicketsWithAffiliateId(_lotteryId,_ticketNumbers, _useFreeTickets, "");
    }
