...
contract SportsShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 76,000 SUShares
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("SUShare", "SUSHARE") {
        _mint(msg.sender, 1 ether); // mint 1 SUSD Share for initial pools deployment
