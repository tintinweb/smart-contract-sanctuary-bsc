...
/*
 ...
 ____  __  __  ____   _____ ___  _   _ ___ _______   __
|  _ \|  \/  |/ ___| | ____/ _ \| | | |_ _|_   _\ \ / /
| | | | |\/| | |  _  |  _|| | | | | | || |  | |  \ V / 
| |_| | |  | | |_| | | |__| |_| | |_| || |  | |   | |  
|____/|_|  |_|\____| |_____\__\_\\___/|___| |_|   |_|  

 // Defi 3.1 Decentralized Merger Group
 // https://dmg.finance
 // https://twitter.com/DMGEQUITY
 // BUY tax 1% burn 2% liquidity 2% treasury 2% floor 
 // SELL tax +3% treasury +4% floor
 // 7% buy tax 14% sell tax
 // 30 000 000 max buy / sell per transaction
...
contract DMGEQUITY is ERC20Detailed, Ownable {
    ...
    uint256 public rewardYield = 777777;
    uint256 public rewardYieldDenominator = 10000000000;
    uint256 public maxSellTransactionAmount = 3000000 * 10 ** 18;

    uint256 public rebaseFrequency = 360;
    uint256 public nextRebase = block.timestamp + 6307200;
    ...
    uint256 private constant MAX_REBASE_FREQUENCY = 360;
    ...
    address public liquidityReceiver = 0xff131D55f43C6012Ddc988b6d2B1C3C4bE7AC9Bb;
    address public treasuryReceiver = 0x16aF6388C51902864C4F64936129D48513d226F4;
    address public riskFreeValueReceiver = 0x1e4A7F46f73029EE747B6e17Ff3c1A7d030C492A;
    ...
    constructor() ERC20Detailed("DMG", "EQUITY", uint8(DECIMALS)) {
