...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAutoComp; // if we are depositing to another farm such as pancake
...
contract GammaStrategy_AQUA is StratX2 {
    ...
    constructor(
        ...
        controllerFee = _controllerFee;
        rewardsAddress = _addresses[7]; // Shall we remove this as we are not charging controller fee - Raj
        buyBackRate = _buyBackRate;
        buyBackAddress = _addresses[8];
        planetRouterAddress = _addresses[9];
        entranceFeeFactor = _entranceFeeFactor;
        withdrawFeeFactor = _withdrawFeeFactor;
