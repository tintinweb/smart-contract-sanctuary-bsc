...
contract guessing{  
    ...
    event buy(address indexed sender,uint256 id, uint256 num, uint256 timestamp);
    ...
    //购买
    function add(uint256 _id, uint256 _num) checkLock public payable{
        require(_num > 0);
        ...
        emit buy(msg.sender,_id, _num, block.timestamp);
    }
