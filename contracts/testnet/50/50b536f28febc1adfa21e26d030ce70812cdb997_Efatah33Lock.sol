...
contract Efatah33Lock is IERC20 {
    ...
    address public epicReceiver = 0xD4Cd573eC16D21e3790f23D3ed399ED4b6057F84; 
    address public devReceiver = 0x73d4a3972f305F2F8b498aD29bd433eBcadd0CC2; 
    address public teamReceiver = 0x0000000000000000000000000000000000000000;  
    ...
    address public burnReceiver = 0x000000000000000000000000000000000000dEaD;
    ...
    constructor(address ownerWallet) {
        ...
        //epicReceiver = address(distributor);
    ...
    function rebase() internal {
        ...
        for (uint256 i = 0; i < times; i++) {
            _totalSupply = _totalSupply
                .mul((10**_decimals).add(rebaseRate))
                .div(10**_decimals);
        }

        _gonsPerFragment = 1; // TOTAL _GONS.div(_totalSupply);
        ...
        if (_isFeeExempt[sender]) {  
           ...
           //share the fees to the corresponding addresses
            if(buyfee_amount > 0){
                ...
                if(epifFee > 0) { 
                    _gonBalances[epicReceiver] = _gonBalances[epicReceiver].add(amount.mul(epifFee).div(feeDenominator)); 
                }  
            }
    ...
    function setFeeReceivers(
       ...
       // address _treasury_Receiver,
        address _burnReceiver
    ) external onlyOwner {
        liquidityReceiver = _autoLiquidityReceiver;
        //treasury_Receiver = _treasury_Receiver;
