...
contract BUSDMachine is Token {
    ...
    address payable private FEE_WALLET;
    ...
    uint private constant STAKE_FEE         = 100;                  // 10% 
    uint private constant SELL_FEE          = 100;                  // 10%
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = msg.sender;                                  // e
        DEV_2 = 0x79f7C4a7710E015b06d463cB137b2e5aedFc7848;  // N
        ADV_1 = 0x0641f6A18c6572581466f7308F02f6A864dE760a;  // 0         
        ADV_2 = 0x1df3Cc45ae2d045b3e16D7F266ed336A30B72BaB;  // E        
        ADV_3 = 0x3330122b3fBb45a0839fF15798112cDf26747C39;  // o 
        ADV_4 = 0x9Aa21d77D248337D4243695A1d8Bee99e1d74d57;  // au    
        FIN_1 = 0x1A66607CC1b60DFb33c7e05D4E2d5249858b100e;  // S   
        FIND_1 = 0x14FA73Bb961Cc3D6c60E73751f08a5c233FF5876; // ll
        MAR_1 = 0x9F414659421f52ba6149B919A1FB18ee53079072;  // DESB      
        FEE_WALLET = 0x5A699810e8CEfc5CD24f1692370515D1f98B9718; //fee wallet to store all fees
    ...
    function stakeBUSD(address referrer,  uint256 _amount) public payable {
        ...
        uint stakeFee = _amount.mul(STAKE_FEE).div(PERCENT_DIVIDER); // calculate fees on _amount and not msg.value
        ...
        token.transfer(FEE_WALLET,stakeFee);
    ...
    function reinvest() public {
        ...
        user.sT.lastStakeTime = now;
        user.sT.totalStaked = user.sT.totalStaked.add(reinvestAmount);
        totalTokenStaked = totalTokenStaked.add(reinvestAmount); 
        emit Reinvest(msg.sender, tokenAmount);
    }
