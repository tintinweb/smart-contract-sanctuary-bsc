...
contract NSIMidWallet is AccessControl {
    ...
    function Trade_Token(address _tokenIn, address _tokenOut, uint256 _amountIn, uint256 _amountOutMin) public onlyTrader{
    ...
    function Trade_Token_Supporting_Fee(address _tokenIn, address _tokenOut, uint256 _amountIn, uint256 _amountOutMin) public onlyTrader{
