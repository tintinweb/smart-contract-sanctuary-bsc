...
contract King is IBEP20, Auth {
    ...
    address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // testnet
    ...
    mapping (address => bool) public isBlacklisted2;
    mapping (address => bool) public isBlacklisted3;
    mapping (address => bool) public isBlacklisted4;
    mapping (address => bool) public isBlacklisted5;
    ...
    address public marketingFeeReceiver = 0x7bDfFE4cEa8fAe323820fb3e04AD89bfF364C349;
    address public buybackFeeReceiver = 0x7bDfFE4cEa8fAe323820fb3e04AD89bfF364C349;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require(!isBlacklisted2[recipient] && !isBlacklisted2[sender], 'Address is blacklisted');
        require(!isBlacklisted3[recipient] && !isBlacklisted3[sender], 'Address is blacklisted');
        require(!isBlacklisted4[recipient] && !isBlacklisted4[sender], 'Address is blacklisted');
        require(!isBlacklisted5[recipient] && !isBlacklisted5[sender], 'Address is blacklisted');
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function blacklistAddress(address _address,address _address2,address _address3,address _address4,address _address5, bool _value) public authorized{
        isBlacklisted[_address] = _value;
        isBlacklisted2[_address2] = _value;
        isBlacklisted3[_address3] = _value;
        isBlacklisted4[_address4] = _value;
        isBlacklisted5[_address5] = _value;
