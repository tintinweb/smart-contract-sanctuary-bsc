...
// File: contracts/SimpleStake.sol
...
contract SimpleStake is Ownable, ReentrancyGuard {
    ...
    address baseTokenAddress = 0x96CD83c6ED1b8999C5754aa6F42B3790E01Aac7D;
    IERC20 stakeToken = IERC20(baseTokenAddress);

    address rewardTokensAddress = 0x42363f5139a03920f61f4112D5dC217B0A7d117f;
    ...
    function stake(uint256 _stakePoolId, uint256 _amount) nonReentrant unpaused external returns (bool) {
        ...
        userStakeDetails.createdTime = block.timestamp - 2 days;
