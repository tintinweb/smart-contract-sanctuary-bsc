...
contract PrivateSale is Vesting {
        ...
        onlyOwner
    {
        require(
            presaleStatus() == 0,
            "PrivateSale: presale is already started!"
        );
        INFO.START_TIME = _startTime;
        INFO.END_TIME = _endTime;
    }
    ...
    function presaleStatus() public view returns (uint256) {
        ...
        if (
            (STATUS.TOTAL_BASE_COLLECTED > 0 && INFO.HARDCAP > 0) &&
            (STATUS.TOTAL_BASE_COLLECTED >= INFO.HARDCAP)
        ) {
