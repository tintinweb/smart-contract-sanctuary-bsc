...
import "./LunaOneUser721Token.sol";
...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new LunaOneUser721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        LunaOneUser721Token token = LunaOneUser721Token(address(addr));
...
contract LunaOneUser721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
