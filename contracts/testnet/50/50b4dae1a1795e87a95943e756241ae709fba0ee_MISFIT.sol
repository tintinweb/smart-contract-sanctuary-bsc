...
contract MISFIT is ERC20, Ownable {
    ...
    address public marketingWallet = 0xFdE4D51EC9ABda93c8A64f651E00472BfDFC3286;
    address public developmentWallet = 0xFdE4D51EC9ABda93c8A64f651E00472BfDFC3286;
    address public playToEarnWallet = 0xFdE4D51EC9ABda93c8A64f651E00472BfDFC3286;
    ...
    constructor () ERC20("MISFIT Token", "MISFIT") 
    {   
        address newOwner = 0x7f8c9344Ea5C5941e068776A4427520458D3F43f;
        ...
        maxWalletAmount       = 1_000_000 * (10 ** decimals());

        maxTransactionLimitEnabled = true;
        maxTransactionAmountBuy = ( 3 * 333_333) * (10 ** decimals()) ;
        maxTransactionAmountSell = ( 3 * 333_333) * (10 ** decimals()) ;
