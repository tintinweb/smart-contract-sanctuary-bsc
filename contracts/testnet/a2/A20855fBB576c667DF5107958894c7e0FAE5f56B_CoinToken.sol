...
contract CoinToken is Context, IERC20, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, uint256 decimals_, uint256 supply, uint256 taxFee, uint liquidityFee, uint256 maxTxAmount, uint256 numTokensSellToAddToLiquidity, address routerAddress) {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
