...
contract MultiSigs {
    ...
    /// @param _txIndex index of the transaction
    function revokeRejection(uint256 _txIndex) public onlyOwner txExists(_txIndex) notExecuted(_txIndex) {
    ...
    function addOwner(address _newOwnerAddress) public {
    ...
    function setNumConfirmationsRequired(uint8 _newNumConfirmationsRequired) public {
        require(msg.sender == address(this), "CALL_DENIED");
        require(
