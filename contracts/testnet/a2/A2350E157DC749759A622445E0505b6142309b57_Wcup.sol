...
contract Wcup is Context, IERC20 {
    ...
    function _chengeSwapTrigger(uint8 _swapTrigger) public onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
     ...
     function swapAndLiquify1(uint256 contractTokenBalance) public lockTheSwap {
