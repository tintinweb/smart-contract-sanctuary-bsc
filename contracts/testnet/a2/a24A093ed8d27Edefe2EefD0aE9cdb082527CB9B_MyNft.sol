...
contract MyNft is ERC721, Ownable, ERC2981 {
    ...
    address[] public withdrawAddresses = [0x329b743D7372b6Ec12FD6B8bb2b45Fc9EA948BaE, 0xd5F75aBe2F0F2a1104fE219830216f85204c1d26, 0xb4082f8469795D49BD62DB1232561B4621BE127B];
    uint256[] public withdrawPercentages = [10, 20, 70];


    bytes32 public merkleRoot = 0;

    constructor() ERC721("MILK", "M") {
        _baseTokenURI = "https://test-api.nftool.io/generator-server/api/contract/v1/hRMwmu5teCxVwHui0/1605744135031304194/metadata/";
        _setDefaultRoyalty(0xb4082f8469795D49BD62DB1232561B4621BE127B, uint96(300));
    }
