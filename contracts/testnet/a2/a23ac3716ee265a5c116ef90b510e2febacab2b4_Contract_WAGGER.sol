...
contract Contract_WAGGER is ERC20, Ownable {
    ...
    string constant _name = "GAYGIE";
    string constant _symbol = "JEWGIE";
    ...
    function setFee(uint256 _liquidityFee, uint256 _marketingFee, uint256 _developerFee) external authorized {
