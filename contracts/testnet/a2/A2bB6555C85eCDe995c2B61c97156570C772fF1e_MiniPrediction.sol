...
contract MiniPrediction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function getSponsorToken(uint256 matchId) public view returns (uint256) {
        ...
        return IERC20Upgradeable(_match.sToken).balanceOf(address(this));
    }
    ...
    function claimReward(
        ...
        // back locked fund
        IERC20Upgradeable(_token).safeTransfer(msg.sender, predictions[_token][msg.sender][_matchId].predictionAmount[0]);
