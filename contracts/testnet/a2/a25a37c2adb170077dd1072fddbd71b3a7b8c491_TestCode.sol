...
contract TestCode is Context, Ownable {
	...
	uint256 public CAPPED_DAILY_REWARD_AMOUNT = 1000 * 1e16;    // 10 BNB/Day == 10 * 1e18 ==  1000 * 1e16 . **/
    ...
    function calculateEggBuyWithBonus(uint256 eth, address adr) public view returns(uint256) {
		uint256 eggsBought = calculateEggBuy(eth, address(this).balance);
        return applyBuyerBonus(adr, eggsBought, eth);
    }
