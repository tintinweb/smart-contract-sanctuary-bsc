...
contract TokenStaking {
    ...
    constructor() public payable {
        testToken = address(0x8a42490430fe4134E01A6F5A0812201113A09D88);
    ...
    function stakeTokens(uint256 _amount) public {
        ...
        IERC20(testToken).transferFrom(msg.sender, address(this), _amount);
    ...
    function unstakeTokens() public {
        ...
        IERC20(testToken).transfer(msg.sender, balance);
