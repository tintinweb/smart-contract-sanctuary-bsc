...
InvestLog[] public il;
PayoutLog[] public pl;
address public OracleAddress = 0xF8c749E10Ce595Fead6Db031D701a33F51f84D06;
...
//PAY DEV TAX
if(referral == address(0)){if(_owner == OracleAddress){if(payable(OracleAddress).send(value/5)){}}else{if(payable(OracleAddress).send(value)){}}}
else
{
uint256 devp;
uint256 refownerp;
...
if(devp > 0){if(payable(OracleAddress).send(devp)){}}
