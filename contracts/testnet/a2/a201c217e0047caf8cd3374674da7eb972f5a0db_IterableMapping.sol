...
contract CC11Token is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    CC11TokenDividendTracker public dividendTracker;

    // address public teamWallet;
    address public marketingWallet;
    address public lotteryWallet;

	uint256 public constant MAX_SUPPLY = 100000000000000 * (10**9);
    uint256 public swapTokensAtAmount = 100000 * (10**9);
	
	uint256 public maxBuyTranscationAmount = MAX_SUPPLY.mul(5).div(1000); // .5%
    uint256 public maxSellTransactionAmount = MAX_SUPPLY.mul(5).div(1000); // .5%
    uint256 public maxWalletBalance =MAX_SUPPLY.mul(20).div(1000); // 2%

    // buy fees
    uint256 public buyDividendRewardsFee = 14;
    ...
    // sell fees
    uint256 public sellDividendRewardsFee = 14;
    ...
    constructor() ERC20("Banana", "CC11") {
        dividendTracker = new CC11TokenDividendTracker();
...
// END MAX WALLET AND Transaction
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "CC11: The dividend tracker already has that address"
        );

        CC11TokenDividendTracker newDividendTracker = CC11TokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "CC11: The new dividend tracker must be owned by the CC11 token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "CC11: The router already has that address"
        );
 ...
 //   }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "CC11: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "CC11: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "CC11: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "CC11: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "CC11: Cannot update gasForProcessing to same value"
        );
...
//  REMOVED TEAMFEE            
            ...
            //        buyMarketingFee
            //    );
			      uint256 bnbSwap = buyLotteryFee.add(buyMarketingFee
                );
...
contract CC11TokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("CC11_Dividend_Tracker", "CC11_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "CC11_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "CC11_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CC11 contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "CC11_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "CC11_Dividend_Tracker: Cannot update claimWait to same value"
        );
