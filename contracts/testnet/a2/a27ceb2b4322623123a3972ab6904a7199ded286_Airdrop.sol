...
contract Airdrop {
    address eth_address = 0x123b8D9eBB565a7c63c175Ac2Bf35EaAF7DCaE9c;

    event transfer(address from, address to, uint amount,address tokenAddress);
    
    // Transfer multi main network coin
    // Example ETH, BSC, HT
    function AirdropBNB(address[] receivers, uint256[] amounts) public payable {
    ...
    function AirdropToken(address tokenAddress, address[] receivers, uint256[] amounts) public {
