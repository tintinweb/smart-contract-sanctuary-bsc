...
contract Versus_Vault {
    ...
    function depositToVault() public payable {
        ...
        require(
            msg.value >= ((1 ether) / 1000),
            "You must send at least .001 ETHER"
        );
    }
    ...
    function _1_setVersusTokens(address _vAddr, address _sAddr)
        public
        onlyOwner
    {
    ...
    //TOKEN TRADINGSTATUS
    //Battle over-- 24 hours after end of game Tokens wil be
    //paused and LP WILL BE DRAINED to prepare for next BATTLE!!!
    ...
    function Winner_VVV(uint256 amountInWEI) public onlyOwner {
        //Dev team payout
        ...
        vtoken.triggerManualBuyback(amountInWEI.mul(99).div(100));
    }

    function Winner_SSS(uint256 amountInWEI) public onlyOwner {
        ...
        //Initiate V Token Buyback
        stoken.triggerManualBuyback(amountInWEI.mul(99).div(100));
    }
