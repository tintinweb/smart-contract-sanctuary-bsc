...
contract TokenVesting is ITokenVesting, Ownable {
  ...
  /// @dev Shows total vested amount for beneficiary
  /// @return amount of vested tokens for beneficiary
  function getVestedAmount(address _beneficiary) external view override returns (uint256) {
    Vesting[] memory vesting = vestings[_beneficiary];
  ...
  /// @dev Shows total outstanding shares for beneficiary
  /// @return amount of tokens which beneficiary can withdraw in the future
  function getOutstandingAmount(address _beneficiary) external view override returns (uint256) {
    Vesting[] memory vesting = vestings[_beneficiary];
  ...
  /// @dev Shows total withdrawn shares for beneficiary
  /// @return amount of tokens which beneficiary already withdrawn
  function getWithdrawnAmount(address _beneficiary) external view override returns (uint256) {
    Vesting[] memory vesting = vestings[_beneficiary];
  ...
  function revokeVestingOfUser(address _beneficiary, uint256 _vestingId) external override onlyOwner {
  ...
  function withdrawShare() external override {
...
interface ITokenVesting {
  ...
  /// @dev Shows total vested amount for beneficiary
  /// @return amount of vested tokens for beneficiary
  function getVestedAmount(address shareholder) external view returns (uint256);

  /// @dev Shows total outstanding shares for beneficiary
  /// @return amount of tokens which beneficiary can withdraw in the future
  function getOutstandingAmount(address _beneficiary) external view returns (uint256);

  /// @dev Shows total withdrawn shares for beneficiary
  /// @return amount of tokens which beneficiary already withdrawn
  function getWithdrawnAmount(address _beneficiary) external view returns (uint256);
