...
contract LPLockToken is Context, Ownable {
	...
	IERC20 public _LP = IERC20(_lpaddress);
	IERC20 public _LPwin = IERC20(_winaddress);
	...
	function setUdayMin(uint256 _value) public onlyOwner {
		_udays = _value;
	}
