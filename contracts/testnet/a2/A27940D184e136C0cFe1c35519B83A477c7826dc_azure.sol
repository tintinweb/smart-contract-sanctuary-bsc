...
contract azure is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "AZURE";
    ...
    uint256 public  _liquidityFeeSell = 13;
    
    uint256 public  _maxTxAmount     = _tTotal * 25 / 10000;
    ...
    constructor () {
        ...
        // 
        _teamWallet       = 0x4c5243B44d4DB32005FA6272ec0ebD5f2082cD14;
        _marketingWallet = 0x87B37398C0D95374Bdb2Da3b21fCE48c30A556Fe;
