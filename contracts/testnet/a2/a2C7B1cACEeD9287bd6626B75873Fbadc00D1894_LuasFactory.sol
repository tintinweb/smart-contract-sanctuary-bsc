...
contract LuasERC20 is IPancakeERC20 {
    using SafeMath for uint;

    string public constant name = 'Luas LP';
    string public constant symbol = 'Luas-LP';
...
contract PancakePair is IPancakePair, LuasERC20 {
    using SafeMath  for uint;
...
contract LuasFactory is IPancakeFactory {
