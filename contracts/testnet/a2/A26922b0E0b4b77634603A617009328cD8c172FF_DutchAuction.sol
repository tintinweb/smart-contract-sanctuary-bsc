...
contract AuctionTime is Ownable, Random{
    ...
    uint public auctionStartTime = 1644980000;// 2022/1/30 20:00
    uint public auctionEndTime = 9999999999;
    uint public dutchAuctionTime = 1644980000;
...
contract DutchAuction is Pausable, AuctionTime, IMomoBear{
    ...
    function getPriceForUSDT() public view returns(uint){
        ...
        uint off = newtime / reduceTime;
        uint overtime = _priceForUSDT / reducePrice;
        if(off > overtime){
            off = overtime;
        }
        uint newPrice = _priceForUSDT - reducePrice*off;
    ...
    function winTheBidByUsdt(
        ...
        // require(_nftCount.current() < totalAuctionAmount, "auctions sold out!");
...
//_winTheBid
    ...
    function _winTheBid(uint lastPrice) private{
        ...
        if(randomNumber > (17 - bearAuctionAmount())){
            heroIndex = 906;
