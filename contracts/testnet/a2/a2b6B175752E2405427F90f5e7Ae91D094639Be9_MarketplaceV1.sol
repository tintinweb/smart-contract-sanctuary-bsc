...
contract MarketplaceV1 is AccessControl, ReentrancyGuard{
        ...
        nonReentrant
    {
        ...
        idToMarketplaceItem[itemId - 1].price,
    ...
    function ChangeNftSalesDuration(address _nftcontract, uint _tokenid, uint _salesDuration) isWhitelisted(_nftcontract) public payable {
        uint256 _itemid = fetchItemId(_nftcontract, _tokenid);
