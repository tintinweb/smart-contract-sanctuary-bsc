...
contract escrow is Backend, OwnableUpgradeable {
    ...
    function deposit(BackendSigner memory whitelist) external {
        ...
        CBS.transferFrom(msg.sender, address(this), whitelist.amount * 1 ether);
    ...
    function withdraw(BackendSigner memory whitelist) external {
        ...
        CBS.transfer(senderSlotToReceiver[whitelist.senderAddress][whitelist.slotId],whitelist.amount * 1 ether);
