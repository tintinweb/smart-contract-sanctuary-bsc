...
contract SuperBowlDoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x4A202D41b076115DaA09E3c23c8C8263F515cc6C); // Marketing Address
    ...
    string private _name = "SuperBowl Doge";
    string private _symbol = "SBDoge";
   ...
   // once enabled, can never be turned off, block delay is a max of 256 blocks
   function enableTrading(uint8 _deadBlockDelay) external onlyOwner {
      tradingActiveBlock = block.number;
      deadBlockDelay = _deadBlockDelay;
   }
