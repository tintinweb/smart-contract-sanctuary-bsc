...
contract Adorn1155 is ERC1155, IAdorn1155, Ownable {
    ...
    constructor( address factory, string memory name,string memory symbol, string memory baseURI ) 
    ERC1155(baseURI) 
    {
         _factory = factory;
         _name=name;
     ...
     */
     function tokensOfOwner(address owner, uint256 offset, uint256 pageMax ) external view returns ( IAdorn1155.NftInfo1155[] memory nftInfos) {
        ...
        for (uint i=0; i<maxCount; i++) {
            nftInfos[i].id = _ids.at(i);
            nftInfos[i].amount = balanceOf(owner, _ids.at(i) );
        }
    }


    // function tokensOfOwner(address owner) external  view returns ( IAdorn1155.NftInfo1155[] memory nftInfos) {
...
interface IAdorn1155 is IERC1155MetadataURI {
