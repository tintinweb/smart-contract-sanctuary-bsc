...
contract ReedBricks is Context, IBEP20, Ownable, ReedLock {
    ...
    string private _name = "JAXO";
    string private _symbol = "JAXO";
    ...
    function frozenOf(address account) external view returns (uint256) {
        ...
        uint256 freeBalance = _getFreeFund(account);
    ...
    function _getFreeFund(address _account) private view returns (uint256) {
    ...
    function getFreeFund(address _account) external view returns (uint256) {
        return _getFreeFund(_account);
    }
