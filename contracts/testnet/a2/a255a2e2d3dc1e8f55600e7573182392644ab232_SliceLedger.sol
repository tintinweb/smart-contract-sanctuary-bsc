...
contract SliceLedger is BEP20, Ownable {
    ...
    uint256 public CommunityGrants = 5; // 5%
    uint256 public UnlockedCommunityGrants =  5; // 5% every 3 months.

    uint256 public TreasuryProtocol =  12; // 12%
    uint256 public UnlockedTreasuryProtocol =  5; // 5% months 1,2 and 3, then 5% every 3 months.
    
    uint256 public ChessTournaments =  5; // 5%
    uint256 public UnlockedChessTournaments =  5; // 5% every 2 months.

    uint256 public Founders =  8; // 8%
    uint256 public UnlockedFounders =  0.1666 ether; // 16.66% every 6 months.
