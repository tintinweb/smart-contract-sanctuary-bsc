...
interface IOBXReferral {
    ...
    */
    ...
    /**
    * @dev Returns current commission bonus
    */
    function getCurrentCommission(address _referrer) external view returns (uint256);

    /**
    * @dev Returns total commission bonus
    */
    function getTotalCommission(address _referrer) external view returns (uint256);

    /**
    * @dev Returns total referrer volume in USD
    */
    function getTotalReferrerVolume(address _referrer) external view returns (uint256);
...
contract OBXExchange is Ownable,ReentrancyGuard {
    ...
    address public stableToken = 0x96F7e7fd1e17fe3a18d8B8b9CE6961fE7285baaB;
        ...
        for (uint8 i = 0; i < len; i++) {
            ...
            if (buyAmount == 0) {
                ...
                if(feeRate > 0){
                    ...
                    uint256 currentFee = (price * buyAmount / 1000) * feeRate / 1000000;
