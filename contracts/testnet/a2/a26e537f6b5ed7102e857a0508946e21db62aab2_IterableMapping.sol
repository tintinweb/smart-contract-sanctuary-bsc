...
contract DividendPayingToken is BEP20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable BUSD = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //BUSD pancake
...
contract wJindoChainCoin is BEP20, LockToken {
    ...
    address payable public _marketingWalletAddress = payable(0xABaa93A2C320b78423bAF49Aa6f7E6b87F0d8FB3); //work
    address payable public _buybackWalletAddress = payable(0x1234D8ebf8D83fBd305B1AF0369e8dcD4A62C9cF); //acc 4
    ...
    constructor() BEP20("wJindoChainCoin", "wJCC") 
    {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //pancake test
    ...
    uint256 public _amountDueForSaleLimit = _totalSupply.div(1000000); //0.0000001%  chek there!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
