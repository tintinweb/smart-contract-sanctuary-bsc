...
contract PUMPCOIN is Context, IBEP20, Ownable { // change name 
    ...
    string private constant _name     = "PUMPCOIN"; // change name
    string private constant _symbol   = "PUMP"; // change ticker
