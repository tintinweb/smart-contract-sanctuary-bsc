...
contract BNBBets_Prediction is Ownable, Pausable, ReentrancyGuard {
    ...
    constructor() {
        ...
        operatorAddress = address(0x04f61498aaf25A376ee44114Ad4CE2a22825317E); // testnet - address should be change
        intervalSeconds = 300;
        bufferSeconds = 30;
        minBetAmount = 0.01 ether;
        oracleUpdateAllowance = 300;
        // devAddress = address(0xd6b2466EC22e655D8Af2cBC75Dd75d8c16337CE3); // mainnet
        // adminAddress = address(0x554472D18830641fF7256B60b4f4E14b0E88D1Ba); // mainnet
        devAddress = address(0x207C06fB7fe5C79F60442991e8749689beB1DdA9); // testnet
        adminAddress = address(0x30547B4eD9a0811A59a3fb5f14EC3ceE8F41E608); // testnet
    }
    ...
    function executeRound() external whenNotPaused onlyOperator {
        ...
        uint256 currentRoundId = 0; // testnet - delete on mainnet

        int256 currentPrice = 202.83 ether; // testnet - delete on mainnet
        ...
        onlyAdmin
    {
        ...
        require(_bufferSeconds >= 30 && _bufferSeconds <= 120, "between 30 seconds to 2 minutes");
        require(_intervalSeconds >= 300 && _intervalSeconds <= 1 days, "between 5 minutes to 1 day");
    ...
    function setMinBetAmount(uint256 _minBetAmount) external whenPaused onlyAdmin {
        require(_minBetAmount >= 0.01 ether && _minBetAmount <= 0.1 ether, "between 0.01 ether to 0.1 ether");
    ...
    function _calculateRewards(uint256 epoch) internal {
        ...
        if (round.closePrice > round.lockPrice) {
            ...
            devAmt = (round.totalAmount * devFee) / 10000;
        ...
        // House wins
            ...
            rewardAmount = 0;
            devAmt = round.totalAmount / 10;
            treasuryAmt = round.totalAmount - devAmt;
        }
        ...
        emit RewardsCalculated(epoch, rewardBaseCalAmount, rewardAmount, (treasuryAmt + devAmt));
    }
