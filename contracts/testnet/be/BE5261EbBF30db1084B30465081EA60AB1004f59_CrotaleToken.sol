...
contract CrotaleToken is ERC20, Ownable {
    ...
    uint256 public _supplyMax = 325 * 10**12;
    uint256 public _supplyInitial = 325 * 10**8;
    ...
    constructor(
        ...
        totalFee = liquidityFee.add(treasuryFee).add(ecosystemFee).add(autoBlackholeFee);
    ...
    function swapBack() internal swapping {
        ...
        uint256 feeTotal = treasuryFee.add(ecosystemFee);
     ...
     * 2 - Assurance Ecosystem receiver
     * 3 - Auto SnakePit Burn
     */
     ...
     */
    function triggerVenomBuyback(uint256 amount) external authorized {
