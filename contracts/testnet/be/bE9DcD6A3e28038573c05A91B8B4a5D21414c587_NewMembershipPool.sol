...
contract NewMembershipPool is ReentrancyGuardUpgradeable, Authorizable {
    ...
    */
    ...
    /**
     * @dev admin add reserve amount for user withdraw 
    ...
    */
    ...
    /**
     * @dev admin withdraw reserve amount from the pool 
     * @param _amounts pass all four token amount
    */
    ...
    /**
     * @dev admin deposit betting amount 
    ...
    */
    ...
    /**
     * @dev admin withdraw betting amount from the pool 
     * @param amounts pass all four token amount
    */
    ...
    /**
     * @dev change and set ticket token address 
    */
    ...
    */
    ...
    /**
     * @dev Owner set/change token reward duration  
    */
    ...
    /**
     * @dev Owner set/change medal reward duration  
    */
    ...
    */
    ...
    /**
     * @dev Owner change medalContract address  
    */
    ...
    /**
     * @dev Owner change rewardToken address  
    */
    ...
    /**
     * @dev Owner change sportBettingAddress address  
    */
    ...
    /**
     * @dev Owner change feeReciverTreasuryAddress address  
    */
    ...
    /**
     * @dev Owner change treasury address  
    */
