...
import "./PancakeStableSwapTriplePool.sol";

contract PancakeStableSwapTriplePoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(PancakeStableSwapTriplePool).creationCode;
        ...
        PancakeStableSwapTriplePool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
...
contract PancakeStableSwapTriplePool is Ownable, ReentrancyGuard {
