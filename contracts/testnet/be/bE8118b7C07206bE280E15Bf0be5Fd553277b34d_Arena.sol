...
contract Arena is Ownable{
    ...
    uint256 public weekCyle =  3*3600; // 周期时间
...
contract Game is AccessControl,Ownable {
    ...
    function rechargeBnb(uint256 amount)  public{
        bnbPool += amount;
