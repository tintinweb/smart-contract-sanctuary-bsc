...
contract Factory721 {
    ...
    function deploy(
        ...
        addr = address(
            new NFTMarket24User721Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        NFTMarket24User721Token token = NFTMarket24User721Token(address(addr));
...
contract NFTMarket24User721Token is
    Context,
    ERC721Enumerable,
    ERC721Burnable,
    ERC721URIStorage,
