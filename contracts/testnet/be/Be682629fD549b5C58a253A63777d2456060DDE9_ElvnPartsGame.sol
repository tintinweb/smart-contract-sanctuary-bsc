...
contract ElvnPartsGame is ERC1155, Ownable, Pausable, ERC1155Burnable, ERC1155Supply {
    ...
    */
    ...
    function addPartBatch(uint[] calldata _partId, uint[] calldata _class, uint[] calldata _stakingPower, uint[] calldata _setId) public onlySetter{
    ...
    function addEXPBoostBatch(uint[] calldata _boostId, uint[] calldata _expBoostPower) public onlySetter{
    ...
    function addStakingBoostBatch(uint[] calldata _boostId, uint[] calldata _stakingBoostPower, uint[] memory _stakingBoostDuration) public onlySetter{
    ...
    function addChestBatch(uint[] calldata _chestId) public onlySetter{
