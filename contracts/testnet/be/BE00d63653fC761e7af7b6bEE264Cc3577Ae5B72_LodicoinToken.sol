...
Taxation & Limits
	•	Buy Tax & proceeds- 15% (can be adjusted along the way)
2% Burn
2% Liquidity in BNB
1% Development Guard BNB
3% Insurance Guard in BNB
3% Goes to All Token Holders in BNB
4% Token for Pool Rewards under Reserve Bank
 
	•	Sell Tax & proceeds- 20% (can be adjusted along the way)
2% Burn
4% Liquidity in BNB
1% Treasury Guard BNB
4% Insurance Guard in BNB
4% Goes to All Token Holders in BNB
5% Token for Pool Rewards under Reserve Bank
...
contract LodicoinToken is ERC20Detailed, Ownable {
    ...
    stakes[investor] = Invest(_amount, investingStartingTime, investingEndingTime, false);
