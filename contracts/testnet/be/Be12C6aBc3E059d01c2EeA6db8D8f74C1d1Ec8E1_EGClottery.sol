    ...
    Ownable 
{
    ...
    */
    ...
    Lottery
    */
    mapping(address => uint256) private multipleDaysRegestration;
    ...
    */
    ...
    function _mulDaysRegistration(uint256 _days) external {
        ...
        multipleDaysRegestration[_msgSender()] = lottDay + _days;
...
contract RewardsWallet is Ownable {
    ...
    */
    ...
    function convertToEGC(uint256 _slippage) public {
        ...
        uint256 _amountOutMin = amountOut.mul(_slippage).div(100);
...
contract Lottery is RandomNumberConsumer, Ownable {
    ...
    */
    ...
    function mulDaysRegistration(address _holder, uint256 _share, uint256 _day, uint256 _n) external onlyWithPermission registrationCheck {
