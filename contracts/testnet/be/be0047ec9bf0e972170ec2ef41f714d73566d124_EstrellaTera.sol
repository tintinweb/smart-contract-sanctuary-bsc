...
contract EstrellaTera is Ownable, Pausable, ReentrancyGuard{
    ...
    function checktoken(uint256 currentRound , uint256 _round, uint256 _token) public view returns (uint256[] memory)
    {
    ...
    function getPriceAfterTwoRunds(uint256 _Tokens,uint256 _startRound,uint256 _endRound, uint256 _totaluser, address _SellerAddress, 
        ...
        while(_remainingbuyerToken > 0)
            {
                ...
                TokenBuy_User = checktoken(_currentRound, priceDetails[1], _TokenBuy);
