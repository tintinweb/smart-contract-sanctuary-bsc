...
// File contracts/interfaces/ISaharaDaoChef.sol

pragma solidity 0.8.4;

interface ISaharaDaoChef {
...
// File contracts/farms/SaharaDaoZapMMSwap.sol

pragma solidity 0.8.4;

/*
    SaharaDaoZap is a ZapperFi's simplified version of zapper contract which will:
    1. use ETH to swap to target token
    2. make LP between ETH and target token
    3. add into SaharaDaoChef farm
*/
contract SaharaDaoZapMMSwap is Ownable, ReentrancyGuard {
    ...
    ZapInfo[] public zaps;
    ISaharaDaoChef public saharaDaoChef;
    IUniswapV2Router02 public uniRouter;

    constructor(address _saharaDaoChef, address _uniRouter) {
        require(_saharaDaoChef != address(0), "Zap::constructor: Invalid address");
        require(_uniRouter != address(0), "Zap::constructor: Invalid address");
        saharaDaoChef = ISaharaDaoChef(_saharaDaoChef);
    ...
    function zap(
        ...
        address _lp = address(saharaDaoChef.lpToken(_info.pid));
        ...
        approveToken(_lp, address(saharaDaoChef), _liquidity);
        saharaDaoChef.deposit(_info.pid, _liquidity, msg.sender);
