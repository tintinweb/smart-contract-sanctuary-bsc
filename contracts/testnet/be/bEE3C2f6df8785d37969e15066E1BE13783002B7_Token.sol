...
contract Token is IERC20 {
    ...
    function setDelta(uint256 delta) public onlyOwner {
        ...
        //delta of 1 = 100%, 2 = 50%, 4 = 25%, 5 = 20%, 10 = 10%, 20 = 5%, 100 = 1%, 1000 = 0.1%, and so on
    }
    ...
    function setTargets() public onlyOwner {
        ...
        target_buy = price.add(price.div(delta_buy).mul(1));
        target_sell = price.add(price.div(delta_sell).mul(1));
    }
