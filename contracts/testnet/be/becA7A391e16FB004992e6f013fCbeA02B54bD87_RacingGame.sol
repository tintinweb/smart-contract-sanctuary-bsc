...
contract RacingGame
{
    ...
    function gameResult(address[] memory _participents,uint256 _fees) external
    {
        userdetails[(_participents[0])].totalpoint-=_fees;
        userdetails[(_participents[1])].totalpoint+=_fees;
    }
