    ...
    ERC1155Burnable
{
    ...
    ReignNFT1155 public  ReignNFT1155M;
    ...
    constructor(    
        ...
        ReignNFT1155 _ReignNFT1155M = ReignNFT1155(adminContract);
        // set the rest of the contract variables
        ReignNFT1155M = _ReignNFT1155M;
    ...
    function getServiceFeeESC() public view returns (uint256) {
        return  ReignNFT1155M.getServiceFeeESC();
    }

    function getServiceFee() public view returns (uint256) {
        return  ReignNFT1155M.getServiceFee();
    }
    ...
    function _saleToken(
        ...
        uint256 serviceVal = ReignNFT1155M.getServiceFee();
        if(keccak256(bytes(bidtoken)) == keccak256(bytes("NIL")))
        {
             serviceVal = ReignNFT1155M.getServiceFeeESC();
        }

        address payable admin =  payable(ReignNFT1155M.getOwner());
