...
contract MythBounty {
    ...
    event bountyResolved(uint256 bountyId, bool degenWinner);

    constructor(address _degenAddress, address _mythralAddress) {
        owner = msg.sender;
        ...
        external
    {
        ...
        while (counter < resolveCountOfBlock) {
            ...
            emit bountyResolved(tempId, currentBattle.degenWinner);
            counter++;
        }
    }
    ...
    function payoutBounty(uint256 _bountyId, address _degenOwnerAddress)
        internal
        returns (bool)
    {
        ...
        uint256 rewardOfBounty = (((currentRewardPool * 10**18) / 100000) *
            currentBounty.rewardPercent) / 10**18;
        ...
        ERC20 mythralContract = ERC20(mythralAddress);
        mythralContract.transfer(_degenOwnerAddress, rewardOfBounty);
        return true;
    }
