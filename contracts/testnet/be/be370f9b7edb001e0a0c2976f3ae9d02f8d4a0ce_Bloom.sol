...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 BEETS = IERC20(0x0D9C8723B343A8368BebE0B5E89273fF8D712e3C);
    ...
    constructor (address _router) {
        ...
        ? IDEXRouter(_router)
        : IDEXRouter(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506); // spirit
        _token = msg.sender;
    }
...
contract Bloom is IERC20Metadata, Auth, Pausable {
    ...
    address BEETS = 0x0D9C8723B343A8368BebE0B5E89273fF8D712e3C;
