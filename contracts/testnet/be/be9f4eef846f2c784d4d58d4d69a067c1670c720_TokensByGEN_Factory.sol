...
contract TokensByGEN_Factory is Context {
    ...
    // Affiliate Tracking
    IERC20 GEN = IERC20(0xa68a7896F8f3E628942dead8624c5f67C197E3d6); // XXXX evergrn
    IERC20 AFF = IERC20(0xE47824dd6f80Ddd2eD6d72E40D6fe2914a502b62); // XXXX zne test
 ...
 //   address payable private FeeCollectorContract = payable(0xde491C65E507d281B6a3688d11e8fC222eee0975); XXXX
    address payable private FeeCollectorContract = payable(0x06376fF13409A4c99c8d94A1302096CB4dC7c07e); // wallet 3
...
contract Contract is Context, IERC20 { 
 ...
 //   address payable public feeCollector = payable(0xde491C65E507d281B6a3688d11e8fC222eee0975); // XXXX
    ...
    // Affiliate Tracking
    IERC20 GEN = IERC20(0xa68a7896F8f3E628942dead8624c5f67C197E3d6); // XXXX egrn
    IERC20 AFF = IERC20(0xE47824dd6f80Ddd2eD6d72E40D6fe2914a502b62); // XXXX zne 
