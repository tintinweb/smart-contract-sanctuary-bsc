...
contract ADCToken is IERC20, Ownable {
    ...
    constructor(address tokenOwner,address user) {
        ...
        _tTotal = 880000000 * 10**_decimals;
    ...
    function _tokenSellTransferFee(
		...
		if(fee){
			...
			_takeTransfer(
				sender,
				_destroyAddress,
				tAmount.div(1000).mul(_destroyFee.add(30).sub(ratesum)),
				currentRate
			);
		    ...
		    _rOwned[recipient] = _rOwned[recipient].add(rAmount.div(100).mul(94));
