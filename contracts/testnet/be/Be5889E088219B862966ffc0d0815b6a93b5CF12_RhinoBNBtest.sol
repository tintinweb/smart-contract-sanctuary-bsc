...
contract RhinoBNBtest is Context, Ownable , ReentrancyGuard {
    ...
    uint256 public constant max = 99 ether;
    uint256 public roi = 50;
    uint256 public constant fee = 6;
    uint256 public constant withdraw_fee = 7;
    uint256 public withdrawDays = 0.1 * 60 * 60; //168 = 7 days
    uint256 public claimDays = 0.01 * 60 * 60; //24 = 1 day
    ...
    function withdrawal() public noReentrant {
        ...
        uint256 wFee = withdrawFee(aval_withdraw3); // changed from aval_withdraw
        uint256 totalAmountToWithdraw = SafeMath.sub(aval_withdraw3,wFee); // changed from aval_withdraw to aval_withdraw2
