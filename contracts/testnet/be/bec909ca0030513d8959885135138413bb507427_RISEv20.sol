...
contract RISEv20Burner is Context {
    // A unique manual burner smart contract! (May or may not be used.)
    ...
    modifier onlyToken {
        require(TOKEN == _msgSender(), "Ownable: Caller is not the owner!");
        _;
    }
...
contract RISEv20 is Context, IERC20 {
    // Ownership moved to in-contract for customizability.
    address private _owner;

    RISEv20Burner burner;
    ...
    string private _name = "EVER RISE 2.0";
    string private _symbol = "RISE 2.0";
    ...
    //This is the initial state of the buy taxes to punish snipers!
    uint256 public _buyReflectFee = 0; // 1% upon announcement of the official CA.
    uint256 public _buyLiquidityFee = 0; // 1% upon announcement of the official CA.
    uint256 public _buyMarketingFee = 10000; // 3% upon announcement of the official CA.
    uint256 public _buyTeamFee = 0; // 0% all the way!
    uint256 public _buyBurnFee = 0; // 0% all the way!

    //This is the initial and final state of the sell taxes!
    ...
    uint256 public _transferTeamFee = 0;
    uint256 public _transferBurnFee = 0;

    uint256 constant public maxReflectFee = 200;
    uint256 constant public maxLiquidityFee = 500;
    uint256 constant public maxMarketingFee = 500;
    uint256 constant public maxTeamFee = 500;
    uint256 constant public maxBurnFee = 10000; // 3% upon announcement of the official CA.
    ...
    address private _routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //Testnet

    address public burnAddress = 0x000000000000000000000000000000000000dEaD;
    address public ZERO = 0x0000000000000000000000000000000000000000;
    address payable private _marketingWallet = payable(0xa1d7AdE56cdea1c3083C54Bdc5Dd9dAE442eC28E);
    address payable private _teamWallet = payable(0xa1d7AdE56cdea1c3083C54Bdc5Dd9dAE442eC28E);
    ...
    constructor () payable {
        ...
        burner = new RISEv20Burner(address(this), _decimals, _tTotal, _owner);
...
//===============================================================================================================
    ...
    function enableTrading() external onlyOwner {
        ...
        // DxLocker , Pinksale, DAPPLock, Deeplock Address (BSC)
        _isExcludedFromFee[0x19A89597c8342eAE38fB5b0A86974183abCE345e] = true;
        _isExcludedFromFee[0xAEaF8B617E463F7c1804793cd4a7a2F6e8d5E71A] = true;
        _isExcludedFromFee[0x787D9831f49fc5B4FAa7c7eE2c21491502883899] = true;
        _isExcludedFromFee[0x11bE1345bEabCF82C9CF8e6E4Fdf6928A4b1E8c6] = true;
        _isExcludedFromFee[0x1CDa480022A5C45971be9285200DEADDb62c3a82] = true;
