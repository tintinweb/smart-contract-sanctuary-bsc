...
contract Campaign is OwnableUpgradeable, Whitelist {
    ...
    function completeCampaign() public onlyOwner {
        ...
        IERC20(mintToken).transfer(owner(), balance);
    }
    ...
    function claimRefund() public {
        require(refundActive, "Not active");
    ...
    function getDates() public view returns(uint256 _startDate, uint256 _endDate) {
    ...
    Whitelist
{
    ...
    function initialize(
        ...
        // transferOwnership(_addresses[1]);
    }
    ...
    function mint(uint256 _numberOfNfts) public {
        (uint256 startDate, uint256 endDate) = campaignContract.getDates();
...
interface ICampaign {
    ...
    function getDates() external view returns (uint256, uint256);
}
