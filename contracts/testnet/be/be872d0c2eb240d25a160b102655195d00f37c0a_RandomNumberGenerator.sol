...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public panrp1SwapLottery;
     ...
     * @param _seed: seed provided by the MoonBizSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == panrp1SwapLottery, "Only panrp1SwapLottery");
    ...
    /**
     * @notice Set the address for the panrp1SwapLottery
     * @param _panrp1SwapLottery: address of the MoonBizSwap lottery
     */
    function setLotteryAddress(address _panrp1SwapLottery) external onlyOwner {
        panrp1SwapLottery = _panrp1SwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IPanrp1SwapLottery(panrp1SwapLottery).viewCurrentLotteryId();
    }
}