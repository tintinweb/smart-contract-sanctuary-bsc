    ...
    PermissionExtension
{
    ...
    event ListNFT(address indexed from, uint256 tokenId, uint256 price, bool isBUSDPrice);
    ...
    function listNft(
        ...
        _listDetail[tokenId] = ListDetail(
            ...
            price,
            tokenId,
            expireTime == 0 ? 0 : block.timestamp + expireTime * 1 days,
            false,
            true,
            isBUSDPrice
        );
        emit ListNFT(msg.sender, tokenId, price, isBUSDPrice);
    }
