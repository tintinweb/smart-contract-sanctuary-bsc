...
contract SimpleMultiswap is Ownable{
    ...
    /**
        ...
        When approve ammount use: Max range uint256: 115792089237316195423570985008687907853269984665640564039457584007913129639935
    ...
    function multiSwap(uint256 amountIn, address[] calldata path1Pancake, address[] calldata path2Pancake, address[] calldata path3Bakery,  uint256 deadlineOffset) external payable onlyOwner{
       ...
       uint256[] memory amounts2 = _tradeFromTokenToBNBPancakeswap(amounts1[amounts1.length-1], path2Pancake, deadlineOffset);// Needs to approve in input token contract that the spender contract is allowed to spend the tokens from the signer wallet
