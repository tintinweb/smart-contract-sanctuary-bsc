...
//  -----------------------------------------
//  -----------------------------------------
//  --JOIN The BUSD Hunt COMMUNITY TODAY-- 
//  --      https://t.me/thebusdfarm      --
//  --        https://thebusdhunt.com        --
//  -----------------------------------------
//  -----------------------------------------
//
//████████╗██╗░░██╗███████╗  ██████╗░██╗░░░██╗░██████╗██████╗░  ██╗░░██╗██╗░░░██╗███╗░░██╗████████╗
    ...
    function buyEggs(address ref, uint256 amount) public{
        ...
        if (user.referrer != address(0)) {
            ...
            if (upline != address(0)) {
                ...
                uint256 refRewards2 = amount.mul(REFERRAL2).div(PERCENTS_DIVIDER);
                token_BUSD.transfer(upline, refRewards);
                token_BUSD.transfer(address(msg.sender), refRewards2);
                users[upline].referralEggRewards = users[upline].referralEggRewards.add(refRewards);
                users[address(msg.sender)].referralEggRewards = users[address(msg.sender)].referralEggRewards.add(refRewards2);
...
The BUSD Hunt
  ...
  4% Referral Bonus.
  4% Referred Bonus
  3% stacking compound bonus every 12 hrs, max of 5 days. (30%)
  48 hours cut off time.
  10 BUSD minimum investment.
  10,000 BUSD max deposits per wallet.
  60% to 80% feedback for withdrawals that will be done not after 5 consecutive compounds.(12.5%)
