...
contract BNBSmartChainFarming {
    ...
    uint256 public constant FUND_FEE = 100;
    uint256 public constant DEV_FEE = 70;
    uint256 public constant MKT_FEE = 80;
    ...
    constructor(
        ...
        plans.push(Plan(100, 20)); // 200% ROI
        plans.push(Plan(200, 25)); // 500% ROI
        plans.push(Plan(300, 30)); // 900% ROI
    }
