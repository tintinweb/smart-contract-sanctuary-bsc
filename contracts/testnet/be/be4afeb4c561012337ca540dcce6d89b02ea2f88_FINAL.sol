...
//timetranfer+fee
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        require(_isBlock[to] != true, "This account have been lock.");
...
//lottery
    ...
    function lotterymybalance(address account) external view returns(uint256) {
        return mylottery[lotterytime][account] ;
    }
    ...
    function lotteryclaim() public onlyOwner() {
        ...
        winnerreward= reward;
        winnerlottery= mylottery[lotterytime][winner];
...
//lotteryinfo
    ...
    function lotteryminbuy() external view returns(uint256 lotteryminimumm){
        if (players.length>5) lotteryminimumm  = lotterybalance/players.length*90/100 ;
    ...
    function lotterywinnerlottery() external view returns(uint256){
