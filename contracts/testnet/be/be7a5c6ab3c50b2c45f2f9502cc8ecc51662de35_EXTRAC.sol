...
/*
 * Only for test do pay here money. We test only for bugs. No option to refund etc.
 */
...
contract ERC20 is Context, IERC20, IERC20Metadata, ReentrancyGuard {
    ...
    string private _name = "EXTRAC";
    string private _symbol = "MCLAND";
...
contract EXTRAC is ERC20, Ownable {
