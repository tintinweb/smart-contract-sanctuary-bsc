...
contract Talon is ERC20Interface, SafeMath {
    ...
    constructor() public {
        ...
        endIcoBlock = safeAdd(startBlock, transferLockup);
        transferStartDate = safeAdd(startBlock, transferLockup);
        icoTokensPerETH = 10000;
        ...
        reflectPercentPerTransaction = 4;
        devPercentPerTransaction = 1;
    ...
    function transfer(address to, uint amount) public returns (bool success) {
        ...
        if (msg.sender != ownerAddress && msg.sender != reflectionPoolAddress) {
            ...
            // burn specified amount on tx
            _totalSupply = safeSub(_totalSupply, burned_amt);
            balances[address(0)] = safeAdd(balances[address(0)], burned_amt);
            emit Transfer(msg.sender, address(0), burned_amt);
            burnedTokens = burnedTokens + burned_amt;
