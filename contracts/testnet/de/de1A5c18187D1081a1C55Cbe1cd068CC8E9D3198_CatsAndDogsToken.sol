...
contract CatsAndDogsToken is ERC20, Ownable, ERC20Burnable, ReentrancyGuard {
    mapping(address => uint256) private _balances;
    ...
    ILiquidityRestrictor public liquidityRestrictor =
        ILiquidityRestrictor(0x0000000000000000000000000000000000000000);
