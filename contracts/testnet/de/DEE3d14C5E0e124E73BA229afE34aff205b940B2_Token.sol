...
contract Token is ERC20, ERC20Burnable, Ownable {
    ...
    constructor(address _TokenStrategy, address _gnosisSafeWallet) ERC20("SOCCER CRYPTO", "SOT") {
    ...
    function _transfer(address sender, address recipient, uint amount) internal override antiWhale(sender, recipient, amount) {
        if (_excludedFromTax[sender] || transferTaxRate == 0) {
