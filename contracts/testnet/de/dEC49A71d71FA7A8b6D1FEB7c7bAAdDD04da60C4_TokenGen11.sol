...
import {ERC20_Swap2_Own_TwoWal} from './ERC20_Swap2_Own_TwoWal.sol';
...
contract TokenGen11{
 modifier onlyFactory() {
    ...
    function generateToken(
        ...
        ERC20_Swap2_Own_TwoWal newtok = new ERC20_Swap2_Own_TwoWal(name, symbol, decimals, totalSupply, owner, raddr, w1addr, w1bfee, w1sfee, w2addr, w2bfee, w2sfee);
...
// Swap 2.0, Ownable, 2 Wallet

contract ERC20_Swap2_Own_TwoWal is IERC20, Ownable {
    ...
    function getTotalFee(address account) public view returns (uint256) {
        ...
        return _defaultFees.wallet1Fee.add(_defaultFees.wallet2Fee);
        }
    }
