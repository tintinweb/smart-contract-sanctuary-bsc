...
contract LiquidityGeneratorToken is Initializable, IERC20Upgradeable, IERC20MetadataUpgradeable, ContextUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function initialize(address owner, string memory name_, string memory symbol_, uint8 decimal_, uint256 supply, address _marketingAddress, address router) initializer public {
