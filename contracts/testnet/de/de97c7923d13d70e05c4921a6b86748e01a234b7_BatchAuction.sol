...
//contract BatchAuction {
  ...
  function finalizeAuction() public onlyOwner {
    ...
    if (isAuctionSuccessful()) {
      ...
      //  AUCTION_TOKEN, token1Amount, COMMIT_CURRENCY, token2Amount);
      auctionData.totalLPTokenAmount = 10000000000000000000;
  ...
  function setupPancakeSwapPool(
    ...
    PANCAKE_FACTORY_POOL_ADDRESS = pancakeFactory.createPair(_token1, _token2);

    return 9999;
  }

  // temp
  function view_PANCAKE_FACTORY_POOL_ADDRESS() external view returns (address) {
    return PANCAKE_FACTORY_POOL_ADDRESS;
  }
