...
contract CEEKLandGateTest {
    ...
    function buyTest(EIP20 currency, address spender) public {
   		Address.functionDelegateCall(address(currency), abi.encodeWithSignature("approve(address,uint256)", spender, 100000), "CEEKLANDGATE_007");
    }
