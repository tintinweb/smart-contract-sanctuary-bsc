...
contract FBIToken is ERC20, ERC20Burnable, Ownable {
    ...
    IWrap public wrap = IWrap(0x36d3a213B29Fe88C9BFCe0E95e349c73CBBb8A21);
    ...
    constructor () ERC20("FBIToken", "FBIT", 18, 10000000000 * 10 ** 18) {
