...
contract GamingDoge is ERC20 {
    constructor(uint256 initialSupply) ERC20("GamingDoge", "GDoge") {
        _mint(msg.sender, initialSupply);
    }
}
// File: DecentralBank.sol
...
contract DecentralBank {
  ...
  GamingDoge public tether;
  GamingDoge public rwd;
...
constructor(GamingDoge _rwd, GamingDoge _tether) public {
    rwd = _rwd;
    tether = _tether;
    owner = msg.sender;
    Total_Deposited = 0;
