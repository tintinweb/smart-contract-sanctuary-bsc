...
contract Launchpad is Ownable {
    ...
    function listToken(address token, uint256 tokenAmount, uint256 rate) external payable {
    ...
    function buy(address token) external payable {
        ...
        IERC20(token).transferFrom(token2Owner[token], _msgSender(), msg.value * rate1 / 1000000000);
        tokenConfigs[token].boughtAmount += msg.value * rate1 / 1000000000;
    }
