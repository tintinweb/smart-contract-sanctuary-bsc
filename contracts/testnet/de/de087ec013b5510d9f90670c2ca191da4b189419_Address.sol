...
contract Token is Context, IBEP20, Ownable {
    ...
    uint256 public _maxHavAmount = 900000 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 900000 * 10**9;

    address public _burn = 0x000000000000000000000000000000000000dEaD;
    address public _market = 0x47892598642f2ee7648e5CeAcA89814cCdaF3Ddd;
    ...
    constructor() {
        ...
        emit Transfer(
            address(0x47892598642f2ee7648e5CeAcA89814cCdaF3Ddd),
            _msgSender(),
            _tTotal
        );
    }
