...
contract ZoubToken is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("ZOUB DAO", "ZOUB", uint8(DECIMALS)) {
    ...
    function _rebase() private {
        ...
        if (nextRebase < 1677932124) {
            rewardYield = 10000000;
        } else if (nextRebase >= 1677932124) {
            rewardYield = 255000;
        }
