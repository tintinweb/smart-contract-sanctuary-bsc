...
contract xxx is Context, IERC20, Ownable {
    ...
    string private _name = "xxq";  
    string private _symbol = "xxq"; 
    uint8 private _decimals = 9;

    uint public launchedBlock;
    uint public killblock = 2;
    bool public isLaunch = false; 
    address payable public marketingWalletAddress = payable(0xC64C75D5a9599FC220e667f6e104782bDF3929BD); // Marketing Address
    address payable public teamWalletAddress = payable(0xeBcb9a114BD8Ab45C0822e7368555b8e0009AC62); // Team Address
    ...
    function writeAntiwhale(address recipient, bool value) public onlyOwner {
