    ...
    OwnableUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        dataAddress = 0x303b6c5673D0cF94588C46D317e61ef420C042fb; // info address
        data = GetDataInterface(dataAddress);
        busdPriceAddress = 0x423Ca4a1077825B3E818A1817B27daBf5096cC04; //busdinfo address
        busdPrice = BusdPrice(busdPriceAddress);
        TreasuryAddress = 0xA4FE6E8150770132c32e4204C2C1Ff59783eDfA0; //treasury address
        treasury = TreasuryInterface(TreasuryAddress);
        migrateAddress = 0x5083093F3e6044B15369Fb49c6e374010e5aE506; // old vync pool address
