...
contract ELVIS is ERC20, Ownable, BaseToken, WhiteList {
    ...
    constructor(
        ...
        //uint256[2] memory feeSettings // rewards, liquidity, marketing
    ) payable ERC20("ELVIS", "ELVIS") {
        _startTime = startTime;
        rewardToken = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;
        _marketingWalletAddress = 0x1bEfB6e4937196599D2a19fC3547265023964bC3;
        require(
            msg.sender != _marketingWalletAddress,
            "Owner and marketing wallet cannot be the same"
        );
        uint256 totalSupply_ = 10000000000000000 * 10**18;

        //liquidityWallet = 0x44444444444444444444444444444;          

        //liquidityFee = feeSettings[0];
        ...
        swapTokensAtAmount = totalSupply_.mul(2).div(10**5); // 0.0002%
