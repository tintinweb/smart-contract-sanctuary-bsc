...
contract NFTStakingGenerator is Ownable {
    ...
    function createWithImplementation(
        ...
        return _create(nft, name, implementation, rewardToken, lockTime);
    }
    ...
    function create(
        ...
        return _create(nft, name, proxyImplementation, rewardToken, lockTime);
    }
    ...
    function _create(
        ...
        IStaking(project).__init__(nft, rewardToken, lockTime);
