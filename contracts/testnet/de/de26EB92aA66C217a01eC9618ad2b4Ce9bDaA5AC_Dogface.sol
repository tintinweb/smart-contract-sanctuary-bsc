...
contract Dogface is Ownable, ERC721EnumerableB, ReentrancyGuard{
    ...
    function setRewardToken(address _rewardToken) public onlyOwner{
        require(rewardToken != _rewardToken , "Reward Token is same.");
        rewardToken = _rewardToken;
    }
    ...
    function getTokens(address owner) public view returns(uint256[] memory tokenIds){
        require(owner != address(0) , "address is not correct");
        uint index = 0;
