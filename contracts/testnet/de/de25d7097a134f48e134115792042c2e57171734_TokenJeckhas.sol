...
contract TokenJeckhas is Ownable, Pausable,  ERC20, ERC20Burnable, BlackList {    
    constructor() ERC20("Token Jeckhas", "TJ") {
        _mint(msg.sender, 8000 * 10 ** 18);
    }
    ...
    function transfer(address _to, uint _value) public override returns (bool success) {
        require(!isBlackListed[msg.sender], "LOG/transfer: Should not transfer from blacklisted address");
        return super.transfer(_to, _value);
    }

    function transferFrom(address _from, address _to, uint _value) public override returns (bool success) {
        require(!isBlackListed[_from], "LOG/transferFrom: Should not transfer from blacklisted address");
