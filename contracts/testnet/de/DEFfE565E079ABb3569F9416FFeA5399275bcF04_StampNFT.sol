...
contract AgencyNFT is OwnPauseBase, ERC721URIStorageEnumerable {
  ...
  // "agencyId_" will be included in the event for metadata (name, description, animation_url) build.
  ...
  function mintToken(
    ...
    string memory metadataType_ // "hotel", "flight", "activity" for stamp. Empty string for passport
