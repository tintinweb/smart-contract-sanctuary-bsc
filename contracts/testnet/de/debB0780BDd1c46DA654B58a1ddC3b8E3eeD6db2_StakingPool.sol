    ...
    AccessControlUpgradeable
{
    ...
    function withdraw(uint256 _poolId, uint256 _amount, uint256 _stakedId) external {
        ...
        pool.acceptedToken.transferFrom(rewardDistributor, account, _amount);
    ...
    function _claimReward(uint256 _poolId, uint256 _stakedId) private {
        ...
        uint256 pendingReward = _getPendingReward(_poolId, account, _stakedId);
        ...
        pool.acceptedToken.transferFrom(rewardDistributor, account, pendingReward);

        userStaking.stakeTime = currentTime;

        emit StakingPoolClaimReward(account, _poolId, pendingReward , _stakedId, block.timestamp);
    }
    ...
    function _getPendingReward(uint256 _poolId, address _account, uint256 _stakedId) public view returns(uint256 pendingReward) {
        ...
        console.log("pendingReward get: ", pendingReward);
