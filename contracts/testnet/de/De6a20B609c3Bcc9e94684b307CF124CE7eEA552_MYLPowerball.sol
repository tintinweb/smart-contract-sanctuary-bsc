...
contract MYLPowerball {
    ...
    constructor (uint256 ticketPrice, uint256 purchaseTokenAmount, address owner, address _poolToken, uint256 _elapsedTime)  {
        _ticketPrice = ticketPrice;
        _purchaseTokenAmount = purchaseTokenAmount;
        _owner = owner;
        lottoCoin = IERC20(_poolToken);
        initiateSmartContractValue(_elapsedTime);
    }
    ...
    */
    ...
    uint256 private elapsedTime;   
    uint256 private elapsedLimit = 7889238; //3 months                                                           //variable to set time for powerball winning 
    ...
    */
    function initiateSmartContractValue(uint256 _elapseTime) public onlyOwner returns(bool){
        ...
        require(_elapseTime <= elapsedLimit, "Sale should end within elapsedLimit Time");      //elapsed time less than elapsed limit
    ...
    */
    ...
    function purchaseTicket(uint256 _ticketNumbers, uint256 ticketCount) external payable returns(bool)
    {
            ...
            if((saleStartTimeStamp[saleIdNow] + elapsedTime) > block.timestamp){
                ...
                saleStartTimeStamp[saleId] = block.timestamp;
    ...
    */
    function setElapsedTime(uint256 time) public onlyOwner returns(bool){
        ...
        require(time <= elapsedLimit, "Sale should end within elapsedLimit Time");      //elapsed time less than elapsed limit
     ...
     * @dev set elapsed time for powerball
    */
    function setElapsedLimit(uint256 time) public onlyOwner returns(bool){
        require(time > 0,"Invalid time provided, Please try Again!!");
    ...
    */
     ...
     * @dev get elapsed time for powerball
    */
    function getElapsedLimit() external view returns(uint256){
        return elapsedLimit;
    }
    ...
    */
    function getStartTime(uint256 _saleId) external view returns(uint256){
        return saleStartTimeStamp[_saleId];
    }
