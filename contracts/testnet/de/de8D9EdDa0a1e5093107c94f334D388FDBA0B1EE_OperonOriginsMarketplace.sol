...
contract OperonOriginsMarketplace {
    ...
    function placeOffering(
        ...
        require(tokenBalance >= saletoken[_tokenId][msg.sender] + _amount, "Limit Exceeds");
        ...
        saletoken[_tokenId][msg.sender] = saletoken[_tokenId][msg.sender] +  _amount;
    ...
    function cancelOffering(bytes32 _offeringId) external {
        ...
        saletoken[offeringRegistry[_offeringId].tokenId][msg.sender] = saletoken[offeringRegistry[_offeringId].tokenId][msg.sender] -  offeringRegistry[_offeringId].amount;
        ...
        payable
    {
        ...
        offeringRegistry[_offeringId].amount = offeringRegistry[_offeringId].amount - amount;
        saletoken[offeringRegistry[_offeringId].tokenId][offeringRegistry[_offeringId].offerer] = saletoken[offeringRegistry[_offeringId].tokenId][ offeringRegistry[_offeringId].offerer] -  amount;
    ...
    function burnToken(
        ...
        if (offer == 1) {
            offeringRegistry[_offeringId].amount = offeringRegistry[_offeringId].amount - amount;
            saletoken[tokenId][msg.sender] =  saletoken[tokenId][msg.sender] - amount;
        }
    ...
    function transfer(
        ...
        if (offer == 1) {
            offeringRegistry[_offeringId].amount = offeringRegistry[_offeringId].amount - amount;
            saletoken[offeringRegistry[_offeringId].tokenId][msg.sender] =  saletoken[offeringRegistry[_offeringId].tokenId][msg.sender] - amount;
        }
