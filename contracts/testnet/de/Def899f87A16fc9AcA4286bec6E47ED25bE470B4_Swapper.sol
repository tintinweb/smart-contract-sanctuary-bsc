...
contract Swapper is PaymentSplitterUpgradeable, OwnersUpgradeable {
    ...
    bool public openSwapCreateNodesWithTokens;
    bool public openSwapCreateNodesWithPending;
    ...
    function __Swapper_init_unchained(
        ...
        openSwapCreateNodesWithTokens = false;
        openSwapCreateNodesWithPending = false;
