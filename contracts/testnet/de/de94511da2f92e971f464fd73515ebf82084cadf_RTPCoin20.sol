 ...
 *
 * 
 * The RTPCoin is based on the Automatic Liquidity Pool & Custom Fees Architecture.
 *
 * 
 */
...
// File: RTP1.0/IPancakeFactory.sol
...
// File: RTP1.0/IPancakeRouter01.sol
...
// File: RTP1.0/IPancakeRouter02.sol
...
contract RTPCoin20 is Context, IBEP20, Ownable {

    using Address for address;
    using SafeMath for uint256;

    // : In Reflection contracts like RTPCoin, _reflectTotal is like the money shown in the balance sheets
    ...
    uint256 private _takeTotal = 1 * 10**6 * 10**9;
    uint256 private _reflectTotal = (MAX - (MAX % _takeTotal));
    uint256 private _takeFeeTotal;

    string private constant _name = "RTPCoin";
    string private constant _symbol = "RTP";
    ...
    uint256 public _maximumValueOfTransaction = 1 * 10**6 * 10**9 ;
    uint256 private numTokensSellToAddToLiquidity = 4 * 10**2 * 10**9 ;
