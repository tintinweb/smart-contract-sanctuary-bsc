...
contract CosmicFinanceToken is ERC20Detailed, Ownable {
    ...
    string public constant _name = "Cosmik Finance";
    string public constant _symbol = "COSMIK";
    ...
    uint256 public constant cosmikTrustFee = 25;
    uint256 public constant cosmikVaultFundFee = 50;
    uint256 public constant sellFee = 20;
    uint256 public constant firePitFee = 25;
    uint256 public totalFee =
        liquidityFee.add(cosmikTrustFee).add(cosmikVaultFundFee).add(
            firePitFee
        );
    ...
    address public cosmikVaultFundReceiver;
    ...
    constructor() ERC20Detailed("Cosmik Finance", "COSMIK", uint8(DECIMALS)) Ownable() {
        ...
        cosmikVaultFundReceiver = 0xd17Bc6123A197642D3944d0DA106342CEFBB7009;
        firePit = DEAD;
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.mul(_cosmikTrustFee.add(cosmikVaultFundFee)).div(feeDenominator)
        );
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(cosmikTrustReceiver).call{
            value: amountETHToCosmikTrustAndSIF.mul(cosmikTrustFee).div(
                cosmikTrustFee.add(cosmikVaultFundFee)
            ),
            gas: 30000
        }("");
        (success, ) = payable(cosmikVaultFundReceiver).call{
            value: amountETHToCosmikTrustAndSIF.mul(cosmikVaultFundFee).div(
                cosmikTrustFee.add(cosmikVaultFundFee)
            ),
            gas: 30000
        }("");
    ...
    function setFeeReceivers(
        ...
        address _cosmikVaultFundReceiver
    ) external onlyOwner {
        cosmikTrustReceiver = _cosmikTrustReceiver;
        cosmikVaultFundReceiver = _cosmikVaultFundReceiver;
    }
