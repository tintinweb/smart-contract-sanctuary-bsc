...
contract MULTIBNB {
	...
	uint constant public			INVEST_MIN_AMOUNT				= 50000000000000000;				// 20 MATIC
	uint[] public					REFERRAL_PERCENTS				= [50, 30, 20, 10, 5];	// 7% 2% 1% 0.5% 0.5%
	uint constant public			DEV_FEE							= 190;					// dev fee 1% of deposit
	uint constant public			MAX_WITHDRAW_AMOUNT				= 3000000000000000000 ether;			// claim 10000 MATIC max
