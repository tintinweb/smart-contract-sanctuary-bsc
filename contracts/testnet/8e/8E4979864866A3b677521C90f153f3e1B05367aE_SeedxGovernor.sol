...
interface IExecutorWithTimelock {
   ...
   **/
  function isProposalOverGracePeriod(ISeedxGovernor governance, uint256 proposalId)
    external
    view
    returns (bool);
...
interface IProposalValidator {
   ...
   **/
  function getMinimumPropositionPowerNeeded(ISeedxGovernor governance, uint256 blockNumber)
    external
    view
    returns (uint256);
   ...
   **/
  function isProposalPassed(ISeedxGovernor governance, uint256 proposalId)
    external
    view
    returns (bool);
   ...
   **/
  function isQuorumValid(ISeedxGovernor governance, uint256 proposalId)
    external
    view
    returns (bool);
   ...
   **/
  function isVoteDifferentialValid(ISeedxGovernor governance, uint256 proposalId)
    external
    view
    returns (bool);
...
/**
 * @title SeedX governor contract.
 * @author SeedX
 *
 * @notice Main point of interaction for SeedX governance. Holds governance proposals. Delegates to
  ...
  ISeedxGovernor
{
  ...
  string public constant EIP712_DOMAIN_NAME = 'SeedX Governance';
