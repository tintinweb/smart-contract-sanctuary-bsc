...
contract PredictionChecker is Ownable, Pausable {
    ...
    function checkRound(uint256 roundID)
        public
        view
        returns (
            bool _canRun,
...
interface IPredictionGame {
    ...
    function getResultBlock(uint256 round) external view returns (uint256);

    function executeRound(uint256 round) external;
}
