...
contract RewardDistributor is IRewardDistributor {
    ...
    IBEP20 public BUSD = IBEP20(0xF22d9792c7197C3c832B27CCEA92F4e4ee60D337);
...
contract Cashflow_Money_Inu is IBEP20, Ownable {
    ...
    address public BUSD = 0xF22d9792c7197C3c832B27CCEA92F4e4ee60D337; // Reward Token
    ...
    constructor() {
        ...
        marketFeeReceiver = address(0x48b9b9Ff4b7103b81b24212E2c5139FD66258304);
        devFeeReceiver = address(0x03B74EB671dC0D52B789C5E8234434B5eF54b414);
