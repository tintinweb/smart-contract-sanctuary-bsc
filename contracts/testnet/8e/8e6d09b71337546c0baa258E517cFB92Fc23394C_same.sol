...
// 0x23E87E1793B17725a0c241b659A3b5fb89aE4914 remember to remove liq 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    ...
    constructor() ERC20("same", "SMT") {
        ...
        // 3% on SELL
        // 0% on Transfer
        _feesRates = Fees({buyFee: 2200, sellFee: 2200, transferFee: 2200});
        ...
        address currentRouter = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    ...
    function swapTokensForUSD(uint256 tokenAmount) private swapping  {
        address[] memory path = new address[](2);
        ...
        // IERC20(BUSD).approve(address(dexRouter), type(uint256).max);
        // IERC20(BUSD).approve(address(lpPair), type(uint256).max);
