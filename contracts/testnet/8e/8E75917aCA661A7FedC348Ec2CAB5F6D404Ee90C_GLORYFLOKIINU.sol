...
contract GLORYFLOKIINU is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0xFDe5575218B26Dd738d41EF6b890B864F61A0438));
    address payable public devWallet =
        payable(address(0xFDe5575218B26Dd738d41EF6b890B864F61A0438));
    address public liquidityReceiver =
        0xFDe5575218B26Dd738d41EF6b890B864F61A0438;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "GLORYFLOKIINU";
    string private _symbol = "GLORYFLOKIINU";
