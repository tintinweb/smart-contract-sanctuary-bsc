...
contract HotNFT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("HotNFT", "HNFT") {

        address newOwner = address(0x6625850F0F9e189b2f7C7Dd479B0cc74065B3B85);
    	...
    	marketingWallet = address(0x29d6a85cAf79f2479c77757281De70eca1E92dCc); // set as marketing wallet
    	buyBackWallet = address(0x6625850F0F9e189b2f7C7Dd479B0cc74065B3B85); // set as buyback wallet
