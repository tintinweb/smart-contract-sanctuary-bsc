...
contract BNBSeed {
	...
	constructor(address payable wallet) public {
        ...
        plans.push(Plan(10000, 25920));
		plans.push(Plan(150, 40320));
		plans.push(Plan(80, 54720));
	}
	...
	function getUserInfo(address userAddress) public view returns(uint256 totalDeposit, uint256 totalWithdrawn, uint256 totalReferrals, uint256 yourboomplan, uint256 yourboompercent) {
		return(getUserTotalDeposits(userAddress), getUserTotalWithdrawn(userAddress), getUserTotalReferrals(userAddress), getyourboomplan(userAddress), getyourboompercent(userAddress));
	}
