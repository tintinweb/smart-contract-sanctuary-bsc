...
abstract contract VestingGovernanceToken is ERC20Burnable, Ownable {
    ...
    function _isExistAllocation(Allocation _allocation)
        ...
        returns (bool)
    {
        return allocationAmounts[_allocation].isValid ? true : false;
    }
        ...
        returns (uint256)
    {
        ...
        if (_currentTimestamp < 1665187200) {
            // 10M
            lockedAmount = lockedAmount.add(10 * _millions() * _tokenWei());
        }
        // 2022-10-12
        if (_currentTimestamp < 1665532800) {
            // 6M
            lockedAmount = lockedAmount.add(6 * _millions() * _tokenWei());
        }
        ...
        returns (uint256)
    {
        ...
        if (_currentTimestamp < 1665187200) {
            // 5M
            lockedAmount = lockedAmount.add(5 * _millions() * _tokenWei());
        }
        // 2022-10-11
        if (_currentTimestamp < 1665446400) {
            // 7M
            lockedAmount = lockedAmount.add(7 * _millions() * _tokenWei());
        }
        ...
        returns (uint256)
    {
        ...
        if (_currentTimestamp < 1665187200) {
            // 3M
            lockedAmount = lockedAmount.add(3 * _millions() * _tokenWei());
        }
        // 2022-10-13
        if (_currentTimestamp < 1665619200) {
            // 8M
            lockedAmount = lockedAmount.add(8 * _millions() * _tokenWei());
        }
        ...
        returns (uint256)
    {
        ...
        if (_currentTimestamp < 1665273600) {
            // 4M
            lockedAmount = lockedAmount.add(4 * _millions() * _tokenWei());
        }
        // 2022-10-13
        if (_currentTimestamp < 1665619200) {
            // 10M
        ...
        returns (uint256)
    {
        ...
        if (_currentTimestamp < 1665100800) {
            // 9M
            lockedAmount = lockedAmount.add(9 * _millions() * _tokenWei());
        }
        // 2022-10-13
        if (_currentTimestamp < 1665619200) {
            // 3M
