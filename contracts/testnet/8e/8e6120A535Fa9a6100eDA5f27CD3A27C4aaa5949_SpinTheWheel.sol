...
contract SpinTheWheel {
    ...
    event SpinComplete(address spinner, uint256 rewardIndex, uint256 rewardType, uint256 value);
    ...
    function spin(uint256 amount) external notPaused spinning{
        ...
        emit SpinComplete(msg.sender, rewardPos, reward.rewardType, reward.value);
