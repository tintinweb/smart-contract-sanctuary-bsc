...
contract ShibShark is Context, IERC20, Ownable {
    ...
    string private _name = "Shiba Shark";
    string private _symbol = "ShibShark";
    ...
    address payable public marketingWallet = payable(0x819aED3870581eDBc2345E9CCD8f8C5ADbc49bd7);
    uint256 private _previousmarketingFee = _marketingFee;

    IUniswapV2Router02 public  uniswapV2Router;
    address public  uniswapV2Pair;

    uint256 public maxBuyTransactionAmount = 20000000000000 * (10**18); // 2%
    uint256 public maxSellTransactionAmount = 50000000000000 * (10**18); // 5%
    uint256 public maxWalletToken = 50000000000000 * (10**18); // 5%
    
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = true;

    uint256 public numTokensSellToAddToLiquidity = 10000000000000 * 10**18;
    ...
    function setNumTokensSellToAddToLiquidity(uint256 newAmt) external onlyOwner() {
        numTokensSellToAddToLiquidity = newAmt;
    }
