...
contract TaroNFT is ERC1155Mintable, ERC1155Burnable, ERC1155HolderTokens, ERC1155Supply {
    ...
    constructor() ERC1155Mintable("https://taroverse.com/api/item/{id}.json") {
    }
...
abstract contract ERC1155HolderTokens is ERC1155 {
    ...
    function tokenIdsAndBalancesOf(address holder) public view returns (uint256[] memory tokenIds, uint256[] memory balances) {
...
library TaroNFTConstants {
    ...
    bytes internal constant NAME_IDS_2_CLASS_IDS = hex"000000000000000101010101010101010202020202020202020203030303030303030303030304040404050505050505050505050505050505050505";
     ...
     * @return classId the ID of the class name, 0 (Assasin), 1 (Diviner), 2 (Guardian), 3 (Mage), 4 (Sniper), 5 (Warrior)
