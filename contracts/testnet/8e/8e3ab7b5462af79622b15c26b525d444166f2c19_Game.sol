...
contract Data is PriceConsumerV3{
    ...
    constructor(){
        ...
        winTokenAddr = 0xc6a02366b9575376A1275E562fCBdd3Dca48395E;
        _gameData = GameData(0xD5dF015FF265fA8197Aa46Fc29EbfeE811eC6eDb);
        PoolAddr = 0xD5dF015FF265fA8197Aa46Fc29EbfeE811eC6eDb;
    ...
    function importSeedFromThird() internal view returns (uint8) {
        ...
        // );
                return uint8(
            (uint256(keccak256(abi.encodePacked(blockhash(block.timestamp % 256),msg.sender,block.gaslimit))) % 6) + 1
        );
    }
