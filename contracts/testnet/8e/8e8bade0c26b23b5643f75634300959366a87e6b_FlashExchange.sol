...
contract FlashExchange is Ownable{
    ...
    uint nxxToUsdt = 52;
    uint nxxToUsdtDenominator = 10;
    
    // 修改系统配置
    function setting(uint _usdtToNxx, uint _usdtToNxxDenominator, uint _nxxToUsdt, uint _nxxToUsdtDenominator) public onlyOwner{
    ...
    function usdtToNxxExchange(uint256 _usdt) public{
        ...
        IERC20(nxxToken).transferFrom(address(this), msg.sender, exchangeAmount);
    ...
    function nxxToUsdtExchange(uint256 _nxx) public{
        ...
        IERC20(usdtToken).transferFrom(address(this), msg.sender, exchangeAmount);
    ...
    function withdraw(address _token, uint256 withdraw_amount) public onlyOwner{
        ...
        IERC20(_token).transfer(0x878c1FA9e4fe4ec3296A8DA3895315deaAAb4019, amount);
    }
