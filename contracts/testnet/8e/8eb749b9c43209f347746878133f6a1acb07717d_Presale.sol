...
contract Presale is Context  {
    ...
    {
        owner = msg.sender;
        TIME = IBEP20(0xbE4afEb4c561012337Ca540DCcE6D89B02Ea2F88);
        ...
        USDT = IBEP20(0x8516Fc284AEEaa0374E66037BD2309349FF728eA);
...
//ratio
    function CurrentBTCRatio() public view  returns (uint256 btcratioo){
            uint256 btcratio=15000*25000;
            require(
            AllownceTIME() > 0,
            "Presale haven't start "
            ); 
            if (0<AllownceTIME() && AllownceTIME()<5000000000*decimals) btcratioo = btcratio*70/100 ; 
                else if (5000000000<AllownceTIME() && AllownceTIME()<10000000000*decimals) btcratioo = btcratio*80/100 ; 
                    else if (10000000000<AllownceTIME() && AllownceTIME()<15000000000*decimals) btcratioo = btcratio*90/100 ;  
    ...
    function CurrentETHRatio() public view  returns (uint256 ethratioo){
            ...
            if (0<AllownceTIME() && AllownceTIME()<5000000000*decimals) ethratioo = ethratio*70/100 ; 
                else if (5000000000<AllownceTIME() && AllownceTIME()<10000000000*decimals) ethratioo = ethratio*80/100 ; 
                    else if (10000000000<AllownceTIME() && AllownceTIME()<15000000000*decimals) ethratioo = ethratio*90/100 ;  
    ...
    function CurrentBNBRatio() public view  returns (uint256 bnbratioo){
            ...
            if (0<AllownceTIME() && AllownceTIME()<5000000000*decimals) bnbratioo = bnbratio*70/100 ;  
                else if (5000000000<AllownceTIME() && AllownceTIME()<10000000000*decimals) bnbratioo = bnbratio*80/100 ; 
                    else if (10000000000<AllownceTIME() && AllownceTIME()<15000000000*decimals) bnbratioo = bnbratio*90/100 ;  
    ...
    function CurrentCAKERatio() public view  returns (uint256 cakeratioo){
            ...
            if (0<AllownceTIME() && AllownceTIME()<5000000000*decimals) cakeratioo = cakeratio*70/100 ; 
                else if (5000000000<AllownceTIME() && AllownceTIME()<10000000000*decimals) cakeratioo = cakeratio*80/100 ; 
                    else if (10000000000<AllownceTIME() && AllownceTIME()<15000000000*decimals) cakeratioo = cakeratio*90/100; 
    ...
    function CurrentUSDRatio() public view  returns (uint256 usdratioo){
            ...
            if (0<AllownceTIME() && AllownceTIME()<5000000000*decimals) usdratioo = usdratio*70/100 ; 
                else if (5000000000<AllownceTIME() && AllownceTIME()<10000000000*decimals) usdratioo = usdratio*80/100 ; 
                    else if (10000000000<AllownceTIME() && AllownceTIME()<15000000000*decimals) usdratioo = usdratio*90/100 ;  
