...
contract FOFPlayerController3 is Ownable {
    ...
    function getSells() public view returns(uint256[] memory sellNFTIDs, uint256[] memory prices) {
    ...
    function getSellsByType(uint256 NFTType) public view returns(uint256[] memory sellNFTIDs, uint256[] memory prices) {
    ...
    function getUserSellsByType(address user, uint256 NFTType) public view returns(uint256[] memory sellNFTIDs, uint256[] memory prices) {
        ...
        for(i = 0; i < sellTokenIds.length; i++){
            if(FPN.ownerOf(sellTokenIds[i]) == user && FPN.NFTTypes(sellTokenIds[i]) == NFTType){
