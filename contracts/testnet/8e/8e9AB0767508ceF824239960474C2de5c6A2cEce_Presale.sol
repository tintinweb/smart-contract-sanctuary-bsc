...
contract Presale is ReentrancyGuard, Ownable {
    ...
    function userWithdrawTokens () public nonReentrant {
		...
		uint256 sale = IERC20(presale_info.sale_token).balanceOf(address(this)).mul(buyer.sale).div(remaintoken);
		require(sale > 0, 'MAPPY_Withdraw: NOTHING TO WITHDRAW');
		...
		TransferHelper.safeTransfer(address(presale_info.sale_token), msg.sender, sale);
