...
contract Auction is IERC721Receiver {
    ...
    */
    function createTokenAuction(
        ...
        require(_enddate > 0, "Invalid duration value");
        require(_startingdate > 0, "Invalid duration value");
    ...
    */
    function bid(address _nft, uint256 _tokenId) external payable {
        ...
        require(auction.enddate > auction.startingdate, "Deadline already passed");
    ...
    */
    function executeSale(address _nft, uint256 _tokenId) external {
        tokenDetails storage auction = tokenToAuction[_nft][_tokenId];
        require(auction.enddate <= auction.startingdate, "Deadline did not pass yet");
