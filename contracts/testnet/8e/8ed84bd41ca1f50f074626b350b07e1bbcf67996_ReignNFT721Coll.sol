...

{
    ...
    ReignNFT721 public ReignNFT721M;
    ...
    {   
        ...
        ReignNFT721 _ReignNFT721M = ReignNFT721(originalContract);
        // set the rest of the contract variables
        ReignNFT721M = _ReignNFT721M;
    ...
    function getServiceFeeESC() public view returns (uint256) {
        return  ReignNFT721M.getServiceFeeESC();
    }

    function getServiceFee() public view returns (uint256) {
        return  ReignNFT721M.getServiceFee();
    }
    ...
    function newtokenasbid(
        ...
        uint256 serviceVal = ReignNFT721M.getServiceFee();
        if(keccak256(bytes(tokenAss)) == keccak256(bytes("NIL")))
        {
             serviceVal = ReignNFT721M.getServiceFeeESC();
        }

        address payable admin =  payable(ReignNFT721M.getOwner());
