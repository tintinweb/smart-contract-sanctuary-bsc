...
contract ABC_BUSD {
    ...
    struct data {
        ...
        uint256 ThirdDistributionTime;
        uint256 PercentageOnFirstDist;
        uint256 PercentageOnSecondDist;
        uint256 PercentageOnThirdDist;
    }
    ...
    constructor( 
            ...
            uint256 _firstDistributionTime,
            uint256 _secondDistributionTime,
            uint256 _thirdDistributionTime,
            uint256 _pctOnFisrtDist,
            uint256 _pctOnScdDist,
            uint256 __pctOnThdDist
        ) 
        {
            ...
            inData.FirstDistributionTime = _firstDistributionTime;
            inData.SecondDistributionTime = _secondDistributionTime;
            inData.ThirdDistributionTime = _thirdDistributionTime;
            inData.PercentageOnFirstDist = _pctOnFisrtDist;
            inData.PercentageOnSecondDist = _pctOnScdDist;
            inData.PercentageOnThirdDist = __pctOnThdDist;
    }
   ...
   function updateInfoData(
    ...
    function lockFund(uint256 _tokenAmount) public checkLocked{
        ...
        require(block.timestamp <= inData.FirstDistributionTime, "Can't LockFund during distribution time");
    ...
    function getUser(address _user) public view returns(uint256 reward, uint256 firstBatch, uint256 secondBatch, uint256 thirdBatch) {
        data memory inData = getData[0];
        ...
        return ( reward, firstBatch, secondBatch, thirdBatch );
    }
    ...
    function viewData() public view returns(
        ...
        return(
            ...
            inData.lockedFunds,
            inData.maxLock,
            inData.FirstDistributionTime,
            inData.SecondDistributionTime,
            inData.ThirdDistributionTime,
            inData.PercentageOnFirstDist,
            inData.PercentageOnSecondDist,
            inData.PercentageOnThirdDist
        );
    }
