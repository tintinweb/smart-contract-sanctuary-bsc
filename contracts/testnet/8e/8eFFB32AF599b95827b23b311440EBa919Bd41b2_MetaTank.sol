...
contract MetaTank is Context, IERC20, IERC20Extented, Ownable {
    ...
    uint256 public constant _tTotal = 77777777777 * 10**18;
   ...
   //overall ether distribution
    ...
    address payable private _marketingAddress = payable(0x0913b9204B5cC582AeA84c38a9f0891e9221CB70);
    address payable private _teamAddress = payable(0x0913b9204B5cC582AeA84c38a9f0891e9221CB70);
    address payable private _devAddress = payable(0x0913b9204B5cC582AeA84c38a9f0891e9221CB70);
    address payable private _liqudityAddress = payable(0x0913b9204B5cC582AeA84c38a9f0891e9221CB70);
    address payable private _ecoSystemAddress = payable(0x0913b9204B5cC582AeA84c38a9f0891e9221CB70);
    address payable private _stakingAddress = payable(0x0913b9204B5cC582AeA84c38a9f0891e9221CB70);
    address payable private _rewardsAddress = payable(0xAF4F0d3439bea3aE3Dc71e311d7F039d9808C447);
    ...
    constructor() {
        ...
        address my = 0x467C761F9d68D24D70B2cC8916713fb864df4184;
