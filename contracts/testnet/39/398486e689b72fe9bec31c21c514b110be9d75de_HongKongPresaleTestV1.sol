...
contract HongKongPresaleTestV1 {
    ...
    function buyToken(address buyer, uint256 numberOfTokens) public payable {
        require(!_paused,"Contract is Paused!");
        require(numberOfTokens*10**18 <= maxPresaleTokenBuy, "You cant buy more than 1.000.000 Tokens,1");
        require( presaleAmountGathered[msg.sender] + numberOfTokens*10**18 <= maxPresaleTokenBuy,"You cant buy more than 1.000.000 Tokens,2");
        require(msg.value >= numberOfTokens*tokenPresalePrice);
