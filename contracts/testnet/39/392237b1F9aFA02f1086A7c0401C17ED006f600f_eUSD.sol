    ...
    WhitelistUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        setMinimumFee(0);
        setMinimumSentToChainAmount(10 * (10**uint256(decimals())));
        setBridgeFee(3 * 100000); //0.3%
        setFeeTreasury(multiSigTreasury);
        _mint(multiSigTreasury, 10000000 * (10**uint256(decimals())));
    }
    ...
    function sendToChain(
        ...
        uint256 fee = (amount * _bridgeFee) / 100000000; // fee 0.3%
    ...
    function bridgeFee() public view returns (uint256, string memory) {
        ...
        string memory res = string(bstr);
        return (_bridgeFee, string.concat(res, "%"));
    }
