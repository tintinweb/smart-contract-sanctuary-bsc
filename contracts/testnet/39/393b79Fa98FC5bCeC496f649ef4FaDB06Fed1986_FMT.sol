...
contract FMT is ERC20, Ownable {
    ...
    constructor() ERC20("fmt", "FMT", 18) {
    	...
    	marketingWallet = address(0xF74BE446960e9630784EcACC7DF390bAf5E10cBe); // set as marketing wallet
    	liquidityWallet = address(0x81395360910ad19B0e46915B586bbf2308d15b00); // set as liquidity wallet
        stakingAddress = address(0x1d52905C889fC7A3d6f89F89B40DA196aDa1aEb7); // set as staking wallet / contract
        jumpStartWallet = address(0xbe9adE86e87773Bf222610353020e88f64F1878E); // set as Jump Start wallet
        utilityWallet = address(0x7783f3515141dEDFE2B3FDc3a41a6154F5A481c4); // set as utility wallet
