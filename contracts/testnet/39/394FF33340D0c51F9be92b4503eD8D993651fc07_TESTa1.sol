...
contract TESTa1 is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress = payable(0x2cB4C4525798DF7C60a0a3398DA779b397EeafE2); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0xd11bB2a258a6cFC6E2D56754accBaDaA573Fc1C6); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0xbd845CFb434d30D9718497f4d63daEaC316f4924); // charity Wallet Address
    address payable public devWalletAddress = payable(0x2cB4C4525798DF7C60a0a3398DA779b397EeafE2); // dev Wallet Address
    ...
    string private constant _name = "TESTa1";
    string private constant _symbol = "TTa1";
    ...
    constructor () {
        address _owner = 0xe2AD3c323ba9bFBD01CB57eB0Ddb066e5111198E;
