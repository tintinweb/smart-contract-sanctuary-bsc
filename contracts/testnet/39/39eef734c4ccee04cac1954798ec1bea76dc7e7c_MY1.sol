...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
 ...
 //address public immutable ETH = address(0x2170Ed0880ac9A755fd29B2688956BD959F933F8); //ETH
  address public immutable ETH = address(0x1Caf3796CA4f33dbf775C458e7086191454473dC); //ETH
...
contract MY1 is ERC20, Ownable {
   ...
   ERC20DividendTracker public dividendTracker;
    ...
    uint256 public swapTokensAtAmount = 50000000 * (10**6) * (10**18); 
    uint256 public maxTransactionAmount = 1000000000000 * (10**9) * (10**18); //1%
  ...
  //  uint256 public extraFeeOnSell = 4;
    uint256 public _BuyTotalFees = _BuyETHRewardsFee.add(_BuyBurnFee).add(_BuyMarketingFee).add(_BuyDevFee);
    
    uint256 public _SellETHRewardsFee = 2;
    uint256 public _SellBurnFee = 1;
    uint256 public _SellMarketingFee = 2;
    uint256 public _SellDevFee = 4;
    uint256 public _SellTotalFees = _SellETHRewardsFee.add(_SellBurnFee).add(_SellMarketingFee).add(_SellDevFee);
    
    uint256 public maxWalletToken = 10000000000000 * (10**9) * (10**18); //1%

    address public _marketingWalletAddress = 0x96A0ff4fC33e12dcAc3CD29498203073Fc064158;
    address public _developmentWalletAddress = 0x971795c37d02A05758d45b8557c1a0eeF33904B5;
    ...
    constructor() ERC20("rewardineth", "rieth") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        ERC20DividendTracker newDividendTracker = ERC20DividendTracker(payable(newAddress));
    ...
    {
        require(_isExcludedFromMaxTx[account] != excluded, "ERC20: Account is already the value of 'excluded'");
    ...
    {
        require(_isExcludedFromMaxWallet[account] != excluded, "ERC20: Account is already the value of 'excluded'");
    ...
    function setDevelopmentWallet(address payable wallet) external onlyOwner{
      ...
      function setBuyFees(uint256 buyEthRewardFee, uint256 BuyBurnFee, uint256 buyMarketingFee, uint256 buyDevFee) external onlyOwner
    {
        _BuyETHRewardsFee = buyEthRewardFee;
        _BuyBurnFee = BuyBurnFee;
        _BuyMarketingFee = buyMarketingFee;
        _BuyDevFee = buyDevFee;
        _BuyTotalFees = _BuyETHRewardsFee.add(_BuyBurnFee).add(_BuyMarketingFee).add(_BuyDevFee);
        require(_BuyTotalFees >= 0 && _BuyTotalFees <= 20, "Fees are exceeding the limits");
    }

    function setSellFees(uint256 sellEthRewardFee, uint256 SellBurnFee, uint256 sellMarketingFee, uint256 sellDevFee) external onlyOwner
    {
        _SellETHRewardsFee = sellEthRewardFee;
        _SellBurnFee = SellBurnFee;
        _SellMarketingFee = sellMarketingFee;
        _SellDevFee = sellDevFee;
        _SellTotalFees = _SellETHRewardsFee.add(_SellBurnFee).add(_SellMarketingFee).add(_SellDevFee);
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 800000, "ERC20: gasForProcessing must be between 200,000 and 800,000");
    ...
    function _transfer(
        ...
        
        {
            ...
            uint256 swapTokens = contractTokenBalance.mul(_SellBurnFee).div(_SellTotalFees);
...
contract ERC20DividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() DividendPayingToken("ERC20_Dividen_Tracker", "ERC20_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 200000+ tokens
    }

    function _transfer(address, address, uint256) internal pure override {
        require(false, "ERC20_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(false, "ERC20_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ERC20 contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "ERC20_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "ERC20_Dividend_Tracker: Cannot update claimWait to same value");
