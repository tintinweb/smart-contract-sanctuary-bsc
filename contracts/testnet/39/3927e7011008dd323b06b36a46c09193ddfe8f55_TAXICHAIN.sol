...
interface IUniswapV2Router02 {
...
}contract TAXICHAIN is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 69000000000000000 * 10**18;
    ...
    constructor () {
        _taxWallet = payable(0x373E23E1978D22b0A47E62C4b98A2ef76BBd0Fee);
        _liqWallet = payable(0x373E23E1978D22b0A47E62C4b98A2ef76BBd0Fee);
        _liqFee = 3;
        _taxFee = 9;
    ...
    function higuysbro() external onlyOwner() {
