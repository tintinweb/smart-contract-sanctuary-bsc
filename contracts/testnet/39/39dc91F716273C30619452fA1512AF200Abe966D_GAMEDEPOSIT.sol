...
contract GAMEDEPOSIT  {
    ...
    function getUserInfo(address usr,address asset) public view returns(address recommend,uint256 rechargeed){
        recommend = recommended[usr];
        rechargeed = userInfo[usr][asset].rechargeed;
    }
