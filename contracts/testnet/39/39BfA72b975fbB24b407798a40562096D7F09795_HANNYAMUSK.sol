...
contract HANNYAMUSK is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        _isTxLimitExempt[_marketingWallet] = true;
   ...
   function excludeFromFee(address account) public onlyOwner {
    ...
    function _transfer(
        ...
        if (balanceOf(address(this)) >= swapTokensAtAmount && !swapping && from != uniswapV2Pair && from != owner() && to != owner()) {
            swapping = true;
    ...
    function setFees(uint256 marketingFee, uint256 liquidityFee) external onlyOwner() {
