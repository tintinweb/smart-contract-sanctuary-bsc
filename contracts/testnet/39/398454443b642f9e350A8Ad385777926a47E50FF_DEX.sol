...
contract asas is IBEP20, Ownable {

    string public constant name = "asas";
    string public constant symbol = "asas";
    uint8 public constant decimals = 11;

    
    mapping(address => uint256) balances;
    mapping(address => mapping (address => uint256)) allowed;
    uint256 totalSupply_ = 111111 *10 **decimals;
