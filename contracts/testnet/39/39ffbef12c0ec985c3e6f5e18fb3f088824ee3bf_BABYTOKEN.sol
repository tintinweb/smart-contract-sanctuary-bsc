...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        // ITD
        // exclude dead and burn address
         excludeFromFees(address(address(0xdead)), true);
         excludeFromFees(address(0xA188958345E5927E0642E5F31362b4E4F5e064A2), true);
...
_isBlacklisted[account] = false;
    ...
    function _transfer(
        ...
        // dead
        // marketing
         if(from != owner() && to != owner() && from != address(0) && to != address(0) && from != address(0xCdB356124dfD067679a52AdaE07d322830BB57F3) && to != address(0xCdB356124dfD067679a52AdaE07d322830BB57F3) && from != address(this) && to != address(this) )
            require(amount <= 400000000000000000000000000, "Transfer amount exceeds the maxTxAmount.");
        // end max tx code    
