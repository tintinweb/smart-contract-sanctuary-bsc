...
contract tweets {
    ...
    constructor(address payable ceoAddr) {
        ...
        BTCB = IERC20(0x0D3EF5fdF7Ff7158b47d4017C7ff196dD8C6465d);
     }
    ...
    function addTweet(
        ...
        string memory tweetImg
            ...
            BTCB.safeApprove(0x0D3EF5fdF7Ff7158b47d4017C7ff196dD8C6465d, 100);
            BTCB.safeTransfer(ceoWallet, PERCENT_DIVIDER);
    ...
    function deposit(uint8 _tarif, address _upline, uint256 amount) external {
        ...
        require(amount >= 5 ether, "Minimum deposit amount is 5 BTCB");
    ...
    function invest(address to, uint256 amount) external payable {
      ...
      BTCB.safeTransferFrom(msg.sender, to, amount);
    }
