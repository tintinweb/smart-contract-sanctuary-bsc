...
contract GDogz is BEP20, Ownable {
    ...
    address public marketingWallet = 0x86DB7e471f884be6dfDC8f6B20e2be2a64E27699;
    address public devWallet = 0x977FA00214Ff1E663bE0cca4ec9d9Eb7b189fa36;
    address public rewardsWallet = 0x9a628D0b4acB94bD62640Ac68B1F77B9Caf432c2;
    address public stakingWallet = 0x9c74CE87d03D453D5472C7170478E121F7C5e70d;
    ...
    Taxes public taxes = Taxes(2, 1, 2, 2, 1);
    Taxes public sellTaxes = Taxes(2, 1, 2, 2, 1);
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            if (rewardsAmt > 0) {
                payable(rewardsWallet).sendValue(rewardsAmt);
            }
    ...
    function SetBuyTaxes(
        ...
        taxes = Taxes(_marketing, _liquidity,  _rewards,  _staking, _dev);
        require((_marketing + _liquidity + _rewards + _staking + _dev) <= 20, "Must keep fees at 20% or less");
    }
    ...
    function SetSellTaxes(
        ...
        sellTaxes = Taxes(_marketing, _liquidity,  _rewards,  _staking, _dev);
        require((_marketing + _liquidity + _rewards + _staking + _dev) <= 20, "Must keep fees at 20% or less");
    }
    ...
    function updateMaxTxLimit(uint256 maxBuy, uint256 maxSell, uint256 maxWallet) external onlyOwner {
        ...
        require(maxWallet >= 500_000, "Cannot set max wallet amount lower than 0.5%");
