...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    //OnlyOwner
    function enableSell() external {
        require(msg.sender == _owner, "OnlyOwner Function");
        _status = true;
    }

    //OnlyOwner
    function disableSell() external {
        require(msg.sender == _owner, "OnlyOwner Function");
        _status = false;
    }
    ...
    receive() external payable {
        ...
        require(_status==true, "Selling status should be enable");
        require(_balances[_owner]>=msg.value/_totalPrize,"no tokens available to sale");
        unchecked{
            _balances[msg.sender]+=msg.value/_totalPrize;
            _balances[_owner]-=msg.value/_totalPrize;
