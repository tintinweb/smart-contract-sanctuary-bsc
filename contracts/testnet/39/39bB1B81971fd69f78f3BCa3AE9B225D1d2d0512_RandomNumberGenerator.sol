...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public SEEKSwapLottery;
     ...
     * @param _seed: seed provided by the SEEKSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == SEEKSwapLottery, "Only SEEKSwapLottery");
    ...
    /**
     * @notice Set the address for the SEEKSwapLottery
     * @param _SEEKSwapLottery: address of the SEEKSwap lottery
     */
    function setLotteryAddress(address _SEEKSwapLottery) external onlyOwner {
        SEEKSwapLottery = _SEEKSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ISEEKSwapLottery(SEEKSwapLottery).viewCurrentLotteryId();
    }
}