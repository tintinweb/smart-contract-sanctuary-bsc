...
contract dailydollars is notConation {
    ...
    event InvestedOther(address Caller, uint256 Earned);
 ...
 function packageactiveother(uint256 _amount,address _otherAdd) external payable {
        require(users[msg.sender].is_exist == true,  "User not Exist");
            Busd.transfer(_otherAdd, _amount);
           emit InvestedOther(_otherAdd,_amount);
    } 
