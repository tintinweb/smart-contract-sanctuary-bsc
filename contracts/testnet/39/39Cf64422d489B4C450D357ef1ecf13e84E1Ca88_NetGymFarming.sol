...
contract NetGymFarming is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(
        ...
        buyBackComission = 4;
        buyBack = 0x8e246D24915b425fe7a578530EFaF4746D8E1B0C;
        ROUTER_ADDRESS = 0xD00C7e4c6bDd8FE20159E31FaD5389482CDbE46B;
        wbnbAddress = address(0xDfb1211E2694193df5765d54350e1145FD2404A1);
        liquidityProvider = ILiquidityProvider(
            0xa832DEa34135a1e5c5f68bD002535C5fFD8F60B9
        );
