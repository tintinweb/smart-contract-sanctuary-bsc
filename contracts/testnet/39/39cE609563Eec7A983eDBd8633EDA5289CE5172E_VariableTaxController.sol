...
contract VariableTaxController is OwnableUpgradeable {
    ...
    function getBoosterRate( address _addr ) public view returns (uint256){
        ...
        for(uint256 i = 0; i < userStats[_addr].boosterslots.length; i++){
    ...
    function getBoosterSlotInfo(address _addr) public view returns (uint256 _slot0, uint256 _slot1, uint256 _slot2 ){
        _slot0 = userStats[_addr].boosterslots[0].boost;
        _slot1 = userStats[_addr].boosterslots[1].boost;
        _slot2 = userStats[_addr].boosterslots[2].boost;
    }
