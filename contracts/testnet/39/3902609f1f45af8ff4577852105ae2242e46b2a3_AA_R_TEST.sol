...
contract AA_R_TEST is Context, IERC20 { 
 ...
 //   _excluded.push(address(this)); // XXXX 
    ...
    */
    ...
    // XXX MOVE TO CORRECT PLACE
    function Contract_Setup_Create_Liqudidty_Pool() payable external onlyOwner {
 ...
 function Liquidity_Percent_on_Contract() external view returns(uint256) {
        ...
        if (OnContract == inTotal){return 100;} else {
        return (OnContract * 100 / inTotal);}
