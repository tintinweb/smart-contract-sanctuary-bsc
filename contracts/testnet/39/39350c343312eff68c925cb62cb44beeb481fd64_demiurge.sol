...
contract demiurge is ERC20Detailed, Ownable {
    ...
    uint256 public rewardYield = 10;
    uint256 public rewardYieldDenominator = 100;
    // max buy and sell
    ...
    uint256 public nextRebase = inception;

    mapping(address => bool) _isFeeExempt;
    address[] public _markerPairs;
    mapping (address => bool) public automatedMarketMakerPairs;

    uint256 public constant MAX_FEE_RATE = 333;
    uint256 private constant MAX_REBASE_FREQUENCY = 3600;
    uint256 private constant DECIMALS = 18;
    uint256 private constant MAX_UINT256 = ~uint256(0);
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 44444444 * 10**DECIMALS;
    ...
    uint256 public liquidityFee = 31;
    uint256 public treasuryFee =45;
    uint256 public burnFee = 2;
    uint256 public buyFeeRFV = 22;
    uint256 public sellFeeTreasuryAdded = 61;
    uint256 public sellFeeRFVAdded = 39;
    ...
    uint256 public totalFee = totalBuyFee + totalSellFee;
    ...
    constructor() ERC20Detailed("demi", "accelerated", uint8(DECIMALS)) {
    ...
    function manualRebase() external onlyOwner{
        require(!inSwap, "inSwap is true");
        require(nextRebase <= block.timestamp, "waiting for nextRebase");
...
// external rebase variables
    ...
    function setRebaseFrequency(uint256 _rebaseFrequency) external onlyOwner {
        require(_rebaseFrequency <= MAX_REBASE_FREQUENCY, "max rebase exceeded");
    ...
    function setMaxSellTransaction(uint256 _maxSellTxn) external onlyOwner {
        maxSellTransactionAmount = _maxSellTxn;
    }

    function setMaxBuyTransaction(uint256 _maxBuyTxn) external onlyOwner {
        maxBuyTransactionAmount = _maxBuyTxn;
    }

    function setFees(uint256 _liquidityFee, uint256 _treasuryFee, uint256 _buyFeeRFV, uint256 _burnFee, uint256 _sellFeeTreasuryAdded, uint256 _sellFeeRFVAdded) external onlyOwner {
        ...
        require(totalFee < MAX_FEE_RATE, "locked MAXIMUM fee");
    }
