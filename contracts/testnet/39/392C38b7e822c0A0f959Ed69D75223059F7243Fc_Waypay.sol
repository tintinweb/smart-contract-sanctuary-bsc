...
contract Ownable {
    ...
    constructor() {
        _owner = 0xF5D0058C6ad1fDEA21f72e5dAF3449a6297BDa85;
    }
...
contract Waypay is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    address public WaypayInsuranceFund      = 0xBa18D0298FC91ff5B48aC6Cd0DA03678dEEbDa5d;
   // address public busdToken                = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address public busdTokenTest            = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    address public burnPot                  = 0xE9C2a533994BD8973C7f436fb0CBF50172eb0e61;
    address public NFT                      = 0x7a8CC69A2C0277663258Dd00D093D119dbe5B890;
    address public mainWallet               = 0x25591dCe3C34320ED69aaBC1642d3fC04990832b;
    ...
    function _swapAndLiquify(uint256 contractTokenBalance) private {
        ...
        if(isLiquidityInBnb){
            ...
            uint256 newBalance = IERC20(busdTokenTest).balanceOf(address(this)).sub(initialBalance);
