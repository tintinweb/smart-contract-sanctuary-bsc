...
contract TeleCrypto {    
    ...
    uint256 bal;
    uint[] public luckynumbers;    

    event BuyTickets(address _from, uint[] _luckyNumbers);
    ...
    function ShowTicket() public view returns(uint  [] memory) {
        return luckynumbers;
    }

    function BuyTicket(uint[] memory _luckyNumbers) public payable {
