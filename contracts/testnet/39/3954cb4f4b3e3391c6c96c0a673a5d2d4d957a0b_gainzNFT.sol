...
contract gainzNFT is ERC721Enumerable, Ownable {
    ...
    function mint(uint256 _amount) internal {
        ...
        require(totalSupply() + _amount <= 6100, "exceeds max supply");
        require(_amount <= 2, "exceeds max buy amount");
    ...
    function viewSale() external view returns (uint256 remainingTokens) {
		return _sTotal;
    }
