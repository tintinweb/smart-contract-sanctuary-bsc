...
contract MoonForce is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0xd652b830AF5787d4D932F3ffb1c069661A0D8261); // Marketing Address

    address payable public teamAddress =
        payable(0xFbC98cffAA471E9491aBc4b3E74B8635FbD0835A); // Team Address

    address payable public liquidityAddress =
        payable(0xdEFa0F621fD7E317CFAde40ac496fBC74A33ad4f); // Liquidity Address
    ...
    string private constant _name = "MOONFORCE";
    string private constant _symbol = "MOONFORCE";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 5 / 100000; // 0.1%
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 20 / 100000000; 
        maxWalletAmount = _tTotal * 30 / 100000000; 
