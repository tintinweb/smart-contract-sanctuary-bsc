...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "HareYachtClub";
    string private _symbol = "HYC";
    ...
    address payable public BuyBackWalletAddress = payable(0x23D95d80AE37ABBe40D734ce4C213B634aD67dd4); // BuyBack Address
