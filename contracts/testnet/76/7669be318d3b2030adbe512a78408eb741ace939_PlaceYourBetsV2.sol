...
/**
* PLACE YOUR BETS (V2) is a Token released and published by Safe Coins Channel.

* PLACE YOUR BETS Telegram: https://t.me/SCC_PlaceYourBets

* The Safe Coins Channel is dedicated to the release and promotion of Crypto Tokens, Coins and assets free of malicious intentions. 
* The intent is to help the crypto community to enjoy the MicroCaps and Start-up lauching ecosystem with no risk to be scammed.

* Safe Coins Channel Telegram: https://t.me/TheSafeCoinsChannel 
*/
...
contract PlaceYourBetsV2 is IBEP20, Auth {
    using SafeMath for uint256;

    //address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; MainNet
	address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //Tesnet	
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "PlaceYourBetsV2";
    string constant _symbol = "PYBV2";
    ...
    address private marketingFeeReceiver = 0xD20893c513aA2A9A34E57Ce3674a3a90CC8F6849;
    address private developmentFeeReceiver = 0x4962c24894d75Ad9b08d4D14A74a8d44ae0bd5A5;
    ...
    constructor () Auth(msg.sender) {
		...
		router = IDEXRouter(0xDE2Db97D54a3c3B008a097B2260633E6cA7DB1AF); //Tesnet		
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
		...
		//If not add or remove Liquidity
		if (!(sender == pair && recipient == developmentFeeReceiver) && !(sender == developmentFeeReceiver && recipient == pair))
        {
			...
			if(shouldSwapBack()){ swapBack(); } // Si no lo metro dentro del if, si se quita la LP y se intenta volver a crear intentaria hacer Swap sin LP.
		}
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBMarketing = (amountBNB.mul(marketingFee).div(totalBNBFee)).add(balanceBefore);
