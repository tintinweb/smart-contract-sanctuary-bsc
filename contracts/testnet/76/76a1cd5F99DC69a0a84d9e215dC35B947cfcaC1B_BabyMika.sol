...
╚═════╝ ╚═╝  ╚═╝╚═════╝    ╚═╝   ╚═╝     ╚═╝╚═╝╚═╝  ╚═╝╚═╝  ╚═╝
   ...
   3% Marketing and Development fund
   1% Treasure for DAO purposes

   "BabyMika starts with an ideas, someone must have that vision. 
   Once you have a concept you can start to discuss it, 
   this is the first glimmer of BabyMika"
...
contract BabyMika is Context, IERC20, Ownable {
    ...
    //address payable public marketingWalletAddress = payable(0x0cF656f56cB646297EE1728D8877007845DA35ce); // Marketing/Developer Address
    //address payable public treasuryWalletAddress = payable(0xc713a94F3eA0127F581f8c51BA759b612068282d); // Treasury Address

    address payable public marketingWalletAddress = payable(0x06511CCC5533Bf30a2aFd6738335C4b3F7F94D5A); // TestMarketing/Developer Address
    address payable public treasuryWalletAddress = payable(0x75065EED6584CF351c37F41d40340Ec1Ad9Fc9d8); // TestTreasury Address
    ...
    string private _name = "BabyMika";
    string private _symbol = "BBMK";
