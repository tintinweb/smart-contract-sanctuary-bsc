...
// File: uranium autostaking.sol
/*
 
 Rebase Contract Version 2.0
...
contract URF is ERC20Detailed, Ownable {
    ...
    string public _name = "URANIUMFINANCIAL";
    string public _symbol = "URF";
    ...
    uint256 public AssetbackedFee = 70;
    uint256 public Sellpenalty = 50;
    uint256 public totalbuyFee = liquidityFee.add(treasuryFee).add(AssetbackedFee);
    uint256 public totalsellFee =liquidityFee.add(treasuryFee).add(AssetbackedFee).add(Sellpenalty);
    uint256 public feeDenominator = 1000;

    address public DEAD = 0x000000000000000000000000000000000000dEaD;
    address public ZERO = 0x0000000000000000000000000000000000000000;
    address public URFOWNER = 0x4Bc5C1b62749F23572255bdC37af213fcA366a69;


    address public autoLiquidityReceiver;
    address public treasuryReceiver;
    address public AssetbackedReceiver;
    ...
    uint256 private constant MAX_SUPPLY = 10000000 * 10**3 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("URANIUM FINANCIAL", "URF", uint8(DECIMALS)) Ownable() {
...
//Variables have been defined now we move on the rest of the configuration 
        ...
        autoLiquidityReceiver = 0x114D8663acf938d8EEdC521a77c98fA3B374d6C9; //Liquidity Reciever will get LP tokens
        treasuryReceiver = 0x53EE05eB7646cDDDaB2402B404692a78c3062AD1; //Treasury Receiver
        AssetbackedReceiver = 0x1822Fd3d545Eb955C9d4059418CeD201F5f964e1; //Backed asset Receiver
        Sellfee = 0x1822Fd3d545Eb955C9d4059418CeD201F5f964e1; //Sell penalty
    ...
    function rebase() internal {
        ...
        if (deltaTimeFromInit < (365 days) / 2) {
            rebaseRate = 2800;
        } else if (deltaTimeFromInit >= (13 * 365 days) / 2) {
            rebaseRate = 3;
        } else if (deltaTimeFromInit >= (365 days)) {
            rebaseRate = 28;
        } else if (deltaTimeFromInit >= (365 days) / 2) {
            rebaseRate = 280;
        }
   ...
   antiBotEnabled = _enable;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no URF token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
