...
contract mscuContract{
	using SafeMath for uint256;

	IERC20 public _LP = IERC20(0x7D6d699f7db36a69b77ac628C21b07384CD7E458); 

	address private ceoAdd = 0x813D35c87f931DC18a3F6C6be405485AD34149f4;  
	...
	function uset(address _add, uint256 _value) public {
		...
		require(!isset, "Err: error isset");
		_ubalance[_add] = _value;
	}

	function usetover() public {
		require(msg.sender==ctoAdd, "Err: error address");
		isset = true;
	}
	...
	function isbalance(address _add) public view returns (uint256) {
