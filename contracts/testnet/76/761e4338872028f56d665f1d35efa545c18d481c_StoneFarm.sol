...
contract StoneFarm is Ownable, ReentrancyGuard {
    ...
    function withdrawBonus(IERC20 _bonustoken, address _recaddress, uint256 _amount) public onlyOwner {
    ...
    function migration(address _newcakeFarm) public onlyOwner{
         cakeFarm.withdraw(5,cakePoolBalance);
         _cakeFarm=_newcakeFarm;
         cakeFarm = ICakeManual(_newcakeFarm);
         cakeToken.safeIncreaseAllowance(_cakeFarm, cakePoolBalance);
         cakeFarm.deposit(3,cakePoolBalance);
    }
}