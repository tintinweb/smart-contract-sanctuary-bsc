...
contract Krios is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Krios Finance", "KRI", uint8(DECIMALS)) Ownable() {
        ...
        treasuryReceiver = 0xD5eBd4217c935001C9B39Ad0f922158a553ff82E; 
        kriInsuranceFundReceiver = 0xCcFbcBF0b03b90242dc3Ed376C6405C83EC5725B;
        blackhole = DEAD;
        nftFeeReceiver = 0x5739e041490e65c71de99A7898199f709eB77dD0;
