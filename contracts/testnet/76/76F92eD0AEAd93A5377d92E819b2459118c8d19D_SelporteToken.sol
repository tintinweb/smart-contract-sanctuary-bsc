...
contract SelporteToken is ERC20, Ownable {
    ...
    // }
    event Transaction(uint256 _count, uint256 _amount, uint256 _time, Status _type);
    ...
    function transfer(address _to, uint256 _amount) public override returns (bool) {
        ...
        // );
        _counter.increment();
        emit Transaction(_newCount, _amount, block.timestamp, Status.tokenTransfer);
        return true;
    }
    ...
    function burnToken(uint256 _amount) public onlyOwner {
        ...
        // );
        _counter.increment();
        emit Transaction(_newCount, _amount * 10 **decimals(), block.timestamp, Status.tokenBurn);
    }

    // Enlist All transaction made
    // function allTransaction() public view returns (TransactionDetails[] memory) {
