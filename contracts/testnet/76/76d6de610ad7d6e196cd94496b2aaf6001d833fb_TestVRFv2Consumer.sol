...
contract TestVRFv2Consumer is VRFConsumerBaseV2 {
  ...
  function requestRandomWords(uint32 _numwords) external onlyOwner {
    ...
    uint256 len = requestIDsArray.length;
    s_requestId[len] = COORDINATOR.requestRandomWords(
      keyHash,
      s_subscriptionId,
    ...
    requestIDsArray.push(s_requestId[len]);
    numWords[len] =_numwords;
  }
