...
interface ICrossPair {
    ...
    function UpdateCRSSPriceCheckSettings(
        bool _isActive,
        uint32 _sessionInterval,
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex"b73945690e8806bc23861856384c1871201edbd19d7f59333b53aae960c21366" // init code hash
                    )
                )
            )
        );
...
contract CrossRouter is ICrossRouter02 {
    ...
    function UpdateCRSSPriceCheckSettings(
        ...
        ICrossPair(_pair).UpdateCRSSPriceCheckSettings(
            _isActive,
            _sessionInterval,
            _maxSessionPriceChange
        );
    }
