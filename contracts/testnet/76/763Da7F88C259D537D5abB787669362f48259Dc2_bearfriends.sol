...
1666323780
    */
    ...
    function wl1Info(address user) public view returns (Info memory) {
       return  Info(WL1_AMOUNT,WL1_MINTED,0,WL1_START_TIME,WL1_END_TIME,WL1_WALLET_CAP[user],STATE);
    }

    function wl2Info(address user) public view returns (Info memory) {
       return  Info(WL2_AMOUNT,WL2_MINTED,0,WL2_START_TIME,WL2_END_TIME,WL2_WALLET_CAP[user],STATE);
    }

    function mainInfo(address user) public view returns (Info memory) {
       return  Info(mainAmount(),MAIN_MINTED,MAIN_PRICE,MAIN_START_TIME,MAIN_END_TIME,MAIN_WALLET_CAP[user],STATE);
    }
