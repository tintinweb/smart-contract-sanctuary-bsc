...
contract MarketPlace is ERC165 {
    ...
    mapping(uint256 => bytes32)public tempRootHash;
    ...
    function placeOpenBid(
        ...
        //  require(
        //     verify(msg.sender, allowance, proof, tempRootHash[_projectID]),
        //     "User not authenticated"
        // );
        require(
            amount >=
        ...
        returns (bool)
    {
        ...
        addTotalRaise(_order.tokenId, _bid.copies * (currentBidAmount -((platformFees * (_bid.copies * _order.startPrice)) / 100) ));
    ...
    function addRootHash(uint256 _projectID,bytes32  _roothash)external {
        tempRootHash[_projectID] = _roothash;
    }
