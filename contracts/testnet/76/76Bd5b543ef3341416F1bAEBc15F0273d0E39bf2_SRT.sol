...
contract StakingRewards is AccessControl {
    ...
    constructor(address _router,address _usdt, address _stakingToken, address _rewardToken, address _liquidityAddress) {
        owner = msg.sender;
...
contract SRT is StakingRewards {
    constructor() StakingRewards(
        address(0xB6BA90af76D139AB3170c7df0139636dB6120F7e),                    //0x10ED43C718714eb63d5aA57B78B54704E256024E
        address(0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb),                 //0x55d398326f99059fF775485246999027B3197955
    //name
        address(0x4fA15e5c0f302119133ad40F585a441BD6485eaE),
    //symbol
        address(0x4fA15e5c0f302119133ad40F585a441BD6485eaE) ,
    ...
    //mint
        address(0x1AeE709E2eA7BD215e9aC3E0B5bE016af34FC7DC)             //0xf3D5661f48e99F2123B938182225EF5EC9552B5A
