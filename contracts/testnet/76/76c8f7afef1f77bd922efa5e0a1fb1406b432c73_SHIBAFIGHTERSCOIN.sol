...
contract SHIBAFIGHTERSCOIN is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 10000000000 * 18**decimals();
    uint256 public maxWalletLimit = 50000000000 * 18**decimals();

    uint256 public genesis_block;
    uint256 private deadline = 3;
    uint256 private launchtax = 99;

    address private marketingWallet = 0xb86C86f61F84Df94667ddAEbA3EfDec5487aaC28;
    address private devWallet = 0xAA8E1937e349B67c26Cf3854Dc16482f72DE24Cf;
    ...
    constructor(address routerAdd, address serviceFeeReceiver) ERC20("SHIBAFIGHTERS COIN", "SFC") payable {
    ...
    function updateMaxWalletlimit(uint256 amount) external onlyOwner {
        require(amount >= 1000000000, "Cannot set max wallet amount lower than 0.1%");
