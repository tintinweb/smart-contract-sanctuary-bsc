...
contract HectagonNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    event Redeem(uint256 tokenId, address indexed to);
    ...
    function setBackedToken(
        ...
        backedTokens[_symbol] = BackedToken({addr: _addr, redeemableAt: _redeemableAt});
    }
    ...
    function safeMint(
        ...
        require(backedToken.addr != address(0), "Backed Token Is Not Supported!");

        require(_to != address(0), "Mint to zero address!");

        IERC20(backedToken.addr).transferFrom(msg.sender, address(this), _amount);
    ...
    function redeem(uint256 _tokenId) public {
        ...
        BackedToken memory backedToken = backedTokens[attribute.symbol];
