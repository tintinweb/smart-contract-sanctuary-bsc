...
contract FlashHostFactory is Ownable {
  ...
  //call this function to deploy an instance of hosting, using the chat ID # of the group you wish to host for.
  function deploy(int256 chatID) external {
    require(!Hosting[msg.sender], "You are already hosting");
