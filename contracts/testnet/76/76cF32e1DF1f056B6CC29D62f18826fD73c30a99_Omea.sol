...
contract Omea is Ownable, ReentrancyGuard{
    ...
    uint256 public developerFee = 350; // 300 : 3 %. 10000 : 100 %
    uint256 public referrerReward = 900; // 800 : 8%. 10000 : 100%
    uint256 public rewardPeriod = 1 days;
    uint256 public withdrawPeriod = 60 * 60 * 24 * 30;	// 30 days
    uint256 public apr = 250; // 200 : 2 %. 10000 : 100 %
    ...
    function setWithdrawTime (uint256 _withdrawtime) public onlyOwner {
        withdrawPeriod = _withdrawtime;
    }
