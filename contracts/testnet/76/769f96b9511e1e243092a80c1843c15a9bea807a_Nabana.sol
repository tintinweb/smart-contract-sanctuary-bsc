...
contract Nabana is ERC20, Ownable {
    ...
    /**
     * @dev Structured with the assumption that 'owner' will deploy
     * @dev 'owner' and 'feeWallet' are assumed to be different during deployment
     */
    constructor(address _nabanaVesting, address _pinkAntiBot) ERC20("Nabana", "BANA") {
    ...
    function updateNabanaVesting(address _nabanaVesting) external onlyOwner {
        ...
        dividendTracker.excludeFromDividends(_nabanaVesting);
        excludeFromFees(_nabanaVesting, true);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        newDividendTracker.excludeFromDividends(feeWallet);
