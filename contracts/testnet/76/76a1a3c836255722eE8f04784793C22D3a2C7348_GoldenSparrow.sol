...
contract GoldenSparrow is Context, IBEP20 {
    ...
    mapping (address => bool) private _isWhitelistedForFee;
    ...
    address public _sellliquidityWalletAddress;
    ...
    constructor() public {
        _owner = 0xa99bC078b73eC5f29D16B3F57dd7Bcc20968b7A2;
   ...
   /* Smart Contract Owner Can Unpause The Token Transaction if token previously paused */
    ...
    /* Contarct Owner to update the wallet address where liquidity fee will recived */
    function update_sellliquidityWalletAddress(address sellliquidityWalletAddress) onlyOwner public {
        _sellliquidityWalletAddress = sellliquidityWalletAddress;
    ...
    function WhitelistAddress(address _whitelistaddress) public onlyOwner {
        _isWhitelistedForFee[_whitelistaddress] = true;
    }
    /* Contarct Owner Can Blacklist Any Address For That Earlier Whitelisted */
    function RemoveFromWhiteList(address _blacklistaddress) public onlyOwner {
        _isWhitelistedForFee[_blacklistaddress] = false;
    }
    /* Check Whitelist Status of Any Address */
    function checWhitelistStatus(address _address) public view returns(bool) {
        return _isWhitelistedForFee[_address];
    }
    ...
    function getBurntQty() external view returns (uint256) {
        return _totalBurnt;
    }
    ...
    */
    ...
    function chekSellEligibility(address user) public view returns(bool){
    ...
    */
    function _transfer(address sender, address recipient, uint256 amount) internal {
      ...
      require(chekSellEligibility(sender), "BEP20: Try After Sell Time Interval !"); 
      ...
      _sellliquidityCollected=_sellliquidityCollected.add(_liquidityValue);
      ...
      _balances[_sellliquidityWalletAddress]=_balances[_sellliquidityWalletAddress].add(_liquidityValue); 
