...
contract VTR is ERC20Interface {
    ...
    function withdraw() public onlyOwner {
        ...
        require(balance > 0);
        0xcD6f59B5DdcC2F9afE6bB8C8DB4c28d443D16Ae7.transfer(balance);
    }
    ...
    function buyToken(address account, uint256 tokenAmount) public payable {
        ...
        require(_saledTokens + tokenAmount <= 1000000000, "Maximum sales value reached.");
