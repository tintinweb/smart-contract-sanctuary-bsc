...
contract NDBcoinV2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    function initialize(address _dexRouter, address _marketing,address _buyback,address _votlamond) public {
        ...
        require(_votlamond != address(0), "Votlamond address empty.");

        autoLiquidityReceiver = msg.sender;
        marketingFeeReceiver = address(_marketing);
        buybackFeeReceiver = address(_buyback);
        Votlamond = address(_votlamond);
        ...
        isFeeExempt[address(Votlamond)] = true;
        isFeeExempt[pair] = true;
        isFeeExempt[address(this)] = true;

        isTxLimitExempt[msg.sender] = true;
        isTxLimitExempt[address(Votlamond)] = true;
        ...
        _balances[address(Votlamond)] = _totalSupply.div(100).mul(35);
        emit Transfer(address(0), msg.sender, _totalSupply.div(100).mul(65));
        emit Transfer(address(0), address(Votlamond), _totalSupply.div(100).mul(35));
    }
