...
contract Hound is ERC20, Ownable {
    ...
    uint256 public deadFee = 3; //销毁 3%
    uint256 public liquidityFee = 4; //回流 4%
    uint256 public marketingFee = 1; //营销 1%
    uint256 public foundationFee = 1; //基金 1%
    uint256 public lpRewardFee = 5; //lp分红 5%
