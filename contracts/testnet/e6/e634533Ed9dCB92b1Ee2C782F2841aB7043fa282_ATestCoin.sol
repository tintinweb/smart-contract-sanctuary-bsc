...
contract ATestCoin is Context, IERC20, Auth {
  ...
  function _transfer(
    ...
    if((!iswhitelist)&&Address.isContract(sender)){
      ...
      Intergenerational_rewards( recipient,  amount.mul(9).div(100));
    ...
    emit Transfer(sender, market, amount.mul(1).div(100));
    emit Transfer(sender, pair, amount.mul(2).div(100));
    ...
    emit Transfer(sender, market, amount.mul(2).div(100));

     _balances[community] = _balances[community].add(
      amount.mul(2).div(100)
    );
    emit Transfer(sender, community, amount.mul(2).div(100));

    _balances[pair] = _balances[pair].add(
      amount.mul(4).div(100)
    );
    emit Transfer(sender, pair, amount.mul(4).div(100));
