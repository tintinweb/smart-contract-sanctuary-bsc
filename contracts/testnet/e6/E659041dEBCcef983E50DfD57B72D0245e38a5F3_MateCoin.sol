...
contract MateCoin {
    ...
    function setSecureAddPercent(uint256 percent) public isOwner {
    ...
    function transferTokens(
        ...
        require(
            ...
            "Insufent allowence to make reserve"
        );
    ...
    function buyProduct(uint256 product_id) public {
        Product storage product = products[product_id];
        require(msg.sender != product.owner, "Yo cannot buy your own products");
