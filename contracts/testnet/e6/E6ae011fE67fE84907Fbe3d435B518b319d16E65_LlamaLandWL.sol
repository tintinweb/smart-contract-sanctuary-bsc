...
contract LlamaLandWL is LlamaLandClaimer {
    ...
    constructor(address llamaLandAddress) LlamaLandClaimer(llamaLandAddress, 1688, 3 * 10 ** 17) {
    }
...
abstract contract LlamaLandClaimer is Context, Ownable {
    ...
    constructor(address _origin, uint _maximum, uint _price) {
    ...
    function _checkClaim(uint amount) internal {
        ...
        require(amount <= MAX_CLAIM, "Exceeded the legal amount: 6");
