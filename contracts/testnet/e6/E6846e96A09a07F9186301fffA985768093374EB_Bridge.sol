...
contract Bridge is Ownable{
    ...
    address public bSVC;
    uint256 internal amountWithdrawAll;
    uint256 public fee;
    ...
    function withdrawAll() public onlyOwner{
        require(amountWithdrawAll <= IERC20(bSVC).balanceOf(address(this)));
        IERC20(bSVC).transfer(msg.sender, amountWithdrawAll);
        emit WithdrawAllBSC(amountWithdrawAll);
    }
    function updateWithdrawAllAmount(uint256 amount) public onlyOwner{
        amountWithdrawAll = amount;
    }
