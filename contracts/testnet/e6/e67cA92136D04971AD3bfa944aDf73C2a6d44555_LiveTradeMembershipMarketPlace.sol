...
contract LiveTradeMembershipMarketPlace is Ownable, ReentrancyGuard, Pausable {
  ...
  constructor(address _marketFeeWallet,uint256 _feeRate,address[] memory _membershipNfts,address[] memory _currencyTradingList, bool _isOpenMarket) {
