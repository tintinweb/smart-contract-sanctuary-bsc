...
contract Greenbacks is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Greenbacks";
    string private _symbol = "GRNBKS";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x31b9Ee2157654dbA155EefaB9fd7361C77AD13Ca);
