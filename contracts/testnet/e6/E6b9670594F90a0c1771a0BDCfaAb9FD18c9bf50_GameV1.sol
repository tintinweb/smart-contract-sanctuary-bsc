...
contract GameV1 is GameV1Interface, ReentrancyGuard, Pausable {
     ...
     * @dev Callable by admin or creator
     */
    function _setEncodedCron(string memory _encodedCron) internal whenNotPaused onlyAdminOrCreator {
     ...
     *  _updateGameData.prizesToAdd the game prizes to add to the game
     */
    function setGameData(UpdateGameData memory _updateGameData) external payable override onlyAdminOrCreator {
        ...
        if (_updateGameData.prizesToAdd.length != 0) _addPrizes(_updateGameData.prizesToAdd);
    }
...
interface GameV1Interface {
     ...
     *
     */
    function setGameData(UpdateGameData memory _updateGameData) external payable;
