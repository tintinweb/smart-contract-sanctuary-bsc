...
contract OrbedNFT is Initializable, ERC721Upgradeable, PausableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
  ...
  */
  function updateMintState(MintState newMintState) external onlyRole(TRANSACTION_ROLE)
  {
    //SHEPARD: Allow only certain roles to update the mint state.
  ...
  */
  ...
  /** 
   * @notice halts the enitre contract e. ( transfers, minting etc) 
   * @dev only Admin Role can call this
   */
