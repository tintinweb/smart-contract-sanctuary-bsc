...
* @notice This is the base contract for Solarity Tokens.
* @dev This contract is also upgradeable and contains public & private functions for a variety of use cases for Solarity Tokens.
*/
contract Solarity is Initializable, ERC20Upgradeable, UUPSUpgradeable, AccessControlUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  */
  ...
  /* #TODO: ## ADD PUBLIC MEMBERS / VARIABLES */
  ...
  */
    ...
    address _operationsAddress) public initializer
  {
    ...
    _grantRole(OPERATIONS_ROLE, _operationsAddress);
