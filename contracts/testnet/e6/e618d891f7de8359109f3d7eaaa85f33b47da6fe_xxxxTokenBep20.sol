...
contract xxxxTokenBep20 is Context, IERC20, Ownable {
    ...
    address public DevAddress = 0x690E8D4F73D9ab9752B4F496CD6E64a6a35B73eA;
    ...
    constructor (address routerAddress) {
        ...
        address _pair = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee;
   ...
   function setMaxWalletPercent(uint256 maxWallPercent) external onlyOwner() {
    ...
    function swapAndLiquify(uint256 tokens) private lockTheSwap{
        ...
        if(operationsAmt > 0){
          payable(DevAddress).transfer(operationsAmt);
        }
    }
