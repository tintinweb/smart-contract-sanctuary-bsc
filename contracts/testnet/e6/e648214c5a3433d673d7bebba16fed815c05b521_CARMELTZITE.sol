...
contract CARMELTZITE is ERC20, Ownable {
    ...
    constructor() ERC20("CARMELTAZITE", "CARMEL") {
        ...
        uint256 _buyTaxFee = 7;

        uint256 _sellLiquidityFee = 3;
        uint256 _sellTaxFee = 7;

        uint256 totalSupply = 10000000000000000 * 1e18; // 10 QUADRILLIONS

        maxTransactionAmount = 100000000000000 * 1e18; // 1% from total supply maxTransactionAmountTxn: i.e 1 Trillion
        maxWallet = 200000000000000 * 1e18; // 2% from total supply maxWallet: i.e 200 Trillions
        ...
        taxWallet = address(0x069bB2BB3235623A2E0aEAc8D2980417E9E92c2F); // set as tax wallet
