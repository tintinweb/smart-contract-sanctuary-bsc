...
contract Titanotest is ERC20Detailed, Ownable, MinterRole {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    event LogRebase(uint256 indexed epoch, uint256 totalSupply);

    string public _name = "Titano test";
    string public _symbol = "TIT";
    ...
    constructor() ERC20Detailed("TitanoTEST", "TIT", uint8(DECIMALS)) {
        ...
        TreasuryReceiver = 0x0Ca3Be8d394800D8B608cbEF02BF58F9B1D184f3;
