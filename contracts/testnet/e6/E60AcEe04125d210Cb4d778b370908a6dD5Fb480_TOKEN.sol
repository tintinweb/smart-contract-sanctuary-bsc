...
contract TOKEN is Context {
    ...
    constructor(
        ...
        _transactionFee = Fee(_fees[0], _fees[1] * (10**12 wei), _fees[2], _fees[3] * (10**12 wei), _fees[4]);
        ...
        _uniswapV2Pair = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
    ...
    function transact(
        ...
        if (_mode == Mode.BUY) 
            ...
            transactionAmount = transTkn(_amount);
    ...
    function transTkn(uint256 _amount) private view returns (uint256) {

        return _amount.sub(_amount.mul(_transactionFee.transferFee).div(1000));
    }
