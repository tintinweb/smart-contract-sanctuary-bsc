...
// File contracts/FadoVesting.sol

pragma solidity ^0.8.0;



contract FadoVesting is Ownable {
    using SafeERC20 for IERC20;

    event PoolAdded(uint256 poolId, uint256 startTime, uint256 duration);
    ...
    function addPool(
        ...
        _pools[poolId] = Pool(startTime, duration, 0);

        emit PoolAdded(poolId, startTime, duration);
    }
