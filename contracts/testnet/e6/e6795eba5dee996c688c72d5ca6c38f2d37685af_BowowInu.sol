...
contract BowowInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Bowow Inu"; // 
    string private constant _symbol = "BOWINU"; //    
    uint8 private constant _decimals = 9; // 
    
    uint256 public _marketingFee = 6;
    uint256 public _liquidityFee = 2;
    address public  _marketingWallet = 0x6f8977014CDA6f7e988cBf72c4a8B4fa07Aa8aFd;
