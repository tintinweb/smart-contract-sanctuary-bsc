...
contract NFTMarketplace is Initializable, OwnableUpgradeable {
    ...
    function makeOffer(address _nftCollection, uint _id, uint _price) public {
        ERC721Upgradeable(_nftCollection).transferFrom(msg.sender, address(this), _id);
        offerCount ++;
        offers[offerCount] = _Offer(offerCount, _id, _price, false, false, _nftCollection, msg.sender);
        emit Offer(offerCount, _id, _price, false, false, _nftCollection, msg.sender);
    }
    ...
    function fillOffer(uint _offerId) public payable {
        ...
        ERC721Upgradeable(_offer.nftCollection).transferFrom(address(this), msg.sender, _offer.id);
