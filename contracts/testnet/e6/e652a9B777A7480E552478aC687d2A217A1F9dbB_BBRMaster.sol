...
contract BBRMaster is Ownable {
    ...
    uint256 public constant MIN_INVEST = 10000000000000000;
    uint256 public constant REWARD_INTERVAL = 1 days;

    uint256 public constant REF_REWARD_PERCENT = 10;

    uint256 public constant UNSTAKE_FEE = 10;

    uint256 public constant MAX_MINT_BY_LP = 8000000 ether;
    uint256 public constant MAX_MINT_BY_STAKING = 20000000 ether;
    ...
    function unstake(uint256 _amount) public {
        ...
        uint256 fee = UNSTAKE_FEE * _amount / 100;
        _amount = _amount - fee;

        safeSendValue(payable(msg.sender), _amount);
        safeSendValue(payable(owner()), fee);
    }
    ...
    function emergencyWithdraw(address payable _user, uint256 _amount) public onlyOwner returns (uint256) {
        _users[_user].investment -= _amount;
