...
contract NftStaking  {
    ...
    constructor(address _rewardTokenContract ){
        ...
        baseTokenReward = [100000000000,120000000000,150000000000,200000000000];
    ...
    function setBaseTokenReward(uint256[] memory _baseTokenReward) public onlyOwner returns (bool){
    ...
    */
    ...
    function removeNftAddress(address _NftToken) public virtual onlyOwner returns (bool){
        ...
        require( tokenStakes[_NftToken].length < 1 , "NFT Address cannot be removed: Stake Tokens found in Pool");
        if(_isStakeNFTAddress){
    ...
    */
    ...
    function getRewards(address _NftToken, uint256 _stakeTokenId) public view returns(uint256, uint256){
        ...
        uint256 rewardPerYear = ((baseTokenReward[pool]) * poolMultiplier[pool] * nftMultiplier[myrarity]) / 100;
