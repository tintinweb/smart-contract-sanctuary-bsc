...
contract Sanemi_Inu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sanemi_Inu";
    string private constant _symbol = "SANEMI_INU";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x82ff563E0a205e7A0E949529291dccD45AaE188F);
    address payable private _marketingAddress = payable(0xFD445BB82c27D55b50149055e78Dc8813F58fE6A);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
        require(redisFeeOnBuy < 11, "Redis cannot be more than 11");
        require(redisFeeOnSell < 11, "Redis cannot be more than 11");
