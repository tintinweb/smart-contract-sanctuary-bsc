...
contract CorePad is ERC20Detailed, Ownable {
    ...
    string public _name = "CorePad";
    string public _symbol = "CCP";
    ...
    uint256 public supplyControlFee = 10;
    ...
    address public corepadInsuranceFundReceiver;
    ...
    constructor() ERC20Detailed("CorePad", "CPP", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x107bC0aB068febcb0fB43aCC9bBCfb712019684F;
        treasuryReceiver = 0xdff79449f8B83f13bED210BA1cD2f63e53053028; 
        corepadInsuranceFundReceiver = 0x065A9C3Bd03C1992c783585E5B3f209B31aB6859;
        supplyControl = 0xAe023988088F5392169A96744c2F0ab515f15079;
    ...
    function rebase() internal {
        ...
        if (deltaTimeFromInit < (30 days)) {
            rebaseRate = 2355;
        } else if (deltaTimeFromInit >= (1 * 1 days)) {
            rebaseRate = 30;
        } 
        else if (deltaTimeFromInit >= (7 * 30 days)) {
            rebaseRate = 2;
        }
        else if (deltaTimeFromInit >= ((15 * 30 days) / 15)) {
            rebaseRate = 14;
        } else if (deltaTimeFromInit >= (30 days)) {
            rebaseRate = 211;
        }
    ...
    function swapBack() internal swapping {
        ...
        (success, ) = payable(corepadInsuranceFundReceiver).call{
    ...
    function setFeeReceivers(
        ...
        address _corepadInsuranceFundReceiver,
        address _supplyControl
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        corepadInsuranceFundReceiver = _corepadInsuranceFundReceiver;
