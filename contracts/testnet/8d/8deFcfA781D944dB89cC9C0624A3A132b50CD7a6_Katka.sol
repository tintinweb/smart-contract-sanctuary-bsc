...
contract Katka is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        totalFees = devFee
            ...
            .add(communityFee)
            .add(marketingFee);
        require(totalFees <= 2500, "KATKA: Total fee is over 25%");
        swapTokensAtAmount = 100 ether; // Swap at 100 KATKA
    ...
    function setMaxSellAtStart(uint256 _maxSellAtStart) external onlyOwner {
        require(_maxSellAtStart <= totalSupply(), "KATKA: Max sell at start is over total supply");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "KATKA: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "KATKA: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "KATKA: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "KATKA: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function _transfer(
        ...
        if (
            ...
            require(tradingOpen, "KATKA: Trading is not open");
