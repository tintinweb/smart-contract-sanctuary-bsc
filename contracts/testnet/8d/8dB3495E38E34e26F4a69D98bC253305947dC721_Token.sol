...
contract Token is ERC20, ERC20Detailed {
    ...
    constructor(
        ...
        sFundFee = _sFundFee;       
        sLpFee = _sLpFee;         
        MAX_STOP_BURN_FEE_TOTAL = totalSupply().mul(_MAX_STOP_BURN_FEE_TOTAL).div(totalRate);  
        canRemoveLiquidityFee = totalSupply().mul(_canRemoveLiquidityFee).div(totalRate);   
    }
}