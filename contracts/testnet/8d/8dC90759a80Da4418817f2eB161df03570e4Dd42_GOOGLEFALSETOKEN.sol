...
contract GOOGLEFALSETOKEN is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xF150B3C3bD15B740f53b91350c8639B7ecCD0868); 
    address payable public Wallet_Dev = payable(0xF150B3C3bD15B740f53b91350c8639B7ecCD0868);
    ...
    string private constant _name = "GOOGLE FALSE"; 
    string private constant _symbol = unicode"GFT"; 
    ...
    uint256 public Percent_Marketing = 35;
    uint256 public Percent_Dev = 50;
    uint256 public Percent_Burn = 0;
    uint256 public Percent_AutoLP = 15; 

    uint256 public _maxWalletToken = _tTotal * 4 / 100;
    uint256 public _afterLaunchMaxWalletToken =_tTotal * 100 / 100;

    uint256 public _maxTxAmount = _tTotal * 2 / 100; 
    uint256 public _afterLaunchMaxTxAmount = _tTotal * 100 / 100;

    uint256 public launchTime;
    uint256 private constant _minutes = 600;
    uint256 public lockTime = 10 * _minutes;
    ...
    function launch() public {
        require(now_() >= unlock, "Still Locked!");
        _maxTxAmount = _afterLaunchMaxTxAmount;
        _maxWalletToken = _afterLaunchMaxWalletToken;
    }
