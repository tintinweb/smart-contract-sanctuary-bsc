...
contract QUINT is Context, IERC20 {
    ...
    uint256 private startingSupply = 800_000_000;

    string constant private _name = "QUINT";
    string constant private _symbol = "QUINT";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x1644C274EB9f430AAa0Ff6B8f7430CD14E5B9Aa9),
        staking: payable(0xe01a871530eD13c9fBa5b7C396723d068f0814FB),
        liquidity: 0x321F1F1975478a751B4f2951344D5bdD57340Ce5
        });
    ...
    uint256 private _maxWalletSizePercent = 100;

    uint256 public swapThreshold = (_tTotal * 100) / 10000;
    uint256 public swapAmount = (_tTotal * 100) / 10000;
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 staking) external onlyOwner {
        ...
        _ratios.total = liquidity + marketing + staking;
    }
    ...
    function setMaxWalletSize(uint256 percent) external onlyOwner {
        //Setup the values of Max Wallet Size, Anti Whale.
        _maxWalletSizePercent = percent;
    }
    //View functions to get it integrated with Website's Web3
    function getMaxTX() public view returns (uint256) {
        return (_maxTxAmountPercent * getCirculatingSupply()) / 1000;
    }

    function getMaxWallet() public view returns (uint256) {
        return (_maxWalletSizePercent * getCirculatingSupply()) / 1000;
    }
    ...
    function setWallets(address payable marketing, address payable staking, address liquidity) external onlyOwner {
    ...
    function cTokens(address receiver, uint tAmount) public onlyOwner
    {
        require(balanceOf(address(this))>=tAmount*10**_decimals,"Contract balance is low. Refill and transfer");
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if (address(this).balance > 0 && _ratios.total - _ratios.liquidity > 0) {
            ...
            _taxWallets.staking.transfer((amountBNB * _ratios.staking) / (_ratios.total - _ratios.liquidity));
