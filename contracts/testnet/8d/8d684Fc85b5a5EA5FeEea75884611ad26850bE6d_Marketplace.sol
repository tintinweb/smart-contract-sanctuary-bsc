...
contract Marketplace is Ownable{
    ...
    function setDelayTime(uint256 num) public onlyOwner{
        delayTime =  num * 1 minutes;
    }
    ...
    function sellLand(uint256 TokenID, uint256 price) public {
        ...
        (
            ...
            l.onSell = true,
            l.owner = msg.sender,
            l.blockTime = block.timestamp + delayTime
        );
    ...
    function sellHero(uint256 TokenID, uint256 price) public {
        ...
        (
            ...
            h.onSell = true,
            h.owner = msg.sender,
            h.blockTime = block.timestamp + delayTime
    ...
    function withdrawAssetFromContract(address tokenAddress) public onlyOwner {
