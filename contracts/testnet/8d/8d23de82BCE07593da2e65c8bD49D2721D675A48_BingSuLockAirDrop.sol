...
contract BingSuLockAirDrop is Ownable {
    ...
    function transferAndLock(address _lockedAddress, uint256 _amount, uint _releaseDays) public onlyOwner
    {
        ...
        if(totalLockedAmount > _airDropAmount)
        {
            revert("totalLockedAmount is over airDropAmount");
        }
    ...
    function getWithdrawAmount(address _lockedAddress) public view returns (uint256 _amount)
    {
    ...
    constructor() {
        _airDropAmount = 50_000_000_000_000 * (10 ** uint256(18));
    }

    function getAirdropAmount() public view returns (uint256 _amount)
    {
