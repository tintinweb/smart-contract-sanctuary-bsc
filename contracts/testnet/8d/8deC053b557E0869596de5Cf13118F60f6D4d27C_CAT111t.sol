...
contract CAT111t
 is Context, IERC20, Ownable {
    ...
    uint256 public _walletMax = 200000000000000 * 10**_decimals;
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x7718E92101d48854649c3da115Ec70dE51871501));
        _anotherA = payable(address(0x7718E92101d48854649c3da115Ec70dE51871501));
