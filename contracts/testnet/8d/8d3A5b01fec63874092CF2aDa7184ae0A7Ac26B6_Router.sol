...
library PancakeLibrary {
    ...
    function getReserves(address factory, address tokenA, address tokenB, uint id) internal view returns (uint reserveA, uint reserveB) {
        pairFor(factory, tokenA, tokenB, id);
        (uint reserveA, uint reserveB,) = IPancakePair(pairFor(factory, tokenA, tokenB,id)).getReserves();
    }
