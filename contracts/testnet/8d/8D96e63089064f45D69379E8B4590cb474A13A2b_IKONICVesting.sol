...
contract IKONICVesting is Ownable,ReentrancyGuard{
    ...
    function setDates (uint startTime) external onlyOwner {
        ...
        linearVestingAmountWithdrawThresholdTime= [0,startTime+ 60 minutes ,startTime + 1 minutes ,startTime + 1 minutes,startTime +  1 minutes ,startTime + 180 minutes,startTime + 365 minutes,startTime + 30 minutes,startTime + 180 minutes, startTime + 90 minutes,startTime + 1 minutes];
