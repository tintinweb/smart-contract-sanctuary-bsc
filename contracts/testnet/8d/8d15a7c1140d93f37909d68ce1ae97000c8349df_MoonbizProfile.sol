...
// File: @moonbiz/Moonbiz-swap-lib/contracts/token/BEP20/IBEP20.sol
...
// File: contracts/MoonbizProfile.sol

pragma solidity ^0.6.0;

/** @title MoonbizProfile.
@dev It is a contract for users to bind their address 
to a customizable profile by depositing a NFT.
*/
contract MoonbizProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public rp1Token;
    ...
    uint256 public numberRp1ToReactivate;
    uint256 public numberRp1ToRegister;
    uint256 public numberRp1ToUpdate;
    ...
    constructor(
        IBEP20 _rp1Token,
        uint256 _numberRp1ToReactivate,
        uint256 _numberRp1ToRegister,
        uint256 _numberRp1ToUpdate
    ) public {
        rp1Token = _rp1Token;
        numberRp1ToReactivate = _numberRp1ToReactivate;
        numberRp1ToRegister = _numberRp1ToRegister;
        numberRp1ToUpdate = _numberRp1ToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends RP1 to burn address. Requires 2 token approvals.
     */
    function createProfile(
        ...
        // Transfer RP1 tokens to this contract
        rp1Token.safeTransferFrom(
            _msgSender(),
            address(this),
            numberRp1ToRegister
        );
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer RP1 token to this address
        rp1Token.safeTransferFrom(
            _msgSender(),
            address(this),
            numberRp1ToUpdate
    ...
    /**
     * @dev Claim RP1 to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        rp1Token.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of RP1 to register
     * Callable only by owner admins.
     */
    function updateNumberRp1(
        uint256 _newNumberRp1ToReactivate,
        uint256 _newNumberRp1ToRegister,
        uint256 _newNumberRp1ToUpdate
    ) external onlyOwner {
        numberRp1ToReactivate = _newNumberRp1ToReactivate;
        numberRp1ToRegister = _newNumberRp1ToRegister;
        numberRp1ToUpdate = _newNumberRp1ToUpdate;
    }
