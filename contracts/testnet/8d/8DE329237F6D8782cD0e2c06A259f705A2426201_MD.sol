...
contract MD is ERC721Enumerable, Ownable {
    ...
    address private immutable doodlezContract;
    ...
    constructor(address doodlezContract_)
        ERC721("MD", "MD")
    {
        doodlezContract = doodlezContract_;
        _safeMint(FEE_RECEIVER, 10);
    }
    ...
    function mint() external payable noContracts(msg.sender) {
        ...
        uint256 doodlezBalance = IERC721Enumerable(doodlezContract)
            .balanceOf(_user);
