...
CryptoSyno ($CSYN) Token Contract
...
contract SpinV3{
    ...
    uint256 public spinCost = 777 ether;
    ...
    constructor(){
        ...
        listingtoken = IBEP20(0x11C897eF6d369ae0E3239efDE2CB9da663233047);
        tokens.push(0x11C897eF6d369ae0E3239efDE2CB9da663233047);
    }
    ...
    function _spin(IBEP20 _token,address spiner) internal isSpin returns(bool success){
        ...
        _token.transferFrom(spiner,address(this), spinCost);
        bool win;
    ...
    function SetSpinCost(uint256 _spinCost) onlyOwner public{
    ...
    function addtoken(address _token) public {
        ...
        listingtoken.transferFrom(msg.sender,address(0xdead),spinCost);
        tokens.push(_token);
    }
