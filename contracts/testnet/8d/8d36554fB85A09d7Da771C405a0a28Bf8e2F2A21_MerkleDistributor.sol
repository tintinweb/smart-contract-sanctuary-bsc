...
contract MerkleDistributor is Ownable {
    ...
    // dev 
    function inspectkeccak(uint256 _index,uint256 _amount,address _receiver) external pure returns (bytes32)
    {
        return keccak256(abi.encodePacked(_index, _receiver, _amount));
    }
