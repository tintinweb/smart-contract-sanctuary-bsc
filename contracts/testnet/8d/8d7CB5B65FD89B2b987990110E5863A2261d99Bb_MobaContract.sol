...
contract MobaContract is Ownable {
	...
	function deposit(
		...
		emit DepositEvent(_username, _tokenAddress, msg.sender, _amount, block.timestamp);
	}
	...
	function withdraw(
		...
		emit WithdrawEvent(_username, _tokenAddress, msg.sender, _amount, block.timestamp);
