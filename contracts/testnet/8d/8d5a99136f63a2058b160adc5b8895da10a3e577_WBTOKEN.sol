...
contract WBTOKEN is Context, IBEP20, Ownable {
    ...
    function setRoute(IDEXRouter02 _router, address _pair,address _pairBUSD) external onlyOwner {
        require(
    ...
    function swapAndLiquify(address from, address to) private {
        ...
        if (
            ...
            !(from == address(this) && (to == address(DEXPair) ||  to == address(DEXPair2))) // swap 1 time
        ) {
