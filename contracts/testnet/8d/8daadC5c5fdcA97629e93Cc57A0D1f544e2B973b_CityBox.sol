...
contract CityBox is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 private constant _tTOTAL = 1000 * 1e6 * 10**_DECIMALS;
     ...
     */     
    uint256 numTokensSellToAddToLiquidity = 1e5 * 10**_DECIMALS;
     ...
     */   
    function setNumTokensSellToAddToLiquidity(uint256 newAmount) private onlyOwner() {
