...
contract WealthBUSD is Context, Ownable, ReentrancyGuard {
    ...
    constructor() {
        BUSD = IERC20(0x61Ae56e7650EA3Caee32234b48830E8C31B70eD9);
        devOwner = 0xd4F453b7a06d2BBabEc3aA7A11dd7ef95f5351Ac;
        ideaOwner = 0xd4F453b7a06d2BBabEc3aA7A11dd7ef95f5351Ac;
    }
    ...
    function addVIP (address vipAddy) public {
        require(msg.sender == devOwner);
        require(block.timestamp < firstlaunch);

        WL storage wl = WhiteList[vipAddy];
