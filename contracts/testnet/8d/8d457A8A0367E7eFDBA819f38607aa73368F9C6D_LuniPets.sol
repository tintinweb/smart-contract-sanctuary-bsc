...
contract LuniPets is Evolvable, ERC721, ERC721Enumerable, ReentrancyGuard, Ownable, VRFConsumerBaseV2{
    ...
    // Max NFT per user
    uint256 public MAX_NFT_PER_USER = 15;
    ...
    // Pending Ids
    uint256[2001] private _pendingIds; 
    ...
    function mintNFT(uint256 numberOfNfts) external payable nonReentrant{
        ...
        if(price > 0) payable(admin).transfer(price);
