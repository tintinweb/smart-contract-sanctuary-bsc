...
// File: contracts/NFTItalia/RentingProxy.sol
...
contract MyToken is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function initialize() initializer public {
        ...
        _grantRole(DEFAULT_ADMIN_ROLE, 0x0b907a2cF844c08D88AdAf306f524c2BC8a247CC);
        _grantRole(MINTER_ROLE, 0x0b907a2cF844c08D88AdAf306f524c2BC8a247CC);
        _grantRole(UPGRADER_ROLE, 0x0b907a2cF844c08D88AdAf306f524c2BC8a247CC);
    }
