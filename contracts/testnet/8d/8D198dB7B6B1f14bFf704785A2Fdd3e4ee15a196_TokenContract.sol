...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 amount = BUSD.balanceOf(address(this)).sub(
            balanceBefore
        );
...
// main contract
contract TokenContract is IERC20Extended, Auth {
    using SafeMath for uint256;
    ...
    address public BUSD = 0xA63a11721792915Fe0acEf709293f95e483d7d23;
