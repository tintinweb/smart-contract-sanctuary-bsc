...
contract Herd is ERC721URIStorage, Ownable {
     ...
     */
    constructor(string memory baseURI) ERC721("HERDS", "HD") {
        ...
        onlyWhenNotPaused
    {
        ...
        ListItem memory item = ListItem(msg.sender, price, false, tokenId);
        ListItems[tokenId] = item;
    }
    ...
    function buyItem(uint256 tokenId) public payable onlyWhenNotPaused {
        require(
            msg.value >= ListItems[tokenId].price,
