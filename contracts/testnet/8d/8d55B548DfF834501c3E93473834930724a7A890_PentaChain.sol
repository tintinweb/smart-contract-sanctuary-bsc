...
contract PentaChain is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Penta Chain";
    ...
    address payable public marketingWalletAddress = payable(0xf87296C8031378Cd078Dcd3Cc2DE2CED49742e78); // Marketing Address
    address payable public teamWalletAddress = payable(0x028d2897895228A878957398c2Bcc8A8a22807da); // Team Address
