...
contract LIFEGAMESV2 is ERC20Upgradeable {
    ...
    */
    ...
    function initialize() public initializer {
        ...
        _owner = msg.sender; // 0x19cbE4C70c36757E79BC1510a7ffEca6b6ddA4dd
        _name = "LIFEGAMES";
        _symbol = "LFG";
        _decimals = 18;
        ...
        // constructor -------------------------------------
        _rOwned[msg.sender] = _tTotal; // send total supply to owner
        //_rOwned[msg.sender] = _rTotal; // send total supply to owner // old work

        // set busd address
        busdAddress = address(addresses[0]);
        busdReserveAddress = payable(_owner);
    ...
    function _transfer(
        ...
        takeFee = !(_isExcludedFromFee[from] || _isExcludedFromFee[to]);
