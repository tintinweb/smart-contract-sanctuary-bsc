...
/// @title IWorld token contract
/// @author Long
/// @notice This contract is the WerewolfKill token contract
contract IWorld is IERC20, Ownable, ReentrancyGuard {
    ...
    //3% Lp dividend
    uint256 public _dividendFee = 30;
    //3% Add l P
    ...
    IERC20 public husdtTokenAddress = IERC20(0x9127f9B3FC13eC52E21654e6837C03A4881e7502);
    //token -> usdt
...
//        }
    ...
    */
    function distributeLp() private {
        ...
        if (difference > 0) {
            ILpDividend(lp).notifyRewardAmount(difference, rewardDuration);
            ldContractAmount = 0;
        }
    }
