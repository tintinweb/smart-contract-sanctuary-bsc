...
contract AriaCAWB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FEG 3.0";
    string private _symbol = "FEG 3.0";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x08AaF3B13b09F1f4cbD258402a5663D106774b52); 
    address payable public teamWalletAddress = payable(0x28F87A75f8e803ECc34287F35CE821459469785d); 
    ...
    uint256 public _maxTxAmount = 500 * 10**9 * 10**_decimals; //(0.5%) 
    uint256 public _walletMax = 1200 * 10**9 * 10**_decimals; //(1.2%)
