...
contract StableTest is Context, IERC20, Ownable {
    ...
    string private _name = " StableTest";
    string private _symbol = " StableTest";
    ...
    address payable public marketingWallet = payable(0x00F21DF3e89cE2FDC78c5fD74c094348bEd2DcED);
