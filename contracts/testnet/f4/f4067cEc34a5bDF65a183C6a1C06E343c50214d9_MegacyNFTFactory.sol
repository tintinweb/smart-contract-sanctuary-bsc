...
/* Megacy NFT-ERC721 */
contract MegacyNFT is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
...
import "./MegacyNFT.sol";

/* Megacy NFT Factory
    Create new Megacy NFT collection
*/
contract MegacyNFTFactory {
    // owner address => nft list
    mapping(address => address[]) private nfts;
    mapping(address => bool) private megacyNFT;
