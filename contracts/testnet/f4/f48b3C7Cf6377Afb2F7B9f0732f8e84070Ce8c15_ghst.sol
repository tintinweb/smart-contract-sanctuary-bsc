    ...
    ReentrancyGuard
{
    ...
    uint256 public constant maxSupply = 610;
    ...
    uint256 public pricePresale = 0.05 ether;
    ...
    function priceFor(address _user) external view returns (uint256) {
        return (onlyWhitelisted && presaleSpotsAvailable[_user] > 0) ? pricePresale : pricePublic;
    }
