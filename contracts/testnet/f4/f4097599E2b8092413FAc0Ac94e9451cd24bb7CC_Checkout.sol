...
contract Checkout is DeHubUpgradeable, ICheckout {
   ...
   */
  function purchaseByBNB(string calldata _metadataURI)
    external
    payable
    override
    returns (uint256)
  {
    return _purchaseByBNBFor(msg.sender, _metadataURI);
  }
   ...
   * @return Receipt Id minted
   */
  function purchaseByBNBFor(address _forWhom, string calldata _metadataURI)
    external
    payable
    override
    returns (uint256)
  {
    return _purchaseByBNBFor(_forWhom, _metadataURI);
  }
   ...
   * @return Receipt Id minted
   */
  function purchaseByDeHub(uint256 _priceInDeHub, string calldata _metadataURI)
    external
    override
    returns (uint256)
  {
    return _purchaseByDeHubFor(msg.sender, _priceInDeHub, _metadataURI);
  }
  ...
  function purchaseByDeHubFor(
    ...
    return _purchaseByDeHubFor(_forWhom, _priceInDeHub, _metadataURI);
  }
   ...
   * @return Receipt Id minted
   */
  function purchaseByBUSD(uint256 _priceInBUSD, string calldata _metadataURI)
    external
    override
    returns (uint256)
  {
    return _purchaseByBUSDFor(msg.sender, _priceInBUSD, _metadataURI);
  }
  ...
  function purchaseByBUSDFor(
    ...
    return _purchaseByBUSDFor(_forWhom, _priceInBUSD, _metadataURI);
  }
  ...
  function _purchaseByBNBFor(address _forWhom, string memory _metadataURI)
    internal
    virtual
