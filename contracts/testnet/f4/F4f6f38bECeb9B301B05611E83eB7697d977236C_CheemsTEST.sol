...
contract CheemsTEST is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'CHEEMSTEST';
    string private constant _symbol = '$CINUTEST';
    ...
    //DevWallets
    address public TeamWallet=payable(0x9CFE1E430F5baBc7E04f0dF893018EB09d924Ee5);
    address public walletTwo=payable(0x69D2d982222b0f189355E84C6161A0AA284301aD);
    //TestNet
