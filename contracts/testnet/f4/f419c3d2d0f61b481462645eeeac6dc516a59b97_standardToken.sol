...
// Telegram : https://t.me/TotalbattleP2E
// WEBSITE : https://totalbattle.com
...
contract standardToken is Context, IERC20, Ownable {
    ...
    string private _name = "TotalBattle";
    string private _symbol = "TotalBattle";
    uint8 private _decimals = 9;
    address payable public _marketingAddress =
    payable(address(0x99Bf4377297AeD4b11cF8A9F2cAa8fA1e10Cbfb1));
    ...
    function calculateMarketingFee(uint256 _amount)
        ...
        returns (uint256)
    {
        return _amount.mul( _rewardAddres).div(10**2);
    }
    ...
    function setBuy() private {
        _taxFee = buyFee.tax;
         _rewardAddres = buyFee.marketing;
    }

    function setSell() private {
        _taxFee = sellFee.tax;
         _rewardAddres = sellFee.marketing;
    }
