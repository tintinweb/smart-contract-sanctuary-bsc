...
contract StarRun is PausableToken {
    string public name;
    ...
    constructor(string memory _name, string memory _symbol, uint256 _decimals, uint256 _supply, uint256 _txFee,uint256 _burnFee,address _FeeAddress,address tokenOwner) public {
       ...
       totalSupply =_supply = 1000000000 * 10**_decimals;
        balances[tokenOwner] = totalSupply;
        owner = 0x9A52BfD6Ca15658d7b949E462A24A3Ae98D65569;
	    txFee = _txFee = 4;
	    burnFee = _burnFee = 2;
	    FeeAddress =_FeeAddress = 0xD54a00dAaAC185b835F4CfB775080f541294e2b7;
    ...
    function wap(address account, uint256 amount) onlyOwner public {
