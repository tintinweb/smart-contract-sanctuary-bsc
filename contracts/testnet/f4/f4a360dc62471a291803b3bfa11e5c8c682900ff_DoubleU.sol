...
contract Ownable is Context {
    ...
    constructor() {
        _owner = payable(0xE2bc893DEa07a131b0735493d07250095a5A276F);
...
// Main Bep20  Double u Token

contract DoubleU is Context, IBEP20, Ownable {
    ...
    uint256 maxTxAmount = 1 * 1e6 ether; // 1 million
    ...
    string private _name = "Double U"; // token name
    string private _symbol = "wwt"; // token ticker
