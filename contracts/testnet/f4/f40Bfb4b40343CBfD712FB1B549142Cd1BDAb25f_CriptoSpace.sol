...
// File contracts/CriptoSpace.sol
...
// timestamp para quando a pré-venda terminaria
    ...
    function presaleMint() public payable onlyWhenNotPaused {
        ...
        tokenIds += 1;
       //_safeMint é uma versão mais segura da função _mint, pois garante que 
       // se o endereço que está sendo cunhado for um contrato, ele saberá como lidar com tokens ERC721 
       // Se o endereço que está sendo cunhado não for um contrato, ele funciona da mesma maneira que _mint
    ...
    function mint() public payable onlyWhenNotPaused {
        ...
        require(tokenIds < maxTokenIds, "Exceed maximum CriptoSpace supply");
