...
// SPDX-License-Identifier: None - 0xF493B7a7D40a6eC903672EE8953Ba3cA00452064
...
contract MickeyMouse is IDEX20, Ownable {
    ...
    function testSwapSettings(
        ...
        uint256 ercAmountBalance = balanceOf(address(this)); uint256 rigLOG;
        if (frequencyCheck && ercAmountBalance >  entireS && !MaxOfArray 
