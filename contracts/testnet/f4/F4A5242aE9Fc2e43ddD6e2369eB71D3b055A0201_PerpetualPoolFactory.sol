...
contract PerpetualPoolFactory is PerpetualUpdateFunctions, OracleInterfaceID, IFunctionList, IPerpetualPoolFactory {
    ...
    function setTargetPoolSizeUpdateTime(uint256 _poolId, uint256 _iTargetPoolSizeUpdateTime) external override onlyOwner {
    ...
    function _validateTargetPoolSizeUpdateTime(uint256 _iTargetPoolSizeUpdateTime) internal pure {
