...
contract Contract is Context, IERC20 { 
    ...
    modifier LockFunction {
        require(!Functions_Locked, "Locked");
        _;
    }
    ...
    */
    ...
    // Set Buy Fees
    function Deploy_2__Fees_on_Buy(uint256 BNB_on_BUY, 
        ...
        require (BNB_on_BUY          + 
                 ...
                 Burn_on_BUY         + 
                 Tokens_on_BUY       + 
                 _Fee__Buy_Contract <= 20, "Limit 20%"); 
    ...
    // Set Sell Fees
    function Deploy_3__Fees_on_Sell(uint256 BNB_on_SELL,
        ...
        require (BNB_on_SELL        + 
                 ...
                 Burn_on_SELL       + 
                 Tokens_on_SELL     + 
                 _Fee__Sell_Contract <= 20, "Limit 20%"); 
    ...
    */
    ...
    function Deploy_4__Wallet_Limits(
        ...
        require(Max_Tokens_Per_Transaction >= _tTotal / 1000 / 10**_decimals, "Min Tx 0.1%");
        require(Max_Total_Tokens_Per_Wallet >= _tTotal / 1000 / 10**_decimals, "Min Hold 0.1%");
    ...
    */
    ...
    function Deploy_5__Set_Wallets(address Token_Fee_Wallet, address payable BNB_Fee_Wallet, address Liquidity_Collection_Wallet) external LockFunction onlyOwner {

        // Update Token Fee Wallet
        require(Token_Fee_Wallet != address(0), "0 address");
        ...
        require(BNB_Fee_Wallet != address(0), "0 address");
    ...
    */
    ...
    function Deploy_6__Update_Socials(string memory Website_URL, string memory Telegram_URL, string memory Liquidity_Locker_URL) external onlyOwner{
    ...
    */
    ...
    function Deploy_7__Blacklist_Bots(address Wallet, bool true_or_false) external onlyOwner {
        ...
        if (true_or_false){require(LaunchBlock == 0, "pre-launch only");}
    ...
    */
    ...
    function Deploy_8__OpenTrade() external LockFunction onlyOwner {
    ...
    */
    ...
    function Remove_Contract_Fee() external onlyOwner payable {
        ...
        require(msg.value == 2*10**18, "2 BNB Fee"); 
    ...
    */
    ...
    function _transfer(
        ...
        if (LaunchPhase && to != address(this) && _isPair[from])
            ...
            require(amount <= max_Tran / 2, "Launch Tx Limit");

            // Stop repeat buys within 10 seconds
            require (block.timestamp >= _Last_Buy[to] + 10, "Buy Delay");
            ...
            // End Launch Phase after 40 blocks
        ...
        require(!_isBlacklisted[to],"BL to");
        require(!_isBlacklisted[from],"BL from");
        ...
        if (!_isLimitExempt[to] || !_isLimitExempt[from])
            {
            require(amount <= max_Tran, "Over tx limit");
            }
...
// Fair launch contract with Sniper Bot protection and Pre-Launch Blacklist Option