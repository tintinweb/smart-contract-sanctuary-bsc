...
contract Metamonstas is  IERC20, Ownable {
    ...
    string private _name = "MetaMonstas";
    ...
    address DevWallet=0xf9E7422cB5906f611b834716DBFDE26F1fda5B72;
    address MarketingWallet=0x89D884b9dca8E9aFDFF33cdB83CB33D91C15714b;
    address BuyBackWallet=0x1E38cd2Bfd20f94eF48F259bbEbd1Ec01D6Fe9C1;
    ...
    function setFeeReceivers (address _Dev, address _Marketing, address _Buyback) external onlyOwner {
    DevWallet = _Dev;
    ...
    function calculateContractFee(uint256 _amount, uint8 taxes) private view returns (uint256) {
        return (_amount*(_liquidityTax+_marketingTax+_DevTax+_buybackTax)*taxes)/10000;
    }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    uint8 _marketingTax=22;
    uint8 _DevTax=22;
    uint8 _buybackTax=22;
    ...
    uint256 BotProtectionTime=0;
    
    
    function SetTaxes(uint8 LP_, uint8 marketing_, uint8 Dev_, uint8 Buyback_,  uint8 reflection_, uint8 buy_, uint8 sell_, uint8 bot_, uint8 transfer_) public onlyOwner{
        require((LP_+marketing_+Dev_+Buyback_+reflection_)==100);
        _liquidityTax=LP_;
        _marketingTax=marketing_;
        _DevTax=Dev_;
        _buybackTax=Buyback_;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint16 totalTax=_liquidityTax+_marketingTax+_DevTax+_buybackTax;
