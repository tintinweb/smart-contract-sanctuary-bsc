...
contract KyotoLaunchpad {
    ...
    function getInvestmentAmount(string calldata idoID) external {
        ...
        require(
            ...
            "KyotoLaunchPad: IDO is not closed yet"
        );
        require(
     ...
     * @param idoID ID of the IDO
     */
    function cancelAndRefundIDO(string calldata idoID) external{
        _checkForOnlyOwner();
        require(
            _idos[idoID].tokenAddress != address(0),
            "KyotoLaunchpad: IDO doesn't exist"
        ...
        require(
            _idoInvestment.investors.length != 0,
            "KyotoLaunchPad: No investments found"
        );
        ...
        for (
            ...
            IERC20(_ido.tokenAddress).transfer(
                _ido.idoOwner,
