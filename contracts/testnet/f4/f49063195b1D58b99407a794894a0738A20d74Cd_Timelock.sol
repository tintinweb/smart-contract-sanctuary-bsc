...
contract Timelock {
	string public description = 'Locking some tokens';
	uint256 public constant _duration = 15 minutes;
	uint256 public immutable _end;
	address public immutable _deployer;
	address[] public _owners;
	ERC20 _token = ERC20(0x159e34c2aA21b0933548b8CD1a2A8De7243B7C31);
