...
contract TakaToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Taka Token", "TAKA") {
        	
    	marketingWallet = 0x5584058C5CC998fe81298A9564CeD159Ae0898d0; 
    ...
    function updatebusdDividendTracker(address newAddress) external onlyOwner {
        ...
        require(newbusdDividendTracker.owner() == address(this), "Test: The new dividend tracker must be owned by the Taka token contract");
