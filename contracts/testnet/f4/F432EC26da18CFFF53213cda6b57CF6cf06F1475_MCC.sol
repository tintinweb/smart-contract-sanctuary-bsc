...
contract MCC is Context, IERC20, Ownable {
  ...
  address payable public marketingWalletAddress = payable(0xF8a41EEA22Cc211b16eC1aD279891c9a761421E0); // Marketing Address
  address payable public teamWalletAddress = payable(0xc8300378C4728EC4962593E13017A362aDff3931); // Team Address
  ...
  uint256 private _totalSupply = 1314520 * 10**_decimals;
  uint256 public _maxTxAmount = 520 * 10**_decimals;
  uint256 public _walletMax = 1314 * 10**_decimals;
  uint256 private minimumTokensBeforeSwap = 1314520 * 10**3;
