...
contract Presale is IPreIDOBase, Ownable {
    ...
    receive() external payable inPresalePeriod {
        ...
        _order(msg.value, 18, price, priceFeed.decimals(), 1); // default to 1% discount rate
    }
    ...
    function _order(
        ...
        uint256 tokenPriceX4 =  (100 * (100 - discountsRate)) / 100;   //(100 * (100 - discountsRate)) / 100; // 100 = 0.01(default price) * 10^4
        //(300 * (100 - discountsRate)) / 100; // 300 = 0.03(default price) * 10^4
