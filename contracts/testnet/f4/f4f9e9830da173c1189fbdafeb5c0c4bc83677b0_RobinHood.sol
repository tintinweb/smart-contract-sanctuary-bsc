...
/*
    ____        __    _          ______      _     
   / __ \____  / /_  (_)___     / ____/___  (_)___ 
  / /_/ / __ \/ __ \/ / __ \   / /   / __ \/ / __ \
 / _, _/ /_/ / /_/ / / / / /  / /___/ /_/ / / / / /
/_/ |_|\____/_.___/_/_/ /_/   \____/\____/_/_/ /_/ 
...
/*
  ...
  Your Project Name
  *for cool ASCII names use https://patorjk.com/software/taag/#p=display&f=Slant&t=Type%20Something%20
  Website:  https://
  Telegram: https://
  Twitter:  https://

      __ __ _________ __  ______________    ____ 
     / //_//  _/ ___// / / /  _/ ____/ /   / __ \
    / ,<   / / \__ \/ /_/ // // __/ / /   / / / /
   / /| |_/ / ___/ / __  // // /___/ /___/ /_/ / 
  /_/ |_/___//____/_/ /_/___/_____/_____/_____/  
  Build By KISHIELD: https://www.kishield.com/    

  Features:
  + No fee for transfer between wallets
  + BUSD dividents (reflectionFee)
...
contract RobinHood is IBEP20, Ownable {
    using SafeMath for uint256;

	string constant _name = 'RobinHood';   // Name
	string constant _symbol = 'RBTEST';    // Symbol
	uint8 constant _decimals = 18;         // Decimals

    uint256 private constant _totalSupply = 1_000_000 * (10 ** _decimals);  // 1 million
    uint256 public  constant _maxWalletLimit = 10_000 * (10 ** _decimals);  // 1%
    ...
    mapping (address => bool) isMaxWalletExempt; // UNIQUE

    // FEES CALCULATIONS:
    // 100 tokens @ 12% fee
    // fee = 100 * 1200 / 10000 = 12

    // Buy Fees
    uint256 constant reflectionFeeBuy = 800;
    uint256 constant liquidityFeeBuy  = 200;
    uint256 constant marketingFeeBuy  = 200;
    uint256 constant totalFeeBuy      = 1200;

    // Sell Fees
    uint256 constant reflectionFeeSell = 800;
    uint256 constant liquidityFeeSell  = 200;
    uint256 constant marketingFeeSell  = 200;
    uint256 constant totalFeeSell      = 1200;
    ...
    constructor ( address _dexRouter ){
        ...
        // HH 0x70997970C51812dc3A010C7d01b50e0d17dc79C8
        autoLiquidityReceiver = 0x0600061016d090f004925000D80008e0fA1610c0;
        marketingFeeReceiver = 0x0600061016d090f004925000D80008e0fA1610c0;
    ...
    // Burn amount amount from msg.sender
