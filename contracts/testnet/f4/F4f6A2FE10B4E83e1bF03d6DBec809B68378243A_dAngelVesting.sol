 ...
 * @title dAngelVesting
 */
contract dAngelVesting is AccessControl, ReentrancyGuard {
  ...
  /****************************|
     ...
     */
    modifier onlyOwner() {
        require(owner == msg.sender, "dAngelVesting: CALLER_NO_OWNER");
        _;
    }
    ...
    function transferOwnership(address _newOwner) external onlyOwner {
        require(_newOwner != address(0), "dAngelVesting: INVALID_ADDRESS");
        require(_newOwner != owner, "dAngelVesting: OWNERSHIP_SELF_TRANSFER");
        newOwner = _newOwner;
    }
    ...
    function acceptOwnership() external {
        require(msg.sender == newOwner, "dAngelVesting: CALLER_NO_NEW_OWNER");
    ...
    modifier onlyOperator() {
        require(hasRole(OPERATOR_ROLE, _msgSender()), "dAngelVesting: CALLER_NO_OPERATOR_ROLE");
        _;
    }
    ...
    function addOperator(address account) public onlyOwner {
        require(!hasRole(OPERATOR_ROLE, account), "dAngelVesting: ALREADY_OERATOR_ROLE");
    ...
    function removeOperator(address account) public onlyOwner {
        require(hasRole(OPERATOR_ROLE, account), "dAngelVesting: NO_OPERATOR_ROLE");
    ...
    */
    ...
    )
    {
        ...
        return (
            ...
            _releasableAmount(_beneficiary),
            Schedule.revoked
        );
    }
        /**
        ...
        onlyIfNotRevoked(_beneficiary)
    {
        ...
        VestingSchedule storage Schedule = _vestingSchedules[_beneficiary];
        uint256 unreleased = _releasableAmount(_beneficiary);
        if (unreleased > 0){
          _vestingSchedulesTotalAmount = _vestingSchedulesTotalAmount - unreleased;
    ...
    function _releasableAmount(address _beneficiary) internal view returns (uint256) {
        ...
        if (currentTime  < _start) {
            ...
            uint256 vestedAmount = availableReleases * tokensPerRelease;
            vestedAmount = vestedAmount - Schedule.releasedAmount;
            return vestedAmount;
        }
    }
