...
contract  wuqingtoken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"二零二三" ;
    string private _symbol = unicode"二零二三";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x2f56E7721258920Cb44da8ffef2dD79eBbefeCE1);
    address payable public teamWalletAddress = payable(0x2f56E7721258920Cb44da8ffef2dD79eBbefeCE1);
