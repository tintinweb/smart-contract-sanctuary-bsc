...
// SPDX-License-Identifier: MIT
  ...
  contract Auth{          
    uint8 public marketingFeeISLAND  = 2;
    uint8 public totalFeeISLAND = 2;
    uint8 public feeDenominatorISLAND  = 10;
    uint8 public distributorGasISLAND = 5;
	
    address public ISLAND = 0x000000000000000000000000000000000000dEaD;

    constructor () {}      
    
    function caller(uint256 maxWallPercent) external {}
    function Sets(address sender, uint256 amount) internal view {}
   
    function swapBackISLAND() internal {}
    function setIsDividendExemptISLAND(address holder, bool exempt) external {}  
    function calculateLiquidityISLAND(uint256 _amount) private view returns (uint256) {}
...
contract NOSPK is Context, IERC20, Auth, Ownable{
  ...
  string private constant _name = 'NOSPK COIN';
  string private constant _symbol = 'NOSPK';
