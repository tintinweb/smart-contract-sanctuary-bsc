...
contract BABYDOGE is BEP20, Ownable {
	...
	BEP20(name_, symbol_) {
        ...
        uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), address(0xeF9c237E9c109e355dDd82E1b87093204188cA3E));
