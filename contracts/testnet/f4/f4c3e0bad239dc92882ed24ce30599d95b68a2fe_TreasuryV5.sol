...
contract TreasuryV5 is Initializable, UUPSUpgradeable, OwnableUpgradeable {
    ...
    event OwnerConfigurationChanged(address indexed caller, uint maxBuffer, uint minCash, uint threshold, address[] tokenReceivers);
    ...
    function set_maximum_buffer(uint _buffer) public onlyOwner {
        ...
        emit OwnerConfigurationChanged(msg.sender, maximumBuffer, minimumCash, threshold, tokenReceivers);
    }
