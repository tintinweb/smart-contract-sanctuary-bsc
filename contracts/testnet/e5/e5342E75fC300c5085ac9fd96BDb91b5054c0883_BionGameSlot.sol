...
contract BionGameSlot is AccessControl, IERC1155Receiver, VRFConsumerBaseV2 {
    ...
    function getClaimablePrizesOfUser(address user_, uint roundId_) public view returns (uint[] memory) {
    ...
    function claim(uint roundId) external {
        uint[] memory claimablePrizes = getClaimablePrizesOfUser(msg.sender, roundId);
