...
contract Market is AccessControl,Ownable{
    ...
    event Shelves(uint256 indexed tokenId,uint256 indexed amount);
    ...
    // 市场
    function getNarkets() view public returns(market[] memory){
        return markets;
    }
    ...
    function stake(uint256 _tokenId) public{
        ...
        _tokenMtStakeInfo[_tokenId] = mtStakeInfo(_tokenId,block.timestamp,block.timestamp + _stakeInfo.day*3600,_stakeInfo.money);
    ...
    function nftTransferFrom(address from,address to,uint256 _tokenId) internal{
        ...
        _inft.transferFrom(from,to, _tokenId);
    }
