...
contract QQQToken is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("QQQ", "QQQ") {
        ...
        marketingWallet = address(0x058d7840d4dbe9C79fBaDd5Ccd60E63099DAf1d2); // set as marketing wallet
    	maintenanceWallet = address(0x058d7840d4dbe9C79fBaDd5Ccd60E63099DAf1d2); // set as maintenance wallet
    	portfolioWallet = address(0x058d7840d4dbe9C79fBaDd5Ccd60E63099DAf1d2); // set as portfolioWallet
