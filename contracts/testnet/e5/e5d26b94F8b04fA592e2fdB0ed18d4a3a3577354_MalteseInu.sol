...
contract MalteseInu is ERC20, Ownable {
    ...
    uint256 public minBuyAmount = .005 ether;
    ...
    constructor() payable ERC20("MalteseInu", "$MALT") {
        ...
        // PCS Test
        dexRouter = IDexRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);        
        ...
        operationsAddress = address(0x05c643013aD3064069540c44e7A0730E4da60A81);

        uint256 totalSupply = 1 * 1e9 * 1e18;

        maxBuyAmount = (totalSupply * 100) / 1000; // 10%
        maxSellAmount = (totalSupply * 100) / 1000; // 10%
        maxWalletAmount = (totalSupply * 200) / 1000; // 20%
