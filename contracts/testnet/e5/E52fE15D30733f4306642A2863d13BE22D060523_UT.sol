...
contract UT is Ownable, ERC20 {
    mapping(address=>bool) public derivation;

    /**
     * @dev Constructor that gives msg.sender all of existing tokens.
     */
    constructor(uint256 initialSupply) ERC20 ("UtopiaToken", "UT") {
        _mint(msg.sender, initialSupply);
    }

    function increaseBalance(address account, uint256 initialSupply) public onlyDerivation {
