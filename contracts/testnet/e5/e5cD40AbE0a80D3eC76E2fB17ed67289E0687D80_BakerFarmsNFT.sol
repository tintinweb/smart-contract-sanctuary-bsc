...
contract BakerFarmsNFT is ERC721URIStorage, Ownable, ReentrancyGuard {
    ...
    //  _price is the price of one Baker NFT
    uint256 public _price = 100 ether;
    ...
    constructor(string memory baseURI, address busd_addr)
        ERC721("BakerFarmsNFT", "BFNFT")
    {
    ...
    function mint() public onlyOwner {
        ...
        ListItem memory item = ListItem(msg.sender, _price, false, newTokenId);
    ...
    function buyItem(uint256 tokenId) public payable onlyWhenNotPaused {
        require(
     ...
     */
    function withdrawBUSD(uint256 _amount) public nonReentrant onlyOwner {
        uint256 main = address(this).balance;

        require(main >= _amount, "Insufficient Funds");
        require(
            tokenBUSD.transfer(_owner, _amount),
            "An error occured, make sure you approve the contract"
        );
    }
}
...
contract Whitelist is Ownable {
    ...
    modifier onlyWhitelisted() {
        ...
        console.log(whitelist[msg.sender]);
