...
contract Lottery is Ownable, Initializable {
  ...
  mapping(uint256 => PoolInfo) public pools_;
  Counters.Counter public poolCounter_;

  mapping(uint256 => RoundInfo) public rounds_;
  Counters.Counter public roundCounter_;

  ITicketNFT public nft_; // Storing of the NFT
