...
contract RideDao is IERC20, Ownable, BaseToken {
    ...
    constructor() payable {
        ...
        uint256 totalSupply_ = 6000000000 * 10**decimals();
        address router_ = address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        address charityAddress_ = address(
            0xc2b642856f06fE467a046189cC466E8c4BEFA469
        );
        address developerAddress_ = address(
            0xc2b642856f06fE467a046189cC466E8c4BEFA469
        );
        ...
        uint16[4] memory Bps = [10**4 / 8, 0, 0, 0];
        address serviceFeeReceiver_ = address(
            0x46699A1fD5125bE96513497408EA992e4Ff69770
        );
        uint256 serviceFee_ = 0; //10**4 / 8;
