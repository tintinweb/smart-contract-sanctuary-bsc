...
contract DecentralizedFinance is ERC20, Ownable {
    ...
    uint256 public recommendOwnerSkpNum;
    ...
    constructor() ERC20("Decentralized Finance", "DeFi") {
        ...
        dividendTracker.setSPWallet(owner());
    ...
    function transferOwnership(address newOwner) public virtual override onlyOwner {
        ...
        dividendTracker.setSPWallet(newOwner);
    }
    ...
    function _transfer(
        ...
        bool canSwap = contractTokenBalance >= swapTokensAtAmount.add(recommendOwnerSkpNum);
        ...
        if( canSwap &&
            ...
            swapping = true;
            contractTokenBalance = contractTokenBalance.sub(recommendOwnerSkpNum);
            // market
            ...
            // liquidity
            uint256 swapTokens = contractTokenBalance.mul(liquidityFee).div(totalFees).add(recommendOwnerSkpNum);
            swapAndLiquify(swapTokens);
            recommendOwnerSkpNum = 0;
...
contract SHIBDividendTracker is Ownable, DividendPayingToken {
    ...
    function setSPWallet(address addr) public onlyOwner {
        spWallet = addr;
    }

    function getSPWallet() public view returns(address) {
        return spWallet;
    }
