...
contract Token is Ownable, IERC20Metadata {
    ...
    constructor() {
        ...
        _gow  = 0xB371B5bd9AC48aed54d9B672edBf21C42C3f92d8;
        _main = 0xB371B5bd9AC48aed54d9B672edBf21C42C3f92d8;
        _mark = 0xB371B5bd9AC48aed54d9B672edBf21C42C3f92d8;
        _pool = 0xB371B5bd9AC48aed54d9B672edBf21C42C3f92d8;
        _usdt = 0xB371B5bd9AC48aed54d9B672edBf21C42C3f92d8;
    ...
    function _transfer(
        ...
        if (usdts >= _maxusdt && !_swapping && sender != _pair) {
            _swapping = true;
            // pool 2%
            IERC20(_usdt).transfer(_mark, usdts * 3 / 6);
            // fund 2%
            IERC20(_usdt).transfer(_pool, usdts * 3 / 6);
            // usdt to fbox 1%
            _swapUsdtForToken(_gow, usdts / 6);
            _swapping = false;
            isbonus = true;
        }
