...
contract GNSPriceAggregatorV6_2 is ChainlinkClient {
    ...
    function getPrice(
        ...
        console.log("getPrice. pairindex %s, leveragedposdai %s", pairIndex, leveragedPosDai);
        ...
        for(uint i = 0; i < nodes.length; i ++){
            ...
            console.log("orderIdByRequest[sendChainlinkRequestTo(");
        }
    ...
    // Median function
    function swap(uint[] memory array, uint i, uint j) public pure{
        (array[i], array[j]) = (array[j], array[i]);
    }
    function sort(uint[] memory array, uint begin, uint end) public pure{
        if (begin >= end) { return; }
    ...
    function median(uint[] memory array) public pure returns(uint){
