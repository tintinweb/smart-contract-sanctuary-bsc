...
contract TMTToken is BEP20, BEP20Burnable {
    address public minter;
    address private owner;

    event MinterChanged(address indexed from, address to);

    constructor() BEP20("Test Matching Token", "TMT") {
      owner = msg.sender;
    }

    function passMinterRole(address newMinter) public returns (bool) {
      require(minter==address(0) || msg.sender==minter || msg.sender == owner, "You are not minter");
      minter = newMinter;
