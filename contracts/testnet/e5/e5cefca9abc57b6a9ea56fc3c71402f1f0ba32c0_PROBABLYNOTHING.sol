...
contract PROBABLYNOTHING is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Probably Nothing";
    string constant _symbol = "NOTHING";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 666666666666666666 * 10**_decimals;
