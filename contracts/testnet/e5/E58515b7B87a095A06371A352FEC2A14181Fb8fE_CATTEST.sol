...
library Address{
 ...
 contract CATTEST is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x2578b9D4CA7eF68B990D18dC2dD31Aca95EBcADC;
    address public eCoWallet = 0x2578b9D4CA7eF68B990D18dC2dD31Aca95EBcADC;

    string private constant _name = "CAT TEST";
    ...
    Taxes public sellTaxes = Taxes(1, 12, 2, 2);
