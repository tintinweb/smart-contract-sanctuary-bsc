    ...
    VRFConsumerBaseV2
{
    ...
    mapping(uint256 => RequestPayload) private _requestIdToRequestPayload;
    ...
    constructor(
        ...
        address linkTokenContract_,
        uint64 subscriptionId_,
        bytes32 keyHash_,
        uint256 fee_
    ) VRFConsumerBaseV2(vrfCoordinator_) {
        COORDINATOR = VRFCoordinatorV2Interface(vrfCoordinator_);
        LINKTOKEN = LinkTokenInterface(linkTokenContract_);
     ...
     * Requests randomness
     */
    function requestRandomWords(uint256 tokenId_) public onlyRole(CONSUMER_ROLE) {
        require(
    ...
    function fulfillRandomWords(
        ...
        _tokenIdToRandomNumber[_payload.tokenId] = randomWords_[0];

        IRandomConsumer _consumer = IRandomConsumer(_payload.requester);
        _consumer.rawFulfillRandomWords(_payload.tokenId, randomWords_);
    ...
    function withdrawBnb(uint256 amount_) external onlyRole(OPERATOR_ROLE) {
    ...
    function removeConsumer(address consumerAddress)
        external
        onlyRole(OPERATOR_ROLE)
    {
    ...
    // 1000000000000000000 = 1 LINK
    function withdrawLink(uint256 amount, address to)
        external
        onlyRole(OPERATOR_ROLE)
    {
