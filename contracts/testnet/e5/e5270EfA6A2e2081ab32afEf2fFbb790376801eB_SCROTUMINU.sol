...
/**
 *  ______   ______  ______   ______  _______  _    _   _________    _____  ______   _    _  
 * / |      | |     | |  | \ / |  | \   | |   | |  | | | | | | | \    | |  | |  \ \ | |  | | 
 * '------. | |     | |__| | | |  | |   | |   | |  | | | | | | | |    | |  | |  | | | |  | | 
 *  ____|_/ |_|____ |_|  \_\ \_|__|_/   |_|   \_|__|_| |_| |_| |_|   _|_|_ |_|  |_| \_|__|_|
 */
...
contract SCROTUMINU is IBEP20, Ownable {
    ...
    string _name = "SCROTUM INU";
    string _symbol = "SCROTE";
