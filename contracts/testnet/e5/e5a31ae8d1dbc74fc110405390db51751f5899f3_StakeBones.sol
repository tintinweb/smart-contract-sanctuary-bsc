...
contract StakeBones is SecurityBase, Ownable {
    ...
    mapping(address => uint256) private timeAction;
...
require( block.timestamp - timeAction[msg.sender]  >= 2505600, "30 days must have passed since your last operation");
timeAction[msg.sender] = block.timestamp ;
