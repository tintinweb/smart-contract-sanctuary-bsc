...
contract LaunchpadPresale is Initializable, ReentrancyGuard, Ownable, Pausable {
    ...
    address public feeAddress;
    address public signer = 0x932241Be334109Dd6EE2834899Fa347a3D14cEf8;
     ...
     */
    function getWhitelisted(bytes32 hash, bytes memory signature) public {
        require(recover(hash, signature) == signer, "Wrong Signer");
