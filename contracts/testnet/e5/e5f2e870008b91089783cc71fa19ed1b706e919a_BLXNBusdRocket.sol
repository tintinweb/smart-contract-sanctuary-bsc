...
contract BLXNBusdRocket {
    ...
    address constant loanWallet = 0x052E9FB338F18170edA1F69fDC546183e1e4474E;
    ...
    function MakeDeposit(uint256 amtx, address reffy) public {
        ...
        uint256 loanFee = amtx*30/1000; // loan wallet for seed round funding agreement

        BUSD.safeTransferFrom(msg.sender, address(this), amtx);
        BUSD.safeTransfer(devWallet, devFee);
        BUSD.safeTransfer(loanWallet, loanFee);
