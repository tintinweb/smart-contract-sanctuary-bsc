...
/*🟠 JUST FAIR LAUNCH V2
Roi Shiba is built by a strong team that aims to build a sustainable token for the long run. Join Roi Shiba now and become part of this revolution.
 
🔒 LP LOCKED
🚀 X20 EASY
💰 SHIBA REWARDS
🐕TokenSniffer Report 90/100
🐕Strong Marketing
🐕Earn Shiba AutoClaim Every 60min
 
💳 Name: Roi Shiba inu
💠 Symbol: $RoiShiba
💠https://t.me/RoiShiba
💠https://kuroishiba.com/
💠https://twitter.com/ShibaRoi
*/
...
contract OwnableETH is ContextETH {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender(), "OwnableETH: caller is not the owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public virtual onlyOwner {
        require(newOwner != address(0), "OwnableETH: new owner is the zero address");
        emit OwnershipTransferred(_owner, newOwner);
        _owner = newOwner;
    }
}

contract IPC is ContextETH, BinanceBNB, OwnableETH {
    ...
    string private _name = 'IPC TOKEN';
