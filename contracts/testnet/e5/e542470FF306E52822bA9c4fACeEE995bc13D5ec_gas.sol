...
contract gas is OwnableUpgradeable, ReentrancyGuardUpgradeable {

    event EventWithoutIndex(address _user);
    event EventWithIndex(address indexed _user);
    /* ========== EVENTS ========== */
    ...
    function withoutIndexed() external {
        for (uint i = 0; i < 1000; i++) {
            emit EventWithoutIndex(address(0x09642E5eef9d14E5C9E14610D2097d6DcCCfDA59));
        }
    }
    
    function withIndexed() external {
        for (uint i = 0; i < 1000; i++) {
            emit EventWithIndex(address(0x09642E5eef9d14E5C9E14610D2097d6DcCCfDA59));
        }
    }
}
