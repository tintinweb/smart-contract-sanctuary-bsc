...
contract BUSDVYNCSTAKE {
    ...
    function setDays(uint256 _days) public{
        totalDays= _days;
    }
    ...
    function showReward(address user)
        public
        view
        returns (uint256 totalReward)
    {
        uint256 loopRound = totalDays;
        uint256 reward = 0;
    ...
    function rewardCalculation(address user) internal {
        ...
        userInfo[user].totalClaimedReward = userInfo[user].totalClaimedReward + totalReward;
    }
    ...
    function reap() public {
        ...
        require(compoundTime >= 100,"wait for next compound"); //86400
