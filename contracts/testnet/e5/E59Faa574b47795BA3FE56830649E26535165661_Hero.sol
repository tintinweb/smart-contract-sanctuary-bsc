...
contract Hero is BEP721 {
    ...
    // constructor
    constructor(address _owner, IBEP20 _HBG) BEP721("HERO Token", "HERO") {
        owner = _owner;
        HBG = IBEP20(_HBG);
    }
    ...
    function buyBox(
        ...
        if (_type == 1) {
            ...
            require(HBG.balanceOf(msg.sender) >= silverPrice, "invalid Price ");
            ownerOfSilverBox[silverBox] = msg.sender;
            silverBox += 1;
            HBG.transferFrom(msg.sender, owner, silverPrice);
            circulatingSupply += 1;
            ...
            require(HBG.balanceOf(msg.sender)  >= goldPrice, "invalid Price ");
            ownerOfGoldenBox[goldenBox] = msg.sender;
            goldenBox += 1;
            HBG.transferFrom(msg.sender, owner, goldPrice);
            circulatingSupply += 1;
            _mint(msg.sender, circulatingSupply);
            start[circulatingSupply] = block.timestamp;
            emit buyNewBox(msg.sender, "Gold", circulatingSupply);
        } else if (_type == 3) {
            require(platinumBox < totalSupplyPlatinumBox, "Out of platinum Box");
            require(HBG.balanceOf(msg.sender)  >= platinumPrice, "invalid Price ");
            ownerOfPlatinumBox[platinumBox] = msg.sender;
            platinumBox += 1;
            HBG.transferFrom(msg.sender, owner, platinumPrice);
            circulatingSupply += 1;
            _mint(msg.sender, circulatingSupply);
            start[circulatingSupply] = block.timestamp;
            ...
            require(HBG.balanceOf(msg.sender)  >= diamondPrice, "invalid Price ");
            ownerOfDiamondBox[diamondBox] = msg.sender;
            diamondBox += 1;
            HBG.transferFrom(msg.sender, owner, diamondPrice);
            circulatingSupply += 1;
            _mint(msg.sender, circulatingSupply);
            start[circulatingSupply] = block.timestamp;
