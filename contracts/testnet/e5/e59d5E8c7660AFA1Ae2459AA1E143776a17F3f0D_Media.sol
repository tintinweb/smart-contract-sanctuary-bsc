...
contract Media is Ownable {
    ...
    event MintToken (uint256 _id, string _contractType, string _uri, uint256 _copies, address _royaltyReceiver, uint96 _tokenRoyaltyInBips);
        ...
        returns (uint256)
    {
        ...
        emit MintToken(_id, _contractType, _uri, _copies, _royaltyReceiver, _tokenRoyaltyInBips);
