...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Goldenzone", "GLD") {

        address _owner = _msgSender();

        _decimals = 18;

        uint256 totalSupply = 1 * 1e7 * (10**_decimals);
        ...
        marketingWallet = address(0xc9BeD279FAEdAf49Be40cc714E0f3819E178B45F); // set as marketing wallet
