...
contract golden9 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = unicode"golden9";
    string private _symbol = unicode"GDN";
    uint8 private _decimals = 8;

    address payable public marketingWalletAddress = payable(0x724Ed06a82668048377f523AF20CB42c019E8BbF); 
