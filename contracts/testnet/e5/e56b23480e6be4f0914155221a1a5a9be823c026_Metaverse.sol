...
// File: contracts/MetaverseOld.sol
...
contract Metaverse is ERC20, Ownable {
    ...
    address public WBNB = 0x11e815a78Cc41D733Db00f06B3A96074855362CE;

	constructor() ERC20("metaverse DAO", "META2DIDO") {
		_leftTotalSupply = 100000000 * 10 ** decimals();	
		_feeRate = 10;		// 百分比
        ...
        address _dexRouter = address(0xB6BA90af76D139AB3170c7df0139636dB6120F7e);
    ...
    function swapBack(address sender,uint256 fee) internal {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = WBNB;
         _approve(sender, address(router), fee);
