...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x8256138Bd0959Ab563c5C994b7e109427a841572; // owner address
...
contract Dartien is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dartien";
    string private _symbol = "DRT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xFF3F89cCBc534A55b366B3255b716e7c685afF7a); // Marketing Address
    address payable public teamWalletAddress = payable(0x8256138Bd0959Ab563c5C994b7e109427a841572); // Team Address
    ...
    uint256 private minimumTokensBeforeSwap = 40000000 * 10**3; 
