...
import "./types/standard/StandardToken.sol";
import "./types/liquidity-generator/LiquidityGeneratorToken.sol";
...
contract TokenFactory is Context, ReentrancyGuard{
    ...
    */
    function createLiquidityGenerator(
        ...
        LiquidityGeneratorToken liquidityGeneratorToken = new LiquidityGeneratorToken(
            name, 
            symbol, 
            decimals_, 
            totalSupply, 
        ...
        _transferTokens(liquidityGeneratorToken);
        
        _saveToken(address(liquidityGeneratorToken));

        return address(liquidityGeneratorToken);
    }
