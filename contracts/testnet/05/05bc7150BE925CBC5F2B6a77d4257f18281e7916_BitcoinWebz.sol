...
contract BitcoinWebz is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 12000000 * 10**1 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "BitcoinWebz";
    ...
    uint256 public maxSellPerDay = 1 * 10**1 * 10**18;
    uint256 public _maxTxAmount = 12000000 * 10**1 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 12000000 * 10**1 * 10**18;
