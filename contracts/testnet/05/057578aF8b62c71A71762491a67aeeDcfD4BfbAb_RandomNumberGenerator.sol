...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Frst lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == frstLottery, "Only FrstLottery");
    ...
    /**
     * @notice Set the address for the FrstLottery
     * @param _frstLottery: address of the Frst lottery
     */
    function setLotteryAddress(address _frstLottery) external onlyOwner {
        frstLottery = _frstLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IFrstLottery(frstLottery).viewCurrentLotteryId();
    }
}
