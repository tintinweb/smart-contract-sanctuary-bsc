...
contract RunEarner is ERC20, Ownable {
    ...
    address public immutable rewardToken = 0x8516Fc284AEEaa0374E66037BD2309349FF728eA; 
    address public immutable rewardTokenII = 0x8516Fc284AEEaa0374E66037BD2309349FF728eA;
    ...
    {          
        ...
        insuranceWallet  = 0xfee2879FAAb37E5662BD5E9D2f211cFc897C7340;     
    ...
    function shouldRebase() internal view returns (bool) {
        return
            ...
            !inSwap &&
            block.timestamp >= (lastRebasedTime + 5 minutes);
    }

    function rebase() internal {
        
        if ( inSwap ) return;
        uint256 times = (block.timestamp - lastRebasedTime) / 5 minutes;
        ...
        rate = rSupply / _totalSupply;
        lastRebasedTime = lastRebasedTime + (times * 5 minutes);
