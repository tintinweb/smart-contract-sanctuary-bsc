...
contract Calamus is Initializable, OwnableUpgradeable, ICalamus, IPlatformFee, ReentrancyGuardUpgradeable, CarefulMath, PausableUpgradeable {
    ...
    function _createBatchStreams(Types.StreamGeneral memory generalInfo, Types.Recipient[] memory recipients, address realRender) internal {
        address sender = msg.sender;
        if (sender == systemAddress) {
            sender = realRender;
        }
        CreateStreamLocalVars memory vars;
    ...
    function batchStreams(Types.StreamGeneral memory generalInfo, Types.Recipient[] memory recipients, address realSender) external whenNotPaused nonReentrant {
        _createBatchStreams(generalInfo, recipients, realSender);
    }
...
interface ICalamus {
    ...
    */
    ...
    function batchStreams(Types.StreamGeneral memory generalInfo, Types.Recipient[] memory recipients, address realSender) external;
