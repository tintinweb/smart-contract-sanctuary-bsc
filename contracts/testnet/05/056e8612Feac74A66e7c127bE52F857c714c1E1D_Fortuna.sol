...
contract Fortuna {
    ...
    function buyNewLevel( uint8 level) external payable {
        ...
        require(!users[msg.sender].activeX3Levels[level], "level already activated");
            ...
            address random_ref = idToAddress[getLineWinnerByLevel(level)]; 
    ...
    function registration(address userAddress, address referrerAddress) private {
        ...
        address random_ref = idToAddress[getLineWinnerByLevel(1)]; 
    ...
    function getLineWinnerByLevel(uint256 level) public view returns(uint256) {
