...
contract BeRich is ERC20, Ownable {
    ...
    constructor(
    ...
    ) payable ERC20("BeRich", "BR")  {
        uint256 totalSupply_ =  2 * 10**13;
        address serviceAddr_ = 0x3447b2ea50E7bC50984959a44CcD88a34233e09E;//0xaa847FCe96BD2a183d42eeE2c56d0464De8b2385;
        uint256 minimumTokenBalanceForDividends_ = totalSupply_.div(10**5);// 0.001%
        address router = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;// 0xB6BA90af76D139AB3170c7df0139636dB6120F7e;
        rewardToken = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684;
        _marketingWalletAddress = 0xF000942c4398360aace96a16DCbAfCBDe3752b1B;


        uint8[4]  memory buyFeeSetting_=[5,1,5,0];
        ...
        uint8[4]  memory sellFeeSetting_=[5,1,5,0];
        ...
        require(buyTokenRewardsFee.add(buyLiquidityFee).add(buyMarketingFee).add(buyDeadFee) <= 50, "Total buy fee is over 50%");
        require(sellTokenRewardsFee.add(sellLiquidityFee).add(sellMarketingFee).add(sellDeadFee) <= 50, "Total sell fee is over 50%");
        ...
        dividendTracker.initialize{value: msg.value}(rewardToken,minimumTokenBalanceForDividends_);
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "RedCheCoin The dividend tracker already has that address"
        );
