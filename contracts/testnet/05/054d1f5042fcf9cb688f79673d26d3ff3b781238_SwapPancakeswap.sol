...
contract SwapPancakeswap is Ownable {
    ...
    */
    ...
    function tradeExactBNBForToken_pairMethod(address pairAddress, address receiver, uint256 deadlineOffset) external payable onlyOwner {
        require(IPancakePair(pairAddress).token0()==0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd || IPancakePair(pairAddress).token1()==0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd, 'PAIR_DOES_NOT_HAVE_WBNB');
