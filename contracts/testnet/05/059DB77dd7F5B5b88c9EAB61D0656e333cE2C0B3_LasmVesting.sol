...
//        registerEvent(msg.sender, index, claimAmount);
    ...
    function claimByScheduleName22(string memory _templateName) external view returns (uint256 ){
        require(vestingToken != address(0), "Vesting: VESTINGTOKEN_NO__SET");
    ...
    function claimByScheduleName33(string memory _templateName) external {
        require(vestingToken != address(0), "Vesting: VESTINGTOKEN_NO__SET");
