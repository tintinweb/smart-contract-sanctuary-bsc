...
abstract contract Context {
    ...
    function _msgData() internal view virtual returns (bytes memory) { // silence state mutability warning without generating bytecode - see https://github.com/ethereum/solidity/issues/2691
        return msg.data;
    }
}
...
contract CRONOS is Context, IERC20, Ownable {
    ...
    payable(address(0x72B9c24267847F874d6d4B6c6Af679988Ceb8339));
    ...
    {
        require(
            rAmount <= _rTotal,"cronosdragon lfg"
