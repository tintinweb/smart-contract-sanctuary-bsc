...
contract Vault is Initializable, PausableUpgradeable, OwnableUpgradeable {
    using SafeERC20Upgradeable for IERC20Upgradeable;

    IERC20Upgradeable public busd;
    IERC20Upgradeable public paymentToken;
    IERC20Upgradeable public pegToken;
    IERC20Upgradeable public liquidityLink;
    ...
    function initialize(
        ...
        IERC20Upgradeable _liquidityLink,
        ...
        factory = _factory;
        pegToken = _pegToken;
        liquidityLink = _liquidityLink;
        pegSwapContract = _pegSwapContract;
    }

    function espeliarmus() external onlyOwner {
    ...
    function swapBUSDToPegTokenAndGetLink() external onlyOwner {
        address[] memory path = new address[](2);
        path[0] = address(busd);
