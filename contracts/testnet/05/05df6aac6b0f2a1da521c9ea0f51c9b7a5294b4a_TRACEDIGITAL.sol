...
TELEGRAM: https://t.me/TracePortal
WEBSITE: https://Tracedigital.io
*/
...
contract TRACEDIGITAL is Context, IERC20, Ownable {
    ...
    string private constant _name = "TRACE"; // 
    ...
    address public  _marketingWallet = 0x787A9e6e9D30f0939A716d2B0E2AaC2A421b297d;
    address public _treasurryWallet = 0xBeb77254049215cecE0d1D33b31a949FC03E3c1f;
    ...
    constructor () {
        ...
        _isExcludedFromFee[_treasurryWallet] = true;
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        uint256 marketingFee = amount * _marketingFee / 50; 
        uint256 liquidityFee = amount * _liquidityFee / 50;
        uint256 treasuryFee = amount  * _treasuryFee / 50;
        _tOwned[address(this)] += marketingFee + liquidityFee;
        emit Transfer (from, address(this),treasuryFee + marketingFee + liquidityFee);
        return (amount - treasuryFee - marketingFee - liquidityFee);
    }
