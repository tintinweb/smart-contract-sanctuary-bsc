...
contract MasRelic is Pausable, Ownable, ReentrancyGuard, IERC20 {
    ...
    function mintBridgedTokens(address relicHolder, uint256 amount) public onlyOwner returns(bool) {
    ...
    function burnBridgedTokensMultiSides(uint256 amount, address destinationAddress) public nonReentrant returns (bool) {
