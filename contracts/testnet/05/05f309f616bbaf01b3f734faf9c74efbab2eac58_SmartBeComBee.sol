...
contract SmartBeComBee {
    ...
    function updB3Refer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        users[referrerAddress].b3Matrix[level].referralsDirect = users[referrerAddress].b3Matrix[level].referralsDirect + 1;
        ...
        if (referrerAddress != owner) {
            ...
            users[referrerAddress].b3Matrix[level].reinvestCount = users[referrerAddress].b3Matrix[level].reinvestCount + 1;
            ...
            users[owner].b3Matrix[level].reinvestCount = users[owner].b3Matrix[level].reinvestCount + 1;
            delete users[referrerAddress].b3Matrix[level].toReferrals;
    ...
    function updB6Referrer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        users[referrerAddress].b6Matrix[level].referralsDirect = users[referrerAddress].b6Matrix[level].referralsDirect + 1;
    ...
    function updB6ReferrerSecondLevel(address userAddress, address referrerAddress, uint8 level) private {
        ...
        users[referrerAddress].b6Matrix[level].reinvestCount = users[referrerAddress].b6Matrix[level].reinvestCount + 1;
