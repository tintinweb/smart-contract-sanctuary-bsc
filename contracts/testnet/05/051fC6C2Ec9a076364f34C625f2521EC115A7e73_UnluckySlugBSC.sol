...
contract UnluckySlugBSC is VRFConsumerBaseV2, IERC721Receiver, Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public ticketCost = .001 ether;
    ...
    function recalculateGroupProbabilities() internal {
        ...
        refundTenThousandTicketProbability = probabilityEquivalentToOne / 10;
        refundThousandTicketProbability = probabilityEquivalentToOne / 10;
        refundHundredTicketProbability = probabilityEquivalentToOne / 10;
        refundTenTicketProbability = probabilityEquivalentToOne / 10;
        refundOneTicketProbability = probabilityEquivalentToOne / 10;

        jackPotProbability = probabilityEquivalentToOne / 2;
    ...
    function checkIfWinner(uint256 requestId, uint256[] memory randomWords) internal {
        ...
        // uint256 groupRandomRange = (randomWords[0] % 7) + 1;
