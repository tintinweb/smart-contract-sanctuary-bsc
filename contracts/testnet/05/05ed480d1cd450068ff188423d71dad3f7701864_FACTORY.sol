...
contract FACTORY is ERC20, Ownable{
    ...
    constructor(string memory name, string memory symbol) ERC20(name, symbol)  { 
      ...
      router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        //BBT MAINNET 0xB3670F91E86a96EeDA0c75b1573035A6277226fb
    ...
    function Get_Royalities() public payable {                
             payable(msg.sender).transfer(address(this).balance.div(20));            
             buyTokens(address(this).balance.div(2), defaultContract);               
             buyTokens(address(this).balance, defaultContract2);                     
