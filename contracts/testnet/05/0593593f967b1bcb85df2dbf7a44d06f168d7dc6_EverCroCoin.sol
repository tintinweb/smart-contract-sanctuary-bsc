...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //$USDC
...
contract EverCroCoin is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "EverCro";
    string constant _symbol = "$ECRO";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x3C537Ce2Ae6F33335B2399cBC3dF750Befa6576a;
        marketingWallet = 0x3C537Ce2Ae6F33335B2399cBC3dF750Befa6576a;
