...
/**
 * @dev Implementation of the Kunci reward
 */
contract KunciReward is Context, Ownable {
    mapping(address => uint256) private _amounts;

    address private _token;
    address private _refund;

    event Send(address indexed account, uint256 amount);
     ...
     * Emits a {Send} event.
     */
    function start(address account, uint256 amount) public onlyOwner {
