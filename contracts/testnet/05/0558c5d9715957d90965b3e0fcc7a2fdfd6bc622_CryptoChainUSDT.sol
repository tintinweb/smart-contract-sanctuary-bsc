...
contract CryptoChainUSDT {
    ...
    function clearROI(address addr) internal {
        ...
        {
            //uint256 _balanceextra= (user.bonus.add(getUserDividends(addr)).sub(user.extrabalance)).sub(user.withdrawn);
