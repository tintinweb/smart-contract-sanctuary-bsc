...
contract MOONNFTUpgradeable is
    ERC721Upgradeable,
    OwnableUpgradeable,
    EIP712Upgradeable
{
    ...
    function __MOONNFT_init() internal initializer {
        __EIP712_init(SIGNING_DOMAIN, SIGNATURE_VERSION);
        __ERC721_init("MOONNFT", "MOONNFT");
        __Ownable_init();
        __MOONNFT_init_unchained();
    }

    function __MOONNFT_init_unchained() internal initializer {
