...
contract SwapPancakeswap is Ownable {
     ...
     */
    function tradeFromExactTokenToToken(uint256 amountIn, address[] calldata path, uint256 deadlineOffset) external onlyOwner {
     ...
     */
    function tradeFromBNBToToken(address[] calldata path, uint256 deadlineOffset) external payable onlyOwner {
        require(path.length >= 2, "Length of path needs to be 2 at least");
    ...
    */
    function tradeFromTokenToBNB(uint256 amountIn, address[] calldata path, uint256 deadlineOffset) external onlyOwner {
        require(path.length >= 2, "Length of path needs to be 2 at least");
    ...
    Pair BUSD-WBNB Pancakeswap: 
        ...
        - token1: 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd (WBNB)
     */
    function tradeFromExactTokenToToken_pairMethod(uint256 amountIn, address pairAddress, bool inputIsToken0, address receiver, uint256 deadlineOffset) external onlyOwner ensureOffset(deadlineOffset){
    ...
    function tradeFromTokenToExactToken_pairMethod(uint256 amountOut, address pairAddress, bool inputIsToken0, address receiver, uint256 deadlineOffset) external onlyOwner ensureOffset(deadlineOffset){
    ...
    /**
        ...
        the address_being_approved on behalf of the owner.
        ...
        - For tradeFromExactTokenToToken_pairMethod:
