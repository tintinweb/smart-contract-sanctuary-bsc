...
abstract contract BaseUniswapAdapter is FlashLoanReceiverBase, IBaseUniswapAdapter, Ownable {
  ...
  function _calcUsdValue(
    ...
    uint256 ethUsdPrice = _getPrice(USD_ADDRESS); // if we use this SC - delete ethUsdPrice
...
contract UiPoolDataProvider is IUiPoolDataProvider {
  ...
  address public constant MOCK_USD_ADDRESS = 0x10F7Fc1F91Ba351f9C629c5947AD69bD03C05b96; // TODO: research it and use proper value
