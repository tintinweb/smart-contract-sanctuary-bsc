...
contract RPv1 is IERC20 {
    ...
    string constant private _name = "RPv1";
    string constant private _symbol = "RPv1";
    ...
    struct TaxWallets {
        ...
        address payable proposal;
    }

    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x15d802735363d915c2814468aB09910891eadd17),
        proposal: payable(0xd346723FaB8AD02B87b3A6FD0EdD7F5741639D92)
    });
...
//===============================================================================================================
    ...
    function setWallets(address payable marketing, address payable proposal) external onlyOwner {
        _taxWallets.marketing = payable(marketing);
        _taxWallets.proposal = payable(proposal);
    }

    function setRatios(uint16 reflection, uint16 liquidity, uint16 marketing, uint16 proposal) external onlyOwner {
        _ratios.reflection = reflection;
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.proposal = proposal;
        _ratios.totalSwap = liquidity + marketing + proposal;
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        bool success;
        uint256 proposalBalance = (amtBalance * ratios.proposal) / ratios.totalSwap;
        uint256 marketingBalance = amtBalance - proposalBalance;
        if (ratios.marketing > 0) {
            (success,) = _taxWallets.marketing.call{value: marketingBalance, gas: 35000}("");
        }
        if (ratios.proposal > 0) {
            (success,) = _taxWallets.proposal.call{value: proposalBalance, gas: 35000}("");
        }
    }
