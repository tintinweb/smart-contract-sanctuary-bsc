...
contract ERC_721_token {
    ...
    */
    ...
    @param tokenId - token id
    */
    function mint(uint256 tokenId) internal returns (bool) {
...
contract DEVSNFTs is ERC_721_token {
    ...
    constructor(RewardToken _RewardingTokenAddr, string memory _URI)
    ...
    function CurrentlyOwnedTokens()
        public
        view
        returns (uint256[4] memory ownedTokens)
    {
        require(balanceOf(msg.sender) > 0, "You dont Own Any NFTs yet");
        uint256 j = 0;
