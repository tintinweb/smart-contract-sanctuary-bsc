...
contract Adeiza is Context, IERC20, Ownable {
    ...
    string private constant _name = "Adeiza";
    string private constant _symbol = "ADEIZA";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x31Fb9f55b43bC48D1533e262e5F651183C98F507);
    address payable private _marketingAddress = payable(0xF1233D886B999Eb700Dc5C36c10CFF9a1700ea2C);
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyDev {
	    require(redisFeeOnBuy < 7, "Redis cannot be more than 6.");
