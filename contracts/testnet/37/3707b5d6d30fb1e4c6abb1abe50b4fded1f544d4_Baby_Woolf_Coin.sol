...
contract Baby_Woolf_Coin is BEP20, Ownable {
    ...
    function setFees(uint256 BNBRewards, uint256 liquidity, uint256 metaverse, uint256 vault, uint256 app, uint256 _burnFee, uint256 _largeTokenSellFee) public onlyOwner {
    ...
    function _transfer(
        ...
        uint256 maxSellTransactionAmount = getMaxSellTransactionAmount(from);
