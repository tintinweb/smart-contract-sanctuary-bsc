...
contract GallerNFTMinter is Ownable {
    ...
    DragonaireNFTManager public immutable manager;
    ...
    ItemFactoryManager
{
    ...
    mapping(uint256 => UnboxStage) public unboxStageOf;
    ...
    function _doUnbox(uint256 tokenId_) internal onlyExistedToken(tokenId_) onlyTokenOwner(tokenId_) onlyMysteryBox(tokenId_) {
        ...
        unboxStageOf[tokenId_] = UnboxStage.UNBOXING;
    ...
    function fulfillRandomness(uint256 tokenId_, uint256 randomness_) internal override(RandomConsumerBase) {
        ...
        unboxStageOf[tokenId_] = UnboxStage.UNBOXED;
