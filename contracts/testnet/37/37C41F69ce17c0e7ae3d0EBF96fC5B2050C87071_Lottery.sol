...
contract Lottery is RandomNumberConsumer, Ownable {
    ...
    */
    ...
    modifier onlyVRFCoordinator {
        require(_msgSender() == 0xa555fC018435bef5A13C6c6870a9d4C11DEC329C, "Access denied");
        _;
    }*/
    ...
    */
    function _register() public {
        ...
        require(state == LotteryState.Closed, "You can't register yet");
    ...
    */
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        uint256[] memory randomValues = expand(randomResult, 12);
        ...
        for (uint256 i = 0; i < 12; i++) {
            if (randomValues[i] < 100000000000) {
                ...
                (lvl, indx) = getRandomIndex(randomValues[i], i, lvl);
                transferFunds(lvl, indx, dividedAmount);
                //transferFunds(getRandomIndex(randomValues[i], i, lvl));
            }
        }
    ...
    function transferFunds(uint256 _lvl, uint256 _index, uint256 _amount) internal onlyWithPermission {
        ...
        //uint256 amount = getLotteryEGCLbalance()/12;

        EGCL.transferLotteryWinnings(_msgSender(), winner, _amount);
