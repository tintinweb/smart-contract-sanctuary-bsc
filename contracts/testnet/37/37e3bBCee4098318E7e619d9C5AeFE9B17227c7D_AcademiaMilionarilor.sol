...
contract AcademiaMilionarilor {
    address public owner = 0x9E4e16151f9fB31f9943eEAbF02C3d41Bf4aBe55;
    address public autoPayer = 0x9E4e16151f9fB31f9943eEAbF02C3d41Bf4aBe55;
    address public paymentSplitter = 0x9E4e16151f9fB31f9943eEAbF02C3d41Bf4aBe55;
    address public BUSD = 0xB31A60c49Bb19Fa6B74c140b332a26eF4594beFE;
    ...
    function subscribe(bytes32 userIdHash, address referral) public {
        require(
            ...
            "You don't have enough BUSD to subscribe"
        );
        require(
        ...
        if (referral != address(0) && referral != msg.sender) {
            BUSDContract.transfer(referral, planCost / 2);
        }
    ...
    function cancel() public {
        ...
        BUSDContract.transfer(msg.sender, planCost);
        subscriptions[msg.sender].isActive = false;
        totalSubscribers--;
    }
    ...
    function checkDue(address _subscriber) public view returns (bool) {
        Subscription storage subscription = subscriptions[_subscriber];
        if (block.timestamp < subscription.nextPayment) return true;
        return false;
    }
