...
contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xE03D3A8c1b6D527023D3C11a0939111521f663a7;
...
contract TestToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000000000 * 10**9; // 1 millions
    ...
    address payable public  _marketingWallet = payable(0xE03D3A8c1b6D527023D3C11a0939111521f663a7);
    ...
    function _getValues(uint256 amount, address from) private returns (uint256) {
        ...
        _tOwned[address(this)] += marketingFee + liquidityFee + taxFee;
        emit Transfer (from, address(this), marketingFee + liquidityFee + taxFee);
        return (amount - marketingFee - liquidityFee - taxFee);
    }
    ...
    function swapAndLiquify() private {
        ...
        uint256 liquidityTokens = balanceOf (address(this)) * _liquidityFee / (_marketingFee + _liquidityFee + _taxFee);
