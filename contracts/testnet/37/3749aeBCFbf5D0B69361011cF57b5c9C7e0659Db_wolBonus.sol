...
contract wolBonus is baseBonus{    
    ...
    // 用户待领取wol
    function getUserBonus(address _u) public view returns (uint userWolNumber) {
    ...
    function receiveReward() Register public {
        ...
        _safeOtherSend(airdrapAddress,abi.encodeWithSelector(airdrapAddress.addairdrop.selector,wolNumber.sub(wolNumberReal)));
    }
    //修改空投池合约地址
