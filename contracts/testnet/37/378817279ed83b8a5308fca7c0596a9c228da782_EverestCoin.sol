...
//================================================ BLACKLIST
    ...
    function contractSwap(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        if (ratios.mod > 0) {
            _taxWallets.mod.transfer(modBalance);
        }
        if (ratios.development > 0) {
            _taxWallets.development.transfer(developmentBalance);
        }
        if (ratios.gameAdvancement > 0) {
            _taxWallets.gameAdvancement.transfer(gameAdvancementBalance);
        }
        if (ratios.technicalSupport > 0) {
            _taxWallets.technicalSupport.transfer(technicalSupportBalance);
        }
    }
