...
contract PassBet is Ownable, ReentrancyGuard, IPassBet {
    ...
    constructor(IPassCurrencies _passCurrencies, IERC20 _xiv) {
        ...
        addRewards(300, 4 minutes, 5000);
        addRewards(300, 2 minutes, 10000);
    }
    ...
    function betOnCurrency(
        ...
        require(
            xiv.balanceOf(msg.sender) >= _betAmount,
            "User doesn't have enough balance to bet."
        );
        require(
            xiv.allowance(msg.sender, address(this)) >= _betAmount,
            "Allowance issue."
        );
        ...
        require(currency.isActive, "Currency is not active or doesn't exist.");
        ...
        // User bet will start from the next rounf
        uint256 _startRound = passCurrencies.roundId() + 1;
        uint256 _addedRounds = _timePeriod / passCurrencies.slotTime();
        ...
        PassLibrary.UserBet memory newBet = PassLibrary.UserBet({
            ...
            finalRound: _startRound + _addedRounds,
    ...
    function stakeTokens(uint256 _amount) public {
        ...
        require(
            ...
            "User doesn't have enough balance to stake."
        );
        require(
