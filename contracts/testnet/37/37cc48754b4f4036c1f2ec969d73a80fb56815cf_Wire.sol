...
contract Wire is ERC721, Ownable, Pausable {
    using Strings for uint256;
    ...
    constructor(IERC20 _token) ERC721("Wire", "Wire") 
    { 
        token = _token;
    ...
    // Public Mint
    function mint(uint256 _count ,uint256 amount) public  {
        ...
        require(amount >=(_count * MINT_PRICE), "INVALID_ETH_SENT");
