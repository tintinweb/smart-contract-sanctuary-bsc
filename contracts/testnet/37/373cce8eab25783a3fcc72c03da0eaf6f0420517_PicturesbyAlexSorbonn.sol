...
contract PicturesbyAlexSorbonn is ERC721, IERC2981, ReentrancyGuard, Ownable {
  using Counters for Counters.Counter;

  constructor(string memory customBaseURI_)
    ERC721("Pictures by Alex Sorbonn", "PbAS")
  {
  ...
  uint256 public constant MINT_LIMIT_PER_WALLET = 17;
