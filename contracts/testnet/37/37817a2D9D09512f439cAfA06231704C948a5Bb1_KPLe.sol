...
contract KPLe is IERC20, Ownable {
    ...
    address private sat = 0x177849b19d0B1aFeA500b1dF4b0364267570aF32;
    address private projectAddress = 0x0E06501daE5CDBdDb3e080C1824b1D20be0478Ce;
   

    uint256 private _tFeeTotal;

    string private _name = "KPL2";
    string private _symbol = "KPL2";
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _takeburnFee(
        ...
        if(_tFeeTotal >= 999 * 10**8 * 10**9)_burnFee = 0;
    ...
    function swapEthForToken(uint256 ethAmount,address receiver) private{
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        IERC20 TestE = IERC20(0x177849b19d0B1aFeA500b1dF4b0364267570aF32);//sat代币地址--
    ...
    function swapThisTokenForToken(uint256 thisTokenAmount,address receiver) private{
        // generate the uniswap pair path of token -> weth
        address[] memory path = new address[](2);
        IERC20 SAT = IERC20(0x177849b19d0B1aFeA500b1dF4b0364267570aF32);//sat代币地址--
