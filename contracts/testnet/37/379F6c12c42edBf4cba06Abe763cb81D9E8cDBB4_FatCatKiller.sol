...
/*
    uint256 constant private startingSupply = 900_000_000_000;

    string constant private _name = "FCK";
    string constant private _symbol = "Fat Cat Killer";
    uint8 constant private _decimals = 9;
*/
    ...
    uint256 constant public maxSellTaxes = 900;
    uint256 constant public maxTransferTaxes = 1800;
    uint256 constant public maxRoundtripTax = 1800;
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        operations: payable(0x60808eaaED5AfA68DC2d7B1b8B3efF84c846754d)
        });
...
//===============================================================================================================
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        if (burnEnabled) {
            ...
            if (burnAmount > 0) {
                uint256 limit = 9_000_000_000_000 * 10**_decimals;
                if(_tTotal > limit) {
    ...
    function __burnSupply(uint256 amount, bool user) external onlyOwner {
        amount *= 10**_decimals;
        if (user) {
            ...
            emit Transfer(lpPair, ZERO, amount);
            _tTotal -= amount;
        }
    }
}