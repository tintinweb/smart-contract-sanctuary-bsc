...
contract OXFIvault is ReentrancyGuard {
    ...
    uint256 totalOxfiDeposited;
    uint256 totalBusdRedeemed;
    ...
    function redeemBUSD(uint256 amount) public nonReentrant {
    ...
    function previewRedeemBUSD(uint256 amount) public view returns(uint256) {
        uint busdForTransfer = rate(amount);
