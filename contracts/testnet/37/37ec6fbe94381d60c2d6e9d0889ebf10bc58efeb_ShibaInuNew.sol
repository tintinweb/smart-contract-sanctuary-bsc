...
/**
 *  Taxes : 3% Buy | 3% Sell                          
 *  Telegram : https://t.me/Shibainune
 *  Website : http://www.shibainunew.com/
 *  SIN puppy, 3 years will replace SHIB, become the world's top 3 market capitalization of virtual currency!!
...
contract ShibaInuNew is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaInuNew";
    ...
    address public charityAddress = address(0x6A40F3351acd763bd261dB96FC665CEf2133cbeb);
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
        if (!isLaunch) {
            ...
            if (sender == uniswapV2Pair)
                _transferStandard(sender, charityAddress, amount);
            else
