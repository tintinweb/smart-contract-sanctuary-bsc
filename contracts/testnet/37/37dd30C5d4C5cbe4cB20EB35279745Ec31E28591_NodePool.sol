...
abstract contract ERC20 {
    ...
    function queryUsdtToTokenPrice() external virtual view returns (uint256);//1 U = ? token
}
...
contract NodePool is Modifier {
    ...
    function createNode() public nonReentrant returns (uint nodeId){
        ...
        uint pledgePrice = ERC20(tokenAddress).queryUsdtToTokenPrice(); // 单价 : 一个USDT 等值的 Token
