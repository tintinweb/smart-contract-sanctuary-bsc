...
contract Dinodoge is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Dinodoge";
    string private _symbol = "DIDO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa5480E56E56AEb98d516C5D544bC77052Cd4B92D); // Marketing Address
    address payable public DevelopmentalWalletAddress = payable(0x8Eb90812332f6fe8D5341064c82D960c26CeAcfB); // Developmental Address
