...
contract Pacmate is Context, IERC20, Ownable {
    ...
    uint256 private _previousGameRewardsFee = gameRewardsFee;

    uint256 public totalFees = taxFee + stakingFee + marketingFee + devTeamFee + gameRewardsFee;
    ...
    address public gameRewardsWallet = 0x37F07949d9094C31696484497158aD63C1414ec6;
    address public stakingWallet = 0x09E626Eb98bCF39d17163C01B8F3c46135218491;
    ...
    function removeAllFee() private {
        if(taxFee == 0 && stakingFee == 0 && marketingFee == 0 && devTeamFee == 0) return;
        
        _previousTaxFee = taxFee;
        _previousStakingFee = stakingFee;
        _previousMarketingFee = marketingFee;
        _previousDevTeamFee = devTeamFee;
        _previousGameRewardsFee = gameRewardsFee;
        taxFee = 0;
        marketingFee = 0;
        stakingFee = 0;
        devTeamFee = 0;
    ...
    function restoreAllFee() private {
        ...
        stakingFee = _previousStakingFee;
        devTeamFee = _previousDevTeamFee;
        gameRewardsFee = _previousGameRewardsFee;
    }
    ...
    function _transfer(
        ...
        if (
            ...
            uint256 taxForSwap = devTeamFee + marketingFee + gameRewardsFee;
            if(taxForSwap > 0) {
                ...
                if(gameRewardsFee > 0) {
                    uint256 gameBNB = newBalance * gameRewardsFee / taxForSwap;
    ...
    function setTaxFeePercent(uint256 _taxFee) external onlyOwner() {
        taxFee = _taxFee;
        totalFees = taxFee + marketingFee + stakingFee + devTeamFee + gameRewardsFee;
        require(totalFees <= 20, "Total fees must be less than 20%");
    }
   ...
   function setMarketingFee(uint256 _marketingFee) external onlyOwner() {
    ...
    function setDevTeamFee(uint256 _devTeamFee) external onlyOwner() {
        devTeamFee = _devTeamFee;
        totalFees = taxFee + marketingFee + stakingFee + devTeamFee + gameRewardsFee;
        require(totalFees <= 20, "Total fees must be less than 20%");
    }

    function setGameRewardsFee(uint256 _gameRewardsFee) external onlyOwner() {
