...
contract Game is BEP20Token {
    ...
    mapping (address => uint) private second_game;
    ...
    event EmperorLog(address emperator, uint256 money);
    event ReferalsSum(address referal, address own, uint256 revards);
    ...
    function First_Game() public Set_InGame(){
       ...
       if (my_inviter[msg.sender] != address(0)){
           ...
           emit ReferalsSum(msg.sender,my_inviter[msg.sender], entry_price[my_table[msg.sender]] - (entry_price[my_table[msg.sender]] - referal_price[my_table[msg.sender]]));
       }
       ...
       if (tables[my_table[msg.sender]][tables[my_table[msg.sender]].length-1] != address(0)){
           ...
           emit EmperorLog(tables[my_table[msg.sender]][tables[my_table[msg.sender]].length-1],entry_price[my_table[msg.sender]] - referal_price[my_table[msg.sender]]);
       }
       ...
       if(tables[my_table[msg.sender]][tables[my_table[msg.sender]].length-1] != address(0) 
          && tables[my_table[msg.sender]][tables[my_table[msg.sender]].length-1] != address(this))
        {
            ...
            my_table[tables[my_table[msg.sender]][14]]++;
                     ...
                     second_game[tables[my_table[msg.sender]][14]]++;
            }
    ...
    require(second_game[msg.sender] == 1, "Second game lock");
