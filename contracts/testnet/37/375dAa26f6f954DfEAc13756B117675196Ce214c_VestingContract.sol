...
contract VestingContract is Ownable, ReentrancyGuard {
	...
	uint256 public constant MAX_DAYS = 14;
    ...
    */
	function claim() external nonReentrant {
		...
		require(_totalValue != 0, "Vesting complete. Please check your policy again");
    ...
    */
	function collect() external onlyOwner {
		...
		require(
			block.timestamp > startAt + _until * 24 hours, "Should call after 7 days"
		);
