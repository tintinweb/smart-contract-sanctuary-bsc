...
// File: contracts/PackageSale.sol
...
contract PackageSale {
    ...
    IERC20 public constant BUSD = IERC20(0x8e1C1359c00212533033a8A1FCdb6bc395272D58); // mainnet BUSD contract on BSC
    IERC20 public constant XQZS = IERC20(0x8e1C1359c00212533033a8A1FCdb6bc395272D58);
    ...
    function purchaseMonthlyPackage(Package packageType, address _ref) external {
        ...
        if(_ref!=address(0))
        {
            uint amount10=(10000000000000000000 * purchaseAmount)/100000000000000000000;
            uint amount90=(90000000000000000000 * purchaseAmount)/100000000000000000000;
    ...
    function purchaseQuarterlyPackage(Package packageType, address _ref) external {
        ...
        uint256 payoutPeriod = 4 minutes;  
        uint256 purchaseAmount = packageOne ? BUSD_PRICE_PACKAGE_ONE : BUSD_PRICE_PACKAGE_TWO;
