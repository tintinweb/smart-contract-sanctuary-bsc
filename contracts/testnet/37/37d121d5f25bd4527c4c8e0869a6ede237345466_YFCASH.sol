...
contract YFCASH is Context, IERC20, Ownable {
    ...
    string private _symbol = "YFCASH";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0x07c3720a02560f6EF42972Bf38C7868851aAF83f);
    address payable public teamWalletAddress = payable(0x07c3720a02560f6EF42972Bf38C7868851aAF83f);
