...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IPancakeV3SwapCallback, PeripheryImmutableState {
    ...
    function getPairAmountOut(
        ...
        (uint256 reserveIn, uint256 reserveOut) = SmartRouterHelper.getReserves(factoryV2, tokenIn, tokenOut);
        return SmartRouterHelper.getAmountOut(amountIn, reserveIn, reserveOut);
    }
    ...
    function pancakeV3SwapCallback(
        ...
        SmartRouterHelper.verifyCallback(factory, tokenIn, tokenOut, fee);
        ...
        IPancakeV3Pool pool = SmartRouterHelper.getPool(factory, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IPancakeV3Pool pool = SmartRouterHelper.getPool(factory, params.tokenIn, params.tokenOut, params.fee);
