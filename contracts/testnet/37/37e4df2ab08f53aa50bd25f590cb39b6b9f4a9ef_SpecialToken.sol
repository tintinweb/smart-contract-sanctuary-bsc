...
contract SpecialToken is AccessControlEnumerableUpgradeable, ERC721EnumerableUpgradeable {
    ...
    function mint(
        ...
        require(!_exists(tokenId), "Error: Duplicate tokenId");
        require(bytes(tokenUri).length > 0, "Error: tokenUri is empty");
