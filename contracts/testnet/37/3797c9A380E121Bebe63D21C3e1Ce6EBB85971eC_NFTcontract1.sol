...
contract NFTcontract1 is ERC721, ERC721URIStorage, Ownable {
    ...
    mapping(address => uint256) public _isMinter;
    ...
    function mintNFT(
        ...
        require(msg.value == gasFee,"Should have gas fee in BNB");
        ...
        sold += _quantitiy;
        _isMinter[msg.sender] += _quantitiy;
    }

    function getProgress() public view returns (uint256 _percent) {
        uint256 remaining = totalSupply.sub(quantity);
