 ...
 */
abstract contract ContextTEST is Initializable {
...
contract ERC20TEST is
    ...
    IERC20TEST
{
    using SafeMathTEST for uint256;
 ...
 */
abstract contract PausableTEST is Initializable, ContextTEST {
    /**
 ...
 */
abstract contract ERC20PausableTEST is
    Initializable,
    ERC20TEST,
    PausableTEST
{
 ...
 * the owner.
 */
abstract contract OwnableTEST is Initializable, ContextTEST {
    ...
    ERC20PausableTEST
{
    ...
    address payable public teamAddress = payable(0x5AA1dCA1EF60afBc2DDb215de890aD4b50615b2C);
    ...
    function setBUYFeePercent(uint256 updatedTeamFee, uint256 updatedLiquidityFee) external onlyOwner {
        _BUYteamFee = updatedTeamFee;
        _BUYliquidityFee = updatedLiquidityFee;
        
    }

    
   function setSELLFeePercent(uint256 updatedTeamFee, uint256 updatedLiquidityFee) external onlyOwner {
        _SELLteamFee = updatedTeamFee;
        _SELLliquidityFee = updatedLiquidityFee;
    ...
    function _approve(address towner, address spender, uint amount) internal override {
