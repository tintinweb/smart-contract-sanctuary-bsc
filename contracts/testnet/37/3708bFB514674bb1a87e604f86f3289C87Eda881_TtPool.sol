...
contract TtPool  is Ownable {
    ...
    function buyNft(uint256 id, uint256 num, uint256 amount,address currency)  external {
        require(amount > 0&&num>0, "NFT: amout and num error"); 
    ...
    address public feeAddress=0x23C57B3e659C650eE1eF2e901723c04a113667e9;
    struct Config {
        uint256 fee;
        uint256 minAmount;
        uint256 maxAmount;
    ...
    function claim(address currency,uint256 _amount) public { 
        ...
        uint256 fee=SafeMath.div(SafeMath.mul(_amount,config.fee),1000);
