...
contract LiveArtXGoldenPass is ERC721Upgradeable, OwnableUpgradeable {
    ...
    function initialize(string memory _baseURI, address _admin) public initializer {
        __ERC721_init("LiveArtX Golden Pass", "Pass");
        baseURI = _baseURI;
        admin = _admin;
    }
    ...
    function mintTo(address recipient) public onlyAdmin {
    ...
    function batchMintTo(address[] calldata recipients) public onlyAdmin {
