...
// File: contracts/Baby Elephant.sol
...
contract Babyelephant is Context, IERC20, Ownable {
    ...
    address public SWAP = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // change for busd in mainnet

    address pinkAntiBot_ = 0xbb06F5C7689eA93d9DeACCf4aF8546C4Fe0Bf1E5; // change for pinkantibot mainnet

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 14 * 10**12 * 10**3;
    ...
    uint256 public _utilitiesFee = 3;
    ...
    constructor() {
        ...
        IUniswapV2Router02 uniswapV2Router = IUniswapV2Router02(
            0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3 // change for main net
        );
    ...
    function updateFees(
        ...
        _utilitiesFee = utilitiesFee;
        _projectFee = projectFee;
        _burnFee = burnFee;

        _totalFeesToContract = utilitiesFee.add(projectFee).add(burnFee);
        _taxFee = rewardFee;
    }
    ...
    function takeTokenFees(
        ...
        if (_burnFee > 0) {
            ...
            takeTransactionFee(address(burnAddress), tokensToBurn, currentRate);
    ...
    function swapAndSendBusd(uint256 contractTokenBalance) private lockTheSwap {
        uint256 totalSwapFees = _totalFeesToContract.sub(_burnFee);
        ...
        uint256 busdForUtilities = swappedBusd.mul(_utilitiesFee).div(
            totalSwapFees
        );
