...
contract ZDT is AbsToken {
    constructor() AbsToken(
        address(0xB6BA90af76D139AB3170c7df0139636dB6120F7e),//RouterAddress
        address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684),//FISTAddress
        "ZDT",//Name
        "ZDT",//Symbol
        6,//Decimals
        3333,//Supply
        address(0xA9CC0B923CB161D0e6577CB6Ddb31dC4caeD2b13),//FundAddress
        address(0xb043dC3400c6E1D29d7B4C08Aa163EaAfDDEF777)//ReceiveAddress
    ){
