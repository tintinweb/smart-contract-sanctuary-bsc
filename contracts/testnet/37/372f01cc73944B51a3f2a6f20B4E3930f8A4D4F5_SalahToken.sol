...
contract SalahToken is ERC20, Ownable {
    ...
    function setPercentBuyDev(uint256 tax) external onlyOwner {
        require(tax <= 500,"Salah: Maximum Tax is 5%");
        buyTaxes["dev"] = tax;
    }

    function setPercentBuyMarketing(uint256 tax) external onlyOwner {
        require(tax <= 500,"Salah: Maximum Tax is 5%");
        buyTaxes["marketing"] = tax;
    }

    function setPercentBuyLiquidity(uint256 tax) external onlyOwner {
        require(tax <= 500,"Salah: Maximum Tax is 5%");
        buyTaxes["liquidity"] = tax;
    }

    function setPercentBuyCharity(uint256 tax) external onlyOwner {
        require(tax <= 500,"Salah: Maximum Tax is 5%");
        buyTaxes["charity"] = tax;
    }

    function setPercentSellDev(uint256 tax) external onlyOwner {
        require(tax <= 500,"Salah: Maximum Tax is 5%");
        sellTaxes["dev"] = tax;
    }

    function setPercentSellMarketing(uint256 tax) external onlyOwner {
        require(tax <= 500,"Salah: Maximum Tax is 5%");
        sellTaxes["marketing"] = tax;
    }

    function setPercentSellLiquidity(uint256 tax) external onlyOwner {
        require(tax <= 500,"Salah: Maximum Tax is 5%");
        sellTaxes["liquidity"] = tax;
    }

    function setPercentSellCharity(uint256 tax) external onlyOwner {
        require(tax <= 500,"Salah: Maximum Tax is 5%");
        sellTaxes["charity"] = tax;
    }
