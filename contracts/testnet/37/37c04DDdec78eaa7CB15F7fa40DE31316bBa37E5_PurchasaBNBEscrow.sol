...
contract PurchasaBNBEscrow is Ownable {
    ...
    function lockBNBToken(string memory orderId,Orders[] memory orders, address reciever,string memory currency,string memory userId,uint256 damount,uint256 paymentfee) payable public {
        ...
        uint totalc = ((((orders[i].amount * orders[i].quantity) / 100) * (categoryList[orders[i].categoryName].bnbcommission + categoryList[orders[i].categoryName].commission)));
    ...
    function lockBEPToken(uint256 paymentfee,uint256 damount,string memory orderId,Orders[] memory orders, address tokenAddress,uint256 amount, address reciever,string memory currency,string memory userId) public {
