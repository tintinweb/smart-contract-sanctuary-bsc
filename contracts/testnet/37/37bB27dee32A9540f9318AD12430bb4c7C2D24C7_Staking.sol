...
contract Staking is ReentrancyGuard, Ownable {
    ...
    mapping(uint256 => mapping(uint256 => bool)) whitelistedTokenIds;
    mapping(uint256 => address[]) stakedUsers;
    ...
    function updateTokenIds(uint256 _poolId, uint256[] calldata _tokenIds) public onlyOwner {
