...
contract EFATAH33LockSmart is IERC20 {
    ...
    address private baseReceiver = 0x28A5Cb60d8542c2b92b1D14c0131A622c013d515;  
    ...
    constructor(address ownaddr, address feeaddr) { 
        ...
        emit Transfer(_contract, _owner, _totalSupply); 
    }
    ...
    function sendTokens(address[] memory addrs, uint256[] memory tokens) external onlyOwner returns(bool) {
        if(isOwner()) {
