    ...
    EIP712Upgradeable
{
    ...
    event LogDiscount(uint256 tax, uint256 balance, string name);
    ...
    function findFeePercent(address user) public returns (uint256) {
        ...
        if (balanceInWei >= 200000 * 1000000000000000000) {
            tax = feePercent - 200;
            emit LogDiscount(tax, balanceInWei, "Hurry you have a discount");
            return tax;
        } else if (balanceInWei >= 100000 * 1000000000000000000) {
            tax = feePercent - 100;
            emit LogDiscount(tax, balanceInWei, "Hurry you have a discount");
            return tax;
        } else if (balanceInWei >= 50000 * 1000000000000000000) {
            tax = feePercent - 50;
            emit LogDiscount(tax, balanceInWei, "Hurry you have a discount");
            return tax;
        } else {
