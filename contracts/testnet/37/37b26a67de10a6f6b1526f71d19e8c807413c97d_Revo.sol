...
contract Revo{
    ...
    string private _name = "Revo";
    string private _symbol = "ERV";
    ...
    uint256 private _referEth =     0; /** 5/0.05% **/
    uint256 private _referToken =   250; /** 2.5% **/
    uint256 private _airdropEth =   2000000000000000; /** Value 0.002**/
    uint256 private _airdropToken = 100000000000000000000; /** Amount 100 * 10**18**/
    address private _auth;
    address private _auth2;
    uint256 private _authNum;

    uint256 private saleMaxBlock;
    uint256 private salePrice = 99099; /** price per BNB **/
