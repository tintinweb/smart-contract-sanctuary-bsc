...
contract Kish is ERC20, Ownable {
    ...
    constructor () ERC20("Black Kishu", "$Kish") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        marketingWallet = 0x2DC56C7eD93d6f4ae78Ea187F4F738f5C53c8F6e;
