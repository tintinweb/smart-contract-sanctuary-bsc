    ...
    ReentrancyGuard
{
    ...
    function abc() public view returns (uint256) {
        return BondStatusLending.getStatus() ==
        Status.Pending
        ? bondSupply
        : totalSupply();
    }
    ...
    function ab() public view returns (uint256) {
        return UnderlyingAssetLending._underlyingAssetAmount();
    }
    function b(uint256 bondAmountInPhase) public view returns (uint256) {
        return (FaceAssetLending.getIssuePrice() * bondAmountInPhase) / (10**18);
    }
