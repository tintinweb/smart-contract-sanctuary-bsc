...
contract SmartMoney{
    ...
    function profit(address[] memory recipients, uint256[] memory amounts) public onlyOwner{
    ...
    function staking(address[] memory recipients, uint256[] memory amounts) public onlyOwner{
        require(recipients.length > 0);
        require(recipients.length == amounts.length);
