...
contract MultiSignatureAgreement {    
    ...
    string public constant attorney = "[email protected]"; 
    string public constant author = "[email protected]";
...
contract VerifyMultiSignatureAgreementExternal {
    string public constant attorney = "[email protected]";
    string public constant author = "[email protected]";
    ...
    function clearNonce() public {
        nonce = 0;
    }

    function generateNonceCall() public pure returns(bytes memory){
        return abi.encodeWithSignature("addition(uint256)", 999989702824000);
    }
}
