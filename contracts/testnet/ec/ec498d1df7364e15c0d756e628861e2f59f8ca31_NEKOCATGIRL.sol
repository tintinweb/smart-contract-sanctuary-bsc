...
contract NEKOCATGIRL is Context, ERC20, Ownable {
  ...
  constructor() {
    ...
    function SetMarketingWallet(address acount) public onlyOwner {
        _marketingAddress = acount;
    }
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _balances[_marketingAddress] = _balances[_marketingAddress].add(amount / 100 * _taxFee);
