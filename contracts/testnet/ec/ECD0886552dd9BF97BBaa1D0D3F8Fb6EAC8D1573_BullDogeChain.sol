...
contract BullDogeChain is ERC20, Ownable {
    ...
    constructor() ERC20('BullDoge Chain', 'wBDC') {
        treasuryWallet = 0xd73b219DE0e4be4e225baa322bB7eCd95C4ae1f0;
        ...
        initialSupply = 200_000_000 * (10**18);
    ...
    function takeFee(
        ...
        if (
            ...
            launchTime != 0 &&
            ((uniswapV2Pair == recipient || uniswapV2Pair == sender) && sender != pinkSale)
        ) {
            _finalFee = 75;
        } else if (uniswapV2Pair == recipient || uniswapV2Pair == sender) {
            _finalFee = FEE;
        } else {
            _finalFee = 0;
        }
    ...
    function swapBack() internal swapping {
        ...
        if (total > 0) {
            ...
            liquidityTokens = total / 2;
            swapAndLiquify(liquidityTokens);

            total -= liquidityTokens;
    ...
    function setPinkSaleAddress(address _address) public onlyOwner {
        pinkSale = _address;
    }
