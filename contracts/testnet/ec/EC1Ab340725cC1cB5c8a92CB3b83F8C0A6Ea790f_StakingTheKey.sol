...
contract StakingTheKey{
    ...
    function transferTokenToStaking(uint256 amount, uint8 period, uint256 LO) public {
    ...
    function transferFrozenToStaking(uint8 period, uint8 token, uint256 LO) public {
        require(StakingPeriods[period][0] != 0, "There is no such staking period");
