...
contract TestPOOM is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PolyTest", "POOM") {
        
        address newOwner = address(0xa7ac9658eD6eDc1EC510e95E7cec785633D9F6A8);
    	...
    	marketingWallet = address(0xA8b385780FecBc970fC01725CA429aE70B5cB0Ee); // set as marketing wallet
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xa7ac9658eD6eDc1EC510e95E7cec785633D9F6A8),
            block.timestamp
        );
