...
contract Crystals is ERC20Burnable, Operator {
    ...
    uint256[] public taxTiersTwaps = [
        0, 1e17, 2e17, 3e17, 4e17, 5e17, 6e17, 7e17, 8e17, 9e17, 9.5e17
    ];
    ...
    // Pair addresses include or exclude from Tax
    ...
    constructor(
        ...
        busdPair = IUniswapV2Factory(uniswapV2Router.factory()).createPair(address(this), address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7));
    ...
    function excludeAddress(address _address)
        ...
        returns (bool)
    {
        require(!excludedAddresses[_address], "Address already excluded from tax");
    ...
    function includeAddress(address _address)
        ...
        returns (bool)
    {
        require(excludedAddresses[_address], "Address already included from tax");
    ...
    function _transfer(
        ...
        if (!excludedAddresses[_sender] && (pairs[_sender] || pairs[_recipient])) {
            uint256 taxAmount;
            uint256 amountAfterTax;

            if (pairs[_sender]) {
                taxAmount = _amount.mul(taxRate.add(flatBuyFee)).div(10000);
