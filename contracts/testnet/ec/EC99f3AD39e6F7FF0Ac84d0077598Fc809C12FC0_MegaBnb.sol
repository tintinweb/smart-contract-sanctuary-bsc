...
contract MegaBnb is Context, Ownable{
   ...
   // mapping (address => bool) public investedFifty;
    ...
    mapping (address => uint256) public compoundCount;
...
mapping (address => uint256) public addtoextra;
//Withdraw
