...
contract CoffeeToken is Context, IBEP20 {
   ...
   function zeroWalletBalance() public view returns (uint256) {
        return tokenFromReflection(_rOwned[address(0)]);
    }
    ...
    function burn(uint256 tAmount) public returns (bool) {
        ...
        uint256 accountBalance = tokenFromReflection(_rOwned[_msgSender()]);
        require(accountBalance >= tAmount, "BEP20: burn amount exceeds balance");
    ...
    function _transferBothExcluded(address sender, address recipient, uint256 tAmount) private {
        ...
        _tOwned[sender] = _tOwned[sender].sub(tBurnFee);
        ...
        _reflectBurnFee(rBurnFee, tBurnFee);
    ...
    function _reflectBurnFee(uint256 rBurnFee, uint256 tBurnFee) private {
