...
contract MySanta is Ownable, ReentrancyGuard {
    ...
    // Map a charity id to donor structs
    mapping(uint256 => Donor[]) public charityDonors;
    ...
    function transfer(
        ...
        require(
            charity.fundReceiver != address(0),
            "My Santa: no available charity"
        );
        ...
        charityDonors[charityId].push(donor[msg.sender]);
