...
Telegram - https://t.me/busdxtoken

Twitter - https://twitter.com/busdxtoken
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 CAKE = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
...
contract StakeMars is IBEP20, Auth {
    using SafeMath for uint256;

    uint256 public constant MASK = type(uint128).max;
    address constant CAKE = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
    address public WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address constant DEAD = 0x000000000000000000000000000000000000dEaD;
    address constant ZERO = 0x0000000000000000000000000000000000000000;
    address constant DEAD_NON_CHECKSUM =
        0x000000000000000000000000000000000000dEaD;
    address constant _dexRouter = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;

    string constant _name = "StakeMars";
    string constant _symbol = "StakeMars";
    ...
    uint256 internal reflectionFee = 4;
    ...
    address public marketingFeeReceiver =
        0x87Ba8971E6117C4864352b9af1ebdEC27F1C1899;
    ...
    function launch() public authorized {
        require(launchedAt == 0, "Already launched for BUSDX");
        launchedAt = block.timestamp + 15 minutes;
    }
