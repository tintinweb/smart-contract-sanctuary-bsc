...
pragma solidity ^0.8.9;
abstract contract LandService is LandStorage, ILandCore{
    ...
    function setLandTypeInfos() internal {
        LandTypeInfo[] memory _landTypeInfos = new LandTypeInfo[](4);
        _landTypeInfos[0] = LandTypeInfo(1, 1000000000000, 100, 0);
        _landTypeInfos[1] = LandTypeInfo(2, 4500000000000, 100, 0);
        _landTypeInfos[2] = LandTypeInfo(3, 30000000000000, 100, 0);
        _landTypeInfos[3] = LandTypeInfo(4, 10000000000, 100, 0);
    ...
    function updateLandTypeInfos(LandTypeInfo[] memory _landTypeInfos) public onlyOwner {
        uint allSetNum = 0;
        for(uint i = 0; i < _landTypeInfos.length; i++) {
            LandTypeInfo memory _landTypeInfo = _landTypeInfos[i];
    ...
    function setLandNum(uint _landNum) public onlyOwner {
        landNum = _landNum;
    }
