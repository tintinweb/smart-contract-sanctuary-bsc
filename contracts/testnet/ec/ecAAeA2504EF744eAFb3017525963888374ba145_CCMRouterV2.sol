...
contract CCMRouterV2 is TaxableRouter, UUPSUpgradeable {
    ...
    function updatePcsRouter(address newPcsRouter) external onlyOwner {
        ...
        returns (uint[] memory amounts)
    {
        ...
        uint ethToSend = takeInTax(tokenToSwap, TaxableRouter.ETH_ADDRESS, msg.value);
        ...
        returns (uint[] memory amounts)
    {
        ...
        uint ethToTransfer = takeOutTax(tokenToSwap, TaxableRouter.ETH_ADDRESS, amounts[amounts.length - 1]);
