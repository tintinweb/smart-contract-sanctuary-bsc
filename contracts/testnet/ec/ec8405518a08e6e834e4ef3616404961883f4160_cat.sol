...
contract cat is ERC20, Ownable, BaseToken, WhiteList {
    ...
    constructor(
    ...
    ) payable ERC20("cat", "cat") {
        _startTime = startTime;
        rewardToken = 0x337610d27c682E347C9cD60BD4b3b107C9d34dDd;
        _marketingWalletAddress = 0xeB198918ABDF4fE835Cf8450780ff1699A561DC9;
        require(
        ...
        //流动性钱包=msg.sender.也就是部署这个合约的钱包
        liquidityWallet = 0xb7AD1513998f2e88AFF9D79B87c832D1083C82fc;          
    ...
    function updateStartTime(uint256 _starttime) public onlyOwner {
        _startTime = _starttime;          //设置新的流动池钱包         
    }
    ...
    {
        if (
            !isWhiteListed(receiver)    //检查是不是白名单  isWhiteListed(receiver) 是为 true
        ) {
            return false;
        }
