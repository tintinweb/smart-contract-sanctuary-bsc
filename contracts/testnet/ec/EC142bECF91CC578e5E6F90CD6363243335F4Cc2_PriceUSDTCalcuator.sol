...
contract PriceUSDTCalcuator is IPriceUSDTCalcuator, Ownable {
    ...
    ////////////////////////////////////////////////////////////
    mapping(address => uint256) public priceUSDT;
    function setPriceUSDT(address token, uint256 price) public onlyOwner {
        priceUSDT[token] = price;
    }
