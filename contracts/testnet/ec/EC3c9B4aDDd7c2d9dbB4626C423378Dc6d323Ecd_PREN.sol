...
abstract contract ERC20 is IERC20 {
  ...
  function transfer(address recipient, uint256 amount) public virtual override returns (bool) {
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        _balances[account] = _balances[account].sub(amount, "ERC20: burn amount PEN exceeds balance");
...
contract PREN is ERC20Permit, VaultOwned {
    using SafeMath for uint256;

    constructor() ERC20("PEN", "PREN Token", 18) {}

    /**
     * @dev sets initials supply and the owner
     */
    function initialize() public {
        _totalSupply = 10_000_000 * (10 ** uint256(_decimals));
    ...
    function burnFrom(address account_, uint256 amount_) public virtual onlyVault {
