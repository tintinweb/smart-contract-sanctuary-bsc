...
contract TestCode is Context, Ownable {
	...
	uint256 private MAX_REWARDS_ACCUMULATION_CUTOFF = 86400;  // 24*60*60. Seconds in 1 day. Rewards will accumulate till max 24 hours until after the user will have to either compound or sell

    uint256 private EGGS_TO_HATCH_1MINERS = 1080000; // 86400/1080000 = 8% APY
