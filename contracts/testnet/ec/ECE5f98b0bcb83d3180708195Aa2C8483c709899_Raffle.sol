...
contract Raffle is Context, AccessControlEnumerable, ERC721Enumerable {
    ...
    function loadPrizes(uint256[] calldata tokenIds) public {
        ...
        for (uint256 i = 0; i < length; i++) {
            ...
            prizeNftContract.safeTransferFrom(msg.sender, address(this), tokenIds[i]);
        }
    ...
    function revealResult(bytes32 reveal, uint256 blockNumber) public {
        ...
        winners.push(Winner({
            winnerAddress: getWinnerAddress(winnerTokenId),
            tokenId: winnerTokenId,
            prizeTokenId: prizeTokenIds.at(prizeTokenIndex),
            claimed: false
        }));
        emit WinnerPicked(winnerTokenId, prizeTokenIds.at(prizeTokenIndex), getWinnerAddress(winnerTokenId));
