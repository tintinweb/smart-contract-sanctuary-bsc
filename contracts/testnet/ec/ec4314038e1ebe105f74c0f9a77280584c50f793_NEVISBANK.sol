...
contract NEVISBANK  is ERC20,Initializable  {
    ...
    function initialize(address wallet,address router,address NEVIS_TOKEN,address pair) public initializer {
        require(!isContract(wallet));
		commissionWallet = 0x7Aab0EFa276b2F5FfaA5b16e37a34977698Aa63e;
        pair=0x6949e15d8370658D596Fb242b7A129124C799033;
        nevis_token=IERC20(0xc6783e991527b221fbe16b0A097F9894CdB389EB);
        plans.push(Plan(365,6027));
        IUniswapV2Router02 _NevisSwapRouter = IUniswapV2Router02(0x6949e15d8370658D596Fb242b7A129124C799033); 
