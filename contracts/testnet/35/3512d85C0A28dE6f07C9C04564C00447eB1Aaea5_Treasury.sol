    ...
    ReentrancyGuardUpgradeable
{
    ...
    uint256 public daoFundPrinterPercent;
    ...
    function buyBonds(uint256 _radianceAmount, uint256 targetPrice)
        ...
        nonReentrant
    {
        console.log("Amount", _radianceAmount);
        require(
            _radianceAmount > 0,
        ...
        console.log("Radiance Price", radiancePrice);
