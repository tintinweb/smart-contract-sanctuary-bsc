...
//////////////////////////////////////// default methods
        ...
        onlyMinter
    {
        ...
        _mint(to, tokenId);
        emit WinePoolMintToken(to, tokenId);
    }
...
//////////////////////////////////////// internal users and tokens
        ...
        onlyMinter
    {
        ...
        emit WinePoolMintTokenToInternal(internalUser, tokenId);
    }
        ...
        tokenIdExists(tokenId) onlyManager whenNotPaused
    {
        ...
        emit InternalToInternalTransfer(internalFrom, internalTo, tokenId);
    }
        ...
        tokenIdExists(tokenId)
    {
        ...
        internalOwnedTokens[tokenId] = internalTo;
        emit OuterToInternalTransfer(outerFrom, internalTo, tokenId);
    }
        ...
        tokenIdExists(tokenId) onlyAllowInternalTransfers
    {
        ...
        emit InternalToOuterTransfer(internalFrom, outerTo, tokenId);
    }
