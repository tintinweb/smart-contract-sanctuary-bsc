...
contract PYEGov{
    ...
    function delWeight(address del)public{
        ...
        weight[msg.sender].votes = IGov(tokenaddress).balanceOfAt(msg.sender, IGov(tokenaddress).getCurrentSnapshotId());
...
// File: PYEGovernance/contracts/IGovernor.sol
...
// File: PYEGovernance/contracts/GovFactory.sol
