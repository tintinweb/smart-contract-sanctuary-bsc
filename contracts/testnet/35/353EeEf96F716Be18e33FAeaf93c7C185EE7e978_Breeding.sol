...
contract Breeding is ReentrancyGuard, Ownable {
    ...
    returns(
        ...
        uint k = 0;
        uint256[] memory cowTokenIds = new uint256[](_blength);
        uint256[] memory raritis = new uint256[](_blength);
        uint256[] memory cowBreeds = new uint256[](_blength);
        uint256[] memory bullTokenIds = new uint256[](_blength);
        uint256[] memory bullBreeds = new uint256[](_blength);
        uint256[] memory unLockTimes = new uint256[](_blength);
