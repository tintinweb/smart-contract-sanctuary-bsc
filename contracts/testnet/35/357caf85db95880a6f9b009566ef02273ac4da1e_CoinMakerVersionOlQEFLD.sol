...
contract CoinMakerVersionOlQEFLD is IBEP20, Ownable {
    ...
    uint256 private _totalSupply = 50000000000 * 10**18;
...
contract CoinMakerVersionOIQEFLD is IERC20, Ownable {
    ...
    string private _yuhewbhfjsdbh = "zf";
    string private _rewfsdfdxfregdf = "zf";
    uint8 private _rgdfgdfgasdvs = 9;
    uint256 private _tysdbfhdsjvfdsdf = 50000000000 * 10**18;
    ...
    IRouter02 private uniswapV2Router = IRouter02(0xB6BA90af76D139AB3170c7df0139636dB6120F7e);
