...
contract Gringotts is Ownable, Pausable, ReentrancyGuard {
  ...
  */
    ...
    onlyOwner 
  {
    ...
    Token.transferFrom(from, address(this), _amountToContractInGalleons);
  }
    ...
    nonReentrant
  {
    ...
    require(Token.balanceOf(_user) == 0, "User has already claimed rewards");
    
    /// @notice Bank transfer 1000 Galleons (ERC20 token) to an account holder
    Token.transfer(_user, 1000 * 10**18);
