...
contract SSW is Context, IERC20 {
    ...
    address payable public Wallet_Marketing =
        payable(0x7c09316ab69aa1DE4834E11FF64E5e63C0A972B6);
    ...
    uint256 private _tTotal = 200**9 * 10**_decimals;
    string private constant _name = "SWW";
    string private constant _symbol = "Save Water Wildlife";
