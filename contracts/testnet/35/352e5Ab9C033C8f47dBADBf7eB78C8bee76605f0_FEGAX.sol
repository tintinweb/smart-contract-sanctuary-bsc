...
interface IDEXRouter {
 ...
 contract FEGAX is IBEP20, Auth { using SafeMath for uint256;

    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // MAINNET,testnet

    string constant _name = "Feg A";
    string constant _symbol = "FEGA";
    ...
    address public buybackFeeReceiver = 0x60a2C0ca285D4D528110f59124982d89b93467EA;
