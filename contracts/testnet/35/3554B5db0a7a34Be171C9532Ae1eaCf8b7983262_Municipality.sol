...
contract Municipality is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function _getPriceForParcels(Parcel[] memory parcels) private view returns (uint256) {
        uint256 diffPriceAfter = 0;
        uint256 diffPriceBefore = parcels.length * 100000000000000000000;
        uint256 totalParcelsToBuy = currentlySoldStandardParcelsCount + parcels.length;
        if(totalParcelsToBuy > 157500) {
            diffPriceBefore = parcels.length * 301000000000000000000;
        } else if(totalParcelsToBuy > 100500) {
            diffPriceBefore = parcels.length * 209000000000000000000;
        } else if(totalParcelsToBuy > 52500) {
            diffPriceBefore = parcels.length * 144000000000000000000;
        } else if(totalParcelsToBuy > 21000) {
            diffPriceBefore = parcels.length * 116000000000000000000;
        }
        if(currentlySoldStandardParcelsCount < 157500 && totalParcelsToBuy > 157500) {
            diffPriceAfter = (totalParcelsToBuy - 157500) * 301000000000000000000;
            diffPriceBefore = (157500 - currentlySoldStandardParcelsCount) * 209000000000000000000;
        } else if(currentlySoldStandardParcelsCount < 100500 && totalParcelsToBuy > 100500) {
            diffPriceAfter = (totalParcelsToBuy - 100500) * 209000000000000000000;
            diffPriceBefore = (100500 - currentlySoldStandardParcelsCount) * 144000000000000000000;
        } else if(currentlySoldStandardParcelsCount < 52500 && totalParcelsToBuy > 52500) {
            diffPriceAfter = (totalParcelsToBuy - 52500) * 144000000000000000000;
            diffPriceBefore = (52500 - currentlySoldStandardParcelsCount) * 116000000000000000000;
        } else if(currentlySoldStandardParcelsCount < 21000 && totalParcelsToBuy > 21000) {
            diffPriceAfter = (totalParcelsToBuy - 21000) * 116000000000000000000;
            diffPriceBefore = (21000 - currentlySoldStandardParcelsCount) * 100000000000000000000;
        }
        return diffPriceBefore + diffPriceAfter;
    }
