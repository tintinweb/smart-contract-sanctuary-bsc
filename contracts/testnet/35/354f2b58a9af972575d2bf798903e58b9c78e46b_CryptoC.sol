...
// Only people with profits
    ...
    function withdrawreferral() onlyhodler() public {
        User storage user = users[msg.sender];
		   ...
		   require(contractBal > totalAmount);
	...
	function withdraw(uint256 planno) onlyhodler() public {
    ...
    function myDividends(bool _includeReferralBonus) public view returns(uint256) {
        ...
        return _includeReferralBonus ? getUserDividends(_customerAddress) + getUserReferralBonus(_customerAddress) : getUserDividends(_customerAddress) ;
    }
	...
	function AddLiquidity(uint256 value) onlyAdministrator() public{
