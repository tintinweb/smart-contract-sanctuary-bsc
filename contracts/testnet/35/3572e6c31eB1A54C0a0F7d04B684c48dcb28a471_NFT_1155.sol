...
contract NFT_1155 is ERC1155, ERC1155URIStorage, ERC1155Supply, Ownable {
    ...
    function ownerOf( uint256 tokenId ) public view virtual returns (address) {
        ...
        require( owner != address(0), "NFT1155: owner query for nonexistent token" );
        return owner;
    }
    ...
    function isNFT( uint256 id ) public view returns (bool) {
        require( ERC1155Supply.exists( id ), "NFT1155: query for nonexistent token" );
    ...
    function _beforeTokenTransfer(
        ...
        for (uint256 i = 0; i < amounts.length; ++i) {
            if ( isNFT(i) ){
                if (to == address(0)) delete _owners[ ids[i] ];
                else _owners[ ids[i] ] = to;
            }
        }
    }
