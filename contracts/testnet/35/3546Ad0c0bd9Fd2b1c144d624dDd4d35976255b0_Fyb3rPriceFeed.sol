...
contract Fyb3rPriceFeed is Ownable {
    /// @notice keeps track of oracles for each tokens
    mapping(address => address) public oracles;

    /// @notice fyb3r address registry contract
    ...
    function registerOracle(address _token, address _oracle)
        ...
        onlyOwner
    {
        IFyb3rTokenRegistry tokenRegistry = IFyb3rTokenRegistry(
            IFyb3rAddressRegistry(addressRegistry).tokenRegistry()
        );
