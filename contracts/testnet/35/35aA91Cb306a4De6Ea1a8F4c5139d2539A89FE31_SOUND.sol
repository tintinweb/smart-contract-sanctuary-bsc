...
contract SOUND is Context, IERC20, Ownable {
    ...
    // for testing
    address payable _adminAddress       = payable(0x691D15596e5219dD1f6B4Bd2220FA15f2eE495Ba);
    address payable _developmentAddress = payable(0xb150a57aB18EE7dA5f54ED23F3b1dEB3a3223194);

    address payable presale             = payable(0x6D828b9803e0bA9E0bfef171205B23Bb835D43d4);
    address payable private_sale        = payable(0x3E6f96111237aB086569fd2914713b217d9fd69b);
    address payable liquidity           = payable(0x020fD58D19EA8c0f071e90ED784a4F2E64280948);
    address payable listen_to_earn      = payable(0x3876e3676E47e82029B8A7B9a8d7b1e89dF6B5DA);
    address payable marketing           = payable(0x9C53d5818e1EB2175EF83C6d87B46F591ad9b024);
    address payable airdrop             = payable(0x55727e639DdA396eE87d167991c369EB8c4c878d);
    address payable stake_reward        = payable(0x55727e639DdA396eE87d167991c369EB8c4c878d);
    ...
    uint256 private _swapTokensAtAmount = 100 * 10**9; // SEND BUSD
    ...
    function sendBUSDToFee(uint256 amount) private {
        ...
        busdToken.approve(_developmentAddress, amount.div(2));
        busdToken.approve(_adminAddress, amount.div(2));
