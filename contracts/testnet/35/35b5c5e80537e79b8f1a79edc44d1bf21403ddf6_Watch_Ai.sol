...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, Ownable {
  ...
  constructor(string memory _name, string memory _symbol)  ERC20(_name, _symbol) {
      ...
      router = _router;
      rewardToken = 0xaB1a4d4f1D656d2450692D237fdD6C7f9146e814;
  }
...
contract Watch_Ai is ERC20, Ownable {
    ...
    uint256 private antiBotBlocks = 30;
    ...
    function setAntiBotBlocks(uint256 numberOfBlocks) external onlyOwner{
        ...
        require(numberOfBlocks < 8,"Deadline should be less than 8 Blocks");
    ...
    function Blacklist_Single_Sniper(address _address, bool _status) external onlyOwner {
        isBlacklisted[_address] = _status;
    }
    
    function Blacklist_Multi_Snipers(address[] calldata addresses, bool status) external onlyOwner {
