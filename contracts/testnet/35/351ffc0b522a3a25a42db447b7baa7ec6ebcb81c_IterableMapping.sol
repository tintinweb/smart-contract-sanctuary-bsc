...
contract TestNeko is ERC20, Ownable {
    ...
    constructor() ERC20("$TNKG", "Testneko"){
    	...
    	marketingWallet = address(0xfa8465854746515BAB6e744e5cf4D7b0247F47DA);  // set as marketing wallet
        charityWallet = address(0xfa8465854746515BAB6e744e5cf4D7b0247F47DA);    // set as charity wallet
        lockWallet = address(0xfa8465854746515BAB6e744e5cf4D7b0247F47DA);       // set as lock wallet

        devWallet = address(0xfa8465854746515BAB6e744e5cf4D7b0247F47DA);        // set as dev wallet
        liquidityWallet = address(0xfa8465854746515BAB6e744e5cf4D7b0247F47DA);  // set as liquidity wallet
        presaleWallet = address(0xfa8465854746515BAB6e744e5cf4D7b0247F47DA);  // set as presale wallet
        airdropWallet = address(0xfa8465854746515BAB6e744e5cf4D7b0247F47DA);    // set as airdrop wallet
        BurnWallet = address(0xfa8465854746515BAB6e744e5cf4D7b0247F47DA);       // set as Burn wallet
