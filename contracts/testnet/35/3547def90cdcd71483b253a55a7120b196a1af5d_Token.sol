...
// ON PROGRESS
//- Tax berupa bnb/token (switchable)
//- Marketing 3%
//- RnD 2%
//- MAX SET TAX 20%
//- 2 tax wallet address
//- auto sell min x% / 1.000.000 token




// DONE
//- no blacklist function for transaction
//- transfer wallet to wallet no tax
//- No minting
//- whitelist / exclude tax
//- no on off trading
//- Supply 10 Miliar
//- decimal 18
  ...
  , IERC20Metadata
{
  ...
  uint256 public _taxSellLimit = 100000;
  uint256 public _maxTaxPercentage = 20;
  address public _taxReserved;
  ...
  function setTaxReserved(address input_) public onlyOwner { 
  ...
  function distributeFee () private swapping {
    ...
    if (_balances[address(this)] > 0) {
      ...
      try _router.swapExactTokensForETHSupportingFeeOnTransferTokens(
        ...
        (bool sent, ) = payable(_taxReserved).call{value: amountBNB, gas: 30000}(""); require(sent, "Transfer error.");
