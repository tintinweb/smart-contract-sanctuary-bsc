...
contract EVoting is Owned{
    ...
    uint256[] public joinedvoterAadhar;
    ...
    /**
     * @dev Create a new EVoting to choose one of 'candidateNames'
    ...
    {
        Voter[] memory ret = new Voter[](joinedvoterAadhar.length);
        for (uint i = 0; i < joinedvoterAadhar.length; i++) {
            uint256 _id = joinedvoterAadhar[i];
            ret[i] = voter[_id];
        }
        return ret;
    }
    ...
    function getuser(uint256 voterAadharNumber)
        public
        view
        returns (bool isuser)
    {
        Voter storage voter_ = voter[voterAadharNumber];
        if (voter_.isAlive) isuser = true;
    }
    ...
    function editVoters(string memory _name,uint256 _aadhar,uint8 age) public onlyOwner returns (bool) {
        require(voter[_aadhar].isAlive == true , "User Not exist");
        voter[uint256(_aadhar)].name = _name;
        voter[uint256(_aadhar)].age = age;
        return true;
    }    
    ...
    function addVoters(string memory _name,uint256 _aadhar,uint8 age) public onlyOwner returns (bool) {
        ...
        joinedvoterAadhar.push(uint256(_aadhar));
        return true;
    }
    ...
    function initializeVoterDatabase_() internal {
        ...
        joinedvoterAadhar.push(uint256(482253918244));
        ...
        joinedvoterAadhar.push(uint256(532122269467));
        ...
        joinedvoterAadhar.push(uint256(468065932286));
        ...
        joinedvoterAadhar.push(uint256(809961147437));
        ...
        joinedvoterAadhar.push(uint256(908623597782));
        ...
        joinedvoterAadhar.push(uint256(760344621247));
        ...
        joinedvoterAadhar.push(uint256(908704156902));
        ...
        joinedvoterAadhar.push(uint256(778925466180));
        ...
        joinedvoterAadhar.push(uint256(393071790055));
        ...
        joinedvoterAadhar.push(uint256(983881786161));
        ...
        joinedvoterAadhar.push(uint256(756623869645));
        ...
        joinedvoterAadhar.push(uint256(588109459505));
        ...
        joinedvoterAadhar.push(uint256(967746320661));
        ...
        joinedvoterAadhar.push(uint256(727938171119));
        ...
        joinedvoterAadhar.push(uint256(609015917688));
        ...
        joinedvoterAadhar.push(uint256(620107691388));
        ...
        joinedvoterAadhar.push(uint256(403561319377));
        ...
        joinedvoterAadhar.push(uint256(837970229674));
    }
}