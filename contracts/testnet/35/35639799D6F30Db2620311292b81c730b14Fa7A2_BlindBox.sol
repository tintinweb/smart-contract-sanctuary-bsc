...
contract BlindBox is ERC721Upgradeable, OwnableUpgradeable, IERC721ReceiverUpgradeable {
    ...
    // free
    uint256 public freeFirstTokenId;
    uint256 public freeTokenId;
    uint256 public freeTotalCount;
    uint256 public freeBuyCount;
    uint256 public freeBuyPrice;
    uint256 public freeMaxPurchases;
    bool public freeOpen;

    // toll
    uint256 public tollFirstTokenId;
    uint256 public tollTokenId;
    uint256 public tollTotalCount;
    uint256 public tollBuyCount;
    uint256 public tollBuyPrice;
    uint256 public tollMaxPurchases;
    bool public tollOpen;
    ...
    function changePriceConfig(uint256 _freePrice, uint256 _tollPrice) public checkAdmin
    {
        freeBuyPrice = _freePrice;
        tollBuyPrice = _tollPrice;
    }


    function changeOpenConfig(bool _freeOpen, bool _tollOpen) public checkAdmin
    {
        freeOpen = _freeOpen;
        tollOpen = _tollOpen;
    }
    ...
    function setMaxPurchase(uint256 _type, uint256 _max) public checkAdmin
    {
        if (_type == 0) {
    ...
    function setTotalCount(uint256 _type, uint256 _value) public checkAdmin
    {
        if (_type == 0) {
    ...
    function singleMint(uint256 _type, bytes32[] calldata _merkleProof) external payable
    {
        ...
        if (_type == 0) {
            ...
            _safeMint(_msgSender(), freeTokenId);
            addPurchases(_msgSender(), 0);
            freeBuyCount++;
            freeTokenId++;
        } else if (_type == 1) {
            require(tollOpen, "Not open");
            ...
            _safeMint(_msgSender(), tollTokenId);
