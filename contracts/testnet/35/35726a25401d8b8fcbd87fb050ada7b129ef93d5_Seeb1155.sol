...
contract Seeb1155 is Initializable, ERC1155Upgradeable, OwnableUpgradeable, ERC1155BurnableUpgradeable {
    ...
    function initialize() public initializer {
        ERC1155Upgradeable.__ERC1155_init("", "SeebNFT", "SNFT");
        __Ownable_init();
        _tid = 1;
    ...
    function burnToken(
        ...
        require(
            (_balances[tokenId][from] >= NOFToken && from == msg.sender) || msg.sender == owner(),
