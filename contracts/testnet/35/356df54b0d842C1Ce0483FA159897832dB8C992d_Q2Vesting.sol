...
contract Q2Vesting is Ownable {
    ...
    function vestingDetails(address userAddress,uint256 index) public view returns(uint256,uint256)
    {
        return (unLockTokenAmount[userAddress][index],unLockTokenAmount[userAddress][index]);
    }
