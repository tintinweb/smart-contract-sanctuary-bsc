...
contract AuctionFeature is ReentrancyGuard, IAuctionFeature, FixinCommon {
    ...
    function Bid(uint _idOnMarket, uint256 _price)
        public
        override
        nonReentrant
    {
    ...
    function claimNft(uint _idOnMarket) public override nonReentrant {
...
interface IAuctionFeature {
    ...
    function Bid(uint _idOnMarket, uint256 _price) external;

    function claimNft(uint _idOnMarket) external;
