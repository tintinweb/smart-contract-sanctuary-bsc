    ...
    ITreasuryDeposit
{
    ...
    event Withdraw(address indexed wallet, uint256 indexed amount);
        ...
        returns (bool)
    {
        ...
        if (!ITreasuryDeposit(token_).liquidityDeposit(from, amount)) {
    ...
    {
        require(amount > 0, "Not enough money in wallet");
        if (!ITreasuryDeposit(token_).foundationDeposit(from, amount)) {
            revert TransferFailed();
        }
        return true;
    }
    ...
    {
        require(amount > 0, "Not enough money in wallet");
        if (!ITreasuryDeposit(token_).marketingDeposit(from, amount)) {
            revert TransferFailed();
        }
        return true;
    }
    ...
    {
        require(amount > 0, "Not enough money in wallet");
        if (!ITreasuryDeposit(token_).tokenSaleDeposit(from, amount)) {
            revert TransferFailed();
        }
        return true;
    }
        ...
        returns (bool)
    {
        ...
        if (!ITreasuryWithdraw(token_).liquidityWithdraw(to, amount)) {
            revert TransferFailed();
        }
        ...
        returns (bool)
    {
        ...
        if (!ITreasuryWithdraw(token_).foundationWithdraw(to, amount)) {
            revert TransferFailed();
        }
        ...
        returns (bool)
    {
        ...
        if (!ITreasuryWithdraw(token_).marketingWithdraw(to, amount)) {
            revert TransferFailed();
        }
        ...
        returns (bool)
    {
        ...
        if (!ITreasuryWithdraw(token_).tokenSaleWithdraw(to, amount)) {
            revert TransferFailed();
        }
    ...
    function getMaketingTotalAmount() external view override returns (uint256) {
        return ITreasury(token_).getMaketingTotalAmount();
    }
    ...
    function donate(uint256 amount) public whenNotPaused {
        ...
        emit Transfer(_msgSender(), owner(), amount);
    }
...
interface ITreasury {
    function getMaketingTotalAmount() external view returns (uint256);
