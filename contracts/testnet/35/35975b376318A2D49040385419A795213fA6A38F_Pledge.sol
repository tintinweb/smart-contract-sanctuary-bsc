...
contract Pledge {
    ...
    //质押时间变量
    uint256 private _profitDay = 730;
    //理财时间变量
    uint256 private _financialDay = 90;
    //质押利润率
    ...
    address private _token = 0x412A54997925749f6E8fc1Fe7228e08f37C7F7Bc; //TOKEN地址

    //市场地址
    address private _marketAddress = 0x1aBF9A2E66906F13ff2830bc18478405abC68eE0;
    //市场比率
    uint256 private _marketRate = 15;
    //技术地址
    address private _technologyAddress =
        0x1aBF9A2E66906F13ff2830bc18478405abC68eE0;
    //技术比率
    ...
    function lockProfit(uint256 num) public payable returns (bool) {
        ...
        _profitOrder[msg.sender].push(
            order({
                ...
                unLockTime: block.timestamp + _profitDay * 1 days,
                takeTime: 0
            })
        );
        //计算奖金
    ...
    function lockFinancial(uint256 num) public payable returns (bool) {
        ...
        _financialOrder[msg.sender].push(
            order({
                ...
                num: num,
                lockTime: block.timestamp,
                unLockTime: block.timestamp + _financialDay * 1 days,
                takeTime: 0
            })
        );
