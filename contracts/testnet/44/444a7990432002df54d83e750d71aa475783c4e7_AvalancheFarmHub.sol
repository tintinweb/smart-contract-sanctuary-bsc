...
contract AvalancheFarmHub {
	...
	IBEP20 public BUSD = IBEP20(0xC9C7C814607d731372CC6CC47a4b0426efAC2811); 
    ...
    uint256[] public TOKENS_AIRDROP_PERCENTS = [20000000, 40000000, 60000000, 80000000, 100000000, 120000000];
	
	
	uint256[] public REFERRAL_PERCENTS = [140, 20, 20, 20, 20, 1, 1, 1, 1, 1];
	
	uint256 public constant BNB_PER_TICKET = 1e16; // 0.01 AVAX
