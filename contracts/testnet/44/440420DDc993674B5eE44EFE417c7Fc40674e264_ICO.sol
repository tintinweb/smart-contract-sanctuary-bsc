...
contract ICO is Ownable {      
    ...
    function migrateOrder(address usr, uint256 _cnt,uint256[] memory _amount, uint256[] memory _start, uint256[] memory _unfreeze, bool[] memory _isUnfreezed, uint256[] memory _freezed)public onlyOwner returns(bool){
