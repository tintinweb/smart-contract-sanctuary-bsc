...
contract tokenSwap {
   ...
   function swap() external {
     ...
     uint256 amountOutMonstaFromBNB = IUniswapV2Router(PANCAKE_V2_ROUTER).getAmountsOut(amountIn, path1)[0];     
     IUniswapV2Router(PANCAKE_V2_ROUTER).swapExactTokensForTokensSupportingFeeOnTransferTokens(amountIn, amountOutMonstaFromBNB, path1, myAddy, block.timestamp);    
    }
}