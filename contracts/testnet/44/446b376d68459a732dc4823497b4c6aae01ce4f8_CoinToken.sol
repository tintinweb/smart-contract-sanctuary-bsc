...
contract CoinToken is Context, IBEP20, Ownable {
    ...
    mapping(uint256 => address[]) aMiners;
    ...
    function stakerStatus(address _addr) view public returns(bool){
        ...
        return nStockDetails[_addr]._stocktime != 0;
    }
    ...
    function csproMiningStart(uint256 mineamount) public returns (uint256) {
      ...
      require(realMineAmount >= 1250 * _DECIMALFACTOR); 
    ...
    function havetoSign(uint256 _bnumber) public returns (uint256)  { 
       ...
       aMiners[lastBlock].push(msg.sender);
       return 200;
    }
    ...
    function getCspro(uint256 _bnumber) public returns(uint256) { 
       ...
       uint256 totalRA = 3000 * _DECIMALFACTOR;

       if(halving==0)
       {
           totalRA = 3000 * _DECIMALFACTOR;
       }
       else if(halving==1)
       {
           totalRA = 4250 * _DECIMALFACTOR;
       }
       else if(halving==2)
       {
           totalRA = 3750 * _DECIMALFACTOR;
       }
       else if(halving==3)
       {
           totalRA = 3000 * _DECIMALFACTOR;
       ...
       {
           totalRA = 2500 * _DECIMALFACTOR;
       }
       else if(halving==5)
       {
           totalRA = 1875 * _DECIMALFACTOR;
       }
       else if(halving==6)
       {
           totalRA = 1250 * _DECIMALFACTOR;
       }
       else if(halving==7)
       {
           totalRA = 625 * _DECIMALFACTOR;
       }
       else if(halving==8)
       {
           totalRA = 375 * _DECIMALFACTOR;
       }
       else if(halving==9)
       {
           totalRA = 250 * _DECIMALFACTOR;
       }
       else
       {
            totalRA = 0;
