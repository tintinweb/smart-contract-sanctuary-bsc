...
contract RR is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x6750FA129bd34A08861CBb2F45f12b2237124143);
    address payable public teamWalletAddress = payable(0x6750FA129bd34A08861CBb2F45f12b2237124143);
...
//        address(this).transfer(teamWalletAddress, balanceOf(address(this)));
