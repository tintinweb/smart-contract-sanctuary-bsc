...
contract FManCard is ERC1155, Ownable {
    ...
    modifier onlyDeveloper() {
        require(developerAddress == msg.sender, "Caller is not the developer");
        _;
    }

    modifier onlyOwnerOrDeveloper() {
        require(
            owner() == _msgSender() || developerAddress == msg.sender,
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 developerBalance = balance.div(10).div(2);
    ...
    function mintDrop(
        ...
        // Verify balance and transfer tokens
        require(
            IERC20(busdAddress).balanceOf(msg.sender) >= tokenAmount,
            "Insufficient balance to mint"
        );
