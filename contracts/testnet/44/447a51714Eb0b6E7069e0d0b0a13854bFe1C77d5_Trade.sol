...
contract Trade {
    ...
    function initialize(address _sfmr,
        address _growthFund,
        ...
        returns (uint256[] memory output)
    {
        ...
        ISafeswapRouter02 sr =
            ISafeswapRouter02(0xE42D262dA212a25B7Fa5C40c545317ba24A7bE1b);
    ...
    function bnbTransaction(address token, uint256 amount, address payable seller) internal {
        // Pancake Interface
        ISafeswapFactory sf =
            ISafeswapFactory(0xa45813C0618809F8529c41215Ae29e092FB97554);

        // check if (BNB/SFMR) pair present in pancakeswap
        address pair =
            sf.getPair(sfmr, 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
        require(pair != address(0), "!! BNB/SFMR pair not found !!");
        ...
        if (sellerStake && refStake) {
            ...
            uint256 tokAmt = IERC20(sfmr).balanceOf(address(this));
            ...
            IERC20(sfmr).transfer(0x000000000000000000000000000000000000dEaD,amtLeft2);
        ...
        returns (uint256[] memory output)
    {
        ...
        IERC20(token).approve(0xE42D262dA212a25B7Fa5C40c545317ba24A7bE1b, amt);

        ISafeswapRouter02 sr =
            ISafeswapRouter02(0xE42D262dA212a25B7Fa5C40c545317ba24A7bE1b);

        uint256[] memory amounts =
            sr.swapExactTokensForTokens(amt, 0, path, address(this), deadline);
    ...
    function tokenTransaction(
        ...
        address pair2 =
            sf.getPair(sfmr, 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
        require(pair2 != address(0), "!! BNB/SFMR pair not found !!");
