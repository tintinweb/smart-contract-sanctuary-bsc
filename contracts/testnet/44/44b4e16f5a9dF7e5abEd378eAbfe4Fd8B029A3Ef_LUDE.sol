...
contract LUDE is Context, IBEP20, IBEP20Metadata,Ownable {
    ...
    address public teamWallet = 0x556313741D7DE93D91c1D74A2a49F15c3aA05b27;
    
    uint256 public MaxSupply = 17_000_000 * 10 ** _decimals;
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 50000000 * 10**18;
    ...
    constructor () {
        ...
        _mint(_msgSender(), 4_000_000 * 10 ** _decimals);
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        require(_isAutomaticMarketMaker[sender] || _isAutomaticMarketMaker[recipient], "To can't make wallet to wallet Transaction");
        ...
        _balances[recipient] += amount.sub(_TeamAmt).sub(_liquidityAmt).sub(_burnAmt);
        if(_TeamAmt > 0){
    ...
    function mint(address account, uint256 amount) external onlyOwner() virtual {
       require(_totalSupply.add(amount) <= MaxSupply,"You can't mint more than MaxSupply");
