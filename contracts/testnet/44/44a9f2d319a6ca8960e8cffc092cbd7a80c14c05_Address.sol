...
contract BinLottoMaster is Context, IERC20, Ownable {
    ...
    string private _name = "MEGATOKEN";
    ...
    address public marketingWallet = 0x99F3fe5Ca1134dd3A428C04950E603ea441955ce;
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner() {
        require(maxTxPercent > 7, "Cannot set transaction amount less than 5 percent!");
