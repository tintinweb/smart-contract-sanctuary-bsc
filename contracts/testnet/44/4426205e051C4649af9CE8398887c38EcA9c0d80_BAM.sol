...
contract BAM is Ownable, ReentrancyGuard {
    ...
    struct Stake {
        ...
        uint256 totalResidualEarning; // Residual earnings
    ...
    function stakeBNB() external payable {
        ...
        if (!userDetails[msg.sender].activeStake.isActive) {
            ...
            newStake.totalResidualEarning = 0;
    ...
    function seeTeamSize(address _user) external view returns( uint256[5] memory) {
