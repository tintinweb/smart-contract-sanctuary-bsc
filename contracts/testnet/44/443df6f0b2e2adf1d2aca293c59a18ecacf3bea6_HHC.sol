...
abstract contract AbsToken is IERC20, Ownable {
    ...
    constructor (
        ...
        IPancakeRouter02 swapRouter = IPancakeRouter02(RouterAddress);
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        USDT.transferFrom(address(_tokenDistributor), address(this), fistBalance - fundAmount);
