...
contract lar is ERC20Detailed, Auth {
    ...
    address public pair;
    address public constant busdToken = 0xf5152A54b6f946bbBda8672e0869Ea360F8FEC8c;
    ...
    constructor() ERC20Detailed('lar', 'lar', uint8(DECIMALS)) Auth(msg.sender) {
        router = IDEXRouter(0x8d1cb76584f997CD2B8A7C200490fd7FA30dc746);
