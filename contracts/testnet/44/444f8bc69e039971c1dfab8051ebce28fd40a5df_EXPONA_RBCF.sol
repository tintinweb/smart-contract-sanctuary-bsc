...
contract EXPONA_RBCF {
    ...
    function Registration(uint _referrerID, uint _coreferrerID,uint256 _amountStable, uint256 _amountToken) public payable {
        ...
        //    if (!isTokenAcceptance) {
            ...
            }else if(_amountStable >0){
            require(_amountStable == REGESTRATION_FESS, "Incorrect Value");
            require(stableCoin.allowance(msg.sender, address(this)) >= _amountStable,"NEED_TO_APPROVE_TOKEN"); 
            stableCoin.transferFrom(msg.sender, address(this), _amountStable);
            tokenReward =  _amountStable / tokenPrice() * 1e18;
        }
        else {
