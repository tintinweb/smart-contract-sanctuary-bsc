...
// File: pre-sale_flat.sol


// File: presale/sale/pre-sale.sol
...
// File: ido-contract-12022022/ido.sol
...
contract IDOSale is AccessControl, Pausable, ReentrancyGuard {
    ...
    /**
     * @dev Set _endTime cap for each user
     */
    function setEndTime(uint256 _endTime) external onlyOwner {
        purchaseCap = _endTime;
     ...
     * The result array can include zero amount item
     */
    function timeNowAction() external view returns (uint256) {
