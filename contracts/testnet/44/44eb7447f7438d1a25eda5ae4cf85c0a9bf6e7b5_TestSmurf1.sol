...
contract TestSmurf1 is Context, IBEP20, Ownable 
{
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x2f3380D8a8cB8a0Acb22A33b7C566B9220d4E037); 
    address payable public charityAddress =   payable(0x2f3380D8a8cB8a0Acb22A33b7C566B9220d4E037); 
    address payable public liquidityAddress = payable(0x2f3380D8a8cB8a0Acb22A33b7C566B9220d4E037);
    ...
    string private _name = "TestSmurf1";
    string private _symbol = "TSMURF1";
