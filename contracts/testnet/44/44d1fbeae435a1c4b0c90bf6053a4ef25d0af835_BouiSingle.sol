    ...
    BEP721BurnableUpgradeable
{
    ...
    uint256 private bouiserviceValue;
    uint256 private busdserviceValue;
    address private BusdAddress;
    address private BouiAddress;
    ...
    function initialize() public initializer {
        __Ownable_init();
        BEP721Upgradeable.__BEP721_init("BOUI", "BOUI");
        _tid = 1;
    ...
    function getBouiFee() public view returns (uint256) {
        return bouiserviceValue;
    }

    function getBUSDFee() public view returns (uint256) {
        return busdserviceValue;
    }
    ...
    function setTokenAddress(address _bouiAddress, address _busdAddress)
        public
        onlyOwner
    {
        BouiAddress = _bouiAddress;
        BusdAddress = _busdAddress;
    }

    function bouiserviceFunction(uint256 _bouiserviceValue) public onlyOwner {
        bouiserviceValue = _bouiserviceValue;
    }

    function busdserviceFunction(uint256 _busdserviceValue) public onlyOwner {
        busdserviceValue = _busdserviceValue;
    }
    ...
    function newtokenasbid(
        ...
        if (tokenAddress == BouiAddress) {
            fee = bouiserviceValue;
        } else if (tokenAddress == BusdAddress) {
            fee = busdserviceValue;
        }
    ...
    function _saleToken(
        ...
        uint256 fee = serviceValue;
        if (tokenAss == BouiAddress) {
            fee = bouiserviceValue;
        } else if (tokenAss == BusdAddress) {
            fee = busdserviceValue;
        }
        uint256 val = pBEPent(amount, fee).add(amount);
