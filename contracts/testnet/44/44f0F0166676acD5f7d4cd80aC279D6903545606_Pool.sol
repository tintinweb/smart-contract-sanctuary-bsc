...
interface IPool {
    function initialize(
        ...
        bool[3] memory _useWhitelisting, // [0] = whitelist ,[1] = audit , [1] = kyc
...
contract Pool is OwnableUpgradeable, IPool {
    ...
    function initialize(
        ...
        uint256[3] memory _timeSettings, // [0] = start, [1] = end, [2] = unlock seconds
        uint256[2] memory _feeSettings, // [0] = token fee percent, [1] = eth fee percent
        bool[3] memory _useWhitelisting, // [0] = whitelist ,[1] = audit , [2] = kyc
        uint256[2] memory _liquidityPercent, // [0] = liquidityPercent , [1] = refundType 
        string memory _poolDetails,
        address _poolOwner,
        address _poolManager,
        ...
        useWhitelisting = _useWhitelisting[0];
        audit = _useWhitelisting[1];
        kyc = _useWhitelisting[2];
