...
contract StakePoolBNBForToken is States, ReentrancyGuard, Ownable {
    ...
    function setTokens(uint256 unlockDate, IBEP20 _rewardingToken, uint256 _lockPeriod) public onlyOwner {
        lockPeriod = _lockPeriod;
        rewardingToken = _rewardingToken;
        unlockDate = unlockDate;
    }

    function setData(uint256 _days, uint256 unlockDate) public onlyOwner {
        lockPeriod = _days;
        unlockDate = unlockDate;
    }
...
contract FactoryStakingPool is Ownable{
    ...
    function createBNBForToken(address ownerAddress, uint256 unlockDate, IBEP20 _rewardingToken, uint256 _lockPeriod) public onlyOwner returns (address)
    {
        StakePoolBNBForToken toDeploy = new StakePoolBNBForToken();
        toDeploy.setTokens(unlockDate, _rewardingToken, _lockPeriod);
