...
// File: contracts/NaughtylistStake.sol
...
contract NaughtyListStake is IERC721Receiver, Ownable, ReentrancyGuard{
    function onERC721Received(
        address operator,
        address from,
        uint256 tokenId,
    ...
    address nftTokenAddress = 0xc68761C70A9751806d8bB6AdbaD03986ecCbDA1c;
    ...
    constructor() {
        address _baseTokenAddress = 0xA0469f287D4C0E6610feaBae1333b7B8b6f7BA84; 
        address _rewardTokensAddress = 0xA0469f287D4C0E6610feaBae1333b7B8b6f7BA84;
        ...
        apys[1][7] = 100; //APY based on rarity,locked days
        apys[1][15] = 150; 
        apys[1][30] = 200;
        apys[1][365] = 1000;
        
        apys[2][7] = 250; //APY based on rarity,locked days
        apys[2][15] = 375; 
        apys[2][30] = 500;
        apys[2][365] = 2500;

        apys[3][7] = 500; //APY based on rarity,locked days
        apys[3][15] = 750; 
        apys[3][30] = 1000;
        apys[3][365] = 5000;

        apys[4][7] = 800; //APY based on rarity,locked days
        apys[4][15] = 1200; 
        apys[4][30] = 1600;
        apys[4][365] = 8000;

        apys[4][7] = 5000; //APY based on rarity,locked days
        apys[4][15] = 7500; 
        apys[4][30] = 10000;
        apys[4][365] = 50000;
    }
