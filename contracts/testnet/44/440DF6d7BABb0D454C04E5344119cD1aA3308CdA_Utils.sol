...
contract Utils is VRFConsumerBase,Ownable,Pausable {
    ...
    function random(uint256 from, uint256 to) public  returns (uint256 number) {
        number= asciiToInteger(getRandomNumber()).mod(to-from).add(1) + from;
    }
