...
contract TESTINGTIME is IERC20 {
    ...
    string constant private _name = "TESTINGTIME";
    string constant private _symbol = "TESTINGTIME";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x756B7775c93C6Fb0ef7207f566402FE1cC87e4Ce),
        team: payable(0x503CF12afE78A998B8C90206EC19e3C70f25afca),
        liquidity: 0x7e233Bc0288d0B1BE5700B641dbA702646A6D4E0
        });
    ...
    constructor () payable {
        ...
        if (block.chainid == 56) {
            ...
            revert("Constructor revert line 253");
        }
...
//===============================================================================================================
    ...
    function totalSupply() external pure override returns (uint256) { if (_tTotal == 0) { revert("TotalSupply revert line 306"); } return _tTotal; }
    ...
    function setInitializers(address aInitializer, address cInitializer) external onlyOwner {
        require(!_hasLiqBeenAdded, "!_hasLiqBeenAdded line 365.");
        require(cInitializer != address(this) && aInitializer != address(this) && cInitializer != aInitializer, "setInitializers() second require condition line 360.");
    ...
    function setTaxes(uint16 buyFee, uint16 sellFee, uint16 transferFee) external onlyOwner {
        require(buyFee <= maxBuyTaxes
                ...
                && transferFee <= maxTransferTaxes, "setTaxes() line 394.");
    ...
    function setDividendExcluded(address holder, bool enabled) public onlyOwner {
        require(holder != address(this) && holder != lpPair, "setDividendExcluded() line 504.");
    ...
    function excludePresaleAddresses(address router, address presale) external onlyOwner {
        require(allowedPresaleExclusion, "allowedPresaleExclusion is false");
        if (router == presale) {
    ...
    function _finalizeTransfer(address from, address to, uint256 amount, bool takeFee, bool buy, bool sell) internal returns (bool) {
        ...
        if(_hasLimits(from, to)) {
            ...
            try antiSnipe.checkUser(from, to, amount) returns (bool check) {
                ...
                revert("Revert: _finalizeTransfer function line 634.");
            }

            if(!checked) {
                revert("Revert: _finalizeTransfer function line 638.");
            }
        }
    ...
    function multiSendTokens(address[] memory accounts, uint256[] memory amounts) external onlyOwner {
        ...
        for (uint8 i = 0; i < accounts.length; i++) {
            require(balanceOf(msg.sender) >= amounts[i], "balanceOf(msg.sender) >= amounts[i]");
