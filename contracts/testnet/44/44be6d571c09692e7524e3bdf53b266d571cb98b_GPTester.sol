...
contract GPTester is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xdead);
    address public routerCA = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // 0x38eEd6a71A4ddA9d7f776946e3cfa4ec43781AE6 uniswap
    ...
    constructor() ERC20("GPTester", "GPT2") {
        ...
        maxTransactionAmount = 20_000_000 * 1e18; // 20% max txn
        maxWallet = 20_000_000 * 1e18; // 20% max wallet
        ...
        mktgWallet = address(0xc05b0E09DffF5569c4F76c473327cA188Fd6647f); 
        devWallet = address(0xc05b0E09DffF5569c4F76c473327cA188Fd6647f); 
        liqWallet = address(0xc05b0E09DffF5569c4F76c473327cA188Fd6647f); 
        operationsWallet = address(0xc05b0E09DffF5569c4F76c473327cA188Fd6647f);
