...
contract Safuu is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Safuu", "SAFUU", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x224c4F980125Ce61EBAE83729a9001CcDC7823E1;
        treasuryReceiver = 0x113CDf1c402E7675417499C871CaE1C553B9C571; 
        safuuInsuranceFundReceiver = 0x8BA1B5Ce9D10E2d6f7C4A533F8B838693BC85BdF;
        firePit = 0xc68BCcEA2e6d9883483417b4Fe954Cd4eaf72Cca;
