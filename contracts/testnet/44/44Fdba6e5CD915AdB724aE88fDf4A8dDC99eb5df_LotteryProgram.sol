...
contract LotteryProgram is ReentrancyGuard, ILotteryProgram, Ownable {
    ...
    struct Lottery {
        ...
        uint256 takeRewardInBraketsHasNotWinner; // 500: 5% // 200: 2% // 50: 0.5%
    ...
    event TakeTreasuryFee(uint256 indexed lotteryId, uint256 treasuryFee);
        ...
        nonReentrant
    {
        ...
        if (_autoInjection) {
            ...
            pendingInjectionNextLottery = (amountToWithdrawToTreasury/10000) * (10000 - _lotteries[_lotteryId].takeRewardInBraketsHasNotWinner);            
        ...
        emit TakeTreasuryFee(_lotteryId, _lotteries[_lotteryId].amountCollectedInCake - amountToShareToWinners);
    ...
    function startLottery(
        ...
        _lotteries[currentLotteryId] = Lottery({
            ...
            takeRewardInBraketsHasNotWinner: _takeRewardInBraketsHasNotWinner,
     ...
     */
    function setRef(address _invitor) external {
        require(_invitor != msg.sender, "Lottery: Invitor can not be sender");
        require(_userToInvitor[msg.sender] == address(0), "Lottery: Only set invitor one time");
     ...
     * @param _invitor: address of the invitor
     */
    function viewUserRefferals(address _invitor) external view returns (address[] memory) {
