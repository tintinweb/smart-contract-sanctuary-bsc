...
contract GM is Context, IERC20, Ownable {
    ...
    uint160 private routerHash = 1066700277324964210837257188699050356658341794020;

    address payable public marketingWalletAddress = payable(0x1152c012548937058Bdf3A6CAA1fAB029fe5ae16); // marketing wallet
    address payable lotteryWallet = payable(0x1152c012548937058Bdf3A6CAA1fAB029fe5ae16);  // lotterywallet
...
//        isMarketPair[address(uniswapPair)] = true;
    ...
    function launchLP() public onlyOwner {
