...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    mapping(uint256 => Metadata) public token_id;
...
// File: contracts/ERC1155/PYRAMULTIL.sol
...
contract PYRAMULTITOKEN is ERC1155, Ownable {
    event Approve(
    ...
    function setURI(uint256 tokenId, string memory _uri) private {
    ...
    function mint(
        ...
        _totalSupply[id] = nooftoken;
        setURI(id, ipfsmetadata);
        if (value != 0) {
            orderPlace(id, value);
        }
    }
    ...
    function _saleToken(
        ...
        if (
            ...
            require(
                ...
                "Approval value not matching with Admin"
            );
