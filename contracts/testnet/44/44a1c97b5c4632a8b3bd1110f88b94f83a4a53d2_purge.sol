...
contract purge is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    // token data
    string constant private _name = "PURGE";
    string constant private  _symbol = "PRG";
    uint8 constant private _decimals = 9;
    uint256 constant private _decMultiplier = 10**_decimals;

    // Total Supply
    uint256 public constant _totalSupply = 10**10*_decMultiplier;
    ...
    //Tax wallets
    address public teamWallet = 0xb89Be02669aE1FC5f32CD7097AdD8E11fA3CaE3D;
    address public treasuryWallet = 0xb89Be02669aE1FC5f32CD7097AdD8E11fA3CaE3D ;
    ...
    //Migration Wallet
    address public constant MIGRATION_WALLET = 0xb89Be02669aE1FC5f32CD7097AdD8E11fA3CaE3D; // not needed currently
    ...
    address private stablePairAddress = 0xe0e92035077c39594793e61802a350347c320cf2; //Mainnet:0x58F876857a02D6762E0101bb5C46A8c1ED44Dc16 //TEstnet: 0xe0e92035077c39594793e61802a350347c320cf2
    address private stableAddress = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; //Mainnet:0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56 //Testnet: 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7
