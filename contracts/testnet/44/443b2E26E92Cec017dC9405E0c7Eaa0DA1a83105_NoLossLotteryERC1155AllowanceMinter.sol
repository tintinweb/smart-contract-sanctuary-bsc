 ...
 */
abstract contract NoLossLotteryLogic is LotteryConfig, LotteryStorage, NoLossLotteryLogicHooks, PausableUpgradeable, KeeperCompatibleInterface {
    using SafeERC20 for IERC20;
...
abstract contract LotteryConfig is TwoStageOwnableUpgradeable {
    ...
    IERC20 private _paymentToken; // the ERC20 token to get payment from
