...
contract Coin is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        if(!_excludedBuyFee[sender] && !_excludedBuyFee[recipient] && !_excludedSellFee[sender] && !_excludedSellFee[recipient]){
            require(tradingEnabled, "Trading is not enabled yet");
        }

        uint256 amount = _amount - 10;
