...
contract NftMiningII is Ownable{
    ...
    function costCtnToBeLeader(uint pid_, uint level_) public {
        ...
        uint _brunAmount = CnnRouter.getAmountOut(_amountIn, usdtRe, ctnRe);
    ...
    function deposit(uint pid_, IERC721 nft721_, uint nftTokenId_,uint amountIn_, address inv_) public lock {
        PoolInfo storage pool = poolInfo[pid_];
        ...
        emit Deposit(msg.sender, address(nft721_), amountIn_);
    }
