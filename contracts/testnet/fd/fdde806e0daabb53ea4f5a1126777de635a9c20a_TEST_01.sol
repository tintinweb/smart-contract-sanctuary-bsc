...
// SPDX-License-Identifier: MIT
    ...
    contract TEST_01 is Context, IERC20, Ownable {
        ...
        function Sell_Price_Impact_Tiers__Percentage_Multiplied_by_100() external view returns (
                uint Price_Impact1,
                uint Price_impact2) {
        ...
        function Check_If_Price_Impacts_Feature_Is_Used(bool enter_the_word_true) external view returns (
                uint Price_Impact1_Percentage_Multiplied_by_100,
                uint Price_impact2_Percentage_Multiplied_by_100,
                string memory, 
                string memory, 
                bool) {
                ...
                // Otherwise Solidity will not show the text (string) messages.    

                Price_Impact1_Percentage_Multiplied_by_100 = price_impact1;
                Price_impact2_Percentage_Multiplied_by_100 = price_impact2;
                string memory Price_Impact1_Info;
                string memory Price_Impact2_Info;
                
                if (price_impact1 != 0) {Price_Impact1_Info = "Price Impact1 feature is used";} 
                else {Price_Impact1_Info = "Price Impact1 feature is NOT used";}

                if (price_impact2 != 0) {Price_Impact2_Info = "Price Impact2 feature is used";} 
                else {Price_Impact2_Info = "Price Impact2 feature is NOT used";}

                return (Price_Impact1_Percentage_Multiplied_by_100,
                        Price_impact2_Percentage_Multiplied_by_100,
                        Price_Impact1_Info, 
                        Price_Impact2_Info, 
                        enter_the_word_true);
        }
        ...
        function ABC_Restricted_Security_Check(address account) external view returns (bool) {
