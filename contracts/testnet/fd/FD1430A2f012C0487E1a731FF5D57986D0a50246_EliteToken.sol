...
contract EliteToken is ERC31337 {
    ...
    constructor (IERC20Metadata _wrappedToken, string memory _name, string memory _symbol, uint8 _decimals)
    ERC31337(_wrappedToken, _name, _symbol, _decimals) {
    ...
    function setBurnRateController(address burnRateController, bool allow) public onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual override {
        ...
        _balances[sender] = _balances[sender].sub(amount, "EliteToken: transfer amount exceeds balance");
...
contract WrappedERC20 is StandardERC20, IWrappedERC20, TokensRecoverable
{
    using SafeERC20 for IERC20Metadata;
    using SafeMath for uint256;

    IERC20Metadata public immutable override wrappedToken;
...
contract ERC31337 is WrappedERC20, IERC31337
{
    ...
    constructor(IERC20Metadata _wrappedToken, string memory _name, string memory _symbol, uint8 _decimals)
        WrappedERC20(_wrappedToken, _name, _symbol, _decimals)
    {
    }

    function setFloorCalculator(IFloorCalculator _floorCalculator) public override onlyOwner
    {
        floorCalculator = _floorCalculator;
    }

    function setSweeper(address sweeper, bool allow) public override onlyOwner
    {
