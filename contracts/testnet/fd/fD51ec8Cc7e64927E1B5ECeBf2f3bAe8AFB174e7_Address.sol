...
Other feature
2.5% Max transaction (25.000.000.000)
5% Max Wallet (50.000.000.000)
...
contract TESTREBEL is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x5198945c62bc15053B7C7Ed67840Be8bDE8382eA));
    address payable public devWallet =
        payable(address(0x982e59D69A5cD589B822Bb1C1D413CE365630100));
    address public liquidityReceiver =
        0x21a20b31dD3e46aB842302f66D4aE717478A57C7;
    address private fixedBurnAddress =
        0x000000000000000000000000000000000000dEaD;
    
    bool public burnDeductSupply = true;

    string private _name = "TESTREBEL";
    string private _symbol = "TESTREBEL";
