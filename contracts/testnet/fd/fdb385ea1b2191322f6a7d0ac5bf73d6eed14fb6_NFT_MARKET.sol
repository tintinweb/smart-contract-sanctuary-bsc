...
contract NFT_MARKET {
    ...
    function sellNFT(address _nftAddress, uint _tokenId, uint _price) external{
        ...
        require(sellingRegistry[sellingId].closed != true, "Sorry, you have already posted this item for sale");
    ...
    function getSellingIdList() public view returns(bytes32[] memory){
        return sellingIdList;
    }
}