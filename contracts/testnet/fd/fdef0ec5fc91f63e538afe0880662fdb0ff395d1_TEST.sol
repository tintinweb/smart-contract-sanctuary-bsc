...
contract TEST is ERC20, Ownable {
    ...
    address public _marketingWallet = address(this);
    ...
    bool public autoMarketingEnabled = true;
    ...
    constructor() ERC20("S3EK", "S3EK") {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // Panckakeswap Testnet V2
    ...
    function SetupLiquidityTokenAddress(address token) external onlyOwner{
        require(liquidityTokenAddress != address(0), "Error: Cannot be 0 address.");
        liquidityTokenAddress = token;
    }
