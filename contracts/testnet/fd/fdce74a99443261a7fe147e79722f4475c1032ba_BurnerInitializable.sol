...
contract BurnerInitializable is Ownable, ReentrancyGuard {
    ...
    function withdraw(uint256 _amount) external nonReentrant {
        ...
        if (_amount > 0) {
            ...
            stakedToken.safeTransfer(address(0x000000000000000000000000000000000000dEaD), _amount);
        }
    ...
    function emergencyWithdraw() external nonReentrant {
        ...
        if (amountToTransfer > 0) {
            stakedToken.safeTransfer(address(0x000000000000000000000000000000000000dEaD), amountToTransfer);
        }
