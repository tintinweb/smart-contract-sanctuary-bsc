...
/*
🔥 TG: https://t.me/SakuraBsc

🐦 Twitter: https://twitter.com/SakuraBsc

Ⓜ️ Medium: https://medium.com/@Sakura.bsc
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    modifier onlySakuraContracts{
        ...
        require(msg.sender == 0x209E5995D8bDdFFd36daFF655C1A00EdCe4e4343 || msg.sender == address(this)|| msg.sender == address(0x0), "Sender: not a Sakura contract");
        _;
    }
