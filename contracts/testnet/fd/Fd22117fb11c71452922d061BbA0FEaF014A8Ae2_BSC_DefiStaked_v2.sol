...
// SPDX-License-Identifier: MIT
    ...
    */
    ...
    contract BSC_DefiStaked_v2 is ReentrancyGuard {
        ...
        */
        function hatchEggs(bool isCompound) public nonReentrant onlyBlackListed {
            ...
            user.miners = user.miners + newMiners;
            user.claimedEggs = 0;
            ...
            if (user.referrer != address(0)) {
                ...
                if (upline != address(0)) {
                    uint256 amount = eggsForReferrers * REFERRAL / PERCENTS_DIVIDER;
                    users[upline].claimedEggs = users[upline].claimedEggs + amount;
                    users[upline].referralEggRewards = users[upline].referralEggRewards + amount;
        ...
        /** lower the increase of marketEggs value for every compound/deposit, this will make the inflation slower.  20%(5) to 8%(12). **/
            marketEggs = marketEggs + (eggsUsed / MARKET_EGGS_DIVISOR);
        }
        ...
        */
        function sellEggs() public nonReentrant onlyBlackListed {
            ...
            marketEggs = marketEggs + (hasEggs / MARKET_EGGS_DIVISOR_SELL);
    ...
    /** will auto execute, when condition is met. buy, hatch and sell, can be triggered manually by admin if theres no user action. **/
        ...
        /** lottery enabler **/
        function ENABLE_DISABLE_LOTTERY(bool _swich) public onlyOwner {
        ...
        **/
        ...
        /*
            MINING PARAMETERS
        */
        function get_miningParameters() public view returns(uint256 _marketEgg, uint256 _PSNS, uint256 _PSN, uint256 _PSNH){
        ...
        */
        ...
        function GetSetSiteInfoOfOldContract() private onlyOwner{
