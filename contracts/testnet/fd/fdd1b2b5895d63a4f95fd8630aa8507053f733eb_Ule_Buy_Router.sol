...
contract Ule_Buy_Router is Ownable {
    ...
    payable
    {
        ...
        (uint256 a, uint256 b, uint256 c) = addLiquidity(returnValues[1],half);
        returnToken = Percentage(a);
    ...
    function addLiquidity(uint256 _amount,uint256 half) public payable returns (uint amounts,uint amounts1,uint amounts2)
    {
