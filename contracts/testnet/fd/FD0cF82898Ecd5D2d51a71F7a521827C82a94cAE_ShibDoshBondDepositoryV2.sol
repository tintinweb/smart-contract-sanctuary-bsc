...
/// @title ShibDosh Bond Depository V2
/// @author Zeus, Indigo
/// Review by: JeffX

contract ShibDoshBondDepositoryV2 is IBondDepository, NoteKeeper {
    /* ======== DEPENDENCIES ======== */
    ...
    constructor(
        IShibDoshAuthority _authority,
        IERC20 _bone,
        IgPAW _gpaw,
        IStaking _staking,
        ITreasury _treasury
    ) NoteKeeper(_authority, _bone, _gpaw, _staking, _treasury) {
        // save gas for users by bulk approving stake() transactions
        _bone.approve(address(_staking), 1e45);
    }
     ...
     * @return payout_     the amount of gPAW due
        ...
        )
    {
         ...
         * price = quote tokens : bone (i.e. 42069 DAI : BONE)
         *
         * 1e18 = BONE decimals (9) + price decimals (9)
         */
         ...
         *
         * this is either the number of BONE that the market can sell
        ...
        // purchased, and how much BONE has been sold
    ...
    function _tune(uint256 _id, uint48 _time) internal {
        ...
        if (_time >= meta.lastTune + meta.tuneInterval) {
            ...
            // bone decimals (9) + price decimals (9)
             ...
             * is 10,000 BONE. max payout would be 1,000 BONE (10,000 * 1 / 10).
             */
     ...
     * @param _market      [capacity (in BONE or quote), initial price / BONE (9 decimals), debt buffer (3 decimals)]
    ...
    function create(
         ...
         *
         * 1e18 = bone decimals (9) + initial price decimals (9)
         */
        uint64 targetDebt = uint64(_booleans[0] ? ((_market[0] * 1e18) / _market[1]) / 10**decimals : _market[0]);

        /*
         * max payout is the amount of capacity that should be utilized in a deposit
         * interval. for example, if capacity is 1,000 BONE, there are 10 days to conclusion,
         * and the preferred deposit interval is 1 day, max payout would be 100 BONE.
         */
        ...
        emit CreateMarket(id_, address(bone), address(_quoteToken), _market[1]);
    }
     ...
     * @param _id          ID of market
     * @return             price for market in BONE decimals
     *
     ...
     * @param _id          ID of market
     * @return             amount of BONE to be paid in BONE decimals
     *
     * @dev 1e18 = bone decimals (9) + market price decimals (9)
     */
     ...
     * @param _id          ID of market
     * @return             current debt for market in BONE decimals
     */
     ...
     * @param _id          ID of market
     * @return             control variable for market in BONE decimals
     */
...
abstract contract NoteKeeper is INoteKeeper, FrontEndRewarder {
    ...
    constructor(
        ...
        IStaking _staking,
        ITreasury _treasury
    ) FrontEndRewarder(_authority, _bone) {
        gPAW = _gpaw;
        staking = _staking;
        treasury = _treasury;
    }
     ...
     * @param _payout      the amount of BONE due to the user
    ...
    function addNote(
        ...
        // note that only the payout gets staked (front end rewards are in BONE)
     ...
     * @param _sendgPAW    send payout as gPAW or sHUG
     * @return payout_     sum of payout sent, in gPAW
     */
    function redeem(
        address _user,
        ...
        if (_sendgPAW) {
            gPAW.transfer(_user, payout_); // send payout as gPAW
        } else {
            staking.unwrap(_user, payout_); // unwrap and send payout as sHUG
        }
    }
     ...
     * @param _sendgPAW    send payout as gPAW or sHUG
     * @return             sum of payout sent, in gPAW
     */
    function redeemAll(address _user, bool _sendgPAW) external override returns (uint256) {
        return redeem(_user, indexesFor(_user), _sendgPAW);
    }
     ...
     * @return payout_     the payout due, in gPAW
...
interface IBondDepository {
    ...
    struct Market {
        ...
        bool capacityInQuote; // capacity limit is in payment token (true) or in BONE (false, default)
    ...
    struct Terms {
        ...
        uint64 maxDebt; // 9 decimal debt maximum in BONE
    }
...
abstract contract FrontEndRewarder is ShibDoshAccessControlled {
    /* ========= STATE VARIABLES ========== */
    ...
    IERC20 internal immutable bone; // reward token

    constructor(IShibDoshAuthority _authority, IERC20 _bone) ShibDoshAccessControlled(_authority) {
        bone = _bone;
    }
    ...
    function getReward() external {
        ...
        bone.transfer(msg.sender, reward);
    }
...
interface INoteKeeper {
    ...
    struct Note {
        uint256 payout; // gPAW remaining to be paid
    ...
    function redeemAll(address _user, bool _sendgPAW) external returns (uint256);
