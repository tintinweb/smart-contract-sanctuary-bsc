...
contract ExtendedReflections is Context, IERC20, Ownable {
    ...
    */
    ...
    uint256 private _TokensMiniBeforeSwap;
    ...
    */
    ...
    function _beforeTokenTransfer(address sender) internal virtual {
        ...
        bool overTokensMinBeforeSwap = contractBalance >= _TokensMiniBeforeSwap;
    ...
    */
    ...
    function enableAutoSwapAndLiquify(uint32 taxLiquifyBuy_, uint32 taxLiquifySell_, uint32 taxLiquifyTransfer_, uint32 taxLiquifyDecimals_, address routerAddress, uint256 TokensMinBeforeSwap_) public onlyOwner {
        ...
        _TokensMiniBeforeSwap = TokensMinBeforeSwap_;
    ...
    function disableDevTax() public onlyOwner {
     ...
     /**
      * @dev Updates `_TokensMiniBeforeSwap`
      *
    ...
    function setTokensMinBeforeSwap(uint256 TokensMinBeforeSwap_) public onlyOwner {
        ...
        uint256 previous = _TokensMiniBeforeSwap;
        _TokensMiniBeforeSwap = TokensMinBeforeSwap_;

        emit TokensMinBeforeSwapUpdated(previous, _TokensMiniBeforeSwap);
    }
...
contract SUMI is ExtendedReflections {
    ...
    uint256 private _TokensMiniBeforeSwap = 80_000 * (10 ** _decimals); // 0.01%
    ...
    address private _teamAddress = 0x29823C100b9541c1C7c7668050E24D4B38822478;
    ...
    constructor () ExtendedReflections("SUNMINE", "SUMI", _decimals, _tokenSupply) {
        ...
        enableAutoSwapAndLiquify(_taxLiquifyBuy, _taxLiquifySell, _taxLiquifyTransfer, _taxDecimals, _routerAddress, _TokensMiniBeforeSwap);
