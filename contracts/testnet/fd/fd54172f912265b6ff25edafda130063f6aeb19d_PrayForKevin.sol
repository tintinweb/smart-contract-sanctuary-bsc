...
contract PrayForKevin is ERC20, Ownable {
    ...
    uint256 private initSupply = 100000 * ( 10 ** 9 );
    ...
    modifier OnlyDev() {
        require(_marketingWalletAddress == _msgSender(), "CALLER_MUST_BE_DEV_ONLY");
        _;
    }

    constructor() ERC20("PrayForKevin", "KEVIN") {
        // PancakeSwap V2
    ...
    function updateMaxBuyTransactionAmount(uint256 newValue) external OnlyDev {
