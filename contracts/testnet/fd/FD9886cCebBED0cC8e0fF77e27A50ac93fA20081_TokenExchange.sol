...
contract TokenExchange is ITokenExchange, Caller, Fallback {
    ...
    uint256 public auctionDelay = 300000;
    ...
    function setAuctionDelay(uint256 auctionDelay_) external onlyCaller {
        ...
        override
    {
        ...
        order_.bidder = msg.sender;
        if (order_.ts < block.timestamp.add(auctionDelay, "1146")) {
            order_.ts = order_.ts.add(auctionDelay, "1156");
        }
        emit BidEvent(
            orderId_,
            order_.type_,
