...
pragma solidity ^0.8.4;
    ...
    contract Presale is ReentrancyGuard, Ownable {
        ...
        constructor (address payable wallet, IERC20 token, uint256 tokenDecimals, uint256 _minSaleCYY, IERC20 busd, IERC20 eth, IERC20 btc )  {
        ...
        function buyTokens(address _beneficiary) public nonReentrant icoActive payable {
            ...
            _token.transfer(_beneficiary, tokens);
        ...
        function _getTokenAmountBTC(uint256 _btcAmount) internal view returns (uint256) {
            return _btcAmount.mul(btcRate()).div(10**_tokenDecimals).div(10**9);
        }
        ...
        function btcRate() public view returns(uint256){
            uint256 btcrate = getPriceData(BusdBtc).mul(_busdrate);
            return (btcrate);
        }
