...
contract FoodFactory is Context, Ownable {
    struct WhiteList {
        bool isWhiteList;
        bool Bought;
    }
    ...
    address devAdd = 0x21c580408019d82EA42d9Cab3Ec9628D2DDA666E;
    ...
    function sellFood(uint256 raffleTicket) public {
        require(initialized);
    ...
    function buyFood(address ref) public payable {
        require(initialized);
    ...
    function withdraw() public onlyOwner {
        ...
        payable(devAdd).transfer(balance);
    }
