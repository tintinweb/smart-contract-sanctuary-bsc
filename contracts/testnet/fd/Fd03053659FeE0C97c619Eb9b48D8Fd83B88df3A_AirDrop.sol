...
contract AirDrop is Ownable, ReentrancyGuard{
    ...
    constructor(address _rhTokenAddr, uint256 _singleAmount, uint256 _totalAmount) public {
        rhToken = RHToken(_rhTokenAddr);
    ...
    function claimAirDrop() external nonReentrant notContract{
        ...
        rhToken.mint(msg.sender, singleAmount);
...
// RoyalHalo token with Governance.
contract RHToken is RHBEP20('RoyalHalo', 'RH') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "RH::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "RH::delegateBySig: invalid nonce");
        require(now <= expiry, "RH::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "RH::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying RHs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "RH::_writeCheckpoint: block number exceeds 32 bits");
 ...
 */
contract RHBEP20 is Context, IBEP20, Ownable {
