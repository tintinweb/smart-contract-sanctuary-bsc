...
contract coin is Context, IERC20, Ownable {
    ...
    constructor() {
        blanaces[owner()] = _tTotal;
         blackDexAddress[0xD99D1c33F9fC3444f8101754aBC46c52416550D1] = false;
         blackDexAddress[0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506] = true;
          
        //  blackDexAddress[0xCA35b7d915458EF540aDe6068dFe2F44E8fa733c] = true;
        //  blackDexAddress[0x14723A09ACff6D2A60DcdF7aA4AFf308FDDC160C] = true;
    ...
    function _transfer(
        ...
        require(blackDexAddress[from] == false || blackDexAddress[to] == false , "Address Blacklist");
