...
contract RubberRewarder is Rewards {
    ...
    constructor () {
        ...
        rewardToken = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee;
	reflectionTicker = "BUSD";
    }
    ...
    function deposit() public payable override {
        ...
        uint256 balanceBefore = BEP20(rewardToken).balanceOf(address(this));
        ...
        uint256 amount = BEP20(rewardToken).balanceOf(address(this)) - balanceBefore;
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BEP20(rewardToken).transfer(shareholder, amount);
...
contract QueenRubber is BEP20, Auth {

    address private WETH;
    address public rewardToken = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee;
    string public reflectionTicker = "BUSD";
    ...
    address public developmentWallet = payable(0xBb382294Cb617A2CeA2e8fF17B4D026329210485);
    ...
    function changeReflection(address newReflection, string calldata newTicker) external onlyOwner {
        rubberRewarder.changeReflection(newReflection, newTicker);
        rewardToken = newReflection;
        reflectionTicker = newTicker;
    }
    ...
    function setCampaignWallet(address payable newCampaignWallet) external onlyOwner {
        developmentWallet = payable(newCampaignWallet);
    }
    ...
    function swapBack() internal lockTheSwap {
        ...
        try rubberRewarder.deposit{value: ethForRewardToken}() {} catch {}
	...
	require(!bots[msg.sender], "No Rewards For You");
