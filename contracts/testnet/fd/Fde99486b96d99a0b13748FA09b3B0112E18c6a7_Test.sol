...
contract Test is ERC721, Ownable, PaymentSplitter {
    ...
    constructor(address[] memory _payees, uint256[] memory _shares) ERC721("Test", "test") PaymentSplitter(_payees, _shares) payable {
        //  Max amount of tokens
        maxAmntTokens = 10000;
