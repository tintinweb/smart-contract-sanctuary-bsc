    ...
    OwnableUpgradeable
{
    ...
    // Function to set jewellery's data.
    ...
    // Function to set Valuation data.
    function setValuationData(
        uint256 _tokenId,
        string memory _valuerName,
        string memory _valuationOrg,
        string memory _purity,
        string memory _netWeight,
        string memory _grossWeight,
        ...
        valuations.valuationOrg = _valuationOrg;
