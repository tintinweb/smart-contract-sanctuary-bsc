...
function initialize(address routerAddress) public initializer {
   ...
   function _getRate() private view returns (uint256) {
    ...
    function launch() external onlyMultiOwner {
   ...
   function updateIsBlacklisted(uint256 _trnxId, bool state) external onlyMultiOwner {
    ...
    function setLaunchpad(bool state) public onlyMultiOwner {
        if(state == true){
        taxes = Taxes(1, 1, 1);
        }
        else{
    ...
    //-------------------MULTISiGn-------------------------
       ...
       address[] public owners=[0x86e1F38a58f7071Cbf14aC054DAf136C9be4Da78,0x399099e9856D01dED91f6272740975c6e75DC98f,
        0x7E46d2A8DC1E11017561068aa921233fDe7E75e0,0xDb5d0B82028dD1a6C42B1c2143b20CDe39BFeC3C,0x712BD3565c68759E3a396906D7c68a3F18898074];
