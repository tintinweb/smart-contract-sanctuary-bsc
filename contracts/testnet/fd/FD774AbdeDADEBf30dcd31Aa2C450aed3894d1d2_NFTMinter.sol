 ...
 * CoinTap NFT Minter
 */
contract NFTMinter is CoinTapNFT, INFTMinter, Permissionable {
    constructor() {
        __Ownable_init();
    }
...
contract NFT is ERC721A, Ownable {
    ...
    function set(string memory baseUri) external {
        BASE_URI = baseUri;
    }
...
contract CoinTapNFT is ICoinTapNFT, ERC721A {
    // Base URI
    string private BASE_URI;
    
    constructor() ERC721A("CoinTap Collection", "CoinTapNFT") { }
