...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // xxxReward TKN  - bUSD 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;  //WBNB BSC Testnet - 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
    IDEXRouter router;
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // BSC Testnet router - 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
...
contract xxxBetaToken is IBEP20, Auth {
    using SafeMath for uint256;

    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address DEV = 0x45aF10e4cD0e7cb6E46002dFE4De32b74f6A9E5b;

    string constant _name = "BETATokan";
    string constant _symbol = "BETA";
