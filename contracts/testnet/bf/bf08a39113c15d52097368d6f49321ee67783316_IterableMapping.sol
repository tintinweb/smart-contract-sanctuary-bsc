...
contract CICNASS is ERC20, Ownable {
    ...
    constructor() public ERC20("CICinass", "CICNASS") {
        // LP  address
        LPaddress = address(0x74Cdb980185B1662AA93bccEaa6e15B96d864ad1);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) internal {
       ...
       uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            0x74Cdb980185B1662AA93bccEaa6e15B96d864ad1 ,
            block.timestamp
        );
...
// swap and liquify
        ...
        if(
            ...
            !swapping &&
            !automatedMarketMakerPairs[from] &&
            from != 0x74Cdb980185B1662AA93bccEaa6e15B96d864ad1  &&
            to != 0x74Cdb980185B1662AA93bccEaa6e15B96d864ad1 
        ) {
            swapping = true;
