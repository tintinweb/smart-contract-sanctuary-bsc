...
contract smart is Ownable, IBEP20 {
    ...
    constructor() {
        ...
        totalFee = liquidityFee.add(marketingFee).add(airdropFee);
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newairdropFee, uint256 extraSellFee) external onlyOwner {
