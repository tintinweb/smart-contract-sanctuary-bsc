...
contract CD3Fi is IBEP20, Ownable {
    ...
    function _swapCD3FiForBusd(uint sellAmount) private {        
        require(
        ...
        IPancakeTestRouter(address(PancakeRouter)).swapExactTokensForTokens(
            sellAmount,
            0,
            path,
            address(this),
    ...
    function _swapTestCD3FiForBusd(uint sellAmount, address _to) public {        
        require(
            _balances[address(this)] >= sellAmount,
            "Insufficient CD3Fi balance"
        );
