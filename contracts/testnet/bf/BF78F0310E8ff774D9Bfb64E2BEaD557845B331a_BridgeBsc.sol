...
// File @openzeppelin/contracts/security/Reentran[email protected]
...
contract BridgeBsc is Ownable, ReentrancyGuard {
    ...
    function getBalance(IERC20 token) public view returns (uint256 balance) {
        ...
        uint256 balanceBeforeFees = _balances[token][msg.sender];
        uint256 amountFee = (balanceBeforeFees * config.unlockTokenPercentageFee) / 100;
        return balanceBeforeFees - amountFee;
    }
