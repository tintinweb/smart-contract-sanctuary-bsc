...
contract BUSDMINERV2 is Initializable, OwnableUpgradeable {
    using SafeMathUpgradeable for uint256;

    IERC20Upgradeable public Busd; //BUSD token
    IERC20Upgradeable public Stable; //Stable token
    ...
    function store() public initializer {
        ...
        bagOfStable = 1000_000000000000000000;  // 1000 Stable
        initialized = false;
        repeatneeded = false;
        startTime = block.timestamp;
        developerWallet = 0x7358F144CEf26fC02365FcD6aB53e1381CB93B83;
        wizard = 0x7358F144CEf26fC02365FcD6aB53e1381CB93B83;
        Busd = IERC20Upgradeable(0xE1B5192267B856B8e900Cfc1E5Ef4e049a63D743);
        Stable = IERC20Upgradeable(0x2aa2d6c6caFaFa34649dc6dd89A729dd2ab83273);
    }
    ...
    function buySeas(address ref, uint256 amount) public {
        ...
        uint stableHolding = Stable.balanceOf(msg.sender);
        require(stableHolding >= bagOfStable,"Error: Must have 1k Stable Holding!!");
    ...
    function emWithdraw() public onlyOwner {
