...
contract ArtForestry is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    mapping(address => bool) public minted;
       ...
       constructor() ERC721("Art Forestry", "ART") {}
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        require(minted[msg.sender] == false, "Wallet has already minted a ART");
