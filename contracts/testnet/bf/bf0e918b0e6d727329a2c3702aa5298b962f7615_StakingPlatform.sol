...
/// @author Chinese Zodiac Developer
...
contract StakingPlatform is IStakingPlatform, Ownable {
    ...
    uint256 public claimRewardsFee = 500;
    // claimRewards fee 10%

    uint256 public claimRewardsInterval = 1 hours;
    // Max claimRewards interval: 7 days.
    uint256 public constant MAXIMUM_claimRewards_INTERVAL = 36500 days;
    ...
    event claimRewardsFeeUpdated(uint256 value);
    event TreasuryUpdated(address value);
    event FeeTreasuryUpdated(address value);
    event FixedAPYUpdate(uint8 value);
    ...
    function setFeeTreasury(address _feeTreasury) public onlyOwner {
        ...
        function setfixedAPY(uint8 _fixedAPY) public onlyOwner {
        FixedAPY = _fixedAPY;
        emit FixedAPYUpdate(_fixedAPY);
    }
