...
contract IslandGirlStaking is ERC20, Ownable {
    ...
    function deposit(uint256 _amount, uint256 _option) public {
        ...
        // }
        // acceptedToken.approve(address(this), _amount);
    ...
    function withdraw() public {
        ...
        acceptedToken.safeTransfer(msg.sender, userBalance);
