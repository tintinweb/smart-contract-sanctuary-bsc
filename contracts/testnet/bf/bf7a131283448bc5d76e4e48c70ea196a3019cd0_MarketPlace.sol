...
contract MarketPlace is Auth, PausableUpgradeable {
  ...
  uint public discount; // decimal 3
  ...
  function setContracts(address _heroNft, address _itemNft, address _treasury, address _fotaToken, address _busdToken, address _usdtToken, address _fotaPricer, address _citizen, address _gameProxyContract, address _eatherTransporter) external onlyMainAdmin {
