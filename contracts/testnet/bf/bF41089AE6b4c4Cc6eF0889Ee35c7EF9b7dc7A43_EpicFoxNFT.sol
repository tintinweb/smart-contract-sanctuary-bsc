...
contract EpicFoxNFT is ERC721Enumerable, Ownable, Guard, RI, Withdrawable {
    ...
    constructor(address riAddress_) ERC721("Epic Fox NFT V1", "EFOX V1")
    {
        royaltyAddress = riAddress_;

        string memory baseTokenURI = "https://legendaryfox.io/meta/efox/";
        string memory baseContractURI = "https://legendaryfox.io/meta/efox/main.json";
