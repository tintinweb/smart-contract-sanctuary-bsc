...
contract SmartWallet is DecimalERC20, Initializable, ISmartWallet, Pausable {
    ...
    event ExecuteClosePartialPosition(
        address indexed trader,
    ...
    function executeClosePartialPosition(
        ...
        emit ExecuteClosePartialPosition(owner, _percentage, address(_asset));
  ...
  */
    ...
    function _handleClosePositionWithApproval(
        ...
        clearingHouse.closePartialPosition(_asset, _percentage, _slippage);
    }
