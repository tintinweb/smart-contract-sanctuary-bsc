...
contract Locker is Ownable {
    ...
    function lockTokens(
        ...
        lockedToken[_tokenType][_tokenAddress].cumSum.add(lockAmount);
    ...
    function withdrawTokens(uint256 _id, Tokentype _tokenType, address _tokenAddress) external {
        ...
        address withdrawalAddress = item.withdrawalAddress;
