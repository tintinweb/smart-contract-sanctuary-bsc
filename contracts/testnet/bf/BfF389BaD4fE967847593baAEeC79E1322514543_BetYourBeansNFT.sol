...
contract BetYourBeansNFT is ERC1155Supply, Ownable, AccessControl {
    ...
    constructor() ERC1155("https://storageapi2.fleek.co/{id}") {
        ...
        _mint(address(sale), 1, 50, ""); sale.supply(1, 50);
        _mint(address(sale), 2, 50, ""); sale.supply(2, 50);
        _mint(address(sale), 3, 50, ""); sale.supply(3, 50);
        _mint(address(sale), 4, 50, ""); sale.supply(4, 50);
