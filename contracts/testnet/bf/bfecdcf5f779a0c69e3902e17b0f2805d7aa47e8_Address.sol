...
contract ethfly is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ethfly";
    
    string private _symbol = "ethfly";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xB40a439DA58f47272ae6bd850AeDC2D2Cfc6a24f); 
    address payable public BurnedWalletAddress = payable(0xB40a439DA58f47272ae6bd850AeDC2D2Cfc6a24f); 
