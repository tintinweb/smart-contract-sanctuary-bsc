...
// File: contracts/ponto/Monero.sol
...
contract Monero is Ownable, ERC20 {
    ...
    event Released(uint256 amount, string recipient);
    ...
    function release(uint256 amount, string memory recipient) public {
        _burn(msg.sender, amount);
        emit Released(amount, recipient);
    }
}