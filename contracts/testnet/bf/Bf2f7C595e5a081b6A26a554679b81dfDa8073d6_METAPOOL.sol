...
contract METAPOOL is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20("METAPOOL", "MTP") {
        ...
        busd = IERC20(address(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee)); //TODO
        holder = _msgSender();
    ...
    function _beforeTokenTransfer(
        ...
        // If the recipient is a "Holder" contract , then unfreeze the tokens
        if (to == holder) {
    ...
    function _afterTokenTransfer(
        ...
        // If the balance of the "Holder" contract is replenished by the manager,
        // means funds will not be blocked
        if (to == holder && _msgSender() != management) {
            // Any other transfer to the "Holder" contract address blocks the funds for a year
