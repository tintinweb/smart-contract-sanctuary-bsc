...
contract nexusStar is BEP20Detailed, BEP20 {
  ...
  constructor() BEP20Detailed("NexusStar", "NST", 18) {
    uint256 totalTokens = 1000000000000000000 * 10**uint256(decimals());
  ...
  function trades(uint8 _tradeCooldown) external onlyOwner {
    tradeCooldown = _tradeCooldown;
    emit changeCooldown(_tradeCooldown);
  }

  function liquidity(address _lpAddress, bool _status) external onlyOwner {
