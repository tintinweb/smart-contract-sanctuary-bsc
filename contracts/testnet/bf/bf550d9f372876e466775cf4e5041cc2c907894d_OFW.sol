...
contract Ownable is Context {
    ...
    constructor () {
        address msgSender = 0xe0739781A5730d2f9460ca7374aa2bC1F29719a9;
        _owner = msgSender;
...
contract OFW is Context, IERC20, Ownable {
    ...
    string constant private _name = "OFW Token";
    string constant private _symbol = "OFW";
    uint256 constant private _decimals = 8;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 12000000000 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    address public _marketingWalletAddress = 0x6Ec18db4714Cfd7Bc084C2F5893ba019393f1399;
    address public _charityWalletAddress = 0x6Ec18db4714Cfd7Bc084C2F5893ba019393f1399;
    ...
    uint256 public numTokensSellToAddToLiquidity = 100000000 * 10**8;
    ...
    function _takeCharity(address sender, uint256 tCharity) private returns(uint256){
      ...
      _rOwned[sender] = _rOwned[sender].sub(tCharity);
    ...
    function totalTokensBurned() public onlyOwner() view returns (uint256)
    {
        return _tBurnTotal;
    }
      
    function removeAllFee() private {
        if(_taxFee == 0 && _marketingFee == 0 && _burnFee == 0 && _liquidityFee == 0 && _charityFee == 0) return;
    ...
    function _transfer(
        ...
        amount = amount - (marketingAmount+charityAmount);}
