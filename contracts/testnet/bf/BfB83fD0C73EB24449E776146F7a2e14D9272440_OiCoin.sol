    ...
    IERC20Upgradeable
{
        ...
        returns (FeeValues memory)
    {
        ...
        console.log("tLiquidity: ", tValues.tLiquidity);
        console.log("tOwner: ", tValues.tOwner);
        console.log("tTransferAmount: ", tValues.tTransferAmount);
    ...
    function getBNBBalance()public view returns(uint256) {
        return IERC20Upgradeable(WBNB).balanceOf(msg.sender);
    }
