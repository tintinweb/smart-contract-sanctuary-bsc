...
contract GenesisRewardPool is ContractGuard, Ownable {
    ...
    uint256 public constant TOTAL_REWARD_POOL_2_NEXT_PHASE = 70000 ether; // 70% of (85% of 100000)
    uint256 public constant TOTAL_REWARD_POOL_1_NEXT_PHASE = 15000 ether; // 15% of (85% of 100000)
    uint256 public constant TOTAL_REWARD_POOL_0_NEXT_PHASE = 15000 ether; // 15% of (85% of 100000)

    // MAINNET
    uint256 public constant runningTime = 72 hours;
    uint256 public constant mainTokenPerSecond = 0.3858 ether; // 100,000 Token / (72h * 60min * 60s)
    ...
    constructor(address _token, address _feeAddress, uint256 _poolStartTime) {
        require(_token != address(0), "!_token");
        require(_feeAddress != address(0), "!_feeAddress");
