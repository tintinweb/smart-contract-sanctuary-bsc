...
contract OmiInu is ERC20Detailed, Ownable {
    ...
    function rebase() internal {
        ...
        uint rebaseRate = 395600 * 10**18; // 0.03956
        uint hourRebaseRate = 791500 * 10**18;   // 0.07915 %
        uint dayRebaseRate = 9170000 * 10**18;  // 1.917 %

        uint blockCount = block.timestamp.sub(_lastRebasedTime);
