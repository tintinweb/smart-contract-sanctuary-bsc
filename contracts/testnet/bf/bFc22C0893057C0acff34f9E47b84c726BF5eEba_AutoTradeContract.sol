...
contract AutoTradeContract {
    ...
    function buyPLOT(uint amount, address to) public returns (uint[] memory amounts){
    ...
    function sellPLOT(uint amount, address to) public returns (uint[] memory amounts){
        address[] memory path = new address[](2);
        path[0] = 0xd7803dE72362e1443709C01899BE4c9b0E457376;
        path[1] = 0xfAFF90d6e743E528E77e2Bb7881dAbc34A62103F;
        lastTradingTime = block.timestamp;
        return router.swapExactTokensForTokens(amount, 0, path, to, block.timestamp);
    }

    function withdrawBUSD(uint amount) public {
        ERC20Detailed(0xfAFF90d6e743E528E77e2Bb7881dAbc34A62103F).transfer(msg.sender, amount);
    }

    function withdrawPLOT(uint amount) public {
        ERC20Detailed(0xd7803dE72362e1443709C01899BE4c9b0E457376).transfer(msg.sender, amount);
    }
    ...
    function setTradingPeriod(uint256 forMinutes) public {
