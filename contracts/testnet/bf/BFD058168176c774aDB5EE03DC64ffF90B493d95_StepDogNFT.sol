...
contract StepDogNFT is Initializable, ERC721Upgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public {
        __ERC721_init("StepDogNFT", "StepDogNFT");
        __Ownable_init();
        testVar = 5;
        anotherTestVar = 123;
    }
    ...
    function mint(address _to) external payable {
        dogs.push(Dog("qwerty", block.timestamp, 0, 0, 123, 0, 0));

        anotherTestVar = anotherTestVar.add(1);
        _safeMint(_to, dogs.length - 1);
    }
