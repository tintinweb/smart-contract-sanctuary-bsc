...
contract SamoyedVaultHelper is ReentrancyGuard, IVaultHelper {
    ...
    constructor(
        ...
        // TODO: un-comment this code when deploy mainnet
    ...
    function _depositPrizeFromWETH(
        ...
        (ISamoyedVault _vault, ) = _getVaultPair(vault);
        ...
        for (uint256 i; i < tokens.length; i++) {
            ...
            if (balance > 0) {
                if (tokens[i] == address(WETH)) {
                    // TODO: Toggle this code when deploy mainnet
