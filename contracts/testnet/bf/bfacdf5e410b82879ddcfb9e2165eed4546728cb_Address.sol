...
contract Staking is Ownable, ReentrancyGuard {
    ...
    function initialize(
        ...
        lockups.push(Lockup(1, 30, 0, 0, 2500, 0, 0, 0, 0, 0));
        lockups.push(Lockup(2, 90, 0, 0, 4000, 0, 0, 0, 0, 0));
        lockups.push(Lockup(3, 180, 0, 0, 5000, 0, 0, 0, 0, 0));
        lockups.push(Lockup(4, 360, 0, 0, 6000, 0, 0, 0, 0, 0));
