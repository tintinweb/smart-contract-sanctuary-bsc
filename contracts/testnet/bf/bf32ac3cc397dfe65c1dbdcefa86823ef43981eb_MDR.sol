...
contract MDR is Context, IBEP20, Ownable{
    ...
    address public burnAddr = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
    ...
    function mint(address receiver, uint256 amount) public onlyOwner{
        ...
        if(receiver == burnAddr){
            _totalBurned = _totalBurned.add(amount);
        }
    }

    function burn(address account, uint256 amount) public onlyOwner{
        uint256 _accountbBalance = balanceOf(account);
        require(_accountbBalance >= amount, "MDR: Don't have enough MDR to burn");
    ...
    function updateBurnAddr(address _burnAddr) public onlyOwner {
        burnAddr = _burnAddr;
    }
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        if(isTranferBurnedEnabled){
            ...
            _transferBothExcluded(_msgSender(), burnAddr, burnAmount);
            //  _tOwned[burnAddr] = _tOwned[burnAddr].add(burnAmount);
            //  _rOwned[burnAddr] = _rOwned[burnAddr].add(burnAmount);
            _totalBurned = _totalBurned + burnAmount;
        }
