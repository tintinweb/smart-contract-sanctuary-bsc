    ...
    Ownable
{
        ...
        onlyOwner
    {
        require(
            ...
            "ALTEST: The router already has that address"
        );
...
contract ALTest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ALTestDividendTracker public dividendTracker;
    ...
    constructor() ERC20("ALTest", "ALTS", 9) {
        dividendTracker = new ALTestDividendTracker();
        ...
        onlyOwner
    {
        require(
            ...
            "ALTEST: setWhiteListAMM:: AMM is a wallet, not a contract"
        );
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "ALTEST: The dividend tracker already has that address"
        );

        ALTestDividendTracker newDividendTracker = ALTestDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "ALTEST: The new dividend tracker must be owned by the ALTEST token contract"
        );
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "ALTEST: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function airdropToWallets(
        ...
        require(
            ...
            "ALTEST: airdropToWallets:: Arrays must be the same length"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "ALTEST: The liquidity wallet is already this address"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "ALTEST: The operations wallet is already this address"
        );
        ...
        onlyOwner
    {
        require(
            ...
            "ALTEST: The migration swap contract is already this address"
        );
    ...
    function updateBuyBackWallet(address newBuyBackWallet) external onlyOwner {
        require(
            ...
            "ALTEST: The buyback wallet is already this address"
        );
    ...
    function updateFees(
        ...
        require(
            ...
            "ALTEST: updateFees:: Liquidity Perc must be equal to or higher than operations and buyback combined."
        );
        emit FeesUpdated(
            bnbRewardPerc,
            liquidityPerc,
    ...
    function updateGasForProcessing(uint256 newValue) external onlyOwner {
        require(
            ...
            "ALTEST: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "ALTEST: Cannot update gasForProcessing to same value"
        );
    ...
    function setRewardToken(address rewardTokenAddress) public returns (bool) {
        require(
            ...
            "ALTEST: setRewardToken:: Address is a wallet, not a contract."
        );
        require(
            rewardTokenAddress != address(this),
            "ALTEST: setRewardToken:: Cannot set reward token as this token due to Router limitations."
        );
        require(
            !isBlacklistedToken(rewardTokenAddress),
            "ALTEST: setRewardToken:: Reward Token is blacklisted from being used as rewards."
        );
    ...
    function setRewardTokenWithCustomAMM(
        ...
        require(
            ammContractAddress != address(uniswapV2Router),
            "ALTEST: setRewardToken:: Use setRewardToken to use default Router"
        );
        require(
            rewardTokenAddress != address(this),
            "ALTEST: setRewardToken:: Cannot set reward token as this token due to Router limitations."
        ...
        require(
            ...
            "ALTEST: setRewardToken:: AMM is not whitelisted!"
        );
        dividendTracker.setRewardToken(
            msg.sender,
            rewardTokenAddress,
    ...
    function buyBackTokensWithNoFees() external payable returns (bool) {
        ...
        require(
            ...
            "ALTEST: buyBackTokensWithNoFees:: Cannot Spend more than earned."
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "ALTEST: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function swapAndLiquify(uint256 tokens) private {
        if (liquidityFee > 0) {
            ...
            if (operationsFee > 0) {
                ...
                require(
                    success,
                    "ALTEST: SwapAndLiquify:: Unable to send BNB to Operations Wallet"
                );
            }
            ...
            if (buyBackFee > 0) {
                ...
                require(
                    success,
                    "ALTEST: SwapAndLiquify:: Unable to send BNB to BuyBack Wallet"
                );
            }
...
contract ALTestDividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    function _transfer(
        ...
        require(false, "ALTest_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "ALTest_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ALTEST contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "ALTest_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "ALTest_Dividend_Tracker: Cannot update claimWait to same value"
        );
