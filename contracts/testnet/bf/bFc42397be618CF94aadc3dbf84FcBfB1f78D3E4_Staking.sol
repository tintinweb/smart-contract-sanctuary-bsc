...
contract Staking {
    ...
    uint256[4] stakingRates = [9, 8, 7, 6];
    uint256[4] stakingPeriod = [360 days, 180 days, 90 days, 45 days];
    uint256 rewardDelay = 15 days;
    ...
    function stake(uint256 tokenId, uint256 category) public {
        ...
        emit TokenStaked(msg.sender, tokenId, stakingRates[category], block.timestamp + stakingPeriod[category]);
    }
