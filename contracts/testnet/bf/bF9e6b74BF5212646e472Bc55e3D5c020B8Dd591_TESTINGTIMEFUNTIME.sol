...
interface Cashier {
    ...
    function checkToken(address token) external view returns (bool, address);
    function getUserReflectingToken(address account) external view returns(address);
}

contract TESTINGTIMEFUNTIME is IERC20 {
    ...
    string constant private _name = "TESTING TIME FUNTIME";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        ...
        rebaseTreasury: payable(0xEd56a7F78b830518ff00808e2bAff0F4bDc722Ed),
...
//===============================================================================================================
    ...
    function enableTrading() public onlyOwner {
        ...
        _isExcludedFromDividends[address(reflector)] = true;
        _isExcludedFromFees[address(reflector)] = true;
        _isExcludedFromLimits[address(reflector)] = true;
        tradingEnabled = true;
    ...
    function setRatios(uint16 rewards, uint16 liquidity, uint16 marketing, uint16 rebaseTreasury, uint16 dev) external onlyOwner {
    ...
    function setWallets(address payable marketing, address payable node) external onlyOwner {
        ...
        _taxWallets.rebaseTreasury = payable(node);
    }
    ...
    function revertUserReflectingTokenToNative() external {
        reflector.setUserReflectingToken(msg.sender, dexRouter.WETH());
    }
