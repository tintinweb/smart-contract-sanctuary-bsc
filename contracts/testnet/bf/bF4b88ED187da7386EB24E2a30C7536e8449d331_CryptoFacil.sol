...
contract CryptoFacil is Ownable {
    ...
    function comprarCartela() public payable {
        ...
        uint256 valorPosDistribuicao = distribuirValores(msg.sender, msg.value);
    ...
    function distribuirValores(address carteiraInicial, uint256 valor)
        internal
        returns (uint256)
    {
        address carteiraParaConsultar = carteiraInicial;
    ...
    function alterarValorCartela(uint256 valorCartela_) public onlyOwner {
        valorCartela = valorCartela_;
    }
    ...
    function iniciaRodada() public onlyOwner {
    ...
    function finalizaRodada() public onlyOwner {
        require(jogoIniciado, "O jogo nao esta iniciado");
        jogoIniciado = false;
    }
    ...
    function sacarValorDisponivel() public {
