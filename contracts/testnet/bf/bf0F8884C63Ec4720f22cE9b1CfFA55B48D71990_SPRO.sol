...
contract SPRO is IERC20, Ownable {
    ...
    string constant _name = "Staking Pro";
    ...
    address public treasuryFeeWallet =
        0x31e0fadD311c26D1B2Ef645533CC03ebd27846Fd;
    ...
    function swapBack() internal swapping {
        ...
        uint256 busdForInsurance = swappedBusd.mul(insuranceSwap).div(
            insuranceSwap.add(treasurySwap)
        );
        uint256 busdForTreasury = swappedBusd.sub(busdForInsurance);
