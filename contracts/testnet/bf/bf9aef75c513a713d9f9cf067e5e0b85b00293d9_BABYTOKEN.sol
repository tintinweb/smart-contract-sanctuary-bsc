...
contract BABYTOKEN is ERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        address[5] memory addrs, // reward, router, marketing wallet, dividendTracker, usdt
        ...
        uint256 minimumTokenBalanceForDividends = minimumTokenBalanceForDividends_ * (10**18);
