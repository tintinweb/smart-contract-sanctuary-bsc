...
// SPDX-License-Identifier: HASHDEV LTD
...
/**
   ...
   * @author Hashdev
   */
contract MartinBettingVault {
    // Address of martin betting vault owner
    address public owner;

    // Address of martin betting vault admin
    ...
    /**
	   * @dev Creates/deploys Martin betting vault by Hashdev Version 1.0
	   *
	   * @param owner_ address of Martin betting owner
	   * @param admin_ address of Martin admin
    ...
    constructor(address owner_, address admin_, address token_) {
        ...
        admin = admin_;
        tok = token_;
        DOMAIN_SEPARATOR = keccak256(abi.encode(DOMAIN_TYPEHASH, keccak256(bytes("MartinBettingVault")), block.chainid, address(this)));
    }
