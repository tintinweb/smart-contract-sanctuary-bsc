...
contract BabypinkMiddleware is ContextUpgradeable, OwnableUpgradeable {
    using SafeMath for uint256;
    using Address for address;
    ...
    function initialize(address payable _admin) public initializer {
        biswapfee = 100000000000000000;
        pancakefee = 250000000000000000;
        babypinkfee = 200000000000000000;
        ...
        babypinkrouter = 0x431328b03B2Fb571BFE5dDCbc401B89277767C3d;
    ...
    function swapExactTokensForETHMiddleware(
        ...
        calculation.fee = 0;
        if (router == babypinkrouter) {
            calculation.fee = sitefee.sub(babypinkfee);
    ...
    function swapExactTokensForTokensMiddleware(
        ...
        require(
            calculation.balance >= calculation.inputAmount,
            "Insufficient Balance"
        );
        uint256 allowanceBalance = tokenContract.allowance(
            msg.sender,
        ...
        require(
            allowanceBalance >= calculation.inputAmount,
            "Insufficient allowance"
        );
