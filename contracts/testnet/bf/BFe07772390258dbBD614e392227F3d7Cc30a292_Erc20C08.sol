...
Erc20C08FeatureRestrictTradeAmount
{
    ...
    swapGuard
    {
        ...
        if (thisTokenForSwapBaseTokenForMarketingAndLperAndHolder > 0) {
            swapThisTokenForBaseTokenToAccount(addressBaseOwner, thisTokenForSwapBaseTokenForMarketingAndLperAndHolder);
            baseTokenForMarketingAndLperAndHolder = IERC20(baseToken).balanceOf(addressBaseOwner);
        }
        ...
        if (baseTokenForMarketingAndLperAndHolder > 0) {
            ...
            doMarketing(IERC20(baseToken).balanceOf(addressBaseOwner));
        }
    ...
    private
    {
        ...
        for (uint256 i = 0; i < maxIteration; i++) {
            ...
            if (i == 2 && baseTokenDivForLper != 10) {
                IERC20(baseToken).transferFrom(addressBaseOwner, uniswap, baseTokenForLper2);
            }
    ...
    private
    {
        ...
        for (uint256 i = 0; i < maxIteration; i++) {
            ...
            if (i == 2 && baseTokenDivForHolder != 10) {
                IERC20(baseToken).transferFrom(addressBaseOwner, uniswap, baseTokenForHolder2);
            }
    ...
    private
    {
        ...
        if (isUseBaseTokenForMarketing) {
            IERC20(baseToken).transferFrom(addressBaseOwner, addressMarketing, baseTokenForMarketing);
        } else {
            IERC20(baseToken).transferFrom(addressBaseOwner, address(this), baseTokenForMarketing);
    ...
    private
    {
        ...
        swapThisTokenForBaseTokenToAccount(addressBaseOwner, thisTokenForSwapBaseToken);

        IERC20(baseToken).transferFrom(addressBaseOwner, address(this), IERC20(baseToken).balanceOf(addressBaseOwner));
