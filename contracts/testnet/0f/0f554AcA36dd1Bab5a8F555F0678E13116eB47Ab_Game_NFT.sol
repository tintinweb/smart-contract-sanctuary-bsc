...
contract Game_NFT is Ownable {
    ...
    function Add_Inviter(address inviter) public{   //////////////////////////1 метод
        ...
        my_referrals[inviter][1] = 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4;
    }
    ...
    */
    ...
    ////////////////3 метод///////////////
    function Check_AllZarabotok() public view returns(uint256) {
       return allZarabotok[msg.sender];
    }
    ...
    ////8 метод////
    function Reg_Time() external{
        time_registration[msg.sender] = block.timestamp;
    }

    ///8.2 метод
    function Check_Reg_Time() public view returns(uint256){
        return time_registration[msg.sender];
    }
