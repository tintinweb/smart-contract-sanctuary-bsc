...
contract PlearnNFTs is ERC721Enumerable, Ownable {
    ...
    constructor(
        ...
        uint256 _priceInPlearn
    ) ERC721(_name, _symbol) {
        currentTokenId = 0;
        maxSupply = _maxSupply;
        priceInPlearn = _priceInPlearn;
    ...
    function buyNFT() external {
        require(currentTokenId < maxSupply, "NFT: Total supply reached");

        // Transfer Plearn tokens to this contract
        plearnToken.safeTransferFrom(address(msg.sender), address(this), priceInPlearn);

        _mint(address(msg.sender), currentTokenId);
    ...
    function setNFTPrice(uint256 _priceInPlearn) external onlyOwner {
        priceInPlearn = _priceInPlearn;
    }
