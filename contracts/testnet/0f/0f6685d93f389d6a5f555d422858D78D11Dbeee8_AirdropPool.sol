...
contract AirdropPool is Ownable {
    ...
    struct UserInfo {
        ...
        //only user in list can get aridrop.
    struct AirdropList{
        address address0;
    ...
    /// @dev Maximum of total token airdrop per user.
    ...
    function airdrop() external {
        ...
        require(airdropList.address0 == msg.sender, "Pool: this user address not in airdrop list");
