...
contract TShare is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) public ERC20("TSHARE", "Tangerine Share") {
        _mint(msg.sender, 1 ether); // mint 1 TANGERINE Share for initial pools deployment
