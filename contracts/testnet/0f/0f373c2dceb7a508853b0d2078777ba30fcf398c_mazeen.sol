...
contract mazeen is Context, IERC20, Ownable {
    ...
    string private constant _name = "mzn INU";
    string private constant _symbol = "mbn";

    address public _PancakeSwapV1RouterUniswap = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //PancakeSwap owner
    address public _PancakeSwapV2RouterUniswap = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //can be the same
    ...
    constructor () {
      ...
      IUniswapV2Router02 _PancakeSwapV2Router = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // mainnet
        ...
        _isExcludedFromFee[address(0x5086365F66e3b1F0F18ed9EeB6eb47B0443d9276)] = true; //uniswap router liquidity
