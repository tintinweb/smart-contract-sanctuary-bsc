...
// File: contracts/CepanicaAI.sol

contract CepanicaAI is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("CepanicaAI", "PIXIA") {
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            _isExcludedFromFees[account] != excluded); //"CepanicaAI: Account is already excluded"
   ...
   function setWallets(address  _dev, address _int, address _treasury, address _staking ) external onlyOwner {
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "CepanicaAI: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor(address rewardToken)
        DividendPayingToken("CepanicaAI_Dividend_Tracker", "CepanicaAI_Dividend_Tracker", rewardToken)
    {
        claimWait = 3600;
