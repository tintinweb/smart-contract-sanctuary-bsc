...
// to get it back.
contract secondAdoptionAmplifer {
    ...
    function setPayDayAmount (uint256 unClaimedAmount) public isOwner {
        payDayAmount = payDayAmount + unClaimedAmount;
    }

    function getPayDayAmount () public view isOwner returns(uint256)  {
        return payDayAmount;
    }
