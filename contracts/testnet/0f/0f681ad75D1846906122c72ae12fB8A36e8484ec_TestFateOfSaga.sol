...
contract TestFateOfSaga is ERC20, ERC20Burnable,Ownable, Pausable, ERC20Permit, ERC20VotesComp, AccessControlEnumerable {
    ...
    function burnInPool_byCEOorCTO (uint256 _amount) external onlyRole(CEO_CTO_ROLE){
        _burn(owner(), _amount);
    }
