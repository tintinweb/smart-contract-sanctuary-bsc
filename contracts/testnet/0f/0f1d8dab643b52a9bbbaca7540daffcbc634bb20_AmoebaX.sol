...
contract AmoebaX {
    ...
    constructor() {
        owner = msg.sender;
        address2 = 0xF5132c5BCdC564b3548A0BE325ef8C158446ca6D;
    }
    ...
    function createAmoeba(address _ref) external payable onlyStartOpen {
        ...
        // dev fee
        (bool ownerSuccess, ) = owner.call{value: fee / 2}("");
        require(ownerSuccess, "owner pay failed");
        (bool address2Success, ) = address2.call{value: fee / 2}("");
    ...
    function divideAmoeba(address _ref) public onlyStartOpen {
        ...
        if (referrals[msg.sender] == owner) {
            claimedAmoeba[owner] += amoebaRebate / 2;
            claimedAmoeba[address2] += amoebaRebate / 2;
            tempClaimedAmoeba[owner] += amoebaRebate / 2;
            tempClaimedAmoeba[address2] += amoebaRebate / 2;
        } else {
