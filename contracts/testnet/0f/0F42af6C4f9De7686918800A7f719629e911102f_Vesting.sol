...
contract Vesting is Ownable{
    ...
    uint256 constant initialSupply = 500000000000000000000000000;  
    ...
    uint256 constant oneMouth = 2629743; // 1 month in seconds
    ...
    /// @dev the function for withdraw the team of their tokens must be called by the token holder at least once a month
     function withdrawalTeamShare() external{
        ...
        require(block.timestamp >= teamShares[tokenOwner].lastWithdraw + oneMouth, "A month of westing has not passed");
        ...
        uint256 vestingOneYear = teamShares[tokenOwner].releaseTime + 31556926;

         if(vestingOneYear < block.timestamp){
    ...
    function withdrawalAdvisorsShare() external{
        ...
        require(block.timestamp >= advisorsShares[tokenOwner].lastWithdraw + oneMouth, "A month of westing has not passed");
        ...
        uint256 vestingTwoYears = advisorsShares[tokenOwner].releaseTime + 63113852;

         if(vestingTwoYears < block.timestamp){
    ...
    function withdrawalSeedRoundShare() external {
        ...
        require(block.timestamp >= seedRoundsShares[tokenOwner].lastWithdraw + oneMouth, "A month of westing has not passed");
        ...
        uint256 vestingOneYear = seedRoundsShares[tokenOwner].releaseTime + 31556926;
    ...
    function withdrawalPrivateSaleShare() external {
        ...
        require(block.timestamp >= privateSalesShares[tokenOwner].lastWithdraw + oneMouth, "A month of westing has not passed");
        ...
        uint256 vestingSixMouth = privateSalesShares[tokenOwner].releaseTime + 15778458 + oneMouth;

         if(vestingSixMouth < block.timestamp){
    ...
    function withdrawalPublicSaleShare() external{
        ...
        require(block.timestamp >= publicSalesShares[tokenOwner].lastWithdraw + oneMouth, "A month of westing has not passed");
        ...
        uint256 threeMouths = publicSalesShares[tokenOwner].releaseTime + 7889229 + oneMouth;

         if(threeMouths < block.timestamp){
