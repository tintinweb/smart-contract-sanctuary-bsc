...
contract MiningCenter is ERC1155Holder {
        ...
        )
    {
        ...
        uint256 different = (block.timestamp -
            stakingHistory[stakingIndex].stakedTime) / 20 minutes;
    ...
    function unStakingPropertyIntern(
        ...
        ) = getExpetecInStakingReward(_owner, _nftNum, _nftType);
        ...
        // uint256 index = getHistoryIndex(_owner, _nftNum, _nftType);
