...
contract WVWToken is ERC20, ERC20Burnable, Ownable {
    ...
    event ChangeBlackList(address indexed newAddress, bool status);
    ...
    constructor(
        ...
        address[] memory blackListAddresses_
    ) ERC20("WVW Token", "WVW") {
        ...
        // Send list of Custom blacklist address
        for (uint256 i = 0; i < blackListAddresses_.length; i++) {
            _isBlacklisted[blackListAddresses_[i]] = true;
        }
    ...
    function _transfer(
        ...
        require(!_isBlacklisted[to], "This address was banned");
        require(!_isBlacklisted[from], "This address was banned");
    ...
    function setBlackListAddress(address _address, bool activate)
        external
        onlyOwner
    {
        _isBlacklisted[_address] = activate;
        emit ChangeBlackList(_address, activate);
    }

    function getBlackListAddress(address _address)
        external view
