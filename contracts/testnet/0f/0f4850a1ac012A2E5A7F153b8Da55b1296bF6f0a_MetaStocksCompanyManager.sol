    ...
    OwnableUpgradeable
{
    ...
    function createMetaStocksFranchiseUsingBNB() external payable {
        if (!ceos[msg.sender]) {
    ...
    function getMetaStocksFranchisesUnclaimedRewards(address account)
        external
        view
        returns (uint256)
    {
    ...
    function getMetaStocksFranchisesUnclaimedRewardsBNB(address account)
        external
        view
        returns (uint256)
    {
    ...
    function getCreateFranchisePriceBNB() external view returns (uint256) {
        return metaStocksFranchiseManager.getCreateFranchisePriceBNB();
    }

    function getNumberOfMetaStocksFranchises(address account)
        external
        view
        returns (uint256)
    {
        return
            metaStocksFranchiseManager.getNumberOfMetaStocksFranchises(
                this.getCompanyId(account)
            );
    }
}
