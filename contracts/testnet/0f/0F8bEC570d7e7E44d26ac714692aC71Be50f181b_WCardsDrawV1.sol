...
// File: contracts/wcardsGame/WcardDraw.sol
...
contract WCardsDrawV1 is VRFConsumerBaseV2, Ownable, Initializable {
    ...
    function setIsRelay (address _newRelay, bool value) external onlyOwner {
        isRelay[_newRelay] = value;
    }
