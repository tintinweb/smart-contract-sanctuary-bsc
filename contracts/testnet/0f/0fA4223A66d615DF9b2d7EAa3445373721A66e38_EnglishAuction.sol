    ...
    PriceGetter
{
    ...
    isWhitelisted(_erc20Token)
    {
        ...
        nftContractAuctions[_nftContractAddress][_tokenId]
            .bidIncreasePercentage = _getBidIncreasePercentage(_nftContractAddress, _tokenId);
        ...
        isAuctionNotStartedByOwner(_nftContractAddress, _tokenId)
    {
        ...
        if (_auctionBidPeriod != 0 && _bidIncreasePercentage == 0){
            if (_auctionBidPeriod == 345600){
                ...
                nftContractAuctions[_nftContractAddress][_tokenId]
                    .bidIncreasePercentage = defaultBidIncreasePercentage;
                uint256 price72 = (convertBnbUsd(price1));
                (bool success, ) = payable(address(this)).call{value:price72}("");
...
/*     event whitelistedToken(address indexed tokenaddressToWhitelist);
  ...
  function convertBnbUsd(uint _amountInUsd) public view returns (uint) {
    ...
    uint FinalPrice = ((_amountInUsd.mul(10 ** 26)).div(BnbUsd));
