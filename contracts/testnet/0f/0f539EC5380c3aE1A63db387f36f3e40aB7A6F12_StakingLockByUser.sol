...
contract StakingLockByUser is
    Ownable,
    ReentrancyGuard,
    ERC20("Token earn Token", "Token-Token")
{
    using SafeMath for uint256;

    // The address of the smart chef factory
    address public WCoin_CASTLE_FACTORY;
    ...
    constructor() public {
        WCoin_CASTLE_FACTORY = msg.sender;
    ...
    function initialize(
        ...
        require(msg.sender == WCoin_CASTLE_FACTORY, "Not factory");
        require(
