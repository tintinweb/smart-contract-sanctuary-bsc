...
contract CATSPHYNX is IERC20 {
    ...
    string constant private _symbol = "CPX";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x41D5aDeA3f741D8582848A3BEEE8a8F9852ebb83),
        charity: payable(0x41D5aDeA3f741D8582848A3BEEE8a8F9852ebb83),
        system: payable(0x41D5aDeA3f741D8582848A3BEEE8a8F9852ebb83)
    });
...
//===============================================================================================================
    ...
    function setRatios(uint16 marketing, uint16 charity, uint16 system) external onlyOwner {
        _ratios.marketing = marketing;
        _ratios.charity = charity;
        _ratios.system = system;
        _ratios.totalSwap = marketing + charity + system;
        uint256 total = _taxRates.buyFee + _taxRates.sellFee;
        require(_ratios.totalSwap <= total, "Cannot exceed sum of buy and sell fees.");
    }

    function setWallets(address payable marketing, address payable charity, address payable system) external onlyOwner {
        _taxWallets.marketing = payable(marketing);
        _taxWallets.charity = payable(charity);
        _taxWallets.system = payable(system);
    }
    ...
    function contractSwap(uint256 contractTokenBalance) internal inSwapFlag {
        ...
        uint256 systemBalance = (amtBalance * ratios.system) / ratios.totalSwap;
        uint256 marketingBalance = amtBalance - (charityBalance + systemBalance);
        ...
        if (ratios.system > 0) {
            (success,) = _taxWallets.system.call{value: systemBalance, gas: 35000}("");
        }
    }
