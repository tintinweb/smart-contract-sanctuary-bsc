...
contract WarBet is Ownable {
    ...
    WarcraftUniverseController  WUN;
    ...
    constructor() {
        ...
        WUN = WarcraftUniverseController(payable(WundWallet));
    ...
    function selectMonster(uint256 monsterID,uint256 heroId) public {
        ...
        SHE.transferFrom(msg.sender, address(WundWallet), amount* 10 **6);

        WUN.selectMonster(monsterID,heroId);
    }
}