...
contract BUSDLPBondDepository is Ownable {
    ...
    function deposit( 
        ...
        uint balanceBefore = Marshmallow.balanceOf(address(this));
        /**
            principle is transferred in
            approved and
            deposited into the treasury, returning (_amount - profit) Marshmallow
         */
        ...
        if ( fee != 0 ) { // fee is transferred to dao 
            Marshmallow.safeTransfer( DAO, fee ); 
        }
        require(balanceBefore.add(profit) == Marshmallow.balanceOf(address(this)), "Not enough Marshmallow to cover profit");
