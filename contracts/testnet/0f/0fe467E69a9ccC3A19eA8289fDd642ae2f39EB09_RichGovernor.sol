...
contract RichGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorVotes, GovernorVotesQuorumFraction, GovernorTimelockControl {
    constructor(IVotes _token, TimelockController _timelock)
        Governor("RichGovernor")
        GovernorSettings(6545 /* 1 day */, 45818 /* 1 week */, 1e18)
