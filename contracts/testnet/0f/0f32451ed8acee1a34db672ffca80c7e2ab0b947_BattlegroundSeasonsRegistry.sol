...
// File: axesBattlegroundSeasonsRegistry.sol
...
interface IBattlegroundSeasonsRegistry {
    ...
    */
    function createClaimRewardRequest(uint256 _seasonId, string memory _profile, address _sendTo) external payable;
    /**
...
contract BattlegroundSeasonsRegistry is IBattlegroundSeasonsRegistry, AccessControl {
    ...
    */
    function createClaimRewardRequest(uint256 _seasonId, string memory _profile, address _sendTo) external payable {
        ...
        require(msg.value >= claimRewardCommission, "Season: msg.value is less than claimRewardCommission");
