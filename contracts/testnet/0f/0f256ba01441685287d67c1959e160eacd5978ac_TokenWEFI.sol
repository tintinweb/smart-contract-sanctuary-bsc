...
contract TokenWEFI is IERC20, Ownable {
    ...
    address public _marketingWallet =
        0xDA616Cf8f1114dcC4acfb76Efc9b23DCF2DeB54a;

    // 10% buy/sell tax: (7% reflection to all holders, 1.5% auto LP, 1% buyback & burn, 0.5% marketing wallet)
    uint8 public reflectionFee = 70;
    uint8 public autoLPFee = 15;
    uint8 public buyBackFee = 10;
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 liquidityShare = (contractTokenBalance / total) * autoLPFee;
        uint256 buyBackShare = (contractTokenBalance / total) * buyBackFee;
    ...
    function _takeMarketing(uint256 tMarketing) private {
        uint256 currentRate = _getRate();
        uint256 rMarketing = tMarketing * currentRate;
        _rOwned[_marketingWallet] = _rOwned[_marketingWallet] + rMarketing;
        if (_isExcluded[_marketingWallet])
            _tOwned[_marketingWallet] = _tOwned[_marketingWallet] + tMarketing;
    }
    ...
    function setMinimumTokensBeforeSwap(uint256 newMinimumTokensBeforeSwap)
        external
        onlyOwner
    {
