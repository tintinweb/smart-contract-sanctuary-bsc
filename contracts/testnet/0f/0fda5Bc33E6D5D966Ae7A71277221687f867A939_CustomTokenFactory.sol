...
contract CustomTokenFactory {
    ...
    function createToken(
        ...
        string memory contractName = string(
            abi.encodePacked(yourTokenName, "BEP20")
        );

        ERC20MintableBurnable token = new ERC20MintableBurnable{
            salt: keccak256(abi.encodePacked(contractName))
        }(name, symbol, decimals, initialSupply, true);
