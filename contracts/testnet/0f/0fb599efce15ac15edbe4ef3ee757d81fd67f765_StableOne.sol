...
contract StableOne is ReentrancyGuard {
    ...
    uint256 private constant PRIMARY_BENIFICIARY_INVESTMENT_PERC = 80;
    uint256 private constant SECONDARY_BENIFICIARY_INVESTMENT_PERC = 20;
    uint256 private constant PRIMARY_BENIFICIARY_REINVESTMENT_PERC = 30;
    uint256 private constant SECONDARY_BENIFICIARY_REINVESTMENT_PERC = 10;
    uint256 private constant PLAN_TERM = 20 days;
    ...
    uint256 private constant MIN_WITHDRAW = 0.01 ether;
    ...
    function _invest(
        ...
        investors[_addr].lockedUntil = block.timestamp + 60 minutes; //5 days;
    ...
    function withdraw() public nonReentrant {
        ...
        require(
            ...
            "Cannot withdraw less than 0.01 BNB"
        );
         require(
            block.timestamp >= investors[msg.sender].lockedUntil,
            "Cannot withdraw before 5 days"
        );
        ...
        investors[msg.sender].lockedUntil = block.timestamp + 60 minutes; //5 days;
