...
contract WhaleInu is Context, IERC20, Ownable {
    ...
    // Initial setting to avoid bots pumping and dumping later!
    ...
    // Initial setting to punish jeets!
    // Note: Liquidity Fee shall be restored to 1% after 1 hour from launch.
    // Note: Marketing Fee shall be restored to 5% after 1 hour from launch.
    // Note: Team Fee shall be restored to 4% after 1 hour from launch.
