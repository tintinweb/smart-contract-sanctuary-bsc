...
contract RayMay is ERC20, Ownable {
    ...
    constructor (address newOwner ) payable ERC20("Ray","May",150_000_000)
    {   
        ...
        liquidityShare  = 50;
        marketingShare  = 50;
        marketingWallet = 0xcaA98CBaF47F8fB2b5e2f6add18c43bf7182516E;
    ...
    function setMaxTransactionRates_Denominator1000(uint256 _maxTransactionRateBuy, uint256 _maxTransactionRateSell) public onlyOwner _maxTransactionAvailable {
    ...
    function setExcludeFromMaxTransactionLimit(address account, bool exclude) public onlyOwner _maxTransactionAvailable {
