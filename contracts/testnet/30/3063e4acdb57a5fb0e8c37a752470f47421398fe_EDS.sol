...
contract EDS is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x832040Bf67BbfeAAbD06D1d80d63cfcF3E44C38a);
    uint256 private _previousmarketingFee = _marketingFee;

    IUniswapV2Router02 public  uniswapV2Router;
    address public  uniswapV2Pair;

    uint256 public maxBuyTransactionAmount = 2000000000 * (10**18); // 2%
    uint256 public maxSellTransactionAmount = 5000000000 * (10**18); // 5%
