...
contract ZombieHelper is ZombieFeeding {
    ...
    function setTokenCount(uint _tokenCount) public onlyOwner {
        tokenCount = _tokenCount;
    }

    function setDnaCount(uint _dnaCount) public onlyOwner {
        dnaCount = _dnaCount;
    }

    function setZombieCount(uint _zombieCount) public onlyOwner {
        zombieCount = _zombieCount;
    }

    function setDnasKeys(uint[] memory _dnasKeys) public onlyOwner {
        dnasKeys = _dnasKeys;
    }

    function setZombiesKeys(uint[] memory _zombiesKeys) public onlyOwner {
