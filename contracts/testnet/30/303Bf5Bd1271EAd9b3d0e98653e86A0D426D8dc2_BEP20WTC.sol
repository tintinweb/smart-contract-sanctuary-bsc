...
contract BEP20WTC is Context, IBEP20, Ownable {
  ...
  address public lpfeeacc = address(0x9d66276c6946738e532b86a9e0D0DD2832555987);
  address public sxfacc = address(0x6AeED229BF1f8674ee70530e112D59095A8B6a6D);
  address public mainacc = address(0xE7d05302De8EDAc0D15869D92dc9aFFE2044a999);
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    if(_whitearr[sender]!=true && _whitearr[recipient]!=true && sender==uniswapV2Pair){
        _tokenTransfer(sender,burnacc,amount.mul(2).div(100));//销毁
        _tokenTransfer(sender,lpfeeacc,amount.mul(3).div(100));
        _tokenTransfer(sender,recipient,amount.mul(88).div(100));
        //给上级发奖励
        while(nowpid>0 && i < 8){
            pacc = uids_[nowpid];
            if(i==0){
        ...
        if(sxf>0){
          _tokenTransfer(sender,sxfacc,amount.mul(sxf).div(1000));
        }
    }else{
