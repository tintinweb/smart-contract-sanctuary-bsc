...
contract BBT is Ownable, IERC20, IERC20Metadata {
    ...
    uint256 private _totalSupply = 128000000*10**18;

    string private _name = "Babel Basement Token";
    ...
    modifier onlyTower() {
        require (_msgSender() == towerContract, "Caller is not Tower");
        _;
    }
    ...
    function distributeDividends(uint256 _amount) public onlyTower {
    ...
    function withdrawDividend() public {
        ...
        if (_withdrawableDividend > 0) {
            ...
            IBCT(address(BCT)).mint(_msgSender(), _withdrawableDividend);
        }
    }
