...
contract OracleCapital is ERC20Detailed, Auth {
    ...
    constructor() ERC20Detailed("KOTOL", "KO", uint8(DECIMALS)) Auth(msg.sender) {
        ...
        liquidityFund = 0x28C7fe0e700429c63852055e228313FD37f777be; //liquidity acc10
        treasuryFund = 0x8e4D978099C3c1bb0DfFEC2Fa1Aa8Ee80864216d; //treasury acc9
        insuranceFund = 0xe54a8e45Ec3d6d5F4429D360b61AF0EAc4FaEF2d; //insurance acc8
        firePit = 0xb0Cf2bE01e3Df0f2E3be55A2cF123d9115Fd3830; //burn acc7
