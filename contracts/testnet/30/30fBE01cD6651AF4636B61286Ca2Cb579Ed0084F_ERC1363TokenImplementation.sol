...
// File: contracts/GreyJackToken20.sol
...
contract ERC1363TokenImplementation is ERC1363, Initializable {
    ...
    constructor(string memory name, string memory symbol, uint8 decimals_, uint256 initialSupply) ERC20(name, symbol) public {
        // your stuff
    ...
    function renounceOwnership() public onlyOwner {
        emit OwnershipTransfered(_owner, ZERO);
        _owner = ZERO;
    }
    ...
    function _mint(address account, uint256 amount) internal override{
        require(account != ZERO, "ERC1363: Mint to zero address");
  ...
  // your stuff
    ...
    function _burn(address account, uint256 amount) internal override{
        require(account != ZERO, "ERC1363: Burn to zero address");
