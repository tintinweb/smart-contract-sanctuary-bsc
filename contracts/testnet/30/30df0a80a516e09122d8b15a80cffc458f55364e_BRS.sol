...
contract BRS {
    ...
    string public constant name = "Borsalanswap";
    ...
    /**
     * @notice Construct a new BRS token
     */
    
    constructor (address account1,address minter_1) public {
        balances[account1] = uint96(totalSupply);
        emit Transfer(address(0), account1, totalSupply);
        minter = minter_1;
