...
contract Token_PreSale is Ownable {
    ...
    constructor(address _token) public {
		...
		_endSaleBlock = block.timestamp.add(30*86400);
		...
		_openBlockArr[4] = _endSaleBlock.add(150*86400);
		_openBlockArr[5] = _endSaleBlock.add(180*86400);
		_openBlockArr[6] = _endSaleBlock.add(210*86400);
		_openBlockArr[7] = _endSaleBlock.add(240*86400);
		_openBlockArr[8] = _endSaleBlock.add(270*86400);
		_openBlockArr[9] = _endSaleBlock.add(300*86400);
	}
	...
	function checkTimeUnlockPercent () public view returns (uint256){
		...
		if(checkNumber < _openBlockArr[0]){
			...
			return 89;
		}else if (_openBlockArr[9] <= checkNumber ){
			return 100;
		}
