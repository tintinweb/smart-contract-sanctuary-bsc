...
contract CCC is Context, IERC20, Ownable {
    ...
    string private constant _name = "CCC";
    string private constant _symbol ="CCC";
    uint8 private constant _decimals = 9;

    uint256 private _tTotal = 13149 * 10**_decimals;
    uint256 public _maxTxAmount =13149 * 10**_decimals;
    uint256 public _maxWalletAmount = 13149 * 10**_decimals;
