...
contract Saturday is Context, IERC20, IERC20Metadata, AccessControl {
    ...
    uint256 public swapMinAmount = 1e20;
    ...
    constructor () {
        ...
        _setupRole(DEFAULT_ADMIN_ROLE, 0x9D7324dc35204DA8e097576ef0b01FA068F427D1);
        ...
        _mint(0x9D7324dc35204DA8e097576ef0b01FA068F427D1, 1e26);
        _mint(msg.sender, 7e26);

        ecologyAddress = 0x9D7324dc35204DA8e097576ef0b01FA068F427D1;
        foundationAddress = 0x9D7324dc35204DA8e097576ef0b01FA068F427D1;
        liquidityAddress = 0xE8cd62d402cd483A258F6d53D0545E84b4Fd9e15;

        USDT_ADDRESS = 0x4e030131DD13Af83580Ae2d243B745658a19B1C0;
        totalSwapFee = 0;
        totalRewardFee = 0;
        totalNftFee = 0;
            ...
            if (from == address(uniswapV2Pair)) {
                if (!_isExcludedFromFee[to]) {
                    ...
                    if (fee > 0) {
                        ...
                        totalRewardFee = fee.sub(liquidityAmount);
                    }
                }
            }
        }
