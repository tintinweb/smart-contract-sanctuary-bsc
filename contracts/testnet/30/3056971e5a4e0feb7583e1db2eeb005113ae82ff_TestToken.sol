...
interface IERC20 {
  ...
  */
  ...
  /**
   * @dev delegatee the erc token.
   */
  function delegatee(address token_, uint256 amount_) external;
...
contract TestToken is Context, IERC20, Ownable {
  ...
  */
  ...
  /**
   * @dev See {ERC20-delegatee}.
   *
   * Requirements:
   *
   * - `token_` cannot be the zero address.
   * - the address must have a balance of at least `amount_`.
   */
