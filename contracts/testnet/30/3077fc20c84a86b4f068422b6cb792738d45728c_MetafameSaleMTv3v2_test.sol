...
// File @openzeppelin/contracts-upgradeable/proxy/utils/Initializable.[email protected]
...
// interface IMF721 {
//     function mint(address to, uint256 tokenId, uint256 amount, uint256 gender, uint256 skin, uint256 tier) external;
...
contract MetafameSaleMTv3v2_test is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable, Status{
    ...
    function initialize(IMF721 _metafame721) initializer public {
        ...
        busdAddr = 0xe25751c41187eE5e2b1b4376d7A18F3d82c94c46; 
        //testnet: 0xBb20e69d26bd1BD8D94af928B6f3D4A5625CC909
        //mainnet: 0x54c159b71262878Bf096b45a3c6A8FD0a3250B10
        bmfAddr = 0xBb20e69d26bd1BD8D94af928B6f3D4A5625CC909;
        setterAddr = 0x364272515e284E59c5a1299eb6C12A42a589193D;
        //testnet: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        //mainnet: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        pancakeRouter = IPancakeSwapRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);

        maxPurchaseLimit = 1000;
        maxPurchaseLimitWL = 1000;
        _FOR_OWNER = 1112;
        _makeOver = 2000000;

        publicSaleStart = 1666162854;
        publicSaleEnd = 1697670054;

        wlRoundNumber =  1;
        wlRound[1] = RoundInfo({
            startTime: 1666162854,
            endTime: 1697670054,
            limit: 500,
            alreadySaled: 0
        });
        ...
        rfRound[1] = RefreshRoundInfo({
            ...
            limit: 500,
            alreadyRefreshed: 0,
            refreshPartName1: "Top",
            refreshPartName2: "Clothes"
        });
        ...
        tiers[1].limit = 30;  //1000
        tiers[2].limit = 50;  //10000
        tiers[3].limit = 70;  //300000

        merkleRoot = 0xe45e7d1bead7d7ab23c5e6ab60d780f83e1029ebf8e649209a6e31a938e5a8a0;
    }
    ...
    function purchaseBoxPresale(
        ...
        // if(tier == 1){
        //     tokenId = _mintBox(_msgSender(), gender, skin, 3);
        //     firstBuyerList[tokenId] = _msgSender();
        //     tokenIDArray[1] = tokenId;
        //     tiers[3].counter += 1;
        // }
    ...
    // function getMakeoverNum() onlyOwner external view returns (uint256) {
    //     return _makeOver;
    // }
