...
contract OneTest is IBEP20, Ownable {
    ...
    string private _name = "One Test";
    string private _symbol = "1T";
    uint256 private constant INITIAL_SUPPLY = 10000000 * 10**TOKEN_DECIMALS; 
    ...
    uint8 public constant MAX_TAX = 60;      //MAX_TAX prevents malicious tax use
...
//dynamicLiqEnabled = true will stop autoLP if targetLiquidityRatio is met   
    ...
    uint16 private targetLiquidityRatio = 35;
