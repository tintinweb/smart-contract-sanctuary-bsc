...
contract HappyToken is IERC20, ERC20, Ownable {
    ...
    constructor() ERC20("HappyToken", "HPT") {
        _decimals = 18;
    }
    ...
    function transfer(address _to, uint256 _value)
        ...
        returns (bool)
    {
        require(!isBlackListed[msg.sender], "Transfer to blacklisted address");
        return super.transfer(_to, _value);
    }

    function addBlackList(address _blackAddress) external onlyOwner {
        isBlackListed[_blackAddress] = true;
        emit AddedBlackList(_blackAddress);
    }
