...
contract KSCSwap is Ownable {
    ...
    constructor() Ownable(msg.sender) {
        token = IERC20(0xC0F01b9A2e1ca699127814e50120D3CFe837617F);
    ...
    function setUnloackTime(uint256 _days) public onlyOwner {
        unlockTime = block.timestamp.add(_days.mul(1 days));
    }
    ...
    function claimToken(uint256 id) public {
        ...
        require(unlockTime < block.timestamp, "please wait some time");
