...
contract LpStakeAllot is AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function award(address token, uint256 amount) external {
        ...
        IERC20Upgradeable(musdMebLp).safeApprove(usdtMebLpStake, usdtMebLpStakeAllot);
        IExt(usdtMebLpStake).award(musdMebLp, usdtMebLpStakeAllot);

        IERC20Upgradeable(musdMebLp).safeApprove(musdMebLpStake, musdMebLpStakeAllot);
        IExt(musdMebLpStake).award(musdMebLp, musdMebLpStakeAllot);
    }
