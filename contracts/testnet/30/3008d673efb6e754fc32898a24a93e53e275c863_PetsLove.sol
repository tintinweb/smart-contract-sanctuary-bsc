...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PETH = IBEP20(0x034a02598D62D78dD02D166e3F9E1A6d3192DAD3);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = PETH.balanceOf(address(this));
        ...
        uint256 amount = PETH.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            PETH.transfer(shareholder, amount);
...
contract PetsLove is IBEP20, Auth {
    using SafeMath for uint256;
    address PETH = 0x034a02598D62D78dD02D166e3F9E1A6d3192DAD3;
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "PetsLove Coin";
    string constant _symbol = "PETL";
