...
interface IRaffle {
    function deposit(address user) payable external;
}
...
struct StakedNFTInfo {
    ...
    function donateBNB() payable public nonReentrant {
        ...
        raffleContract.deposit{value: depositAmount}(address(msg.sender));
    ...
    function donateBUSD(uint256 _amountBUSD) nonReentrant public {
        ...
        raffleContract.deposit{value: deposit}(address(msg.sender));
