...
contract King is Context, IERC20, Ownable {
    ...
    string private _name = "Victory Doge";
    string private _symbol = "Victory Doge";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x8672F2907C27170c543bA154C72503385B75dfff));
        marketingWalletAddress = payable(address(0x8672F2907C27170c543bA154C72503385B75dfff));
