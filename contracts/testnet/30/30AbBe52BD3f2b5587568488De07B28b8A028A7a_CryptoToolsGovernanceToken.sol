...
// File: contracts/CryptoToolsGovernanceToken.sol
...
contract CryptoToolsGovernanceToken is Initializable, ERC20Upgradeable, ERC20SnapshotUpgradeable, OwnableUpgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable {
    /// @custom:oz-upgrades-unsafe-allow constructor
    constructor() {
        _disableInitializers();
    }
    ...
    function initialize() initializer public {
        __ERC20_init("CryptoTools Governance Token", "GCTS");
        __ERC20Snapshot_init();
        __Ownable_init();
        __ERC20Permit_init("CryptoTools Governance Token");
        __ERC20Votes_init();
