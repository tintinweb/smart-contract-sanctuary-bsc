...
contract Exchange {
	...
	address owner;
	uint256 public minExchange1To2amt = 1000000;
	uint256 public exchange1To2rate = 3000000000000;
	uint256 public minExchange2To1amt = 1000000000000000000;
	uint256 public exchange2To1rate = 3;
...
*/
	function exchange1To2(uint256 v0) public {
		...
		ERC20(0xd22c5018ecb09f9718CeB2C74C8CE4A0bf658106).transfer(msg.sender, (v0 * exchange1To2rate));
	}
 ...
 * transfers ((v0) * (exchange2To1rate)) / (10000000000000) of the native currency to the address that called this function
*/
	function exchange2To1(uint256 v0) public {
		require((v0 >= minExchange2To1amt), "Too little exchanged");
		ERC20(0xd22c5018ecb09f9718CeB2C74C8CE4A0bf658106).transferFrom(msg.sender, address(this), v0);
		payable(msg.sender).transfer(((v0 * exchange2To1rate) / 10000000000000));
	}
