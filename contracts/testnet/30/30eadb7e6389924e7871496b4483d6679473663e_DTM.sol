            ...
            if(upline != address(0)){
                ...
                if(i > 0 && i < 5 && userInfo[upline].level > 3){
                    if(upRewards.level4Freezed > 0){
                        ...
                        uint256 splitLevel4Reward = level4Reward.mul(freezeIncomePercents).div(baseDivider);
                        uint256 trueLevel4Reward =level4Reward.sub(splitLevel4Reward);
                ...
                if(i >= 5 && userInfo[upline].level > 4){
                    if(upRewards.level5Left > 0){
                        ...
                        uint256 splitLevel5Reward =level5Reward.mul(freezeIncomePercents).div(baseDivider);
                        uint256 trueLevel5Reward =level5Reward.sub(splitLevel5Reward);
