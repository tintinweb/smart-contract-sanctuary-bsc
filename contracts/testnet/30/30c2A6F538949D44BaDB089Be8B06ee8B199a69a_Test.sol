...
contract Test is Token {
    ...
    uint private startTime = 1646090268; // Thursday, March 3, 2022 23:00:00 PM GMT+01:00
    ...
    uint8[] private REF_BONUSES             = [50, 30, 20];
    uint private constant ADV_FEE           = 20;
    ...
    // Configurables
    uint public MIN_INVEST_AMOUNT = 100 ether;
    uint public SELL_LIMIT        = 1000000 ether;
    ...
    constructor() public {
        ...
        ADMIN = msg.sender;
        DEV_1 = 0x0A44D1CeBeD8bd4670AfA49fab234BF8a52E9854;
        DEV_2 = 0x56a9EA067af706bE184740Cb01d52Be75CecAf50;
