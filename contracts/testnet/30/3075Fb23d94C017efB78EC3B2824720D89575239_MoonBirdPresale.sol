...
contract MoonBirdPresale is Context, Ownable {
  ...
  constructor(bool _seed,address _token,address _busd,uint256 _price,uint256 _minbuy,uint256 _maxsold,uint256 _maxhold,address _recaiver,uint256 _timer,uint256 _deley) public {
      saletoken = _token;
      busd = _busd;
      ...
      _seedround = _seed;
      starttimer = block.timestamp.add(_deley);
      endtimer = starttimer.add(_timer);
  }
