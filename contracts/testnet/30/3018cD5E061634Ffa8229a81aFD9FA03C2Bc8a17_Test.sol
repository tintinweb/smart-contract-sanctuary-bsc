...
contract Test is RequesterStandart {
    ...
    constructor(EquaProtocol equaProtocol_) {
        ...
        problemId = 0x5edc9c87265c9c17815adac011dc3a26e1998aec32546827d9865eb3198f867b;
    }

    mapping(uint256 => uint256) public inputs;

    function solve(uint256, bytes memory answer_) external override {
        require(msg.sender == address(equaProtocol));
    ...
    function ask(uint256 q_) external {
        ...
        EQUA.approve(address(equaProtocol), reward);
        equaProtocol.request(problemId, abi.encode(q_), reward, true);
    }
}
