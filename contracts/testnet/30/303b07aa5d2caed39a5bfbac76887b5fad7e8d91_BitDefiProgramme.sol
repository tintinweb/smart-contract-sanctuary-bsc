...
contract BitDefiProgramme {
    ...
    function teamDetails(address user) public view returns(uint256 [5] memory levelteam, uint256 [5] memory levelinc, uint256 [5] memory staketeam, uint256 [5] memory stakeinc){
