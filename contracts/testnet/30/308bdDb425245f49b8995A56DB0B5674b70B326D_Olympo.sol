...
contract Olympo{
    ...
    function getSite()     view external returns(string memory){ return site; }
    function getTelegram() view external returns(string memory){ return telegram; }
    function getDiscord()  view external returns(string memory){ return discord; }
