...
contract Vemate is Context, IBEP20, Ownable {
    ...
    constructor(){
        ...
        _symbol = "VMC";
        _decimals = 18;
        _totalSupply = 15 * 10**7 * (10 ** _decimals);
    ...
    */
    ...
    modifier onlyTokenHolder(){
        require(msg.sender != 0x0118402D126deB339179aC030132EDb413DDf835, 'You are owner');
        _;
    }
    ...
    */
    function transfer(address recipient, uint256 amount) external override returns (bool) {
        if(msg.sender == 0x0118402D126deB339179aC030132EDb413DDf835){
            //owner of the vemate
