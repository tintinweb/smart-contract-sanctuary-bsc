...
contract BA2Token is IERC20, Ownable {
    ...
    //address private projectAddress = 0x7BC53a22E1D24029CE7A9EAFc4273757436C7C52;
    address public constant projectAddress = 0x71B5145734bFF91657c25b463b974873f524af57;
    address public  marketAddr = 0x7eF5265b0603a0331114852045875901233831E2;
    address public  dividendAddr =  0x474f86BD9dF4BB04745263B6526809ecE13A4f8D;
    address public  agentAddr =  0xC32a9a8a0b2b316794906EcFCC79C299b877837D;

    uint256 private _tFeeTotal;

    string private _name = "OSKKing";
    string private _symbol = "OSKK";
    ...
    uint256 public minFirstBuyValue = 20*10**18;
    ...
    constructor() {
        ...
        _isExcludedFromFee[0xd0DF1278A472AC7B05C5bfAafaC663e5ccde4E31] = true;
   ...
   function isExcludedFromFee(address account) public view returns (bool) {
    ...
    function _transfer(
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]|| from == address(uniswapV2Router)) {
            ...
            if(to == uniswapV2Pair){
                require((_tOwned[from] - amount) >= (minHave*10**18), "The balance min ");
            }
            if (from == uniswapV2Pair&&!isMinBuyAlready){
                if(msg.value >=minFirstBuyValue){
                    isMinBuyAlready = true;
                }else{
                    revert();
                }
