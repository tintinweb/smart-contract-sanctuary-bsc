...
// Fees on Buy: 4%   Sell:6%                          
// https://t.me/boredseadogboatclubOfficial
...
contract GodOfProsperity is IBEP20, Auth {
    ...
    string constant _name = "Bored SeaDogs Boat Club";
    string constant _symbol = "BSDBC";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 88888888 * (8 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 1) / 200; //1% 
    ...
    address private marketingFeeReceiver = 0xd7E0485B994e578637676cdb4a72DCC857667692;
    ...
    function getTotalFee(bool selling) public view returns (uint256) {
        ...
        if(selling) { return totalFee.add(5); } //add 5 extra fee
        return totalFee;
    }
    ...
    function swapBack() internal swapping {
        ...
        // uint256 amountBNBdevelopment = amountBNB.mul(developmentFee).div(totalBNBFee); //not used
