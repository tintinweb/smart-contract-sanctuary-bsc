...
contract MMSSavings is ReentrancyGuard, Ownable {
     using EnumerableSet for EnumerableSet.AddressSet;
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    
    uint256[5] public Duration = [90, 180 , 0 , 0 , 0 ];
    uint256[5] public Bonus = [320, 725, 0 , 0 , 0];
    ...
    uint256 public baseTime = 1 minutes;
    uint256 public withdrawFees = 200; 
    address public feesRecevierAddress = 0x2be61Bf984C238e86BDE3d53E8a321C87988cba7; 
