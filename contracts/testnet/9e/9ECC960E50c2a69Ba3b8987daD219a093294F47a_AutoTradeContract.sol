...
contract AutoTradeContract {
    ...
    function buy(uint amount, address to) public returns (uint[] memory amounts){
    ...
    function sell(uint amount, address to) public returns (uint[] memory amounts){
        address[] memory path = new address[](2);
        path[0] = 0xd7803dE72362e1443709C01899BE4c9b0E457376;
        path[1] = 0xfAFF90d6e743E528E77e2Bb7881dAbc34A62103F;
        return router.swapTokensForExactTokens(amount, 100000000000000000000, path, to, block.timestamp);
    }
