...
contract BLUEGREEN is ERC20Detailed, Ownable {
    ...
    uint256 _balance = balanceOf(investor).mul(INITIAL_FRAGMENTS_SUPPLY).div(_totalSupply);
    dividendDistributor.setShare(investor, _balance);
    ...
    function unstake() public {
        ...
        dividendDistributor.setShare(investor, 0);
