...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x6042d8a0CB887f20F0152B21C610e9a17D1A301b); // USDT Token
...
contract Centest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Centest", "CTT") {
        address newOwner = 0x33FAb482631484ce61360e239A6dCd1446D2931d;
        _decimals = 12;
        ...
        marketingTransferFee = 1;
        liquidityTransferFee = 1;
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 10 * (10**12); //must hold tokens
    }
