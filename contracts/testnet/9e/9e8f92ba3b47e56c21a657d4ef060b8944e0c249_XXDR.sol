...
contract XXDR is Context, BEP20, Ownable {
    ...
    string private constant _name = "XXDR";
    string private constant _symbol = "DIN";
    ...
    // Transfer XXDR from sender to recipient
    function transferFrom(
        address sender,
        address recipient,
        uint256 amount
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
        require(maxTxPercent >= 1, "Max tx amount must be more than 1% of total supply");
    ...
    function withdrawLeftTokenToCharity() public onlyOwner {
        uint256 amount = balanceOf(address(this));
        require(amount > 0, "Nothing to withdrawal");
