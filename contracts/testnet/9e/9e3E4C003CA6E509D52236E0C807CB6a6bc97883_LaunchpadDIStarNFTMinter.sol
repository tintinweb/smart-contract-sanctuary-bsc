...
// 1/ Three functions required to have inside your smart contract,
// 1/a template for NFT smart contract: https://github.com/galler-dev/launchpad/blob/master/contracts/LaunchpadNFT.sol
// 1/b functions must be implemented, getMaxLaunchpadSupply(), getLaunchpadSupply() and mintTo(address to, uint256 size)
// 1/c check details in function mintTo(address to, uint size) external onlyLaunchpad 
// 1/d config our smart contract address inside modifier onlyLaunchpad()

// 2/ check our tech guide for more details, 
// https://nftbinance.readme.io/docs

// 3/ Our smart contract address on testnet which your tech team would use when implementing your smart contract,
// “
//   {
//  "bsc_testnet": {
//       "launchpad": "0x64eF5f4145A77EA9091DA00eb5f5B865eB27B5D2"
//     },
//     "rinkeby": {
//       "launchpad": "0xd73b53cBe6A5FE32Ae4aE475d4EA9307bD7aAAfA",
//     }
// }
// "
...
// this a demon NFT
contract LaunchpadDIStarNFTMinter is ERC721Enumerable, Ownable {
    ...
    constructor(string memory name_, string memory symbol_, string memory suffix_, address launchpad, uint256 maxSupply, address starNFT) ERC721(name_, symbol_) {
        suffix = suffix_;
        LAUNCHPAD = launchpad;
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        return _starNft.tokenURI(tokenId);
    }
    ...
    function mintTo(address to, uint size) external onlyLaunchpad {
        ...
        // For Test...
        // TO DO : fill right config
        DIStarCharacter memory cd = DIStarCharacter({
            level:1,
            exp:0,
            combatPower:1000,
            avatar:1,
        ...
        IDIStarNFTCodec codec = IDIStarNFTCodec(_starNft.getCodec());
        DIStarNFTDataBase memory mintData = codec.fromCharacterData(cd);
        mintData.role = 1;
        mintData.tp = 1;
        mintData.grade = 5;
