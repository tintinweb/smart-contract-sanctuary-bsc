    ...
    OwnableUpgradeable
{
    ...
    function rentMiner(address referral) public nonReentrant {
        ...
        _settleUplineMiners(referral, referralBonus, user);
    }

    function _settleUplineMiners(
        address referral,
        ...
        if (referral != address(0) && _checkIfUserInSystem(referral)) {
            ...
            if (userReferral.firstDownlineTime == 0 || !canClaim ) {
                ...
                if (userReferral.monthlyReferralCount == 9) {
        ...
        //distribute the referral bonus
            ...
            for (uint256 i = 0; i < REF_BONUSES.length; i++) {
                if (upline != address(0)) {
                    ...
                    User storage userBonusShare = users[upline];
                    userBonusShare.levels[i] += 1;
                    userBonusShare.bonus += amount;
                    upline = userBonusShare.referrer;
                } else break;
            }
