...
contract MEAWNFTpool is Pausable, AccessControl {
    ...
    constructor() {
      tokenAddress = 0x237B69b49bd1FcC9867b27C928ec42E40d3A694b;
      tokenNftAddress = 0x8F35FBb138c330721a9315cE7e6101F700808a18;
    ...
    function buyNft(uint256 tokenId,uint256 amount) public {
        ...
        _balance += amount;
        MEAWNFT(tokenNftAddress).safeMint(msg.sender, tokenId, uri);
    }
