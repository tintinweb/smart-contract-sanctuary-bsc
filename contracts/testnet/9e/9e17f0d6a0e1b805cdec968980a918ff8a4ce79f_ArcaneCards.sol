...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "Testg";
    string internal constant SYMBOL = "ggg";
    ...
    // --------------------- Wallet Settings ------------------- //
    uint256 public wdivisor = 50;
    uint256 public maxWalletBalance = (TOTAL_SUPPLY * wdivisor) / 10000; // 
    ...
    address internal marketingAddress = 0x314F06031e3068D58ABFCAD6FC8c9685CdC8fDaF;
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    function setwdivisor(uint256 percent) external onlyManager {
        wdivisor = percent;
        maxWalletBalance = (TOTAL_SUPPLY * wdivisor) / 10000;
        }
