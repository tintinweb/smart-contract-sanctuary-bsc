...
contract BakePay is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    uint256 public maxSellTransactionAmount = 2500 * 10 ** 18;
    ...
    address public liquidityReceiver = 0x7d424B1630811A2c492C71e46c401901B18c88aa;
    address public marketingReceiver = 0xa5306B35C3b6d5c3dBb7bd882043965707560e87;
    address public treasuryReceiver = 0xAd11e041b9fE684922437F17D9b36ac86A5EBC89;
    ...
    uint256 private gonSwapThreshold = (TOTAL_GONS * 10) / 500000;

    mapping(address => uint256) private _gonBalances;
    mapping(address => mapping(address => uint256)) private _allowedFragments;

    constructor() ERC20Detailed("BakePay", "BPAY", uint8(DECIMALS)) {
