...
pragma solidity ^0.8.4;
    ...
    contract Presale is ReentrancyGuard, Ownable {
        ...
        constructor (address payable wallet, address admin, IERC20 token, IERC20 busd, IERC20 eth, IERC20 btc, IERC20 usdc, IERC20 usdt, IProviderPair _BusdBnb, IProviderPair _BusdEth,  IProviderPair _BusdBtc, uint256 _newRate)  {
        ...
        function adminTransfer(address _beneficiary, uint256 amount) public nonReentrant icoActive {
            require(msg.sender == _admin, "Only Admin can run this function");
            availableTokensICO = availableTokensICO.sub(amount);
            _token.transferFrom(_wallet,_beneficiary, amount);
        }
    }