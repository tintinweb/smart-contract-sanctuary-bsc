...
contract Presale is Ownable {
    ...
    mapping(address => uint256) public usertokenbought;
    ...
    function buyToken() public payable returns (address) {
        ...
        uint256 tperbnb = getTokensPerEth(msg.value);

        usertokenbought[msg.sender] = usersInvestments[msg.sender].mul(tperbnb);
