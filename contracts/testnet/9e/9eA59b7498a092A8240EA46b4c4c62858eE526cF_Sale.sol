...
contract Sale is ReentrancyGuard {
    ...
    //address internal auditorContract = 0xbdE7fc94527a84a856B65eC54803c71B923a54Ea;
    ...
    function finalizeSale (uint8 _round) public nonReentrant {
        require(msg.sender == owner || msg.sender == adminAddress, "You don't have authorization for this");
        ...
        if(sale_info[_round].end > 0) {
            if(block.timestamp > sale_info[_round].end) {
                ...
                uint256 feeAmount = ((sale_status[_round].sale_raised_amount * (10000 - sale_info[_round].multT)) / 10000);
                ...
                //receiverFee.transfer(feeAmount);
                ...
                // Owner payment
                //address payable receiver = payable(msg.sender);
                //receiver.transfer(sale_status[_round].sale_raised_amount - feeAmount - liquidityAmount);
