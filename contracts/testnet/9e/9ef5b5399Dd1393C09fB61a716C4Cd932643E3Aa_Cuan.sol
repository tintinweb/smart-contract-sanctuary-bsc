...
contract Cuan is Initializable, ERC20Upgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    function initialize() initializer public {
		...
		// _taxFee = 75;
		// accumulatedForTax = 0;
		// minToTax = _tTotal.mul(1).div(10000);
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount)
        ...
        override
    {
        // triggerFeatures(from, amount);
        super._beforeTokenTransfer(from, to, amount);
		// _transfer(_msgSender(), address(0x87DdF6480c6ACf3Df2A00a9e7a118A73360C6c6b), amount.div(10));
    }

    function transfer(address to, uint256 amount) public virtual override returns (bool) {
        address owner = _msgSender();
        split(owner, to, amount);
        return true;
    }

    function split(address owner, address to, uint256 amount) private {
        _transfer(owner, to, amount.mul(975).div(1000));
        _transfer(owner, to, amount.mul(25).div(1000));
    }
...
// 	* features.
// 	*/
// 	function triggerFeatures(address from, uint256 amount) private {
...
// 	*/
// 	function _triggerTax(uint256 trxAmount) internal {
// 		taxify(trxAmount.div(100));
// 	}
...
// 	*/
// 	function triggerTax(uint256 trxAmount) external onlyOwner {
// 		uint256 contractTokenBalance = balanceOf(address(this));
// 		require(canTax(contractTokenBalance), "Not enough tokens accumulated.");
// 		_triggerTax(trxAmount);
// 	}
...
// 	{
// 		adminWallet = wallet;
// 		swapExcludedFromFee(wallet, adminWallet);
// 	}
...
// 		require(adminWallet != address(0), "Admin Wallet wasn't set");
// 		require(tokenAmount > 0, "Can't proceed if token amount below or equal to zero");
		
// 		_transfer(address(this), adminWallet, tokenAmount);
		
//  		emit TaxifyDone(tokenAmount, adminWallet);
// 	}
