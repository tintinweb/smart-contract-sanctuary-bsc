...
contract NftWhitelistSaleMerkle is Sample {
    ...
    function transferFrom(
        ...
        address to,
        uint256 tokenId
    ) public payable virtual override(IERC721A, ERC721A) onlyAllowedOperator(from) {
...
abstract contract ERC4907A is ERC721A, IERC4907A {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721A, IERC721A) returns (bool) {
        return interfaceId == type(ERC4907A).interfaceId || super.supportsInterface(interfaceId);
    }
