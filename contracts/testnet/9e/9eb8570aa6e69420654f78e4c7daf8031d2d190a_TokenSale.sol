...
contract TokenSale is Ownable {
    ...
    // Testnet
    IERC20 constant usdt = IERC20(0xC80218fE74F5ee6e487AB07DC0d0599A3170EDa0);
    IERC20 constant btc = IERC20(0x1eCa2978207BAbA4bF56af32De1464Fba29820aE);
    IERC20 constant eth = IERC20(0x2A8406dF4d85C23BaeD54FF497973ab9f67c9945);
    IERC20 constant busd = IERC20(0xE304a78db8650863E7Aef4B6545aC05892A7D98c);
    ...
    //     AggregatorInterface(0xB97Ad0E74fa7d920791E90258A6E2085088b4320);
        
    // AggregatorInterface public pricefeedBNB =
    //     AggregatorInterface(0x0567F2323251f0Aab15c8dFb1967E4e8A7D42aeE);
        
    // AggregatorInterface public pricefeedBTC =
    //     AggregatorInterface(0x264990fbd0A4796A3E3d8E37C4d5F87a3aCa5Ebf);
        
    // AggregatorInterface public pricefeedETH =
    //     AggregatorInterface(0x9ef1B8c0E4F7dc8bF5719Ea496883DC6401d5b2e);
        
    // AggregatorInterface public pricefeedBUSD =
    //     AggregatorInterface(0xcBb98864Ef56E9042e7d2efef76141f15731B82f);
    ...
    IERC20 public token = IERC20(0xDaa39C02157a89D033aAd2A8f135cDBaD8139F7a);
        ...
        returns (uint256 _receivingAmount)
    {
        if (_amount >= 5000 ether && _amount < 10000 ether) {
            ...
            _amount = _amount + _amount * 20 / 100;
        } else if (_amount >= 25000 ether && _amount < 50000 ether) {
            _amount = _amount + _amount * 30 / 100;
        } else if (_amount >= 50000 ether) {
            _amount = _amount + _amount * 50 / 100;
        }
        return _amount;
    }
    ...
    function updateWallets(address _admin)
        public
        onlyOwner
    {
