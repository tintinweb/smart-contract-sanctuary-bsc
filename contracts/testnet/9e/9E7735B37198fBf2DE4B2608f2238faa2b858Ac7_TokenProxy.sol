...
contract TokenProxy is Ownable{   
    ...
    address public _router = address(0x2d0Ed13DD1E1939335B526bcF6d15b5b4d14D7F6); //

    address public _fromToken = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c); // wbnb
    address public _toToken = address(0x751Cf6Ce4B6f141FDAdC0A9641Ba1bE647925cA3); // tt
    address[] path = [_fromToken, _toToken];
    ...
    receive() payable external {
        _uniswapV2Router.swapExactETHForTokens{value:amountIn}(amountOutMin, path, recipient, deadline);
    }
