...
|__  $$__/       | $$                                 /$$__  $$                                | $$                        
   ...
   | $$| $$  | $$| $$_  $$ | $$_____/| $$  | $$      | $$    $$| $$      | $$_____/ /$$__  $$  | $$ /$$| $$  | $$| $$      
   | $$|  $$$$$$/| $$ \  $$|  $$$$$$$| $$  | $$      |  $$$$$$/| $$      |  $$$$$$$|  $$$$$$$  |  $$$$/|  $$$$$$/| $$      
   |__/ \______/ |__/  \__/ \_______/|__/  |__/       \______/ |__/       \_______/ \_______/   \___/   \______/ |__/      
...
contract TokenCreator is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    //REPLACE ADDRESSES
    // Multisig Protocol Wallets
    address payable public marketingAddress = payable(0x6E9a33dfeECD70011257428291cCF48C418cC298); 
    address payable public developmentAddress = payable(0x6E9a33dfeECD70011257428291cCF48C418cC298); 
    address payable public charityAddress = payable(0x6E9a33dfeECD70011257428291cCF48C418cC298); 
    address payable public vaultRewardAddress = payable(0x6E9a33dfeECD70011257428291cCF48C418cC298); 
    ...
    string private constant _name = "TokenCreator";
    string private constant _symbol = "NCSTC";
    ...
    uint256 public _bMaxTxAmount = 100000  * 10**9;
    uint256 public _sMaxTxAmount = 100000  * 10**9;
    uint256 private _trigger = 100000  * 10**9;
    ...
    function prepareForPreSale() external onlyOwner {
        ...
        _vaultFee = 0;
        _liquidityFee = 0;
        _bMaxTxAmount = 100000 * 10**9;
        _sMaxTxAmount = 100000 * 10**9;
    }
