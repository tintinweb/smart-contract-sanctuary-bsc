...
/*
ERC721 implementation optimized for batch minting.
Inspired by AzukiZen's ERC721A https://github.com/chiru-labs/ERC721A/blob/main/contracts/ERC721A.sol
...
abstract contract ERC721Min is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function batchSafeTransferFrom(address from, address to, uint256[] memory tokenIds, bytes memory data) public virtual {
        for (uint256 i = 0; i < tokenIds.length; i++) {
