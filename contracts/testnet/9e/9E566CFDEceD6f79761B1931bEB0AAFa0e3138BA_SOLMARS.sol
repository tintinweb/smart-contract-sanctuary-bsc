...
/**
 *Submitted for verification at BscScan.com on 2022-7/5
*/
...
contract SOLMARS is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10 * 10**7 * 10**3; // total supply add. 
  
   uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = "SOLMARS";
    ...
    address public charityWallet = 0xa4d664B1DD4892424B4cd5D9D3528E0A024dA82B;   // charity wallet address..
    ...
    constructor () public {
        ...
        // WBNB ADDRESS TESTNET : 0x9ac64cc6e4415144c455bd8e4837fea55603e5c3
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0xD99D1c33F9fC3444f8101754aBC46c52416550D1, 'We can not exclude Pancake router.'); // PCS ROUTER TESTNET
