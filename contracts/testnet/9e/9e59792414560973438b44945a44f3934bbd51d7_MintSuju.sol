...
contract MintSuju is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "MintSuju";
    string private _symbol = "MintSuju";
...
0xD99D1c33F9fC3444f8101754aBC46c52416550D1); 
        ...
        teamWalletAddress = payable(address(0x39A150703879Dd1352fAbCb8D48F351367392B18));
        marketingWalletAddress = payable(address(0x39A150703879Dd1352fAbCb8D48F351367392B18));
