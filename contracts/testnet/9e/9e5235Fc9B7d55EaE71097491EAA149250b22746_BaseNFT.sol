 ...
 */
contract BaseNFT is AccessControlEnumerable, ERC721Enumerable {
     ...
     * See {ERC721-tokenURI}.
     */
    constructor(string memory name, string memory symbol, uint256 hardCap, string memory baseTokenURI, address owner) ERC721(name, symbol) {
    ...
    function tokenIdOf(address from) external view returns (uint256) {
        return tokenOfOwnerByIndex(from, 0);
    }
