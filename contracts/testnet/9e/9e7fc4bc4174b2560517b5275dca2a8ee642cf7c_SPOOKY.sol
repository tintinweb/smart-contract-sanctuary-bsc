...
contract SPOOKY is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xd3E0e655C7c571892864f0c97d1AAbFc73e71BfF);
    address payable private _marketingAddress = payable(0x458d3499DF42ab5E3c276d0f4a8c23eD15962dB5);
	address payable private _charityAddress = payable(0xFEE0Bfb981708EF239809C5Ac33E4F35f16f2B85);
