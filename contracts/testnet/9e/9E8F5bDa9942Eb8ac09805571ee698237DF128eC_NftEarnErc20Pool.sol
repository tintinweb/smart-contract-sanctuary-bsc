...
contract NftEarnErc20Pool is Ownable, IERC721Receiver, ReentrancyGuard {
    ...
    //    function remainTime(address _user, uint256 slot) external view returns (uint256) {
    //        UserInfo storage user = userInfo[_user];
    //        uint256 share = user.slotInfo[slot].share;
    //        //3600+(机甲战力-5000)*1.5
    //        uint256 limitBlock = 3600;
    //        uint256 limitTime;
    //        if (share >= 5000) {
    //            limitTime = limitBlock.mul(10).add(share.sub(5000).mul(15)).mul(12).div(10);
    //        } else {
    //            limitTime = limitBlock.mul(12);
    //        }
    //        uint256 untilTime = user.slotInfo[slot].originStartTime.add(limitTime);
    //        if (untilTime < user.slotInfo[slot].startTime) {
    //            return 0;
    //        }
    //        uint256 cur = block.timestamp;
    //        if (untilTime >= cur) {
    //            return untilTime.sub(cur);
    //        } else {
    //            return 0;
    //        }
    //    }
