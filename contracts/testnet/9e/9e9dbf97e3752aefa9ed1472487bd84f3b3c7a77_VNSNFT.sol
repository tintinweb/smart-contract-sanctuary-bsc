...
contract VNSNFT is IVNSNFT, ERC721A,ERC721AQueryable, AccessControl {
    ...
    function _afterTokenTransfers(
       ...
       try  IVNSMemberShip(memberShip).updateLevel(from){} catch  {}
       try  IVNSMemberShip(memberShip).updateLevel(to){} catch  {}
    }
