...
import "./ExtendERC721Upgradeable.sol";

contract Lands is ExtendERC721Upgradeable {

    function initialize() public initializer {
        ExtendERC721Upgradeable.initialize("Kingdom Raid Land", "KDRL");
    }
}
...
interface IExtendERC721Upgradeable {
...
;
import "./Interfaces/IExtendERC721Upgradeable.sol";

abstract contract ExtendERC721Upgradeable is IExtendERC721Upgradeable, ERC721EnumerableUpgradeable, AccessControlEnumerableUpgradeable, OwnableUpgradeable {
    ...
    function burn(uint256 _tokenId) external override(IExtendERC721Upgradeable) {
        require(
    ...
    function getMetadataId(uint256 tokenId) external view returns(string memory) {
