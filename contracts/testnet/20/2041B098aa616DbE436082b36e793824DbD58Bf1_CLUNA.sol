...
contract CLUNA is ERC721A, Ownable {
	...
	constructor() ERC721A("CLUNA NFT Collection", "CLUNA") {
		setBaseURI("http://api.clunanft.com/cluna/");
	}
	...
	function withdraw(uint amount) public onlyOwner {
		require(payable(0x84E9D38c744672b47F8E86C6662AD880fC07A3D9).send(amount));
	}
