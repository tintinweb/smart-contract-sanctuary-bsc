...
/**
PRINCE TSUKA $PRINCE
Made by Tsuka OGs and Whales
We are adding to tsuka's greatness with top quality utilities
Taxes used to fund utilities for $TSUKA
Games, Dex, Shopping platforms,Dapps ... We can make it all

Any great token needs great utility
...
contract KOKOSHKA is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public pairedToken = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    ...
    constructor() ERC20("kokoshkaqoa", "koko2a") {
        ...
        treasuryWallet = address(0x6F33cd55271Df22DE8d86954E7d34a95A598AD2a); // set as treasury wallet
