    ...
    WhitelistUpgradeable
{
    ...
    function makeOffer(
        ...
        require(
            IERC20Upgradeable(_contractERC20).allowance(
                msg.sender,
                address(this)
            ) >= priceWithFee,
            "Offer: Not enough allowance"
        );
        require(
            IERC20Upgradeable(_contractERC20).balanceOf(msg.sender) >=
                priceWithFee,
            "Offer: Not enough balance"
        );
        ...
        totalOffersFromUsers[_contractERC721][_tokenId][msg.sender] += 1;
    ...
    function cancelOffer(
        ...
        address _owner = IERC721Upgradeable(_contractERC721).ownerOf(_tokenId);
        require(
            msg.sender == _owner || offer.from == msg.sender,
