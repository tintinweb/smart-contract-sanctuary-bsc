...
contract ANYCIRCLE {
    ...
    uint256 private constant dayPerCycle = 1 days; 
    uint256 private constant dayRewardPercents = 160;
    uint256 private constant maxAddFreeze = 5 days;
    ...
    function _calLevelNow(address _user) private view returns(uint256) {
        ...
        if(total >= 1000e18){
            ...
            if(total >= 2000e18 && user.teamNum >= 5 && maxTeam >= 5000e18 && otherTeam >= 5000e18){
                levelNow = 5;
            }else if(user.teamNum >= 4 && maxTeam >= 1000e18 && otherTeam >= 1000e18){
                levelNow = 4;
            }else{
                levelNow = 3;
            }
