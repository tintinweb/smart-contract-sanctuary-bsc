...
contract CheemsInu is IBEP20, Ownable
{
    ...
    uint256 public constant InitialSupply= 5e10 * 10**_decimals;

    //Amount to Swap variable
    uint256 currentAmountToSwap = 1e8 * 10**_decimals;
    ...
    //DevWallets
    address public TeamWallet=payable(0x23F8F7F82e0aF414880dd3866435EeADcb471842);
    address public walletTwo=payable(0xCC770355B872403F30d8E703B6e585a6556f6400);
    //TestNet
	...
	uint256 private antiWhale = 5e10 * 10**_decimals;

    //Used for anti-bot autoblacklist
    uint256 private tradingEnabledAt; //DO NOT CHANGE, THIS IS FOR HOLDING A TIMESTAMP
	uint256 private autoBanTime = 600; // Set to the amount of time in seconds after enable trading you want addresses to be auto blacklisted if they buy/sell/transfer in this time.
