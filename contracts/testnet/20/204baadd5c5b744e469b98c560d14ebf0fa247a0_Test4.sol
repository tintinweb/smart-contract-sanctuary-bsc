...
contract Test4 is Ownable, IBEP20 {
    ...
    constructor() {
        ...
        autoLiquidityReceiver =0x49A6074Be8F3c8Eaf0C9d1274E378F0E709cDD25 ;
        marketingWallet =0x49A6074Be8F3c8Eaf0C9d1274E378F0E709cDD25 ;
        

        totalFee = 0;
        totalFeeIfSelling = 16;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint newTotalBuy, uint newTotalSell) external onlyOwner {
        require (newTotalBuy < 25);
        require (newTotalSell < 25);
