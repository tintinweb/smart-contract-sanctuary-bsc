...
*/
// Telegram : https://t.me/tokensalesite
...
contract TokenSale is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 10000000 * 10**_decimals; // 1 Trillion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Token Sale";
    string private _symbol = "Token S";
