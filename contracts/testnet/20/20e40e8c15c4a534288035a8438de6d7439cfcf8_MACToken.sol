...
contract MACToken is Context, IERC20, Ownable {
    ...
    string private _name = "MACToken"; // define o nome do token
    string private _symbol = "MAC"; // define o símbolo do token
    ...
    uint256 public _taxFee = 0; // tax fee padrão, esse valor não é utilizado no contrato, ele é sobrescrito pelo buytaxfee e selltaxfee
    uint256 private _previousTaxFee = _taxFee; // adição de variável para a função de alteração do tax fee
    
    uint256 public _liquidityFee = 0; // liquidity fee padrão, esse valor não é utilizado no contrato, ele é sobrescrito pelo buyliquidityfee e sellliquidityfee
