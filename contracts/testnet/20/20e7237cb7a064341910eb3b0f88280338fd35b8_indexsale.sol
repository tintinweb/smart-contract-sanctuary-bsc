...
contract indexsale is IBEP20, ReentrancyGuard, Context, Ownable {
    ...
    string private constant _symbol       = "IDS";
	uint8 private constant _decimals      = 9;
	uint256 private constant _totalSupply = 10 * 10**9 * 10**_decimals; // 10B
	...
	// Dev's wallets
	address payable public constant marketingWallet = payable(0x7BE958faEe9462B7Ad3a47c190c0247bbb8E48FB);
