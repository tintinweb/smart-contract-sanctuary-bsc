...
contract ProductDeployERC20 is Ownable{
    ...
    function deployERC20Token(string memory name, string memory symbol, uint256 amount, uint256 value) external returns(bool) {
    ...
    function getTotalPrice(address productContract,uint amount_) public view returns (uint256) {
        return amount_ * getPrice(productContract);
    }
