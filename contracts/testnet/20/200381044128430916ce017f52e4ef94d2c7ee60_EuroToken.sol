...
contract EuroToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Euro Token";
    string private constant _symbol = "EURO";
    uint8 private constant _decimals = 9;

    address payable private _devAddress = payable(0xcAA3A3844C3AAd89207c0357706055fcaEeAaE23);
    ...
    modifier onlyDev() {
        require(_devAddress == _msgSender(), "Not dev address");
        _;
    }
    ...
    function setTax(uint256 rewardHolderFee, uint256 mktFee, uint256 devFee, uint256 burnFee) external onlyDev {
        _rewardHolderFee = rewardHolderFee;
        _mktFee = mktFee;
        _devFee = devFee;
        _burnFee = burnFee;
    }
