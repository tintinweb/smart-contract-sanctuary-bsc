...
contract StakePoolTokenForToken is States, ReentrancyGuard, Ownable {
    ...
    function setTokens(IBEP20 _stakingToken, IBEP20 _rewardingToken, uint256 _lockPeriod) public onlyOwner {
...
contract FactoryStakingPool is Ownable{
    ...
    function createTokenForToken(address ownerAddress, IBEP20 _stakingToken, IBEP20 _rewardingToken, uint256 _lockPeriod) public onlyOwner returns (address)
    {
        StakePoolTokenForToken toDeploy = new StakePoolTokenForToken();
        toDeploy.setTokens(_stakingToken, _rewardingToken, _lockPeriod);
