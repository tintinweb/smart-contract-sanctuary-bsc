...
contract LevelStorage is Ownable, ERC721Holder {
    ...
    event AddZaiToLevel(uint256 indexed zaiId, uint256 level, uint256 numberOfZaiInLevel);
    event RemoveZaiFromLevel(uint256 indexed zaiId, uint256 level, uint256 numberOfZaiInLevel);
