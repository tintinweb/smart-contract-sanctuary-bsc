...
contract voltreum_ICO is ReentrancyGuard {
     ...
     */
    constructor(address _voltContract, address _GUSD, address _tokenlock, address _reserveWallet) {
        investorMinCap = 10**18;
        reserveWallet = _reserveWallet;
        voltContract = IERC20(_voltContract);
        GUSD = IERC20(_GUSD);
        tokenlock = IVesting(_tokenlock);
        icoAdmin = msg.sender;
        tokenPrice = 10**18;
    ...
    function change_investorMinCap(uint256 _investorMinCap) external onlyIcoAdmin {
