...
contract MarsKitty is Context, IERC20, Ownable {
    ...
    string private _name = "Mars Kitty";
    string private _symbol = "MarsKitty";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE3D0d3C912201E1103A16e862760e7988065F175); 
    address payable public buyBackWalletAddress = payable(0xE3D0d3C912201E1103A16e862760e7988065F175); 
    ...
    uint256 public _maxTxAmount = 40 * 10**9 * 10**9; 
    uint256 public _walletMax =  40 * 10**9 * 10**9; 
