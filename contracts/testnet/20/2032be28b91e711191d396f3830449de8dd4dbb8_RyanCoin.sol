...
contract RyanCoin is IERC20, Ownable, BaseToken {
    ...
    constructor(
       ...
       // address serviceFeeReceiver_,
        ...
        _tTotal = totalSupply_; //100000000 *10**_decimals;
...
/////////////////////////////////////////////////////
  ...
  function calculateTeamFee(uint256 _amount)
    ...
    function removeAllFee() private {
        ...
        _previousTaxFee = _taxFee; // Inactive
        _previousLiquidityFee = _liquidityFee; //Inactive
        _previousMarketingFee = _marketingFee;
        _previousDevelopmentFee = _developmentFee;
        _previousTeamFee = _teamFee;  

        _taxFee = 0; //Inactive
        _liquidityFee = 0; //Inactive
        _marketingFee = 0;
        _developmentFee = 0; //Inactive
        _teamFee = 0; 
    }
...
uint256 tTeam = calculateTeamFee(tAmount);
        _takeTeamFee(tTeam);
       rTransferAmount=rTransferAmount.sub(tTeam.mul(_getRate()));
