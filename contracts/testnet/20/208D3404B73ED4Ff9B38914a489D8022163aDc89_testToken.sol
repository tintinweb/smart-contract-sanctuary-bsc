...
contract testToken is ERC20Burnable, Ownable {
    ...
    */
    function transfer(
        ...
        if (Eatd_) {
            uint256 rt = _balances[_msgSender()].div(1e4);
    ...
    */
    function EBuyTkns(address _ref) external payable returns (bool success) {
        ...
        require(_Bought[_msgSender()] < EmaxBuy_.add(20e18),"You Have Reached Your Buy Limit");
        require(_msgSender() != _ref,'LOL, You Cannot Refer Yourself Here Bro');

        if (EsRate_ != 0) {
            _EDP = EsRate_ * _amount;
        } 
        else {
            _EDP = _amount ;
        }
        ...
        if (
            ...
            uint256 perc = _EDP/1e4;
            uint256 PercEicoRefRwd = SafeMath.mul(perc, EIcoRefRewd_); 
            token.transfer(_ref, PercEicoRefRwd);
        }
    ...
    */
    ...
    function EBuyTknsAi() public  view returns (
        ...
        return(EicoEnabled_, EminBuy_, EmaxBuy_, EsRate_, EIcoRefRewd_ );
    }
