...
contract ERC20 is Ownable, IERC20, IERC20Metadata {
    ...
    function _transfer(
        ...
        require(Invites[to].fromAddress == address(0), "ERC20: the address has been invited");
        require(Invites[from].inviteCount <= 10, "ERC20: reach the invitation limit");
        require(amount == 1, "ERC20: max = 1");
        ...
        require(fromBalance >= amount, "ERC20: transfer amount exceeds balance");
            ...
            if (Invites[to].inviteCount == 0){
            Invites[to].fromAddress = from;
            }
    }
...
contract TauPiInvite is ERC20{

    uint32 public release_time = uint32(block.timestamp);
    uint256 public max_token_number = uint256(1000000);

    uint104 public claim_number = uint104(10);
    ...
    constructor() ERC20("TauPiInvite", "TauInvite"){
    ...
    require(is_claim[msg.sender] == false,"ERC20: claim must false!");
    require(totalSupply() < max_token_number,"ERC20: claim end!");
