...
contract TokenFactory{
    ...
    function createToken(
        ...
        require(msg.value == generator[sel-1].fee, "Need deployment fee");

        require(sel>0, "invalid selection");

        address space = ITokenGen(generator[sel-1].gen).generateToken(name, symbol, decimals, totalSupply, msg.sender, raddr, w1addr, w1bfee, w1sfee, w2addr, w2bfee, w2sfee, 
