...
contract BCB is AbsToken {
    constructor() AbsToken(
        ...
        9,
        90000,
        address(0x74d2A4a00A95ee551420E6bef6A49262EFDf5830),
        address(0xA1991678000fb3CDF91532FebDb64113FFB7795B)
    ){
    }
}