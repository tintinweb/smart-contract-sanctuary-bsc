...
contract GotFinance is ERC20Detailed, Ownable {

    using SafeMath for uint256;
    using SafeMathInt for int256;

    string public _name = "Got Finance";
    string public _symbol = "GOTF4";
    ...
    uint256 public gotfBankFee = 20;
    uint256 public nftHolderFee = 15;
    uint256 public lotteryFee = 15;
    uint256 public sellFee = gotfBankFee.add(nftHolderFee).add(lotteryFee);
    ...
    address public gotfBankReceiver;
    ...
    constructor() ERC20Detailed("Got Finance", "GOTF4", uint8(DECIMALS)) Ownable() {
        // router address testnet: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        ...
        lpReceiver = 0x5B83EB2F9F9a003Ccd71C01D9bD5ea86bB963fD3;
        treasuryReceiver = 0x50778d11E1b2fF2D54c7A9b1e5FdadD6b1487637;
        insuranceReceiver = 0x9e6397cEE6646eC1278Df490F235AC54a9F6C78F;
        gotfBankReceiver = 0x59066C7B22da34FFB58C4ea25855C09D7113e704;
        nftHolderReceiver = 0x20C2de4693A2FD30a8f30ef3c285BAeF60a2F965;
        lotteryReceiver = 0x99DC161e816d0EEB1c74e9EE90FCa4D3B92117f0;
    ...
    function setNormalFees(
        ...
        gotfBankFee = _gotfBankFee;
        nftHolderFee = _nftHolderFee;
        lotteryFee = _lotteryFee;
        burnFee = _burnFee;

        sellFee = gotfBankFee.add(nftHolderFee).add(lotteryFee);
    ...
    function rebase() internal {
        ...
        // uint rebaseRate = 881 * 10**18;
        // uint minuteRebaseRate = 17610 * 10**18;
        // uint hourRebaseRate = 1057174 * 10**18;
        // uint dayRebaseRate = 256830527 * 10**18;
        uint deno = 10**7 * 10**18;
    ...
    function swapBack() internal swapping {
        ...
        uint256 _currentFee = treasuryFee.add(insuranceFee).add(gotfBankFee).add(nftHolderFee).add(lotteryFee);
        ...
        (success, ) = payable(gotfBankReceiver).call{
            value: currentBalance.mul(gotfBankFee).div(
                _currentFee
            ),
            gas: 30000
        }("");
        ...
        (success, ) = payable(lotteryReceiver).call{
            value: currentBalance.mul(lotteryFee).div(
                _currentFee
            ),
            gas: 30000
        }("");
