...
contract EFATAH33SmartLock_DEMO is IERC20 {
    ...
    string private _name = "EFTDEMOLOSCK";  //EFATAHLOCK
    string private _symbol =  "EFTDELOCK"; //EFA33LOCK
   ...
   function createPair(address routeraddr, address contractaddr) external onlyOwner  {
       //_router = IDexRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //testnet
       //_router = IDexRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); //production 
