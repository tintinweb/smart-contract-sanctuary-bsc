...
contract BullBotTs is ERC20, Ownable, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    //Contract By: TG @Altcryp
    constructor() ERC20("BullBotTs", "BBTt") {
        BNBRewardsFee = 2;
        liquidityFee = 0;
        extraFeeOnSell = 3; // extra fee on sell
        marketingFee = 2;
        marketingWallet = payable(0xC59B0D26E65d0dbeF5E08e1B138A29E2FfF18CE1);
