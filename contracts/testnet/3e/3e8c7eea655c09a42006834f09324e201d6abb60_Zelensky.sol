...
//Zelensky NFT Giveaways/WL will take place on ETH Mainnet
...
contract Zelensky is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityFee = 6; //4% development and 2% liquidity
    ...
    constructor (address payable charityWalletAddress) public {
        ...
        //BSC Mainet router: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //Testnet router: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 liquidityAmount = contractTokenBalance.div(3);
