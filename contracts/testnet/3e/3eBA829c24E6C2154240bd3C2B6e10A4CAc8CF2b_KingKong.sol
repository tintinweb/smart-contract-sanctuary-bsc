...
contract KingKong is Context, IERC20, Ownable {
    ...
    string private _name = "big black bear king";
    string private _symbol = "big black bear king";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xC0276E2B1a16a01579C50aF33BE021C0AF77576B); // Marketing Address
    address payable public teamWalletAddress = payable(0xC0276E2B1a16a01579C50aF33BE021C0AF77576B); // Team Address
