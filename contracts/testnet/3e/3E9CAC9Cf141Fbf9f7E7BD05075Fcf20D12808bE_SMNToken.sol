...
contract DividendDistributor is IDividendDistributor {
    ...
    address public SFM = 0x42981d0bfbAf196529376EE702F2a9Eb9092fcB5;
...
contract SMNToken is IBEP20, Auth {
    ...
    constructor() Auth(msg.sender) {
        ...
        pair = IDEXFactory(router.factory()).createPair(SFM, address(this));
        ...
        marketingFeeReceiver = 0x285bAe881B96d043939bb4287cB719368C1acB8f;
