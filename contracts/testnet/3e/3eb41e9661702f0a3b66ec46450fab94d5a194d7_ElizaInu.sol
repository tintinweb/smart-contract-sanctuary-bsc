...
contract ElizaInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Eliza Inu", "ELIZINU") {
        a80DividendTracker = new A80DividendTracker();
        b20DividendTracker = new B20DividendTracker();
        
        /*
        //Mainnet
        contractWallet = 0xAefaaB9053a6161527ab914D446108766EA24Ca1;
        marketingWallet = 0xef68B95675934BE89dDa52E3669a11f1367E6449;
        ...
        */
        ...
        contractWallet = 0xAefaaB9053a6161527ab914D446108766EA24Ca1;
        marketingWallet = 0xef68B95675934BE89dDa52E3669a11f1367E6449;
        a80DividendToken = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //WBNB
        b20DividendToken = 0x6BdeE88395f14160C9aeB897eEe00F1a50dB441D; //ETH
...
contract A80DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("A80_Dividend_Tracker", "A80_Dividend_Tracker", 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd, tx.origin) {
        claimWait = 3600;
...
contract B20DividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("B20_Dividend_Tracker", "B20_Dividend_Tracker", 0x6BdeE88395f14160C9aeB897eEe00F1a50dB441D, tx.origin) {
        claimWait = 3600;
        minimumTokenBalanceForDividends = 200000 * (10**18); //must hold 10000+ tokens
    }
