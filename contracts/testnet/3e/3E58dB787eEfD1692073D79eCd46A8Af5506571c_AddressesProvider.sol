...
contract AddressesProvider is Ownable, IAddressesProvider {
  ...
  function getSpent() external view override returns (address) {
    return getAddress(SPENT);
  }

  function getEusd() external view override returns (address) {
    return getAddress(eUSD);
  }

  function getZapContract() external view override returns (address) {
    return getAddress(ZAP_CONTRACT);
  }

  function getBarterRouter() external view override returns (address) {
    return getAddress(BARTER_ROUTER);
  }

  function getBarterFactory() external view override returns (address) {
    return getAddress(BARTER_FACTORY);
  }

  function getUpRightContract() external view override returns (address) {
    return getAddress(UPRIGHT_CONTRACT);
  }

  function getCropYardContract() external view override returns (address) {
    return getAddress(CROP_YARD_CONTRACT);
  }

  function getPrimeContract() external view override returns (address) {
    return getAddress(PRIME_CONTRACT);
  }

  function getFiskContract() external view override returns (address) {
    return getAddress(FISK_CONTRACT);
  }

  function getWhitelistContract() external view override returns (address) {
  ...
  function getUprightStableContract() external view override returns (address) {
    return getAddress(UPRIGHT_STABLE_CONTRACT);
  }

  function getUprightLpContract() external view override returns (address) {
    return getAddress(UPRIGHT_LP_CONTRACT);
  }

  function getUprightSwapTokenContract() external view override returns (address) {
    return getAddress(UPRIGHT_SWAP_TOKEN_CONTRACT);
  }

  function getUprightBstContract() external view override returns (address) {
    return getAddress(UPRIGHT_BST_CONTRACT);
  }

  function getBorrowLendContract() external view override returns (address) {
