...
contract FarmVerse is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Farm Verse";
    string private _symbol = "FVerse";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x011bAe485A1BF77F58C330b7f89dF99E95a2edaA);
