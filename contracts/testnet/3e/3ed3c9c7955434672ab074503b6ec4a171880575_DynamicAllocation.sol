...
// File: contracts/Utopia/DynamicAllocation.sol
...
contract DynamicAllocation is Ownable {
    ...
    function allocateds(address[] memory accounts, uint256[] memory amount) public onlyDerivation{
        require(accounts.length == amount.length, "[DynamicAllocation] Parameter error!");
