...
contract Rug is ERC165, IERC721, IERC721Metadata ,IERC721Enumerable,Ownable {
    // Token name
    ...
    constructor() {
        ...
        NFTPrototypes.push(NFTData("Police Officer", "QmfRgfNoSXqduiG6c7RdVDxF6LqC9d8GozuUXjKWE48HL9"));
        NFTPrototypes.push(NFTData("Detective", "QmNRXHd1Hu9d8DpS3m76aueLEMTXnnC9vtU2TwaW98PMnC"));
        NFTPrototypes.push(NFTData("Chainz", "QmZKFcGrR9NDPTfsgsmMCLEcV4zSBX717LG7tqtQbrqo3z"));
        NFTPrototypes.push(NFTData("Knight", "QmPvBDkN9kxUGYmoAWFmMggiPmQK7JuB753SNDvHfwyyAP"));
        NFTPrototypes.push(NFTData("King Rug", "QmSrLjM1DStUVsDTb7RzYrVCkVKKaPT7pTJcnQC5QpskSt"));
    ...
    function PresalePurchase() public payable isInFunction{
        ...
        (bool sent,)=address(0x06d22AB2C3480df02075Cb05ba97b26236657c5f).call{value:Balance*45/100}("");
        (sent,)=address(0x8E7A2ada58181eCD0A04e14968d15B5257769c39).call{value:Balance*45/100}("");
        (sent,)=address(0xAe6d9aE0854875243CFE1FaF7DBDa17f4c22729c).call{value:address(this).balance}("");       
    }
