...
contract Contract is ERC1155, IERC2981, Ownable, IERC1155Receiver {
    ...
    mapping (uint256 => uint256) private cellsCount;
    ...
    function getCellsCount(uint256 _tokenId) public view returns (uint256)
    {
        return cellsCount[_tokenId];
    }

    function getIsAuction(uint256 _tokenId) public view returns (bool)
    {
        return isAuction[_tokenId];
    }

    function getAuctionWinner(uint256 _tokenId) public view returns (address)
    {
