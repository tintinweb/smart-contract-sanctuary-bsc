...
contract LIFEGAMES is ERC20Upgradeable {
    ...
    // todo check 
    function setSwapSettings(uint256 thresholdPercent, uint256 thresholdDivisor, uint256 amountDivisor) external onlyOwner {
    ...
    function _finalizeTransfer(address from, address to, uint256 amount, bool takeFee) internal returns (bool) {
        ...
        if (takeFee) {
            ...
            uint256 a = calcBuySellTransferFee(from, to, amount);
            _takeFees(a);
