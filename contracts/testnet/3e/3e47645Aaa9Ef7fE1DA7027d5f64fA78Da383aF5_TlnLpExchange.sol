...
contract TlnLpExchange is AccessControl {
    ...
    function exchange(
        ...
        require(IERC20(_tlnToken).transferFrom(_msgSender(), address(this), amount), "!transferFrom");
        require(BurnableIERC20(_tlnToken).burn(amount), "!burn");
