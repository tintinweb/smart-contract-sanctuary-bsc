...
interface IBEP20 {
    ...
    function getOwner() external view returns (address);
     ...
     function getContractBalance(address wallet) external view returns (uint256);
    /**
...
contract BEP20 is Ownable, IBEP20 {
    ...
    function getContractBalance(address wallet) public view override returns (uint256){
...
function getContractBalance(address wallet) public view returns (uint) {
    return address(wallet).balance;
}
