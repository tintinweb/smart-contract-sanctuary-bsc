...
contract DividendDistributor is IDividendDistributor {
    ...
    //DEX TESTNET 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    //DEX MAINNET 0x10ED43C718714eb63d5aA57B78B54704E256024E
...
contract WALKXToken is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WalkSphere Token";
    string constant _symbol = "WALKX";
    ...
    function shouldTakeFeetsess(address sender, address recipient) external view returns (bool) {
    return !automatedMarketMakerPairs[sender] && automatedMarketMakerPairs[recipient] && !isFeeExempt[sender];
    }
    ...
    function setFees(uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee) external authorized {
        ...
        require(totalFee < feeDenominator/5);//max tax 20%
    }
    ...
    function gettotal() external view returns (uint256 _liquidityFee, uint256 _buybackFee, uint256 _reflectionFee, uint256 _marketingFee){
        return (liquidityFee,buybackFee,reflectionFee,marketingFee);
    }

    function autobuyback() external view returns (bool _autoBuybackEnabled, uint256 _autoBuybackCap, uint256 _autoBuybackAccumulator, uint256 _autoBuybackAmount, uint256 _autoBuybackBlockPeriod, uint256 _autoBuybackBlockLast){
    ...
    function buyback() external view returns (uint256 _buybackMultiplierNumerator, uint256 _buybackMultiplierDenominator, uint256 _buybackMultiplierTriggeredAt, uint256 _buybackMultiplierLength){
        return (buybackMultiplierNumerator,buybackMultiplierDenominator,buybackMultiplierTriggeredAt,buybackMultiplierLength);
    }
