...
contract HalfBaked is ERC20, Ownable {
    ...
    constructor(ConstructorArgument memory _arg) payable ERC20(_arg.name_, _arg.symbol_) {
        ...
        require(_arg.feeManager_.marketingShare_ +
                ...
                _arg.feeManager_.liquidityShare_ == 100, "Total Fee Share must be Equal to 100");
    ...
    event FeeSharesUpdated(uint256  marketingFeeShare, uint256 liquidityFeeShare, uint256 rewardShare);
    ...
    function updateFeeShares(uint256 _marketingShare, uint256 _liquidityShare, uint256 _rewardShare) external onlyOwner {
        require(_marketingShare + _liquidityShare + _rewardShare == 100, "Total Fee Shares Must be Equal to 100");
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if( canSwap &&
            ...
            if(contractTokenBalance > 0 && bnbShare > 0) {
                ...
                if(marketingShare > 0 ) {
                    uint256 marketing = newBalance * marketingShare / bnbShare;
