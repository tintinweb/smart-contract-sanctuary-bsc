...
contract DALONG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "DALONG";
    string private _symbol = "DALONG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4dB9c1F8c86B2E44Fd1b27DafdF649eFe9B9F441); // Marketing Address
    address payable public teamWalletAddress = payable(0x92F1214C1609df80a4aD56C326d1544A8C5eC8B4); // Team Address
    ...
    uint256 private _totalSupply = 3800 * 10**_decimals;
    uint256 public _maxTxAmount = 1 * 10**_decimals; 
    uint256 public _walletMax = 1 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 3800 * 10**3; 
