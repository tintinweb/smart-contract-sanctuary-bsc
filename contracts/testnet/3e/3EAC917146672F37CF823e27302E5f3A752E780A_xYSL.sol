   ...
   /**
    ...
    function _transfer(
        ...
        require(
            ...
            if (
                IUniswapV2Router02(APE_SWAP_ROUTER_ADDRESS).getAmountsOut(amount,path)[1] >= xYSL_ThresholdLimit) {     
                IERC20(address(this)).approve(
                    APE_SWAP_ROUTER_ADDRESS,
                    taxAmount
            ...
            uint prev = IUniswapV2Router02(APE_SWAP_ROUTER_ADDRESS).getAmountsOut(amount ,path)[1];
            super._transfer(sender, recipient, amount);
            uint current = IUniswapV2Router02(APE_SWAP_ROUTER_ADDRESS).getAmountsOut(amount ,path)[1];
