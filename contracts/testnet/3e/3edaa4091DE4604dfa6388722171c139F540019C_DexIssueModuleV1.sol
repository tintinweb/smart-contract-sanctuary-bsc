    ...
    */
    function _makeIssueDexSwaps(ISetToken _setToken, IERC20 _reserveAsset, ActionInfo memory _issueInfo) internal returns (ActionInfo memory) {
        ...
        for (uint256 i = 0; i < components.length; i++) {
            ...
            path[1] = components[i];
            bytes memory _data = this.getUniswapExchangeData(path, false);
            // TODO: This work incorrect should be calculated estimated price
        ...
        uint256 minPercent = 100000000000000000000;
