...
contract Milez is Pausable, AccessControl {
    ...
    mapping (uint256 => uint256) private _playerBalances;
    ...
    external
    {
        uint256 currentPlayerTier = _playerz.getPlayerFlyerTier(playerId);
        FlyerTier memory newTier = _flyerTierz[pkgId];
        FlyerTier memory currentTier = _flyerTierz[currentPlayerTier];
        require(newTier.isTier, "Tier not found");
        require(currentPlayerTier < pkgId, "Current tier is higher.");
        uint256 toPay = newTier.pkgPrice.sub(currentTier.pkgPrice);
        _spendPlayerMilez(playerId, toPay);
...
interface ITICKETZ {
    ...
    function addPlayerTicketz(uint256 playerId, uint256 seatCount, uint256 ticketCount) external;
    function spendPlayerTicketz(uint256 playerId, uint256 seatCount, uint256 ticketCount) external;
    function setPlayerTicketz(uint256 playerId, uint256 seatCount, uint256 ticketCount) external;
    function listPlayerTicketz(uint256 playerId) external view returns (uint256[7] memory seats, uint256[7] memory count);
    function listAllTicketz() external view returns (uint256[7] memory seats, uint256[7] memory count);
    function addPlayerStandbyz(uint256 playerId, uint256 ticketCount) external;
    function spendPlayerStandbyz(uint256 playerId) external;
    function listPlayerStandbyz(uint256 playerId) external view returns (uint256 count);
    function setPlayerStandbyz(uint256 playerId, uint256 ticketCount) external;
    ...
    function purchaseTicketPkg(uint256 playerId, uint256 pkgId) external;
