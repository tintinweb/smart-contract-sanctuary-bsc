...
interface IDivMarketplaceFeeDistributor {
...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyDivMarket() {
        require(msg.sender == _DivMarket);
        _;
    }
    ...
    function setDivMarket (address DivMarket) external onlyToken {
        _DivMarket = DivMarket;
    }
    ...
    function deposit() external payable override onlyDivMarket {
...
contract TetherShiba is IBEP20, Context {
    using SafeMath for uint256;
    ...
    string constant _name = "Tether Shiba";
    ...
    IDivMarketplaceFeeDistributor public DivMarket;
    ...
    constructor() {
        ...
        DivMarket = IDivMarketplaceFeeDistributor(address(this));
    ...
    function swapBack() internal swapping {
       ...
       _basicTransfer(address(this),address(DivMarket), amountSwapBackBefore.div(2));
    
    
        try DivMarket.distributeChipTokens() {} catch {}
    ...
    function whitelistPresaleAddress(address holder) external onlyOwner {
    ...
    function setDivMarket(address _DivMarket) external onlyOwner {
        DivMarket = IDivMarketplaceFeeDistributor(_DivMarket);
        distributor.setDivMarket(_DivMarket);
    }
