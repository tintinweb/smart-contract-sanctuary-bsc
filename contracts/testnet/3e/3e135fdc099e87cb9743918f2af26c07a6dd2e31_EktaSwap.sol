...
/**
  @title EktaSwap contract is a upgradable contract which helps to Swap tokens
  @author ShobikaBabu
  @notice Swap tokens & Withdraw tokens.
 */
contract EktaSwap is Initializable, UUPSUpgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
  ...
  /**
    @dev swap tokens
    @param amount - amount of tokens to be swap
  */
  ...
  */
  ...
  /**
    @dev withdraw tokens from EktaSwap contract
