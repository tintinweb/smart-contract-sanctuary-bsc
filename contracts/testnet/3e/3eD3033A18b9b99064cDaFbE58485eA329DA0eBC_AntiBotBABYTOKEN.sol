...
contract AntiBotBABYTOKEN is ERC20, Ownable {
    ...
    BABYTOKENDividendTracker private dividendTracker;

    address private rewardToken;

    uint256 private swapTokensAtAmount;

    uint256 private tokenRewardsFee;
    ...
    function swapTokensForCake(uint256 tokenAmount) internal {
...
interface ITattooAntiBot {
    ...
    function _pairToken() external view returns (address);
    function _pairAddress() external view returns (address);
    function _amountLimitPerTrade() external view returns (uint256);
    function _amountToBeAddedPerBlock() external view returns (uint256);
    function _timeLimitPerTrade() external view returns (uint256);
    function _blockNumberToDisable() external view returns (uint256);
...
import "../baby/IterableMapping.sol";
