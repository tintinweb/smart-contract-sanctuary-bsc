...
interface IDynamicPair {
    ...
    function initialize(address, address, uint32[8] calldata, bool, uint) external;
...
contract DynamicFactory {
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        return _createPair(tokenA, tokenB, vars, false, address(0));
...

    {
        ...
        return _createPair(tokenA, tokenB, _vars, isPrivate, protectedToken);
...

    {
        ...
        pair = _createPair(tokenA, tokenB, _vars, isPrivate, protectedToken);
...

    {
        ...
        IDynamicPair(pair).initialize(token0, token1, _vars, isPrivate, baseProtectedToken);
