...
contract LIFEGAMES is IERC20 {
    ...
    function _finalizeTransfer(address from, address to, uint256 amount, bool takeFee) internal returns (bool) {
        ...
        if (inSwap) {
            ...
            //return _transferBothExcluded(from, to, amount);
        ...
        //uint256 contractTokenBalance = _rOwned[address(this)];
        ...
        return _tokenTransfer(from, to, amount, takeFee && takeFeeEnabled);
    ...
    function contractSwap(uint256 numTokensToSwap) internal swapping {
        ...
        if (autoAddLiquidity) {
            ...
            // amounts
            uint256 estimatedBusdForAutoLiquidity  = 100000;
    ...
    function _takeFees(uint256 tFee) private {
        uint256 currentRate = _getRate();
        uint256 rDistributionHoldersFee = tFee.mul(currentRate);
