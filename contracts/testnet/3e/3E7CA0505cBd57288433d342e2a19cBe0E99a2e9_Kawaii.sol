...
/**
Akiba Finance
Tax for Buying/Selling: 4%
    - 2% of each transaction sent to holders as KAVA transactions
    - 1% of each transaction sent to Treasury Wallet
    - 1% of each transaction sent to the Liquidity Pool
Earning Dashboard:
https://akiba.finance/kawaii
*/
...
contract Kawaii is Ownable, IERC20 {
    address UNISWAPROUTER = address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // change this router
    address DEAD = 0xec17A9fFb69B08E08Af8E67f486bdAE77a9Ad13b;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string private _name = "Kawaii";
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "Kawaii: decreased allowance below zero"
        );
        _approve(_msgSender(), spender, currentAllowance - subtractedValue);
        return true;
    }
    ...
    function transferFrom(
        ...
        require(
            ...
            "Kawaii: transfer amount exceeds allowance"
        );
        _approve(sender, _msgSender(), currentAllowance - amount);
        return true;
    }
    ...
    function _transfer(
        ...
        require(sender != address(0), "Kawaii: transfer from the zero address");
        require(recipient != address(0), "Kawaii: transfer to the zero address");
        ...
        require(
            ...
            "Kawaii: transfer amount exceeds balance"
        );
    ...
    function _approve(
        ...
        require(owner != address(0), "Kawaii: approve from the zero address");
        require(spender != address(0), "Kawaii: approve to the zero address");
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }

    function _mint(address account, uint256 amount) private {
        require(account != address(0), "Kawaii: mint to the zero address");
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    }
    ...
    function _burn(address account, uint256 amount) private {
        require(account != address(0), "Kawaii: burn from the zero address");
        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "Kawaii: burn amount exceeds balance");
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "Kawaii: account is already set to requested state"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value)
        ...
        onlyOwner
    {
        require(pair != uniswapV2Pair, "Kawaii: DEX pair can not be removed");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "Kawaii: automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
        if (value) {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "Kawaii: the router is already set to the new address"
        );
    ...
    function compound() public {
        require(compoundingEnabled, "Kawaii: compounding is not enabled");
...
contract DividendTracker is Ownable, IERC20 {
    ...
    string private _name = "Kawaii_DividendTracker";
    string private _symbol = "Kawaii_DividendTracker";
        ...
        onlyOwner
    {
        require(
            ...
            "Kawaii_DividendTracker: account already set to requested state"
        );
        excludedFromDividends[account] = excluded;
        if (excluded) {
            _setBalance(account, 0);
    ...
    function _mint(address account, uint256 amount) private {
        require(
            account != address(0),
            "Kawaii_DividendTracker: mint to the zero address"
        );
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    ...
    function _burn(address account, uint256 amount) private {
        require(
            account != address(0),
            "Kawaii_DividendTracker: burn from the zero address"
        );
        uint256 accountBalance = _balances[account];
        require(
            accountBalance >= amount,
            "Kawaii_DividendTracker: burn amount exceeds balance"
        );
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    ...
    function transfer(address, uint256) public pure override returns (bool) {
        revert("Kawaii_DividendTracker: method not implemented");
    }
