...
error GovernorContract__NotProposer();
    ...
    GovernorTimelockControl
{
    ...
    constructor(
        ...
        GovernorSettings(
            ...
            _proposalThreshold // proposal threshold
        )
    ...
    function propose(
        ...
        // s_propsalIdToProposer[proposalId] = msg.sender;
    ...
    //     if (s_propsalIdToProposer[proposalId] != msg.sender) {
    //         revert GovernorContract__NotProposer();
    //     }
