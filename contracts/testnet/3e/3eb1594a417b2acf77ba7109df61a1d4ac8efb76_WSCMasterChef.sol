...
contract WSCMasterChef is Ownable, ReentrancyGuard {
    ...
    function add(uint256 _allocPoint, IBEP20 _lpToken, uint16 _withdrawFeeBP, uint256 _harvestInterval, bool _withUpdate,
    ...
    function set(uint256 _pid, uint256 _allocPoint, uint16 _withdrawFeeBP, uint256 _harvestInterval, bool _withUpdate,
        uint256 _withdrawLockPeriod ) external onlyOwner {
