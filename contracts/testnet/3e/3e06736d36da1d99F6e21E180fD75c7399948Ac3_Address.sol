 ...
 */
contract Lejyoner is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "Lejyoner";
    string private _symbol   = "Lej";
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x17D63E1df72A7B84211c2C7cea7FBD173ECF57a4); // Marketing address used to pay for marketing
    address payable public _charityAddress = payable(0x823C979E36ab84bdBb075e95D533925eDDEe4598); // Marketing address used to pay for marketing
    address payable public _prizzeAddress = payable(0x563efeDBc58B00cf8FaEDA3B8C84D4FAbc28207B); // Marketing address used to pay for marketing
    address payable public _lpAddress      = payable(0x68ea43f31a71f00DF7242CE84a24F949B0452842); // Burn address used to burn a portion of tokens
    ...
    uint256 public _charityPercentage = 1;
