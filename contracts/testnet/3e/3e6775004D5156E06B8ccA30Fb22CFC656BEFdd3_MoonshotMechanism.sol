...
interface IMoonshotMechanism {
    ...
    function shootMoon(uint) external;
...
contract MoonshotMechanism is IMoonshotMechanism {
    ...
    uint256 public shootmoonBalance;
    ...
    function shootMoon(uint256 amount) external override {
        shootmoonBalance = amount.add(shootmoonBalance);
        if(shootmoonBalance >= disbursalThreshold) {
