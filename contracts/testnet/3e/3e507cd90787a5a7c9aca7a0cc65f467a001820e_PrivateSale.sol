...
//  uint public constant blockInOneMonth = 864000; // 30 * 24 * 60 * 20
  ...
  function buy(USDCurrency _usdCurrency) external {
    ...
    buyer.boughtAtBlock = block.number; // TOD reentrancy
  ...
  function claim() external {
    ...
    require(dggToken.releasePrivateSaleAllocation(msg.sender, releaseAmount), "PrivateSale: transfer token failed");
