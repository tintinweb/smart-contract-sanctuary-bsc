...
contract FeeDistributorFactory is Ownable {
    ...
    constructor(address router_, address partnerAdmin_) {
        router = router_;
    ...
    function createFeeDistributor(
        ...
        // require(feeDistributors[_token] == address(0)); TODO add on prod !!!
        ...
        feeDistributors[_token] = address(_feeDistributor);
    }
}
