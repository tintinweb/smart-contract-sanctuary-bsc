...
contract HappyDoge is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress ;//设置定义营销钱包
    ...
    uint256 public _maxTxAmount = 6900000000000000000000 * 10**9;//设置最大交易数量。一般十分之一
    uint256 private numTokensSellToAddToLiquidity = 69000000000000000000 * 10**9;
    //设置添加到池子的代币数量达到多少。建议千分之一或者2千分之一
    ...
    constructor () public {
        ...
        //0x10ED43C718714eb63d5aA57B78B54704E256024E        正式路由
        ...
        _marketingAddress = msg.sender;//设置营销钱包

        //exclude owner and this contract from fee
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_marketingAddress] = true;//设置排除营销钱包费用
