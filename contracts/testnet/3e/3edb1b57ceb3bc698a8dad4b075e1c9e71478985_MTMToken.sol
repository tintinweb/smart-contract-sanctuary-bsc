...
contract MTMToken is Context, IERC20Metadata, Ownable {
    ...
    string private _name = "MetamonT";
    string private _symbol = "MTMT";
    uint8 private _decimals = 18;
    uint256 public maxBuy = 200 * 10 ** 18;
    MTMStake public stake;
    IPancakePair public pancakePair;
    address public burnAddress = address(0x000000000000000000000000000000000000dEaD);
    address public mainAddres = address(0x0EFd5bB7c0d8c538B08bA130f2f9C2D5Fde47fA0); //0xC06FB7FC81e2Fd08688220f4b90a6C04317c032F
    address public reflowAddress = address(0x0EFd5bB7c0d8c538B08bA130f2f9C2D5Fde47fA0); //0x223558298D7F317FBc86668B7cD85e50a348Fb88
    address public marketAddress = address(0x0EFd5bB7c0d8c538B08bA130f2f9C2D5Fde47fA0); //0x9a0B475C086D7eB917A57877d370427cDFA35B52
    address public USDT = address(0xe73b142E880c9f57A1cfcE4DbC298D95D4D09b63); //0x55d398326f99059fF775485246999027B3197955
    address public technologyAddress = address(0x0EFd5bB7c0d8c538B08bA130f2f9C2D5Fde47fA0); //0x6308731D1a37A4cb8Ac92EaFEddfE911616ad205
    ...
    function gainMarketToken() public  {
        ...
        require(block.timestamp.sub(lastChangeMarketTime) >= 3 minutes, "Didn't have enough time");
    ...
    function gainTechnologyToken() public  {
        ...
        require(block.timestamp.sub(lastChangeTechTime) >= 3 minutes, "Didn't have enough time");
    ...
    function getPairPrice() public view returns (uint) {
        ...
        PairPrice = temp0.div(temp1.div(10 ** 18));
        return PairPrice;
    }

    function setStopFalling(bool _result) external {
        require(_msgSender() == address(stake), "Insufficient permissions");
        stopFalling = _result;
    }
