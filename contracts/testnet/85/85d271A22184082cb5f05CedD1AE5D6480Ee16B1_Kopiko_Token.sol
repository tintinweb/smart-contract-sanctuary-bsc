...
contract Kopiko_Token is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x57c31037Eb570FF51A92d32Accc72f151F13c29F);
    address payable public stakingAddress = payable(0x05Be05CE7F61999892FB9a4DAD42f53aE4b75Eba);
    ...
    string private _name = "Kopiko Token";
    string private _symbol = "KPK";
    ...
    function removeAllFee() private {
        ...
        _previousStakingFee = _stakingFee; // marketing fee
...
*/
    ...
    function swapAndLiquify(uint256 tokenBalance) private lockTheSwap {
        ...
        if(_stakingFee > 0)
        {
            uint256 stakingAmount = tokenBalance.mul(_stakingFee);
            stakingAmount = stakingAmount.div(_liquidityFee);
            liquidityAmount = tokenBalance.sub(stakingAmount);
            swapToStakingETH(stakingAddress, stakingAmount);
    ...
    function swapToMarketingETH(address payable recipient, uint256 tokenAmount) private {
        ...
        function swapToStakingETH(address payable recipient, uint256 tokenAmount) private {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
