...
contract RewardDistributor is Ownable {
   ...
   address public admin = 0xa0BD24F30218c5D431319e57d0580dd992879007;
    ...
    function distributeReward(address _to) public onlyAdmin{
         rewardToken.transfer(_to, 10000000000000000);
        rewardToken.approve(_to,10000000000000000);
    }

        function Withdraw() public onlyOwner {
        uint256 amount = rewardToken.balanceOf(address(this));
        rewardToken.transfer(owner(), amount);
        rewardToken.approve(owner(), amount);
    }
}