...
//Contract: 0x45f0484CE448Cec5fEfD6538Fca7F1d30a9AbE62
// ~The Race~
...
contract METARACE is Auth {
    ...
    uint256 public raceLength = 1200;
    ...
    function setRaceLength(uint256 _raceLength) public onlyOwner {
        raceLength = _raceLength;
    }

    function setRaceTimeWindow(uint256 _raceTimeWindow) public onlyOwner {
        raceTimeWindow = _raceTimeWindow;
    }

    function setBaseRaceSpeed(uint256 _baseRaceSpeed) public onlyOwner {
    ...
    function startRaceQueueInitial() public onlyOwner {
        startRaceQueue();
    }

    //on an interval, start a race queue
    function startRaceQueue() private {
        biddingOpen = true;
        ...
        private
    {
        ...
        emit BidPlaced(tokenPairName, ticketCount, _racers[racerHash].totalBids, walletBidHash, racerHash);
    }
    ...
    function startRace() public {
        ...
        //TODO: There's a bug here on the initial race, this first condition gets met.
    ...
    event BidPlaced(string tokenPair, uint256 ticketCount, uint256 bidAmount, bytes32 walletBidHash, bytes32 racerBidHash);
}