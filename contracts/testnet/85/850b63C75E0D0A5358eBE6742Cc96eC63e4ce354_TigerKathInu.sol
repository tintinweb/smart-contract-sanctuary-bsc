...
contract Ownable is Context {
    ...
    */
    ...
    function unlock() public virtual {
        ...
        require(_lockTime == block.timestamp , "Contract is locked until 7 days");
...
contract TigerKathInu is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        marketingAddress = payable(0xaC1256f355Dbed31cF18cAF50e6e32EDaFDcE269);
        charityAddress = payable(0xa8D44f53D57dfD77CF88Cd42735F52cEe924352F);
        devAddress = payable(0xC18a009f615CfCD849Ca24b22876bfE7CefD5643);
    ...
    function setCharityFeePercent(uint256 _charityFee) external onlyOwner() {
