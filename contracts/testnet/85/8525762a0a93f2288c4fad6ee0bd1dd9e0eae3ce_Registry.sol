...
contract Registry is OwnableUpgradeable, CoreRegistry, PullPaymentConfig {
	...
	// bytes32 constant UNISWAP_LIBRARY_REGISTRY_ID = keccak256(abi.encodePacked("UniswapV2Library"));
...
contract PullPaymentConfig is OwnableUpgradeable {
	...
	/**
	 * @dev Remove a token from the supported token list
	...
	/**
	 * @notice This method allows owner to update the execution fee receiver
	...
	/**
	 * @notice This method allows owner to update the execution fee
	 * @param _newFee - new execution fee
	 */
