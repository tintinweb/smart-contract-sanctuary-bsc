...
contract VUSD_vault is Ownable {    
    ...
    uint256 public ethRateOfAdmin1 = 30;
    uint256 public ethRateOfAdmin2 = 30;
    uint256 public ethRateOfDev = 40;
    ...
    function setDevidensOfBNB(uint256 _rateOfAdmin1, uint256 _rateOfAdmin2, uint256 _rateOfDev) public 
    {
        require(_rateOfAdmin1 + _rateOfAdmin2 + _rateOfDev > 100, "invalid sum of fees, should be equal or small than 100");
        ethRateOfAdmin1 = _rateOfAdmin1;
    ...
    {
        payable(Admin1).transfer(amount.mul(ethRateOfAdmin1).div(100));
