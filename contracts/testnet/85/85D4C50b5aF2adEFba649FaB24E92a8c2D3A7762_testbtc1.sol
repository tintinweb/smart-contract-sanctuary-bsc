...
contract ManualDividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //Mainnet
...
contract testbtc1 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "testbtc1";
    string constant _symbol = "testb1";
