...
import "./interfaces/IMediaEyeSubscriptionMediator.sol";
...
contract MediaEyeFee is AccessControl {
    ...
    struct TokenAmounts {
        ...
        uint256 subscribeOne365Amount;
        uint256 subscribeTwo365Amount;
        bool chainlinkFeed;
        bool stableCoin;
    ...
    function paySubscriptionLevelTwoFee(
        ...
        if (_duration == SubscriptionDuration.Duration1) {
            ...
            endTimestamp = block.timestamp + 525600 minutes;
        }
        ...
        if (tokenAmount.chainlinkFeed && _paymentMethod == address(0)) {
            if (_duration == SubscriptionDuration.Duration1) {
                ...
                price = baseUSDTokenAmounts.subscribeTwo365Amount;
            }
            // get price from chainlink feed
            price = convertPrice(
                price,
            ...
            if (_duration == SubscriptionDuration.Duration1) {
                ...
                price = tokenAmount.subscribeTwo365Amount;
            }
            if (_paymentMethod == address(0)) {
                require(
                    msg.value == price,
