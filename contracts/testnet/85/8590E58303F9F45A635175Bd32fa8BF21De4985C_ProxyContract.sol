...
import "../../externalContract/openzeppelin/Proxy.sol";

contract ProxyContract is Proxy, Ownable {
    ...
    function _setImplementation(address _newImplementation) internal {
        require(Address.isContract(_newImplementation), "Implementation not a contract");
