...
contract BitnouCoin is BEP20 , Ownable{
    ...
    uint256 public constant _totalSupply = 10_000_000_000 * (10**18);
    ...
    uint256 public totalFees = LiquidityFee.add(StakingFee).add(BurnFee).add(TeamFee);
    ...
    function _transfer(address from, address to, uint256 amount) internal override 
    {
        ...
        if( canSwap && !swapping && from != owner()) 
        {
            ...
            uint256 safeTokens = contractTokenBalance.mul(StakingFee).div(totalFees);
            super._transfer(address(this), stakingContract, safeTokens);
            ...
            super._transfer(address(this), teamWallet, teamTokens);
