...
contract busdStaking is Ownable {
    ...
    function stake(address _upliner, uint256 _amount) external {
        ...
        if (
            TeamInfo[TeamNumber].teamMember.length >= 2 &&
            TeamInfo[TeamNumber].teamDeposit >= 5_00
        ) {
        ...
        if (
            TeamInfo[TeamNumber].teamMember.length >= 4 &&
            TeamInfo[TeamNumber].teamDeposit >= 10_00
        ) {
        ...
        if (
            TeamInfo[TeamNumber].teamMember.length >= 6 &&
            TeamInfo[TeamNumber].teamDeposit >= 15_00
        ) {
