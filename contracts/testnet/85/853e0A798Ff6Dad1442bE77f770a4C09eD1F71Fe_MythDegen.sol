...
contract MythDegen is ERC721 {
    ...
    event ownerChange(uint256 _degenId, address _ownerAddress);
    ...
    function unlockCosmetic(
        ...
        if (_layerType == 0) {
            require(
                MythCosmetic(_address).backgroundExists(_itemId),
                "This Item Is not available"
            );
        } else if (_layerType == 1) {
            require(
                MythCosmetic(_address).eyeExists(_itemId),
                "This Item Is not available"
            );
        } else if (_layerType == 2) {
            require(
                MythCosmetic(_address).mouthExists(_itemId),
                "This Item Is not available"
            );
        } else if (_layerType == 3) {
            require(
                MythCosmetic(_address).noseExists(_itemId),
                "This Item Is not available"
            );
        } else if (_layerType == 4) {
            require(
                MythCosmetic(_address).skinColorExists(_itemId),
                "This Item Is not available"
            );
        } else if (_layerType == 5) {
            require(
                MythCosmetic(_address).bodyExists(_itemId),
                "This Item Is not available"
            );
        } else if (_layerType == 6) {
            require(
                MythCosmetic(_address).headExists(_itemId),
                "This Item Is not available"
            );
        }
...
contract MythCosmetic {
    ...
    event cosmeticAdded(uint256 _layerType, string _imageURL);
