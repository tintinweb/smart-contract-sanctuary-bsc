...
abstract contract NFTMarketReserveAuction is NFTMarketFees {
    ...
    uint private constant MAX_DURATION = 30 days; // Max duration an auction can be held
    ...
    function updateReserveAuctionDefaultDuration(
        ...
        require(
            ...
            "Market: Reserve auction duration must be <= 30 days" //TODO Upgrade this into mainnet
        );
        require(
    ...
    function _createReserveAuction(
        ...
        require(
            ...
            "Market: Auction must be shorter than 30 days"
        );
