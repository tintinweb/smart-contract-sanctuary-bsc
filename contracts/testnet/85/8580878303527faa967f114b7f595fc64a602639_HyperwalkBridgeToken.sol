...
contract HyperwalkBridgeToken is Ownable {
    ...
    mapping(address => uint256) public lastestWithdraw;
    ...
    function withdraw(uint256 amount, bytes calldata _signature) public {
      ...
      require(block.timestamp - lastestWithdraw[msg.sender] >= WITHDRAW_CYCLE_TIME, 'Not yet withdraw');
      ...
      nounce[msg.sender]++;
      lastestWithdraw[msg.sender] = block.timestamp;
