...
contract NUEVO_33 is Context, IERC20, Ownable {
    ...
    constructor (
    ...
    
     {
        ...
        _MkWalletAddress = feeaddress;     //MkAddress;
        _ChaWalletAddress = feeaddress;    //ChaAddress;
        _liqWalletAddress = LiqAddress;
        _ExWalletAddress = MaxAddress;
        ...
        //_isExcludedFromFee[_MkWalletAddress] = true;
        //_isExcludedFromFee[_ChaWalletAddress] = true;
