...
// File: contracts/main/Assets.sol
...
// File: contracts/main/SafeHouse.sol
...
contract InvestmentAlpha is Investment {
        constructor( uint256 _product, address _admin,  address _safeHouse, address _stableToken, address _token,
        address _deposit, address _withdrawal) Investment( _product, _admin, _safeHouse,  _stableToken, _token,
