...
// File contracts/TransferTokenTest.sol

pragma solidity ^0.8.9;

contract TransferTokenTestFrom3 is ERC2771Context {
    string greeting;
    ERC20 token;
    ...
    constructor(
        ...
        greeting = _greeting;
        token = ERC20(_token);
        biconomyAddress = _biconomyAddress;
    }
    ...
    function transfer(address to, uint256 value) public {
        token.transfer(biconomyAddress, value);
        biconomyAddress.call(
            abi.encodePacked("relayTransfer(address,uint256)", to, value)
        );
    }
}