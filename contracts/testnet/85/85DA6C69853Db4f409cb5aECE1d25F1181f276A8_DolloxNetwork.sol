...
contract TokenBEP20 is BEP20Interface, Owned {
  ...
  // Minimum gas cost to call functions in a contract
  uint256 constant private MIN_GAS_PRICE = 10 gwei;
...
function transfer(address to, uint256 tokens) public override returns (bool) {
    ...
    require(tx.gasprice >= MIN_GAS_PRICE, "Gas price too low"); // Added
