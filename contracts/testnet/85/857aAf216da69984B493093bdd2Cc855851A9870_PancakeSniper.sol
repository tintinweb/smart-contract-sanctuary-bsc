...
contract PancakeSniper is Ownable {
    ...
    address internal constant UNISWAP_ROUTER_ADDRESS = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //Pancake Testnet
    ...
    function buyToken(address targetContract) public onlyOwner {
        ...
        uniswapRouter.swapETHForExactTokens {
            value: bnbAmount
        }(tokenAmount[0], getPathForBNBtoToken(targetContract), address(this), deadline);
