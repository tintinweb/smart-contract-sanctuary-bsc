...
contract SquidGame is SquidGameBasic {
    ...
    constructor(address _ownerAddress, address _secWallet, address _regWallet, IERC20 _depositTokenAddress) {
        ...
        LevelPayments[1].timeToOpen = block.timestamp + 1 hours;
        LevelPayments[2].timeToOpen = block.timestamp + 2 hours;
        LevelPayments[3].timeToOpen = block.timestamp + 3 hours;
        LevelPayments[4].timeToOpen = block.timestamp + 4 hours;
        LevelPayments[5].timeToOpen = block.timestamp + 5 hours;
        LevelPayments[6].timeToOpen = block.timestamp + 6 hours;
        LevelPayments[7].timeToOpen = block.timestamp + 7 hours;
        LevelPayments[8].timeToOpen = block.timestamp+ 8 hours;
        LevelPayments[9].timeToOpen = block.timestamp + 9 hours;
        LevelPayments[10].timeToOpen = block.timestamp + 10 hours;
        LevelPayments[11].timeToOpen = block.timestamp + 11 hours;
        LevelPayments[12].timeToOpen = block.timestamp + 12 hours;
        LevelPayments[13].timeToOpen = block.timestamp + 13 hours;
        LevelPayments[14].timeToOpen = block.timestamp + 14 hours;
    ...
    function sendETHDividends(uint8 level) private returns (bool success) {
        ...
        {
            if((users[prev_user].activeMainLevels[level+1]) && (level != 16)) {
