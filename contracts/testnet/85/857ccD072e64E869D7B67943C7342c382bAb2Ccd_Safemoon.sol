...
contract Safemoon is ISafemoon, Initializable, ContextUpgradeable, OwnableUpgradeable {
    ...
    isRouter(_msgSender())
    {
        ...
        bool overMinBnbBalance = contractBnbBalance >= numOfBnbToSwapAndEvolve;
    ...
    function swapAndEvolve(uint256 contractBnbBalance) private  lockTheSwap {
