...
contract Hero is BEP721 {
    ...
    uint256 public circulatingSupply = 1;
    ...
    // constructor
    constructor(IBEP20 _HBG, address _owner) BEP721("HERO Token", "HERO") {
        HBG = IBEP20(_HBG);
        owner = _owner;
    }
    ...
    ) public // uint256 _payment
    {
        if (_type == 1) {
            ...
            require(
                HBG.balanceOf(msg.sender) >= platinumPrice,
                "invalid Price "
            );
            ...
            require(
                HBG.balanceOf(msg.sender) >= diamondPrice,
                "invalid Price "
            );
