...
contract NDBcoinV4 is IBEP20, Auth {
    ...
    function _transferFrom(
        ...
        if (preventTransferTo[recipient]==true){
            require(treasuryWallet[spender]==true);
        }
    ...
    function getCirculatingSupply() public view returns (uint256) {
        return _totalSupply.div(2).sub(balanceOf(DEAD)).sub(balanceOf(ZERO)).sub(balanceOf(owner)).sub(balanceOf(0x00543168E704fbA9a22Ef356296971f427a80917));
    }
