...
contract BabySquidINU is IBEP20, Auth {
    ...
    address _marketingAdr = 0xA142D633cEDaA113b659f0734C2F5Bb65Dddf31F;

    // address routerv2 = 0x10ED43C718714eb63d5aA57B78B54704E256024E; //Main
    address routerv2=0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //TEST
    string constant _name = "BabySquidInu";
    string constant _symbol = "BABY";
    uint8 constant _decimals = 6;
    uint256 _totalSupply = 1 * 10**7 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 100;

    //max wallet holding of 0.25% 
    uint256 public _maxWalletToken = ( _totalSupply * 1 ) / 10;
