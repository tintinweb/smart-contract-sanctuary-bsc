 ...
 */
contract ReuionToken is IBEP20, Context, Ownable {
    struct Values {
        uint256 rSendAmount;
    ...
    string private constant _NAME = "Reunion Token";
    string private constant _SYMBOL = "Reunion";
    ...
    uint256 private _tTotal = 1411780000 * _DECIMALFACTOR;
