...
contract StakingFarmingTokenTwo is BEP20, Ownable {
    using SafeMath for uint256;

    uint256 tokenBalance;

    string public constant name = "Token Two";
...
contract Staking is Context, StakingFarmingTokenTwo {
    using SafeMath for uint256;

    address[] internal stakeholders;

    StakingFarmingTokenTwo public TOKENTWO;
    ...
    constructor(StakingFarmingTokenTwo _address) public payable {
        TOKENTWO = _address;
    }
...
// console.log("finalTokenPrice",finalTokenPrice);
        ...
        require(
            TOKENTWO.totalSupply() >=(numTokens.add(totalTokenStaked)),
            "addition error"
        );
