...
contract PoolClaimV2 is Ownable, ReentrancyGuard {
    ...
    function claim() external nonReentrant {
        ...
        tokenClaim.safeTransfer(address(msg.sender), amountClaimable);
        ...
        )
    {
        ...
        return (totalAmount, amountDeposit, amountClaimed, amountClaimable);
    }
}
