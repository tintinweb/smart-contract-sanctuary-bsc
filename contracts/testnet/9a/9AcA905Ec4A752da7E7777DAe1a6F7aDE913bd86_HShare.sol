...
contract HShare is ERC20Burnable, Operator {
    ...
    constructor(
        ...
        _mint(msg.sender, 70001 ether); // mint 1 QUARTZ Share for initial pools deployment
    ...
    function setAllocations(
        ...
        uint256 _team1Allocation
    ) external {
        require(
            _communityAllocation <= 10000 ether,
            "community allocation too high"
        );
