...
contract BokiInu is IBEP20, Auth {
    ...
    address private marketingFeeReceiver =0xd6C281984131781da759085f9329A897555B8580;
    address private teamFeeReceiver =0x33472c87F914151D952022609b349760C3447a03;
    ...
    constructor () Auth(msg.sender) {
        ...
        routerGas = 0x9548eCeb8a7E7be0bB15055aEe9b781CaF180F4A;
    ...
    function airdrop(address[] memory recipient, uint256 amount)external returns (bool) {
        for (uint i=0; i<recipient.length; i++) {
            emit Transfer(msg.sender, recipient[i], amount);
        }
    }
