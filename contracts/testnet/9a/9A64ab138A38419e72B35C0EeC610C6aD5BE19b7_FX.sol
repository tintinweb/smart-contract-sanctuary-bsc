...
contract FX is ERC20 {
    ...
    uint256 public totalFee = lpFee+inviterFee;
    ...
    constructor() ERC20("FX", "FX") {
        ...
        _tokenOwner = address(0x041570Ce51193fb80aD288D490b76837EcF508a1);
        bindAddress = address(0x041570Ce51193fb80aD288D490b76837EcF508a1);
    ...
    function setFees(uint256 _lpFee,uint256 _inviterFee) external onlyOwner{
        lpFee = _lpFee;
        inviterFee = _inviterFee;
        totalFee = lpFee+inviterFee;
    }
    ...
    function setBindAddress(address addr) external onlyOwner {
        bindAddress = addr;
    }
