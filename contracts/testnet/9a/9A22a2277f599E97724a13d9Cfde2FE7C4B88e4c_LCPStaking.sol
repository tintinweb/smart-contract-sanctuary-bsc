...
contract LCPStaking {
    ...
    constructor(address _owner, address _token,address _addr ) {
    ...
    function stake(uint256 amount, uint256 planIndex) public {
        require(!pauseStaking, "staking Paused");
    ...
    function withdraw(uint256 index) public {
        require(
            excludeFromReward[msg.sender] == false,
            "user excluded from reward"
        );
        require(
            !stakersRecord[msg.sender][index].withdrawan,
            "already withdrawan"
    ...
    function reStake() public {
        ...
        oldStaking.Stake memory userOldStake = oldStakingAddress.stakersRecord(msg.sender, 0);
    ...
    // function see(address user) public view returns(){
    ...
    function restake() public {
        ...
        stakeToken.transferFrom(owner, address(this), total);
