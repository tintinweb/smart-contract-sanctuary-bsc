...
contract NowDaoTreasury is Ownable {
    ...
    /**
        @notice transfer ownership of NMETA
        @param newOwner_ address
     */
    function yieldTokenOwner( address newOwner_ ) onlyManager external {
        IERC20Ownable( Nmeta ).transferOwnership( newOwner_ );
    }
}