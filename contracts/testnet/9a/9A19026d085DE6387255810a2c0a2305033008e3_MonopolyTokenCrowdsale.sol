...
contract MonopolyTokenCrowdsale is AllowanceCrowdsale, TimedCrowdsale {
	...
	{
		super._deliverTokens(address(this), tokenAmount);
	}
	...
	function claimStuckTokens(address token, uint256 amount) external onlyOwner {
	 ...
	 require(ERC20token.balanceOf(address(this))>=amount*decimals,"Insufficent amount");
     ERC20token.transfer(msg.sender, amount*decimals);
}
}
