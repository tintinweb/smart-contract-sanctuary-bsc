...
contract INFINITYLOTTO2 is IBEP20, Auth {
    ...
    constructor (address _router) Auth(msg.sender) {
        ...
        teamDivWallets.push(0x1A6891c4C91787E7e21611f9e94aF2A55fbD56F8);
        teamDivWallets.push(0xAC5Dfd7325aF48a814Cc0c7cc184eb3e3C82972A);
        teamDivWallets.push(0x5ce9653C3C76bed44F1C8eA0250c2ccdB69f800A);
        teamDivWallets.push(0x173fc113c053C27744E65bc259af67c5d256e04b);
        
        isTeamDivWallet[teamDivWallets[0]] = true;
        isTeamDivWallet[teamDivWallets[1]] = true;
        isTeamDivWallet[teamDivWallets[2]] = true;
        isTeamDivWallet[teamDivWallets[3]] = true;
        ...
        isFeeExempt[teamDivWallets[0]] = true;
        isFeeExempt[teamDivWallets[1]] = true;
        isFeeExempt[teamDivWallets[2]] = true;
        isFeeExempt[teamDivWallets[3]] = true;
        ...
        isMaxWalletExempt[teamDivWallets[0]] = true;
        isMaxWalletExempt[teamDivWallets[1]] = true;
        isMaxWalletExempt[teamDivWallets[2]] = true;
        isMaxWalletExempt[teamDivWallets[3]] = true;
    ...
    function addTeamDivWallet(address newTeamDivWallet) external onlyOwner {
    ...
    function removeTeamDivWallet(address oldTeamDivWallet) external onlyOwner {
        ...
        for (uint i = 0; i < l; i++){
            if (teamDivWallets[i] == oldTeamDivWallet) {
                ...
                teamDivWallets.pop();
                delete isTeamDivWallet[oldTeamDivWallet];
                delete isFeeExempt[oldTeamDivWallet];
                delete isMaxWalletExempt[oldTeamDivWallet];
