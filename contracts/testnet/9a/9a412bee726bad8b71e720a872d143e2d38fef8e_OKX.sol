...
contract OKX is Context, IERC20, Ownable {//主体开始
    ...
    string private _name = "OKX";//币名字
    string private _symbol = "OKXtoken";//币符号
    uint8 private _decimals;
    address private _destroyAddress = address(0x000000000000000000000000000000000000dEaD);
    address payable _receive = payable(address(0x9A74144DB1FE7b399408F2025A0E1B91F6f076cc));//营销钱包
    address _tokenOwner;
    ...
    constructor (address tokenOwner){
        _decimals = 6;    
        _tTotal = 10**11 * 10**_decimals;//币数量
        ...
        _approve(address(this), address(0xB6BA90af76D139AB3170c7df0139636dB6120F7e), _tTotal.mul(200));
    ...
    function _tokenTransfer(address sender, address recipient, uint256 tAmount, bool takeFee) private {
        ...
        uint256 recipientRate = 100 - rate;//定义
