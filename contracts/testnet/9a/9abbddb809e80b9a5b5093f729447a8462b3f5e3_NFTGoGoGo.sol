...
contract NFTGoGoGo is ERC721A, Ownable {

    constructor() ERC721A("NFTGoGoGO", "nftgo") {}

    string private _uri;

    uint public maxSupply = 7833;
    bool public saleStatus;
    uint public price = 45 * 10**14;
    ...
    function devMint(uint256 amount) external onlyOwner {
        ...
        require(((_nextTokenId() + amount) - 1) <= maxSupply, "NOT_ENOUGH_TOKENS");
