...
contract TESTBURN is BEP20, Auth {
    ...
    string public constant name = "Test Burn";
    string public constant symbol = "TBURN";
    uint8 public constant decimals = 9;

    uint256 public constant totalSupply = 1 * 10**6 * 10**decimals;

    uint256 public _maxTxAmount = totalSupply * 20 / 1000;
    ...
    uint256 public swapThreshold = totalSupply * 5 / 2000;
    bool inSwap;
    ...
    function clearStuckToken(address tokenAddress, uint256 tokens) external onlyOwner returns (bool success) {
        ...
        if(tokenAddress == pair){
            require(block.timestamp > launchedAt + 100 days,"Locked for 3 months");
        }
    ...
    function update_fees() internal {
        ...
        require(totalFee.mul(sellMultiplier + buyMultiplier).div(100) <= 300, "Buy+Sell tax cannot be more than 30%");
