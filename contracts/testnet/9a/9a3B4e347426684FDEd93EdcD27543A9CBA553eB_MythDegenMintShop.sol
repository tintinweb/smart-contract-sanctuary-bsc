...
contract MythCosmeticShop {
    ...
    function unlockFreeCosmetics(uint256 _degenId) external {
        ...
        tmpEyes[8] = 20;
        tmpEyes[9] = 21;
        tempDegen.unlockCosmetics(cosmeticAddress, _degenId, 1, 10, tmpEyes);
        ...
        tmpMouth[8] = 9;
        tmpMouth[9] = 10;
        tempDegen.unlockCosmetics(cosmeticAddress, _degenId, 2, 10, tmpMouth);
        uint256[10] memory tmpNose;
        tmpNose[0] = 1;
        tmpNose[1] = 2;
        tmpNose[2] = 3;
        tempDegen.unlockCosmetics(cosmeticAddress, _degenId, 3, 3, tmpNose);
        ...
        tempBody[5] = 117;
        tempBody[6] = 118;
        tempDegen.unlockCosmetics(cosmeticAddress, _degenId, 5, 7, tempBody);
        ...
        tempHead[5] = 118;
        tempHead[6] = 119;
        tempDegen.unlockCosmetics(cosmeticAddress, _degenId, 6, 7, tempHead);
    }
}
