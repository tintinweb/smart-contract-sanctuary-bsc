 ...
 * @dev
 */
contract ClaimLinearVestingMaster is
    Initializable,
    PausableUpgradeable,
    ReentrancyGuardUpgradeable
{
     ...
     * @param _startAmount Percentage of the initial amount
    ...
    function initialize(
        ...
        for (uint256 j = 0; j < _length; j++) {
            ...
            addUserVesting(
                _user,
                _tokensAmount,  
                _startAmount,   // TODO: this is now a percentage
                _startTime,
                _endTime
            );
        }
...
import "./ClaimLinearVestingMaster.sol";
...
contract LinearVestingCloneFactory is Ownable {
     ...
     */
    constructor() {
        linearVestingImplementation = address(new ClaimLinearVestingMaster());
    }
    ...
    function createVesting(
        ...
        ClaimLinearVestingMaster(clone).initialize(
            owner(),
            _presale,
            _tokenAddress,
            _startAmount,
