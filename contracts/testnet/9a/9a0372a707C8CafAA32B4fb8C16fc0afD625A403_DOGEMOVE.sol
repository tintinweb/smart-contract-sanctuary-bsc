...
contract DOGEMOVE is Context, IBEP20, Ownable {
    ...
    function UpdateBuyTaxFeePercentage(
        ...
        require(
            liquidityFee.add(MarketingFee) <= (feeDenominator.div(4)),
            "You can't set more than 25%"
        );
        emit BuyTaxFeeUpdated(liquidityFee.add(MarketingFee));
    }
    ...
    function UpdateSellTaxFeePercentage(
        ...
        emit SellTaxFeeUpdated(liquidityFee.add(MarketingFee));
    }
