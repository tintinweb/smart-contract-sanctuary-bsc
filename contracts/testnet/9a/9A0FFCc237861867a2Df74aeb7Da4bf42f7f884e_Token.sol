...
contract Token {
    ...
    constructor() {
        name = "MWBK"; // Sets the name of the token, i.e Ether
        symbol = "MK"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 10 * 10 **18; // Holds an initial supply of coins
