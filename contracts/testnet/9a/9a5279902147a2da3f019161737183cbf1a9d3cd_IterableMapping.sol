...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BTCB
...
contract RwdTest is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("RwdTest", "RwdTest") {
        address newOwner = address(0xa2517Aa995854519c79fAC0898A18a9aFCe83A8E); // update to 0xdEd79cDC6bA42CEc023ce66Ce92A409f23A795d6
    	...
    	marketingWallet = address(0xa2517Aa995854519c79fAC0898A18a9aFCe83A8E); // set as marketing wallet
