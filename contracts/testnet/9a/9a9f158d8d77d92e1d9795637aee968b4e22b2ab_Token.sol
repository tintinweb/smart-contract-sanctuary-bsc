...
contract Token is IERC20 {
    ...
    uint256 public TRANSACTION_LIMIT = 100000000000000000;
    ...
    function setTargets() public onlyOwner {
        ...
        target_sell = price.add(price.div(delta_sell).mul(_deltafactor));
    }
    ...
    function resetTransactionLimit(uint256 TransactionLimit) public onlyOwner {
        TransactionLimit = 100000000000000000;
    ...
    function adjustTargets() public onlyOwner {
        target_sell = target_sell.add(target_buy.div(delta_sell).mul(1));
        target_buy = target_buy.add(target_sell.div(delta_buy).mul(1));
    }
