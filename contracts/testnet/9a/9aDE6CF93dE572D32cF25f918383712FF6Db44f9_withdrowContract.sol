...
contract withdrowContract{
	...
	OracleU private _OracleU = OracleU(0xa695f8b2f0978D2D52Fd81fDa35fBFa7bF0a2bA4);


	uint256 public daymax = 500*10**18;
	uint256 public daymaxset = 500*10**18;
	uint256 public daystart = 0;
	uint256 public daynext = 24*60*60;

	uint256 private daymining = 100*10**18;
	...
	function withdrowUsdt() external {
		require(_usdtBalance[msg.sender]>0, "Err: error address");
