...
contract TestD is Context, IERC20, Ownable {
    ...
    string private _name = "TestD";
    string private _symbol = "TestD";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xd91cA395a54506EF9fAFeE7E269D5EA6cf9a8A50);
    address payable public TeamWAddress = payable(0xd91cA395a54506EF9fAFeE7E269D5EA6cf9a8A50);
    ...
    function BlacklistMode() external onlyOwner {
    for (uint256 i=0; i < Addr.length; ++i) {
        address xAddr = Addr[i];
    _isBlacklisted[xAddr] = true;
    }
}
