...
contract POOL is IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _name = "POOL TOKEN";
    string constant _symbol = "$POOL";
    ...
    uint256 poolFeeOnBuying = 40;
    uint256 marketFeeOnBuying = 40; 

    // sell tax fee
    uint256 reflectionFeeOnSelling = 0;
    uint256 liquidityFeeOnSelling = 50;
    uint256 poolFeeOnSelling = 230;
    ...
    constructor(
        ...
        marketFeeReceiver = payable(0x0227C0E6Ba5825fF4AD495c1Fc5D1a6536182228);
        poolFeeReceiver = payable(0x0227C0E6Ba5825fF4AD495c1Fc5D1a6536182228);
    ...
    function _takepoolFee(address sender, uint256 amount) private {
        ...
        poolFeeAmount = amount.mul(_poolFee).div(feeDenominator);
        _accumulatedPool = _accumulatedPool.add(poolFeeAmount);
        _balances[address(this)] = _balances[address(this)].add(poolFeeAmount);
        emit Transfer(sender, address(this), poolFeeAmount);
    }
