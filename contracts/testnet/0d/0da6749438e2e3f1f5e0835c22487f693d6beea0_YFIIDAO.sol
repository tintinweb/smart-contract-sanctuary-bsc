...
contract YFIIDAO is ABS {
    constructor() ABS("DFI.Money Dao", "YFIIDAO", "DFI.Money Dao", 0x4420F2E42ad49A220d60e99ae76f0072d1F31739) {
        _mint(msg.sender, 40000 * 10**decimals());
        setEnableWhitelist(false);
        setMarketingWallet(0xFc4C900d65Fc5b74f828Fe5f9173c40E2053B42A);
        setDevWallet(0xa13D8AE4C47B88eC7c219e5C1E360d6610192186);
        setBuySlippage(3);
        setSellSlippage(3);
