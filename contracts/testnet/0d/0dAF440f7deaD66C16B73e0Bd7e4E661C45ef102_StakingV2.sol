...
contract StakingV2 is Initializable {
    ...
    function getTotalPayableStake() external view returns(uint256, uint256,uint256) {
       ...
       uint256 perToken = address(this).balance / totalPayableStakes;
       uint256 payableAmount = stakes[1].value * perToken;

       return (totalPayableStakes/1000000000000000000,perToken*1000000000000000000, payableAmount/1000000000000000000);
