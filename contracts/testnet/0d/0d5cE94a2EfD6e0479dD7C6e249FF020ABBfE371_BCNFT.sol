...
contract BCNFT is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    mapping(address => bool) private _tokenHolder;
    ...
    function _transfer(address from, address to, uint256 _tokenId) internal virtual override {
        ...
        if(_tokenHolder[to] == false) {
            holders.push(to);
            _tokenHolder[to] = true;
        }
    }   
    ...
    function checkNFTHolder(address _owner) public view returns (bool) {
        return _tokenHolder[_owner];
    }
}
