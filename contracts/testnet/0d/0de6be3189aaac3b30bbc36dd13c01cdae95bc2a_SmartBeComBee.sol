...
contract SmartBeComBee {
    ...
    function usersB3MatrixReinvest2(address userAddress, uint8 level) public view returns(uint8, uint8) {
    ...
    function usersB6MatriReinvestx2(address userAddress, uint8 level) public view returns(uint8, uint8) {
