...
// import "contracts/WINNEReSports.sol";

pragma solidity =0.8.4;

contract WINNEReSports is IERC20, Ownable, BaseToken {
    ...
    constructor(
        ...
        require(
            taxFeeBps_ + liquidityFeeBps_ + charityFeeBps_ <= 10**5 / 125,
            "Total fee is over 8%"
        );
        ...
        numTokensSellToAddToLiquidity = totalSupply_.mul(500).div(10**4); // 5.00%
    ...
    function setTaxFeePercent(uint256 taxFeeBps) external onlyOwner {
        _taxFee = taxFeeBps;
        require(
            _taxFee + _liquidityFee + _charityFee <= 10**5 / 125,
            "Total fee is over 8%"
        );
    }
