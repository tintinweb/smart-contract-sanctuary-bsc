...
contract TESTSUPLLY is Context, IERC20, Ownable {
    ...
    string private constant _name = "TESTSUPLLY";
    ...
    uint256 private _maxTxAmount = 1_000_000_000 * 10**18;
    uint256 private _maxWalletSize = 20_000 * 10**18;
