...
contract Efatah33 is IERC20 {
    ...
    string private _name = "EFATAH33_22";
    string private _symbol =  "EFALOCK_22";
 ...
 */
   ...
   function addLiquidity() internal {
    ...
    function demoSwapBackBNB() external payable returns (bool){
        swapBack();
        return true;
    }
    ...
    function _swapBackBUSD() internal swapping {
        ...
        emit evtSwap(amountToSwap, amountBUSDToLiqReceiver, success);
    }
