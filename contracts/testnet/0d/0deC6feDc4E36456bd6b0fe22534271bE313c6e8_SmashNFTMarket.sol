...
contract SmashNFTMarket is ERC721{
    ...
    address devwallet;
    address smashlaunch = 0x0194beDbB0182A0E4AD121973B1ce36c9c822680;
    ...
    function createMulti(uint256 collectionid,address to,string memory _tokenURI,string memory _mintname,string memory _nftowner,uint256 _copies,string memory description, uint256 _times) external 
    {
