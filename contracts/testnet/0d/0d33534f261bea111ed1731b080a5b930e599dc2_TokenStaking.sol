...
contract TokenStaking is Ownable {
    ...
    function invest(uint256 _amount, address refferAddress) public {
        ...
        uint256 addAmount = getUserdipositAddamount(msg.sender).add(_amount);
        if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && addAmount <=40 ether && users.boostlaval.boostAmount == 1 ether ){
        ...
        else if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && (addAmount > 40 ether && addAmount <= 80 ether && users.boostlaval.boostAmount == 2 ether)){
        users.userStoreReward += calculateReward(msg.sender);
        users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
        users.boostlaval.boostTime =block.timestamp;
        } else if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && (addAmount > 80 ether && addAmount <= 120 ether && users.boostlaval.boostAmount == 3 ether)){
        users.userStoreReward += calculateReward(msg.sender);
        users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
        users.boostlaval.boostTime =block.timestamp;
        } else if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && (addAmount > 120 ether && addAmount <= 160 ether && users.boostlaval.boostAmount == 4 ether)){
        users.userStoreReward += calculateReward(msg.sender);
        users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
        users.boostlaval.boostTime =block.timestamp;
        } else if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && addAmount > 160 ether && users.boostlaval.boostAmount == 5 ether){
        users.userStoreReward += calculateReward(msg.sender);
        users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
        users.boostlaval.boostTime =block.timestamp;
        }
    ...
    function booster(uint256 boostAmount) public {
        ...
        users.boostlaval.boostDuration = 30  minutes;
        users.boostlaval.boostTime = block.timestamp;
        } else {
        ...
        users.boostlaval.boostAmount = 1 ether;
        ...
        users.boostlaval.boostAmount = 2 ether;
        ...
        users.boostlaval.boostAmount = 3 ether;
        ...
        users.boostlaval.boostAmount = 4 ether;
        ...
        users.boostlaval.boostAmount = 5 ether;
        }
    }
    ...
    function withdrawToken(uint256 id) public {
        ...
        users.checkTime;
        require(duration >= 2 minutes, "Please wait 2 minutes ");
    ...
    function compound() public {
        ...
        users.userStoreReward += calculateReward(msg.sender);
        if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && (getUserdipositAddamount(msg.sender).add(reward.sub(treasuryTax)) <=40 ether && users.boostlaval.boostAmount == 1 ether)){
        users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
        users.boostlaval.boostTime =block.timestamp;
        }
        else if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && (getUserdipositAddamount(msg.sender).add(reward.sub(treasuryTax)) > 40 ether && getUserdipositAddamount(msg.sender).add(reward.sub(treasuryTax)) <= 80 ether && users.boostlaval.boostAmount == 2 ether)){
        users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
        users.boostlaval.boostTime =block.timestamp;
        } else if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && (getUserdipositAddamount(msg.sender).add(reward.sub(treasuryTax)) > 80 ether && getUserdipositAddamount(msg.sender).add(reward.sub(treasuryTax)) <= 120 ether && users.boostlaval.boostAmount == 3 ether)){
        users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
        users.boostlaval.boostTime =block.timestamp;
        } else if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && (getUserdipositAddamount(msg.sender).add(reward.sub(treasuryTax)) > 120 ether && getUserdipositAddamount(msg.sender).add(reward.sub(treasuryTax)) <= 160 ether && users.boostlaval.boostAmount == 4 ether)){
        users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
        users.boostlaval.boostTime =block.timestamp;
        } else if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && getUserdipositAddamount(msg.sender).add(reward.sub(treasuryTax)) > 160 ether && users.boostlaval.boostAmount == 5 ether){
        users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
        users.boostlaval.boostTime =block.timestamp;
        }
        else{
    ...
    function reStakeRefferalReward() public {
        ...
        uint256 totalRefferReward = investment[msg.sender].refferReward;
        require(totalRefferReward > 0, "No refferal rewards found");
        if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && (getUserdipositAddamount(msg.sender).add(totalRefferReward) <=40 ether && users.boostlaval.boostAmount == 1 ether)){
            users.userStoreReward += calculateReward(msg.sender);
            users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
            users.boostlaval.boostTime =block.timestamp;
        }
         else if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && (getUserdipositAddamount(msg.sender).add(totalRefferReward) > 40 ether && getUserdipositAddamount(msg.sender).add(totalRefferReward) <= 80 ether && users.boostlaval.boostAmount == 2 ether)){
            users.userStoreReward += calculateReward(msg.sender);
            users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
            users.boostlaval.boostTime =block.timestamp;
        } else if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && (getUserdipositAddamount(msg.sender).add(totalRefferReward) > 80 ether && getUserdipositAddamount(msg.sender).add(totalRefferReward) <= 120 ether && users.boostlaval.boostAmount == 3 ether)){
            users.userStoreReward += calculateReward(msg.sender);
            users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
            users.boostlaval.boostTime =block.timestamp;
        } else if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && (getUserdipositAddamount(msg.sender).add(totalRefferReward) > 120 ether && getUserdipositAddamount(msg.sender).add(totalRefferReward) <= 160 ether && users.boostlaval.boostAmount == 4 ether)){
            users.userStoreReward += calculateReward(msg.sender);
            users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
            users.boostlaval.boostTime =block.timestamp;
        } else if(users.boostlaval.boostTime+users.boostlaval.boostDuration > block.timestamp && getUserdipositAddamount(msg.sender).add(totalRefferReward) > 160 ether && users.boostlaval.boostAmount == 5 ether){
            users.userStoreReward += calculateReward(msg.sender);
            users.boostlaval.boostDuration = (users.boostlaval.boostDuration+users.boostlaval.boostTime) - block.timestamp;
            users.boostlaval.boostTime =block.timestamp;
        }
