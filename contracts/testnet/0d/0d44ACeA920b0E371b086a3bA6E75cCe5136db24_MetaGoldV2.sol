...
contract MetaGoldV2 is ERC20, Ownable, ReentrancyGuard {
    ...
    constructor(uint256 _supply) ERC20("MetaGoldV2", "METAGOLDV2") {
    ...
    receive() external payable {
        uint256 metagoldV2Price = getPriceBNB();
        uint256 paidMetaGold = msg.value.mul(10**8).div(metagoldV2Price).div(10**8);
    ...
    function getPriceBNB() public view returns (uint256) {
        ...
        path[0] = uniswapV2Pair;
        path[1] = bnb_address;
        return uniswapV2Router.getAmountsOut(1000000000000000000, path)[0];
    }
    ...
    */
    ...
    function updateBNBaddress(address newAddress) public onlyOwner {
        bnb_address = newAddress;
    }
