...
contract Nfttesttoken is ERC721, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("nfttesttoken", "tst") {}
    ...
    function safeMint(address _to, string memory _uri, string memory _name, string memory _description, uint _amount) public onlyOwner {
        ...
        tokens.push(_token); // push to the array
