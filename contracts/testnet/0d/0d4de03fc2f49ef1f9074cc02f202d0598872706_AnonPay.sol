...
contract AnonPay is BEP20, Ownable {
	...
	function excludeFromMaxTrxToken(address account, bool excluded) public onlyOwner {
        require(isExcludedFromMaxTrxToken[account] != excluded, "APAY: Account is already the value of 'excluded'");
        isExcludedFromMaxTrxToken[account] = excluded;
    }
