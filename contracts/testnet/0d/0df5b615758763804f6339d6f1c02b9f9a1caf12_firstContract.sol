...
//----------------------------------------------------------------
    ...
    */
    ...
    Trạng thái: public view returns (Read Contract)
    Kiểu dữ liệu trả về: bool của biến myBool
    */
...
//----------------------------------------------------------------
    ...
    /*
    Khởi tạo hàm: myAddress
    Kiểu dữ liệu: address
    Trạng thái: public (Write Contract)
    Giá trị mặc định: myAddress = 0x0000000000000000000000000000000000000000
    */
    address public myAddress;
    /*
    Khởi tạo hàm: setAddress
    Trạng thái: public (Write Contract)
    */
    ...
    /*
    Get balance ETH of Address
    Khởi tạo hàm: getBalanceETH
    Trạng thái: public view returns (Read Contract)
    Kiểu dữ liệu trả về: uint của biến myAddress
    */
