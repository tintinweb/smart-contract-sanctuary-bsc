...
contract WBLOOM is ITOKEN {
    ...
    ITOKEN bloom = ITOKEN(0xBe370F9b7EDB001e0A0c2976F3AE9D02F8D4A0CE);
    ...
    function wrap(uint256 _amount) external returns(bool){
       ...
       bloom.transferFrom(msg.sender,address(this),_amount);
    ...
    function unwrap(uint256 _amount) external returns(bool){
       ...
       this.transferFrom(address(this),msg.sender,_amount);
       return _burnFrom(_amount);
    }
