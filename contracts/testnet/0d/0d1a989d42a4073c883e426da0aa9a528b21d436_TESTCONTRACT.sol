...
contract TESTCONTRACT is ERC20, Ownable {
    ...
    address payable _marketingWallet = payable(address(0x76cf6911495026591B58351F9eD81c9Ae4dE2A15));
    address payable _devWallet = payable(address(0x76cf6911495026591B58351F9eD81c9Ae4dE2A15));
