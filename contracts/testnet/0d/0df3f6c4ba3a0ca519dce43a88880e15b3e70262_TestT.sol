...
contract TestT is IBEP20, Ownable {
    ...
    address public marketingFeeReceiver = 0xe4fACAF29bB7713A40EE537c56977b846Da6fd57;
...
//        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Mainnet
    ...
    function getBuyFees() public view returns( uint256, uint256, uint256, uint256){
    ...
    function getSellFees() public view returns( uint256, uint256, uint256, uint256){
