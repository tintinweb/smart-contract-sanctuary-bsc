...
contract BitOption is Pausable, Ownable, ReentrancyGuard {
    ...
    address public B2OToken = 0x5eb8Da29762d57f4ADD0dC634B010E34d6E83e37;
    uint256 public UNLOCK_PERIOD = 300;
    ...
    function getStakeInfo(address account, uint256 id) public view returns(StakeTokenInfo memory) {
        return stakeInfo[account][id];
    }

    function getStakeList(address account) public view returns(StakeTokenInfo[] memory) {
    ...
    function _stakeToken(address _to, uint256 _amount) private nonReentrant whenNotPaused { 
        ...
        StakeTokenInfo storage _stakeInfo = stakeInfo[_to][_userInfo.countStaked];
    ...
    function _unstakeToken(address _to, uint256 _amount) private nonReentrant whenNotPaused {
        ...
        require(_amount > 0 && _amount <= _userBalance(_to) && _amount <= _totalUnlocked(_to), "UnstakeToken: _amount invalid");
    ...
    function _withdrawToken(address _to, uint256 _amount) private nonReentrant whenNotPaused { 
        ...
        require(_amount > 0, "WithdrawTokenTo: _amount must be greater than zero");
