...
import "./GEUniversal.sol";

contract GEStakingCon  is GEUniversalCon {
    ...
    function _UnStakeUnlockedAmount(uint _amount,uint256 _tierslab) public updateReward(msg.sender,_tierslab) {
        ...
        usertier.lastUnStakedUpdateTime[_tierslab] -= _amount;
        useroverall.lastUnStakedUpdateTime -= _amount;
