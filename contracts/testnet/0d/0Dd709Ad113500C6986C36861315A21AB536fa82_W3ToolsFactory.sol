...
contract W3ToolsFactory  {
    ...
    address public immutable w3toolsErc1155Impl;
    ...
    constructor(BaseFactory _factory, address _w3toolsErc20Impl, address _w3toolsErc721Impl, address _w3toolsErc1155Impl) {
        factory = _factory;
        w3toolsErc20Impl = _w3toolsErc20Impl;
        w3toolsErc721Impl = _w3toolsErc721Impl;
        w3toolsErc1155Impl = _w3toolsErc1155Impl;
    }
    ...
    function createERC1155(string memory uri) public {
        ...
        address proxy = factory.deploy(w3toolsErc1155Impl, data);
        factory.transferOwnership(proxy, msg.sender);
