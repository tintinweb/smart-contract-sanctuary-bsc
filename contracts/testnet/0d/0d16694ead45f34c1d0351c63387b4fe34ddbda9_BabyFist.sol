...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  //0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684 test
...
contract BabyFist is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public  uniswapV2Pair;
    bool private swapping;
    SmartDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x52bf405DF2Ad2099420F0f17541c55A505B7001C;
    ...
    constructor() public ERC20("BabyFist", "BF") {

    	dividendTracker = new SmartDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        SmartDividendTracker newDividendTracker = SmartDividendTracker(payable(newAddress));
...
contract SmartDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
