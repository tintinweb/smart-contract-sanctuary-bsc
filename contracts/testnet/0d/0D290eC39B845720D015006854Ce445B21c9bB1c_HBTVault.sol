...
library SafeMath {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "Vault: addition overflow");
        return c;
    }
    ...
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b <= a, "Vault: subtraction overflow");
        return a - b;
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        if (a == 0) return 0;
        uint256 c = a * b;
        require(c / a == b, "Vault: multiplication overflow");
        return c;
    }
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b > 0, "Vault: division by zero");
        return a / b;
    }
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        require(b > 0, "Vault: modulo by zero");
        return a % b;
    }
...
contract HBTVault is ERC20, Ownable, ReentrancyGuard {
    ...
    function deposit(uint256 _amount) public nonReentrant {
        ...
        require(depositWhitelist[msg.sender], "can't deposit");
