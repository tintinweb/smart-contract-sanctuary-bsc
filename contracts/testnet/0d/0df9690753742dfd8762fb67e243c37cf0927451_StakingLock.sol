...
contract StakingLock is Ownable, ReentrancyGuard {
    ...
    function initialize(
        ...
        lockups.push(Lockup(0, 60, 0, 50, 142515006079443329000000000, 0, 0, 0)); // 1.5% liquidity
        lockups.push(Lockup(1, 90, 0, 30, 166267507092683883000000000, 0, 0, 0)); // 1.75% liquidity
        lockups.push(Lockup(2, 180, 0, 0, 190020008105924438000000000, 0, 0, 0)); // 2% liquidity
    ...
    *************************/
    ...
    function setServiceInfo(address _addr, uint256 _fee) external onlyOwner {
