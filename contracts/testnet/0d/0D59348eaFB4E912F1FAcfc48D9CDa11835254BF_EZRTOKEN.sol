    ...
    IDividendPayingTokenOptional
{
    ...
    address public dividendToken = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee;
...
contract EZRTOKEN is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;

    address public _dividendToken = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee;
    ...
    EZRTokenDividendTracker public dividendTracker;
    ...
    uint256 public buyFarmingFee = 3;
    ...
    uint256 public sellFarmingFee = 3;
    ...
    constructor() ERC20("EZRTOKEN", "EZR") {
        dividendTracker = new EZRTokenDividendTracker();

        teamWallet = 0x9A24337BbF6A553182692b5B9d20BC6818b1d853;
        farmingWallet = 0x71B74Ca34A6848a93Cd573023C5C98B87Adc2709;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "EZR: The dividend tracker already has that address"
        );

        EZRTokenDividendTracker newDividendTracker = EZRTokenDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "EZR: The new dividend tracker must be owned by the EZR token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "EZR: The router already has that address"
        );
    ...
    function updateFarmingAddress(address newAddress) public onlyOwner {
        excludeFromFees(farmingWallet, false);
        farmingWallet = newAddress;
        excludeFromFees(newAddress, true);
    }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "EZR: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "EZR: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "EZR: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "EZR: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "EZR: Cannot update gasForProcessing to same value"
        );
    ...
    function _transfer(
        ...
        if (tradingIsEnabled && automatedMarketMakerPairs[to]) {
            ...
            if (!swapping && canSwap) {
                ...
                uint256 bnbSwap = buyFarmingFee.add(buyTeamFee).add(
                    buyMarketingFee
                );
    ...
    function swapAndSendBnb(uint256 tokenAmount, uint256 totalFee) private {
        ...
        transferToWallet(
            payable(farmingWallet),
            address(this).balance.div(totalFee).mul(buyFarmingFee)
        );
        transferToWallet(
...
contract EZRTokenDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("EZR_Dividend_Tracker", "EZR_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "EZR_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "EZR_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EZR contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "EZR_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "EZR_Dividend_Tracker: Cannot update claimWait to same value"
        );
