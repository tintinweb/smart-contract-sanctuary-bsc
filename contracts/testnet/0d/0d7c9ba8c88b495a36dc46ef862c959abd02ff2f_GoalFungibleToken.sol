...
contract GoalFungibleToken is ERC721A, Ownable, ReentrancyGuard { //Change contract name from SampleNFTLowGas
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("GoalFungibleToken", "GFT")  { //change this line to your full and short NFT name
    seturi(_uri);
