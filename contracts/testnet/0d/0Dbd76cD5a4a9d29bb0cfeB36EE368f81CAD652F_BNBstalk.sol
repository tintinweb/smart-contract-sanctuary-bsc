...
abstract contract ReentrancyGuard {
    ...
    contract BNBstalk is Ownable , ReentrancyGuard {
    ...
    constructor() {
        dev1 = payable(0x0891b9b47C9D4c916e8e54ADD3c09E17efAE0842);
        dev2 = payable(0xFA969E897400E52D946399abA34b33F0153CB268);
    }
    ...
    function unStake() external noReentrant {
        ...
        dev1.transfer(UnstakeValueCore/2);
        dev1.transfer(UnstakeValueCore/2);
