...
contract MutoPool is Ownable {
  ...
  function initiatePool(
    ...
    function CheckUserId() external view returns(uint64){
        require(registeredUsers.hasAddress(msg.sender), "Not Registered Yet");
        return registeredUsers.getId(msg.sender);
    }
}