...
contract ASNZToken is ERC20, Pausable, Ownable {
    ...
    uint256 private _feeValue = 300; // 3%
    uint256 public constant FEE_BASE = 10000;

    constructor() ERC20("ASNZ", "ASNZ") {
     ...
     */
    function setFeeValeu(uint256 newFee) onlyOwner public returns (bool) {
        _feeValue = newFee;
     ...
     */
    function setFeeAddress(address account) onlyOwner public returns (bool) {
        _feeAddress = account;
     ...
     */
    function setWhitelist(address account, bool enable) onlyOwner public returns (bool) {
