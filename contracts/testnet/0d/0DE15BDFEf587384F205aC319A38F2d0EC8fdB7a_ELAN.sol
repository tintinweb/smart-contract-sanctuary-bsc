...
contract ELAN  is IBEP20, Auth {
    ...
    string constant _name = "Elan";
    string constant _symbol = "$ELAN";
    ...
    uint256 public swapThreshold = _totalSupply / 10000000;
    bool inSwap;
    ...
    function setMaxWalletPercent_base1000(uint256 maxWallPercent_base1000) external onlyOwner() {
        _maxWalletToken = (_totalSupply * maxWallPercent_base1000 ) / 1000000;
    }
    function setMaxTxPercent_base1000(uint256 maxTXPercentage_base1000) external onlyOwner() {
        _maxTxAmount = (_totalSupply * maxTXPercentage_base1000 ) / 1000000;
    }
