...
contract OCP is Context, IERC20, Ownable {
    ...
    uint256 private _time_presaleend = block.timestamp + 10 minutes;
    uint256 private _time_presalerelease = block.timestamp + 30 minutes;
    uint256 private _time_marketrelease = block.timestamp + 30 minutes;
    uint256 private _time_founderrelease = block.timestamp + 30 minutes;
