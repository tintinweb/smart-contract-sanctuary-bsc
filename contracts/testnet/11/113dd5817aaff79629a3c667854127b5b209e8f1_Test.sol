...
contract Test is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 10**9 * 10**9; // 1000000000 tokens
    ...
    address public _marketingWallet = payable(address(0x123)); // place your marketing wallet address here
    ...
    constructor() {
        ...
        maxWalletAmount = _tTotal.mul(2).div(100); // 2% of the supply (max wallet limit)
        maxTxAmount = _tTotal.mul(4).div(1000); // 0.4% of the supply (max tokens transfer per transaction)
        priceImpactPercent = 7; // price impact 7%
        isPriceImpactEnabled = true;
        minimumBuy = 0.0002 ether; // min buy 0.0002 bnb
...
// function to set price impact, it's state and min buy
