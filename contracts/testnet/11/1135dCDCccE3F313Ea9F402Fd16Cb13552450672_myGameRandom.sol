...
abstract contract VRFv2ConsumerBSC is VRFConsumerBaseV2 {
...
contract myGameRandom is VRFv2ConsumerBSC {

    VRFv2ConsumerBSC vrf;

    // uint[2][] public randomList;
    ...
    function play() public returns(uint) {
        uint request_id = vrf.requestRandomWords();
        // randomList.push([request_id, randomResult]);
        randomGame[request_id] = randomResult;
        return request_id;
    }
