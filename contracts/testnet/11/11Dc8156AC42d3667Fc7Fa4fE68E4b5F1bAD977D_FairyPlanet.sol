...
/**
 _______  _______ _________ _______    _______  _        _______  _        _______ _________
(  ____ \(  ___  )\__   __/(  ____ )  (  ____ )( \      (  ___  )( (    /|(  ____ \\__   __/
| (    \/| (   ) |   ) (   | (    )|  | (    )|| (      | (   ) ||  \  ( || (    \/   ) (   
...
telegram => https://t.me/+HANKnBywjcc1NDU9
 website => https://fairyplanet.io/
 twitter => https://twitter.com/FairyPlanet4
 discord => https://discord.gg/kCWVNtw6Dr
 youtube => https://www.youtube.com/channel/UCkq7Out-GNXwvZZfpFR-m6A
...
contract FairyPlanet is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "FairyPlanet";
    string private constant _symbol = "FRP";
    ...
    constructor(address payable marketingWalletAddress) {
        ...
        _maxTxAmount = _totalSupply.mul(8).div(100);
    ...
    function manualsend() internal {
        ...
        transfer(_marketingAddress, contractBalance);
    }
