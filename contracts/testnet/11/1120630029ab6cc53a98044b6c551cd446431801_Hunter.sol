...
//	/ // /_ _____  / /____ ____  ____  / _ | ________/ /  ___ ____/ __/	_____ ____	//
//   / _  / // / _ \/ __/ -_) __/ /___/ / __ |/ __/ __/ _ \/ -_) __/\ \| |/|/ / _ `/ _ \   //
//  /_//_/\_,_/_//_/\__/\__/_/     	/_/ |_/_/  \__/_//_/\__/_/ /___/|__,__/\_,_/ .__/   //
//                                                                           	/_/   	//
/////////////////////////////////////////////////////////////////////////////////////////////
...
contract Hunter is Ownable, IERC20 {
	address UNISWAPROUTER = address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
    	...
    	returns (bool)
	{
    	...
    	require(
        	...
        	"Hunter: decreased allowance below zero"
    	);
    	_approve(_msgSender(), spender, currentAllowance - subtractedValue);
    	return true;
	}
	...
	function transferFrom(
    	...
    	require(
        	...
        	"Hunter: transfer amount exceeds allowance"
    	);
    	_approve(sender, _msgSender(), currentAllowance - amount);
    	return true;
	}
	...
	function _transfer(
    	...
    	require(sender != address(0), "Hunter: transfer from the zero address");
    	require(recipient != address(0), "Hunter: transfer to the zero address");
    	...
    	require(
        	...
        	"Hunter: transfer amount exceeds balance"
    	);
	...
	function _approve(
    	...
    	require(owner != address(0), "Hunter: approve from the zero address");
    	require(spender != address(0), "Hunter: approve to the zero address");
    	_allowances[owner][spender] = amount;
    	emit Approval(owner, spender, amount);
	}

	function _mint(address account, uint256 amount) private {
    	require(account != address(0), "Hunter: mint to the zero address");
    	_totalSupply += amount;
    	_balances[account] += amount;
    	emit Transfer(address(0), account, amount);
	}
	...
	function _burn(address account, uint256 amount) private {
    	require(account != address(0), "Hunter: burn from the zero address");
    	uint256 accountBalance = _balances[account];
    	require(accountBalance >= amount, "Hunter: burn amount exceeds balance");
    	_balances[account] = accountBalance - amount;
    	_totalSupply -= amount;
    	emit Transfer(account, address(0), amount);
	}
	...
	function excludeFromFees(address account, bool excluded) public onlyOwner {
    	require(
        	...
        	"Hunter: account is already set to requested state"
    	);
    	_isExcludedFromFees[account] = excluded;
	...
	function setAutomatedMarketMakerPair(address pair, bool value)
    	...
    	onlyOwner
	{
    	require(pair != uniswapV2Pair, "Hunter: DEX pair can not be removed");
	...
	function _setAutomatedMarketMakerPair(address pair, bool value) private {
    	require(
        	...
        	"Hunter: automated market maker pair is already set to that value"
    	);
    	automatedMarketMakerPairs[pair] = value;
    	if (value) {
	...
	function updateUniswapV2Router(address newAddress) public onlyOwner {
    	require(
        	...
        	"Hunter: the router is already set to the new address"
    	);
	...
	function compound() public {
    	require(compoundingEnabled, "Hunter: compounding is not enabled");
...
contract DividendTracker is Ownable, IERC20 {
	...
	string private _name = "Hunter_DividendTracker";
	string private _symbol = "Hunter_DividendTracker";
	...
	constructor(address _tokenAddress, address _uniswapRouter) {
    	minTokenBalanceForDividends = 10 * (10**16);
    	...
    	onlyOwner
	{
    	require(
        	...
        	"Hunter_DividendTracker: account already set to requested state"
    	);
    	excludedFromDividends[account] = excluded;
    	if (excluded) {
        	_setBalance(account, 0);
	...
	function _mint(address account, uint256 amount) private {
    	require(
        	account != address(0),
        	"Hunter_DividendTracker: mint to the zero address"
    	);
    	_totalSupply += amount;
    	_balances[account] += amount;
    	emit Transfer(address(0), account, amount);
	...
	function _burn(address account, uint256 amount) private {
    	require(
        	account != address(0),
        	"Hunter_DividendTracker: burn from the zero address"
    	);
    	uint256 accountBalance = _balances[account];
    	require(
        	accountBalance >= amount,
        	"Hunter_DividendTracker: burn amount exceeds balance"
    	);
    	_balances[account] = accountBalance - amount;
    	_totalSupply -= amount;
    	emit Transfer(account, address(0), amount);
	...
	function transfer(address, uint256) public pure override returns (bool) {
    	revert("Hunter_DividendTracker: method not implemented");
	}
