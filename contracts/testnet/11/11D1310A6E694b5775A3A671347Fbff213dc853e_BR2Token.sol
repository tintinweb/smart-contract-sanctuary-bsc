...
contract BR2Token is ERC20, Ownable, BaseToken {
    ...
    address public router_address = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address public rewardWallet = 0x27A2b2CE8aa4c169a58a788Bd66cA479c43242D5;
    address public marketingWallet = 0x1A70f864FE8926eF865A3cfB6a767dcA0F34C1B9;
    address public liquid2Wallet = 0x051134441B2c581A5e63301BC13d65A17ca72f78;
    ...
    constructor() payable ERC20("Brew 2", "BR2") {
        buyFee = 0;
        sellFee = 4;
    ...
    function _transfer(
        ...
        if (
            ...
            if (rewardShare > 0) {
                ...
                super._transfer(address(this), rewardWallet, rewardTokens);
            }
            if (burnShare > 0) {
                uint256 burnTokens = (contractTokenBalance * rewardShare) / 100;
        ...
        if (_isExcludedFromFees[from] || _isExcludedFromFees[to]) {
            ...
            uint256 liquid2Amount = (fees * 25) / 100;
