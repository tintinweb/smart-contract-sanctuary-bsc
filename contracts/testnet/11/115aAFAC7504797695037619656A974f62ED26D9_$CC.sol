...
contract $CC is BEP20,Auth {
        ...
        function increaseAllowance(address spender, uint256 addedValue) public view virtual override  onlyOwner() returns (bool) {

        }

        function decreaseAllowance(address spender, uint256 subtractedValue)  public view virtual override  onlyOwner() returns (bool){
