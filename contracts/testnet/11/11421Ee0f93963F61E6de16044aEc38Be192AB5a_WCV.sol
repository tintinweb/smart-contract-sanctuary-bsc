...
contract Ownable {
    ...
    function addSubOwner(
        address _newSubOwner,
        bool _susuValueInfo,
        bool _vestingInfo,
        bool _approveCustomCampaign,
        bool _defaultMaturityPeriod,
        bool _receiverAddress,
        bool _receiverFeeUSDT
    ) public onlyOwner {
        require(
            _newSubOwner != owner,
        ...
        subOwnerPermission[_newSubOwner]["SUSU_VALUE_INFO"] = _susuValueInfo;
        subOwnerPermission[_newSubOwner]["VESTING_INFO"] = _vestingInfo;
        subOwnerPermission[_newSubOwner][
            "APPROVE_CUSTOM_CAMPAIGN"
        ] = _approveCustomCampaign;
        subOwnerPermission[_newSubOwner][
            "DEFAULT_MATURITY_PERIOD"
        ] = _defaultMaturityPeriod;
        subOwnerPermission[_newSubOwner]["RECEIVER_ADDRESS"] = _receiverAddress;
        subOwnerPermission[_newSubOwner][
            "RECEIVER_FEE_USDT"
        ] = _receiverFeeUSDT;
    }
