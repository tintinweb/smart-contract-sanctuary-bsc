    ...
    function addDownlineRef(address senderAddress, address refUserAddress, uint refLevel) internal {
	 ...
	 function distributeRef(address _referredBy,address _sender, bool _newReferral) internal {
        ...
        if(chkLv6 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {addDownlineRef(referralLevel5Address[_referredBy], _customerAddress, 6);}
        }
        ...
        if(chkLv7 != 0x0000000000000000000000000000000000000000) {
           ...
           if(_newReferral == true) {addDownlineRef(referralLevel6Address[_referredBy], _customerAddress, 7);}
        }
        ...
        if(chkLv8 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {addDownlineRef(referralLevel7Address[_referredBy], _customerAddress, 8);}
        }
        ...
        if(chkLv9 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {addDownlineRef(referralLevel8Address[_referredBy], _customerAddress, 9);}
        }
        ...
        if(chkLv10 != 0x0000000000000000000000000000000000000000) {
            ...
            if(_newReferral == true) {addDownlineRef(referralLevel9Address[_referredBy], _customerAddress, 10);}
        }
    }
