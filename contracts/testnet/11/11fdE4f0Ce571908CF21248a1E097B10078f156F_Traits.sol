...
contract Traits is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize() public initializer {
        ...
        randomSeed[0] = 114752457914154034703782719128603736432803673513545525954165806151979000397824;
        randomSeed[1] = 29838572442267453040084185676903427190593993171374796311914555256690368839680;
        randomSeed[2] = 58141763867902987667119455232087797452207670115993568857924173679224705515520;
        randomSeed[3] = 82597346046666049413878851392995477350609317175374626732720028451299016048640;
        randomSeed[4] = 85112136349967130187540267021579322470169402882651515496393425408278667460608;
        randomSeed[5] = 63903525220838285465581955374181076858537601383716369588878493749985247494144;
        randomSeed[6] = 64816503427654028815137830873280027735082919454727034624448142487716267819008;
        randomSeed[7] = 12280118959278067894011229406775167706083688932613123190071627905168171859968;
        randomSeed[8] = 88049384903444485368770698321999891596995709632116060396630288910230088581120;
        randomSeed[9] = 106746994646415493734242281455488537010170111446686222177118248838212209344512;
    ...
    function getRandomSeed(uint256 _tokenId) public view returns (uint256) {
        ...
        uint256 newseed = (randomSeed[_tokenId % 10] ^ (randomSeed[_tokenId % 10] >> 128) ) | randomSeed[(_tokenId/10) % 10] ;
        return newseed;
    }
    ...
    function getRandom(uint256 _tokenId) external view returns (uint256) {
        ...
        return
            uint256(
                keccak256(
                    abi.encodePacked(
                        random(_tokenId, getRandomSeed(_tokenId+1)),
                        tx.origin,
