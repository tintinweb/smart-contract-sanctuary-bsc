...
contract FavaLaunchpad{
    ...
    function rankDetails() public view returns(uint256, uint256, uint256, uint256, uint256, uint256,
                                               uint256, uint256, uint256, uint256, uint256, uint256){
        return(rank1,weight1,rank2,weight2,rank3,weight3,rank4,weight4,rank5,weight5,rank6,weight6);
    }
