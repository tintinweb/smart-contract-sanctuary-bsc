...
contract CSDOGEStaking is Ownable, ReentrancyGuard {
    ...
    {
        return (stakers[_user].TotalAmountStaked, stakers[msg.sender].unclaimedRewards, calculateRewards(_user), availableRewards(_user), stakers[msg.sender].lastUpdateTime - block.timestamp);
    }
