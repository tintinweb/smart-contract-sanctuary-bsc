...
contract ChainPalTransaction is Ownable, ReEntrancyGuard {
    ...
    uint256 public constant PAYMENT_HOD_DAYS = 3600;
    ...
    function claimTransactionAmount(string memory _uid) external noReentrant {
        ...
        if (
            ...
            sendBnb(escrowBonusAddress, transaction.fees.escrowBonus);
    ...
    /**
     * @dev Update escrow bonu address
     *
     * Requirements:
     * - _address : address
     *
     * - t- `msg.sender` must be the token owner
     */
    function updateEscrowBonusAddress(address _address) public onlyOwner {
        require(_address != address(0), "_address can not be the zero address");
