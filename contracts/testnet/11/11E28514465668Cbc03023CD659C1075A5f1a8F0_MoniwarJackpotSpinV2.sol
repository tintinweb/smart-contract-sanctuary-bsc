...
contract MoniwarJackpotSpinV2 is Ownable, ReentrancyGuard {
    ...
    function getFeeSpin(address account) public view returns (uint256 tokenId, uint256 amount, uint256 pricex1, uint256 pricex2, uint256 pricex3) {
        ...
        if (amount == 0) {
            pricex1 = mowaSpin;
            pricex2 = pricex2 * mowaSpin;
            pricex3 = pricex3 * mowaSpin;
        } else {
            if (amount >= pricex1) {
                pricex1 = (amount - pricex1) * mowaSpin;
            } else {
                pricex1 = (pricex1 - amount) * mowaSpin;
            }
            if (amount >= pricex2) {
                pricex2 = (amount - pricex2) * mowaSpin;
            } else {
                pricex2 = (pricex2 - amount) * mowaSpin;
            }
            if (amount >= pricex3) {
                pricex3 = (amount - pricex3) * mowaSpin;
            } else {
                pricex3 = (pricex3 - amount) * mowaSpin;
            }
        }
    }
