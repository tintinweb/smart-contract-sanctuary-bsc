...
contract SpacePay is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 _launchTimestamp = 1656551803;

    /// @notice tax varibles
    uint8 private _taxOnBuy;
    uint8 private _taxOnSell;

    address private _preSaleAddress = 0xE81B19b46c48eFdC4545aD15B3172AA791f0a3aE;
    address private _fairLaunchAddress = 0x54FCAAb442F0e92F8587b053f6455aFeD8fdB929;
    address private _marsPoolAddress = 0xA44AC7a13d88fc9b21Da354454900aBa818cBA83;
    address private _earnSystemAddress = 0xBF363cb69E1a3E8daE784596dc3B7BAd900BBCA1;
    address private _liquidityAddress = 0x8f0F3da786F55fD7c31D8fe7cceD930D49C39FF6;
    address private _teamAddress = 0xbEf6A17339574e04269Ee92B01fEb225538C8B5c;
    address private _exchangesAddress = 0xEdf0B0AA4eB7F6eb1A16D9b3E7b90743321e2020;
    address private _ecoSystemFoundAddress = 0xAd6eA67586Ec34AF8c2d42F78c0A126DD145dA57;
    ...
    constructor(
        ...
        _totalSupply += initialBalance * 10**decimals();
     ...
     */
    function setOnBuyTax(uint8 taxPercentage) public virtual onlyOwner {
    ...
    function setEcoSystemFoundAddress(address newAddress)
        public
        virtual
        onlyOwner
    {
    ...
    function launchTimestamp() public view virtual returns (uint256) {
        return _launchTimestamp;
    }

    function setLaunchTimestamp(uint256 launchTime) public virtual onlyOwner {
        _launchTimestamp = launchTime;
    }
