...
contract BSCSTAKING {
    ...
    uint256[5] public percentPerInterval = [40_00, 5_20, 5_50, 1_50, 2_50];
    ...
    uint256[5] public minDepositAmounts = [50000, 100, 1000, 5000, 50000];

    uint256[5] public maxDepositAmounts = [200000, 1000, 5000, 50000, 300000];
    ...
    function withdraw(uint256 _index) public {
        ...
        if (user.stakes[_index].extraBonus) {
            currentDividend =
                currentDividend +
                ((currentDividend * extraRewardPercentage) / percentDivider);
        }
