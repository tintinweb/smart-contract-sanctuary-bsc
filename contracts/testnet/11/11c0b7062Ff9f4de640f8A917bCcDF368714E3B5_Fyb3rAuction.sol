 ...
 */
contract Fyb3rAuction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using AddressUpgradeable for address;
    using SafeERC20 for IERC20;

    /// @notice Event emitted only on construction. To be used by indexers
    event Fyb3rAuctionContractDeployed();
        ...
        initializer
    {
        require(
            ...
            "Fyb3rAuction: Invalid Platform Fee Recipient"
        );

        platformFeeRecipient = _platformFeeRecipient;
        emit Fyb3rAuctionContractDeployed();
 ...
 */
        ...
        nonReentrant
    {
        ...
        IFyb3rMarketplace marketplace = IFyb3rMarketplace(
