...
contract GTEST is Context, IERC20, Ownable {
    ...
    string private constant _name = "GTEST CHECK";
    string private constant _symbol = "GTEST CHECK";
    uint8 private constant _decimals = 9;
    
    address payable private _developmentAddress = payable(0x9f239e0C5c21c3f5b129cDF2fe22A0c513e61Ea5);
    address payable private _marketingAddress = payable(0xA12109BfbF04d002BC6f863F386e5716fe1C2dee);
    address payable private _autoLiquidityReceiver = payable(0x73AD1f102d967D8a8b726FB9758d0272Ba1125e7);
