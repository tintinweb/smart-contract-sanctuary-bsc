    ...
    ERC721RoyaltyUpgradeable
{
    ...
    uint256 public constant decimalPrecesion = 100;

    function initialize3(uint256 _brokrage, address _brokerAddress)
        public
        initializer
    {
        __ERC721_init("BLEUFI NFT", "BLEUFINFT");
        __EIP712_init(SIGNING_DOMAIN, SIGNATURE_VERSION);
         maximumRoyality = 10000;
    ...
    function _bleufiMint(
        ...
        _setTokenRoyalty(tokenCount, to, _royality);
    }
        ...
        returns (uint256)
    {
        ...
        _setTokenRoyalty(tokenCount, creator, voucher.royality);
    ...
    function mint(
        ...
        _bleufiMint(_to, _royality, _tokenURI);
    }
  ...
  function testingUpgrade() pure public returns(string memory) {
        return "TestingUpgrade";
    }
}
