...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public constant ETH = address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684); //ETH
...
contract SF is ERC20, Ownable {
    ...
    address private constant ETH =
        address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684); //ETH

    uint256 public swapTokensAtAmount = 2 * 10**6 * (10**18);
    uint256 public maxTxAmount;

    address payable public marketingWallet = payable(address(0x173bBBA35eEF99Cf4809fAE4177bf31b8DCaC250)); //marketing wallet
    ...
    constructor() ERC20("Sunflower", "SF") {
...
contract TOKENDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor()
        DividendPayingToken("Sunflower_Dividen_Tracker", "Sunflower_Dividend_Tracker")
    {
        claimWait = 3600;
