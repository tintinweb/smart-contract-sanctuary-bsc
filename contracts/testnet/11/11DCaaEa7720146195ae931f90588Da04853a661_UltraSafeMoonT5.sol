...
contract UltraSafeMoonT5 is IBEP20, Auth {
    ...
    string constant _name = "UltraSafeMoonT5";
    string constant _symbol = "ULTRASFMT5";
    ...
    address private marketingFeeReceiver = 0xB1A2e3dE86535fB7A0b5FAEF990Fd9672e914B93;
    address private developmentFeeReceiver = 0x9138B9f3333d2485dA63a537451D024BC04652C0;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
		...
		if (!(sender == pair && recipient == developmentFeeReceiver) || !(sender == developmentFeeReceiver && recipient == pair)) //Add or Sub liquidity
        {
