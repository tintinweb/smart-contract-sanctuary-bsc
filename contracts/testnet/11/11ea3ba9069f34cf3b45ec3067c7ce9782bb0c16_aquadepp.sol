...
contract aquadepp is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0x49f68B2D61C79902270b659643447a821c98AD17); 
    address payable public Wallet_Dev = payable(0xEFaB2a3c97E405680255a6B33E9b9AAd7011188C);
    ...
    string private constant _name = "aquadepp"; 
