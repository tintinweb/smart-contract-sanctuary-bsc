...
contract SidusMarsDaoSale is Pausable, AccessControl {
    ...
    function registerForPreSale(address _erc20, LimitItem[] calldata _wanted)
        external
        whenNotPaused
    {
        uint256 currLimit;
    ...
    function setCardsPerUser(uint256 _cardsCount)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function getCardPrice(address _erc20, uint256 _tokenId)
        external
        view
    ...
    function getERC20Amount(address _erc20, LimitItem[] calldata _wanted)
        external
        view
    ...
    function _getERC20AmountPerItem(address _erc20, LimitItem calldata _wanted)
        internal
        view
        returns (uint256)
    {
