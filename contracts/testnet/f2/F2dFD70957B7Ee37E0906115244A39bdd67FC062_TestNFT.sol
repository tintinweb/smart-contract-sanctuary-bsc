...
contract TestNFT  is Ownable, ERC721Burnable, ERC721EnumerableEx {
     ...
     */
    string public baseUrl = "https://nft-collection.com/api/"; 
    ...
    function _doMint(uint8 _amount, address _to) internal {
