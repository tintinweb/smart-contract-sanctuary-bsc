...
contract WEMOVE is Context, IERC20, IERC20Extented, Ownable {
    ...
    uint256 public _rfiFee = 0; // divided by 1000
    ...
    uint256 public _teamFee = 0; // divided by 1000
    uint256 private _previousTeamFee = _teamFee;
    uint256 public _devFee = 0; // divided by 1000s
    ...
    constructor() {
        ...
        _transfer(_msgSender(),_rewardsAddress,rewards);
        _transfer(_msgSender(),_stakingAddress,staking);
        _transfer(_msgSender(),_ecoSystemAddress,ecosystem);
        _transfer(_msgSender(),_liqudityAddress,liquidity);
        _transfer(_msgSender(),_teamAddress,team);
        _transfer(_msgSender(),_marketingAddress,marketing);
    ...
    function setTaxes(uint256 marketingFee, uint256 liquidityFee, uint256 teamFee, uint256 devFee, uint256 rfiFee) external onlyOwner() {
        ...
        require(totalFee.div(10) < 60, "Sum of fees must be less than 30");
