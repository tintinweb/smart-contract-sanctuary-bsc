...
contract  BlindBox is  Ownable, ReentrancyGuard  {
    ...
    event BuyMultiBox(address indexed buyer, uint256 indexed materialId, uint256[] indexed receivedAmountArray);
    ...
    constructor() public {
        ...
        _materialIdToPrice[1] = 1 * 1e16;
        _materialIdToPrice[2] = 1 * 1e16;
    ...
    function buyMultipleBox(uint256 materialId, uint256 times) public nonReentrant{
        ...
        emit BuyMultiBox(_msgSender(), materialId, boxList);
    }
