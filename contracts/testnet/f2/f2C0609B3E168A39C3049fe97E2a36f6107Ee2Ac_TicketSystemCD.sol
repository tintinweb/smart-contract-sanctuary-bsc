...
contract TicketSystemCD is Ownable, ReentrancyGuard, Pausable {
    ...
    event TicketClaimed(address indexed recipient, uint256 numofTicket);
     ...
     * @param numOfTicket to select quantity of tickets to purchase
     */
    function claimTicket(address recipient, uint256 numOfTicket)
        external
        onlyAdmin
        whenNotPaused
        nonReentrant
    {
        ...
        emit TicketClaimed(recipient, numOfTicket);
    }
