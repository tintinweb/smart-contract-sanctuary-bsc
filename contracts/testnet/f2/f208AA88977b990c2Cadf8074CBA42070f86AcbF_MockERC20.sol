...
contract MockERC20 is Ownable, ERC20 {
    uint256 INITIAL_SUPPLY = 100000000 ether; //  Total supply 100000000 1e9 (decimals = 9)

    // mapping(address => uint256) private _faucets;
    // uint256 public constant faucetLimit = 500_000_000 * 10**18;
    ...
    //     require(msg.sender == owner() , "Onwer can mint only");
