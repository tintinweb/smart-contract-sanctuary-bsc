...
contract NorthStar {
    ...
    uint256 private constant CHEF_COST_IN_Dishes = 1_000_000; 
    uint256 private constant INITIAL_MARKET_Dishes = 100_000_000_000;
    ...
    //Creates Chefs + referal logic
    function makeChefs6Days(address ref) public requireKitchenOpen {
