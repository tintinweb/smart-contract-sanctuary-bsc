...
contract AgentOrangeHub is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xC8A2B6D6Ba5c496cf168b8dA7bbFbDf6282D42F1);
    address payable public devAddress = payable(0xC8A2B6D6Ba5c496cf168b8dA7bbFbDf6282D42F1);
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellDevFee <= 100, "Must keep taxes below 10%");
