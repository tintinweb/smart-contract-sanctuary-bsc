...
contract Eternal is Context, Ownable, Token {
    ...
    function deposit(address referrer, uint256 amount) public payable {
        ...
        _compoundBUSD(msg.sender); //compound accumulated divs before accepting new deposits.
    ...
    function airdrop(address receiver, uint256 amount) external {
        ...
        uint256 tax = amount.mul(_properties.compoundTax).div(percentDivider);
        ...
        ) 
    {
        ...
        _properties.sellAndCompoundTax,
