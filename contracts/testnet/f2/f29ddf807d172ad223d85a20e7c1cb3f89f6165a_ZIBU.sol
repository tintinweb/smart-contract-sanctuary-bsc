...
contract ZIBU is ERC20, Ownable {
    ...
    {   
        transferOwnership(0x3bEF52196aBAF96E628D7526a66E792e9449edb4);

        _mint(owner(), 1e12 * (10 ** 18));
        swapTokensAtAmount = totalSupply() / 5000;

    	dividendTracker = new DividendTracker(1e7, BUSD);
    ...
    function sendLMS(uint256 amount) private{
    ...
    function excludeFromLMS(address account, bool value) public onlyOwner {
        ...
        try lmsTracker.removeFromLMS(account) {} catch {}
    }
