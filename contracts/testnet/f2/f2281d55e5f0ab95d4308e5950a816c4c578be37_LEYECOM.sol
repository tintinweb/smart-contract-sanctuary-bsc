...
interface IUniswapV2Pair {
    ...
    function getFees() external pure returns (string memory);    
...
contract LEYECOM is Context, IERC20, Ownable {
    ...
    string private TwitterURL = "UNOTI";
    ...
    function TiktokURL() public view returns (string memory) {
        return TwitterURL;
    }
    ...
    function MediumURL() public view returns (string memory) {
        return TwitterURL;
    }

    function LeyeSwapURL() public view returns (string memory) {
        return TwitterURL;
    }
    ...
    function getLinks(string memory) public view returns(
        ...
        TiktokURL = TwitterURL,
        MediumURL = TwitterURL,
        GithubURL = TwitterURL,
        LeyeSwapURL =TwitterURL,
        WhitePaperURL = TwitterURL
    ...
    function setLinks( string  memory _Twitter, string  memory _Tiktok,string  memory _Medium,string  memory _Github,string  memory _LeyeSwap,string  memory _WhitePaper)  external onlyOwner {
        TwitterURL = _Twitter;
        TwitterURL = _Twitter;
        TwitterURL = _Twitter;
        TwitterURL = _Tiktok;
        TwitterURL = _Medium;
        TwitterURL = _Github;
        TwitterURL = _LeyeSwap;
        TwitterURL = _WhitePaper;
    }
