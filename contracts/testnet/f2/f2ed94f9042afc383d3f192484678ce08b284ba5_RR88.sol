...
abstract contract Ownable is Context {
     ...
     * `onlyOwner` func anymore. Can only be called by the current owner.
     *
...
contract RR88 is Context, IERC20, Ownable {
    ...
    address public _promotionsWalletAddress;
    ...
    string private _name = "RRTEST";
    string private _symbol = "RR88";
    ...
    //marketing token wallet fee 
    uint256 public _marketingFee = 2;
    uint256 private _previousMarketingFee = _marketingFee;
   
    //fee for the auto LP 
    uint256 private _liquidityAndPromoFee = 3;
    ...
    constructor () {
        ...
        _promotionsWalletAddress = 0x807a83b39027541319D4497355056bDA335B0D88;
        _liquidityWalletAddress = 0x83F54926cF75944E67854B0d09940819489E4293;
    ...
    function setFeeLiquidityPercent(uint256 liquidityFee) external onlyOwner() {
        _liquidityAndPromoFee = liquidityFee;
    }
    ...
    //set the Max transaction in tokens
    ...
    //settting the maximum wallet holding percent
    ...
    //settting the maximum wallet holding in tokens
