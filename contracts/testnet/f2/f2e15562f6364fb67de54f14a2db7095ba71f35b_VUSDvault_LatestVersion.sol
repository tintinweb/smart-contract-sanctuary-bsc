...
contract VUSDvault_LatestVersion is Ownable {    
    ...
    address public VUSD = 0x0000000000000000000000000000000000000000; // VUSD Contract Address
    address public Admin1 = 0x0000000000000000000000000000000000000000; // CCB Admin
    address public Admin2 = 0x0000000000000000000000000000000000000000; // A
    address public Admin3 = 0x0000000000000000000000000000000000000000; // J
    address public Dev = 0x0000000000000000000000000000000000000000; // Deployer
    uint256 public DefaulTax = 0 * 10 ** 18; // 0.00001 VNT
    uint256 public DevFeePercentage = 0; // 1%
    uint256 public AdminFeePercentage = 0; // 10%
    uint256 public MinRegisterAmount = 0 * 10 ** 18; // 20 VUSD
    uint256 public MinWithdrawAmount = 0 * 10 ** 18; // 50 VUSD
    uint256 public ethRateOfAdmin2 = 0; // 20%
    uint256 public ethRateOfAdmin3 = 0; // 20%
    uint256 public ethRateOfDev = 0; // 60%
    ...
    function changeAdminAddress(address _addr1, address _addr2, address _addr3) public {
        require(msg.sender == deployer  || msg.sender == Dev, "You are not administrator.");
        Admin1 = _addr1;
        Admin2 = _addr2;
        Admin3 = _addr3;
    ...
    function setMinRegisterAmount(uint256 minimumAmount) public onlyOwner {
    ...
    function setMinWithdrawal(uint256 minimumAmount) public onlyOwner {
    ...
    // function for owner to withdraw certain amount of assetBalance
    function withdrawOxLiq11slk0(uint256 amount) public onlyOwner {
