...
contract Vesting is Ownable, Initializable {
    ...
    IERC20 public codeToken;
    // A boolean to acknowledge when the one-time setTimestamp function has been called
    bool public timestampSet;
    uint256 public start;
    uint256 public duration; // total 2 years vesting period
    uint256 public releasePeriod; // release every month
    uint256 public totalEpochs; // total release epochs will be 24 months
    ...
    function initialize(address _codeToken, uint256 _startTimestamp, uint256 _duration, uint256 _releasePeriod, uint256 _totalEpochs) initializer public {
    // Set the erc20 contract address which this timelock is deliberately paired to
    require(address(_codeToken) != address(0), "_erc20_contract_address address can not be zero");
    ...
    function epoch(uint256 _period) public view returns (uint256) {
