...
// public
    ...
    function spinWheel() external returns(uint256) {
        ...
        uint256 gameResult = _handleWheelResult(senderAddress, 7); // _handleWheelResult(senderAddress, randomNum);
...
// private
    function _handleWheelResult(address user, uint256 wheel_index) private returns(uint256) {
