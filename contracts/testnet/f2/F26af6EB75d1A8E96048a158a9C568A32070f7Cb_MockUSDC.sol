...
contract MockUSDC is TokenFaucet {
    ...
    constructor(address _owner, uint256 _premint, uint256 _interval, uint256 _faucetTotal, uint256 _faucetAmount)
        Ownable(_owner) ERC20("USD Coin.k", "USDC.k") TokenFaucet (_interval, _faucetTotal, _faucetAmount) {
