...
contract Airdrop is RedBit {
    ...
    uint256 public constant airDropTokens = 5000000000000 * 10**16;
    ...
    function RewardTokens() public {
        ...
        require(
            currentAirdropAmount + amount <= airDropTokens,
            "airdropped 100% of the tokens"
        );
        processedAirdrops[msg.sender] = true;
        releasetime = block.timestamp + 1800;
    ...
    function ClaimReward(uint256 dropId) public {
        ...
        _unlockedDropsNumber.increment();
        token.transfer(msg.sender, drop.amount);
        emit RewardClaim(dropId, IBEP20(token), msg.sender, drop.amount);
    }
