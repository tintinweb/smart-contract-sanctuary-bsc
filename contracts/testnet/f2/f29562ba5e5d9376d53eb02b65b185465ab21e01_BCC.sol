...
contract BCC is Context, IERC20, Ownable {
    ...
    string private _name = "BCC CHAIN";
    string private _symbol = "BCC";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x0000000000000000000000000000000000000000);
    address payable public teamWalletAddress = payable(0x0000000000000000000000000000000000000000);
