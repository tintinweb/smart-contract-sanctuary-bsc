...
contract BABYTOKEN is ERC20, Ownable {
    ...
    // uint256 public lockedEndTime = 1653015000; // 輸入的時間：2022-05-20 10:50:0
    ...
    //test ["0x337610d27c682E347C9cD60BD4b3b107C9d34dDd",  "0x9ac64cc6e4415144c455bd8e4837fea55603e5c3",  "0x8Ff48A92eA8f3153821b218c4EC1f7214aAC3f6B", "0x0637C3a654B9A3E8213304a1e12632E77Cd89c0F", "0x8b22a7ab5c0a1c9463a2d770a39f724207761f02"]
    //main ["0x55d398326f99059fF775485246999027B3197955",  "0x10ed43c718714eb63d5aa57b78b54704e256024e",  "0x8Ff48A92eA8f3153821b218c4EC1f7214aAC3f6B", "0x0637C3a654B9A3E8213304a1e12632E77Cd89c0F", "0x8e268141daf54aa1fcdb5574a72feb0ec2fc3970"]
    // _wrapRouter 0x5619D0e70cC5a72558DCfbE2209b5a40b3de28bd
    // buy [5,4,1,1,3]
    // sell [5,4,1,1,3]
    // 100000000000
    constructor(
    ...
    function _transfer(
        ...
        require(_overLockedBalance(from, amount), "Over remain balance");
    ...
    function _overLockedBalance(address addr, uint256 out) private returns (bool){
        ...
        if(_lockedBalance[addr] == 0) {
            ...
            if(block.timestamp > lockedEndTime) {
                uint256 passDay = (block.timestamp - lockedEndTime) / dayTime;
