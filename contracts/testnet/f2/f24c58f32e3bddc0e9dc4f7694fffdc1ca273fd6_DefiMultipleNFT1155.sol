    ...
    ERC1155Burnable
{
    ...
    DefiMultiple public  DefiMultipleNFT1155Many;
    ...
    constructor(    
        ...
        string memory type2,
        address address2
    ) ERC1155("", "DefiMultiple", "DefiMultiple") { 
        _tid = id;
        deci = 18;
        ...
        DefiMultiple _DefiNFT1155 = DefiMultiple(adminContract);
        // set the rest of the contract variables
        DefiMultipleNFT1155Many = _DefiNFT1155;
    ...
    function _saleToken(
        ...
        serviceValue = DefiMultipleNFT1155Many.getServiceFee();
        address payable admin =  payable(DefiMultipleNFT1155Many.getOwner());
