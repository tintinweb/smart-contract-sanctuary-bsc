...
contract MasterKey3_2 is ERC721A, Ownable,Pausable,IMK {
 IContracts_TITIMITI Contr;
   ...
   string private URL;
    ...
    constructor( ) ERC721A("MasterKey3_2 - NFT by TITIMITI", "MK3_2", 10, 500000) {
    ...
    function MINT_Price_MasterKey_3_2 (address adr, uint256 amount)  public  {
    ...
    function SkillUP_3_2 (uint256 ID)  public {
        address sender =msg.sender;
    ...
    function WearUP_3_2 (uint256 ID, uint256 num_RepairKit) public {
         address sender =msg.sender;
        skillUP_c.GNFTtrans(num_RepairKit,sender);
        Wear[ID] = Wear[ID] + skillUP_c.GetWearPlus(num_RepairKit);
    }

    function OpeningMasterKey_3_2(uint256 ID, uint256 ChestLevel_) public {
