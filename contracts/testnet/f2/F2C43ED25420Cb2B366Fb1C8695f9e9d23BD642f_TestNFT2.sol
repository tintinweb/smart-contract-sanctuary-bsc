...
contract TestNFT2 is ERC721 {
    ...
    address private tokenAddr = 0x1d30962163b37aC7e87734B8Becc8Ad968838228;
    
    IERC20 private rmt;
    
    constructor() ERC721("TestNFT", "TNFT") {
        rmt = IERC20(tokenAddr);
    }

    function mint() external {
        _safeMint(msg.sender, mintedSupply);
        names[mintedSupply] = "default_name";
        mintedSupply++;
        // rmt.transferFrom(msg.sender, address(this), 1*10**18);
    }
