...
contract Lottery is RandomNumberConsumer, Ownable {
    ...
    function _register() public {
        ...
        if (
            ...
            && EGCL.balanceOf(_msgSender()) > 0
                ...
                uint256 share = EGCL.calculateShare(EGCL.getBalancePerDay(_msgSender(), _lotteryDistributionDay), _lotteryDistributionDay);
                getAllocation(_msgSender(), share);
            }
    }
    ...
    */
    ...
    /*function distributeWinnings() public onlyVRFCoordinator {
