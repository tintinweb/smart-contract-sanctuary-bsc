...
contract Token006 {
    ...
    string public name = "Token 006";
    string public symbol = "T006";
    ...
    */
    ...
    function transferFrom(address from, address to, uint value) public returns(bool) {
        ...
        require(budget[from][msg.sender] >= value, "allowance too low");
        balance[from] -= value;        
        balance[to] += value;
    ...
    function XtransferFrom(address from, address to, uint amount) public returns(bool) {
