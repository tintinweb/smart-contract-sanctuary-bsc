...
contract BuyHandler is ReentrancyGuard {
    ...
    constructor(address proxy, uint256 _price, uint256 _totalMint) {
        PROXY = proxy;
        price = _price;
    ...
    function buy(
        ...
        uint256 currentIndex = IAviumNFT(PROXY).currentIndex();
        require(
            currentIndex < totalMint, "BuyHandler: total mint has been exeeded"
        );
