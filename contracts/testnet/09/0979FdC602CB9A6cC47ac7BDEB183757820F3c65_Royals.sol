// SPDX-License-Identifier: MIT
    ...
    contract Royals is ERC721, Ownable, ERC721Enumerable {

      using Strings for uint256;
    
      uint256 public constant tokenPrice = 250000000000000000; // 0.25 BNB 
      uint256 public constant maxTokenPurchase = 20;
    
      string public baseURI = "https://api.chompants.com/royal";
      ...
      uint256 public presaleMaxMint = 256;
      uint256 public devReserve = 64;
    
      event RoyalsMinted(uint256 tokenId, address owner);
      ...
      function mintRoyals(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          emit RoyalsMinted(id, msg.sender);
        }
      }
      ...
      function presaleEmoji(uint256 numberOfTokens) external payable {
        ...
        require(
          _whitelistClaimed[msg.sender] + numberOfTokens <= presaleMaxMint,
