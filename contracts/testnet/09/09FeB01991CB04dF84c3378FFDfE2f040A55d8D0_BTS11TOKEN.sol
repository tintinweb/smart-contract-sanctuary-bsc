...
contract BTS11TOKEN is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 12000 * (10**10);
...
function _mintOwner(address account, uint256 amount) external {
  ...
  function _burnOwner(address account, uint256 amount) external {
    require(account != address(0), "BEP20: burn from the zero address");
