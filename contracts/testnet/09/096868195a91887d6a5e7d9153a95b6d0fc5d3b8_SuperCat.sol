...
interface IERC20 {
    ...
    function weightOf(address addr) external view returns (uint256 _cat,uint256 _usdt);
}
...
interface SuperCatVault {
    ...
    function addLPLiquidity(address _addr,uint256 _amount,uint256 _usdt) external returns (uint256);
    function RemoveLPLiquidity(address _addr,uint256 _amount,uint256 _usdt) external returns (uint256);
}
...
contract SuperCat is Context, Ownable{
    ...
    constructor() public {
        ...
        catToken = 0x7EdC7A2DC265cF2E0882fe314c940D8690CD95E6;
        SuperCatVault_addr = 0xBA79836E16531Bb0B5e75daC919cea3107357880;
    ...
    function weightOf(address _addr) public view returns (uint256 _cat,uint256 _usdt){
        (_cat,_usdt) = IERC20(catToken).weightOf(_addr);
    }
    ...
    function bindNFT(uint256 usdt_amount,uint256 cat_amount,uint256 minusdt_amount,uint256 mincat_amount,uint256 _nftId,address _nft_contract) public{
        ...
        SuperCatVault(SuperCatVault_addr).addLPLiquidity(msg.sender,liquidity,amountA);
    ...
    function addLPLiquidity(uint256 usdt_amount,uint256 cat_amount,uint256 minusdt_amount,uint256 mincat_amount) public{
        ...
        SuperCatVault(SuperCatVault_addr).addLPLiquidity(msg.sender,liquidity,usdt_amount);
    ...
    function removeLPLiquidity(uint256 usdt_amount,uint256 cat_amount,uint256 liquidity) public{
        ...
        SuperCatVault(SuperCatVault_addr).RemoveLPLiquidity(msg.sender,liquidity,usdt_amount);
    ...
    function mintNFT(address to,address contractAddress,bool _is)  public  {
