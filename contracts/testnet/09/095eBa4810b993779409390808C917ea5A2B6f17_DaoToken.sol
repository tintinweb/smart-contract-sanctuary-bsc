...
contract DaoToken is IERC20 {
    ...
    string private _name = "DotDao";
    string private _symbol = "DotDao";
    ...
    uint256 private _tTotal = 6666 * 1e9;
    ...
    constructor() {
        ...
        marketingAddress = 0xb1Fc8F04815A4badc4D8f4b45D63da01D8293510;
    ...
    function distributeMarketingAward() internal {
        if (IERC20(rewardToken).balanceOf(address(this)) == 0) return;
        IERC20(rewardToken).transfer(marketingAddress,IERC20(rewardToken).balanceOf(address(this)));
    }
