...
/*********************************************** Products ***********************************************/
    ...
    function FilterProductName(string memory item) public view returns(
        string memory batchid,
        address organizationid,
        string memory country,
        string memory region,
        ...
        return (
            ProductDetails[item].batchid,
            ProductDetails[item].organizationid,
            ProductDetails[item].country,
            ProductDetails[item].city,
            ProductDetails[item].region,
            ProductDetails[item].productiondate,
            ProductDetails[item].ingredients );
    }

    function FilterProductBatchID(string memory item) public view returns(
        string memory name,
        address organizationid,
        string memory country,
        string memory city,
        ...
        return (
            PrdBatchID[item].name,
            PrdBatchID[item].organizationid,
            PrdBatchID[item].country,
            PrdBatchID[item].city,
            PrdBatchID[item].testdate,
            PrdBatchID[item].productiondate,
            PrdBatchID[item].ingredients );
            }
    ...
    function  AddProduct(
        ...
        ProductDetails[Name].uid = ListOfProducts.length;
        ...
        ListOfProducts.push(ProductInfo(ListOfProducts.length,  Name, BatchID, OrganizationID, Country, Region, City, TestDate, ProductionDate, Ingredients));
        ...
        emit ProductAdded (ListOfProducts.length, Name,
        BatchID,
        OrganizationID,
        Country,
        Region,
    ...
    function getArrayIProductss() public view returns(ProductInfo[] memory) {
...
/*********************************************** Ingredients *********************************************/
    ...
    function IngredientsFilterName(string memory item) public view returns(
        uint256 uid,
        string memory name,
        string memory batchid,
        address organizationid,
    ...
    function IngredientsFilterBatchID(string memory item) public view returns(
        uint256 uid,
        string memory name,
        string memory batchid,
        address organizationid,
        ...
        return (
            IngBatchID[item].uid,
            IngBatchID[item].name,
            IngBatchID[item].batchid,
            IngBatchID[item].organizationid,
            IngBatchID[item].location,
            IngBatchID[item].lotNumber );
            }
    ...
    function  AddIngredient(
        ...
        IngredientDetails[Name].uid = ListOfIngredients.length;
        ...
        ListOfIngredients.push(IngredientInfo(ListOfIngredients.length, Name, BatchID, OrganizationID, Location, LotNumber));
        IngredientsName.push(Name);


        IngBatchID[BatchID].uid = ListOfIngredients.length;
        ...
        emit IngredientAdded (ListOfIngredients.length, Name,
        BatchID,
        OrganizationID,
        Location,
        LotNumber
...
/***
    ...
    *****/
    ...
    mapping(uint256 => Certificates) public CertificatesList;

    function AddCertificates(uint256 Uid, string memory url) public {
        require(
            AdminsDetails[msg.sender].role == roles.admin,
            "Only admin can call this function"
        );

        CertificatesList[Uid].UID = Uid;
        CertificatesList[Uid].URL = url;
