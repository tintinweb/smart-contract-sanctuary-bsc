...
contract CarvEvents is Initializable, ERC1155Upgradeable, OwnableUpgradeable, PausableUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, ERC1155URIStorageUpgradeable, UUPSUpgradeable {
    ...
    */
    ...
    function metaCarv(uint256 cid, bytes memory functionSignature,
        bytes32 sigR, bytes32 sigS, uint8 sigV) public payable returns (bytes memory) {

        require(!minted[cid], "Already carved");
        require(verify(cid, getChainID(), functionSignature, sigR, sigS, sigV), "Signer and signature do not match");
    ...
    function verify(uint256 cid, uint256 chainID, bytes memory functionSignature,
