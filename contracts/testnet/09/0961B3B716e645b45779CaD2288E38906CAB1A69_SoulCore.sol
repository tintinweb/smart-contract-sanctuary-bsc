...
contract SoulCore is DivestorUpgradeable, RandomGeneratorUpgradeable, ERC1155HolderUpgradeable{
    ...
    event CreateBlindBox(address indexed player, address indexed recommender, uint gender, uint probability, uint amount, uint soulCount, uint tokenId);
    event OpenBlindBox(address indexed player, address indexed recommender, uint gender, uint probability, uint tokenId);
    ...
    function createToken(uint gender, uint amount, uint soulCount, address recommender) public returns(bool){
        ...
        emit CreateBlindBox(_msgSender(), recommender, gender, probability, amount, soulCount, tokenId);
