...
contract T69 is IBEP20, Auth {
    ...
    // switch Trading
    function WenLaunch(uint256 _swapAt, uint256 _swapDelay) public onlyOwner {
        tradingOpen = true;
