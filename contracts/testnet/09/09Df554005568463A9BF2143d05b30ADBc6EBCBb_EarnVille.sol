...
contract EarnVille is ERC20Detailed, Ownable {
    ...
    uint256 public maxJackpotMultiplier = 5;
    ...
    uint256 public maxSellTransactionAmount = 1000 * 10**DECIMALS; // 1%
        ...
        Ownable()
    {
        ...
        earnVilleInsuranceFundReceiver = 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266;
    ...
    function _transferFrom(
        ...
        if (sender == pair && isJackpotEligible(amount)) {
            ...
            _lastBuyBUSDValue = tempConvert(amount);
        }
    ...
    function tempConvert(uint256 amount) public view returns(uint256) {
    ...
    function awardJackpot() internal swapping {
        ...
        if (cashedOut > _lastBuyBUSDValue.mul(maxJackpotMultiplier)) {
            cashedOut = _lastBuyBUSDValue.mul(maxJackpotMultiplier);
        }
    ...
    function setMaxJackpotMultiplier(uint256 _maxJackpotMultiplier)
        external
        onlyOwner
    {
        maxJackpotMultiplier = _maxJackpotMultiplier;
    }
