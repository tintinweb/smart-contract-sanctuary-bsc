...
contract working is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
    payable(0xFb1E36A4364bB28fD43c8474B4264Dd45A18A6fF);
    ...
    string private constant _name = "Testeris";
...
maxTransactionAmount = _tTotal * 10 / 1000; // 1.5% maxTransactionAmountTxn
maxWalletAmount = _tTotal * 20 / 1000; // 3% maxWalletToken
