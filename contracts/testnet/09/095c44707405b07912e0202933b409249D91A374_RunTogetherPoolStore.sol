...
interface IRunTogetherPool {
  function withdraw(uint256 _amount) external returns(bool);
}

// contract RunTogetherPool {
...
// }
contract RunTogetherPool is Ownable, ReentrancyGuard, IRunTogetherPool {
     ...
     * @param _amount: amount to withdraw (in rewardToken)
     */
    function withdraw(uint256 _amount) public virtual override nonReentrant isRun returns(bool) {
        require(blacklistMap[msg.sender] == false, "You are in Blacklist");
        UserInfo storage user = userInfo[msg.sender];
...
contract RunTogetherPoolStore is Ownable, ReentrancyGuard {
    ...
    RunTogetherPool runTogetherPoolInfo;
    IRunTogetherPool IRunTogetherPoolInfo;
    ...
    constructor (address _runTogetherPoolAddress) {
        ...
        runTogetherPoolInfo = RunTogetherPool(_runTogetherPoolAddress);
    }
    ...
    function withdraws() public {
      runTogetherPoolInfo.withdraw(0);
    }
}
