...
contract CommunityFund is ICommunityFund,Ownable{
    ...
    function init(address _lucaToken, address[] calldata _nodeAddrs) external initializer{
        __Ownable_init_unchained();
        __CommunityFund_init_unchained(_lucaToken, _nodeAddrs);
    }

    function __CommunityFund_init_unchained(address _lucaToken, address[] calldata _nodeAddrs) internal initializer{
