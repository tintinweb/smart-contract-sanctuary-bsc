...
contract MODULOTEST is IBEP20, Ownable {
    using SafeMath for uint256;
    string constant _name = "MODDEITY";
    string constant _symbol = "MODGOD";
    ...
    address public marketingFeeReceiver = 0x6C6763cF558517b1Fd3564F0D429f0DD905085b9;
    address public buybackFeeReceiver = 0x64Dae2A1e639FE6E736fE093dDe9e1fe630e7440;
...
//		router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Testnet
    ...
    function swapBack(uint256 internalThreshold) internal swapping {
        ...
        uint256 amountToLiquify = internalThreshold.mul(swapLiquidityFee).div(totalFee).div(2);
