...
contract TaxOptions is Ownable {
        ...
        returns (Tvalues memory)
    {
        ...
        tValues.burnTax = tAmount.mul(_burnTax).div(10**2);
        tValues.TeamTax = tAmount.mul(_TeamTax).div(10**2);
        tValues.liquidityTax = tAmount.mul(_liquidityTax).div(10**2);
        tValues.rAndDTax = tAmount.mul(_rAndDTax).div(10**2);
        tValues.marketingTax = tAmount.mul(_marketingTax).div(10**2);
