...
import "./interfaces/IUniswapLiquidityProvider.sol";

contract LiquidityProvider is IUniswapLiquidityProvider, Initializable, OwnableUpgradeable {
    struct API {
...
interface IUniswapLiquidityProvider {
    function addLiquidityETH(
        address,
        address,
        uint256,
