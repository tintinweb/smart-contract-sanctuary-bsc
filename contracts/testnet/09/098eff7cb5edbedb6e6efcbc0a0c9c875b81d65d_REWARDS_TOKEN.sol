...
Needs Pre launch access to add the liquidity!!! 
Can't add liquidity with launch mode active for first hour! 
Owner needs to be dividend exempt???
...
contract REWARDS_TOKEN is Context, IERC20 { 
    ...
    address private _developer = 0xD05895EDF847e1712721Cc9e0427Aa26289A6Bc5;
   ...
   /// IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);
    ...
    modifier onlyOwner_or_Developer() {
        ...
        if (owner() == address(0)) {
                ...
                require(_developer == _msgSender(), "XXX");
    ...
    */
    ...
    function Contract_SetUp_03__Wallet_Limits(
        ...
        // Maximum limits of 3%
        require(Max_Tokens_Per_Transaction <= _tTotal / 100 * 3 / 10**_decimals, "E03");
        require(Max_Total_Tokens_Per_Wallet <= _tTotal / 100 * 3 / 10**_decimals, "E04");
    ...
    // Contract launches in honey pot mode to traps bots!
    bool public BlackList_Mode;
    bool public BlackList_Possible;
    ...
    */
    ...
    function Contract_SetUp_06__Blacklist_Bots(
        ...
        if (true_or_false){require(BlackList_Possible, "E06");}
    ...
    */
    ...
    function Maintenance__Renounce_Ownership(uint256 Enter_Confirmation_Code__1234) public virtual onlyOwner {
        ...
        require(Enter_Confirmation_Code__1234 == 1234, "XXX");
    ...
    */
    ...
    function Deactivate_Launch_Mode() external onlyOwner {
    ...
    function BlackList_Mode_Switch(bool true_or_false) external onlyOwner {
    ...
    */
    ...
    // During Honey Pot Mode the Liquidity Tokens can not be removed! 
