...
contract PINK is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x187841B8a4F1D197183a26741fcD40BF3D996C9A));
        marketingWalletAddress = payable(address(0x187841B8a4F1D197183a26741fcD40BF3D996C9A));
