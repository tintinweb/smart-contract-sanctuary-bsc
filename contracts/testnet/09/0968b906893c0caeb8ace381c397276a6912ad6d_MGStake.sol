...
contract MGStake is Context,Ownable{
    ...
    mapping(address => mapping(uint256=>uint256)) public nextBuy;
    mapping(uint256 => mapping(uint256 => uint256)) public minerGroup;
    ...
    constructor () {
        ...
        address topUser=address(0xBA1A1d2dcF4091BC4F5ac8873D140345b6974599); //0x3D5DcF713766c3cE6fd664838a8363B78D4f34C8
    ...
    function deposit(address referrer,uint256 minerId) external returns (bool) {
        ...
        require(nextBuy[sender][minerId] < _timestamp,"Invalid Block Num");
        require(store(minerId)>0,"Invalid store");
        nextBuy[sender][minerId]=_timestamp.add(86400);
        ...
        (uint256 usdtNum,uint256 hashRate,)=_minerType(minerId);
