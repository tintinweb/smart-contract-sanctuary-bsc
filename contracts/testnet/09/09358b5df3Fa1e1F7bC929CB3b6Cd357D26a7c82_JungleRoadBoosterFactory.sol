...
/**
 * @title JungleRoadBoosterFactory
 * Booster - a factory contract for Jungle Road semi-fungible
 * tokens.
 */
contract JungleRoadBoosterFactory is Ownable, ReentrancyGuard, Pausable {
    IERC1155Tradable public immutable booster;
    IERC1155Tradable public immutable lootBox;
    IERC20 public immutable busd;

    // The number of booster (not rarity classes!)
    uint256 public constant NUM_ITEM_OPTIONS = 2; // ID 0-1
    uint256 public constant MAX_LOOTBOX_SUPPLY = 10000;
    uint256 public constant LOOTBOX_ID = 0;
    uint256 public constant BOX_PRICE = 39 ether;
     ...
     */
    function mintBooster(uint256 _optionId, address _toAddress)
        external
        nonReentrant
        whenNotPaused
        canUnbox(_optionId)
    {
        ...
        _mintBooster(_optionId, _toAddress);
    ...
    /**
     * booster are minted here
     */
    function _mintBooster(uint256 _option, address _toAddress) private {
        opened += 1;
        booster.mint(_toAddress, _option, 1, "");
    }
