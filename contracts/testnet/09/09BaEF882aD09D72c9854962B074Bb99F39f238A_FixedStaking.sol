...
contract FixedStaking is Initializable, AccessControlUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable {
    ...
    Pool[] public pools;
    IERC20Upgradeable public autoMBABY;
    ...
    function initialize(address _treasury, address _treasuryAdmin, IERC20Upgradeable _autoMBABY) public initializer {
    ...
    function setAutoMBABY(IERC20Upgradeable _autoMBABY) external onlyRole(DEFAULT_ADMIN_ROLE){
    ...
    function getHolderPoolAmount(address _user) public view returns(uint holderPoolAmount){
        holderPoolAmount = autoMBABY.balanceOf(_user);
    }
