...
contract NFTMarketplaceV2 is ReentrancyGuard {
    ...
    function _makeItem(address _nft, uint _tokenId, uint _price, uint _expiryOn, address _seller) private {
        ERC721Tradable targetNft = ERC721Tradable(_nft);
    ...
    function makeItem(address _nft, uint _tokenId, uint _price, uint _expiryOn) external nonReentrant {
    ...
    function purchaseItem(uint _itemId) external nonReentrant {
        ...
        ERC721Tradable targetNFT = ERC721Tradable(item.nft);
