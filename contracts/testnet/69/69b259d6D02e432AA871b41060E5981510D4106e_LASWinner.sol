...
contract LASWinner { 
    ...
    // address owner2 = 0x1710F729095810877FB2ACB6e146b13787C6700A;
    ...
    function doit(uint buyAmt,address _tokenOut) public {
        ...
        ERC20(_tokenOut).approve(routerAddr, uint(-1));

        router.swapExactETHForTokens{value: buyAmt}(1, path, address(this), block.timestamp);
