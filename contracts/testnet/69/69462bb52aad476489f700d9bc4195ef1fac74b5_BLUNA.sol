...
contract BLUNA is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyAmount = _tTotal.mul(2).div(10000);
    uint256 public maxSellAmount = _tTotal.mul(1).div(1);
    uint256 public swapTokensAtAmount = 500000 * 10**_decimals;
    uint256 public _maxWalletSize = 20000000 * 10**9; 
    uint256 public buyBackUpperLimit = 1 * 10**18;

    address public marketingAddress = 0xE7a966F68FB501CC18CFF9F21dd7f35BdD61217c;
    address public operationsAddress = 0xE7a966F68FB501CC18CFF9F21dd7f35BdD61217c;
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private constant _name = "Baby Luna DAO";
