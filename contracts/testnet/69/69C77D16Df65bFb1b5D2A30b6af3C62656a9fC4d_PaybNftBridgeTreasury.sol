...
contract PaybNftBridgeTreasury is Ownable, ReentrancyGuard{
    ...
    IPaybNftMarketplace public market;
    constructor(address _market){
        market = IPaybNftMarketplace(_market);
    }
...
interface IPaybNftMarketplace{
    function getTokenInfo(uint256 tokenId) external view returns(uint256,uint256,uint256,uint256,address,address,string memory,bool,bool,bool,bool);
}
