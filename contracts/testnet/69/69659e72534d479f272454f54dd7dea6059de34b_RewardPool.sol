...
contract LPTokenWrapper {
    ...
    IERC20 public y = IERC20(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd);
...
contract RewardPool is LPTokenWrapper, IRewardDistributionRecipient {
    IERC20 public yfi = IERC20(0x2Cc0A52b4581d483Fc6bDD733c3CDaAD86Ca0b2f);
    ...
    function stake(uint256 amount) public updateReward(msg.sender) {
        ...
        require(block.timestamp > 1648919420, "Cannot stake yet");
        super.stake(amount);
