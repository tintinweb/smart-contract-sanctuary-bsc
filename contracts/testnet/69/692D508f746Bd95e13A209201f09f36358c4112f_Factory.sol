...
contract Factory 
{
    ...
    function deployToken(uint256 initialSupply, string calldata name, uint8 decimalUnits, string calldata symbol, address tokenOwner) public returns (address) 
    {
        ERCToken token = new ERCToken(initialSupply, name, decimalUnits, symbol, tokenOwner);
