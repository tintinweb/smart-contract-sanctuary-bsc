...
contract T2411TT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    T2411TTDividendTracker public dividendTracker;
    ...
    constructor() ERC20("T2411TT", "$TT") {
        ...
        dividendTracker = new T2411TTDividendTracker(
            payable(this),
            router,
...
contract T2411TTDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    T2411TT public T2411TTContract;
    ...
    constructor(
        ...
        defaultToken = token;
        T2411TTContract = T2411TT(mainContract);
    ...
    function _transfer(
        ...
        require(false, "T2411TT_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "T2411TT_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main T2411TT contract."
        );
    }
