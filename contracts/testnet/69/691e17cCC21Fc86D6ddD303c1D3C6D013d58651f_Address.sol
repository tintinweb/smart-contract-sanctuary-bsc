...
abstract contract Ownable is Context {
    ...
    constructor () {
        ...
        // actio-dev-01 0xd008df4fFf523a86e9e4D57FC7bAc39fe02346a6
        _owner = 0xd008df4fFf523a86e9e4D57FC7bAc39fe02346a6;
...
contract AioContract is Context, IERC20, Ownable {
    ...
    // address actio-dev-02 0xBF85c1cE85F016B3ab0c11477102597A81961C4B
    address private _developmentWalletAddress = 0xBF85c1cE85F016B3ab0c11477102597A81961C4B;
    
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 5000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Actio19";
    string private _symbol = "AIO19";
    ...
    // log
    uint256 public mylogCount;
    struct mylogObj {
        address from;
        address to;
        uint256 amount;
        uint256 jenis;      // 1: transfer standard, 2: transfer to excluded, 3: transfer from excluded
    }
    mapping(uint256 => mylogObj) public mylogs;
    struct mylogFeeObj {
        uint256 aaRTotal;
        uint256 aaFeeTotal;
    }
    mapping(uint256 => mylogFeeObj) public mylogFees;
    struct mylogSwapObj {
        uint256 oTokenAmount;
        uint256 oGakTahu;     // biasanya nol 
        address oPathThisAddress;
        address oPathUniswapAddressWeth;
        address oThisAddress;
        uint256 oTimestamp;
    }
    mapping(uint256 => mylogSwapObj) public mylogswaps;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public override returns (bool) {
        ...
        // INI SANGAT JANGGAL. HARUSNYA APPROVE DULU BARU BISA DI TRANSFER
        // APAKAH INI APPROVE UNTUK ROUTER?
    ...
    function _reflectFee(uint256 rFee, uint256 tFee) private {
        ...
        // log
        mylogFees[mylogCount] = mylogFeeObj(_rTotal, _tFeeTotal);
    }
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        // log
        mylogswaps[mylogCount] = mylogSwapObj(
            tokenAmount,
            0, 
            path[0],
            path[1], 
