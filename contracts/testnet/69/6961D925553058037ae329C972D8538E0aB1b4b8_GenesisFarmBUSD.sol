...
/**
Welcome to Satoshi's Bank!
The first BTC miner made on Binance Smart Chain
3.5% Daily | Sustainable Static ROI Yield Farm on you favourite coin, BTC!

Launching 14th of August, 8PM UTC
by Metaminers, trusted and known Team (Ruby Mine, Rothschild Winery)

Satoshi'bank (BTCB) official Dapp:
Website: https://satoshisbank.com/
*/
...
contract GenesisFarmBUSD {
    ...
    IERC20 public token = IERC20(0x6ce8dA28E2f864420840cF74474eFf5fD80E65B8); //** testnet
    ...
    uint256 constant public PROJECT_FEE_2 = 500;
	...
	function withdraw(uint256 amounts) public {

		uint256 fee2 = amounts.mul(PROJECT_FEE_2).div(PERCENTS_DIVIDER);
