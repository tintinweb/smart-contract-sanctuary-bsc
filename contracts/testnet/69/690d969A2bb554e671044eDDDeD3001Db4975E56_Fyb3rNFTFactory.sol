...
import "./Fyb3rNFTTradable.sol";

contract Fyb3rNFTFactory is Ownable {
    ...
    */
        ...
        returns (address)
    {
        ...
        Fyb3rNFTTradable nft = new Fyb3rNFTTradable(
            _name,
            _symbol,
            auction,
            marketplace,
...
/**
 * @title Fyb3rNFTTradable
 * Fyb3rNFTTradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract Fyb3rNFTTradable is ERC721URIStorage, Ownable {
    /// @dev Events of the contract
    event Minted(
        uint256 tokenId,
        address beneficiary,
