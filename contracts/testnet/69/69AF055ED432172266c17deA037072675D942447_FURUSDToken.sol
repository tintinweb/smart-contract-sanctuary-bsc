...
contract FURUSDToken is BaseContract, ERC20Upgradeable {
    ...
    address public furfiVaultManagerAddress;
    address public furfiStabilityPoolAddress;
    address public furfiBorrowerOperationsAddress;
    address public furVaultManagerAddress;
    address public furStabilityPoolAddress;
    address public furBorrowerOperationsAddress;

    function initialize( uint256 initialMintAmount) public initializer
    {  
        __BaseContract_init();
    ...
    event FurFiLiquityAddressesChanged(
        address _furfiVaultManagerAddress, 
        address _furfiStabilityPoolAddress,
        address _furfiBorrowerOperationsAddress
    );

    event FurLiquityAddressesChanged(
        address _furVaultManagerAddress, 
        address _furStabilityPoolAddress,
        address _furBorrowerOperationsAddress
    );


    function setFurFiLiquityAddresses (
        address _furfiVaultManagerAddress,
        address _furfiStabilityPoolAddress,
        address _furfiBorrowerOperationsAddress
    ) external onlyOwner {
        furfiVaultManagerAddress = _furfiVaultManagerAddress;
        furfiStabilityPoolAddress = _furfiStabilityPoolAddress;
        furfiBorrowerOperationsAddress = _furfiBorrowerOperationsAddress;

        emit FurFiLiquityAddressesChanged(
            _furfiVaultManagerAddress, 
            _furfiStabilityPoolAddress, 
            _furfiStabilityPoolAddress
        );
    }

    function setFurLiquityAddresses (
        address _furVaultManagerAddress,
        address _furStabilityPoolAddress,
        address _furBorrowerOperationsAddress
    ) external onlyOwner {
        furVaultManagerAddress = _furVaultManagerAddress;
        furStabilityPoolAddress = _furStabilityPoolAddress;
        furBorrowerOperationsAddress = _furBorrowerOperationsAddress;

        emit FurLiquityAddressesChanged(
            _furVaultManagerAddress, 
            _furStabilityPoolAddress, 
            _furStabilityPoolAddress
        );
    }
    ...
    function _requireValidRecipient(address _recipient) internal view {
        ...
        require(
            _recipient != furfiStabilityPoolAddress && 
            _recipient != furfiVaultManagerAddress && 
            _recipient != furfiBorrowerOperationsAddress, 
    ...
    function _requireCallerIsBorrowerOperationsOrOwner() internal view {
        require(
            msg.sender == furfiBorrowerOperationsAddress ||
            msg.sender == furBorrowerOperationsAddress ||
            msg.sender == owner(), 
            "FURUSDToken: Caller is neither BorrowerOperations nor Owner");
    }

    function _requireCallerIsBOorVaultMorSPOrOwner() internal view {
        require(
            msg.sender == furfiBorrowerOperationsAddress ||
            msg.sender == furfiVaultManagerAddress ||
            msg.sender == furfiStabilityPoolAddress ||
            msg.sender == furBorrowerOperationsAddress ||
            msg.sender == furVaultManagerAddress ||
    ...
    function _requireCallerIsStabilityPool() internal view {
        require(
            msg.sender == furfiStabilityPoolAddress ||
            msg.sender == furStabilityPoolAddress,
            "FURUSD: Caller is not the StabilityPool");
    }
