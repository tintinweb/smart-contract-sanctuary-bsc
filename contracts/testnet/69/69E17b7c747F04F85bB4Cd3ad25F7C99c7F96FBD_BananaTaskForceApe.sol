...
contract BananaTaskForceApe is Context, IERC20 {
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x024cd9a40a7f780d9F3582496A5f3c00bb22c3C6)
        });
    ...
    constructor () payable {
        ...
        dexRouter = IRouter02(0xc99f3718dB7c90b020cBBbb47eD26b0BA0C6512B); // TESTNET - https://pancakeswap.rainbit.me/
