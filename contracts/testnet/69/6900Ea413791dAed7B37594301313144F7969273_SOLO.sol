...
contract SOLO is Context, IBEP20, Ownable {
    ...
    address public _marketingWallet = 0xcBaC15E0eeAEC3A96D0a7032d883Aef6C02306dF;
    ...
    string private _name     = "SOLO METAVERSE";
    string private _symbol   = "SOLO";
    uint8 private  _decimals = 9;
    
    uint256 public _taxFee          = 0; 
    uint256 public _marketingFee    = 4; 
    uint256 public _liquidityFee    = 6;    //liquidity + marketing
    uint256 public _swapThreshold   = _tTotal * 5/1000; //0.5%;
	...
	function calculateMarketingFee(uint256 amount) private view returns (uint256) {
        //uint256 marketingFeeInPercent = _marketingFee.div(_liquidityFee);
