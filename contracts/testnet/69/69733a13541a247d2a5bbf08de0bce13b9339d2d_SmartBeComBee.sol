...
contract SmartBeComBee {
    ...
    function buyLevel(uint8 matrix, uint8 level) external payable {
        ...
        require(msg.value == levelCost[level]/100000, "invalid price");
    ...
    function sendETHDividends(address userAddress, address _from, uint8 matrix, uint8 level) private {
        ...
        //busd
        transfertokenbusd(receiver, level);
    ...
    function transfertokenbusd(address receiver, uint8 level) private {
        require(msg.value > 0, "invalid price");

        _token = IERC20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
        _token.transfer(receiver, levelCost[level]/100000);
    }

    function transfertoken(address receiver, address tokenAddress, uint8 level) external payable {
        require(msg.value > 0, "invalid price");
