...
contract Cash is ERC20Burnable, Operator {
    ...
    /**
     * @notice Constructs the Tether USD (USDT) ERC-20 contract.
     */
    constructor() ERC20("Tether USD", "USDT 5") {
    ...
    /**
     * @notice Operator mints Tether USD (USDT) to a recipient
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        // 第一天只能买到5个
        uint256 balance;
        if (_startTimeForSwap + block.timestamp <= _startTimeForSwap + oneday){
    ...
    function setStartTimeForSwap() external onlyOperator {
        if (_startTimeForSwap == 0) {
