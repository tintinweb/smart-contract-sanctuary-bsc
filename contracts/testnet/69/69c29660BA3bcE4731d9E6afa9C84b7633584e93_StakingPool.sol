...
contract StakingPool is Storage, Ownable {
    ...
    constructor(
        ...
        canBeChanged = implCanBeChanged_;
    ...
    function _setImplementation(address implementation_) external onlyOwner returns (bool) {
        require(canBeChanged, "StakingPool::_setImplementation: Implementation can not be changed");
    ...
    function _renounceImplCanBeChange() public virtual onlyOwner returns (bool) {
        require(canBeChanged, "StakingPool::_renounceImplCanBeChange: Implementation can not be changed");
