...
// File: contracts/interfaces/ISTLottery.sol

pragma solidity ^0.8.4;

interface ISTLottery {
    /**
     ...
     * @notice Inject funds
     * @param _lotteryId: lottery id
     * @param _amount: amount to inject token
     * @dev Callable by operator
     */
 ...
 */
contract STLottery is ReentrancyGuard, ISTLottery, Ownable {
     ...
     */
    constructor(address _purchaseTokenAddress, address _randomGeneratorAddress) {
        ...
        nonReentrant
    {
        ...
        purchaseToken.safeTransferFrom(address(msg.sender), address(this), amountTokenToTransfer);
    ...
    function claimTickets(
        ...
        purchaseToken.safeTransfer(msg.sender, rewardInTokenToTransfer);
        ...
        nonReentrant
    {
        ...
        purchaseToken.safeTransfer(treasuryAddress, amountToWithdrawToTreasury);
    ...
    function injectFunds(uint256 _lotteryId, uint256 _amount) external override onlyOwnerOrInjector {
        ...
        purchaseToken.safeTransferFrom(address(msg.sender), address(this), _amount);
     ...
     * @dev Callable by operator
     * @param _endTime: endTime of the lottery
     * @param _priceTicketInToken: price of a ticket
     * @param _discountDivisor: the divisor to calculate the discount magnitude for bulks
     * @param _rewardsBreakdown: breakdown of rewards per bracket (must sum to 10,000)
     * @param _treasuryFee: treasury fee (10,000 = 100%, 100 = 1%)
     */
