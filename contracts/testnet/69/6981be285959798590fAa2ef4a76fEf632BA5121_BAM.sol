...
contract BAM is Ownable, ReentrancyGuard {
    ...
    constructor() {
        minimumStakeValue = 0.0125 * (10**18); // 0.01 BNB
        maximumStakeValue = 555 * (10**18); // 500 BNB
        maxStakedBalance = 555 * (10**18); // 500 BNB
    ...
    function stakeBNB() external payable {
        ...
        if (
            ...
            //Nog Active Stake Present

            userDetails[msg.sender].cycles++;
            userDetails[msg.sender].previousEarnings += userDetails[msg.sender]
                .activeStake
                .totalEarnings;
