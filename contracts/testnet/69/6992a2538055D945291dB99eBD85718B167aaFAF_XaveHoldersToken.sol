...
/**
 * @title Xave Official Holders Token
 * @author Xave Project
 * @notice BEP20 (ERC20) official Xave Holder token for certifying 
 * the holder condition of our beloved and supporting community.
 * 
 *                          .:^~!7????JJJJJ???77!~^..                         
 *                     .:~7?J??7!~^:::.....:::^~!7????!~:.                    
 *                  :!?JJ7~:.  .:^^~!!!777!!!~^:..  .^~7??7~:                 
...
// contracts/XaveHoldersToken.sol

pragma solidity ^0.8.0;
contract XaveHoldersToken is BEP20 {
    constructor(uint256 initialSupply) BEP20("Xave Holders Token", "HLDXVC") {
