...
// Gank token contract interface
import "./IGankToken.sol";
...
contract GankStaking is Initializable, Auth, ReentrancyGuardUpgradeable {
    IGankToken public gankToken;
    ...
    function initialize(IGankToken _gankToken, ITimelock _timelock)
        public
        initializer
    {
    ...
    function withdrawFee(uint256 _amountPercentage) external onlyOwner {
        ...
        gankToken.transfer(msg.sender, amountToWithdraw);
    }
        ...
        nonReentrant
    {
        ...
        gankToken.transferFrom(msg.sender, address(this), _principal);
        ...
        nonReentrant
    {
        ...
        gankToken.transfer(msg.sender, _principal);
    ...
    function claimRewards() external nonReentrant {
        ...
        gankToken.mintRewards(msg.sender, userRewardCount);
