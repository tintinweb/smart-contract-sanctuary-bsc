...
contract Staking is Ownable {
  ...
  function changeRewardPerBlock (uint256 rewardPerBlk) public onlyOwner {
      rewardPerBlock = rewardPerBlk;
  }
  ...
  function deposit(uint256 _amount) public {
    require(block.number > startBlock && block.number < rewardEndBlock, "not stake block");
    PoolInfo storage pool = poolInfo[0];
  ...
  function withdrawAllTokens() public onlyOwner {
      ...
      BaseToken.safeTransfer(msg.sender, baseBalance);
