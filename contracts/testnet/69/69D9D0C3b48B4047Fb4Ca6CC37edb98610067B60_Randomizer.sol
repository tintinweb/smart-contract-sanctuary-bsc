...
contract Randomizer is Initializable, IRandomizer {
    ...
    function priceSeedGetter() public view returns (bytes32 priceSeed) {
    ...
    function dataSeedGetter() public view returns (bytes32 dataSeed) {
        dataSeed = keccak256(
    ...
    function random(
        ...
        // bytes32 _priceSeed = priceSeedGetter();
        bytes32 _priceSeed;
        bytes32 _dataSeed = dataSeedGetter();
