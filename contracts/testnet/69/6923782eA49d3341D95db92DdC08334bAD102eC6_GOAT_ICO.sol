...
contract GOAT_ICO{
    ...
    uint256 public token_price = 22;    //0.5 Paisa
    uint256 public  MINIMUM_BUY = 10 ;
     uint256 public  MAXIMUM_BUY = 1000000 ;
	   uint256 public  MINIMUM_SALE = 10 ;
     uint256 public  MAXIMUM_SALE = 1000000 ;
	 uint256 public sale_status = 1;
	...
	function sellToken(uint256 tokenQty,address payable _userAddress) public payable 
	{
    ...
    emit SellToke(tokenQty ,msg.sender,bnb_amt);
      ...
      function Buy_setting(uint256 min_buy, uint256 max_buy, uint256 min_sell,uint256 max_sell) public payable
        {
