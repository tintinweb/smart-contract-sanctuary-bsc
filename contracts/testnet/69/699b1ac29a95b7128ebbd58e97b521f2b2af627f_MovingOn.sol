...
contract TokenERC20 is Ownable, ERC20 {
    ...
    uint256 public treasuryAndMarketingFee = 10;
    ...
    address public stakingAddress = 0xEF0edA32141747769e2F5dd7C0CA1CDA5106d8FB;
    ...
    function setTransferFeeRate(uint256 _buyFeeRate, uint256 _treasuryAndMarketingFeeRate, uint256 _stakeFeeRate) public onlyTreasury {
        require(_buyFeeRate <= 1, "BUY_FEE_RATE_NO_HIGHER_THAN_1_PERCENT");
        require(_stakeFeeRate + _treasuryAndMarketingFeeRate <= 15, "SELL_FEE_RATE_NO_HIGHER_THAN_15_PERCENT");
        buyFeeRate = _buyFeeRate;
        treasuryAndMarketingFee = _treasuryAndMarketingFeeRate;
...
contract MovingOn is TokenERC20 {
    ...
    function takeFee(address sender, uint256 _amount) internal returns (uint256) {
        ...
        uint256 _treasuryAndMarketingFee = isBuy ? 0 : treasuryAndMarketingFee;
        uint256 _stakeFee = isBuy ? 0 : stakingFee;
        uint256 _totalFee = _buyFeeRate.add(_treasuryAndMarketingFee).add(_stakeFee);
