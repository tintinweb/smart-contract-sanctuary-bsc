...
import "../auction/AuctionUpgradeable.sol";
import "../exchange/ExchangeUpgradeable.sol";

contract MarketplaceUpgradeable is AuctionUpgradeable, ExchangeUpgradeable {
    function initialize(address multiSigAccount) public override(AuctionUpgradeable, ExchangeUpgradeable) initializer {
...
import "../core/FactoryUpgradeable.sol";
import "./AuctionHelper.sol";

contract AuctionUpgradeable is FactoryUpgradeable, ERC721HolderUpgradeable, ERC1155HolderUpgradeable {
    AuctionItem[] private _auctionItems;
    // seller => auctionItemIndex[]
    ...
    function createAuctionItem(
        ...
        require(startTime > block.timestamp, AuctionError.START_TIME_MUST_BE_IN_FUTURE);
        require(duration > 0, AuctionError.DURATION_MUST_BE_GREATER_THAN_ZERO);
        require(bidIncrement > 0, AuctionError.BID_INCREMENT_MUST_BE_GREATER_THAN_ZERO);
...
contract ExchangeUpgradeable is FactoryUpgradeable, ERC721HolderUpgradeable, ERC1155HolderUpgradeable {
...
contract FactoryUpgradeable is AccessControlEnumerableUpgradeable, ReentrancyGuardUpgradeable {
...
library AuctionError {
    ...
    string public constant START_TIME_MUST_BE_IN_FUTURE = "Error: Start time must be in future";
    string public constant DURATION_MUST_BE_GREATER_THAN_ZERO = "Error: Duration must be greater than zero";
    string public constant BID_INCREMENT_MUST_BE_GREATER_THAN_ZERO = "Error: Bid increment must greater than zero";
