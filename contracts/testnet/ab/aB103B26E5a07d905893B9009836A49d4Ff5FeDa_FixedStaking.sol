...
contract FixedStaking is Ownable {
    ...
    function unStake(uint _amount) external {
        ...
        require(idoBalance[msg.sender] + idoTransfer[msg.sender] >= (_amount * (idoMulti / 1000000000000000000)), "Unstake failed! User dont haveSUFFICIENT IDO Token");
        ...
        launchpad(launchpadAddress).transferIDOTokenToFixed(address(this), _user, (initialAmount * (idoMulti / 1000000000000000000)));
