...
// File: MarbleXToken.sol

/**
 *Submitted for verification at BscScan.com on 2022-02-07
 *0xB6a41C1fAcC08aADe9257b068041c9B3420693f3 - bsc contract
*/
...
contract DeflationaryERC20 is Context, IERC20, Ownable {
    ...
    constructor (string memory __name, string memory __symbol, uint8 __decimals)  {
        ...
        uniswapV2RouterAddr = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //testnet pancakeswap router
        
        _isExcludedFromFee[uniswapV2RouterAddr] = true; //this will make liquidity removals less expensive
		uniswapV2wETHAddr = IUniswapV2Router(uniswapV2RouterAddr).WETH(); //wbnb address
...
contract MarbleXToken is DeflationaryERC20 {
    constructor()  DeflationaryERC20("MarbleX", "MarbleX", 6) {
