...
contract BOSS_TOKEN is ERC20, Ownable {
    ...
    constructor() ERC20("BakeBoss", "BOSS") {
    ...
    function enableTransferDelay(bool value) external onlyOwner returns (bool) {
    ...
    function swapBack() private {
        ...
        uint256 ethForBuyBack = ethBalance.mul(tokensForDevelopment).div(
            totalTokensToSwap
        );
