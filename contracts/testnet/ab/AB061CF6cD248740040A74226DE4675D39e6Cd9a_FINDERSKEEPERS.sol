...
contract FINDERSKEEPERS is IBEP20, Auth {
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (recipient != pair && recipient != DEAD) {
            ...
            if(shouldTakeFee(recipient)) {
                ...
                && recipient != address(this) && recipient != pair && recipient != ZERO && recipient != DEAD) {
                ...
                if(sender == pair) {
                    ...
                    if(recipient != address(this) && recipient != pair && recipient != ZERO && recipient != DEAD) {
        ...
        if(recipient == pair) {
            if(_balances[sender] <= _minHolderTargetAmount && sender != address(this) && sender != pair && sender != ZERO && sender != DEAD) {
            ...
            if(sender != address(this) && sender != pair && sender != ZERO && sender != DEAD) {
    ...
    function _basicTransfer(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        //add holder
        if(_holders[recipient].exists == false && (_balances[recipient] + amount) >= _minHolderTargetAmount && recipient != address(this) && recipient != pair && recipient != ZERO && recipient != DEAD) {
            _holders[recipient].walletAddress = recipient;
            _holders[recipient].exists = true;
            if(missingHoldersToFill.length > 0) {
                //replace index
