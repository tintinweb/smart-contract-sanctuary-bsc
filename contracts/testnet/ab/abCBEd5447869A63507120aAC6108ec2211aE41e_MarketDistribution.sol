...
contract MarketDistribution is TokensRecoverable, IMarketDistribution {
    ...
    // baseToken = WBNB
    function distribute(uint256 _baseAmountForLiquidity, uint256 _rootedAndEliteAmountForLiquidity, uint256 _lockTimeInSeconds, uint256 _maxTransactionAmount, uint16 additionalDumpTaxRate, uint256 dumpTaxRateDurationInSeconds) public override {
        ...
        gate.setDumpTax(additionalDumpTaxRate, dumpTaxRateDurationInSeconds);
