...
contract IngredientERC1155 is ERC1155Upgradeable, AccessControlUpgradeable  {
    ...
    event IngredientCreated(uint8 childType, uint256 indexed id, address indexed owner, uint256 boxId,  uint256 created);
    ...
    function createIngredient(
        ...
        uint256 seed
    ) onlyRole(BELLYBOX_ROLE)  external {
        uint32 calories = Random.createRandom(20, 40, seed, boxId);
        uint32 scent = Random.createRandom(20, 40, seed, calories);
        uint32 freshness = Random.createRandom(20, 40, seed, scent);
        ...
        emit IngredientCreated(childType, totalIngredient, recipient, boxId, ingredient.created);
        nextIngredientId();
    }
     ...
     */
    function getIngredient(uint256 _id) public view returns (
        uint256 id,
    ...
    function useIngredients(uint256 id) onlyRole(SANDWICHES_ROLE) external {
