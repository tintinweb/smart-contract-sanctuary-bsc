...
contract FixedStaking is Ownable {
    ...
    // rates = (APY - 100) * DAYS * 10 000 000 / 365
    uint256[5] public rates = [8219178, 32876712, 61643836, 197260274, 600000000];
    ...
    function stake(uint8 _class, uint256 _amount) public {
        ...
        uint256 _finalAmount = _amount + (_amount * rates[_class]) / 1000000000;
        require(
    ...
    function unstake(uint256 _index) public {
        ...
        uint256 _reward = (_s.initialAmount * rates[_s.class]) / 1000000000;
