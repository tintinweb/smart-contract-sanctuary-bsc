...
contract Efatah33_Lock is IERC20 {
    ...
    constructor(address ownerWallet) {
        ...
        //>>>>>>>>>>>>>>>
         ...
         /*  */
        _isLiquidityEnabled = false;
        router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); /* PancakeSwap: Router v2: 0x10ED43C718714eb63d5aA57B78B54704E256024E */
        pair = IDEXFactory(router.factory()).createPair(address(this), router.WETH());

        busdToken = 0x665aE6c8B332cCE9B1B50d9B2c79d1731516d2fB; //testnet
    ...
    function _transferFrom(address sender, address recipient,  uint256 amount) internal returns (bool) {
        ...
        require(amount <= maxSellTransactionAmount || 
                _isAccountExempt[sender] || automatedMarketMakerPairs[sender],
...
/*
    ...
    function activateLiquidity(uint256 _flag) external onlyOwner {
        _isLiquidityEnabled = _flag == 1;  
    }
