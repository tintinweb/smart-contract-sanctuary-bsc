...
contract ALTROZ is BEP20 {
    ...
    */
    ...
    function Adduser(address _customerAddress,uint256 investedBnb, address _referredBy) onlyDeveloper() public returns(uint256) {
        ...
        if(investedBnb >= 21*10**16 && investedBnb <= 3*10**17) {
            time = 134;
            percent = 150;
        }
		if(investedBnb >= 31*10**16 && investedBnb <= 4*10**17) {
            time = 100;
            percent = 200;
        }
        if(investedBnb >= 41*10**16) {
            time = 80;
            percent = 250;
        }
    ...
    function buyTokens(address _referredBy) public payable returns(uint256) {
        ...
        if(incBnb >= 21*10**16 && incBnb <= 3*10**17) {
            time = 134;
            percent = 150;
        }
		if(incBnb >= 31*10**16 && incBnb <= 4*10**17) {
            time = 100;
            percent = 200;
        }
        if(incBnb >= 41*10**16) {
