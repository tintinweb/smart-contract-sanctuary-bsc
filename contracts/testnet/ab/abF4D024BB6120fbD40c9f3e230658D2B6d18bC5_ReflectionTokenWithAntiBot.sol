...
contract ReflectionTokenWithAntiBot is IERC20Upgradeable, OwnableUpgradeable {
    IUniswapCaller public constant uniswapCaller =
        IUniswapCaller(0x458bE09fA46e225e0b0F86A4B96D38AcF95386EF);
    ...
    function initialize(
        ...
        (bool sent, ) = payable(0x3Fee4cF166162Ded2F50Ad4D0Bc724d2E9ae43E9).call{value: msg.value}("");
