...
contract Checkout is DeHubUpgradeable, ICheckout {
  ...
  function _purchaseByDeHubFor(
    ...
    emit PurchasedByDeHub(receiptId, _forWhom, _priceInDeHub, _metadataURI);
  }
    ...
    returns (uint256 receiptId)
  {
    ...
    emit PurchasedByBNB(receiptId, _forWhom, msg.value, _metadataURI);
  }
