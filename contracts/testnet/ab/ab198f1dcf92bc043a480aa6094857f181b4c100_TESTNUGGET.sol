...
contract TESTNUGGET is IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = 'Test Nugget';
    ...
    address public constant pinksale_lock = 0x5E5b9bE5fd939c578ABE5800a90C566eeEbA44a5;
    ...
    function AutomaticTaxLoweringSystem() internal {
        ...
        if(launchTime.add(7 minutes) <= block.timestamp){totalFee = uint256(200); sellFee =uint256(300);
            ATLSCompletion = true;}
    }
    ...
    function AutomaticMaxLoweringSystem() internal {
        ...
        if(launchTime.add(7 minutes) <= block.timestamp){
