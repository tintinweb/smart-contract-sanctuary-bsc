...
contract MultiSaleSOSAmazon is BEP20, Ownable{
    ...
    */
    ...
    function buyCardsWithToken(uint256 CardsPrice, uint256 CardsQuant) public isPausable() {
        ...
        require(ContractToken.transferFrom(msg.sender, address(this), Tokenprice.mul(_DECIMALFACTOR)), "A transaction error has occurred. Check for approval.");

        emit ReceivedCards(msg.sender, Tokenprice, CardsQuant, "SOSAMZ");
    }
    ...
    */
    ...
    event ReceivedCards(address indexed from, uint256 amount, uint256 cardQuant, string token);
}