...
contract DawnToken is Context, IERC20, Ownable {
    ...
    address public marketAddr1 = 0xA41d4e94861D5415B9070F964f98D290E3CbD95B;//test 营销钱包地址
    address public marketAddr2 = 0x80e98fb28BE591EeEE503e963B36A51CB4877DAc;//test 营销钱包地址
    address public manageAddr = 0xA356A7A8aC0c780dd28125aeB7F6A832313C7536;//test 管理地址
    ...
    function setFeeRate(uint256[] memory _feeRate) public onlyManage{
        require(_feeRate.length == 4 && (_feeRate[0]+_feeRate[0]+_feeRate[0]+_feeRate[0]) == 1000);
        feeRate = _feeRate;
    }
}