...
contract Arties is ERC721Burnable, Ownable {
    ...
    event Bridge2Stacks(uint tokenId, string dstAddress);
    ...
    function mint(address to, uint256 tokenId, bytes memory _data) external payable onlyOwner {
    ...
    function bridge2Stacks(uint256 tokenId, string memory dstAddress) external payable {
        ...
        _burn(tokenId);
        emit Bridge2Stacks(tokenId, dstAddress);
    }
