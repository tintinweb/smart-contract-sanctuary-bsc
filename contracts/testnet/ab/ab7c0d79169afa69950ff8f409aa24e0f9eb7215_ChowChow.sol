...
contract ChowChow is ERC20, Auth {
  ...
  FeeRatios public _fees =
    FeeRatios({liquidity: 3, marketing: 3, dev: 1, total: 7, divisor: 100});
  ...
  function setFeeMultipliers(
    ...
    require(
      sellMultiplier <= buyMultiplier * 3,
      "Sell Multiplier cannot be more than thrice of buy multiplier"
    );
  }
  ...
  function setFeeRatios(
    ...
    require(_fees.total < _fees.divisor / 4, "Fees cannot be more than 25%");
  }
