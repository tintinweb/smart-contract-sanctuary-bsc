...
contract FirstPrivate is Ownable, Pausable, ReentrancyGuard {
    ...
    IERC20 public busd;
    address public constant receiverWallet = 0xA0F533CcfCac5ADe17C95EA5B2045d660d9A8dC9;
    uint tokenPrice = 0.06 * 1e18;
    uint public vestingPeriodCount = 0;
    uint256 countBuyers = 0;
    uint256 MAX_TOKEN_CAP = 3 * 1e6 * 1e18;
    ...
    function BuymehgToken(uint256 _amount) public payable whenNotPaused {
        ...
        require(_amount >= 5, "BuymehgToken: Amount is less than required purchase of 50 busd");
        ...
        require(mehgToken.balanceOf(_msgSender()) <= 25000 * 1e18, "You have already purchased approved tokens limit per wallet");
        ...
        mehgToken.firstBuyTokenHolder(_msgSender(), tokenCalculator * 7/100, true, block.timestamp, block.timestamp, false); // send 7% of the tokens to the buyer
