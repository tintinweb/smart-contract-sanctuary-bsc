...
// MasterChef is the master of AVF. He can make AVF and he is a fair guy.
//
// Note that it's ownable and the owner wields tremendous power. The ownership
// will be transferred to a governance smart contract once AVF is sufficiently
...
// AVFToken with Governance.
contract AvfToken is BEP20('AVF Test Token', 'AVFT') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "AVF::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "AVF::delegateBySig: invalid nonce");
        require(now <= expiry, "AVF::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "AVF::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying AVFs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "AVF::_writeCheckpoint: block number exceeds 32 bits");
