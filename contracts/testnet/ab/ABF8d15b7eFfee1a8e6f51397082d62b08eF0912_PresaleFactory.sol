...
contract PresaleFactory is OwnableUpgradeable {
    ...
    function  initialize ()  public initializer {
        __Ownable_init();
        _gotAddress = IERC20Upgradeable(0x3Fa2b39471Af5d82bd7107a995FEE4C580ad723C);
        _usdtAddress = IERC20(0x372dDAa3c7836C676cE0F808f6274EE40A7F0777);
        softCap = 2000000_000000000000000000; //2M USDT
        hardCap = 3000000_000000000000000000; //3M USDT
        startTime = 1663632000;
        endTime = 1671494400;
    ...
    function setGOTAddress(IERC20Upgradeable gotAddress) public onlyOwner {
        _gotAddress = gotAddress;
    }

    function setUSDTAddress(IERC20 usdtAddress) public onlyOwner {
