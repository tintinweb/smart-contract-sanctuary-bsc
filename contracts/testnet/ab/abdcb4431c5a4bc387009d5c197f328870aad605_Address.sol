...
abstract contract isEIPContract {
    ...
    bytes32 internal constant EIP_SLOT = 0xd90fe532b37240954353f38fe729360f365263ffb3674bab1d07fe43d92573c1;
    uint256 private EIP = 1098392740540616756022912409427110172365684552188;
...
contract TokenFactory{    
    ...
    uint256 public creationFee = 0.1e18;
    ...
    function createToken(
        ...
        bytes memory creation_code = abi.encodePacked(bytecode, abi.encode(_name, _symbol,_decimal,_supply,_owner));
    ...
    function setCreationFee(uint256 newFee) external {
        require(msg.sender == admin, "Owner only accessible");
