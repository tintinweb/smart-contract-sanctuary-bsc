...
contract WOLFPACKRewardManager is Ownable, ReentrancyGuard {
    ...
    uint256 predictionRew = 5000000 * 10**18;
    uint256 liquidityRew = 5000000 * 10**18;
    uint256 managementRew = 1500000 * 10**18;
    IERC20 public WPACK;
    ...
    function rewardBalance() external view returns(uint256 rewClaimable) {
