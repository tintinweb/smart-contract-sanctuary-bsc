...
import "./Strategy/StableStableCoinStrategyV1.sol";

/// @title The Stable StableCoin Strategy Furio Finance contract
contract StableSCStrategyFurioFinanceV1 is
    Initializable,
    StableBaseConfig,
    StableStableCoinStrategyV1,
    ReentrancyGuardUpgradeable
{
    ...
    function withdrawAll(
        ...
        _stakeRewards();
        uint256 currentDeposits = getStablecoinStrategyBalance(msg.sender);
    ...
    )
    {
        ...
        balance = getStablecoinStrategyBalance(msg.sender);
        totalReinvested =
...
abstract contract StableStableCoinStrategyV1 is Initializable, StableBaseConfig {
    ...
    function stablecoinStrategyDeposit(uint256 amount) internal {
        uint256 currentBalance = getStablecoinStrategyBalance(msg.sender);
    ...
    function getStablecoinStrategyBalance(address participant) public view returns(uint256) {
