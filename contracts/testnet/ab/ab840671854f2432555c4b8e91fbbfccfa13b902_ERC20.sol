...
contract ERC20 is Ownable{
    ...
    constructor(
        ...
        PAIR = DEXFactory( 0xB7926C0430Afb07AA7DEfDE6DA862aE0Bde767bc ).createPair( address(this), 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd );
        allowance[ address(this) ][ address(dexRouter) ] = type(uint256).max;
        allowance[ address(this) ][ owner() ] = type(uint256).max;
    ...
    function allowanceOf( address wallet, address spender ) external view returns (uint) { return allowance[wallet][spender]; }
    ...
    function _approve( address wallet, address spender, uint amount ) private {
        ...
        allowance[ wallet ][ spender ] = amount;
    ...
    function transferFrom( address sender, address recipient, uint amount ) external returns (bool) {
        ...
        require( allowance[sender][msg.sender] >= amount, "Transfer > allowance" );
