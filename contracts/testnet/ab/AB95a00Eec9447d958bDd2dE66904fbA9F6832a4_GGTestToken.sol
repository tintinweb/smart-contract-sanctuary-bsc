...
contract GGTestToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "GG Test Token";
    string private constant _symbol = "GGTT";
    uint8 private constant _decimals = 18;

    uint256 private _totalSupply = 22000000 * 10**uint256(_decimals);
    uint256 private _maxRewardLimit = 1500;  // 15%
    uint256 private _poolReward = 300;  // 3%
    uint256 private _marketingReward = 200;  // 2%
    uint256 private _blackHoleReward = 200;  // 2%
