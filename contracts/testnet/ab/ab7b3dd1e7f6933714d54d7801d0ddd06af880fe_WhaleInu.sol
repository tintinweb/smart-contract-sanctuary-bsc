...
contract WhaleInu is Context, IERC20, Ownable {
    ...
    string private _name = "Whale Inu";
    string private _symbol = "$WINU";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xf18212E265763457fC18DbB14E83dd7A5682846A); 
    address payable public teamWalletAddress = payable(0x4769eBA0285b76f0FF7118A786BC227ee904EBe6); 
    ...
    // Initial setting to avoid bots pumping and dumping upon adding liquidity.
    // Note: Liquidity Fee shall be restored to 1% during the official announcement of the CA.
    // Note: Marketing Fee shall be restored to 4% during the official announcement of the CA.
    // Note: Team Fee shall be restored to 3% during the official announcement of the CA.
    ...
    uint256 public _maxTxAmount = 1 * 10**6 * 10**_decimals; //(1%)
    uint256 public _walletMax = 2 * 10**6 * 10**_decimals; //(2%)
    ...
    function changeRouterVersion(address newRouterAddress) public onlyOwner returns(address newPairAddress) {
        ...
        if(newPairAddress == address(0)) //Create If It Doesnt exist
        {
