...
contract DIMA is IBEP20, Ownable {
    ...
    uint256 public maxWalletBalance = 25000000 * _decimalFactor; // 5% do Supply
    uint256 public maxBuyAmount = 5000000 * _decimalFactor; // 1% do Supply
    uint256 public maxSellAmount = 5000000 * _decimalFactor; // 1% do Supply
