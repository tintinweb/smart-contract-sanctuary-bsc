...
contract Flapinu is Context, IERC20, LockToken {
    ...
    function setAllFeesPercentages(uint256 taxFee, uint256 liquidityFee, uint256 burnFee) 
    external onlyOwner() 
    {
        _taxFee = taxFee;
        ...
        uint256 totalFee = _taxFee.add(_liquidityFee).add(_burnFee);
