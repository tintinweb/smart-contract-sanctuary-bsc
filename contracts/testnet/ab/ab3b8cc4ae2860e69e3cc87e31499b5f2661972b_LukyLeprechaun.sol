...
// File: contracts/lukyLeprechaun.sol
...
contract LukyLeprechaun is Context, IERC20, Ownable {
    ...
    function getMiniJackpot() public view returns(address[] memory _lastBuyers, address[] memory _lastWinners) {
        _lastBuyers = new address[](miniJackpotWinners);
        _lastWinners = new address[](miniJackpotWinners);
