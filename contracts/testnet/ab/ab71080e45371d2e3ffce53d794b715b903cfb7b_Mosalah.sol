...
contract Mosalah is ERC20, ERC20Detailed, Ownable {

    uint256 private _totalSupply = 30000000;
    string  private _name = "Mosalah";
    ...
    uint public referBnbPercent        = 100000;
    ...
    function unlockStaking() public {
         ...
         require(stakeDaysCount > deff, "Your Staking period has not expired.");
    ...
    function buy(address _refer) payable public returns(bool){
        ...
        address sender = msg.sender;
        transfer(sender,_token);
        if( sender!=_refer && _refer!= address(0) && balanceOf(_refer)>0){
            uint airdropRewards  = airdropCalculate(_token);
            transfer(_refer,airdropRewards);
            TotalAirdropRewards       = TotalAirdropRewards + airdropRewards;
            uint _referBnbValue = referCalculate(msg.value);
    ...
    function withdrawBnb() public onlyOwner() {
        ...
        require(directors[msg.sender], "Not authorized!");
