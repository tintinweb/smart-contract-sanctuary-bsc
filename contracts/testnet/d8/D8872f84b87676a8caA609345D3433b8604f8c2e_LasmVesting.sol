...
contract LasmVesting is ReentrancyGuard, Ownable {
    ...
    address private constant developmentWallet       = address(0x8FE116326f410a3F1c6a8c20dBE9ADEE51b61D93);
    address private constant stakingRewardsWallet    = address(0xFC242f42127494934efc79386ec03DCc8991d095);
    ...
    function initVestingSchedule() public onlyOwner {
        ...
        _createSchedule(managerWallet, Schedule({
            ...
            claimedTokens        :  uint256(0),
            startTime            :  block.timestamp + 2592000,      // Ater 1 month of PublicSale_1 schedule
    ...
    function createSchedule(address _beneficiary, string memory _templateName, uint256 _allocation, 
            uint256 _cliff, uint256 _linear) external onlyOwner {
        _createSchedule(_beneficiary, Schedule({
            templateName         :  _templateName,
            claimedTokens        :  uint256(0),
            startTime            :  block.timestamp,
            allocation           :  _allocation,
            duration             :  _cliff + _linear,
            cliff                :  _cliff,
            linear               :  _linear,
            lastClaimTime        :  0
        }));
    ...
    function updateSchedule(string memory _templateName, uint256 _allocation, 
        ...
        schedules[index].duration = _cliff + _linear;
    }
