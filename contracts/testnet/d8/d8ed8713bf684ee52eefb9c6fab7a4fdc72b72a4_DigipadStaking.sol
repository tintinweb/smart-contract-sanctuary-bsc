...
contract DigipadStaking is Ownable {
    ...
    uint256 public emergencyFeesAmount = 0;
   ...
   function pendingRewards(uint256 _orderId ) external view returns (uint256) {
    ...
    function emergencyWithdraw(uint256 orderId) external {
        ...
        emergencyFeesAmount = emergencyFeesAmount.add(fees);
    ...
    function withdrawToken() public onlyOwner 
    {
       ...
       uint256 total = contract_balance.add(emergencyFeesAmount).sub(totalStaked).sub(totalRewardPending);
       emergencyFeesAmount = 0;
