...
contract PancakePredictionV3 is Ownable, Pausable, ReentrancyGuard {
    ...
    function setKeeper(address _keeperAddress) external onlyAdmin {
        ...
        operatorAddress = _keeperAddress;
    ...
    /**
     * @notice Get the current epoch info
     */
    ...
    {
        return (
            rounds[currentEpoch].epoch,
            rounds[currentEpoch].startTimestamp,
            rounds[currentEpoch].lockTimestamp,
            rounds[currentEpoch].closeTimestamp
        );
    }
