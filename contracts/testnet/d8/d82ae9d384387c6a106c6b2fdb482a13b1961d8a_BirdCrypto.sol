...
contract BirdCrypto is IERC20, Ownable {
    ...
    uint256 public swapAndEvolveAmount = 5000 ether; //5k ether       
    ...
    function _swapAndLiquify(uint256 amount) private lockTheSwap {
        ...
        _swapTokensForTokenB(tokensSwapped, address(this)); // <- this breaks the TokenB -> HATE swap when swap+liquify is triggered
