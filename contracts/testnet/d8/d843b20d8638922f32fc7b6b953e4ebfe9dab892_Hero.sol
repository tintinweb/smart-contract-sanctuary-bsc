...
contract Hero is BEP721, Ownable {
    ...
    function setTotalSupply (uint256 totalID) public onlyManager {
        require(totalID > circulatingSupply, "Can not set ID lower than current ID");
        circulatingSupply = totalID;
    }
