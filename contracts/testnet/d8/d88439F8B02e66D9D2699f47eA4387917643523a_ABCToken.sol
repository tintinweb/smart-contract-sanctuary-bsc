...
contract ABCToken is GasHelper, ERC20 {
  ...
  string constant private _nameToken = "ABC";
  string constant private _symbolToken = "1bilhao";
  ...
  constructor()ERC20(_nameToken, _symbolToken) {
    ...
    administrativeWallet = 0x1913EF908e7FFf353ca9D9D110A295d319bf40dA;
    _permissions[administrativeWallet] = 15; // exempt fee, fee receiver, tx limit and wallet limit
    internalFundWallet = 0xeE393b43588a4b190478309d29eD4Da2A105F3c5;
