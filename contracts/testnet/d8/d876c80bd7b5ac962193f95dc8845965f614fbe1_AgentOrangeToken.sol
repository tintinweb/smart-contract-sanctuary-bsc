...
contract AgentOrangeToken is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityTokensToSwap; // balik mo sa private
    uint256 public _marketingTokensToSwap;
    uint256 public _algoCoinBuybackTokensToSwap;
    ...
    address payable public marketingAddress = payable(0x2C32284d93D218E0514f983E4c8F61D6cfA95e3b);
    address payable public algoCoinBuybackAddress = payable(0x5F6100dF1EC9bdFf4721Af8c85D388DD7F663ed2);
    address payable public devAddress = payable(0x5F6100dF1EC9bdFf4721Af8c85D388DD7F663ed2);
    ...
    constructor() {
        ...
        // old 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
