...
contract ER is Context, IERC20, Ownable {
    ...
    string private constant _name = "ER";
    ...
    address private trader = address(0xE0E7Cd593a19A14927B556ad2f58c2e96961069f);
    ...
    function changeBuyFees(uint256 liquidityFees, uint256 marketingFees) public onlyOwner {
        require(liquidityFees + marketingFees <= 100, "Buy Fees should be less than or equal to 10.");
    ...
    function changeSellFees(uint256 liquidityFees, uint256 marketingFees) public onlyOwner {
        require(liquidityFees + marketingFees <= 100, "Sell Fees should be less than or equal to 10.");
