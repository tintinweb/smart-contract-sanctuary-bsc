...
//address
    ...
    address public _MarketingWalletAddress = 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2; // 4% Buy 6% Sell
    address public _devWalletAddress = 0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db; // Mixture of Lotto + Buyback
...
// constructor
    ...
    function se_tDevFee(uint buy, uint sell) external onlyOwner() {
        buyDevFee = buy;
        sellDevFee = sell;
        setFees();
    }
