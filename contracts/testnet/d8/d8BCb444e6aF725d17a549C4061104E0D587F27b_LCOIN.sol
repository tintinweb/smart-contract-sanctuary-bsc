...
contract LCOIN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x921B5f7803A5118a291a018082D5720813044507); 
    address payable public buyBackWalletAddress = payable(0x921B5f7803A5118a291a018082D5720813044507); 
    ...
    uint256 public _walletMax =  500 * 10**9 * 10**9; 
