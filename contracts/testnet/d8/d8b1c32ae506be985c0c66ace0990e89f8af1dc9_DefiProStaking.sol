...
contract DefiProStaking is  Ownable {
  ...
  constructor() {  
    ...
    function calculateReward(address user, uint256 optionId) public view returns(uint256 interestAmount) {
        if(options[user][optionId].isActive){
            ...
            //  for(uint i=0; i < rewardCount; i++){
                 uint256 _interestAmount = TotalAmount.mul(options[user][optionId].interestPercent).div(10000000000);
    ...
    function claimReward(uint256 optionId) public returns(bool) {
        ...
        uint256 withdrawReward = rewardInBUSD.sub(rewardInBUSD.mul(options[msg.sender][optionId].interestFeePercent).div(10000000000));
    ...
    function rewardPercentCalculate(string memory coin, uint256 amount) view public  returns(uint256 percent) {
        ...
        uint256 amountInUSD = convertCoinValue(amount,coin,"BUSD");
         ...
         if(amountInUSD >= 100 * 10**18 &&  amountInUSD <= 499 * 10**18){
            if(coinId == 0){
                percent = 1250000 ;// 0.300000 * 10**8
            }
            if(coinId == 1){
                percent = 937500;// 0.1275 * 10**8
            }
            if(coinId == 2){
                percent = 750000;// 0.1800 * 10**8
            }
          
        }else if(amountInUSD >= 500 * 10**18 &&  amountInUSD <= 999 * 10**18){
            if(coinId == 0){
                percent =1350000; //0.325000*  10**8
            }
             if(coinId == 1){
                percent = 1000000; // 10**8
            }
            if(coinId == 2){
                percent = 812500;// 0.1950 * 10**8
            }

        }else if(amountInUSD >= 1000 * 10**18 &&  amountInUSD <= 2999 * 10**18){
            if(coinId == 0){
                percent = 1450000; // 0.350000 * 10**8
            }
            if(coinId == 1){
                percent = 1060000; // 10**8
            }
            if(coinId == 2){
                percent = 875000;// 0.2100 * 10**8
            }
            if(coinId == 3){
                percent = 625000;// 0.1500 * 10**8
            }

        }else if(amountInUSD >= 3000 * 10**18 &&  amountInUSD <= 4999 * 10**18){
             if(coinId == 0){
                percent = 1562500; // 0.375000 * 10**8
            }
            if(coinId == 1){
                percent = 1125000; // 10**8
            }
            if(coinId == 2){
                percent = 937500;// 0.2250 * 10**8
            }
            if(coinId == 3){
                percent = 650000 ;// 0.1575 * 10**8
            }
            if(coinId == 4){
                percent = 500000;// 0.1200 * 10**8
            }

        }else if(amountInUSD >= 5000 * 10**18 &&  amountInUSD <= 9999 * 10**18){
            if(coinId == 0){
                percent = 1660000; //0.400000 * 10**8
            }
            if(coinId == 1){
                percent = 1180000; // 10**8
            }
            if(coinId == 2){
                percent = 1000000;// 0.2400 * 10**8
            }
            if(coinId == 3){
                percent = 687500;// 0.1650 * 10**8
            }
            if(coinId == 4){
                percent = 531250;// 0.1275 * 10**8
            }

        }else if(amountInUSD >= 10000 * 10**18 &&  amountInUSD <= 19999 * 10**18){
            if(coinId == 0){
                percent = 1770000; //0.425000* 10**8
            }
            if(coinId == 1){
                percent =1250000; // 10**8
            }
            if(coinId == 2){
                percent = 1062500;// 0.2550 * 10**8
            }
            if(coinId == 3){
                percent = 750000;// 0.1800 * 10**8
            }
            if(coinId == 4){
                percent = 562500;// 0.1350 * 10**8
            }

        }else if(amountInUSD >= 20000 * 10**18){
            if(coinId == 0){
                percent = 1875000; // 0.450000 *10**8
            }
            if(coinId == 1){
                percent = 1350000; // 10**8
            }
            if(coinId == 2){
                percent = 1125000;// 0.2700 * 10**8
            }
            if(coinId == 3){
                percent = 812500;// 0.1950 * 10**8
            }
            if(coinId == 4){
                percent = 593750;// 0.1425 * 10**8
            }
        }   
