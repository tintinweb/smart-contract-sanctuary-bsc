...
contract FaceWish is ERC721Enumerable, Ownable{
    ...
    uint256 public minPublicMintPrice = 10000000000000;    
...
////////////////////////// Auction Variables    ///////////////////////////////////
    ...
    function publicMaleMint(uint256 _count) public payable publicMinter(_count) {
      require(msg.value >= minPublicMintPrice.mul(_count), "Less Amount!!");
    ...
    function publicFemaleMint(uint256 _count) public payable publicMinter(_count) {
      require(msg.value >= minPublicMintPrice.mul(_count), "Less Amount!!");
