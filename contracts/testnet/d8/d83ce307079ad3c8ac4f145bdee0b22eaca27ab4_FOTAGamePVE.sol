...
contract FOTAGamePVE is Auth, EIP712Upgradeable {
  ...
  function syncData(uint[][4] memory _heroData, uint32[] memory _experiences, uint[] memory _data, bytes memory _signature, uint16[] calldata _revokedHeroes, int pvpGem) external {
