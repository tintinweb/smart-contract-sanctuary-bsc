...
contract PlearnFeeManager is Ownable {
    ...
    function processAllFee(bool ignoreError) external onlyOwner {
        ...
        IPlearnFeeHandler.RemoveLiquidityInfo[] memory liquidityList = new IPlearnFeeHandler.RemoveLiquidityInfo[](pairCount);
        IPlearnFeeHandler.SwapInfo[] memory swapList = new IPlearnFeeHandler.SwapInfo[](pairCount);
