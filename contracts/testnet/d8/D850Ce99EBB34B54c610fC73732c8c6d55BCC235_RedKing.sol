...
contract RedKing is ERC20, Ownable {
    ...
    string public name_ = "bbb token";//名称
    string public symbol_ = "bbb";//简称
    uint256 public totalSupply_ = 1000000000000;//供应量 不用后面18位
    address public rewardAddr_ = 0x11e815a78Cc41D733Db00f06B3A96074855362CE;//分红合约地址
    address public marketingWalletAddr_ = 0xCb82eaa9Fe38965aA1B71427a86dca89C9a28777;//营销钱包地址
    uint256[4] public  buyFeeSetting_ = [1,1,1,1];//买入手续费
    uint256[4] public  sellFeeSetting_ = [1,1,1,1];//卖出手续费
    uint256 public tokenBalanceForReward_ = 100000000000000000000000000;//持币门槛，后面+18个0
