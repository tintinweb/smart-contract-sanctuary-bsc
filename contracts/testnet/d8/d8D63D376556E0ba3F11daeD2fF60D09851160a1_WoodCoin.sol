...
/**
Standard BEP-20 contract created for the project: www.woodcointoken.com
...
contract WoodCoin is Ownable, ERC20Burnable {
    ...
    uint256 immutable maxIndividualFee; // Ensures security for investors so that a 99% rate is not possible
    uint256 immutable minIndividualLimitTx; //  Ensures security for investors so that a 0 linit tx is not possible
