...
/**
 *Submitted for verification at hecoinfo.com on 2022-04-05
*/
...
contract SaoBi is Context, IERC20, Ownable {
    ...
    string private _name = "SaoBi";
    string private _symbol = "SaoBi";
    ...
    address public devAddress = address(0x06284705530c58bdd574DC5c189213a49D53365a);
    address public marketingAddress = address(0x2742fBBCB2AA5A419554CFbCAd29AAaefd5b689c);
