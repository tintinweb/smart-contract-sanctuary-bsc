...
contract FeeContract is Ownable {
    ...
    function claimToken() external {
        ...
        require(iyal.feeHistory(currentMonth) > 0, "No fee tokens to claim");
        require(iyal.totalAmount(currentMonth) > 0, "Invalid Total amount");
        require(iyal.c_amountHistory(msg.sender) > 0, "No tokens for your account");
