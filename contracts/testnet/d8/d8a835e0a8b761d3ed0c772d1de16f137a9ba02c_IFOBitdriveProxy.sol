...
contract IFOBitdriveProxy is ReentrancyGuard, Initializable {
  ...
  function initialize(
      ...
      STAKING_PRICE[1]  =   1000*1e18;
      STAKING_PRICE[2]  =   10000*1e18;
      STAKING_PRICE[3]  =   50000*1e18;
      STAKING_PRICE[4]  =   100000*1e18;
  ...
  function deposit(uint256 _amount) public {
    ...
    if(userInfo[msg.sender].amount>=STAKING_PRICE[1] && userInfo[msg.sender].amount<STAKING_PRICE[3]){
