...
contract TIKTOKNFT is BlackLkisted,ERC721Enumerable {
	using SafeMath for uint256;
	IBEP20 dart;
	constructor() payable ERC721('tik-Tok ', 'TTNFT') {
		sellingFess = 5;
	}
	...
	function mintNFT(string memory _tokenURI,uint256 amount, uint256 tokenId, bool isToken,uint256 price,IBEP20 paymentCurrency) public payable {
