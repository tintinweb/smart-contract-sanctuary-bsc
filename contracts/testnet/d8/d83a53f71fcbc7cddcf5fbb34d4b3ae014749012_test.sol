...
contract test is Ownable, IBEP20 {
    ...
    address pancakeAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;        /////TESTNET ADRESSE

    string private _name = "Firstname";

    string private _symbol = "Firststring";
    ...
    mapping(address => bool) private canChangeName;     //ChangeName TEST
    ...
    constructor() {
        ...
        canChangeName[msg.sender] = true;       //ChangeName TEST
