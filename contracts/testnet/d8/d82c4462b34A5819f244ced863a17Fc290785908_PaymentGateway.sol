...
contract PaymentGateway is Initializable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    // TODO: Change this
    address constant public GNOSIS_ADDRESS = 0x1C77851cFA99677D6152897680642C99E3818Fd7;
    // TODO: Change this
    IERC20Upgradeable constant public BUSD = IERC20Upgradeable(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
    ...
    function pay(address user, string calldata product_code, string calldata coupon_code, string calldata referrer_code) public whenNotPaused nonReentrant {
        ...
        if (bytes(coupon_code).length > 0) {
            ...
            busd_to_charge -= (busd_to_charge * (coupon.discount_percent / ONE_HUNDRED_PERCENT));
        }
        ...
        if (bytes(referrer_code).length > 0) {
            ...
            uint256 referrer_cut = (busd_to_charge * (referrer.cut_percent / ONE_HUNDRED_PERCENT));
