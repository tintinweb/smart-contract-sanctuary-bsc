...
contract AlmightyGod is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "AlmightyGod";
    string private _symbol = "aGod";
    uint8 private _decimals = 9;

    address payable public DevelopmentWalletAddress =
        payable(0xcc9A86bc60F6b2F05E4D753730dEBb6E8Dae1Db0);
    ...
    uint256 public _DevelopmentShare =
        _buyDevelopmentFee.add(_sellDevelopmentFee);
    ...
    constructor() {
        ...
        uniswapPair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(
            address(this),
            0xe53797D8719cBcB371efE2B58bc10d01EdC1Ed0D
        );
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newDevelopmentTax)
        external
        onlyOwner
    {
    ...
    function setSellTaxes(uint256 newLiquidityTax, uint256 newDevelopmentTax)
        external
        onlyOwner
    {
