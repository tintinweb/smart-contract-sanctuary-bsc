...
// main contract
contract TokenInu is IERC20Extended, Auth {
    using SafeMath for uint256;

    string private constant _name = "Token INNU";
    string private constant _symbol = "Token INNU";
    uint8 private constant _decimals = 9;
    uint256 private constant _totalSupply =
        500_000_000_000_000 * 10**_decimals;
    ...
    constructor(
        address router_, // 0x10ed43c718714eb63d5aa57b78b54704e256024e mainnet pcs
        address marketingFeeReceiver_,
        address devFeeReceiver_
    ) Auth(0x9A216241203dc6c4bB6f011EF673A6aD32F641C9) {
        ...
        _balances[0x9A216241203dc6c4bB6f011EF673A6aD32F641C9] = _totalSupply;
