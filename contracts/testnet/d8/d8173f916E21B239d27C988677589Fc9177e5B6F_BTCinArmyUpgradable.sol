    ...
    UUPSUpgradeable
{
    ...
    uint256 private rewardTokenRate;
    ...
    function initialize() external initializer {
        ...
        rewardTokenOwner = 0x7a0DeC713157f4289E112f5B8785C4Ae8B298F7F;
    ...
    function getRewardTokenRate() external view returns (uint256) {
    ...
    function _payReward(uint256 _value, address _referee) private {
        ...
        if (
            ...
            _payRewardTokens(_referee, rewardValue);
            ...
            _payRewardTokens(userAccount.referrer, _value);
            userReferrerAccount.payReward = false;
    ...
    function _payRewardTokens(address _address, uint256 _value) private {
        uint256 rewardTokenValue = _value.mul(rewardTokenRate).div(100);
        uint256 remainingAllowance = IERC20Upgradeable(rewardTokenContract)
            .allowance(rewardTokenOwner, address(this));
