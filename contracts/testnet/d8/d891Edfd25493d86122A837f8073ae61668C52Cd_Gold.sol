...
contract Gold is Context, ERC165, IERC721, IERC721Metadata {
    ...
    bool public whetherTransfer; // 是否允许交易
    uint256 public buyTokenUsdt = 200 * 10**18;
    ...
    // 修改是否可以交易
    function setwhetherTransfer(bool whether_) public Owner returns (bool) {
        whetherTransfer = whether_;
        return true;
    }
    ...
    // 铸造
    function toMint(address to_) public WhiteList returns (uint256) {
        initialTokenId += 1;
    ...
    function toTransfer(
        ...
        address to_,
        uint256 tokenId_
    ) public WhiteList returns (bool) {
        require(
            Gold.ownerOf(tokenId_) == from_,
