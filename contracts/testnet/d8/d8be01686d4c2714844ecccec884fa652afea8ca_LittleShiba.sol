...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x4253Aa611835b479dbC6F7886f5e3F81CC4dF435;
...
contract LittleShiba is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x2275F979bab02E940899b3077A00f21654Bbe148;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "LittleShibaInu";
    string private _symbol = "LSHIBU";
