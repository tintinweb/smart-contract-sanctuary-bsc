...
contract CROCO is BEP20Detailed, Ownable, WhitelistedRole {
    ...
    uint256 public buyFeemarketing = 3;
    uint256 public sellFeeDevelopmentAdded = 5;
    uint256 public sellFeemarketingAdded = 5;
 ...
 uint256 public maxSellTransactionAmount = INITIAL_FRAGMENTS_SUPPLY;
    ...
    constructor() BEP20Detailed("CROCO FAMILY", "CROCO", uint8(DECIMALS)) {
