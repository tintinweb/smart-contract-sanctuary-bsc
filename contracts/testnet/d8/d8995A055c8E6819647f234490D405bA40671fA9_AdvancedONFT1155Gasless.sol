...
contract AdvancedONFT1155Gasless is ONFT1155, GelatoRelayContext, ReentrancyGuard {
    ...
    uint public maxTokenPerID = 5000;
    ...
    function publicMint(uint _tokenId, uint _amount) external {
        ...
        require(_tokenId == ableToMint, "A3");
        require(_amount <= maxTokensPerMint, "A4");
        require(tokenCountMap[_tokenId] + _amount <= maxTokenPerID, "A5");
        require(_tokenId != 0, "A6");
        require(price > 0, "A7");
        require(address(stableToken) != address(0), "O8");
...
contract ONFT1155 is ONFT1155Core, ERC1155Supply, IONFT1155 {
    ...
    function _debitFrom(address _from, uint16, bytes memory, uint[] memory _tokenIds, uint[] memory _amounts) internal virtual override {
        ...
        require(spender == _from || isApprovedForAll(_from, spender), "O10");
