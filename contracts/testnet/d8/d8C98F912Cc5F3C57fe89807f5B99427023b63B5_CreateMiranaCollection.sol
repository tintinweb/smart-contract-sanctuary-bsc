...
contract CreateMiranaCollection is ICollection, Ownable {
    ...
    returns (bool)
  {
    ...
    require(
      ...
      "tokenType is All/Single/Multiple"
    );
    return true;
  }
  ...
  //     keccak256(abi.encodePacked(("All")))
  //   ) {
  //     if (collection.erc721 != address(0)) {
  //       erc721 = new MockERC721(
  //         owner,
  //         collection.tokenName,
  //         collection.tokenSymbol,
  //         ""
  //       );
  //       collection.erc721 = address(erc721);
  //     } else {
  //       erc1155 = new MockERC1155(
  //         owner,
  //         collection.tokenName,
  ...
  //         ""
  //       );
  //       collection.erc1155 = address(erc1155);
  //     }
  //   }
