...
contract Marketplace is IERC721Receiver{
    ...
    function sellItem(
      ...
      // require(msg.value >= listingPrice, "Price must be more than to listing price");
    ...
    function buyItem(
      ...
      tokenAddress.transferFrom(msg.sender,marketItem.seller,marketItem.price);
      //โอน nft
      ERC721(marketItem.nftAddress).safeTransferFrom(address(this),msg.sender,marketItem.tokenId);
      //get history id
    ...
    function tranferItem(
      ...
      ERC721(a.nftAddress).safeTransferFrom(address(this),msg.sender,a.tokenId);
    }

    /* Returns all unsold market items */
     function getAllMarketItem() public view returns (MarketItem[] memory) {
