...
contract RecoveryPunks is ERC721, ERC721Enumerable, Ownable {
    ...
    string public constant RECOVERYPUNKS_PROVENANCE =
        "b2816ce44009fd52cb17864cd3b60818a798be5d1b8307de23c168e68a339fcb";

    constructor() ERC721("RecoveryPunks", "RecoveryPunks") {
    ...
    function safeMint(address to, uint256 tokenId) public onlyMinter {
        require(tokenId != 0, "safeMint: zero id cant minted");
