...
contract Game_NFT is Ownable {
   ...
   //  mapping(address => uint256) Ref_Zarabotok;
            ...
            if (all_tables[number_table].zarabotok[all_tables[number_table].adr_pool[all_tables[number_table].count]] > 0){
              ...
              //  if(my_inviter[all_tables[number_table].adr_pool[all_tables[number_table].count]] != address(0)){
                  if(my_referrals[all_tables[number_table].adr_pool[all_tables[number_table].count]][0] != address(0)){
                     ...
                     myIncomeReferal[my_referrals[all_tables[number_table].adr_pool[all_tables[number_table].count]][0]] += referal_cost / 100 * 12 / 100;
                     if (my_referrals[all_tables[number_table].adr_pool[all_tables[number_table].count]][1] != address(0))
                     myIncomeReferal[my_referrals[all_tables[number_table].adr_pool[all_tables[number_table].count]][1]] += referal_cost / 100 * 7 / 100;
                     if (my_referrals[all_tables[number_table].adr_pool[all_tables[number_table].count]][2] != address(0))
                     myIncomeReferal[my_referrals[all_tables[number_table].adr_pool[all_tables[number_table].count]][2]] += referal_cost / 100 * 5 / 100;
    ...
    function dddddddd (address adr) public view returns (address){
