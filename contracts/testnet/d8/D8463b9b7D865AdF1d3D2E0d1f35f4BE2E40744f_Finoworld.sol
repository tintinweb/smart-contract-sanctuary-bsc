...
contract Finoworld is ERC20Detailed, Ownable {
    ...
    string private _name = "Finoworld";
    string private _symbol = "FNWD";
    ...
    uint8 private constant RATE_DECIMALS = 9;
    ...
    address public OWNER = 0x9B4aA981ccbF9d63853B3a4d49E701c29BF2fC8F;


    address private autoLiquidityReceiver;
    address private treasuryReceiver;
    address private AssetbackedReceiver;
    ...
    uint256 private constant MAX_SUPPLY = 50000 * 10**3 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("Finoworld", "FNWD", uint8(DECIMALS)) Ownable() {
...
//Variables have been defined now we move on the rest of the configuration 
        ...
        autoLiquidityReceiver = 0x9B4aA981ccbF9d63853B3a4d49E701c29BF2fC8F; //Liquidity Reciever will get LP tokens
        treasuryReceiver = 0x9B4aA981ccbF9d63853B3a4d49E701c29BF2fC8F; //Treasury Receiver
        AssetbackedReceiver = 0x9B4aA981ccbF9d63853B3a4d49E701c29BF2fC8F; //Backed asset Receiver
        Sellfee = 0x9B4aA981ccbF9d63853B3a4d49E701c29BF2fC8F; //Sell penalty
