...
contract DiscountPool is Ownable,ReentrancyGuard,Pausable {
    ...
    */
    ...
    function getSummary() public view returns (
        IBEP20,uint256,uint256,uint256,uint256,uint256,bool,bool,uint256,address,uint256,uint256
    ) {
        return (
            saleToken,
            saleToken.totalSupply(),
            soldTokens,
            saleToken.totalSupply() - soldTokens,
            startTime,
            endTime,
            burnState,
            autoBuyBackEnabled,
