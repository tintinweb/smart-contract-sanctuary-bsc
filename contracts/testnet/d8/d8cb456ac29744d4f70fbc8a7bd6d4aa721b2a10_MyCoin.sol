...
pragma solidity 0.5.16;
  ...
  interface Ixg {
    ...
    function mint(address account, uint256 amount) external view returns (uint256);        
  }
  ...
  contract MyCoin is Context, IBEP20, Ownable {
    ...
    mapping (uint256 => uint256) private dailyMintAmount;
    ...
    constructor() public {
      ...
      setFees(5, 0, 99);
      initContracts(0x5D9B130B9B7fe205645BddACE2971E5b1FF7931B, 0x5D9B130B9B7fe205645BddACE2971E5b1FF7931B, 0x5B0F7C1336F3BFB1D07798F37c9EA0583314792A);
    ...
    function update() public {
      ...
      // emit Update(lastUpdate, c, getGain(), xgCoin.getCurrentPrice(), gL, gG);
      emit Update(lastUpdate, c, getGain(), 0, gL, gG);
    }
