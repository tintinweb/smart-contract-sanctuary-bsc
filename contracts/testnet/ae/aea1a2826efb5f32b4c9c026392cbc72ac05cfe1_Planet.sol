...
contract Planet is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Pausable, AccessControl {
    ...
    string public tokenURIPrefix = "https://storage.googleapis.com/planet-alliance/";
    
    string public tokenURISuffix = "/planet.json";
    ...
    event PlanetBirth(address indexed owner,uint256 indexed tokenId);
    ...
    function recivePlanet(address _owner)  
        onlyRole(RECIVE_ROLE)
        external 
    {
        uint256 tokenId = _tokenIdCounter.current()+1;
        require(tokenId<=5000,'PLANET: maxnum is 5000');
        _mint(_owner,tokenId);
        _tokenIdCounter.increment();
        emit PlanetBirth(_owner,tokenId);
    }
