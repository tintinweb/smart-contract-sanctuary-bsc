...
contract SUNEKU is Context, IBEP20, Ownable {
    ...
    uint8 private _decimals = 0; // token decimals
    ...
    uint256 public minTokenToSwap = 4000000; // 10000k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 30000000;
    uint256 public minBuyLimit = 20000000;
    ...
    uint256 public liquidityFeeOnBuying = 50;
    uint256 public marketWalletFeeOnBuying = 50;
    uint256 public burnFeeOnBuying = 50;
    ...
    uint256 public burnFeeOnSelling = 50;
