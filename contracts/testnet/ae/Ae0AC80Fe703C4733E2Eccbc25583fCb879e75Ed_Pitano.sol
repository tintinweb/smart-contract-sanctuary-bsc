...
import "./Common.sol";
contract Pitano is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("Pitano", "PITANO", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x5Cda3CF68D19068EB200216bAf2A7E37fAf69F40;
        TreasuryReceiver = 0xf4F0E6eDaCcaD13071d1564F9B283F6fB4231663;
        RiskFreeValueReceiver = 0xd08C806152867e3d2293DcE35D9385De8AB85F5B;
    ...
    function sendPresaleToken(address[] calldata recipients, uint256[] calldata values)
        external
        onlyOwner
    {
