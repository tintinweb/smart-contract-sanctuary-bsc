...
*/      IN=IInvest(address(Contr.getInvest()));
        Stok_NFTW= 0x8fb2146365D0C9f015486109b4eA6ea92486b816;

        USDT = IERC20(0xEC7f9B6343883594E8a521e14fd5e61De09025Ea);
        Coll = ICollections(0x6d8A97319821c5B7c7342b579d34F943DaB0cE6e);
    }
    uint256 Price_USDT=36900;
    ...
    function Exchange_NFTW (uint256 ID_Collections, uint256 ID_NFTW) public {
        ...
        //address Invest = Contr.getInvest();
        NFTW.safeTransferFrom(msg.sender,Stok_NFTW, ID_NFTW, "");
        Count++;
    }
    ...
    function set_adr_Stok_NFTW (address adr) public onlyOwner {
        Stok_NFTW=adr;
    }
