...
contract MarketPlace is ERC721, ERC721URIStorage, Ownable, ERC721Enumerable {
    ...
    constructor(address _paymentToken) ERC721("MarketPlace", "MTK") {
        Token = _paymentToken;
    }
    ...
    function buyNfts(uint256 _tokenId, uint256 amount) public {
        ...
        if (Sale[_tokenId].saleCounter < 1) {
            ...
            Sale[_tokenId].totalRoyalties += firstOwnerPrecentage;
        }
        Sale[_tokenId].owner = msg.sender;
        Sale[_tokenId].saleCounter++;
    }
    ...
    function changeNftStatus(uint256 _tokenId, bool _status) public {
        require(
            ownerOf(_tokenId) == msg.sender,
            "Only Owner is able to change the price"
        );
        Sale[_tokenId].forSale = _status;
    }
