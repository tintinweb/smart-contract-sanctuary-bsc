...
contract Tomatoezilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tomatoezilla";
    string private _symbol = "Tomatoezilla";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x7cA2479d1FEd757530B4F3230daa8710053Aa0b8); // Marketing Address
    address payable public teamWalletAddress = payable(0xAE1078AAFcc9a1c35C97914Ce8F702630eE4402a); // Team Address
