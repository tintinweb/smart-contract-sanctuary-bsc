...
contract RichMonkey is Context, Ownable{
    ...
    constructor() public {
        origin = msg.sender;
        work = true;
        dy_addr = 0xc6eDD89D6570567514F78d789c01926a4f401c45;
        usdt_receive = 0x07DD6D40f2adFBD4012130AF877056bCF4B5bfcA;
    ...
    function initNftIndex() private{
        ...
        nft_index[0xE51a35b2Aa643138628db5dF4BF76113F51cB296] = 2;
