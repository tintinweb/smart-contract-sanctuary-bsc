...
interface IToken1DividendTracker is IDividendPayingToken{
    ...
    function setAuth(address account) external;
...
interface IToken2DividendTracker is IDividendPayingToken{
    // uint256 public claimWait;
