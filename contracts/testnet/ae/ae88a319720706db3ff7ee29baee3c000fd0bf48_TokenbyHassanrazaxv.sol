...
contract TokenbyHassanrazaxv is Context, IERC20, Ownable {
    ...
    string private _name = "Hassanrazaxv";
    string private _symbol = "HXV";
    uint8 private _decimals = 18;
    
    uint256 public _RefToHoldersFee = 0;
    uint256 private _previousRefToHoldersFee = _RefToHoldersFee;
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        uint256 tFee = calculateRefToHoldersFee(tAmount);
    ...
    function calculateRefToHoldersFee(uint256 _amount) private view returns (uint256) {
        return _amount.mul(_RefToHoldersFee).div(
            10**2
        );
    }
    ...
    function removeAllFee() private {
        if(_RefToHoldersFee == 0 && _liquidityFee == 0 && _marketingFee==0 && _burnFee==0) return;
        
        _previousRefToHoldersFee = _RefToHoldersFee;
    ...
    function restoreAllFee() private {
       _RefToHoldersFee = _previousRefToHoldersFee;
    ...
    function _transfer(
        ...
        //transfer amount, it will take RefToHolders, burn, liquidity fee
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        //Restore RefToHolders and liquidity fees
        _RefToHoldersFee = _previousRefToHoldersFee;
        _liquidityFee = _previousLiquidityFee;
