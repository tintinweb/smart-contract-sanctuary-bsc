...
contract BigHeadPresale is Ownable {
    ...
    address devAddress = 0xbaD3b4FCe98339868b132a5e62f9FA88bDA4b96f;
    address public homeAddress = 0x225c59e17f10E52F6B47B729Ac1F8a40728D9297; 
    ...
    function deposit(uint256 _amount) external checkIfPaused {
        ...
        uint256 payout = _amount.mul(1e18).div(price).div(1e9); // pBHD to mint for _amount
