...
contract Test is IERC20, Ownable {
    ...
    event ChangeMaxWalletStatus(address holder, bool status);
    ...
    constructor() {
        ...
        marketingAndDAOWalletAddress = 0xE65690b556A9894020bB444D9bF55c17c06453D1;
        donationWalletAddress = 0x41BDcADA2A5018b0F95dC219971cF171F2799A11;
        developmentWalletAddress = 0xaEFde9b261a05aa1D7C147B44590ba8E72cAf529;
    ...
    function doContractSwap() internal swapping {
        ...
        if (busdForDev > 0) {
            IERC20(REWARD).transfer(developmentWalletAddress, busdForDev);
        }
    }
