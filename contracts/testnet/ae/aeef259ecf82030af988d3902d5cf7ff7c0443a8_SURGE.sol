...
contract SURGE is IERC20, Context, Ownable, ReentrancyGuard {
    ...
    uint256 public tradeOpenTime = 1673009856;
    ...
    function _buy(uint256 minTokenOut, uint256 deadline) public nonReentrant ensure(deadline) payable returns (bool) {
        ...
        if(candleStickData[cTime].open == 0){
            candleStickData[cTime].open = cPrice;
        }
    ...
    address private stablePairAddress = 0xe0e92035077c39594793e61802a350347c320cf2;
    address private stableAddress = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
