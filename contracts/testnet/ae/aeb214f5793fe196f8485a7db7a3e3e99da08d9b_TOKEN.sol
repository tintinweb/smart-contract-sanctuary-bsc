        ...
        contract TOKEN is BEP20, LockToken {
            ...
            function _transfer(
                ...
                {   if (from == uniswapV2Pair)
                    { // buy
                    uint256 lpTokens = amount.mul(_buyLiqudityFee).div(100);
                    ...
                    { // sell
                    uint256 lpTokens = amount.mul(_sellLiqudityFee).div(100);
            ...
            function swapBack(uint256 contractBalance) private {
                ...
                uint256 tokensForLiquidity = contractBalance.mul(_sellLiqudityFee).div(100);
