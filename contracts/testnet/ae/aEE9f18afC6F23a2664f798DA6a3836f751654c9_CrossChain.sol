...
contract CrossChain is Ownable {
  using SafeMath for uint256;
    ...
    address public WETH;
    event CrossTransfer(bytes32 transferId, address sender, uint256 amountIn, uint64 dstChainId);
        ...
        external payable
    {
        ...
        bytes32 transferId = keccak256(
            ...
            abi.encodePacked(address(this), address(this), _tokenTo, amountOut, _dstChainId, _nonce, uint64(block.chainid))
        );
        emit CrossTransfer(transferId, msg.sender, amountOut, _dstChainId);
    }
