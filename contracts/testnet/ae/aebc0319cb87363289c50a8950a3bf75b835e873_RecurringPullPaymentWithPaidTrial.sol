...
/// @title RecurringPullPaymentWithPaidTrial
	...
	IVersionedContract
{
	...
	function createBillingModel(
		...
		_billingModels[newBillingModelID].initialAmount = _initialAmount;
		...
		returns (uint256 subscriptionID)
	{
		...
		bm.subscriptions[newSubscriptionID].lastPaymentTimestamp = block.timestamp;
		...
		returns (uint256 subscriptionID)
	{
		...
		require(
			...
			'RecurringPullPaymentWithPaidTrial: INVALID_SUBSCRIBER'
		);
	...
	function editBillingModel(
		...
		if (_newPayee != address(0)) {
			require(
				...
				'RecurringPullPaymentWithPaidTrial: ALREADY_PAYEE'
			);
		...
		returns (BillingModelData memory bm)
	{
		...
		bm.initialAmount = _billingModels[_billingModelID].initialAmount;
