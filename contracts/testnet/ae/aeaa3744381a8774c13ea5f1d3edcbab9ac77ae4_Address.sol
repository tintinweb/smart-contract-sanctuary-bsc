...
contract DOGEKEK is IBEP20, Auth {
    // LIBRARIES
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // MAIN WALLET ADDRESSES
    address MKT                    = 0x0a20B18eFCb220813c7353c6F48381fA04DF95c2;
    address PROJECT                = 0xfaC4E8a41D5c508fEC1fa70acE06D3D0b433546F;
    address TOKEN_B                = 0xB7C241eE8024242864457E845aba277ae1D78312;

    // TOKEN GLOBAL VARIABLES
    string constant _name = "DOGE KEK";
    string constant _symbol = "DGK";
