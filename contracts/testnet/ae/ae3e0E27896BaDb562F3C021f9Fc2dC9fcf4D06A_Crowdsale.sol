...
contract TEST_TOKEN is Context, IBEP20, Ownable {
...
contract Crowdsale is Ownable {
    ...
    constructor (
        ...
        uint256 phase2DurationInDays)
     {
        ...
        tokenReward = TEST_TOKEN(tokenRewardAddress);
    ...
    function getCurrentState() public view returns(State) {
        ...
        if (block.timestamp >= phase1OpeningTime && block.timestamp < phase1ClosingTime) {
            currentState = State.Phase1;
        }
        else if (block.timestamp >= phase2OpeningTime && block.timestamp < phase2ClosingTime) {
    ...
    function _validatePurchase(address beneficiary, uint256 weiAmount, State currentState) internal pure {
