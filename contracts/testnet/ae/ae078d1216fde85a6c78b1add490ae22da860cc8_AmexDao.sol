...
contract AmexDao is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        pancakeswapV2Pair = IPancakeFactory(_pancakeswapV2Router.factory()).createPair(address(this), USDT);
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if (!inSwap && !isMarketPair[sender] && sender != owner() && contractTokenBalance > 0) 
            {
    ...
    function swapAndSendFee(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 recieveUSDtBalance = IERC20(USDT).balanceOf(address(this));
        emit SwapAndSendFee(contractTokenBalance, recieveUSDtBalance);
    }
