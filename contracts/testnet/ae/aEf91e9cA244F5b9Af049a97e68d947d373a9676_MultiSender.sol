...
contract MultiSender is Ownable {
    ...
    address public constant ETH_ADDRESS = 0xBa55D5FeA81050659E26e5F2932Db3e958c878d7;
    ...
    function multiSendEther(address payable[] memory _contributors, uint256[] memory _balances) public payable {
        ...
        emit MultiSend(msg.sender, ETH_ADDRESS, msg.value);
    }
    ...
    function multiSendNFT(
        ...
        emit MultiSend(msg.sender, ETH_ADDRESS, _tokenIds.length);
    }
