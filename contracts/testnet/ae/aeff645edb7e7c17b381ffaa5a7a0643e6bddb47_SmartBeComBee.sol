...
contract SmartBeComBee {
    ...
    struct B6 {
        ...
        uint[] toLevelReferrals; //first/second, type, order
        uint reinvestCount;
        bool blocked;
    ...
    function updB3Refer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        emit NewUserPlace(userAddress, referrerAddress, 1, level, 3, users[referrerAddress].b3Matrix[level].reinvestCount, usertype);
        users[referrerAddress].b3Matrix[level].toReferrals.push(usertype*10+3);
    ...
    function updB6Referrer(address userAddress, address referrerAddress, uint8 level) private {
        ...
        if (users[referrerAddress].b6Matrix[level].firstLevelReferrals.length < 2) {
            ...
            users[referrerAddress].b6Matrix[level].toLevelReferrals.push(100+usertype*10+place);
            ...
            if ((len == 2) && 
                ...
                if (users[referrerAddress].b6Matrix[level].firstLevelReferrals.length == 1) {
                    emit NewUserPlace(userAddress, ref, 2, level, 5, users[referrerAddress].b6Matrix[level].reinvestCount, usertype);
                    users[ref].b6Matrix[level].toLevelReferrals.push(200+usertype*10+5);

                } else {
                    emit NewUserPlace(userAddress, ref, 2, level, 6, users[referrerAddress].b6Matrix[level].reinvestCount, usertype);
                    users[ref].b6Matrix[level].toLevelReferrals.push(200+usertype*10+6);
                }
            }  else if ((len == 1 || len == 2) &&
                    users[ref].b6Matrix[level].firstLevelReferrals[0] == referrerAddress) {
                if (users[referrerAddress].b6Matrix[level].firstLevelReferrals.length == 1) {
                    emit NewUserPlace(userAddress, ref, 2, level, 3, users[referrerAddress].b6Matrix[level].reinvestCount, usertype);
                    users[ref].b6Matrix[level].toLevelReferrals.push(200+usertype*10+3);
                } else {
                    emit NewUserPlace(userAddress, ref, 2, level, 4, users[referrerAddress].b6Matrix[level].reinvestCount, usertype);
                    users[ref].b6Matrix[level].toLevelReferrals.push(200+usertype*10+4);
                }
    ...
    function updB6(address userAddress, address referrerAddress, uint8 level, bool x2) private {
        if (!x2) {
            ...
            emit NewUserPlace(userAddress, referrerAddress, 2, level, 2 + place, users[referrerAddress].b6Matrix[level].reinvestCount, 2);
            
            users[users[referrerAddress].b6Matrix[level].firstLevelReferrals[0]].b6Matrix[level].toLevelReferrals.push(120+ place);
            users[referrerAddress].b6Matrix[level].toLevelReferrals.push(210+ 2 + place);
            ...
            emit NewUserPlace(userAddress, referrerAddress, 2, level, 4 + place, users[referrerAddress].b6Matrix[level].reinvestCount, 2);

            users[users[referrerAddress].b6Matrix[level].firstLevelReferrals[1]].b6Matrix[level].toLevelReferrals.push(120+ place);
            users[referrerAddress].b6Matrix[level].toLevelReferrals.push(210+ 4 + place);
    ...
    function updB6ReferrerSecondLevel(address userAddress, address referrerAddress, uint8 level) private {
        ...
        delete users[referrerAddress].b6Matrix[level].toLevelReferrals;
    ...
    function usersB6Matrix(address userAddress, uint8 level) public view returns(address, address[] memory, address[] memory, bool, uint[] memory) {
        return (users[userAddress].b6Matrix[level].currentReferrer,
                ...
                users[userAddress].b6Matrix[level].toLevelReferrals);
    }
    function usersB6Matrix2(address userAddress, uint8 level) public view returns(address, address[] memory, address[] memory, uint, uint8, uint[] memory) {
        return (users[userAddress].b6Matrix[level].currentReferrer,
                users[userAddress].b6Matrix[level].firstLevelReferrals,
                users[userAddress].b6Matrix[level].secondLevelReferrals,
