...
contract MockERC721 is ExtendERC721 {
    constructor() ExtendERC721("Mock", "MOCK") {
    }
}
...
abstract contract ExtendERC721 is IExtendERC721, ERC721Enumerable, AccessControlEnumerable, Ownable {
    ...
    function getMetadataId(uint256 tokenId) external override view returns(string memory) {
