...
contract PlearnNFT is IPlearnNFT, ERC721Enumerable, ERC721Pausable, ERC721Burnable, Ownable, AccessControl, ReentrancyGuard {
    ...
    function mint(address to, uint256 tokenId)
        ...
        returns (bool)
    {
        require(totalSupply() < _maxSupply, "Plearn NFT: Total supply reached");
