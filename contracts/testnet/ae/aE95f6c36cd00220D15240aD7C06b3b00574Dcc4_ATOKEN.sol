...
contract ATOKEN is ERC20Detailed, Ownable, WhitelistedRole {
    ...
    bool private initialDistributionFinished = true;
    ...
    uint256 public rewardYield = 2500000;
    ...
    address private liquidityReceiver = 0x83D4A655e61C77F9aC2beD846B90E1bA2526D36C;
    address private treasuryReceiver = 0xC5D82f6B6D387788140C98cFCC386238b9A3b912;
    address private riskFreeValueReceiver = 0x3a6299C681E6720C65294208A725187fB0CFb920;
    address private busdToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;

    IDEXRouter public router;
    address public pair;

    uint256 private liquidityFee = 5;
    uint256 private treasuryFee = 5;
    uint256 private buyFeeRFV = 5;
    uint256 public price = 9120000000000000;
    uint256 private sellFeeTreasuryAdded = 5;
    uint256 private sellFeeRFVAdded = 5;
    uint256 private totalBuyFee = liquidityFee.add(treasuryFee).add(buyFeeRFV);
    uint256 private totalSellFee = totalBuyFee.add(sellFeeTreasuryAdded).add(sellFeeRFVAdded);
    ...
    constructor() ERC20Detailed("A Token11", "Token11", uint8(DECIMALS)) {
    ...
    function XsendFee() public payable {
         require(msg.value == price, 'Need to send some ETH');

    }

    function userRebase() public payable {
    ...
    function setInitialDistributionFinished(bool _value) private {
    ...
    function setFees(uint256 _liquidityFee, uint256 _riskFreeValue, uint256 _treasuryFee, uint256 _sellFeeTreasuryAdded, uint256 _sellFeeRFVAdded, uint256 _feeDenominator, uint256 _price) private {
        require(
    ...
    function setAutoRebase(bool _autoRebase) private {
        require(autoRebase != _autoRebase, "Not changed");
        autoRebase = _autoRebase;
    }

    function setRebaseFrequency(uint256 _rebaseFrequency) private {
        require(_rebaseFrequency <= MAX_REBASE_FREQUENCY, "Too high");
        rebaseFrequency = _rebaseFrequency;
    }

    function setRewardYield(uint256 _rewardYield, uint256 _rewardYieldDenominator) public onlyOwner {
        rewardYield = _rewardYield;
        rewardYieldDenominator = _rewardYieldDenominator;
    }

    function setFeesOnNormalTransfers(bool _enabled) private {
    ...
    function setMaxSellTransaction(uint256 _maxTxn) public onlyOwner {
