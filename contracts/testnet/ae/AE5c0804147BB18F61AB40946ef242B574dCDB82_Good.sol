...
contract Good is Ownable, ReentrancyGuard {
    ...
    address public constant DEVELOPER = 0x034bFa575989Cb4b935CC7f34eAb02cd0E797871;
    ...
    event depUser(uint256 indexed id, address indexed user);
        ...
        alreadyInit
    {
        ...
        emit depUser(lastID, msg.sender);
    }
