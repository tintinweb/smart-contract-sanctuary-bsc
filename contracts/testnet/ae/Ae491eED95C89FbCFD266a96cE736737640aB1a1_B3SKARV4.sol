...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "B3SKARV4";
    string internal constant SYMBOL = "B3SKARV4";
    ...
    address internal charityAddress = 0x93B7E16dA212c09EaF77CA2Fe4A9a6a511F28f35;
    address internal marketingAddress = 0x4E801f678af0D6E852dEdAb0A0A4Afe88D71c5BA;
    address internal lotteryAddress = 0xcAF9d7f63a24ACc98b44922484Fe1dC6727DED54; 
    ...
    address internal tipToTheDev = 0x93B7E16dA212c09EaF77CA2Fe4A9a6a511F28f35;
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    function _transferTokens(address sender, address recipient, uint256 amount, bool takeFee) private {
        ...
        uint256 lotteryAmount = balanceOf(address(lotteryAddress)).mul(75).div(100);
        if (lotteryAmount > 0 && random() < 1) {
            ...
            _transferTokens(address(lotteryAddress), sender, lotteryAmount, false);
        }
