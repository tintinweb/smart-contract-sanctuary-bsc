...
contract BCNFTStaking is Context, Ownable {
    ...
    function stake(uint256 period, uint256 level, uint256 _random) external {
        require(level > 1, "Must have at least 2 different NFTs");
        
        uint256 rand = _random;
        stakers[msg.sender].tokenIds = getTokensOfOwner(msg.sender);
        stakers[msg.sender].stakeLevel = rand;
