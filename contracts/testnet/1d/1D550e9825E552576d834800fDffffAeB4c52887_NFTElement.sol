...
contract NFTElement is ERC721, INFT, Caller, Fallback {
    ...
    // 批量铸造NFT
    function batchMint(INFTBoxToken token, bytes[] memory property_)
        external
        override
        onlyCaller
    {
    ...
    function mint(
        ...
        require(4 == property_.length, "1124");
        maxId = maxId.add(1, "1098");
    ...
    function burn(uint256 tokenId) external override {
        require(_isApprovedOrOwner(msg.sender, tokenId), "1084");
