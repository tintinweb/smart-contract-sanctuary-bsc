...
contract Kichee is IERC20 {
    ...
    */
    ...
    function buyTokensByUSDC(uint256 valueUSDC, string) checkHardCaps((valueUSDC.mul(priceUsdc)).div(1000000), msg.sender) public{
        iUSDC.transferFrom(msg.sender,address(this),valueUSDC);
        _mintNewTokens(msg.sender, (valueUSDC.mul(priceUsdc)).div(1000000));
        totalMinted += (valueUSDC.mul(priceUsdc)).div(1000000);
        userPurchase[msg.sender] += (valueUSDC.mul(priceUsdc)).div(1000000);
    }
    ...
    function claimTokens() external returns(bool){
        ...
        totalMinted += whitelistClaimUsers[msg.sender];
