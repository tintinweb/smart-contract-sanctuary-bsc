...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xeBd0bD777F5C66E781f05cCc5aD8864d751d91a8;
...
contract AskTest is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0xeBd0bD777F5C66E781f05cCc5aD8864d751d91a8;
    ...
    string private _name = "Asktest";
    string private _symbol = "A2E";
    ...
    constructor () {
        ...
        //mainnet arbi 0x38eEd6a71A4ddA9d7f776946e3cfa4ec43781AE6
    ...
    function _takeDevelopment(uint256 tDevelopment) private {
        uint256 currentRate =  _getRate();
        uint256 rDevelopment = tDevelopment.mul(currentRate);
        _rOwned[_charityWalletAddress] = _rOwned[_charityWalletAddress].add(rDevelopment);
        if(_isExcluded[_charityWalletAddress])
            _tOwned[_charityWalletAddress] = _tOwned[_charityWalletAddress].add(tDevelopment);
    }
