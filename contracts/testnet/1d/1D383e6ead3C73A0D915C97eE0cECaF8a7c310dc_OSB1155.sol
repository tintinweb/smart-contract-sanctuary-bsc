...
contract OSB1155 is ERC1155 {
    ...
    constructor(string memory _name, string memory _symbol, address _sale) ERC1155("") {
        name = _name;
        symbol = _symbol;
        sale = _sale;
    }
...
contract $OSB1155 is OSB1155 {
    constructor(string memory _name, string memory _symbol, address _sale) OSB1155(_name, _symbol, _sale) {}
