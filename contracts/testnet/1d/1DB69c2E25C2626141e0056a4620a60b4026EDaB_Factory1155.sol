...
import "./LunaOneUser1155Token.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new LunaOneUser1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        LunaOneUser1155Token token = LunaOneUser1155Token(address(addr));
...
contract LunaOneUser1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
