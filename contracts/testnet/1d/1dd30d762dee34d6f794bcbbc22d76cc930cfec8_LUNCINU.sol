...
// File contracts/LUNCINU.sol
pragma solidity ^0.8.0;

contract LUNCINU is Context, IERC20, Ownable {
    ...
    uint256 public maxTxAmountBuy = _tTotal / 400; // 0,25% of supply
    uint256 public maxTxAmountSell = _tTotal / 400; // 0,25% of supply
    ...
    string private constant _name = "LUNC INU";
    string private constant _symbol = "LUNCINU";
    ...
    uint256 public numTokensSellToAddToLiquidity = _tTotal / 50;
    ...
    feeRatesStruct public buyRates =
        feeRatesStruct({
            ...
            lp: 1, // lp rate in %
            toSwap: 8 // treasury + autolp
        });

    feeRatesStruct public sellRates =
        feeRatesStruct({
            rfi: 5, // reflection rate, in %
            treasury: 4, // treasury fee in %
            lp: 1, // lp rate in %
            toSwap: 10 // treasury + autolp
        });
