...
contract PistonToken is Initializable, ERC20Upgradeable, OwnableUpgradeable {
    ...
    bool public tradingEnabled;
		...
		iPistonController PistonControllerApp;
	...
	function setUniswapV2PairAndController(address _uniswapV2Pair, address   _controller, iPistonController   _PistonController) external onlyOwner{
        uniswapV2Pair=address(_uniswapV2Pair);
				controller=address(_controller);
				PistonControllerApp = _PistonController;
				excludeFromFees(controller, true);
    }

    function setFees(uint256 _ecosystemFee, uint256 _devFee, uint256 _liquidityFee, uint256 _extraSellFee) external onlyOwner{
    ...
    function _transfer(
		...
		emit TestEvent_I_WAS_HERE("Trasnfer started 1");
        ...
        emit TestEvent_I_WAS_HERE("_transfer");
        ...
        emit TestEvent_I_WAS_HERE("before takeFee");
        if(takeFee) {
            emit TestEvent_I_WAS_HERE("in takeFee");
        ...
        super._transfer(from, to, amount);
					...
					// do some thing after _transfer
				emit TestEvent_I_WAS_HERE("After tarnsfer, do swap");
				PistonControllerApp.swapAndLiquify();
    }  
