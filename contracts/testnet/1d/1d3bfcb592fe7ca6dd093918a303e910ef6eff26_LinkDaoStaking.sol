...
contract LinkDaoStaking is Ownable {
    ...
    uint256 public MAX_STAKE = 1000 ether;
    uint256 public MAX_STAKE_PER_USER = 500 ether;
    ...
    uint256 public TOTAL_RELEASE_DAYS = 24 minutes;

    uint256 public ROI_PERCENTAGE = 2500; // 2.5%
    uint256 public TOTAL_PERCENTAGE = 100000;
    uint256 public MAX_REWARD_PERCENTAGE = 40750;
    ...
    function investAmountForOwner(address investorAddress,uint256 _amount) external onlyOwner{
        ...
        require(totalInvestments.add(_amount)<=MAX_STAKE,"Cannot stake more than 1000 LKD");
        require(investors[investorAddress].totalInvestment.add(_amount)<=MAX_STAKE_PER_USER,"Cannot stake more than 1000 LKD");
    ...
    function investAmount(uint256 _amount) external{
        ...
        require(totalInvestments.add(_amount)<=MAX_STAKE,"Cannot stake more than 1000 LKD");
        require(investors[msg.sender].totalInvestment.add(_amount)<=MAX_STAKE_PER_USER,"Cannot stake more than 1000 LKD");
