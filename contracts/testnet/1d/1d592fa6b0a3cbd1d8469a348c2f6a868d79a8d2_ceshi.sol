...
contract ceshi is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xB6BA90af76D139AB3170c7df0139636dB6120F7e); //一个标准合同 
        ...
        teamWalletAddress = payable(address(0xb9166C61904CE1311185664618E6ceF2bD442AAf));
        marketingWalletAddress = payable(address(0xb9166C61904CE1311185664618E6ceF2bD442AAf));
