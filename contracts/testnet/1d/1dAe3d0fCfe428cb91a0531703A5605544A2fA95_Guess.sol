...
contract Guess {
    ...
    function setUserGuessData(
        ...
        require(!isContract(msg.sender), "address is invalid");
        (
            bool isExist,
            uint256 tokenId,
        ...
        require(isExist, "you don't have GuessGlasses");
        ...
        require(
            ...
            "your NFT status is locked"
        );
        require(_userGuessData.rate < 100001, "max rate is 1000x");
        require(
