...
contract LPMining is Ownable {
    ...
    function addPool(bool lockToTime_, IPair lpToken_, IBEP20 outPutToken_, uint dailyOut_, uint endTime_, bool withUpdate_) public onlyOwner returns(uint _pid){
    ...
    function addTimeLimitPool(bool lockToTime_, IPair lpToken_, IBEP20 outPutToken_, uint dailyOut_, uint startTime_, uint endTime_, bool withUpdate_) public onlyOwner returns(uint _pid){
        require(initialize, "not started");
