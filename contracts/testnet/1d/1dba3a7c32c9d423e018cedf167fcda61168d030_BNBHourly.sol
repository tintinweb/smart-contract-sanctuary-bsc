...
contract BNBHourly {
	...
	uint256 constant public INVEST_MIN_AMOUNT = 0.0001 ether; //0.1
    uint256 constant public INVEST_MAX_AMOUNT = 1000 ether; 
    uint256 constant public WITHDRAW_MIN_AMOUNT = 0 ether; //0.1
    uint256 constant public WITHDRAW_MAX_AMOUNT = 100 ether; 
    uint256 constant public MAX_DEPOSIT = 300;
    uint256 constant public INVEST_STEP = 0.0001 ether; //0.01
	...
	constructor() {
        ceoWallet = payable(0xDb569603dc189Aa1F23a6B661D02BA562656E212);
		marketinWallet = payable(0xDb569603dc189Aa1F23a6B661D02BA562656E212);
        insuranceWallet = payable(0xDb569603dc189Aa1F23a6B661D02BA562656E212);

		startDate = 1672743600;

        plans.push(Plan(25, 600));
        plans.push(Plan(25, 650));
		plans.push(Plan(25, 700));
		plans.push(Plan(25, 750));
		plans.push(Plan(25, 800));
		plans.push(Plan(25, 850));
	}
	...
	function admin() public {
		require(msg.sender == ceoWallet, "Not admin");
