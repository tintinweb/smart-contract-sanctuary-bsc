...
// 7% LOCK WALLET 3 Months (NEKO SUPERSTAR) This will be used to add "Liquidity or Burnt"
// 8% Airdrop Wallet
// LP lock 6 Months
// ----------------------------------------------------------------------------
...
contract NekoGame is ERC20, Ownable {
    ...
    constructor() ERC20("Carlos", "TokenCarlos"){
        // address newOwner = address(0x4ea2b5aCe230156C6F064f9A82e3423eA9d3a374);
    
        uint256 totalSupply = 400 * 1e12 * 1e18;
    	...
    	marketingWallet = address(0xf370C0f60c3022E2116846893c029b2E1302A513);  // set as marketing wallet
        charityWallet = address(0xf370C0f60c3022E2116846893c029b2E1302A513);    // set as charity wallet
        lockWallet = address(0xf370C0f60c3022E2116846893c029b2E1302A513);       // set as lock wallet

        devWallet = address(0xD518bEA4be7A696D7b0A4E55469c251fe70D43E0);        // set as dev wallet
        liquidityWallet = address(0xB5E0c85EAFB53eBe9E2AB6D91be8C8366BaAa729);  // set as liquidity wallet
        presaleWallet = address(0xa3281bA47Cb254aF1951f8D9F6C8B47290d8f586);  // set as presale wallet
        airdropWallet = address(0x309C2fb3E6EB8be6a1127aBcD266C612349784fF);    // set as airdrop wallet
        deadWallet = address(0x9E38a22f4bb7cF0046B14Cf11fe7708451FA4071);       // set as dead wallet
