...
contract FundMe {
    ...
    function fund() public payable {
        console.log("::::: Calling Fund... Caller: %s", msg.sender);
     ...
     function withdraw() public onlyOwner {
        console.log("::::: Calling Withdraw... Caller: %s", msg.sender);
        for (uint256 funderIndex = 0; funderIndex < s_funders.length; funderIndex++) {
            address funder = s_funders[funderIndex];
            s_addressToAmountFunded[funder] = 0;
        }
        s_funders = new address[](0); // reinitialize funders
     ...
     function cheaperWithdrawal() public payable onlyOwner {
        address[] memory funders = s_funders; // use memory to avoid reading from storage, and save on gas
    ...
    // The reason for these getter functions is so that people interracting with our code
    // have a cleaner API to work with instead of the variable names starting with s_ or i_
    // Also, changing the visibility can save us some gas as well
