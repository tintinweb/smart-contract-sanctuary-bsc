...
contract JkcToken is IERC20, Ownable, Util {
    ...
    function _transfer(
        ...
        if(sender == swapRouter && !_isExcludedFromFee[recipient]) {
            ...
            purchaseRecord[block.number][recipient] = amount;
    ...
    function getPurchaseRecord(uint256 _number, address _address) public view returns(uint256 amountToWei) {
        return purchaseRecord[_number][_address];
    }
