...
contract BringBack80s is Ownable, IBEP20 {
    ...
    address pancakeAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;
   // address pancakeAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;

    uint256 public gas = 13 * 1 gwei;

    string constant _name = "Bring Back 80s";
    string constant _symbol = "BB80";
    ...
    uint256 public opperationFee = 3;
    ...
    address private opperationWallet;
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x9A833152c22b51780548ce1997915C384194e7e1;
        marketingWallet = 0x693f2c607b06f58D2d84A17Bb33e54Ac7892A347;
        opperationWallet = 0x1BE5436ca5c0949375B472cBdb644034501612cC;
        
        isFeeExempt[marketingWallet] = true;
        totalFee = liquidityFee.add(marketingFee).add(opperationFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        uint256 amountBNB = address(this).balance.mul(95).div(100);

        uint256 totalBNBFee = totalFee.sub(liquidityFee.div(2));

        uint256 amountBNBLiquidity = amountBNB.mul(liquidityFee).div(totalBNBFee).div(2);
        uint256 amountBNBMarketing = amountBNB.mul(marketingFee).div(totalBNBFee);
        uint256 amountBNBOpperation = amountBNB.mul(opperationFee).div(totalBNBFee);
        
        (bool tmpSuccess1,) = payable(marketingWallet).call{value : amountBNBMarketing, gas : 30000}("");
        tmpSuccess1 = false;

        (bool tmpSuccess2,) = payable(opperationWallet).call{value : amountBNBOpperation, gas : 30000}("");
        tmpSuccess2 = false;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newopperationFee, uint256 extraSellFee) external onlyOwner {
        liquidityFee = newLiqFee;
        marketingFee = newMarketingFee;
        opperationFee = newopperationFee;
