...
contract LuckyRoll {
    ...
    function placeBet(uint betMask, uint modulo, uint commitLastBlock, uint commit, bytes32[2] ecdsa, uint8 v, uint amount) external {
        ...
        require (secretSigner == ecrecover(signatureHash, v, ecdsa[0], ecdsa[1]), "ECDSA signature is not valid.");
