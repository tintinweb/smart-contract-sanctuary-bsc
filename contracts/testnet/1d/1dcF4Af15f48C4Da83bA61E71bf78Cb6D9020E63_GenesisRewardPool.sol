...
contract GenesisRewardPool is Operator{
    ...
    // MAINNET
    uint256 public crystalPerSecond = 0.0330687 ether; // 20000 CRS / (7 days * 24h * 60min * 60s)
    uint256 public runningTime = 7 days; // a week
    ...
    constructor(address _crystal, uint256 _poolStartTime) {
    ...
    function add(
        ...
        poolInfo.push(PoolInfo({token: _token, allocPoint: _allocPoint, lastRewardTime: _lastRewardTime, accCRSPerShare: 0, isStarted: _isStarted}));
        if (_isStarted) {
