...
// File: contracts/MoonExchangeToken.sol
pragma solidity ^0.7.6;
contract MET is ERC20, Ownable {
    ...
    constructor() public ERC20("Moon Exchange Token", "M.E.T") {
        // LP address
        LPaddress = address(0xE169240b9965E691BBa73231c81C5890dd6E5655);
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        //require(_isExcludedFromFees[account] != excluded, "M.E.T: Account is already the value of 'excluded'");
    ...
    function _transfer(
        ...
        if(!tradingIsEnabled) {
            require(canTransferBeforeTradingIsEnabled[from], "M.E.T: This account cannot send tokens until trading is enabled");
        }
