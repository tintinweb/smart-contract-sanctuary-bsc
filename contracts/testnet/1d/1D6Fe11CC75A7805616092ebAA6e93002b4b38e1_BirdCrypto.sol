...
contract BirdCrypto is  IERC20 {
    ...
    */
    ...
    uint256 public override totalSupply = 1000000000 * 10**6 * 10**9;
    uint256 public _rTotal = (MAX - (MAX % totalSupply));
    ...
    function launch() public returns (bool) {
        ...
        uint256 _treasuryShare = _share.mul(49);
        uint256 _tokenLiquidity = _share.mul(50);


        //Transfers
        
        //dev/marketing
        _transfer(address(this), _owner, _share);
        //treasury
        _transfer(address(this), address(treasury), _treasuryShare);
