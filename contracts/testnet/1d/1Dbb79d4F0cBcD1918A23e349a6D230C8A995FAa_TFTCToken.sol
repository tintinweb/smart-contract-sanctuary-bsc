...
// File: contracts/TFTCfix3/TFTCToken.sol
...
contract TFTCToken is IBEP20, Ownable {
    ...
    modifier onlyByCaller() {
        require(msg.sender == _msgSender(), "BEP20: Caller is not a sender");
        _;
    }
    ...
    function approve(
        ...
        //Suggested ERC20 API Changes for APPROVE FRONT-RUNNING ATTACK
        //If current allowance for spender is equal to currentValue,
        //then overwrite it with amount and return true
        require(
            _allowances[_msgSender()][spender] == currentValue,
            "BEP20: approval overriding current allowance"
        );
    ...
    function transferFrom(
        ...
        address recipient,
        uint256 amount
    ) external payable virtual override onlyByCaller returns (bool) {
        require(
