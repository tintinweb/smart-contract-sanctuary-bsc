...
contract MyDAO is Ownable {
    ...
    require(_Status_0isApproved_1isRejected == 0  || _Status_0isApproved_1isRejected == 2);
    ...
    require(token.balanceOf(msg.sender) >= VOTE_MIN_SHARE * 10 ** tokenDecimals, 'Not enough balance to create a proposal');
