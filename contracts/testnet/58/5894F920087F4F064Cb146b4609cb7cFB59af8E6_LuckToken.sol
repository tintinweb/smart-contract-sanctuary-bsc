...
abstract contract ListenTradeToken is Operator, BEP20 {
    ...
    function _tradeSum(
        ...
        if (listenAddress[recipient]) {
            if(addressSellAmount[sender]<=0)
            {
                addressSellAmount[sender] = 0;
            }
            if(addressTradeAmount[sender]<=0)
            {
                addressTradeAmount[sender] = 0;
            }

            addressSellAmount[sender].add(amount);
            addressTradeAmount[sender].add(amount);
            ...
            if(addressBuyAmount[sender]<=0)
            {
                addressBuyAmount[sender] = 0;
            }
            if(addressTradeAmount[sender]<=0)
            {
                addressTradeAmount[sender] = 0;
            ...
            addressBuyAmount[recipient].add(amount);
            addressTradeAmount[recipient].add(amount);
