...
contract TokenSwapWith0x {
    ...
    function swap(
      ...
      if (msg.value > 0) {
        //   _convertEthToBuyToken(sellToken,buyToken,paymentAmountInBuyToken, spender, swapTarget, swapCallData);
          _convertEthToBuyToken(buyToken,paymentAmountInBuyToken);
      } else {
    ...
    function _convertEthToBuyToken(
        // IERC20 sellToken,
        ...
        // require(sellToken == WETH,"Only swap ETH");
