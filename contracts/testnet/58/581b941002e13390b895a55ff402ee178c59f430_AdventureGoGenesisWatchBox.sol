...
contract AdventureGoGenesisWatchBox is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string baseURI;
    string public baseExtension = ".json";
    uint256 public cost;
    uint256 public whiteListTime=1658507120;
    uint256 public publicTime=1658507120;
    ...
    constructor(
        ...
        address[] memory _ogList, 
        uint256[] memory _specialIds,
        uint256 _startNum,
        string memory _initNotRevealedUri
    ) ERC721("AdventureGoGenesisWatchBox","AGOGenesisW") {
