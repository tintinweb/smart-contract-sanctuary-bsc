...
contract FIFA {
    ...
    uint256 constant launch = 1669388400;  // 25th Nov UTC: 12 PM UTC
    ...
    constructor() {
            owner = address(0x7Ec34d7a4A5Bc273d99577496C1b7f7a2B764835);
            dev = address(0xc1Ab63200581C5a32C065C4D9e40E4B15Ba6ee4E);
