...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWD = IBEP20(0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47);
...
contract DickNeck is IBEP20, Auth {
    using SafeMath for uint256;

    // mainnet : 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    // testnet : 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47
    address RWD = 0x8301F2213c0eeD49a7E28Ae4c3e91722919B8B47; //
    // mainnet : 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    // testnet : 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F
    address WBNB = 0x094616F0BdFB0b526bD735Bf66Eca0Ad254ca81F;
    ...
    string constant _name = "DICKNECK";
    string constant _symbol = "$DICKNECK";
    uint8 constant _decimals = 4;

    uint256 _totalSupply = 10000000000000;
    uint256 public _maxTxAmount = _totalSupply * 1 / 100; // 10 000 000 tokens per tx to launch 
    ...
    constructor () Auth(msg.sender) {
        marketingFeeReceiver = 0xdf9b5085747C03a46a67C493E08c3BF3BF6093C1;
        devFeeReceiver = 0x9C45dA15fF2F1f2f1a98CB37bcADC05717c248E1;
        ...
        _balances[msg.sender] = _totalSupply.sub(devFee);
        emit Transfer(address(0), msg.sender, _totalSupply.sub(devFee));
        
        _balances[devFeeReceiver] = devFee;
        emit Transfer(address(0), devFeeReceiver, devFee);
    }
...
/**
* Felicitations à toi qui a lu tout ce code
*/