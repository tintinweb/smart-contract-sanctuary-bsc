...
contract BakeryChicka is Context, Ownable {
    ...
    function buyEggs(address ref) public payable {
        require(initialized);
        uint256 eggsBought = calculateEggBuy(704147135529274453,SafeMath.sub(address(this).balance,704147135529274453));
