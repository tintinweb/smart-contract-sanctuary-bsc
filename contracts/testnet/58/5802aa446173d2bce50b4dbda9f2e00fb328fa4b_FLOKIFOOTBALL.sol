...
interface IUniswapV2Router02 is IUniswapV2Router01 {
 ...
 contract FLOKIFOOTBALL is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "SUPERBALL FLOKI";                  
 ...
 //COLLECT TAX IN TOKENS WHEN SWAP LIQUIFY SET TO FALSE THIS IS FOR SLOW PERIODS AND COMMUNITY BURNS
    ...
    uint256 public _fundingFee4Sellers = 8;
    ...
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        ...
        payable(0x016Ba94d432141bF1460Bd01C5f6a4785b9c48fF),
        payable(0x016Ba94d432141bF1460Bd01C5f6a4785b9c48fF)
 ];
