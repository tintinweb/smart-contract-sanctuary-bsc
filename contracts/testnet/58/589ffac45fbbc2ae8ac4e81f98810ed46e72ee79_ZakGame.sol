...
// CHANGE
contract ZakGame  is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ZAK Game";
    string constant _symbol = "ZAKG";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals); // 1,000,000
    uint256 public _maxTxAmount = (_totalSupply * 3) / 1000; // 0.3% MAX 3,000
    uint256 public _maxWalletSize = (_totalSupply * 15) / 1000; // 1.5% MAX 15,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xD6F759293d3f9c0229a43ef1CDB7246636912014);
 ...
 _balances[account]; }
    ...
    function setDistributionCriteria(uint256
 _minPeriod, uint256 _minDistribution) external onlyOwner {
