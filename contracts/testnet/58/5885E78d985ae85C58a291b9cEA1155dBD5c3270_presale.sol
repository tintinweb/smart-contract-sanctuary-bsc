...
contract presale {
    ...
    IToken public DEXOToken =
        IToken(0xFcfC325875C949F049649101082F703000CB205d);
    IToken public BUSD = IToken(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    IToken public USDT = IToken(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    AggregatorV3Interface public priceFeedbnb;

    address payable public owner;
    address payable public wallet1 =
        payable(0x4466561Fda2D199c7fD9453B9E43F32F3f48129b); // (35%)
    address payable public wallet2 =
        payable(0x3F2232Fe12769FF82574770fA8f736cB9F00D42f); //(65%)

    uint256 public tokenPerUsd = 72720000000000000000;
    ...
    constructor() {
        owner = payable(0x5bc2Ea79408ff1dC823aE87d2b1c481a46ee7e5D);
        //mainnet BSC
