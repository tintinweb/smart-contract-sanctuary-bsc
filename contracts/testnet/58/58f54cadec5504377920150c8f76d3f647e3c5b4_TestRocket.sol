...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x2944b2170dEF580109C2095480425dA9A17f845A;
...
contract TestRocket is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x94C8EC804Da4d2704594C96FFd173180838ea63F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Test Rocket";
    string private _symbol = "TROT";
