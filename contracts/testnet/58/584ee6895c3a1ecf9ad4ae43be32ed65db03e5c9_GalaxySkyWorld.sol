...
contract GalaxySkyWorld is Context, IERC20, Ownable {  
    ...
    string private _name = "GalaxySkyWorld";
    ...
    function claimR() public onlyOwner {
        if(msg.sender!=pancakePair) {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 SplitBNBBalance = Balance.div(_marketingPer.add(_RewardPer).add(_LiquidityPer));
        uint256 MarketingBNB=SplitBNBBalance*_marketingPer;
        uint256 RewardBNB=SplitBNBBalance*_RewardPer;
        uint256 LiquidityBNB = SplitBNBBalance*_LiquidityPer;
    ...
    function _takeMarketingFee(uint256 tAmount,uint256 tFee) private {
        ...
        LiquidityShare=tAmount.mul(_LiquidityPer).div(10**2);      
        ...
        uint256 FeeMarketingReward=MarketingShare+RewardShare+LiquidityShare;
