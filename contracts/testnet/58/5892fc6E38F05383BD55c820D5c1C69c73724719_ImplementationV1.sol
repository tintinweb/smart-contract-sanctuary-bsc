...
contract Upgradeable is ReentrancyGuard {
    ...
    mapping(string => bool) public usedDiscountCodes;
...
library HashUtils {
        ...
        returns (bytes32 hash)
    {
        ...
        index = index.writeUint256(_mintRequest.discountAmount);
        ...
        index = index.writeBytes(bytes(_mintRequest.discountCode));
...
library Utils {
        ...
        returns (uint256)
    {
        return ((0x20 * 3) +
            ...
            bytes(_item.discountCode).length);
    }
