...
// fixed supply
// ----------------------------------------------------------------------------
contract GBOX is ERC20Interface, Owned {
    ...
    address public devPool = address(0x2a04d2Edd28D72e86279624CcE2f8b9f13815aCd);
    address public gaur_dao = address(0x2641bb0820cB5D844877604D85730aFD410Bf730);
    address public supe_dao = address(0xb972C4027818223BB7b9399b3cA3cA58186e1590);
    ...
    function initialize(address _router, address _WETH, address _devPool, address _gaur_dao, address _supe_dao, address _treasury, address _supe) external onlyOwner{
