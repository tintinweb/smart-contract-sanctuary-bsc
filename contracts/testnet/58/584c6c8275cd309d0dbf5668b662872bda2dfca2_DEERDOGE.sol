...
contract DEERDOGE is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "DEERDOGE";
   string constant _symbol = "$ARFARF";
...
uint256 reflectionFee = 2;
   ...
   uint256 public swapThreshold = _totalSupply / 500; // 0.5%
   bool inSwap;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0xa5ddE6B6b3a4292730fA134207f28f2654f0d410; //should be wallet of owner
       ...
       autoLiquidityReceiver = 0xa5ddE6B6b3a4292730fA134207f28f2654f0d410; //Can be change to any wallet you want
       marketingFeeReceiver = 0xA1cd5EC73E45baF8f6a0C70b10adcc44e2935a07; //Can be change to any wallet you want
