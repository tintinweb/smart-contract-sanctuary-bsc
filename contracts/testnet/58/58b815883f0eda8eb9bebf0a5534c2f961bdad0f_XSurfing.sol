...
contract XSurfing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "X-Surfing";
    string private _symbol = "XS";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xE34F1B82c41aA855FEaaA7fADE66E6F035d5D1dF);
    address payable public teamWalletAddress = payable(0x8e802Acae4Dbc6ad67028fEAB999041B58e157C8);
    ...
    function setBuyTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        ...
        require(_totalTaxIfBuying <= 25, "Total buy fee need to be lower than 25%");
    }
    ...
    function setSelTaxes(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyOwner() {
        ...
        require(_totalTaxIfSelling <= 25, "Total sell fee need to be lower than 25%");
    }
