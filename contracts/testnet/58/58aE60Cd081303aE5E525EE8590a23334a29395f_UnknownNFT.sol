...
contract UnknownNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    ...
    constructor() ERC721("unknown", "unknown") {}
    ...
    function safeMints(address[] memory tos, string[] memory uris, uint256[] memory tokenIds) public onlyOwner {
    ...
    function safeMintBlindBox(address to, string memory uri) external checkPermit(msg.sender) {
        uint256 tokenId = _tokenIdCounter.current();
        _tokenIdCounter.increment();
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, uri);
    ...
    function safeMintBlindBox(address to, string memory uri, uint256 tokenId) external checkPermit(msg.sender) {
        _safeMint(to, tokenId);
        _setTokenURI(tokenId, uri);
    }
