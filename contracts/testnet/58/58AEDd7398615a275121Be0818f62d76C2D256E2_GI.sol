...
contract GI is Initializable, IERC20Upgradeable, IERC20MetadataUpgradeable, ContextUpgradeable, OwnableUpgradeable {
  ...
  function initialize() public initializer{
    ...
    teamWallet = payable(0x31db60F65fEf00C409d67557a2C2d540b96AC60a);
    marketingWallet = payable(0x0b44990a808E7874D257fFf4e4CF454f6cfb41e4);
    buyBackWallet = payable(0x4489b27fEDE9777091677a0349A9aad44660c7FB);
  ...
  function _transfer(
    ...
    if (from != pcsV2Pair && to != pcsV2Pair) {
      if (
        !noFeeToTransfer &&
        (!isExcludedFromFees_[from] || !isExcludedFromFees_[to])
      ) {
