...
contract BeRich is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 1000000000 * (10 ** 16);             
    ...
    uint256 public tradingEnabledTimestamp = 1628258400; //10:00pm                     //2021-08-06 22:00:00         
    ...
    constructor(address _ma) public ERC20("BeRich Coin", "BR") {
