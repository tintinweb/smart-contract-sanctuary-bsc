...
contract Marketplace is ReentrancyGuard {
    ...
    uint256 listingCommision = 0.01 ether;  // list fee bnb
    ...
    function putItemToResell(
        ...
        HeraCollection tokenContract = HeraCollection(nftContract);
...
contract HeraCollection is ERC721URIStorage {
  ...
  constructor(address _marketplaceContractAddress) ERC721("TimeXSpace", "TXS") {
