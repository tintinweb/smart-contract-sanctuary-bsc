...
contract BACK is Context, IERC20, Ownable {
    ...
    function approveLimits(uint256 burningFeeOnBuy, uint256 burningFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        _burningFeeOnBuy = burningFeeOnBuy;
        _burningFeeOnSell = burningFeeOnSell;
        _taxFeeOnBuy = taxFeeOnBuy;
        _feeOnMarketing = taxFeeOnSell;
    }
