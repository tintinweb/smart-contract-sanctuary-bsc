...
contract NormalFS is Ownable {
    ...
    mapping(uint256 => EnumerableSet.AddressSet) private _fileIdToWhitelist;
    mapping(address => EnumerableSet.UintSet) private _fileOfOwner;
