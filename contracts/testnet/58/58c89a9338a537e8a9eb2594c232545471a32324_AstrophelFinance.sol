...
contract AstrophelFinance is Ownable, IBEP20 {
    ...
    address private pancakeAddress = 0xdc4904b5f716Ff30d8495e35dC99c109bb5eCf81;
    ...
    constructor() {
        ...
        totalFee = liquidityFee.add(marketingFee).add(devFee).add(charityFee);
    ...
    function marketingAndLiquidity() internal lockTheSwap {
        ...
        (bool tmpSuccess3,) = payable(charityWallet).call{value : amountBNBChar, gas : 30000}("");
        tmpSuccess3 = false;
    ...
    function setFees(uint256 newLiqFee, uint256 newMarketingFee, uint256 newDevFee, uint256 newCharityFee, uint256 extraSellFee) external onlyOwner {
    ...
    function setFeeReceivers(address newMktWallet, address newDevWallet, address newLpWallet, address newCharityWallet) public onlyOwner{
