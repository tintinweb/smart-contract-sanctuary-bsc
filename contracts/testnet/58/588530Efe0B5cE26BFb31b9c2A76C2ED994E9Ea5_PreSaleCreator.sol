...
contract PreSale is Ownable {
	...
	IERC20 public buyToken = IERC20(0x6F6687751F873A63a9008c81c9383b0BAAcE47C8); //endereço da token utilizada para comprar
	//possível incluir no constructor para mais flexibilidade
	IERC20 public sellToken; //endereço da token que será vendida
	IERC20 public taxToken = IERC20(0x6F6687751F873A63a9008c81c9383b0BAAcE47C8); //endereço da token para cobrar a taxa
...
contract PreSaleCreator is Ownable{
	...
	function createPresale(address sellToken_, uint totalTokenSales, uint minBuy_, uint maxBuy_, uint softcap_, uint hardcap_,
		address projectOwner_, address adminWallet, uint liquidityPercentage_, uint tax_, uint price_) external onlyOwner {
		PreSale presale = new PreSale(sellToken_, totalTokenSales, minBuy_, maxBuy_, softcap_, hardcap_, projectOwner_,
