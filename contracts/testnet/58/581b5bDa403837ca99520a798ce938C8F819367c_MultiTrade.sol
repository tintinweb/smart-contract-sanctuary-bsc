...
contract MultiTrade {
    ...
    // SushiSwap
    IUniswapV2Router02 private constant pancakeRouter = IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
    address private constant DAI = 0x8a9424745056Eb399FD19a0EC26A14316684e274;
  
    constructor() {
    }

    function _tradeOnSushi(uint256 amount) private {
    ...
    function multiSwapPreview() external payable returns(uint256) {
        uint256 amount = IERC20(BNB).balanceOf(msg.sender);
        _tradeOnSushi(amount);
        
        uint256 daiBalanceUserAfterTrade = IERC20(DAI).balanceOf(msg.sender);
        return daiBalanceUserAfterTrade;
    }
