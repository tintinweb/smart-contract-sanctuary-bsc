...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xB37B1564543F4e7A440a6808EfC35A063f265B46); // Marketing Address
    address payable public devAddress = payable(0x2c44f60DAb22ED85DA8c1D9883294a7e52150AeF); // Dev Address
    ...
    uint256 public percentToBuyBack = 0; // percent of fund to be used to buy back each time
...
contract Sekuya is ERC1363, TokenRecover {
    constructor ()
        ERC1363("Sekuya", "SKUY")
    {
    }
