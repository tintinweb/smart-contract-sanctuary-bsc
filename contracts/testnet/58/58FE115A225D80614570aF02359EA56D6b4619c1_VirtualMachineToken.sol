...
contract VirtualMachineToken is Ownable {
    ...
    function buyVirtualMachine(uint256 option) external {
        ...
        require(!stopBuy, "NO_OPEN"); // 虚拟机购买开关
        require(getVirtualMachineAmount(option) > 0, "SELL_OUT"); // 虚拟机剩余大于0才能购买
        ...
        // 推荐人加速释放
        relationTransfer(relation, _virtualMachineMap[option].price);
