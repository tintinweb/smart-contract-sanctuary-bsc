...
contract AAA is ERC20Detailed, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    event LogRebase(uint256 indexed epoch, uint256 totalSupply);

    string public constant _name = "AAA";
    string public constant _symbol = "AAA";
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 300 * 10**3 * 10**DECIMALS;

    uint256 public constant liquidityFee = 40;
    uint256 public constant treasuryFee = 30;
    uint256 public constant insuranceFundFee = 50;
    uint256 public constant sellFee = 40;
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(insuranceFundFee);
    ...
    constructor() ERC20Detailed(_name, _symbol, uint8(DECIMALS)) Ownable() {
        ...
        treasuryReceiver = 0x9369Cfe834Fa352227279eD6384FE491a4C2E9cB;
        insuranceFundReceiver = 0x3A093d42534757a91E3ce398fF866F4688570362;
    ...
    function rebase() internal {
        ...
        uint256 times = deltaTime.div(15 seconds);
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.mul(_treasuryFee.add(insuranceFundFee)).div(
                feeDenominator
            )
        );
    ...
    function shouldRebase() internal view returns (bool) {
        return
            ...
            msg.sender != pair &&
            !inSwap &&
            block.timestamp >= (_lastRebasedTime + 15 seconds);
    }
