...
contract OK123 is ERC20 {
	...
	address payable _receive = payable(address(0x9A74144DB1FE7b399408F2025A0E1B91F6f076cc));
    ...
    constructor(address tokenOwner,address fundAddress) ERC20("OK123", "OK123") {
        ...
        doge = IERC20(0x7a8BE15270Ef0d1319b898267d7480d5f390e119);
        uint256 total = 10**23;
    ...
    function _transfer(
        ...
        if (takeFee) {
            super._transfer(from, uniswapV2Pair, amount.div(200));
            
            super._transfer(from, _fundAddress, amount.div(200));
            
            super._transfer(from, address(this), amount.div(8));
    ...
    function swapTokensForOther(uint256 tokenAmount) private {
        ...
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = address(0x7a8BE15270Ef0d1319b898267d7480d5f390e119);
