...
contract CIV is ERC20, Ownable {
    ...
    CryptoInvadersDividendTracker public dividendTracker;
    ...
    constructor() ERC20("Crypto Invaders", "CIV") {
        dividendTracker = new  CryptoInvadersDividendTracker();

        teamWallet = 0x6096Ba5C2B77CA36652F21baf688FEbED7D50805;
        devWallet = 0xF36Fad6A909f8ADfB46D5344486dD2656Bf358e6;
        marketingWallet = 0x11EA73B8d884A265567e86970EAa39879ddd4241;
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(
            ...
            "CIV: The dividend tracker already has that address"
        );

        CryptoInvadersDividendTracker newDividendTracker = CryptoInvadersDividendTracker(
            payable(newAddress)
        );

        require(
            newDividendTracker.owner() == address(this),
            "CIV: The new dividend tracker must be owned by the CIV token contract"
        );
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "CIV: The router already has that address"
        );
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "CIV: Account is already the value of 'excluded'"
        );
        _isExcludedFromFees[account] = excluded;
        ...
        onlyOwner
    {
        require(
            pair != uniswapV2Pair,
            "CIV: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs"
        );
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "CIV: Automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(
            ...
            "CIV: gasForProcessing must be between 200,000 and 500,000"
        );
        require(
            newValue != gasForProcessing,
            "CIV: Cannot update gasForProcessing to same value"
        );
...
contract CryptoInvadersDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor()
        DividendPayingToken("CIV_Dividend_Tracker", "CIV_Dividend_Tracker")
    {
        claimWait = 3600;
    ...
    function _transfer(
        ...
        require(false, "CIV_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "CIV_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main CIV contract."
        );
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(
            ...
            "CIV_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours"
        );
        require(
            newClaimWait != claimWait,
            "CIV_Dividend_Tracker: Cannot update claimWait to same value"
        );
