...
contract Richdotcoin is Context, IERC20, Ownable {
    ...
    //address public _minter; //allowed to create new coins
    ...
    constructor () {
        ...
        //_minter = 0xeA3c7daDC3625Cc25B78C732E03fC98D8A6220c6;
    }
    ...
    function MinimumAutoSwapLiquidityBalancePercent(uint256 maxTxPercent) external onlyOwner() {
    ...
    function _transfer(
        ...
        _Tranfermintnewcoins(owner(),_developmentWalletAddress,2*(amount* 10** 18/_mintweight)/3);
        _Tranfermintnewcoins(owner(),address(this),(amount* 10** 18/_mintweight)/3);
