	...
	IVersionedContract
{
		...
		returns (uint256 subscriptionID)
	{
		...
		// update pull payment
		bm.subscriptions[newSubscriptionID].pullPayments[newPullPaymentID].paymentAmount = bm.amount;
		...
		returns (uint256 billingModelID)
	{
		...
		_billingModels[_billingModelID].amount = _newAmount;
		_billingModels[_billingModelID].settlementToken = _newSettlementToken;
