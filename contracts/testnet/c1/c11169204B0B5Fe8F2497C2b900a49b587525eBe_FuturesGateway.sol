    ...
    ReentrancyGuardUpgradeable
{
    ...
    function addMargin(
        ...
        depositWithBonus(_positionManager, msg.sender, _depositAmount, 0, _busdBonusAmount);
        futuresAdapter.crossBlockchainCall(
            posiChainId,
            posiChainCrosschainGatewayContract,
    ...
    function deposit(
        ...
        insuranceFund.deposit(_manager, _trader, _amount, _busdBonusAmount, _fee);
    }
    ...
    function receiveFromOtherBlockchain(
        ...
        insuranceFund.withdraw(_manager, _trader, _totalAmount, _busdBonusAmount);
    }
