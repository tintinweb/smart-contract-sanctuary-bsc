...
//  _____                       ____
// |  ___|__  _ __ ___   ___   |  _ \  __ _  ___
// | |_ / _ \| '_ ` _ \ / _ \  | | | |/ _` |/ _ \
// |  _| (_) | | | | | | (_) | | |_| | (_| | (_) |
// |_|  \___/|_| |_| |_|\___/  |____/ \__,_|\___/
//
...
contract FomoDao is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "FomoDao";
    ...
    address payable public marketingWalletAddress = payable(0xEf78941b035720AfeEDFFBe9393dcCBb6471222f); // Marketing Address
    ...
    uint256 private _totalSupply = 10000 * 10**11 * 10**_decimals;
    uint256 public _maxTxAmount = 10000 * 10**11 * 10**_decimals; 
    uint256 public _walletMax = 10000 * 10**11 * 10**_decimals;
    uint256 private minimumTokensBeforeSwap = 10000 * 10**5 * 10**_decimals; 
