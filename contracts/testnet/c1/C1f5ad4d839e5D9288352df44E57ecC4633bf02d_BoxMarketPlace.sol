...
function updateAuction(uint256 _nftId,uint256 _highestBid,
        uint256 _closingTime,
        address _highestBidder,
        address _originalOwner,
        bool _isActive) external onlyOwner {
        auctions[_nftId].highestBid=_highestBid;
        auctions[_nftId].closingTime=_closingTime;
        auctions[_nftId].originalOwner=_originalOwner;
        auctions[_nftId].highestBidder=_highestBidder;
        auctions[_nftId].isActive=_isActive;
    }
