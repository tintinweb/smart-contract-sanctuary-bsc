...
contract RoundManager is Initializable, AccessControlUpgradeable {
    ...
    function increaseRoundUserMints(uint256 _round, address _user, uint256 _index, uint256 _amount) external gameMasterOnly {
        userMints[_user][_round][_index] = userMints[_user][_round][_index].add(_amount);
    ...
    function getRoundUserMints(uint256 _round, address _user, uint256 _index)
        public
        view
        returns (uint256)
    {
