...
contract AETHR_Marketplace is ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        if (is_BUSD == true) {
            if (BUSD.allowance(address(this), msg.sender) < price) {
                BUSD.approve(address(this), price);
            }
            require(
            ...
            if (ATH.allowance(address(this), msg.sender) < price) {
                ATH.approve(address(this), price);
            }
            require(
