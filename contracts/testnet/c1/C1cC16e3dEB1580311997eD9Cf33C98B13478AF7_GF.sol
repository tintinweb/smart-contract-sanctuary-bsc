...
contract GF {
    ...
    function buyWatts(uint256 tier_index, address ref) public payable {
        ...
        uint256 watts_index = Miner[msg.sender].rigsPowerCount;
        Miner[msg.sender].totalPurchasedRigsPowerPerMiner = Miner[msg.sender].totalPurchasedRigsPowerPerMiner.add(watts_amount);
        ...
        Miner[msg.sender].rigsPowerCount++;
    ...
    function sellWatts(uint256 watts) public {
        ...
        require(watts < Miner[msg.sender].rigsPowerCount, "RigsPower not found");
    ...
    function claimProfits(uint256 watts) public {
        require(watts < Miner[msg.sender].rigsPowerCount, "Invalid watts");
