...
abstract contract TokenProcessing is CompanyVault, NextLevelConfiguration {
    NextLevelDTOs.ExtractingFee public extractingFee;
...
abstract contract Security is Voting {
    NextLevelDTOs.AddOwner public addOwnerVoting;
    NextLevelDTOs.RemoveOwner public removeOwnerVoting;
...
abstract contract Voting is Ownable {
    ...
    NextLevelDTOs.VotingInfo public votingInfo;
