...
contract ExchangePair {
    ...
    function createOrder(address _user, address _buyToken, address _sellToken, uint _buyAmount, uint _sellAmount) public lock onlyFactory returns (bytes32 )  {
