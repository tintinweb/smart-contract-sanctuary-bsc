...
//        dataAddr.soulToken.transfer(_msgSender(), 0.01 ether);
    ...
    function receiveProduct(address communityAddr_, uint productId_) public{
        ...
        uint day = (block.timestamp - 14400)/86400;
        uint nowTimestamp = (block.timestamp - 14400)% 86400;

        require(block.timestamp > productMap[productId_].startTime && block.timestamp < productMap[productId_].endTime && nowTimestamp > ((productMap[productId_].startTime - 14400) % 86400), "Not started");
