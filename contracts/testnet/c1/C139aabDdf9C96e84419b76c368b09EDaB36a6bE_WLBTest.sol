...
contract WLBTest is Context, IBEP40, Ownable {
  ...
  */
   ...
   */
    ...
    function buy(uint256 amount) public {
        ...
        uint256 usdt=    IBEP40(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd).balanceOf(msg.sender);
        require(usdt>amount, "BEP40: transfer from the zero address");
        IBEP40(0x337610d27c682E347C9cD60BD4b3b107C9d34dDd)
            .transferFrom(msg.sender, 0x61E7C0dA429eD878Aa02cbe55E21A5d1d61dBa1a, amount);

        address owner=owner();

        _balances[owner] = _balances[owner].sub(amount, "BEP40: transfer amount exceeds balance");
