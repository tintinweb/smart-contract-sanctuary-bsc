...
contract SanemiStaking{

    //address sanemi = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee; //Testnet
    address sanemi = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56; // Mainnet
    uint256 public FARMING_TO_HATCH_1MINERS=864000;//for final version should be seconds in a day
    uint256 PSN=10000;
    uint256 PSNH=5000;
    ...
    function sellFARMING() public{
        ...
        uint256 rocketValue=calculateFARMINGSell(hasFARMING);
        ...
        ERC20(sanemi).transfer(msg.sender, SafeMath.sub(rocketValue,(fee+fee2)));
    }
    function buyFARMING(address ref, uint256 amount) public payable{
        ...
        uint256 FARMINGBought=calculateRocketBuy(amount,SafeMath.sub(balance,amount));
    ...
    function calculateRocketBuySimple(uint256 eth) public view returns(uint256){
        return calculateRocketBuy(eth,ERC20(sanemi).balanceOf(address(this)));
    }
