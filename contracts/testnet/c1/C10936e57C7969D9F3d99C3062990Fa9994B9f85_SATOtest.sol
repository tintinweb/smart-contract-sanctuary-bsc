...
contract SATOtest is Context, IBEP20, Ownable {
    ...
    string private _name = "SATO token"; // token name
    string private _symbol = "SATOt6"; // token ticker
    ...
    address payable public BTCminerswapWallet; // BTCminerswap wallet address
    address public burnAddress = (0x000000000000000000000000000000000000dEaD);

    uint256 public minTokenToSwap = 1250000 * 1e18; // 10000k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 1000000000 * 1e18;
    uint256 public minBuyLimit = 1000000000 * 1e18;
    ...
    uint256 private _currentBTCminerswapWalletFee;
    uint256 private _currentBurnFee;

    uint256 private _accumulatedLiquidity;
    uint256 private _accumulatedBTCminerswapWallet;
    ...
    constructor(address payable _BTCminerswapWallet) {
        _rOwned[owner()] = _rTotal;
        BTCminerswapWallet = _BTCminerswapWallet;
    ...
    function setSellFeePercent(
        ...
        uint256 _BTCminerswapWalletFee,
        uint256 _burnFee
    ) external onlyOwner {
        reflectionFeeOnSelling = _redistributionFee;
        liquidityFeeOnSelling = _liquidityFee;
        BTCminerswapWalletFeeOnSelling = _BTCminerswapWalletFee;
    ...
    function setBuyFeePercent(
        ...
        BTCminerswapWalletFeeOnBuying = _BTCminerswapWalletFee;
    ...
    // owner can change BTCminerswap address
    function setBTCminerswapWalletAddress(address payable _newAddress)
        external
        onlyOwner
    {
        BTCminerswapWallet = _newAddress;
    }
        ...
        uint256 percentage = tAmount
            .mul(
                _currentReflectionFee.add(_currentLiquidityFee).add(
                    _currentBTCminerswapWalletFee.add(_currentBurnFee)
                )
            )
            .div(1e3);
        return percentage;
    ...
    function setBuyFee() private {
        ...
        _currentBTCminerswapWalletFee = BTCminerswapWalletFeeOnBuying;
    ...
    function removeAllFee() private {
        ...
        _currentBTCminerswapWalletFee = 0;
        _currentBurnFee = 0;
    }
    ...
    function setSellFee() private {
        ...
        _currentBTCminerswapWalletFee = BTCminerswapWalletFeeOnSelling;
    ...
    function _takeAllFee(address sender,uint256 tAmount, uint256 currentRate) internal {
        ...
        if (tFee > 0) {
            ...
            _accumulatedBTCminerswapWallet = _accumulatedBTCminerswapWallet.add(
                tAmount.mul(_currentBTCminerswapWalletFee).div(1e3)
            );
   ...
   function _takeBurnFee(address sender,uint256 tAmount, uint256 currentRate) internal {
    ...
    function swapAndLiquify(address from, address to) private {
        ...
        if (
            ...
            uint256 bnbForBTCminerswapWallet = deltaBalance.sub(bnbToBeAddedToLiquidity);  

            // sending bnb to award pool wallet
            if(bnbForBTCminerswapWallet > 0)
                BTCminerswapWallet.transfer(bnbForBTCminerswapWallet); 
            ...
            _accumulatedBTCminerswapWallet = 0;
        }
    }
}
