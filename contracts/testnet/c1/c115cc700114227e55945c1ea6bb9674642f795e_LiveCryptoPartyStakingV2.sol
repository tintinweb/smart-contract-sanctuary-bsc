...
contract LiveCryptoPartyStakingV2 is Initializable {
    ...
    function initialize() public initializer {
        ...
        owner = payable(0x153B1f632596687e84D7b6fC0C4a2586cB0D5373);
        stakeToken = IERC20Upgradeable(
            0x3E3dd26c2cf50f2b7E5AaB86B0eb916502034c13
        );

        goldNFT = IERC721Upgradeable(
            0x3951Be7cd5abDd4900a8127e1cC39625d1c24278
        );
        silverNFT = IERC721Upgradeable(
            0x3951Be7cd5abDd4900a8127e1cC39625d1c24278
        );
        feeReciever = payable(0x153B1f632596687e84D7b6fC0C4a2586cB0D5373);
