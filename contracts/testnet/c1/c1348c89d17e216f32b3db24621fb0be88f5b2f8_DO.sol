    ...
    DividendPayingTokenOptionalInterface
{
    ...
    address public immutable dToken =
        address(0xaC74C6dde58eEBDde7Fca7E981a3e2D987AA2Cb2);
...
contract DO is ERC20, Ownable {
    ...
    constructor() ERC20("DO", "DO") {
        _totalSupply = 36500000 * (10**18);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        _approve(address(this), address(uniswapV2Router), tokenAmount);
        // add the liquidity
        uniswapV2Router.addLiquidity{value: ethAmount}(
            address(this),
            _USDT,
            tokenAmount,
            ethAmount,
    ...
    function withdrawUMarket() public {
        ...
        IERC20(_USDT).transfer(marketingWalletAddress, amount);
    }
