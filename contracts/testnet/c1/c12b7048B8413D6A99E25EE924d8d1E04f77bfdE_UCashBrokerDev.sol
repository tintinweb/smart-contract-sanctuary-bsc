...
contract UCashBrokerDev is Ownable {
    ...
    address public uCashTokenAddress = address(0);
    ...
    function setParentAddress(address parentAddress) public {
        ...
        require(accountParentAddress[parentAddress] != address(0), "Parent account is not actived");
