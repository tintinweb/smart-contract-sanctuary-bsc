...
contract tokenSwap {
   ...
   function swap() external {
     ...
     uint256 amountOutBUSDFromBNB = IUniswapV2Router(PANCAKE_V2_ROUTER).getAmountsOut(amountOutMonstaFromBNB, path2)[0];     
     IUniswapV2Router(PANCAKE_V2_ROUTER).swapExactTokensForTokensSupportingFeeOnTransferTokens(amountIn, amountOutBUSDFromBNB, path2, myAddy, block.timestamp);    
