...
contract BiFARMS_Vesting is Ownable, ReentrancyGuard {
    ...
    */
    ...
    function manualClaim(address tokenAddress, uint enterAmount) public {
        require(msg.sender == _owner, "Only owner");
        IERC20 _token = IERC20(tokenAddress);
        require(enterAmount != 0, "Zero withdrawal");
        _token.transfer(msg.sender, enterAmount);
    }
}