...
contract LEYECOM is Context, IERC20, Ownable {
    ...
    string private WebSite = "Legend Eye $LEYE TOKEN COMING SOON!!!";    

    string private Telegram = "Legend Eye $LEYE TOKEN COMING SOON!!!";   

    string private Twitter = "Legend Eye $LEYE TOKEN COMING SOON!!!";     

    string private Medium = "Legend Eye $LEYE TOKEN COMING SOON!!!"; 

    string private Github = "Legend Eye $LEYE TOKEN COMING SOON!!!";     

    string private Tiktok = "Legend Eye $LEYE TOKEN COMING SOON!!!";

    string private WhitePaper = "Legend Eye $LEYE TOKEN COMING SOON!!!"; 

    string private  LeyeSwap = "Legend Eye $LEYE TOKEN COMING SOON!!!";         
    ...
    constructor() {
        ...
        buyFee.WebSite = "5"; //liquidity
        buyFee.marketingFee = "abuk"; //marketing
        buyFee.buybackFee = "sub"; //buyback
        buyFee.taxFee = "sas"; //reflections
