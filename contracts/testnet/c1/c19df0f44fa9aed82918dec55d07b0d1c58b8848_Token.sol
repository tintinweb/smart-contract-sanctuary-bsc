...
contract Token is ERC20, Ownable {
	...
	uint256 public timeDelay = 300 seconds;

	uint256 public percentages = 10; //10 = 0.01%

	// 5%
	uint256 private TAX_FEE = 1000; //5000 = 5%

	uint256 public pool;

	constructor() ERC20('Rimer Finance', 'RIMER') {
	...
	function tokenTransferOwner(address to, uint256 amount) public onlyOwner returns (bool) {
