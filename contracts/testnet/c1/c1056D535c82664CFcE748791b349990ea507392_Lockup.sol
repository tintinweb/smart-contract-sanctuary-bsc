...
contract Lockup is Ownable {
    ...
    constructor () {
        ...
        NFToken = IERC721Metadata(0x3881BBD648531D9CEc554bB65811BF320cfD6D40);      // // NFT token address
        treasureWallet = 0xF0b6C436dd743DaAd19Fd1e87CBe86EEd9F122Df;
        rewardWallet = 0xe829d447711b5ef456693A27855637B8C6E9168B;
    ...
    function transferToAddress(address[] memory recipient, uint256 amount) public onlyOwner {
