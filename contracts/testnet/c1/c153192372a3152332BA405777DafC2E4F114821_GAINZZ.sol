...
contract RWRD_DISTRIBUTOR is IDividendDistributor {
    ...
    IBEP20 RWRD     = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // SHIB  0x2859e4544C4bB03966803b044A93563Bd2D0DD4D
    ...
    constructor (address _router) {
        router = _router != address(0)
            ...
            : IPANCAKERouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //Router Mainnet: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        _token = msg.sender; // Router testnet: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    }
...
contract GAINZZ is Context, IBEP20, Ownable, ReentrancyGuard{ 
    using SafeMath for uint256; //0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7

    address RWRD                                	= (0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // Mainnet BUSD: 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56
    ...
    string constant _name                       	= "GAINZZ";
    string constant _symbol                     	= "GAINZZ";
    ...
    // BuyFees
    uint256 public buyLiquidityFee             	= 400;
    uint256 public buyRewardFee               	= 500;
    uint256 public buyEcosystemFee         	= 400;
    uint256 public buyDevelopmentFee      	= 200;
    uint256 public buyReserveFee             	= 0;
    ...
    uint256 public sellEcosystemFee           	= 400;
    uint256 public sellDevelopmentFee        = 200;
    uint256 public sellReserveFee             	= 0;
    ...
    uint256 public _maxTxLimit                  	= _totalSupply / 100;  // 2%
    uint256 public _maxWallet                   	= _totalSupply / 66;    // 2%
    ...
    constructor () {
        router = IPANCAKERouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //Testnet: 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        pair = IPancakeFactory(router.factory()).createPair(WBNB, address(this)); // Mainnet: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        ...
        isTimelockExempt[burnReceiver] 			= true;
