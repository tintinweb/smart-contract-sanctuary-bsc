...
contract SRV is ERC20, AccessControl {
  ...
  function _transfer(
    ...
    // TODO: Give this as a parameter to _processFeeBalance()
  ...
  function _processFeeBalance() internal {
    ...
    super._transfer(feeRecipient, address(this), feeBalance);
    ...
    if (srvPrice < limitPrice * PRICE_PRECISION) super._transfer(address(this), rewardWallet, remainingSrv);
  ...
  function getSrvPriceInUsd() public view returns (uint256) {
    ...
    (uint256 reserve0a, uint256 reserve1a, ) = pancakeBnbBusdPair.getReserves();
