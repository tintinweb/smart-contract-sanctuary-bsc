...
contract TomCat is Context, IERC20, Ownable {
    ...
    string private constant _name = "TomCat";
    string private constant _symbol = "TCat";
    uint8 private constant _decimals = 9;
    
    address payable private _appAddress = payable(0xA91800250e618f995a408B77f155B0A15676aD31);
    address payable private _marketingAddress = payable(0x661cD28090dCD04EBA0A37E84Ce90C868898d129);
    address payable private _buybackAddress = payable(0xFcC18aBd9E98791B3Ee705bF34579963B0E276a1);
    address payable private _burnAddress = payable(0x5E1B7485c1D1Df6B04A506899B0CeD5095f23775);
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        uint256 buybackAmount = amount.mul(3).div(8);
