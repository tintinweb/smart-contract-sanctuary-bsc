...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // MAINNET: 0x10ED43C718714eb63d5aA57B78B54704E256024E // TESTMAIN: 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
        _token = msg.sender;
    }
...
contract TestF1 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "TestF1";
    string constant _symbol = "TTTF1";
