...
/*
   #LIQ+#RFI+#SHIB+#DOGE = #gameMoney

   #Game Money Token features:
   3% fee auto add to the liquidity pool to locked forever when selling
   1% fee auto distribute to all holders
   1% fee auto sent to dev wallet for marketing purposes.
   1% fee auto burned.
   there is no auto pre-burn.

*/
// SPDX-License-Identifier: Unlicensed
// Game Money Token BSC contract
...
contract Tokencontract is Context, IERC20, Ownable {
    ...
    string private _name = "Token contract";
    string private _symbol = "TC";
    uint8 private _decimals = 9;
    uint256 public _taxFee = 1;
    uint256 private _previousTaxFee = _taxFee;
    uint256 public _liquidityFee = 3; //(1% LP Burn, 1% Buyback Burn, 1% Marketing Wallet)
    ...
    /* Max token can purchase and sell */
...
at the next transaction it will call the function swapAndLiquify which divide the contract balance in half. One parte is swapped for wbnb and the second half remain in tokens.
These two halves are then paired together and added to liqudiity on pancake*/
    ...
    constructor ()  {
        ...
        IpancakeV2Router02 _pancakeV2Router = IpancakeV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //mainnet 0x10ED43C718714eb63d5aA57B78B54704E256024E
        pancakeV2Pair = IpancakeV2Factory(_pancakeV2Router.factory())
            .createPair(address(this), _pancakeV2Router.WETH());
        pancakeV2Router = _pancakeV2Router;
        buyback = payable(0x000000000000000000000000000000000000dEaD); //burn
        marketing= payable(0x6965e9C81a9ca9Cbc211Db9AA35E93bC1130Da54);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // liquiditys is contractTokenBalance divided by 3
        uint256 liquiditys = contractTokenBalance.div(3);
        
        // buybacks is contractTokenBalance divided by 3
        uint256 buybacks = contractTokenBalance.div(3);
        
        //marketings is contractTokenBalance divided by 3
        uint256 marketings = contractTokenBalance.div(3);
        
        // split the liquidity
        // half is liquiditys divided by 2
        ...
        // swap tokens for ETH
        swapTokensForEth(half.add(buybacks).add(marketings));  // <- this breaks the ETH -> HATE swap when swap+liquify is triggered
