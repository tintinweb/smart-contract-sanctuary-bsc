...
contract VRShiba is Context, IERC20, Ownable {
    ...
    string private _name = "VRShiba";
    string private _symbol = "VRA";
    ...
    function setBuyFeePercent(uint256 taxFee, uint256 MarketingFee, uint256 liquidityFee, uint256 TeamFee) external onlyOwner() {
        ...
        _buyTeamFee = TeamFee;
        require(_buyTaxFee + _buyTeamFee + _buyLiquidityFee + _buyMarketingFee <= 15, "Must keep at 15% or less");
    }
