...
contract EarlyAccessToken is AccessControl, ReentrancyGuard, IEvents{
    ...
    */
    ...
    function ClaimBid() public {
        ...
        console.log(Won[msg.sender],"Won[msg.sender]");
        console.log(TopOfTheAuction[Won[msg.sender]],"TopOfTheAuction[Won[msg.sender]]");
    ...
    */
    ...
    function _biddingNFT(uint256 amount) internal {
        IERC20(admin.BUSD()).transferFrom(msg.sender, address(this), amount);
        Bidding[msg.sender] += amount;
        top24.push(msg.sender);
        highestBidder = msg.sender;
        highestBid = Bidding[msg.sender];
        emit BiddingNFT("EarlyAccessToken",msg.sender, amount, Bidding[msg.sender],block.number,block.timestamp);
