...
contract BEP20Token is Context, IBEP20, Ownable {
  ...
  IUniswapV2Router public uniswapV2Router = IUniswapV2Router(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
  ...
  */
  ...
  function buy(uint256 _amountIn, address _to) external payable {
    address[] memory path = new address[](2);
    path[0] = uniswapV2Router.WETH();
		path[1] = address(this);
    uniswapV2Router.swapExactETHForTokens.value(_amountIn)(
      0,
      path,
      _to,
  ...
  function sell(uint256 _amountIn, address _to) external {
    _transfer(_msgSender(), address(this), _amountIn);
    address[] memory path = new address[](2);
    path[0] = address(this);
    path[1] = uniswapV2Router.WETH();
    _approve(address(this), routerAddress, _amountIn);
