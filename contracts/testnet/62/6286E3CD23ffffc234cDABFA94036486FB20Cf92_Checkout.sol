...
contract Checkout is DeHubUpgradeable, ICheckout {
  ...
  function purchaseByBNB(string calldata _orderId, string calldata _metadataURI)
    ...
    returns (uint256)
  {
    return _purchaseByBNBFor(msg.sender, _stringHash(_orderId), _metadataURI);
  }
  ...
  function purchaseByBNBFor(
    ...
    return _purchaseByBNBFor(_forWhom, _stringHash(_orderId), _metadataURI);
  }
  ...
  function _stringHash(string memory _orderId) internal view returns (bytes32) {
