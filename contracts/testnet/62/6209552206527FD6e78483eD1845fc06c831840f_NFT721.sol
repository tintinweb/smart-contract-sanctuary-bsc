...
contract NFT721 is Ownable, SignerRole, IERC721, ERC721Base, ExchangeDomain {
    ...
    function mint(uint256 tokenId, uint8 v, bytes32 r, bytes32 s, Fee[] memory _fees, string memory tokenURI, uint price, AssetType assetType, address addressToken)  public  {
    ...
    function testTransfer(address to, AssetType assetType, uint price, address addressToken) public {
