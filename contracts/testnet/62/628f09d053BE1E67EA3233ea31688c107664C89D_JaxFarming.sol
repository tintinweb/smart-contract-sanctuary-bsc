...
contract JaxFarming is Ownable{
    ...
    IERC20 constant hst = IERC20(0x4411F3bc052ce3eEbFFBd7DE5c140bBd684eE93a); // 0xd6AF849b09879a3648d56B5d43c6e5908a74CA83

    uint minimum_wjxn_price; // 1e18

    uint farm_period = 9 minutes;

    uint farm_reward_percentage = 15; // 15%
