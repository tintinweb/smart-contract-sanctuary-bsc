...
contract MetaBoardsNfts is ERC1155Tradable {
    ...
    constructor(
        string memory _name,
        string memory _sumbol,
        string memory _uri,
        address _proxyRegistryAddress,
        address _bridge
    ) ERC1155Tradable(_name, _sumbol, _uri, _proxyRegistryAddress) {
        bridge = _bridge;
    ...
    function burn(
        ...
        // If it's a user or operator that's bruning we reduce the max supply (removed from circulation)
        // if it's a bridge that's burning we keep the max supply (synthetic)
