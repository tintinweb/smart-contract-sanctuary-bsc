...
contract ReflexV2_1 is Initializable, UUPSUpgradeable, IERC20MetadataUpgradeable, PausableUpgradeable, OwnableUpgradeable {
    ...
    bool public enableGetHoldersCall;
    ...
    function setGetHoldersCallStatus(bool enable) external onlyOwner {
      enableGetHoldersCall = enable;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
      ...
      if (inSwap) {
        ...
        if(enableGetHoldersCall) try distributor.getHolders() {} catch {}
