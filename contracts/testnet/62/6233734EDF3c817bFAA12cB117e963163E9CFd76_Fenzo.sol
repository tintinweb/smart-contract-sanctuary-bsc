...
contract Fenzo is ERC721, ERC721Enumerable, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Fenzo", "FL2") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://ejok7lzcjiak.usemoralis.com:2053/server/functions/getNFT?_ApplicationId=6Naf4RvcT0rHD96eLlCC0E0epyPA4ICgrvcWWlii&id=1";
    }
