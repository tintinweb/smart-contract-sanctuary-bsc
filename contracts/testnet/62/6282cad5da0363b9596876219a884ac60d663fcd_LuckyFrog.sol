...
contract LuckyFrog is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Lucky Frog";
    string private _symbol = "LFG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x4769eBA0285b76f0FF7118A786BC227ee904EBe6); 
    address payable public teamWalletAddress = payable(0xe9bB721439BB3c09D5fFa7113EAe62dC372AcC91); 
    ...
    // Final Fees when Buying Liq = 1, Marketing = 2, Team = 2 at the announcement of CA
    ...
    uint256 private _totalSupply = 50 * 10**3 * 10**_decimals; // 50 000
    uint256 public _maxTxAmount = 1 * 10**3 * 10**_decimals; // 1 000 or 2%
    uint256 public _walletMax = 15 * 10**2 * 10**_decimals; // 1 500 or 3%
