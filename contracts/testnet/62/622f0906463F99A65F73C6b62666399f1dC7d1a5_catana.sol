...
// https://t.me/catanaBSC
// http://Catana.me  
/*
              /\                                           /\
 _            )( ___________________   ___________________ )(         _
(_)彡\[^._.^](**)___________________> <___________________(**)[^._.^]ﾉ彡(_)
              )(                                           )(
              \/                                           \/
*/
...
abstract contract Ownable is Context {
    ...
    constructor () {
         _owner = 0xfccAA60B1CDDD2Bc46D16F0C524b9103e26d4AbA;
...
contract catana is Context, IERC20, Ownable { 
   
    using Address for address;
     using SafeMath for uint256;

    address payable public Wallet_Dev = payable(0xfccAA60B1CDDD2Bc46D16F0C524b9103e26d4AbA);
    ...
    string private constant _name = unicode"Catana"; 
