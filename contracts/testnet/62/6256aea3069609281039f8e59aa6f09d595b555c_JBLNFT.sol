...
contract JBLNFT is ERC721{
    ...
    constructor ()  public ERC721("JBL-720Mantou", "JBL-720Mantou"){
        owner = msg.sender; 
    ...
    function mintCard(address account) public returns (uint256) {
        ...
        string memory name = "JBL-720Mantou";
        string memory tokenURI = "https://farms.jblgamefi.io/nft/rnft720/JBL-720Mantou.png";
