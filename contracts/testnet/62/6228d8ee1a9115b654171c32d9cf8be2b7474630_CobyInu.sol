...
contract Ownable is Context {
    ...
    // *
    modifier onlySetter() {
        require(_setter == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract CobyInu is IERC20, Ownable {
    ...
    string _name = "PI Coby";
    string _symbol = "PICOBY";
    ...
    uint256 bgiveawayFee = 0;  
    uint256 bmarketingFee = 0;   
    uint256 breflectionFee = 1;   
    uint256 btotalFee = 2;  
    uint256 bfeeDenominator = 100; 
    // *
    uint256 sliquidityFee = 2; 
    uint256 sgiveawayFee = 0;  
    uint256 smarketingFee = 0;   
    ...
    function changeFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _giveawayFee) external onlySetter {
    ...
    function changeMaxWallet(uint256 percent, uint256 denominator) external onlySetter {
    ...
    function setIsFeeExempt(address holder, bool exempt) external onlySetter {
    ...
    function setFeeReceivers(address _marketingFeeReceiver, address _liquidityReceiver) external onlySetter {
        require(isTxLimitExempt[msg.sender]);
