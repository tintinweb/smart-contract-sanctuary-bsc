...
contract AnubisPrime is IERC20, Auth {
	string _name = "Anubis Prime";
	...
	uint16 public taxSharesP2E = 0;
	uint16 public taxSharesBurn = 0;
	uint16 public taxSharesLP = 100;
	uint16 public taxSharesMarketing = 400;
	uint16 public taxSharesTeam = 300;
	uint16 public taxSharesDonation = 400;
	...
	address payable public walletMarketing = payable(0xff6414306E3d561F7E41c3b681B684E5AA49c1C1); 
	address payable public walletTeam = payable(0xF7891fB21e19c53C7F989eCC18221792060cEC1D); 
	address payable public walletDonation = payable(0x3e43481983F40796C78198cDDf39A55bf70652C5); 
	address public walletTokensP2E = address(0xDa27192254B4ae0536010F6D1c79E6D17e9B9559); 
	bool private _inTaxSwap = false;
	address private constant _dexRouterAddress = address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
	...
	function _humanize(uint8 blkcount) internal {
		if ( _humanBlock > block.number || _humanBlock == 1 ) { _humanBlock = block.number + blkcount; }
	}
