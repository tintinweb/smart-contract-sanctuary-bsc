...
contract TinkerBot is ERC721, ERC721Enumerable, Ownable,ERC721Burnable, DefaultOperatorFilterer721 {
    ...
    uint256 private  tokenPrice = 80000000000000000; // 0.09 ETH 90000000000000000
    uint256 private  limitTransaction = 3;
    uint256 private  limitWallet      = 9;
    ...
    constructor(string memory baseURI, string memory _notrevealURI) ERC721("Tinkerbots", "TNKR") { 
