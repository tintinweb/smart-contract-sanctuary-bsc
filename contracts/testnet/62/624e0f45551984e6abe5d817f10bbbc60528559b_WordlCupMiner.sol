...
contract WordlCupMiner {
   ...
   // uint256 public MIN_INVEST = 0.01 ether; /** 0.01 BNB  **/
    ...
    uint256 public MIN_INVEST = 1 * 1e16; /** 0.1 BNB  **/
  //  uint256 public WALLET_DEPOSIT_LIMIT = 50 * 1e18; /** 50 BNB  **/
    ...
    function calculateTradeBuy(uint256 amountBNB) public view returns(uint256) {
        return SafeMath.mul(amountBNB, goalsValue);
    }

    function calculateTradeSell(uint256 amountGoals) public view returns(uint256) {
       return SafeMath.div(amountGoals, goalsValue);
    }
