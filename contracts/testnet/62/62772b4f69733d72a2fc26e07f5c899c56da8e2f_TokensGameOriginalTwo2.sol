...
contract TokensGameOriginalTwo2 {
    ...
    uint256 public TOKENS_TO_HATCH_1TOKENS = 600; //for final version should be seconds in a day wiil 1728000
    uint256 PSN = 10000;
    uint256 PSNH = 5000;
    ...
    uint256 public countUsers = 0;  // кол-во пользователй
    uint256 public deals = 0; // кол-во транз
    uint256 public volume = 0; // обьем

    uint256[] public REFERRAL_PERCENTS = [5, 4, 3, 2, 3, 4, 5]; // реф ввод
    uint256[] public REFERRAL_PERCENTS_SELL = [1, 0, 2, 0, 3, 0, 4]; // will 0,0,0,1,1,1,1
    ...
    uint256[] public REFERRAL_MINIMUM = [
        ...
        6000000000000000000,
        7000000000000000000
    ]; // минимальные депы уровне
    bool public initialized = false;
    address public Delevoper; // овнер
    //address public TimerPool; // пул
    ITimerPool timer;
...
//        require(AllDep[msg.sender] >= mDep);
        ...
        // ERC20(busdt).transfer(Delevoper1, fee);
        amountSell -= amount4;
    ...
    function buyTokens(address ref, uint256 amount) public payable {
        require(amount >= 5000000000000000000);
        require(initialized);
    ...
    function seedMarket() public payable {
        ...
        initialized = true;
        marketTokens = 86400000000; //will 333000000000
    }
