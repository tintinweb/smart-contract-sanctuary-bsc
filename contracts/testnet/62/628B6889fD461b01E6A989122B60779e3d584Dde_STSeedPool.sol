...
// File contracts/pool/STSeedPool.sol


pragma solidity >=0.8.12;
/**
 * @title ST Seed Pool Contract
 * @author SEALEM-LAB
 * @notice In this contract seed round users can harvest ST
 */
contract STSeedPool is ReentrancyGuard {
    using SafeERC20 for IERC20;

    IERC20 public st;

    uint256 public constant blockPerDay = 10;
    uint256 public constant blockPerYear = blockPerDay * 365;
    uint256 public constant blockPerQuarter = blockPerYear / 4;

    uint256 public constant stStartBlock = 1655891100;
    uint256 public constant releasedTotalToken = 3e6 * 1e18;
