...
contract GTEST is Context, IERC20, IERC20Metadata, Ownable {
    ...
    address public devWallet = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    uint256 public totalTax = SafeMath.add(buyTax, sellTax);
    ...
    constructor(string memory name_, string memory symbol_, uint256 totalSupply_) {
        ...
        isExcludedFromFees_[devWallet] = true;
    ...
    function isExlcludedFromFees(address account_) public view returns(bool){
        return isExcludedFromFees_[account_];
    }
    ...
    function toggleExcludeFromFees(address account_) public onlyOwner {
        ...
        if(isExlcludedFromFees(account_) == true){
    ...
    function setBuyTax(uint256 buyTax_) public onlyOwner {
