...
/// RACA V2 token
contract SAV2Token is ERC20("SA", "SA"), Ownable {
    ...
    constructor() public {
        ...
        saInAdvance = 500000 * 10**6 * 10**18;

        mint(treasuryWalletAddr, saInAdvance);
    }
    ...
    function transferSAByOwner(address _to, uint256 _amount) external onlyOwner {
