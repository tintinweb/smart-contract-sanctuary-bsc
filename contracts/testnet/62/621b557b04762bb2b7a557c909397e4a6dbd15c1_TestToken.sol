...
contract TestToken is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 10**6 * 10**9;//1000000
    ...
    address payable private _developmentAddress = payable(0xeD0dacABfb81bE26257C625A6df04624f47E997E); //devwallet
    address payable private _marketingAddress = payable(0xd56df1B62dA2b4546c7EA0f9B74946726AA89DA0);//marketwallet
