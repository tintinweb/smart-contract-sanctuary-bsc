...
contract FuoIdo is Ownable {
    ...
    function init(address target,uint256 nodeNum,uint256 nodeLevel,uint256 inviteNodeNum, uint256 nft3Num,address parent,uint256 usdtProfit) public onlyOwner {
        uint256 futAmount = 0;
        uint256 usdtAmount = 0;
        if(nodeLevel == 3){
