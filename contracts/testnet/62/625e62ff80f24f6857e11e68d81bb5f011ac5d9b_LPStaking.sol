...
contract LPStaking is Ownable {
    ...
    function updateReward(address stakerAddress) internal {
        ...
        stakers[stakerAddress].lastRewardUpdatedTime = stakers[stakerAddress].lastRewardUpdatedTime.add(times.mul(1 minutes));
    }

    function shouldFinish(address stakerAddress) internal view returns (bool) {
        return (block.timestamp - stakers[stakerAddress].initialStakeStartTime) > 10 minutes;
    }
