...
contract SPAC3X20 is ISPAC3X20,Ownable{
  ...
  IUniswapV2Router02 public router;
    ...
    uint256 public maxTX = TOKEN.mul(10000000000);
        ...
        onlyOwner
    {
        ...
        swapThreshold = TOKEN.mul(_amount);
         ...
         function setmaxTransaction(uint256 _amount)
        external
        onlyOwner
    {
         uint256 one_percent = _totalSupply.mul(1).div(100);
            maxTX = one_percent;
           uint256 amount =  TOKEN.mul(_amount);
        require(_amount >=one_percent,"Max Tx must be equal or greater than 1%");
            maxTX = amount;
    }
