...
import "../../token/MiranaERC1155V2.sol";
import "./MinimalMiranaBaseCollectionV2.sol";

contract ERC1155MiranaCollectionV2 is Initializable, MinimalMiranaBaseCollectionV2 {
  function initialize(
  ...
  function createCollection(
    ...
    MiranaERC1155V2 token = MiranaERC1155V2(minimalAddress);
    token.initialize(
      tokenName,
      tokenSymbol,
      baseTokenURI,
...
import "./ERC1155LazyMinimalV2.sol";
import "@openzeppelin/contracts-upgradeable/proxy/utils/Initializable.sol";

contract MiranaERC1155V2 is Initializable, ERC1155LazyMinimalV2 {
...
abstract contract MinimalMiranaBaseCollectionV2 is OwnableUpgradeable {
  address public originAddress;
  address public transferProxy;
  address public lazyTransferProxy;
  address public royaltiesRegister;
  ...
  function setTransferProxyAddress(address _transferProxyAddress)
    external
    onlyOwner
  {
    transferProxy = _transferProxyAddress;
  }

  function setRoyaltiesRegister(address _lazyTransferProxyAddress)
    external
    onlyOwner
  {
    lazyTransferProxy = _lazyTransferProxyAddress;
  }

  function setLazyTransferProxyAddress(address _royaltiesRegister)
    external
    onlyOwner
  {
    royaltiesRegister = _royaltiesRegister;
  }
}
...
abstract contract ERC1155LazyMinimalV2 is
  IERC1155LazyMint,
