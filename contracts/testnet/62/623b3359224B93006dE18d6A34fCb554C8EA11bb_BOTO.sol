...
contract BOTO is ERC20UpgradeSafe, OwnableUpgradeSafe, ReentrancyGuard {
    uint256 public rewardsTax; // buy back SDO and add liquidity
    address public rewardsFund; // fund buy back SDO
    ...
    function initialize( address _rewardsFund) public initializer {
