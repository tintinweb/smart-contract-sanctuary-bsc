...
contract HYRIToken is ERC20Detailed {
    ...
    address public liquidityReceiver = 0x1eB0989EFE3067177205a3f24d71ae7C6762cF28;
    address public treasuryReceiver = 0x95BA03E7B27A100CA6b4BEA2D1f310B34B4912a8;
    address public riskFreeValueReceiver = 0xEABEC6F09fFb1185CD5DF82EeC05305AA0C6C654;
    address public futureEcosystemReceiver = 0x3c1976eC9992ff3d0C4cfa347474E707eEc42cAc;
    ...
    */
    ...
    uint256[3] public liquidityFee      = [400, 600, 2500];
    uint256[3] public treasuryFee       = [400, 600, 2000];
    uint256[3] public riskFeeValueFee   = [300, 500, 1500];
    uint256[3] public ecosystemFee      = [200, 300, 1000];
