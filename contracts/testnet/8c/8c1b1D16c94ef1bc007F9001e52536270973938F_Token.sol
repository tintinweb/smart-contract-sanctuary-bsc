...
contract Token is ERC20, Ownable {
    ...
    constructor() ERC20("Coin", "ECO", 18) {
        ...
        // Addresses
        REWARD = address(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd);
    ...
    function swapAndSendToFee(address account, uint256 amount) internal {
        ...
        IERC20(REWARD).transfer(account, newBalance);
    }
    ...
    function swapTokensForReward(uint256 amount) internal {
        ...
        uniswapV2Router.swapExactTokensForETH(amount, 0, path, address(this), block.timestamp.add(30));
    }
