...
contract Exchange is ExchangeDomain, Initializable, ERC2771ContextUpgradeable, AccessControlUpgradeable, UUPSUpgradeable, FeeComp, RoyaltyComp, BidComp {
    ...
    event RewardBid(address bider, address seller, address token, uint256 tokenId, uint256 tomenAmount);
        ...
        payable
    {
        ...
        emit Bid(_msgSender(), bidReq.asset.token, bidReq.asset.tokenId, bidReq.asset.tokenAmount, bidReq.price);
    }
    ...
    function rewardBid(RewardBidRequest calldata rewardBidReq) public {
        ...
        emit RewardBid( _msgSender(), rewardBidReq.seller, rewardBidReq.asset.token, rewardBidReq.asset.tokenId, rewardBidReq.asset.tokenAmount);
    }
