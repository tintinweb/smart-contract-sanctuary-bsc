...
contract spiritualhealing2 is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "spiritualhealing";
    string constant _symbol = "spiritualhealing";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x73677678fc34E46FfA7147Ba2e93ce6e511fDC7f;  // teamwallet
