...
interface IV2Router02 is IV2Router01 {
    ...
    uint256 private _tTotal = 90900000 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));


    uint256 public swapTokensAtAmount = 90_900 * 10**_decimals;
    uint256 public maxBuyLimit = 9_09_000 * 10**_decimals;
    uint256 public maxSellLimit = 9_09_000 * 10**_decimals;
    uint256 public maxWalletLimit = 9_09_000 * 10**_decimals;
    ...
    address public marketingWallet = 0x1C7F0c770E45030DA303728969821f800dd55476;
...
function initialize(address routerAddress) public onlyMultiOwner{
   ...
   function updateIsBlacklisted(uint256 _trnxId, bool state) external onlyMultiOwner {
    ...
    address[] public owners=[0x686aC14acc91145a42dEa24DeD14335472aa7B9c,0x370c9120bc57c0F9c4FEda2074410292732a35c6,
