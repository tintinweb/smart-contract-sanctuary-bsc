...
contract HODLZILLA_MINER {
    ...
    uint256 refPercentage1 = 80;            // standard referral incentive 8%
    uint256 refPercentage2 = 120;           // Influencer referral incentive 12%
    ...
    constructor() {
            ...
            FeesKey[30] = FeesPercs(3456000, 120);
            FeesKey[40] = FeesPercs(4320000, 100);
    ...
    function stakeStablecoins(uint256 amtx, address ref) external {
        ...
        uint256 refAmtx = adjustedAmt.mul(influencers[ref] ? refPercentage2 : refPercentage1).div(percentdiv);
    ...
    function setInfluencer(address _account, bool _value) external {
        require(msg.sender == owner, "Only owner available");
        influencers[_account] = _value;
    }
}