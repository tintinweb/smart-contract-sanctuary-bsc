    ...
    Ownable
{
    ...
    /**
     * Mints `numberOfMints` NFTs To `to`
     */
    function mint(address to, uint256 numberOfMints) external onlyOwner {
    ...
    function _transfer(
        ...
        require(transferringEnabled, "Transferring Not Enabled");
