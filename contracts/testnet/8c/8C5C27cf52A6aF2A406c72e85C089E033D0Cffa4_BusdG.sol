...
// TELEGRAM: https://t.me/BusdGtokenofficialgroup

// WEBSITE: https://BusdGtoken.com/
...
contract BusdG is IBEP20, Auth {
   ...
   string constant _name = "Busd G";
   string constant _symbol = "BusdG";
...
uint256 reflectionFee = 400;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaIer = 0x6e5A93ec5a5AB8D508bd389818080e99F628C025;
       pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
       _allowances[address(this)][address(router)] = type(uint256).max;
 
       distributor = new DividendDistributor(address(router));
       
       address _presaler = 0x6e5A93ec5a5AB8D508bd389818080e99F628C025;
       ...
       marketingFeeReceiver = 0x6e5A93ec5a5AB8D508bd389818080e99F628C025;
