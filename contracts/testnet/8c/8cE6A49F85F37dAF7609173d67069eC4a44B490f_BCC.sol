...
function getmymessage(address _my) public view returns (
            uint256 performance1,address inviter1,uint256 sharenumber1,uint256 bonus1,uint256 simuedulingqucishu2) {
        return (performance[_my],inviter[_my],sharenumber[_my],bonus[_my],simuedulingqucishu[_my]);
    }
   ...
   function  pledgein(address fatheraddr)  public payable returns (bool) {
        ...
        require(msg.value>=_bnbnumber*10**17,"pledgein low 0.3");
    ...
    function  LPin()  public payable returns (bool) {
        ...
        require(_rOwned[msg.sender]>=_lpzhiya*10**18,"pledgein balance too low");
