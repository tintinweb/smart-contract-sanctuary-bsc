 ...
 */
contract ReflexFarming is Initializable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable, UUPSUpgradeable {
    ...
    event AddPool(IERC20Upgradeable lpToken, IERC20Upgradeable rewardToken, uint256 startTime, uint256 endTime, uint256 rewardInterval, uint256 rewardRate);
    ...
    */
    function addPool(IERC20Upgradeable _lpToken, IERC20Upgradeable _rewardToken, uint256 _startTime, uint256 _endTime, uint256 _rewardInterval, uint256 _rewardRate) public onlyOwner whenNotPaused {
        ...
        emit AddPool(_lpToken, _rewardToken, _startTime, _endTime, _rewardInterval, _rewardRate);
    }
    ...
    */
    function calculateReward(uint256 _pid, address _rewardAddress) public view returns(uint256, uint256){
		...
		if(balances > 0){
            ...
            rewards = ((user.amount * poolInfo[_pid].rewardRate * timeFactor) / (100 * 10 ** 4));
