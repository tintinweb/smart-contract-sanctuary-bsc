...
contract SPTToken is ERC20, Ownable {
    ...
    uint256 private constant initialTotalSupply = 1 * 10**5 * 10**18;
    ...
    constructor(
        ...
        slotDaysFeeInfo.feeBeforeDaysSlot1 = 3500;
        slotDaysFeeInfo.feeBeforeDaysSlot2 = 3500;
        ...
        slotDaysFeeInfoDex.feeBeforeDaysSlot1 = 3200;
        slotDaysFeeInfoDex.feeBeforeDaysSlot2 = 3200;
        slotDaysFeeInfoDex.feeBeforeDaysSlot3 = 3000;
        slotDaysFeeInfoDex.feeBeforeDaysSlot4 = 2000;
        slotDaysFeeInfoDex.feeBeforeDaysSlot5 = 1000;
        slotDaysFeeInfoDex.feeBeforeDaysSlot6 = 500;
        ...
        setIsCaller(msg.sender, true);
    }

    modifier onlyCaller() {
        require(isCallerMap[msg.sender], "Not Authorised");
        _;
    }
    ...
    function _transfer(
        ...
        if (!_isExemptFromFee[from]) {
            ...
            uint256 totalDistribution = (sell_fee + transfer_fee) / 4;

            _balances[development_address] += totalDistribution;
            emit Transfer(from, development_address, totalDistribution);

            _balances[management_address] += totalDistribution;
            emit Transfer(from, management_address, totalDistribution);
    ...
    function rewardPrimeHoldersWithInput(
        ...
        require(_arrayLengthData.length == 6, "array length should be 6");
        require(_arrayData.length == 6, "array length should be 6");
        uint256 _prime_holders_balance = _balances[prime_holders_address];
        require(_prime_holders_balance != 0, "Reward Balance is Zero");
        RewardInfo memory reward_info;
        RewardArrayInfo memory reward_array_info;
        ...
        reward_array_info.afterSlot1days = _arrayData[0];
        reward_array_info.afterSlot2days = _arrayData[1];
        reward_array_info.afterSlot3days = _arrayData[2];
        reward_array_info.afterSlot4days = _arrayData[3];
        reward_array_info.afterSlot5days = _arrayData[4];
        reward_array_info.afterSlot6days = _arrayData[5];

        length_info.afterSlot1days_length = _arrayLengthData[0];
        length_info.afterSlot2days_length = _arrayLengthData[1];
        length_info.afterSlot3days_length = _arrayLengthData[2];
        length_info.afterSlot4days_length = _arrayLengthData[3];
        length_info.afterSlot5days_length = _arrayLengthData[4];
        length_info.afterSlot6days_length = _arrayLengthData[5];
    ...
    function setIsDex(address _address, bool _value) public onlyOwner {
        require(_isDex[_address] != _value, "Value already Set");
    ...
    function setFeeBeforeSlotDaysDex(
        ...
        slotDaysFeeInfoDex.feeBeforeDaysSlot1 = _feeBeforeDaysSlot1;
        slotDaysFeeInfoDex.feeBeforeDaysSlot2 = _feeBeforeDaysSlot2;
        slotDaysFeeInfoDex.feeBeforeDaysSlot3 = _feeBeforeDaysSlot3;
        slotDaysFeeInfoDex.feeBeforeDaysSlot4 = _feeBeforeDaysSlot4;
        slotDaysFeeInfoDex.feeBeforeDaysSlot5 = _feeBeforeDaysSlot5;
        slotDaysFeeInfoDex.feeBeforeDaysSlot6 = _feeBeforeDaysSlot6;
    }
    ...
    function setShouldBurn(bool _shouldBurn) public onlyOwner {
        require(shouldBurn != _shouldBurn, "Value already Set");
        shouldBurn = _shouldBurn;
    }

    function setShouldChargeTransfer(bool _shouldChargeTransfer) public onlyOwner {
        require(shouldChargeTransfer != _shouldChargeTransfer, "Value already Set");
    ...
    function withdrawDevelopmentBalance(address _to, uint256 _amount) public onlyOwner {
        _withdrawBalance(development_address, _to, _amount);
    }

    function withdrawMarketingBalance(address _to, uint256 _amount) public onlyOwner {
        _withdrawBalance(marketing_address, _to, _amount);
    }

    function withdrawManagementBalance(address _to, uint256 _amount) public onlyOwner {
        _withdrawBalance(management_address, _to, _amount);
    }

    function withdrawPrimeHoldersBalance(address _to, uint256 _amount) public onlyOwner {
    ...
    function _withdrawBalance(
        ...
        require(fromBalance > 0, "Balance is zero");
    ...
    function setIsCaller(address _address, bool _value) public onlyOwner {
        require(isCallerMap[_address] != _value, "Already a Caller");
