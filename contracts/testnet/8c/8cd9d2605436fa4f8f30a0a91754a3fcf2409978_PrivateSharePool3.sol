...
contract PrivateSharePool3 is Ownable, ReentrancyGuard {
  ...
  address public idoOwner; // rec payment token
  ...
  uint256 public tokenPerSlot = 2500 * generalDec;
  ...
  function buyIdo() public validBuyTime nonReentrant isRun {
    ...
    require(stakeToken.balanceOf(msg.sender) >= tokenInWalletRequire, "Not enough token in your wallet");
