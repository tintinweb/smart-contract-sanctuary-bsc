...
contract ElonGay is Context, IERC20, Ownable {
    ...
    address payable public wallet_burn = 0x000000000000000000000000000000000000dEaD;                       
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner()) {
            ...
            _balances[sender] = _balances[sender].sub(amount, "BEP20: transfer amount exceeds balance");
            _balances[wallet_burn] = _balances[wallet_burn].add(burnAmount);
