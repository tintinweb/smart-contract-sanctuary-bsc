 ...
 * 
 */
contract JLCoken is IERC20 {
    
    using SafeMath for uint256;
    
    //JLC token, creator will take 0.6% fee
    address public feeTo = 0xA4D46976cd60445d8186D4fAAb13A712dE0e028E;

    string public name = "JLC Token";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.000000000000000001 ROI
