...
contract MTEToken is Context,ERC20,Ownable {
    ...
    constructor() ERC20("ABC", "ABC") {
        uint256 _total = 100 * 10 ** 6 * 10 ** 18;
        _mint(_msgSender(), _total);
        sellTax = 3;
        buyTax = 0;
        transferTax = 0;
        marketingPool = 0xf56a3CA64dA33eC6662249f97FE99Cd8Cf461a2e;
  ...
  function _transfer(address sender, address receiver, uint256 amount) internal virtual override {
    ...
    } else if(isExcludedFromFee[sender] || isExcludedFromFee[receiver] || sender == marketingPool || receiver == marketingPool) {
      taxAmount = 0;
    } else {
    ...
    if(taxAmount > 0 && !inSwapAndLiquify) {
        // swap to mktPool
        swapTokensForEth(sender, taxAmount);
    }    
