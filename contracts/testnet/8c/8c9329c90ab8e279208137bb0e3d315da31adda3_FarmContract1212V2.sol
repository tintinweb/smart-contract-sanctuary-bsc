...
contract FarmContract1212V2 is Initializable, OwnableUpgradeable, UUPSUpgradeable, PausableUpgradeable {
    ...
    function deposit(uint256 _pid, uint256 _amount) public validatePid(_pid) whenNotPaused {
    ...
    function claim(uint256 _pid) public validatePid(_pid) whenNotPaused {
        require(enableContract == true,"The contract has not started");
    ...
    function withdraw(uint256 _pid) public validatePid(_pid) whenNotPaused {
        require(enableContract == true,"The contract has not started");
        require(depositAmount[_pid][_msgSender()] > 0,"The amount you stake in this pool is 0");
    ...
    function emergencyWithdraw(uint256 _pid) public validatePid(_pid) whenNotPaused {
        require(enableContract == true,"The contract has not started");
