...
contract RandomSpin is RandSpinInterface {
    ...
    function randMod(address userAddress) external override
    {
    ...
    function currentRandMod(address userAddress) external override view returns (Rand memory)
    {
        return randomStruct[userAddress];
    }
