...
contract SpacePadFriends is Pausable, Ownable, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        require(
            _amount % currentRound.unitPrice == 0,
        ...
        uint256 currentStepDepositAmountWithCurrentDeposit = currentRound
            .currentStepDepositsAmount + currentRound.unitPrice / _amount;
        ...
        if (
            ...
            currentRound.unitPrice += currentRound.nextStepUnitPriceIncrease;
        }
        ...
        onlyOwner
    {
        ...
        uint256 balance = IERC20(currentRound.tokenAddress).balanceOf(
            address(this)
        );
    ...
    function depositOnReferrer(
        ...
        _depositTokenAddress.safeTransferFrom(
            msg.sender,
            _referrer,
            referralFeeAmount
        );
