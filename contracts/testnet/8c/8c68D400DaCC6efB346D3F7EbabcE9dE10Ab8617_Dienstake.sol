...
// SPDX-License-Identifier: MIT
 ...
 /*   BNBDienstake - investment platform based on Binance Smart Chain blockchain smart-contract technology. Safe and legit!

 *
 *   [USAGE INSTRUCTION]
 *
 *   1) Connect browser extension Metamask
 *   2) Choose one of the packages, enter the BNB amount (.01 BNB minimum) using our website "Stake BNB" button
 *   3) Wait for your earnings
 *   4) Withdraw earnings any time using our website "Withdraw" button
 *
 *   [INVESTMENT CONDITIONS]
 *
 *   - Basic interest rate: 1% every 24 hours - only for new deposits
 *   - Minimal deposit: 10 BNB, no maximal limit
 *   - Total income: based on your package plan (from 5% to 8% daily!!!) + Basic interest rate !!!
...
contract Dienstake  {
	...
	uint256 constant public WITHDRAW_FEE = 1500; //In base point
