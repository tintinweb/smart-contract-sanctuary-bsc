...
contract WorldClassCoin is Context, IERC20, Ownable {
    ...
    uint256 dueDevAndMarketingBalance = 0;
    ...
    uint256 private numTokensSellToAddToDevAndMar = 1 * 10**18;
    ...
    event maxWalletSwitchTriggered(bool flag);
    ...
    constructor() {
        ...
        _devAndMarketingWallet = msg.sender;
