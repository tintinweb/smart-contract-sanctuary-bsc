...
contract Multisplitter is Whitelist {
    ...
    constructor(
        ...
        _user[1].wallet = _user1; // Hobbs
        _user[2].wallet = _user2; // Walid
        _user[3].wallet = _user3; // Snake
    ...
    function distribute() public onlyWhitelisted() returns (bool _success) {
        ...
        _user[1].baseBalance += tokens.mul(5000).div(10000);
        _user[2].baseBalance += tokens.mul(3000).div(10000);
    ...
    function distributeTokens(address _token) public onlyWhitelisted() returns (bool _success) {
        ...
        _user[1].tokenBalance += tokens.mul(5000).div(10000);
        _user[2].tokenBalance += tokens.mul(3000).div(10000);
