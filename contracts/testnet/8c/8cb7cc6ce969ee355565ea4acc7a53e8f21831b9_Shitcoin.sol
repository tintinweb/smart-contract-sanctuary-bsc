...
contract Shitcoin is ERC20, Pausable, ERC20Burnable, Ownable {
    ...
    function setAmountToBurn(uint8 _precent) public onlyOwner{
        require(_precent <= 10, "Precent is too high");
        amountToBurn = _precent;
    }

    function showAmountToBurn() public view returns(uint8){
        return amountToBurn;
    }
