...
interface StorageInterfaceV5{
    ...
    function storeTradeByParameters(address, bool, uint[8] calldata) external;
...
*/
    ...
    function registerTrade(
        ...
        uint[8] memory uintData = [trade.pairIndex, trade.initialPosToken, trade.positionSizeDai, trade.openPrice, trade.leverage, trade.tp, trade.sl, v.tokenPriceDai];
        //storageT.storeTradeByParameters(trade.trader, trade.buy, uintData);
