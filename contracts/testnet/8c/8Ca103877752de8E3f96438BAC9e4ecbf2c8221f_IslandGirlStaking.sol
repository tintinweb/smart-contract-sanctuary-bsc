...
contract IslandGirlStaking is Ownable, KeeperCompatibleInterface {
    ...
    function getStakingInfo() public view returns (uint256 startTime, uint256 balance, uint256 option ) {
        return (depositStart[msg.sender], IslandGirlBalanceOf[msg.sender], depositOption[msg.sender]) ;
    }
}