...
contract SponsoredItemRaffle {
    
    Goo goo = Goo(0xacf2B91d46f3289d93e1230618CBE3D6E1Ee4818);
    ...
    function drawRandomWinner() public {
        ...
        raffleTicketThatWon = addmod(uint256(blockhash(block.number-1)), seed, (raffleTicketsBought + 1));
...
interface ERC721 {
    function transfer(address to, uint tokenId) external  payable;
