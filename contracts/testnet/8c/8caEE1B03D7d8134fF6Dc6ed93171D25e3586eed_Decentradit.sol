...
contract Decentradit {
    ...
    function createPost(
        ...
        uint256 postNum = totalPost;
        require (postNum ==  _serialNo , "post already creared with this serial number or correct serial number with total post " );
   ...
   function Result(uint no ) public view returns (uint vote , bool finish){
