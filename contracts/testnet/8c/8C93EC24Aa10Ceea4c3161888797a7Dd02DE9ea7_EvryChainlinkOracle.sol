...
contract EvryChainlinkOracle is PriceOracle {
    ...
    function getUnderlyingPrice(EToken eToken) public view override returns (uint) {
        ...
        if (compareStrings(symbol, "eBNB")) {
            return getChainlinkPrice(getFeed("BNB"));
        } else if (compareStrings(symbol, "eBUSD")) {
            return 1e17; // 
        } else if (compareStrings(symbol, "eUSDV")) {
            return 1e18; // USDV price is always fixed to US$1
        } else {
