...
contract MetaTiger is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2500000001000000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Meta Tiger";
    string private _symbol = "TIGR";
    uint8 private _decimals = 9;
    //Owner address: 0x8B235BF6721C0886F52A65289e4fa415f1778700
    //Marketing and Development address: 0xCb46D46570000106E927c8afEdD55c6C6C8ca0a8 
    //Assets address: 0x8F25372300E8F345002d1A3e38dE7369b4Bca10f
    //Staking, Rewards, Assets: 0xDB706C2B7206f843385d72ba319da563B13Be283 
    //Foundation: 0xd0965E573C7F8F8C3fC610FfD099d5Db8621500F
  
    //-----***-----
    //All Fees go in to single marketing wallet. 
    //The use of one wallet is for security, transparencey, and accountability for the team and MetaTiger community.
    //From marketing wallet tax fee % will be split by the following requirments:
    // **2% Buy Tax**
    // ● 1% Marketing and Development address
    // ● 1% Assets wallet
    // **10% Sell/Transfer Tax**
    // ● 3% to dead address
    // ● 3% to Marketing and Development (same address as above)
    // ● 2.5% to Staking, Rewards, Assets wallet
    // ● 1.5% to Foundation wallet
    //-----***-----
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0xCb46D46570000106E927c8afEdD55c6C6C8ca0a8;
    // buy fee
    ...
    constructor() 
    {
        ...
        //pswap router 0x10ED43C718714eb63d5aA57B78B54704E256024E
        // pswap testnet router 0xD99D1c33F9fC3444f8101754aBC46c52416550D1
...
{
    require(value != cooldownEnabled, "CooldownEnabled is already set, ya flithy animal.");
...
function checkForCoolDown(address from, address to) public
{
    if(cooldownEnabled && to==uniswapV2Pair)
    {
        ...
        require(coolDownTimestamp < block.timestamp, "Wait one hour Cool Down Pd big fella, or feel thy WRATH!");    
