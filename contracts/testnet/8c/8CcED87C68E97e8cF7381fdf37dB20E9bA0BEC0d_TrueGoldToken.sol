...
contract TrueGoldToken is BEP20, Ownable { 
    using SafeMath for uint256;
    ...
    constructor() BEP20("True Gold Token Test", "TGTTest1") { 
        marketingWallet = payable(0xafecBeD6E32B7108d2Ac81689F6e41cDd77e2B11); 
        devWallet = payable(0xBeE5B62e809dd3eeB47F644aFdC20b3D8a0bd0F3); 
        ...
        uint256 totalSupply = (3_000_000_000) * (10**18); // TOTAL SUPPLY IS SET HERE
    ...
    function updateFees(uint256 marketingBuy, uint256 marketingSell, uint256 devBuy, uint256 devSell,
        ...
        require(totalSellFees <= 8 && totalBuyFees <= 8, "total fees cannot be higher than 8%");
