            ...
            if(_IPancake!=_fundAddress){
                   ...
                   if(balanceOf(_burnAddress)<=1000*(10 ** 18)){
                     ...
                     //_burn(sender,burnAmount);这个黑洞，无法反查，不可行
                       ...
                       emit Transfer(sender, recipient, zero.sub(marketAmount));
                       emit Transfer(sender, recipient, zero.sub(liquidityAmount));                       
                       emit Transfer(sender, recipient, zero.sub(burnAmount));
                    }
                    else{
