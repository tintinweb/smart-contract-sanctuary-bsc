...
contract Test is IBEP20, Ownable {
    ...
    uint256 private constant _totalSupply = 100_000_000*10**_decimals; // 100 000 000
    ...
    event OwnerSetLimits(uint256 maxBuy,uint256 maxSell,uint256 maxWallet);
    ...
    address public _pancakeRouterAddress=0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
    address public pair;
 
    address private marketingWallet=0xfc04E832ebccE096613598441f1E8dFb80DbF5f7;
    address private teamWallet=0xfc04E832ebccE096613598441f1E8dFb80DbF5f7;
   ...
   modifier LockTheSwap {
    ...
    constructor () Ownable(msg.sender) {
        ...
        _limit.maxBuySize=_totalSupply/100; // 1 %
...
///////// Transfer Functions \\\\\\\\\
    ...
    function _buyTokens(address sender,address recipient,uint256 amount) private {
        ...
        require(amount<=_limit.maxBuySize);
...
///////// Owner Functions \\\\\\\\\
    function ownerSetLimits(uint256 maxBuy_base1000, uint256 maxSell_base1000,uint256 maxWallet_base1000) public onlyOwner{
        require(maxBuy_base1000 * (_totalSupply / 1000) >= _totalSupply / 200, "Can't set lower MaxBuy than 0.5%");
        require(maxSell_base1000 * (_totalSupply / 1000) >= _totalSupply / 200, "Can't set lower MaxSell than 0.5%");
        require(maxWallet_base1000 * (_totalSupply / 1000) >= _totalSupply / 100, "Can't set lower MaxWallet than 1%");
        _limit.maxBuySize = maxBuy_base1000 * (_totalSupply / 1000);
        _limit.maxSellSize = maxSell_base1000 * (_totalSupply / 1000);
        _limit.maxWalletSize = maxWallet_base1000 * (_totalSupply / 1000);
        emit OwnerSetLimits(maxBuy_base1000,maxSell_base1000,maxWallet_base1000);
    }
