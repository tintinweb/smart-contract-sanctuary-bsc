...
contract Test {
    ...
    constructor(address ownerAddress, IBEP20 _graceToken)  
    {
        owner = ownerAddress;       
        graceToken=_graceToken;
        
        stakingPrograms_.push(Program(110,365*2,110));  //  365 Days 24*60*60
        stakingPrograms_.push(Program(120,365*2,120));
        stakingPrograms_.push(Program(130,365*2,130));
        stakingPrograms_.push(Program(140,365*2,140));
