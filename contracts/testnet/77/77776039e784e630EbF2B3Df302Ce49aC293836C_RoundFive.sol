...
contract RoundFive is Ownable, Pausable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeERC20 for ERC20;
    ...
    // Investor cap
    uint256 public investorMinCap = 670000000000000000; // 0.67 bnb
    uint256 public investorHardCap = 135000000000000000000; // 135 bnb
    // Crowdsale time
    ...
    uint256 public constant CROWDSALE_ESCROW_CLIFF = 2 hours;
    uint256 public constant CROWDSALE_ESCROW_DURATION = 6 hours;
