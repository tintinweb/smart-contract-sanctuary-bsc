...
contract TEST is IBEP20, Ownable {
    ...
    address RWRD = 0x8a9424745056Eb399FD19a0EC26A14316684e274;
    ...
    uint256 lotteryPercentage = 25;
    uint256 lastLottery=block.timestamp;
    uint256 lotteryMinPeriod = 4 hours;
    ...
    function setLotterySettings(address newReward, uint256 minPeriod, uint256 percentage, uint256 minBalance_base1000) external onlyOwner{
        ...
        lotteryMinBalance = minBalance_base1000 * _totalSupply / 1000;
    }
