...
contract sBDAOERC20Token is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked BDAO", "sBDAO", 9) ERC20Permit() {
    ...
    /**
        @notice increases sBDAO supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sBDAO
