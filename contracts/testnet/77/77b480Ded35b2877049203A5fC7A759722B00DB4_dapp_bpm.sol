...
contract dapp_bpm is ReentrancyGuard {
	...
	bool contractStablePrice = false;



	/**	SUSCRIPTION **/
	uint256[] plan = [1900800, 7603200, 31536000];
	uint256[] planPrice = [60*1e18, 240*1e18, 900*1e18];
    ...
    *
    ************************************/
    function registerUser(bool _isArtist) external pause onlyBlackListed {
    ...
    function withdraw(uint256 _base, uint256 _reproductionsBase, uint256 _ammountBase, uint256 _reproductions, uint256 _ammount, uint256 _random) external nonReentrant pause onlyBlackListed {
    	...
    	(uint256 verifyReproduction ,uint256 verfyAmmout) = verifyTrade(_base, _reproductionsBase, _ammountBase, _random);
    ...
    function payPremium(uint256 _plan) external pause onlyBlackListed {
    	...
    	emit PaySuscription(msg.sender, _plan+1);
    ...
    ************************************/
    ...
    function get_tokenBnbPrice() public view returns(uint256 _tokenDecimal, uint256 _defaultDecimal){
    ...
    ************************************/
    ...
    function verifyTrade(uint256 _b, uint256 _rpB, uint256 _aB, uint256 _ramdom) private pure returns(uint256 _rpT, uint256 _aT){
    	uint256 rpMB; uint256 rpT; 
    	uint256 aMB; uint256 aT;
    	rpMB = _rpB * _ramdom;
...
par busd/token
(no liquidez) 0x840328b96Bc61D9b6A0f28479aD80f5493301E36

par wbnb/token
0xaeec8C3158dcC65ddE7f8f82C21Bc68e3EAD37dd

oraculo 0x5C7c8f04835DE871609508Af36804e574E8cD149
...
prueba testnet _1
0xCeB3A6d1C4460c8f40145727D634C4598CE67cEb (fallo en obtener precios del bnb)
***/