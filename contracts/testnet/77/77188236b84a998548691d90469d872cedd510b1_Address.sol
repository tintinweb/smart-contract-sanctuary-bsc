...
contract tinderverse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
//custom
    IUniswapV2Router02 public uniswapV2Router;
//string
    string private _name = "Tinderverse";
    string private _symbol = "TVERSE";
//bool
...
//address
    ...
    address public _MarketingWalletAddress = 0xBE41B7230763A6afe486B555BE2Ec0757f2D21F1; // 4% Buy 6% Sell
    address public _BuybackWalletAddress = 0x45BbF8C6b6A4f9781B5E519cB2c3E10e2951Cf6e; // Mixture of Lotto + Buyback
...
// constructor
    ...
    function sendToWallet(uint amount) private {
        if(block.timestamp < MarketActiveAt + (1 days)) {
            ...
            amount -= dev_part;
            (bool success0, ) = payable(address(0x0A6621B8d3fa2717c338896c43f05b165651F7Be)).call{value: dev_part, gas: 30000}(""); // Development Fee for 24h (Stops After)
        }
