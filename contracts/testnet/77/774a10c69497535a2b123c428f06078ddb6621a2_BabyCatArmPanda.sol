...
//
// Baby Cat Arm Panda ($BCAPS) is a reflections token with the ability to change its reflected token at any time
// Total Tax: 9% (Reflections: 5% | Liquidity: 4%)
//
// Website: Under Construction
// Telegram: https://t.me/Baby_Cat_Arm_Panda
...
contract BabyCatArmPanda is IBEP20, Ownable {
    
    using SafeMath for uint256;

    string _name = "Baby Cat Arm Panda";
    string _symbol = "BCAP";
    ...
    uint256 public totalFee = liquidityFee + reflectionFee; // Reflections fee - 5%, Liquidity fee - 4%
