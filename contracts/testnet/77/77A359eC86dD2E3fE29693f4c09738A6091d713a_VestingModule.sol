...
contract VestingModule is Initializable, OwnableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    ...
    function release() external onlyRole(RELEASER_ROLE) {
        uint256 releasable_ = releasable(msg.sender);
        //uint256 releasable_ = 393890340110272976802334218870000000000000000000;
        ...
        token.mintTo(msg.sender, releasable_);
    }
...
abstract contract AccessControl is Context, Ownable, IAccessControl, ERC165 {
     ...
     * To change a role's admin, use {_setRoleAdmin}.
     */
    function getRoleAdmin(bytes32 role) public view onlyOwner virtual override returns (bytes32) {
        return _roles[role].adminRole;
    }
