...
contract EventRoxul is IEventRoxul, Ownable {
    uint256 timeCloseBet;
    uint256 timeStart;
    uint256 timeLastTransaction;
    uint256 bet;
    uint256 balance;
    uint256 betId = 0;
    ...
    mapping(address => uint256) userBetTime;
    mapping(address => uint256) userBetId;
    mapping(uint256 => address) betIdUser;
    mapping(uint256 => uint256) betBalance;
