...
contract FTEST is ERC20, Ownable {
    ...
    constructor () ERC20("FeTESTers", "FTEST") 
    {   
        address router;
        if (block.chainid == 56) {
        ...
        teamCEXWallet = 0xeDAF9684cAC320E095933207F9Db9445017bc429;
        deploymentWallet = 0xeDAF9684cAC320E095933207F9Db9445017bc429;
    ...
    function _transfer(address from,address to,uint256 amount) internal  override {
        ...
        if (burnTokens > 0 && (lastBurn + 1 hours < block.timestamp)) {
            lastBurn = block.timestamp;
