...
contract PropComToken_v1 is IERC20, IERC20Metadata, Context, Ownable, Stakeable {
    ...
    function stake(uint256 _amount) public {
        ...
        _stake(_amount * 10**uint256(_decimals));
        _burn(msg.sender, _amount * 10**uint256(_decimals));
    }
        ...
        returns (StakingSummary memory)
    {
        ...
        summary.total_amount = totalStakeAmount/ (10**uint256(_decimals));
        return summary;
    }
}