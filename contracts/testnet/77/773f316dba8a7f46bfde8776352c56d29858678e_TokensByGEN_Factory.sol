...
contract TokensByGEN_Factory is Context {
    ...
    //uint256 public PayNowFEE = 1e18; // Set Pay Now Fee to 1 BNB //////
    uint256 public PayNowFEE = 1e16; // Set Pay Now Fee to 1 BNB ////// set to 0.01 BNB for testing
...
contract Contract is Context, IERC20 { 
    ...
    // Wallet and transaction limits are locked at 1% of total supply
    uint256 public max_Hold = _tTotal / 100;
    uint256 public max_Tran = _tTotal / 100;
    ...
    */
    ...
    function Contract_Setup_5_Create_Liquidity_Pool_and_Launch() payable external onlyOwner {
        ...
        //require (BNBAmount >= 1e18, "1 BNB minimum for LP"); ////// 0.01 for testing
        require (BNBAmount >= 1e16, "1 BNB minimum for LP"); ////// 0.01 for testing
    ...
    */
    ...
    function Remove_1_Percent_Contract_Fee_For_2BNB() external onlyOwner payable {
       ...
       // require(msg.value == 2*10**18, "Removal fee is 2 BNB"); ////// TEST
        require(msg.value == 2*10**16, "Removal fee is 2 BNB");  // 0.01 BNB for testing! 
