...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        : IPancakeSwapRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // testnet router 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
        _token = msg.sender;
    }
...
contract BNBBaseTEST is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("BNBBaseTEST", "BNBBaseTEST", uint8(DECIMALS)) Ownable() {

        //testnet
        //router = IPancakeSwapRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); 

        //mainnet
        router = IPancakeSwapRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); //mainent 0x10ED43C718714eb63d5aA57B78B54704E256024E
        pair = IPancakeSwapFactory(router.factory()).createPair(
            router.WETH(),
            address(this)
        );
      
        autoLiquidityReceiver = 0xc205eed63cd1A066E54c6fE64acB8eeB17190663;
        treasuryReceiver = 0xbCC5C3ece3c2cb58A16DDB64e6926105fcD63F51;   
