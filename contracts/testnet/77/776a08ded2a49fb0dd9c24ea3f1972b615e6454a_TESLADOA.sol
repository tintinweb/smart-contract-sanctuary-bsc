...
contract TESLADOA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TESLA DAO";
    string private _symbol = "TESLA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x0dbBCc4b73F1B9e3437643C4E7bD8C28A84EFd84); 
    address payable public teamWalletAddress = payable(0xA21c2B2e36CBdD381F1E11f911f854A430948eE4); 
