...
import "./SonicRings.sol";

contract SonicRingsCrowdsale is Crowdsale, WhitelistedCrowdsale {
    uint256 public minAmount = 0.1365 ether; //1BNB
        ...
        view
    {
        ...
        require(_weiAmount >= minAmount, "need to contribute more");
    }
...
contract SonicRings is ERC20, ERC20Detailed {
    constructor(
