...
contract JUSTToken is ERC20, SafeOwnable {
    ...
    address public fundAddr = 0x3cEeC23dFc2baE9E3907Dd5B19A09dC9657DE272;

    uint256 public nftFee = (3 * BASE_RATIO) / 100;
    address public nftAddr = 0x2dA41A170C4325F6933D804Aa50ec9C962b14617;
    ...
    IERC20 public usdtToken = IERC20(0xf5Eacdee153A7247aC93A35FFD7cCF1Aec89fac2);
    ...
    constructor() ERC20("JUST Token", "JUST") {
        ...
        _balances[owner()] = _balances[owner()].add(total);
