...
contract SP1Million is Context, IERC20 { 
    ...
    address payable public Wallet_Marketing = payable(0xaA869C034f253524444f61a43843759cd2e5274B); 
    address payable public Wallet_Dev = payable(0xaA869C034f253524444f61a43843759cd2e5274B);
    ...
    string private constant _name = "SP1Million"; 
    string private constant _symbol = unicode"$SP1M"; 
    ...
    constructor () {
        ...
        _owner = 0xaA869C034f253524444f61a43843759cd2e5274B;
