...
contract TokensFactory{
  ...
  function createToken(address cOwner, address marketingWallet, string memory name, string memory symbol, uint256 totalSupply, uint256 taxFee) external {

    //TOKEN[] tokens;

    token = new TOKEN(cOwner, marketingWallet, name, symbol, totalSupply, taxFee);
