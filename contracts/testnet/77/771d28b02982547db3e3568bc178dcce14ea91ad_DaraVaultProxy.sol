...
contract DaraVaultProxy is Ownable {
    ...
    function addTweetToVault(string memory currency, string memory tweetAuthor, string memory tweetContent, string memory tweetDate, string memory tweetID) external returns (bool){
