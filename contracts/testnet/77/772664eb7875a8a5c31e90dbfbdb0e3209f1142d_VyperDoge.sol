...
contract VyperDoge is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Vyper Doge";
    string constant _symbol = "$VYPER";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWalletB = 0xcD04f6F37f71329a0FC424b9074772CE4fFdf494;
