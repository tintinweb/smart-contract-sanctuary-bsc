...
contract s3 is Context, IERC20, Ownable {
    ...
    string private constant _name = "s3";
    string private constant _symbol = "s3";
   ...
   function checkBot(address from, address to) private {
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee + _buyBurnFee <= 100, "Must keep taxes below 100%");
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee + _sellBurnFee <= 100, "Must keep taxes below 100%");
