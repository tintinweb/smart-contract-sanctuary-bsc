...
/////////////////////////////////////////////////////
 ...
 uint256 tTeam = calculateTeamFee(tAmount);
  ...
  //      _takeTeamFee(tTeam);
    ...
    function setTaxFeePercent(uint256 setTax) external onlyOwner {
        setTax = setTax.mul(100);
        _taxFee = 0;
        _liquidityFee = 0;
        _marketingFee = setTax.mul(40).div(100);
        _developmentFee = setTax.mul(40).div(100);
        _teamFee =setTax.mul(20).div(100); 
        require(
            _taxFee + _liquidityFee + _marketingFee + _developmentFee + _teamFee <= 1400,
            "Total fee is over 25%"
        );
    }
