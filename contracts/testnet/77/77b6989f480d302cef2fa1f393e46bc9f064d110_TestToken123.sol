...
contract WBNBDividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd); //WBNB
...
contract TestToken123 is Ownable, IBEP20 {
    using SafeMath for uint256;
    ...
    string  _name = "Test Token 123";
    string  _symbol = "TT123";
    ...
    uint256 public NFTRewardsFee        = 1;
    uint256 private devFee              = 1;
    uint256 public burnFee              = 0;
    uint256 public totalFee             = marketingFee + rewardFee + liquidityFee + NFTRewardsFee + burnFee + devFee;
    ...
    address private NFTRewardsFeeReceiver;
    ...
    WBNBDividendDistributor private distributor;
    ...
    constructor () {
       router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
        ...
        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
         ...
         distributor = new WBNBDividendDistributor(address(router));

        isFeeExempt[msg.sender] = true;
        isFeeExempt[marketingFeeReceiver] = true;
        isFeeExempt[devFeeReceiver] = true;
        isFeeExempt[NFTRewardsFeeReceiver] = true;
        ...
        isTxLimitExempt[NFTRewardsFeeReceiver] = true;
        ...
        marketingFeeReceiver = 0xDC8074b7323eb5119F959697B4C8CFa316a135CC;
        NFTRewardsFeeReceiver = 0xDC8074b7323eb5119F959697B4C8CFa316a135CC;
        devFeeReceiver = 0xDC8074b7323eb5119F959697B4C8CFa316a135CC;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBNFTRewards = amountBNB.mul(NFTRewardsFee).div(totalBNBFee);
        ...
        (tmpSuccess,) = payable(NFTRewardsFeeReceiver).call{value: amountBNBNFTRewards, gas: 30000}("");
    ...
    function setFees(uint256 _liquidityFee, uint256 _rewardFee, uint256 _marketingFee, uint256 _NFTRewardsFee, uint256 _devFee, uint256 _burnFee, uint256 _feeDenominator) public onlyOwner {
        ...
        devFee = _devFee;
        burnFee = _burnFee;
        totalFee = _liquidityFee + _rewardFee + _marketingFee + _NFTRewardsFee + _burnFee + _devFee;
        feeDenominator = _feeDenominator;
        require(totalFee < feeDenominator/2, "Fees cannot be more than 25%");
    }

    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _NFTRewardsFeeReceiver, address _burnFeeReceiver, address _devFeeReceiver ) public onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        marketingFeeReceiver = _marketingFeeReceiver;
        NFTRewardsFeeReceiver = _NFTRewardsFeeReceiver;
