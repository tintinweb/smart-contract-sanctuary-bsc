 ...
 */
contract xYSLVault is AccessControl, Initializable {
    ...
    function initialize(
        ...
        INTT(xYSLs).initialize(address(this), "xYSLs", "xYSLs");
    ...
    */
    function Deposit(uint256 _amount) external {
        ...
        IERC20(Admin.xYSL()).transferFrom(msg.sender, address(this), _amount);
        IYSLS(xYSLs).mint(msg.sender, _amount * 90 / exchangeRatio);
        exchangeRatio = (IERC20(Admin.xYSL()).balanceOf(address(this)) * 100) / IERC20(xYSLs).totalSupply();
    ...
    */
    function Withdraw(address user,uint256 amount) external {
        ...
        IERC20(Admin.xYSL()).transfer(msg.sender, balance);
