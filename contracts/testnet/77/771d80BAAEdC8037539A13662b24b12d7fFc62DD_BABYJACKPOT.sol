...
contract DividendDistributor is IDividendDistributor {
    ...
    // address public WBNBSelectionMainNet = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; //MainNet WBNB Address
     address RWDSelectionTestnet = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; //0x55E0C4Cb24c146BEDF4AaCec69A1B492bE2cd309; //0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7 BUSD Testnet Address, CAKE wont work on Pancakeswap Testnet.
     address WBNBSelectionTestnet = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee;//wbnb -0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; //DAI Testnet Address, cant get WNBN address to compile.
...
contract BABYJACKPOT is IBEP20, Auth {
    ...
    address public WBNB = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee;// wbnb-0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;//0x2859e4544C4bB03966803b044A93563Bd2D0DD4D; //WBNB Pegged Address //testnet0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd
    ...
    address public marketingFeeReceiver = 0x4c0Eb12198d62b13Cad3E93b13Dc9ab99A02812B;
    address public developerFeeReceiver = 0x4816fEC583401c2117e924dC95BF21d37819FbD0;
    address public burnFeeReceiver;
    address public charityFeeReceiver = 0x558B624De1d61379E0A131C7a9C6F6D9DcC14abE;
    address public currentRouter;
    ...
    constructor () Auth(msg.sender) {
        ...
        currentRouter = PancakeRouterDev2; //PancakerouterProd; //Define Current Router
    ...
    */
    ...
    uint256 public cherryBombMax = 5000000000000000000;
    uint256 public jackpotMaxBalance = 10000000000000000000;
    uint256 public startingJackpot = 1000000000000000000;
    ...
    function distributeBNBShare(uint256 _dAmount, uint256 _jid) private{        
        ...
        if(_dAmount > 0){
            ...
            IBEP20(busd).transfer(addr, shareAmount);
            //payable(addr).call{value: shareAmount, gas: 3000}("");
            //tmpSuccess;
    ...
    function stakeJackpot(uint256 _busd) external payable {
        uint256 _jid = jackId;
        uint256 timestamp = block.timestamp;
        uint256 amount = _busd; //msg.value;
        address staker = msg.sender;

    
        IBEP20(busd).transferFrom(msg.sender, address(this), _busd);
        require(
    ...
    function awardJackpot() public {
        ...
        IBEP20(busd).transfer(winnerAddress, winnerPercent);
    ...
    function approve(address spender, uint256 amount) public override returns (bool) {
        require(spender != address(0), "BEP20: cannot approve from the zero address");
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        require(recipient != address(0) && sender != address(0), "BEP20: cannot approve from the zero address");
    ...
    function swapBack() internal swapping {
        ...
        uint256 balanceBefore = IBEP20(busd).balanceOf(address(this));//address(this).balance;
        ...
        uint256 amountBNB = IBEP20(busd).balanceOf(address(this)).sub(balanceBefore);//address(this).balance.sub(balanceBefore);
        ...
        IBEP20(busd).transfer(nftReward, marketShare);
        IBEP20(busd).transfer(marketingFeeReceiver, marketShare);
        IBEP20(busd).transfer(developerFeeReceiver, amountBNBDeveloper);
        IBEP20(busd).transfer(developerFeeReceiver2, amountBNBDeveloper);
       // IBEP20(busd).transfer(address(this), amountBNBCharity);
    ...
    function setWbnbandCakeAddress(address wbnb, address cake, address _busd) external authorized {
        WBNB = wbnb;
        CAKE = cake;
        busd = _busd;
    ...
    // Withdraw BEP20 tokens that are potentially stuck in the BSJ Contract
