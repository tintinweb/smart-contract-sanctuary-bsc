...
contract GoalsAndWin is Context, Ownable, IERC20   {
    ...
    uint256 private _taxLiquidityFee = 2;
    uint256 private _taxTreasuryFee = 2;    
    uint256 public _totalFee = _taxLiquidityFee + _taxTreasuryFee ;

    uint256 private _previousTotalFee = _totalFee; 

    
    string private constant _name = "GoalsAndWin";
    string private constant _symbol = "GAW";
    ...
    function setTotalFeePercent(uint256 taxLiquidityFee, uint256 taxTreasuryFee) external onlyOwner() {
