...
contract PAMP is ERC20, ReentrancyGuard, Ownable {
    ...
    function _swapTokensForEth(uint256 _amount) private {
        ...
        _approve(address(rewardsContractAddress), address(uniswapV2Router), _amount);
    ...
    function _transfer(address _from, address _to, uint256 _amount) internal override {
        ...
        // if (excludeFromFees[_from] || excludeFromFees[_to] || _from == owner() || _to == owner()) {
        if (!dividendsInETH) {
            ...
            //     _calculateDividends(IERC20(uniswapV2Router.WETH()).balanceOf(address(this)));
            // } else {
    ...
    function claimETH() external nonReentrant {
        ...
        if (dividendsInETH) {
            ...
            IERC20(uniswapV2Router.WETH()).transfer(msg.sender, claimableETH);
        } else {
