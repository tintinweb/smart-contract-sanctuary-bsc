...
contract StakeUpFarm is Ownable, ReentrancyGuard {
    ...
    IERC20 public SUF = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // $SUF
    IERC721 public NFTx125 =
        IERC721(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // $NFT @todo: change to NFT
    IERC721 public NFTx150 =
        IERC721(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // $NFT @todo: change to NFT
    IERC721 public NFTx175 =
        IERC721(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // $NFT @todo: change to NFT
    IERC721 public NFTx2 = IERC721(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // $NFT @todo: change to NFT
    ...
    function buyNFT(uint256 _option) public nonReentrant {
        ...
        if (_option == 1) {
            ...
            NFTx125.safeTransferFrom(address(this), msg.sender, ID); //@todo: change to real ID
