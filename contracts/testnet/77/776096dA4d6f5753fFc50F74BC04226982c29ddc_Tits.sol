...
contract Tits is Context, IERC20, Ownable {
    ...
    uint256 private startingSupply = 2; //1 Quadrillion, underscores aid readability
    ...
    address public burnAddress = 0x9c1280a9825b02d248978d7c4050Ae6e20157309;
    address payable private _marketingWallet =
        payable(0x9c1280a9825b02d248978d7c4050Ae6e20157309);
    ...
    uint256 public maxTxAmountUI =
        (startingSupply * maxTxPercent) / maxTxDivisor; // Actual amount for UI's
    ...
    uint256 public maxWalletAmountUI =
        (startingSupply * maxWalletPercent) / maxWalletDivisor; // Actual amount for UI's
