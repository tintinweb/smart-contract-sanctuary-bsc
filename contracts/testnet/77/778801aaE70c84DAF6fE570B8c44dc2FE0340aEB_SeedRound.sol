...
contract SeedRound is WhiteList {
    ...
    uint256 public maxBuy = 2000000000000000000;
    uint256 public minBuy = 1000000000000000;

    bool isWhiteList;
    uint256 timeBuyWhitelist;
    ...
    function claim() public {
        ...
        data[msg.sender].amountWithdrawed = _amountwithdrawNow.add(
            data[msg.sender].amountWithdrawed
        );
        data[msg.sender].lastWithdrawed = block.timestamp;
        data[msg.sender].countWithdrawed = countWithdrawedSave;
        data[msg.sender].isFirstWithdrawed = isFirstWithdrawSave;
        ...
        )
    {
        ...
        uint256 _amountTokenWithdraw = _dataBuy.isFirstWithdrawed
            ? 0
            : amountFirst;
        ...
        calCountTime = calCountTime > countPeriodWithdraw
            ? countPeriodWithdraw
            : calCountTime;
        uint256 countWithdraw = calCountTime > _dataBuy.countWithdrawed
            ? calCountTime - _dataBuy.countWithdrawed
            : 0;
        ...
        countWithdrawedSave = _dataBuy.countWithdrawed.add(countWithdraw);
    }
