...
contract GBT is ERC20, Ownable {
    ...
    constructor(
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(swapAddr_);
        address _uniswapV2Pair = IUniswapV2Factory(_uniswapV2Router.factory()).createPair(address(this), _uniswapV2Router.WETH());
        
        liquidityAddress = liquidityAddr_;
    ...
    function setLiquidityAddress(address _liquidityAddress) external onlyOwner {
        require(_liquidityAddress != address(0), "liquidityAddress address cannot be 0");
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            super._transfer(from, liquidityAddress, fees.sub(DFee));
        }
