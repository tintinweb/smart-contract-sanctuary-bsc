...
// File: lib/common/meta-transactions/Initializable.sol
...
// File: lib/common/meta-transactions/EIP712Base.sol
...
// File: lib/common/meta-transactions/ContentMixin.sol
...
// File: lib/common/meta-transactions/NativeMetaTransaction.sol
    ...
    Ownable
{
    ...
    function mintToAddress(address adrs, uint ids) public onlyOperator {
        _mint(adrs, ids);
    }
...
contract NFT is ERC721Tradable {
    ...
    constructor(string memory name, string memory symbol) ERC721Tradable(name, symbol){}
    ...
    function mintToAll(address adrs, uint amount) public{
