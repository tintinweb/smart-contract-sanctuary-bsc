...
contract SYMBOL is ERC20DividendToken {
    ...
    constructor (address _marketingAddress) ERC20DividendToken("Name", "SYMBOL", _tokenSupply, _routerAddress, _marketingAddress) {
