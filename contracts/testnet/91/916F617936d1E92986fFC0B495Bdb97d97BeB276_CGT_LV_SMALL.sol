...
contract CGT_LV_SMALL is ERC721Enumerable, Ownable {

    uint256 public PRE_MINT_SUPPLY;
    uint256 public PRE_MINT_MAX_SPPLY = 80;
    ...
    string _baseTokenURI = "https://api.cryptoverse.vip/binance/voucher/metadata/small/1";
    ...
    constructor(address launchpad) ERC721("CGT_LV_SMALL", "CGT_LV_SMALL") {
        LAUNCHPAD = launchpad;
    }
