...
contract PlayerBook {
    ...
    //    (_|(_| | (_|  _\(/_ | |_||_)  .
    //=============================|================================================
    uint256 public registrationFee_ = 5 finney;            // price to register a name
    ...
    //==============================================================================
    constructor() public {
        TeamJust = TeamJustInterface(0x84557eb7834d8781f8d87ed4cae389ee67c0f6a7);
        CommunityBank = CommunityBankInterface(0xbd773ca70d8febde70a63b25b4e3845425fafd79);
        // premine the dev names (sorry not sorry)
        // No keys are purchased with this method, it's simply locking our addresses,
        // PID's and names for referral codes.

        plyr_[1].addr = 0xf6e6B55A5769Bd434e193DfFdbD8b494ab72C4f8;
        plyr_[1].name = "testdeployer";
        plyr_[1].names = 1;
        pIDxAddr_[0xf6e6B55A5769Bd434e193DfFdbD8b494ab72C4f8] = 1;
        pIDxName_["testdeployer"] = 1;
        plyrNames_[1]["testdeployer"] = true;
        plyrNameList_[1][1] = "testdeployer";
