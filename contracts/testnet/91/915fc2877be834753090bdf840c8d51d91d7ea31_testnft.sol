...
contract testnft is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public PUBLIC_SUPPLY = 8;
        ...
        onlyOwner
    {
        ...
        for (uint256 k = 0; k < airdropAddress.length; k++) {
            _mintTNFTS(airdropAddress[k], numberOfTokens);
        }
    }
    ...
    function mintPublic(uint256 numberOfTokens) external payable nonReentrant {
        ...
        _mintTNFTS(msg.sender, numberOfTokens);
    }
    ...
    function _mintTNFTS(address to, uint256 numberOfMints) internal {
      require(msg.sender == tx.origin, "contract not allowed");
        ...
        for (uint256 i; i < numberOfMints; ) {
            ...
            // Mint TNFT and generate its attributes
