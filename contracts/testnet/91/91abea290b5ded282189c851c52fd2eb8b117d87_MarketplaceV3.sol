...
// File @openzeppelin/contracts-upgradeable/access/IAccessControlUpg[email protected]
...
// File contracts/marketplace/MarketplaceV3.sol
...
contract MarketplaceV3 is Initializable, AccessControlUpgradeable, PausableUpgradeable {
  ...
  function _executeOrder(uint256 orderId, bool payWithBusd) internal whenNotPaused {
    ...
    address customSender = msg.sender;

    if (payWithBusd) {
      customSender = address(this);
      _buyMHT(order.price);
    }
