...
contract DividendDistributor is IDividendDistributor {
 ...
 //   IBEP20 RWRD = IBEP20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); // mainnet
...
contract ETWITTER is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB =  0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
  //  address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // mainnet
    ...
    string constant _name = "ETWITTER";
    ...
    constructor () Auth(msg.sender) {
       ...
       // router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);//mainnet
        ...
        marketingFeeReceiver = 0x02eFBC50DD18FBe9DB724E7e1cE8F55D08BB3Fe8;
        developmentFee = 0x378425548BAed63B3466Da7c33A334488326C655;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if (!authorizations[sender] && recipient != address(this)  && recipient != address(DEAD) && recipient != pair && recipient != marketingFeeReceiver && recipient != developmentFee  && recipient != autoLiquidityReceiver && recipient != burnFeeReceiver){
    ...
    function swapBack() internal swapping {
        ...
        (tmpSuccess,) = payable(developmentFee).call{value: amountBNBDev, gas: 30000}("");
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _developmentFee, address _burnFeeReceiver ) external authorized {
