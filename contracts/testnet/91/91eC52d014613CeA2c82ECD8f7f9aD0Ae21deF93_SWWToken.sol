...
contract SWWToken is IERC20, Ownable {
    ...
    address payable public advertisementWallet =
    ...
    function changeAdvestisementWallets(address wallet) public onlyOwner {
        advertisementWallet = payable(wallet);
    }
    ...
    function _takeAdvertisement(uint256 tAdvertisement) private {
        ...
        // swapTokensForBNB(rAdvertisement);
        // uint256 BNB_rAdvertisement = address(this).balance;

        // sendToWallet(advertisementWallet, BNB_rAdvertisement);
