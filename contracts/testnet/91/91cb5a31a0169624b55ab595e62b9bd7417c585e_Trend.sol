...
contract Trend is Context, IBEP20, Ownable {
    ...
    constructor(address payable _developer) public {
    ...
    function setHours(uint newval)  public onlyOwner returns (bool) {
   	...
   	function setDevt(address newDevt)  public onlyOwner returns (bool) {       
        devt = newDevt;
        return true;
    }

	  function setMarketing(address newMarketing)  public onlyOwner returns (bool) {
