...
contract FOUNDERDROPPOL is ERC721, ERC721URIStorage, Pausable, Ownable {
    ...
    function safeMintUsingEther(uint256[] memory tokenId, uint256 quantity) public payable {
    ...
    function safeMintUsingToken(uint256[] memory tokenId, address token_address, uint256 amount, uint256 quantity) public {
        require(isSaleActive, "Sale is not active" );
        ERC20 token;
