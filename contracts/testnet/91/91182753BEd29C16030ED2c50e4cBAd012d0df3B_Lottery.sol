...
contract Lottery {
    ...
    uint256 public constant ticketCommission = 0.005 ether; 
    uint256 public constant duration = 5 minutes; // The duration set for the lottery
    ...
    mapping (address => bool) private _isBlacklisted; //blacklist biggest wallet
    ...
    function DrawWinnerTicket(address from, address to) public isOperator {
