...
Erc20C08FeatureRestrictTradeAmount
{
    ...
    override
    {
        ...
        if (from != uniswapV2Pair && to != uniswapV2Pair) {
            ...
            uint256 fees = amount * feeTotal_ / 1000;
    ...
    swapGuard
    {
        ...
        * (shareMarketing + shareLper + shareHolder + (shareLiquidity / 2))
        ...
        uint256 thisTokenForLiquidity = thisTokenForSwap * (shareLiquidity / 2) / shareTotal;
        uint256 thisTokenForBurn = thisTokenForSwap - thisTokenForSwapBaseToken - thisTokenForLiquidity;
    ...
    private
    {
        ...
        uint256 baseTokenDivForLper = isUniswap ? (10 - uniswapCount) : 10;
    ...
    private
    {
        ...
        uint256 baseTokenDivForHolder = isUniswap ? (10 - uniswapCount) : 10;
...
Ownable
{
    ...
    address internal constant addressPinkSaleLock = address(0x7ee058420e5937496F5a2096f04caA7721cF70cc);
...
Ownable
{
    ...
    onlyOwner
    {
        ...
        shareTotal = shareMarketing + shareLper + shareHolder + shareLiquidity + shareBurn;
    }
}
