    ...
    ERC721BurnableUpgradeable
{
    ...
    function initialize() public initializer {
        __Ownable_init();
        ERC721Upgradeable.__ERC721_init("Seeb721NFT", "SNFT");
        _tid = 1;
    ...
    function newtokenasbid(
        ...
        require(amount == order_place[from][tokenId].price && order_place[from][tokenId].price > 0, "Insufficent fund");
        ...
        require(
            approveValue >= (_adminfee.add(roy.add(netamount))).div(10**Tokendecimals),
