...
contract Test_CryptoDrift_V2 is ERC721Upgradeable, ERC721EnumerableUpgradeable, AccessControlUpgradeable,PausableUpgradeable, ERC721URIStorageUpgradeable,UUPSUpgradeable {
    ...
    bool public rareSaleOpen;
    bool public genesis1SaleOpen;
    bool public genesis2SaleOpen;
    bool public mysterySaleOpen;
    bool public regularSaleOpen;
    bool public giveawaysOpen;
    ...
    mapping(address => mapping(uint256 => uint256)) public accountGenesis1Keys;
    mapping(address => mapping(uint256 => uint256)) public accountGenesis2Keys;
    ...
    function initialize() public initializer {
        ...
        genesis1SaleOpen = true;
        genesis2SaleOpen = true;
        ...
        carMysterySaleSupply = 1000;

        //Regular Cars
        carSaleSupply[1] = 1000;
        carSaleSupply[2] = 1000;    
        carSaleSupply[3] = 1000;
        carSaleSupply[4] = 1000;
        carSaleSupply[5] = 1000;    
        carSaleSupply[6] = 1000;
        carSaleSupply[7] = 1000;
        carSaleSupply[8] = 1000;    
        carSaleSupply[9] = 1000;
        carSaleSupply[10] = 1000;
        carSaleSupply[11] = 1000;    
        carSaleSupply[12] = 1000;
        carSaleSupply[13] = 1000;
        carSaleSupply[14] = 1000;    
        carSaleSupply[15] = 1000;
        carSaleSupply[16] = 1000;
        carSaleSupply[17] = 1000;    
        carSaleSupply[18] = 1000;

        carSaleSupply[19] = 1000;
        carSaleSupply[20] = 1000;
        carSaleSupply[21] = 1000;    
        carSaleSupply[22] = 1000;
        carSaleSupply[23] = 1000;
        carSaleSupply[24] = 1000;    
        carSaleSupply[25] = 1000;
        carSaleSupply[26] = 1000;
        carSaleSupply[27] = 1000;    
        carSaleSupply[28] = 1000;

        carSaleSupply[29] = 1000;
        carSaleSupply[30] = 1000;
        carSaleSupply[31] = 1000;    
        carSaleSupply[32] = 1000;
        carSaleSupply[33] = 1000;
        carSaleSupply[34] = 1000;    
        carSaleSupply[35] = 1000;
        carSaleSupply[36] = 1000;
        carSaleSupply[37] = 1000;    
        carSaleSupply[38] = 1000;

        carSaleSupply[39] = 1000;
        carSaleSupply[40] = 1000;
        carSaleSupply[41] = 1000;    
        carSaleSupply[42] = 1000;
        carSaleSupply[43] = 1000;
        carSaleSupply[44] = 1000;    
        carSaleSupply[45] = 1000;
        carSaleSupply[46] = 1000;
        carSaleSupply[47] = 1000;    
        carSaleSupply[48] = 1000;
    }
    ...
    function addGenesis1Key(uint256 carType, uint256 qty, address recepient) external onlyRole(MINTER_ROLE){
        require(genesis1SaleOpen, "Genesis1 sale is closed");
        require(carSaleSupply[carType] - qty >= 0, "Not enough Supply");
        require(balanceOf(recepient)<= maxNFTOwnership, "Ownership limit exceeded!");
        require((accountTotalNFTPurchased[recepient] + qty <= maxNFTPurchase),"Purchase limit reached!");

        accountGenesis1Keys[recepient][carType] = accountGenesis1Keys[recepient][carType] + qty;
        accountTotalNFTPurchased[recepient] = accountTotalNFTPurchased[recepient] + qty;
        carSaleSupply[carType] = carSaleSupply[carType] - qty;
    }

    function addGenesis2Key(uint256 carType, uint256 qty, address recepient) external onlyRole(MINTER_ROLE){
        require(genesis2SaleOpen, "Genesis2 sale is closed");
        require(carSaleSupply[carType] - qty >= 0, "Not enough Supply");
        require(balanceOf(recepient)<= maxNFTOwnership, "Ownership limit exceeded!");
        require((accountTotalNFTPurchased[recepient] + qty <= maxNFTPurchase),"Purchase limit reached!");

        accountGenesis2Keys[recepient][carType] = accountGenesis2Keys[recepient][carType] + qty;
        accountTotalNFTPurchased[recepient] = accountTotalNFTPurchased[recepient] + qty;
        carSaleSupply[carType] = carSaleSupply[carType] - qty;
    }
    ...
    function useRareKey(uint256 count,uint256 carType) external {
        ...
        for(uint256 i=0;i < count;i++){
            ...
            emit carMinted(id,carType);
        }
    }

    function useGenesis1Key(uint256 count,uint256 carType) external {
        require((accountGenesis1Keys[msg.sender][carType] - count) >= 0,"Not enough key/s to use!");

        accountGenesis1Keys[msg.sender][carType] = accountGenesis1Keys[msg.sender][carType] - count;
    ...
    function useGenesis2Key(uint256 count,uint256 carType) external {
        require((accountGenesis2Keys[msg.sender][carType] - count) >= 0,"Not enough key/s to use!");

        accountGenesis2Keys[msg.sender][carType] = accountGenesis2Keys[msg.sender][carType] - count;
    ...
    function useMysteryKey(uint256 count) external {
        ...
        for(uint256 i=0;i < count;i++){
            ...
            attribute memory attr = attribute(carIdCounter.current(),carType,4);
            CARS[id] = attr;
            _safeMint(msg.sender, id);
            carIdCounter.increment();
    ...
    function useRegularKey(uint256 count,uint256 carType) external {
        ...
        for(uint256 i=0;i<count;i++){
            uint256 id = carIdCounter.current();
            attribute memory attr = attribute(carIdCounter.current(),carType,5);
            CARS[id] = attr;
            _safeMint(msg.sender, id);
            carIdCounter.increment();
    ...
    function useGiveAwayKey(uint256 count,uint256 carType) external {
        ...
        for(uint256 i=0;i<count;i++){
            uint256 id = carIdCounter.current();
            attribute memory attr = attribute(carIdCounter.current(),carType,6);
            CARS[id] = attr;
            _safeMint(msg.sender, id);
            carIdCounter.increment();
