...
contract SingleSell is  AccessControlEnumerable, Allowances {
    ...
    */
    ...
    ) external  
    {
        ...
        uint256 athleteRoyaltyFee = _loyalty(priceOfAuction,RoyaltiesAddress.getAthletefee(RoyaltiesAddress.getCategories(cardId)));
        uint256 fedrationRoyaltyFee = _loyalty(priceOfAuction,RoyaltiesAddress.getFedrationfee(RoyaltiesAddress.getCategories(cardId)));
        ...
        uint256 remaining_price=priceOfAuction.sub(athleteRoyaltyFee);
        ...
        if(_onionAuction[onionId].amountOnion() == 0){
