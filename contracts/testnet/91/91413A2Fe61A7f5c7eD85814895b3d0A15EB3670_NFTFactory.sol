...
contract NFTFactory is Governance, INFTFactory {
    ...
    function buy(uint256 quantity) public lock
    {
        ...
        require(_ruleProxys[0] != IGegoRuleProxy(address(0)), " invalid mint nftType!");
        ...
        mintErc20 = _ruleProxys[0].costMultiple(params, quantity);

        for (uint256 index = 0; index < quantity; index ++) {
            _randomNonce++;
            INFTSignature.Gego memory gego = _ruleProxys[0].generate(msg.sender, 0, _randomNonce);
            ...
            gego.amount = 0;
            gego.resBaseId = gego.resBaseId>0?gego.resBaseId:0;
            gego.tLevel = 0;
