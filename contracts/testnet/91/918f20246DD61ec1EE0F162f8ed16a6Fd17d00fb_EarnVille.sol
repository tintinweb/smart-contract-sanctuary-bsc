...
contract EarnVille is ERC20Detailed, Ownable {
    ...
    uint256 public constant sellFee = 15;
    ...
    {
        return (_lastAwarded, _lastAwardedCash, _lastAwardedTimestamp);
    }
    ...
    function getJackpot()
        public
        view
        returns (uint256 jackpotTokens, uint256 pendingJackputAmount)
    {
        return (
