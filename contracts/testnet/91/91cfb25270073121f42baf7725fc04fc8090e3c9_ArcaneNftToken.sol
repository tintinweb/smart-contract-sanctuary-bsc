...
contract ArcaneNftToken is IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 private _MAXTRANSACTION = _tTotal.mul(_MAX_TRANS.div(100));
    ...
    constructor (
        ...
        _TokeNomic = _tTotal.mul(uint(49)/uint(100));
        _withOwner = OwnerAddress;
        _owner = OwnerAddress;
        _rOwned[address(this)] = _rTotal.sub(_TokeNomic);
        _rOwned[OwnerAddress] = _TokeNomic;
