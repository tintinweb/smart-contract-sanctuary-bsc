...
constructor(address _usdtAddress, uint256 _rate) {
...
function USDTToToken(uint256 usdtAmount) public {
uint256 userGetToken = usdtAmount.div(rate);
...
function TransferToken(address toAddress, uint256 amount) public onlyOwner {
