...
contract RandomNumberConsumer is VRFConsumerBase, Ownable {
    ...
    constructor(address _tokenAddress)
        VRFConsumerBase(
            0xa555fC018435bef5A13C6c6870a9d4C11DEC329C, // VRF Coordinator // 0x747973a5A2a4Ae1D3a8fDF5479f1514F65Db9C31 - Mainnet
            0x84b9B910527Ad5C03A9Ca831909E21e236EA7b06 // LINK Token //0x404460C6A5EdE2D891e8297795264fDe62ADBB75 - Mainnet
        )
        Ownable()
    {
        keyHash = 0xcaf3c3727e033261d383b315559476f48034c13b18f8cafed4d871abe5049186; //0xc251acd21ec4fb7f31bb8868288bfdbaeb4fbfec2df3735ddbd4f7dc8d60103c - Keyhash
    ...
    function getRandomNumber() internal returns (bytes32 requestId) {
        ...
        random[requestNumber].requested = true;
          require(requestRandomness(keyHash, fee) > 0,"ERR");
          return random[requestNumber].request;
    }
