...
contract DeployVerifyTest is ERC20, Ownable {
  uint256 private initialSupply = 100000 * (10 ** 18);

  mapping(bool => mapping(address => bool)) public isExcludedFromFees;

  uint256 public sellFee = 1;
  uint256 public buyFee = 1;
  address public marketingWallet = 0x7c9768629C4A62A8f77D1Dd680c5eaD7EAAeE100;

  IUniswapV2Router02 public uniswapV2Router;
  address public uniswapV2Pair;

  constructor() ERC20("DeployVerifyTest", "DeployVerifyTest") {
    address _routerAddr;
    if (block.chainid == 56) {
