...
abstract contract baseContract is  IBEP20 , Auth {
    ...
    string public constant TOKEN_NAME = "Super Pig Token";
    string public constant TOKEN_SYMBOL = "SuperPig";  
...
contract  SuperPig  is baseContract { 
    using SafeMath for uint;  
    uint private constant MAX = ~uint(0);
...
//         marketingAddress = [0x2a86ec2430b95e88E8dFD230F00c16E0Dd2b999a];
//         marketingShare=[100];  
