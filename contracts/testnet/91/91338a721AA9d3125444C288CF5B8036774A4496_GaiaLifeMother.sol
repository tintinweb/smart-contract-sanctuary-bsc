...
import "../Commerce/interfaces/IMidasGoldKing.sol";
...
contract GaiaLifeMother is Initializable {
    ...
    function createNewToken(
        ...
        console.log("_isPayingWithNativeCurrency", _isPayingWithNativeCurrency);

        if (_isPayingWithNativeCurrency) {
            uint256 requiredEthAmount = uint256(
                midasGoldKing.getRequiredEthAmount()
            );
            console.log("requiredEthAmount", requiredEthAmount);
            ...
            console.log("requiredAmount", requiredTokenAmount);
...
contract Token is ERC20, ERC20Burnable, Ownable {
    ...
    uint256 public w2AddressPercent;
    uint256 public w3AddressPercent;
    uint256 public w4AddressPercent;
    uint256 public w5AddressPercent;
    ...
    constructor(
        ...
        _isExcludedFromFee[super.owner()] = true;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            super.owner(), // send lp tokens to owner
