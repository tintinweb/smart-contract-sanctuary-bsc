...
dev fee must be 2% of total accumulated fees! 
...
contract AA_BUNNY is Context, IERC20 { 
    ...
    */
    ...
    address public Wallet_Multi_Sig = 0xE12F3F4c48fAe15347Ea1c52b01aF7230d570b0d; // Used to verify ownership transfer // XXX 2

    address payable public Wallet_Marketing = payable(0xE12F3F4c48fAe15347Ea1c52b01aF7230d570b0d); // Marketing Wallet
    address payable public Wallet_Dev_Charity = payable(0x68e4dE396C4f7C0fE83F2C7bd5d883E0396c1fb7); // Development & Charity Wallet 
    address payable public Wallet_SolidityDev = payable(0x0123447F813F9AB49cf749ad57CdD2051A6C4604); // Solidity Developer
    address payable public Wallet_CakeLP = payable(0x6269c794291Af3A73FC5DC3E7E508716f750Ead4); // Auto Liquidity CakeLP Destination
    ...
    uint256 public percent_Dev_Charity    = 20;
    uint256 public percent_ContractDev    = 10;
    ...
    */
    ...
    constructor () {
        ...
        Contract_Developer = 0x627C95B6fD9026E00Ab2c373FB08CC47E02629a0;
    ...
    function Swap_Trigger_Count(uint256 number_of_transactions) external onlyOwner {
        ...
        emit E_Swap_Trigger_Count(number_of_transactions);
    }
    ...
    */
    ...
    function set_Fees(uint256 _Fee_Buy,
        ...
        require(_Fee_Buy    <= 15, "Buy fee too high");
        require(_Fee_Sell   <= 15, "Sell fee too high");
        require(_Fee_P2P    <= 10, "P2P fee too high");
    ...
    // Set the fee distribution percents - TOTAL MUST BE 90 as 10% goes to developer 
    function set_Fee_Distribution(uint256 _percent_Marketing,
        ...
        // Check total is 100
        require((_percent_Marketing + _percent_Liquidity + _percent_Development) == 90, "Total must be 90. 10% dev already included");

        // Update fee distribution percent
        percent_Marketing = _percent_Marketing;
        percent_Liquidity = _percent_Liquidity;
        percent_Dev_Charity = _percent_Development;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 BNB_D = returned_BNB * percent_Dev_Charity * 2 / fee_Split; 
        uint256 BNB_C = returned_BNB * 10 * 2 / fee_Split;

        // Take development and charity fee
        if(BNB_D > 0){sendToWallet(Wallet_Dev_Charity, BNB_D);}
