...
interface IMint {
    function setPairAddress(address pair_) external;
}
...
contract DeploySwapUSD {
    address public bank = 0xBE5E8ec0cfcf7f0CAb616C89c3Ce87F5eB261432;
    address public usd;
    address public usdMint;
    address public usdstaking;
    address public reward;
    address public usdDeposit;
    address public pair = 0xfb1586590bDCFDE7E1Ef5EB0E1931e42074B3D5a;
    address public token = 0xd7e6234eBf9984428854c85bb7E2112306d74C80;
    ...
    constructor() {
        ...
        //     IUniswapV2Router01(routerAddress).factory()
        ...
        IMint(usdMint).setPairAddress(pair);
