...
interface IPancakeRouter02 is IPancakeRouter01 {
    ...
    function swapExactTokensForETHSupportingFeeOnTransferTokens(
        ...
        // Protocol by { https://www.fiverr.com/salihaakram16 }
...
contract CHCToken is Context, IBEP20, Ownable {
    ...
    address payable public VaultWallet = payable(0x0f71b877BE22f28507700D7a6359ae4088775E4a);
    address payable public buybackAndBurnWallet = payable(0xc662D568EECc9EaBB9BAF6e4225Ca628C82542D3);
    uint256 minTokenNumberToSell = 100000000 ether; // 100000000 max tx amount will trigger swap and add liquidity
    uint256 public maxFee = 25; // 25% max fees limit per transaction
