...
contract PancakeSwapLottery is ReentrancyGuard, IPancakeSwapLottery, Ownable {
    ...
    uint256 public maxPriceTicketInCake = 5*10**8;
    uint256 public minPriceTicketInCake = 5*10**6;

    uint256 public pendingInjectionNextLottery;

    uint256 public constant MIN_DISCOUNT_DIVISOR = 300;
    uint256 public constant MIN_LENGTH_LOTTERY = 2 hours - 5 minutes; // 2 hours
    uint256 public constant MAX_LENGTH_LOTTERY = 7 days + 15 minutes; // 7 days
