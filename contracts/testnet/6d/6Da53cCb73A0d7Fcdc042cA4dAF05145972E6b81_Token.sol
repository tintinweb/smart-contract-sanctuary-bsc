...
contract Token is Initializable, UUPSUpgradeable, ERC20Upgradeable, ERC20PermitUpgradeable, ERC20VotesUpgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    function initialize(        
        ...
        __ERC20_init_unchained("TOKEN", "TOKEN");
        __Pausable_init_unchained();
        ERC20PermitUpgradeable.__ERC20Permit_init("TOKEN");
    ...
    */
    ...
    function deposit(uint256 _pid, uint256 _amount) public {
        ...
        if (user.amount > 0) {
            ...
            pool.lpToken.transfer(msg.sender, cultReward);
