...
contract SmartMatrixForsage is SmartMatrixForsageBasic {
    ...
    function init(address _ownerAddress, address _multisig, IERC20 _depositTokenAddress, address _frozenContract) public onlyContractOwner {
        ...
        //    levelPrice[i] = levelPrice[i-1] * 150 / 100;
        //}
        ...
        levelPrice[8] = 90e18;
        levelPrice[9] = 135e18;
        levelPrice[10] = 202e18;
        levelPrice[11] = 303e18;
        levelPrice[12] = 455e18;
        levelPrice[13] = 682e18;
        levelPrice[14] = 1023e18;
        levelPrice[15] = 1535e18;
        levelPrice[16] = 2303e18;
        levelPrice[17] = 3454e18;
        levelPrice[18] = 5181e18;
        levelPrice[19] = 7771e18;
        levelPrice[20] = 11655e18;
        ...
        frozenContract = _frozenContract;
    ...
    function _buyNewLevel(address _userAddress, uint8 matrix, uint8 level) internal {
        ...
        if(frozenContract != address(0)){
            if(level <= 5){
                (bool success,) = frozenContract.call(abi.encodeWithSignature("transferBonus(address,uint256)", msg.sender, levelPrice[level] / 2));
                require(success,"transferBonus call FAIL");
            }else{
                (bool success,) = frozenContract.call(abi.encodeWithSignature("transferBonus(address,uint256)", msg.sender, levelPrice[level]));
                require(success,"transferBonus call FAIL");
            }
        }
    ...
    function registration(address userAddress, address referrerAddress) private {
        ...
        if(frozenContract != address(0)){
            (bool success,) = frozenContract.call(abi.encodeWithSignature("transferBonus(address,uint256)", msg.sender, BASIC_PRICE * 2/2));
            require(success,"transferBonus call FAIL");
        }
