...
//        uint256 myLimit = 0;
    ...
    function _getMaxTokenAllowedToSell(address whoWantsToSell) private view returns(uint256 maxTokens, uint256 maxTokensFilter)  {
        ...
        reserve_a_initial = reserve_a_initial;
    ...
    function getMaxTokenAllowedToSell(address whoWantsToSell) external view onlyMetagold returns(uint256 maxTokens, uint256 maxTokensFilter)  {
