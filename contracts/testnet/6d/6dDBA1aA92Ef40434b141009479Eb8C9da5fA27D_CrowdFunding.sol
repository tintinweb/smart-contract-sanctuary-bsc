...
contract CrowdFunding is Ownable{
    ...
    function ransom(uint32 payNumber) public {
        ...
        if(playerMap[payNumber + 1].status == 2 || playerMap[payNumber + 2].status == 2 || playerMap[payNumber + 3].status == 2 || playerMap[payNumber + 4].status == 2){
