...
contract Ethnos {
    ...
    event PoolCreated(string _charity, address _treasury, uint _id);
    ...
    function addPool(string calldata _charity, address _treasury) public {
        _requireAdmin();
        ...
        emit PoolCreated(_charity, _treasury, id);
    }
