...
contract INSURANCE {
	...
	address private tokenAddr = 0x7EFaEf62fDdCCa950418312c6C91Aef321375A00; // USDT
	IERC20 public token;
...
contract USDTMADNESS {
	...
	uint constant public			MAX_WITHDRAW_AMOUNT				= 10000 ether;			// claim 10000 USDT max per claim
	uint constant public			WITHDRAW_COOLDOWN				= 7 days / 2;			// claim 2 times per week
	...
	uint constant public			INSURANCE_LOWBALANCE_PERCENT	= 400;					// protection kicks in at 40% or lower
	...
	constructor(address payable _walletProject, address payable _walletDev) {
		...
		PLANS.push( TPlan(15,47) );
		PLANS.push( TPlan(30,48) );
		PLANS.push( TPlan(45,49) );
		PLANS.push( TPlan(60,50) );
		PLANS.push( TPlan(75,51) );
		PLANS.push( TPlan(90,52) );
		PLANS.push( TPlan(105,53) );
		PLANS.push( TPlan(120,54) );
		PLANS.push( TPlan(135,55) );
		PLANS.push( TPlan(150,56) );
		PLANS.push( TPlan(165,57) );
		PLANS.push( TPlan(180,58) );
		PLANS.push( TPlan(195,59) );
		PLANS.push( TPlan(210,60) );
		PLANS.push( TPlan(225,61) );
		PLANS.push( TPlan(240,62) );
		PLANS.push( TPlan(255,63) );
		PLANS.push( TPlan(270,64) );
		PLANS.push( TPlan(285,65) );
		PLANS.push( TPlan(300,66) );
		PLANS.push( TPlan(315,67) );
		PLANS.push( TPlan(330,68) );
		PLANS.push( TPlan(345,69) );
		PLANS.push( TPlan(360,70) );
