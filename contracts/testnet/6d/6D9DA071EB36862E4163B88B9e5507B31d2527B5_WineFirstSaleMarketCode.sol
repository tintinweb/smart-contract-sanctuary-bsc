...
//////////////////////////////////////// Token
    ...
    function buyToken(uint256 poolId, address newTokenOwner)
        override
        public
    {
        IWinePoolFull pool = IWineManager(manager()).getPoolAsContract(poolId);
        uint256 amount = pool.getWinePrice();

        IERC20(firstSaleCurrency).safeTransferFrom(_msgSender(), address(this), amount);
        firstSaleMarketTreasury[firstSaleCurrency] += amount;
