...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    // Mapping from owner address to token ID when first mint
    mapping(address => uint256) private _take;
...
contract DasBabyGenesis is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _dasBabyCoin,address _layerZeroEndpoint) ERC721("DasBabyGenesis", "DasBabyGenesis") { 
        ...
        baseURI = baseURI_;
        dasBabyCoin = IERC20(_dasBabyCoin);
    }
