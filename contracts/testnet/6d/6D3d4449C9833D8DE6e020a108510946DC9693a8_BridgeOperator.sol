...
contract BridgeOperator is Ownable, Pausable {
    ...
    function bridgeEmission() external onlyOperator whenNotPaused {
        _bridgeEmission(address(this), address(0), "");
    }

    function bridgeEmission(bytes memory adapterParams) external onlyOperator whenNotPaused {
        _bridgeEmission(address(this), address(0), adapterParams);
    }
    ...
    function bridgeEmission(
        ...
        _bridgeEmission(refundAddress, zroPaymentAddress, adapterParams);
    }
