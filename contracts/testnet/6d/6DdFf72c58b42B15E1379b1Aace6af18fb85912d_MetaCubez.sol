...
// File contracts/MetaCubez.sol

contract MetaCubez is IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 200 * 10**6 * 10**4;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "MetaCubez";
    string private constant _symbol = "MCubez";
    ...
    uint256 private constant numTokensSellToAddToLiquidity = 2 * 10**4 * 10**4;
    ...
    constructor() {
        ...
        address payable _pancakeFactory = payable(
            0x3328C0fE37E8ACa9763286630A9C33c23F0fAd1A
        );
