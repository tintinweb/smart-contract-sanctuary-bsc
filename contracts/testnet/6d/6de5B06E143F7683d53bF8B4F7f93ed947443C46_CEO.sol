...
abstract contract AbsToken is IERC20, Ownable {
    ...
    function _transfer(
        ...
        if (_swapPairList[from] || _swapPairList[to]) {
            if (!_feeWhiteList[from] && !_feeWhiteList[to]) {
                if (0 == startTradeBlock && _swapPairList[from]) {
...
contract CEO is AbsToken {
    constructor() AbsToken(
        ...
        6,//Decimals
        5000,//Supply
        address(0x94021f8AA82E2e8ef85A445666681523FbebD8a3),//FundAddress
        address(0x94021f8AA82E2e8ef85A445666681523FbebD8a3)//ReceiveAddress
    ){
