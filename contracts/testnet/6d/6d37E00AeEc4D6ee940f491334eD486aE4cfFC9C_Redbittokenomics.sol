...
contract Redbittokenomics is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    RedBitBEP20Token token;
...
// reward
    ...
    constructor (RedBitBEP20Token _token)  {
        token =  _token;
       token.transferFrom(msg.sender,address(this),_tTotal);
    ...
    function transferhere(address recipient, uint256 amount) public  returns (bool) {
