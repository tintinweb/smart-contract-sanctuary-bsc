...
contract faizan is IERC20 {
    
    using SafeMath for uint256;

    string private _name = "faizan";
    string private _symbol = "faizan";
    ...
    // uint256 public _inbetweenFee_ = 700; // 4000 = 7%
