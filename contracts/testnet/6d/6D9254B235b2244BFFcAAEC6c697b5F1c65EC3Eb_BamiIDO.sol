...
contract BamiIDO is Ownable, ReentrancyGuard {
  ...
  uint256 public releaseStakeTime; // 1 month after
  ...
  constructor(
    ...
    modifier validReturnTokenTime() {
        require(releaseStakeTime < block.timestamp, "Time return BAMI invalid");
      _;
    }


  // Using TimeStamp
  function setTimeStake(uint256 _startStakeTime, uint256 _endStakeTime, uint256 _releaseStakeTime) public onlyOwner {
      require(_startStakeTime < _endStakeTime, "Input time staking invalid");
      require(_endStakeTime < _releaseStakeTime, "Input time staking invalid");


      startStakeTime = _startStakeTime;
      endStakeTime = _endStakeTime;
      releaseStakeTime = _releaseStakeTime;
  }
  ...
  function setIdoConfig(
    ...
    totalOfSlot = _totalOfSlot;
    totalOfUserStaked = _totalOfUserStaked;
    requireStakingToken = _requireStakingToken;
    feeBamiAmount = _feeBamiAmount;
  ...
  function stakeBamiGetSlot() public validStakeTime nonReentrant {
    require(blacklistMap[msg.sender] == false, "You are in Blacklist");
    require(totalOfUserStaked + 1 <= tokenPerSlot, "Full staking slot");
  ...
  function buyIdo() public validBuyTime nonReentrant {
  ...
  function claimIdo() public nonReentrant {
  ...
  function unstakeToken() public nonReentrant validReturnTokenTime {
  ...
  function nextStageInfo() public view returns (StageIdo memory stage) {
    uint256 currentIndexVesting = vestingMap[msg.sender];
    stage = stageList[currentIndexVesting];
  }
