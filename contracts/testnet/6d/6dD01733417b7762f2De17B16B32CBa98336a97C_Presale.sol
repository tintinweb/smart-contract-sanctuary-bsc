...
contract Presale is  Ownable, Pausable, ReentrancyGuard {
    ...
    uint256[3] public offeringPrice = [0.000000066666667e18, 0.0000001e18, 0.0000002e18];
    ...
    uint[2] public claimRelease = [600 /* launch date */,333 /* month release */];
    // Number of current sale
    uint[3] public currentSale;
    
    // Active status of the presale
    bool[3] public isPresaleActive = [true, true];
    // Active status of the claim
    bool[3] public isClaimActive = [true, true];
    ...
    function claim( uint _pSale, uint _saleID) external onlyPresales( _pSale) whenNotPaused nonReentrant {
        ...
        if(_usrInfo.lastClaimTime == 0) {
            _var._releaseAmount += (_usrInfo.balances*claimRelease[0])/10**4;
