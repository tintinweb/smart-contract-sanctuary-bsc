...
contract NanoNetwork is IBEP20, Auth {
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 500 / 10000; // 5%
    uint256 public _maxSellTxAmount = _totalSupply * 500 / 10000; // 5% 
    ...
    // Dead blocks
    uint256 deadBlocks = 4;

    // Sell amount of tokens when a sell takes place
    uint256 public swapThreshold = _totalSupply * 500 / 10000; // 5% of supply
    ...
    // seting the max wallet in percentages
    // NOTE: 1% = 100
