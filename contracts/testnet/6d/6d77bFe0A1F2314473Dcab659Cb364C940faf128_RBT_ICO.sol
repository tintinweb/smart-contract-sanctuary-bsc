...
contract RBT_ICO is Ownable {
  using SafeMath for uint256;
  Token token;

  uint256 public constant RATE = 3000; // Number of tokens per BNB
  uint256 public constant CAP = 5000; // Cap in BNB
  uint256 public constant START = 1651830465; //Thu May 06 2022 14:47:45  GMT+0500 (Pakistan Standard Time)
