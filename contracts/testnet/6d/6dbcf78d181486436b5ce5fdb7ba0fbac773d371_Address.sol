...
/**
 * @title The asyleum Token Vault contract for bounties.
...
// Root file: contracts/asyleumToken.sol
 ...
 */
contract AsyleumToken is ERC20, ERC20Burnable, ERC20Capped, Ownable {
    /**
    ...
    ) ERC20("Asyleum Token", "ASY") ERC20Capped(_maxSupply) {
