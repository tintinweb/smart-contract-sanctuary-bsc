...
contract TESTING11 is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xFA3E0C0AcC5840BB61C8f7f3A37547e2652610A3);
    address payable private _marketingAddress = payable(0x55583c4a035a0893bBe619084dC2A2a32DcDF364);
    
    string private constant _name = "TESTING111";
