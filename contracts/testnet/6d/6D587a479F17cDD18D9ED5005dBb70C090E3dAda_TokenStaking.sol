...
contract TokenStaking is Ownable {
    ...
    address public tt = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee;
    ...
    function toggleSale(bool _sale) external onlyOwner {
        hasStart = _sale;
    }
    ...
    function setTax(uint256 _refferalFee, uint256 _adminFee) external onlyOwner {
        require(_refferalFee >= 1000, "Fee is too low");
