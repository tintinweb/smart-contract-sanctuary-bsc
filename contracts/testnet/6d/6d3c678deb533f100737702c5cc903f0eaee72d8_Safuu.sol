...
contract Safuu is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Safuu", "SAFUU", uint8(DECIMALS)) Ownable() {
        ...
        treasuryReceiver = 0xe1B918219c7380583Dfda9D17f3A548032149ff5; 
    ...
    function rebase() internal {
        ...
        _gonsPerFragment = TOTAL_GONS.div(_totalSupply);
        _lastRebasedTime = _lastRebasedTime.add(times.mul(1));
    ...
    function shouldRebase() internal view returns (bool) {
        return
            ...
            msg.sender != pair  &&
            !inSwap &&
            block.timestamp >= (_lastRebasedTime + 1);
    }
