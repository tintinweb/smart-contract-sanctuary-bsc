    ...
    ReentrancyGuardUpgradeable
{
    ...
    // MXST Stake
    function stakeMSTToken(uint256 stakeAmount) external {
        ...
        if (_apr != 0) {
            ...
            uint256 endTime = investors[msg.sender].startTime + withdrawPeriod;
            // get All Claim
            ...
            if (endTime > block.timestamp) {
                uint256 totalTime = endTime - block.timestamp;
