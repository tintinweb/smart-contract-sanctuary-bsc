...
contract NFTCard is ERC721,ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("NFTCard", "NFTCard") {
    ...
    function claimNft(
        ...
        require(!_exists(id),"SN: NftCardID exist");
        bytes32 _msgHash = keccak256(
            abi.encodePacked(
                "\x19Ethereum Signed Message:\n32",
                keccak256(abi.encodePacked("SN_CARD_GENERATE", to, id))
            )
        );
