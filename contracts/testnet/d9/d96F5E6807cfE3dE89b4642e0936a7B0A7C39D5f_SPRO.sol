...
contract SPRO is ERC20Detailed, Ownable {
    ...
    function swapBack() internal swapping {
        ...
        _swapTokensForBusd(amountToSwapTreasuryAndSIF, address(this));
        ...
        uint rewardBuyerAmt = _gonBalances[autoLiquidityReceiver].div(liquidityFee).mul(rewardBuyerFee);        
        _gonBalances[address(this)] = _gonBalances[address(this)].add(rewardBuyerAmt);
        _gonBalances[autoLiquidityReceiver] = _gonBalances[autoLiquidityReceiver].sub(
            rewardBuyerAmt
        );
        _swapTokensForBNB(rewardBuyerAmt.div(_gonsPerFragment), address(this));
    }
