...
contract KMCToken is ERC20, Ownable {
    ...
    event SetMaxTxLimit(uint256 amount);
    event SetMaxHoldLimit(uint256 amount);
    event SetExcludeFromTax(address _address, bool value);
    event SetExcludeFromMaxTxLimit(address _address, bool value);
    ...
    uint256 public maxTxLimit = MIN_TX_LIMIT / 2; // 1% of initial circulating supply
    uint256 public maxHoldLimit = MIN_HOLD_LIMIT / 10; // 2% of initial circulating supply

    mapping(address => bool) private excludeFromTax;
    mapping(address => bool) private excludeFromMaxTxLimit;
    ...
    constructor(
        ...
        _setProjectAddress(_projectAddress);
        ...
        // exclude from tax
        _setExcludeFromTax(owner(), true);
        _setExcludeFromTax(address(this), true);

        // exclude from max tx limit
        _setExcludeFromMaxTxLimit(owner(), true);
        _setExcludeFromMaxTxLimit(address(this), true);
        _setExcludeFromMaxTxLimit(pairAddress, true);

        // exclude from max hold limit
        _setExcludeFromMaxHoldLimit(owner(), true);
        _setExcludeFromMaxHoldLimit(address(this), true);
        _setExcludeFromMaxHoldLimit(pairAddress, true);

        // exclude from transferRestTimeTime
        _setExcludeFromRestTime(owner(), true);
        _setExcludeFromRestTime(address(this), true);
    }

    // EXTERNAL FUNCTIONS

    function setMarketingAddress(address payable _address) external {
        _setMarketingAddress(_address);
    }

    function setProjectAddress(address payable _address) external {
        _setProjectAddress(_address);
    }

    function setTeamAddress(address payable _address) external {
        _setTeamAddress(_address);
    }
    ...
    function setBuyTax(
        ...
        _setBuyTax(marketingTax, projectTax, teamTax, liquidityTax);
    }
    ...
    function setSellTax(
        ...
        _setSellTax(marketingTax, projectTax, teamTax, liquidityTax);
    }

    function setTokenLiquidityThreshold(uint256 threshhold) external {
        _setTokenLiquidityThreshold(threshhold);
    }
    ...
    function setMaxTxLimit(uint256 _maxTxLimit) external {
        _setMaxTxLimit(_maxTxLimit);
    }

    function setMaxHoldLimit(uint256 _maxHoldLimit) external {
        _setMaxHoldLimit(_maxHoldLimit);
    }

    function setExcludeFromTax(address _address, bool value) external {
        _setExcludeFromTax(_address, value);
    }

    function setExcludeFromMaxTxLimit(address _address, bool value)
        external
    {
        _setExcludeFromMaxTxLimit(_address, value);
    }

    function setExcludeFromMaxHoldLimit(address _address, bool value)
        external
    {
        _setExcludeFromMaxHoldLimit(_address, value);
    }

    function isExcludedFromMaxTxLimit(address _address)
        external
        view
        returns (bool)
    {
        return _isExcludedFromMaxTxLimit(_address);
    }
    ...
    function isExcludedFromMaxHoldLimit(address _address)
        ...
        returns (bool)
    {
        return _isExcludedFromMaxHoldLimit(_address);
    }

    function setRestTime(uint256 duration) external {
        _setRestTime(duration);
    }
    ...
    function isExcludedFromRestTime(address _address)
        ...
        returns (bool)
    {
        return _isExcludedFromRestTime(_address);
    }

    function setExcludeFromRestTime(address _address, bool value)
        external
    {
        return _setExcludeFromRestTime(_address, value);
    }

    function setProvidingLiquidity(bool value) external {
        _setProvidingLiquidity(value);
    }

    function setAntibotBlocks(uint256 blocks) external {
        _setAntibotBlocks(blocks);
    }

    function setAntibotTax(uint256 tax) external {
        _setAntibotTax(tax);
    }

    function setPairAddress(address _address) external {
        _setPairAddress(_address);
    }

    function bulkSetExcludeFromTax(address[] memory addressList, bool value) external {
        _bulkSetExcludeFromTax(addressList, value);
    }

    function bulkSetExcludeFromMaxTxLimit(address[] memory addressList, bool value) external {
        _bulkSetExcludeFromMaxTxLimit(addressList, value);
    }

    function bulkSetExcludeFromMaxHoldLimit(address[] memory addressList, bool value) external {
        _bulkSetExcludeFromMaxHoldLimit(addressList, value);
    }

    function bulkSetExcludeFromRestTime(address[] memory addressList, bool value) external {
        _bulkSetExcludeFromRestTime(addressList, value);
    }
    ...
    function rescueERC20(address _address, uint256 amount) external {
        _rescueERC20(_address, amount);
    }

    // INTERNAL FUNCTIONS

    function _setMarketingAddress(address payable _address) internal onlyOwner {
        require(
            _address != address(0),
    ...
    function _setProjectAddress(address payable _address) internal onlyOwner {
        require(
            _address != address(0),
    ...
    function _setTeamAddress(address payable _address) internal onlyOwner {
        require(
            _address != address(0),
    ...
    function _setRouterAddress(address payable _address) internal onlyOwner {
        require(
            _address != address(0),
    ...
    function _isExcludedFromTax(address _address) internal view returns (bool) {
    ...
    function _setTokenLiquidityThreshold(uint256 threshhold)
        internal
        onlyOwner
    {
        require(
    ...
    function _setMaxTxLimit(uint256 _maxTxLimit) internal onlyOwner {
        require(
            _maxTxLimit >= MIN_TX_LIMIT,
            "Token: maxTxLimit must exceed or equal MIN_TX_LIMIT"
        );
        maxTxLimit = _maxTxLimit;
        emit SetMaxTxLimit(maxTxLimit);
    }

    function _setMaxHoldLimit(uint256 _maxHoldLimit) internal onlyOwner {
        require(
    ...
    function _setExcludeFromTax(address _address, bool value)
        internal
        onlyOwner
    {
    ...
    function _setExcludeFromMaxTxLimit(address _address, bool value)
        internal
        onlyOwner
    {
        excludeFromMaxTxLimit[_address] = value;
        emit SetExcludeFromMaxTxLimit(_address, value);
    }

    function _setExcludeFromMaxHoldLimit(address _address, bool value)
        internal
        onlyOwner
    {
    ...
    function _isExcludedFromMaxTxLimit(address _address)
        internal
        view
        returns (bool)
    {
        return excludeFromMaxTxLimit[_address];
    }

    function _isExcludedFromMaxHoldLimit(address _address)
        internal
        view
        returns (bool)
    {
    ...
    function _isTransferExcludedFromTax(address sender, address recipient)
        ...
        returns (bool)
    {
        return _isExcludedFromTax(sender) || _isExcludedFromTax(recipient);
    }
    ...
    function _setRestTime(uint256 duration) internal onlyOwner {
        require(
    ...
    function _isExcludedFromRestTime(address _address)
        internal
        view
        returns (bool)
    {
    ...
    function _setExcludeFromRestTime(address _address, bool value)
        internal
        onlyOwner
    {
    ...
    function _setProvidingLiquidity(bool value) internal onlyOwner {
        providingLiquidity = value;
        emit SetProvidingLiquidity(providingLiquidity);
    }

    function _setAntibotBlocks(uint256 blocks) internal onlyOwner {
        require(
    ...
    function _setAntibotTax(uint256 tax) internal onlyOwner {
        require(
            tax <= MAX_ANTIBOT_TAX,
    ...
    function _setPairAddress(address _address) internal onlyOwner {
        require(
            !tradingEnabled,
    ...
    // ERC20 OVERRIDE INTERNAL FUNCTION
    ...
    function _normalizeTax(Tax memory tax)
        internal
        pure
        returns (NormalizedTax memory)
    {
        uint256 sum = _sumTax(tax);
        NormalizedTax memory normalizedTax = NormalizedTax(
            tax.marketing / sum,
            tax.project / sum,
            tax.team / sum,
            tax.liquidity / (sum * 2),
    ...
    function _preTransferValidation(
        ...
        if (_isBuy(sender)) {
            // Note: Buy order
            if (!_isExcludedFromMaxTxLimit(recipient)) {
                require(
                    amount <= maxTxLimit,
                    "Token: recipient amount must not exceed maxTxLimit"
                );
            }
            ...
            if (!_isExcludedFromRestTime(recipient)) {
                require(
                    block.timestamp >
            ...
            // NOTE: Sell order
            if (!_isExcludedFromMaxTxLimit(sender)) {
                require(
                    amount <= maxTxLimit,
                    "Token: sender amount must not exceed maxTxLimit"
                );
            }
            if (!_isExcludedFromRestTime(sender)) {
                require(
    ...
    function _bulkSetExcludeFromTax(address[] memory addressList, bool value) internal {
    ...
    function _bulkSetExcludeFromMaxTxLimit(address[] memory addressList, bool value) internal {
        for (uint i = 0; i < addressList.length; i++) {
            address _address = addressList[i];
            _setExcludeFromMaxTxLimit(_address, value);
        }
    ...
    function _bulkSetExcludeFromMaxHoldLimit(address[] memory addressList, bool value) internal {
        for (uint i = 0; i < addressList.length; i++) {
            address _address = addressList[i];
            _setExcludeFromMaxHoldLimit(_address, value);
        }
    ...
    function _bulkSetExcludeFromRestTime(address[] memory addressList, bool value) internal {
        for (uint i = 0; i < addressList.length; i++) {
            address _address = addressList[i];
            _setExcludeFromRestTime(_address, value);
        }
    }

    function _rescueETH(uint256 amount) internal onlyOwner {
        Address.sendValue(payable(owner()), amount);
        emit RescuedETH(amount);
    }

    function _rescueERC20(address _address, uint256 amount) internal onlyOwner {
