...
contract ERC1155Tradable is ERC1155, ERC1155MintBurn, ERC1155Metadata, Ownable {
  ...
  uint256 private _maxTokenPerUser = 3;
  uint256 private _maxTokenPerMint = 10;
  uint256 private sold = 0;
  uint256 private reserved = 0;
  uint256 private presalesMaxToken = 3;
  uint256 private preSalesPrice1 = 0.2 ether;
  uint256 private preSalesPrice2 = 0.2 ether;
  uint256 private publicSalesPrice = 0.3 ether;
 ...
 */
contract SuperMisFitNFT is ERC1155Tradable {
  constructor(string memory _name)//address _proxyRegistryAddress)
  ERC1155Tradable(
    _name,
    "SMF"
  ) public {
    _setBaseMetadataURI("https://api.supermisfit.io/nft/");
  }
