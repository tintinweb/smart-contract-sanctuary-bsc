...
/* Token contract */
contract S_TOKEN is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "S_TOKEN";
    string constant _symbol = "S_TOKEN";
    ...
    function triggerManualBuyback(uint256 amountInWEI) external authorized {
        // uint256 amountWithDecimals = amount * (10**18);
        // uint256 amountToBuy = amountWithDecimals.div(10000);
        buyTokens(amountInWEI, DEAD);
    }
