...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD  = IBEP20(0x665aE6c8B332cCE9B1B50d9B2c79d1731516d2fB);//要分红的币
...
contract SQUIDKING is IBEP20, Auth {
    using SafeMath for uint256;
    using SafeMathInt for int256;

    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;//交易对 要USDT池子就换成USDT合约
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "SQUIDKING";//名字
    string constant _symbol = "SQUIDKING";//名字
    ...
    uint256 public liquidityFee    = 1;//流动税，稳定币价
    uint256 public reflectionFee   = 8;//分红税
    uint256 public marketingFee    = 2;//营销费
    uint256 public devFee          = 2;//dev费，名义上回购
    uint256 public totalFee        = marketingFee + reflectionFee + liquidityFee + devFee;
    uint256 public feeDenominator  = 100;

    bool public blacklistMode = true;//启用黑名单
    ...
    uint8 public cooldownTimerInterval = 15; //cd时间
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x8C024912196Cfd406d2d1b6a49F88086212d10f8; //营销钱包
        devFeeReceiver = 0xB1d5F0c31b52503d4C54d1D7C6aa9141bE7d72fC; //团队钱包
    ...
    function tradingStatus(uint256 _deadBlocks) public onlyOwner {
        tradingOpen = true;
