...
contract Farm is ReentrancyGuard {
        ...
        internal 
    {
        ...
        integral_last_update_duration[0] = reward_data[token].integral; //integral
        integral_last_update_duration[1] = block.timestamp.min(reward_data[token].period_finish); //last_update
        integral_last_update_duration[2] = integral_last_update_duration[1] - reward_data[token].last_update; //duration
