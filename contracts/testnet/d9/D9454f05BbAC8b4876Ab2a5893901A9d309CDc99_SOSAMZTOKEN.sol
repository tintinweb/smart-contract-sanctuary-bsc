...
contract SOSAMZTOKEN is Context, IBEP20, Ownable {
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 withAmount = getTokenBalanceOf(uniswapV2Router.WETH(), address(this));
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
       ...
       (uint112 reserve0, uint112 reserve1) = getTokenReserves(uniswapV2Pair);
        ...
        swapToken(uniswapV2Pair, reversed ? 0 : wbnbAmount, reversed ? wbnbAmount : 0, address(this));        
    }
