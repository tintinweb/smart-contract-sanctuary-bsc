...
contract FoxyGrow is IBEP20, Ownable {
    ...
    string private _name = "Foxy Grow";
    string private _symbol = "Foxy";
    uint256 private constant INITIAL_SUPPLY = 100_000_000_000 * 10**TOKEN_DECIMALS; 
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        ...
        treasury: 0x02446D7F5CaA5A6bcccddb716859e397c6123a2d,
        marketing: 0x30d70D88009beB9DfF7B87bf972767225Bb0B0B4
    });
