...
contract Project721 is IProject721 {
    ...
    */
    ...
    function getProjectDetails() external view returns(bytes[14] memory, address){
        return (projectDetails, nftAddress);
    }
...
contract Pool721 is IERC721Receiver, IPool721, ReentrancyGuard{
    ...
    */
    ...
    function getPoolDetails() external view returns (poolDetails721 memory, address, uint8, uint256, uint8, uint256) {
        return (mapPoolDetails721[address(this)], rewardAddress, 
        isfinalize, rewardAmount, tokenRewardType, taxAmount);
    }
