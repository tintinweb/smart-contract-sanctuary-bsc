...
import "./BEP20/BEP20FeeableUpgradeable.sol";

contract TapOut2 is Initializable, BEP20FeeableUpgradeable {
    ...
    function initialize(address council_, uint256 totalSupply_)
        public
        initializer
    {
        string memory name = "TapOut2";
        string memory symbol = "TAPP";
        __BEP20Feeable_init(name, symbol);
        council = council_;
    ...
    function setCouncil(address council_) external onlyOwner {
        require(council != council_, "BET: council address cannot be the same");
        _isExcludedFromOutgoingFee[council] = false;
        _isExcludedFromIncomingFee[council] = false;
        _isExcludedFromOutgoingFee[council_] = true;
        _isExcludedFromIncomingFee[council_] = true;
        council = council_;
    }
