...
contract SafeMoon is Context, IERC20, Ownable {
  ...
  uint256 public _maxTxAmount = 5000000 * 10**6 * 10**9; // 50^21 5000000000000000000000
  uint256 private numTokensSellToAddToLiquidity = 500000 * 10**6 * 10**9; // 50^20 500000000000000000000
  ...
  function setNumTokensSellToAddToLiquidity(uint256 token) external onlyOwner{
    numTokensSellToAddToLiquidity = token;
  }
