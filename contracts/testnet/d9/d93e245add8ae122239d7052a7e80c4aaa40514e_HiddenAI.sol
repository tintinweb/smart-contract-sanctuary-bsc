...
contract HiddenAI is IERC20, Ownable {
    using SafeMath for uint256;

    address constant ROUTER        = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;//= 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    ...
    uint256 smallSwapThreshold = _totalSupply * 2 / 1000; //.2%
    ...
    function changeMaxWallet(uint256 percent, uint256 denominator) external onlyOwner {
        require( percent >= 1, "Max wallet must be greater than 1%");
