...
abstract contract Privacy is MerkleTreeWithHistory, ReentrancyGuard {
...
contract PrivateChannel is Privacy {
  constructor(
    IVerifier _verifier,
    IHasher _hasher,
    uint256 _denomination,
    uint32 _merkleTreeHeight
  ) Privacy(_verifier, _hasher, _denomination, _merkleTreeHeight) {}
