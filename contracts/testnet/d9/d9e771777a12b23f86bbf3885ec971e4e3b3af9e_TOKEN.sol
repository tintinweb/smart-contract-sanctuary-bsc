...
contract TOKEN is Context, IERC20, Ownable {
    ...
    constructor() {
        ...
        _marketingWalletAddress = 0x3b3B78154078dBB7024EDFe66A4815C916429234;
    ...
    function setMaxBalance(uint256 maxBalance) external onlyOwner {
        _maxWalletBalance = maxBalance * 10**_decimals;
    }
    ...
    function _transfer(
            ...
            to != uniswapV2Pair) 
        {
            ...
            require(_isExcludedFromMaxWallet[to] || (currentBalance + amount <= _maxWalletBalance),
                    "ERC20: Balance is exceeding maxWalletBalance");
        }
