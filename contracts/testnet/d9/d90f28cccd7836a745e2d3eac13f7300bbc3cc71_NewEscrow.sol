...
contract NewEscrow is ERC165 {
    ...
    function buyNowPayment(
        ...
        ) = _order.nftCollection.ownerOfToken(_order.tokenId);
    ...
    function putOnSaleBuy(
        ...
        return placeSecondHandOrder(_tokenId, _editionNumber, _pricePerNFT, 2, _nftCollection);
    }
    ...
    function requestOffer(
        ...
        return placeSecondHandOrder(_tokenId, _editionNumber, _pricePerNFT, 3, _nftCollection);
    }
