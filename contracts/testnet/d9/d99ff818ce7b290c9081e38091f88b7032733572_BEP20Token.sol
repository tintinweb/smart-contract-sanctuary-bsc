...
contract BEP20Token is Context, IBEP20, Ownable {
    ...
    string private _name = "Doge Girl Coin";
    string private _symbol = "DGC";
    uint8 private _decimals = 9;
    
    uint256 public _liquiditySellFee = 3;                           // Liquidity Fee to sell
    uint256 public _liquidityBuyFee = 3;                            // Liquidity Fee to buy

    uint256 public _rewardSellFee = 4;                              // Reflected reward Fee to sell
    uint256 public _rewardBuyFee = 4;                               // Reflected reward Fee to buy

    uint256 public _marketingSellFee = 2;                           // Marketing Fee percent to sell
    uint256 public _marketingBuyFee = 2;                            // Marketing Fee percent to buy

    uint256 public _charitySellFee = 0;                             // Charity Fee percent to sell
    uint256 public _charityBuyFee = 0;                              // Charity Fee percent to buy

    uint256 public _burnSellFee = 2;                                // Burn Fee percent to sell
    uint256 public _burnBuyFee = 2;                                 // Burn Fee percent to buy
    ...
    constructor () {
        ...
        IPancakeswapV2Router02 _pancakeswapV2Router = IPancakeswapV2Router02(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); // mainnet router
