...
contract ERC20 is IERC20 {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require(!frozen[sender] && !frozen[msg.sender], "address frozen");
    ...
    function isFreezed(address _addr) public view returns (bool) {
      return frozen[_addr];
    }
...
// File: contracts\ERC20\LiboToken.sol
...
/**
 * @title LiboToken
 * @author LiboToken (visit https://LiboToken.com)
 *
 * @dev Standard ERC20 token with burning and optional functions implemented.
 * For full specification of ERC-20 standard see:
 * https://github.com/ethereum/EIPs/blob/master/EIPS/eip-20.md
 */
contract LiboToken is ERC20 {
