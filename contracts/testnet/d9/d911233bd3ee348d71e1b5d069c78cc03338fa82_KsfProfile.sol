...
// File: @ksfswap/ksfswap-lib/contracts/token/BEP20/IBEP20.sol
...
*/
contract KsfProfile is AccessControl, ERC721Holder {
    using Counters for Counters.Counter;
    using SafeBEP20 for IBEP20;
    using SafeMath for uint256;

    IBEP20 public ksfToken;
    ...
    uint256 public numberKsfToReactivate;
    uint256 public numberKsfToRegister;
    uint256 public numberKsfToUpdate;
    ...
    constructor(
        IBEP20 _ksfToken,
        uint256 _numberKsfToReactivate,
        uint256 _numberKsfToRegister,
        uint256 _numberKsfToUpdate
    ) public {
        ksfToken = _ksfToken;
        numberKsfToReactivate = _numberKsfToReactivate;
        numberKsfToRegister = _numberKsfToRegister;
        numberKsfToUpdate = _numberKsfToUpdate;
        _setupRole(DEFAULT_ADMIN_ROLE, _msgSender());
    }

    /**
     * @dev To create a user profile. It sends the NFT to the contract
     * and sends KSF to burn address. Requires 2 token approvals.
     */
    ...
    function updateProfile(address _nftAddress, uint256 _tokenId) external {
        ...
        // Transfer KSF token to this address
        ksfToken.safeTransferFrom(
            _msgSender(),
            address(this),
            numberKsfToUpdate
    ...
    /**
     * @dev Claim KSF to burn later.
     * Callable only by owner admins.
     */
    function claimFee(uint256 _amount) external onlyOwner {
        ksfToken.safeTransfer(_msgSender(), _amount);
    }
    ...
    /**
     * @dev Update the number of KSF to register
     * Callable only by owner admins.
     */
    function updateNumberKsf(
        uint256 _newNumberKsfToReactivate,
        uint256 _newNumberKsfToRegister,
        uint256 _newNumberKsfToUpdate
    ) external onlyOwner {
        numberKsfToReactivate = _newNumberKsfToReactivate;
        numberKsfToRegister = _newNumberKsfToRegister;
        numberKsfToUpdate = _newNumberKsfToUpdate;
    }
