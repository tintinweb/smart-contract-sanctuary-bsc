...
contract BabyPaulTokenTest is ERC20Permit, IOHM, OlympusAccessControlled {
    using SafeMath for uint256;

    constructor(address _authority) 
    ERC20("BabyPaulTest", "BPT01", 9) 
    ERC20Permit("BabyPaulTest") 
    OlympusAccessControlled(IOlympusAuthority(_authority)) {       
        
        _mint(_authority, 20000000000000000); 
