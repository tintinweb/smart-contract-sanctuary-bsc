...
contract Richdotcoin is Context, IERC20, Ownable {
    ...
    uint256 private _mintweight = ((100000/_tTotal)* _tTotal**3) / (7*(300*(_tTotal/100000))* (100001* 10**18 - _tTotal)**2); //difficulty of newcoins minted in transfers = TransferAmount/mintweight
    ...
    function _transfer(
        ...
        _mintweight = ((100000/_tTotal)* _tTotal**3) / (7*(300*(_tTotal/100000))*(100001* 10**18 - _tTotal)**2);
