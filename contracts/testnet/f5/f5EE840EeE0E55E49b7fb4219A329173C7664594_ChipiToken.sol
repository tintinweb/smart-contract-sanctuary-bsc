...
//
// Copyright of Chipino
// chipino.xyz
//
// Inspired by the Rainbow Protocol/Token: https://rainbowtoken.finance/
// 
...
/**
 * @dev The official ChipiToken smart contract
 */
contract ChipiToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "ChipiToken";
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x75a10bDD29F3D743318610F81E1B98DC29914317); // Marketing address used to pay for marketing
    address payable public _distributorAddress = payable(0x75a10bDD29F3D743318610F81E1B98DC29914317); // distributor address for rewards
    ...
    function setDistributorAddress(address distributorAddress) external onlyOwner() {
        _distributorAddress = payable(distributorAddress);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts CHIPI balance for buybacks, charity, liquidity, marketing, and distributor
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        uint256 marketingDistributorBNB = receivedBNB.div(7).mul(2);
        
        // Send the remaining BNB to the marketing wallet
        transferBNBToAddress(_marketingAddress, marketingDistributorBNB);
        transferBNBToAddress(_distributorAddress, marketingDistributorBNB);
