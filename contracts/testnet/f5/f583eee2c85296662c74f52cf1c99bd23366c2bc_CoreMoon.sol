...
contract CoreMoon is limitIsTrading, minEnable, minEnableMetadata {
    ...
    string private txLaunch = "Core Moon";

    mapping(address => bool) public amountAuto;

    string private totalLimit = "CMO";
    ...
    constructor (){
        ...
        //tradingMaxLaunch marketingTo = tradingMaxLaunch(0x802B587b459e5ea8968602a50C538Bdf1303418B);
