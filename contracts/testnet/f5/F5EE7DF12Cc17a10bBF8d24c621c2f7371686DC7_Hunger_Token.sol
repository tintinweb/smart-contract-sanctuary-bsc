...
contract Hunger_Token is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000 *  10 ** 18; //100Billion
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Hunger Token";
    ...
    uint public _charityFee = 4;
    address public charityWallet = 0x733AbC81C7Cae004Ea158D3704aF03AfDBac304a;

    uint256 public _marketingFee = 2;
    address public marketingWallet = 0x9ae22a0AD92bb8dAdfA60BB7bb29Ff97Afc95293;
    ...
    uint256 public _maxTxAmount = 50000000000 * 10**18; //50 Billion
 ...
 function _beforeTokenTransfer(address from, address to, uint256 amount) internal virtual { }
    ...
    function setMarktingFeePercent(uint256 marketingFee) external onlyOwner() {
