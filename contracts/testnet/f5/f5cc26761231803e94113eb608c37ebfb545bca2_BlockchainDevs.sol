...
contract BlockchainDevs is ERC721Enum, Ownable, ReentrancyGuard {
    ...
    address private dev = 0xf6D14956e5c77390C8367CCDbcb5b845244365dE;
	//presale settings
    ...
    //giveAway
   	function giveAway(address _address) external onlyOwner{
    uint256 s = totalSupply();
	for (uint256 i = 0; i < 50; ++i) {
	_safeMint(_address, s++, "");
	}	
    delete s;	
    }
    function bridgeMint(address _address, uint256 tokenId) external {
