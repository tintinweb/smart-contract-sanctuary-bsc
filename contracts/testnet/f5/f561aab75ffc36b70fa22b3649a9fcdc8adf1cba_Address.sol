...
contract SwapDust is Context, IERC20 { 
    ...
    address payable public Wallet_Development = payable(0x681C8ea8AcA5C280596Fa5cb462C742038CDE495); 
    address payable public Wallet_Team = payable(0x5412eb952d1a8F2876f40a355B2B3922942FE7Ba);
    address payable public constant Wallet_Burn = payable(0x000000000000000000000000000000000000dEaD); 
    address payable public constant Lp_Reciever = payable(0xa27352b6C9Cc229B7FccDfb559bd646147f4532f); 
    

    uint256 private constant MAX = ~uint256(0);
    uint8 private constant _decimals = 9;
    uint256 private _tTotal = 1000000000 * 10**_decimals;
    string private constant _name = "Swap Dust"; 
    ...
    uint256 public Percent_Development = 70;
    ...
    constructor () {
        ...
        _owner = 0xa27352b6C9Cc229B7FccDfb559bd646147f4532f;
