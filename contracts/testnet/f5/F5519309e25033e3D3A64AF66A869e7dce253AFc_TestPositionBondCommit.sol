...
import "./MockPositionBondCommit.sol";

contract TestPositionBondCommit is MockPositionBondCommit {
    // MOCK VARIABLES
    bool _canPurchase;
    uint256 _issuePrice;
    uint256 _bondAmount;
    ...
    constructor(
        ...
        TestHoldTokenAndStake(holdToken_, minAmount_)
    {}
    ...
    function convertAmountStakeCanCommit(address holder)
        public
        override(TestHoldTokenAndStake)
        view
        returns (uint256)
    {
        return _maxCommit;
    ...
    function setMockMaxCommit(uint256 maxCommit) public {
        _maxCommit = maxCommit;
    }
}
...
import "./TestHoldTokenAndStake.sol";
...
abstract contract MockPositionBondCommit is
    Issuer,
    BondStatus,
    UnderlyingAsset,
    TestHoldTokenAndStake,
    FaceAsset,
    SaleStrategyBase,
    BondUnit,
    IPositionBondCommit,
    ReentrancyGuard
{
    ...
    function _beforeCommitHook(address _buyer, uint256 _commitAmount)
        internal
        virtual
    {}
...
abstract contract TestHoldTokenAndStake {
