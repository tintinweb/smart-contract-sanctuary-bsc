...
contract SPACEFI is BEP20, Auth {
    ...
    uint256 public constant totalSupply = 90 * 10**6 * 10**decimals;
    ...
    bool public initialDistributionMode = true;
    ...
    uint256 sellMultiplier = 90;
    uint256 buyMultiplier = 110;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x702dc95EC7cF53Be39195dBAbf351320DC5D3e6B;
        pipdFeeReceiver =  0x702dc95EC7cF53Be39195dBAbf351320DC5D3e6B;
        teamFeeReceiver = 0x702dc95EC7cF53Be39195dBAbf351320DC5D3e6B;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        if(!authorizations[sender] && !authorizations[recipient]){
            require(!initialDistributionMode,"Presale not over yet");
        }
    ...
    function takeitlive() external onlyOwner {
        initialDistributionMode = false;
        emit config_initialDistributionMode(initialDistributionMode);
    }
...
event config_initialDistributionMode(bool Status);
