...
contract GAWStaking is Context, Ownable {
    using SafeMath for uint256;
    
    struct UserInfo {
        uint256 _amountDeposite; // How many LP tokens the user has provided.
        uint256 _timeDeposite;
    }

    // struct PoolInfo {
    //     uint256 _totalUserStake; // How many LP tokens the user has provided.
    //     uint256 _totalTokenStake;
    // }

    mapping(address => UserInfo) private _userInfoMap;

    address private _tokenReward = 0x7710fc9F64e8AfAD6A6f2314ed43aE84cb6d9A9e;
