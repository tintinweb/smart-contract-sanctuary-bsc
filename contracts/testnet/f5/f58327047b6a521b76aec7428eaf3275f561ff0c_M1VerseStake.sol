...
contract M1VerseStake {
    ...
    uint256[4] public Duration = [10 minutes, 15 minutes, 20 minutes, 30 minutes];
    uint256[4] public Bonus = [6, 13, 20, 45];
    ...
    function unstake(uint256 index) external {
        ...
        require(!stakersRecord[msg.sender][index].unstaked, "already unstaked");
        require(
            (stakersRecord[msg.sender][index].initiateUnstakeTime +  (5*oneDay)) < block.timestamp,
