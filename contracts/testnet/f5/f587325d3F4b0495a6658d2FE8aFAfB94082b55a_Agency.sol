...
contract Agency is OwnPauseBase {
  ...
  constructor(
    ...
    _defaultAgencyMetadata.animation_url = defaultAgencyImage_;
  ...
  function setAgencyMetadata(
    ...
    string memory animation_url // can be empty string if the agency does not wanna specify the default image
  ) external isAuthorized {
    ...
    emit EvtSetAgencyMetadata(agencyId_, name_, description_, animation_url);
  }

  function setAgencyMultiMetadata(
    string memory agencyId_,
    string memory metadataType_, // "hotel", "flight", "activity"
    string memory name_,
    string memory description_,
    string memory animation_url // can be empty string if the agency does not wanna specify the default image
  ) external isAuthorized {
