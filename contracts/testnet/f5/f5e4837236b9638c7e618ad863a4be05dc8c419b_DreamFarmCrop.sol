...
contract DreamFarmCrop is INft, Context, ERC165, IERC721, IERC721Metadata, IERC721Receiver, Ownable {
    ...
    constructor()
    {
        ...
        drfToken = token(0x6b64AcA5A9Fd61Ae2dBaA4Ff2C494e5d86cA0597);
    }
    ...
    function buy(address to, uint amount, uint256 price) public {
        ...
        bool trans = drfToken.transferFrom(msg.sender, address(0x6b64AcA5A9Fd61Ae2dBaA4Ff2C494e5d86cA0597), requiredValue);
