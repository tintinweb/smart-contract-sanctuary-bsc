...
contract Refer is OwnableUpgradeable {
    ...
    function initialize() initializer public {
        ...
        referRate = [0, 2, 3, 4, 5, 6, 7];
        referAmountRate = [0, 20000 ether, 50000 ether, 200000 ether, 50000 ether, 1500000 ether, 5000000 ether];
        levelRewardRate = [0, 10, 20, 30, 40, 50, 60];
        isRefer[address(this)] = true;
    }

    function setOPT(address addr) external onlyOwner {
        opt = IERC20Upgradeable(addr);
    }
