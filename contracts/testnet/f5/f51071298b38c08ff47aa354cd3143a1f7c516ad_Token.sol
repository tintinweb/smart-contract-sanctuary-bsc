...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "O21";
    string private _symbol = "O21";
    uint8 private _decimals = 18;

    uint256 public _burnFee = 80;
    ...
    constructor() public {
        ...
        _balances[ownerAddress] = 210000000 * 10**18;
        _totalSupply = 210000000 * 10**18;

        transferOwnership(ownerAddress);

        emit Transfer(address(0), ownerAddress, 210000000 * 10**18);
    }
    ...
    function setBlockBuy(bool _blockBuy) public onlyOwner {
        blockBuy = _blockBuy;
    }
    ...
    function calculateBurnFee(uint256 _amount) private view returns (uint256) {
        if (_balances[burnAddress] >= 189000000 * 10 ** 18) return 0;
