...
contract SmartChefFactory is Ownable {
    ...
    address[] public smartchefAddressList;
    ...
    function deployPool(
        ...
        bytes32 salt = keccak256(abi.encodePacked(_stakedToken, _rewardToken, _startBlock,block.timestamp));
        ...
        smartchefAddressList.push(smartChefAddress);
        poolCount = smartchefAddressList.length;
