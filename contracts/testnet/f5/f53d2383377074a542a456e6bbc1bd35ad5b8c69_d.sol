...
contract d is IBEP20, Auth {
    ...
    function changeTxLimit(uint256 newLimit) external authorized {
        ...
        require(newLimit >= 1000000 * 10 ** _decimals); // Max Tx amount cannot be lower or equal to 0.1% of Total Supply
    }
    ...
    function changeWalletLimit(uint256 newLimit) external authorized {
        _walletMax  = newLimit;
        require(newLimit >= 10000000 * 10 ** _decimals); // Max Wallet amount cannot be bigger or equal to 1% of Total Supply
    }
    ...
    function changeIsTxLimitExempt(address holder, bool exempt) external authorized {
        require(isTxLimitExempt[marketingWallet] = true);
        isTxLimitExempt[holder] = exempt;
    }

    function changeIsMaxWalletExempt(address holder, bool exempt) external authorized {
        require(isMaxWalletExempt[marketingWallet] = true);
        isMaxWalletExempt[holder] = exempt;
    }
