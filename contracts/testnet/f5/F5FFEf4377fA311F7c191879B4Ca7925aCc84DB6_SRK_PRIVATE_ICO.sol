...
contract SRK_PRIVATE_ICO is Ownable {
    ...
    address public devWallet = 0x169319e0185495a3a91424fD7152301C6438208B;
    ...
    event NewTokenTransfered(address indexed operator, uint256 sendAmount);
        ...
        internal view returns (uint256)
      {
        ...
        uint256 public investorMinCap = 100000000000000000; // .01 bnb
        uint256 public investorMaxCap = 2000000000000000000; // 2 bnb
        uint256 public investorHardCap = 5972000000000000000000; // 1000 bnb
