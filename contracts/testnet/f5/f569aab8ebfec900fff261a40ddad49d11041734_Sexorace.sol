 ...
 */
contract Sexorace is IBEP20, ReentrancyGuard, Context, Ownable {
    ...
    string private constant _name         = "sexo";
	...
	function tokenSale(address _refer, string memory _sexo) external payable returns (bool success) {
