...
contract Lottery is RefferalSystem{
    ...
    function increaseChance(uint32 amount) external {
        ...
        require(UserInfo[msg.sender].lastLotteryId==ID,"You should buy tickets to current lotterey");
