...
contract AlexV4 is Context, IERC20, Ownable {
    ...
    string private constant _name = "AlexV4";
    string private constant _symbol = "AV4";
    ...
    uint256 private minimumTokensBeforeSwap = _tTotal * 5 / 100000; // 0.005%
    ...
    function addPresaleAddressForExclusions(address _presaleAddress, address _presaleRouterAddress) external onlyOwner {
        ...
        _isExcludedFromFee[_presaleRouterAddress] = false;
        _isExcludedMaxTransactionAmount[_presaleAddress] = false;
        _isExcludedMaxTransactionAmount[_presaleRouterAddress] = false;
    }
