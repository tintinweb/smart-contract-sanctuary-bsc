...
contract HeadsTails is Ownable, ReentrancyGuard {
    ...
    * @param questionId question id
    **/
    function unstake(uint256 questionId) external nonReentrant  {
        Question storage question = questionList[questionId];
        StakeInfo storage stakeInfo = stakingList[msg.sender][questionId];
    ...
    * @param questionId question id
    **/
    function harvest(uint256 questionId) external nonReentrant {
        Question storage question = questionList[questionId];
        StakeInfo storage stakeInfo = stakingList[msg.sender][questionId];
