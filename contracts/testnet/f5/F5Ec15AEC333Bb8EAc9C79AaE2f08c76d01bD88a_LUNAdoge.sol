...
contract LUNAdoge is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x607c21F607e60A5d889F3f235bE9bDE38736A90d));
        marketingWalletAddress = payable(address(0x3B4B81a067527F2B17b9cA76569372732735d04c));
