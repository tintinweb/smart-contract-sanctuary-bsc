...
contract MetaHypeWorld is IERC20 {
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0xC56e77E3cB90c7C731f10A43968b3bA26515B4a8),
        development: payable(0x67BC73Ec90cf5bEE0B8ab74850c480710a4Cf6B8),
        marketing2: payable(0x4E97c3cD28A6cE3Af0f0fd248Dee1a1C00CB39f4)
        });
...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 development, uint16 marketing2) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.marketing2 = marketing2;
        _ratios.development = development;
        _ratios.total = liquidity + marketing + development + marketing2;
    }
    ...
    function setWallets(address payable marketing, address payable development, address payable marketing2) external onlyOwner {
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketing2Balance = (amtBalance * ratios.marketing2) / ratios.total;
        uint256 marketingBalance = amtBalance - (developmentBalance + marketing2Balance);
        if (ratios.development > 0) {
            _taxWallets.development.transfer(developmentBalance);
        }
        if (ratios.marketing2 > 0) {
            _taxWallets.marketing2.transfer(marketing2Balance);
        }
