...
Buy/Sell Tax: 6/6%
Breakdown: (2% marketing & development, 2% liquidity and 2% reflection in BasicBoy)
MAX_Wallet / MAX_TX = 1 % for now, will be changed.
...
contract XXX is IERC20, Ownable {
    ...
    uint256 _totalSupply = 42_000_000_000 * (10 ** _decimals);
