...
contract bdbd is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    string private _name = "bdbd";
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x9a3FB39474ce6c197cdF1FcD750E4CaAB0a5CAfF));
        marketingWalletAddress = payable(address(0x9a3FB39474ce6c197cdF1FcD750E4CaAB0a5CAfF));
