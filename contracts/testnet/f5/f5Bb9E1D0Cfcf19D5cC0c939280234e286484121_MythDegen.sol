...
contract MythDegen is ERC721 {
    ...
    mapping(uint256 => stats) private degenStats;
    mapping(uint256 => gear) private degenGear;
    mapping(uint256 => cosmetics) private degenCosmetics;
    mapping(uint256 => mods) private degenMods;
    ...
    constructor() ERC721("Myth City Degen", "MYDG") {
        tokenCount = 0;
        owner = msg.sender;
        defaultBackground = "https://gateway.pinata.cloud/ipfs/QmcnL4RzSkiSUtcQ7BYwnKcQhALaPcBcNTKRhCQ4Bi4cHJ";
        defaultEye = "https://gateway.pinata.cloud/ipfs/QmYXtDE7SLP5dast23ZGaKEQshGZW4F6wPcF6ePWXBabrg";
        defaultMouth = "https://gateway.pinata.cloud/ipfs/QmVczJqbTdH7DeuRLSyqxEYmmVg2DLhoNrxEzXzjxGWL98";
        defaultSkinColor = "https://gateway.pinata.cloud/ipfs/QmYJm46xrt7cX8XZjT9QnkT9Fe8kUcbLffc9bwTULbhCAX";
