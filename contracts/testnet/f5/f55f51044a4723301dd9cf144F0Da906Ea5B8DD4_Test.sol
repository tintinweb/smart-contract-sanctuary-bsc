...
contract Test is ERC1155Supply, Ownable {
    ...
    bool public marketingTokenMinted = false;
    ...
    function mintMarketingPass() external onlyOwner {
        require(!marketingTokenMinted, "Marketng Passes are already minted");
        _mint(msg.sender, TOKEN_ID, MARKETING_TOKENS, "");
        marketingTokenMinted = true;
    }
