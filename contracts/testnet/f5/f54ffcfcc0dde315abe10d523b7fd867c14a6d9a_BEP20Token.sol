...
//HÀM TỰ TẠO VÀ HÀM THAY ĐỔI
// có thể viết thêm hàm mới nhưng mà không thể thiếu các hàm quy định sẵn, nếu không sẽ không deploy được 
  function receiveToken(uint256 amount) external payable returns (bool) {
    ...
    //từ phía người sở hữu contract chuyển 1 lượng token tương ứng cho người gọi hàm
    return true;
  }
