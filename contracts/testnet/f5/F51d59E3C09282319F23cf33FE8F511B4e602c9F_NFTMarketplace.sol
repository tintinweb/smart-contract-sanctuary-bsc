...
contract NFTMarketplace is Ownable, ERC721Holder {
    ...
    event ItemPriceUpdated(uint256 itemID, address owner, address sender, uint256 itemPrice);
    ...
    function delistItem(uint256 itemID) external onlyOwnerOrMarket(itemID) {
    ...
    function updateItemPrice(uint256 itemID, uint256 newPrice) external onlyOwnerOrMarket(itemID) {
        ...
        emit ItemPriceUpdated(itemID, items.ownerOf(itemID), _msgSender(), newPrice);
