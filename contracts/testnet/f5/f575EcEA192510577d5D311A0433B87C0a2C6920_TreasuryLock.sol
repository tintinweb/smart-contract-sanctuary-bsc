...
contract TreasuryLock is Ownable {
    address public usdtAddress;
    address public tokenAddress;
    address public multSigAddress;

    constructor(address _multSigAddress, address _usdtAddress, address _tokenAddress) public {
    ...
    function withdrawToken(address to, uint256 amount) public onlyMultSig {
