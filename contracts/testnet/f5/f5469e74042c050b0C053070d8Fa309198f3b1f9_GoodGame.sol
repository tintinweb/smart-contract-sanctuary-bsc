...
contract GoodGame {
    ...
    function closeTable() internal {
        ...
        for (uint256 i = 1;i < levlToIdToTable[adrToInfo[msg.sender].level][adrToInfo[msg.sender].tableId].userCount;i++) {
            levlToAmount[adrToInfo[msg.sender].level]++;
            levlToIdToTable[adrToInfo[msg.sender].level][levlToAmount[adrToInfo[msg.sender].level] + 1].leader = levlToIdToTable[adrToInfo[msg.sender].level][levlToAmount[adrToInfo[msg.sender].level]].users[i];
            levlToIdToTable[adrToInfo[msg.sender].level][levlToAmount[adrToInfo[msg.sender].level] + 1].tableId = levlToAmount[adrToInfo[msg.sender].level];
            isParticipated[levlToIdToTable[adrToInfo[msg.sender].level][adrToInfo[msg.sender].tableId].leader] = true;
            ...
            adrToInfo[levlToIdToTable[adrToInfo[msg.sender].level][levlToAmount[adrToInfo[msg.sender].level]].users[i]].tableId = levlToAmount[adrToInfo[msg.sender].level];
            adrToInfo[levlToIdToTable[adrToInfo[msg.sender].level][levlToAmount[adrToInfo[msg.sender].level]].users[i]].payment = levlToPayment[adrToInfo[msg.sender].level + 1];
        }
    }
    ...
    {
        return (
            levlToIdToTable[adrToInfo[msg.sender].level][adrToInfo[msg.sender].tableId].leader,
            adrToInfo[msg.sender].tableId,
            levlToIdToTable[adrToInfo[msg.sender].level][adrToInfo[msg.sender].tableId].userCount,
            adrToInfo[msg.sender].timest,
            levlToIdToTable[adrToInfo[msg.sender].level][adrToInfo[msg.sender].tableId].isPaidAll
        );
    }
}
