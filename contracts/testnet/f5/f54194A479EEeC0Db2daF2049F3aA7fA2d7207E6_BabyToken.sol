...
contract BabyToken is ERC20, Ownable, BaseToken {
    ...
    function _setAutomatedMarketMakerPair(address pair, bool _value) private {
        require(
            automatedMarketMakerPairs[pair] != _value,
        ...
        emit SetAutomatedMarketMakerPair(pair, _value);
    }
