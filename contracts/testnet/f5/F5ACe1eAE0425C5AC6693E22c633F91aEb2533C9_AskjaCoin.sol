...
contract AskjaCoin is ERC20PresetFixedSupplyUpgradeable, OwnableUpgradeable {
    //////////////////////////////////////////////////////////////////////
    //PROD
    address public constant rusticityFee =
        0x462716fA20351150d62054AE26B1B604196d61ab;

    //DEV
    // address public constant rusticityFee =
    //     0x70997970C51812dc3A010C7d01b50e0d17dc79C8;

    mapping(address => uint256) _lastTimeMinted;
    //List of accounts that do not pay fee (time vaults)
    address[5] _whiteList;
        ...
        returns (bool)
    {
        ...
        if (!isWhiteListed && !_feeDisabled) {
            ...
            // add last minted
            _lastTimeMinted[_msgSender()] = block.timestamp;
        } else {
    ...
    function getCoolDownAddress(address adress)
        ...
        returns (uint256)
    {
        return _lastTimeMinted[adress];
    }

    function getCoolDownValue() public view virtual returns (uint256) {
    ...
    function getWhiteList() public view virtual returns (address[5] memory) {
        return _whiteList;
    }

    // add address to the whitelisted adresses
    function addToWhiteList(address _address, uint256 _index) public onlyOwner {
        _whiteList[_index] = _address;
    }
    ...
    function updateFeeDisabled(bool feeDisabled) public onlyOwner {
        _feeDisabled = feeDisabled;
    }

    function getFeeDisabled() public view returns (bool) {
        return _feeDisabled;
    }
}
