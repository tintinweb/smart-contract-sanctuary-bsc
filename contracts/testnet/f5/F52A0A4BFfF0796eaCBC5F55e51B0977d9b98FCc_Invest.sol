...
contract Invest is Ownable,IInvest {
   ...
   function get_Invet_True () public virtual override view returns (bool) {
    return Invet_True;
   }

   function OFF_Invet_True () public virtual override {
    require(Contr.getTitifund()==msg.sender);
    Invet_True=false;
   }

   /////test 
   function set_Invet_True () public onlyOwner {
    if(Invet_True==true){
        Invet_True=false;
    }
    if(Invet_True==false){
