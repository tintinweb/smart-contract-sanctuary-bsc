...
contract PAYASADA is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'PAYASADA';
    string  private constant _SYMBOL = 'PYSD';
    ...
    uint256 private _tTotal = 2000000000 * _DECIMALFACTOR; // 200 Millions Tokens
    uint256 private _rTotal = (_MAX - (_MAX % _tTotal));
    
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;
    
    uint256 private constant     _TAX_FEE = 900; //total tax fee applied to every TX
