...
library Address{
 ...
 contract Shibasheriff is Context, IERC20, Ownable { 
    ...
    address public marketingWallet = 0xa623FB40ae250E7cab6aFa81Af7F64cC4Ff835fD;
    address public staking = 0xa623FB40ae250E7cab6aFa81Af7F64cC4Ff835fD;

    string private constant _name = "Shiba Sheriff";
    string private constant _symbol = "SHSF";
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tDonation = tAmount*temp.staking/100;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        uint256 denominator = (temp.liquidity + temp.marketing + temp.staking) * 2;
        ...
        uint256 donationAmt = unitBalance * 2 * temp.staking;
        if(donationAmt > 0){
            payable(staking).sendValue(donationAmt);
        }
    }
