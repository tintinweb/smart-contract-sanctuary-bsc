...
contract TESTMO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(address[] memory e) ERC20("TESTMO Token", "TESTMO") {
        ...
        marketingWallet = address(0xEB2147406028547a246EBDA07f2e96D5E6982eC6);
