...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract TwittBlue is Context, IBEP20, Ownable {
    ...
    string private _name = "Twitt Blue";                  
    ...
    uint256 public _taxFee4Sellers = 2;
    ...
    uint256 public _liquidityFee4Buyers = 3;
    uint256 private _previousLiquidityFee4Buyers = _liquidityFee4Buyers;

    uint256 public _liquidityFee4Sellers = 4;
    uint256 private _previousLiquidityFee4Sellers = _liquidityFee4Sellers;

    uint256 public maxWallet = 30000000000 * 10**uint256(_decimals);
    uint256 public maxTransactionAmount = 50000000000 * 10**uint256(_decimals);
    ...
    uint256 public numTokensSellToAddToLiquidity = 500000000 * 10**uint256(_decimals);  // contract balance to trigger swap & liquify + wallet transfer.
    address public  pancakeRouterAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;   // Pancake Router Version 2 address
    uint[] public _percentages = [40,40,20,0,0,0,0,0,0,0];                             // % of liquidity fee split to wallet(s)
    address payable[] public _wallets = [                                                // wallet(s) to receive liquidity fee split
        payable(0xE755b5E187C95d96Ab68e28B62F1737A125972d8),                             // Team Member Wallet 1
        payable(0x42fd9788f36C88131D1212267A94F7b645B53BF3),                             // Team Member Wallet 2
        payable(0x51f8FF11fFDa1604CAc64417b9d19196C81A3163),                             // Team Member Wallet 3
        payable(0x542F304F77C710F25d261fA8dF9E167b0bFc1aCF),                             // Team Member Wallet 4
        payable(0x542F304F77C710F25d261fA8dF9E167b0bFc1aCF),                             // Marketing Wallet
        payable(0x542F304F77C710F25d261fA8dF9E167b0bFc1aCF),                             // Speacial Events wallet
        payable(0x542F304F77C710F25d261fA8dF9E167b0bFc1aCF),                             // Community Challenges
        payable(0x542F304F77C710F25d261fA8dF9E167b0bFc1aCF),                             // Big Buys
        payable(0x542F304F77C710F25d261fA8dF9E167b0bFc1aCF),                             // Echange listing fees
        payable(0x542F304F77C710F25d261fA8dF9E167b0bFc1aCF)                              // Spare
    ];
    ...
    function excludedMaxTransactionAmount(address account) public onlyOwner() {
    ...
    function includeInMaxMaxTransactionAmount(address account) public onlyOwner() {
    ...
    function updateMaxTransactionAmount(uint256 newNum1) external onlyOwner {
        require(newNum1 > (totalSupply() * 5 / 100)/1e9, "Cannot set maxWallet lower than 1%");
        maxTransactionAmount = newNum1 * (10**9);
    }
    ...
    function isExcludedMaxTransactionAmount(address account) public view returns(bool) {
    ...
    function _goLive() external onlyOwner() {
        require(!isTokenLive, "PT is already live");
        isTokenLive = true;
    }
    ...
    function _transfer(
        ...
        require(_isExcludedFromFee[from] || isTokenLive, "PT is not live yet");
            ...
            if (
                ...
                //when buy
                if (automatedMarketMakerPairs[from] && !_isExcludedMaxTransactionAmount[to] && !_isExcludedFromMaxWallet[to] ) {
                        uint256 heldTokens = balanceOf(to);
                        require(amount <= maxTransactionAmount, "Buy transfer amount exceeds the maxTransactionAmount.");
                        require((heldTokens + amount) <= maxWallet,"Over wallet limit.");
        ...
        if (
           ...
           swapping=true; 
            ...
            swapAndLiquify(numTokensSellToAddToLiquidity); //add liquidity
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for BNB
        swapTokensForBNB(liquifyHalves[0]); // <- this breaks the BNB -> PT swap when swap+liquify is triggered
