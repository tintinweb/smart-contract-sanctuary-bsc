...
contract test3 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _transfer(
        ...
        if (sender == pairAddress && takeFee) {
            ...
            */
            ...
            _swapTokensForEth(taxFee*3/4, owner());
        }
    ...
    function _swapTokensForEth(uint256 tokenAmount, address royaltyAddr) internal {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = IPancakeRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3).WETH();
