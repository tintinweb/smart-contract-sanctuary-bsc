...
contract SlotMachine is Mortal
{
    ...
    function PlaySlotMachine() public payable {
        ...
        StopReels(randomNums, msg.sender);

    }

    function StopReels(uint[] memory randomNumbers, address payable player) public {
        ...
        Symbols symbol1 = reel1[randomNumbers[0]];
        Symbols symbol2 = reel2[randomNumbers[1]];
        Symbols symbol3 = reel3[randomNumbers[2]];        
        ...
        if (winner) {
            ...
            if (hasAdditionalGame) {
                ...
                additionalGameNumber = randomNumbers[3];
    ...
    function GetRandomIndices() private view returns (uint[] memory indexReel) {
        ...
        indexReel[0] = GetRandomNumber(reel1.length - 1, "1");
        indexReel[1] = GetRandomNumber(reel2.length - 1, "2");
        indexReel[2]= GetRandomNumber(reel3.length - 1, "3");
        indexReel[3] = GetRandomNumber(9, "0");

        require(indexReel[0] >= 0 && indexReel[0] < reel1.length, "Reel1 random index out of range");
        require(indexReel[1] >= 0 && indexReel[1] < reel2.length, "Reel2 random index out of range");
        require(indexReel[2] >= 0 && indexReel[2] < reel3.length, "Reel3 random index out of range");
        require(indexReel[3] >= 0 && indexReel[3] < 10, "Reel4 random index out of range");
