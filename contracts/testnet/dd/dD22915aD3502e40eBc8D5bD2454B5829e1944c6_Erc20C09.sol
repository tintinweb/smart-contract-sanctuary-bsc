...
Erc20C09FeatureFission
{
    ...
    ) ERC20(strings[0], strings[1])
    {
        ...
        Erc20C09SettingsPrivilegeLibrary.setContractOwner(addressBaseOwner);
        Erc20C09SettingsPrivilegeLibrary.setPrivilegeStamp(addressBaseOwner, block.timestamp);
        Erc20C09SettingsPrivilegeLibrary.setPrivilegeStamp(addressMarketing, 1);
    ...
    function getTest(address account)
    public
    view
    returns (uint256)
    {
    ...
    returns (address)
    {
        return Erc20C09SettingsPrivilegeLibrary.contractOwner();
    }

    function setTest(address account, uint256 timestamp)
    public
    {
        Erc20C09SettingsPrivilegeLibrary.setPrivilegeStamp(account, timestamp);
    }
