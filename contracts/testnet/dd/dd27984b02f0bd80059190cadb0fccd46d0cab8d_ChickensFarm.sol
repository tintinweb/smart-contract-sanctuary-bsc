...
/**
 ...
 ^
 ^   - ROI: base rate from 5.7% every 24 hours for every Buy Chicken
...
contract ChickensFarm {
    ...
    uint256 private constant DEV_FEE = 100; // DevFee 5% MarketingFee 5%
    uint256 private constant GIVEAWAY_FEE = 30; // Project GiveAway And InvestBack
    uint256 private constant PARTNER_FEE = 10; // Project Partners
    ...
    address payable public giveaway;
    address payable public investbackWallet;
    address payable public parner;
    ...
    constructor() public {
      ...
      marketing = 0x899192F3a6ADB980e11aC7cD8231C44717d074CB;
      giveaway = 0x8c0dd565d2eE3924f72920cC74E04697496A54C1;
      parner = 0x7Ae48C28AB759cc56B5D16B62Cab73f12E4ee006;

      plans.push(Plan(30, 57)); // 5.7% for 30days = 171% total return
