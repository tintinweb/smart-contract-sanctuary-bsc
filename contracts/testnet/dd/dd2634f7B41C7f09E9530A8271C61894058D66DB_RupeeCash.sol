...
contract RupeeCash is BEP20Upgradeable {
    ...
    // RupeeCash Swap
    IERC20 public BUSD; // = IERC20(0x2D91b0da253F357B06D1c112F584C1c94d6bD6B4);
    IERC20 public JAXRE; // = IERC20(0x07f6b1CEb3e2E2E9ab38f1018cAaFae4d80f82D1);
    ...
    event Create_RupeeCash_Busd_Swap_Request(uint requestId, Request request);
    ...
    {
        _setup("Digital Rupee", "RupeeCash", 18);
        max_jaxre_rupeeCash_ratio = 1e8;
        BUSD = IERC20(0x2D91b0da253F357B06D1c112F584C1c94d6bD6B4);
        JAXRE = IERC20(0x07f6b1CEb3e2E2E9ab38f1018cAaFae4d80f82D1);
    }
...
contract RupeeCashAdmin is OwnableUpgradeable {
    ...
    event Auto_Settlement_Transfer(address to, uint amount, string private_tx_hash, bool auto_exchange);
    ...
    function add_broker(bytes32 email_hash, bytes32 mobile_hash, address broker_address, uint credit_rating) external checkZeroAddress(broker_address) onlyOwner {
    ...
    function auto_settlement_transfer(address to, uint amount, string memory private_tx_hash) external onlyGatekeeper {
        ...
        emit Auto_Settlement_Transfer(to, amount, private_tx_hash, auto_exchange[to]);
    }
