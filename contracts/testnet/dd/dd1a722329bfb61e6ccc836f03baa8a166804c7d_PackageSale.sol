...
contract PackageSale {
    ...
    IERC20 public constant BUSD = IERC20(0xD7E7330Fa43786e8f1D2d797F568D422eD7799F5); // BUSD MINE SMART BLOCK 
    IERC20 public constant WOW = IERC20(0x3bC8F24Fe42dc430c598f82D24DffcF623B3e998); //Mine WOW Blockchain TOken
    ...
    function purchaseMonthlyPackage(Package packageType, address _ref) external {
        ...
        if(_ref!=address(0))
        {
            ...
            WOW.transfer(msg.sender, packageOne ? GIFT_AMOUNT_PACKAGE_ONE : GIFT_AMOUNT_PACKAGE_TWO);
