...
contract fixtest is Ownable {
    using SafeMath for uint256;
    MowaCore public mowaCore;
    ...
    // character => MowaPet
    mapping(uint256 => MowaPet) public mowaPet;
    ...
    constructor(
        ...
        mowaPet[40] = MowaPet(1, 1, 1, 40, 0);
    }

    function petCombine() public {
        uint256 tokenIdNew = mowaCore.getNextNFTId();
        tokenIdNew += 1;
        mowaCore.safeMintNFT(_msgSender(), tokenIdNew);
        Mowa memory mowa = Mowa(
            tokenIdNew,
            mowaPet[40].level,
            mowaPet[40].skill,
            mowaPet[40].star,
            mowaPet[40].character,
            mowaPet[40].class,
            block.timestamp
        );
        mowaCore.setNFTFactory(mowa, tokenIdNew);
    }
}
