...
contract Testking is Context, IERC20, Ownable, LockToken 
{
    ...
    uint256 public _maxSaleAmount = 2_000_000_000_000_0 * 10**9; //1%
    uint256 public _maxBuyAmount = 9_000_000_000_000_0 * 10**9; //2%
    uint256 private numTokensSellToAddToLiquidity = 1_000_000 * 10**9;
    uint256 public maxLimit = 9_000_000_000_000_0 * 10**9; //max allowed tokens in one wallet. 
