...
contract Bnb {
    ...
    function _register1(address _addr, uint Amount) private{
     uint depositAmount = Amount;
      ...
      lvl1s[_affAddr16].lvl7count = lvl1s[_affAddr16].lvl7count.add(1);
      lvl1s[_affAddr17].lvl7count = lvl1s[_affAddr17].lvl7count.add(1);
      lvl1s[_affAddr18].lvl7count = lvl1s[_affAddr18].lvl7count.add(1);
      lvl1s[_affAddr19].lvl7count = lvl1s[_affAddr19].lvl7count.add(1);
      lvl1s[_affAddr20].lvl7count = lvl1s[_affAddr20].lvl7count.add(1);
      ...
      lvl1s[_affAddr16].lvl7total = lvl1s[_affAddr16].lvl7total.add(depositAmount);
      lvl1s[_affAddr17].lvl7total = lvl1s[_affAddr17].lvl7total.add(depositAmount);
      lvl1s[_affAddr18].lvl7total = lvl1s[_affAddr18].lvl7total.add(depositAmount);
      lvl1s[_affAddr19].lvl7total = lvl1s[_affAddr19].lvl7total.add(depositAmount);
      lvl1s[_affAddr20].lvl7total = lvl1s[_affAddr20].lvl7total.add(depositAmount);
        ...
        if (_amount > 0 && _receiver != address(0)) {
          uint contractBalance = address(this).balance;
            if (contractBalance > 0) {
                ...
                player.maticDeposit = player.maticDeposit.add(reinvest);
                ...
                player.maticDeposit = player.maticDeposit.sub((payout.mul(80)).div(100));
