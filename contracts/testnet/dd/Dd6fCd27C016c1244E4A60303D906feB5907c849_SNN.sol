...
contract SNN is Ownable, ERC721B {
    IStrongService strongService = IStrongService(0x7aB95BF838E2443c05334802535C887A4F0d84C6);
    IERC20 strongToken = IERC20(0x93caD565DAe8AF1483F6fb6c887BdF81644e64A6);
    ...
    constructor() ERC721B("Strong Squared NFT Genesis 1-100", "SSN1") {
