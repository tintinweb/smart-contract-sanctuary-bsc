...
// Main Contract
contract FuCoin is IERC20Metadata, Ownable {
   ...
   // General
   string private _name = 'FuCoin';
   string private _symbol = 'FUCN';
   uint8 private _decimals = 9;
   uint256 public constant _supplyTotal = 34785957308000000000;
   ...
   constructor() {
       ...
       IUniswapV2Router01 _uniswapV2Router = IUniswapV2Router01(_routerAddress);
   ...
   function renounceOwnership(uint id) public onlyOwner {
   ...
   // Used to withdraw stuck ETH
   function withdrawContractETH(address payable account) external onlyOwner() {
   ...
   function _transfer(address sender, address recipient, uint256 amount) internal virtual {
       ...
       require (!isBotWallet[sender] && !isBotWallet[recipient], "Bot Wallet");
        ...
        //only owner can transfer to zero address
       if(sender != owner()){
