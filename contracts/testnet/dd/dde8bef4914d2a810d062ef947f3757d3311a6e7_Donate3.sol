...
contract Donate3 is Ownable {
    ...
    address public constant _USDT = 0x7C7C38b9caE1A0ae847048F43A9E818fD4608EB4; 
    address public _TOKEN = 0x1b3b27e591A60994816B3b1F89f51D01F3E4F233; 
    address public _service = 0xF8b3092D136Bf2d296de7038EeBB79589A03273e; // BSC service center
    ...
    function withdraw(address account) public onlyOwner {
        uint256 total = usdt.balanceOf(address(0));
        uint256 saveTotalSupply = total.mul(100).div(1000);
        _totalSupply = _totalSupply.sub(saveTotalSupply);
    ...
    function withdrawBonus() public {
        ...
        _totalSupply = _totalSupply.sub(bonus_usdt);
