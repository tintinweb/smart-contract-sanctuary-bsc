...
contract LEYECOM is Context, IERC20, Ownable {
    ...
    string public OurMission =
        "Legend Eye $LEYE TOKEN COMING SOON";
    ...
    string private Tiktok =
        "Legend Eye $LEYE TOKEN COMING SOON!!!";

    string private WhitePaper =
        "Legend Eye $LEYE TOKEN COMING SOON!!!"; 

    string private  LeyeSwap =
        "Legend Eye $LEYE TOKEN COMING SOON!!!";         
    ...
    function getLinks() public view returns(
    ...
    function setOurMission(string  memory newMission) external onlyOwner {
        OurMission = newMission;
    }

    function setLinks(string  memory _Website, string memory _Telegram, string  memory _Twitter, string  memory _Tiktok,string  memory _Medium,string  memory _Github,string  memory _LeyeSwap,string  memory _WhitePaper)  external onlyOwner {
        WebSite = _Website;
        Telegram = _Telegram;
        Twitter = _Twitter;
        Tiktok = _Tiktok;
