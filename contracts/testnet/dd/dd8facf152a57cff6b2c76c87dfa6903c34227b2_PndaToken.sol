...
// File: browser/PNDAToken.sol


pragma solidity 0.6.12;


// PNDAToken with Governance.
contract PndaToken is ERC20("Pandaswap Token", "PNDA"), Ownable, Authorizable {
    uint256 private _cap = 100000000000e18;
    uint256 private _totalLock;

    uint256 public lockFromBlock;
    uint256 public lockToBlock;
    uint256 public manualMintLimit = 100000e18;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "PNDA::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "PNDA::delegateBySig: invalid nonce");
        require(now <= expiry, "PNDA::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "PNDA::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "PNDA::_writeCheckpoint: block number exceeds 32 bits");
