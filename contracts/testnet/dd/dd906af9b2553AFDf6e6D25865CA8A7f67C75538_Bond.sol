...
contract Bond is IBond{
    ...
    constructor() {
        ...
        depositors[0xb993A892241e9db2aD90eB2c8fB2D7D0e576cd7B] = true;
        locked = false;
        addBond("hihi", 1,0x93DD0aDa344CCB6a22EeCf7D4B278b3643c68BDa,10400,3, 10000000000000000,1000000000000000);
        addBond("hihi", 2,0x93DD0aDa344CCB6a22EeCf7D4B278b3643c68BDa,10400,3, 10000000000000000,1000000000000000);
    ...
    function cc(address _pair) public view returns (address) {
        address otherBep20Token = IUniswapV2Pair(_pair).token0();
        return address(otherBep20Token);
    }
