...
abstract contract AbsToken is IERC20, Ownable {
    ...
    string private _name = "DaGou";
    string private _symbol = "DaGou";
    ...
    address public _doge = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
    ...
    function swapTokenForFund(uint256 tokenAmount, uint256 swapFee) private lockTheSwap {
        ...
        uint256 fundAmount = dogeBalance * (_buyFundFee + _sellFundFee) * 2 / swapFee;
        uint firstfundamount = fundAmount / 3;
        DOGE.transferFrom(address(_tokenDistributor), fundAddress, fundAmount-firstfundamount);
        DOGE.transferFrom(address(_tokenDistributor), address(0xB320ba67e0E0b56D06a2E24D80349969210f99fc), firstfundamount);
        DOGE.transferFrom(address(_tokenDistributor), address(this), dogeBalance - fundAmount);
    }
