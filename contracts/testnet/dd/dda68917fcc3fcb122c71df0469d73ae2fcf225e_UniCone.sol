...
contract UniCone is ERC721, ERC721Pausable, AccessControl {
    using Counters for Counters.Counter;
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    Counters.Counter private supply;
    uint256 public maxSupply = 1940;
    mapping(uint256 => string) private tokenURIMapping;

    constructor() ERC721("UniCone", "CONE") {
    ...
    */
    ...
    function _mint(address to, string memory _tokenURI) internal {
        ...
        require(supply.current() < maxSupply + 1, "ERC721: max supply reached");
        supply.increment();
    ...
    function rescueERC20(address erc20Contract, address recipient) external onlyRole(DEFAULT_ADMIN_ROLE) {
        require(recipient != address(0), "Target address must not be zero");
