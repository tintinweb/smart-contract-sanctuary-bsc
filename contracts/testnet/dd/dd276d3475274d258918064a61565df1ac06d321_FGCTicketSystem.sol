...
contract Surprise is Context, ERC165, IERC721, IERC721Metadata, IERC2309, Ownable {
     ...
     */
    constructor() {
        _name = "Forgotten Surprise";
        _symbol = "FGCSRPS";
        _decimals = 1;
        setBaseURI("https://data.forgottenchain.com/nfts/0/surprises");
    }
   ...
   /**
     ...
     */
    function _mintConsecutive(uint256 tokenCount) internal virtual ownerOrApprovedByOwner {
    ...
    Ownable
{
    ...
    function transferSurprise() internal {
        if(lastSupriseTokenIdTransfered < type(uint256).max) {
            Surprise(SurpriseNFTAddress).safeTransferFrom(
                address(this),
                msg.sender,
