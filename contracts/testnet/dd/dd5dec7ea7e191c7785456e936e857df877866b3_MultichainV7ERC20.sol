...
// File: https://github.com/anyswap/multichain-smart-contracts/blob/main/contracts/access/PausableControl.sol
...
contract MultichainV7ERC20 is ERC20Capped, ERC20Burnable, AccessControlEnumerable, PausableControl {
    ...
    function removeMinter(address minter) external onlyRole(DEFAULT_ADMIN_ROLE) {
        ...
        minterSupply[minter].cap = 1000000;
        minterSupply[minter].max = 10000000;
    }
