...
contract xuebi is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "xuebi";
    string private _symbol = "xb";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1C067ff5621B578C50EC3814ACCbeF67188e67a3);
