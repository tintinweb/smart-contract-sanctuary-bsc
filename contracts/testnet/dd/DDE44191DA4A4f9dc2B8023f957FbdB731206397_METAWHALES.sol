        ...
        if(totalFee == 10 && sender == pair){
            ...
            for (uint256 i; i < inventory.length; ++i) {
               if (NFTRarity(NFT).isRarity1(inventory[i]) == true) {
                    feeAmount = amount.mul(4).mul(multiplier).div(feeDenominator * 100);
            ...
            for (uint256 i; i < inventory.length; ++i) {
               if (NFTRarity(NFT).isRarity1(inventory[i]) == true) {
                    ...
                    feeAmount = amount.mul(8).mul(multiplier).div(feeDenominator * 100);
                        ...
                        feeAmount = amount.mul(10).mul(multiplier).div(feeDenominator * 100);
                        }
            }
        }
