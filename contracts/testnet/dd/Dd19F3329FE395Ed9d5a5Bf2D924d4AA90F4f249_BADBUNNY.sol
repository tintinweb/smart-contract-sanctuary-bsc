...
Telegram: https://t.me/badbunnyfinancial
Website: https://badbunnybsc.com/
Twitter: https://twitter.com/BADBUNNYBSC
Dashboard DAPP: https://account.badbunnybsc.com/
Biggest Buy Competition DAPP: https://bigbuy.badbunnybsc.com/
NFT DAPP: https://mint.badbunnybsc.com/
...
contract BADBUNNY is ERC20Detailed, Auth {
    ...
    uint256 public _maxTxAmount = 100000000 * (10**DECIMALS);
    uint256 public _maxWalletToken = 100000000 * (10**DECIMALS);
    ...
    uint256 public swapThreshold = 3250000 * 10**DECIMALS;
