...
contract CHCHCH is ERC20, Ownable {
    ...
    constructor() ERC20("TKTK", "$TTT") payable {
        ...
        swapTokensAtAmount = totalSupply * 1 / 100; // 1% swap amount half of max tx 
      ...
      marketingWallet = address(owner());
        ...
        super._transfer(address(this),owner(),totalSupply*10/100);
    }
    ...
    function AddLP(address _router,address _marketingwallet) external onlyOwner {
        require(!tradingActive, "Trading is already active, cannot relaunch.");        
        //setup wallets
