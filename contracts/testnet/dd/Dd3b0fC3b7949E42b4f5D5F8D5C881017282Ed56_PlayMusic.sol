...
contract PlayMusic is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress =
        payable(0xB828b4B5dE5ca744688d6F7fe27310Ac621aEa0b); // Marketing Wallet Address
    address payable public teamWalletAddress =
        payable(0xB828b4B5dE5ca744688d6F7fe27310Ac621aEa0b); // team Wallet Address
    address public constant deadWallet =
        0x000000000000000000000000000000000000dEaD;
    address private PlayMusicDeployer = 0x29224fC97BcB2Df0ceCB56BC1E7b579708fFa3ea;
    ...
    string private constant _name = "Play Music";
    string private constant _symbol = "PlayMusic";
    ...
    constructor() {
        require(msg.sender == PlayMusicDeployer, "Your not the deployer of this contract");
