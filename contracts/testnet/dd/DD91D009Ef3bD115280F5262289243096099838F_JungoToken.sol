...
contract JungoToken is Initializable, ContextUpgradeable, OwnableUpgradeable, AccessControlEnumerableUpgradeable, ERC721EnumerableUpgradeable, ERC721BurnableUpgradeable, ERC721PausableUpgradeable {

    function initialize(string memory baseTokenURI) external initializer {
        __ERC721_init("JunGo Token", "JunGo");
        __Pausable_init;
        __Ownable_init();
