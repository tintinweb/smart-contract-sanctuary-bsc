...
contract Snowball is Context, Ownable {
    ...
    function snowRewards(address adr) public view returns(uint256) {
    ...
    function getEggs(address ref) public {
