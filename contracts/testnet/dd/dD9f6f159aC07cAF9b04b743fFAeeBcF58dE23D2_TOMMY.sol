...
contract TOMMY is Context, ERC20, Ownable {
...
//--------------------------------------BEGIN CONSTRUCTOR AND RECEIVE FUNCTION---------|    
    ...
    constructor() ERC20("PYE", "PYE") {
        ...
        pyeSwapRouter = IPYESwapRouter(0x58A4C8fA9D47A7a7E3C2973Fa8Ea21BacAAF1002);
        WBNB = pyeSwapRouter.WETH();
        BUSD = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
        pyeSwapPair = IPYESwapFactory(pyeSwapRouter.factory()).createPair(address(this), WBNB, true, WBNB);
