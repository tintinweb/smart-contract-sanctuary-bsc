...
contract UberTaxiController is Ownable {
    ...
    constructor() {
        ...
        UTD = UberTaxiDate(0x5aBbEA43c203D1D743044Cb33dA57E907A3470Bb);
    }
    ...
    function setIds(uint256 _ids) public onlyOwner {
        ids = _ids;
    }

    function setCIds(uint256 _cIds) public onlyOwner {
        cIds = _cIds;
    }
