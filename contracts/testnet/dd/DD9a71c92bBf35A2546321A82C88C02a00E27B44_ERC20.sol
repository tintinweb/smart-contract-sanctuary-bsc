...
contract ERC20 is  Ownable, Pausable, Initializable, IERC20Permit, EIP712  {
    ...
    function _transfer( address from, address to, uint256 value) internal  {
        ...
        console.log("name: %s , trn.amount :%s, balance :%s",name,value,balances[from]);
    ...
    function _increaseAllowance( address _owner, address _spender, uint256 _increment) internal  {
        _approve(_owner, _spender, allowed[_owner][_spender]+_increment);
    }

    function _decreaseAllowance(address _owner, address _spender, uint256 _decrement) internal  {
         _approve(_owner,_spender, allowed[_owner][_spender]-_decrement);
    }
