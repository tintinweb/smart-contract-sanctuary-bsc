...
contract FortuneCookiesLottery is ReentrancyGuard, IFortuneCookiesLottery, Ownable {
        ...
        nonReentrant
    {
        ...
        require(currentTicketId <= 99999, "No more tickets available");
        ...
        for (uint256 i = 0; i < _ticketAmount; i++) {
            uint32 thisTicketNumber = randomTicket(i);

            while (viewIfTicketIsOwned(currentTicketId) == true)
            {
              thisTicketNumber = randomTicket(i);
            }
