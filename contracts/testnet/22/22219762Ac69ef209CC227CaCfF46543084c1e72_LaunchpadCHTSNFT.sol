    ...
    ReentrancyGuardUpgradeable
{
        ...
        for (uint256 i = 0; i < _launches.length; i++) {
            ...
            launches.push(
                Launchpad({
                    ...
                    soldCount: _launches[i].soldCount,
        ...
        returns (uint256, uint256)
    {
        ...
        require(_dealToken == address(usd), "Invalid deal token");
        ...
        uint256 nftId = CHTSNFT.launchpadMint(msg.sender, _launch.level, false);
