...
contract CR888 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 private maxMintPerWeek = 1000000;
    ...
    constructor() {
        _name = "Crypto 888";
        _symbol = "CR888";
        address market = address(0xbfb0Ecd5fdC8f3e5Ed6bD7c2d8d92DE7CB044f80);
        whitelist[msg.sender] = true;
        whitelist[market] = true;
        initMint = true;
        mint(msg.sender, 100000000000);//game rewards
        mint(market, 10000000000);//marketing
        initMint = false;
    }
