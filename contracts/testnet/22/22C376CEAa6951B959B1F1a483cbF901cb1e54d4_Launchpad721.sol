...
//TODO: compare with openZepplin
import "./token/ERC721.sol";

contract Launchpad721 is ERC721 {
    ...
    function _multipleMint(string[] memory _tokenUriArr, uint256 fee, Sign memory sign) public {
        for(uint i = 0; i<_tokenUriArr.length; i++) {
            createCollectible(_tokenUriArr[i], fee, sign);
        }
    }
