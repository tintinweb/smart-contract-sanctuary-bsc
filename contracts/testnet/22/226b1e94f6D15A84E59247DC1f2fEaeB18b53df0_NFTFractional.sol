...
interface ISignatureUtils {
    function getMessageHash(uint256 poolId,uint256 amount,uint256 allocation,uint256 purchaseFNFT, uint256 nonce, address sender) external returns (bytes32);
    function getEthSignedMessageHash(bytes32 _messageHash) external returns (bytes32);
    function verify(uint256 poolId,uint256 amount,uint256 allocation,uint256 purchaseFNFT,uint256 nonce,address sender,address signer,bytes memory signature) external returns (bool);
