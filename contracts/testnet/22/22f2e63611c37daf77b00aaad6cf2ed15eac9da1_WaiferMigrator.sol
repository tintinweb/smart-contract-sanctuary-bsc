...
contract WaiferMigrator is Initializable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
  ...
  * total supply.
  */
  function removeToken(address account, uint256 amount) external onlyOwner whenNotPaused returns(bool) {
  ...
  */
  function _removeToken(address account,uint256 amount) internal virtual onlyOwner whenNotPaused {
