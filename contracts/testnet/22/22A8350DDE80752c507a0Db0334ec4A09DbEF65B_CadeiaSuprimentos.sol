...
contract CadeiaSuprimentos {
  ...
  event ProduccionAgricolaAgricultor (string _CodigoProductoAgricola, string _CodFornecedor,int _NumLoteColectado, int _quantidade, int _precoAgricola, string _ProdExt);
  function ProducionAgricola (string memory _CodigoProductoAgricola, string memory _CodFornecedor, int _NumLoteColectado, int _quantidade, int _precoAgricola, string memory _ProdExt) public {
  uint timestamp;
  ...
  emit ProduccionAgricolaAgricultor (_CodigoProductoAgricola, _CodFornecedor ,_NumLoteColectado, _quantidade, _precoAgricola, _ProdExt);}
 ...
 // para el paso 1 el agricultor solicita el analisis de la produccion y codigo de autorizacion de produccion "campo certificado" 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2 = endereço do agricultor para solicitar analisis
  ...
  event SolicitudAvaliaMostra (address _Fornecedor, int _CodsolicitudAnls,int _CodigMostra, string _hash1);
  function SolicAvalMostra(address _Fornecedor, int _CodsolicitudAnls, int _CodigMostra, string memory _hash1) public {
  ...
  emit SolicitudAvaliaMostra(_Fornecedor, _CodsolicitudAnls, _CodigMostra,_hash1);}
 ...
 // paso 2resultado de analisis del laboratorio para confirmar que la carga esta en condiciones optimas dirigido a esa visibilidad
  ...
  event ResultadoLab (string _ResultadoAval, int _CodsolicitudAnls, string _LabID, string _Temperatura, string _InsumQuimico, string _CalidadAgua, string _hash1);
  function ResultadoLabO (string memory _ResultadoAval, int _CodsolicitudAnls, string memory _LabID, string memory _Temperatura, string memory _InsumQuimico, string memory _CalidadAgua, string memory _hash1) public {
  ...
  emit ResultadoLab(_ResultadoAval, _CodsolicitudAnls, _LabID, _Temperatura, _InsumQuimico, _CalidadAgua, _hash1);}
...
// EMPEZAMOS CON LA PARTE TRANSFORMADORA
 ...
 // con este paso deberiamos generar muchas orden de pedidos de acuerdo con la estructura, estos pedidos seran colocados por la transformadora 0x5B38Da6a701c568545dCfcB03FcB875f56beddC4
  ...
  event OrdenRequerimientoEmpresa1 (string _ProdExtS, int _Nrequerimiento, int _quantidadeRequerida1, int _preco, int _peso, int _Lote1, string _condicion, string _IDPEDIDO, string _hash2);
  function OrdenRequerEMpresa1 (string memory _ProdExtS, int _Nrequerimiento, int _quantidadeRequerida1, int _preco, int _peso, int _Lote1, string memory _condicion, string memory _IDPEDIDO, string memory _hash2) public{
  uint timestamp;
  timestamp = block.timestamp;
  ...
  emit OrdenRequerimientoEmpresa1 (_ProdExtS, _Nrequerimiento, _quantidadeRequerida1, _preco, _peso, _Lote1, _condicion, _IDPEDIDO, _hash2);}
  ...
  event SolicIngSenasa (string _ProductoDeExportacion, int _DiaMesAno, int _hora, string _Lugar, string _hash3);
  function SolicIngeSenasa (string memory _ProductoDeExportacion, int _DiaMesAno, int _hora, string memory _Lugar, string memory _hash3) public {
  uint timestamp;
  timestamp = block.timestamp;
  require(msg.sender==0x5B38Da6a701c568545dCfcB03FcB875f56beddC4);
  ...
  emit SolicIngSenasa(_ProductoDeExportacion, _DiaMesAno, _hora, _Lugar, _hash3);}
  ...
  event ValidacionCertificadoEstatal (string _ProductoSenasa, int _CodigoCertificado, string _referenciaHash2, int _CodigoIngSenasa, int _fechaInspeccion, string _LugardeCarga, string _StatusFInal);
  OrigenCertificadoS [] public OrigenCertificadosSenasa;
  function CertificacionEmpresaEstatal (string memory _ProductoSenasa, int _CodigoCertificado, string memory _referenciaHash2, int _CodigoIngSenasa, int _fechaInspeccion, string memory _LugardeCarga, string memory _StatusFInal) public {
  ...
  emit ValidacionCertificadoEstatal (_ProductoSenasa, _CodigoCertificado, _referenciaHash2, _CodigoIngSenasa, _fechaInspeccion, _LugardeCarga, _StatusFInal);
  }
 ...
 //function ConsultaCliente (address ClienteFinal) public returns  {} NAO SEI COMO FAZER QUE O CLIENTE CONSIGA REVISAR TODAS AS INFORMACOES
