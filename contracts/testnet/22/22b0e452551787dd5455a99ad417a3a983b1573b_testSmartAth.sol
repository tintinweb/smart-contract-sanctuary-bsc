...
contract testSmartAth is ERC20, Ownable {
    ...
    constructor() ERC20("test SmartAth", "tSmartAth") {
    ...
    function updateLiquidityFee(uint256 _buyFee, uint256 _sellFee) public onlyOwner {
        require(_buyFee <= 10, "buy tax to high");
        buyFee = _buyFee;
        require(_sellFee <= 10, "sell tax to high");
        sellFee = _sellFee;
    }
