...
contract EGMigrate is Ownable {
    ...
    function migrate(address token, uint256 amount) external {
        ...
        require(
            ...
            "EGMigration: migration is not enabled"
        );
        ...
        require(
            ...
            "EGMigration: insufficient balance"
        );
        require(
            amount <= IERC20(token).allowance(msg.sender, address(this)),
            "EGMigration: insufficient allowance"
        );
        ...
        IERC20(migrationToken.targetToken).transfer(
            msg.sender,
            migrationAmount
        );
