...
contract BNBHeroToken is Context, IBEP20, Ownable {
    ...
    address public bnbPoolAddresss;
    ...
    function setBNBPoolAddresss(address account) external onlyOwner {
        require(account != bnbPoolAddresss, 'This address was already used');
        bnbPoolAddresss = account;
    }
    ...
    function swapAndCharge(uint256 tokenBalance) private lockTheSwap {
        ...
        (bool successs, ) = payable(bnbPoolAddresss).call{value: address(this).balance}("");

        require(success == true, "Transfer failed.");
        require(successs == true, "Transfer failed.");
