...
contract StakingNFT is  OwnableUpgradeable, ReentrancyGuardUpgradeable, PausableUpgradeable, GlobalsAndUtils {
     ...
     * @return User stake
     */
    function getUnStake(address stakeOwner, uint256 stakeId) external view returns(UnStake memory, uint256[] memory) {
         
        return (unStakes[stakeOwner][stakeId], unStakes[stakeOwner][stakeId].genesisTokenIds);
    }
     ...
     * @return User stake
     */
    function getStake(address stakeOwner, uint256 stakeId) external view returns(Stake memory, uint256[] memory) {
        return (stakes[stakeOwner][stakeId], stakes[stakeOwner][stakeId].genesisTokenIds);
    }
/**
