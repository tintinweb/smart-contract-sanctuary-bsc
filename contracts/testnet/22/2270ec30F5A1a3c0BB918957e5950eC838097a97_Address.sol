...
library Address{
 ...
 contract PunDoge is Context, IERC20, Ownable {
    ...
    IRouter public router; //MAIN 0x10ED43C718714eb63d5aA57B78B54704E256024E //TEST 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
    address public pair;
    ...
    address public marketingWallet = 0x02446D7F5CaA5A6bcccddb716859e397c6123a2d;
    address public devWallet = 0x8D935f23C3987Ff4c9770b50aB783Bd05Fc3119A;

    string private constant _name = "89";
    string private constant _symbol = "x89";
    ...
    Taxes public taxes = Taxes(0, 7, 1, 2);
    Taxes public sellTaxes = Taxes(0, 7, 1, 2);
    ...
    function _takeDonation(uint256 rDonation, uint256 tDonation) private {
        totFeesPaid.devwallet +=tDonation;
    ...
    function _getTValues(uint256 tAmount, bool takeFee, bool isSell) private view returns (valuesFromGetValues memory s) {
        ...
        s.tDonation = tAmount*temp.devwallet/100;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        uint256 denominator = (temp.liquidity + temp.marketing + temp.devwallet) * 2;
        ...
        uint256 donationAmt = unitBalance * 2 * temp.devwallet;
        if(donationAmt > 0){
            payable(devWallet).sendValue(donationAmt);
        }
    }
