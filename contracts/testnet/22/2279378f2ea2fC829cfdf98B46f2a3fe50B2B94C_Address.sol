...
// File: WakandaBurn_flat_flat.sol


// File: WakandaBurn_flat.sol


// File: contracts/WakandaBurn.sol
...
/**
    ...
    When buy token:
    5% fee automatically move to donation wallet. contract
...
contract WakandaBurn is Context, IERC20, Ownable {
    ...
    string private _name = "WakandaBurn";
    string private _symbol = "WKBN";
    ...
    function _takeDev(uint256 tDev) private {
        uint256 currentRate =  _getRate();
        uint256 rDev = tDev.mul(currentRate);
        _rOwned[_mondayInvestmentFund] = _rOwned[_mondayInvestmentFund].add(rDev);
        if(_isExcluded[_mondayInvestmentFund])
            _tOwned[_mondayInvestmentFund] = _tOwned[_mondayInvestmentFund].add(tDev);
    }
