...
contract GNSTradingCallbacksV6_2 {
    ...
    event OTMCEvent(string s);
    event InIf(string s, uint u1, uint u2);
    event AfterIf(string s, uint u);
    event PriceImpact(string s, uint u1, uint u2);
    event DentroIfChungo(string s);
    event DentroIfBueno(string s);
    ...
    function openTradeMarketCallback(
        ...
        emit OTMCEvent("Dentro openTradeMarketCallback");


        StorageInterfaceV5.PendingMarketOrder memory o =
        storageT.reqID_pendingMarketOrder(a.orderId);
        if(o.block == 0){
            emit InIf("OBLOCK", o.block, block.number);
            return; }
        StorageInterfaceV5.Trade memory t = o.trade;
        emit AfterIf("AfterIf", o.block);
        ...
        emit PriceImpact("PriceImpact", priceImpactP, priceAfterImpact);
...
/*
        ...
        t.openPrice >= t.sl))
            ...
            emit DentroIfChungo("DentroIfChungo");
            ...
            emit DentroIfBueno("DentroIfBueno");
    ...
    function registerTrade(
        ...
        uint nftId,
        uint limitIndex
    ) public returns(StorageInterfaceV5.Trade memory, uint){
        ...
        v.tokenPriceDai = aggregator.tokenPriceDai();
        //console.log("v.tokenPriceDai levPosDai %s %s", v.tokenPriceDai, v.levPosDai);
        ...
        //console.log("trade.positionSizeDai %s", trade.positionSizeDai);
        ...
        if(nftId < 1500){
            ...
            //console.log("                        storageT.transferDai(address(storageT), address(this), v.reward2);");
        ...
        //console.log("  return after storeTrade");
    ...
    function unregisterTrade(
        ...
        uint tokenPriceDai   // PRECISION
    ) public returns(uint daiSentToTrader){
