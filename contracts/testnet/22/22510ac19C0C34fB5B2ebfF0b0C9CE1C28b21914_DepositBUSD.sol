...
contract DepositBUSD is Ownable {
    ...
    function DepositBUSDs(uint256 amount, address _from)
        public
        payable
        returns (string memory)
    {
        ...
        busd.transferFrom(_from, address(this), amount);
        ...
        return
            "You have sent successfully and please check your BUSD wallet in our system";
    }
    ...
    // function ApproveBUSDs(uint256 _amount) public payable returns (bool) {
    //     require(
    //         _amount >= 10000000000000000000,
    //         "You need to sell at least some tokens"
    //     );
    //     emit busd.Approval(msg.sender,address(this), _amount);
    //     return true;
    // }
