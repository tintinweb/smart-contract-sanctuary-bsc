...
contract LsstGang is Context, IERC20, Ownable {  
    ...
    string  private _name = "LastGang";
    string  private _symbol = "GNG";
    ...
    address payable public LiquidityReward;
   ...
   event showEthAddress (address wallet);
    ...
    function _takeMarketingFee(uint256 tAmount,uint256 tFee) private {
         ...
         emit comments("takeMarketingFeeTAmount" ,tAmount.div(1000));
         emit comments ("EnteredINMarketingFee-Tfee" , tFee.div(1000));
         ...
         emit comments ("MarkShare" , MarketingShare.div(1000));
         emit comments ("buybackShare" , Buyback.div(1000));
         emit comments ("RewardShare" , RewardShare.div(1000));
