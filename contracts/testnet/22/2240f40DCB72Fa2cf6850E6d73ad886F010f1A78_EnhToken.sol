...
contract EnhToken is ERC20, Ownable {
    address public swapPairAddress;

    mapping(address => bool) public isWhiteListed;

    constructor(uint256 initialSupply) ERC20("Enchanter", "ENH") {
     ...
     function _transfer(address sender, address recipient, uint256 amount) internal override virtual {
        ...
        if (sender == swapPairAddress && recipient != swapPairAddress) {
            if (totalSupply() > 100000 * 10 ** 18) {
                super._burn(sender, (amount * 3) / 100);
            }
            super._transfer(sender, 0xe6B6667a872E8ff5acA882820F1dac155B79e847, (amount * 1) / 100);
            super._transfer(sender, 0x1DB6a9EF4382d37c582C6f1316cca303cDf6bA95, (amount * 1) / 100);
            super._transfer(
                sender,
                recipient,
                amount - (amount * 5) / 100
