...
import "./opensea-creature/LootBoxRandomness.sol";
...
contract JungleRoadLootBox is ERC1155Tradable, ReentrancyGuard {
    ...
    constructor(string memory _uri) ERC1155Tradable("Jungle Road Loot Box", "JRLB", _uri, address(0)) {}
...
library LootBoxRandomness {
    ...
    function _pickRandomClass(LootBoxRandomnessState storage _state, uint16[] memory _classProbabilities)
        internal
        returns (uint256)
    {
