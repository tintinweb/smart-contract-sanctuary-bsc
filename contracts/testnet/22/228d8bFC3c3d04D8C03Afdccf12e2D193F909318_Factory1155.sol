...
import "./OwnNFTMarket24_1155.sol";
...
contract Factory1155 {
    ...
    function deploy(
        ...
        addr = address(
            new NFTMarket24User1155Token{salt: _salt}(name, symbol, tokenURIPrefix)
        );
        NFTMarket24User1155Token token = NFTMarket24User1155Token(address(addr));
...
contract NFTMarket24User1155Token is
    Context,
    ERC1155Burnable,
    ERC1155Supply,
    ERC2981,
