...
contract CSDOGEStaking is Ownable, ReentrancyGuard {
    ...
    function userStakeInfo(address _user)
        public
        view
        returns (uint256 _tokensStaked, uint256, uint256, uint256 _availableRewards)
    {
        return (stakers[_user].TotalAmountStaked, stakers[_user].unclaimedRewards, calculateRewards(_user), availableRewards(_user));
    }
