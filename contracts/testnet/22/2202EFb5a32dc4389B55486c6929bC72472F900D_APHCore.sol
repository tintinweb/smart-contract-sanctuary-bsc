...
contract CoreBorrowing is CoreBase, CoreBorrowingEvent {
    ...
    function calculateLTV(
        ...
        return ((borrowAmount + interestOwed) * WEI_UNIT * precision) / (collateralAmount * rate);
    }
    ...
    function _isLoanLTVExceedMaxLTV(
        ...
        return loanLTV > maxLTV ? true : false;
    }

    function _isLoanLTVExceedLiqLTV(
        uint256 borrowAmount,
        uint256 collateralAmount,
        uint256 interestOwed,
        uint256 liqLTV,
