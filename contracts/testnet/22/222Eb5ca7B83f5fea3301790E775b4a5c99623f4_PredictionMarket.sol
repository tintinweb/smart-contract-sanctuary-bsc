...
contract PredictionMarket is Ownable {
  ...
  event RequiredBalanceChanged(address indexed user, uint256 requiredBalance);
  ...
  function changeRequiredBalance(uint256 _requiredBalance) public onlyOwner() {
      requiredBalance = _requiredBalance.mul(10 ** 18);

      emit RequiredBalanceChanged(msg.sender, _requiredBalance);
  }
