...
contract BNBBets_Prediction is Ownable, Pausable, ReentrancyGuard {
    ...
    function claimHousePot() external nonReentrant onlyAdmin {
        uint256 currentHouseAmount = houseBetAmount;
        houseBetAmount = 0;
        _safeTransferBNB(adminAddress, currentHouseAmount);

        emit HouseClaim(adminAddress, currentHouseAmount);
    }
