...
contract MyNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    constructor() ERC721("ARTICollection721", "ARTICollection721") {}
    ...
    string memory _newURI
        ...
        address sellerNftBalance = ownerOf( _tokenId);

        require(sellerNftBalance == (msg.sender) , "Only NFT Owner can change the uri ");
