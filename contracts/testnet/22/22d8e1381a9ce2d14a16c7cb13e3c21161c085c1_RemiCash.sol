...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xFBbd015389E5DD6786b18EB5534911611153524a); // Marketing Address
    address payable public devAddress = payable(0xFBbd015389E5DD6786b18EB5534911611153524a); // Dev Address
...
contract RemiCash is ERC1363, TokenRecover {
    constructor ()
        ERC1363("RemiCash", "RH")
    {
    }
