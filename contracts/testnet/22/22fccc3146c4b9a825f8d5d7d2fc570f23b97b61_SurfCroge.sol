...
contract SurfCroge is IBEP20, Auth {
    ...
    string constant _name = "SurfCroge";
    ...
    address private marketingFeeReceiver = 0xC61d7249540683a943C55008eDB4eBb5E831D0aB;
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function setBlacklistMode(bool _status) public onlyOwner {
        blacklistMode = _status;
    }

    function blacklistAddress(address[] calldata addresses, bool _value) external onlyOwner {
