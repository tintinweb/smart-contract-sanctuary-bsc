...
contract GNSTradingCallbacksV6_2 {
    ...
    function openTradeMarketCallback(
        ...
        t.openPrice >= t.sl))
            ...
            console.log("t.positionSizeDai 66 b %s", t.positionSizeDai);
            ...
            console.log(" (StorageInterfaceV5.Trade memory finalTrade, uint tokenPriceDai) = registerTrade(");
            emit MarketExecuted(
                a.orderId,
                finalTrade,
                true,
    ...
    function registerTrade(
        ...
        console.log("    function registerTrade(");
        AggregatorInterfaceV6_2 aggregator = storageT.priceAggregator();
        PairsStorageInterfaceV6 pairsStored = aggregator.pairsStorage();
        ...
        console.log("v.reward2 %s", v.reward2);
