...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6C89627BB81E64358ceaBC4c04F6b88dB0427C59;
...
contract PICKGAS is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x6C89627BB81E64358ceaBC4c04F6b88dB0427C59;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "PickGas";
    string private _symbol = "PICK";
