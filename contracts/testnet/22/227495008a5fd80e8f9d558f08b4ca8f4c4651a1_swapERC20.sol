...
*/
//发布一个最简单的erc20到uniswap官网添加流动性
//已完成 中途BUG_transferfrom没有返回值导致 uniswap中safeTransferFrom方法返回值不满足 失败 改进添加返回值即可
...
contract swapERC20 is IERC20,tokenDetails("swaperc20","exerc",9){
  ...
  //0x227495008A5FD80E8F9D558f08B4Ca8f4C4651A1