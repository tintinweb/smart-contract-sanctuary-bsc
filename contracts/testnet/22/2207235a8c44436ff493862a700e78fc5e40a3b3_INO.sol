...
contract INO is Ownable, ReentrancyGuard {
     ...
     address public nftAdmin = 0x2add64A6077Aa946282Da263a839Dd0caA0D1668;
    ...
    function trade(uint _noofnfts) public payable nonReentrant {
        ...
        if (round == Round.Whitelistround) {
         ...
         require(_amount == msg.value, "incorrect amount");
          ...
          // check wiz balance 
          require (IERC20(wizard).balanceOf(msg.sender) >= wizardlimit, "Hold Wizard to Participate");
