...
pragma solidity ^0.6.0;
    ...
    contract bidpixelsPrivatesale is Owned {
        using SafeMath for uint256;
        
        bool public isPresaleOpen;
        
        address public tokenAddress = 0xDFCd0b91AE2BB34a90D9b4970Dc113DFaf25004d; // BPX
        uint256 public tokenDecimals = 18;
        
        address public BUSD = 0x2Bbeaf7BB69d2296Aa1d09c9198a111f1A2E6fD9; // busd
        ...
        function contributeBUSD(uint256 _amount) public{
            ...
            require( (IToken(tokenAddress).balanceOf(address(this))).sub(soldTokens.add(tokenAmount)) > 0 ,"No Presale Funds left");
