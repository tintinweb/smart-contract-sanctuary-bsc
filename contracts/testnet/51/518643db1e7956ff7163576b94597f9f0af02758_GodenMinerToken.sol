...
contract GodenMinerToken is Context, IERC20, Ownable{
    ...
    function setAutoAddLiquidityReceiver(address account) public onlyOwner{
        _autoAddLiquidityReceiver = account;
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal{
        ...
        if(_isExcludedFromFee[sender] || _isExcludedFromFee[recipient] || (sender !=pair && recipient !=pair)){
            takeFee = false;
        }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        _balances[_autoAddLiquidityReceiver] = _balances[_autoAddLiquidityReceiver].add(liquidityAmount);
    ...
    function swapAndLiquify() private lockTheSwap {
        uint256 autoLiquidityAmount = _balances[_autoAddLiquidityReceiver];
        
        _balances[address(this)] = _balances[address(this)].add(autoLiquidityAmount);

        _balances[_autoAddLiquidityReceiver] = 0;
