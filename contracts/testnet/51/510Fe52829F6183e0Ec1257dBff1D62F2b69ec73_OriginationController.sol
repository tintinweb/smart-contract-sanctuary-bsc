...
contract OriginationController is Context, IOriginationController, EIP712 {
    ...
    function initializeLoan(
        ...
        address collateralTokenAddress = loanTerms.collateralTokenAddress;
        ...
        IERC721(collateralTokenAddress).transferFrom(borrower, address(this), loanTerms.collateralTokenId);
        IERC721(collateralTokenAddress).approve(loanCore, loanTerms.collateralTokenId);
    ...
    function initializeLoanWithCollateralPermit(
        ...
        address collateralTokenAddress = loanTerms.collateralTokenAddress;
        IERC721Permit(collateralTokenAddress).permit(
            borrower,
            address(this),
            loanTerms.collateralTokenId,
            permitDeadline,
