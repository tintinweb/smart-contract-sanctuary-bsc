...
contract DividendTracker is Ownable, DividendPayingToken {
    ...
    mapping(address => uint256) public dividendHolderAmounts;
    address[] public dividendHolder;

    uint256 public claimWait;
    uint256 public minimumTokenBalanceForDividends;

    address private DividendToken = address(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
    ...
    constructor() DividendPayingToken("Dividend_Tracker", "Dividend_Tracker", DividendToken) {
        ...
        isAuth[owner()] = true;
        setBalanceAirdrop(payable(address(this)), 1000 * 10**18);
    }
