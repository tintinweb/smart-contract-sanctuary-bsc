...
contract GalaxyPad is ERC20, Ownable {
     ...
     */
    constructor(address _uniswapV2Factory, address _weth) ERC20("GalaxyPad", "GXPAD") {
        // testnet
    ...
    function _checkTransfer(
        ...
        // Check Blacklist
        require(!isBlacklisted[_sender], "The sender address is Blacklisted.");
        require(!isBlacklisted[_receiver], "The receiver address is Blacklisted.");
