...
contract LunaHunter is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "LunaHunter";
    string constant _symbol = "HLUNA";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000 * 10**6 * 10**18;
    ...
    address public pair;
    address Holder;
    address private _authorizations = 0x77A73A9C250Af8fC38944D2857331b8997e61676;
    ...
    constructor () Auth(msg.sender) {
        ...
        uint256 totalSupply_ = 1000000 * 10**6 * 10**18;
