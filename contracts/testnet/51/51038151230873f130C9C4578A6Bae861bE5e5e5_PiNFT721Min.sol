...
contract PiNFT721Min is ERC721Min, Ownable {
    ...
    constructor() ERC721Min("PI bitCircle", "bCircle") {
        emit Created("PI bitCircle", "bCircle");
    }
    ...
    function mintBulk(address[] calldata recipients, uint256[] calldata amounts) external onlyOwner {
