 ...
 *  - ability for tracking of total supply per id.
 ...
 *
 * Note: While a totalSupply of 1 might mean the
 * corresponding is an NFT, there is no guarantees that no other token with the
 * same id are not going to be minted.
 */
contract OVLChests is
    Context,
    AccessControlEnumerable,
    ERC1155Burnable,
    ERC1155Pausable,
    ERC1155Supply
{
     ...
     */
    constructor() ERC1155("https://metadata.overleague.com/chest/{id}") {
        name = "Overleague Chest";
        symbol = "OVLC";
        ...
        _mint(msg.sender, COMMON, 10**28, "");
        _mint(msg.sender, RARE, 10**28, "");
        _mint(msg.sender, EPIC, 10**28, "");
    }
    ...
    function mint(
        ...
        require(
            ...
            "ERC1155OVLChests: must have minter role to mint"
        );
    ...
    function pause() public virtual {
        require(
            ...
            "ERC1155OVLChests: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "ERC1155OVLChests: must have pauser role to unpause"
        );
        _unpause();
    }
    ...
    function setURI(string memory newuri) public virtual {
        require(
            ...
            "OVLChests: must have admin role to setURI"
        );
        _setURI(newuri);
    }
}