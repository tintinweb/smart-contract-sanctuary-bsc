...
contract TaxPool is Ownable {
  ...
  uint256 public stakingrewardPercentage = 2000; 
  address public stakingrewardWallet = 0x54A19C8d44cE38465FCDAB771Fc655d6b0cd465c;
  function setStakingreward (uint256 percent_, address wallet_) public onlyOwner {
     stakingrewardPercentage = percent_;
     stakingrewardWallet = wallet_; 
     }
  
  uint256 public marketingPercentage = 6000;
   address public marketingWallet = 0x2E7676D94B16B93b2771a0301e155B1396724515;
  ...
  uint256 public buybackandburnPercentage = 2000;
   address public buybackandburnWallet = 0xD7AADa41837446B307f198E8Af4bfD3cAEcf0e39;
  function setBuyandburn (uint256 percent_, address wallet_) public onlyOwner {
     buybackandburnPercentage = percent_;
      buybackandburnWallet = wallet_;
       }
  ...
  function distribute() public onlyOwner swapping {
    ...
    (bool sent_1, ) = payable(stakingrewardWallet).call{value: (amount * stakingrewardPercentage / maxPercent), gas: 30000}("");
    ...
    (bool sent_2, ) = payable(marketingWallet).call{value: (amount * marketingPercentage / maxPercent), gas: 30000}("");
     require(sent_2, "Transfer wallet_2 error.");
      balance = address(this).balance;
    (bool sent_3, ) = payable(buybackandburnWallet).call{value: (amount * buybackandburnPercentage / maxPercent), gas: 30000}(""); 
