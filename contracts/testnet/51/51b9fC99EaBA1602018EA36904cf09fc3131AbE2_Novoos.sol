...
contract Novoos is ERC20, Ownable, BaseToken {
    ...
    function _transfer(
        ...
        uint256 _tokenRewardsFee = tokenRewardsFee;
        ...
        if (takeFee) {
            ...
            if (automatedMarketMakerPairs[to]) {
                _totalFees = totalFees.add(sellMarketingFee).add(sellRewardsFee);
                _tokenRewardsFee = tokenRewardsFee.add(sellRewardsFee);
                _MarketingFee = marketingFee.add(sellMarketingFee); 
