...
contract DXBToken is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    ...
    string private constant _name = "DXB Coin";
    ...
    uint256 private previousTotalMarketingFee;
    ...
    function initialize() public initializer {
        ...
        marketingFee = 1;
        previousTotalMarketingFee = marketingFee;
    ...
    function _transfer(
        ...
        if((enableFee) && (!takeFeeStatus) && (from == uniswapV2Pair || to == uniswapV2Pair)) {
            takeFee = true;
        }
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) internal {
        ...
        takeMarketingFee(sender, rSwapFee, tSwapFee);
    ...
    function getTValues(uint256 amount) internal view returns (uint256, uint256, uint256) {
        ...
        uint256 tSwapFee = calculateMarketingFee(tAmount);
    ...
    function takeMarketingFee(address sender, uint256 rSwapFee, uint256 tSwapFee) internal {
    ...
    function restoreAllFee() internal {
        ...
        marketingFee = previousTotalMarketingFee;
    }
