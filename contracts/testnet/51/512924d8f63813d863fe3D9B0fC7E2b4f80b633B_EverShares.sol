...
contract EverShares is ERC20Burnable, Operator {
    ...
    constructor(uint256 _startTime, address _communityFund, address _devFund) ERC20("EVEREST Shares", "EVERSHARES") {
        _mint(msg.sender, 1 ether); // mint 1 EVEREST Share for initial pools deployment
