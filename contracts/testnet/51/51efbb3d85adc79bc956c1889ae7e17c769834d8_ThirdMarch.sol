...
contract ThirdMarch is Context, IERC20, Ownable {
    ...
    string private _name = "ThirdMarch";
    string private _symbol = "TMAR";
    ...
    function _transfer( address from, address to, uint256 amount ) private {
        ...
        require(amount < _SellLimit, "Amount exeeceded!");
