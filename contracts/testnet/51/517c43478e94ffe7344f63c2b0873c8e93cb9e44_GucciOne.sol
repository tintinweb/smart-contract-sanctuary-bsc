...
contract GucciOne is ERC20, Ownable {
//custom
...
//address
    ...
    address public marketingAddress = 0xD52389Bc32247eCA808288aDbAC4F2C8b10A46B5;
    address public teamAddress = 0xaAD40945e1E721cC43D3BeAbd4d7D60E536da8b1;
    address public buybackAddress = 0x2205871c7654CBE4Fb762A17F702b68824112dEA;
//uint
    ...
    uint public minimumTokensBeforeSwap = 150000000 * 10 ** 4 * 10 ** decimals();
    uint public tokensToSwap = 150000000 * 10 ** 4 * 10 ** decimals();
...
// constructor
    constructor() ERC20("GucciOne", "GUCCIONE") {
