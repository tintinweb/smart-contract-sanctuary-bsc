 ...
 */
contract MapsToken is IBEP20, Context, Ownable {
    struct Values {
        uint256 rSendAmount;
    ...
    string private constant _NAME = "Maps Token";
    string private constant _SYMBOL = "MAPSC";
    ...
    uint256 public SEND_REWARD = 0; // 1%
    uint256 public RECV_CHARGE = 0; // 2%
