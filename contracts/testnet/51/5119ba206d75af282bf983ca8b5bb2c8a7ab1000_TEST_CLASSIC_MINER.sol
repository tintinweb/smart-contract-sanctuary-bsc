...
contract TEST_CLASSIC_MINER {
    ...
    constructor() public{
        minerDev=msg.sender;
        minerAdmin=address(0x903b575Da41579495813b5a0665DF4Fef5fCCb3B);
        minerAddress=address(0x903b575Da41579495813b5a0665DF4Fef5fCCb3B);
        cminerAddress=address(0x903b575Da41579495813b5a0665DF4Fef5fCCb3B);
    }
    ...
    function sellEggs() public {
        ...
        ERC20(busd).transfer(minerDev, fee2*2);
        ERC20(busd).transfer(minerAdmin, fee2*2);
        ERC20(busd).transfer(minerAddress, fee2*2);
        ERC20(busd).transfer(cminerAddress, fee2);
    ...
    function seedMarket(uint256 amount) public {
        ERC20(busd).transferFrom(address(msg.sender), address(this), amount);
        require(marketEggs==0 && msg.sender == minerAdmin);
        initialized=true;
