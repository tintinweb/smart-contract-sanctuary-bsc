...
contract MetaZonex is ERC721, Ownable {
  using Strings for uint256;
  ...
  //public sale (stage=2)
  uint256 public salePrice = 2 ether;
  ...
  //sale holders
  address public fundRecipient = 0xA1ae8f9ed498c7EF353DD275b6F581fC76E72b8B;
  ...
  function mint_whitelist(uint8 _mintAmount, bytes memory signature) public payable {
    ...
    require(_mintAmount + presaleMintCount[msg.sender] <= presaleMintMax, "Cannot mint more than 3");
  ...
  function reserveMint(uint256 _mintAmount, address _to) public onlyOwner {
    require(totalSupply() + _mintAmount <= totalSaleSupply, "Mint exceed total supply");
