...
contract LevelStake is Initializable, OwnableUpgradeable, ILevelStake {
    ...
    address booster;
    uint256 boostedRewardPerSecond;
    uint256 boostedRewardEndTime;
    ...
    /**
     * @dev Return total rewards of LGO distribute per second.
     * @return The rewards.
     */
    function getTotalRewardPerSecond() public view returns (uint256) {
        if (block.timestamp > boostedRewardEndTime) {
            return rewardPerSecond;
        }
        return rewardPerSecond + boostedRewardPerSecond;
    }
