...
contract BNBCrown {
    ...
    function invest(address referrer, uint8 plan) public payable {
        ...
        // require(msg.value >= INVEST_MIN_AMOUNT);getResult(plan, msg.value);
        // uint256 lowest = getPlanLowest(lowest);
        // require(msg.value >= lowest);
    ...
    function getPlanLowest(uint8 plan) public view returns (uint256 lowest) {
        return plans[plan].lowest;
    }
