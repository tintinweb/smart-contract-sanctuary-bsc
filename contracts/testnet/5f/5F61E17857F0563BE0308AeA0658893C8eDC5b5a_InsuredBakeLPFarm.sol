...
contract InsuredBakeLPFarm is Ownable, ReentrancyGuard {
    ...
    ERC20 constant bakeLP = ERC20(0x9C77166445bA329A727B1ab946b173b19B149279);
    ERC20 constant bakeToken = ERC20(0x47384fa5bC3dd6572925296608e2de685855587C);
    ...
    BakeLPFarm constant bakePool = BakeLPFarm(0xde54328981Bc36e6d14421d8b80972A29C282609);
    
    OracleSimpleBNBBake bakeTwap = OracleSimpleBNBBake(0xd145837fAfdE4661A917Aa913a8007db2D764AEc);
    ...
    constructor() public {
        ...
        bakeToken.approve(address(ape), 2 ** 255);
    }
