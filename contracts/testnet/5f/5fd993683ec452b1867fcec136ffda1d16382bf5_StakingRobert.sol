...
contract StakingRobert {
    ...
    //     if (_laddress == BUSDA) {
    //         if (totalBalanceBUSD == 0) {
    //             return rewardPerTokenStoredBUSD;
    //         }
    //         return
    //             rewardPerTokenStoredBUSD +
    //             (((block.timestamp - lastUpdateTimeBUSD) * rewardRate * 1e18) / totalBalanceBUSD);
    ...
    //             (((block.timestamp - lastUpdateTimeUSDT) * rewardRate * 1e18) / totalBalanceUSDT);

    //     } else {
    //         if (totalBalanceBNB == 0) {
    //             return rewardPerTokenStoredBNB;
    //         }
    //         return
    //             rewardPerTokenStoredBNB +
    //             (((block.timestamp - lastUpdateTimeBNB) * rewardRate * 1e18) / totalBalanceBNB);
    //     }      
    // }
