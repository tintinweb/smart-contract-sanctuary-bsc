...
// File contracts/MetafameSale_Lottery_t.sol
...
*/
contract MetafameLotteryV0 is OwnableUpgradeable, PausableUpgradeable{
    ...
    */
    modifier senderCheck() {
        require(_msgSender() == adminAddress || _msgSender() == owner(), "Metafame721: Invalid msg sender");
        _;
    }
