...
contract Guess {
    ...
    struct TokenMeta {
        ...
        uint256 unlockAddRate; //eg:10
        uint256 unlockCycle_h; //eg:72
        ...
        returns (HtmlUserinfo memory userinfo)
    {
        ...
        if (_isHasNFT) {
            ...
            _userinfo.NFTunlockedTime = NFTunlockedTime[_tokenId];
            _userinfo.NFTunlockedTimes_cycle = NFTunlockedTimes_cycle[_tokenId];
    ...
    struct HtmlUserinfo {
        ...
        bool isNFTUsing;
        uint256 balance;
        uint256 NFTunlockedTime;
        uint256 NFTunlockedTimes_cycle;
        bool isNFTlocked;
