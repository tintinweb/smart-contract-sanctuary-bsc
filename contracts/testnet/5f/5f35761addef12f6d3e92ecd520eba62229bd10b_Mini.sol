...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0x9222D24274E912F4d5E889b460924C4fEFe97954);
    ...
    uint256 public minPeriod = 0 hours; // min 1 hour delay
    uint256 public minDistribution = 0 * (0 ** 18); // 1 ADA minimum auto send
    uint256 public minimumTokenBalanceForDividends = 10000 * (10**9); // user must hold 10,000 token
...
contract Mini is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Maxi";
    string constant _symbol = "MXLINUX";
    ...
    function swapBack() internal swapping {
        ...
        try router.swapExactTokensForETHSupportingFeeOnTransferTokens(
            ...
            payable(marketing).call{value: amountBNBMarketing, gas: 100000}("");
