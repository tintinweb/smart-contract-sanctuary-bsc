...
contract Stability is KeeperCompatibleInterface {
    ...
    uint256 public usdprice=0;

    uint public immutable interval;
    uint public lastTimeStamp;


    constructor(address _usdsctoken, uint updateInterval){
    ...
    function monitorBNBPrice() public returns (bool){
