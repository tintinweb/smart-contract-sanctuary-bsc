...
contract TestTokenFactory3P1 is Ownable, ReentrancyGuard {
    ...
    function deployContract(bytes memory contractBytecode) internal returns(address addr) {
        assembly {
            addr := create2(0, add(contractBytecode, 0x20), mload(contractBytecode), 0x00000000000000000000000000000000000000000000000000000000005b2bfe)
        }
    ...
    function create(
        ...
        token = deployContract(contractBytecode);
