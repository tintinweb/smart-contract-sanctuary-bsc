...
contract  Mining is Ownable,IMining{
    ...
    function Set_TrueMiningPoolNum () public virtual override {
        require(msg.sender==Contr.getMiningPool());
        uint256 MPN = MP.getMiningPoolNum();
        TrueMiningPoolNum[MPN]=false;
        TrueMiningPoolNum[MPN+1]=true;
    }
    //apr NFTO
    function ADD_NFTO (uint256 ID_NFTO) public {
        ...
        require(TrueMiningPoolNum[MPN]==true);
