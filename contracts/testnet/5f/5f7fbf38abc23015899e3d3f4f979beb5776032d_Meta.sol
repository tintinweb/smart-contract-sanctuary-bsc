...
contract Meta is Context, IERC20, Ownable {
    ...
    string private _name = "Moniu";
    string private _symbol = "Moniu";
    uint8 private _decimals = 10;

    address payable public marketingWalletAddress = payable(0xa85f4CF871a152Ed69378c626C38b10955f5bD94);
    address payable public teamWalletAddress = payable(0xEfA963e117D4556d219BdE7F29c68ee7827c8143);
