...
library Constants {
    ...
    address private constant DOLLAR_ADDRESS = address(0x0000000000000000000000000000000000000000);
    ...
    address private constant DIAMOND_HAND_ADDRESS = address(0x0000000000000000000000000000000000000000);
...
contract Dollar is IDollar, MinterRole, ERC20Detailed, Permittable, ERC20Burnable {
    ...
    constructor()
    ERC20Detailed("Empty Set Crypto", "ESC", 18)
    Permittable()
    public
    { }
...
contract Oracle is IOracle {
    ...
    function setup() public onlyDao {
        _pair = IUniswapV2Pair(IUniswapV2Factory(UNISWAP_FACTORY).createPair(_dollar, wcro()));
    ...
    function wcro() internal view returns (address) {
...
/*
    ...
    limitations under the License.
*/
contract Deployer1_2 is State, Permission, Upgradeable {
