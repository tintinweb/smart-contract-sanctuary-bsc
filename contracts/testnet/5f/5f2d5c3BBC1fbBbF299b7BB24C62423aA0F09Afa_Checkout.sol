...
contract Checkout is DeHubUpgradeable, ICheckout {
  ...
  mapping(bytes32 => uint256) public orderId2ReceiptId;
  ...
  function _purchaseByDeHubFor(
    ...
    bytes32 orderId32 = _stringHash(_orderId);
    ...
    orderId2ReceiptId[orderId32] = receiptId;

    emit Purchased(
      _forWhom,
      receiptId,
      uint256(Currency.DeHub),
      _priceInDeHub,
      _orderId,
      _metadataURI
    );
  ...
  function _purchaseByBNBFor(
    ...
    bytes32 orderId32 = _stringHash(_orderId);
    receiptId = receipt.mint(_forWhom, 0, msg.value, orderId32, _metadataURI);
  ...
  IReceipt
{
  ...
  function mint(
    ...
    return _mintFor(_to, _priceInDeHub, _priceInBNB, _orderId, _metadataURI);
  }
