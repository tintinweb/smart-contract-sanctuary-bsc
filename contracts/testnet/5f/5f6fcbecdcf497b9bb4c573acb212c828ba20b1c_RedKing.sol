...
contract RedKing is ERC20, Ownable {
    ...
    string public name_ = "swapping";//名称
    string public symbol_ = "false";//简称
    uint256 public totalSupply_ = 300000;//供应量 不用后面18位
    address public rewardAddr_ = 0x8516Fc284AEEaa0374E66037BD2309349FF728eA; //;//分红合约地址
    address public marketingWalletAddr_ = 0x3c63280f1c1987a3671d537e87d03110cF266506;//营销钱包地址
    ...
    event ifTakeFee(bool takeFee);

    event BuyOrSellFee(uint256 indexed LFee,uint256 indexed MFee,uint256 indexed DFee);
    ...
    constructor() payable ERC20(name_, symbol_)  {
        ...
        swapTokensAtAmount = totalSupply.mul(2).div(10**12);
    ...
    function _transfer(
        ...
        if(takeFee) {
            ...
            if(automatedMarketMakerPairs[from]){
                ...
                emit BuyOrSellFee(LFee,MFee,DFee);
            }
