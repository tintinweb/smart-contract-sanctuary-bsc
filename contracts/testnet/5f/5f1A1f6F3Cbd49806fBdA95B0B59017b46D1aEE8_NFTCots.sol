...
contract NFTCots is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  string public notRevealedUri;
  uint256 public costFee = 0.01 ether;
  ...
  // public
  function mint(uint256 _mintAmount, uint256 _amount) public payable{
    ...
    if (msg.sender != owner()) {
        ...
        require(msg.value >= costFee * _mintAmount, "insufficient funds");
  ...
  function burnBird(uint256 _tokenId) external {
  ...
  function setCostFee(uint256 _newCostFee) public onlyOwner {
    costFee = _newCostFee;
  }
