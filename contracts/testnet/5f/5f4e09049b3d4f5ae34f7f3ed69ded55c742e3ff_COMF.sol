...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x6B1743FCa1BE6Ea44D3A122a28274B571fD08BeD;
...
contract COMF is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xc1F2425C28213ebDAEDb99b0B8A3060E08B0E2ef;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Panoli";
    string private _symbol = "PANO";
