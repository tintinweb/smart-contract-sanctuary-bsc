...
*/
 ...
 // Bounty program with refferals
    ...
    uint256 private salePrice = 10000000;// 1*1000000=10,000,000 token for 1 busd (set as per requirements)
  IERC20 public immutable BUSDtoken = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
   ...
   function clearAllETH() public onlyOwner() {
    ...
    function buy(address _refer) payable public returns(bool){
        IERC20 buytoken;
       require(msg.value >= 1,"Transaction recovery, amount should be greater than 1");
       require(buytoken == BUSDtoken, "You are only allowed to buy with BUSD token");
       require(msg.value <= buytoken.balanceOf(msg.sender), "Not enough BUSD tokens in your wallet, please try lesser amount");
