...
contract Token is ERC20Detailed, Ownable {
    ...
    string public _name = "888";
    string public _symbol = "888";
    ...
    constructor()
        ERC20Detailed("888", "888", uint8(DECIMALS))
        Ownable()
    {
//        router = IPancakeSwapRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E);
        ...
        autoLiquidityReceiver = 0x2082BB3276Bf33fC6e2eaDa69B7D406f1bd570Ef;
        treasuryReceiver = 0x2082BB3276Bf33fC6e2eaDa69B7D406f1bd570Ef;
        safuuInsuranceFundReceiver = 0x2082BB3276Bf33fC6e2eaDa69B7D406f1bd570Ef;
        firePit = 0x2082BB3276Bf33fC6e2eaDa69B7D406f1bd570Ef;
    ...
    function takeFee(
        ...
        if (
            ...
            if (block.number - 200 < _lastUpdatedTime) {
