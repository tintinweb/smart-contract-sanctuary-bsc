...
//  SatoshiGOLD - SatoshiGOLD is a new revolutionary project that allows all SatoshiGOLD HODLERS to generate infinite passive rewards in the form of SatoshiGOLD and BNB!.
...
contract satoshi is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x1C1bbD342DB93feB4C616be005925717819b2666); // Marketing Address
    address payable public charityAddress = payable(0x1C1bbD342DB93feB4C616be005925717819b2666); // Charity/Dev Address
