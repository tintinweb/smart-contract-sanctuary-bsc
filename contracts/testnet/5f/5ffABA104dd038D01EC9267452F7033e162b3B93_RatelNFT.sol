...
contract RatelNFT is ERC721A, VRFConsumerBase, Ownable, ReentrancyGuard {
  ...
  uint public preSalePrice = 0.02 ether; //TODO，上线改为 0.2 ether;

  // price for publicsale stage (0.25 BNB)
  uint public publicSalePrice =  0.025 ether;  //TODO，上线改为 0.25 ether;
    ...
    returns(bool)
  {
    ...
    require(ratelGameToken.balanceOf(_msgSender()) >= _fee, "Insufficient token for breed" );
    ...
    emit OnRatelBreed(_msgSender(), newBabyId, maleTokenId, femaleTokenId);
    return true; 
  }
    ...
    online
  {
    ...
    //触发事件
    emit OnTakeGrownupRatel(_msgSender(), babyId);
  ...
  */
  function withdrawToken() public onlyOwner returns(bool){
    ...
    ratelGameToken.safeTransfer(_msgSender(), balance);
    return true; 
  }
    ...
    returns(bool)
  {
    ...
    emit OnBabyMarketItemCreated(itemId, babyId, _msgSender(), address(0), price, false);    
    return true;
  }
