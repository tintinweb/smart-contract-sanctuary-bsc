...
contract BakedPizza is Initializable {
    ...
    // функция для реинвестирования доходов
    ...
    function rebakePizza(address ref) public {
        ...
        claimedEggs[referrals[msg.sender]] = SafeMath.add(
            ...
            SafeMath.div(SafeMath.mul(eggsUsed, 12), 100)
        );
    ...
    //функция для продажи пиццы и получения bnb
    ...
    //функция для первичного инвестирования
    ...
    //рассчет количества пиццы за bnb (сколько bnb за количество пиццы)
    ...
    //сколько пиццы выйдет за количество bnb
    ...
    function addedFunction(uint256 abc) public pure returns (uint256) {
        return abc * 10000;
    }
}
