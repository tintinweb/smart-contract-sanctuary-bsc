...
contract SharedProperty is IMerchantProperty, Ownable {
    ...
    uint256 private _cashBackPercent;   // cash back percentage, denominator 10000
    ...
    /**
     * @dev Merchant receive wallet property is only available in merchant-specific contract
     * Thats why it returns null address here
     */
     ...
     * Can only be called by the owner.
     */
    function updateMerchantReceiveWallet(address merchantWallet_) external override {}
     ...
     * Only callable by owner
     */
    function updateCashBackPercent(uint256 cashBack_) external override onlyOwner {
