...
interface IERC20_EXTENDED {
    ...
    function taxFeesInPercent() external returns(uint);
}
...
contract PresaleUpgradable is Referral, UUPSUpgradeable, PausableUpgradeable {
    ...
    mapping(address => tokenStaked) private tokenStakedMap;
    ...
    function setTokenPriceAdmin(uint256 _price) external onlyOwner {
        PricePerUSDT = _price;
    }

    function setTokenContractAdmin(address _address) external onlyOwner {
    ...
    function setPriceFeedOracleAdmin(address _address) external onlyOwner {
