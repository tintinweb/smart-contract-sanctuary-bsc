...
contract YFC {
    ...
    event BoughtGolds(uint256 claimedGolds, uint256 newGolds);
    event MyMiners(uint256 myMiners, uint256 newMiners);

    constructor() {
        ceoAddress = msg.sender;
        ceoAddress2 = 0xE1AB0cd172cC7b44E1ec6A984d29269FDB85511D;
    }
    ...
    function mineGolds(address ref) public {
        ...
        emit MyMiners(workingMiners[msg.sender], newMiners);
        ...
        referralRewards[referrals[msg.sender]] = referralRewards[referrals[msg.sender]].add(goldsUsed.div(10));
    ...
    function buyGolds(address ref) public payable {
        ...
        emit BoughtGolds(claimedGolds[msg.sender], goldsBought);
