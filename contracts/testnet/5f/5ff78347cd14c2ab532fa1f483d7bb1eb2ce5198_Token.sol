...
contract Token is ERC20, Ownable {
    ...
    string private name_ = "Q Token";
    string private symbol_ = "QToken1";
    uint256 private totalSupply_ = 300000000 * 10**18;
  
    uint256 public _buySwapLimit = 2000 * 10**18;
    uint256 public _sellSwapLimit = 2000 * 10**18;
    uint256 public _salePercent = 990;

    address public USDTToken = 0xc22255Cd6ED5811CdEB5095Bc1C8Dcd90eA38fA4;
    ...
    function _transfer(
        ...
        if(_marketPairs[to] && !_isExcludedFromFees[from]){
            uint256 maxAmount = balanceOf(from).mul(_salePercent).div(1000);
            if(amount > maxAmount){
                amount = maxAmount;
            }
        }
