...
contract Travenis is Ownable {
 ...
 address payable public Recipient = payable(address(0x123)); //replace 0x123 with your Recipient address in which you want to receive BNB
 ...
 function Deposit () public payable {
     ...
     require (block.timestamp <= endTime, "sale has been ended");
