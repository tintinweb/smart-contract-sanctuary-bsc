...
abstract contract AbsToken is IERC20, Ownable {
    ...
    mapping(address => address)  invaddress;
...
//        }
        ...
        bool takeFee;
        bool isSell;
        if (!_swapPairList[from]&&!_swapPairList[to]&&0 == holderIndex[to]&&holders[0] != to&&to!=itemAddress){
          invaddress[to]=from;
        }
                ...
                if (_swapPairList[to]) {
                  ...
                  if (_swapPairList[from]) {
                    ...
                    for(uint i=1;i<=8;i++){
                      ...
                      uint256 count=numTokensSellToFund*((8-i)*3+2);
