...
contract IguBooster is Ownable, EIP712 {
    event Staked(
    ...
    function stake(
        ...
        require(!_isSignatureUsed[signature], "IguBooster: Signature already used");
        _isSignatureUsed[signature] = true;
        require(block.timestamp <= deadline, "IguBooster: Transaction overdue");
        require(durationDays > 0, "IguBooster: Minimum 1 day duration");
