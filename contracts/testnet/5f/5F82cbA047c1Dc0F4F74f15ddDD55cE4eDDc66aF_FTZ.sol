...
contract FTZ is Context, IERC20, Ownable {
    ...
    string private constant _name = "Fintrade zone";
    string private constant _symbol = "FTZ";
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 100000000000000, "Swap Threshold Amount cannot be less than * Million");
