...
// File: contracts/WithdrawalAccount.sol
...
contract WithdrawalAccount is Ownable {

    event Withdrawal(address user, uint256 amount);
    address public token;
    mapping(address => bool) operators;
    
    modifier onlyperator() {
    ...
    function withdrawal(address user, uint256 amount) external onlyperator{
       IERC20 tokenObj = IERC20(token);
       tokenObj.transfer(user, amount);
