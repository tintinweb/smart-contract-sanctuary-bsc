...
contract Test is ERC20, Ownable {
    ...
    function setMaxBuy(uint256 amount) external onlyOwner {
        require ( amount >= 4 * 10**8 * 10**9, "Can't set lower than 100 million tokens, no rug pull");
        maxBuyAmount = amount;
    }
...
require ( amount >= 4 * 10**10 * 10**9, "Can't set lower than 10 billion tokens, no rug pull");
