...
contract BTCS is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0xC36f2C90aE4849Bf9cd84bf4E7F193317aFF8e86;
    ...
    uint256 private numTokensSellToAddToLiquidity = 600000000 * 10**18;
	  uint256 private numTokensBurn = 2000000000000 * 10**18;
    ...
    constructor () {
        ...
        IPancakeSwapV2Router02 _pancakeSwapV2Router = IPancakeSwapV2Router02(0xB6BA90af76D139AB3170c7df0139636dB6120F7e);
