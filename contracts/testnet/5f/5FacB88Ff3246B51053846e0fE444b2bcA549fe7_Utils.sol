...
contract Utils is OwnableUpgradeable, PausableUpgradeable  {
    ...
    function initByOwner(VRFv2Consumer _v2Consumer) public onlyOwner{
    ...
    function randomV2VRF(uint256 from, uint256 to) public whenNotPaused  returns (uint256 ) {
        require(to > from, "Not correct input");
        uint256 _random = v2Consumer.getRandomWords();
        return from + _random.mod(to-from).add(1);
    }
