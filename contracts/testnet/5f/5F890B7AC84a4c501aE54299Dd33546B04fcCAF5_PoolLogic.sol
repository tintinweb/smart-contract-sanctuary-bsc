...
contract PoolLogic is ERC20ExtendedUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function swap(
        ...
        emit Swap(_tokenIn, _tokenOut, amountAfterFee, amountOut);
    }
    ...
    function __withdraw(
        ...
        if (!_isStablecoin) {
            ...
            uint256 amountAfterFee = __payProtocolFee(_denominationAsset, withdrawnAssets[0].amount);
...
library SwapLib {
    ...
    function __swapForWithdrawal(
        ...
        return __swap(_router, _tokenIn, _amountIn, amountOutmin[0], path, _to);
    }
