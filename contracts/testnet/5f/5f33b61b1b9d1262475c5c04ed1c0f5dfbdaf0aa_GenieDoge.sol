...
contract GenieDoge is ERC20, Ownable {
    ...
    uint256 public minBuyAmount = 750 ether;
    ...
    address operationsAddress = address(0x83243E27B0177D03280bD7454fA672D4AEf43E06); 
    ...
    constructor() payable ERC20("DogeGenie", "DOGEGENIE") {
        address newOwner = msg.sender;

        // Dex Main (DogeSwap)
        dexRouter = IDexRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1); //tutaj
    ...
    function updateMaxBuyAmount(uint256 newNum) external onlyOwner {
        require(newNum >= 1 && newNum <= 10, "Max buy amount cannot be lower than 0.1% or greater than 1%");
        maxBuyAmount = (totalSupply() * newNum) / 1000;
        emit UpdatedMaxBuyAmount(maxBuyAmount);
    }

    function updateMaxSellAmount(uint256 newNum) external onlyOwner {
        require(newNum >= 1 && newNum <= 10, "Max sell amount cannot be lower than 0.1% or greater than 1%");
