...
contract DividendDistributor is IDividendDistributor {
    ...
    function rescueToken(address token_,address recipient,uint256 amount) external onlyToken {
...
contract testv3 is Initializable,OwnableUpgradeable {
    ...
    function swapAndLiquify(uint _amount) private {
    ...
    function swapAndSendMFee(uint _amount) private {
        uint256 initalBalance = address(this).balance;
    ...
    function swapAndSendDFee(uint _amount) private {
        uint256 initalBalance = address(this).balance;
        swapTokenforBnb(_amount);
        uint256 recBalance = address(this).balance.sub(initalBalance);
    ...
    function swapAndSendReward(uint _amount) internal swapping {
        uint256 initalBalance = address(this).balance;
        swapTokenforBnb(_amount);
        uint256 recBalance = address(this).balance.sub(initalBalance);
    ...
    function DividendRescueToken(address token_,address recipient,uint256 amount) external onlyOwner {
