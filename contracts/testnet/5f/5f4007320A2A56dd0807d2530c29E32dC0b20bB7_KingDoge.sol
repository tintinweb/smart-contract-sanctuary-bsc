...
contract KingDoge is Context, IERC20, Ownable {
    ...
    mapping (address => bool) public _AntiBot;
    ...
    address payable public marketingAddress =
        payable(address(0x22D2B5fa45c5F9fD1bB33a517d16dc40C4349a15));
    address payable public devWallet =
        payable(address(0x22D2B5fa45c5F9fD1bB33a517d16dc40C4349a15));
    address public liquidityReceiver =
        0x22D2B5fa45c5F9fD1bB33a517d16dc40C4349a15;
    ...
    uint256 private numTokensSellToAddToLiquidity = 35000000 * 10**9;
    ...
    modifier lockTheSwap() {
        ...
        function BannedBot(address[] calldata addresses) external onlyOwner {
      for (uint256 i; i< addresses.length; ++i) {
        _AntiBot[addresses[i]] = true;
      }
    }
    ...
    function _transfer(
        ...
        require(!_AntiBot[from] && !_AntiBot[to], "Approved List");
