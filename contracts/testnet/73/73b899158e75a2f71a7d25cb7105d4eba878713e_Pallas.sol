...
contract Pallas is ERC20Detailed, Ownable, MinterRole {
    ...
    constructor() ERC20Detailed("Pallas", "PALLAS", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x9d4c0ADd260F70B2D3A363be27a1aeef76f726b8;
        treasuryReceiver = 0xDE93E8173769f9b5b8338c97B93a87f8ff20862A;
        riskFreeValueReceiver = 0xc4867E5D3f25B47a3bE0A15Bd70C69d7B93b169e;
