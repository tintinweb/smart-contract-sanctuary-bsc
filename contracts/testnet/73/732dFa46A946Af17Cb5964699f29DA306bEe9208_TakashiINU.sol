...
contract TakashiINU is IERC20, Ownable {
    ...
    uint256 maxCollectionTillSwap = 0; //Swap and add liquidity when this value is reached
    ...
    {
        // pancakeswapV2Router = IUniswapV2Router02(address(0x10ED43C718714eb63d5aA57B78B54704E256024E)); //For BSC Mainnet
        pancakeswapV2Router = IUniswapV2Router02(address(0xD99D1c33F9fC3444f8101754aBC46c52416550D1)); //For BSC TestNet
