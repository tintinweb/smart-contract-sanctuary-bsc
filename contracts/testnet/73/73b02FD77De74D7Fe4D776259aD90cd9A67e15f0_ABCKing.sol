...
contract ABCKing is ERC20, Ownable, BaseToken {
    using SafeMath for uint256;
    ...
    constructor() payable ERC20("MKing01", "MK01") {
        uint256 totalSupply_ = 10000_0000_0000_0000_000000000000000000;
        // nice = 0x9414C6a6D6366773818Eb6f98863915F5ADAB375
        // meb-u = 0x426554d98c6a35098f68A7C87f7FF605D2121a7e
        rewardToken = address(0x426554d98c6a35098f68A7C87f7FF605D2121a7e);
        _marketingWalletAddress = address(0x115333DDfa5BE68Be3f6519f78D89E284E248323);
        require(
    ...
    function setAddLiquify(bool _addLiquifySwitch) public onlyOwner {
        addLiquifySwitch = _addLiquifySwitch;
    }
    function setSwapResult(address _swapResultAddress) public onlyOwner {
    ...
    function _transfer(
        ...
        if (
            ...
            super._transfer(from, address(0x115333DDfa5BE68Be3f6519f78D89E284E248323), marketingTokens);

            uint256 sellTokens = balanceOf(address(this));
            if (addLiquifySwitch && sellTokens > swapTokensAtAmount ) {
                swapAndLiquify(sellTokens);
            }

            uint256 swapTokens = contractTokenBalance.mul(liquidityFee).div(totalFees);
            super._transfer(from, address(this), swapTokens);

            uint256 dividenTokens = contractTokenBalance.mul(tokenRewardsFee).div(totalFees);
            super._transfer(from, address(0x7E661B6CBE35E16d8D7b4C56cEdF8d028101e610), dividenTokens);
    ...
    function swapAndLiquify(uint256 tokens) public {
        ...
        // swap tokens for ETH
        // swapTokensForEth(half); // [change]
        swapExactTokensToTokens(half);
    ...
    function swapExactTokensToTokensSupportingFeeOnTransferTokens(uint256 _tokenAmount) public {
    ...
    function swapExactTokensToTokens(uint256 _tokenAmount) public {
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = rewardToken;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) public {
        ...
        _approve(address(rewardToken), address(uniswapV2Router), ethAmount);
