...
contract bigBaby is ERC20, Ownable {
    ...
    uint256 public totalBuyFee = buyRewardFee + buyMarketingFee + buyBuybackFee;
    uint256 public totalSellFee = sellRewardFee + sellMarketingFee + sellBuybackFee;
    ...
    event FeesBuyUpdated(uint256 buyRewardFee, uint256 buyMarketingFee, uint256 buyBuybackFee);
    event FeesSellUpdated(uint256 sellRewardFee, uint256 sellMarketingFee, uint256 sellBuybackFee);
    ...
    constructor() payable ERC20("BigBaby", "BBY") {
        require(totalBuyFee <= 20 && totalSellFee <= 20, "Fees must be less than 25%");
    ...
    function updateBuyFees(uint256 _buyRewardFee, uint256 _buyMarketingFee, uint256 _buyBuybackFee) external onlyOwner {
        require(_buyRewardFee + _buyMarketingFee + _buyBuybackFee <= 20, "Fees must be less than 20%");
        buyRewardFee = _buyRewardFee;
        buyMarketingFee = _buyMarketingFee;
        buyBuybackFee = _buyBuybackFee;
        totalBuyFee = buyRewardFee + buyMarketingFee + buyBuybackFee;
        emit FeesBuyUpdated(buyRewardFee, buyMarketingFee, buyBuybackFee);
    }

    function updateSellFees(uint256 _sellRewardFee, uint256 _sellMarketingFee, uint256 _sellBuybackFee) external onlyOwner {
        require(_sellRewardFee + _sellMarketingFee + _sellBuybackFee <= 20, "Fees must be less than 20%");
        sellRewardFee = _sellRewardFee;
        sellMarketingFee = _sellMarketingFee;
        sellBuybackFee = _sellBuybackFee;
        totalSellFee = sellRewardFee + sellMarketingFee + sellBuybackFee;
        emit FeesSellUpdated(sellRewardFee, sellMarketingFee, sellBuybackFee);
    }
