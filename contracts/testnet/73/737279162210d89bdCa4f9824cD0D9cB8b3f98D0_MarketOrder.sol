...
contract MarketOrder is Ownable, ReentrancyGuard {
    ...
    function marketBuy(uint _amount, address _token, address _pair, address _recipient) external payable nonReentrant returns (uint) {
        ...
        IWETH(WETH).transfer(_pair, _amount);
