...
contract MetaFashion is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xC2a5ea1d4406EC5fdd5eDFE0E13F59124C7e9803); // Marketing Address
    address payable public rewardAddress = payable(0xC2a5ea1d4406EC5fdd5eDFE0E13F59124C7e9803); // Reward Address
    address payable public liquidityAddress = payable(0xC2a5ea1d4406EC5fdd5eDFE0E13F59124C7e9803); // Liquidity Address
    ...
    function _transfer(
        ...
        if (
            ...
            require(from != address(uniswapV2Router) && to != address(uniswapV2Router), "You cannot add liquidity before trading active");
        }
