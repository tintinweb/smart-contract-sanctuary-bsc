...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDd0F9beee47a0f196A721f14787B726E7921E658;
...
contract Hara is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0x4f54C72bC84517D314FE8e27C4C3ECaE593CFC4F;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Harambians";
    string private _symbol = "Hans";
    uint8 private _decimals = 18;
    uint256 public _taxFee = 20; //RF
