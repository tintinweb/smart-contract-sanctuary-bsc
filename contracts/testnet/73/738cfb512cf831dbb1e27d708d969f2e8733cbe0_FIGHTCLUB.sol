...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x2b3Fa9d2C4F4961532018Cac39CBa9Dcbaf7CF0D); //manly test
...
contract FIGHTCLUB is IBEP20, Auth {
    ...
    string constant _name = "Fight Club Token";
    string constant _symbol = "FPT";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; //test
    address RewardToken = 0x2b3Fa9d2C4F4961532018Cac39CBa9Dcbaf7CF0D; //MANLYTEST

    uint256 _totalSupply = 555015300000 * (10 ** _decimals); //500B
    ...
    address public marketingWallet = 0x75D39e2da416973dfbcc9C0c2B00bFe057d3DBF8; //change
