...
contract Mining is MNT
{
    ...
    uint constant public cycle_period = 24 * 60 * 60;
    // lock time (2 hours)
    uint constant public lock_time = 30 * 60 * 60;

    // production
    /*
    uint public profit = 15 * 10000 * (10**decimals);
    //  Revenue cycle (one month)
    uint constant cycle_period = 2629746;
    // lock time (31 hours)
    uint constant lock_time = 32 * 24 * 60 * 60;
    */
