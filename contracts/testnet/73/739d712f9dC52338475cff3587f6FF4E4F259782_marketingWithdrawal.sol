...
contract marketingWithdrawal is Ownable, ReentrancyGuard {
    
    uint256 public lastWithdrawalTimestamp;
    AVR private _avrToken;
    
    mapping(address => uint8) private _marketingOwners;
    address[] private _ownersAddresses;

    constructor() {

        _marketingOwners[0xD783684ad1d0FEE4A4f5b038D09c6E7c9117659f] = 100;
    ...
    function sendRevenue(uint8 percent) public thirtyDaysPassed avrInstanceInited  onlyOwner nonReentrant returns(bool){
        ...
        for (uint i; i < _ownersAddresses.length;) {
            ...
            _avrToken.transfer(addressReceiver, allowedAmount * _marketingOwners[addressReceiver] / 100);
            unchecked {
                i++; 
                }
        }
