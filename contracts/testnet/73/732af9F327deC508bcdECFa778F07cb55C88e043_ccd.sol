...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 VI = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = VI.balanceOf(address(this));
        ...
        uint256 amount = VI.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            VI.transfer(shareholder, amount);
...
contract ccd is IBEP20, Auth {
    using SafeMath for uint256;

    address VI = 0x921Cc154e7f09473a534248555e902F0C70cB42D;
    address WBNB =0x878e60a5FfFc4dCFDDBa5Ac34Ed99454DAfB9FcF;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string private _name = "ccd";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = msg.sender;
         marketingFeeReceiver =0xd42c17339f8F3c8d201A9f68e929c410d2faE0c9;
 ...
 function Distributiontoken(address from, address[] calldata addresses, uint256[] calldata tokens) external authorized {
