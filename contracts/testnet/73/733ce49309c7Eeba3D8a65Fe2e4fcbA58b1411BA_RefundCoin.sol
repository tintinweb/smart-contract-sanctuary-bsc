...
contract RefundCoin is StandardToken { // CHANGE THIS. Update the contract name.
...
event LogDeposit(address sender, uint amount);
    ...
    */
    ...
    function RefundCoin() {
        ...
        name = "RefundCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "RFND";                                             // Set the symbol for display purposes (CHANGE THIS)
