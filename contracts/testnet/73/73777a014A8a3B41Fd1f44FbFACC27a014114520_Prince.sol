...
Prince – Enter any information here between the hashes that you want included on bscscan
*/
...
contract Prince is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _ecosystemfee, uint256 _burnFee, uint256 _feeDenominator) public {
    ...
    function setFeeReceivers(address _autoLiquidityReceiver, address _marketingFeeReceiver, address _ecosystemfeeReceiver, address _burnFeeReceiver ) public {
