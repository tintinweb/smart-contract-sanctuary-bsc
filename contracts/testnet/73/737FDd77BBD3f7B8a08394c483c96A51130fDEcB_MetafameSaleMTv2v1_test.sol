...
contract MetafameSaleMTv2v1_test is Initializable, ReentrancyGuardUpgradeable, OwnableUpgradeable, PausableUpgradeable, Status{
    ...
    function purchaseBoxPresale(
        ...
        payToken(busdPerBoxWL[tier], payType);
    ...
    function purchaseBoxPublicSale(
        ...
        payToken(busdPerBox[tier], payType);
