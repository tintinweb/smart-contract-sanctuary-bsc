...
contract PurgeTown is ERC20, Ownable {
    ...
    uint256 private _startSupply = 5000000000 * (10**18);
    uint256 private swapTokensAtAmount = 2000 * (10**18);
    ...
    function updateSwapTokensAtAmount(uint256 _swapTokensAtAmount) external onlyOwner {
        ...
        require(_swapTokensAtAmount <= 100000 * (10**18), "Max should be at 100000");
