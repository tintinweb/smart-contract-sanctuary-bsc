...
contract testv10 is Initializable, OwnableUpgradeable {
    using SafeMath for uint256;
    ...
    function takeFee(
        ...
        if (automatedMarketMakerPairs[sender]) {
            _realFee = _buyTax;
            feeAmount = gonAmount.mul(_realFee);
            ...
            _realFee = _sellTax;
            feeAmount = gonAmount.mul(_realFee).div(feeDenominator);
    ...
    function setter(uint256 _val) public {
        _sellTax = _val;
    }
