...
contract Flask_Withdrawer is Base, Adressable, Math, AccessControl, With_DAORole, With_TradeManagerRole, With_TradeRole,
                                With_PWRToken, With_BUSDToken, With_FundContract, I_Flask_Withdrawer{
    ////
    ////
    ////
    //////////////// Public variables ////////////////
    ...
    function askWithdraw(uint256 nbPWR) external{
        require(nbPWR > 0, "Flask_Withdrawer: Cannot withdraw 0 PWR");
        
        (, uint256 maxNbLockedPwr,, uint256 maxLockPercentNumerator, uint256[2][] memory lockDatas) = fund.getDataPWRLock(msg.sender);
        
        require(nbPWR <= maxNbLockedPwr, "Flask_Withdrawer: Not enough locked PWR");
        ...
        for(uint256 i=0; i<l; i++){
            ...
            require(!d.claimable, "Flask_Withdrawer: Trade already closed");
    ...
    function claimWithdraw() external{
        ...
        require(totalClaimableBUSD>0, "Flask_Withdrawer: no PWR withdraw to claim");
