...
*/
    ...
    event DATA3u(uint u1, uint u2, uint u3);
    event DATA1u(uint u1);
    event DATA2a1u(address u1, address u2, uint u3);
    ...
    function registerTrade(
        ...
        trade.positionSizeDai -= v.reward2;
            ...
            if(nftId < 1500){
                ...
                emit DATA2a1u(address(storageT), address(this), v.reward2);
        ...
        */
        ...
        return (trade, 1); // ESTE ES FAKE PARA Q NO PETE POR COMENTARIOS
    }
