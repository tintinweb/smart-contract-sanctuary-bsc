...
contract JackPay is ERC20Detailed, Ownable {
    ...
    string public constant _name = "Jack Pay";
    ...
    // At any given time, buy and sell fees can NOT exceed 20% each
    uint256 private constant TOTAL_FEES_LIMIT = 200;
    ...
    uint256 public jackPayInsuranceFundFee = 30;
    uint256 public treasuryFee = 30;
    uint256 public jackpotFee = 20;
    ...
    constructor()
        ERC20Detailed("Jack Pay", "JACK", uint8(DECIMALS))
        Ownable()
    {
        ...
        autoLiquidityReceiver = 0x57208E1f14B859ebab0e84870f15B710ab28e55F;
        treasuryReceiver = 0x39aF2D040E2400373d27B0aAB742F1003660f749;

        jackPayInsuranceFundReceiver = 0x224C09635a815744246ADEF155d93DaB1e509f85;
        buybackWallet = 0x424E5927Fd882eA3173cd251B2439305a78981D8;
