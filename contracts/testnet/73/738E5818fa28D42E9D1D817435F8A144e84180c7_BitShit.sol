...
* 1% Stake ← every buy transaction sends BitShit to the stake award pool.
...
* 1,000,000,000 ← fixed total supply.
* 0% Transfer ← zero transaction fees for sending and receiving.
* 2% Stake ← every sell transaction sends BitShit to the stake award pool.
...
contract BitShit is Context, IBEP20, Ownable {
    ...
    string private _name = "BitShit";
    string private _symbol = "BST";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 1 * 1e9 * 1e18; // 1 Billion
    ...
    uint256 public minTokenToSwap = 100000 * 1e18; // 100K
    uint256 public maxHolding = _totalSupply.mul(10).div(1000); // 1 max wallet
    ...
    //buying taxes
    uint256 public stakingFeeOnBuying = 30; // 3% will be added to the Marketing wallet
    ...
    //selling taxes
    uint256 public stakingFeeOnSelling = 30; // 3% will be added to the Marketing wallet
    ...
    constructor(address payable _stakingPool, address payable _devWallet) {
        ...
        IDexRouter _pancakeRouter = IDexRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);
