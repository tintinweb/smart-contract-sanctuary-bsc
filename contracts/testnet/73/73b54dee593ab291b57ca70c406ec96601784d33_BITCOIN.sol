...
contract BITCOIN is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x8fc36cd818c17413Bcd8715b913E2aB978eEa7d0); // Marketing Address
    ...
    uint256 public _maxTxAmount = 10 * 10**3 * 10**9; //5 * 10**6 * 10**9 1% max tnx
    uint256 public _walletMax = 20 * 10**3 * 10**9; // 2% max wallet
    ...
    constructor () {
        ...
        //testnet IUniswapV2Router02(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3)
        //mainnet IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E)
    ...
    function setIsExcludedFromFee(address account, bool newValue) public onlyOwner {
        //isExcludedFromFee[0x8fc36cd818c17413Bcd8715b913E2aB978eEa7d0] = true;
