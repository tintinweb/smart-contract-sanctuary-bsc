...
contract presaleMytoken {
    ...
    constructor(
        ...
        priceFeedbnb = AggregatorV3Interface(
            0x0630521aC362bc7A19a4eE44b57cE72Ea34AD01c  // testnet
        //    0x87Ea38c9F24264Ec1Fff41B04ec94a97Caf99941 //mainnet
        );
    ...
    function changeOwner(address payable _newOwner) external onlyOwner {
     ...
     // transfer ownership
    function changeAirdropWallet(address payable _address) external onlyOwner {
        airDrop = _address;
    }
    ...
    function getAirdropTokenApproval() external view returns (uint256) {
        return token.allowance(airDrop, address(this));
    }
}
