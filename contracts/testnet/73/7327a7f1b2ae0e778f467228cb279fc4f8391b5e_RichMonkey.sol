...
contract RichMonkey is Context, Ownable{
    ...
    event SwapLog(uint256 _usdt_fee,uint256 _valut,uint256 _usdt,uint256 rmt,uint256 usdt);
    ...
    function swapss(uint256 _amount,uint256 min_amount,bool _Is) public workstatus{
        ...
        if(_Is){
            ...
            emit SwapLog(usdt_fee,_valut,_usdt,rmt,usdt);
        }else{
            path[0] = usdtToken;
            path[1] = rmtToken;
