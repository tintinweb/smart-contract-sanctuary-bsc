...
contract OLIVEAI is BEP20, Ownable {
    ...
    address public marketingWallet = 0x793182e9bb932797484C0D25F2c90d120d990Ac8; 
    address public devWallet = 0xE0FadBfac8f3f24FE0d5c572264D602DB27a607B;
    address public missionWallet = 0x90f6BbcEe2bE7be96207B9CFACaae26aFf07e861;
    ...
    function Liquify(uint256 feeswap, Taxes memory swapTaxes) private lockTheSwap {
        ...
        if (contractBalance >= tokenLiquidityThreshold) {
            ...
            if (bbAmt > 0) {
                payable(missionWallet).sendValue(bbAmt);
            }
