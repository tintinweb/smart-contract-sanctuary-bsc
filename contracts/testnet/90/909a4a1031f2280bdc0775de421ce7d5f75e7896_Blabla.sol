...
contract TokenBEP20 is BEP20Interface, Owned{
 ...
 contract PausableToken is BEP20Interface, Pausable {
  
  function transfer(address _to, uint _tokens) public whenNotPaused returns (bool success) {
    return transfer(_to, _tokens);
  }
  
  function transferFrom(address _from, address _to, uint _tokens) public whenNotPaused returns (bool success) {
    return transferFrom(_from, _to, _tokens);
  }

  function approve(address _spender, uint _tokens) public whenNotPaused returns (bool success) {
    return approve(_spender, _tokens);
  }

  }

contract Blabla is TokenBEP20 {
