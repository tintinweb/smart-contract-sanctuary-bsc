...
contract Lottery is Ownable{
    ...
    uint public target_amount_default = 20000;
    uint public target_amount = target_amount_default;
    uint public max_buy_player = 10000;
    ...
    function MegaLottoTicket(address payable _addrinviter, address payable _addrplayer) public payable onGame{
        ...
        IDoublePrize(address_doubleprize).updatePlayers{value: value_super_prize}(payable(_addrplayer), msg.value);
    ...
    function pickWinner() private {
        ...
        isGameEnded = true;
        mapwinners[winner] = Winners(payable(winner), amount_draw, block.timestamp, draw_edition, index);
        winners.push(winner);
