...
contract PawSwap is Ownable, ReentrancyGuard {
    ...
    function addTokenTax (uint256 amount, TaxStruct memory taxStruct) private pure returns (uint256) {
        ...
        // if using pawswap, account for LP
        // if (taxStruct.router == pawSwapRouter) {
        //     uint256 dexPercentageTakenPostSwap = 20; // this is the LP tax and treasury tax for pawswap (0.2%)
        //     uint256 dexOtherPercentage = 10**4 - dexPercentageTakenPostSwap;
        //     minAmount = minAmount / dexOtherPercentage * 10**4;
        // } else if (!dexExcludedFromTreasury[taxStruct.router]) {
        //     uint256 dexPercentageTakenPostSwap = 30; // this is the LP tax and treasury tax for most other dex's (0.3%)
        //     uint256 dexOtherPercentage = 10**4 - dexPercentageTakenPostSwap;
        //     minAmount = minAmount / dexOtherPercentage * 10**4;
        // }
        return minAmount;
