...
library SafeMathInt {
    ...
    function mul(int256 a, int256 b) internal pure returns (int256) {
        ...
        require(c != MIN_INT256 || (a & MIN_INT256) != (b & MIN_INT256), "SafeMathInt: mul");
        require((b == 0) || (c / b == a), "SafeMathInt: mul zero");
        return c;
    }

    function div(int256 a, int256 b) internal pure returns (int256) {
        require(b != -1 || a != MIN_INT256, "SafeMathInt: div");
    ...
    function sub(int256 a, int256 b) internal pure returns (int256) {
        int256 c = a - b;
        require((b >= 0 && c <= a) || (b < 0 && c > a), "SafeMathInt: sub");
        return c;
    }

    function add(int256 a, int256 b) internal pure returns (int256) {
        int256 c = a + b;
        require((b >= 0 && c >= a) || (b < 0 && c < a), "SafeMathInt: add");
        return c;
    }

    function abs(int256 a) internal pure returns (int256) {
        require(a != MIN_INT256, "SafeMathInt: abs");
        return a < 0 ? -a : a;
    }
}
...
contract Ownable {
    ...
    function _transferOwnership(address newOwner) internal {
        require(newOwner != address(0), "onlyOwner: transferOwnership");
...
contract WaterFinance is ERC20Detailed, Ownable, MinterRole {
    ...
    modifier initialDistributionLock() {
        require(initialDistributionFinished || isOwner() || allowTransfer[msg.sender], "WaterFinance: initialDistributionLock");
        _;
    }

    modifier validRecipient(address to) {
        require(to != address(0x0), "WaterFinance: validRecipient");
        _;
    }
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0x3E6CbC990E509E09CDf64963E78FfadAca188b86;
        TreasuryReceiver = 0x3E6CbC990E509E09CDf64963E78FfadAca188b86;
        RiskFreeValueReceiver = 0x3E6CbC990E509E09CDf64963E78FfadAca188b86;
    ...
    function setFees(
        ...
        require(totalFee < feeDenominator / 4, "WaterFinance: setFees");
    }
