...
contract UNIFUNDS {
	...
	uint256 constant public PERCENT_STEP = 5; //0.5 daily
    ...
    bool public started;
	address payable public owner = 0x461E1426504adcE355F6616CEE98a14A8e4f8c85;
	...
	function withdraw(uint8 plan) public {
        ...
        uint256 reinvestAmount = totalAmount.div(6); 
