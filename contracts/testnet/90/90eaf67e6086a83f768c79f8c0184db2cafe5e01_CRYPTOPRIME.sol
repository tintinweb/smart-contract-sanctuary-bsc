/*
    ...
    // Telegram: https://t.me/Cryptoprimetoken 
    // Telegram: https://t.me/cryptoprimebr
*/
...
contract CRYPTOPRIME is ERC20, Ownable {
    ...
    address public marketingWallet = 0x259F07832bB5bF6926D851aFE19f962f7F2d061B;
    ...
    // Taxes fee:
    constructor() public ERC20("CPR", "CRYPTO PRIME") {
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        require(newDividendTracker.owner() == address(this), "CRYPTOPRIME: The new dividend tracker must be owned by the UR token contract");
...
contract CRYPTOPRIMEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("CRYPTOPRIME_Dividend_Tracker", "CRYPTOPRIME_Dividend_Tracker") {
        // TODO: Change this
    	claimWait = 3600;
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1 && newClaimWait <= 86400, "CRYPTOPRIME_Dividend_Tracker: claimWait must be updated to between 0 and 24 hours");
