...
contract PreSaleXYT is Ownable{
    ...
    function issueXYT() public onlyOwner returns(bool){
        ...
        for(uint256 i=0; i < length; i++){
            ...
            issueAmount = xytAmount[userAddr].mul(issuePercent.div(100));
            IERC20(XYTToken).transfer(userAddr, issueAmount);
            xytAmount[userAddr] = xytAmount[userAddr].sub(issueAmount);
        }
