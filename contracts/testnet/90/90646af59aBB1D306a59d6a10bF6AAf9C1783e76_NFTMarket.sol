    ...
    IBEP721Enumerable
{
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        ...
        require(
            _msgSender() == owner ||
                BEP721.isApprovedForAll(owner, _msgSender()),
        ...
        returns (bool)
    {
        ...
        return (spender == owner ||
            ...
            BEP721.isApprovedForAll(owner, spender));
    }
...
contract NFTMarket is BEP721 {
    ...
    address payable owner = payable(0x99D70F75aA0DeB7Fa35163E061250708aF88CF02);
    // define nft struct
    struct NFT {
        uint256 tokenId;
        string tokenURI;
    ...
    constructor() BEP721("FarazGhazi", "FG") {
        collectionName = name();
