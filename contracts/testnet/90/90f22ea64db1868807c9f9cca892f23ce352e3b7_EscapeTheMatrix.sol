...
contract EscapeTheMatrix is ERC20, Ownable {
    ...
    address public USD = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;//0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;
	...
	//transferOwnership(0x0475d06C9F700716CDfA47130E898eFF3ebe12Df);
        ...
        projectWallet = 0xa7BAF73F28612596B7e83DF8B7AC88831f4Bd615; //0x0475d06C9F700716CDfA47130E898eFF3ebe12Df;
...
//------------------Swap------------------//
    ...
    function swapLiquifyAndProject(uint256 contractTokenBalance) private {
        ...
        if(liquidityShare != 0 || projectShare != 0){
            ...
            uint256 totalTokenAmount = half + projectTokens;
            ...
            uniswapV2Router.addLiquidityETH{value: half}(
                address(this),
                otherHalf,
                0,
                0,
            ...
            payable(projectWallet).sendValue(newBalance-half);

            emit SwapLiquifyAndProject(totalTokenAmount,newBalance,otherHalf);
        }
