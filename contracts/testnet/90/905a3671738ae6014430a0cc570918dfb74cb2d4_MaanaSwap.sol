...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xace7E12F44c2f992c1b5251B26a9d1Ea50E7bf61;
    ...
    function updateOwnerAddress(address newOwner) public onlyOwner {
        _owner = newOwner;
    }
...
contract MaanaSwap is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xace7E12F44c2f992c1b5251B26a9d1Ea50E7bf61;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 100000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "Maana Swap";
    string private _symbol = "MAP";
