...
contract RaphHasAidsForEver is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 450_000 * 10**9;
    ...
    address public marketingWallet = 0xB256524efE2035EB9bEA906A3E73947e9BCF43cc;
    address public devWallet = 0xE138F55ca67C418505bd53Ddf96BC86c24f7Ca94; 
    address public operationWallet = 0xB256524efE2035EB9bEA906A3E73947e9BCF43cc; 
    address public charityWallet = 0xB256524efE2035EB9bEA906A3E73947e9BCF43cc; 

    string private constant _name = "RaphHasAidsForever";
    string private constant _symbol = "Raidss";
    ...
    Taxes public taxes = Taxes(0, 5, 2, 3, 0, 0);
    Taxes public sellTaxes = Taxes(0, 5, 3, 0, 0, 0);
    ...
    function setTradingStatus(bool state) external onlyOwner{
        ...
        swapEnabled = state;
        tTimer = block.timestamp + 3 minutes;
    }

    function antiBotTime() public view returns (uint){
        return block.timestamp < tTimer ? tTimer - block.timestamp : 0;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(block.timestamp < tTimer && !_isExcludedFromFee[from] && !_isExcludedFromFee[to]){
            _tokenTransfer(from, address(this), amount, false, false);
        }else{
