...
contract ClaimPoolFactory is IClaimPoolFactory, Adminable, ERC165Upgradeable {
    ...
    mapping(address => uint256) public maxClaimPoolOfUsers;
    ...
    function initialize(IClaimPool _templateClaimPool, address owner_) public initializer {
        __ERC165_init();
        __Adminable_init();
    ...
    function create(address _project, address _paymentToken, address _projectOwner) external onlyAdmin returns (address) {
        ...
        // initialize
        _claimPool.initialize(owner(), _project, _paymentToken, _projectOwner);
    ...
    function getClaimPoolLength() public view returns (uint256) {
