...
contract LpStakingPool is USDTWrapper,Ownable {
   using SafeMath for uint256;
    ...
    uint256 public totalOutput = 10000e18;
    uint256 public totalDuration = 60 * 60 * 24 * 1000;
    ...
    constructor()  {
        ...
        address inToken_ = 0x8CC0358f91B13c16003DB23Db39e40D3a45Def36;

        address outToken_ = 0xB214EE9F9c78c0Fe9A9A7AC5B82Aab8337c3b09d; 

        uint256 starttime_ = 1654444800;
