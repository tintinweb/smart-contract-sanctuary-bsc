    ...
    PausableUpgradeable
{
    ...
    uint256 public constant RATE_BASE = 1e9;
    ...
    // internal vars
    bool internal _canReceive;

    // constructor(IWETH weth_) {
    //     weth = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    // }

    function initialize(uint256 _feePercent, IERC20 _leslarTokenContract, IWETH _weth) public initializer {
    ...
    function setFee(uint256 _feePercent) external onlyRole(OPERATOR_ROLE) {
        require(
            _feePercent >= 0,
            "fee percentage must greater than or equal to zero"
        );
        feePercent = _feePercent;
    }
    ...
    function setTokenContract(IERC20 _leslarTokenContract)
        external
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function _newSellDeal(
        ...
        _transferBundle(id, seller, buyer);
