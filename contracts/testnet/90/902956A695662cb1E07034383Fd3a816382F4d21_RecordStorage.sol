...
contract RecordStorage is Ownable, ReentrancyGuardRecord {
    ...
    uint256 public merchantNeedCount = 100000000 * (10**18);// 商家
    uint256 public witnessNeedCount = 100000000 * (10**18);// 见证者
    uint256 public congressNeedCount = 100000000 * (10**18);// 国会议员
    ...
    // USDC -0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580da
