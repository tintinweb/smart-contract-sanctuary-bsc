...
contract Crowdsale is Context, ReentrancyGuard {
   ...
   function buyTokens() public payable nonReentrant {
        ...
        uint256 weiAmount = USDT.allowance(_msgSender(), address(this));
        require(weiAmount >= minBuy && weiAmount <= maxBuy,"please approve USDT according to limit");
        ...
        USDT.safeTransferFrom(_msgSender(), address(this), weiAmount);
