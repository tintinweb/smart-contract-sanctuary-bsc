...
abstract contract ERC20 is IERC20{
    ...
    mapping (address => mapping (address => uint)) _allowances; // owener => (spender => allowance)
    ...
    function _tranfer(address from, address to, uint amount) private {
...
contract BossToken is ERC20, Ownable {
    ...
    constructor() ERC20("Boss Token", "BOS") {
        admin = msg.sender;
    }
