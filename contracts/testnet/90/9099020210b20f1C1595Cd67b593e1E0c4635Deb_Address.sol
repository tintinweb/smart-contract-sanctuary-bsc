...
contract LAZYLAMBO is Context, IERC20, Ownable {
   ...
   //=======General=======//
    ...
    string private _name="Lazylambo";
    string private _symbol="Lazylambo";
    ...
    uint256 private taxFeeOnBuy = 2;
    uint256 private taxFeeOnSell = 2;
    uint256 private _previousTaxFeeOnBuy = taxFeeOnBuy;
    uint256 private _previousTaxFeeOnSell = taxFeeOnSell;

    
    uint256 private liquidityFee;
    uint256 public liquidityFeeOnBuy=2;
    uint256 public liquidityFeeOnSell=2;
    uint256 private _previousLiquidityFeeOnBuy = liquidityFeeOnBuy;
    uint256 private _previousLiquidityFeeOnSell = liquidityFeeOnSell;

    uint256 private marketingFee=3;
    uint256 public marketingFeeOnBuy=3;
    uint256 public marketingFeeOnSell=3;
    uint256 private _previousMarketingFeeOnBuy = marketingFeeOnBuy;
    uint256 private _previousMarketingFeeOnSell = marketingFeeOnSell;

    address public marketingWallet=0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3;

    uint256 public totalFeesOnBuy = taxFeeOnBuy + liquidityFeeOnBuy + marketingFeeOnBuy;
    uint256 public totalFeesOnSell = taxFeeOnSell + liquidityFeeOnSell + marketingFeeOnSell;
    ...
    function _takeLiquidity(uint256 tLiquidity) private returns(uint256){
        if (tLiquidity > 0) {
            uint256 currentRate =  _getRate();
            uint256 rLiquidity = tLiquidity * currentRate;
    ...
    function _takeMarketing(uint256 tMarketing) private returns(uint256){
        if (tMarketing > 0) {
            uint256 currentRate =  _getRate();
            uint256 rMarketing = tMarketing * currentRate;
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        uint256 mFee=_takeMarketing(tMarketing);        
        uint256 lFee=_takeLiquidity(tLiquidity);
    ...
    function setTaxFeePercentOnBuy(uint256 _taxFee) external onlyOwner() {
        taxFeeOnBuy = _taxFee;
        totalFeesOnBuy = taxFeeOnBuy + marketingFeeOnBuy + liquidityFeeOnBuy;
        require(totalFeesOnBuy <= 21, "Total fees must be less than 25%");
    }

    function setMarketingFeePercentOnBuy(uint256 _marketingFee) external onlyOwner() {
        marketingFeeOnBuy = _marketingFee;
        totalFeesOnBuy = taxFeeOnBuy + marketingFeeOnBuy + liquidityFeeOnBuy;
        require(totalFeesOnBuy <= 21, "Total fees must be less than 25%");
    }

    function setLiquidityFeePercentOnBuy(uint256 _liquidityFee) external onlyOwner() {
        liquidityFeeOnBuy = _liquidityFee;
        totalFeesOnBuy = taxFeeOnBuy + marketingFeeOnBuy + liquidityFeeOnBuy;
        require(totalFeesOnBuy <= 21, "Total fees must be less than 25%");
    }

    function setTaxFeePercentOnSell(uint256 _taxFee) external onlyOwner() {
        taxFeeOnSell = _taxFee;
        totalFeesOnSell = taxFeeOnSell + marketingFeeOnSell + liquidityFeeOnSell;
        require(totalFeesOnSell <= 21, "Total fees must be less than 25%");
    }

    function setMarketingFeePercentOnSell(uint256 _marketingFee) external onlyOwner() {
        marketingFeeOnSell = _marketingFee;
        totalFeesOnSell = taxFeeOnSell + marketingFeeOnSell + liquidityFeeOnSell;
        require(totalFeesOnSell <= 21, "Total fees must be less than 25%");
    }

    function setLiquidityFeePercentOnSell(uint256 _liquidityFee) external onlyOwner() {
