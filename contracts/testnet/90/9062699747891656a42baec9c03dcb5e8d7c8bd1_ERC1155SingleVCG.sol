...
contract ERC1155SingleVCG is ERC1155Base {
  event CreateERC1155SingleVCG(address owner, string name, string symbol);

  mapping(uint256 => address) tokenCreator;

  function __ERC1155SingleVCG_init(
    string memory _name,
    string memory _symbol,
    string memory _contractURI
  ) external initializer {
    __ERC1155SingleVCG_init_unchained(_name, _symbol, _contractURI);
    emit CreateERC1155SingleVCG(_msgSender(), _name, _symbol);
  }

  function __ERC1155SingleVCG_init_unchained(
    string memory _name,
    string memory _symbol,
    string memory _contractURI
  ) internal {
  ...
  function mint(
    ...
    _minting(account, _tokenId, amount, _tokenURI);
    tokenCreator[_tokenId] = creator;
  }
