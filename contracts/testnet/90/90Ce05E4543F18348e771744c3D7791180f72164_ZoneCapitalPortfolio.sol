...
import "./abtracts/FactoryOwnableUpgradeable.sol";

contract ZoneCapitalPortfolio is Initializable, FactoryOwnableUpgradeable {
    /// @dev Constructor
    ...
    function transfer(
        ...
        require(_recipient != address(0), "ZCP: INVALID_ADDRESS");
        console.log("Transfering");
        SafeERC20Upgradeable.safeTransfer(_token, _recipient, _amount);
    }
...
abstract contract FactoryOwnableUpgradeable is OwnableUpgradeable {
    ...
    modifier onlyFactory() {
        require(supportedFactories[msg.sender], "FOU: FORBIDDEN");
        _;
    }
    ...
    function addFactory(address _factory) external onlyOwner {
        require(_factory != address(0), "FOU: INVALID_ADDRESS");
    ...
    function removeFactory(address _factory) external onlyOwner {
        require(supportedFactories[_factory], "FOU: NOT_SUPPORTED");
