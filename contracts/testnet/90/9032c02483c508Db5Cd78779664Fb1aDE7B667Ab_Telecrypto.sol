...
contract Telecrypto {
    ...
    constructor() {
        BEP20 = IBEP20(0xeD24FC36d5Ee211Ea25A80239Fb8C4Cfd80f12Ee);
        Owner = msg.sender;
        Admin = msg.sender;
    ...
    //GameStates: 'open','closed','raffle','payed'
    ...
    //GameStates: 'open','closed','raffle','payed'
    function setGameWinner(uint256 _nrgame, address[] memory _winners, uint256[] memory _tickets) public {
