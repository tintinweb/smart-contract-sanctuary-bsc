...
contract TestimToken is ERC20Detailed, Ownable {
    ...
    uint256 public rewardYield = 10000000;
    ...
    uint256 private constant MAX_REBASE_FREQUENCY = 600;
    ...
    address public liquidityReceiver = 0xF3eDb861678eF2c0a9Ca6c3387795d261cb8c7B9;
    ...
    uint256 public totalBuyFee = liquidityFee.add(burnFee);
    ...
    constructor() ERC20Detailed("Testim DAO", "TESTIM", uint8(DECIMALS)) {
    ...
    function swapBack() internal swapping {
        ...
        emit SwapBack(contractTokenBalance, amountToLiquify);
    }
    ...
    function _rebase() private {
        ...
        if (deltaTimeFromInit < (1 days)) {
            rewardYield = 10000000;
        } else if (deltaTimeFromInit >= (1 days)) {
            rewardYield = 255000;
        }
    ...
    function setFeeReceivers(address _liquidityReceiver) external onlyOwner {
    ...
    event SwapBack(uint256 contractTokenBalance,uint256 amountToLiquify);
