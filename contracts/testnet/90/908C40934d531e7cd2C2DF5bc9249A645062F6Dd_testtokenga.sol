...
contract testtokenga is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress =
        payable(address(0x2B7Ed69dC1e9a69c909495101E2CB3A8490B1fB8));
    address payable public devWallet =
        payable(address(0x2B7Ed69dC1e9a69c909495101E2CB3A8490B1fB8));
    address public liquidityReceiver =
        0x2B7Ed69dC1e9a69c909495101E2CB3A8490B1fB8;
    address private fixedBurnAddress =
        0x0000000000000000000000000000000000000000;
    
    bool public burnDeductSupply = true;

    string private _name = "Test Token ga";
