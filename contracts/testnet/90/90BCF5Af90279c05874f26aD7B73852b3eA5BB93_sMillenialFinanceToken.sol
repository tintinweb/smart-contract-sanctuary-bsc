...
contract sMillenialFinanceToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked MillenialFinanceToken", "sMILL", 18) ERC20Permit() {
    ...
    /**
        @notice increases sBHD supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sBHD
