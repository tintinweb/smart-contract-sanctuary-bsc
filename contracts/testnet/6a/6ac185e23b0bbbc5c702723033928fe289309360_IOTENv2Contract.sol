...
contract IOTENv2Contract is Context, IBEP20, Ownable, ReentrancyGuard {
    ...
    uint256 private _tTotal = 10000000000* 1e18; // 30 trillion total supply
    ...
    uint256 public minTokenToSwap = _tTotal / 100000; // 0.001% will trigger swap
    ...
    function setNormalFeePercent(
        ...
        require(
            redistributionFee.add(liquidityFee).add(burnFee) <= 5,
            "BEP20: Can not be greater than max fee"
        );
    }
