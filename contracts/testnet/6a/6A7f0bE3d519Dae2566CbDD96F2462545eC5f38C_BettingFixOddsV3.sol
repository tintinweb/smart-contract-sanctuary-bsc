    ...
    BetTokenWrapper
{
    ...
    uint256 public _ODD_RATE_DENOMINATOR;
        ...
        require(
            initFee_ >=
                (whitelistTokenCharacteristic[betToken_].max *
                    counterpartOdd_) /
                    hostOdd_,
            "Error: initFee is not greater than  (_MAXIMUM_BET_AMOUNT * counterpartOdd_) / hostOdd_"
        );
