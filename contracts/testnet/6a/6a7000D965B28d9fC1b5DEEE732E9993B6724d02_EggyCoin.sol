...
contract EggyCoin is ERC20Detailed, Ownable {
    ...
    uint256 private constant MAX_SUPPLY = 1 * 10**20 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("EggyCoin", "Eggy", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x0D833C0e385d4900C386badEbe4020908E7cc2e8;
        treasuryReceiver = 0x7C2998db7Fc8F12E43D283C3bC8caA85b91353bD;   
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no Eggycoin token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
