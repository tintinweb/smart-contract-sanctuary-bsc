...
contract ThankMeLater is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 3288 * 10**9;
    ...
    constructor(
        ...
        address[3] memory addr //_market,_market2,Router,
    ...
    function setMarketAddress(address market,address market2) public onlyOwner {
        _market = market;
        _market2 = market2;
    }
    ...
    function _takeMarket(uint256 tMarket) private {
        ...
        uint256 tMarket1=tMarket.mul(3).div(4);
        uint256 tMarket2=tMarket.sub(tMarket1); 

        _balances[_market] = _balances[_market].add(tMarket1);
        _balances[_market2] = _balances[_market2].add(tMarket2); 
    }
