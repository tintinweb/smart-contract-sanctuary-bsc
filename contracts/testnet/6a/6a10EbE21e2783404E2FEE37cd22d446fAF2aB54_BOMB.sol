...
contract BOMB is Ownable {
   ...
   // mapping(address => bool) internal ambassadors_;
    ...
    uint8 public rewardInvitePool = 50;
    ...
    mapping(address => inviteLog) public inviteLogs;
    address[] public maxInviteUser;
    mapping(address => bool) inviteExit;
        ...
        if(inviteExit[inviteaddress] != true){
            if(maxInviteUser.length<20 && inviteLogs[inviteaddress].inum>0){
                ...
                for(uint8 i=1;i<maxInviteUser.length;i++){
                    ...
                    if(inviteLogs[tempAddress].inum<inviteLogs[inviteaddress].inum){
   ...
   // mapping(address => uint256) internal ambassadorAccumulatedQuota_;
    ...
    uint256 public freeTokenThisWeek=0;
