...
contract interfaceServer  is Ownable {
    ...
    address public businessBattleAddr = 0xbc1C7EB78C09B88603fCb4d8c3Af51f9d505AbB7;
    address public businessRecoverAddr = 0xb63356350131708F0C219435C0a96f63551A482D;

    event battleEvent(uint256 indexed isWin,EnhanceConfig indexed ec);
    event mintEvent(uint256 indexed tokenId,Attr indexed attr);
    ...
    function pvpbattle(uint from ,uint to) external{
        ...
        emit battleEvent(isWin,EnhanceConfig(coin,0,0));
