...
contract Glaki is IERC20, Ownable {
    bool public tradingEnabled;

    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;

    string public constant name = "Glaki";
    string public constant symbol = "Glaki";
    ...
    function setFeePercentage(uint8 feePercentage_) external onlyOwner {
        require(feePercentage_ <= 10, "Glaki: transaction fee percentage exceeds 10");
        require(feePercentage_ >= 0, "Glaki: transaction fee percentage equals 0");
