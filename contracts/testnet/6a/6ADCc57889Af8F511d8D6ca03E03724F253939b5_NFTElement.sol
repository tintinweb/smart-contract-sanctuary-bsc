...
// ERC721
// ERC721A
contract NFTElement is ERC721, INFT, Caller, Fallback {
    ...
    constructor(
        ...
        _init(config_, parent_, baseURI_, name__, symbol__);
    }
    ...
    function burn(uint256 tokenId) external override {
        require(ownerOf(tokenId) == msg.sender, "1084");
        _burn(tokenId);
    ...
    function getParent() external view override returns (INFT) {
        return parent;
    }

    function getChild() external pure override returns (INFT) {
