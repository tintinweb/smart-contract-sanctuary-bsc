...
contract Label2Earn is IBEP20, Auth {
   ...
   function setMaxWallet(uint256 amount) external onlyOwner() {
    ...
    function getFees() external pure returns (uint256 _liquidityFeeSell,  uint256 _marketingFeeSell, uint256 _burnFeeSell , uint256 _liquidityFeeBuy,  uint256 _marketingFeeBuy, uint256 _burnFeeBuy ,  uint256 _transferFee){
        return (_liquidityFeeSell, _marketingFeeSell ,_burnFeeSell,  _liquidityFeeBuy, _marketingFeeBuy, _burnFeeBuy , _transferFee);        
    }
