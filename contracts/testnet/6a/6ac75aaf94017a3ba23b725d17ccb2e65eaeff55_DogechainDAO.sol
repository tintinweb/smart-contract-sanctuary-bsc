...
contract DogechainDAO is ERC20Detailed, Ownable {
    ...
    uint256 public dogechaindaoTreasuryFee = 0;
    uint256 public dogechaindaoDefenceFee = 0;
    uint256 public sellFee = 0;
    uint256 public totalFee = liquidityFee.add(dogechaindaoTreasuryFee).add(dogechaindaoDefenceFee);
    uint256 public feeDenominator = 0;

    address public dogechaindaoTreasuryAddress;
    address public dogechaindaoDefenceAddress;
    ...
    constructor() ERC20Detailed("DogechainDAO", "$DDAO", uint8(DECIMALS)) Ownable() {
        ...
        dogechaindaoTreasuryAddress = 0x81Ee3c609Bb148c7F06b39437ac98a63108C38ad; 
        dogechaindaoDefenceAddress = 0x81Ee3c609Bb148c7F06b39437ac98a63108C38ad;
        ...
        _isFeeExempt[dogechaindaoTreasuryAddress] = true;
        _isFeeExempt[dogechaindaoDefenceAddress] = true;
    ...
    function setTaxes(uint256 _liquidityFee, 
        uint256 _dogechaindaoTreasuryFee, 
        uint256 _dogechaindaoDefenceFee, 
        uint256 _sellFee
    ) external onlyOwner {
        liquidityFee = _liquidityFee;
        dogechaindaoTreasuryFee = _dogechaindaoTreasuryFee;
        dogechaindaoDefenceFee = _dogechaindaoDefenceFee;
        sellFee = _sellFee;
        totalFee = liquidityFee.add(dogechaindaoTreasuryFee).add(dogechaindaoDefenceFee);
    }

    function setFeeReceivers(address _dogechaindaoTreasuryAddress, address _dogechaindaoDefenceAddress) external onlyOwner {
        dogechaindaoTreasuryAddress = _dogechaindaoTreasuryAddress;
        dogechaindaoDefenceAddress = _dogechaindaoDefenceAddress;
    }
    ...
    function swapAndLiquify() internal swapping {
        ...
        uint256 bnbForTreasury = bnbReceived.mul(dogechaindaoTreasuryFee).div(totalShares);
        ...
        if(bnbForTreasury > 0) {
            (success, ) = payable(dogechaindaoTreasuryAddress).call{
        ...
        if(bnbForDefence > 0) {
            (success, ) = payable(dogechaindaoDefenceAddress).call{
                value: bnbForDefence,
                gas: 30000
            }("");
        }
