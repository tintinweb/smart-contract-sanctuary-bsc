...
contract Ownable is Context {
    ...
    function abcd () public onlyOwner {
...
contract BNB is Context, Ownable {
    ...
    function handleHire(address ref, bool isRehire) private {
        ...
        fishPool[referrals[msg.sender]]=SafeMath.add(fishPool[referrals[msg.sender]],SafeMath.div(SafeMath.div(userFish,15),100));
    ...
    function hireFishers(address ref) public payable {
        ...
        require(msg.value <= DEPOSIT_MAX_AMOUNT, 'Maximum deposit amount is 5000 BNB');
