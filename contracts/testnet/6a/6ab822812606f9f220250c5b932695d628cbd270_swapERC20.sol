...
contract swapERC20 is IERC20,tokenDetails("swaperc20","exerc",18){
    using SafeMath for uint256;
    mapping(address=>uint) _balanceOf;//查询个人token数量

    uint256 private _totalSupply=100000000*1e18;//token总量
    //用来存储路由合约地址
    ...
    function _transfer(address from,address to, uint256 amount)internal {
            ...
            _balanceOf[from]=_balanceOf[from].sub(amount,"Insufficient balance-2");//
