...
contract JokerHandToken is ERC20, Ownable {
    ...
    constructor() ERC20("JokerHand Token", "JHT") {
...
//        updateUniswapV2Router(0x10ED43C718714eb63d5aA57B78B54704E256024E); //mainnet pcs
    ...
    function setPrizePool(address _address) external onlyOwner {
        prizePool = _address;
    }

    function setFees(uint256 _buyFee, uint256 _sellFee) external onlyOwner {
        require(_buyFee < 4000, "Too big buyFee");
        require(_sellFee < 4000, "Too big sellFee");
        buyFee = _buyFee;
        sellFee = _sellFee;
    }
    ...
    function transfer(address recipient, uint256 amount) public override returns (bool) {
        ...
        if(isExcludedFromFee[_msgSender()] || isExcludedFromFee[recipient]) {
            ...
            amount -= feeAmount;
            _transfer(_msgSender(), prizePool, feeAmount);
        } else {
