...
contract ERC721NFT is Ownable, ERC721A, ReentrancyGuard {
    ...
    bool public og_Sale = true;
    bytes32 private root;
    uint256 public maxToken = 3333;
    uint256 public og_price = 0.0004 ether;
    uint256 public public_price = 0.0008 ether;
    ...
    function OGmint(bytes32[] memory proof, uint256 _amount) external payable callerIsUser {
