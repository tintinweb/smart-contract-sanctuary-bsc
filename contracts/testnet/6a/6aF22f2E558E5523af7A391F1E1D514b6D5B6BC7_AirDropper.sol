...
contract AirDropper is Ownable, ReentrancyGuard, Pausable {
    address public OPERATOR;

    mapping(uint256 => uint256) public startReleaseTimestamps;
    mapping(uint256 => bytes32) public merkleRoots;
    mapping(uint256 => mapping(address => uint8)) public claimed;

    IERC20 constant GOEN = IERC20(0xE24Fb64c0113e90193F3ea85e4a349bE5Ce4e409);
    ...
    function unlock(
        ...
        require(_amount > 0, "zero unlock");
        GOEN.transfer(_account, _amount);
    ...
    event Unlock(uint256 seasonID, address account, uint256 amount);
}
