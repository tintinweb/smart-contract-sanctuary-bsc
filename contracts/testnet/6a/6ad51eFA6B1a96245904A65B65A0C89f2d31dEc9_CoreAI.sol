...
contract CoreAI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Core AI";
    string private _symbol = "CoreAI";
    ...
    address payable public marketingWalletAddress =
        payable(0x275E3179d61D47d6A85C521E7d40F4E35E936460); // Marketing Address
    address payable private teamWalletAddress =
        payable(0x7eff5f85ea53f294A2C671d3abDF59d8022efCD1); // Team Address
    ...
    function setTotalTaxIfBuying(uint256 value) public onlyOwner {
        require(value <= 30, "ERC20: Max Tax limit 3");
        _totalTaxIfBuying = value;
    }

    function setTotalTaxIfSelling(uint256 value) public onlyOwner {
        require(value <= 30, "ERC20: Max Tax limit 3");
    ...
    function _transfer(
        ...
        if (inSwapAndLiquify) {
            ...
            if (
                ...
                uint _sellReserveFeeAmount = amount.div(100).mul(
                    _sellReserveFee
                );
