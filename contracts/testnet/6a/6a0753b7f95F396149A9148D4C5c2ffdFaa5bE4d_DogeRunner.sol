...
contract DogeRunner  is ERC20Burnable, Ownable, AccessControlEnumerable {
    ...
    constructor (address _beneficiary, address _factoryAddress, address _pairToken) ERC20("Doge Runner", "$DR") {
        _mint(_msgSender(), 100_000_000_000 ether); // 100.000.000.000 $DR
