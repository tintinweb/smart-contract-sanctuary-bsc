...
contract Meta is Context, IERC20, Ownable {
    ...
    string private _name = "BNB3.0";
    string private _symbol = "BNB3.0";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0xA4a8438F00938e37ddf365311C83cC106AEFb4d7);
    address payable public teamWalletAddress = payable(0xCE9De96CBA46B5C17bE70C746463a5f487896665);
