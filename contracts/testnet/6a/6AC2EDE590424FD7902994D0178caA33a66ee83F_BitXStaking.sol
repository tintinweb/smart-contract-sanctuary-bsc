...
contract BitXStaking is ReentrancyGuard, Ownable {
    IERC20 public immutable bxg;
    ...
    uint256 miniStakingTime = 2592000;
    ...
    constructor(IERC20 _bxg, IBitXGoldSwap _pool) {
        bxg = _bxg;
        pool = _pool;
    }
    ...
    function stake(uint256 _amount) external nonReentrant returns (uint256) {
        ...
        require(
            (Staker[msg.sender].amountStaked + _amount) >= 20000000000000000000,
    ...
    function awardReferrals(address _staker, uint256 _amount) internal {
        ...
        // Incase of only two referrals
            ...
            reward1 = ((_amount * 700000000000000000) / 100000000000000000000);
            reward2 = ((_amount * 300000000000000000) / 100000000000000000000);
            pool.transferReward(
                StakedReferrals[_staker].firstReferral,
                reward1
            );
            ...
            reward1 = ((_amount * 700000000000000000) / 100000000000000000000);
            reward2 = ((_amount * 200000000000000000) / 100000000000000000000);
            reward3 = ((_amount * 100000000000000000) / 100000000000000000000);
            pool.transferReward(
                StakedReferrals[_staker].firstReferral,
                reward1
            );
