...
contract DividendDistributor is IDividendDistributor {
    ...
    // IERC20 BUSD = IERC20(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56); mainnet busd
...
contract SAFUFINANCE is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("safufinance", "SFA", uint8(DECIMALS)) Ownable() {
        ...
        marketingReceiver = 0x0Ca3Be8d394800D8B608cbEF02BF58F9B1D184f3;   
    ...
    function takeFee(
        ...
        _gonBalances[address(this)] = _gonBalances[address(this)].add(
            gonAmount.div(feeDenominator).mul(_marketingFee.add(DividendFeeBuy))
        );
