...
// SPDX-License-Identifier: None
    ...
    contract PlexusDAO is ERC20Detailed, Ownable {
        ...
        address private treasuryReceiver = 0x079cCf679F4150edF3c6Fb44C184C89a79cD6bE2;
        address private riskFreeValueReceiver = 0x13bd392f9abd6941F825e846346b264209369907;
        address private stakingFeeReceiver = 0xa94FCA74301b5760D5d4323db0910aA56b5F4992;
        
        address private constant busdToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; 
        ...
        //sellFee
        uint256 private sellFeeTreasury = 8;
        uint256 private sellFeeRFV = 3;
        ...
        uint256 private minSupplyForReferralReward = (INITIAL_FRAGMENTS_SUPPLY * 5) / 10000 ; 
        ...
        function takeBuyFee(address sender, address recipient, uint256 gonAmount) internal returns (uint256){
            ...
            else{referralFeeReceiver = address(this);} 
