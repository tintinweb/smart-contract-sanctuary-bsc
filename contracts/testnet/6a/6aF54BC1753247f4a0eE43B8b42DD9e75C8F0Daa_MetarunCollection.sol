...
contract MetarunClassifier is AccessControlUpgradeable {
    uint256 internal constant KIND_MASK = 0xffffffff0000;

    uint256 public constant CRAFTSMAN_CHARACTER_KIND = 0x00000000;
    uint256 public constant FIGHTER_CHARACTER_KIND = 0x00000001;
    uint256 public constant SPRINTER_CHARACTER_KIND = 0x00000002;

    uint256 public constant ARTIFACT_TOKEN_KIND = 0x00000100;
    uint256 public constant PET_TOKEN_KIND = 0x00000200;

    uint256 public constant COMMON_SKIN_KIND = 0x00000300;
    uint256 public constant RARE_SKIN_KIND = 0x00000301;
    uint256 public constant MYTHICAL_SKIN_KIND = 0x00000302;
    ...
    // uint256 public constant GLEAM_CLASSIC_COMMON = 0x00000600;
    // uint256 public constant GLEAM_CLASSIC_RARE = 0x00000601;
    // uint256 public constant GLEAM_CLASSIC_MYTHICAL = 0x00000602;
    // uint256 public constant GLEAM_EPIC_COMMON = 0x00000603;
    // uint256 public constant GLEAM_EPIC_RARE = 0x00000604;
    // uint256 public constant GLEAM_EPIC_MYTHICAL = 0x00000605;
    // uint256 public constant GLEAM_LEGENDARY_COMMON = 0x00000606;
    // uint256 public constant GLEAM_LEGENDARY_RARE = 0x00000607;
    // uint256 public constant GLEAM_LEGENDARY_MYTHICAL = 0x00000608;

    // uint256 public constant MISTERY_BOX_CLASSIC_COMMON = 0x00010600;
    // uint256 public constant MISTERY_BOX_CLASSIC_RARE = 0x00010601;
    // uint256 public constant MISTERY_BOX_CLASSIC_MYTHICAL = 0x00010602;
    // uint256 public constant MISTERY_BOX_EPIC_COMMON = 0x00010603;
    // uint256 public constant MISTERY_BOX_EPIC_RARE = 0x00010604;
    // uint256 public constant MISTERY_BOX_EPIC_MYTHICAL = 0x00010605;
    // uint256 public constant MISTERY_BOX_LEGENDARY_COMMON = 0x00010606;
    // uint256 public constant MISTERY_BOX_LEGENDARY_RARE = 0x00010607;
    // uint256 public constant MISTERY_BOX_LEGENDARY_MYTHICAL = 0x00010608;
...
import "contracts/MetarunClassifier.sol";
...
contract MetarunCollection is ERC1155Upgradeable, AccessControlUpgradeable, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable {
    MetarunClassifier public metarunClassifier;
    uint256 internal constant KIND_MASK = 0xffffffff0000; 
    ...
    function initialize(string memory uri, address metarunClassifierAddress) public initializer {
        __ERC1155_init(uri);
        metarunClassifier = MetarunClassifier(metarunClassifierAddress);
    ...
    function mintBatch(
        ...
        require(kind != 0x00000500, "UNSUITABLE_KIND");
        ...
        while (countOfReadyToMintIds < count) {
            require(metarunClassifier.isKind(currentTokenId, kind), "KIND_OVERFLOW");
    ...
    function getPerks(uint256 id) external view returns (Perks memory) {
        require(
            metarunClassifier.isGameToken(id) || metarunClassifier.isKind(id, 0x00000200),
            "HAS_NO_PERKS"
        );
    ...
    function setClassifier(address classifier) public {
        metarunClassifier = MetarunClassifier(classifier);
    }
}