...
contract Staking {
    ...
    function getAllStakesByAddress(uint256 _number, address _userAddress) public view returns(uint256 _amountByStakeId, uint256 _timeByStakeId , bool _flagByStakeId){
