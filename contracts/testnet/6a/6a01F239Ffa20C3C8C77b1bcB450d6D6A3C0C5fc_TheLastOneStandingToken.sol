...
// Game Wallets //
    ...
    uint8   private prizePoolFee;
    uint    private winnerPrize;

    address private marketingFeeReceiverAddress;
    uint8   private marketingFee;

    address private teamFeeReceiverAddress;
    uint8   private teamFee;
    uint8   private bucketPrizeFee;

    address private autoLiquidityReceiverAddress;
    uint8   private liquidityFee;
// Game Wallets //
//=====================================================================================//
// Player Information //
    struct Player {
...
// Owner Section //
    ...
    function setBuyAmount(uint newAmount) public onlyOwner{
    ...
    function setTaxFeeEnabled(bool _taxfee) public onlyOwner{
      taxFeeEnabled = _taxfee;
    }
    ...
    // SCISSOR > PAPER
    // PAPER > ROCK
    function PlayRounds() public onlyOwner{
      uint _id;
    ...
    function setDailyUpdate(uint newAmount) public onlyOwner{
      _dayGame++;
...
//Knowing if player is already registered into the current edition//
    function getPlayerRegistered(address playerAddress,uint editionId) view public returns (bool found) {
     uint _id = players.length - 1;
...
//Transfer taxes
  ...
  function _transfer(address sender, address  recipient, uint256 amount) internal virtual override {
    ...
    require(sender == owner() || recipient == owner(),"You shouldn't be trading right now");
    super._transfer(sender, recipient, amount);
    }
  }
}