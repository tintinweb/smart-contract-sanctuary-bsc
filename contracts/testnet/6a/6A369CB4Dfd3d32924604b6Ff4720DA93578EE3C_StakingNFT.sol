...
contract StakingNFT is Upgradable721 {
    ...
    */
    function stakeNFT721(string[] memory strs, uint256[] memory tokenIds) external poolExist(strs[0]) notBlocked payable{
        ...
        // Transfer tax fee
        _transferTaxFee();
        emit StakeNFT(pool.stakingToken, msg.sender, address(this), tokenIds, strs);
    }
    ...
    */
    function unstakeNFT(string[] memory strs, uint256 tokenId) external poolExist(strs[0]) notBlocked payable {
        ...
        // Transfer tax fee
        _transferTaxFee();
        emit StakeNFT(pool.stakingToken,address(this), msg.sender, t, strs);
    }
    ...
    */
    ...
    function initialize() external {
        trustPayAddress = 0x69c542320AcF7B64b620361c8eECc3D1777F127c;
