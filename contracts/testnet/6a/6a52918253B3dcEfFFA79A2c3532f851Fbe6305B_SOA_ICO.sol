...
contract SOA_ICO is Ownable {
  using SafeMath for uint256;
  Token token;

  uint256 public  RATE = 10000; // Number of tokens per 1 BNB
  uint256 public  CAP = 1000; // Cap in BNB 
  uint256 public  START = 1657576777; // July 11, 2022,  11:00 PM (GMT+1)
  uint256 public  DAYS = 30; // 30 Days 
  // The minimum amount of Wei you must pay to participate in the SOA_ICO
