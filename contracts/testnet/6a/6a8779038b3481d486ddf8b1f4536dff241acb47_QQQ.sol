...
// Check after token transfer _msgSender() = pancakePair
// Check enableAutoSwapAndLiquify(  excludeFromReward(

// SET REWARD ENABLED AT THE STARTING
// SET SWAP AND LIQUIFY ENABLED
// CHECK MAX SENDING AMOUNT LIMIT
// STATE UPDATE CHeck

// CHECK BURN ADDRESS REFLECTION
...
contract QQQ is Context, IERC20, Ownable {
    ...
    uint8 public _taxLiquify = 10;
    uint8 public _devTax = 10;

    bool public swapAndLiquifyEnabled = true;

    uint256 private _minTokensBeforeSwap = 5 * (10**5) * (10**_decimals);
    ...
    /* function deliver(uint256 tAmount) public {
        ...
        _totalRewarded = _totalRewarded.add(tAmount);
    } */
    ...
    function enableAutoSwapAndLiquify(
        ...
        _pancakePair = IPancakeFactory(pancakeRouter.factory()).getPair(
            address(this),
            pancakeRouter.WETH()
        );
