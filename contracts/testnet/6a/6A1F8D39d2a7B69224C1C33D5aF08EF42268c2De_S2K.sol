...
contract S2K is ERC20, Ownable{
    ...
    address public marketingWallet = 0xADEc5d194552643aC2ba0e7c642526219Ed79cF2;
    ...
    constructor() ERC20("Sports 2K75", "S2K") {
        _mint(msg.sender, 50000000000000 * 10 ** decimals());
        excludedFromFees[msg.sender] = true;



        IRouter _router = IRouter(0xCc7aDc94F3D80127849D2b41b6439b7CF1eB4Ae0);
