...
contract MOON0603 is ERC20, Ownable {
    ...
    constructor() payable ERC20("MOON0603 ", "MOON") {

        rewardToken = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; // BUSD
        ...
        treasuryWallet = 0xbFC35bCc99A26BF744AcE3078022DE62E10c8a21;
    ...
    function updateSellFees(uint256 _liquidityFeeOnSell, uint256 _treasuryFeeOnSell, uint256 _rewardsFeeOnSell) external onlyOwner {
        ...
        require(totalSellFee <= 15, "Sell fee cannot be more than 15%");
