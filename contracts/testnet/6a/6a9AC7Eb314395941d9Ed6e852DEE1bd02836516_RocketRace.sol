...
contract RocketRace is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable {
    uint256 public _taxFee = 0; // 1.1%
    address _taxAddress = 0x93A364BcA26F754DaBF95fC5Ac3cb62196b65590;

    constructor() ERC20("Rocket OneHour", "ROH") {
    ...
    {
        {
            uint256 taxAmount = (amount * _taxFee) / 100 / 1000;
