...
contract DistributeAmounts is OwnableUpgradeable, ReentrancyGuardUpgradeable, IAmountsDistributor {
    ...
    event DistributionReceiverAddressesSet(address[10] indexed nftContractAddresses);
    ...
    function setNFTContractAddresses(address[4] calldata _nftContractAddresses) external onlyOwner {
        ...
        gymNetworkAddress = _nftContractAddresses[3];
    ...
    function setDistributionReceiverAddresses(address[10] calldata _distributionReceiverAddresses) external onlyOwner {
