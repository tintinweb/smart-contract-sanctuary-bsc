...
contract Market is Ownable {
    ...
    function sellToken(uint256 tokenId, uint256 price, uint32 expireTime)  NFTContractMustSet tokenApproved(tokenId) public {
    ...
    function buyToken(uint256 tokenId) NFTContractMustSet tokenApproved(tokenId) public payable {
        TokenSellingInfo memory sellingInfo = tokens[tokenId];
