...
contract CyberMiner {
    ...
    uint256 public SECONDS_WORK_MINER = 2592000; 
    uint256 PSN = 10000;
    uint256 PSNH = 5000;
    uint256 private mDep = 50000000000000000000;  // min dep
    uint256 public Dop = 0; // tvl to 0 
    uint256 public countUsers = 0;  
    uint256 public deals = 0; 
    uint256 public volume = 0; 

    uint256[] public REFERRAL_PERCENTS_BUY = [8, 5, 4, 2, 1, 1]; 
    uint256[] public REFERRAL_PERCENTS_SELL = [0, 0, 0, 1, 1, 1]; 
...
struct User {
    ...
    function sellTokens(uint256 amountSell) public {
        ...
        usersMiner[msg.sender] = SafeMath.mul(SafeMath.div(usersMiner[msg.sender],100),90);
    }
