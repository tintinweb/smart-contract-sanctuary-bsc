...
contract FMEV2 is Context, IERC20, Ownable {
    ...
    string private _name = "Fantasy Girl";
    string private _symbol = "FMEV2";
    ...
    address payable public marketingWallet = payable(0x82A4C9437C7aA6711b79e8916820a86761c43619);
