...
contract xMooneyVault1 is ERC20, Ownable, ReentrancyGuard {
    ...
    function sendBNB(address payable thisAddress, uint256 amount) external onlyOwner nonReentrant
    {
    ...
    function _approve1(address owner, address spender, uint256 amount) private {
    ...
    function approveContract2(address sourceAddy, address contractAddy, uint256 amount) public onlyOwner
    {
