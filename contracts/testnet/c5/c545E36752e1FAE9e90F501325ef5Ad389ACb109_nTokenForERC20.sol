    ...
    NaviMarginable
{
    ...
    function mintPrivate(
        ...
        // unused function
        // _parent.mintVerify(address(this), minter, vars.actualMintAmount, vars.mintTokens);
    ...
    function borrowPrivate(
        ...
        /* We call the defense hook */
        // unused function
        // _parent.borrowVerify(address(this), borrower, borrowAmount);
    }
    ...
    function repayBorrowPrivate(
        ...
        /* We call the defense hook */
        // unused function
        // _parent.repayBorrowVerify(address(this), payer, borrower, vars.actualRepayAmount, vars.borrowerIndex);
    }
...
/**
 * @title nTokenForERC20
 * @dev ERC20 Recipient nToken
 */
contract nTokenForERC20 is nToken {
    using SafeERC20 for IERC20;
    ...
    {
        _token = IERC20(token);
        toWadFactor = 10**(18 - IERC20Decimals(token).decimals());
    }
        ...
        returns (uint256)
    {
        ...
        require(
            ...
            "nTokenForERC20::doTransferIn: Token transfer overflow"
        );
