    ...
    ERC721BurnableUpgradeable
{
    ...
    uint256 private DPLTserviceValue;
    address private DPLTAddress;
    string private _currentBaseURI;
    uint256 public _tid;
    uint256 deci;
    function initialize() public initializer  {
        __Ownable_init();
        ERC721Upgradeable.__ERC721_init("DPLT", "DPLT");
        _tid = 1;
    ...
    function DPLTserviceFunction(uint256 _DPLTserviceValue) public onlyOwner{
        DPLTserviceValue = _DPLTserviceValue;
    }
     function setTokenAddress(address _DPLTAddress) public onlyOwner{
         DPLTAddress = _DPLTAddress;
    }
    function getDPLTServiceFee() public view returns(uint256){
        return DPLTserviceValue;
    }
    ...
    function newtokenasbid(string memory tokenAss,address from, address admin, uint256 amount, uint256 tokenId,address tokenAddress) internal {
        ...
        if(tokenAddress == DPLTAddress ){
            fee = DPLTserviceValue;
        }
