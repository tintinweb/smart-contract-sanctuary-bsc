...
contract TiTDAO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public lpRewardToken = 0xEdA5dA0050e21e9E34fadb1075986Af1370c7BDb; 

    address public _devAddress = 0xa075fbbbeef7d4D7C1c6Dc5e6ee389F2cD0dF274;

    address public _devAddress2 = 0xa075fbbbeef7d4D7C1c6Dc5e6ee389F2cD0dF274;
   ...
   TokenDividendTracker public dividendTracker;
    ...
    uint256 distributorGas = 160000;

     uint256 public _maxTxAmount = 200 * 10**18;
    uint256 public _sellMaxTxAmount = 100 * 10**18;

    uint256 public _inviteTxAmount = 100 * 10**18;
    ...
    constructor() payable ERC20("TiTDAO", "TiTDAO") {
  ...
  function setBuyLiquidityFee(uint256 val) public onlyOwner {
   ...
   function swapAndSendToFee(uint256 tokens) private lockTheSwap{
        ...
        (bool success,) = address(_devAddress).call{value: initialBalance}("");
        if(success){
