...
contract FIST is Context, IERC20, Ownable {
    ...
    address payable private _anotherA = payable(0x6777EBb62C4F27316a76370a34fAc0aF00A43deb); 
    address payable private teamWalletAddress = payable(0xd858f9c6868Eb09E15451061D575b89Eb1dF2cC5); 
    ...
    uint256 private _totalSupply = 1 * 388 * 10**_decimals;
