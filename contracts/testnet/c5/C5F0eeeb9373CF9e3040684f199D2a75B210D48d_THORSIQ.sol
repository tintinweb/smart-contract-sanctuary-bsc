...
//Contract
contract THORSIQ is IBEP20, Ownable {
    ...
    string private constant _name = 'THORSIQ';  
    string private constant _symbol = 'TIG';    
    uint8 private constant _decimals = 18;
    uint256 public constant _totalSupply= 100000000 * 10**_decimals;
    uint256 public _circulatingSupply=_totalSupply;    
    uint8 private constant MaxWalletDivider=50; //3% = 20,000,000
    uint16 private constant SellLimitDivider=50; //3% = 20,000,000
    ...
    address public MiscReward=0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47;    //Only MiscReward can be changed to BNB
...
/////////////////////////////   DISPLAY INFO  /////////////////////////////////////////
    ...
    function getLimits() public view returns(uint256 balance, uint256 sell){
        return(MaxWallet/30, sellLimit/30);
    }  
    ...
    function getTaxes() public view returns(uint256 burnTax, uint256 buybackTax, uint256 devTax, uint256 marketingTax, uint256 liquidityTax,uint256 rewardsTax, uint256 buyTax, uint256 sellTax){
        return (_burnTax, _buyBackTax, _devTax, _marketingTax,_liquidityTax,_stakingTax,_buyTax,_sellTax);
    }    
