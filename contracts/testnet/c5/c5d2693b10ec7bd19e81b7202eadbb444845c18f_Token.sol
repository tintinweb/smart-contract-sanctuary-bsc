...
contract Token {
    ...
    constructor() {
        name = "RektHesh"; // Sets the name of the token, i.e Ether
        symbol = "RHX"; // Sets the symbol of the token, i.e ETH
        decimals = 18; // Sets the number of decimal places
        uint256 _initialSupply = 2200000*10**18; // Holds an initial supply of coins
