...
// File: busdygrowV2.sol


/**
BUSDY GROW. Extreme BUSD Rewards. https://t.me/BusdyGrowOfficial
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IDEXRouter router;
    //TestNet
    //address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; main:0x10ED43C718714eb63d5aA57B78B54704E256024E
...
contract BusdyGROW is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "BUSDY GROW";
    string constant _symbol = "BUSDYG";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    //Testnet
    //address routerAddress = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingWallet = 0x6Aa7664993Be5A4145D541576524a5102A6052c2;
        buybackWallet = 0x6Aa7664993Be5A4145D541576524a5102A6052c2;
