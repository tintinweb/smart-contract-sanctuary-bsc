...
contract GToken is ERC20Upgradeable, ERC4626Upgradeable, OwnableUpgradeable, IGToken {
    ...
    function initialize(
        ...
        lossesDevFeesP = 1000000000000000000; // 1%
    ...
    modifier checks(uint assetsOrShares) {
        require(shareToAssetsPrice > 0, "");
        require(assetsOrShares > 0, "");
        _;
    }

    modifier validDiscount(uint lockDuration) {
        require(maxDiscountP > 0, "");
        require(lockDuration >= MIN_LOCK_DURATION, "");
        require(lockDuration <= MAX_LOCK_DURATION, "");
        _;
    }
    ...
    function updateManager(address newValue) external onlyOwner{
        require(newValue != address(0), "");
        require(newValue != owner() && newValue != admin, "");
        manager = newValue;
    ...
    function updateAdmin(address newValue) external onlyManager{
        require(newValue != address(0), "");
        require(newValue != owner() && newValue != manager, "");
        admin = newValue;
    ...
    function transfer(
        ...
        require(totalSharesBeingWithdrawn(sender) <= balanceOf(sender) - amount, "");
    ...
    function transferFrom(
        ...
        require(totalSharesBeingWithdrawn(from) <= balanceOf(from) - amount, "");
    ...
    function deposit(
        ...
        require(assets <= maxDeposit(receiver), "ERx");
    ...
    function mint(
        ...
        require(shares <= maxMint(receiver), "E");
    ...
    function withdraw(
        ...
        require(assets <= maxWithdraw(owner), "ERCx");
    ...
    function redeem(
        ...
        require(shares <= maxRedeem(owner), "ER");
    ...
    function makeWithdrawRequest(uint shares, address owner) external {
        require(openTradesPnlFeed.nextEpochValuesRequestCount() == 0, "");

        address sender = _msgSender();
        uint allowance = allowance(owner, sender);
        require(sender == owner || allowance > 0 && allowance >= shares, "");
    ...
    function cancelWithdrawRequest(uint shares, address owner, uint unlockEpoch) external {
        require(shares <= withdrawRequests[owner][unlockEpoch], "");
    ...
    function depositWithDiscountAndLock(
        ...
        * (PRECISION * 100 + lockDiscountP(collateralizationP(), lockDuration))
        ...
        require(simulatedAssets <= maxDeposit(receiver), "");
    ...
    function _executeDiscountAndLock(
        ...
        require(assets > assetsDeposited, "");
    ...
    function unlockDeposit(uint depositId, address receiver) external {
        ...
        require(accPnlPerToken <= int(maxAccPnlPerToken()), "");
    ...
    function sendAssets(uint assets, address receiver) external {
        ...
        require(dailyAccPnlDelta <= int(maxDailyAccPnlDelta), "");
    ...
    function deplete(uint assets) external {
        require(assets <= assetsToDeplete, "");
    ...
    function refill(uint assets) external {
        ...
        * IERC20Upgradeable(gnsToken).totalSupply() / PRECISION / 100, "");
    ...
    function updateAccPnlPerTokenUsed(
        ...
        address sender = _msgSender();
        require(sender == address(openTradesPnlFeed), "");
