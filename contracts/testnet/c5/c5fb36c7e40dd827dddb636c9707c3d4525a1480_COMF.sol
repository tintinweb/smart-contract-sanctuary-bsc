...
contract COMF is Context, IERC20, Ownable {
    ...
    address private _marketingwalletAddress = 0x675c82790C1B9910334f306408dd3b8B04c72F3A;
    uint256 public _marketingFee;
    uint256 private _previousMarketingFee;
    address private _developmentwalletAddress = 0x038AD631521D4130A7d016986EE6B73093AB850c;
    ...
    constructor (string memory _NAME, string memory _SYMBOL, uint256 _DECIMALS, uint256 _supply, uint256 _TaxFee,uint256 _LiquidityFee,uint256 _MarketingFee,uint256 _DevelopmentFee,uint256 _MAXAMOUNT,uint256 SELLMAXAMOUNT,address routerAddress,address tokenOwner) public {
        _name = _NAME;
        _symbol = _SYMBOL;
        _decimals = _DECIMALS;
        ...
        _developmentFee = _DevelopmentFee;
