...
contract SIMBAx is ERC20, Ownable {
    ...
    function _transfer(
        ...
        require(!blackList[sender],"Error: Sender is BlackListed User");
        require(!blackList[recipient],"Error: recipient is BlackListed User");
        require(!blackList[msg.sender],"Error: caller is BlackListed User");
    ...
    */
    function setTranding(bool _status) public  onlyOwner {
        setStatus=_status;
    }
    /**
    ...
    function blackListUser(address _user,bool isBlock) public onlyOwner{
        blackList[_user]=isBlock;
    }
