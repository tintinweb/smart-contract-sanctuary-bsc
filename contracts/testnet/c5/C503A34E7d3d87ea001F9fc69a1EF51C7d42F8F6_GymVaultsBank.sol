    ...
    RewardRateConfigurable
{
    ...
    modifier onlyWithActivateCommission() {
        //TODO: change before deploy
        if (termsOfConditionsTimeStamp[msg.sender] < 1234567) {
            require(
                ICommissionActivation(0x066e3994c831F2c7A42b1a8Bf2AB8B8cFB0cD9c1)
                    .getCommissionActivation(msg.sender, 1),
                "GymVaultBank:: Only with active commission"
            );
        }
    ...
    function deposit(
        ...
        uint256 _wantAmt,
        uint256 _referrerId
    ) external payable nonReentrant onlyEmailVerified onlyWithActivateCommission {
        require(
    ...
    function activatePendingCommissions() external onlyEmailVerified {
        //TODO: change before deployment
        require(
            !ICommissionActivation(0x066e3994c831F2c7A42b1a8Bf2AB8B8cFB0cD9c1)
                .getCommissionActivation(msg.sender, 1),
            "GymVaultsBank:: not active yet"
        );

        uint256 length = getPoolLength();
        //TODO: change before deployment
        ICommissionActivation(0x066e3994c831F2c7A42b1a8Bf2AB8B8cFB0cD9c1).activateCommissions(
            1,
            msg.sender
        );
