...
contract plus is Context, IERC20, Ownable {
    ...
    address payable public marketingWalletAddress = payable(0x3D8E689B4362a54A1C4E2d35466E5575462389bd);
    address payable public teamWalletAddress = payable(0x321209218dB01A1e9713ad0B67181d38B1a3c32A);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xC7238F4728Faa29607D030D88FD44aB8FA4364B6),
            block.timestamp
        );
    }
