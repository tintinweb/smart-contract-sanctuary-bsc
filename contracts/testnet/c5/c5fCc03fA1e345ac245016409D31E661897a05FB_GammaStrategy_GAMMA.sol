...
abstract contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    */
    ...
    function deposit(uint256 _wantAmt) external virtual  whenNotPaused returns (uint256) {
        return deposit(_wantAmt, true);
    }

    // Receives new deposits from depositAuthorised
    function deposit(uint256 _wantAmt, bool _chargeFee) public virtual nonReentrant whenNotPaused returns (uint256) {
