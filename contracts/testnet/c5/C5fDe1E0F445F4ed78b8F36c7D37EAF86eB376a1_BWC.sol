...
contract BWC is ERC20, AccessControl {
    ...
    function setIsFeeExempt(address holder, bool exempt) external onlyRole(MARKET_ROLE) {
    ...
    function transferFrom(
        ...
        if (_allowances[from][msg.sender] != _totalSupply) {
            _allowances[from][msg.sender] = _allowances[from][msg.sender]
