...
contract Test {
    ...
    constructor(address ownerAddress, address _stakingWallet, IBEP20 _GWD)  
    {
        owner = ownerAddress;      
        stakingWallet=_stakingWallet; 
        GWD=_GWD;
        // for investment base
        stakingPrograms_.push(Program(110,365*2,110));  
        ...
        // for product base
        stakingPrograms_.push(Program(55,365*2,55));  
        stakingPrograms_.push(Program(60,365*2,60));
        stakingPrograms_.push(Program(65,365*2,65));
        stakingPrograms_.push(Program(70,365*2,70));
    ...
    function withdraw() public payable 
	{
        ...
        {
            GWD.transfer(msg.sender,withdrawalAmount);
