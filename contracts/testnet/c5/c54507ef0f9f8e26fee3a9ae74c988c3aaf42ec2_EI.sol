    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            ...
            if(isMarketPair[sender]) {
                    ...
                    _balances[marketingWallet] += amount.mul(_buyMarketingFee).div(100);
                    emit Transfer(sender, marketingWallet, amount.mul(_buyMarketingFee).div(100));
                    
                    _balances[lpWallet] += amount.mul(_buyLpFee).div(100);
                    emit Transfer(sender, lpWallet, amount.mul(_buyLpFee).div(100));

                    
                    _balances[invitationWallet] += amount.mul(_buyInviteOneFee).div(100);
                    ...
                    _balances[marketingWallet] += amount.mul(_sellMarketingFee).div(100);
                    emit Transfer(sender, marketingWallet, amount.mul(_sellMarketingFee).div(100));
                    
                    _balances[fundWallet] += amount.mul(_sellFundFee).div(100);
