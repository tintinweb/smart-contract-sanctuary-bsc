...
contract MarketZai is ERC721Enumerable, Ownable {
    ...
    function createTickets(uint256 _quantity) external onlyOwner {
        ...
        address _claimNFTsAddress = gameAddresses.getClaimNFTsAddress();
        ...
        for (uint256 i = 0; i < _quantity; ) {
            _mintTicket(_claimNFTsAddress, _currentSeason,_dateCreation, 0);
            unchecked {
                ++i;
            }
        }
        _mintSilverTicket(_claimNFTsAddress,_currentSeason,_dateCreation);
        _mintGoldTicket(_claimNFTsAddress,_currentSeason,_dateCreation);
        _mintPlatinumTicket(_claimNFTsAddress,_currentSeason,_dateCreation);
    }
    ...
    function _mintSilverTicket(address _claimNFTsAddress,uint256 _currentSeason, uint256 _dateCreation) internal{
        ...
        if(_silverToMint > 0){
            ...
            for (uint256 i = 0; i < _silverToMint; ) {
    ...
    function _mintPlatinumTicket(address _claimNFTsAddress,uint256 _currentSeason, uint256 _dateCreation) internal{
        ...
        if(_platinumToMint > 0){
            ...
            for (uint256 i = 0; i < _platinumToMint; ) {
