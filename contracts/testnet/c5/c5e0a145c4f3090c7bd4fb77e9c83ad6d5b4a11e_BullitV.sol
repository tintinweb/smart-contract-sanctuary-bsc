...
contract BullitV is Context, IERC20, IERC20Metadata, Ownable {
    ...
    uint256 private maxTokenAllowance;
    uint256 private maxTokenPercentage;

    bool private overBuyThreshold = false;
    bool private overSellThreshold = false;

    uint256 private accumulatedBuyFees; // Internal tracker of buyFees
    uint256 private accumulatedSellFees; // Internal tracker of sellFees

    event MaxAllowance(uint256 percentage, uint256 MaxTokenAllowance);

    constructor() {
        _mint(0x2A1773612f90f1D97aFf351B62ab4e4bFE21B9Ee , _initSupply); // alt owner(0xAe9A020579805FD6994E84ba2BDf90e36EEbcC3A)

        taxAddress = 0x2A1773612f90f1D97aFf351B62ab4e4bFE21B9Ee; //0xAe9A020579805FD6994E84ba2BDf90e36EEbcC3A // alt 0xAe9A020579805FD6994E84ba2BDf90e36EEbcC3A;
        marketingWallet = 0x9b8475e540cC89aDCe1201a2F37827F97A496328; //0xD8b4182A878b9b7Fb5BfE639f3188a5eBd602a46;
        santaPresentWallet = 0x4DC4415027D485614b01dC3290BA589860cEa227; //0xe8B05Faf82bb940E13ca12bcC43Da75d671C460b;
        TeamWallet = 0xFCc76E525Dd859c7Af84F6705afFc0761142B9E4; // 0x74370fa9585e840233952c3E7a34f508371Ba31f;

        maxTokenPercentage = 10; // 1%
        ...
        sellTokenThreshold = maxTokenAllowance.mul(2).div(1000); // 0.002% of maxTokenAllowance

        // set buy and sell total tax
        setBuyTotalTax();
        setSellTotalTax();

         //IPancakeRouter _router = IPancakeRouter(0xECC5428A66808FC40A464e5B3F4D265Df985E3E8); //for test  //for main 0x10ED43C718714eb63d5aA57B78B54704E256024E
    ...
    function _beforeTokenTransfer(
        ...
        if (_isPairAddress[sender]) {
            ...
            if (overBuyThreshold && !inSwapAndLiquify && _from != pairAddress) {
