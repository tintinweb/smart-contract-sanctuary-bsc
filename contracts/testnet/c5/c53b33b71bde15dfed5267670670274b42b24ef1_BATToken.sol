...
contract BATToken is IERC20 {
    ...
    //BAT token, creator will take 6% fee
    address public feeTo = 0xfbDB4a8E39B1f7E6D7BbB87B9D89d4d01c4B6c10;

    string public name = "9999 Token";
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (fee == 0) fee = 1; // minimum 0.00000000000000001 9999
