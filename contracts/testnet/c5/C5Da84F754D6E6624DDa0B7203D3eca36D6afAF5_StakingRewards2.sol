...
contract StakingRewards2 is Ownable {
    ...
    function viewAPR() public view returns (uint) {
        if (totalSupply == 0) {
            return rewardRate * (3600 * 24 * 365) * 1e2;
        }

        return ((rewardRate * (3600 * 24 * 365) * 1e20) / totalSupply) / 1e18;
    }
