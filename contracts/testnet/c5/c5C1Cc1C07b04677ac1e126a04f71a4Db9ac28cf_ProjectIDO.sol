...
contract ProjectIDO is Ownable {
	...
	function getUserInfo(address user)
		...
		returns (
			uint256 firstIdoTime,
			uint256 idoAmountVns,
			uint256 idoQuotaVns,
			uint256 idoAmountCpd,
			uint256 idoQuotaCpd,
			uint256 idoAmountUsdt,
			uint256 idoQuotaUsdt,
			uint256 rewardVNSAmount,
			uint256 projectTokenClaimed
		)
	{
		firstIdoTime = users[user].firstIdoTime;
		idoAmountVns = users[user].idoAmount[0];
		idoQuotaVns = users[user].idoQuota[0];
		idoAmountCpd = users[user].idoAmount[1];
		idoQuotaCpd = users[user].idoQuota[1];
		idoAmountUsdt = users[user].idoAmount[2];
		idoQuotaUsdt = users[user].idoQuota[2];
		rewardVNSAmount = users[user].rewardVNSAmount;
		projectTokenClaimed = users[user].projectTokenClaimed;
	}
