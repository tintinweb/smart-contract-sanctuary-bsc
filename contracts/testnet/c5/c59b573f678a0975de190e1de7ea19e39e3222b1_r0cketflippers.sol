...
// ================== Variables Start =======================
  ...
  uint256 public tokenIDStart = 1011; // starting token id
  uint256 public supplyLimit = 10; // limit
  ...
  // collection address
  address public FreeMintCollection = 0x086bb1bCCc2B4b0d2ea48D392f27d2C7B94ca9cD;
