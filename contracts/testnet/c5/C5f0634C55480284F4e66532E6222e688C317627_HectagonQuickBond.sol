...
contract HectagonQuickBond is Ownable {
    ...
    address private constant wbnbTokenAddress = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    ...
    function quickLPBond(
        ...
        uint256 _maxPrice,
        uint256 _bondId
    ) external payable stopInEmergency returns (uint256 HectaRec) {
