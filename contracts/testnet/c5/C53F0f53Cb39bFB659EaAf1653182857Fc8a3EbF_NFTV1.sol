    ...
    Ownable
{
    ...
    Counters.Counter public totalTokenSupply;
    ...
    function totalSupply() public view override returns (uint256) {
        return totalTokenSupply.current();
    }
    ...
    function tokensOfOwner(
        ...
        require(_max != 0, "tokensOfOwner: max value is zero");
    ...
    function _createCard(address _toAddress, uint256 _cardIndex) private {
        lastTokenId.increment();
        totalTokenSupply.increment();
    ...
    function createCard(address _toAddress, uint256 _cardIndex)
        public
        onlyOwner
    {
        _createCard(_toAddress, _cardIndex);
    }
    ...
    function unpack(
        ...
        for (uint256 i = 0; i < _amount; i++) {
            _createCard(_toAddress, _cardIndex[i]);
        }
    }

    function burn(uint256 _tokenId) public override {
        totalTokenSupply.decrement();
        _burn(_tokenId);
    }
