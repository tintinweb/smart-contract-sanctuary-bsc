    ...
    StakingTierModels
{
    ...
    // (uint256 => uint256)[] public _vestingTimeline;
    ...
    uint256 private _tierRoundParticipants;
    uint256 private _communityRoundParticipants;
    ...
    function register() external virtual whoCanBuy whenOpening onlyUnRegister {
        ...
        _totalSlot += _getUserTier(sender).slot;
        _participants += 1;
