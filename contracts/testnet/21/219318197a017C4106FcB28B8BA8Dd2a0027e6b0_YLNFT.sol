...
contract YLNFT is ERC721URIStorage, EIP712, Ownable, AccessControl, ReentrancyGuard {
    ...
    function getCategoryCount(string memory _sport, string memory _cnft) public view returns (uint256) {
        uint256 _cnt = categoryCount[_sport][_cnft];
        return _cnt;
    }

    function getCategoryAmount(string memory _sport, string memory _cnft) public view returns (uint256) {
