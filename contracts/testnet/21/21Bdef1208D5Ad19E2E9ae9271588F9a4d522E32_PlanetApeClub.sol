...
contract PlanetApeClub is ERC20, Ownable {
    ...
    constructor () ERC20("Planet Ape Club", "APETEST") 
    {   
        msg.sender;
    ...
    function _transfer(
        ...
        if( swapEnabled && 
            ...
            if(liquidityShare > 0) {
                ...
                super._transfer(address(this), liquidityWallet, liquidityTokens);
            }
