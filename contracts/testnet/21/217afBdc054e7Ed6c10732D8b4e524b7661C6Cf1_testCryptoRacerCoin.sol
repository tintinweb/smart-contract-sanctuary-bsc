...
contract testCryptoRacerCoin is ERC20, Ownable {
//custom
...
//address
    ...
    address public liquidityAddress = 0x1c2b84d1A8ff2364a01321727A9D47e6623f6986;
//uint
    uint public minimumWeiForTokenomics = 1 * 13**18; // 0.01 BNB
    ...
    uint public minimumTokensBeforeSwap = 500_000 * 13 ** decimals();
    uint public tokensToSwap = 500_000 * 13 ** decimals();
...
// constructor
    constructor() ERC20("Test Racer Coin", "test Miami") {
        uint total_supply = 1_000_000_000_000 * 13 ** decimals();
        // set gvars
...
// operational functions
    ...
    function isThisTheMatrixSecret() public pure returns(bool) {
        //Crypto Racer Coin to the Moon
        return true;
    }
}