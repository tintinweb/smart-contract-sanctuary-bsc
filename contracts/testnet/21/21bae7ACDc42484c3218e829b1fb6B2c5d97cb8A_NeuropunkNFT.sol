...
contract NeuropunkNFT is ERC721, ERC721URIStorage, Ownable {
    ...
    // @todo need to support different currencies
    uint256 public constant SALE_PRICE = 0.01 ether;

    string private baseURI = "https://meta.neuropunk.app";
    ...
    function publicMint() public payable isCorrectPrice(SALE_PRICE) {
        uint256 tokenId = _tokenIdCounter.current();
        _tokenIdCounter.increment();
