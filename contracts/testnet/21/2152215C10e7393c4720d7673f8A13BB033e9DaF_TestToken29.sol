...
contract TestToken29 is Context, IERC20, Ownable {
    ...
    address private maxWallet = 0x1390E8705983C47830E9A6CEc68FAE9d94a4c18C;

    string private _name = "TestToken29";
    string private _symbol = "TTG29";
    ...
    bool private _buyBackEnabled;
    uint96 internal _minimumTokensBeforeSwap = uint96(5 * 10**6 * 10**9);
    uint256 internal _buyBackUpperLimit = 10 * 10**18;
    uint256 internal _buyBackTriggerTokenLimit = 1 * 10**6 * 10**9;
    ...
    uint256 internal _minBuybackAmount = 1 * 10**9 / (10**1);
    uint256 internal _maxBuybackAmount = 1 * 10**9;
    ...
    function _buyBackTokens(uint256 amount) private lockTheSwap returns (bool boughtBack) {
        ...
        if (amount > 0) {
            //uint256 tokensBefore = balanceOf(address(stakeToken));
