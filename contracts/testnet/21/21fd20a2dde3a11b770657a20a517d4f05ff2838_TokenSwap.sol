...
uint public reserverJe ;
    ...
    uint public userDuration ;
    uint public  userMaxSwap ;
...
function updateReseaveUSD(uint256 _reserveUSD) public  onlyAdmin returns (uint256) {
   ...
   function updateMaxLimit(uint256 _limit) public  onlyAdmin returns (uint256) {
       userMaxSwap = _limit * 1e6 ;
       return  userMaxSwap;
    }

function updateDuration(uint256 _time) public  onlyAdmin returns (uint256) {
       userDuration =  _time  ;
       return  userDuration;
    }
}