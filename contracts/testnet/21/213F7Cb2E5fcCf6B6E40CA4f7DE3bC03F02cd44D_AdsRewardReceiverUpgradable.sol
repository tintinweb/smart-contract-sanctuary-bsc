...
contract AdsRewardReceiverUpgradable is OperatorAbilityUpgradable {
    ...
    function initialize(address _swashTokenAddress, address _adsTokenAddress, address _uniswapAddress) public initializer
    {
    ...
    function allowance(uint256 value) public onlyOwner {
