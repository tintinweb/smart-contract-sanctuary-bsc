...
contract Lottery {
    ...
    function setFeeWallet(address payable _feeWallet) public restricted {
    require(msg.sender == manager, "Only the manager can set the fee wallet.");
   ...
   function pickWinner() public restricted {
    ...
    uint fee = (winBalance * 10) / 100;
    winner.transfer(winBalance - fee);
