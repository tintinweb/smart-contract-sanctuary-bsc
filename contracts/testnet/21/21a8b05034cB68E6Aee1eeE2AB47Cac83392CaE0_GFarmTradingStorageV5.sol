...
contract GFarmTradingStorageV5 {
    ...
    event storePendingMarketOrderEvent(string info, uint tBlock, uint bl);
    ...
    function storePendingMarketOrder(PendingMarketOrder memory _order, uint _id, bool _open) external onlyTrading{
        ...
        emit storePendingMarketOrderEvent("SPMO", reqID_pendingMarketOrder[_id].block, block.number);
