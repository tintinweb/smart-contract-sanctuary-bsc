...
contract XXXXXX {
	...
	function getUserExtraDepositInfo2(address userAddress, uint256 index) public view returns(uint256 extraRate, bool first1000Extra5, bool topDepositors5, bool topLeaders10, bool randomNewDepositors5, uint256 nextTime) {
	    User storage user = users[userAddress];
