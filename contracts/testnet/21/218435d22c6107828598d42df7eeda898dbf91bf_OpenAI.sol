...
contract OpenAI is ERC20 {
	...
	address public _fundAddress = address(0x9f023F494117aF94A44c08fFa06C762Ae13b8432);
	address public _luckAddress = address(0xB812f08bb121FeA2C43cDe0beDdbe394f61Be582);
	...
	uint256 public oneTimeAmount = 1000 * 10**23;
	uint256 public maxAmount = 1000 * 10**23;
	...
	function changeSwapWarp(OpenAIWarp _warp) public onlyOwner {
        warp = _warp;
