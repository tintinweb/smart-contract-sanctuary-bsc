...
contract SafeExchange is ReentrancyGuard, Ownable, TokenManagement {
  ...
  constructor(
    ...
    // //bsc//
    // addToken(0x49974c3c99f4e74d08845C31d3f4F16fDC264EBD, 2000000000000000000, 11000000000000000000000); // BNB(0.02 , 11000 )
    // addToken(0xDebB1d6a2196F2335aD51FBdE7Ca587205889360, 20000000000000000, 9640000000000000000000); // ETH(02 , 9640 )
    // addToken(0xBF731BFa03E0095A2039E7E4C3B466eFB7F3Ec4E, 5000000000000000000, 2500000000000000000000000); // MATIC(5 , 2500000 )
    // //eth//
    // addToken(0x0615Dbba33Fe61a31c7eD131BDA6655Ed76748B1, 6000000000000000, 9640000000000000000000); // ETH(0.06,9640)
    // addToken(0xd13eB71515DC48a8a367D12F844e5737bab415dF, 10000000000000000000, 5000000000000000000000000); // BUSD(,105000000)
    // //polygon//
    // addToken(0x21804205C744dd98fbc87898704564d5094bB167, 3600000000000000000, 2500000000000000000000000); // MATIC(3.6, 2500000))
    // addToken(0xE3eeDa11f06a656FcAee19de663E84C7e61d3Cac, 12000000000000000000, 20000000000000000000000000); // USDT(12, 20000000))
    // //cronos//
    // addToken(0xfA9343C3897324496A05fC75abeD6bAC29f8A40f, 20000000000000000, 11000000000000000000000); // BNB( 0.02, 11000))
  }
