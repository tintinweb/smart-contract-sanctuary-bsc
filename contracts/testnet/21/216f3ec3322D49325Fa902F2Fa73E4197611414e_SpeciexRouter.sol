...
// File: contracts\interfaces\SpeciexFactory.sol

pragma solidity >=0.5.0;

interface SpeciexFactory {
...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'411302d8679fd176419dc17ae7bee33352091b9cf06335bf71d028332585bd02' // init code hash
            ))));
    }
...
contract SpeciexRouter is IPancakeRouter02 {
    ...
    function _addLiquidity(
        ...
        if (SpeciexFactory(factory).getPair(tokenA, tokenB) == address(0)) {
            SpeciexFactory(factory).createPair(tokenA, tokenB);
        }
