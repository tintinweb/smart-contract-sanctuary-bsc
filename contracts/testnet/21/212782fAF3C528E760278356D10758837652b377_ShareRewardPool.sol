...
contract ShareRewardPool is Initializable, ReentrancyGuard {
    ...
    uint256 public sharesPerSecond = 0.000938438438438438 ether; // 30000 share / (370 days * 24h * 60min * 60s)
    ...
    function init (address _share, uint256 _poolStartTime)  external initializer {
        ...
        require(share.balanceOf(address(this)) >= TOTAL_REWARDS, "rewards missing");
