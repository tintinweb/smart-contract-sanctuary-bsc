 ...
 */
contract ERC20 is ERC2771Context, IERC20, IERC20Metadata {
...
abstract contract Mintable is MetaOwnable {
    ...
    function setMinter(address newMinter) public onlyOwner {
        ...
        _minter = newMinter;
        emit OwnershipTransferred(oldMinter, newMinter);
    }
     ...
     * Can only be called by the owner.
     */
    function resetMint() public onlyOwner {
        _resetMint();
    }
 ...
 * the minter.
 */
abstract contract MinimalClaimContext {
