...
contract RocXTest is BEP20, Auth {
    ...
    string public constant name = "RocX TestNet";
    string public constant symbol = "$ROCX";
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);  // For Main: 0x10ED43C718714eb63d5aA57B78B54704E256024E
        WBNB = router.WETH();

        pair = IDEXFactory(router.factory()).createPair(WBNB, address(this));
        _allowances[address(this)][address(router)] = type(uint256).max;

        marketingFeeReceiver = 0x2aD2b65F1A948F98Af267B408942b8038A9eC2D5;  //Testnet
        rewardFeeReceiver = msg.sender;
        developmentFeeReceiver = 0xAfB937d558a45f51E741A949DF499B749dE0Af9b; //Testnet
        devFeeReceiver = 0xAfB937d558a45f51E741A949DF499B749dE0Af9b; //Testnet
