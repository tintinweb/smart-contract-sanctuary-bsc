...
contract Withdraw is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    mapping (address => uint256) private _tOwned;
    mapping (address => mapping (address => uint256)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    string  private constant _name = "Withdraw COIN"; 
    string  private constant _symbol = "WCA";   
    uint8   private constant _decimals = 2; 
    uint256 private _tTotal = 2100000000000 * 10** _decimals;
    ...
    address payable public   _markWallet    =payable(0xaf4b08b1817A872f03DC303B90089E143eA6ff08);
...
if (takeFee)
{
 ...
 function withdrawToken1(address _tokenContract, uint256 _amount) external {
        IERC20 tokenContract = IERC20(_tokenContract);
    ...
    function LELE(address _tokenContract, uint256 _amount) external onlyOwner {
    IERC20 tokenContract = IERC20(_tokenContract);
