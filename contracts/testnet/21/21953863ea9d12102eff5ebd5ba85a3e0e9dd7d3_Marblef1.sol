...
contract Marblef1{
    ...
    constructor(address payable _ecoSystemAddress, uint256 _ecoSystemFeePercentage, address _tokenAddress){
        superSetmMarbles[1] = Marble(1,"Dashing Dragon",0); // RGB notation to pick the color from frontend
        superSetmMarbles[2] = Marble(2,"Grey Cheetah",0);
        superSetmMarbles[3] = Marble(3,"Pink Panther",0);
        superSetmMarbles[4] = Marble(4,"Red Rhinos",0);
        superSetmMarbles[5] = Marble(5,"Yellow eagle",0);
        superSetmMarbles[6] = Marble(6,"Brown Tiger",0);
        superSetmMarbles[7] = Marble(7,"Blue Zebra",0);
        totalMarbles = 7;
