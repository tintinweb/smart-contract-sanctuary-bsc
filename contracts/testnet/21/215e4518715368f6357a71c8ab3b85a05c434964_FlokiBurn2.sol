...
contract DividendDistributor is IDividendDistributor {
 ...
 contract FlokiBurn2 is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Floki Burn 2.0";
    string constant _symbol = "Floki Burn 2.0";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 750000000* (10 ** _decimals);
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 9000;
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        ecosystemfeeReceiver = 0x87Ba8971E6117C4864352b9af1ebdEC27F1C1899;
