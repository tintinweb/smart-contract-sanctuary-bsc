...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public beastSwapLottery;
     ...
     * @param _seed: seed provided by the BeastSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == beastSwapLottery, "Only BeastSwapLottery");
    ...
    /**
     * @notice Set the address for the BeastSwapLottery
     * @param _beastSwapLottery: address of the BeastSwap lottery
     */
    function setLotteryAddress(address _beastSwapLottery) external onlyOwner {
        beastSwapLottery = _beastSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IBeastSwapLottery(beastSwapLottery).viewCurrentLotteryId();
    }
}
