...
contract MiloTestFarm is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    IBEP20 public immutable miloYachtClub;
    ...
    constructor(
        ...
        miloYachtClub = IBEP20(0x5B1a0E4b21ee69D38A397D49f00A7Ec28D614423);
        rewardToken = miloYachtClub;
        rewardPerBlock = 9 ether;
        startBlock = block.number;
        bonusEndBlock = 99999999;

        // staking pool
        poolInfo.push(PoolInfo({
            lpToken: miloYachtClub, // Coin
            allocPoint: 1000,
