...
contract EscrowFactory {
    ...
    mapping(string => mapping(string => address)) private user;
    EscrowBeacon beacon;
        ...
        external 
    {
        ...
        emit ProxyAddress(address(proxy));
        setDealDetails(userId, dealId, address(proxy)); 
        Escrow(address(proxy)).escrowParties(seller);
    ...
    function getEscrowProxyAddress(
        string memory _userId,
        string memory _dealId
    ) 
        public 
    ...
    function getEscrowImplementationAddress() public view returns (address) {
        return beacon.implementation();
    }
