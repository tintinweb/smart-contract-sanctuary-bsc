...
contract PowerUpsNFT is ERC1155PresetMinterPauser {
    constructor() ERC1155PresetMinterPauser("https://nftservice.basketballverse.gg/powerups/{id}") {}
    
    function uri(uint256 _tokenId) override public view returns (string memory) {
        return (
            string(abi.encodePacked(
                "https://nftservice.basketballverse.gg/powerups/",
