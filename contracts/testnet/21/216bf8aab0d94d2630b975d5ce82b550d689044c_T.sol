...
contract T is IERC20, Ownable, ReentrancyGuard {
    ...
    constructor(address underlying_, address feeReceiver_) {
        ...
        feeReceiverPercentage = 60000; // 60% of fee is taken for receivers to split for NFTs & treasury
    ...
    /** 
        Mint UP Tokens For `recipient` By Depositing BUSD Into The Contract
            Requirements:
                Approval from the BUSD prior to purchase
        
        @param numTokens number of BUSD tokens to mint UP with
        @param recipient Account to receive minted UP tokens
    ...
    */
    ...
    /** Burns UP Tokens And Deposits BUSD Tokens into Recipients's Address */
    ...
    /** Handles Minting Logic To Create New UP */
