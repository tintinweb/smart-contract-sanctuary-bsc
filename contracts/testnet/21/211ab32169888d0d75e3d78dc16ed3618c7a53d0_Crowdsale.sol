...
contract Crowdsale is Pausable, Ownable {
    ...
    uint256 private constant ICO_SUPPLY_PER_PHASE = 1000 ether;
    uint256 private constant PHASES = 5;
    uint256 private constant PHASE_DURATION = 1 hours;
    ...
    constructor(
        ...
        tokenPrices[1] = 1000000000 gwei; // 0.0013 BUSD
        tokenPrices[2] = 2000000000 gwei; // 0.0026 BUSD
        tokenPrices[3] = 3000000000 gwei; // 0.0039 BUSD
        tokenPrices[4] = 4000000000 gwei; // 0.0052 BUSD
        tokenPrices[5] = 5000000000 gwei; // 0.0065 BUSD
    }
