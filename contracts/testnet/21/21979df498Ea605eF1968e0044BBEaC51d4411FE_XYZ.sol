...
contract XYZ is ERC20Detailed, Ownable {
    ...
    uint256 public safuuInsuranceFundFee = 10;
    ...
    constructor() ERC20Detailed("Xyz", "XYZ", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x533316D51aA5152ad48e1648F18A1a94e1927d59;
        treasuryReceiver = 0xC62574A5E9D86BA85E5d10A44632dD6a52E69C13; 
        safuuInsuranceFundReceiver = 0x9001601723e4e4b32e29dB7F6f588704F9313E25;
        firePit = 0x95B8A7D510b79aCAa0d65393D9a67D2bA50B1577;
    ...
    function takeFee(
        ...
        if (recipient == pair) {
            ...
            _safuuInsuranceFundFee = safuuInsuranceFundFee.add(sellFees);
