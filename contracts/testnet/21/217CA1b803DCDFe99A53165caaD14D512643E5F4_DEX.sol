...
contract gh is IBEP20, Ownable {

    string public constant name = "gh";
    string public constant symbol = "ghjgh";
    uint8 public constant decimals = 11;

    
    mapping(address => uint256) balances;
    mapping(address => mapping (address => uint256)) allowed;
    uint256 totalSupply_ = 555 *10 **decimals;
