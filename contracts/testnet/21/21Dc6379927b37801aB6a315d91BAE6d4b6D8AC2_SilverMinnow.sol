...
contract SilverMinnow is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    SilverMinnowDividendTracker public dividendTracker;
    ...
    uint256 public cooldowntimer = 77; //default cooldown 45s
    ...
    constructor() ERC20("Silver Minnow", "SM") {
        ...
        dividendTracker = new SilverMinnowDividendTracker(
            payable(this),
            router,
        ...
        maxWallet = totalTokenSupply / 50; // 2% - ish
...
contract SilverMinnowDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    SilverMinnow public SilverMinnowContract;
    ...
    constructor(
        ...
        defaultToken = token;
        SilverMinnowContract = SilverMinnow(mainContract);
    ...
    function _transfer(
        ...
        require(false, "SilverMinnow_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public pure override {
        require(
            false,
            "SilverMinnow_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main SilverMinnow contract."
        );
    }
        ...
        returns (uint256)
    {
        ...
        if (_withdrawableDividend > 0) {
            ...
            path[1] = address(SilverMinnowContract);

            uint256 prevBalance = SilverMinnowContract.balanceOf(address(this));
            ...
            {
                uint256 received = SilverMinnowContract
                    .balanceOf(address(this))
                    .sub(prevBalance);
                if (received > 0) {
                    success = true;
                    SilverMinnowContract.transfer(account, received);
                } else {
                    success = false;
                }
            } catch {
