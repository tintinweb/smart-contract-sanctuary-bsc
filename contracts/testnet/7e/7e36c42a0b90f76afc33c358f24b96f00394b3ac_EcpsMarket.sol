     ...
     function markupEnd(uint _tokenId, address[] memory bidAddress) external onlyAdmin {
        ...
        if(commodityList[_tokenId].coin == 1){
            ...
            if(commodityList[_tokenId].highestBid > 0){
                if(commodityInfoList[_tokenId].copyright){
                    COP.transferFrom(address(this), commodityList[_tokenId].sellAdderss, commodityList[_tokenId].highestBid.mul(85).div(100));
                    COP.transferFrom(address(this), commodityInfoList[_tokenId].copyrightAdderss, commodityList[_tokenId].ecpsAmount.mul(10).div(100));
                } else{
                    COP.transferFrom(address(this), commodityList[_tokenId].sellAdderss, commodityList[_tokenId].highestBid.mul(95).div(100));
                }
                COP.transferFrom(address(this), dividendAddress, commodityList[_tokenId].highestBid.mul(5).div(100));
            }
        } else if(commodityList[_tokenId].coin == 2){
            for (uint i = 0; i < bidAddress.length; i++) {
            ...
            if(commodityList[_tokenId].highestBid > 0){
                if(commodityInfoList[_tokenId].copyright){
                    ROC.transferFrom(address(this), commodityList[_tokenId].sellAdderss, commodityList[_tokenId].highestBid.mul(85).div(100));
                    ROC.transferFrom(address(this), commodityInfoList[_tokenId].copyrightAdderss, commodityList[_tokenId].ecpsAmount.mul(10).div(100));
                } else{
                    ROC.transferFrom(address(this), commodityList[_tokenId].sellAdderss, commodityList[_tokenId].highestBid.mul(95).div(100));
                }
                ROC.transferFrom(address(this), dividendAddress, commodityList[_tokenId].highestBid.mul(5).div(100));
            }
        }
