...
contract SoftX is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 50000000;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "SoftX Platform"; // token name
    string private _symbol = "SOFTX"; // token ticker
    ...
    uint256 public minTokenToSwap = 200000; // 10000k amount will trigger the swap and add liquidity
    uint256 public maxHoldingAmount = 1000000;
    uint256 public minBuyLimit = 1000000;
