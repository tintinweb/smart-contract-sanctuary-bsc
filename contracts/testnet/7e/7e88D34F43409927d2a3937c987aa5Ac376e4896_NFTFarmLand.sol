...
contract NFTFarmLand is ERC721, Callerable {
    ...
    constructor(string memory name_, string memory symbol_, address _auth) Callerable(_auth) ERC721(name_, symbol_) {
        ...
        land_picture_list = [
            ...
            "",
            ""];
        sow_limitation_list[0] = LimitData(100, 199);
        sow_limitation_list[1] = LimitData(200, 499);
        sow_limitation_list[2] = LimitData(500, 999);
        sow_limitation_list[3] = LimitData(1000, 1999);
        sow_limitation_list[4] = LimitData(2000, 4999);
        sow_limitation_list[5] = LimitData(5000, 9999);
        sow_limitation_list[6] = LimitData(10000, 19999);
    }
