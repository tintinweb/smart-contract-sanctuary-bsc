...
contract saleteste is IBEP20, ReentrancyGuard, ERC721Holder, Context, Ownable {
    ...
    // Pet rewards
    uint256 public PetRate = (20 * 10 ** _decimals) /  1 days;
    uint256 public PetRate2 = (35 * 10 ** _decimals) /  2 days;
    uint256 public PetRate3 = (55 * 10 ** _decimals) /  3 days;
    uint256 public PetRate4 = (100 * 10 ** _decimals) /  4 days;
    ...
    uint256 public LifeRate = (100 * 10 ** _decimals) /  1 days;
