...
// File contracts/dex/interfaces/IUniswapV2Router01.sol
...
// File contracts/dex/interfaces/IUniswapV2Router.sol
...
// File contracts/dex/libraries/UniswapV2Library.sol
                ...
                uint256(
                    keccak256(
                        abi.encodePacked(
                            ...
                            hex'305ec49721773280016e746a3ac948e125c29fa1b640d00c17c479c4d0d3f75f' // init code hash
                        )
                    )
                )
            )
...
// File contracts/dex/UniswapV2Router.sol
...
contract UniswapV2Router {
    ...
    function testPairFor(address tokenA, address tokenB)
        public
        view
        virtual
        returns (address pair)
