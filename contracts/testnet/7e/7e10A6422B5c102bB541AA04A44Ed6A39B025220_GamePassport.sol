    ...
    IPassport
{
    ...
    function initialize(address _slotsAddress) public initializer {
        __Ownable_init();
    ...
    function mint(address _to) public override nonReentrant returns (bool) {
    ...
    function setSlotsAddress(address _slotsAddress) public onlyOwner {
