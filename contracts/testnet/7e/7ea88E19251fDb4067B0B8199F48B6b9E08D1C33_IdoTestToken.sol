...
contract IdoTestToken is ERC20, Ownable {
    uint256 public transferFee = 2;

    mapping(address => bool) public excludedFromFee;

    constructor() ERC20("IdoTestToken", "ITTK") {
    ...
    function excludeFromFee(address _addr, bool status) external {
        excludedFromFee[_addr] = status;
    }
