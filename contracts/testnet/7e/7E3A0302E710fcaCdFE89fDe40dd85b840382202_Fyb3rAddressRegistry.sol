...
contract Fyb3rAddressRegistry is Ownable {
    bytes4 private constant INTERFACE_ID_ERC721 = 0x80ac58cd;

    /// @notice Fyb3r contract
    address public artion;

    /// @notice Fyb3rAuction contract
    address public auction;

    /// @notice Fyb3rMarketplace contract
    address public marketplace;

    /// @notice Fyb3rBundleMarketplace contract
    address public bundleMarketplace;

    /// @notice Fyb3rNFTFactory contract
    address public factory;

    /// @notice Fyb3rNFTTFactoryPrivate contract
    address public privateFactory;

    /// @notice Fyb3rArtFactory contract
    address public artFactory;

    /// @notice Fyb3rArtFactoryPrivate contract
    address public privateArtFactory;

    /// @notice Fyb3rTokenRegistry contract
    address public tokenRegistry;

    /// @notice Fyb3rPriceFeed contract
    ...
    /**
     @notice Update Fyb3rAuction contract
     @dev Only admin
     */
    ...
    /**
     @notice Update Fyb3rMarketplace contract
     @dev Only admin
     */
    ...
    /**
     @notice Update Fyb3rBundleMarketplace contract
     @dev Only admin
     */
    ...
    /**
     @notice Update Fyb3rNFTFactory contract
     @dev Only admin
     */
    ...
    /**
     @notice Update Fyb3rNFTTFactoryPrivate contract
     @dev Only admin
     */
    ...
    /**
     @notice Update Fyb3rArtFactory contract
     @dev Only admin
     */
    ...
    /**
     @notice Update Fyb3rArtFactoryPrivate contract
     @dev Only admin
     */
