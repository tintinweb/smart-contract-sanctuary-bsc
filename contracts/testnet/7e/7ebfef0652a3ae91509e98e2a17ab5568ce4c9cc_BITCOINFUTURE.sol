...
contract BITCOINFUTURE is Context, BTCF, Ownable {
  ...
  */
  ...
  function getMaxFee() external override view returns (uint8) {
    return _maxFee;
  }
  ...
  //receiver's cost
  function currentFee() external override  view returns (uint8) {
  ...
  function _mint(address account, uint256 amount) internal {
    ...
    require(amount <= 100000000000, "BTCF: mint amount too high");
