...
contract Token is Context, IERC20 {
    ...
    address payable public marketingWalletAddress = payable(0x00000008298D444985fB0a3Ffb9E9cEcd34F2181);
    address payable public BurnedWalletAddress = payable(0x00000008298D444985fB0a3Ffb9E9cEcd34F2181);
    ...
    constructor() payable{
        ...
        isWalletLimitExempt[rowner()] = true;
        isWalletLimitExempt[address(uniswapPair)] = true;
        isWalletLimitExempt[address(this)] = true;

        isTxLimitExempt[rowner()] = true;
        isTxLimitExempt[address(this)] = true;

        isMarketPair[address(uniswapPair)] = true;

        _balances[rowner()] = _totalSupply;
        emit Transfer(address(0), rowner(), _totalSupply);
    }
