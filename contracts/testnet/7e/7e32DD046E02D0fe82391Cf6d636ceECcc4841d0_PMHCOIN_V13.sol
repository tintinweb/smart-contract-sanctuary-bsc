...
contract PMHCOIN_V13 is BEP20, Auth {
    ...
    string public constant name = "PMHCOIN V13";
    string public constant symbol = "PMHC XIII";
  ...
  function _burn(address account, uint256 amount) internal {
    ...
    balanceOf[account] = balanceOf[account].sub(amount, "burn amount exceeds balance");
