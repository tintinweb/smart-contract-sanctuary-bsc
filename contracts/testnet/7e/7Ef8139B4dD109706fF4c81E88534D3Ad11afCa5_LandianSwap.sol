    ...
    Oracle
{
        ...
        returns (bool)
    {
        ...
        if (pair.activeOracle) {
            ...
            // @dev
            uint256 amountTokenPrice = valueInUsd / 1e18;

            // @dev amount of token to buy
            amountTokenBuy = amountTokenPrice.div(pair.price);
        } else {
...
contract SwapNative is ReEntrancyGuard, Chainalysis, FactorySwap, Oracle {
        ...
        returns (uint256 tokenAmount)
    {
        ...
        if (pair.activeOracle) {
            ...
            uint256 amountTo18 = _amountOfTokens.mul(pair.amountForTokens);
            tokenAmountToBuy = amountTo18 / 1e18;
        }
