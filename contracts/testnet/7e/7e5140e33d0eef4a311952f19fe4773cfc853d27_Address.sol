...
contract BEP20 is Context, Ownable, IBEP20 {
    ...
    address public D = 0xD7fcC9D6aE533d206Ee2F32335e23315Cca1ABa3;  // deployer address
    address public T = 0x5d1f1C1f64b55e7EEaEeFCA79A47BB0425267bd3;  // team address
    address public P = 0x0cc98db89d17E10B46EB0C4a1FD1611D0828C687;  // partner address
    address public C = 0xBC821455AB6f975865F1415e896eb273717c7C30;  // consultant address
    address public AD = 0xe0Dc6CcA6e51D706DF027cEb5A7544eDe22a1e8a;  // airdrop address
    address public A = 0x77bCA569C388bC3623dF39A11e195E401c26bbfA;  // transition address
    address public M = 0xc11DcC597eBa3572e822307fe3FE5d4909aEd40a;  // market address
...
contract DODToken is BEP20Detailed {
    ...
    constructor() BEP20Detailed("Day Of Defeat2", "DOD2", 18) public {
