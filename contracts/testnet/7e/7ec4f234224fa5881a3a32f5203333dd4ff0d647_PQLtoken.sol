...
contract Ownable is Context {
    ...
    uint256 public taxDeductionPeriod=30 days;
    ...
    /*===========constructor================-*/
    constructor( address _toLiquidityPool ,uint _supply ) {
    ...
    function _transfer( address from, address to,  uint256 amount  )  private canTransfer(from, to,amount  ){
    ...
    function approve(address _spender, uint256 _amount) public returns (bool success) {
        ...
        require(balances[ownerAddress] >= _amount ,"BEP20: user balance is insufficient");
        allowed[ownerAddress][_spender]=_amount;
        emit Approval(ownerAddress, _spender, _amount);
        return true;
    }
