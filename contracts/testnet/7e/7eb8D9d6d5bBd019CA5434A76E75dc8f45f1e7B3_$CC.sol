...
contract $CC is BEP20,Auth {
        ...
        bool public buySlowdownEnabled = true;
        uint8 public slowdownTimerInterval = 45;
        ...
        function _transfer(address sender,address recipient,uint256 amount) internal virtual override{
            ...
            // slowdown timer, so a bot doesnt do quick trades! 1min gap between 2 trades.
            if (buySlowdownEnabled && !isTimelockExempt[recipient]) {
                require(slowdownTimer[recipient] < block.timestamp,"Please wait for 1min between two buys");
                slowdownTimer[recipient] = block.timestamp + slowdownTimerInterval;
            }
