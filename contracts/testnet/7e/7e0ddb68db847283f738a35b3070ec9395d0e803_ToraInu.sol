...
contract ToraInu is ERC20, Ownable {
    ...
    uint256 public maxTxAmount = 50000000 ether;
    ...
    constructor() ERC20("ToraInu", "ToraInu") {
    ...
    function swapOnDemand() external onlyOwner {
        swapping = true;
        uint256 contractTokenBalanceforlp = balanceOf(address(this))-(pendingMarketingFee)-(burnFee);
    ...
    function _deflationaryBurn() public {
        uint _pendingBurnFee = pendingBurnFee;
        if (_pendingBurnFee > 0) {
            super._transfer(address(this), address(0), _pendingBurnFee);
            pendingBurnFee = 0;
        } 
    }
