...
modifier onlyAccounts() {
  ...
  function mint(uint256 tokenAmount) public payable onlyAccounts {
      ...
      require(msg.value >= tokenAmount * contributionAmount, "Insufficient BNB for Contribution");
      require(totalSupply() + tokenAmount <= currentRaiseSupply, "MellowPass :: Supply Limit Reached for This Round");
      require(tokenAmount > 0 && tokenAmount <= maxContribution, "Can't contribute more than allocated");
      require(walletMints[msg.sender] + tokenAmount <= maxContribution, "Exceeded Max Allocation per Wallet");
  ...
  function setParams(uint256 _contributionAmount, string memory _tokenBaseURI, string memory _newBaseExtension) external onlyOwner {
  ...
  function toggleRaise() external onlyOwner {
      raiseOpen = !raiseOpen;
  }
