...
contract TestTest is Ownable, ERC721, NonblockingReceiver {
    ...
    uint16 public mintLimit = 1111; // only allow mints up to and including this tokenID. 
    ...
    constructor(address _new_owner) ERC721("TestTest", "TESTTEST") {
