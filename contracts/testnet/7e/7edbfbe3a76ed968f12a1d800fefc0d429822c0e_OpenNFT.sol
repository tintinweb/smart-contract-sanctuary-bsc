...
/*
 .----------------. .----------------. .----------------. .-----------------..-----------------..----------------. .----------------. 
| .--------------. | .--------------. | .--------------. | .--------------. | .--------------. | .--------------. | .--------------. |
| |     ____     | | |   ______     | | |  _________   | | | ____  _____  | | | ____  _____  | | |  _________   | | |  _________   | |
| |   .'    `.   | | |  |_   __ \   | | | |_   ___  |  | | ||_   \|_   _| | | ||_   \|_   _| | | | |_   ___  |  | | | |  _   _  |  | |
| |  /  .--.  \  | | |    | |__) |  | | |   | |_  \_|  | | |  |   \ | |   | | |  |   \ | |   | | |   | |_  \_|  | | | |_/ | | \_|  | |
| |  | |    | |  | | |    |  ___/   | | |   |  _|  _   | | |  | |\ \| |   | | |  | |\ \| |   | | |   |  _|      | | |     | |      | |
| |  \  `--'  /  | | |   _| |_      | | |  _| |___/ |  | | | _| |_\   |_  | | | _| |_\   |_  | | |  _| |_       | | |    _| |_     | |
| |   `.____.'   | | |  |_____|     | | | |_________|  | | ||_____|\____| | | ||_____|\____| | | | |_____|      | | |   |_____|    | |
| |              | | |              | | |              | | |              | | |              | | |              | | |              | |
| '--------------' | '--------------' | '--------------' | '--------------' | '--------------' | '--------------' | '--------------' |
 '----------------' '----------------' '----------------' '----------------' '----------------' '----------------' '----------------' 
*/
...
contract OpenNFT is Context, IERC20, Ownable {
    ...
    address private OpenNFTAddress;
    ...
    function setOpenNFTAddress(address ad) public onlyOwner {
        OpenNFTAddress = ad;
    }
