...
contract BEP20PayToken is Ownable{
    ...
    event PayToken(address indexed sender, uint  amount, string id);
    ...
    function payToken(address beneficiaryAddress,uint benefit_amount, uint amount,uint burn_amount, string memory id) external returns(bool){
