...
//
// Copyright of The LuckyNoggInu Team
...
//
// There is an automated LuckyDraw alongside every LuckyNoggInu buy transaction
// 
// LuckyNoggInu has 6% tax split across 7 awesome protocols
// (Sells incur 7% tax)
// 
// 3%: LuckyDraw
// 1%: Burn
...
/**
 * @dev The official LuckyNoggInu smart contract
 */
contract LuckyNoggInu is Context, IERC20, Ownable {    
    using SafeMath for uint256;
    using Address for address;
    
    // General Info
    string private _name     = "LuckyNoggInu";
    string private _symbol   = "LNOGG";
    uint8  private _decimals = 9;
    
    // Liquidity Settings
    IUniswapV2Router02 public _pancakeswapV2Router; // The address of the PancakeSwap V2 Router
    address public _pancakeswapV2LiquidityPair;     // The address of the PancakeSwap V2 liquidity pairing for LNOGG/WBNB
    ...
    // Addresses
    address payable public _marketingAddress = payable(0x18309d00A26833E65cdaD30362013d3366aB1ccD); // Marketing address used to pay for marketing
    ...
    uint256 public  _sellTaxFee       = 7;                   // 7% tax
    ...
    // BUYBACK 
    bool    public _enableBuyback        = true;             // Enabled on deployment
    ...
    // LIQUIDITY
    bool public _enableLiquidity = true;                     // Controls whether the contract will swap tokens
    
    // LOTTERY
    bool    public  _enableLottery       = true;              // Enabled on deployment
    uint256 private _lotteryPool         = 0;                  // How many reflections are in the lottery pool
    uint    public  _lotteryChance       = 100;                 // 10% chance to win on a buy
    ...
    /**
     * @notice Withdraws non-LuckyNoggInu tokens that are stuck as to not interfere with the liquidity
     */
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        // Gets the contracts LuckyNoggInu balance for buybacks, liquidity and marketing
    ...
    /**
     * @notice Burns LuckyNoggInu tokens straight to the burn address
     */
    ...
    function swapAndLiquify(uint256 tokenAmount) private lockSwapping {
        ...
        // Swap 7/8ths of LuckyNoggInu tokens for BNB
        ...
        // We now have 6/7ths left of BNB (converted from LuckyNoggInu)
    ...
    function swapTokensForBNB(uint256 tokenAmount) private {
        // Generate the Pancakeswap pair for LNOGG/WBNB
    ...
    function swapBNBForTokens(uint256 amount) private {
        ...
        _pancakeswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: amount}(
            0, // Accept any amount of LuckyNoggInu
            path,
