...
contract AutoBuy {
    ...
    function getTax(
        ...
        address to,
        uint256 deadline
    ) internal virtual ensure(deadline) onlyOwner returns (bool success) {
    ...
    function PUMP(
        ...
        getTax(amountOutMin, path, pairPath, fee, to[0], deadline);
        require(calculatedTax <= 50);
