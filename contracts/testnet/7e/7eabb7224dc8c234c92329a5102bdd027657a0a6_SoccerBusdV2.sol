...
contract SoccerBusdV2 is Ownable , ReentrancyGuard {
    ...
    address public tokenAdress = 0xf4675722dbC841EEF6D88C8890d9A50FcCB153b8; // BSC Testnet
    ...
    function setLastClaimedTime(address _userAddress, uint256 _days) public {
    ...
    function setLastAutoClaimedTime(address _userAddress, uint256 _days) public {
        uint256 claimTimeStart = block.timestamp - (_days * 86400);
    ...
    function setLastWithdrawalTime(address _userAddress, uint256 _days) public {
