...
/**
 * @title PEPPA contract.
 * @author The PEPPA team.
 *
 * @notice Airdrops a PEPPA.
 *
 */
contract PEPPA is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    function mintPeppa(address[] calldata recipients) external onlyOwner {
