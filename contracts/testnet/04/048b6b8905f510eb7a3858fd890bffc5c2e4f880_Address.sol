...
contract Rebound is Context, IBEP20 { 
    ...
    uint256 private _tTotal = 6000000 * 10 ** 8; 
    string private constant _name = "Rebound"; 
    string private constant _symbol = unicode"$RBD"; 
