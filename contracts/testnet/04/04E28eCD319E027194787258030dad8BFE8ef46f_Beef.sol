...
*/
    ...
    function checkForWhales(address from, address to, uint256 amount) virtual public {
            ...
            if (to != uniswapV2Pair) {
                ...
                if(_isExcludedFromAntiWhale[from] == false){
                    ...
                    if(_sellIntervalStart[from] != 0){
                        ...
                        if(_sellIntervalStart[from]+(_sellTimeLimit) < block.timestamp){
                    ...
                    if(amount > _allowedTxAmount[from]){
                        ...
                        if(_allowedTxAmount[from]/(amount) <= 0){
                            _allowedTxAmount[from] = 0;
                        }else{
                            _allowedTxAmount[from] = _allowedTxAmount[from]/(amount);
                        }
                    }
                }
            }
