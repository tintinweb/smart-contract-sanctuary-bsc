...
// File: contracts/IReferralManager.sol
...
contract HBTPresale is Ownable {
    ...
    function participate(uint256 usdcAmount, address referralAddress) public {
        ...
        uint256 referralComissionAmount = (hbtAmount * REFERRAL_COMISSION) /
            1000;

        referralManager.recordComission(finalReferral, referralComissionAmount);

        uint256 bonus = (hbtAmount * BONUS) / 1000;
        uint256 finalHBTAmountAfterBonus = hbtAmount + bonus;
    ...
    function getPendingReward(address user) public view returns (uint256) {
        ...
        uint256 vestedInHBT = purchaseInfo[user].totalHBTBought -
            purchaseInfo[user].totalHBTClaimed;
      
        uint256 stakedFinalBalance = (receiptOwned *
            vault.getPricePerFullShare()) / 1e18;
        ...
        return stakedFinalBalance - vestedInHBT;
    }
    ...
    function claim() public {
        ...
        //1845000000000000000000
        
        uint256 remainingVestedAmount = totalVestedAmount -
            purchaseInfo[msg.sender].totalHBTClaimed;

        //2050000000000000000000 - 1845000000000000000000 = 205
       


        uint256 timePassed = block.timestamp - presaleEndTime;

        // 1659474001-1659471268 = 2733
        ...
        // claimableTrenches = 10;

        claimableTrenches =
            claimableTrenches -
            purchaseInfo[msg.sender].claimedTrenches;
        
        // claimableTrenches = 10-9 = 1;
        ...
        // 1659474001+180-2733%180 = 1659474148
       ...
       // 203.626816312382308576
        ...
        if(finalHBTBal>remainingVestedAmount){
            rewardProfit = finalHBTBal - remainingVestedAmount;
        }

        uint256 reStakeAmount = finalHBTBal - tokensToClaim - rewardProfit;
        // 205-205-0 = 0
        if (reStakeAmount > 0) {
