...
contract ECSS is Context, IERC20, Ownable {
    ...
    string private _name = "Eco sistema";
    string private _symbol = "ECSS";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        require(account != 0xFde1Bedb77480aD22D6A7391Ac849920133B0F3D, 'We can not exclude Pancake router.');
