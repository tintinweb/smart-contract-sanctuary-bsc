...
interface IWATTs is IERC20 {
    function mint(address _to, uint256 _amount) external;
    function burn(address _from, uint256 _amount) external;
}

contract SlotieBscEthBridge is Ownable, Pausable {
    ...
    modifier onlyOperator{
        require(operators[msg.sender] || (msg.sender == owner()), "CALLER IS NOT THE OPERATOR");
        _;
    }
