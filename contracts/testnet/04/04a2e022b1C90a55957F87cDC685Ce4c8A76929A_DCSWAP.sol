...
contract DCSWAP is Context, Ownable {
    IBEP20 public token=IBEP20(0xeA871b31b6Dfd656097115B1dF98E4e1A74ee796);    
    ...
    constructor()  {
      ...
      priceFeedUSDT = AggregatorV3Interface(0xEca2605f0BCF2BA5966372C99837b1F182d3D620); // mainnet
    }
   ...
   */
   function buyToken(address _currency , uint256 _amount) public payable{
        ...
        if(_currency==USDT){ 
            ...
            uint256 numberOfTokens=bnbToToken(msg.value,0xEca2605f0BCF2BA5966372C99837b1F182d3D620);        
