...
contract gGRT is IgGRT, ERC20 {
    ...
    constructor(address _migrator, address _sGRT)
        ERC20("Governance GRT", "gGRT", 18)
    {
     ...
     * @param _sGRT address
     */
    function migrate(address _staking, address _sGRT) external override onlyApproved {
        ...
        require(_sGRT != address(0), "Zero address found");
        sGRT = IsGRT(_sGRT);
    }
    ...
    /**
     * @notice pull index from sGRT token
     */
    ...
    /**
        @notice converts gGRT amount to GRT
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts GRT amount to gGRT
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gGRT::getPriorVotes: not yet determined");
