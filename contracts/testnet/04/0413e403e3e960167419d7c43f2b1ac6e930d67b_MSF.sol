...
contract MSF is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        mTF = IBEP20(0x7d0e3a9f5A6aB89dC8CBD2954bE79b75d296D437);
        rewardToken = mTF;
        rewardPerBlock = 3 ether;
        startBlock = block.number;
        bonusEndBlock = 17916400;  // current 15916400 + 10 weeks approx

        // staking pool
        poolInfo.push(PoolInfo({
            lpToken: mTF, // Coin
            allocPoint: 1000,
            lastRewardBlock: 17916400,
            accTokensPerShare: 100
        }));
    ...
    function startReward() public onlyOwner {
        require(poolInfo[0].lastRewardBlock == 17916400, "Can only start rewards once");
