...
//===============================================================================================================
    ...
    function setRatios(uint16 liquidity, uint16 marketing, uint16 buyback, uint16 lottery, uint16 tokens) external onlyOwner {
        _ratios.liquidity = liquidity;
        _ratios.marketing = marketing;
        _ratios.buyback = buyback;
        _ratios.lottery = lottery;
        _ratios.tokens = tokens;
        _ratios.total = liquidity + marketing + buyback + lottery;
    }
    ...
    function setWallets(address payable marketing, address payable buyback, address payable lottery, address tokens) external onlyOwner {
    ...
    function takeTaxes(address from, bool buy, bool sell, uint256 amount) internal returns (uint256) {
        ...
        uint256 tokensAmount = (feeAmount * _ratios.tokens) / (_ratios.total + _ratios.tokens);
