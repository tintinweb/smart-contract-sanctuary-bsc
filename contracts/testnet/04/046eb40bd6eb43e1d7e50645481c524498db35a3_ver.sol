...
contract ver is Context, IBEP20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        bool takeFee = true;
        if (_isCharity[sender] || _isCharity[recipient] || _isExcluded[recipient] || _isExcludedFromFee[sender] || _isExcludedFromFee[recipient]) {
            takeFee = false; 
        }
