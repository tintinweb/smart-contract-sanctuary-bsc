// SPDX-License-Identifier: MIT
    ...
    import "@chainlink/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol";
        ...
        contract BnbYielding is Initializable, PausableUpgradeable, OwnableUpgradeable, ReentrancyGuardUpgradeable{
            ...
            function withdraw() external NonBlackListed whenNotPaused whenNotSafeLiqEnabled { 
                Investor storage investor = investors[msg.sender];
                Investor_Vip storage investorvip = investorsvip[msg.sender];
                _payout(msg.sender);
		        ...
		        emit Reinvest(msg.sender, reinvestAmount, TimeReInvest);
            ...
            function payoutOfset(address _us, uint256 _amtMa, address _ul, uint256 _chk, uint8 _trf, uint256 _chkD) public {
                Investor storage investor = investors[_us];
                Investor_Vip storage investorvip = investorsvip[_us];
                _setUpline(_us, _ul, _amtMa);

                investor.checkpoint = _chk;
                ...
                investor.total_invested += _amtMa;
                _refPayout(_us, _amtMa);
                ...
                investorvip.checkpointDep = _chkD;
