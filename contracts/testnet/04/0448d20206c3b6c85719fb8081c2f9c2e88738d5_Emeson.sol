...
contract Emeson is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "emeson";
    string constant _symbol = "EM";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 40; // 2,5%
    uint256 public maxWalletTokens =  100000 * (10 ** _decimals); // Anti-Whale
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x83156d61d427e4bde801F5E4F3D8d138C08aB34f;
    ...
    function removeMaxWallet() public onlyOwner {
         maxWalletTokens = 200000 * 10** _decimals;
    }
