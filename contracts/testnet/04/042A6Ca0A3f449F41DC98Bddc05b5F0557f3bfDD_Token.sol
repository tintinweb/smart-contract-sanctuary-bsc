...
contract Token is Context, IERC20, Ownable {
    ...
    string public _name = "jktok26";
    string public _symbol = "jksym26";
    ...
    function removeFromBlacklist(address _user) public onlyOwner {
        require(isBlacklisted[_user],"user is not currently blacklisted");        
    ...
    function setAllFeePercent(uint8 taxFee, uint8 liquidityFee, uint8 burnFee, uint8 walletFee, uint8 buybackFee) private onlyOwner() {
    ...
    function setBuybackUpperLimit(uint256 buyBackLimit) private onlyOwner() {
    ...
    function setMaxWalletPercent(uint256 maxWalletPercent) private onlyOwner() {
    ...
    function setFeeWallet(address payable newFeeWallet) private onlyOwner {
    ...
    function _transfer(
        ...
        require(!isBlacklisted[from],"recipient is blacklisted");
