...
contract ExeraV1 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor() {
        ...
        */
        ...
        address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd; // BSC
        address _router = 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3; // BSC
    ...
    */
    ...
    function _transfer(
        ...
        if(hasFees && (to == pair || from == pair)) {
            ...
            TokenFees.forreward = amount.mul(rewardFee).mul(100 - taxDiscount).div(10000);
