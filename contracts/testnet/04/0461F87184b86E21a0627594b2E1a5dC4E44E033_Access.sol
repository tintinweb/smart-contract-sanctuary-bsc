...
contract Access is AccessControl {
    ...
    bytes32 private constant VIP_ROLE = keccak256("VIP_ROLE");

    constructor(address admin) {
        _setupRole(DEFAULT_ADMIN_ROLE, admin);
        _setupRole(OPERATOR_ROLE, admin);
        _setupRole(MODERATOR_ROLE, admin);
        _setupRole(VIP_ROLE, admin);
        _setRoleAdmin(VIP_ROLE, MODERATOR_ROLE);
        _setRoleAdmin(USER_ROLE, MODERATOR_ROLE);
        _setRoleAdmin(MODERATOR_ROLE, OPERATOR_ROLE);
    }
}
