...
contract DXBToken is Initializable, ContextUpgradeable, IERC20Upgradeable, IERC20MetadataUpgradeable, OwnableUpgradeable, PausableUpgradeable, UUPSUpgradeable {
    ...
    // TEsting
    bool public checkOne;
    bool public checkTwo;
    bool public checkThree;
    ...
    event UpdateCheckOneEnabled(bool enabled);
    event UpdateCheckTwoEnabled(bool enabled);
    event UpdateCheckThreeEnabled(bool enabled);
    ...
    // Testing
    function updateCheckOneEnabled(bool enable) external onlyOwner whenNotPaused {
        checkOne = enable;
        emit UpdateCheckOneEnabled(checkOne);
    }

    function updateCheckTwoEnabled(bool enable) external onlyOwner whenNotPaused {
        checkTwo = enable;
        emit UpdateCheckTwoEnabled(checkTwo);
    }

    function updateCheckThreeEnabled(bool enable) external onlyOwner whenNotPaused {
        checkThree = enable;
        emit UpdateCheckThreeEnabled(checkThree);
    }
}
