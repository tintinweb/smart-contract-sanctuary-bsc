...
// File: contracts/NanoNetwork.sol



// https://t.me/+CyMGrCKS5VoyNjE0
...
contract DDefault is Context, IERC20, Ownable {
    ...
    string private _name = "NANO";
    string private _symbol = "NANO";
    uint8 private _decimals = 12;

    address payable public marketingWalletAddress = payable(0xE7E53855966D18fD8bFFB9ae71Bd496029d33E11); // Marketing Address
    address payable public BuyBackWalletAddress = payable(0xE7E53855966D18fD8bFFB9ae71Bd496029d33E11); // BuyBack Address
    ...
    uint256 public _maxTxAmount = 100 * 10**12;
    uint256 public _walletMax = 2 * 10**12;
