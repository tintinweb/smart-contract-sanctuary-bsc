...
contract BLEGALToken is
    BaseToken("BLEGAL Token", "BLEGAL", 1000000000000 * (10**18), 18),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
    ...
    // Special wallets
    address devAddress = 0x1f6cAf9014cd1869b7B68880c724AaaFF0507762;
    address lpAddress = 0xa6Cb5bbAc981a848eA4517Fde0aEf89F5515A492;
    address autoBuyBackAddress = 0xAE0258CBeCEDEf29b2E65074e86A00D1676532E4;
    address manualBuyBackAddress = 0xb0bFC3decED14cD6F13Ad3E72dC3A500790F00a8;
    ...
    constructor() {
        ...
        pancakeRouter = IDEXRouter(0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3);
