    ...
    UUPSUpgradeable
{
    ...
    function _payReferralInETH(uint256 _value, address _userAddress) private {
    ...
    function payReferralETHAdmin(
        ...
        _payReferralInETH(_value, _userAddress);
        return true;
    }

    function _payReferralInUSD(uint256 _value, address _userAddress) private {
        Account memory userAccount = accounts[_userAddress];
        uint256 totalReferral;
    ...
    function payReferralUSDAdmin(
        ...
        _payReferralInUSD(_value, _userAddress);
        return true;
    }
