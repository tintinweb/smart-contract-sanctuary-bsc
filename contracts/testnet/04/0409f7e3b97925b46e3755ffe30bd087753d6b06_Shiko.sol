...
contract Shiko is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000000000000000 * 10**1;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Shikoou inu";
    ...
    address public marketingWallet = 0xE6bEd22C32854a2Dad6296D02Ed7FA821FF435AA;
    uint256 private _previousmarketingFee = _marketingFee;

    uint256 public _walletMax =     1000000000000000 * 10**1;
    uint256 public _maxTxAmount =   1000000000000000 * 10**1;  
    ...
    uint256 private numTokensSellToAddToLiquidity = 8000 * 10**1;
    ...
    function setwalletmax(uint256 walletMax) external onlyOwner() {
        _walletMax = walletMax;
    }
}