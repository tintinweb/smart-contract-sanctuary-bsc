...
contract TaurenToken2 is Context, IBEP20, Ownable {
    ...
    address public castingPoolAddress = 0xAEAcecC74Ab607CE5431A903f0f2cD28dDFF5DA4;

    address public operationAddress = 0xa0669bCB3f37dEbeB8490f2CcaB4c1816CB61a43;

    address public genesisPoolAddress = 0x43433e85eB95E81026E6067f2Ff678EEeB0f0F65;

    address public pledgePoolAddress = 0xB99f7eEaa97fa52971741785ce52779174E9c2d4;

    address public IDOAddress = 0xaBeB2a70d69E5a00b0C2a77360ad4665E1dD8e72;

    address public relayAddress = 0x01DD36D043B139C1D8879ce8e800411769d6db5f;
    ...
    constructor () {
        ...
        TRN = TaurenNFT(0x7bA08fa3D8C3CD9D571062992665ED95d0928234);
    ...
    function setPledgePoolAddress(address _pledgePoolAddress) external onlyOwner {
        pledgePoolAddress = _pledgePoolAddress;
    }
    ...
    function genesisPrivatePlacement() public payable returns(uint256[] memory tokenIds) {
        ...
        payable(IDOAddress).transfer(msg.value);
    ...
    function sellTaurenNFT(uint256 tokenId) public {
        ...
        ERC20(BUSD).transferFrom(pledgePoolAddress, msg.sender, TRN.typeToNFTPrice(1));
    ...
    function pledgeNFT(uint256 types, uint256 tokenId) public {
        ...
        if(types == 2){
            ...
            _transfer(msg.sender, pledgePoolAddress, tokenAmount);
        }
    ...
    function quitPledgeNFT(uint256 tokenId) public {
        ...
        if(tokenAmount + profit > 0){
            _transfer(pledgePoolAddress, msg.sender, tokenAmount + profit);
        }
    ...
    function withdrawPledgeProfit(uint256 tokenId) public {
        ...
        if(profit > 0){
            _transfer(pledgePoolAddress, msg.sender, profit);
        }
