...
contract centest is Context, IERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(
        ...
        MarketingFeeInBNB = wallet.MarketingFeeInBNB;
        ...
        require(
            fee.setMarketingFee >= 0 && fee.setMarketingFee <= maxMarketingFee,
            "WF err"
        );
        require(
        ...
        require(
            fee.setWalletCharityFee >= 0 &&
                fee.setWalletCharityFee <= maxMarketingFee,
            "WFT err"
        );
        require(
        ...
        _MarketingFee = fee.setMarketingFee;
    ...
    function setAllFeePercent(
        ...
        require(MarketingFee >= 0 && MarketingFee <= maxMarketingFee, "WF err");
        require(buybackFee >= 0 && buybackFee <= maxBuybackFee, "BBF err");
        require(
            walletCharityFee >= 0 && walletCharityFee <= maxMarketingFee,
            "WFT err"
        );
    ...
    function setMarketingFeeTokenType(bool inBNB) external onlyOwner {
        MarketingFeeInBNB = inBNB;
    }
