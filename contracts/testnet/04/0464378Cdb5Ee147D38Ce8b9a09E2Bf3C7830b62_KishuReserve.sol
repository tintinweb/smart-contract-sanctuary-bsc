...
contract KishuReserve is Ownable {
    ...
    function kishGoldBalance() public  returns ( uint256) {
        ERC20 _erc20 = ERC20 ( engineecosystem.returnAddress("RhythmGold") );
    ...
    function sendRhythmGold ( address _to, uint256 _amount ) public onlyOwner {
         ERC20 _erc20 = ERC20 ( engineecosystem.returnAddress("RhythmGold") );
        _erc20.transfer ( _to , _amount );
    }
    
    function emergencyWithdrawalRhythmGold () public onlyOwner {
         ERC20 _erc20 = ERC20 ( engineecosystem.returnAddress("RhythmGold") );
