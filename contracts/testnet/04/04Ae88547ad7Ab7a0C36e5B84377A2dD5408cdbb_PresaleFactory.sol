...
contract PresaleFactory is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable, IPresaleFactory {
    ...
    function createPresale (
        ...
        if(!PRESALE_SETTINGS.getUserWhitelistStatus(address(_presaleToken))){
        ...
        bool isWhiteListed =  PRESALE_SETTINGS.getUserWhitelistStatus(address(_presaleToken));
        uint256 baseFee =  isWhiteListed ? 0 : PRESALE_SETTINGS.getBaseFee();
        uint256 tokenFee = isWhiteListed ? 0 : PRESALE_SETTINGS.getTokenFee();
        newPresale.init2(_baseToken, _presaleToken, baseFee, tokenFee, PRESALE_SETTINGS.getEthAddress(), PRESALE_SETTINGS.getTokenAddress());
    ...
    function setPresaleSettings(address presaleSettings) external onlyOwner {
        ...
        PRESALE_SETTINGS_ADDRESS = presaleSettings;
    }
