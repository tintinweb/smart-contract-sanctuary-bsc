...
contract ELongate is Context, IERC20, Ownable {
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x8C3d96973023B36123cca5E70ceCE4BE2806f9B5));
        marketingWalletAddress = payable(address(0x65c4607D2f6c332A28FcA88c9115C83A982ac456));
