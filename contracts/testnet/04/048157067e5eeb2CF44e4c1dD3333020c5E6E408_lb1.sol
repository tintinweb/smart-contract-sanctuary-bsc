...
contract lb1 is VRFConsumerBase,ReentrancyGuard,Ownable {
	using SafeMath for uint256;
    ...
    // Play Function
    function BuyTicket(address player,uint256 ticketValue,uint number1,uint number2) public nonReentrant {
