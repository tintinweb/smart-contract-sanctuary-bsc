...
contract CK_Stake is OwnableUpgradeable {
    ...
    function initialize() initializer public {
        ...
        //        ck = IERC20(0x084A0004ec2E8eEbfb0E60fB3Bd454FEd2Eb0C2c);
        //        ck = IERC20(0x794520Aa81a5b916039bbde73aD44EB2E4754D60);
        //        pair = 0x09f486566421E8F2B2207fBd0969FD3c77994E1A;
        //        ckPair = 0xfB86b990ad2d4Ef84CAF5365638177504634b844;
    ...
    function _processRefer(address addr, uint price) internal {
        ...
        for (uint i = 0; i < 10; i++) {
            ...
            if (isOut) {
                ...
                ck.transfer(temp, finalRew * 99 / 100);
                ck.transfer(wallet, finalRew / 100);
            } else {
    ...
    function stake(uint amount, uint tokenIndex, address invitor) external onlyEOA rateChange {
        ...
        if (!stakeW[msg.sender]) {
            ...
            reBuyCK(81 ether);
            U.transfer(wallet, U.balanceOf(address(this)));
        }
        TVL += power;
    ...
    function claimReward() external onlyEOA rateChange {
        ...
        if (out) {
            ...
            ck.transfer(msg.sender, finalsRew * 99 / 100);
            ck.transfer(wallet, finalsRew / 100);
