...
contract  CCY is IERC20, Ownable {
    ...
    constructor(){  
             address adminAddress = 0xA0da3032f269cf1D1484732C573EB068E224c3F2; //收币地址
            _name = "CCK TOKEN"; //代币名称
            _symbol = "CCK TOKEN";//代币简写
            _decimals= 18;
            _tTotal = 90000* (10**uint256(_decimals)); //代币数量
            _marketingFee = 100;//营销钱包手续费 代币数量 需要X100
            _LPFee = 400;//LP分红手续费 需要X100
            marketAddr =  0x683130Cd611489dA045334e00c0d1A2961206d54; //营销钱包
