...
contract PlantTest is ERC721Pausable, AccessControl, Ownable, IPlantValue {
    ...
    address public TkTToken = 0x9E99EAaCf87cE80da8e903c7Df32e1F4D178DAeC;
    bool public isBurn;
    uint256 public rate;
    ...
    function burnPlant(uint256 _tokenId) external {
        ...
        IERC20(TkTToken).transfer(msg.sender, amount);
    }
    ...
    function getBalance() public view returns (uint256) {
        return IERC20(TkTToken).balanceOf(address(this));
    }

    function withdrawBalance() external onlyOwner {
        IERC20(TkTToken).transfer(owner(), getBalance());
    }
