...
contract Fomb is ERC20Burnable, Operator {
   ...
   uint256 public constant INITIAL_TOMB_POOL_DISTRIBUTION = 10000 ether; // 140000
    ...
    */
   constructor(uint256 _taxRate, address _taxCollectorAddress) ERC20("FOMB", "FOMB") {
   ...
   function _updateTaxRate(uint256 _tombPrice) internal returns (uint256 u) {
      if (autoCalculateTax) {
