...
contract Workers is ERC721Enumerable, Ownable, WorkerFactory, PriceConsumerWTN {
    ...
    ChestContract wtContractSettler     = ChestContract(0x907645dC735FcECa8c3B836FDf9d28C9c13fb555);
    IERC721 wtContractSettler721        = IERC721(0x907645dC735FcECa8c3B836FDf9d28C9c13fb555);

    ChestContract wtContractMigrant     = ChestContract(0xC78D0e7D2049Dbe74D2B29d7E0E45dB3ecE5CFB7);
    IERC721 wtContractMigrant721        = IERC721(0xC78D0e7D2049Dbe74D2B29d7E0E45dB3ecE5CFB7);

    ChestContract wtContractChristmas   = ChestContract(0x1C59c88A0C4a04F06E486101703A20D03ae99995);
    IERC721 wtContractChristmas721      = IERC721(0x1C59c88A0C4a04F06E486101703A20D03ae99995);

    ChestContract wtContractLegion      = ChestContract(0x77DdB9f8c6cC81EdE6dCaBfDDC2517C259CC51AA);
    IERC721 wtContractLegion721         = IERC721(0x77DdB9f8c6cC81EdE6dCaBfDDC2517C259CC51AA);

    WorkersContractOld wtContractWorkersOld = WorkersContractOld(0x9cc6AC365948AAE34AFa62813319bA144c792798);
    IERC721 wtContractWorkersOld721     = IERC721(0x9cc6AC365948AAE34AFa62813319bA144c792798);

    address tokenAddress                = 0xdcBc3957b90569f916F666192EDEEC1E59f19d4C;
    IERC20 wtToken                      = IERC20(0xdcBc3957b90569f916F666192EDEEC1E59f19d4C);   

    address townshipAddress;

    uint256 workerCreateFee             = 80;
    uint8   developmentTax = 5;
    ...
    function setDevelopmentTax(uint8 _value) external onlyOwner {
        developmentTax = _value;
    }
    ...
    function value() public view returns (uint256) {
        ...
        uint256 amountBNBReward = (workerCreateFee * 1 ether) / BNB_USD_Price; //  cuantos bnb son
        // return amountBNBReward;
        return (amountBNBReward * 1 ether) / ERC20_BNB_Price; //  amounBNBReward = weis cuantos bnb son la cantidad de dolares deseada    erc20_bnb_price = weis de bnb
    }
   ...
   function canPayCreate() internal view returns (bool) {
    ...
    function evolveWorker(uint256 tokenId) external {
        ...
        require(msg.sender == wtContractWorkersOld.ownerOf(tokenId), "you dont own the NFT");
        WorkersContractOld.Worker memory v1 = wtContractWorkersOld.getWorkerData(tokenId);

        wtContractWorkersOld.burn(tokenId);
        _createWorker(v1.class_id, v1.rarity, v1.gender_id, _nftId);
        _nftId++;

        // ver si es el owner --
        // copiar el metadata
        // quemarlo
        // crear nuevo nft con los valores

    }

    function createWorkerFee() public {
        uint256 amountExp               = value();
    
        IERC20(tokenAddress).transfer(address(this), amountExp.mul(100 - (developmentTax + nextRewardsTax + burnTax)).div(100));
        IERC20(tokenAddress).transfer(developmentAddress, amountExp.mul(developmentTax).div(100));
        IERC20(tokenAddress).transfer(nextRewardsAddress, amountExp.mul(nextRewardsTax).div(100));
        ERC20Burnable(tokenAddress).burn(amountExp.mul(burnTax).div(100));
    }
        

    function createWorker() external {
        require(townshipOpened, "township is closed");
