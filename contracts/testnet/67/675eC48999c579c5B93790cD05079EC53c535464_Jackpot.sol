...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xD6B8C629B26e132aC196252201167857C7A59DE0;
...
contract Jackpot is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Marketing = payable(0xDb63821949F870a36b321876AD9c69a482D582C5); // Marketing wallet  
    ...
    */
    ...
    string private _name = "777 Jackpot"; 
    ...
    uint256 public _buyFee = 89;
    uint256 public _sellFee = 11;

    // Distirbution of fees
    uint256 public Percent_Marketing = 20;
    uint256 public Percent_Jackpot = 70;
    ...
    */
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
            ...
            uint256 tokens_to_Jackpot = contractTokenBalance * Percent_Jackpot / 100;

            uint256 balanceBeforeSwap = address(this).balance;
            swapTokensForBNB(tokens_to_LP_Half + tokens_to_M + tokens_to_Jackpot);
            ...
            uint256 split_J = Percent_Jackpot * 100 / (Percent_AutoLP + Percent_Marketing + Percent_Jackpot);
            uint256 BNB_J = BNB_Total * split_J / 100;


            addLiquidity(tokens_to_LP_Half, (BNB_Total - BNB_M - BNB_J));

            emit SwapAndLiquify(tokens_to_LP_Half, (BNB_Total - BNB_M -BNB_J), tokens_to_LP_Half);
