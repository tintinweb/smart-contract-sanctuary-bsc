...
// function to dispute & resolve dispute
    ...
    function fetchMyEscrows() public view returns (Escrow[] memory) {
        ...
        for (uint i = 0; i < totalEscrowCount; i++) { // the || operator isn't working here. need a find a better way to do this. for now, using 2 loops to check if the user is the buyer or seller. This is not efficient...
