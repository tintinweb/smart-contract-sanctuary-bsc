...
contract RPNWinnerV18 {
    ...
    event TransferByDevFund(address user, address receiver, uint256 amount);
    ...
    function transferByDevFund(address _receiver, uint256 _amount) external {
        ...
        emit TransferByDevFund(msg.sender, _receiver, _amount);
    }
...
//        if (total >= 400e18 && user.teamNum >= 25 && maxTeam >= 5000e18 && otherTeam >= 5000e18) {
        if (total >= 400e18 && user.teamNum >= 3 && maxTeam >= 500e18 && otherTeam >= 500e18) {
            levelNow = 2;
        } 
//        if (total >= 800e18 && user.teamNum >= 50 && maxTeam >= 10000e18 && otherTeam >= 10000e18) {
        if (total >= 800e18 && user.teamNum >= 5 && maxTeam >= 1000e18 && otherTeam >= 1000e18) {
            levelNow = 3;
        } 
//        if (total >= 1000e18 && user.teamNum >= 100 && maxTeam >= 20000e18 && otherTeam >= 20000e18) {
        if (total >= 1000e18 && user.teamNum >= 8 && maxTeam >= 2000e18 && otherTeam >= 2000e18) {
            levelNow = 4;
        } 
//        if (total >= 2000e18 && user.teamNum >= 200 && maxTeam >= 40000e18 && otherTeam >= 40000e18) {
        if (total >= 2000e18 && user.teamNum >= 10 && maxTeam >= 4000e18 && otherTeam >= 4000e18) {
            levelNow = 5;
        }
//        if (total >= 2000e18 && user.teamNum >= 300 && maxTeam >= 75000e18 && otherTeam >= 75000e18) {
        if (total >= 2000e18 && user.teamNum >= 12 && maxTeam >= 7500e18 && otherTeam >= 7500e18) {
            levelNow = 6;
        }
        return levelNow;
    }
