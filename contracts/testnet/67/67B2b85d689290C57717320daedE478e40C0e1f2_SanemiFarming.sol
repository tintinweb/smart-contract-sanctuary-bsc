...
contract SanemiFarming{

    //address sanemi = 0xe659901847e9820B26A0aFBfeD9283DEce0EB6B3; //Sanemi contract Testnet
    address public sanemi = 0xe659901847e9820B26A0aFBfeD9283DEce0EB6B3; // sanemi contract Mainnet
    ...
    function ContractFarming(address sanemiN) external{
        require(ceoAddress == msg.sender, "only owner");
	    sanemi = sanemiN;
    }
