...
contract TestNFT is ERC721, ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    uint256 public price = 100 gwei;
    uint256 public rechargePrice = 6415 gwei;
    uint256 public breedingPrice = 100 gwei;
    uint256 public maximumClaimablePercentage = 10;
    uint256 public minClaim = 1603 gwei;
    uint256 public maxClaim = 8020 gwei;
    ...
    function mintRandom(uint256 _quantity) public nonReentrant {
        ...
        for (uint256 i = 0; i < _quantity; i++) {
            safe_mint(msg.sender, totalsupply());
