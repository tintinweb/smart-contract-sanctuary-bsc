...
contract Token is Context, IBEP20, Ownable {
    ...
    address public _marketingWallet = 0x11Fbd9DE4B44d392eaf10c6010253150fDE8Ac2d; /// ####
    address public _devWallet = 0x489ED969bc7817E701Cf928332b64978AF739F09; /// ####
    ...
    string private _name     = "test 0005";
    string private _symbol   = "t0005";
    uint8 private  _decimals = 9;

    uint256 public _taxFee          = 0;
    uint256 public _marketingFee    = 8;
    uint256 public _devFee    = 8;
    uint256 public _liquidityFee    = 20;    //liquidity + marketing
    uint256 public _swapThreshold   = 10 ** 10 * 9; //0.5%;
    ...
    function sedDevWallet(address devWallet) external onlyOwner {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        */
        ...
        // take marketing fee
        uint256 marketingFee   	= calculateSystemFee(newBalance);
        uint256 devFee   	= calculateSystemFee(newBalance);
