...
contract HeadEndGame is Ownable, Pausable, ReentrancyGuard {
    ...
    event BetClaimed(uint256 indexed id, address indexed user, uint256 amount);
    ...
    event NewTreasuryRate(uint256 indexed round, uint256 treasuryFee);
    ...
    function placeBet(
        ...
        emit PlaceBet(id, _msgSender(), amount, head);
    }
        ...
        nonReentrant
    {
        ...
        for (uint256 i = 0; i < betIds.length; i++) {
            ...
            emit BetClaimed(bet.roundID, _msgSender(), profit);
        }
