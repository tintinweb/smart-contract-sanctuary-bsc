...
contract Deelian {
     ...
     address payable private Token = 0xb5450ffaf67E289A185C20F643Cd69507617196e;
    // state variables
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function Proposal_Approval() public payable {
      ...
      // require(donutBalances[address(this)] / ((amount * deelian_price * 25/100) + amount* deelian_price)>= 3, "Transaction Still Pending");
     
     //deelianprice = deelian_price/10000;
     
     // if (  (donutBalances[address(this)]*deelian_price) /   ((amount * deelian_price * 25/100) + amount * deelian_price)>= 3)
      
      if (  (donutBalances[address(this)]*deelian_price) / ee_deelian[msg.sender]>= 3)
      
      {

        //balances[msg.sender] += (amount * 18/100);
       // balances[msg.sender] = balances[msg.sender] + ee_deelian[msg.sender];
