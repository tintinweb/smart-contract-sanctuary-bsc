...
// File: contracts/FS/StakerTierFantomStarter.sol
...
contract StakerTierFantomStarter is ERC1155Holder, AccessControl {
    ...
    constructor(ITierFactoryFantomStarter _tierFactory, IERC20 _fsToken, IERC20 _sFSToken, address _devWallet) {
    ...
    **/
    ...
    function unstakeTierFSTokensAfterLockupPeriod() public {
        ...
        require(sFSToken.balanceOf(msg.sender) >= _stakedTierFSToken.tokenAmount, "You don't have enough sFS token!");
