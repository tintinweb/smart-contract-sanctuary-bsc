...
contract ReflexPreSale is Crowdsale, Pausable, FinalizableCrowdsale {
  ...
  function dexListing() private {
    ...
    uint256 tokenForLiquidity = (((bnbBalanceInContract - fee) * listingRate) * liquidityPercentage) / 10 ** 2;
    uint256 bnbForLiquidity = tokenForLiquidity / listingRate;
  ...
  */
  function userWithdrawContributionWhileSoftcapNotReached() external whenNotPaused {
    ...
    totalUserTokenBalance -= userTokenBalance[msg.sender];
