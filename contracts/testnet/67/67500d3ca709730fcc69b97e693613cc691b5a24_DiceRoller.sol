...
contract DiceRoller is VRFConsumerBaseV2, ReentrancyGuard {
  ...
  constructor() VRFConsumerBaseV2(vrfCoordinator) {
    ...
    minerAddress = 0xA2a295E49e262226F152681bc9c7A719Cb8d23C5; //Mining contract address

    busdAddress = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; //BUSD Token contract address
  ...
  function betUp(uint256 _amount) isUnpaused public {
    rollDice(1,_amount);
  }

  function betDown(uint256 _amount) isUnpaused public {
    rollDice(0,_amount);
  }
