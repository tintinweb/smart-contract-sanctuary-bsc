...
contract SpacePad is Pausable, Ownable, ReentrancyGuard {
        ...
        nonReentrant
    {
        ...
        if (_referrer == address(0)) {
            IERC20(BUSD_ADDRESS).safeTransferFrom(
                msg.sender,
                address(this),
                _amount
            );
            ...
            IERC20(BUSD_ADDRESS).safeTransferFrom(msg.sender, _referrer, fee);
            IERC20(BUSD_ADDRESS).safeTransferFrom(
                msg.sender,
                address(this),
                depositAmount
    ...
    function withdraw(address _recipient) external whenNotPaused onlyOwner {
        ...
        uint256 balance = IERC20(BUSD_ADDRESS).balanceOf(address(this));
        IERC20(BUSD_ADDRESS).safeTransfer(_recipient, balance);
