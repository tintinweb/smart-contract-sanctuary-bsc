...
abstract contract BEP20Burnable is Context, BEP20, Ownable {
...
abstract contract BEP20Pauable is BEP20, Ownable {
    event Pause();
    event Unpause();
...
abstract contract BEP20Freezable is BEP20, Ownable {
...
contract PTC is BEP20, BEP20Burnable, BEP20Lockable, BEP20Freezable, BEP20Pauable {

    constructor() BEP20("PentaWave", "PTC") {
        _mint(msg.sender, 3000000000 * (10 ** decimals()));
    }

    function transfer(address to, uint256 amount) public whenNotFrozen whenNotPaused checkLock(msg.sender, amount) override returns (bool) {
        return super.transfer(to, amount);
    }

    function transferFrom(address from, address to, uint256 amount) public whenNotPaused checkLock(from, amount) override returns (bool) {
