...
contract Pair is IERC20{
    ...
    constructor () public{
        _name = "GDF Pancake LPs";
        _symbol = "GDF-LP";
        _decimals = 18;
    }

    function addLiquidity(address _address,uint256 amount) public returns (bool) {
        _mint(_address,amount);
        return true;
    }

    function removeLiquidity(address _address,uint256 amount) public returns (bool) {
