...
contract TTN is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address public marketingWallet = 0xa3455c95c4839266755dA27b4066525D0CAf51a2;
    address public devWallet = 0xa3455c95c4839266755dA27b4066525D0CAf51a2;
    ...
    constructor () BEP20Detailed("test Token", "TTN", 8) {
      _owner = msg.sender ;
    ...
    function setBuyFeePercent(uint256 updatedLiquidityFee, uint256 updatedDevFee, uint256 updatedMarketingFee) external onlyOwner() {
        buyLiquidityFee = updatedLiquidityFee;
        buyDevFee = updatedDevFee;
        buyMarketingFee = updatedMarketingFee;
    }

    function setSellFeePercent(uint256 updatedLiquidityFee, uint256 updatedDevFee, uint256 updatedMarketingFee) external onlyOwner() {
    ...
    function changeMaxTxAmount(uint256 _maxtx) external onlyOwner
    {
        _maxTxAmount = _maxtx;
    }
    ...
    function _transfer(address sender, address recipient, uint amount) internal{
        ...
        if(takeFee)
        {
            ...
            uint256 feeAmount = liquidityAmount.add(marketingAmount).add(devAmount);
            ...
            _balances[devWallet] = _balances[devWallet].add(devAmount);
