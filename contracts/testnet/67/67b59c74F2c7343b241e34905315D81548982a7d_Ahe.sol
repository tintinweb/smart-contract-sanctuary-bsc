...
contract Ahe is Context, IERC20, Ownable {
    ...
    uint256 private minimumTokensBeforeSwap = 9000000 * 10**_decimals; 
    ...
    constructor () {
        ...
        teamWalletAddress = payable(address(0x3C2F4c4C6a18bb057730710860e1A5fB6942aF33));
        marketingWalletAddress = payable(address(0x3C2F4c4C6a18bb057730710860e1A5fB6942aF33));
