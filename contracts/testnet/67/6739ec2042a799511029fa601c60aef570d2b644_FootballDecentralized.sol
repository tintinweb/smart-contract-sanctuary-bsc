...
// Football Decentralized with Governance.
contract FootballDecentralized is BEP20('Football Decentralized', 'FBD'), LGEWhitelisted {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "FBD::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "FBD::delegateBySig: invalid nonce");
        require(now <= expiry, "FBD::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "FBD::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying FBDs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "FBD::_writeCheckpoint: block number exceeds 32 bits");
