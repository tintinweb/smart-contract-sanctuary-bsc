...
contract HoneyPad is ERC20, Ownable {
    ...
    constructor(string memory _name, string memory _symbol, uint256 _supply, uint256[3] memory _buyFees, uint256[3] memory _sellFees, address[3] memory _addresses, uint256 _minimumTokenBalanceForDividends) ERC20(_name, _symbol) {
        buyback = _buyFees[0];
