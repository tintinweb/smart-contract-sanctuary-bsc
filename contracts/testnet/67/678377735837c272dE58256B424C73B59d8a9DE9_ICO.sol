...
contract ICO is Ownable, Crowdsale, RefundPostDeliveryCrowdsale {
    ...
    uint256 public constant MAX_TOKEN_LIMIT = 77777778 * 10**18;
    uint256 privateRate;
    uint256 publicRate;
 ...
 * to token holders.
 */
contract RefundPostDeliveryCrowdsale is RefundableCrowdsales {
    ...
    PostDeliveryCrowdsales
{
     ...
     */
    function claimRefund(address payable refundee) external {
    ...
    function buyBack() external {
        ...
        require(!finalized(), "RefundableCrowdsale:  finalized");
...
contract EscrowRefund is ConditionalEscrow {
    ...
    function withdrawalAllowed(address) public view returns (bool) {
        bool allowed = (_state == State.Refunding || _state == State.Active);
        return allowed;
    }
}
