...
contract KazamaClaimGame is TheZaibatsu {
    ...
    uint256 totalTimesWon;
    uint256 burnedByClaims;
    }

    address[] winners;
    mapping (address => uint256) winnerIndexes;
    mapping (address => winnerStruct) public winnerData;
    ...
    function addWinner(address winner) internal {
      winnerIndexes[winner] = winners.length;
      winners.push(winner);
    }
    ...
    function claimKazama() external notContract {
        ...
        if (winnerData[winner].totalTimesWon < 0) {
            addWinner(winner);
        }
        
        winnerData[winner].totalTimesWon += 1;
        winnerData[winner].totalAmountWon = winnerData[winner].totalAmountWon + correctedClaim;
        winnerData[winner].burnedByClaims = winnerData[winner].burnedByClaims + claimBurn;

        if (winnerData[winner].totalTimesWon >= winsForTopClaimer) {
            topClaimer[winner] = true;
        }
    ...
    function claimRewardTokenPot() external onlyTopClaimer {
        ...
        topClaimer[winner] = false;
        winnerData[winner].totalTimesWon = 0;
...
contract KazamaRankPots is TheZaibatsu {
    ...
    uint256 public shrimpBalance = 50000e18;
    uint256 public crabBalance = 75000e18;
    uint256 public fishBalance = 100000e18;
    uint256 public turtleBalance = 200000e18;
    uint256 public dolphinBalance = 300000e18;
    uint256 public orcaBalance = 500000e18;
    uint256 public sharkBalance = 750000e18;
    uint256 public whaleBalance = 2500000e18;
    uint256 public krakenBalance = 5000000e18;
    uint256 public spacenautBalance = 10000000e18;
