...
contract MPUpdateCard is Initializable, ERC721,Member {
    ...
    function initialize(INFT _nft,IERC20 _usdt, IERC20 _mp, IUniswapV2Pair _pair) public initializer {
    ...
    function setPair(IUniswapV2Pair _pair, IPancakeRouter02 _pancakeSwap) external {
        require(msg.sender == manager.members("owner"));
        pair = _pair;
    ...
    function distribute(uint256 needpay) internal{
        ...
        usdt.approve(address(pancakeSwap), 1000000000* 1e18);
