...
// This contract locks metastarterSwap liquidity tokens. Used to give investors peace of mind a token team has locked liquidity
...
contract metastarterSwapLocker is Initializable,Ownable, ReentrancyGuard  {
    ...
    function setSwapFactory(address _factory) external onlyOwner returns (bool) {
...
function initt() public onlyInitializing {
...
abstract contract Ownable is Context , Initializable {
     ...
     */
       function init() public onlyInitializing {
