...
contract GTITstaking {
	...
	uint256 constant public LiquidityFees = 10;
   ...
   address [] private admins;  
	constructor(address payable wallet)  {
		...
		admins.push(wallet);
        plans.push(Plan(180, 50000,10000000000000000000,true,0));
		plans.push(Plan(365, 100000,50000000000000000000,true,0));
	...
	function invest(address referrer, uint8 plan,uint256 stackAmount) public  {
		...
		token.safeTransferFrom(msg.sender,LiquidityWallet,fee);
