...
contract ClaimNftReward is AccessControl, Pausable, ERC721Holder {
    ...
    constructor (IERC721Transfer _nftContractAddress) {
    ...
    function setNftsIds(uint256[] calldata _nftsIds) external onlyRole(DEFAULT_ADMIN_ROLE) {
        delete nftArray;
