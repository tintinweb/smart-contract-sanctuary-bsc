...
contract NationsCombatICO is NationsCombatToken {
    ...
    uint256 tokenPrice; // 1 ETH = 1000 CRTP, 1 CRPT = 0.001
        
  
    uint256 public raisedAmount; // this value will be in wei
    uint256 private saleStart;
    uint256 private saleEnd; //one week
    ERC20Interface public tokenContract;
    uint256 private tokenTradeStart; //transferable in a week after saleEnd
...
/*function token(uint _token)public view returns(uint256){
    return _token *10 **18;
}*/
    ...
    function transferFrom(
        ...
        NationsCombatToken.transferFrom(from, to, tokens); // same as super.transferFrom(to, tokens);
        return true;
    }
}
