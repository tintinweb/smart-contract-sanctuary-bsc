...
library NFIDGeneration{
    function generateNFID(string memory x, string memory y) public pure returns (uint256){
...
*/
    ...
    function mint(
        ...
        bytes32 messageHash = getMessageHash(to, _message, deadline, x, y);
...
*/
    ...
    function getMessageHash(
        ...
        return keccak256(abi.encodePacked(to, _message, deadline, x, y));
    }
