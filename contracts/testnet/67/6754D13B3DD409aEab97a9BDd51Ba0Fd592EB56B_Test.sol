...
contract Test is IERC20, Ownable {
    ...
    */
    constructor(string memory name_, string memory symbol_, bool[4] memory flags_, uint256[9] memory feesAndLimits_, address markAddr) {
        ...
        require(feesAndLimits_[2] + feesAndLimits_[3] + feesAndLimits_[4] + feesAndLimits_[5] <= feesAndLimits_[6], 'Fees too high');
        ...
        emit UpdateFees(feesAndLimits_[2], feesAndLimits_[3], feesAndLimits_[4], feesAndLimits_[5]);
