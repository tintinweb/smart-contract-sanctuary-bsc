...
contract MFTStaking {
    ...
    mapping(address => uint256) public DurationUint;
    ...
    function _stakingInDue(uint256 _amount) public {
        ...
        customHasStaked3[msg.sender] = true;
        customIsStakingAtm3[msg.sender] = true;
        Duration256[msg.sender] = (block.timestamp - startTime3[msg.sender]) / 86400;
        DurationUint[msg.sender] = (block.timestamp - startTime3[msg.sender]) / 86400;
    }
