...
contract TerraMoon is Context, IERC20, Ownable {
    ...
    string private _name = "TerraMoon";
    ...
    uint256 private _previousLiquidityFee = 10;
    ...
    address payable private _liquidityAddress = 0x75Ba3797819B85e97496060a7CDB4DFA882d6D22;
    address payable private _marketingAddress = 0xB4065b8c1C8823d97e30393bA30197617160FCbA;
    ...
    constructor() public {
        ...
        _maxWalletSize = _tTotal.div(10**2);
        numTokensSellToAddToLiquidity = _tTotal.div(10**2);
    ...
    function setMarketingAddress(address payable _address) public onlyOwner {
    ...
    function sendETHToFee(uint256 amount) private {
        uint256 lpAmount = amount.div(2);

        _liquidityAddress.transfer(lpAmount);
