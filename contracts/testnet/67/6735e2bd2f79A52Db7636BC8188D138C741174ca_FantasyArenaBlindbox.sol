...
interface IERC721Mintable is IERC721, IERC721Enumerable, IERC721Metadata {
    function autoMint(string memory tokenURI, address to) external returns (bool);
}
...
contract FantasyArenaBlindbox is VRFConsumerBaseV2
{
    ...
    constructor() VRFConsumerBaseV2(0x6A2AAd07396B36Fe02a22b33cf443582f682c82f)  {
        owner = msg.sender;
        wallet = payable(0xA5139A7fb5eC250D2780f2627f6EfD7E1B184700);
        blindboxCost = 1 * 10 ** 17; // 0.1 BNB

        // Nft Contract
        nftContractAddress = 0xa923f76B6a965F301066aA2fc35389b60A5bc149;
        ...
        // Box Contents
        possibleNfts.push(PossibleNft(1, 0, "LEGENDARY"));
        possibleNfts.push(PossibleNft(2, 0, "EPIC"));
        possibleNfts.push(PossibleNft(3, 0, "RARE"));
    ...
    function purchaseBlindbox() public payable {
    ...
    function openBlindbox(uint256 index) public {
        require(soldBoxes[boxIndexes[index]].purchaser == msg.sender, "You do not own this blindbox.");
        require(soldBoxes[boxIndexes[index]].key > 0, "This box is not ready to be opened yet. Please try again soon.");
        ...
        NFT_MINTABLE.autoMint(uri, msg.sender);
    ...
    function setChainlink(address coordinatorAddress, address linkAddress, bytes32 hash, uint32 gasLimit, uint16 confirmations) public onlyOwner {
    ...
    function unsubscribe(address to) external onlyOwner {
        COORDINATOR.cancelSubscription(subscriptionId, to);
        subscriptionId = 0;
    }
