...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7); //testnet pancake
    ...
    constructor (address _router) {
        router = _router != address(0)
            ? IDEXRouter(_router)
            //: IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); mainet pancake
            : IDEXRouter(0xD99D1c33F9fC3444f8101754aBC46c52416550D1);  //testnet pancake
        _token = msg.sender;
    }
...
contract BUSDBuffetTest is IBEP20, BBFTAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "BUSD Buffet Test2";
    string constant _symbol = "BBFTest2";
    uint8 constant _decimals = 18;

    uint256 _totalSupply =  1000000000000000000000000; // 1 million //поколдуй здесь,залей норм ликвидность чтобы наглядно было
    uint256 public _maxTxAmount = _totalSupply.div(10); // 10% - 100 000 //поколдуй здесь
    ...
    uint256 public kitchenFee = 100;
    uint256 totalFee = 1200;
    uint256 public feeDenominator = 10000;

    uint256 public BKITBUSDthreshold = 250000000000000000000; // 250
    ...
    uint256 public swapThreshold = _totalSupply / 2000; // 500
    bool public inSwap;
    ...
    constructor () BBFTAuth(msg.sender) {
        //address dexRouter_ = 0x10ED43C718714eb63d5aA57B78B54704E256024E; mainnet
        address dexRouter_ = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1; //testnet pancake
