...
contract COPPV is IERC20, Ownable {
    ...
    address public fundAddress = 0xf5f90AcfD657c5464E16dce26B771d1Be040dfb8;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == address(uniswapV2Pair)){
            uint256 fundFee = amount.mul(_fundFee).div(denominator);
    ...
    function setFundFee(uint256 fundFee_, uint256 denominator_) external onlyOwner {
        _fundFee = fundFee_;
        denominator = denominator_;
    }

    function getFundFee() public view returns (uint256) {
        return _fundFee;
    }
