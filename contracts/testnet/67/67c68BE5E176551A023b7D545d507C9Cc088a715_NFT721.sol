...
contract NFT721 is Ownable, SignerRole, IERC721, ERC721Base, ExchangeDomain {
    ...
    event TransferTest(address indexed from, address indexed to, uint256 money);
    ...
    function testTransfer(address to, AssetType assetType, uint price, address addressToken) payable public {
        transfer(to, assetType, price, addressToken);
    }
