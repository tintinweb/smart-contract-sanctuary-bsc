...
contract TendriBSC is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Tendri BSC";
    ...
    address payable public marketingWalletAddress = payable(0x39B0Ca5B00eeb9674b66C004955CAd12C67DFd1e);
    address payable public teamWalletAddress = payable(0x2b494F62b1a955E8D60E30D0C05760E3C45d1c69);
