...
contract CastDiem is Context, IERC20, Ownable {
    ...
    function setSellFee(
        ...
        require( (liquidity + marketing + charity)  < 20 , "Total sell tax must be lower than 20%");
    ...
    function setBuyFee(
        ...
        require( (liquidity + marketing + charity)  < 20 , "Total buy tax must be lower than 20%");
    ...
    function setBothFees(
        ...
        require( (buy_liquidity + buy_marketing + buy_charity)  < 20 , "Total sell tax must be lower than 20%");
        require( (sell_liquidity + sell_marketing + sell_charity)  < 20 , "Total buy tax must be lower than 20%");
