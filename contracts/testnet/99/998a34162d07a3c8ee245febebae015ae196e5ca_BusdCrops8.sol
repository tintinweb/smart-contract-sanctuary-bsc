...
contract BusdCrops8 {
    ...
    constructor(address _owner, address _dev1, address _dev2, address _dev3, address _mkt) {
		require(!isContract(_owner) && !isContract(_dev1) && !isContract(_dev2) && !isContract(_dev3) && !isContract(_mkt));
        owner = _owner;
        dev1 = _dev1;
        dev2 = _dev2;
        dev3 = _dev3;
