...
contract OverrideMatrix is AccessControl {
    ...
    function _newLocation(address _account, uint256 _newGrade) internal {
        ...
        _addLocations(_account, accountInfoList[_account].referRecommender, _newGrade, false);
    }

    function _addLocations(address _account, address _vertex, uint256 _newGrade, bool isReIn) internal {
        ...
        if (types == 6) {
            ...
            if (_vertex != address(0)) {
                _addLocationsTo6(_account, _vertex, _newGrade, isReIn);
            }
        }
        if (types == 3) {
    ...
    function _addLocationsTo6(address _account, address _vertex, uint256 _grade, bool isReIn) internal {
        if (accountInfoList[_vertex].matrix6Grade[_grade].upperLayer[0] == address(0) ||
            ...
            if (accountInfoList[_vertex].matrix6Grade[_grade].upperLayer[0] == address(0)) {
                _set6Location(_vertex, _account, _grade, 0, isReIn);
            } else {
                _set6Location(_vertex, _account, _grade, 1, isReIn);
            }
        } else {
            for (uint256 i = 0; i < 4; i++) {
                if (accountInfoList[_vertex].matrix6Grade[_grade].lowerLayer[i] == address(0)) {
                    if (i == 0 || i == 1) {
                        ...
                        _set6Location(upper, _account, _grade, i, isReIn);
                    } else {
                        address upper = accountInfoList[_vertex].matrix6Grade[_grade].upperLayer[1];
                        _set6Location(upper, _account, _grade, i.sub(2), isReIn);
                    }
                    _set6Location(_vertex, _account, _grade, i.add(2), isReIn);
                    return;
                }
            }
        }
    ...
    function _set6Location(address _setKey, address _setValue, uint256 _setGrade, uint256 _setLocation, bool isReIn) internal {
        if (_setLocation == 0) {
            ...
            if (accountInfoList[_setKey].matrix6Grade[_setGrade].upper != address(0)) {
                if (
                    ...
                    if (accountInfoList[accountInfoList[_setKey].matrix6Grade[_setGrade].upper].matrix6Grade[_setGrade].lowerLayer[2] == address(0)) {
                        _set6Location(accountInfoList[_setKey].matrix6Grade[_setGrade].upper, _setValue, _setGrade, 4, true);
                    }
                } else if (
                    ...
                    if (accountInfoList[accountInfoList[_setKey].matrix6Grade[_setGrade].upper].matrix6Grade[_setGrade].lowerLayer[0] == address(0)) {
                        _set6Location(accountInfoList[_setKey].matrix6Grade[_setGrade].upper, _setValue, _setGrade, 2, true);
                    }
                }
            } else {
                if (!isReIn) {
            ...
            if (accountInfoList[_setKey].matrix6Grade[_setGrade].upper != address(0)) {
                if (
                    ...
                    if (accountInfoList[accountInfoList[_setKey].matrix6Grade[_setGrade].upper].matrix6Grade[_setGrade].lowerLayer[3] == address(0)) {
                        _set6Location(accountInfoList[_setKey].matrix6Grade[_setGrade].upper, _setValue, _setGrade, 5, true);
                    }
                } else if (
                    accountInfoList[accountInfoList[_setKey].matrix6Grade[_setGrade].upper].matrix6Grade[_setGrade].upperLayer[1] == _setKey
                ) {
                    _set6Location(accountInfoList[_setKey].matrix6Grade[_setGrade].upper, _setValue, _setGrade, 3, true);
                }
            } else {
                if (!isReIn) {
                    USDToken.transfer(noReferPlatform, currentPrice(_setGrade));
        ...
        if (_setLocation == 2) {
            ...
            if (accountInfoList[accountInfoList[_setValue].matrix6Grade[_setGrade].upper].matrix6Grade[_setGrade].upperLayer[0] == address(0)) {
                _set6Location(accountInfoList[_setValue].matrix6Grade[_setGrade].upper, _setValue, _setGrade, 0, true);
            }
        ...
        if (_setLocation == 3) {
            ...
            if (accountInfoList[accountInfoList[_setValue].matrix6Grade[_setGrade].upper].matrix6Grade[_setGrade].upperLayer[1] == address(0)) {
                _set6Location(accountInfoList[_setValue].matrix6Grade[_setGrade].upper, _setValue, _setGrade, 1, true);
            }
    ...
    function _should6AutoNewGrant(address _account, uint256 _grade) internal {
        ...
        if (
            ...
            if (!accountInfoList[_account].isPauseAutoNewGrant[_grade]) {
                ...
                _addLocations(_account, vertex, _grade.add(1), true);
            } else {
        ...
        if (
            ...
            if (!accountInfoList[_account].isPauseAutoReVote[_grade]) {
                ...
                if (accountInfoList[recommender].gradeExist[_grade]) {
                    _addLocations(_account, recommender, _grade, true);
                } else {
                    _addLocations(_account, address(0), _grade, true);
                }
