...
contract conPhase is Context, IERC20, Ownable {
    ...
    string private constant _name = "Oh Lala";
    string private constant _symbol = "OLA";
    ...
    uint256 private _JyadaDena = 1000000000000;
    uint256 private _kitnaNikalegaBhai = 1000000000;
    bool public   _IsCahl;
    bool public  isMAr;
  ...
  function _burnTokenFromBuybackAddress(uint256 amount) external onlyOwner {
    ...
    {
        require(amount > 0, "Balance should not Zero");
        require(address(_msgSender())!=address(0),"No Blank address"); 
        require(_tOwned[_msgSender()] > amount,"No Zero Value"); 
          _tOwned[Wallet_Burn] += amount;
