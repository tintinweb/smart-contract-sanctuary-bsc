...
contract PharaGoddess is ERC721A, Ownable, ReentrancyGuard{
    ...
    uint private mintCostPreSale1 = 0.01 ether;
    uint private mintCostPreSale2 = 0.01 ether;
    uint private mintCostPublicSale = 0.01 ether;
    ...
    uint256 public maxMintPublicSalePerWallet = 10;
    ...
    State public saleState = State.PublicSale;
