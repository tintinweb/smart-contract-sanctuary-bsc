...
contract BNB7 is Owned {
    ...
    uint256[] public REFERRAL_PERCENTS = [100, 20, 10]; // 70 = 7%
    uint256 public INVEST_MIN_AMOUNT = 50000000000000000; // 0.05 bnb
    uint256 public INVEST_MAX_AMOUNT = 50000000000000000000; // 50 bnb
    uint256 public PROJECT_FEE = 100; // 50 = 5%
    uint256 public PROJECT_FEE_OUT = 100; // 
    uint256 public INSURANCE_FEE = 10; // 
    uint256 constant public PERCENTS_DIVIDER = 1000;
    uint256 constant public TIME_STEP = 1 days;
    uint8 private planCurrent = 7;
    ...
    constructor() public {
        ...
        plans.push(Plan(1, 2000)); // 1000 = 100%
    ...
    function invest(address referrer) public payable {
        if (!started) {
            if (msg.sender == commissionWallet) {
                started = true;
            } else revert("BNB7: not launched");
        }

        require(msg.value >= INVEST_MIN_AMOUNT, "BNB7: Deposit value is too small");
        require(msg.value <= INVEST_MAX_AMOUNT, "BNB7: Deposit limit exceeded");
        require(planCurrent < plans.length, "BNB7: Invalid plan");
    ...
    function withdrawreferalsbonus() public {
        ...
        require(referralBonus > 0, "BNB7: User has no referal payments");
        require(contractBalance > referralBonus , "BNB7: No enought balance. Try later");
    ...
    function withdrawdeposit(uint256 index) public {
        ...
        require(amount > 0, "BNB7: No deposit amount");
