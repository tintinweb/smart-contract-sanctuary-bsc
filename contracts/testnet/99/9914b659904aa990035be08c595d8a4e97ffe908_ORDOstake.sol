...
contract ORDOstake {
    ...
    function getPriceinUSD() public view returns (uint256){
        ...
        address ORDO_WBNB = 0x01847df53f5A3C48B94a55D790c054B002CAC085; // ORDO_WBNB pancake pool address
        IERC20 ORDOTOKEN = IERC20(0xc41F3C09e7BA6Af2Ad5DC3c8e3e605FCED91d5e5); // ORDO Token address 
