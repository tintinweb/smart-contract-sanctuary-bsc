    ...
    VRFConsumerBaseV2Upgradeable
{
    ...
    function initialize(
        ...
        __ERC721_init("WeaponERC721", "WeaponNFT");
        ...
        rangesMap[1] = RangesByTier({minRange: 0, maxRange: 16});
        rangesMap[2] = RangesByTier({minRange: 0, maxRange: 9});
        rangesMap[3] = RangesByTier({minRange: 0, maxRange: 9});
        rangesMap[4] = RangesByTier({minRange: 0, maxRange: 4});
        rangesMap[5] = RangesByTier({minRange: 20, maxRange: 24});
        rangesMap[6] = RangesByTier({minRange: 25, maxRange: 29});

        baseURIByTier[
            1
        ] = "https://bamboodefi.mypinata.cloud/ipfs/QmbvmPhQvp86ZGdRfkVCQejFowUfdrTU8tWtikaEKbxL46/";
        baseURIByTier[
            2
        ] = "https://bamboodefi.mypinata.cloud/ipfs/QmRqUFViKQSWBAodDDZ9MMtwwVqwLqKbRAYaQLjHJ4En2i/";
        baseURIByTier[
            3
        ] = "https://bamboodefi.mypinata.cloud/ipfs/QmbPwA6dzXEK26ED26qyjy5RmnbaE6XXbKaiwjwNipvLbb/";
        baseURIByTier[
            4
        ] = "https://bamboodefi.mypinata.cloud/ipfs/QmRXNUK43FKUjSCcCP9vJDaAjx1UiQHA7ptt3L36t7qpi4/";
    }
