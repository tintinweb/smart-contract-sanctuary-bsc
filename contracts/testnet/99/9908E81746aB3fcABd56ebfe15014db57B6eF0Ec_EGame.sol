...
contract EGame is ERC20 {
    ...
    modifier onlyOnce() {
        require(!claimed[msg.sender], "Unable to claim twice");
        _;
    }

    constructor() ERC20("EGame Token", "EGT") {
    ...
    function claim(uint256 token_amount) external onlyOnce returns (bool) {
