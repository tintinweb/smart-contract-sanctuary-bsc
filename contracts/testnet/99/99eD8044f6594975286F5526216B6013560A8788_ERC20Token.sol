...
contract ERC20Token is ERC20 {
    ...
    function getMaxLowbAmount(uint lusdAmount) public view returns (uint) {
    ...
    function burn(uint amount) public {
        ...
        IERC20 token = IERC20(lowbAddress);
        uint lowbAmount = getLowbAmount(amount) * 9800 / 10000;
        require(lowbAmount <= getMaxLowbAmount(amount), "not enough lowb");
