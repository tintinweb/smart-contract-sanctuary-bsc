...
contract Proxy {
    mapping(uint => address) public _presale;
     IBEP20 public tokenAddress;
     address public ownerAddress;
     uint256 public ifoIncrement;

      constructor() public {
      }

     function createIfoSale( IBEP20 _lpToken,
        IBEP20 _offeringToken,
        uint256 _startBlock,
        uint256 _endBlock,
        uint256 _offeringAmount,
        ...
        address adminAddess
         ...
         ifoIncrement++;
        _presale[ifoIncrement] = address(new IFOByProxy(_lpToken,_offeringToken,_startBlock,_endBlock,_offeringAmount,_raisingAmount,adminAddess));
    }
    function getPresale(uint256 _token) public view returns (address){
