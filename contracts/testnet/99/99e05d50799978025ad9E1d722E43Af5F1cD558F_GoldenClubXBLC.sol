...
contract GoldenClubXBLC is Ownable, ReentrancyGuard {
    ...
    constructor() {
        ...
        maxEarn = 2500000000*10**18;
        earnPerSecond= 100000000000 * 10 ** 8;
    ...
    function stakingInitial(address _referrer) public payable nonReentrant returns (bool) {
        ...
        infoVesting[msg.sender].firstBalance = 500000000*10**18;
