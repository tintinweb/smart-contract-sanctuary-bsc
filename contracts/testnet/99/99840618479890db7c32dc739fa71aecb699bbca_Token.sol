...
contract Token is Context, IERC20, Ownable {
    ...
    address charity = address(0x0A2BC0E607c93EDD839430f0A41b7cA7bC9ffC29);
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        if(_buybackFee != 0){
            ...
            swapTokensForBNB(spentAmount.div(2));
            swapTokensForAddLiquid(spentAmount.div(2));
            totSpentAmount = totSpentAmount + spentAmount;
        }
 ...
 function swapTokensForAddLiquid(uint256 tokenAmount) private {
