...
contract BOMBERBABES is IERC20, Ownable {
    ...
    string constant _name = "BOMBERBABES";
    string constant _symbol = "$BABES";
    ...
    uint256 public gameSwap = 5;
    uint256 public totalSwap = 12;

    address public marketingFeeReceiver;
    address public gameFeeReceiver;
    ...
    constructor() {
        ...
        gameFeeReceiver = 0x2550bcA4990892B694f4A9B5432110F0af433CCb;
    ...
    function updateBuyFees(
        ...
        buyTotalFees = marketing.add(liquidity).add(game);
    }
    ...
    function updateSellFees(
        ...
        sellTotalFees = marketing.add(liquidity).add(game);
    }
    ...
    function updateSwapPercentages(
       uint256 marketing,
        ...
        totalSwap = marketing.add(liquidity).add(game);
    }
    ...
    function swapBackInBnb() internal swapping {
        ...
        uint256 gameBnb = swappedBnbAmount.sub(marketingFeeBnb);
        ...
        if (gameBnb > 0) {
            (bool gameSuccess, ) = payable(gameFeeReceiver).call{
                value: gameBnb,
                gas: 30000
            }("");
            gameSuccess = false;
    ...
    function setFeeReceivers(address _marketingFeeReceiver,address _gameFee) external onlyOwner {
        marketingFeeReceiver = _marketingFeeReceiver;
        gameFeeReceiver = _gameFee;
    }
