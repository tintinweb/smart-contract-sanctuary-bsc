...
contract TOSKA is Context, IBEP20, Ownable, Pausable {
  ...
  uint256 private _maxSupply = 175000000000000000000000000;
  constructor() public {
    _name = "TOSKA";
    _symbol = "TSK";
    _decimals = 18;
  ...
  */
  ...
  function _transfer(address sender, address recipient, uint256 amount) internal {
    ...
    {
        uint256 burn_per = amount * 75 / 10000;
        uint256 charity_per = amount * 25 /10000;
        uint256 amt = amount - burn_per - charity_per;
      
        _balances[sender] = _balances[sender].sub(amount, "BEP20: transfer amount exceeds balance");
        _balances[recipient] = _balances[recipient].add(amt);
        emit Burn(sender, burn_per);
        emit Transfer(sender, owner(), charity_per);
