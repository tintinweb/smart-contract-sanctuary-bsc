...
contract LICKS is ERC20, ERC20Burnable, Pausable, Ownable {
    IUniswapV2Router02 public pancakeRouter;

    address public pancakeRouterAddress;

    address public pancakePair;
    address public liquidityReceiver = owner();

    bool public autoSwapAndLiquifyEnabled = false;
    ...
    constructor() ERC20("LICKS", "LICKS") {
        _mint(msg.sender, 1 * 10**8 * 10**decimals());
        setMinTokensBeforeSwap(50);
        ...
        onlyOwner
    {
        ...
        minTokensBeforeSwap = minTokensBeforeSwap_ * 10**decimals();
